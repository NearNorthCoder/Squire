...
import q.p000.t.a.o.u.i.p001.o.u.t.e.s.a.r.EnumC0063l;
import q.p000.t.a.o.u.i.p001.o.u.t.e.s.a.r.EnumC0071t;
import q.p000.t.a.o.u.i.p001.o.u.t.e.s.a.r.EnumC0072u;
import q.p000.t.a.o.u.i.p001.o.u.t.e.s.a.r.EnumC0074w;
@ConfigGroup("squiretoa")
/* loaded from: 581bf999-de0d-4fc5-a3b6-1ebe3d93b748.jar:gg/squire/autotoa/TOAConfig.class */
public interface TOAConfig extends Config {
    ...
    public static final /* synthetic */ String SPECIAL_INVOCATIONS = "Invocations";
    ...
    default EnumC0074w rangePrayer() {
        return EnumC0074w.RIGOUR;
    }
    ...
    default EnumC0071t magePrayer() {
        return EnumC0071t.AUGURY;
    }
    ...
    default boolean disableHopping() {
        return ((170 ^ 155) ^ (106 ^ 86)) & (((61 ^ 74) ^ (112 ^ 10)) ^ (-" ".length()));
    }
    ...
    default ConfigStorageBox<EquipmentSetup> kephriMelee() {
        return new ConfigStorageBox<>("equipmentsetup", "None");
    }
    ...
    default ConfigStorageBox<EquipmentSetup> kephriRanger() {
        return new ConfigStorageBox<>("equipmentsetup", "None");
    }
    ...
    default EnumC0063l thirdRoom() {
        return EnumC0063l.HET;
    }
