...
import q.s.p000.i.r.e.r.w.r.s.o.u.b.a.f;
@ConfigGroup("squirebarrows")
/* loaded from: 3b638005-922a-492f-9405-93e6a5194477.jar:gg/squire/barrows/SquireBarrowsConfig.class */
public interface SquireBarrowsConfig extends Config {
    ...
    public static final /* synthetic */ String POH_SETTINGS = "POH Settings";
    ...
    public static final /* synthetic */ String BANKING_SETTINGS = "Banking settings";
    ...
    default boolean specOnAhrim() {
        return ((((39 + 74) - 18) + 41) ^ (((160 + 24) - 157) + 139)) & (((((156 + 80) - 154) + 105) ^ (((24 + 101) - (-15)) + 9)) ^ (-" ".length()));
    }
    ...
    default boolean specOnKaril() {
        return ((((116 + 158) - 217) + 119) ^ (((22 + 53) - 70) + 146)) & (((((20 + 9) - (-30)) + 95) ^ (((73 + 21) - (-8)) + 87)) ^ (-" ".length()));
    }
    ...
    default boolean restoreMidTrip() {
        return ((235 ^ 129) ^ (195 ^ 174)) & (((((99 + 139) - 206) + 162) ^ (((2 + 87) - (-78)) + 30)) ^ (-" ".length()));
    }
