...
import s.i.e.i.m.r.p000.q.e.g.h.u.n.t.r.a.EnumC0022s;
import s.i.e.i.m.r.p000.q.e.g.h.u.n.t.r.a.EnumC0026w;
@ConfigGroup("squirenightmare")
/* loaded from: squire-nightmare-0.1.0.jar:gg/squire/nightmare/SquireNightmareConfig.class */
public interface SquireNightmareConfig extends Config {
    @ConfigSection(name = "Misc Settings", description = "Miscellaneous settings", position = 3)
    public static final /* synthetic */ String MISC_SETTINGS = "Misc Settings";
    ...
    public static final /* synthetic */ String OUTSIDE_SETTINGS = "Outside Settings";
    ...
    default EnumC0026w bankLocation() {
        return EnumC0026w.VER_SINHAZA;
    }
    ...
    default int rechargeStaffAmount() {
        return (-10284) & 12283;
    }
    ...
    default ConfigStorageBox<EquipmentSetup> sleepwalkerGear() {
    ...
    default boolean continueWithNoPots() {
    ...
    default boolean advancedSettings() {
        return (true ^ true) & ((true ^ true) ^ true);
    }
    ...
    default EnumC0022s fireSpell() {
        return EnumC0022s.FIRE_SURGE;
    }
    ...
    default ConfigStorageBox<EquipmentSetup> huskGear() {
        return new ConfigStorageBox<>("equipmentsetup", "None");
    }
    ...
    default boolean enableRestocking() {
        return ((115 ^ 111) ^ (21 ^ 41)) & (((((128 + 44) - 19) + 24) ^ (((39 + 143) - 166) + 129)) ^ (-" ".length()));
    }
    ...
    default int restoreHealthPercentBetweenPhase() {
        return 122 ^ 70;
    }
    ...
    default boolean adaptiveHopAfterTeleport() {
        return " ".length();
    }
    ...
    default boolean neverTeleport() {
        return ((96 ^ 104) ^ (111 ^ 93)) & (((((84 + 66) - 34) + 60) ^ (((14 + 37) - (-47)) + 40)) ^ (-" ".length()));
    }
    ...
    default boolean lowerDamageFinalPhase() {
        return ((177 ^ 166) ^ (109 ^ 26)) & (((((23 + 143) - 134) + 207) ^ (((104 + 35) - 25) + 29)) ^ (-" ".length()));
    }
    ...
    default boolean restoreInPOH() {
        return ((((70 + 81) - 83) + 131) ^ (((86 + 49) - 60) + 59)) & (((232 ^ 177) ^ (19 ^ 11)) ^ (-" ".length()));
    }
    ...
    default ConfigStorageBox<EquipmentSetup> parasiteGear() {
        return new ConfigStorageBox<>("equipmentsetup", "None");
    }
    ...
    default boolean assistantMode() {
        return ((102 ^ 2) ^ (44 ^ 30)) & (((174 ^ 196) ^ (144 ^ 172)) ^ (-" ".length()));
    }

    @ConfigItem(position = 2, keyName = "totemGear", name = "Totem Gear", description = "Gear for attacking totems", section = "Gear Settings")
    default ConfigStorageBox<EquipmentSetup> totemGear() {
        return new ConfigStorageBox<>("equipmentsetup", "None");
    }
}
