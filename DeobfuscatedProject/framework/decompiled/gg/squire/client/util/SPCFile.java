...
public class SPCFile {
    ...
    public SPCFile(Reader input) throws IOException {
        this.data = IOUtils.toByteArray((Reader)input, (Charset)StandardCharsets.UTF_8);
        input.close();
    }
    ...
    public void read() {
        ...
        String[] lines = StringUtils.split((String)new String(body), (String)"\n");
        ...
        for (int i = 3; i < lines.length; ++i) {
            if (Strings.isNullOrEmpty((String)lines[i])) {
            ...
            try (Response execute = client.newCall(request).execute();){
                ...
                ByteString byteString = ByteString.decodeBase64((String)rb.string());
                if (byteString == null) {
