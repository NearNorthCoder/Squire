...
public enum PortalNexus {
    ARCEUUS_LIBRARY(new WorldPoint(1634, 3836, 0), "4"),
    ...
    ANNAKARL(new WorldPoint(3288, 3888, 0), "1"),
    APE_ATOLL(new WorldPoint(2770, 2699, 0), "2"),
    APE_ATOLL_DUNGEON(new WorldPoint(2769, 9100, 0), "3"),
    ...
    private PortalNexus(WorldPoint destination) {
        this.destination = destination;
        this.option = null;
    }

    private PortalNexus(WorldPoint destination, String option) {
        this.destination = destination;
        this.option = option;
    }
