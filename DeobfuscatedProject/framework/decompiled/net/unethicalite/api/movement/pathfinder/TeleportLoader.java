...
public class TeleportLoader {
                    ...
                    if (TeleportLoader.chronicle()) {
                        ...
                        if (chatLineBuffer == null) {
                            ...
                            while (var4_13 < n) {
                                ...
                                if (StringUtils.contains((CharSequence)messageNode.getValue(), (CharSequence)"Your book does not hvae any charges")) {
                                    hasChronicleTeleports = true;
                                } else if (StringUtils.contains((CharSequence)messageNode.getValue(), (CharSequence)"charges to your book")) {
    ...
    public static Teleport mountedPohTeleport(WorldPoint destination, int objId, String action) {
        return new Teleport(destination, 10, () -> {
            ...
            log.debug("Using Mounted POH teleport {} {} {}", new Object[]{destination, objId, action});
