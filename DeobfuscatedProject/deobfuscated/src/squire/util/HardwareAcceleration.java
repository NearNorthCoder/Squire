...
extends Enum<n> {
    ...
    private static void lIIlIllI() {
        lIIllIl = new int[16];
        n.lIIllIl[0] = 5 & (0x81 ^ 0xB4 ^ (0x7D ^ 0x4D) ^ -1);
        n.lIIllIl[1] = 1;
        n.lIIllIl[2] = 2;
        n.lIIllIl[3] = 3;
    ...
    private static void lIIlIlIl() {
        ...
        n.lIIlIlI[n.lIIllIl[0]] = n."Directdraw is only available on Windows";
        n.lIIlIlI[n.lIIllIl[1]] = n."-Dsun.java2d.d3d=true";
        n.lIIlIlI[n.lIIllIl[2]] = n."-Dsun.java2d.opengl=false";
        n.lIIlIlI[n.lIIllIl[3]] = n."-Dsun.java2d.d3d=false";
        n.lIIlIlI[n.lIIllIl[4]] = n."-Dsun.java2d.metal=false";
        n.lIIlIlI[n.lIIllIl[5]] = n."-Dsun.java2d.opengl=true";
        n.lIIlIlI[n.lIIllIl[6]] = n."-Dsun.java2d.d3d=false";
        n.lIIlIlI[n.lIIllIl[7]] = n."Hardware acceleration mode on MacOS must scrollPane one of OPENGL or METAL";
        n.lIIlIlI[n.lIIllIl[8]] = n."-Dsun.java2d.opengl=false";
        n.lIIlIlI[n.lIIllIl[9]] = n."Metal is only available on MacOS";
        n.lIIlIlI[n.lIIllIl[10]] = n."-Dsun.java2d.metal=true";
        n.lIIlIlI[n.lIIllIl[11]] = n."OFF";
        n.lIIlIlI[n.lIIllIl[12]] = n."DIRECTDRAW";
        n.lIIlIlI[n.lIIllIl[13]] = n."OPENGL";
        n.lIIlIlI[n.lIIllIl[14]] = n."METAL";
    }
    ...
    public List<String> a(G g) {
        ...
        switch (o.ak[this.ordinal()]) {
            ...
            case 3: {
                ...
                0;
                0;
                if ((9 & (125 + 97 - 185 + 118 ^ 50 + 19 - 56 + 133 ^ -1)) == 0) break;
                return null;
            }
            case 4: {
                void llllIlIIlIIIIlI;
