...
import squire.util.ImageLoader;
import squire.auth.RequestBuilder;
import squire.util.StringUtils;
import squire.auth.TokenManager;
import squire.util.FileUtil;
...
extends JPanel {
    ...
    private static String llIlIIl(String llllIlllIIlIlII, String llllIlllIIlIIll) {
        ...
        while (q.lllIIII(llllIlllIIIlIII, llllIlllIIIlIIl)) {
            ...
            ++llllIlllIIIlIII;
            0;
            if (((0x57 ^ 4) & ~(0xC2 ^ 0x91)) != 3) continue;
            return null;
        }
    ...
    private static void llIlIll() {
        ...
        q.llIllI[q.llIlll[2]] = q."Open logs folder";
        q.llIllI[q.llIlll[7]] = q."Get help on Discord";
        q.llIllI[q.llIlll[1]] = q."Instant invite link to join the Squire discord";
        q.llIllI[q.llIlll[9]] = q."Troubleshooting steps";
        q.llIllI[q.llIlll[5]] = q."Opens a link to the troubleshooting wiki";
        q.llIllI[q.llIlll[3]] = q."Exit";
        q.llIllI[q.llIlll[10]] = q."Closes the application immediately";
        q.llIllI[q.llIlll[11]] = q."Authentication Code";
        q.llIllI[q.llIlll[12]] = q."Please enter your auth code";
        q.llIllI[q.llIlll[13]] = q."https://raw.githubusercontent.com/Squire/Squire-launcher/master/build.gradle.kts";
        q.llIllI[q.llIlll[14]] = q."User-Agent";
        q.llIllI[q.llIlll[6]] = q."version = '(\\d{1}).(\\d{1}).(\\d{1})'";
        q.llIllI[q.llIlll[15]] = q."%s.%s.%s";
        q.llIllI[q.llIlll[16]] = q."-1";
        q.llIllI[q.llIlll[17]] = q."cfg.sqr";
        q.llIllI[q.llIlll[8]] = q."";
        q.llIllI[q.llIlll[19]] = q."https://github.com/runelite/runelite/wiki/Troubleshooting-problems-with-the-client";
        q.llIllI[q.llIlll[20]] = q."https://discord.gg/squireos";
        q.llIllI[q.llIlll[21]] = q."https://discord.gg/squireos";
        q.llIllI[q.llIlll[22]] = q."https://discord.gg/squireos";
        q.llIllI[q.llIlll[23]] = q."https://github.com/runelite/runelite/wiki/Troubleshooting-problems-with-the-client";
        q.llIllI[q.llIlll[24]] = q."user.home";
        q.llIllI[q.llIlll[27]] = q."squire.png";
    }
    ...
    private static JLabel b(String string) {
        ...
        jLabel.setForeground(k.PRIMARY_COLOR);
    ...
    public static String e() {
        ...
        try {
            ...
            try {
                ...
                if (2 > 0) throw llllIlllIlIIllI222;
                return null;
            }
            {
    ...
    public JTextField d() {
        ...
        jTextField.setForeground(k.BACKGROUND_COLOR);
        jTextField.setCaretColor(k.BACKGROUND_COLOR);
        jTextField.setBackground(k.PRIMARY_COLOR);
        jTextField.setPreferredSize(new Dimension(llIlll[18], llIlll[18]));
        jTextField.setMinimumSize(new Dimension(llIlll[18], llIlll[18]));
        jTextField.setBorder(new CompoundBorder(new MatteBorder(llIlll[7], llIlll[2], llIlll[2], llIlll[2], k.BORDER_COLOR), new EmptyBorder(llIlll[2], llIlll[8], llIlll[2], llIlll[8])));
    ...
    static {
        ...
        ao = new Dimension(llIlll[25], L.WINDOW_SIZE.height);
    ...
    private static JLabel a(String string, Runnable runnable) {
        ...
        jLabel.setFont(m.o());
        jLabel.setHorizontalAlignment(llIlll[2]);
        jLabel.setForeground(k.ERROR_COLOR);
        jLabel.setBackground(null);
        jLabel.setPreferredSize(ar);
        jLabel.setMinimumSize(ar);
        jLabel.setBorder(new MatteBorder(llIlll[7], llIlll[2], llIlll[2], llIlll[2], ap));
