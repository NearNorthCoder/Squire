...
import squire.ui.AuthProgressBarUI;
import squire.ui.HtmlLabel;
...
extends JPanel {
    ...
    public static final /* synthetic */ File squireDir;
    ...
    static {
        ...
        c.llllIIl();
        D = lllIll[19];
        squireDir = new File(System.getProperty(lllIlI[lllIll[3]]) + "/.squire/");
        B = new Dimension(c.r.m.L.WINDOW_SIZE.width - q.ao.width, c.r.m.L.WINDOW_SIZE.height);
    ...
    public static String e() {
        File file = new File(squireDir, lllIlI[lllIll[20]]);
    ...
    private static void llllIIl() {
        ...
        c.lllIlI[c.lllIll[0]] = c."Squire Launcher";
        c.lllIlI[c.lllIll[2]] = c."Please authenticate since this is your first time opening the client.";
        c.lllIlI[c.lllIll[12]] = c."Authenticate";
        c.lllIlI[c.lllIll[17]] = c."Center";
        c.lllIlI[c.lllIll[20]] = c."cfg.sqr";
        c.lllIlI[c.lllIll[11]] = c."";
        c.lllIlI[c.lllIll[21]] = c."https://g0dp8zyku3.execute-api.eu-west-1.amazonaws.com/default/AuthenticateAlpha?key=%s&mid=%s";
        c.lllIlI[c.lllIll[22]] = c."launcher";
        c.lllIlI[c.lllIll[24]] = c."This authentication key is invalid";
        c.lllIlI[c.lllIll[25]] = c."Invalid Auth";
        c.lllIlI[c.lllIll[10]] = c."cfg.sqr";
        c.lllIlI[c.lllIll[3]] = c."user.home";
    }
    ...
    private void a(JTextField llllIllIIllIIll) {
        ...
        llllIllIIlIllll2 = new File(squireDir, lllIlI[lllIll[10]]);
        if (c.lllllII(squireDir.exists() ? 1 : 0)) {
            squireDir.mkdirs();
            0;
        }
        try {
        ...
        if ((50 + 109 - 124 + 162 ^ 77 + 2 - -91 + 23) < 3) {
            return;
        }
    }
    ...
    public c() {
        ...
        jTextField.setBackground(k.INPUT_BACKGROUND);
        ...
        jTextField.setForeground(k.PRIMARY_COLOR);
        JPanel jPanel = new JPanel();
        jPanel.setBackground(k.BACKGROUND_COLOR);
        ...
        this.N.setBackground(k.BACKGROUND_COLOR);
        ...
        this.K.setBackground(k.SECONDARY_COLOR.darker());
        this.K.setForeground(k.PRIMARY_COLOR);
