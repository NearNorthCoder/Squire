...
extends JFrame {
    ...
    static final /* synthetic */ Dimension WINDOW_SIZE;
    private static /* synthetic */ int[] lIlII;
    private static /* synthetic */ String[] llll;
    private final /* synthetic */ c authPanel;
    public static /* synthetic */ File squireDir;
    private /* synthetic */ z progressPanel;
    private static /* synthetic */ L instance;
    ...
    private void o(String string) {
        boolean bl;
        JProgressBar jProgressBar = this.progressPanel.P();
        jProgressBar.setString(string);
        if (L.lIIlll(string)) {
            bl = lIlII[2];
            0;
            if (4 == ((0xBC ^ 0xC7 ^ (0x90 ^ 0xBB)) & (0x9A ^ 0x85 ^ (0x55 ^ 0x1A) ^ -1))) {
                return;
            }
        } else {
            bl = lIlII[0];
    ...
    static {
        ...
        WINDOW_SIZE = new Dimension(lIlII[13], lIlII[14]);
    }

    public static void h(String string, String string2) {
        if (L.lIIlll(instance)) {
            instance.i(string, string2);
        }
    }

    public static void K() {
        if (L.lIIlll(instance)) {
            L.instance.progressPanel.K();
        }
    }
    ...
    private void i(String string, String string2) {
        this.progressPanel.h(string2);
        this.progressPanel.i(llll[lIlII[8]]);
        this.progressPanel.O().setText(string);
        this.progressPanel.P().setBackground(k.ERROR_COLOR.darker());
        this.progressPanel.P().setForeground(k.ERROR_COLOR);
    ...
    public static void m(String string) {
        if (L.lIIlll(instance)) {
            L.instance.progressPanel.h(string);
        }
    }

    public static JButton n(String string) {
        if (L.lIIlll(instance)) {
            return L.instance.progressPanel.g(string, llll[lIlII[7]]);
        }
        return null;
    }
    ...
    private L(String string, boolean bl) {
        ...
        this.progressPanel = new z(llll[lIlII[1]].equals(string));
        JPanel jPanel = new JPanel();
        jPanel.setLayout(new BorderLayout());
        jPanel.setPreferredSize(WINDOW_SIZE);
        if (L.lIIllI(bl ? 1 : 0)) {
            jPanel.add((Component)this.authPanel, llll[lIlII[3]]);
            0;
            if (1 < -1) {
                throw null;
            }
            ...
            lllllllIIIIlIlI.add((Component)lllllllIIIIllIl.progressPanel, llll[lIlII[5]]);
        }
    ...
    public static void close() {
        SwingUtilities.invokeLater(() -> {
            if (L.lIlIlI(instance)) {
                return;
            }
            instance.setDefaultCloseOperation(lIlII[0]);
            instance.setVisible(lIlII[0]);
            instance.dispose();
            instance = null;
        });
    }
        ...
        try {
            SwingUtilities.invokeAndWait(() -> {
                ...
                try {
                    ...
                    instance = new L(llllllIllIllllI, llllllIllIlllII.exists());
                    0;
                }
                catch (Exception llllllIllIlllIl) {
                    logger.warn(llll[lIlII[12]], llllllIllIlllIl);
                }
                if (-1 > 2) {
                    return;
                }
    ...
    private static void lIlll() {
        ...
        L.llll[L.lIlII[0]] = L."Squire";
        L.llll[L.lIlII[2]] = L."squire.png";
        L.llll[L.lIlII[1]] = L."Selecting account";
        L.llll[L.lIlII[3]] = L."Center";
        L.llll[L.lIlII[4]] = L."East";
        L.llll[L.lIlII[5]] = L."West";
        L.llll[L.lIlII[6]] = L."%.1f / %.1f MB";
        L.llll[L.lIlII[7]] = L."";
        L.llll[L.lIlII[8]] = L."Error!";
        L.llll[L.lIlII[10]] = L."user.home";
        L.llll[L.lIlII[11]] = L."cfg.sqr";
        L.llll[L.lIlII[12]] = L."Unable to start splash screen";
    }
    ...
    private void a(String string, double d) {
        this.progressPanel.O().setText(string);
        this.progressPanel.P().setMaximum(lIlII[9]);
        this.progressPanel.P().setValue((int)(d * 1000.0));
        this.o(null);
        this.getContentPane().revalidate();
        this.getContentPane().repaint();
    }
