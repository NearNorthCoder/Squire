...
public class WidgetItem {
    ...
    public String toString() {
        return "WidgetItem(id=" + this.getId() + ", quantity=" + this.getQuantity() + ", index=" + this.getIndex() + ", canvasBounds=" + String.valueOf(this.getCanvasBounds()) + ", widget=" + String.valueOf(this.getWidget()) + ", draggingCanvasBounds=" + String.valueOf(this.getDraggingCanvasBounds()) + ")";
    }
