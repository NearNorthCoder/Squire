...
Identifiable {
    ...
    public Widget createStaticChild(int var1);
    ...
    public void setPaddingX(int var1);

    public void setPaddingY(int var1);

    public boolean isVisible();

    public void setVisible(boolean var1);

    public void interact(int var1, int var2, int var3);
}
