...
public class ChatMessage {
    ...
    public String toString() {
        return "ChatMessage(messageNode=" + String.valueOf(this.getMessageNode()) + ", type=" + String.valueOf((Object)this.getType()) + ", name=" + this.getName() + ", message=" + this.getMessage() + ", sender=" + this.getSender() + ", timestamp=" + this.getTimestamp() + ")";
    }
