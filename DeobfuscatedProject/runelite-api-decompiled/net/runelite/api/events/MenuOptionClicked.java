...
public class MenuOptionClicked {
    ...
    public void setParam0(int param0) {
        this.menuEntry.setParam0(param0);
    }
    ...
    public void setParam1(int param1) {
        this.menuEntry.setParam1(param1);
    }
    ...
    public void setMenuOption(String menuOption) {
        this.menuEntry.setOption(menuOption);
    }
    ...
    public void setMenuTarget(String menuTarget) {
        this.menuEntry.setTarget(menuTarget);
    }
    ...
    public void setId(int id) {
        this.menuEntry.setIdentifier(id);
    }
    ...
    public void setItemId(int itemId) {
        this.menuEntry.setItemId(itemId);
    }
    ...
    public void setActionParam(int actionParam) {
        this.menuEntry.setParam0(actionParam);
    }
    ...
    public void setWidgetId(int widgetId) {
        this.menuEntry.setParam1(widgetId);
    }
    ...
    public String toString() {
        return "MenuOptionClicked(getParam0=" + this.getParam0() + ", getParam1=" + this.getParam1() + ", getMenuOption=" + this.getMenuOption() + ", getMenuTarget=" + this.getMenuTarget() + ", getMenuAction=" + String.valueOf((Object)this.getMenuAction()) + ", getId=" + this.getId() + ")";
    }
