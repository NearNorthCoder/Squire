...
public final class ItemQuantityChanged {
    ...
    public String toString() {
        return "ItemQuantityChanged(item=" + String.valueOf(this.getItem()) + ", tile=" + String.valueOf(this.getTile()) + ", oldQuantity=" + this.getOldQuantity() + ", newQuantity=" + this.getNewQuantity() + ")";
    }
}
