...
public class AreaSoundEffectPlayed {
    ...
    public String toString() {
        return "AreaSoundEffectPlayed(source=" + String.valueOf(this.getSource()) + ", soundId=" + this.getSoundId() + ", sceneX=" + this.getSceneX() + ", sceneY=" + this.getSceneY() + ", range=" + this.getRange() + ", delay=" + this.getDelay() + ", consumed=" + this.isConsumed() + ")";
    }
}
