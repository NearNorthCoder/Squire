...
public class GrandExchangeTrade {
    ...
    public String toString() {
        return "GrandExchangeTrade(buy=" + this.isBuy() + ", cancel=" + this.isCancel() + ", login=" + this.isLogin() + ", itemId=" + this.getItemId() + ", qty=" + this.getQty() + ", dqty=" + this.getDqty() + ", total=" + this.getTotal() + ", spent=" + this.getSpent() + ", dspent=" + this.getDspent() + ", offer=" + this.getOffer() + ", slot=" + this.getSlot() + ", worldType=" + String.valueOf((Object)this.getWorldType()) + ", seq=" + this.getSeq() + ", resetTime=" + String.valueOf(this.getResetTime()) + ")";
    }
}
