...
public class ItemPrice {
    ...
    public void setWikiPriceFsw(int wikiPriceFsw) {
        this.wikiPriceFsw = wikiPriceFsw;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (this.getWikiPriceFsw() != other.getWikiPriceFsw()) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = result * 59 + this.getWikiPriceFsw();
    ...
    public String toString() {
        return "ItemPrice(id=" + this.getId() + ", name=" + this.getName() + ", price=" + this.getPrice() + ", wikiPrice=" + this.getWikiPrice() + ", wikiPriceFsw=" + this.getWikiPriceFsw() + ")";
    }
}
