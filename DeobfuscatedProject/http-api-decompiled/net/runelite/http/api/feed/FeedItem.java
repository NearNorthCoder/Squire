...
public class FeedItem {
    ...
    public String toString() {
        return "FeedItem(type=" + String.valueOf((Object)this.getType()) + ", avatar=" + this.getAvatar() + ", title=" + this.getTitle() + ", content=" + this.getContent() + ", url=" + this.getUrl() + ", timestamp=" + this.getTimestamp() + ")";
    }
