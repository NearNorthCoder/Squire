...
public class LootRecord {
    ...
    public String toString() {
        return "LootRecord(eventId=" + this.getEventId() + ", type=" + String.valueOf((Object)this.getType()) + ", metadata=" + String.valueOf(this.getMetadata()) + ", drops=" + String.valueOf(this.getDrops()) + ", time=" + String.valueOf(this.getTime()) + ", world=" + this.getWorld() + ", amount=" + this.getAmount() + ", source=" + this.getSource() + ")";
    }

    public LootRecord() {
    }

    public LootRecord(String eventId, LootRecordType type, Object metadata, Collection<GameItem> drops, Instant time, Integer world, Integer amount, String source) {
        this.eventId = eventId;
        this.type = type;
        this.metadata = metadata;
        this.drops = drops;
