...
public class LootAggregate {
    ...
    public String toString() {
        return "LootAggregate(eventId=" + this.getEventId() + ", type=" + String.valueOf((Object)this.getType()) + ", drops=" + String.valueOf(this.getDrops()) + ", first_time=" + String.valueOf(this.getFirst_time()) + ", last_time=" + String.valueOf(this.getLast_time()) + ", amount=" + this.getAmount() + ")";
    }
