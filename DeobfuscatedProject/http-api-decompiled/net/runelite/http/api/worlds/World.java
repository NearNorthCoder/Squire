...
public final class World {
    ...
    public String toString() {
        return "World(id=" + this.getId() + ", types=" + String.valueOf(this.getTypes()) + ", address=" + this.getAddress() + ", activity=" + this.getActivity() + ", location=" + this.getLocation() + ", players=" + this.getPlayers() + ")";
    }
    ...
    public static class WorldBuilder {
        ...
        public String toString() {
            return "World.WorldBuilder(id=" + this.id + ", types=" + String.valueOf(this.types) + ", address=" + this.address + ", activity=" + this.activity + ", location=" + this.location + ", players=" + this.players + ")";
        }
    }
}
