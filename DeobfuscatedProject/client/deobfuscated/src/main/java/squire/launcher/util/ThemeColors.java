...
public final class ThemeColors {
    ...
    /**
     * Primary color for progress bars and highlights
     * Same as PRIMARY_ACCENT
     */
    public static final Color PRIMARY_COLOR = new Color(124, 183, 64);
     ...
     * RGB (45, 45, 45)
     */
    public static final Color BUTTON_BACKGROUND = new Color(45, 45, 45);
