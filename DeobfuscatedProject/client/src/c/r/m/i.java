...
public class i {
    ...
    private static void lllI() {
        ...
        i.llII[i.llIl[1]] = i.llII("rV6DE+JFlukIf7JKMBGf3w==", "GwITv");
        i.llII[i.llIl[2]] = i.llIl("PQoHDgQ=", "seuzl");
        i.llII[i.llIl[3]] = i.llII("QciUe2XSUQg=", "kBSFt");
    }
    ...
    private static void llll() {
        llIl = new int[9];
        i.llIl[0] = 0xB0 ^ 0xB6;
        i.llIl[1] = (0xF6 ^ 0xBC ^ (0x37 ^ 0x3A)) & (0x1E ^ 0x27 ^ (0x4C ^ 0x32) ^ -" ".length());
        i.llIl[2] = " ".length();
        i.llIl[3] = "  ".length();
        i.llIl[4] = "   ".length();
        i.llIl[5] = 0x92 ^ 0x96;
