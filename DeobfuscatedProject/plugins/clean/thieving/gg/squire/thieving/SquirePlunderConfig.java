...
extends Config {
    ...
    default public boolean plunderSarcophagusTwo() {
        return ((0xC7 ^ 0xAD ^ (0xA8 ^ 0x9C)) & (0x40 ^ 2 ^ (0x3A ^ 0x26) ^ -" ".length())) != 0;
    }
    ...
    default public boolean plunderUrnsTwo() {
        return ((177 + 104 - 181 + 126 ^ 143 + 5 - -13 + 13) & (125 + 222 - 189 + 87 ^ 114 + 124 - 230 + 177 ^ -" ".length())) != 0;
    }
    ...
    default public boolean plunderChestTwo() {
        return ((0xE9 ^ 0x97 ^ (0x5D ^ 0x3C)) & (0 ^ 0x5A ^ (0x78 ^ 0x3D) ^ -" ".length())) != 0;
    }
    ...
    default public boolean plunderChestEight() {
        return ((42 + 86 - 85 + 202 ^ 113 + 61 - 41 + 15) & (0 + 187 - 56 + 90 ^ 143 + 151 - 211 + 105 ^ -" ".length())) != 0;
    }
    ...
    default public boolean plunderSarcophagusSeven() {
        return ((0xD ^ 0x1C ^ (0xBF ^ 0x94)) & (0x9D ^ 0x81 ^ (0x20 ^ 6) ^ -" ".length())) != 0;
    }
    ...
    default public boolean plunderChestThree() {
        return ((0x63 ^ 0x1D ^ (0x79 ^ 0x1C)) & (0x68 ^ 0x22 ^ (0x43 ^ 0x12) ^ -" ".length())) != 0;
    }
    ...
    default public boolean plunderUrnsEight() {
        return ((0x43 ^ 0x59 ^ (0x75 ^ 0x5D)) & (159 + 88 - 187 + 121 ^ 38 + 29 - -26 + 42 ^ -" ".length())) != 0;
    }
    ...
    default public boolean plunderSarcophagusFive() {
        return ((0x3F ^ 0x6E ^ (0xE ^ 0x73)) & (0x36 ^ 0x21 ^ (0x70 ^ 0x4B) ^ -" ".length())) != 0;
    }
    ...
    default public boolean plunderUrnsFive() {
        return ((0x6D ^ 0x49 ^ (0x32 ^ 0x5C)) & (0xE5 ^ 0x9B ^ (0x21 ^ 0x15) ^ -" ".length())) != 0;
    }
    ...
    default public boolean plunderUrnsSix() {
        return ((0xB2 ^ 0xBB ^ (0x8A ^ 0xAF)) & (0x7E ^ 0 ^ (0xB ^ 0x59) ^ -" ".length())) != 0;
    }
    ...
    default public boolean plunderSarcophagusThree() {
        return ((0x4F ^ 4 ^ (0x9A ^ 0x8C)) & (0xE4 ^ 0xBF ^ (0x30 ^ 0x36) ^ -" ".length())) != 0;
    }
}
