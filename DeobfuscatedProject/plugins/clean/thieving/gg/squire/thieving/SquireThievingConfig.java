...
extends Config {
    ...
    default public boolean buyWines() {
        return ((105 + 195 - 221 + 125 ^ 44 + 174 - 111 + 91) & (0x9E ^ 0xAB ^ (0x8B ^ 0xB4) ^ -" ".length())) != 0;
    }
    ...
    default public boolean useStaminaPotion() {
        return ((0x6C ^ 0x21 ^ (0x9F ^ 0x88)) & (185 + 122 - 213 + 130 ^ 79 + 137 - 53 + 23 ^ -" ".length())) != 0;
    }
