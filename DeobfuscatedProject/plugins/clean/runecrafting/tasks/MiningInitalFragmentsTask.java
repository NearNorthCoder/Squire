...
extends RunecraftingTaskBase {
    ...
    public void a(ChatMessage chatMessage) {
        ...
        if (l.lllllllIlIIIll(var1.getMessage().contains(llIIlllIlIII[llIIlllIlIIl[2]]) ? 1 : 0)) {
            l var2;
            var2.sleep(Rand.nextInt((int)llIIlllIlIIl[7], (int)llIIlllIlIIl[8]));
        }
    }

    private static void lllllllIIlllll() {
        llIIlllIlIII = new String[llIIlllIlIIl[3]];
        l.llIIlllIlIII[l.llIIlllIlIIl[1]] = "Mine";
        l.llIIlllIlIII[l.llIIlllIlIIl[2]] = "There's no need";
    }
    ...
    protected boolean ak() {
        ...
        if (l.lllllllIlIIlII(var4.aV.g() ? 1 : 0)) {
            var4.bd = llIIlllIlIIl[1];
            return llIIlllIlIIl[1];
        }
        if (l.lllllllIlIIlIl(var4.aV.a(), var4.aW.fragmentAmount())) {
            var4.bd = llIIlllIlIIl[1];
            return llIIlllIlIIl[1];
        }
        if (l.lllllllIlIIlII(var4.bd ? 1 : 0)) {
            return llIIlllIlIIl[1];
        }
        ...
        if (l.lllllllIlIIlll(var3 = tileObject)) {
        ...
        int n2 = Reachable.isInteractable((Locatable)var3);
        if (l.lllllllIlIIIll(var4.ah() ? 1 : 0) && l.lllllllIlIIlII(n2) && l.lllllllIlIIlII(var5.isAnimating() ? 1 : 0)) {
        ...
        if (l.lllllllIlIIIll(Players.getLocal().isAnimating() ? 1 : 0) && l.lllllllIlIIIll(var4.bd ? 1 : 0)) {
            return llIIlllIlIIl[2];
        }
        if (!l.lllllllIlIlIII(var4.aV.L()) || l.lllllllIlIIlII(var4.b((GameObject)var3) ? 1 : 0)) {
            var3.interact(llIIlllIlIII[llIIlllIlIIl[1]]);
            var4.sleep(llIIlllIlIIl[3]);
            return llIIlllIlIIl[2];
        }
        return llIIlllIlIIl[2];
    }
