...
import gg.squire.7ff08cb7-2eac-4b0f-b288-ca118289a708.tasks.SHelper;
...
implements ab {
    ...
    private static void llIIlllIllll() {
        ...
        ak.llllIIlII[ak.llllIIlIl[0]] = "Buying items";
        ak.llllIIlII[ak.llllIIlIl[1]] = "Finished buying items, switching back to magic training";
        ak.llllIIlII[ak.llllIIlIl[3]] = "Navigating to bank";
        ak.llllIIlII[ak.llllIIlIl[4]] = "Handling banking";
        ak.llllIIlII[ak.llllIIlIl[7]] = "We are missing supplies, switching to BUYING";
        ak.llllIIlII[ak.llllIIlIl[6]] = "Take";
        ak.llllIIlII[ak.llllIIlIl[30]] = "Remove";
        ak.llllIIlII[ak.llllIIlIl[33]] = "Wield";
        ak.llllIIlII[ak.llllIIlIl[35]] = "Wear";
        ak.llllIIlII[ak.llllIIlIl[36]] = "Wield";
        ak.llllIIlII[ak.llllIIlIl[24]] = "Wield";
        ak.llllIIlII[ak.llllIIlIl[38]] = "Wield";
        ak.llllIIlII[ak.llllIIlIl[40]] = "Wear";
        ak.llllIIlII[ak.llllIIlIl[41]] = "Wear";
        ak.llllIIlII[ak.llllIIlIl[42]] = "Wear";
        ak.llllIIlII[ak.llllIIlIl[43]] = "Wear";
        ak.llllIIlII[ak.llllIIlIl[45]] = "Wear";
        ak.llllIIlII[ak.llllIIlIl[46]] = "Wear";
        ak.llllIIlII[ak.llllIIlIl[47]] = "Wear";
        ak.llllIIlII[ak.llllIIlIl[48]] = "Wield";
        ak.llllIIlII[ak.llllIIlIl[34]] = "Range training";
        ak.llllIIlII[ak.llllIIlIl[63]] = "ring of wealth (";
        ak.llllIIlII[ak.llllIIlIl[64]] = "bow";
    }
    ...
    private static void Q() {
        block30: {
            ...
            block29: {
                block28: {
                    block27: {
                        ...
                        block25: {
                            block26: {
                                ...
                                if (ak.llIIllllIIll(Bank.contains((int[])nArray) ? 1 : 0)) {
                                    d d2 = new DHelper(llllIIlIl[12], llllIIlIl[1], llllIIlIl[49]);
                                    bx.add(d2);
                                ...
                                if (ak.llIIllllIIll(Bank.contains((int[])nArray2) ? 1 : 0)) {
                                    llIIIIIlIllIl = new DHelper(llllIIlIl[13], llllIIlIl[1], llllIIlIl[49]);
                                    bx.add((DHelper) lIIIIIlIllIl);

                                }
                                int[] nArray3 = new int[llllIIlIl[1]];
                                nArray3[ak.llllIIlIl[0]] = llllIIlIl[14];
                                if (ak.llIIllllIIll(Bank.contains((int[])nArray3) ? 1 : 0)) {
                                    llIIIIIlIllIl = new DHelper(llllIIlIl[14], llllIIlIl[1], llllIIlIl[49]);
                                    bx.add((DHelper) lIIIIIlIllIl);
                            ...
                            llIIIIIlIllIl = new DHelper(llllIIlIl[15], llllIIlIl[51], llllIIlIl[36]);
                            bx.add((DHelper) lIIIIIlIllIl);
                        ...
                        nArray[ak.llllIIlIl[0]] = llllIIlIl[18];
                        if (ak.llIIllllIIll(Bank.contains((int[])nArray) ? 1 : 0)) {
                            llIIIIIlIllIl = new DHelper(llllIIlIl[18], llllIIlIl[1], llllIIlIl[52]);
                            bx.add((DHelper) lIIIIIlIllIl);
                        ...
                        if (ak.llIIllllIIll(Bank.contains((int[])nArray6) ? 1 : 0)) {
                            llIIIIIlIllIl = new DHelper(llllIIlIl[19], llllIIlIl[1], llllIIlIl[52]);
                            bx.add((DHelper) lIIIIIlIllIl);
                        ...
                        if (ak.llIIllllIIll(Bank.contains((int[])nArray7) ? 1 : 0)) {
                            llIIIIIlIllIl = new DHelper(llllIIlIl[17], llllIIlIl[1], llllIIlIl[52]);
                            bx.add((DHelper) lIIIIIlIllIl);
                        ...
                        if (ak.llIIllllIIll(Bank.contains((int[])nArray8) ? 1 : 0)) {
                            llIIIIIlIllIl = new DHelper(llllIIlIl[20], llllIIlIl[1], llllIIlIl[53]);
                            bx.add((DHelper) lIIIIIlIllIl);
                        ...
                        if (ak.llIIllllIIlI(Skills.getLevel((Skill)Skill.RANGED), llllIIlIl[2])) {
                            ...
                            if (ak.llIIllllIIll(Bank.contains((int[])nArray9) ? 1 : 0)) {
                                llIIIIIlIllIl = new DHelper(llllIIlIl[16], llllIIlIl[54], llllIIlIl[43]);
                                bx.add((DHelper) lIIIIIlIllIl);
                        ...
                        if (ak.llIIllllIIll(Bank.contains((int[])nArray10) ? 1 : 0)) {
                            llIIIIIlIllIl = new DHelper(llllIIlIl[9], llllIIlIl[1], llllIIlIl[55]);
                            bx.add((DHelper) lIIIIIlIllIl);
                        ...
                        if (ak.llIIllllIIll(Bank.contains((int[])nArray11) ? 1 : 0)) {
                            llIIIIIlIllIl = new DHelper(llllIIlIl[10], llllIIlIl[1], llllIIlIl[55]);
                            bx.add((DHelper) lIIIIIlIllIl);
                        ...
                        if (ak.llIIllllIllI(Skills.getLevel((Skill)Skill.RANGED), llllIIlIl[2])) {
                            ...
                            if (ak.llIIllllIIll(Bank.contains((int[])nArray12) ? 1 : 0)) {
                                llIIIIIlIllIl = new DHelper(llllIIlIl[11], llllIIlIl[51], llllIIlIl[56]);
                                bx.add((DHelper) lIIIIIlIllIl);
                        ...
                        if (ak.llIIllllIIll(Bank.contains((int[])nArray13) ? 1 : 0)) {
                            llIIIIIlIllIl = new DHelper(llllIIlIl[22], llllIIlIl[1], j.ch);
                            bx.add((DHelper) lIIIIIlIllIl);
                        ...
                        if (ak.llIIllllIIll(Bank.contains((int[])nArray14) ? 1 : 0)) {
                            llIIIIIlIllIl = new DHelper(llllIIlIl[26], llllIIlIl[57], llllIIlIl[58]);
                            bx.add((DHelper) lIIIIIlIllIl);
                        ...
                        if (ak.llIIllllIIll(Bank.contains((Predicate)(llIIIIIlIllIl = item -> item.getName().toLowerCase().contains(llllIIlII[llllIIlIl[63]]))) ? 1 : 0)) {
                            llIIIIIlIllII = new DHelper(llllIIlIl[59], llllIIlIl[6], llllIIlIl[60]);
                    ...
                    llIIIIIlIllII = new DHelper(llllIIlIl[61], llllIIlIl[24], llllIIlIl[62]);
                    bx.add(llIIIIIlIllII);
            ...
            llIIIIIlIllII = new DHelper(llllIIlIl[23], llllIIlIl[24], llllIIlIl[62]);
            bx.add(llIIIIIlIllII);
