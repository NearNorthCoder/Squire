...
implements G {
    ...
    public static final  WorldArea jG;
    public static  int[] js;
    
    public static final  int jE;
    public static  boolean bt;
    public static final  WorldArea jH;
    ...
    public static void af() {
        ...
        if (T.lllIllIlIIlI(Bank.contains((int[])nArray) ? 1 : 0)) {
            d d2 = new DHelper(lIIIlIlllI[7], lIIIlIlllI[1], lIIIlIlllI[5]);
            bv.add(d2);
        ...
        if (T.lllIllIlIIlI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lIIllIIIllIl = new DHelper(lIIIlIlllI[8], lIIIlIlllI[1], lIIIlIlllI[5]);
            bv.add((DHelper) IIllIIIllIl);

        }
        int[] nArray3 = new int[lIIIlIlllI[1]];
        nArray3[T.lIIIlIlllI[0]] = lIIIlIlllI[9];
        if (T.lllIllIlIIlI(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lIIllIIIllIl = new DHelper(lIIIlIlllI[9], lIIIlIlllI[1], lIIIlIlllI[26]);
            bv.add((DHelper) IIllIIIllIl);
        ...
        if (T.lllIllIlIIlI(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lIIllIIIllIl = new DHelper(lIIIlIlllI[10], lIIIlIlllI[1], lIIIlIlllI[27]);
            bv.add((DHelper) IIllIIIllIl);
        ...
        if (T.lllIllIlIIlI(Bank.contains((int[])nArray5) ? 1 : 0)) {
            lIIllIIIllIl = new DHelper(lIIIlIlllI[11], lIIIlIlllI[1], lIIIlIlllI[28]);
            bv.add((DHelper) IIllIIIllIl);
        ...
        if (T.lllIllIlIIlI(Bank.contains((Predicate)(lIIllIIIllIl = item -> item.getName().toLowerCase().contains(lIIIlIllIl[lIIIlIlllI[36]]))) ? 1 : 0)) {
            lIIllIIIllII = new DHelper(lIIIlIlllI[29], lIIIlIlllI[12], lIIIlIlllI[28]);
            bv.add(lIIllIIIllII);
        ...
        if (T.lllIllIlIIlI(Bank.contains((int[])nArray6) ? 1 : 0)) {
            lIIllIIIllII = new DHelper(lIIIlIlllI[30], lIIIlIlllI[31], lIIIlIlllI[32]);
            bv.add(lIIllIIIllII);
    ...
    private static void lllIllIIllIl() {
        ...
        T.lIIIlIllIl[T.lIIIlIlllI[0]] = "Buying items";
        T.lIIIlIllIl[T.lIIIlIlllI[1]] = "Finished buying items, switching back to woodcutting";
        T.lIIIlIllIl[T.lIIIlIlllI[3]] = "Navigating to bank";
        T.lIIIlIllIl[T.lIIIlIlllI[4]] = "Opening bank";
        T.lIIIlIllIl[T.lIIIlIlllI[6]] = "Handling banking";
        T.lIIIlIllIl[T.lIIIlIlllI[12]] = "We are missing pickaxes, switching to BUYING";
        T.lIIIlIllIl[T.lIIIlIlllI[13]] = "Dropping logs";
        T.lIIIlIllIl[T.lIIIlIlllI[14]] = "Dropping logs";
        T.lIIIlIllIl[T.lIIIlIlllI[16]] = "Walking to trees";
        T.lIIIlIllIl[T.lIIIlIlllI[17]] = "Chopping";
        T.lIIIlIllIl[T.lIIIlIlllI[18]] = "Chopping logs";
        T.lIIIlIllIl[T.lIIIlIlllI[19]] = "Chop down";
        T.lIIIlIllIl[T.lIIIlIlllI[20]] = "Walking to oak trees";
        T.lIIIlIllIl[T.lIIIlIlllI[21]] = "Chopping oaks";
        T.lIIIlIllIl[T.lIIIlIlllI[22]] = "Chopping oak logs";
        T.lIIIlIllIl[T.lIIIlIlllI[15]] = "Chop down";
        T.lIIIlIllIl[T.lIIIlIlllI[34]] = "Woodcutting";
        T.lIIIlIllIl[T.lIIIlIlllI[36]] = "ring of wealth (";
    }
