...
extends Config {
    ...
    public static final /* synthetic */ String SUPPLIES;
    ...
    default public boolean hybrid() {
        return ((0xAC ^ 0xC7 ^ (0x6D ^ 0x55)) & (0x30 ^ 0x47 ^ (0x69 ^ 0x4D) ^ -" ".length())) != 0;
    }
    ...
    default public boolean addCoalBuffer() {
        return ((6 + 169 - 21 + 42 ^ 115 + 96 - 210 + 128) & (0xF9 ^ 0xA5 ^ (0x57 ^ 0x4E) ^ -" ".length())) != 0;
    }
}
