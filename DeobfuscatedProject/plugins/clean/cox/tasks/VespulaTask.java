...
extends CoxTaskBase {
    ...
    private static void llIlIllllIIllI() {
        ...
        aH.lIlIIIlllllI[aH.lIlIIIllllll[4]] = "Attack";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[2]] = "updating last safe!";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[3]] = "Enter";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[6]] = "Drink";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[7]] = "Take";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[8]] = "tendrils is null";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[9]] = "Are you sure you wish to log out?";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[10]] = "Yes.";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[11]] = "tendrils";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[12]] = "Pass";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[13]] = "Revitalisation";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[14]] = "Revitalisation";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[15]] = "Xeric's";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[16]] = "Prayer enhance";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[17]] = "trident";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[18]] = "sanguinesti";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[5]] = "Passage";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[19]] = "Enter";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[20]] = "Vespula";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[21]] = "Abyssal portal";
        aH.lIlIIIlllllI[aH.lIlIIIllllll[22]] = "Vespula";
    }
    ...
    public boolean cg() {
        ...
        if (aH.llIlIllllIlIlI(var1.bS.distanceTo(var1.ak.bs), lIlIIIllllll[2]) && aH.llIlIllllIlIIl(var1.dm() ? 1 : 0)) {
            return lIlIIIllllll[2];
        }
        var1.dl();

        var1.db();
        if (aH.llIlIllllIlIlI(var1.cq.getTickCount() - var1.dX, lIlIIIllllll[3]) && aH.llIlIllllIlIll(Prayers.getPoints())) {
            void var2;
            if (aH.llIlIllllIlIII(var2)) {
                return lIlIIIllllll[4];
            }
            var2.interact(lIlIIIlllllI[lIlIIIllllll[4]]);
            return lIlIIIllllll[2];
        }
        WorldPoint var3 = H.VESPULA_ATTACK_POINT.c(var1.ak);
        if (aH.llIlIllllIlIIl(var1.bS.getWorldLocation().equals((Object)var3) ? 1 : 0)) {
            System.out.println(lIlIIIlllllI[lIlIIIllllll[2]]);
            var1.dX = var1.cq.getTickCount();
            return lIlIIIllllll[2];
        }
    ...
    public List<Prayer> ci() {
        ...
        if (aH.llIlIllllIlIlI(var4.bS.distanceTo(var4.ak.bs), lIlIIIllllll[2])) {
            return null;
        }
    ...
    private boolean cS() {
        ...
        if (aH.llIlIllllIlIII(var7)) {
            Movement.setDestination((WorldPoint)var6.ak.bq.dx(lIlIIIllllll[5]).dy(lIlIIIllllll[5]));
            return lIlIIIllllll[2];
        }
        if (!aH.llIlIllllIlllI(var6.bS.isMoving() ? 1 : 0) || aH.llIlIllllIlIIl(var6.bS.isAnimating() ? 1 : 0)) {
            return lIlIIIllllll[4];
        }
    ...
    private boolean dl() {
        ...
        int var8 = Static.getClient().getVarbitValue(lIlIIIllllll[1]);
        if (aH.llIlIllllIlIll(var8)) {
            return lIlIIIllllll[4];
        }
    ...
    private boolean cU() {
        ...
        TileItem var10 = TileItems.getNearest(tileItem -> {
            int n2;
        ...
        if (aH.llIlIllllIlllI(Inventory.contains(item -> item.getName().startsWith(lIlIIIlllllI[lIlIIIllllll[14]])) ? 1 : 0)) {
            var10 = TileItems.getNearest(tileItem -> {
                int n2;
