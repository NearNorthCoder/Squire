...
extends Items {
    ...
    public static boolean a(List<Integer> list) {
        int[] nArray;
        Iterator<Integer> var1 = list.iterator();
        do {
            void var1_1;
            if (E.llIlIlIlIIllll(var1.hasNext() ? 1 : 0)) {
    ...
    public static boolean i(int ... nArray) {
        ...
        int var3 = lIlIIIIllllI[0];
        while (E.llIlIlIlIIlllI(var3, (int)var2)) {
            void var4;
            void var5 = var4[var3];
            int[] nArray3 = new int[lIlIIIIllllI[1]];
            nArray3[E.lIlIIIIllllI[0]] = var5;
