...
public class AWHelper
implements ac {
    
    public static final  int oA;
    public static  List<d> bv;
    static  String[] cE;
    public static final  WorldPoint oz;
    ...
    private static void llIIIIIlIlIlI() {
        ...
        aw.lllIIlIlIl[aw.lllIIlIllI[0]] = "Buying items";
        aw.lllIIlIlIl[aw.lllIIlIllI[1]] = "Finished buying items, switching back to construction";
        aw.lllIIlIlIl[aw.lllIIlIllI[2]] = "Navigating to bank";
        aw.lllIIlIlIl[aw.lllIIlIllI[3]] = "Castle Wars";
        aw.lllIIlIlIl[aw.lllIIlIllI[5]] = "Wear";
        aw.lllIIlIlIl[aw.lllIIlIllI[6]] = "Handling banking";
        aw.lllIIlIlIl[aw.lllIIlIllI[9]] = "We are missing rings, switching to BUYING";
        aw.lllIIlIlIl[aw.lllIIlIllI[11]] = "We are missing saw, switching to BUYING";
        aw.lllIIlIlIl[aw.lllIIlIllI[13]] = "We are missing hammer, switching to BUYING";
        aw.lllIIlIlIl[aw.lllIIlIllI[15]] = "We are missing house tab, switching to BUYING";
        aw.lllIIlIlIl[aw.lllIIlIllI[18]] = "We are missing nails, switching to BUYING";
        aw.lllIIlIlIl[aw.lllIIlIllI[20]] = "We are missing plank, switching to BUYING";
        aw.lllIIlIlIl[aw.lllIIlIllI[22]] = "We are missing oak planks, switching to BUYING";
        aw.lllIIlIlIl[aw.lllIIlIllI[29]] = "Equiping duel";
        aw.lllIIlIlIl[aw.lllIIlIllI[30]] = "Wear";
        aw.lllIIlIlIl[aw.lllIIlIllI[32]] = "Nav to house guy";
        aw.lllIIlIlIl[aw.lllIIlIllI[33]] = "Buy house";
        aw.lllIIlIlIl[aw.lllIIlIllI[34]] = "Estate agent";
        aw.lllIIlIlIl[aw.lllIIlIllI[36]] = "Entering portal";
        aw.lllIIlIlIl[aw.lllIIlIllI[37]] = "Build mode";
        aw.lllIIlIlIl[aw.lllIIlIllI[39]] = "Tele to house";
        aw.lllIIlIlIl[aw.lllIIlIllI[40]] = "Break";
        aw.lllIIlIlIl[aw.lllIIlIllI[41]] = "Turning on build mode";
        aw.lllIIlIlIl[aw.lllIIlIllI[16]] = "Yes";
        aw.lllIIlIlIl[aw.lllIIlIllI[43]] = "Building chair";
        aw.lllIIlIlIl[aw.lllIIlIllI[46]] = "Build";
        aw.lllIIlIlIl[aw.lllIIlIllI[48]] = "Removing";
        aw.lllIIlIlIl[aw.lllIIlIllI[49]] = "Remove";
        aw.lllIIlIlIl[aw.lllIIlIllI[27]] = "Yes";
        aw.lllIIlIlIl[aw.lllIIlIllI[51]] = "Building wood larder";
        aw.lllIIlIlIl[aw.lllIIlIllI[53]] = "Build";
        aw.lllIIlIlIl[aw.lllIIlIllI[55]] = "Removing";
        aw.lllIIlIlIl[aw.lllIIlIllI[56]] = "Remove";
        aw.lllIIlIlIl[aw.lllIIlIllI[57]] = "Yes";
        aw.lllIIlIlIl[aw.lllIIlIllI[58]] = "Build oak table";
        aw.lllIIlIlIl[aw.lllIIlIllI[61]] = "Build";
        aw.lllIIlIlIl[aw.lllIIlIllI[63]] = "Removing";
        aw.lllIIlIlIl[aw.lllIIlIllI[64]] = "Remove";
        aw.lllIIlIlIl[aw.lllIIlIllI[65]] = "Yes";
        aw.lllIIlIlIl[aw.lllIIlIllI[66]] = "Build oak larder";
        aw.lllIIlIlIl[aw.lllIIlIllI[67]] = "Remove";
        aw.lllIIlIlIl[aw.lllIIlIllI[68]] = "Build";
        aw.lllIIlIlIl[aw.lllIIlIllI[70]] = "Removing";
        aw.lllIIlIlIl[aw.lllIIlIllI[71]] = "Remove";
        aw.lllIIlIlIl[aw.lllIIlIllI[72]] = "Yes";
        aw.lllIIlIlIl[aw.lllIIlIllI[73]] = "Building rooms";
        aw.lllIIlIlIl[aw.lllIIlIllI[77]] = "View House Options";
        aw.lllIIlIlIl[aw.lllIIlIllI[79]] = "Viewer";
        aw.lllIIlIlIl[aw.lllIIlIllI[81]] = "Done";
        aw.lllIIlIlIl[aw.lllIIlIllI[83]] = "Add room";
        aw.lllIIlIlIl[aw.lllIIlIllI[84]] = "Kitchen";
        aw.lllIIlIlIl[aw.lllIIlIllI[85]] = "Done";
        aw.lllIIlIlIl[aw.lllIIlIllI[87]] = "Counter-clockwise";
        aw.lllIIlIlIl[aw.lllIIlIllI[88]] = "Done";
        aw.lllIIlIlIl[aw.lllIIlIllI[89]] = "View House Options";
        aw.lllIIlIlIl[aw.lllIIlIllI[90]] = "Viewer";
        aw.lllIIlIlIl[aw.lllIIlIllI[91]] = "Done";
        aw.lllIIlIlIl[aw.lllIIlIllI[93]] = "Add room";
        aw.lllIIlIlIl[aw.lllIIlIllI[94]] = "Dining room";
        aw.lllIIlIlIl[aw.lllIIlIllI[95]] = "Done";
        aw.lllIIlIlIl[aw.lllIIlIllI[96]] = "Counter-clockwise";
        aw.lllIIlIlIl[aw.lllIIlIllI[97]] = "Done";
        aw.lllIIlIlIl[aw.lllIIlIllI[86]] = "Build";
        aw.lllIIlIlIl[aw.lllIIlIllI[98]] = "View House Options";
        aw.lllIIlIlIl[aw.lllIIlIllI[99]] = "On";
        aw.lllIIlIlIl[aw.lllIIlIllI[80]] = "Iron nails";
        aw.lllIIlIlIl[aw.lllIIlIllI[104]] = "Teleport to house";
        aw.lllIIlIlIl[aw.lllIIlIllI[105]] = "Saw";
        aw.lllIIlIlIl[aw.lllIIlIllI[106]] = "Hammer";
        aw.lllIIlIlIl[aw.lllIIlIllI[107]] = "Plank";
        aw.lllIIlIlIl[aw.lllIIlIllI[108]] = "Plank";
        aw.lllIIlIlIl[aw.lllIIlIllI[109]] = "Iron nails";
        aw.lllIIlIlIl[aw.lllIIlIllI[110]] = "Teleport to house";
        aw.lllIIlIlIl[aw.lllIIlIllI[111]] = "Saw";
        aw.lllIIlIlIl[aw.lllIIlIllI[112]] = "Hammer";
        aw.lllIIlIlIl[aw.lllIIlIllI[113]] = "Plank";
        aw.lllIIlIlIl[aw.lllIIlIllI[114]] = "Plank";
        aw.lllIIlIlIl[aw.lllIIlIllI[115]] = "Teleport to house";
        aw.lllIIlIlIl[aw.lllIIlIllI[116]] = "Saw";
        aw.lllIIlIlIl[aw.lllIIlIllI[117]] = "Hammer";
        aw.lllIIlIlIl[aw.lllIIlIllI[118]] = "Teleport to house";
        aw.lllIIlIlIl[aw.lllIIlIllI[119]] = "Saw";
        aw.lllIIlIlIl[aw.lllIIlIllI[120]] = "Hammer";
        aw.lllIIlIlIl[aw.lllIIlIllI[92]] = "Construction";
        aw.lllIIlIlIl[aw.lllIIlIllI[135]] = "ring of wealth (";
        aw.lllIIlIlIl[aw.lllIIlIllI[136]] = "ring of dueling(";
        aw.lllIIlIlIl[aw.lllIIlIllI[137]] = "ring of dueling(";
        aw.lllIIlIlIl[aw.lllIIlIllI[140]] = "How can I get a house?";
        aw.lllIIlIlIl[aw.lllIIlIllI[141]] = "Yes please!";
    }
    ...
    private static void eI() {
        ...
        if (aw.llIIIIIllIIIl(Skills.getLevel((Skill)Skill.CONSTRUCTION), lllIIlIllI[18]) && aw.llIIIIIlIllIl(Skills.getLevel((Skill)Skill.CONSTRUCTION), lllIIlIllI[16]) && aw.llIIIIIlIllII(aw.eN() ? 1 : 0)) {
            ...
            if (aw.llIIIIIlIllll(TileObjects.getNearest((int[])nArray))) {
                ...
                if (aw.llIIIIIlIlllI(Widgets.get((int)lllIIlIllI[44]).isEmpty() ? 1 : 0) && aw.llIIIIIlIllll(var1 = Widgets.get((int)lllIIlIllI[44], (int)lllIIlIllI[5]))) {
                    Mouse.click((int)var1.getChild(lllIIlIllI[9]).getClickPoint().getX(), (int)var1.getChild(lllIIlIllI[9]).getClickPoint().getY(), (boolean)lllIIlIllI[1]);
                    Time.sleepUntil(() -> {
                        boolean bl;
                        int[] nArray = new int[lllIIlIllI[1]];
                        nArray[aw.lllIIlIllI[0]] = lllIIlIllI[50];
        ...
        if (aw.llIIIIIllIIIl(Skills.getLevel((Skill)Skill.CONSTRUCTION), lllIIlIllI[16]) && aw.llIIIIIlIllIl(Skills.getLevel((Skill)Skill.CONSTRUCTION), lllIIlIllI[57]) && aw.llIIIIIlIllII(aw.eN() ? 1 : 0)) {
            ...
            if (aw.llIIIIIlIllll(TileObjects.getNearest((int[])nArray))) {
                if (aw.llIIIIIlIlllI(Widgets.get((int)lllIIlIllI[44]).isEmpty() ? 1 : 0) && aw.llIIIIIlIllll(var1 = Widgets.get((int)lllIIlIllI[44], (int)lllIIlIllI[6]))) {
                    Mouse.click((int)var1.getChild(lllIIlIllI[5]).getClickPoint().getX(), (int)var1.getChild(lllIIlIllI[5]).getClickPoint().getY(), (boolean)lllIIlIllI[1]);
                    Time.sleepUntil(() -> {
                        boolean bl;
                        int[] nArray = new int[lllIIlIllI[1]];
    ...
    private static void Q() {
        ...
        block24: {
            block23: {
                block21: {
                        ...
                        block17: {
                            block20: {
                                block19: {
                                    ...
                                    var4 = new DHelper(lllIIlIllI[19], lllIIlIllI[121], e.c(lllIIlIllI[122], lllIIlIllI[123]));
                                    bv.add((DHelper) ar4);
                            ...
                            var4 = new DHelper(lllIIlIllI[17], lllIIlIllI[23], lllIIlIllI[67]);
                            bv.add((DHelper) ar4);
                    ...
                    var4 = new DHelper(lllIIlIllI[21], lllIIlIllI[124], lllIIlIllI[125]);
                    bv.add((DHelper) ar4);
            ...
            var4 = new DHelper(lllIIlIllI[14], lllIIlIllI[126], lllIIlIllI[127]);
            bv.add((DHelper) ar4);
        ...
        if (aw.llIIIIIlIlllI(Bank.contains((int[])nArray) ? 1 : 0)) {
            var4 = new DHelper(lllIIlIllI[12], lllIIlIllI[1], lllIIlIllI[128]);
            bv.add((DHelper) ar4);
        ...
        if (aw.llIIIIIlIlllI(Bank.contains((int[])nArray10) ? 1 : 0)) {
            var4 = new DHelper(lllIIlIllI[10], lllIIlIllI[1], lllIIlIllI[128]);
            bv.add((DHelper) ar4);

        }
        if (aw.llIIIIIlIlllI(Bank.contains((Predicate)(var4 = item -> item.getName().toLowerCase().contains(lllIIlIlIl[lllIIlIllI[136]]))) ? 1 : 0)) {
            var3 = new DHelper(lllIIlIllI[28], lllIIlIllI[39], lllIIlIllI[129]);
            bv.add((DHelper) ar3);

        }
        if (aw.llIIIIIlIlllI(Bank.contains(var3 = item -> item.getName().toLowerCase().contains(lllIIlIlIl[lllIIlIllI[135]])) ? 1 : 0)) {
            var2 = new DHelper(lllIIlIllI[130], lllIIlIllI[2], lllIIlIllI[26]);
            bv.add(var2);
        ...
        if (aw.llIIIIIlIlllI(Bank.contains((int[])nArray11) ? 1 : 0)) {
            var2 = new DHelper(lllIIlIllI[131], lllIIlIllI[67], lllIIlIllI[132]);
            bv.add(var2);
            ...
            block40: {
                block41: {
                    block42: {
                        ...
                        if (aw.llIIIIIlIllll(var6) && aw.llIIIIIlIlllI(var6.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (!aw.llIIIIIlIllll(var6) || !aw.llIIIIIlIllII(var6.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block40;
                        ...
                        if (aw.llIIIIIlIlllI(Bank.contains(var7 = item -> item.getName().toLowerCase().contains(lllIIlIlIl[lllIIlIllI[137]])) ? 1 : 0)) {
                            aw.Q();
            ...
            if (aw.llIIIIIlIllII(aw.an() ? 1 : 0)) {
                ...
                if (aw.llIIIIIlIllII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    if (aw.llIIIIIlIlllI(Equipment.contains((int[])nArray10) ? 1 : 0)) {
                        ...
                        var6 = Inventory.getFirst((int[])nArray11);
                        if (aw.llIIIIIlIllll(var6)) {
                            var6.interact(lllIIlIlIl[lllIIlIllI[30]]);
                            Time.sleepTicks((int)lllIIlIllI[3]);
