...
import s.o.r.e.i.t.h.-.z.n.g.u.r.e.m.e.n.i.a.-.q.c;
...
extends Config {
    ...
    default public boolean perfectFlick() {
        return ((219 + 111 - 303 + 193 ^ 148 + 174 - 216 + 87) & (0x5E ^ 2 ^ (0x81 ^ 0xC0) ^ -" ".length())) != 0;
    }
    ...
    default public boolean protectFromMelee() {
        return ((0x41 ^ 0x15 ^ (0x6A ^ 7)) & (0xD5 ^ 0xA7 ^ (0x57 ^ 0x1C) ^ -" ".length())) != 0;
    }
