...
extends NightmareTaskBase {
    ...
    public boolean ci() {
        ...
        if (R.lIIIlllIlllllII(var2)) {
            return llllIIIlIIlI[0];
        }
        if (R.lIIIlllIlllllIl(Movement.shouldWalk() ? 1 : 0)) {
            return llllIIIlIIlI[0];
        }
        if (R.lIIIlllIllllIll(Inventory.contains(var1.ck()) ? 1 : 0)) {
            return llllIIIlIIlI[0];
        }
        BankLocation var3 = BankLocation.getNearest();
        if (R.lIIIlllIllllllI(var3.getArea().distanceTo(var2.getWorldLocation()), llllIIIlIIlI[1])) {
            Movement.walkTo((WorldPoint)var3.getArea().getCenter());
    ...
    private static void lIIIlllIllllIIl() {
        ...
        R.llllIIIlIIII[R.llllIIIlIIlI[0]] = "[GetTeleportToGE]: We don't have a proper teleport to GE";
        R.llllIIIlIIII[R.llllIIIlIIlI[2]] = "[GetTeleportToGE]: Prefer house: {}";
        R.llllIIIlIIII[R.llllIIIlIIlI[4]] = "Ring of wealth (";
        R.llllIIIlIIII[R.llllIIIlIIlI[5]] = "Amulet of Glory (";
    }
