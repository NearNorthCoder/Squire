...
public class LHelper {
    ...
    public static void ah() {
        ...
        if (l.lIIllIllIIllI(worldArea.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (!l.lIIllIllIIllI(Players.getLocal().getWorldLocation().equals((Object)worldPoint3) ? 1 : 0) || l.lIIllIllIIlll(Players.getLocal().getWorldLocation().equals((Object)worldPoint4) ? 1 : 0)) {
                var2 = new WorldPoint(lIllIlllll[12], lIllIlllll[13], lIllIlllll[4]);
                e.c(var2);
                Time.sleepUntil(() -> Players.getLocal().getWorldLocation().equals((Object)var2), (int)lIllIlllll[14]);
        ...
        List var4 = Players.getAll(arg_0 -> l.a((WorldArea)var1, arg_0));
        if (l.lIIllIllIIlll(var1.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && l.lIIllIllIlIII(var4.size(), lIllIlllll[16])) {
            void var5;
            if (l.lIIllIllIlIIl(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var5), lIllIlllll[17])) {
            ...
            if (l.lIIllIllIlIlI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var5), lIllIlllll[17])) {
                AccBuilderShamans.c = lIllIllllI[lIllIlllll[17]];
                e.B();
            }
        }
        if (l.lIIllIllIIlll(var1.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && l.lIIllIllIlIll(var4.size(), lIllIlllll[16])) {
            NPC var6;
            ...
            if (l.lIIllIllIllIl(Players.getLocal().getInteracting()) && l.lIIllIllIlllI(Players.getLocal().getHealthRatio(), lIllIlllll[21])) {
                ...
                if (l.lIIllIllIllIl(var6)) {
                    var6.interact(lIllIllllI[lIllIlllll[22]]);
                ...
                if (l.lIIllIllIllIl(var2) && l.lIIllIllIllll(var6)) {
                    AccBuilderShamans.c = lIllIllllI[lIllIlllll[16]];
                    var2.interact(lIllIllllI[lIllIlllll[23]]);
                    Time.sleepTicks((int)lIllIlllll[17]);
            ...
            if (l.lIIllIllIllll(Players.getLocal().getInteracting())) {
                ...
                if (l.lIIllIllIllIl(var6) && l.lIIllIllIllll(var2)) {
                    AccBuilderShamans.c = lIllIllllI[lIllIlllll[24]];
                    var6.interact(lIllIllllI[lIllIlllll[25]]);
                    Time.sleepTicks((int)lIllIlllll[17]);
    ...
    private static void lIIllIllIIIll() {
        ...
        l.lIllIllllI[l.lIllIlllll[4]] = "Nav to hill giants";
        l.lIllIllllI[l.lIllIlllll[15]] = "Run to hop tile";
        l.lIllIllllI[l.lIllIlllll[17]] = "World hopping";
        l.lIllIllllI[l.lIllIlllll[19]] = "Eat";
        l.lIllIllllI[l.lIllIlllll[20]] = "In combat";
        l.lIllIllllI[l.lIllIlllll[22]] = "Attack";
        l.lIllIllllI[l.lIllIlllll[16]] = "Attacking hill giant";
        l.lIllIllllI[l.lIllIlllll[23]] = "Attack";
        l.lIllIllllI[l.lIllIlllll[24]] = "Attacking hill giant";
        l.lIllIllllI[l.lIllIlllll[25]] = "Attack";
        l.lIllIllllI[l.lIllIlllll[26]] = "Hill";
        l.lIllIllllI[l.lIllIlllll[27]] = "Hill";
        l.lIllIllllI[l.lIllIlllll[28]] = "Hill";
        l.lIllIllllI[l.lIllIlllll[29]] = "Hill";
    }
