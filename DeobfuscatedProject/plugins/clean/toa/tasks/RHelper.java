...
extends ToaTaskBase {
    ...
    private void b(Graphics2D graphics2D) {
        ...
        Iterator<NPC> var2 = var1.ax.e().iterator();
        while (r.lIllIllIlIIllll(var2.hasNext() ? 1 : 0)) {
            void var3;
            NPC var4 = var2.next();
            Shape var5 = var4.getConvexHull();
            if (r.lIllIllIlIlIIII(var5)) {

                if (-1 < ((0x98 ^ 0xC6 ^ (0xD4 ^ 0x8C)) & (119 + 122 - 80 + 25 ^ 157 + 169 - 215 + 77 ^ -1))) continue;
                return;
            }
            OverlayUtil.renderPolygon((Graphics2D)var3, (Shape)var5, (Color)Color.BLUE, (Stroke)new BasicStroke(1.0f));
