...
import q.s.r.i.e.s.o.u.a.d.n.-.b.c;
...
extends Config {
    ...
    default public boolean turnOffRun() {
        return ((0x73 ^ 0x4E ^ (0x17 ^ 0x2F)) & (97 + 48 - 100 + 85 ^ 29 + 0 - -96 + 10 ^ -" ".length())) != 0;
    }
    ...
    default public boolean pickupCannon() {
        return ((0xB ^ 0x60 ^ (0x79 ^ 0x20)) & (0x2C ^ 5 ^ (0xDA ^ 0xC1) ^ -" ".length())) != 0;
    }
    ...
    default public boolean useBlowpipe() {
        return ((94 + 10 - 12 + 45 ^ 152 + 67 - 112 + 65) & (0x21 ^ 0x24 ^ (3 ^ 0x23) ^ -" ".length())) != 0;
    }
}
