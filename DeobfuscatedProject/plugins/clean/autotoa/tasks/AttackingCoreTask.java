...
extends AutotoaTaskBase {
    ...
    private static void lIIllIIlllIIlI() {
        ...
        bA.lIlllIllIIl[bA.lIlllIllIlI[0]] = "Wield";
        bA.lIlllIllIIl[bA.lIlllIllIlI[6]] = "Drink";
        bA.lIlllIllIIl[bA.lIlllIllIlI[4]] = "Attack";
        bA.lIlllIllIIl[bA.lIlllIllIlI[16]] = "Core projectile spawned";
        bA.lIlllIllIIl[bA.lIlllIllIlI[17]] = "Core";
        bA.lIlllIllIIl[bA.lIlllIllIlI[19]] = "Warden";
        bA.lIlllIllIIl[bA.lIlllIllIlI[20]] = "Attack";
    }
    ...
    public boolean bl() {
        ...
        if (!bA.lIIllIIlllIllI(var2.getAnimation(), lIlllIllIlI[1]) || bA.lIIllIIlllIlll(var2.getAnimation(), lIlllIllIlI[2])) {
            var1.fU = lIlllIllIlI[3];
            return lIlllIllIlI[0];
        }
        ...
        if ((!bA.lIIllIIlllIlIl(var3) || bA.lIIllIIllllIII(n2)) && bA.lIIllIIllllIIl(var1.cu.getTickCount() - var1.fU, lIlllIllIlI[8] + (var1.fV - lIlllIllIlI[6]) * lIlllIllIlI[9])) {
            if (bA.lIIllIIllllIlI(n2)) {
                var3.interact(lIlllIllIIl[lIlllIllIlI[0]]);
            ...
            boolean bl2;
            if (bA.lIIllIIllllIlI(var1.cW.overlyDraining() ? 1 : 0)) {
                bl2 = lIlllIllIlI[6];
            ...
            boolean var4 = var1.e(bl2);
        }
        if (bA.lIIllIIllllIlI(var1.aZ() ? 1 : 0) && bA.lIIllIIllllIIl(var1.aY(), lIlllIllIlI[10]) && bA.lIIllIIllllIlI(var1.cW.overlyDraining() ? 1 : 0)) {
            int[] nArray3 = new int[lIlllIllIlI[4]];
            nArray3[bA.lIlllIllIlI[0]] = lIlllIllIlI[11];
            nArray3[bA.lIlllIllIlI[6]] = lIlllIllIlI[12];
            Item var4 = Inventory.getFirst((int[])nArray3);
            if (bA.lIIllIIllllIll(var4)) {
                var4.interact(lIlllIllIIl[lIlllIllIlI[6]]);
            }
        }
        int[] nArray4 = new int[lIlllIllIlI[6]];
        nArray4[bA.lIlllIllIlI[0]] = lIlllIllIlI[13];
        NPC var4 = NPCs.getNearest((int[])nArray4);
        if (bA.lIIllIIlllIlIl(var4)) {
