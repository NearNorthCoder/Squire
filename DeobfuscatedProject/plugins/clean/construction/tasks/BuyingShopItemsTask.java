...
extends Task {
    ...
    private static void lllllIlIl() {
        ...
        bV.lIIIIIlI[bV.lIIIIIll[0]] = "Starting location set to {}";
        bV.lIIIIIlI[bV.lIIIIIll[1]] = "Updating the starting location as we seem to have moved a bit.";
        bV.lIIIIIlI[bV.lIIIIIll[7]] = "Hopping to world {}";
        bV.lIIIIIlI[bV.lIIIIIll[9]] = "We're far away from the shop location, walking back.";
        bV.lIIIIIlI[bV.lIIIIIll[10]] = "Walking to {}";
        bV.lIIIIIlI[bV.lIIIIIll[5]] = "Trade";
        bV.lIIIIIlI[bV.lIIIIIll[2]] = "Trade";
        bV.lIIIIIlI[bV.lIIIIIll[11]] = "Buy-food";
        bV.lIIIIIlI[bV.lIIIIIll[4]] = "Reached end of BuyShopItem with no action taken.";
