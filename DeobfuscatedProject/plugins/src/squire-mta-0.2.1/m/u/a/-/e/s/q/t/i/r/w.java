...
extends Task {
    ...
    private static void lIIIllIIIIIIIlI() {
        ...
        w.lllIlIlIIllI[0] = (42 + 171 - 180 + 184 ^ 122 + 118 - 126 + 30) & (45 + 181 - 14 + 7 ^ 70 + 58 - 35 + 53 ^ -" ".length());
        w.lllIlIlIIllI[1] = " ".length();
        w.lllIlIlIIllI[2] = "  ".length();
        w.lllIlIlIIllI[3] = "   ".length();
    ...
    private static void lIIIllIIIIIIIIl() {
        ...
        w.lllIlIlIIlIl[w.lllIlIlIIllI[0]] = w.lIIIlIllllllllI("KhE68bLQjpY=", "LDnBB");
        w.lllIlIlIIlIl[w.lllIlIlIIllI[1]] = w.lIIIlIllllllllI("MWltfNhOGic=", "zYnuK");
        w.lllIlIlIIlIl[w.lllIlIlIIllI[2]] = w.lIIIlIlllllllll("4kHqB+IUoDX/ohxVjY8MU1PX1ueOJgOym/hJ0feG7II=", "Viycd");
        w.lllIlIlIIlIl[w.lllIlIlIIllI[3]] = w.lIIIllIIIIIIIII("PB0pGyw=", "ktLwH");
        w.lllIlIlIIlIl[w.lllIlIlIIllI[4]] = w.lIIIlIlllllllll("qa3Zu1GWNn5y8eUs/lRFyA==", "CFSVo");
    }
