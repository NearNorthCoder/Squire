...
extends w<e> {
    ...
    private static void lIIIlIllllIIlll() {
        ...
        r.lllIlIIlllll[r.lllIlIlIIIII[1]] = r.lIIIlIllllIIlII("OK0Bc900PgZx8I5wrwV5/Q==", "rnswI");
        r.lllIlIIlllll[r.lllIlIlIIIII[2]] = r.lIIIlIllllIIlIl("H0zE23G3/iQ=", "FLINg");
        r.lllIlIIlllll[r.lllIlIlIIIII[3]] = r.lIIIlIllllIIllI("LgMMCkQuAwkIAQ4YChY=", "mledd");
        r.lllIlIIlllll[r.lllIlIlIIIII[6]] = r.lIIIlIllllIIlIl("uV2lHLdDtH9U0/PGPJAAtTvGyA3WRXE7", "AMYze");
        r.lllIlIIlllll[r.lllIlIlIIIII[7]] = r.lIIIlIllllIIlII("/eyqFv13o0SIMaqTM6yzZDiKUcPJ7m9u", "lBZzD");
        r.lllIlIIlllll[r.lllIlIlIIIII[8]] = r.lIIIlIllllIIllI("HBgHACQ+GA==", "IvlnK");
        r.lllIlIIlllll[r.lllIlIlIIIII[9]] = r.lIIIlIllllIIlII("tg7USPpC4hI=", "wZRjo");
    }
        ...
        if (r.lIIIlIllllIllIl(Inventory.isFull() ? 1 : 0)) {
            Item lllllllllllllllIIllIllIlIllIIIIl = Inventory.getFirst(item -> Stream.of(d.values()).anyMatch(d2 -> {
                ...
                if (r.lIIIlIllllIllll(d2.i(), item.getId())) {
                    ...
                    "".length();
                    if (-"  ".length() > 0) {
                        return ((0xF4 ^ 0x9D ^ (0xC2 ^ 0xB6)) & (115 + 55 - 65 + 43 ^ 134 + 4 - 93 + 92 ^ -" ".length())) != 0;
                    }
                } else {
                    bl = lllIlIlIIIII[1];
                }
