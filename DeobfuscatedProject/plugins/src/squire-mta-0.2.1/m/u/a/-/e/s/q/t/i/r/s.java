...
extends Task {
    ...
    private static void lIIIllIIlIllIlI() {
        ...
        s.lllIlIlllllI[0] = (73 + 112 - 77 + 19 ^ (0x37 ^ 0xE)) & (" ".length() ^ (0x36 ^ 0x71) ^ -" ".length());
        ...
        s.lllIlIlllllI[6] = " ".length();
        s.lllIlIlllllI[7] = "  ".length();
        s.lllIlIlllllI[8] = "   ".length();
    ...
    private static void lIIIllIIlIlIlIl() {
        ...
        s.lllIlIllllII[s.lllIlIlllllI[0]] = s.lIIIllIIlIlIlII("/pZd1g1z3nsHpI8LcgUjP4WNpBo3o8SfhyG+n9k+7ZUxirxZgH5TDpF5NQHzUAtF/pZd1g1z3nuTrEtw0KYiYbBwNbwfCathezWrgrpL/VN14RipWFKedputAK3XF1f9IVcUuUnyc0E=", "UoikC");
    }
