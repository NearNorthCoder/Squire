...
extends Enum<c> {
    ...
    private static void lIIIllIIlllIIIl() {
        ...
        c.lllIllIIIllI[1] = ("   ".length() ^ (0x46 ^ 0x1C)) & (5 + 23 - -81 + 43 ^ 107 + 52 - 19 + 53 ^ -" ".length());
        c.lllIllIIIllI[2] = " ".length();
        c.lllIllIIIllI[3] = (0x39 ^ 0x36) + (40 + 139 - 150 + 122) - (44 + 9 - -62 + 30) + (82 + 91 - 47 + 49);
        c.lllIllIIIllI[4] = "  ".length();
        c.lllIllIIIllI[5] = "   ".length();
    ...
    private static void lIIIllIIlllIIII() {
        ...
        c.lllIllIIIlIl[c.lllIllIIIllI[1]] = c.lIIIllIIllIllIl("NxAOORQpAx0r", "pBOoQ");
        c.lllIllIIIlIl[c.lllIllIIIllI[2]] = c.lIIIllIIllIlllI("buRAeRV14npHPh7vv64YIk4ZSxpfVm/F", "JNhHn");
        c.lllIllIIIlIl[c.lllIllIIIllI[4]] = c.lIIIllIIllIllll("2JelLiWpmjT/DcBS2AEMcQ==", "Rmtsq");
        c.lllIllIIIlIl[c.lllIllIIIllI[5]] = c.lIIIllIIllIllIl("MCQVLxINLxw+EAdhLS8VATEWOA0=", "dAyJy");
        c.lllIllIIIlIl[c.lllIllIIIllI[7]] = c.lIIIllIIllIllIl("ACcSDAgMMg==", "AkQDM");
        c.lllIllIIIlIl[c.lllIllIIIllI[8]] = c.lIIIllIIllIlllI("H/Z4PsXo76wlRYWnpTaZ0ssylfmY0TDu", "faxnR");
        c.lllIllIIIlIl[c.lllIllIIIllI[0]] = c.lIIIllIIllIlllI("nVfxLn73ZOtK3DY3oTgayw==", "zVorW");
        c.lllIllIIIlIl[c.lllIllIIIllI[10]] = c.lIIIllIIllIlllI("efUcEVmRJ87eLJFPCN+3nTBA9maI9b9n", "xjNQW");
    }
