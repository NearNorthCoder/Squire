...
extends Enum<i> {
    ...
    private static void lIIIllIIllIIlll() {
        ...
        i.lllIllIIIIII[i.lllIllIIIIlI[0]] = i.lIIIllIIllIIIII("hGYoSCRIDEs=", "WAseb");
        i.lllIllIIIIII[i.lllIllIIIIlI[1]] = i.lIIIllIIllIIIIl("GRA6Jg==", "ZeXCA");
        i.lllIllIIIIII[i.lllIllIIIIlI[4]] = i.lIIIllIIllIIIIl("EwUnLngAGSku", "PpEKX");
        i.lllIllIIIIII[i.lllIllIIIIlI[5]] = i.lIIIllIIllIIIlI("h9pVmcJT5JnYHCOtRa2JYQ==", "MLnmk");
        i.lllIllIIIIII[i.lllIllIIIIlI[6]] = i.lIIIllIIllIIIII("5gbmT0E7o+RE8WFW7OlYNw==", "fqCnR");
        i.lllIllIIIIII[i.lllIllIIIIlI[8]] = i.lIIIllIIllIIIlI("8MEaH4mCNdir98uotwHtPg==", "nkIPy");
        i.lllIllIIIIII[i.lllIllIIIIlI[9]] = i.lIIIllIIllIIIlI("6Y3Qy+pCdM+IwWLyPNIkEw==", "IvVfz");
        i.lllIllIIIIII[i.lllIllIIIIlI[10]] = i.lIIIllIIllIIIlI("C6T6C6KbXFaeDoiu46MGlQ==", "kDzaB");
        i.lllIllIIIIII[i.lllIllIIIIlI[12]] = i.lIIIllIIllIIIlI("NKqov1riXy9Spuv8ZBQGBg==", "TkThv");
        i.lllIllIIIIII[i.lllIllIIIIlI[13]] = i.lIIIllIIllIIIlI("gxvUz9tPAw/c7rRifhvFyA==", "nfZVX");
        i.lllIllIIIIII[i.lllIllIIIIlI[3]] = i.lIIIllIIllIIIlI("EocvAIUj8ihShUNX3rzFDg==", "qtzsq");
        i.lllIllIIIIII[i.lllIllIIIIlI[15]] = i.lIIIllIIllIIIlI("EWx0fQ0PJrogDYn4UcCHZoj05efVJ3tN", "OfLpn");
    }
    ...
    private static void lIIIllIIllIlIII() {
        ...
        i.lllIllIIIIlI[0] = (124 + 88 - 68 + 4 ^ 179 + 28 - 79 + 52) & (0x72 ^ 0x57 ^ (4 ^ 1) ^ -" ".length());
        i.lllIllIIIIlI[1] = " ".length();
        i.lllIllIIIIlI[2] = 14 + 75 - -62 + 44;
        i.lllIllIIIIlI[3] = 0x25 ^ 0x2F;
        i.lllIllIIIIlI[4] = "  ".length();
        i.lllIllIIIIlI[5] = "   ".length();
