...
extends Task {
            ...
            lllllllllllllllIIIlllIllIIIIllIl = TileObjects.getNearest(tileObject -> {
                ...
                if (d.lIIlIlllllIlIII(tileObject.getName().contains(lIIIIIIlIllII[lIIIIIIlIlllI[24]]) ? 1 : 0) && d.lIIlIlllllIllII(tileObject.getWorldLocation().distanceTo(Players.getLocal().getWorldLocation()), lIIIIIIlIlllI[17])) {
                    ...
                    if (-(63 + 46 - 14 + 47 ^ 109 + 130 - 106 + 6) >= 0) {
                        return ((0x54 ^ 0x40 ^ (0x3F ^ 0x12)) & (63 + 109 - 80 + 69 ^ 110 + 21 - -4 + 17 ^ -" ".length())) != 0;
                    }
                } else {
                    n = lIIIIIIlIlllI[4];
                }
    ...
    private static void lIIlIlllllIIlII() {
        ...
        d.lIIIIIIlIllII[d.lIIIIIIlIlllI[4]] = d.lIIlIllllIllIll("vYz10+TNot8nvm7w37fm/g==", "KGszy");
        d.lIIIIIIlIllII[d.lIIIIIIlIlllI[12]] = d.lIIlIllllIlllII("Bw0HEVUpGRwEGQ==", "Jlltx");
        d.lIIIIIIlIllII[d.lIIIIIIlIlllI[18]] = d.lIIlIllllIllIll("VTEU/WY8Y1qGDbivc7Ypmw==", "MHBBn");
        d.lIIIIIIlIllII[d.lIIIIIIlIlllI[19]] = d.lIIlIllllIlllII("ABQuIDUrGT8=", "EzZRT");
        d.lIIIIIIlIllII[d.lIIIIIIlIlllI[20]] = d.lIIlIllllIlllII("AzwdIwcvPA5mESk9Gw==", "FRiFu");
        d.lIIIIIIlIllII[d.lIIIIIIlIlllI[17]] = d.lIIlIllllIlllII("CDAmGUQsOScFHD85", "XQUji");
        d.lIIIIIIlIllII[d.lIIIIIIlIlllI[21]] = d.lIIlIllllIlllll("SZ2HIuL3giYaexsLGBE18w==", "acAWf");
        d.lIIIIIIlIllII[d.lIIIIIIlIlllI[22]] = d.lIIlIllllIlllII("AQ8DDAorDQVFBCoGERE=", "Bcbeg");
        d.lIIIIIIlIllII[d.lIIIIIIlIlllI[23]] = d.lIIlIllllIllIll("4+7J6F6cIXY=", "bxaDm");
        d.lIIIIIIlIllII[d.lIIIIIIlIlllI[24]] = d.lIIlIllllIlllll("SDlIk3ECWpJFXlKZd17scA==", "LBsYt");
    }
    ...
    private static void lIIlIlllllIIlIl() {
        ...
        d.lIIIIIIlIlllI[4] = (95 + 29 - 65 + 142 ^ 90 + 114 - 127 + 70) & (0x4B ^ 0x47 ^ (0xDD ^ 0x8B) ^ -" ".length());
        ...
        d.lIIIIIIlIlllI[18] = "  ".length();
        d.lIIIIIIlIlllI[19] = "   ".length();
        d.lIIIIIIlIlllI[20] = 0x8C ^ 0x88;
        d.lIIIIIIlIlllI[21] = "   ".length() ^ (0x67 ^ 0x62);
