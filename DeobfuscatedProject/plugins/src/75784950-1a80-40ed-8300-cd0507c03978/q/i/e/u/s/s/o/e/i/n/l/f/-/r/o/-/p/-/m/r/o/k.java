...
extends Task {
    ...
    private static void lIIlIlllIIlIIIl() {
        ...
        k.lIIIIIIIlllll[1] = " ".length();
        k.lIIIIIIIlllll[2] = "  ".length();
        k.lIIIIIIIlllll[3] = "   ".length();
        ...
        k.lIIIIIIIlllll[58] = "   ".length() ^ (0x5E ^ 0x70);
        ...
        k.lIIIIIIIlllll[79] = "  ".length() ^ (0x73 ^ 0x30);
        ...
        k.lIIIIIIIlllll[109] = 0x2E ^ 0x78 ^ "  ".length();
    ...
    private static void lIIlIlllIIIIllI() {
        ...
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[0]] = k.lIIlIlllIIIIIll("CRclOzwtHyIhcCMKPzdwNBk5ITU=", "DxJUP");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[1]] = k.lIIlIlllIIIIIll("KhUVNB4OHRIuUhcVDjMdCVJLcw==", "gzzZr");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[2]] = k.lIIlIlllIIIIlII("Pa3VdwKX/TNMXbCv/AqRxTahE1/myvAl", "rvGTC");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[3]] = k.lIIlIlllIIIIlII("lPlIERZnJ052pGOyMCCdaHnEMpHsU1LC", "vBaou");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[4]] = k.lIIlIlllIIIIlII("+vcAXRsdw6lLa+pOsIcl9V66g2m2IhlK", "ZnUdh");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[5]] = k.lIIlIlllIIIIIll("IQ0iFHUYAmMPNAMBMQ==", "wdCxU");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[6]] = k.lIIlIlllIIIIIll("BSIiNGs8LWMvKicuMQ==", "SKCXK");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[7]] = k.lIIlIlllIIIIlII("N3G/8NLCkZ8=", "EPuaQ");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[9]] = k.lIIlIlllIIIIlIl("tyovTnBxK3aZX7rMlprnDQ==", "JXQSn");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[10]] = k.lIIlIlllIIIIIll("PBY4PU4SAiMoAg==", "qwSXc");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[13]] = k.lIIlIlllIIIIlIl("QalTiWSwB5fBgH7wytM2M/8U4p86svDz", "OtJVX");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[14]] = k.lIIlIlllIIIIlIl("+5ZsKVTUxis7HbPWrqQClU+aBbBoe571", "YGpNa");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[15]] = k.lIIlIlllIIIIlIl("ggtzK8CzmCDTjBLokRqY7A==", "UnfsH");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[18]] = k.lIIlIlllIIIIlIl("ajECgZRS7JZpOhFwr3w4eGS6AkVlXZxD", "CWUYB");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[19]] = k.lIIlIlllIIIIlII("wR7+VXbtSIIHaYILSKcE9eiG7sxbnS7/", "yWteA");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[20]] = k.lIIlIlllIIIIlII("b4O2B8QbyIJDUPos2DUEyA==", "yFoJY");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[23]] = k.lIIlIlllIIIIIll("NgUBaDIXRAQ8NB0FGiopDQoTaCIXCwU=", "xdwHF");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[24]] = k.lIIlIlllIIIIlIl("JTzIv2evVX7a7wG0QYx3G8GmXgYoP4eU", "zaaGv");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[25]] = k.lIIlIlllIIIIlII("Uh6a2gq29WL+yWqc5XBpzA==", "HFcAQ");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[26]] = k.lIIlIlllIIIIIll("DjEyIQ==", "XXSMo");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[27]] = k.lIIlIlllIIIIlII("lnJJq/10CAw=", "qDoxB");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[28]] = k.lIIlIlllIIIIlIl("J7UtKAh91rs=", "UEpGR");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[29]] = k.lIIlIlllIIIIlII("UlSnQTg+YN2WllgarMSxIw==", "govWo");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[30]] = k.lIIlIlllIIIIlII("WoRSM9nb+T8BdWrIug9/0Q==", "AbxoD");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[31]] = k.lIIlIlllIIIIlIl("UjBP9gkz8TA=", "ndTIr");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[32]] = k.lIIlIlllIIIIlIl("ZPOB+EYbqk+eLIw/1e42aA==", "qytFE");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[33]] = k.lIIlIlllIIIIlIl("SsuatwuUMWQvoxo8owX7JQ==", "dyqPz");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[34]] = k.lIIlIlllIIIIlII("6pBHNH7Dl74=", "NoMZt");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[37]] = k.lIIlIlllIIIIlIl("+mr3M4Q2NA3tSMCXbNdBlw==", "plNDf");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[38]] = k.lIIlIlllIIIIIll("CBIsZSsqBTplEDoHKCkKKgQ=", "OwXEc");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[39]] = k.lIIlIlllIIIIIll("PzwmAykVaTUBJBgsJQ==", "lIVsE");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[40]] = k.lIIlIlllIIIIIll("OA4bKzkcBhwxdRITASd1BQAHMTA=", "uatEU");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[41]] = k.lIIlIlllIIIIIll("GiokCT8+IiMTczA3PgU=", "WEKgS");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[42]] = k.lIIlIlllIIIIlII("LNBoS2+NhbOmCRxGhAGZ6w==", "gknTe");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[43]] = k.lIIlIlllIIIIIll("Hx0gKyI7FScxbjUAOic=", "RrOEN");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[48]] = k.lIIlIlllIIIIlII("j8jI6enZ2Ph8YgCzu48Md+JT3W0jhHwC", "vXyNt");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[49]] = k.lIIlIlllIIIIIll("MyY/MAEGLiU/RBM1PjoX", "tGKXd");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[50]] = k.lIIlIlllIIIIIll("PQUzDyADVzUMMhYeKAo=", "zwFmB");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[51]] = k.lIIlIlllIIIIlII("qdlVnFVp6IpJTjmHPdniRw==", "DsSNx");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[52]] = k.lIIlIlllIIIIlII("ooy0uNWoJ5JpU6+hE5HO2A==", "PEQam");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[53]] = k.lIIlIlllIIIIIll("Cj89GC4uNzoCYiAiJxQ=", "GPRvB");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[54]] = k.lIIlIlllIIIIIll("JyMQIyoNPwJwJRYkByM=", "dQePB");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[55]] = k.lIIlIlllIIIIlII("Cer7m7XKpEuoKevlEq0biA==", "TyNAK");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[56]] = k.lIIlIlllIIIIlIl("4ufbEbia82cffdScBCuPz7LKN526l6Mp", "eXrlT");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[57]] = k.lIIlIlllIIIIlIl("9DNCzWo2DbbfM2MI8VCUqg==", "qGanp");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[58]] = k.lIIlIlllIIIIlII("J2SpZaQqgMxsLyWtgebs9Q==", "QTrPO");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[59]] = k.lIIlIlllIIIIlII("JU3ltQqa56Y+ac13rzGdHNb6gupyUThY", "Rasfh");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[60]] = k.lIIlIlllIIIIIll("PBsmNAkRByh6Fh0I", "xiOZb");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[61]] = k.lIIlIlllIIIIIll("ISA8HE4PNCcJAg==", "lAWyc");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[62]] = k.lIIlIlllIIIIlII("y6CtJyV+TkXbQyyqkpoQKWva5WEoNKhQ", "btxPg");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[63]] = k.lIIlIlllIIIIIll("IDc0IggeMWc0DwQkJj8CFQ==", "pVGQa");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[64]] = k.lIIlIlllIIIIIll("JgA2JmACCTc6OBEJ", "vaEUM");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[65]] = k.lIIlIlllIIIIlII("Z9/N+wbzDRJE5K6MaSwob8Z+uRINPWpn", "zeukK");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[66]] = k.lIIlIlllIIIIlIl("DwbQK+uA7ta+l9zkhZUflSp9hzoKkixS", "tQQiq");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[67]] = k.lIIlIlllIIIIIll("Ny0rJ1gTJCo7AAAk", "gLXTu");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[68]] = k.lIIlIlllIIIIlIl("d7WkjfekHZq+YeMauahruwAggoQT3D92", "UOVEK");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[69]] = k.lIIlIlllIIIIlII("oau/brb8qfvaeOXYgwRASxMb5M1dDFnp", "IZKPO");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[70]] = k.lIIlIlllIIIIlII("+Ei+tev9geLw5HR2scV7eg==", "bSbeB");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[71]] = k.lIIlIlllIIIIlII("kLME/gpPfm6UnVdoL1GnMg==", "XRAQY");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[73]] = k.lIIlIlllIIIIIll("HSQfYSc8ZRo0IyMpACQg", "SEiAS");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[74]] = k.lIIlIlllIIIIIll("MAEEcSwSEA==", "wdpQB");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[75]] = k.lIIlIlllIIIIlIl("lxbV0DhyQk5IU1/Wcqkfmg==", "xvWQf");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[76]] = k.lIIlIlllIIIIlIl("fFuYHXTBgSD8rjbQXgho97i0aojpdZxp", "vDfKp");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[77]] = k.lIIlIlllIIIIlIl("dN/K0YYTYn8=", "BeTmT");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[78]] = k.lIIlIlllIIIIlII("m2gMRK0gNxk=", "oBOnf");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[79]] = k.lIIlIlllIIIIlII("Y6zA0IeE/E54f+XXxDxZJw==", "MzGpd");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[80]] = k.lIIlIlllIIIIlII("5ZReqXhkByiqVvHyumEdLQ==", "ghvkx");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[81]] = k.lIIlIlllIIIIlII("VcGROkj3tw4pXUnwX5Pbnw==", "EsSQy");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[82]] = k.lIIlIlllIIIIIll("MB4EIgodFks6FxwHDg==", "sqkIc");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[83]] = k.lIIlIlllIIIIlII("/Ra9QLOgkTc=", "wCCqk");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[8]] = k.lIIlIlllIIIIlIl("VLFHYDJxc40NTVfod6P6eQ==", "vkFVE");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[84]] = k.lIIlIlllIIIIlIl("dInnhcjCHPw=", "eyqoQ");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[85]] = k.lIIlIlllIIIIIll("JCI4IDMPLyk=", "aLLRR");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[86]] = k.lIIlIlllIIIIlIl("X9CvUaKYgk0JTTTrCNh5Xw==", "hQHgL");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[87]] = k.lIIlIlllIIIIlIl("avBowm+b2nT2rM58tvOD/Q==", "LKYdx");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[88]] = k.lIIlIlllIIIIIll("NxwnBjEaFGgeLBsFLQ==", "tsHmX");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[89]] = k.lIIlIlllIIIIIll("FQ8ZFyM+Agg=", "PameB");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[90]] = k.lIIlIlllIIIIIll("NB0fCgkfEA4=", "qskxh");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[91]] = k.lIIlIlllIIIIlIl("Qfa5s1BDtNstZTZtxPQUsw==", "ajTwu");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[92]] = k.lIIlIlllIIIIlII("R3F/G6Yvh6NtXQCderhoCg==", "zQJyA");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[93]] = k.lIIlIlllIIIIlIl("DOWFAX7+pHgei1IemnWUtPKRiC0QfTWo", "jJNdN");
        k.lIIIIIIIllllI[k.lIIIIIIIlllll[94]] = k.lIIlIlllIIIIlII("Rr6SyiQFdmxFA+xPYWsGB20X49ZJ7Jy/", "wKxnQ");
    }
    ...
    private static void i() {
        ...
        TileObject tileObject2 = TileObjects.getNearest(tileObject -> {
            ...
            if (k.lIIlIlllIIlIIll(tileObject.getName().contains(lIIIIIIIllllI[lIIIIIIIlllll[88]]) ? 1 : 0) && k.lIIlIlllIIlllll(tileObject.getWorldLocation().distanceTo(Players.getLocal().getWorldLocation()), lIIIIIIIlllll[5])) {
                ...
                "".length();
                if (-"  ".length() >= 0) {
                    return ((0x52 ^ 0x3E ^ (0x21 ^ 0x6D)) & (140 + 106 - 216 + 140 ^ 36 + 11 - 3 + 94 ^ -" ".length())) != 0;
                }
            } else {
                n = lIIIIIIIlllll[0];
            }
        ...
        if (k.lIIlIlllIIlIIll(au.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            lllllllllllllllIIIllllIlIlIIlIII = TileObjects.getNearest(tileObject -> {
                ...
                if (k.lIIlIlllIIlIIll(tileObject.getName().contains(lIIIIIIIllllI[lIIIIIIIlllll[87]]) ? 1 : 0) && k.lIIlIlllIIlllll(tileObject.getWorldLocation().distanceTo(lllllllllllllllIIIllllIlIlIIlIIl), lIIIIIIIlllll[5])) {
                    n = lIIIIIIIlllll[1];
                    "".length();
                    if (((0x30 ^ 0x7A ^ (0xAA ^ 0x83)) & (0xE7 ^ 0xB0 ^ (0xF4 ^ 0xC0) ^ -" ".length())) > 0) {
                        return ((76 + 92 - 2 + 70 ^ 6 + 64 - -53 + 59) & (0x7E ^ 0x20 ^ (3 ^ 7) ^ -" ".length())) != 0;
                    }
                } else {
                    n = lIIIIIIIlllll[0];
                }
        ...
        if (k.lIIlIlllIIlIIll(as.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            lllllllllllllllIIIllllIlIlIIlIII = TileObjects.getNearest(tileObject -> {
                ...
                if (k.lIIlIlllIIlIIll(tileObject.getName().contains(lIIIIIIIllllI[lIIIIIIIlllll[85]]) ? 1 : 0) && k.lIIlIlllIIlllll(tileObject.getWorldLocation().distanceTo(lllllllllllllllIIIllllIlIlIIlIIl), lIIIIIIIlllll[7])) {
                    ...
                    "".length();
                    if ("  ".length() < "  ".length()) {
                        return ((29 + 156 - 91 + 121 ^ 92 + 102 - 84 + 47) & (151 + 184 - 272 + 139 ^ 116 + 70 - 117 + 59 ^ -" ".length())) != 0;
                    }
                } else {
                    n = lIIIIIIIlllll[0];
                }
    ...
    public static boolean j() {
        ...
        if (!k.lIIlIlllIIlllIl(ap.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !k.lIIlIlllIIlllIl(aq.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !k.lIIlIlllIIlllIl(Q.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || k.lIIlIlllIIlIIll(K.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            "".length();
            if (null != null) {
                return ((0xCB ^ 0xA7 ^ (0x41 ^ 0x7C)) & (0x48 ^ 0x76 ^ (0x7C ^ 0x13) ^ -" ".length())) != 0;
            }
        } else {
            n = lIIIIIIIlllll[0];
        }
