...
extends Task {
    ...
    private static void lIIlIllllIllIlI() {
        ...
        i.lIIIIIIlIlIll[i.lIIIIIIlIllIl[4]] = i.lIIlIllllIllIII("LRc2PicKWDsnJw8V", "nxYUB");
        i.lIIIIIIlIlIll[i.lIIIIIIlIllIl[12]] = i.lIIlIllllIllIIl("MDdbt3A7OXyZZxYKyWOcqQ==", "zDDKw");
        i.lIIIIIIlIlIll[i.lIIIIIIlIllIl[13]] = i.lIIlIllllIllIII("IDE8", "ePHOz");
        i.lIIIIIIlIlIll[i.lIIIIIIlIllIl[14]] = i.lIIlIllllIllIIl("lVRTKvRMwTLbx9W2ICxtNA==", "dZIpm");
        i.lIIIIIIlIlIll[i.lIIIIIIlIllIl[15]] = i.lIIlIllllIllIII("EgYjGQYk", "ArBms");
        i.lIIIIIIlIlIll[i.lIIIIIIlIllIl[16]] = i.lIIlIllllIllIIl("iGLFZ8xFxfQ=", "fsQhm");
    }
    ...
    private static void lIIlIllllIlllIl() {
        ...
        i.lIIIIIIlIllIl[12] = " ".length();
        i.lIIIIIIlIllIl[13] = "  ".length();
        i.lIIIIIIlIllIl[14] = "   ".length();
