...
extends Task {
    ...
    private static void lIIlIllIllIlIII() {
        ...
        f.lIIIIIIIllIlI[0] = " ".length();
        f.lIIIIIIIllIlI[1] = (130 + 137 - 141 + 33 ^ 122 + 20 - -39 + 0) & (30 + 88 - 56 + 74 ^ 152 + 136 - 286 + 160 ^ -" ".length());
        f.lIIIIIIIllIlI[2] = "  ".length();
        f.lIIIIIIIllIlI[3] = "   ".length();
    ...
    private static void lIIlIllIllIIllI() {
        ...
        f.lIIIIIIIllIII[f.lIIIIIIIllIlI[1]] = f.lIIlIllIllIIIll("AwANHA==", "Uilpy");
        f.lIIIIIIIllIII[f.lIIIIIIIllIlI[0]] = f.lIIlIllIllIIIll("GAQnKw==", "NmFGw");
        f.lIIIIIIIllIII[f.lIIIIIIIllIlI[2]] = f.lIIlIllIllIIlII("babD6SBXuZE=", "Ygpuc");
        f.lIIIIIIIllIII[f.lIIIIIIIllIlI[3]] = f.lIIlIllIllIIlII("B7weJAZX/tkKFPAGuDt+5Q==", "NvNGh");
        f.lIIIIIIIllIII[f.lIIIIIIIllIlI[4]] = f.lIIlIllIllIIlIl("P9GrPxPmAeE=", "qaDdN");
        f.lIIIIIIIllIII[f.lIIIIIIIllIlI[5]] = f.lIIlIllIllIIIll("LDUZOjsO", "iTmSU");
        f.lIIIIIIIllIII[f.lIIIIIIIllIlI[6]] = f.lIIlIllIllIIIll("DA48KgcrQTEzBy4M", "OaSAb");
        f.lIIIIIIIllIII[f.lIIIIIIIllIlI[7]] = f.lIIlIllIllIIlII("zuVo/kS/UB0=", "ALBZM");
    }
