...
extends Task {
    ...
    private static void lIIlIlllIIIlIII() {
        ...
        b.lIIIIIIlIIIII[4] = (0xC3 ^ 0x8C ^ (0xBE ^ 0xB3)) & (83 + 131 - 97 + 121 ^ 47 + 44 - -41 + 40 ^ -" ".length());
        ...
        b.lIIIIIIlIIIII[8] = " ".length();
        b.lIIIIIIlIIIII[9] = 0xFFFFD7F3 & 0x2D7F;
        b.lIIIIIIlIIIII[10] = 0xFFFFEDFF & 0x379E;
        b.lIIIIIIlIIIII[11] = "  ".length();
        b.lIIIIIIlIIIII[12] = "   ".length();
    ...
    private static void lIIlIlllIIIIlll() {
        ...
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[4]] = b.lIIlIlllIIIIIII("e9FLQqUE3fBGdGMFxA/43w==", "MlZrd");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[8]] = b.lIIlIlllIIIIIIl("XUlBZoNjYLHt9BXQPzqxWA==", "koyKt");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[11]] = b.lIIlIlllIIIIIIl("dwRToSNNp6A=", "gMSUZ");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[12]] = b.lIIlIlllIIIIIlI("LyQbGS0IaxYALQ0m", "lKtrH");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[5]] = b.lIIlIlllIIIIIII("iS8NvP8R+bpNx60Q4brhoTPtZ+Bsbpu5", "znNdM");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[26]] = b.lIIlIlllIIIIIIl("ncR/xKblhIizlR2Vz2+e3w==", "rFoQt");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[27]] = b.lIIlIlllIIIIIII("00PONEgp8+VT2X/Djyr4XiAm+sAolhyE", "DyKRH");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[29]] = b.lIIlIlllIIIIIIl("pSNCBGcgrY1TsJ/D9eo3Lg==", "EAebi");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[30]] = b.lIIlIlllIIIIIlI("AAMuPh0=", "DqGPv");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[32]] = b.lIIlIlllIIIIIII("j++J232qnEo=", "QydFj");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[33]] = b.lIIlIlllIIIIIIl("+2gpBk0F1W+R3OVaN0U5oY6AV6K//opi", "pQmWO");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[34]] = b.lIIlIlllIIIIIlI("OBYzMGUBFmUmJBMcZSY1Gg0=", "uyEUE");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[37]] = b.lIIlIlllIIIIIII("2Qr/aiunSnv8lv/SLoqOL5Zn43gOhMXe", "wyKYj");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[38]] = b.lIIlIlllIIIIIIl("96yGwCuLeRo=", "FzUUp");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[39]] = b.lIIlIlllIIIIIIl("mKP+H56MDZBeqhxrRMSqBA==", "yYgsb");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[40]] = b.lIIlIlllIIIIIII("M7c8SiXm9fk=", "bKnJO");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[43]] = b.lIIlIlllIIIIIIl("4rmN1+O/6zyGMSrRAdT0c5Y0Cv8onbGh", "DceCo");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[44]] = b.lIIlIlllIIIIIII("VxPTpxoH9C1qnTEPDtBP3cMN+Dzo3ZCe", "Vdudx");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[45]] = b.lIIlIlllIIIIIlI("BTspEQIl", "VOHxp");
        b.lIIIIIIIlllIl[b.lIIIIIIlIIIII[46]] = b.lIIlIlllIIIIIIl("c3tzJl8/M9wBQOT+qtzcAA==", "gEcio");
    }
    ...
    private static /* synthetic */ boolean a(Set set, WorldPoint worldPoint) {
        ...
        if (b.lIIlIlllIIIllII(Reachable.isWalkable((WorldPoint)worldPoint) ? 1 : 0) && b.lIIlIlllIIIlIll(set.contains(worldPoint) ? 1 : 0)) {
            ...
            "".length();
            if (null != null) {
                return ((" ".length() ^ (0x1B ^ 7)) & (58 + 167 - 164 + 128 ^ 75 + 70 - 33 + 48 ^ -" ".length())) != 0;
            }
        } else {
            n = lIIIIIIlIIIII[4];
        }
    ...
    public boolean run() {
        WorldPoint lllllllllllllllIIIllllIlllIllIlI;
        List lllllllllllllllIIIllllIlllIllIll;
        TileObject lllllllllllllllIIIllllIlllIlllII2;
        b lllllllllllllllIIIllllIllllIIIII;
        if (b.lIIlIlllIIIlIll(this.a(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            return lIIIIIIlIIIII[4];
        }
        if (b.lIIlIlllIIIlIll(lllllllllllllllIIIllllIllllIIIII.b().isFullyEquipped() ? 1 : 0)) {
            if (b.lIIlIlllIIIllII(Inventory.isFull() ? 1 : 0)) {
                ...
                if (b.lIIlIlllIIIllII(Inventory.contains((String[])stringArray) ? 1 : 0) && b.lIIlIlllIIIllIl(Equipment.fromSlot((EquipmentInventorySlot)EquipmentInventorySlot.SHIELD)) && b.lIIlIlllIIIlllI(lllllllllllllllIIIllllIllllIIIII.b().get(EquipmentInventorySlot.SHIELD))) {
            ...
            lllllllllllllllIIIllllIllllIIIII.b().swap();
        }
        NPC lllllllllllllllIIIllllIlllIlllll = NPCs.getNearest(nPC -> {
            int n;
        ...
        NPC lllllllllllllllIIIllllIlllIllllI = NPCs.getNearest(nPC -> {
            int n;
        ...
        TileObject lllllllllllllllIIIllllIlllIlllIl = TileObjects.getNearest((int[])nArray);
        String[] stringArray = new String[lIIIIIIlIIIII[8]];
        stringArray[b.lIIIIIIlIIIII[4]] = lIIIIIIIlllIl[lIIIIIIlIIIII[12]];
        if (b.lIIlIlllIIIlIll(Inventory.contains((String[])stringArray) ? 1 : 0) && b.lIIlIlllIIIllll(lllllllllllllllIIIllllIlllIlllll) && b.lIIlIlllIIIllll(lllllllllllllllIIIllllIlllIlllIl) && b.lIIlIlllIIlIIII(b.lIIlIlllIIIlIIl(Combat.getHealthPercent(), 40.0))) {
        ...
        if (b.lIIlIlllIIIllll(lllllllllllllllIIIllllIlllIlllll) && b.lIIlIlllIIIllIl(lllllllllllllllIIIllllIlllIllllI)) {
            int lllllllllllllllIIIllllIlllIlllII2 = lllllllllllllllIIIllllIllllIIIII.b(lllllllllllllllIIIllllIlllIllllI.getWorldLocation()) ? 1 : 0;
            if (b.lIIlIlllIIIlIll(lllllllllllllllIIIllllIlllIlllII2)) {
                SquireMoonsOfPeril.g = lIIIIIIIlllIl[lIIIIIIlIIIII[27]];
                Movement.setDestination((WorldPoint)lllllllllllllllIIIllllIlllIllllI.getWorldLocation());
                return lIIIIIIlIIIII[4];
            }
            if (b.lIIlIlllIIIllII(lllllllllllllllIIIllllIlllIlllII2)) {
                ...
                lllllllllllllllIIIllllIlllIllIll = NPCs.getNearest((int[])nArray2);
                if (b.lIIlIlllIIIllIl(lllllllllllllllIIIllllIlllIllIll)) {
                    ...
                    lllllllllllllllIIIllllIlllIllIll.interact(lIIIIIIIlllIl[lIIIIIIlIIIII[32]]);
                    return lIIIIIIlIIIII[8];
                }
            }
        }
        if (b.lIIlIlllIIIllll(lllllllllllllllIIIllllIlllIlllll) && b.lIIlIlllIIIllIl(lllllllllllllllIIIllllIlllIlllIl)) {
            lllllllllllllllIIIllllIlllIlllII2 = lllllllllllllllIIIllllIllllIIIII.c();
            lllllllllllllllIIIllllIlllIllIll = Players.getLocal().getWorldLocation().createWorldArea(lIIIIIIlIIIII[27]).toWorldPointList();
            lllllllllllllllIIIllllIlllIllIlI = lllllllllllllllIIIllllIlllIllIll.stream().filter(arg_0 -> b.a((Set)lllllllllllllllIIIllllIlllIlllII2, arg_0)).min(Comparator.comparingInt(worldPoint -> worldPoint.distanceTo(Players.getLocal().getWorldLocation()))).orElse(null);
            if (b.lIIlIlllIIIlIll(lllllllllllllllIIIllllIlllIlllII2.isEmpty() ? 1 : 0) && b.lIIlIlllIIIllIl(lllllllllllllllIIIllllIlllIllIlI)) {
                SquireMoonsOfPeril.g = lIIIIIIIlllIl[lIIIIIIlIIIII[33]];
                Movement.setDestination((WorldPoint)lllllllllllllllIIIllllIlllIllIlI);
                return lIIIIIIlIIIII[4];
            }
        }
        if (b.lIIlIlllIIIllIl(lllllllllllllllIIIllllIlllIlllll) && b.lIIlIlllIIIllIl(lllllllllllllllIIIllllIlllIllllI)) {
            int lllllllllllllllIIIllllIlllIlllII2 = lllllllllllllllIIIllllIllllIIIII.b(lllllllllllllllIIIllllIlllIllllI.getWorldLocation()) ? 1 : 0;
            if (b.lIIlIlllIIIlIll(lllllllllllllllIIIllllIlllIlllII2)) {
            ...
            if (b.lIIlIlllIIIllII(lllllllllllllllIIIllllIlllIlllII2)) {
                Object lllllllllllllllIIIllllIlllIllIII;
                int[] nArray4 = new int[lIIIIIIlIIIII[8]];
                nArray4[b.lIIIIIIlIIIII[4]] = lIIIIIIlIIIII[35];
                lllllllllllllllIIIllllIlllIllIll = NPCs.getNearest((int[])nArray4);
                int[] nArray5 = new int[lIIIIIIlIIIII[8]];
                nArray5[b.lIIIIIIlIIIII[4]] = lIIIIIIlIIIII[25];
                lllllllllllllllIIIllllIlllIllIlI = TileObjects.getNearest((int[])nArray5);
                if (b.lIIlIlllIIIllIl(lllllllllllllllIIIllllIlllIllIlI)) {
                    int lllllllllllllllIIIllllIlllIllIIl = b.a((TileObject)lllllllllllllllIIIllllIlllIllIlI);
                    if (b.lIIlIlllIIlIlII(lllllllllllllllIIIllllIlllIllIIl, lIIIIIIlIIIII[36])) {
                        ++lllllllllllllllIIIllllIllllIIIII.p;
                    }
                    if (b.lIIlIlllIIlIlIl(b.lIIlIlllIIIlIlI(lllllllllllllllIIIllllIllllIIIII.p, 3L))) {
                        int[] nArray6 = new int[lIIIIIIlIIIII[8]];
                        nArray6[b.lIIIIIIlIIIII[4]] = lIIIIIIlIIIII[25];
                        lllllllllllllllIIIllllIlllIllIII = TileObjects.getNearest((int[])nArray6);
                        if (b.lIIlIlllIIIllIl(lllllllllllllllIIIllllIlllIllIII)) {
                            SquireMoonsOfPeril.g = lIIIIIIIlllIl[lIIIIIIlIIIII[37]];
                            Movement.setDestination((WorldPoint)lllllllllllllllIIIllllIlllIllIII.getWorldLocation());
                            Time.sleepTicks((int)lIIIIIIlIIIII[8]);
                            "".length();
                            lllllllllllllllIIIllllIllllIIIII.p = 0L;
                            return lIIIIIIlIIIII[8];
                        }
                    }
                }
                if (b.lIIlIlllIIIllIl(lllllllllllllllIIIllllIlllIllIll)) {
                    List lllllllllllllllIIIllllIlllIllIIl;
                    String[] stringArray3 = new String[lIIIIIIlIIIII[8]];
                    stringArray3[b.lIIIIIIlIIIII[4]] = lIIIIIIIlllIl[lIIIIIIlIIIII[38]];
                    if (b.lIIlIlllIIIllII(Equipment.contains((String[])stringArray3) ? 1 : 0) && b.lIIlIlllIIllIII(Players.getLocal().getWorldLocation().distanceTo(lllllllllllllllIIIllllIlllIllIll.getWorldLocation()), lIIIIIIlIIIII[8]) && b.lIIlIlllIIIlIll((lllllllllllllllIIIllllIlllIllIII = (lllllllllllllllIIIllllIlllIllIIl = Tiles.getAll().stream().filter(arg_0 -> b.b((NPC)lllllllllllllllIIIllllIlllIllIll, arg_0)).collect(Collectors.toList())).stream().filter(arg_0 -> lllllllllllllllIIIllllIllllIIIII.a((NPC)lllllllllllllllIIIllllIlllIllIll, arg_0)).collect(Collectors.toList())).isEmpty() ? 1 : 0)) {
                        Movement.setDestination((WorldPoint)((Tile)lllllllllllllllIIIllllIlllIllIII.get(lIIIIIIlIIIII[4])).getWorldLocation());
                        return lIIIIIIlIIIII[4];
                    }
                    SquireMoonsOfPeril.g = lIIIIIIIlllIl[lIIIIIIlIIIII[39]];
                    lllllllllllllllIIIllllIlllIllIll.interact(lIIIIIIIlllIl[lIIIIIIlIIIII[40]]);
                    return lIIIIIIlIIIII[8];
                }
            }
        }
    ...
    private static String lIIlIlllIIIIIII(String lllllllllllllllIIIllllIllIlIlIlI, String lllllllllllllllIIIllllIllIlIIlll) {
        try {
            SecretKeySpec lllllllllllllllIIIllllIllIlIllIl = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIIllllIllIlIIlll.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIIIllllIllIlIllII = Cipher.getInstance("Blowfish");
            lllllllllllllllIIIllllIllIlIllII.init(lIIIIIIlIIIII[11], lllllllllllllllIIIllllIllIlIllIl);
            return new String(lllllllllllllllIIIllllIllIlIllII.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIllllIllIlIlIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIIlIlllIIIIIIl(String lllllllllllllllIIIllllIllIIIIlIl, String lllllllllllllllIIIllllIllIIIIlII) {
        try {
            SecretKeySpec lllllllllllllllIIIllllIllIIIlIII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIIllllIllIIIIlII.getBytes(StandardCharsets.UTF_8)), lIIIIIIlIIIII[30]), "DES");
            Cipher lllllllllllllllIIIllllIllIIIIlll = Cipher.getInstance("DES");
            lllllllllllllllIIIllllIllIIIIlll.init(lIIIIIIlIIIII[11], lllllllllllllllIIIllllIllIIIlIII);
            return new String(lllllllllllllllIIIllllIllIIIIlll.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIllllIllIIIIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private boolean b(WorldPoint worldPoint) {
        ...
        Iterator<List> lllllllllllllllIIIllllIlllIIlIll = Arrays.asList(listArray).iterator();
        while (b.lIIlIlllIIIllII(lllllllllllllllIIIllllIlllIIlIll.hasNext() ? 1 : 0)) {
            void lllllllllllllllIIIllllIlllIIllII;
            List lllllllllllllllIIIllllIlllIIlIlI = lllllllllllllllIIIllllIlllIIlIll.next();
            if (b.lIIlIlllIIIllII(lllllllllllllllIIIllllIlllIIlIlI.contains(lllllllllllllllIIIllllIlllIIllII) ? 1 : 0) && b.lIIlIlllIIIllII(lllllllllllllllIIIllllIlllIIlIlI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                return lIIIIIIlIIIII[8];
            }
            "".length();
            if (" ".length() >= 0) continue;
            return ((0xAB ^ 0x8A ^ (0xDA ^ 0xB6)) & (178 + 134 - 230 + 134 ^ 32 + 96 - 122 + 143 ^ -" ".length())) != 0;
        }
        return lIIIIIIlIIIII[4];
    }
    ...
    private static String lIIlIlllIIIIIlI(String lllllllllllllllIIIllllIllIIllIlI, String lllllllllllllllIIIllllIllIIllIIl) {
        lllllllllllllllIIIllllIllIIllIlI = new String(Base64.getDecoder().decode(lllllllllllllllIIIllllIllIIllIlI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIIllllIllIIllIII = new StringBuilder();
        char[] lllllllllllllllIIIllllIllIIlIlll = lllllllllllllllIIIllllIllIIllIIl.toCharArray();
        int lllllllllllllllIIIllllIllIIlIllI = lIIIIIIlIIIII[4];
        char[] lllllllllllllllIIIllllIllIIlIIII = lllllllllllllllIIIllllIllIIllIlI.toCharArray();
        int lllllllllllllllIIIllllIllIIIllll = lllllllllllllllIIIllllIllIIlIIII.length;
        int lllllllllllllllIIIllllIllIIIlllI = lIIIIIIlIIIII[4];
        while (b.lIIlIlllIIlllII(lllllllllllllllIIIllllIllIIIlllI, lllllllllllllllIIIllllIllIIIllll)) {
            char lllllllllllllllIIIllllIllIIllIll = lllllllllllllllIIIllllIllIIlIIII[lllllllllllllllIIIllllIllIIIlllI];
            lllllllllllllllIIIllllIllIIllIII.append((char)(lllllllllllllllIIIllllIllIIllIll ^ lllllllllllllllIIIllllIllIIlIlll[lllllllllllllllIIIllllIllIIlIllI % lllllllllllllllIIIllllIllIIlIlll.length]));
            "".length();
            ++lllllllllllllllIIIllllIllIIlIllI;
            ++lllllllllllllllIIIllllIllIIIlllI;
            "".length();
            if ((0xB5 ^ 0xA5 ^ (0x98 ^ 0x8C)) >= 0) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllIIIllllIllIIllIII);
    }
