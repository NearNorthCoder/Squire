...
extends SquirePlugin {
    ...
    private static void lIIlIllIllllIlI() {
        ...
        SquireMoonsOfPeril.lIIIIIIIllIll[SquireMoonsOfPeril.lIIIIIIIlllII[1]] = SquireMoonsOfPeril.lIIlIllIlllIlll("Yo8tbJ2bcbBi/ESdRJk+w+QN315LEx8v", "AyCEu");
        SquireMoonsOfPeril.lIIIIIIIllIll[SquireMoonsOfPeril.lIIIIIIIlllII[2]] = SquireMoonsOfPeril.lIIlIllIllllIII("LlrPew5EFTY=", "OPzvI");
        SquireMoonsOfPeril.lIIIIIIIllIll[SquireMoonsOfPeril.lIIIIIIIlllII[3]] = SquireMoonsOfPeril.lIIlIllIllllIII("n9fbIpwHljAycPw+YRGIXnq4V4W5M4Fm", "rJvvK");
        SquireMoonsOfPeril.lIIIIIIIllIll[SquireMoonsOfPeril.lIIIIIIIlllII[4]] = SquireMoonsOfPeril.lIIlIllIllllIIl("eFt0eA==", "IuEIq");
    }
    ...
    private static void lIIlIllIllllIll() {
        ...
        SquireMoonsOfPeril.lIIIIIIIlllII[1] = (59 + 180 - 67 + 48 ^ 58 + 123 - 168 + 128) & (0x40 ^ 0x1C ^ (0x1E ^ 0x13) ^ -" ".length());
        SquireMoonsOfPeril.lIIIIIIIlllII[2] = " ".length();
        SquireMoonsOfPeril.lIIIIIIIlllII[3] = "  ".length();
        SquireMoonsOfPeril.lIIIIIIIlllII[4] = "   ".length();
