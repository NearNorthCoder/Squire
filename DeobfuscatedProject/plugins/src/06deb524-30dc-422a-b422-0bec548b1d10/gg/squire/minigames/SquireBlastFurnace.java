...
extends SquirePlugin {
    ...
    private static void llIIlllIIllIIl() {
        ...
        SquireBlastFurnace.lIIllIIlIIlI[2] = " ".length();
        SquireBlastFurnace.lIIllIIlIIlI[3] = "  ".length();
        SquireBlastFurnace.lIIllIIlIIlI[4] = "   ".length();
    ...
    private static void llIIlllIIllIII() {
        ...
        SquireBlastFurnace.lIIllIIlIIIl[SquireBlastFurnace.lIIllIIlIIlI[0]] = SquireBlastFurnace.llIIlllIIlIlIl("JRYyARozBSE=", "VgGhh");
        SquireBlastFurnace.lIIllIIlIIIl[SquireBlastFurnace.lIIllIIlIIlI[2]] = SquireBlastFurnace.llIIlllIIlIlIl("NAMOdQkaGhB1HwcKQjIfEBxCOh4BAEIhGBBPAToeAwobOgJVDQc5BFs=", "uobUp");
        SquireBlastFurnace.lIIllIIlIIIl[SquireBlastFurnace.lIIllIIlIIlI[3]] = SquireBlastFurnace.llIIlllIIlIllI("FViSeIJZzz0=", "Xouyo");
        SquireBlastFurnace.lIIllIIlIIIl[SquireBlastFurnace.lIIllIIlIIlI[4]] = SquireBlastFurnace.llIIlllIIlIlll("wNfoZa3hY44=", "lpeex");
    }
