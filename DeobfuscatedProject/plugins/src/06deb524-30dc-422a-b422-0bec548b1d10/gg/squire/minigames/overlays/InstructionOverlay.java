...
extends OverlayPanel {
    ...
    private static void llIIlllIllIIII() {
        ...
        InstructionOverlay.lIIllIIllIlI[InstructionOverlay.lIIllIIllIll[0]] = InstructionOverlay.llIIlllIlIllIl("OsQU7Ng6lDI=", "geKFx");
        InstructionOverlay.lIIllIIllIlI[InstructionOverlay.lIIllIIllIll[1]] = InstructionOverlay.llIIlllIlIlllI("MDYiCXQXOzADIFUxJAI6FDQ0UDsDMiMcNQw=", "uWQpT");
        InstructionOverlay.lIIllIIllIlI[InstructionOverlay.lIIllIIllIll[2]] = InstructionOverlay.llIIlllIlIllll("g5+gnQ+HV18oXNcVK8oDMw==", "ePoAl");
        InstructionOverlay.lIIllIIllIlI[InstructionOverlay.lIIllIIllIll[3]] = InstructionOverlay.llIIlllIlIllll("5rG+pN58IUEh2W9T0tV+JprSyVGEKqaaYj0Cb8pLV7U=", "qlZia");
        InstructionOverlay.lIIllIIllIlI[InstructionOverlay.lIIllIIllIll[4]] = InstructionOverlay.llIIlllIlIllIl("uzOSnSmSNz0wgIrOMw0BI9CCWg3GZwyO", "BkldY");
        InstructionOverlay.lIIllIIllIlI[InstructionOverlay.lIIllIIllIll[5]] = InstructionOverlay.llIIlllIlIllll("P6wJStsotvv5xmAKzk+mP6KrAmE2KXZbTHpjH1MLeRaLRTm5/dMTxCvqAVUYgRVT3Y4WZKs68PbhgJ8qOo9KfIffD5deVRjNKUwO+lgYA3xDSlnPNj79r8eumoFsJCxcD+vFTijBjoQ=", "EufZk");
        InstructionOverlay.lIIllIIllIlI[InstructionOverlay.lIIllIIllIll[6]] = InstructionOverlay.llIIlllIlIlllI("FA8=", "LKjUV");
        InstructionOverlay.lIIllIIllIlI[InstructionOverlay.lIIllIIllIll[7]] = InstructionOverlay.llIIlllIlIlllI("JQgcIQY=", "wmoDr");
    }
    ...
    private static void llIIlllIllIIIl() {
        ...
        InstructionOverlay.lIIllIIllIll[1] = " ".length();
        InstructionOverlay.lIIllIIllIll[2] = "  ".length();
        InstructionOverlay.lIIllIIllIll[3] = "   ".length();
