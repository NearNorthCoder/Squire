...
extends OverlayPanel {
    ...
    private static void llIIllllIIIIll() {
        ...
        StatisticsOverlay.lIIllIlIIIII[4] = " ".length();
        StatisticsOverlay.lIIllIlIIIII[5] = "  ".length();
        StatisticsOverlay.lIIllIlIIIII[6] = "   ".length();
    ...
    private static void llIIllllIIIIlI() {
        ...
        StatisticsOverlay.lIIllIIlllll[StatisticsOverlay.lIIllIlIIIII[2]] = StatisticsOverlay.llIIlllIllllll("btAvPGgkjkwbXFOSmNLMslUIQYIPbJYD", "vDQik");
        StatisticsOverlay.lIIllIIlllll[StatisticsOverlay.lIIllIlIIIII[4]] = StatisticsOverlay.llIIllllIIIIII("GQ8AIAomHw==", "KznTc");
        StatisticsOverlay.lIIllIIlllll[StatisticsOverlay.lIIllIlIIIII[5]] = StatisticsOverlay.llIIllllIIIIII("BzY6BksoNiwQUQ==", "EWHuk");
        StatisticsOverlay.lIIllIIlllll[StatisticsOverlay.lIIllIlIIIII[6]] = StatisticsOverlay.llIIllllIIIIIl("Gu9yR4cMcfdTMsyBwrs6rw==", "OYixV");
        StatisticsOverlay.lIIllIIlllll[StatisticsOverlay.lIIllIlIIIII[7]] = StatisticsOverlay.llIIllllIIIIII("LCdWNgIdGRM1WQ==", "twvQc");
        StatisticsOverlay.lIIllIIlllll[StatisticsOverlay.lIIllIlIIIII[8]] = StatisticsOverlay.llIIlllIllllll("hx+V/+xmZrY=", "ldrjY");
        StatisticsOverlay.lIIllIIlllll[StatisticsOverlay.lIIllIlIIIII[9]] = StatisticsOverlay.llIIllllIIIIII("CCU2Ihk=", "KISCk");
    }
