...
extends SquirePlugin {
    ...
    private static void lIIlIIlllIlIIl() {
        ...
        SquireAerialFisher.lIlIllIllII[1] = (57 + 42 - -11 + 35 ^ 158 + 13 - 22 + 46) & (0x55 ^ 0xD ^ (0x5A ^ 0x50) ^ -" ".length());
        SquireAerialFisher.lIlIllIllII[2] = " ".length();
        SquireAerialFisher.lIlIllIllII[3] = "  ".length();
        SquireAerialFisher.lIlIllIllII[4] = "   ".length();
