...
implements ac {
    ...
    private static String lIlIlIlIIIIIl(String llllllllllllllllllIlIIlIllIlIIIl, String llllllllllllllllllIlIIlIllIlIIII) {
        try {
            SecretKeySpec llllllllllllllllllIlIIlIllIlIllI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIlIIlIllIlIIII.getBytes(StandardCharsets.UTF_8)), llIIlIlIIl[12]), "DES");
            ...
            return new String(llllllllllllllllllIlIIlIllIlIlIl.doFinal(Base64.getDecoder().decode(llllllllllllllllllIlIIlIllIlIIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void Q() {
        d llllllllllllllllllIlIIlIllllIIll;
        Object llllllllllllllllllIlIIlIllllIlII;
        ...
        if (ay.lIlIlIlIIIlll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            ...
            llllllllllllllllllIlIIlIllllIlII = new d(llIIlIlIIl[8], llIIlIlIIl[1], llIIlIlIIl[36]);
            bv.add((d)llllllllllllllllllIlIIlIllllIlII);
            "".length();
        }
        if (ay.lIlIlIlIIIlll(Bank.contains(llllllllllllllllllIlIIlIllllIlII = item -> item.getName().toLowerCase().contains(llIIlIlIII[llIIlIlIIl[45]])) ? 1 : 0)) {
            llllllllllllllllllIlIIlIllllIIll = new d(llIIlIlIIl[37], llIIlIlIIl[9], llIIlIlIIl[38]);
            bv.add(llllllllllllllllllIlIIlIllllIIll);
            "".length();
        }
        int[] nArray3 = new int[llIIlIlIIl[1]];
        nArray3[ay.llIIlIlIIl[0]] = llIIlIlIIl[39];
        if (ay.lIlIlIlIIIlll(Bank.contains((int[])nArray3) ? 1 : 0)) {
            llllllllllllllllllIlIIlIllllIIll = new d(llIIlIlIIl[39], llIIlIlIIl[40], llIIlIlIIl[41]);
            bv.add(llllllllllllllllllIlIIlIllllIIll);
            "".length();
        }
    }
    ...
    private static String lIlIlIlIIIIII(String llllllllllllllllllIlIIlIllIIIlII, String llllllllllllllllllIlIIlIllIIIIll) {
        try {
            SecretKeySpec llllllllllllllllllIlIIlIllIIlIIl = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIlIIlIllIIIIll.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllllIlIIlIllIIlIII = Cipher.getInstance("Blowfish");
            llllllllllllllllllIlIIlIllIIlIII.init(llIIlIlIIl[3], llllllllllllllllllIlIIlIllIIlIIl);
            return new String(llllllllllllllllllIlIIlIllIIlIII.doFinal(Base64.getDecoder().decode(llllllllllllllllllIlIIlIllIIIlII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIlIlIlIIIIll() {
        ...
        ay.llIIlIlIII[ay.llIIlIlIIl[0]] = ay.lIlIlIlIIIIII("RLBGQmVl8BRw4wo+T5XS+Q==", "NBsiR");
        ay.llIIlIlIII[ay.llIIlIlIIl[1]] = ay.lIlIlIlIIIIIl("zmBtvhARoqLwi8ez9Hb0ynjdLv1qWVNm2yOqtqqsKwDgg46zu+L1uRCBV/uLdyiRsXsl64maln0=", "ahzST");
        ay.llIIlIlIII[ay.llIIlIlIIl[3]] = ay.lIlIlIlIIIIII("2mxplDdPVyRwzmE1lIJKR6HbaKbdvWEv", "rpjyu");
        ay.llIIlIlIII[ay.llIIlIlIIl[4]] = ay.lIlIlIlIIIIlI("CggqGA4rH28UBisT", "ExOvg");
        ay.llIIlIlIII[ay.llIIlIlIIl[6]] = ay.lIlIlIlIIIIII("9/r+atTYG3OWxbJcYiifPV4Rndb4DBmZ", "PDuae");
        ay.llIIlIlIII[ay.llIIlIlIIl[9]] = ay.lIlIlIlIIIIIl("NP0g8KXp/434B4BZFtk3JSEJnhYrpHRwh0sDNC1GBUbtuYJbjTaFGnrBvU1XAJWm", "xoxhq");
        ay.llIIlIlIII[ay.llIIlIlIIl[10]] = ay.lIlIlIlIIIIIl("a1DNqceP3M/zC2Si+sUVCA==", "LudsU");
        ay.llIIlIlIII[ay.llIIlIlIIl[11]] = ay.lIlIlIlIIIIII("Ue9lE47q3euKlUKR92ZYMg==", "xCUap");
        ay.llIIlIlIII[ay.llIIlIlIIl[12]] = ay.lIlIlIlIIIIlI("IwoKF2EGAw4WMg==", "aooeA");
        ay.llIIlIlIII[ay.llIIlIlIIl[15]] = ay.lIlIlIlIIIIIl("IG/7th7Q6eXcEWXKWlsESqZGYS2NTuid", "UJduK");
        ay.llIIlIlIII[ay.llIIlIlIIl[17]] = ay.lIlIlIlIIIIlI("OzckCAQRKyJOHBkoNQ==", "xEEnp");
        ay.llIIlIlIII[ay.llIIlIlIIl[18]] = ay.lIlIlIlIIIIII("YmlEHNzzepAK6VzaLRi6FA==", "gQect");
        ay.llIIlIlIII[ay.llIIlIlIIl[14]] = ay.lIlIlIlIIIIIl("G9eNQffRDazpv2QM4lt5Ow==", "BYBCo");
        ay.llIIlIlIII[ay.llIIlIlIIl[20]] = ay.lIlIlIlIIIIIl("4YsaEpTaLmU=", "OAfDo");
        ay.llIIlIlIII[ay.llIIlIlIIl[22]] = ay.lIlIlIlIIIIII("oy6lMaIGww0XeeHnKuiOUhzf5M7RAs7h", "cYbGz");
        ay.llIIlIlIII[ay.llIIlIlIIl[23]] = ay.lIlIlIlIIIIII("3z4wGtDl2tBVFPGY2bekMA==", "nWVuR");
        ay.llIIlIlIII[ay.llIIlIlIIl[25]] = ay.lIlIlIlIIIIlI("KCY3FiMCOjFQOBk2", "kTVpW");
        ay.llIIlIlIII[ay.llIIlIlIIl[26]] = ay.lIlIlIlIIIIlI("BAwZPg40EAw1WSIWCDcfcQ0bMw==", "QbiQy");
        ay.llIIlIlIII[ay.llIIlIlIIl[28]] = ay.lIlIlIlIIIIII("k6hPzw/tbn66hHtUi5X8hg==", "LMJUe");
        ay.llIIlIlIII[ay.llIIlIlIIl[29]] = ay.lIlIlIlIIIIIl("U/JXv7Q40s3gYkCCLhmAYw==", "HGjlg");
        ay.llIIlIlIII[ay.llIIlIlIIl[30]] = ay.lIlIlIlIIIIIl("PRg3Y2hNXx4+pRpgsMXF5FjM+SpvAFiI", "oZySr");
        ay.llIIlIlIII[ay.llIIlIlIIl[31]] = ay.lIlIlIlIIIIII("JGxe7viPf7Fm/IGS5bUuNw==", "QPADo");
        ay.llIIlIlIII[ay.llIIlIlIIl[32]] = ay.lIlIlIlIIIIlI("CyQ9JwQucSkhBj00Km4NJTA3PQ==", "IQDNj");
        ay.llIIlIlIII[ay.llIIlIlIIl[35]] = ay.lIlIlIlIIIIII("pj8g2uEWtMkIKMpKcmRyex8DCkMTtRUeV/yKC5vH/ZY=", "khsnY");
        ay.llIIlIlIII[ay.llIIlIlIIl[43]] = ay.lIlIlIlIIIIII("sRha5INkWjZlXbZ/BbA6qA==", "tTtBW");
        ay.llIIlIlIII[ay.llIIlIlIIl[45]] = ay.lIlIlIlIIIIlI("HT4eP1YAMVAvEw47BDBWRw==", "oWpXv");
    }

    private static String lIlIlIlIIIIlI(String llllllllllllllllllIlIIlIlllIlIII, String llllllllllllllllllIlIIlIlllIIlll) {
        llllllllllllllllllIlIIlIlllIlIII = new String(Base64.getDecoder().decode(llllllllllllllllllIlIIlIlllIlIII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllIlIIlIlllIIllI = new StringBuilder();
        char[] llllllllllllllllllIlIIlIlllIIlIl = llllllllllllllllllIlIIlIlllIIlll.toCharArray();
        int llllllllllllllllllIlIIlIlllIIlII = llIIlIlIIl[0];
        char[] llllllllllllllllllIlIIlIllIllllI = llllllllllllllllllIlIIlIlllIlIII.toCharArray();
        int llllllllllllllllllIlIIlIllIlllIl = llllllllllllllllllIlIIlIllIllllI.length;
        int llllllllllllllllllIlIIlIllIlllII = llIIlIlIIl[0];
        while (ay.lIlIlIlIIIllI(llllllllllllllllllIlIIlIllIlllII, llllllllllllllllllIlIIlIllIlllIl)) {
            char llllllllllllllllllIlIIlIlllIlIIl = llllllllllllllllllIlIIlIllIllllI[llllllllllllllllllIlIIlIllIlllII];
            llllllllllllllllllIlIIlIlllIIllI.append((char)(llllllllllllllllllIlIIlIlllIlIIl ^ llllllllllllllllllIlIIlIlllIIlIl[llllllllllllllllllIlIIlIlllIIlII % llllllllllllllllllIlIIlIlllIIlIl.length]));
            "".length();
            ++llllllllllllllllllIlIIlIlllIIlII;
            ++llllllllllllllllllIlIIlIllIlllII;
            "".length();
    ...
    private static void lIlIlIlIIIlII() {
        ...
        ay.llIIlIlIIl[1] = " ".length();
        ay.llIIlIlIIl[2] = -(0xFFFFDAFD & 0x7D1B) & (0xFFFFFFFF & 0x5BFB);
        ay.llIIlIlIIl[3] = "  ".length();
        ay.llIIlIlIIl[4] = "   ".length();
        ...
        ay.llIIlIlIIl[34] = 0x4A ^ 0x27 ^ "   ".length();
    ...
    public static void fi() {
        block29: {
            BankLocation llllllllllllllllllIlIIlIlllllIII;
            block31: {
                block34: {
                    block33: {
                        block32: {
                            ...
                            if (ay.lIlIlIlIIlIIl(llllllllllllllllllIlIIlIlllllIII = BankLocation.getNearest()) && ay.lIlIlIlIIIlll(llllllllllllllllllIlIIlIlllllIII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                AccBuilderSotf.c = llIIlIlIII[llIIlIlIIl[3]];
                                a.a(llllllllllllllllllIlIIlIlllllIII);
                            }
                            if (!ay.lIlIlIlIIlIIl(llllllllllllllllllIlIIlIlllllIII) || !ay.lIlIlIlIIIlIl(llllllllllllllllllIlIIlIlllllIII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block31;
                        ...
                        if (ay.lIlIlIlIIlIII(Inventory.getCount((int[])nArray7))) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (ay.lIlIlIlIIlIII(Inventory.getCount((int[])nArray))) {
                                    ...
                                    "".length();
                                    if (" ".length() != " ".length()) {
                                        return ((0x2F ^ 0x77 ^ (0x5C ^ 0x30)) & (0x67 ^ 0x51 ^ "  ".length() ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = llIIlIlIIl[0];
                                }
            ...
            if (ay.lIlIlIlIIIlIl(ay.an() ? 1 : 0)) {
                ...
                if (ay.lIlIlIlIIIlll(Bank.isOpen() ? 1 : 0) && ay.lIlIlIlIIIlll(Players.getLocal().isAnimating() ? 1 : 0)) {
                    ...
                    if (ay.lIlIlIlIIIlll(Production.isOpen() ? 1 : 0)) {
                        ...
                        int[] nArray = new int[llIIlIlIIl[1]];
                        nArray[ay.llIIlIlIIl[0]] = llIIlIlIIl[8];
                        llllllllllllllllllIlIIlIlllllIII = Inventory.getFirst((int[])nArray);
                        int[] nArray8 = new int[llIIlIlIIl[1]];
                        nArray8[ay.llIIlIlIIl[0]] = llIIlIlIIl[7];
                        Item llllllllllllllllllIlIIlIllllIlll = Inventory.getFirst((int[])nArray8);
                        if (ay.lIlIlIlIIlIIl(llllllllllllllllllIlIIlIlllllIII) && ay.lIlIlIlIIlIIl(llllllllllllllllllIlIIlIllllIlll)) {
                            llllllllllllllllllIlIIlIlllllIII.useOn(llllllllllllllllllIlIIlIllllIlll);
                        ...
                        if (ay.lIlIlIlIIIllI(Skills.getLevel((Skill)Skill.CRAFTING), llIIlIlIIl[6])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!ay.lIlIlIlIIlIlI(Inventory.getCount((int[])nArray), llIIlIlIIl[1]) || ay.lIlIlIlIIIlIl(Dialog.isOpen() ? 1 : 0)) {
                                    bl = llIIlIlIIl[1];
                                    "".length();
                                    if (((0xB8 ^ 0x94 ^ (0x10 ^ 0x28)) & (0x3D ^ 0x18 ^ (0xF3 ^ 0xC2) ^ -" ".length())) <= -" ".length()) {
                                        return ((0x4E ^ 0x50 ^ 95 + 66 - 128 + 94) & (91 + 74 - 111 + 109 ^ 26 + 97 - -6 + 65 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = llIIlIlIIl[0];
                                }
                        ...
                        if (ay.lIlIlIlIIlIlI(Skills.getLevel((Skill)Skill.CRAFTING), llIIlIlIIl[19]) && ay.lIlIlIlIIIllI(Skills.getLevel((Skill)Skill.CRAFTING), llIIlIlIIl[21])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!ay.lIlIlIlIIlIlI(Inventory.getCount((int[])nArray), llIIlIlIIl[1]) || ay.lIlIlIlIIIlIl(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (-"  ".length() > 0) {
                                        return ((5 ^ 0x33 ^ (0xC0 ^ 0xB6)) & (80 + 190 - 235 + 187 ^ 138 + 26 - 16 + 10 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = llIIlIlIIl[0];
                                }
                        ...
                        if (ay.lIlIlIlIIlIlI(Skills.getLevel((Skill)Skill.CRAFTING), llIIlIlIIl[21]) && ay.lIlIlIlIIIllI(Skills.getLevel((Skill)Skill.CRAFTING), llIIlIlIIl[24])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!ay.lIlIlIlIIlIlI(Inventory.getCount((int[])nArray), llIIlIlIIl[1]) || ay.lIlIlIlIIIlIl(Dialog.isOpen() ? 1 : 0)) {
                                    bl = llIIlIlIIl[1];
                                    "".length();
                                    if ("   ".length() < ((0x52 ^ 0x69) & ~(0xB2 ^ 0x89))) {
                                        return ((0x1D ^ 0x2A) & ~(0x45 ^ 0x72)) != 0;
                                    }
                                } else {
                                    bl = llIIlIlIIl[0];
                                }
                        ...
                        if (ay.lIlIlIlIIlIlI(Skills.getLevel((Skill)Skill.CRAFTING), llIIlIlIIl[27])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!ay.lIlIlIlIIlIlI(Inventory.getCount((int[])nArray), llIIlIlIIl[1]) || ay.lIlIlIlIIIlIl(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if ("   ".length() < 0) {
                                        return ((0x64 ^ 0x24 ^ (3 ^ 0xB)) & (0x53 ^ 0x6A ^ (0x7E ^ 0xF) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = llIIlIlIIl[0];
                                }
