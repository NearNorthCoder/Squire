...
import o.c.k.i.-.l.o.f.-.n.c.t.e.s.W;
...
import o.c.k.i.-.l.o.f.-.n.c.t.e.s.aj;
import o.c.k.i.-.l.o.f.-.n.c.t.e.s.ak;
import o.c.k.i.-.l.o.f.-.n.c.t.e.s.an;
import o.c.k.i.-.l.o.f.-.n.c.t.e.s.ao;
import o.c.k.i.-.l.o.f.-.n.c.t.e.s.aq;
import o.c.k.i.-.l.o.f.-.n.c.t.e.s.ar;
import o.c.k.i.-.l.o.f.-.n.c.t.e.s.at;
import o.c.k.i.-.l.o.f.-.n.c.t.e.s.au;
...
implements ac {
    ...
    private static String lIlIIlIIIlIll(String llllllllllllllllllIllIIlIllIllll, String llllllllllllllllllIllIIlIllIllII) {
        try {
            SecretKeySpec llllllllllllllllllIllIIlIlllIIlI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIllIIlIllIllII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllllIllIIlIlllIIIl = Cipher.getInstance("Blowfish");
            llllllllllllllllllIllIIlIlllIIIl.init(llIIIIllll[3], llllllllllllllllllIllIIlIlllIIlI);
        ...
        catch (Exception llllllllllllllllllIllIIlIlllIIII) {
            llllllllllllllllllIllIIlIlllIIII.printStackTrace();
            return null;
        }
    }
    ...
    private static String lIlIIlIIIllII(String llllllllllllllllllIllIIlIllIIIII, String llllllllllllllllllIllIIlIllIIIIl) {
        try {
            ...
            return new String(llllllllllllllllllIllIIlIllIIlII.doFinal(Base64.getDecoder().decode(llllllllllllllllllIllIIlIllIIIII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlIIlIIIlIlI(String llllllllllllllllllIllIIlIlIIllIl, String llllllllllllllllllIllIIlIlIlIIIl) {
        llllllllllllllllllIllIIlIlIIllIl = new String(Base64.getDecoder().decode(llllllllllllllllllIllIIlIlIIllIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllIllIIlIlIlIIII = new StringBuilder();
        ...
        char[] llllllllllllllllllIllIIlIlIIlIII = llllllllllllllllllIllIIlIlIIllIl.toCharArray();
        int llllllllllllllllllIllIIlIlIIIlll = llllllllllllllllllIllIIlIlIIlIII.length;
        int llllllllllllllllllIllIIlIlIIIllI = llIIIIllll[2];
        while (t.lIlIIlIIlIIIl(llllllllllllllllllIllIIlIlIIIllI, llllllllllllllllllIllIIlIlIIIlll)) {
            char llllllllllllllllllIllIIlIlIlIIll = llllllllllllllllllIllIIlIlIIlIII[llllllllllllllllllIllIIlIlIIIllI];
            llllllllllllllllllIllIIlIlIlIIII.append((char)(llllllllllllllllllIllIIlIlIlIIll ^ llllllllllllllllllIllIIlIlIIllll[llllllllllllllllllIllIIlIlIIlllI % llllllllllllllllllIllIIlIlIIllll.length]));
            "".length();
            ++llllllllllllllllllIllIIlIlIIlllI;
            ++llllllllllllllllllIllIIlIlIIIllI;
            "".length();
            if (-"   ".length() <= 0) continue;
            return null;
        }
        return String.valueOf(llllllllllllllllllIllIIlIlIlIIII);
    }
                ...
                if (t.lIlIIlIIlIIlI(Inventory.contains((String[])stringArray2) ? 1 : 0)) {
                    ...
                    if (t.lIlIIlIIlIIlI(Inventory.contains((String[])stringArray3) ? 1 : 0)) {
                        ...
                        if (t.lIlIIlIIlIIlI(Inventory.contains((String[])stringArray4) ? 1 : 0) && t.lIlIIlIIlIlIl(Skills.getLevel((Skill)Skill.SLAYER), llIIIIllll[7])) {
                            ...
                            return ((0x53 ^ 0x55 ^ (0x68 ^ 0x49)) & (0xA ^ 0x34 ^ (0x1D ^ 4) ^ -" ".length())) != 0;
                        }
                    }
                }
            }
    ...
    private static void lIlIIlIIIllll() {
        ...
        t.llIIIIllll[0] = " ".length();
        t.llIIIIllll[1] = 0x13 ^ 0x1B ^ (0x87 ^ 0x8A);
        t.llIIIIllll[2] = (0xC5 ^ 0xA0 ^ (0x24 ^ 0x51)) & (0x7B ^ 0x4D ^ (0xAA ^ 0x8C) ^ -" ".length());
        t.llIIIIllll[3] = "  ".length();
        t.llIIIIllll[4] = "   ".length();
        ...
        t.llIIIIllll[34] = 0x8A ^ 0x93 ^ " ".length();
        ...
        t.llIIIIllll[46] = "   ".length() ^ (0xE7 ^ 0xC6);
    ...
    private static void lIlIIlIIIlllI() {
        ...
        t.llIIIIllIl[t.llIIIIllll[2]] = t.lIlIIlIIIlIlI("LQQvNw==", "CkARO");
        t.llIIIIllIl[t.llIIIIllll[0]] = t.lIlIIlIIIlIll("qc3pSzmuKZw6XnQpoSooAFegME/Pv65+", "lWECV");
        t.llIIIIllIl[t.llIIIIllll[3]] = t.lIlIIlIIIlIll("G1IdUYxSwZLAGCS31V2doA==", "RLAQS");
        t.llIIIIllIl[t.llIIIIllll[4]] = t.lIlIIlIIIlIlI("CQoZCyQ8FA==", "HmpgM");
        t.llIIIIllIl[t.llIIIIllll[5]] = t.lIlIIlIIIlIll("DTvQzEY3BKi864jhWf90nw==", "yMMfq");
        t.llIIIIllIl[t.llIIIIllll[1]] = t.lIlIIlIIIllII("v93k6mGTRCw=", "eyEef");
        t.llIIIIllIl[t.llIIIIllll[6]] = t.lIlIIlIIIlIlI("GQYnEjozGiE=", "ZtFtN");
        t.llIIIIllIl[t.llIIIIllll[13]] = t.lIlIIlIIIlIll("/oan5LWDX84HoA4PVjpVcw==", "EvWpK");
        t.llIIIIllIl[t.llIIIIllll[14]] = t.lIlIIlIIIlIlI("CA4QGTtlGwURMSsGGRc=", "EowpX");
        t.llIIIIllIl[t.llIIIIllll[16]] = t.lIlIIlIIIllII("PA7sXtjckfjXZKEvNVP8Zw==", "oJJuA");
        t.llIIIIllIl[t.llIIIIllll[18]] = t.lIlIIlIIIlIll("IBjD9OvGg7Qx2+I48+IROw==", "JcLUZ");
        t.llIIIIllIl[t.llIIIIllll[19]] = t.lIlIIlIIIlIll("mm/ZvD/lVAWJRqqJ7lvQEQ==", "UoIio");
        t.llIIIIllIl[t.llIIIIllll[21]] = t.lIlIIlIIIlIlI("Ix4oJQoOUCwpDAwVNSEYDw==", "bpAHk");
        t.llIIIIllIl[t.llIIIIllll[23]] = t.lIlIIlIIIllII("RjMtQIau+aTcXt3xxad9yQ==", "VDYTk");
        t.llIIIIllIl[t.llIIIIllll[25]] = t.lIlIIlIIIlIlI("DCMnBng3KmoGICgpOAo9Ni8vQ3BrZQ==", "XLJcX");
        t.llIIIIllIl[t.llIIIIllll[26]] = t.lIlIIlIIIllII("m1XmbKjku50yX498D0V1Ywu4wT9sGIcb", "CzhaU");
        t.llIIIIllIl[t.llIIIIllll[27]] = t.lIlIIlIIIlIlI("LgIPI3UVC0IjLQoIEC8wFA4HZn1LRA==", "zmbFU");
        t.llIIIIllIl[t.llIIIIllll[28]] = t.lIlIIlIIIllII("QFpt3tT79IA7pEu7kJZsx+L1vZtR5C3lW71x8SPKJyZRH3e9Fq6Cyg==", "MIEBU");
        t.llIIIIllIl[t.llIIIIllll[29]] = t.lIlIIlIIIlIlI("AxsqAXE4EmcBKScRNQ00ORciRHlkXQ==", "WtGdQ");
        t.llIIIIllIl[t.llIIIIllll[30]] = t.lIlIIlIIIllII("HL59J5SJRaBTg0BM0n5YCf0ha7m9CJqd", "WkwZU");
        t.llIIIIllIl[t.llIIIIllll[31]] = t.lIlIIlIIIllII("s8tsQdc4fPeW9p6sJDwr/335lOwhAW+X", "aMrsQ");
        t.llIIIIllIl[t.llIIIIllll[32]] = t.lIlIIlIIIllII("Vl12+/ATTdhLYSpXpJz3Og==", "WGQkB");
        t.llIIIIllIl[t.llIIIIllll[9]] = t.lIlIIlIIIlIll("WEmTQDIEGU0=", "GAvrz");
        t.llIIIIllIl[t.llIIIIllll[33]] = t.lIlIIlIIIlIlI("EgE8F2spCHEXMzYLIxsuKA00UmN1Rw==", "FnQrK");
        t.llIIIIllIl[t.llIIIIllll[34]] = t.lIlIIlIIIllII("3XQoxxMWaqu/Xh7wIfRrZQhrjBG2lgCY", "vRSXB");
        t.llIIIIllIl[t.llIIIIllll[35]] = t.lIlIIlIIIlIll("+rSQbxFW+c+t8UlqswFNWuiDhQLNJX6m", "StvVw");
        t.llIIIIllIl[t.llIIIIllll[10]] = t.lIlIIlIIIllII("/YTupGvlsAqsARIMTK6olO/j5/uxl2H2", "jieBa");
        t.llIIIIllIl[t.llIIIIllll[37]] = t.lIlIIlIIIlIlI("CXMTMRs8Nmc/DmgbKCAN", "HSGPh");
        t.llIIIIllIl[t.llIIIIllll[38]] = t.lIlIIlIIIlIll("M+9T+cNC22LT33uRZImtx2Tay55GlUWM", "tXSEL");
        t.llIIIIllIl[t.llIIIIllll[39]] = t.lIlIIlIIIlIlI("ESobFnUqI1YWLTUgBBowKyYTU313bA==", "EEvsU");
        t.llIIIIllIl[t.llIIIIllll[40]] = t.lIlIIlIIIlIll("SpajWE3ARXTtysk2LV5V0IpK3gJnhzqJ", "GUOeY");
        t.llIIIIllIl[t.llIIIIllll[41]] = t.lIlIIlIIIlIlI("Nzc1LU4MPngtFhM9KiELDTs9", "cXXHn");
        t.llIIIIllIl[t.llIIIIllll[43]] = t.lIlIIlIIIllII("mJMWX64aoIPhpA4DNLYNB+d5FfnHXuSP", "kaFzR");
        t.llIIIIllIl[t.llIIIIllll[45]] = t.lIlIIlIIIllII("pYEvtkq6LmtNdT+f+QMrUc85lVJhCe+r", "cnVGB");
        t.llIIIIllIl[t.llIIIIllll[46]] = t.lIlIIlIIIlIlI("BCU8AVM/LHEBCyAvIw0WPik0RFtjYw==", "PJQds");
        t.llIIIIllIl[t.llIIIIllll[47]] = t.lIlIIlIIIlIll("qRhUJBnrKxza67yYB93hiJSHsC8+r7NC", "AisIt");
        t.llIIIIllIl[t.llIIIIllll[48]] = t.lIlIIlIIIllII("MsRU8Rxl/7HcOk0shgPVeTty0Pg240PC", "znisF");
        t.llIIIIllIl[t.llIIIIllll[49]] = t.lIlIIlIIIlIll("IHJzh2HNjIM=", "DcJvp");
    }
                            ...
                            while (t.lIlIIlIIlIIlI(dc.isEmpty() ? 1 : 0) && t.lIlIIlIIlIIlI(AccBuilderSotf.d ? 1 : 0)) {
                                ...
                                if (t.lIlIIlIIlIIll(Game.getState(), GameState.LOGGED_IN)) {
                                    while (t.lIlIIlIIlIIII(e.z() ? 1 : 0)) {
                                        ...
                                        "".length();
                                        "".length();
                                        if (((0x86 ^ 0x9E) & ~(0x10 ^ 8)) >= -" ".length()) continue;
                                        return;
                                    }
                                    AccBuilderSotf.l = dc.get(llIIIIllll[2]).ag();
                                    int llllllllllllllllllIllIIlIlllllll = dc.get(llIIIIllll[2]).af();
                                    Time.sleep((long)llllllllllllllllllIllIIlIlllllll);
                                    "".length();
