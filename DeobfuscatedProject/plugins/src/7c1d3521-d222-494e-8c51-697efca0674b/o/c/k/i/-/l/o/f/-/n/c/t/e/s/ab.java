...
implements ac {
    ...
    private static void Q() {
        d llllllllllllllllllIIlIIIlIIlIlIl;
        Object llllllllllllllllllIIlIIIlIIlIllI;
        ...
        if (ab.lIllIIlIIIIIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
            llllllllllllllllllIIlIIIlIIlIllI = new d(llIlIIlIll[14], llIlIIlIll[1], llIlIIlIll[47]);
            bv.add((d)llllllllllllllllllIIlIIIlIIlIllI);
            "".length();
        }
        int[] nArray3 = new int[llIlIIlIll[1]];
        nArray3[ab.llIlIIlIll[0]] = llIlIIlIll[4];
        if (ab.lIllIIlIIIIIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
            llllllllllllllllllIIlIIIlIIlIllI = new d(llIlIIlIll[4], llIlIIlIll[48], llIlIIlIll[49]);
            bv.add((d)llllllllllllllllllIIlIIIlIIlIllI);
            "".length();
        }
        if (ab.lIllIIlIIIIIl(Bank.contains((Predicate)(llllllllllllllllllIIlIIIlIIlIllI = item -> item.getName().toLowerCase().contains(llIlIIIllI[llIlIIlIll[56]]))) ? 1 : 0)) {
            llllllllllllllllllIIlIIIlIIlIlIl = new d(llIlIIlIll[50], llIlIIlIll[7], llIlIIlIll[51]);
            bv.add(llllllllllllllllllIIlIIIlIIlIlIl);
            "".length();
        }
        int[] nArray4 = new int[llIlIIlIll[1]];
        nArray4[ab.llIlIIlIll[0]] = llIlIIlIll[11];
        if (ab.lIllIIlIIIIIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
            llllllllllllllllllIIlIIIlIIlIlIl = new d(llIlIIlIll[11], llIlIIlIll[15], llIlIIlIll[52]);
            bv.add(llllllllllllllllllIIlIIIlIIlIlIl);
            "".length();
        }
        ...
        if (ab.lIllIIlIIIIIl(Bank.contains((int[])nArray5) ? 1 : 0)) {
            llllllllllllllllllIIlIIIlIIlIlIl = new d(llIlIIlIll[16], llIlIIlIll[15], llIlIIlIll[52]);
            bv.add(llllllllllllllllllIIlIIIlIIlIlIl);
            "".length();
        }
        ...
        if (ab.lIllIIlIIIIIl(Bank.contains((int[])nArray6) ? 1 : 0)) {
            llllllllllllllllllIIlIIIlIIlIlIl = new d(llIlIIlIll[13], llIlIIlIll[53], llIlIIlIll[52]);
            bv.add(llllllllllllllllllIIlIIIlIIlIlIl);
            "".length();
        }
        ...
        if (ab.lIllIIlIIIIIl(Bank.contains((int[])nArray7) ? 1 : 0)) {
            llllllllllllllllllIIlIIIlIIlIlIl = new d(llIlIIlIll[12], llIlIIlIll[7], j.cf);
            bv.add(llllllllllllllllllIIlIIIlIIlIlIl);
            "".length();
        }
    }

    private static String lIllIIIlIIIll(String llllllllllllllllllIIlIIIIllIlIIl, String llllllllllllllllllIIlIIIIllIllIl) {
        llllllllllllllllllIIlIIIIllIlIIl = new String(Base64.getDecoder().decode(llllllllllllllllllIIlIIIIllIlIIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllIIlIIIIllIllII = new StringBuilder();
        char[] llllllllllllllllllIIlIIIIllIlIll = llllllllllllllllllIIlIIIIllIllIl.toCharArray();
        int llllllllllllllllllIIlIIIIllIlIlI = llIlIIlIll[0];
        char[] llllllllllllllllllIIlIIIIllIIlII = llllllllllllllllllIIlIIIIllIlIIl.toCharArray();
        int llllllllllllllllllIIlIIIIllIIIll = llllllllllllllllllIIlIIIIllIIlII.length;
        int llllllllllllllllllIIlIIIIllIIIlI = llIlIIlIll[0];
        while (ab.lIllIIlIIIIII(llllllllllllllllllIIlIIIIllIIIlI, llllllllllllllllllIIlIIIIllIIIll)) {
            char llllllllllllllllllIIlIIIIllIllll = llllllllllllllllllIIlIIIIllIIlII[llllllllllllllllllIIlIIIIllIIIlI];
            llllllllllllllllllIIlIIIIllIllII.append((char)(llllllllllllllllllIIlIIIIllIllll ^ llllllllllllllllllIIlIIIIllIlIll[llllllllllllllllllIIlIIIIllIlIlI % llllllllllllllllllIIlIIIIllIlIll.length]));
            "".length();
            ++llllllllllllllllllIIlIIIIllIlIlI;
            ++llllllllllllllllllIIlIIIIllIIIlI;
            "".length();
    ...
    private static String lIllIIIlIIlII(String llllllllllllllllllIIlIIIlIIIlIll, String llllllllllllllllllIIlIIIlIIIlIII) {
        try {
            SecretKeySpec llllllllllllllllllIIlIIIlIIIlllI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIIlIIIlIIIlIII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            return new String(llllllllllllllllllIIlIIIlIIIllIl.doFinal(Base64.getDecoder().decode(llllllllllllllllllIIlIIIlIIIlIll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static boolean an() {
        ...
        if (ab.lIllIIIllllll(Inventory.contains((String[])stringArray) ? 1 : 0)) {
            ...
            if (ab.lIllIIIllllll(Inventory.contains((int[])nArray) ? 1 : 0)) {
                n2 = llIlIIlIll[1];
                "".length();
                if (((140 + 47 - 83 + 54 ^ 74 + 156 - 123 + 92) & (0xB7 ^ 0x8D ^ (0xF ^ 0x6C) ^ -" ".length())) == 0) return n2 != 0;
                return ((0xC7 ^ 0x86 ^ (0x48 ^ 0x4F)) & (0x66 ^ 0x5E ^ (0x56 ^ 0x28) ^ -" ".length())) != 0;
            }
        }
        n2 = llIlIIlIll[0];
        return n2 != 0;
    ...
    public int af() {
        ...
        if ("   ".length() <= " ".length()) {
            return (0x69 ^ 0x1E ^ (0x41 ^ 0x17)) & (0xB2 ^ 0xBE ^ (0x46 ^ 0x6B) ^ -" ".length());
        }
    ...
    public static void ex() {
        ...
        if (ab.lIllIIlIIIIIl(bt ? 1 : 0)) {
            block49: {
                BankLocation llllllllllllllllllIIlIIIlIIllIlI;
                ...
                if (ab.lIllIIlIIIIIl(ab.an() ? 1 : 0) && ab.lIllIIlIIIIIl(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()))) {
                    llllllllllllllllllIIlIIIlIIllIlI = BankLocation.getNearest();
                    if (ab.lIllIIlIIIlII(llllllllllllllllllIIlIIIlIIllIlI) && ab.lIllIIlIIIIIl(llllllllllllllllllIIlIIIlIIllIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderSotf.c = llIlIIIllI[llIlIIlIll[6]];
                        a.a(llllllllllllllllllIIlIIIlIIllIlI);
                        Time.sleepTicks((int)llIlIIlIll[3]);
                        "".length();
                    }
                    if (ab.lIllIIlIIIlII(llllllllllllllllllIIlIIIlIIllIlI) && ab.lIllIIIllllll(llllllllllllllllllIIlIIIlIIllIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                do {
                    ...
                    if (ab.lIllIIlIIIlII(Widgets.get((int)llIlIIlIll[39]))) {
                        Widget llllllllllllllllllIIlIIIlIIllIIl;
                        ...
                        llllllllllllllllllIIlIIIlIIllIlI = Widgets.get((int)llIlIIlIll[39], (int)llIlIIlIll[23]);
                        if (ab.lIllIIlIIIlII(llllllllllllllllllIIlIIIlIIllIlI)) {
                            llllllllllllllllllIIlIIIlIIllIlI.interact(llIlIIIllI[llIlIIlIll[43]]);
                            Time.sleepTicks((int)llIlIIlIll[1]);
                            "".length();
                        }
                        if (ab.lIllIIlIIIlII(llllllllllllllllllIIlIIIlIIllIIl = Widgets.get((int)llIlIIlIll[39], (int)llIlIIlIll[35]))) {
                            llllllllllllllllllIIlIIIlIIllIIl.interact(llIlIIIllI[llIlIIlIll[44]]);
                            Time.sleepTicks((int)llIlIIlIll[3]);
                            "".length();
                        }
                    }
    ...
    private static void lIllIIIllIIll() {
        ...
        ab.llIlIIIllI[ab.llIlIIlIll[0]] = ab.lIllIIIlIIIll("LRE/DjkIRC8TMgIX", "odFgW");
        ab.llIlIIIllI[ab.llIlIIlIll[1]] = ab.lIllIIIlIIlII("UAFE4FH1UAkqxXetaUI5OgtwCyjidGwjqNPHA27u/Tav79ft9NldoOZbnjD4bYhV", "jXjzC");
        ab.llIlIIIllI[ab.llIlIIlIll[3]] = ab.lIllIIIlIIlII("zFV3PCB6Ztg=", "xHIML");
        ab.llIlIIIllI[ab.llIlIIlIll[5]] = ab.lIllIIIlIIlII("g7Ju/Ei9B6s=", "EEWim");
        ab.llIlIIIllI[ab.llIlIIlIll[6]] = ab.lIllIIIlIIIll("Jw85ayYGTi0qPAI=", "inOKR");
        ab.llIlIIIllI[ab.llIlIIlIll[7]] = ab.lIllIIIlIIlIl("POB2CYq9LkgQcbCU3XoMNxU0Ut8YI7Cz", "suCgi");
        ab.llIlIIIllI[ab.llIlIIlIll[9]] = ab.lIllIIIlIIIll("Ih1YBzAQWBUPMQYRFgFiBA0dFTZVCw0WMhkRHRVuVQsPDzYWEBEIJVUMF0YAICExKAU=", "uxxfB");
        ab.llIlIIIllI[ab.llIlIIlIll[17]] = ab.lIllIIIlIIIll("Ly8beAIObh4sFxM6", "aNmXv");
        ab.llIlIIIllI[ab.llIlIIlIll[18]] = ab.lIllIIIlIIIll("GRQnCT0xGSdMISAZ", "PzSlO");
        ab.llIlIIIllI[ab.llIlIIlIll[19]] = ab.lIllIIIlIIlIl("qudnjdV23/o=", "YsDpA");
        ab.llIlIIIllI[ab.llIlIIlIll[15]] = ab.lIllIIIlIIIll("OAEtOQ==", "ndBJB");
        ab.llIlIIIllI[ab.llIlIIlIll[20]] = ab.lIllIIIlIIIll("IzAhNxUCMCF2FRQwKzoK", "wBDVf");
        ab.llIlIIIllI[ab.llIlIIlIll[21]] = ab.lIllIIIlIIIll("AQkmMA==", "VlGBY");
        ab.llIlIIIllI[ab.llIlIIlIll[22]] = ab.lIllIIIlIIlII("r1mSHeNBN8E=", "KfQdv");
        ab.llIlIIIllI[ab.llIlIIlIll[23]] = ab.lIllIIIlIIIll("GgAUVQM7QQYcEHRQ", "Tabuw");
        ab.llIlIIIllI[ab.llIlIIlIll[24]] = ab.lIllIIIlIIlIl("Ve2N93ZjgR0=", "vOgsk");
        ab.llIlIIIllI[ab.llIlIIlIll[25]] = ab.lIllIIIlIIIll("NQgu", "qaIdL");
        ab.llIlIIIllI[ab.llIlIIlIll[26]] = ab.lIllIIIlIIIll("JCsHcSQFahU4N0p4", "jJqQP");
        ab.llIlIIIllI[ab.llIlIIlIll[27]] = ab.lIllIIIlIIlIl("tnF6jUsgjAc=", "FvhwC");
        ab.llIlIIIllI[ab.llIlIIlIll[28]] = ab.lIllIIIlIIlII("s9jjFddSdMA=", "UyNyj");
        ab.llIlIIIllI[ab.llIlIIlIll[29]] = ab.lIllIIIlIIlII("MJK/AGVDLwxedpykxYtceQ==", "EieeJ");
        ab.llIlIIIllI[ab.llIlIIlIll[30]] = ab.lIllIIIlIIlII("8TRZqghCYCg=", "djOor");
        ab.llIlIIIllI[ab.llIlIIlIll[31]] = ab.lIllIIIlIIlIl("sf1mHLWhujs=", "gGAib");
        ab.llIlIIIllI[ab.llIlIIlIll[32]] = ab.lIllIIIlIIlII("hCfnzMCC1ZBz8006s4TD9w==", "xgDkU");
        ab.llIlIIIllI[ab.llIlIIlIll[33]] = ab.lIllIIIlIIlIl("Kds9QqJhkNM=", "PhKGw");
        ab.llIlIIIllI[ab.llIlIIlIll[34]] = ab.lIllIIIlIIIll("Fw0x", "SdVpi");
        ab.llIlIIIllI[ab.llIlIIlIll[35]] = ab.lIllIIIlIIIll("HjATcCA/cRM1OyNxAzk6OSIN", "PQePT");
        ab.llIlIIIllI[ab.llIlIIlIll[36]] = ab.lIllIIIlIIIll("LSwcLzcFIRxqKxQh", "dBhJE");
        ab.llIlIIIllI[ab.llIlIIlIll[37]] = ab.lIllIIIlIIlII("dCoFTTGiZK4=", "aIRey");
        ab.llIlIIIllI[ab.llIlIIlIll[40]] = ab.lIllIIIlIIIll("ETElNw8tI2c5By40", "CDGUf");
        ab.llIlIIIllI[ab.llIlIIlIll[41]] = ab.lIllIIIlIIlIl("AUGywy22gEw=", "RYWfE");
        ab.llIlIIIllI[ab.llIlIIlIll[42]] = ab.lIllIIIlIIlII("ZTLmxhP+ezB21oW6sm48KgOnrdbmC2FK", "LjGkB");
        ab.llIlIIIllI[ab.llIlIIlIll[43]] = ab.lIllIIIlIIlII("WyJ3QF4AnF8=", "pKHPX");
        ab.llIlIIIllI[ab.llIlIIlIll[44]] = ab.lIllIIIlIIlIl("aGe4xhSpaA8=", "WODhb");
        ab.llIlIIIllI[ab.llIlIIlIll[45]] = ab.lIllIIIlIIIll("MDUtBSQ=", "cELaA");
        ab.llIlIIIllI[ab.llIlIIlIll[55]] = ab.lIllIIIlIIlIl("JgGtanYNgsegVK/BJN7rXBo5vE+n324S", "bCVJM");
        ab.llIlIIIllI[ab.llIlIIlIll[56]] = ab.lIllIIIlIIlIl("UYmfZUbJQg0c4SRBHvc6hLK06MnsenUv", "LBXHs");
        ab.llIlIIIllI[ab.llIlIIlIll[57]] = ab.lIllIIIlIIlII("vCfDvkemtCE=", "mSxUt");
        ab.llIlIIIllI[ab.llIlIIlIll[58]] = ab.lIllIIIlIIIll("PiEXLy0h", "IDvCY");
        ab.llIlIIIllI[ab.llIlIIlIll[59]] = ab.lIllIIIlIIlII("o2UXyjUfChg=", "FyduB");
        ab.llIlIIIllI[ab.llIlIIlIll[53]] = ab.lIllIIIlIIlIl("Yu2JTDDzsnc=", "ZgRPM");
        ab.llIlIIIllI[ab.llIlIIlIll[60]] = ab.lIllIIIlIIlII("ucIr8wCyrwI=", "XXOFE");
        ab.llIlIIIllI[ab.llIlIIlIll[61]] = ab.lIllIIIlIIlII("TyMV3LQxh/A=", "dUIHl");
        ab.llIlIIIllI[ab.llIlIIlIll[62]] = ab.lIllIIIlIIlII("Jj32JUC7suGOoutJ5MczVnoVXJn0ahWb6tpfxmiTvZE=", "qvpYL");
        ab.llIlIIIllI[ab.llIlIIlIll[63]] = ab.lIllIIIlIIlIl("29ZlTFusxiRIgXdHoMvr8hheZ7j32a7yos46DxwRVIjFf4wxPFfY/g==", "liEiX");
        ab.llIlIIIllI[ab.llIlIIlIll[64]] = ab.lIllIIIlIIlII("YHDhqFIUxFsUOGzQBXexYbiC1ECw0JWf", "MvFjf");
        ab.llIlIIIllI[ab.llIlIIlIll[65]] = ab.lIllIIIlIIlII("cWUclzOCsjA=", "XdNrO");
        ab.llIlIIIllI[ab.llIlIIlIll[66]] = ab.lIllIIIlIIIll("LWsgZy8LIyYuLQNsKygxRC1tNjYBPzlm", "dLMGC");
        ab.llIlIIIllI[ab.llIlIIlIll[67]] = ab.lIllIIIlIIIll("ISduTiYLOGIDL04kJwI6TjgqCyRA", "nLBnJ");
        ab.llIlIIIllI[ab.llIlIIlIll[68]] = ab.lIllIIIlIIlIl("6y/BvCaqPqkf3qBQBqImZJe3svkSfG5qLzsWBYyVGMF+vbaVV9gc5g==", "ZuAMt");
        ab.llIlIIIllI[ab.llIlIIlIll[69]] = ab.lIllIIIlIIlIl("QYzQdWP6+6xVRJWmFS9NbQiFK1+gdSU/xPflLO6l320BMiyoC2UGDcdAJnZzfcZ0", "lxXjh");
        ab.llIlIIIllI[ab.llIlIIlIll[70]] = ab.lIllIIIlIIlIl("6bl3kn1ruSuZ3tZtFWSLtFn9SYlucsbBSONMkw7Lnw955OiI+XN2dg==", "KpIyZ");
        ab.llIlIIIllI[ab.llIlIIlIll[71]] = ab.lIllIIIlIIlII("VYPf4GYw9/w=", "cClmk");
        ab.llIlIIIllI[ab.llIlIIlIll[72]] = ab.lIllIIIlIIlIl("ZeNO94JMntQURbX42tcsu7zYD9O8Cq90QSC6qhtUHPba+0/w0QNlNg==", "cwzoX");
        ab.llIlIIIllI[ab.llIlIIlIll[73]] = ab.lIllIIIlIIIll("EisJXHACaRdQIz48H14=", "KNzpP");
        ab.llIlIIIllI[ab.llIlIIlIll[48]] = ab.lIllIIIlIIlII("AWEIgOv3ie1S98SSRfFuNw==", "JorCd");
        ab.llIlIIIllI[ab.llIlIIlIll[74]] = ab.lIllIIIlIIlIl("uXRCiJDBZcjsgvMaW7M6Pwy/uGBS/TcrlCvAl6mS0cs=", "vtIiE");
        ab.llIlIIIllI[ab.llIlIIlIll[75]] = ab.lIllIIIlIIlII("eEBNulyxc4hH3Kyf4cFrJg==", "aflTt");
    }

    private static String lIllIIIlIIlIl(String llllllllllllllllllIIlIIIIlllllII, String llllllllllllllllllIIlIIIIlllllIl) {
        try {
            ...
            Cipher llllllllllllllllllIIlIIIlIIIIIII = Cipher.getInstance("DES");
            llllllllllllllllllIIlIIIlIIIIIII.init(llIlIIlIll[3], llllllllllllllllllIIlIIIlIIIIIIl);
            return new String(llllllllllllllllllIIlIIIlIIIIIII.doFinal(Base64.getDecoder().decode(llllllllllllllllllIIlIIIIlllllII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIllIIIllllII() {
        ...
        ab.llIlIIlIll[0] = "   ".length() & ~"   ".length();
        ab.llIlIIlIll[1] = " ".length();
        ab.llIlIIlIll[2] = 68 + 49 - 32 + 50 ^ 9 + 7 - -77 + 100;
        ab.llIlIIlIll[3] = "  ".length();
        ab.llIlIIlIll[4] = -(0xFFFFA60F & 0x7FF5) & (0xFFFFE77F & 0x3FFF);
        ab.llIlIIlIll[5] = "   ".length();
        ...
        ab.llIlIIlIll[39] = (0xB6 ^ 0xAF) + "  ".length() - -(62 + 104 - 135 + 114) + (0x50 ^ 0x14);
        ...
        ab.llIlIIlIll[54] = 0x54 ^ 0x31 ^ " ".length();
    ...
    public boolean ah() {
        ...
        if (ab.lIllIIlIIlIlI(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()), llIlIIlIll[18])) {
            ...
            if (ab.lIllIIlIIIIIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                n2 = llIlIIlIll[1];
                "".length();
                if ((0x68 ^ 0x6C) > -" ".length()) return n2 != 0;
                return ((0x9D ^ 0xC5) & ~(0x5E ^ 6)) != 0;
            }
        }
        n2 = llIlIIlIll[0];
        return n2 != 0;
