...
implements ac {
    ...
    private static void lIllIIIIllIlI() {
        ...
        ao.llIlIIIlII[ao.llIlIIIlIl[0]] = ao.lIllIIIIlIlll("5Xe8MRjyDkVyzOmX0KcgxA==", "JVHfg");
        ao.llIlIIIlII[ao.llIlIIIlIl[1]] = ao.lIllIIIIllIII("9QyUU1WqOaLw4EVrbe2fgwoYxpx+qau7swljpMgYYdv5Velwqouq4gvhZ27td4TC", "LhbeE");
        ao.llIlIIIlII[ao.llIlIIIlIl[3]] = ao.lIllIIIIllIIl("Kg0QIDEFGA8nMUQYCWk0BQIN", "dlfIV");
        ao.llIlIIIlII[ao.llIlIIIlIl[4]] = ao.lIllIIIIllIII("VY74/9Ce+0LwCgYhavC6l3OWvB8601pJ", "cNtNI");
        ao.llIlIIIlII[ao.llIlIIIlIl[6]] = ao.lIllIIIIllIII("d7Lza81GlxF7l1Z0Sffu8Lj5h/3PGupzpkjWwEpGCBBv6W49NeSutCC7J8Ey1Bn3", "DBojD");
        ao.llIlIIIlII[ao.llIlIIIlIl[24]] = ao.lIllIIIIllIIl("DQUOJzMgGQY=", "IwaWC");
        ao.llIlIIIlII[ao.llIlIIIlIl[22]] = ao.lIllIIIIllIII("xZNEQlRP3Kn0sghbo+Iz1w==", "iZYBT");
        ao.llIlIIIlII[ao.llIlIIIlIl[26]] = ao.lIllIIIIllIIl("OAUvACkSTCIGNwUJMw==", "ulAiG");
        ao.llIlIIIlII[ao.llIlIIIlIl[27]] = ao.lIllIIIIlIlll("3pQRlnUYpy8=", "ErHBD");
        ao.llIlIIIlII[ao.llIlIIIlIl[28]] = ao.lIllIIIIlIlll("IB7vAWKpnlsukwbVTBVCXDP7t0O6nYSx", "zTtxf");
        ao.llIlIIIlII[ao.llIlIIIlIl[29]] = ao.lIllIIIIlIlll("pBa9ycRucktPaun9NxdsGw==", "EPiOV");
        ao.llIlIIIlII[ao.llIlIIIlIl[30]] = ao.lIllIIIIlIlll("ZDLSM0Enqxk=", "SyURk");
        ao.llIlIIIlII[ao.llIlIIIlIl[42]] = ao.lIllIIIIllIII("Jf/iYnjjJes=", "dvEDa");
        ao.llIlIIIlII[ao.llIlIIIlIl[43]] = ao.lIllIIIIllIII("i5hiV0d0dK1zLZeKoXPuWyS81YuOvD/e", "ZuBsx");
    }
                ...
                if (ao.lIllIIIlIIIII(Inventory.getCount((int[])nArray5))) {
                    ...
                    if (ao.lIllIIIlIIIII(Inventory.getCount((int[])nArray6))) {
                        ...
                        if (ao.lIllIIIlIIIII(Inventory.getCount((int[])nArray7))) {
                            ...
                            return ((0x3B ^ 0x5C ^ (0xCC ^ 0xBE)) & (77 + 133 - 185 + 131 ^ 29 + 77 - 36 + 67 ^ -" ".length())) != 0;
                        }
                    }
                }
            }
    ...
    private static void lIllIIIIllIll() {
        ...
        ao.llIlIIIlIl[0] = (57 + 211 - 100 + 59 ^ 30 + 60 - 83 + 153) & (0xE9 ^ 0xC7 ^ (0x71 ^ 0x1C) ^ -" ".length());
        ao.llIlIIIlIl[1] = " ".length();
        ao.llIlIIIlIl[2] = 0xA4 ^ 0xB2;
        ao.llIlIIIlIl[3] = "  ".length();
        ao.llIlIIIlIl[4] = "   ".length();
                    ...
                    if (ao.lIllIIIIlllII(Bank.contains((int[])nArray9) ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (ao.lIllIIIlIIIII(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (-"   ".length() >= 0) {
                                    return ((0x54 ^ 0x3F ^ (0x48 ^ 0x6D)) & (0x4D ^ 0x1E ^ (0xDF ^ 0xC2) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIlIIIlIl[0];
                            }
                    ...
                    if (ao.lIllIIIIlllII(Bank.contains((int[])nArray10) ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (ao.lIllIIIlIIIII(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if ("  ".length() < " ".length()) {
                                    return ((54 + 171 - 79 + 28 ^ 6 + 138 - 94 + 100) & (0xBB ^ 0xA4 ^ (0xAD ^ 0x8A) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIlIIIlIl[0];
                            }
                    ...
                    if (ao.lIllIIIIlllII(Bank.contains((int[])nArray12) ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (ao.lIllIIIlIIIII(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (-" ".length() >= 0) {
                                    return ((0xD7 ^ 0xA9 ^ (0xE9 ^ 0xB1)) & (0xCD ^ 0x9D ^ (0xD6 ^ 0xA0) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIlIIIlIl[0];
                            }
                    ...
                    if (ao.lIllIIIIlllII(Bank.contains((int[])nArray14) ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (ao.lIllIIIlIIIII(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if ("  ".length() <= " ".length()) {
                                    return ((158 + 171 - 188 + 40 ^ 135 + 3 - 106 + 129) & (0xB1 ^ 0x89 ^ (0x54 ^ 0x78) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIlIIIlIl[0];
                            }
