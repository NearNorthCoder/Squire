...
implements ac {
    ...
    public static boolean aM() {
        ...
        block18: {
                                        ...
                                        block8: {
                                            ...
                                            block10: {
                                                ...
                                                if (ah.lIlIllIIIlIII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                    ...
                                                    return ((160 + 149 - 246 + 184 ^ 72 + 18 - -20 + 56) & (0x30 ^ 0x75 ^ (0xB8 ^ 0xAC) ^ -" ".length())) != 0;
                                                }
                                            }
                                            n3 = llIIllIIlI[0];
                                            return n3 != 0;
            ...
            if (ah.lIlIllIIIlIII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                n2 = llIIllIIlI[1];
                "".length();
                if ((0x67 ^ 0x63) > "   ".length()) return n2 != 0;
            ...
            if (ah.lIlIllIIIllll(Players.getLocal().getInteracting())) {
                NPC llllllllllllllllllIIlllIIIlIlIlI = NPCs.getNearest(nPC -> {
                    ...
                    if (ah.lIlIllIIIlIII(nPC.getName().contains(llIIllIIII[llIIllIIlI[58]]) ? 1 : 0) && ah.lIlIllIIIllll(nPC.getInteracting()) && ah.lIlIllIIIlIlI(nPC.isDead() ? 1 : 0)) {
                        n2 = llIIllIIlI[1];
                        "".length();
                        if ("  ".length() == ((0xAA ^ 0x8B ^ (0x71 ^ 5)) & (0xFC ^ 0x86 ^ (0xB7 ^ 0x98) ^ -" ".length()))) {
                            return ((95 + 58 - 127 + 121 ^ 144 + 54 - 139 + 129) & (57 + 39 - 46 + 97 ^ 65 + 85 - 149 + 187 ^ -" ".length()) & ((0x42 ^ 0x5B ^ (0x51 ^ 0x57)) & (75 + 39 - -4 + 41 ^ 116 + 82 - 169 + 99 ^ -" ".length()) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = llIIllIIlI[0];
                    }
                ...
                List llllllllllllllllllIIlllIIIlIlIIl = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                    ...
                    if (ah.lIlIllIIlIIIl(nPC.getInteracting(), Players.getLocal())) {
                        ...
                        if ((116 + 108 - 160 + 76 ^ 16 + 88 - 53 + 85) == 0) {
                            return ((8 ^ 0x4D ^ (0xF1 ^ 0x8A)) & (0xAF ^ 0x9F ^ (0x76 ^ 0x78) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = llIIllIIlI[0];
                    }
    ...
    private static void lIlIllIIIIIlI() {
        ...
        ah.llIIllIIII[ah.llIIllIIlI[0]] = ah.lIlIlIlllllll("w4RRcrkStqNPgdUcbNPA/A==", "xwkIU");
        ah.llIIllIIII[ah.llIIllIIlI[1]] = ah.lIlIllIIIIIII("NTMpIhEbPyNrAAYjLiUFUzMzLg8Admc4FRouJCMLHT1nKQMQMWc/DVM3IicHFnozOQMaNC4lBQ==", "sZGKb");
        ah.llIIllIIII[ah.llIIllIIlI[3]] = ah.lIlIllIIIIIII("GyIdDyI0NwIIInU3BEYnNC0A", "UCkfE");
        ah.llIIllIIII[ah.llIIllIIlI[4]] = ah.lIlIllIIIIIII("LgoPPRwPBQZ5EgcFCjAeAQ==", "fkaYp");
        ah.llIIllIIII[ah.llIIllIIlI[6]] = ah.lIlIllIIIIIIl("0wfsM+oxxBfb2NxHeNLOqqYF+4SexLjjqlVfhYr3ehzPtpK/IwGTVFFSMbwyEj+z", "SsYrA");
        ah.llIIllIIII[ah.llIIllIIlI[10]] = ah.lIlIlIlllllll("l85eN/duQoAsvSHL/lxxRg==", "mXwNi");
        ah.llIIllIIII[ah.llIIllIIlI[14]] = ah.lIlIllIIIIIIl("79tncjHUo7z02m6cwJiyDQ==", "sGMXr");
        ah.llIIllIIII[ah.llIIllIIlI[15]] = ah.lIlIllIIIIIII("JSoHAx4BL1MYDwEuGh8NGg==", "hCskl");
        ah.llIIllIIII[ah.llIIllIIlI[18]] = ah.lIlIllIIIIIII("PTgi", "xYVkR");
        ah.llIIllIIII[ah.llIIllIIlI[20]] = ah.lIlIllIIIIIIl("rIfp4Cg4/hXsPCo7kz2q/A867ECAHdZ1", "tBPCM");
        ah.llIIllIIII[ah.llIIllIIlI[21]] = ah.lIlIllIIIIIII("LyUpACgKK2UPLhM/", "dLElA");
        ah.llIIllIIII[ah.llIIllIIlI[22]] = ah.lIlIllIIIIIII("Ghk9", "YvJEO");
        ah.llIIllIIII[ah.llIIllIIlI[23]] = ah.lIlIllIIIIIII("BiIz", "eMDgC");
        ah.llIIllIIII[ah.llIIllIIlI[24]] = ah.lIlIllIIIIIIl("Ys+MjeGuvMQ=", "UVadc");
        ah.llIIllIIII[ah.llIIllIIlI[25]] = ah.lIlIlIlllllll("zg7t+tgou40=", "CSOJk");
        ah.llIIllIIII[ah.llIIllIIlI[13]] = ah.lIlIllIIIIIII("Jx0YP3QUDRgxOA8JGDU=", "fhlPT");
        ah.llIIllIIII[ah.llIIllIIlI[26]] = ah.lIlIlIlllllll("S4pvpfiYiGg=", "alxYO");
        ah.llIIllIIII[ah.llIIllIIlI[29]] = ah.lIlIlIlllllll("LY0ZICYhKES86KUYXi7VrA==", "Znaak");
        ah.llIIllIIII[ah.llIIllIIlI[30]] = ah.lIlIlIlllllll("GAqbswUssluUthqAl+nOew==", "tbIOW");
        ah.llIIllIIII[ah.llIIllIIlI[31]] = ah.lIlIllIIIIIII("JCoDLyw=", "sCfCH");
        ah.llIIllIIII[ah.llIIllIIlI[19]] = ah.lIlIlIlllllll("MNkvuTAPUn/XolcAY6Il7Q==", "SwlSQ");
        ah.llIIllIIII[ah.llIIllIIlI[32]] = ah.lIlIlIlllllll("tKEeornBxxLLiqq+oMUa3Q==", "xPwqJ");
        ah.llIIllIIII[ah.llIIllIIlI[33]] = ah.lIlIllIIIIIII("Ex8nHgk=", "DvBrm");
        ah.llIIllIIII[ah.llIIllIIlI[35]] = ah.lIlIllIIIIIIl("Y31wCXaaD4dIUNhl+fujUbhB9mG1v4HG", "DmIft");
        ah.llIIllIIII[ah.llIIllIIlI[36]] = ah.lIlIllIIIIIIl("PmYY9tFwL23Ft1D6padsoq5gYVwTioM0", "gVoUe");
        ah.llIIllIIII[ah.llIIllIIlI[37]] = ah.lIlIllIIIIIIl("fUnQ0g0SvOI=", "zEFOA");
        ah.llIIllIIII[ah.llIIllIIlI[38]] = ah.lIlIlIlllllll("ecnMh2LGBKU=", "sFrZx");
        ah.llIIllIIII[ah.llIIllIIlI[39]] = ah.lIlIlIlllllll("g4tuZd3zABE=", "dwLPZ");
        ah.llIIllIIII[ah.llIIllIIlI[41]] = ah.lIlIlIlllllll("89ZNzaRkPk8=", "hwYfv");
        ah.llIIllIIII[ah.llIIllIIlI[43]] = ah.lIlIllIIIIIIl("bG9VzgCj5SI=", "cNsqo");
        ah.llIIllIIII[ah.llIIllIIlI[34]] = ah.lIlIlIlllllll("tA/wA4R2nys=", "KsaSq");
        ah.llIIllIIII[ah.llIIllIIlI[46]] = ah.lIlIllIIIIIII("LSwPOA==", "zInJD");
        ah.llIIllIIII[ah.llIIllIIlI[48]] = ah.lIlIlIlllllll("HxrUWnPw7os=", "GaNaS");
        ah.llIIllIIII[ah.llIIllIIlI[50]] = ah.lIlIlIlllllll("PeTi2zly8UQ=", "TgylI");
        ah.llIIllIIII[ah.llIIllIIlI[57]] = ah.lIlIlIlllllll("FxGIGUkCEKY=", "sQzTK");
        ah.llIIllIIII[ah.llIIllIIlI[58]] = ah.lIlIllIIIIIII("OjsD", "yTtev");
    }
    ...
    public static boolean aN() {
        ...
        block15: {
                                        ...
                                        block14: {
                                            block4: {
                                                ...
                                                block6: {
                                                    ...
                                                    n3 = llIIllIIlI[1];
                                                    "".length();
                                                    if (((0x2C ^ 0x74) & ~(0x51 ^ 9)) <= " ".length()) return n3 != 0;
            ...
            n2 = llIIllIIlI[1];
            "".length();
            if (((155 + 218 - 297 + 153 ^ 23 + 155 - 83 + 104) & ("   ".length() ^ (0x86 ^ 0xA7) ^ -" ".length())) < (131 + 103 - 225 + 126 ^ 82 + 24 - 40 + 65)) return n2 != 0;
            return ((0x60 ^ 0x2D ^ (0xD5 ^ 0xAC)) & (0x44 ^ 0x2E ^ (0xE7 ^ 0xB9) ^ -" ".length())) != 0;
        }
        n2 = llIIllIIlI[0];
        return n2 != 0;
    }
