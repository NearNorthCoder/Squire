...
implements ac {
    ...
    private static String lIlIIIIIIlIII(String llllllllllllllllllIlllIIlIIIIlII, String llllllllllllllllllIlllIIlIIIIIIl) {
        try {
            SecretKeySpec llllllllllllllllllIlllIIlIIIIlll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIlllIIlIIIIIIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllllIlllIIlIIIIllI = Cipher.getInstance("Blowfish");
            llllllllllllllllllIlllIIlIIIIllI.init(lIllllIlll[2], llllllllllllllllllIlllIIlIIIIlll);
            return new String(llllllllllllllllllIlllIIlIIIIllI.doFinal(Base64.getDecoder().decode(llllllllllllllllllIlllIIlIIIIlII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIlIIIIIIlIlI() {
        ...
        m.lIllllIllI[m.lIllllIlll[0]] = m.lIlIIIIIIIlll("tjmSghPxcdd8zdSNj3r3ag==", "kSFWb");
        m.lIllllIllI[m.lIllllIlll[1]] = m.lIlIIIIIIlIII("MQA1sl+ffv26Ft1NPEY1o05aTtRg3Q3yznM4tdQRUPIN4OJcRDwjGN5hf3yY0Trj5b806jXgOFI=", "arHKd");
        m.lIllllIllI[m.lIllllIlll[2]] = m.lIlIIIIIIIlll("JBmKyFrH22KDuuLQ9K+ZErK/iA9b8BEj", "NaWKp");
        m.lIllllIllI[m.lIllllIlll[3]] = m.lIlIIIIIIlIII("DF+N0v2rvZ/R8PXE0djKwz6MgMWzyYnZ", "sPKVT");
        m.lIllllIllI[m.lIllllIlll[5]] = m.lIlIIIIIIlIIl("HCFWGQAuZBsRATgtGB9SODEGCB4iIQVUUjgzHwwRIy0YH1I/K1Y6JxINOD8=", "KDvxr");
        m.lIllllIllI[m.lIllllIlll[17]] = m.lIlIIIIIIIlll("p93LQORGb5sG73p9QD8iXg==", "Eipwk");
        m.lIllllIllI[m.lIllllIlll[24]] = m.lIlIIIIIIIlll("Kv7NhJxSVz4oy8bU5UKFOA==", "NqQcK");
        m.lIllllIllI[m.lIllllIlll[26]] = m.lIlIIIIIIlIII("zPZGQEyEjb0dE0LpTyPif2tByJf0PGqU", "lyvXC");
        m.lIllllIllI[m.lIllllIlll[29]] = m.lIlIIIIIIIlll("9xLN6NPdL2RM0Wzf7C7DtQiSDMfnmhMr", "ydYKm");
        m.lIllllIllI[m.lIllllIlll[31]] = m.lIlIIIIIIIlll("eJSKnwqY/rPdb0FubryZ6AW7nYZBKDce", "butDP");
        m.lIllllIllI[m.lIllllIlll[32]] = m.lIlIIIIIIIlll("t+EgauqlI2SYdoj1PZ7M7JZGrgz0c1Xd", "xXvMS");
        m.lIllllIllI[m.lIllllIlll[33]] = m.lIlIIIIIIlIII("0lLvRe5ibmg=", "FTGAN");
        m.lIllllIllI[m.lIllllIlll[34]] = m.lIlIIIIIIlIIl("GCgGAS4=", "OAcmJ");
        m.lIllllIllI[m.lIllllIlll[36]] = m.lIlIIIIIIIlll("gbRgHLzr48zYLNJ3FrlPHl+uV95+zyJU", "OJHbx");
        m.lIllllIllI[m.lIllllIlll[40]] = m.lIlIIIIIIlIIl("PxsRWSAeWgQWIwI=", "qzgyT");
        m.lIllllIllI[m.lIllllIlll[41]] = m.lIlIIIIIIlIIl("JhUH", "ctsSd");
        m.lIllllIllI[m.lIllllIlll[42]] = m.lIlIIIIIIlIIl("Jg4x", "eaFkU");
        m.lIllllIllI[m.lIllllIlll[43]] = m.lIlIIIIIIlIIl("OQ4y", "ZaEEe");
        m.lIllllIllI[m.lIllllIlll[45]] = m.lIlIIIIIIlIII("kQdRFnCekePulT15uM5ahg==", "oAiVi");
        m.lIllllIllI[m.lIllllIlll[46]] = m.lIlIIIIIIIlll("frJUFzzjGn8=", "XHvrR");
        m.lIllllIllI[m.lIllllIlll[47]] = m.lIlIIIIIIlIIl("OS1hMy4dISAk", "pCAPA");
        m.lIllllIllI[m.lIllllIlll[51]] = m.lIlIIIIIIlIII("tgT2i/B65y0DMthPFP/OxroWqGVYEFjC", "zNCin");
        m.lIllllIllI[m.lIllllIlll[52]] = m.lIlIIIIIIIlll("uUvHtVpvbfxavA1kRVzDuw==", "CwYTK");
        m.lIllllIllI[m.lIllllIlll[54]] = m.lIlIIIIIIIlll("CFiwKdTwkvBIzUrc46cw7w==", "oRnvF");
        m.lIllllIllI[m.lIllllIlll[55]] = m.lIlIIIIIIlIII("T43jHbgQp28CpQkyPF+D6w==", "hCmTi");
        m.lIllllIllI[m.lIllllIlll[19]] = m.lIlIIIIIIlIIl("CColJC1tGCMiLCYu", "MKWPE");
        m.lIllllIllI[m.lIllllIlll[50]] = m.lIlIIIIIIIlll("o42pJJp5xInCwnTY84WvSQ==", "kXhRJ");
        m.lIllllIllI[m.lIllllIlll[56]] = m.lIlIIIIIIlIIl("CCUgD3odOCADMSs=", "NLRjZ");
        m.lIllllIllI[m.lIllllIlll[72]] = m.lIlIIIIIIlIIl("AiooHzRvPz0XPiEiIRE=", "OKOvW");
        m.lIllllIllI[m.lIllllIlll[74]] = m.lIlIIIIIIlIII("aAtfx+08e8EUIOaNFA4hAwSLnSSc6SaK", "hEhRE");
        m.lIllllIllI[m.lIllllIlll[75]] = m.lIlIIIIIIlIIl("Lx8a", "lpmXN");
    }

    private static void Q() {
        d llllllllllllllllllIlllIIlIlllIll;
        Object llllllllllllllllllIlllIIlIllllII;
        if (m.lIlIIIIIIllIl(Skills.getLevel((Skill)Skill.MAGIC), lIllllIlll[6])) {
            ...
            if (m.lIlIIIIIIlllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[7], lIllllIlll[59], lIllllIlll[24]);
                bv.add((d)llllllllllllllllllIlllIIlIllllII);
                "".length();
            }
            int[] nArray3 = new int[lIllllIlll[1]];
            nArray3[m.lIllllIlll[0]] = lIllllIlll[9];
            if (m.lIlIIIIIIlllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
                llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[9], lIllllIlll[60], lIllllIlll[24]);
                bv.add((d)llllllllllllllllllIlllIIlIllllII);
                "".length();
            }
            ...
            if (m.lIlIIIIIIlllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
                llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[11], lIllllIlll[61], lIllllIlll[24]);
                bv.add((d)llllllllllllllllllIlllIIlIllllII);
                "".length();
            }
            ...
            if (m.lIlIIIIIIlllI(Bank.contains((int[])nArray5) ? 1 : 0)) {
                llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[12], lIllllIlll[4], lIllllIlll[24]);
                bv.add((d)llllllllllllllllllIlllIIlIllllII);
                "".length();
            }
            ...
            if (m.lIlIIIIIIlllI(Bank.contains((int[])nArray6) ? 1 : 0)) {
                llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[44], lIllllIlll[1], e.c(lIllllIlll[62], lIllllIlll[63]));
                bv.add((d)llllllllllllllllllIlllIIlIllllII);
                "".length();
            }
        }
        if (m.lIlIIIIIlIIIl(Skills.getLevel((Skill)Skill.MAGIC), lIllllIlll[6])) {
            ...
            if (m.lIlIIIIIIllII(Bank.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (m.lIlIIIIIIllIl(Bank.getFirst((int[])nArray7).getQuantity(), lIllllIlll[61])) {
                    ...
                    llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[22], lIllllIlll[61] - Bank.getFirst((int[])nArray8).getQuantity(), lIllllIlll[64]);
                    bv.add((d)llllllllllllllllllIlllIIlIllllII);
                    "".length();
                }
            }
            ...
            if (m.lIlIIIIIIlllI(Bank.contains((int[])nArray9) ? 1 : 0)) {
                llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[22], lIllllIlll[61], lIllllIlll[64]);
                bv.add((d)llllllllllllllllllIlllIIlIllllII);
                "".length();
            }
            ...
            if (m.lIlIIIIIIllII(Bank.contains((int[])nArray10) ? 1 : 0)) {
                ...
                if (m.lIlIIIIIIllIl(Bank.getFirst((int[])nArray11).getQuantity(), lIllllIlll[61])) {
                    ...
                    llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[23], lIllllIlll[61] - Bank.getFirst((int[])nArray12).getQuantity(), lIllllIlll[65]);
                    bv.add((d)llllllllllllllllllIlllIIlIllllII);
                    "".length();
                }
            }
            ...
            if (m.lIlIIIIIIlllI(Bank.contains((int[])nArray13) ? 1 : 0)) {
                llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[23], lIllllIlll[61], lIllllIlll[65]);
                bv.add((d)llllllllllllllllllIlllIIlIllllII);
                "".length();
            }
            ...
            if (m.lIlIIIIIIlllI(Bank.contains((int[])nArray14) ? 1 : 0)) {
                ...
                if (m.lIlIIIIIIlllI(Equipment.contains((int[])nArray15) ? 1 : 0)) {
                    llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[20], lIllllIlll[1], lIllllIlll[66]);
                    bv.add((d)llllllllllllllllllIlllIIlIllllII);
                    "".length();
                }
            }
            if (m.lIlIIIIIIllII(ci ? 1 : 0)) {
                ...
                if (m.lIlIIIIIIllII(Bank.contains((int[])nArray16) ? 1 : 0)) {
                    ...
                    if (m.lIlIIIIIIllIl(Bank.getFirst((int[])nArray17).getQuantity(), lIllllIlll[61])) {
                        ...
                        llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[14], lIllllIlll[61] - Bank.getFirst((int[])nArray18).getQuantity(), lIllllIlll[58]);
                        bv.add((d)llllllllllllllllllIlllIIlIllllII);
                        "".length();
                    }
                }
                ...
                if (m.lIlIIIIIIlllI(Bank.contains((int[])nArray19) ? 1 : 0)) {
                    llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[14], lIllllIlll[61], lIllllIlll[58]);
                    bv.add((d)llllllllllllllllllIlllIIlIllllII);
                    "".length();
                }
                ...
                if (m.lIlIIIIIIllII(Bank.contains((int[])nArray20) ? 1 : 0)) {
                    ...
                    if (m.lIlIIIIIIllIl(Bank.getFirst((int[])nArray21).getQuantity(), lIllllIlll[66])) {
                        ...
                        llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[21], lIllllIlll[66] - Bank.getFirst((int[])nArray22).getQuantity(), lIllllIlll[24]);
                        bv.add((d)llllllllllllllllllIlllIIlIllllII);
                        "".length();
                    }
                }
                ...
                if (m.lIlIIIIIIlllI(Bank.contains((int[])nArray23) ? 1 : 0)) {
                    llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[21], lIllllIlll[66], lIllllIlll[24]);
                    bv.add((d)llllllllllllllllllIlllIIlIllllII);
                    "".length();
                }
            }
        ...
        if (m.lIlIIIIIIlllI(Bank.contains((int[])nArray) ? 1 : 0)) {
            llllllllllllllllllIlllIIlIllllII = new d(lIllllIlll[18], lIllllIlll[67], lIllllIlll[37]);
            bv.add((d)llllllllllllllllllIlllIIlIllllII);
            "".length();
        }
        if (m.lIlIIIIIIlllI(Bank.contains(llllllllllllllllllIlllIIlIllllII = item -> item.getName().toLowerCase().contains(lIllllIllI[lIllllIlll[74]])) ? 1 : 0)) {
            llllllllllllllllllIlllIIlIlllIll = new d(lIllllIlll[68], lIllllIlll[17], lIllllIlll[69]);
            bv.add(llllllllllllllllllIlllIIlIlllIll);
            "".length();
        }
        int[] nArray24 = new int[lIllllIlll[1]];
        nArray24[m.lIllllIlll[0]] = lIllllIlll[70];
        if (m.lIlIIIIIIlllI(Bank.contains((int[])nArray24) ? 1 : 0)) {
            llllllllllllllllllIlllIIlIlllIll = new d(lIllllIlll[70], lIllllIlll[32], lIllllIlll[71]);
            bv.add(llllllllllllllllllIlllIIlIlllIll);
            "".length();
        }
        ...
        if (m.lIlIIIIIIlllI(Bank.contains((int[])nArray25) ? 1 : 0)) {
            llllllllllllllllllIlllIIlIlllIll = new d(lIllllIlll[16], lIllllIlll[32], lIllllIlll[71]);
            bv.add(llllllllllllllllllIlllIIlIlllIll);
            "".length();
        }
    }
                        ...
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    ...
                                    return ((0x6B ^ 0x52 ^ (0x1C ^ 0x31)) & (99 + 111 - 121 + 45 ^ 64 + 53 - 78 + 107 ^ -" ".length())) != 0;
                                }
                                n4 = lIllllIlll[0];
                                return n4 != 0;
                            }
                    ...
                    if (m.lIlIIIIIlIIIl(Bank.getFirst((int[])nArray17).getQuantity(), lIllllIlll[17])) {
                        ...
                        if (m.lIlIIIIIIllII(Bank.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (m.lIlIIIIIIllII(Bank.contains((int[])nArray19) ? 1 : 0)) {
                                ...
                                return ((127 + 70 - 174 + 199 ^ 8 + 99 - 97 + 181) & (29 + 35 - -63 + 37 ^ 1 + 18 - -162 + 16 ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
    ...
    private static String lIlIIIIIIIlll(String llllllllllllllllllIlllIIlIlIlIIl, String llllllllllllllllllIlllIIlIlIIllI) {
        try {
            SecretKeySpec llllllllllllllllllIlllIIlIlIllII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIlllIIlIlIIllI.getBytes(StandardCharsets.UTF_8)), lIllllIlll[29]), "DES");
            Cipher llllllllllllllllllIlllIIlIlIlIll = Cipher.getInstance("DES");
            llllllllllllllllllIlllIIlIlIlIll.init(lIllllIlll[2], llllllllllllllllllIlllIIlIlIllII);
            return new String(llllllllllllllllllIlllIIlIlIlIll.doFinal(Base64.getDecoder().decode(llllllllllllllllllIlllIIlIlIlIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
                        ...
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    block24: {
                                        block19: {
                                            ...
                                            block20: {
                                                ...
                                                n5 = lIllllIlll[1];
                                                "".length();
                                                if (((0x11 ^ 0x42 ^ (0xC ^ 0x6A)) & (122 + 53 - 125 + 94 ^ 63 + 148 - 200 + 154 ^ -" ".length())) == 0) return n5 != 0;
                                                return ((148 + 10 - 104 + 108 ^ 162 + 136 - 247 + 135) & (61 + 116 - 137 + 99 ^ 135 + 9 - 90 + 93 ^ -" ".length())) != 0;
                                            }
                                            n5 = lIllllIlll[0];
                                            return n5 != 0;
                                        }
                                    ...
                                    return ((77 + 129 - 120 + 58 ^ 69 + 136 - 95 + 69) & (0xC2 ^ 0x95 ^ (0xEB ^ 0x9F) ^ -" ".length())) != 0;
                                }
                                n4 = lIllllIlll[0];
                                return n4 != 0;
                            }
                    ...
                    if (m.lIlIIIIIlIIIl(Inventory.getFirst((int[])nArray17).getQuantity(), lIllllIlll[17])) {
                        ...
                        if (m.lIlIIIIIIllII(Inventory.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (m.lIlIIIIIIllII(Inventory.contains((int[])nArray19) ? 1 : 0)) {
                                ...
                                "".length();
                                if ("  ".length() >= 0) return n2 != 0;
                                return ((177 + 160 - 176 + 83 ^ 7 + 27 - 11 + 125) & (65 + 8 - 63 + 209 ^ 90 + 15 - -70 + 12 ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
    ...
    private static String lIlIIIIIIlIIl(String llllllllllllllllllIlllIIlIIlIlII, String llllllllllllllllllIlllIIlIIlIIll) {
        llllllllllllllllllIlllIIlIIlIlII = new String(Base64.getDecoder().decode(llllllllllllllllllIlllIIlIIlIlII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllIlllIIlIIlIlll = new StringBuilder();
        char[] llllllllllllllllllIlllIIlIIlIllI = llllllllllllllllllIlllIIlIIlIIll.toCharArray();
        int llllllllllllllllllIlllIIlIIlIlIl = lIllllIlll[0];
        char[] llllllllllllllllllIlllIIlIIIllll = llllllllllllllllllIlllIIlIIlIlII.toCharArray();
        int llllllllllllllllllIlllIIlIIIlllI = llllllllllllllllllIlllIIlIIIllll.length;
        int llllllllllllllllllIlllIIlIIIllIl = lIllllIlll[0];
        while (m.lIlIIIIIIllIl(llllllllllllllllllIlllIIlIIIllIl, llllllllllllllllllIlllIIlIIIlllI)) {
            char llllllllllllllllllIlllIIlIIllIlI = llllllllllllllllllIlllIIlIIIllll[llllllllllllllllllIlllIIlIIIllIl];
            llllllllllllllllllIlllIIlIIlIlll.append((char)(llllllllllllllllllIlllIIlIIllIlI ^ llllllllllllllllllIlllIIlIIlIllI[llllllllllllllllllIlllIIlIIlIlIl % llllllllllllllllllIlllIIlIIlIllI.length]));
            "".length();
            ++llllllllllllllllllIlllIIlIIlIlIl;
            ++llllllllllllllllllIlllIIlIIIllIl;
            "".length();
    ...
    public static void ak() {
        ...
        if (m.lIlIIIIIIlllI(bt ? 1 : 0)) {
            BankLocation llllllllllllllllllIlllIIllIIIlIl;
            if (m.lIlIIIIIIlllI(m.an() ? 1 : 0)) {
                llllllllllllllllllIlllIIllIIIlIl = BankLocation.getNearest();
                if (m.lIlIIIIIIllll(llllllllllllllllllIlllIIllIIIlIl) && m.lIlIIIIIIlllI(llllllllllllllllllIlllIIllIIIlIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderSotf.c = lIllllIllI[lIllllIlll[2]];
                    a.a(llllllllllllllllllIlllIIllIIIlIl);
                }
                if (m.lIlIIIIIIllll(llllllllllllllllllIlllIIllIIIlIl) && m.lIlIIIIIIllII(llllllllllllllllllIlllIIllIIIlIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (m.lIlIIIIIlIIII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            if (-(0x8D ^ 0x9B ^ (0xA0 ^ 0xB2)) >= 0) {
                                                return ((0x35 ^ 0x58 ^ (0x37 ^ 0x1D)) & (45 + 76 - 85 + 162 ^ 21 + 76 - 70 + 102 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIllllIlll[0];
                                        }
                                ...
                                if (m.lIlIIIIIIllIl(Inventory.getCount((int[])nArray6), lIllllIlll[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (m.lIlIIIIIlIIII(Inventory.getCount((int[])nArray))) {
                                            bl = lIllllIlll[1];
                                            "".length();
                                            if ("   ".length() < ((0xC ^ 0x51) & ~(0xE9 ^ 0xB4))) {
                                                return ((7 ^ 0x64) & ~(0xDE ^ 0xBD)) != 0;
                                            }
                                        } else {
                                            bl = lIllllIlll[0];
                                        }
            ...
            if (m.lIlIIIIIIllII(m.an() ? 1 : 0)) {
                ...
                if (m.lIlIIIIIlIIIl(Skills.getLevel((Skill)Skill.MAGIC), lIllllIlll[6])) {
                    int llllllllllllllllllIlllIIllIIIIll;
                    ...
                    llllllllllllllllllIlllIIllIIIlIl = Inventory.getFirst((int[])nArray17);
                    int[] nArray18 = new int[lIllllIlll[1]];
                    nArray18[m.lIllllIlll[0]] = lIllllIlll[35];
                    Item llllllllllllllllllIlllIIllIIIlII = Inventory.getFirst((int[])nArray18);
                    if (m.lIlIIIIIIlllI(ci ? 1 : 0)) {
                        ...
                        if (m.lIlIIIIIIllII(Players.getLocal().getWorldLocation().equals((Object)cl) ? 1 : 0) && m.lIlIIIIIIllll(llllllllllllllllllIlllIIllIIIlIl) && m.lIlIIIIIIllll(llllllllllllllllllIlllIIllIIIlII)) {
                            llllllllllllllllllIlllIIllIIIIll = Skills.getExperience((Skill)Skill.MAGIC);
                            Magic.cast((Spell)SpellBook.Standard.HIGH_LEVEL_ALCHEMY, (Item)llllllllllllllllllIlllIIllIIIlII);
                            Time.sleepUntil(() -> {
                                boolean bl;
                                if (m.lIlIIIIIlIlll(Skills.getExperience((Skill)Skill.MAGIC), llllllllllllllllllIlllIIllIIIIll)) {
                                    bl = lIllllIlll[1];
                                    "".length();
                                    if ((8 + 125 - 128 + 173 ^ 172 + 52 - 96 + 54) < 0) {
                                        return ((116 + 75 - 118 + 61 ^ 135 + 128 - 238 + 120) & (138 + 83 - 166 + 131 ^ 8 + 60 - -73 + 32 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIllllIlll[0];
                                }
                    ...
                    if (m.lIlIIIIIIllII(ci ? 1 : 0)) {
                        if (m.lIlIIIIIIllll(llllllllllllllllllIlllIIllIIIlIl) && m.lIlIIIIIIllll(llllllllllllllllllIlllIIllIIIlII) && m.lIlIIIIIlIIlI(Players.getLocal().getAnimation(), lIllllIlll[27])) {
                            llllllllllllllllllIlllIIllIIIIll = Skills.getExperience((Skill)Skill.MAGIC);
                            Magic.cast((Spell)SpellBook.Standard.HIGH_LEVEL_ALCHEMY, (Item)llllllllllllllllllIlllIIllIIIlII);
                            Time.sleepUntil(() -> {
                                boolean bl;
                                if (m.lIlIIIIIlIlll(Skills.getExperience((Skill)Skill.MAGIC), llllllllllllllllllIlllIIllIIIIll)) {
                                    bl = lIllllIlll[1];
                                    "".length();
                                    if (-" ".length() >= ((141 + 121 - 217 + 101 ^ 54 + 169 - 104 + 67) & (0xAA ^ 0xC4 ^ (0xCA ^ 0x8C) ^ -" ".length()))) {
                                        return (("  ".length() ^ (0x1A ^ 0)) & (138 + 173 - 233 + 110 ^ 69 + 108 - 168 + 155 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIllllIlll[0];
                                }
    ...
    public boolean ah() {
        ...
        if (m.lIlIIIIIlIIIl(Skills.getLevel((Skill)Skill.MAGIC), lIllllIlll[73])) {
            ...
            if (-(0x73 ^ 0x42 ^ (0xA4 ^ 0x91)) >= 0) {
                return ((0x1F ^ 0x14 ^ (0x26 ^ 0x6D)) & (0x3E ^ 0x49 ^ (0x83 ^ 0xB4) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIllllIlll[0];
        }
    ...
    private static void lIlIIIIIIlIll() {
        ...
        m.lIllllIlll[0] = (152 + 141 - 141 + 27 ^ 71 + 110 - 157 + 149) & (0x4A ^ 0x5B ^ (0xBE ^ 0xB1) ^ -" ".length());
        m.lIllllIlll[1] = " ".length();
        m.lIllllIlll[2] = "  ".length();
        m.lIllllIlll[3] = "   ".length();
        ...
        m.lIllllIlll[71] = -"  ".length() & (0xFFFF8FA5 & 0x73DF);
    ...
    private static void am() {
        ...
        if (m.lIlIIIIIlIlIl(Players.getLocal().getInteracting())) {
            NPC llllllllllllllllllIlllIIllIIIIII = NPCs.getNearest(nPC -> {
                int n2;
                if (m.lIlIIIIIIllII(nPC.getName().contains(lIllllIllI[lIllllIlll[75]]) ? 1 : 0) && m.lIlIIIIIIlllI(nPC.isDead() ? 1 : 0)) {
                    n2 = lIllllIlll[1];
                    "".length();
                    if (((0x26 ^ 0x5D ^ (0x22 ^ 0x1D)) & (0x17 ^ 0xE ^ (0x27 ^ 0x7A) ^ -" ".length())) >= " ".length()) {
                        return ((13 + 33 - -41 + 121 ^ 76 + 35 - 106 + 139) & (75 + 142 - 160 + 173 ^ 27 + 12 - -101 + 26 ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIllllIlll[0];
                }
            ...
            List llllllllllllllllllIlllIIlIllllll = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                ...
                if (m.lIlIIIIIlIllI(nPC.getInteracting(), Players.getLocal())) {
                    bl = lIllllIlll[1];
                    "".length();
                    if (((0xA9 ^ 0xA3 ^ (0xD0 ^ 0x9A)) & (0x36 ^ 0x59 ^ (0x89 ^ 0xA6) ^ -" ".length())) != 0) {
                        return ((0x3C ^ 0x7E ^ (0x2D ^ 0x27)) & (0x45 ^ 0x5C ^ (0x11 ^ 0x40) ^ -" ".length())) != 0;
                    }
                } else {
                    bl = lIllllIlll[0];
                }
            ...
            if (m.lIlIIIIIIllll(llllllllllllllllllIlllIIllIIIIII) && m.lIlIIIIIIlllI(Players.getLocal().isMoving() ? 1 : 0)) {
                AccBuilderSotf.c = lIllllIllI[lIllllIlll[45]];
                llllllllllllllllllIlllIIllIIIIII.interact(lIllllIllI[lIllllIlll[46]]);
