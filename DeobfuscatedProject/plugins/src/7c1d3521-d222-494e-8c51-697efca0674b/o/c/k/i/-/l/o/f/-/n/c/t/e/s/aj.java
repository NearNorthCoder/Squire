...
implements ac {
        ...
        if (aj.llIIIIIIlllIl(Skills.getLevel((Skill)Skill.HERBLORE), lllIIlIlII[8])) {
            ...
            if (aj.llIIIIIIlllII(Bank.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (aj.llIIIIIIlllII(Bank.contains((int[])nArray2) ? 1 : 0)) {
                    ...
                    return (("   ".length() ^ (0x76 ^ 0x59)) & (26 + 149 - 71 + 129 ^ 115 + 163 - 274 + 193 ^ -" ".length())) != 0;
                }
            }
            n3 = lllIIlIlII[0];
            return n3 != 0;
        ...
        if (aj.llIIIIIlIIIlI(Skills.getLevel((Skill)Skill.HERBLORE), lllIIlIlII[8]) && aj.llIIIIIIlllIl(Skills.getLevel((Skill)Skill.HERBLORE), lllIIlIlII[12])) {
            ...
            if (aj.llIIIIIIlllII(Bank.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (aj.llIIIIIIlllII(Bank.contains((int[])nArray3) ? 1 : 0)) {
                    ...
                    return ((0x73 ^ 0x36 ^ (0x6D ^ 8)) & (172 + 190 - 230 + 59 ^ 36 + 13 - -51 + 59 ^ -" ".length())) != 0;
                }
            }
            n4 = lllIIlIlII[0];
            return n4 != 0;
    ...
    private static void llIIIIIIllIll() {
        ...
        aj.lllIIlIlII[23] = " ".length() ^ (0x1B ^ 0x7E);
    ...
    private static boolean an() {
        ...
        if (aj.llIIIIIlIIIlI(Skills.getLevel((Skill)Skill.HERBLORE), lllIIlIlII[8]) && aj.llIIIIIIlllIl(Skills.getLevel((Skill)Skill.HERBLORE), lllIIlIlII[12])) {
            ...
            if (aj.llIIIIIIlllII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (aj.llIIIIIIlllII(Inventory.contains((int[])nArray3) ? 1 : 0)) {
                    n4 = lllIIlIlII[1];
                    "".length();
                    if ((93 + 36 - 77 + 103 ^ 4 + 14 - -49 + 92) >= -" ".length()) return n4 != 0;
                    return ((0xAA ^ 0xBC ^ (0xF1 ^ 0xAA)) & (114 + 12 - -49 + 80 ^ 29 + 93 - 71 + 127 ^ -" ".length())) != 0;
                }
            }
            n4 = lllIIlIlII[0];
            return n4 != 0;
        ...
        if (aj.llIIIIIIlllII(Inventory.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (aj.llIIIIIIlllII(Inventory.contains((int[])nArray4) ? 1 : 0)) {
                ...
                return ((0xA8 ^ 0xA7 ^ (0x44 ^ 3)) & (0x43 ^ 0x75 ^ (0x4F ^ 0x31) ^ -" ".length())) != 0;
            }
        }
        n2 = lllIIlIlII[0];
        return n2 != 0;
    ...
    public boolean ah() {
        ...
        if (aj.llIIIIIlIIIlI(Skills.getLevel((Skill)Skill.HERBLORE), lllIIlIlII[2])) {
            ...
            "".length();
            if ("  ".length() <= " ".length()) {
                return ((85 + 73 - -11 + 15 ^ 63 + 128 - 182 + 131) & (18 + 138 - 71 + 92 ^ 58 + 72 - 32 + 35 ^ -" ".length())) != 0;
            }
        } else {
            bl = lllIIlIlII[0];
        }
    ...
    private static void llIIIIIIllIlI() {
        ...
        aj.lllIIlIIll[aj.lllIIlIlII[0]] = aj.llIIIIIIlIlll("IxM0DCEGRiQRKgwV", "afMeO");
        aj.lllIIlIIll[aj.lllIIlIlII[1]] = aj.llIIIIIIlIlll("Hi46Gx4wIjBSDy0+PRwKeC4gFwAra3QBGjEzNxoENiB0EAw7LHQGAngvMQAPNCgmFw==", "XGTrm");
        aj.lllIIlIIll[aj.lllIIlIlII[5]] = aj.llIIIIIIllIII("CuMwg/RrMcWdEmHyjfrBHPFYH/F6+fHa", "LJSvE");
        aj.lllIIlIIll[aj.lllIIlIlII[6]] = aj.llIIIIIIllIII("dtQRWIAgxMTpTM65ZJoMNy94U4PT+69u", "TaABx");
        aj.lllIIlIIll[aj.lllIIlIlII[4]] = aj.llIIIIIIllIIl("eohisk/f7z0K7kiRyu2b5BX7eb+hWwPDWqPZ62/7DGQN8/i8u2kge+zU/9yurU71", "TTOIU");
        aj.lllIIlIIll[aj.lllIIlIlII[16]] = aj.llIIIIIIllIII("hJkP+CxA4x1ANXV4AK7Tyg==", "UxHHw");
        aj.lllIIlIIll[aj.lllIIlIlII[31]] = aj.llIIIIIIllIIl("y2q3JlSM2YlSkPKSV7jFbg==", "CogyR");
        aj.lllIIlIIll[aj.lllIIlIlII[32]] = aj.llIIIIIIllIIl("GeVp3LPU9L0=", "wOKhT");
        aj.lllIIlIIll[aj.lllIIlIlII[33]] = aj.llIIIIIIllIIl("JQ+2mZcF5Ck=", "BIfcL");
        aj.lllIIlIIll[aj.lllIIlIlII[34]] = aj.llIIIIIIllIIl("DEEwxMDJXYs=", "KmWyu");
    }
            ...
            if (aj.llIIIIIlIIIII(lllllllllllllllllIlllIllIIlIllII = Widgets.get((int)lllIIlIlII[17], (int)lllIIlIlII[18]))) {
                ...
                Time.sleepUntil(() -> {
                    ...
                    block4: {
                        ...
                        return ((141 + 91 - 161 + 75 ^ 110 + 110 - 128 + 74) & (0xC8 ^ 0xA6 ^ (0x7B ^ 0x21) ^ -" ".length())) != 0;
                    }
                    bl = lllIIlIlII[0];
                    return bl;
                }, (int)lllIIlIlII[19]);
