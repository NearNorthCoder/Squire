...
implements ac {
    ...
    private static void llIIIIIlIlIlI() {
        ...
        aw.lllIIlIlIl[aw.lllIIlIllI[0]] = aw.llIIIIIlIIlll("APZ//lxWMSXTKfLMPgbv5Q==", "sVZWj");
        aw.lllIIlIlIl[aw.lllIIlIllI[1]] = aw.llIIIIIlIlIII("Gann/9CBc5FN1HqNQzGjyb7/Akp6kYjv4HwPcysG2BrPluC7oqqg1aUaK3VUBlVPNKPNKjRwejI=", "dFdAK");
        aw.lllIIlIlIl[aw.lllIIlIllI[2]] = aw.llIIIIIlIIlll("00QHanii/QyvJu+tw6HzKv1HZiDP6xJE", "DoGyg");
        aw.lllIIlIlIl[aw.lllIIlIllI[3]] = aw.llIIIIIlIIlll("CFPfy34TkbR+1xm3/ILeWQ==", "iFjif");
        aw.lllIIlIlIl[aw.lllIIlIllI[5]] = aw.llIIIIIlIlIII("sbki22WIgms=", "RzTlj");
        aw.lllIIlIlIl[aw.lllIIlIllI[6]] = aw.llIIIIIlIlIII("QSahXx1MABFyszk0R8Y274vs1fPoZDc4", "rSlrQ");
        aw.lllIIlIlIl[aw.lllIIlIllI[9]] = aw.llIIIIIlIlIIl("NA5ZIDEGSxQoMBACFyZjEQIXJjBPSwo2KhcIESgtBEsNLmMhPiAIDSQ=", "ckyAC");
        aw.lllIIlIlIl[aw.lllIIlIllI[11]] = aw.llIIIIIlIIlll("VZdRqFRTAwhd+1fQae5C+qQEP8ByHve0IFSpIZ1ZawGvMmL0wTfU6Q==", "KMsFE");
        aw.lllIIlIlIl[aw.lllIIlIllI[13]] = aw.llIIIIIlIlIIl("MDBEFDoCdQkcOxQ8ChJoDzQJGC0VeUQGPw4hBx0hCTJEASdHFzEsASkS", "gUduH");
        aw.lllIIlIlIl[aw.lllIIlIllI[15]] = aw.llIIIIIlIIlll("XLoPAoD5xKcPOQuTb6347Pl23nZ0MFDYCnE45VUTSs/A2ikhaoassXMHLZwcXBLC", "GKrWq");
        aw.lllIIlIlIl[aw.lllIIlIllI[18]] = aw.llIIIIIlIlIII("mOjJA965DqUjhrsrcYEsvWDP2WK3RQqqC6o+mujJqTTeDNyIkfkdmwX1o+lYpZAF", "CKtCV");
        aw.lllIIlIlIl[aw.lllIIlIllI[20]] = aw.llIIIIIlIlIIl("LipoNAscbyU8CgomJjJZCSMpOxJVbzsiEA0sIDwXHm88Olk7GhEcNz4=", "yOHUy");
        aw.lllIIlIlIl[aw.lllIIlIllI[22]] = aw.llIIIIIlIlIIl("FCBvECAmZSIYITAsIRZyLCQkUSIvJCEaIW9lPAY7NyYnGDwkZTsecgEQFjgcBA==", "CEOqR");
        aw.lllIIlIlIl[aw.lllIIlIllI[29]] = aw.llIIIIIlIlIIl("EDM+HRU8LCxUASAnJw==", "UBKte");
        aw.lllIIlIlIl[aw.lllIIlIllI[30]] = aw.llIIIIIlIlIIl("LzMJFA==", "xVhfu");
        aw.lllIIlIlIl[aw.lllIIlIllI[32]] = aw.llIIIIIlIlIIl("DwAzeiUuQS01JDIEZT0kOA==", "AaEZQ");
        aw.lllIIlIlIl[aw.lllIIlIllI[33]] = aw.llIIIIIlIIlll("eWnqzfQMRnq6VmeKYpC+qg==", "TYMRo");
        aw.lllIIlIlIl[aw.lllIIlIllI[34]] = aw.llIIIIIlIIlll("qDL7dsZyGIZ35H+PCd+GXA==", "mtrdB");
        aw.lllIIlIlIl[aw.lllIIlIllI[36]] = aw.llIIIIIlIIlll("AEBfg+a6vjzK7+qUYyK0NQ==", "rFwCQ");
        aw.lllIIlIlIl[aw.lllIIlIllI[37]] = aw.llIIIIIlIlIII("2Xf+oAPGoYr84mM451OHXQ==", "Sdgjj");
        aw.lllIIlIlIl[aw.lllIIlIllI[39]] = aw.llIIIIIlIIlll("EC5rQfeWe/kMld1bSKZ0zA==", "DdgkE");
        aw.lllIIlIlIl[aw.lllIIlIllI[40]] = aw.llIIIIIlIlIII("Ep6IOIcWs70=", "GBaZb");
        aw.lllIIlIlIl[aw.lllIIlIllI[41]] = aw.llIIIIIlIIlll("Al1QohwkDb0y7gAXr3BEz01lhJDrJrY3", "hgYGN");
        aw.lllIIlIlIl[aw.lllIIlIllI[16]] = aw.llIIIIIlIIlll("GF0b+a3JAt8=", "IccqU");
        aw.lllIIlIlIl[aw.lllIIlIllI[43]] = aw.llIIIIIlIlIIl("KQIMJDECGQJoNgMWDDo=", "kweHU");
        aw.lllIIlIlIl[aw.lllIIlIllI[46]] = aw.llIIIIIlIIlll("5984mdJoYfU=", "ZMIne");
        aw.lllIIlIlIl[aw.lllIIlIllI[48]] = aw.llIIIIIlIlIII("Mzm55Cr+mm0/drRTqbimmw==", "uKoVC");
        aw.lllIIlIlIl[aw.lllIIlIllI[49]] = aw.llIIIIIlIlIIl("GAkvOCMv", "JlBWU");
        aw.lllIIlIlIl[aw.lllIIlIllI[27]] = aw.llIIIIIlIlIIl("LTwd", "tYnkU");
        aw.lllIIlIlIl[aw.lllIIlIllI[51]] = aw.llIIIIIlIlIIl("AQYKAyUqHQRPNiwcB08tIgEHCjM=", "CscoA");
        aw.lllIIlIlIl[aw.lllIIlIllI[53]] = aw.llIIIIIlIIlll("c2xhspnYSWg=", "hdTnu");
        aw.lllIIlIlIl[aw.lllIIlIllI[55]] = aw.llIIIIIlIlIIl("EBYnCSYrHS0=", "BsJfP");
        aw.lllIIlIlIl[aw.lllIIlIllI[56]] = aw.llIIIIIlIlIIl("HxwFKjgo", "MyhEN");
        aw.lllIIlIlIl[aw.lllIIlIllI[57]] = aw.llIIIIIlIIlll("+bbnKPjvPhg=", "ehPaC");
        aw.lllIIlIlIl[aw.lllIIlIllI[58]] = aw.llIIIIIlIlIIl("IAMTCxBCGRsMVBYXGAsR", "bvzgt");
        aw.lllIIlIlIl[aw.lllIIlIllI[61]] = aw.llIIIIIlIlIII("+eXcVc5Ttuo=", "rnmAP");
        aw.lllIIlIlIl[aw.lllIIlIllI[63]] = aw.llIIIIIlIIlll("ZRzLMl45rkEprA2u9Psi0g==", "WTPSZ");
        aw.lllIIlIlIl[aw.lllIIlIllI[64]] = aw.llIIIIIlIlIIl("HworAQIo", "MoFnt");
        aw.lllIIlIlIl[aw.lllIIlIllI[65]] = aw.llIIIIIlIlIIl("Lz0j", "vXPfI");
        aw.lllIIlIlIl[aw.lllIIlIllI[66]] = aw.llIIIIIlIlIIl("LwYkFClNHCwTbQESPxwoHw==", "msMxM");
        aw.lllIIlIlIl[aw.lllIIlIllI[67]] = aw.llIIIIIlIIlll("Mg+425AVJNg=", "HSaxw");
        aw.lllIIlIlIl[aw.lllIIlIllI[68]] = aw.llIIIIIlIlIII("9kRaxDdLMQw=", "QmqOy");
        aw.lllIIlIlIl[aw.lllIIlIllI[70]] = aw.llIIIIIlIIlll("kaZiNQuwaw5n7gmSGZ7bdg==", "jaRMO");
        aw.lllIIlIlIl[aw.lllIIlIllI[71]] = aw.llIIIIIlIIlll("oxVDvVhDwRI=", "ohJMP");
        aw.lllIIlIlIl[aw.lllIIlIllI[72]] = aw.llIIIIIlIIlll("BP4Dj9LRt98=", "xLJPH");
        aw.lllIIlIlIl[aw.lllIIlIllI[73]] = aw.llIIIIIlIlIII("JnEHVzoMccWm9iKl+zqjSA==", "SwIzZ");
        aw.lllIIlIlIl[aw.lllIIlIllI[77]] = aw.llIIIIIlIIlll("IU1/DIqH1hk2JguvdYE+2FyFFDQ+DDhm", "kiPeS");
        aw.lllIIlIlIl[aw.lllIIlIllI[79]] = aw.llIIIIIlIlIIl("HyYUBgQ7", "IOqqa");
        aw.lllIIlIlIl[aw.lllIIlIllI[81]] = aw.llIIIIIlIlIII("9ULsbz/Oq9U=", "sqVWX");
        aw.lllIIlIlIl[aw.lllIIlIllI[83]] = aw.llIIIIIlIlIIl("EwwFVwc9Bww=", "Rhawu");
        aw.lllIIlIlIl[aw.lllIIlIllI[84]] = aw.llIIIIIlIlIIl("CSA6AjInJw==", "BINaZ");
        aw.lllIIlIlIl[aw.lllIIlIllI[85]] = aw.llIIIIIlIlIIl("IwwhNA==", "gcOQj");
        aw.lllIIlIlIl[aw.lllIIlIllI[87]] = aw.llIIIIIlIlIIl("KCY/IDwOO2ctJAQqITkhGCw=", "kIJNH");
        aw.lllIIlIlIl[aw.lllIIlIllI[88]] = aw.llIIIIIlIIlll("z50Ka2ok3ZQ=", "QzQxD");
        aw.lllIIlIlIl[aw.lllIIlIllI[89]] = aw.llIIIIIlIlIII("AJmvFvdz80JfTpLm9brJCdja0J9yB0Ku", "jQUcg");
        aw.lllIIlIlIl[aw.lllIIlIllI[90]] = aw.llIIIIIlIlIII("yLMV2ALjOl4=", "sJauL");
        aw.lllIIlIlIl[aw.lllIIlIllI[91]] = aw.llIIIIIlIlIII("NmJsJvNHDKg=", "jmYoX");
        aw.lllIIlIlIl[aw.lllIIlIllI[93]] = aw.llIIIIIlIlIII("nJKHW+/0xsluyW7UJVArqA==", "NrMsU");
        aw.lllIIlIlIl[aw.lllIIlIllI[94]] = aw.llIIIIIlIlIII("jH1R1LCHBt2jGyiKWeMnBw==", "wBBIF");
        aw.lllIIlIlIl[aw.lllIIlIllI[95]] = aw.llIIIIIlIIlll("Q8sa+f53BPw=", "JhRip");
        aw.lllIIlIlIl[aw.lllIIlIllI[96]] = aw.llIIIIIlIlIIl("Bx4TCTchA0sELysSDRAqNxQ=", "DqfgC");
        aw.lllIIlIlIl[aw.lllIIlIllI[97]] = aw.llIIIIIlIlIIl("EyQZCQ==", "WKwlK");
        aw.lllIIlIlIl[aw.lllIIlIllI[86]] = aw.llIIIIIlIlIII("6oE4Cvmu85k=", "LLJTf");
        aw.lllIIlIlIl[aw.lllIIlIllI[98]] = aw.llIIIIIlIlIII("0pV//Xbb7HwAJZR8z3BY4phd8oAeaDJ1", "DjRSU");
        aw.lllIIlIlIl[aw.lllIIlIllI[99]] = aw.llIIIIIlIlIII("BBj3NKKXoOM=", "Zvlgs");
        aw.lllIIlIlIl[aw.lllIIlIllI[80]] = aw.llIIIIIlIIlll("jFexzoZTaaGIi5Knfrlhvw==", "iFCYH");
        aw.lllIIlIlIl[aw.lllIIlIllI[104]] = aw.llIIIIIlIIlll("jMM3V9kMPSi/aiGSTxmy6k4W+LkYWJz2", "CQhEL");
        aw.lllIIlIlIl[aw.lllIIlIllI[105]] = aw.llIIIIIlIlIII("fS7V5VJlyoA=", "WzGbu");
        aw.lllIIlIlIl[aw.lllIIlIllI[106]] = aw.llIIIIIlIlIIl("DQAVJjY3", "EaxKS");
        aw.lllIIlIlIl[aw.lllIIlIllI[107]] = aw.llIIIIIlIlIIl("HQAuJzw=", "MlOIW");
        aw.lllIIlIlIl[aw.lllIIlIllI[108]] = aw.llIIIIIlIlIII("YRenMj2MevU=", "wgKKy");
        aw.lllIIlIlIl[aw.lllIIlIllI[109]] = aw.llIIIIIlIlIII("UCfgDO0e/KtUyeiE2v1Yzg==", "vxxfP");
        aw.lllIIlIlIl[aw.lllIIlIllI[110]] = aw.llIIIIIlIlIIl("BQY8HyM+ESRaJz5DOBUmIgY=", "QcPzS");
        aw.lllIIlIlIl[aw.lllIIlIllI[111]] = aw.llIIIIIlIlIIl("ICkf", "sHhRW");
        aw.lllIIlIlIl[aw.lllIIlIllI[112]] = aw.llIIIIIlIIlll("zYC6+AggX0k=", "yjdiM");
        aw.lllIIlIlIl[aw.lllIIlIllI[113]] = aw.llIIIIIlIlIII("erAZgejuEU8=", "LKdPg");
        aw.lllIIlIlIl[aw.lllIIlIllI[114]] = aw.llIIIIIlIlIIl("Nj0PFgI=", "fQnxi");
        aw.lllIIlIlIl[aw.lllIIlIllI[115]] = aw.llIIIIIlIlIII("hDfAhOa0GEG07jZ0c6/9xWn/eQTY8cSi", "EtRCa");
        aw.lllIIlIlIl[aw.lllIIlIllI[116]] = aw.llIIIIIlIIlll("MW1NSqEQoh0=", "wBHcx");
        aw.lllIIlIlIl[aw.lllIIlIllI[117]] = aw.llIIIIIlIIlll("8HHbMEo37Ak=", "vurUg");
        aw.lllIIlIlIl[aw.lllIIlIllI[118]] = aw.llIIIIIlIlIII("RD5wRCRRf6a7At/FYz1GgioeT5QWAjW2", "wXjVO");
        aw.lllIIlIlIl[aw.lllIIlIllI[119]] = aw.llIIIIIlIlIIl("Bggg", "UiWMf");
        aw.lllIIlIlIl[aw.lllIIlIllI[120]] = aw.llIIIIIlIlIIl("Ly03PCkV", "gLZQL");
        aw.lllIIlIlIl[aw.lllIIlIllI[92]] = aw.llIIIIIlIIlll("6qhdEXWLmzEjc4bUAQvJzg==", "EEHxS");
        aw.lllIIlIlIl[aw.lllIIlIllI[135]] = aw.llIIIIIlIlIIl("NSw8IWMoI3IxJiYpJi5jbw==", "GERFC");
        aw.lllIIlIlIl[aw.lllIIlIllI[136]] = aw.llIIIIIlIlIIl("NgsqFWMrBGQWNiEOLRwkbA==", "DbDrC");
        aw.lllIIlIlIl[aw.lllIIlIllI[137]] = aw.llIIIIIlIlIII("TPqlXJ/u6SI6AmJ7SylsHq24D5PQbFmf", "hEtMy");
        aw.lllIIlIlIl[aw.lllIIlIllI[140]] = aw.llIIIIIlIIlll("LK9d6qMTwCMfRJU21+bdCX06S7RiFTy/", "TJwJa");
        aw.lllIIlIlIl[aw.lllIIlIllI[141]] = aw.llIIIIIlIlIIl("Hg4rRRsrDjkWDmY=", "GkXek");
    }
    ...
    private static String llIIIIIlIIlll(String lllllllllllllllllIlllIlIlIlIllII, String lllllllllllllllllIlllIlIlIlIlIll) {
        try {
            SecretKeySpec lllllllllllllllllIlllIlIlIllIIIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIlllIlIlIlIlIll.getBytes(StandardCharsets.UTF_8)), lllIIlIllI[13]), "DES");
            ...
            return new String(lllllllllllllllllIlllIlIlIllIIII.doFinal(Base64.getDecoder().decode(lllllllllllllllllIlllIlIlIlIllII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public boolean ah() {
        ...
        if (aw.llIIIIIllIIIl(Skills.getLevel((Skill)Skill.CONSTRUCTION), lllIIlIllI[134])) {
            ...
            "".length();
            if (-" ".length() != -" ".length()) {
                return ((170 + 84 - 200 + 147 ^ 121 + 107 - 131 + 37) & (0xF0 ^ 0xAF ^ (0x78 ^ 0x68) ^ -" ".length())) != 0;
            }
        } else {
            bl = lllIIlIllI[0];
        }
                ...
                if (aw.llIIIIIlIllII(Inventory.contains((String[])stringArray15) ? 1 : 0)) {
                    ...
                    if (aw.llIIIIIlIllII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                        ...
                        if (aw.llIIIIIllIIIl(Inventory.getAll((int[])nArray3).size(), lllIIlIllI[13]) && (!aw.llIIIIIlIlllI(Inventory.contains((int[])f.aS) ? 1 : 0) || aw.llIIIIIlIllII(Equipment.contains((int[])f.aS) ? 1 : 0))) {
                            n2 = lllIIlIllI[1];
                            "".length();
                            if (((0x2A ^ 0x39 ^ (0x6F ^ 0x6A)) & (48 + 150 - 171 + 142 ^ 70 + 178 - 120 + 63 ^ -" ".length())) <= 0) return n2 != 0;
                            return ((0x34 ^ 0x14 ^ (0x43 ^ 0x3B)) & (0x1A ^ 0x4F ^ (0xCA ^ 0xC7) ^ -" ".length())) != 0;
                        }
                    }
                }
            }
    ...
    private static String llIIIIIlIlIII(String lllllllllllllllllIlllIlIlIlIIIIl, String lllllllllllllllllIlllIlIlIlIIIII) {
        try {
            SecretKeySpec lllllllllllllllllIlllIlIlIlIIlII = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIlllIlIlIlIIIII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            return new String(lllllllllllllllllIlllIlIlIlIIIll.doFinal(Base64.getDecoder().decode(lllllllllllllllllIlllIlIlIlIIIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void eI() {
        Widget lllllllllllllllllIlllIlIllIlIllI;
        if (aw.llIIIIIlIllIl(Skills.getLevel((Skill)Skill.CONSTRUCTION), lllIIlIllI[18])) {
            int[] nArray = new int[lllIIlIllI[1]];
                    ...
                    if (aw.llIIIIIlIllll(TileObjects.getNearest((int[])nArray2))) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (aw.llIIIIIlIlllI(Widgets.get((int)lllIIlIllI[44]).isEmpty() ? 1 : 0)) {
                                bl = lllIIlIllI[1];
                                "".length();
                                if (-" ".length() > (0x6D ^ 0x49 ^ (0x4F ^ 0x6F))) {
                                    return ((0x57 ^ 0x60 ^ (0xA ^ 0x6C)) & (0x7A ^ 0x18 ^ (0x54 ^ 0x67) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lllIIlIllI[0];
                            }
        ...
        if (aw.llIIIIIllIIIl(Skills.getLevel((Skill)Skill.CONSTRUCTION), lllIIlIllI[18]) && aw.llIIIIIlIllIl(Skills.getLevel((Skill)Skill.CONSTRUCTION), lllIIlIllI[16]) && aw.llIIIIIlIllII(aw.eN() ? 1 : 0)) {
            ...
            if (aw.llIIIIIlIllll(TileObjects.getNearest((int[])nArray))) {
                ...
                if (aw.llIIIIIlIlllI(Widgets.get((int)lllIIlIllI[44]).isEmpty() ? 1 : 0) && aw.llIIIIIlIllll(lllllllllllllllllIlllIlIllIlIllI = Widgets.get((int)lllIIlIllI[44], (int)lllIIlIllI[5]))) {
                    Mouse.click((int)lllllllllllllllllIlllIlIllIlIllI.getChild(lllIIlIllI[9]).getClickPoint().getX(), (int)lllllllllllllllllIlllIlIllIlIllI.getChild(lllIIlIllI[9]).getClickPoint().getY(), (boolean)lllIIlIllI[1]);
                    Time.sleepUntil(() -> {
                        boolean bl;
                        int[] nArray = new int[lllIIlIllI[1]];
                        nArray[aw.lllIIlIllI[0]] = lllIIlIllI[50];
                        if (aw.llIIIIIlIllll(TileObjects.getNearest((int[])nArray))) {
                            bl = lllIIlIllI[1];
                            "".length();
                            if (((85 + 5 - -19 + 110 ^ 127 + 129 - 162 + 50) & (4 ^ 0x24 ^ (0x4D ^ 0x26) ^ -" ".length())) != 0) {
                                return ((101 + 3 - -12 + 26 ^ 15 + 0 - 13 + 184) & (0x77 ^ 0x45 ^ (0x8D ^ 0x8B) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lllIIlIllI[0];
                        }
        ...
        if (aw.llIIIIIllIIIl(Skills.getLevel((Skill)Skill.CONSTRUCTION), lllIIlIllI[16]) && aw.llIIIIIlIllIl(Skills.getLevel((Skill)Skill.CONSTRUCTION), lllIIlIllI[57]) && aw.llIIIIIlIllII(aw.eN() ? 1 : 0)) {
            ...
            if (aw.llIIIIIlIllll(TileObjects.getNearest((int[])nArray))) {
                if (aw.llIIIIIlIlllI(Widgets.get((int)lllIIlIllI[44]).isEmpty() ? 1 : 0) && aw.llIIIIIlIllll(lllllllllllllllllIlllIlIllIlIllI = Widgets.get((int)lllIIlIllI[44], (int)lllIIlIllI[6]))) {
                    Mouse.click((int)lllllllllllllllllIlllIlIllIlIllI.getChild(lllIIlIllI[5]).getClickPoint().getX(), (int)lllllllllllllllllIlllIlIllIlIllI.getChild(lllIIlIllI[5]).getClickPoint().getY(), (boolean)lllIIlIllI[1]);
                    Time.sleepUntil(() -> {
                        boolean bl;
                        int[] nArray = new int[lllIIlIllI[1]];
                        ...
                        if (aw.llIIIIIlIllll(TileObjects.getNearest((int[])nArray))) {
                            bl = lllIIlIllI[1];
                            "".length();
                            if ("   ".length() < ((0xA4 ^ 0x92 ^ (0x75 ^ 0x53)) & (0xA7 ^ 0xB6 ^ " ".length() ^ -" ".length()))) {
                                return ((0x75 ^ 0x20 ^ (0xF ^ 0x6C)) & (0xE2 ^ 0xBA ^ (0x3A ^ 0x54) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lllIIlIllI[0];
                        }
                    ...
                    if (aw.llIIIIIlIllll(TileObjects.getNearest((int[])nArray10))) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (aw.llIIIIIlIlllI(Widgets.get((int)lllIIlIllI[44]).isEmpty() ? 1 : 0)) {
                                ...
                                "".length();
                                if (-" ".length() > 0) {
                                    return ((0x64 ^ 0xB ^ (0xE6 ^ 0xB1)) & (227 + 65 - 127 + 83 ^ 57 + 134 - 99 + 100 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lllIIlIllI[0];
                            }
                ...
                if (aw.llIIIIIlIlllI(Widgets.get((int)lllIIlIllI[44]).isEmpty() ? 1 : 0) && aw.llIIIIIlIllll(lllllllllllllllllIlllIlIllIlIllI = Widgets.get((int)lllIIlIllI[44], (int)lllIIlIllI[6]))) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (aw.llIIIIIlIllll(TileObjects.getNearest((int[])nArray))) {
                            ...
                            "".length();
                            if (" ".length() > "   ".length()) {
                                return ((0x26 ^ 0x69 ^ (0xA5 ^ 0xC7)) & (29 + 198 - 91 + 102 ^ 153 + 154 - 113 + 1 ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lllIIlIllI[0];
                        }
    ...
    private static void llIIIIIlIlIll() {
        ...
        aw.lllIIlIllI[1] = " ".length();
        aw.lllIIlIllI[2] = "  ".length();
        aw.lllIIlIllI[3] = "   ".length();
        ...
        aw.lllIIlIllI[41] = "   ".length() ^ (0x1A ^ 0xF);
        ...
        aw.lllIIlIllI[54] = -"   ".length() & (0xFFFFBEFF & 0x75FF);
        ...
        aw.lllIIlIllI[70] = 0x25 ^ 0xC ^ "   ".length();
        ...
        aw.lllIIlIllI[90] = 0x4C ^ 0x78 ^ "   ".length();
        ...
        aw.lllIIlIllI[117] = "   ".length() ^ (0x58 ^ 0x14);
    ...
    private static void Q() {
        d lllllllllllllllllIlllIlIllIlIIII;
        Object lllllllllllllllllIlllIlIllIlIIIl;
        Object lllllllllllllllllIlllIlIllIlIIlI;
        block24: {
            block23: {
                block21: {
                    block22: {
                        block17: {
                            block20: {
                                block19: {
                                    ...
                                    lllllllllllllllllIlllIlIllIlIIlI = new d(lllIIlIllI[19], lllIIlIllI[121], e.c(lllIIlIllI[122], lllIIlIllI[123]));
                                    bv.add((d)lllllllllllllllllIlllIlIllIlIIlI);
                                    "".length();
                                }
                                int[] nArray = new int[lllIIlIllI[1]];
                            ...
                            lllllllllllllllllIlllIlIllIlIIlI = new d(lllIIlIllI[17], lllIIlIllI[23], lllIIlIllI[67]);
                            bv.add((d)lllllllllllllllllIlllIlIllIlIIlI);
                            "".length();
                        }
                    ...
                    lllllllllllllllllIlllIlIllIlIIlI = new d(lllIIlIllI[21], lllIIlIllI[124], lllIIlIllI[125]);
                    bv.add((d)lllllllllllllllllIlllIlIllIlIIlI);
                    "".length();
                }
                int[] nArray = new int[lllIIlIllI[1]];
            ...
            lllllllllllllllllIlllIlIllIlIIlI = new d(lllIIlIllI[14], lllIIlIllI[126], lllIIlIllI[127]);
            bv.add((d)lllllllllllllllllIlllIlIllIlIIlI);
            "".length();
        }
        int[] nArray = new int[lllIIlIllI[1]];
        ...
        if (aw.llIIIIIlIlllI(Bank.contains((int[])nArray) ? 1 : 0)) {
            lllllllllllllllllIlllIlIllIlIIlI = new d(lllIIlIllI[12], lllIIlIllI[1], lllIIlIllI[128]);
            bv.add((d)lllllllllllllllllIlllIlIllIlIIlI);
            "".length();
        }
        int[] nArray10 = new int[lllIIlIllI[1]];
        ...
        if (aw.llIIIIIlIlllI(Bank.contains((int[])nArray10) ? 1 : 0)) {
            lllllllllllllllllIlllIlIllIlIIlI = new d(lllIIlIllI[10], lllIIlIllI[1], lllIIlIllI[128]);
            bv.add((d)lllllllllllllllllIlllIlIllIlIIlI);
            "".length();
        }
        if (aw.llIIIIIlIlllI(Bank.contains((Predicate)(lllllllllllllllllIlllIlIllIlIIlI = item -> item.getName().toLowerCase().contains(lllIIlIlIl[lllIIlIllI[136]]))) ? 1 : 0)) {
            lllllllllllllllllIlllIlIllIlIIIl = new d(lllIIlIllI[28], lllIIlIllI[39], lllIIlIllI[129]);
            bv.add((d)lllllllllllllllllIlllIlIllIlIIIl);
            "".length();
        }
        if (aw.llIIIIIlIlllI(Bank.contains(lllllllllllllllllIlllIlIllIlIIIl = item -> item.getName().toLowerCase().contains(lllIIlIlIl[lllIIlIllI[135]])) ? 1 : 0)) {
            lllllllllllllllllIlllIlIllIlIIII = new d(lllIIlIllI[130], lllIIlIllI[2], lllIIlIllI[26]);
            bv.add(lllllllllllllllllIlllIlIllIlIIII);
            "".length();
        }
        int[] nArray11 = new int[lllIIlIllI[1]];
        nArray11[aw.lllIIlIllI[0]] = lllIIlIllI[131];
        if (aw.llIIIIIlIlllI(Bank.contains((int[])nArray11) ? 1 : 0)) {
            lllllllllllllllllIlllIlIllIlIIII = new d(lllIIlIllI[131], lllIIlIllI[67], lllIIlIllI[132]);
            bv.add(lllllllllllllllllIlllIlIllIlIIII);
            "".length();
        }
    }
    ...
    private static String llIIIIIlIlIIl(String lllllllllllllllllIlllIlIlIlllllI, String lllllllllllllllllIlllIlIllIIIIlI) {
        lllllllllllllllllIlllIlIlIlllllI = new String(Base64.getDecoder().decode(lllllllllllllllllIlllIlIlIlllllI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllIlllIlIllIIIIIl = new StringBuilder();
        ...
        char[] lllllllllllllllllIlllIlIlIlllIIl = lllllllllllllllllIlllIlIlIlllllI.toCharArray();
        int lllllllllllllllllIlllIlIlIlllIII = lllllllllllllllllIlllIlIlIlllIIl.length;
        int lllllllllllllllllIlllIlIlIllIlll = lllIIlIllI[0];
        while (aw.llIIIIIlIllIl(lllllllllllllllllIlllIlIlIllIlll, lllllllllllllllllIlllIlIlIlllIII)) {
            char lllllllllllllllllIlllIlIllIIIlII = lllllllllllllllllIlllIlIlIlllIIl[lllllllllllllllllIlllIlIlIllIlll];
            lllllllllllllllllIlllIlIllIIIIIl.append((char)(lllllllllllllllllIlllIlIllIIIlII ^ lllllllllllllllllIlllIlIllIIIIII[lllllllllllllllllIlllIlIlIllllll % lllllllllllllllllIlllIlIllIIIIII.length]));
            "".length();
            ++lllllllllllllllllIlllIlIlIllllll;
            ++lllllllllllllllllIlllIlIlIllIlll;
            "".length();
            if (-" ".length() <= 0) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllIlllIlIllIIIIIl);
    }
    ...
    public static void eH() {
        block39: {
            BankLocation lllllllllllllllllIlllIlIllIllIIl;
            block40: {
                block41: {
                    block42: {
                        Predicate<Item> lllllllllllllllllIlllIlIllIllIII;
                        ...
                        lllllllllllllllllIlllIlIllIllIIl = BankLocation.getNearest();
                        if (aw.llIIIIIlIllll(lllllllllllllllllIlllIlIllIllIIl) && aw.llIIIIIlIlllI(lllllllllllllllllIlllIlIllIllIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            if (aw.llIIIIIlIlllI(Equipment.contains((int[])f.aS) ? 1 : 0) && aw.llIIIIIlIlllI(Inventory.contains((int[])f.aS) ? 1 : 0)) {
                                a.a(lllllllllllllllllIlllIlIllIllIIl);
                                Time.sleepTicks((int)lllIIlIllI[1]);
                                "".length();
                            }
                        }
                        if (!aw.llIIIIIlIllll(lllllllllllllllllIlllIlIllIllIIl) || !aw.llIIIIIlIllII(lllllllllllllllllIlllIlIllIllIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block40;
                        ...
                        if (aw.llIIIIIlIlllI(Bank.contains(lllllllllllllllllIlllIlIllIllIII = item -> item.getName().toLowerCase().contains(lllIIlIlIl[lllIIlIllI[137]])) ? 1 : 0)) {
                            aw.Q();
                ...
                if (aw.llIIIIIlIlllI(Equipment.contains((int[])f.aS) ? 1 : 0) && aw.llIIIIIlIlllI(Inventory.contains((int[])f.aS) ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (aw.llIIIIIllIIII(Inventory.getCount((int[])nArray))) {
                            ...
                            "".length();
                            if (" ".length() != " ".length()) {
                                return ((76 + 60 - 122 + 114 ^ 40 + 127 - 8 + 38) & (0x1A ^ 0x52 ^ (0x83 ^ 0x8E) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lllIIlIllI[0];
                        }
            ...
            if (aw.llIIIIIlIllII(aw.an() ? 1 : 0)) {
                ...
                if (aw.llIIIIIlIllII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    if (aw.llIIIIIlIlllI(Equipment.contains((int[])nArray10) ? 1 : 0)) {
                        ...
                        lllllllllllllllllIlllIlIllIllIIl = Inventory.getFirst((int[])nArray11);
                        if (aw.llIIIIIlIllll(lllllllllllllllllIlllIlIllIllIIl)) {
                            lllllllllllllllllIlllIlIllIllIIl.interact(lllIIlIlIl[lllIIlIllI[30]]);
                            Time.sleepTicks((int)lllIIlIllI[3]);
                            "".length();
                        }
                    }
                    ...
                    if (aw.llIIIIIlIllll(TileObjects.getNearest((int[])nArray12))) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (aw.llIIIIIlIllll(TileObjects.getNearest((int[])nArray))) {
                                ...
                                "".length();
                                if (null != null) {
                                    return ((127 + 112 - 74 + 5 ^ 86 + 73 - 156 + 164) & (0x2E ^ 2 ^ (0x7E ^ 0x5F) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lllIIlIllI[0];
                            }
                        ...
                        if (aw.llIIIIIllIlII(TileObjects.getNearest((int[])nArray15))) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (aw.llIIIIIlIllll(TileObjects.getNearest((int[])nArray))) {
                                    bl = lllIIlIllI[1];
                                    "".length();
                                    if ((0x7F ^ 0x6F ^ (0x82 ^ 0x96)) <= -" ".length()) {
                                        return ((0xDF ^ 0xBE ^ (0xBE ^ 0x98)) & (35 + 49 - -10 + 117 ^ 106 + 132 - 236 + 146 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lllIIlIllI[0];
                                }
    ...
    public int af() {
        ...
        if ((0xC ^ 0x13 ^ (0x63 ^ 0x79)) <= 0) {
            return (0x44 ^ 0x4F ^ (0x68 ^ 0x23)) & (123 + 98 - 132 + 153 ^ 57 + 121 - 130 + 130 ^ -" ".length());
        }
