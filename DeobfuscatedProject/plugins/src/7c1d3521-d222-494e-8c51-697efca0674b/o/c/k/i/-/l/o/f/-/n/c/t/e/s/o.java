...
implements ac {
    ...
    public boolean ah() {
        ...
        if (o.lIlllIIlIIIlI(Skills.getLevel((Skill)Skill.RANGED), llIlllIIIl[35]) && o.lIlllIIlIIIlI(Skills.getLevel((Skill)Skill.DEFENCE), llIlllIIIl[35])) {
            ...
            "".length();
            if (-" ".length() > 0) {
                return ((139 + 123 - 224 + 107 ^ 156 + 110 - 226 + 134) & (0x14 ^ 0x7F ^ (0xD0 ^ 0x84) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIlllIIIl[1];
        }
    ...
    public int af() {
        ...
        if ((0xBF ^ 0x9E ^ (0xF ^ 0x2A)) < 0) {
            return (0xC ^ 0x56 ^ (0x6E ^ 0x1E)) & (17 + 44 - -65 + 25 ^ 72 + 79 - 112 + 150 ^ -" ".length());
        }
    ...
    private static void lIlllIIIlIIll() {
        ...
        o.llIllIllll[o.llIlllIIIl[1]] = o.lIlllIIIlIIII("nvl+b7U/oJUFko1J3SDnEgRKjsLtooy8", "HAlSi");
        o.llIllIllll[o.llIlllIIIl[0]] = o.lIlllIIIlIIIl("NzEDGw0YJBwcDVkkGlIIGD4e", "yPurj");
        o.llIllIllll[o.llIlllIIIl[3]] = o.lIlllIIIlIIlI("4SlofLP2A0EDbgf4/K/eAS2fYQq6ElTZ", "cisOg");
        o.llIllIllll[o.llIlllIIIl[10]] = o.lIlllIIIlIIII("+H9fQbXKqRGcUdQ8BgcFF05t8V3unjhe", "QeHkj");
        o.llIllIllll[o.llIlllIIIl[12]] = o.lIlllIIIlIIIl("Fz8YAQ0=", "SMqof");
        o.llIllIllll[o.llIlllIIIl[13]] = o.lIlllIIIlIIlI("n3Xp61DVWC2TC1ckAWmCKA==", "cdVSJ");
        o.llIllIllll[o.llIlllIIIl[14]] = o.lIlllIIIlIIII("kxRka8ylPrpynlZB6Zvtj7Xu2hn6u3nK", "maudT");
        o.llIllIllll[o.llIlllIIIl[15]] = o.lIlllIIIlIIlI("toqKjskKuDw=", "suBKL");
        o.llIllIllll[o.llIlllIIIl[16]] = o.lIlllIIIlIIIl("NSEaDHg1JxsbORcnBBEtFg==", "eNhxX");
        o.llIllIllll[o.llIlllIIIl[17]] = o.lIlllIIIlIIIl("GhY4E1EaEDkEEDgQJg4EOQ==", "JyJgq");
        o.llIllIllll[o.llIlllIIIl[8]] = o.lIlllIIIlIIIl("ITc1M3khMTQkOAMxKy4sAg==", "qXGGY");
        o.llIllIllll[o.llIlllIIIl[18]] = o.lIlllIIIlIIIl("DAgmMQ==", "ZmIBH");
        o.llIllIllll[o.llIlllIIIl[19]] = o.lIlllIIIlIIIl("MCUZ", "uDmPn");
        o.llIllIllll[o.llIlllIIIl[20]] = o.lIlllIIIlIIlI("jeXsqol1eyGukz73XpulDA==", "qObXy");
        o.llIllIllll[o.llIlllIIIl[21]] = o.lIlllIIIlIIlI("v5kUwcXtAqhy0w4rzHAM9Q==", "Ndrhp");
        o.llIllIllll[o.llIlllIIIl[22]] = o.lIlllIIIlIIlI("p1FUb/ewXCR07IW77mPOKNxB7+aw/rSU", "GrOFM");
        o.llIllIllll[o.llIlllIIIl[23]] = o.lIlllIIIlIIII("Eqa1AH9J5Ug=", "xbARk");
        o.llIllIllll[o.llIlllIIIl[30]] = o.lIlllIIIlIIlI("Gk79Qbyr9YDkHVX07taLfw==", "mJEDV");
        o.llIllIllll[o.llIlllIIIl[34]] = o.lIlllIIIlIIlI("R0KuiKg3Stz37K8qqWj9mA==", "lLegV");
        o.llIllIllll[o.llIlllIIIl[36]] = o.lIlllIIIlIIII("dapjPCj/vmbWXtkvc9MkKQ==", "opkfC");
        o.llIllIllll[o.llIlllIIIl[60]] = o.lIlllIIIlIIlI("+9Vc469CWpxBQbjQxCvDOsxJIauYQG6cCfDbPQdPiImHKw7S/0pc3w+kNKoQZjKf", "QbQbz");
        o.llIllIllll[o.llIlllIIIl[61]] = o.lIlllIIIlIIlI("bMI/46rbogsQpNBppfb+NQqVjQQwA+rJSLGU1ylnBuRYXmLQ94h7Vg==", "zoLoS");
        o.llIllIllll[o.llIlllIIIl[62]] = o.lIlllIIIlIIII("Xc9KkiFgFwSsscPoP2EmKw==", "WAOeu");
    }
        ...
        if (o.lIlllIIIlIllI(list.isEmpty() ? 1 : 0) && o.lIlllIIIlllIl(list.size(), llIlllIIIl[0])) {
            ...
            while (o.lIlllIIIlIlIl(llllllllllllllllllIIIIllIIlIlIll, llllllllllllllllllIIIIllIIlIllII.size())) {
                ...
                if (o.lIlllIIIllIII(((Player)llllllllllllllllllIIIIllIIlIllII.get(llllllllllllllllllIIIIllIIlIlIll)).equals(Players.getLocal()) ? 1 : 0)) {
                    "".length();
                    if (((0xB ^ 0x4F ^ (0x42 ^ 0x56)) & (" ".length() ^ (0x72 ^ 0x23) ^ -" ".length())) >= (0xBE ^ 0x99 ^ (0x85 ^ 0xA6))) {
                        return ((138 + 83 - 161 + 95 ^ 81 + 143 - 73 + 36) & (0x7E ^ 0x3C ^ (0x42 ^ 0x20) ^ -" ".length())) != 0;
                    }
    ...
    private static String lIlllIIIlIIIl(String llllllllllllllllllIIIIllIIIIlIlI, String llllllllllllllllllIIIIllIIIIlIIl) {
        ...
        while (o.lIlllIIIlIlIl(llllllllllllllllllIIIIllIIIIIIll, llllllllllllllllllIIIIllIIIIIlII)) {
            ...
            "".length();
            if (-" ".length() <= ((0x25 ^ 0x28) & ~(0x36 ^ 0x3B))) continue;
            return null;
        }
