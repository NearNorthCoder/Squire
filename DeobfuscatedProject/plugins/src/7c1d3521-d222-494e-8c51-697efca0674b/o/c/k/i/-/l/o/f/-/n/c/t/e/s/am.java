...
implements ac {
    ...
    private static String lIllllIIlllII(String lllllllllllllllllIlllllIllIlIIII, String lllllllllllllllllIlllllIllIIllll) {
        try {
            SecretKeySpec lllllllllllllllllIlllllIllIlIlIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIlllllIllIIllll.getBytes(StandardCharsets.UTF_8)), lllIIIIIIl[19]), "DES");
            Cipher lllllllllllllllllIlllllIllIlIlII = Cipher.getInstance("DES");
            lllllllllllllllllIlllllIllIlIlII.init(lllIIIIIIl[4], lllllllllllllllllIlllllIllIlIlIl);
            return new String(lllllllllllllllllIlllllIllIlIlII.doFinal(Base64.getDecoder().decode(lllllllllllllllllIlllllIllIlIIII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIllllIIlllIl() {
        ...
        am.lllIIIIIII[am.lllIIIIIIl[0]] = am.lIllllIIIlllI("mOSc/Am5U8AEds0SqGz6pw==", "RrZoj");
        am.lllIIIIIII[am.lllIIIIIIl[1]] = am.lIllllIIIllll("AhwNDRUsEAdEBDEMCgoBZBwXAQs3WUMXES0BAAwPKhJDBgcnHkMQCWQYBggDIVUXFgctGwoKAQ==", "Ducdf");
        am.lllIIIIIII[am.lllIIIIIIl[4]] = am.lIllllIIIlllI("L4Rg2G3BgtPSxsiCfPs/KQcC0REBajML", "TseZm");
        am.lllIIIIIII[am.lllIIIIIIl[5]] = am.lIllllIIIlllI("15bQzt3Ll+epDR6L9GJRFs1/3s8BEx4d", "DUAgG");
        am.lllIIIIIII[am.lllIIIIIIl[7]] = am.lIllllIIIllll("MQtiJCMDTi8sIhUHLCJxFRsyNT0PCzFpcRUZKzEyDgcsInESAWIHBD8nDAI=", "fnBEQ");
        am.lllIIIIIII[am.lllIIIIIIl[11]] = am.lIllllIIlllII("Fq+ZijoW2QxXPxTE/HvtHA==", "AQgLj");
        am.lllIIIIIII[am.lllIIIIIIl[15]] = am.lIllllIIIllll("PwwOLT5MCwghPwUMCjo=", "lxkHR");
        am.lllIIIIIII[am.lllIIIIIIl[16]] = am.lIllllIIIllll("BAcyDxYgAmYUByADLxMFOw==", "InFgd");
        am.lllIIIIIII[am.lllIIIIIIl[19]] = am.lIllllIIlllII("qWMrb4LAFDI=", "EMaIu");
        am.lllIIIIIII[am.lllIIIIIIl[21]] = am.lIllllIIIlllI("Iwnxclo6vPmj5NeOzcA/HMvVfWiV+5VM", "ZUvEG");
        am.lllIIIIIII[am.lllIIIIIIl[22]] = am.lIllllIIIlllI("RNYuCr9nRA/J/okPdwYyTw==", "sCEuo");
        am.lllIIIIIII[am.lllIIIIIIl[23]] = am.lIllllIIIlllI("ytXcBcmDXbM=", "SIqna");
        am.lllIIIIIII[am.lllIIIIIIl[24]] = am.lIllllIIIlllI("uowtC70oYMo=", "cvdUi");
        am.lllIIIIIII[am.lllIIIIIIl[25]] = am.lIllllIIlllII("0SSAur7J1u0=", "pwlnr");
        am.lllIIIIIII[am.lllIIIIIIl[26]] = am.lIllllIIIlllI("QUYmBzj6KIQ=", "lViwC");
        am.lllIIIIIII[am.lllIIIIIIl[14]] = am.lIllllIIIlllI("7R+szm39071HARmqm4nwvnjj68mLkfTX", "GNSHL");
        am.lllIIIIIII[am.lllIIIIIIl[27]] = am.lIllllIIIlllI("3RFVxD0XW7cfJqZFbIJgMA==", "ddPMD");
        am.lllIIIIIII[am.lllIIIIIIl[28]] = am.lIllllIIIlllI("BaBevXVAUOE=", "cThSB");
        am.lllIIIIIII[am.lllIIIIIIl[31]] = am.lIllllIIlllII("SioBbKYiGCt17gp1tY2JrQ==", "PVnru");
        am.lllIIIIIII[am.lllIIIIIIl[32]] = am.lIllllIIlllII("a9TAoKVTvPxY3VUMpzpvlQ==", "driJa");
        am.lllIIIIIII[am.lllIIIIIIl[20]] = am.lIllllIIIllll("ED4GAw8=", "GWcok");
        am.lllIIIIIII[am.lllIIIIIIl[33]] = am.lIllllIIIlllI("h05l//NHyFU9FV7DRVWXHg==", "AcRKd");
        am.lllIIIIIII[am.lllIIIIIIl[34]] = am.lIllllIIIlllI("gKb4VShbc4Zu6STfeMmwWA==", "Vnzdj");
        am.lllIIIIIII[am.lllIIIIIIl[35]] = am.lIllllIIIllll("Lx8BGwA=", "xvdwd");
        am.lllIIIIIII[am.lllIIIIIIl[36]] = am.lIllllIIIlllI("mklE5x6mTKoGoSf4eRtYFqVB2XVb0ZvJ", "KuNiq");
        am.lllIIIIIII[am.lllIIIIIIl[37]] = am.lIllllIIlllII("ZQ0Sf7qPoIq/7wp2/o+KhbNsrbB49Gzh", "LKRrd");
        am.lllIIIIIII[am.lllIIIIIIl[38]] = am.lIllllIIlllII("kH7C0U13gI4=", "pUcOn");
        am.lllIIIIIII[am.lllIIIIIIl[40]] = am.lIllllIIlllII("ifA/01aZgNc=", "KfCOD");
        am.lllIIIIIII[am.lllIIIIIIl[41]] = am.lIllllIIlllII("8z9Pdo5J8/I=", "nTqDm");
        am.lllIIIIIII[am.lllIIIIIIl[43]] = am.lIllllIIIlllI("ZFmg8NChedg=", "JbdtV");
        am.lllIIIIIII[am.lllIIIIIIl[2]] = am.lIllllIIIllll("OxAOAQ==", "luosL");
        am.lllIIIIIII[am.lllIIIIIIl[46]] = am.lIllllIIlllII("G8MVxxu1L+8=", "kqLfn");
        am.lllIIIIIII[am.lllIIIIIIl[48]] = am.lIllllIIIllll("BA8qBA==", "SjKvq");
        am.lllIIIIIII[am.lllIIIIIIl[50]] = am.lIllllIIIllll("MhYxFg==", "esPdZ");
        am.lllIIIIIII[am.lllIIIIIIl[52]] = am.lIllllIIIlllI("yH3Lgj54MGI=", "iRYiE");
        am.lllIIIIIII[am.lllIIIIIIl[59]] = am.lIllllIIIlllI("zizd0S2DfIY=", "vilnz");
        am.lllIIIIIII[am.lllIIIIIIl[60]] = am.lIllllIIlllII("DCNETRHwr+M=", "AsMRg");
    }
    ...
    public static boolean aM() {
        ...
        block18: {
                                        ...
                                        block8: {
                                            ...
                                            block10: {
                                                ...
                                                if (am.lIllllIlIIIII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                    ...
                                                    return ((0xF2 ^ 0xBF ^ (0xE8 ^ 0xAA)) & (117 + 111 - 153 + 56 ^ 36 + 88 - 89 + 105 ^ -" ".length())) != 0;
                                                }
                                            }
                                            n3 = lllIIIIIIl[0];
                                            return n3 != 0;
            ...
            if (am.lIllllIlIIIII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                n2 = lllIIIIIIl[1];
                "".length();
                if ((10 + 71 - -55 + 12 ^ 105 + 5 - 39 + 73) > " ".length()) return n2 != 0;
                return ((0x7E ^ 4 ^ (0x61 ^ 0x5A)) & (70 + 107 - 173 + 131 ^ 158 + 22 - 48 + 66 ^ -" ".length())) != 0;
            }
        }
        n2 = lllIIIIIIl[0];
        return n2 != 0;
    ...
    public static void Q() {
        d lllllllllllllllllIllllllIIIIIlIl;
        int[] nArray = new int[lllIIIIIIl[1]];
        ...
        if (am.lIllllIlIIIlI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lllllllllllllllllIllllllIIIIIlIl = new d(lllIIIIIIl[54], lllIIIIIIl[11], lllIIIIIIl[53]);
            bv.add(lllllllllllllllllIllllllIIIIIlIl);
            "".length();
        }
        int[] nArray3 = new int[lllIIIIIIl[1]];
        nArray3[am.lllIIIIIIl[0]] = lllIIIIIIl[51];
        if (am.lIllllIlIIIlI(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllllIllllllIIIIIlIl = new d(lllIIIIIIl[51], lllIIIIIIl[1], lllIIIIIIl[55]);
            bv.add(lllllllllllllllllIllllllIIIIIlIl);
            "".length();
        }
        int[] nArray4 = new int[lllIIIIIIl[1]];
        ...
        if (am.lIllllIlIIIlI(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllllIllllllIIIIIlIl = new d(lllIIIIIIl[49], lllIIIIIIl[1], lllIIIIIIl[56]);
            bv.add(lllllllllllllllllIllllllIIIIIlIl);
            "".length();
        }
        int[] nArray5 = new int[lllIIIIIIl[1]];
        ...
        if (am.lIllllIlIIIlI(Bank.contains((int[])nArray5) ? 1 : 0)) {
            lllllllllllllllllIllllllIIIIIlIl = new d(lllIIIIIIl[12], lllIIIIIIl[13], lllIIIIIIl[57]);
            bv.add(lllllllllllllllllIllllllIIIIIlIl);
            "".length();
        }
        int[] nArray6 = new int[lllIIIIIIl[1]];
        ...
        if (am.lIllllIlIIIlI(Bank.contains((int[])nArray6) ? 1 : 0)) {
            lllllllllllllllllIllllllIIIIIlIl = new d(lllIIIIIIl[42], lllIIIIIIl[1], lllIIIIIIl[58]);
            bv.add(lllllllllllllllllIllllllIIIIIlIl);
            "".length();
        }
        int[] nArray7 = new int[lllIIIIIIl[1]];
        ...
        if (am.lIllllIlIIIlI(Bank.contains((int[])nArray7) ? 1 : 0)) {
            lllllllllllllllllIllllllIIIIIlIl = new d(lllIIIIIIl[45], lllIIIIIIl[1], lllIIIIIIl[58]);
            bv.add(lllllllllllllllllIllllllIIIIIlIl);
            "".length();
        }
        int[] nArray8 = new int[lllIIIIIIl[1]];
        ...
        if (am.lIllllIlIIIlI(Bank.contains((int[])nArray8) ? 1 : 0)) {
            lllllllllllllllllIllllllIIIIIlIl = new d(lllIIIIIIl[47], lllIIIIIIl[1], lllIIIIIIl[58]);
            bv.add(lllllllllllllllllIllllllIIIIIlIl);
            "".length();
        }
        int[] nArray9 = new int[lllIIIIIIl[1]];
        ...
        if (am.lIllllIlIIIlI(Bank.contains((int[])nArray9) ? 1 : 0)) {
            lllllllllllllllllIllllllIIIIIlIl = new d(lllIIIIIIl[44], lllIIIIIIl[1], lllIIIIIIl[58]);
            bv.add(lllllllllllllllllIllllllIIIIIlIl);
            "".length();
        }
        if (am.lIllllIlIIIll(Skills.getLevel((Skill)Skill.ATTACK), lllIIIIIIl[39])) {
            ...
            if (am.lIllllIlIIIlI(Bank.contains((int[])nArray10) ? 1 : 0)) {
                lllllllllllllllllIllllllIIIIIlIl = new d(lllIIIIIIl[18], lllIIIIIIl[1], lllIIIIIIl[56]);
                bv.add(lllllllllllllllllIllllllIIIIIlIl);
                "".length();
            }
        }
        ...
        if (am.lIllllIlIIIlI(Bank.contains((int[])nArray11) ? 1 : 0)) {
            lllllllllllllllllIllllllIIIIIlIl = new d(lllIIIIIIl[17], lllIIIIIIl[1], lllIIIIIIl[58]);
            bv.add(lllllllllllllllllIllllllIIIIIlIl);
            "".length();
        }
    }

    private static String lIllllIIIlllI(String lllllllllllllllllIlllllIllllIlIl, String lllllllllllllllllIlllllIllllIlII) {
        try {
            SecretKeySpec lllllllllllllllllIlllllIlllllIlI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIlllllIllllIlII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            return new String(lllllllllllllllllIlllllIlllllIIl.doFinal(Base64.getDecoder().decode(lllllllllllllllllIlllllIllllIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
            ...
            block19: {
                block18: {
                    ...
                    if (am.lIllllIlIIIlI(am.aM() ? 1 : 0) && (!am.lIllllIlIIIll(Skills.getLevel((Skill)Skill.DEFENCE), lllIIIIIIl[2]) || !am.lIllllIlIIIll(Skills.getLevel((Skill)Skill.ATTACK), lllIIIIIIl[3]) || am.lIllllIlIIIIl(Skills.getLevel((Skill)Skill.STRENGTH), lllIIIIIIl[3]))) {
                        BankLocation lllllllllllllllllIllllllIIIIlIll = BankLocation.getNearest();
                        if (am.lIllllIlIIlII(lllllllllllllllllIllllllIIIIlIll) && am.lIllllIlIIIlI(lllllllllllllllllIllllllIIIIlIll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            AccBuilderSotf.c = lllIIIIIII[lllIIIIIIl[4]];
                            a.a(lllllllllllllllllIllllllIIIIlIll);
                        }
                        if (am.lIllllIlIIlII(lllllllllllllllllIllllllIIIIlIll) && am.lIllllIlIIIII(lllllllllllllllllIllllllIIIIlIll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String lIllllIIIllll(String lllllllllllllllllIlllllIlllIIIlI, String lllllllllllllllllIlllllIlllIIIIl) {
        lllllllllllllllllIlllllIlllIIIlI = new String(Base64.getDecoder().decode(lllllllllllllllllIlllllIlllIIIlI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllIlllllIlllIIlIl = new StringBuilder();
        char[] lllllllllllllllllIlllllIlllIIlII = lllllllllllllllllIlllllIlllIIIIl.toCharArray();
        int lllllllllllllllllIlllllIlllIIIll = lllIIIIIIl[0];
        char[] lllllllllllllllllIlllllIllIlllIl = lllllllllllllllllIlllllIlllIIIlI.toCharArray();
        int lllllllllllllllllIlllllIllIlllII = lllllllllllllllllIlllllIllIlllIl.length;
        int lllllllllllllllllIlllllIllIllIll = lllIIIIIIl[0];
        while (am.lIllllIlIIIIl(lllllllllllllllllIlllllIllIllIll, lllllllllllllllllIlllllIllIlllII)) {
            char lllllllllllllllllIlllllIlllIlIII = lllllllllllllllllIlllllIllIlllIl[lllllllllllllllllIlllllIllIllIll];
            ...
            ++lllllllllllllllllIlllllIllIllIll;
            "".length();
    ...
    public boolean ah() {
        ...
        if (am.lIllllIlIIIll(Skills.getLevel((Skill)Skill.STRENGTH), lllIIIIIIl[39])) {
            bl = lllIIIIIIl[1];
            "".length();
            if ((57 + 29 - 17 + 65 ^ 16 + 13 - -72 + 29) <= ((14 + 111 - 110 + 118 ^ 139 + 123 - 194 + 83) & (0x7B ^ 0x70 ^ (0x68 ^ 0x71) ^ -" ".length()))) {
                return ((0x53 ^ 0x2F ^ (0x7A ^ 0x19)) & ("  ".length() ^ (0x79 ^ 0x64) ^ -" ".length())) != 0;
            }
        } else {
            bl = lllIIIIIIl[0];
        }
    ...
    public int af() {
        ...
        catch (Exception lllllllllllllllllIllllllIIIIIIll) {
            lllllllllllllllllIllllllIIIIIIll.printStackTrace();
        }
        if ((0xA7 ^ 0x86 ^ (0x5A ^ 0x7F)) <= 0) {
            return (0x7A ^ 0x22 ^ (0x72 ^ 0x64)) & (0x6D ^ 0x38 ^ (0x80 ^ 0x9B) ^ -" ".length());
        }
        return lllIIIIIIl[0];
    }
    ...
    private static void lIllllIIllllI() {
        ...
        am.lllIIIIIIl[0] = (99 + 207 - 189 + 105 ^ 84 + 1 - -20 + 52) & (61 + 41 - 80 + 230 ^ 48 + 140 - 92 + 95 ^ -" ".length());
        am.lllIIIIIIl[1] = " ".length();
        am.lllIIIIIIl[2] = 0xB2 ^ 0xAC;
        am.lllIIIIIIl[3] = 0xF6 ^ 0xB8 ^ (0x43 ^ 0x3F);
        am.lllIIIIIIl[4] = "  ".length();
        am.lllIIIIIIl[5] = "   ".length();
    ...
    public static void am() {
        ...
        if (am.lIllllIlIIIII(cM.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (am.lIllllIlIIlll(Players.getLocal().getInteracting())) {
                NPC lllllllllllllllllIllllllIIIIlIII = NPCs.getNearest(nPC -> {
                    int n2;
                ...
                List lllllllllllllllllIllllllIIIIIlll = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                    boolean bl;
                    if (am.lIllllIlIlIlI(nPC.getInteracting(), Players.getLocal())) {
                        bl = lllIIIIIIl[1];
                        "".length();
                        if (-"   ".length() >= 0) {
                            return ((0xC6 ^ 0xA5) & ~(0x21 ^ 0x42)) != 0;
                        }
                    } else {
                        bl = lllIIIIIIl[0];
                    }
                ...
                if (am.lIllllIlIIIlI(lllllllllllllllllIllllllIIIIIlll.isEmpty() ? 1 : 0)) {
                    ((NPC)lllllllllllllllllIllllllIIIIIlll.get(lllIIIIIIl[0])).interact(lllIIIIIII[lllIIIIIIl[25]]);
                    Time.sleepTicks((int)lllIIIIIIl[4]);
                    "".length();
                }
                if (am.lIllllIlIIlII(lllllllllllllllllIllllllIIIIlIII) && am.lIllllIlIIIlI(Players.getLocal().isMoving() ? 1 : 0) && am.lIllllIlIIIII(lllllllllllllllllIllllllIIIIIlll.isEmpty() ? 1 : 0)) {
                    lllllllllllllllllIllllllIIIIlIII.interact(lllIIIIIII[lllIIIIIIl[26]]);
                    Time.sleepTicks((int)lllIIIIIIl[4]);
                    "".length();
                }
            }
