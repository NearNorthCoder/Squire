...
implements ac {
    ...
    private static String lIllllIlIllII(String lllllllllllllllllIllllIlIlIllIll, String lllllllllllllllllIllllIlIlIllIlI) {
        ...
        while (aa.lIllllIllIIlI(lllllllllllllllllIllllIlIlIlIlII, lllllllllllllllllIllllIlIlIlIlIl)) {
            ...
            "".length();
            if (((0x50 ^ 0x57 ^ (0x17 ^ 1)) & (0x61 ^ 0x20 ^ (0x34 ^ 0x64) ^ -" ".length())) != " ".length()) continue;
            return null;
        }
    ...
    private static void lIllllIlIllll() {
        ...
        aa.lllIIIIIll[29] = " ".length() ^ (3 ^ 0x13);
        ...
        aa.lllIIIIIll[37] = "   ".length() ^ (0x6A ^ 0x71);
        ...
        if (aa.lIllllIllIIIl(Inventory.contains((String[])stringArray) ? 1 : 0)) {
            ...
            if (aa.lIllllIllIIIl(Inventory.contains((String[])stringArray2) ? 1 : 0)) {
                ...
                if (aa.lIllllIllIIIl(Inventory.contains((String[])stringArray3) ? 1 : 0)) {
                    ...
                    return ((0xE1 ^ 0xA2 ^ (0xCD ^ 0xB4)) & (113 + 137 - 135 + 71 ^ 67 + 118 - 89 + 32 ^ -" ".length())) != 0;
                }
            }
        }
        n2 = lllIIIIIll[0];
    ...
    private static void lIllllIlIlllI() {
        ...
        aa.lllIIIIIlI[aa.lllIIIIIll[0]] = aa.lIllllIlIlIll("g67tGroIFQW0cqWwnP5EZg==", "DnxJe");
        aa.lllIIIIIlI[aa.lllIIIIIll[1]] = aa.lIllllIlIllII("MwAJAwIdDANKEwAQDgQWVQATDxwGRUcZBhwdBAIYGw5HCBAWAkceHlUYEg8CAQ==", "uigjq");
        aa.lllIIIIIlI[aa.lllIIIIIll[5]] = aa.lIllllIlIllIl("eNCtBGHG9ps=", "WHEYY");
        aa.lllIIIIIlI[aa.lllIIIIIll[7]] = aa.lIllllIlIllIl("0T5r1mfoao8=", "gqTqC");
        aa.lllIIIIIlI[aa.lllIIIIIll[10]] = aa.lIllllIlIllIl("wbiTIy55lD34pmq+w0+E6g==", "HZnzO");
        aa.lllIIIIIlI[aa.lllIIIIIll[11]] = aa.lIllllIlIllIl("dcHxTyOzR/544U1VU0x1mRJWmV4V/kC9", "AQNSj");
        aa.lllIIIIIlI[aa.lllIIIIIll[18]] = aa.lIllllIlIllII("GiJPNyUoZwI/JD4uATF3PDIKJSNtNBomJyEuCiV7bTQYPyMuLwY4MG0zAHYVGB4mGBA=", "MGoVW");
        aa.lllIIIIIlI[aa.lllIIIIIll[20]] = aa.lIllllIlIllII("Ci4YbSIrbx05NzY7", "DOnMV");
        aa.lllIIIIIlI[aa.lllIIIIIll[21]] = aa.lIllllIlIllII("GREIMw==", "NtiAT");
        aa.lllIIIIIlI[aa.lllIIIIIll[22]] = aa.lIllllIlIllIl("qfhkr05KZUOfG2Z9ZoZN5Q==", "PAigq");
        aa.lllIIIIIlI[aa.lllIIIIIll[3]] = aa.lIllllIlIllII("KhsDFSAJ", "gtqrA");
        aa.lllIIIIIlI[aa.lllIIIIIll[23]] = aa.lIllllIlIlIll("MJIyX33Nhxy0Ted0hm60hg==", "BndUn");
        aa.lllIIIIIlI[aa.lllIIIIIll[24]] = aa.lIllllIlIllIl("Da7tvMXyfHj+KggtEXoNXQ==", "mCReH");
        aa.lllIIIIIlI[aa.lllIIIIIll[25]] = aa.lIllllIlIlIll("wHVz1F7dNjoZNxnZldUEvQ==", "vfHhN");
        aa.lllIIIIIlI[aa.lllIIIIIll[26]] = aa.lIllllIlIllII("CyIQGg==", "IGuhm");
        aa.lllIIIIIlI[aa.lllIIIIIll[27]] = aa.lIllllIlIlIll("c2Lbx9sfBsI=", "pSJOt");
        aa.lllIIIIIlI[aa.lllIIIIIll[28]] = aa.lIllllIlIllII("GTMfHEI5PVMTEDg8GA==", "MRswb");
        aa.lllIIIIIlI[aa.lllIIIIIll[29]] = aa.lIllllIlIllII("ETB5GSYnLjYm", "UBYQG");
        aa.lllIIIIIlI[aa.lllIIIIIll[30]] = aa.lIllllIlIlIll("EenfdZQD9ww=", "rDKDH");
        aa.lllIIIIIlI[aa.lllIIIIIll[31]] = aa.lIllllIlIllIl("+TIZoD2EhsI=", "EKzrS");
        aa.lllIIIIIlI[aa.lllIIIIIll[32]] = aa.lIllllIlIllII("DAQUVAwtRREAGSsXEQ==", "Bebtx");
        aa.lllIIIIIlI[aa.lllIIIIIll[34]] = aa.lIllllIlIllII("BSIVLTQuIlQCMy08FTM/", "APtTZ");
        aa.lllIIIIIlI[aa.lllIIIIIll[35]] = aa.lIllllIlIllIl("yBaGzNNkBTKrN9kiD4/L53QaEv9L1tzw", "wbMLB");
        aa.lllIIIIIlI[aa.lllIIIIIll[36]] = aa.lIllllIlIllII("KQQ0MzMJ", "zpUZA");
        aa.lllIIIIIlI[aa.lllIIIIIll[37]] = aa.lIllllIlIllIl("wy/FRjJ9BgBGJ8+62u4XJg==", "WwYMU");
        aa.lllIIIIIlI[aa.lllIIIIIll[38]] = aa.lIllllIlIllII("MAoGARdTIQEOGh0KAQ==", "sesoc");
        aa.lllIIIIIlI[aa.lllIIIIIll[39]] = aa.lIllllIlIllII("HyUKEQYlPwxDFCU2Axc=", "LQkcr");
        aa.lllIIIIIlI[aa.lllIIIIIll[40]] = aa.lIllllIlIlIll("dzVbwl7SfG8=", "XzdBR");
        aa.lllIIIIIlI[aa.lllIIIIIll[41]] = aa.lIllllIlIllIl("B6SdwQDz3R8=", "IIGGT");
        aa.lllIIIIIlI[aa.lllIIIIIll[42]] = aa.lIllllIlIllII("JBsDBy5HMAQIIwkbBA==", "gtviZ");
        aa.lllIIIIIlI[aa.lllIIIIIll[43]] = aa.lIllllIlIllII("JCMlGCALJCU=", "bJBpT");
        aa.lllIIIIIlI[aa.lllIIIIIll[44]] = aa.lIllllIlIllIl("4I76kUbUIjw=", "TBqOu");
        aa.lllIIIIIlI[aa.lllIIIIIll[45]] = aa.lIllllIlIlIll("TM2psdUhgu4=", "aXWrT");
        aa.lllIIIIIlI[aa.lllIIIIIll[46]] = aa.lIllllIlIlIll("f6r+jEXWeP0=", "ISwPp");
        aa.lllIIIIIlI[aa.lllIIIIIll[47]] = aa.lIllllIlIllIl("AfMDMsQ9EK4=", "sgqGC");
        aa.lllIIIIIlI[aa.lllIIIIIll[48]] = aa.lIllllIlIllII("EjYoACQ2", "UWZlM");
        aa.lllIIIIIlI[aa.lllIIIIIll[49]] = aa.lIllllIlIlIll("5RaerC8fE2Y=", "NdAsv");
        aa.lllIIIIIlI[aa.lllIIIIIll[60]] = aa.lIllllIlIlIll("8U7OfYrO2voBNI8zhGPMj4RgmUqZm1Fj", "cuTth");
        aa.lllIIIIIlI[aa.lllIIIIIll[61]] = aa.lIllllIlIllIl("1mcIPvdvi097aG8gVwOjtGc9NbNXdgXt", "baWft");
        aa.lllIIIIIlI[aa.lllIIIIIll[70]] = aa.lIllllIlIlIll("nVnIrqPRPuCNG1EHc1WBzQMb69JO6M4JkYr4aIfjmh0=", "ySBLs");
        aa.lllIIIIIlI[aa.lllIIIIIll[53]] = aa.lIllllIlIlIll("BcMvLeNi+56hXQpc80DIYGE8WcVfuWR6LpU1VRHjTY7Zb81Q3LgBlQ==", "dKfep");
        aa.lllIIIIIlI[aa.lllIIIIIll[71]] = aa.lIllllIlIllIl("m85Z1b7iL/4N+enpOToe7e2gKvjDvoF+", "btLAN");
        aa.lllIIIIIlI[aa.lllIIIIIll[72]] = aa.lIllllIlIllIl("lT8V4xnzAV8=", "gBBVt");
    }
    ...
    public int af() {
        ...
        if (" ".length() >= "  ".length()) {
            return (53 + 159 - 174 + 136 ^ 123 + 32 - 25 + 32) & (0x3E ^ 0x11 ^ (0x41 ^ 0x62) ^ -" ".length());
        }
