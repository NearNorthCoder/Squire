...
implements ac {
    ...
    private static void Q() {
        block33: {
            d llllllllllllllllllIlIlIlIllIIlll;
            block32: {
                block31: {
                    block30: {
                        block29: {
                            block28: {
                                block27: {
                                    block26: {
                                        block25: {
                                            block24: {
                                                Object llllllllllllllllllIlIlIlIllIlIII;
                                                block23: {
                                                    block22: {
                                                    ...
                                                    llllllllllllllllllIlIlIlIllIlIII = new d(llIIIllllI[12], llIIIllllI[13], llIIIllllI[103]);
                                                    bv.add((d)llllllllllllllllllIlIlIlIllIlIII);
                                                    "".length();
                                                }
                                                if (M.lIlIIllllIllI(Bank.contains((Predicate)(llllllllllllllllllIlIlIlIllIlIII = item -> item.getName().toLowerCase().contains(llIIIlllII[llIIIllllI[110]]))) ? 1 : 0)) {
                                                    llllllllllllllllllIlIlIlIllIIlll = new d(llIIIllllI[104], llIIIllllI[16], llIIIllllI[105]);
                                                    bv.add(llllllllllllllllllIlIlIlIllIIlll);
                                                    "".length();
                                                }
                                                int[] nArray = new int[llIIIllllI[0]];
                                                ...
                                                if (M.lIlIIllllIlII(Bank.contains((int[])nArray) ? 1 : 0)) {
                                                    ...
                                                    if (M.lIlIIllllIlIl(Bank.getFirst((int[])nArray4).getQuantity(), llIIIllllI[7])) {
                                                        ...
                                                        llllllllllllllllllIlIlIlIllIIlll = new d(llIIIllllI[15], llIIIllllI[7] - Bank.getFirst((int[])nArray5).getQuantity(), llIIIllllI[106]);
                                                        bv.add(llllllllllllllllllIlIlIlIllIIlll);
                                                        "".length();
                                                    }
                                                }
                                            ...
                                            llllllllllllllllllIlIlIlIllIIlll = new d(llIIIllllI[10], llIIIllllI[9], llIIIllllI[21]);
                                            bv.add(llllllllllllllllllIlIlIlIllIIlll);
                                            "".length();
                                        }
                                        int[] nArray = new int[llIIIllllI[0]];
                                    ...
                                    llllllllllllllllllIlIlIlIllIIlll = new d(llIIIllllI[8], llIIIllllI[9], llIIIllllI[21]);
                                    bv.add(llllllllllllllllllIlIlIlIllIIlll);
                                    "".length();
                                }
                                int[] nArray = new int[llIIIllllI[0]];
                            ...
                            llllllllllllllllllIlIlIlIllIIlll = new d(llIIIllllI[11], llIIIllllI[9], llIIIllllI[21]);
                            bv.add(llllllllllllllllllIlIlIlIllIIlll);
                            "".length();
                        }
                        int[] nArray = new int[llIIIllllI[0]];
                        ...
                        if (M.lIlIIllllIllI(Bank.contains((int[])nArray) ? 1 : 0)) {
                            llllllllllllllllllIlIlIlIllIIlll = new d(llIIIllllI[15], llIIIllllI[7], llIIIllllI[106]);
                            bv.add(llllllllllllllllllIlIlIlIllIIlll);
                            "".length();
                        }
                    ...
                    llllllllllllllllllIlIlIlIllIIlll = new d(llIIIllllI[18], llIIIllllI[7], j.cf);
                    bv.add(llllllllllllllllllIlIlIlIllIIlll);
                    "".length();
                }
                int[] nArray = new int[llIIIllllI[0]];
            ...
            llllllllllllllllllIlIlIlIllIIlll = new d(llIIIllllI[14], llIIIllllI[66], llIIIllllI[107]);
            bv.add(llllllllllllllllllIlIlIlIllIIlll);
            "".length();
        }
    }
    ...
    private static boolean an() {
        void llllllllllllllllllIlIlIlIllIllII;
        int[] nArray = new int[llIIIllllI[6]];
        nArray[M.llIIIllllI[1]] = llIIIllllI[14];
        nArray[M.llIIIllllI[0]] = llIIIllllI[12];
        nArray[M.llIIIllllI[4]] = llIIIllllI[15];
        int[] nArray2 = nArray;
        int llllllllllllllllllIlIlIlIllIlIll = llIIIllllI[1];
        while (M.lIlIIllllIlIl(llllllllllllllllllIlIlIlIllIlIll, ((void)llllllllllllllllllIlIlIlIllIllII).length)) {
            int[] nArray3 = new int[llIIIllllI[0]];
            nArray3[M.llIIIllllI[1]] = llllllllllllllllllIlIlIlIllIllII[llllllllllllllllllIlIlIlIllIlIll];
            if (M.lIlIIllllIllI(Inventory.contains((int[])nArray3) ? 1 : 0)) {
                return llIIIllllI[1];
            }
            ++llllllllllllllllllIlIlIlIllIlIll;
            "".length();
            if ("   ".length() >= "  ".length()) continue;
            return ((0x34 ^ 0x3B) & ~(0xAB ^ 0xA4)) != 0;
        }
        return llIIIllllI[0];
    }
    ...
    private static void lIlIIllllIIlI() {
        ...
        M.llIIIllllI[0] = " ".length();
        M.llIIIllllI[1] = (0xEC ^ 0x8A ^ (0x59 ^ 0x17)) & (0x44 ^ 0x17 ^ (0xF5 ^ 0x8E) ^ -" ".length());
        M.llIIIllllI[2] = 0x8F ^ 0x82;
        M.llIIIllllI[3] = 0x1C ^ 0x31;
        M.llIIIllllI[4] = "  ".length();
        M.llIIIllllI[5] = -(0xFFFFAE2B & 0x7DF7) & (0xFFFFFFFA & 0x3FAF);
        M.llIIIllllI[6] = "   ".length();
        ...
        M.llIIIllllI[25] = 0x18 ^ 0x12 ^ "   ".length();
        M.llIIIllllI[26] = -(0xFFFFEDC7 & 0x3EBD) & (0xFFFFBFFF & 0x6EDC);
        M.llIIIllllI[27] = "  ".length() ^ (0x2C ^ 0x25);
        ...
        M.llIIIllllI[75] = "  ".length() ^ (0x56 ^ 0x67);
        ...
        M.llIIIllllI[101] = 0x2B ^ 0x69 ^ " ".length();
        M.llIIIllllI[102] = 4 ^ 0x6C ^ (0xA2 ^ 0x8E);
        M.llIIIllllI[103] = (3 ^ 0x30) + (5 + 109 - 18 + 58) - (0x7D ^ 0x75) + "   ".length();
    ...
    public int af() {
        ...
        if ((0x48 ^ 0x6D ^ (0xA4 ^ 0x84)) == 0) {
            return (34 + 27 - 46 + 212 ^ 103 + 100 - 18 + 9) & (0x48 ^ 0x76 ^ (0xDA ^ 0xC5) ^ -" ".length());
        }
        return llIIIllllI[108];
    }

    private static String lIlIIlllIllIl(String llllllllllllllllllIlIlIlIlIllIll, String llllllllllllllllllIlIlIlIlIllIII) {
        try {
            SecretKeySpec llllllllllllllllllIlIlIlIlIllllI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIlIlIlIlIllIII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllllIlIlIlIlIlllIl = Cipher.getInstance("Blowfish");
            llllllllllllllllllIlIlIlIlIlllIl.init(llIIIllllI[4], llllllllllllllllllIlIlIlIlIllllI);
            return new String(llllllllllllllllllIlIlIlIlIlllIl.doFinal(Base64.getDecoder().decode(llllllllllllllllllIlIlIlIlIllIll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void cT() {
        block83: {
            Object llllllllllllllllllIlIlIlIllllIlI;
            ...
            block84: {
                ...
                while (M.lIlIIllllIllI(I.co() ? 1 : 0)) {
                    ...
                    "".length();
                    "".length();
                    if (((50 + 27 - -67 + 6 ^ 16 + 178 - 146 + 140) & (132 + 25 - 130 + 117 ^ 165 + 54 - 88 + 55 ^ -" ".length())) != "  ".length()) continue;
                    return;
                }
                if (M.lIlIIllllIllI(Bank.isOpen() ? 1 : 0)) {
                    a.a();
            ...
            if (M.lIlIIllllllII(e.j(gX), llIIIllllI[7])) {
                ...
                if (M.lIlIIllllllII(Vars.getBit((int)llIIIllllI[26]), llIIIllllI[0]) && M.lIlIIllllllII(Vars.getBit((int)llIIIllllI[34]), llIIIllllI[0]) && M.lIlIIllllllII(Vars.getBit((int)llIIIllllI[37]), llIIIllllI[0])) {
                    ...
                    if (M.lIlIIlllllllI(Players.getLocal().getWorldLocation().distanceTo(gT), llIIIllllI[4])) {
                        ...
                        llllllllllllllllllIlIlIlIllllIlI = Dialog.getOptions();
                        if (M.lIlIIllllIllI(llllllllllllllllllIlIlIlIllllIlI.isEmpty() ? 1 : 0)) {
            ...
            if (M.lIlIIllllllII(e.j(gX), llIIIllllI[16])) {
                ...
                if (M.lIlIIllllIllI(Players.getLocal().getWorldLocation().getPlane())) {
                    llllllllllllllllllIlIlIlIllllIlI = new WorldArea(llIIIllllI[51], llIIIllllI[50], llIIIllllI[28], llIIIllllI[13], llIIIllllI[1]);
                    WorldArea llllllllllllllllllIlIlIlIllllIIl = new WorldArea(llIIIllllI[51], llIIIllllI[52], llIIIllllI[7], llIIIllllI[16], llIIIllllI[1]);
                    WorldArea llllllllllllllllllIlIlIlIllllIII = new WorldArea(llIIIllllI[53], llIIIllllI[54], llIIIllllI[7], llIIIllllI[4], llIIIllllI[1]);
                    WorldArea llllllllllllllllllIlIlIlIlllIlll = new WorldArea(llIIIllllI[53], llIIIllllI[52], llIIIllllI[6], llIIIllllI[6], llIIIllllI[1]);
                    if (M.lIlIIllllllIl(Players.getLocal().getWorldLocation().distanceTo(gU), llIIIllllI[4]) && M.lIlIIllllIllI(llllllllllllllllllIlIlIlIllllIlI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && M.lIlIIllllIllI(llllllllllllllllllIlIlIlIllllIIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && M.lIlIIllllIllI(llllllllllllllllllIlIlIlIllllIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && M.lIlIIllllIllI(llllllllllllllllllIlIlIlIlllIlll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (M.lIlIIllllIlII(llllllllllllllllllIlIlIlIllllIll2.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (!M.lIlIIllllIllI(llllllllllllllllllIlIlIlIllllIlI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !M.lIlIIllllIllI(llllllllllllllllllIlIlIlIllllIIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !M.lIlIIllllIllI(llllllllllllllllllIlIlIlIllllIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || M.lIlIIllllIlII(llllllllllllllllllIlIlIlIlllIlll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            String[] stringArray = new String[llIIIllllI[0]];
            ...
            if (M.lIlIIllllllII(e.j(gX), llIIIllllI[17])) {
                ...
                if (M.lIlIIlllllllI(Players.getLocal().getWorldLocation().distanceTo(gW), llIIIllllI[25])) {
                    ...
                    llllllllllllllllllIlIlIlIllllIlI = NPCs.getNearest(nPC -> {
                        int n2;
                        if (M.lIlIIllllIlII(nPC.getName().contains(llIIIlllII[llIIIllllI[111]]) ? 1 : 0) && M.lIlIlIIIIIIII(nPC.getInteracting(), Players.getLocal())) {
                            ...
                            "".length();
                            if ("   ".length() < 0) {
                                return ((0xF8 ^ 0x80 ^ (0xBE ^ 0x8A)) & (0xD2 ^ 0xA1 ^ (0x58 ^ 0x67) ^ -" ".length())) != 0;
                            }
                        } else {
                            n2 = llIIIllllI[1];
                        }
                    ...
                    if (M.lIlIIlllllIII(llllllllllllllllllIlIlIlIllllIll2) && M.lIlIIllllllll(llllllllllllllllllIlIlIlIllllIlI)) {
    ...
    private static void lIlIIllllIIIl() {
        ...
        M.llIIIlllII[M.llIIIllllI[1]] = M.lIlIIlllIlIll("goqjB9xVM6zRcb3/v4ByCJ0XDZ5w5aIu9BuSewuaedFNHus8v/znTFqrJMUqNUdU", "cPxbv");
        M.llIIIlllII[M.llIIIllllI[0]] = M.lIlIIlllIlIll("AXHaamSd1h4=", "BQkzM");
        M.llIIIlllII[M.llIIIllllI[4]] = M.lIlIIlllIllII("FjMGdDM3chI1KTM=", "XRpTG");
        M.llIIIlllII[M.llIIIllllI[6]] = M.lIlIIlllIlIll("jIbEPiLdX7voB87cBu6u+REZHsC6SdLs", "uqtRH");
        M.llIIIlllII[M.llIIIllllI[7]] = M.lIlIIlllIllIl("iyz+hY2hFqDvj/yihoFEb0FS3/C+p5pMlo+QJ6DI4nIX5yvIAm80eTIKD7130oxG", "UTreh");
        M.llIIIlllII[M.llIIIllllI[16]] = M.lIlIIlllIllIl("Ral5nXTMNRe9tdWqHmJTzSmpBdQC2/EE3klPSZVKNL/WadAVqc+uzto2CeISmkHGKpAK0YperIY=", "gigdZ");
        M.llIIIlllII[M.llIIIllllI[13]] = M.lIlIIlllIllIl("MocrH+gXCXw=", "korqs");
        M.llIIIlllII[M.llIIIllllI[17]] = M.lIlIIlllIllIl("wHwcjmFkJro=", "ZvIYR");
        M.llIIIlllII[M.llIIIllllI[20]] = M.lIlIIlllIllIl("1AsJxZ78WI5mG7xrnOsAUw==", "vTXXA");
        M.llIIIlllII[M.llIIIllllI[25]] = M.lIlIIlllIllII("OAYfSjsZRwoFIhsGBw4qBA==", "vgijO");
        M.llIIIlllII[M.llIIIllllI[21]] = M.lIlIIlllIllII("NwE/ChUaCjcVVDkBPBMVHQ==", "tnRgt");
        M.llIIIlllII[M.llIIIllllI[27]] = M.lIlIIlllIllIl("eJZw9QUSxaCgjo/caUkZsA==", "kIoJs");
        M.llIIIlllII[M.llIIIllllI[28]] = M.lIlIIlllIlIll("oXFNMhozY7g=", "MtOHD");
        M.llIIIlllII[M.llIIIllllI[2]] = M.lIlIIlllIllIl("MRHCD/P9rv8=", "JPgap");
        M.llIIIlllII[M.llIIIllllI[29]] = M.lIlIIlllIlIll("bL/DmafG/Nc=", "tykoz");
        M.llIIIlllII[M.llIIIllllI[30]] = M.lIlIIlllIllIl("TmizxaAQp54=", "icvjA");
        M.llIIIlllII[M.llIIIllllI[31]] = M.lIlIIlllIllIl("/Ko8XoTezjw=", "XHbpP");
        M.llIIIlllII[M.llIIIllllI[32]] = M.lIlIIlllIllIl("haOsRupmU5E=", "fatwF");
        M.llIIIlllII[M.llIIIllllI[33]] = M.lIlIIlllIllIl("FOpT6DA5jy6WafNw3HBfmw==", "DrSih");
        M.llIIIlllII[M.llIIIllllI[35]] = M.lIlIIlllIllII("CCA5UyMpYTsBNiUqKgE=", "FAOsW");
        M.llIIIlllII[M.llIIIllllI[36]] = M.lIlIIlllIllIl("/sqxgSE3/3vJ7PYfrcuDDA==", "AyILf");
        M.llIIIlllII[M.llIIIllllI[38]] = M.lIlIIlllIlIll("ICRqDSORfrLJVqWiHJsxUg==", "evDIb");
        M.llIIIlllII[M.llIIIllllI[39]] = M.lIlIIlllIlIll("pcFC/mI5ki9xz6axQz5LDg==", "CfVah");
        M.llIIIlllII[M.llIIIllllI[40]] = M.lIlIIlllIllII("LSU+eQcMZCo4Hw8tOy0S", "cDHYs");
        M.llIIIlllII[M.llIIIllllI[41]] = M.lIlIIlllIllII("KSQ+HSkI", "oMLtG");
        M.llIIIlllII[M.llIIIllllI[42]] = M.lIlIIlllIllII("DRInNgw8Byo=", "OsKZe");
        M.llIIIlllII[M.llIIIllllI[43]] = M.lIlIIlllIllII("MTA9Hw==", "wYOzc");
        M.llIIIlllII[M.llIIIllllI[45]] = M.lIlIIlllIllIl("jY60rY4EZpQ=", "JozkY");
        M.llIIIlllII[M.llIIIllllI[46]] = M.lIlIIlllIllII("ZVFVRg==", "Uaetr");
        M.llIIIlllII[M.llIIIllllI[47]] = M.lIlIIlllIllII("c2lDXw==", "CYslS");
        M.llIIIlllII[M.llIIIllllI[48]] = M.lIlIIlllIllII("VWRAdw==", "eTpCf");
        M.llIIIlllII[M.llIIIllllI[55]] = M.lIlIIlllIllII("FjMHajo3chI4OzUwHS8=", "XRqJN");
        M.llIIIlllII[M.llIIIllllI[56]] = M.lIlIIlllIllIl("PwiL9XD4fdbSFG3RqRznBg==", "VwADn");
        M.llIIIlllII[M.llIIIllllI[57]] = M.lIlIIlllIllII("DgAvJwNgAzAvEw==", "MlFJa");
        M.llIIIlllII[M.llIIIllllI[60]] = M.lIlIIlllIlIll("CotqHkaJ5Fc=", "jMGVS");
        M.llIIIlllII[M.llIIIllllI[61]] = M.lIlIIlllIllII("AzokFA==", "LJAzn");
        M.llIIIlllII[M.llIIIllllI[62]] = M.lIlIIlllIlIll("LcREWdJSyPo=", "QOPSC");
        M.llIIIlllII[M.llIIIllllI[63]] = M.lIlIIlllIllIl("x20sXf9wjXo=", "sVGtq");
        M.llIIIlllII[M.llIIIllllI[64]] = M.lIlIIlllIllIl("qDRzvKVeVyc=", "bJyaq");
        M.llIIIlllII[M.llIIIllllI[65]] = M.lIlIIlllIllIl("1bcq0/HkMvc=", "YiGVK");
        M.llIIIlllII[M.llIIIllllI[66]] = M.lIlIIlllIllII("DzMzNhYx", "CRWRs");
        M.llIIIlllII[M.llIIIllllI[67]] = M.lIlIIlllIllII("KR0TAhVHBAo=", "jqzow");
        M.llIIIlllII[M.llIIIllllI[68]] = M.lIlIIlllIlIll("28N2ydGZcnk=", "PjAiv");
        M.llIIIlllII[M.llIIIllllI[69]] = M.lIlIIlllIlIll("G5puMaj5JDtvqdnJI2meqA==", "TgDCj");
        M.llIIIlllII[M.llIIIllllI[70]] = M.lIlIIlllIllII("JBoXLngMGhQ=", "chvLX");
        M.llIIIlllII[M.llIIIllllI[3]] = M.lIlIIlllIllIl("HP3gPMAz80XXGBDNn0JP+A==", "dUuZZ");
        M.llIIIlllII[M.llIIIllllI[71]] = M.lIlIIlllIlIll("rer5Tba5qMCsJyrot4CR+g==", "FOQTb");
        M.llIIIlllII[M.llIIIllllI[72]] = M.lIlIIlllIllIl("vK3AyN/tfWI=", "Ujpwe");
        M.llIIIlllII[M.llIIIllllI[73]] = M.lIlIIlllIlIll("RvxcUwrQcQo2x7+6akI+yA==", "LOxuL");
        M.llIIIlllII[M.llIIIllllI[74]] = M.lIlIIlllIllIl("Fk661Ig+5YpBKMQcWdBH3g==", "BvzwJ");
        M.llIIIlllII[M.llIIIllllI[24]] = M.lIlIIlllIllII("Ih0ABwsZ", "qxauh");
        M.llIIIlllII[M.llIIIllllI[75]] = M.lIlIIlllIlIll("jDaw51qdEW4PY3vgN8FxLw==", "hBMzT");
        M.llIIIlllII[M.llIIIllllI[76]] = M.lIlIIlllIllIl("2CC3rwP/RN15LG44gXPZrAGBISVOKexo", "YkFzh");
        M.llIIIlllII[M.llIIIllllI[77]] = M.lIlIIlllIllII("GCsGKgIhJ0cnAiEvCCIH", "SCgPc");
        M.llIIIlllII[M.llIIIllllI[78]] = M.lIlIIlllIllIl("o94B4y8f5hk=", "zccHr");
        M.llIIIlllII[M.llIIIllllI[79]] = M.lIlIIlllIlIll("qsmK+mY/eO1cgt549YGhAw==", "TwgFW");
        M.llIIIlllII[M.llIIIllllI[80]] = M.lIlIIlllIllIl("HJQGTOjbfU0=", "kljkY");
        M.llIIIlllII[M.llIIIllllI[81]] = M.lIlIIlllIllIl("TTg3hzwcg0mXptFZEXBcWg==", "fHiVZ");
        M.llIIIlllII[M.llIIIllllI[82]] = M.lIlIIlllIllII("Fzs7BSc=", "SIRkL");
        M.llIIIlllII[M.llIIIllllI[83]] = M.lIlIIlllIlIll("kzARCbcrZhvBTVt6pe09CTsPSJsRd5qV", "uewDT");
        M.llIIIlllII[M.llIIIllllI[84]] = M.lIlIIlllIllIl("Uk2npbaqbvBmdPnz6Nk3wA==", "xkamZ");
        M.llIIIlllII[M.llIIIllllI[85]] = M.lIlIIlllIlIll("r+pjXxLigWhyePg/ygvpgZfKe7eNoXZg", "SLtrv");
        M.llIIIlllII[M.llIIIllllI[86]] = M.lIlIIlllIllII("NycPEw==", "cFdvL");
        M.llIIIlllII[M.llIIIllllI[87]] = M.lIlIIlllIlIll("tYNebx1XOv0FZsFucSAo5SxZhSCPZ3pZ", "QnGBm");
        M.llIIIlllII[M.llIIIllllI[88]] = M.lIlIIlllIllII("DSgPElcELg0HEig=", "FAauw");
        M.llIIIlllII[M.llIIIllllI[89]] = M.lIlIIlllIllII("Ow4dczcaTxgnIgcb", "uokSC");
        M.llIIIlllII[M.llIIIllllI[100]] = M.lIlIIlllIllIl("Ov2u3Yx4vGCgs12oE2cG1w==", "ZlBYi");
        M.llIIIlllII[M.llIIIllllI[101]] = M.lIlIIlllIlIll("YCKx37s1/ivuOXsRTYTI9A==", "fYrkY");
        M.llIIIlllII[M.llIIIllllI[102]] = M.lIlIIlllIllII("BzsMFBIuL1QFHyYlDBYf", "TJyqw");
        M.llIIIlllII[M.llIIIllllI[109]] = M.lIlIIlllIlIll("P0dJtqqz72/bEjtdfsUNlvpbTVsyNkKx", "KPxcE");
        M.llIIIlllII[M.llIIIllllI[110]] = M.lIlIIlllIllII("MyQeBFkuK1AUHCAhBAtZaQ==", "AMpcy");
        M.llIIIlllII[M.llIIIllllI[111]] = M.lIlIIlllIllII("OxADCyoqEA==", "ObldZ");
        M.llIIIlllII[M.llIIIllllI[130]] = M.lIlIIlllIlIll("Vi0ik7wfJ6ChSFlGyaKiObNXdG0Y1aJd", "ufguB");
        M.llIIIlllII[M.llIIIllllI[131]] = M.lIlIIlllIllII("GkcDJQI/A1QoEnMAGCsTcxMbah82CwRk", "SgtJw");
        M.llIIIlllII[M.llIIIllllI[132]] = M.lIlIIlllIllII("BjhURBxuPxREMignEAEnaSAXCTBpJBcLMWc=", "ISxdU");
        M.llIIIlllII[M.llIIIllllI[133]] = M.lIlIIlllIllIl("LFlolt2GztA1jbtIcEOV2EmbHZHJ0rd6", "ReybG");
        M.llIIIlllII[M.llIIIllllI[134]] = M.lIlIIlllIllIl("VDY8DvDB7nk9ICS9iJcMkqCf3lwOyNABTNmZ+sAFlI1ohhFxAbK+kvpGw9bKKWhzSn1w9qSjPDQ=", "omriw");
        M.llIIIlllII[M.llIIIllllI[135]] = M.lIlIIlllIllII("IBMjSw==", "yvPen");
    }

    private static String lIlIIlllIlIll(String llllllllllllllllllIlIlIlIlIIlllI, String llllllllllllllllllIlIlIlIlIIlIll) {
        try {
            SecretKeySpec llllllllllllllllllIlIlIlIlIlIIIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIlIlIlIlIIlIll.getBytes(StandardCharsets.UTF_8)), llIIIllllI[20]), "DES");
            Cipher llllllllllllllllllIlIlIlIlIlIIII = Cipher.getInstance("DES");
            llllllllllllllllllIlIlIlIlIlIIII.init(llIIIllllI[4], llllllllllllllllllIlIlIlIlIlIIIl);
            return new String(llllllllllllllllllIlIlIlIlIlIIII.doFinal(Base64.getDecoder().decode(llllllllllllllllllIlIlIlIlIIlllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void cU() {
        if (M.lIlIIllllllIl(Players.getLocal().getWorldLocation().distanceTo(gN), llIIIllllI[4])) {
            void llllllllllllllllllIlIlIlIllIllll;
            void llllllllllllllllllIlIlIlIlllIIII;
            void llllllllllllllllllIlIlIlIlllIIlI;
            ...
            if (M.lIlIIllllIllI(llllllllllllllllllIlIlIlIlllIIlI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (M.lIlIIllllIlII(O.ks.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && M.lIlIIllllIllI(llllllllllllllllllIlIlIlIlllIIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && M.lIlIIllllIllI(llllllllllllllllllIlIlIlIllIllll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && M.lIlIIllllIllI(gY.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && M.lIlIIllllIllI(gZ.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                Walker.stepAlong(List.of(O.jy));
                "".length();
                Time.sleepTicks((int)llIIIllllI[0]);
                "".length();
            }
            if (!M.lIlIIllllIllI(llllllllllllllllllIlIlIlIlllIIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || M.lIlIIllllIlII(llllllllllllllllllIlIlIlIllIllll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                String[] stringArray = new String[llIIIllllI[0]];
    ...
    private static String lIlIIlllIllII(String llllllllllllllllllIlIlIlIIlllllI, String llllllllllllllllllIlIlIlIIlllIII) {
        llllllllllllllllllIlIlIlIIlllllI = new String(Base64.getDecoder().decode(llllllllllllllllllIlIlIlIIlllllI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllIlIlIlIIllllII = new StringBuilder();
        char[] llllllllllllllllllIlIlIlIIlllIll = llllllllllllllllllIlIlIlIIlllIII.toCharArray();
        int llllllllllllllllllIlIlIlIIlllIlI = llIIIllllI[1];
        char[] llllllllllllllllllIlIlIlIIllIlII = llllllllllllllllllIlIlIlIIlllllI.toCharArray();
        int llllllllllllllllllIlIlIlIIllIIll = llllllllllllllllllIlIlIlIIllIlII.length;
        int llllllllllllllllllIlIlIlIIllIIlI = llIIIllllI[1];
        while (M.lIlIIllllIlIl(llllllllllllllllllIlIlIlIIllIIlI, llllllllllllllllllIlIlIlIIllIIll)) {
            char llllllllllllllllllIlIlIlIIllllll = llllllllllllllllllIlIlIlIIllIlII[llllllllllllllllllIlIlIlIIllIIlI];
            llllllllllllllllllIlIlIlIIllllII.append((char)(llllllllllllllllllIlIlIlIIllllll ^ llllllllllllllllllIlIlIlIIlllIll[llllllllllllllllllIlIlIlIIlllIlI % llllllllllllllllllIlIlIlIIlllIll.length]));
            "".length();
            ++llllllllllllllllllIlIlIlIIlllIlI;
            ++llllllllllllllllllIlIlIlIIllIIlI;
            "".length();
