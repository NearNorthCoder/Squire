...
implements ac {
    ...
    public static void gY() {
        ...
        if (aJ.lIlIIIIlIlIll(bt ? 1 : 0)) {
            if (aJ.lIlIIIIlIlIll(aJ.an() ? 1 : 0) && aJ.lIlIIIIlIlIlI(e.j(pN), lIlllllIll[0])) {
                BankLocation llllllllllllllllllIlllIIIIIlIIll = BankLocation.getNearest();
                if (aJ.lIlIIIIlIllII(llllllllllllllllllIlllIIIIIlIIll) && aJ.lIlIIIIlIlIll(llllllllllllllllllIlllIIIIIlIIll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderSotf.c = lIlllllIIl[lIlllllIll[0]];
                    a.a(llllllllllllllllllIlllIIIIIlIIll);
                }
                if (aJ.lIlIIIIlIllII(llllllllllllllllllIlllIIIIIlIIll) && aJ.lIlIIIIlIlIIl(llllllllllllllllllIlllIIIIIlIIll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String lIlIIIIIlllII(String llllllllllllllllllIllIlllllIllII, String llllllllllllllllllIllIllllllIIII) {
        llllllllllllllllllIllIlllllIllII = new String(Base64.getDecoder().decode(llllllllllllllllllIllIlllllIllII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllIllIlllllIllll = new StringBuilder();
        char[] llllllllllllllllllIllIlllllIlllI = llllllllllllllllllIllIllllllIIII.toCharArray();
        int llllllllllllllllllIllIlllllIllIl = lIlllllIll[1];
        char[] llllllllllllllllllIllIlllllIIlll = llllllllllllllllllIllIlllllIllII.toCharArray();
        int llllllllllllllllllIllIlllllIIllI = llllllllllllllllllIllIlllllIIlll.length;
        int llllllllllllllllllIllIlllllIIlIl = lIlllllIll[1];
        while (aJ.lIlIIIIlIlIlI(llllllllllllllllllIllIlllllIIlIl, llllllllllllllllllIllIlllllIIllI)) {
            char llllllllllllllllllIllIllllllIIlI = llllllllllllllllllIllIlllllIIlll[llllllllllllllllllIllIlllllIIlIl];
            llllllllllllllllllIllIlllllIllll.append((char)(llllllllllllllllllIllIllllllIIlI ^ llllllllllllllllllIllIlllllIlllI[llllllllllllllllllIllIlllllIllIl % llllllllllllllllllIllIlllllIlllI.length]));
            "".length();
            ++llllllllllllllllllIllIlllllIllIl;
            ++llllllllllllllllllIllIlllllIIlIl;
            "".length();
    ...
    private static String lIlIIIIIlllIl(String llllllllllllllllllIllIllllllllll, String llllllllllllllllllIlllIIIIIIIIII) {
        try {
            ...
            Cipher llllllllllllllllllIlllIIIIIIIIll = Cipher.getInstance("Blowfish");
            llllllllllllllllllIlllIIIIIIIIll.init(lIlllllIll[3], llllllllllllllllllIlllIIIIIIIlII);
            return new String(llllllllllllllllllIlllIIIIIIIIll.doFinal(Base64.getDecoder().decode(llllllllllllllllllIllIllllllllll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static boolean an() {
        void llllllllllllllllllIlllIIIIIlIIII;
        ...
        while (aJ.lIlIIIIlIlIlI(llllllllllllllllllIlllIIIIIIllll, ((void)llllllllllllllllllIlllIIIIIlIIII).length)) {
            int[] nArray3 = new int[lIlllllIll[0]];
            nArray3[aJ.lIlllllIll[1]] = llllllllllllllllllIlllIIIIIlIIII[llllllllllllllllllIlllIIIIIIllll];
            ...
            return ((0x91 ^ 0x8D ^ (1 ^ 0x2C)) & (0xF1 ^ 0x96 ^ (3 ^ 0x55) ^ -" ".length())) != 0;
        }
        return lIlllllIll[0];
    }
    ...
    private static void Q() {
        block22: {
            d llllllllllllllllllIlllIIIIIIlIll;
            block21: {
                block20: {
                    block19: {
                        block18: {
                            block17: {
                                Object llllllllllllllllllIlllIIIIIIllII;
                                block16: {
                                    block15: {
                                    ...
                                    llllllllllllllllllIlllIIIIIIllII = new d(lIlllllIll[17], lIlllllIll[8], e.c(lIlllllIll[18], lIlllllIll[19]));
                                    bv.add((d)llllllllllllllllllIlllIIIIIIllII);
                                    "".length();
                                }
                                int[] nArray = new int[lIlllllIll[0]];
                                nArray[aJ.lIlllllIll[1]] = lIlllllIll[20];
                                if (aJ.lIlIIIIlIlIll(Bank.contains((int[])nArray) ? 1 : 0)) {
                                    llllllllllllllllllIlllIIIIIIllII = new d(lIlllllIll[20], lIlllllIll[21], lIlllllIll[22]);
                                    bv.add((d)llllllllllllllllllIlllIIIIIIllII);
                                    "".length();
                                }
                                if (aJ.lIlIIIIlIlIll(Bank.contains((Predicate)(llllllllllllllllllIlllIIIIIIllII = item -> item.getName().toLowerCase().contains(lIlllllIIl[lIlllllIll[34]]))) ? 1 : 0)) {
                                    llllllllllllllllllIlllIIIIIIlIll = new d(lIlllllIll[23], lIlllllIll[12], lIlllllIll[24]);
                                    bv.add(llllllllllllllllllIlllIIIIIIlIll);
                                    "".length();
                                }
                                int[] nArray4 = new int[lIlllllIll[0]];
                                nArray4[aJ.lIlllllIll[1]] = lIlllllIll[25];
                                if (aJ.lIlIIIIlIlIll(Bank.contains((int[])nArray4) ? 1 : 0)) {
                                    llllllllllllllllllIlllIIIIIIlIll = new d(lIlllllIll[25], lIlllllIll[0], lIlllllIll[26]);
                                    bv.add(llllllllllllllllllIlllIIIIIIlIll);
                                    "".length();
                                }
                            ...
                            llllllllllllllllllIlllIIIIIIlIll = new d(lIlllllIll[9], lIlllllIll[4], j.cf);
                            bv.add(llllllllllllllllllIlllIIIIIIlIll);
                            "".length();
                        }
                        int[] nArray = new int[lIlllllIll[0]];
                    ...
                    llllllllllllllllllIlllIIIIIIlIll = new d(lIlllllIll[27], lIlllllIll[22], lIlllllIll[28]);
                    bv.add(llllllllllllllllllIlllIIIIIIlIll);
                    "".length();
                }
                int[] nArray = new int[lIlllllIll[0]];
            ...
            llllllllllllllllllIlllIIIIIIlIll = new d(lIlllllIll[5], lIlllllIll[30], lIlllllIll[31]);
            bv.add(llllllllllllllllllIlllIIIIIIlIll);
            "".length();
        }
    }
    ...
    private static String lIlIIIIlIIlIl(String llllllllllllllllllIllIllllIllIlI, String llllllllllllllllllIllIllllIllIIl) {
        try {
            SecretKeySpec llllllllllllllllllIllIllllIlllll = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIllIllllIllIIl.getBytes(StandardCharsets.UTF_8)), lIlllllIll[15]), "DES");
            Cipher llllllllllllllllllIllIllllIllllI = Cipher.getInstance("DES");
            llllllllllllllllllIllIllllIllllI.init(lIlllllIll[3], llllllllllllllllllIllIllllIlllll);
            return new String(llllllllllllllllllIllIllllIllllI.doFinal(Base64.getDecoder().decode(llllllllllllllllllIllIllllIllIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public int af() {
        ...
        if (-"   ".length() >= 0) {
            return (0x7B ^ 0x75 ^ (0x8F ^ 0xAD)) & (0x8E ^ 0xC3 ^ (0x5E ^ 0x3F) ^ -" ".length());
        }
    ...
    private static void lIlIIIIlIIllI() {
        ...
        aJ.lIlllllIIl[aJ.lIlllllIll[1]] = aJ.lIlIIIIIlllII("MxwZJTsdEBNsKgAMHiIvVRwDKSUGWVc/PxwBFCQhGxJXLikWHlc4J1UEAik7AQ==", "uuwLH");
        aJ.lIlllllIIl[aJ.lIlllllIll[0]] = aJ.lIlIIIIIlllII("Gi0xZiE7bCUnOz8=", "TLGFU");
        aJ.lIlllllIIl[aJ.lIlllllIll[3]] = aJ.lIlIIIIIlllIl("AhsSjdkOsgnQgy7eaNAfiCThNdsk4lsY", "nRzPB");
        aJ.lIlllllIIl[aJ.lIlllllIll[7]] = aJ.lIlIIIIIlllII("FgNBORMkRgwxEjIPDz9BMBMEKxVhFRQoES0PBCtNYRUWMRUiDgg2BmESDngjFD8oFiY=", "AfaXa");
        aJ.lIlllllIIl[aJ.lIlllllIll[4]] = aJ.lIlIIIIIlllIl("esHW+YCFN3M=", "XpobM");
        aJ.lIlllllIIl[aJ.lIlllllIll[12]] = aJ.lIlIIIIIlllIl("riVSswKo8LY=", "KNMVz");
        aJ.lIlllllIIl[aJ.lIlllllIll[13]] = aJ.lIlIIIIIlllII("IQ4XFQk=", "rfvgb");
        aJ.lIlllllIIl[aJ.lIlllllIll[14]] = aJ.lIlIIIIIlllII("HiEgFjs=", "MIAdP");
        aJ.lIlllllIIl[aJ.lIlllllIll[15]] = aJ.lIlIIIIIlllIl("IOa/60QIvi0=", "DiBJD");
        aJ.lIlllllIIl[aJ.lIlllllIll[16]] = aJ.lIlIIIIIlllIl("aCnjModD2KKWISpRysKBIA==", "pbEHg");
        ...
        aJ.lIlllllIIl[aJ.lIlllllIll[34]] = aJ.lIlIIIIIlllIl("VIjSGAt6IWsIJwfO2hT9dbQGAFSFBM9A", "tMgny");
        aJ.lIlllllIIl[aJ.lIlllllIll[35]] = aJ.lIlIIIIlIIlIl("IduDDOzn1/s=", "MWYuT");
    }
    ...
    public boolean ah() {
        ...
        if (aJ.lIlIIIIllIIIl(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()), lIlllllIll[15])) {
            ...
            if (-(172 + 123 - 198 + 81 ^ 150 + 59 - 62 + 35) >= 0) {
                return ((0x43 ^ 0x2F ^ (0xBC ^ 0xC6)) & (0x87 ^ 0xC0 ^ (0xEE ^ 0xBF) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlllllIll[1];
        }
