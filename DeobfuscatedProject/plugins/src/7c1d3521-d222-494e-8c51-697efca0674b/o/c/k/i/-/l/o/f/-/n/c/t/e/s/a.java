...
public class a {
    ...
    public static void a(int[] nArray) {
        int[] llllllllllllllllllIIlIlIIIlllIII;
        int llllllllllllllllllIIlIlIIIllIlll = llIlIIIIlI[2];
        while (a.lIllIIIIIIlll(llllllllllllllllllIIlIlIIIllIlll, llllllllllllllllllIIlIlIIIlllIII.length)) {
            Bank.withdraw((int)llllllllllllllllllIIlIlIIIlllIII[llllllllllllllllllIIlIlIIIllIlll], (int)llIlIIIIlI[1], (Bank.WithdrawMode)Bank.WithdrawMode.DEFAULT);
            Time.sleepTicks((int)llIlIIIIlI[1]);
            "".length();
            ++llllllllllllllllllIIlIlIIIllIlll;
            "".length();
    ...
    private static String lIlIllllllIlI(String llllllllllllllllllIIlIlIIIIlIlll, String llllllllllllllllllIIlIlIIIIllIll) {
        llllllllllllllllllIIlIlIIIIlIlll = new String(Base64.getDecoder().decode(llllllllllllllllllIIlIlIIIIlIlll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllIIlIlIIIIllIlI = new StringBuilder();
        char[] llllllllllllllllllIIlIlIIIIllIIl = llllllllllllllllllIIlIlIIIIllIll.toCharArray();
        int llllllllllllllllllIIlIlIIIIllIII = llIlIIIIlI[2];
        char[] llllllllllllllllllIIlIlIIIIlIIlI = llllllllllllllllllIIlIlIIIIlIlll.toCharArray();
        int llllllllllllllllllIIlIlIIIIlIIIl = llllllllllllllllllIIlIlIIIIlIIlI.length;
        int llllllllllllllllllIIlIlIIIIlIIII = llIlIIIIlI[2];
        while (a.lIllIIIIIIlll(llllllllllllllllllIIlIlIIIIlIIII, llllllllllllllllllIIlIlIIIIlIIIl)) {
            char llllllllllllllllllIIlIlIIIIlllIl = llllllllllllllllllIIlIlIIIIlIIlI[llllllllllllllllllIIlIlIIIIlIIII];
            llllllllllllllllllIIlIlIIIIllIlI.append((char)(llllllllllllllllllIIlIlIIIIlllIl ^ llllllllllllllllllIIlIlIIIIllIIl[llllllllllllllllllIIlIlIIIIllIII % llllllllllllllllllIIlIlIIIIllIIl.length]));
            "".length();
            ++llllllllllllllllllIIlIlIIIIllIII;
            ++llllllllllllllllllIIlIlIIIIlIIII;
            "".length();
            if (((0x80 ^ 0xB5) & ~(0x8B ^ 0xBE)) >= 0) continue;
            return null;
        }
        return String.valueOf(llllllllllllllllllIIlIlIIIIllIlI);
    }
    ...
    public static void b(int[] nArray, int n2) {
        int[] llllllllllllllllllIIlIlIIIlIllIl;
        int llllllllllllllllllIIlIlIIIlIlIll = llIlIIIIlI[2];
        while (a.lIllIIIIIIlll(llllllllllllllllllIIlIlIIIlIlIll, llllllllllllllllllIIlIlIIIlIllIl.length)) {
            void llllllllllllllllllIIlIlIIIlIllII;
            Bank.withdraw((int)llllllllllllllllllIIlIlIIIlIllIl[llllllllllllllllllIIlIlIIIlIlIll], (int)llllllllllllllllllIIlIlIIIlIllII, (Bank.WithdrawMode)Bank.WithdrawMode.DEFAULT);
            Time.sleepTicks((int)llIlIIIIlI[1]);
            "".length();
            int[] nArray2 = new int[llIlIIIIlI[1]];
            nArray2[a.llIlIIIIlI[2]] = llllllllllllllllllIIlIlIIIlIllIl[llllllllllllllllllIIlIlIIIlIlIll];
            if (a.lIllIIIIIIIlI(Inventory.contains((int[])nArray2) ? 1 : 0)) {
                "".length();
                if (null == null) break;
                return;
            }
            ++llllllllllllllllllIIlIlIIIlIlIll;
            "".length();
            if (-" ".length() <= (0x9B ^ 0x9F)) continue;
            return;
        }
    }
    ...
    public static void a(int[] nArray, int n2) {
        int[] llllllllllllllllllIIlIlIIIllIIll;
        int llllllllllllllllllIIlIlIIIllIIIl = llIlIIIIlI[2];
        while (a.lIllIIIIIIlll(llllllllllllllllllIIlIlIIIllIIIl, llllllllllllllllllIIlIlIIIllIIll.length)) {
            void llllllllllllllllllIIlIlIIIllIIlI;
            Bank.withdraw((int)llllllllllllllllllIIlIlIIIllIIll[llllllllllllllllllIIlIlIIIllIIIl], (int)llllllllllllllllllIIlIlIIIllIIlI, (Bank.WithdrawMode)Bank.WithdrawMode.DEFAULT);
            Time.sleepTicks((int)llIlIIIIlI[1]);
            "".length();
            ++llllllllllllllllllIIlIlIIIllIIIl;
            "".length();
            if (((0xAB ^ 0xA0 ^ (0x45 ^ 0x72) & ~(0x51 ^ 0x66)) & (0xD6 ^ 0x90 ^ (0x5F ^ 0x12) ^ -" ".length())) != "   ".length()) continue;
            return;
        }
    }
    ...
    public static void a() {
        ...
        if (!a.lIllIIIIIIIll(BankLocation.GRAND_EXCHANGE_BANK.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || a.lIllIIIIIIIlI(w.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            TileObject llllllllllllllllllIIlIlIIIlllIll = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (String[])stringArray);
            if (a.lIllIIIIIIlIl(llllllllllllllllllIIlIlIIIlllIll)) {
                String[] stringArray2 = new String[llIlIIIIlI[1]];
                stringArray2[a.llIlIIIIlI[2]] = llIlIIIIII[llIlIIIIlI[23]];
                if (a.lIllIIIIIIIlI(llllllllllllllllllIIlIlIIIlllIll.hasAction(stringArray2) ? 1 : 0)) {
                    llllllllllllllllllIIlIlIIIlllIll.interact(llIlIIIIII[llIlIIIIlI[22]]);
                    Time.sleepTicks((int)llIlIIIIlI[15]);
                    "".length();
                    Time.sleepUntil(() -> Bank.isOpen(), (int)llIlIIIIlI[30]);
                    "".length();
                ...
                if (a.lIllIIIIIIIlI(llllllllllllllllllIIlIlIIIlllIll.hasAction(stringArray3) ? 1 : 0)) {
                    llllllllllllllllllIIlIlIIIlllIll.interact(llIlIIIIII[llIlIIIIlI[33]]);
                    Time.sleepTicks((int)llIlIIIIlI[15]);
                    "".length();
                    Time.sleepUntil(() -> Bank.isOpen(), (int)llIlIIIIlI[30]);
                    "".length();
            ...
            TileObject llllllllllllllllllIIlIlIIIlllIll = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (String[])stringArray);
            if (a.lIllIIIIIIlIl(llllllllllllllllllIIlIlIIIlllIll)) {
                llllllllllllllllllIIlIlIIIlllIll.interact(llIlIIIIII[llIlIIIIlI[35]]);
                Time.sleepTicks((int)llIlIIIIlI[15]);
                "".length();
                Time.sleepUntil(() -> Bank.isOpen(), (int)llIlIIIIlI[30]);
                "".length();
    ...
    private static void lIllIIIIIIIII() {
        ...
        a.llIlIIIIlI[12] = -" ".length();
        a.llIlIIIIlI[13] = 0xB0 ^ 0x84 ^ (0x3B ^ 9);
        a.llIlIIIIlI[14] = "  ".length();
        a.llIlIIIIlI[15] = "   ".length();
        ...
        a.llIlIIIIlI[43] = "   ".length() ^ (0x14 ^ 0x30);
    ...
    private static String lIlIllllllIll(String llllllllllllllllllIIlIIllllllIII, String llllllllllllllllllIIlIIlllllIlll) {
        try {
            SecretKeySpec llllllllllllllllllIIlIIlllllllIl = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIIlIIlllllIlll.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            return new String(llllllllllllllllllIIlIIlllllllII.doFinal(Base64.getDecoder().decode(llllllllllllllllllIIlIIllllllIII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
        catch (Exception llllllllllllllllllIIlIIllllllIll) {
            llllllllllllllllllIIlIIllllllIll.printStackTrace();
            return null;
        }
    }
    ...
    private static void lIlIlllllllll() {
        ...
        a.llIlIIIIII[a.llIlIIIIlI[2]] = a.lIlIllllllIIl("rN6ScatqMm8=", "wXoLl");
        a.llIlIIIIII[a.llIlIIIIlI[1]] = a.lIlIllllllIIl("y30C3f9RWr8=", "LwIBF");
        a.llIlIIIIII[a.llIlIIIIlI[14]] = a.lIlIllllllIlI("HSgQBQ==", "JMqwt");
        a.llIlIIIIII[a.llIlIIIIlI[15]] = a.lIlIllllllIll("zYLaAytXCCo=", "Hbxfn");
        a.llIlIIIIII[a.llIlIIIIlI[24]] = a.lIlIllllllIlI("EgQgBDM=", "PvEeX");
        a.llIlIIIIII[a.llIlIIIIlI[19]] = a.lIlIllllllIIl("ggPhSMLHRQQ=", "UBsYc");
        a.llIlIIIIII[a.llIlIIIIlI[13]] = a.lIlIllllllIll("WZ11uzyWq7g=", "mmSKK");
        a.llIlIIIIII[a.llIlIIIIlI[27]] = a.lIlIllllllIll("8gO6Nor98Q2Mj+npx3QVtgL4moGckPPf", "QQBHv");
        a.llIlIIIIII[a.llIlIIIIlI[29]] = a.lIlIllllllIll("pwfO+lldTzI=", "PmPvn");
        a.llIlIIIIII[a.llIlIIIIlI[31]] = a.lIlIllllllIll("iyvwj78Ph2kbfGnndR8WdA==", "FWJWU");
        a.llIlIIIIII[a.llIlIIIIlI[23]] = a.lIlIllllllIlI("NCYy", "aUWgZ");
        a.llIlIIIIII[a.llIlIIIIlI[22]] = a.lIlIllllllIlI("DwUr", "ZvNbK");
        a.llIlIIIIII[a.llIlIIIIlI[32]] = a.lIlIllllllIlI("FyUXCg==", "UDyag");
        a.llIlIIIIII[a.llIlIIIIlI[33]] = a.lIlIllllllIll("VvP9M5wZVvo=", "ihyid");
        a.llIlIIIIII[a.llIlIIIIlI[34]] = a.lIlIllllllIlI("MDIHOlYQPAYlHg==", "rSiQv");
        a.llIlIIIIII[a.llIlIIIIlI[35]] = a.lIlIllllllIlI("IwsHOQ==", "ajiRj");
        a.llIlIIIIII[a.llIlIIIIlI[36]] = a.lIlIllllllIIl("Z29NmPk7DoT6gAewBYF/Tw==", "efkPd");
        a.llIlIIIIII[a.llIlIIIIlI[37]] = a.lIlIllllllIll("HnIsF3AekdEVz527wr27Qw==", "iytpz");
        a.llIlIIIIII[a.llIlIIIIlI[38]] = a.lIlIllllllIll("5i5thGe837GEQFLutwS24Q==", "jzjra");
        a.llIlIIIIII[a.llIlIIIIlI[39]] = a.lIlIllllllIlI("MycGFjcoMB4=", "GBjsG");
    }

    private static String lIlIllllllIIl(String llllllllllllllllllIIlIlIIIIIIlIl, String llllllllllllllllllIIlIlIIIIIIlII) {
        try {
            SecretKeySpec llllllllllllllllllIIlIlIIIIIlIlI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIIlIlIIIIIIlII.getBytes(StandardCharsets.UTF_8)), llIlIIIIlI[29]), "DES");
            Cipher llllllllllllllllllIIlIlIIIIIlIIl = Cipher.getInstance("DES");
            llllllllllllllllllIIlIlIIIIIlIIl.init(llIlIIIIlI[14], llllllllllllllllllIIlIlIIIIIlIlI);
            return new String(llllllllllllllllllIIlIlIIIIIlIIl.doFinal(Base64.getDecoder().decode(llllllllllllllllllIIlIlIIIIIIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void a(int n2, int n3) {
        int llllllllllllllllllIIlIlIIIlIlIII;
        ...
        int[] nArray2 = new int[llIlIIIIlI[1]];
        nArray2[a.llIlIIIIlI[2]] = llllllllllllllllllIIlIlIIIlIlIII;
        if (a.lIllIIIIIIIlI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            void llllllllllllllllllIIlIlIIIlIIlll;
            Bank.withdraw((int)llllllllllllllllllIIlIlIIIlIlIII, (int)llllllllllllllllllIIlIlIIIlIIlll, (Bank.WithdrawMode)Bank.WithdrawMode.DEFAULT);
            Time.sleepTicks((int)llIlIIIIlI[1]);
            "".length();
        }
    }
    ...
    public static void a(BankLocation bankLocation) {
        ...
        WorldPoint llllllllllllllllllIIlIlIIlIIIIll = new WorldPoint(llIlIIIIlI[3], llIlIIIIlI[4], llIlIIIIlI[2]);
        WorldPoint llllllllllllllllllIIlIlIIlIIIIlI = new WorldPoint(llIlIIIIlI[5], llIlIIIIlI[6], llIlIIIIlI[2]);
        WorldArea llllllllllllllllllIIlIlIIlIIIIIl = new WorldArea(llIlIIIIlI[7], llIlIIIIlI[8], llIlIIIIlI[9], llIlIIIIlI[10], llIlIIIIlI[2]);
        if ((!a.lIllIIIIIIIll(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllIIlIlIIlIIIIll) ? 1 : 0) || !a.lIllIIIIIIlII(Players.getLocal().getWorldLocation().distanceTo(llllllllllllllllllIIlIlIIlIIIIlI), llIlIIIIlI[11]) || a.lIllIIIIIIIlI(llllllllllllllllllIIlIlIIlIIIIIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) && a.lIllIIIIIIIlI(Inventory.contains(item -> item.getName().contains(llIlIIIIII[llIlIIIIlI[39]])) ? 1 : 0) && a.lIllIIIIIIIIl(Players.getLocal().getAnimation(), llIlIIIIlI[12])) {
        ...
        if (!a.lIllIIIIIIlII(Players.getLocal().getWorldLocation().distanceTo(x), llIlIIIIlI[11]) || a.lIllIIIIIIIlI(z.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            BankLocation llllllllllllllllllIIlIlIIlIIIlII;
            WorldArea llllllllllllllllllIIlIlIIIlllllI;
            WorldArea llllllllllllllllllIIlIlIIlIIIIII = new WorldArea(llIlIIIIlI[17], llIlIIIIlI[18], llIlIIIIlI[13], llIlIIIIlI[19], llIlIIIIlI[2]);
            WorldArea llllllllllllllllllIIlIlIIIllllll = new WorldArea(llIlIIIIlI[20], llIlIIIIlI[21], llIlIIIIlI[22], llIlIIIIlI[23], llIlIIIIlI[2]);
            if ((!a.lIllIIIIIIIll(llllllllllllllllllIIlIlIIlIIIIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || a.lIllIIIIIIIlI(llllllllllllllllllIIlIlIIIllllll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) && a.lIllIIIIIIIlI(Inventory.contains(item -> item.getName().contains(llIlIIIIII[llIlIIIIlI[37]])) ? 1 : 0)) {
            ...
            if (a.lIllIIIIIIIlI((llllllllllllllllllIIlIlIIIlllllI = new WorldArea(llIlIIIIlI[25], llIlIIIIlI[26], llIlIIIIlI[27], llIlIIIIlI[13], llIlIIIIlI[2])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                String[] stringArray = new String[llIlIIIIlI[1]];
                stringArray[a.llIlIIIIlI[2]] = llIlIIIIII[llIlIIIIlI[19]];
                TileObject llllllllllllllllllIIlIlIIIllllIl = TileObjects.getNearest((String[])stringArray);
                if (a.lIllIIIIIIlIl(llllllllllllllllllIIlIlIIIllllIl)) {
                    llllllllllllllllllIIlIlIIIllllIl.interact(llIlIIIIII[llIlIIIIlI[13]]);
                    Time.sleepTicks((int)llIlIIIIlI[24]);
                    "".length();
                }
            }
            Movement.walkTo((BankLocation)llllllllllllllllllIIlIlIIlIIIlII);
            "".length();
            Time.sleepTicks((int)llIlIIIIlI[14]);
            "".length();
        }
