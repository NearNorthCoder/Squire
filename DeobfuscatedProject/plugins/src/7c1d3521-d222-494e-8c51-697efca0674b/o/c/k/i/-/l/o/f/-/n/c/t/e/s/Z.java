...
implements ac {
    ...
    public int af() {
        ...
        if (((45 + 86 - 92 + 108 ^ 102 + 55 - -14 + 3) & (14 + 184 - 22 + 13 ^ 30 + 100 - 73 + 71 ^ -" ".length())) >= "  ".length()) {
            return (0x23 ^ 0x12 ^ (0xE6 ^ 0x9C)) & (13 + 113 - 38 + 55 ^ 145 + 142 - 187 + 96 ^ -" ".length());
        }
    ...
    private static void lIllIIllIlIll() {
        ...
        Z.llIlIlIIIl[Z.llIlIlIlll[0]] = Z.lIllIIllIIIIl("EhIzIQY3RyM8DT0U", "PgJHh");
        Z.llIlIlIIIl[Z.llIlIlIlll[1]] = Z.lIllIIllIIIlI("cRTvvUx5R74gW4lj8+JuyPLFsOHPQ7Ya3nQv3LT8oG2CDYEvgZSExRQxGHyr9ych", "uGEtX");
        Z.llIlIlIIIl[Z.llIlIlIlll[3]] = Z.lIllIIllIIIll("1Uur511rVAU=", "spOTF");
        Z.llIlIlIIIl[Z.llIlIlIlll[6]] = Z.lIllIIllIIIlI("IpTaIUUfqt5HAIbZufIhYw==", "RlGgF");
        Z.llIlIlIIIl[Z.llIlIlIlll[7]] = Z.lIllIIllIIIll("AGloLvhV+Y93n5xc/j1Nn8zUzVZcmI5k", "KEEcg");
        Z.llIlIlIIIl[Z.llIlIlIlll[10]] = Z.lIllIIllIIIIl("HzBUIhwtdRkqHTs8GiROOSARMBpoJgEzHiQ8ETBCaCYDKhorPR0tCWghG2MsHQw9DSk=", "HUtCn");
        Z.llIlIlIIIl[Z.llIlIlIlll[14]] = Z.lIllIIllIIIll("AD1oNFA/XF9LRoeWw2QsjQ==", "CSfJD");
        Z.llIlIlIIIl[Z.llIlIlIlll[15]] = Z.lIllIIllIIIlI("d0/4n2uDfRTN48DSeVfWwQ==", "udlCN");
        Z.llIlIlIIIl[Z.llIlIlIlll[13]] = Z.lIllIIllIIIll("zYS0nZWz2LQ=", "Oxtts");
        Z.llIlIlIIIl[Z.llIlIlIlll[16]] = Z.lIllIIllIIIlI("1f4lr58cOYs=", "TVtEM");
        Z.llIlIlIIIl[Z.llIlIlIlll[12]] = Z.lIllIIllIIIlI("uPnByWEF1SiOLDg8KjC41w==", "IKWAm");
        Z.llIlIlIIIl[Z.llIlIlIlll[17]] = Z.lIllIIllIIIlI("hjy3/kk+nwDp8Ye369EHcw==", "aHWxQ");
        Z.llIlIlIIIl[Z.llIlIlIlll[18]] = Z.lIllIIllIIIll("1R3hX2SLHRo=", "HhjXF");
        Z.llIlIlIIIl[Z.llIlIlIlll[19]] = Z.lIllIIllIIIll("xOBkz5h0A3o=", "piTST");
        Z.llIlIlIIIl[Z.llIlIlIlll[21]] = Z.lIllIIllIIIIl("OBQQbCUZVRQjPBMa", "vufLQ");
        Z.llIlIlIIIl[Z.llIlIlIlll[22]] = Z.lIllIIllIIIIl("FjUoEAQsLy5CATAkOhY=", "EAIbp");
        Z.llIlIlIIIl[Z.llIlIlIlll[23]] = Z.lIllIIllIIIll("CxNzHo3Nk8A=", "qDZkA");
        Z.llIlIlIIIl[Z.llIlIlIlll[25]] = Z.lIllIIllIIIll("ZXhRBSaEZJehTz2JfmqvWQ==", "GKBXg");
        Z.llIlIlIIIl[Z.llIlIlIlll[26]] = Z.lIllIIllIIIlI("8Z2UgS330RG5+Zzynynxgg==", "gtvxb");
        Z.llIlIlIIIl[Z.llIlIlIlll[27]] = Z.lIllIIllIIIlI("M6XPIuhvOiVY+JdRYuTKoA==", "SGTdG");
        Z.llIlIlIIIl[Z.llIlIlIlll[20]] = Z.lIllIIllIIIll("oUicGwNsrn3e+dwqVGnyEGFORzA6Rq/4", "PpMpX");
        Z.llIlIlIIIl[Z.llIlIlIlll[29]] = Z.lIllIIllIIIll("9KE/zfBEW4io9+0EgOEH8g==", "qqlGt");
        Z.llIlIlIIIl[Z.llIlIlIlll[30]] = Z.lIllIIllIIIIl("GCgJICo8OwcmOw==", "YXfTB");
        Z.llIlIlIIIl[Z.llIlIlIlll[31]] = Z.lIllIIllIIIll("pkIWbQsbBuJwMUT7yZIaIQ==", "WQVqf");
        Z.llIlIlIIIl[Z.llIlIlIlll[32]] = Z.lIllIIllIIIlI("U+lcx57JmHnHBqlLO9u92yNysAf0DkRM", "trIXB");
        Z.llIlIlIIIl[Z.llIlIlIlll[33]] = Z.lIllIIllIIIlI("jnCPWHzAc7s5IeOfpEGM7w==", "SzWMJ");
        Z.llIlIlIIIl[Z.llIlIlIlll[34]] = Z.lIllIIllIIIlI("HSibXpu//0RBOPd+W5J7aw==", "egdNL");
        Z.llIlIlIIIl[Z.llIlIlIlll[35]] = Z.lIllIIllIIIlI("XMzAgrpeWr00BQ5gc4lLYQ==", "ZhKOq");
        Z.llIlIlIIIl[Z.llIlIlIlll[36]] = Z.lIllIIllIIIIl("ARgWEzojWQIdOCsWHA==", "ByrrL");
        Z.llIlIlIIIl[Z.llIlIlIlll[37]] = Z.lIllIIllIIIIl("NSc5JQ==", "bBXWS");
        Z.llIlIlIIIl[Z.llIlIlIlll[24]] = Z.lIllIIllIIIll("uqw09mK9LlyNn4c5cwCSYw==", "GNLhH");
        Z.llIlIlIIIl[Z.llIlIlIlll[38]] = Z.lIllIIllIIIll("+O7YExm6gwvsPKp3NzNnfw==", "XwGqJ");
        Z.llIlIlIIIl[Z.llIlIlIlll[39]] = Z.lIllIIllIIIll("sku/nDzJX2k=", "gZxoi");
        Z.llIlIlIIIl[Z.llIlIlIlll[40]] = Z.lIllIIllIIIll("74n1DIoOhEs=", "bbvdY");
        Z.llIlIlIIIl[Z.llIlIlIlll[42]] = Z.lIllIIllIIIll("6BPUJ1zVAlYhQz01igB05w==", "OxTKX");
        Z.llIlIlIIIl[Z.llIlIlIlll[43]] = Z.lIllIIllIIIIl("NAs0DDIaCzQCYQMXPxY1", "rbZeA");
        Z.llIlIlIIIl[Z.llIlIlIlll[44]] = Z.lIllIIllIIIlI("Cdv5BjLLfAQ=", "bUvbS");
        Z.llIlIlIIIl[Z.llIlIlIlll[45]] = Z.lIllIIllIIIll("Ei+RLr9rQChSRQpHUJf/Ag==", "pohHH");
        Z.llIlIlIIIl[Z.llIlIlIlll[46]] = Z.lIllIIllIIIIl("MgIBBwATDQhDDhsNBAoCHQ==", "zcocl");
        Z.llIlIlIIIl[Z.llIlIlIlll[47]] = Z.lIllIIllIIIIl("AjdHKDYwcgogNyY7CS5kJCcCOjB1IRI5NDk7AjpodSEQIDA2Og4nI3UmCGkGAAsuBwM=", "URgID");
        Z.llIlIlIIIl[Z.llIlIlIlll[28]] = Z.lIllIIllIIIlI("MXi8H9rBRbIbOYKslpGYWVRILL92ncJ3", "lXOUV");
        Z.llIlIlIIIl[Z.llIlIlIlll[54]] = Z.lIllIIllIIIlI("anQYbrN36sapX2IpDPuRukHInsl2frKv", "WOHdk");
        Z.llIlIlIIIl[Z.llIlIlIlll[55]] = Z.lIllIIllIIIlI("klfaVfv8qIw=", "wiJJR");
        Z.llIlIlIIIl[Z.llIlIlIlll[58]] = Z.lIllIIllIIIll("Jfz7D7jlf5U=", "etHhK");
        Z.llIlIlIIIl[Z.llIlIlIlll[59]] = Z.lIllIIllIIIll("i+UzTA25esU=", "WNmlD");
        Z.llIlIlIIIl[Z.llIlIlIlll[60]] = Z.lIllIIllIIIll("D/zdOQsRz7U=", "lstUO");
        Z.llIlIlIIIl[Z.llIlIlIlll[69]] = Z.lIllIIllIIIIl("PjMeQEEudgUNFwJ2HgkECXYFCRNHNw4YFAY6ARVA", "gVmla");
        Z.llIlIlIIIl[Z.llIlIlIlll[70]] = Z.lIllIIllIIIll("9l5WvoB7XL+cctgrYbFWopaDzBQN22i6OVATZaAqWAg=", "qiABO");
        Z.llIlIlIIIl[Z.llIlIlIlll[71]] = Z.lIllIIllIIIlI("SJjxHAkWoLKMld4zkwP3oA==", "nfqhn");
        Z.llIlIlIIIl[Z.llIlIlIlll[72]] = Z.lIllIIllIIIlI("AeSBNl1iM+jJzZjCN+3NeKsN1mQ/WautMp9mm13fGsA=", "bgELM");
        Z.llIlIlIIIl[Z.llIlIlIlll[2]] = Z.lIllIIllIIIIl("OCo1A1ENKTYdBUwZNgUUA2t/SDsZJzANBUI=", "lKYhq");
        Z.llIlIlIIIl[Z.llIlIlIlll[73]] = Z.lIllIIllIIIll("8zRfjsRoa6mYs8MCQ+hPDA==", "ZvFYl");
        Z.llIlIlIIIl[Z.llIlIlIlll[74]] = Z.lIllIIllIIIIl("OAk3Vw==", "alDyN");
    }
    ...
    private static String lIllIIllIIIIl(String llllllllllllllllllIIIlllIlIlIlIl, String llllllllllllllllllIIIlllIlIIllll) {
        ...
        while (Z.lIllIIllIlllI(llllllllllllllllllIIIlllIlIIlIIl, llllllllllllllllllIIIlllIlIIlIlI)) {
            ...
            "".length();
            if ("   ".length() != ((0xD ^ 8) & ~(0x35 ^ 0x30))) continue;
            return null;
        }
    ...
    private static void lIllIIllIllII() {
        ...
        Z.llIlIlIlll[0] = (199 + 160 - 209 + 102 ^ 5 + 85 - -59 + 41) & (0xE0 ^ 0xC0 ^ (0x78 ^ 0x1A) ^ -" ".length());
        Z.llIlIlIlll[1] = " ".length();
        Z.llIlIlIlll[2] = 0x45 ^ 0x77;
        Z.llIlIlIlll[3] = "  ".length();
        Z.llIlIlIlll[4] = 0xFFFF93F7 & 0x6FEB;
        Z.llIlIlIlll[5] = 20 + 99 - 114 + 139;
        Z.llIlIlIlll[6] = "   ".length();
        ...
        Z.llIlIlIlll[39] = 0xA3 ^ 0x82 ^ " ".length();
                        ...
                        llllllllllllllllllIIIllllIIIIllI = TileObjects.getNearest(tileObject -> {
                            ...
                            if (Z.lIllIIllIllIl(tileObject.getName().contains(llIlIlIIIl[llIlIlIlll[55]]) ? 1 : 0) && Z.lIllIIlllIIll(tileObject.getWorldLocation().distanceTo(new WorldPoint(llIlIlIlll[56], llIlIlIlll[57], llIlIlIlll[1])), llIlIlIlll[3])) {
                                ...
                                if (Z.lIllIIllIllIl(tileObject.hasAction(stringArray) ? 1 : 0)) {
                                    ...
                                    return ((0x58 ^ 0x2C ^ (0x52 ^ 0x7A)) & (49 + 21 - 26 + 165 ^ 111 + 116 - 148 + 62 ^ -" ".length())) != 0;
                                }
                            }
                            n2 = llIlIlIlll[0];
                            return n2 != 0;
