...
implements ac {
        ...
        if (aA.lIllIlIllIIIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[6]) && aA.lIllIlIlIllIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[10])) {
            ...
            if (aA.lIllIlIllIIII(Inventory.getCount((int[])nArray))) {
                ...
                if (aA.lIllIlIllIIII(Inventory.getCount((int[])nArray2))) {
                    n3 = llIlIlllll[1];
                    "".length();
                    if (((0x10 ^ 0x28 ^ (0x3F ^ 0x32)) & (0x73 ^ 0x2D ^ (0x2C ^ 0x47) ^ -" ".length())) != " ".length()) return n3 != 0;
                    return ((0x63 ^ 0x2B ^ (0xD4 ^ 0xA6)) & (13 + 105 - -31 + 32 ^ 87 + 42 - 105 + 119 ^ -" ".length())) != 0;
                }
            }
            n3 = llIlIlllll[0];
            return n3 != 0;
        ...
        if (aA.lIllIlIllIIIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[10])) {
            ...
            if (aA.lIllIlIllIIII(Inventory.getCount((int[])nArray))) {
                ...
                if (aA.lIllIlIllIIII(Inventory.getCount((int[])nArray3))) {
                    ...
                    return ((0x79 ^ 0x32 ^ (0xDC ^ 0xA9)) & (88 + 171 - 208 + 122 ^ 58 + 117 - 148 + 120 ^ -" ".length())) != 0;
                }
            }
            n4 = llIlIlllll[0];
            return n4 != 0;
    ...
    private static void lIllIlIlIlIlI() {
        ...
        aA.llIlIllllI[aA.llIlIlllll[0]] = aA.lIllIlIlIIlll("mKJe4NxD3aqdcsax4+oyoA==", "gdCcM");
        aA.llIlIllllI[aA.llIlIlllll[1]] = aA.lIllIlIlIlIII("IQIHJSYPDg1sNxISACIyRwIdKTgUR0k/Ig4fCiQ8CQxJLjQEAEk4OkcNBSkhBAMAIjI=", "gkiLU");
        aA.llIlIllllI[aA.llIlIlllll[2]] = aA.lIllIlIlIIlll("IQAYhCgHunI8Gt7v20rad2f+4Zqmhnxh", "hJCjn");
        aA.llIlIllllI[aA.llIlIlllll[3]] = aA.lIllIlIlIlIIl("xQ3QWH70YNj4o4U1WwHT5w==", "ynMuB");
        aA.llIlIllllI[aA.llIlIlllll[5]] = aA.lIllIlIlIlIII("BRAYEx0kHxFXEywfHR4fKg==", "Mqvwq");
        aA.llIlIllllI[aA.llIlIlllll[9]] = aA.lIllIlIlIlIIl("AmBLQFZ39LZUCZbJs3Qci/QlgB0FwCRtv8P0wdfvduRsM+nmTeaUoTXAtzR0vzQk", "drXTE");
        aA.llIlIllllI[aA.llIlIlllll[12]] = aA.lIllIlIlIlIII("DwNXLDw9RhokPSsPGSpuKxMHPSIxAwRhbisRHjktMA8ZKm4sCVcPGwEvOQo=", "XfwMN");
        aA.llIlIllllI[aA.llIlIlllll[14]] = aA.lIllIlIlIlIIl("fbuGpt2ypZToo0oZo8Ft04DTBe0ryl2dDN/nuKTu0H2yz90IzvLNF0y8KNvnrY+Z", "SttMj");
        aA.llIlIllllI[aA.llIlIlllll[15]] = aA.lIllIlIlIlIIl("S748BzXCQRWzSgJSbvDO1w==", "mTCXT");
        aA.llIlIllllI[aA.llIlIlllll[16]] = aA.lIllIlIlIIlll("uC8vWsdUeBgTDchjuYXOYg==", "fCwOw");
        aA.llIlIllllI[aA.llIlIlllll[20]] = aA.lIllIlIlIlIII("ATsNJiIvPgY1YSg2A3ItKDkPIQ==", "GWhRA");
        aA.llIlIllllI[aA.llIlIlllll[21]] = aA.lIllIlIlIlIII("Gg45aik6ATUoKiI=", "UoRJE");
        aA.llIlIllllI[aA.llIlIlllll[24]] = aA.lIllIlIlIIlll("tWd2rCYEH72jEMQkyhf8Zyoc6aVncDHw", "wanXy");
        aA.llIlIllllI[aA.llIlIlllll[25]] = aA.lIllIlIlIlIIl("nUOezxfA9wfW/ky0jbxvSg==", "OrHTU");
        aA.llIlIllllI[aA.llIlIlllll[27]] = aA.lIllIlIlIlIII("KC0OIQYGKAUyRRkoBzkKGWEHOgsJIwQiFg==", "nAkUe");
        aA.llIlIllllI[aA.llIlIlllll[6]] = aA.lIllIlIlIlIIl("xHn0LxofG5GAGwQaz5Ey+Q==", "vbjxG");
        aA.llIlIllllI[aA.llIlIlllll[28]] = aA.lIllIlIlIlIIl("zKhTM42DAWmY7N7lR2LOpner5YbdCKge", "MOnRi");
        aA.llIlIllllI[aA.llIlIlllll[29]] = aA.lIllIlIlIIlll("jIlXptGHWxx98phBjdgfFw==", "chBCz");
        aA.llIlIllllI[aA.llIlIlllll[35]] = aA.lIllIlIlIlIII("Fzk9Oiw5PDYp", "QUXNO");
        aA.llIlIllllI[aA.llIlIlllll[45]] = aA.lIllIlIlIIlll("5i1fPoxrUI215j1i2KuEZSRun/CBE9xx", "QFYDF");
    }
                ...
                if (aA.lIllIlIlIllIl(Inventory.getCount((int[])nArray), llIlIlllll[1])) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (aA.lIllIlIllIIII(Inventory.getCount((int[])nArray))) {
                            bl = llIlIlllll[1];
                            "".length();
                            if ((0x5F ^ 0x2C ^ (0xDE ^ 0xA9)) < -" ".length()) {
                                return ((0x9F ^ 0x81 ^ (0x18 ^ 0x3B)) & (73 + 40 - 50 + 66 ^ 39 + 105 - 95 + 139 ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = llIlIlllll[0];
                        }
                        ...
                        if (aA.lIllIlIllIIIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[10]) && aA.lIllIlIlIllIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[19])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                block3: {
                                    ...
                                    return ((0xA0 ^ 0x86 ^ (0x5C ^ 0x7E)) & (0x7E ^ 0x6F ^ (0xD2 ^ 0xC7) ^ -" ".length())) != 0;
                                }
                                n2 = llIlIlllll[0];
                                return n2 != 0;
                        ...
                        if (aA.lIllIlIllIIIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[19]) && aA.lIllIlIlIllIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[11])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                block3: {
                                    ...
                                    "".length();
                                    if (" ".length() == " ".length()) return n2 != 0;
                                    return ((0x78 ^ 0x24 ^ (0xBD ^ 0xB5)) & (26 + 214 - 181 + 157 ^ 37 + 42 - 6 + 67 ^ -" ".length())) != 0;
                                }
                                n2 = llIlIlllll[0];
                                return n2 != 0;
                            }, (int)e.c(llIlIlllll[22], llIlIlllll[23]));
                        ...
                        if (aA.lIllIlIllIIIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[11]) && aA.lIllIlIlIllIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[26])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                block3: {
                                    ...
                                    "".length();
                                    if (-"   ".length() <= 0) return n2 != 0;
                                    return ((0xB0 ^ 0x89 ^ (0x88 ^ 0xA6)) & (0xBA ^ 0x95 ^ (0x6A ^ 0x52) ^ -" ".length())) != 0;
                                }
                                n2 = llIlIlllll[0];
                                return n2 != 0;
                            }, (int)e.c(llIlIlllll[22], llIlIlllll[23]));
                        ...
                        if (aA.lIllIlIllIIIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[26])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                block3: {
                                    ...
                                    return ((0x12 ^ 5 ^ (0xF9 ^ 0xAD)) & (184 + 162 - 197 + 47 ^ 105 + 95 - 136 + 71 ^ -" ".length())) != 0;
                                }
                                n2 = llIlIlllll[0];
                                return n2 != 0;
                            }, (int)e.c(llIlIlllll[22], llIlIlllll[23]));
    ...
    private static void lIllIlIlIlIll() {
        ...
        aA.llIlIlllll[0] = (122 + 132 - 224 + 111 ^ 63 + 109 - 102 + 91) & (0x27 ^ 0x60 ^ (0x13 ^ 0x78) ^ -" ".length());
        aA.llIlIlllll[1] = " ".length();
        aA.llIlIlllll[2] = "  ".length();
        aA.llIlIlllll[3] = "   ".length();
