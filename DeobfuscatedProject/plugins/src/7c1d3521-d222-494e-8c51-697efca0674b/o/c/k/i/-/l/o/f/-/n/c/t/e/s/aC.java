...
implements ac {
    ...
    public boolean ah() {
        ...
        if (aC.lIIllllIlIIll(Skills.getLevel((Skill)Skill.MINING), lIlllIllIl[42])) {
            ...
            "".length();
            if (null != null) {
                return ((151 + 138 - 155 + 63 ^ 75 + 83 - -5 + 29) & (70 + 111 - 37 + 0 ^ 61 + 50 - -26 + 12 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlllIllIl[0];
        }
    ...
    private static void lIIllllIIllIl() {
        ...
        aC.lIlllIllIl[1] = " ".length();
        aC.lIlllIllIl[2] = "  ".length();
        aC.lIlllIllIl[3] = "   ".length();
                    ...
                    if (aC.lIIllllIIlllI(Bank.contains((int[])nArray11) ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (aC.lIIllllIlIIlI(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (null != null) {
                                    return ((8 + 56 - -4 + 59 ^ (0xF5 ^ 0xB5)) & (45 + 1 - -58 + 68 ^ 92 + 47 - 2 + 10 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlllIllIl[0];
                            }
                    ...
                    if (aC.lIIllllIIlllI(Bank.contains((int[])nArray12) ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (aC.lIIllllIlIIlI(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (null != null) {
                                    return ((0xE6 ^ 0xA7 ^ (0xB5 ^ 0xA5)) & (0xA5 ^ 0x94 ^ (0x64 ^ 4) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlllIllIl[0];
                            }
                    ...
                    if (aC.lIIllllIIlllI(Bank.contains((int[])nArray13) ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (aC.lIIllllIlIIlI(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (" ".length() == 0) {
                                    return ((0x18 ^ 0x2E ^ (0xD5 ^ 0xA1)) & (0x2C ^ 0x66 ^ (4 ^ 0xC) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlllIllIl[0];
                            }
    ...
    private static void lIIllllIIllII() {
        ...
        aC.lIlllIllII[aC.lIlllIllIl[0]] = aC.lIIllllIIlIIl("XAic6+DrR2PQFQ3t6fDe3g==", "NMbkq");
        aC.lIlllIllII[aC.lIlllIllIl[1]] = aC.lIIllllIIlIlI("JwslPzgJBy92KRQbIjgsQQs/MyYSTmslPAgWKD4iDwVrNCoCCWsiJEEPIjgiDwU=", "abKVK");
        aC.lIlllIllII[aC.lIlllIllIl[2]] = aC.lIIllllIIlIll("ookCOqFfwNbb3G+xasuuCYWMI9aH9PBW", "pvhYv");
        aC.lIlllIllII[aC.lIlllIllIl[3]] = aC.lIIllllIIlIlI("KSgUDRwIJx1JEgAnEQAeBg==", "aIzip");
        aC.lIlllIllII[aC.lIlllIllIl[5]] = aC.lIIllllIIlIlI("Dzd0Ejo9cjkaOys7OhRoOSoxAGR4ISMaPDs6PR0veCY7UwoNCx09Dw==", "XRTsH");
        aC.lIlllIllII[aC.lIlllIllIl[23]] = aC.lIIllllIIlIll("HaM0H+ahCgtTF8iYUv71oQ==", "SoVMh");
        aC.lIlllIllII[aC.lIlllIllIl[21]] = aC.lIIllllIIlIIl("OEwQ367PjZ1STsw2NQzVXw==", "lgwlU");
        aC.lIlllIllII[aC.lIlllIllIl[25]] = aC.lIIllllIIlIIl("K2KeilKlFZukR2SQAbDrfQ==", "RVXAs");
        aC.lIlllIllII[aC.lIlllIllIl[26]] = aC.lIIllllIIlIll("vYrDkAxEBcU=", "NSalX");
        aC.lIlllIllII[aC.lIlllIllIl[27]] = aC.lIIllllIIlIll("jVIIABPUeHbW0G38tB2osakuL5lFK9++", "oXCnr");
        aC.lIlllIllII[aC.lIlllIllIl[28]] = aC.lIIllllIIlIIl("CDGAZcDFdvIvwZ3KXJfr6Q==", "XDeMG");
        aC.lIlllIllII[aC.lIlllIllIl[29]] = aC.lIIllllIIlIlI("JSEiBg==", "hHLcD");
        aC.lIlllIllII[aC.lIlllIllIl[41]] = aC.lIIllllIIlIlI("Dh0qKwUk", "CtDBk");
        aC.lIlllIllII[aC.lIlllIllIl[43]] = aC.lIIllllIIlIlI("HDs9MVgBNHMhHQ8+Jz5YRg==", "nRSVx");
    }
        ...
        if (aC.lIIllllIlIIll(Skills.getLevel((Skill)Skill.MINING), lIlllIllIl[31]) && aC.lIIllllIIllll(Skills.getLevel((Skill)Skill.MINING), lIlllIllIl[30])) {
            ...
            if (aC.lIIllllIlIIlI(Inventory.getCount((int[])nArray))) {
                ...
                if (aC.lIIllllIlIIlI(Inventory.getCount((int[])nArray2))) {
                    ...
                    return ((0xB2 ^ 0xAD ^ (0x69 ^ 0x7A)) & (177 + 109 - 102 + 18 ^ 121 + 91 - 57 + 43 ^ -" ".length())) != 0;
                }
            }
            n3 = lIlllIllIl[0];
            return n3 != 0;
                ...
                if (aC.lIIllllIlIIlI(Inventory.getCount((int[])nArray9))) {
                    ...
                    if (aC.lIIllllIlIIlI(Inventory.getCount((int[])nArray10))) {
                        ...
                        if (aC.lIIllllIlIIlI(Inventory.getCount((int[])nArray11))) {
                            n2 = lIlllIllIl[1];
                            "".length();
                            if (-" ".length() < ((221 + 53 - 98 + 56 ^ 21 + 113 - 90 + 128) & (33 + 178 - 3 + 2 ^ 44 + 49 - -43 + 14 ^ -" ".length()))) return n2 != 0;
                            return ((0x66 ^ 0x7D ^ (0xBC ^ 0x93)) & (103 + 52 - 140 + 143 ^ 73 + 156 - 228 + 169 ^ -" ".length())) != 0;
                        }
                    }
                }
            }
