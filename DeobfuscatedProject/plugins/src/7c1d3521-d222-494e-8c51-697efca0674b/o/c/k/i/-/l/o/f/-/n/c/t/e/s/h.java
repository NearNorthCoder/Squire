...
public class h {
    ...
    private static void lIlIllllIIIlI() {
        ...
        h.llIIllllII[h.llIIllllIl[0]] = h.lIlIlllIlllll("NmYDNS08MRY=", "PTsXH");
        h.llIIllllII[h.llIIllllIl[1]] = h.lIlIllllIIIII("4XBBgDBha+fRue9vaDht3w==", "TVZli");
        h.llIIllllII[h.llIIllllIl[2]] = h.lIlIllllIIIIl("B9PQ1MOO4po=", "JIpGM");
        h.llIIllllII[h.llIIllllIl[3]] = h.lIlIlllIlllll("JQcrCQ==", "HfLlM");
        h.llIIllllII[h.llIIllllIl[4]] = h.lIlIllllIIIIl("fJXcilKTcvA=", "imPrF");
        h.llIIllllII[h.llIIllllIl[5]] = h.lIlIllllIIIII("uQEfNakQ0y+JYpeke5flEw==", "mwcVW");
        h.llIIllllII[h.llIIllllIl[6]] = h.lIlIllllIIIIl("XYVucbTzUlo=", "IqeyW");
        h.llIIllllII[h.llIIllllIl[7]] = h.lIlIllllIIIII("PEnou7fJpwE=", "bPpZS");
        h.llIIllllII[h.llIIllllIl[8]] = h.lIlIllllIIIIl("f03WFQ+shpxb/VFCANH/SQ==", "hQWfU");
        h.llIIllllII[h.llIIllllIl[9]] = h.lIlIlllIlllll("OBUINhMEGRw=", "JtfQv");
        h.llIIllllII[h.llIIllllIl[10]] = h.lIlIlllIlllll("BzALFSM4OB8UKHUUFAQlJTwAHzhv", "UQeqL");
        h.llIIllllII[h.llIIllllIl[11]] = h.lIlIlllIlllll("EgMPOSQ3Vh8kLz0F", "PvvPJ");
        h.llIIllllII[h.llIIllllIl[12]] = h.lIlIlllIlllll("Ay0fDjgtIRVHKTA9GAksZS0FAiY2aFEUPCwwEg8iKyNRBSomL1ETJGU2EAkvKik2Aio3LR8A", "EDqgK");
        h.llIIllllII[h.llIIllllIl[13]] = h.lIlIlllIlllll("AA8/ETEvGiAWMW4aJlg0LwAi", "NnIxV");
        h.llIIllllII[h.llIIllllIl[14]] = h.lIlIllllIIIIl("YkAcu+gXEy+6Rp+NMml//kaQoVB13M5V", "LmfCb");
        h.llIIllllII[h.llIIllllIl[19]] = h.lIlIllllIIIII("CIeYfyptgzp9UK3+AA63x0c0qKzqt4+9CPP6aeZY8acQTrhu6DuVToqIq2FvGERT", "wdsOa");
        h.llIIllllII[h.llIIllllIl[20]] = h.lIlIllllIIIIl("Xh8K65iP5SqmaQ+7jEC1qgqtVqXrRrSokw+spZGnVAbW6D3CVZBon/arKQAqRCSr", "AlHmL");
        h.llIIllllII[h.llIIllllIl[21]] = h.lIlIllllIIIII("5xsf7T/voehlpv49PXiYAh1wEeuiRpe+sRLDj44NcCGs3JWBWKgJr06r/AtvF6gK", "LBguT");
        h.llIIllllII[h.llIIllllIl[24]] = h.lIlIllllIIIIl("5G+NwQ0/YyCbRSiQBbMpCSZ1gFnYQYHa", "DBQkK");
        h.llIIllllII[h.llIIllllIl[203]] = h.lIlIlllIlllll("OCoXOyUIJwYmMU0hADE6H2QdIDYYNgAmMU0zGio5CGQVJiEZLRwkdQxkACI7CSsfYz4IPVw=", "mDrCU");
        h.llIIllllII[h.llIIllllIl[46]] = h.lIlIllllIIIIl("LQExU5aWSGl48Cm0EJWtQNobG3w1l8yxMyjsQEM3RX8=", "pfton");
        h.llIIllllII[h.llIIllllIl[204]] = h.lIlIllllIIIII("qzUS8nB71K4=", "xzdIu");
    }
    ...
    private static int a(Map<Integer, Integer> map, Random random) {
        Map<Integer, Integer> llllllllllllllllllIIlIlIllllIIlI;
        void llllllllllllllllllIIlIlIllllIIIl;
        if (h.lIlIllllIIlII(map.isEmpty() ? 1 : 0)) {
            return llIIllllIl[0];
        }
        int llllllllllllllllllIIlIlIllllIIII = llllllllllllllllllIIlIlIllllIIIl.nextInt(llllllllllllllllllIIlIlIllllIIlI.size());
        int llllllllllllllllllIIlIlIlllIllll = llIIllllIl[0];
        Iterator<Integer> llllllllllllllllllIIlIlIlllIlllI = llllllllllllllllllIIlIlIllllIIlI.keySet().iterator();
        while (h.lIlIllllIIlII(llllllllllllllllllIIlIlIlllIlllI.hasNext() ? 1 : 0)) {
            int llllllllllllllllllIIlIlIlllIllIl = llllllllllllllllllIIlIlIlllIlllI.next();
            if (h.lIlIllllIlIIl(llllllllllllllllllIIlIlIlllIllll, llllllllllllllllllIIlIlIllllIIII)) {
                return llllllllllllllllllIIlIlIlllIllIl;
            }
            ++llllllllllllllllllIIlIlIlllIllll;
            "".length();
    ...
    private static void Q() {
        d llllllllllllllllllIIlIlIlllllIIl;
        ...
        if (h.lIlIllllIIlII(bI)) {
            ...
            if (h.lIlIllllIIlIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                llllllllllllllllllIIlIlIlllllIIl = new d(bI, llIIllllIl[1], bT);
                bv.add(llllllllllllllllllIIlIlIlllllIIl);
                "".length();
            }
        }
        if (h.lIlIllllIIlII(bJ)) {
            ...
            if (h.lIlIllllIIlIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                llllllllllllllllllIIlIlIlllllIIl = new d(bJ, llIIllllIl[1], bU);
                bv.add(llllllllllllllllllIIlIlIlllllIIl);
                "".length();
            }
        }
        if (h.lIlIllllIIlII(bK)) {
            ...
            if (h.lIlIllllIIlIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                llllllllllllllllllIIlIlIlllllIIl = new d(bK, llIIllllIl[1], bV);
                bv.add(llllllllllllllllllIIlIlIlllllIIl);
                "".length();
            }
        }
        if (h.lIlIllllIIlII(bL)) {
            ...
            if (h.lIlIllllIIlIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                llllllllllllllllllIIlIlIlllllIIl = new d(bL, llIIllllIl[1], bW);
                bv.add(llllllllllllllllllIIlIlIlllllIIl);
                "".length();
            }
        }
        if (h.lIlIllllIIlII(bM)) {
            ...
            if (h.lIlIllllIIlIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                llllllllllllllllllIIlIlIlllllIIl = new d(bM, llIIllllIl[1], bX);
                bv.add(llllllllllllllllllIIlIlIlllllIIl);
                "".length();
            }
        }
        if (h.lIlIllllIIlII(bN)) {
            ...
            if (h.lIlIllllIIlIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                llllllllllllllllllIIlIlIlllllIIl = new d(bN, llIIllllIl[1], bY);
                bv.add(llllllllllllllllllIIlIlIlllllIIl);
                "".length();
            }
        }
        if (h.lIlIllllIIlII(bO)) {
            ...
            if (h.lIlIllllIIlIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                llllllllllllllllllIIlIlIlllllIIl = new d(bO, llIIllllIl[1], bZ);
                bv.add(llllllllllllllllllIIlIlIlllllIIl);
                "".length();
            }
        }
        if (h.lIlIllllIIlII(bP)) {
            ...
            if (h.lIlIllllIIlIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                llllllllllllllllllIIlIlIlllllIIl = new d(bP, llIIllllIl[1], ca);
                bv.add(llllllllllllllllllIIlIlIlllllIIl);
                "".length();
            }
        }
        if (h.lIlIllllIIlII(bQ)) {
            ...
            if (h.lIlIllllIIlIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                llllllllllllllllllIIlIlIlllllIIl = new d(bQ, llIIllllIl[1], cb);
                bv.add(llllllllllllllllllIIlIlIlllllIIl);
                "".length();
            }
        }
                    ...
                    if (h.lIlIllllIIlIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
                        ...
                        if (h.lIlIllllIIlIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
                            ...
                            if (h.lIlIllllIIlIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
                                llllllllllllllllllIIlIlIlllllIIl = new d(bR, llIIllllIl[1], cc);
                                bv.add(llllllllllllllllllIIlIlIlllllIIl);
                                "".length();
                                "".length();
                                if ((0x95 ^ 0x91) < 0) {
    ...
    public static boolean c(int[] nArray) {
        int[] llllllllllllllllllIIlIlIlllllllI;
        int llllllllllllllllllIIlIlIllllllIl = llIIllllIl[0];
        while (h.lIlIllllIIllI(llllllllllllllllllIIlIlIllllllIl, llllllllllllllllllIIlIlIlllllllI.length)) {
            if (h.lIlIllllIlIII(llllllllllllllllllIIlIlIlllllllI[llllllllllllllllllIIlIlIllllllIl])) {
                int[] nArray2 = new int[llIIllllIl[1]];
                nArray2[h.llIIllllIl[0]] = llllllllllllllllllIIlIlIlllllllI[llllllllllllllllllIIlIlIllllllIl];
                if (h.lIlIllllIIlIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
                    System.out.println("Missing ID: " + llllllllllllllllllIIlIlIlllllllI[llllllllllllllllllIIlIlIllllllIl]);
                    return llIIllllIl[0];
                }
            }
            ++llllllllllllllllllIIlIlIllllllIl;
            "".length();
            if (((0x22 ^ 0xE ^ (0x69 ^ 0x5F)) & (0x4C ^ 0x7F ^ (0x6B ^ 0x42) ^ -" ".length())) == ((0x57 ^ 0x23 ^ (0xB5 ^ 0x99)) & (92 + 170 - 67 + 35 ^ 23 + 175 - 74 + 66 ^ -" ".length()))) continue;
            return ((0xFF ^ 0xC5 ^ (0x82 ^ 0xBC)) & (0x22 ^ 0x66 ^ (0xD1 ^ 0x91) ^ -" ".length())) != 0;
        }
        return llIIllllIl[1];
    }
    ...
    private static String lIlIllllIIIIl(String llllllllllllllllllIIlIlIlIlllllI, String llllllllllllllllllIIlIlIlIlllIll) {
        try {
            SecretKeySpec llllllllllllllllllIIlIlIllIIIIIl = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIIlIlIlIlllIll.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllllIIlIlIllIIIIII = Cipher.getInstance("Blowfish");
            llllllllllllllllllIIlIlIllIIIIII.init(llIIllllIl[2], llllllllllllllllllIIlIlIllIIIIIl);
            return new String(llllllllllllllllllIIlIlIllIIIIII.doFinal(Base64.getDecoder().decode(llllllllllllllllllIIlIlIlIlllllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlIllllIIIII(String llllllllllllllllllIIlIlIlllIIIll, String llllllllllllllllllIIlIlIlllIIIlI) {
        try {
            ...
            Cipher llllllllllllllllllIIlIlIlllIIlIl = Cipher.getInstance("DES");
            llllllllllllllllllIIlIlIlllIIlIl.init(llIIllllIl[2], llllllllllllllllllIIlIlIlllIIllI);
            return new String(llllllllllllllllllIIlIlIlllIIlIl.doFinal(Base64.getDecoder().decode(llllllllllllllllllIIlIlIlllIIIll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void d(String string) {
        if (!h.lIlIllllIIlII(bH) || h.lIlIllllIIlIl(bN)) {
            String llllllllllllllllllIIlIllIIIIIIll;
            if (h.lIlIllllIIlII(llllllllllllllllllIIlIllIIIIIIll.equalsIgnoreCase(llIIllllII[llIIllllIl[0]]) ? 1 : 0)) {
                h.R();
            }
            if (h.lIlIllllIIlII(llllllllllllllllllIIlIllIIIIIIll.equalsIgnoreCase(llIIllllII[llIIllllIl[1]]) ? 1 : 0)) {
                // empty if block
            }
            if (h.lIlIllllIIlII(llllllllllllllllllIIlIllIIIIIIll.equalsIgnoreCase(llIIllllII[llIIllllIl[2]]) ? 1 : 0)) {
                h.V();
            }
            if (h.lIlIllllIIlII(llllllllllllllllllIIlIllIIIIIIll.equalsIgnoreCase(llIIllllII[llIIllllIl[3]]) ? 1 : 0)) {
                // empty if block
            }
            if (h.lIlIllllIIlII(llllllllllllllllllIIlIllIIIIIIll.equalsIgnoreCase(llIIllllII[llIIllllIl[4]]) ? 1 : 0)) {
                // empty if block
            }
            if (h.lIlIllllIIlII(llllllllllllllllllIIlIllIIIIIIll.equalsIgnoreCase(llIIllllII[llIIllllIl[5]]) ? 1 : 0)) {
                // empty if block
            }
            if (h.lIlIllllIIlII(llllllllllllllllllIIlIllIIIIIIll.equalsIgnoreCase(llIIllllII[llIIllllIl[6]]) ? 1 : 0)) {
                h.S();
            }
            if (h.lIlIllllIIlII(llllllllllllllllllIIlIllIIIIIIll.equalsIgnoreCase(llIIllllII[llIIllllIl[7]]) ? 1 : 0)) {
                // empty if block
            }
            if (h.lIlIllllIIlII(llllllllllllllllllIIlIllIIIIIIll.equalsIgnoreCase(llIIllllII[llIIllllIl[8]]) ? 1 : 0)) {
                h.U();
            }
            if (h.lIlIllllIIlII(llllllllllllllllllIIlIllIIIIIIll.equalsIgnoreCase(llIIllllII[llIIllllIl[9]]) ? 1 : 0)) {
                h.T();
            }
            h.W();
        ...
        if (h.lIlIllllIIlII(bH) && h.lIlIllllIIlII(bN)) {
            ...
            if (h.lIlIllllIIlIl(bt ? 1 : 0)) {
                BankLocation llllllllllllllllllIIlIllIIIIIIlI = BankLocation.getNearest();
                if (h.lIlIllllIIlll(llllllllllllllllllIIlIllIIIIIIlI) && h.lIlIllllIIlIl(llllllllllllllllllIIlIllIIIIIIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderSotf.c = llIIllllII[llIIllllIl[13]];
                    a.a(llllllllllllllllllIIlIllIIIIIIlI);
                }
                if (h.lIlIllllIIlll(llllllllllllllllllIIlIllIIIIIIlI) && h.lIlIllllIIlII(llllllllllllllllllIIlIllIIIIIIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (h.lIlIllllIIlII(Bank.isOpen() ? 1 : 0)) {
                        ...
                        if (h.lIlIllllIIlII(h.n(bR) ? 1 : 0)) {
                            ...
                            nArray[h.llIIllllIl[9]] = bQ;
                            nArray[h.llIIllllIl[10]] = bR;
                            int[] llllllllllllllllllIIlIllIIIIIIIl = nArray;
                            if (h.lIlIllllIlIIl(bR, llIIllllIl[16])) {
                            ...
                            a.a(llllllllllllllllllIIlIllIIIIIIIl, llIIllllIl[1]);
                            ...
                            while (!h.lIlIllllIIlIl(Inventory.contains((int[])llllllllllllllllllIIlIllIIIIIIIl) ? 1 : 0) || h.lIlIllllIIlII(Inventory.contains(item -> {
                                int n2;
                                if (h.lIlIllllIIlII(item.getName().contains(llIIllllII[llIIllllIl[204]]) ? 1 : 0) && h.lIlIllllIIlIl(item.isNoted() ? 1 : 0)) {
                                    n2 = llIIllllIl[1];
                                    "".length();
                                    if ("   ".length() <= 0) {
                                        return ((26 + 34 - 32 + 111 ^ 156 + 21 - 59 + 40) & (0x8C ^ 0x9E ^ (0x15 ^ 0x12) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    n2 = llIIllllIl[0];
                                }
                                ...
                                e.l(llIIllllIl[23]);
                                "".length();
                                if ((0xA ^ 0x2A ^ (0x47 ^ 0x63)) > -" ".length()) continue;
                                return;
                            }
                            if (h.lIlIllllIIlIl(Bank.isOpen() ? 1 : 0)) {
                                a.a();
    ...
    private static void lIlIllllIIIll() {
        ...
        h.llIIllllIl[0] = (3 ^ 0x10 ^ (0x3A ^ 0x25)) & (0x6A ^ 0x72 ^ (0xAE ^ 0xBA) ^ -" ".length());
        h.llIIllllIl[1] = " ".length();
        h.llIIllllIl[2] = "  ".length();
        h.llIIllllIl[3] = "   ".length();
        ...
        h.llIIllllIl[17] = -"  ".length() & (0xFFFFAEFF & 0x7FCF);
        ...
        h.llIIllllIl[79] = 0x1A ^ 0x26 ^ " ".length() & ~" ".length();
        ...
        h.llIIllllIl[91] = -" ".length() & (0xFFFFAAFE & 0xFDDF);
    ...
    private static String lIlIlllIlllll(String llllllllllllllllllIIlIlIllIlIIll, String llllllllllllllllllIIlIlIllIlIIlI) {
        llllllllllllllllllIIlIlIllIlIIll = new String(Base64.getDecoder().decode(llllllllllllllllllIIlIlIllIlIIll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllIIlIlIllIlIIIl = new StringBuilder();
        char[] llllllllllllllllllIIlIlIllIlIIII = llllllllllllllllllIIlIlIllIlIIlI.toCharArray();
        int llllllllllllllllllIIlIlIllIIllll = llIIllllIl[0];
        char[] llllllllllllllllllIIlIlIllIIlIIl = llllllllllllllllllIIlIlIllIlIIll.toCharArray();
        int llllllllllllllllllIIlIlIllIIlIII = llllllllllllllllllIIlIlIllIIlIIl.length;
        int llllllllllllllllllIIlIlIllIIIlll = llIIllllIl[0];
        while (h.lIlIllllIIllI(llllllllllllllllllIIlIlIllIIIlll, llllllllllllllllllIIlIlIllIIlIII)) {
            char llllllllllllllllllIIlIlIllIlIlII = llllllllllllllllllIIlIlIllIIlIIl[llllllllllllllllllIIlIlIllIIIlll];
            llllllllllllllllllIIlIlIllIlIIIl.append((char)(llllllllllllllllllIIlIlIllIlIlII ^ llllllllllllllllllIIlIlIllIlIIII[llllllllllllllllllIIlIlIllIIllll % llllllllllllllllllIIlIlIllIlIIII.length]));
            "".length();
            ++llllllllllllllllllIIlIlIllIIllll;
            ++llllllllllllllllllIIlIlIllIIIlll;
            "".length();
            if ((0x1C ^ 0x18) != "   ".length()) continue;
            return null;
        }
        return String.valueOf(llllllllllllllllllIIlIlIllIlIIIl);
    }
