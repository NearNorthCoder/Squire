...
implements ac {
    ...
    public int af() {
        ...
        if (((0x21 ^ 0x7A ^ (0x7F ^ 0xD)) & (138 + 124 - 69 + 44 ^ 105 + 8 - 73 + 156 ^ -" ".length())) < ((0x43 ^ 0x5C ^ (0x81 ^ 0xC4)) & (0x4D ^ 0x6F ^ (0xF8 ^ 0x80) ^ -" ".length()))) {
            return (0x4F ^ 0x70 ^ (0xD1 ^ 0xC1)) & (0xD4 ^ 0xA4 ^ (0x4A ^ 0x15) ^ -" ".length());
        }
                ...
                llllllllllllllllllIIlIIIIIlIlllI = NPCs.getNearest(nPC -> {
                    ...
                    if (k.lIllIIlIlIIII(nPC.getName().contains(llIlIIllII[llIlIIllIl[40]]) ? 1 : 0) && k.lIllIIlIIlllI(nPC.isDead() ? 1 : 0)) {
                        ...
                        if (k.lIllIIlIlIIII(nPC.hasAction(stringArray) ? 1 : 0) && k.lIllIIlIllIIl(nPC.getInteracting(), Players.getLocal())) {
                            ...
                            "".length();
                            if ("   ".length() > " ".length()) return n2 != 0;
                            return ((171 + 107 - 229 + 160 ^ 70 + 56 - -67 + 4) & (0xA4 ^ 0x8D ^ (0x65 ^ 0x58) ^ -" ".length())) != 0;
                        }
                    }
                    n2 = llIlIIllIl[1];
                    return n2 != 0;
    ...
    private static void lIllIIlIIllIl() {
        ...
        k.llIlIIllIl[0] = " ".length();
        k.llIlIIllIl[1] = (59 + 114 - 133 + 163 ^ 88 + 118 - 91 + 23) & (173 + 70 - 54 + 6 ^ 58 + 113 - 41 + 0 ^ -" ".length());
        ...
        k.llIlIIllIl[38] = "   ".length() ^ (0x5D ^ 0x3A);
    ...
    public boolean ah() {
        ...
        if (k.lIllIIlIllIII(Skills.getLevel((Skill)Skill.RANGED), llIlIIllIl[39])) {
            ...
            if ((128 + 79 - 72 + 57 ^ 112 + 86 - 38 + 37) == 0) {
                return ((152 + 24 - 97 + 157 ^ 122 + 51 - 84 + 94) & (0x65 ^ 0x2E ^ (0x22 ^ 0x32) ^ -" ".length())) != 0;
            }
        } else {
            bl = llIlIIllIl[1];
        }
    ...
    private static void lIllIIlIIllII() {
        ...
        k.llIlIIllII[k.llIlIIllIl[1]] = k.lIllIIlIIlIII("BAszBQwrHiwCDGoeKkwJKwQu", "JjElk");
        k.llIlIIllII[k.llIlIIllIl[0]] = k.lIllIIlIIlIIl("zf/uIPTKGKDsN9vDcNpkaifxAay8xAEk", "HqBKb");
        k.llIlIIllII[k.llIlIIllIl[10]] = k.lIllIIlIIlIll("NsgJMzlV7y4=", "uhqvp");
        k.llIlIIllII[k.llIlIIllIl[20]] = k.lIllIIlIIlIII("GTsQUQQ4ehUeBTsp", "WZfqp");
        k.llIlIIllII[k.llIlIIllIl[28]] = k.lIllIIlIIlIIl("MChnjWypk4hUgE06mGOkCJLisJVqfH6P", "PeJlh");
        k.llIlIIllII[k.llIlIIllIl[29]] = k.lIllIIlIIlIll("kSIbFvksKOM=", "iEXXL");
        k.llIlIIllII[k.llIlIIllIl[27]] = k.lIllIIlIIlIIl("0mAUqUuch4WnhTthpyCghw==", "fGwWf");
        k.llIlIIllII[k.llIlIIllIl[34]] = k.lIllIIlIIlIII("My0IPR4cKgh1GRoxAyY=", "uDoUj");
        k.llIlIIllII[k.llIlIIllIl[35]] = k.lIllIIlIIlIIl("ZlU+cYwkXEOJ7h81eiSWUg==", "yIzIW");
        k.llIlIIllII[k.llIlIIllIl[36]] = k.lIllIIlIIlIll("uHKS4/Sd7zo=", "RfxNV");
        k.llIlIIllII[k.llIlIIllIl[7]] = k.lIllIIlIIlIII("LgYtAgoEGzcESRwdLA8F", "orYci");
        k.llIlIIllII[k.llIlIIllIl[13]] = k.lIllIIlIIlIIl("Ie3/tSikK6Q=", "HhlIm");
        k.llIlIIllII[k.llIlIIllIl[37]] = k.lIllIIlIIlIIl("tc+qVKRAw+4cWZyg42zzNA==", "GsQgx");
        k.llIlIIllII[k.llIlIIllIl[14]] = k.lIllIIlIIlIII("CyImATo5OTEIdR4iIQom", "MMTfU");
        k.llIlIIllII[k.llIlIIllIl[40]] = k.lIllIIlIIlIII("BgUkFA==", "UjQxX");
        k.llIlIIllII[k.llIlIIllIl[41]] = k.lIllIIlIIlIII("GCUVMxQy", "YQaRw");
        k.llIlIIllII[k.llIlIIllIl[42]] = k.lIllIIlIIlIIl("VDriKYbM5MA=", "sFqEt");
        k.llIlIIllII[k.llIlIIllIl[43]] = k.lIllIIlIIlIII("Fiw2MgI8", "WXBSa");
        k.llIlIIllII[k.llIlIIllIl[44]] = k.lIllIIlIIlIIl("jhP8WTtMYZcGghbeneOaxw==", "uwJeQ");
    }
}
