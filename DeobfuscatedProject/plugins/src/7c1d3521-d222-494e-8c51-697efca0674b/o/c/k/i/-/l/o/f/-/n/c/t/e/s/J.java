...
import o.c.k.i.-.l.o.f.-.n.c.t.e.s.K;
...
implements ac {
    ...
    private static void Q() {
        d llllllllllllllllllIIllIIlllllIll;
        Object llllllllllllllllllIIllIIllllllII;
        block27: {
            block26: {
                block25: {
                    block24: {
                        block23: {
                            block22: {
                                block21: {
                                    ...
                                    llllllllllllllllllIIllIIllllllII = new d(llIIlllIII[11], llIIlllIII[3], j.cf);
                                    bv.add((d)llllllllllllllllllIIllIIllllllII);
                                    "".length();
                                }
                                int[] nArray = new int[llIIlllIII[5]];
                                nArray[J.llIIlllIII[6]] = llIIlllIII[25];
                                if (J.lIlIllIllllII(Bank.contains((int[])nArray) ? 1 : 0)) {
                                    llllllllllllllllllIIllIIllllllII = new d(llIIlllIII[25], llIIlllIII[5], llIIlllIII[60]);
                                    bv.add((d)llllllllllllllllllIIllIIllllllII);
                                    "".length();
                                }
                                ...
                                if (J.lIlIllIllllII(Bank.contains((int[])nArray4) ? 1 : 0)) {
                                    llllllllllllllllllIIllIIllllllII = new d(llIIlllIII[22], llIIlllIII[5], llIIlllIII[60]);
                                    bv.add((d)llllllllllllllllllIIllIIllllllII);
                                    "".length();
                                }
                            ...
                            llllllllllllllllllIIllIIllllllII = new d(llIIlllIII[10], llIIlllIII[9], llIIlllIII[61]);
                            bv.add((d)llllllllllllllllllIIllIIllllllII);
                            "".length();
                        }
                        int[] nArray = new int[llIIlllIII[5]];
                        ...
                        if (J.lIlIllIllllII(Bank.contains((int[])nArray) ? 1 : 0)) {
                            llllllllllllllllllIIllIIllllllII = new d(llIIlllIII[19], llIIlllIII[5], llIIlllIII[60]);
                            bv.add((d)llllllllllllllllllIIllIIllllllII);
                            "".length();
                        }
                        ...
                        if (J.lIlIllIllllII(Bank.contains((int[])nArray8) ? 1 : 0)) {
                            llllllllllllllllllIIllIIllllllII = new d(llIIlllIII[17], llIIlllIII[5], llIIlllIII[60]);
                            bv.add((d)llllllllllllllllllIIllIIllllllII);
                            "".length();
                        }
                        ...
                        if (J.lIlIllIllllII(Bank.contains((int[])nArray9) ? 1 : 0)) {
                            llllllllllllllllllIIllIIllllllII = new d(llIIlllIII[15], llIIlllIII[5], llIIlllIII[60]);
                            bv.add((d)llllllllllllllllllIIllIIllllllII);
                            "".length();
                        }
                        ...
                        if (J.lIlIllIllllII(Bank.contains((int[])nArray10) ? 1 : 0)) {
                            llllllllllllllllllIIllIIllllllII = new d(llIIlllIII[16], llIIlllIII[5], llIIlllIII[60]);
                            bv.add((d)llllllllllllllllllIIllIIllllllII);
                            "".length();
                        }
                    ...
                    llllllllllllllllllIIllIIllllllII = new d(llIIlllIII[14], llIIlllIII[4], llIIlllIII[62]);
                    bv.add((d)llllllllllllllllllIIllIIllllllII);
                    "".length();
                }
                int[] nArray = new int[llIIlllIII[5]];
            ...
            llllllllllllllllllIIllIIllllllII = new d(llIIlllIII[12], llIIlllIII[4], llIIlllIII[62]);
            bv.add((d)llllllllllllllllllIIllIIllllllII);
            "".length();
        }
        if (J.lIlIllIllllII(Bank.contains((Predicate)(llllllllllllllllllIIllIIllllllII = item -> item.getName().toLowerCase().contains(llIIllIlll[llIIlllIII[67]]))) ? 1 : 0)) {
            llllllllllllllllllIIllIIlllllIll = new d(llIIlllIII[63], llIIlllIII[3], llIIlllIII[64]);
            bv.add(llllllllllllllllllIIllIIlllllIll);
            "".length();
        }
        int[] nArray = new int[llIIlllIII[5]];
        nArray[J.llIIlllIII[6]] = llIIlllIII[13];
        if (J.lIlIllIllllII(Bank.contains((int[])nArray) ? 1 : 0)) {
            llllllllllllllllllIIllIIlllllIll = new d(llIIlllIII[13], llIIlllIII[42], llIIlllIII[62]);
            bv.add(llllllllllllllllllIIllIIlllllIll);
            "".length();
        }
    }
    ...
    private static void lIlIllIllIllI() {
        ...
        J.llIIllIlll[J.llIIlllIII[6]] = J.lIlIllIllIIll("NgI5KioYDjNjOwUSPi0+UAIjJjQDR3cwLhkfNCswHgx3ITgTAHc3NlAaIiYqBA==", "pkWCY");
        J.llIIllIlll[J.llIIlllIII[5]] = J.lIlIllIllIlII("R0f4E1LZCpp0wKUBMD9eMg==", "TkUow");
        J.llIIllIlll[J.llIIlllIII[8]] = J.lIlIllIllIlIl("eol6RChTmn/aNKqM/BTirwfmpw5hLyfd", "yWqoE");
        J.llIIllIlll[J.llIIlllIII[1]] = J.lIlIllIllIIll("Ai9lJzgwaigvOSYjKyFqJD8gNT51OTA2OjkjIDVmdTkyLz42IiwoLXU+KmYIABMMCA0=", "UJEFJ");
        J.llIIllIlll[J.llIIlllIII[9]] = J.lIlIllIllIIll("PjN4EQIMdjUZAxo/NhdQGCM9AwRJJS0AAAU/PQNcSSUvGQQKPjEeF0kiN1AyPA8RPjc=", "iVXpp");
        J.llIIllIlll[J.llIIlllIII[3]] = J.lIlIllIllIIll("KiogPgc=", "nXIPl");
        J.llIIllIlll[J.llIIlllIII[18]] = J.lIlIllIllIlIl("CbI4+pTDMeU=", "zUqVn");
        J.llIIllIlll[J.llIIlllIII[20]] = J.lIlIllIllIlII("TLxahhwWr+AZD8++Dv5onQ==", "CDjmk");
        J.llIIllIlll[J.llIIlllIII[21]] = J.lIlIllIllIlIl("eCxTB9r7ecM=", "nePzV");
        J.llIIllIlll[J.llIIlllIII[23]] = J.lIlIllIllIIll("AxoOIiE=", "GmoPG");
        J.llIIllIlll[J.llIIlllIII[4]] = J.lIlIllIllIlII("VMIBmoUMPpk=", "ncfzZ");
        J.llIIllIlll[J.llIIlllIII[2]] = J.lIlIllIllIlIl("lxf/qAvYh7J/A7JDNcBjAPwzo4T2dfQF", "MDkIJ");
        J.llIIllIlll[J.llIIlllIII[29]] = J.lIlIllIllIIll("JiYDJgALZw4qDRo=", "nGmBl");
        J.llIIllIlll[J.llIIlllIII[30]] = J.lIlIllIllIlIl("mEgKcyzAdZg=", "CDrmO");
        J.llIIllIlll[J.llIIlllIII[31]] = J.lIlIllIllIlIl("L0vSRrjH1tAxYJCo/pl+12FvRutYGEbK", "ubnqQ");
        J.llIIllIlll[J.llIIlllIII[32]] = J.lIlIllIllIIll("CQoCHj0kSw8SMDU=", "AklzQ");
        J.llIIllIlll[J.llIIlllIII[33]] = J.lIlIllIllIIll("FwhDAQ8yRicZAiQA", "Vfcnc");
        J.llIIllIlll[J.llIIlllIII[36]] = J.lIlIllIllIIll("HSkGagI8aAIlFThoEysdNmgXPw8=", "SHpJv");
        J.llIIllIlll[J.llIIlllIII[37]] = J.lIlIllIllIIll("BBspIA0pWiQsADg=", "LzGDa");
        J.llIIllIlll[J.llIIlllIII[38]] = J.lIlIllIllIIll("CB9LABYtUS8YGzsX", "Iqkoz");
        J.llIIllIlll[J.llIIlllIII[34]] = J.lIlIllIllIIll("GAUAAAA=", "Jjhak");
        J.llIIllIlll[J.llIIlllIII[39]] = J.lIlIllIllIlII("iMXAe8QE+9wz5qaAzFiFCQ==", "wKYcN");
        J.llIIllIlll[J.llIIlllIII[40]] = J.lIlIllIllIIll("Ij4JDgY=", "pQaom");
        J.llIIllIlll[J.llIIlllIII[43]] = J.lIlIllIllIlIl("NDuyOVHEnrM3oxwutJz0TA==", "jtxWK");
        J.llIIllIlll[J.llIIlllIII[44]] = J.lIlIllIllIlIl("M4iL3Rfxz64=", "GYLWu");
        J.llIIllIlll[J.llIIlllIII[45]] = J.lIlIllIllIlIl("+hYIAm6bS+s=", "ZJtIi");
        J.llIIllIlll[J.llIIlllIII[47]] = J.lIlIllIllIIll("AAsJAg==", "TjbgS");
        J.llIIllIlll[J.llIIlllIII[48]] = J.lIlIllIllIlIl("3xFLZ2nkZMg=", "WdQuV");
        J.llIIllIlll[J.llIIlllIII[49]] = J.lIlIllIllIlIl("75Pj1iNDumHv0FoF39NtUw==", "LBsAj");
        J.llIIllIlll[J.llIIlllIII[50]] = J.lIlIllIllIlII("CnbuSvPrQkxAv9V6v2Mzcg==", "wEuVQ");
        J.llIIllIlll[J.llIIlllIII[41]] = J.lIlIllIllIlIl("oJ5TeToa+UEWqT1dowK0Jw==", "KqDGL");
        J.llIIllIlll[J.llIIlllIII[51]] = J.lIlIllIllIlIl("hhBHRhPDTJ0=", "ahdDO");
        J.llIIllIlll[J.llIIlllIII[55]] = J.lIlIllIllIlIl("/Qg7/wx3bNE=", "HScWH");
        J.llIIllIlll[J.llIIlllIII[56]] = J.lIlIllIllIlII("7wuAr+Ahm9jQs2temwg6Sg==", "AIOhg");
        J.llIIllIlll[J.llIIlllIII[57]] = J.lIlIllIllIIll("JzcwIQ==", "fEYRR");
        J.llIIllIlll[J.llIIlllIII[58]] = J.lIlIllIllIlIl("IcaTvQ2Kmw5qN7Jqfikhiw==", "iKTVo");
        J.llIIllIlll[J.llIIlllIII[59]] = J.lIlIllIllIlIl("aPklL5ZppIc=", "Tjoup");
        J.llIIllIlll[J.llIIlllIII[66]] = J.lIlIllIllIlII("4apv4R1NV2PIrMjOLFrM8g==", "BLgJf");
        J.llIIllIlll[J.llIIlllIII[67]] = J.lIlIllIllIlII("u4XWdk7sUEJ6kzDEh8hGe9qiOBR2kLec", "qpwbp");
        J.llIIllIlll[J.llIIlllIII[76]] = J.lIlIllIllIlIl("Xo2n+UPu+aU=", "LajSk");
        J.llIIllIlll[J.llIIlllIII[42]] = J.lIlIllIllIlII("f0CbJCZG3pcebbT3XjK81TMpzD7KEt0bQyjUKpAQ5Rz+32e899W7mwVa/1PvssA0", "kKFNS");
        J.llIIllIlll[J.llIIlllIII[77]] = J.lIlIllIllIlII("x3T+stv4Gg0RAOiGZ7zmgs9BGGqRtzwPoBqtSqfKfh1pdaKqO1p1yv1uQZjns48smQNchy/e7b4=", "aWQkZ");
    }

    private static String lIlIllIllIlIl(String llllllllllllllllllIIllIIlllIllll, String llllllllllllllllllIIllIIlllIlllI) {
        try {
            SecretKeySpec llllllllllllllllllIIllIIllllIlII = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIIllIIlllIlllI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllllIIllIIllllIIll = Cipher.getInstance("Blowfish");
            llllllllllllllllllIIllIIllllIIll.init(llIIlllIII[8], llllllllllllllllllIIllIIllllIlII);
            return new String(llllllllllllllllllIIllIIllllIIll.doFinal(Base64.getDecoder().decode(llllllllllllllllllIIllIIlllIllll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlIllIllIlII(String llllllllllllllllllIIllIIlllIIlII, String llllllllllllllllllIIllIIlllIIIll) {
        try {
            SecretKeySpec llllllllllllllllllIIllIIlllIIlll = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIIllIIlllIIIll.getBytes(StandardCharsets.UTF_8)), llIIlllIII[21]), "DES");
            Cipher llllllllllllllllllIIllIIlllIIllI = Cipher.getInstance("DES");
            llllllllllllllllllIIllIIlllIIllI.init(llIIlllIII[8], llllllllllllllllllIIllIIlllIIlll);
            return new String(llllllllllllllllllIIllIIlllIIllI.doFinal(Base64.getDecoder().decode(llllllllllllllllllIIllIIlllIIlII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public int af() {
        ...
        if ((((0xE ^ 0x2F) & ~(0x2C ^ 0xD) ^ (0x96 ^ 0x9F)) & (67 + 119 - 125 + 83 ^ 52 + 99 - 14 + 16 ^ -" ".length())) == "  ".length()) {
            return (0x5A ^ 0x70 ^ (0xB3 ^ 0xA8)) & (9 + 9 - -101 + 123 ^ 117 + 55 - 97 + 120 ^ -" ".length());
        }
    ...
    private static String lIlIllIllIIll(String llllllllllllllllllIIllIIllIIllll, String llllllllllllllllllIIllIIllIlIIll) {
        llllllllllllllllllIIllIIllIIllll = new String(Base64.getDecoder().decode(llllllllllllllllllIIllIIllIIllll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllIIllIIllIlIIlI = new StringBuilder();
        char[] llllllllllllllllllIIllIIllIlIIIl = llllllllllllllllllIIllIIllIlIIll.toCharArray();
        int llllllllllllllllllIIllIIllIlIIII = llIIlllIII[6];
        char[] llllllllllllllllllIIllIIllIIlIlI = llllllllllllllllllIIllIIllIIllll.toCharArray();
        int llllllllllllllllllIIllIIllIIlIIl = llllllllllllllllllIIllIIllIIlIlI.length;
        int llllllllllllllllllIIllIIllIIlIII = llIIlllIII[6];
        while (J.lIlIllIlllIII(llllllllllllllllllIIllIIllIIlIII, llllllllllllllllllIIllIIllIIlIIl)) {
            char llllllllllllllllllIIllIIllIlIlIl = llllllllllllllllllIIllIIllIIlIlI[llllllllllllllllllIIllIIllIIlIII];
            llllllllllllllllllIIllIIllIlIIlI.append((char)(llllllllllllllllllIIllIIllIlIlIl ^ llllllllllllllllllIIllIIllIlIIIl[llllllllllllllllllIIllIIllIlIIII % llllllllllllllllllIIllIIllIlIIIl.length]));
            "".length();
            ++llllllllllllllllllIIllIIllIlIIII;
            ++llllllllllllllllllIIllIIllIIlIII;
            "".length();
            if (" ".length() == " ".length()) continue;
            return null;
        }
        return String.valueOf(llllllllllllllllllIIllIIllIlIIlI);
    }
    ...
    public static void cw() {
        block50: {
            block58: {
                block57: {
                    BankLocation llllllllllllllllllIIllIIllllllll;
                    block56: {
                        block51: {
                            block55: {
                                block53: {
                                    block54: {
                                        block52: {
                                            ...
                                            llllllllllllllllllIIllIIllllllll = BankLocation.getNearest();
                                            if (J.lIlIllIllllIl(llllllllllllllllllIIllIIllllllll) && J.lIlIllIllllII(llllllllllllllllllIIllIIllllllll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                                AccBuilderSotf.c = llIIllIlll[llIIlllIII[5]];
                                                a.a(llllllllllllllllllIIllIIllllllll);
                                            }
                                            if (!J.lIlIllIllllIl(llllllllllllllllllIIllIIllllllll) || !J.lIlIllIlllIll(llllllllllllllllllIIllIIllllllll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block51;
                        ...
                        llllllllllllllllllIIllIIllllllll = new WorldPoint(llIIlllIII[53], llIIlllIII[54], llIIlllIII[6]);
                    ...
                    if (!J.lIlIlllIIIIlI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)llllllllllllllllllIIllIIllllllll), llIIlllIII[41])) break block58;
                }
                        ...
                        if (J.lIlIllIlllIll(Inventory.contains((int[])nArray5) ? 1 : 0)) {
                            ...
                            if (J.lIlIllIlllIll(Inventory.contains((int[])nArray6) ? 1 : 0)) {
                                ...
                                if (J.lIlIllIlllIll(Inventory.contains((int[])nArray7) ? 1 : 0)) {
                                    n2 = llIIlllIII[5];
                                    "".length();
                                    if ((0x6F ^ 0x6B) > "  ".length()) return n2 != 0;
                                    return ((6 ^ 0x29) & ~(0x2D ^ 2)) != 0;
                                }
                            }
                        }
                    }
