...
public class g {
    ...
    private static void lIlllIlIIIlII() {
        ...
        g.llIlllIlIl[g.llIlllIllI[3]] = g.lIlllIlIIIIIl("Xma5CL1Tb/g=", "eqlPF");
        g.llIlllIlIl[g.llIlllIllI[2]] = g.lIlllIlIIIIlI("eyKy9y49C/g=", "IzRfk");
        g.llIlllIlIl[g.llIlllIllI[6]] = g.lIlllIlIIIIll("Nx05FjkdGzFZLh0UOhYt", "tuVyJ");
        g.llIlllIlIl[g.llIlllIllI[7]] = g.lIlllIlIIIIll("LTMPKEINPQ==", "yRcCo");
        g.llIlllIlIl[g.llIlllIllI[8]] = g.lIlllIlIIIIlI("AD7hN9gmFKI=", "LHftn");
        g.llIlllIlIl[g.llIlllIllI[4]] = g.lIlllIlIIIIll("Nx4HFTodGA9aLR0XBBUu", "tvhzI");
        g.llIlllIlIl[g.llIlllIllI[9]] = g.lIlllIlIIIIll("FRchKmo1GQ==", "AvMAG");
        g.llIlllIlIl[g.llIlllIllI[10]] = g.lIlllIlIIIIIl("VKZbBmcc6zuPyUWXVsa3wQ==", "VjyuO");
    }
    ...
    private static void lIlllIlIIIlIl() {
        ...
        g.llIlllIllI[2] = " ".length();
        g.llIlllIllI[3] = (125 + 140 - 249 + 150 ^ 7 + 49 - -67 + 60) & (181 + 103 - 75 + 2 ^ 164 + 9 - 44 + 65 ^ -" ".length());
        g.llIlllIllI[4] = 0xB0 ^ 0xB5;
        g.llIlllIllI[5] = -(0xFFFFFFE7 & 0x2459) & (0xFFFFFFFC & 0x2FFB);
        g.llIlllIllI[6] = "  ".length();
        g.llIlllIllI[7] = "   ".length();
        g.llIlllIllI[8] = 0x77 ^ 0x73;
        g.llIlllIllI[9] = 0x99 ^ 0x9F;
        g.llIlllIllI[10] = 0x66 ^ 0x61;
        g.llIlllIllI[11] = (0xD3 ^ 0x9B) + (0x50 ^ 0x7A) - -"   ".length() + (0x7F ^ 0x33);
    ...
    public static boolean M() {
        ...
        while (g.lIlllIlIIIllI(llllllllllllllllllIIIIIlIIlIIIlI, bs.length)) {
            ...
            "".length();
            if (null == null) continue;
            return ((0x16 ^ 5 ^ (0xB2 ^ 0xB8)) & (0x1B ^ 0x58 ^ (0xE4 ^ 0xBE) ^ -" ".length())) != 0;
        }
        return llIlllIllI[3];
    }
}
