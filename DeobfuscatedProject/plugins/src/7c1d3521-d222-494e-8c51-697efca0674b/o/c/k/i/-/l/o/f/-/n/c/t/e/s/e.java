...
public class e {
    ...
    private static void lIlIlIIIIIlIl() {
        ...
        e.llIIlIIIII[85] = "   ".length() ^ (0x9D ^ 0xAD);
        ...
        e.llIIlIIIII[99] = "  ".length() ^ (0xB5 ^ 0x88);
        ...
        e.llIIlIIIII[106] = -" ".length() & (0xFFFFEFFD & 0x1C7F);
        ...
        e.llIIlIIIII[186] = 0xD5 ^ 0x90 ^ "   ".length();
    ...
    public static void D() {
        World world2 = Worlds.getRandom(world -> {
            ...
            if (e.lIlIlIIIIlIll(world.isMembers() ? 1 : 0) && e.lIlIlIIIIlllI(world.getPlayerCount(), llIIlIIIII[82]) && e.lIlIlIIIIllll(world.getId(), Worlds.getCurrentId()) && e.lIlIlIIIIlIII(world.getActivity().endsWith(llIIIlllll[llIIlIIIII[83]]) ? 1 : 0) && e.lIlIlIIIIlIII(world.getActivity().endsWith(llIIIlllll[llIIlIIIII[84]]) ? 1 : 0) && e.lIlIlIIIIlIII(world.getActivity().startsWith(llIIIlllll[llIIlIIIII[78]]) ? 1 : 0) && e.lIlIlIIIIlIII(world.getActivity().startsWith(llIIIlllll[llIIlIIIII[85]]) ? 1 : 0) && e.lIlIlIIIIllll(world.getId(), llIIlIIIII[86]) && e.lIlIlIIIIllll(world.getId(), llIIlIIIII[87]) && e.lIlIlIIIIllll(world.getId(), llIIlIIIII[87]) && e.lIlIlIIIIlIII(world.getActivity().contains(llIIIlllll[llIIlIIIII[88]]) ? 1 : 0) && e.lIlIlIIIIlIII(world.getActivity().contains(llIIIlllll[llIIlIIIII[89]]) ? 1 : 0) && e.lIlIlIIIIlIII(world.getActivity().contains(llIIIlllll[llIIlIIIII[90]]) ? 1 : 0) && e.lIlIlIIIIlIII(world.getActivity().startsWith(llIIIlllll[llIIlIIIII[91]]) ? 1 : 0) && e.lIlIlIIIIlIII(world.getActivity().endsWith(llIIIlllll[llIIlIIIII[92]]) ? 1 : 0) && e.lIlIlIIIIlIII(world.getActivity().endsWith(llIIIlllll[llIIlIIIII[93]]) ? 1 : 0) && e.lIlIlIIIIlIII(world.getActivity().endsWith(llIIIlllll[llIIlIIIII[94]]) ? 1 : 0) && e.lIlIlIIIIlIII(world.getActivity().startsWith(llIIIlllll[llIIlIIIII[95]]) ? 1 : 0) && e.lIlIlIIIIllIl(world.getPlayerCount(), llIIlIIIII[96])) {
                ...
                "".length();
                if (" ".length() <= -" ".length()) {
                    return ((0x29 ^ 0 ^ (0x11 ^ 0xA)) & (0x4A ^ 0x14 ^ (0xA9 ^ 0xC5) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIIlIIIII[2];
            }
    ...
    public static void G() {
        block9: {
            ...
            do {
                ...
                "".length();
                "".length();
            } while (((0xBF ^ 0xB9 ^ (0x88 ^ 0xAB)) & (122 + 22 - 25 + 31 ^ 10 + 45 - -33 + 91 ^ -" ".length())) == (" ".length() & (" ".length() ^ -" ".length())));
            return;
        }
    }
    ...
    private static void lIlIlIIIIIlII() {
        ...
        e.llIIIlllll[e.llIIlIIIII[2]] = e.lIlIlIIIIIIIl("DRMmBxs4Cz0JSy8HMhw=", "HbSnk");
        e.llIIIlllll[e.llIIlIIIII[1]] = e.lIlIlIIIIIIIl("DBg/bh8tWT8rBDE=", "ByINk");
        e.llIIIlllll[e.llIIlIIIII[9]] = e.lIlIlIIIIIIlI("2UByrVE0lQHorhKWH8hDAKogUAPK+Q69", "jQDUd");
        e.llIIIlllll[e.llIIlIIIII[5]] = e.lIlIlIIIIIIIl("OgQiHXQ6AiMKNRgCPAAhGQ==", "jkPiT");
        e.llIIIlllll[e.llIIlIIIII[10]] = e.lIlIlIIIIIIIl("PTUUIHM9MxU3Mh8zCj0mHg==", "mZfTS");
        e.llIIIlllll[e.llIIlIIIII[11]] = e.lIlIlIIIIIIIl("HQo1IlYdDDQ1Fz8MKz8DPg==", "MeGVv");
        e.llIIIlllll[e.llIIlIIIII[12]] = e.lIlIlIIIIIIIl("PRA7JA==", "kuTWL");
        e.llIIIlllll[e.llIIlIIIII[13]] = e.lIlIlIIIIIIlI("rQrdParFQfQSm2/k60+tchBFtHiraer7", "FnnIA");
        e.llIIIlllll[e.llIIlIIIII[14]] = e.lIlIlIIIIIIIl("GC41Nk8YKDQhDjooKysaOw==", "HAGBo");
        e.llIIIlllll[e.llIIlIIIII[15]] = e.lIlIlIIIIIIIl("BysYJUIHLRkyAyUtBjgXJA==", "WDjQb");
        e.llIIIlllll[e.llIIlIIIII[16]] = e.lIlIlIIIIIIIl("GQAZE1QZBhgEFTsGBw4BOg==", "Iokgt");
        e.llIIIlllll[e.llIIlIIIII[17]] = e.lIlIlIIIIIIlI("rR+63QVIR/uoRsA8Y7S0Ihkd6cfhLJtN", "yttfz");
        e.llIIIlllll[e.llIIlIIIII[18]] = e.lIlIlIIIIIIIl("bXdRdyUs", "HRaRA");
        e.llIIIlllll[e.llIIlIIIII[19]] = e.lIlIlIIIIIIll("bCnxc2H1fBRjapLyXI5RcsQiah8kxVuKU1SRlpSmM6BVxPWEsA4+HpadRwBgrnKe3Ea0XBQvetw=", "QPiOt");
        e.llIIIlllll[e.llIIlIIIII[20]] = e.lIlIlIIIIIIll("NLg/cORlgwWP3OHSf0vYfg==", "TxsyT");
        e.llIIIlllll[e.llIIlIIIII[23]] = e.lIlIlIIIIIIIl("MDkpHhE=", "sUFmt");
        e.llIIIlllll[e.llIIlIIIII[24]] = e.lIlIlIIIIIIlI("B0iZRF7/S5yHMp1shxKzzyuAq7aqCyte", "yNVZG");
        e.llIIIlllll[e.llIIlIIIII[30]] = e.lIlIlIIIIIIll("tqrAxv52hrw=", "oOdwp");
        e.llIIIlllll[e.llIIlIIIII[31]] = e.lIlIlIIIIIIlI("rQ0aoB00ys+SWuid323V/XJoGtUg8k8m", "UmJII");
        e.llIIIlllll[e.llIIlIIIII[34]] = e.lIlIlIIIIIIlI("U2IbaQZNkOmos4d3U8JTcw==", "TZcZB");
        e.llIIIlllll[e.llIIlIIIII[36]] = e.lIlIlIIIIIIll("aqjDzcJgg+M=", "UpePa");
        e.llIIIlllll[e.llIIlIIIII[39]] = e.lIlIlIIIIIIIl("JT4iNAIU", "qQESn");
        e.llIIIlllll[e.llIIlIIIII[40]] = e.lIlIlIIIIIIlI("T2OWIktRTMk=", "cSMGr");
        e.llIIIlllll[e.llIIlIIIII[33]] = e.lIlIlIIIIIIlI("E9gpoNx8L43O+lTlYMVGog==", "AjxNQ");
        e.llIIIlllll[e.llIIlIIIII[43]] = e.lIlIlIIIIIIIl("JQI4EA==", "rgYbo");
        e.llIIIlllll[e.llIIlIIIII[44]] = e.lIlIlIIIIIIll("k0/iLCCSnAU=", "mWSsH");
        e.llIIIlllll[e.llIIlIIIII[45]] = e.lIlIlIIIIIIll("pDRZH2uNIPc=", "KEysy");
        e.llIIIlllll[e.llIIlIIIII[46]] = e.lIlIlIIIIIIll("xHxyXLbnsdg=", "qyHfT");
        e.llIIIlllll[e.llIIlIIIII[47]] = e.lIlIlIIIIIIll("zL+qeP2vbwU=", "TdDYt");
        e.llIIIlllll[e.llIIlIIIII[22]] = e.lIlIlIIIIIIIl("PT8XASg=", "xNbhX");
        e.llIIIlllll[e.llIIlIIIII[49]] = e.lIlIlIIIIIIIl("AxkPH3gpFVkbeBQ7WQkzMRwVVA==", "DpyzX");
        e.llIIIlllll[e.llIIlIIIII[61]] = e.lIlIlIIIIIIll("TBYK8ovKJcR6mjHuydquHTpe5mec8zH9", "tUJTi");
        e.llIIIlllll[e.llIIlIIIII[42]] = e.lIlIlIIIIIIIl("PRcbKA==", "zvoMT");
        e.llIIIlllll[e.llIIlIIIII[62]] = e.lIlIlIIIIIIIl("BDw1Hg==", "KLPpp");
        e.llIIIlllll[e.llIIlIIIII[63]] = e.lIlIlIIIIIIlI("q2jQYRlUiz87XNvtdMHth14J2zRYkztx", "IBSqf");
        e.llIIIlllll[e.llIIlIIIII[54]] = e.lIlIlIIIIIIlI("k0AQ1k0bKiu+HIrUq67tjRYYxRXfOVPy", "Nozcf");
        e.llIIIlllll[e.llIIlIIIII[66]] = e.lIlIlIIIIIIlI("7f0LtB+Do48=", "tWMtZ");
        e.llIIIlllll[e.llIIlIIIII[67]] = e.lIlIlIIIIIIll("uE8ftVzo0BY7B3qc8DDqrA==", "myVsO");
        e.llIIIlllll[e.llIIlIIIII[68]] = e.lIlIlIIIIIIll("yXNYkb8Dpi49EPEvlYHn1EX+RMMOUNy5", "wJAUq");
        e.llIIIlllll[e.llIIlIIIII[72]] = e.lIlIlIIIIIIll("27pp69PTyan5N1WnpNYYzQ==", "sorZc");
        e.llIIIlllll[e.llIIlIIIII[28]] = e.lIlIlIIIIIIll("0sLj2y9pDD6A5nFLMgr8Lg==", "SpeMY");
        e.llIIIlllll[e.llIIlIIIII[38]] = e.lIlIlIIIIIIlI("RU2pBT+TKjCajl+mLN07WA==", "gKEHj");
        e.llIIIlllll[e.llIIlIIIII[73]] = e.lIlIlIIIIIIll("gxbOqGFFz2P3xrlOWngLiQ==", "aPNKs");
        e.llIIIlllll[e.llIIlIIIII[74]] = e.lIlIlIIIIIIll("5rtEs94VMMg=", "JUIEX");
        e.llIIIlllll[e.llIIlIIIII[75]] = e.lIlIlIIIIIIIl("HQAIJVw9Dg==", "IadNq");
        e.llIIIlllll[e.llIIlIIIII[76]] = e.lIlIlIIIIIIll("OO+/9TOYgl8=", "IUWQi");
        e.llIIIlllll[e.llIIlIIIII[77]] = e.lIlIlIIIIIIll("I2K6oPqsX8s=", "wXEKZ");
        e.llIIIlllll[e.llIIlIIIII[81]] = e.lIlIlIIIIIIlI("MM1vcxPNMR8=", "Gkmux");
        e.llIIIlllll[e.llIIlIIIII[83]] = e.lIlIlIIIIIIll("p06zWuMq7SE=", "JmhsF");
        e.llIIIlllll[e.llIIlIIIII[84]] = e.lIlIlIIIIIIll("hMr5eYEuLjw=", "jSsPF");
        e.llIIIlllll[e.llIIlIIIII[78]] = e.lIlIlIIIIIIlI("MZ1nRREZsFE=", "dGRvO");
        e.llIIIlllll[e.llIIlIIIII[85]] = e.lIlIlIIIIIIll("oy6J2rYsGow=", "sEOHT");
        e.llIIIlllll[e.llIIlIIIII[88]] = e.lIlIlIIIIIIIl("KDMxARkBJQ==", "dVPfl");
        e.llIIIlllll[e.llIIlIIIII[89]] = e.lIlIlIIIIIIIl("KS8SMQ==", "kJfPT");
        e.llIIIlllll[e.llIIlIIIII[90]] = e.lIlIlIIIIIIlI("IexEDyQcl28=", "lAJLc");
        e.llIIIlllll[e.llIIlIIIII[91]] = e.lIlIlIIIIIIIl("KTACEiIMOw==", "mUcvO");
        e.llIIIlllll[e.llIIlIIIII[92]] = e.lIlIlIIIIIIlI("OHpSQjY59mY=", "aaBTT");
        e.llIIIlllll[e.llIIlIIIII[93]] = e.lIlIlIIIIIIlI("AialEU0f09uVNPHBeYHLVw==", "ePEor");
        e.llIIIlllll[e.llIIlIIIII[94]] = e.lIlIlIIIIIIlI("QSwectulrtg=", "NXLHD");
        e.llIIIlllll[e.llIIlIIIII[95]] = e.lIlIlIIIIIIIl("NRcHDA==", "wrsml");
        e.llIIIlllll[e.llIIlIIIII[97]] = e.lIlIlIIIIIIlI("qkDri8JR7h16ciXcA05xvbRu/GlbpHHx", "ZldeN");
        e.llIIIlllll[e.llIIlIIIII[27]] = e.lIlIlIIIIIIIl("ICYZIC0tPBI=", "CIwTD");
        e.llIIIlllll[e.llIIlIIIII[98]] = e.lIlIlIIIIIIlI("ed5wkaDptnSxjN9gh9/nfA==", "QTNqF");
        e.llIIIlllll[e.llIIlIIIII[99]] = e.lIlIlIIIIIIlI("Zuive74JdTiJ+sE0O4WtyA==", "iVvfI");
        e.llIIIlllll[e.llIIlIIIII[100]] = e.lIlIlIIIIIIll("noiAr4W89n3lnBas4B+2vA==", "pZwZP");
        e.llIIIlllll[e.llIIlIIIII[104]] = e.lIlIlIIIIIIlI("La0LtL8e+Ru/fJaqFPORSbr/YwkUwkc1y2Z/J+xU1cvTXDoSd/MtTWcoGXsF0KjhY5OxR294FL4=", "rACMV");
    }
    ...
    public static int c(int n2, int n3) {
        ...
        if (e.lIlIlIIIIlIlI(Math.abs(llllllllllllllllllIlIlIIllllIlIl), llIIlIIIII[1])) {
            ...
            if (e.lIlIlIIIIlIll(R.nextBoolean() ? 1 : 0)) {
                ...
                "".length();
                if (" ".length() == 0) {
                    return (0xEF ^ 0xC7 ^ (0x4E ^ 0x50)) & (1 + 150 - 19 + 57 ^ 58 + 1 - -24 + 56 ^ -" ".length());
                }
            } else {
    ...
    public static boolean c(int[] nArray) {
        ...
        while (e.lIlIlIIIIIlll(llllllllllllllllllIlIlIIlllIlIll, llllllllllllllllllIlIlIIlllIllII.length)) {
            ...
            return ((92 + 113 - 132 + 132 ^ 9 + 11 - -109 + 18) & (0x25 ^ 0x14 ^ (0xDF ^ 0xB0) ^ -" ".length())) != 0;
        }
        return llIIlIIIII[1];
    }
    ...
    public static boolean B() {
        ...
        if (e.lIlIlIIIIlIIl(Widgets.get((int)llIIlIIIII[32], (int)llIIlIIIII[1]))) {
            bl = llIIlIIIII[1];
            "".length();
            if (((0x28 ^ 0x1A ^ (0x22 ^ 0x33)) & (26 + 171 - 148 + 134 ^ 10 + 124 - -11 + 3 ^ -" ".length())) >= "  ".length()) {
                return ((0x4B ^ 0x2F ^ (0x1F ^ 0x3B)) & (9 + 212 - 178 + 209 ^ 33 + 178 - 159 + 136 ^ -" ".length())) != 0;
            }
        } else {
            bl = llIIlIIIII[2];
        }
