...
implements ac {
    ...
    private static String lIlIIIIllIIll(String llllllllllllllllllIllIlllIIlllIl, String llllllllllllllllllIllIlllIIllIlI) {
        try {
            SecretKeySpec llllllllllllllllllIllIlllIlIIIII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIllIlllIIllIlI.getBytes(StandardCharsets.UTF_8)), lIllllllll[30]), "DES");
            Cipher llllllllllllllllllIllIlllIIlllll = Cipher.getInstance("DES");
            llllllllllllllllllIllIlllIIlllll.init(lIllllllll[3], llllllllllllllllllIllIlllIlIIIII);
    ...
    private static void am() {
        ...
        if (al.lIlIIIIlllllI(Players.getLocal().getInteracting())) {
            ...
            if (al.lIlIIIIlllIlI(llllllllllllllllllIllIlllIllIlII) && al.lIlIIIIlllIIl(Players.getLocal().isMoving() ? 1 : 0)) {
                llllllllllllllllllIllIlllIllIlII.interact(lIlllllllI[lIllllllll[49]]);
    ...
    private static void lIlIIIIllIlIl() {
        ...
        al.lIlllllllI[al.lIllllllll[0]] = al.lIlIIIIllIIlI("iOXV1mH3Dil9oQj1+Gtqjg==", "FWvuG");
        al.lIlllllllI[al.lIllllllll[1]] = al.lIlIIIIllIIll("XHRUO/a0cklBLDqEejLkbCPUoYuJlwmbzzhLObhdp6D+cOwft1KBhOP+I85LTRdCEsMkTRmVjwc=", "wPylJ");
        al.lIlllllllI[al.lIllllllll[3]] = al.lIlIIIIllIlII("LzIgHw0AJz8YDUEnOVYIAD09", "aSVvj");
        al.lIlllllllI[al.lIllllllll[4]] = al.lIlIIIIllIIll("oQJ6HkJVmLzrLJ4YpVexz9IFG2+He4PD", "oZqCP");
        al.lIlllllllI[al.lIllllllll[7]] = al.lIlIIIIllIlII("IgdXJjYQQhouNwYLGSBkBhcHNygcBwRrZAYVHjMnHQsZIGQBDVcFESwrOQA=", "ubwGD");
        al.lIlllllllI[al.lIllllllll[19]] = al.lIlIIIIllIIlI("yLcWOvTuE90Bxb1ZkK61vg==", "JqIRm");
        al.lIlllllllI[al.lIllllllll[6]] = al.lIlIIIIllIIll("eWPjhYnunHR4Hng6sjN1nA==", "rjzoO");
        al.lIlllllllI[al.lIllllllll[27]] = al.lIlIIIIllIlII("ARU4HA0sE2seBTAGJAsPYgAuBAE=", "BtKhd");
        al.lIlllllllI[al.lIllllllll[30]] = al.lIlIIIIllIlII("FScxMC04IWIoMTskO2QwMyon", "VFBDD");
        al.lIlllllllI[al.lIllllllll[32]] = al.lIlIIIIllIlII("GjIJAx83NFoRFzU/A1cCPD8f", "YSzwv");
        al.lIlllllllI[al.lIllllllll[33]] = al.lIlIIIIllIlII("OykeLicWL005LxUlFHo6HSQI", "xHmZN");
        al.lIlllllllI[al.lIllllllll[34]] = al.lIlIIIIllIIll("QL1IpOy40Ro=", "kfdEG");
        al.lIlllllllI[al.lIllllllll[37]] = al.lIlIIIIllIIlI("/omSjdCyPYo=", "DfQuz");
        al.lIlllllllI[al.lIllllllll[39]] = al.lIlIIIIllIIll("5H4o7ed70rrsYwr7VF4u0jLCtKVCKRPn", "JTxgw");
        al.lIlllllllI[al.lIllllllll[43]] = al.lIlIIIIllIIll("UHhWPYwHC97ZJnVbFw0mYA==", "PYdOv");
        al.lIlllllllI[al.lIllllllll[44]] = al.lIlIIIIllIIll("jj4uQpeqQl9yIfw5EAsz/Q==", "bDJaN");
        al.lIlllllllI[al.lIllllllll[45]] = al.lIlIIIIllIlII("CTMM", "LRxax");
        al.lIlllllllI[al.lIllllllll[46]] = al.lIlIIIIllIIll("woImsgXZ7hY=", "gVUsn");
        al.lIlllllllI[al.lIllllllll[47]] = al.lIlIIIIllIIll("VcsKJxuLA64=", "DBxze");
        al.lIlllllllI[al.lIllllllll[49]] = al.lIlIIIIllIIlI("m1WYd3SeFBs=", "iuVft");
        al.lIlllllllI[al.lIllllllll[53]] = al.lIlIIIIllIIlI("4YWvx9LPubVE/EtBhFlPcVkxcV+JGlma", "AaGFp");
        al.lIlllllllI[al.lIllllllll[54]] = al.lIlIIIIllIlII("Oh8aIh0cVwY9CxUb", "ywuMn");
        al.lIlllllllI[al.lIllllllll[56]] = al.lIlIIIIllIlII("FSgbEFURNQcdHic=", "BAutu");
        al.lIlllllllI[al.lIllllllll[57]] = al.lIlIIIIllIIll("ekBkKSc1U4uLEYQj6PqJLA==", "SnJBM");
        al.lIlllllllI[al.lIllllllll[58]] = al.lIlIIIIllIIll("vQr1fCG791xEdsOOponUfw==", "WrwSS");
        al.lIlllllllI[al.lIllllllll[21]] = al.lIlIIIIllIIlI("5mROpJTf2uOG/xdRN/+spA==", "gTIqQ");
        al.lIlllllllI[al.lIllllllll[52]] = al.lIlIIIIllIIll("aKfrGTP4iTisUMgp1R/UAg==", "VWRTP");
        al.lIlllllllI[al.lIllllllll[74]] = al.lIlIIIIllIlII("Gy0/GTF2OCoROzglNhc=", "VLXpR");
        al.lIlllllllI[al.lIllllllll[75]] = al.lIlIIIIllIIlI("DzNorDYgk04UBGgXoxAhhxxu/i1lwh9/", "rOuul");
        al.lIlllllllI[al.lIllllllll[76]] = al.lIlIIIIllIIll("JaoZQ+K5Pvk=", "VGqDk");
    }
    ...
    private static void Q() {
        d llllllllllllllllllIllIlllIlIllll;
        Object llllllllllllllllllIllIlllIllIIII;
        if (al.lIlIIIIlllIII(Skills.getLevel((Skill)Skill.MAGIC), lIllllllll[8])) {
            ...
            if (al.lIlIIIIlllIIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
                llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[9], lIllllllll[61], lIllllllll[6]);
                bv.add((d)llllllllllllllllllIllIlllIllIIII);
                "".length();
            }
            int[] nArray3 = new int[lIllllllll[1]];
            nArray3[al.lIllllllll[0]] = lIllllllll[11];
            if (al.lIlIIIIlllIIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
                llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[11], lIllllllll[62], lIllllllll[6]);
                bv.add((d)llllllllllllllllllIllIlllIllIIII);
                "".length();
            }
            ...
            if (al.lIlIIIIlllIIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
                llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[13], lIllllllll[63], lIllllllll[6]);
                bv.add((d)llllllllllllllllllIllIlllIllIIII);
                "".length();
            }
            ...
            if (al.lIlIIIIlllIIl(Bank.contains((int[])nArray5) ? 1 : 0)) {
                llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[14], lIllllllll[5], lIllllllll[6]);
                bv.add((d)llllllllllllllllllIllIlllIllIIII);
                "".length();
            }
            ...
            if (al.lIlIIIIlllIIl(Bank.contains((int[])nArray6) ? 1 : 0)) {
                llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[48], lIllllllll[1], e.c(lIllllllll[64], lIllllllll[65]));
                bv.add((d)llllllllllllllllllIllIlllIllIIII);
                "".length();
            }
        }
        if (al.lIlIIIIllllII(Skills.getLevel((Skill)Skill.MAGIC), lIllllllll[8])) {
            ...
            if (al.lIlIIIIllIlll(Bank.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (al.lIlIIIIlllIII(Bank.getFirst((int[])nArray7).getQuantity(), lIllllllll[63])) {
                    ...
                    llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[24], lIllllllll[63] - Bank.getFirst((int[])nArray8).getQuantity(), lIllllllll[66]);
                    bv.add((d)llllllllllllllllllIllIlllIllIIII);
                    "".length();
                }
            }
            ...
            if (al.lIlIIIIlllIIl(Bank.contains((int[])nArray9) ? 1 : 0)) {
                llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[24], lIllllllll[63], lIllllllll[66]);
                bv.add((d)llllllllllllllllllIllIlllIllIIII);
                "".length();
            }
            ...
            if (al.lIlIIIIllIlll(Bank.contains((int[])nArray10) ? 1 : 0)) {
                ...
                if (al.lIlIIIIlllIII(Bank.getFirst((int[])nArray11).getQuantity(), lIllllllll[63])) {
                    ...
                    llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[25], lIllllllll[63] - Bank.getFirst((int[])nArray12).getQuantity(), lIllllllll[67]);
                    bv.add((d)llllllllllllllllllIllIlllIllIIII);
                    "".length();
                }
            }
            ...
            if (al.lIlIIIIlllIIl(Bank.contains((int[])nArray13) ? 1 : 0)) {
                llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[25], lIllllllll[63], lIllllllll[67]);
                bv.add((d)llllllllllllllllllIllIlllIllIIII);
                "".length();
            }
            ...
            if (al.lIlIIIIlllIIl(Bank.contains((int[])nArray14) ? 1 : 0)) {
                ...
                if (al.lIlIIIIlllIIl(Equipment.contains((int[])nArray15) ? 1 : 0)) {
                    llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[22], lIllllllll[1], lIllllllll[68]);
                    bv.add((d)llllllllllllllllllIllIlllIllIIII);
                    "".length();
                }
            }
            if (al.lIlIIIIllIlll(ci ? 1 : 0)) {
                ...
                if (al.lIlIIIIllIlll(Bank.contains((int[])nArray16) ? 1 : 0)) {
                    ...
                    if (al.lIlIIIIlllIII(Bank.getFirst((int[])nArray17).getQuantity(), lIllllllll[63])) {
                        ...
                        llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[16], lIllllllll[63] - Bank.getFirst((int[])nArray18).getQuantity(), lIllllllll[60]);
                        bv.add((d)llllllllllllllllllIllIlllIllIIII);
                        "".length();
                    }
                }
                ...
                if (al.lIlIIIIlllIIl(Bank.contains((int[])nArray19) ? 1 : 0)) {
                    llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[16], lIllllllll[63], lIllllllll[60]);
                    bv.add((d)llllllllllllllllllIllIlllIllIIII);
                    "".length();
                }
                ...
                if (al.lIlIIIIllIlll(Bank.contains((int[])nArray20) ? 1 : 0)) {
                    ...
                    if (al.lIlIIIIlllIII(Bank.getFirst((int[])nArray21).getQuantity(), lIllllllll[68])) {
                        ...
                        llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[23], lIllllllll[68] - Bank.getFirst((int[])nArray22).getQuantity(), lIllllllll[6]);
                        bv.add((d)llllllllllllllllllIllIlllIllIIII);
                        "".length();
                    }
                }
                ...
                if (al.lIlIIIIlllIIl(Bank.contains((int[])nArray23) ? 1 : 0)) {
                    llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[23], lIllllllll[68], lIllllllll[6]);
                    bv.add((d)llllllllllllllllllIllIlllIllIIII);
                    "".length();
                }
            }
        ...
        nArray[al.lIllllllll[0]] = lIllllllll[20];
        if (al.lIlIIIIlllIIl(Bank.contains((int[])nArray) ? 1 : 0)) {
            llllllllllllllllllIllIlllIllIIII = new d(lIllllllll[20], lIllllllll[69], lIllllllll[40]);
            bv.add((d)llllllllllllllllllIllIlllIllIIII);
            "".length();
        }
        if (al.lIlIIIIlllIIl(Bank.contains(llllllllllllllllllIllIlllIllIIII = item -> item.getName().toLowerCase().contains(lIlllllllI[lIllllllll[75]])) ? 1 : 0)) {
            llllllllllllllllllIllIlllIlIllll = new d(lIllllllll[70], lIllllllll[19], lIllllllll[71]);
            bv.add(llllllllllllllllllIllIlllIlIllll);
            "".length();
        }
        ...
        if (al.lIlIIIIlllIIl(Bank.contains((int[])nArray24) ? 1 : 0)) {
            llllllllllllllllllIllIlllIlIllll = new d(lIllllllll[72], lIllllllll[33], lIllllllll[73]);
            bv.add(llllllllllllllllllIllIlllIlIllll);
            "".length();
        }
        ...
        if (al.lIlIIIIlllIIl(Bank.contains((int[])nArray25) ? 1 : 0)) {
            llllllllllllllllllIllIlllIlIllll = new d(lIllllllll[18], lIllllllll[33], lIllllllll[73]);
            bv.add(llllllllllllllllllIllIlllIlIllll);
            "".length();
        }
    }
                    ...
                    block27: {
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    block24: {
                                        block19: {
                                            ...
                                            block20: {
                                                ...
                                                n5 = lIllllllll[1];
                                                "".length();
                                                if (((0x58 ^ 0x4E ^ (4 ^ 0x1C)) & (0x5D ^ 0x1E ^ (0x40 ^ 0xD) ^ -" ".length())) != -" ".length()) return n5 != 0;
                                                return ((0x44 ^ 0x24 ^ (0x49 ^ 0x77)) & (7 ^ 0x44 ^ (0xAA ^ 0xB7) ^ -" ".length())) != 0;
                                            }
                                            n5 = lIllllllll[0];
                                            return n5 != 0;
                                        }
                                    ...
                                    return ((0x2C ^ 0x3F ^ (0x99 ^ 0xA7)) & (0x61 ^ 0xB ^ (0x5D ^ 0x1A) ^ -" ".length())) != 0;
                                }
                                n4 = lIllllllll[0];
                                return n4 != 0;
                            }
                        ...
                        if (al.lIlIIIIllIlll(Bank.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (al.lIlIIIIllIlll(Bank.contains((int[])nArray14) ? 1 : 0)) {
                                n3 = lIllllllll[1];
                                "".length();
                                if ((0x17 ^ 0x60 ^ (0x18 ^ 0x6B)) > "  ".length()) return n3 != 0;
                                return ((0x6A ^ 0x11 ^ (0x5D ^ 0x35)) & (128 + 65 - 138 + 74 ^ 45 + 78 - 12 + 35 ^ -" ".length())) != 0;
                            }
                        }
                    }
                    n3 = lIllllllll[0];
    ...
    private static void lIlIIIIllIllI() {
        ...
        al.lIllllllll[0] = (0xB1 ^ 0xA4 ^ (0x58 ^ 0xA)) & (0xD2 ^ 0xB1 ^ (0x7D ^ 0x59) ^ -" ".length());
        al.lIllllllll[1] = " ".length();
        al.lIllllllll[2] = 0xE7 ^ 0xBA ^ (0x42 ^ 0x54);
        al.lIllllllll[3] = "  ".length();
        al.lIllllllll[4] = "   ".length();
        ...
        al.lIllllllll[38] = 0x64 ^ 0x5A ^ " ".length();
    ...
    private static String lIlIIIIllIIlI(String llllllllllllllllllIllIllIllllIII, String llllllllllllllllllIllIllIlllIlIl) {
        try {
            SecretKeySpec llllllllllllllllllIllIllIllllIll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIllIllIlllIlIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllllIllIllIllllIlI = Cipher.getInstance("Blowfish");
            llllllllllllllllllIllIllIllllIlI.init(lIllllllll[3], llllllllllllllllllIllIllIllllIll);
    ...
    private static String lIlIIIIllIlII(String llllllllllllllllllIllIlllIIIlIII, String llllllllllllllllllIllIlllIIIIlll) {
        llllllllllllllllllIllIlllIIIlIII = new String(Base64.getDecoder().decode(llllllllllllllllllIllIlllIIIlIII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllIllIlllIIIlIll = new StringBuilder();
        char[] llllllllllllllllllIllIlllIIIlIlI = llllllllllllllllllIllIlllIIIIlll.toCharArray();
        int llllllllllllllllllIllIlllIIIlIIl = lIllllllll[0];
        char[] llllllllllllllllllIllIlllIIIIIll = llllllllllllllllllIllIlllIIIlIII.toCharArray();
        int llllllllllllllllllIllIlllIIIIIlI = llllllllllllllllllIllIlllIIIIIll.length;
        int llllllllllllllllllIllIlllIIIIIIl = lIllllllll[0];
        while (al.lIlIIIIlllIII(llllllllllllllllllIllIlllIIIIIIl, llllllllllllllllllIllIlllIIIIIlI)) {
            char llllllllllllllllllIllIlllIIIlllI = llllllllllllllllllIllIlllIIIIIll[llllllllllllllllllIllIlllIIIIIIl];
            llllllllllllllllllIllIlllIIIlIll.append((char)(llllllllllllllllllIllIlllIIIlllI ^ llllllllllllllllllIllIlllIIIlIlI[llllllllllllllllllIllIlllIIIlIIl % llllllllllllllllllIllIlllIIIlIlI.length]));
            "".length();
            ++llllllllllllllllllIllIlllIIIlIIl;
            ++llllllllllllllllllIllIlllIIIIIIl;
            "".length();
                                    ...
                                    block24: {
                                        block19: {
                                            ...
                                            block20: {
                                                ...
                                                return ((0xE1 ^ 0x9D ^ (0xC0 ^ 0xB6)) & (0x77 ^ 0x14 ^ (0x4E ^ 0x27) ^ -" ".length())) != 0;
                                            }
                                            n5 = lIllllllll[0];
                                            return n5 != 0;
                                        }
                    ...
                    if (al.lIlIIIIllllII(Inventory.getFirst((int[])nArray17).getQuantity(), lIllllllll[19])) {
                        ...
                        if (al.lIlIIIIllIlll(Inventory.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (al.lIlIIIIllIlll(Inventory.contains((int[])nArray19) ? 1 : 0)) {
                                ...
                                return ((0x24 ^ 0x79 ^ (0xF3 ^ 0x81)) & (123 + 101 - 194 + 133 ^ 110 + 77 - 115 + 68 ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
    ...
    public boolean ah() {
        ...
        if (al.lIlIIIIllllII(Skills.getLevel((Skill)Skill.MAGIC), lIllllllll[2])) {
            bl = lIllllllll[1];
            "".length();
            if (((0x2A ^ 0x65 ^ (0x2E ^ 0x67)) & (0x4A ^ 0x58 ^ (0x10 ^ 4) ^ -" ".length())) > (111 + 14 - 65 + 94 ^ 79 + 50 - 80 + 109)) {
                return ((188 + 50 - 53 + 4 ^ 56 + 83 - 86 + 83) & (123 + 82 - 154 + 129 ^ 81 + 51 - 90 + 87 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIllllllll[0];
        }
    ...
    public static void ak() {
        ...
        if (al.lIlIIIIlllIIl(bt ? 1 : 0) && al.lIlIIIIlllIII(Skills.getLevel((Skill)Skill.MAGIC), lIllllllll[2])) {
            BankLocation llllllllllllllllllIllIlllIlllIIl;
            if (al.lIlIIIIlllIIl(al.an() ? 1 : 0)) {
                llllllllllllllllllIllIlllIlllIIl = BankLocation.getNearest();
                if (al.lIlIIIIlllIlI(llllllllllllllllllIllIlllIlllIIl) && al.lIlIIIIlllIIl(llllllllllllllllllIllIlllIlllIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderSotf.c = lIlllllllI[lIllllllll[3]];
                    a.a(llllllllllllllllllIllIlllIlllIIl);
                }
                if (al.lIlIIIIlllIlI(llllllllllllllllllIllIlllIlllIIl) && al.lIlIIIIllIlll(llllllllllllllllllIllIlllIlllIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                ...
                                if (al.lIlIIIIlllIII(Inventory.getCount((int[])nArray2), lIllllllll[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (al.lIlIIIIlllIll(Inventory.getCount((int[])nArray))) {
                                            bl = lIllllllll[1];
                                            "".length();
                                            if (((107 + 126 - 42 + 44 ^ 10 + 98 - 29 + 92) & (0x2E ^ 0x29 ^ (0x41 ^ 6) ^ -" ".length())) <= -" ".length()) {
                                                return ((0x89 ^ 0xAC ^ (0x46 ^ 0x75)) & (0xA ^ 0x53 ^ (0x3F ^ 0x70) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIllllllll[0];
                                        }
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (al.lIlIIIIlllIll(Inventory.getCount((int[])nArray))) {
                                            ...
                                            if (("  ".length() & ("  ".length() ^ -" ".length())) != 0) {
                                                return ((15 + 63 - -76 + 28 ^ 96 + 184 - 147 + 54) & (0x1F ^ 0xE ^ (0x73 ^ 0x6F) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIllllllll[0];
                                        }
                                ...
                                if (al.lIlIIIIlllIII(Inventory.getCount((int[])nArray6), lIllllllll[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (al.lIlIIIIlllIll(Inventory.getCount((int[])nArray))) {
                                            bl = lIllllllll[1];
                                            "".length();
                                            if (-" ".length() == (0x5B ^ 0x2F ^ (0x2D ^ 0x5D))) {
                                                return ((0x6C ^ 0x3D ^ (0xEB ^ 0xBC)) & (115 + 108 - 115 + 34 ^ 131 + 76 - 148 + 77 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIllllllll[0];
                                        }
                                ...
                                if (al.lIlIIIIlllIII(Inventory.getCount((int[])nArray8), lIllllllll[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (al.lIlIIIIlllIll(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (null != null) {
                                                return ((0x42 ^ 0x6B ^ (0xB5 ^ 0xB8)) & (111 + 81 - 167 + 155 ^ 98 + 110 - 97 + 33 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIllllllll[0];
                                        }
                                ...
                                if (al.lIlIIIIlllIII(Inventory.getCount((int[])nArray10), lIllllllll[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (al.lIlIIIIlllIll(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if ("   ".length() < -" ".length()) {
                                                return ((54 + 41 - 91 + 143 ^ 188 + 95 - 216 + 127) & (29 + 15 - -105 + 86 ^ 74 + 11 - -97 + 4 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIllllllll[0];
                                        }
                                ...
                                if (al.lIlIIIIlllIII(Inventory.getCount((int[])nArray14), lIllllllll[1]) && al.lIlIIIIlllIII(Skills.getLevel((Skill)Skill.MAGIC), lIllllllll[21])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (al.lIlIIIIlllIll(Inventory.getCount((int[])nArray))) {
                                            bl = lIllllllll[1];
                                            "".length();
                                            if (((0xB7 ^ 0x82 ^ (0xEA ^ 0x92)) & (0x6F ^ 0x36 ^ (0x3E ^ 0x2A) ^ -" ".length())) > 0) {
                                                return ((0xF4 ^ 0x90 ^ (0x1E ^ 0x5B)) & (128 + 40 - 137 + 126 ^ 105 + 111 - 43 + 15 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIllllllll[0];
                                        }
            ...
            if (al.lIlIIIIllIlll(al.an() ? 1 : 0)) {
                ...
                if (al.lIlIIIIllllII(Skills.getLevel((Skill)Skill.MAGIC), lIllllllll[8])) {
                    int llllllllllllllllllIllIlllIllIlll;
                    ...
                    llllllllllllllllllIllIlllIlllIIl = Inventory.getFirst((int[])nArray17);
                    int[] nArray18 = new int[lIllllllll[1]];
                    nArray18[al.lIllllllll[0]] = lIllllllll[38];
                    Item llllllllllllllllllIllIlllIlllIII = Inventory.getFirst((int[])nArray18);
                    if (al.lIlIIIIlllIIl(ci ? 1 : 0) && al.lIlIIIIlllIlI(cl)) {
                        ...
                        if (al.lIlIIIIllIlll(Players.getLocal().getWorldLocation().equals((Object)cl) ? 1 : 0) && al.lIlIIIIlllIlI(llllllllllllllllllIllIlllIlllIIl) && al.lIlIIIIlllIlI(llllllllllllllllllIllIlllIlllIII)) {
                            llllllllllllllllllIllIlllIllIlll = Skills.getExperience((Skill)Skill.MAGIC);
                            Magic.cast((Spell)SpellBook.Standard.HIGH_LEVEL_ALCHEMY, (Item)llllllllllllllllllIllIlllIlllIII);
                            Time.sleepUntil(() -> {
                                boolean bl;
                                if (al.lIlIIIlIIIIlI(Skills.getExperience((Skill)Skill.MAGIC), llllllllllllllllllIllIlllIllIlll)) {
                                    bl = lIllllllll[1];
                                    "".length();
                                    if (((91 + 69 - 2 + 32 ^ 52 + 46 - -15 + 23) & (90 + 79 - 136 + 142 ^ 24 + 82 - -12 + 35 ^ -" ".length())) != 0) {
                                        return ((0x57 ^ 0x69 ^ (6 ^ 0x65)) & (0x50 ^ 0x6F ^ (0xC ^ 0x6E) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIllllllll[0];
                                }
                    ...
                    if (al.lIlIIIIllIlll(ci ? 1 : 0)) {
                        if (al.lIlIIIIlllIlI(llllllllllllllllllIllIlllIlllIIl) && al.lIlIIIIlllIlI(llllllllllllllllllIllIlllIlllIII) && al.lIlIIIIllllIl(Players.getLocal().getAnimation(), lIllllllll[28])) {
                            llllllllllllllllllIllIlllIllIlll = Skills.getExperience((Skill)Skill.MAGIC);
                            Magic.cast((Spell)SpellBook.Standard.HIGH_LEVEL_ALCHEMY, (Item)llllllllllllllllllIllIlllIlllIII);
                            Time.sleepUntil(() -> {
                                boolean bl;
                                if (al.lIlIIIlIIIIlI(Skills.getExperience((Skill)Skill.MAGIC), llllllllllllllllllIllIlllIllIlll)) {
                                    ...
                                    "".length();
                                    if ("   ".length() == 0) {
                                        return ((0x14 ^ 0x37 ^ (0x8D ^ 0xB2)) & (0x61 ^ 0xD ^ (0x1A ^ 0x6A) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIllllllll[0];
                                }
