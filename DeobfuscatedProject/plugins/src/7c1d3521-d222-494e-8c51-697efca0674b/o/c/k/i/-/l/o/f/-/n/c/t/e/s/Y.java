...
implements ac {
    ...
    private static void lIllllIIIIIII() {
        ...
        Y.llIlllllIl[Y.llIlllllll[0]] = Y.lIlllIlllllII("VijtT3JLsGjMZV2Bpg+1xg==", "rlkcn");
        Y.llIlllllIl[Y.llIlllllll[1]] = Y.lIlllIlllllIl("FwAvADo5DCVJKyQQKAcucQA1DCQiRWEaPjgdIgEgPw5hCygyAmEdJnEYNAw6JQ==", "QiAiI");
        Y.llIlllllIl[Y.llIlllllll[3]] = Y.lIlllIllllllI("M6NPFOqFHI8=", "kzfog");
        Y.llIlllllIl[Y.llIlllllll[5]] = Y.lIlllIllllllI("wgRk036F2pk=", "ZpmPq");
        Y.llIlllllIl[Y.llIlllllll[7]] = Y.lIlllIlllllII("MwjBZ/ksTmK18cEcdFtEsg==", "JDiqY");
        Y.llIlllllIl[Y.llIlllllll[8]] = Y.lIlllIlllllIl("PxIaNiYeHRNyKBYdHzskEA==", "wstRJ");
        Y.llIlllllIl[Y.llIlllllll[14]] = Y.lIlllIllllllI("RbdWLRm0hai7nq1//qC9VymabOBdTojHbiQkH65UGpnawoiIPLo8CoSpvnNA63Ei1LUL59wdVS8=", "JbJNM");
        Y.llIlllllIl[Y.llIlllllll[20]] = Y.lIlllIlllllIl("LSwuHAsZbRsRHA4uMQ==", "kMZtn");
        Y.llIlllllIl[Y.llIlllllll[18]] = Y.lIlllIllllllI("A+kTggJ4AMzy/pVRJ0+TsA==", "BmWyM");
        Y.llIlllllIl[Y.llIlllllll[21]] = Y.lIlllIllllllI("xEPX4VUXYCW4HCFg5YiNog==", "KccfH");
        Y.llIlllllIl[Y.llIlllllll[15]] = Y.lIlllIlllllIl("Ny4NDxIDbzgCBRQsEg==", "qOygw");
        Y.llIlllllIl[Y.llIlllllll[19]] = Y.lIlllIlllllIl("LCUGQQ0NZB4EGgkoEQIcQiMFGA==", "bDpay");
        Y.llIlllllIl[Y.llIlllllll[22]] = Y.lIlllIlllllII("02WjZdAXm0Jx9u6pBp0NiQ==", "nSEuk");
        Y.llIlllllIl[Y.llIlllllll[23]] = Y.lIlllIlllllII("DPHqKFP3b4Y=", "jEyMT");
        Y.llIlllllIl[Y.llIlllllll[24]] = Y.lIlllIllllllI("4WYDwb+Mq+o=", "CrHvp");
        Y.llIlllllIl[Y.llIlllllll[25]] = Y.lIlllIlllllIl("ITQhGA==", "nDDvU");
        Y.llIlllllIl[Y.llIlllllll[26]] = Y.lIlllIllllllI("Ku76wHK5LX8x/1GCsobe/g==", "lcVKU");
        Y.llIlllllIl[Y.llIlllllll[28]] = Y.lIlllIllllllI("LLmPBB5b5HE=", "FJWYP");
        Y.llIlllllIl[Y.llIlllllll[29]] = Y.lIlllIlllllII("eJItOr1jyg+vmzGCJPyskw==", "MDoit");
        Y.llIlllllIl[Y.llIlllllll[30]] = Y.lIlllIlllllIl("Jg4/DQIHATZJDQEJNwAA", "noQin");
        Y.llIlllllIl[Y.llIlllllll[31]] = Y.lIlllIlllllIl("FAcwJRkjETBxEi4NMCU=", "FbCQu");
        Y.llIlllllIl[Y.llIlllllll[32]] = Y.lIlllIlllllII("jBFQROp3zhHjx+9pCx5Iug==", "jYsMf");
        Y.llIlllllIl[Y.llIlllllll[33]] = Y.lIlllIlllllIl("OysoJyAW", "xDNAI");
        Y.llIlllllIl[Y.llIlllllll[34]] = Y.lIlllIllllllI("FCcnLtiwia4=", "LAera");
        Y.llIlllllIl[Y.llIlllllll[35]] = Y.lIlllIllllllI("sldPpH5/T0CaUY+uY0vfQQ==", "oxIPt");
        Y.llIlllllIl[Y.llIlllllll[36]] = Y.lIlllIlllllII("VgBdzpeEdIiBJgssEv2y7g==", "jcUpZ");
        Y.llIlllllIl[Y.llIlllllll[37]] = Y.lIlllIlllllIl("OSQtKSE=", "xHYHS");
        Y.llIlllllIl[Y.llIlllllll[38]] = Y.lIlllIlllllII("t7qQ077w4Bk=", "uCaet");
        Y.llIlllllIl[Y.llIlllllll[39]] = Y.lIlllIlllllIl("FDcQBQ==", "CRqwI");
        Y.llIlllllIl[Y.llIlllllll[40]] = Y.lIlllIlllllII("hGmXUr+vuoRgxFYgUSAr2Q==", "EJWVG");
        Y.llIlllllIl[Y.llIlllllll[41]] = Y.lIlllIllllllI("c2X/K745VSfRWWfJ/cP/FQ==", "IGvKD");
        Y.llIlllllIl[Y.llIlllllll[42]] = Y.lIlllIlllllIl("OyInAj8W", "xMAdV");
        Y.llIlllllIl[Y.llIlllllll[43]] = Y.lIlllIlllllII("bNZoLp5WccQ=", "QFHSj");
        Y.llIlllllIl[Y.llIlllllll[44]] = Y.lIlllIllllllI("n1DjJWRcjEw=", "ZwyFZ");
        Y.llIlllllIl[Y.llIlllllll[45]] = Y.lIlllIlllllIl("EC8AEgxwNE8SEyIrAw==", "WGoax");
        Y.llIlllllIl[Y.llIlllllll[52]] = Y.lIlllIllllllI("bPU11qY55t2Y7676g1KMnqiBQTUYIkAq", "rsSFX");
        Y.llIlllllIl[Y.llIlllllll[53]] = Y.lIlllIlllllIl("KioIBUc3JUYVAjkvEgpHcA==", "XCfbg");
        Y.llIlllllIl[Y.llIlllllll[54]] = Y.lIlllIlllllII("jJNLfVUvdFRFaxq2f+cTjbRR77m7RqZrAiS5NyyR+MQ=", "IRuSe");
        Y.llIlllllIl[Y.llIlllllll[55]] = Y.lIlllIllllllI("2ybdPnbCZi3qRV3nHHYHDLiRv/TAMCcdSpx9uNE4U/n0aNhtBBj+eA==", "OsOYF");
        Y.llIlllllIl[Y.llIlllllll[56]] = Y.lIlllIlllllIl("PiUzJTgdai8nPBc5YTs2BjhhKjwfOmA=", "sJABY");
        Y.llIlllllIl[Y.llIlllllll[57]] = Y.lIlllIlllllII("zkzlQj8HKrU=", "AUbLD");
        Y.llIlllllIl[Y.llIlllllll[58]] = Y.lIlllIlllllII("J8e9bCXlrLrR+2w1zoFUV4lSq+6Ws/gAizbLsMgyjGo=", "KSOZI");
        Y.llIlllllIl[Y.llIlllllll[59]] = Y.lIlllIlllllII("NTQJPR/DTTTYyNuxfRo0n8ZtP3qNP1/f", "bkylc");
        Y.llIlllllIl[Y.llIlllllll[60]] = Y.lIlllIlllllIl("IAAEHQ0UQTEQGgMCG1UbAw8EVQUDQQQaSBIAHB5IEg5QDAcTTw==", "fapuh");
        Y.llIlllllIl[Y.llIlllllll[61]] = Y.lIlllIlllllII("/7BTOVIUWNiQTyYzcLQ5hhJNjp9RsKXqTBpYLAW+zyHsxr0sO/EnRI5N/zc3yknH", "SNHzC");
        Y.llIlllllIl[Y.llIlllllll[62]] = Y.lIlllIllllllI("eUzza8YcjTJoi88sjjd/E4nfyxja0JOJZBFOFviX1F+nrYz0x6271A==", "jziGd");
        Y.llIlllllIl[Y.llIlllllll[63]] = Y.lIlllIllllllI("i6sxVxE8mxk=", "gfHIl");
        Y.llIlllllIl[Y.llIlllllll[64]] = Y.lIlllIlllllII("g6zBKXDST3R35qudQUdPUfYJEKYoLfJ+ytB8Y3ZFcrkXWzcps+0pVw==", "ZVdMn");
        Y.llIlllllIl[Y.llIlllllll[65]] = Y.lIlllIlllllII("StzbRRIJgHfazt4sq6BUkA==", "ObWLy");
        Y.llIlllllIl[Y.llIlllllll[66]] = Y.lIlllIllllllI("564lqPuYKnx3aQg1i3zX0Q==", "lknfs");
    }
    ...
    private static void lIllllIIIIIIl() {
        ...
        Y.llIlllllll[30] = 0x7C ^ 0x6C ^ "   ".length();
        ...
        Y.llIlllllll[59] = 0x77 ^ 0x5F ^ "  ".length();
    ...
    private static String lIlllIlllllII(String lllllllllllllllllIllllllIIllIIII, String lllllllllllllllllIllllllIIllIIIl) {
        try {
            SecretKeySpec lllllllllllllllllIllllllIIllIlIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIllllllIIllIIIl.getBytes(StandardCharsets.UTF_8)), llIlllllll[18]), "DES");
            Cipher lllllllllllllllllIllllllIIllIlII = Cipher.getInstance("DES");
            lllllllllllllllllIllllllIIllIlII.init(llIlllllll[3], lllllllllllllllllIllllllIIllIlIl);
            return new String(lllllllllllllllllIllllllIIllIlII.doFinal(Base64.getDecoder().decode(lllllllllllllllllIllllllIIllIIII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlllIllllllI(String lllllllllllllllllIllllllIIllllIl, String lllllllllllllllllIllllllIIllllII) {
        try {
            SecretKeySpec lllllllllllllllllIllllllIlIIIIlI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIllllllIIllllII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllllIllllllIlIIIIIl = Cipher.getInstance("Blowfish");
            lllllllllllllllllIllllllIlIIIIIl.init(llIlllllll[3], lllllllllllllllllIllllllIlIIIIlI);
            return new String(lllllllllllllllllIllllllIlIIIIIl.doFinal(Base64.getDecoder().decode(lllllllllllllllllIllllllIIllllIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void eq() {
        ...
        if (Y.lIllllIIIIlIl(bt ? 1 : 0)) {
            NPC lllllllllllllllllIllllllIllIIlIl;
            BankLocation lllllllllllllllllIllllllIllIIllI;
            ...
            if (Y.lIllllIIIIlIl(Y.an() ? 1 : 0) && Y.lIllllIIIIlII(e.j(llIlllllll[6]), llIlllllll[1])) {
                lllllllllllllllllIllllllIllIIllI = BankLocation.getNearest();
                if (Y.lIllllIIIlIII(lllllllllllllllllIllllllIllIIllI) && Y.lIllllIIIIlIl(lllllllllllllllllIllllllIllIIllI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderSotf.c = llIlllllIl[llIlllllll[7]];
                    a.a(lllllllllllllllllIllllllIllIIllI);
                    Time.sleepTicks((int)llIlllllll[3]);
                    "".length();
                }
                if (Y.lIllllIIIlIII(lllllllllllllllllIllllllIllIIllI) && Y.lIllllIIIIIll(lllllllllllllllllIllllllIllIIllI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (Y.lIllllIIIIIll(Y.an() ? 1 : 0) && Y.lIllllIIIIlII(e.j(llIlllllll[6]), llIlllllll[1])) {
                lllllllllllllllllIllllllIllIIllI = new WorldArea(llIlllllll[16], llIlllllll[17], llIlllllll[18], llIlllllll[19], llIlllllll[0]);
                String[] stringArray = new String[llIlllllll[1]];
                stringArray[Y.llIlllllll[0]] = llIlllllIl[llIlllllll[20]];
                lllllllllllllllllIllllllIllIIlIl = NPCs.getNearest((String[])stringArray);
                if (Y.lIllllIIIlIIl(lllllllllllllllllIllllllIllIIlIl) && Y.lIllllIIIlIlI(Players.getLocal().getWorldLocation().distanceTo(mz), llIlllllll[5]) && Y.lIllllIIIIlIl(AccBuilderSotf.d ? 1 : 0)) {
                ...
                if (Y.lIllllIIIlIII(lllllllllllllllllIllllllIllIIlIl)) {
            ...
            if (Y.lIllllIIIlIll(e.j(llIlllllll[6]), llIlllllll[1])) {
                ...
                if (Y.lIllllIIIllII(Players.getLocal().getWorldLocation().distanceTo(mA), llIlllllll[14])) {
                    ...
                    lllllllllllllllllIllllllIllIIllI = TileObjects.getNearest((String[])stringArray);
                    if (Y.lIllllIIIlIII(lllllllllllllllllIllllllIllIIllI)) {
                        String[] stringArray2 = new String[llIlllllll[1]];
                        stringArray2[Y.llIlllllll[0]] = llIlllllIl[llIlllllll[24]];
                        if (Y.lIllllIIIIIll(lllllllllllllllllIllllllIllIIllI.hasAction(stringArray2) ? 1 : 0)) {
                            lllllllllllllllllIllllllIllIIllI.interact(llIlllllIl[llIlllllll[25]]);
            ...
            if (Y.lIllllIIIlIll(e.j(llIlllllll[6]), llIlllllll[3])) {
                ...
                if (Y.lIllllIIIllII(Players.getLocal().getWorldLocation().distanceTo(mB), llIlllllll[3])) {
                    ...
                    lllllllllllllllllIllllllIllIIllI = NPCs.getNearest((String[])stringArray);
                    if (Y.lIllllIIIlIII(lllllllllllllllllIllllllIllIIllI)) {
                        g.a(llIlllllIl[llIlllllll[32]], my);
                    }
                    if (Y.lIllllIIIlIIl(lllllllllllllllllIllllllIllIIllI)) {
            ...
            if (Y.lIllllIIIlIll(e.j(llIlllllll[6]), llIlllllll[5])) {
                ...
                if (Y.lIllllIIIllII(Players.getLocal().getWorldLocation().distanceTo(mC), llIlllllll[5])) {
                    ...
                    lllllllllllllllllIllllllIllIIllI = TileObjects.getNearest((String[])stringArray);
                    if (Y.lIllllIIIlIII(lllllllllllllllllIllllllIllIIllI)) {
                        lllllllllllllllllIllllllIllIIllI.interact(llIlllllIl[llIlllllll[38]]);
                    }
                }
            }
            if (Y.lIllllIIIlIll(e.j(llIlllllll[6]), llIlllllll[7])) {
                ...
                if (Y.lIllllIIIllII(Players.getLocal().getWorldLocation().distanceTo(mB), llIlllllll[3])) {
                    ...
                    if (Y.lIllllIIIlIII(lllllllllllllllllIllllllIllIIllI)) {
                        ...
                        if (Y.lIllllIIIIIll(lllllllllllllllllIllllllIllIIllI.hasAction(stringArray4) ? 1 : 0)) {
                            lllllllllllllllllIllllllIllIIllI.interact(llIlllllIl[llIlllllll[44]]);
                            Time.sleepTicks((int)llIlllllll[3]);
                            "".length();
                        }
                        String[] stringArray5 = new String[llIlllllll[1]];
                        stringArray5[Y.llIlllllll[0]] = llIlllllIl[llIlllllll[45]];
                        lllllllllllllllllIllllllIllIIlIl = Inventory.getFirst((String[])stringArray5);
                        if (Y.lIllllIIIlIII(lllllllllllllllllIllllllIllIIlIl)) {
                            ...
                            lllllllllllllllllIllllllIllIIlIl.useOn((TileObject)lllllllllllllllllIllllllIllIIllI);
    ...
    private static String lIlllIlllllIl(String lllllllllllllllllIllllllIlIIllll, String lllllllllllllllllIllllllIlIlIIll) {
        lllllllllllllllllIllllllIlIIllll = new String(Base64.getDecoder().decode(lllllllllllllllllIllllllIlIIllll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllIllllllIlIlIIlI = new StringBuilder();
        char[] lllllllllllllllllIllllllIlIlIIIl = lllllllllllllllllIllllllIlIlIIll.toCharArray();
        int lllllllllllllllllIllllllIlIlIIII = llIlllllll[0];
        char[] lllllllllllllllllIllllllIlIIlIlI = lllllllllllllllllIllllllIlIIllll.toCharArray();
        int lllllllllllllllllIllllllIlIIlIIl = lllllllllllllllllIllllllIlIIlIlI.length;
        int lllllllllllllllllIllllllIlIIlIII = llIlllllll[0];
        while (Y.lIllllIIIIlII(lllllllllllllllllIllllllIlIIlIII, lllllllllllllllllIllllllIlIIlIIl)) {
            char lllllllllllllllllIllllllIlIlIlIl = lllllllllllllllllIllllllIlIIlIlI[lllllllllllllllllIllllllIlIIlIII];
            lllllllllllllllllIllllllIlIlIIlI.append((char)(lllllllllllllllllIllllllIlIlIlIl ^ lllllllllllllllllIllllllIlIlIIIl[lllllllllllllllllIllllllIlIlIIII % lllllllllllllllllIllllllIlIlIIIl.length]));
            "".length();
            ++lllllllllllllllllIllllllIlIlIIII;
            ++lllllllllllllllllIllllllIlIIlIII;
            "".length();
    ...
    private static void Q() {
        d lllllllllllllllllIllllllIllIIIIl;
        Object lllllllllllllllllIllllllIllIIIlI;
        int[] nArray = new int[llIlllllll[1]];
        nArray[Y.llIlllllll[0]] = llIlllllll[10];
        ...
        if (Y.lIllllIIIIlIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lllllllllllllllllIllllllIllIIIlI = new d(llIlllllll[4], llIlllllll[15], llIlllllll[47]);
            bv.add((d)lllllllllllllllllIllllllIllIIIlI);
            "".length();
        }
        if (Y.lIllllIIIIlIl(Bank.contains(lllllllllllllllllIllllllIllIIIlI = item -> item.getName().toLowerCase().contains(llIlllllIl[llIlllllll[53]])) ? 1 : 0)) {
            lllllllllllllllllIllllllIllIIIIl = new d(llIlllllll[48], llIlllllll[8], llIlllllll[49]);
            bv.add(lllllllllllllllllIllllllIllIIIIl);
            "".length();
        }
        int[] nArray3 = new int[llIlllllll[1]];
        nArray3[Y.llIlllllll[0]] = llIlllllll[11];
        if (Y.lIllllIIIIlIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllllIllllllIllIIIIl = new d(llIlllllll[11], llIlllllll[15], llIlllllll[50]);
            bv.add(lllllllllllllllllIllllllIllIIIIl);
            "".length();
        }
        int[] nArray4 = new int[llIlllllll[1]];
        ...
        if (Y.lIllllIIIIlIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllllIllllllIllIIIIl = new d(llIlllllll[13], llIlllllll[31], llIlllllll[50]);
            bv.add(lllllllllllllllllIllllllIllIIIIl);
            "".length();
        }
        ...
        if (Y.lIllllIIIIlIl(Bank.contains((int[])nArray5) ? 1 : 0)) {
            lllllllllllllllllIllllllIllIIIIl = new d(llIlllllll[12], llIlllllll[8], j.cf);
            bv.add(lllllllllllllllllIllllllIllIIIIl);
            "".length();
        }
    }
