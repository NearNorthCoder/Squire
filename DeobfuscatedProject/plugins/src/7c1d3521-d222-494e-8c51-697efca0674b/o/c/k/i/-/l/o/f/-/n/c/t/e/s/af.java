...
implements ac {
    ...
    private static void lIlIIllIIlIII() {
        ...
        af.llIIIlIlll[af.llIIIllIIl[0]] = af.lIlIIllIIIlII("JjINMBQDZx0tHwk0", "dGtYz");
        af.llIIIlIlll[af.llIIIllIIl[1]] = af.lIlIIllIIIlII("Cw4aPTslAhB0KjgeHTovbQ4AMSU+S1QnPyQTFzwhIwBUNikuDFQgJ20EGzo7ORUBNzwkCBo=", "MgtTH");
        af.llIIIlIlll[af.llIIIllIIl[3]] = af.lIlIIllIIIlIl("vjroXiunrQmqFOX8kkZ3WxElh2gFTSnT", "NsBdj");
        af.llIIIlIlll[af.llIIIllIIl[4]] = af.lIlIIllIIIlII("Di8mLjQobgI7Kj4=", "MNUZX");
        af.llIIIlIlll[af.llIIIllIIl[6]] = af.lIlIIllIIIlIl("3aK8ICWtCFw=", "jlJiG");
        af.llIIIlIlll[af.llIIIllIIl[2]] = af.lIlIIllIIIllI("kq9i6zfZsoFLBBOv63X/niNX9t9UtCDO", "Qcwnm");
        af.llIIIlIlll[af.llIIIllIIl[9]] = af.lIlIIllIIIlIl("GI8YITWtc8OlYlf7wkXfktXnkooZi9IlDYOt6oHiVQIiGIUYQuAHPgWJRUJ8aWeQ", "FfKYL");
        af.llIIIlIlll[af.llIIIllIIl[11]] = af.lIlIIllIIIlIl("tYSwIA6ehEymDeCTH8FUclABMwDU7jcE/VbmYaX+gD7Y71or36vCOA==", "IHOcB");
        af.llIIIlIlll[af.llIIIllIIl[13]] = af.lIlIIllIIIllI("IOCobeTP5tyaeNvbKJnbXj9y/Gtn+eUAIjwaWhoxQq/lprHvUHJWuMqyeUZNY8rV", "mJSHl");
        af.llIIIlIlll[af.llIIIllIIl[15]] = af.lIlIIllIIIlIl("4lOhFh5kbf100o0YZ0n1AX4IEiljiClWneJM0SJPXvD3qZsfrnZex6YRr9XR95Tj", "LsRip");
        af.llIIIlIlll[af.llIIIllIIl[18]] = af.lIlIIllIIIlII("PzdaMSMNchc5Ihs7FDdxBjMTPCJEcgknOBwxEjk/D3IOP3EqByMZHy8=", "hRzPQ");
        af.llIIIlIlll[af.llIIIllIIl[20]] = af.lIlIIllIIIlII("BS5WNxM3axs/EiEiGDFBIicXOAp+awUhCCYoHj8PNWsCOUEQHi8fLxU=", "RKvVa");
        af.llIIIlIlll[af.llIIIllIIl[22]] = af.lIlIIllIIIllI("Xmu05fMn9LV8lquCv2VLrB2+w973gdbU6pfrAfyw5r6pTjiFLQ5mJNghaXFrRl67", "wbFjo");
        af.llIIIlIlll[af.llIIIllIIl[29]] = af.lIlIIllIIIllI("dlLm5vBbIyQHJqcJ8fmfhQ==", "yIoHu");
        af.llIIIlIlll[af.llIIIllIIl[30]] = af.lIlIIllIIIllI("0Nil+79PsXQ=", "zYRhC");
        af.llIIIlIlll[af.llIIIllIIl[32]] = af.lIlIIllIIIllI("ndRoPMhn2zXD4jNmlRxV9uEbYm/gGDf5", "GAQsQ");
        af.llIIIlIlll[af.llIIIllIIl[33]] = af.lIlIIllIIIlII("NgEeTBEbARQJ", "ttgly");
        af.llIIIlIlll[af.llIIIllIIl[34]] = af.lIlIIllIIIllI("dhIwdy+uRZPAHdn11jurEw==", "GiYeG");
        af.llIIIlIlll[af.llIIIllIIl[36]] = af.lIlIIllIIIllI("Ogz2Dk/q0qTBaoBaawj3iA==", "QtQpR");
        af.llIIIlIlll[af.llIIIllIIl[37]] = af.lIlIIllIIIlII("JiEYDgVEOR4GBA==", "dTqba");
        af.llIIIlIlll[af.llIIIllIIl[39]] = af.lIlIIllIIIllI("KZcNMtyuM0tfvH2gyBai5A==", "EKlTd");
        af.llIIIlIlll[af.llIIIllIIl[40]] = af.lIlIIllIIIllI("jFxpLBBbDRc=", "QrqKj");
        af.llIIIlIlll[af.llIIIllIIl[41]] = af.lIlIIllIIIlIl("BGUtKHMDkIKZKuakvixEF1Zps7nTWf47", "vYqcF");
        af.llIIIlIlll[af.llIIIllIIl[16]] = af.lIlIIllIIIlII("NSs5", "lNJan");
        af.llIIIlIlll[af.llIIIllIIl[43]] = af.lIlIIllIIIlIl("bVwVZiDWiRg6fNh1LygVSA==", "YTdsZ");
        af.llIIIlIlll[af.llIIIllIIl[46]] = af.lIlIIllIIIlIl("xMXT9zx1/hQ=", "zFKln");
        af.llIIIlIlll[af.llIIIllIIl[48]] = af.lIlIIllIIIlII("Fg48OzgtBTY=", "DkQTN");
        af.llIIIlIlll[af.llIIIllIIl[49]] = af.lIlIIllIIIllI("wI84a/lcPHw=", "WGfxN");
        af.llIIIlIlll[af.llIIIllIIl[27]] = af.lIlIIllIIIlIl("K4VhEUm9xuk=", "DnBdc");
        af.llIIIlIlll[af.llIIIllIIl[51]] = af.lIlIIllIIIllI("wFjSEAsAZk4Y1285MYn8KyqtKIP8LUvA", "YnkDS");
        af.llIIIlIlll[af.llIIIllIIl[53]] = af.lIlIIllIIIlII("OiYcNSo=", "xSuYN");
        af.llIIIlIlll[af.llIIIllIIl[55]] = af.lIlIIllIIIlIl("eXsw6mzX2Lf05yMmhakHRw==", "TzCKG");
        af.llIIIlIlll[af.llIIIllIIl[56]] = af.lIlIIllIIIllI("WXa2IfpB7lM=", "AJpxV");
        af.llIIIlIlll[af.llIIIllIIl[57]] = af.lIlIIllIIIllI("Kxed+fc7+zw=", "ynCLv");
        af.llIIIlIlll[af.llIIIllIIl[58]] = af.lIlIIllIIIlII("IxogHzBBACgYdBUOKx8x", "aoIsT");
        af.llIIIlIlll[af.llIIIllIIl[61]] = af.lIlIIllIIIlIl("cJywknbbUUw=", "KSWLP");
        af.llIIIlIlll[af.llIIIllIIl[63]] = af.lIlIIllIIIlII("NQQPATgODwU=", "gabnN");
        af.llIIIlIlll[af.llIIIllIIl[64]] = af.lIlIIllIIIlIl("B6xRUDmeWss=", "lMASP");
        af.llIIIlIlll[af.llIIIllIIl[65]] = af.lIlIIllIIIllI("TuLm4u6qqMM=", "lCEeZ");
        af.llIIIlIlll[af.llIIIllIIl[66]] = af.lIlIIllIIIllI("M7Ri5f+ORhb4nL6GaiNV8x9LrVcSXcyG", "iRmPV");
        af.llIIIlIlll[af.llIIIllIIl[67]] = af.lIlIIllIIIlIl("3kXGoXubfCY=", "XojRo");
        af.llIIIlIlll[af.llIIIllIIl[68]] = af.lIlIIllIIIlII("CyM7ISc=", "IVRMC");
        af.llIIIlIlll[af.llIIIllIIl[70]] = af.lIlIIllIIIlII("EzA5CQUoOzM=", "AUTfs");
        af.llIIIlIlll[af.llIIIllIIl[71]] = af.lIlIIllIIIlIl("cRVK1QmWEJo=", "PiPSp");
        af.llIIIlIlll[af.llIIIllIIl[72]] = af.lIlIIllIIIlII("CRA3", "PuDYI");
        af.llIIIlIlll[af.llIIIllIIl[73]] = af.lIlIIllIIIlII("BCElJCMvOitoNSk7ITs=", "FTLHG");
        af.llIIIlIlll[af.llIIIllIIl[77]] = af.lIlIIllIIIlIl("D2VLbg99QLe5Z9S73O/0KRKDLOMk80gP", "sDjfa");
        af.llIIIlIlll[af.llIIIllIIl[79]] = af.lIlIIllIIIllI("LugoK2dcgCA=", "jJmrI");
        af.llIIIlIlll[af.llIIIllIIl[81]] = af.lIlIIllIIIlIl("TRdyo62kiDo=", "YkThG");
        af.llIIIlIlll[af.llIIIllIIl[83]] = af.lIlIIllIIIllI("f1Cb86l++zo46fb/+/MwKQ==", "SvkBi");
        af.llIIIlIlll[af.llIIIllIIl[84]] = af.lIlIIllIIIllI("0o0gozSr7w0=", "lPQUK");
        af.llIIIlIlll[af.llIIIllIIl[85]] = af.lIlIIllIIIllI("dLoTTzr7M1A=", "VNWsp");
        af.llIIIlIlll[af.llIIIllIIl[87]] = af.lIlIIllIIIllI("xh6EKxI2rMzusdpbbBc/IZmofNsZR35P", "RPAnP");
        af.llIIIlIlll[af.llIIIllIIl[88]] = af.lIlIIllIIIlIl("HrH4/CdPhOA=", "kGElh");
        af.llIIIlIlll[af.llIIIllIIl[89]] = af.lIlIIllIIIlIl("gS/7/EbSYtj85avDiKX4jaWKk1MNXbMR", "GNCCR");
        af.llIIIlIlll[af.llIIIllIIl[90]] = af.lIlIIllIIIlIl("U/ZdD1N8ucs=", "MuIlS");
        af.llIIIlIlll[af.llIIIllIIl[91]] = af.lIlIIllIIIlIl("s6qLN7Gir18=", "UNkDc");
        af.llIIIlIlll[af.llIIIllIIl[93]] = af.lIlIIllIIIllI("AcViNTWjdysMAR1p+93/cQ==", "LGuEt");
        af.llIIIlIlll[af.llIIIllIIl[94]] = af.lIlIIllIIIllI("rsWvv+imvANiru3l7iprnQ==", "DvyXD");
        af.llIIIlIlll[af.llIIIllIIl[95]] = af.lIlIIllIIIlII("ISsKDg==", "eDdkR");
        af.llIIIlIlll[af.llIIIllIIl[96]] = af.lIlIIllIIIlII("FiEUBzcwPEwKLzotCh4qJis=", "UNaiC");
        af.llIIIlIlll[af.llIIIllIIl[97]] = af.lIlIIllIIIllI("htD7+cOuNfY=", "KTkxg");
        af.llIIIlIlll[af.llIIIllIIl[86]] = af.lIlIIllIIIllI("bDvEulic2Eo=", "egSBK");
        af.llIIIlIlll[af.llIIIllIIl[98]] = af.lIlIIllIIIlII("FB0JJ3YKGxkjM2I7HCQ/LRof", "BtlPV");
        af.llIIIlIlll[af.llIIIllIIl[99]] = af.lIlIIllIIIlII("DAA=", "CnhWI");
        af.llIIIlIlll[af.llIIIllIIl[80]] = af.lIlIIllIIIlII("ITE1CXAGIjMLIw==", "hCZgP");
        af.llIIIlIlll[af.llIIIllIIl[104]] = af.lIlIIllIIIlIl("QmRBU9V7g1Li0opgPd2M1F9HQghKvIbp", "jVgLf");
        af.llIIIlIlll[af.llIIIllIIl[105]] = af.lIlIIllIIIlIl("xcTrJpxM/6Y=", "EksyA");
        af.llIIIlIlll[af.llIIIllIIl[106]] = af.lIlIIllIIIlII("ACAkJzY6", "HAIJS");
        af.llIIIlIlll[af.llIIIllIIl[107]] = af.lIlIIllIIIlII("OxUTKT0=", "kyrGV");
        af.llIIIlIlll[af.llIIIllIIl[108]] = af.lIlIIllIIIllI("jfAxLOhS6ww=", "YnUNa");
        af.llIIIlIlll[af.llIIIllIIl[109]] = af.lIlIIllIIIlIl("F3Oo9XFIPfBX3Uobe5Jlug==", "LiVNM");
        af.llIIIlIlll[af.llIIIllIIl[110]] = af.lIlIIllIIIllI("ydCQVCGlqmHZrzF2uemUrox8upFMIg8u", "ulhPb");
        af.llIIIlIlll[af.llIIIllIIl[111]] = af.lIlIIllIIIlII("FiQA", "EEwHz");
        af.llIIIlIlll[af.llIIIllIIl[112]] = af.lIlIIllIIIlII("IRcpKwkb", "ivDFl");
        af.llIIIlIlll[af.llIIIllIIl[113]] = af.lIlIIllIIIllI("IHFgkg+p1XM=", "MWGYC");
        af.llIIIlIlll[af.llIIIllIIl[114]] = af.lIlIIllIIIlIl("gIVX5HHLxVg=", "KFHlS");
        af.llIIIlIlll[af.llIIIllIIl[115]] = af.lIlIIllIIIlII("HAcFKx0nEB1uGSdCASEYOwc=", "HbiNm");
        af.llIIIlIlll[af.llIIIllIIl[116]] = af.lIlIIllIIIllI("zSnDph4GDmU=", "QwxfQ");
        af.llIIIlIlll[af.llIIIllIIl[117]] = af.lIlIIllIIIlII("OwQvBBIB", "seBiw");
        af.llIIIlIlll[af.llIIIllIIl[118]] = af.lIlIIllIIIlIl("8N/KAtovqPPbSV+cGPMc/+MvBOxG0vT/", "pncma");
        af.llIIIlIlll[af.llIIIllIIl[119]] = af.lIlIIllIIIlII("HQMb", "Nbldm");
        af.llIIIlIlll[af.llIIIllIIl[120]] = af.lIlIIllIIIlII("GgQqKiog", "ReGGO");
        af.llIIIlIlll[af.llIIIllIIl[92]] = af.lIlIIllIIIllI("0y42fj2sVnivsPtJOMltqg==", "JsLuG");
        af.llIIIlIlll[af.llIIIllIIl[134]] = af.lIlIIllIIIllI("tEScSfUBRtzjEyiSPYP4mJZEJ9gygjys", "ZeWPN");
        af.llIIIlIlll[af.llIIIllIIl[135]] = af.lIlIIllIIIlII("Cz0vI1cWMmEgAhw4KCoQUQ==", "yTADw");
        af.llIIIlIlll[af.llIIIllIIl[136]] = af.lIlIIllIIIllI("R7oTPSaHIDmd0PodqqBQ/05DklMqezaD", "WKRxL");
        af.llIIIlIlll[af.llIIIllIIl[139]] = af.lIlIIllIIIlIl("mbjEhaFXfbkrjMWAhveN/yFE2trsvc9p", "RjRnc");
        af.llIIIlIlll[af.llIIIllIIl[140]] = af.lIlIIllIIIlII("AQI+Wio0AiwJP3k=", "XgMzZ");
    }

    private static String lIlIIllIIIlII(String llllllllllllllllllIlIlIlllIIIllI, String llllllllllllllllllIlIlIlllIIIIII) {
        llllllllllllllllllIlIlIlllIIIllI = new String(Base64.getDecoder().decode(llllllllllllllllllIlIlIlllIIIllI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllIlIlIlllIIIlII = new StringBuilder();
        char[] llllllllllllllllllIlIlIlllIIIIll = llllllllllllllllllIlIlIlllIIIIII.toCharArray();
        int llllllllllllllllllIlIlIlllIIIIlI = llIIIllIIl[0];
        char[] llllllllllllllllllIlIlIllIllllII = llllllllllllllllllIlIlIlllIIIllI.toCharArray();
        int llllllllllllllllllIlIlIllIlllIll = llllllllllllllllllIlIlIllIllllII.length;
        int llllllllllllllllllIlIlIllIlllIlI = llIIIllIIl[0];
        while (af.lIlIIllIIlllI(llllllllllllllllllIlIlIllIlllIlI, llllllllllllllllllIlIlIllIlllIll)) {
            char llllllllllllllllllIlIlIlllIIIlll = llllllllllllllllllIlIlIllIllllII[llllllllllllllllllIlIlIllIlllIlI];
            llllllllllllllllllIlIlIlllIIIlII.append((char)(llllllllllllllllllIlIlIlllIIIlll ^ llllllllllllllllllIlIlIlllIIIIll[llllllllllllllllllIlIlIlllIIIIlI % llllllllllllllllllIlIlIlllIIIIll.length]));
            "".length();
            ++llllllllllllllllllIlIlIlllIIIIlI;
            ++llllllllllllllllllIlIlIllIlllIlI;
            "".length();
            if (((0x5B ^ 1) & ~(0xEB ^ 0xB1)) != (0xB0 ^ 0xB4)) continue;
            return null;
        }
        return String.valueOf(llllllllllllllllllIlIlIlllIIIlII);
    }

    private static void lIlIIllIIlIll() {
        llIIIllIIl = new int[142];
        af.llIIIllIIl[0] = (0x1B ^ 0x41) & ~(0xDA ^ 0x80);
        af.llIIIllIIl[1] = " ".length();
        af.llIIIllIIl[2] = 0x2C ^ 8 ^ (0x36 ^ 0x17);
        af.llIIIllIIl[3] = "  ".length();
        af.llIIIllIIl[4] = "   ".length();
        ...
        af.llIIIllIIl[33] = "  ".length() ^ (0x72 ^ 0x60);
        ...
        af.llIIIllIIl[111] = "  ".length() ^ (7 ^ 0x4C);
        ...
        af.llIIIllIIl[120] = "  ".length() ^ (0xC4 ^ 0x94);
    ...
    public static void eH() {
        block39: {
            BankLocation llllllllllllllllllIlIlllIIIIllII;
            block40: {
                block41: {
                    block42: {
                        Predicate<Item> llllllllllllllllllIlIlllIIIIlIll;
                        ...
                        llllllllllllllllllIlIlllIIIIllII = BankLocation.getNearest();
                        if (af.lIlIIllIlIIlI(llllllllllllllllllIlIlllIIIIllII) && af.lIlIIllIlIIII(llllllllllllllllllIlIlllIIIIllII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            if (af.lIlIIllIIllIl(Equipment.contains((int[])f.aS) ? 1 : 0)) {
                                ...
                                Time.sleepUntil(() -> {
                                    ...
                                    if (af.lIlIIllIlllIl(TileObjects.getNearest((int[])nArray))) {
                                        ...
                                        "".length();
                                        if (-" ".length() >= 0) {
                                            return ((0x5E ^ 7 ^ (0x7F ^ 0x23)) & (0x4E ^ 0x19 ^ (0xC0 ^ 0x92) ^ -" ".length())) != 0;
                                        }
                                    } else {
                                        bl = llIIIllIIl[0];
                                    }
                            ...
                            if (af.lIlIIllIlIIII(Equipment.contains((int[])f.aS) ? 1 : 0) && af.lIlIIllIlIIII(Inventory.contains((int[])f.aS) ? 1 : 0)) {
                                a.a(llllllllllllllllllIlIlllIIIIllII);
                                Time.sleepTicks((int)llIIIllIIl[1]);
                                "".length();
                            }
                        }
                        if (!af.lIlIIllIlIIlI(llllllllllllllllllIlIlllIIIIllII) || !af.lIlIIllIIllIl(llllllllllllllllllIlIlllIIIIllII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block40;
                        ...
                        if (af.lIlIIllIlIIII(Bank.contains(llllllllllllllllllIlIlllIIIIlIll = item -> item.getName().toLowerCase().contains(llIIIlIlll[llIIIllIIl[136]])) ? 1 : 0)) {
                            af.Q();
            ...
            if (af.lIlIIllIIllIl(af.an() ? 1 : 0)) {
                ...
                if (af.lIlIIllIIllIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    if (af.lIlIIllIlIIII(Equipment.contains((int[])nArray10) ? 1 : 0)) {
                        ...
                        llllllllllllllllllIlIlllIIIIllII = Inventory.getFirst((int[])nArray11);
                        if (af.lIlIIllIlIIlI(llllllllllllllllllIlIlllIIIIllII)) {
                            llllllllllllllllllIlIlllIIIIllII.interact(llIIIlIlll[llIIIllIIl[30]]);
                    ...
                    if (af.lIlIIllIlIIlI(TileObjects.getNearest((int[])nArray12))) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (af.lIlIIllIlIIlI(TileObjects.getNearest((int[])nArray))) {
                                bl = llIIIllIIl[1];
                                "".length();
                                if (((0xAC ^ 0xC2 ^ (0x57 ^ 0x34)) & (0x7B ^ 0x65 ^ (0xB6 ^ 0xA5) ^ -" ".length())) < 0) {
                                    return ((15 + 73 - -61 + 103 ^ 156 + 158 - 257 + 139) & ("   ".length() ^ (0x84 ^ 0xBF) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIIIllIIl[0];
                            }
    ...
    static boolean eM() {
        ...
        if (af.lIlIIllIlIIlI(TileObjects.getNearest((int[])nArray))) {
            ...
            "".length();
            if (null != null) {
                return ((224 + 26 - 158 + 135 ^ 92 + 145 - 201 + 133) & (9 + 113 - 21 + 92 ^ 98 + 38 - 28 + 31 ^ -" ".length())) != 0;
            }
        } else {
            bl = llIIIllIIl[0];
        }
    ...
    static boolean eN() {
        ...
        if (af.lIlIIllIlIIlI(TileObjects.getNearest((int[])nArray))) {
            ...
            if (af.lIlIIllIlIIlI(TileObjects.getNearest((int[])nArray2))) {
                ...
                return ((0x31 ^ 0x7B ^ (0xAC ^ 0xB6)) & (0x7C ^ 0x18 ^ (0x61 ^ 0x55) ^ -" ".length())) != 0;
            }
        }
        n2 = llIIIllIIl[0];
        return n2 != 0;
    ...
    private static void Q() {
        d llllllllllllllllllIlIlllIIIIIIll;
        Object llllllllllllllllllIlIlllIIIIIlII;
        Object llllllllllllllllllIlIlllIIIIIlIl;
        block24: {
            block23: {
                block21: {
                    block22: {
                        block17: {
                            block20: {
                                block19: {
                                    ...
                                    llllllllllllllllllIlIlllIIIIIlIl = new d(llIIIllIIl[19], llIIIllIIl[121], e.c(llIIIllIIl[122], llIIIllIIl[123]));
                                    bv.add((d)llllllllllllllllllIlIlllIIIIIlIl);
                                    "".length();
                                }
                                int[] nArray = new int[llIIIllIIl[1]];
                            ...
                            llllllllllllllllllIlIlllIIIIIlIl = new d(llIIIllIIl[17], llIIIllIIl[23], llIIIllIIl[67]);
                            bv.add((d)llllllllllllllllllIlIlllIIIIIlIl);
                            "".length();
                        }
                    ...
                    llllllllllllllllllIlIlllIIIIIlIl = new d(llIIIllIIl[21], llIIIllIIl[124], llIIIllIIl[125]);
                    bv.add((d)llllllllllllllllllIlIlllIIIIIlIl);
                    "".length();
                }
                int[] nArray = new int[llIIIllIIl[1]];
            ...
            llllllllllllllllllIlIlllIIIIIlIl = new d(llIIIllIIl[14], llIIIllIIl[126], llIIIllIIl[127]);
            bv.add((d)llllllllllllllllllIlIlllIIIIIlIl);
            "".length();
        }
        int[] nArray = new int[llIIIllIIl[1]];
        ...
        if (af.lIlIIllIlIIII(Bank.contains((int[])nArray) ? 1 : 0)) {
            llllllllllllllllllIlIlllIIIIIlIl = new d(llIIIllIIl[12], llIIIllIIl[1], llIIIllIIl[128]);
            bv.add((d)llllllllllllllllllIlIlllIIIIIlIl);
            "".length();
        }
        int[] nArray10 = new int[llIIIllIIl[1]];
        ...
        if (af.lIlIIllIlIIII(Bank.contains((int[])nArray10) ? 1 : 0)) {
            llllllllllllllllllIlIlllIIIIIlIl = new d(llIIIllIIl[10], llIIIllIIl[1], llIIIllIIl[128]);
            bv.add((d)llllllllllllllllllIlIlllIIIIIlIl);
            "".length();
        }
        if (af.lIlIIllIlIIII(Bank.contains((Predicate)(llllllllllllllllllIlIlllIIIIIlIl = item -> item.getName().toLowerCase().contains(llIIIlIlll[llIIIllIIl[135]]))) ? 1 : 0)) {
            llllllllllllllllllIlIlllIIIIIlII = new d(llIIIllIIl[28], llIIIllIIl[39], llIIIllIIl[129]);
            bv.add((d)llllllllllllllllllIlIlllIIIIIlII);
            "".length();
        }
        if (af.lIlIIllIlIIII(Bank.contains(llllllllllllllllllIlIlllIIIIIlII = item -> item.getName().toLowerCase().contains(llIIIlIlll[llIIIllIIl[134]])) ? 1 : 0)) {
            llllllllllllllllllIlIlllIIIIIIll = new d(llIIIllIIl[130], llIIIllIIl[3], llIIIllIIl[26]);
            bv.add(llllllllllllllllllIlIlllIIIIIIll);
            "".length();
        }
        int[] nArray11 = new int[llIIIllIIl[1]];
        nArray11[af.llIIIllIIl[0]] = llIIIllIIl[131];
        if (af.lIlIIllIlIIII(Bank.contains((int[])nArray11) ? 1 : 0)) {
            llllllllllllllllllIlIlllIIIIIIll = new d(llIIIllIIl[131], llIIIllIIl[67], llIIIllIIl[132]);
            bv.add(llllllllllllllllllIlIlllIIIIIIll);
            "".length();
        }
    }
    ...
    private static void eI() {
        Widget llllllllllllllllllIlIlllIIIIlIIl;
                ...
                if (af.lIlIIllIlIIII(Widgets.get((int)llIIIllIIl[44]).isEmpty() ? 1 : 0) && af.lIlIIllIlIIlI(widget = Widgets.get((int)llIIIllIIl[44], (int)llIIIllIIl[6]))) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (af.lIlIIllIlIIlI(TileObjects.getNearest((int[])nArray))) {
                            bl = llIIIllIIl[1];
                            "".length();
                            if (((0xA5 ^ 0xC0 ^ (0x24 ^ 0xA)) & (115 + 12 - 64 + 176 ^ 109 + 6 - 14 + 63 ^ -" ".length())) != 0) {
                                return ((0xD1 ^ 0x92 ^ (0x44 ^ 0x1D)) & (97 + 92 - 152 + 186 ^ 133 + 149 - 246 + 161 ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = llIIIllIIl[0];
                        }
        ...
        if (af.lIlIIllIllIII(Skills.getLevel((Skill)Skill.CONSTRUCTION), llIIIllIIl[18]) && af.lIlIIllIIlllI(Skills.getLevel((Skill)Skill.CONSTRUCTION), llIIIllIIl[16]) && af.lIlIIllIIllIl(af.eN() ? 1 : 0)) {
            ...
            if (af.lIlIIllIlIIlI(TileObjects.getNearest((int[])nArray))) {
                ...
                if (af.lIlIIllIlIIII(Widgets.get((int)llIIIllIIl[44]).isEmpty() ? 1 : 0) && af.lIlIIllIlIIlI(llllllllllllllllllIlIlllIIIIlIIl = Widgets.get((int)llIIIllIIl[44], (int)llIIIllIIl[6]))) {
                    Mouse.click((int)llllllllllllllllllIlIlllIIIIlIIl.getChild(llIIIllIIl[9]).getClickPoint().getX(), (int)llllllllllllllllllIlIlllIIIIlIIl.getChild(llIIIllIIl[9]).getClickPoint().getY(), (boolean)llIIIllIIl[1]);
                    Time.sleepUntil(() -> {
                        boolean bl;
                        int[] nArray = new int[llIIIllIIl[1]];
                        nArray[af.llIIIllIIl[0]] = llIIIllIIl[50];
        ...
        if (af.lIlIIllIllIII(Skills.getLevel((Skill)Skill.CONSTRUCTION), llIIIllIIl[16]) && af.lIlIIllIIlllI(Skills.getLevel((Skill)Skill.CONSTRUCTION), llIIIllIIl[57]) && af.lIlIIllIIllIl(af.eN() ? 1 : 0)) {
            ...
            if (af.lIlIIllIlIIlI(TileObjects.getNearest((int[])nArray))) {
                if (af.lIlIIllIlIIII(Widgets.get((int)llIIIllIIl[44]).isEmpty() ? 1 : 0) && af.lIlIIllIlIIlI(llllllllllllllllllIlIlllIIIIlIIl = Widgets.get((int)llIIIllIIl[44], (int)llIIIllIIl[2]))) {
                    Mouse.click((int)llllllllllllllllllIlIlllIIIIlIIl.getChild(llIIIllIIl[6]).getClickPoint().getX(), (int)llllllllllllllllllIlIlllIIIIlIIl.getChild(llIIIllIIl[6]).getClickPoint().getY(), (boolean)llIIIllIIl[1]);
                    Time.sleepUntil(() -> {
                        boolean bl;
                        int[] nArray = new int[llIIIllIIl[1]];
                    ...
                    if (af.lIlIIllIlIIlI(TileObjects.getNearest((int[])nArray10))) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (af.lIlIIllIlIIII(Widgets.get((int)llIIIllIIl[44]).isEmpty() ? 1 : 0)) {
                                ...
                                "".length();
                                if ("   ".length() != "   ".length()) {
                                    return ((0xB1 ^ 0x94 ^ (0x2E ^ 0x5C)) & (156 + 101 - 62 + 51 ^ 53 + 64 - 76 + 120 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIIIllIIl[0];
                            }
                    ...
                    if (af.lIlIIllIlIIlI(TileObjects.getNearest((int[])nArray16))) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (af.lIlIIllIlIIII(Widgets.get((int)llIIIllIIl[44]).isEmpty() ? 1 : 0)) {
                                ...
                                "".length();
                                if (" ".length() > " ".length()) {
                                    return ((0x5C ^ 0x2D ^ (0xDD ^ 0xA7)) & (0x5D ^ 0x41 ^ (0x67 ^ 0x70) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIIIllIIl[0];
                            }
    ...
    public int af() {
        ...
        if (null != null) {
            return (0x2D ^ 0x5A ^ (0x55 ^ 3)) & (0xD0 ^ 0x86 ^ (0x3D ^ 0x4A) ^ -" ".length());
        }
    ...
    private static String lIlIIllIIIllI(String llllllllllllllllllIlIlIllIlIIIlI, String llllllllllllllllllIlIlIllIlIIIll) {
        try {
            SecretKeySpec llllllllllllllllllIlIlIllIlIIlll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIlIlIllIlIIIll.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllllIlIlIllIlIIllI = Cipher.getInstance("Blowfish");
            llllllllllllllllllIlIlIllIlIIllI.init(llIIIllIIl[3], llllllllllllllllllIlIlIllIlIIlll);
            return new String(llllllllllllllllllIlIlIllIlIIllI.doFinal(Base64.getDecoder().decode(llllllllllllllllllIlIlIllIlIIIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
                            ...
                            if (af.lIlIIllIIllIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                ...
                                if (af.lIlIIllIIllIl(Inventory.contains((String[])stringArray5) ? 1 : 0)) {
                                    ...
                                    if (af.lIlIIllIllIII(Inventory.getAll((String[])stringArray6).size(), llIIIllIIl[3]) && (!af.lIlIIllIlIIII(Inventory.contains((int[])f.aS) ? 1 : 0) || af.lIlIIllIIllIl(Equipment.contains((int[])f.aS) ? 1 : 0))) {
                                        n3 = llIIIllIIl[1];
                                        "".length();
                                        if ("   ".length() <= (0x79 ^ 0x49 ^ (0x60 ^ 0x54))) return n3 != 0;
                                        return ((0xF5 ^ 0xB8 ^ (0x5E ^ 0x44)) & (" ".length() ^ (0x28 ^ 0x7E) ^ -" ".length())) != 0;
                                    }
                                }
                            }
                        }
    ...
    private static boolean eO() {
        ...
        if (af.lIlIIlllIIIIl(Vars.getBit((int)llIIIllIIl[103]), llIIIllIIl[1])) {
            ...
            "".length();
            if (-" ".length() >= 0) {
                return ((0x38 ^ 0x6F ^ (0x3A ^ 0x52)) & (155 + 42 - 111 + 84 ^ 18 + 69 - -17 + 45 ^ -" ".length())) != 0;
            }
        } else {
            bl = llIIIllIIl[0];
        }
    ...
    private static String lIlIIllIIIlIl(String llllllllllllllllllIlIlIllIllIIIl, String llllllllllllllllllIlIlIllIlIlllI) {
        try {
            SecretKeySpec llllllllllllllllllIlIlIllIllIlII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIlIlIllIlIlllI.getBytes(StandardCharsets.UTF_8)), llIIIllIIl[13]), "DES");
            Cipher llllllllllllllllllIlIlIllIllIIll = Cipher.getInstance("DES");
            llllllllllllllllllIlIlIllIllIIll.init(llIIIllIIl[3], llllllllllllllllllIlIlIllIllIlII);
            return new String(llllllllllllllllllIlIlIllIllIIll.doFinal(Base64.getDecoder().decode(llllllllllllllllllIlIlIllIllIIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
        catch (Exception llllllllllllllllllIlIlIllIllIIlI) {
            llllllllllllllllllIlIlIllIllIIlI.printStackTrace();
            return null;
        }
    }
}
