...
implements ac {
    ...
    private static String lIllIIllIlIII(String llllllllllllllllllIIIllIllllllII, String llllllllllllllllllIIIllIlllllIll) {
        try {
            SecretKeySpec llllllllllllllllllIIIlllIIIIIIIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIIIllIlllllIll.getBytes(StandardCharsets.UTF_8)), llIlIlIllI[20]), "DES");
            ...
            return new String(llllllllllllllllllIIIlllIIIIIIII.doFinal(Base64.getDecoder().decode(llllllllllllllllllIIIllIllllllII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static boolean aN() {
        ...
        block28: {
                                        ...
                                        block27: {
                                            block17: {
                                                ...
                                                block19: {
                                                    ...
                                                    return ((0xA9 ^ 0xB7 ^ (0x73 ^ 0x49)) & (0x12 ^ 0x38 ^ (0x7F ^ 0x71) ^ -" ".length())) != 0;
                                                }
                                                n3 = llIlIlIllI[0];
                                                return n3 != 0;
                                            }
            ...
            return ((0x3F ^ 0x7F ^ (0x42 ^ 0xB) & ~(0x34 ^ 0x7D)) & (0x2C ^ 0x24 ^ (7 ^ 0x4F) ^ -" ".length())) != 0;
        }
        n2 = llIlIlIllI[0];
        return n2 != 0;
    }
    ...
    private static void lIllIIllIlIlI() {
        ...
        an.llIlIlIlIl[an.llIlIlIllI[0]] = an.lIllIIllIIlll("KhcXLgoPQgczAQUR", "hbnGd");
        an.llIlIlIlIl[an.llIlIlIllI[1]] = an.lIllIIllIlIII("Lv0jVOzymQXuxgwkWjLY35VyovpnaJEEHr5pbIsxBQmpMu80H7NGBcfKZ1HgxFuDnXbQ+q0z2ic=", "nIFLO");
        an.llIlIlIlIl[an.llIlIlIllI[4]] = an.lIllIIllIIlll("OQsFEyoWHhoUKlceHFovFgQY", "wjszM");
        an.llIlIlIlIl[an.llIlIlIllI[5]] = an.lIllIIllIlIIl("lGotVKidphbuLN8nVe/lMc/FsS09pkAN", "XjHWJ");
        an.llIlIlIlIl[an.llIlIlIllI[7]] = an.lIllIIllIIlll("HyFIIzgtZAUrOTstBiVqOzEYMiYhIRtuajszATYpIC0GJWo8K0gAHxENJgU=", "HDhBJ");
        an.llIlIlIlIl[an.llIlIlIllI[11]] = an.lIllIIllIlIIl("kYXw4VkVNU5p+r+S+jBXCw==", "oyORW");
        an.llIlIlIlIl[an.llIlIlIllI[15]] = an.lIllIIllIIlll("GSMVFh9qJBMaHiMjEQE=", "JWpss");
        an.llIlIlIlIl[an.llIlIlIllI[16]] = an.lIllIIllIIlll("CQgePgstDUolGi0MAyIYNg==", "DajVy");
        an.llIlIlIlIl[an.llIlIlIllI[20]] = an.lIllIIllIlIII("T5xyEUTU/8A=", "gqyFw");
        an.llIlIlIlIl[an.llIlIlIllI[23]] = an.lIllIIllIlIIl("50dbb1DVkmdB/SV7rgQoHw==", "AjSbq");
        an.llIlIlIlIl[an.llIlIlIllI[22]] = an.lIllIIllIIlll("EjcsFAFhMCoYACg3KAM=", "ACIqm");
        an.llIlIlIlIl[an.llIlIlIllI[24]] = an.lIllIIllIlIII("nEdWV0SlUhUucvuZZevcT+PvHfMQf9jf", "DHbmj");
        an.llIlIlIlIl[an.llIlIlIllI[25]] = an.lIllIIllIIlll("BxIqDT8+FGYSOXAQKRF2MQEjBw==", "PsFfV");
        an.llIlIlIlIl[an.llIlIlIllI[26]] = an.lIllIIllIIlll("CgA6Hh4vDnYRGDYa", "AiVrw");
        an.llIlIlIlIl[an.llIlIlIllI[27]] = an.lIllIIllIIlll("Gxob", "Xulbe");
        an.llIlIlIlIl[an.llIlIlIllI[14]] = an.lIllIIllIlIII("XO92syVN968=", "eWvqk");
        an.llIlIlIlIl[an.llIlIlIllI[28]] = an.lIllIIllIlIIl("kYFjxYX0ypI=", "RAkgZ");
        an.llIlIlIlIl[an.llIlIlIllI[29]] = an.lIllIIllIlIII("QioK3n6irqw=", "sovlm");
        an.llIlIlIlIl[an.llIlIlIllI[30]] = an.lIllIIllIlIII("jJR/D1PZhfR9e8zDD2rdlQ==", "QyAFr");
        an.llIlIlIlIl[an.llIlIlIllI[31]] = an.lIllIIllIlIII("gynfp9GEPiQ=", "eBhbL");
        an.llIlIlIlIl[an.llIlIlIllI[41]] = an.lIllIIllIIlll("LT8DPVMXLgU+GhAsHg==", "dMlSs");
        an.llIlIlIlIl[an.llIlIlIllI[42]] = an.lIllIIllIlIII("E717bsGHXPdF60YF7HJfJg==", "BXtlU");
        an.llIlIlIlIl[an.llIlIlIllI[43]] = an.lIllIIllIIlll("LwwPACU=", "xejlA");
        an.llIlIlIlIl[an.llIlIlIllI[44]] = an.lIllIIllIIlll("JiQcKCBVIxokIRwkGD8=", "uPyML");
        an.llIlIlIlIl[an.llIlIlIllI[45]] = an.lIllIIllIlIII("vah36SFtoGsQTtjn0bljag==", "HQlgW");
        an.llIlIlIlIl[an.llIlIlIllI[46]] = an.lIllIIllIlIII("Kx2C2rLByQI=", "AxbQI");
        an.llIlIlIlIl[an.llIlIlIllI[48]] = an.lIllIIllIlIIl("ySIUasFcQ2nHkIzHVCpSCHz2Dq73vOTG", "kIjcB");
        an.llIlIlIlIl[an.llIlIlIllI[49]] = an.lIllIIllIlIIl("gSyO+7kJLAefp0qmUzi6Sz+qW3HcAlcU", "MgEyY");
        an.llIlIlIlIl[an.llIlIlIllI[50]] = an.lIllIIllIlIIl("EyWBUsjTlnA=", "POfHC");
        an.llIlIlIlIl[an.llIlIlIllI[51]] = an.lIllIIllIIlll("ABocJx4=", "WsyKz");
        an.llIlIlIlIl[an.llIlIlIllI[47]] = an.lIllIIllIlIII("nlonuT+XPLo=", "CyTjG");
        an.llIlIlIlIl[an.llIlIlIllI[53]] = an.lIllIIllIlIII("TQ5wfVeC13A=", "VRHnT");
        an.llIlIlIlIl[an.llIlIlIllI[55]] = an.lIllIIllIlIII("DsFwXPdtaZE=", "dXyln");
        an.llIlIlIlIl[an.llIlIlIllI[57]] = an.lIllIIllIIlll("EBcPHg==", "Grnlf");
        an.llIlIlIlIl[an.llIlIlIllI[59]] = an.lIllIIllIIlll("ARAOBg==", "Vuotn");
        an.llIlIlIlIl[an.llIlIlIllI[61]] = an.lIllIIllIIlll("OSsAPQ==", "nNaOk");
        an.llIlIlIlIl[an.llIlIlIllI[63]] = an.lIllIIllIIlll("BzEwAA==", "PTQrA");
        an.llIlIlIlIl[an.llIlIlIllI[86]] = an.lIllIIllIlIII("mxKsyrzDdrjaoEYPefWJsA==", "MXheg");
        an.llIlIlIlIl[an.llIlIlIllI[87]] = an.lIllIIllIIlll("LAw2", "ocAWg");
    }
    ...
    private static void lIllIIlllIlIl() {
        ...
        an.llIlIlIllI[0] = (127 + 111 - 194 + 86 ^ 110 + 159 - 91 + 2) & (0x68 ^ 0x4C ^ (0x94 ^ 0x86) ^ -" ".length());
        an.llIlIlIllI[1] = " ".length();
        an.llIlIlIllI[2] = 0x1C ^ 0x20;
        an.llIlIlIllI[3] = 0x74 ^ 0x3F;
        an.llIlIlIllI[4] = "  ".length();
        an.llIlIlIllI[5] = "   ".length();
                    ...
                    block25: {
                        block24: {
                            ...
                            if (an.lIllIIllllIIl(an.aM() ? 1 : 0) && (!an.lIllIIllllIlI(Skills.getLevel((Skill)Skill.DEFENCE), llIlIlIllI[2]) || !an.lIllIIllllIlI(Skills.getLevel((Skill)Skill.ATTACK), llIlIlIllI[3]) || an.lIllIIllllIII(Skills.getLevel((Skill)Skill.STRENGTH), llIlIlIllI[3]))) {
                                BankLocation llllllllllllllllllIIIlllIIlIlIlI = BankLocation.getNearest();
                                if (an.lIllIIllllIll(llllllllllllllllllIIIlllIIlIlIlI) && an.lIllIIllllIIl(llllllllllllllllllIIIlllIIlIlIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    AccBuilderSotf.c = llIlIlIlIl[llIlIlIllI[4]];
                                    a.a(llllllllllllllllllIIIlllIIlIlIlI);
                                }
                                if (an.lIllIIllllIll(llllllllllllllllllIIIlllIIlIlIlI) && an.lIllIIlllIlll(llllllllllllllllllIIIlllIIlIlIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String lIllIIllIlIIl(String llllllllllllllllllIIIllIllllIIIl, String llllllllllllllllllIIIllIlllIlllI) {
        try {
            SecretKeySpec llllllllllllllllllIIIllIllllIlII = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIIIllIlllIlllI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllllIIIllIllllIIll = Cipher.getInstance("Blowfish");
            llllllllllllllllllIIIllIllllIIll.init(llIlIlIllI[4], llllllllllllllllllIIIllIllllIlII);
    ...
    public int af() {
        ...
        catch (Exception llllllllllllllllllIIIlllIIlIIIlI) {
            llllllllllllllllllIIIlllIIlIIIlI.printStackTrace();
        }
        if ("  ".length() >= (0xF5 ^ 0xB3 ^ (0x67 ^ 0x25))) {
            return (0xAB ^ 0xA2 ^ (0xC9 ^ 0x82)) & (0x2A ^ 0x24 ^ (0x4C ^ 0) ^ -" ".length());
        }
        return llIlIlIllI[0];
    }
    ...
    public static void Q() {
        d llllllllllllllllllIIIlllIIlIIlII;
        int[] nArray = new int[llIlIlIllI[1]];
        ...
        if (an.lIllIIllllIIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
            llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[67], llIlIlIllI[11], llIlIlIllI[66]);
            bv.add(llllllllllllllllllIIIlllIIlIIlII);
            "".length();
        }
        int[] nArray3 = new int[llIlIlIllI[1]];
        nArray3[an.llIlIlIllI[0]] = llIlIlIllI[62];
        if (an.lIllIIllllIIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
            llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[62], llIlIlIllI[1], llIlIlIllI[68]);
            bv.add(llllllllllllllllllIIIlllIIlIIlII);
            "".length();
        }
        int[] nArray4 = new int[llIlIlIllI[1]];
        ...
        if (an.lIllIIllllIIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
            llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[60], llIlIlIllI[1], llIlIlIllI[69]);
            bv.add(llllllllllllllllllIIIlllIIlIIlII);
            "".length();
        }
        int[] nArray5 = new int[llIlIlIllI[1]];
        ...
        if (an.lIllIIllllIIl(Bank.contains((int[])nArray5) ? 1 : 0)) {
            llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[12], llIlIlIllI[13], llIlIlIllI[70]);
            bv.add(llllllllllllllllllIIIlllIIlIIlII);
            "".length();
        }
        if (an.lIllIIllllIlI(Skills.getLevel((Skill)Skill.ATTACK), llIlIlIllI[21]) && !an.lIllIIllllIlI(Skills.getLevel((Skill)Skill.ATTACK), llIlIlIllI[2]) || an.lIllIIllllIlI(Skills.getLevel((Skill)Skill.ATTACK), llIlIlIllI[2]) && an.lIllIIllllIII(Skills.getLevel((Skill)Skill.DEFENCE), llIlIlIllI[2])) {
            ...
            if (an.lIllIIllllIIl(Bank.contains((int[])nArray6) ? 1 : 0)) {
                llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[52], llIlIlIllI[1], llIlIlIllI[71]);
                bv.add(llllllllllllllllllIIIlllIIlIIlII);
                "".length();
            }
            int[] nArray7 = new int[llIlIlIllI[1]];
            ...
            if (an.lIllIIllllIIl(Bank.contains((int[])nArray7) ? 1 : 0)) {
                llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[56], llIlIlIllI[1], llIlIlIllI[71]);
                bv.add(llllllllllllllllllIIIlllIIlIIlII);
                "".length();
            }
            int[] nArray8 = new int[llIlIlIllI[1]];
            ...
            if (an.lIllIIllllIIl(Bank.contains((int[])nArray8) ? 1 : 0)) {
                llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[58], llIlIlIllI[1], llIlIlIllI[71]);
                bv.add(llllllllllllllllllIIIlllIIlIIlII);
                "".length();
            }
            int[] nArray9 = new int[llIlIlIllI[1]];
            ...
            if (an.lIllIIllllIIl(Bank.contains((int[])nArray9) ? 1 : 0)) {
                llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[54], llIlIlIllI[1], llIlIlIllI[71]);
                bv.add(llllllllllllllllllIIIlllIIlIIlII);
                "".length();
            }
        }
        ...
        if (an.lIllIIllllIlI(Skills.getLevel((Skill)Skill.ATTACK), llIlIlIllI[2]) && an.lIllIIllllIlI(Skills.getLevel((Skill)Skill.DEFENCE), llIlIlIllI[2]) && an.lIllIIllllIlI(Skills.getLevel((Skill)Skill.STRENGTH), llIlIlIllI[2])) {
            ...
            if (an.lIllIIllllIIl(Bank.contains((int[])nArray14) ? 1 : 0)) {
                llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[19], llIlIlIllI[1], e.c(llIlIlIllI[72], llIlIlIllI[73]));
                bv.add(llllllllllllllllllIIIlllIIlIIlII);
                "".length();
            }
            int[] nArray15 = new int[llIlIlIllI[1]];
            ...
            if (an.lIllIIllllIIl(Bank.contains((int[])nArray15) ? 1 : 0)) {
                llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[40], llIlIlIllI[1], e.c(llIlIlIllI[74], llIlIlIllI[75]));
                bv.add(llllllllllllllllllIIIlllIIlIIlII);
                "".length();
            }
            int[] nArray16 = new int[llIlIlIllI[1]];
            ...
            if (an.lIllIIllllIIl(Bank.contains((int[])nArray16) ? 1 : 0)) {
                llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[38], llIlIlIllI[1], e.c(llIlIlIllI[76], llIlIlIllI[77]));
                bv.add(llllllllllllllllllIIIlllIIlIIlII);
                "".length();
            }
            int[] nArray17 = new int[llIlIlIllI[1]];
            ...
            if (an.lIllIIllllIIl(Bank.contains((int[])nArray17) ? 1 : 0)) {
                llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[35], llIlIlIllI[1], e.c(llIlIlIllI[76], llIlIlIllI[77]));
                bv.add(llllllllllllllllllIIIlllIIlIIlII);
                "".length();
            }
            int[] nArray18 = new int[llIlIlIllI[1]];
            ...
            if (an.lIllIIllllIIl(Bank.contains((int[])nArray18) ? 1 : 0)) {
                llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[36], llIlIlIllI[1], e.c(llIlIlIllI[78], llIlIlIllI[79]));
                bv.add(llllllllllllllllllIIIlllIIlIIlII);
                "".length();
            }
            int[] nArray19 = new int[llIlIlIllI[1]];
            ...
            if (an.lIllIIllllIIl(Bank.contains((int[])nArray19) ? 1 : 0)) {
                llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[37], llIlIlIllI[1], e.c(llIlIlIllI[80], llIlIlIllI[81]));
                bv.add(llllllllllllllllllIIIlllIIlIIlII);
                "".length();
            }
            int[] nArray20 = new int[llIlIlIllI[1]];
            ...
            if (an.lIllIIllllIIl(Bank.contains((int[])nArray20) ? 1 : 0)) {
                llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[39], llIlIlIllI[1], e.c(llIlIlIllI[82], llIlIlIllI[83]));
                bv.add(llllllllllllllllllIIIlllIIlIIlII);
                "".length();
            }
            int[] nArray21 = new int[llIlIlIllI[1]];
            ...
            if (an.lIllIIllllIIl(Bank.contains((int[])nArray21) ? 1 : 0)) {
                llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[34], llIlIlIllI[1], e.c(llIlIlIllI[84], llIlIlIllI[85]));
                bv.add(llllllllllllllllllIIIlllIIlIIlII);
                "".length();
            }
        }
        if (an.lIllIIllllIlI(Skills.getLevel((Skill)Skill.ATTACK), llIlIlIllI[21])) {
            ...
            if (an.lIllIIllllIIl(Bank.contains((int[])nArray22) ? 1 : 0)) {
                llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[18], llIlIlIllI[1], llIlIlIllI[69]);
                bv.add(llllllllllllllllllIIIlllIIlIIlII);
                "".length();
            }
        }
        ...
        if (an.lIllIIllllIIl(Bank.contains((int[])nArray23) ? 1 : 0) && an.lIllIIllllIII(Skills.getLevel((Skill)Skill.ATTACK), llIlIlIllI[21]) && an.lIllIIllllIlI(Skills.getLevel((Skill)Skill.ATTACK), llIlIlIllI[47])) {
            llllllllllllllllllIIIlllIIlIIlII = new d(llIlIlIllI[17], llIlIlIllI[1], llIlIlIllI[71]);
            bv.add(llllllllllllllllllIIIlllIIlIIlII);
            "".length();
        }
    }
    ...
    private static String lIllIIllIIlll(String llllllllllllllllllIIIlllIIIIlllI, String llllllllllllllllllIIIlllIIIlIIlI) {
        llllllllllllllllllIIIlllIIIIlllI = new String(Base64.getDecoder().decode(llllllllllllllllllIIIlllIIIIlllI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllIIIlllIIIlIIIl = new StringBuilder();
        char[] llllllllllllllllllIIIlllIIIlIIII = llllllllllllllllllIIIlllIIIlIIlI.toCharArray();
        int llllllllllllllllllIIIlllIIIIllll = llIlIlIllI[0];
        char[] llllllllllllllllllIIIlllIIIIlIIl = llllllllllllllllllIIIlllIIIIlllI.toCharArray();
        int llllllllllllllllllIIIlllIIIIlIII = llllllllllllllllllIIIlllIIIIlIIl.length;
        int llllllllllllllllllIIIlllIIIIIlll = llIlIlIllI[0];
        while (an.lIllIIllllIII(llllllllllllllllllIIIlllIIIIIlll, llllllllllllllllllIIIlllIIIIlIII)) {
            char llllllllllllllllllIIIlllIIIlIlII = llllllllllllllllllIIIlllIIIIlIIl[llllllllllllllllllIIIlllIIIIIlll];
            llllllllllllllllllIIIlllIIIlIIIl.append((char)(llllllllllllllllllIIIlllIIIlIlII ^ llllllllllllllllllIIIlllIIIlIIII[llllllllllllllllllIIIlllIIIIllll % llllllllllllllllllIIIlllIIIlIIII.length]));
            "".length();
            ++llllllllllllllllllIIIlllIIIIllll;
            ++llllllllllllllllllIIIlllIIIIIlll;
            "".length();
                                                                        ...
                                                                        block23: {
                                                                            block11: {
                                                                                ...
                                                                                block13: {
                                                                                    ...
                                                                                    n4 = llIlIlIllI[1];
                                                                                    "".length();
                                                                                    if (((111 + 184 - 104 + 0 ^ 108 + 20 - 68 + 73) & (0xF2 ^ 0xC2 ^ (0x4B ^ 0x41) ^ -" ".length())) == 0) return n4 != 0;
                                                                                    return ((24 + 113 - -39 + 38 ^ 35 + 37 - -8 + 51) & (0x4A ^ 0x41 ^ (3 ^ 0x5D) ^ -" ".length())) != 0;
                                                                                }
                                                                                n4 = llIlIlIllI[0];
                                                                                return n4 != 0;
                                                                            }
    ...
    public static void am() {
        ...
        if (an.lIllIIlllIlll(cM.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (an.lIllIIlllllll(Players.getLocal().getInteracting())) {
                NPC llllllllllllllllllIIIlllIIlIIlll = NPCs.getNearest(nPC -> {
                    int n2;
                    if (an.lIllIIlllIlll(nPC.getName().contains(llIlIlIlIl[llIlIlIllI[87]]) ? 1 : 0) && an.lIllIIlllllll(nPC.getInteracting()) && an.lIllIIllllIIl(nPC.isDead() ? 1 : 0)) {
                        ...
                        "".length();
                        if (" ".length() <= -" ".length()) {
                            return ((0x50 ^ 0x44 ^ (0xD7 ^ 0x85)) & (0x61 ^ 0x48 ^ (0x16 ^ 0x79) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = llIlIlIllI[0];
                    }
                ...
                List llllllllllllllllllIIIlllIIlIIllI = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                    boolean bl;
                    if (an.lIllIlIIIIIlI(nPC.getInteracting(), Players.getLocal())) {
                        bl = llIlIlIllI[1];
                        "".length();
                        if (" ".length() <= -" ".length()) {
                            return ((0x82 ^ 0xA4) & ~(0xB ^ 0x2D)) != 0;
                        }
                    } else {
                        bl = llIlIlIllI[0];
                    }
                ...
                if (an.lIllIIllllIIl(llllllllllllllllllIIIlllIIlIIllI.isEmpty() ? 1 : 0)) {
                    ((NPC)llllllllllllllllllIIIlllIIlIIllI.get(llIlIlIllI[0])).interact(llIlIlIlIl[llIlIlIllI[28]]);
                    Time.sleepTicks((int)llIlIlIllI[4]);
                    "".length();
                }
                if (an.lIllIIllllIll(llllllllllllllllllIIIlllIIlIIlll) && an.lIllIIllllIIl(Players.getLocal().isMoving() ? 1 : 0) && an.lIllIIlllIlll(llllllllllllllllllIIIlllIIlIIllI.isEmpty() ? 1 : 0)) {
                    llllllllllllllllllIIIlllIIlIIlll.interact(llIlIlIlIl[llIlIlIllI[29]]);
                    Time.sleepTicks((int)llIlIlIllI[4]);
                    "".length();
                }
            }
