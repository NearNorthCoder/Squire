...
public class l {
    ...
    private static void lIllllllIIlll() {
        ...
        l.lllIIIlIlI[4] = (0x5A ^ 0x21 ^ (0xF3 ^ 0x84)) & (61 + 100 - 53 + 42 ^ 15 + 85 - 63 + 117 ^ -" ".length());
        ...
        l.lllIIIlIlI[15] = " ".length();
        l.lllIIIlIlI[16] = 0x2D ^ 0x2B;
        l.lllIIIlIlI[17] = "  ".length();
        l.lllIIIlIlI[18] = 0xFFFFD1FB & 0x2F7F;
        l.lllIIIlIlI[19] = "   ".length();
        l.lllIIIlIlI[20] = 0xA3 ^ 0xA7;
        l.lllIIIlIlI[21] = -" ".length();
    ...
    private static void lIllllllIIllI() {
        ...
        l.lllIIIlIIl[l.lllIIIlIlI[4]] = l.lIllllllIIIll("kLALdj94/Mo8fApZCShfyMwgBpTLgW1M", "gjtAJ");
        l.lllIIIlIIl[l.lllIIIlIlI[15]] = l.lIllllllIIIll("ZUK2vLj33SIZlKnVcCzU1Q==", "khcLD");
        l.lllIIIlIIl[l.lllIIIlIlI[17]] = l.lIllllllIIIll("MqxmvC7yuj8Hwuru9BBUpQ==", "zmsqL");
        l.lllIIIlIIl[l.lllIIIlIlI[19]] = l.lIllllllIIIll("w+X2l08Gv8s=", "izdwD");
        l.lllIIIlIIl[l.lllIIIlIlI[20]] = l.lIllllllIIlII("IwhEOxgHBAUs", "jfdXw");
        l.lllIIIlIIl[l.lllIIIlIlI[22]] = l.lIllllllIIlIl("G4KkJyVjBKY=", "XBnmy");
        l.lllIIIlIIl[l.lllIIIlIlI[16]] = l.lIllllllIIlII("JjMdABUMLgcGVg8uBQ1WAC4IDwI=", "gGiav");
        l.lllIIIlIIl[l.lllIIIlIlI[23]] = l.lIllllllIIlIl("rKt0MwldUcs=", "TzqrB");
        l.lllIIIlIIl[l.lllIIIlIlI[24]] = l.lIllllllIIIll("0kc+ikQThP3srQ08qi5+za1xOVkKTcNl", "mddKN");
        l.lllIIIlIIl[l.lllIIIlIlI[25]] = l.lIllllllIIlII("ORw1FhUT", "xhAwv");
        l.lllIIIlIIl[l.lllIIIlIlI[26]] = l.lIllllllIIIll("rfBSH3F5joc=", "FUWds");
        l.lllIIIlIIl[l.lllIIIlIlI[27]] = l.lIllllllIIlIl("MxdYaLptE7Q=", "axVRn");
        l.lllIIIlIIl[l.lllIIIlIlI[28]] = l.lIllllllIIlIl("k+jJwYNz87A=", "HWWeh");
        l.lllIIIlIIl[l.lllIIIlIlI[29]] = l.lIllllllIIIll("6U8OgYFTUNA=", "iLFoB");
    }
            ...
            if (l.lIlllllllIIII(Players.getLocal().getInteracting()) && l.lIlllllllIIIl(Players.getLocal().getHealthRatio(), lllIIIlIlI[21])) {
                lllllllllllllllllIllllIIIlIlllIl = NPCs.getNearest(nPC -> {
                    ...
                    if (l.lIllllllIlIlI(nPC.getName().contains(lllIIIlIIl[lllIIIlIlI[29]]) ? 1 : 0) && l.lIlllllllIIll(nPC.getInteracting(), Players.getLocal()) && l.lIllllllIlIIl(nPC.isDead() ? 1 : 0)) {
                        n2 = lllIIIlIlI[15];
                        "".length();
                        if (((0x4D ^ 0x3D ^ (0x2F ^ 0xC)) & (0x13 ^ 0x45 ^ (4 ^ 1) ^ -" ".length())) != 0) {
                            return ((0xF0 ^ 0x96 ^ (0x5E ^ 2)) & (0xF0 ^ 0xC6 ^ (0x63 ^ 0x6F) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lllIIIlIlI[4];
                    }
            ...
            if (l.lIlllllllIIlI(Players.getLocal().getInteracting())) {
                ...
                lllllllllllllllllIllllIIIlIlllII = NPCs.getNearest(nPC -> {
                    ...
                    if (l.lIllllllIlIlI(nPC.getName().contains(lllIIIlIIl[lllIIIlIlI[26]]) ? 1 : 0) && l.lIlllllllIIll(nPC.getInteracting(), Players.getLocal()) && l.lIllllllIlIIl(nPC.isDead() ? 1 : 0)) {
                        n2 = lllIIIlIlI[15];
                        "".length();
                        if (((0x7E ^ 0x1B ^ (0x51 ^ 9)) & (85 + 118 - 63 + 12 ^ 75 + 51 - 33 + 72 ^ -" ".length())) == "   ".length()) {
                            return ((42 + 148 - 105 + 82 ^ 6 + 70 - 66 + 121) & (21 + 160 - 102 + 83 ^ 23 + 111 - 91 + 91 ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lllIIIlIlI[4];
                    }
