...
public class I {
    ...
    private static void llIIIIlIIIIll() {
        ...
        I.lllIIllIlI[0] = (0x50 ^ 0x41 ^ (0xB6 ^ 0x86)) & (0xF9 ^ 0xBC ^ (0x6F ^ 0xB) ^ -" ".length());
        I.lllIIllIlI[1] = " ".length();
        I.lllIIllIlI[2] = "  ".length();
        I.lllIIllIlI[3] = "   ".length();
        ...
        I.lllIIllIlI[23] = -" ".length() & (0xFFFFEF7E & 0x7FDF);
                    ...
                    if (I.llIIIIlIIIlIl(Inventory.getCount((int[])nArray6), lllIIllIlI[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (I.llIIIIlIIlIII(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if ("  ".length() < 0) {
                                    return ((26 + 29 - 48 + 144 ^ 53 + 52 - 10 + 77) & (141 + 93 - 233 + 190 ^ 131 + 56 - 110 + 55 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lllIIllIlI[0];
                            }
                    ...
                    if (I.llIIIIlIIIlIl(Inventory.getCount((int[])nArray10), lllIIllIlI[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (I.llIIIIlIIlIII(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if ("  ".length() == 0) {
                                    return ((123 + 37 - 54 + 97 ^ 93 + 101 - 96 + 43) & (0x98 ^ 0xBD ^ (0x7A ^ 0x19) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lllIIllIlI[0];
                            }
    ...
    private static void llIIIIlIIIIlI() {
        ...
        I.lllIIllIIl[I.lllIIllIlI[0]] = I.llIIIIIllllll("Mh8MGxcXShwGHB0Z", "pjury");
        I.lllIIllIIl[I.lllIIllIlI[1]] = I.llIIIIIllllll("EjoNIDs8NgdpKiEqCicvdDoXLCUnf0M6Pz0nACEhOjRDKyk3OEM9J3Q0Big6PT0E", "TScIH");
        I.lllIIllIIl[I.lllIIllIlI[2]] = I.llIIIIlIIIIII("aux/s4209t6afbHltn/vuwhFXQj3CiCa", "YDIWX");
        I.lllIIllIIl[I.lllIIllIlI[3]] = I.llIIIIlIIIIII("7vnTo4aOB7U/LPyFn06oeSz8OLHj6dh4", "BaExD");
        I.lllIIllIIl[I.lllIIllIlI[4]] = I.llIIIIlIIIIIl("pDP219FuJzyYB57/BfrvMw==", "hORIq");
        I.lllIIllIIl[I.lllIIllIlI[6]] = I.llIIIIIllllll("HiAUChg/Lx1OFjcvEQcaMQ==", "VAznt");
        I.lllIIllIIl[I.lllIIllIlI[9]] = I.llIIIIIllllll("JS54FRgXazUdGQEiNhNKAT4oBAYbLitYSgE8MQAJGiI2E0oGJHg2PysCFjNKJz8xGA==", "rKXtj");
        I.lllIIllIIl[I.lllIIllIlI[10]] = I.llIIIIlIIIIIl("+HXWTPBTcBE=", "cGnyu");
        I.lllIIllIIl[I.lllIIllIlI[11]] = I.llIIIIlIIIIIl("FLxmjknD/hA=", "IuSVP");
        I.lllIIllIIl[I.lllIIllIlI[12]] = I.llIIIIlIIIIII("AZkYEtxcnbU=", "pidBc");
        I.lllIIllIIl[I.lllIIllIlI[13]] = I.llIIIIlIIIIIl("9zcUYDuyRVA=", "XfJFy");
        I.lllIIllIIl[I.lllIIllIlI[14]] = I.llIIIIIllllll("JAMzHho=", "arFwj");
        I.lllIIllIIl[I.lllIIllIlI[15]] = I.llIIIIIllllll("ARYvMyQ=", "DgZZT");
        I.lllIIllIIl[I.lllIIllIlI[17]] = I.llIIIIIllllll("FQI2CgxmGTFMCy8E", "FvWlj");
        I.lllIIllIIl[I.lllIIllIlI[18]] = I.llIIIIlIIIIII("9TkLLt+SKJBSxpbdRZp5PA==", "UcOvS");
        I.lllIIllIIl[I.lllIIllIlI[19]] = I.llIIIIlIIIIII("gb1auniNROPijmqdkTeT8w==", "IASFP");
        I.lllIIllIIl[I.lllIIllIlI[20]] = I.llIIIIlIIIIIl("Hj7rsNlkBm2AUj3XblqY9g==", "JwSRA");
        I.lllIIllIIl[I.lllIIllIlI[38]] = I.llIIIIlIIIIII("2V2ZgJGCWMY=", "IBAIZ");
        I.lllIIllIIl[I.lllIIllIlI[39]] = I.llIIIIIllllll("OAE7AA==", "odZrD");
        I.lllIIllIIl[I.lllIIllIlI[40]] = I.llIIIIIllllll("By4dFFIaIVMEFxQrBxtSXQ==", "uGssr");
    }
