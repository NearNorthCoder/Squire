...
implements ac {
    ...
    public int af() {
        ...
        if ("   ".length() == 0) {
            return (5 + 8 - -144 + 25 ^ 100 + 2 - -9 + 61) & (0x73 ^ 0x56 ^ (9 ^ 0x36) ^ -" ".length());
        }
    ...
    private static void lIllIIIlIlIlI() {
        ...
        Q.llIlIIlIII[0] = (0x3E ^ 0x76 ^ (0x20 ^ 0x72)) & (38 + 77 - -1 + 65 ^ 46 + 1 - -110 + 18 ^ -" ".length());
        Q.llIlIIlIII[1] = " ".length();
        Q.llIlIIlIII[2] = 0x29 ^ 0x15 ^ (0xAD ^ 0x95);
        Q.llIlIIlIII[3] = 1 ^ 0x1C;
        Q.llIlIIlIII[4] = "  ".length();
        Q.llIlIIlIII[5] = "   ".length();
    ...
    private static void lIllIIIlIlIIl() {
        ...
        Q.llIlIIIlll[Q.llIlIIlIII[0]] = Q.lIllIIIlIIllI("/+aV9nmMVryJ39Cc/hzMGA==", "XzndD");
        Q.llIlIIIlll[Q.llIlIIlIII[1]] = Q.lIllIIIlIIlll("aVTaAOscdd1XgDvgKr49pv2R6yn1yX4NWkO1LPUHyWrZ5j/UQQlJ1LoBSTlNdJ9X", "ETqXq");
        Q.llIlIIIlll[Q.llIlIIlIII[4]] = Q.lIllIIIlIlIII("EysaIyoqLVY8LGQoFyYo", "DJvHC");
        Q.llIlIIIlll[Q.llIlIIlIII[5]] = Q.lIllIIIlIlIII("Jw0CEhkGAgtWFw4CBx8bCA==", "ollvu");
        Q.llIlIIIlll[Q.llIlIIlIII[2]] = Q.lIllIIIlIlIII("DTJmAiU/dysKJCk+KAR3KyIjECN6JDMTJzY+IxB7eiQxCiM5Py8NMHojKUMVDw4PLRA=", "ZWFcW");
        Q.llIlIIIlll[Q.llIlIIlIII[11]] = Q.lIllIIIlIIllI("0JSb3Y29Mxb+OlZjMKEvgA==", "bcRth");
        Q.llIlIIIlll[Q.llIlIIlIII[12]] = Q.lIllIIIlIIllI("7XiFQt3Wn946+M0FXLKnBw==", "ySuls");
        Q.llIlIIIlll[Q.llIlIIlIII[13]] = Q.lIllIIIlIIlll("KMkCJGC5iBo=", "lPgwg");
        Q.llIlIIIlll[Q.llIlIIlIII[22]] = Q.lIllIIIlIlIII("KzwMOApIEhAgEBsnAj0NSAIWNgoc", "hScSy");
        Q.llIlIIIlll[Q.llIlIIlIII[23]] = Q.lIllIIIlIIlll("9RkGlMGIOM+RV5XT7m+VhqN7kYVW8l5G", "sGAzx");
        Q.llIlIIIlll[Q.llIlIIlIII[14]] = Q.lIllIIIlIIlll("+DtsCn+jUGquKybvf6lkda7aarcQOqm9", "EvrLD");
        Q.llIlIIIlll[Q.llIlIIlIII[26]] = Q.lIllIIIlIIlll("/cPS6LZQ/wWoFHSou7/lmI56Fncgqe+NZglWiX+kDn/dP++LV5r7W0uOOjSPm06J", "kvVSR");
        Q.llIlIIIlll[Q.llIlIIlIII[27]] = Q.lIllIIIlIIllI("O4L7gw7JRUQKzbBiUs9piZGlrlDM+uLN8w6IHUsJEeJd2MjGEuURGNlsTCXAJLLp", "sjZKE");
        Q.llIlIIIlll[Q.llIlIIlIII[28]] = Q.lIllIIIlIIllI("AXY2Q/EBxmc=", "rFMqR");
        Q.llIlIIIlll[Q.llIlIIlIII[29]] = Q.lIllIIIlIIllI("+gARwmziamqQLNHvl26diQ==", "EcuTh");
    }
        ...
        if (Q.lIllIIIllIIII(Inventory.getCount((int[])nArray))) {
            ...
            if (Q.lIllIIIllIIII(Inventory.getCount((int[])nArray2))) {
                ...
                if (Q.lIllIIIllIIII(Inventory.getCount((int[])nArray3))) {
                    ...
                    return ((25 + 148 - 168 + 152 ^ 86 + 103 - 111 + 52) & (24 + 95 - 9 + 70 ^ 114 + 92 - 106 + 71 ^ -" ".length())) != 0;
                }
            }
        }
        n2 = llIlIIlIII[0];
