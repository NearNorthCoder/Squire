...
public class b {
    ...
    public static boolean a(String string) {
        ...
        if (b.lIlIIlIllIlll(list.isEmpty() ? 1 : 0)) {
            ...
            while (b.lIlIIlIlllIIl(llllllllllllllllllIlIlllIlllIllI, llllllllllllllllllIlIlllIllllIII.size())) {
                ...
                "".length();
                if (" ".length() >= ((0x61 ^ 0x57) & ~(4 ^ 0x32))) continue;
                        ...
                        if (b.lIlIIlIlllIII(Bank.contains((int[])nArray2) ? 1 : 0) && b.lIlIIlIlllIll(Players.getLocal().getWorldLocation().distanceTo(I), llIIIlIlIl[3])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (b.lIlIIlIlllllI(Inventory.getCount((int[])nArray))) {
                                    bl = llIIIlIlIl[1];
                                    "".length();
                                    if ((59 + 110 - 119 + 101 ^ 68 + 65 - 52 + 66) == "   ".length()) {
                                        return ((0xF0 ^ 0xB9 ^ (0xEC ^ 0x80)) & (0xC4 ^ 0x9F ^ (0x2F ^ 0x51) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = llIIIlIlIl[0];
                                }
                    ...
                    block69: {
                        block70: {
                            block68: {
                                    ...
                                    block66: {
                                        if (b.lIlIIlIllIlll(GrandExchange.canCollect() ? 1 : 0)) {
                                            ...
                                            if (b.lIlIIlIlllllI(GrandExchange.getOffers().stream().filter(grandExchangeOffer -> {
                                                ...
                                                n2 = llIIIlIlIl[1];
                                                "".length();
                                                if (" ".length() == ((0xF ^ 0x40 ^ (0xB ^ 0x6A)) & ("  ".length() ^ (0x40 ^ 0x6C) ^ -" ".length()))) {
                                                    return;
                                                }
                                            } else {
                                                n2 = llIIIlIlIl[0];
                                        ...
                                        if (b.lIlIIlIlllIII(GrandExchange.canCollect() ? 1 : 0)) {
                                            ...
                                            Time.sleepUntil(() -> {
                                                ...
                                                if (b.lIlIIlIllIlll(GrandExchange.canCollect() ? 1 : 0)) {
                                                    bl = llIIIlIlIl[1];
                                                    "".length();
                                                    if (((0x56 ^ 0x7E ^ (0x9D ^ 0xA8)) & (0x61 ^ 0x36 ^ (0x3C ^ 0x76) ^ -" ".length())) != 0) {
                                                        return ((40 + 43 - 1 + 46 ^ 79 + 2 - -63 + 48) & (0x4C ^ 0x22 ^ (0x18 ^ 0x36) ^ -" ".length())) != 0;
                                                    }
                                                } else {
                                                    bl = llIIIlIlIl[0];
                                                }
                                ...
                                "".length();
                                "".length();
                                if (" ".length() >= ((0xEB ^ 0xB3) & ~(0x5A ^ 2))) continue;
                                return;
                            }
                            if (b.lIlIIlIllllll(J.get(llllllllllllllllllIlIllllIIIllIl2), llIIIlIlIl[16])) {
                                ...
                                if (b.lIlIIlIlllIII(Inventory.contains((int[])nArray8) ? 1 : 0)) {
                                    ...
                                    "".length();
                                    "".length();
                                    if ("  ".length() > ((0x6F ^ 0x7B ^ (4 ^ 0x58)) & (0x76 ^ 0x3E ^ (0x18 ^ 0x78) & ~(0xCD ^ 0xAD) ^ -" ".length()))) continue;
                                    return;
                                }
                            }
                            ...
                            if (b.lIlIIlIllllll(J.get(llllllllllllllllllIlIllllIIIllIl2), llIIIlIlIl[21])) {
                                ...
                                if (b.lIlIIlIlllIII(Inventory.contains((int[])nArray12) ? 1 : 0)) {
                                    ...
                                    "".length();
                                    "".length();
                                    if ((129 + 18 - 61 + 57 ^ 67 + 33 - 21 + 60) >= "  ".length()) continue;
                                    return;
                                }
                            }
                        ...
                        "".length();
                        "".length();
                        if (((0xC9 ^ 0x9F ^ (0x9A ^ 0x90)) & (0xFF ^ 0x8D ^ (0x2F ^ 1) ^ -" ".length())) == 0) continue;
                        return;
                    }
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (b.lIlIIlIllIlll(GrandExchange.canCollect() ? 1 : 0)) {
                            ...
                            if ((64 + 49 - 85 + 108 ^ 96 + 84 - 142 + 102) == 0) {
                                return ((0x9E ^ 0x80 ^ (0x9A ^ 0xC5)) & (0x1D ^ 0xB ^ (0x1A ^ 0x4D) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = llIIIlIlIl[0];
                        }
                    ...
                    if (b.lIlIIlIlllIII(GrandExchange.canCollect() ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (b.lIlIIlIllIlll(GrandExchange.canCollect() ? 1 : 0)) {
                                ...
                                "".length();
                                if (" ".length() == 0) {
                                    return ((0x4E ^ 9 ^ (0x60 ^ 0x31)) & ("   ".length() ^ (0x37 ^ 0x22) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIIIlIlIl[0];
                            }
    ...
    private static void lIlIIlIllIlIl() {
        ...
        b.llIIIlIlII[b.llIIIlIlIl[0]] = b.lIlIIlIllIIlI("ovwEyJW50D8=", "OBFGf");
        b.llIIIlIlII[b.llIIIlIlIl[1]] = b.lIlIIlIllIIll("FAYoLChzMTEhJDIaLic=", "StIBL");
        b.llIIIlIlII[b.llIIIlIlIl[8]] = b.lIlIIlIllIIlI("KgPdZoprfUfpTGsyIuCP30zYG+ALy2f/1I0eAoJWzfIeq3luFH8U3PyHx++mp9gcrWtIyHyy6aE=", "ksTmI");
        b.llIIIlIlII[b.llIIIlIlIl[4]] = b.lIlIIlIllIIll("KyIuIScWN288IQw/ICJmTH8=", "xVOLN");
        b.llIIIlIlII[b.llIIIlIlIl[7]] = b.lIlIIlIllIIlI("QfKoXWg26NkOWGuEjz7yCCW9GsF/DTOY", "MvYLd");
        b.llIIIlIlII[b.llIIIlIlIl[25]] = b.lIlIIlIllIlII("CE2k4Q+/TVE=", "pBXiD");
        b.llIIIlIlII[b.llIIIlIlIl[26]] = b.lIlIIlIllIIlI("qPIhTeGpWUTxjg5yZ9lNmg==", "zzMEE");
        b.llIIIlIlII[b.llIIIlIlIl[13]] = b.lIlIIlIllIIlI("eC9mB/5Z/kA=", "CzDan");
        b.llIIIlIlII[b.llIIIlIlIl[28]] = b.lIlIIlIllIIll("GQg+HwI=", "ZdQlg");
        b.llIIIlIlII[b.llIIIlIlIl[29]] = b.lIlIIlIllIIll("EBAuJxkP", "guOKm");
        b.llIIIlIlII[b.llIIIlIlIl[3]] = b.lIlIIlIllIlII("EUf9MPUtPso=", "CvhfN");
        b.llIIIlIlII[b.llIIIlIlIl[27]] = b.lIlIIlIllIIlI("ebRt5ZMRPta5MKhcV/dEEeBsmwYBomCr", "ztguw");
    }
