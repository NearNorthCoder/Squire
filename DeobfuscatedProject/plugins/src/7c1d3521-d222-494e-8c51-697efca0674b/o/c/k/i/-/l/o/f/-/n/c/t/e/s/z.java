...
implements ac {
            ...
            if (z.llIIIIIIIIIlI(Inventory.getCount((String[])stringArray2))) {
                ...
                if (z.llIIIIIIIIIlI(Inventory.getCount((String[])stringArray3))) {
                    ...
                    if (z.llIIIIIIIIIlI(Inventory.getCount((String[])stringArray4))) {
                        ...
                        return ((0x25 ^ 0x6D ^ (0x2C ^ 0x4B)) & (131 + 86 - 178 + 106 ^ 167 + 155 - 152 + 20 ^ -" ".length())) != 0;
                    }
                }
            }
        }
    ...
    private static void Q() {
        d lllllllllllllllllIlllIllllllIIlI;
        Object lllllllllllllllllIlllIllllllIIll;
        ...
        if (z.llIIIIIIIIIII(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lllllllllllllllllIlllIllllllIIll = new d(lllIIIlllI[11], lllIIIlllI[1], lllIIIlllI[45]);
            bv.add((d)lllllllllllllllllIlllIllllllIIll);
            "".length();
        }
        int[] nArray3 = new int[lllIIIlllI[1]];
        nArray3[z.lllIIIlllI[0]] = lllIIIlllI[12];
        if (z.llIIIIIIIIIII(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllllIlllIllllllIIll = new d(lllIIIlllI[12], lllIIIlllI[1], lllIIIlllI[45]);
            bv.add((d)lllllllllllllllllIlllIllllllIIll);
            "".length();
        }
        ...
        if (z.llIIIIIIIIIII(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllllIlllIllllllIIll = new d(lllIIIlllI[14], lllIIIlllI[1], lllIIIlllI[45]);
            bv.add((d)lllllllllllllllllIlllIllllllIIll);
            "".length();
        }
        ...
        if (z.llIIIIIIIIIII(Bank.contains((int[])nArray5) ? 1 : 0)) {
            lllllllllllllllllIlllIllllllIIll = new d(lllIIIlllI[13], lllIIIlllI[1], lllIIIlllI[45]);
            bv.add((d)lllllllllllllllllIlllIllllllIIll);
            "".length();
        }
        ...
        if (z.llIIIIIIIIIII(Bank.contains((int[])nArray6) ? 1 : 0)) {
            lllllllllllllllllIlllIllllllIIll = new d(lllIIIlllI[4], lllIIIlllI[17], lllIIIlllI[45]);
            bv.add((d)lllllllllllllllllIlllIllllllIIll);
            "".length();
        }
        if (z.llIIIIIIIIIII(Bank.contains((Predicate)(lllllllllllllllllIlllIllllllIIll = item -> item.getName().toLowerCase().contains(lllIIIllIl[lllIIIlllI[53]]))) ? 1 : 0)) {
            lllllllllllllllllIlllIllllllIIlI = new d(lllIIIlllI[46], lllIIIlllI[9], lllIIIlllI[47]);
            bv.add(lllllllllllllllllIlllIllllllIIlI);
            "".length();
        }
        int[] nArray7 = new int[lllIIIlllI[1]];
        nArray7[z.lllIIIlllI[0]] = lllIIIlllI[48];
        if (z.llIIIIIIIIIII(Bank.contains((int[])nArray7) ? 1 : 0)) {
            lllllllllllllllllIlllIllllllIIlI = new d(lllIIIlllI[48], lllIIIlllI[49], lllIIIlllI[50]);
            bv.add(lllllllllllllllllIlllIllllllIIlI);
            "".length();
        }
    }
    ...
    private static String lIlllllllIlll(String lllllllllllllllllIlllIlllllIlIII, String lllllllllllllllllIlllIlllllIIlll) {
        try {
            SecretKeySpec lllllllllllllllllIlllIlllllIlIll = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIlllIlllllIIlll.getBytes(StandardCharsets.UTF_8)), lllIIIlllI[19]), "DES");
            Cipher lllllllllllllllllIlllIlllllIlIlI = Cipher.getInstance("DES");
            lllllllllllllllllIlllIlllllIlIlI.init(lllIIIlllI[3], lllllllllllllllllIlllIlllllIlIll);
            return new String(lllllllllllllllllIlllIlllllIlIlI.doFinal(Base64.getDecoder().decode(lllllllllllllllllIlllIlllllIlIII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIllllllllIlI() {
        ...
        z.lllIIIllIl[z.lllIIIlllI[0]] = z.lIlllllllIlll("3MwGqhznBZgeH4YIvVmJ1Q==", "Xwklq");
        z.lllIIIllIl[z.lllIIIlllI[1]] = z.lIlllllllIlll("Ltp3NcyKbb86orQHWwpnHvITjl09EIKm6pcN9TpuvxY1uyEBb2YB5ZHxhXD6cCWe", "CnnJT");
        z.lllIIIllIl[z.lllIIIlllI[3]] = z.lIlllllllIlll("N3FvgEBCMh8=", "PIYzA");
        z.lllIIIllIl[z.lllIIIlllI[5]] = z.lIllllllllIII("X4G9jd1QiBw=", "VhOXe");
        z.lllIIIllIl[z.lllIIIlllI[8]] = z.lIllllllllIIl("ISsXdgAAagM3GgQ=", "oJaVt");
        z.lllIIIllIl[z.lllIIIlllI[9]] = z.lIllllllllIIl("AikhIjgjJihmNismJC86LQ==", "JHOFT");
        z.lllIIIllIl[z.lllIIIlllI[15]] = z.lIllllllllIIl("ACNYEzoyZhUbOyQvFhVoJjMdATx3NQ0CODsvHQFkdzUPGzw0LhEcL3cyF1IKAh8xPA8=", "WFxrH");
        z.lllIIIllIl[z.lllIIIlllI[18]] = z.lIllllllllIIl("IwMfcCYCQhokMx8W", "mbiPR");
        z.lllIIIllIl[z.lllIIIlllI[19]] = z.lIllllllllIII("UAsCcq213YcbCXga3NJpsg==", "dletC");
        z.lllIIIllIl[z.lllIIIlllI[20]] = z.lIllllllllIII("dBfBa+Ku+xwvgQPsjcUILg==", "hMsNj");
        z.lllIIIllIl[z.lllIIIlllI[17]] = z.lIllllllllIII("Yvpb1w9cIpqlR7p+iMVodw==", "TRqWu");
        z.lllIIIllIl[z.lllIIIlllI[21]] = z.lIllllllllIIl("ASgvCVYmKC0EEyI=", "UICbv");
        z.lllIIIllIl[z.lllIIIlllI[22]] = z.lIllllllllIIl("HhcZCz86", "MvwmZ");
        z.lllIIIllIl[z.lllIIIlllI[23]] = z.lIlllllllIlll("YTamqFtMd8RnKGWb51uuhA==", "usxUT");
        z.lllIIIllIl[z.lllIIIlllI[24]] = z.lIllllllllIII("/jjWbo/UQ9PYklapu2G/Vg==", "QztTC");
        z.lllIIIllIl[z.lllIIIlllI[26]] = z.lIllllllllIII("bH0yN/5qKGW81PObH4uxCQ==", "mFUKX");
        z.lllIIIllIl[z.lllIIIlllI[27]] = z.lIllllllllIIl("BzkPYhE0LFgvBjQs", "UXxBc");
        z.lllIIIllIl[z.lllIIIlllI[28]] = z.lIlllllllIlll("Sy84d33BokGZ6he9Od6DEQ==", "zWSrU");
        z.lllIIIllIl[z.lllIIIlllI[29]] = z.lIllllllllIII("dDNEL5MBclLU5ImMo2xO3g==", "ZqVfI");
        z.lllIIIllIl[z.lllIIIlllI[30]] = z.lIllllllllIII("/UYuDXAC6SXI/9eKImXG5w==", "RFCow");
        z.lllIIIllIl[z.lllIIIlllI[31]] = z.lIlllllllIlll("8U62Cp9ta8n3WZMWO4JYpg==", "eObcn");
        z.lllIIIllIl[z.lllIIIlllI[32]] = z.lIlllllllIlll("5i6a7qaWpHY=", "XmrPo");
        z.lllIIIllIl[z.lllIIIlllI[33]] = z.lIllllllllIII("F5n5iRaLb1KpRXs5im321w==", "mjznj");
        z.lllIIIllIl[z.lllIIIlllI[34]] = z.lIllllllllIIl("IBQLIVoaBQQ=", "tugJz");
        z.lllIIIllIl[z.lllIIIlllI[35]] = z.lIlllllllIlll("B0H7ND4hz1utlj89X6TcAw==", "ozQHU");
        z.lllIIIllIl[z.lllIIIlllI[36]] = z.lIllllllllIIl("ACMqMDUrOSw8dCcoKCo=", "EMIXT");
        z.lllIIIllIl[z.lllIIIlllI[37]] = z.lIllllllllIIl("Mx85ECsYBT8cahUZMxshEx8=", "vqZxJ");
        z.lllIIIllIl[z.lllIIIlllI[38]] = z.lIllllllllIII("v+KdicFRgzJOibIGUE7icg==", "ODiiU");
        z.lllIIIllIl[z.lllIIIlllI[39]] = z.lIllllllllIII("yTcGkkCBBhumbiGtOQXF8w==", "wFiee");
        z.lllIIIllIl[z.lllIIIlllI[40]] = z.lIllllllllIIl("BgckRxE8DzAMFzo=", "TfSgr");
        z.lllIIIllIl[z.lllIIIlllI[41]] = z.lIllllllllIIl("OhsHTg8NHxY=", "hzpnm");
        z.lllIIIllIl[z.lllIIIlllI[42]] = z.lIlllllllIlll("OkfIHB1PIIIcvR33IFTHug==", "BEoFf");
        z.lllIIIllIl[z.lllIIIlllI[43]] = z.lIllllllllIIl("PCUcQiIPMEsPNQ8w", "nDkbP");
        z.lllIIIllIl[z.lllIIIlllI[52]] = z.lIllllllllIII("EqCBOxge4cMkiSpMnaZgw84zh+PwWa1C", "dDdGB");
        z.lllIIIllIl[z.lllIIIlllI[53]] = z.lIlllllllIlll("0Ia+ooGcr43E9cuSHHMZc7QRowRX2baW", "WUYNS");
        z.lllIIIllIl[z.lllIIIlllI[60]] = z.lIllllllllIII("hw21PWmW6DH2DqteT925XgqJZqOTQhQkB7tC4GB3YRA=", "yUXzr");
        z.lllIIIllIl[z.lllIIIlllI[61]] = z.lIllllllllIII("ixxDtTMaGD5YR5WbA/LI6cShcsOBbGYBjB9a4dcTn0w=", "zJmer");
        z.lllIIIllIl[z.lllIIIlllI[62]] = z.lIllllllllIIl("LQEEWw==", "tdwuX");
        z.lllIIIllIl[z.lllIIIlllI[63]] = z.lIlllllllIlll("DjnIvOEDrSASMHgv09S/Uk87vpFRuLCU2tOQlZX6423U5+uPVnR1PeLMvM+olYLswmcCxiizd8w=", "SytBl");
        z.lllIIIllIl[z.lllIIIlllI[64]] = z.lIllllllllIIl("BSZdchttIR1yNiVtBTozPm0FOjckYw==", "JMqRR");
    }
    ...
    public boolean ah() {
        ...
        if (z.llIIIIIIIIlll(e.j(lllIIIlllI[7]), lllIIIlllI[8])) {
            ...
            "".length();
            if (null != null) {
                return ((70 + 0 - -31 + 43 ^ 22 + 39 - -9 + 73) & (152 + 53 - 140 + 103 ^ 110 + 103 - 210 + 180 ^ -" ".length())) != 0;
            }
        } else {
            bl = lllIIIlllI[0];
        }
    ...
    public static void bt() {
        block40: {
            BankLocation lllllllllllllllllIlllIlllllllIlI;
            block42: {
                block41: {
                ...
                if (z.lIlllllllllll(e.j(lllIIIlllI[7]), lllIIIlllI[1])) {
                    lllllllllllllllllIlllIlllllllIlI = BankLocation.getNearest();
                    if (z.llIIIIIIIIIll(lllllllllllllllllIlllIlllllllIlI) && z.llIIIIIIIIIII(lllllllllllllllllIlllIlllllllIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderSotf.c = lllIIIllIl[lllIIIlllI[8]];
                        a.a(lllllllllllllllllIlllIlllllllIlI);
                        Time.sleepTicks((int)lllIIIlllI[3]);
                        "".length();
                    }
                    if (z.llIIIIIIIIIll(lllllllllllllllllIlllIlllllllIlI) && z.lIllllllllllI(lllllllllllllllllIlllIlllllllIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (z.llIIIIIIIIllI(e.j(lllIIIlllI[7]), lllIIIlllI[3]) && z.llIIIIIIIIIII(z.bu() ? 1 : 0)) {
                ...
                if (z.llIIIIIIIIlIl(Players.getLocal().getWorldLocation().distanceTo(ec), lllIIIlllI[5])) {
                    ...
                    lllllllllllllllllIlllIlllllllIlI = TileObjects.getNearest((int[])nArray);
                    if (z.llIIIIIIIIIll(lllllllllllllllllIlllIlllllllIlI)) {
                        String[] stringArray = new String[lllIIIlllI[1]];
                        stringArray[z.lllIIIlllI[0]] = lllIIIllIl[lllIIIlllI[26]];
                        Item lllllllllllllllllIlllIlllllllIIl = Inventory.getFirst((String[])stringArray);
                        String[] stringArray2 = new String[lllIIIlllI[1]];
                        stringArray2[z.lllIIIlllI[0]] = lllIIIllIl[lllIIIlllI[27]];
                        Item lllllllllllllllllIlllIlllllllIII = Inventory.getFirst((String[])stringArray2);
                        String[] stringArray3 = new String[lllIIIlllI[1]];
                        stringArray3[z.lllIIIlllI[0]] = lllIIIllIl[lllIIIlllI[28]];
                        Item lllllllllllllllllIlllIllllllIlll = Inventory.getFirst((String[])stringArray3);
                        String[] stringArray4 = new String[lllIIIlllI[1]];
                        stringArray4[z.lllIIIlllI[0]] = lllIIIllIl[lllIIIlllI[29]];
                        Item lllllllllllllllllIlllIllllllIllI = Inventory.getFirst((String[])stringArray4);
                        if (z.llIIIIIIIIIll(lllllllllllllllllIlllIlllllllIIl)) {
                            lllllllllllllllllIlllIlllllllIIl.useOn((TileObject)lllllllllllllllllIlllIlllllllIlI);
                            Time.sleepTicks((int)lllIIIlllI[1]);
                            "".length();
                        }
                        if (z.llIIIIIIIIIll(lllllllllllllllllIlllIlllllllIII)) {
                            lllllllllllllllllIlllIlllllllIII.useOn((TileObject)lllllllllllllllllIlllIlllllllIlI);
                            Time.sleepTicks((int)lllIIIlllI[1]);
                            "".length();
                        }
                        if (z.llIIIIIIIIIll(lllllllllllllllllIlllIllllllIlll)) {
                            lllllllllllllllllIlllIllllllIlll.useOn((TileObject)lllllllllllllllllIlllIlllllllIlI);
                            Time.sleepTicks((int)lllIIIlllI[1]);
                            "".length();
                        }
                        if (z.llIIIIIIIIIll(lllllllllllllllllIlllIllllllIllI)) {
                            lllllllllllllllllIlllIllllllIllI.useOn((TileObject)lllllllllllllllllIlllIlllllllIlI);
                            Time.sleepTicks((int)lllIIIlllI[1]);
                            "".length();
                        }
                    }
    ...
    private static String lIllllllllIII(String lllllllllllllllllIlllIllllIIIIIl, String lllllllllllllllllIlllIllllIIIIII) {
        try {
            SecretKeySpec lllllllllllllllllIlllIllllIIIllI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIlllIllllIIIIII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllllIlllIllllIIIlIl = Cipher.getInstance("Blowfish");
            lllllllllllllllllIlllIllllIIIlIl.init(lllIIIlllI[3], lllllllllllllllllIlllIllllIIIllI);
            return new String(lllllllllllllllllIlllIllllIIIlIl.doFinal(Base64.getDecoder().decode(lllllllllllllllllIlllIllllIIIIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIllllllllIIl(String lllllllllllllllllIlllIllllIllIII, String lllllllllllllllllIlllIllllIlIIlI) {
        lllllllllllllllllIlllIllllIllIII = new String(Base64.getDecoder().decode(lllllllllllllllllIlllIllllIllIII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllIlllIllllIlIllI = new StringBuilder();
        char[] lllllllllllllllllIlllIllllIlIlIl = lllllllllllllllllIlllIllllIlIIlI.toCharArray();
        int lllllllllllllllllIlllIllllIlIlII = lllIIIlllI[0];
        char[] lllllllllllllllllIlllIllllIIlllI = lllllllllllllllllIlllIllllIllIII.toCharArray();
        int lllllllllllllllllIlllIllllIIllIl = lllllllllllllllllIlllIllllIIlllI.length;
        int lllllllllllllllllIlllIllllIIllII = lllIIIlllI[0];
        while (z.lIlllllllllll(lllllllllllllllllIlllIllllIIllII, lllllllllllllllllIlllIllllIIllIl)) {
            char lllllllllllllllllIlllIllllIllIIl = lllllllllllllllllIlllIllllIIlllI[lllllllllllllllllIlllIllllIIllII];
            lllllllllllllllllIlllIllllIlIllI.append((char)(lllllllllllllllllIlllIllllIllIIl ^ lllllllllllllllllIlllIllllIlIlIl[lllllllllllllllllIlllIllllIlIlII % lllllllllllllllllIlllIllllIlIlIl.length]));
            "".length();
