...
implements ac {
    ...
    private static void lIlllIIIIIlII() {
        ...
        P.llIllIlllI[31] = " ".length() ^ (0x88 ^ 0x9B);
        ...
        P.llIllIlllI[91] = 0x7D ^ 0x36 ^ "   ".length();
    ...
    public boolean ah() {
        ...
        if (P.lIlllIIIIllIl(e.j(llIllIlllI[2]), llIllIlllI[18])) {
            bl = llIllIlllI[3];
            "".length();
            if (((0xF1 ^ 0xC7 ^ (0xF1 ^ 0x81)) & (0x38 ^ 0x69 ^ (0x3B ^ 0x2C) ^ -" ".length())) != 0) {
    ...
    private static void lIlllIIIIIIII() {
        ...
        P.llIllIlIlI[P.llIllIlllI[4]] = P.lIllIlllIllll("dsvBX5G2qmd+K5/q4ac7rg==", "RkTdK");
        P.llIllIlIlI[P.llIllIlllI[3]] = P.lIllIllllIIII("Fi8MJBs4IwZtCiU/CyMPcC8WKAUjakI+HzkyASUBPiFCLwkzLUI5B3A3FygbJC8MKg==", "PFbMh");
        P.llIllIlIlI[P.llIllIlllI[1]] = P.lIllIllllIIIl("NgXcn1pAxpBWfiXyXAGQTQ==", "RGmJw");
        P.llIllIlIlI[P.llIllIlllI[12]] = P.lIllIllllIIIl("nt7Wn69HNo0=", "emMmW");
        P.llIllIlIlI[P.llIllIlllI[15]] = P.lIllIllllIIII("KiIEcycLYwEnMhY3", "dCrSS");
        P.llIllIlIlI[P.llIllIlllI[13]] = P.lIllIllllIIII("KTsiDQY=", "mIKcm");
        P.llIllIlIlI[P.llIllIlllI[14]] = P.lIllIllllIIII("DCwQ", "NCirJ");
        P.llIllIlIlI[P.llIllIlllI[18]] = P.lIllIllllIIII("Lwg3EREAHSgWEUEdLlgZFB0yERIESSUXGRM=", "aiAxv");
        P.llIllIlIlI[P.llIllIlllI[20]] = P.lIllIlllIllll("8I2gcyN4rbQ=", "qWhNw");
        P.llIllIlIlI[P.llIllIlllI[21]] = P.lIllIlllIllll("rsnj6i1O7SGpjG2gS8fg+g==", "nsoRs");
        P.llIllIlIlI[P.llIllIlllI[22]] = P.lIllIllllIIII("PighH3cHKSoRKA==", "rGNtZ");
        P.llIllIlIlI[P.llIllIlllI[24]] = P.lIllIllllIIIl("UtY9REEKl8izEU3wopnXWg==", "jtduA");
        P.llIllIlIlI[P.llIllIlllI[25]] = P.lIllIlllIllll("SMFgh4T/24Q=", "Ryuat");
        P.llIllIlIlI[P.llIllIlllI[26]] = P.lIllIllllIIIl("HSo6qvMFUyc=", "iiazt");
        P.llIllIlIlI[P.llIllIlllI[27]] = P.lIllIlllIllll("5t/kGII5sTuykY7KfQiQIR9sOK/1tBBV", "Cqgfe");
        P.llIllIlIlI[P.llIllIlllI[28]] = P.lIllIllllIIII("KA0PViMJTBQXMAgJDVY1CRQ=", "flyvW");
        P.llIllIlIlI[P.llIllIlllI[29]] = P.lIllIlllIllll("Qw7DELHuVQMh7vHIMdftYw==", "YlMSg");
        P.llIllIlIlI[P.llIllIlllI[30]] = P.lIllIllllIIII("EikHADQhaAEIPSgtGA==", "FHliZ");
        P.llIllIlIlI[P.llIllIlllI[31]] = P.lIllIllllIIIl("fTelrXwuEq8=", "WrSFj");
        P.llIllIlIlI[P.llIllIlllI[32]] = P.lIllIllllIIIl("rlocs7gAJjg=", "buXJE");
        P.llIllIlIlI[P.llIllIlllI[33]] = P.lIllIllllIIIl("SRyR1nK/JrU=", "BpUDY");
        P.llIllIlIlI[P.llIllIlllI[34]] = P.lIllIllllIIII("OScCOgoC", "jBcHi");
        P.llIllIlIlI[P.llIllIlllI[35]] = P.lIllIllllIIIl("FhiWASREbco=", "DEQDu");
        P.llIllIlIlI[P.llIllIlllI[36]] = P.lIllIllllIIII("JSQDAiUIPgg=", "fKmvL");
        P.llIllIlIlI[P.llIllIlllI[37]] = P.lIllIlllIllll("hkISwjo7Y5g=", "bbPjO");
        P.llIllIlIlI[P.llIllIlllI[38]] = P.lIllIllllIIIl("ks1ximmI4k8=", "WgOVr");
        P.llIllIlIlI[P.llIllIlllI[40]] = P.lIllIllllIIII("BTARRBIkcQoFASU0E0QEJCk=", "KQgdf");
        P.llIllIlIlI[P.llIllIlllI[41]] = P.lIllIllllIIII("FgIXMwA0BQM=", "UwgQo");
        P.llIllIlIlI[P.llIllIlllI[42]] = P.lIllIlllIllll("dpFFxKEqE8u8tazVnAvvFQ==", "reVWn");
        P.llIllIlIlI[P.llIllIlllI[43]] = P.lIllIllllIIIl("+aEZlB7prIo=", "bAQWh");
        P.llIllIlIlI[P.llIllIlllI[44]] = P.lIllIlllIllll("ZCi+Z2VOQSE=", "RPqJz");
        P.llIllIlIlI[P.llIllIlllI[45]] = P.lIllIlllIllll("g5lTSS+/8RU=", "CrKrL");
        P.llIllIlIlI[P.llIllIlllI[46]] = P.lIllIllllIIII("Bg8PEBM9", "Ujnbp");
        P.llIllIlIlI[P.llIllIlllI[47]] = P.lIllIlllIllll("4mpJr51Ea8Nesg1XOq+3aA==", "vowvW");
        P.llIllIlIlI[P.llIllIlllI[48]] = P.lIllIllllIIII("Njk0Jw==", "XLXKx");
        P.llIllIlIlI[P.llIllIlllI[49]] = P.lIllIllllIIIl("5z7fHL0clQM=", "hCzeW");
        P.llIllIlIlI[P.llIllIlllI[50]] = P.lIllIllllIIII("NDUEdQQVdBE9FR8nF3UDCjsG", "zTrUp");
        P.llIllIlIlI[P.llIllIlllI[51]] = P.lIllIlllIllll("ocXk2fSHXbftc3qgiCr+/g==", "pWoHz");
        P.llIllIlIlI[P.llIllIlllI[52]] = P.lIllIllllIIII("Ji4vFSM=", "kAZfF");
        P.llIllIlIlI[P.llIllIlllI[53]] = P.lIllIllllIIIl("U7Wyoi1EDiwuC8vMEYS17g==", "JiDEA");
        P.llIllIlIlI[P.llIllIlllI[54]] = P.lIllIllllIIIl("oMtdfqeoV+w=", "ydWqG");
        P.llIllIlIlI[P.llIllIlllI[55]] = P.lIllIllllIIIl("1Aek4mvJxd4=", "xIScG");
        P.llIllIlIlI[P.llIllIlllI[56]] = P.lIllIllllIIIl("lu4ntwpozWmi4MeLwC5kMw==", "Ljsoj");
        P.llIllIlIlI[P.llIllIlllI[57]] = P.lIllIllllIIII("Kz86HQUHPylYGg8rKw==", "nQNxw");
        P.llIllIlIlI[P.llIllIlllI[61]] = P.lIllIlllIllll("MzyKA7FLB7eIs7tSigEVeFOfPkVWI44/", "gtRxz");
        P.llIllIlIlI[P.llIllIlllI[63]] = P.lIllIllllIIIl("HFE/5laHXYU=", "VTvLA");
        P.llIllIlIlI[P.llIllIlllI[64]] = P.lIllIlllIllll("zNfTPgPasU7PPu4el+DMow==", "YvwFX");
        P.llIllIlIlI[P.llIllIlllI[65]] = P.lIllIlllIllll("6yEUDI6P8rc8Fg0u1n+1eX2oWoW9fy25", "bWjfE");
        P.llIllIlIlI[P.llIllIlllI[66]] = P.lIllIllllIIIl("B1jWeBNCwto=", "WSYKI");
        P.llIllIlIlI[P.llIllIlllI[67]] = P.lIllIllllIIII("KiY6GQcHIGkeHgwrJQ==", "iGImn");
        P.llIllIlIlI[P.llIllIlllI[68]] = P.lIllIlllIllll("xekBVM7EHKTZ7jQiwNCoJw==", "hQsYk");
        P.llIllIlIlI[P.llIllIlllI[69]] = P.lIllIllllIIII("HzECIGMrLR4g", "YXpEC");
        P.llIllIlIlI[P.llIllIlllI[70]] = P.lIllIllllIIIl("ZGZDMEts7SA=", "EEyoA");
        P.llIllIlIlI[P.llIllIlllI[71]] = P.lIllIllllIIIl("uS8L9Hvl++U=", "LKcaQ");
        P.llIllIlIlI[P.llIllIlllI[72]] = P.lIllIllllIIII("AA8GDw0zTg8HDzg=", "Tnmfc");
        P.llIllIlIlI[P.llIllIlllI[73]] = P.lIllIllllIIIl("i18sC11WfUM=", "XItMD");
        P.llIllIlIlI[P.llIllIlllI[74]] = P.lIllIllllIIII("ITI+JA==", "cSRHR");
        P.llIllIlIlI[P.llIllIlllI[75]] = P.lIllIllllIIII("MSEoCx0aPSpKAhIx", "sSMjv");
        P.llIllIlIlI[P.llIllIlllI[76]] = P.lIllIlllIllll("oDBws0Xvdl4=", "MFQOx");
        P.llIllIlIlI[P.llIllIlllI[77]] = P.lIllIllllIIIl("FPt8TdwGx1nY40XtclMZ9R6NZkR9TmsU", "VwUNJ");
        P.llIllIlIlI[P.llIllIlllI[78]] = P.lIllIlllIllll("gdfLUAmRyyzTYN12ibKv5cryaZeQn7mZ", "KQkTb");
        P.llIllIlIlI[P.llIllIlllI[79]] = P.lIllIlllIllll("LunO3cmPHwQ=", "HRUUf");
        P.llIllIlIlI[P.llIllIlllI[80]] = P.lIllIllllIIIl("eMrViHnMlmo=", "kToaP");
        P.llIllIlIlI[P.llIllIlllI[81]] = P.lIllIllllIIII("DSoEBhQhKhdDCyk+FQ==", "HDpcf");
        P.llIllIlIlI[P.llIllIlllI[83]] = P.lIllIllllIIIl("DrxmzSFvAZ21gjJ831hw1FYzFMcngvAx", "cTfei");
        P.llIllIlIlI[P.llIllIlllI[84]] = P.lIllIllllIIII("Pw4TayEeTxYuNh4BAWsmAQAR", "qoeKU");
        P.llIllIlIlI[P.llIllIlllI[85]] = P.lIllIlllIllll("X40+6hhuzBLfc+8ZnkztORH5c+cFVfip", "bWkzM");
        P.llIllIlIlI[P.llIllIlllI[86]] = P.lIllIllllIIII("PAcYSDwdRggHPRwSDwEm", "rfnhH");
        P.llIllIlIlI[P.llIllIlllI[87]] = P.lIllIlllIllll("Wk1JpTRhi1LQdGj3l7zP0A==", "Fevpz");
        P.llIllIlIlI[P.llIllIlllI[88]] = P.lIllIlllIllll("v9e5Q3wJMGBUV+E5+uz5ZA==", "LeRnU");
        P.llIllIlIlI[P.llIllIlllI[89]] = P.lIllIllllIIII("Jj4oOQk=", "eVMZb");
        P.llIllIlIlI[P.llIllIlllI[90]] = P.lIllIllllIIII("Fz8dGhA6JRY=", "TPsny");
        P.llIllIlIlI[P.llIllIlllI[91]] = P.lIllIlllIllll("jgFdNlPJ3cA=", "AGITL");
        P.llIllIlIlI[P.llIllIlllI[92]] = P.lIllIllllIIII("TQ==", "mJrVX");
        P.llIllIlIlI[P.llIllIlllI[95]] = P.lIllIllllIIII("BRs1RCMqGShENSQNIhYlaxciHiQ=", "KzCdA");
        P.llIllIlIlI[P.llIllIlllI[96]] = P.lIllIlllIllll("WOSVt6sCd4KK+eJ41mwFxN7PewcTx+oC", "gFIqO");
        P.llIllIlIlI[P.llIllIlllI[97]] = P.lIllIllllIIII("DBccGTIjAgMeMmICBVA3IxgB", "BvjpU");
        P.llIllIlIlI[P.llIllIlllI[98]] = P.lIllIllllIIII("BhgcNDMnD1k4OycD", "IhyZZ");
        P.llIllIlIlI[P.llIllIlllI[100]] = P.lIllIlllIllll("tpeWowpDKG7pQA0eSr54xGAbcbNFDRpO", "cBLEY");
        P.llIllIlIlI[P.llIllIlllI[102]] = P.lIllIllllIIIl("0ZcHxSRdJdZsGaA1l3xRHkHMKXY8tcUfNqegQH8vNJTsh4r+wqD1etcZUaghWM9e", "Ucsfk");
        P.llIllIlIlI[P.llIllIlllI[16]] = P.lIllIllllIIIl("LtgvixBcMUBbpbP64OL4x6cQJiVnPF8VJ/g2RDmEtqvzHXeepKBoIuYf5sGPjEvq", "cTbfk");
        P.llIllIlIlI[P.llIllIlllI[103]] = P.lIllIllllIIIl("fH4y2vt5cWPm+22zlLG+u2CWDUY/PMZfM0mbPki+4krVzfsyqakdJ00r16mlzWHa", "JxVqy");
        P.llIllIlIlI[P.llIllIlllI[104]] = P.lIllIlllIllll("wuAH4TsBbHdLsjpaf54dXB/kiYkBjxwTd0xSjX2EWiGfNdaeVMbHEqfLkDY+1MYa", "jUshU");
        P.llIllIlIlI[P.llIllIlllI[106]] = P.lIllIllllIIIl("Xyig9HK5xnS1GtkelTa1UxlQws2QC0rom5eZupuMkYhXcdjmBH5uHSXJPbA+rsIZ", "UsNGR");
        P.llIllIlIlI[P.llIllIlllI[116]] = P.lIllIllllIIIl("AP9kpjh/vAhJp9bZShL+wSTi5j/Osicm", "XQFID");
        P.llIllIlIlI[P.llIllIlllI[117]] = P.lIllIllllIIIl("ifVUBYVmuRO0Grbxyuoo+SO/ZxaxY1sN", "YnFdd");
        P.llIllIlIlI[P.llIllIlllI[163]] = P.lIllIllllIIIl("sbYB0frn4Vrv1eNRB4O4rw==", "omNuA");
        P.llIllIlIlI[P.llIllIlllI[164]] = P.lIllIllllIIIl("2bSxKfvzgNzgyRuA90fQC0ocXwrgUB06", "huwjX");
        P.llIllIlIlI[P.llIllIlllI[165]] = P.lIllIllllIIIl("b4yaNmwDGa5vhhBx4SIXzQ==", "mROVI");
        P.llIllIlIlI[P.llIllIlllI[166]] = P.lIllIllllIIIl("YVj0MxBu5sfowdAi/3LosIXnkJUunsJ3HHbglZXrYLt2itZXXi5ZfCkY4iPcw1kP", "LVdXY");
        P.llIllIlIlI[P.llIllIlllI[167]] = P.lIllIllllIIIl("wZXByQjG8E8=", "pPjJn");
        P.llIllIlIlI[P.llIllIlllI[168]] = P.lIllIllllIIIl("dDgNC2tLydewp7gAD6h5rG601GPI7pdk", "vEXKK");
        P.llIllIlIlI[P.llIllIlllI[169]] = P.lIllIllllIIII("ACxFUyFoKwVTGyoiSQQALjNJOkgsJgdTDCBp", "OGish");
    }
                            ...
                            if (P.lIlllIIIIIllI(e.j(llIllIlllI[0]), llIllIlllI[1]) && P.lIlllIIIIIlIl(e.j(llIllIlllI[2]), llIllIlllI[3])) {
                                block88: {
                                    ...
                                    do {
                                        ...
                                        "".length();
                                        "".length();
                                    } while (((204 + 208 - 235 + 47 ^ 54 + 5 - 16 + 88) & (0x5D ^ 0x13 ^ (0xBB ^ 0x96) ^ -" ".length())) <= "  ".length());
                                    return;
                                }
                ...
                if (P.lIlllIIIIIlIl(Inventory.getCount((int[])nArray14), llIllIlllI[3])) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (P.lIlllIIIIlllI(Inventory.getCount((int[])nArray))) {
                            ...
                            "".length();
                            if (-"   ".length() >= 0) {
                                return ((0x6E ^ 0x71 ^ (0x35 ^ 0x30)) & (0x19 ^ 0x64 ^ (0x62 ^ 5) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = llIllIlllI[4];
                        }
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (P.lIlllIIIIlllI(Inventory.getCount((int[])nArray))) {
                            ...
                            if (-(0x4C ^ 0x41 ^ (0xA8 ^ 0xA1)) > 0) {
                                return ((66 + 77 - 33 + 58 ^ 49 + 171 - 120 + 75) & (0x1C ^ 0x3D ^ (0x87 ^ 0xA1) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = llIllIlllI[4];
                        }
