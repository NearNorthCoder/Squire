...
implements ac {
    ...
    private static void lIlIlIIllIllI() {
        ...
        T.llIIlIIllI[T.llIIlIIlll[0]] = T.lIlIlIIllIIll("MhQ0LzYXQSQyPR0S", "paMFX");
        T.llIIlIIllI[T.llIIlIIlll[1]] = T.lIlIlIIllIIll("ASghLRQvJCtkBTI4JioAZyg7IQo0bW83EC41LCwOKSZvJgYkKm8wCGcwOiEUMw==", "GAODg");
        T.llIIlIIllI[T.llIIlIIlll[3]] = T.lIlIlIIllIlII("z76ctGIbxeI=", "wWpvF");
        T.llIIlIIllI[T.llIIlIIlll[5]] = T.lIlIlIIllIIll("OQcuVgAYRjoXGhw=", "wfXvt");
        T.llIIlIIllI[T.llIIlIIlll[6]] = T.lIlIlIIllIIll("LyIELAIOLQ1oDAYtASEAAA==", "gCjHn");
        T.llIIlIIllI[T.llIIlIIlll[12]] = T.lIlIlIIllIlII("fp3qe/d/4Su+QjsBvkp/QU1DunnJkl9hb+u3zRmNagcx2Pegov5OjoLWmWiLg6AnB9s/t1A4eeQ=", "lBpuW");
        T.llIIlIIllI[T.llIIlIIlll[9]] = T.lIlIlIIllIIll("MS9VIz8DahgrPhUjGyVtFz8QMTlGOQAyPQojEDFhRjkCKzkFIhwsKkY+GmIPMxM8DAo=", "fJuBM");
        T.llIIlIIllI[T.llIIlIIlll[15]] = T.lIlIlIIllIIll("JAI3ShkFQzIeDBgX", "jcAjm");
        T.llIIlIIllI[T.llIIlIIlll[16]] = T.lIlIlIIllIlII("imoDEKqR5G3HmKnzwWntzw==", "SSIuE");
        T.llIIlIIllI[T.llIIlIIlll[17]] = T.lIlIlIIllIlII("Vp3Y27btJeo=", "EJhHD");
        T.llIIlIIllI[T.llIIlIIlll[18]] = T.lIlIlIIllIlII("sgR/o0MCf0w=", "HCoWw");
        T.llIIlIIllI[T.llIIlIIlll[19]] = T.lIlIlIIllIlIl("g7jYLed2G5k=", "MaNhP");
        T.llIIlIIllI[T.llIIlIIlll[20]] = T.lIlIlIIllIIll("BgYaBBo=", "Bihmy");
        T.llIIlIIllI[T.llIIlIIlll[21]] = T.lIlIlIIllIlIl("SszECdlEIj87O1u8foEB+A==", "cppUG");
        T.llIIlIIllI[T.llIIlIIlll[22]] = T.lIlIlIIllIlII("5kexF30YxpQlo4Mu3kqpN+QX85nrFvEu", "YFxgS");
        T.llIIlIIllI[T.llIIlIIlll[23]] = T.lIlIlIIllIlII("OhjWII5aSTc4leT+EopvTsA69Ejv+ipWA3ExAVdmWQllf0AoGHXRQoBwwOyYjP7xQpAdotV21Cc=", "eLxAi");
        T.llIIlIIllI[T.llIIlIIlll[30]] = T.lIlIlIIllIlIl("9T+7ykRNUOUl6T640QvASw==", "PHiFI");
        T.llIIlIIllI[T.llIIlIIlll[31]] = T.lIlIlIIllIlIl("qB77QMWCkHVcaTsAJV+uICXSBHs37rZE", "oVFGh");
        T.llIIlIIllI[T.llIIlIIlll[34]] = T.lIlIlIIllIlIl("vWNpk6kwnPMHyf/5IRCo/B4Y9d5xv/mP1jUnEUafnLk=", "SLxal");
        T.llIIlIIllI[T.llIIlIIlll[35]] = T.lIlIlIIllIlIl("nH7ro43GQio0WMRbb3X1vXhidTmQHITNUBEbNSHUYDDalZhuTgfZNQ==", "PQpLu");
        T.llIIlIIllI[T.llIIlIIlll[36]] = T.lIlIlIIllIlII("9WGia4zE8QYn+av71c0d/ikiVmw4xtf71cj95s4epXU=", "aMGGT");
        T.llIIlIIllI[T.llIIlIIlll[37]] = T.lIlIlIIllIlIl("kcp5tqDDrsY=", "zycVP");
    }
    ...
    private static String lIlIlIIllIIll(String llllllllllllllllllIlIIllIIlIIIII, String llllllllllllllllllIlIIllIIIlllll) {
        ...
        while (T.lIlIlIIlllIIl(llllllllllllllllllIlIIllIIIlIlII, llllllllllllllllllIlIIllIIIlIlIl)) {
            ...
            "".length();
            if (-" ".length() < ((0xA3 ^ 0x91) & ~(0x9E ^ 0xAC))) continue;
            return null;
        }
    ...
    private static void lIlIlIIllIlll() {
        ...
        T.llIIlIIlll[1] = " ".length();
        T.llIIlIIlll[2] = 0x41 ^ 0x73;
        T.llIIlIIlll[3] = "  ".length();
        T.llIIlIIlll[4] = 0xC6 ^ 0xBF ^ (0x1D ^ 0x7B);
        T.llIIlIIlll[5] = "   ".length();
    ...
    public boolean ah() {
        ...
        if (T.lIlIlIIllllIl(e.j(llIIlIIlll[4]), llIIlIIlll[14])) {
            bl = llIIlIIlll[1];
            "".length();
            if (((0x6B ^ 0x12 ^ (0x93 ^ 0xAF)) & (0x32 ^ 0x51 ^ (0x15 ^ 0x33) ^ -" ".length()) & ((65 + 47 - 75 + 107 ^ 10 + 156 - 93 + 87) & (127 + 17 - 84 + 124 ^ 98 + 39 - 23 + 22 ^ -" ".length()) ^ -" ".length())) != 0) {
                return ((0xD2 ^ 0xBD ^ (0x55 ^ 0x76)) & (160 + 210 - 179 + 38 ^ 150 + 18 - 27 + 28 ^ -" ".length())) != 0;
            }
        } else {
            bl = llIIlIIlll[0];
        }
        ...
        if (T.lIlIlIIllllIl(Inventory.getCount((int[])nArray), llIIlIIlll[9])) {
            ...
            if (T.lIlIlIIllllIl(Inventory.getCount((int[])nArray2), llIIlIIlll[3])) {
                ...
                if (T.lIlIlIIllllIl(Inventory.getCount((int[])nArray3), llIIlIIlll[6])) {
                    n2 = llIIlIIlll[1];
                    "".length();
                    if (((0x62 ^ 0x78 ^ (2 ^ 0x5E)) & (0xC5 ^ 0x94 ^ (0x52 ^ 0x45) ^ -" ".length())) == 0) return n2 != 0;
                    return ((156 + 158 - 218 + 74 ^ 156 + 92 - 120 + 61) & (0x25 ^ 0x7F ^ (0xCF ^ 0x82) ^ -" ".length())) != 0;
                }
            }
        }
        n2 = llIIlIIlll[0];
