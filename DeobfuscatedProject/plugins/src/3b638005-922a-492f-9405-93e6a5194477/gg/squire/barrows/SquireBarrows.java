...
extends SquirePlugin {
    ...
    private static void lIllIlIlIIIIII() {
        ...
        SquireBarrows.llllIlIIIIl[2] = (25 + 10 - -155 + 65 ^ 64 + 164 - 108 + 64) & (0xD7 ^ 0x9F ^ (0xAE ^ 0xA1) ^ -" ".length());
        ...
        SquireBarrows.llllIlIIIIl[11] = " ".length();
        SquireBarrows.llllIlIIIIl[12] = 0x8A ^ 0x82 ^ (0x56 ^ 0x4D);
        SquireBarrows.llllIlIIIIl[13] = "  ".length();
        SquireBarrows.llllIlIIIIl[14] = "   ".length();
    ...
    private static void lIllIlIIllllll() {
        ...
        SquireBarrows.llllIlIIIII[SquireBarrows.llllIlIIIIl[2]] = SquireBarrows.lIllIlIIllllII("IiUeJw==", "fJqUa");
        SquireBarrows.llllIlIIIII[SquireBarrows.llllIlIIIIl[11]] = SquireBarrows.lIllIlIIllllIl("hZYGg8GTXyw=", "mRtzS");
        SquireBarrows.llllIlIIIII[SquireBarrows.llllIlIIIIl[13]] = SquireBarrows.lIllIlIIlllllI("c0dlk97+sB0=", "RtEgj");
        SquireBarrows.llllIlIIIII[SquireBarrows.llllIlIIIIl[14]] = SquireBarrows.lIllIlIIlllllI("h0SPVMASJeY=", "mmleP");
        SquireBarrows.llllIlIIIII[SquireBarrows.llllIlIIIIl[15]] = SquireBarrows.lIllIlIIllllII("NjYAKD40PkMuMjkxAi0+KTQ=", "ZYcCW");
        SquireBarrows.llllIlIIIII[SquireBarrows.llllIlIIIIl[0]] = SquireBarrows.lIllIlIIllllIl("91IZ/AVbPVdxUiKVscq3Txxk0KxABg/S", "xaukC");
        SquireBarrows.llllIlIIIII[SquireBarrows.llllIlIIIIl[3]] = SquireBarrows.lIllIlIIllllIl("U3OH/Zm3bZI=", "PMLMw");
        SquireBarrows.llllIlIIIII[SquireBarrows.llllIlIIIIl[16]] = SquireBarrows.lIllIlIIlllllI("SGhm8yRUN/g=", "decDC");
        SquireBarrows.llllIlIIIII[SquireBarrows.llllIlIIIIl[17]] = SquireBarrows.lIllIlIIllllII("OwgGOg47CA==", "ImuNa");
    }
    ...
    public boolean i() {
        ...
        if (SquireBarrows.lIllIlIlIIIlIl((Object)this.m)) {
            ...
            "".length();
            if (-" ".length() > "   ".length()) {
                return ((0xFD ^ 0x85 ^ (0xF3 ^ 0xB8)) & (0x88 ^ 0x80 ^ (0x95 ^ 0xAE) ^ -" ".length())) != 0;
            }
        } else {
    ...
    public boolean m() {
        ...
        while (SquireBarrows.lIllIlIlIIIllI(llllllllllllllllIIIllIlIlIllIlIl, (int)llllllllllllllllIIIllIlIlIllIllI)) {
            ...
            return ((58 + 190 - 94 + 57 ^ 17 + 99 - 12 + 44) & (0x53 ^ 0x7A ^ (0x40 ^ 0x2E) ^ -" ".length())) != 0;
        }
        return llllIlIIIIl[2];
    }
    ...
    public boolean a(d d2) {
        ...
        if (SquireBarrows.lIllIlIlIIlIII(this.k.getVarbitValue(d2.F()))) {
            ...
            "".length();
            if (-" ".length() > "  ".length()) {
                return ((45 + 55 - 21 + 56 ^ 20 + 73 - 50 + 137) & (51 + 20 - -20 + 71 ^ 104 + 124 - 155 + 72 ^ -" ".length())) != 0;
            }
        } else {
            bl = llllIlIIIIl[2];
        }
