...
extends Task {
    ...
    public boolean run() {
        ...
        NPC llllllllllllllllIIIllIIlIIllIIlI = NPCs.getNearest(nPC -> {
            ...
            if (v.lIllIllIIIIIIl(llllllllllllllllIIIllIIlIIllIlII.contains(nPC) ? 1 : 0) && v.lIllIllIIIIIIl(Reachable.isInteractable((Locatable)nPC) ? 1 : 0)) {
                n2 = llllIlIllll[2];
                "".length();
                if (((0xC5 ^ 0xBB ^ (0xDE ^ 0xA7)) & (89 + 81 - 139 + 125 ^ 35 + 147 - 34 + 7 ^ -" ".length())) != ((0x79 ^ 0x40 ^ (0x7B ^ 2)) & (21 + 33 - -55 + 20 ^ 156 + 150 - 251 + 138 ^ -" ".length()))) {
                    return ((91 + 36 - 15 + 15 ^ (0x6F ^ 0x53)) & (0x48 ^ 0x53 ^ (0x7C ^ 0x24) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llllIlIllll[0];
            }
            ...
            TileObject llllllllllllllllIIIllIIlIIllIIIl = TileObjects.getNearest(tileObject -> {
                ...
                if (v.lIllIllIIIIIIl(tileObject.getName().equals(llllIlIllIl[llllIlIllll[5]]) ? 1 : 0)) {
                    ...
                    if (v.lIllIllIIIIIIl(tileObject.hasAction(stringArray) ? 1 : 0)) {
                        n2 = llllIlIllll[2];
                        "".length();
                        if (-" ".length() < ((89 + 147 - 85 + 2 ^ 29 + 102 - 7 + 71) & (157 + 221 - 256 + 113 ^ 136 + 21 - 33 + 53 ^ -" ".length()))) return n2 != 0;
                        return ((0x55 ^ 0x69 ^ (0x1D ^ 0x6B)) & (0xD ^ 0x23 ^ (0xE7 ^ 0x83) ^ -" ".length())) != 0;
                    }
                }
                n2 = llllIlIllll[0];
                return n2 != 0;
            ...
            TileObject llllllllllllllllIIIllIIlIIllIIII = TileObjects.getNearest(tileObject -> {
                ...
                if (v.lIllIllIIIIIIl(tileObject.getName().equals(llllIlIllIl[llllIlIllll[3]]) ? 1 : 0)) {
                    ...
                    if (v.lIllIllIIIIIIl(tileObject.hasAction(stringArray) ? 1 : 0)) {
                        n2 = llllIlIllll[2];
                        "".length();
                        if (-" ".length() != ((9 ^ 0x70 ^ (0xB1 ^ 0xAB)) & (0x75 ^ 0x67 ^ (0x75 ^ 4) ^ -" ".length()))) return n2 != 0;
                        return ((14 + 124 - 136 + 208 ^ 14 + 66 - -27 + 37) & ("  ".length() ^ (0x33 ^ 0x73) ^ -" ".length())) != 0;
                    }
                }
                n2 = llllIlIllll[0];
                return n2 != 0;
    ...
    private static void lIllIllIIIIIII() {
        ...
        v.llllIlIllll[0] = (0xC5 ^ 0xC0 ^ (0x14 ^ 0x26)) & (0x1C ^ 0x6E ^ (0xC4 ^ 0x81) ^ -" ".length());
        v.llllIlIllll[1] = "  ".length();
        v.llllIlIllll[2] = " ".length();
        v.llllIlIllll[3] = "   ".length();
    ...
    private static void lIllIlIllllllI() {
        ...
        v.llllIlIllIl[v.llllIlIllll[0]] = v.lIllIlIllllIII("vVNodsJbOLU=", "gzraj");
        v.llllIlIllIl[v.llllIlIllll[2]] = v.lIllIlIllllIIl("7gUg9c1GTu4=", "ZsXme");
        v.llllIlIllIl[v.llllIlIllll[1]] = v.lIllIlIllllIlI("LDY+KysG", "mBJJH");
        v.llllIlIllIl[v.llllIlIllll[3]] = v.lIllIlIllllIlI("AisgNQ==", "FDOGb");
        v.llllIlIllIl[v.llllIlIllll[4]] = v.lIllIlIllllIIl("Vi3fClargu0=", "HlCEH");
        v.llllIlIllIl[v.llllIlIllll[5]] = v.lIllIlIllllIII("0LUNVJf3LkY=", "VxyVJ");
        v.llllIlIllIl[v.llllIlIllll[6]] = v.lIllIlIllllIII("3srPRqmOQaw=", "xyfOS");
        v.llllIlIllIl[v.llllIlIllll[7]] = v.lIllIlIllllIII("3a3LwFMRM1Q=", "GxerD");
    }
