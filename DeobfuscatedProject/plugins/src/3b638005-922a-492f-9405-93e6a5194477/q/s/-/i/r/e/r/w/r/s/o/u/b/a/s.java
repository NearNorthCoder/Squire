...
extends Task {
    ...
    private static void lIllIllIIlIIII() {
        ...
        s.llllIllIlII[4] = " ".length();
        s.llllIllIlII[5] = 0x33 ^ 0x65 ^ (0x36 ^ 0x6A);
        s.llllIllIlII[6] = "  ".length();
    ...
    private static void lIllIllIIIllll() {
        ...
        s.llllIllIIll[s.llllIllIlII[0]] = s.lIllIllIIIllIl("0eQeINsyhCr1YcKR8GDWh4EzmJZ2ASSKythSXrEu3as=", "WZoZb");
        s.llllIllIIll[s.llllIllIlII[4]] = s.lIllIllIIIlllI("D7JR62OTVzY=", "TicOx");
    }
