...
extends Task {
    ...
    public boolean run() {
        t llllllllllllllllIIIllllIllIllIII;
        if (t.lIllIIlIlIlllI(House.isInside() ? 1 : 0)) {
            return lllIlllllIl[0];
        }
        llllllllllllllllIIIllllIllIllIII.af.b(lllIlllllIl[0]);
    ...
    private static void lIllIIlIlIllIl() {
        ...
        t.lllIlllllIl[0] = (92 + 158 - 95 + 40 ^ 131 + 18 - 2 + 9) & (112 + 126 - 213 + 212 ^ 52 + 123 - 156 + 159 ^ -" ".length());
    }
}
