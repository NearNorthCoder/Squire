...
extends Task {
    ...
    private static void lIllIIllIlIlIl() {
        ...
        h.llllIIIlIII[2] = " ".length();
        h.llllIIIlIII[3] = 0xFFFFF77F & 0x2BFD;
        h.llllIIIlIII[4] = "  ".length();
        h.llllIIIlIII[5] = "   ".length();
    ...
    public boolean run() {
        ...
        if (h.lIllIIllIllIIl(llllllllllllllllIIIllllIIIIIllIl)) {
            Inventory.dropAll(item -> {
                ...
                if (h.lIllIIllIlllIl(item.getId(), llllIIIlIII[3])) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((0x78 ^ 0x73 ^ (0x72 ^ 0x4B)) & (0x2F ^ 0x57 ^ (0x48 ^ 2) ^ -" ".length())) != 0;
                    }
                } else {
                    bl = llllIIIlIII[0];
                }
        ...
        int n2 = Inventory.contains(item -> {
            ...
            if (!h.lIllIIllIllIII(item.getName().toLowerCase().contains(llllIIIIlll[llllIIIlIII[10]]) ? 1 : 0) || h.lIllIIllIllIll(item.getName().toLowerCase().contains(llllIIIIlll[llllIIIlIII[11]]) ? 1 : 0)) {
                ...
                "".length();
                if (null != null) {
                    return ((128 + 33 - 127 + 107 ^ 17 + 117 - 85 + 137) & (0x23 ^ 0x59 ^ (0x3A ^ 0x77) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llllIIIlIII[0];
            }
    ...
    private static void lIllIIllIlIlII() {
        ...
        h.llllIIIIlll[h.llllIIIlIII[0]] = h.lIllIIllIlIIIl("wE8Q/fTF+PlXy8qDylOk1Sl3ImA06GUOQsUzVVdN6qQ3m5hbQzvQGQ==", "AvTOi");
        h.llllIIIIlll[h.llllIIIlIII[2]] = h.lIllIIllIlIIlI("RSzRdQnetFh/tV7RAoZPzUroFB/AJhPaKBy08vpn4ol/HJsboJ5knQ==", "dnVNv");
        h.llllIIIIlll[h.llllIIIlIII[4]] = h.lIllIIllIlIIlI("anPeL+QPjWdxt0+C33hL89HgrVQMyrvcdR1i9aDvyKg=", "MKRlr");
        h.llllIIIIlll[h.llllIIIlIII[5]] = h.lIllIIllIlIIIl("AGNb1Y74D3VYQG8lvRvEWHeggxelYJAadaxhg+aoG+pP2ATm/21BTMzGmqvsfJfhbb61KWYEjRoAzu6Jta0Psegye8xLvhUG", "yVbBM");
        h.llllIIIIlll[h.llllIIIlIII[8]] = h.lIllIIllIlIIlI("py15MGHPEwwIrg+PJKnxqw==", "XLEko");
        h.llllIIIIlll[h.llllIIIlIII[9]] = h.lIllIIllIlIIIl("ACOZ3c1H80I=", "TsHgB");
        h.llllIIIIlll[h.llllIIIlIII[10]] = h.lIllIIllIlIIlI("2SpKRDlO8+I=", "mnxRl");
        h.llllIIIIlll[h.llllIIIlIII[11]] = h.lIllIIllIlIIll("ESQ+PRkRJA==", "cAMIv");
        h.llllIIIIlll[h.llllIIIlIII[12]] = h.lIllIIllIlIIIl("5NOaKIbbqac=", "SDgTk");
    }
