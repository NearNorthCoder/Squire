...
extends Task {
    ...
    private static void lIllIIlllIlIII() {
        ...
        w.llllIIIlIll[0] = (92 + 58 - 3 + 29 ^ 113 + 143 - 196 + 85) & (181 + 186 - 182 + 5 ^ 107 + 78 - 117 + 91 ^ -" ".length());
        w.llllIIIlIll[1] = " ".length();
        w.llllIIIlIll[2] = "   ".length();
        w.llllIIIlIll[3] = "  ".length();
    ...
    private static void lIllIIlllIIlll() {
        ...
        w.llllIIIlIlI[w.llllIIIlIll[0]] = w.lIllIIlllIIlII("ihbuJOZwrJA=", "VKBRd");
        w.llllIIIlIlI[w.llllIIIlIll[1]] = w.lIllIIlllIIlIl("NBQ+", "quJAf");
        w.llllIIIlIlI[w.llllIIIlIll[3]] = w.lIllIIlllIIlII("0gCE0ff63fQ=", "Svmkn");
        w.llllIIIlIlI[w.llllIIIlIll[2]] = w.lIllIIlllIIlII("AblDIQG6iXM=", "hlAFR");
        w.llllIIIlIlI[w.llllIIIlIll[6]] = w.lIllIIlllIIlIl("LTYAKwMYJFI6BAokBnkPACIcLQ==", "oWrYl");
        w.llllIIIlIlI[w.llllIIIlIll[7]] = w.lIllIIlllIIlIl("JhEJTgAaHB8aQxsKTAsOAg0V", "rylnc");
        w.llllIIIlIlI[w.llllIIIlIll[5]] = w.lIllIIlllIIllI("9I+PgJK3Dtskpihxrbvh3E+/bcDqrXvzpg8DQ4qY1cA=", "DnNNL");
        w.llllIIIlIlI[w.llllIIIlIll[8]] = w.lIllIIlllIIlIl("AxIm", "FsRxA");
    }
