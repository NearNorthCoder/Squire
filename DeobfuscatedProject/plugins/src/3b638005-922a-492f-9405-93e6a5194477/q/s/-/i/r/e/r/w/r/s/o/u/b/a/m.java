...
extends Task {
    ...
    private static void lIllIIlIlllIIl() {
        ...
        m.llllIIIIIlI[2] = " ".length();
        m.llllIIIIIlI[3] = "  ".length();
        m.llllIIIIIlI[4] = "   ".length();
    ...
    private static String lIllIIlIllIIll(String llllllllllllllllIIIllllIlIIlIllI, String llllllllllllllllIIIllllIlIIlIlIl) {
        ...
        while (m.lIllIIlIllllll(llllllllllllllllIIIllllIlIIIllll, llllllllllllllllIIIllllIlIIlIIII)) {
            ...
            "".length();
            if (((" ".length() ^ (0x51 ^ 0x48)) & (0xEE ^ 0xBE ^ (6 ^ 0x4E) ^ -" ".length())) == 0) continue;
            return null;
        }
    ...
    private static void lIllIIlIllIlll() {
        ...
        m.llllIIIIIIl[m.llllIIIIIlI[0]] = m.lIllIIlIllIIll("KxYqJSI=", "odCKI");
        m.llllIIIIIIl[m.llllIIIIIlI[2]] = m.lIllIIlIllIlII("C5D4JxbifUM=", "xWitx");
        m.llllIIIIIIl[m.llllIIIIIlI[3]] = m.lIllIIlIllIlIl("JVfYlVKWDys=", "UqdNv");
        m.llllIIIIIIl[m.llllIIIIIlI[4]] = m.lIllIIlIllIlII("lcKz1SD3RjE=", "BiMfI");
    }
