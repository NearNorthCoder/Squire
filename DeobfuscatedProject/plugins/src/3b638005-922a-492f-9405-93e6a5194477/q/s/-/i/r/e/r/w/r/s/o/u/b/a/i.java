...
extends Task {
    ...
    public boolean run() {
        i llllllllllllllllIIIllIlIIllIlIII;
        if (i.lIllIlIlIIlIlI(this.H.useBank() ? 1 : 0)) {
            return llllIlIIIlI[0];
        }
        if (i.lIllIlIlIIlIlI(llllllllllllllllIIIllIlIIllIlIII.G.u() ? 1 : 0)) {
            return llllIlIIIlI[0];
        }
    ...
    private static void lIllIlIlIIlIIl() {
        ...
        i.llllIlIIIlI[0] = (4 ^ 0x77 ^ (0x2D ^ 0x61)) & (0xA0 ^ 0x9D ^ "  ".length() ^ -" ".length());
    }
