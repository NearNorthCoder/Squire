...
extends Enum<d> {
    ...
    private static void lIllIlIllIIIll() {
        ...
        d.llllIlIIlll[d.llllIlIlIII[0]] = d.lIllIlIllIIIII("Ot75+O/owvE=", "zRJpX");
        d.llllIlIIlll[d.llllIlIlIII[1]] = d.lIllIlIllIIIIl("AwYDEBgs", "Gnbbw");
        d.llllIlIIlll[d.llllIlIlIII[6]] = d.lIllIlIllIIIII("rp8+ApTT7SM=", "BKBUP");
        d.llllIlIIlll[d.llllIlIlIII[7]] = d.lIllIlIllIIIlI("GIKzO6j7mx8=", "xIlIs");
        d.llllIlIIlll[d.llllIlIlIII[11]] = d.lIllIlIllIIIII("S0JKIO6b/Wo=", "IOXey");
        d.llllIlIIlll[d.llllIlIlIII[12]] = d.lIllIlIllIIIlI("hn3mAypTxio=", "pkBdt");
        d.llllIlIIlll[d.llllIlIlIII[17]] = d.lIllIlIllIIIII("KNisEfwwXjI=", "smXey");
        d.llllIlIIlll[d.llllIlIlIII[18]] = d.lIllIlIllIIIII("fWks5ok0Dgs=", "eQCGc");
        d.llllIlIIlll[d.llllIlIlIII[21]] = d.lIllIlIllIIIIl("MywDDgo=", "gcQOM");
        d.llllIlIIlll[d.llllIlIlIII[22]] = d.lIllIlIllIIIIl("PwUxORc=", "kjCXp");
        d.llllIlIIlll[d.llllIlIlIII[25]] = d.lIllIlIllIIIlI("IZ5U008mMFQ=", "AIDHr");
        d.llllIlIIlll[d.llllIlIlIII[26]] = d.lIllIlIllIIIII("SDpyWGQeq/Y=", "toKYk");
    }
    ...
    public static boolean a(Actor actor) {
        ...
        while (d.lIllIlIllIIllI(llllllllllllllllIIIllIIlllIlIIlI, llllllllllllllllIIIllIIlllIlIIll)) {
            ...
            return ((221 + 185 - 348 + 192 ^ 65 + 126 - 108 + 86) & (0xE9 ^ 0x83 ^ (0x51 ^ 0x68) ^ -" ".length())) != 0;
        }
        return llllIlIlIII[0];
    }
    ...
    private static void lIllIlIllIIlII() {
        ...
        d.llllIlIlIII[6] = "  ".length();
        d.llllIlIlIII[7] = "   ".length();
