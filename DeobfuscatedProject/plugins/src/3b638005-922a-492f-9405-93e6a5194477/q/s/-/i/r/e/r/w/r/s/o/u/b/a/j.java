...
extends i {
    ...
    private static void lIllIlIIIlIlII() {
        ...
        j.llllIIlIIll[j.llllIIlIllI[0]] = j.lIllIlIIIIlIIl("5sFZx6uMZ7TOKd0Bcl7bcc5lGVh9pdKdEXGiDrIg83E=", "XYIcU");
        j.llllIIlIIll[j.llllIIlIllI[1]] = j.lIllIlIIIIlIIl("iVlbnLtiHBDVS9tdxGD0caWj8lPAwIhkZd+YPbwpgX0=", "mwIWj");
        j.llllIIlIIll[j.llllIIlIllI[2]] = j.lIllIlIIIlIIll("NycMIAQVZhEjQQYvESQFAycSbA0eJwEjFAVqRTsEVjQAbBEDKQctAx0/RSMUBWYKKkEQKwgjQR40RT8VECADbAIZJxcrBAJoRR8VHjYVJQ8WZhUgFBYvC2BBECgBbA0eIQIlDxZmCjkVXw==", "qFeLa");
    }
    ...
    protected boolean L() {
        ...
        while (j.lIllIlIIIllIII(llllllllllllllllIIIlllIIIIlIIIIl.hasNext() ? 1 : 0)) {
            ...
            return ((0x76 ^ 0x6E ^ (0xEA ^ 0xB3)) & (0x45 ^ 0x42 ^ (0xC ^ 0x4A) ^ -" ".length())) != 0;
        }
        return llllIIlIllI[0];
    }
    ...
    private static void lIllIlIIIlIlIl() {
        ...
        j.llllIIlIllI[1] = " ".length();
        j.llllIIlIllI[2] = "  ".length();
        j.llllIIlIllI[3] = -" ".length();
        j.llllIIlIllI[4] = "   ".length();
