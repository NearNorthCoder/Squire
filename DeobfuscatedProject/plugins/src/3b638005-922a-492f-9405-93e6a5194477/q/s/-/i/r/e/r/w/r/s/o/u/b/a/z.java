...
extends Task {
    ...
    private static void lIllIlIIIIllII() {
        ...
        z.llllIIlIlII[z.llllIIlIlIl[0]] = z.lIllIlIIIIlIlI("pOXRijsyq1g=", "uyXhG");
        z.llllIIlIlII[z.llllIIlIlIl[2]] = z.lIllIlIIIIlIll("AggKBgMhARkCGSI=", "Qixel");
        z.llllIIlIlII[z.llllIIlIlIl[3]] = z.lIllIlIIIIlIlI("ySDe7An0wV8=", "nACxY");
        z.llllIIlIlII[z.llllIIlIlIl[4]] = z.lIllIlIIIIlIll("IB0hFg==", "omDxV");
    }
    ...
    public boolean run() {
        ...
        if (z.lIllIlIIIIlllI(ap.contains(llllllllllllllllIIIlllIIIllIlIll.getWorldLocation()) ? 1 : 0) && z.lIllIlIIIlIIIl(llllllllllllllllIIIlllIIIllIlIlI = TileObjects.getNearest(tileObject -> {
            ...
            if (z.lIllIlIIIIlllI(tileObject.hasAction(stringArray) ? 1 : 0) && z.lIllIlIIIIlllI(Reachable.isInteractable((Locatable)tileObject) ? 1 : 0)) {
                ...
                "".length();
                if (-"   ".length() >= 0) {
                    return ((51 + 137 - -12 + 25 ^ 177 + 83 - 204 + 133) & (53 + 165 - 58 + 32 ^ 38 + 54 - 81 + 145 ^ -" ".length())) != 0;
                }
            } else {
                n2 = llllIIlIlIl[0];
            }
    ...
    private static void lIllIlIIIIllIl() {
        ...
        z.llllIIlIlIl[0] = (0x3E ^ 0x32 ^ (0x61 ^ 0x2F)) & (96 + 111 - -24 + 13 ^ 159 + 3 - 76 + 96 ^ -" ".length());
        z.llllIIlIlIl[1] = 4 ^ 0x25 ^ (0x2B ^ 0);
        z.llllIIlIlIl[2] = " ".length();
        z.llllIIlIlIl[3] = "  ".length();
        z.llllIIlIlIl[4] = "   ".length();
