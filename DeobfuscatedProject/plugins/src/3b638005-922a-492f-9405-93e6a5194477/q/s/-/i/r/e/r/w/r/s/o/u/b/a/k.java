...
extends Task {
    ...
    public boolean run() {
        k llllllllllllllllIIIllIIllIIlIIll;
        if (k.lIllIlIllIlIIl(this.M.useBank() ? 1 : 0)) {
            return llllIlIlIlI[0];
        }
        if (k.lIllIlIllIlIlI(llllllllllllllllIIIllIIllIIlIIll.K.getGameState(), GameState.LOGGED_IN)) {
            return llllIlIlIlI[0];
        }
        if (k.lIllIlIllIlIIl(llllllllllllllllIIIllIIllIIlIIll.L.u() ? 1 : 0)) {
            return llllIlIlIlI[0];
        }
        if (k.lIllIlIllIlIll(Bank.isOpen() ? 1 : 0)) {
            return llllIlIlIlI[0];
        }
        if (k.lIllIlIllIllII(llllllllllllllllIIIllIIllIIlIIll.N)) {
            llllllllllllllllIIIllIIllIIlIIll.N = BankLocation.getNearestCommon();
        }
        if (k.lIllIlIllIlIIl(Bank.open() ? 1 : 0)) {
            Log.info((String)("Walking to bank: " + llllllllllllllllIIIllIIllIIlIIll.N.toString()));
            Movement.walkTo((BankLocation)llllllllllllllllIIIllIIllIIlIIll.N);
            "".length();
        }
    ...
    private static void lIllIlIllIlIII() {
        ...
        k.llllIlIlIlI[0] = (0x43 ^ 0x71 ^ (0x64 ^ 0x1D)) & (0xC9 ^ 0xC1 ^ (0x7F ^ 0x3C) ^ -" ".length());
        k.llllIlIlIlI[1] = " ".length();
    }
