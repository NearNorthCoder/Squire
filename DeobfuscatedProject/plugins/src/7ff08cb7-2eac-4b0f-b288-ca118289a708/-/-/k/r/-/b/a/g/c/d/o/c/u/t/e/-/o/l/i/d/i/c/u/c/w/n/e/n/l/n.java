...
implements ab {
    ...
    public int af() {
        ...
        if ("  ".length() <= 0) {
            return (0x98 ^ 0xBF ^ (0x40 ^ 0x2E)) & (193 + 13 - 185 + 174 ^ 80 + 58 - 31 + 31 ^ -" ".length());
        }
        return llIllIIIl[54];
    }
    ...
    public boolean ah() {
        ...
        if (n.lIllIllllIII(Skills.getLevel((Skill)Skill.RANGED), llIllIIIl[7])) {
            ...
            "".length();
            if (null != null) {
                return ((0xB ^ 0x42 ^ (0xDD ^ 0x80)) & (0xA0 ^ 0xC4 ^ (0xA ^ 0x7A) ^ -" ".length())) != 0;
            }
        } else {
            bl = llIllIIIl[0];
        }
    ...
    private static void lIllIlllIIlI() {
        ...
        n.llIllIIIl[0] = (2 ^ 0x2C ^ (0xB1 ^ 0x8B)) & (7 + 45 - 4 + 111 ^ 29 + 20 - -71 + 19 ^ -" ".length());
        n.llIllIIIl[1] = " ".length();
        n.llIllIIIl[2] = "  ".length();
        n.llIllIIIl[3] = "   ".length();
        ...
        block20: {
                                ...
                                if (n.lIllIlllIIll(Bank.contains((int[])nArray10) ? 1 : 0)) {
                                    ...
                                    if (n.lIllIlllIIll(Bank.contains((int[])nArray11) ? 1 : 0)) {
                                        ...
                                        if (n.lIllIlllIIll(Bank.contains((int[])nArray12) ? 1 : 0)) {
                                            ...
                                            return ((0x64 ^ 0x41 ^ (0x80 ^ 0xC5)) & (168 + 117 - 218 + 185 ^ 64 + 44 - 65 + 113 ^ -" ".length())) != 0;
                                        }
                                    }
                                }
                            }
            ...
            if (n.lIllIlllIIll(Bank.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (n.lIllIlllIIll(Bank.contains((int[])nArray22) ? 1 : 0)) {
                    ...
                    return ((0xCF ^ 0xC6 ^ (0x44 ^ 0x66)) & (0x90 ^ 0xAB ^ (0xD7 ^ 0xC7) ^ -" ".length())) != 0;
                }
            }
        }
        n2 = llIllIIIl[0];
    ...
    private static String lIllIllIlllI(String lIIIlIllIllIIl, String lIIIlIllIlIIll) {
        ...
        while (n.lIllIlllIlII(lIIIlIllIIllIl, lIIIlIllIIlllI)) {
            ...
            ++lIIIlIllIIllIl;
            "".length();
            if (((0x36 ^ 0xA ^ (0x1C ^ 0x7B)) & (0x94 ^ 0xC3 ^ (0x5E ^ 0x52) ^ -" ".length())) != "   ".length()) continue;
            return null;
        }
    ...
    private static void lIllIlllIIII() {
        ...
        n.llIllIIII[n.llIllIIIl[0]] = n.lIllIllIllIl("q+AOy1NZHYDIJ8hvnG/c6Q==", "zUSSy");
        n.llIllIIII[n.llIllIIIl[1]] = n.lIllIllIlllI("LyIAIREBLgpoABwyByYFSSIaLQ8aZ047FQA/DSALByxOKgMKIE48DUkmDy8LCmsaOgMAJQcmBQ==", "iKnHb");
        n.llIllIIII[n.llIllIIIl[2]] = n.lIllIllIlllI("AScPMwguMhA0CG8yFnoNLigS", "OFyZo");
        n.llIllIIII[n.llIllIIIl[3]] = n.lIllIllIlllI("His8MR0/JDV1EzckOTwfMQ==", "VJRUq");
        n.llIllIIII[n.llIllIIIl[6]] = n.lIllIllIlllI("DSB4Izc/ZTUrNiksNiVlKTAoMikzICtuZSkyMTYmMiw2JWUuKngAEAMMFgU=", "ZEXBE");
        n.llIllIIII[n.llIllIIIl[5]] = n.lIllIllIllll("C7Gjtujb/Y4=", "uGpld");
        n.llIllIIII[n.llIllIIIl[30]] = n.lIllIllIlllI("PDMHKAM=", "kZbDg");
        n.llIllIIII[n.llIllIIIl[32]] = n.lIllIllIlllI("JR0sAQ==", "rxMsD");
        n.llIllIIII[n.llIllIIIl[33]] = n.lIllIllIlllI("IgQwPgw=", "umURh");
        n.llIllIIII[n.llIllIIIl[35]] = n.lIllIllIllll("40EjnionoxA=", "gDwdW");
        n.llIllIIII[n.llIllIIIl[24]] = n.lIllIllIlllI("HSYCAhw=", "JOgnx");
        n.llIllIIII[n.llIllIIIl[37]] = n.lIllIllIlllI("BRwnHw==", "RyFmw");
        n.llIllIIII[n.llIllIIIl[38]] = n.lIllIllIllIl("NNJ702SEoQw=", "Fyygn");
        n.llIllIIII[n.llIllIIIl[39]] = n.lIllIllIlllI("LQg5GQ==", "zmXky");
        n.llIllIIII[n.llIllIIIl[40]] = n.lIllIllIlllI("BR8LOA==", "RzjJT");
        n.llIllIIII[n.llIllIIIl[42]] = n.lIllIllIllIl("Rq2Jyu8ysHA=", "NgbZI");
        n.llIllIIII[n.llIllIIIl[43]] = n.lIllIllIllll("YI7XE8zv2pA=", "gQAgc");
        n.llIllIIII[n.llIllIIIl[44]] = n.lIllIllIlllI("Bg4LIg==", "QkjPZ");
        n.llIllIIII[n.llIllIIIl[45]] = n.lIllIllIlllI("GggCOS0=", "MagUI");
        n.llIllIIII[n.llIllIIIl[60]] = n.lIllIllIllIl("I6IXx+ROLAr9oWq6HKBx5A==", "rRPXw");
        n.llIllIIII[n.llIllIIIl[31]] = n.lIllIllIllIl("YEKloUq6nmN4gfcV45HLf3sjiEe0pIFF", "niSsu");
        n.llIllIIII[n.llIllIIIl[61]] = n.lIllIllIllIl("ntuVPx2sD5Q=", "chKwC");
    }
                ...
                if (n.lIllIllllIII(Skills.getLevel((Skill)Skill.RANGED), llIllIIIl[27])) {
                    lIIIlIlllIllII = TileItems.getNearest(tileItem -> {
                        ...
                        if (n.lIllIllllIlI(tileItem.getId(), llIllIIIl[16]) && n.lIllIllllIII(tileItem.getQuantity(), llIllIIIl[42])) {
                            ...
                            "".length();
                            if (" ".length() == 0) {
                                return ((0xDF ^ 0x88 ^ (0xE5 ^ 0x93)) & (35 + 69 - -30 + 45 ^ 37 + 44 - -25 + 40 ^ -" ".length())) != 0;
                            }
                        } else {
                            n2 = llIllIIIl[0];
                        }
    ...
    private static boolean an() {
        ...
        block40: {
                                                                                                            ...
                                                                                                            block16: {
                                                                                                                ...
                                                                                                                block18: {
                                                                                                                    ...
                                                                                                                    if (n.lIllIlllIIll(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                                                                                        ...
                                                                                                                        return ((2 ^ 0x44 ^ (0x64 ^ 0x7E)) & (127 + 182 - 257 + 166 ^ 115 + 79 - 78 + 18 ^ -" ".length())) != 0;
                                                                                                                    }
                                                                                                                }
                                                                                                                n5 = llIllIIIl[0];
                                                                                                                return n5 != 0;
            ...
            if (n.lIllIlllIIll(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                return ((0x7B ^ 0x4E ^ (0x71 ^ 0xC)) & (0xCE ^ 0xC0 ^ (0x3C ^ 0x7A) ^ -" ".length()) & ((0x33 ^ 0x38 ^ (0x60 ^ 0x79)) & (19 + 1 - -73 + 97 ^ 127 + 104 - 91 + 32 ^ -" ".length()) ^ -" ".length())) != 0;
            }
        }
        n2 = llIllIIIl[0];
        return n2 != 0;
