...
implements ab {
    ...
    private static void lllIIIlIlllI() {
        ...
        S.lIIIIlIlll[S.lIIIIllIII[0]] = S.lllIIIlIlIll("LQE/Gx4IVC8GFQIH", "otFrp");
        S.lIIIIlIlll[S.lIIIIllIII[1]] = S.lllIIIlIllII("mTiVjFRXtLz4g6p8O7zqBSR1hD1CA7DZvteJF3ziYVq46bZsztfwuGjI96x4IfXb", "gxXZW");
        S.lIIIIlIlll[S.lIIIIllIII[3]] = S.lllIIIlIllIl("kc2Qt68oDgg=", "CnRvn");
        S.lIIIIlIlll[S.lIIIIllIII[5]] = S.lllIIIlIllIl("o/sh1dJRq0EUdgULvb+uDQ==", "yuQBT");
        S.lIIIIlIlll[S.lIIIIllIII[6]] = S.lllIIIlIllIl("sGHRulappfwA+e4gE6tA76yTr8kNvGwg", "NAhva");
        S.lIIIIlIlll[S.lIIIIllIII[12]] = S.lllIIIlIlIll("JQ1ENjEXSAk+MAEBCjBjAx0BJDdSGxEnMx4BASRvUhsTPjcRAA05JFIcC3cBJzEtGQQ=", "rhdWC");
        S.lIIIIlIlll[S.lIIIIllIII[9]] = S.lllIIIlIlIll("OC1UAgIKaBkKAxwhGgRQHj0REARPOwETAAMhERBcTzsDCgQMIB0NF088G0MyOhE9LTc=", "oHtcp");
        S.lIIIIlIlll[S.lIIIIllIII[15]] = S.lllIIIlIllIl("8lH0tcYRnEM8n4ozbVQqGg==", "wiaMs");
        S.lIIIIlIlll[S.lIIIIllIII[16]] = S.lllIIIlIlIll("DzEdNh4icBc7Eys/FA==", "GPsRr");
        S.lIIIIlIlll[S.lIIIIllIII[17]] = S.lllIIIlIlIll("KQgjMA==", "mgLBQ");
        S.lIIIIlIlll[S.lIIIIllIII[18]] = S.lllIIIlIlIll("KRYsLA==", "ffIBQ");
        S.lIIIIlIlll[S.lIIIIllIII[19]] = S.lllIIIlIllII("yWVb8SyPeBU=", "olruM");
        S.lIIIIlIlll[S.lIIIIllIII[20]] = S.lllIIIlIlIll("IjceAwI=", "fXlja");
        S.lIIIIlIlll[S.lIIIIllIII[21]] = S.lllIIIlIllII("7VgKtbUzQeHOltvucVILFw==", "JoeHE");
        S.lIIIIlIlll[S.lIIIIllIII[22]] = S.lllIIIlIllIl("sMXbnS/SOnMZUiFIkgGZKCuaQqihvfDq", "Afgjn");
        S.lIIIIlIlll[S.lIIIIllIII[23]] = S.lllIIIlIllIl("EKn++Lv89LSooDUwxs+7CesOkQlf3e67ZX+v2GRtwN3LqYB7nIYCZZ0d+R/cE7t9Hb1hYlAxBXs=", "DsiHc");
        S.lIIIIlIlll[S.lIIIIllIII[30]] = S.lllIIIlIlIll("IRgwBA8WVzMYCRYD", "ewBml");
        S.lIIIIlIlll[S.lIIIIllIII[31]] = S.lllIIIlIlIll("Cg0PHUMXAkENBhkIFRJDUA==", "xdazc");
        S.lIIIIlIlll[S.lIIIIllIII[34]] = S.lllIIIlIlIll("DFIuLAcxFz1tHSpSLD4MZQs2OBtlEzc7ACkBdw==", "ErYMi");
        S.lIIIIlIlll[S.lIIIIllIII[35]] = S.lllIIIlIlIll("HwY1QmgPQzEHJCpDIQs8ZhopG2gyCyNOJScXIxwhJw81QA==", "FcFnH");
        S.lIIIIlIlll[S.lIIIIllIII[36]] = S.lllIIIlIllII("NQBgsBOoaQ6H28CgjtFZgV6UKtkhXPFRaQvc8WdcDms=", "eCYMg");
        S.lIIIIlIlll[S.lIIIIllIII[37]] = S.lllIIIlIlIll("LRckSw==", "trWeo");
    }
    ...
    public boolean ah() {
        ...
        if (S.lllIIIllIlIl(e.j(lIIIIllIII[4]), lIIIIllIII[14])) {
            bl = lIIIIllIII[1];
            "".length();
            if ((((0xE ^ 0x44) & ~(0xE ^ 0x44) ^ (0x44 ^ 0x59)) & (0xB ^ 0x28 ^ (0x7C ^ 0x42) ^ -" ".length())) > 0) {
                return ((0x4A ^ 0x69 ^ (0x67 ^ 0x1A)) & (0xAF ^ 0x8B ^ (0xF2 ^ 0x88) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIIllIII[0];
        }
    ...
    private static void lllIIIlIllll() {
        ...
        S.lIIIIllIII[0] = (0x19 ^ 0x49 ^ (0xF6 ^ 0x80)) & (0xB3 ^ 0x8A ^ (0x2A ^ 0x35) ^ -" ".length());
        S.lIIIIllIII[1] = " ".length();
        S.lIIIIllIII[2] = 0xBB ^ 0x89;
        S.lIIIIllIII[3] = "  ".length();
        S.lIIIIllIII[4] = 0x77 ^ 0x68;
        S.lIIIIllIII[5] = "   ".length();
        ...
        if (S.lllIIIllIlIl(Inventory.getCount((int[])nArray), lIIIIllIII[9])) {
            ...
            if (S.lllIIIllIlIl(Inventory.getCount((int[])nArray2), lIIIIllIII[3])) {
                ...
                if (S.lllIIIllIlIl(Inventory.getCount((int[])nArray3), lIIIIllIII[6])) {
                    n2 = lIIIIllIII[1];
                    "".length();
                    if ((22 + 168 - 123 + 130 ^ 61 + 74 - -54 + 4) >= (((0xB0 ^ 0x99) & ~(0xB7 ^ 0x9E) ^ (0x46 ^ 0x74)) & (101 + 148 - 201 + 107 ^ 106 + 111 - 118 + 70 ^ -" ".length()))) return n2 != 0;
                    return ((0xCA ^ 0xB4 ^ (0xB6 ^ 0xC6)) & ((0xDF ^ 0x91) & ~(0x38 ^ 0x76) ^ (0x72 ^ 0x7C) ^ -" ".length())) != 0;
                }
            }
        }
        n2 = lIIIIllIII[0];
