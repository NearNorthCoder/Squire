...
implements ab {
        ...
        if (af.lIlIlllIIlll(Players.getLocal().getInteracting())) {
            NPC lIlIIIIIIlllIl = NPCs.getNearest(nPC -> {
                ...
                if (af.lIlIlllIIIII(nPC.getName().contains(llIIlllII[llIIlllIl[75]]) ? 1 : 0) && af.lIlIlllIIIlI(nPC.isDead() ? 1 : 0)) {
                    n2 = llIIlllIl[1];
                    "".length();
                    if (((0x6E ^ 0x17 ^ (0x7F ^ 0x3B)) & (2 ^ 0x17 ^ (0xE9 ^ 0xC1) ^ -" ".length())) != 0) {
                        return (((0x77 ^ 0x34) & ~(0x48 ^ 0xB) ^ (0x52 ^ 0x42)) & (0xCB ^ 0xBC ^ (0x77 ^ 0x10) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = llIIlllIl[0];
                }
                        ...
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    ...
                                    return ((126 + 190 - 310 + 203 ^ 45 + 109 - 73 + 56) & (212 + 52 - 248 + 207 ^ 96 + 41 - 49 + 47 ^ -" ".length())) != 0;
                                }
                                n4 = llIIlllIl[0];
                                return n4 != 0;
                            }
    ...
    public boolean ah() {
        ...
        if (af.lIlIlllIIlIl(Skills.getLevel((Skill)Skill.MAGIC), llIIlllIl[2])) {
            ...
            "".length();
            if (" ".length() < -" ".length()) {
                return ((0x7F ^ 0x6A ^ (0x9E ^ 0xBB)) & (0x17 ^ 0x45 ^ (0xD2 ^ 0xB0) ^ -" ".length())) != 0;
            }
        } else {
            bl = llIIlllIl[0];
        }
                    ...
                    block27: {
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    ...
                                    "".length();
                                    if ("  ".length() >= 0) return n4 != 0;
                                    return ((122 + 140 - 236 + 219 ^ 160 + 21 - 132 + 134) & (0x48 ^ 0x1B ^ (7 ^ 0x16) ^ -" ".length())) != 0;
                                }
                                n4 = llIIlllIl[0];
                                return n4 != 0;
                            }
                        ...
                        if (af.lIlIlllIIIII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (af.lIlIlllIIIII(Inventory.contains((int[])nArray14) ? 1 : 0)) {
                                n3 = llIIlllIl[1];
                                "".length();
                                if ((0x5E ^ 0x45 ^ (0x11 ^ 0xE)) > -" ".length()) return n3 != 0;
                                return ((0x6B ^ 0x6D ^ (0x2E ^ 0x3A)) & (90 + 128 - 155 + 87 ^ 129 + 87 - 209 + 125 ^ -" ".length())) != 0;
                            }
                        }
                    }
                    n3 = llIIlllIl[0];
                    ...
                    if (af.lIlIlllIIlIl(Inventory.getFirst((int[])nArray17).getQuantity(), llIIlllIl[19])) {
                        ...
                        if (af.lIlIlllIIIII(Inventory.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (af.lIlIlllIIIII(Inventory.contains((int[])nArray19) ? 1 : 0)) {
                                ...
                                return ((0x42 ^ 0x3A ^ (0x2B ^ 0x73)) & (65 + 56 - 110 + 117 ^ 74 + 113 - 119 + 92 ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
    ...
    private static void lIlIllIlllll() {
        ...
        af.llIIlllIl[0] = (171 + 21 - 34 + 15 ^ 27 + 44 - -78 + 1) & (93 + 49 - 134 + 169 ^ 18 + 28 - -40 + 52 ^ -" ".length());
        af.llIIlllIl[1] = " ".length();
        af.llIIlllIl[2] = 5 + 33 - -39 + 59 ^ 184 + 105 - 219 + 116;
        af.llIIlllIl[3] = "  ".length();
        af.llIIlllIl[4] = "   ".length();
                                ...
                                if (af.lIlIlllIIIIl(Inventory.getCount((int[])nArray2), llIIlllIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (af.lIlIlllIIlII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (-"  ".length() > 0) {
                                                return (("   ".length() ^ (0x21 ^ 0x72)) & (0x7D ^ 0x52 ^ 3 + 86 - -30 + 8 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = llIIlllIl[0];
                                        }
                                ...
                                if (af.lIlIlllIIIIl(Inventory.getCount((int[])nArray6), llIIlllIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (af.lIlIlllIIlII(Inventory.getCount((int[])nArray))) {
                                            bl = llIIlllIl[1];
                                            "".length();
                                            if ((73 + 149 - 77 + 11 ^ 85 + 123 - 68 + 12) == -" ".length()) {
                                                return ((85 + 156 - 197 + 171 ^ 139 + 174 - 273 + 159) & (108 + 101 - 194 + 124 ^ 30 + 33 - 44 + 136 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = llIIlllIl[0];
                                        }
                                ...
                                if (af.lIlIlllIIIIl(Inventory.getCount((int[])nArray8), llIIlllIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (af.lIlIlllIIlII(Inventory.getCount((int[])nArray))) {
                                            bl = llIIlllIl[1];
                                            "".length();
                                            if (((0x1E ^ 0xB) & ~(0x3A ^ 0x2F)) > "   ".length()) {
                                                return ((0x45 ^ 0x58) & ~(0x57 ^ 0x4A)) != 0;
                                            }
                                        } else {
                                            bl = llIIlllIl[0];
                                        }
                                ...
                                if (af.lIlIlllIIIIl(Inventory.getCount((int[])nArray10), llIIlllIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (af.lIlIlllIIlII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (-" ".length() > "   ".length()) {
                                                return ((0xEF ^ 0xA3 ^ "  ".length()) & (0x68 ^ 0x2A ^ (0x6A ^ 0x66) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = llIIlllIl[0];
                                        }
                                ...
                                if (af.lIlIlllIIIIl(Inventory.getCount((int[])nArray14), llIIlllIl[1]) && af.lIlIlllIIIIl(Skills.getLevel((Skill)Skill.MAGIC), llIIlllIl[21])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (af.lIlIlllIIlII(Inventory.getCount((int[])nArray))) {
                                            bl = llIIlllIl[1];
                                            "".length();
                                            if (-" ".length() >= ((0xAF ^ 0x91 ^ (0x13 ^ 0x3E)) & (165 + 67 - 204 + 140 ^ 113 + 128 - 61 + 7 ^ -" ".length()))) {
                                                return ((9 + 84 - 13 + 87 ^ 41 + 38 - 18 + 87) & (0xF9 ^ 0x99 ^ (0xE7 ^ 0xB4) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = llIIlllIl[0];
                                        }
                        ...
                        if (af.lIlIlllIIIll(lIlIIIIIlIIIlI) && af.lIlIlllIIIll(lIlIIIIIlIIIIl) && af.lIlIlllIIllI(Players.getLocal().getAnimation(), llIIlllIl[28])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (af.lIlIlllIlIll(Skills.getExperience((Skill)Skill.MAGIC), lIlIIIIIlIIIII)) {
                                    bl = llIIlllIl[1];
                                    "".length();
                                    if (((0x22 ^ 0x6F ^ (0xDB ^ 0x8B)) & (0xB ^ 0x3C ^ (0x2E ^ 4) ^ -" ".length())) >= (0xB9 ^ 0xB6 ^ (0x45 ^ 0x4E))) {
                                        return ((48 + 149 - 152 + 130 ^ 96 + 139 - 147 + 83) & (0x6E ^ 0x64 ^ (0x4E ^ 0x40) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = llIIlllIl[0];
                                }
    ...
    private static void lIlIllIllllI() {
        ...
        af.llIIlllII[af.llIIlllIl[0]] = af.lIlIllIllIll("KDc6EAYNYioNDQcx", "jBCyh");
        af.llIIlllII[af.llIIlllIl[1]] = af.lIlIllIlllII("oHqLRQ1Q9EwH+KMMRdipal+6L4acxWq2K1xmszJM6ecnYJCi0PNfysGSwl4SMg30EHt/dQEEIZ0=", "cxdYg");
        af.llIIlllII[af.llIIlllIl[3]] = af.lIlIllIlllII("h0bkzoQe5a9g2EjnNY37pJNGIhPM8M4+", "lLCdv");
        af.llIIlllII[af.llIIlllIl[4]] = af.lIlIllIlllII("m6ZPR7Gi/mPf9zq7zNb7Cmm3kezqhcpD", "noZIt");
        af.llIIlllII[af.llIIlllIl[7]] = af.lIlIllIlllII("osKHwNqZuKGXScF14UwmrWTK21AcO8Nkek61ouWYSQmoNz1DutHRT2N2vJyvVrQb", "UPPNI");
        af.llIIlllII[af.llIIlllIl[19]] = af.lIlIllIlllIl("258CwfqnhHcfNZ4jnlbJJQ==", "pdZnT");
        af.llIIlllII[af.llIIlllIl[6]] = af.lIlIllIllIll("DSMwDwQnPioJRy84Mx0=", "LWDng");
        af.llIIlllII[af.llIIlllIl[27]] = af.lIlIllIllIll("KwA+ISYGBm0jLhoTIjYkSBUoOSo=", "haMUO");
        af.llIIlllII[af.llIIlllIl[30]] = af.lIlIllIlllIl("wNp7hLus6MHrvCTutaxMTQVeR0E4sJPd", "MkszH");
        af.llIIlllII[af.llIIlllIl[32]] = af.lIlIllIllIll("MCsADg0dLVMcBR8mCloQFiYW", "sJszd");
        af.llIIlllII[af.llIIlllIl[33]] = af.lIlIllIlllII("zQndLi5ogqhTSauAXo9rQrqxh9j1il8y", "oyzpY");
        af.llIIlllII[af.llIIlllIl[34]] = af.lIlIllIllIll("CToNCywmMQ==", "HVncE");
        af.llIIlllII[af.llIIlllIl[37]] = af.lIlIllIlllIl("nbzLkYembUA=", "tQjkr");
        af.llIIlllII[af.llIIlllIl[39]] = af.lIlIllIlllIl("tTWi4wmmkfZpzbcWuv3w71QnfvTM6Dt8", "jONhm");
        af.llIIlllII[af.llIIlllIl[41]] = af.lIlIllIlllIl("vl3ExiCqG0B6ilWtAO3WmA==", "iILWy");
        af.llIIlllII[af.llIIlllIl[42]] = af.lIlIllIlllII("bG5B1okli8hNo+1xtl9seg==", "wBpqh");
        af.llIIlllII[af.llIIlllIl[43]] = af.lIlIllIlllIl("k6hWygbDLzc=", "oWARy");
        af.llIIlllII[af.llIIlllIl[44]] = af.lIlIllIllIll("IiI8", "aMKOE");
        af.llIIlllII[af.llIIlllIl[45]] = af.lIlIllIllIll("Aj0U", "aRcEh");
        af.llIIlllII[af.llIIlllIl[47]] = af.lIlIllIlllIl("nWyG+NCO1kU=", "ahzPs");
        af.llIIlllII[af.llIIlllIl[51]] = af.lIlIllIllIll("AzMoIh4iJG0tAjgsLi0EOA==", "LCMLw");
        af.llIIlllII[af.llIIlllIl[52]] = af.lIlIllIlllIl("hXmluKARKlEqnODAlJfzHA==", "jpmEN");
        af.llIIlllII[af.llIIlllIl[54]] = af.lIlIllIllIll("EwcKJW0XGhYoJiE=", "DndAM");
        af.llIIlllII[af.llIIlllIl[55]] = af.lIlIllIlllII("gV1a9oj5po1pT+ynhJ0+UA==", "MYSmV");
        af.llIIlllII[af.llIIlllIl[56]] = af.lIlIllIlllII("U1JaYvqXlb3M67nRqhtibA==", "PrRNW");
        af.llIIlllII[af.llIIlllIl[21]] = af.lIlIllIllIll("ABsoJx1lKS4hHC4f", "EzZSu");
        af.llIIlllII[af.llIIlllIl[50]] = af.lIlIllIlllIl("gdxs0zEdp4/IuHc4s/27sQ==", "fnxOG");
        af.llIIlllII[af.llIIlllIl[73]] = af.lIlIllIlllII("ha3duHaV42KJuLlfqpKxbA==", "eAWav");
        af.llIIlllII[af.llIIlllIl[74]] = af.lIlIllIlllIl("34PwD8IYoq038b3LNbf9xZq3W9dW42Qu", "waewX");
        af.llIIlllII[af.llIIlllIl[75]] = af.lIlIllIlllIl("AYynZJgvpMc=", "UKwwv");
    }
}
