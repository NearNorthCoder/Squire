...
public class b {
                        ...
                        if (b.llIIlllIlIII(GrandExchange.getPrice(), llllIIIll[24])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (b.llIIlllIlIlI(GrandExchange.getPrice(), llllIIIll[1])) {
                                    bl = llllIIIll[1];
                                    "".length();
                                    if (((0xF3 ^ 0x8E ^ (0x92 ^ 0xAD)) & (43 + 47 - 29 + 184 ^ 17 + 150 - 142 + 158 ^ -" ".length())) != 0) {
                                        return ((0x6F ^ 0x6A ^ (0x37 ^ 0x72)) & (142 + 50 - 128 + 134 ^ 72 + 18 - 76 + 120 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = llllIIIll[0];
                                }
    ...
    private static void llIIllIlIlII() {
        ...
        b.llllIIIII[b.llllIIIll[0]] = b.llIIllIlIIIl("NCAgOg==", "cEAHD");
        b.llllIIIII[b.llllIIIll[1]] = b.llIIllIlIIlI("uEQuszTJEn5GLJTGyMnttw==", "PymiR");
        b.llllIIIII[b.llllIIIll[8]] = b.llIIllIlIIll("WK+tzAMycAp0lZ2WXgFA+IYSlcMhf/ZjJ38ti7tUvFWJeXdSpjohV4bLBq4/VuTWpb7GvrYY6JI=", "xseuE");
        b.llllIIIII[b.llllIIIll[4]] = b.llIIllIlIIIl("ICUpBj0dMGgbOwc4JwV8R3g=", "sQHkT");
        b.llllIIIII[b.llllIIIll[7]] = b.llIIllIlIIlI("EL42ukANSJC2RNXDpzVi4xC5i8nJxPWw", "nRMiK");
        b.llllIIIII[b.llllIIIll[25]] = b.llIIllIlIIlI("IpUJa7Zex7Q=", "FdlhF");
        b.llllIIIII[b.llllIIIll[26]] = b.llIIllIlIIlI("BiN+zDJPcllz61XxlEH0og==", "bJWMj");
        b.llllIIIII[b.llllIIIll[13]] = b.llIIllIlIIIl("", "vvgqE");
        b.llllIIIII[b.llllIIIll[28]] = b.llIIllIlIIIl("NBghGQ8=", "wtNjj");
        b.llllIIIII[b.llllIIIll[29]] = b.llIIllIlIIll("cwP8X/4JTHc=", "DCKFh");
        b.llllIIIII[b.llllIIIll[3]] = b.llIIllIlIIlI("oWCwbyik34c=", "GKjMl");
        b.llllIIIII[b.llllIIIll[27]] = b.llIIllIlIIIl("GhE9AmUHHnMSIAkUJw1lQA==", "hxSeE");
    }
    ...
    public static boolean a(String string) {
        ...
        if (b.llIIlllIIIlI(list.isEmpty() ? 1 : 0)) {
            ...
            while (b.llIIlllIIlII(llIIIlllIIIll, llIIIlllIIlIl.size())) {
                ...
                return ((0x70 ^ 0x15 ^ (0x28 ^ 0x55)) & (38 + 76 - 6 + 54 ^ 162 + 150 - 218 + 92 ^ -" ".length())) != 0;
            }
        }
        return llllIIIll[0];
    }
        ...
        block65: {
            ...
            if (b.llIIlllIIIlI(list.isEmpty() ? 1 : 0) && b.llIIlllIIIll(L.isEmpty() ? 1 : 0)) {
                ...
                while (b.llIIlllIIlII(llIIIlllllIlI2, llIIIlllllIll.size())) {
                    ...
                    ++llIIIlllllIlI2;
                    "".length();
                    if (((0x7D ^ 0x31 ^ (0xC5 ^ 0xA9)) & (0x52 ^ 0x71 ^ "   ".length() ^ -" ".length())) < " ".length()) continue;
                    return;
                }
            }
            int[] nArray = new int[llllIIIll[1]];
                    ...
                    if (b.llIIlllIIIll(Bank.contains(llIIIlllllIlI2) ? 1 : 0) && b.llIIlllIIIlI(Inventory.contains(item -> item.getName().contains(llllIIIII[llllIIIll[3]])) ? 1 : 0) && b.llIIlllIIllI(Players.getLocal().getWorldLocation().distanceTo(K), llllIIIll[3])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (b.llIIlllIlIIl(Inventory.getCount((Predicate)llIIIlllllIlI2))) {
                                ...
                                "".length();
                                if (" ".length() <= -" ".length()) {
                                    return ((20 + 19 - -39 + 52 ^ 150 + 119 - 114 + 0) & (174 + 123 - 193 + 82 ^ 30 + 65 - 60 + 128 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llllIIIll[0];
                            }
                        ...
                        if (b.llIIlllIIIll(Bank.contains((int[])nArray2) ? 1 : 0) && b.llIIlllIIllI(Players.getLocal().getWorldLocation().distanceTo(K), llllIIIll[3])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (b.llIIlllIlIIl(Inventory.getCount((int[])nArray))) {
                                    bl = llllIIIll[1];
                                    "".length();
                                    if (((0x93 ^ 0x94) & ~(0x9D ^ 0x9A)) >= "  ".length()) {
                                        return ((0x78 ^ 0x34) & ~(0xCE ^ 0x82)) != 0;
                                    }
                                } else {
                                    bl = llllIIIll[0];
                                }
            ...
            while (b.llIIlllIIlII(llIIIlllllIlI2, L.size())) {
                ...
                while (b.llIIlllIIIlI(b.a(llIIIlllllIIl) ? 1 : 0)) {
                    block69: {
                        block70: {
                                        ...
                                        if (b.llIIlllIIIll(GrandExchange.canCollect() ? 1 : 0)) {
                                            ...
                                            Time.sleepUntil(() -> {
                                                ...
                                                if (b.llIIlllIIIlI(GrandExchange.canCollect() ? 1 : 0)) {
                                                    ...
                                                    "".length();
                                                    if ("  ".length() <= 0) {
                                                        return ((0x12 ^ 0x72 ^ (0x3D ^ 0x70)) & (0x81 ^ 0xAE ^ "  ".length() ^ -" ".length())) != 0;
                                                    }
                                                } else {
                                                    bl = llllIIIll[0];
                                                }
                            ...
                            if (b.llIIlllIlIlI(L.get(llIIIlllllIlI2), llllIIIll[20])) {
                                ...
                                if (b.llIIlllIIIll(Inventory.contains((int[])nArray11) ? 1 : 0)) {
                                    ...
                                    "".length();
                                    "".length();
                                    if (" ".length() > ((0x85 ^ 0xA8 ^ (0x32 ^ 0x2B)) & (23 + 34 - 17 + 113 ^ 125 + 117 - 95 + 26 ^ -" ".length()))) continue;
                                    return;
                                }
                            }
                        ...
                        "".length();
                        "".length();
                        if (((187 + 162 - 285 + 132 ^ 140 + 16 - 136 + 124) & (0x2B ^ 0x51 ^ (0x5C ^ 0x72) ^ -" ".length())) <= 0) continue;
                        return;
                    }
                    if (!b.llIIlllIIIlI(b.a(llIIIlllllIIl) ? 1 : 0)) break;
                    if (b.llIIlllIIIll(AccBuilderGWD.d ? 1 : 0)) {
                        "".length();
                        if (-" ".length() != (0x2E ^ 0x46 ^ (0x26 ^ 0x4A))) break;
                        return;
                    }
                    Time.sleepTicks((int)llllIIIll[4]);
                    "".length();
                ...
                ++llIIIlllllIlI2;
                "".length();
                if ((116 + 16 - 126 + 126 ^ 59 + 72 - 47 + 44) >= ((0xA ^ 0x2A ^ (0x22 ^ 0x3F)) & (0x20 ^ 0x24 ^ (0x69 ^ 0x50) ^ -" ".length()))) continue;
                return;
            }
        }
    }
