...
public class g {
    ...
    public static boolean M() {
        ...
        while (g.lIllIIIllllI(lIIllIIllIlIll, bu.length)) {
            ...
            return ((0x56 ^ 0x14 ^ (0x41 ^ 0x2F)) & (0xD4 ^ 0x8D ^ (0xE ^ 0x7B) ^ -" ".length())) != 0;
        }
        return llIlIIllI[3];
    }
    ...
    private static void lIllIIIlllIl() {
        ...
        g.llIlIIllI[13] = "  ".length() + (68 + 35 - 91 + 163) - (140 + 155 - 167 + 35) + (69 + 67 - 105 + 174);
    ...
    private static void lIllIIIlllII() {
        ...
        g.llIlIIlIl[g.llIlIIllI[3]] = g.lIllIIIllIlI("fZbu9lwqjkk=", "ozXHO");
        g.llIlIIlIl[g.llIlIIllI[2]] = g.lIllIIIllIll("CHTdMpBsHUg=", "ALJNq");
        g.llIlIIlIl[g.llIlIIllI[6]] = g.lIllIIIllIll("QbX3kFVshEABwYJzAEw/Aw==", "mhcYK");
        g.llIlIIlIl[g.llIlIIllI[7]] = g.lIllIIIllIlI("yS3+977B8gQ=", "lIbBT");
        g.llIlIIlIl[g.llIlIIllI[8]] = g.lIllIIIllIlI("Kh7lsZVa0p8=", "QJEzb");
        g.llIlIIlIl[g.llIlIIllI[4]] = g.lIllIIIllIll("K3DYo6RksKbukK+LIPMA/A==", "fzooq");
        g.llIlIIlIl[g.llIlIIllI[9]] = g.lIllIIIllIlI("+coMjzNRMPU=", "wjmtT");
        g.llIlIIlIl[g.llIlIIllI[10]] = g.lIllIIIllIlI("mTDdEYPkhHEoZ7ecjAPdHg==", "CBzjD");
    }
