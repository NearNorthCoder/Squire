...
public class h {
    ...
    private static void llIIIlIlIlll() {
        ...
        h.lllIlIIIl[0] = (0x5F ^ 0x61 ^ (0x69 ^ 7)) & (0x1E ^ 0x56 ^ (4 ^ 0x1C) ^ -" ".length());
        h.lllIlIIIl[1] = " ".length();
        h.lllIlIIIl[2] = "  ".length();
        h.lllIlIIIl[3] = "   ".length();
        ...
        h.lllIlIIIl[22] = -"  ".length() & (0xFFFFEEDB & 0x3FF7);
    ...
    private static void llIIIlIlIllI() {
        ...
        h.lllIlIIII[h.lllIlIIIl[0]] = h.llIIIlIlIIll("mBpuL2IrjtGqn579kYpS0A==", "AtFTT");
        h.lllIlIIII[h.lllIlIIIl[1]] = h.llIIIlIlIlII("Mlc0JB0xFjA=", "TeDUh");
        h.lllIlIIII[h.lllIlIIIl[2]] = h.llIIIlIlIIll("9GEvQL+f9gw=", "zqBpk");
        h.lllIlIIII[h.lllIlIIIl[3]] = h.llIIIlIlIIll("1INKKDUcEDs=", "ERISV");
        h.lllIlIIII[h.lllIlIIIl[4]] = h.llIIIlIlIlII("Px4CJQE=", "NkgVu");
        h.lllIlIIII[h.lllIlIIIl[5]] = h.llIIIlIlIlIl("AhV/VpHXDZ6G0Hr43Qy/9w==", "GIeyx");
        h.lllIlIIII[h.lllIlIIIl[6]] = h.llIIIlIlIlII("IgMFLR0=", "OfiHx");
        h.lllIlIIII[h.lllIlIIIl[7]] = h.llIIIlIlIlII("Nz4RITMiIA==", "VYxMZ");
        h.lllIlIIII[h.lllIlIIIl[8]] = h.llIIIlIlIIll("GRn6wBSrWRiVxTfXd1fxTQ==", "BVhFw");
        h.lllIlIIII[h.lllIlIIIl[9]] = h.llIIIlIlIlIl("3vsuAXRWKMOolCwYy42EOA==", "SuSPf");
        h.lllIlIIII[h.lllIlIIIl[10]] = h.llIIIlIlIlIl("N/vsG4nW26ywYOgQ8i/FidnXIC05tCBJ", "IwmOt");
        h.lllIlIIII[h.lllIlIIIl[11]] = h.llIIIlIlIIll("Z6NCL5D7elF3rTsG87JeRQ==", "AKNla");
        h.lllIlIIII[h.lllIlIIIl[12]] = h.llIIIlIlIlII("CQYbGB4nChFRDzoWHB8KbwYBFAA8Q1UCGiYbFhkEIQhVEwwsBFUFAm8dFB8JIAIyFAw9BhsW", "Oouqm");
        h.lllIlIIII[h.lllIlIIIl[13]] = h.llIIIlIlIlIl("UGL7qm19iWAezGJBMDzHlrI831c3JOLu", "thmiA");
        h.lllIlIIII[h.lllIlIIIl[14]] = h.llIIIlIlIIll("Xv7m8JDDjW+qqanRPhJbEr7MNofHEHNj", "NLtbr");
        h.lllIlIIII[h.lllIlIIIl[19]] = h.llIIIlIlIlII("GjB4MSsodTU5Kj48Njd5PzQ2NDYgdT81OD95eCMuJCE7ODAjMngkNm0XDQkQAxI=", "MUXPY");
        h.lllIlIIII[h.lllIlIIIl[20]] = h.llIIIlIlIIll("/FG1b/xxadi1Hp6PQlyUF7RMXN1Z7HYWjLkkdC59ZdUBvoeydR5Pb42Vgt/iIUHf", "Vabbl");
        h.lllIlIIII[h.lllIlIIIl[21]] = h.llIIIlIlIIll("MUkubvlWXQMPWyvdz7FhfNfDLH7mSxl0lbNDlqqHKNVlCeLw+edq7o+eZWuRJPQm", "YitOg");
        h.lllIlIIII[h.lllIlIIIl[24]] = h.llIIIlIlIIll("mq4XhuCQ0peo4V+wW9591Y4rOf41eSDf", "RQOLC");
        h.lllIlIIII[h.lllIlIIIl[203]] = h.llIIIlIlIIll("kAgXvhGXgackMJEA1YA8q1cYqQoKoPAXLiZYsqtKNK/I9CpYjJI0pWv9yTLuMtZjj0CpKxbJ9Qg=", "EyJhV");
        h.lllIlIIII[h.lllIlIIIl[46]] = h.llIIIlIlIlIl("Hf/gxsrs8O0nr5TgQAHqZl+LwcCnb3bjh/dNixRVw9o=", "Ldgbb");
        h.lllIlIIII[h.lllIlIIIl[204]] = h.llIIIlIlIIll("2u2yaXaCl3M=", "AyDEa");
    }
    ...
    private static int a(Map<Integer, Integer> map, Random random) {
        ...
        while (h.llIIIlIllIII(lllIIIllIllll.hasNext() ? 1 : 0)) {
            ...
            ++lllIIIlllIIII;
            "".length();
            if ("  ".length() >= ((8 ^ 0x46) & ~(0x74 ^ 0x3A))) continue;
    ...
    private static String llIIIlIlIlII(String lllIIIlIlllII, String lllIIIllIIIII) {
        ...
        while (h.llIIIlIllIlI(lllIIIlIlIlIl, lllIIIlIlIllI)) {
            ...
            ++lllIIIlIlIlIl;
            "".length();
            if (((0xB2 ^ 0x93) & ~(0xA9 ^ 0x88)) < "   ".length()) continue;
            return null;
        }
    ...
    public static boolean d(int[] nArray) {
        ...
        while (h.llIIIlIllIlI(lllIIIllllllI, lllIIIlllllll.length)) {
            ...
            ++lllIIIllllllI;
            "".length();
            if (-" ".length() <= (0x1F ^ 0x58 ^ (0xCC ^ 0x8F))) continue;
            return ((0x87 ^ 0xB0 ^ (0x4B ^ 0x50)) & (119 + 8 - 60 + 115 ^ 48 + 2 - 2 + 106 ^ -" ".length())) != 0;
        }
        return lllIlIIIl[1];
    }
