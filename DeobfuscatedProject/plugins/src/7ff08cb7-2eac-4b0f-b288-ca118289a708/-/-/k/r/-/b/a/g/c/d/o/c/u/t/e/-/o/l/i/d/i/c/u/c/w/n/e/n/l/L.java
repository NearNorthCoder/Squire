...
implements ab {
                    ...
                    if (L.lIllIIlllIIl(Skills.getLevel((Skill)Skill.MAGIC), llIlIIlII[46]) && L.lIllIIllIlll(Skills.getLevel((Skill)Skill.MAGIC), llIlIIlII[60])) {
                        Magic.cast((Spell)SpellBook.Standard.WIND_BOLT, (NPC)NPCs.getNearest(nPC -> {
                            ...
                            if (L.lIllIIllIllI(nPC.getName().equalsIgnoreCase(llIIllIll[llIlIIlII[324]]) ? 1 : 0) && L.lIllIIlllIII(nPC.isDead() ? 1 : 0)) {
                                n2 = llIlIIlII[0];
                                "".length();
                                if (((0x16 ^ 0x61 ^ (0x1E ^ 0x5D)) & (0x8E ^ 0x94 ^ (0x5E ^ 0x70) ^ -" ".length())) != 0) {
                                    return ((154 + 151 - 247 + 112 ^ 111 + 94 - 135 + 91) & (0xEA ^ 0x93 ^ (0xC7 ^ 0xB5) ^ -" ".length())) != 0;
                                }
                            } else {
                                n2 = llIlIIlII[1];
                            }
                ...
                if (L.lIllIIllIllI((lIIlIlllIllllI = new WorldArea(llIlIIlII[78], llIlIIlII[79], llIlIIlII[68], llIlIIlII[55], llIlIIlII[1])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    TileObjects.getNearest(tileObject -> {
                        ...
                        if (L.lIllIIllIllI(tileObject.getName().contains(llIIllIll[llIlIIlII[320]]) ? 1 : 0) && L.lIllIlIIIIII(tileObject.getWorldLocation().distanceTo(new WorldPoint(llIlIIlII[260], llIlIIlII[295], llIlIIlII[1])), llIlIIlII[9])) {
                            n2 = llIlIIlII[0];
                            "".length();
                            if (((0xD4 ^ 0x81 ^ (1 ^ 0x5B)) & (0xC9 ^ 0x98 ^ (0xCD ^ 0x93) ^ -" ".length())) >= "  ".length()) {
                                return ((37 + 85 - -34 + 23 ^ 36 + 50 - -41 + 23) & (92 + 99 - 126 + 97 ^ 76 + 44 - 31 + 46 ^ -" ".length())) != 0;
                            }
                        } else {
                            n2 = llIlIIlII[1];
                        }
                ...
                if (L.lIllIIllIllI(gc.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && L.lIllIIlllIlI(lIIlIlllIlllll = TileObjects.getNearest(tileObject -> {
                    ...
                    if (L.lIllIIllIllI(tileObject.getName().contains(llIIllIll[llIlIIlII[314]]) ? 1 : 0)) {
                        ...
                        if (L.lIllIIllIllI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                            n2 = llIlIIlII[0];
                            "".length();
                            if ((0x1E ^ 0x1A) != " ".length()) return n2 != 0;
                            return ((0x64 ^ 0x68) & ~(0xAA ^ 0xA6)) != 0;
                        }
                    }
                    n2 = llIlIIlII[1];
                    return n2 != 0;
                            ...
                            if (L.lIllIIllIllI(Inventory.contains((int[])nArray16) ? 1 : 0)) {
                                lIIlIlllIllllI = TileObjects.getNearest(tileObject -> {
                                    ...
                                    if (L.lIllIIllIllI(tileObject.getName().contains(llIIllIll[llIlIIlII[313]]) ? 1 : 0) && L.lIllIlIIIIII(tileObject.getWorldLocation().distanceTo(new WorldPoint(llIlIIlII[206], llIlIIlII[148], llIlIIlII[1])), llIlIIlII[6])) {
                                        n2 = llIlIIlII[0];
                                        "".length();
                                        if (-" ".length() > ((0x5B ^ 0x7C) & ~(0x5F ^ 0x78))) {
                                            return ((0xB1 ^ 0xA7) & ~(0x49 ^ 0x5F)) != 0;
                                        }
                                    } else {
                                        n2 = llIlIIlII[1];
                                    }
                            ...
                            if (L.lIllIIllIllI(Inventory.contains((int[])nArray21) ? 1 : 0)) {
                                lIIlIlllIllllI = TileObjects.getNearest(tileObject -> {
                                    ...
                                    if (L.lIllIIllIllI(tileObject.getName().contains(llIIllIll[llIlIIlII[311]]) ? 1 : 0) && L.lIllIlIIIIII(tileObject.getWorldLocation().distanceTo(new WorldPoint(llIlIIlII[312], llIlIIlII[135], llIlIIlII[1])), llIlIIlII[6])) {
                                        ...
                                        "".length();
                                        if ("   ".length() == " ".length()) {
                                            return ((0x51 ^ 0x38 ^ (0xF ^ 0x46)) & (4 ^ 0xF ^ (0x3A ^ 0x11) ^ -" ".length())) != 0;
                                        }
                                    } else {
                                        n2 = llIlIIlII[1];
                                    }
    ...
    private static boolean an() {
        ...
        while (L.lIllIIllIlll(lIIlIllIIllllI, ((void)lIIlIllIIlllll).length)) {
            ...
            "".length();
            if (null == null) continue;
            return ((0x98 ^ 0x93 ^ (0x87 ^ 0x93)) & (0xD5 ^ 0x9D ^ (0x6F ^ 0x38) ^ -" ".length())) != 0;
        }
        return llIlIIlII[0];
    }
    ...
    private static /* synthetic */ boolean c(WorldPoint worldPoint, TileObject tileObject) {
        ...
        if (L.lIllIIllIllI(tileObject.getName().contains(llIIllIll[llIlIIlII[297]]) ? 1 : 0) && L.lIllIlIIIIII(tileObject.getWorldLocation().distanceTo(worldPoint), llIlIIlII[9])) {
            ...
            "".length();
            if (null != null) {
                return ((5 ^ 0x3A ^ (0x26 ^ 0x5F)) & (0x4E ^ 0x37 ^ (0x35 ^ 0xA) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIlIIlII[1];
        }
    ...
    private static void lIllIIIllIIl() {
        ...
        L.llIIllIll[L.llIlIIlII[1]] = L.lIlIllIllIII("bqmniugVDr5Z149su1FMUvcerauW1FocMyTKTU2qTuwSCRGSuxAT9Uy3IXyjRMlH", "QATyw");
        L.llIIllIll[L.llIlIIlII[0]] = L.lIlIllIllIIl("4IThmQppXdN4HJFXLfcZzA==", "OKHRL");
        L.llIIllIll[L.llIlIIlII[5]] = L.lIlIllIllIlI("VFkSBC0NEXYxIBgNMwA5", "yyVaL");
        L.llIIllIll[L.llIlIIlII[6]] = L.lIlIllIllIlI("", "ZWjuW");
        L.llIIllIll[L.llIlIIlII[7]] = L.lIlIllIllIlI("JxUycC4GVCYxNAI=", "itDPZ");
        L.llIIllIll[L.llIlIIlII[9]] = L.lIlIllIllIlI("MQgMNS0QBwVxIxgHCTgvHg==", "yibQA");
        L.llIIllIll[L.llIlIIlII[18]] = L.lIlIllIllIII("8zut1P7bD7fQlMyarZ4Qogp3J87ww3ri+JTi8XbrR56VfZeTzBcVeOTy+7YFurd+hqzJZeiNmJU=", "bRtkd");
        L.llIIllIll[L.llIlIIlII[25]] = L.lIlIllIllIlI("AAtCBhMyTg8OEiQHDABBJhsHFBV3HRcXETsHBxRNdx0VDhU0BgsJBncaDUcjAjcrKSY=", "Wnbga");
        L.llIIllIll[L.llIlIIlII[26]] = L.lIlIllIllIlI("HRoFLBo=", "YhlBq");
        L.llIIllIll[L.llIlIIlII[27]] = L.lIlIllIllIII("/3a2UaXI8DY=", "upFAy");
        L.llIIllIll[L.llIlIIlII[19]] = L.lIlIllIllIIl("ORp9f71j0x4=", "ayzNe");
        L.llIIllIll[L.llIlIIlII[31]] = L.lIlIllIllIlI("MBsmJSo=", "csGWA");
        L.llIIllIll[L.llIlIIlII[32]] = L.lIlIllIllIlI("FgIh", "ScUBo");
        L.llIIllIll[L.llIlIIlII[33]] = L.lIlIllIllIIl("ZtPMql7Mn5I=", "bhwQR");
        L.llIIllIll[L.llIlIIlII[34]] = L.lIlIllIllIIl("vsqIX/vJ2shWwO5esBDLFQ==", "fqSKi");
        L.llIIllIll[L.llIlIIlII[35]] = L.lIlIllIllIlI("BhElIwY2HA==", "BtKVj");
        L.llIIllIll[L.llIlIIlII[36]] = L.lIlIllIllIlI("FSw0IgglIQ==", "QIZWd");
        L.llIIllIll[L.llIlIIlII[46]] = L.lIlIllIllIII("S0LV86WeA1TSU2XII1evig==", "HYSpp");
        L.llIIllIll[L.llIlIIlII[43]] = L.lIlIllIllIIl("lp014rlirXZJE5ifK5NL8J5wuxdyjpGN", "HCKlI");
        L.llIIllIll[L.llIlIIlII[47]] = L.lIlIllIllIlI("KBgaADk=", "zwykJ");
        L.llIIllIll[L.llIlIIlII[48]] = L.lIlIllIllIII("zGD9LPr8PwM=", "BIvTc");
        L.llIIllIll[L.llIlIIlII[54]] = L.lIlIllIllIlI("NBYMOTceFAJ0JhIZCjoxVwgKNz4E", "wzeTU");
        L.llIIllIll[L.llIlIIlII[55]] = L.lIlIllIllIII("P+T5Iew7elI=", "JrvWw");
        L.llIIllIll[L.llIlIIlII[60]] = L.lIlIllIllIIl("/42yL387K0ay51jS+jINkqGhJzOk7L7j", "uPpzR");
        L.llIIllIll[L.llIlIIlII[30]] = L.lIlIllIllIII("cVE2qa4Zstc=", "nagJT");
        L.llIIllIll[L.llIlIIlII[62]] = L.lIlIllIllIlI("NAEAFCoeAw5ZPB8EGx1oBQIKEjs=", "wmiyH");
        L.llIIllIll[L.llIlIIlII[40]] = L.lIlIllIllIII("01gdOnHpNAU=", "ClTUF");
        L.llIIllIll[L.llIlIIlII[63]] = L.lIlIllIllIlI("NyoWJDobKgVhKQAhDCA=", "rDbAH");
        L.llIIllIll[L.llIlIIlII[64]] = L.lIlIllIllIlI("CigHJxtrHww9CCo0ASw=", "KZbIz");
        L.llIIllIll[L.llIlIIlII[65]] = L.lIlIllIllIlI("PRk3Og==", "riRTM");
        L.llIIllIll[L.llIlIIlII[39]] = L.lIlIllIllIlI("MgUe", "vdzxb");
        L.llIIllIll[L.llIlIIlII[67]] = L.lIlIllIllIII("Dx0SNNeRk7GTI7udHp+7+Q==", "GQaAs");
        L.llIIllIll[L.llIlIIlII[68]] = L.lIlIllIllIII("dgTSmUzquhtThdBNTSmMGQ==", "sIOnI");
        L.llIIllIll[L.llIlIIlII[69]] = L.lIlIllIllIII("TNaWgpviogZPvKycrbei5A==", "rjRbd");
        L.llIIllIll[L.llIlIIlII[71]] = L.lIlIllIllIlI("KSgYGicCN1EPPAk+EA==", "lPqnN");
        L.llIIllIll[L.llIlIIlII[70]] = L.lIlIllIllIII("zTGlXrNomLrRF/V3NiUjfw==", "jqkEs");
        L.llIIllIll[L.llIlIIlII[72]] = L.lIlIllIllIII("aq3zJ/u1yCs=", "pFNel");
        L.llIIllIll[L.llIlIIlII[74]] = L.lIlIllIllIlI("Eik8JlYUJj4xFz8rLw==", "QHJCv");
        L.llIIllIll[L.llIlIIlII[75]] = L.lIlIllIllIII("6Lhs7tm8F/jitNK7NJY8lQ==", "VrgDr");
        L.llIIllIll[L.llIlIIlII[76]] = L.lIlIllIllIII("3NOqIEh2uDBhV4lxuSxhiw==", "NTibl");
        L.llIIllIll[L.llIlIIlII[77]] = L.lIlIllIllIIl("XQTw1lnTzmc=", "gDNme");
        L.llIIllIll[L.llIlIIlII[80]] = L.lIlIllIllIIl("VHaEeJVm5xRN7b49SDvuuQ==", "uehKU");
        L.llIIllIll[L.llIlIIlII[81]] = L.lIlIllIllIIl("+TphoIkt/To=", "kVQUF");
        L.llIIllIll[L.llIlIIlII[2]] = L.lIlIllIllIIl("lUTdQ7lMh5nJhoepXvcU6PFyMbs6oL8H2cXnBCqEDuM=", "BVahx");
        L.llIIllIll[L.llIlIIlII[130]] = L.lIlIllIllIlI("AgM7BjsuAyhDOjMfIA0uLwIjBw==", "GmOcI");
        L.llIIllIll[L.llIlIIlII[131]] = L.lIlIllIllIlI("ET8XOAwlIwo7Bg==", "BKeWb");
        L.llIIllIll[L.llIlIIlII[132]] = L.lIlIllIllIIl("FdNSLsfDq0s=", "TpQIn");
        L.llIIllIll[L.llIlIIlII[136]] = L.lIlIllIllIII("Bam2t7g6GqfCZjzvYETWUw==", "InZHP");
        L.llIIllIll[L.llIlIIlII[137]] = L.lIlIllIllIlI("Ag0OEg==", "Vlewi");
        L.llIIllIll[L.llIlIIlII[138]] = L.lIlIllIllIIl("p8Xui953BsfdSN2LWei63Q==", "wLmql");
        L.llIIllIll[L.llIlIIlII[29]] = L.lIlIllIllIII("TFCVG99HufwJ3jn/BPR2Rw==", "vQqpT");
        L.llIIllIll[L.llIlIIlII[141]] = L.lIlIllIllIlI("FRw7ChFmOyAFHTQLNRcR", "FhTdt");
        L.llIIllIll[L.llIlIIlII[142]] = L.lIlIllIllIII("I2oarUqByKzQVejcDJlzcQ==", "XVBlF");
        L.llIIllIll[L.llIlIIlII[143]] = L.lIlIllIllIII("g3gPwzBMGVCfHGQw5WwZtQ==", "cBfBe");
        L.llIIllIll[L.llIlIIlII[144]] = L.lIlIllIllIII("HUPhhs8fLT8Kjo9y3wU8GQ==", "HDfxv");
        L.llIIllIll[L.llIlIIlII[145]] = L.lIlIllIllIlI("JhkhTxkHWCQbDAEK", "hxWom");
        L.llIIllIll[L.llIlIIlII[146]] = L.lIlIllIllIlI("Gg0lJjR0BSM8OA==", "YaLKV");
        L.llIIllIll[L.llIlIIlII[149]] = L.lIlIllIllIII("EVoZkV9iRZAdJCaWGi2ebw==", "QhaWb");
        L.llIIllIll[L.llIlIIlII[150]] = L.lIlIllIllIII("lLnQyaRHm0YaxrCZwLXyXw==", "ZSucE");
        L.llIIllIll[L.llIlIIlII[152]] = L.lIlIllIllIlI("MhY3ExY=", "psEao");
        L.llIIllIll[L.llIlIIlII[153]] = L.lIlIllIllIIl("wm58NzjF5cY=", "xaqwE");
        L.llIIllIll[L.llIlIIlII[154]] = L.lIlIllIllIlI("JRQfFEwkCR4DBQA=", "cfzql");
        L.llIIllIll[L.llIlIIlII[156]] = L.lIlIllIllIII("FuOsRkFwDz8=", "uLHug");
        L.llIIllIll[L.llIlIIlII[157]] = L.lIlIllIllIlI("Mg8CEg==", "fniwb");
        L.llIIllIll[L.llIlIIlII[160]] = L.lIlIllIllIII("uQeKzuY8anHU4U5wcY3hLA==", "UwTfl");
        L.llIIllIll[L.llIlIIlII[161]] = L.lIlIllIllIIl("/nUmI33Szws=", "bfHgy");
        L.llIIllIll[L.llIlIIlII[169]] = L.lIlIllIllIlI("CSolZi0oayEpOiw4", "GKSFY");
        L.llIIllIll[L.llIlIIlII[170]] = L.lIlIllIllIlI("GQ4FAzN6BAUcIi5CHgEyMRE=", "ZblnQ");
        L.llIIllIll[L.llIlIIlII[171]] = L.lIlIllIllIIl("G9ke7HRLncQ=", "NgUoJ");
        L.llIIllIll[L.llIlIIlII[172]] = L.lIlIllIllIII("W90RRhj+n7U=", "SmcEA");
        L.llIIllIll[L.llIlIIlII[173]] = L.lIlIllIllIII("T+JlGOCuG3nlJv7kxT3f6uNTICDF/qSi", "JGZGd");
        L.llIIllIll[L.llIlIIlII[174]] = L.lIlIllIllIIl("p0KOjoBEVN0=", "YtUtA");
        L.llIIllIll[L.llIlIIlII[175]] = L.lIlIllIllIII("WVm7UTwrHkV67hHqUB3y127F94mGWKFG", "lZrWE");
        L.llIIllIll[L.llIlIIlII[176]] = L.lIlIllIllIIl("kSsKZtKsMAg=", "ZkKso");
        L.llIIllIll[L.llIlIIlII[177]] = L.lIlIllIllIIl("PFR9onQ36OC/Q0p2MLZLfJXyCPTveZXF", "FruAm");
        L.llIIllIll[L.llIlIIlII[178]] = L.lIlIllIllIII("9gFoeNnShPA=", "jaZII");
        L.llIIllIll[L.llIlIIlII[179]] = L.lIlIllIllIlI("BwIVAB8rAgZFDDAJDwQ=", "Blaem");
        L.llIIllIll[L.llIlIIlII[180]] = L.lIlIllIllIlI("DQoIOBZsPQMiBS0WDjM=", "LxmVw");
        L.llIIllIll[L.llIlIIlII[181]] = L.lIlIllIllIIl("uOGlJqdwyQA=", "HZjUG");
        L.llIIllIll[L.llIlIIlII[182]] = L.lIlIllIllIIl("BZN2xn59v2APC1WlSEXAvA==", "bkjbP");
        L.llIIllIll[L.llIlIIlII[4]] = L.lIlIllIllIIl("F2C/sxrkJ9v5LnaQPfxa6w==", "Kijot");
        L.llIIllIll[L.llIlIIlII[183]] = L.lIlIllIllIII("WsrIdfbdqLA=", "RmKZr");
        L.llIIllIll[L.llIlIIlII[184]] = L.lIlIllIllIII("+6jN3twzOzRsUuHeZA+cnw==", "WbVLj");
        L.llIIllIll[L.llIlIIlII[185]] = L.lIlIllIllIIl("x3iPs5KWYw4Yl+yjlbiVyw==", "hHhRY");
        L.llIIllIll[L.llIlIIlII[186]] = L.lIlIllIllIII("79xn/JdmHD7dTc2fqAJ6+w==", "BjEkR");
        L.llIIllIll[L.llIlIIlII[187]] = L.lIlIllIllIlI("KQ0yPBs=", "lcFYi");
        L.llIIllIll[L.llIlIIlII[164]] = L.lIlIllIllIlI("LhQiACAFC2sXKB0J", "klKtI");
        L.llIIllIll[L.llIlIIlII[188]] = L.lIlIllIllIIl("PUdD2EtijAQ=", "kvjTq");
        L.llIIllIll[L.llIlIIlII[212]] = L.lIlIllIllIIl("MnQcbhy5UNIT7Xk2AxcBvfuK67xCNViK", "gAwNc");
        L.llIIllIll[L.llIlIIlII[213]] = L.lIlIllIllIII("13jru0Kc8lMqHEFsemErTQ==", "yFlIX");
        L.llIIllIll[L.llIlIIlII[214]] = L.lIlIllIllIII("Y+WgnsKNcvt16MkA+azMb0rDTq7CfRKN", "jnNMN");
        L.llIIllIll[L.llIlIIlII[215]] = L.lIlIllIllIII("JawObEeCp6c=", "mNMvx");
        L.llIIllIll[L.llIlIIlII[216]] = L.lIlIllIllIIl("+gFLexoAl6c=", "vuIck");
        L.llIIllIll[L.llIlIIlII[217]] = L.lIlIllIllIIl("FlutfwrvawrfuRuYU5GHA0a8gXf6TcAs", "QOFuW");
        L.llIIllIll[L.llIlIIlII[165]] = L.lIlIllIllIlI("GgYBABo=", "Yjhmx");
        L.llIIllIll[L.llIlIIlII[218]] = L.lIlIllIllIII("Lg1qaeL+mK1FJ9485Pyj+BhusX/bwcnW", "OYOaf");
        L.llIIllIll[L.llIlIIlII[219]] = L.lIlIllIllIII("JKla9H52Pz8=", "jkRTb");
        L.llIIllIll[L.llIlIIlII[220]] = L.lIlIllIllIlI("JQYtGDsPBCNVLQ4DNhF5FAUnHio=", "fjDuY");
        L.llIIllIll[L.llIlIIlII[221]] = L.lIlIllIllIIl("slPKDMjcHOU=", "QfCXy");
        L.llIIllIll[L.llIlIIlII[222]] = L.lIlIllIllIIl("UsAGqGv80ylNHfD7dUa9yQ==", "knKWC");
        L.llIIllIll[L.llIlIIlII[223]] = L.lIlIllIllIlI("KDEzDTVJBjgXJggtNQY=", "iCVcT");
        L.llIIllIll[L.llIlIIlII[224]] = L.lIlIllIllIlI("KD8tFg==", "gOHxq");
        L.llIIllIll[L.llIlIIlII[225]] = L.lIlIllIllIlI("Hz4GDQ40IU8YFT8oDg==", "ZFoyg");
        L.llIIllIll[L.llIlIIlII[226]] = L.lIlIllIllIII("undylOslYnUHRGoamkgzwQ==", "dhAYV");
        L.llIIllIll[L.llIlIIlII[227]] = L.lIlIllIllIIl("ba8a835ZdzQ=", "gGoKH");
        L.llIIllIll[L.llIlIIlII[228]] = L.lIlIllIllIII("jLep0Jaex4/gVJiBw7UBqg==", "CPcvd");
        L.llIIllIll[L.llIlIIlII[229]] = L.lIlIllIllIII("FRCWKFXEUJt8huX1iXwMZg==", "gcvHQ");
        L.llIIllIll[L.llIlIIlII[230]] = L.lIlIllIllIlI("MyclJmU1KCcxJB4lNg==", "pFSCE");
        L.llIIllIll[L.llIlIIlII[231]] = L.lIlIllIllIlI("Chg5NBk=", "OvMQk");
        L.llIIllIll[L.llIlIIlII[232]] = L.lIlIllIllIlI("EhE4ETs5DnEGMyEM", "WiQeR");
        L.llIIllIll[L.llIlIIlII[233]] = L.lIlIllIllIlI("EBwwPA==", "UdYHm");
        L.llIIllIll[L.llIlIIlII[234]] = L.lIlIllIllIIl("0fH4NqJbgKDdhM2F4jPBq2V3Sdj6WXw4Vg9DI89UZQM=", "slxNC");
        L.llIIllIll[L.llIlIIlII[235]] = L.lIlIllIllIlI("IxQnLh4PFDRrHxIIPCULDhU/Lw==", "fzSKl");
        L.llIIllIll[L.llIlIIlII[236]] = L.lIlIllIllIII("sP4pzqVmdbX60kd6Sf5KCw==", "oucBZ");
        L.llIIllIll[L.llIlIIlII[237]] = L.lIlIllIllIlI("MysGAQo=", "vErdx");
        L.llIIllIll[L.llIlIIlII[238]] = L.lIlIllIllIIl("f/5732Kg5cXq1QGnY76Jrg==", "LuCJI");
        L.llIIllIll[L.llIlIIlII[239]] = L.lIlIllIllIlI("Nw0cAQhUBxweGQBBBwMJHxI=", "taulj");
        L.llIIllIll[L.llIlIIlII[240]] = L.lIlIllIllIII("a9bvyRzcwdA=", "gPtwi");
        L.llIIllIll[L.llIlIIlII[168]] = L.lIlIllIllIIl("zp9alxL6TSQ=", "hshwV");
        L.llIIllIll[L.llIlIIlII[241]] = L.lIlIllIllIII("+hO9YD3B0qfkxrGpk4uk2/5S2MkDn7j6", "Mhdtr");
        L.llIIllIll[L.llIlIIlII[242]] = L.lIlIllIllIlI("EDkZBi8=", "SUpkM");
        L.llIIllIll[L.llIlIIlII[243]] = L.lIlIllIllIIl("fsBTlGYj5Jg7anFIQfnuDCkNhsopjitr", "gAeyk");
        L.llIIllIll[L.llIlIIlII[244]] = L.lIlIllIllIlI("ASABJBI=", "BLhIp");
        L.llIIllIll[L.llIlIIlII[245]] = L.lIlIllIllIlI("OTQnOwkTNil2HxIxPDJLCDctPRg=", "zXNVk");
        L.llIIllIll[L.llIlIIlII[246]] = L.lIlIllIllIII("mP85+XdyMpY=", "KXUfU");
        L.llIIllIll[L.llIlIIlII[247]] = L.lIlIllIllIIl("GmJvOjF6BgZQzUqzIi5L5g==", "Ljkfc");
        L.llIIllIll[L.llIlIIlII[248]] = L.lIlIllIllIIl("80gqh+tfwdorHnsvJ/KdBg==", "ryfeQ");
        L.llIIllIll[L.llIlIIlII[249]] = L.lIlIllIllIlI("KyMVDQ==", "dSpcK");
        L.llIIllIll[L.llIlIIlII[250]] = L.lIlIllIllIIl("3TyQIVyClT9zcIDAjAhvQA==", "dOanV");
        L.llIIllIll[L.llIlIIlII[251]] = L.lIlIllIllIIl("/n1FkubnrVV8MABAJ65aGg==", "XCDVw");
        L.llIIllIll[L.llIlIIlII[252]] = L.lIlIllIllIIl("ZC2DtyUP6uU=", "fcyhn");
        L.llIIllIll[L.llIlIIlII[253]] = L.lIlIllIllIlI("KQMVEHYvDBcHNwQBBg==", "jbcuV");
        L.llIIllIll[L.llIlIIlII[254]] = L.lIlIllIllIIl("hGjn6Zouxo9h95tvmBhFSg==", "auTMj");
        L.llIIllIll[L.llIlIIlII[255]] = L.lIlIllIllIIl("wCBvUxM1pYMRQZDgSK9RYA==", "tRWOI");
        L.llIIllIll[L.llIlIIlII[256]] = L.lIlIllIllIIl("95nlgJFcu1g=", "nmBij");
        L.llIIllIll[L.llIlIIlII[257]] = L.lIlIllIllIII("TgNcIUVQWSKr5hUPZM+ymw==", "xXDUs");
        L.llIIllIll[L.llIlIIlII[258]] = L.lIlIllIllIlI("HT88Jg==", "XGURH");
        L.llIIllIll[L.llIlIIlII[273]] = L.lIlIllIllIlI("JwodSzwGSy4KLA4KGRhoCgodDg==", "ikkkH");
        L.llIIllIll[L.llIlIIlII[274]] = L.lIlIllIllIlI("Jz8eFTcLPw1QJgMnDw==", "bQjpE");
        L.llIIllIll[L.llIlIIlII[275]] = L.lIlIllIllIII("j6RVzTHmirht0hyBKpOoEw==", "DYpNO");
        L.llIIllIll[L.llIlIIlII[276]] = L.lIlIllIllIIl("QsmGYJtTPyk=", "KxXov");
        L.llIIllIll[L.llIlIIlII[277]] = L.lIlIllIllIIl("dW1ZdVPJl4oyk+m8v8aQyg==", "mroVV");
        L.llIIllIll[L.llIlIIlII[278]] = L.lIlIllIllIlI("CiAwATJpOiQAJA==", "IHQnA");
        L.llIIllIll[L.llIlIIlII[291]] = L.lIlIllIllIII("a56Ir6Krq3iotLCmujkK0e78PYG6v1Q7", "ATINW");
        L.llIIllIll[L.llIlIIlII[292]] = L.lIlIllIllIlI("Mh8bIRkDBQ==", "fwiNn");
        L.llIIllIll[L.llIlIIlII[293]] = L.lIlIllIllIlI("OSUWGgMIPw==", "mMdut");
        L.llIIllIll[L.llIlIIlII[294]] = L.lIlIllIllIlI("KC81CnkuNiob", "kNCoY");
        L.llIIllIll[L.llIlIIlII[296]] = L.lIlIllIllIlI("AzgpERI=", "QWJza");
        L.llIIllIll[L.llIlIIlII[297]] = L.lIlIllIllIII("Hq2Dl68XDF4=", "DdCpw");
        L.llIIllIll[L.llIlIIlII[298]] = L.lIlIllIllIlI("NTUrLik=", "gZHEZ");
        L.llIIllIll[L.llIlIIlII[299]] = L.lIlIllIllIIl("p3wqxOIrLDo=", "EwNKi");
        L.llIIllIll[L.llIlIIlII[300]] = L.lIlIllIllIII("QWzMR9DG8d0=", "CWXwJ");
        L.llIIllIll[L.llIlIIlII[301]] = L.lIlIllIllIlI("LhYyPGEoDy0t", "mwDYA");
        L.llIIllIll[L.llIlIIlII[302]] = L.lIlIllIllIIl("CUZvD9wmW38=", "wgqAw");
        L.llIIllIll[L.llIlIIlII[303]] = L.lIlIllIllIlI("EB4UDwc=", "Bqwdt");
        L.llIIllIll[L.llIlIIlII[304]] = L.lIlIllIllIIl("6oZ182wuQA4=", "gkben");
        L.llIIllIll[L.llIlIIlII[305]] = L.lIlIllIllIII("20MCjHvHwtQ=", "kTLkX");
        L.llIIllIll[L.llIlIIlII[306]] = L.lIlIllIllIII("WU5cu6J0KD0=", "DARlO");
        L.llIIllIll[L.llIlIIlII[307]] = L.lIlIllIllIII("ma+mp84Kd5PWx/6OCgQmqw==", "qHffc");
        L.llIIllIll[L.llIlIIlII[308]] = L.lIlIllIllIlI("NCsRIiM=", "fDrIP");
        L.llIIllIll[L.llIlIIlII[309]] = L.lIlIllIllIII("aTGmqdUJFWo=", "AEXGT");
        L.llIIllIll[L.llIlIIlII[310]] = L.lIlIllIllIIl("5FfmZXEKxqs=", "PvpHj");
        L.llIIllIll[L.llIlIIlII[311]] = L.lIlIllIllIIl("t2U1pjsTYsnOVuZPshz4dA==", "sqAkj");
        L.llIIllIll[L.llIlIIlII[313]] = L.lIlIllIllIII("n8ZZ+P8CB810y0+jV2vtgw==", "DKnUz");
        L.llIIllIll[L.llIlIIlII[314]] = L.lIlIllIllIlI("AAAIHQIwFRoR", "Stitp");
        L.llIIllIll[L.llIlIIlII[315]] = L.lIlIllIllIIl("NtMvIgf6qGeCDaFGdy5j8g==", "ljqlw");
        L.llIIllIll[L.llIlIIlII[316]] = L.lIlIllIllIII("3hm0iBujaaLkQCX9X6SdYA==", "CiWgB");
        L.llIIllIll[L.llIlIIlII[317]] = L.lIlIllIllIII("PpKLdtSguln/3R8KmrnhoQ==", "rZZSi");
        L.llIIllIll[L.llIlIIlII[318]] = L.lIlIllIllIlI("LS4LJDMcNA==", "yFyKD");
        L.llIIllIll[L.llIlIIlII[319]] = L.lIlIllIllIIl("x09jVApMQ5k=", "Cwjlx");
        L.llIIllIll[L.llIlIIlII[320]] = L.lIlIllIllIII("R9i95nr5ORoQdv+p+b+0MQ==", "loPSU");
        L.llIIllIll[L.llIlIIlII[321]] = L.lIlIllIllIlI("MQkC", "uhflR");
        L.llIIllIll[L.llIlIIlII[322]] = L.lIlIllIllIII("ojsnICj7aks=", "scDEj");
        L.llIIllIll[L.llIlIIlII[323]] = L.lIlIllIllIlI("NAQx", "peUnS");
        L.llIIllIll[L.llIlIIlII[324]] = L.lIlIllIllIIl("DgZ4WEbjqmE=", "RXUct");
        L.llIIllIll[L.llIlIIlII[325]] = L.lIlIllIllIIl("vbYi4SH2ztc=", "kDErL");
        L.llIIllIll[L.llIlIIlII[326]] = L.lIlIllIllIIl("4Mk3qgsOP2I=", "weLXd");
        L.llIIllIll[L.llIlIIlII[327]] = L.lIlIllIllIII("5NWmFT4EvEo=", "QYbuN");
        L.llIIllIll[L.llIlIIlII[328]] = L.lIlIllIllIIl("Gb3P1Yb7dIU=", "yTBRQ");
        L.llIIllIll[L.llIlIIlII[339]] = L.lIlIllIllIIl("U4yh2rzD0DI=", "YNLrz");
        L.llIIllIll[L.llIlIIlII[283]] = L.lIlIllIllIlI("MSUICS5FBBMXLQswDwouAXc=", "eWgeB");
        L.llIIllIll[L.llIlIIlII[340]] = L.lIlIllIllIlI("FxI6fQ==", "NwISC");
        L.llIIllIll[L.llIlIIlII[341]] = L.lIlIllIllIIl("SYlTF94H+Qd+T7PcrTbyjh6Y62OpgJuJXPgfh3MlenjROepiCGTA7A==", "uIPCD");
        L.llIIllIll[L.llIlIIlII[342]] = L.lIlIllIllIIl("SiiUkLFIW6su+BuAcYnYkAY1pI7J6DmsWoBsuW9SvVQ=", "OMPXe");
        L.llIIllIll[L.llIlIIlII[343]] = L.lIlIllIllIII("ksYgcJnxpy4LEhICh6ciiZ+xHvMp2y4g", "UTxKP");
    }
    ...
    private static boolean cm() {
        ...
        if (!L.lIllIIlllIII(worldArea.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || L.lIllIIllIllI(worldArea2.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            "".length();
            if ("  ".length() != "  ".length()) {
                return ((161 + 92 - 174 + 161 ^ 145 + 107 - 182 + 109) & (0x63 ^ 1 ^ (0xE2 ^ 0xC3) ^ -" ".length())) != 0;
            }
        } else {
            bl = llIlIIlII[1];
        }
    ...
    public int af() {
        ...
        if ("   ".length() >= (0x55 ^ 0x71 ^ (0x53 ^ 0x73))) {
            return (0x61 ^ 0x2B ^ (0x41 ^ 4)) & (0xA4 ^ 0xB3 ^ (0x57 ^ 0x4F) ^ -" ".length());
        }
    ...
    public boolean ah() {
        ...
        if (L.lIllIIlllIIl(e.j(dL), llIlIIlII[29])) {
            ...
            "".length();
            if (" ".length() < -" ".length()) {
                return ((0xF7 ^ 0x83 ^ (0xAD ^ 0x97)) & (0x6B ^ 0x65 ^ (0x18 ^ 0x58) ^ -" ".length())) != 0;
            }
        } else {
            bl = llIlIIlII[1];
        }
        ...
        block9: {
            ...
            Magic.cast((Spell)SpellBook.Standard.FIRE_STRIKE, (NPC)NPCs.getNearest(nPC -> {
                ...
                if (L.lIllIIllIllI(nPC.getName().equalsIgnoreCase(lIIlIllIlIIIlI) ? 1 : 0) && L.lIllIIlllIII(nPC.isDead() ? 1 : 0)) {
                    ...
                    "".length();
                    if (" ".length() != " ".length()) {
                        return ((0x9B ^ 0x84 ^ (0x55 ^ 0x75)) & (0xE9 ^ 0x94 ^ (0xE5 ^ 0xA7) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = llIlIIlII[1];
                }
            ...
            if (L.lIllIIlllIIl(Skills.getLevel((Skill)Skill.MAGIC), llIlIIlII[46]) && L.lIllIIllIlll(Skills.getLevel((Skill)Skill.MAGIC), llIlIIlII[60])) {
                Magic.cast((Spell)SpellBook.Standard.WIND_BOLT, (NPC)NPCs.getNearest(nPC -> {
                    ...
                    if (L.lIllIIllIllI(nPC.getName().equalsIgnoreCase(lIIlIllIlIIIlI) ? 1 : 0) && L.lIllIIlllIII(nPC.isDead() ? 1 : 0)) {
                        n2 = llIlIIlII[0];
                        "".length();
                        if (-" ".length() > ((0xB0 ^ 0x90) & ~(0xBA ^ 0x9A))) {
                            return ((0x5E ^ 0x78) & ~(0x6C ^ 0x4A)) != 0;
                        }
                    } else {
                        n2 = llIlIIlII[1];
                    }
            ...
            if (L.lIllIIlllIIl(Skills.getLevel((Skill)Skill.MAGIC), llIlIIlII[60]) && L.lIllIIllIlll(Skills.getLevel((Skill)Skill.MAGIC), llIlIIlII[65])) {
                Magic.cast((Spell)SpellBook.Standard.WATER_BOLT, (NPC)NPCs.getNearest(nPC -> {
                    ...
                    if (L.lIllIIllIllI(nPC.getName().equalsIgnoreCase(lIIlIllIlIIIlI) ? 1 : 0) && L.lIllIIlllIII(nPC.isDead() ? 1 : 0)) {
                        ...
                        "".length();
                        if (null != null) {
                            return ((61 + 143 - 135 + 108 ^ 51 + 124 - 172 + 158) & (0 + 152 - -26 + 3 ^ 133 + 61 - 137 + 108 ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = llIlIIlII[1];
                    }
            ...
            if (L.lIllIIlllIIl(Skills.getLevel((Skill)Skill.MAGIC), llIlIIlII[65]) && L.lIllIIllIlll(Skills.getLevel((Skill)Skill.MAGIC), llIlIIlII[70])) {
                Magic.cast((Spell)SpellBook.Standard.EARTH_BOLT, (NPC)NPCs.getNearest(nPC -> {
                    ...
                    if (L.lIllIIllIllI(nPC.getName().equalsIgnoreCase(lIIlIllIlIIIlI) ? 1 : 0) && L.lIllIIlllIII(nPC.isDead() ? 1 : 0)) {
                        ...
                        "".length();
                        if (null != null) {
                            return ((32 + 7 - -79 + 30 ^ 4 + 80 - -38 + 56) & (0x81 ^ 0xB8 ^ (0x66 ^ 0x79) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = llIlIIlII[1];
                    }
            ...
            if (L.lIllIIlllIIl(Skills.getLevel((Skill)Skill.MAGIC), llIlIIlII[70])) {
                Magic.cast((Spell)SpellBook.Standard.FIRE_BOLT, (NPC)NPCs.getNearest(nPC -> {
                    ...
                    if (L.lIllIIllIllI(nPC.getName().equalsIgnoreCase(lIIlIllIlIIIlI) ? 1 : 0) && L.lIllIIlllIII(nPC.isDead() ? 1 : 0)) {
                        n2 = llIlIIlII[0];
                        "".length();
                        if (((0x3E ^ 0x6F ^ (0xF6 ^ 0x85)) & (0x27 ^ 0x39 ^ (0xA2 ^ 0x9E) ^ -" ".length())) != 0) {
                            return ((0x1E ^ 0x27 ^ (0x42 ^ 0x69)) & (0x50 ^ 0xE ^ (0xF3 ^ 0xBF) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = llIlIIlII[1];
                    }
    ...
    private static /* synthetic */ boolean l(WorldPoint worldPoint, TileObject tileObject) {
        ...
        if (L.lIllIIllIllI(tileObject.getName().contains(llIIllIll[llIlIIlII[327]]) ? 1 : 0) && L.lIllIlIIIIII(tileObject.getWorldLocation().distanceTo(worldPoint), llIlIIlII[9])) {
            n2 = llIlIIlII[0];
            "".length();
            if ("   ".length() > (0x29 ^ 0x3B ^ (0x37 ^ 0x21))) {
                return ((169 + 110 - 180 + 90 ^ 14 + 103 - -5 + 24) & (15 + 70 - 84 + 138 ^ 119 + 128 - 200 + 117 ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIlIIlII[1];
        }
    ...
    private static /* synthetic */ boolean b(WorldPoint worldPoint, TileObject tileObject) {
        ...
        if (L.lIllIIllIllI(tileObject.getName().contains(llIIllIll[llIlIIlII[296]]) ? 1 : 0) && L.lIllIlIIIIII(tileObject.getWorldLocation().distanceTo(worldPoint), llIlIIlII[9])) {
            ...
            "".length();
            if (null != null) {
                return ((80 + 63 - 57 + 120 ^ 69 + 98 - 127 + 116) & (14 + 81 - -142 + 17 ^ 82 + 158 - 198 + 130 ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIlIIlII[1];
        }
    ...
    private static /* synthetic */ boolean m(WorldPoint worldPoint, TileObject tileObject) {
        ...
        if (L.lIllIIllIllI(tileObject.getName().contains(llIIllIll[llIlIIlII[328]]) ? 1 : 0) && L.lIllIlIIIIII(tileObject.getWorldLocation().distanceTo(worldPoint), llIlIIlII[9])) {
            ...
            "".length();
            if ("  ".length() < 0) {
                return ((0x71 ^ 0x75 ^ (0xD ^ 1)) & (0x50 ^ 0x4F ^ (0xD3 ^ 0xC4) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIlIIlII[1];
        }
    ...
    private static void lIllIIllIlII() {
        ...
        L.llIlIIlII[16] = (0x9E ^ 0x9B) + "  ".length() - -(0x5D ^ 0x21) + (0x42 ^ 7);
        ...
        L.llIlIIlII[236] = 0xF6 ^ 0x86 ^ " ".length();
        ...
        L.llIlIIlII[289] = -"   ".length() & (0xFFFFE3FE & 0x1FFF);
    ...
    private static /* synthetic */ boolean f(WorldPoint worldPoint, TileObject tileObject) {
        ...
        if (L.lIllIIllIllI(tileObject.getName().contains(llIIllIll[llIlIIlII[303]]) ? 1 : 0) && L.lIllIlIIIIII(tileObject.getWorldLocation().distanceTo(worldPoint), llIlIIlII[9])) {
            n2 = llIlIIlII[0];
            "".length();
            if ((91 + 103 - 53 + 12 ^ 65 + 81 - 86 + 97) < "   ".length()) {
                return ((138 + 86 - 135 + 82 ^ 99 + 108 - 182 + 123) & (0x73 ^ 0x5B ^ (0x4A ^ 0x5D) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIlIIlII[1];
        }
    ...
    private static /* synthetic */ boolean g(WorldPoint worldPoint, TileObject tileObject) {
        ...
        if (L.lIllIIllIllI(tileObject.getName().contains(llIIllIll[llIlIIlII[304]]) ? 1 : 0) && L.lIllIlIIIIII(tileObject.getWorldLocation().distanceTo(worldPoint), llIlIIlII[9])) {
            ...
            if (-(1 + 65 - -28 + 34 ^ 124 + 126 - 181 + 63) > 0) {
                return ((0x54 ^ 0x12 ^ (0x45 ^ 0x3B)) & (0xA2 ^ 0xB5 ^ (0x66 ^ 0x49) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIlIIlII[1];
        }
            ...
            TileObjects.getNearest(tileObject -> {
                ...
                if (L.lIllIIllIllI(tileObject.getName().contains(llIIllIll[llIlIIlII[301]]) ? 1 : 0) && L.lIllIlIIIIII(tileObject.getWorldLocation().distanceTo(new WorldPoint(llIlIIlII[260], llIlIIlII[295], llIlIIlII[1])), llIlIIlII[9])) {
                    ...
                    if ((0x27 ^ 0x65 ^ (0xC9 ^ 0x8F)) > (0xF8 ^ 0x8F ^ (0x5C ^ 0x2F))) {
                        return ((57 + 73 - -78 + 1 ^ 5 + 66 - 44 + 121) & (0x1C ^ 0x56 ^ (0xCC ^ 0xC3) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = llIlIIlII[1];
                }
