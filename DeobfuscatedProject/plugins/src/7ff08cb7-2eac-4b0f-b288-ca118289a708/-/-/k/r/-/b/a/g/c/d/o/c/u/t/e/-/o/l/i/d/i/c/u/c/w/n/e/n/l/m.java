...
implements ab {
                    ...
                    block27: {
                                    ...
                                    block24: {
                                        block19: {
                                            ...
                                            block20: {
                                                ...
                                                n5 = lIIIIlllIl[1];
                                                "".length();
                                                if (((0xF1 ^ 0xBC ^ (0xF1 ^ 0xB0)) & (0xBC ^ 0x94 ^ (0x17 ^ 0x33) ^ -" ".length())) == 0) return n5 != 0;
                                                return ((105 + 111 - 167 + 114 ^ 60 + 104 - 149 + 176) & (5 + 25 - -61 + 65 ^ 86 + 50 - 93 + 85 ^ -" ".length())) != 0;
                                            }
                                            n5 = lIIIIlllIl[0];
                                            return n5 != 0;
                                        }
                        ...
                        if (m.lllIIlIIllll(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (m.lllIIlIIllll(Inventory.contains((int[])nArray14) ? 1 : 0)) {
                                ...
                                return ((165 + 17 - 86 + 127 ^ 15 + 56 - 54 + 116) & (0x39 ^ 0x16 ^ (0x54 ^ 0x21) ^ -" ".length())) != 0;
                            }
                        }
                    }
                    n3 = lIIIIlllIl[0];
                    ...
                    if (m.lllIIlIlIlII(Inventory.getFirst((int[])nArray17).getQuantity(), lIIIIlllIl[17])) {
                        ...
                        if (m.lllIIlIIllll(Inventory.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (m.lllIIlIIllll(Inventory.contains((int[])nArray19) ? 1 : 0)) {
                                ...
                                return ((0xDC ^ 0xAB ^ (0x62 ^ 0xB)) & (33 + 165 - 191 + 167 ^ 132 + 5 - 104 + 143 ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
    ...
    private static void lllIIlIIlllI() {
        ...
        m.lIIIIlllIl[1] = " ".length();
        m.lIIIIlllIl[2] = "  ".length();
        m.lIIIIlllIl[3] = "   ".length();
        ...
        m.lIIIIlllIl[25] = "  ".length() ^ (0x6E ^ 0x73);
        m.lIIIIlllIl[26] = 0xA1 ^ 0x9B ^ (0x55 ^ 0x68);
        m.lIIIIlllIl[27] = -" ".length();
                    ...
                    block27: {
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    block24: {
                                        block19: {
                                            ...
                                            block20: {
                                                ...
                                                return ((0xC7 ^ 0x9F ^ (0xE ^ 0x77)) & (54 + 157 - 49 + 3 ^ 46 + 0 - -12 + 74 ^ -" ".length())) != 0;
                                            }
                                            n5 = lIIIIlllIl[0];
                                            return n5 != 0;
                                        }
                                    ...
                                    return (("  ".length() ^ (0x81 ^ 0xA9)) & (0x69 ^ 0x55 ^ (3 ^ 0x15) ^ -" ".length())) != 0;
                                }
                                n4 = lIIIIlllIl[0];
                                return n4 != 0;
                            }
                        ...
                        if (m.lllIIlIIllll(Bank.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (m.lllIIlIIllll(Bank.contains((int[])nArray14) ? 1 : 0)) {
                                n3 = lIIIIlllIl[1];
                                "".length();
                                if (((0x3B ^ 6) & ~(0x74 ^ 0x49)) <= " ".length()) return n3 != 0;
                    ...
                    if (m.lllIIlIlIlII(Bank.getFirst((int[])nArray17).getQuantity(), lIIIIlllIl[17])) {
                        ...
                        if (m.lllIIlIIllll(Bank.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (m.lllIIlIIllll(Bank.contains((int[])nArray19) ? 1 : 0)) {
                                ...
                                return ((4 ^ 0x6B ^ (0x58 ^ 0x7B)) & (0x12 ^ 0x67 ^ (0x5C ^ 0x65) ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
    ...
    private static void lllIIlIIllIl() {
        ...
        m.lIIIIllIll[m.lIIIIlllIl[0]] = m.lllIIlIIIlIl("Ny0gEDQSeDANPxgr", "uXYyZ");
        m.lIIIIllIll[m.lIIIIlllIl[1]] = m.lllIIlIIIllI("iVam/cOh2fF8wahucqxY6d07YqqiAca5kJbFmE0AoOQtlVQEVu2ef5RYlGQEYSP7AUYX6wqM/dM=", "nqqWI");
        m.lIIIIllIll[m.lIIIIlllIl[2]] = m.lllIIlIIIlIl("BiYhER0pMz4WHWgzOFgYKSk8", "HGWxz");
        m.lIIIIllIll[m.lIIIIlllIl[3]] = m.lllIIlIIIlll("cF60VkI5eyyhKwG4h+XUMiMXKoXXjN43", "VXDJa");
        m.lIIIIllIll[m.lIIIIlllIl[5]] = m.lllIIlIIIlIl("MhJNESMAVwAZIhYeAxdxFgIdAD0MEh5ccRYABAQyDR4DF3ERGE0yBDw+Izc=", "ewmpQ");
        m.lIIIIllIll[m.lIIIIlllIl[17]] = m.lllIIlIIIllI("y2LDVyXeZq1Fbm5OmyCD+Q==", "rGMFp");
        m.lIIIIllIll[m.lIIIIlllIl[24]] = m.lllIIlIIIllI("10dWtaghp6qHQKfTSEvTYw==", "NHEQs");
        m.lIIIIllIll[m.lIIIIlllIl[26]] = m.lllIIlIIIllI("jgiwjPs58wDgOkuV5qj2hS0Z67gLz9yR", "Jfymp");
        m.lIIIIllIll[m.lIIIIlllIl[29]] = m.lllIIlIIIllI("A0xs3DiQw3jniM3pdV01A1DoF0pre0aD", "TQbEy");
        m.lIIIIllIll[m.lIIIIlllIl[31]] = m.lllIIlIIIllI("rdoJT/GRJdehBZrgKvZaWZNLzfX11lkU", "VtYMt");
        m.lIIIIllIll[m.lIIIIlllIl[32]] = m.lllIIlIIIlll("NIfk+avJJ2nP7k9ygtzW8EBp6cqdv17L", "oPibq");
        m.lIIIIllIll[m.lIIIIlllIl[33]] = m.lllIIlIIIllI("xLnpED2/Wc8=", "RgcrJ");
        m.lIIIIllIll[m.lIIIIlllIl[34]] = m.lllIIlIIIlll("eRL1bHyyk40=", "WWxnI");
        m.lIIIIllIll[m.lIIIIlllIl[36]] = m.lllIIlIIIlIl("NRUnKGgMFXEsJBsScT44Fw4=", "xzQMH");
        m.lIIIIllIll[m.lIIIIlllIl[40]] = m.lllIIlIIIlIl("BxcOTAImVhsDATo=", "Ivxlv");
        m.lIIIIllIll[m.lIIIIlllIl[41]] = m.lllIIlIIIlll("y/xsM/gsvbg=", "AipeY");
        m.lIIIIllIll[m.lIIIIlllIl[42]] = m.lllIIlIIIlIl("LTcE", "nXsUQ");
        m.lIIIIllIll[m.lIIIIlllIl[43]] = m.lllIIlIIIllI("bM7brmWa4kY=", "MrXdi");
        m.lIIIIllIll[m.lIIIIlllIl[45]] = m.lllIIlIIIlIl("KCQ3Cy4COS0NbQo/NBk=", "iPCjM");
        m.lIIIIllIll[m.lIIIIlllIl[46]] = m.lllIIlIIIllI("eE+5kjdDZtc=", "IJwAQ");
        m.lIIIIllIll[m.lIIIIlllIl[47]] = m.lllIIlIIIlll("g9812TYBTR00a0x4aFi5RQ==", "BzKHV");
        m.lIIIIllIll[m.lIIIIlllIl[51]] = m.lllIIlIIIlIl("HicmFBE/MGMbDSU4IBsLJQ==", "QWCzx");
        m.lIIIIllIll[m.lIIIIlllIl[52]] = m.lllIIlIIIlIl("EzAWJSQ1eAo6Mjw0", "PXyJW");
        m.lIIIIllIll[m.lIIIIlllIl[54]] = m.lllIIlIIIlIl("PCw+K3o4MSImMQ4=", "kEPOZ");
        m.lIIIIllIll[m.lIIIIlllIl[55]] = m.lllIIlIIIlll("em1EtSQUee2P+WA11cm/hA==", "eAKZB");
        m.lIIIIllIll[m.lIIIIlllIl[19]] = m.lllIIlIIIlll("qWAO6sGTRBZboqdIMhZt2g==", "yyGLd");
        m.lIIIIllIll[m.lIIIIlllIl[50]] = m.lllIIlIIIllI("Sff2qxsAMgVTbAp6FtJHjw==", "qRFNT");
        m.lIIIIllIll[m.lIIIIlllIl[56]] = m.lllIIlIIIllI("UygvquNV/I/Jl83OP7/CMw==", "EgGcC");
        m.lIIIIllIll[m.lIIIIlllIl[72]] = m.lllIIlIIIlll("dTha2NZE+OKQ0IwdWtPnJA==", "oYeZp");
        m.lIIIIllIll[m.lIIIIlllIl[74]] = m.lllIIlIIIlIl("BCQ+KG8ZK3A4KhchJCdvXg==", "vMPOO");
        m.lIIIIllIll[m.lIIIIlllIl[75]] = m.lllIIlIIIlIl("MTcj", "rXTwa");
    }
        ...
        if (m.lllIIlIllIII(Players.getLocal().getInteracting())) {
            NPC llIlllllIlIl = NPCs.getNearest(nPC -> {
                ...
                if (m.lllIIlIIllll(nPC.getName().contains(lIIIIllIll[lIIIIlllIl[75]]) ? 1 : 0) && m.lllIIlIlIIIl(nPC.isDead() ? 1 : 0)) {
                    ...
                    "".length();
                    if (-" ".length() >= " ".length()) {
                        return ((123 + 65 - 110 + 155 ^ 19 + 141 - 122 + 141) & (0xAF ^ 0x9C ^ (0xF2 ^ 0x9B) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIIIIlllIl[0];
                }
            ...
            List llIlllllIlII = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                ...
                if (m.lllIIlIllIIl(nPC.getInteracting(), Players.getLocal())) {
                    ...
                    "".length();
                    if ("   ".length() == 0) {
                        return ((7 + 70 - -16 + 92 ^ 115 + 124 - 173 + 66) & (0x33 ^ 0x36 ^ (0xBC ^ 0x84) ^ -" ".length())) != 0;
                    }
                } else {
                    bl = lIIIIlllIl[0];
                }
                                ...
                                if (m.lllIIlIlIIII(Inventory.getCount((int[])nArray2), lIIIIlllIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (m.lllIIlIlIIll(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (null != null) {
                                                return ((0x91 ^ 0x82 ^ (0x23 ^ 0x69)) & (0x8D ^ 0x96 ^ (0xE2 ^ 0xA0) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIIIlllIl[0];
                                        }
                                ...
                                if (m.lllIIlIlIIII(Inventory.getCount((int[])nArray8), lIIIIlllIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (m.lllIIlIlIIll(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (null != null) {
                                                return ((144 + 136 - 129 + 50 ^ 17 + 148 - 107 + 134) & (43 + 77 - 21 + 43 ^ 129 + 121 - 218 + 103 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIIIlllIl[0];
                                        }
                                ...
                                if (m.lllIIlIlIIII(Inventory.getCount((int[])nArray10), lIIIIlllIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (m.lllIIlIlIIll(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if ("  ".length() == 0) {
                                                return ((0x4C ^ 7 ^ (0xC2 ^ 0xAB)) & (0xBC ^ 0x9B ^ (0x28 ^ 0x2D) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIIIlllIl[0];
                                        }
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (m.lllIIlIllIlI(Skills.getExperience((Skill)Skill.MAGIC), llIllllllIII)) {
                                    ...
                                    if (-(184 + 55 - 113 + 72 ^ 132 + 174 - 290 + 178) >= 0) {
                                        return ((0x1F ^ 0xD ^ (0x2A ^ 0x1A)) & (101 + 93 - 84 + 24 ^ 128 + 43 - 30 + 23 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIIlllIl[0];
                                }
                    ...
                    if (m.lllIIlIIllll(ck ? 1 : 0)) {
                        if (m.lllIIlIlIIlI(llIllllllIlI) && m.lllIIlIlIIlI(llIllllllIIl) && m.lllIIlIlIlIl(Players.getLocal().getAnimation(), lIIIIlllIl[27])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (m.lllIIlIllIlI(Skills.getExperience((Skill)Skill.MAGIC), llIllllllIII)) {
                                    ...
                                    "".length();
                                    if (-" ".length() > "   ".length()) {
                                        return ((0x78 ^ 0x75 ^ (0x65 ^ 0x4E)) & (0x39 ^ 0x75 ^ (0x48 ^ 0x22) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIIlllIl[0];
                                }
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (m.lllIIlIlIlIl(Players.getLocal().getAnimation(), lIIIIlllIl[27])) {
                                ...
                                "".length();
                                if ("  ".length() == 0) {
                                    return ((2 ^ 0x6C ^ (0xFF ^ 0x9F)) & (0xF7 ^ 0x80 ^ (0x4F ^ 0x36) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIIIlllIl[0];
                            }
