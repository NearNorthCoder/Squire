...
public class q {
    ...
    private static void lIlllIIIllIl() {
        ...
        q.llIllIlll[123] = 0xF0 ^ 0xA4 ^ " ".length();
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (q.lIlllIIlIlIl(TileObjects.getNearest((int[])nArray))) {
                                ...
                                if ((0x3A ^ 0x40 ^ (0x49 ^ 0x37)) <= 0) {
                                    return ((0x15 ^ 0xE ^ (0x5F ^ 0x4C)) & (0x15 ^ 0x6E ^ (0x3B ^ 0x48) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIllIlll[3];
                            }
            ...
            if ((!q.lIlllIIIlllI(q.f(lIIIlIIIlIllII) ? 1 : 0) || q.lIlllIIIllll(Inventory.contains(item -> {
                ...
                if (q.lIlllIIIlllI(item.getName().contains(llIllIIll[llIllIlll[206]]) ? 1 : 0) && q.lIlllIIIllll(item.isNoted() ? 1 : 0)) {
                    ...
                    if ((0x41 ^ 0x54 ^ (0xD4 ^ 0xC4)) == 0) {
                        return ((0x68 ^ 0x44 ^ (0xC3 ^ 0xB1)) & (0x23 ^ 0x60 ^ (0x6A ^ 0x77) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = llIllIlll[3];
                }
                    ...
                    if (q.lIlllIIlIIIl(Vars.getBit((int)llIllIlll[58]), llIllIlll[15]) && q.lIlllIIlIllI(Vars.getBit((int)llIllIlll[48]))) {
                        ...
                        if (q.lIlllIIIllll(Widgets.get((int)llIllIlll[59]).isEmpty() ? 1 : 0)) {
                            ...
                            while (q.lIlllIIlIIII(lIIIlIIIlIIlIl, lIIIlIIIlIIllI.length)) {
                                ...
                                ++lIIIlIIIlIIlIl;
                                "".length();
                                if (((178 + 62 - 37 + 46 ^ 90 + 138 - 53 + 16) & (0x6B ^ 0x66 ^ (0x3B ^ 0x70) ^ -" ".length())) >= ((60 + 144 - 76 + 50 ^ 139 + 106 - 148 + 90) & (72 + 3 - 65 + 125 ^ 42 + 98 - 72 + 74 ^ -" ".length()))) continue;
                                return;
                            }
    ...
    static boolean aQ() {
        ...
        if (q.lIlllIIIlllI(Inventory.contains(item -> item.getName().contains(llIllIIll[llIllIlll[208]])) ? 1 : 0) && (!q.lIlllIIIllll(Inventory.isFull() ? 1 : 0) || q.lIlllIIlIIII(Vars.getBit((int)cY), llIllIlll[0]) && !q.lIlllIIlIIIl(Vars.getBit((int)llIllIlll[1]), llIllIlll[2])) || q.lIlllIIlIIII(Vars.getBit((int)cY), llIllIlll[0]) && q.lIlllIIlIIII(Vars.getBit((int)llIllIlll[1]), llIllIlll[2])) {
            ...
            "".length();
            if (-"  ".length() > 0) {
                return ((0x17 ^ 0x7B ^ (0xAC ^ 0x94)) & (0xE2 ^ 0x9E ^ (0x7C ^ 0x54) ^ -" ".length())) != 0;
            }
        } else {
            bl = llIllIlll[3];
        }
    ...
    private static void lIlllIIIlIIl() {
        ...
        q.llIllIIll[q.llIllIlll[3]] = q.lIlllIIIIllI("U5YR3mQRu9W4kXQV9pQNFw==", "dleNF");
        q.llIllIIll[q.llIllIlll[0]] = q.lIlllIIIIllI("ZSZs/G3cr4pKk6DXPjqeE++/PC3EVo9fTsQT5yonMSZTRUjPvjZzLXCJl+my9tWkhj9oGT6wvTU=", "sHqQX");
        q.llIllIIll[q.llIllIlll[4]] = q.lIlllIIIIlll("Ox8zLA8H", "kpAXn");
        q.llIllIIll[q.llIllIlll[5]] = q.lIlllIIIIlll("CxMWECMtUjIFPTs=", "HredO");
        q.llIllIIll[q.llIllIlll[7]] = q.lIlllIIIIlll("AAMSKA==", "WfsZy");
        q.llIllIIll[q.llIllIlll[8]] = q.lIlllIIIlIII("7oM5YerQ/2p0p51madTgGoBZ99+Wnfnd", "bzAhe");
        q.llIllIIll[q.llIllIlll[9]] = q.lIlllIIIIlll("AxczIQI9", "SxGHm");
        q.llIllIIll[q.llIllIlll[10]] = q.lIlllIIIIllI("AsSfLyqRvvo=", "OtShb");
        q.llIllIIll[q.llIllIlll[11]] = q.lIlllIIIlIII("fpeNKme42Xw=", "OLzbW");
        q.llIllIIll[q.llIllIlll[12]] = q.lIlllIIIIllI("JXQjTzuvQQE=", "YArPo");
        q.llIllIIll[q.llIllIlll[13]] = q.lIlllIIIlIII("hdLS/lulHn8=", "efwaD");
        q.llIllIIll[q.llIllIlll[14]] = q.lIlllIIIIllI("/gQZWqXz3vM=", "eMybN");
        q.llIllIIll[q.llIllIlll[17]] = q.lIlllIIIlIII("mJ1rpdEsg2flqs665Its5w==", "NnQPK");
        q.llIllIIll[q.llIllIlll[18]] = q.lIlllIIIIlll("FyYoOSY6KmIjaDAmIzYtIQ==", "SIEPH");
        q.llIllIIll[q.llIllIlll[19]] = q.lIlllIIIIllI("DUTiyPFY1DU=", "NwVOF");
        q.llIllIIll[q.llIllIlll[20]] = q.lIlllIIIIlll("CB8rPDclE2EmeS8fIDM8Pg==", "LpFUY");
        q.llIllIIll[q.llIllIlll[21]] = q.lIlllIIIlIII("YJ7955HboHE=", "RNuHe");
        q.llIllIIll[q.llIllIlll[22]] = q.lIlllIIIlIII("32uwA3titM2FnH9o+qkm3Jw6LhqhzgOV", "mCwaO");
        q.llIllIIll[q.llIllIlll[23]] = q.lIlllIIIIlll("Hwoq", "JyOKM");
        q.llIllIIll[q.llIllIlll[24]] = q.lIlllIIIIlll("HQ4CLj8wH1IsIzcOC28=", "YkrAL");
        q.llIllIIll[q.llIllIlll[27]] = q.lIlllIIIIllI("8AjzvMlJ3IHZ2BOlCCBwI5xsQUJzT84m", "mfIpT");
        q.llIllIIll[q.llIllIlll[29]] = q.lIlllIIIIllI("Fv+gKjlww4ty6yQv4xLi/g==", "ruyLH");
        q.llIllIIll[q.llIllIlll[30]] = q.lIlllIIIIllI("eKS1sS1pxUnLTBbqIZttAA==", "VOvyv");
        q.llIllIIll[q.llIllIlll[31]] = q.lIlllIIIIlll("MSkOCyEK", "bLoyB");
        q.llIllIIll[q.llIllIlll[32]] = q.lIlllIIIIllI("vKpF5DEuWPw=", "kFnPy");
        q.llIllIIll[q.llIllIlll[33]] = q.lIlllIIIIllI("N2VD+mjlDNA=", "rCkil");
        q.llIllIIll[q.llIllIlll[34]] = q.lIlllIIIlIII("kK3S8hv601U=", "GECwy");
        q.llIllIIll[q.llIllIlll[35]] = q.lIlllIIIlIII("ZUrw0Qdycuvk4aZzYBKFhQ==", "CmmXf");
        q.llIllIIll[q.llIllIlll[36]] = q.lIlllIIIlIII("4aLpSiMrnlM2Rb/CZojt+j1vg2ihlzOD", "MRwpH");
        q.llIllIIll[q.llIllIlll[37]] = q.lIlllIIIIlll("HBEQOzk8BhFpJTwTHCY7", "SguIU");
        q.llIllIIll[q.llIllIlll[15]] = q.lIlllIIIlIII("86iBDNPnICw=", "ajdty");
        q.llIllIIll[q.llIllIlll[40]] = q.lIlllIIIlIII("FbbRa1cSVJ74gjPqQlExMA==", "dfEBL");
        q.llIllIIll[q.llIllIlll[41]] = q.lIlllIIIlIII("jNwge3+926yEB356se8m8Ti/5V85zyRo", "uzHWc");
        q.llIllIIll[q.llIllIlll[42]] = q.lIlllIIIIllI("S+B+4JYJFVU=", "sGfzv");
        q.llIllIIll[q.llIllIlll[43]] = q.lIlllIIIIlll("JT8MHisIM0YEZQI/BxEgEw==", "aPawE");
        q.llIllIIll[q.llIllIlll[44]] = q.lIlllIIIIllI("fpIzeo2FnNw=", "lSRso");
        q.llIllIIll[q.llIllIlll[45]] = q.lIlllIIIIllI("fproZdYy896zbAZVb91ViYy7LwbwSgMM", "Uezrj");
        q.llIllIIll[q.llIllIlll[46]] = q.lIlllIIIIlll("ISss", "tXIMz");
        q.llIllIIll[q.llIllIlll[47]] = q.lIlllIIIIllI("4Wc4dVJqUBIHnNXztbz+Dw==", "ZRinp");
        q.llIllIIll[q.llIllIlll[49]] = q.lIlllIIIIlll("OhgOLDwQBAxtLAsPCiA=", "yjkMH");
        q.llIllIIll[q.llIllIlll[50]] = q.lIlllIIIlIII("Gfjx5676eSh8NwSialQwzQ==", "qzYRf");
        q.llIllIIll[q.llIllIlll[51]] = q.lIlllIIIIlll("NyQIJDYaKEUCNhokCw==", "sKeMX");
        q.llIllIIll[q.llIllIlll[52]] = q.lIlllIIIlIII("plhIk5ZZ6Pg=", "FavtA");
        q.llIllIIll[q.llIllIlll[53]] = q.lIlllIIIIlll("ICoZAgMNJlQkAw0qGg==", "dEtkm");
        q.llIllIIll[q.llIllIlll[54]] = q.lIlllIIIIllI("zIRut8iQLzc=", "CgLiK");
        q.llIllIIll[q.llIllIlll[55]] = q.lIlllIIIlIII("1zBDlaVaRcs=", "BZrjn");
        q.llIllIIll[q.llIllIlll[56]] = q.lIlllIIIIlll("CRIKGzwnDgoOMSYCWUJzIgYLCw==", "JgyoS");
        q.llIllIIll[q.llIllIlll[57]] = q.lIlllIIIlIII("5coVPgLPG/U=", "aeRdP");
        q.llIllIIll[q.llIllIlll[60]] = q.lIlllIIIlIII("V0rvKH/sh8U=", "RMWLd");
        q.llIllIIll[q.llIllIlll[61]] = q.lIlllIIIlIII("XXWd6LFSB5Y=", "OqJJh");
        q.llIllIIll[q.llIllIlll[62]] = q.lIlllIIIlIII("mi1Zmm6gTe5CT4SPNWp2e9bHMY/cEMgJ", "uWgNf");
        q.llIllIIll[q.llIllIlll[65]] = q.lIlllIIIIlll("HCQpHhU4IGQ9ACs8IRw=", "JEDnl");
        q.llIllIIll[q.llIllIlll[66]] = q.lIlllIIIIlll("PAI9FD4NTSwSPxg=", "hmZsR");
        q.llIllIIll[q.llIllIlll[67]] = q.lIlllIIIIllI("HGoyQogLyNY=", "guIjq");
        q.llIllIIll[q.llIllIlll[68]] = q.lIlllIIIIllI("ECzDGpwpGxIibhpAjJ9DLQ==", "OiYYL");
        q.llIllIIll[q.llIllIlll[69]] = q.lIlllIIIlIII("WGpsTOMrC/Vfu7zP/py/biSUK+s93rx0", "oSsUf");
        q.llIllIIll[q.llIllIlll[70]] = q.lIlllIIIIllI("t5CR3H57P6o=", "uRCda");
        q.llIllIIll[q.llIllIlll[71]] = q.lIlllIIIIllI("s7DmQbB99TPCnK5duJ8cOA==", "jYUuC");
        q.llIllIIll[q.llIllIlll[72]] = q.lIlllIIIIlll("BRcVJTw0WBAtJT8bFzA=", "QxrBP");
        q.llIllIIll[q.llIllIlll[73]] = q.lIlllIIIlIII("fJLvLfO+/QU=", "NlWSW");
        q.llIllIIll[q.llIllIlll[74]] = q.lIlllIIIIlll("CwEoFgJsJzsdAw==", "LsIxf");
        q.llIllIIll[q.llIllIlll[75]] = q.lIlllIIIIllI("riIg9UHgR7YX0nQeaoUgZRu7VlrOT9AC", "wToLY");
        q.llIllIIll[q.llIllIlll[76]] = q.lIlllIIIIllI("b05D/1gcRlU=", "braxy");
        q.llIllIIll[q.llIllIlll[77]] = q.lIlllIIIIllI("MnKnUaTMoIJtKXswRjZGx+I7UDWqEUsP", "VoBDV");
        q.llIllIIll[q.llIllIlll[78]] = q.lIlllIIIIllI("6x5Ni0Qhf6ViOUGs78LF6Ap32xY8mA6l", "dfayD");
        q.llIllIIll[q.llIllIlll[79]] = q.lIlllIIIlIII("5AZRcvIL9dA=", "zwZDO");
        q.llIllIIll[q.llIllIlll[80]] = q.lIlllIIIlIII("CQxYFzUD1Qh13bGDqnA4kg==", "shdeh");
        q.llIllIIll[q.llIllIlll[81]] = q.lIlllIIIIlll("ISIYBjoMLlUgOgwiGw==", "eMuoT");
        q.llIllIIll[q.llIllIlll[82]] = q.lIlllIIIlIII("csjLipNzcsX3ApOC5Nv2cQ==", "TmOVD");
        q.llIllIIll[q.llIllIlll[83]] = q.lIlllIIIIlll("PRg5HxZNBDsIAwg=", "mwNzd");
        q.llIllIIll[q.llIllIlll[84]] = q.lIlllIIIIlll("AxUiPUogG247AzAQIjM=", "TtNVj");
        q.llIllIIll[q.llIllIlll[85]] = q.lIlllIIIIllI("/lb11C9WtLcfmkoGE9nK2A==", "tJmDJ");
        q.llIllIIll[q.llIllIlll[86]] = q.lIlllIIIIlll("MzMGLB4V", "rUmEp");
        q.llIllIIll[q.llIllIlll[87]] = q.lIlllIIIIllI("TGmZwRiuGHU=", "Zpbzc");
        q.llIllIIll[q.llIllIlll[88]] = q.lIlllIIIIlll("IBclNCw=", "deLZG");
        q.llIllIIll[q.llIllIlll[89]] = q.lIlllIIIIllI("0HkVxQ/NgttDuT8c9Pm0+A==", "UPjKy");
        q.llIllIIll[q.llIllIlll[90]] = q.lIlllIIIIllI("I1+uUDB+mP+G07ALUTNL1A==", "xwlly");
        q.llIllIIll[q.llIllIlll[91]] = q.lIlllIIIlIII("fEEBLoEWRrVJ0gnPKZAw0w==", "EdBrj");
        q.llIllIIll[q.llIllIlll[93]] = q.lIlllIIIIlll("EgIOCQI=", "Vpggi");
        q.llIllIIll[q.llIllIlll[94]] = q.lIlllIIIIlll("DQgKKw==", "cgdNJ");
        q.llIllIIll[q.llIllIlll[95]] = q.lIlllIIIIllI("pWzTTFO22M4=", "yNekC");
        q.llIllIIll[q.llIllIlll[110]] = q.lIlllIIIIllI("mGdAZcFpzjU=", "mDOLI");
        q.llIllIIll[q.llIllIlll[118]] = q.lIlllIIIIllI("AbP5iFNo8AxW5uDuN2dG+WNDJYnrab+o", "CfdSg");
        q.llIllIIll[q.llIllIlll[119]] = q.lIlllIIIIlll("OgoFPisbBQx6JRMFADMpFQ==", "rkkZG");
        q.llIllIIll[q.llIllIlll[121]] = q.lIlllIIIlIII("ahruggd0Wvs=", "jxJpP");
        q.llIllIIll[q.llIllIlll[123]] = q.lIlllIIIlIII("OnVjzMWNNSw=", "DCnhx");
        q.llIllIIll[q.llIllIlll[124]] = q.lIlllIIIlIII("8bymdF8ZbNS5Y8yg/RGw3eUb5io4gtWNDymC2uNEm9bb5dzllnjFVl7as6nZ5mIB+Vd0V1zJxko=", "BQfZz");
        q.llIllIIll[q.llIllIlll[125]] = q.lIlllIIIlIII("pXl9gbd45qtbI1FSWi1ojg==", "yclgR");
        q.llIllIIll[q.llIllIlll[127]] = q.lIlllIIIlIII("84EthLhLIyA=", "ixHho");
        q.llIllIIll[q.llIllIlll[128]] = q.lIlllIIIIlll("Jh1tLjwUWCAmPQIRIyhuAw0jKm4QCj8gOQJUbTw5GAwuJycfH207IVE6GBYHPz8=", "qxMON");
        q.llIllIIll[q.llIllIlll[129]] = q.lIlllIIIIlll("BgklIgY=", "klIGc");
        q.llIllIIll[q.llIllIlll[130]] = q.lIlllIIIIllI("9AOaITDJzQL7kfgN0Wd4jw==", "BoMxY");
        q.llIllIIll[q.llIllIlll[131]] = q.lIlllIIIIlll("GS4JDAc=", "kOgkb");
        q.llIllIIll[q.llIllIlll[132]] = q.lIlllIIIlIII("kagI4QMWO0C6jP54/T6Ndw==", "NsjZV");
        q.llIllIIll[q.llIllIlll[133]] = q.lIlllIIIIlll("KC0pAiA=", "ZLGeE");
        q.llIllIIll[q.llIllIlll[134]] = q.lIlllIIIlIII("0oPaKlEs2Jc=", "jsVXw");
        q.llIllIIll[q.llIllIlll[135]] = q.lIlllIIIlIII("mktB8wu05Nc=", "ZTwRy");
        q.llIllIIll[q.llIllIlll[136]] = q.lIlllIIIIlll("GycGFRA=", "iFhru");
        q.llIllIIll[q.llIllIlll[137]] = q.lIlllIIIIlll("OBIAAyMiAgM=", "KgpsO");
        q.llIllIIll[q.llIllIlll[138]] = q.lIlllIIIIllI("ZnVJEzTPLZTj9AEskc89MaTE0ldAQFrBUEGfyxpgNEALm4BMGN+rDISvEwCxEcT4", "tiPRj");
        q.llIllIIll[q.llIllIlll[139]] = q.lIlllIIIIlll("BRMkIjM=", "hvHGV");
        q.llIllIIll[q.llIllIlll[140]] = q.lIlllIIIlIII("vZ/Soa/0M2c=", "TrSEH");
        q.llIllIIll[q.llIllIlll[142]] = q.lIlllIIIIllI("Kzbs0F5WzEENsK8cvGjtow==", "vTdXH");
        q.llIllIIll[q.llIllIlll[143]] = q.lIlllIIIIllI("jJ7EMOvkuiiBtaVwO6/iIYGGeTZIF2g5", "XmLlR");
        q.llIllIIll[q.llIllIlll[145]] = q.lIlllIIIIllI("AxxsKe8ogbw=", "oLXah");
        q.llIllIIll[q.llIllIlll[154]] = q.lIlllIIIIllI("LKhuzf088jU=", "vYLYB");
        q.llIllIIll[q.llIllIlll[155]] = q.lIlllIIIlIII("aqdnKlwFGs4=", "ujJzG");
        q.llIllIIll[q.llIllIlll[158]] = q.lIlllIIIlIII("wYeHGmI2n2I=", "bYJTA");
        q.llIllIIll[q.llIllIlll[159]] = q.lIlllIIIIlll("Lw0wHg4OFHEeFwgRcQ8ZAB8=", "kzQlx");
        q.llIllIIll[q.llIllIlll[160]] = q.lIlllIIIIllI("I1CE7wQDEjg=", "IcijD");
        q.llIllIIll[q.llIllIlll[161]] = q.lIlllIIIlIII("esKe2KCoqkdcDxSyUxA+Tg==", "fwaWX");
        q.llIllIIll[q.llIllIlll[167]] = q.lIlllIIIIlll("CzUjJgw=", "fPOCi");
        q.llIllIIll[q.llIllIlll[184]] = q.lIlllIIIlIII("WXrot48HfQY=", "VOPCc");
        q.llIllIIll[q.llIllIlll[195]] = q.lIlllIIIIlll("BAoeDT41HAQNIg==", "EhmbL");
        q.llIllIIll[q.llIllIlll[196]] = q.lIlllIIIIlll("OREvPRYZBi4=", "vgJOz");
        q.llIllIIll[q.llIllIlll[197]] = q.lIlllIIIIlll("LTIpCjocJDMKJg==", "lPZeH");
        q.llIllIIll[q.llIllIlll[198]] = q.lIlllIIIIlll("EBA8HyEaAg==", "teYsH");
        q.llIllIIll[q.llIllIlll[199]] = q.lIlllIIIIllI("OSycpHMQR3Y=", "ApKTx");
        q.llIllIIll[q.llIllIlll[200]] = q.lIlllIIIlIII("1nAehbIto/s=", "LpgBl");
        q.llIllIIll[q.llIllIlll[201]] = q.lIlllIIIIlll("IDopPxMC", "pHHFv");
        q.llIllIIll[q.llIllIlll[162]] = q.lIlllIIIIlll("fz8bEB02PV0=", "WQtbp");
        q.llIllIIll[q.llIllIlll[202]] = q.lIlllIIIIlll("YBIjKC1h", "HzBZI");
        q.llIllIIll[q.llIllIlll[203]] = q.lIlllIIIlIII("WXh/Wqd5xv4SXw0XZKyUXA==", "bQVmo");
        q.llIllIIll[q.llIllIlll[204]] = q.lIlllIIIIllI("GHWMH4i76iJNhvzd/ucJdw==", "XELbf");
        q.llIllIIll[q.llIllIlll[205]] = q.lIlllIIIIlll("KDkSCC4K", "xKsqK");
        q.llIllIIll[q.llIllIlll[206]] = q.lIlllIIIlIII("dNW7rK05aOU=", "ZCHQo");
        q.llIllIIll[q.llIllIlll[208]] = q.lIlllIIIIlll("DRMCMT0tBAM=", "BegCQ");
    }
    ...
    private static void g(String string) {
        block52: {
            ...
            while (q.lIlllIIIllll(h.bw ? 1 : 0) && q.lIlllIIIllll(AccBuilderGWD.d ? 1 : 0)) {
                ...
                "".length();
                "".length();
                if (((0 ^ 0x19 ^ (0xFE ^ 0xBC)) & (201 + 184 - 174 + 6 ^ 109 + 61 - 87 + 47 ^ -" ".length())) != (0x53 ^ 0x57 ^ (0x54 ^ 0x42) & ~(0xAE ^ 0xB8))) continue;
                return;
            }
    ...
    private static boolean f(String string) {
        ...
        block38: {
                                                                                        ...
                                                                                        if (q.lIlllIIIlllI(Equipment.contains((int[])nArray7) ? 1 : 0)) {
                                                                                            ...
                                                                                            if (q.lIlllIIIlllI(Equipment.contains((int[])nArray8) ? 1 : 0)) {
                                                                                                ...
                                                                                                if (q.lIlllIIIlllI(Equipment.contains((int[])nArray9) ? 1 : 0)) {
                                                                                                    n5 = llIllIlll[0];
                                                                                                    "".length();
                                                                                                    if (((0x1C ^ 0x4E) & ~(0x7B ^ 0x29)) != " ".length()) return n5 != 0;
                                                                        ...
                                                                        if (q.lIlllIIIlllI(Equipment.contains((int[])nArray15) ? 1 : 0)) {
                                                                            ...
                                                                            if (q.lIlllIIIlllI(Equipment.contains((int[])nArray16) ? 1 : 0)) {
                                                                                ...
                                                                                if (q.lIlllIIIlllI(Equipment.contains((int[])nArray17) ? 1 : 0)) {
                                                                                    ...
                                                                                    return ((0x6B ^ 7 ^ (0x5A ^ 5)) & (0xE5 ^ 0x93 ^ (0x71 ^ 0x34) ^ -" ".length())) != 0;
                                                                                }
                                                                            }
                                                                        }
                                                                    }
            ...
            return ((0xF ^ 0x1A ^ (0xAF ^ 0xB6)) & (0x93 ^ 0x8A ^ (0x4D ^ 0x58) ^ -" ".length())) != 0;
        }
        n2 = llIllIlll[3];
        return n2 != 0;
    }
            ...
            if (q.lIlllIIIlllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                ...
                if (q.lIlllIIIlllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
                    ...
                    if (q.lIlllIIIlllI(Bank.contains((int[])nArray4) ? 1 : 0) && q.lIlllIIIlllI(Bank.contains(item -> item.getName().contains(llIllIIll[llIllIlll[198]])) ? 1 : 0)) {
                        n2 = llIllIlll[0];
                        "".length();
                        if ((0x17 ^ 0x13) != "  ".length()) return n2 != 0;
