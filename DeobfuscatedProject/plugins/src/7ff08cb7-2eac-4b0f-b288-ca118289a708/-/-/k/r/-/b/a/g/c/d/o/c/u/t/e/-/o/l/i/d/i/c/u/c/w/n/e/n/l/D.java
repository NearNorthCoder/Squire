...
implements ab {
    ...
    private static void lIllllIIIlIl() {
        ...
        D.llIllllll[0] = " ".length();
        D.llIllllll[1] = (0x93 ^ 0xB2 ^ (0x79 ^ 0x46)) & (0x70 ^ 0x45 ^ (0x8F ^ 0xA4) ^ -" ".length());
        D.llIllllll[2] = 0x36 ^ 0x41 ^ (0x7D ^ 0x15);
        D.llIllllll[3] = 31 + 134 - -9 + 4 ^ 73 + 121 - 150 + 106;
        D.llIllllll[4] = "  ".length();
        D.llIllllll[5] = 0x32 ^ 0x1F;
        D.llIllllll[6] = "   ".length();
                        ...
                        if (D.lIllllIIlIlI(Skills.getLevel((Skill)Skill.MAGIC), llIllllll[41]) && D.lIllllIIlIII(Skills.getLevel((Skill)Skill.MAGIC), llIllllll[34])) {
                            Magic.cast((Spell)SpellBook.Standard.WIND_BOLT, (NPC)NPCs.getNearest(nPC -> {
                                ...
                                if (D.lIllllIIIlll(nPC.getName().equalsIgnoreCase(llIllllII[llIllllll[108]]) ? 1 : 0) && D.lIllllIIlIIl(nPC.isDead() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (-"   ".length() >= 0) {
                                        return ((168 + 161 - 314 + 158 ^ 145 + 92 - 96 + 25) & (158 + 19 - 10 + 3 ^ 143 + 99 - 190 + 109 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    n2 = llIllllll[1];
                                }
                        ...
                        if (D.lIllllIIlIlI(Skills.getLevel((Skill)Skill.MAGIC), llIllllll[34]) && D.lIllllIIlIII(Skills.getLevel((Skill)Skill.MAGIC), llIllllll[56])) {
                            Magic.cast((Spell)SpellBook.Standard.WATER_BOLT, (NPC)NPCs.getNearest(nPC -> {
                                ...
                                if (D.lIllllIIIlll(nPC.getName().equalsIgnoreCase(llIllllII[llIllllll[107]]) ? 1 : 0) && D.lIllllIIlIIl(nPC.isDead() ? 1 : 0)) {
                                    n2 = llIllllll[0];
                                    "".length();
                                    if (((0xE4 ^ 0x8D ^ (0x73 ^ 0x2B)) & (0x7F ^ 0x55 ^ (0xB6 ^ 0xAD) ^ -" ".length())) > " ".length()) {
                                        return ((0xB2 ^ 0xC0 ^ (0x3C ^ 0xC)) & (99 + 108 - 6 + 51 ^ 25 + 50 - -11 + 104 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    n2 = llIllllll[1];
                                }
                            ...
                            Magic.cast((Spell)SpellBook.Standard.EARTH_BOLT, (NPC)NPCs.getNearest(nPC -> {
                                ...
                                if (D.lIllllIIIlll(nPC.getName().equalsIgnoreCase(llIllllII[llIllllll[106]]) ? 1 : 0) && D.lIllllIIlIIl(nPC.isDead() ? 1 : 0)) {
                                    ...
                                    if (("  ".length() & ("  ".length() ^ -" ".length())) != 0) {
                                        return ((6 + 62 - 55 + 151 ^ 46 + 114 - 33 + 27) & (0x76 ^ 0x59 ^ (0x94 ^ 0x85) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    n2 = llIllllll[1];
                                }
    ...
    public int af() {
        ...
        if (((0x5D ^ 0x33 ^ (0xC0 ^ 0x80)) & (0x9D ^ 0x93 ^ (0x7E ^ 0x5E) ^ -" ".length())) >= "  ".length()) {
            return (0xB9 ^ 0xB1 ^ (0x59 ^ 0x66)) & (121 + 37 - 13 + 12 ^ 169 + 70 - 170 + 101 ^ -" ".length());
        }
    ...
    private static boolean an() {
        ...
        while (D.lIllllIIlIII(lIIIIIlIlIIllI, ((void)lIIIIIlIlIIlll).length)) {
            ...
            return ((94 + 115 - 112 + 95 ^ 3 + 29 - -29 + 71) & (0x44 ^ 7 ^ (0x17 ^ 0x10) ^ -" ".length())) != 0;
        }
        return llIllllll[0];
    }
    ...
    private static void lIllllIIIlII() {
        ...
        D.llIllllII[D.llIllllll[1]] = D.lIlllIlllIII("KicoOwcEKyJyFhk3LzwTTCcyNxkfYmYhAwU6JTodAilmMBUPJWYmG0w/MzcHGA==", "lNFRt");
        D.llIllllII[D.llIllllll[0]] = D.lIlllIlllIII("Ylc1IREpAx89Fw==", "OwvSp");
        D.llIllllII[D.llIllllll[4]] = D.lIlllIlllIIl("6Qs5rTqcdw9XSThPUDjc8Q==", "cnxHw");
        D.llIllllII[D.llIllllll[6]] = D.lIlllIlllIIl("G86XQTDQE+2e1YoOHNJfAA==", "cgbCY");
        D.llIllllII[D.llIllllll[7]] = D.lIlllIlllIIl("YBeEZhSdcEg=", "thuMF");
        D.llIllllII[D.llIllllll[8]] = D.lIlllIlllIIl("8fj6YmJcFF8iv12nMRZSsg==", "nLDIn");
        D.llIllllII[D.llIllllll[10]] = D.lIlllIlllIIl("uUoAjZFgigE+y8zgCzxjIhQ5gd1d88w5", "aOFWi");
        D.llIllllII[D.llIllllll[19]] = D.lIlllIlllIII("HiF6FSYsZDcdJzotNBN0ODE/ByBpNy8EJCUtPwd4aTctHSAqLDMaM2kwNVQWHB0TOhM=", "IDZtT");
        D.llIllllII[D.llIllllll[21]] = D.lIlllIlllIlI("IahmqztsYdAAInXcrMaRnZTna1nR6k+VxXVPjryXvPbGkF0hwFvaQxz73pC3BPPgxxNmksXHT/8=", "MHNBj");
        D.llIllllII[D.llIllllll[23]] = D.lIlllIlllIIl("yLdQcKixnI4=", "XFElk");
        D.llIllllII[D.llIllllll[11]] = D.lIlllIlllIlI("iKiy6byWrns=", "Hlkyu");
        D.llIllllII[D.llIllllll[31]] = D.lIlllIlllIII("HhsDEQk=", "Msbcb");
        D.llIllllII[D.llIllllll[29]] = D.lIlllIlllIII("Jwon", "bkSlc");
        D.llIllllII[D.llIllllll[35]] = D.lIlllIlllIII("JhoFCjs=", "bhldP");
        D.llIllllII[D.llIllllll[36]] = D.lIlllIlllIII("DDgacz4teR8nKzAt", "BYlSJ");
        D.llIllllII[D.llIllllll[37]] = D.lIlllIlllIII("BwAAHhF0BRQJFiA=", "Ttale");
        D.llIllllII[D.llIllllll[38]] = D.lIlllIlllIIl("ExOXnSD0ofk=", "byMbJ");
        D.llIllllII[D.llIllllll[41]] = D.lIlllIlllIII("HC4+ZQY9bzw3Fzc=", "ROHEr");
        D.llIllllII[D.llIllllll[42]] = D.lIlllIlllIlI("5mDpVpSfdQgjzySaen6ucA==", "PEdPm");
        D.llIllllII[D.llIllllll[43]] = D.lIlllIlllIlI("6ek1RyyuYeM=", "TJAlB");
        D.llIllllII[D.llIllllll[45]] = D.lIlllIlllIIl("aNHSu9mHC8E=", "tTulN");
        D.llIllllII[D.llIllllll[46]] = D.lIlllIlllIIl("wG0MCAg7I0E=", "CLNPR");
        D.llIllllII[D.llIllllll[47]] = D.lIlllIlllIIl("R5aIKNSwfHM=", "Uydfl");
        D.llIllllII[D.llIllllll[34]] = D.lIlllIlllIII("BAAJFw0jUgcBEg==", "Frfyw");
        D.llIllllII[D.llIllllll[49]] = D.lIlllIlllIII("FzAsNG0yOiY3", "SBCDM");
        D.llIllllII[D.llIllllll[50]] = D.lIlllIlllIII("MzAlJCgUYisyNw==", "qBJJR");
        D.llIllllII[D.llIllllll[51]] = D.lIlllIlllIIl("uyKBkgFsCvQ=", "LfJti");
        D.llIllllII[D.llIllllll[53]] = D.lIlllIlllIIl("5sayd9oiMdo60ESiVhYJUg==", "fdcYF");
        D.llIllllII[D.llIllllll[55]] = D.lIlllIlllIlI("DIAh5ltL7GxgiqvC3FHy1w==", "VHWjH");
        D.llIllllII[D.llIllllll[56]] = D.lIlllIlllIlI("XFcPqDxKEjxm/L9s/offlg==", "lVrFC");
        D.llIllllII[D.llIllllll[48]] = D.lIlllIlllIlI("TjqNcpWwIkhbiF532So2KQ==", "jYBWm");
        D.llIllllII[D.llIllllll[2]] = D.lIlllIlllIII("KhESKiNJCwYrNQ==", "iysEP");
        D.llIllllII[D.llIllllll[57]] = D.lIlllIlllIII("FxkDKBR0AxcpAg==", "TqbGg");
        D.llIllllII[D.llIllllll[59]] = D.lIlllIlllIII("DR4kHigqTCoINw==", "OlKpR");
        D.llIllllII[D.llIllllll[60]] = D.lIlllIlllIIl("rVSU2iFZ3Gvu1FlzOnr4Xg==", "gwvMn");
        D.llIllllII[D.llIllllll[58]] = D.lIlllIlllIIl("hK4uzh/xWV/BKeNzIusnzp2PZFc1aZ08tk4wyIYKm7M=", "eiOty");
        D.llIllllII[D.llIllllll[3]] = D.lIlllIlllIII("ATI0HCw6dzQZLit7dSdvOjYjC288OCEGJjwwdRogcj88Cip8", "RWUnO");
        D.llIllllII[D.llIllllll[61]] = D.lIlllIlllIlI("1A/wkJotoNI=", "hrThq");
        D.llIllllII[D.llIllllll[62]] = D.lIlllIlllIIl("ob/7MHhiwsZN574dqmmVvg==", "gQTvh");
        D.llIllllII[D.llIllllll[63]] = D.lIlllIlllIlI("/mwf1sgGp0I=", "dgyBF");
        D.llIllllII[D.llIllllll[64]] = D.lIlllIlllIII("ATgMGRRvMAoDGA==", "BTetv");
        D.llIllllII[D.llIllllll[65]] = D.lIlllIlllIIl("lY9IwqQR1jac9kcrUg1xJw==", "IOhws");
        D.llIllllII[D.llIllllll[66]] = D.lIlllIlllIII("HTE2Hx00M2IKDD8=", "ZTBkt");
        D.llIllllII[D.llIllllll[67]] = D.lIlllIlllIIl("osxosH5cDThnOcFZltPgIA==", "uUtLr");
        D.llIllllII[D.llIllllll[68]] = D.lIlllIlllIlI("q3s6j62cD+Jj+3halRyZiw==", "uzgsW");
        D.llIllllII[D.llIllllll[5]] = D.lIlllIlllIIl("T1ZBQa9CCNz1XfotG4nl8g==", "DDWUW");
        D.llIllllII[D.llIllllll[69]] = D.lIlllIlllIIl("cb/PIZrJCIUd7ksDIzKZrA==", "mVAhP");
        D.llIllllII[D.llIllllll[70]] = D.lIlllIlllIlI("98XDnHLckkZ/GXO3zljqtA==", "SmxuF");
        D.llIllllII[D.llIllllll[71]] = D.lIlllIlllIII("BgkSPw==", "RhyZh");
        D.llIllllII[D.llIllllll[72]] = D.lIlllIlllIIl("GYuSWZmmsOvgEp0Jnezahg==", "YNnqF");
        D.llIllllII[D.llIllllll[33]] = D.lIlllIlllIIl("yRnza+2FFdQOLuF9iobOew==", "OmSBC");
        D.llIllllII[D.llIllllll[73]] = D.lIlllIlllIII("OyA4KGEcJyA2", "xHWXA");
        D.llIllllII[D.llIllllll[75]] = D.lIlllIlllIIl("5RlyVu1oy5c=", "XmGKI");
        D.llIllllII[D.llIllllll[76]] = D.lIlllIlllIIl("s3F3i55/ZQ0=", "Mrxgx");
        D.llIllllII[D.llIllllll[77]] = D.lIlllIlllIIl("iAi0/IJvJG7agHLJqTd74g==", "zOygS");
        D.llIllllII[D.llIllllll[78]] = D.lIlllIlllIIl("bGGPyp6f2m0=", "jAGvM");
        D.llIllllII[D.llIllllll[79]] = D.lIlllIlllIlI("vgO9oZMDK0g=", "uYxOv");
        D.llIllllII[D.llIllllll[80]] = D.lIlllIlllIlI("FEexckofwns=", "nvQGS");
        D.llIllllII[D.llIllllll[81]] = D.lIlllIlllIlI("/pHF/LOpO4A=", "EALAC");
        D.llIllllII[D.llIllllll[82]] = D.lIlllIlllIII("Izw/KQA=", "hRVOe");
        D.llIllllII[D.llIllllll[83]] = D.lIlllIlllIlI("lMOGXHJAgZa+GwHhuZZWgw==", "pPxkZ");
        D.llIllllII[D.llIllllll[84]] = D.lIlllIlllIIl("XsKFytxjY4le3lnqLxSrcw==", "edySY");
        D.llIllllII[D.llIllllll[85]] = D.lIlllIlllIIl("MZVc4KHIbnAsbSjGsGLChw==", "iJoPY");
        D.llIllllII[D.llIllllll[86]] = D.lIlllIlllIIl("ke7V2LZaTSgARpXCmHE/8w==", "XNJTZ");
        D.llIllllII[D.llIllllll[87]] = D.lIlllIlllIII("MCUHFD4=", "gLbxZ");
        D.llIllllII[D.llIllllll[88]] = D.lIlllIlllIlI("Z97sindDFqUnhMx6nO6O+A==", "jyeVf");
        D.llIllllII[D.llIllllll[89]] = D.lIlllIlllIlI("IRheXk+LIl04A6GEr33Dvw==", "BsEtW");
        D.llIllllII[D.llIllllll[90]] = D.lIlllIlllIlI("IdW5/LhoCHI=", "dBWuf");
        D.llIllllII[D.llIllllll[91]] = D.lIlllIlllIIl("GRCdSJCo0jY=", "uDYOH");
        D.llIllllII[D.llIllllll[105]] = D.lIlllIlllIlI("QRjomQYVEf/hHY/CARoj3wO/J9BqpP26", "ftyYX");
        D.llIllllII[D.llIllllll[52]] = D.lIlllIlllIlI("GkMB56xcnaw=", "yQAZq");
        D.llIllllII[D.llIllllll[106]] = D.lIlllIlllIII("FSE6CD8q", "ONWjV");
        D.llIllllII[D.llIllllll[107]] = D.lIlllIlllIlI("4UWd6oOSLpg=", "zdNNF");
        D.llIllllII[D.llIllllll[108]] = D.lIlllIlllIlI("lEbJN6FLTLE=", "laBTX");
        D.llIllllII[D.llIllllll[109]] = D.lIlllIlllIlI("ATiE0DgBKxk=", "oeMkO");
        D.llIllllII[D.llIllllll[128]] = D.lIlllIlllIlI("Zjfp9S1RwOYHCC1VWih/Uenptk/2EjZmiff+/S7Lyu+HLdaNfErO1MUAZFkemH39", "WFotH");
        D.llIllllII[D.llIllllll[129]] = D.lIlllIlllIIl("x3wRY/w7eq9eAT+wlS0LdJm3Ns0Hvzmn45V4hj+w6tlObOTiw+z4sWOR7Shprg0USsTwuqoN1p8=", "Vttfu");
        D.llIllllII[D.llIllllll[130]] = D.lIlllIlllIIl("kGgKQwyXpdUYxjyeMP/E51bqYntkl7RVD7+YHJCJ0e1KzOb8Ds55XA==", "ZCBai");
        D.llIllllII[D.llIllllll[131]] = D.lIlllIlllIII("BgV1GzZoEHUaKysHMBxiJwwiUiM9BnULLTpDJR4jIQ08HCVvFzpSJCYNMVIrO1w=", "OcUrB");
        D.llIllllII[D.llIllllll[132]] = D.lIlllIlllIIl("1mEP8aTu3vkTcRDwinky+oWtGZhlcpUkQtrvsvmVhMvFYQEZjwb0/w==", "gYowO");
        D.llIllllII[D.llIllllll[133]] = D.lIlllIlllIII("JgYZeCEBDB14LBpJCDExTgAAeCROGgY9IU4dBj0rUQ==", "ninXE");
        D.llIllllII[D.llIllllll[134]] = D.lIlllIlllIIl("YO1XYcUuAjuRPVXA3nOiVJoP29oGx0BX/tezvXw8tK40HdJBmIF25HXsOdd0k6YU", "UyHqj");
        D.llIllllII[D.llIllllll[135]] = D.lIlllIlllIIl("0hncOOetb+Y=", "cGXPJ");
        D.llIllllII[D.llIllllll[136]] = D.lIlllIlllIIl("baiuqBfT0YI=", "uisjH");
    }
