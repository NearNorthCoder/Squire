...
extends HashMap<Integer, String> {
    ...
    private static void lIlllIllllll() {
        llIllllIl = new int[7];
        R.llIllllIl[0] = (14 + 15 - -42 + 182 ^ 59 + 108 - 58 + 54) & (190 + 47 - 133 + 112 ^ 48 + 2 - -68 + 16 ^ -" ".length());
        R.llIllllIl[1] = " ".length();
        R.llIllllIl[2] = "  ".length();
        R.llIllllIl[3] = "   ".length();
    ...
    private static void lIlllIlllllI() {
        ...
        R.llIlllIll[R.llIllllIl[0]] = R.lIlllIlllIll("ATQrBhEv", "BUYjt");
        R.llIlllIll[R.llIllllIl[1]] = R.lIlllIllllII("VIdes9nmaPw=", "IJxtF");
        R.llIlllIll[R.llIllllIl[2]] = R.lIlllIllllIl("uvQ7QVXBVthllR55OpGpfg==", "xYnuI");
        R.llIlllIll[R.llIllllIl[3]] = R.lIlllIlllIll("GSw7DAooMA==", "IYIob");
        R.llIlllIll[R.llIllllIl[4]] = R.lIlllIlllIll("HzgXJAA8Ng==", "XYuMn");
    }
