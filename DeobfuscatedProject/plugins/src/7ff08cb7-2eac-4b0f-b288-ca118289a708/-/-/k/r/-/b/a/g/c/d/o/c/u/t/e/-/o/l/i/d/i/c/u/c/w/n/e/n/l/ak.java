...
implements ab {
    ...
    private static void llIIlllIllll() {
        ...
        ak.llllIIlII[ak.llllIIlIl[0]] = ak.llIIlllIllII("tG2U+Na5m7P8BIfGOAzhQw==", "WknPP");
        ak.llllIIlII[ak.llllIIlIl[1]] = ak.llIIlllIllIl("AiICDiosLghHOzEyBQk+ZCIYAjQ3Z0wULi0/Dw8wKixMBTgnIEwTNmQmDQAwJ2sYFTgtJQUJPg==", "DKlgY");
        ak.llllIIlII[ak.llllIIlIl[3]] = ak.llIIlllIlllI("pUZY8Jnr2fgZnMCA7Fa8/aipKetLdKr2", "tiEyH");
        ak.llllIIlII[ak.llllIIlIl[4]] = ak.llIIlllIlllI("ATaYB9EHeWGV01WH6kd+Co2njLHKyvWz", "ESODy");
        ak.llllIIlII[ak.llllIIlIl[7]] = ak.llIIlllIlllI("dbpU4ausq6Zbl1UNrN0eU/7zUv+cOz+RxptncIt/dlIqqC72pvzF6UBgA+zrvRei", "UUOCp");
        ak.llllIIlII[ak.llllIIlIl[6]] = ak.llIIlllIllII("qU/FAHl+OY8=", "pYQNW");
        ak.llllIIlII[ak.llllIIlIl[30]] = ak.llIIlllIllIl("Oh83HyAN", "hzZpV");
        ak.llllIIlII[ak.llllIIlIl[33]] = ak.llIIlllIlllI("5sq0fKxGs5U=", "Fqeuw");
        ak.llllIIlII[ak.llllIIlIl[35]] = ak.llIIlllIllII("dtpbE+nCo4A=", "ardoS");
        ak.llllIIlII[ak.llllIIlIl[36]] = ak.llIIlllIllIl("BjsGOCw=", "QRcTH");
        ak.llllIIlII[ak.llllIIlIl[24]] = ak.llIIlllIllII("d/iP3boRkdo=", "sEcFO");
        ak.llllIIlII[ak.llllIIlIl[38]] = ak.llIIlllIllIl("OyILGgc=", "lKnvc");
        ak.llllIIlII[ak.llllIIlIl[40]] = ak.llIIlllIllII("2XQs8QG8TXI=", "HoIqG");
        ak.llllIIlII[ak.llllIIlIl[41]] = ak.llIIlllIllII("S/RM2NECJB0=", "LNSId");
        ak.llllIIlII[ak.llllIIlIl[42]] = ak.llIIlllIllII("Bkqk+5KXkuI=", "ibrJy");
        ak.llllIIlII[ak.llllIIlIl[43]] = ak.llIIlllIllII("BCQrYyG88Is=", "tSYtm");
        ak.llllIIlII[ak.llllIIlIl[45]] = ak.llIIlllIllII("HU3zwADGXNw=", "Rkugc");
        ak.llllIIlII[ak.llllIIlIl[46]] = ak.llIIlllIllII("2bMHrkJ5B4M=", "IPGof");
        ak.llllIIlII[ak.llllIIlIl[47]] = ak.llIIlllIllII("H7iPLQOu9GM=", "hHjml");
        ak.llllIIlII[ak.llllIIlIl[48]] = ak.llIIlllIllIl("Aj8GHC0=", "UVcpI");
        ak.llllIIlII[ak.llllIIlIl[34]] = ak.llIIlllIllIl("AjceCB9wIgIOEz4/Hgg=", "PVpoz");
        ak.llllIIlII[ak.llllIIlIl[63]] = ak.llIIlllIllII("B8epJzWoX02cm8z3jRntbOCRCIXGQVQK", "ayxeR");
        ak.llllIIlII[ak.llllIIlIl[64]] = ak.llIIlllIlllI("jCI6Gj/ju/A=", "EqWhs");
    }
    ...
    public int af() {
        ...
        if (((0x3D ^ 0xB ^ (0xFE ^ 0x97)) & (3 + 134 - -32 + 36 ^ 44 + 70 - 88 + 120 ^ -" ".length())) >= (0x47 ^ 0x77 ^ (0x96 ^ 0xA2))) {
            return (95 + 81 - 157 + 120 ^ 51 + 146 - 100 + 82) & (0xB6 ^ 0xAC ^ (0xA5 ^ 0x87) ^ -" ".length());
        }
        return llllIIlIl[57];
    }
                                                ...
                                                block32: {
                                                    ...
                                                    block34: {
                                                        ...
                                                        if (ak.llIIllllIIIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                            n3 = llllIIlIl[1];
                                                            "".length();
                                                            if (((111 + 49 - 147 + 135 ^ 89 + 81 - 113 + 138) & (0x44 ^ 0x13 ^ (0x45 ^ 0x24) & ~(0xD8 ^ 0xB9) ^ -" ".length())) == 0) return n3 != 0;
                                                            return ((0xEE ^ 0xB3 ^ (0x48 ^ 0x18)) & (0x8F ^ 0xB8 ^ (0xBD ^ 0x87) ^ -" ".length())) != 0;
                                                        }
                                                    }
                                                    n3 = llllIIlIl[0];
                                                    return n3 != 0;
    ...
    private static void llIIllllIIII() {
        ...
        ak.llllIIlIl[0] = (26 + 17 - 42 + 190 ^ 136 + 95 - 215 + 137) & (0x1E ^ 0x2F ^ (0xB5 ^ 0xA2) ^ -" ".length());
        ak.llllIIlIl[1] = " ".length();
        ak.llllIIlIl[2] = 0x74 ^ 0x46;
        ak.llllIIlIl[3] = "  ".length();
        ak.llllIIlIl[4] = "   ".length();
        ...
        ak.llllIIlIl[24] = "  ".length() ^ (0x1B ^ 0x13);
        ...
        block20: {
                                ...
                                if (ak.llIIllllIIIl(Bank.contains((int[])nArray10) ? 1 : 0)) {
                                    ...
                                    if (ak.llIIllllIIIl(Bank.contains((int[])nArray11) ? 1 : 0)) {
                                        ...
                                        if (ak.llIIllllIIIl(Bank.contains((int[])nArray12) ? 1 : 0)) {
                                            ...
                                            return ((0x42 ^ 0x2E ^ (0x1D ^ 0x13)) & (0x58 ^ 0x37 ^ (0x21 ^ 0x2C) ^ -" ".length())) != 0;
                                        }
                                    }
                                }
                            }
            ...
            if (ak.llIIllllIIIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (ak.llIIllllIIIl(Bank.contains((int[])nArray22) ? 1 : 0)) {
                    ...
                    return ((0x77 ^ 1 ^ (0xF5 ^ 0xAC)) & (80 + 83 - 89 + 54 ^ 88 + 130 - 163 + 120 ^ -" ".length())) != 0;
                }
            }
        }
        n2 = llllIIlIl[0];
                ...
                if (ak.llIIllllIllI(Skills.getLevel((Skill)Skill.RANGED), llllIIlIl[27]) && ak.llIIllllIIlI(Skills.getLevel((Skill)Skill.RANGED), llllIIlIl[2])) {
                    llIIIIIllIIII = TileItems.getNearest(tileItem -> {
                        ...
                        if (ak.llIIlllllIII(tileItem.getId(), llllIIlIl[16]) && ak.llIIllllIllI(tileItem.getQuantity(), llllIIlIl[43])) {
                            ...
                            "".length();
                            if (null != null) {
                                return ((120 + 44 - 22 + 56 ^ 45 + 119 - 24 + 9) & (146 + 5 - 105 + 105 ^ 156 + 32 - 40 + 48 ^ -" ".length())) != 0;
                            }
                        } else {
                            n2 = llllIIlIl[0];
                        }
