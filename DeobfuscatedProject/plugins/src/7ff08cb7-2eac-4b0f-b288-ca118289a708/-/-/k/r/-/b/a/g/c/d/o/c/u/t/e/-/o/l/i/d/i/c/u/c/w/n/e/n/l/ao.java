...
implements ab {
                ...
                if (ao.llIIIIIlllll(Bank.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (ao.llIIIIlIIIll(Inventory.getCount((String[])stringArray))) {
                            bl = lllIIlIIl[1];
                            "".length();
                            if ("   ".length() <= ((0xC ^ 0x3D ^ (0x54 ^ 0x40) & ~(0xBD ^ 0xA9)) & (12 + 20 - 18 + 150 ^ 121 + 14 - 23 + 37 ^ -" ".length()))) {
                                return ((0x63 ^ 0x59 ^ (0x36 ^ 0x58)) & (0xFF ^ 0xB3 ^ (0xD ^ 0x15) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lllIIlIIl[0];
                        }
    ...
    private static void llIIIIIlllIl() {
        ...
        ao.lllIIIlll[ao.lllIIlIIl[0]] = ao.llIIIIIlIlll("DgUaEzorUAoOMSED", "LpczT");
        ao.lllIIIlll[ao.lllIIlIIl[1]] = ao.llIIIIIllIII("RekIypSNHOSKDsHVY62sXuwI8bwy/0uzAqxln9ROsA3LsKgOLXrfgnMjcDklKYX6MjVAfXRY3jU=", "xBKQG");
        ao.lllIIIlll[ao.lllIIlIIl[2]] = ao.llIIIIIllIIl("ijC5gFiU/3gIqeZ/mkg77Tr0lvU8cCSM", "svice");
        ao.lllIIIlll[ao.lllIIlIIl[3]] = ao.llIIIIIllIII("E8DJFbiP1gBOTOnoEGKbLQ==", "bPGDL");
        ao.lllIIIlll[ao.lllIIlIIl[5]] = ao.llIIIIIllIII("CL6uSX9qyK+9PsIekID8UIU5NPBRHkyv", "vHbJq");
        ao.lllIIIlll[ao.lllIIlIIl[7]] = ao.llIIIIIlIlll("EBksBRhjEiQaHCoaKkkaJgA=", "CtMit");
        ao.lllIIIlll[ao.lllIIlIIl[9]] = ao.llIIIIIllIIl("X5BvV0vV7F33oad86wRv8g==", "brUua");
        ao.lllIIIlll[ao.lllIIlIIl[11]] = ao.llIIIIIllIII("Jhq661+7MHbeO4Tca14Y7O2OvvRy8fNT", "HPFhK");
        ao.lllIIIlll[ao.lllIIlIIl[13]] = ao.llIIIIIllIIl("tpFkIjoz0G0=", "Mcknt");
        ao.lllIIIlll[ao.lllIIlIIl[15]] = ao.llIIIIIllIII("3Lqp8eXA0+NVGZSSGPwOxQ==", "IiSNG");
        ao.lllIIIlll[ao.lllIIlIIl[16]] = ao.llIIIIIllIII("Fji0bR5KPqX1ZF7RRdFZskCBBbR06hkntt/KE1URoE+dTIbrohTVZtIrLRHo5coD", "MwLon");
        ao.lllIIIlll[ao.lllIIlIIl[17]] = ao.llIIIIIllIII("Nb3CvWv7OKODP/NIBLCr0org+6bNseBa", "BrKeU");
        ao.lllIIIlll[ao.lllIIlIIl[18]] = ao.llIIIIIlIlll("MgIAPwoaDFMlDBA=", "tksWc");
        ao.lllIIIlll[ao.lllIIlIIl[19]] = ao.llIIIIIllIII("v92SItJ6XvSe5S2C/9luzA==", "tgVPW");
        ao.lllIIIlll[ao.lllIIlIIl[20]] = ao.llIIIIIllIII("rUmUzUpWHPw=", "SfYab");
        ao.lllIIIlll[ao.lllIIlIIl[22]] = ao.llIIIIIllIIl("JkEd0ob7GQ2K1yCo+a5/jQ==", "SDnGY");
        ao.lllIIIlll[ao.lllIIlIIl[25]] = ao.llIIIIIllIIl("ksSz8T8ZpCaGwYzZEQ9mXw==", "OCxhh");
        ao.lllIIIlll[ao.lllIIlIIl[26]] = ao.llIIIIIllIII("kEM7mnQMQzBTk5DyqJJ1Rg==", "zzRDo");
        ao.lllIIIlll[ao.lllIIlIIl[28]] = ao.llIIIIIlIlll("LBICZBINUwcpBw4fVCIPERtUNxYNBw==", "bstDf");
        ao.lllIIIlll[ao.lllIIlIIl[29]] = ao.llIIIIIllIII("ONOj1eYMth8=", "QZbMz");
        ao.lllIIIlll[ao.lllIIlIIl[27]] = ao.llIIIIIllIII("HUuIkXZHwTg=", "FFNiu");
        ao.lllIIIlll[ao.lllIIlIIl[32]] = ao.llIIIIIllIII("890Ia9duu7xlwjBXlNCjTVVu6VI8CanO", "YEZGc");
        ao.lllIIIlll[ao.lllIIlIIl[33]] = ao.llIIIIIllIII("LLCaJDILrAY=", "goEDq");
        ao.lllIIIlll[ao.lllIIlIIl[34]] = ao.llIIIIIllIII("FR6T+tMFTEY=", "sGZLk");
        ao.lllIIIlll[ao.lllIIlIIl[35]] = ao.llIIIIIlIlll("LC0ScAwNbAI8AUIqDSMQQj8UPww=", "bLdPx");
        ao.lllIIIlll[ao.lllIIlIIl[36]] = ao.llIIIIIllIIl("O1nKoKMmzNI=", "bKnHv");
        ao.lllIIIlll[ao.lllIIlIIl[37]] = ao.llIIIIIllIIl("+mTRrIqZrf4=", "SbzoH");
        ao.lllIIIlll[ao.lllIIlIIl[38]] = ao.llIIIIIllIIl("oC7lTH5KRoyPsDYrbMy43Q==", "udOMh");
        ao.lllIIIlll[ao.lllIIlIIl[39]] = ao.llIIIIIllIIl("GHo8FzhLKtqFNSMisCOvxQ==", "HnSrZ");
        ao.lllIIIlll[ao.lllIIlIIl[40]] = ao.llIIIIIlIlll("KQUZJz0BC0o8JAAY", "oljOT");
        ao.lllIIIlll[ao.lllIIlIIl[41]] = ao.llIIIIIllIIl("NMg8GmRNhNE=", "SiOPI");
        ao.lllIIIlll[ao.lllIIlIIl[42]] = ao.llIIIIIllIIl("1/1cDlQ6GxU8oG7GwpdvPQ==", "EISvP");
        ao.lllIIIlll[ao.lllIIlIIl[43]] = ao.llIIIIIllIIl("n1NsSqyyrilif69s97FYvg4pZMzyIUCKDSzIWHUAmLk1sF0BMyW4xPFBYfnsPwgCimZ2WOcSkv0=", "UvJum");
        ao.lllIIIlll[ao.lllIIlIIl[44]] = ao.llIIIIIllIIl("TVMOpDrIBzmngp4w+mlMUAAjloE14YAj", "xmgRb");
        ao.lllIIIlll[ao.lllIIlIIl[45]] = ao.llIIIIIllIIl("6LKPNgE+5248HPdUxa26Ug==", "aYJgu");
        ao.lllIIIlll[ao.lllIIlIIl[46]] = ao.llIIIIIlIlll("LwUXECQOCh5UKgYKEh0mAA==", "gdytH");
        ao.lllIIIlll[ao.lllIIlIIl[47]] = ao.llIIIIIlIlll("AQIEISJyCQw+JjsBAm0gNxs=", "RoeMN");
        ao.lllIIIlll[ao.lllIIlIIl[48]] = ao.llIIIIIllIIl("eOHhw3E5/Xfbp2XpKYxPBjFZPaQHfe9GnrNwKnTvKv6Bt/bb2SEuV3epDr8hEc1Y", "GDPHa");
        ao.lllIIIlll[ao.lllIIlIIl[49]] = ao.llIIIIIlIlll("NCIAKj9HKQg1Ow4hBmY9Ajs=", "gOaFS");
        ao.lllIIIlll[ao.lllIIlIIl[53]] = ao.llIIIIIllIII("kBEflMLW/Kz9kyGe+G1EKQ==", "dRDkX");
        ao.lllIIIlll[ao.lllIIlIIl[54]] = ao.llIIIIIllIIl("NPAFdzb0LfbOpFhMx8vMjWS3jkGoZ1b8", "bTLLK");
        ao.lllIIIlll[ao.lllIIlIIl[55]] = ao.llIIIIIlIlll("GzIWIQ==", "LWwSp");
        ao.lllIIIlll[ao.lllIIlIIl[56]] = ao.llIIIIIlIlll("NSsRPSIdJQ==", "sBbUK");
        ao.lllIIIlll[ao.lllIIlIIl[57]] = ao.llIIIIIlIlll("Ih8QKx5RFBg0GhgcFmccFAY=", "qrqGr");
        ao.lllIIIlll[ao.lllIIlIIl[58]] = ao.llIIIIIllIIl("DtvYNIvJElYyDwPUXGYhZKf6FS3z7NSK", "OqDvM");
        ao.lllIIIlll[ao.lllIIlIIl[59]] = ao.llIIIIIlIlll("MiwkPxAaInclFhA=", "tEWWy");
        ao.lllIIIlll[ao.lllIIlIIl[60]] = ao.llIIIIIlIlll("IDwJYRcPIxgoHwFwAi4V", "fPpAq");
        ao.lllIIIlll[ao.lllIIlIIl[61]] = ao.llIIIIIlIlll("FQojEyM2HQ==", "SoBgK");
        ao.lllIIIlll[ao.lllIIlIIl[62]] = ao.llIIIIIllIII("l5aoFv0lp4dGoM/MRnkOcg==", "yIebP");
        ao.lllIIIlll[ao.lllIIlIIl[73]] = ao.llIIIIIlIlll("FiICBw4+LA==", "PKqog");
        ao.lllIIIlll[ao.lllIIlIIl[75]] = ao.llIIIIIlIlll("FyIgFmsKLW4GLgQnOhlrTQ==", "eKNqK");
        ao.lllIIIlll[ao.lllIIlIIl[76]] = ao.llIIIIIllIII("k0dL3NL4flSCKstRwyZxL3I13S5OFclF", "brAwS");
        ao.lllIIIlll[ao.lllIIlIIl[78]] = ao.llIIIIIllIIl("hbqAbEWayglGKNfmA41WfQ==", "DaNpy");
        ao.lllIIIlll[ao.lllIIlIIl[79]] = ao.llIIIIIllIIl("IGMtHwZurNU=", "zmOya");
        ao.lllIIIlll[ao.lllIIlIIl[80]] = ao.llIIIIIlIlll("KSQIWD4GOxkRNghoAxc8", "oHqxX");
        ao.lllIIIlll[ao.lllIIlIIl[81]] = ao.llIIIIIllIIl("TA9sDNQDOj1hT3Ipsfhtrg==", "WWcxX");
        ao.lllIIIlll[ao.lllIIlIIl[82]] = ao.llIIIIIllIIl("wbZ3jFdF6Q7HsFrDEQkFiubGi4aAlLHY", "kEwXm");
    }

    private static void llIIIIIllllI() {
        lllIIlIIl = new int[101];
        ao.lllIIlIIl[0] = (0xB4 ^ 0x88) & ~(0x2B ^ 0x17);
        ao.lllIIlIIl[1] = " ".length();
        ao.lllIIlIIl[2] = "  ".length();
        ao.lllIIlIIl[3] = "   ".length();
    ...
    public boolean ah() {
        ...
        if (ao.llIIIIlIIlII(Skills.getLevel((Skill)Skill.FISHING), lllIIlIIl[74])) {
            bl = lllIIlIIl[1];
            "".length();
            if (((83 + 198 - 272 + 243 ^ 73 + 33 - 95 + 177) & (37 + 26 - -41 + 105 ^ 87 + 102 - 124 + 80 ^ -" ".length())) != ((0x90 ^ 0x81 ^ (0x17 ^ 0x58)) & (115 + 45 - 115 + 110 ^ 117 + 22 - 138 + 196 ^ -" ".length()))) {
                return ((0x4E ^ 0x5E ^ (0xC ^ 0x31)) & (0x22 ^ 0x4C ^ (0xED ^ 0xAE) ^ -" ".length())) != 0;
            }
        } else {
            bl = lllIIlIIl[0];
        }
                ...
                if (ao.llIIIIIlllll(Bank.contains((int[])nArray3) ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (ao.llIIIIlIIIll(Inventory.getCount((String[])stringArray))) {
                            ...
                            "".length();
                            if (null != null) {
                                return ((0x51 ^ 0x1C ^ (8 ^ 0x51)) & (40 + 82 - 7 + 56 ^ 76 + 103 - 143 + 155 ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lllIIlIIl[0];
                        }
