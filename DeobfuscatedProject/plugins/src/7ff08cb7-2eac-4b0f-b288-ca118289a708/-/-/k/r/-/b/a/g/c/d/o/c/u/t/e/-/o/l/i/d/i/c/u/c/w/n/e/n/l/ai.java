...
implements ab {
    ...
    private static void lIlIlIIIlllI() {
        ...
        ai.llIIlIIIl[0] = " ".length() & (" ".length() ^ -" ".length());
        ai.llIIlIIIl[1] = " ".length();
        ai.llIIlIIIl[2] = 0x43 ^ 0x7F;
        ai.llIIlIIIl[3] = 0x46 ^ 0xD;
        ai.llIIlIIIl[4] = 0x6C ^ 0x2A;
        ai.llIIlIIIl[5] = "  ".length();
        ai.llIIlIIIl[6] = "   ".length();
    ...
    public static boolean aN() {
        ...
        block28: {
                                        ...
                                        block27: {
                                            block17: {
                                                ...
                                                block19: {
                                                    ...
                                                    n3 = llIIlIIIl[1];
                                                    "".length();
                                                    if (" ".length() != ((0x34 ^ 0x3B) & ~(0x39 ^ 0x36))) return n3 != 0;
                                                    return ((0x9D ^ 0x90) & ~(0x52 ^ 0x5F)) != 0;
                                                }
                                                n3 = llIIlIIIl[0];
                                                return n3 != 0;
                                            }
            ...
            return ((0x9B ^ 0x86 ^ (0xD2 ^ 0x9A)) & (84 + 214 - 151 + 71 ^ 65 + 4 - 40 + 114 ^ -" ".length())) != 0;
        }
        n2 = llIIlIIIl[0];
        return n2 != 0;
    }
    ...
    public boolean ah() {
        ...
        if (ai.lIlIlIIlIlIl(Skills.getLevel((Skill)Skill.ATTACK), llIIlIIIl[2]) && ai.lIlIlIIlIlIl(Skills.getLevel((Skill)Skill.STRENGTH), llIIlIIIl[4]) && ai.lIlIlIIlIlIl(Skills.getLevel((Skill)Skill.DEFENCE), llIIlIIIl[3])) {
            ...
            if ((0xCB ^ 0xB7 ^ (0xF6 ^ 0x8E)) != (0x2C ^ 0x45 ^ (0xE ^ 0x63))) {
                return ((98 + 86 - 108 + 53 ^ 186 + 53 - 108 + 68) & (0x33 ^ 0x3B ^ (0xF4 ^ 0xBA) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIIlIIIl[0];
        }
    ...
    public static boolean aM() {
        ...
        block32: {
                                        ...
                                        block22: {
                                            ...
                                            block24: {
                                                ...
                                                if (ai.lIlIlIIlIIlI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                    n3 = llIIlIIIl[1];
                                                    "".length();
                                                    if (-" ".length() < (57 + 23 - 30 + 144 ^ 56 + 60 - 42 + 124)) return n3 != 0;
                                                    return (("  ".length() ^ (0x6B ^ 0x2B)) & (123 + 21 - -60 + 50 ^ 127 + 151 - 114 + 24 ^ -" ".length())) != 0;
                                                }
                                            }
                                            n3 = llIIlIIIl[0];
                                            return n3 != 0;
            ...
            if (ai.lIlIlIIlIIlI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                n2 = llIIlIIIl[1];
                "".length();
                if (((0x8D ^ 0xBB) & ~(0x7E ^ 0x48)) != "  ".length()) return n2 != 0;
                return ((2 ^ 0x1F) & ~(0x89 ^ 0x94)) != 0;
            }
        }
        n2 = llIIlIIIl[0];
        return n2 != 0;
    ...
    private static void lIlIlIIIllIl() {
        ...
        ai.llIIIllll[ai.llIIlIIIl[0]] = ai.lIlIlIIIIIII("NyAuLiISdT4zKRgm", "uUWGL");
        ai.llIIIllll[ai.llIIlIIIl[1]] = ai.lIlIlIIIIIII("IA0ZEQIOARNYExMdHhYWRg0DHRwVSFcLBg8QFBAYCANXGhAFD1cMHkYJEhQUA0QDChAPCh4WFg==", "fdwxq");
        ai.llIIIllll[ai.llIIlIIIl[5]] = ai.lIlIlIIIIIII("OxkVEDQUDAoXNFUMDFkxFBYI", "uxcyS");
        ai.llIIIllll[ai.llIIlIIIl[6]] = ai.lIlIlIIIIIIl("CqkElqeXV2YKqTRGEl1mZ/+cSqsn1F+Z", "QIUFt");
        ai.llIIIllll[ai.llIIlIIIl[8]] = ai.lIlIlIIIIIII("EBRpLRUiUSQlFDQYJytHNAQ5PAsuFDpgRzQGIDgELxgnK0czHmkOMh44Bws=", "GqILg");
        ai.llIIIllll[ai.llIIlIIIl[12]] = ai.lIlIlIIIIIII("ATAuGFQ7ISgbHTwjMw==", "HBAvt");
        ai.llIIIllll[ai.llIIlIIIl[16]] = ai.lIlIlIIIIIlI("zR90zSEFA31Qk121lAkqGA==", "Aoevw");
        ai.llIIIllll[ai.llIIlIIIl[17]] = ai.lIlIlIIIIIIl("I62ueAuFwDRsP3+VoGVDrpmdd3imN3Eh", "jwKKq");
        ai.llIIIllll[ai.llIIlIIIl[21]] = ai.lIlIlIIIIIII("DjUw", "KTDwS");
        ai.llIIIllll[ai.llIIlIIIl[24]] = ai.lIlIlIIIIIII("JgsgCUYcGiYKDxsYPQ==", "oyOgf");
        ai.llIIIllll[ai.llIIlIIIl[23]] = ai.lIlIlIIIIIlI("sggA0zNzv3FEIjqOJP7zLg==", "saHsg");
        ai.llIIIllll[ai.llIIlIIIl[25]] = ai.lIlIlIIIIIIl("tp6JAdZ1vzetuDbjZfTz0cAIe+yWIPCJ", "TZlbS");
        ai.llIIIllll[ai.llIIlIIIl[26]] = ai.lIlIlIIIIIIl("LDJi2q/qIcLXITT0Kf000axeS/fCwdqL", "FoIGS");
        ai.llIIIllll[ai.llIIlIIIl[27]] = ai.lIlIlIIIIIII("MgwqHDAXAmYTNg4W", "yeFpY");
        ai.llIIIllll[ai.llIIlIIIl[28]] = ai.lIlIlIIIIIII("ABgY", "CwoDN");
        ai.llIIIllll[ai.llIIlIIIl[15]] = ai.lIlIlIIIIIlI("8TpP1Ccq2oc=", "iZJne");
        ai.llIIIllll[ai.llIIlIIIl[29]] = ai.lIlIlIIIIIII("DiM2CCwk", "OWBiO");
        ai.llIIIllll[ai.llIIlIIIl[30]] = ai.lIlIlIIIIIlI("hnkFSwYdxKk=", "yawBR");
        ai.llIIIllll[ai.llIIlIIIl[31]] = ai.lIlIlIIIIIlI("vGB6DLXwJEGMPNvjYXdotA==", "cIGpP");
        ai.llIIIllll[ai.llIIlIIIl[32]] = ai.lIlIlIIIIIlI("5E0gOgno11A=", "AaMTp");
        ai.llIIIllll[ai.llIIlIIIl[42]] = ai.lIlIlIIIIIII("Kwg3IGQRGTEjLRYbKg==", "bzXND");
        ai.llIIIllll[ai.llIIlIIIl[43]] = ai.lIlIlIIIIIIl("EYqRSQ/LuBfL44WJ7Ri8oQ==", "oqnqZ");
        ai.llIIIllll[ai.llIIlIIIl[44]] = ai.lIlIlIIIIIII("IxMvJRI=", "tzJIv");
        ai.llIIIllll[ai.llIIlIIIl[45]] = ai.lIlIlIIIIIII("ITU8HChSMjoQKRs1OAs=", "rAYyD");
        ai.llIIIllll[ai.llIIlIIIl[46]] = ai.lIlIlIIIIIIl("tg06Poy7auJ8/xUcv+U6Bg==", "MgjPv");
        ai.llIIIllll[ai.llIIlIIIl[47]] = ai.lIlIlIIIIIlI("BaGfoMleCGE=", "mBlnl");
        ai.llIIIllll[ai.llIIlIIIl[49]] = ai.lIlIlIIIIIIl("wCudbr+SOcpfRdF88pxVvKXRimSAZ9Hn", "biFpb");
        ai.llIIIllll[ai.llIIlIIIl[50]] = ai.lIlIlIIIIIIl("dMUOecoS2Dny1DQkLXj+hpx8bJG6scKS", "Ljase");
        ai.llIIIllll[ai.llIIlIIIl[51]] = ai.lIlIlIIIIIlI("ZBCqqNHK2DA=", "QIYRn");
        ai.llIIIllll[ai.llIIlIIIl[52]] = ai.lIlIlIIIIIII("JiUyLT4=", "qLWAZ");
        ai.llIIIllll[ai.llIIlIIIl[48]] = ai.lIlIlIIIIIIl("jrgEE4NbiSE=", "DlWdZ");
        ai.llIIIllll[ai.llIIlIIIl[54]] = ai.lIlIlIIIIIlI("i6ychJvav+M=", "PQPeh");
        ai.llIIIllll[ai.llIIlIIIl[56]] = ai.lIlIlIIIIIlI("oHqjNUN3SLg=", "DenxA");
        ai.llIIIllll[ai.llIIlIIIl[58]] = ai.lIlIlIIIIIII("MA8VEQ==", "gjtcQ");
        ai.llIIIllll[ai.llIIlIIIl[60]] = ai.lIlIlIIIIIII("HAstFw==", "KnLeT");
        ai.llIIIllll[ai.llIIlIIIl[62]] = ai.lIlIlIIIIIlI("PRxVX2TktB0=", "IDvIa");
        ai.llIIIllll[ai.llIIlIIIl[64]] = ai.lIlIlIIIIIII("OhMAFQ==", "mvagz");
        ai.llIIIllll[ai.llIIlIIIl[86]] = ai.lIlIlIIIIIII("dFdYRFltUEJTJCcLEhY=", "Bgwsi");
        ai.llIIIllll[ai.llIIlIIIl[87]] = ai.lIlIlIIIIIIl("t5gxGfF4P8M=", "ppQOa");
    }
