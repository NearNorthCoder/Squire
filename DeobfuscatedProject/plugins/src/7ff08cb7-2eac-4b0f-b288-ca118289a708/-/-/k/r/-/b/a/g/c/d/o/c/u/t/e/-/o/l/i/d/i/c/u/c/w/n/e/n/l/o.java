...
implements ab {
    ...
    private static void lIllllIlIlll() {
        ...
        o.lllIIIIlI[10] = "   ".length();
        o.lllIIIIlI[11] = 7 ^ 0x42 ^ "   ".length();
        ...
        if (o.lIllllIllIIl(list.isEmpty() ? 1 : 0) && o.lIlllllIIIII(list.size(), lllIIIIlI[0])) {
            ...
            while (o.lIllllIllIII(lIIIIIIIIlIllI, lIIIIIIIIlIlll.size())) {
                ...
                if (o.lIllllIllIll(((Player)lIIIIIIIIlIlll.get(lIIIIIIIIlIllI)).equals(Players.getLocal()) ? 1 : 0)) {
                    "".length();
                    if (((0x1D ^ 4 ^ "   ".length()) & (54 + 151 - 137 + 87 ^ 26 + 114 - 117 + 106 ^ -" ".length())) != 0) {
                        return ((0xA0 ^ 0x9A ^ (0x27 ^ 0x47)) & (49 + 138 - 54 + 22 ^ 116 + 160 - 168 + 85 ^ -" ".length())) != 0;
                    }
    ...
    private static String lIllllIlIIll(String llllllllllIlI, String lllllllllIlII) {
        ...
        while (o.lIllllIllIII(llllllllIlllI, llllllllIllll)) {
            ...
            ++llllllllIlllI;
            "".length();
            if (((38 + 144 - 129 + 168 ^ 137 + 100 - 220 + 124) & (0x3B ^ 0x4A ^ (0x77 ^ 0x56) ^ -" ".length())) < "   ".length()) continue;
            return null;
        }
    ...
    private static void lIllllIlIllI() {
        ...
        o.lllIIIIIl[o.lllIIIIlI[1]] = o.lIllllIlIIll("ORAhJxJrFDUlFCRVJisLLgc=", "KuRBf");
        o.lllIIIIIl[o.lllIIIIlI[0]] = o.lIllllIlIlII("fcWbeIklTZb1El8p2cUgCKKgPxUSKmxH", "aqhvt");
        o.lllIIIIIl[o.lllIIIIlI[3]] = o.lIllllIlIlIl("yXpJRAL94hxbQo+Kp6s9V7JugD3pNQVN", "Xailt");
        o.lllIIIIIl[o.lllIIIIlI[10]] = o.lIllllIlIlIl("1aMdH//ZefB3/VuPwyfRvFoNeJcRC6dL", "EkspQ");
        o.lllIIIIIl[o.lllIIIIlI[12]] = o.lIllllIlIlIl("+4Kjf5YfOpU=", "DbRCr");
        o.lllIIIIIl[o.lllIIIIlI[13]] = o.lIllllIlIlIl("75gZfXkaTdMfhuzSl74bPg==", "DoDmg");
        o.lllIIIIIl[o.lllIIIIlI[14]] = o.lIllllIlIIll("JTQ4MRsIdSAwGB51NT0WGQ==", "mUVUw");
        o.lllIIIIIl[o.lllIIIIlI[15]] = o.lIllllIlIlIl("ZibUJkLIQmI=", "WISQj");
        o.lllIIIIIl[o.lllIIIIlI[16]] = o.lIllllIlIlIl("5nU/A+VxPvHGsoeiAaKdMHRPqxCvPpof", "ekmPG");
        o.lllIIIIIl[o.lllIIIIlI[17]] = o.lIllllIlIlII("1DGF1JquW07QfEDSAWJ2597jWssZssvg", "sDgWh");
        o.lllIIIIIl[o.lllIIIIlI[8]] = o.lIllllIlIIll("Eio8AnESLD0VMDAsIh8kMQ==", "BENvQ");
        o.lllIIIIIl[o.lllIIIIlI[18]] = o.lIllllIlIIll("HzQIBQ==", "IQgvT");
        o.lllIIIIIl[o.lllIIIIlI[19]] = o.lIllllIlIIll("DCUT", "IDgts");
        o.lllIIIIIl[o.lllIIIIlI[20]] = o.lIllllIlIIll("Cz4gMTQteCI2ejkoJCw=", "JXKXZ");
        o.lllIIIIIl[o.lllIIIIlI[21]] = o.lIllllIlIlII("v/s32ZPTOkeGi0Npqop1uQ==", "pzuai");
        o.lllIIIIIl[o.lllIIIIlI[22]] = o.lIllllIlIIll("Oxs7JBURBiEiVhkdLjYeHws=", "zoOEv");
        o.lllIIIIIl[o.lllIIIIlI[23]] = o.lIllllIlIlIl("mkBn0JDh8FQ=", "Crzce");
        o.lllIIIIIl[o.lllIIIIlI[30]] = o.lIllllIlIlII("zDBzIOZqSOfszn/jGtkkVw==", "jjvnA");
        o.lllIIIIIl[o.lllIIIIlI[34]] = o.lIllllIlIlIl("vrOa/ocDnDjMcA0R5QVafw==", "BvMfv");
        o.lllIIIIIl[o.lllIIIIlI[36]] = o.lIllllIlIIll("ASkJDVYROgYL", "rHgiv");
        o.lllIIIIIl[o.lllIIIIlI[60]] = o.lIllllIlIlII("TJIX3r7NDIp44iG7jw//2BXvoPGwsAjstvWsP7oLKQTUdaeSQJKzy8p6jNINd7a/", "UIJVT");
        o.lllIIIIIl[o.lllIIIIlI[61]] = o.lIllllIlIlII("x1TBhtOGSC6M6irOMWzFOJtdYrEL21HK3gvUiZtXOhDXp8dXR6LUrQ==", "PDFuF");
        o.lllIIIIIl[o.lllIIIIlI[62]] = o.lIllllIlIlII("fD7r9R8WiiBFazYRSgOeug==", "ZGEZg");
    }
