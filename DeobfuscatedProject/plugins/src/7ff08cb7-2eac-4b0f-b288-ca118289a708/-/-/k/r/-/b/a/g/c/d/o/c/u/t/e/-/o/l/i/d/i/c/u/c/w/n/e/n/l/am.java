...
implements ab {
                    ...
                    if (am.lllIIIllllll(Equipment.contains((int[])nArray) ? 1 : 0) && am.lllIIlIIIIll(Players.getLocal().getWorldLocation().distanceTo(ms), lIIIIllIlI[14])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (am.lllIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                bl = lIIIIllIlI[1];
                                "".length();
                                if ((74 + 153 - 70 + 12 ^ 68 + 145 - 200 + 160) == -" ".length()) {
                                    return ((0x3A ^ 0x7D ^ (0x27 ^ 0x4D)) & (113 + 108 - 102 + 55 ^ 49 + 8 - -58 + 16 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIIIllIlI[0];
                            }
                    ...
                    if (am.lllIIIlllllI(Skills.getLevel((Skill)Skill.COOKING), lIIIIllIlI[5])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (am.lllIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                bl = lIIIIllIlI[1];
                                "".length();
                                if (-" ".length() >= ((0x2B ^ 0x15 ^ (0x6E ^ 0x33)) & (35 + 179 - 158 + 139 ^ 95 + 100 - 181 + 146 ^ -" ".length()))) {
                                    return ((0x28 ^ 0x12 ^ (0x81 ^ 0xAB)) & (0x1D ^ 0xC ^ " ".length() ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIIIllIlI[0];
                            }
                    ...
                    if (am.lllIIlIIIIlI(Skills.getLevel((Skill)Skill.COOKING), lIIIIllIlI[5]) && am.lllIIIlllllI(Skills.getLevel((Skill)Skill.COOKING), lIIIIllIlI[8])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (am.lllIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                bl = lIIIIllIlI[1];
                                "".length();
                                if ((0x23 ^ 0x7A ^ (0x59 ^ 4)) == "   ".length()) {
                                    return ((126 + 229 - 321 + 217 ^ 120 + 126 - 203 + 156) & (1 + 88 - 32 + 71 ^ 72 + 123 - 127 + 120 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIIIllIlI[0];
                            }
                        ...
                        if (am.lllIIIllllIl(Production.isOpen() ? 1 : 0)) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!am.lllIIIllllIl(am.an() ? 1 : 0) || am.lllIIIllllIl(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (null != null) {
                                        return ((0xB4 ^ 0xA3 ^ (0x64 ^ 0x24)) & (156 + 53 - 38 + 28 ^ 26 + 55 - 35 + 98 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIIllIlI[0];
                                }
    ...
    private static boolean an() {
        ...
        if (am.lllIIlIIIIlI(Skills.getLevel((Skill)Skill.COOKING), lIIIIllIlI[8])) {
            ...
            if (am.lllIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                bl2 = lIIIIllIlI[1];
                "".length();
                if ("   ".length() == (65 + 46 - -37 + 1 ^ 132 + 106 - 191 + 98)) {
                    return ((0xE1 ^ 0xA9 ^ (0x4F ^ 0x24)) & (0x17 ^ 0x4C ^ (0x18 ^ 0x60) ^ -" ".length())) != 0;
                }
            } else {
                bl2 = lIIIIllIlI[0];
            }
        ...
        if (am.lllIIlIIIIIl(Inventory.getCount((int[])nArray))) {
            bl = lIIIIllIlI[1];
            "".length();
            if (((0x69 ^ 9 ^ (0x53 ^ 0x79)) & (132 + 141 - 73 + 5 ^ 57 + 14 - 47 + 111 ^ -" ".length())) != 0) {
                return ((0x4F ^ 0x37 ^ (0xDB ^ 0xAA)) & (0x23 ^ 0x7D ^ (0xF2 ^ 0xA5) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIIllIlI[0];
        }
    ...
    public boolean ah() {
        ...
        if (am.lllIIlIIIIlI(Skills.getLevel((Skill)Skill.COOKING), lIIIIllIlI[35])) {
            ...
            "".length();
            if (-" ".length() > 0) {
                return ((134 + 116 - 245 + 199 ^ 81 + 130 - 78 + 16) & (0x6B ^ 0x4D ^ 108 + 101 - 186 + 104 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIIllIlI[0];
        }
    ...
    private static void lllIIIllllII() {
        ...
        am.lIIIIllIlI[1] = " ".length();
        am.lIIIIllIlI[2] = "  ".length();
        am.lIIIIllIlI[3] = "   ".length();
    ...
    private static void lllIIIlllIll() {
        ...
        am.lIIIIllIIl[am.lIIIIllIlI[0]] = am.lllIIIlllIII("SxA56fA10jgtGzGkrExq8Q==", "IlCnD");
        am.lIIIIllIIl[am.lIIIIllIlI[1]] = am.lllIIIlllIII("83czMqXSpu/PE8k0+t559zqjM/u5HF3npTZMXY5i2v1aeA2Xcy+7nD7tTMIjNgALXp6BP1WBMzw=", "YQoyy");
        am.lIIIIllIIl[am.lIIIIllIlI[2]] = am.lllIIIlllIII("oJFuNV/tlHX/g/z3fPXvakRKu8Iber7h", "AJIoR");
        am.lIIIIllIIl[am.lIIIIllIlI[3]] = am.lllIIIlllIII("PAi7A9TKgEV0AHv9X0483TGK2JCo52NX", "QxcGU");
        am.lIIIIllIIl[am.lIIIIllIlI[7]] = am.lllIIIlllIII("WfMdB4BgRMuxTWa/NAUuZ026ittH0ILHSGjVQZZDfGOsLOTx6vTmwXb1uQ3jXk+N", "WlxgM");
        am.lIIIIllIIl[am.lIIIIllIlI[10]] = am.lllIIIlllIII("TgeYhqAkkW++dmLonGG6ge+A70Gm51qLxf5jevjZ0OtijfTkhjnPHhr/uc/qlwAA", "jmfAC");
        am.lIIIIllIIl[am.lIIIIllIlI[12]] = am.lllIIIlllIIl("BzxEJhk1eQkuGCMwCiBLIywUNwc5PBdrSyMuDTMIODAKIEskNkQFPgkQKgA=", "PYdGk");
        am.lIIIIllIIl[am.lIIIIllIlI[15]] = am.lllIIIlllIlI("d2E8Gs5nCXdDUccCgh4VnQ==", "bNVQb");
        am.lIIIIllIIl[am.lIIIIllIlI[16]] = am.lllIIIlllIlI("D8E8Mx1n1Kg=", "vFGWf");
        am.lIIIIllIIl[am.lIIIIllIlI[17]] = am.lllIIIlllIII("rcmhJx1Ek/Z2EIw5lyxrISjzRZSXmK7n", "wfeVi");
        am.lIIIIllIIl[am.lIIIIllIlI[18]] = am.lllIIIlllIIl("Gh4VCjA3Fg==", "YqzaY");
        am.lIIIIllIIl[am.lIIIIllIlI[19]] = am.lllIIIlllIII("yIAnv+X1fwk=", "OZOJc");
        am.lIIIIllIIl[am.lIIIIllIlI[20]] = am.lllIIIlllIIl("LgccIQ==", "mhsJZ");
        am.lIIIIllIIl[am.lIIIIllIlI[34]] = am.lllIIIlllIlI("+kOHOI0VvI8=", "mAHPD");
        am.lIIIIllIIl[am.lIIIIllIlI[36]] = am.lllIIIlllIIl("Kj87InA3MHUyNTk6IS1wcA==", "XVUEP");
        am.lIIIIllIIl[am.lIIIIllIlI[5]] = am.lllIIIlllIlI("M2jVpczkS/Ta/H0g1rky3igNsvTiIlEl", "AGmIR");
    }
