...
implements ab {
            ...
            if (ad.llIllIIlIIlI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (ad.llIllIIlIIlI(Inventory.contains((int[])nArray2) ? 1 : 0)) {
                    ...
                    if (!(!ad.llIllIIlIIlI(Inventory.contains((int[])nArray3) ? 1 : 0) || ad.llIllIIlIlII(Inventory.contains(item -> item.getName().contains(lllllllII[lllllllIl[207]])) ? 1 : 0) && !ad.llIllIIlIIlI(Equipment.contains(item -> item.getName().contains(lllllllII[lllllllIl[206]])) ? 1 : 0) || ad.llIllIIlIlII(Inventory.contains((int[])f.bm) ? 1 : 0) && !ad.llIllIIlIIlI(Equipment.contains((int[])f.bm) ? 1 : 0))) {
                        ...
                        return ((0x4E ^ 0x72 ^ 75 + 118 - 151 + 85) & (0xEE ^ 0x88 ^ (0x21 ^ 4) ^ -" ".length())) != 0;
                    }
                }
            }
            n3 = lllllllIl[0];
        ...
        if (ad.llIllIIlIlII(ad.dY() ? 1 : 0)) {
            ...
            if (ad.llIllIIlIIlI(lIIllllllllll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.llIllIIlIlIl(lIIllllllIlll = TileObjects.getNearest(tileObject -> {
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (ad.llIllIIlIllI(Skills.getExperience((Skill)Skill.AGILITY), lIIllllllIllI)) {
                        bl = lllllllIl[1];
                        "".length();
                        if ((0x41 ^ 0x75 ^ (0xBA ^ 0x8A)) <= ((0x7E ^ 0xB ^ (0x6D ^ 0x55)) & (0x52 ^ 0x16 ^ (0x12 ^ 0x1B) ^ -" ".length()))) {
                            return ((0xFE ^ 0xB2 ^ (0x3A ^ 0x22)) & (185 + 23 - 127 + 166 ^ 103 + 1 - 89 + 148 ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lllllllIl[0];
                    }
            ...
            if (ad.llIllIIlIIlI(lIIllllllllIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.llIllIIlIlIl(lIIllllllIlll = TileObjects.getNearest(tileObject -> {
                ...
                if (ad.llIllIIlIIlI(tileObject.getName().contains(lllllllII[lllllllIl[227]]) ? 1 : 0) && ad.llIllIIllIlI(tileObject.getWorldLocation().distanceTo(new WorldPoint(lllllllIl[228], lllllllIl[229], lllllllIl[10])), lllllllIl[3])) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((54 + 87 - 22 + 65 ^ 13 + 69 - -48 + 9) & (2 ^ 0xE ^ (6 ^ 0x39) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lllllllIl[0];
                }
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (ad.llIllIIlIllI(Skills.getExperience((Skill)Skill.AGILITY), lIIllllllIllI)) {
                        bl = lllllllIl[1];
                        "".length();
                        if ((0x6A ^ 0x11 ^ 79 + 116 - 117 + 49) == ((" ".length() ^ (0x7D ^ 0x33)) & (16 + 167 - 46 + 112 ^ 32 + 42 - -60 + 48 ^ -" ".length()))) {
                            return ((138 + 72 - 71 + 8 ^ 106 + 130 - 170 + 122) & (0xB0 ^ 0xBE ^ (0x15 ^ 0x34) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lllllllIl[0];
                    }
            ...
            if (ad.llIllIIlIIlI(lIIllllllllII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.llIllIIlIlIl(lIIllllllIlll = TileObjects.getNearest(tileObject -> {
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (ad.llIllIIlIllI(Skills.getExperience((Skill)Skill.AGILITY), lIIllllllIllI)) {
                        ...
                        "".length();
                        if (-"   ".length() >= 0) {
                            return ((0x15 ^ 0x61 ^ (0xD5 ^ 0xC2)) & (0x19 ^ 0x37 ^ (0x7B ^ 0x36) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lllllllIl[0];
                    }
            ...
            if (ad.llIllIIlIIlI(lIIlllllllIll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.llIllIIlIlIl(lIIllllllIlll = TileObjects.getNearest(tileObject -> {
                ...
                if (ad.llIllIIlIIlI(tileObject.getName().contains(lllllllII[lllllllIl[224]]) ? 1 : 0) && ad.llIllIIllIlI(tileObject.getWorldLocation().distanceTo(new WorldPoint(lllllllIl[225], lllllllIl[215], lllllllIl[10])), lllllllIl[3])) {
                    n2 = lllllllIl[1];
                    "".length();
                    if ((146 + 88 - 76 + 14 ^ 17 + 152 - 108 + 107) < ((0x8B ^ 0xAA ^ (0x56 ^ 0x37)) & (0x75 ^ 0x11 ^ (0x93 ^ 0xB7) ^ -" ".length()))) {
                        return ((152 + 124 - 185 + 63 ^ 47 + 75 - 36 + 93) & (0x19 ^ 0x29 ^ (0x92 ^ 0x8B) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lllllllIl[0];
                }
            ...
            if (ad.llIllIIlIIlI(lIIlllllllIlI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.llIllIIlIlIl(lIIllllllIlll = TileObjects.getNearest(tileObject -> {
                ...
                if (ad.llIllIIlIIlI(tileObject.getName().contains(lllllllII[lllllllIl[221]]) ? 1 : 0) && ad.llIllIIllIlI(tileObject.getWorldLocation().distanceTo(new WorldPoint(lllllllIl[222], lllllllIl[223], lllllllIl[3])), lllllllIl[3])) {
                    ...
                    "".length();
                    if (" ".length() < 0) {
                        return ((0xC6 ^ 0x93 ^ (0x31 ^ 0x25)) & (0x6D ^ 0x2D ^ " ".length() ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lllllllIl[0];
                }
    ...
    private static void llIllIIIlIll() {
        ...
        ad.lllllllII[ad.lllllllIl[0]] = ad.llIllIIIlIII("dtuJ20ODthYISDBEpXSdxg==", "IYIbR");
        ad.lllllllII[ad.lllllllIl[1]] = ad.llIllIIIlIII("QOkB7sUOvWpfCyL7IsjubK65YQg+yWiVzQPKN3NBCNrfiwgwm67DAYI8KsKNMLx94KVNBCel3bk=", "UgLxY");
        ad.lllllllII[ad.lllllllIl[3]] = ad.llIllIIIlIIl("LAg5JCEDHSYjIUIdIG0kAwck", "biOMF");
        ad.lllllllII[ad.lllllllIl[10]] = ad.llIllIIIlIlI("Q0puCnMjZeuuZuCA3RrNY5bDy9/XCgkK", "HkVFQ");
        ad.lllllllII[ad.lllllllIl[17]] = ad.llIllIIIlIlI("K25rTPFk3EZ5rSOG+f9icZQFSbI0WNv1lCh1bL8aSNiMdAHjVLAcVOh0yqRqLzDW1alec7PPXeg=", "ITFHk");
        ad.lllllllII[ad.lllllllIl[2]] = ad.llIllIIIlIII("FRclIIWhtcg=", "oEqld");
        ad.lllllllII[ad.lllllllIl[20]] = ad.llIllIIIlIlI("awM9OT6pNHM=", "hsjnb");
        ad.lllllllII[ad.lllllllIl[22]] = ad.llIllIIIlIII("U5NnaXw9GFc=", "FiNoW");
        ad.lllllllII[ad.lllllllIl[24]] = ad.llIllIIIlIlI("CpTrFfDdSRw=", "qYYvI");
        ad.lllllllII[ad.lllllllIl[26]] = ad.llIllIIIlIIl("HTIV", "XSasm");
        ad.lllllllII[ad.lllllllIl[12]] = ad.llIllIIIlIIl("LyI+Ui4OYy8cNQwmaBE1FDE7Fw==", "aCHrZ");
        ad.lllllllII[ad.lllllllIl[49]] = ad.llIllIIIlIIl("EgseFgM4FxZFHD4e", "Qyqep");
        ad.lllllllII[ad.lllllllIl[63]] = ad.llIllIIIlIIl("OSwIdQ0ULw47DBA=", "uCoUo");
        ad.lllllllII[ad.lllllllIl[64]] = ad.llIllIIIlIIl("MSo0LW4HKCopMBU=", "fKXFC");
        ad.lllllllII[ad.lllllllIl[53]] = ad.llIllIIIlIlI("x7OhMLgMRAF1RY1yBF33eA==", "baqnJ");
        ad.lllllllII[ad.lllllllIl[38]] = ad.llIllIIIlIlI("1mxX4t8BeCrvGM8UX5oGCA==", "AdYvM");
        ad.lllllllII[ad.lllllllIl[65]] = ad.llIllIIIlIlI("llRz2IULzRixZ7WLZIDNRA==", "vUQsL");
        ad.lllllllII[ad.lllllllIl[66]] = ad.llIllIIIlIIl("KiUCCTcAJwxENxsoBQc9", "iIkdU");
        ad.lllllllII[ad.lllllllIl[54]] = ad.llIllIIIlIlI("3taGnh17i6OHTLPGIOaViA==", "nVNjN");
        ad.lllllllII[ad.lllllllIl[67]] = ad.llIllIIIlIII("TpWnZw5L380=", "cvmMq");
        ad.lllllllII[ad.lllllllIl[40]] = ad.llIllIIIlIIl("MiILFRcYPgNGFh4gAQ==", "qPdfd");
        ad.lllllllII[ad.lllllllIl[68]] = ad.llIllIIIlIlI("78yGtg5ZEMcWmHP6O8Ozyw==", "WGNtq");
        ad.lllllllII[ad.lllllllIl[61]] = ad.llIllIIIlIII("hKsDk2PgG8U=", "hHvxe");
        ad.lllllllII[ad.lllllllIl[69]] = ad.llIllIIIlIII("JFaLFSl6NO+tGasaCzTD1Q==", "CLwPj");
        ad.lllllllII[ad.lllllllIl[70]] = ad.llIllIIIlIII("5Avhok+dA3jmWyeRbFSgXQ==", "NcJCQ");
        ad.lllllllII[ad.lllllllIl[41]] = ad.llIllIIIlIIl("FzosNAx5MiouAA==", "TVEYn");
        ad.lllllllII[ad.lllllllIl[71]] = ad.llIllIIIlIII("jYnofKKIaaIlh3v+JE2oZA==", "MhmWL");
        ad.lllllllII[ad.lllllllIl[72]] = ad.llIllIIIlIIl("Jy4jJBELIDVwHg04", "hLPPp");
        ad.lllllllII[ad.lllllllIl[73]] = ad.llIllIIIlIIl("Jzo8IClJOSMoOQ==", "dVUMK");
        ad.lllllllII[ad.lllllllIl[74]] = ad.llIllIIIlIlI("nryGUmN+z9XyK7GiWpxK3Q==", "XCRfo");
        ad.lllllllII[ad.lllllllIl[42]] = ad.llIllIIIlIIl("CRoWLRAlFAB5AS8IAA==", "FxeYq");
        ad.lllllllII[ad.lllllllIl[75]] = ad.llIllIIIlIII("r79Yjv2Vmo0x6TN2dCBnfA==", "ehLDf");
        ad.lllllllII[ad.lllllllIl[95]] = ad.llIllIIIlIlI("blPnjEDsfgFLINks9hGu3g==", "eywFI");
        ad.lllllllII[ad.lllllllIl[97]] = ad.llIllIIIlIlI("cTQ2RyCY30A6nYIEU8go/w==", "ZNoXc");
        ad.lllllllII[ad.lllllllIl[98]] = ad.llIllIIIlIII("fKDN1uO0564l1yEnDn+uWA==", "oMIzP");
        ad.lllllllII[ad.lllllllIl[99]] = ad.llIllIIIlIlI("lMQVcjhuUknbmIFIob3rx/gRZOiOlkL7", "qsTxh");
        ad.lllllllII[ad.lllllllIl[100]] = ad.llIllIIIlIII("eksT276Gw7U=", "zeYWd");
        ad.lllllllII[ad.lllllllIl[101]] = ad.llIllIIIlIIl("KwU1Jj0RHzN0KhcEJics", "xqTTI");
        ad.lllllllII[ad.lllllllIl[102]] = ad.llIllIIIlIIl("IiIFJi9QOhEtKw==", "pMpAG");
        ad.lllllllII[ad.lllllllIl[103]] = ad.llIllIIIlIIl("LCI9BSM=", "oNThA");
        ad.lllllllII[ad.lllllllIl[37]] = ad.llIllIIIlIIl("JCIaJgEOPhJ1EQs/AT0XFHAZPBwC", "gPuUr");
        ad.lllllllII[ad.lllllllIl[105]] = ad.llIllIIIlIII("OEptgjQtzwDLKtctu5tgaA==", "Vekud");
        ad.lllllllII[ad.lllllllIl[106]] = ad.llIllIIIlIlI("w2KFFGjxlz4=", "FdwfU");
        ad.lllllllII[ad.lllllllIl[107]] = ad.llIllIIIlIII("cb5mZHf2JKs=", "Uuwpa");
        ad.lllllllII[ad.lllllllIl[108]] = ad.llIllIIIlIIl("FCc7", "SFKwE");
        ad.lllllllII[ad.lllllllIl[109]] = ad.llIllIIIlIlI("WLR64vCccJ4=", "ujncr");
        ad.lllllllII[ad.lllllllIl[110]] = ad.llIllIIIlIIl("NRYGCAsUHgQO", "wwjie");
        ad.lllllllII[ad.lllllllIl[111]] = ad.llIllIIIlIII("wXLotc8GVqw=", "alcXW");
        ad.lllllllII[ad.lllllllIl[112]] = ad.llIllIIIlIIl("ITsiOCEAPw==", "cZNYO");
        ad.lllllllII[ad.lllllllIl[113]] = ad.llIllIIIlIIl("HgIuNiU6EGMhLSQ=", "TwCFL");
        ad.lllllllII[ad.lllllllIl[39]] = ad.llIllIIIlIlI("cHKv838xpDc=", "YLzsp");
        ad.lllllllII[ad.lllllllIl[7]] = ad.llIllIIIlIII("iSktNfJJkoE=", "fysro");
        ad.lllllllII[ad.lllllllIl[114]] = ad.llIllIIIlIIl("GTcqEzo9JWcEMiNidQ==", "SBGcS");
        ad.lllllllII[ad.lllllllIl[116]] = ad.llIllIIIlIlI("UFOP99pQ86s=", "xGWGr");
        ad.lllllllII[ad.lllllllIl[117]] = ad.llIllIIIlIlI("uOH6y+kUzyolHgGSoH89rg==", "YDXvF");
        ad.lllllllII[ad.lllllllIl[119]] = ad.llIllIIIlIII("YvfJ7U8ZGL4=", "YNMRu");
        ad.lllllllII[ad.lllllllIl[120]] = ad.llIllIIIlIlI("QneoKgBev9v+P1X80bNPag==", "VkQBO");
        ad.lllllllII[ad.lllllllIl[122]] = ad.llIllIIIlIlI("fSZOiyBHBdg=", "IxOWv");
        ad.lllllllII[ad.lllllllIl[123]] = ad.llIllIIIlIlI("sjF8PZryK+mtFOqWUTtX/gB6v+JSNgG/", "oMfOu");
        ad.lllllllII[ad.lllllllIl[124]] = ad.llIllIIIlIIl("CxQ0PA==", "NpSYX");
        ad.lllllllII[ad.lllllllIl[44]] = ad.llIllIIIlIlI("APH2CQ3/q5Yg6PufDDWKXw==", "sNdda");
        ad.lllllllII[ad.lllllllIl[140]] = ad.llIllIIIlIlI("/EBKO6fPdUzz9Oas7c6FeaSJfi1SzCIq", "OAEBR");
        ad.lllllllII[ad.lllllllIl[6]] = ad.llIllIIIlIlI("xIkG07o3xib6+z4M9nAmOw==", "OhnwR");
        ad.lllllllII[ad.lllllllIl[141]] = ad.llIllIIIlIIl("FTUqBAMvLyxWFCk0OQUS", "FAKvw");
        ad.lllllllII[ad.lllllllIl[142]] = ad.llIllIIIlIIl("OAU8IkcYFjUr", "ldPNg");
        ad.lllllllII[ad.lllllllIl[143]] = ad.llIllIIIlIIl("Jz4bIRA=", "dRrLr");
        ad.lllllllII[ad.lllllllIl[144]] = ad.llIllIIIlIlI("DKVpC+TS+BBLZdJfmORP0A==", "pKOLg");
        ad.lllllllII[ad.lllllllIl[145]] = ad.llIllIIIlIIl("OBUECjgLVAICJAc=", "ltocV");
        ad.lllllllII[ad.lllllllIl[146]] = ad.llIllIIIlIIl("PBkPAwFaGxsfDloZFE0CCBkPAwE=", "zvzme");
        ad.lllllllII[ad.lllllllIl[147]] = ad.llIllIIIlIIl("OyUhDw==", "oDJjJ");
        ad.lllllllII[ad.lllllllIl[148]] = ad.llIllIIIlIII("R1OO8yUUPaLw3s+xNJl9ow==", "CuHvL");
        ad.lllllllII[ad.lllllllIl[149]] = ad.llIllIIIlIlI("Wx1uXZsJRgo=", "hHKZJ");
        ad.lllllllII[ad.lllllllIl[150]] = ad.llIllIIIlIIl("IjsJGwcGKUQMDxhuVg==", "hNdkn");
        ad.lllllllII[ad.lllllllIl[151]] = ad.llIllIIIlIIl("DxMcPg==", "EfqNw");
        ad.lllllllII[ad.lllllllIl[152]] = ad.llIllIIIlIlI("GEyHe9oosyX8tbAjYJtWyA==", "vFRtM");
        ad.lllllllII[ad.lllllllIl[153]] = ad.llIllIIIlIIl("PwMUIw==", "uvySa");
        ad.lllllllII[ad.lllllllIl[154]] = ad.llIllIIIlIII("aIrdustgr8fr0kzhv4+KvA==", "ABuUb");
        ad.lllllllII[ad.lllllllIl[155]] = ad.llIllIIIlIlI("LLjb41PPzf4=", "FaPNC");
        ad.lllllllII[ad.lllllllIl[156]] = ad.llIllIIIlIIl("PQocPRYCBQ4=", "kkiQb");
        ad.lllllllII[ad.lllllllIl[157]] = ad.llIllIIIlIIl("HQk/Lic=", "KhJBS");
        ad.lllllllII[ad.lllllllIl[158]] = ad.llIllIIIlIIl("HSMIOgY5MUUtDid2UA==", "WVeJo");
        ad.lllllllII[ad.lllllllIl[159]] = ad.llIllIIIlIIl("CwQJJw==", "AqdWn");
        ad.lllllllII[ad.lllllllIl[160]] = ad.llIllIIIlIIl("CCMHBgMsMUoRCzJ2XA==", "BVjvj");
        ad.lllllllII[ad.lllllllIl[161]] = ad.llIllIIIlIII("uwy6Acl1XFM=", "Ghzef");
        ad.lllllllII[ad.lllllllIl[172]] = ad.llIllIIIlIIl("KCQSRhIJZQcHCAcjDRVGBSoRFBUD", "fEdff");
        ad.lllllllII[ad.lllllllIl[173]] = ad.llIllIIIlIIl("PQUcZAAcRBkwFQEQ", "sdjDt");
        ad.lllllllII[ad.lllllllIl[174]] = ad.llIllIIIlIII("Q5a3vnowoD9JtOpaKec89g==", "fyLcY");
        ad.lllllllII[ad.lllllllIl[175]] = ad.llIllIIIlIlI("CEwB8PJ8vHo=", "Stbwu");
        ad.lllllllII[ad.lllllllIl[35]] = ad.llIllIIIlIlI("IwMIqA3vcpqc4bDNdhN8ZA==", "yPGNw");
        ad.lllllllII[ad.lllllllIl[176]] = ad.llIllIIIlIlI("c5aEIzAeR9qM13VZxDKW4A==", "KKzWk");
        ad.lllllllII[ad.lllllllIl[177]] = ad.llIllIIIlIlI("+AN0C0xRcqk5Wz/SgHZnFg==", "gBPRp");
        ad.lllllllII[ad.lllllllIl[178]] = ad.llIllIIIlIII("Z2CgGVoICYW1L9Jm2JugCxTYVodvRgSb", "XvNNX");
        ad.lllllllII[ad.lllllllIl[179]] = ad.llIllIIIlIlI("nhgM0tlhu9k=", "cYYxl");
        ad.lllllllII[ad.lllllllIl[180]] = ad.llIllIIIlIIl("DA89IxAoHXA0GDZaYQ==", "FzPSy");
        ad.lllllllII[ad.lllllllIl[79]] = ad.llIllIIIlIIl("IwALIg==", "iufRT");
        ad.lllllllII[ad.lllllllIl[181]] = ad.llIllIIIlIII("xeiSqQqHFloKwAvromf94Q==", "eDzST");
        ad.lllllllII[ad.lllllllIl[182]] = ad.llIllIIIlIII("rePTJDEkkuA=", "ZiUiy");
        ad.lllllllII[ad.lllllllIl[183]] = ad.llIllIIIlIlI("JO4BLhr5T1k1rD8BMMbiVQ==", "kPsLb");
        ad.lllllllII[ad.lllllllIl[184]] = ad.llIllIIIlIIl("DxAMAg==", "EearE");
        ad.lllllllII[ad.lllllllIl[185]] = ad.llIllIIIlIII("6hbEckQmV+BzpadtdzOEcw==", "dPpFs");
        ad.lllllllII[ad.lllllllIl[186]] = ad.llIllIIIlIIl("Ez4KCA==", "YKgxa");
        ad.lllllllII[ad.lllllllIl[187]] = ad.llIllIIIlIIl("EiACMgU2Mk8HCD8w", "XUoBl");
        ad.lllllllII[ad.lllllllIl[188]] = ad.llIllIIIlIIl("MCAkJQ==", "zUIUi");
        ad.lllllllII[ad.lllllllIl[194]] = ad.llIllIIIlIIl("BzUMDB1hNxgQEmE1F0IeMzUMDB0=", "AZyby");
        ad.lllllllII[ad.lllllllIl[203]] = ad.llIllIIIlIII("9b6RomNTWdU=", "Ohdsc");
        ad.lllllllII[ad.lllllllIl[204]] = ad.llIllIIIlIIl("JikrMDYxLQ==", "VHXCW");
        ad.lllllllII[ad.lllllllIl[205]] = ad.llIllIIIlIlI("htOsCyQ0bj4=", "fJAOX");
        ad.lllllllII[ad.lllllllIl[206]] = ad.llIllIIIlIlI("1nEPEO4zpHM=", "OTMrD");
        ad.lllllllII[ad.lllllllIl[207]] = ad.llIllIIIlIIl("ISgpNgo2LA==", "QIZEk");
        ad.lllllllII[ad.lllllllIl[208]] = ad.llIllIIIlIIl("BwAlLg==", "BdBKi");
        ad.lllllllII[ad.lllllllIl[211]] = ad.llIllIIIlIIl("CRI2", "NsFVi");
        ad.lllllllII[ad.lllllllIl[213]] = ad.llIllIIIlIlI("ksy36DFluPE=", "BiDaC");
        ad.lllllllII[ad.lllllllIl[216]] = ad.llIllIIIlIII("axbcOImEw4EzwG3TNtJR1w==", "OdxWk");
        ad.lllllllII[ad.lllllllIl[218]] = ad.llIllIIIlIII("oota7g/rFPs=", "niuNb");
        ad.lllllllII[ad.lllllllIl[221]] = ad.llIllIIIlIIl("LigA", "iIpRJ");
        ad.lllllllII[ad.lllllllIl[224]] = ad.llIllIIIlIIl("JBck", "cvTCk");
        ad.lllllllII[ad.lllllllIl[226]] = ad.llIllIIIlIIl("MgQ/D2EUCiYGOA==", "bkSjL");
        ad.lllllllII[ad.lllllllIl[227]] = ad.llIllIIIlIlI("ekmuJAprTBY=", "lpuYc");
        ad.lllllllII[ad.lllllllIl[230]] = ad.llIllIIIlIlI("/2vAR0tUKXA=", "vfCJi");
        ad.lllllllII[ad.lllllllIl[232]] = ad.llIllIIIlIIl("LAwH", "kmwlc");
        ad.lllllllII[ad.lllllllIl[233]] = ad.llIllIIIlIIl("IxQn", "duWBh");
    }
    ...
    private static void llIllIIlIIIl() {
        ...
        ad.lllllllIl[0] = (6 ^ 0x4E ^ (0x29 ^ 0x4E)) & (0x39 ^ 0x23 ^ (0x61 ^ 0x54) ^ -" ".length());
        ad.lllllllIl[1] = " ".length();
        ad.lllllllIl[2] = 0xC5 ^ 0xC0;
        ad.lllllllIl[3] = "  ".length();
        ...
        ad.lllllllIl[53] = "   ".length() ^ (0xA5 ^ 0xA8);
    ...
    private static boolean dY() {
        ...
        if (ad.llIllIIlIlIl(TileItems.getNearest((int[])nArray))) {
            ...
            while (ad.llIllIIlIIll(lIIlllIlIlllI, ((void)lIIlllIlIllll).length)) {
                ...
                return ((0x5B ^ 0x41 ^ (0x3F ^ 0x22)) & (14 + 14 - -70 + 63 ^ 162 + 82 - 82 + 4 ^ -" ".length())) != 0;
            }
        }
        return lllllllIl[0];
    }
    ...
    public boolean ah() {
        ...
        if (ad.llIllIIllIII(Skills.getLevel((Skill)Skill.AGILITY), lllllllIl[2])) {
            ...
            "".length();
            if (" ".length() == 0) {
                return ((0x15 ^ 0x3A ^ (0x7A ^ 0x4A)) & (0x6F ^ 0xE ^ (0xC3 ^ 0xBD) ^ -" ".length())) != 0;
            }
        } else {
            bl = lllllllIl[0];
        }
        ...
        if (ad.llIllIIlIlII(ad.dY() ? 1 : 0)) {
            ...
            if (ad.llIllIIlIIlI(lIIlllllIIIll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.llIllIIlIlIl(lIIllllIlllIl = TileObjects.getNearest(tileObject -> {
                ...
                if (ad.llIllIIlIIlI(tileObject.getName().contains(lllllllII[lllllllIl[216]]) ? 1 : 0) && ad.llIllIIllIlI(tileObject.getWorldLocation().distanceTo(new WorldPoint(lllllllIl[217], lllllllIl[128], lllllllIl[3])), lllllllIl[3])) {
                    n2 = lllllllIl[1];
                    "".length();
                    if ("  ".length() <= ((8 + 198 - 187 + 190 ^ 82 + 95 - 89 + 91) & (94 + 58 - 114 + 191 ^ 40 + 64 - 31 + 62 ^ -" ".length()))) {
                        return ((66 + 136 - 184 + 121 ^ 39 + 65 - -86 + 2) & (80 + 136 - 96 + 135 ^ 55 + 113 - 80 + 92 ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lllllllIl[0];
                }
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (ad.llIllIIlIllI(Skills.getExperience((Skill)Skill.AGILITY), lIIllllIlllII)) {
                        ...
                        "".length();
                        if (-"   ".length() >= 0) {
                            return ((0x51 ^ 0x20 ^ (0xD5 ^ 0xBC)) & (126 + 142 - 251 + 152 ^ 86 + 136 - 213 + 168 ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lllllllIl[0];
                    }
            ...
            if (ad.llIllIIlIIlI(lIIlllllIIIIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.llIllIIlIlIl(lIIllllIlllIl = TileObjects.getNearest(tileObject -> {
                ...
                if (ad.llIllIIlIIlI(tileObject.getName().contains(lllllllII[lllllllIl[211]]) ? 1 : 0) && ad.llIllIIllIlI(tileObject.getWorldLocation().distanceTo(new WorldPoint(lllllllIl[209], lllllllIl[212], lllllllIl[10])), lllllllIl[3])) {
                    ...
                    "".length();
                    if (-"   ".length() >= 0) {
                        return ((0x4E ^ 0x37 ^ (1 ^ 0x27)) & (0xA9 ^ 0xAE ^ (0x42 ^ 0x1A) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lllllllIl[0];
                }
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (ad.llIllIIlIllI(Skills.getExperience((Skill)Skill.AGILITY), lIIllllIlllII)) {
                        ...
                        if ((0x65 ^ 0x61 ^ (0x63 ^ 0x49) & ~(3 ^ 0x29)) < 0) {
                            return ((0xA4 ^ 0xC6 ^ (0x2A ^ 0x53)) & (71 + 51 - 38 + 55 ^ 19 + 73 - 7 + 59 ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lllllllIl[0];
                    }
            ...
            if (ad.llIllIIlIIlI(lIIlllllIIIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.llIllIIlIlIl(lIIllllIlllIl = TileObjects.getNearest(tileObject -> {
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (ad.llIllIIlIllI(Skills.getExperience((Skill)Skill.AGILITY), lIIllllIlllII)) {
                        ...
                        "".length();
                        if (null != null) {
                            return ((0x90 ^ 0xA8 ^ (0x2A ^ 0x41)) & (0x55 ^ 3 ^ (0x3B ^ 0x3E) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lllllllIl[0];
                    }
                ...
                if (ad.llIllIIlIIlI(lIlIIIIIllIlI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.llIllIIlIlII(ad.dY() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (ad.llIllIIlIllI(Skills.getExperience((Skill)Skill.AGILITY), lIlIIIIIlIlII)) {
                            ...
                            "".length();
                            if (null != null) {
                                return ((4 + 68 - -21 + 94 ^ 6 + 36 - -48 + 46) & ("   ".length() ^ (0x1C ^ 0x2C) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lllllllIl[0];
                        }
                ...
                if (ad.llIllIIlIIlI(lIlIIIIIllIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.llIllIIlIlII(ad.dY() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (ad.llIllIIlIllI(Skills.getExperience((Skill)Skill.AGILITY), lIlIIIIIlIlII)) {
                            ...
                            "".length();
                            if (null != null) {
                                return ((0xCA ^ 0xAD ^ (0x5F ^ 0x7A)) & (0x1E ^ 0x5C ^ (0x88 ^ 0x9F) & ~(0x72 ^ 0x65) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lllllllIl[0];
                        }
                ...
                if (ad.llIllIIlIIlI(lIlIIIIIlIlll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.llIllIIlIlII(ad.dY() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (ad.llIllIIlIllI(Skills.getExperience((Skill)Skill.AGILITY), lIlIIIIIlIlII)) {
                            ...
                            "".length();
                            if (-" ".length() >= 0) {
                                return ((0x6D ^ 0x5D ^ (0x39 ^ 0x33)) & (0x21 ^ 0x30 ^ (0xEF ^ 0xC4) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lllllllIl[0];
                        }
