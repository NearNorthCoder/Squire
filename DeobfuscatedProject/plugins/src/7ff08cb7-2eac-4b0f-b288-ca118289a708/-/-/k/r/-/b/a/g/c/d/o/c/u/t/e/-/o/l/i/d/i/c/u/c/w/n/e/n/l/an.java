...
implements ab {
    ...
    private static void llIIllllllIl() {
        ...
        an.llllIIllI[0] = (0xC9 ^ 0xC6 ^ (0x8F ^ 0xC6)) & (4 ^ 0x3B ^ (0x6D ^ 0x14) ^ -" ".length());
        an.llllIIllI[1] = " ".length();
        an.llllIIllI[2] = 0xFFFFCFEF & 0x33F3;
        an.llllIIllI[3] = "  ".length();
        an.llllIIllI[4] = "   ".length();
        ...
        an.llllIIllI[19] = "   ".length() & ~"   ".length() ^ (0x20 ^ 0xA);
    ...
    public static boolean an() {
        ...
        if (an.llIlIIIIIIIl(Inventory.getCount((int[])nArray))) {
            ...
            if (an.llIlIIIIIIIl(Inventory.getCount((int[])nArray2))) {
                ...
                return ((73 + 46 - 74 + 146 ^ 117 + 54 - 104 + 62) & (0x80 ^ 0x92 ^ (0x65 ^ 0x49) ^ -" ".length())) != 0;
            }
        }
        n2 = llllIIllI[0];
        return n2 != 0;
    ...
    private static void llIIllllllII() {
        ...
        an.llllIIIlI[an.llllIIllI[0]] = an.llIIlllllIIl("JAEQJzkBVAA6MgsH", "ftiNW");
        an.llllIIIlI[an.llllIIllI[1]] = an.llIIlllllIlI("+9CCfPsXIRsJGjW9o0dLvjNU2lDipKwzSTt4SvhMDdBdveu6wkXl/r9VanABRXyugZcjqeElR/g=", "bnleY");
        an.llllIIIlI[an.llllIIllI[3]] = an.llIIlllllIlI("2jjOF6Hd8KuBn4z9eQfDK6NpMksjhvWA", "Qoipa");
        an.llllIIIlI[an.llllIIllI[4]] = an.llIIlllllIll("qBzM5ZiV6FMaanxXLnp6pw==", "QClyM");
        an.llllIIIlI[an.llllIIllI[6]] = an.llIIlllllIlI("R4t0zewgkUNSQEsHQMdfiIQgOciqkkgv", "RtHON");
        an.llllIIIlI[an.llllIIllI[9]] = an.llIIlllllIll("YAMEvF4cWhqt8vPDFFCyVHbky+XKmoDQ6q2w4Q78p8eugzfTMvroicjM6A6dFxOi", "KglMP");
        an.llllIIIlI[an.llllIIllI[10]] = an.llIIlllllIIl("MicLLDMYOw1q", "qUjJG");
        an.llllIIIlI[an.llllIIllI[11]] = an.llIIlllllIlI("ZxI/FiG++T/r/OAksERW5Q==", "JavMu");
        an.llllIIIlI[an.llllIIllI[12]] = an.llIIlllllIlI("zhBTwl7//6bBAv8seolO+w==", "TThOt");
        an.llllIIIlI[an.llllIIllI[15]] = an.llIIlllllIIl("AggyCgUoFDRMEiAUNwAUYRYyAgUkCD0=", "AzSlq");
        an.llllIIIlI[an.llllIIllI[17]] = an.llIIlllllIll("EabmhaCLHJnewt0LjT0aXQ==", "TmXfi");
        an.llllIIIlI[an.llllIIllI[18]] = an.llIIlllllIIl("GCAtZhw2JDE=", "WIAFp");
        an.llllIIIlI[an.llllIIllI[14]] = an.llIIlllllIlI("rW4uPA4XEuCcpNg5ihMV6Q==", "HEABf");
        an.llllIIIlI[an.llllIIllI[20]] = an.llIIlllllIll("RkMz9nCWYdA=", "yNPQX");
        an.llllIIIlI[an.llllIIllI[22]] = an.llIIlllllIlI("70Jg+QrmpD8doU/5UEGa8KUxP9KmV/2R", "zaGGy");
        an.llllIIIlI[an.llllIIllI[23]] = an.llIIlllllIll("dUBpVCUy6ibKHNE9mWHzKg==", "bbwer");
        an.llllIIIlI[an.llllIIllI[25]] = an.llIIlllllIll("o60nw5m4mplNojyJ5h6asw==", "zsZcC");
        an.llllIIIlI[an.llllIIllI[26]] = an.llIIlllllIll("12IALsrflaO8irzgjYaPL1OMoC3upx6P", "DBHHy");
        an.llllIIIlI[an.llllIIllI[28]] = an.llIIlllllIlI("XHqG3fhCk1aYQsZZyM8mJg==", "LrFIN");
        an.llllIIIlI[an.llllIIllI[29]] = an.llIIlllllIIl("Jg4vDiYYAWEWJgQc", "joAzC");
        an.llllIIIlI[an.llllIIllI[30]] = an.llIIlllllIlI("HLQUnR0Nl4YjXwgwKug6bXOQ2v+VUXZ/", "tkXQS");
        an.llllIIIlI[an.llllIIllI[31]] = an.llIIlllllIll("mqMdXHXUb7ivLe8UPQsZPw==", "LyeJa");
        an.llllIIIlI[an.llllIIllI[32]] = an.llIIlllllIIl("KBMSHSoNRgYbKB4DBVQjBgcYBw==", "jfktD");
        an.llllIIIlI[an.llllIIllI[35]] = an.llIIlllllIlI("s9Qfr4VjPvMzsti5QZNlJEsMg5dQnDEo1fRPTePHa2w=", "BXajP");
        an.llllIIIlI[an.llllIIllI[43]] = an.llIIlllllIIl("BSoPKB8vNgk=", "FXnNk");
        an.llllIIIlI[an.llllIIllI[45]] = an.llIIlllllIlI("GYg8Pf0a2EqiYWJeLCxXvXucYN8J4aqU", "EPmhZ");
    }
                        ...
                        if (an.llIlIIIIIIll(Skills.getLevel((Skill)Skill.CRAFTING), llllIIllI[6]) && an.llIIllllllll(Skills.getLevel((Skill)Skill.CRAFTING), llllIIllI[14])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!an.llIlIIIIIIll(Inventory.getCount((int[])nArray), llllIIllI[1]) || an.llIIlllllllI(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (-" ".length() < -" ".length()) {
                                        return ((0x3F ^ 0x5A ^ (0x40 ^ 0x11)) & (0xA8 ^ 0xAF ^ (0xAF ^ 0x9C) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = llllIIllI[0];
                                }
                        ...
                        if (an.llIlIIIIIIll(Skills.getLevel((Skill)Skill.CRAFTING), llllIIllI[14]) && an.llIIllllllll(Skills.getLevel((Skill)Skill.CRAFTING), llllIIllI[16])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!an.llIlIIIIIIll(Inventory.getCount((int[])nArray), llllIIllI[1]) || an.llIIlllllllI(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (" ".length() >= "   ".length()) {
                                        return ((0x3B ^ 0x21 ^ (5 ^ 9)) & (0xC5 ^ 0xC3 ^ (0x58 ^ 0x48) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = llllIIllI[0];
                                }
                        ...
                        if (an.llIlIIIIIIll(Skills.getLevel((Skill)Skill.CRAFTING), llllIIllI[19]) && an.llIIllllllll(Skills.getLevel((Skill)Skill.CRAFTING), llllIIllI[21])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!an.llIlIIIIIIll(Inventory.getCount((int[])nArray), llllIIllI[1]) || an.llIIlllllllI(Dialog.isOpen() ? 1 : 0)) {
                                    bl = llllIIllI[1];
                                    "".length();
                                    if ("  ".length() > (0x6D ^ 0x58 ^ (0x66 ^ 0x57))) {
                                        return ((200 + 142 - 240 + 101 ^ 26 + 75 - -46 + 8) & (90 + 157 - 180 + 171 ^ 165 + 120 - 154 + 59 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = llllIIllI[0];
                                }
                        ...
                        if (an.llIlIIIIIIll(Skills.getLevel((Skill)Skill.CRAFTING), llllIIllI[21]) && an.llIIllllllll(Skills.getLevel((Skill)Skill.CRAFTING), llllIIllI[24])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!an.llIlIIIIIIll(Inventory.getCount((int[])nArray), llllIIllI[1]) || an.llIIlllllllI(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (null != null) {
                                        return ((0x7A ^ 0x76 ^ (0xB0 ^ 0x99)) & (0x38 ^ 0x36 ^ (0x3B ^ 0x10) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = llllIIllI[0];
                                }
                        ...
                        if (an.llIlIIIIIIll(Skills.getLevel((Skill)Skill.CRAFTING), llllIIllI[24]) && an.llIIllllllll(Skills.getLevel((Skill)Skill.CRAFTING), llllIIllI[27])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!an.llIlIIIIIIll(Inventory.getCount((int[])nArray), llllIIllI[1]) || an.llIIlllllllI(Dialog.isOpen() ? 1 : 0)) {
                                    bl = llllIIllI[1];
                                    "".length();
                                    if (-" ".length() >= ((0x62 ^ 0) & ~(0xEC ^ 0x8E))) {
                                        return ((0xAF ^ 0xB6) & ~(0x2D ^ 0x34)) != 0;
                                    }
                                } else {
                                    bl = llllIIllI[0];
                                }
                        ...
                        if (an.llIlIIIIIIll(Skills.getLevel((Skill)Skill.CRAFTING), llllIIllI[27])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!an.llIlIIIIIIll(Inventory.getCount((int[])nArray), llllIIllI[1]) || an.llIIlllllllI(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (-"   ".length() > 0) {
                                        return ((0x1F ^ 0x18 ^ (0x96 ^ 0xA8)) & (0x1B ^ 0x42 ^ (5 ^ 0x65) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = llllIIllI[0];
                                }
