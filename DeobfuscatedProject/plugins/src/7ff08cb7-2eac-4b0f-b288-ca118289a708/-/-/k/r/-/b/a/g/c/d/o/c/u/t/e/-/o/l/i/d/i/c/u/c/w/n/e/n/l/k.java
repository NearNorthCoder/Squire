...
implements ab {
    ...
    public boolean ah() {
        ...
        if (k.lIlIllIlIlIl(Skills.getLevel((Skill)Skill.RANGED), llIIllIlI[39])) {
            ...
            "".length();
            if ("  ".length() != "  ".length()) {
                return ((0x9A ^ 0xBA ^ (0x37 ^ 0x3E)) & (4 ^ 0x60 ^ (0xDE ^ 0x93) ^ -" ".length())) != 0;
            }
        } else {
            bl = llIIllIlI[1];
        }
                ...
                lIlIIIlIIIIIll = NPCs.getNearest(nPC -> {
                    ...
                    if (k.lIlIllIIlllI(nPC.getName().contains(llIIlIlll[llIIllIlI[40]]) ? 1 : 0) && k.lIlIllIIllII(nPC.isDead() ? 1 : 0)) {
                        ...
                        if (k.lIlIllIIlllI(nPC.hasAction(stringArray) ? 1 : 0) && k.lIlIllIlIllI(nPC.getInteracting(), Players.getLocal())) {
                            n2 = llIIllIlI[0];
                            "".length();
                            if (((113 + 43 - 139 + 127 ^ 77 + 151 - 158 + 96) & (0xF6 ^ 0xBE ^ (0x1B ^ 0x65) ^ -" ".length())) != (0x67 ^ 0x3E ^ (0xF4 ^ 0xA9))) return n2 != 0;
                            return ((0x12 ^ 0x1A ^ (0x4B ^ 1)) & (0x57 ^ 0x61 ^ (0x76 ^ 2) ^ -" ".length())) != 0;
                        }
                    }
                    n2 = llIIllIlI[1];
                    return n2 != 0;
    ...
    private static void lIlIllIIIIll() {
        ...
        k.llIIlIlll[k.llIIllIlI[1]] = k.lIlIlIllllIl("Gi86GSM1OiUeI3Q6I1AmNSAn", "TNLpD");
        k.llIIlIlll[k.llIIllIlI[0]] = k.lIlIlIlllllI("Jf5V7nAaGv3yItosQ/xQeUycCKyojO0s", "scgol");
        k.llIIlIlll[k.llIIllIlI[10]] = k.lIlIllIIIIIl("aeNc98+TX0w=", "SOVGZ");
        k.llIIlIlll[k.llIIllIlI[20]] = k.lIlIllIIIIIl("5qvGPa+z1x1ljR3PUnZl6g==", "kZvDW");
        k.llIIlIlll[k.llIIllIlI[28]] = k.lIlIlIlllllI("NRhFIWmNESsqNd3a4H5s27pzsDItP869", "woaxd");
        k.llIIlIlll[k.llIIllIlI[29]] = k.lIlIlIllllIl("Dg82Chk=", "KaBok");
        k.llIIlIlll[k.llIIllIlI[27]] = k.lIlIlIllllIl("FiYeKQd4Pwc=", "UJwDe");
        k.llIIlIlll[k.llIIllIlI[34]] = k.lIlIllIIIIIl("wOXW/A4YRCuJ1CG1kazTmw==", "InHYD");
        k.llIIlIlll[k.llIIllIlI[35]] = k.lIlIlIllllIl("AzkGLyUpJBwpZjEiByI=", "BMrNF");
        k.llIIlIlll[k.llIIllIlI[36]] = k.lIlIlIllllIl("Ix45DTEJ", "bjMlR");
        k.llIIlIlll[k.llIIllIlI[7]] = k.lIlIllIIIIIl("tQoobGajt46L6MEkzj3RVw==", "phDQR");
        k.llIIlIlll[k.llIIllIlI[13]] = k.lIlIllIIIIIl("weboaDHVBP0=", "DEpbX");
        k.llIIlIlll[k.llIIllIlI[37]] = k.lIlIlIlllllI("bqX67Xh+RThFf3cvaTcI7w==", "RfMAc");
        k.llIIlIlll[k.llIIllIlI[14]] = k.lIlIlIllllIl("NQUjIz0HHjQqciAFJCgh", "sjQDR");
        k.llIIlIlll[k.llIIllIlI[40]] = k.lIlIlIllllIl("Pzo7BQ==", "lUNiO");
        k.llIIlIlll[k.llIIllIlI[41]] = k.lIlIlIlllllI("Abuqh5StIqU=", "zYpqp");
        k.llIIlIlll[k.llIIllIlI[42]] = k.lIlIlIlllllI("1wT6x5ERv8I=", "vdfQf");
        k.llIIlIlll[k.llIIllIlI[43]] = k.lIlIlIlllllI("mGMsJs6g8iA=", "HezhK");
        k.llIIlIlll[k.llIIllIlI[44]] = k.lIlIllIIIIIl("v9IMDosX0qI4btJiIPcsyQ==", "XfYmo");
    }
    ...
    public int af() {
        ...
        if ("   ".length() < 0) {
            return (126 + 120 - 200 + 82 ^ 110 + 41 - 105 + 136) & (0x53 ^ 0x72 ^ (0xA0 ^ 0xB7) ^ -" ".length());
        }
        return llIIllIlI[38];
    }
