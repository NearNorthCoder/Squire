...
implements ab {
    ...
    private static void llIllIlIIIIl() {
        ...
        aq.lIIIIIIIII[aq.lIIIIIIIIl[1]] = aq.llIllIIllllI("JB4TJAYBSwM5DQsY", "fkjMh");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[2]] = aq.llIllIIlllll("mMVbwBPSCMPOCCQ44vdDQU/yPmqXvqArPbxK3EHwVwUM2IPkoxPR2eGTa7MugLuW", "LxfyC");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[3]] = aq.llIllIIlllll("zsv94OTeaYGV4Rn/KxLIB3BQM2csj8Fa", "ppWAo");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[4]] = aq.llIllIIlllll("+Nu6bgHd8rfTwmFLti2nXdqNnxzKjKbj", "xzEml");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[6]] = aq.llIllIIllllI("LS9ZLSAfahQlIQkjFytyCjgYNTcIago5IgomECkhVmoKOzsOKRElPB1qDSNyOB8gBRw9", "zJyLR");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[13]] = aq.llIllIlIIIII("jJJYGov8xcw=", "vhEHT");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[15]] = aq.llIllIIlllll("hs3XtSS9US2JyKgSKAyKXA==", "AaCcL");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[17]] = aq.llIllIIlllll("bwTpBFvRe40=", "wnWEh");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[18]] = aq.llIllIlIIIII("BnFO51YUu+r5KnnT2Nbswg==", "fEvqD");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[19]] = aq.llIllIIllllI("NSYqMm5aOS4nJwoiOT9iDiJrJycMKCdrdkttHCIuHig5JScJPmU=", "zMKKB");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[21]] = aq.llIllIlIIIII("lETkc2bvAuOd6sPR7x9jNw==", "CWroz");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[41]] = aq.llIllIIlllll("E/UPq7NTsVY1MTcZeEjMXQ==", "mTqyB");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[44]] = aq.llIllIlIIIII("Tx/Girg54jnttNHD3A4PIA==", "kKAEh");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[20]] = aq.llIllIIllllI("LRUfPxBBEAI3Bw==", "atmXu");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[46]] = aq.llIllIIlllll("C6cLmWaxPEg=", "bhEGB");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[47]] = aq.llIllIlIIIII("RSBMHFCW8uE=", "tGvlu");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[48]] = aq.llIllIIllllI("Oj8uHg==", "uOKpc");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[49]] = aq.llIllIIlllll("71lNEuUphj+7VaQusSlhlA==", "wJkcY");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[51]] = aq.llIllIIllllI("Cy4ATxMqbxcDEyQ9", "EOvog");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[52]] = aq.llIllIlIIIII("lTDVDRZNxBC2vEfNmpH30w==", "qoEoL");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[14]] = aq.llIllIlIIIII("cpWGl5t62GoUgigbZsekmaeuACPT1MBb", "wtOiB");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[53]] = aq.llIllIlIIIII("nL0fvLcQlkyFBCt4V4Dq4A==", "ckyQn");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[54]] = aq.llIllIlIIIII("HHZTwby84oc=", "jYUVm");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[55]] = aq.llIllIIllllI("IhMHOQ==", "mcbWd");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[56]] = aq.llIllIIlllll("oP0XstmSgy4=", "zsbrW");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[57]] = aq.llIllIlIIIII("r+ueoYqvPbKf/o+rEtbiLw==", "lisya");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[58]] = aq.llIllIIllllI("FwkqMTs8Fix5bw==", "RqIYZ");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[59]] = aq.llIllIlIIIII("kfGm1DLDUKETT14gskVFNQ==", "AXbvc");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[60]] = aq.llIllIlIIIII("624yE0arppUrsjETN4Ifgg==", "uJrMb");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[61]] = aq.llIllIIlllll("HNQ+keFY9LMOFxPSRzXWbw==", "iBWcD");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[62]] = aq.llIllIIllllI("GhIELg==", "NsoKu");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[75]] = aq.llIllIIllllI("OwskFi4ZWTEdKgIXLAEs", "kyEoK");
        aq.lIIIIIIIII[aq.lIIIIIIIIl[77]] = aq.llIllIIllllI("FAgNFFUJB0MEEAcNFxtVTg==", "facsu");
    }
    ...
    private static void llIllIlIIIlI() {
        ...
        aq.lIIIIIIIIl[1] = (37 + 81 - -8 + 23 ^ 79 + 18 - -75 + 1) & (0xC5 ^ 0x9D ^ (0xC8 ^ 0xA8) ^ -" ".length());
        aq.lIIIIIIIIl[2] = " ".length();
        aq.lIIIIIIIIl[3] = "  ".length();
        aq.lIIIIIIIIl[4] = "   ".length();
        ...
        aq.lIIIIIIIIl[52] = "  ".length() ^ (0xBA ^ 0xAB);
        ...
        aq.lIIIIIIIIl[64] = -"   ".length() & (0xFFFFEFCF & 0x3EFE);
    ...
    public boolean ah() {
        ...
        if (aq.llIllIlIlIll(Skills.getLevel((Skill)Skill.PRAYER), lIIIIIIIIl[76])) {
            bl = lIIIIIIIIl[2];
            "".length();
            if (((0x1B ^ 0x17 ^ (0x6E ^ 0x65)) & (0x12 ^ 0x63 ^ (0x30 ^ 0x46) ^ -" ".length())) != ((16 + 105 - 86 + 160 ^ 141 + 142 - 273 + 134) & (0x7C ^ 0x4A ^ (0x3F ^ 0x5A) ^ -" ".length()))) {
                return ((72 + 3 - -52 + 54 ^ 109 + 96 - 179 + 120) & (0x39 ^ 0x27 ^ (0x10 ^ 0x29) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIIIIIIl[1];
        }
    ...
    private static boolean an() {
        ...
        block2: {
            ...
            n2 = lIIIIIIIIl[2];
            "".length();
            if (((0x83 ^ 0x9B ^ (0xA7 ^ 0x85)) & (0x2D ^ 0x38 ^ (0x53 ^ 0x7C) ^ -" ".length())) >= 0) return n2 != 0;
            return ((0x5F ^ 0x5B ^ (0x32 ^ 0x63)) & (116 + 5 - -10 + 62 ^ 20 + 58 - 6 + 76 ^ -" ".length())) != 0;
        }
        n2 = lIIIIIIIIl[1];
        return n2 != 0;
    }
