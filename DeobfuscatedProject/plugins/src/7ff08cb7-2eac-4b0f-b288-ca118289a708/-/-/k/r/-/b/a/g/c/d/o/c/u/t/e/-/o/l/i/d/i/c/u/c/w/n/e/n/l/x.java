...
implements ab {
    ...
    public int af() {
        ...
        if ("  ".length() <= 0) {
            return (0xF2 ^ 0xB9 ^ (0x39 ^ 0x4E)) & (53 + 102 - 103 + 92 ^ 151 + 21 - 169 + 169 ^ -" ".length());
        }
    ...
    private static void llIIIIIIIlll() {
        ...
        x.lllIIIllI[49] = -" ".length() & (0xFFFFDFEF & 0x2DFB);
        ...
        x.lllIIIllI[103] = "  ".length() ^ (0x97 ^ 0xAA);
        ...
        x.lllIIIllI[114] = "  ".length() ^ (0x7D ^ 0x38);
    ...
    private static boolean an() {
        ...
        while (x.llIIIIIIlIlI(lllllIlIlIIlI, ((void)lllllIlIlIIll).length)) {
            ...
            ++lllllIlIlIIlI;
            "".length();
            if ((0x3C ^ 0x4F ^ (0x4D ^ 0x3A)) > "  ".length()) continue;
            return ((0x7F ^ 0x4A ^ (0x28 ^ 8)) & (0xDC ^ 0x81 ^ (0xF9 ^ 0xB1) ^ -" ".length())) != 0;
        }
        return lllIIIllI[0];
    }
    ...
    private static void llIIIIIIIllI() {
        ...
        x.lllIIIIll[x.lllIIIllI[1]] = x.lIllllllIIll("Hx4NOSAxEgdwMSwOCj40eR4XNT4qW0MjJDADADg6NxBDMjI6HEMkPHkGFjUgLQ==", "YwcPS");
        x.lllIIIIll[x.lllIIIllI[0]] = x.lIllllllIlII("CTvfOFswhxm4FQDpV/DHdg==", "elmct");
        x.lllIIIIll[x.lllIIIllI[3]] = x.lIllllllIlII("WsrxWgbUTQ3Wq6bzKSzNQGJwedF2m8Jh", "tLXRS");
        x.lllIIIIll[x.lllIIIllI[6]] = x.lIllllllIlII("wEBcoI0NjAedTOcvTkAyg7k+YZHkxG6nlzUCoSaUAy7hLn9J1g1tPILn4x+Y8M0bVrPp2amOkGs=", "QaXly");
        x.lllIIIIll[x.lllIIIllI[4]] = x.lIllllllIIll("OShnOCILbSowIx0kKT5wHzgiKiROPjIpIAIkIip8Tj4wMCQNJS43N045KHkSOxQOFxc=", "nMGYP");
        x.lllIIIIll[x.lllIIIllI[10]] = x.lIllllllIlll("WvFKqznlDznCKbHqROqBmlvnrhwAlFdV62WmZHfr/1yTAFj+/lmUmhLym45Z0Vddgp9OldcJEJs=", "UBjDe");
        x.lllIIIIll[x.lllIIIllI[16]] = x.lIllllllIlll("JS1E5nx1Cki3V9NcsZOkv+lu/3VPAUei0ti03a8B2zmI++z3JALBLm2r+a6mygPGVdOfEIEg+IY=", "OftEg");
        x.lllIIIIll[x.lllIIIllI[11]] = x.lIllllllIIll("KggPFB8=", "nzfzt");
        x.lllIIIIll[x.lllIIIllI[22]] = x.lIllllllIIll("CjUsAz0=", "NGEmV");
        x.lllIIIIll[x.lllIIIllI[23]] = x.lIllllllIlII("5HC/FEl71Zg=", "gSPil");
        x.lllIIIIll[x.lllIIIllI[8]] = x.lIllllllIlII("lJ2cuLsXVI8=", "oiUES");
        x.lllIIIIll[x.lllIIIllI[24]] = x.lIllllllIlll("RKqBQDUfXTs=", "lhhvv");
        x.lllIIIIll[x.lllIIIllI[25]] = x.lIllllllIIll("ATAdQSYgcRgVMz0l", "OQkaR");
        x.lllIIIIll[x.lllIIIllI[26]] = x.lIllllllIIll("AxUMOiUzGA==", "GpbOI");
        x.lllIIIIll[x.lllIIIllI[30]] = x.lIllllllIlll("Y7KaLW0j9U/l8LZBN/IZYw==", "uBkfg");
        x.lllIIIIll[x.lllIIIllI[31]] = x.lIllllllIIll("HSkpGxw7", "XFAiu");
        x.lllIIIIll[x.lllIIIllI[36]] = x.lIllllllIlII("fS/piUh8JCYgwxOiL+VMIQ==", "auoao");
        x.lllIIIIll[x.lllIIIllI[37]] = x.lIllllllIIll("PgMRPhgS", "vbcQt");
        x.lllIIIIll[x.lllIIIllI[38]] = x.lIllllllIlII("4UAwa6t2nOQ=", "zujFy");
        x.lllIIIIll[x.lllIIIllI[39]] = x.lIllllllIlll("qmKvkqgr+14XA8VicExryMahWl2WXFs5", "ekTyw");
        x.lllIIIIll[x.lllIIIllI[32]] = x.lIllllllIlll("8skXzty8GhU=", "VXlgm");
        x.lllIIIIll[x.lllIIIllI[41]] = x.lIllllllIlII("0TOI7+jF8e5fmwv334VcrPh/9iV7iZtNZ1IH7/QzQM8=", "frHBM");
        x.lllIIIIll[x.lllIIIllI[45]] = x.lIllllllIlII("XPkplG4HRlc=", "MKOqg");
        x.lllIIIIll[x.lllIIIllI[46]] = x.lIllllllIlII("TV78iGmU6/4=", "gkwOu");
        x.lllIIIIll[x.lllIIIllI[21]] = x.lIllllllIlII("TunK1ZDqn+k=", "LwQeu");
        x.lllIIIIll[x.lllIIIllI[50]] = x.lIllllllIlII("wvFkVyVXvbfJU9yTMYjOcA==", "bcfTY");
        x.lllIIIIll[x.lllIIIllI[51]] = x.lIllllllIlII("1VLjOzmDu/6XbR2pZnhjNw==", "ChZdk");
        x.lllIIIIll[x.lllIIIllI[52]] = x.lIllllllIlll("sRx2dL0ijyY=", "bfDsN");
        x.lllIIIIll[x.lllIIIllI[43]] = x.lIllllllIlII("LxaAcelHQFM=", "ffetn");
        x.lllIIIIll[x.lllIIIllI[55]] = x.lIllllllIIll("IjI/IA==", "vSTEe");
        x.lllIIIIll[x.lllIIIllI[27]] = x.lIllllllIlll("rKwYP8wATCA=", "yeGWO");
        x.lllIIIIll[x.lllIIIllI[58]] = x.lIllllllIlII("YXFYqQYz+gU=", "Rnmks");
        x.lllIIIIll[x.lllIIIllI[60]] = x.lIllllllIIll("OQkKMQ==", "mhaTZ");
        x.lllIIIIll[x.lllIIIllI[62]] = x.lIllllllIlll("o1yeY2F2EUc4IW58Hq6I3g==", "EPUDU");
        x.lllIIIIll[x.lllIIIllI[63]] = x.lIllllllIlII("zTP9tIisMndWzBoiZHl3iw==", "yqvHW");
        x.lllIIIIll[x.lllIIIllI[64]] = x.lIllllllIlll("zVe9VFSo09E=", "YkZeG");
        x.lllIIIIll[x.lllIIIllI[67]] = x.lIllllllIIll("BgcHegwnRhI7Di0=", "HfqZx");
        x.lllIIIIll[x.lllIIIllI[68]] = x.lIllllllIIll("NCQOHHAyKwwLMRkmHQ==", "wExyP");
        x.lllIIIIll[x.lllIIIllI[69]] = x.lIllllllIlII("cEU7T+AVJ7k=", "TltQO");
        x.lllIIIIll[x.lllIIIllI[70]] = x.lIllllllIIll("GzEADA==", "HPbmU");
        x.lllIIIIll[x.lllIIIllI[33]] = x.lIllllllIlll("kUJNExqZOsc=", "cewQV");
        x.lllIIIIll[x.lllIIIllI[71]] = x.lIllllllIlII("0GRfWQ/0eqwXtI4nwXfAqPB6Less07qFXBe3rV2TrJ6Y5TXxbhA60/CY2zpSP4E2", "cqseF");
        x.lllIIIIll[x.lllIIIllI[72]] = x.lIllllllIlll("q36omlEJhrSp1O1CYdVWqw==", "joMFE");
        x.lllIIIIll[x.lllIIIllI[73]] = x.lIllllllIIll("KxU9GgwBFzNXDAcWIAQ=", "hyTwn");
        x.lllIIIIll[x.lllIIIllI[76]] = x.lIllllllIIll("KDsHVjkJeiUTIxwzHxE=", "fZqvM");
        x.lllIIIIll[x.lllIIIllI[77]] = x.lIllllllIIll("HhIUKhMkEA==", "JwzPz");
        x.lllIIIIll[x.lllIIIllI[78]] = x.lIllllllIIll("OiIcGgwQIBJXDBYhAQQ=", "yNuwn");
        x.lllIIIIll[x.lllIIIllI[81]] = x.lIllllllIlII("/gbDgAijT2Ag7C+DgZiFvQ==", "lOKgc");
        x.lllIIIIll[x.lllIIIllI[82]] = x.lIllllllIIll("AxsIPRgmAA==", "GnfNl");
        x.lllIIIIll[x.lllIIIllI[83]] = x.lIllllllIlll("Tkmfu31RLX9J8Tx2n5htPQ==", "qyJPs");
        x.lllIIIIll[x.lllIIIllI[20]] = x.lIllllllIIll("NychPgsHKg==", "sBOKg");
        x.lllIIIIll[x.lllIIIllI[84]] = x.lIllllllIlII("4x/lu28k/eyv9etnqgISTQ==", "LjYpY");
        x.lllIIIIll[x.lllIIIllI[85]] = x.lIllllllIlII("52Btgo7iwUA=", "JUAtw");
        x.lllIIIIll[x.lllIIIllI[86]] = x.lIllllllIlII("YvF0lJrU4JWx/cZoru8KtA==", "NNNcR");
        x.lllIIIIll[x.lllIIIllI[87]] = x.lIllllllIlII("3AVXQtO33EFcbUjVqW7Qtg==", "PvpqP");
        x.lllIIIIll[x.lllIIIllI[44]] = x.lIllllllIIll("Di8/Fzg0LQ==", "ZJQmQ");
        x.lllIIIIll[x.lllIIIllI[88]] = x.lIllllllIlII("p5IcsB6xwtPIs8dmAyBNAw==", "bZYbT");
        x.lllIIIIll[x.lllIIIllI[89]] = x.lIllllllIIll("JgQdGCgcBg==", "rasbA");
        x.lllIIIIll[x.lllIIIllI[90]] = x.lIllllllIlII("ibUPMV1hVk3EQn+AZ1nnxQ==", "vSdoH");
        x.lllIIIIll[x.lllIIIllI[93]] = x.lIllllllIlII("WG3Wq9fmMszQTTdx8V5yeA==", "MivdP");
        x.lllIIIIll[x.lllIIIllI[47]] = x.lIllllllIIll("ISIybCQAYzc4MR03", "oCDLP");
        x.lllIIIIll[x.lllIIIllI[94]] = x.lIllllllIlll("NMV4QnF3IIo=", "zQYmV");
        x.lllIIIIll[x.lllIIIllI[95]] = x.lIllllllIlII("xmX20vQYUsPr++2HgzMqHg==", "ScVRB");
        x.lllIIIIll[x.lllIIIllI[103]] = x.lIllllllIlII("90SbPShMgpgqYopFqECkBg==", "SLwdF");
        x.lllIIIIll[x.lllIIIllI[105]] = x.lIllllllIIll("Kgc3DU83CHkdCjkCLQJPcA==", "XnYjo");
        x.lllIIIIll[x.lllIIIllI[106]] = x.lIllllllIlll("rlROKkE72uEjvt28IDa/fQ==", "WIBGK");
        x.lllIIIIll[x.lllIIIllI[108]] = x.lIllllllIlll("vjWP0y0NMOUxatDvviH4WA==", "cQvsR");
        x.lllIIIIll[x.lllIIIllI[109]] = x.lIllllllIlll("MffjN4y7q82/POHvzrPl1w==", "OjaFD");
        x.lllIIIIll[x.lllIIIllI[111]] = x.lIllllllIIll("PAcYKx9PPhImEg4dHjYX", "oswEz");
        x.lllIIIIll[x.lllIIIllI[113]] = x.lIllllllIlII("ZuZY8xYeV+vIbenL5a8diQ==", "pIhIR");
        x.lllIIIIll[x.lllIIIllI[61]] = x.lIllllllIIll("CiMmCA==", "nLIzT");
        x.lllIIIIll[x.lllIIIllI[114]] = x.lIllllllIIll("DRkkKQ==", "BiAGo");
        x.lllIIIIll[x.lllIIIllI[120]] = x.lIllllllIlll("+Xg7SXDerS4=", "LrbnD");
        x.lllIIIIll[x.lllIIIllI[121]] = x.lIllllllIlII("J34hIvyBc+MhF0+YLugx2KHBnbwEJToi0fCxUQDEf2s=", "whomf");
        x.lllIIIIll[x.lllIIIllI[122]] = x.lIllllllIlII("PIn+I4NlWGrVhSWSWnYA9XiMASosRHLfPzsI7EQM1/OaQewnOjfPJEMIc+dsv5ZSUGkWFwUuVgY=", "Tdrae");
        x.lllIIIIll[x.lllIIIllI[123]] = x.lIllllllIlll("aIYD3ghX64XZjCT9zYauE7AEuG+/0OOFRuiXKpycs4Fr4Jmz9NAmuu2RDTJKkij5", "fIEEJ");
        x.lllIIIIll[x.lllIIIllI[124]] = x.lIllllllIlll("4X6CZ98PvgqI9p2Um//FAlaSog873JeKI8FOc73jUOQ=", "PdmGK");
    }
                ...
                if (x.llIIIIIlIIII(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllIlIlllII), lllIIIllI[10])) {
                    ...
                    TileItem lllllIlIllIlI = TileItems.getNearest(tileItem -> {
                        ...
                        if (x.llIIIIIlIIlI(tileItem.getId(), lllIIIllI[54]) && x.llIIIIIIlIIl(tileItem.getWorldLocation().equals((Object)new WorldPoint(lllIIIllI[112], lllIIIllI[110], lllIIIllI[1])) ? 1 : 0)) {
                            ...
                            "".length();
                            if (" ".length() == 0) {
                                return ((119 + 0 - 15 + 80 ^ 109 + 12 - 49 + 66) & (0x3D ^ 0x39 ^ (0x87 ^ 0xB1) ^ -" ".length())) != 0;
                            }
                        } else {
                            n2 = lllIIIllI[1];
                        }
                    ...
                    TileItem lllllIlIllIII = TileItems.getNearest(tileItem -> {
                        ...
                        if (x.llIIIIIlIIlI(tileItem.getId(), lllIIIllI[59]) && x.llIIIIIIlIIl(tileItem.getWorldLocation().equals((Object)new WorldPoint(lllIIIllI[48], lllIIIllI[107], lllIIIllI[1])) ? 1 : 0)) {
                            n2 = lllIIIllI[0];
                            "".length();
                            if ("   ".length() == ((124 + 167 - 250 + 137 ^ 104 + 16 - 29 + 41) & (0xA7 ^ 0xB1 ^ (0x5B ^ 0x7B) ^ -" ".length()))) {
                                return ((0x59 ^ 0x11 ^ (0xB5 ^ 0xC3)) & (9 ^ 0x49 ^ (0xD ^ 0x73) ^ -" ".length())) != 0;
                            }
                        } else {
                            n2 = lllIIIllI[1];
                        }
                    ...
                    TileItem lllllIlIlIlll = TileItems.getNearest(tileItem -> {
                        ...
                        if (x.llIIIIIlIIlI(tileItem.getId(), lllIIIllI[56]) && x.llIIIIIIlIIl(tileItem.getWorldLocation().equals((Object)new WorldPoint(lllIIIllI[48], lllIIIllI[110], lllIIIllI[1])) ? 1 : 0)) {
                            n2 = lllIIIllI[0];
                            "".length();
                            if (((0xBE ^ 0x8C) & ~(0x18 ^ 0x2A)) < -" ".length()) {
                                return ((0x57 ^ 0x52) & ~(0x94 ^ 0x91)) != 0;
                            }
                        } else {
                            n2 = lllIIIllI[1];
                        }
                        ...
                        if (x.llIIIIIIlIIl(Inventory.contains((int[])nArray17) ? 1 : 0)) {
                            ...
                            Inventory.getFirst((int[])nArray18).useOn(TileObjects.getNearest(tileObject -> {
                                ...
                                if (x.llIIIIIIlIIl(tileObject.getName().contains(lllIIIIll[lllIIIllI[109]]) ? 1 : 0) && x.llIIIIIIlIIl(tileObject.getWorldLocation().equals((Object)new WorldPoint(lllIIIllI[48], lllIIIllI[110], lllIIIllI[1])) ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (null != null) {
                                        return ((0x38 ^ 0x68 ^ (0x28 ^ 0x5C)) & (39 + 139 - 159 + 129 ^ 120 + 82 - 142 + 116 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    n2 = lllIIIllI[1];
                                }
                        ...
                        if (x.llIIIIIIlIIl(Inventory.contains((int[])nArray20) ? 1 : 0)) {
                            ...
                            Inventory.getFirst((int[])nArray21).useOn(TileObjects.getNearest(tileObject -> {
                                ...
                                if (x.llIIIIIIlIIl(tileObject.getName().contains(lllIIIIll[lllIIIllI[108]]) ? 1 : 0) && x.llIIIIIIlIIl(tileObject.getWorldLocation().equals((Object)new WorldPoint(lllIIIllI[48], lllIIIllI[49], lllIIIllI[1])) ? 1 : 0)) {
                                    n2 = lllIIIllI[0];
                                    "".length();
                                    if ("  ".length() < ((0x77 ^ 0x2F) & ~(0x49 ^ 0x11))) {
                                        return ((0x5C ^ 0x40) & ~(0x1C ^ 0)) != 0;
                                    }
                                } else {
                                    n2 = lllIIIllI[1];
                                }
                        ...
                        if (x.llIIIIIIlIIl(Inventory.contains((int[])nArray23) ? 1 : 0)) {
                            ...
                            Inventory.getFirst((int[])nArray24).useOn(TileObjects.getNearest(tileObject -> {
                                ...
                                if (x.llIIIIIIlIIl(tileObject.getName().contains(lllIIIIll[lllIIIllI[106]]) ? 1 : 0) && x.llIIIIIIlIIl(tileObject.getWorldLocation().equals((Object)new WorldPoint(lllIIIllI[48], lllIIIllI[107], lllIIIllI[1])) ? 1 : 0)) {
                                    n2 = lllIIIllI[0];
                                    "".length();
                                    if (((0x5D ^ 0x3E ^ (0x21 ^ 0x73)) & (32 + 32 - -43 + 20 ^ (0x29 ^ 0x67) ^ -" ".length())) != 0) {
                                        return ((0xC8 ^ 0xA7 ^ (0xF2 ^ 0xB9)) & (0x5C ^ 0x2B ^ (0xF6 ^ 0xA5) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    n2 = lllIIIllI[1];
                                }
