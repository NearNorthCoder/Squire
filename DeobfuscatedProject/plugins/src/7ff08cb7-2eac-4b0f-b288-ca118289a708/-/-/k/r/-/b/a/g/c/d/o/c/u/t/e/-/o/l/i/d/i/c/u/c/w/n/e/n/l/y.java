...
implements ab {
            ...
            if (y.lIlIllllIllI(Inventory.getCount((String[])stringArray2))) {
                ...
                if (y.lIlIllllIllI(Inventory.getCount((String[])stringArray3))) {
                    ...
                    if (y.lIlIllllIllI(Inventory.getCount((String[])stringArray4))) {
                        n2 = llIIlllll[1];
                        "".length();
                        if ("  ".length() > ((1 ^ 0x6E ^ (0x61 ^ 0x51)) & (0xC6 ^ 0xA5 ^ (0x17 ^ 0x2B) ^ -" ".length()))) return n2 != 0;
                        return ((197 + 107 - 115 + 20 ^ 83 + 61 - 77 + 82) & (0x56 ^ 0x7D ^ (0xFC ^ 0x93) ^ -" ".length())) != 0;
                    }
                }
            }
        }
    ...
    private static void lIlIlllIllll() {
        ...
        y.llIIllllI[y.llIIlllll[0]] = y.lIlIlllIllII("FhoVBQkzTwUYAjkc", "Tollg");
        y.llIIllllI[y.llIIlllll[1]] = y.lIlIlllIllIl("o7bjILFUfzJMEn2Cjt2A1iybKSecDQYxcKMgqKRU79TW5DV7/tITughZFVevRNPO", "TJuzB");
        y.llIIllllI[y.llIIlllll[3]] = y.lIlIlllIllIl("460ecxkI31k=", "gEaOK");
        y.llIIllllI[y.llIIlllll[5]] = y.lIlIlllIlllI("D1nW9Pn6kOY=", "fcFcx");
        y.llIIllllI[y.llIIlllll[8]] = y.lIlIlllIlllI("XgdOItJToSrmCxeqiDxkSA==", "QeQoR");
        y.llIIllllI[y.llIIlllll[9]] = y.lIlIlllIllIl("hxkoz0ktqSsVFFi+gXUpFdrEh0egzu1X", "OjMvy");
        y.llIIllllI[y.llIIlllll[15]] = y.lIlIlllIllII("IQFEOxETRAkzEAUNCj1DBxEBKRdWFxEqExoNASlPVhcTMxcVDA00BFYQC3ohIz0tFCQ=", "vddZc");
        y.llIIllllI[y.llIIlllll[18]] = y.lIlIlllIllIl("ZANpeeXxuu46nj94271G2A==", "RIiRe");
        y.llIIllllI[y.llIIlllll[19]] = y.lIlIlllIllIl("22ONn2dIATk3XLi8meY2Dw==", "VGTya");
        y.llIIllllI[y.llIIlllll[20]] = y.lIlIlllIllIl("4n3QQX2s1qcGTCbTu2FgrA==", "ztwZz");
        y.llIIllllI[y.llIIlllll[17]] = y.lIlIlllIlllI("PoDL8Vzyb8uJJJbcB3JI5w==", "WAiNq");
        y.llIIllllI[y.llIIlllll[21]] = y.lIlIlllIllII("IAY5A2cHBjsOIgM=", "tgUhG");
        y.llIIllllI[y.llIIlllll[22]] = y.lIlIlllIlllI("jqF9MEm3YXA=", "Iniuv");
        y.llIIllllI[y.llIIlllll[23]] = y.lIlIlllIlllI("tQ6iHAH7yOZDnatnbeORjw==", "EPclV");
        y.llIIllllI[y.llIIlllll[24]] = y.lIlIlllIllII("NSMSEgYeORgUAA==", "pMqzg");
        y.llIIllllI[y.llIIlllll[26]] = y.lIlIlllIllIl("Naip5Vn1soEsWQm2ZxN48Q==", "RhJto");
        y.llIIllllI[y.llIIlllll[27]] = y.lIlIlllIllII("JQghTCsWHXYBPBYd", "wiVlY");
        y.llIIllllI[y.llIIlllll[28]] = y.lIlIlllIllII("FAkuYxMuATooFSg=", "FhYCp");
        y.llIIllllI[y.llIIlllll[29]] = y.lIlIlllIllIl("jiiAB/qq+5uR3AiX6fkQMw==", "fcmbN");
        y.llIIllllI[y.llIIlllll[30]] = y.lIlIlllIllIl("jWvknBRlUrkfT4MKZezXfw==", "gInxA");
        y.llIIllllI[y.llIIlllll[31]] = y.lIlIlllIllII("EjsEIEw1OwYtCTE=", "FZhKl");
        y.llIIllllI[y.llIIlllll[32]] = y.lIlIlllIllII("Gg4hMgo+", "IoOTo");
        y.llIIllllI[y.llIIlllll[33]] = y.lIlIlllIlllI("eR0Y1pPx8tf7n3wnQt6p+g==", "HhQCe");
        y.llIIllllI[y.llIIlllll[34]] = y.lIlIlllIlllI("LmZPUC8neBBGdQlaowNAbQ==", "FeInO");
        y.llIIllllI[y.llIIlllll[35]] = y.lIlIlllIlllI("gs/FCfgD7DZt+XjezHUMiw==", "aMCtJ");
        y.llIIllllI[y.llIIlllll[36]] = y.lIlIlllIllII("BwswORksETY1WCAAMiM=", "BeSQx");
        y.llIIllllI[y.llIIlllll[37]] = y.lIlIlllIllIl("QN2YrAHM3lzzvibgV0Go3bwrf/pa//lt", "QBCLi");
        y.llIIllllI[y.llIIlllll[38]] = y.lIlIlllIllII("BCotMQwvMCs9TTMlOg==", "ADNYm");
        y.llIIllllI[y.llIIlllll[39]] = y.lIlIlllIllII("IwkuHywIEygTbQQCKBE=", "fgMwM");
        y.llIIllllI[y.llIIlllll[40]] = y.lIlIlllIlllI("uRXrDMqA7JByoeG/oIz5Vg==", "nvohC");
        y.llIIllllI[y.llIIlllll[41]] = y.lIlIlllIllIl("tuZpshfvIb6z9Ve5tKsIkg==", "CFrvH");
        y.llIIllllI[y.llIIlllll[42]] = y.lIlIlllIllII("JggUUSYRCBFRKREIFw==", "ticqD");
        y.llIIllllI[y.llIIlllll[43]] = y.lIlIlllIllII("ECYucwIjM3k+FSMz", "BGYSp");
        y.llIIllllI[y.llIIlllll[52]] = y.lIlIlllIlllI("kMwoaucKEwSVcoqA8yp1iXgmJ2+I+pfo", "CYHua");
        y.llIIllllI[y.llIIlllll[53]] = y.lIlIlllIllII("JjAMP2c7P0IvIjU1FjBnfA==", "TYbXG");
        y.llIIllllI[y.llIIlllll[60]] = y.lIlIlllIllII("HEIuUgM7RTAXCycGK1IFM0UiUhsgADAGRA==", "UeCrj");
        y.llIIllllI[y.llIIlllll[61]] = y.lIlIlllIllII("IB0EKlZPP0UkEwMaRScIFlYEPR5PHgA/CkE=", "oveSz");
        y.llIIllllI[y.llIIlllll[62]] = y.lIlIlllIllIl("P52xmBxIQoM=", "AhdgH");
        y.llIIllllI[y.llIIlllll[63]] = y.lIlIlllIllIl("cn/WvuFBKTifr3n9dyQ4593UMRu3WDO1LXzdqC4WzZFwW+0BQoOWmNi00HEb1iovomK1tHHgcM0=", "cNvLM");
        y.llIIllllI[y.llIIlllll[64]] = y.lIlIlllIllII("LTJFbgtFNQVuJg15HSYjFnkdJicMdw==", "bYiNB");
    }
    ...
    private static void lIlIllllIIII() {
        ...
        y.llIIlllll[0] = (58 + 115 - 101 + 85 ^ 4 + 180 - 117 + 115) & (26 + 54 - -51 + 21 ^ 44 + 29 - 8 + 114 ^ -" ".length());
        y.llIIlllll[1] = " ".length();
        y.llIIlllll[2] = 0xA4 ^ 0xC3 ^ (0x48 ^ 0x1D);
        y.llIIlllll[3] = "  ".length();
        y.llIIlllll[4] = 0xFFFF8D7B & 0x73FF;
        y.llIIlllll[5] = "   ".length();
