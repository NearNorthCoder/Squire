...
extends Script {
    ...
    private static void lIllIIIIlIlI() {
        ...
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[4]] = AccBuilderGWD.lIllIIIIIlll("ltEDUF3hxerz9sFP8a2SgYllXsxTjOqTNv9xUIeRuz5rI420aed7Q07t5UfGxabtkgQmxTNzm+rGcqdmiSREec8ukfLl73IDdYQCIkjOk2wiXtAjBCjAa8ujBWyCbntDNtuVHOS5oax2Gcktl7zJ+KNqb/Ks9EqU1lUSq9Y1bwc=", "usYSa");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[5]] = AccBuilderGWD.lIllIIIIlIII("PyM2CSY=", "NVSzR");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[9]] = AccBuilderGWD.lIllIIIIlIIl("aeXUIlCbf1seJespf7msuVnP8G2/hx0O", "HPzPs");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[10]] = AccBuilderGWD.lIllIIIIlIII("KAgQESUHHQ8WJUYdCVgFIw==", "fifxB");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[11]] = AccBuilderGWD.lIllIIIIlIIl("HTuYW+VJkf6x/aFPBaDtr2/NRdAO7KFV", "VVZoW");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[13]] = AccBuilderGWD.lIllIIIIIlll("l+4X+bGJ6YX9Lro7YQOhUNsiOvn3KPPm5284+pMd3Zw=", "RKcew");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[14]] = AccBuilderGWD.lIllIIIIlIII("ESQVWQ8VMA==", "vSqyn");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[15]] = AccBuilderGWD.lIllIIIIlIIl("zM1WYGyMUFlwxxZ7eAooz4Fmiyks613daKitrcP7clE=", "rcdwx");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[16]] = AccBuilderGWD.lIllIIIIlIII("KyAOIDAqKAkgMzE=", "COaTV");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[17]] = AccBuilderGWD.lIllIIIIlIII("FhcHJisWHQ==", "syfDG");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[18]] = AccBuilderGWD.lIllIIIIIlll("mtSx4jk8DuM=", "Ypjyk");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[19]] = AccBuilderGWD.lIllIIIIlIIl("bbcVMsdXsv2qI82z2wSh24VJrlWV7DRIieq28FAlCMY=", "oXxmB");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[23]] = AccBuilderGWD.lIllIIIIlIIl("qGuMxDuS41bhzslD7ibXbQ==", "olqTK");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[24]] = AccBuilderGWD.lIllIIIIlIIl("7ZhxnxuUQng1eUuS+Wf1XDHreJLghEZe", "OnDLp");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[25]] = AccBuilderGWD.lIllIIIIlIII("KEo4DB1pCTocDw==", "IjVij");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[26]] = AccBuilderGWD.lIllIIIIlIIl("EXAdjyxv1Db23ecTVFAYK66iYmCqIZuy", "LQiWJ");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[27]] = AccBuilderGWD.lIllIIIIlIII("OjMgET8yNm4EN3c1KwR4OituAzc5", "WRNpX");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[32]] = AccBuilderGWD.lIllIIIIlIIl("W8FPvMxyPspAVE4S8rn0HA==", "muKqp");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[33]] = AccBuilderGWD.lIllIIIIIlll("ZAL+gjf0MZHfrQ3/b4xAd1ofyvnq7og+", "WPRpo");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[34]] = AccBuilderGWD.lIllIIIIlIII("NhwCO2YRVBAgLAdUFCotDlkEOiAQEAYrYRERAD0kFlQCIzMLEws7", "btcOA");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[20]] = AccBuilderGWD.lIllIIIIIlll("m3XeC2OAep9RF6fyte1WQ6qHu7Fde33D0b02ud9PP+ehJypBYrdbVQ==", "lUZWR");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[35]] = AccBuilderGWD.lIllIIIIlIIl("9dsC4YybNUy/uikhG6+sstfYvLEreNK+", "piBkd");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[36]] = AccBuilderGWD.lIllIIIIlIII("IQQdWgYBBBwdC08MBhYHTw0GCEMNHhATDQg=", "okizc");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[37]] = AccBuilderGWD.lIllIIIIIlll("OxVinlUo/b8LF9l1/Y0OvFVHc+ojErw0", "RZjzH");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[38]] = AccBuilderGWD.lIllIIIIlIIl("iQU8Aa7t5wIHtfCs+YHyUA==", "jPwmV");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[39]] = AccBuilderGWD.lIllIIIIlIIl("tgbxO8m0fuXiUr2jFgOHOeb+kS4A59PdzBF0Pi9tSLjP48Oh2hwZfXWobOwcGw0pAZmPDdQAgN6ZzbOMhttek77eDlXHNhee9Z06tH6nGb43nbojCiYl8w==", "cqPHE");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[40]] = AccBuilderGWD.lIllIIIIIlll("DVDsdyd1/+17aliBZx25t57ZoNrOXW52wX1GP/BX4C6fC5Eo3X8yCx88MjKoPyLvirHr2IlREP5nvOTQahRPEECXGIiSTKBeqfte+GNGrbqSNstFxQjw++M4eV84D5Glojr8rBIHhLFly+6D5Yj125jwNPEooEO4MC+jjIkSKw0=", "PobMX");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[30]] = AccBuilderGWD.lIllIIIIlIIl("O6ff/IgO39UyZU4FSNUhdjPZOEf9zr0w", "GYmSB");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[41]] = AccBuilderGWD.lIllIIIIlIII("PD0mKA==", "xRIZc");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[42]] = AccBuilderGWD.lIllIIIIlIII("MAIfMw==", "tmpAT");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[43]] = AccBuilderGWD.lIllIIIIIlll("GVPOIJyKxlE=", "zeKRT");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[44]] = AccBuilderGWD.lIllIIIIlIII("BxwuFVEXASQC", "SnKpq");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[45]] = AccBuilderGWD.lIllIIIIIlll("ZdXY28yFHfoJ5JS3LZgYIw==", "tJQtt");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[31]] = AccBuilderGWD.lIllIIIIlIIl("6GSpAg1oi+g=", "cOSka");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[46]] = AccBuilderGWD.lIllIIIIIlll("wSLplUTw/3JfXKY9U24org0OuOm/DSdn", "oxySO");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[49]] = AccBuilderGWD.lIllIIIIIlll("DB+Uhi+WGmgx6bsXSgHKtyJdRZ2FV5ir", "rrbXR");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[51]] = AccBuilderGWD.lIllIIIIlIII("PT8oKQ==", "yMGYs");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[52]] = AccBuilderGWD.lIllIIIIIlll("OUpEnhvHCdk=", "bpnhH");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[53]] = AccBuilderGWD.lIllIIIIlIII("OBo5GS8UCA==", "zoKwF");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[54]] = AccBuilderGWD.lIllIIIIIlll("VqIA7O4Fy/I=", "YjFuO");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[55]] = AccBuilderGWD.lIllIIIIlIII("AgUnCyE=", "VwHgM");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[56]] = AccBuilderGWD.lIllIIIIIlll("WucLkSih1Zw=", "cVLbM");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[57]] = AccBuilderGWD.lIllIIIIlIIl("4mgm6b+A6/NSXIb2tbeVVg==", "pwxeK");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[58]] = AccBuilderGWD.lIllIIIIIlll("fS9FKHmNgHw=", "ohUgh");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[59]] = AccBuilderGWD.lIllIIIIlIIl("pGKavzMO5TI=", "iRaGu");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[60]] = AccBuilderGWD.lIllIIIIlIIl("tiyXIy15270=", "lATyq");
        AccBuilderGWD.llIlIIIlI[AccBuilderGWD.llIlIIIll[61]] = AccBuilderGWD.lIllIIIIlIIl("erh5UQ55DM0=", "NuOAs");
    ...
    private static void lIllIIIIlIll() {
        ...
        AccBuilderGWD.llIlIIIll[4] = (89 + 94 - 89 + 40 ^ 95 + 3 - 97 + 185) & (0x42 ^ 0x1D ^ (0x67 ^ 4) ^ -" ".length());
        AccBuilderGWD.llIlIIIll[5] = " ".length();
        ...
        AccBuilderGWD.llIlIIIll[9] = "  ".length();
        AccBuilderGWD.llIlIIIll[10] = "   ".length();
        ...
        block10: {
            block11: {
                ...
                while (AccBuilderGWD.lIllIIIlIIII(-.-.k.r.-.b.a.g.c.d.o.c.u.t.e.-.o.l.i.d.i.c.u.c.w.n.e.n.l.e.z() ? 1 : 0) && AccBuilderGWD.lIllIIIIllIl(d ? 1 : 0) && AccBuilderGWD.lIllIIIlIIIl(-.-.k.r.-.b.a.g.c.d.o.c.u.t.e.-.o.l.i.d.i.c.u.c.w.n.e.n.l.e.j(llIlIIIll[7]), llIlIIIll[8]) && AccBuilderGWD.lIllIIIIllIl(Dialog.isOpen() ? 1 : 0)) {
                    ...
                    return (0x28 ^ 0x7E ^ (0x51 ^ 0x41)) & (231 + 248 - 417 + 188 ^ 77 + 6 - -2 + 103 ^ -" ".length());
                }
    ...
    public boolean a(int n2, int n3, Player player) {
        ...
        if (AccBuilderGWD.lIllIIIlIlIl(n5, n6) && AccBuilderGWD.lIllIIIlIIll(n5, n7)) {
            ...
            "".length();
            if (null != null) {
                return ((150 + 51 - 183 + 154 ^ 120 + 60 - 66 + 56) & (0x4B ^ 0x24 ^ (0xDB ^ 0xB2) ^ -" ".length())) != 0;
            }
        } else {
            n4 = llIlIIIll[4];
        }
    ...
    public void a(GameTick gameTick) {
            ...
            block16: {
                ...
                Player player3 = Players.getNearest(player2 -> {
                    ...
                    if (AccBuilderGWD.lIllIIIlIlll(player2, player) && AccBuilderGWD.lIllIIIlIIII(this.a(n2, n3, (Player)player2) ? 1 : 0)) {
                        ...
                        "".length();
                        if ("  ".length() <= -" ".length()) {
                            return ((0xBE ^ 0xB7 ^ (0xE ^ 0x19)) & (99 + 25 - -23 + 70 ^ 6 + 73 - -38 + 82 ^ -" ".length())) != 0;
                        }
                    } else {
                        n4 = llIlIIIll[4];
                    }
        ...
        if (AccBuilderGWD.lIllIIIIlllI(lIIllIlllllllI = NPCs.getNearest(nPC -> {
            ...
            if (!(AccBuilderGWD.lIllIIIIllIl(nPC.getName().contains(llIlIIIlI[llIlIIIll[54]]) ? 1 : 0) && AccBuilderGWD.lIllIIIIllIl(nPC.getName().contains(llIlIIIlI[llIlIIIll[55]]) ? 1 : 0) && AccBuilderGWD.lIllIIIIllIl(nPC.getName().contains(llIlIIIlI[llIlIIIll[56]]) ? 1 : 0) && AccBuilderGWD.lIllIIIIllIl(nPC.getName().contains(llIlIIIlI[llIlIIIll[57]]) ? 1 : 0) && AccBuilderGWD.lIllIIIIllIl(nPC.getName().contains(llIlIIIlI[llIlIIIll[58]]) ? 1 : 0) && AccBuilderGWD.lIllIIIIllIl(nPC.getName().contains(llIlIIIlI[llIlIIIll[59]]) ? 1 : 0) && !AccBuilderGWD.lIllIIIlIIII(nPC.getName().contains(llIlIIIlI[llIlIIIll[60]]) ? 1 : 0) || !AccBuilderGWD.lIllIIIIllIl(lIIllIlllIlIII.getName().contains(llIlIIIlI[llIlIIIll[61]]) ? 1 : 0) || AccBuilderGWD.lIllIIIIllIl(L.ga.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && AccBuilderGWD.lIllIIIIllIl(L.gb.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && !AccBuilderGWD.lIllIIIlIIII(L.gc.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !AccBuilderGWD.lIllIIIlIIll(lIIllIlllIlIII.getWorldLocation().distanceTo(Players.getLocal().getWorldLocation()), llIlIIIll[10]))) {
                ...
                "".length();
                if (" ".length() <= 0) {
                    return ((0x7D ^ 0x47 ^ (0x4B ^ 0x68)) & (0x52 ^ 0x25 ^ (0x2F ^ 0x41) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIlIIIll[4];
            }
