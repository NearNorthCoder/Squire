...
implements M {
    ...
    private static boolean S() {
        ...
        if (L.lIlIlIIIIIllIll(Inventory.contains((String[])stringArray) ? 1 : 0)) {
            ...
            if (L.lIlIlIIIIIllIll(Inventory.contains((int[])nArray) ? 1 : 0)) {
                n2 = lIIlIIIIllIlI[1];
                "".length();
                if (((81 + 100 - 123 + 70 ^ 43 + 110 - 149 + 152) & (0xD3 ^ 0x93 ^ (0xF ^ 0x53) ^ -" ".length())) >= 0) return n2 != 0;
                return ((0xE6 ^ 0xC2 ^ (0x10 ^ 0x54)) & (0xA3 ^ 0x82 ^ (0xEE ^ 0xAF) ^ -" ".length())) != 0;
            }
        }
        n2 = lIIlIIIIllIlI[0];
        return n2 != 0;
    ...
    private static void lIlIlIIIIIllIII() {
        ...
        L.lIIlIIIIllIlI[0] = (0xBE ^ 0x8B ^ (0x6B ^ 0x4F)) & (0x53 ^ 0x1E ^ (0x32 ^ 0x6E) ^ -" ".length());
        L.lIIlIIIIllIlI[1] = " ".length();
        L.lIIlIIIIllIlI[2] = 213 + 86 - 278 + 221 ^ 1 + 138 - 67 + 108;
        L.lIIlIIIIllIlI[3] = "  ".length();
        L.lIIlIIIIllIlI[4] = -(0xFFFFDE9F & 0x35E1) & (0xFFFF95FB & Short.MAX_VALUE);
        L.lIIlIIIIllIlI[5] = "   ".length();
    ...
    private static void lIlIlIIIIIlIlll() {
        ...
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[0]] = L.lIlIlIIIIIlIlII("sUp5OCEJTJ7FXyanj/Lw5g==", "gnaEv");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[1]] = L.lIlIlIIIIIlIlIl("Lx7EhZVotRnlxaimJ0Rrir+xOR0Cch+LoBW9Yy4dnaixtC/Xa2qSFLw7szduBISS", "BixFB");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[3]] = L.lIlIlIIIIIlIlII("QwcwJXUPCOI=", "iBlnB");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[5]] = L.lIlIlIIIIIlIllI("Ly86", "jNNBi");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[6]] = L.lIlIlIIIIIlIlII("ljdekk1+MFoaIA7vbzAADQ==", "PyhLG");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[7]] = L.lIlIlIIIIIlIlII("61rJfX+Zr+LNCUhZ9neBDfYv4y3mrXVh", "ulmxD");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[9]] = L.lIlIlIIIIIlIllI("MjRLExEAcQYbEBY4BRVDFCQOARdFIh4CEwk4DgFPRSIcGxcGOQIcBEUlBFIhMAgiPCQ=", "eQkrc");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[17]] = L.lIlIlIIIIIlIlIl("/iNMrwWwwlC5C7J8KLwINg==", "SQiYH");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[18]] = L.lIlIlIIIIIlIllI("Hj4/LAU2Mz9pGScz", "WPKIw");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[19]] = L.lIlIlIIIIIlIlII("tHBvijxN4/g=", "YdQUW");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[15]] = L.lIlIlIIIIIlIllI("JCQOAQ==", "rAarB");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[20]] = L.lIlIlIIIIIlIlIl("i+0CYOotAju3wG/rf4f/oQ==", "lpeQN");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[21]] = L.lIlIlIIIIIlIlIl("2gmHJqmaFL8=", "JRJtM");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[22]] = L.lIlIlIIIIIlIllI("PjE4Aw==", "iTYqY");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[23]] = L.lIlIlIIIIIlIllI("ICYVdzoBZwc+KU52", "nGcWN");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[24]] = L.lIlIlIIIIIlIllI("BgEMBTU=", "UqmaP");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[25]] = L.lIlIlIIIIIlIllI("IAcf", "dnxkN");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[26]] = L.lIlIlIIIIIlIllI("LzQhZzAOdTMuI0Fn", "aUWGD");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[27]] = L.lIlIlIIIIIlIlII("/O1Pj1EUGaY=", "DPCQE");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[28]] = L.lIlIlIIIIIlIlIl("pxVbwsraSI0=", "GHwUr");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[29]] = L.lIlIlIIIIIlIllI("IDMlSTMBcjcAIE5h", "nRSiG");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[30]] = L.lIlIlIIIIIlIlII("zA5WcAiTV9c=", "EWFXh");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[31]] = L.lIlIlIIIIIlIllI("Lzgq", "kQMvy");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[32]] = L.lIlIlIIIIIlIllI("IyQlTxkCZTcGCk1x", "mESom");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[33]] = L.lIlIlIIIIIlIlII("e81fe6QbxM8=", "qEzZk");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[34]] = L.lIlIlIIIIIlIlII("pCsxbhEZ32o=", "vWIGl");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[35]] = L.lIlIlIIIIIlIlIl("aDoF0S2pyDVRDZdD3bkHn+7Su2rI2ET2", "eGBKd");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[36]] = L.lIlIlIIIIIlIllI("EQIOFDc5Dw5RKygP", "XlzqE");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[37]] = L.lIlIlIIIIIlIlII("Bkj7FtL15uI=", "boLGf");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[40]] = L.lIlIlIIIIIlIlIl("DfrpWvTnTvhgtM2f+b7/+Q==", "XzUSJ");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[41]] = L.lIlIlIIIIIlIllI("Mw07", "axYqk");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[42]] = L.lIlIlIIIIIlIlIl("xkOU5gciAWQ5ZXrHU6PDbBaJHa54h3kd", "jnZHZ");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[43]] = L.lIlIlIIIIIlIlIl("z1HPHxM0Yc4=", "PCnKJ");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[44]] = L.lIlIlIIIIIlIlII("52/BIQycTqM=", "zEZzi");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[45]] = L.lIlIlIIIIIlIlIl("N6BAIJ28QD4=", "JlaRX");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[55]] = L.lIlIlIIIIIlIlII("a6cRihFdEHkpA0/Ivkn6iqNWxf7FBAHr", "LEhgf");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[56]] = L.lIlIlIIIIIlIlIl("fruU5XJDgI+Z0wZKrbFUJh+65BZCtH3X", "VJXHV");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[57]] = L.lIlIlIIIIIlIlIl("dBaA+57KCXQ=", "XakPh");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[58]] = L.lIlIlIIIIIlIllI("GCYZOwwH", "oCxWx");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[59]] = L.lIlIlIIIIIlIlII("e0Yj8jjGgiQ=", "PkIDs");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[53]] = L.lIlIlIIIIIlIlII("Rny+veKKKvA=", "PJOvI");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[60]] = L.lIlIlIIIIIlIlII("j0Qwqu6jYJo=", "uIGXo");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[61]] = L.lIlIlIIIIIlIllI("CC4YOjY=", "oBwHO");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[62]] = L.lIlIlIIIIIlIllI("ChhJTxhiHkUaIWUVCh1xJB1FDjUzFgsbJDcWSw==", "EseoQ");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[63]] = L.lIlIlIIIIIlIlII("+JTSHf2sTmdxm5qlVuQteQOxu/8llHhFIOjElAor6TEaSlTEEQvdpA==", "jgPEZ");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[64]] = L.lIlIlIIIIIlIlII("EitF7ZG4Oc3lZfLKKh0XdJ9BusuH428K", "lAgAc");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[65]] = L.lIlIlIIIIIlIllI("Fig0Wg==", "OMGta");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[66]] = L.lIlIlIIIIIlIlIl("ZPD1dRgfWRUekXuH0rvYtkcVbyj3Wg94IxjMSUSH2jE=", "vgovb");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[67]] = L.lIlIlIIIIIlIlIl("6wYDvTvbbi/P71+qJWeP4zMWV3H2dmx6", "PcAai");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[68]] = L.lIlIlIIIIIlIllI("EjEDOgsmcDY3HDEzHHIdMT4DcgMxcAM9TiAxGzlOID9XKwEhfg==", "TPwRn");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[69]] = L.lIlIlIIIIIlIllI("IjRXFmMNPgRFIko2GAowHnEYBDYEJRkLJEo5GRZjDSMREyYTMAIBbQ==", "jQpeC");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[70]] = L.lIlIlIIIIIlIlII("NC5HjffmuRv0D1pgrVJHgmQQ8rlZ4deQ+8D9CnJAS3+d2Q6RGzq6Zw==", "ZGPBx");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[71]] = L.lIlIlIIIIIlIlIl("hicx4omZwt0=", "GIWdL");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[72]] = L.lIlIlIIIIIlIlII("xrdeimi4keQe9WF01pBREYDa2dcnh5pE7q4PjlhxQlQgaQ0OM8Nekg==", "NVcoz");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[73]] = L.lIlIlIIIIIlIlII("Sir7rF07XEoGqcWGoWM2qA==", "neUiv");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[48]] = L.lIlIlIIIIIlIlIl("UtOHOiFMfOK7ZzRM4WdaxA==", "GZciv");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[74]] = L.lIlIlIIIIIlIlIl("e74XPehSv9t2tgFrXLzBBjbhk+wwX28iKOXqyd/xg4U=", "pXrQr");
        L.lIIlIIIIllIIl[L.lIIlIIIIllIlI[75]] = L.lIlIlIIIIIlIlIl("uCBkjFKcmFZUcKXwaY8gcg==", "LkrhR");
    }
    ...
    public boolean aa() {
        ...
        if (L.lIlIlIIIIlIIlII(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()), lIIlIIIIllIlI[18])) {
            ...
            if (L.lIlIlIIIIIlllIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                n2 = lIIlIIIIllIlI[1];
                "".length();
                if (((0x6A ^ 0x3A ^ (0x43 ^ 0x21)) & (0xB1 ^ 0xAA ^ (0x9C ^ 0xB5) ^ -" ".length())) < (100 + 128 - 142 + 48 ^ 43 + 20 - 35 + 102)) return n2 != 0;
                return ((0x42 ^ 0x39 ^ (0xCC ^ 0xA7)) & (0x4C ^ 0x36 ^ (0x1B ^ 0x71) ^ -" ".length()) & ((52 + 83 - 64 + 118 ^ 117 + 143 - 132 + 53) & (0xF9 ^ 0xC0 ^ (0xAA ^ 0x9B) ^ -" ".length()) ^ -" ".length())) != 0;
            }
        }
        n2 = lIIlIIIIllIlI[0];
        return n2 != 0;
        ...
        if (L.lIlIlIIIIIlllIl(by ? 1 : 0)) {
            block49: {
                ...
                do {
                    ...
                    "".length();
                    "".length();
                } while ((0x72 ^ 0x61 ^ (0xD0 ^ 0xC7)) > " ".length());
                return;
            }
