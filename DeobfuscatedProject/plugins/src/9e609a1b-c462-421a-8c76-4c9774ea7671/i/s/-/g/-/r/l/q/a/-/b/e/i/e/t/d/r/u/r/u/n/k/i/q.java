...
implements M {
    ...
    private static void lIlIIlIIIIllIII() {
        ...
        q.lIIIlllIlIIII[5] = " ".length();
        q.lIIIlllIlIIII[6] = "  ".length();
    ...
    private static String lIlIIlIIIIlIllI(String lllllllllllllllIIIIIlIlllIlllIll, String lllllllllllllllIIIIIlIlllIlllIlI) {
        ...
        while (q.lIlIIlIIIIllIll(lllllllllllllllIIIIIlIlllIlIllll, lllllllllllllllIIIIIlIlllIllIIII)) {
            ...
            "".length();
            if (((0xCE ^ 0x93) & ~(0xCA ^ 0x97)) != "   ".length()) continue;
            return null;
        }
    ...
    private static void lIlIIlIIIIlIlll() {
        ...
        q.lIIIlllIIllll[q.lIIIlllIlIIII[4]] = q.lIlIIlIIIIlIlII("2yB82wMTr52T2k3lWXbOWd5lSYx3rxhDt8qVWEhEpgxTlYlBDdV0vEYlRcHI2x4E", "nAJym");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[5]] = q.lIlIIlIIIIlIlIl("jMVbViPiF1997qBdMTdRTw==", "HKlQW");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[6]] = q.lIlIIlIIIIlIlIl("FAmxMGnpWkg2B5NkIP3qoQ==", "iVKET");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[11]] = q.lIlIIlIIIIlIllI("ORU6KwsYGjNvBRAaPyYJFg==", "qtTOg");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[12]] = q.lIlIIlIIIIlIlIl("83qllTn2o5gF0H6vpp3c+uPrK29VDJCncwxVPy7gZmv0kZR3Lfq22IqLoeuFlIsGpFgezSjvQdA=", "CLfLX");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[19]] = q.lIlIIlIIIIlIlII("g5PmN4j4sPg=", "rKYFP");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[21]] = q.lIlIIlIIIIlIlII("Icer5mZ4bBA=", "LLtkj");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[23]] = q.lIlIIlIIIIlIlII("AWvKGGPVru+yG5DoXtvrxg==", "jHxfg");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[13]] = q.lIlIIlIIIIlIlIl("GEHXf3iTGWVWeXsgc7ibhA==", "ZSyYL");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[32]] = q.lIlIIlIIIIlIllI("JBAvGyEE", "syCwN");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[25]] = q.lIlIIlIIIIlIllI("DRUhJCogFiNjJi4VPQ==", "AzOCB");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[35]] = q.lIlIIlIIIIlIlIl("k0TaP58koGQ=", "eqraD");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[36]] = q.lIlIIlIIIIlIlII("iYCKUxcTjMySwr4dJTJZKQ==", "ZNkJK");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[37]] = q.lIlIIlIIIIlIlIl("dCqVG/I0+vI=", "staKB");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[38]] = q.lIlIIlIIIIlIlII("BBL2REtZt3O0zGPtbyUplA==", "rQInG");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[34]] = q.lIlIIlIIIIlIlIl("aBW3h+pVxSw=", "puKWH");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[9]] = q.lIlIIlIIIIlIlII("8JWYdGHzVFiY+R3xM8358w==", "JffCf");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[51]] = q.lIlIIlIIIIlIllI("AQYZATkjDg==", "QckgV");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[52]] = q.lIlIIlIIIIlIlIl("Y6Pp+PQtRj0=", "PEodP");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[53]] = q.lIlIIlIIIIlIlIl("MdPN5EYUK3A=", "uAzGy");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[55]] = q.lIlIIlIIIIlIlII("hggfFb0mcSkWfOMrYNurYw==", "EiKAD");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[57]] = q.lIlIIlIIIIlIllI("CQY4FR8kBTpSEyoGJA==", "EiVrw");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[58]] = q.lIlIIlIIIIlIllI("KjY8CQ==", "eFYgP");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[31]] = q.lIlIIlIIIIlIlIl("tNH9qsX+GMg/PtO+QTVGXQ==", "xkydr");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[59]] = q.lIlIIlIIIIlIllI("CRwWOA==", "FlsVj");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[60]] = q.lIlIIlIIIIlIlIl("J4RaPrVwZrR+menFJd8fZw==", "JuqJJ");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[61]] = q.lIlIIlIIIIlIlII("ICZ8eaasCmU=", "uJvqS");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[62]] = q.lIlIIlIIIIlIlII("clh9Pj6S+3k=", "wHZjc");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[63]] = q.lIlIIlIIIIlIllI("PRIGCA==", "IsjcF");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[64]] = q.lIlIIlIIIIlIllI("BzUfKQQ=", "FAsHw");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[66]] = q.lIlIIlIIIIlIlIl("Bj5UJsLILJCOJesvn0Q5CA==", "EJlYm");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[7]] = q.lIlIIlIIIIlIllI("By8dHQ==", "SNqvB");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[67]] = q.lIlIIlIIIIlIllI("CSk1IRc9", "DHGMr");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[68]] = q.lIlIIlIIIIlIlII("dO0rbmwElaSQtlPcZQRrFQ==", "sZEID");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[69]] = q.lIlIIlIIIIlIllI("FxEDHQ==", "cpovd");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[70]] = q.lIlIIlIIIIlIlII("vReEiZphSJg=", "sAUzS");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[71]] = q.lIlIIlIIIIlIlII("6QtgMweV8p4do+wkGHd8pQ==", "MudgA");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[72]] = q.lIlIIlIIIIlIlIl("BNkNJ2eX/NA=", "yzcyN");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[73]] = q.lIlIIlIIIIlIlIl("caRvpNZn/bA=", "ashAJ");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[74]] = q.lIlIIlIIIIlIlII("gvCbnAuRMzGKs7vPlFCtTg==", "inXwE");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[50]] = q.lIlIIlIIIIlIlII("JcyGh4Tx5J5njWWfmaPH1g==", "CVOdl");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[75]] = q.lIlIIlIIIIlIlIl("DfhGfnlSISU=", "tQClp");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[76]] = q.lIlIIlIIIIlIlIl("xzD6tPPctOA=", "TckIb");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[77]] = q.lIlIIlIIIIlIlIl("Bse3q3HSsfqWV9W1QGAHYA==", "SHqWj");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[78]] = q.lIlIIlIIIIlIllI("CzEKAR8mIg==", "IDxok");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[79]] = q.lIlIIlIIIIlIlIl("/8udYHIqk9EGQdGA+Q8VcQ==", "PxWrr");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[80]] = q.lIlIIlIIIIlIlII("ymdV18HEZl0rxoxnUrZnjg==", "IGFhq");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[81]] = q.lIlIIlIIIIlIlII("3JuEKDjquck=", "zTMcm");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[82]] = q.lIlIIlIIIIlIlII("NO8LnVOl/W0=", "VsWay");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[83]] = q.lIlIIlIIIIlIlIl("k9bJu/Tj1ZROoOqFkZ38IQ==", "CLUql");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[30]] = q.lIlIIlIIIIlIllI("IgALHA==", "oieyI");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[84]] = q.lIlIIlIIIIlIllI("DxIS", "Jsfhw");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[86]] = q.lIlIIlIIIIlIllI("EykZD3YzI1UcNzU+Ggk9", "GLujV");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[87]] = q.lIlIIlIIIIlIlIl("LdIVd3KijxE=", "BdElp");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[94]] = q.lIlIIlIIIIlIlII("Q/t+srzTSa1Uj6oTuBup6LP+AJfKcO4x", "GpQEM");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[95]] = q.lIlIIlIIIIlIllI("Ny4jEFYqIW0AEyQrOR9WbQ==", "EGMwv");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[96]] = q.lIlIIlIIIIlIlIl("BxyesAcsZGs=", "dnjAW");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[97]] = q.lIlIIlIIIIlIlII("pBx3NslI2X0=", "JYlQd");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[115]] = q.lIlIIlIIIIlIlIl("cZ+ZbZiGgl0=", "Ruxls");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[116]] = q.lIlIIlIIIIlIllI("L2gwOzRGPyg0IwM6LjQgRiEhej4JPWA+ZwQtZzslCi1nLihGJSYxIkYlInomRhszPyYNaDQ7KQI/LjkvWQ==", "fHGZG");
        q.lIIIlllIIllll[q.lIIIlllIlIIII[117]] = q.lIlIIlIIIIlIllI("JS41L3Y=", "wAVDX");
    }
                ...
                if (q.lIlIIlIIIIlllll(lllllllllllllllIIIIIlIlllllIlllI = TileObjects.getNearest(tileObject -> {
                    ...
                    if (q.lIlIIlIIIIllIlI(tileObject.getName().contains(lIIIlllIIllll[lIIIlllIlIIII[96]]) ? 1 : 0)) {
                        ...
                        if (q.lIlIIlIIIIllIlI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                            ...
                            return ((175 + 77 - 61 + 40 ^ 33 + 21 - -83 + 45) & (3 ^ 0x59 ^ (0x5E ^ 0x55) ^ -" ".length())) != 0;
                        }
                    }
                    n2 = lIIIlllIlIIII[4];
                    return n2 != 0;
