...
implements M {
    ...
    private static String lIlIIlIIllIIIll(String lllllllllllllllIIIIIlIIlIIIlllII, String lllllllllllllllIIIIIlIIlIIIllIll) {
        lllllllllllllllIIIIIlIIlIIIlllII = new String(Base64.getDecoder().decode(lllllllllllllllIIIIIlIIlIIIlllII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIIIIlIIlIIIlllll = new StringBuilder();
        char[] lllllllllllllllIIIIIlIIlIIIllllI = lllllllllllllllIIIIIlIIlIIIllIll.toCharArray();
        int lllllllllllllllIIIIIlIIlIIIlllIl = lIIIlllIlllII[1];
        char[] lllllllllllllllIIIIIlIIlIIIlIlll = lllllllllllllllIIIIIlIIlIIIlllII.toCharArray();
        int lllllllllllllllIIIIIlIIlIIIlIllI = lllllllllllllllIIIIIlIIlIIIlIlll.length;
        int lllllllllllllllIIIIIlIIlIIIlIlIl = lIIIlllIlllII[1];
        while (A.lIlIIlIIllllIII(lllllllllllllllIIIIIlIIlIIIlIlIl, lllllllllllllllIIIIIlIIlIIIlIllI)) {
            char lllllllllllllllIIIIIlIIlIIlIIIlI = lllllllllllllllIIIIIlIIlIIIlIlll[lllllllllllllllIIIIIlIIlIIIlIlIl];
            lllllllllllllllIIIIIlIIlIIIlllll.append((char)(lllllllllllllllIIIIIlIIlIIlIIIlI ^ lllllllllllllllIIIIIlIIlIIIllllI[lllllllllllllllIIIIIlIIlIIIlllIl % lllllllllllllllIIIIIlIIlIIIllllI.length]));
            "".length();
            ++lllllllllllllllIIIIIlIIlIIIlllIl;
            ++lllllllllllllllIIIIIlIIlIIIlIlIl;
            "".length();
    ...
    private static String lIlIIlIIllIIlIl(String lllllllllllllllIIIIIlIIlIIllllII, String lllllllllllllllIIIIIlIIlIIllllIl) {
        try {
            ...
            Cipher lllllllllllllllIIIIIlIIlIlIIIIII = Cipher.getInstance("DES");
            lllllllllllllllIIIIIlIIlIlIIIIII.init(lIIIlllIlllII[6], lllllllllllllllIIIIIlIIlIlIIIIIl);
            return new String(lllllllllllllllIIIIIlIIlIlIIIIII.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIIlIIlIIllllII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIlIIlIIlllIlIl() {
        ...
        A.lIIIlllIlllII[98] = -"  ".length() & (0xFFFFEBF7 & 0x1FBD);
    ...
    public static void cc() {
        ...
        if (A.lIlIIlIIllllIIl(by ? 1 : 0)) {
            BankLocation lllllllllllllllIIIIIlIIlIlIIllll;
            ...
            if (A.lIlIIlIIllllIIl(A.S() ? 1 : 0) && A.lIlIIlIIllllIlI(e.j(lIIIlllIlllII[2]), lIIIlllIlllII[3]) && A.lIlIIlIIllllIII(e.j(lIIIlllIlllII[4]), lIIIlllIlllII[0])) {
                lllllllllllllllIIIIIlIIlIlIIllll = BankLocation.getNearest();
                if (A.lIlIIlIIllllIll(lllllllllllllllIIIIIlIIlIlIIllll) && A.lIlIIlIIllllIIl(lllllllllllllllIIIIIlIIlIlIIllll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderRat.c = lIIIlllIllIIl[lIIIlllIlllII[0]];
                    a.a(lllllllllllllllIIIIIlIIlIlIIllll);
                }
                if (A.lIlIIlIIllllIll(lllllllllllllllIIIIIlIIlIlIIllll) && A.lIlIIlIIlllIlll(lllllllllllllllIIIIIlIIlIlIIllll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (A.lIlIIlIIlllIlll(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    ...
                    if (A.lIlIIlIIllllIIl(Inventory.contains((String[])stringArray2) ? 1 : 0)) {
                        ...
                        if (A.lIlIIlIIlllllll(Players.getLocal().getWorldLocation().distanceTo(gr), lIIIlllIlllII[9])) {
                            ...
                            lllllllllllllllIIIIIlIIlIlIIllll = new WorldArea(lIIIlllIlllII[38], lIIIlllIlllII[39], lIIIlllIlllII[21], lIIIlllIlllII[7], lIIIlllIlllII[6]);
                            String[] stringArray3 = new String[lIIIlllIlllII[0]];
                            stringArray3[A.lIIIlllIlllII[1]] = lIIIlllIllIIl[lIIIlllIlllII[40]];
                            NPC lllllllllllllllIIIIIlIIlIlIIlllI = NPCs.getNearest((String[])stringArray3);
                            if (A.lIlIIlIIllllIll(lllllllllllllllIIIIIlIIlIlIIlllI) && A.lIlIIlIIlllIlll(lllllllllllllllIIIIIlIIlIlIIllll.contains(lllllllllllllllIIIIIlIIlIlIIlllI.getWorldLocation()) ? 1 : 0)) {
                                e.C();
                            }
                            int[] nArray = new int[lIIIlllIlllII[0]];
                            nArray[A.lIIIlllIlllII[1]] = lIIIlllIlllII[41];
                            TileObject lllllllllllllllIIIIIlIIlIlIIllIl = TileObjects.getNearest((int[])nArray);
                            if (A.lIlIIlIIllllIll(lllllllllllllllIIIIIlIIlIlIIllIl)) {
                                String[] stringArray4 = new String[lIIIlllIlllII[0]];
                                stringArray4[A.lIIIlllIlllII[1]] = lIIIlllIllIIl[lIIIlllIlllII[42]];
                                if (A.lIlIIlIIlllIlll(lllllllllllllllIIIIIlIIlIlIIllIl.hasAction(stringArray4) ? 1 : 0)) {
                                    lllllllllllllllIIIIIlIIlIlIIllIl.interact(lIIIlllIllIIl[lIIIlllIlllII[43]]);
                                    Time.sleepTicks((int)lIIIlllIlllII[6]);
                                    "".length();
                                }
                            }
                            ...
                            TileObject lllllllllllllllIIIIIlIIlIlIIllII = TileObjects.getNearest((int[])nArray8);
                            if (A.lIlIIlIIllllIll(lllllllllllllllIIIIIlIIlIlIIllII)) {
                                String[] stringArray5 = new String[lIIIlllIlllII[0]];
                                stringArray5[A.lIIIlllIlllII[1]] = lIIIlllIllIIl[lIIIlllIlllII[45]];
                                if (A.lIlIIlIIlllIlll(lllllllllllllllIIIIIlIIlIlIIllII.hasAction(stringArray5) ? 1 : 0)) {
                                    lllllllllllllllIIIIIlIIlIlIIllII.interact(lIIIlllIllIIl[lIIIlllIlllII[46]]);
                                    Time.sleepTicks((int)lIIIlllIlllII[6]);
                                    "".length();
                                    if (A.lIlIIlIIlllIlll(Dialog.isOpen() ? 1 : 0)) {
    ...
    private static void lIlIIlIIlllIIIl() {
        ...
        A.lIIIlllIllIIl[A.lIIIlllIlllII[1]] = A.lIlIIlIIllIIIll("MDAsBgYePCZPFwMgKwESVjA2ChgFdWIcAh8tIQccGD5iDRQVMmIbGlYoNwoGAg==", "vYBou");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[0]] = A.lIlIIlIIllIIlII("aKJN4qDwnfFmFMGHd6Q5JA==", "UuFPv");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[6]] = A.lIlIIlIIllIIIll("KzEDKDoKPgpsNAI+BiU4BA==", "cPmLV");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[9]] = A.lIlIIlIIllIIIll("Gx1YDzUpWBUHND8RFglnPQ0dHTNsCw0eNyARHR1rbAsPBzMvEBEAIGwMF04FGSExIAA=", "LxxnG");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[7]] = A.lIlIIlIIllIIlII("AeFzuyokRNP8R+INHSUZ+XUsfdR0eeP2KReiYzjPB72e2y7R7VQ/6ruFYIdIwuaxKpIq90V/68M=", "VrxZG");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[15]] = A.lIlIIlIIllIIlII("y86bem+MYgU=", "ALyve");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[17]] = A.lIlIIlIIllIIlIl("+nta1/Dsf4E=", "gVUVZ");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[10]] = A.lIlIIlIIllIIlII("RFCHE75vYQneL8yNOENkhA==", "KJxiH");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[21]] = A.lIlIIlIIllIIlII("1FxAtLdhTee3YhPsWkneew==", "iWbiN");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[22]] = A.lIlIIlIIllIIlIl("RjzJHKta/zM=", "CSCnt");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[19]] = A.lIlIIlIIllIIIll("HAMTSx89QgkCCSADFxJLNRcc", "Rbekk");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[23]] = A.lIlIIlIIllIIIll("JAoCCGEEBE4PKBIZDxE4UAwbGg==", "pkncA");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[24]] = A.lIlIIlIIllIIlIl("8ihvJWLQnjg=", "KZxOU");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[25]] = A.lIlIIlIIllIIlII("UN9cQS4t2rjjvtP5U1VMlw==", "yGaZw");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[26]] = A.lIlIIlIIllIIlIl("/xS7QTNYPJDXtOMR0IxWWQ==", "wKXLi");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[27]] = A.lIlIIlIIllIIlII("/q/AjfpG+Mc=", "JhKwu");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[28]] = A.lIlIIlIIllIIlII("n8xliqnM2eq0+4kFTNaP/Q==", "hcyFx");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[29]] = A.lIlIIlIIllIIIll("DzMqCVowNScH", "BZDlz");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[30]] = A.lIlIIlIIllIIIll("GwgnPA==", "VaIYC");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[31]] = A.lIlIIlIIllIIlIl("9XfTKnfLuK2hfpf6DLgjYQ==", "GFMBL");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[32]] = A.lIlIIlIIllIIIll("EiwEE2M1PB0RMSM=", "FMhxC");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[33]] = A.lIlIIlIIllIIlIl("non0canFTp4=", "mwayl");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[34]] = A.lIlIIlIIllIIlII("Ut+AEwepjEg7k8BQBO+YjQ==", "QQOtA");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[35]] = A.lIlIIlIIllIIlIl("zx++swPVsWIlhkqA9TMDEw==", "ValcD");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[36]] = A.lIlIIlIIllIIlIl("mxnhkrsxwKTfLA7+9OyiRw==", "sJAyh");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[37]] = A.lIlIIlIIllIIlIl("ZVKZGcIlCUJi2p6LCIFO4yqsaOtX8iyv", "XeOra");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[40]] = A.lIlIIlIIllIIIll("ABMech4qDAU8", "SzlRH");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[42]] = A.lIlIIlIIllIIlII("/IY63v8cNBY=", "UMGkP");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[43]] = A.lIlIIlIIllIIlII("BRAsf9iqtzk=", "QSZiX");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[45]] = A.lIlIIlIIllIIlIl("uvxncasmEvc=", "hBfSs");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[46]] = A.lIlIIlIIllIIlIl("9VEapMAFuDY=", "WSbwf");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[2]] = A.lIlIIlIIllIIlIl("1ZV8+DPq7QimH7Dhb2YYLw==", "tBWVB");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[47]] = A.lIlIIlIIllIIlII("Cnlm1etAsl1hxd2X7YcdTg==", "IlETh");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[48]] = A.lIlIIlIIllIIlIl("eTv4RmiyRFzGp2T/XYozeg==", "TunFv");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[49]] = A.lIlIIlIIllIIlII("nY2OdsbDjII62SDTelu5sA==", "EkwEI");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[50]] = A.lIlIIlIIllIIlIl("t2BX86gbVq8=", "ukYuS");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[51]] = A.lIlIIlIIllIIlIl("x0p4+FGCE6px31lHzTX0Gg==", "QiOXu");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[52]] = A.lIlIIlIIllIIlIl("dFQ/kMKFGDKV+hu7TmDuxQ==", "Bgidp");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[53]] = A.lIlIIlIIllIIlIl("joYiYzFD/J7vNt2DYA2Q/w==", "ojiMF");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[54]] = A.lIlIIlIIllIIIll("GAUEG2Q4C0g0Ew02Lg==", "LdhpD");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[55]] = A.lIlIIlIIllIIlII("/7dtOzuEvvQ=", "JyGHI");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[56]] = A.lIlIIlIIllIIIll("Jh8WMy8QFkMyMQsBBw==", "dscAF");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[57]] = A.lIlIIlIIllIIlII("wd7FvWDXzi5VvcMl9cIaaA==", "LfsGc");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[58]] = A.lIlIIlIIllIIlIl("NXEHIsKtyToQxjnpRUTHlw==", "CvPxD");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[59]] = A.lIlIIlIIllIIlII("RpzgsszEXWo=", "PlKZR");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[64]] = A.lIlIIlIIllIIlII("Jqm0ufaZtqTxu3kpL8fssQ==", "AMPuN");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[65]] = A.lIlIIlIIllIIlII("EngKIGvOwJCK6SJ5m0cjRPZTxsrmuGJ0", "wvjHv");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[78]] = A.lIlIIlIIllIIlII("aBgF0JnkJ0zJzeN2nXAHMX0uDcLD8VUiEi3l9fa5IKo=", "KKEFy");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[79]] = A.lIlIIlIIllIIlII("UlRj9TxkfuJlknfI3y1zPOwYqIj/aiYA/hN+ibNK24I44jDhRcbyNw==", "MhRfG");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[80]] = A.lIlIIlIIllIIlIl("j2Ly14jVqZPRqNUEE836fYD63+KWJJfT4avlD+1cgX8thJmZX1EE5kxl4hbv4scP", "qJkgb");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[20]] = A.lIlIIlIIllIIlIl("llyEdv4lPPOBdPp8Op2PLNrbURP6YUTs", "LuBoA");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[81]] = A.lIlIIlIIllIIIll("GCMwPXQrJHEwOzprOic7OGswKzs6P3E9PCprGCQ3LiU1JnQrPDA7Iio4bg==", "OKQIT");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[82]] = A.lIlIIlIIllIIIll("HAYoFxYnACsVQioFNhdM", "OiErb");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[83]] = A.lIlIIlIIllIIlIl("O4i27uRLzL2aWVKglpsWkWLC7JfmdtPHWRooBAvBvls=", "BDugp");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[84]] = A.lIlIIlIIllIIIll("ChgcdBUmDFI5DSIcUjVMOgkXNwUoFVInGyYLFnQKJgtSOQl2", "IyrTl");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[85]] = A.lIlIIlIIllIIlII("mB3Vu1+lhf43mbpguZBhuKPtPhOyAyRS", "vSlBg");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[86]] = A.lIlIIlIIllIIlIl("LjiH+6PKBHEIPBz0E2sCFSIEZp0EuN1fZfeTd2Ao/bTj3CQVpF1MqkSdq9cGFipD", "ZIOkS");
        A.lIIIlllIllIIl[A.lIIIlllIlllII[87]] = A.lIlIIlIIllIIlIl("L09zGAB6dxs=", "rtqBh");
    }
    ...
    public boolean aa() {
        ...
        if (A.lIlIIlIlIIIIIIl(e.j(lIIIlllIlllII[4]), lIIIlllIlllII[10])) {
            bl = lIIIlllIlllII[0];
            "".length();
            if (" ".length() <= ((0x77 ^ 0x65) & ~(0x5C ^ 0x4E))) {
                return ((0xA9 ^ 0x88) & ~(0x13 ^ 0x32)) != 0;
            }
        } else {
            bl = lIIIlllIlllII[1];
        }
    ...
    private static void W() {
        d lllllllllllllllIIIIIlIIlIlIIlIII;
        Object lllllllllllllllIIIIIlIIlIlIIlIIl;
        block11: {
            block10: {
                int[] nArray = new int[lIIIlllIlllII[0]];
                ...
                if (A.lIlIIlIIllllIIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
                    lllllllllllllllIIIIIlIIlIlIIlIIl = new d(lIIIlllIlllII[13], lIIIlllIlllII[0], h.bv);
                    bA.add((d)lllllllllllllllIIIIIlIIlIlIIlIIl);
                    "".length();
                }
                int[] nArray3 = new int[lIIIlllIlllII[0]];
                nArray3[A.lIIIlllIlllII[1]] = lIIIlllIlllII[8];
            ...
            lllllllllllllllIIIIIlIIlIlIIlIIl = new d(lIIIlllIlllII[8], lIIIlllIlllII[6], h.bv);
            bA.add((d)lllllllllllllllIIIIIlIIlIlIIlIIl);
            "".length();
        }
        int[] nArray = new int[lIIIlllIlllII[0]];
        ...
        if (A.lIlIIlIIllllIIl(Bank.contains((int[])nArray) ? 1 : 0)) {
            lllllllllllllllIIIIIlIIlIlIIlIIl = new d(lIIIlllIlllII[14], lIIIlllIlllII[0], h.bv);
            bA.add((d)lllllllllllllllIIIIIlIIlIlIIlIIl);
            "".length();
        }
        int[] nArray6 = new int[lIIIlllIlllII[0]];
        ...
        if (A.lIlIIlIIllllIIl(Bank.contains((int[])nArray6) ? 1 : 0)) {
            lllllllllllllllIIIIIlIIlIlIIlIIl = new d(lIIIlllIlllII[16], lIIIlllIlllII[27], lIIIlllIlllII[60]);
            bA.add((d)lllllllllllllllIIIIIlIIlIlIIlIIl);
            "".length();
        }
        int[] nArray7 = new int[lIIIlllIlllII[0]];
        ...
        if (A.lIlIIlIIllllIIl(Bank.contains((int[])nArray7) ? 1 : 0)) {
            lllllllllllllllIIIIIlIIlIlIIlIIl = new d(lIIIlllIlllII[12], lIIIlllIlllII[19], lIIIlllIlllII[61]);
            bA.add((d)lllllllllllllllIIIIIlIIlIlIIlIIl);
            "".length();
        }
        if (A.lIlIIlIIllllIIl(Bank.contains((Predicate)(lllllllllllllllIIIIIlIIlIlIIlIIl = item -> item.getName().toLowerCase().contains(lIIIlllIllIIl[lIIIlllIlllII[65]]))) ? 1 : 0)) {
            lllllllllllllllIIIIIlIIlIlIIlIII = new d(lIIIlllIlllII[62], lIIIlllIlllII[15], lIIIlllIlllII[63]);
            bA.add(lllllllllllllllIIIIIlIIlIlIIlIII);
            "".length();
        }
        int[] nArray8 = new int[lIIIlllIlllII[0]];
        nArray8[A.lIIIlllIlllII[1]] = lIIIlllIlllII[11];
        if (A.lIlIIlIIllllIIl(Bank.contains((int[])nArray8) ? 1 : 0)) {
            lllllllllllllllIIIIIlIIlIlIIlIII = new d(lIIIlllIlllII[11], lIIIlllIlllII[55], lIIIlllIlllII[61]);
            bA.add(lllllllllllllllIIIIIlIIlIlIIlIII);
            "".length();
        }
    }
    ...
    private static String lIlIIlIIllIIlII(String lllllllllllllllIIIIIlIIlIIlIllll, String lllllllllllllllIIIIIlIIlIIlIlllI) {
        try {
            SecretKeySpec lllllllllllllllIIIIIlIIlIIllIlII = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIIIIlIIlIIlIlllI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIIIIIlIIlIIllIIll = Cipher.getInstance("Blowfish");
            lllllllllllllllIIIIIlIIlIIllIIll.init(lIIIlllIlllII[6], lllllllllllllllIIIIIlIIlIIllIlII);
            return new String(lllllllllllllllIIIIIlIIlIIllIIll.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIIlIIlIIlIllll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
