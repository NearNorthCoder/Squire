...
implements M {
    ...
    private static void lIlIIlIIlIlIlll() {
        ...
        O.lIIIlllIlIlll[O.lIIIlllIllIII[1]] = O.lIlIIlIIlIlIlII("71/XSdo8lSmKtFAnSREoNQ==", "FiNQM");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[2]] = O.lIlIIlIIlIlIlII("Ea45MbUTHNnl7y/pybhrtYjnynIejyWSZJObhyXcQBJ/VnCoRUQ5L8Sez8h/aJwt", "iCEXR");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[3]] = O.lIlIIlIIlIlIlIl("Z4l17L/s9EF701HDsz7GnbymP2q1MnQL", "Fuzuc");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[4]] = O.lIlIIlIIlIlIllI("EAgnJScxBy5hKTkHIiglPw==", "XiIAK");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[6]] = O.lIlIIlIIlIlIllI("Ei1MAyMgaAELIjYhAgVxNToNGzQ3aB8XITUkBQciaWgfFTgxKwQLPyJoGA1xBx01Kx8C", "EHlbQ");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[13]] = O.lIlIIlIIlIlIllI("Big6Ixo=", "BZSMq");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[15]] = O.lIlIIlIIlIlIllI("GhUtAkI6H2EQCyIUOA==", "NpAgb");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[17]] = O.lIlIIlIIlIlIlIl("JN3SRwL76JE=", "bdeUy");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[18]] = O.lIlIIlIIlIlIlII("YxPhrUL6TIPv4RgaDsQrUQ==", "jEOYZ");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[19]] = O.lIlIIlIIlIlIlIl("ZSpRmuwhKJNgGCc4CaZoBhFsxH0+BomZLkg93I0D51FlPjMMimoR0g==", "IWCdQ");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[21]] = O.lIlIIlIIlIlIllI("PCY8agYdZysmBhM1", "rGJJr");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[41]] = O.lIlIIlIIlIlIllI("aUsEOSszSwAiKSE=", "XkpPH");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[44]] = O.lIlIIlIIlIlIlIl("A0HPq7TZhInsmKDT7EfSOw==", "XJTBW");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[20]] = O.lIlIIlIIlIlIllI("GRk0LyB1HCknNw==", "UxFHE");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[46]] = O.lIlIIlIIlIlIlIl("9UVuQwKzNYI=", "GVnib");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[47]] = O.lIlIIlIIlIlIlIl("3N9RKccfKzM=", "BRmJj");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[48]] = O.lIlIIlIIlIlIllI("DQEkKQ==", "BqAGV");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[49]] = O.lIlIIlIIlIlIlII("JdSzpe53ZvJFyJjVuVmCng==", "IKaqL");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[51]] = O.lIlIIlIIlIlIllI("HyMkcjE+YjM+MTAw", "QBRRE");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[52]] = O.lIlIIlIIlIlIllI("ECggCzUsKClEIyooKxc=", "EFNdA");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[14]] = O.lIlIIlIIlIlIlII("lICHCDNxCdOqfYEmUyM+S2Kf2Js6Y6+A", "ibcwV");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[53]] = O.lIlIIlIIlIlIlII("f1wz3J9BKa/DoZy2vWXG4w==", "SYtui");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[54]] = O.lIlIIlIIlIlIlIl("bWpQAgzTYrY=", "cFoSu");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[55]] = O.lIlIIlIIlIlIllI("FQYqIw==", "ZvOMO");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[56]] = O.lIlIIlIIlIlIllI("FjEDHA==", "YAfrC");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[57]] = O.lIlIIlIIlIlIlII("H9Ta2iVXgxlrLAL5cFaCWw==", "mjegA");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[58]] = O.lIlIIlIIlIlIllI("LTUXIiYGKhFqcg==", "hMtJG");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[59]] = O.lIlIIlIIlIlIlIl("onOc07lvfxZvF+Rtf6zcpA==", "jDhhn");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[60]] = O.lIlIIlIIlIlIlII("0rlm2MHGT+0b3rBHnvpg/A==", "dVlJY");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[61]] = O.lIlIIlIIlIlIllI("AzsvME47NGEvDzk9MzQF", "TRAUn");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[62]] = O.lIlIIlIIlIlIlIl("PbfxPvH0Ppc=", "jtojw");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[75]] = O.lIlIIlIIlIlIllI("BwQkLw8lVjEkCz4YLDgN", "WvEVj");
        O.lIIIlllIlIlll[O.lIIIlllIllIII[77]] = O.lIlIIlIIlIlIllI("HBM3BWUBHHkVIA8WLQplRg==", "nzYbE");
    }
    ...
    private static boolean S() {
        ...
        block2: {
            ...
            n2 = lIIIlllIllIII[2];
            "".length();
            if ((0x96 ^ 0x92) > "  ".length()) return n2 != 0;
            return ((0x41 ^ 0x67) & ~(0x20 ^ 6)) != 0;
        }
        n2 = lIIIlllIllIII[1];
        return n2 != 0;
    }
    ...
    private static String lIlIIlIIlIlIlIl(String lllllllllllllllIIIIIlIlIIIlIIIIl, String lllllllllllllllIIIIIlIlIIIlIIIII) {
        try {
            SecretKeySpec lllllllllllllllIIIIIlIlIIIlIIlII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIIIIlIlIIIlIIIII.getBytes(StandardCharsets.UTF_8)), lIIIlllIllIII[18]), "DES");
            Cipher lllllllllllllllIIIIIlIlIIIlIIIll = Cipher.getInstance("DES");
            lllllllllllllllIIIIIlIlIIIlIIIll.init(lIIIlllIllIII[3], lllllllllllllllIIIIIlIlIIIlIIlII);
            return new String(lllllllllllllllIIIIIlIlIIIlIIIll.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIIlIlIIIlIIIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlIIlIIlIlIllI(String lllllllllllllllIIIIIlIlIIIllIllI, String lllllllllllllllIIIIIlIlIIIllIlIl) {
        lllllllllllllllIIIIIlIlIIIllIllI = new String(Base64.getDecoder().decode(lllllllllllllllIIIIIlIlIIIllIllI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIIIIlIlIIIllIlII = new StringBuilder();
        ...
        char[] lllllllllllllllIIIIIlIlIIIlIllII = lllllllllllllllIIIIIlIlIIIllIllI.toCharArray();
        int lllllllllllllllIIIIIlIlIIIlIlIll = lllllllllllllllIIIIIlIlIIIlIllII.length;
        int lllllllllllllllIIIIIlIlIIIlIlIlI = lIIIlllIllIII[1];
        while (O.lIlIIlIIlIllIlI(lllllllllllllllIIIIIlIlIIIlIlIlI, lllllllllllllllIIIIIlIlIIIlIlIll)) {
            char lllllllllllllllIIIIIlIlIIIllIlll = lllllllllllllllIIIIIlIlIIIlIllII[lllllllllllllllIIIIIlIlIIIlIlIlI];
            lllllllllllllllIIIIIlIlIIIllIlII.append((char)(lllllllllllllllIIIIIlIlIIIllIlll ^ lllllllllllllllIIIIIlIlIIIllIIll[lllllllllllllllIIIIIlIlIIIllIIlI % lllllllllllllllIIIIIlIlIIIllIIll.length]));
            "".length();
            ++lllllllllllllllIIIIIlIlIIIllIIlI;
            ++lllllllllllllllIIIIIlIlIIIlIlIlI;
            "".length();
            if (-" ".length() >= -" ".length()) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllIIIIIlIlIIIllIlII);
    }
    ...
    private static void W() {
        d lllllllllllllllIIIIIlIlIIlIlIlII;
        Object lllllllllllllllIIIIIlIlIIlIlIlIl;
        int[] nArray = new int[lIIIlllIllIII[2]];
        ...
        if (O.lIlIIlIIlIllIll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lllllllllllllllIIIIIlIlIIlIlIlIl = new d(lIIIlllIllIII[0], O.cM(), lIIIlllIllIII[63]);
            bA.add((d)lllllllllllllllIIIIIlIlIIlIlIlIl);
            "".length();
        }
        int[] nArray3 = new int[lIIIlllIllIII[2]];
        nArray3[O.lIIIlllIllIII[1]] = lIIIlllIllIII[7];
        if (O.lIlIIlIIlIllIll(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllIIIIIlIlIIlIlIlIl = new d(lIIIlllIllIII[7], lIIIlllIllIII[3], lIIIlllIllIII[5]);
            bA.add((d)lllllllllllllllIIIIIlIlIIlIlIlIl);
            "".length();
        }
        if (O.lIlIIlIIlIllIll(Bank.contains((Predicate)(lllllllllllllllIIIIIlIlIIlIlIlIl = item -> item.getName().toLowerCase().contains(lIIIlllIlIlll[lIIIlllIllIII[77]]))) ? 1 : 0)) {
            lllllllllllllllIIIIIlIlIIlIlIlII = new d(lIIIlllIllIII[64], lIIIlllIllIII[13], lIIIlllIllIII[65]);
            bA.add(lllllllllllllllIIIIIlIlIIlIlIlII);
            "".length();
        }
        int[] nArray4 = new int[lIIIlllIllIII[2]];
        nArray4[O.lIIIlllIllIII[1]] = lIIIlllIllIII[66];
        if (O.lIlIIlIIlIllIll(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllIIIIIlIlIIlIlIlII = new d(lIIIlllIllIII[66], lIIIlllIllIII[67], lIIIlllIllIII[68]);
            bA.add(lllllllllllllllIIIIIlIlIIlIlIlII);
            "".length();
        }
    }
    ...
    public static void cL() {
        block44: {
            TileItem lllllllllllllllIIIIIlIlIIlIllIll;
            block45: {
                ...
                if (O.lIlIIlIIlIllIll(O.S() ? 1 : 0) && O.lIlIIlIIlIllIlI(Game.getWildyLevel(), lIIIlllIllIII[2])) {
                    lllllllllllllllIIIIIlIlIIlIllIll = BankLocation.getNearest();
                    if (O.lIlIIlIIlIlllII(lllllllllllllllIIIIIlIlIIlIllIll) && O.lIlIIlIIlIllIll(lllllllllllllllIIIIIlIlIIlIllIll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderRat.c = lIIIlllIlIlll[lIIIlllIllIII[3]];
                        a.a((BankLocation)lllllllllllllllIIIIIlIlIIlIllIll);
                    }
                    if (O.lIlIIlIIlIlllII(lllllllllllllllIIIIIlIlIIlIllIll) && O.lIlIIlIIlIllIIl(lllllllllllllllIIIIIlIlIIlIllIll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (O.lIlIIlIIlIllIIl(O.S() ? 1 : 0)) {
                    ...
                    if (O.lIlIIlIIlIlllIl(Game.getWildyLevel())) {
                        TileObject lllllllllllllllIIIIIlIlIIlIllIlI;
                        int[] nArray = new int[lIIIlllIllIII[2]];
                        ...
                        if (O.lIlIIlIIlIllIIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            if (O.lIlIIlIIlIllllI(Players.getLocal().getWorldLocation().distanceTo(in), lIIIlllIllIII[20])) {
                                ...
                                lllllllllllllllIIIIIlIlIIlIllIll = tileItem;
                                Walker.walkAlong(Arrays.asList(lllllllllllllllIIIIIlIlIIlIllIll), new HashMap());
                                "".length();
                                Time.sleepTicks((int)lIIIlllIllIII[2]);
                                "".length();
                            }
                            if (O.lIlIIlIIllIIIII(Players.getLocal().getWorldLocation().distanceTo(in), lIIIlllIllIII[20])) {
                                ...
                                lllllllllllllllIIIIIlIlIIlIllIll = TileObjects.getNearest((String[])stringArray);
                                String[] stringArray2 = new String[lIIIlllIllIII[2]];
                                stringArray2[O.lIIIlllIllIII[1]] = lIIIlllIlIlll[lIIIlllIllIII[20]];
                                lllllllllllllllIIIIIlIlIIlIllIlI = TileObjects.getNearest((String[])stringArray2);
                                String[] stringArray3 = new String[lIIIlllIllIII[2]];
                                stringArray3[O.lIIIlllIllIII[1]] = lIIIlllIlIlll[lIIIlllIllIII[46]];
                                if (O.lIlIIlIIlIllIIl(lllllllllllllllIIIIIlIlIIlIllIlI.hasAction(stringArray3) ? 1 : 0)) {
                                    lllllllllllllllIIIIIlIlIIlIllIlI.interact(lIIIlllIlIlll[lIIIlllIllIII[47]]);
                                }
                                if (O.lIlIIlIIlIlllII(lllllllllllllllIIIIIlIlIIlIllIll)) {
                                    String[] stringArray4 = new String[lIIIlllIllIII[2]];
                                    stringArray4[O.lIIIlllIllIII[1]] = lIIIlllIlIlll[lIIIlllIllIII[48]];
                                    if (O.lIlIIlIIlIllIll(lllllllllllllllIIIIIlIlIIlIllIlI.hasAction(stringArray4) ? 1 : 0)) {
                                        int lllllllllllllllIIIIIlIlIIlIllIIl = Skills.getExperience((Skill)Skill.PRAYER);
                                        int[] nArray3 = new int[lIIIlllIllIII[2]];
                                        nArray3[O.lIIIlllIllIII[1]] = lIIIlllIllIII[0];
                        ...
                        if (O.lIlIIlIIlIllIll(Inventory.contains((int[])nArray4) ? 1 : 0)) {
                            ...
                            if (O.lIlIIlIIlIllIIl(Inventory.contains((int[])nArray5) ? 1 : 0)) {
                                if (O.lIlIIlIIlIllllI(Players.getLocal().getWorldLocation().distanceTo(in), lIIIlllIllIII[20])) {
                                    ...
                                    lllllllllllllllIIIIIlIlIIlIllIll = worldPointArray;
                                    Walker.walkAlong(Arrays.asList(lllllllllllllllIIIIIlIlIIlIllIll), new HashMap());
                                    "".length();
                                    Time.sleepTicks((int)lIIIlllIllIII[2]);
                                    "".length();
                                ...
                                if (O.lIlIIlIIllIIIII(Players.getLocal().getWorldLocation().distanceTo(in), lIIIlllIllIII[20])) {
                                    ...
                                    lllllllllllllllIIIIIlIlIIlIllIll = NPCs.getNearest((String[])stringArray);
                                    String[] stringArray6 = new String[lIIIlllIllIII[2]];
                                    stringArray6[O.lIIIlllIllIII[1]] = lIIIlllIlIlll[lIIIlllIllIII[53]];
                                    lllllllllllllllIIIIIlIlIIlIllIlI = TileObjects.getNearest((String[])stringArray6);
                                    String[] stringArray7 = new String[lIIIlllIllIII[2]];
                                    stringArray7[O.lIIIlllIllIII[1]] = lIIIlllIlIlll[lIIIlllIllIII[54]];
                                    if (O.lIlIIlIIlIllIIl(lllllllllllllllIIIIIlIlIIlIllIlI.hasAction(stringArray7) ? 1 : 0)) {
                                        lllllllllllllllIIIIIlIlIIlIllIlI.interact(lIIIlllIlIlll[lIIIlllIllIII[55]]);
                                    }
                                    if (O.lIlIIlIIlIlllII(lllllllllllllllIIIIIlIlIIlIllIll)) {
                                        String[] stringArray8 = new String[lIIIlllIllIII[2]];
                                        stringArray8[O.lIIIlllIllIII[1]] = lIIIlllIlIlll[lIIIlllIllIII[56]];
                                        if (O.lIlIIlIIlIllIll(lllllllllllllllIIIIIlIlIIlIllIlI.hasAction(stringArray8) ? 1 : 0)) {
                                            List lllllllllllllllIIIIIlIlIIlIllIIl;
                                            if (O.lIlIIlIIlIllIll(Dialog.isOpen() ? 1 : 0)) {
                                                int[] nArray6 = new int[lIIIlllIllIII[2]];
                                                nArray6[O.lIIIlllIllIII[1]] = lIIIlllIllIII[50];
                                                Inventory.getFirst((int[])nArray6).useOn((Actor)lllllllllllllllIIIIIlIlIIlIllIll);
                                                Time.sleepTicks((int)lIIIlllIllIII[3]);
                                                "".length();
                                            }
                                            if (O.lIlIIlIIlIllIIl(Dialog.isOpen() ? 1 : 0) && O.lIlIIlIIlIllIll((lllllllllllllllIIIIIlIlIIlIllIIl = Dialog.getOptions()).isEmpty() ? 1 : 0)) {
                                                int lllllllllllllllIIIIIlIlIIlIllIII = lIIIlllIllIII[1];
                                                while (O.lIlIIlIIlIllIlI(lllllllllllllllIIIIIlIlIIlIllIII, lllllllllllllllIIIIIlIlIIlIllIIl.size())) {
                                                    int[] nArray7 = new int[lIIIlllIllIII[2]];
                                                    nArray7[O.lIIIlllIllIII[1]] = lIIIlllIllIII[50];
                                                    if (O.lIlIIlIIlIlllll(((Item)Inventory.getAll((int[])nArray7).get(lIIIlllIllIII[1])).getQuantity(), lIIIlllIllIII[2]) && O.lIlIIlIIlIllIIl(((Widget)lllllllllllllllIIIIIlIlIIlIllIIl.get(lllllllllllllllIIIIIlIlIIlIllIII)).getText().contains(lIIIlllIlIlll[lIIIlllIllIII[57]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)lllllllllllllllIIIIIlIlIIlIllIIl.get(lllllllllllllllIIIIIlIlIIlIllIII)).getClickPoint().getX(), (int)((Widget)lllllllllllllllIIIIIlIlIIlIllIIl.get(lllllllllllllllIIIIIlIlIIlIllIII)).getClickPoint().getY(), (boolean)lIIIlllIllIII[2]);
                                                        Time.sleepTicks((int)lIIIlllIllIII[3]);
                                                        "".length();
                                                    }
                                                    int[] nArray8 = new int[lIIIlllIllIII[2]];
                                                    nArray8[O.lIIIlllIllIII[1]] = lIIIlllIllIII[50];
                                                    if (O.lIlIIlIIlIlllll(((Item)Inventory.getAll((int[])nArray8).get(lIIIlllIllIII[1])).getQuantity(), lIIIlllIllIII[13]) && O.lIlIIlIIlIllIIl(((Widget)lllllllllllllllIIIIIlIlIIlIllIIl.get(lllllllllllllllIIIIIlIlIIlIllIII)).getText().contains(lIIIlllIlIlll[lIIIlllIllIII[58]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)lllllllllllllllIIIIIlIlIIlIllIIl.get(lllllllllllllllIIIIIlIlIIlIllIII)).getClickPoint().getX(), (int)((Widget)lllllllllllllllIIIIIlIlIIlIllIIl.get(lllllllllllllllIIIIIlIlIIlIllIII)).getClickPoint().getY(), (boolean)lIIIlllIllIII[2]);
                                                        Time.sleepTicks((int)lIIIlllIllIII[3]);
                                                        "".length();
                                                    }
                                                    if (O.lIlIIlIIlIllIIl(((Widget)lllllllllllllllIIIIIlIlIIlIllIIl.get(lllllllllllllllIIIIIlIlIIlIllIII)).getText().contains(lIIIlllIlIlll[lIIIlllIllIII[59]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)lllllllllllllllIIIIIlIlIIlIllIIl.get(lllllllllllllllIIIIIlIlIIlIllIII)).getClickPoint().getX(), (int)((Widget)lllllllllllllllIIIIIlIlIIlIllIIl.get(lllllllllllllllIIIIIlIlIIlIllIII)).getClickPoint().getY(), (boolean)lIIIlllIllIII[2]);
                                                        Time.sleepTicks((int)lIIIlllIllIII[3]);
                                                        "".length();
                                                    }
                                                    ++lllllllllllllllIIIIIlIlIIlIllIII;
                                                    "".length();
                                                    if (" ".length() >= -" ".length()) continue;
                                                    return;
                                                }
            ...
            if (O.lIlIIlIIllIIIII(Players.getLocal().getWorldLocation().distanceTo(in), lIIIlllIllIII[20])) {
                ...
                lllllllllllllllIIIIIlIlIIlIllIll = TileItems.getNearest((String[])stringArray);
                if (O.lIlIIlIIlIlllII(lllllllllllllllIIIIIlIlIIlIllIll)) {
                    lllllllllllllllIIIIIlIlIIlIllIll.interact(lIIIlllIlIlll[lIIIlllIllIII[62]]);
                }
            }
        }
    }
    ...
    private static void lIlIIlIIlIllIII() {
        ...
        O.lIIIlllIllIII[2] = " ".length();
        O.lIIIlllIllIII[3] = "  ".length();
        O.lIIIlllIllIII[4] = "   ".length();
    ...
    private static String lIlIIlIIlIlIlII(String lllllllllllllllIIIIIlIlIIlIIIllI, String lllllllllllllllIIIIIlIlIIlIIIIll) {
        try {
            SecretKeySpec lllllllllllllllIIIIIlIlIIlIIlIIl = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIIIIlIlIIlIIIIll.getBytes(StandardCharsets.UTF_8)), "Blowfish");
