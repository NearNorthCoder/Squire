...
public class m {
    ...
    private static String lIlIIllIlIIllIl(String lllllllllllllllIIIIIIIIIIlIIIlIl, String lllllllllllllllIIIIIIIIIIlIIIllI) {
        try {
            SecretKeySpec lllllllllllllllIIIIIIIIIIlIIlIlI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIIIIIIIIIlIIIllI.getBytes(StandardCharsets.UTF_8)), lIIIlllllllII[11]), "DES");
            Cipher lllllllllllllllIIIIIIIIIIlIIlIIl = Cipher.getInstance("DES");
            lllllllllllllllIIIIIIIIIIlIIlIIl.init(lIIIlllllllII[2], lllllllllllllllIIIIIIIIIIlIIlIlI);
            return new String(lllllllllllllllIIIIIIIIIIlIIlIIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIIIIIIIlIIIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlIIllIlIIllll(String lllllllllllllllIIIIIIIIIIIlIIIlI, String lllllllllllllllIIIIIIIIIIIlIIIIl) {
        try {
            SecretKeySpec lllllllllllllllIIIIIIIIIIIlIIlIl = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIIIIIIIIIIlIIIIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIIIIIIIIIIIlIIlII = Cipher.getInstance("Blowfish");
            lllllllllllllllIIIIIIIIIIIlIIlII.init(lIIIlllllllII[2], lllllllllllllllIIIIIIIIIIIlIIlIl);
    ...
    public static void W() {
        d lllllllllllllllIIIIIIIIIIlIIllll;
        Object lllllllllllllllIIIIIIIIIIlIlIIII;
        ...
        if (m.lIlIIllIlIlIlII(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lllllllllllllllIIIIIIIIIIlIlIIII = new d(cr, lIIIlllllllII[1], lIIIlllllllII[22]);
            bA.add((d)lllllllllllllllIIIIIIIIIIlIlIIII);
            "".length();
        }
        ...
        if (m.lIlIIllIlIlIlII(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllIIIIIIIIIIlIlIIII = new d(lIIIlllllllII[8], lIIIlllllllII[1], lIIIlllllllII[23]);
            bA.add((d)lllllllllllllllIIIIIIIIIIlIlIIII);
            "".length();
        }
        ...
        if (m.lIlIIllIlIlIlII(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllIIIIIIIIIIlIlIIII = new d(lIIIlllllllII[7], lIIIlllllllII[1], lIIIlllllllII[24]);
            bA.add((d)lllllllllllllllIIIIIIIIIIlIlIIII);
            "".length();
        }
        ...
        if (m.lIlIIllIlIlIlII(Bank.contains((int[])nArray5) ? 1 : 0)) {
            lllllllllllllllIIIIIIIIIIlIlIIII = new d(lIIIlllllllII[25], lIIIlllllllII[5], lIIIlllllllII[13]);
            bA.add((d)lllllllllllllllIIIIIIIIIIlIlIIII);
            "".length();
        }
        ...
        if (m.lIlIIllIlIlIlII(Bank.contains((int[])nArray6) ? 1 : 0)) {
            lllllllllllllllIIIIIIIIIIlIlIIII = new d(lIIIlllllllII[26], lIIIlllllllII[27], lIIIlllllllII[13]);
            bA.add((d)lllllllllllllllIIIIIIIIIIlIlIIII);
            "".length();
        }
        ...
        if (m.lIlIIllIlIlIlII(Bank.contains((int[])nArray7) ? 1 : 0)) {
            lllllllllllllllIIIIIIIIIIlIlIIII = new d(lIIIlllllllII[28], lIIIlllllllII[29], lIIIlllllllII[13]);
            bA.add((d)lllllllllllllllIIIIIIIIIIlIlIIII);
            "".length();
        }
        ...
        if (m.lIlIIllIlIlIlII(Bank.contains((int[])nArray8) ? 1 : 0)) {
            lllllllllllllllIIIIIIIIIIlIlIIII = new d(lIIIlllllllII[30], lIIIlllllllII[31], lIIIlllllllII[13]);
            bA.add((d)lllllllllllllllIIIIIIIIIIlIlIIII);
            "".length();
        }
        ...
        if (m.lIlIIllIlIlIlII(Bank.contains((Predicate)(lllllllllllllllIIIIIIIIIIlIlIIII = item -> item.getName().toLowerCase().contains(lIIIllllllIll[lIIIlllllllII[40]]))) ? 1 : 0)) {
            lllllllllllllllIIIIIIIIIIlIIllll = new d(lIIIlllllllII[33], lIIIlllllllII[6], lIIIlllllllII[34]);
            bA.add(lllllllllllllllIIIIIIIIIIlIIllll);
            "".length();
        }
        ...
        if (m.lIlIIllIlIlIlII(Bank.contains((int[])nArray17) ? 1 : 0)) {
            lllllllllllllllIIIIIIIIIIlIIllll = new d(lIIIlllllllII[35], lIIIlllllllII[36], lIIIlllllllII[37]);
            bA.add(lllllllllllllllIIIIIIIIIIlIIllll);
            "".length();
        }
    }
        ...
        if (m.lIlIIllIlIlIIlI(Inventory.contains((String[])stringArray) ? 1 : 0)) {
            ...
            if (m.lIlIIllIlIlIIlI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (m.lIlIIllIlIlIIlI(Inventory.contains((String[])stringArray2) ? 1 : 0) && m.lIlIIllIlIlIIlI(Inventory.contains((int[])f.aS) ? 1 : 0)) {
                    ...
                    return ((0xD0 ^ 0xA8 ^ (0xF6 ^ 0x84)) & (84 + 67 - 53 + 32 ^ 77 + 101 - 98 + 56 ^ -" ".length())) != 0;
                }
            }
        }
        n2 = lIIIlllllllII[0];
    ...
    private static void lIlIIllIlIlIIIl() {
        ...
        m.lIIIlllllllII[0] = (0x4B ^ 0x4F ^ (0x49 ^ 0x6C)) & (107 + 144 - 187 + 92 ^ 185 + 40 - 104 + 68 ^ -" ".length());
        m.lIIIlllllllII[1] = " ".length();
        m.lIIIlllllllII[2] = "  ".length();
        m.lIIIlllllllII[3] = "   ".length();
        ...
        block28: {
                        ...
                        block33: {
                            block32: {
                                block30: {
                                    ...
                                    BankLocation lllllllllllllllIIIIIIIIIIlIlIlII = BankLocation.getNearest();
                                    if (m.lIlIIllIlIlIlIl(lllllllllllllllIIIIIIIIIIlIlIlII) && m.lIlIIllIlIlIlII(lllllllllllllllIIIIIIIIIIlIlIlII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                        AccBuilderRat.c = lIIIllllllIll[lIIIlllllllII[3]];
                                        a.a(lllllllllllllllIIIIIIIIIIlIlIlII);
                                    }
                                    if (!m.lIlIIllIlIlIlIl(lllllllllllllllIIIIIIIIIIlIlIlII) || !m.lIlIIllIlIlIIlI(lllllllllllllllIIIIIIIIIIlIlIlII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block29;
                    ...
                    if (m.lIlIIllIlIlIIll(Inventory.getCount((int[])nArray6), lIIIlllllllII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (m.lIlIIllIlIlIllI(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (null != null) {
                                    return ((91 + 194 - 204 + 135 ^ 72 + 104 - 130 + 113) & (0x73 ^ 0x35 ^ " ".length() ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIIlllllllII[0];
                            }
                    ...
                    if (m.lIlIIllIlIlIIll(Inventory.getCount((int[])nArray8), lIIIlllllllII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (m.lIlIIllIlIlIllI(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (" ".length() >= "   ".length()) {
                                    return ((0x5E ^ 0x6F ^ (0x2A ^ 0x27)) & (99 + 60 - 95 + 80 ^ 140 + 50 - 39 + 21 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIIlllllllII[0];
                            }
                    ...
                    if (m.lIlIIllIlIlIIll(Inventory.getCount((int[])nArray10), lIIIlllllllII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (m.lIlIIllIlIlIllI(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (-" ".length() > " ".length()) {
                                    return ((0x76 ^ 0x21 ^ (0x12 ^ 0x5D)) & (0x80 ^ 0x9B ^ "   ".length() ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIIlllllllII[0];
                            }
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (m.lIlIIllIlIlIllI(Inventory.getCount((int[])nArray))) {
                                ...
                                if ((0x91 ^ 0x87 ^ (0xA5 ^ 0xB6)) <= 0) {
                                    return ((0x40 ^ 0x39 ^ (0xF3 ^ 0x99)) & (0x54 ^ 0x38 ^ 15 + 70 - 76 + 118 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIIlllllllII[0];
                            }
            ...
            if (m.lIlIIllIlIlIIlI(m.au() ? 1 : 0)) {
                ...
                if (m.lIlIIllIlIlIlII(Bank.isOpen() ? 1 : 0)) {
                    ...
                    int lllllllllllllllIIIIIIIIIIlIlIlII = lIIIlllllllII[0];
                    while (m.lIlIIllIlIlIIll(lllllllllllllllIIIIIIIIIIlIlIlII, cs.length)) {
                        int[] nArray = new int[lIIIlllllllII[1]];
                        nArray[m.lIIIlllllllII[0]] = cs[lllllllllllllllIIIIIIIIIIlIlIlII];
                        Item lllllllllllllllIIIIIIIIIIlIlIIll = Inventory.getFirst((int[])nArray);
                        if (m.lIlIIllIlIlIlIl(lllllllllllllllIIIIIIIIIIlIlIIll)) {
                            int[] nArray13 = new int[lIIIlllllllII[1]];
                            nArray13[m.lIIIlllllllII[0]] = lllllllllllllllIIIIIIIIIIlIlIIll.getId();
                            if (m.lIlIIllIlIlIIlI(Inventory.contains((int[])nArray13) ? 1 : 0)) {
                                String[] stringArray = new String[lIIIlllllllII[1]];
                                stringArray[m.lIIIlllllllII[0]] = lIIIllllllIll[lIIIlllllllII[10]];
                                if (m.lIlIIllIlIlIIlI(lllllllllllllllIIIIIIIIIIlIlIIll.hasAction(stringArray) ? 1 : 0)) {
                                    lllllllllllllllIIIIIIIIIIlIlIIll.interact(lIIIllllllIll[lIIIlllllllII[11]]);
                                    Time.sleepTicks((int)lIIIlllllllII[1]);
                                    "".length();
                                }
                                String[] stringArray2 = new String[lIIIlllllllII[1]];
                                stringArray2[m.lIIIlllllllII[0]] = lIIIllllllIll[lIIIlllllllII[12]];
                                if (m.lIlIIllIlIlIIlI(lllllllllllllllIIIIIIIIIIlIlIIll.hasAction(stringArray2) ? 1 : 0)) {
                                    lllllllllllllllIIIIIIIIIIlIlIIll.interact(lIIIllllllIll[lIIIlllllllII[13]]);
                                    Time.sleepTicks((int)lIIIlllllllII[1]);
                                    "".length();
                                }
                                String[] stringArray3 = new String[lIIIlllllllII[1]];
                                stringArray3[m.lIIIlllllllII[0]] = lIIIllllllIll[lIIIlllllllII[14]];
                                if (m.lIlIIllIlIlIIlI(lllllllllllllllIIIIIIIIIIlIlIIll.hasAction(stringArray3) ? 1 : 0)) {
                                    lllllllllllllllIIIIIIIIIIlIlIIll.interact(lIIIllllllIll[lIIIlllllllII[15]]);
                                    Time.sleepTicks((int)lIIIlllllllII[1]);
                                    "".length();
                                }
                                Time.sleepTicks((int)lIIIlllllllII[1]);
                        ...
                        ++lllllllllllllllIIIIIIIIIIlIlIlII;
                        "".length();
    ...
    private static void lIlIIllIlIlIIII() {
        ...
        m.lIIIllllllIll[m.lIIIlllllllII[0]] = m.lIlIIllIlIIllIl("pNtXwouqVTQA5rQ2wtaSWA==", "HQezQ");
        m.lIIIllllllIll[m.lIIIlllllllII[1]] = m.lIlIIllIlIIllIl("9twZeGWGdXgshTzQKThI3cxybHgTcGHLyBur+pMt3uEExp1wGDtiR+t0pZczPBwJBPZbryqQuKk=", "dUIJB");
        m.lIIIllllllIll[m.lIIIlllllllII[2]] = m.lIlIIllIlIIlllI("Nh8DYwoQHRJjABQbBWMSBRMb", "qzwCG");
        m.lIIIllllllIll[m.lIIIlllllllII[3]] = m.lIlIIllIlIIllIl("RRkiV6MIlN/6kgLogO3/6zxl8XeqeQay", "VXObN");
        m.lIIIllllllIll[m.lIIIlllllllII[4]] = m.lIlIIllIlIIllll("A6xkbSj2DwZSJThST+o6DA==", "iLKMp");
        m.lIIIllllllIll[m.lIIIlllllllII[6]] = m.lIlIIllIlIIlllI("IjEELzkDPg1rNws+ASI7DQ==", "jPjKU");
        m.lIIIllllllIll[m.lIIIlllllllII[9]] = m.lIlIIllIlIIllIl("uLoSqOlKOZbWe9kq9ZYuebToNnGa7n1so0xLj+5lvdNxU3oawjMoQ7FIPFBGBJ/CfbZI09l/q+8=", "waFQU");
        m.lIIIllllllIll[m.lIIIlllllllII[10]] = m.lIlIIllIlIIllll("9v7FH70E03Q=", "ftHSJ");
        m.lIIIllllllIll[m.lIIIlllllllII[11]] = m.lIlIIllIlIIllll("u1kkXIF/ZD0=", "ImpRA");
        m.lIIIllllllIll[m.lIIIlllllllII[12]] = m.lIlIIllIlIIllIl("Q6bEcZo8pHo=", "RAMoY");
        m.lIIIllllllIll[m.lIIIlllllllII[13]] = m.lIlIIllIlIIllIl("mO6gISNfUaQ=", "jzWUI");
        m.lIIIllllllIll[m.lIIIlllllllII[14]] = m.lIlIIllIlIIllll("8h4FqhCR3JU=", "oeAdJ");
        m.lIIIllllllIll[m.lIIIlllllllII[15]] = m.lIlIIllIlIIllIl("loUErioFWCE=", "pbTLl");
        m.lIIIllllllIll[m.lIIIlllllllII[17]] = m.lIlIIllIlIIllIl("9yTLd0zBXgZKWi8Y0cP9rQ==", "ibwAX");
        m.lIIIllllllIll[m.lIIIlllllllII[18]] = m.lIlIIllIlIIllIl("r72SBEPPUA4jUcDelhaPXw==", "iedeG");
        m.lIIIllllllIll[m.lIIIlllllllII[19]] = m.lIlIIllIlIIllll("h7gXwlpZW3QOGDrJKKIsFA==", "JuahU");
        m.lIIIllllllIll[m.lIIIlllllllII[20]] = m.lIlIIllIlIIllll("Pek1LhRTDM7Aox5ckvl9pg==", "QjmJx");
        m.lIIIllllllIll[m.lIIIlllllllII[38]] = m.lIlIIllIlIIllIl("yj3JkjjS19Y=", "TiWgA");
        m.lIIIllllllIll[m.lIIIlllllllII[39]] = m.lIlIIllIlIIllll("/0ykzMlmLlw=", "ivIvq");
        m.lIIIllllllIll[m.lIIIlllllllII[40]] = m.lIlIIllIlIIllll("b1DVeCKimugKXZjHc3+eJ7BBcV652Jt2", "OWbjz");
    }

    private static String lIlIIllIlIIlllI(String lllllllllllllllIIIIIIIIIIIllIlll, String lllllllllllllllIIIIIIIIIIIllIllI) {
        lllllllllllllllIIIIIIIIIIIllIlll = new String(Base64.getDecoder().decode(lllllllllllllllIIIIIIIIIIIllIlll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        ...
        char[] lllllllllllllllIIIIIIIIIIIlIllIl = lllllllllllllllIIIIIIIIIIIllIlll.toCharArray();
        int lllllllllllllllIIIIIIIIIIIlIllII = lllllllllllllllIIIIIIIIIIIlIllIl.length;
        int lllllllllllllllIIIIIIIIIIIlIlIll = lIIIlllllllII[0];
        while (m.lIlIIllIlIlIIll(lllllllllllllllIIIIIIIIIIIlIlIll, lllllllllllllllIIIIIIIIIIIlIllII)) {
            char lllllllllllllllIIIIIIIIIIIlllIII = lllllllllllllllIIIIIIIIIIIlIllIl[lllllllllllllllIIIIIIIIIIIlIlIll];
            ...
            ++lllllllllllllllIIIIIIIIIIIlIlIll;
            "".length();
