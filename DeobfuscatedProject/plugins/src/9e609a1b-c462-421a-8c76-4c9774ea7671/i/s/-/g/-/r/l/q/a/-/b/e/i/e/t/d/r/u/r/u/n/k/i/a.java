...
public class a {
    ...
    private static void lIlIIllIllIlIll() {
        ...
        a.lIIIlllllllll[a.lIIlIIIIIIIII[2]] = a.lIlIIllIllIlIII("HCA9", "EENwP");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[1]] = a.lIlIIllIllIlIIl("AGGkCABzfqo=", "zLclA");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[14]] = a.lIlIIllIllIlIII("LTIkMw==", "zWEAC");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[15]] = a.lIlIIllIllIlIIl("AhybV75qz/8=", "gatPD");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[24]] = a.lIlIIllIllIlIlI("EE7Q+BAYq3M=", "bScOU");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[19]] = a.lIlIIllIllIlIlI("NzBBx+FQlYc=", "xdtGG");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[13]] = a.lIlIIllIllIlIIl("iu0q/9Y8ZyY=", "cGWpM");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[27]] = a.lIlIIllIllIlIII("BhcUBQ4vHlE1Ci0fFR4MNw==", "Czqwo");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[29]] = a.lIlIIllIllIlIIl("NyROq7PwQN4=", "qHdfe");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[31]] = a.lIlIIllIllIlIIl("y+s9RHL3+OB5ojMmeoQEKQ==", "PsJtt");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[23]] = a.lIlIIllIllIlIII("FjQq", "CGOlI");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[22]] = a.lIlIIllIllIlIIl("90oyoC9zdz8=", "Xhapf");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[32]] = a.lIlIIllIllIlIlI("UVsMyeuYCHk=", "siGpr");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[33]] = a.lIlIIllIllIlIII("Bi0LAw==", "DLehf");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[34]] = a.lIlIIllIllIlIII("DBMlD2csHSQQLw==", "NrKdG");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[35]] = a.lIlIIllIllIlIII("DRIWHw==", "OsxtJ");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[36]] = a.lIlIIllIllIlIII("DQkONBMWHhY=", "ylbQc");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[37]] = a.lIlIIllIllIlIIl("A6gWeXEbsTRHR/+JqqeFyA==", "kXjww");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[38]] = a.lIlIIllIllIlIII("MRUFATgqAh0=", "EpidH");
        a.lIIIlllllllll[a.lIIlIIIIIIIII[39]] = a.lIlIIllIllIlIlI("SZr61qGCf2e8GImo4MMuVQ==", "jwkII");
    }
    ...
    public static void a(BankLocation bankLocation) {
        ...
        WorldPoint llllllllllllllIllllllllllIIllIll = new WorldPoint(lIIlIIIIIIIII[3], lIIlIIIIIIIII[4], lIIlIIIIIIIII[2]);
        WorldPoint llllllllllllllIllllllllllIIllIlI = new WorldPoint(lIIlIIIIIIIII[5], lIIlIIIIIIIII[6], lIIlIIIIIIIII[2]);
        WorldArea llllllllllllllIllllllllllIIllIIl = new WorldArea(lIIlIIIIIIIII[7], lIIlIIIIIIIII[8], lIIlIIIIIIIII[9], lIIlIIIIIIIII[10], lIIlIIIIIIIII[2]);
        if ((!a.lIlIIllIllIllll(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllIllllllllllIIllIll) ? 1 : 0) || !a.lIlIIllIlllIIII(Players.getLocal().getWorldLocation().distanceTo(llllllllllllllIllllllllllIIllIlI), lIIlIIIIIIIII[11]) || a.lIlIIllIllIlllI(llllllllllllllIllllllllllIIllIIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) && a.lIlIIllIllIlllI(Inventory.contains(item -> item.getName().contains(lIIIlllllllll[lIIlIIIIIIIII[39]])) ? 1 : 0) && a.lIlIIllIllIllIl(Players.getLocal().getAnimation(), lIIlIIIIIIIII[12])) {
        ...
        if (!a.lIlIIllIlllIIII(Players.getLocal().getWorldLocation().distanceTo(x), lIIlIIIIIIIII[11]) || a.lIlIIllIllIlllI(z.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            BankLocation llllllllllllllIllllllllllIIlllII;
            WorldArea llllllllllllllIllllllllllIIlIllI;
            WorldArea llllllllllllllIllllllllllIIllIII = new WorldArea(lIIlIIIIIIIII[17], lIIlIIIIIIIII[18], lIIlIIIIIIIII[13], lIIlIIIIIIIII[19], lIIlIIIIIIIII[2]);
            WorldArea llllllllllllllIllllllllllIIlIlll = new WorldArea(lIIlIIIIIIIII[20], lIIlIIIIIIIII[21], lIIlIIIIIIIII[22], lIIlIIIIIIIII[23], lIIlIIIIIIIII[2]);
            if ((!a.lIlIIllIllIllll(llllllllllllllIllllllllllIIllIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || a.lIlIIllIllIlllI(llllllllllllllIllllllllllIIlIlll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) && a.lIlIIllIllIlllI(Inventory.contains(item -> item.getName().contains(lIIIlllllllll[lIIlIIIIIIIII[37]])) ? 1 : 0)) {
            ...
            if (a.lIlIIllIllIlllI((llllllllllllllIllllllllllIIlIllI = new WorldArea(lIIlIIIIIIIII[25], lIIlIIIIIIIII[26], lIIlIIIIIIIII[27], lIIlIIIIIIIII[13], lIIlIIIIIIIII[2])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                String[] stringArray = new String[lIIlIIIIIIIII[1]];
                stringArray[a.lIIlIIIIIIIII[2]] = lIIIlllllllll[lIIlIIIIIIIII[19]];
                TileObject llllllllllllllIllllllllllIIlIlIl = TileObjects.getNearest((String[])stringArray);
                if (a.lIlIIllIlllIIlI(llllllllllllllIllllllllllIIlIlIl)) {
                    llllllllllllllIllllllllllIIlIlIl.interact(lIIIlllllllll[lIIlIIIIIIIII[13]]);
                    Time.sleepTicks((int)lIIlIIIIIIIII[24]);
                    "".length();
                }
            }
            Movement.walkTo((BankLocation)llllllllllllllIllllllllllIIlllII);
            "".length();
            Time.sleepTicks((int)lIIlIIIIIIIII[14]);
            "".length();
        }
    ...
    public static void a() {
        ...
        if (!a.lIlIIllIllIllll(BankLocation.GRAND_EXCHANGE_BANK.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || a.lIlIIllIllIlllI(w.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            TileObject llllllllllllllIllllllllllIIlIIll = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (String[])stringArray);
            if (a.lIlIIllIlllIIlI(llllllllllllllIllllllllllIIlIIll)) {
                String[] stringArray2 = new String[lIIlIIIIIIIII[1]];
                stringArray2[a.lIIlIIIIIIIII[2]] = lIIIlllllllll[lIIlIIIIIIIII[23]];
                if (a.lIlIIllIllIlllI(llllllllllllllIllllllllllIIlIIll.hasAction(stringArray2) ? 1 : 0)) {
                    llllllllllllllIllllllllllIIlIIll.interact(lIIIlllllllll[lIIlIIIIIIIII[22]]);
                    Time.sleepTicks((int)lIIlIIIIIIIII[15]);
                    "".length();
                    Time.sleepUntil(() -> Bank.isOpen(), (int)lIIlIIIIIIIII[30]);
                    "".length();
                ...
                if (a.lIlIIllIllIlllI(llllllllllllllIllllllllllIIlIIll.hasAction(stringArray3) ? 1 : 0)) {
                    llllllllllllllIllllllllllIIlIIll.interact(lIIIlllllllll[lIIlIIIIIIIII[33]]);
                    Time.sleepTicks((int)lIIlIIIIIIIII[15]);
                    "".length();
                    Time.sleepUntil(() -> Bank.isOpen(), (int)lIIlIIIIIIIII[30]);
                    "".length();
            ...
            TileObject llllllllllllllIllllllllllIIlIIll = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (String[])stringArray);
            if (a.lIlIIllIlllIIlI(llllllllllllllIllllllllllIIlIIll)) {
                llllllllllllllIllllllllllIIlIIll.interact(lIIIlllllllll[lIIlIIIIIIIII[35]]);
                Time.sleepTicks((int)lIIlIIIIIIIII[15]);
                "".length();
                Time.sleepUntil(() -> Bank.isOpen(), (int)lIIlIIIIIIIII[30]);
                "".length();
    ...
    public static void a(int[] nArray) {
        int[] llllllllllllllIllllllllllIIlIIII;
        int llllllllllllllIllllllllllIIIllll = lIIlIIIIIIIII[2];
        while (a.lIlIIllIlllIIll(llllllllllllllIllllllllllIIIllll, llllllllllllllIllllllllllIIlIIII.length)) {
            Bank.withdraw((int)llllllllllllllIllllllllllIIlIIII[llllllllllllllIllllllllllIIIllll], (int)lIIlIIIIIIIII[1], (Bank.WithdrawMode)Bank.WithdrawMode.DEFAULT);
            Time.sleepTicks((int)lIIlIIIIIIIII[1]);
            "".length();
            ++llllllllllllllIllllllllllIIIllll;
            "".length();
    ...
    public static void a(int n2, int n3) {
        int llllllllllllllIllllllllllIIIIIII;
        ...
        nArray2[a.lIIlIIIIIIIII[2]] = llllllllllllllIllllllllllIIIIIII;
        if (a.lIlIIllIllIlllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            void llllllllllllllIlllllllllIlllllll;
            Bank.withdraw((int)llllllllllllllIllllllllllIIIIIII, (int)llllllllllllllIlllllllllIlllllll, (Bank.WithdrawMode)Bank.WithdrawMode.DEFAULT);
            Time.sleepTicks((int)lIIlIIIIIIIII[1]);
            "".length();
        }
    }
    ...
    public static void b(int[] nArray, int n2) {
        int[] llllllllllllllIllllllllllIIIIlIl;
        int llllllllllllllIllllllllllIIIIIll = lIIlIIIIIIIII[2];
        while (a.lIlIIllIlllIIll(llllllllllllllIllllllllllIIIIIll, llllllllllllllIllllllllllIIIIlIl.length)) {
            void llllllllllllllIllllllllllIIIIlII;
            Bank.withdraw((int)llllllllllllllIllllllllllIIIIlIl[llllllllllllllIllllllllllIIIIIll], (int)llllllllllllllIllllllllllIIIIlII, (Bank.WithdrawMode)Bank.WithdrawMode.DEFAULT);
            Time.sleepTicks((int)lIIlIIIIIIIII[1]);
            "".length();
            int[] nArray2 = new int[lIIlIIIIIIIII[1]];
            nArray2[a.lIIlIIIIIIIII[2]] = llllllllllllllIllllllllllIIIIlIl[llllllllllllllIllllllllllIIIIIll];
            if (a.lIlIIllIllIlllI(Inventory.contains((int[])nArray2) ? 1 : 0)) {
                "".length();
                if ("  ".length() > 0) break;
                return;
            }
            ++llllllllllllllIllllllllllIIIIIll;
            "".length();
            if (-" ".length() == -" ".length()) continue;
            return;
        }
    ...
    private static String lIlIIllIllIlIIl(String llllllllllllllIlllllllllIlIlIIlI, String llllllllllllllIlllllllllIlIlIIIl) {
        try {
            SecretKeySpec llllllllllllllIlllllllllIlIlIlIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllIlllllllllIlIlIIIl.getBytes(StandardCharsets.UTF_8)), lIIlIIIIIIIII[29]), "DES");
            Cipher llllllllllllllIlllllllllIlIlIlII = Cipher.getInstance("DES");
            llllllllllllllIlllllllllIlIlIlII.init(lIIlIIIIIIIII[14], llllllllllllllIlllllllllIlIlIlIl);
            return new String(llllllllllllllIlllllllllIlIlIlII.doFinal(Base64.getDecoder().decode(llllllllllllllIlllllllllIlIlIIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlIIllIllIlIII(String llllllllllllllIlllllllllIlllIlII, String llllllllllllllIlllllllllIllIlllI) {
        llllllllllllllIlllllllllIlllIlII = new String(Base64.getDecoder().decode(llllllllllllllIlllllllllIlllIlII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllIlllllllllIlllIIlI = new StringBuilder();
        char[] llllllllllllllIlllllllllIlllIIIl = llllllllllllllIlllllllllIllIlllI.toCharArray();
        int llllllllllllllIlllllllllIlllIIII = lIIlIIIIIIIII[2];
        char[] llllllllllllllIlllllllllIllIlIlI = llllllllllllllIlllllllllIlllIlII.toCharArray();
        int llllllllllllllIlllllllllIllIlIIl = llllllllllllllIlllllllllIllIlIlI.length;
        int llllllllllllllIlllllllllIllIlIII = lIIlIIIIIIIII[2];
        while (a.lIlIIllIlllIIll(llllllllllllllIlllllllllIllIlIII, llllllllllllllIlllllllllIllIlIIl)) {
            char llllllllllllllIlllllllllIlllIlIl = llllllllllllllIlllllllllIllIlIlI[llllllllllllllIlllllllllIllIlIII];
            llllllllllllllIlllllllllIlllIIlI.append((char)(llllllllllllllIlllllllllIlllIlIl ^ llllllllllllllIlllllllllIlllIIIl[llllllllllllllIlllllllllIlllIIII % llllllllllllllIlllllllllIlllIIIl.length]));
            "".length();
        ...
        return String.valueOf(llllllllllllllIlllllllllIlllIIlI);
    }

    private static String lIlIIllIllIlIlI(String llllllllllllllIlllllllllIlIlllll, String llllllllllllllIlllllllllIlIllllI) {
        try {
            SecretKeySpec llllllllllllllIlllllllllIllIIIlI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllIlllllllllIlIllllI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllIlllllllllIllIIIIl = Cipher.getInstance("Blowfish");
            llllllllllllllIlllllllllIllIIIIl.init(lIIlIIIIIIIII[14], llllllllllllllIlllllllllIllIIIlI);
    ...
    public static void a(int[] nArray, int n2) {
        int[] llllllllllllllIllllllllllIIIlIll;
        int llllllllllllllIllllllllllIIIlIIl = lIIlIIIIIIIII[2];
        while (a.lIlIIllIlllIIll(llllllllllllllIllllllllllIIIlIIl, llllllllllllllIllllllllllIIIlIll.length)) {
            void llllllllllllllIllllllllllIIIlIlI;
            Bank.withdraw((int)llllllllllllllIllllllllllIIIlIll[llllllllllllllIllllllllllIIIlIIl], (int)llllllllllllllIllllllllllIIIlIlI, (Bank.WithdrawMode)Bank.WithdrawMode.DEFAULT);
            Time.sleepTicks((int)lIIlIIIIIIIII[1]);
            "".length();
            ++llllllllllllllIllllllllllIIIlIIl;
            "".length();
    ...
    private static void lIlIIllIllIllII() {
        ...
        a.lIIlIIIIIIIII[1] = " ".length();
        a.lIIlIIIIIIIII[2] = (0x84 ^ 0x82 ^ (0x9F ^ 0xC6)) & (0x37 ^ 0x21 ^ (0x61 ^ 0x28) ^ -" ".length());
        ...
        a.lIIlIIIIIIIII[12] = -" ".length();
        a.lIIlIIIIIIIII[13] = 0x45 ^ 0x74 ^ (0x1B ^ 0x2C);
        a.lIIlIIIIIIIII[14] = "  ".length();
        a.lIIlIIIIIIIII[15] = "   ".length();
