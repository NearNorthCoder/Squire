...
implements M {
    ...
    private static String lIlIIlIllIlIIII(String lllllllllllllllIIIIIIllIlllIlIlI, String lllllllllllllllIIIIIIllIlllIlIll) {
        try {
            ...
            return new String(lllllllllllllllIIIIIIllIlllIlllI.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIIIllIlllIlIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void al() {
        NPC lllllllllllllllIIIIIIlllIIIlIllI;
        WorldArea lllllllllllllllIIIIIIlllIIIlIlll;
        if (j.lIlIIlIllIlllII(j.lIlIIlIllIllIlI(e.a(bV), lIIIllllIlIIl[9] + ca))) {
            if (j.lIlIIlIllIlIllI(Players.getLocal().getWorldLocation().equals((Object)bU) ? 1 : 0)) {
                ...
                if (j.lIlIIlIllIlIllI(bX.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (j.lIlIIlIllIllllI(Players.getLocal().getWorldLocation().distanceTo(bT), lIIIllllIlIIl[10])) {
                        ...
                        lllllllllllllllIIIIIIlllIIIlIlll = NPCs.getNearest((String[])stringArray);
                        if (j.lIlIIlIllIlIlll(lllllllllllllllIIIIIIlllIIIlIlll)) {
                            String[] stringArray2 = new String[lIIIllllIlIIl[0]];
                            stringArray2[j.lIIIllllIlIIl[1]] = lIIIllllIlIII[lIIIllllIlIIl[16]];
                            if (j.lIlIIlIllIllIII(lllllllllllllllIIIIIIlllIIIlIlll.hasAction(stringArray2) ? 1 : 0)) {
                                lllllllllllllllIIIIIIlllIIIlIlll.interact(lIIIllllIlIII[lIIIllllIlIIl[17]]);
                            ...
                            if (j.lIlIIlIllIlIllI(lllllllllllllllIIIIIIlllIIIlIlll.hasAction(stringArray3) ? 1 : 0)) {
            ...
            if (j.lIlIIlIllIllIII(Players.getLocal().getWorldLocation().equals((Object)bU) ? 1 : 0)) {
                ...
                if (j.lIlIIlIllIllIII(j.an() ? 1 : 0)) {
                    lllllllllllllllIIIIIIlllIIIlIlll = new WorldArea(bU, lIIIllllIlIIl[3], lIIIllllIlIIl[3]);
                    lllllllllllllllIIIIIIlllIIIlIllI = j.am();
                    AccBuilderRat.c = lIIIllllIlIII[lIIIllllIlIIl[21]];
                    if (j.lIlIIlIllIlllll(Players.getLocal().getInteracting()) && j.lIlIIlIllIlIlll(lllllllllllllllIIIIIIlllIIIlIllI) && j.lIlIIlIllIlIllI(lllllllllllllllIIIIIIlllIIIlIllI.isDead() ? 1 : 0)) {
                        System.out.println(lIIIllllIlIII[lIIIllllIlIIl[22]]);
                        lllllllllllllllIIIIIIlllIIIlIllI.interact(lIIIllllIlIII[lIIIllllIlIIl[23]]);
        ...
        if (j.lIlIIlIlllIIIII(j.lIlIIlIllIllIlI(e.a(bV), lIIIllllIlIIl[9] + ca))) {
            lllllllllllllllIIIIIIlllIIIlIlll = new WorldArea(lIIIllllIlIIl[24], lIIIllllIlIIl[25], lIIIllllIlIIl[26], lIIIllllIlIIl[27], lIIIllllIlIIl[1]);
            lllllllllllllllIIIIIIlllIIIlIllI = new WorldPoint(lIIIllllIlIIl[28], lIIIllllIlIIl[29], lIIIllllIlIIl[1]);
            if (j.lIlIIlIllIllIII(lllllllllllllllIIIIIIlllIIIlIlll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && j.lIlIIlIllIlllIl(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllllllllllllIIIIIIlllIIIlIllI), lIIIllllIlIIl[13])) {
                Movement.walkTo((WorldPoint)lllllllllllllllIIIIIIlllIIIlIllI);
                "".length();
            }
    ...
    private static void ak() {
        ...
        if (j.lIlIIlIllIlIllI(Inventory.contains((int[])nArray) ? 1 : 0)) {
            BankLocation lllllllllllllllIIIIIIlllIIIllIlI = BankLocation.getNearest();
            if (j.lIlIIlIllIlIlll(lllllllllllllllIIIIIIlllIIIllIlI) && j.lIlIIlIllIlIllI(lllllllllllllllIIIIIIlllIIIllIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                AccBuilderRat.c = lIIIllllIlIII[lIIIllllIlIIl[0]];
                a.a(lllllllllllllllIIIIIIlllIIIllIlI);
            }
            if (j.lIlIIlIllIlIlll(lllllllllllllllIIIIIIlllIIIllIlI) && j.lIlIIlIllIllIII(lllllllllllllllIIIIIIlllIIIllIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static void lIlIIlIllIlIIll() {
        ...
        j.lIIIllllIlIII[j.lIIIllllIlIIl[1]] = j.lIlIIlIllIlIIII("lDNmEZlUdvNcvHnEZ4oDLSvmWe81VQJx", "uDGzf");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[0]] = j.lIlIIlIllIlIIII("oATu4hC7NYpPlYF5+u4WGPryBm8tygP5", "LGqxT");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[3]] = j.lIlIIlIllIlIIIl("Iz2W43l2C3tyagjjbwdCyzHsZmvoFWKi", "aONFE");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[10]] = j.lIlIIlIllIlIIII("3ySBgxvTkW+X37teqiQmQ7RzZAH51QCy", "VQnEm");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[12]] = j.lIlIIlIllIlIIIl("uXGYbRmIZek=", "XCWKR");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[13]] = j.lIlIIlIllIlIIII("ChqfFag7+uavS/7yIOS7AA==", "bXvGS");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[14]] = j.lIlIIlIllIlIIlI("PS0ZMCsQbAExKAZsFDwmAQ==", "uLwTG");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[15]] = j.lIlIIlIllIlIIII("rvsH4nSwkag=", "Xogqr");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[16]] = j.lIlIIlIllIlIIII("Pgmei8EVk07it6PZNoiBrpqA7rJhVKMy", "aLwBt");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[17]] = j.lIlIIlIllIlIIII("eqf1UtN3ZToKbb55FFf0g1Rq/Yb9a4dH", "lqBCM");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[8]] = j.lIlIIlIllIlIIlI("ADcjAkYAMSIVByIxPR8TIw==", "PXQvf");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[18]] = j.lIlIIlIllIlIIlI("OgQ9HQ==", "laRnY");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[19]] = j.lIlIIlIllIlIIlI("Igg9", "giIKY");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[20]] = j.lIlIIlIllIlIIlI("FikJIwkwbwskRyQ/DT4=", "WObJg");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[21]] = j.lIlIIlIllIlIIII("V1KLqYksZrXpjCYWLdQKpw==", "MRfxP");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[22]] = j.lIlIIlIllIlIIII("NB+vRRhreAWF3/FX30/N8/c/Fe1kT3WK", "qWOpo");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[23]] = j.lIlIIlIllIlIIlI("JiAQOSsM", "gTdXH");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[30]] = j.lIlIIlIllIlIIIl("Us/5EoSxMzqh+pKLvj1i5A==", "VBDfu");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[34]] = j.lIlIIlIllIlIIII("7AE84EjE65u8fnXTHenJbA==", "Syuyg");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[36]] = j.lIlIIlIllIlIIII("NpZ7PJDFDzShLVLiCFv/uA==", "SpSCc");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[60]] = j.lIlIIlIllIlIIlI("Ji4QB0oBZhYBCBMyXVMOEyhRCgIHZgUSBhdmHBZNBi4UAQhSNh0WDAEjTg==", "rFqsm");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[61]] = j.lIlIIlIllIlIIII("xKzKvlJRlgh2JrMmaER5pEoTXFdSQ7kilhkJnCiMJ3DGX6/FHGPPZw==", "uzFFZ");
        j.lIIIllllIlIII[j.lIIIllllIlIIl[62]] = j.lIlIIlIllIlIIIl("lGhF79sxc1YE9kNCJ9Kj3g==", "vFOrY");
    }

    private static void lIlIIlIllIlIlII() {
        lIIIllllIlIIl = new int[68];
        j.lIIIllllIlIIl[0] = " ".length();
        j.lIIIllllIlIIl[1] = (0x30 ^ 0x1D ^ (0xB6 ^ 0xA7)) & (0x57 ^ 0x5D ^ (0x10 ^ 0x26) ^ -" ".length());
        j.lIIIllllIlIIl[2] = 0xFFFFC17F & 0x3FFB;
        j.lIIIllllIlIIl[3] = "  ".length();
    ...
    public boolean aa() {
        ...
        if (j.lIlIIlIlllIIIlI(Skills.getLevel((Skill)Skill.RANGED), lIIIllllIlIIl[35]) && j.lIlIIlIlllIIIlI(Skills.getLevel((Skill)Skill.DEFENCE), lIIIllllIlIIl[35])) {
            n2 = lIIIllllIlIIl[0];
            "".length();
            if (-" ".length() > ((132 + 181 - 205 + 135 ^ 121 + 40 - 20 + 45) & (0x75 ^ 0x37 ^ (0xBF ^ 0xB4) ^ -" ".length()))) {
                return ((85 + 4 - -115 + 1 ^ 49 + 123 - 55 + 13) & (0xED ^ 0x8E ^ (0xF ^ 0x23) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIIIllllIlIIl[1];
        }
    ...
    public static boolean an() {
        ...
        if (j.lIlIIlIllIlIllI(list.isEmpty() ? 1 : 0) && j.lIlIIlIllIlllIl(list.size(), lIIIllllIlIIl[0])) {
            void lllllllllllllllIIIIIIllIlllllIIl;
            int lllllllllllllllIIIIIIllIlllllIII = lIIIllllIlIIl[1];
            while (j.lIlIIlIllIlIlIl(lllllllllllllllIIIIIIllIlllllIII, lllllllllllllllIIIIIIllIlllllIIl.size())) {
                void lllllllllllllllIIIIIIllIlllllIlI;
                if (j.lIlIIlIllIllIII(((Player)lllllllllllllllIIIIIIllIlllllIIl.get(lllllllllllllllIIIIIIllIlllllIII)).equals(Players.getLocal()) ? 1 : 0)) {
                    "".length();
                    if ("   ".length() != "   ".length()) {
                        return ((102 + 14 - -66 + 72 ^ 35 + 149 - 66 + 60) & (0x43 ^ 0x1E ^ (0x4F ^ 0x5E) ^ -" ".length())) != 0;
                    }
                } else if (j.lIlIIlIllIllIII(lllllllllllllllIIIIIIllIlllllIlI.contains(((Player)lllllllllllllllIIIIIIllIlllllIIl.get(lllllllllllllllIIIIIIllIlllllIII)).getWorldLocation()) ? 1 : 0)) {
                    return lIIIllllIlIIl[0];
                }
                ++lllllllllllllllIIIIIIllIlllllIII;
                "".length();
                if (-"   ".length() <= 0) continue;
                return ((0x36 ^ 0x6C) & ~(0x2A ^ 0x70)) != 0;
            }
        }
        return lIIIllllIlIIl[1];
    }

    private static String lIlIIlIllIlIIlI(String lllllllllllllllIIIIIIllIllIlIlll, String lllllllllllllllIIIIIIllIllIlIllI) {
        lllllllllllllllIIIIIIllIllIlIlll = new String(Base64.getDecoder().decode(lllllllllllllllIIIIIIllIllIlIlll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIIIIIllIllIllIlI = new StringBuilder();
        char[] lllllllllllllllIIIIIIllIllIllIIl = lllllllllllllllIIIIIIllIllIlIllI.toCharArray();
        int lllllllllllllllIIIIIIllIllIllIII = lIIIllllIlIIl[1];
        char[] lllllllllllllllIIIIIIllIllIlIIlI = lllllllllllllllIIIIIIllIllIlIlll.toCharArray();
        int lllllllllllllllIIIIIIllIllIlIIIl = lllllllllllllllIIIIIIllIllIlIIlI.length;
        int lllllllllllllllIIIIIIllIllIlIIII = lIIIllllIlIIl[1];
        while (j.lIlIIlIllIlIlIl(lllllllllllllllIIIIIIllIllIlIIII, lllllllllllllllIIIIIIllIllIlIIIl)) {
            char lllllllllllllllIIIIIIllIllIlllIl = lllllllllllllllIIIIIIllIllIlIIlI[lllllllllllllllIIIIIIllIllIlIIII];
            lllllllllllllllIIIIIIllIllIllIlI.append((char)(lllllllllllllllIIIIIIllIllIlllIl ^ lllllllllllllllIIIIIIllIllIllIIl[lllllllllllllllIIIIIIllIllIllIII % lllllllllllllllIIIIIIllIllIllIIl.length]));
            "".length();
    ...
    static NPC am() {
        ...
        if (j.lIlIIlIllIlIlll(list)) {
            void lllllllllllllllIIIIIIlllIIIIIIII;
            ...
            int lllllllllllllllIIIIIIllIlllllllI = lIIIllllIlIIl[1];
            while (j.lIlIIlIllIlIlIl(lllllllllllllllIIIIIIllIlllllllI, lllllllllllllllIIIIIIlllIIIIIIII.size())) {
                void lllllllllllllllIIIIIIllIllllllll;
                if (j.lIlIIlIllIllIII(lllllllllllllllIIIIIIllIllllllll.contains(((NPC)lllllllllllllllIIIIIIlllIIIIIIII.get(lllllllllllllllIIIIIIllIlllllllI)).getWorldLocation()) ? 1 : 0)) {
                    return (NPC)lllllllllllllllIIIIIIlllIIIIIIII.get(lllllllllllllllIIIIIIllIlllllllI);
                }
                ++lllllllllllllllIIIIIIllIlllllllI;
                "".length();
    ...
    public static void ao() {
        void lllllllllllllllIIIIIIllIllllIllI;
        int n2 = e.c(lIIIllllIlIIl[0], lIIIllllIlIIl[13]);
        if (j.lIlIIlIlllIIIIl(n2, lIIIllllIlIIl[0])) {
            bU = bE;
            bK = bF;
        }
        if (j.lIlIIlIlllIIIIl((int)lllllllllllllllIIIIIIllIllllIllI, lIIIllllIlIIl[3])) {
            bU = bL;
            bK = bM;
        }
        if (j.lIlIIlIlllIIIIl((int)lllllllllllllllIIIIIIllIllllIllI, lIIIllllIlIIl[10])) {
            bU = bN;
            bK = bO;
        }
        if (j.lIlIIlIlllIIIIl((int)lllllllllllllllIIIIIIllIllllIllI, lIIIllllIlIIl[12])) {
            bU = bP;
            bK = bQ;
        }
        if (j.lIlIIlIlllIIIIl((int)lllllllllllllllIIIIIIllIllllIllI, lIIIllllIlIIl[13])) {
            bU = bR;
            bK = bS;
        }
    }
    ...
    private static String lIlIIlIllIlIIIl(String lllllllllllllllIIIIIIllIllIIIlll, String lllllllllllllllIIIIIIllIllIIIlII) {
        try {
            SecretKeySpec lllllllllllllllIIIIIIllIllIIlIlI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIIIIIllIllIIIlII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            return new String(lllllllllllllllIIIIIIllIllIIlIIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIIIllIllIIIlll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
