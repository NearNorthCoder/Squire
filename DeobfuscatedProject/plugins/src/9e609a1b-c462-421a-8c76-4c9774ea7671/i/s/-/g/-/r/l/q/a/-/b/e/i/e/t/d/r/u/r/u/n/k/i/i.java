...
implements M {
    ...
    private static void lIlIIlIlIIlIIll() {
        ...
        i.lIIIllllIIIII[1] = " ".length();
        i.lIIIllllIIIII[2] = "  ".length();
        i.lIIIllllIIIII[3] = "   ".length();
                    ...
                    block27: {
                                    ...
                                    block24: {
                                        block19: {
                                            ...
                                            block20: {
                                                ...
                                                n5 = lIIIllllIIIII[1];
                                                "".length();
                                                if ("  ".length() <= (0xED ^ 0x9B ^ (0x7D ^ 0xF))) return n5 != 0;
                                                return ((0xA4 ^ 0xC5 ^ (0xDD ^ 0xA8)) & (0xB7 ^ 0xAD ^ (0xCD ^ 0xC3) ^ -" ".length())) != 0;
                                            }
                                            n5 = lIIIllllIIIII[0];
                                            return n5 != 0;
                                        }
                        ...
                        if (i.lIlIIlIlIIlIlII(Bank.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (i.lIlIIlIlIIlIlII(Bank.contains((int[])nArray14) ? 1 : 0)) {
                                n3 = lIIIllllIIIII[1];
                                "".length();
                                if (-" ".length() != (91 + 43 - 2 + 8 ^ 23 + 60 - 61 + 114)) return n3 != 0;
                                return ((0x72 ^ 0x22 ^ "   ".length()) & (239 + 60 - 284 + 226 ^ 35 + 128 - 38 + 37 ^ -" ".length())) != 0;
                            }
                        }
                    }
                    n3 = lIIIllllIIIII[0];
                    ...
                    block27: {
                                    ...
                                    block24: {
                                        block19: {
                                            ...
                                            block20: {
                                                ...
                                                return ((102 + 149 - 143 + 123 ^ 112 + 158 - 260 + 185) & (0x32 ^ 0x4C ^ (0x11 ^ 0x4B) ^ -" ".length())) != 0;
                                            }
                                            n5 = lIIIllllIIIII[0];
                                            return n5 != 0;
                                        }
                        ...
                        if (i.lIlIIlIlIIlIlII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (i.lIlIIlIlIIlIlII(Inventory.contains((int[])nArray14) ? 1 : 0)) {
                                n3 = lIIIllllIIIII[1];
                                "".length();
                                if ((9 + 167 - 158 + 153 ^ 45 + 174 - 142 + 98) != -" ".length()) return n3 != 0;
                                return ((0x74 ^ 0x54 ^ (0xC4 ^ 0xB4)) & (0x3A ^ 0x56 ^ (0x79 ^ 0x45) ^ -" ".length())) != 0;
                            }
                        }
                    }
                    n3 = lIIIllllIIIII[0];
        ...
        if (i.lIlIIlIlIIlllIl(Players.getLocal().getInteracting())) {
            ...
            List lllllllllllllllIIIIIlIIIlIIlIlII = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                ...
                if (i.lIlIIlIlIIllllI(nPC.getInteracting(), Players.getLocal())) {
                    ...
                    "".length();
                    if (-"   ".length() >= 0) {
                        return ((0x8A ^ 0xC6 ^ (0xB3 ^ 0x9C)) & (38 + 78 - -38 + 13 ^ 61 + 49 - -73 + 13 ^ -" ".length())) != 0;
                    }
                } else {
                    bl = lIIIllllIIIII[0];
                }
                                ...
                                if (i.lIlIIlIlIIlIlIl(Inventory.getCount((int[])nArray2), lIIIllllIIIII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (i.lIlIIlIlIIllIII(Inventory.getCount((int[])nArray))) {
                                            bl = lIIIllllIIIII[1];
                                            "".length();
                                            if (((0xF5 ^ 0xAB ^ (7 ^ 0x51)) & (0xD6 ^ 0xB3 ^ (0x67 ^ 0xA) ^ -" ".length())) >= " ".length()) {
                                                return ((0x61 ^ 0x3D ^ (0xCC ^ 0xBD)) & (133 + 140 - 199 + 79 ^ 159 + 122 - 140 + 39 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIIllllIIIII[0];
                                        }
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (i.lIlIIlIlIIllIII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            if ((0x4E ^ 0x54 ^ (0x5E ^ 0x40)) == 0) {
                                                return ((4 ^ 0x77 ^ (0x65 ^ 0x45)) & (142 + 170 - 294 + 235 ^ 101 + 83 - 104 + 94 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIIllllIIIII[0];
                                        }
                                ...
                                if (i.lIlIIlIlIIlIlIl(Inventory.getCount((int[])nArray8), lIIIllllIIIII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (i.lIlIIlIlIIllIII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (null != null) {
                                                return ((0x7B ^ 0x74 ^ (0x14 ^ 0x51)) & (77 + 158 - 85 + 65 ^ 34 + 135 - 24 + 12 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIIllllIIIII[0];
                                        }
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (i.lIlIIlIlIIlllll(Skills.getExperience((Skill)Skill.MAGIC), lllllllllllllllIIIIIlIIIlIIllIII)) {
                                    ...
                                    if ((91 + 136 - 215 + 154 ^ 80 + 5 - -6 + 71) == 0) {
                                        return ((120 + 6 - 69 + 113 ^ 130 + 72 - 175 + 119) & (0x1D ^ 0x43 ^ (0x27 ^ 0x41) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIllllIIIII[0];
                                }
                        ...
                        if (i.lIlIIlIlIIlIlll(lllllllllllllllIIIIIlIIIlIIllIlI) && i.lIlIIlIlIIlIlll(lllllllllllllllIIIIIlIIIlIIllIIl) && i.lIlIIlIlIIllIlI(Players.getLocal().getAnimation(), lIIIllllIIIII[27])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (i.lIlIIlIlIIlllll(Skills.getExperience((Skill)Skill.MAGIC), lllllllllllllllIIIIIlIIIlIIllIII)) {
                                    bl = lIIIllllIIIII[1];
                                    "".length();
                                    if (((131 + 8 - 47 + 137 ^ 101 + 67 - 26 + 26) & (0x46 ^ 0x20 ^ (0x9A ^ 0xB1) ^ -" ".length())) != 0) {
                                        return ((55 + 200 - 170 + 129 ^ 28 + 7 - -39 + 67) & (0x61 ^ 0x21 ^ (0x30 ^ 0x2B) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIllllIIIII[0];
                                }
    ...
    private static void lIlIIlIlIIlIIlI() {
        ...
        i.lIIIlllIllIll[i.lIIIllllIIIII[0]] = i.lIlIIlIIlllIIlI("LAQLDj8JURsTNAMC", "nqrgQ");
        i.lIIIlllIllIll[i.lIIIllllIIIII[1]] = i.lIlIIlIIlllIIll("SxSQolnAqiUpqma0mN32NYOLxYMJ+/YMGDi+uINxdxjtji5TtCthwOi+3OuZ0M+825miKxGkY08=", "nvdKn");
        i.lIIIlllIllIll[i.lIIIllllIIIII[2]] = i.lIlIIlIIlllIIll("FKeSYn3Wld8vSmjQ7aG0lgxlQvDZLg3d", "kApIf");
        i.lIIIlllIllIll[i.lIIIllllIIIII[3]] = i.lIlIIlIIlllIIlI("Oi4DNTQbIQpxOhMhBjg2FQ==", "rOmQX");
        i.lIIIlllIllIll[i.lIIIllllIIIII[5]] = i.lIlIIlIIlllIIll("Dp9wcfJ+XeTCoTECeWm8DU56sacu2s+6vhRSo5AmDyCRF3fV3sUi4qLRECW01PdK", "nuLUK");
        i.lIIIlllIllIll[i.lIIIllllIIIII[17]] = i.lIlIIlIIlllIlII("ADttcLNGBuvbxpr19AHJUA==", "IOjeB");
        i.lIIIlllIllIll[i.lIIIllllIIIII[24]] = i.lIlIIlIIlllIIlI("Ch0GBSogABwDaSgGBRc=", "KirdI");
        i.lIIIlllIllIll[i.lIIIllllIIIII[26]] = i.lIlIIlIIlllIIlI("BwoEBAAqDFcGCDYZGBMCZB8SHAw=", "Dkwpi");
        i.lIIIlllIllIll[i.lIIIllllIIIII[29]] = i.lIlIIlIIlllIIll("fMgMvmchaFPyvhH7noGD7Q79cuux2q1L", "YVhwS");
        i.lIIIlllIllIll[i.lIIIllllIIIII[31]] = i.lIlIIlIIlllIlII("WjyZk4Q8L8O5/f2B1lCI0kUnxMNuPaaN", "mSuvL");
        i.lIIIlllIllIll[i.lIIIllllIIIII[32]] = i.lIlIIlIIlllIlII("RIf3SfA5K0OOr9ffbzgOfDVvWyM+fSgb", "RknnS");
        i.lIIIlllIllIll[i.lIIIllllIIIII[33]] = i.lIlIIlIIlllIIlI("OxoQHCYUEQ==", "zvstO");
        i.lIIIlllIllIll[i.lIIIllllIIIII[34]] = i.lIlIIlIIlllIIll("X3hl84U9NPE=", "uQQwN");
        i.lIIIlllIllIll[i.lIIIllllIIIII[36]] = i.lIlIIlIIlllIIlI("AB8mFXY5H3AROi4YcAMmIgQ=", "MpPpV");
        i.lIIIlllIllIll[i.lIIIllllIIIII[40]] = i.lIlIIlIIlllIIlI("DTQseD0sdTk3PjA=", "CUZXI");
        i.lIIIlllIllIll[i.lIIIllllIIIII[41]] = i.lIlIIlIIlllIlII("xnUKWfA89Dg=", "XGmco");
        i.lIIIlllIllIll[i.lIIIllllIIIII[42]] = i.lIlIIlIIlllIIlI("EBgE", "SwsjY");
        i.lIIIlllIllIll[i.lIIIllllIIIII[43]] = i.lIlIIlIIlllIIll("+bMs3rdRkPE=", "aLMGr");
        i.lIIIlllIllIll[i.lIIIllllIIIII[45]] = i.lIlIIlIIlllIIlI("DCAlFzsmPT8ReC47JgU=", "MTQvX");
        i.lIIIlllIllIll[i.lIIIllllIIIII[46]] = i.lIlIIlIIlllIIlI("MQAOEhUb", "ptzsv");
        i.lIIIlllIllIll[i.lIIIllllIIIII[47]] = i.lIlIIlIIlllIIlI("LzxkKhULMCU9", "fRDIz");
        i.lIIIlllIllIll[i.lIIIllllIIIII[51]] = i.lIlIIlIIlllIlII("mvWQxH5a1pLk7ySjgqNpm8Y3dYB/bY+X", "mNRTA");
        i.lIIIlllIllIll[i.lIIIllllIIIII[52]] = i.lIlIIlIIlllIIlI("EBIXCiA2WgsVNj8W", "SzxeS");
        i.lIIIlllIllIll[i.lIIIllllIIIII[54]] = i.lIlIIlIIlllIlII("Fc/qhEWQnNdLhY9KzbPV7Q==", "xCWbv");
        i.lIIIlllIllIll[i.lIIIllllIIIII[55]] = i.lIlIIlIIlllIIll("qI66J32Dj5R3lcm9Ozb7iQ==", "SiDmj");
        i.lIIIlllIllIll[i.lIIIllllIIIII[19]] = i.lIlIIlIIlllIlII("qXumnKFOA+4tY4W9lW0YtQ==", "wfysh");
        i.lIIIlllIllIll[i.lIIIllllIIIII[50]] = i.lIlIIlIIlllIIll("bylYs0bO5rrpkif9W09+oA==", "rQwvW");
        i.lIIIlllIllIll[i.lIIIllllIIIII[56]] = i.lIlIIlIIlllIIll("jIEAARI9LLExDAZTyir82g==", "ayVXs");
        i.lIIIlllIllIll[i.lIIIllllIIIII[72]] = i.lIlIIlIIlllIIlI("Gi8jHjp3OjYWMDknKhA=", "WNDwY");
        i.lIIIlllIllIll[i.lIIIllllIIIII[74]] = i.lIlIIlIIlllIIlI("JyoEJmg6JUo2LTQvHilofQ==", "UCjAH");
        i.lIIIlllIllIll[i.lIIIllllIIIII[75]] = i.lIlIIlIIlllIlII("+9Na7cqk2cU=", "YElVq");
    }
