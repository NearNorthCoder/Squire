...
implements M {
    ...
    private static void lIlIIlIIlIIlIIl() {
        ...
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[0]] = F.lIlIIlIIlIIIIll("DTkAORcobBAkHCI/", "OLyPy");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[1]] = F.lIlIIlIIlIIIlII("KkFwN+tRPhcp81Rh6hA9E+bcn5/70HLws6otwAOxyVCqMKDWn4hnCSYvJ8G9yQ68", "FaDIM");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[3]] = F.lIlIIlIIlIIIlIl("lCHo6ZW2PDM=", "WTNzv");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[6]] = F.lIlIIlIIlIIIIll("GysZSj46ag0LJD4=", "UJojJ");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[7]] = F.lIlIIlIIlIIIlIl("ALmDd8NxHpFr/lO1tttMTPNdaaNek+I/", "sywAw");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[10]] = F.lIlIIlIIlIIIlII("HUf7O8WrUUMu1YEO94D4UkPPDoC/9ZYyfXYlWD+bugaIK/nFqfcjedvDZkqxJictTLZ/2703ph0=", "NEmaQ");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[14]] = F.lIlIIlIIlIIIlIl("sF3N9IOnX650SIPrSrG4xA==", "WCKtd");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[15]] = F.lIlIIlIIlIIIlII("i3Kde/y1yDB2cfGq8HLkIA==", "yYnKr");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[13]] = F.lIlIIlIIlIIIlII("RHhnogwklJc=", "EJJjc");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[16]] = F.lIlIIlIIlIIIIll("IS80JQ==", "vJUWA");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[12]] = F.lIlIIlIIlIIIlIl("/P5wIgrrqTQ7Y6lDhdza7g==", "NCUrW");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[17]] = F.lIlIIlIIlIIIlIl("f6UikcZJg3JZNVZYnks6Sw==", "WAGOT");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[18]] = F.lIlIIlIIlIIIlIl("E7x4RtcwzXU=", "UgDHD");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[19]] = F.lIlIIlIIlIIIlII("h5a3w+rguhY=", "WOMfv");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[21]] = F.lIlIIlIIlIIIlII("oKnd+Fz6UPoRndDoQ4UlHg==", "IYimr");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[22]] = F.lIlIIlIIlIIIlIl("v8Z7qcZEQqhg5AYOFVLOaA==", "CNFma");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[23]] = F.lIlIIlIIlIIIlII("WSzp6JlKVdI=", "QUeBv");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[25]] = F.lIlIIlIIlIIIIll("LzsuRhMOej4HEwk/Kg==", "aZXfg");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[26]] = F.lIlIIlIIlIIIIll("NRQcH2onFAQcLzM=", "AuptJ");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[27]] = F.lIlIIlIIlIIIIll("JTgVKRYReS0gBBE8DyIW", "cYaAs");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[20]] = F.lIlIIlIIlIIIlIl("e5swjk9w8c1PAlUJIR7UZyyMSG6M5DRx", "KAcGA");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[29]] = F.lIlIIlIIlIIIlII("9823vfa6MLRCzefmBXD0PQ==", "ukLDu");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[30]] = F.lIlIIlIIlIIIlIl("2O7PvrhZstwNSGxSfAtMIg==", "dlKVI");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[31]] = F.lIlIIlIIlIIIlIl("zCi1y0Sn90LEcfOGL6aPaQ==", "hKDCK");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[32]] = F.lIlIIlIIlIIIlII("XNcFuT0Xm9wZrK5bH4zIEsuTaj24afRS", "Mofum");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[33]] = F.lIlIIlIIlIIIlII("ZrKIwjZxwIc37+kDmQM4kA==", "gkwTF");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[34]] = F.lIlIIlIIlIIIlII("HhVlUfUlieV0XDA54gjdAA==", "MrSPf");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[35]] = F.lIlIIlIIlIIIlII("gI3egce003EDhDGsWUFE1w==", "OCJFk");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[36]] = F.lIlIIlIIlIIIIll("AhQmDiAgVTIAIigaLA==", "AuBoV");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[37]] = F.lIlIIlIIlIIIIll("GhQXJg==", "MqvTe");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[24]] = F.lIlIIlIIlIIIIll("KBEnYTsJUDs0Iw8VJQ==", "fpQAO");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[38]] = F.lIlIIlIIlIIIIll("GjsND046NUEOGyIzBBA=", "NZadn");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[39]] = F.lIlIIlIIlIIIlIl("hLlySNiHlxI=", "WCpIZ");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[40]] = F.lIlIIlIIlIIIlIl("Kucb6Ml4uik=", "HRUxK");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[42]] = F.lIlIIlIIlIIIlIl("QSQU2xeeizOGN885UAmdIA==", "WUrZG");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[43]] = F.lIlIIlIIlIIIIll("DCcLCzkiJwsFajs7ABE+", "JNebJ");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[44]] = F.lIlIIlIIlIIIIll("PQYZDzg=", "oitjW");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[45]] = F.lIlIIlIIlIIIIll("KQMgbjcIQjQvLQw=", "gbVNC");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[46]] = F.lIlIIlIIlIIIIll("BQM2PTYkDD95OCwMMzA0Kg==", "MbXYZ");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[47]] = F.lIlIIlIIlIIIIll("Pzx3DhANeToGERswOQhCGSwyHBZIKiIfEgQwMhxOSCogBhYLMT4BBUgtOE8gPQAeISU=", "hYWob");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[28]] = F.lIlIIlIIlIIIlIl("mHUpLhANkr0tAcQ29Iz+tpnHCCYX4Jc1", "vAXsM");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[54]] = F.lIlIIlIIlIIIlIl("FOJSc0NUA5gASNf24JAzBYESYR8gIoec", "NAlxs");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[55]] = F.lIlIIlIIlIIIlIl("JsVfW4DBm+k=", "yDjqX");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[58]] = F.lIlIIlIIlIIIlIl("V6Rq8Askr6s=", "MEaVj");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[59]] = F.lIlIIlIIlIIIIll("HAAkHA==", "XoKny");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[60]] = F.lIlIIlIIlIIIlII("71SjWhrgIXo=", "KVXBP");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[69]] = F.lIlIIlIIlIIIlII("rsEVLwL453HBwsjEPFcPY1igczQrMCu6aPRNALkgmn8=", "MWMVQ");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[70]] = F.lIlIIlIIlIIIIll("ACwmfGE2InlwCH4lOXAtPD11OCQraT4+Li5n", "YIUPA");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[71]] = F.lIlIIlIIlIIIlII("JQdtXmKaT3lvw0rvZyvzwg==", "iRmts");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[72]] = F.lIlIIlIIlIIIIll("IRgNGVoUGw4HDlUKDh8fAREIHB1VHA0BH1s=", "uyarz");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[2]] = F.lIlIIlIIlIIIlII("Wn04P0XvwoWHGLhL1ypJH6PkhvaVC3j2fAdoWm3SojY=", "RNHop");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[73]] = F.lIlIIlIIlIIIlIl("9/J9z0zynix5KhkrW11Htw==", "bCkjK");
        F.lIIIlllIlIlII[F.lIIIlllIlIllI[74]] = F.lIlIIlIIlIIIIll("NTE4RA==", "lTKjp");
    }
                        ...
                        lllllllllllllllIIIIIlIlIlIlllIlI = TileObjects.getNearest(tileObject -> {
                            ...
                            if (F.lIlIIlIIlIIlIll(tileObject.getName().contains(lIIIlllIlIlII[lIIIlllIlIllI[55]]) ? 1 : 0) && F.lIlIIlIIlIlIIIl(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIIlllIlIllI[56], lIIIlllIlIllI[57], lIIIlllIlIllI[1])), lIIIlllIlIllI[3])) {
                                ...
                                if (F.lIlIIlIIlIIlIll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                                    n2 = lIIIlllIlIllI[1];
                                    "".length();
                                    if ("   ".length() != (0xB5 ^ 0x87 ^ (0xAB ^ 0x9D))) return n2 != 0;
                                    return ((165 + 149 - 202 + 65 ^ 109 + 45 - 100 + 91) & (0x3B ^ 0x75 ^ (0xE ^ 0x60) ^ -" ".length())) != 0;
                                }
                            }
                            n2 = lIIIlllIlIllI[0];
                            return n2 != 0;
    ...
    private static void lIlIIlIIlIIlIlI() {
        ...
        F.lIIIlllIlIllI[1] = " ".length();
        F.lIIIlllIlIllI[2] = 0xA1 ^ 0x93;
        F.lIIIlllIlIllI[3] = "  ".length();
        F.lIIIlllIlIllI[4] = 0xFFFFEFF7 & 0x13EB;
        F.lIIIlllIlIllI[5] = 22 + 46 - -13 + 63;
        F.lIIIlllIlIllI[6] = "   ".length();
        F.lIIIlllIlIllI[7] = " ".length() ^ (0xC5 ^ 0xC0);
