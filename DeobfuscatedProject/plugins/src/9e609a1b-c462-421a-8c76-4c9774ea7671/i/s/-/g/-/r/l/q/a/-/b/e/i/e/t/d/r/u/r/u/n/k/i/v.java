...
implements M {
    ...
    public static void bl() {
        block22: {
            BankLocation lllllllllllllllIIIIIlIIIllllIIII;
            block23: {
                block27: {
                    block25: {
                        block26: {
                            block24: {
                                ...
                                lllllllllllllllIIIIIlIIIllllIIII = BankLocation.getNearest();
                                if (v.lIlIIlIlIIIlIll(lllllllllllllllIIIIIlIIIllllIIII) && v.lIlIIlIlIIIlIIl(lllllllllllllllIIIIIlIIIllllIIII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    AccBuilderRat.c = lIIIlllIlllIl[lIIIlllIllllI[5]];
                                    a.a(lllllllllllllllIIIIIlIIIllllIIII);
                                    Time.sleepTicks((int)lIIIlllIllllI[3]);
                                    "".length();
                                }
                                if (!v.lIlIIlIlIIIlIll(lllllllllllllllIIIIIlIIIllllIIII) || !v.lIlIIlIlIIIIlll(lllllllllllllllIIIIIlIIIllllIIII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block23;
            ...
            if ((!v.lIlIIlIlIIIlIIl(v.S() ? 1 : 0) || v.lIlIIlIlIIIlllI(Players.getLocal().getWorldLocation().distanceTo(fJ), lIIIlllIllllI[12])) && v.lIlIIlIlIIIlIII(e.j(lIIIlllIllllI[4]), lIIIlllIllllI[14])) {
                ...
                if (v.lIlIIlIlIIIlllI(Players.getLocal().getWorldLocation().distanceTo(fJ), lIIIlllIllllI[9])) {
                    ...
                    lllllllllllllllIIIIIlIIIllllIIII = TileObjects.getNearest((String[])stringArray);
                    if (v.lIlIIlIlIIIlIll(lllllllllllllllIIIIIlIIIllllIIII)) {
                        String[] stringArray2 = new String[lIIIlllIllllI[1]];
                        stringArray2[v.lIIIlllIllllI[0]] = lIIIlllIlllIl[lIIIlllIllllI[18]];
                        if (v.lIlIIlIlIIIIlll(lllllllllllllllIIIIIlIIIllllIIII.hasAction(stringArray2) ? 1 : 0)) {
                            lllllllllllllllIIIIIlIIIllllIIII.interact(lIIIlllIlllIl[lIIIlllIllllI[19]]);
    ...
    private static void lIlIIlIlIIIIllI() {
        ...
        v.lIIIlllIllllI[0] = (31 + 19 - -171 + 23 ^ 155 + 76 - 129 + 70) & (0x90 ^ 0x84 ^ (0x27 ^ 0x6B) ^ -" ".length());
        v.lIIIlllIllllI[1] = " ".length();
        v.lIIIlllIllllI[2] = 0x82 ^ 0xA2 ^ (0xA0 ^ 0xB2);
        v.lIIIlllIllllI[3] = "  ".length();
        v.lIIIlllIllllI[4] = 0x2A ^ 0x35;
        v.lIIIlllIllllI[5] = "   ".length();
    ...
    private static void W() {
        d lllllllllllllllIIIIIlIIIlllIlIlI;
        Object lllllllllllllllIIIIIlIIIlllIlIll;
        block17: {
            block16: {
                block15: {
                    block14: {
                        block13: {
                            ...
                            lllllllllllllllIIIIIlIIIlllIlIll = new d(lIIIlllIllllI[8], lIIIlllIllllI[9], lIIIlllIllllI[24]);
                            bA.add((d)lllllllllllllllIIIIIlIIIlllIlIll);
                            "".length();
                        }
                        int[] nArray = new int[lIIIlllIllllI[1]];
                        nArray[v.lIIIlllIllllI[0]] = lIIIlllIllllI[10];
                    ...
                    lllllllllllllllIIIIIlIIIlllIlIll = new d(lIIIlllIllllI[10], lIIIlllIllllI[3], lIIIlllIllllI[24]);
                    bA.add((d)lllllllllllllllIIIIIlIIIlllIlIll);
                    "".length();
                }
                int[] nArray = new int[lIIIlllIllllI[1]];
            ...
            lllllllllllllllIIIIIlIIIlllIlIll = new d(lIIIlllIllllI[11], lIIIlllIllllI[6], lIIIlllIllllI[24]);
            bA.add((d)lllllllllllllllIIIIIlIIIlllIlIll);
            "".length();
        }
        int[] nArray = new int[lIIIlllIllllI[1]];
        ...
        if (v.lIlIIlIlIIIlIIl(Bank.contains((int[])nArray) ? 1 : 0)) {
            lllllllllllllllIIIIIlIIIlllIlIll = new d(lIIIlllIllllI[13], lIIIlllIllllI[12], lIIIlllIllllI[7]);
            bA.add((d)lllllllllllllllIIIIIlIIIlllIlIll);
            "".length();
        }
        if (v.lIlIIlIlIIIlIIl(Bank.contains((Predicate)(lllllllllllllllIIIIIlIIIlllIlIll = item -> item.getName().toLowerCase().contains(lIIIlllIlllIl[lIIIlllIllllI[31]]))) ? 1 : 0)) {
            lllllllllllllllIIIIIlIIIlllIlIlI = new d(lIIIlllIllllI[25], lIIIlllIllllI[12], lIIIlllIllllI[26]);
            bA.add(lllllllllllllllIIIIIlIIIlllIlIlI);
            "".length();
        }
        ...
        if (v.lIlIIlIlIIIlIIl(Bank.contains((int[])nArray8) ? 1 : 0)) {
            lllllllllllllllIIIIIlIIIlllIlIlI = new d(lIIIlllIllllI[27], lIIIlllIllllI[28], lIIIlllIllllI[29]);
            bA.add(lllllllllllllllIIIIIlIIIlllIlIlI);
            "".length();
        }
    }
    ...
    private static void lIlIIlIlIIIIlIl() {
        ...
        v.lIIIlllIlllIl[v.lIIIlllIllllI[0]] = v.lIlIIlIlIIIIIlI("1/+1f558mzi2YolpdA8zWw==", "Ulfwl");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[1]] = v.lIlIIlIlIIIIIlI("RrdywXVouG/Zgk8+l1RiMn3jTqUrl2kLWPI6wjKdHFXPIstioPPKhFvKbSYNBCTL", "ZuGpG");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[3]] = v.lIlIIlIlIIIIIll("LzANJSo=", "kBdKA");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[5]] = v.lIlIIlIlIIIIlII("wwpujdJ6osBIq67qYQCEhQ==", "PFimI");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[6]] = v.lIlIIlIlIIIIIll("LTUgMiIMOil2LAQ6JT8gAg==", "eTNVN");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[12]] = v.lIlIIlIlIIIIIlI("xzO3UTdBeax98ByacUaCH9EPpQBQwqKBdNXadHhFgV7I4iTv3YzdCkONwA2ZtGJh47IagE/8FiU=", "qvEyf");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[9]] = v.lIlIIlIlIIIIIlI("NGgv4w9pHUzvH2YlBMoOGreOLm8BGQR7ZCHbHaQlCbyqxARkEbiUNB7hHry4vjeaaUFxAvAibvQ=", "CIUNk");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[15]] = v.lIlIIlIlIIIIIll("PCo9VTkdazgBLAA/", "rKKuM");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[16]] = v.lIlIIlIlIIIIlII("Itj2ewnPiRw7ENeGWFtC4g==", "kDxZw");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[17]] = v.lIlIIlIlIIIIIll("NgIoEQ==", "rmGcp");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[18]] = v.lIlIIlIlIIIIIll("HiMkNw==", "QSAYT");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[19]] = v.lIlIIlIlIIIIIlI("cn14CDKUUw8=", "WEuED");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[20]] = v.lIlIIlIlIIIIIlI("U/jazuPJe9E=", "YxUTx");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[21]] = v.lIlIIlIlIIIIlII("79KwCal2moxnlc2tDOVt3w==", "nnZym");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[22]] = v.lIlIIlIlIIIIIll("KgQiHiMLCytaLQMLJxMhBQ==", "beLzO");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[23]] = v.lIlIIlIlIIIIIlI("bWrSMSLjpXNpxDoKZxtdYPKlAonsrUCv+/8J53gcG3XCGMPK5y1Fk/6vczJxZ1B7sLJiJ4Lfq1I=", "wKjtl");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[30]] = v.lIlIIlIlIIIIIll("LhUkLyQZWiczIhkO", "jzVFG");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[31]] = v.lIlIIlIlIIIIIlI("IoaPOQmqoN4JNw30b06xjF21GCjMGGNu", "aISpn");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[34]] = v.lIlIIlIlIIIIlII("vuFS2BOw+qf33pSMSE+osvOVo8eBKp+67PaLVYSYIXo=", "lArJC");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[35]] = v.lIlIIlIlIIIIlII("b1CWRIiRnnfVu3lw/6Ih+tARGSXmnJsv4Ldo1e4CyQkePjfzVOOE1w==", "opiIX");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[36]] = v.lIlIIlIlIIIIlII("9fHUobo1m10eOUt7ezq7vLF0RZ970+wCv/Ks9TKZTvs=", "QzNsk");
        v.lIIIlllIlllIl[v.lIIIlllIllllI[37]] = v.lIlIIlIlIIIIIll("MAEcfg==", "idoPL");
    }

    private static String lIlIIlIlIIIIIll(String lllllllllllllllIIIIIlIIIllIlIIII, String lllllllllllllllIIIIIlIIIllIIllll) {
        lllllllllllllllIIIIIlIIIllIlIIII = new String(Base64.getDecoder().decode(lllllllllllllllIIIIIlIIIllIlIIII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIIIIlIIIllIIlllI = new StringBuilder();
        char[] lllllllllllllllIIIIIlIIIllIIllIl = lllllllllllllllIIIIIlIIIllIIllll.toCharArray();
        int lllllllllllllllIIIIIlIIIllIIllII = lIIIlllIllllI[0];
        char[] lllllllllllllllIIIIIlIIIllIIIllI = lllllllllllllllIIIIIlIIIllIlIIII.toCharArray();
        int lllllllllllllllIIIIIlIIIllIIIlIl = lllllllllllllllIIIIIlIIIllIIIllI.length;
        int lllllllllllllllIIIIIlIIIllIIIlII = lIIIlllIllllI[0];
        while (v.lIlIIlIlIIIlIII(lllllllllllllllIIIIIlIIIllIIIlII, lllllllllllllllIIIIIlIIIllIIIlIl)) {
            char lllllllllllllllIIIIIlIIIllIlIIIl = lllllllllllllllIIIIIlIIIllIIIllI[lllllllllllllllIIIIIlIIIllIIIlII];
            ...
            ++lllllllllllllllIIIIIlIIIllIIIlII;
            "".length();
    ...
    public boolean aa() {
        ...
        if (v.lIlIIlIlIIIllII(e.j(lIIIlllIllllI[4]), lIIIlllIllllI[14])) {
            ...
            "".length();
            if ("   ".length() > "   ".length()) {
                return ((0xCC ^ 0xC4 ^ (0x5C ^ 0x66)) & (133 + 87 - 171 + 142 ^ 111 + 132 - 212 + 110 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIlllIllllI[0];
        }
    ...
    private static String lIlIIlIlIIIIIlI(String lllllllllllllllIIIIIlIIIlIlllIll, String lllllllllllllllIIIIIlIIIlIlllIlI) {
        try {
            SecretKeySpec lllllllllllllllIIIIIlIIIlIlllllI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIIIIlIIIlIlllIlI.getBytes(StandardCharsets.UTF_8)), lIIIlllIllllI[16]), "DES");
            Cipher lllllllllllllllIIIIIlIIIlIllllIl = Cipher.getInstance("DES");
            lllllllllllllllIIIIIlIIIlIllllIl.init(lIIIlllIllllI[3], lllllllllllllllIIIIIlIIIlIlllllI);
            return new String(lllllllllllllllIIIIIlIIIlIllllIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIIlIIIlIlllIll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public int Y() {
        ...
        catch (Exception lllllllllllllllIIIIIlIIIlllIlIII) {
            lllllllllllllllIIIIIlIIIlllIlIII.printStackTrace();
        }
        if ("  ".length() >= "   ".length()) {
    ...
    private static String lIlIIlIlIIIIlII(String lllllllllllllllIIIIIlIIIllIllllI, String lllllllllllllllIIIIIlIIIllIlllIl) {
        try {
            SecretKeySpec lllllllllllllllIIIIIlIIIlllIIIll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIIIIlIIIllIlllIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIIIIIlIIIlllIIIlI = Cipher.getInstance("Blowfish");
            lllllllllllllllIIIIIlIIIlllIIIlI.init(lIIIlllIllllI[3], lllllllllllllllIIIIIlIIIlllIIIll);
            return new String(lllllllllllllllIIIIIlIIIlllIIIlI.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIIlIIIllIllllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void bm() {
        void lllllllllllllllIIIIIlIIIlllIlllI;
        ...
        if (v.lIlIIlIlIIIlIll(lllllllllllllllIIIIIlIIIlllIlllI) && v.lIlIIlIlIIIIlll(lllllllllllllllIIIIIlIIIlllIlllI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
