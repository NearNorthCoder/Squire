...
extends Task {
    ...
    private static void lIlIIIIllllIlIl() {
        ...
        m.lIIIllIIlIllI[1] = " ".length();
        m.lIIIllIIlIllI[2] = "  ".length();
    ...
    public boolean run() {
        m lllllllllllllllIIIIlIlIlIlllIlII;
        if (m.lIlIIIIllllIllI((Object)this.al.quest(), (Object)h.BELOW_ICE_MOUNTAIN)) {
            return lIIIllIIlIllI[0];
        }
        if (m.lIlIIIIllllIlll(lllllllllllllllIIIIlIlIlIlllIlII.a(Quest.BELOW_ICE_MOUNTAIN.getId()))) {
            // empty if block
        }
