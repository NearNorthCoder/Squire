...
extends Task {
    ...
    private void bx() {
        ...
        TileItem lllllllllllllllIIIIlIIIlIlllllII = TileItems.getNearest((int[])nArray2);
        if (y.lIlIIIlIlllIllI(lllllllllllllllIIIIlIIIlIlllllII)) {
            lllllllllllllllIIIIlIIIlIlllllII.interact(lIIIllIlIlllI[lIIIllIlIllll[10]]);
            "".length();
            if ("  ".length() > (0x46 ^ 0x42)) {
                return;
            }
    ...
    private static String lIlIIIlIllIlllI(String lllllllllllllllIIIIlIIIlIllIIlll, String lllllllllllllllIIIIlIIIlIllIIllI) {
        lllllllllllllllIIIIlIIIlIllIIlll = new String(Base64.getDecoder().decode(lllllllllllllllIIIIlIIIlIllIIlll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIIIlIIIlIllIIlIl = new StringBuilder();
        ...
        char[] lllllllllllllllIIIIlIIIlIlIlllIl = lllllllllllllllIIIIlIIIlIllIIlll.toCharArray();
        int lllllllllllllllIIIIlIIIlIlIlllII = lllllllllllllllIIIIlIIIlIlIlllIl.length;
        int lllllllllllllllIIIIlIIIlIlIllIll = lIIIllIlIllll[0];
        while (y.lIlIIIlIllllIII(lllllllllllllllIIIIlIIIlIlIllIll, lllllllllllllllIIIIlIIIlIlIlllII)) {
            char lllllllllllllllIIIIlIIIlIllIlIII = lllllllllllllllIIIIlIIIlIlIlllIl[lllllllllllllllIIIIlIIIlIlIllIll];
            lllllllllllllllIIIIlIIIlIllIIlIl.append((char)(lllllllllllllllIIIIlIIIlIllIlIII ^ lllllllllllllllIIIIlIIIlIllIIlII[lllllllllllllllIIIIlIIIlIllIIIll % lllllllllllllllIIIIlIIIlIllIIlII.length]));
            "".length();
            ++lllllllllllllllIIIIlIIIlIllIIIll;
            ++lllllllllllllllIIIIlIIIlIlIllIll;
            "".length();
            if ("   ".length() < (0x7B ^ 8 ^ (0xF0 ^ 0x87))) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllIIIIlIIIlIllIIlIl);
    }
    ...
    private static void lIlIIIlIlllIIIl() {
        ...
        y.lIIIllIlIllll[7] = "  ".length();
        y.lIIIllIlIllll[8] = "   ".length();
    ...
    private static String lIlIIIlIllIllll(String lllllllllllllllIIIIlIIIlIlIlIIlI, String lllllllllllllllIIIIlIIIlIlIIllll) {
        try {
            SecretKeySpec lllllllllllllllIIIIlIIIlIlIlIlIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIIIlIIIlIlIIllll.getBytes(StandardCharsets.UTF_8)), lIIIllIlIllll[13]), "DES");
            Cipher lllllllllllllllIIIIlIIIlIlIlIlII = Cipher.getInstance("DES");
            lllllllllllllllIIIIlIIIlIlIlIlII.init(lIIIllIlIllll[7], lllllllllllllllIIIIlIIIlIlIlIlIl);
            return new String(lllllllllllllllIIIIlIIIlIlIlIlII.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIlIIIlIlIlIIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public boolean run() {
        y lllllllllllllllIIIIlIIIllIIIIlll;
        if (y.lIlIIIlIlllIIlI(this.bs.quest().equals((Object)h.ROMEO_AND_JULIET) ? 1 : 0)) {
            return lIIIllIlIllll[0];
        }
        int lllllllllllllllIIIIlIIIllIIIIllI = lllllllllllllllIIIIlIIIllIIIIlll.Q();
        if (y.lIlIIIlIlllIIll(lllllllllllllllIIIIlIIIllIIIIllI, lIIIllIlIllll[1])) {
            return lIIIllIlIllll[0];
        }
        System.out.println("[ROMEO_AND_JULIET] - Current Progress: " + lllllllllllllllIIIIlIIIllIIIIllI);
        switch (lllllllllllllllIIIIlIIIllIIIIllI) {
            case 0: {
                lllllllllllllllIIIIlIIIllIIIIlll.co();
                lllllllllllllllIIIIlIIIllIIIIlll.M();
                "".length();
                if (" ".length() != 0) break;
                return ((10 + 22 - -14 + 108 ^ 77 + 116 - 76 + 41) & (69 + 8 - 35 + 103 ^ 95 + 114 - 194 + 134 ^ -" ".length())) != 0;
            }
            case 10: {
                lllllllllllllllIIIIlIIIllIIIIlll.cn();
                "".length();
                if (null == null) break;
                return ((0xAF ^ 0xA6) & ~(0x62 ^ 0x6B)) != 0;
            }
            case 20: {
                lllllllllllllllIIIIlIIIllIIIIlll.P();
                lllllllllllllllIIIIlIIIllIIIIlll.cm();
                "".length();
                if (-(0xB ^ 0xE) < 0) break;
                return ((0x83 ^ 0x98) & ~(0x99 ^ 0x82)) != 0;
            }
            case 30: {
                lllllllllllllllIIIIlIIIllIIIIlll.cl();
                "".length();
                if ("  ".length() == "  ".length()) break;
                return ((0x44 ^ 0x43) & ~(0x1B ^ 0x1C)) != 0;
            }
            case 40: {
                lllllllllllllllIIIIlIIIllIIIIlll.ck();
                "".length();
                if (-(0x83 ^ 0x86) < 0) break;
                return ((0x60 ^ 0x75) & ~(0x8F ^ 0x9A)) != 0;
            }
            case 50: {
                lllllllllllllllIIIIlIIIllIIIIlll.cj();
                "".length();
                if (-"   ".length() <= 0) break;
                return ((0xB ^ 0x4D ^ (0xE5 ^ 0xB4)) & (0x10 ^ 0x1A ^ (0x8E ^ 0x93) ^ -" ".length())) != 0;
            }
            case 60: {
                lllllllllllllllIIIIlIIIllIIIIlll.Y();
                "".length();
    ...
    private void a(int n2, WorldPoint worldPoint, DialogOption ... dialogOptionArray) {
        void lllllllllllllllIIIIlIIIlIlllIlIl;
        if (y.lIlIIIlIlllIlII(Dialog.isOpen() ? 1 : 0)) {
            Dialog.invokeDialog((DialogOption[])dialogOptionArray);
            return;
        }
        int[] nArray = new int[lIIIllIlIllll[2]];
        nArray[y.lIIIllIlIllll[0]] = lllllllllllllllIIIIlIIIlIlllIlIl;
        NPC lllllllllllllllIIIIlIIIlIlllIIlI = NPCs.getNearest((int[])nArray);
        if (y.lIlIIIlIlllIllI(lllllllllllllllIIIIlIIIlIlllIIlI) && y.lIlIIIlIlllIlII(Reachable.isInteractable((Locatable)lllllllllllllllIIIIlIIIlIlllIIlI) ? 1 : 0)) {
            lllllllllllllllIIIIlIIIlIlllIIlI.interact(lIIIllIlIlllI[lIIIllIlIllll[11]]);
            "".length();
            if ("  ".length() < 0) {
                return;
            }
        } else {
            void lllllllllllllllIIIIlIIIlIlllIlII;
            System.out.println(lIIIllIlIlllI[lIIIllIlIllll[12]]);
            Walker.walkTo((WorldPoint)lllllllllllllllIIIIlIIIlIlllIlII);
            "".length();
        }
    }
    ...
    private void co() {
        ...
        TileObject lllllllllllllllIIIIlIIIlIllllllI = TileObjects.getNearest((int[])nArray2);
        if (y.lIlIIIlIlllIllI(lllllllllllllllIIIIlIIIlIllllllI) && y.lIlIIIlIlllIlII(Reachable.isInteractable((Locatable)lllllllllllllllIIIIlIIIlIllllllI) ? 1 : 0)) {
            lllllllllllllllIIIIlIIIlIllllllI.interact(lIIIllIlIlllI[lIIIllIlIllll[0]]);
            "".length();
            if (((6 ^ 0x35 ^ (0x9F ^ 0xB4)) & (73 + 131 - 114 + 56 ^ 56 + 5 - -77 + 0 ^ -" ".length())) > "  ".length()) {
                return;
            }
        } else {
    ...
    private static void lIlIIIlIlllIIII() {
        ...
        y.lIIIllIlIlllI[y.lIIIllIlIllll[0]] = y.lIlIIIlIllIlllI("Nh8KBEIABAYC", "fvioo");
        y.lIIIllIlIlllI[y.lIIIllIlIllll[2]] = y.lIlIIIlIllIllll("J98m0zCTAKo=", "jGIXo");
        y.lIIIllIlIlllI[y.lIIIllIlIllll[7]] = y.lIlIIIlIllIllll("tKwHuenc0zc=", "vXBLH");
        y.lIIIllIlIlllI[y.lIIIllIlIllll[8]] = y.lIlIIIlIllIllll("oIYXr9b9iYY=", "sBWlt");
        y.lIIIllIlIlllI[y.lIIIllIlIllll[9]] = y.lIlIIIlIllIllll("4grpMEGPhTY=", "dYoSw");
        y.lIIIllIlIlllI[y.lIIIllIlIllll[10]] = y.lIlIIIlIllIlllI("GiggKg==", "NIKOw");
        y.lIIIllIlIlllI[y.lIIIllIlIllll[11]] = y.lIlIIIlIllIlllI("GDQuGWs4Og==", "LUBrF");
        y.lIIIllIlIlllI[y.lIIIllIlIllll[12]] = y.lIlIIIlIllIllll("HGUL6PLnc073l3qgXcczkg==", "pbWFg");
    }
