...
extends Task {
     ...
     */
    private void al() {
        void lllllllllllllllIIIIlIlIIlIlIIIlI;
        ...
        if (r.lIlIIIlIIIIIlll(Inventory.contains((int[])nArray) ? 1 : 0) && r.lIlIIIlIIIIlIIl(lllllllllllllllIIIIlIlIIlIlIIIlI.getName().contains(lIIIllIIllIII[lIIIllIIllIIl[0]]) ? 1 : 0)) {
            lllllllllllllllIIIIlIlIIlIlIIIlI.interact(lIIIllIIllIII[lIIIllIIllIIl[2]]);
            return;
        }
        int[] nArray2 = new int[lIIIllIIllIIl[2]];
        nArray2[r.lIIIllIIllIIl[0]] = lIIIllIIllIIl[4];
        if (r.lIlIIIlIIIIIlll(Inventory.contains((int[])nArray2) ? 1 : 0) && r.lIlIIIlIIIIlIIl(lllllllllllllllIIIIlIlIIlIlIIIlI.getName().contains(lIIIllIIllIII[lIIIllIIllIIl[1]]) ? 1 : 0)) {
            lllllllllllllllIIIIlIlIIlIlIIIlI.interact(lIIIllIIllIII[lIIIllIIllIIl[18]]);
            return;
        }
        int[] nArray3 = new int[lIIIllIIllIIl[2]];
        nArray3[r.lIIIllIIllIIl[0]] = lIIIllIIllIIl[5];
        if (r.lIlIIIlIIIIIlll(Inventory.contains((int[])nArray3) ? 1 : 0) && r.lIlIIIlIIIIlIIl(lllllllllllllllIIIIlIlIIlIlIIIlI.getName().contains(lIIIllIIllIII[lIIIllIIllIIl[19]]) ? 1 : 0)) {
            lllllllllllllllIIIIlIlIIlIlIIIlI.interact(lIIIllIIllIII[lIIIllIIllIIl[20]]);
            return;
        }
        int[] nArray4 = new int[lIIIllIIllIIl[2]];
        nArray4[r.lIIIllIIllIIl[0]] = lIIIllIIllIIl[6];
        if (r.lIlIIIlIIIIIlll(Inventory.contains((int[])nArray4) ? 1 : 0) && r.lIlIIIlIIIIlIIl(lllllllllllllllIIIIlIlIIlIlIIIlI.getName().contains(lIIIllIIllIII[lIIIllIIllIIl[21]]) ? 1 : 0)) {
            lllllllllllllllIIIIlIlIIlIlIIIlI.interact(lIIIllIIllIII[lIIIllIIllIIl[22]]);
            return;
        }
    }
    ...
    private static void lIlIIIlIIIIIllI() {
        ...
        r.lIIIllIIllIIl[0] = (164 + 18 - -20 + 11 ^ 31 + 103 - 0 + 59) & (0x17 ^ 0x6B ^ (4 ^ 0x6C) ^ -" ".length());
        r.lIIIllIIllIIl[1] = "  ".length();
        r.lIIIllIIllIIl[2] = " ".length();
    ...
    private static void lIlIIIlIIIIIlIl() {
        ...
        r.lIIIllIIllIII[r.lIIIllIIllIIl[0]] = r.lIlIIIlIIIIIIlI("1D9jGpLq3bY=", "rTVJb");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[2]] = r.lIlIIIlIIIIIIll("NxIxBg==", "csZcp");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[1]] = r.lIlIIIlIIIIIIll("DQg8Lg4j", "TmPBa");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[18]] = r.lIlIIIlIIIIIIlI("a/OEaJNGFk0=", "BUpky");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[19]] = r.lIlIIIlIIIIIlII("tk/txOfb9KQ=", "MHTWt");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[20]] = r.lIlIIIlIIIIIIll("GDQDFg==", "LUhsK");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[21]] = r.lIlIIIlIIIIIlII("ORumr1Kt0nk=", "KRgHX");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[22]] = r.lIlIIIlIIIIIIlI("YfzXAYqu1Ig=", "wxKvG");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[23]] = r.lIlIIIlIIIIIIll("Gh09CUIeACEECSg=", "MtSmb");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[24]] = r.lIlIIIlIIIIIIlI("AFZ0Y48SAReT7ilbUNG02g==", "Vlzrg");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[14]] = r.lIlIIIlIIIIIIlI("BWrNXs/D33w=", "hIEXs");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[34]] = r.lIlIIIlIIIIIlII("px6pWtmFg10=", "cxXoA");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[40]] = r.lIlIIIlIIIIIIll("CwIPAXYrDA4ePg==", "IcajV");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[42]] = r.lIlIIIlIIIIIIlI("4/4hMe/39UA=", "qwpkB");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[43]] = r.lIlIIIlIIIIIlII("bxBn2mehjqA=", "UNFlt");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[45]] = r.lIlIIIlIIIIIIll("HQEWEio=", "IswvO");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[49]] = r.lIlIIIlIIIIIIlI("gjvuwlD9jyA=", "iKnML");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[52]] = r.lIlIIIlIIIIIIlI("vZ8aKSNgsR0=", "Hhpib");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[53]] = r.lIlIIIlIIIIIIlI("4l1/gP246mk=", "PHoAT");
        r.lIIIllIIllIII[r.lIIIllIIllIIl[54]] = r.lIlIIIlIIIIIIll("CiAuIQ==", "hEOEG");
    }
    ...
    private static String lIlIIIlIIIIIIll(String lllllllllllllllIIIIlIlIIIllIIllI, String lllllllllllllllIIIIlIlIIIllIlIlI) {
        lllllllllllllllIIIIlIlIIIllIIllI = new String(Base64.getDecoder().decode(lllllllllllllllIIIIlIlIIIllIIllI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        ...
        char[] lllllllllllllllIIIIlIlIIIllIIIIl = lllllllllllllllIIIIlIlIIIllIIllI.toCharArray();
        int lllllllllllllllIIIIlIlIIIllIIIII = lllllllllllllllIIIIlIlIIIllIIIIl.length;
        int lllllllllllllllIIIIlIlIIIlIlllll = lIIIllIIllIIl[0];
        while (r.lIlIIIlIIIIllll(lllllllllllllllIIIIlIlIIIlIlllll, lllllllllllllllIIIIlIlIIIllIIIII)) {
            char lllllllllllllllIIIIlIlIIIllIllII = lllllllllllllllIIIIlIlIIIllIIIIl[lllllllllllllllIIIIlIlIIIlIlllll];
            lllllllllllllllIIIIlIlIIIllIlIIl.append((char)(lllllllllllllllIIIIlIlIIIllIllII ^ lllllllllllllllIIIIlIlIIIllIlIII[lllllllllllllllIIIIlIlIIIllIIlll % lllllllllllllllIIIIlIlIIIllIlIII.length]));
            "".length();
            ++lllllllllllllllIIIIlIlIIIllIIlll;
            ++lllllllllllllllIIIIlIlIIIlIlllll;
            "".length();
    ...
    private void M() {
        ...
        if (r.lIlIIIlIIIIlIlI(Players.getLocal().getWorldLocation().getRegionID(), lIIIllIIllIIl[7]) && r.lIlIIIlIIIIlIlI(Players.getLocal().getWorldLocation().getRegionID(), lIIIllIIllIIl[8]) && r.lIlIIIlIIIIlIlI(Players.getLocal().getWorldLocation().getRegionID(), lIIIllIIllIIl[9]) && r.lIlIIIlIIIIlIlI(Players.getLocal().getWorldLocation().getRegionID(), lIIIllIIllIIl[10]) && r.lIlIIIlIIIIlIlI(Players.getLocal().getWorldLocation().getRegionID(), lIIIllIIllIIl[11]) && r.lIlIIIlIIIIlIlI(Players.getLocal().getWorldLocation().getRegionID(), lIIIllIIllIIl[12])) {
            if (r.lIlIIIlIIIIIlll(Magic.isHomeTeleportOnCooldown() ? 1 : 0) && r.lIlIIIlIIIIlIll(Players.getLocal().getAnimation(), lIIIllIIllIIl[13])) {
                r lllllllllllllllIIIIlIlIIlIlIIlII;
                Magic.cast((Spell)SpellBook.Standard.HOME_TELEPORT);
                lllllllllllllllIIIIlIlIIlIlIIlII.sleep(lIIIllIIllIIl[14]);
            }
            return;
        }
        DialogOption[] dialogOptionArray = new DialogOption[lIIIllIIllIIl[14]];
    ...
    private static String lIlIIIlIIIIIIlI(String lllllllllllllllIIIIlIlIIlIIIIllI, String lllllllllllllllIIIIlIlIIlIIIIlIl) {
        try {
            SecretKeySpec lllllllllllllllIIIIlIlIIlIIIlIll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIIIlIlIIlIIIIlIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIIIIlIlIIlIIIlIlI = Cipher.getInstance("Blowfish");
            lllllllllllllllIIIIlIlIIlIIIlIlI.init(lIIIllIIllIIl[1], lllllllllllllllIIIIlIlIIlIIIlIll);
            return new String(lllllllllllllllIIIIlIlIIlIIIlIlI.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIlIlIIlIIIIllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private void a(int n2, WorldPoint worldPoint, DialogOption ... dialogOptionArray) {
        void lllllllllllllllIIIIlIlIIlIIlIlIl;
        if (r.lIlIIIlIIIIlIIl(Dialog.isOpen() ? 1 : 0)) {
            Dialog.invokeDialog((DialogOption[])dialogOptionArray);
        }
        int[] nArray = new int[lIIIllIIllIIl[2]];
        nArray[r.lIIIllIIllIIl[0]] = lllllllllllllllIIIIlIlIIlIIlIlIl;
        NPC lllllllllllllllIIIIlIlIIlIIlIIlI = NPCs.getNearest((int[])nArray);
        if (r.lIlIIIlIIIIllIl(lllllllllllllllIIIIlIlIIlIIlIIlI) && r.lIlIIIlIIIIlIIl(Reachable.isInteractable((Locatable)lllllllllllllllIIIIlIlIIlIIlIIlI) ? 1 : 0)) {
            lllllllllllllllIIIIlIlIIlIIlIIlI.interact(lIIIllIIllIII[lIIIllIIllIIl[52]]);
            "".length();
            if (null != null) {
                return;
            }
        } else {
            void lllllllllllllllIIIIlIlIIlIIlIlII;
            Walker.walkTo((WorldPoint)lllllllllllllllIIIIlIlIIlIIlIlII);
            "".length();
        }
    }
    ...
    private static String lIlIIIlIIIIIlII(String lllllllllllllllIIIIlIlIIIllllIIl, String lllllllllllllllIIIIlIlIIIllllIlI) {
        try {
            SecretKeySpec lllllllllllllllIIIIlIlIIIllllllI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIIIlIlIIIllllIlI.getBytes(StandardCharsets.UTF_8)), lIIIllIIllIIl[23]), "DES");
            Cipher lllllllllllllllIIIIlIlIIIlllllIl = Cipher.getInstance("DES");
            lllllllllllllllIIIIlIlIIIlllllIl.init(lIIIllIIllIIl[1], lllllllllllllllIIIIlIlIIIllllllI);
            return new String(lllllllllllllllIIIIlIlIIIlllllIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIlIlIIIllllIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private void am() {
        TileItem lllllllllllllllIIIIlIlIIlIlIIIII;
        int[] nArray = new int[lIIIllIIllIIl[2]];
        ...
        if (r.lIlIIIlIIIIIlll(Inventory.contains((int[])nArray6) ? 1 : 0)) {
            ...
            lllllllllllllllIIIIlIlIIlIlIIIII = TileItems.getNearest((int[])nArray7);
            if (r.lIlIIIlIIIIllIl(lllllllllllllllIIIIlIlIIlIlIIIII)) {
                return;
            }
        }
        ...
        if (r.lIlIIIlIIIIIlll(Inventory.contains((int[])nArray8) ? 1 : 0)) {
            ...
            lllllllllllllllIIIIlIlIIlIlIIIII = TileItems.getNearest((int[])nArray9);
            if (r.lIlIIIlIIIIllIl(lllllllllllllllIIIIlIlIIlIlIIIII)) {
                return;
            }
        }
        ...
        if (r.lIlIIIlIIIIIlll(Inventory.contains((int[])nArray10) ? 1 : 0)) {
            ...
            lllllllllllllllIIIIlIlIIlIlIIIII = TileItems.getNearest((int[])nArray11);
            if (r.lIlIIIlIIIIllIl(lllllllllllllllIIIIlIlIIlIlIIIII)) {
                return;
            }
        }
        ...
        if (r.lIlIIIlIIIIIlll(Inventory.contains((int[])nArray12) ? 1 : 0)) {
            ...
            lllllllllllllllIIIIlIlIIlIlIIIII = TileItems.getNearest((int[])nArray13);
            if (r.lIlIIIlIIIIllIl(lllllllllllllllIIIIlIlIIlIlIIIII)) {
                return;
            }
        }
        ...
        if (r.lIlIIIlIIIIllIl(lllllllllllllllIIIIlIlIIlIlIIIII = NPCs.getNearest(nPC -> {
            int n2;
            if (r.lIlIIIlIIIIlIIl(nPC.getName().equals(lIIIllIIllIII[lIIIllIIllIIl[53]]) ? 1 : 0) && r.lIlIIIlIIIIIlll(nPC.isDead() ? 1 : 0)) {
                ...
                if ((0x28 ^ 0x1C ^ (0xAB ^ 0x9B)) != (0xF6 ^ 0xC3 ^ (0x29 ^ 0x18))) {
                    return ((106 + 162 - 252 + 158 ^ 6 + 0 - -115 + 34) & (0xBB ^ 0xB6 ^ (0x58 ^ 0x60) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIIllIIllIIl[0];
            }
            return n2 != 0;
        })) && r.lIlIIIlIIIIlIIl(Reachable.isInteractable((Locatable)lllllllllllllllIIIIlIlIIlIlIIIII) ? 1 : 0)) {
            if (!r.lIlIIIlIIIIlIlI(Players.getLocal().getWorldLocation().getRegionID(), lIIIllIIllIIl[29]) || r.lIlIIIlIIIIlIll(Players.getLocal().getWorldLocation().getRegionID(), lIIIllIIllIIl[30])) {
                lllllllllllllllIIIIlIlIIlIlIIIII.interact(lIIIllIIllIII[lIIIllIIllIIl[14]]);
                "".length();
                if ("  ".length() != "  ".length()) {
                    return;
                }
    ...
    private void an() {
        r lllllllllllllllIIIIlIlIIlIIlllIl;
        block33: {
            block32: {
                int[] nArray = new int[lIIIllIIllIIl[2]];
            ...
            if (r.lIlIIIlIIIIIlll(Bank.isOpen() ? 1 : 0)) {
                ...
                List lllllllllllllllIIIIlIlIIlIIlllII = TileObjects.getAt((WorldPoint)new WorldPoint(lIIIllIIllIIl[38], lIIIllIIllIIl[39], lIIIllIIllIIl[0]), (String[])stringArray);
                if (r.lIlIIIlIIIIlIIl(lllllllllllllllIIIIlIlIIlIIlllII.isEmpty() ? 1 : 0)) {
                    Walker.walkTo((WorldPoint)new WorldPoint(lIIIllIIllIIl[41], lIIIllIIllIIl[39], lIIIllIIllIIl[0]));
                    "".length();
                    return;
                }
                if (r.lIlIIIlIIIIlIll(lllllllllllllllIIIIlIlIIlIIlllII.size(), lIIIllIIllIIl[2])) {
                    if (r.lIlIIIlIIIIIlll(Reachable.isInteractable((Locatable)((Locatable)lllllllllllllllIIIIlIlIIlIIlllII.get(lIIIllIIllIIl[0]))) ? 1 : 0)) {
                        Walker.walkTo((WorldPoint)new WorldPoint(lIIIllIIllIIl[41], lIIIllIIllIIl[39], lIIIllIIllIIl[0]));
                        "".length();
                        return;
                    }
                    ((TileObject)lllllllllllllllIIIIlIlIIlIIlllII.get(lIIIllIIllIIl[0])).interact(lIIIllIIllIII[lIIIllIIllIIl[42]]);
                }
                return;
            }
        ...
        if (r.lIlIIIlIIIIlIIl(Bank.isOpen() ? 1 : 0)) {
            ...
            if (r.lIlIIIlIIIlIIII(Inventory.getCount((boolean)lIIIllIIllIIl[2], (int[])nArray), lIIIllIIllIIl[36])) {
                ...
                if (r.lIlIIIlIIIIlIII(Bank.getCount((boolean)lIIIllIIllIIl[2], (int[])nArray7), lIIIllIIllIIl[36])) {
                    ...
                    lllllllllllllllIIIIlIlIIlIIlllIl.sleep(lIIIllIIllIIl[20]);
                }
            }
        }
        int[] nArray = new int[lIIIllIIllIIl[2]];
        ...
        if (r.lIlIIIlIIIIIlll(Equipment.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (r.lIlIIIlIIIIlIIl(Inventory.contains((int[])nArray8) ? 1 : 0)) {
                ...
                NPC lllllllllllllllIIIIlIlIIlIIlllII = NPCs.getNearest((int[])nArray10);
                if (r.lIlIIIlIIIIllIl(lllllllllllllllIIIIlIlIIlIIlllII) && r.lIlIIIlIIIIlIIl(Reachable.isInteractable((Locatable)lllllllllllllllIIIIlIlIIlIIlllII) ? 1 : 0)) {
                    lllllllllllllllIIIIlIlIIlIIlllII.interact(lIIIllIIllIII[lIIIllIIllIIl[45]]);
                    "".length();
                    if ((0x24 ^ 0x21) == 0) {
                        return;
                    }
        ...
        if (r.lIlIIIlIIIIIlll(Inventory.contains((int[])nArray11) ? 1 : 0)) {
            if (r.lIlIIIlIIIIlIIl(Shop.isOpen() ? 1 : 0)) {
                ...
                NPC lllllllllllllllIIIIlIlIIlIIlllII = NPCs.getNearest((int[])nArray12);
                if (r.lIlIIIlIIIIllIl(lllllllllllllllIIIIlIlIIlIIlllII) && r.lIlIIIlIIIIlIIl(Reachable.isInteractable((Locatable)lllllllllllllllIIIIlIlIIlIIlllII) ? 1 : 0)) {
                    lllllllllllllllIIIIlIlIIlIIlllII.interact(lIIIllIIllIII[lIIIllIIllIIl[49]]);
                    "".length();
                    if (" ".length() < 0) {
                        return;
                    }
                    ...
                    "".length();
                    lllllllllllllllIIIIlIlIIlIIlllIl.sleep(lIIIllIIllIIl[1]);
                    return;
                }
            }
        }
    ...
    public boolean run() {
        r lllllllllllllllIIIIlIlIIlIlIIlll;
        if (r.lIlIIIlIIIIIlll(this.av.quest().equals((Object)h.IMP_CATCHER) ? 1 : 0)) {
            return lIIIllIIllIIl[0];
        }
        int lllllllllllllllIIIIlIlIIlIlIIllI = lllllllllllllllIIIIlIlIIlIlIIlll.Q();
        if (r.lIlIIIlIIIIlIII(lllllllllllllllIIIIlIlIIlIlIIllI, lIIIllIIllIIl[1])) {
            return lIIIllIIllIIl[0];
        }
        System.out.println("[IMP_CATCHER] - Current Progress: " + lllllllllllllllIIIIlIlIIlIlIIllI);
        switch (lllllllllllllllIIIIlIlIIlIlIIllI) {
            case 0: {
                lllllllllllllllIIIIlIlIIlIlIIlll.an();
                lllllllllllllllIIIIlIlIIlIlIIlll.al();
                lllllllllllllllIIIIlIlIIlIlIIlll.am();
                lllllllllllllllIIIIlIlIIlIlIIlll.M();
                "".length();
                if (-" ".length() <= 0) break;
                return ((101 + 18 - -40 + 6 ^ 131 + 59 - 36 + 42) & (0x33 ^ 0x2A ^ (0xFD ^ 0x85) ^ -" ".length())) != 0;
            }
            case 1: {
                lllllllllllllllIIIIlIlIIlIlIIlll.Y();
            }
            default: {
                return lIIIllIIllIIl[0];
            }
