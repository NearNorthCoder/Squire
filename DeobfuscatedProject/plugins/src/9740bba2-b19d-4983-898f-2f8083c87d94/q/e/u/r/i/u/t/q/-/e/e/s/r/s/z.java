...
extends Task {
            ...
            if (z.lIlIIIIlllIllIl(nPC) && z.lIlIIIIlllIlllI(Reachable.isInteractable((Locatable)nPC) ? 1 : 0)) {
                ...
                this.sleepWhile(lIIIllIIlIIII[3], () -> {
                    ...
                    if (z.lIlIIIIlllIlIll(Dialog.isOpen() ? 1 : 0)) {
                        ...
                        "".length();
                        if (" ".length() == 0) {
                            return ((0x77 ^ 0x19 ^ (0x1D ^ 0x23)) & (0x97 ^ 0xC0 ^ (4 ^ 3) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIIllIIlIIII[0];
                    }
    ...
    public boolean run() {
        ...
        switch (lllllllllllllllIIIIlIlIlllIlllll) {
            ...
            case 5: {
                ...
                "".length();
                if (-"  ".length() < 0) break;
                return ((0x54 ^ 0x75 ^ (0x2C ^ 0x1F)) & (0x30 ^ 0x3C ^ (0xB ^ 0x15) ^ -" ".length())) != 0;
            }
            default: {
                return lIIIllIIlIIII[0];
            }
    ...
    private static void lIlIIIIlllIlIlI() {
        ...
        z.lIIIllIIlIIII[7] = "  ".length();
        z.lIIIllIIlIIII[8] = "   ".length();
        ...
        z.lIIIllIIlIIII[37] = "  ".length() ^ (0x6D ^ 0x4D);
            ...
            if (z.lIlIIIIlllIllIl(nPC) && z.lIlIIIIlllIlllI(Reachable.isInteractable((Locatable)nPC) ? 1 : 0)) {
                ...
                this.sleepWhile(lIIIllIIlIIII[3], () -> {
                    ...
                    if (z.lIlIIIIlllIlIll(Dialog.isOpen() ? 1 : 0)) {
                        bl = lIIIllIIlIIII[2];
                        "".length();
                        if (((92 + 18 - 102 + 124 ^ 87 + 60 - 131 + 140) & (200 + 55 - 216 + 184 ^ 43 + 4 - 1 + 153 ^ -" ".length())) != ((0x50 ^ 0x6D ^ (0x55 ^ 0x6C)) & (76 + 143 - 122 + 47 ^ 46 + 117 - 97 + 82 ^ -" ".length()))) {
                            return ((66 + 95 - 127 + 146 ^ 64 + 101 - 135 + 98) & (0x25 ^ 0x43 ^ (0xF1 ^ 0xA3) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIIllIIlIIII[0];
                    }
    ...
    private static void lIlIIIIlllIlIIl() {
        ...
        z.lIIIllIIIllll[z.lIIIllIIlIIII[0]] = z.lIlIIIIlllIIllI("2Z2hRLnrwwmVFzUbaesjdfsTEaqCEymf", "ISaer");
        z.lIIIllIIIllll[z.lIIIllIIlIIII[2]] = z.lIlIIIIlllIIllI("e1SYPznm+RA=", "mnFGx");
        z.lIIIllIIIllll[z.lIIIllIIlIIII[7]] = z.lIlIIIIlllIIlll("C0BYwsJmQX8=", "CHfit");
        z.lIIIllIIIllll[z.lIIIllIIlIIII[8]] = z.lIlIIIIlllIlIII("DBM1D0ksHQ==", "XrYdd");
        z.lIIIllIIIllll[z.lIIIllIIlIIII[9]] = z.lIlIIIIlllIIllI("Jdk6tt1Rkj8ypy/E1sy/gjACiCMucN77", "hCPbN");
        z.lIIIllIIIllll[z.lIIIllIIlIIII[10]] = z.lIlIIIIlllIlIII("OCslHmoYJQ==", "lJIuG");
        z.lIIIllIIIllll[z.lIIIllIIlIIII[1]] = z.lIlIIIIlllIlIII("EAQlKUgcHjwtCz0e", "TqNLh");
        z.lIIIllIIIllll[z.lIIIllIIlIIII[11]] = z.lIlIIIIlllIlIII("OzQnP0MbOg==", "oUKTn");
    }
            ...
            if (z.lIlIIIIlllIllIl(nPC) && z.lIlIIIIlllIlllI(Reachable.isInteractable((Locatable)nPC) ? 1 : 0)) {
                ...
                this.sleepWhile(lIIIllIIlIIII[3], () -> {
                    ...
                    if (z.lIlIIIIlllIlIll(Dialog.isOpen() ? 1 : 0)) {
                        bl = lIIIllIIlIIII[2];
                        "".length();
                        if (((98 + 101 - 187 + 132 ^ 169 + 11 - 8 + 20) & (0xFC ^ 0x8D ^ (9 ^ 0x28) ^ -" ".length())) == "   ".length()) {
                            return (("   ".length() ^ (0x12 ^ 0x3E)) & (0xCC ^ 0xAB ^ (0x5A ^ 0x12) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIIllIIlIIII[0];
                    }
            ...
            if (z.lIlIIIIlllIllIl(nPC) && z.lIlIIIIlllIlllI(Reachable.isInteractable((Locatable)nPC) ? 1 : 0)) {
                ...
                this.sleepWhile(lIIIllIIlIIII[3], () -> {
                    ...
                    if (z.lIlIIIIlllIlIll(Dialog.isOpen() ? 1 : 0)) {
                        ...
                        "".length();
                        if (null != null) {
                            return ((0x1E ^ 0x64 ^ (0xC9 ^ 0x9A)) & (103 + 32 - 123 + 138 ^ 50 + 73 - 77 + 145 ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIIllIIlIIII[0];
                    }
                ...
                "".length();
                if (((" ".length() ^ (0xB3 ^ 0xB4)) & (11 + 179 - 37 + 36 ^ 126 + 22 - 116 + 155 ^ -" ".length())) != 0) {
                    return;
                }
            } else {
                Walker.walkTo((WorldPoint)new WorldPoint(lIIIllIIlIIII[4], lIIIllIIlIIII[5], lIIIllIIlIIII[0]));
