...
extends Task {
    ...
    public boolean run() {
        ...
        switch (lllllllllllllllIIIIlIlllIlIlIlll) {
            case 0: {
                ...
                return ((15 + 69 - -9 + 122 ^ 37 + 124 - 151 + 128) & (144 + 79 - 160 + 95 ^ 112 + 91 - 83 + 75 ^ -" ".length()) & ((0x53 ^ 0x43 ^ (0x6A ^ 0x7F)) & (0x63 ^ 6 ^ (0x59 ^ 0x39) ^ -" ".length()) ^ -" ".length())) != 0;
            }
            case 1: {
                lllllllllllllllIIIIlIlllIlIllIII.cp();
                "".length();
            ...
            case 5: {
                ...
                "".length();
                if (" ".length() != ((0x5A ^ 0x6F ^ (0x37 ^ 0x45)) & (0xBE ^ 0xB1 ^ (0x51 ^ 0x19) ^ -" ".length()))) break;
                return ((0x42 ^ 0x1B ^ (0x75 ^ 0x63)) & (15 + 9 - -187 + 2 ^ 91 + 88 - 127 + 102 ^ -" ".length())) != 0;
            }
            case 6: {
                lllllllllllllllIIIIlIlllIlIllIII.P();
                lllllllllllllllIIIIlIlllIlIllIII.Y();
                "".length();
                if ("  ".length() >= ((0x7D ^ 0x51 ^ (0x7F ^ 0x75)) & (107 + 32 - 54 + 48 ^ 65 + 147 - 50 + 1 ^ -" ".length()))) break;
                return ((0x63 ^ 0xA ^ (0xEE ^ 0xC0)) & (0x24 ^ 0x15 ^ (0xB4 ^ 0xC2) ^ -" ".length())) != 0;
            }
            case 7: {
                lllllllllllllllIIIIlIlllIlIllIII.P();
                "".length();
    ...
    private static void lIlIIIIlIlllIll() {
        ...
        D.lIIIllIIIIIll[D.lIIIllIIIIlII[0]] = D.lIlIIIIlIlllIII("twIeuCzgZkI=", "jywbW");
        D.lIIIllIIIIIll[D.lIIIllIIIIlII[2]] = D.lIlIIIIlIlllIII("st7xSuDTdYk=", "uqERw");
        D.lIIIllIIIIIll[D.lIIIllIIIIlII[6]] = D.lIlIIIIlIlllIIl("LQc0", "inStE");
        D.lIIIllIIIIIll[D.lIIIllIIIIlII[7]] = D.lIlIIIIlIlllIII("qyhrg5NJWLg=", "hzVly");
        D.lIIIllIIIIIll[D.lIIIllIIIIlII[8]] = D.lIlIIIIlIlllIII("201bqaImbxE=", "FaFTJ");
        D.lIIIllIIIIIll[D.lIIIllIIIIlII[9]] = D.lIlIIIIlIlllIIl("FiABHA==", "BAjyd");
        D.lIIIllIIIIIll[D.lIIIllIIIIlII[10]] = D.lIlIIIIlIlllIlI("Gr1a9O9bizU=", "GPKWx");
        D.lIIIllIIIIIll[D.lIIIllIIIIlII[11]] = D.lIlIIIIlIlllIIl("JCkiHHoEJw==", "pHNwW");
        D.lIIIllIIIIIll[D.lIIIllIIIIlII[1]] = D.lIlIIIIlIlllIII("lMGy/shFhVOVAAZYPJUYGw==", "GZJVu");
        D.lIIIllIIIIIll[D.lIIIllIIIIlII[26]] = D.lIlIIIIlIlllIlI("BsVJLQiH1Nc=", "njwij");
        D.lIIIllIIIIIll[D.lIIIllIIIIlII[25]] = D.lIlIIIIlIlllIIl("HysrBgEmLWcZB2gEFy4=", "HJGmh");
    }
    ...
    private void a(int n2, WorldPoint worldPoint, DialogOption ... dialogOptionArray) {
        ...
        if (D.lIlIIIIllIIIIIl(lllllllllllllllIIIIlIlllIlIIlIIl) && D.lIlIIIIlIllllll(Reachable.isInteractable((Locatable)lllllllllllllllIIIIlIlllIlIIlIIl) ? 1 : 0)) {
            ...
            "".length();
            if (-" ".length() >= ((0x14 ^ 0x65 ^ (0xED ^ 0xB6)) & (38 + 82 - -43 + 11 ^ 81 + 99 - 53 + 5 ^ -" ".length()))) {
                return;
            }
        } else {
    ...
    private static void lIlIIIIlIllllII() {
        ...
        D.lIIIllIIIIlII[0] = (57 + 140 - 113 + 162 ^ 46 + 122 - 78 + 92) & (0x82 ^ 0xBE ^ (0x41 ^ 0x3D) ^ -" ".length());
        D.lIIIllIIIIlII[1] = 0xBB ^ 0xB3;
        D.lIIIllIIIIlII[2] = " ".length();
        ...
        D.lIIIllIIIIlII[6] = "  ".length();
        D.lIIIllIIIIlII[7] = "   ".length();
