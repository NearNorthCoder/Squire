...
extends Task {
    ...
    private static void lIlIIIlIlIIlllI() {
        ...
        p.lIIIllIlIlIII[0] = " ".length() & ~" ".length();
        p.lIIIllIlIlIII[1] = "  ".length();
        p.lIIIllIlIlIII[2] = "   ".length();
        p.lIIIllIlIlIII[3] = " ".length();
        ...
        p.lIIIllIlIlIII[27] = 5 ^ 0xA ^ "  ".length();
            ...
            if (p.lIlIIIlIlIlIIlI(nPC)) {
                ...
                this.sleepWhile(lIIIllIlIlIII[17], () -> {
                    ...
                    if (p.lIlIIIlIlIIllll(Dialog.isOpen() ? 1 : 0)) {
                        bl = lIIIllIlIlIII[3];
                        "".length();
                        if (" ".length() >= (0x82 ^ 0x9F ^ (0x87 ^ 0x9E))) {
                            return ((0x4A ^ 0x39 ^ (0xD ^ 0x60)) & (8 + 70 - 30 + 113 ^ 33 + 141 - 172 + 189 ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIIllIlIlIII[0];
                    }
    ...
    private static void lIlIIIlIlIIllIl() {
        ...
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[0]] = p.lIlIIIlIlIIlIlI("5yuncXdPqbXo25fHZl6V5RuHDsmvJ02XS4rkRef3CojGgUairXDLypN8vCYQxAdB", "OYfKq");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[3]] = p.lIlIIIlIlIIlIll("LCU+NC0BKjNtbCRmIS8jGmY9KSkfI2o1I00gIy8oTTIiKD9NNT40Kgto", "mFJAL");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[1]] = p.lIlIIIlIlIIllII("oxQSxbMmvcg=", "bgENW");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[2]] = p.lIlIIIlIlIIllII("cRxKMLy1bMU=", "qxgox");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[6]] = p.lIlIIIlIlIIllII("RjD2aMMj7IRa29aZzJAyqA==", "xAgAW");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[7]] = p.lIlIIIlIlIIllII("YdDDc57FtCW1t3GYeWqQ7Q==", "qAbtp");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[8]] = p.lIlIIIlIlIIlIlI("qJrWjTSf1R4=", "QMnao");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[9]] = p.lIlIIIlIlIIlIll("LSg6Ag==", "nGUil");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[5]] = p.lIlIIIlIlIIllII("VEEYpo/MZQM=", "JXRip");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[20]] = p.lIlIIIlIlIIllII("0CGkwF+qMVg=", "BesXE");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[17]] = p.lIlIIIlIlIIlIlI("LHTurr/eA68=", "YWstt");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[21]] = p.lIlIIIlIlIIlIlI("SUgJ9uLQxNg=", "LusEH");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[26]] = p.lIlIIIlIlIIlIll("FBgZJzJwGh8i", "PypUK");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[27]] = p.lIlIIIlIlIIlIlI("QxywdB+LwEI=", "aMClF");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[34]] = p.lIlIIIlIlIIllII("FswXFwLq18o=", "TkKDr");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[35]] = p.lIlIIIlIlIIlIlI("rZ+7q21nQko=", "ynRgQ");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[36]] = p.lIlIIIlIlIIlIll("LQ4+Oy4X", "eaNKK");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[37]] = p.lIlIIIlIlIIlIll("Hyo+PT8l", "WENMZ");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[38]] = p.lIlIIIlIlIIlIlI("1jRR+Wul0uo=", "clKpl");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[41]] = p.lIlIIIlIlIIlIlI("DKAs7MBACLs=", "dVfxN");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[42]] = p.lIlIIIlIlIIlIlI("SJOyMu5ed/XTlZkH55ql6g==", "MpUnR");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[43]] = p.lIlIIIlIlIIlIlI("N8Ge1IubgqQ=", "CzuXi");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[44]] = p.lIlIIIlIlIIllII("8MGbm6qxguQTieFcBA/AXQ==", "LfCAY");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[45]] = p.lIlIIIlIlIIlIll("KhopHTdMFC8G", "lvFhE");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[46]] = p.lIlIIIlIlIIlIll("IRc7IwE=", "dzKWx");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[49]] = p.lIlIIIlIlIIlIll("IxYZDQ==", "wwrhC");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[50]] = p.lIlIIIlIlIIlIll("BAodLw==", "PkvJu");
        p.lIIIllIlIIlll[p.lIIIllIlIlIII[51]] = p.lIlIIIlIlIIlIlI("b2i+9VzgKc2/kfEeJEa/t8A1/A6dIxVe", "cNkge");
    }
    ...
    private static String lIlIIIlIlIIlIll(String lllllllllllllllIIIIlIIlIIlIIlIIl, String lllllllllllllllIIIIlIIlIIlIIlIII) {
        ...
        while (p.lIlIIIlIlIlIlII(lllllllllllllllIIIIlIIlIIIllllIl, lllllllllllllllIIIIlIIlIIIlllllI)) {
            ...
            "".length();
            if (((0x42 ^ 0x79) & ~(0x8E ^ 0xB5)) < " ".length()) continue;
            return null;
        }
    ...
    public boolean run() {
        ...
        switch (lllllllllllllllIIIIlIIlIIlllIlII) {
            case 0: {
                ...
                "".length();
                if (null == null) break;
                return ((0xEC ^ 0x95 ^ (0x75 ^ 0x38)) & (0x78 ^ 0x37 ^ (0x5F ^ 0x24) ^ -" ".length())) != 0;
            }
            case 1: {
                lllllllllllllllIIIIlIIlIIlllIlIl.R();
                lllllllllllllllIIIIlIIlIIlllIlIl.sleep(lIIIllIlIlIII[2]);
                "".length();
                if ((0x5D ^ 0x6E ^ (0xA6 ^ 0x91)) >= ((52 + 53 - -21 + 51 ^ 88 + 28 - -2 + 44) & (1 + 8 - -175 + 7 ^ 132 + 141 - 228 + 127 ^ -" ".length()))) break;
                return ((20 + 37 - -23 + 67 ^ 76 + 38 - 63 + 81) & (81 + 124 - 86 + 66 ^ 23 + 163 - 20 + 8 ^ -" ".length())) != 0;
            }
            default: {
                return lIIIllIlIlIII[0];
            }
