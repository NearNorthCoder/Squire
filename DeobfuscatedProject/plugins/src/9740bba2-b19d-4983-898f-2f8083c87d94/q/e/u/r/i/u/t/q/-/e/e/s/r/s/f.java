...
public class f {
    ...
    private static void lIlIIIlIlIllIII() {
        ...
        f.lIIIllIlIlIIl[f.lIIIllIlIlIlI[1]] = f.lIlIIIlIlIlIlIl("RoVsR1y2vsTlWrUPbGKU9w==", "KknVO");
        f.lIIIllIlIlIIl[f.lIIIllIlIlIlI[2]] = f.lIlIIIlIlIlIllI("xZbc5nxKd6KSfTIKBFIlSQ==", "yxGKH");
        f.lIIIllIlIlIIl[f.lIIIllIlIlIlI[3]] = f.lIlIIIlIlIlIlIl("nZtNFhxjpTNB50t/nbhKCA==", "MMZOj");
        f.lIIIllIlIlIIl[f.lIIIllIlIlIlI[4]] = f.lIlIIIlIlIlIlll("GSgfBwAPKB8LAR48GA==", "jYjnr");
        f.lIIIllIlIlIIl[f.lIIIllIlIlIlI[0]] = f.lIlIIIlIlIlIlll("DjgvCCQYPCwQ", "lYAcM");
        f.lIIIllIlIlIIl[f.lIIIllIlIlIlI[5]] = f.lIlIIIlIlIlIlIl("0D16A/A5Ong=", "VUrfh");
        f.lIIIllIlIlIIl[f.lIIIllIlIlIlI[6]] = f.lIlIIIlIlIlIlIl("rDypXE/qPKDemI6bmp9+kw==", "qMiTJ");
        f.lIIIllIlIlIIl[f.lIIIllIlIlIlI[7]] = f.lIlIIIlIlIlIlIl("hqKQdrLP6Av7KbcCnY5d7A==", "YYrcx");
        f.lIIIllIlIlIIl[f.lIIIllIlIlIlI[8]] = f.lIlIIIlIlIlIlll("HzUmCjUJNSYGNBghIQ==", "lDScG");
    }
    ...
    private static void lIlIIIlIllIlIII() {
        ...
        f.lIIIllIlIlIlI[2] = " ".length();
        f.lIIIllIlIlIlI[3] = "  ".length();
        f.lIIIllIlIlIlI[4] = "   ".length();
