...
extends Task {
    ...
    private void a(WorldPoint worldPoint, int n2) {
        ...
        if (t.lIlIIIIllIlllII(tileObject)) {
            ...
            void lllllllllllllllIIIIlIllIIllIllll;
            Walker.walkTo((WorldPoint)lllllllllllllllIIIIlIllIIllIllll);
            "".length();
        }
    }
    ...
    private void bd() {
        t lllllllllllllllIIIIlIllIIlllIlll;
        int lllllllllllllllIIIIlIllIIlllIlIl;
        WorldPoint lllllllllllllllIIIIlIllIIlllIllI;
        ...
        if (t.lIlIIIIllIlllIl(Vars.getBit((int)lIIIllIIIllII[18]), lIIIllIIIllII[7])) {
            lllllllllllllllIIIIlIllIIlllIllI = new WorldPoint(lIIIllIIIllII[19], lIIIllIIIllII[16], lIIIllIIIllII[0]);
            lllllllllllllllIIIIlIllIIlllIlIl = lIIIllIIIllII[20];
            lllllllllllllllIIIIlIllIIlllIlll.a(lllllllllllllllIIIIlIllIIlllIllI, lllllllllllllllIIIIlIllIIlllIlIl);
            return;
        }
        if (t.lIlIIIIllIlllIl(Vars.getBit((int)lIIIllIIIllII[21]), lIIIllIIIllII[7])) {
            lllllllllllllllIIIIlIllIIlllIllI = new WorldPoint(lIIIllIIIllII[22], lIIIllIIIllII[16], lIIIllIIIllII[0]);
            lllllllllllllllIIIIlIllIIlllIlIl = lIIIllIIIllII[23];
            lllllllllllllllIIIIlIllIIlllIlll.a(lllllllllllllllIIIIlIllIIlllIllI, lllllllllllllllIIIIlIllIIlllIlIl);
            return;
        }
        if (t.lIlIIIIllIlllIl(Vars.getBit((int)lIIIllIIIllII[24]), lIIIllIIIllII[7])) {
            lllllllllllllllIIIIlIllIIlllIllI = new WorldPoint(lIIIllIIIllII[25], lIIIllIIIllII[16], lIIIllIIIllII[0]);
            lllllllllllllllIIIIlIllIIlllIlIl = lIIIllIIIllII[26];
            lllllllllllllllIIIIlIllIIlllIlll.a(lllllllllllllllIIIIlIllIIlllIllI, lllllllllllllllIIIIlIllIIlllIlIl);
            return;
        }
        if (t.lIlIIIIllIlllIl(Vars.getBit((int)lIIIllIIIllII[27]), lIIIllIIIllII[7])) {
            lllllllllllllllIIIIlIllIIlllIllI = new WorldPoint(lIIIllIIIllII[28], lIIIllIIIllII[29], lIIIllIIIllII[0]);
            lllllllllllllllIIIIlIllIIlllIlIl = lIIIllIIIllII[30];
            lllllllllllllllIIIIlIllIIlllIlll.a(lllllllllllllllIIIIlIllIIlllIllI, lllllllllllllllIIIIlIllIIlllIlIl);
            return;
        }
        if (t.lIlIIIIllIlllIl(Vars.getBit((int)lIIIllIIIllII[31]), lIIIllIIIllII[7])) {
            lllllllllllllllIIIIlIllIIlllIllI = new WorldPoint(lIIIllIIIllII[32], lIIIllIIIllII[29], lIIIllIIIllII[0]);
            lllllllllllllllIIIIlIllIIlllIlIl = lIIIllIIIllII[33];
            lllllllllllllllIIIIlIllIIlllIlll.a(lllllllllllllllIIIIlIllIIlllIllI, lllllllllllllllIIIIlIllIIlllIlIl);
            return;
        }
        if (t.lIlIIIIllIlllIl(Vars.getBit((int)lIIIllIIIllII[34]), lIIIllIIIllII[7])) {
            lllllllllllllllIIIIlIllIIlllIllI = new WorldPoint(lIIIllIIIllII[35], lIIIllIIIllII[36], lIIIllIIIllII[0]);
            lllllllllllllllIIIIlIllIIlllIlIl = lIIIllIIIllII[37];
            lllllllllllllllIIIIlIllIIlllIlll.a(lllllllllllllllIIIIlIllIIlllIllI, lllllllllllllllIIIIlIllIIlllIlIl);
            return;
        }
        if (t.lIlIIIIllIlllIl(Vars.getBit((int)lIIIllIIIllII[38]), lIIIllIIIllII[7])) {
            lllllllllllllllIIIIlIllIIlllIllI = new WorldPoint(lIIIllIIIllII[39], lIIIllIIIllII[36], lIIIllIIIllII[0]);
            lllllllllllllllIIIIlIllIIlllIlIl = lIIIllIIIllII[40];
            lllllllllllllllIIIIlIllIIlllIlll.a(lllllllllllllllIIIIlIllIIlllIllI, lllllllllllllllIIIIlIllIIlllIlIl);
            return;
        }
        if (t.lIlIIIIllIlllIl(Vars.getBit((int)lIIIllIIIllII[41]), lIIIllIIIllII[7])) {
            lllllllllllllllIIIIlIllIIlllIllI = new WorldPoint(lIIIllIIIllII[42], lIIIllIIIllII[43], lIIIllIIIllII[0]);
            lllllllllllllllIIIIlIllIIlllIlIl = lIIIllIIIllII[44];
            lllllllllllllllIIIIlIllIIlllIlll.a(lllllllllllllllIIIIlIllIIlllIllI, lllllllllllllllIIIIlIllIIlllIlIl);
            return;
        }
        if (t.lIlIIIIllIlllIl(Vars.getBit((int)lIIIllIIIllII[45]), lIIIllIIIllII[7])) {
            lllllllllllllllIIIIlIllIIlllIllI = new WorldPoint(lIIIllIIIllII[46], lIIIllIIIllII[47], lIIIllIIIllII[0]);
            lllllllllllllllIIIIlIllIIlllIlIl = lIIIllIIIllII[48];
            lllllllllllllllIIIIlIllIIlllIlll.a(lllllllllllllllIIIIlIllIIlllIllI, lllllllllllllllIIIIlIllIIlllIlIl);
            return;
        }
        if (t.lIlIIIIllIlllIl(Vars.getBit((int)lIIIllIIIllII[49]), lIIIllIIIllII[7])) {
            lllllllllllllllIIIIlIllIIlllIllI = new WorldPoint(lIIIllIIIllII[50], lIIIllIIIllII[36], lIIIllIIIllII[0]);
            lllllllllllllllIIIIlIllIIlllIlIl = lIIIllIIIllII[51];
            lllllllllllllllIIIIlIllIIlllIlll.a(lllllllllllllllIIIIlIllIIlllIllI, lllllllllllllllIIIIlIllIIlllIlIl);
            return;
        }
        if (t.lIlIIIIllIlllIl(Vars.getBit((int)lIIIllIIIllII[52]), lIIIllIIIllII[7])) {
            lllllllllllllllIIIIlIllIIlllIllI = new WorldPoint(lIIIllIIIllII[53], lIIIllIIIllII[36], lIIIllIIIllII[0]);
            lllllllllllllllIIIIlIllIIlllIlIl = lIIIllIIIllII[54];
            lllllllllllllllIIIIlIllIIlllIlll.a(lllllllllllllllIIIIlIllIIlllIllI, lllllllllllllllIIIIlIllIIlllIlIl);
            return;
        }
        if (t.lIlIIIIllIlllIl(Vars.getBit((int)lIIIllIIIllII[55]), lIIIllIIIllII[7])) {
            lllllllllllllllIIIIlIllIIlllIllI = new WorldPoint(lIIIllIIIllII[56], lIIIllIIIllII[29], lIIIllIIIllII[0]);
            lllllllllllllllIIIIlIllIIlllIlIl = lIIIllIIIllII[57];
            lllllllllllllllIIIIlIllIIlllIlll.a(lllllllllllllllIIIIlIllIIlllIllI, lllllllllllllllIIIIlIllIIlllIlIl);
            return;
        }
        if (t.lIlIIIIllIlllIl(Vars.getBit((int)lIIIllIIIllII[58]), lIIIllIIIllII[7])) {
            lllllllllllllllIIIIlIllIIlllIllI = new WorldPoint(lIIIllIIIllII[59], lIIIllIIIllII[29], lIIIllIIIllII[0]);
            lllllllllllllllIIIIlIllIIlllIlIl = lIIIllIIIllII[60];
            lllllllllllllllIIIIlIllIIlllIlll.a(lllllllllllllllIIIIlIllIIlllIllI, lllllllllllllllIIIIlIllIIlllIlIl);
            return;
        }
    ...
    private static void lIlIIIIllIlIlll() {
        ...
        t.lIIIllIIIlIll[t.lIIIllIIIllII[0]] = t.lIlIIIIllIlIlII("Mxc/JQcJBW0iAEcTOC4dEw==", "gbMKn");
        t.lIIIllIIIlIll[t.lIIIllIIIllII[1]] = t.lIlIIIIllIlIlIl("1pQPLlaDAqA=", "gsBNp");
        t.lIIIllIIIlIll[t.lIIIllIIIllII[4]] = t.lIlIIIIllIlIlII("GzgnOCohPmsnLG82OT8iIT0k", "OYKSC");
        t.lIIIllIIIlIll[t.lIIIllIIIllII[7]] = t.lIlIIIIllIlIlIl("sWNkXijK9ochz97moHx4+SqOsTlQK7cE", "dHQTo");
        t.lIIIllIIIlIll[t.lIIIllIIIllII[9]] = t.lIlIIIIllIlIlIl("d6dEFFxzp/HdBlyTCrMmYQ==", "JqGDV");
        t.lIIIllIIIlIll[t.lIIIllIIIllII[10]] = t.lIlIIIIllIlIlIl("kzYG/ZAitJg=", "olftA");
        t.lIIIllIIIlIll[t.lIIIllIIIllII[11]] = t.lIlIIIIllIlIlIl("CgcY1nX/gc8=", "gsSKz");
        t.lIIIllIIIlIll[t.lIIIllIIIllII[12]] = t.lIlIIIIllIlIllI("3jTXVO6qnC0=", "yZCdA");
    }
    ...
    private static String lIlIIIIllIlIlII(String lllllllllllllllIIIIlIllIIIllIlIl, String lllllllllllllllIIIIlIllIIIlllIIl) {
        lllllllllllllllIIIIlIllIIIllIlIl = new String(Base64.getDecoder().decode(lllllllllllllllIIIIlIllIIIllIlIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIIIlIllIIIlllIII = new StringBuilder();
        char[] lllllllllllllllIIIIlIllIIIllIlll = lllllllllllllllIIIIlIllIIIlllIIl.toCharArray();
        int lllllllllllllllIIIIlIllIIIllIllI = lIIIllIIIllII[0];
        char[] lllllllllllllllIIIIlIllIIIllIIII = lllllllllllllllIIIIlIllIIIllIlIl.toCharArray();
        int lllllllllllllllIIIIlIllIIIlIllll = lllllllllllllllIIIIlIllIIIllIIII.length;
        int lllllllllllllllIIIIlIllIIIlIlllI = lIIIllIIIllII[0];
        while (t.lIlIIIIllIlllll(lllllllllllllllIIIIlIllIIIlIlllI, lllllllllllllllIIIIlIllIIIlIllll)) {
            char lllllllllllllllIIIIlIllIIIlllIll = lllllllllllllllIIIIlIllIIIllIIII[lllllllllllllllIIIIlIllIIIlIlllI];
            lllllllllllllllIIIIlIllIIIlllIII.append((char)(lllllllllllllllIIIIlIllIIIlllIll ^ lllllllllllllllIIIIlIllIIIllIlll[lllllllllllllllIIIIlIllIIIllIllI % lllllllllllllllIIIIlIllIIIllIlll.length]));
            "".length();
            ++lllllllllllllllIIIIlIllIIIllIllI;
            ++lllllllllllllllIIIIlIllIIIlIlllI;
            "".length();
    ...
    public boolean run() {
        t lllllllllllllllIIIIlIllIIlllllIl;
        ...
        if (t.lIlIIIIllIllIlI(lllllllllllllllIIIIlIllIIlllllIl.be(), lIIIllIIIllII[1])) {
            lllllllllllllllIIIIlIllIIlllllIl.aK -= lIIIllIIIllII[1];
            return lIIIllIIIllII[0];
        }
        if (t.lIlIIIIllIllIIl(Vars.getBit((int)lIIIllIIIllII[2]))) {
            lllllllllllllllIIIIlIllIIlllllIl.M();
            return lIIIllIIIllII[1];
        }
        if (t.lIlIIIIllIllIll(lllllllllllllllIIIIlIllIIlllllIl.aL ? 1 : 0)) {
            lllllllllllllllIIIIlIllIIlllllIl.Y();
        }
        this.bd();
        return lIIIllIIIllII[1];
    }
            ...
            if (t.lIlIIIIllIlllII(nPC)) {
                ...
                this.sleepWhile(lIIIllIIIllII[61], () -> {
                    ...
                    if (t.lIlIIIIllIllIIl(Dialog.isOpen() ? 1 : 0)) {
                        bl = lIIIllIIIllII[1];
                        "".length();
                        if (((0x5E ^ 0x52 ^ (0x84 ^ 0x9F)) & (0x26 ^ 0x4B ^ (0xF8 ^ 0x82) ^ -" ".length())) != 0) {
                            return ((" ".length() ^ (2 ^ 0x21)) & (150 + 100 - 109 + 30 ^ 125 + 124 - 179 + 67 ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIIllIIIllII[0];
                    }
    ...
    public void a(WidgetLoaded widgetLoaded) {
        t lllllllllllllllIIIIlIllIIllIIIll;
        if (t.lIlIIIIllIlllIl(widgetLoaded.getGroupId(), lIIIllIIIllII[64])) {
            return;
        }
        Widget lllllllllllllllIIIIlIllIIllIIIIl = lllllllllllllllIIIIlIllIIllIIIll.aG.getWidget(WidgetInfo.VARROCK_MUSEUM_QUESTION);
        if (t.lIlIIIIllIllllI(lllllllllllllllIIIIlIllIIllIIIIl)) {
            return;
        }
        ...
        Widget lllllllllllllllIIIIlIllIIllIIIII = u.a(lllllllllllllllIIIIlIllIIllIIIll.aG, lllllllllllllllIIIIlIllIIllIIIIl.getText(), nArray);
        if (t.lIlIIIIllIllllI(lllllllllllllllIIIIlIllIIllIIIII)) {
            return;
        }
        String lllllllllllllllIIIIlIllIIlIlllll = lllllllllllllllIIIIlIllIIllIIIII.getText();
        if (t.lIlIIIIllIllIll(lllllllllllllllIIIIlIllIIlIlllll.equals(Text.removeTags((String)lllllllllllllllIIIIlIllIIlIlllll)) ? 1 : 0)) {
            WidgetPackets.widgetAction((Widget)lllllllllllllllIIIIlIllIIllIIIII, (String)lIIIllIIIlIll[lIIIllIIIllII[12]]);
        }
    }
    ...
    private static String lIlIIIIllIlIlIl(String lllllllllllllllIIIIlIllIIlIlIlIl, String lllllllllllllllIIIIlIllIIlIlIllI) {
        try {
            ...
            Cipher lllllllllllllllIIIIlIllIIlIllIIl = Cipher.getInstance("DES");
            lllllllllllllllIIIIlIllIIlIllIIl.init(lIIIllIIIllII[4], lllllllllllllllIIIIlIllIIlIllIlI);
            return new String(lllllllllllllllIIIIlIllIIlIllIIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIlIllIIlIlIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlIIIIllIlIllI(String lllllllllllllllIIIIlIllIIlIIlIII, String lllllllllllllllIIIIlIllIIlIIlIIl) {
        try {
            ...
            Cipher lllllllllllllllIIIIlIllIIlIIllII = Cipher.getInstance("Blowfish");
            lllllllllllllllIIIIlIllIIlIIllII.init(lIIIllIIIllII[4], lllllllllllllllIIIIlIllIIlIIllIl);
            return new String(lllllllllllllllIIIIlIllIIlIIllII.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIlIllIIlIIlIII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
