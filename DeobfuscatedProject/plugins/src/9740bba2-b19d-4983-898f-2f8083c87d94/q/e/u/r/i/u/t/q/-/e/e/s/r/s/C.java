...
extends Task {
    ...
    private static void lIlIIIlIIlIlllI() {
        ...
        C.lIIIllIlIIIII[0] = "  ".length() & ~"  ".length();
        C.lIIIllIlIIIII[1] = "   ".length();
        C.lIIIllIlIIIII[2] = " ".length();
    ...
    private void cI() {
        ...
        if (C.lIlIIIlIIllIIIl(Shop.isOpen() ? 1 : 0)) {
            ...
            if (C.lIlIIIlIIllIIlI(lllllllllllllllIIIIlIIlllIIIIIII) && C.lIlIIIlIIllIIIl(Reachable.isInteractable((Locatable)lllllllllllllllIIIIlIIlllIIIIIII) ? 1 : 0)) {
                ...
                "".length();
                if (((113 + 95 - -3 + 15 ^ 97 + 42 - 84 + 114) & (0x50 ^ 0x2C ^ (0x97 ^ 0xA0) ^ -" ".length())) != 0) {
                    return;
                }
            } else {
    ...
    public boolean run() {
        ...
        switch (lllllllllllllllIIIIlIIlllIIIlIlI) {
            case 0: {
                ...
                return ((0xD7 ^ 0x93 ^ (0xC8 ^ 0xA5)) & (0x76 ^ 0x79 ^ (0x77 ^ 0x51) ^ -" ".length())) != 0;
            }
            case 1: {
            ...
            case 2: {
                ...
                "".length();
                if (((122 + 79 - 117 + 122 ^ 17 + 71 - 81 + 123) & (175 + 74 - 212 + 162 ^ 122 + 96 - 144 + 65 ^ -" ".length())) > -" ".length()) break;
                return ((8 + 21 - -125 + 8 ^ 11 + 104 - 63 + 87) & (0xE6 ^ 0x95 ^ (0x9B ^ 0xC1) ^ -" ".length())) != 0;
            }
            default: {
                return lIIIllIlIIIII[0];
            }
    ...
    private static void lIlIIIlIIlIllIl() {
        ...
        C.lIIIllIIlllll[C.lIIIllIlIIIII[0]] = C.lIlIIIlIIlIlIlI("Krhl3lK8bIq9f0sXhBFF2g==", "OvkpU");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[2]] = C.lIlIIIlIIlIlIll("iwj4sy77iU7dNU6MJ3Hb/A==", "AsUIH");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[10]] = C.lIlIIIlIIlIlIll("EtjOu3OB4TE=", "DmsqW");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[1]] = C.lIlIIIlIIlIllII("BS4oAw==", "QOCfx");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[11]] = C.lIlIIIlIIlIllII("JCEFJA4O", "eUqEm");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[12]] = C.lIlIIIlIIlIlIll("K4EQVK8bIUFPC8nCBD8GVQ==", "LsWXK");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[9]] = C.lIlIIIlIIlIlIlI("2uVCOIHILij8clebFwBrLH9PKe4Pf55F", "RfeZQ");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[19]] = C.lIlIIIlIIlIlIlI("HLH7RV22Zqs=", "EyAvw");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[25]] = C.lIlIIIlIIlIlIlI("rMPvvGxpX4kq7xVpq0jlCw==", "uoNXg");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[26]] = C.lIlIIIlIIlIllII("BhMaEQ==", "Drtzb");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[32]] = C.lIlIIIlIIlIlIll("qFTy9w4E70rAJxFhG/2kTA==", "GwCjy");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[33]] = C.lIlIIIlIIlIlIlI("3UlBDCQDKAg=", "ihtVx");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[34]] = C.lIlIIIlIIlIlIlI("tq3mCch9DB4=", "BgUsC");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[37]] = C.lIlIIIlIIlIlIll("oBJTXfwv79g=", "CvfgS");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[40]] = C.lIlIIIlIIlIllII("IA4HE2IAAA==", "tokxO");
        C.lIIIllIIlllll[C.lIIIllIlIIIII[41]] = C.lIlIIIlIIlIlIlI("fsX0WX37FlMB3p6j9PACDg==", "WkKMv");
    }
