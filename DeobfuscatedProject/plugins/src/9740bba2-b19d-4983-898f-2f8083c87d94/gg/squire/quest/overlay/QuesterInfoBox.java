...
extends OverlayPanel {
    ...
    private static void lIlIIIIllIIllll() {
        ...
        QuesterInfoBox.lIIIllIIIlIIl[1] = " ".length();
        QuesterInfoBox.lIIIllIIIlIIl[2] = "  ".length();
        QuesterInfoBox.lIIIllIIIlIIl[3] = "   ".length();
    ...
    private static void lIlIIIIllIIlllI() {
        ...
        QuesterInfoBox.lIIIllIIIlIII[QuesterInfoBox.lIIIllIIIlIIl[0]] = QuesterInfoBox.lIlIIIIllIIlIll("34cVSdZ3g2ni7d7uggfa/g==", "OIrqj");
        QuesterInfoBox.lIIIllIIIlIII[QuesterInfoBox.lIIIllIIIlIIl[1]] = QuesterInfoBox.lIlIIIIllIIlIll("2aZAzE/zIS4=", "MNmls");
        QuesterInfoBox.lIIIllIIIlIII[QuesterInfoBox.lIIIllIIIlIIl[2]] = QuesterInfoBox.lIlIIIIllIIllII("IrngkAUNPqc=", "CGSkx");
        QuesterInfoBox.lIIIllIIIlIII[QuesterInfoBox.lIIIllIIIlIIl[3]] = QuesterInfoBox.lIlIIIIllIIllIl("PSY0HX9J", "iGGvE");
    }
