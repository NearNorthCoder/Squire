...
extends OverlayPanel {
    ...
    private static void lIIIllIllIlIIll() {
        ...
        HunterInfoBox.lllIlllIIIII[HunterInfoBox.lllIlllIIIIl[1]] = HunterInfoBox.lIIIllIllIlIIIl("PO1fo5wNcIQaiu897B5a2w==", "gvTzA");
        HunterInfoBox.lllIlllIIIII[HunterInfoBox.lllIlllIIIIl[2]] = HunterInfoBox.lIIIllIllIlIIlI("33Reu5jIhho=", "DJSZR");
        HunterInfoBox.lllIlllIIIII[HunterInfoBox.lllIlllIIIIl[3]] = HunterInfoBox.lIIIllIllIlIIlI("ALRxjoy1pX8=", "hCarM");
        HunterInfoBox.lllIlllIIIII[HunterInfoBox.lllIlllIIIIl[4]] = HunterInfoBox.lIIIllIllIlIIIl("vTvUI9PbTYw=", "wowiU");
        HunterInfoBox.lllIlllIIIII[HunterInfoBox.lllIlllIIIIl[5]] = HunterInfoBox.lIIIllIllIlIIlI("KB9dOem5DpM=", "jrrCc");
        HunterInfoBox.lllIlllIIIII[HunterInfoBox.lllIlllIIIIl[6]] = HunterInfoBox.lIIIllIllIlIIlI("08yr8GWo92t3N285UERujw==", "KMcFT");
    }
    ...
    private static void lIIIllIllIlIlII() {
        ...
        HunterInfoBox.lllIlllIIIIl[1] = (0x3B ^ 0x41 ^ (0x2B ^ 0x47)) & (101 + 11 - 32 + 59 ^ 91 + 14 - -33 + 19 ^ -" ".length());
        HunterInfoBox.lllIlllIIIIl[2] = " ".length();
        HunterInfoBox.lllIlllIIIIl[3] = "  ".length();
        HunterInfoBox.lllIlllIIIIl[4] = "   ".length();
