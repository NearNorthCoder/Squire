...
extends k {
    ...
    private static void lIIlIlIIlIlllll() {
        ...
        g.lllllllIIIII[0] = (0x99 ^ 0x8F ^ (0xA0 ^ 0x98)) & (21 + 99 - 115 + 161 ^ 41 + 37 - 15 + 73 ^ -" ".length());
        g.lllllllIIIII[1] = " ".length();
        g.lllllllIIIII[2] = "  ".length();
        g.lllllllIIIII[3] = "   ".length();
        g.lllllllIIIII[4] = 0xA4 ^ 0xA0;
        g.lllllllIIIII[5] = 0xE ^ 7 ^ (0x61 ^ 0x6D);
        g.lllllllIIIII[6] = 0xAF ^ 0x9D ^ (0x24 ^ 0x10);
        g.lllllllIIIII[7] = 0x4F ^ 0x4A ^ "  ".length();
    ...
    private static void lIIlIlIIlIllllI() {
        ...
        g.llllllIlIIll[g.lllllllIIIII[0]] = g.lIIlIlIIIlIllll("Ho0F2k2Q5og=", "npvEo");
        g.llllllIlIIll[g.lllllllIIIII[1]] = g.lIIlIlIIIlIllll("LRiv432Su+o3boYxgIVFIA==", "HjlIW");
        g.llllllIlIIll[g.lllllllIIIII[2]] = g.lIIlIlIIIllIIII("EgcUOlUuARQ6", "BnwQx");
        g.llllllIlIIll[g.lllllllIIIII[3]] = g.lIIlIlIIIllIIII("PDcIG2ssNwoL", "hXeyK");
        g.llllllIlIIll[g.lllllllIIIII[4]] = g.lIIlIlIIIlIllll("h4709IcxTt9iCBE7RKLhxw==", "MQfpZ");
        g.llllllIlIIll[g.lllllllIIIII[5]] = g.lIIlIlIIIlIllll("kj6Ewepl6D3ay76ujv+CFg==", "kwZoW");
        g.llllllIlIIll[g.lllllllIIIII[6]] = g.lIIlIlIIIlIllll("02wo3lwR2Ud9JzUpMJCxsQ==", "tDEbF");
        g.llllllIlIIll[g.lllllllIIIII[7]] = g.lIIlIlIIIlIllll("lpfT0/GlRo2BkN8pPMlSqKosINntn4Ja", "oYtPS");
        g.llllllIlIIll[g.lllllllIIIII[8]] = g.lIIlIlIIIlIllll("1z1QsEoEv3c=", "QOOth");
    }
    ...
    private static String lIIlIlIIIllIIII(String lllllllllllllllIIlIIllIIllIIlllI, String lllllllllllllllIIlIIllIIllIIllIl) {
        ...
        while (g.lIIlIlIIllIIlII(lllllllllllllllIIlIIllIIllIIIIlI, lllllllllllllllIIlIIllIIllIIIIll)) {
            ...
            "".length();
            if ((0x5A ^ 0x69 ^ (0x89 ^ 0xBE)) != -" ".length()) continue;
            return null;
        }
        ...
        if (g.lIIlIlIIllIIIIl(lllllllllllllllIIlIIllIIllllIIII.D.a((c)lllllllllllllllIIlIIllIIlllIllll) ? 1 : 0) && g.lIIlIlIIllIIIlI(lllllllllllllllIIlIIllIIlllIlllI = TileObjects.getNearest(tileObject -> {
            ...
            if (g.lIIlIlIIllIIIIl(tileObject.getName().equals(llllllIlIIll[lllllllIIIII[7]]) ? 1 : 0)) {
                ...
                if (g.lIIlIlIIllIIIIl(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x1A ^ 0x59 ^ (0x17 ^ 1)) & (88 + 69 - 131 + 174 ^ 145 + 2 - 93 + 103 ^ -" ".length())) != 0;
                }
            }
            n2 = lllllllIIIII[0];
            return n2 != 0;
            ...
            lllllllllllllllIIlIIllIIlllIlllI = TileObjects.getNearest(tileObject -> {
                ...
                if (g.lIIlIlIIllIIIIl(tileObject.getName().equals(llllllIlIIll[lllllllIIIII[5]]) ? 1 : 0) && g.lIIlIlIIllIIIIl(Reachable.isInteractable((Locatable)tileObject) ? 1 : 0)) {
                    ...
                    if (g.lIIlIlIIllIIIIl(tileObject.hasAction(stringArray) ? 1 : 0)) {
                        n2 = lllllllIIIII[1];
                        "".length();
                        if (((5 ^ 0x5D ^ (0xF1 ^ 0x97)) & (18 + 25 - -59 + 55 ^ 82 + 12 - 28 + 97 ^ -" ".length())) == 0) return n2 != 0;
                        return ((0x28 ^ 0x51 ^ (0x6D ^ 0xD)) & (24 + 41 - -47 + 52 ^ 106 + 44 - 1 + 40 ^ -" ".length())) != 0;
                    }
                }
                n2 = lllllllIIIII[0];
                return n2 != 0;
        ...
        lllllllllllllllIIlIIllIIlllIlllI = TileObjects.getNearest(tileObject -> {
            ...
            if (g.lIIlIlIIllIIIIl(tileObject.getName().equals(llllllIlIIll[lllllllIIIII[3]]) ? 1 : 0)) {
                ...
                if (g.lIIlIlIIllIIIIl(tileObject.hasAction(stringArray) ? 1 : 0) && g.lIIlIlIIllIIIIl(Reachable.isInteractable((Locatable)tileObject) ? 1 : 0)) {
                    n2 = lllllllIIIII[1];
                    "".length();
                    if (((0x33 ^ 0xC ^ (0xDD ^ 0xBB)) & (0x71 ^ 0x6D ^ (0xC2 ^ 0x87) ^ -" ".length())) == 0) return n2 != 0;
                    return ((0xA9 ^ 0x8A ^ (0x17 ^ 0x28)) & (0xAB ^ 0x89 ^ (0x29 ^ 0x17) ^ -" ".length())) != 0;
                }
            }
            n2 = lllllllIIIII[0];
            return n2 != 0;
