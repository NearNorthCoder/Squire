...
extends k {
    ...
    private static void lIIlIlIIIlIIIII() {
        ...
        j.llllllIIlllI[2] = " ".length();
        j.llllllIIlllI[3] = 0xFFFFDFC7 & 0x733F;
        j.llllllIIlllI[4] = "  ".length();
    }
    ...
    private static void lIIlIlIIIIlllll() {
        ...
        j.llllllIIllIl[j.llllllIIlllI[0]] = j.lIIlIlIIIIlllIl("IBYpJw==", "ofLIm");
        j.llllllIIllIl[j.llllllIIlllI[2]] = j.lIIlIlIIIIllllI("3BWuOUJ5aaE=", "Ooyzk");
    }
