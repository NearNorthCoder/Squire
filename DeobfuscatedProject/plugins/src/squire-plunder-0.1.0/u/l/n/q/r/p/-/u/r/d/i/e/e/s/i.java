...
extends k {
    ...
    private static void lIIlIlIIlllllII() {
        ...
        i.lllllllIIlll[0] = (0x5C ^ 0x79 ^ (0x5E ^ 0x66)) & (60 + 6 - -31 + 123 ^ 86 + 105 - 53 + 55 ^ -" ".length());
        i.lllllllIIlll[1] = " ".length();
        i.lllllllIIlll[2] = -(0xFFFFBDDD & 0x66F3) & (0xFFFFFFF7 & 0x77DF);
        i.lllllllIIlll[3] = "  ".length();
        i.lllllllIIlll[4] = "   ".length();
        i.lllllllIIlll[5] = 12 + 32 - -25 + 89 ^ 34 + 12 - 8 + 112;
    }

    private static void lIIlIlIIllllIll() {
        lllllllIIllI = new String[lllllllIIlll[4]];
        i.lllllllIIllI[i.lllllllIIlll[0]] = i.lIIlIlIIllllIII("FTExGjJyBD8YMnIAOBElJg==", "RCPtV");
        i.lllllllIIllI[i.lllllllIIlll[1]] = i.lIIlIlIIllllIIl("x3/Ch2jVgek=", "RkviV");
        i.lllllllIIllI[i.lllllllIIlll[3]] = i.lIIlIlIIllllIlI("pegj2Els8eM=", "njcVK");
    }
