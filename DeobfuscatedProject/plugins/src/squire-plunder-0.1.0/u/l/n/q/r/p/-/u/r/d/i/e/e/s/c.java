...
extends Enum<c> {
    ...
    private static String lIIlIlIIIIIIllI(String lllllllllllllllIIlIIllllIIIIlllI, String lllllllllllllllIIlIIllllIIIIllll) {
        try {
            SecretKeySpec lllllllllllllllIIlIIllllIIIlIIll = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIlIIllllIIIIllll.getBytes(StandardCharsets.UTF_8)), llllllIIlIII[40]), "DES");
            Cipher lllllllllllllllIIlIIllllIIIlIIlI = Cipher.getInstance("DES");
            lllllllllllllllIIlIIllllIIIlIIlI.init(llllllIIlIII[10], lllllllllllllllIIlIIllllIIIlIIll);
            return new String(lllllllllllllllIIlIIllllIIIlIIlI.doFinal(Base64.getDecoder().decode(lllllllllllllllIIlIIllllIIIIlllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIIlIlIIIIIIlll() {
        ...
        c.llllllIIIlll[c.llllllIIlIII[0]] = c.lIIlIlIIIIIIlII("0o/sX2A1f7ynveb4+PWihw==", "gZQjW");
        c.llllllIIIlll[c.llllllIIlIII[1]] = c.lIIlIlIIIIIIlIl("GC4+LzIeNj4=", "Jaqbm");
        c.llllllIIIlll[c.llllllIIlIII[10]] = c.lIIlIlIIIIIIllI("xTIehBMB5TqxJDltOPy7+g==", "KqCQf");
        c.llllllIIIlll[c.llllllIIlIII[16]] = c.lIIlIlIIIIIIlII("0f5MW3EgHZhJBnRyxlxy+Q==", "xDjzt");
        c.llllllIIIlll[c.llllllIIlIII[22]] = c.lIIlIlIIIIIIlIl("Hw4EBxwLCB0P", "MAKJC");
        c.llllllIIIlll[c.llllllIIlIII[28]] = c.lIIlIlIIIIIIlII("P0p6xMm7G37cLluUWBI1uA==", "kpKsM");
        c.llllllIIIlll[c.llllllIIlIII[32]] = c.lIIlIlIIIIIIlII("uiheFoyg0FXQquv9NLb3zg==", "pyjiW");
        c.llllllIIIlll[c.llllllIIlIII[36]] = c.lIIlIlIIIIIIllI("yVHaqOoMuDX/TK+daW898A==", "tCZRA");
    }

    private static String lIIlIlIIIIIIlIl(String lllllllllllllllIIlIIllllIIIIIIII, String lllllllllllllllIIlIIlllIlllllIlI) {
        lllllllllllllllIIlIIllllIIIIIIII = new String(Base64.getDecoder().decode(lllllllllllllllIIlIIllllIIIIIIII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIlIIlllIlllllllI = new StringBuilder();
        char[] lllllllllllllllIIlIIlllIllllllIl = lllllllllllllllIIlIIlllIlllllIlI.toCharArray();
        int lllllllllllllllIIlIIlllIllllllII = llllllIIlIII[0];
        char[] lllllllllllllllIIlIIlllIllllIllI = lllllllllllllllIIlIIllllIIIIIIII.toCharArray();
        int lllllllllllllllIIlIIlllIllllIlIl = lllllllllllllllIIlIIlllIllllIllI.length;
        int lllllllllllllllIIlIIlllIllllIlII = llllllIIlIII[0];
        while (c.lIIlIlIIIIIlIIl(lllllllllllllllIIlIIlllIllllIlII, lllllllllllllllIIlIIlllIllllIlIl)) {
            char lllllllllllllllIIlIIllllIIIIIIIl = lllllllllllllllIIlIIlllIllllIllI[lllllllllllllllIIlIIlllIllllIlII];
            lllllllllllllllIIlIIlllIlllllllI.append((char)(lllllllllllllllIIlIIllllIIIIIIIl ^ lllllllllllllllIIlIIlllIllllllIl[lllllllllllllllIIlIIlllIllllllII % lllllllllllllllIIlIIlllIllllllIl.length]));
            "".length();
            ++lllllllllllllllIIlIIlllIllllllII;
            ++lllllllllllllllIIlIIlllIllllIlII;
            "".length();
    ...
    private static String lIIlIlIIIIIIlII(String lllllllllllllllIIlIIlllIlllIlIIl, String lllllllllllllllIIlIIlllIlllIlIlI) {
        try {
            SecretKeySpec lllllllllllllllIIlIIlllIlllIlllI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIlIIlllIlllIlIlI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIIlIIlllIlllIllIl = Cipher.getInstance("Blowfish");
            lllllllllllllllIIlIIlllIlllIllIl.init(llllllIIlIII[10], lllllllllllllllIIlIIlllIlllIlllI);
            return new String(lllllllllllllllIIlIIlllIlllIllIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIIlIIlllIlllIlIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static boolean g() {
        boolean bl;
        void lllllllllllllllIIlIIllllIIlIIIIl;
        void lllllllllllllllIIlIIllllIIlIIIII;
        int n2 = Skills.getBoostedLevel((Skill)Skill.THIEVING);
        c c2 = c.f();
        if (c.lIIlIlIIIIIlIll((Object)c2)) {
            return llllllIIlIII[0];
        }
        c lllllllllllllllIIlIIllllIIIlllll = c.d((c)lllllllllllllllIIlIIllllIIlIIIII);
        if (c.lIIlIlIIIIIlIll((Object)lllllllllllllllIIlIIllllIIIlllll)) {
            return llllllIIlIII[0];
        }
        int lllllllllllllllIIlIIllllIIIllllI = lllllllllllllllIIlIIllllIIIlllll.h();
        if (c.lIIlIlIIIIIllII((int)lllllllllllllllIIlIIllllIIlIIIIl, lllllllllllllllIIlIIllllIIIllllI)) {
            bl = llllllIIlIII[1];
            "".length();
            if (-" ".length() >= ((0x4C ^ 3) & ~(0xDE ^ 0x91))) {
                return ((0x5D ^ 0x50) & ~(0x52 ^ 0x5F)) != 0;
            }
        } else {
            bl = llllllIIlIII[0];
        }
    ...
    private static void lIIlIlIIIIIlIII() {
        ...
        c.llllllIIlIII[0] = (0x63 ^ 0x38 ^ (0x59 ^ 0x2B)) & (0xD6 ^ 0x95 ^ (0xD7 ^ 0xBD) ^ -" ".length());
        c.llllllIIlIII[1] = " ".length();
        ...
        c.llllllIIlIII[10] = "  ".length();
        c.llllllIIlIII[11] = 0x5F ^ 0x74 ^ "  ".length();
        ...
        c.llllllIIlIII[29] = " ".length() ^ (9 ^ 0x4F);
     ...
     */
    public static c f() {
        void lllllllllllllllIIlIIllllIIlIlIII;
        Player player = Players.getLocal();
        c[] cArray = c.values();
        int n2 = cArray.length;
        int lllllllllllllllIIlIIllllIIlIIlll = llllllIIlIII[0];
        while (c.lIIlIlIIIIIlIIl(lllllllllllllllIIlIIllllIIlIIlll, (int)lllllllllllllllIIlIIllllIIlIlIII)) {
            void lllllllllllllllIIlIIllllIIlIlIlI;
            void lllllllllllllllIIlIIllllIIlIlIIl;
            void lllllllllllllllIIlIIllllIIlIIllI = lllllllllllllllIIlIIllllIIlIlIIl[lllllllllllllllIIlIIllllIIlIIlll];
            if (c.lIIlIlIIIIIlIlI(lllllllllllllllIIlIIllllIIlIIllI.i().contains((Locatable)lllllllllllllllIIlIIllllIIlIlIlI) ? 1 : 0)) {
                return lllllllllllllllIIlIIllllIIlIIllI;
            }
