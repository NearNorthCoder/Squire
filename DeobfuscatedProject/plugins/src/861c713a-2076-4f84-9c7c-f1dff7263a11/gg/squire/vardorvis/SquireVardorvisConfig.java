...
extends Config {
    ...
    default public boolean bankOnStart() {
        return ((0x8D ^ 0xA2 ^ (0xBF ^ 0x9E)) & (0xE0 ^ 0xB2 ^ (0xF1 ^ 0xAD) ^ -" ".length())) != 0;
    }
    ...
    default public int specHp() {
        return (0x9A ^ 0xA3) + (0x76 ^ 3) - -(0x5F ^ 0x48) + "   ".length();
    }
    ...
    default public boolean earlyBank() {
        return ((0x39 ^ 0x40 ^ (0xDA ^ 0xC1)) & (141 + 199 - 239 + 105 ^ 97 + 22 - -8 + 45 ^ -" ".length())) != 0;
    }
