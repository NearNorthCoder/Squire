...
extends OverlayPanel {
    ...
    private static void lIlllllIIIIIIII() {
        ...
        SquireVardorvisBox.lIlIlIIlIllII[SquireVardorvisBox.lIlIlIIlIllIl[1]] = SquireVardorvisBox.lIllllIllllllIl("C05y/FZSWy6xmKgm3jMnRnKO2XuMzfO+", "LhVXJ");
        SquireVardorvisBox.lIlIlIIlIllII[SquireVardorvisBox.lIlIlIIlIllIl[4]] = SquireVardorvisBox.lIllllIllllllIl("L42rVUmabo9RNVfhFaRLqg==", "nvzUz");
        SquireVardorvisBox.lIlIlIIlIllII[SquireVardorvisBox.lIlIlIIlIllIl[5]] = SquireVardorvisBox.lIllllIllllllIl("GJUb4WoYuNk=", "VAsZu");
        SquireVardorvisBox.lIlIlIIlIllII[SquireVardorvisBox.lIlIlIIlIllIl[6]] = SquireVardorvisBox.lIllllIllllllIl("Cc6+/QswfCSMTVY6s/tDLw==", "NOCkO");
        SquireVardorvisBox.lIlIlIIlIllII[SquireVardorvisBox.lIlIlIIlIllIl[7]] = SquireVardorvisBox.lIllllIlllllllI("WMzkoHuyUyA=", "XwumP");
        SquireVardorvisBox.lIlIlIIlIllII[SquireVardorvisBox.lIlIlIIlIllIl[8]] = SquireVardorvisBox.lIllllIllllllll("LzMCHkM=", "kZgzy");
    }

    private static void lIlllllIIIIIIIl() {
        lIlIlIIlIllIl = new int[11];
        SquireVardorvisBox.lIlIlIIlIllIl[0] = 0x3E ^ 0x34;
        SquireVardorvisBox.lIlIlIIlIllIl[1] = (180 + 144 - 191 + 60 ^ 5 + 101 - 64 + 97) & (10 + 153 - 48 + 95 ^ 97 + 70 - 128 + 113 ^ -" ".length());
        SquireVardorvisBox.lIlIlIIlIllIl[2] = 145 + 79 - 86 + 55;
        SquireVardorvisBox.lIlIlIIlIllIl[3] = "  ".length() ^ (0x57 ^ 0x41);
        SquireVardorvisBox.lIlIlIIlIllIl[4] = " ".length();
        SquireVardorvisBox.lIlIlIIlIllIl[5] = "  ".length();
        SquireVardorvisBox.lIlIlIIlIllIl[6] = "   ".length();
