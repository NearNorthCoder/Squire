...
extends SquirePlugin {
    ...
    public boolean c() {
        ...
        while (SquireFarmer.lllIllIIIIlIII(lllllllllllllllIlIllIllIIllIlIII, (int)lllllllllllllllIlIllIllIIllIlIIl)) {
            ...
            "".length();
            if ((72 + 147 - 158 + 130 ^ 79 + 134 - 167 + 141) > " ".length()) continue;
            return ((61 + 16 - 53 + 136 ^ 76 + 95 - 82 + 79) & (0x83 ^ 0x98 ^ (0x51 ^ 0x42) ^ -" ".length())) != 0;
        }
    ...
    private boolean c(o o2) {
        switch (-.m.e.a.u.s.r.r.q.i.r.e.f.a.p[o2.ordinal()]) {
            case 1: {
                ...
                return ((0x20 ^ 0x32 ^ (0xCD ^ 0x93)) & (0x72 ^ 0x5E ^ (0x23 ^ 0x43) ^ -" ".length())) != 0;
            }
            case 2: {
                boolean bl;
                SquireFarmer lllllllllllllllIlIllIllIIlIllIII;
                if (SquireFarmer.lllIllIIIIIlIl(lllllllllllllllIlIllIllIIlIllIII.h.birdhouses_enabled() ? 1 : 0)) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((0xBF ^ 0x83 ^ (0x59 ^ 0x61)) & (0x5F ^ 8 ^ (0x52 ^ 1) ^ -" ".length())) != 0;
                    }
                } else {
                    bl = lIlllIlIIIII[1];
                }
    ...
    private static void lllIllIIIIIIIl() {
        ...
        SquireFarmer.lIlllIIlllll[SquireFarmer.lIlllIlIIIII[1]] = SquireFarmer.lllIlIllllllll("TSfNJrPr8Daey7x8kxoFJA==", "ROuWf");
        SquireFarmer.lIlllIIlllll[SquireFarmer.lIlllIlIIIII[0]] = SquireFarmer.lllIlIllllllll("ig75Wj5gKPo=", "jQKDS");
        SquireFarmer.lIlllIIlllll[SquireFarmer.lIlllIlIIIII[3]] = SquireFarmer.lllIllIIIIIIII("EBo5KzQ/", "SrPXQ");
        SquireFarmer.lIlllIIlllll[SquireFarmer.lIlllIlIIIII[4]] = SquireFarmer.lllIlIllllllll("XuvAmMs99xTf27x0WWvF9A==", "TTTvo");
    }
    ...
    private o b() {
        ...
        while (SquireFarmer.lllIllIIIIlIII(lllllllllllllllIlIllIllIIlllIIlI, (int)lllllllllllllllIlIllIllIIlllIIll)) {
            ...
            "".length();
            if ("   ".length() > ((9 ^ 0x23) & ~(0x58 ^ 0x72))) continue;
            return null;
        }
        ...
        switch (-.m.e.a.u.s.r.r.q.i.r.e.f.a.p[var1_1.ordinal()]) {
            ...
            case 2: {
...

                {
                    ...
                    "".length();
                    if (-"   ".length() >= 0) {
                        return (boolean)((102 ^ 116 ^ "   ".length()) & (132 ^ 174 ^ (5 ^ 62) ^ -" ".length()));
                    }
                } else lbl-1000:
                // 2 sources
    ...
    private static void lllIllIIIIIIlI() {
        ...
        SquireFarmer.lIlllIlIIIII[0] = " ".length();
        SquireFarmer.lIlllIlIIIII[1] = (0xF6 ^ 0xA1) & ~(0xE1 ^ 0xB6);
        SquireFarmer.lIlllIlIIIII[2] = 0x99 ^ 0xB9 ^ (0x94 ^ 0xA8);
        SquireFarmer.lIlllIlIIIII[3] = "  ".length();
        SquireFarmer.lIlllIlIIIII[4] = "   ".length();
