...
extends P {
    ...
    @Override
    public an f(int n2) {
        void lllllllllllllllIlIlIlIIIllIIIIll;
        if (Q.llllIlIIIIIllI(n2) && Q.llllIlIIIIIlll(n2, llIIIlIIlIII[0])) {
            return new an(au.WEEDS, n.GROWING, llIIIlIIlIII[0] - n2);
        }
        if (Q.llllIlIIIIlIII((int)lllllllllllllllIlIlIlIIIllIIIIll, llIIIlIIlIII[1]) && Q.llllIlIIIIIlll((int)lllllllllllllllIlIlIlIIIllIIIIll, llIIIlIIlIII[2])) {
            return new an(au.BELLADONNA, n.GROWING, (int)(lllllllllllllllIlIlIlIIIllIIIIll - llIIIlIIlIII[1]));
        }
        if (Q.llllIlIIIIlIIl((int)lllllllllllllllIlIlIlIIIllIIIIll, llIIIlIIlIII[3])) {
            return new an(au.BELLADONNA, n.HARVESTABLE, llIIIlIIlIII[4]);
        }
        if (Q.llllIlIIIIlIII((int)lllllllllllllllIlIlIlIIIllIIIIll, llIIIlIIlIII[5]) && Q.llllIlIIIIIlll((int)lllllllllllllllIlIlIlIIIllIIIIll, llIIIlIIlIII[6])) {
            return new an(au.BELLADONNA, n.DISEASED, (int)(lllllllllllllllIlIlIlIIIllIIIIll - llIIIlIIlIII[3]));
        }
        if (Q.llllIlIIIIlIII((int)lllllllllllllllIlIlIlIIIllIIIIll, llIIIlIIlIII[7]) && Q.llllIlIIIIIlll((int)lllllllllllllllIlIlIlIIIllIIIIll, llIIIlIIlIII[8])) {
            return new an(au.BELLADONNA, n.DEAD, (int)(lllllllllllllllIlIlIlIIIllIIIIll - llIIIlIIlIII[6]));
        }
        if (Q.llllIlIIIIlIII((int)lllllllllllllllIlIlIlIIIllIIIIll, llIIIlIIlIII[9]) && Q.llllIlIIIIIlll((int)lllllllllllllllIlIlIlIIIllIIIIll, llIIIlIIlIII[10])) {
