...
public class h {
    ...
    public boolean K() {
        ...
        if (h.lllIlIllIIllll(this.I())) {
            ...
            "".length();
            if ("  ".length() == 0) {
                return ((47 + 87 - 84 + 105 ^ 170 + 31 - 101 + 80) & (1 + 8 - -99 + 37 ^ 155 + 114 - 232 + 153 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlllIIlIIlI[1];
        }
    ...
    private static void lllIlIllIIllII() {
        ...
        h.lIlllIIlIIlI[2] = " ".length();
        h.lIlllIIlIIlI[3] = 0xDB ^ 0xB0 ^ (0x89 ^ 0x9C);
        h.lIlllIIlIIlI[4] = 0xC ^ 9;
        h.lIlllIIlIIlI[5] = "  ".length();
        h.lIlllIIlIIlI[6] = -" ".length() & (0xFFFFFFFF & Integer.MAX_VALUE);
        h.lIlllIIlIIlI[7] = "   ".length();
    ...
    private static void lllIlIllIIlIII() {
        ...
        h.lIlllIIIlIlI[h.lIlllIIlIIlI[1]] = h.lllIlIllIIIIIl("ETstGEwJMTIGCSY8IwEC", "ETBtl");
        h.lIlllIIIlIlI[h.lIlllIIlIIlI[2]] = h.lllIlIllIIIIlI("hUphOyudoHE=", "yOsMx");
        h.lIlllIIIlIlI[h.lIlllIIlIIlI[5]] = h.lllIlIllIIIIlI("gXJ2Jio5up0=", "jPmfK");
        h.lIlllIIIlIlI[h.lIlllIIlIIlI[7]] = h.lllIlIllIIIIIl("FA4mEzdqOyUN", "GzIaR");
        h.lIlllIIIlIlI[h.lIlllIIlIIlI[8]] = h.lllIlIllIIIlll("LQ/f4Jd70vX/dDu7MeK8FA==", "FmTOv");
        h.lIlllIIIlIlI[h.lIlllIIlIIlI[4]] = h.lllIlIllIIIIIl("MDMoIjwHewQhJg==", "bVEMJ");
        h.lIlllIIIlIlI[h.lIlllIIlIIlI[9]] = h.lllIlIllIIIIIl("OCkmHxUP", "jLKpc");
        h.lIlllIIIlIlI[h.lIlllIIlIIlI[10]] = h.lllIlIllIIIlll("iGfh+svknm2vUww8GoPH0A==", "nrgaM");
    }
