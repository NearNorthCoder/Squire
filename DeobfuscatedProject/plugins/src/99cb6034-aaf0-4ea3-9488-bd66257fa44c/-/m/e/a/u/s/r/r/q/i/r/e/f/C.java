...
extends Enum<C> {
    ...
    private static void lllIllIlIlIIll() {
        ...
        C.lIlllIllllIl[0] = " ".length();
        C.lIlllIllllIl[1] = "   ".length();
        C.lIlllIllllIl[2] = (0x20 ^ 0x30 ^ (0x6A ^ 0x73)) & (0x34 ^ 0x6E ^ (0x60 ^ 0x33) ^ -" ".length());
        C.lIlllIllllIl[3] = 0xFFFFD5F9 & 0x7E0E;
        C.lIlllIllllIl[4] = 0xFFFFDFE7 & 0x25FF;
        C.lIlllIllllIl[5] = "  ".length();
        ...
        C.lIlllIllllIl[23] = -"  ".length() & (0xFFFFFEFF & 0x19BD);
    ...
    private static void lllIllIlIlIIlI() {
        ...
        C.lIlllIllllII[C.lIlllIllllIl[2]] = C.lllIllIlIIllll("e5ayL8aA9iQ=", "jmeUZ");
        C.lIlllIllllII[C.lIlllIllllIl[0]] = C.lllIllIlIlIIII("O4i+OVJ71bZwq8ADcDQctA==", "BgNAT");
        C.lIlllIllllII[C.lIlllIllllIl[5]] = C.lllIllIlIlIIII("Fw+y+YI9gi8=", "lzrrB");
        C.lIlllIllllII[C.lIlllIllllIl[1]] = C.lllIllIlIlIIIl("BDABcTQiIw5xPiQkGTQ=", "KQjQv");
        C.lIlllIllllII[C.lIlllIllllIl[8]] = C.lllIllIlIlIIIl("GzsKGQQb", "LrFUK");
        C.lIlllIllllII[C.lIlllIllllIl[9]] = C.lllIllIlIIllll("A0YkgKYqjFZeZLOxlWKKtkz1aA5q7cAN", "tAfEd");
        C.lIlllIllllII[C.lIlllIllllIl[12]] = C.lllIllIlIlIIII("7ehDMVtenFo=", "oYNVU");
        C.lIlllIllllII[C.lIlllIllllIl[13]] = C.lllIllIlIlIIII("cvNQiyWFYvq3zdVRWa8LZQ==", "rwXzz");
        C.lIlllIllllII[C.lIlllIllllIl[16]] = C.lllIllIlIlIIIl("DCUeNh8=", "AdNzZ");
        C.lIlllIllllII[C.lIlllIllllIl[17]] = C.lllIllIlIIllll("OxUbnG++9PWSyQDntdbOUProNmfixTFr", "vxcmE");
        C.lIlllIllllII[C.lIlllIllllIl[20]] = C.lllIllIlIlIIII("Fbgr81qSY6lxbp6FkKiifA==", "NhjtQ");
        C.lIlllIllllII[C.lIlllIllllIl[21]] = C.lllIllIlIIllll("5fcTAtxNlkjX2AUQ4uBZRuMaI+/U560S", "GoJTl");
        C.lIlllIllllII[C.lIlllIllllIl[24]] = C.lllIllIlIlIIII("yi7EHNwZV14=", "xOPso");
        C.lIlllIllllII[C.lIlllIllllIl[25]] = C.lllIllIlIlIIII("UsR9dZEku82NHcpteorh5A==", "mXIcP");
        C.lIlllIllllII[C.lIlllIllllIl[28]] = C.lllIllIlIIllll("hSQZHneGte0=", "VKOLK");
        C.lIlllIllllII[C.lIlllIllllIl[29]] = C.lllIllIlIlIIII("1jCHHpIE69vkavJ5sS/4bY9F4/KI7Vva", "RdZWR");
        C.lIlllIllllII[C.lIlllIllllIl[32]] = C.lllIllIlIIllll("Qtrcg+i1ctQ=", "joeIA");
        C.lIlllIllllII[C.lIlllIllllIl[33]] = C.lllIllIlIlIIII("VqDw9zjAAqydhvpgo3yuocpyDN/AneXF", "LVnRD");
    }
