...
extends az {
    ...
    public boolean run() {
        void var3_3;
        void lllllllllllllllIlIlIlIlIIlIIIIlI;
        aN lllllllllllllllIlIlIlIlIIlIIIIll;
        q q2 = this.bR.x();
        if (aN.llllIIllIIlllI(q2)) {
            return llIIIIllIllI[0];
        }
        if (aN.llllIIllIIllll(lllllllllllllllIlIlIlIlIIlIIIIll.bR.b((q)lllllllllllllllIlIlIlIlIIlIIIIlI).ai() ? 1 : 0)) {
            return llIIIIllIllI[0];
        }
        N lllllllllllllllIlIlIlIlIIlIIIIIl = lllllllllllllllIlIlIlIlIIlIIIIlI.aa();
        if (!aN.llllIIllIlIIII(lllllllllllllllIlIlIlIlIIlIIIIIl) || aN.llllIIllIIllll(lllllllllllllllIlIlIlIlIIlIIIIll.I(lllllllllllllllIlIlIlIlIIlIIIIIl) ? 1 : 0)) {
            return llIIIIllIllI[0];
        }
        TileObject lllllllllllllllIlIlIlIlIIlIIIIII = lllllllllllllllIlIlIlIlIIlIIIIIl.b(lllllllllllllllIlIlIlIlIIlIIIIll.bT);
        if (!aN.llllIIllIlIIII(lllllllllllllllIlIlIlIlIIlIIIIII) || aN.llllIIllIIllll(Reachable.isInteractable((Locatable)lllllllllllllllIlIlIlIlIIlIIIIII) ? 1 : 0)) {
            return llIIIIllIllI[0];
        }
