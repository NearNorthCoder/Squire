...
extends Task {
    ...
    private static void llllIIlIlllIIl() {
        ...
        aC.llIIIIllIIIl[0] = (88 + 36 - 11 + 20 ^ 176 + 44 - 62 + 36) & (0xA4 ^ 0xAA ^ (0x3F ^ 0x76) ^ -" ".length());
        aC.llIIIIllIIIl[1] = " ".length();
        aC.llIIIIllIIIl[2] = 0x62 ^ 0x57 ^ (0xCF ^ 0xC6);
        aC.llIIIIllIIIl[3] = -" ".length();
    }
    ...
    private static void llllIIlIlllIII() {
        ...
        aC.llIIIIllIIII[aC.llIIIIllIIIl[0]] = aC.llllIIlIllIlll("Pz48Eg==", "qQRwS");
    }
