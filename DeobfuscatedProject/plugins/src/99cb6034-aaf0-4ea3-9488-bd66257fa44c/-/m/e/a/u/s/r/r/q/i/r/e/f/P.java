...
extends Enum<P> {
    ...
    private static String llllIIllIIIIIl(String lllllllllllllllIlIlIlIlIIlIlllII, String lllllllllllllllIlIlIlIlIIlIllIll) {
        lllllllllllllllIlIlIlIlIIlIlllII = new String(Base64.getDecoder().decode(lllllllllllllllIlIlIlIlIIlIlllII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIlIlIlIlIIlIlllll = new StringBuilder();
        char[] lllllllllllllllIlIlIlIlIIlIllllI = lllllllllllllllIlIlIlIlIIlIllIll.toCharArray();
        int lllllllllllllllIlIlIlIlIIlIlllIl = llIIIIllIIll[1];
        char[] lllllllllllllllIlIlIlIlIIlIlIlll = lllllllllllllllIlIlIlIlIIlIlllII.toCharArray();
        int lllllllllllllllIlIlIlIlIIlIlIllI = lllllllllllllllIlIlIlIlIIlIlIlll.length;
        int lllllllllllllllIlIlIlIlIIlIlIlIl = llIIIIllIIll[1];
        while (P.llllIIllIIlIII(lllllllllllllllIlIlIlIlIIlIlIlIl, lllllllllllllllIlIlIlIlIIlIlIllI)) {
            char lllllllllllllllIlIlIlIlIIllIIIlI = lllllllllllllllIlIlIlIlIIlIlIlll[lllllllllllllllIlIlIlIlIIlIlIlIl];
            ...
            ++lllllllllllllllIlIlIlIlIIlIlIlIl;
            "".length();
    ...
    public boolean aT() {
        ...
        if (!P.llllIIllIIIllI((Object)this, (Object)HERB) || !P.llllIIllIIIllI((Object)this, (Object)BUSH) || !P.llllIIllIIIllI((Object)this, (Object)SEAWEED) || P.llllIIllIIIlll((Object)this, (Object)GRAPES)) {
            bl = llIIIIllIIll[0];
            "".length();
            if (((179 + 84 - 134 + 76 ^ 118 + 49 - 164 + 145) & (0x31 ^ 0x6B ^ "   ".length() ^ -" ".length())) != 0) {
                return ((0x7B ^ 0x20 ^ (0xA0 ^ 0xB2)) & (63 + 120 - 53 + 110 ^ 72 + 78 - -31 + 4 ^ -" ".length())) != 0;
            }
        } else {
            bl = llIIIIllIIll[1];
        }
    ...
    private static void llllIIllIIIlIl() {
        ...
        P.llIIIIllIIll[0] = " ".length();
        P.llIIIIllIIll[1] = (0x2E ^ 0x28) & ~(0xC7 ^ 0xC1);
        P.llIIIIllIIll[2] = "  ".length();
        P.llIIIIllIIll[3] = "   ".length();
        ...
        P.llIIIIllIIll[19] = 0x3F ^ 0x2E ^ "  ".length();
    ...
    private static void llllIIllIIIlII() {
        ...
        P.llIIIIllIIlI[P.llIIIIllIIll[1]] = P.llllIIllIIIIIl("ES87GSIXJTkbIg==", "SjwUc");
        P.llIIIIllIIlI[P.llIIIIllIIll[0]] = P.llllIIllIIIIIl("", "KBbHB");
        P.llIIIIllIIlI[P.llIIIIllIIll[2]] = P.llllIIllIIIIlI("tzPVtBXCMeQZnxGv0MJNZg==", "LBncx");
        P.llIIIIllIIlI[P.llIIIIllIIll[3]] = P.llllIIllIIIIlI("tBbeOVX5uvU=", "lveGn");
        P.llIIIIllIIlI[P.llIIIIllIIll[4]] = P.llllIIllIIIIll("7qLMoSKS5Hg=", "XwDfx");
        P.llIIIIllIIlI[P.llIIIIllIIll[5]] = P.llllIIllIIIIIl("", "dRWJB");
        P.llIIIIllIIlI[P.llIIIIllIIll[6]] = P.llllIIllIIIIll("4bmB3tNw8LrBNAJeiDKJAA==", "HqGnx");
        P.llIIIIllIIlI[P.llIIIIllIIll[7]] = P.llllIIllIIIIIl("BAE0KxwoCDYw", "EmXDh");
        P.llIIIIllIIlI[P.llIIIIllIIll[8]] = P.llllIIllIIIIIl("ByAYKw==", "OeJif");
        P.llIIIIllIIlI[P.llIIIIllIIll[9]] = P.llllIIllIIIIIl("JhECOEEeFQQ5CQ==", "ntpZa");
        P.llIIIIllIIlI[P.llIIIIllIIll[10]] = P.llllIIllIIIIIl("LyI4ISc=", "gGJCT");
        P.llIIIIllIIlI[P.llIIIIllIIll[11]] = P.llllIIllIIIIll("ivT+/AGF54U=", "LKfyN");
        P.llIIIIllIIlI[P.llIIIIllIIll[12]] = P.llllIIllIIIIlI("A0dqse7wSf1EFqW/8ZRIYg==", "NTSHf");
        P.llIIIIllIIlI[P.llIIIIllIIll[13]] = P.llllIIllIIIIlI("OViYCdaKI/c=", "kCwNM");
        P.llIIIIllIIlI[P.llIIIIllIIll[14]] = P.llllIIllIIIIIl("", "HhCDi");
        P.llIIIIllIIlI[P.llIIIIllIIll[15]] = P.llllIIllIIIIIl("CCExDz0RJzYDLA==", "NsdFi");
        P.llIIIIllIIlI[P.llIIIIllIIll[16]] = P.llllIIllIIIIlI("Ba2m8cFQ65w=", "YoudW");
        P.llIIIIllIIlI[P.llIIIIllIIll[17]] = P.llllIIllIIIIlI("0+FNl0GFWgo=", "GkVOR");
        P.llIIIIllIIlI[P.llIIIIllIIll[18]] = P.llllIIllIIIIll("BYI129CFvkE=", "iAImi");
        P.llIIIIllIIlI[P.llIIIIllIIll[19]] = P.llllIIllIIIIlI("g3G0fcNskgY=", "DPJlB");
        P.llIIIIllIIlI[P.llIIIIllIIll[20]] = P.llllIIllIIIIll("VHIeA2ej0Ws=", "MbpQn");
        P.llIIIIllIIlI[P.llIIIIllIIll[21]] = P.llllIIllIIIIlI("tvw7XHxpUR6Hx4pC2al8Og==", "CEBiP");
        P.llIIIIllIIlI[P.llIIIIllIIll[22]] = P.llllIIllIIIIll("NLmQGLq2uyO3oM1pJzNd/A==", "yCiYP");
        P.llIIIIllIIlI[P.llIIIIllIIll[23]] = P.llllIIllIIIIlI("ESTtZs4FWDc=", "loBAD");
        P.llIIIIllIIlI[P.llIIIIllIIll[24]] = P.llllIIllIIIIll("ny14ICA1KxnochyUGY/keA==", "xWHCf");
        P.llIIIIllIIlI[P.llIIIIllIIll[25]] = P.llllIIllIIIIIl("Ch8HKD0NEBooMRw=", "YONzt");
        P.llIIIIllIIlI[P.llIIIIllIIll[26]] = P.llllIIllIIIIIl("MAEtOyAXURA7LAYC", "cqDII");
        P.llIIIIllIIlI[P.llIIIIllIIll[27]] = P.llllIIllIIIIIl("IB8oByg=", "aQaJi");
        P.llIIIIllIIlI[P.llIIIIllIIll[28]] = P.llllIIllIIIIll("nOmuEGqiFG0=", "agvOZ");
        P.llIIIIllIIlI[P.llIIIIllIIll[29]] = P.llllIIllIIIIll("868xzVXxyvw=", "XOAxi");
        P.llIIIIllIIlI[P.llIIIIllIIll[30]] = P.llllIIllIIIIIl("KTICOzAZ", "jSaOE");
        P.llIIIIllIIlI[P.llIIIIllIIll[31]] = P.llllIIllIIIIIl("GhMsAxwMEg==", "IVmTY");
        P.llIIIIllIIlI[P.llIIIIllIIll[32]] = P.llllIIllIIIIIl("HBMzLi4qEg==", "OvRYK");
        P.llIIIIllIIlI[P.llIIIIllIIll[33]] = P.llllIIllIIIIIl("LDkrFQAuLA==", "oxgDU");
        P.llIIIIllIIlI[P.llIIIIllIIll[34]] = P.llllIIllIIIIll("YaY1jFs9uf0=", "XNfpp");
        P.llIIIIllIIlI[P.llIIIIllIIll[35]] = P.llllIIllIIIIlI("M3OcO4w3WwDQiIWZh9MQ4A==", "eOzRp");
        P.llIIIIllIIlI[P.llIIIIllIIll[36]] = P.llllIIllIIIIll("iDLw7d5LTwqW4CaVkxvPgw==", "InWmG");
        P.llIIIIllIIlI[P.llIIIIllIIll[37]] = P.llllIIllIIIIIl("CRglIRUd", "NJdqP");
        P.llIIIIllIIlI[P.llIIIIllIIll[38]] = P.llllIIllIIIIlI("1VDJfTdZTcs=", "tlCYa");
        P.llIIIIllIIlI[P.llIIIIllIIll[39]] = P.llllIIllIIIIll("4T1ld43PvcBJj+d9WGACeg==", "aybXL");
        P.llIIIIllIIlI[P.llIIIIllIIll[40]] = P.llllIIllIIIIIl("NgswBz8UFWkgORAc", "uyItK");
        P.llIIIIllIIlI[P.llIIIIllIIll[41]] = P.llllIIllIIIIIl("ACUePCoQPg==", "CjSle");
        P.llIIIIllIIlI[P.llIIIIllIIll[42]] = P.llllIIllIIIIlI("eeBwcQlLS+ofHl3/Ff6r5Q==", "WZtgl");
        P.llIIIIllIIlI[P.llIIIIllIIll[43]] = P.llllIIllIIIIll("YfKwcX/8wB5CP7tdU0JVmg==", "LdQyh");
        P.llIIIIllIIlI[P.llIIIIllIIll[44]] = P.llllIIllIIIIlI("jM1qCcRkIlJ5sdCEOPDTtQ==", "ThDxV");
    }
    ...
    private static String llllIIllIIIIll(String lllllllllllllllIlIlIlIlIIllIllll, String lllllllllllllllIlIlIlIlIIlllIIII) {
        try {
            ...
            return new String(lllllllllllllllIlIlIlIlIIlllIIll.doFinal(Base64.getDecoder().decode(lllllllllllllllIlIlIlIlIIllIllll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String llllIIllIIIIlI(String lllllllllllllllIlIlIlIlIIllllllI, String lllllllllllllllIlIlIlIlIIlllllIl) {
        try {
            ...
            Cipher lllllllllllllllIlIlIlIlIlIIIIIII = Cipher.getInstance("DES");
            lllllllllllllllIlIlIlIlIlIIIIIII.init(llIIIIllIIll[2], lllllllllllllllIlIlIlIlIlIIIIIIl);
            return new String(lllllllllllllllIlIlIlIlIlIIIIIII.doFinal(Base64.getDecoder().decode(lllllllllllllllIlIlIlIlIIllllllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
