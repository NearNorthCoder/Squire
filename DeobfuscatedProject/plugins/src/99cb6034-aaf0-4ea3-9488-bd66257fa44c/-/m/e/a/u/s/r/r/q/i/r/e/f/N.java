...
public class N {
    ...
    private static String lllIllIllIIlII(String lllllllllllllllIlIllIIllllllllll, String lllllllllllllllIlIllIlIIIIIIIIll) {
        ...
        while (N.lllIllIllIllIl(lllllllllllllllIlIllIIlllllllIII, lllllllllllllllIlIllIIlllllllIIl)) {
            ...
            "".length();
            if ("  ".length() != ((0x87 ^ 0xA3) & ~(0x18 ^ 0x3C))) continue;
            return null;
        }
    ...
    public TileObject b(Client client) {
        ...
        return TileObjects.getNearest(tileObject -> {
            ...
            if (N.lllIllIllIlIIl(tileObject.hasAction(lIllllIIIIll[lIllllIIIlII[1]]::equals) ? 1 : 0) && N.lllIllIllIlIlI(client.getObjectDefinition(tileObject.getId()).getVarbitId(), this.bt)) {
                ...
                "".length();
                if (-"  ".length() > 0) {
                    return ((0x1C ^ 0x2F ^ (0x73 ^ 0x23)) & (98 + 8 - -79 + 11 ^ 130 + 95 - 213 + 155 ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIllllIIIlII[1];
            }
    ...
    static {
        ...
        br = string -> {
            ...
            if (N.lllIllIllIlIll(string) && (!N.lllIllIllIllII(string.equals(lIllllIIIIll[lIllllIIIlII[0]]) ? 1 : 0) || !N.lllIllIllIllII(string.equals(lIllllIIIIll[lIllllIIIlII[3]]) ? 1 : 0) || N.lllIllIllIlIIl(string.equals(lIllllIIIIll[lIllllIIIlII[4]]) ? 1 : 0))) {
                ...
                "".length();
                if (-"  ".length() >= 0) {
                    return ((7 ^ 0x53 ^ (0xBB ^ 0xAF)) & (67 + 204 - 268 + 230 ^ 14 + 40 - -87 + 28 ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIllllIIIlII[1];
            }
    ...
    private static void lllIllIllIIllI() {
        ...
        N.lIllllIIIlII[0] = " ".length();
        N.lIllllIIIlII[1] = (0x49 ^ 0x14 ^ (0x6E ^ 0x17)) & (101 + 9 - 29 + 54 ^ 41 + 153 - 32 + 1 ^ -" ".length());
        N.lIllllIIIlII[2] = -" ".length();
        N.lIllllIIIlII[3] = "  ".length();
        N.lIllllIIIlII[4] = "   ".length();
    ...
    private static void lllIllIllIIlIl() {
        ...
        N.lIllllIIIIll[N.lIllllIIIlII[1]] = N.lllIllIllIIIlI("MNTNBQ/09jM=", "vVGNM");
        N.lIllllIIIIll[N.lIllllIIIlII[0]] = N.lllIllIllIIIll("uRRcdLVcn+4=", "qrKLf");
        N.lIllllIIIIll[N.lIllllIIIlII[3]] = N.lllIllIllIIlII("OhwXGw==", "jutpb");
        N.lIllllIIIIll[N.lIllllIIIlII[4]] = N.lllIllIllIIIlI("kjAQpFeCY/S3gurMiH3gtA==", "nDRXn");
    }
