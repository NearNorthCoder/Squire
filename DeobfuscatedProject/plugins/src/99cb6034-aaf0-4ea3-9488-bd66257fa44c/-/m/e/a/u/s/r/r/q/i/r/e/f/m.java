...
extends Enum<m> {
    ...
    private static void llllIIllIlIIIl() {
        ...
        m.llIIIIllIlll[1] = " ".length();
        m.llIIIIllIlll[2] = "  ".length();
        m.llIIIIllIlll[3] = "   ".length();
        m.llIIIIllIlll[4] = 0x84 ^ 0x8C;
    }

    private static void llllIIllIIllII() {
        llIIIIllIlII = new String[llIIIIllIlll[3]];
        m.llIIIIllIlII[m.llIIIIllIlll[0]] = m.llllIIllIIlIIl("sOcOJMg04PA=", "RJROF");
        m.llIIIIllIlII[m.llIIIIllIlll[1]] = m.llllIIllIIlIlI("DGtxP68DgDY=", "TeiWG");
        m.llIIIIllIlII[m.llIIIIllIlll[2]] = m.llllIIllIIlIll("ITs=", "nuGOd");
    }
