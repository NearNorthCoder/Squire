...
public class j {
    ...
    private static void llllIIlIIllIIl() {
        ...
        j.llIIIIlIlIIl[j.llIIIIlIlIlI[0]] = j.llllIIlIIlIllI("aH8+6a8qE0qBUdECGzYo8A==", "kNfCn");
        j.llIIIIlIlIIl[j.llIIIIlIlIlI[1]] = j.llllIIlIIlIlll("bZmJNPy9PSs=", "XlAoB");
        j.llIIIIlIlIIl[j.llIIIIlIlIlI[2]] = j.llllIIlIIlIlll("I83xGzoVH0OZOOxThFFNSQ==", "sNanH");
        j.llIIIIlIlIIl[j.llIIIIlIlIlI[4]] = j.llllIIlIIlIlll("nnBb0o2aEn/DM1181d1ukFNs91NBp7B2", "KXKNt");
        j.llIIIIlIlIIl[j.llIIIIlIlIlI[5]] = j.llllIIlIIllIII("KwkHJ1oQDwAxWhoJByYfAUYTJx9SFBc0HgtGBjpaEANSMRMBCxM7Dh4DFns=", "rfrUz");
        j.llIIIIlIlIIl[j.llIIIIlIlIlI[6]] = j.llllIIlIIllIII("Eg8uPS0UByAzMAgB", "ffCXY");
        j.llIIIIlIlIIl[j.llIIIIlIlIlI[7]] = j.llllIIlIIlIllI("kY38mu9TxVTt/g5hm6eL6A==", "ltSVX");
        j.llIIIIlIlIIl[j.llIIIIlIlIlI[8]] = j.llllIIlIIlIlll("JgvskoXpA+U=", "YjpSl");
    }
    ...
    public TileObject a(E e2) {
        return TileObjects.getFirstAt((WorldPoint)e2.az(), tileObject -> {
            ...
            if (j.llllIIlIIlllII(tileObject.getName()) && (!j.llllIIlIlIIIlI(tileObject.getName().toLowerCase().contains(llIIIIlIlIIl[llIIIIlIlIlI[7]]) ? 1 : 0) || j.llllIIlIIllllI(tileObject.getName().equals(llIIIIlIlIIl[llIIIIlIlIlI[8]]) ? 1 : 0))) {
                n2 = llIIIIlIlIlI[1];
                "".length();
                if (((0x27 ^ 0x4F ^ (7 ^ 0x39)) & (8 ^ 0x31 ^ (0x55 ^ 0x3A) ^ -" ".length())) != 0) {
                    return ((73 + 89 - 84 + 121 ^ 110 + 25 - -17 + 5) & (210 + 134 - 254 + 127 ^ 12 + 33 - 6 + 92 ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIIIIlIlIlI[0];
            }
    ...
    private static void llllIIlIIllIlI() {
        ...
        j.llIIIIlIlIlI[0] = (62 + 103 - 17 + 64 ^ 69 + 81 - 99 + 85) & (0xBB ^ 0x87 ^ (0xE1 ^ 0x81) ^ -" ".length());
        j.llIIIIlIlIlI[1] = " ".length();
        j.llIIIIlIlIlI[2] = "  ".length();
        j.llIIIIlIlIlI[3] = -" ".length();
        j.llIIIIlIlIlI[4] = "   ".length();
            ...
            Stream.of(E.values()).filter(e2 -> {
                ...
                if (!j.llllIIlIlIIIlI(this.c((E)((Object)e2)) ? 1 : 0) || j.llllIIlIIlllll((Object)this.b((E)((Object)e2)), (Object)F.SEEDED)) {
                    ...
                    if (-(0x17 ^ 0x21 ^ (0x63 ^ 0x51)) > 0) {
                        return ((0x3B ^ 0x59 ^ (0xBE ^ 0x9B)) & (27 + 66 - 45 + 83 ^ 143 + 18 - -6 + 29 ^ -" ".length())) != 0;
                    }
                } else {
                    bl = llIIIIlIlIlI[0];
                }
