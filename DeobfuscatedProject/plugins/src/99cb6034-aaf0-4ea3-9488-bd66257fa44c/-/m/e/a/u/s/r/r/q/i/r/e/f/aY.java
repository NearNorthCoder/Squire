...
extends aX {
        ...
        if (aY.lllIllllIIIIlI(lllllllllllllllIlIllIIIlllIIllll.distanceTo((Locatable)lllllllllllllllIlIllIIIlllIlIIIl.cO), lIllllIlllll[6])) {
            ...
            if (aY.lllIllllIIIlIl((Object)lllllllllllllllIlIllIIIlllIIllII, (Object)P.ALLOTMENT)) {
                ...
                if (-(12 + 112 - 44 + 62 ^ 18 + 93 - 63 + 90) > 0) {
                    return ((0xAA ^ 0x86 ^ (0x8F ^ 0xC2)) & (203 + 51 - 156 + 123 ^ 152 + 49 - 29 + 16 ^ -" ".length())) != 0;
                }
            } else {
                n3 = lIllllIlllll[6];
            }
    ...
    private static void lllIlllIlllIll() {
        ...
        aY.lIllllIlIlII[aY.lIllllIlllll[1]] = aY.lllIlllIlIIIIl("Ul9gw/5nx0U=", "igwvm");
        aY.lIllllIlIlII[aY.lIllllIlllll[3]] = aY.lllIlllIlIIIIl("DOVd6aX8qxs=", "CiFcR");
    }
    ...
    private static void lllIlllIllllIl() {
        ...
        aY.lIllllIlllll[0] = -" ".length();
        aY.lIllllIlllll[1] = (112 + 18 - 86 + 143 ^ 99 + 104 - 181 + 137) & (0xF7 ^ 0xC0 ^ (0x76 ^ 0x65) ^ -" ".length());
        aY.lIllllIlllll[2] = -" ".length() & (0xFFFFFFFF & Integer.MAX_VALUE);
        aY.lIllllIlllll[3] = " ".length();
        aY.lIllllIlllll[4] = -(0xFFFFB30F & 0x6EFD) & (0xFFFFBFFF & 0x7EFD);
        aY.lIllllIlllll[5] = -(0xFFFFF4AD & 0x7B53) & (0xFFFFF787 & 0x7FFD);
        aY.lIllllIlllll[6] = "   ".length();
