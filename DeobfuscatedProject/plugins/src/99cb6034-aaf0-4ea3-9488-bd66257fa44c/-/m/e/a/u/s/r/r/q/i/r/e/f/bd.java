...
extends az {
    ...
    private static void lllIlIllIlIlIl() {
        ...
        bd.lIlllIIlIIIl[bd.lIlllIIlIIll[1]] = bd.lllIlIllIIlIlI("Cxg1NT0=", "HtPTS");
        bd.lIlllIIlIIIl[bd.lIlllIIlIIll[2]] = bd.lllIlIllIIlIll("3uLEqFZ6y5g=", "vZixi");
        bd.lIlllIIlIIIl[bd.lIlllIIlIIll[3]] = bd.lllIlIllIIlIlI("OwANIwo=", "xlhBd");
    }
    ...
    public static boolean a(Predicate<Item> predicate) {
        ...
        while (bd.lllIlIllIlIlll(lllllllllllllllIlIllIlllIlllIIIl.hasNext() ? 1 : 0)) {
            ...
            return ((0x2D ^ 0x1B ^ (0xDA ^ 0xAF)) & (0x2A ^ 0x31 ^ (0x5A ^ 2) ^ -" ".length())) != 0;
        }
        if (bd.lllIlIllIllIIl((int)lllllllllllllllIlIllIlllIlllIIlI, lIlllIIlIIll[0])) {
            bl = lIlllIIlIIll[2];
            "".length();
            if ("   ".length() >= (0x8E ^ 0x9D ^ (0x61 ^ 0x76))) {
                return ((0xC4 ^ 0x8C ^ (0x94 ^ 0x87)) & (55 + 99 - 81 + 138 ^ 131 + 29 - 121 + 97 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlllIIlIIll[1];
        }
    ...
    private static void lllIlIllIlIllI() {
        ...
        bd.lIlllIIlIIll[1] = (106 + 146 - 206 + 192 ^ 118 + 4 - 42 + 80) & (66 + 79 - -91 + 8 ^ 59 + 169 - 135 + 93 ^ -" ".length());
        bd.lIlllIIlIIll[2] = " ".length();
        bd.lIlllIIlIIll[3] = "  ".length();
        bd.lIlllIIlIIll[4] = "   ".length();
    }
