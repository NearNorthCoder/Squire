...
extends Task {
    ...
    private boolean bt() {
        ...
        while (aE.lllIlIllllIIII(lllllllllllllllIlIllIlllIIIIllII, (int)lllllllllllllllIlIllIlllIIIIllIl)) {
            ...
            return ((160 + 118 - 153 + 75 ^ 39 + 150 - 109 + 72) & (0x66 ^ 0x79 ^ (1 ^ 0x4E) ^ -" ".length())) != 0;
        }
        ...
        if (aE.lllIlIlllIlIll(lllllllllllllllIlIllIlllIIIlIlIl.cn.N())) {
            ...
            if (aE.lllIlIlllIlllI(Inventory.getCount((int[])nArray), lIlllIIllIIl[1]) && aE.lllIlIlllIllll(Inventory.contains(item -> Stream.of(G.values()).anyMatch(g2 -> {
                ...
                if (aE.lllIlIllllIIlI(g2.aA(), item.getId())) {
                    bl = lIlllIIllIIl[3];
                    "".length();
                    if (((19 + 40 - -109 + 15 ^ 108 + 95 - 45 + 20) & (0x30 ^ 0x47 ^ (0x1D ^ 0x6F) ^ -" ".length())) > "  ".length()) {
                        return ((0xE ^ 0x5B ^ (0x74 ^ 0x40)) & (0xBD ^ 0xAC ^ (2 ^ 0x72) ^ -" ".length())) != 0;
                    }
                } else {
                    bl = lIlllIIllIIl[0];
                }
        ...
        if (aE.lllIlIlllIllll(Bank.isOpen() ? 1 : 0)) {
            ...
            if (aE.lllIlIlllIlIll(Inventory.contains(item -> Stream.of(G.values()).anyMatch(g2 -> {
                ...
                if (aE.lllIlIllllIIlI(g2.aA(), item.getId())) {
                    bl = lIlllIIllIIl[3];
                    "".length();
                    if (((0x5D ^ 0x42 ^ (0x46 ^ 0x5D)) & (117 + 48 - 107 + 70 ^ 118 + 7 - 43 + 50 ^ -" ".length())) < 0) {
                        return ((59 + 88 - 102 + 127 ^ 10 + 42 - -41 + 63) & (0x31 ^ 0x74 ^ (0xDB ^ 0xAE) ^ -" ".length())) != 0;
                    }
                } else {
                    bl = lIlllIIllIIl[0];
                }
                ...
                Bank.withdrawAll(item -> Stream.of(G.values()).anyMatch(g2 -> {
                    ...
                    if (aE.lllIlIllllIIlI(g2.aA(), item.getId())) {
                        ...
                        "".length();
                        if (null != null) {
                            return ((11 + 56 - -52 + 90 ^ 54 + 130 - 121 + 68) & (0x87 ^ 0xB8 ^ (0x47 ^ 0x2A) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIlllIIllIIl[0];
                    }
            ...
            if (aE.lllIlIlllIlIll(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (aE.lllIlIlllIlIll(Inventory.contains((int[])nArray2) ? 1 : 0)) {
                    ...
                    "".length();
                    if ("  ".length() != "  ".length()) {
                        return ((0x61 ^ 0x6D ^ (0x6B ^ 0x5E)) & (0x29 ^ 0x4E ^ (0x5B ^ 5) ^ -" ".length())) != 0;
                    }
                } else {
    ...
    private static String lllIlIllIllIll(String lllllllllllllllIlIllIllIllIllIlI, String lllllllllllllllIlIllIllIllIllllI) {
        ...
        while (aE.lllIlIllllIIII(lllllllllllllllIlIllIllIllIlIIll, lllllllllllllllIlIllIllIllIlIlII)) {
            ...
            "".length();
            if ("   ".length() != (131 + 123 - 174 + 54 ^ 27 + 49 - 16 + 70)) continue;
            return null;
        }
    ...
    private static void lllIlIllIllllI() {
        ...
        aE.lIlllIIlIlII[aE.lIlllIIllIIl[0]] = aE.lllIlIllIllIll("GxoEHnQ3FgUO", "YsvzT");
        aE.lIlllIIlIlII[aE.lIlllIIllIIl[3]] = aE.lllIlIllIlllII("heup4cx3+yw=", "iEjOs");
        aE.lIlllIIlIlII[aE.lIlllIIllIIl[1]] = aE.lllIlIllIlllIl("GluJBYMg5mII16Oye9PxPQ==", "sVbni");
    }
