...
extends Task {
    ...
    public boolean run() {
        aB lllllllllllllllIlIllIlllllllIIlI;
        if (aB.lllIlIllIIIlII(Game.getState(), GameState.LOGGED_IN)) {
            return lIlllIIIllII[1];
        }
        if (aB.lllIlIllIIIlIl(Movement.isRunEnabled() ? 1 : 0) && aB.lllIlIllIIIllI(Movement.getRunEnergy(), lllllllllllllllIlIllIlllllllIIlI.cc)) {
            Movement.toggleRun();
            lllllllllllllllIlIllIlllllllIIlI.cc = Rand.nextInt((int)lIlllIIIllII[2], (int)lIlllIIIllII[3]);
        }
        return lIlllIIIllII[1];
    }
    ...
    private static void lllIlIllIIIIll() {
        ...
        aB.lIlllIIIllII[1] = (90 + 124 - 207 + 146 ^ 140 + 10 - 108 + 153) & (0x4D ^ 6 ^ (0x80 ^ 0x91) ^ -" ".length());
