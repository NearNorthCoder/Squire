...
extends aX {
    ...
    public boolean J(N n2) {
        void lllllllllllllllIlIllIlIlllllllII;
        Item item = this.bR.h(n2);
        if (ba.lllIllIIIlIIIl(item)) {
            return lIlllIlIIlII[0];
        }
        if (ba.lllIllIIIlIIlI((Object)lllllllllllllllIlIllIlIlllllllII.aL(), (Object)P.GRAPES) && ba.lllIllIIIlIIll(Vars.getBit((int)lllllllllllllllIlIllIlIlllllllII.aO()))) {
            ba lllllllllllllllIlIllIlIlllllllIl;
            int[] nArray = new int[lIlllIlIIlII[1]];
            nArray[ba.lIlllIlIIlII[0]] = lIlllIlIIlII[2];
            Item lllllllllllllllIlIllIlIllllllIlI = Inventory.getFirst((int[])nArray);
            if (ba.lllIllIIIlIIIl(lllllllllllllllIlIllIlIllllllIlI)) {
                return lIlllIlIIlII[0];
            }
            Item item2 = lllllllllllllllIlIllIlIllllllIlI;
            Objects.requireNonNull(item2);
            "".length();
            lllllllllllllllIlIllIlIlllllllIl.a((N)lllllllllllllllIlIllIlIlllllllII, arg_0 -> ((Item)item2).useOn(arg_0));
            "".length();
    ...
    private static void lllIllIIIlIIII() {
        ...
        ba.lIlllIlIIlII[0] = (0x5E ^ 0x29 ^ (0x40 ^ 0x6A)) & (64 + 33 - 62 + 166 ^ 128 + 34 - 73 + 59 ^ -" ".length());
        ba.lIlllIlIIlII[1] = " ".length();
