...
extends Enum<E> {
    ...
    private static void llllIlIllIIlII() {
        ...
        E.llIIIlIlllll[0] = (0x1B ^ 0x77 ^ (0x2E ^ 0x6A)) & (0x16 ^ 0x29 ^ (0x60 ^ 0x77) ^ -" ".length());
        E.llIIIlIlllll[1] = " ".length();
        ...
        E.llIIIlIlllll[5] = "  ".length();
        E.llIIIlIlllll[6] = "   ".length();
    ...
    private static void llllIlIllIIIll() {
        ...
        E.llIIIlIllllI[E.llIIIlIlllll[0]] = E.llllIlIllIIIII("ACwREQQaNh4aGRkh", "MiPUK");
        E.llIIIlIllllI[E.llIIIlIlllll[1]] = E.llllIlIllIIIII("DCURIyQuPw9rGyQxBiQhYXgsJCQ1OEs=", "APbKV");
        E.llIIIlIllllI[E.llIIIlIlllll[5]] = E.llllIlIllIIIII("BwEzLwodGyEkEB4M", "JDrkE");
        E.llIIIlIllllI[E.llIIIlIlllll[6]] = E.llllIlIllIIIII("KwQlOT0JHjtxAgMQMj44RlkFPjoSGX8=", "fqVQO");
        E.llIIIlIllllI[E.llIIIlIlllll[10]] = E.llllIlIllIIIIl("y2CU7VmSYCrSavdzyuz8lw==", "gOcPy");
        E.llIIIlIllllI[E.llIIIlIlllll[11]] = E.llllIlIllIIIIl("c+UYGqBVn79N8lqFitCkERoZHSWBxLYDrJwqM7V+t84=", "OluuG");
        E.llIIIlIllllI[E.llIIIlIlllll[15]] = E.llllIlIllIIIIl("iYQEzAImBFlDVoRUMYHWuQ==", "neLUL");
        E.llIIIlIllllI[E.llIIIlIlllll[16]] = E.llllIlIllIIIlI("V6ULSo0MDjBHM/0vwL9ntlMb8SKs4MoteHMbYhDWUgY=", "bBLho");
    }
}
