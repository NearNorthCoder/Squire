...
extends az {
    ...
    private static void lllIlllIlIlllI() {
        ...
        bf.lIllllIllIIl[0] = (15 + 110 - 47 + 70 ^ 140 + 160 - 187 + 56) & (0x78 ^ 8 ^ (0x43 ^ 0xE) ^ -" ".length());
        bf.lIllllIllIIl[1] = " ".length();
        bf.lIllllIllIIl[2] = 0x52 ^ 1 ^ (0xE7 ^ 0xBC);
        bf.lIllllIllIIl[3] = "  ".length();
    }

    private static void lllIlllIlIllIl() {
        lIllllIllIII = new String[lIllllIllIIl[1]];
        bf.lIllllIllIII[bf.lIllllIllIIl[0]] = bf.lllIlllIlIllII("RQSPFhUUGko=", "eowAb");
    }
