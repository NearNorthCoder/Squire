...
extends P {
    ...
    private static void lllIllIIIIlIll() {
        ...
        aa.lIlllIlIIIlI[0] = " ".length();
        aa.lIlllIlIIIlI[1] = "   ".length();
        aa.lIlllIlIIIlI[2] = "  ".length();
    ...
    @Override
    public an f(int n2) {
        void lllllllllllllllIlIllIllIIIIlIIII;
        if (aa.lllIllIIIIllII(n2) && aa.lllIllIIIIllIl(n2, lIlllIlIIIlI[0])) {
            return new an(au.WEEDS, n.GROWING, lIlllIlIIIlI[1]);
        }
        if (aa.lllIllIIIIlllI((int)lllllllllllllllIlIllIllIIIIlIIII, lIlllIlIIIlI[2]) && aa.lllIllIIIIllIl((int)lllllllllllllllIlIllIllIIIIlIIII, lIlllIlIIIlI[3])) {
            return new an(au.GRAPE, n.GROWING, (int)(lllllllllllllllIlIllIllIIIIlIIII - lIlllIlIIIlI[2]));
        }
        if (aa.lllIllIIIIllll((int)lllllllllllllllIlIllIllIIIIlIIII, lIlllIlIIIlI[4])) {
            return new an(au.GRAPE, n.GROWING, lIlllIlIIIlI[5]);
        }
        if (aa.lllIllIIIIlllI((int)lllllllllllllllIlIllIllIIIIlIIII, lIlllIlIIIlI[6]) && aa.lllIllIIIIllIl((int)lllllllllllllllIlIllIllIIIIlIIII, lIlllIlIIIlI[7])) {
            return new an(au.GRAPE, n.HARVESTABLE, (int)(lllllllllllllllIlIllIllIIIIlIIII - lIlllIlIIIlI[6]));
        }
        return null;
    }
