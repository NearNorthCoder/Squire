...
public class f {
        ...
        while (f.llllIlIlIIIIIl(lllllllllllllllIlIlIIlllIlIllIll, lllllllllllllllIlIlIIlllIlIlllII)) {
            ...
            if (f.llllIlIlIIIIll(lllllllllllllllIlIlIIlllIlIlllll.b(lllllllllllllllIlIlIIlllIlIllIlI) ? 1 : 0)) {
                ...
                while (f.llllIlIlIIIIIl(lllllllllllllllIlIlIIlllIlIlIlIl, lllllllllllllllIlIlIIlllIlIlIllI)) {
                    ...
                    "".length();
                    if ("  ".length() <= (0x83 ^ 0x91 ^ (0x7D ^ 0x6B))) continue;
                    return null;
                }
            }
                        ...
                        block25: {
                            ...
                            block26: {
                                block22: {
                                    block24: {
                                        ...
                                        block19: {
                                            ...
                                            "".length();
                                            if (" ".length() < 0) {
                                                return ((4 ^ 0x4F ^ (0x3F ^ 0x48)) & (0x7C ^ 0x15 ^ (0x57 ^ 2) ^ -" ".length())) != 0;
                                            }
                                            break block20;
                                        }
                                    ...
                                    "".length();
                                    if (" ".length() < 0) {
                                        return ((86 + 28 - -35 + 14 ^ 145 + 147 - 268 + 169) & (0xB5 ^ 0xAE ^ (0xF4 ^ 0x8D) ^ -" ".length())) != 0;
                                    }
                                    break block21;
                                }
                                ...
                                if (((30 + 16 - -7 + 76 ^ 74 + 128 - 191 + 136) & (122 + 16 - 122 + 155 ^ 60 + 162 - 217 + 180 ^ -" ".length())) != 0) {
                                    return ((0x8E ^ 0xAC ^ (0xAA ^ 0xB9)) & (159 + 84 - 83 + 20 ^ 55 + 113 - 155 + 120 ^ -" ".length())) != 0;
                                }
                                break block20;
                            }
                            ...
                            "".length();
                            if (-" ".length() >= 0) {
                                return ((14 + 155 - 167 + 213 ^ 33 + 49 - 77 + 192) & (0x1D ^ 0x14 ^ (1 ^ 0x1A) ^ -" ".length())) != 0;
                            }
                            break block21;
                        }
    ...
    private static void llllIlIIllllII() {
        ...
        f.llIIIlIlIllI[33] = 0xA9 ^ 0x96 ^ "   ".length();
    ...
    public boolean c(q q2) {
        ...
        while (f.llllIlIlIIIIIl(lllllllllllllllIlIlIIlllIllIlllI, lllllllllllllllIlIlIIlllIllIllll)) {
            ...
            "".length();
            if (((58 + 86 - 74 + 60 ^ 136 + 29 - 116 + 118) & (24 + 72 - 11 + 96 ^ 45 + 101 - 101 + 99 ^ -" ".length())) != (0x5A ^ 0x16 ^ (0x88 ^ 0xC0))) continue;
            return ((0xF5 ^ 0xAD ^ (0xF ^ 0x1C)) & (0x8E ^ 0xBF ^ (0xF5 ^ 0x8F) ^ -" ".length())) != 0;
        }
        return llIIIlIlIllI[0];
    }
    ...
    public boolean f(N n2) {
        ...
        if (f.llllIlIIllllll((Object)this.ae.b(n2))) {
            ...
            if ((0x8A ^ 0x81 ^ (0xB2 ^ 0xBD)) <= 0) {
                return ((0xFD ^ 0xA4 ^ (0x3A ^ 0x3C)) & (171 + 24 - 41 + 38 ^ 125 + 0 - 118 + 152 ^ -" ".length())) != 0;
            }
        } else {
            bl = llIIIlIlIllI[1];
        }
    ...
    private static void llllIlIIlllIII() {
        ...
        f.llIIIlIIIlII[f.llIIIlIlIllI[1]] = f.llllIIllllllIl("2RvZnvVYxlQ=", "eWjod");
        f.llIIIlIIIlII[f.llIIIlIlIllI[0]] = f.llllIIllllllIl("/mLr+eQtfIW11ACZftmnew==", "JztGx");
        f.llIIIlIIIlII[f.llIIIlIlIllI[4]] = f.llllIIlllllllI("Gyq0V4uJBAaeB5od+fZ4xQ==", "hZMYi");
        f.llIIIlIIIlII[f.llIIIlIlIllI[5]] = f.llllIIllllllIl("RUqALWQ4TCClMnztSfcC6w==", "mFaej");
        f.llIIIlIIIlII[f.llIIIlIlIllI[6]] = f.llllIIllllllll("IgsFJDIkAwsqLzgF", "VbhAF");
        f.llIIIlIIIlII[f.llIIIlIlIllI[7]] = f.llllIIllllllIl("LJXIhOPhTYIUxRGTjpODSA==", "ofvKo");
        f.llIIIlIIIlII[f.llIIIlIlIllI[8]] = f.llllIIllllllIl("vUJJMcdedEI3uCH+tob9lZI6A0/OxizhbCPogdfAeSieuC9JPofOaw==", "QsCHn");
        f.llIIIlIIIlII[f.llIIIlIlIllI[9]] = f.llllIIllllllll("PioKMCA4IgQ+PSQk", "JCgUT");
        f.llIIIlIIIlII[f.llIIIlIlIllI[10]] = f.llllIIllllllIl("GMo7n4M5UsY=", "bPBWW");
        f.llIIIlIIIlII[f.llIIIlIlIllI[11]] = f.llllIIllllllll("NyI1HD0xKjsSIC0s", "CKXyI");
        f.llIIIlIIIlII[f.llIIIlIlIllI[12]] = f.llllIIllllllIl("DTZhkRa22nGs3MOL2WDhK+6p8rb2HSah", "VIgZd");
        f.llIIIlIIIlII[f.llIIIlIlIllI[13]] = f.llllIIlllllllI("P+jaN/ZM3do8vXiMpYRBPQ==", "UHbYr");
        f.llIIIlIIIlII[f.llIIIlIlIllI[14]] = f.llllIIlllllllI("JfJ0LTXzoKtRO3kXKvdRkA==", "cMkSl");
        f.llIIIlIIIlII[f.llIIIlIlIllI[15]] = f.llllIIllllllll("ARcnLzg4EDBqKyBVMTIrLQF0LTghAiAiajocNyFkbjoyLDkrAXQjOXRVLzdqKAc7J2ovVS83aiMcOj8+K1UgIykl", "NuTJJ");
        f.llIIIlIIIlII[f.llIIIlIlIllI[16]] = f.llllIIllllllll("FSMEBQMuZQcEFDU3Q1YpODYHBBA/IUIYAy1lDRAAKSAWVgk8ZRkLSno1EBMQMyoXBUY1JxETFCwgBlYJPCMRExJ6MgMFRiE4Ql4dJ2xCJgo7PAcERhYqAUwdJw==", "ZEbvf");
        f.llIIIlIIIlII[f.llIIIlIlIllI[17]] = f.llllIIllllllll("EyInNgd1LHI0DDsqNypDMj89Lxc9bSYxAD5tKSVPdT4zLgo7KnI2BiJtPT4FJigm", "UMRXc");
        f.llIIIlIIIlII[f.llIIIlIlIllI[18]] = f.llllIIlllllllI("8cLrhOakn5mqEuvMA/CYog==", "gqydR");
        f.llIIIlIIIlII[f.llIIIlIlIllI[19]] = f.llllIIllllllIl("i4PDL27GGjHywD1iWl8s8QFTnJMhGAJF", "jAKTl");
        f.llIIIlIIIlII[f.llIIIlIlIllI[20]] = f.llllIIllllllIl("56CqL3lbeH/JDSTMqDV9Sw==", "HqPOP");
        f.llIIIlIIIlII[f.llIIIlIlIllI[21]] = f.llllIIlllllllI("vjGVXhsNXOzhvL3abzoANA==", "yjTyD");
        f.llIIIlIIIlII[f.llIIIlIlIllI[22]] = f.llllIIlllllllI("8aUCTt3lgbCeIiBbAyMoTMXfsOrfhhW0FPgRmMFTDdbrHlEeswM2GntdPITALVHZy/V+GIMt/6tHYg37EN0Xh+7iWGCa4dHiLGweCx88uix7zT5zskeuRw==", "wqTYH");
        f.llIIIlIIIlII[f.llIIIlIlIllI[23]] = f.llllIIllllllll("BDwJFB4CNAcaAx4y", "pUdqj");
        f.llIIIlIIIlII[f.llIIIlIlIllI[24]] = f.llllIIllllllIl("5iG2rX4/BZ/azvafA2wH8CImfn+ScRtXLytd4MmhRkGyI4QDhKYaXZhYS7rASbrK", "NBauZ");
        f.llIIIlIIIlII[f.llIIIlIlIllI[25]] = f.llllIIlllllllI("apIm7IlzE6fbegA3z170FaPL4tPzuTBl0H0cX7Lqf9k=", "cSHhG");
        f.llIIIlIIIlII[f.llIIIlIlIllI[26]] = f.llllIIlllllllI("dqaQMSJfmd26vkASDbGJhlNjh5Qzbk3L", "jZRdk");
        f.llIIIlIIIlII[f.llIIIlIlIllI[27]] = f.llllIIllllllll("DSUfBhwLLREIARcr", "yLrch");
        f.llIIIlIIIlII[f.llIIIlIlIllI[28]] = f.llllIIllllllll("EBM5Bi0UAyk=", "qfMiZ");
        f.llIIIlIIIlII[f.llIIIlIlIllI[29]] = f.llllIIlllllllI("CISAXS3ExvpQ6x358OKdmQ==", "qfOWZ");
        f.llIIIlIIIlII[f.llIIIlIlIllI[30]] = f.llllIIlllllllI("pTyltQxvRLpLtqXajD5Nsg==", "FgtCd");
        f.llIIIlIIIlII[f.llIIIlIlIllI[31]] = f.llllIIlllllllI("5T2988+VzAHm4/lEsZKKAg==", "jZTqO");
        f.llIIIlIIIlII[f.llIIIlIlIllI[32]] = f.llllIIllllllIl("U6kmXH9FtRk=", "mjblX");
        f.llIIIlIIIlII[f.llIIIlIlIllI[34]] = f.llllIIlllllllI("ObuBf3DIZSEeEHZe/3r8qA==", "plaYR");
        f.llIIIlIIIlII[f.llIIIlIlIllI[35]] = f.llllIIllllllll("KTUWPxAmNw8dIiknASYUPTEHOzcmOwo=", "OTdRD");
        f.llIIIlIIIlII[f.llIIIlIlIllI[36]] = f.llllIIlllllllI("Ht17W0oknnkW274GkRke4A==", "LqtND");
        f.llIIIlIIIlII[f.llIIIlIlIllI[37]] = f.llllIIlllllllI("t9QP2KSGuE3J+q3WEMCbWQ==", "MDRUB");
        f.llIIIlIIIlII[f.llIIIlIlIllI[39]] = f.llllIIlllllllI("qooLchB1k0nxJ36ITlJfNQ==", "DmvvK");
        f.llIIIlIIIlII[f.llIIIlIlIllI[40]] = f.llllIIllllllIl("iMtG1opVRSA=", "dZOeD");
        f.llIIIlIIIlII[f.llIIIlIlIllI[41]] = f.llllIIllllllIl("rcl09zcLqUc=", "BAevH");
        f.llIIIlIIIlII[f.llIIIlIlIllI[42]] = f.llllIIllllllIl("auy2LQk0xaY=", "AoqUT");
        f.llIIIlIIIlII[f.llIIIlIlIllI[43]] = f.llllIIlllllllI("MitJzbc77pk=", "VkgPN");
        f.llIIIlIIIlII[f.llIIIlIlIllI[38]] = f.llllIIllllllll("HQQFNT4=", "NkpAV");
        f.llIIIlIIIlII[f.llIIIlIlIllI[44]] = f.llllIIllllllll("Pws4JCc=", "qdJPO");
        f.llIIIlIIIlII[f.llIIIlIlIllI[45]] = f.llllIIllllllIl("xaTH0Et+a/c=", "OJAjR");
        f.llIIIlIIIlII[f.llIIIlIlIllI[46]] = f.llllIIllllllll("OAwEIBw=", "kcqTt");
        f.llIIIlIIIlII[f.llIIIlIlIllI[47]] = f.llllIIllllllIl("JQJAwFAWaH8875AksC2aEQBpdB+hDYNRbidf3oaaT4kE3osD+cxtpiWN1cwNHXzF1O2QD31LwcwwOwhdHRgJkg==", "mrqHc");
        f.llIIIlIIIlII[f.llIIIlIlIllI[48]] = f.llllIIllllllIl("HV+WzxM5bPtXsH/9LLJ5BIzYB7aLwq1DBlNZMgKii5u1tu++HMRyDE3KpnU35OGbmMhQJTr/LdddWtSc2G0d5IBeTv1XHn7e", "bQIPH");
        f.llIIIlIIIlII[f.llIIIlIlIllI[49]] = f.llllIIllllllll("FQQgI0pvR2k4CzJMKDwYJA0tKUojCSw+SmkYOzULNQktLAwkHj05BigfLDRDYRsgJAJhRHZsCS4BOT8ZNTgwIA9/GSUkGCAQOiUaJB41eQkuATk/GTVEdmpKbEw9OA9hHzk1Bi1MKjEEZhhpPQsqCWk5HmENJylKLAM7NUonCTskAy0JYG82bw==", "AlIPj");
        f.llIIIlIIIlII[f.llIIIlIlIllI[50]] = f.llllIIllllllll("PC47CkQBNXIYCldmfFI4RmYGEQFINT0QCEguMwpECiM3F0QcNDcYEA0icg4NHC5yUVtUJT0UFAc1Ji0dGCNsDAgcNDMFFx02NwsYQSU9FBQHNSYlSkZs", "hFRyd");
    }
    ...
    private boolean d(N n2) {
        ...
        if (f.llllIlIlIIIIll(n2.aL().aR() ? 1 : 0) && f.llllIlIIllllIl((Object)an2.aY(), (Object)au.WEEDS) && f.llllIlIlIIIIll(an2.bb())) {
            n3 = llIIIlIlIllI[0];
            "".length();
            if (((0x56 ^ 0x62 ^ (0x47 ^ 0x5B)) & (0x33 ^ 0x1F ^ (0x45 ^ 0x41) ^ -" ".length())) >= "   ".length()) {
                return ((0x82 ^ 0xB5 ^ (0xEC ^ 0xBA)) & (0x28 ^ 0x45 ^ (0x14 ^ 0x18) ^ -" ".length())) != 0;
            }
        } else {
            n3 = llIIIlIlIllI[1];
        }
            ...
            if (f.llllIlIlIIIIll(lllllllllllllllIlIlIIllIIlIIIlIl.b((p)lllllllllllllllIlIlIIllIIIllllll) ? 1 : 0)) {
                ...
                while (f.llllIlIlIIIIIl(lllllllllllllllIlIlIIllIIIlllIlI, lllllllllllllllIlIlIIllIIIlllIll)) {
                    ...
                    if (f.llllIlIlIIIIll(lllllllllllllllIlIlIIllIIlIIIlIl.i(lllllllllllllllIlIlIIllIIIlllIIl) ? 1 : 0)) {
                        "".length();
                        if (((0x83 ^ 0xBC ^ (0x6E ^ 0x15)) & (97 + 63 - 77 + 142 ^ 10 + 43 - 16 + 128 ^ -" ".length())) <= -" ".length()) {
                            return null;
                        }
                    } else {
                    ...
                    "".length();
                    if (" ".length() >= ((0x9E ^ 0xB5 ^ (0x10 ^ 0x7A)) & (0x31 ^ 0x34 ^ (0xC7 ^ 0x83) ^ -" ".length()))) continue;
                    return null;
                }
            }
        ...
        while (f.llllIlIlIIIIII(lllllllllllllllIlIlIIllIIlIIIIlI.hasNext() ? 1 : 0)) {
            ...
            if (f.llllIlIlIIIIII(lllllllllllllllIlIlIIllIIlIIIlII.containsKey(lllllllllllllllIlIlIIllIIlIIIIIl2.getId()) ? 1 : 0)) {
                ...
                if (f.llllIlIlIIIlIl(lllllllllllllllIlIlIIllIIlIIIIII)) {
                    ...
                    "".length();
                    "".length();
                    if (((0x5A ^ 0xD) & ~(0xDC ^ 0x8B)) < "  ".length()) continue;
                    return null;
                }
    ...
    private boolean e(N n2) {
        ...
        if (f.llllIlIIllllIl((Object)lllllllllllllllIlIlIIlllIIlIIIll.aZ(), (Object)n.GROWING) && (!f.llllIlIlIIIlll((Object)lllllllllllllllIlIlIIlllIIlIIIll.aY(), (Object)au.GRAPE) || f.llllIlIlIIIIII(lllllllllllllllIlIlIIlllIIlIIllI.f((N)lllllllllllllllIlIlIIlllIIlIIlIl) ? 1 : 0)) && f.llllIlIlIIIlll((Object)lllllllllllllllIlIlIIlllIIlIIIll.aY(), (Object)au.WEEDS)) {
            n3 = llIIIlIlIllI[0];
            "".length();
            if (" ".length() <= ((0x25 ^ 0x1C ^ (0xD6 ^ 0xBC)) & (0x9C ^ 0xA6 ^ (1 ^ 0x68) ^ -" ".length()))) {
                return ((90 + 88 - 153 + 129 ^ 23 + 81 - 21 + 75) & (0xF1 ^ 0x97 ^ (0x6E ^ 0xC) ^ -" ".length())) != 0;
            }
        } else {
            n3 = llIIIlIlIllI[1];
        }
    ...
    private N z() {
        ...
        return Arrays.stream(q2.ae()).filter(n2 -> {
            ...
            if (!f.llllIlIIlllllI(this.h((N)n2)) || f.llllIlIlIIIIll(this.d((N)n2) ? 1 : 0)) {
                bl = llIIIlIlIllI[0];
                "".length();
                if (((91 + 200 - 245 + 162 ^ 119 + 30 - 25 + 35) & (7 ^ 0x63 ^ (0xC ^ 0x27) ^ -" ".length())) != 0) {
                    return ((0xBA ^ 0x86 ^ (0x6D ^ 0x60)) & (0xC7 ^ 0xAE ^ (0xDC ^ 0x84) ^ -" ".length())) != 0;
                }
            } else {
                bl = llIIIlIlIllI[1];
            }
    ...
    private Map<K, Integer> B() {
        ...
        int lllllllllllllllIlIlIIlllIIllIIlI = Arrays.stream(lllllllllllllllIlIlIIlllIIllIIll.ae()).filter(n2 -> {
            ...
            if (f.llllIlIIllllll(this.h((N)n2))) {
                ...
                "".length();
                if ("  ".length() < 0) {
                    return ((0xF0 ^ 0x98 ^ (0xEC ^ 0xA3)) & ((0x70 ^ 0x20) & ~(0x76 ^ 0x26) ^ (0x44 ^ 0x63) ^ -" ".length())) != 0;
                }
            } else {
                bl = llIIIlIlIllI[1];
            }
        ...
        if (f.llllIlIlIIIlll(lllllllllllllllIlIlIIlllIIlIlllI.an(), ar.NOTHING) && f.llllIlIlIIIIII(lllllllllllllllIlIlIIlllIIllIIIl.stream().anyMatch(n2 -> {
            ...
            if (f.llllIlIlIIIIII(this.i((N)n2) ? 1 : 0) && f.llllIlIIllllIl((Object)n2.aL(), (Object)P.FLOWER)) {
                ...
                "".length();
                if (" ".length() <= 0) {
                    return ((0xEA ^ 0xBA ^ (0x38 ^ 0x6E)) & (82 + 113 - 49 + 14 ^ 12 + 94 - 10 + 70 ^ -" ".length())) != 0;
                }
            } else {
                n3 = llIIIlIlIllI[1];
            }
            ...
            lllllllllllllllIlIlIIlllIIllIlII.compute(lllllllllllllllIlIlIIlllIIllIlIl.ab.compostTypeFlowers().aC(), (k2, n2) -> {
                ...
                if (f.llllIlIIlllllI(n2)) {
                    n3 = llIIIlIlIllI[0];
                    "".length();
                    if (((0x1C ^ 0x59 ^ (0x2C ^ 0x73)) & (0x4F ^ 0x29 ^ (0x68 ^ 0x14) ^ -" ".length())) != 0) {
                        return null;
                    }
                } else {
        ...
        if (f.llllIlIlIIIlll(lllllllllllllllIlIlIIlllIIlIlllI.ak(), at.NOTHING) && f.llllIlIlIIIIII(lllllllllllllllIlIlIIlllIIllIIIl.stream().anyMatch(n2 -> {
            ...
            if (f.llllIlIlIIIIII(this.i((N)n2) ? 1 : 0) && f.llllIlIIllllIl((Object)n2.aL(), (Object)P.HERB)) {
                n3 = llIIIlIlIllI[0];
                "".length();
                if (((0x1F ^ 0x5C ^ (0x81 ^ 0x8C)) & (0xE2 ^ 0xA6 ^ (0x7C ^ 0x76) ^ -" ".length())) != 0) {
                    return ((0x8D ^ 0x92 ^ (0x28 ^ 0x3F)) & (124 + 145 - 91 + 8 ^ 17 + 143 - 67 + 85 ^ -" ".length())) != 0;
                }
            } else {
                n3 = llIIIlIlIllI[1];
            }
        ...
        if (f.llllIlIlIIIlll(lllllllllllllllIlIlIIlllIIlIlllI.aq(), ax.NOTHING) && f.llllIlIlIIIIII(lllllllllllllllIlIlIIlllIIllIIIl.stream().anyMatch(n2 -> {
            ...
            if (f.llllIlIlIIIIII(this.i((N)n2) ? 1 : 0) && f.llllIlIIllllIl((Object)n2.aL(), (Object)P.SEAWEED) && f.llllIlIlIIIIII(n2.ac().contains(llIIIlIIIlII[llIIIlIlIllI[44]]) ? 1 : 0)) {
                ...
                if ((0x2F ^ 0x74 ^ (0x9B ^ 0xC4)) <= 0) {
                    return ((35 + 127 - 93 + 84 ^ 155 + 96 - 150 + 83) & (0xD6 ^ 0x89 ^ (0x27 ^ 0x59) ^ -" ".length())) != 0;
                }
            } else {
                n3 = llIIIlIlIllI[1];
            }
    ...
    private void E() {
        ...
        while (f.llllIlIlIIIIII(lllllllllllllllIlIlIIllIIllIlIlI.hasNext() ? 1 : 0)) {
            ...
            if (f.llllIlIlIIIIII(lllllllllllllllIlIlIIllIIllIIlll)) {
                ...
                "".length();
                if (((0xCF ^ 0xB4 ^ (0x3B ^ 0x6C)) & (113 + 131 - 102 + 47 ^ 94 + 67 - 142 + 126 ^ -" ".length())) != ((0xB5 ^ 0xA3 ^ (0x83 ^ 0xB2)) & (1 ^ 0x29 ^ (0xC ^ 3) ^ -" ".length()))) {
                    return;
                }
    ...
    private boolean b(String string) {
        ...
        if (!f.llllIlIlIIIIll(U.matcher((CharSequence)lllllllllllllllIlIlIIlllIIIlIlIl).matches() ? 1 : 0) || !f.llllIlIlIIIIll(V.matcher((CharSequence)lllllllllllllllIlIlIIlllIIIlIlIl).find() ? 1 : 0) || !f.llllIlIlIIIIll(W.matcher((CharSequence)lllllllllllllllIlIlIIlllIIIlIlIl).matches() ? 1 : 0) || f.llllIlIlIIIIII(X.matcher((CharSequence)lllllllllllllllIlIlIIlllIIIlIlIl).matches() ? 1 : 0)) {
            ...
            "".length();
            if (-" ".length() > " ".length()) {
                return ((0x3D ^ 0x1C ^ (0xA3 ^ 0xC6)) & (0xB3 ^ 0x9E ^ (0x5A ^ 0x33) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIIIlIlIllI[1];
        }
