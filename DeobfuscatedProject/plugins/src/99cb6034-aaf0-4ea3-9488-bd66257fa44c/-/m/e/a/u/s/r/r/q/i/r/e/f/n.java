...
extends Enum<n> {
    ...
    private static void lllIllIIlIlIII() {
        ...
        n.lIlllIlIlIll[n.lIlllIlIllII[0]] = n.lllIllIIlIIlIl("RXceLajuJ+cdyNaWcmvyDA==", "tdWWs");
        n.lIlllIlIlIll[n.lIlllIlIllII[1]] = n.lllIllIIlIIllI("DhwCGgoHCQ==", "INMMC");
        n.lIlllIlIlIll[n.lIlllIlIllII[2]] = n.lllIllIIlIIlll("IM5J+Fs5KdqZOs9gzFzH0g==", "GWkpg");
        n.lIlllIlIlIll[n.lIlllIlIllII[3]] = n.lllIllIIlIIlIl("95DSANrDpAw=", "bQglJ");
        n.lIlllIlIlIll[n.lIlllIlIllII[4]] = n.lllIllIIlIIlIl("FWiGnFbYuWc=", "bSCRU");
        n.lIlllIlIlIll[n.lIlllIlIllII[5]] = n.lllIllIIlIIlIl("UJiKAzMH6eA=", "BYNdj");
    }

    private static void lllIllIIlIlIIl() {
        lIlllIlIllII = new int[8];
        n.lIlllIlIllII[0] = (106 + 98 - 184 + 127 ^ 47 + 20 - -20 + 94) & (0xB7 ^ 0x8D ^ (0xA6 ^ 0xBA) ^ -" ".length());
        n.lIlllIlIllII[1] = " ".length();
        n.lIlllIlIllII[2] = "  ".length();
        n.lIlllIlIllII[3] = "   ".length();
