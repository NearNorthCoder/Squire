...
extends Task {
    ...
    private static void llIlIIlIIIlIII() {
        ...
        h.lIIllllIllIl[h.lIIllllIlllI[0]] = h.llIlIIlIIIIlll("lORYDEodjaM=", "amgZg");
        h.lIIllllIllIl[h.lIIllllIlllI[2]] = h.llIlIIlIIIIlll("O7m2FeHfCUE=", "QRfUX");
    }

    private static void llIlIIlIIIlIIl() {
        lIIllllIlllI = new int[3];
        h.lIIllllIlllI[0] = (138 + 21 - 2 + 10 ^ 96 + 147 - 193 + 110) & (114 + 110 - 187 + 149 ^ 176 + 33 - 86 + 66 ^ -" ".length());
        h.lIIllllIlllI[1] = "  ".length();
        h.lIIllllIlllI[2] = " ".length();
    }
