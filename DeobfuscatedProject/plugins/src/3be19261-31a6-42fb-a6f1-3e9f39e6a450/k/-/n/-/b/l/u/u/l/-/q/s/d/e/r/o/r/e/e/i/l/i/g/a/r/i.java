...
extends Task {
    ...
    private static void llIlIIIIlllIII() {
        ...
        i.lIIlllIlIllI[1] = " ".length();
        i.lIIlllIlIllI[2] = "  ".length();
    }
    ...
    public boolean run() {
        ...
        if (i.llIlIIIIllllII((Object)lllllllllllllllIlllIlIlIlllllIII.E.attackStyle(), (Object)c.MELEE)) {
            ...
            "".length();
            if ("   ".length() == 0) {
                return ((0x8D ^ 0xBD ^ (0x19 ^ 0x71)) & (211 + 157 - 292 + 161 ^ 86 + 157 - 66 + 4 ^ -" ".length())) != 0;
            }
        } else {
    ...
    private static void llIlIIIIllIlll() {
        ...
        i.lIIlllIlIlIl[i.lIIlllIlIllI[0]] = i.llIlIIIIllIllI("ADMe8PaGZBw=", "gpSSH");
    }
}
