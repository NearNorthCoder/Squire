...
public class a {
    ...
    private static void llIlIIIlIIIlIl() {
        ...
        a.lIIlllIllIIl[0] = (0x6C ^ 0xC ^ (0x2B ^ 0x5D)) & (0x2C ^ 0x59 ^ (0x7A ^ 0x19) ^ -" ".length());
        a.lIIlllIllIIl[1] = " ".length();
        a.lIIlllIllIIl[2] = "  ".length();
        a.lIIlllIllIIl[3] = "   ".length();
    ...
    public NPC j() {
        return NPCs.getNearest(nPC -> {
            ...
            if (a.llIlIIIlIIlIIl(nPC.isDead() ? 1 : 0) && a.llIlIIIlIIIlll(nPC.getName().equals(lIIlllIlIlll[lIIlllIllIIl[3]]) ? 1 : 0) && a.llIlIIIlIIIlll(nPC.getWorldArea().hasLineOfSightTo(Static.getClient().getTopLevelWorldView(), Players.getLocal().getWorldArea()) ? 1 : 0)) {
                n = lIIlllIllIIl[1];
                "".length();
                if (((35 + 92 - 110 + 117 ^ 108 + 50 - 19 + 0) & (0xA ^ 0x38 ^ (0xFD ^ 0xC2) ^ -" ".length())) != ((70 + 73 - 22 + 82 ^ 131 + 119 - 189 + 72) & (142 + 119 - 205 + 140 ^ 76 + 92 - 70 + 40 ^ -" ".length()))) {
                    return ((210 + 153 - 152 + 24 ^ 139 + 117 - 190 + 130) & (0x2A ^ 0x43 ^ (0x62 ^ 0x24) ^ -" ".length())) != 0;
                }
            } else {
                n = lIIlllIllIIl[0];
            }
            ...
            block3: {
                ...
                if (!a.llIlIIIlIIlIIl(NPCs.getAll(nPC -> {
                    ...
                    if (a.llIlIIIlIIlIlI(nPC.getInteracting(), Players.getLocal())) {
                        bl = lIIlllIllIIl[1];
                        "".length();
                        if (((0xC6 ^ 0x88 ^ (0x57 ^ 0x79)) & (0x29 ^ 0x2F ^ (0xE7 ^ 0x81) ^ -" ".length())) > 0) {
                            return ((0x60 ^ 0x67 ^ (0x2C ^ 0x66)) & (135 + 41 - 83 + 153 ^ 40 + 9 - -63 + 75 ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIlllIllIIl[0];
                    }
    ...
    private static void llIlIIIlIIIIII() {
        ...
        a.lIIlllIlIlll[a.lIIlllIllIIl[0]] = a.llIlIIIIllllIl("EQQ7JRk7", "PpODz");
        a.lIIlllIlIlll[a.lIIlllIllIIl[1]] = a.llIlIIIIllllIl("LBE2KSwG", "meBHO");
        a.lIIlllIlIlll[a.lIIlllIllIIl[2]] = a.llIlIIIIlllllI("YQ7822DGXXg=", "wwsFB");
        a.lIIlllIlIlll[a.lIIlllIllIIl[3]] = a.llIlIIIIllllll("DrwWHUNtqrayUMvspFkh5g==", "xHwDH");
    }
