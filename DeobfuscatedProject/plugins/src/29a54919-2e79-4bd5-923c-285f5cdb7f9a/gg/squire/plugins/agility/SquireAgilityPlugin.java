...
extends SquirePlugin {
    ...
    private static void lIIlIlIIllIIIl() {
        ...
        SquireAgilityPlugin.lIllIIIIIll[SquireAgilityPlugin.lIllIIIIlII[0]] = SquireAgilityPlugin.lIIlIlIIllIIII("CykabBkIPQQ4", "gHjLz");
    }
    ...
    private static void lIIlIlIIllIIlI() {
        ...
        SquireAgilityPlugin.lIllIIIIlII[2] = " ".length();
        SquireAgilityPlugin.lIllIIIIlII[3] = "  ".length();
        SquireAgilityPlugin.lIllIIIIlII[4] = "   ".length();
