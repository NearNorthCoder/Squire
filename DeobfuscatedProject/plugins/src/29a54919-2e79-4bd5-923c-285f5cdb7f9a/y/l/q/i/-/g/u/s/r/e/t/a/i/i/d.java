...
extends Task {
    ...
    private boolean t() {
        ...
        if (d.lIIlIlIlllIIlI((Object)(llllllllllllllllIlIlIlIIIlIIlIII = b2), (Object)b.ARDOUGNE) && d.lIIlIlIllIllll(Skills.getBoostedLevel((Skill)Skill.AGILITY), lIllIIlIIII[5])) {
            ...
            "".length();
            if ("   ".length() != "   ".length()) {
                return ((58 + 133 - 51 + 34 ^ 115 + 41 - 98 + 113) & (91 + 12 - -45 + 47 ^ 125 + 195 - 277 + 155 ^ -" ".length())) != 0;
            }
        } else {
            n = lIllIIlIIII[1];
        }
    ...
    public boolean run() {
        ...
        if (d.lIIlIlIllIllIl(n)) {
            ...
            "".length();
            if (-"  ".length() > 0) {
                return ((0x44 ^ 0xE ^ 105 + 96 - 105 + 31) & (38 + 101 - 20 + 14 ^ 147 + 29 - 141 + 141 ^ -" ".length())) != 0;
            }
        } else {
    ...
    private static void lIIlIlIllIlIll() {
        ...
        d.lIllIIlIIII[1] = (0x51 ^ 0x23 ^ (0xD3 ^ 0xBB)) & (0x5D ^ 0x25 ^ (2 ^ 0x60) ^ -" ".length());
        d.lIllIIlIIII[2] = " ".length();
        d.lIllIIlIIII[3] = "  ".length();
        d.lIllIIlIIII[4] = "   ".length();
    ...
    private static void lIIlIlIlIlIlII() {
        ...
        d.lIllIIIlIlI[d.lIllIIlIIII[1]] = d.lIIlIlIlIIlllI("4OqyvI4cUAA=", "jthYo");
        d.lIllIIIlIlI[d.lIllIIlIIII[2]] = d.lIIlIlIlIIllll("JjQ2", "cUBwY");
        d.lIllIIIlIlI[d.lIllIIlIIII[3]] = d.lIIlIlIlIlIIII("aeyVuL/8hmYR0I/r6q2UMyI+Y97D5+k0XmSpJUYFjX2DsYHdKEZHBwIcgUbABHHShlbv64N88zg=", "ePkkd");
        d.lIllIIIlIlI[d.lIllIIlIIII[4]] = d.lIIlIlIlIIlllI("ZLDMG9vWltY=", "wTjoT");
        d.lIllIIIlIlI[d.lIllIIlIIII[6]] = d.lIIlIlIlIIlllI("NlJBG3VzEVc=", "cyFsW");
        d.lIllIIIlIlI[d.lIllIIlIIII[7]] = d.lIIlIlIlIlIIII("23qt7EaS8yhjkYEK3Un6Og==", "LHKrx");
        d.lIllIIIlIlI[d.lIllIIlIIII[8]] = d.lIIlIlIlIIlllI("13RjHAG7h4Y=", "QTbLc");
    }
