...
extends Task {
    ...
    private static void lIIlIlIllIIIlI() {
        ...
        i.lIllIIIllIl[0] = (45 + 138 - 149 + 113 ^ 118 + 54 - 84 + 69) & (0x15 ^ 7 ^ (0x32 ^ 0x2E) ^ -" ".length());
        ...
        i.lIllIIIllIl[4] = " ".length();
        i.lIllIIIllIl[5] = "  ".length();
    }

    private static void lIIlIlIllIIIIl() {
        lIllIIIllII = new String[lIllIIIllIl[4]];
        i.lIllIIIllII[i.lIllIIIllIl[0]] = i.lIIlIlIllIIIII("8HoQUOi8xr4=", "bgyCV");
    }
