...
public class b {
    ...
    private Map<e, Widget> a(Widget[] widgetArray) {
        void lllllllllllllllIlIIIIIlIIIIllIIl;
        LinkedHashMap<e, Widget> linkedHashMap = new LinkedHashMap<e, Widget>();
        int lllllllllllllllIlIIIIIlIIIIlIlll = llIlIllllIlI[1];
        while (b.lIIIIlIIIIIlllI(lllllllllllllllIlIIIIIlIIIIlIlll, ((void)lllllllllllllllIlIIIIIlIIIIllIIl).length)) {
            void lllllllllllllllIlIIIIIlIIIIlIllI = lllllllllllllllIlIIIIIlIIIIllIIl[lllllllllllllllIlIIIIIlIIIIlIlll];
            e lllllllllllllllIlIIIIIlIIIIlIlIl = e.b(lllllllllllllllIlIIIIIlIIIIlIllI.getText());
            if (b.lIIIIlIIIIIllII((Object)lllllllllllllllIlIIIIIlIIIIlIlIl) && b.lIIIIlIIIIIllll(lllllllllllllllIlIIIIIlIIIIlIllI.getTextColor(), llIlIllllIlI[4])) {
                void lllllllllllllllIlIIIIIlIIIIllIII;
                lllllllllllllllIlIIIIIlIIIIllIII.put(lllllllllllllllIlIIIIIlIIIIlIlIl, lllllllllllllllIlIIIIIlIIIIlIllI);
                "".length();
            }
    ...
    private static void lIIIIlIIIIIlIll() {
        ...
        b.llIlIllllIlI[1] = "  ".length();
        b.llIlIllllIlI[2] = " ".length();
