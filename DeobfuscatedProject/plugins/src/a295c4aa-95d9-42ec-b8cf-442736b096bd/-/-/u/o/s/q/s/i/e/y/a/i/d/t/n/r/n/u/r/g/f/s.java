...
extends j {
    ...
    private static void lIIIIIllIlllllI() {
        ...
        s.llIlIllIIIIl[1] = " ".length();
        s.llIlIllIIIIl[2] = "  ".length();
    }
    ...
    @Override
    public boolean M() {
        s lllllllllllllllIlIIIIIllllIIIIII;
        if (s.lIIIIIllIllllll(this.T.g() ? 1 : 0)) {
            return llIlIllIIIIl[0];
        }
        if (s.lIIIIIllIllllll(lllllllllllllllIlIIIIIllllIIIIII.T.d() ? 1 : 0)) {
            return llIlIllIIIIl[0];
        }
        if (s.lIIIIIllIllllll(Bank.isOpen() ? 1 : 0)) {
            return llIlIllIIIIl[0];
        }
        if (s.lIIIIIlllIIIIII(lllllllllllllllIlIIIIIllllIIIIII.U.b().matchesInventory() ? 1 : 0)) {
            Bank.close();
            return llIlIllIIIIl[1];
        }
        if (s.lIIIIIlllIIIIII(Bank.isOpen() ? 1 : 0)) {
            lllllllllllllllIlIIIIIllllIIIIII.U.b().withdraw();
            "".length();
            lllllllllllllllIlIIIIIllllIIIIII.sleep(llIlIllIIIIl[2]);
            return llIlIllIIIIl[1];
        }
        return llIlIllIIIIl[0];
    }
