...
extends Enum<g> {
    ...
    private static void lIIIIlIIIIlIIll() {
        ...
        g.llIlIllllIll[g.llIlIlllllII[0]] = g.lIIIIlIIIIlIIII("8+WWXjpgjKE=", "XzBsm");
        g.llIlIllllIll[g.llIlIlllllII[3]] = g.lIIIIlIIIIlIIIl("DRMAHiIZFQYeIw==", "JAIPf");
        g.llIlIllllIll[g.llIlIlllllII[6]] = g.lIIIIlIIIIlIIlI("en+y0Mq1d1k=", "xxFNG");
    }
