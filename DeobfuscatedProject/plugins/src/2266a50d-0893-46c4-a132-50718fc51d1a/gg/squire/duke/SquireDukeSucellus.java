...
extends SquirePlugin {
    ...
    private static void lllIlIIllIIllI() {
        ...
        SquireDukeSucellus.lIllIlllIIII[0] = (0x51 ^ 0x17 ^ (0x82 ^ 0x84)) & (0x81 ^ 0xB3 ^ (0x65 ^ 0x17) ^ -" ".length());
        SquireDukeSucellus.lIllIlllIIII[1] = " ".length();
        SquireDukeSucellus.lIllIlllIIII[2] = 94 + 77 - 63 + 19 ^ (0xC9 ^ 0x95);
        SquireDukeSucellus.lIllIlllIIII[3] = "  ".length();
        SquireDukeSucellus.lIllIlllIIII[4] = "   ".length();
    ...
    public void a(List<WorldArea> list) {
        this.g.clear();
        Iterator<WorldArea> lllllllllllllllIlIlllIlIlIIIlIIl = list.iterator();
        while (SquireDukeSucellus.lllIlIIllIIlll(lllllllllllllllIlIlllIlIlIIIlIIl.hasNext() ? 1 : 0)) {
            SquireDukeSucellus lllllllllllllllIlIlllIlIlIIIlIll;
            WorldArea lllllllllllllllIlIlllIlIlIIIlIII = lllllllllllllllIlIlllIlIlIIIlIIl.next();
            lllllllllllllllIlIlllIlIlIIIlIll.g.addAll(lllllllllllllllIlIlllIlIlIIIlIII.toWorldPointList());
            "".length();
            "".length();
    ...
    public void b(List<WorldArea> list) {
        Iterator<WorldArea> lllllllllllllllIlIlllIlIlIIIIIIl = list.iterator();
        while (SquireDukeSucellus.lllIlIIllIIlll(lllllllllllllllIlIlllIlIlIIIIIIl.hasNext() ? 1 : 0)) {
            SquireDukeSucellus lllllllllllllllIlIlllIlIlIIIIIll;
            WorldArea lllllllllllllllIlIlllIlIlIIIIIII = lllllllllllllllIlIlllIlIlIIIIIIl.next();
            lllllllllllllllIlIlllIlIlIIIIIll.g.addAll(lllllllllllllllIlIlllIlIlIIIIIII.toWorldPointList());
            "".length();
            "".length();
            if (null == null) continue;
            return;
