...
extends Task {
    ...
    private static void lllIIllIIlIlII() {
        ...
        C.lIllIIllllIl[C.lIllIIlllllI[0]] = C.lllIIllIIlIIlI("U/pYLS/akwE=", "ScqhY");
        C.lIllIIllllIl[C.lIllIIlllllI[1]] = C.lllIIllIIlIIlI("nv1gdKX5tXrtk1LLWwi5rA==", "wgzKo");
        C.lIllIIllllIl[C.lIllIIlllllI[2]] = C.lllIIllIIlIIll("FjQ9HGsBNDUcJz40JQ==", "RAVyK");
        C.lIllIIllllIl[C.lIllIIlllllI[3]] = C.lllIIllIIlIIll("LRIMJykH", "lfxFJ");
    }
        ...
        TileObject lllllllllllllllIllIIIIIIlIlIIlII = TileObjects.getNearest(tileObject -> {
            ...
            if (C.lllIIllIIllIII(tileObject.getName().equals(lIllIIllllIl[lIllIIlllllI[0]]) ? 1 : 0)) {
                ...
                if (C.lllIIllIIllIII(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    n2 = lIllIIlllllI[1];
                    "".length();
                    if (((0x67 ^ 0x39 ^ (0x56 ^ 0x2A)) & (0xD8 ^ 0xC1 ^ (0x2B ^ 0x10) ^ -" ".length())) <= (((0xF2 ^ 0xAF) & ~(0x66 ^ 0x3B) ^ (0x9E ^ 0xC4)) & (0x76 ^ 0x38 ^ (0 ^ 0x14) ^ -" ".length()))) return n2 != 0;
                    return ((11 + 53 - -20 + 96 ^ 35 + 87 - 24 + 64) & (0xBE ^ 0x9A ^ (0xA5 ^ 0x97) ^ -" ".length())) != 0;
                }
            }
            n2 = lIllIIlllllI[0];
            return n2 != 0;
    ...
    private static void lllIIllIIlIlIl() {
        ...
        C.lIllIIlllllI[1] = " ".length();
        C.lIllIIlllllI[2] = "  ".length();
        C.lIllIIlllllI[3] = "   ".length();
