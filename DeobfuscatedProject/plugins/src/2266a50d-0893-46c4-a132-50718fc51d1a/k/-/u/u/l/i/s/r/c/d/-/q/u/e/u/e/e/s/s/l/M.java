...
extends Task {
    ...
    private static void lllIlIIlIlIIII() {
        ...
        M.lIllIllIlIIl[1] = " ".length();
        M.lIllIllIlIIl[2] = 0x65 ^ 0x25 ^ (0x29 ^ 0x65);
        M.lIllIllIlIIl[3] = "  ".length();
        M.lIllIllIlIIl[4] = "   ".length();
        ...
        TileObject lllllllllllllllIlIlllIllIIllIlII = TileObjects.getNearest(tileObject -> {
            ...
            if (M.lllIlIIlIlIIIl(tileObject.getName().equals(lIllIllIIllI[lIllIllIlIIl[4]]) ? 1 : 0)) {
                ...
                if (M.lllIlIIlIlIIIl(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    n2 = lIllIllIlIIl[1];
                    "".length();
                    if (((0x44 ^ 0x1D) & ~(0xE3 ^ 0xBA)) >= -" ".length()) return n2 != 0;
    ...
    private static void lllIlIIlIIllIl() {
        ...
        M.lIllIllIIllI[M.lIllIllIlIIl[0]] = M.lllIlIIlIIIllI("jKeAVP0IFMQsB8Hf4GBxTg==", "fQGkP");
        M.lIllIllIIllI[M.lIllIllIlIIl[1]] = M.lllIlIIlIIIlll("FB8nICV5ByEwLCsFOy43", "YjTCD");
        M.lIllIllIIllI[M.lIllIllIlIIl[3]] = M.lllIlIIlIIIlll("JAUtOw==", "tlNPw");
        M.lIllIllIIllI[M.lIllIllIlIIl[4]] = M.lllIlIIlIIIlll("CwwlHQ==", "LmQxZ");
        M.lIllIllIIllI[M.lIllIllIlIIl[5]] = M.lllIlIIlIIIllI("OuSXVoRvrtIE5Wj2MTO7gw==", "AMIvi");
    }
