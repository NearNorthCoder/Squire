...
extends Enum<c> {
    ...
    private static void lllIlIIlIlllIl() {
        ...
        c.lIllIllIlIII[c.lIllIllIlllI[1]] = c.lllIlIIlIIlllI("ADslMTMMLTo5IxI6", "Snuta");
        c.lIllIllIlIII[c.lIllIllIlllI[2]] = c.lllIlIIlIIllll("v61ussIfZ4vj0VFinMlSDbPV2vw1U/wr", "bwhqa");
        c.lIllIllIlIII[c.lIllIllIlllI[6]] = c.lllIlIIlIlIIlI("wYnMkjIpXNV/Z0aA5Fuf/A==", "gvxAx");
        c.lIllIllIlIII[c.lIllIllIlllI[5]] = c.lllIlIIlIlIIlI("BpXyeB/onfUS2+MGPG2a+g==", "ecCCg");
        c.lIllIllIlIII[c.lIllIllIlllI[7]] = c.lllIlIIlIIllll("ewRGXMFcC6pXvtz9Rac+Sg==", "SkMlO");
        c.lIllIllIlIII[c.lIllIllIlllI[3]] = c.lllIlIIlIlIIlI("dfwzD8U5/0knYcWqOUfZPg==", "zdUEI");
        c.lIllIllIlIII[c.lIllIllIlllI[8]] = c.lllIlIIlIlIIlI("3NpBBOiUraOXVPUZH2RG2g==", "kNpUv");
        c.lIllIllIlIII[c.lIllIllIlllI[9]] = c.lllIlIIlIIllll("K2euzNXMMBz1H4zxSPYHRQ==", "iMNQq");
        c.lIllIllIlIII[c.lIllIllIlllI[10]] = c.lllIlIIlIlIIlI("KTsIW4IfUekA+HVgSCyEAk0sHEH67/Sr", "FSYsW");
        c.lIllIllIlIII[c.lIllIllIlllI[11]] = c.lllIlIIlIIllll("56bhD58FqLS5ghx6nWyX+T6gT2yRE6vUcyyCF0Av5o4=", "oKOZo");
        c.lIllIllIlIII[c.lIllIllIlllI[12]] = c.lllIlIIlIlIIlI("SYDQpM/yKYFA8Kb6ORAknQ==", "AlUVV");
        c.lIllIllIlIII[c.lIllIllIlllI[13]] = c.lllIlIIlIIllll("9UMD8kMbNu2rnKUMQ/sqRg==", "JhnyJ");
        c.lIllIllIlIII[c.lIllIllIlllI[14]] = c.lllIlIIlIIllll("Lr3vDCbo1i1Xu9Oiv6J4fTcKqPHbs5hV", "FykUu");
        c.lIllIllIlIII[c.lIllIllIlllI[15]] = c.lllIlIIlIIllll("m69B8pArE5g0EgXh6Qddho6jvOf5j7tl", "fFbfk");
        c.lIllIllIlIII[c.lIllIllIlllI[16]] = c.lllIlIIlIIllll("C1I5omSc7NlpWN/q6M8k6A==", "CsHIR");
        c.lIllIllIlIII[c.lIllIllIlllI[4]] = c.lllIlIIlIIllll("Jlb4dbnTHU93rN9KvbMCRQ==", "hRuBT");
        c.lIllIllIlIII[c.lIllIllIlllI[17]] = c.lllIlIIlIIlllI("PT8hJz48KTUvIy0/OCAvKTkjJz83", "yvwnp");
        c.lIllIllIlIII[c.lIllIllIlllI[18]] = c.lllIlIIlIIllll("2bWF9SBhvisdVn/1SCWf0tHnrq8YtxfD", "SsLfR");
        c.lIllIllIlIII[c.lIllIllIlllI[19]] = c.lllIlIIlIIlllI("BBYjEDYWBysNPAYZ", "IWdYu");
        c.lIllIllIlIII[c.lIllIllIlllI[20]] = c.lllIlIIlIIlllI("KSQKEAVENQINDwsr", "dEmyf");
        c.lIllIllIlIII[c.lIllIllIlllI[21]] = c.lllIlIIlIlIIlI("NZm2Q6821vDjHxf3ovbq4ofbOIfEWJsY", "sMoWB");
        c.lIllIllIlIII[c.lIllIllIlllI[22]] = c.lllIlIIlIIllll("v/Js8RDUaeve/PRZnMOKRzdceBuQNRCZ", "WFvPo");
        c.lIllIllIlIII[c.lIllIllIlllI[23]] = c.lllIlIIlIlIIlI("CZ4ViIJRHtZBfnroCmC3Pw==", "SIzMi");
        c.lIllIllIlIII[c.lIllIllIlllI[24]] = c.lllIlIIlIIlllI("EyI1ET08OHYaKjc7", "RLVxX");
    }

    private static String lllIlIIlIIlllI(String lllllllllllllllIlIlllIlIlIllIllI, String lllllllllllllllIlIlllIlIlIlllIlI) {
        lllllllllllllllIlIlllIlIlIllIllI = new String(Base64.getDecoder().decode(lllllllllllllllIlIlllIlIlIllIllI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIlIlllIlIlIlllIIl = new StringBuilder();
        char[] lllllllllllllllIlIlllIlIlIlllIII = lllllllllllllllIlIlllIlIlIlllIlI.toCharArray();
        int lllllllllllllllIlIlllIlIlIllIlll = lIllIllIlllI[1];
        char[] lllllllllllllllIlIlllIlIlIllIIIl = lllllllllllllllIlIlllIlIlIllIllI.toCharArray();
        int lllllllllllllllIlIlllIlIlIllIIII = lllllllllllllllIlIlllIlIlIllIIIl.length;
        int lllllllllllllllIlIlllIlIlIlIllll = lIllIllIlllI[1];
        while (c.lllIlIIllIIlIl(lllllllllllllllIlIlllIlIlIlIllll, lllllllllllllllIlIlllIlIlIllIIII)) {
            char lllllllllllllllIlIlllIlIlIllllII = lllllllllllllllIlIlllIlIlIllIIIl[lllllllllllllllIlIlllIlIlIlIllll];
            lllllllllllllllIlIlllIlIlIlllIIl.append((char)(lllllllllllllllIlIlllIlIlIllllII ^ lllllllllllllllIlIlllIlIlIlllIII[lllllllllllllllIlIlllIlIlIllIlll % lllllllllllllllIlIlllIlIlIlllIII.length]));
            "".length();
            ++lllllllllllllllIlIlllIlIlIllIlll;
            ++lllllllllllllllIlIlllIlIlIlIllll;
            "".length();
    ...
    private static String lllIlIIlIIllll(String lllllllllllllllIlIlllIlIlIlIIlII, String lllllllllllllllIlIlllIlIlIlIIlIl) {
        try {
            ...
            return new String(lllllllllllllllIlIlllIlIlIlIlIII.doFinal(Base64.getDecoder().decode(lllllllllllllllIlIlllIlIlIlIIlII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lllIlIIllIIlII() {
        ...
        c.lIllIllIlllI[1] = (" ".length() ^ (0x33 ^ 0x7A)) & (195 + 193 - 351 + 216 ^ 90 + 97 - 137 + 131 ^ -" ".length());
        c.lIllIllIlllI[2] = " ".length();
        c.lIllIllIlllI[3] = 0x4A ^ 0x4F;
        c.lIllIllIlllI[4] = 0x2D ^ 0x22;
        c.lIllIllIlllI[5] = "   ".length();
        c.lIllIllIlllI[6] = "  ".length();
        ...
        c.lIllIllIlllI[13] = "   ".length() ^ (0x86 ^ 0x8E);
    ...
    private static String lllIlIIlIlIIlI(String lllllllllllllllIlIlllIlIlIIllIIl, String lllllllllllllllIlIlllIlIlIIllIII) {
        try {
            ...
            Cipher lllllllllllllllIlIlllIlIlIIllIll = Cipher.getInstance("Blowfish");
            lllllllllllllllIlIlllIlIlIIllIll.init(lIllIllIlllI[6], lllllllllllllllIlIlllIlIlIIlllII);
            return new String(lllllllllllllllIlIlllIlIlIIllIll.doFinal(Base64.getDecoder().decode(lllllllllllllllIlIlllIlIlIIllIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
