...
extends Task {
    ...
    private static void lllIlIIlIlllII() {
        ...
        P.lIllIllIllII[P.lIllIllIllIl[0]] = P.lllIlIIlIllIlI("LyyI1ydihcq7SFcEc1JN6g==", "wEvfa");
        P.lIllIllIllII[P.lIllIllIllIl[1]] = P.lllIlIIlIllIlI("YaMd8tWn0CY=", "GLYid");
        P.lIllIllIllII[P.lIllIllIllIl[3]] = P.lllIlIIlIllIll("FwvRB7Ik+SeIVyVoJ/AESQ==", "xGmNu");
    }
        ...
        TileObject lllllllllllllllIlIlllIlIllllIIII = TileObjects.getNearest(tileObject -> {
            ...
            if (P.lllIlIIlIlllll(tileObject.getName().equals(lIllIllIllII[lIllIllIllIl[1]]) ? 1 : 0)) {
                ...
                if (P.lllIlIIlIlllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    n2 = lIllIllIllIl[1];
                    "".length();
                    if (((193 + 128 - 271 + 168 ^ 61 + 126 - 100 + 51) & (94 + 5 - -72 + 22 ^ 81 + 126 - 77 + 15 ^ -" ".length())) >= ((38 + 44 - -87 + 21 ^ 125 + 18 - 94 + 137) & (95 + 58 - 135 + 114 ^ 119 + 7 - 28 + 30 ^ -" ".length()))) return n2 != 0;
                    return (((0x7F ^ 0x32) & ~(0x49 ^ 4) & ~((0x32 ^ 0x6F) & ~(0x2C ^ 0x71)) ^ (0x8F ^ 0xA4)) & (0x26 ^ 0x5D ^ (0x42 ^ 0x12) ^ -" ".length())) != 0;
                }
            }
            n2 = lIllIllIllIl[0];
            return n2 != 0;
    ...
    private static void lllIlIIlIllllI() {
        ...
        P.lIllIllIllIl[1] = " ".length();
        P.lIllIllIllIl[2] = 0xA6 ^ 0xA8 ^ "  ".length();
        P.lIllIllIllIl[3] = "  ".length();
        P.lIllIllIllIl[4] = "   ".length();
