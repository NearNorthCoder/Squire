...
extends Task {
    ...
    private static String lllIIllllIIllI(String lllllllllllllllIlIlllllIIIIlIIIl, String lllllllllllllllIlIlllllIIIIlIlIl) {
        ...
        while (v.lllIIllllIllIl(lllllllllllllllIlIlllllIIIIIlIlI, lllllllllllllllIlIlllllIIIIIlIll)) {
            ...
            "".length();
            if ("  ".length() != ((0xF0 ^ 0xA0) & ~(0x69 ^ 0x39))) continue;
            return null;
        }
    ...
    private static void lllIIllllIlIII() {
        ...
        v.lIllIlIlIIIl[0] = (0x54 ^ 0x78 ^ (0xE2 ^ 0x97)) & (0xD ^ 0x4F ^ (0x38 ^ 0x23) ^ -" ".length());
        v.lIllIlIlIIIl[1] = " ".length();
        v.lIllIlIlIIIl[2] = "  ".length();
        v.lIllIlIlIIIl[3] = "   ".length();
    }
    ...
    private static void lllIIllllIIlll() {
        ...
        v.lIllIlIlIIII[v.lIllIlIlIIIl[0]] = v.lllIIllllIIlIl("usUe1GEdZeE=", "RPKoJ");
        v.lIllIlIlIIII[v.lIllIlIlIIIl[1]] = v.lllIIllllIIlIl("K/ddZktKz62QMgJMccQssw==", "nnqLE");
        v.lIllIlIlIIII[v.lIllIlIlIIIl[2]] = v.lllIIllllIIllI("AhkGJhRRHhMwEh4eEw==", "qlvCf");
    }
