...
extends Task {
    ...
    private static /* synthetic */ boolean a(int n2, TileObject tileObject, TileObject tileObject2) {
        ...
        if (N.lllIlIlIllIlll(lllllllllllllllIlIlllIIIIlllIlII.getWorldX(), lllllllllllllllIlIlllIIIIlllIlIl.getWorldX())) {
            bl = lIlllIIIIlIl[2];
            "".length();
            if (-" ".length() >= ((0x8C ^ 0xA9 ^ (0x4E ^ 0x39)) & (91 + 97 - 143 + 186 ^ 70 + 18 - 44 + 137 ^ -" ".length()))) {
                return ((118 + 224 - 267 + 152 ^ 41 + 38 - -15 + 37) & (0x5F ^ 0x7F ^ (0x61 ^ 0x21) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlllIIIIlIl[0];
        }
    ...
    private static void lllIlIlIllIIlI() {
        ...
        N.lIlllIIIIlIl[0] = "  ".length() & ~"  ".length();
        N.lIlllIIIIlIl[1] = "  ".length();
        N.lIlllIIIIlIl[2] = " ".length();
        N.lIlllIIIIlIl[3] = 0x8C ^ 0x8A;
        N.lIlllIIIIlIl[4] = "   ".length();
        ...
        TileObject tileObject2 = TileObjects.getNearest(tileObject -> {
            ...
            if (N.lllIlIlIlllIII(tileObject.getName().equals(lIlllIIIIIll[lIlllIIIIlIl[5]]) ? 1 : 0)) {
                ...
                if (N.lllIlIlIlllIII(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((122 + 37 - 141 + 123 ^ 86 + 70 - 39 + 39) & (0xA6 ^ 0xC6 ^ (0x4B ^ 0x3A) ^ -" ".length())) != 0;
                }
            }
            n2 = lIlllIIIIlIl[0];
            return n2 != 0;
    ...
    private static void lllIlIlIlIllIl() {
        ...
        N.lIlllIIIIIll[N.lIlllIIIIlIl[0]] = N.lllIlIlIlIlIlI("p4C1uKRT6zqkfycX3wA7oQ==", "oIilH");
        N.lIlllIIIIIll[N.lIlllIIIIlIl[2]] = N.lllIlIlIlIlIll("Ah8OKw==", "DvbGx");
        N.lIlllIIIIIll[N.lIlllIIIIlIl[1]] = N.lllIlIlIlIlIlI("ykNnP0iS0D4=", "PzXeG");
        N.lIlllIIIIIll[N.lIlllIIIIlIl[4]] = N.lllIlIlIlIlIll("KCgkBj0AOTcfMQEjdj05Gg==", "nMVkX");
        N.lIlllIIIIIll[N.lIlllIIIIlIl[5]] = N.lllIlIlIlIllII("cYF/jz+vm+Y=", "TVguw");
        N.lIlllIIIIIll[N.lIlllIIIIlIl[6]] = N.lllIlIlIlIlIll("ORkTDxhFCQkPEhgJ", "hlzls");
    }
