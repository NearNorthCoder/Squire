...
extends Task {
    ...
    private static void lllIIlIllllllI() {
        ...
        G.lIllIIllIlII[0] = "  ".length();
        G.lIllIIllIlII[1] = (7 ^ 0x28) & ~(0x96 ^ 0xB9);
        G.lIllIIllIlII[2] = " ".length();
        G.lIllIIllIlII[3] = "   ".length();
        ...
        TileObject lllllllllllllllIllIIIIIlIIlllIll = TileObjects.getNearest(tileObject -> {
            ...
            if (G.lllIIllIIIIIlI(tileObject.getName().equals(lIllIIllIIll[lIllIIllIlII[0]]) ? 1 : 0)) {
                ...
                if (G.lllIIllIIIIIlI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((26 + 47 - 65 + 149 ^ 113 + 10 - -1 + 10) & (28 + 127 - 126 + 136 ^ 123 + 68 - 76 + 75 ^ -" ".length())) != 0;
                }
            }
            n2 = lIllIIllIlII[1];
            return n2 != 0;
    ...
    private static void lllIIlIlllllIl() {
        ...
        G.lIllIIllIIll[G.lIllIIllIlII[1]] = G.lllIIlIllllIlI("3QlbIUwXAst8m67W+yiDZFvPypYuzZJs", "mfNkp");
        G.lIllIIllIIll[G.lIllIIllIlII[2]] = G.lllIIlIllllIll("sWkJ7EbmHA6GWJXOd1ouZg==", "ufSdj");
        G.lIllIIllIIll[G.lIllIIllIlII[0]] = G.lllIIlIllllIll("XyAfSP00fko=", "ptebh");
        G.lIllIIllIIll[G.lIllIIllIlII[3]] = G.lllIIlIlllllII("OhgCAhpGCBgCEBsI", "kmkaq");
    }
