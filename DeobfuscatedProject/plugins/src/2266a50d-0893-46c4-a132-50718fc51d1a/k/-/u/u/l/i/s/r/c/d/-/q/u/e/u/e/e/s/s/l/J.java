...
extends Task {
    ...
    private static /* synthetic */ boolean a(int n2, TileObject tileObject, TileObject tileObject2) {
        ...
        if (J.lllIIllllllIll(lllllllllllllllIlIllllIlllIllIIl, lIllIlIlIlIl[2])) {
            ...
            if (J.lllIIlllllllII(lllllllllllllllIlIllllIlllIlIlll.getWorldX(), lllllllllllllllIlIllllIlllIllIII.getWorldX())) {
                ...
                "".length();
                if (-" ".length() > " ".length()) {
                    return ((0xC6 ^ 0xC0 ^ (0x26 ^ 0x3C)) & (0x7A ^ 0xE ^ (0xF2 ^ 0x9A) ^ -" ".length())) != 0;
                }
            } else {
                bl2 = lIllIlIlIlIl[0];
            }
    ...
    private static void lllIIlllllIlII() {
        ...
        J.lIllIlIlIlIl[0] = (52 + 36 - 56 + 98 ^ 90 + 5 - -11 + 53) & (87 + 18 - -27 + 34 ^ 17 + 44 - -35 + 91 ^ -" ".length());
        J.lIllIlIlIlIl[1] = "  ".length();
        J.lIllIlIlIlIl[2] = " ".length();
        J.lIllIlIlIlIl[3] = 0x72 ^ 0x74;
        J.lIllIlIlIlIl[4] = "   ".length();
    ...
    private static void lllIIlllllIIll() {
        ...
        J.lIllIlIlIlII[J.lIllIlIlIlIl[0]] = J.lllIIlllllIIII("OBcLBjRZFQAUIhwX", "yeocF");
        J.lIllIlIlIlII[J.lIllIlIlIlIl[2]] = J.lllIIlllllIIIl("8tEy5RtHOlQ=", "lJeke");
        J.lIllIlIlIlII[J.lIllIlIlIlIl[1]] = J.lllIIlllllIIIl("M31H+kjIZ88=", "QGDPb");
        J.lIllIlIlIlII[J.lIllIlIlIlIl[4]] = J.lllIIlllllIIlI("Wb/Rza5dOH5Bl2MNhDmBaPhjRkTeTh/C", "HCtnO");
        J.lIllIlIlIlII[J.lIllIlIlIlIl[5]] = J.lllIIlllllIIII("JAQuAA==", "ceZeX");
        J.lIllIlIlIlII[J.lIllIlIlIlIl[6]] = J.lllIIlllllIIII("FSQ6NQJpNCA1CDQ0", "DQSVi");
    }
