...
extends Task {
    ...
    private static void lllIlIIIIIllIl() {
        ...
        F.lIllIlIllIII[F.lIllIlIllIIl[2]] = F.lllIlIIIIIlIlI("m4MMOaW5syaR1TJcFdIaog==", "JwDPV");
        F.lIllIlIllIII[F.lIllIlIllIIl[1]] = F.lllIlIIIIIlIll("9T6ADdxbwsM=", "zsHVN");
        F.lIllIlIllIII[F.lIllIlIllIIl[0]] = F.lllIlIIIIIlIlI("9f4sZ+GWiVy6RfFlzsH2yw==", "znvCV");
        F.lIllIlIllIII[F.lIllIlIllIIl[3]] = F.lllIlIIIIIllII("Cy0LFiIgMQ==", "OHxbP");
        F.lIllIlIllIII[F.lIllIlIllIIl[4]] = F.lllIlIIIIIlIll("WhEQnMDxn2oV5ZdRO4cqZA==", "RZXag");
        F.lIllIlIllIII[F.lIllIlIllIIl[5]] = F.lllIlIIIIIllII("BRMdHjYuDw==", "AvnjD");
        F.lIllIlIllIII[F.lIllIlIllIIl[6]] = F.lllIlIIIIIlIll("m0wus/eSfcc=", "dknOy");
        F.lIllIlIllIII[F.lIllIlIllIIl[7]] = F.lllIlIIIIIllII("AAs7", "EjOmn");
    }
    ...
    private static void lllIlIIIIIlllI() {
        ...
        F.lIllIlIllIIl[0] = "  ".length();
        F.lIllIlIllIIl[1] = " ".length();
        F.lIllIlIllIIl[2] = (0x42 ^ 0x2B ^ (0xBF ^ 0x98)) & (0x38 ^ 0x40 ^ (0xA9 ^ 0x9F) ^ -" ".length());
        F.lIllIlIllIIl[3] = "   ".length();
