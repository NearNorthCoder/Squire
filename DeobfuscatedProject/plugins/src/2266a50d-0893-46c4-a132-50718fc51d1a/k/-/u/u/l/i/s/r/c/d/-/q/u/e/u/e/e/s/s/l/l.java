...
extends Task {
    ...
    private static void lllIlIIlIIlIII() {
        ...
        l.lIllIllIIlll[3] = " ".length();
        l.lIllIllIIlll[4] = "  ".length();
        l.lIllIllIIlll[5] = "   ".length();
    }
    ...
    public boolean run() {
        ...
        if (l.lllIlIIlIIlIll(Movement.isStaminaBoosted() ? 1 : 0)) {
            if (l.lllIlIIlIIllII(Movement.getRunEnergy(), lIllIllIIlll[2])) {
                void lllllllllllllllIlIlllIllIlIlllll;
                lllllllllllllllIlIlllIllIlIlllll.interact(lIllIllIIlIl[lIllIllIIlll[0]]);
    ...
    private static String lllIlIIlIIIlII(String lllllllllllllllIlIlllIllIlIIllll, String lllllllllllllllIlIlllIllIlIIlllI) {
        lllllllllllllllIlIlllIllIlIIllll = new String(Base64.getDecoder().decode(lllllllllllllllIlIlllIllIlIIllll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIlIlllIllIlIlIIlI = new StringBuilder();
        char[] lllllllllllllllIlIlllIllIlIlIIIl = lllllllllllllllIlIlllIllIlIIlllI.toCharArray();
        int lllllllllllllllIlIlllIllIlIlIIII = lIllIllIIlll[0];
        char[] lllllllllllllllIlIlllIllIlIIlIlI = lllllllllllllllIlIlllIllIlIIllll.toCharArray();
        int lllllllllllllllIlIlllIllIlIIlIIl = lllllllllllllllIlIlllIllIlIIlIlI.length;
        int lllllllllllllllIlIlllIllIlIIlIII = lIllIllIIlll[0];
        while (l.lllIlIIlIIllII(lllllllllllllllIlIlllIllIlIIlIII, lllllllllllllllIlIlllIllIlIIlIIl)) {
            char lllllllllllllllIlIlllIllIlIlIlIl = lllllllllllllllIlIlllIllIlIIlIlI[lllllllllllllllIlIlllIllIlIIlIII];
    ...
    private static void lllIlIIlIIIlIl() {
        ...
        l.lIllIllIIlIl[l.lIllIllIIlll[0]] = l.lllIlIIlIIIlII("BxwxKhs=", "CnXDp");
        l.lIllIllIIlIl[l.lIllIllIIlll[3]] = l.lllIlIIlIIIlII("DzMKBig=", "KAchC");
        l.lIllIllIIlIl[l.lIllIllIIlll[4]] = l.lllIlIIlIIIlII("FyQQKRgqMQ==", "DPqDq");
    }
}
