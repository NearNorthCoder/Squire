...
extends Task {
    ...
    private static String lllIIlllIIIIll(String lllllllllllllllIlIllllllIIIIIIII, String lllllllllllllllIlIllllllIIIIIlII) {
        ...
        while (y.lllIIlllIIlIlI(lllllllllllllllIlIlllllIlllllIIl, lllllllllllllllIlIlllllIlllllIlI)) {
            ...
            "".length();
            if (((0x64 ^ 0x54 ^ (0x4C ^ 0x36)) & (43 + 64 - -104 + 32 ^ 57 + 124 - 36 + 40 ^ -" ".length())) < (167 + 42 - 84 + 70 ^ 148 + 122 - 181 + 110)) continue;
            return null;
        }
    ...
    private static void lllIIlllIIIllI() {
        ...
        y.lIllIlIIlIlI[0] = (0x1C ^ 0x50 ^ (0xA ^ 0x61)) & (0x60 ^ 0x36 ^ (0xD2 ^ 0xA3) ^ -" ".length());
        y.lIllIlIIlIlI[1] = " ".length();
        y.lIllIlIIlIlI[2] = "  ".length();
        y.lIllIlIIlIlI[3] = "   ".length();
        y.lIllIlIIlIlI[4] = 102 + 151 - 126 + 47 ^ 10 + 144 - 29 + 41;
    }

    private static void lllIIlllIIIlIl() {
        lIllIlIIlIIl = new String[lIllIlIIlIlI[3]];
        y.lIllIlIIlIIl[y.lIllIlIIlIlI[0]] = y.lllIIlllIIIIlI("h5p7JA0qGYA=", "QJHrF");
        y.lIllIlIIlIIl[y.lIllIlIIlIlI[1]] = y.lllIIlllIIIIll("ETsMHA==", "EZgyR");
        y.lIllIlIIlIIl[y.lIllIlIIlIlI[2]] = y.lllIIlllIIIlII("+EvjmcrY2a4=", "oeVJy");
    }
