...
extends Task {
    ...
    private static void lllIlIlIlIIlII() {
        ...
        A.lIlllIIIIIlI[3] = "   ".length();
        A.lIlllIIIIIlI[4] = " ".length();
        A.lIlllIIIIIlI[5] = "  ".length();
        A.lIlllIIIIIlI[6] = "  ".length() ^ (0xB4 ^ 0xB2);
    }
    ...
    private static void lllIlIlIIlllll() {
        ...
        A.lIlllIIIIIII[A.lIlllIIIIIlI[0]] = A.lllIlIlIIlllII("DhUaLw==", "ItnJW");
        A.lIlllIIIIIII[A.lIlllIIIIIlI[4]] = A.lllIlIlIIlllIl("Htnj0gS5BTiDOrS8xILSLA==", "dJbIr");
        A.lIlllIIIIIII[A.lIlllIIIIIlI[5]] = A.lllIlIlIIllllI("mlcP1pcglkPlbH7LMLGoXA==", "TxSYD");
        A.lIlllIIIIIII[A.lIlllIIIIIlI[3]] = A.lllIlIlIIlllIl("4AssFQ3E1IQ=", "PrzDv");
    }
