...
extends Task {
    ...
    private static String lllIlIlIIIlIII(String lllllllllllllllIlIlllIIllIIIIIlI, String lllllllllllllllIlIlllIIllIIIIIIl) {
        ...
        while (I.lllIlIlIIlIIIl(lllllllllllllllIlIlllIIlIlllIllI, lllllllllllllllIlIlllIIlIlllIlll)) {
            ...
            "".length();
            if (((0xB4 ^ 0x92 ^ (0x2D ^ 0x12)) & (182 + 45 - 86 + 43 ^ 15 + 36 - -98 + 12 ^ -" ".length())) != "  ".length()) continue;
            return null;
        }
    ...
    private static void lllIlIlIIIlIlI() {
        ...
        I.lIllIlllllIl[1] = " ".length();
        I.lIllIlllllIl[2] = 0x9B ^ 0x97;
        I.lIllIlllllIl[3] = "  ".length();
        I.lIllIlllllIl[4] = "   ".length();
    ...
    private static void lllIlIlIIIlIIl() {
        ...
        I.lIllIlllllII[I.lIllIlllllIl[0]] = I.lllIlIlIIIIllI("awPf27T+i8Z2AhxE7dHYMw==", "XPWCG");
        I.lIllIlllllII[I.lIllIlllllIl[1]] = I.lllIlIlIIIIlll("a5biJ1witI9eSU3JZ5ml0Q==", "EcBzH");
        I.lIllIlllllII[I.lIllIlllllIl[3]] = I.lllIlIlIIIlIII("IiESAw==", "rHqhw");
        I.lIllIlllllII[I.lIllIlllllIl[4]] = I.lllIlIlIIIlIII("FBcBHA==", "Svuyj");
        I.lIllIlllllII[I.lIllIlllllIl[5]] = I.lllIlIlIIIIllI("gdxsDYLYUGbxnk0JiEMI/g==", "gWPqA");
    }
        ...
        TileObject lllllllllllllllIlIlllIIllIlIllII = TileObjects.getNearest(tileObject -> {
            ...
            if (I.lllIlIlIIIlIll(tileObject.getName().equals(lIllIlllllII[lIllIlllllIl[4]]) ? 1 : 0)) {
                ...
                if (I.lllIlIlIIIlIll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((100 + 200 - 84 + 4 ^ 2 + 118 - 23 + 92) & (87 + 141 - 179 + 152 ^ 132 + 127 - 220 + 129 ^ -" ".length())) != 0;
                }
            }
            n2 = lIllIlllllIl[0];
            return n2 != 0;
