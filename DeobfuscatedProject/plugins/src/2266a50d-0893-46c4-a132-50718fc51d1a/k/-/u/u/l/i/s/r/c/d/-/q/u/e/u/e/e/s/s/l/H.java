...
extends Task {
    ...
    public boolean run() {
        ...
        TileObject lllllllllllllllIlIlllIlIIIllllII = TileObjects.getNearest(tileObject -> {
            ...
            if (H.lllIlIlIIIIIlI(tileObject.getName().equals(lIllIlllIIIl[lIllIllllIII[2]]) ? 1 : 0)) {
                ...
                if (H.lllIlIlIIIIIlI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0xFA ^ 0x89 ^ (0xDF ^ 0xAA)) & (6 ^ 0x1E ^ (0x53 ^ 0x4D) ^ -" ".length())) != 0;
                }
            }
            n2 = lIllIllllIII[1];
            return n2 != 0;
        ...
        NPC lllllllllllllllIlIlllIlIIIlllIll = NPCs.getNearest(nPC -> {
            ...
            if (H.lllIlIlIIIIlII(nPC.getId(), e.I) && H.lllIlIlIIIIIIl(nPC.getGraphic(), lIllIllllIII[3])) {
                n2 = lIllIllllIII[2];
                "".length();
                if (((3 ^ 0x7F ^ (0x33 ^ 0x44)) & (38 + 60 - 89 + 140 ^ 37 + 11 - 43 + 153 ^ -" ".length())) < -" ".length()) {
                    return ((0xB8 ^ 0xAD ^ (0x6E ^ 0x30)) & ("   ".length() ^ (0x56 ^ 0x1E) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIllIllllIII[1];
            }
    ...
    private static void lllIlIIllIlIll() {
        ...
        H.lIllIlllIIIl[H.lIllIllllIII[1]] = H.lllIlIIllIlIII("gCn2xHE9JcVx3EXGl5hzXN8HQk7HhmGa", "SKuak");
        H.lIllIlllIIIl[H.lIllIllllIII[2]] = H.lllIlIIllIlIIl("ISYDAg==", "fGwgH");
        H.lIllIlllIIIl[H.lIllIllllIII[0]] = H.lllIlIIllIlIlI("Oi02o88sl4y0nBBTU/Unng==", "eAkmU");
    }
    ...
    private static void lllIlIIllllllI() {
        ...
        H.lIllIllllIII[0] = "  ".length();
        H.lIllIllllIII[1] = (0xD3 ^ 0xB3) & ~(0x35 ^ 0x55);
        H.lIllIllllIII[2] = " ".length();
        H.lIllIllllIII[3] = -" ".length();
        H.lIllIllllIII[4] = "   ".length();
