...
extends Task {
    ...
    private static void lllIlIIIIIIIIl() {
        ...
        R.lIllIlIlIlll[1] = "  ".length();
        R.lIllIlIlIlll[2] = " ".length();
        R.lIllIlIlIlll[3] = 6 ^ 0x3B ^ (0xB4 ^ 0x8F);
        R.lIllIlIlIlll[4] = "   ".length();
    ...
    private static void lllIlIIIIIIIII() {
        ...
        R.lIllIlIlIllI[R.lIllIlIlIlll[0]] = R.lllIIlllllllIl("GDgZJAhrKhQpBA==", "KYuEp");
        R.lIllIlIlIllI[R.lIllIlIlIlll[2]] = R.lllIIlllllllIl("Fis/Bg==", "PBSjd");
        R.lIllIlIlIllI[R.lIllIlIlIlll[1]] = R.lllIIlllllllIl("NiIeAg==", "pKrnI");
        R.lIllIlIlIllI[R.lIllIlIlIlll[4]] = R.lllIIllllllllI("urrJ98pq+g/9HtdbscqJTHtejtjg3jmE", "ZnzHh");
        R.lIllIlIlIllI[R.lIllIlIlIlll[5]] = R.lllIIlllllllIl("FwUyAQ==", "PdFdP");
        R.lIllIlIlIllI[R.lIllIlIlIlll[6]] = R.lllIIlllllllll("dHOEYDCQi2kuprQob4dulg==", "SWxCd");
    }
        ...
        TileObject tileObject2 = TileObjects.getNearest(tileObject -> {
            ...
            if (R.lllIlIIIIIIllI(tileObject.getName().equals(lIllIlIlIllI[lIllIlIlIlll[5]]) ? 1 : 0)) {
                ...
                if (R.lllIlIIIIIIllI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x75 ^ 0x70 ^ (0xA4 ^ 0x9A)) & (0xCA ^ 0x94 ^ (0xC8 ^ 0xAD) ^ -" ".length())) != 0;
                }
            }
            n2 = lIllIlIlIlll[0];
            return n2 != 0;
