...
extends Task {
    ...
    private static void llIIIllIlllllll() {
        ...
        b.lIllIIlllIllI[0] = (0x24 ^ 0x72 ^ "  ".length()) & (0x5F ^ 0x28 ^ (0x28 ^ 0xB) ^ -" ".length());
        b.lIllIIlllIllI[1] = " ".length();
    ...
    private static void llIIIllIlllllII() {
        ...
        b.lIllIIlllIlII[b.lIllIIlllIllI[0]] = b.llIIIllIllllIll("GwY/CB07ES4=", "ZeKak");
    }
