...
extends Task {
    ...
    private static void llIIIllIlllIIll() {
        ...
        e.lIllIIlllIIIl[0] = "   ".length() & ~"   ".length();
        e.lIllIIlllIIIl[1] = " ".length();
    ...
    private boolean r() {
        ...
        if (e.llIIIllIlllIlII(Inventory.isFull() ? 1 : 0)) {
            ...
            if (e.llIIIllIlllIlII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                n = lIllIIlllIIIl[1];
                "".length();
                if (((67 + 139 - 116 + 56 ^ 97 + 2 - 45 + 128) & (0x89 ^ 0xB1 ^ (0xDF ^ 0xC3) ^ -" ".length())) < (171 + 31 - 67 + 64 ^ 19 + 181 - 42 + 37)) return n != 0;
                return ((195 + 1 - 100 + 135 ^ 60 + 53 - -32 + 28) & (141 + 142 - 95 + 13 ^ 92 + 122 - 189 + 106 ^ -" ".length())) != 0;
            }
        }
        n = lIllIIlllIIIl[0];
        return n != 0;
    ...
    private TileObject t() {
        return TileObjects.getNearest(tileObject -> {
            ...
            if (e.llIIIllIlllIlll(tileObject.getWorldLocation().distanceTo(Players.getLocal().getWorldLocation()), lIllIIlllIIIl[3]) && e.llIIIllIllllIII(tileObject.getId(), lIllIIlllIIIl[4])) {
                n = lIllIIlllIIIl[1];
                "".length();
                if (((77 + 42 - 109 + 137 ^ 107 + 119 - 172 + 96) & (124 + 7 - 24 + 29 ^ 107 + 8 - -18 + 8 ^ -" ".length())) != 0) {
                    return ((0xB4 ^ 0xBD ^ (0xEA ^ 0xC7)) & (0xD8 ^ 0x9E ^ (0xC ^ 0x6E) ^ -" ".length())) != 0;
                }
            } else {
                n = lIllIIlllIIIl[0];
            }
    ...
    private static void llIIIllIllIlllI() {
        ...
        e.lIllIIllIlllI[e.lIllIIlllIIIl[0]] = e.llIIIllIllIllIl("BGzY4e5BgRrX8mF8/ysB2g==", "rChcZ");
    }
