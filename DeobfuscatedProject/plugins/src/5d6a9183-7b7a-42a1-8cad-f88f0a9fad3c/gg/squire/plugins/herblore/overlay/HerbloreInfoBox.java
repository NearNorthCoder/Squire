...
extends OverlayPanel {
    ...
    private static void lIIIlIlllIlIIlI() {
        ...
        HerbloreInfoBox.lllIlIIIllII[1] = (89 + 71 - 71 + 58 ^ 97 + 77 - 149 + 113) & (127 + 154 - 270 + 150 ^ 64 + 145 - 138 + 113 ^ -" ".length());
        HerbloreInfoBox.lllIlIIIllII[2] = " ".length();
        HerbloreInfoBox.lllIlIIIllII[3] = "  ".length();
        HerbloreInfoBox.lllIlIIIllII[4] = 176 + 140 - 137 + 14;
        HerbloreInfoBox.lllIlIIIllII[5] = 0xAC ^ 0xB8;
        HerbloreInfoBox.lllIlIIIllII[6] = "   ".length();
    }
    ...
    private static void lIIIlIlllIlIIIl() {
        ...
        HerbloreInfoBox.lllIlIIIlIll[HerbloreInfoBox.lllIlIIIllII[1]] = HerbloreInfoBox.lIIIlIlllIlIIII("PSs5LQULegQhBQw2IzYS", "nZLDw");
        HerbloreInfoBox.lllIlIIIlIll[HerbloreInfoBox.lllIlIIIllII[2]] = HerbloreInfoBox.lIIIlIlllIlIIII("Ig0dBhwdHUlS", "pxsru");
        HerbloreInfoBox.lllIlIIIlIll[HerbloreInfoBox.lllIlIIIllII[3]] = HerbloreInfoBox.lIIIlIlllIlIIII("ATsfOVJ1", "UZlRh");
    }

    private static String lIIIlIlllIlIIII(String lllllllllllllllIIllIIlIIIIllIIlI, String lllllllllllllllIIllIIlIIIIlIllII) {
        lllllllllllllllIIllIIlIIIIllIIlI = new String(Base64.getDecoder().decode(lllllllllllllllIIllIIlIIIIllIIlI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIllIIlIIIIllIIII = new StringBuilder();
        char[] lllllllllllllllIIllIIlIIIIlIllll = lllllllllllllllIIllIIlIIIIlIllII.toCharArray();
        int lllllllllllllllIIllIIlIIIIlIlllI = lllIlIIIllII[1];
        char[] lllllllllllllllIIllIIlIIIIlIlIII = lllllllllllllllIIllIIlIIIIllIIlI.toCharArray();
        int lllllllllllllllIIllIIlIIIIlIIlll = lllllllllllllllIIllIIlIIIIlIlIII.length;
        int lllllllllllllllIIllIIlIIIIlIIllI = lllIlIIIllII[1];
        while (HerbloreInfoBox.lIIIlIlllIlIlIl(lllllllllllllllIIllIIlIIIIlIIllI, lllllllllllllllIIllIIlIIIIlIIlll)) {
            char lllllllllllllllIIllIIlIIIIllIIll = lllllllllllllllIIllIIlIIIIlIlIII[lllllllllllllllIIllIIlIIIIlIIllI];
            lllllllllllllllIIllIIlIIIIllIIII.append((char)(lllllllllllllllIIllIIlIIIIllIIll ^ lllllllllllllllIIllIIlIIIIlIllll[lllllllllllllllIIllIIlIIIIlIlllI % lllllllllllllllIIllIIlIIIIlIllll.length]));
            "".length();
            ++lllllllllllllllIIllIIlIIIIlIlllI;
            ++lllllllllllllllIIllIIlIIIIlIIllI;
            "".length();
