...
public class k {
    ...
    public void a(AnimationChanged animationChanged) {
        void var3_3;
        void llllllllllllllllIIlIlIlIIlIlIIIl;
        Actor actor = animationChanged.getActor();
        if (k.lIlIlIlllIllII(actor instanceof Player)) {
            return;
        }
        b llllllllllllllllIIlIlIlIIlIlIIII = b.a((NPC)llllllllllllllllIIlIlIlIIlIlIIIl);
        if (k.lIlIlIlllIllIl((Object)llllllllllllllllIIlIlIlIIlIlIIII)) {
            return;
        }
        if (k.lIlIlIlllIlllI(llllllllllllllllIIlIlIlIIlIlIIIl.getAnimation(), llllllllllllllllIIlIlIlIIlIlIIII.g())) {
            return;
        }
