...
extends Task {
    ...
    private static void lIlIlIllllIlIl() {
        ...
        w.llIllllIIII[w.llIllllIIlI[0]] = w.lIlIlIllllIIlI("rHWurwTl9ts=", "xistm");
        w.llIllllIIII[w.llIllllIIlI[3]] = w.lIlIlIllllIIll("Hj4HPkY7Jw==", "NWdUk");
        w.llIllllIIII[w.llIllllIIlI[9]] = w.lIlIlIllllIIll("Pz0kQzEc", "lXPnD");
        w.llIllllIIII[w.llIllllIIlI[7]] = w.lIlIlIllllIlII("ARLxZRysWGs=", "VixcT");
    }
