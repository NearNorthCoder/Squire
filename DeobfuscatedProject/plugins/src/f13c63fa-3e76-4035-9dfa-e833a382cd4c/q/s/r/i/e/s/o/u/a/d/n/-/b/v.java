...
extends Task {
    ...
    private static void lIlIllIlllIllI() {
        ...
        v.lllIIIlIlIl[v.lllIIIlIlll[0]] = v.lIlIllIlllIlII("/XTSi5lXpsg=", "ocsiN");
        v.lllIIIlIlIl[v.lllIIIlIlll[2]] = v.lIlIllIlllIlIl("MYsEc3ecZVQ=", "hvNvw");
        v.lllIIIlIlIl[v.lllIIIlIlll[4]] = v.lIlIllIlllIlIl("n21Nr7stYlo=", "XXBKR");
        v.lllIIIlIlIl[v.lllIIIlIlll[5]] = v.lIlIllIlllIlIl("UGqSRaxk+Wk=", "uhQMx");
        v.lllIIIlIlIl[v.lllIIIlIlll[7]] = v.lIlIllIlllIlIl("wTqZoo5C5/E=", "MNrZa");
    }
    ...
    private static void lIlIllIllllIIl() {
        ...
        v.lllIIIlIlll[0] = (0x78 ^ 0x37 ^ (0x67 ^ 0xD)) & (0x3E ^ 0x15 ^ (0x5B ^ 0x55) ^ -" ".length());
        v.lllIIIlIlll[1] = 0xFFFFFFFF & Integer.MAX_VALUE;
        v.lllIIIlIlll[2] = " ".length();
        v.lllIIIlIlll[3] = 0x87 ^ 0xBE ^ (0x4D ^ 0x60);
        v.lllIIIlIlll[4] = "  ".length();
        v.lllIIIlIlll[5] = "   ".length();
