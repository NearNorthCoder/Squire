...
extends Task {
    ...
    private static void lIlIlIllllIIIl() {
        ...
        t.llIlllIllIl[t.llIllllIIIl[0]] = t.lIlIlIlllIlIlI("Ehr8XXsvkIw=", "BRYlR");
        t.llIlllIllIl[t.llIllllIIIl[2]] = t.lIlIlIllllIIII("FCQFNDg=", "dAdWP");
    }
    ...
    private static void lIlIlIllllIllI() {
        ...
        t.llIllllIIIl[2] = " ".length();
        t.llIllllIIIl[3] = "  ".length();
    }
