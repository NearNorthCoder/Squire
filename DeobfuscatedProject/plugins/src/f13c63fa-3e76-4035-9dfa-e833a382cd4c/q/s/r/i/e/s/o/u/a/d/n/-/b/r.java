...
extends Task {
    ...
    private static void lIlIlIllIllIll() {
        ...
        r.llIlllIlIll[0] = -" ".length();
        r.llIlllIlIll[1] = " ".length();
        r.llIlllIlIll[2] = (106 + 47 - 122 + 162 ^ 73 + 8 - -35 + 38) & (89 + 161 - 90 + 58 ^ 11 + 48 - 43 + 113 ^ -" ".length());
        r.llIlllIlIll[3] = "   ".length();
        r.llIlllIlIll[4] = 0x93 ^ 0x99 ^ (0x69 ^ 0x67);
        r.llIlllIlIll[5] = 0x52 ^ 0x55;
        r.llIlllIlIll[6] = -(0xFFFFAFEB & 0x7E56) & (0xFFFFEFFB & 0x3FEF);
        r.llIlllIlIll[7] = "  ".length();
    }
    ...
    private static void lIlIlIllIllIII() {
        ...
        r.llIlllIlIIl[r.llIlllIlIll[2]] = r.lIlIlIllIlIllI("tTCt4x/sjpm+65U+kM6SZWRjnKQrLtH8", "GoIhm");
        r.llIlllIlIIl[r.llIlllIlIll[1]] = r.lIlIlIllIlIllI("VY44RvMvcuA=", "MUkeO");
        r.llIlllIlIIl[r.llIlllIlIll[7]] = r.lIlIlIllIlIlll("Lg0eLTsIBFAPOwg=", "ihpHI");
    }
}
