...
extends Task {
    ...
    private static void lIlIlllIlIIIIl() {
        ...
        l.lllIIIlllll[l.lllIIlIIIII[1]] = l.lIlIlllIIllllI("rKRhgHfVIIk=", "DhYPk");
        l.lllIIIlllll[l.lllIIlIIIII[0]] = l.lIlIlllIIllllI("pQ3oKnGBhm7Da5q2ZQBUmQ==", "oKaOh");
        l.lllIIIlllll[l.lllIIlIIIII[5]] = l.lIlIlllIIlllll("3HkGMS3TOmMZYLDJRYCLfw==", "kFRjI");
        l.lllIIIlllll[l.lllIIlIIIII[7]] = l.lIlIlllIIllllI("lX1xOJ34kCQ=", "YUgTp");
        l.lllIIIlllll[l.lllIIlIIIII[8]] = l.lIlIlllIlIIIII("GjQlHgQRKC9JGh09LhpUDDdqCxFYOyIIBh89Lg==", "xXJit");
        l.lllIIIlllll[l.lllIIlIIIII[9]] = l.lIlIlllIIllllI("DAoDo6qFF24=", "Dfiaq");
        l.lllIIIlllll[l.lllIIlIIIII[10]] = l.lIlIlllIlIIIII("BCwMHgY5OQ==", "WXmso");
    }
    ...
    private void K() {
        ...
        if (l.lIlIlllIlIIlII(llllllllllllllllIIlIIlIlllIllIlI.J.altarTeleport() ? 1 : 0)) {
            ...
            "".length();
            if (((0xF0 ^ 0x95 ^ (0x7D ^ 0x57)) & (21 + 149 - 135 + 213 ^ 150 + 44 - 164 + 153 ^ -" ".length())) <= -" ".length()) {
                return;
            }
        } else {
            llllllllllllllllIIlIIlIlllIllIlI.L();
        ...
        if (l.lIlIlllIlIIIll(Inventory.contains(item -> item.hasAction(lllIIIlllll[lllIIlIIIII[9]]::equals)) ? 1 : 0)) {
            if (l.lIlIlllIlIIlII(llllllllllllllllIIlIIlIlllIlllIl.I.s() ? 1 : 0) && l.lIlIlllIlIIlIl(Combat.getCurrentHealth(), lllIIlIIIII[2])) {
                ...
                if ((0x65 ^ 0x28 ^ (0xD2 ^ 0x9A)) <= 0) {
                    return ((84 + 22 - -2 + 40 ^ 73 + 153 - 187 + 133) & (0x32 ^ 0x2B ^ (0x29 ^ 8) ^ -" ".length())) != 0;
                }
