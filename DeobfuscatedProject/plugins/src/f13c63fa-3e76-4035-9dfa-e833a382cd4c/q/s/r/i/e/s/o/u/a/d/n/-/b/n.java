...
extends Task {
    ...
    private static void lIlIllIlIlIlll() {
        ...
        n.lllIIIIllIl[n.lllIIIIlllI[0]] = n.lIlIllIlIlIlIl("IDcIGic=", "dEatL");
        n.lllIIIIllIl[n.lllIIIIlllI[3]] = n.lIlIllIlIlIllI("D616Rsr/ryk=", "xXYze");
    }
    ...
    private static void lIlIllIlIllIII() {
        ...
        n.lllIIIIlllI[0] = (0x5D ^ 0x3C ^ (0xB4 ^ 0x86)) & (129 + 69 - 125 + 166 ^ 138 + 135 - 135 + 50 ^ -" ".length());
        n.lllIIIIlllI[1] = 0x88 ^ 0x96;
        n.lllIIIIlllI[2] = "   ".length();
        n.lllIIIIlllI[3] = " ".length();
        n.lllIIIIlllI[4] = "  ".length();
    }
