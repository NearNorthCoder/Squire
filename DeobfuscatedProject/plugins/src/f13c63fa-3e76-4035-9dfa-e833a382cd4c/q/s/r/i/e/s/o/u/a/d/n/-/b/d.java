...
public class d {
    ...
    public static WorldPoint a(RegionPoint regionPoint) {
        ...
        return collection.stream().filter(worldPoint -> {
            ...
            if (d.lIlIlllIIIIIll(worldPoint.getPlane(), client.getPlane())) {
                bl = lllIIIllIIl[4];
                "".length();
                if (((0x4F ^ 0x7B ^ (9 ^ 0x2D)) & (0x12 ^ 0x55 ^ (0xD5 ^ 0x82) ^ -" ".length())) != 0) {
                    return ((0x6C ^ 0x19 ^ (0xFF ^ 0x84)) & (142 + 167 - 240 + 121 ^ 123 + 113 - 69 + 9 ^ -" ".length())) != 0;
                }
            } else {
                bl = lllIIIllIIl[2];
            }
    ...
    public RegionPoint m() {
        void llllllllllllllllIIlIIllIlIIIlllI;
        Player player = Players.getLocal();
        WorldPoint worldPoint = player.getWorldLocation();
        WorldPoint llllllllllllllllIIlIIllIlIIIllIl = m.iterator();
        while (d.lIlIlllIIIIIlI(llllllllllllllllIIlIIllIlIIIllIl.hasNext() ? 1 : 0)) {
            RegionPoint llllllllllllllllIIlIIllIlIIIllII = llllllllllllllllIIlIIllIlIIIllIl.next();
            WorldPoint llllllllllllllllIIlIIllIlIIIlIll = d.a(llllllllllllllllIIlIIllIlIIIllII);
            if (d.lIlIlllIIIIIlI(llllllllllllllllIIlIIllIlIIIlllI.equals((Object)llllllllllllllllIIlIIllIlIIIlIll) ? 1 : 0)) {
                return llllllllllllllllIIlIIllIlIIIllII;
            }
            "".length();
            if (" ".length() <= (0x43 ^ 0x47)) continue;
            return null;
        }
        llllllllllllllllIIlIIllIlIIIllIl = d.a(k);
        if (d.lIlIlllIIIIIlI(llllllllllllllllIIlIIllIlIIIlllI.equals((Object)llllllllllllllllIIlIIllIlIIIllIl) ? 1 : 0)) {
            return k;
        }
        return null;
    }
    ...
    private static void lIlIlllIIIIIIl() {
        ...
        d.lllIIIllIIl[1] = "  ".length();
        d.lllIIIllIIl[2] = (8 + 17 - -53 + 83 ^ 125 + 51 - 131 + 126) & (0x2F ^ 0x7B ^ (0x64 ^ 0x3A) ^ -" ".length());
        d.lllIIIllIIl[3] = -" ".length();
        d.lllIIIllIIl[4] = " ".length();
    ...
    public RegionPoint k() {
        void var2_2;
        d llllllllllllllllIIlIIllIlIlIIlIl;
        if (d.lIlIlllIIIIIlI(d.j() ? 1 : 0)) {
            return m.get(lllIIIllIIl[2]);
        }
        RegionPoint llllllllllllllllIIlIIllIlIlIIlII = llllllllllllllllIIlIIllIlIlIIlIl.m();
        int llllllllllllllllIIlIIllIlIlIIIll = m.indexOf(llllllllllllllllIIlIIllIlIlIIlII);
        if (d.lIlIlllIIIIIll(llllllllllllllllIIlIIllIlIlIIIll, lllIIIllIIl[3])) {
            return null;
        }
    ...
    public WorldPoint l() {
        ...
        Iterator<RegionPoint> llllllllllllllllIIlIIllIlIIllIll = m.iterator();
        while (d.lIlIlllIIIIIlI(llllllllllllllllIIlIIllIlIIllIll.hasNext() ? 1 : 0)) {
            void llllllllllllllllIIlIIllIlIIlllII;
            WorldPoint llllllllllllllllIIlIIllIlIIlllIl;
            RegionPoint llllllllllllllllIIlIIllIlIIllIlI = llllllllllllllllIIlIIllIlIIllIll.next();
            WorldPoint llllllllllllllllIIlIIllIlIIllIIl = d.a(llllllllllllllllIIlIIllIlIIllIlI);
            if (d.lIlIlllIIIIlIl(llllllllllllllllIIlIIllIlIIllIIl)) {
                "".length();
                if (" ".length() > 0) continue;
                return null;
            }
            if (d.lIlIlllIIIIlIl(llllllllllllllllIIlIIllIlIIlllIl)) {
                llllllllllllllllIIlIIllIlIIlllIl = llllllllllllllllIIlIIllIlIIllIIl;
                "".length();
                if (-" ".length() < "   ".length()) continue;
                return null;
            }
            if (d.lIlIlllIIIIllI(d.lIlIlllIIIIlII(llllllllllllllllIIlIIllIlIIllIIl.distanceTo2DHypotenuse((WorldPoint)llllllllllllllllIIlIIllIlIIlllII), llllllllllllllllIIlIIllIlIIlllIl.distanceTo2DHypotenuse((WorldPoint)llllllllllllllllIIlIIllIlIIlllII)))) {
                llllllllllllllllIIlIIllIlIIlllIl = llllllllllllllllIIlIIllIlIIllIIl;
            }
            "".length();
