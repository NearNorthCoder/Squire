...
extends Task {
    ...
    public boolean run() {
        ...
        Item llllllllllllllllIIlIlIIlllllIlIl = Inventory.getFirst(item -> {
            ...
            if (o.lIlIllIIIIlIII(item.getName().equals(llIllllIIll[llIllllIlII[3]]) ? 1 : 0) && o.lIlIllIIIIIlll(item.hasAction(llIllllIIll[llIllllIlII[4]]::equals) ? 1 : 0)) {
                n2 = llIllllIlII[2];
                "".length();
                if ((89 + 46 - 50 + 89 ^ 166 + 6 - 111 + 109) <= -" ".length()) {
                    return ((101 + 218 - 248 + 159 ^ 6 + 24 - -62 + 81) & (0x43 ^ 0 ^ (0xBB ^ 0xB3) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIllllIlII[0];
            }
    ...
    private static void lIlIllIIIIIllI() {
        ...
        o.llIllllIlII[2] = " ".length();
        o.llIllllIlII[3] = "  ".length();
        o.llIllllIlII[4] = "   ".length();
    ...
    private static void lIlIllIIIIIlIl() {
        ...
        o.llIllllIIll[o.llIllllIlII[0]] = o.lIlIllIIIIIIll("zXs3cMuCDKU=", "ADETI");
        o.llIllllIIll[o.llIllllIlII[2]] = o.lIlIllIIIIIlII("t+r4NvyuKEA=", "nVieJ");
        o.llIllllIIll[o.llIllllIlII[3]] = o.lIlIllIIIIIlII("dqIMhxVrhro=", "YlXTO");
        o.llIllllIIll[o.llIllllIlII[4]] = o.lIlIllIIIIIIll("r3WN/OdCAeY=", "YmQgw");
    }
