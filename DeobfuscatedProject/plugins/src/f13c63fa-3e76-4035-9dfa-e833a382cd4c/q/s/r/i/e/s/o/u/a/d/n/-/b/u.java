...
extends Task {
    ...
    private static void lIlIllIIllIIll() {
        ...
        u.lllIIIIIlIl[0] = (132 + 38 - 22 + 31 ^ 90 + 133 - 162 + 79) & (64 + 10 - 32 + 103 ^ 103 + 60 - 67 + 78 ^ -" ".length());
        u.lllIIIIIlIl[1] = " ".length();
    }
    ...
    public boolean run() {
        void var1_1;
        void var2_2;
        u llllllllllllllllIIlIlIIIlIIllIlI;
        if (u.lIlIllIIllIlII(this.am.alch() ? 1 : 0)) {
            return lllIIIIIlIl[0];
        }
        if (!u.lIlIllIIllIlIl(llllllllllllllllIIlIlIIIlIIllIlI.al.t() ? 1 : 0) || !u.lIlIllIIllIlII(llllllllllllllllIIlIlIIIlIIllIlI.al.s() ? 1 : 0) || u.lIlIllIIllIlIl(llllllllllllllllIIlIlIIIlIIllIlI.al.v() ? 1 : 0)) {
            return lllIIIIIlIl[0];
        }
        Item llllllllllllllllIIlIlIIIlIIllIIl = Inventory.getFirst(item -> i.x.contains(item.getName()));
        if (u.lIlIllIIllIllI(llllllllllllllllIIlIlIIIlIIllIIl)) {
            return lllIIIIIlIl[0];
        }
        SpellBook.Standard llllllllllllllllIIlIlIIIlIIllIII = SpellBook.Standard.HIGH_LEVEL_ALCHEMY;
        if (u.lIlIllIIllIlII(llllllllllllllllIIlIlIIIlIIllIII.canCast() ? 1 : 0)) {
            return lllIIIIIlIl[0];
        }
