...
extends h {
    ...
    private static void llllllIlllIlII() {
        ...
        x.llIIllIllllI[0] = "   ".length();
        x.llIIllIllllI[1] = (0x96 ^ 0x9B) & ~(0x33 ^ 0x3E);
        x.llIIllIllllI[2] = " ".length();
        x.llIIllIllllI[3] = "  ".length();
    ...
    private static void llllllIlllIIll() {
        ...
        x.llIIllIlllIl[x.llIIllIllllI[1]] = x.llllllIlllIIIl("9J2R11gtamQ=", "kcoMo");
        x.llIIllIlllIl[x.llIIllIllllI[2]] = x.llllllIlllIIIl("CySY7zeNX3s=", "fbYcC");
        x.llIIllIlllIl[x.llIIllIllllI[3]] = x.llllllIlllIIlI("AYim1p/Zz+c=", "jnVdG");
    }
    ...
    protected boolean ak() {
        ...
        TileObject lllllllllllllllIlIIllIIIlIllIlIl = TileObjects.getNearest(tileObject -> {
            ...
            if (x.llllllIlllIlIl(tileObject.getName().equals(llIIllIlllIl[llIIllIllllI[2]]) ? 1 : 0) && x.llllllIlllIlIl(tileObject.hasAction(llIIllIlllIl[llIIllIllllI[3]]::equals) ? 1 : 0)) {
                ...
                "".length();
                if (null != null) {
                    return ((138 + 178 - 130 + 8 ^ 45 + 124 - 109 + 81) & (128 + 223 - 345 + 228 ^ 51 + 66 - -44 + 4 ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIIllIllllI[1];
            }
