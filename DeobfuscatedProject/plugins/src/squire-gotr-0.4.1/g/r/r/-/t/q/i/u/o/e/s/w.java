...
extends h {
    ...
    private static void lllllllllIIlII() {
        ...
        w.llIIlllllIlI[0] = " ".length();
        w.llIIlllllIlI[1] = (0xF6 ^ 0x98 ^ (0x5E ^ 0x3F)) & (160 + 83 - 145 + 78 ^ 164 + 180 - 220 + 67 ^ -" ".length());
        w.llIIlllllIlI[2] = "   ".length();
        w.llIIlllllIlI[3] = 8 + 0 - -68 + 84 ^ 90 + 84 - 79 + 75;
        w.llIIlllllIlI[4] = 0x26 ^ 0x51 ^ (0xF6 ^ 0x9F);
        w.llIIlllllIlI[5] = "  ".length();
    }
    ...
    private static void lllllllllIIIIl() {
        ...
        w.llIIlllllIIl[w.llIIlllllIlI[1]] = w.lllllllllIIIII("AhYDHCA=", "GxwyR");
    }
