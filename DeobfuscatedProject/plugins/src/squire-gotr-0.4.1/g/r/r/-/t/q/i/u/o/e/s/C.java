...
extends h {
    ...
    private static void llllllIIlIllIl() {
        ...
        C.llIIllIIllll[C.llIIllIlIIII[0]] = C.llllllIIlIlIll("vIu++F8OdUU=", "WECtL");
        C.llIIllIIllll[C.llIIllIlIIII[1]] = C.llllllIIlIllII("maDmPFBOrnryJpuP6itb4SrDgZn3JY0E", "vJpXh");
        C.llIIllIIllll[C.llIIllIlIIII[2]] = C.llllllIIlIllII("qSU0tz5Xw5k5kHTd3/dGcwl1LTvA84kmeoL4odiOSBw=", "JFLqc");
        C.llIIllIIllll[C.llIIllIlIIII[6]] = C.llllllIIlIllII("cI2100uU21YKsl2JwqGI11ISal2gJp0p", "GdJgO");
    }
    ...
    private boolean am() {
        ...
        if (C.llllllIIllIIII(Dialog.isOpen() ? 1 : 0) && C.llllllIIlIllll(lllllllllllllllIlIIllIlIllllIlll.bm)) {
            ...
            if (((115 + 99 - 158 + 119 ^ 32 + 47 - 35 + 139) & (58 + 52 - 63 + 113 ^ 28 + 58 - -75 + 23 ^ -" ".length())) != 0) {
                return ((162 + 31 - 26 + 18 ^ 150 + 171 - 284 + 140) & (0x64 ^ 0x2C ^ (0xC2 ^ 0x82) ^ -" ".length())) != 0;
            }
