...
extends Enum<c> {
    ...
    private static void lIIIIIIIIlIIlIl() {
        ...
        c.llIlIIIIlIIl[1] = " ".length();
        c.llIlIIIIlIIl[2] = "  ".length();
        c.llIlIIIIlIIl[3] = "   ".length();
    ...
    private static void lIIIIIIIIlIIlII() {
        ...
        c.llIlIIIIIllI[c.llIlIIIIlIIl[0]] = c.lIIIIIIIIIllIlI("FxoAIgQXDR0lFQ==", "VYTkR");
        c.llIlIIIIIllI[c.llIlIIIIlIIl[1]] = c.lIIIIIIIIIllIll("wA9a3A4mz5z/j2ZtCuPdWA==", "XJbPf");
        c.llIlIIIIIllI[c.llIlIIIIlIIl[2]] = c.lIIIIIIIIIllIlI("BDonHD8A", "EysUi");
        c.llIlIIIIIllI[c.llIlIIIIlIIl[3]] = c.lIIIIIIIIIllIll("GoGiE1vkhojgsH2XhEoVgQ==", "RFMRv");
        c.llIlIIIIIllI[c.llIlIIIIlIIl[4]] = c.lIIIIIIIIIllIll("2+MSmt+st8U=", "jPzRB");
    }
}
