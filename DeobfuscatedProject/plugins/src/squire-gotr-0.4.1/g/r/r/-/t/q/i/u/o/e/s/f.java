...
extends Overlay {
    ...
    private void a(Graphics2D graphics2D, GameObject gameObject) {
        void var3_3;
        void lllllllllllllllIlIIlIlllIIIllIll;
        if (f.lllllllIlllllI(gameObject)) {
            return;
        }
        Shape lllllllllllllllIlIIlIlllIIIllIlI = lllllllllllllllIlIIlIlllIIIllIll.getConvexHull();
        if (f.lllllllIlllllI(lllllllllllllllIlIIlIlllIIIllIlI)) {
            return;
        }
    ...
    private static void lllllllIlllIll() {
        ...
        f.llIIllllIIII[0] = " ".length();
        f.llIIllllIIII[1] = (0x93 ^ 0x8D ^ (0xD3 ^ 0x8F)) & ("  ".length() ^ (0x59 ^ 0x19) ^ -" ".length());
