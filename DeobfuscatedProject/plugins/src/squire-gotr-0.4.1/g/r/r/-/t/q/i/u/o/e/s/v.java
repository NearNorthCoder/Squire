...
extends h {
    ...
    private static void lllllllIIlIllI() {
        ...
        v.llIIlllIIlll[0] = "  ".length();
        v.llIIlllIIlll[1] = (35 + 116 - 23 + 39 ^ 47 + 83 - 67 + 81) & (8 ^ 0x7B ^ (0x4E ^ 0xA) ^ -" ".length());
        v.llIIlllIIlll[2] = " ".length();
        v.llIIlllIIlll[3] = 87 + 107 - 98 + 47 ^ 55 + 31 - -14 + 59;
        v.llIIlllIIlll[4] = 0x22 ^ 0x77 ^ (0xE6 ^ 0x93);
        v.llIIlllIIlll[5] = "   ".length();
        v.llIIlllIIlll[6] = -" ".length();
        v.llIIlllIIlll[7] = -" ".length() & (0xFFFFFFFF & Integer.MAX_VALUE);
    ...
    private static void lllllllIIlIlIl() {
        ...
        v.llIIlllIIllI[v.llIIlllIIlll[1]] = v.lllllllIIlIIll("HzUzPCI4IiQpJDQ=", "PCVNA");
        v.llIIlllIIllI[v.llIIlllIIlll[2]] = v.lllllllIIlIIll("ISQiAg==", "vACis");
        v.llIIlllIIllI[v.llIIlllIIlll[0]] = v.lllllllIIlIIll("BSEyBjJ4LjYJOw==", "UMSeW");
        v.llIIlllIIllI[v.llIIlllIIlll[5]] = v.lllllllIIlIlII("yy8kuYBNnXbdgIN1Siuldg==", "ThxWT");
        v.llIIlllIIllI[v.llIIlllIIlll[8]] = v.lllllllIIlIIll("AxoYOA==", "motTM");
        v.llIIlllIIllI[v.llIIlllIIlll[9]] = v.lllllllIIlIlII("Hq1HWdBHEoE=", "IBICi");
    }
    ...
    static {
        ...
        be = (tileObject, tileObject2) -> {
            ...
            if (v.lllllllIIllIll(lllllllllllllllIlIIlIlllllIllIIl.getHealthRatio(), llIIlllIIlll[6])) {
                n2 = llIIlllIIlll[7];
                "".length();
                if (((0x6A ^ 0x4C ^ "   ".length()) & (0x4D ^ 0x71 ^ (0x64 ^ 0x7D) ^ -" ".length())) != 0) {
                    return ("   ".length() ^ (0x4B ^ 0x6A)) & (6 + 48 - -97 + 13 ^ 103 + 26 - 88 + 93 ^ -" ".length());
                }
            } else {
