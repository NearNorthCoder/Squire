...
implements W {
                    ...
                    block27: {
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    ...
                                    n4 = lIIlllIIl[1];
                                    "".length();
                                    if ((" ".length() ^ (0xA4 ^ 0xA0)) != 0) return n4 != 0;
                                    return ((0x2E ^ 0x4F ^ (0x7C ^ 0x11)) & (0x15 ^ 0x20 ^ (0xAE ^ 0x97) ^ -" ".length())) != 0;
                                }
                                n4 = lIIlllIIl[0];
                                return n4 != 0;
                            }
                        ...
                        if (l.lIIIIIlIIIlI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (l.lIIIIIlIIIlI(Inventory.contains((int[])nArray14) ? 1 : 0)) {
                                n3 = lIIlllIIl[1];
                                "".length();
                                if (" ".length() <= (0xD5 ^ 0xC0 ^ (0xA5 ^ 0xB4))) return n3 != 0;
                                return ((0xBD ^ 0xC3 ^ (0x6A ^ 0)) & (0xE0 ^ 0xBC ^ (0x27 ^ 0x6F) ^ -" ".length())) != 0;
                            }
                        }
                    }
                    n3 = lIIlllIIl[0];
    ...
    private static void lIIIIIlIIIII() {
        ...
        l.lIIllIlll[l.lIIlllIIl[0]] = l.lIIIIIIllIlI("LRYxDicIQyETLAIQ", "ocHgI");
        l.lIIllIlll[l.lIIlllIIl[1]] = l.lIIIIIIllIll("9CscE2cXzE3ZCODqdPEe5IpiF3Vj2Z1NFRr7owwr6PUTTydyK4KoXwPUhpbGBelvZrpCjO4zTzE=", "heaLa");
        l.lIIllIlll[l.lIIlllIIl[2]] = l.lIIIIIIllIlI("JSU9Pj0KMCI5PUswJHc4Ciog", "kDKWZ");
        l.lIIllIlll[l.lIIlllIIl[3]] = l.lIIIIIIlllII("Q0izk1NgYCL2sZYG380ffZTMmGkeeOy/", "HkpaU");
        l.lIIllIlll[l.lIIlllIIl[5]] = l.lIIIIIIlllII("9MIhl7Lby8trLXwxZUGa/1n3GCeTqnMMEz//rfI7QuNDycreKvAl6ffaibYQUh23", "VithT");
        l.lIIllIlll[l.lIIlllIIl[17]] = l.lIIIIIIllIll("nEX8Y+MibbTqvFyCBMh6zA==", "bKQpm");
        l.lIIllIlll[l.lIIlllIIl[24]] = l.lIIIIIIllIll("qP5xXT4va3RwAAM0JSBm0A==", "KhLSv");
        l.lIIllIlll[l.lIIlllIIl[26]] = l.lIIIIIIllIlI("FTA/OR44Nmw7FiQjIy4cdiUpIRI=", "VQLMw");
        l.lIIllIlll[l.lIIlllIIl[29]] = l.lIIIIIIlllII("APCirqR5U1y5+FY+4taIKYSGD20rOXhD", "vHZrx");
        l.lIIllIlll[l.lIIlllIIl[31]] = l.lIIIIIIllIll("FZfHWxmzhttlX4PhGb1DxYMnIJHi3TKP", "LqFQm");
        l.lIIllIlll[l.lIIlllIIl[32]] = l.lIIIIIIllIll("G1mDQvFODzM53RSDwZTn7jusY3VPDRAk", "oBNxJ");
        l.lIIllIlll[l.lIIlllIIl[33]] = l.lIIIIIIllIlI("ChsHHCElEA==", "KwdtH");
        l.lIIllIlll[l.lIIlllIIl[34]] = l.lIIIIIIlllII("7Y8tHkZzI8E=", "oaqxy");
        l.lIIllIlll[l.lIIlllIIl[36]] = l.lIIIIIIllIlI("AB8+BnE5H2gCPS4YaBAhIgQ=", "MpHcQ");
        l.lIIllIlll[l.lIIlllIIl[40]] = l.lIIIIIIllIlI("AhYAaTgjVxUmOz8=", "LwvIL");
        l.lIIllIlll[l.lIIlllIIl[41]] = l.lIIIIIIlllII("7v8foHnnuUw=", "Zaobg");
        l.lIIllIlll[l.lIIlllIIl[42]] = l.lIIIIIIlllII("rP8a9iDM1p4=", "maWYS");
        l.lIIllIlll[l.lIIlllIIl[43]] = l.lIIIIIIlllII("Da84tjbO+HQ=", "pcXkf");
        l.lIIllIlll[l.lIIlllIIl[45]] = l.lIIIIIIllIlI("NiYSNAkcOwgyShQ9ESY=", "wRfUj");
        l.lIIllIlll[l.lIIlllIIl[46]] = l.lIIIIIIllIll("vkLzIJgk4GA=", "rhvnh");
        l.lIIllIlll[l.lIIlllIIl[47]] = l.lIIIIIIlllII("1g/k+sef5OvCH2SSFnN7bg==", "gMoYI");
        l.lIIllIlll[l.lIIlllIIl[51]] = l.lIIIIIIlllII("74dmnV0uHkQbo25v7oQ460k0M9SVlDRI", "uVAjj");
        l.lIIllIlll[l.lIIlllIIl[52]] = l.lIIIIIIllIll("2ooL+5xNkIIgscLI0jg9tQ==", "bVAGN");
        l.lIIllIlll[l.lIIlllIIl[54]] = l.lIIIIIIllIll("imj47TQrKkE7hWYKQK7dlA==", "SrhgV");
        l.lIIllIlll[l.lIIlllIIl[55]] = l.lIIIIIIllIll("TNGwL1BjVBDk3CpI7Ca7Uw==", "ujkdd");
        l.lIIllIlll[l.lIIlllIIl[19]] = l.lIIIIIIllIll("qWV4B3ghZVhdYQBt5cr0eA==", "HJTZy");
        l.lIIllIlll[l.lIIlllIIl[50]] = l.lIIIIIIllIlI("JjIhJhhDACcgGQg2", "cSSRp");
        l.lIIllIlll[l.lIIlllIIl[56]] = l.lIIIIIIllIll("nq5uM+5u0Np5hLyYuLVX5A==", "eiwbq");
        l.lIIllIlll[l.lIIlllIIl[72]] = l.lIIIIIIllIll("un1xC5KbKiY9UbJO/UgwPg==", "SqLDk");
        l.lIIllIlll[l.lIIlllIIl[74]] = l.lIIIIIIllIll("S1+7A8/qzJAmQuVs2huzkQH/QBNQ8ksa", "dWRLp");
        l.lIIllIlll[l.lIIlllIIl[75]] = l.lIIIIIIllIlI("Ljw4", "mSORx");
    }
                    ...
                    if (l.lIIIIIlIIlll(Bank.getFirst((int[])nArray17).getQuantity(), lIIlllIIl[17])) {
                        ...
                        if (l.lIIIIIlIIIlI(Bank.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (l.lIIIIIlIIIlI(Bank.contains((int[])nArray19) ? 1 : 0)) {
                                ...
                                return ((0xE5 ^ 0x89 ^ (0x60 ^ 0x17)) & (6 + 13 - -10 + 154 ^ 7 + 74 - 53 + 144 ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
                                ...
                                if (l.lIIIIIlIIIll(Inventory.getCount((int[])nArray2), lIIlllIIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (l.lIIIIIlIIllI(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (-" ".length() >= 0) {
                                                return ((0xB6 ^ 0xC1 ^ (0x7C ^ 0x4C)) & (0xA2 ^ 0xC7 ^ (0xBB ^ 0x99) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIlllIIl[0];
                                        }
                                ...
                                if (l.lIIIIIlIIIll(Inventory.getCount((int[])nArray8), lIIlllIIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (l.lIIIIIlIIllI(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (-" ".length() > "  ".length()) {
                                                return ((31 + 192 - -3 + 4 ^ 85 + 91 - 92 + 50) & (0xE7 ^ 0x9C ^ (0x4D ^ 0x56) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIlllIIl[0];
                                        }
                                ...
                                if (l.lIIIIIlIIIll(Inventory.getCount((int[])nArray10), lIIlllIIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (l.lIIIIIlIIllI(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (-"   ".length() > 0) {
                                                return ((0x34 ^ 0x61 ^ (0x38 ^ 0x69)) & (9 + 27 - 23 + 150 ^ 69 + 121 - 66 + 43 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIlllIIl[0];
                                        }
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (l.lIIIIIlIIllI(Inventory.getCount((int[])nArray))) {
                                            ...
                                            if ((0x33 ^ 0x6C ^ (0xDE ^ 0x84)) <= 0) {
                                                return ((176 + 192 - 132 + 9 ^ 106 + 173 - 155 + 62) & (0 ^ 0x5B ^ (0x61 ^ 0x75) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIlllIIl[0];
                                        }
                        ...
                        if (l.lIIIIIlIIlIl(lIIIIIIIIIllllI) && l.lIIIIIlIIlIl(lIIIIIIIIIlllIl) && l.lIIIIIlIlIII(Players.getLocal().getAnimation(), lIIlllIIl[27])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (l.lIIIIIlIllIl(Skills.getExperience((Skill)Skill.MAGIC), lIIIIIIIIIlllII)) {
                                    bl = lIIlllIIl[1];
                                    "".length();
                                    if (((0x73 ^ 0x54 ^ (0x3F ^ 0x78)) & (41 + 138 - -73 + 1 ^ 33 + 77 - -6 + 41 ^ -" ".length())) != 0) {
                                        return ((85 + 67 - 33 + 24 ^ 92 + 68 - 61 + 63) & (0x76 ^ 0x62 ^ (0x9B ^ 0xA2) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIlllIIl[0];
                                }
        ...
        if (l.lIIIIIlIlIll(Players.getLocal().getInteracting())) {
            NPC lIIIIIIIIIllIIl = NPCs.getNearest(nPC -> {
                ...
                if (l.lIIIIIlIIIlI(nPC.getName().contains(lIIllIlll[lIIlllIIl[75]]) ? 1 : 0) && l.lIIIIIlIIlII(nPC.isDead() ? 1 : 0)) {
                    n2 = lIIlllIIl[1];
                    "".length();
                    if (((0x69 ^ 0x6E ^ " ".length()) & (0xF3 ^ 0x8B ^ (0x2A ^ 0x54) ^ -" ".length())) != 0) {
                        return ((0xC4 ^ 0xBD ^ (0x60 ^ 0x2C)) & (0x59 ^ 0x72 ^ (0x48 ^ 0x56) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIIlllIIl[0];
                }
    ...
    private static void lIIIIIlIIIIl() {
        ...
        l.lIIlllIIl[1] = " ".length();
        l.lIIlllIIl[2] = "  ".length();
        l.lIIlllIIl[3] = "   ".length();
        ...
        l.lIIlllIIl[26] = "   ".length() ^ (0xA9 ^ 0xAD);
        l.lIIlllIIl[27] = -" ".length();
        ...
        l.lIIlllIIl[75] = " ".length() ^ (0x35 ^ 0x2A);
    ...
    public int T() {
        ...
        if (((0xE7 ^ 0xBC ^ (0x68 ^ 0x1A)) & (125 + 185 - 284 + 163 ^ 12 + 61 - 71 + 146 ^ -" ".length())) == "  ".length()) {
            return (0xE1 ^ 0xC4 ^ (0x6F ^ 0x66)) & (0xCE ^ 0xBB ^ (0xD7 ^ 0x8E) ^ -" ".length());
        }
        return lIIlllIIl[67];
    }
}
