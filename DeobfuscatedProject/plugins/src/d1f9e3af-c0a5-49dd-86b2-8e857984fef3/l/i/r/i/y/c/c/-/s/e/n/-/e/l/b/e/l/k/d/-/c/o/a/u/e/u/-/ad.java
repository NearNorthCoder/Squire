...
implements W {
    ...
    private static void lIIllIllIllI() {
        ...
        ad.lIlllIIll[ad.lIlllIlII[0]] = ad.lIIllIllIIll("EiwQGCc3eQAFLD0q", "PYiqI");
        ad.lIlllIIll[ad.lIlllIlII[1]] = ad.lIIllIllIIll("BRM6DjErHzBHIDYDPQklYxMgAi8wVnQUNSoONw8rLR10BSMgEXQTLWMXNQArIFogFSMqFD0JJQ==", "CzTgB");
        ad.lIlllIIll[ad.lIlllIlII[2]] = ad.lIIllIllIlII("KQsBYbj9hJEuaQWD2M8sKg8TaIdPD7jG", "aYKEc");
        ad.lIlllIIll[ad.lIlllIlII[3]] = ad.lIIllIllIIll("IgAdFC8DDxRQIQsPGBktDQ==", "jaspC");
        ad.lIlllIIll[ad.lIlllIlII[6]] = ad.lIIllIllIIll("NQN3AzYHRjoLNxEPOQVkERMnEigLAyROZBERPhYnCg85BWQWCXcgETsvGSU=", "bfWbD");
        ad.lIlllIIll[ad.lIlllIlII[18]] = ad.lIIllIllIIll("AwcYawIiRg0kAT4=", "MfnKv");
        ad.lIlllIIll[ad.lIlllIlII[5]] = ad.lIIllIllIlII("YMzXfw9MrF1/jhV/bBwGNg==", "nrcCq");
        ad.lIlllIIll[ad.lIlllIlII[26]] = ad.lIIllIllIlII("hWUXBhoqDHv8npDJpGQd+mCrR4xdBWQI", "vZDgW");
        ad.lIlllIIll[ad.lIlllIlII[29]] = ad.lIIllIllIIll("GhkQJBs3H0M8BzQaGnAGPBQG", "YxcPr");
        ad.lIlllIIll[ad.lIlllIlII[31]] = ad.lIIllIllIlII("oOZ4XJE5bDr7SPkDNF/3qbgYeAgjiJvk", "Nyunc");
        ad.lIlllIIll[ad.lIlllIlII[32]] = ad.lIIllIllIlII("Uo68EQVbnSe+T6xiP2hPMY9SLQjHZ+wd", "bqoar");
        ad.lIlllIIll[ad.lIlllIlII[33]] = ad.lIIllIllIlIl("i7sI0B4JBqU=", "LBruo");
        ad.lIlllIIll[ad.lIlllIlII[36]] = ad.lIIllIllIIll("FA4sAi8=", "CgInK");
        ad.lIlllIIll[ad.lIlllIlII[38]] = ad.lIIllIllIlIl("ZUJnrKNu3gsf8tPyzOj051n1HQnsflyv", "OGiDa");
        ad.lIlllIIll[ad.lIlllIlII[42]] = ad.lIIllIllIlII("h9V9gszclL4SpISE6ogUfQ==", "jKRsL");
        ad.lIlllIIll[ad.lIlllIlII[43]] = ad.lIIllIllIlIl("wrpGB3YutNc8rdkXObhamQ==", "QgWvc");
        ad.lIlllIIll[ad.lIlllIlII[44]] = ad.lIIllIllIlIl("5i/L+u8/GeU=", "eNeZh");
        ad.lIlllIIll[ad.lIlllIlII[45]] = ad.lIIllIllIIll("By0O", "DByxo");
        ad.lIlllIIll[ad.lIlllIlII[46]] = ad.lIIllIllIIll("Owkv", "XfXGH");
        ad.lIlllIIll[ad.lIlllIlII[48]] = ad.lIIllIllIlIl("9zwOkfSIx1U=", "InRST");
        ad.lIlllIIll[ad.lIlllIlII[52]] = ad.lIIllIllIlIl("SlXFBi1ZRurlYp+V1khNkVuDBxRp9w6N", "kFkWu");
        ad.lIlllIIll[ad.lIlllIlII[53]] = ad.lIIllIllIIll("DyQ+HTspbCICLSAg", "LLQrH");
        ad.lIlllIIll[ad.lIlllIlII[55]] = ad.lIIllIllIlIl("3KZ7a+pZ9Ume6wtwNEO3Lg==", "RNyTU");
        ad.lIlllIIll[ad.lIlllIlII[56]] = ad.lIIllIllIIll("MyIuBzlEEC4QIg8m", "dCZbK");
        ad.lIlllIIll[ad.lIlllIlII[57]] = ad.lIIllIllIlIl("htM0mVl/Sg97jO9NriKtTA==", "cGHyx");
        ad.lIlllIIll[ad.lIlllIlII[20]] = ad.lIIllIllIlII("nJltfmmDxOGkXZ01q2+Amg==", "HTGgG");
        ad.lIlllIIll[ad.lIlllIlII[51]] = ad.lIIllIllIIll("NzomIUciJyYtDBQ=", "qSTDg");
        ad.lIlllIIll[ad.lIlllIlII[73]] = ad.lIIllIllIlIl("EsUgn/LMRihnXQBOT86gIA==", "fXygP");
        ad.lIlllIIll[ad.lIlllIlII[75]] = ad.lIIllIllIlIl("e13VzsewVSF2SU/Ek0pee80ThBteNVIO", "JwtFV");
        ad.lIlllIIll[ad.lIlllIlII[76]] = ad.lIIllIllIIll("BQk+", "FfIAb");
    }
    ...
    private static void lIIllIllIlll() {
        ...
        ad.lIlllIlII[0] = (0xA6 ^ 0xC7 ^ (2 ^ 0x74)) & (17 + 2 - -18 + 110 ^ 4 + 62 - 15 + 81 ^ -" ".length());
        ad.lIlllIlII[1] = " ".length();
        ad.lIlllIlII[2] = "  ".length();
        ad.lIlllIlII[3] = "   ".length();
                        ...
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    ...
                                    return ((0x11 ^ 0x4F ^ (0x47 ^ 0x26)) & (2 + 94 - 2 + 39 ^ 22 + 92 - 37 + 109 ^ -" ".length())) != 0;
                                }
                                n4 = lIlllIlII[0];
                                return n4 != 0;
                            }
                    ...
                    if (ad.lIIllIllllIl(Bank.getFirst((int[])nArray17).getQuantity(), lIlllIlII[18])) {
                        ...
                        if (ad.lIIllIlllIII(Bank.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (ad.lIIllIlllIII(Bank.contains((int[])nArray19) ? 1 : 0)) {
                                ...
                                return ((0x71 ^ 0x1B ^ (0x6D ^ 0x27)) & (91 + 88 - 120 + 89 ^ 154 + 170 - 237 + 93 ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
    ...
    public int T() {
        ...
        if (-"   ".length() >= 0) {
            return (0x48 ^ 0x71 ^ (0xA ^ 0x63)) & (0x6D ^ 0x6B ^ (0xD6 ^ 0x80) ^ -" ".length());
        }
        return lIlllIlII[68];
    }
                                ...
                                if (ad.lIIllIlllIIl(Inventory.getCount((int[])nArray2), lIlllIlII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (ad.lIIllIllllII(Inventory.getCount((int[])nArray))) {
                                            bl = lIlllIlII[1];
                                            "".length();
                                            if ((0x68 ^ 0x7E ^ (0x51 ^ 0x43)) < "  ".length()) {
                                                return ((163 + 56 - 187 + 137 ^ 103 + 129 - 108 + 25) & (0x99 ^ 0x88 ^ (0x9A ^ 0xB7) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlllIlII[0];
                                        }
                                ...
                                if (ad.lIIllIlllIIl(Inventory.getCount((int[])nArray8), lIlllIlII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (ad.lIIllIllllII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if ("  ".length() <= -" ".length()) {
                                                return ((51 + 2 - -113 + 16 ^ 65 + 74 - 104 + 101) & (7 ^ 0x79 ^ (0x52 ^ 0x12) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlllIlII[0];
                                        }
                                ...
                                if (ad.lIIllIlllIIl(Inventory.getCount((int[])nArray10), lIlllIlII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (ad.lIIllIllllII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if ("   ".length() <= 0) {
                                                return ((100 + 87 - 178 + 126 ^ 144 + 17 - 114 + 139) & (44 + 41 - 54 + 152 ^ 131 + 88 - 108 + 27 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlllIlII[0];
                                        }
                        ...
                        if (ad.lIIllIlllIII(Players.getLocal().getWorldLocation().equals((Object)by) ? 1 : 0) && ad.lIIllIlllIll(llIIlIIlIlIIlI) && ad.lIIllIlllIll(llIIlIIlIlIIIl)) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (ad.lIIlllIIIIll(Skills.getExperience((Skill)Skill.MAGIC), llIIlIIlIlIIII)) {
                                    ...
                                    "".length();
                                    if ("   ".length() < "   ".length()) {
                                        return ((0x33 ^ 0x43 ^ (0xEF ^ 0x97)) & (132 + 14 - 45 + 64 ^ 116 + 71 - 36 + 22 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlllIlII[0];
                                }
                    ...
                    block27: {
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    block24: {
                                        block19: {
                                            ...
                                            block20: {
                                                ...
                                                return ((0xB0 ^ 0xA4 ^ (0x90 ^ 0xA1)) & (161 + 123 - 117 + 23 ^ 25 + 19 - -11 + 100 ^ -" ".length())) != 0;
                                            }
                                            n5 = lIlllIlII[0];
                                            return n5 != 0;
                                        }
                                    ...
                                    return ((64 + 67 - 76 + 110 ^ 90 + 2 - 55 + 140) & (0x79 ^ 9 ^ (0xC ^ 0x68) ^ -" ".length())) != 0;
                                }
                                n4 = lIlllIlII[0];
                                return n4 != 0;
                            }
                        ...
                        if (ad.lIIllIlllIII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (ad.lIIllIlllIII(Inventory.contains((int[])nArray14) ? 1 : 0)) {
                                ...
                                return ((0x57 ^ 0x14 ^ (0x70 ^ 0x1C)) & (0x62 ^ 0x45 ^ (0x55 ^ 0x5D) ^ -" ".length())) != 0;
                            }
                        }
                    }
                    n3 = lIlllIlII[0];
                    ...
                    if (ad.lIIllIllllIl(Inventory.getFirst((int[])nArray17).getQuantity(), lIlllIlII[18])) {
                        ...
                        if (ad.lIIllIlllIII(Inventory.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (ad.lIIllIlllIII(Inventory.contains((int[])nArray19) ? 1 : 0)) {
                                n2 = lIlllIlII[1];
                                "".length();
                                if (((0x24 ^ 0xA ^ (0x1D ^ 0x2B)) & (143 + 187 - 267 + 154 ^ 90 + 78 - 28 + 53 ^ -" ".length())) == 0) return n2 != 0;
                                return ((118 + 22 - 88 + 94 ^ 118 + 129 - 228 + 131) & (0x4A ^ 3 ^ (0x2D ^ 0x60) ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
