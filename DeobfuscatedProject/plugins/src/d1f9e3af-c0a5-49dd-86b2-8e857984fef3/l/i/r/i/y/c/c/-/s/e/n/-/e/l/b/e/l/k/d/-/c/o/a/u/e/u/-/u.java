...
implements W {
            ...
            if (u.lIIlIIlIIlll(Inventory.getCount((String[])stringArray2))) {
                ...
                if (u.lIIlIIlIIlll(Inventory.getCount((String[])stringArray3))) {
                    ...
                    if (u.lIIlIIlIIlll(Inventory.getCount((String[])stringArray4))) {
                        n2 = lIlIllIlI[1];
                        "".length();
                        if ("   ".length() < (0x1B ^ 0x1F)) return n2 != 0;
    ...
    private static void lIIlIIlIIIII() {
        ...
        u.lIlIllIIl[u.lIlIllIlI[0]] = u.lIIlIIIlllIl("o5YBS4eIslJe5FpNaXqTuQ==", "QbxaZ");
        u.lIlIllIIl[u.lIlIllIlI[1]] = u.lIIlIIIllllI("eCdteWCpkV5xPkXF7okjrPLw+xD1vUYQpw74ql0smI8Wmjd6xAA7nCqfzhHq+yhl", "ngUem");
        u.lIlIllIIl[u.lIlIllIlI[3]] = u.lIIlIIIlllll("FSIjFiA=", "QPJxK");
        u.lIlIllIIl[u.lIlIllIlI[5]] = u.lIIlIIIllllI("JseGemstlxg=", "vFcOC");
        u.lIlIllIIl[u.lIlIllIlI[8]] = u.lIIlIIIllllI("oSxGxc71v6vSNhTIhDsr6A==", "Mfmil");
        u.lIlIllIIl[u.lIlIllIlI[9]] = u.lIIlIIIlllll("HBMePSs9HBd5JTUcGzApMw==", "TrpYG");
        u.lIlIllIIl[u.lIlIllIlI[15]] = u.lIIlIIIllllI("9Zr9GdQz+lzTmECesixyKuxebU0pK69e3bBv9Rzq1Nqk8SoZg4ygY0Xi1xZm6/zeTObJPjz3Sv8=", "YAPrh");
        u.lIlIllIIl[u.lIlIllIlI[18]] = u.lIIlIIIlllIl("j7Nt+v4er+CeO4KC5Z+Mhg==", "VXZLY");
        u.lIlIllIIl[u.lIlIllIlI[19]] = u.lIIlIIIllllI("QH6RQMoECLG/6BTgrDLIGg==", "wwxcO");
        u.lIlIllIIl[u.lIlIllIlI[20]] = u.lIIlIIIlllll("ExIgFw49Fik=", "XsQrc");
        u.lIlIllIIl[u.lIlIllIlI[17]] = u.lIIlIIIllllI("d16H6JI8fIyE4leAVL1sog==", "kNeFq");
        u.lIlIllIIl[u.lIlIllIlI[21]] = u.lIIlIIIlllIl("6Ku/z1/D1eYal2BFnkx02A==", "oTviC");
        u.lIlIllIIl[u.lIlIllIlI[22]] = u.lIIlIIIlllll("NRADNSkR", "fqmSL");
        u.lIlIllIIl[u.lIlIllIlI[23]] = u.lIIlIIIlllIl("p8PHFjyaq5ct7Ed+n0qP7g==", "lOmHA");
        u.lIlIllIIl[u.lIlIllIlI[24]] = u.lIIlIIIlllIl("OgAiawwwYTD3fSaGxAgmxw==", "HBAsj");
        u.lIlIllIIl[u.lIlIllIlI[26]] = u.lIIlIIIlllIl("UlklAo2oG1Eb6Ldtx183MQ==", "KreLs");
        u.lIlIllIIl[u.lIlIllIlI[27]] = u.lIIlIIIllllI("Nj5lIXTvqXPcdsWGkD2HBQ==", "GUlyq");
        u.lIlIllIIl[u.lIlIllIlI[28]] = u.lIIlIIIlllIl("Sy75N/IM+aRN3in4MuWOIA==", "phWfY");
        u.lIlIllIIl[u.lIlIllIlI[29]] = u.lIIlIIIlllIl("M+a/GTLKhYppXNmNk+IS4g==", "xljpN");
        u.lIlIllIIl[u.lIlIllIlI[30]] = u.lIIlIIIllllI("WR1Vv2ux/7Us8siaLWMwgg==", "BpowA");
        u.lIlIllIIl[u.lIlIllIlI[31]] = u.lIIlIIIllllI("wIDaNUVo3DxO3wA4EF1aww==", "GLuJT");
        u.lIlIllIIl[u.lIlIllIlI[32]] = u.lIIlIIIlllIl("Kt0ysSLkNxw=", "KwBrG");
        u.lIlIllIIl[u.lIlIllIlI[33]] = u.lIIlIIIllllI("Ffk5aoPLYj4vpy4RmCMjNA==", "CElXB");
        u.lIlIllIIl[u.lIlIllIlI[34]] = u.lIIlIIIlllIl("t4/ApslUPc7F7zVAxuMSOQ==", "JhTMQ");
        u.lIlIllIIl[u.lIlIllIlI[35]] = u.lIIlIIIlllll("BwkjAgopDSo=", "LhRgg");
        u.lIlIllIIl[u.lIlIllIlI[36]] = u.lIIlIIIlllIl("FcohTdU6hE5heVdgBeQ/mA==", "LkOmc");
        u.lIlIllIIl[u.lIlIllIlI[37]] = u.lIIlIIIllllI("qABpts9h2Oc0Ynbfekhqy88ECVp1QfhG", "TdQZS");
        u.lIlIllIIl[u.lIlIllIlI[38]] = u.lIIlIIIlllIl("yC8rfmbxqJBINrMozxfg/g==", "uujMI");
        u.lIlIllIIl[u.lIlIllIlI[39]] = u.lIIlIIIlllIl("pS6hGJdiaw0Qvo3VJVOywQ==", "jCMeg");
        u.lIlIllIIl[u.lIlIllIlI[40]] = u.lIIlIIIllllI("YOwV6YYj23WdJ8anYsFB3A==", "eQSyH");
        u.lIlIllIIl[u.lIlIllIlI[41]] = u.lIIlIIIlllll("BhA6WiwxFCs=", "TqMzN");
        u.lIlIllIIl[u.lIlIllIlI[42]] = u.lIIlIIIlllIl("UraVy5fxbzLGTtb4T5mzaw==", "UzfBr");
        u.lIlIllIIl[u.lIlIllIlI[43]] = u.lIIlIIIlllll("HzYQTR0sI0cACiwj", "MWgmo");
        u.lIlIllIIl[u.lIlIllIlI[52]] = u.lIIlIIIlllll("HDAMEy8xIVkIIiw3GBZrKTccCT8=", "XByzK");
        u.lIlIllIIl[u.lIlIllIlI[53]] = u.lIIlIIIlllIl("M7EdikvzkPohgO7t+m7WhewbJf+Y2Rrk", "SIiwM");
        u.lIlIllIIl[u.lIlIllIlI[60]] = u.lIIlIIIllllI("86iI/cslmc6qcLc2P+9/XfesJXNYk8L72Kn/nNZ25vM=", "THMXc");
        u.lIlIllIIl[u.lIlIllIlI[61]] = u.lIIlIIIlllll("ISkVL3xOC1QhOQIuVCIiF2IVODROKhE6IEA=", "nBtVP");
        u.lIlIllIIl[u.lIlIllIlI[62]] = u.lIIlIIIlllll("Cz8ydw==", "RZAYX");
        u.lIlIllIIl[u.lIlIllIlI[63]] = u.lIIlIIIllllI("UZHCfZkwpMcdJnyAPC09UHLr2HMMDCFC4zDr8MTL1dn3euIGKk6iVkPDezXq2oiJ6SvqSL+XEJw=", "eCshG");
        u.lIlIllIIl[u.lIlIllIlI[64]] = u.lIIlIIIlllll("Kg1negxCCid6IQpGPzIkEUY/MiALSA==", "efKZE");
    }
    ...
    public boolean V() {
        ...
        if (u.lIIlIIlIllll(e.j(lIlIllIlI[7]), lIlIllIlI[8])) {
            ...
            "".length();
            if (" ".length() >= "   ".length()) {
                return ((0x3F ^ 0x48 ^ (0x4E ^ 0x73)) & (0x60 ^ 0x4B ^ (0x57 ^ 0x36) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlIllIlI[0];
        }
