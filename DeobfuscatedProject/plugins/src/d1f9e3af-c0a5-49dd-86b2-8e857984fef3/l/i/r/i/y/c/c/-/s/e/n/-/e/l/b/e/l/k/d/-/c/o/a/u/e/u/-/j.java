...
implements W {
    ...
    private static /* synthetic */ boolean a(WorldArea worldArea, TileObject tileObject) {
        ...
        if (j.lIIIlIIlIIIl(tileObject.getName().contains(lIlIIIllI[lIlIIIlll[44]]) ? 1 : 0) && j.lIIIlIIlIIIl(worldArea.contains(tileObject.getWorldLocation()) ? 1 : 0)) {
            n2 = lIlIIIlll[0];
            "".length();
            if ((0x18 ^ 6 ^ (0x61 ^ 0x7B)) <= " ".length()) {
                return ((0x64 ^ 0xF ^ (0xED ^ 0xBD)) & (0x36 ^ 1 ^ (0x22 ^ 0x2E) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIlIIIlll[1];
        }
    ...
    private static void lIIIlIIIlllI() {
        ...
        j.lIlIIIlll[4] = 0x78 ^ 0x63 ^ "   ".length();
    ...
    private static void lIIIlIIIllIl() {
        ...
        j.lIlIIIllI[j.lIlIIIlll[1]] = j.lIIIlIIIlIlI("GBs5KxY3DiYsFnYOIGITNxQk", "VzOBq");
        j.lIlIIIllI[j.lIlIIIlll[0]] = j.lIIIlIIIlIll("CQDmfQG6LIbk/JMCXscrctT0xCbjTzMT", "EDWoF");
        j.lIlIIIllI[j.lIlIIIlll[10]] = j.lIIIlIIIlIll("LdHMgJ/jYsk=", "LEJfe");
        j.lIlIIIllI[j.lIlIIIlll[20]] = j.lIIIlIIIllII("RjS3YQpZx47vfRv1I9L6pw==", "faBOZ");
        j.lIlIIIllI[j.lIlIIIlll[28]] = j.lIIIlIIIlIlI("BiMRFGUCLRYLZQUjFgwkOQ==", "ULdxE");
        j.lIlIIIllI[j.lIlIIIlll[29]] = j.lIIIlIIIllII("kMjplman4mM=", "OxpKQ");
        j.lIlIIIllI[j.lIlIIIlll[27]] = j.lIIIlIIIllII("vpDv/tyVy3hpPC6Bui2O7A==", "jhzMe");
        j.lIlIIIllI[j.lIlIIIlll[34]] = j.lIIIlIIIlIll("vvqyQeNlLafannqJ3IPRdw==", "HWzjU");
        j.lIlIIIllI[j.lIlIIIlll[35]] = j.lIIIlIIIlIlI("IxU9OwwJCCc9TxEOPDY=", "baIZo");
        j.lIlIIIllI[j.lIlIIIlll[36]] = j.lIIIlIIIlIll("XOmLc70GPOs=", "cOnMQ");
        j.lIlIIIllI[j.lIlIIIlll[7]] = j.lIIIlIIIlIll("4GvZ/SQYiRrRYMLUN51ESA==", "MtsxJ");
        j.lIlIIIllI[j.lIlIIIlll[13]] = j.lIIIlIIIlIll("ogylUa8Cy1I=", "osqOZ");
        j.lIlIIIllI[j.lIlIIIlll[37]] = j.lIIIlIIIllII("A44rg+eYVoMgdfej/ftmxQ==", "EYJyN");
        j.lIlIIIllI[j.lIlIIIlll[14]] = j.lIIIlIIIlIlI("FiQ6IgAkPy0rTwMkPSkc", "PKHEo");
        j.lIlIIIllI[j.lIlIIIlll[40]] = j.lIIIlIIIlIll("VSsEw94bKpw=", "tYqmt");
        j.lIlIIIllI[j.lIlIIIlll[41]] = j.lIIIlIIIlIlI("MSMmBhkb", "pWRgz");
        j.lIlIIIllI[j.lIlIIIlll[42]] = j.lIIIlIIIllII("afOJP5FHs08=", "zUzhp");
        j.lIlIIIllI[j.lIlIIIlll[43]] = j.lIIIlIIIlIlI("FRUNMQQ/", "TayPg");
        j.lIlIIIllI[j.lIlIIIlll[44]] = j.lIIIlIIIlIlI("OxADCwYLBREH", "hdbbt");
    }
    ...
    public boolean V() {
        ...
        if (j.lIIIlIIllIIl(Skills.getLevel((Skill)Skill.RANGED), lIlIIIlll[39])) {
            ...
            "".length();
            if (-"  ".length() >= 0) {
                return ((0xE0 ^ 0xBC ^ (0x17 ^ 0x2A)) & (0x1C ^ 0x48 ^ (0x50 ^ 0x65) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlIIIlll[1];
        }
                ...
                llllIlIlIIllIl = NPCs.getNearest(nPC -> {
                    ...
                    if (j.lIIIlIIlIIIl(nPC.getName().contains(lIlIIIllI[lIlIIIlll[40]]) ? 1 : 0) && j.lIIIlIIIllll(nPC.isDead() ? 1 : 0)) {
                        ...
                        if (j.lIIIlIIlIIIl(nPC.hasAction(stringArray) ? 1 : 0) && j.lIIIlIIllIlI(nPC.getInteracting(), Players.getLocal())) {
                            ...
                            return ((0xC5 ^ 0x93 ^ (0x6C ^ 0x68)) & (0xF3 ^ 0x97 ^ (0x37 ^ 1) ^ -" ".length())) != 0;
                        }
                    }
                    n2 = lIlIIIlll[1];
                    return n2 != 0;
