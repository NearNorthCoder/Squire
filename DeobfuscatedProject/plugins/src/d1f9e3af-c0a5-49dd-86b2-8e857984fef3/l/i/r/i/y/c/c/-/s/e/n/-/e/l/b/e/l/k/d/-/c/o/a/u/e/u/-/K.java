...
implements W {
    ...
    private static void lIIIlIlIlIlI() {
        ...
        K.lIlIIlIlI[0] = "  ".length() & ~"  ".length();
        K.lIlIIlIlI[1] = " ".length();
        K.lIlIIlIlI[2] = 0xFFFFDBA8 & 0x37DF;
        K.lIlIIlIlI[3] = "  ".length();
        K.lIlIIlIlI[4] = 117 + 124 - 159 + 63 ^ 77 + 138 - 97 + 31;
        K.lIlIIlIlI[5] = "   ".length();
        ...
        K.lIlIIlIlI[48] = -" ".length() & (0xFFFFEBDF & 0x1D7F);
        ...
        K.lIlIIlIlI[61] = " ".length() ^ (0x59 ^ 0x77);
    ...
    private static String lIIIlIIllllI(String lllIlllIIllIII, String lllIlllIIlIlll) {
        ...
        while (K.lIIIlIlIllIl(lllIlllIIlIIIl, lllIlllIIlIIlI)) {
            ...
            ++lllIlllIIlIIIl;
            "".length();
            if (((0xAD ^ 0x85 ^ (0x4B ^ 0x27)) & (0x94 ^ 0x92 ^ (0x67 ^ 0x25) ^ -" ".length())) == 0) continue;
            return null;
        }
    ...
    private static boolean ab() {
        ...
        while (K.lIIIlIlIllIl(lllIlllIllIIII, ((void)lllIlllIllIIIl).length)) {
            ...
            "".length();
            if (" ".length() >= 0) continue;
            return ((122 + 64 - 48 + 20 ^ 82 + 43 - 2 + 25) & (112 + 66 - 147 + 110 ^ 73 + 13 - -27 + 22 ^ -" ".length())) != 0;
        }
        return lIlIIlIlI[1];
    }
    ...
    public boolean V() {
        ...
        if (K.lIIIlIllIlll(Vars.getBit((int)QuestVarbits.QUEST_DEMON_SLAYER.getId()), lIlIIlIlI[5])) {
            ...
            "".length();
            if (" ".length() < " ".length()) {
                return ((0x4B ^ 4 ^ (0xC0 ^ 0x81)) & (0x22 ^ 0x3D ^ (0xD6 ^ 0xC7) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlIIlIlI[0];
        }
    ...
    private static void lIIIlIlIlIIl() {
        ...
        K.lIlIIlIIl[K.lIlIIlIlI[0]] = K.lIIIlIIlllII("zVZQB5PQeQeX5mgwaOxHo1KvQ77Py+LyM4UOqWQuBvvn9IRnkwtop3J6UBYAbZFh", "wgFZD");
        K.lIlIIlIIl[K.lIlIIlIlI[1]] = K.lIIIlIIlllIl("QQ4SsoUUn+nx9vMd1Mn75Q==", "ZYstP");
        K.lIlIIlIIl[K.lIlIIlIlI[3]] = K.lIIIlIIlllIl("nXBciYz2yGEl3F9gGum3RhIyP0dYIkfq", "ukAaV");
        K.lIlIIlIIl[K.lIlIIlIlI[5]] = K.lIIIlIIlllIl("W3kYJamu6/PyX0YSO4EvL6M6S2qPFrY+XAZpbXsHFmvXzA7izVmG8xmllbZAPYmzl5CIrAyOTUo=", "MXyNC");
        K.lIlIIlIIl[K.lIlIIlIlI[4]] = K.lIIIlIIlllIl("w0ujkTDkqUc9xyxQIIKaw08SuL5izspfhFQ1XXOwTYHMOKTBDaNDSzvp0HePziPj8R+b4AVtBYo=", "sKbxC");
        K.lIlIIlIIl[K.lIlIIlIlI[10]] = K.lIIIlIIlllIl("Q7brzLDlJ9Y=", "tZbLC");
        K.lIlIIlIIl[K.lIlIIlIlI[16]] = K.lIIIlIIllllI("NxQDBSc=", "sfjkL");
        K.lIlIIlIIl[K.lIlIIlIlI[18]] = K.lIIIlIIllllI("NjAT", "sQgaY");
        K.lIlIIlIIl[K.lIlIIlIlI[19]] = K.lIIIlIIlllIl("KFQHA4V0CUZt/NBuPPy2sw==", "VxbYV");
        K.lIlIIlIIl[K.lIlIIlIlI[20]] = K.lIIIlIIlllII("546ZR7lYxBs=", "rZmIM");
        K.lIlIIlIIl[K.lIlIIlIlI[12]] = K.lIIIlIIlllIl("o0Wn6tit4HAts+nfcPMER09SFyoH6Arf", "TrNwQ");
        K.lIlIIlIIl[K.lIlIIlIlI[23]] = K.lIIIlIIlllIl("EhSxTewefStrcBcy97lYSA==", "uoLcr");
        K.lIlIIlIIl[K.lIlIIlIlI[25]] = K.lIIIlIIllllI("AR0DDgsgGAYfBiY=", "Rtoxn");
        K.lIlIIlIIl[K.lIlIIlIlI[26]] = K.lIIIlIIlllIl("hL29EJO/jmew/wW9mNSYvQ==", "xUdOz");
        K.lIlIIlIIl[K.lIlIIlIlI[27]] = K.lIIIlIIllllI("ACUdJhgqKk0AFjUtAw==", "CDmRy");
        K.lIlIIlIIl[K.lIlIIlIlI[28]] = K.lIIIlIIlllIl("U6d1d+RyNoawBfukIePf2w==", "usNpI");
        K.lIlIIlIIl[K.lIlIIlIlI[29]] = K.lIIIlIIlllIl("96zQdKYFROK5xXp+iFEMZw==", "wpwcN");
        K.lIlIIlIIl[K.lIlIIlIlI[30]] = K.lIIIlIIlllII("dZ7Wv5V7yigxOnSXApXFxg==", "YZhel");
        K.lIlIIlIIl[K.lIlIIlIlI[31]] = K.lIIIlIIlllII("OOltjveSCW4=", "toXWN");
        K.lIlIIlIIl[K.lIlIIlIlI[32]] = K.lIIIlIIlllIl("33pDKegdZRxTJRwM3EhXRw==", "NvUXP");
        K.lIlIIlIIl[K.lIlIIlIlI[33]] = K.lIIIlIIlllIl("oY8XTf6vvf3WwIOlzdvZ1F06KlsoOJp8", "hNheC");
        K.lIlIIlIIl[K.lIlIIlIlI[34]] = K.lIIIlIIllllI("KwkIDCMKDQ==", "fhfdL");
        K.lIlIIlIIl[K.lIlIIlIlI[35]] = K.lIIIlIIlllIl("UJ60bP71X/w=", "MrCSZ");
        K.lIlIIlIIl[K.lIlIIlIlI[36]] = K.lIIIlIIllllI("FiYuFA==", "YVKzt");
        K.lIlIIlIIl[K.lIlIIlIlI[37]] = K.lIIIlIIllllI("LgIcHBgPBg==", "ccrtw");
        K.lIlIIlIIl[K.lIlIIlIlI[9]] = K.lIIIlIIlllIl("llIBxQ4QvFg=", "fzURr");
        K.lIlIIlIIl[K.lIlIIlIlI[38]] = K.lIIIlIIllllI("KyILEgEKJg==", "fCezn");
        K.lIlIIlIIl[K.lIlIIlIlI[39]] = K.lIIIlIIllllI("Hy0YOAI+KQ==", "RLvPm");
        K.lIlIIlIIl[K.lIlIIlIlI[40]] = K.lIIIlIIlllII("+u5TIKPwPZExLjHcOMaaiQ==", "JKvnr");
        K.lIlIIlIIl[K.lIlIIlIlI[41]] = K.lIIIlIIlllIl("ESBDY/TL7GQ=", "Wqcot");
        K.lIlIIlIIl[K.lIlIIlIlI[42]] = K.lIIIlIIlllII("4yDVuy4gRqGrYobHOshOtQ==", "BoSGa");
        K.lIlIIlIIl[K.lIlIIlIlI[43]] = K.lIIIlIIlllII("KhWv9aokeiC3ghn0HKOVlA==", "HPpsD");
        K.lIlIIlIIl[K.lIlIIlIlI[44]] = K.lIIIlIIllllI("CgYgEjh4GDYf", "XsSfA");
        K.lIlIIlIIl[K.lIlIIlIlI[45]] = K.lIIIlIIlllIl("WhyK/T3YzDw=", "FnQhd");
        K.lIlIIlIIl[K.lIlIIlIlI[47]] = K.lIIIlIIllllI("IBsgOQEBHiUoDAc=", "srLOd");
        K.lIlIIlIIl[K.lIlIIlIlI[49]] = K.lIIIlIIllllI("JTs4IAU=", "gTVEv");
        K.lIlIIlIIl[K.lIlIIlIlI[50]] = K.lIIIlIIlllIl("YXFMIRjpIeU=", "mSkcb");
        K.lIlIIlIIl[K.lIlIIlIlI[51]] = K.lIIIlIIlllII("7jM1FL2IKjXSGoQU16/8mQ==", "dqZFf");
        K.lIlIIlIIl[K.lIlIIlIlI[52]] = K.lIIIlIIllllI("OzwSMgAIdTwhEwU3ByEc", "lUhSr");
        K.lIlIIlIIl[K.lIlIIlIlI[53]] = K.lIIIlIIlllIl("6ZGsulWQYiEitVHMoke/yw==", "GHKJv");
        K.lIlIIlIIl[K.lIlIIlIlI[54]] = K.lIIIlIIlllII("EY0FOnnKrOsrUI0cgi8fM6xPEAzvG6OC", "Wdwvb");
        K.lIlIIlIIl[K.lIlIIlIlI[55]] = K.lIIIlIIlllIl("qI4lCQ2IZ7dNj8d2KIRVBA==", "iPSuT");
        K.lIlIIlIIl[K.lIlIIlIlI[56]] = K.lIIIlIIlllIl("b3WNl3Nqxenf8BxusuVGGw==", "RWXQX");
        K.lIlIIlIIl[K.lIlIIlIlI[57]] = K.lIIIlIIllllI("NjwDCDAGMQ==", "rYozY");
        K.lIlIIlIIl[K.lIlIIlIlI[58]] = K.lIIIlIIlllII("TxLlHILg8uMHMiX8aTJCnVQRsV8C1GAC", "EjYcZ");
        K.lIlIIlIIl[K.lIlIIlIlI[59]] = K.lIIIlIIlllII("z+7MbrAOmME0CRypiXm3HQ==", "BGpjP");
        K.lIlIIlIIl[K.lIlIIlIlI[60]] = K.lIIIlIIlllIl("ZDlXmEYVkSY=", "japEf");
        K.lIlIIlIIl[K.lIlIIlIlI[61]] = K.lIIIlIIllllI("PwkbOScGCR5yBg0ACDs2AA==", "hlzRB");
        K.lIlIIlIIl[K.lIlIIlIlI[62]] = K.lIIIlIIllllI("FRcjIDo/", "TcWAY");
        K.lIlIIlIIl[K.lIlIIlIlI[63]] = K.lIIIlIIllllI("PBc4IC0MGg==", "xrTRD");
        K.lIlIIlIIl[K.lIlIIlIlI[15]] = K.lIIIlIIlllII("HnO9SY14thY=", "Rnnix");
        K.lIlIIlIIl[K.lIlIIlIlI[64]] = K.lIIIlIIlllII("EX+kViJC/k0=", "WRRjv");
        K.lIlIIlIIl[K.lIlIIlIlI[65]] = K.lIIIlIIllllI("Bxs3MzUt", "FoCRV");
        K.lIlIIlIIl[K.lIlIIlIlI[66]] = K.lIIIlIIlllII("fOubacqBGNsmMrc20zLR7w==", "gdqyF");
        K.lIlIIlIIl[K.lIlIIlIlI[67]] = K.lIIIlIIlllIl("SRvcsXmuvb4=", "GFQEQ");
        K.lIlIIlIIl[K.lIlIIlIlI[68]] = K.lIIIlIIllllI("BSwIIgk8LA1pKDclGyAYOg==", "RIiIl");
        K.lIlIIlIIl[K.lIlIIlIlI[69]] = K.lIIIlIIlllII("5GrUyaOfsyHabfDT2zDK2Q==", "xmgyT");
        K.lIlIIlIIl[K.lIlIIlIlI[75]] = K.lIIIlIIlllII("0PulgLFJRmU=", "rbczH");
        K.lIlIIlIIl[K.lIlIIlIlI[76]] = K.lIIIlIIlllII("oYxmA4e2z+lq3zH9wcLerQ==", "axQUg");
        K.lIlIIlIIl[K.lIlIIlIlI[77]] = K.lIIIlIIlllIl("3Y4E+I3GEvzCVq7Y3BydMNcI3Xggg6aZ", "LnbaJ");
        K.lIlIIlIIl[K.lIlIIlIlI[79]] = K.lIIIlIIlllIl("MnnlRsC9+mg=", "JDyuP");
        K.lIlIIlIIl[K.lIlIIlIlI[87]] = K.lIIIlIIllllI("EQ0ECSV1OwUHMjAa", "UhifK");
        K.lIlIIlIIl[K.lIlIIlIlI[88]] = K.lIIIlIIllllI("MDMDAmEtPE0SJCM2GQ1hag==", "BZmeA");
        K.lIlIIlIIl[K.lIlIIlIlI[89]] = K.lIIIlIIlllIl("Ae9Nz1/kjr8=", "yqPLd");
        K.lIlIIlIIl[K.lIlIIlIlI[90]] = K.lIIIlIIllllI("HAcFRB86CQZEHzMbUhAAMxxSDQYxCRwQCSYBHQpIMw8TDQZt", "Rhrdh");
        K.lIlIIlIIl[K.lIlIIlIlI[103]] = K.lIIIlIIlllIl("ybFBc1np0a4=", "ElCnY");
        K.lIlIIlIIl[K.lIlIIlIlI[104]] = K.lIIIlIIlllII("xehXs0HXfAFlgfsmn8bKzeE0VwW255ni", "yqiCq");
        K.lIlIIlIIl[K.lIlIIlIlI[105]] = K.lIIIlIIllllI("Cx8YH29kAxEDMSFUEBVjLBFGRgpjGBVGKC0YFUYrLRlZACw2VAAJNmU=", "DtyfC");
        K.lIlIIlIIl[K.lIlIIlIlI[106]] = K.lIIIlIIllllI("Iw1rDgYHQi8PDVA1KgoFCUIgDwUcQg8DBQILPw5W", "pbKfi");
        K.lIlIIlIIl[K.lIlIIlIlI[107]] = K.lIIIlIIllllI("LyYiDWcRPWMNLx1uLhggES0iFWcRICAYKQwvNxAoFnE=", "xNCyG");
        K.lIlIIlIIl[K.lIlIIlIlI[108]] = K.lIIIlIIllllI("BCc9JWs2ND0yawx1Jz4kMDkwdigqODF2KisxdCIqKT50IiRlLDsjZQ==", "EUTVK");
        K.lIlIIlIIl[K.lIlIIlIlI[109]] = K.lIIIlIIllllI("PFkmKDQRWTwicRMQJilxJhAkOzQHFSEqOQFX", "uyHMQ");
        K.lIlIIlIIl[K.lIlIIlIlI[110]] = K.lIIIlIIlllII("4PmX/Yz2tOO9iHwkCi5jhGS2Ni0jw+dvXRJsmGS8qpdI9MkDpQXbvndVA3Do5zNiKpePUX9vN40=", "Yvxmm");
        K.lIlIIlIIl[K.lIlIIlIlI[111]] = K.lIIIlIIllllI("NjhvITATMm8rPEUjJyN5DjI2NXg=", "eWOFY");
        K.lIlIIlIIl[K.lIlIIlIlI[112]] = K.lIIIlIIlllIl("8rCVZGDWP8w//b2HZNjynhNVf01eCGgml3tcmnEs4DXZNEqwLgzbtg==", "ItzGk");
        K.lIlIIlIIl[K.lIlIIlIlI[113]] = K.lIIIlIIllllI("LgkVBAhdElAXTR4EHRkDWhYYGU0NAB4CHloVH1YEFBcREghaFRgfHloCGQIUVA==", "zapvm");
        K.lIlIIlIIl[K.lIlIIlIlI[114]] = K.lIIIlIIlllIl("la+e4Q5pZQNZQ9nHRMi6Gg==", "qbPbX");
        K.lIlIIlIIl[K.lIlIIlIlI[115]] = K.lIIIlIIlllIl("AHevRbrQFfS4yxdLHKDcPQPpsggUEQeqLsQDjiSy1s6q0GIs3eXxRGBH2Npvsi94XklwzOYtgFCR8QjAWxIYjQ==", "WnVtG");
        K.lIlIIlIIl[K.lIlIIlIlI[116]] = K.lIIIlIIlllIl("oT1cAWKci3ji9VMMceVYOqfi8Sblz4AqTLmr5sIJvZOEobHsAvHC8oy7ukn8Jz6z", "eyMNY");
        K.lIlIIlIIl[K.lIlIIlIlI[117]] = K.lIIIlIIlllIl("T57VMmFtLzi0pi9qBFlg/zxuXGFnfX2KKlMLX09gpttJI6+/J8jVKpQielcUSB4d", "gYmpx");
        K.lIlIIlIIl[K.lIlIIlIlI[118]] = K.lIIIlIIllllI("LCcBAEsZJAIeH1gCCAYEFmY+BwoBIx9F", "xFmkk");
        K.lIlIIlIIl[K.lIlIIlIlI[119]] = K.lIIIlIIlllIl("RrbQA2qaLgu9ZOxmHtbj5bEhTMsP0MzLI4zuldCbzqgGMMZmf4h8BQLjlBWmcXkr", "HjZuh");
        K.lIlIIlIIl[K.lIlIIlIlI[120]] = K.lIIIlIIlllII("HmnNQPzxFj4KDYxjYex7dzRiBJx7mEnRaqXv4rhVnuQ=", "PHbrb");
    }
