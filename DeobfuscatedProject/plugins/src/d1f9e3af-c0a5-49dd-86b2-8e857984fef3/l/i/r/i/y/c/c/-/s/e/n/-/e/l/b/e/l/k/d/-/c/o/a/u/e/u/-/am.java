...
implements W {
        ...
        if (am.lllIIIIIlIl(Skills.getLevel((Skill)Skill.WOODCUTTING), lIIIIlllI[24]) && am.lllIIIIIIIl(Skills.getLevel((Skill)Skill.WOODCUTTING), lIIIIlllI[23])) {
            ...
            if (am.lllIIIIIIll(Inventory.getCount((int[])nArray))) {
                ...
                if (am.lllIIIIIIll(Inventory.getCount((int[])nArray2))) {
                    n3 = lIIIIlllI[1];
                    "".length();
                    if ("   ".length() < (5 ^ 1)) return n3 != 0;
                    return ((0x29 ^ 0x76) & ~(0xEF ^ 0xB0)) != 0;
                }
            }
            n3 = lIIIIlllI[0];
            return n3 != 0;
            ...
            if (am.lllIIIIIIll(Inventory.getCount((int[])nArray))) {
                ...
                if (am.lllIIIIIIll(Inventory.getCount((int[])nArray3))) {
                    ...
                    if (am.lllIIIIIIll(Inventory.getCount((int[])nArray4))) {
                        ...
                        return ((0x42 ^ 0x6D ^ (0x6B ^ 0x50)) & (0x1A ^ 0xC ^ "  ".length() ^ -" ".length())) != 0;
                    }
                }
            }
            n4 = lIIIIlllI[0];
                ...
                if (am.lllIIIIIIll(Inventory.getCount((int[])nArray5))) {
                    ...
                    if (am.lllIIIIIIll(Inventory.getCount((int[])nArray6))) {
                        ...
                        if (am.lllIIIIIIll(Inventory.getCount((int[])nArray7))) {
                            ...
                            return ((6 + 23 - 28 + 169 ^ 51 + 49 - -20 + 13) & (0xF6 ^ 0xA7 ^ (0x2A ^ 0x54) ^ -" ".length())) != 0;
                        }
                    }
                }
            }
    ...
    private static void llIllllllll() {
        ...
        am.lIIIIlllI[1] = " ".length();
        am.lIIIIlllI[2] = 0xFFFF8FE3 & 0x73FF;
        am.lIIIIlllI[3] = "  ".length();
        am.lIIIIlllI[4] = "   ".length();
    ...
    private static void llIlllllllI() {
        ...
        am.lIIIIllIl[am.lIIIIlllI[0]] = am.llIlllllIll("M2GQ0A//G/0Q7uadI0bt0g==", "mahJx");
        am.lIIIIllIl[am.lIIIIlllI[1]] = am.llIlllllIll("7nUChs1z4WGEpFX9jrwhOP3RIGKyovjLuEkllDYC5xNMFsjCT8Yb0cnNK5DElXF3ADzgMMRWltE=", "sWMVr");
        am.lIIIIllIl[am.lIIIIlllI[3]] = am.llIllllllII("dzOfg7GlOVZFhwePydi2MCgQqHfc5JyS", "lVOnJ");
        am.lIIIIllIl[am.lIIIIlllI[4]] = am.llIllllllIl("GzwkKQA6K2ElCDon", "TLAGi");
        am.lIIIIllIl[am.lIIIIlllI[6]] = am.llIlllllIll("6h7uqtdKnw9SYCrHToFwZcoDdovaohzB", "EPRxj");
        am.lIIIIllIl[am.lIIIIlllI[12]] = am.llIllllllIl("FhB5KRMkVTQhEjIcNy9BMRw6IwA5ECpkQTICMDwCKRw3L0E1GnkKNBg8Fw8=", "AuYHa");
        am.lIIIIllIl[am.lIIIIlllI[13]] = am.llIllllllII("/8W/HsqKAcq8yvTmgsEHKg==", "IrJkS");
        am.lIIIIllIl[am.lIIIIlllI[14]] = am.llIllllllIl("Cx8sPyYmAyRvOiAKMA==", "OmCOV");
        am.lIIIIllIl[am.lIIIIlllI[16]] = am.llIlllllIll("3r15fx4pCJVTawfc0JJSgsVCatxJZLB+", "CYnDq");
        am.lIIIIllIl[am.lIIIIlllI[17]] = am.llIlllllIll("jz9bmX1k8DOhv4pidWQu7Q==", "wAeDe");
        am.lIIIIllIl[am.lIIIIlllI[18]] = am.llIllllllII("owYQsrCjglVvO7Lmb9zN7w==", "ztyRg");
        am.lIIIIllIl[am.lIIIIlllI[19]] = am.llIllllllII("fTVVuJCzmT1u5+v5KYl/vw==", "SoSbV");
        am.lIIIIllIl[am.lIIIIlllI[20]] = am.llIllllllIl("Eyg2DRAqLnoSFmQmOw1ZMDs/Awo=", "DIZfy");
        am.lIIIIllIl[am.lIIIIlllI[21]] = am.llIlllllIll("hQgSzZW6aG3TsBuFGG/+aw==", "ggVSO");
        am.lIIIIllIl[am.lIIIIlllI[22]] = am.llIlllllIll("WnIr2VA2FSV/n6hwuzs1RCgDmsZ9LsXc", "VPDFk");
        am.lIIIIllIl[am.lIIIIlllI[15]] = am.llIlllllIll("Uuvkr9jkaBO1qltYgB9X5Q==", "wDsLs");
        am.lIIIIllIl[am.lIIIIlllI[34]] = am.llIlllllIll("zoLhXqJVdlHLOBU1lKSwcw==", "ilUQS");
        am.lIIIIllIl[am.lIIIIlllI[36]] = am.llIllllllIl("MyMUIWouLFoxLyAmDi5qaQ==", "AJzFJ");
    }
                ...
                if (am.lllIIIIIIII(Bank.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (am.lllIIIIIIll(Inventory.getCount((int[])nArray))) {
                            ...
                            "".length();
                            if (null != null) {
                                return ((0x39 ^ 2 ^ (0x3A ^ 0x4F)) & (140 + 109 - 62 + 7 ^ 6 + 101 - 37 + 70 ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIIIlllI[0];
                        }
                ...
                if (am.lllIIIIIIII(Bank.contains((int[])nArray7) ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (am.lllIIIIIIll(Inventory.getCount((int[])nArray))) {
                            bl = lIIIIlllI[1];
                            "".length();
                            if (((0x29 ^ 0x24 ^ (2 ^ 0x54)) & (0x64 ^ 0x73 ^ (0x71 ^ 0x3D) ^ -" ".length())) != 0) {
                                return ((0xF2 ^ 0x87 ^ (0xFA ^ 0xAB)) & (28 + 12 - -35 + 107 ^ 70 + 61 - 64 + 79 ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIIIlllI[0];
                        }
                ...
                if (am.lllIIIIIIII(Bank.contains((int[])nArray9) ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (am.lllIIIIIIll(Inventory.getCount((int[])nArray))) {
                            ...
                            "".length();
                            if ("   ".length() < 0) {
                                return ((2 + 106 - -65 + 3 ^ 14 + 10 - -128 + 5) & (0xC ^ 0x36 ^ (5 ^ 0x12) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIIIlllI[0];
                        }
