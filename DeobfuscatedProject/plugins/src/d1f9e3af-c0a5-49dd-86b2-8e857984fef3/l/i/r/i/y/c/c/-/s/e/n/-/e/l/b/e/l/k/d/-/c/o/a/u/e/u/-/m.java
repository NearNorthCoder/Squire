...
implements W {
    ...
    private static void lIIlllIlIlII() {
        ...
        m.lIlllIlll[1] = " ".length();
        m.lIlllIlll[2] = "  ".length();
        m.lIlllIlll[3] = "   ".length();
    ...
    private static void lIIlllIlIIll() {
        ...
        m.lIlllIllI[m.lIlllIlll[0]] = m.lIIlllIIIlIl("MBcJCyMVQhkWKB8R", "rbpbM");
        m.lIlllIllI[m.lIlllIlll[1]] = m.lIIlllIIIlIl("NSwlPhwbIC93DQY8IjkIUyw/MgIAaWskGBoxKD8GHSJrNQ4QLmsjAFMoKjAGEGU/JQ4aKyI5CA==", "sEKWo");
        m.lIlllIllI[m.lIlllIlll[2]] = m.lIIlllIIIllI("7AOo6i1KGQL7Tor3S0n2X/Le40WyxU30", "SbgSY");
        m.lIlllIllI[m.lIlllIlll[3]] = m.lIIlllIIIllI("thO9i5zhFoT7s+1IVQ/5r/oCcKlGja3/", "pkbXV");
        m.lIlllIllI[m.lIlllIlll[6]] = m.lIIlllIIIllI("VqpEmvsAYujzvXBzbMDQu+mUoTTSNb07Ygcw80w/mpzlTk9nFxfLjdUfJUgVFe+W", "iWsgI");
        m.lIlllIllI[m.lIlllIlll[5]] = m.lIIlllIIIllI("ToT/B4+L40M=", "VqxKE");
        m.lIlllIllI[m.lIlllIlll[30]] = m.lIIlllIIIlll("Lo6TG54FQiI=", "MJvWq");
        m.lIlllIllI[m.lIlllIlll[32]] = m.lIIlllIIIlll("imqUFYEIAsI=", "qWNHe");
        m.lIlllIllI[m.lIlllIlll[33]] = m.lIIlllIIIllI("JbZTi0iqywU=", "HjONG");
        m.lIlllIllI[m.lIlllIlll[35]] = m.lIIlllIIIlIl("DwUmKCY=", "XlCDB");
        m.lIlllIllI[m.lIlllIlll[24]] = m.lIIlllIIIlIl("BgMJPCw=", "QjlPH");
        m.lIlllIllI[m.lIlllIlll[37]] = m.lIIlllIIIlIl("HwE7Bw==", "HdZuR");
        m.lIlllIllI[m.lIlllIlll[38]] = m.lIIlllIIIllI("hAj86+QXhzU=", "mBeLl");
        m.lIlllIllI[m.lIlllIlll[39]] = m.lIIlllIIIlIl("EhYvKg==", "EsNXM");
        m.lIlllIllI[m.lIlllIlll[40]] = m.lIIlllIIIlll("ti2CNWMSj2M=", "joIKz");
        m.lIlllIllI[m.lIlllIlll[42]] = m.lIIlllIIIlll("W0ENRTIg0Ok=", "wtfxi");
        m.lIlllIllI[m.lIlllIlll[43]] = m.lIIlllIIIllI("eFUuRYkQQsA=", "rcLTt");
        m.lIlllIllI[m.lIlllIlll[44]] = m.lIIlllIIIlll("dfgDv6dll40=", "UwSnw");
        m.lIlllIllI[m.lIlllIlll[45]] = m.lIIlllIIIllI("pD3bfwxK2Vg=", "pLMuX");
        m.lIlllIllI[m.lIlllIlll[60]] = m.lIIlllIIIlll("Oar845MABbjBoltjBvg0OA==", "STVxv");
        m.lIlllIllI[m.lIlllIlll[31]] = m.lIIlllIIIlIl("GSwMLUwEI0I9CQopFiJMQw==", "kEbJl");
        m.lIlllIllI[m.lIlllIlll[61]] = m.lIIlllIIIllI("f3fwvORauVA=", "NtXcC");
    }
    ...
    private static boolean ab() {
        ...
        block40: {
                                                ...
                                                block32: {
                                                    ...
                                                    block34: {
                                                                            ...
                                                                            block24: {
                                                                                ...
                                                                                block26: {
                                                                                                            ...
                                                                                                            block16: {
                                                                                                                ...
                                                                                                                block18: {
                                                                                                                    ...
                                                                                                                    if (m.lIIlllIlIlIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                                                                                        ...
                                                                                                                        return (("  ".length() ^ (0x24 ^ 0x3A)) & (0x2D ^ 0xC ^ (4 ^ 0x39) ^ -" ".length())) != 0;
                                                                                                                    }
                                                                                                                }
                                                                                                                n5 = lIlllIlll[0];
                                                                                                                return n5 != 0;
                                                                                    ...
                                                                                    if (m.lIIlllIlIlIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                                                        ...
                                                                                        return ((0x7C ^ 0x1C ^ "   ".length()) & (212 + 24 - 224 + 220 ^ 62 + 90 - 60 + 47 ^ -" ".length())) != 0;
                                                                                    }
                                                                                }
                                                                                n4 = lIlllIlll[0];
                                                                                return n4 != 0;
                                                        ...
                                                        if (m.lIIlllIlIlIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                            n3 = lIlllIlll[1];
                                                            "".length();
                                                            if (((0x93 ^ 0x87 ^ (0x9F ^ 0x82)) & (0xB0 ^ 0x80 ^ (0x70 ^ 0x49) ^ -" ".length())) < " ".length()) return n3 != 0;
                                                            return ((172 + 32 - 21 + 5 ^ 103 + 82 - 26 + 9) & (0x92 ^ 0xA5 ^ (0x7E ^ 0x5D) ^ -" ".length())) != 0;
                                                        }
                                                    }
                                                    n3 = lIlllIlll[0];
                                                    return n3 != 0;
            ...
            if (m.lIIlllIlIlIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                return ((0xA3 ^ 0x80 ^ (0xC1 ^ 0xA4)) & (94 + 102 - -49 + 5 ^ 130 + 96 - 137 + 99 ^ -" ".length())) != 0;
            }
        }
        n2 = lIlllIlll[0];
        return n2 != 0;
