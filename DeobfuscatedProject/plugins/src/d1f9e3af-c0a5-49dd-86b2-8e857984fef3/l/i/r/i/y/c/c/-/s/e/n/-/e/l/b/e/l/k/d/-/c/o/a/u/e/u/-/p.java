...
implements W {
            ...
            if (p.llllIIlIIII(p.ab() ? 1 : 0)) {
                ...
                List lIIIlIlIIIlllII = Arrays.stream(lIIIlIlIIIlllIl).filter(widget -> {
                    ...
                    if (p.llllIIlIIII(widget.getText().contains(lIIlIIIIl[lIIlIIIlI[14]]) ? 1 : 0) && p.llllIIllIII(widget.getTextColor(), cb)) {
                        n2 = lIIlIIIlI[0];
                        "".length();
                        if ("   ".length() <= ((74 + 62 - 53 + 67 ^ 21 + 67 - -18 + 50) & (55 + 150 - 33 + 8 ^ 69 + 158 - 129 + 92 ^ -" ".length()))) {
                            return ((0x63 ^ 0x6A ^ (0x55 ^ 0x7D)) & (0x23 ^ 0x70 ^ (0x6A ^ 0x18) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lIIlIIIlI[1];
                    }
                ...
                List lIIIlIlIIIllIll = Arrays.stream(lIIIlIlIIIlllIl).filter(widget -> {
                    ...
                    if (p.llllIIlIIII(widget.getText().contains(lIIlIIIIl[lIIlIIIlI[49]]) ? 1 : 0) && p.llllIIllIII(widget.getTextColor(), cb)) {
                        n2 = lIIlIIIlI[0];
                        "".length();
                        if ((0xD7 ^ 0x9A ^ (0x25 ^ 0x6C)) == ((0x8C ^ 0x89 ^ (0xE6 ^ 0x80)) & (150 + 1 - -36 + 65 ^ 24 + 28 - -106 + 1 ^ -" ".length()))) {
                            return ((0x8C ^ 0xAD ^ (0x2E ^ 0x37)) & (0x29 ^ 0x3F ^ (0x6F ^ 0x41) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lIIlIIIlI[1];
                    }
                ...
                List lIIIlIlIIIllIlI = Arrays.stream(lIIIlIlIIIlllIl).filter(widget -> {
                    ...
                    if (p.llllIIlIIII(widget.getText().contains(lIIlIIIIl[lIIlIIIlI[48]]) ? 1 : 0) && p.llllIIllIII(widget.getTextColor(), cb)) {
                        ...
                        "".length();
                        if ("   ".length() < "  ".length()) {
                            return ((52 + 35 - -101 + 2 ^ 8 + 2 - -143 + 27) & (129 + 128 - 114 + 1 ^ 45 + 151 - 183 + 141 ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lIIlIIIlI[1];
                    }
                ...
                List lIIIlIlIIIllIIl = Arrays.stream(lIIIlIlIIIlllIl).filter(widget -> {
                    ...
                    if (p.llllIIlIIII(widget.getText().contains(lIIlIIIIl[lIIlIIIlI[47]]) ? 1 : 0) && p.llllIIllIII(widget.getTextColor(), cb)) {
                        ...
                        "".length();
                        if (null != null) {
                            return ((0 ^ 0x4A ^ (0x5B ^ 0x5D)) & (0x68 ^ 4 ^ (4 ^ 0x24) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lIIlIIIlI[1];
                    }
    ...
    private static boolean ab() {
        ...
        while (p.llllIIlIIIl(lIIIlIlIIIlIIlI, ((void)lIIIlIlIIIlIIll).length)) {
            ...
            ++lIIIlIlIIIlIIlI;
            "".length();
            if (((0x42 ^ 0x56) & ~(0x4C ^ 0x58)) > -" ".length()) continue;
            return ((0x69 ^ 0x5A) & ~(0x5A ^ 0x69)) != 0;
        }
        return lIIlIIIlI[0];
    }
    ...
    private static String llllIIIllII(String lIIIlIIlllIIlll, String lIIIlIIlllIIIIl) {
        ...
        while (p.llllIIlIIIl(lIIIlIIllIllIll, lIIIlIIllIlllII)) {
            ...
            ++lIIIlIIllIllIll;
            "".length();
            if ((0xCC ^ 0x8E ^ (0xC6 ^ 0x80)) != "   ".length()) continue;
            return null;
        }
    ...
    private static void llllIIIllIl() {
        ...
        p.lIIlIIIIl[p.lIIlIIIlI[1]] = p.llllIIIlIlI("hjYYUMQ8WaMWsehiNXeQXIO+bbfo+D6JVGlYoE9NMqlJ+Y+lRwfgE8A4ougXa+BR", "MZarU");
        p.lIIlIIIIl[p.lIIlIIIlI[0]] = p.llllIIIlIll("c8nzQbvQBFF2nOdqh2HZ3A==", "buLPc");
        p.lIIlIIIIl[p.lIIlIIIlI[3]] = p.llllIIIlIlI("31QmZfadl5Q9lXnTyZsXcGAx+eAN331s", "abGRq");
        p.lIIlIIIIl[p.lIIlIIIlI[9]] = p.llllIIIlIll("YI/GUrkSJFL27dOk/dauaToZXrTPA+mCT5TVHtz+gKQi4QpPV//1/qTqThCPk/RBg+SoTpXwbwE=", "RlHtB");
        p.lIIlIIIIl[p.lIIlIIIlI[4]] = p.llllIIIlIlI("7OJSffH8bUI=", "GGzhj");
        p.lIIlIIIIl[p.lIIlIIIlI[5]] = p.llllIIIlIll("7NdYqRjvmRw=", "hXuuS");
        p.lIIlIIIIl[p.lIIlIIIlI[15]] = p.llllIIIllII("Kj4oIT0=", "yVISV");
        p.lIIlIIIIl[p.lIIlIIIlI[16]] = p.llllIIIlIlI("YWeiVyLYues=", "KortK");
        p.lIIlIIIIl[p.lIIlIIIlI[17]] = p.llllIIIlIll("jd0AB7nyiJ8=", "nmtdZ");
        p.lIIlIIIIl[p.lIIlIIIlI[23]] = p.llllIIIlIlI("WIeY3viyErtrGBt6RqxQElUyz9Xz6O8CVCfX29XyIsPtGPZN7GLgYtG/mNpaYsmv", "yuitn");
        p.lIIlIIIIl[p.lIIlIIIlI[12]] = p.llllIIIlIlI("uBsNkhqNRUCGIzwrpivVytpAcw87etIu", "LIdUO");
        p.lIIlIIIIl[p.lIIlIIIlI[24]] = p.llllIIIlIll("EX/iTcCUMSU=", "nlazU");
        p.lIIlIIIIl[p.lIIlIIIlI[25]] = p.llllIIIlIll("5VnNmaRkzKcz2nd/T4V9Gg==", "vBZKF");
        p.lIIlIIIIl[p.lIIlIIIlI[28]] = p.llllIIIlIll("TqC+658UUyrVwHHkPFaZIgMsuicqHZslWY7szcX6uXmEwQW8NXuAQQ==", "pTJwP");
        p.lIIlIIIIl[p.lIIlIIIlI[31]] = p.llllIIIllII("DSsjcSUsaiI0IjdqOjdxICsmJT0mZnUkPy8lNjpxET8yNjQnagE0IzErPD8=", "CJUQQ");
        p.lIIlIIIIl[p.lIIlIIIlI[34]] = p.llllIIIlIll("+166viA5irTRsESw5hV/ISjOdfQFXiQXTKEy/kGGyBLs5C1y64qgpku5E2P9e6zGmTe7dbG3q6hBw8ludatgGQ==", "IQrkN");
        p.lIIlIIIIl[p.lIIlIIIlI[43]] = p.llllIIIlIlI("XW5WYGbDSXA=", "kHmkO");
        p.lIIlIIIIl[p.lIIlIIIlI[44]] = p.llllIIIlIlI("g9mGoShtMUc=", "HhEPp");
        p.lIIlIIIIl[p.lIIlIIIlI[45]] = p.llllIIIlIll("qxBD8WuCuF21Txpr1ubXtZJHHUb+/Gqn", "mFLus");
        p.lIIlIIIIl[p.lIIlIIIlI[46]] = p.llllIIIllII("ID0ULTQWaCcvIwApGiQ=", "rHsJQ");
        p.lIIlIIIIl[p.lIIlIIIlI[39]] = p.llllIIIllII("JiE7Jng7LnU2PTUkISl4fA==", "THUAX");
        p.lIIlIIIIl[p.lIIlIIIlI[47]] = p.llllIIIllII("PBsaJQsN", "hrjQd");
        p.lIIlIIIIl[p.lIIlIIIlI[48]] = p.llllIIIlIll("xEnaGTX5E8Y=", "dCSMS");
        p.lIIlIIIIl[p.lIIlIIIlI[49]] = p.llllIIIlIlI("tuclxGE/htsOL+P72rFdF6hHfNLa+9kR", "vkHQP");
        p.lIIlIIIIl[p.lIIlIIIlI[14]] = p.llllIIIlIll("3XSXe27rZ3n1/lt78h6fww==", "tODkM");
        p.lIIlIIIIl[p.lIIlIIIlI[50]] = p.llllIIIlIll("9xGfz++4Bwg=", "RbQiI");
    ...
    public boolean V() {
        ...
        List list2 = Arrays.stream(widgetArray).filter(widget -> {
            ...
            if (p.llllIIlIIII(widget.getText().contains(lIIlIIIIl[lIIlIIIlI[45]]) ? 1 : 0) && p.llllIIllIII(widget.getTextColor(), cb)) {
                ...
                "".length();
                if ("   ".length() == " ".length()) {
                    return ((0x37 ^ 0x73 ^ (0x69 ^ 3)) & (0x75 ^ 0x38 ^ (0x43 ^ 0x20) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIlIIIlI[1];
            }
        ...
        List list3 = Arrays.stream(widgetArray).filter(widget -> {
            ...
            if (p.llllIIlIIII(widget.getText().contains(lIIlIIIIl[lIIlIIIlI[44]]) ? 1 : 0) && p.llllIIllIII(widget.getTextColor(), cb)) {
                ...
                "".length();
                if ("  ".length() <= 0) {
                    return ((0xF5 ^ 0xA6 ^ (0x33 ^ 0x48)) & (0x6C ^ 0x68 ^ (0x81 ^ 0xAD) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIlIIIlI[1];
            }
