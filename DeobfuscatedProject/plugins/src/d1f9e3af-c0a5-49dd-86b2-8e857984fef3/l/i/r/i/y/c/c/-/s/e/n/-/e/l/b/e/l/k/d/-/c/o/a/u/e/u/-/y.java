...
implements W {
    ...
    private static void lIIIIlIIlIlI() {
        ...
        y.lIIlllIll[y.lIIlllllI[1]] = y.lIIIIIlllIlI("CywGHgQlIAxXFTg8ARkQbSwcEho+aUgEACQxCx8eIyJIFRYuLkgDGG00HRIEOQ==", "MEhww");
        y.lIIlllIll[y.lIIlllllI[0]] = y.lIIIIIlllIll("BmHAkdc8jEhpdWSTKgM4Ew==", "iCNGm");
        y.lIIlllIll[y.lIIlllllI[5]] = y.lIIIIIllllII("f263DlpCTs/AyCMTEiyBtXOzlFkf8QxW", "sgJLv");
        y.lIIlllIll[y.lIIlllllI[10]] = y.lIIIIIlllIll("dA2Nwym6eVr3w9Z8Sca8aqAmEp34x9IU/Ll1NnLaJGAx+j6XEskEQqBW0fmWuFVCPa5P4gRcXqM=", "iznFt");
        y.lIIlllIll[y.lIIlllllI[6]] = y.lIIIIIlllIlI("DAUKDBE=", "Hwcbz");
        y.lIIlllIll[y.lIIlllllI[3]] = y.lIIIIIlllIll("7WlRqvp46Hk=", "Ccwwt");
        y.lIIlllIll[y.lIIlllllI[16]] = y.lIIIIIlllIll("ZB/P/Aby5h7e9xHrh0okwA==", "aykFv");
        y.lIIlllIll[y.lIIlllllI[17]] = y.lIIIIIlllIll("MBaKuw4gA8Po4hN8TSwjMA==", "vWeOm");
        y.lIIlllIll[y.lIIlllllI[18]] = y.lIIIIIllllII("ka0JFhtKGVwAyktn3Ot7yQ==", "Mbmnu");
        y.lIIlllIll[y.lIIlllllI[19]] = y.lIIIIIlllIlI("KDQ6RjcJdTgDLhY5KUYnCTo+", "fULfC");
        y.lIIlllIll[y.lIIlllllI[13]] = y.lIIIIIlllIll("QbdhD9xaY9UQWdDJgRfKcs3g/eqE2rLN", "TDKqv");
        y.lIIlllIll[y.lIIlllllI[20]] = y.lIIIIIllllII("jg7izyI8YcCzXXCtR7mWGg==", "SoNYD");
        y.lIIlllIll[y.lIIlllllI[21]] = y.lIIIIIlllIll("NfaaWTeyE5U=", "gcVmc");
        y.lIIlllIll[y.lIIlllllI[22]] = y.lIIIIIllllII("Uz2b/Fdv3f7SDZbQ93KXNg==", "rNivk");
        y.lIIlllIll[y.lIIlllllI[23]] = y.lIIIIIllllII("Qkd9fWnPWWtwSXkF6Z1vhA==", "qEIiw");
        y.lIIlllIll[y.lIIlllllI[24]] = y.lIIIIIlllIlI("LjERPjAVLAI=", "zCpNT");
        y.lIIlllIll[y.lIIlllllI[27]] = y.lIIIIIllllII("R+bTicQKGb83QNKyq2pBOQ==", "lgLoq");
        y.lIIlllIll[y.lIIlllllI[28]] = y.lIIIIIlllIll("++J7zV8pbVZkj7bPOEmTSQ==", "QkQDI");
        y.lIIlllIll[y.lIIlllllI[29]] = y.lIIIIIllllII("ykgEB0IDw3A=", "Ctefq");
        y.lIIlllIll[y.lIIlllllI[30]] = y.lIIIIIllllII("s/juM4qG8Vw=", "qoloe");
        y.lIIlllIll[y.lIIlllllI[31]] = y.lIIIIIllllII("c/eZ3E5ZuXtvllEmFHq4+w==", "uDYjY");
        y.lIIlllIll[y.lIIlllllI[32]] = y.lIIIIIlllIlI("Oj0OOSpUNQgjJg==", "yQgTH");
        y.lIIlllIll[y.lIIlllllI[33]] = y.lIIIIIllllII("6iabfqzBXqOdEyxRUSZYnQ==", "modwS");
        y.lIIlllIll[y.lIIlllllI[34]] = y.lIIIIIlllIll("nE1/EJZY6y0=", "cGpdE");
        y.lIIlllIll[y.lIIlllllI[35]] = y.lIIIIIlllIll("3yuKKwG880dlelVUgI/1aQ==", "mctTG");
        y.lIIlllIll[y.lIIlllllI[36]] = y.lIIIIIllllII("q8bjQ0pmBK8=", "TtGdF");
        y.lIIlllIll[y.lIIlllllI[37]] = y.lIIIIIlllIlI("KzwdMSsDPQc=", "fSsDF");
        y.lIIlllIll[y.lIIlllllI[38]] = y.lIIIIIllllII("f3ZblbkD0GE=", "mGxWn");
        y.lIIlllIll[y.lIIlllllI[39]] = y.lIIIIIllllII("JVbXyVxXdfSMHQ4JcoiuOM3Ni76AtciP", "jGHPD");
        y.lIIlllIll[y.lIIlllllI[40]] = y.lIIIIIlllIlI("ECYQLTE4KxAhLT5oACcsKw==", "YHdHC");
        y.lIIlllIll[y.lIIlllllI[41]] = y.lIIIIIlllIll("kE605NH6LLpwyMRe4TNDqg==", "zfvHi");
        y.lIIlllIll[y.lIIlllllI[42]] = y.lIIIIIlllIlI("GigKIA==", "UXoNp");
        y.lIIlllIll[y.lIIlllllI[43]] = y.lIIIIIlllIll("0B4DJ9qd3ty7JeZKb91IiA==", "BmPaB");
        y.lIIlllIll[y.lIIlllllI[44]] = y.lIIIIIlllIll("nHoRKrEJtOEr/mvTmLvynw==", "JRqRi");
        y.lIIlllIll[y.lIIlllllI[45]] = y.lIIIIIlllIll("tcF+OM/SGapHCE5WFSLONg==", "lDSMg");
        y.lIIlllIll[y.lIIlllllI[46]] = y.lIIIIIllllII("Gp1oohtOGEE54YC+bf/Lkw==", "oHfmN");
        y.lIIlllIll[y.lIIlllllI[47]] = y.lIIIIIllllII("XlC3jSo2BUvTgSRM1pIitw==", "RmiJA");
        y.lIIlllIll[y.lIIlllllI[48]] = y.lIIIIIlllIlI("OAUtIgUUGC0uGRZLPSgYAw==", "qkYGw");
        y.lIIlllIll[y.lIIlllllI[49]] = y.lIIIIIlllIlI("MCsrB1IXISgZ", "sNGkr");
        y.lIIlllIll[y.lIIlllllI[50]] = y.lIIIIIllllII("1t5jfM4EZ/I=", "rpRwb");
        y.lIIlllIll[y.lIIlllllI[51]] = y.lIIIIIllllII("JLBlv4pgxvq2QOM8R2vIfQ==", "lZpoZ");
        y.lIIlllIll[y.lIIlllllI[52]] = y.lIIIIIllllII("RAN1c/vUIZdWPDc+sYmpgQ==", "BFflJ");
        y.lIIlllIll[y.lIIlllllI[53]] = y.lIIIIIlllIll("/uiux7ax6HyXa7892aDyZfhR7gE6P3nK", "orHqC");
        y.lIIlllIll[y.lIIlllllI[55]] = y.lIIIIIlllIll("tjz4PNGtPis=", "qQGUz");
        y.lIIlllIll[y.lIIlllllI[56]] = y.lIIIIIllllII("V6QUpG+zOK0ET4FWVVOMHA==", "PaIgz");
        y.lIIlllIll[y.lIIlllllI[57]] = y.lIIIIIlllIlI("NzAf", "rQkjG");
        y.lIIlllIll[y.lIIlllllI[58]] = y.lIIIIIlllIll("Bm/ZdpUXUwQ=", "WwSSj");
        y.lIIlllIll[y.lIIlllllI[59]] = y.lIIIIIlllIlI("CCYPFTEhaQgULQ==", "OIcqT");
        y.lIIlllIll[y.lIIlllllI[60]] = y.lIIIIIllllII("BrA58KSdpXDKqvMWXv7kaQ==", "GKwMK");
        y.lIIlllIll[y.lIIlllllI[61]] = y.lIIIIIllllII("X4Fsvs5PNkZwDIYlGSqoWQ==", "aXafd");
        y.lIIlllIll[y.lIIlllllI[15]] = y.lIIIIIlllIlI("IgMXCVEAFAE=", "kqxgq");
        y.lIIlllIll[y.lIIlllllI[62]] = y.lIIIIIlllIll("rkvaZEI3lqFMrRqfl63ZQA==", "WkzYh");
        y.lIIlllIll[y.lIIlllllI[63]] = y.lIIIIIllllII("gg3q1Hg3yBEE59L1bTKGdA==", "zJPvk");
        y.lIIlllIll[y.lIIlllllI[64]] = y.lIIIIIlllIll("TnFmkL2oUUk=", "oOyTK");
        y.lIIlllIll[y.lIIlllllI[66]] = y.lIIIIIlllIll("pfFcliM1A7X7AE9EVHDPig==", "HOAmv");
        y.lIIlllIll[y.lIIlllllI[67]] = y.lIIIIIlllIlI("Jz4gGzBKPDMELBg=", "jKRpI");
        y.lIIlllIll[y.lIIlllllI[68]] = y.lIIIIIlllIlI("PzA+YSIecSIgPx0=", "qQHAV");
        y.lIIlllIll[y.lIIlllllI[69]] = y.lIIIIIlllIll("/MVpF9sXl0cfEtCRHpXTsmJ2WlXN1OIc", "SOdNA");
        y.lIIlllIll[y.lIIlllllI[70]] = y.lIIIIIlllIlI("Djk3IHAsLiE=", "GKXNP");
        y.lIIlllIll[y.lIIlllllI[71]] = y.lIIIIIlllIlI("LjUYDXQJPxsT", "mPtaT");
        y.lIIlllIll[y.lIIlllllI[72]] = y.lIIIIIllllII("xgEECPRwZA4=", "ZyfqN");
        y.lIIlllIll[y.lIIlllllI[73]] = y.lIIIIIlllIll("0Orc5SRCFGvfh+CnuGEMxQ==", "hAUCz");
        y.lIIlllIll[y.lIIlllllI[74]] = y.lIIIIIlllIll("RW2H5+4EmxWMQysnmbRbAA==", "ThPwu");
        y.lIIlllIll[y.lIIlllllI[75]] = y.lIIIIIllllII("KNYY4YR7ZWc=", "FGxcr");
        y.lIIlllIll[y.lIIlllllI[76]] = y.lIIIIIlllIll("K3UjOSZbroN5IpT3USlKAg==", "HqzMh");
        y.lIIlllIll[y.lIIlllllI[77]] = y.lIIIIIlllIll("QAerfHZa4GWejRYhqK1AUA==", "btysw");
        y.lIIlllIll[y.lIIlllllI[78]] = y.lIIIIIlllIll("Iqj5TKjjDOQ=", "cKvNk");
        y.lIIlllIll[y.lIIlllllI[79]] = y.lIIIIIllllII("UQkC90724Lld/stS5Wtxgw==", "vYfvf");
        y.lIIlllIll[y.lIIlllllI[80]] = y.lIIIIIllllII("zubkwNRERsE=", "DprBY");
        y.lIIlllIll[y.lIIlllllI[81]] = y.lIIIIIlllIlI("OAIOCzJNBgYRMB9RCAt1Dh4BAzwD", "mqgeU");
        y.lIIlllIll[y.lIIlllllI[82]] = y.lIIIIIlllIll("GnSAUvKBTQBD3eQeGBCwbg==", "jNNkO");
        y.lIIlllIll[y.lIIlllllI[83]] = y.lIIIIIlllIll("OJbGWj0okr3pAXiNxbfLPw==", "GtHxQ");
        y.lIIlllIll[y.lIIlllllI[84]] = y.lIIIIIlllIll("QYCI9gbUaHAaS3i7yo/PAw==", "rUKyr");
        y.lIIlllIll[y.lIIlllllI[85]] = y.lIIIIIlllIlI("AgYkNg==", "MvAXc");
        y.lIIlllIll[y.lIIlllllI[86]] = y.lIIIIIllllII("1cFRVj9KQtA=", "cUucr");
        y.lIIlllIll[y.lIIlllllI[87]] = y.lIIIIIllllII("1XoWWeE/ZejQQ/EFcKMAxw==", "auRkS");
        y.lIIlllIll[y.lIIlllllI[88]] = y.lIIIIIlllIll("Do4+IPCpLIc=", "PNbUV");
        y.lIIlllIll[y.lIIlllllI[89]] = y.lIIIIIlllIll("Ea4w5yk36+pIUarRTUp0jg==", "jITMl");
        y.lIIlllIll[y.lIIlllllI[90]] = y.lIIIIIlllIlI("NwYeCXcQDB0X", "tcreW");
        y.lIIlllIll[y.lIIlllllI[91]] = y.lIIIIIllllII("kQxu4GjnnDQ=", "FeVGK");
        y.lIIlllIll[y.lIIlllllI[92]] = y.lIIIIIlllIll("sMVYq/uVdI9KER0CbmqwuyD2fSFiReBq", "hVSUS");
        y.lIIlllIll[y.lIIlllllI[98]] = y.lIIIIIllllII("ndTRXhMDKW9BpaB4FZybPQ==", "jdtai");
        y.lIIlllIll[y.lIIlllllI[99]] = y.lIIIIIlllIll("1LO2xE0Yc40=", "chmnT");
        y.lIIlllIll[y.lIIlllllI[100]] = y.lIIIIIlllIlI("DDYPPg==", "CFjPU");
        y.lIIlllIll[y.lIIlllllI[101]] = y.lIIIIIllllII("Ezz+SQ+t9TRqmtsfRLczEA==", "uqCjc");
        y.lIIlllIll[y.lIIlllllI[102]] = y.lIIIIIlllIll("ZrSu/1QhJLb1+iKbBCEFZA==", "SmRQV");
        y.lIIlllIll[y.lIIlllllI[103]] = y.lIIIIIllllII("nF/v6fcbkJ6/NpHom1UCRg==", "PdoKJ");
        y.lIIlllIll[y.lIIlllllI[104]] = y.lIIIIIllllII("qkZNCn4tdMk=", "irnme");
        y.lIIlllIll[y.lIIlllllI[105]] = y.lIIIIIlllIll("uW66cVF7X2Dhjz44+Tv14w==", "xQMiR");
        y.lIIlllIll[y.lIIlllllI[106]] = y.lIIIIIllllII("8Dcnv8nACoq5HmM6JT76Qg==", "yyTBS");
        y.lIIlllIll[y.lIIlllllI[107]] = y.lIIIIIlllIlI("BxAiHzQv", "CbGeQ");
        y.lIIlllIll[y.lIIlllllI[108]] = y.lIIIIIllllII("O/v1a9UPG9W/GrQbzKpEaQ==", "iemVQ");
        y.lIIlllIll[y.lIIlllllI[109]] = y.lIIIIIlllIlI("IgouNwMMFih1DAoKKnUEFgs=", "exOUa");
        y.lIIlllIll[y.lIIlllllI[110]] = y.lIIIIIlllIlI("GCwFLE4tKgQsACs8", "HYwIn");
        y.lIIlllIll[y.lIIlllllI[111]] = y.lIIIIIlllIlI("PgYcazsfRwwiIRELSj8mHAI=", "pgjKO");
        y.lIIlllIll[y.lIIlllllI[112]] = y.lIIIIIlllIll("q6Gd7sraeBWVsOCB7tv7ig==", "xSWBO");
        y.lIIlllIll[y.lIIlllllI[113]] = y.lIIIIIlllIlI("ARkmCg==", "NiCdd");
        y.lIIlllIll[y.lIIlllllI[114]] = y.lIIIIIllllII("JrZgHwrgHNI=", "vSwhE");
        y.lIIlllIll[y.lIIlllllI[115]] = y.lIIIIIlllIlI("Gy0KFyZ1JQwNKg==", "XAczD");
        y.lIIlllIll[y.lIIlllllI[116]] = y.lIIIIIlllIll("xNcKwTo6icN+3hTZNEZv2g==", "UJPyX");
        y.lIIlllIll[y.lIIlllllI[117]] = y.lIIIIIlllIll("VOePodswSFglC2NlU/r6f/r7qULLDIdeHb8vgT9r8ezHHApVPWCBDA==", "FPrDs");
        y.lIIlllIll[y.lIIlllllI[119]] = y.lIIIIIlllIll("bG2DJx2ED2U=", "RFSds");
        y.lIIlllIll[y.lIIlllllI[127]] = y.lIIIIIlllIll("xzti46fP/BZQowC5Q5sX7w==", "wDAwU");
        y.lIIlllIll[y.lIIlllllI[128]] = y.lIIIIIlllIlI("EywGBwA6YwEGHA==", "TCjce");
        y.lIIlllIll[y.lIIlllllI[129]] = y.lIIIIIllllII("F9b8ElpiC4ZEWRRoOWZjGg==", "EVEwd");
        y.lIIlllIll[y.lIIlllllI[130]] = y.lIIIIIlllIlI("PRYuD3AfATg=", "tdAaP");
        y.lIIlllIll[y.lIIlllllI[131]] = y.lIIIIIllllII("in3nRPZD32N9Er5C8UrYUppdTGxIotqs", "tcLwc");
        y.lIIlllIll[y.lIIlllllI[2]] = y.lIIIIIlllIll("uHhxTwT4SburvnrG9wZcWw==", "AsUVO");
        y.lIIlllIll[y.lIIlllllI[132]] = y.lIIIIIllllII("rU2hHmXtmqg=", "tfrDQ");
        y.lIIlllIll[y.lIIlllllI[133]] = y.lIIIIIlllIll("NZim7yJN2yg=", "vJfql");
        y.lIIlllIll[y.lIIlllllI[134]] = y.lIIIIIlllIlI("DigNLCtgIAs2Jw==", "MDdAI");
        y.lIIlllIll[y.lIIlllllI[135]] = y.lIIIIIlllIlI("CjohASxkMicbIA==", "IVHlN");
        y.lIIlllIll[y.lIIlllllI[136]] = y.lIIIIIllllII("6yvQJk0/tHtxzMlV8+B46A==", "BDxtF");
        y.lIIlllIll[y.lIIlllllI[137]] = y.lIIIIIlllIll("4t6ox3CstsEpoLALxBxRiAImflJe40W6", "QXPTN");
        y.lIIlllIll[y.lIIlllllI[138]] = y.lIIIIIllllII("Fic/Ys5snYVsTwobciuPCw==", "mnWgN");
        y.lIIlllIll[y.lIIlllllI[139]] = y.lIIIIIllllII("ME8gaSc7/kg2kMYazuTt2fr8vLYJWICG", "SzNTT");
        y.lIIlllIll[y.lIIlllllI[140]] = y.lIIIIIlllIll("CV485KzBSHc=", "DeYAf");
        y.lIIlllIll[y.lIIlllllI[141]] = y.lIIIIIllllII("rWM1jZqo6q0=", "PvgYn");
        y.lIIlllIll[y.lIIlllllI[147]] = y.lIIIIIlllIlI("Bx86HxQjTRoURwcIIRML", "WmSzg");
        y.lIIlllIll[y.lIIlllllI[148]] = y.lIIIIIlllIlI("GTAgE1YEP24DEwo1OhxWQw==", "kYNtv");
        y.lIIlllIll[y.lIIlllllI[165]] = y.lIIIIIlllIll("lCv/y4zS3FQVDlZ8qbokwFF0JqtIO2JHMHaR0JsYO9Y=", "QKJat");
        y.lIIlllIll[y.lIIlllllI[166]] = y.lIIIIIlllIlI("IB8BXA==", "yzrrc");
        y.lIIlllIll[y.lIIlllllI[167]] = y.lIIIIIllllII("rQsX0TS4ue/TzB8vzVAIJpA48+Ra+SeK", "QBIEt");
        y.lIIlllIll[y.lIIlllllI[168]] = y.lIIIIIlllIll("REVDalNV4SxpaBeKO7XR8eMZENdfOcCxvwA12NNZQbB0/3d2vD9hcg==", "oBcqH");
        y.lIIlllIll[y.lIIlllllI[169]] = y.lIIIIIllllII("reYRKiT8rGk=", "rbtol");
        y.lIIlllIll[y.lIIlllllI[170]] = y.lIIIIIlllIlI("FT85XT4pcD4TKyQkYFo7KXAoFSJrJGI=", "LPLzL");
        y.lIIlllIll[y.lIIlllllI[171]] = y.lIIIIIllllII("glgRqBYq7wLwNH93MDxzkUNa7rm7y7eRBB9Fx6TH6yJzvHkyqOCwYjwDDnCil+0vzor5VUGXANA=", "mpFBU");
        y.lIIlllIll[y.lIIlllllI[172]] = y.lIIIIIlllIlI("PAEAIXRLEwQsLEsNH20xH0hMBHgGBRVtOg5EDS80DkQYIngDAQA9Zw==", "kdlMX");
        y.lIIlllIll[y.lIIlllllI[173]] = y.lIIIIIlllIll("hGEtmrR4j2VbOLFafAUQ5QgBlfOxBqIbriEGMvLn3dk=", "GFrSq");
        y.lIIlllIll[y.lIIlllllI[174]] = y.lIIIIIlllIlI("HxAiekcPUjx2FDMHNHg=", "FuQVg");
        y.lIIlllIll[y.lIIlllllI[175]] = y.lIIIIIlllIll("v132VA/8yzPgcjmszTtt7w==", "vLSuC");
        y.lIIlllIll[y.lIIlllllI[176]] = y.lIIIIIlllIll("d93EchajaeLWsiGXCffKnA==", "XhKLc");
        y.lIIlllIll[y.lIIlllllI[177]] = y.lIIIIIlllIll("eNVl/pj75REcD7SznKSttE+83M4dSiDee3kwzthbYRI=", "GAVgM");
        y.lIIlllIll[y.lIIlllllI[178]] = y.lIIIIIlllIlI("Ii0dcBcLLEoZVAInBiBL", "jBjPt");
        y.lIIlllIll[y.lIIlllllI[179]] = y.lIIIIIlllIlI("JgsjPCVUFyc+NVQJJ3A1G0QhOCQXD2I/L1QgMDU7EQhs", "tdBPA");
        y.lIIlllIll[y.lIIlllllI[180]] = y.lIIIIIlllIll("LOGPZkvGENlBJYruKqIxLCPisv7ssLI/Ytml/mR9jf+FLa/s2UYt7A==", "ncQsk");
        y.lIIlllIll[y.lIIlllllI[181]] = y.lIIIIIlllIll("vuHrWkDw2hktlipmZbzql+nU2LS1bZFD", "VTYzc");
        y.lIIlllIll[y.lIIlllllI[182]] = y.lIIIIIllllII("S4ke1LrdqJaYij1UbpBHBw==", "xkqoJ");
        y.lIIlllIll[y.lIIlllllI[183]] = y.lIIIIIllllII("vKCZ8DipD7E59Lwv/cc0o2J7VXldw8/8aotrQySB7l38Ac/lomCjiebvV8qxsCtJ", "XtSun");
        y.lIIlllIll[y.lIIlllllI[184]] = y.lIIIIIlllIlI("Owg0Ak9MGjAPF0wEK04KGEF4J0MBDCFOAQlNOQwPCU0sAUMECDQeXA==", "lmXnc");
    }
    ...
    public int T() {
        ...
        if (null != null) {
            return (0xC ^ 0x67 ^ (0xE6 ^ 0xC5)) & (0x89 ^ 0xC4 ^ (0xBE ^ 0xBB) ^ -" ".length());
        }
    ...
    private static void lIIIIlIIlllI() {
        ...
        y.lIIlllllI[0] = " ".length();
        y.lIIlllllI[1] = (86 + 56 - 49 + 35 ^ 65 + 154 - 80 + 58) & (0x15 ^ 0x3E ^ (0x49 ^ 0x27) ^ -" ".length());
        ...
        y.lIIlllllI[128] = "   ".length() ^ (0xC2 ^ 0xA6);
        ...
        y.lIIlllllI[135] = 0xE5 ^ 0x88 ^ "  ".length();
    ...
    private static void aY() {
        ...
        while (y.lIIIIlIlIIlI(dw.isEmpty() ? 1 : 0) && y.lIIIIlIlIIlI(dw.isEmpty() ? 1 : 0)) {
            ...
            if (y.lIIIIlIlIIII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                "".length();
                if (((2 ^ 0x21 ^ (0x66 ^ 0x17)) & (0x4E ^ 0x36 ^ (0x97 ^ 0xBD) ^ -" ".length())) == 0) break;
                return;
            }
            int[] nArray = new int[lIIlllllI[0]];
            ...
            if (y.lIIIIlIlIlIl(Inventory.getCount((int[])nArray))) {
                ...
                if (y.lIIIIlIlIlIl(Inventory.getCount((int[])nArray2))) {
                    ...
                    if (y.lIIIIlIlIIII(Inventory.contains((int[])nArray3) ? 1 : 0)) {
                        n2 = lIIlllllI[0];
                        "".length();
                        if ((0x7D ^ 0x14 ^ (0xF2 ^ 0x9F)) >= -" ".length()) return n2 != 0;
                        return (("   ".length() ^ (0x3B ^ 0x34)) & (0xAD ^ 0x9A ^ (0x9A ^ 0xA1) ^ -" ".length())) != 0;
                    }
                }
            }
        }
