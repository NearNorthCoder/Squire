...
implements W {
    ...
    public boolean V() {
        ...
        if (ai.lllllIIllII(Skills.getLevel((Skill)Skill.FIREMAKING), lIIlIllII[36])) {
            bl = lIIlIllII[1];
            "".length();
            if (((212 + 143 - 122 + 13 ^ 25 + 12 - -118 + 6) & (48 + 76 - -2 + 1 ^ (0x27 ^ 0xF) ^ -" ".length())) >= " ".length()) {
                return ((0xC1 ^ 0xBF ^ (0x57 ^ 0x34)) & (0xFA ^ 0x9A ^ (0x4C ^ 0x31) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIlIllII[0];
        }
    ...
    private static void lllllIIIllI() {
        ...
        ai.lIIlIllII[0] = (8 ^ 0x2A ^ (0x16 ^ 0x6C)) & (0x39 ^ 0x41 ^ (0xAC ^ 0x8C) ^ -" ".length());
        ai.lIIlIllII[1] = " ".length();
        ai.lIIlIllII[2] = "  ".length();
        ai.lIIlIllII[3] = "   ".length();
        ...
        ai.lIIlIllII[44] = "   ".length() ^ (0x95 ^ 0x81);
    ...
    private static void lllllIIIlII() {
        ...
        ai.lIIlIlIlI[ai.lIIlIllII[0]] = ai.lllllIIIIIl("Sn87OtWqrJn0rEFqRV/NJg==", "cnZDJ");
        ai.lIIlIlIlI[ai.lIIlIllII[1]] = ai.lllllIIIIlI("MfmWTQMsxoGyf+DsUazYmrPFhdNhUJ7I6mhPLVmy/1nTch2KiTjscJW9OIVCzFQCPael0WxGtcc=", "WHsRO");
        ai.lIIlIlIlI[ai.lIIlIllII[2]] = ai.lllllIIIIlI("iIoFGPcqUVhcA0er99sLpLQsWuq+/Ndt", "xmZRq");
        ai.lIIlIlIlI[ai.lIIlIllII[3]] = ai.lllllIIIIll("Gj8fACs7KFoMIzsk", "UOznB");
        ai.lIIlIlIlI[ai.lIIlIllII[5]] = ai.lllllIIIIll("HAYnMT89CS51MTUJIjw9Mw==", "TgIUS");
        ai.lIIlIlIlI[ai.lIIlIllII[6]] = ai.lllllIIIIIl("oRuqte+7759j26HmoHdVKBfwoL94gNsRVB+EyIpl7rJpJVaDuma0uYJ7nZypyhnT", "vgVLz");
        ai.lIIlIlIlI[ai.lIIlIllII[8]] = ai.lllllIIIIIl("64gYa++oFA2wbULS1KyZcYuIhFdouI9/", "BUkIF");
        ai.lIIlIlIlI[ai.lIIlIllII[9]] = ai.lllllIIIIIl("uvq6GhupwAs=", "VCtzs");
        ai.lIIlIlIlI[ai.lIIlIllII[10]] = ai.lllllIIIIlI("QnHls5Ki/fybL49My/Oftw==", "RaZXX");
        ai.lIIlIlIlI[ai.lIIlIllII[11]] = ai.lllllIIIIlI("Lqv9HrKIQfvw6012OlQ5M6DdwQujS6wr", "atHPm");
        ai.lIIlIlIlI[ai.lIIlIllII[12]] = ai.lllllIIIIlI("Hh6G5Cxs4rCCQ+Qi8F6SlQ==", "AwKQv");
        ai.lIIlIlIlI[ai.lIIlIllII[35]] = ai.lllllIIIIIl("ISxsCwQrsEidvb/S416EWw==", "iQbKx");
        ai.lIIlIlIlI[ai.lIIlIllII[37]] = ai.lllllIIIIIl("ontpCRFc52dzVDCJocr2rxtaqXqT4K6U", "Hzcvc");
    }
        ...
        if (ai.lllllIIllII(Skills.getLevel((Skill)Skill.FIREMAKING), lIIlIllII[14]) && ai.lllllIIlIII(Skills.getLevel((Skill)Skill.FIREMAKING), lIIlIllII[15])) {
            ...
            if (ai.lllllIIlIll(Inventory.getCount((int[])nArray))) {
                ...
                if (ai.lllllIIlIll(Inventory.getCount((int[])nArray2))) {
                    ...
                    return ((0x27 ^ 0x7D ^ (0x2F ^ 0x2A)) & (230 + 69 - 267 + 207 ^ 98 + 112 - 164 + 130 ^ -" ".length())) != 0;
                }
            }
            n3 = lIIlIllII[0];
            return n3 != 0;
        ...
        if (ai.lllllIIllII(Skills.getLevel((Skill)Skill.FIREMAKING), lIIlIllII[15]) && ai.lllllIIlIII(Skills.getLevel((Skill)Skill.FIREMAKING), lIIlIllII[17])) {
            ...
            if (ai.lllllIIlIll(Inventory.getCount((int[])nArray))) {
                ...
                if (ai.lllllIIlIll(Inventory.getCount((int[])nArray3))) {
                    n4 = lIIlIllII[1];
                    "".length();
                    if ((" ".length() ^ (0x5D ^ 0x58)) >= "  ".length()) return n4 != 0;
                    return ((68 + 68 - 80 + 93 ^ 33 + 102 - 10 + 20) & (58 + 46 - 9 + 89 ^ 6 + 13 - -104 + 65 ^ -" ".length())) != 0;
                }
            }
            n4 = lIIlIllII[0];
            return n4 != 0;
        ...
        if (ai.lllllIIllII(Skills.getLevel((Skill)Skill.FIREMAKING), lIIlIllII[17])) {
            ...
            if (ai.lllllIIlIll(Inventory.getCount((int[])nArray))) {
                ...
                if (ai.lllllIIlIll(Inventory.getCount((int[])nArray4))) {
                    n5 = lIIlIllII[1];
                    "".length();
                    if ("  ".length() <= (142 + 99 - 90 + 10 ^ 38 + 128 - 16 + 15)) return n5 != 0;
                    return ((0x30 ^ 0x16 ^ (0x51 ^ 0x33)) & (94 + 127 - 184 + 94 ^ 188 + 98 - 123 + 36 ^ -" ".length())) != 0;
                }
            }
            n5 = lIIlIllII[0];
            return n5 != 0;
