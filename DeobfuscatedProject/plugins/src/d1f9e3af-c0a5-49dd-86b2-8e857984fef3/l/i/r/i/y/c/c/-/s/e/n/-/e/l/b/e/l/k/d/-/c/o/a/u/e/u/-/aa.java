...
implements W {
    ...
    private static void lIlIIlIlIlll() {
        ...
        aa.llIIIlIIl[0] = (50 + 106 - 89 + 159 ^ 171 + 93 - 208 + 128) & (142 + 90 - 75 + 40 ^ 37 + 152 - 179 + 149 ^ -" ".length()) & ((0x1F ^ 7 ^ (0x51 ^ 0x70)) & (0xCE ^ 0x9B ^ (0xF8 ^ 0x94) ^ -" ".length()) ^ -" ".length());
        aa.llIIIlIIl[1] = " ".length();
        aa.llIIIlIIl[2] = 0x5A ^ 0x44 ^ (0x55 ^ 0x63);
        aa.llIIIlIIl[3] = "  ".length();
        aa.llIIIlIIl[4] = "   ".length();
    ...
    public boolean V() {
        ...
        if (aa.lIlIIlIllllI(Skills.getLevel((Skill)Skill.DEFENCE), llIIIlIIl[2])) {
            ...
            "".length();
            if ("  ".length() < "  ".length()) {
                return ((0x38 ^ 0x68 ^ (0xD2 ^ 0x8D)) & (95 + 83 - 55 + 35 ^ 41 + 11 - -45 + 48 ^ -" ".length())) != 0;
            }
        } else {
            bl = llIIIlIIl[0];
        }
    ...
    private static void lIlIIlIlIllI() {
        ...
        aa.llIIIlIII[aa.llIIIlIIl[0]] = aa.lIlIIlIlIIlI("hlv60RRF2JKNCxRpQ/NhrQ==", "PVpFH");
        aa.llIIIlIII[aa.llIIIlIIl[1]] = aa.lIlIIlIlIIll("IxMUDykNHx5GOBADEwg9RRMOAzcWVloVLQwOGQ4zCx1aBDsGEVoSNUUXHwo/AFoOFDsMFBMIPQ==", "ezzfZ");
        aa.llIIIlIII[aa.llIIIlIIl[3]] = aa.lIlIIlIlIIll("IA4lPyYPGzo4Jk4bPHYjDwE4", "noSVA");
        aa.llIIIlIII[aa.llIIIlIIl[4]] = aa.lIlIIlIlIIll("DSAYNC4sLxFwICQvHTksIg==", "EAvPB");
        aa.llIIIlIII[aa.llIIIlIIl[6]] = aa.lIlIIlIlIIll("NRNwLzMHVj0nMhEfPilhEQMgPi0LEyNiYREBOToiCh8+KWEWGXAMFDs/Hgk=", "bvPNA");
        aa.llIIIlIII[aa.llIIIlIIl[10]] = aa.lIlIIlIlIIll("CCMLDFMyMg0PGjUwFg==", "AQdbs");
        aa.llIIIlIII[aa.llIIIlIIl[14]] = aa.lIlIIlIlIlII("2TL507cEnRcFT6LO1+F2LQ==", "WrABP");
        aa.llIIIlIII[aa.llIIIlIIl[15]] = aa.lIlIIlIlIlII("7akQvdjze4lftYVmXpdFpbXdz9r9TFbL", "RuFGB");
        aa.llIIIlIII[aa.llIIIlIIl[18]] = aa.lIlIIlIlIIll("LCcC", "iFvYx");
        aa.llIIIlIII[aa.llIIIlIIl[20]] = aa.lIlIIlIlIlII("0FnK8qbSLc6OJ2OdK8pDIubfYNvuZyH0", "scnLF");
        aa.llIIIlIII[aa.llIIIlIIl[21]] = aa.lIlIIlIlIlII("opTAkz793dNK2dyKgHaiCQ==", "muUjo");
        aa.llIIIlIII[aa.llIIIlIIl[22]] = aa.lIlIIlIlIlII("IMakQsXj+xU=", "ZhWRo");
        aa.llIIIlIII[aa.llIIIlIIl[23]] = aa.lIlIIlIlIIll("BB4W", "gqanu");
        aa.llIIIlIII[aa.llIIIlIIl[24]] = aa.lIlIIlIlIlII("PCnod5jOCs4=", "KXDpD");
        aa.llIIIlIII[aa.llIIIlIIl[25]] = aa.lIlIIlIlIIlI("OJSUx/h5GQU=", "npyAX");
        aa.llIIIlIII[aa.llIIIlIIl[13]] = aa.lIlIIlIlIIll("GDsfKm4rKx8kIjAvHyA=", "YNkEN");
        aa.llIIIlIII[aa.llIIIlIIl[26]] = aa.lIlIIlIlIIll("", "AqpAP");
        aa.llIIIlIII[aa.llIIIlIIl[29]] = aa.lIlIIlIlIIlI("yhKrYWRFkyGyKmSZVFqRGw==", "gHppn");
        aa.llIIIlIII[aa.llIIIlIIl[30]] = aa.lIlIIlIlIlII("FitMnsP5NUAdSZfmihxvTg==", "kXMvX");
        aa.llIIIlIII[aa.llIIIlIIl[31]] = aa.lIlIIlIlIlII("I/5eqAGFWqI=", "cjUjp");
        aa.llIIIlIII[aa.llIIIlIIl[19]] = aa.lIlIIlIlIIlI("I7Aj+vbfzv6VDYVB+Zh4mg==", "wFoOm");
        aa.llIIIlIII[aa.llIIIlIIl[32]] = aa.lIlIIlIlIlII("5Kn+YlctT53cfXS99r9kDQ==", "waZqb");
        aa.llIIIlIII[aa.llIIIlIIl[33]] = aa.lIlIIlIlIlII("nLxNojG2jFg=", "UCeXp");
        aa.llIIIlIII[aa.llIIIlIIl[35]] = aa.lIlIIlIlIlII("31f4rW6aLmbk1Oqq7jIlry3RIqyPejFk", "GrnnJ");
        aa.llIIIlIII[aa.llIIIlIIl[36]] = aa.lIlIIlIlIlII("ZxzBiK+6Nv7oRUCEZlGAVK7r1IKPf0Qn", "XgljH");
        aa.llIIIlIII[aa.llIIIlIIl[37]] = aa.lIlIIlIlIIlI("r+JEpMgSFV4=", "brOrz");
        aa.llIIIlIII[aa.llIIIlIIl[38]] = aa.lIlIIlIlIIlI("HWd5PrtD5QQ=", "EqcyI");
        aa.llIIIlIII[aa.llIIIlIIl[39]] = aa.lIlIIlIlIIll("AR8XOwE=", "VvrWe");
        aa.llIIIlIII[aa.llIIIlIIl[41]] = aa.lIlIIlIlIIlI("LjSOBQ88zXA=", "QTtBS");
        aa.llIIIlIII[aa.llIIIlIIl[43]] = aa.lIlIIlIlIIlI("TeZxoYLkqVc=", "aGGmX");
        aa.llIIIlIII[aa.llIIIlIIl[34]] = aa.lIlIIlIlIIlI("IVSMG0ASuhQ=", "IwLZI");
        aa.llIIIlIII[aa.llIIIlIIl[46]] = aa.lIlIIlIlIIlI("KP7+s4/ieGw=", "ddgho");
        aa.llIIIlIII[aa.llIIIlIIl[48]] = aa.lIlIIlIlIlII("bmSkeJbggUs=", "zXJGf");
        aa.llIIIlIII[aa.llIIIlIIl[50]] = aa.lIlIIlIlIlII("09oZWe2NDHo=", "eHFsD");
        aa.llIIIlIII[aa.llIIIlIIl[57]] = aa.lIlIIlIlIlII("Cdls+77gHXE=", "NfvoG");
        aa.llIIIlIII[aa.llIIIlIIl[58]] = aa.lIlIIlIlIIll("Ch0j", "IrTLb");
    }
