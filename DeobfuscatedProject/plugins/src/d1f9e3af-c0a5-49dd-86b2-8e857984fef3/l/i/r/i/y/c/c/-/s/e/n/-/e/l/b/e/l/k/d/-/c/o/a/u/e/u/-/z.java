...
public class z {
            ...
            if (z.lllIIIIlllI(Equipment.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (z.lllIIIIlllI(Equipment.contains((int[])nArray2) ? 1 : 0)) {
                    ...
                    if (z.lllIIIIlllI(Equipment.contains((String[])stringArray2) ? 1 : 0)) {
                        ...
                        return ((0x90 ^ 0x9C ^ (0x94 ^ 0xA4)) & (74 + 28 - 40 + 66 ^ 178 + 82 - 173 + 101 ^ -" ".length())) != 0;
                    }
                }
            }
        }
                    ...
                    if (z.lllIIIIllll(Inventory.getCount((int[])nArray8), lIIIlIIIl[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (z.lllIIIlIIlI(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (null != null) {
                                    return ((0x77 ^ 0x4C ^ (0x74 ^ 0x65)) & (0xE1 ^ 0x9D ^ (0x6C ^ 0x3A) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIIlIIIl[0];
                            }
                    ...
                    if (z.lllIIIIllll(Inventory.getCount((int[])nArray10), lIIIlIIIl[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (z.lllIIIlIIlI(Inventory.getCount((int[])nArray))) {
                                bl = lIIIlIIIl[1];
                                "".length();
                                if (("   ".length() ^ (0x5A ^ 0x5D)) < " ".length()) {
                                    return ((82 + 24 - 47 + 191 ^ 99 + 164 - 209 + 123) & (0xE2 ^ 0x93 ^ (3 ^ 0x39) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIIlIIIl[0];
                            }
                    ...
                    if (z.lllIIIIllll(Inventory.getCount((int[])nArray12), lIIIlIIIl[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (z.lllIIIlIIlI(Inventory.getCount((int[])nArray))) {
                                bl = lIIIlIIIl[1];
                                "".length();
                                if (" ".length() < ((9 ^ 0x4D ^ (0x94 ^ 0xB0)) & (74 + 203 - 238 + 168 ^ 24 + 120 - 92 + 123 ^ -" ".length()))) {
                                    return ((1 ^ 0x17 ^ (0x42 ^ 0x5F)) & (32 + 19 - 42 + 156 ^ 102 + 20 - 70 + 122 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIIlIIIl[0];
                            }
            ...
            if (z.lllIIIIlllI(z.bh() ? 1 : 0)) {
                ...
                if (z.lllIIIlIIII(Bank.isOpen() ? 1 : 0)) {
                    ...
                    while (z.lllIIIIllll(lIIlIIIlIlIllIl, dz.length)) {
                        ...
                        ++lIIlIIIlIlIllIl;
                        "".length();
                        if (((0xBD ^ 0xAC ^ (0xFD ^ 0xB3)) & (213 + 213 - 357 + 164 ^ 55 + 36 - 20 + 111 ^ -" ".length())) == 0) continue;
                        return;
                    }
    ...
    private static void lllIIIIllIl() {
        ...
        z.lIIIlIIIl[0] = (0x22 ^ 0x1C ^ (0x1A ^ 0x67)) & (0x8E ^ 0xB6 ^ (0x54 ^ 0x2F) ^ -" ".length());
        z.lIIIlIIIl[1] = " ".length();
        z.lIIIlIIIl[2] = "  ".length();
        z.lIIIlIIIl[3] = "   ".length();
        ...
        z.lIIIlIIIl[21] = -"  ".length() & (0xFFFFECDF & 0x33FB);
        ...
        if (z.lllIIIIlllI(Inventory.contains((String[])stringArray) ? 1 : 0)) {
            ...
            if (z.lllIIIIlllI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (z.lllIIIIlllI(Inventory.contains((String[])stringArray2) ? 1 : 0) && z.lllIIIIlllI(Inventory.contains((int[])f.aN) ? 1 : 0)) {
                    ...
                    "".length();
                    if ("  ".length() >= 0) return n2 != 0;
                    return ((0x11 ^ 0x3B ^ (0x4D ^ 0x5B)) & (0x35 ^ 0x11 ^ (0x6F ^ 0x77) ^ -" ".length())) != 0;
                }
            }
        }
        n2 = lIIIlIIIl[0];
    ...
    private static void lllIIIIllII() {
        ...
        z.lIIIlIIII[z.lIIIlIIIl[0]] = z.lllIIIIlIIl("waGh2a5h+x1L4EppTLBkNQ==", "Xchgm");
        z.lIIIlIIII[z.lIIIlIIIl[1]] = z.lllIIIIlIlI("NwoLPgMZBgF3EgQaDDkXUQoRMh0CT0UkBxgXBj8ZHwRFNRESCEUjH1EEADYCGA0C", "qceWp");
        z.lIIIlIIII[z.lIIIlIIIl[2]] = z.lllIIIIlIIl("HetciSz5fgnr5tB86QuqB4ZfY1xuF2ME", "ECaoT");
        z.lIIIlIIII[z.lIIIlIIIl[3]] = z.lllIIIIlIlI("JCI6LT4LNyUqPko3I2Q7Cy0n", "jCLDY");
        z.lIIIlIIII[z.lIIIlIIIl[4]] = z.lllIIIIlIll("jHTCf5MDgRaxhoOK82xzcQ==", "gDsHC");
        z.lIIIlIIII[z.lIIIlIIIl[6]] = z.lllIIIIlIIl("XvlNKrX7Hw11WNKuCWSPxp0GHHwmDVvg", "XkuFn");
        z.lIIIlIIII[z.lIIIlIIIl[9]] = z.lllIIIIlIIl("B1z+veH/winJ6w+cFjUNXvJnHhHXNNB+gH8CaSCWJjxzOWE2J44UGyBy1J+/elkQDgpALl4wTds=", "ZLtpO");
        z.lIIIlIIII[z.lIIIlIIIl[10]] = z.lllIIIIlIIl("aQAhr5RKYdY=", "rnbfM");
        z.lIIIlIIII[z.lIIIlIIIl[11]] = z.lllIIIIlIlI("MDQiHQ==", "gQCoL");
        z.lIIIlIIII[z.lIIIlIIIl[12]] = z.lllIIIIlIll("a9FguoTlXCw=", "vIeiB");
        z.lIIIlIIII[z.lIIIlIIIl[13]] = z.lllIIIIlIlI("LxkVDyM=", "xppcG");
        z.lIIIlIIII[z.lIIIlIIIl[14]] = z.lllIIIIlIIl("m1qYK7N+3e8=", "zJQBv");
        z.lIIIlIIII[z.lIIIlIIIl[15]] = z.lllIIIIlIIl("+b6yvgAA4Rs=", "NKrcs");
        z.lIIIlIIII[z.lIIIlIIIl[17]] = z.lllIIIIlIIl("Nth2YGns8k5ACm2+P22NUQ==", "JWWTM");
        z.lIIIlIIII[z.lIIIlIIIl[18]] = z.lllIIIIlIIl("5etJ5UJOgoAbL+WoL4bfpA==", "wUQnU");
        z.lIIIlIIII[z.lIIIlIIIl[19]] = z.lllIIIIlIll("sQg8+WICTs/PFkaXrVBghQ==", "PbyQK");
        z.lIIIlIIII[z.lIIIlIIIl[20]] = z.lllIIIIlIlI("Bg4rMC0vGWojKSUdLzc=", "JkJDE");
        z.lIIIlIIII[z.lIIIlIIIl[38]] = z.lllIIIIlIll("BO5skaLuj6U=", "CQOsy");
        z.lIIIlIIII[z.lIIIlIIIl[39]] = z.lllIIIIlIlI("EQAkIg==", "FeEPu");
        z.lIIIlIIII[z.lIIIlIIIl[40]] = z.lllIIIIlIll("/5pITd5fBHVT7Gt//FOrrjrKUZWI6/GU", "QYPRp");
    }
}
