...
implements W {
                                ...
                                if (P.lIlIIIlllllI(Inventory.getCount((int[])nArray13), llIIIIllI[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (P.lIlIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                            bl = llIIIIllI[1];
                                            "".length();
                                            if (((0xC9 ^ 0x86 ^ "   ".length()) & (0xA6 ^ 0x97 ^ (0xCA ^ 0xB7) ^ -" ".length())) != 0) {
                                                return ((0xE2 ^ 0x9A ^ (0x15 ^ 0x33)) & (55 + 122 - 20 + 66 ^ 90 + 98 - 104 + 45 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = llIIIIllI[0];
                                        }
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (P.lIlIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                            ...
                                            if ((0x64 ^ 0x41 ^ (0x67 ^ 0x46)) == 0) {
                                                return ((0x40 ^ 5 ^ (0x27 ^ 0x41)) & (0xC7 ^ 0x9F ^ (0x25 ^ 0x5E) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = llIIIIllI[0];
                                        }
                                ...
                                if (P.lIlIIIlllllI(Inventory.getCount((int[])nArray19), llIIIIllI[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (P.lIlIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (" ".length() == -" ".length()) {
                                                return ((16 + 81 - -43 + 20 ^ 8 + 7 - -91 + 37) & (0x74 ^ 0x71 ^ (0x83 ^ 0xA9) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = llIIIIllI[0];
                                        }
                                ...
                                if (P.lIlIIIlllllI(Inventory.getCount((int[])nArray23), llIIIIllI[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (P.lIlIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                            bl = llIIIIllI[1];
                                            "".length();
                                            if (((0x32 ^ 0x20) & ~(0xD7 ^ 0xC5)) >= "   ".length()) {
                                                return ((0x36 ^ 0xA) & ~(0x4E ^ 0x72)) != 0;
                                            }
                                        } else {
                                            bl = llIIIIllI[0];
                                        }
                                ...
                                if (P.lIlIIIlllllI(Inventory.getCount((int[])nArray25), llIIIIllI[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (P.lIlIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                            bl = llIIIIllI[1];
                                            "".length();
                                            if (((0x72 ^ 0x6E) & ~(0xBD ^ 0xA1)) >= "  ".length()) {
                                                return ((0x2D ^ 0x1F) & ~(0x1C ^ 0x2E)) != 0;
                                            }
                                        } else {
                                            bl = llIIIIllI[0];
                                        }
                                ...
                                if (P.lIlIIIlllllI(Inventory.getCount((int[])nArray27), llIIIIllI[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (P.lIlIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                            bl = llIIIIllI[1];
                                            "".length();
                                            if (((22 + 115 - 67 + 163 ^ 49 + 97 - 69 + 90) & (0xA1 ^ 0x8F ^ (0xF5 ^ 0x95) ^ -" ".length())) > "   ".length()) {
                                                return ((152 + 19 - 9 + 0 ^ 102 + 168 - 194 + 108) & (0xEA ^ 0xB4 ^ (0xFF ^ 0xBB) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = llIIIIllI[0];
                                        }
                                ...
                                if (P.lIlIIIlllllI(Inventory.getCount((int[])nArray33), llIIIIllI[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (P.lIlIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                            bl = llIIIIllI[1];
                                            "".length();
                                            if ("  ".length() <= ((0x2C ^ 7 ^ (0xB2 ^ 0xC6)) & (106 + 71 - 99 + 74 ^ 137 + 130 - 127 + 59 ^ -" ".length()))) {
                                                return ((0xA ^ 0x1B ^ (0x1E ^ 0x20)) & (0xE0 ^ 0xA8 ^ (0xEE ^ 0x89) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = llIIIIllI[0];
                                        }
        ...
        if (P.lIlIIlIIIIII(lIlllIlllIIlII) && P.lIlIIIllllIl(lIlllIlllIIlII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (P.lIlIIIllllIl(Bank.isOpen() ? 1 : 0)) {
                ...
                while (P.lIlIIIllllll(z.bi() ? 1 : 0)) {
                    ...
                    "".length();
                    "".length();
                    if (((0xD1 ^ 0x80 ^ (0x29 ^ 0x5A)) & (0x3B ^ 8 ^ (0xB9 ^ 0xA8) ^ -" ".length())) < " ".length()) continue;
                    return;
                }
                if (P.lIlIIIllllll(Bank.isOpen() ? 1 : 0)) {
                    a.a();
                    ...
                    if (P.lIlIIIlllllI(Inventory.getCount((int[])nArray3), llIIIIllI[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (P.lIlIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                bl = llIIIIllI[1];
                                "".length();
                                if ("  ".length() <= ((0x2A ^ 0x7C) & ~(5 ^ 0x53))) {
                                    return ((0xA1 ^ 0x83) & ~(0x58 ^ 0x7A)) != 0;
                                }
                            } else {
                                bl = llIIIIllI[0];
                            }
                    ...
                    if (P.lIlIIIlllllI(Inventory.getCount((int[])nArray5), llIIIIllI[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (P.lIlIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (null != null) {
                                    return ((0x63 ^ 0x2E ^ (0x49 ^ 0x58)) & (147 + 9 - 121 + 175 ^ 104 + 116 - 136 + 58 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIIIIllI[0];
                            }
                    ...
                    if (P.lIlIIIlllllI(Inventory.getCount((int[])nArray13), llIIIIllI[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (P.lIlIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                bl = llIIIIllI[1];
                                "".length();
                                if (((0x59 ^ 0 ^ (0xFE ^ 0x84)) & (56 + 6 - -86 + 25 ^ 30 + 2 - -56 + 54 ^ -" ".length())) >= "   ".length()) {
                                    return ((0xB8 ^ 0x8C ^ (0x4D ^ 0x7D)) & (0x3A ^ 0x6B ^ (0x4A ^ 0x1F) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIIIIllI[0];
                            }
                    ...
                    if (P.lIlIIIlllllI(Inventory.getCount((int[])nArray17), llIIIIllI[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (P.lIlIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                bl = llIIIIllI[1];
                                "".length();
                                if (((0x42 ^ 0x62 ^ (0x83 ^ 0x87)) & (0x27 ^ 0x6A ^ (0x34 ^ 0x5D) ^ -" ".length())) != 0) {
                                    return ((0x48 ^ 0x26 ^ (0xED ^ 0x9E)) & (51 + 150 - 57 + 32 ^ 49 + 95 - 127 + 156 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIIIIllI[0];
                            }
                    ...
                    if (P.lIlIIIlllllI(Inventory.getCount((int[])nArray19), llIIIIllI[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (P.lIlIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (null != null) {
                                    return ((105 + 122 - 72 + 64 ^ 12 + 104 - -17 + 63) & (0x32 ^ 0xD ^ (0xAC ^ 0x8C) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIIIIllI[0];
                            }
    ...
    private static void lIlIIIllllII() {
        ...
        P.llIIIIllI[0] = (0x76 ^ 0x23 ^ (0x76 ^ 0x3F)) & (0x51 ^ 0x15 ^ (0x70 ^ 0x28) ^ -" ".length());
        P.llIIIIllI[1] = " ".length();
        P.llIIIIllI[2] = 3 + 64 - -21 + 72;
        P.llIIIIllI[3] = "  ".length();
        P.llIIIIllI[4] = "   ".length();
        ...
        P.llIIIIllI[72] = 0x89 ^ 0xA4 ^ " ".length();
        ...
        P.llIIIIllI[81] = "   ".length() ^ (0xB8 ^ 0x8E);
    ...
    public boolean V() {
        ...
        if (P.lIlIIlIIIlIl(e.j(llIIIIllI[2]), llIIIIllI[3])) {
            bl = llIIIIllI[1];
            "".length();
            if (((0xF0 ^ 0x82 ^ (0x67 ^ 0x26)) & (0x6A ^ 0x67 ^ (0x9A ^ 0xA4) ^ -" ".length())) != 0) {
                return ((133 + 119 - 182 + 92 ^ 105 + 53 - 134 + 131) & (0xCD ^ 0x9E ^ (0xCA ^ 0xA0) ^ -" ".length())) != 0;
            }
        } else {
            bl = llIIIIllI[0];
        }
    ...
    private static void lIlIIIlllIll() {
        ...
        P.llIIIIlII[P.llIIIIllI[0]] = P.lIlIIIllIlIl("t4zfNTV4J5J6BSbkBBukSg==", "pLMzM");
        P.llIIIIlII[P.llIIIIllI[1]] = P.lIlIIIllIllI("HBsJASYyFwNINy8LDgYyehsTDTgpXkcbIjMGBAA8NBVHCjQ5GUccOnoDEg0mLhsJDw==", "ZrghU");
        P.llIIIIlII[P.llIIIIllI[3]] = P.lIlIIIllIlIl("vsLHg29MR+8y5CHYjcgYQueel1mH0Iz3", "pJzzw");
        P.llIIIIlII[P.llIIIIllI[4]] = P.lIlIIIllIllI("PSc0PC8cMHEwJxw8", "rWQRF");
        P.llIIIIlII[P.llIIIIllI[6]] = P.lIlIIIllIlll("tPDy5oO0Tu/9w/orFTCVEoF5U9Xnq/ZN", "Qhegr");
        P.llIIIIlII[P.llIIIIllI[9]] = P.lIlIIIllIlIl("k/bGz8vnw/OcdP7ubzvnnpnKverjwFXRJXARynPIKEHFUsyzncSCRI3JLUhqfiHM", "IUfRa");
        P.llIIIIlII[P.llIIIIllI[12]] = P.lIlIIIllIlIl("3PvROzJnI/lmczca8ZTrjsoXMSTaEJYpDT5ZnlLdPub6Y7P8rbvaJONGHsWiRrJl", "PAJmD");
        P.llIIIIlII[P.llIIIIllI[14]] = P.lIlIIIllIllI("BABGKTY2RQshNyAMCC9kIBAWOCg6ABVkZCASDzwnOwwIL2QnCkYKEQosKA8=", "SefHD");
        P.llIIIIlII[P.llIIIIllI[16]] = P.lIlIIIllIllI("IhNqAwoQVicLCwYfJAVYBgM6EhQcEzlOWAYBIxYbHR8kBVgBGWogLSw/BCU=", "uvJbx");
        P.llIIIIlII[P.llIIIIllI[18]] = P.lIlIIIllIlll("iVpy9BbLXjQh/MwJ7gL4/QpdlcLy7AvBwVGvpcfDqna4R8zvJTusAq+Y5/LnRquj", "oSsQY");
        P.llIIIIlII[P.llIIIIllI[8]] = P.lIlIIIllIlll("Hx/knsAHtgoeqdmGyY7IeLVewYUlQauYeuMIj4+EOpYKtUxKlocyF+xr4yx6kX6O", "UqFSq");
        P.llIIIIlII[P.llIIIIllI[19]] = P.lIlIIIllIllI("EC8YCS0pKVQWK2cnGRJkNDoVEDA=", "GNtbD");
        P.llIIIIlII[P.llIIIIllI[32]] = P.lIlIIIllIlIl("WzLEZeGkDIX8BK4bJMhzOg==", "Jpfhe");
        P.llIIIIlII[P.llIIIIllI[33]] = P.lIlIIIllIllI("Cxw2JBM=", "NrBAa");
        P.llIIIIlII[P.llIIIIllI[34]] = P.lIlIIIllIlIl("tQgdzVPKIoQDzRFKmPn6jw==", "AWWnI");
        P.llIIIIlII[P.llIIIIllI[31]] = P.lIlIIIllIlIl("w3Gk8kdhV01/UQhCK7c7ug==", "SAGFS");
        P.llIIIIlII[P.llIIIIllI[35]] = P.lIlIIIllIlll("pMhHh6SlQPrWAqOw2cz8vg==", "JTyNl");
        P.llIIIIlII[P.llIIIIllI[36]] = P.lIlIIIllIlll("tkdtOOvRTMA+OWQ4u9lusIjMdEcmQPP/xIXMk/GokJQ=", "BQnvt");
        P.llIIIIlII[P.llIIIIllI[38]] = P.lIlIIIllIlll("iL7+osjI21T7MNv5rPA2SKFLKj2sxAUNBcBU56/vb00=", "KKIwa");
        P.llIIIIlII[P.llIIIIllI[40]] = P.lIlIIIllIlIl("REQzb6mR+lpgOkivKWyjoXILoVgf0FW8AbctO9temEY=", "poZdA");
        P.llIIIIlII[P.llIIIIllI[30]] = P.lIlIIIllIllI("LAYiHDcKQjEdMBkHZhc8DAZmATZNADMMeQELNQE=", "mbFuY");
        P.llIIIIlII[P.llIIIIllI[41]] = P.lIlIIIllIlll("kmX78TEcg/Z6fln4esDK97SQTvDyt86f8sYsCWxTdl0=", "ENutW");
        P.llIIIIlII[P.llIIIIllI[44]] = P.lIlIIIllIlll("7iY+QBGmgD/qAip181SztMnK1aomnxSgzXk9MWtRtBA=", "RNSJN");
        P.llIIIIlII[P.llIIIIllI[46]] = P.lIlIIIllIlIl("Fbg6kpouF3uI/BWVeIYRLbdWGESHe6qtAI4GGtcxxcA=", "tiIRr");
        P.llIIIIlII[P.llIIIIllI[48]] = P.lIlIIIllIlIl("5tIkVDaPw3oooxOiPTeW0tVkqKIhYXOT5Rh7gggrKgQ=", "OtrDT");
        P.llIIIIlII[P.llIIIIllI[49]] = P.lIlIIIllIlIl("kxnKme0yEbh5qdf/ls8H9qne7F0ui9bfqH6oue88gsU=", "ipspd");
        P.llIIIIlII[P.llIIIIllI[52]] = P.lIlIIIllIlll("MD74Ml0s68gGcLwDvuNnqM6uzBN1rhRMy0QeVK0LvvU=", "ZLgQT");
        P.llIIIIlII[P.llIIIIllI[54]] = P.lIlIIIllIlll("0WSKfx2nN0+vW6EmOSQs/n85jOqIb+TOrGYE5S49Ol0=", "iBkei");
        P.llIIIIlII[P.llIIIIllI[55]] = P.lIlIIIllIllI("ODIoADoedioIOBUvbB01GyVsHTtZNDkQdBU/Px0=", "yVLiT");
        P.llIIIIlII[P.llIIIIllI[56]] = P.lIlIIIllIllI("CwosABotTjsdFScHJggHahonSRY/F2gFHTka", "JnHit");
        P.llIIIIlII[P.llIIIIllI[57]] = P.lIlIIIllIllI("JSoJPAkDbgA8CQBuHyAJAT1NIQhELBgsRwgnHiE=", "dNmUg");
        P.llIIIIlII[P.llIIIIllI[60]] = P.lIlIIIllIlIl("t4kSUtC7WXLrPAUuXFVDJoV1oS7wqQW8NmwBtdfJHHA=", "roJHD");
        P.llIIIIlII[P.llIIIIllI[61]] = P.lIlIIIllIlll("X/BKMdeX5u/t+c9aCiS/Q8FfpRyadnrxVfM3zIMEbPM=", "jizyD");
        P.llIIIIlII[P.llIIIIllI[62]] = P.lIlIIIllIlll("k4te4mvkPBUR+8Kqz3MA43Q5oVsyQFMJTVy88QpLwYg=", "vBqQw");
        P.llIIIIlII[P.llIIIIllI[63]] = P.lIlIIIllIlll("PgemuZT5C1E8PVWTwlk7TfOuy2xTcWiQfsHTbz7/dOA=", "tLZRS");
        P.llIIIIlII[P.llIIIIllI[64]] = P.lIlIIIllIllI("NiAPHRQQZBwVDhI2SwYPGSEYVA4YZAkBA1coAgcO", "wDktz");
        P.llIIIIlII[P.llIIIIllI[65]] = P.lIlIIIllIlll("PuegpO9UnAuRXmZpL7VwAtz/iQzOydlhmvYQ3B1/xno=", "wmiwL");
        P.llIIIIlII[P.llIIIIllI[66]] = P.lIlIIIllIlIl("qA66SXjjEGPCbqB6eiJHT6qmwdLYaUxlbP+OriBcvpo=", "XPqNU");
        P.llIIIIlII[P.llIIIIllI[67]] = P.lIlIIIllIlIl("VLBCR+X7Cd4G1hUy8AMLFA==", "YFTry");
        P.llIIIIlII[P.llIIIIllI[68]] = P.lIlIIIllIlIl("q/j5QGVCyRb+16l1+bI0Ag==", "gVCbf");
        P.llIIIIlII[P.llIIIIllI[45]] = P.lIlIIIllIllI("FgYXOwN0CBM5DA==", "TjvXh");
        P.llIIIIlII[P.llIIIIllI[69]] = P.lIlIIIllIllI("NCYoOjZDLCQvNw==", "cNANS");
        P.llIIIIlII[P.llIIIIllI[70]] = P.lIlIIIllIllI("CQ4nPQQv", "JfBXw");
        P.llIIIIlII[P.llIIIIllI[71]] = P.lIlIIIllIllI("BCwDOCsrORw/K2o5GnEuKyMe", "JMuQL");
        P.llIIIIlII[P.llIIIIllI[72]] = P.lIlIIIllIllI("GhwKFho7C08aEjsH", "Uloxs");
        P.llIIIIlII[P.llIIIIllI[73]] = P.lIlIIIllIlll("hb2IVAXMvLyTqPEHlTOVTleEWZu0BY1e", "DFmwT");
        P.llIIIIlII[P.llIIIIllI[74]] = P.lIlIIIllIlIl("FipbkHUp47wmQf+CSlZwxg==", "gRHVI");
        P.llIIIIlII[P.llIIIIllI[75]] = P.lIlIIIllIlIl("6Y65trNr8roN9u+QM5JA9w==", "adIaJ");
        P.llIIIIlII[P.llIIIIllI[76]] = P.lIlIIIllIlIl("17eOrop82rCtCLt6uTg3XzjVkMU2llWpe16COCfm3LDAQgjcCPwBTTYVnbVbqoJM", "UPkYM");
        P.llIIIIlII[P.llIIIIllI[77]] = P.lIlIIIllIlIl("qwzJ1apByOeBE4I3+mKQww==", "vUZxn");
        P.llIIIIlII[P.llIIIIllI[78]] = P.lIlIIIllIllI("JyMYPCtCMB8mJg==", "bBjHC");
        P.llIIIIlII[P.llIIIIllI[79]] = P.lIlIIIllIlll("Mb3/KumyjIdmlyxSsQ/C2ANi4DKc03agky2A1HE3Ik/NHWmEI3GlMI9p3FNfdWb7", "lyDjs");
        P.llIIIIlII[P.llIIIIllI[80]] = P.lIlIIIllIlll("Neec1sEd5/nd46suPZS9Xg==", "yDxyy");
        P.llIIIIlII[P.llIIIIllI[81]] = P.lIlIIIllIllI("JBkWMAdTChc7EA==", "sxbUu");
        P.llIIIIlII[P.llIIIIllI[82]] = P.lIlIIIllIllI("BT95DgA3ejQGASEzNwhSIS8pHx47PypDUiEtMBsROjM3CFImNXktJwsTFyg=", "RZYor");
        P.llIIIIlII[P.llIIIIllI[83]] = P.lIlIIIllIlll("EHfP/WTpjk/8J82BlYV5jsrZebWrTB5pZsWxkii/efOtmeEAJqnVm9+u4i0BgtPr", "BiqXl");
        P.llIIIIlII[P.llIIIIllI[84]] = P.lIlIIIllIllI("OwkzRwsTECAPLQBEMhItARA=", "rdCgH");
        P.llIIIIlII[P.llIIIIllI[85]] = P.lIlIIIllIlll("r/qFMys7T5iEYY8CG3qpuuPGmyj3AV7L", "nzFlG");
        P.llIIIIlII[P.llIIIIllI[89]] = P.lIlIIIllIllI("PCYSJgcPbyUuDwwgDw==", "kOhGu");
        P.llIIIIlII[P.llIIIIllI[90]] = P.lIlIIIllIllI("BQMiFGovD3QQajMfMQI+Yho4FCsxD3o=", "BjTqJ");
        P.llIIIIlII[P.llIIIIllI[91]] = P.lIlIIIllIlll("CUbkN2yRTMJ09N5GgRRbwQ==", "ujkkX");
        P.llIIIIlII[P.llIIIIllI[92]] = P.lIlIIIllIlll("OgqQzd/mTXfW3QjqoHXv/J+5dXq7puM1tY5NwZ3usaUbVsCIiZdPNRQcd+GU9vPq", "WqQLp");
        P.llIIIIlII[P.llIIIIllI[93]] = P.lIlIIIllIllI("HR02Qw==", "DxEmO");
        P.llIIIIlII[P.llIIIIllI[94]] = P.lIlIIIllIlll("Qi9R6ak+u3Ve7INCYRVJHQKr+1QgkVu+", "mRnRw");
        P.llIIIIlII[P.llIIIIllI[95]] = P.lIlIIIllIlll("EyFpFwNouZkbW8Ugx/U5b5HiUdMLH17vwgdfYmekPG4=", "dEPEx");
    }
}
