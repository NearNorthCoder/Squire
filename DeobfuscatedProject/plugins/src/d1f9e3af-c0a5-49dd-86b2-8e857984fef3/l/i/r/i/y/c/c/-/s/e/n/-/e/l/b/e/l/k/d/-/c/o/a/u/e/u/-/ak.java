...
implements W {
    ...
    private static void lIlIIIIIlllI() {
        ...
        ak.lIlllllll[ak.llIIIIIII[0]] = ak.lIlIIIIIlIll("UeA0ZDDJ77f6TRdlfF5boA==", "SJicU");
        ak.lIlllllll[ak.llIIIIIII[1]] = ak.lIlIIIIIllII("IRgoHREPFCJUABIILxoFRxgyEQ8UXWYHFQ4FJRwLCRZmFgMEGmYADUccLxoLCRY=", "gqFtb");
        ak.lIlllllll[ak.llIIIIIII[2]] = ak.lIlIIIIIllII("GiQ6BTY1MSUCNnQxI0wzNSsn", "TELlQ");
        ak.lIlllllll[ak.llIIIIIII[3]] = ak.lIlIIIIIllIl("GElKRtemJZZz59bahAHsS1i7nG+QcObH", "iHGPS");
        ak.lIlllllll[ak.llIIIIIII[5]] = ak.lIlIIIIIlIll("lS+JOSyJJccg5aLA+mGjeMYI216aDMDk+AZGLWOHSwFfz8tOjxsJunOxA+c8gDIm", "bJqPX");
        ak.lIlllllll[ak.llIIIIIII[23]] = ak.lIlIIIIIllIl("p3crquDj8ZW+h5o+GqMFQw==", "vMLdy");
        ak.lIlllllll[ak.llIIIIIII[21]] = ak.lIlIIIIIlIll("gUtkfRi1wDOSrRzpSZiB7Q==", "VdChr");
        ak.lIlllllll[ak.llIIIIIII[25]] = ak.lIlIIIIIlIll("0O13hgmjyZ+LGUKNw7fthw==", "vyZqM");
        ak.lIlllllll[ak.llIIIIIII[26]] = ak.lIlIIIIIllIl("x4GKKNpigac=", "mfCOQ");
        ak.lIlllllll[ak.llIIIIIII[27]] = ak.lIlIIIIIllIl("IMYv8b0bVB2vVjdLYw4K7Hp9dmBi4aDa", "onxzl");
        ak.lIlllllll[ak.llIIIIIII[28]] = ak.lIlIIIIIllII("Gw0eJgoxRBk9Czg=", "VdpOd");
        ak.lIlllllll[ak.llIIIIIII[29]] = ak.lIlIIIIIlIll("1QdP8Ky/+kk=", "luQGi");
        ak.lIlllllll[ak.llIIIIIII[41]] = ak.lIlIIIIIlIll("kqad8rjadSg=", "OUNmT");
        ak.lIlllllll[ak.llIIIIIII[43]] = ak.lIlIIIIIllIl("kldaD8u7+PShLwJ2DnoI07qOQawH3p++", "daKiN");
    }
    ...
    public boolean V() {
        ...
        if (ak.lIlIIIIlIllI(Skills.getLevel((Skill)Skill.MINING), llIIIIIII[42])) {
            ...
            "".length();
            if (-" ".length() == " ".length()) {
                return ((0x6E ^ 0x16 ^ (0x39 ^ 0xB)) & (0x57 ^ 0x18 ^ (0xF ^ 0xA) ^ -" ".length())) != 0;
            }
        } else {
            bl = llIIIIIII[0];
        }
            ...
            if (ak.lIlIIIIlIlIl(Inventory.getCount((int[])nArray))) {
                ...
                if (ak.lIlIIIIlIlIl(Inventory.getCount((int[])nArray3))) {
                    ...
                    if (ak.lIlIIIIlIlIl(Inventory.getCount((int[])nArray4))) {
                        ...
                        return ((0x30 ^ 0x6B ^ (0x43 ^ 0x23)) & (116 + 50 - 164 + 135 ^ 167 + 157 - 311 + 165 ^ -" ".length())) != 0;
                    }
                }
            }
            n4 = llIIIIIII[0];
                ...
                if (ak.lIlIIIIlIlIl(Inventory.getCount((int[])nArray9))) {
                    ...
                    if (ak.lIlIIIIlIlIl(Inventory.getCount((int[])nArray10))) {
                        ...
                        if (ak.lIlIIIIlIlIl(Inventory.getCount((int[])nArray11))) {
                            ...
                            return ((145 + 195 - 147 + 3 ^ 142 + 64 - 105 + 42) & (80 + 127 - 94 + 101 ^ 112 + 133 - 161 + 73 ^ -" ".length())) != 0;
                        }
                    }
                }
            }
    ...
    private static void lIlIIIIlIIII() {
        ...
        ak.llIIIIIII[0] = (23 + 152 - 150 + 181 ^ 7 + 146 - 138 + 181) & (47 + 122 - 0 + 20 ^ 106 + 29 - 93 + 141 ^ -" ".length());
        ak.llIIIIIII[1] = " ".length();
        ak.llIIIIIII[2] = "  ".length();
        ak.llIIIIIII[3] = "   ".length();
                    ...
                    if (ak.lIlIIIIlIIIl(Bank.contains((int[])nArray11) ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (ak.lIlIIIIlIlIl(Inventory.getCount((int[])nArray))) {
                                bl = llIIIIIII[1];
                                "".length();
                                if ((0x43 ^ 0x47) < (" ".length() & ~" ".length())) {
                                    return ((0x52 ^ 0x12) & ~(0x83 ^ 0xC3)) != 0;
                                }
                            } else {
                                bl = llIIIIIII[0];
                            }
                    ...
                    if (ak.lIlIIIIlIIIl(Bank.contains((int[])nArray12) ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (ak.lIlIIIIlIlIl(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if ("  ".length() == 0) {
                                    return ((0x53 ^ 0xE ^ (0xB ^ 0x7C)) & (24 + 135 - 133 + 145 ^ 119 + 31 - 108 + 87 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIIIIIII[0];
                            }
                    ...
                    if (ak.lIlIIIIlIIIl(Bank.contains((int[])nArray14) ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (ak.lIlIIIIlIlIl(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if ("   ".length() < " ".length()) {
                                    return ((0xBA ^ 0x91 ^ (0x2D ^ 0x43)) & (0xB7 ^ 0xA6 ^ (0x59 ^ 0xD) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = llIIIIIII[0];
                            }
