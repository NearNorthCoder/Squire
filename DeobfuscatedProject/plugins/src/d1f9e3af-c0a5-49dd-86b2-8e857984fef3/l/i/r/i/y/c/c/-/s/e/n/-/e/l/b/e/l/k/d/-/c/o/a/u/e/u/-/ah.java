...
implements W {
    ...
    private static void lIIIllIlllll() {
        ...
        ah.lIlIlIIII[1] = " ".length();
        ah.lIlIlIIII[2] = 0xFFFFC3FF & 0x3FE3;
        ah.lIlIlIIII[3] = "  ".length();
        ah.lIlIlIIII[4] = "   ".length();
        ...
        ah.lIlIlIIII[22] = 0x14 ^ 0x1B ^ " ".length();
    ...
    public boolean V() {
        ...
        if (ah.lIIIlllIIlIl(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlIIII[44])) {
            ...
            "".length();
            if (-" ".length() > 0) {
                return ((110 + 60 - 77 + 49 ^ 160 + 1 - 157 + 157) & (127 + 62 - 143 + 141 ^ 64 + 17 - 76 + 143 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlIlIIII[0];
        }
                    ...
                    if (ah.lIIIlllIIIIl(Inventory.getCount((int[])nArray4), lIlIlIIII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (ah.lIIIlllIIIll(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (" ".length() == "   ".length()) {
                                    return ((0xE4 ^ 0x80 ^ (0x2F ^ 0x6E)) & (0x91 ^ 0xAA ^ (0x8E ^ 0x90) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlIlIIII[0];
                            }
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (ah.lIIIlllIIIll(Inventory.getCount((int[])nArray))) {
                                    ...
                                    if ((0x74 ^ 0x6D ^ (0x3F ^ 0x22)) != (150 + 130 - 130 + 8 ^ 37 + 69 - 38 + 86)) {
                                        return ((0xD6 ^ 0x87 ^ (0x71 ^ 0x39)) & (0x22 ^ 0x66 ^ (0x7B ^ 0x26) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlIlIIII[0];
                                }
                        ...
                        if (ah.lIIIlllIIIIl(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlIIII[6])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!ah.lIIIlllIIlIl(Inventory.getCount((int[])nArray), lIlIlIIII[1]) || ah.lIIIlllIIIII(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (-"   ".length() >= 0) {
                                        return ((0x3B ^ 0x43 ^ (0x9C ^ 0xC6)) & (0x1E ^ 0x5D ^ (0xD4 ^ 0xB5) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlIlIIII[0];
                                }
                        ...
                        if (ah.lIIIlllIIlIl(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlIIII[6]) && ah.lIIIlllIIIIl(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlIIII[14])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!ah.lIIIlllIIlIl(Inventory.getCount((int[])nArray), lIlIlIIII[1]) || ah.lIIIlllIIIII(Dialog.isOpen() ? 1 : 0)) {
                                    bl = lIlIlIIII[1];
                                    "".length();
                                    if ((84 + 44 - 120 + 138 ^ 31 + 39 - -34 + 46) == "  ".length()) {
                                        return ((0xCE ^ 0xC0 ^ (8 ^ 0xE)) & (0xF ^ 0x2E ^ (0x4F ^ 0x66) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlIlIIII[0];
                                }
                        ...
                        if (ah.lIIIlllIIlIl(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlIIII[16]) && ah.lIIIlllIIIIl(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlIIII[19])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!ah.lIIIlllIIlIl(Inventory.getCount((int[])nArray), lIlIlIIII[1]) || ah.lIIIlllIIIII(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (-" ".length() > "   ".length()) {
                                        return ((0x3D ^ 0x43 ^ (0xA2 ^ 0x8B)) & (161 + 71 - 102 + 83 ^ 60 + 24 - -23 + 23 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlIlIIII[0];
                                }
                        ...
                        if (ah.lIIIlllIIlIl(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlIIII[27])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!ah.lIIIlllIIlIl(Inventory.getCount((int[])nArray), lIlIlIIII[1]) || ah.lIIIlllIIIII(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (null != null) {
                                        return ((109 + 165 - 186 + 117 ^ 36 + 120 - 121 + 101) & (0xD7 ^ 0xA6 ^ (0x63 ^ 0x57) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlIlIIII[0];
                                }
    ...
    private static void lIIIllIllllI() {
        ...
        ah.lIlIIllll[ah.lIlIlIIII[0]] = ah.lIIIllIllIll("K/lowOa4mJwP9upnPMo5iQ==", "GlAuu");
        ah.lIlIIllll[ah.lIlIlIIII[1]] = ah.lIIIllIlllII("GbwobTK6qKV7ffDLU9rC7IccTifhdFUANjZQxzMHdp5XFogH3eXU69FihY9ezA9K8JRVw3zpfP0=", "WCBlS");
        ah.lIlIIllll[ah.lIlIlIIII[3]] = ah.lIIIllIlllII("IpenBBMsN0842iRWJXjeaOGOpND/i7hA", "lxcPi");
        ah.lIlIIllll[ah.lIlIlIIII[4]] = ah.lIIIllIlllII("Z5BH1bZe9sgzXT4NSpp1KQ==", "OWwXk");
        ah.lIlIIllll[ah.lIlIlIIII[6]] = ah.lIIIllIllIll("SJ5TsMy3NStr+1LqCoF9wqj5yLMC2Qlb", "GiZnI");
        ah.lIlIIllll[ah.lIlIlIIII[9]] = ah.lIIIllIlllIl("AC5aBxQyaxcPFSQiFAFGJD4KFgo+LglKRiQ8ExIFPyIUAUYjJFokMw4CNCE=", "WKzff");
        ah.lIlIIllll[ah.lIlIlIIII[10]] = ah.lIIIllIlllII("bVxNulz1czk4igErGIoRRg==", "HybUz");
        ah.lIlIIllll[ah.lIlIlIIII[11]] = ah.lIIIllIlllIl("IioAITAINgZnIw05EjQ=", "aXaGD");
        ah.lIlIIllll[ah.lIlIlIIII[12]] = ah.lIIIllIlllII("2ZyJKghr8ju1e/YffCT4UA==", "rDgAl");
        ah.lIlIIllll[ah.lIlIlIIII[15]] = ah.lIIIllIlllII("kJhI9cq3gJZSO6yGa4rEfvmf1halOAyM", "gYWlV");
        ah.lIlIIllll[ah.lIlIlIIII[17]] = ah.lIIIllIlllII("f7obQoONGN57MgKbrL2k3Q==", "hhCmC");
        ah.lIlIIllll[ah.lIlIlIIII[18]] = ah.lIIIllIlllIl("HyEWTykxJQo=", "PHzoE");
        ah.lIlIIllll[ah.lIlIlIIII[14]] = ah.lIIIllIlllII("u1/S15vEr4BDziVkDNxUqQ==", "wFBIu");
        ah.lIlIIllll[ah.lIlIlIIII[20]] = ah.lIIIllIllIll("QFhRrWPiONs=", "sGdKk");
        ah.lIlIIllll[ah.lIlIlIIII[22]] = ah.lIIIllIlllIl("LDwxBT4GIDdDLAY9OAElGCI=", "oNPcJ");
        ah.lIlIIllll[ah.lIlIlIIII[23]] = ah.lIIIllIllIll("7ccMCwTyHzVXVP3ri9Qw+g==", "ADwrS");
        ah.lIlIIllll[ah.lIlIlIIII[25]] = ah.lIIIllIlllIl("FTkbIiU/JR1kPiQp", "VKzDQ");
        ah.lIlIIllll[ah.lIlIlIIII[26]] = ah.lIIIllIlllIl("IgU9DT0SGSgGagQfLAQsVwQ/AA==", "wkMbJ");
        ah.lIlIIllll[ah.lIlIlIIII[28]] = ah.lIIIllIlllIl("JysWDQwNNxBLFAE3BA==", "dYwkx");
        ah.lIlIIllll[ah.lIlIlIIII[29]] = ah.lIIIllIlllII("+XpGX/mi8XDGsCHqSNDTdg==", "JYnWc");
        ah.lIlIIllll[ah.lIlIlIIII[30]] = ah.lIIIllIlllIl("DAMqFB8mHyxSByYWIwZLIAMp", "OqKrk");
        ah.lIlIIllll[ah.lIlIlIIII[31]] = ah.lIIIllIlllII("4l3FkUXaVn3i9UjBSPXbIw==", "QDkbT");
        ah.lIlIIllll[ah.lIlIlIIII[32]] = ah.lIIIllIllIll("jVR7byKaIncEOh1ML4lTsyhREB5sKG1M", "BchsK");
        ah.lIlIIllll[ah.lIlIlIIII[35]] = ah.lIIIllIlllIl("KD46BD8NayQBMBk4IQE+HSItCnEaIjMI", "jKCmQ");
        ah.lIlIIllll[ah.lIlIlIIII[43]] = ah.lIIIllIlllIl("JAUzJSYOGTU=", "gwRCR");
        ah.lIlIIllll[ah.lIlIlIIII[45]] = ah.lIIIllIlllIl("PRMBDHEgHE8cNC4WGwNxZw==", "OzokQ");
    }
