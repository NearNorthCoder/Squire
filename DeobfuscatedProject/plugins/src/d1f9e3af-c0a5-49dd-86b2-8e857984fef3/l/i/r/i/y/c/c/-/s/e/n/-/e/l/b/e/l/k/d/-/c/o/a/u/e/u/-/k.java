...
public class k {
    ...
    private static void lIIllIIIlIll() {
        ...
        k.lIllIlIIl[k.lIllIlIlI[4]] = k.lIIlIllllllI("tf0Ltc7oVj/widTR2JyxMyBnBn0zaGIV", "QWwet");
        k.lIllIlIIl[k.lIllIlIlI[15]] = k.lIIlIllllllI("xvldgoZteHevNfxw0QxSUg==", "QxVue");
        k.lIllIlIIl[k.lIllIlIlI[17]] = k.lIIlIlllllll("bAdjicj2bOSPghNO855+DA==", "nYnXY");
        k.lIllIlIIl[k.lIllIlIlI[19]] = k.lIIlIlllllll("EM+EHQX04FE=", "erPeO");
        k.lIllIlIIl[k.lIllIlIlI[20]] = k.lIIlIllllllI("10sFpGRHPMMzfTIE/50pcA==", "bOFhs");
        k.lIllIlIIl[k.lIllIlIlI[22]] = k.lIIlIlllllll("dpZsS/w/1k0=", "VcmEk");
        k.lIllIlIIl[k.lIllIlIlI[16]] = k.lIIlIllllllI("XFg5dBOb7gvgmYchIxT0dffDqzYwhoWw", "iSKyF");
        k.lIllIlIIl[k.lIllIlIlI[23]] = k.lIIlIlllllll("WPv73ymgmaE=", "TgjJw");
        k.lIllIlIIl[k.lIllIlIlI[24]] = k.lIIlIllllllI("4ElsiW6bqPyZ6s1rDUDYu/QlMEL3JLvg", "dQfSZ");
        k.lIllIlIIl[k.lIllIlIlI[25]] = k.lIIlIllllllI("pJdxT+RNpHQ=", "OaqMl");
        k.lIllIlIIl[k.lIllIlIlI[26]] = k.lIIlIllllllI("ItUZ0ytOxGo=", "UkskX");
        k.lIllIlIIl[k.lIllIlIlI[27]] = k.lIIlIlllllll("wY+upnS+6Ko=", "sODav");
        k.lIllIlIIl[k.lIllIlIlI[28]] = k.lIIllIIIlIlI("ESc/Pg==", "YNSRa");
        k.lIllIlIIl[k.lIllIlIlI[29]] = k.lIIlIllllllI("f39SoWG9f3c=", "IuWLJ");
    }
            ...
            if (k.lIIllIIlIlIl(Players.getLocal().getInteracting()) && k.lIIllIIlIllI(Players.getLocal().getHealthRatio(), lIllIlIlI[21])) {
                llIllIIIIlIlIl = NPCs.getNearest(nPC -> {
                    ...
                    if (k.lIIllIIIllll(nPC.getName().contains(lIllIlIIl[lIllIlIlI[29]]) ? 1 : 0) && k.lIIllIIllIII(nPC.getInteracting(), Players.getLocal()) && k.lIIllIIIlllI(nPC.isDead() ? 1 : 0)) {
                        n2 = lIllIlIlI[15];
                        "".length();
                        if (((0x34 ^ 3 ^ (0x6F ^ 0x1A)) & (0x12 ^ 0x5A ^ (0x50 ^ 0x5A) ^ -" ".length())) > (58 + 133 - 185 + 186 ^ 193 + 80 - 126 + 49)) {
                            return ((0xC5 ^ 0xA6 ^ (0x73 ^ 0xA)) & (0x45 ^ 0x3F ^ (0x24 ^ 0x44) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lIllIlIlI[4];
                    }
            ...
            if (k.lIIllIIlIlll(Players.getLocal().getInteracting())) {
                llIllIIIIlIlIl = NPCs.getNearest(nPC -> {
                    ...
                    if (k.lIIllIIIllll(nPC.getName().contains(lIllIlIIl[lIllIlIlI[27]]) ? 1 : 0) && k.lIIllIIlIlll(nPC.getInteracting()) && k.lIIllIIIlllI(nPC.isDead() ? 1 : 0)) {
                        ...
                        "".length();
                        if (-"  ".length() > 0) {
                            return ((7 ^ 0x47 ^ (0x59 ^ 0x37)) & (0xA7 ^ 0x99 ^ (0x16 ^ 6) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lIllIlIlI[4];
                    }
    ...
    private static void lIIllIIIllII() {
        ...
        k.lIllIlIlI[4] = (131 + 39 - 10 + 33 ^ 124 + 86 - 137 + 69) & (0x60 ^ 0x44 ^ (0xEE ^ 0x85) ^ -" ".length());
