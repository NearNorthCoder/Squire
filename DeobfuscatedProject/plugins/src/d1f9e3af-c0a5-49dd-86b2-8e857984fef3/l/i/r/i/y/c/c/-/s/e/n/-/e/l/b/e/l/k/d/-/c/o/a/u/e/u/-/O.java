...
implements W {
    ...
    private static void lIIlIIIIIlII() {
        ...
        O.lIlIlIlII[O.lIlIlIlll[0]] = O.lIIIlllIllll("MhIeDgMXRw4TCB0U", "pgggm");
        O.lIlIlIlII[O.lIlIlIlll[1]] = O.lIIIlllIllll("NyYpCAcZKiNBFgQ2Lg8TUSYzBBkCY2cSAxg7JAkdHyhnAxUSJGcVG1E+MgQHBQ==", "qOGat");
        O.lIlIlIlII[O.lIlIlIlll[3]] = O.lIIIllllIIII("nIOa594YyaI=", "VLUlq");
        O.lIlIlIlII[O.lIlIlIlll[5]] = O.lIIIlllIllll("IxcgPTUMAj86NU0COXQwDBg9", "mvVTR");
        O.lIlIlIlII[O.lIlIlIlll[6]] = O.lIIIllllIIIl("CYxBaEPKd3yl4Iv+lsPXsQ==", "kGstv");
        O.lIlIlIlII[O.lIlIlIlll[8]] = O.lIIIllllIIII("yQ7C7fZNaGuNXx3Vk3V+6IXj+/P2WnTW", "AVqYs");
        O.lIlIlIlII[O.lIlIlIlll[10]] = O.lIIIllllIIII("pGAKUvHcUQWIF9pYXLcx3Ohq/rgviP7gwzgoUwavbtZ0WWCJ6B/PdMy671mSLaVmog0Y2Rmlsyc=", "vShUv");
        O.lIlIlIlII[O.lIlIlIlll[15]] = O.lIIIllllIIII("cffc8ZNdY9JBOrdOKTJt4fIOXQDWp89IL/HLiWAgtFFLyGQAmRKio/pjDBj8oxtUTG228ScyQhA=", "zBvJd");
        O.lIlIlIlII[O.lIlIlIlll[16]] = O.lIIIlllIllll("FxYiWQ02VycNGCsD", "YwTyy");
        O.lIlIlIlII[O.lIlIlIlll[17]] = O.lIIIllllIIIl("S8NfAdKZ0X/c02I8H1J/6A==", "WyCub");
        O.lIlIlIlII[O.lIlIlIlll[18]] = O.lIIIllllIIIl("9X86ZZn26sF6o07QzpaTjA==", "urxNm");
        O.lIlIlIlII[O.lIlIlIlll[19]] = O.lIIIllllIIIl("hBnSAAY/0qs=", "arCRd");
        O.lIlIlIlII[O.lIlIlIlll[20]] = O.lIIIlllIllll("GDEdBQ==", "WAxkJ");
        O.lIlIlIlII[O.lIlIlIlll[21]] = O.lIIIllllIIII("NDfFG4EKdEyqQii+r7HEYOKIIPV9FYbg", "RWPMZ");
        O.lIlIlIlII[O.lIlIlIlll[25]] = O.lIIIlllIllll("MAAXBFUWFQc=", "rlbau");
        O.lIlIlIlII[O.lIlIlIlll[26]] = O.lIIIllllIIIl("V5Yeb7sA/K5/YU0IltSD1Q==", "GEqaw");
        O.lIlIlIlII[O.lIlIlIlll[27]] = O.lIIIllllIIII("J/34o6rIeLqPDs6lUwzOpA==", "bEXRK");
        O.lIlIlIlII[O.lIlIlIlll[28]] = O.lIIIllllIIII("DiGcAH8p7fTvlbhQpZZ8yQ==", "clWul");
        O.lIlIlIlII[O.lIlIlIlll[29]] = O.lIIIlllIllll("ITwBPFcHKRE=", "cPtYw");
        O.lIlIlIlII[O.lIlIlIlll[30]] = O.lIIIllllIIIl("WbWBA8vfUqUTrM3cYoMnk+UpvmJwvdQp", "KojKK");
        O.lIlIlIlII[O.lIlIlIlll[31]] = O.lIIIlllIllll("GTwkKAkzbiIpDDonK2YDNycp", "VNEFn");
        O.lIlIlIlII[O.lIlIlIlll[32]] = O.lIIIllllIIIl("DRsaoTByrjbSQQei0fYSVA==", "eXMKY");
        O.lIlIlIlII[O.lIlIlIlll[33]] = O.lIIIllllIIIl("sD5LiGaHaWqs6xDCGs5eywEiQegJE0Ov", "izbYy");
        O.lIlIlIlII[O.lIlIlIlll[34]] = O.lIIIllllIIII("kOI5feAKtOWRFUPeFnBi196c99iXCutr", "sISgw");
        O.lIlIlIlII[O.lIlIlIlll[36]] = O.lIIIllllIIIl("u3F5u9EJFtDr4s/7IHl/0ZL2g6E+F26/", "gTfRu");
        O.lIlIlIlII[O.lIlIlIlll[37]] = O.lIIIlllIllll("NgAwP28TAyc2JhpMKDsmGA==", "tlEZO");
        O.lIlIlIlII[O.lIlIlIlll[38]] = O.lIIIllllIIII("clJRLI13MNhZxeDfmNdFdQ==", "CydnA");
        O.lIlIlIlII[O.lIlIlIlll[39]] = O.lIIIllllIIIl("wlD7eXNdUc3KvNrLIh7iJQ==", "bsUlD");
        O.lIlIlIlII[O.lIlIlIlll[40]] = O.lIIIllllIIIl("UvjYDHdWhgIUl81YkscqUSW8pZ9towro", "IFmAs");
        O.lIlIlIlII[O.lIlIlIlll[42]] = O.lIIIllllIIII("xZ/dsv/sRqSb5gnGV2lIuaRqmg31mYsi", "DjGug");
        O.lIlIlIlII[O.lIlIlIlll[43]] = O.lIIIllllIIII("PyqYqx52qKfvjNk+0J1t1g==", "lOxlG");
        O.lIlIlIlII[O.lIlIlIlll[44]] = O.lIIIlllIllll("NjMUMyQQOloUMx8iFDksFA==", "qVzVV");
        O.lIlIlIlII[O.lIlIlIlll[46]] = O.lIIIllllIIII("XEb6IvRacV3A9/Ir1jeYEzzoSlV+L6gO", "pyKXT");
        O.lIlIlIlII[O.lIlIlIlll[47]] = O.lIIIllllIIII("l3iMpGI0peDS5feV53YYdg==", "qjVis");
        O.lIlIlIlII[O.lIlIlIlll[48]] = O.lIIIllllIIIl("2rjVakRB5va6jb9kW6xIXjflqXn0gSOT", "EXtUN");
        O.lIlIlIlII[O.lIlIlIlll[49]] = O.lIIIlllIllll("JTRmOTEXcSsxMAE4KD9jAyQjKzdSIjMoMx44IytvUiIxMTcROS82JFIlKXgBJwgPFgQ=", "rQFXC");
        O.lIlIlIlII[O.lIlIlIlll[50]] = O.lIIIlllIllll("HBR4JgsuUTUuCjgYNiBZOgQ9NA1rAi03CScYPTRVawIvLg0oGTEpHmsFN2c7HigRCT4=", "KqXGy");
        O.lIlIlIlII[O.lIlIlIlll[51]] = O.lIIIlllIllll("ISQMEEQHMRw=", "cHyud");
        O.lIlIlIlII[O.lIlIlIlll[52]] = O.lIIIlllIllll("DAQ3FAUmVjIDBw==", "CvVzb");
        O.lIlIlIlII[O.lIlIlIlll[53]] = O.lIIIlllIllll("JiADOy5COBg4JhA=", "bYjUI");
        O.lIlIlIlII[O.lIlIlIlll[54]] = O.lIIIllllIIII("xtg2pySMMRoC2bwV08HlwQ==", "qqdMO");
        O.lIlIlIlII[O.lIlIlIlll[55]] = O.lIIIllllIIIl("iioFUUV3xeet370iMmuIZA==", "ClAGS");
        O.lIlIlIlII[O.lIlIlIlll[62]] = O.lIIIllllIIII("fcdwRpfcKMzWzfjezpeGUB+UaAm1ckY5", "Ckivm");
        O.lIlIlIlII[O.lIlIlIlll[63]] = O.lIIIlllIllll("OgA9NkYnD3MmAykFJzlGYA==", "HiSQf");
        O.lIlIlIlII[O.lIlIlIlll[64]] = O.lIIIllllIIIl("CcnopFmA2GE=", "GufVi");
        O.lIlIlIlII[O.lIlIlIlll[65]] = O.lIIIllllIIIl("VyPCrjfhjFlVrz4QSGfuZbzTtT4HkG4D9lK6qLg1lMVH7Szhz9hyd4lTOtPSsbxOhlZJ9PlFXY4=", "DFuwx");
        O.lIlIlIlII[O.lIlIlIlll[66]] = O.lIIIlllIllll("Jw8KJ2YRBQQmMlAGSzcvFgEOISMeE0swKRwIHiF5", "pgkSF");
        O.lIlIlIlII[O.lIlIlIlll[67]] = O.lIIIlllIllll("C0EHNw8nQRw5FCdBACQYLAYKdhgwDAAjC2IJCiQcbA==", "BaoVy");
        O.lIlIlIlII[O.lIlIlIlll[68]] = O.lIIIlllIllll("Gno9Djg2eiYAIzZ6NwM7Nno0HSM8LydPJjYoMEE=", "SZUoN");
        O.lIlIlIlII[O.lIlIlIlll[69]] = O.lIIIllllIIII("7Qa9bSXeNUj0NJ7zfDMnPkkwt6EJfz/Qk54Lb/uxZOA=", "ofnrt");
        O.lIlIlIlII[O.lIlIlIlll[70]] = O.lIIIlllIllll("O10uLkUeHyM0AFIDLTdFBhViKxFc", "rzBBe");
    }
    ...
    public boolean V() {
        ...
        if (O.lIIlIIIIllll(e.j(lIlIlIlll[4]), lIlIlIlll[10]) && !O.lIIlIIIIllll(e.j(lIlIlIlll[4]), lIlIlIlll[18]) || O.lIIlIIIlIIII(Quests.getState((Quest)Quest.GOBLIN_DIPLOMACY), QuestState.FINISHED)) {
            bl = lIlIlIlll[1];
            "".length();
            if ("  ".length() > (0x83 ^ 0xBF ^ (0x20 ^ 0x18))) {
                return ((89 + 22 - 11 + 140 ^ 194 + 15 - 198 + 186) & (0x79 ^ 0x54 ^ (0x93 ^ 0x8B) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlIlIlll[0];
        }
    ...
    private static void lIIlIIIIIlIl() {
        ...
        O.lIlIlIlll[0] = (123 + 96 - 170 + 91 ^ 87 + 3 - -23 + 19) & (0x5A ^ 1 ^ (0xC ^ 0x5F) ^ -" ".length());
        O.lIlIlIlll[1] = " ".length();
        O.lIlIlIlll[2] = 0x6F ^ 0x24;
        O.lIlIlIlll[3] = "  ".length();
        O.lIlIlIlll[4] = 91 + 103 - 24 + 8 ^ 56 + 100 - 24 + 8;
        O.lIlIlIlll[5] = "   ".length();
