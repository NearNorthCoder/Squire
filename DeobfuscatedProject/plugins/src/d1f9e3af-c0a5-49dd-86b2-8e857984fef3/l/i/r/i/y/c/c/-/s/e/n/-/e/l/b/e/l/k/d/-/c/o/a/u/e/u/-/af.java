...
implements W {
    ...
    private static void lIIIIlIIIIII() {
        ...
        af.lIIllllII[af.lIIllllIl[0]] = af.lIIIIIllllIl("IBYVATgFQwUcMw8Q", "bclhV");
        af.lIIllllII[af.lIIllllIl[1]] = af.lIIIIIlllllI("/BBlYX+Hmh9TSbjR4IgvdwKeqtIjYdXh88/sCetRZW0PAYinNStUxNA3X+ms2/peMj/qasMIPX8=", "UyYpO");
        af.lIIllllII[af.lIIllllIl[3]] = af.lIIIIIllllIl("NwATEyMYFQwUI1kVClomGA8O", "yaezD");
        af.lIIllllII[af.lIIllllIl[4]] = af.lIIIIIllllIl("LQ0vKh8MAiZuEQQCKicdAg==", "elANs");
        af.lIIllllII[af.lIIllllIl[7]] = af.lIIIIIllllIl("NiRoJzwEYSUvPRIoJiFuEjQ4NiIIJDtqbhI2ITItCSgmIW4VLmgEGzgIBgE=", "aAHFN");
        af.lIIllllII[af.lIIllllIl[6]] = af.lIIIIIllllll("6bvq788DuY0=", "RQAPc");
        af.lIIllllII[af.lIIllllIl[31]] = af.lIIIIIlllllI("xloW97+jzas=", "AwDyN");
        af.lIIllllII[af.lIIllllIl[32]] = af.lIIIIIllllIl("NicyGQ==", "aBSkO");
        af.lIIllllII[af.lIIllllIl[33]] = af.lIIIIIllllll("R+xnVInoQ0s=", "aMIhb");
        af.lIIllllII[af.lIIllllIl[35]] = af.lIIIIIllllIl("NQIOHy0=", "bkksI");
        af.lIIllllII[af.lIIllllIl[25]] = af.lIIIIIllllll("Tr02o/M8gJE=", "GmKBU");
        af.lIIllllII[af.lIIllllIl[37]] = af.lIIIIIllllIl("HSMvAQ==", "JFNsn");
        af.lIIllllII[af.lIIllllIl[38]] = af.lIIIIIllllIl("HhEFBA==", "ItdvO");
        af.lIIllllII[af.lIIllllIl[39]] = af.lIIIIIllllIl("JQoFKA==", "rodZC");
        af.lIIllllII[af.lIIllllIl[40]] = af.lIIIIIllllll("3imC5iiP3us=", "hUrbC");
        af.lIIllllII[af.lIIllllIl[42]] = af.lIIIIIllllIl("JQEDAw==", "rdbqh");
        af.lIIllllII[af.lIIllllIl[43]] = af.lIIIIIlllllI("oQd/h+4sWik=", "pngaI");
        af.lIIllllII[af.lIIllllIl[44]] = af.lIIIIIllllIl("FQMQEQ==", "Bfqcs");
        af.lIIllllII[af.lIIllllIl[45]] = af.lIIIIIllllIl("FCswBjY=", "CBUjR");
        af.lIIllllII[af.lIIllllIl[60]] = af.lIIIIIllllll("7opfBLedILnetfUDTIv4VA==", "BmjDV");
        af.lIIllllII[af.lIIllllIl[2]] = af.lIIIIIllllll("3tmZfhMCLYW0YB6IPQFl23cjl5eEO9hM", "WMDyF");
        af.lIIllllII[af.lIIllllIl[61]] = af.lIIIIIllllIl("LQci", "OhUZV");
    }
    ...
    private static void lIIIIlIIIIIl() {
        ...
        af.lIIllllIl[0] = (0xBC ^ 0x96 ^ (0x65 ^ 0x3B) & ~(0x23 ^ 0x7D)) & (0xC5 ^ 0x98 ^ (0x65 ^ 0x12) ^ -" ".length());
        af.lIIllllIl[1] = " ".length();
        af.lIIllllIl[2] = 0x46 ^ 0x69 ^ (0x6E ^ 0x55);
        af.lIIllllIl[3] = "  ".length();
        af.lIIllllIl[4] = "   ".length();
                                                ...
                                                block32: {
                                                    ...
                                                    block34: {
                                                                            ...
                                                                            block24: {
                                                                                ...
                                                                                block26: {
                                                                                    ...
                                                                                    if (af.lIIIIlIIIIlI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                                                        n4 = lIIllllIl[1];
                                                                                        "".length();
                                                                                        if (((0x17 ^ 0x74) & ~(0xF7 ^ 0x94)) >= -" ".length()) return n4 != 0;
                                                                                        return ((0x7E ^ 0x2C) & ~(0xF0 ^ 0xA2)) != 0;
                                                                                    }
                                                                                }
                                                                                n4 = lIIllllIl[0];
                                                                                return n4 != 0;
                                                        ...
                                                        if (af.lIIIIlIIIIlI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                            ...
                                                            return ((0x4D ^ 0x49 ^ (0x6C ^ 0x4A)) & (0xDC ^ 0x93 ^ (0x77 ^ 0x1A) ^ -" ".length())) != 0;
                                                        }
                                                    }
                                                    n3 = lIIllllIl[0];
                                                    return n3 != 0;
    ...
    public boolean V() {
        ...
        if (af.lIIIIlIIIlll(Skills.getLevel((Skill)Skill.RANGED), lIIllllIl[2])) {
            ...
            "".length();
            if (null != null) {
                return ((0xF8 ^ 0xBB ^ " ".length()) & (7 ^ 0x1B ^ (1 ^ 0x5F) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIllllIl[0];
        }
        ...
        block20: {
                                    ...
                                    if (af.lIIIIlIIIIlI(Bank.contains((int[])nArray5) ? 1 : 0)) {
                                        ...
                                        if (af.lIIIIlIIIIlI(Bank.contains((int[])nArray6) ? 1 : 0)) {
                                            ...
                                            if (af.lIIIIlIIIIlI(Bank.contains((int[])nArray7) ? 1 : 0)) {
                                                ...
                                                "".length();
                                                if (null == null) return n3 != 0;
                                                return ((0xC7 ^ 0x8B ^ (0xD1 ^ 0xB4)) & (0xEA ^ 0x88 ^ (0x48 ^ 3) ^ -" ".length())) != 0;
                                            }
                                        }
                                    }
                                }
                                ...
                                if (af.lIIIIlIIIIlI(Bank.contains((int[])nArray10) ? 1 : 0)) {
                                    ...
                                    if (af.lIIIIlIIIIlI(Bank.contains((int[])nArray11) ? 1 : 0)) {
                                        ...
                                        if (af.lIIIIlIIIIlI(Bank.contains((int[])nArray12) ? 1 : 0)) {
                                            ...
                                            return ((0x60 ^ 0x33 ^ (0xA5 ^ 0xC0)) & (0xB3 ^ 0x81 ^ (0x91 ^ 0x95) ^ -" ".length())) != 0;
                                        }
                                    }
                                }
                            }
            ...
            if (af.lIIIIlIIIIlI(Bank.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (af.lIIIIlIIIIlI(Bank.contains((int[])nArray22) ? 1 : 0)) {
                    ...
                    return ((0x49 ^ 0x3F ^ (0x7F ^ 0x4B)) & (0xE7 ^ 0x84 ^ (0x21 ^ 0) ^ -" ".length())) != 0;
                }
            }
        }
        n2 = lIIllllIl[0];
