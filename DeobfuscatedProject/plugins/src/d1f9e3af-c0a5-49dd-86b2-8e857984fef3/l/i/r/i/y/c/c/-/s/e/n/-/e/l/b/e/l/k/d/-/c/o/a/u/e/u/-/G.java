...
implements W {
                ...
                if (G.lIIlllIIlIIl(Inventory.getCount((int[])nArray12), lIlllIlIl[3])) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (G.lIIlllIlIIlI(Inventory.getCount((int[])nArray))) {
                            ...
                            "".length();
                            if (-" ".length() > 0) {
                                return ((0x87 ^ 0xBA ^ (0x16 ^ 7)) & (79 + 37 - -1 + 26 ^ 139 + 91 - 217 + 150 ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIlllIlIl[4];
                        }
                ...
                if (G.lIIlllIIlIIl(Inventory.getCount((int[])nArray14), lIlllIlIl[3])) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (G.lIIlllIlIIlI(Inventory.getCount((int[])nArray))) {
                            bl = lIlllIlIl[3];
                            "".length();
                            if (" ".length() <= ((49 + 151 - 131 + 149 ^ 69 + 89 - 111 + 97) & ("   ".length() ^ (0xC0 ^ 0x89) ^ -" ".length()))) {
                                return ((0x2D ^ 0x26 ^ (0x15 ^ 0x11)) & (0x7D ^ 8 ^ (0x66 ^ 0x1C) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIlllIlIl[4];
                        }
                ...
                if (G.lIIlllIIlIIl(Inventory.getCount((int[])nArray16), lIlllIlIl[3])) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (G.lIIlllIlIIlI(Inventory.getCount((int[])nArray))) {
                            ...
                            "".length();
                            if (" ".length() >= "  ".length()) {
                                return ((0x65 ^ 0x32 ^ (0xE3 ^ 0x9A)) & (0x66 ^ 0x70 ^ (0x88 ^ 0xB0) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIlllIlIl[4];
                        }
                ...
                if (G.lIIlllIIlIIl(Inventory.getCount((int[])nArray18), lIlllIlIl[3])) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (G.lIIlllIlIIlI(Inventory.getCount((int[])nArray))) {
                            ...
                            "".length();
                            if (null != null) {
                                return ((0x18 ^ 0x34 ^ (0x85 ^ 0xB5)) & (128 + 112 - 239 + 140 ^ 50 + 109 - 45 + 31 ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIlllIlIl[4];
                        }
    ...
    private static void lIIlllIIIlII() {
        ...
        G.lIlllIIII[G.lIlllIlIl[4]] = G.lIIllIlIIIll("7U0OCu7jqt/ajWTMurYeUg==", "XkAXi");
        G.lIlllIIII[G.lIlllIlIl[3]] = G.lIIllIlIIlII("FxwMMz85EAZ6LiQMCzQrcRwWPyEiWUIpOzgBATIlPxJCOC0yHkIuI3EEFz8/JRwMPQ==", "QubZL");
        G.lIlllIIII[G.lIlllIlIl[1]] = G.lIIllIlIIlII("OyISByUQPhBGOhgy", "yPwfN");
        G.lIlllIIII[G.lIlllIlIl[12]] = G.lIIllIlIIIll("56CD2IImZAU=", "YSyLT");
        G.lIlllIIII[G.lIlllIlIl[15]] = G.lIIllIlIIlII("HyAcYxM+YRk3BiM1", "QAjCg");
        G.lIlllIIII[G.lIlllIlIl[13]] = G.lIIllIlIIlIl("n+MZy6FTPdY=", "xJOcn");
        G.lIlllIIII[G.lIlllIlIl[14]] = G.lIIllIlIIlIl("DPhxoCPlZ4w=", "VxCFt");
        G.lIlllIIII[G.lIlllIlIl[18]] = G.lIIllIlIIlIl("UKUoqD3naaurer/CQFbMZtJ4HY+uRk+cAvWxq5XtvKU=", "IhEDh");
        G.lIlllIIII[G.lIlllIlIl[20]] = G.lIIllIlIIlIl("ZrxC8g90xvA=", "VXduF");
        G.lIlllIIII[G.lIlllIlIl[21]] = G.lIIllIlIIlII("JgEmKSAcGyRoJxAM", "uuCHL");
        G.lIlllIIII[G.lIlllIlIl[22]] = G.lIIllIlIIlII("By0CJns+LAkoJA==", "KBmMV");
        G.lIlllIIII[G.lIlllIlIl[24]] = G.lIIllIlIIlIl("7GXg+eXRiw7VSlNdvvX89w==", "cYdkj");
        G.lIlllIIII[G.lIlllIlIl[25]] = G.lIIllIlIIlII("HwccPA==", "qrpPJ");
        G.lIlllIIII[G.lIlllIlIl[26]] = G.lIIllIlIIlII("Wg==", "zHguJ");
        G.lIlllIIII[G.lIlllIlIl[27]] = G.lIIllIlIIlII("IBs+YicBWiUjNAAfPGIxAQI=", "nzHBS");
        G.lIlllIIII[G.lIlllIlIl[28]] = G.lIIllIlIIlII("OxU6WQAaVCEYExsROFkWGgw=", "utLyt");
        G.lIlllIIII[G.lIlllIlIl[29]] = G.lIIllIlIIlII("Ki0CGxsIKhY=", "iXryt");
        G.lIlllIIII[G.lIlllIlIl[30]] = G.lIIllIlIIlII("MywqBjkAbSwOMAkoNQ==", "gMAoW");
        G.lIlllIIII[G.lIlllIlIl[31]] = G.lIIllIlIIlIl("D1r6XyAYolU=", "Pchjg");
        G.lIlllIIII[G.lIlllIlIl[32]] = G.lIIllIlIIlIl("FkKLpnaBRDU=", "oNDJd");
        G.lIlllIIII[G.lIlllIlIl[33]] = G.lIIllIlIIIll("kjFIR4min+o=", "fkSfy");
        G.lIlllIIII[G.lIlllIlIl[34]] = G.lIIllIlIIIll("NXH6yJl/Mpc=", "JoYBn");
        G.lIlllIIII[G.lIlllIlIl[35]] = G.lIIllIlIIlII("BwQONic8", "TaoDD");
        G.lIlllIIII[G.lIlllIlIl[36]] = G.lIIllIlIIlIl("jyQ2ibbT9iS7bk5r5+XIIw==", "kUPLf");
        G.lIlllIIII[G.lIlllIlIl[37]] = G.lIIllIlIIlIl("y4GCDTjN43w=", "nXKIf");
        G.lIlllIIII[G.lIlllIlIl[38]] = G.lIIllIlIIlIl("kssUBDUjJV8=", "YQSVj");
        G.lIlllIIII[G.lIlllIlIl[40]] = G.lIIllIlIIlII("JDYbVAYFdwAVFQQyGVQQBS8=", "jWmtr");
        G.lIlllIIII[G.lIlllIlIl[41]] = G.lIIllIlIIIll("AM5faQPgW63lBSPeyUwT2A==", "nebMn");
        G.lIlllIIII[G.lIlllIlIl[42]] = G.lIIllIlIIIll("xxIOUpI+2VYKJq6weE+0fw==", "lWshn");
        G.lIlllIIII[G.lIlllIlIl[43]] = G.lIIllIlIIIll("D3rCccyU5gE=", "dlpQG");
        G.lIlllIIII[G.lIlllIlIl[44]] = G.lIIllIlIIIll("nyrnhsSHINA=", "ExNXk");
        G.lIlllIIII[G.lIlllIlIl[45]] = G.lIIllIlIIIll("jCHeDfJoA6k=", "zKFeL");
        G.lIlllIIII[G.lIlllIlIl[46]] = G.lIIllIlIIIll("NYR5p7BwCDA=", "lQewv");
        G.lIlllIIII[G.lIlllIlIl[47]] = G.lIIllIlIIlII("Dz4AFgIiJAs=", "LQnbk");
        G.lIlllIIII[G.lIlllIlIl[48]] = G.lIIllIlIIIll("0Soj6pH2hzI=", "wbQvs");
        G.lIlllIIII[G.lIlllIlIl[49]] = G.lIIllIlIIIll("ZAX28hzRKZE=", "JNiVc");
        G.lIlllIIII[G.lIlllIlIl[50]] = G.lIIllIlIIlIl("mfR5QNhqCI1MzU7us/nRLBJ1ujoNz3cM", "woKmq");
        G.lIlllIIII[G.lIlllIlIl[51]] = G.lIIllIlIIlIl("kQl966+kxor4WTP4zvEpUw==", "CkJXJ");
        G.lIlllIIII[G.lIlllIlIl[52]] = G.lIIllIlIIlIl("yZLkN3sPJ14=", "NubMQ");
        G.lIlllIIII[G.lIlllIlIl[53]] = G.lIIllIlIIlII("HjUGKzdrJQcgNTgj", "KFoEP");
        G.lIlllIIII[G.lIlllIlIl[54]] = G.lIIllIlIIlIl("JKhZc7G1/Fs=", "gJBmt");
        G.lIlllIIII[G.lIlllIlIl[55]] = G.lIIllIlIIlII("AQEBJwYn", "BidBu");
        G.lIlllIIII[G.lIlllIlIl[56]] = G.lIIllIlIIlII("Bjc3JiordjQtMz0z", "NVYBF");
        G.lIlllIIII[G.lIlllIlIl[57]] = G.lIIllIlIIIll("TINSCWmABZfS44fXUazfZQ==", "WlErb");
        G.lIlllIIII[G.lIlllIlIl[61]] = G.lIIllIlIIlIl("3k+Te3gu/ND4RsncsgFEiOo6MlfIsEep", "BaqWG");
        G.lIlllIIII[G.lIlllIlIl[63]] = G.lIIllIlIIlIl("7T6TCdzJXyk=", "KJpFa");
        G.lIlllIIII[G.lIlllIlIl[64]] = G.lIIllIlIIIll("f9Dyg6x/BFWj+V7JYo12Ig==", "IKpTk");
        G.lIlllIIII[G.lIlllIlIl[65]] = G.lIIllIlIIIll("oW92aq7+mHP5Cnk/cCWCL6Kw3an7thP0", "nGrew");
        G.lIlllIIII[G.lIlllIlIl[66]] = G.lIIllIlIIlII("Cg0O", "OlzdF");
        G.lIlllIIII[G.lIlllIlIl[67]] = G.lIIllIlIIlII("MwYFGwceAFYcHhULGg==", "pgvon");
        G.lIlllIIII[G.lIlllIlIl[68]] = G.lIIllIlIIlII("MgcBNkkGGx02", "tnsSi");
        G.lIlllIIII[G.lIlllIlIl[69]] = G.lIIllIlIIlII("PDkTFEEIJQ8U", "zPaqa");
        G.lIlllIIII[G.lIlllIlIl[70]] = G.lIIllIlIIlII("NSUHHA==", "wDkpd");
        G.lIlllIIII[G.lIlllIlIl[71]] = G.lIIllIlIIlIl("T08K7AMicuY=", "RDjig");
        G.lIlllIIII[G.lIlllIlIl[72]] = G.lIIllIlIIlII("MDcTMwkDdho7Cwg=", "dVxZg");
        G.lIlllIIII[G.lIlllIlIl[73]] = G.lIIllIlIIIll("r+aelRtltY4=", "SAMBC");
        G.lIlllIIII[G.lIlllIlIl[74]] = G.lIIllIlIIlII("EgQKAw==", "Pefoz");
        G.lIlllIIII[G.lIlllIlIl[75]] = G.lIIllIlIIlIl("flZ27s1oxxAQUOBgfBnQiw==", "zBSIc");
        G.lIlllIIII[G.lIlllIlIl[76]] = G.lIIllIlIIlIl("tCjyQf56WD8=", "olEtA");
        G.lIlllIIII[G.lIlllIlIl[77]] = G.lIIllIlIIlIl("SAoQ+AfZY2Lc7sqMSyxhpWJMYdbxZpBm", "SldQS");
        G.lIlllIIII[G.lIlllIlIl[78]] = G.lIIllIlIIlII("MC8/FA4KPW0TCUQrOB8UEA==", "dZMzg");
        G.lIlllIIII[G.lIlllIlIl[79]] = G.lIIllIlIIIll("YOPIliSPmT8=", "FEDTH");
        G.lIlllIIII[G.lIlllIlIl[80]] = G.lIIllIlIIlII("JwcODRM=", "cugcx");
        G.lIlllIIII[G.lIlllIlIl[81]] = G.lIIllIlIIlII("IDYGFBwMNhVRAwQiFw==", "eXrqn");
        G.lIlllIIII[G.lIlllIlIl[83]] = G.lIIllIlIIlII("DwwASAUuTRABAzIZVhsBLhk=", "Amvhq");
        G.lIlllIIII[G.lIlllIlIl[84]] = G.lIIllIlIIlIl("aNzquDRuk/iASqgGapGNE+tKafGnHkOO", "RrBID");
        G.lIlllIIII[G.lIlllIlIl[85]] = G.lIIllIlIIIll("QPYHTQYZbIHbHt1U332fUf+l4204gF1/", "rAjTd");
        G.lIlllIIII[G.lIlllIlIl[86]] = G.lIIllIlIIIll("w1ASPD1suWxebC0F/onuaA==", "vtTPA");
        G.lIlllIIII[G.lIlllIlIl[87]] = G.lIIllIlIIIll("gF+qFokFyuHd3UFEbcuu7w==", "pgJCD");
        G.lIlllIIII[G.lIlllIlIl[88]] = G.lIIllIlIIlIl("m24+uFQ+vOoroOEavh4flQ==", "jTgDI");
        G.lIlllIIII[G.lIlllIlIl[89]] = G.lIIllIlIIlII("LgQ2JQk=", "mlSFb");
        G.lIlllIIII[G.lIlllIlIl[90]] = G.lIIllIlIIlII("MCUpOy0dPyI=", "sJGOD");
        G.lIlllIIII[G.lIlllIlIl[91]] = G.lIIllIlIIIll("kWW8D8stbqA=", "THlgy");
        G.lIlllIIII[G.lIlllIlIl[92]] = G.lIIllIlIIIll("OS3rx8vZlm8=", "oCMCE");
        G.lIlllIIII[G.lIlllIlIl[95]] = G.lIIllIlIIlIl("nmiYxZTphKV73GZuQWJVOKqDQh39pMWn", "hRCVb");
        G.lIlllIIII[G.lIlllIlIl[96]] = G.lIIllIlIIIll("DHIdoYgHg5RSyMpXqtVAC0laEPfvJt4H", "HEltc");
        G.lIlllIIII[G.lIlllIlIl[97]] = G.lIIllIlIIIll("Bv2mwCen28QGG8giikYgEwuqhMYPKK1z", "PGBEc");
        G.lIlllIIII[G.lIlllIlIl[98]] = G.lIIllIlIIIll("JDyQnsaA58wluwPizb5H8w==", "EAduI");
        G.lIlllIIII[G.lIlllIlIl[100]] = G.lIIllIlIIIll("q4bn20IBT946BZtEO+06OkR9raf23MFr", "ETfxV");
        G.lIlllIIII[G.lIlllIlIl[102]] = G.lIIllIlIIIll("NuzPa+foUkmrhcU6hcFZu+dw90mGfEqRWVZNRW8LZkgfqc0skIv14pbo/B83rVcg", "sdDvX");
        G.lIlllIIII[G.lIlllIlIl[16]] = G.lIIllIlIIlII("ERNVOQQjVhgxBTUfGz9WNQMFKBovEwZ0VjUBHCwVLh8bP1YyGVUaIx8/Ox8=", "FvuXv");
        G.lIlllIIII[G.lIlllIlIl[103]] = G.lIIllIlIIIll("MRsbOFDFcIPKgeQ3WFIo28k7nfoDzeCaOCjVqHtdGKmcQRCIKmKW+eMVGunnFUN+", "WfUHv");
        G.lIlllIIII[G.lIlllIlIl[104]] = G.lIIllIlIIIll("PyifZ/Ms1RLTdVbXXgityTC7amQPd9+pY26me+IUJEQttVpWxC4eOyQrYbgqi3Sy", "DRwsj");
        G.lIlllIIII[G.lIlllIlIl[106]] = G.lIIllIlIIlIl("6OKbhZNo5yK0MlLBCUBcS3RwokeN54leuh4XGGZ79a1MFMvwNvUi/vrwr0bunaiQ", "pEZHX");
        G.lIlllIIII[G.lIlllIlIl[116]] = G.lIIllIlIIlIl("Fhq/Nc54Um4NICxggGv77TGDoQsTsBtQ", "EPPyO");
        G.lIlllIIII[G.lIlllIlIl[117]] = G.lIIllIlIIIll("yZbfkF3PGV07oEUGqdpRbiBJPtT4WBOc", "grnJQ");
        G.lIlllIIII[G.lIlllIlIl[163]] = G.lIIllIlIIIll("escd2Vch6APUmtI0/xjjFg==", "WjUGv");
        G.lIlllIIII[G.lIlllIlIl[164]] = G.lIIllIlIIIll("SrLHAOtf8bwDdb7Z/WjRY9rzbWzij7MY", "sfNtO");
        G.lIlllIIII[G.lIlllIlIl[165]] = G.lIIllIlIIlII("GWEnHk0kNDJc", "PFKrm");
        G.lIlllIIII[G.lIlllIlIl[166]] = G.lIIllIlIIlIl("ZFYIkiXVYlLMIPOoST/tpoA8oW1N5S9G5JcWCuqrG10ZFfRXa4n57nhMAKsQ2CCZ", "SrQLa");
        G.lIlllIIII[G.lIlllIlIl[167]] = G.lIIllIlIIlII("GhI+bw==", "CwMAB");
        G.lIlllIIII[G.lIlllIlIl[168]] = G.lIIllIlIIlII("FjIVLFcyegAwFWE3FSwEJChL", "AZtXp");
        G.lIlllIIII[G.lIlllIlIl[169]] = G.lIIllIlIIlII("GgBIWCJyBwhYGDAORA8DNB9EMUs2CgpYDzpF", "Ukdxk");
    }
    ...
    private static void lIIlllIIlIII() {
        ...
        G.lIlllIlIl[1] = "  ".length();
        G.lIlllIlIl[2] = 98 + 191 - 150 + 81 + (0x41 ^ 0x44) - (0x43 ^ 0x36) + (0x76 ^ 0);
        G.lIlllIlIl[3] = " ".length();
        G.lIlllIlIl[4] = (0x1E ^ 0x4A ^ (0x2D ^ 0x1B)) & (0x2A ^ 0x25 ^ (0x5D ^ 0x30) ^ -" ".length());
    ...
    public boolean V() {
        ...
        if (G.lIIlllIlIIIl(e.j(lIlllIlIl[2]), lIlllIlIl[18])) {
            bl = lIlllIlIl[3];
            "".length();
            if ("  ".length() == (0xE ^ 0x21 ^ (0x95 ^ 0xBE))) {
                return ((235 + 69 - 297 + 242 ^ 77 + 150 - 82 + 50) & (0xFF ^ 0x95 ^ (0x7B ^ 0x2B) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlllIlIl[4];
        }
        ...
        if (G.lIIlllIIllII(Inventory.contains((int[])nArray2) ? 1 : 0)) {
            ...
            if (G.lIIlllIIlIll(hB.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && G.lIIlllIIllll(llIIIllIIlIIII) && G.lIIlllIIlIll(hD.contains(llIIIllIIlIIII.getWorldLocation()) ? 1 : 0)) {
                while (G.lIIlllIIllIl(Players.getLocal().getWorldLocation().distanceTo(ig), lIlllIlIl[1]) && G.lIIlllIIllII(AccBuilderEasyClues.d ? 1 : 0)) {
                    ...
                    "".length();
                    "".length();
                    if ("   ".length() != ((142 + 114 - 173 + 103 ^ 63 + 116 - 170 + 153) & (125 + 188 - 152 + 59 ^ 141 + 173 - 121 + 3 ^ -" ".length()))) continue;
                    return;
                }
            }
        ...
        if (G.lIIlllIIlIll(Inventory.contains((int[])nArray3) ? 1 : 0)) {
            if (G.lIIlllIIlllI(Players.getLocal().getWorldLocation().distanceTo(ig), lIlllIlIl[12])) {
                while (G.lIIlllIIllIl(Players.getLocal().getWorldLocation().distanceTo(new WorldPoint(lIlllIlIl[93], lIlllIlIl[94], lIlllIlIl[4])), lIlllIlIl[3]) && G.lIIlllIIllII(AccBuilderEasyClues.d ? 1 : 0)) {
                    ...
                    "".length();
                    "".length();
                    if (((42 + 35 - -47 + 50 ^ 102 + 37 - 54 + 84) & (11 + 35 - 8 + 102 ^ 92 + 8 - 53 + 92 ^ -" ".length())) == 0) continue;
                    return;
                }
            }
