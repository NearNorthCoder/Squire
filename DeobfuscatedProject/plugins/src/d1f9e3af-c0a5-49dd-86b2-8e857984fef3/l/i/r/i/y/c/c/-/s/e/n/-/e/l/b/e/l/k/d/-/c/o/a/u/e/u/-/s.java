...
implements W {
    ...
    private static boolean ab() {
        ...
        while (s.lllIlIIlIII(lIIIlllIIlIlIII, ((void)lIIIlllIIlIlIIl).length)) {
            ...
            return ((60 + 81 - 45 + 64 ^ 124 + 49 - 73 + 55) & (170 + 124 - 120 + 6 ^ 106 + 138 - 211 + 110 ^ -" ".length())) != 0;
        }
        return lIIIllIIl[0];
    }
    ...
    public boolean V() {
        ...
        if (s.lllIlIIlIll(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIIIllIIl[2])) {
            bl = lIIIllIIl[0];
            "".length();
            if (((127 + 24 - 100 + 97 ^ 127 + 15 - 104 + 94) & (0x25 ^ 0x40 ^ (0xCA ^ 0xBF) ^ -" ".length())) >= (0x12 ^ 0x4D ^ (0x7E ^ 0x25))) {
                return ((0x78 ^ 0x3B ^ (0x54 ^ 0x2A)) & (0xD4 ^ 0x80 ^ (0xF ^ 0x66) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIllIIl[1];
        }
    ...
    private static void lllIlIIIlIl() {
        ...
        s.lIIIllIIl[0] = " ".length();
        s.lIIIllIIl[1] = (0x24 ^ 0xE) & ~(0x6B ^ 0x41);
        s.lIIIllIIl[2] = "   ".length() + (1 + 101 - -13 + 96) - (0x62 ^ 0x2D) + (0xC ^ 0x65);
        ...
        s.lIIIllIIl[9] = "  ".length();
        s.lIIIllIIl[10] = 0xBA ^ 0x9A;
        s.lIIIllIIl[11] = "   ".length();
        ...
        s.lIIIllIIl[49] = "  ".length() ^ (0x36 ^ 0x21);
        ...
        s.lIIIllIIl[114] = 0xC6 ^ 0x83 ^ " ".length();
    ...
    private static void lllIlIIIlII() {
        ...
        s.lIIIllIII[s.lIIIllIIl[1]] = s.lllIlIIIIIl("68kxOthWA0smAFRy5TfUiPsdZnUoeF0tU4gMyljkolESIN9jYcKaSBxDp2SsDHVB", "YVTDD");
        s.lIIIllIII[s.lIIIllIIl[0]] = s.lllIlIIIIIl("7nswVvBYvyDfTfIEzGHc7A==", "wlKqP");
        s.lIIIllIII[s.lIIIllIIl[9]] = s.lllIlIIIIIl("mCUSQpoblANq35xoXxYx0w==", "fKWiO");
        s.lIIIllIII[s.lIIIllIIl[11]] = s.lllIlIIIIIl("tweSbes8NTfDnPS+OPY8DUke7PkitCnk", "lOJKW");
        s.lIIIllIII[s.lIIIllIIl[13]] = s.lllIlIIIIlI("JjAqHhgMLCw=", "eBKxl");
        s.lIIIllIII[s.lIIIllIIl[8]] = s.lllIlIIIIIl("2lRcd2YmciS7nJOhHbO5rg==", "UomLs");
        s.lIIIllIII[s.lIIIllIIl[16]] = s.lllIlIIIIll("kI6ds9F030Yih5Dav41nZw==", "jobTI");
        s.lIIIllIII[s.lIIIllIIl[20]] = s.lllIlIIIIlI("Gg4WNzkvBEQUIyUV", "LodEV");
        s.lIIIllIII[s.lIIIllIIl[21]] = s.lllIlIIIIIl("1p9/0CAxyqle7MN//QZiig==", "qKbjo");
        s.lIIIllIII[s.lIIIllIIl[19]] = s.lllIlIIIIIl("cyiCLyY4b8nplZPVRkGhWw==", "naooz");
        s.lIIIllIII[s.lIIIllIIl[4]] = s.lllIlIIIIlI("LzckCwcbPHAOFwMp", "nYPbv");
        s.lIIIllIII[s.lIIIllIIl[23]] = s.lllIlIIIIIl("qSn/I5LU165uXDh8hdXAH3S8D0VEVAOq", "Xlnuw");
        s.lIIIllIII[s.lIIIllIIl[24]] = s.lllIlIIIIll("/fAOwrF28zH1CMJm9e7p2w==", "IzHAB");
        s.lIIIllIII[s.lIIIllIIl[25]] = s.lllIlIIIIIl("4YTVTmkWUxg=", "zaQIY");
        s.lIIIllIII[s.lIIIllIIl[26]] = s.lllIlIIIIIl("vl0L4ZYJPD8qj4aOv/cWWA==", "dQGVP");
        s.lIIIllIII[s.lIIIllIIl[28]] = s.lllIlIIIIlI("ISYGESgAKQ9VJggpAxwqDg==", "iGhuD");
        s.lIIIllIII[s.lIIIllIIl[35]] = s.lllIlIIIIlI("BhB2DRk0VTsFGCIcOAtLIAAzHx9xBiMcGz0cMx9HcQYhBR8yHT8CDHEBOUwpBCwfIiw=", "QuVlk");
        s.lIIIllIII[s.lIIIllIIl[42]] = s.lllIlIIIIlI("MT9sFBgDeiEcGRUzIhJKFy8pBh5GKTkFGgozKQZGRik7HB4FMiUbDUYuI1UoMwMFOy0=", "fZLuj");
        s.lIIIllIII[s.lIIIllIIl[46]] = s.lllIlIIIIll("K9bFzRKxP1w=", "RZkPo");
        s.lIIIllIII[s.lIIIllIIl[12]] = s.lllIlIIIIll("m3ujVHtzKnc=", "fDKru");
        s.lIIIllIII[s.lIIIllIIl[48]] = s.lllIlIIIIll("ovtfCCWBErA=", "YTFKS");
        s.lIIIllIII[s.lIIIllIIl[49]] = s.lllIlIIIIll("4sdlQrDOW5M=", "QajEe");
        s.lIIIllIII[s.lIIIllIIl[50]] = s.lllIlIIIIIl("a4+EzUb0ZJ8=", "xbcya");
        s.lIIIllIII[s.lIIIllIIl[51]] = s.lllIlIIIIIl("tyTAifbhPvjLpdQs/G7AFA==", "oLbwL");
        s.lIIIllIII[s.lIIIllIIl[47]] = s.lllIlIIIIlI("KQYr", "hpJyu");
        s.lIIIllIII[s.lIIIllIIl[54]] = s.lllIlIIIIlI("FRofPys2BhU=", "WupTH");
        s.lIIIllIII[s.lIIIllIIl[55]] = s.lllIlIIIIll("peLb9dB2738=", "eEPMg");
        s.lIIIllIII[s.lIIIllIIl[57]] = s.lllIlIIIIll("PjU5a+kgTcEsg7wz7ZJ+qA==", "CaNld");
        s.lIIIllIII[s.lIIIllIIl[58]] = s.lllIlIIIIll("n59VpzSMP8s=", "rpEni");
        s.lIIIllIII[s.lIIIllIIl[59]] = s.lllIlIIIIll("TEoB24kUsTg=", "BMKol");
        s.lIIIllIII[s.lIIIllIIl[64]] = s.lllIlIIIIlI("Gy8EcTc6bhE5Iic6FyM=", "UNrQC");
        s.lIIIllIII[s.lIIIllIIl[65]] = s.lllIlIIIIll("ZJzYjYMZpffWhjXdE4jxyTBfNd7vvMGn", "PzhvQ");
        s.lIIIllIII[s.lIIIllIIl[10]] = s.lllIlIIIIlI("HDoWIwg=", "HHwGm");
        s.lIIIllIII[s.lIIIllIIl[66]] = s.lllIlIIIIIl("D+805116j0c=", "hhCWH");
        s.lIIIllIII[s.lIIIllIIl[67]] = s.lllIlIIIIIl("keXvXeuvQnooeA3xzciv1Q==", "SRSFP");
        s.lIIIllIII[s.lIIIllIIl[14]] = s.lllIlIIIIIl("xrjdDvPoZ2g=", "HouGX");
        s.lIIIllIII[s.lIIIllIIl[68]] = s.lllIlIIIIll("BvKiTNP7gbWULPitWWlWhw==", "yKJwy");
        s.lIIIllIII[s.lIIIllIIl[69]] = s.lllIlIIIIIl("6wTXDaf14a2Awu8yg5CGZw==", "sBfyU");
        s.lIIIllIII[s.lIIIllIIl[70]] = s.lllIlIIIIIl("Lc3+qF8Sugk=", "xlGVc");
        s.lIIIllIII[s.lIIIllIIl[71]] = s.lllIlIIIIlI("ATUANhY=", "CZnSe");
        s.lIIIllIII[s.lIIIllIIl[22]] = s.lllIlIIIIlI("ESsMPTw=", "SDbXO");
        s.lIIIllIII[s.lIIIllIIl[72]] = s.lllIlIIIIll("QePvyDxYZRY=", "QqjoG");
        s.lIIIllIII[s.lIIIllIIl[75]] = s.lllIlIIIIIl("a5/MVyHsSZo=", "JuWiG");
        s.lIIIllIII[s.lIIIllIIl[76]] = s.lllIlIIIIIl("BSiRyR44qIXipOUkY1OAKg==", "twGtz");
        s.lIIIllIII[s.lIIIllIIl[77]] = s.lllIlIIIIlI("KAY/FSZGDjkPKg==", "kjVxD");
        s.lIIIllIII[s.lIIIllIIl[78]] = s.lllIlIIIIlI("GA4fHwA/AB0=", "Zaqzm");
        s.lIIIllIII[s.lIIIllIIl[79]] = s.lllIlIIIIIl("7dvFiEYNPN9TRdRQ+exXag==", "ZMKzs");
        s.lIIIllIII[s.lIIIllIIl[80]] = s.lllIlIIIIlI("NisFAAIINA==", "aDwsj");
        s.lIIIllIII[s.lIIIllIIl[81]] = s.lllIlIIIIlI("MQE6ID0WDzg=", "snTEP");
        s.lIIIllIII[s.lIIIllIIl[82]] = s.lllIlIIIIIl("jz3wm/+3lRE2RiKucKBvsQ==", "dwufN");
        s.lIIIllIII[s.lIIIllIIl[15]] = s.lllIlIIIIIl("qAKBb3sZyUk=", "nnoOH");
        s.lIIIllIII[s.lIIIllIIl[84]] = s.lllIlIIIIIl("3PbaOzRgfCg=", "zosuz");
        s.lIIIllIII[s.lIIIllIIl[85]] = s.lllIlIIIIIl("W5ZFHJ3XA1I=", "YarNa");
        s.lIIIllIII[s.lIIIllIIl[86]] = s.lllIlIIIIlI("OxY9BDI=", "zzTgW");
        s.lIIIllIII[s.lIIIllIIl[87]] = s.lllIlIIIIIl("2qhHBP1Z2xw=", "SDiNW");
        s.lIIIllIII[s.lIIIllIIl[88]] = s.lllIlIIIIll("dmXt3kOMTKI=", "cunXB");
        s.lIIIllIII[s.lIIIllIIl[93]] = s.lllIlIIIIlI("OhQkayQbVTE5PxoQ", "tuRKP");
        s.lIIIllIII[s.lIIIllIIl[94]] = s.lllIlIIIIlI("PxY8RzECFTYC", "pzXgR");
        s.lIIIllIII[s.lIIIllIIl[96]] = s.lllIlIIIIlI("GxYiESo6Gg==", "VwNrE");
        s.lIIIllIII[s.lIIIllIIl[98]] = s.lllIlIIIIIl("5mCuuR0odoc=", "yyeKW");
        s.lIIIllIII[s.lIIIllIIl[6]] = s.lllIlIIIIlI("PCU5CB8dKQ==", "qDUkp");
        s.lIIIllIII[s.lIIIllIIl[101]] = s.lllIlIIIIIl("OMLNH118Npv6gmfJFHI62A==", "fqsTY");
        s.lIIIllIII[s.lIIIllIIl[102]] = s.lllIlIIIIIl("XwNYEUZCR0KQFUsWs5SFKQ==", "yEkIl");
        s.lIIIllIII[s.lIIIllIIl[104]] = s.lllIlIIIIll("XdEzWVtQzIUPnqTavVRbjA==", "JsDEt");
        s.lIIIllIII[s.lIIIllIIl[107]] = s.lllIlIIIIlI("HCQzIA0=", "KMGCe");
        s.lIIIllIII[s.lIIIllIIl[3]] = s.lllIlIIIIlI("BhsRCgs=", "Qreic");
        s.lIIIllIII[s.lIIIllIIl[109]] = s.lllIlIIIIlI("JQg/RAQGDiMBHQ==", "giMdi");
        s.lIIIllIII[s.lIIIllIIl[113]] = s.lllIlIIIIll("FgUNmz6PDpRH2iWqCsR/qQ==", "pVRdB");
        s.lIIIllIII[s.lIIIllIIl[114]] = s.lllIlIIIIll("Rl21B7cPDp0=", "grDBy");
        s.lIIIllIII[s.lIIIllIIl[115]] = s.lllIlIIIIIl("pF1MXSykATRNFRoo5wKecg==", "nrMgK");
        s.lIIIllIII[s.lIIIllIIl[89]] = s.lllIlIIIIll("XPojP3L4ciODuBcAP2z/OA==", "fFEml");
        s.lIIIllIII[s.lIIIllIIl[119]] = s.lllIlIIIIlI("Fy0sCScmYzweIyc=", "BCHlF");
        s.lIIIllIII[s.lIIIllIIl[120]] = s.lllIlIIIIlI("OgAaPQ==", "yhuMi");
        s.lIIIllIII[s.lIIIllIIl[90]] = s.lllIlIIIIlI("EBEJIA==", "GthRM");
        s.lIIIllIII[s.lIIIllIIl[125]] = s.lllIlIIIIIl("8Tlrd5pT25UiSTO5KUit1Q==", "tdBtU");
        s.lIIIllIII[s.lIIIllIIl[126]] = s.lllIlIIIIll("cNcCV7eJzcs=", "EBliq");
        s.lIIIllIII[s.lIIIllIIl[95]] = s.lllIlIIIIll("wHysexvZJhw=", "jGZQR");
        s.lIIIllIII[s.lIIIllIIl[128]] = s.lllIlIIIIll("IF6Y+3BjaV9r/pwse7QYCg==", "SwLTh");
        s.lIIIllIII[s.lIIIllIIl[129]] = s.lllIlIIIIlI("OzcpIg0KeTk1CQs=", "nYMGl");
        s.lIIIllIII[s.lIIIllIIl[130]] = s.lllIlIIIIIl("q8pu68665jQ=", "IgsDR");
        s.lIIIllIII[s.lIIIllIIl[97]] = s.lllIlIIIIll("PFxap7EO2/GND+jwe1A4hQ==", "qHxPO");
        s.lIIIllIII[s.lIIIllIIl[134]] = s.lllIlIIIIlI("JykGPCwHLx15Ixo4ECo=", "uLuYM");
        s.lIIIllIII[s.lIIIllIIl[135]] = s.lllIlIIIIIl("xncXskMZ1T067V9eGkjCnQ==", "WCZiJ");
        s.lIIIllIII[s.lIIIllIIl[138]] = s.lllIlIIIIlI("JGcXNTYRIhU6", "eGgTB");
        s.lIIIllIII[s.lIIIllIIl[139]] = s.lllIlIIIIIl("ofSKIpuWTrQ7WazLwWxiyQ==", "zQusg");
        s.lIIIllIII[s.lIIIllIIl[140]] = s.lllIlIIIIlI("MQAfMXQVBAwhPBwT", "yamUT");
        s.lIIIllIII[s.lIIIllIIl[142]] = s.lllIlIIIIIl("HHPzYxTTPV1r+G6mFkrHDg==", "hdjDX");
        s.lIIIllIII[s.lIIIllIIl[143]] = s.lllIlIIIIll("pnG7qJxZUm8=", "ziRfL");
        s.lIIIllIII[s.lIIIllIIl[144]] = s.lllIlIIIIll("ZOeLHaY8fEluQioDoO/g0g==", "TJRXi");
        s.lIIIllIII[s.lIIIllIIl[145]] = s.lllIlIIIIIl("srCTacjZ5x8=", "KSopf");
        s.lIIIllIII[s.lIIIllIIl[99]] = s.lllIlIIIIIl("UC1tNanRgTQh1LPk2o2ODw==", "eYXsE");
        s.lIIIllIII[s.lIIIllIIl[146]] = s.lllIlIIIIlI("KygEHigQ", "xMelK");
        s.lIIIllIII[s.lIIIllIIl[159]] = s.lllIlIIIIlI("", "UTGfR");
        s.lIIIllIII[s.lIIIllIIl[160]] = s.lllIlIIIIlI("Cz8iNComcQY4LCQ0PzA4Jw==", "JQKYK");
        s.lIIIllIII[s.lIIIllIIl[161]] = s.lllIlIIIIlI("GTwYC0IEM1YbBwo5AgRCQw==", "kUvlb");
        s.lIIIllIII[s.lIIIllIIl[162]] = s.lllIlIIIIlI("MxgcKg==", "wjsZW");
        s.lIIIllIII[s.lIIIllIIl[173]] = s.lllIlIIIIIl("8R7arJx5zbI=", "hZVxI");
        s.lIIIllIII[s.lIIIllIIl[174]] = s.lllIlIIIIll("7/TLbDWJjZwDNN7KzTeKcmJBTnAKNdl1", "YxHGn");
        s.lIIIllIII[s.lIIIllIIl[175]] = s.lllIlIIIIll("gIiCaKz/oyx7OGYMSd9uCM2Mscr3yXE+yzAZakQp2yg87rqWhWFefnb1FnaTt0VW", "UAeVw");
        s.lIIIllIII[s.lIIIllIIl[176]] = s.lllIlIIIIIl("KROpCav6fBSqvhLqeCbs294lNoUI24p6sEaicIkLVr47NqdEgEugvg==", "fGRHI");
        s.lIIIllIII[s.lIIIllIIl[100]] = s.lllIlIIIIlI("JwY3GD5EIGIWLx1JcFQ5DAAhHz8KGn0=", "diBtZ");
        s.lIIIllIII[s.lIIIllIIl[177]] = s.lllIlIIIIlI("JnUsZB0KICRkFA09NDBVDnIwMRAcJm8=", "oRADu");
        s.lIIIllIII[s.lIIIllIIl[178]] = s.lllIlIIIIll("PTXqe53gj5u6RlhN9+mQJyi/eSpr0jefkcBva7X4vX6rjLHw0DqRiL/elgRw17TB", "pNsrE");
        s.lIIIllIII[s.lIIIllIIl[179]] = s.lllIlIIIIlI("DlcUbQ4oBhVtDSkVXG0WLxEeJhFp", "GppMb");
