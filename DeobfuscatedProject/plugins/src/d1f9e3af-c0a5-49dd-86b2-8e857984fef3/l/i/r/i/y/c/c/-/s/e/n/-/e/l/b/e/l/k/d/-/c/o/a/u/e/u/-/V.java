...
implements W {
    ...
    public boolean V() {
        ...
        if (V.lIIlIlIIIIII(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()), lIlIlllIl[18])) {
            ...
            if (V.lIIlIIlllIIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                n2 = lIlIlllIl[1];
                "".length();
                if ((130 + 14 - 31 + 30 ^ 42 + 12 - 6 + 91) > ((9 + 126 - -54 + 27 ^ 82 + 21 - 48 + 80) & (126 + 49 - 40 + 19 ^ 166 + 80 - 235 + 186 ^ -" ".length()))) return n2 != 0;
                return ((0xB2 ^ 0x9D ^ (0x96 ^ 0x84)) & (0x72 ^ 0x67 ^ (0x79 ^ 0x51) ^ -" ".length())) != 0;
            }
        }
        n2 = lIlIlllIl[0];
        return n2 != 0;
    ...
    private static void lIIlIIllIIll() {
        ...
        V.lIlIllIll[V.lIlIlllIl[0]] = V.lIIlIIlIllII("MTAvKCAUZT81Kx42", "sEVAN");
        V.lIlIllIll[V.lIlIlllIl[1]] = V.lIIlIIlIllIl("qJpEgEorHqTS9bEdX7F7EVPH9Cjqrcps1LDuJe9Sjsg1FM/1zJKyIZff7q2Fl2fX", "arEFN");
        V.lIlIllIll[V.lIlIlllIl[3]] = V.lIIlIIlIlllI("GAU1qunzWcE=", "pvgxD");
        V.lIlIllIll[V.lIlIlllIl[5]] = V.lIIlIIlIlllI("BimrFSTXwtY=", "jSLKe");
        V.lIlIllIll[V.lIlIlllIl[6]] = V.lIIlIIlIlllI("ArjG5DjGMJQ2cuCX7Kpi6A==", "adsdH");
        V.lIlIllIll[V.lIlIlllIl[7]] = V.lIIlIIlIllII("Hys9JTk+JDRhNzYkOCg7MA==", "WJSAU");
        V.lIlIllIll[V.lIlIlllIl[9]] = V.lIIlIIlIllIl("8DB+I44IPwktvQP/yR5UHU+a6rDCMiuoRkgDWv3sRDr2wUuh7pDhbQ90GMWBWKtbRsnfXj5jdv0=", "WsDII");
        V.lIlIllIll[V.lIlIlllIl[17]] = V.lIIlIIlIllIl("CyVi1IevEPKkaRn2uTLD2Q==", "FMZhY");
        V.lIlIllIll[V.lIlIlllIl[18]] = V.lIIlIIlIlllI("Al3h7I2r3z7YPwc6k54Whw==", "YaPpW");
        V.lIlIllIll[V.lIlIlllIl[19]] = V.lIIlIIlIllIl("CHxuFK9KEkI=", "uKefq");
        V.lIlIllIll[V.lIlIlllIl[15]] = V.lIIlIIlIlllI("flLvo4AfUBM=", "bvWWC");
        V.lIlIllIll[V.lIlIlllIl[20]] = V.lIIlIIlIllIl("ai3SSbj29LZRjXPwx/ck6Q==", "SXUKK");
        V.lIlIllIll[V.lIlIlllIl[21]] = V.lIIlIIlIllIl("511OofgYW/Q=", "bSSfK");
        V.lIlIllIll[V.lIlIlllIl[22]] = V.lIIlIIlIllIl("FwztdkSI6js=", "rAXFm");
        V.lIlIllIll[V.lIlIlllIl[23]] = V.lIIlIIlIllIl("B8KfmZFmOh0N90NOYtU+6Q==", "FLDOo");
        V.lIlIllIll[V.lIlIlllIl[24]] = V.lIIlIIlIlllI("Yl03eZbrv+M=", "gwyjh");
        V.lIlIllIll[V.lIlIlllIl[25]] = V.lIIlIIlIlllI("VcAjL2MQTCs=", "ploHT");
        V.lIlIllIll[V.lIlIlllIl[26]] = V.lIIlIIlIlllI("mw5z96eCqGYBZK7BpUDmfQ==", "GGMdz");
        V.lIlIllIll[V.lIlIlllIl[27]] = V.lIIlIIlIlllI("P3LCRrAgkeM=", "UZeQr");
        V.lIlIllIll[V.lIlIlllIl[28]] = V.lIIlIIlIllII("KgYu", "noIXF");
        V.lIlIllIll[V.lIlIlllIl[29]] = V.lIIlIIlIllII("JAcRaiMFRgMjMEpV", "jfgJW");
        V.lIlIllIll[V.lIlIlllIl[30]] = V.lIIlIIlIllII("FDUGLQ8=", "GEgIj");
        V.lIlIllIll[V.lIlIlllIl[31]] = V.lIIlIIlIlllI("YRlRsDkIulg=", "FsTdR");
        V.lIlIllIll[V.lIlIlllIl[32]] = V.lIIlIIlIllII("Ii4eVSEDbwwcMkx7", "lOhuU");
        V.lIlIllIll[V.lIlIlllIl[33]] = V.lIIlIIlIllIl("LZVG7pkhrt0=", "qQHIa");
        V.lIlIllIll[V.lIlIlllIl[34]] = V.lIIlIIlIlllI("XdJwXXcrH8I=", "WSOAz");
        V.lIlIllIll[V.lIlIlllIl[35]] = V.lIIlIIlIllII("ORI7RAYYUzsBHQRTKw0cHgAl", "wsMdr");
        V.lIlIllIll[V.lIlIlllIl[36]] = V.lIIlIIlIllIl("wg3gMeZKxicI3mPdm2n1og==", "eVFTj");
        V.lIlIllIll[V.lIlIlllIl[37]] = V.lIIlIIlIllII("DgMnHQ==", "XfHnT");
        V.lIlIllIll[V.lIlIlllIl[40]] = V.lIIlIIlIllII("ADkLDyU8K0kBLT88", "RLimL");
        V.lIlIllIll[V.lIlIlllIl[41]] = V.lIIlIIlIllII("FiwF", "DYgqz");
        V.lIlIllIll[V.lIlIlllIl[42]] = V.lIIlIIlIllIl("JoSI/qOWJ2G7XTwo0mHe46BvWyGj8ysF", "nWQXT");
        V.lIlIllIll[V.lIlIlllIl[43]] = V.lIIlIIlIllIl("/tJwD6szlR8=", "ABDQx");
        V.lIlIllIll[V.lIlIlllIl[44]] = V.lIIlIIlIlllI("w27bpUZFRto=", "gAzkT");
        V.lIlIllIll[V.lIlIlllIl[45]] = V.lIIlIIlIlllI("mwfaBa8WObI=", "RXHkE");
        V.lIlIllIll[V.lIlIlllIl[55]] = V.lIIlIIlIlllI("qOkVely+CfL/4Eb+FGaLwoWgMoeGN0cR", "TcZFO");
        V.lIlIllIll[V.lIlIlllIl[56]] = V.lIIlIIlIlllI("DIL9TmZ1sAvDVt+AnTfOey4NS02K298g", "EwNKx");
        V.lIlIllIll[V.lIlIlllIl[57]] = V.lIIlIIlIllII("DhE7IRER", "ytZMe");
        V.lIlIllIll[V.lIlIlllIl[58]] = V.lIIlIIlIllIl("Iioljm8VM34=", "OuClh");
        V.lIlIllIll[V.lIlIlllIl[59]] = V.lIIlIIlIllII("LR0DPBUy", "ZxbPa");
        V.lIlIllIll[V.lIlIlllIl[53]] = V.lIIlIIlIllIl("3R9YaZrCv6U=", "rJvUs");
        V.lIlIllIll[V.lIlIlllIl[60]] = V.lIIlIIlIlllI("p37xuz7jq1Y=", "LlGZS");
        V.lIlIllIll[V.lIlIlllIl[61]] = V.lIIlIIlIlllI("OdSqyXxS4fA=", "XgvMn");
        V.lIlIllIll[V.lIlIlllIl[62]] = V.lIIlIIlIlllI("JKCC1+o+N1nN53W0f08vEiVGGrfuOsVZaEX7NGxTs8o=", "IYrgf");
        V.lIlIllIll[V.lIlIlllIl[63]] = V.lIIlIIlIlllI("iXu+NIA+T3rN/4BBBrhXDT1M6lOzyeB6CJKdVviIjUi0MUtlecSl/A==", "sHqfo");
        V.lIlIllIll[V.lIlIlllIl[64]] = V.lIIlIIlIllIl("zHaz9Nss7d96NZv0SHC0w2kcAwYkYUDs", "bZGcg");
        V.lIlIllIll[V.lIlIlllIl[65]] = V.lIIlIIlIllII("OB00Yg==", "axGLw");
        V.lIlIllIll[V.lIlIlllIl[66]] = V.lIIlIIlIllIl("Y7coWsddHArfEj7KVzoK3u/P6bi5pAoUXmQBKqJX+1s=", "opsGa");
        V.lIlIllIll[V.lIlIlllIl[67]] = V.lIIlIIlIllIl("10aV0FbaSvI5QZHlPDKBJejksz4OVdzu", "snixE");
        V.lIlIllIll[V.lIlIlllIl[68]] = V.lIIlIIlIllIl("I9q5h3HeGpzFEaCxs4cwtC8JOixowmXuws6BV+44zoMOTP8x4eNuag==", "rzUEa");
        V.lIlIllIll[V.lIlIlllIl[69]] = V.lIIlIIlIlllI("RUIKaC3n508tzvn6k6n8+zcIyH2BlAkRFf6vy+OS3NSAh5S8f91QEp0BPDNfSaf4", "khXNs");
        V.lIlIllIll[V.lIlIlllIl[70]] = V.lIIlIIlIlllI("/qkdOMsoBT7SiKFkFK49sbtJRBTMBc2PCr8z0xl9tpW3WvoiZJ/Wzg==", "WpErD");
        V.lIlIllIll[V.lIlIlllIl[71]] = V.lIIlIIlIllII("KTo1Ino=", "zOGGT");
        V.lIlIllIll[V.lIlIlllIl[72]] = V.lIIlIIlIllII("JlEEZhgKFxsvAQhWCChPDhscKgobVgYgTwgeBjUbTwUZIw4EVw==", "oviFo");
        V.lIlIllIll[V.lIlIlllIl[73]] = V.lIIlIIlIllIl("j7iarRftcIV3QnGpa89EYA==", "nDrzg");
        V.lIlIllIll[V.lIlIlllIl[48]] = V.lIIlIIlIllII("ED84azY5Pm8CdTA1Iztq", "XPOKU");
        V.lIlIllIll[V.lIlIlllIl[74]] = V.lIIlIIlIlllI("C5r6PHk8f5Cnh475xJDO6xodUYi27PYgZR26PrRlQog=", "syHxi");
        V.lIlIllIll[V.lIlIlllIl[75]] = V.lIIlIIlIllIl("L16Nx94qPETMULLiABrlFQ==", "EXBrN");
    }
    ...
    private static boolean ab() {
        ...
        if (V.lIIlIIllIlll(Inventory.contains((String[])stringArray) ? 1 : 0)) {
            ...
            if (V.lIIlIIllIlll(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                return ((129 + 112 - 231 + 135 ^ 166 + 1 - 145 + 167) & (63 + 103 - 133 + 97 ^ 7 + 39 - -15 + 113 ^ -" ".length())) != 0;
            }
        }
        n2 = lIlIlllIl[0];
        return n2 != 0;
