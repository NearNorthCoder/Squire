...
public class g {
    ...
    private static void lIlIIllIIllI() {
        ...
        g.llIIIlIlI[g.llIIIlIll[3]] = g.lIlIIllIIIll("TRdbmza9wa0=", "LRKfi");
        g.llIIIlIlI[g.llIIIlIll[2]] = g.lIlIIllIIIll("8mB6yPWG5zY=", "ZsSSh");
        g.llIIIlIlI[g.llIIIlIll[6]] = g.lIlIIllIIIll("Wzem23OnRt4H2Y4qAISP5g==", "yvKUd");
        g.llIIIlIlI[g.llIIIlIll[7]] = g.lIlIIllIIlII("4AT2M/s5ug0=", "lTimo");
        g.llIIIlIlI[g.llIIIlIll[8]] = g.lIlIIllIIlIl("OQADPnUZDg==", "maoUX");
        g.llIIIlIlI[g.llIIIlIll[4]] = g.lIlIIllIIlII("z/lECCkdLeu7AWlCqUjg3g==", "xrYhw");
        g.llIIIlIlI[g.llIIIlIll[9]] = g.lIlIIllIIIll("y9vKWLkcf6Y=", "iuWcq");
        g.llIIIlIlI[g.llIIIlIll[10]] = g.lIlIIllIIIll("0nx5b4TaxiBRyS0Gq68eBQ==", "egWPw");
    }
    ...
    public static boolean K() {
        ...
        while (g.lIlIIllIlIII(lIllIlllIIIlIl, bn.length)) {
            ...
            return ((1 ^ 0x26 ^ "  ".length()) & (0xD0 ^ 0x9E ^ (1 ^ 0x6A) ^ -" ".length())) != 0;
        }
        return llIIIlIll[3];
    }
