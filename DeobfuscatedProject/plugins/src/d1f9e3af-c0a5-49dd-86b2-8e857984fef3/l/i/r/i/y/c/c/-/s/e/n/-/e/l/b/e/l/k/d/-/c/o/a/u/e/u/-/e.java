...
public class e {
    ...
    public static boolean z() {
        ...
        if (e.llIllIIlIll(Widgets.get((int)lIIIIIllI[25], (int)lIIIIIllI[0]))) {
            ...
            "".length();
            if (-"  ".length() > 0) {
                return ((0x22 ^ 0x6C ^ (0x78 ^ 0)) & (123 + 167 - 231 + 116 ^ 48 + 124 - 158 + 139 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIIIllI[2];
        }
                            ...
                            List lIIlIlIIllIllII = lIIlIlIIllIllIl.stream().filter(widget -> {
                                ...
                                if (e.llIllIIIlIl(widget.getText().contains(lIIIIIlII[lIIIIIllI[74]]) ? 1 : 0)) {
                                    ...
                                    if ((13 + 123 - 53 + 67 ^ 27 + 88 - 44 + 76) <= 0) {
                                        return ((0x7A ^ 0x2F ^ (0x45 ^ 0x1F)) & (0xC ^ 0x40 ^ (0xE6 ^ 0xA5) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIIIllI[2];
                                }
    ...
    private static void llIllIIIIll() {
        ...
        e.lIIIIIlII[e.lIIIIIllI[2]] = e.llIlIllllIl("9eRPQQZ5lrxKO2+8zI3rWw==", "kZSZa");
        e.lIIIIIlII[e.lIIIIIllI[0]] = e.llIllIIIIIl("PgMjLQ0TQjssDgVCLiEAAg==", "vbMIa");
        e.lIIIIIlII[e.lIIIIIllI[3]] = e.llIlIllllIl("1qr4Sa263cNSHNp8Vk1MeSbSYMelVjp4", "VOpkM");
        e.lIIIIIlII[e.lIIIIIllI[1]] = e.llIllIIIIlI("SLzeF/gTX/0MnHb6i47RtN5x9BcfD432", "ZdPTp");
        e.lIIIIIlII[e.lIIIIIllI[4]] = e.llIllIIIIlI("NIy5MKl5Camuqrwnq8PY8L6A13mzcLJx", "uWHQY");
        e.lIIIIIlII[e.lIIIIIllI[5]] = e.llIllIIIIlI("2+0q8EY30ZU=", "OtkUz");
        e.lIIIIIlII[e.lIIIIIllI[6]] = e.llIlIllllIl("MZGkt5pp2A7BdiQLbvhJiIakvMi2qUyJ", "SQGqx");
        e.lIIIIIlII[e.lIIIIIllI[7]] = e.llIllIIIIlI("BA/Lhua+mYmRE0A1S54tNnuC9D9GVqXd", "ZjcNb");
        e.lIIIIIlII[e.lIIIIIllI[8]] = e.llIlIllllIl("7d1ielJ6p3v1v2KydGn4+niXRrc63cC2", "dvdch");
        e.lIIIIIlII[e.lIIIIIllI[9]] = e.llIlIllllIl("B20pu4EWGlMypAUE5Ic9zqiyTR11vJ8P", "wbCMw");
        e.lIIIIIlII[e.lIIIIIllI[10]] = e.llIllIIIIlI("DJNb8zOB3+ED0Ods9pblatKfSZ18tL4t", "hVKYj");
        e.lIIIIIlII[e.lIIIIIllI[11]] = e.llIllIIIIlI("AbJUlMVilvA=", "LXplH");
        e.lIIIIIlII[e.lIIIIIllI[12]] = e.llIlIllllIl("FL0yLY4YhDV89Ap8uRTEbNgjHTMd+SBdud/3tXsoy6W6rXXHFr8ZxpNawisIDaGBbUnJxA4yX7o=", "XiAVK");
        e.lIIIIIlII[e.lIIIIIllI[13]] = e.llIlIllllIl("EDgakyGF9nQ9t6fcNW0hHA==", "lanlI");
        e.lIIIIIlII[e.lIIIIIllI[16]] = e.llIllIIIIlI("a8SMFfVIv+Q=", "jWMAv");
        e.lIIIIIlII[e.lIIIIIllI[17]] = e.llIllIIIIIl("CDcgUAMpdgARBTQ5NRtXEXY0ERkt", "FVVpw");
        e.lIIIIIlII[e.lIIIIIllI[23]] = e.llIlIllllIl("RyfVUSUkiYc=", "Geupf");
        e.lIIIIIlII[e.lIIIIIllI[24]] = e.llIlIllllIl("dF/wVhBSJk4YLZ5I2twY+gs+Uagtlm7F", "gYbPq");
        e.lIIIIIlII[e.lIIIIIllI[27]] = e.llIlIllllIl("5JUO3Rt096SVMA19FgwqeQ==", "SPdzx");
        e.lIIIIIlII[e.lIIIIIllI[29]] = e.llIlIllllIl("Zu5fscgkv3U=", "givLo");
        e.lIIIIIlII[e.lIIIIIllI[30]] = e.llIllIIIIIl("OQcAMQQI", "mhgVh");
        e.lIIIIIlII[e.lIIIIIllI[33]] = e.llIlIllllIl("J0+aKiTpcL0=", "KzqBE");
        e.lIIIIIlII[e.lIIIIIllI[36]] = e.llIllIIIIlI("xcifxKxg2ywstPzM8IUYtg==", "Zyepp");
        e.lIIIIIlII[e.lIIIIIllI[26]] = e.llIlIllllIl("T+8bJwaaNt8=", "PJDWw");
        e.lIIIIIlII[e.lIIIIIllI[37]] = e.llIlIllllIl("rzB09mlQz+k=", "eFGaF");
        e.lIIIIIlII[e.lIIIIIllI[38]] = e.llIlIllllIl("mAFYSd4jPyk=", "CsMmQ");
        e.lIIIIIlII[e.lIIIIIllI[39]] = e.llIlIllllIl("7a3CiS5vGeA=", "xRGmJ");
        e.lIIIIIlII[e.lIIIIIllI[40]] = e.llIllIIIIIl("FjoNAyo=", "SKxjZ");
        e.lIIIIIlII[e.lIIIIIllI[41]] = e.llIlIllllIl("i/AcAYo7R90=", "FrKcT");
        e.lIIIIIlII[e.lIIIIIllI[15]] = e.llIllIIIIIl("KyoBJkwBJlciTDwIVzAHGS8bbQ==", "lCwCl");
        e.lIIIIIlII[e.lIIIIIllI[54]] = e.llIllIIIIIl("JTkXTwYEeA4aBhgxBQpSDDkVCg==", "kXaor");
        e.lIIIIIlII[e.lIIIIIllI[55]] = e.llIllIIIIIl("HSsxPQ==", "ZJEXy");
        e.lIIIIIlII[e.lIIIIIllI[35]] = e.llIllIIIIIl("NhE/Kg==", "yaZDv");
        e.lIIIIIlII[e.lIIIIIllI[56]] = e.llIlIllllIl("B0pm2S9+ghsOdtNkELUoZPrJvePFu1FT", "PBavU");
        e.lIIIIIlII[e.lIIIIIllI[57]] = e.llIllIIIIIl("HBsbaQY9Wh49AD0UCiEdPh5NPRs+Hw==", "RzmIr");
        e.lIIIIIlII[e.lIIIIIllI[47]] = e.llIllIIIIlI("gCo+cjQuHCc=", "xopzP");
        e.lIIIIIlII[e.lIIIIIllI[60]] = e.llIllIIIIlI("zyswbv5fVpdQIwq3NhnkqA==", "gETxR");
        e.lIIIIIlII[e.lIIIIIllI[61]] = e.llIllIIIIlI("BGi7mdwDL2/rPDiiVShK4P7nMJJeI05x", "vWbgk");
        e.lIIIIIlII[e.lIIIIIllI[65]] = e.llIllIIIIIl("MgYcLVYBFhwjGhoSHCc=", "sshBv");
        e.lIIIIIlII[e.lIIIIIllI[66]] = e.llIllIIIIIl("CScsOUo6Nyw3BiEzLDM=", "HRXVj");
        e.lIIIIIlII[e.lIIIIIllI[21]] = e.llIllIIIIlI("vlDKFbU8BgEt5pNxyFoi/g==", "xdCio");
        e.lIIIIIlII[e.lIIIIIllI[32]] = e.llIlIllllIl("7NxBiaEUyBcRbogXuJkFag==", "hFFLQ");
        e.lIIIIIlII[e.lIIIIIllI[67]] = e.llIllIIIIlI("235TLXiJXlw=", "sLdXU");
        e.lIIIIIlII[e.lIIIIIllI[68]] = e.llIlIllllIl("owICXjVa55I=", "zvSfr");
        e.lIIIIIlII[e.lIIIIIllI[69]] = e.llIllIIIIlI("NdTvKLJgZ8E=", "yXgLs");
        e.lIIIIIlII[e.lIIIIIllI[70]] = e.llIlIllllIl("rDb4xtakr/M=", "plHeD");
        e.lIIIIIlII[e.lIIIIIllI[74]] = e.llIlIllllIl("FxcR3Z3dctk=", "ALTfQ");
        e.lIIIIIlII[e.lIIIIIllI[76]] = e.llIllIIIIlI("tIaZNZb7j/w=", "VrfIo");
        e.lIIIIIlII[e.lIIIIIllI[77]] = e.llIlIllllIl("I5xX65/7JFI=", "vzaTk");
        e.lIIIIIlII[e.lIIIIIllI[78]] = e.llIlIllllIl("EEfywg778ss=", "gSpbh");
        e.lIIIIIlII[e.lIIIIIllI[71]] = e.llIllIIIIIl("MR0JAA==", "ytnha");
        e.lIIIIIlII[e.lIIIIIllI[81]] = e.llIllIIIIIl("Jj0EPRwPKw==", "jXeZi");
        e.lIIIIIlII[e.lIIIIIllI[82]] = e.llIllIIIIIl("FiYRKA==", "TCeIW");
        e.lIIIIIlII[e.lIIIIIllI[83]] = e.llIllIIIIIl("Li8aDw==", "LJnnR");
        e.lIIIIIlII[e.lIIIIIllI[84]] = e.llIllIIIIIl("AzIWAxkmOQ==", "GWwgt");
        e.lIIIIIlII[e.lIIIIIllI[85]] = e.llIllIIIIlI("fchO42zUrK0=", "NJqBW");
        e.lIIIIIlII[e.lIIIIIllI[86]] = e.llIlIllllIl("S5XHPwhBC1az7i1wBE6d4w==", "yUXOT");
        e.lIIIIIlII[e.lIIIIIllI[87]] = e.llIlIllllIl("GLL5hTZu/uw=", "Rmzok");
        e.lIIIIIlII[e.lIIIIIllI[88]] = e.llIllIIIIIl("JAYcNA==", "fchUf");
        e.lIIIIIlII[e.lIIIIIllI[90]] = e.llIllIIIIIl("Bw4lEWcHCCQGJiUIOwwyJA==", "WaWeG");
        e.lIIIIIlII[e.lIIIIIllI[91]] = e.llIllIIIIlI("C9TnURHMQgRb0ItXG1Jpk8FHUxI7dHAw03KNfqknb+pIscbTwsEtf4ZemuhDwWtDJwYjkVaoBE0=", "QXFWr");
    }
    ...
    public static void a(HashMap<Integer, Integer> hashMap, boolean bl, boolean bl2) {
        if (e.llIllIIlIIl(Players.getLocal().getWorldLocation().distanceTo(Y), lIIIIIllI[4])) {
            ...
            if (e.llIllIIIlIl(worldArea.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                n2 = lIIIIIllI[0];
                "".length();
                if (((0x65 ^ 0x2F ^ (0x31 ^ 0x58)) & (141 + 73 - 51 + 3 ^ 28 + 61 - 57 + 101 ^ -" ".length())) >= (96 + 166 - 177 + 97 ^ 22 + 132 - 25 + 49)) {
                    return;
                }
            } else {
                n2 = lIIIIIllI[2];
    ...
    public static int c(int n2, int n3) {
        ...
        if (e.llIllIIIllI(Math.abs(lIIlIlIllIIllII), lIIIIIllI[0])) {
            ...
            if (e.llIllIIIlll(S.nextBoolean() ? 1 : 0)) {
                ...
                "".length();
                if (-" ".length() >= " ".length()) {
                    return (0x80 ^ 0x91 ^ (0x67 ^ 0x7E)) & (0x9E ^ 0x94 ^ "  ".length() ^ -" ".length());
                }
            } else {
                n5 = lIIlIlIllIIllIl;
            }
    ...
    public static boolean x() {
        ...
        if (!e.llIllIIIlll((Integer)GameThread.invokeLater(() -> Static.getClient().getVarbitValue(lIIIIIllI[28]))) || e.llIllIIIlIl((Integer)GameThread.invokeLater(() -> Static.getClient().getVarbitValue(lIIIIIllI[31])))) {
            ...
            "".length();
            if (" ".length() < 0) {
                return ((0xC8 ^ 0xAF ^ (0x72 ^ 6)) & (0xDE ^ 0xBF ^ (0xE8 ^ 0x9A) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIIIllI[2];
        }
    ...
    private static void llIllIIIlII() {
        ...
        e.lIIIIIllI[0] = " ".length();
        e.lIIIIIllI[1] = "   ".length();
        e.lIIIIIllI[2] = (0x53 ^ 0x43 ^ (0x5A ^ 0x72)) & (0xA9 ^ 0xAD ^ (0xFB ^ 0xC7) ^ -" ".length());
        e.lIIIIIllI[3] = "  ".length();
        ...
        e.lIIIIIllI[62] = -" ".length();
        e.lIIIIIllI[63] = (0x1F ^ 0x26) + " ".length() - -(0x19 ^ 0x7D) + (0x8F ^ 0x81);
        ...
        e.lIIIIIllI[110] = -"  ".length() & (0xFFFFE1FF & 0x1FEF);
        ...
        e.lIIIIIllI[194] = " ".length() ^ (0xE2 ^ 0xAC);
