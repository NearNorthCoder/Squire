...
implements W {
    ...
    private static void lllIlllllll() {
        ...
        aj.lIIIlllll[aj.lIIlIIIII[0]] = aj.lllIllIllll("ivztEgZL0zgJFSng8jsTMQ==", "ezYFR");
        aj.lIIIlllll[aj.lIIlIIIII[1]] = aj.lllIlllIIII("Ow6AJZRwKetKWeA0BDWefb/gZlLSm8/U9HsGIjIb+05dy66BQ9mdkv7sHxRMveboOfnXtO/9fRg=", "JavIL");
        aj.lIIIlllll[aj.lIIlIIIII[2]] = aj.lllIlllIIIl("GhAcCCM1BQMPI3QFBUEmNR8B", "TqjaD");
        aj.lIIIlllll[aj.lIIlIIIII[3]] = aj.lllIlllIIII("+jePEtfj2C0S4IKEIz39MA==", "iXKbh");
        aj.lIIIlllll[aj.lIIlIIIII[5]] = aj.lllIlllIIII("vdi7ikskZTZH1UVLpshng7KQI46vrpAP", "rcZYE");
        aj.lIIIlllll[aj.lIIlIIIII[7]] = aj.lllIlllIIII("Q5uL0Tv1Q0fJs8qaGc/H7ECT5c52AGfD", "qUiqr");
        aj.lIIIlllll[aj.lIIlIIIII[9]] = aj.lllIlllIIII("13PwNEcwgItueBSaTC/acQ==", "dMYRD");
        aj.lIIIlllll[aj.lIIlIIIII[11]] = aj.lllIlllIIII("YeKaU0OW4nndDopUx0PD/ATulUCqeZ34", "xzHdN");
        aj.lIIIlllll[aj.lIIlIIIII[13]] = aj.lllIlllIIII("2xtVda/IYdY=", "EfKxi");
        aj.lIIIlllll[aj.lIIlIIIII[15]] = aj.lllIlllIIIl("HyAWPC83LkU2JzA9", "YIeTF");
        aj.lIIIlllll[aj.lIIlIIIII[16]] = aj.lllIlllIIIl("DQ5BNSo/Sww9KykCDzN4KR4RJDQzDhJ4eCkcCCA7MgIPM3guBEEWDQMiLxM=", "ZkaTX");
        aj.lIIIlllll[aj.lIIlIIIII[17]] = aj.lllIllIllll("smN1F5aUAQfVfdGnIiBwTui8eVFx/HeL", "pbauX");
        aj.lIIIlllll[aj.lIIlIIIII[18]] = aj.lllIlllIIIl("MQYdGQMZCE4DBRM=", "wonqj");
        aj.lIIIlllll[aj.lIIlIIIII[19]] = aj.lllIlllIIIl("NwExTC4YHiAFJhZNOgMs", "qmHlH");
        aj.lIIIlllll[aj.lIIlIIIII[20]] = aj.lllIlllIIIl("ADYZPCojIQ==", "FSxHB");
        aj.lIIIlllll[aj.lIIlIIIII[22]] = aj.lllIllIllll("CkiDxfVfcS0P8qobpG002A==", "YLNNS");
        aj.lIIIlllll[aj.lIIlIIIII[25]] = aj.lllIlllIIII("z2l7qh2rsUgeO9jAjFEcpw==", "dlxyA");
        aj.lIIIlllll[aj.lIIlIIIII[26]] = aj.lllIlllIIIl("LTkAFx4AJQhHAgYsHA==", "iKogn");
        aj.lIIIlllll[aj.lIIlIIIII[28]] = aj.lllIlllIIII("QK/EAOKSujl+8j+yoFu9FlnbLOyFxBLb", "mERqQ");
        aj.lIIIlllll[aj.lIIlIIIII[29]] = aj.lllIlllIIII("7tgROGkDPyU=", "yuinW");
        aj.lIIIlllll[aj.lIIlIIIII[27]] = aj.lllIlllIIII("rP3GNrmayu0=", "ICZYk");
        aj.lIIIlllll[aj.lIIlIIIII[32]] = aj.lllIlllIIII("f8T6HvAHKWdNQpnqy8Euo+t5erZRLM5E", "HklOp");
        aj.lIIIlllll[aj.lIIlIIIII[33]] = aj.lllIlllIIII("nvmD/hQfp8I=", "nwZnC");
        aj.lIIIlllll[aj.lIIlIIIII[34]] = aj.lllIlllIIII("ncVnJK6L4ss=", "AFxyt");
        aj.lIIIlllll[aj.lIIlIIIII[35]] = aj.lllIlllIIIl("PSkOSAEcaB4EDFMuERsdUzsIBwE=", "sHxhu");
        aj.lIIIlllll[aj.lIIlIIIII[36]] = aj.lllIllIllll("FhDJwt/lgTk=", "RUjEi");
        aj.lIIIlllll[aj.lIIlIIIII[37]] = aj.lllIllIllll("0ofePr/ffK0=", "cgXyY");
        aj.lIIIlllll[aj.lIIlIIIII[38]] = aj.lllIlllIIII("ILDesLR4pl1RPN7Js6AsXw==", "GjYDw");
        aj.lIIIlllll[aj.lIIlIIIII[39]] = aj.lllIlllIIII("4vzUImwM3CXBhKwbn6k27A==", "CcyIc");
        aj.lIIIlllll[aj.lIIlIIIII[40]] = aj.lllIllIllll("MpJDNNqCABMhLSRK90UUCQ==", "CkhoX");
        aj.lIIIlllll[aj.lIIlIIIII[41]] = aj.lllIlllIIII("FmF1IEOAXeQ=", "FNouW");
        aj.lIIIlllll[aj.lIIlIIIII[42]] = aj.lllIllIllll("3tVRsochCNjvFXMx0ayN+g==", "wCsLG");
        aj.lIIIlllll[aj.lIIlIIIII[43]] = aj.lllIllIllll("Xb2WFcswS4Ks4H7iseFa3+smp548Y/1EZutqmNSCbk6UifdOKJfOxsl46BBCnFVRBqgh981iNOs=", "bBFyr");
        aj.lIIIlllll[aj.lIIlIIIII[44]] = aj.lllIlllIIIl("LQ8jPS0CGjw6LUMaOnQoAgA+", "cnUTJ");
        aj.lIIIlllll[aj.lIIlIIIII[45]] = aj.lllIlllIIIl("Fx4KFis2CU8aIzYF", "XnoxB");
        aj.lIIIlllll[aj.lIIlIIIII[46]] = aj.lllIlllIIII("bVcWJ5fxZUw0Q5fnwxzUHvIkTA2mKcJ1", "UIWPq");
        aj.lIIIlllll[aj.lIIlIIIII[47]] = aj.lllIlllIIIl("HSoVBhVuIR0ZEScpE0oXKzM=", "NGtjy");
        aj.lIIIlllll[aj.lIIlIIIII[48]] = aj.lllIllIllll("9bY459XFkjvZ0iHhhvM9mbLNGsnN+lS1H6k24b7os2p6OTmy+TcBMDEd6aGH8nad", "fubeJ");
        aj.lIIIlllll[aj.lIIlIIIII[49]] = aj.lllIllIllll("cnc4R/lmajO0m8kVaotZckZblDvruraA", "cgmDY");
        aj.lIIIlllll[aj.lIIlIIIII[53]] = aj.lllIllIllll("DhGmrEv3/SivPUGgnOJAOA==", "DHkde");
        aj.lIIIlllll[aj.lIIlIIIII[54]] = aj.lllIlllIIII("B3rdc4Jqufgg7I2DbZEam02CzFb+5Crm", "ZuXYz");
        aj.lIIIlllll[aj.lIIlIIIII[55]] = aj.lllIlllIIIl("BCMJMQ==", "SFhCs");
        aj.lIIIlllll[aj.lIIlIIIII[56]] = aj.lllIlllIIII("IpuwGBQPaAI=", "sfNYo");
        aj.lIIIlllll[aj.lIIlIIIII[57]] = aj.lllIlllIIII("W0qg/KFOVM3FRXlq/lYUOl7cFU7k7EJp", "SEODL");
        aj.lIIIlllll[aj.lIIlIIIII[58]] = aj.lllIlllIIII("2VFuAEMOVgdVwk7ppKGbrvsz94pYkWaz", "eqpCl");
        aj.lIIIlllll[aj.lIIlIIIII[59]] = aj.lllIlllIIII("mfYV6Ejjl11ekCW+3JDHkA==", "RzREy");
        aj.lIIIlllll[aj.lIIlIIIII[60]] = aj.lllIllIllll("X7YvP1+DcffyAHjnbEPEVA==", "EBHgT");
        aj.lIIIlllll[aj.lIIlIIIII[61]] = aj.lllIllIllll("2WmJCigGj/4=", "znVXU");
        aj.lIIIlllll[aj.lIIlIIIII[62]] = aj.lllIllIllll("nJzvkijKBy0naWdW8bvgMg==", "LbiDU");
        aj.lIIIlllll[aj.lIIlIIIII[73]] = aj.lllIlllIIIl("Mx82KSAbEQ==", "uvEAI");
        aj.lIIIlllll[aj.lIIlIIIII[75]] = aj.lllIllIllll("9ZT2ce4AMp4JZR1jyfP1qk9obckhk7dL", "PjVZQ");
        aj.lIIIlllll[aj.lIIlIIIII[76]] = aj.lllIlllIIII("/RoDxA3MKalUKwJnRnc35TC8rCi6p6k9", "mEDFE");
        aj.lIIIlllll[aj.lIIlIIIII[78]] = aj.lllIlllIIIl("ESseDg85JU0EBz42", "WBmff");
        aj.lIIIlllll[aj.lIIlIIIII[79]] = aj.lllIlllIIIl("MAI2ASETFQ==", "vgWuI");
        aj.lIIIlllll[aj.lIIlIIIII[80]] = aj.lllIllIllll("M6NTEl5ZYWcN18Ma8G+2UA==", "ZMZIN");
        aj.lIIIlllll[aj.lIIlIIIII[81]] = aj.lllIlllIIIl("FgEfMh0+D0woGzQ=", "PhlZt");
        aj.lIIIlllll[aj.lIIlIIIII[82]] = aj.lllIllIllll("XTUKEohEGyg09F4r4wyROlsn0Mt54U/y", "wMKoT");
    }
                ...
                if (aj.llllIIIIIIl(Bank.contains((int[])nArray5) ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (aj.llllIIIIlIl(Inventory.getCount((String[])stringArray))) {
                            ...
                            "".length();
                            if (-" ".length() > " ".length()) {
                                return ((0xD5 ^ 0xC4 ^ (0x5C ^ 7)) & (0x4E ^ 0x3A ^ (0xA3 ^ 0x9D) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIlIIIII[0];
                        }
                            ...
                            if (aj.llllIIIlIII(Players.getLocal().getAnimation(), lIIlIIIII[30]) && aj.llllIIIIlII(NPCs.getNearest(nPC -> {
                                ...
                                if (aj.llllIIIlIII(nPC.getId(), lIIlIIIII[77]) && aj.llllIIIlIIl(nPC.getWorldLocation().distanceTo(me), lIIlIIIII[22])) {
                                    ...
                                    if ((0x72 ^ 0xE ^ (0x76 ^ 0xE)) <= 0) {
                                        return ((0xEA ^ 0xAE ^ (8 ^ 0x4A)) & (46 + 161 - 81 + 37 ^ 70 + 88 - 8 + 15 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    n2 = lIIlIIIII[0];
                                }
                                ...
                                NPCs.getNearest(nPC -> {
                                    ...
                                    if (aj.llllIIIlIII(nPC.getId(), lIIlIIIII[77]) && aj.llllIIIlIIl(nPC.getWorldLocation().distanceTo(me), lIIlIIIII[22])) {
                                        ...
                                        "".length();
                                        if (-" ".length() >= "  ".length()) {
                                            return ((83 + 99 - 51 + 61 ^ 5 + 112 - 48 + 91) & (177 + 73 - 234 + 215 ^ 63 + 125 - 113 + 60 ^ -" ".length())) != 0;
                                        }
                                    } else {
                                        n2 = lIIlIIIII[0];
                                    }
    ...
    public static boolean ei() {
        ...
        if (aj.llllIIIIIIl(Inventory.contains((String[])stringArray) ? 1 : 0) && (!aj.llllIIIIIll(Inventory.contains((int[])f.aO) ? 1 : 0) || aj.llllIIIIIIl(Equipment.contains((int[])f.aO) ? 1 : 0))) {
            ...
            "".length();
            if ("   ".length() == 0) {
                return ((172 + 235 - 211 + 43 ^ 172 + 28 - 178 + 162) & (90 + 30 - 106 + 226 ^ 1 + 145 - 118 + 139 ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIIlIIIII[0];
        }
                ...
                if (aj.llllIIIIIIl(Inventory.contains((String[])stringArray3) ? 1 : 0)) {
                    ...
                    if (aj.llllIIIIIIl(Inventory.contains((String[])stringArray4) ? 1 : 0)) {
                        ...
                        if (aj.llllIIIIIIl(Inventory.contains((String[])stringArray5) ? 1 : 0) && (!aj.llllIIIIIll(Inventory.contains((int[])f.aO) ? 1 : 0) || aj.llllIIIIIIl(Equipment.contains((int[])f.aO) ? 1 : 0))) {
                            ...
                            return ((0x28 ^ 7 ^ (0x4D ^ 0x74)) & (0xC5 ^ 0xB9 ^ (0xCF ^ 0xA5) ^ -" ".length())) != 0;
                        }
                    }
                }
            }
    ...
    private static void llllIIIIIII() {
        ...
        aj.lIIlIIIII[0] = (60 + 31 - -30 + 27 ^ 107 + 110 - 80 + 27) & (0x47 ^ 0x13 ^ (0xDC ^ 0xB8) ^ -" ".length());
        aj.lIIlIIIII[1] = " ".length();
        aj.lIIlIIIII[2] = "  ".length();
        aj.lIIlIIIII[3] = "   ".length();
