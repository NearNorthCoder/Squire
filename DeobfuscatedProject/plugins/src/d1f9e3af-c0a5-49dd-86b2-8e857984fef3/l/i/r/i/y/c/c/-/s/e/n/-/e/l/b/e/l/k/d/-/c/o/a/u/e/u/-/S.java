...
implements W {
    ...
    private static void lIIllllIlllI() {
        ...
        S.lIllllIlI[S.lIlllllII[0]] = S.lIIllllIlIlI("S/NEacwPhgBXJCVG2TqDWw==", "csQNM");
        S.lIllllIlI[S.lIlllllII[1]] = S.lIIllllIlIll("ByQ3GwMpKD1SEjQ0MBwXYSQtFx0yYXkBByg5OhoZLyp5EBEiJnkGH2E8LBcDNQ==", "AMYrp");
        S.lIllllIlI[S.lIlllllII[3]] = S.lIIllllIlIll("KD0fLT0=", "lOvCV");
        S.lIllllIlI[S.lIlllllII[6]] = S.lIIllllIlIll("OykaazwaaA4qJh4=", "uHlKH");
        S.lIllllIlI[S.lIlllllII[7]] = S.lIIllllIllII("OukHgUyLynbmWAu2OsvO2vOwzTnd6Ryw", "ucvFg");
        S.lIllllIlI[S.lIlllllII[10]] = S.lIIllllIllII("yqaUF5Uc7p4mqAbavbpSn+tS5MmKmpEokJykSs3bsU+bjZQh+2RWDdejUkiUO6IHWOfF2X0BzCs=", "ifEBq");
        S.lIllllIlI[S.lIlllllII[14]] = S.lIIllllIlIll("Gyk+Uh86aDodBjAn", "UHHrk");
        S.lIllllIlI[S.lIlllllII[15]] = S.lIIllllIlIll("GTEsIj4jKypwOz8gPiQ=", "JEMPJ");
        S.lIllllIlI[S.lIlllllII[13]] = S.lIIllllIlIlI("X0H7PEOcZiI=", "tTEHF");
        S.lIllllIlI[S.lIlllllII[16]] = S.lIIllllIllII("AOEFv3GG2z0=", "cRuzH");
        S.lIllllIlI[S.lIlllllII[12]] = S.lIIllllIllII("iJJqqIbr0+E0L6bt6BdX8Q==", "CPETR");
        S.lIllllIlI[S.lIlllllII[17]] = S.lIIllllIlIll("GSsGIHQ5JUohISEjDz8=", "MJjKT");
        S.lIllllIlI[S.lIlllllII[18]] = S.lIIllllIlIll("FiEEPQ==", "YQaSV");
        S.lIllllIlI[S.lIlllllII[19]] = S.lIIllllIllII("npzit2kuhYo=", "RKnEX");
        S.lIllllIlI[S.lIlllllII[21]] = S.lIIllllIllII("/zQZ/q2E7skH656aqituTA==", "WEatL");
        S.lIllllIlI[S.lIlllllII[22]] = S.lIIllllIlIlI("t1BCo2HT7xymEwMCLKPxig==", "Mqynu");
        S.lIllllIlI[S.lIlllllII[23]] = S.lIIllllIllII("wvQ53nhBJkc=", "XeDkY");
        S.lIllllIlI[S.lIlllllII[25]] = S.lIIllllIlIll("Cws0Tg4qSiQPDi0PMA==", "EjBnz");
        S.lIllllIlI[S.lIlllllII[26]] = S.lIIllllIlIll("FS04InUHLSAhMBM=", "aLTIU");
        S.lIllllIlI[S.lIlllllII[27]] = S.lIIllllIlIlI("OLNZGhnAc+/Hane60hMkcg==", "DcDXb");
        S.lIllllIlI[S.lIlllllII[20]] = S.lIIllllIlIlI("hMXs3RN7GQrv+LKDHmeJ4rInIA+pe+bZ", "ZSmqS");
        S.lIllllIlI[S.lIlllllII[29]] = S.lIIllllIlIll("GSomIlAdJD4gHwM4", "mKJIp");
        S.lIllllIlI[S.lIlllllII[30]] = S.lIIllllIlIll("KBk3PCYMCjk6Nw==", "iiXHN");
        S.lIllllIlI[S.lIlllllII[31]] = S.lIIllllIllII("ElG4eVweGZ46Lp89GB53hw==", "JqlPe");
        S.lIllllIlI[S.lIlllllII[32]] = S.lIIllllIlIlI("2TPJ7piUXJ3lZ728FNy7lWMfjI7D1hiB", "moExp");
        S.lIllllIlI[S.lIlllllII[33]] = S.lIIllllIllII("cb3PdDVJP2PFsczvOPkhoA==", "zPGiH");
        S.lIllllIlI[S.lIlllllII[34]] = S.lIIllllIlIll("AQUCLkcFCxosCBsX", "udnEg");
        S.lIllllIlI[S.lIlllllII[35]] = S.lIIllllIlIll("NzYmGiUTJSgcNA==", "vFInM");
        S.lIllllIlI[S.lIlllllII[36]] = S.lIIllllIllII("sAmpwAcxXgcMvPwyR4HyiQ==", "AhsRj");
        S.lIllllIlI[S.lIlllllII[37]] = S.lIIllllIllII("ZCoaPsGaQws=", "eAOfr");
        S.lIllllIlI[S.lIlllllII[24]] = S.lIIllllIllII("7UJyE+30TVxpyE4Nfskcqg==", "UvItT");
        S.lIllllIlI[S.lIlllllII[38]] = S.lIIllllIlIll("MDIhAnYQPG0DIwg6KB0=", "dSMiV");
        S.lIllllIlI[S.lIlllllII[39]] = S.lIIllllIlIlI("U8E8z+tK+Jo=", "VePEV");
        S.lIllllIlI[S.lIlllllII[40]] = S.lIIllllIlIll("HC02EQci", "VXZxb");
        S.lIllllIlI[S.lIlllllII[42]] = S.lIIllllIlIlI("GLGFvn41uSrJ5SeSn4niaQ==", "EbOQD");
        S.lIllllIlI[S.lIlllllII[43]] = S.lIIllllIllII("Bu4xzQGaoro6O286U+hXXw==", "wagyo");
        S.lIllllIlI[S.lIlllllII[44]] = S.lIIllllIllII("XIdXJixkBX0=", "YngVM");
        S.lIllllIlI[S.lIlllllII[45]] = S.lIIllllIllII("zXEIefV+/3kYi5bGbizP2w==", "yJPAT");
        S.lIllllIlI[S.lIlllllII[46]] = S.lIIllllIllII("VWhhAi8vX5lx3SPzAfuIbceRU9B9LyW+", "ZwjFC");
        S.lIllllIlI[S.lIlllllII[47]] = S.lIIllllIlIll("PzVYFSQNcBUdJRs5FhN2GSUdByJIIw0EJgQ5HQd6SCMPHSILOBEaMUgkF1QUPQkxOhE=", "hPxtV");
        S.lIllllIlI[S.lIlllllII[28]] = S.lIIllllIllII("dejn7K41V4Cr2jHg3qp7VMYGH9c5/31A", "alPgx");
        S.lIllllIlI[S.lIlllllII[54]] = S.lIIllllIlIll("IgUUNkw/ClomCTEADjlMeA==", "PlzQl");
        S.lIllllIlI[S.lIlllllII[55]] = S.lIIllllIlIlI("gfR6C91/d0A=", "WfTBx");
        S.lIllllIlI[S.lIlllllII[58]] = S.lIIllllIlIll("PgoSBg==", "qzwhX");
        S.lIllllIlI[S.lIlllllII[59]] = S.lIIllllIlIll("IRo8Ng==", "euSDD");
        S.lIllllIlI[S.lIlllllII[60]] = S.lIIllllIllII("QFvfpj5VQVk=", "JjGZl");
        S.lIllllIlI[S.lIlllllII[69]] = S.lIIllllIllII("oaAIFFwoMt2KhvtCwPIicnunVlNC3dNotFSxCs3ToLg=", "bZbMa");
        S.lIllllIlI[S.lIlllllII[70]] = S.lIIllllIlIll("FDICRm0iPF1KBGo7HUohKCNRAig/dxoEIjp5", "MWqjM");
        S.lIllllIlI[S.lIlllllII[71]] = S.lIIllllIlIlI("E1ib8S19yfoJK4uT+ND9aA==", "kBSeA");
        S.lIllllIlI[S.lIlllllII[72]] = S.lIIllllIlIlI("L/ag83nGTtDI5LgIE5kYp0Ynen7I8PAMGban0DWStz4=", "wjEQC");
        S.lIllllIlI[S.lIlllllII[2]] = S.lIIllllIlIlI("yWNpjzi/uZC4l63/fcW2YIA5Hm8ri980JcfH71nSXiA=", "MiGCK");
        S.lIllllIlI[S.lIlllllII[73]] = S.lIIllllIllII("XAiff9tbyFtQPOD4GRyw8g==", "jgCzy");
        S.lIllllIlI[S.lIlllllII[74]] = S.lIIllllIllII("nwPwXN7yjI0=", "ehYAR");
    }
    ...
    private static void lIIllllIllll() {
        ...
        S.lIlllllII[21] = " ".length() ^ (0x3E ^ 0x31);
    ...
    public int T() {
        ...
        if ("  ".length() >= "   ".length()) {
            return (0xC0 ^ 0xA2 ^ (0x78 ^ 0x23)) & (0x2C ^ 0x3E ^ (0x31 ^ 0x1A) ^ -" ".length());
        }
        return lIlllllII[53];
    }
                    ...
                    llIIIIlllIIlII = TileObjects.getNearest(tileObject -> {
                        ...
                        if (S.lIIlllllIIII(tileObject.getName().contains(lIllllIlI[lIlllllII[59]]) ? 1 : 0) && S.lIIlllllIllI(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIlllllII[56], lIlllllII[57], lIlllllII[1])), lIlllllII[3])) {
                            ...
                            if (S.lIIlllllIIII(tileObject.hasAction(stringArray) ? 1 : 0)) {
                                ...
                                return ((173 + 57 - 6 + 8 ^ 175 + 145 - 268 + 144) & (0x74 ^ 0x4B ^ (0x3D ^ 0x2E) ^ -" ".length())) != 0;
                            }
                        }
                        n2 = lIlllllII[0];
                        return n2 != 0;
                        ...
                        llIIIIlllIIlII = TileObjects.getNearest(tileObject -> {
                            ...
                            if (S.lIIlllllIIII(tileObject.getName().contains(lIllllIlI[lIlllllII[55]]) ? 1 : 0) && S.lIIlllllIllI(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIlllllII[56], lIlllllII[57], lIlllllII[1])), lIlllllII[3])) {
                                ...
                                if (S.lIIlllllIIII(tileObject.hasAction(stringArray) ? 1 : 0)) {
                                    n2 = lIlllllII[1];
                                    "".length();
                                    if ("  ".length() >= ((0x12 ^ 0x58) & ~(0x7E ^ 0x34))) return n2 != 0;
                                    return ((0x5D ^ 0x44) & ~(0x22 ^ 0x3B)) != 0;
                                }
                            }
                            n2 = lIlllllII[0];
                            return n2 != 0;
