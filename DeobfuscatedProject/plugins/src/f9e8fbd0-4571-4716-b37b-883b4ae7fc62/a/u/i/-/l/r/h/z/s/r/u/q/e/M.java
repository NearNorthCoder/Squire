...
extends P {
    ...
    public boolean ac() {
        ...
        BankLocation llllllllllllllIllIIIllIIllIlIlIl = BankLocation.getNearest();
        if (M.llIIlIIIIllIIII(llllllllllllllIllIIIllIIllIlIlIl)) {
            return lIllIlIlllIII[0];
        }
        WorldPoint llllllllllllllIllIIIllIIllIlIlII = Players.getLocal().getWorldLocation();
        if (M.llIIlIIIIlIllll(llllllllllllllIllIIIllIIllIlIlIl.getArea().contains2D(llllllllllllllIllIIIllIIllIlIlII) ? 1 : 0)) {
            return lIllIlIlllIII[0];
        }
        ...
        if (M.llIIlIIIIlIllll(Movement.shouldWalk() ? 1 : 0)) {
            Movement.walkTo((WorldArea)llllllllllllllIllIIIllIIllIlIlIl.getArea());
            "".length();
        }
        return lIllIlIlllIII[1];
    }
