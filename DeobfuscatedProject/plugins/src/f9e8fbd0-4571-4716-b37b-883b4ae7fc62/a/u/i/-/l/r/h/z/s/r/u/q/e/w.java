...
extends Overlay {
    ...
    public Dimension render(Graphics2D graphics2D) {
        ...
        Player llllllllllllllIllIIlIIIIlIlIllII = Players.getLocal();
        if (w.llIIIlllIIllIlI(llllllllllllllIllIIlIIIIlIlIllII)) {
            return null;
        }
    ...
    private static String llIIIlllIIlIlIl(String llllllllllllllIllIIlIIIIlIlIIIII, String llllllllllllllIllIIlIIIIlIlIIIIl) {
        try {
            SecretKeySpec llllllllllllllIllIIlIIIIlIlIIlIl = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllIllIIlIIIIlIlIIIIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllIllIIlIIIIlIlIIlII = Cipher.getInstance("Blowfish");
            llllllllllllllIllIIlIIIIlIlIIlII.init(lIllIlIIIIIII[3], llllllllllllllIllIIlIIIIlIlIIlIl);
            return new String(llllllllllllllIllIIlIIIIlIlIIlII.doFinal(Base64.getDecoder().decode(llllllllllllllIllIIlIIIIlIlIIIII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void llIIIlllIIllIIl() {
        ...
        w.lIllIlIIIIIII[0] = (9 + 131 - 69 + 111 ^ 145 + 129 - 108 + 6) & (103 + 87 - 94 + 68 ^ 75 + 39 - -3 + 73 ^ -" ".length());
        w.lIllIlIIIIIII[1] = "   ".length();
        w.lIllIlIIIIIII[2] = " ".length();
        w.lIllIlIIIIIII[3] = "  ".length();
    }
    ...
    private static void llIIIlllIIllIII() {
        ...
        w.lIllIIlllllll[w.lIllIlIIIIIII[0]] = w.llIIIlllIIlIlIl("OiHvlTYVfLiGoD6kD3xIvLR9L/0gY9BwjIqdeoS5TgFVFbndrjrWSw==", "kOiIC");
    }
}
