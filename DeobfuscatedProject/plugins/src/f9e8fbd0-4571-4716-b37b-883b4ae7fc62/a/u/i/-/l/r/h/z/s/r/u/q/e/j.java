...
extends Enum<j> {
    ...
    private static void llIIlIIIIIlIlll() {
        ...
        j.lIllIlIlIlllI[j.lIllIlIllIIII[0]] = j.llIIlIIIIIlIlIl("7ht95oQiEGL7/eQ4bmbS0A==", "DUgUZ");
        j.lIllIlIlIlllI[j.lIllIlIllIIII[1]] = j.llIIlIIIIIlIllI("NgowAR42", "dCwNK");
    }
    ...
    private static void llIIlIIIIIllIlI() {
        ...
        j.lIllIlIllIIII[1] = " ".length();
        j.lIllIlIllIIII[2] = "  ".length();
    }
