...
extends ad {
    ...
    private static void llIIIllllIIIIII() {
        ...
        ab.lIllIlIIIllIl[0] = (0x43 ^ 0x1E ^ (0x6D ^ 0xE)) & (0x80 ^ 0xAC ^ (0x15 ^ 7) ^ -" ".length());
        ab.lIllIlIIIllIl[1] = " ".length();
        ab.lIllIlIIIllIl[2] = -(0xFFFFFE6F & 0x6BFC) & (0xFFFFFF7F & 0x6EFF);
        ab.lIllIlIIIllIl[3] = 0xFFFFEFBF & 0x1456;
        ab.lIllIlIIIllIl[4] = "  ".length();
    ...
    private static void llIIIlllIllllll() {
        ...
        ab.lIllIlIIIllII[ab.lIllIlIIIllIl[0]] = ab.llIIIlllIlllllI("qDXn1ne/a8I=", "SRmvt");
        ab.lIllIlIIIllII[ab.lIllIlIIIllIl[1]] = ab.llIIIlllIlllllI("7P7NanoGWQOpVV/iGmxxyg==", "TYjgu");
    }
    ...
    private boolean a(List<Prayer> list, boolean bl) {
        ...
        while (ab.llIIIllllIIIlII(llllllllllllllIllIIIllllIllIIlII.hasNext() ? 1 : 0)) {
            ...
            if (ab.llIIIllllIIIllI(llllllllllllllIllIIIllllIllIIIll, Prayer.PROTECT_ITEM)) {
                ...
                return ((0x4E ^ 0x18 ^ (0x37 ^ 0x45)) & (44 + 73 - 107 + 133 ^ 8 + 60 - -3 + 100 ^ -" ".length())) != 0;
            }
            ...
            "".length();
            if (((0x1E ^ 0x69 ^ (0x3C ^ 0x70)) & ("  ".length() ^ (0x57 ^ 0x6E) ^ -" ".length())) == 0) continue;
            return ((0x27 ^ 0x2B ^ (0x9C ^ 0xB3)) & (110 + 7 - 114 + 139 ^ 119 + 102 - 122 + 74 ^ -" ".length())) != 0;
        }
        return bl2;
    }
    ...
    public boolean ac() {
        ...
        if (ab.llIIIllllIIIIIl(n2)) {
            ...
            "".length();
            if (((0x95 ^ 0xC7 ^ (0x4B ^ 0x2F)) & (0x6D ^ 0x3C ^ (0xF7 ^ 0x90) ^ -" ".length())) != 0) {
                return ((61 + 88 - 119 + 115 ^ 34 + 50 - -28 + 65) & (0x88 ^ 0x8D ^ (0xE6 ^ 0xC3) ^ -" ".length())) != 0;
            }
