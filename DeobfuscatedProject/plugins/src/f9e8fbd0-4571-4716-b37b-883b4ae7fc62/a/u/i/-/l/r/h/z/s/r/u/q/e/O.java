...
extends P {
    ...
    @Override
    public boolean ac() {
        O llllllllllllllIllIIIlIIIllIllIll;
        ...
        if (O.llIIlIIllIIllII(llllllllllllllIllIIIlIIIllIllIll.ah() ? 1 : 0)) {
            return lIllIlllIlIll[1];
        }
        if (O.llIIlIIllIIllII(Bank.isOpen() ? 1 : 0)) {
            return lIllIlllIlIll[1];
        }
        BankLocation llllllllllllllIllIIIlIIIllIllIIl = BankLocation.getNearest();
        if (O.llIIlIIllIIllIl(llllllllllllllIllIIIlIIIllIllIIl)) {
            return lIllIlllIlIll[1];
        }
        ...
        if (O.llIIlIIllIIllII(Movement.shouldWalk() ? 1 : 0)) {
            Movement.walkTo((WorldArea)llllllllllllllIllIIIlIIIllIllIIl.getArea());
            "".length();
        }
        return lIllIlllIlIll[0];
    }
