...
extends Enum<g> {
    ...
    private static void llIIIlllllIllll() {
        ...
        g.lIllIlIlIIIIl[1] = " ".length();
        g.lIllIlIlIIIIl[2] = "  ".length();
    }
    ...
    private static void llIIIlllllIlllI() {
        ...
        g.lIllIlIlIIIII[g.lIllIlIlIIIIl[0]] = g.llIIIlllllIllIl("AD43JhgOOCk7FgUz", "MgdrQ");
        g.lIllIlIlIIIII[g.lIllIlIlIIIIl[1]] = g.llIIIlllllIllIl("JRYdBDc9", "dCZQe");
    }
