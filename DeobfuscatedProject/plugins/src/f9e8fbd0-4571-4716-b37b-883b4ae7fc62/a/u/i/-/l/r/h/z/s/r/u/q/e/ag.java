...
extends Task {
    ...
    private static void llIIlIIlIIlIlII() {
        ...
        ag.lIllIllIlIllI[ag.lIllIllIllIII[0]] = ag.llIIlIIlIIlIIll("Py8NATIN", "eZasS");
    }

    private static void llIIlIIlIIllIll() {
        lIllIllIllIII = new int[4];
        ag.lIllIllIllIII[0] = (0x28 ^ 0x1C ^ (0x26 ^ 0x1C)) & (32 + 119 - 101 + 132 ^ 22 + 42 - 20 + 140 ^ -" ".length());
        ag.lIllIllIllIII[1] = " ".length();
