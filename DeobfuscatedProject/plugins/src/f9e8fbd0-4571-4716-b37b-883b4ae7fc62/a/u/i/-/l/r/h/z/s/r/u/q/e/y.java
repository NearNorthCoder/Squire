...
extends Task {
    ...
    private static String llIIlIIIlIIlIII(String llllllllllllllIllIIIllIIIIIIlIlI, String llllllllllllllIllIIIllIIIIIIlIIl) {
        ...
        while (y.llIIlIIIlIlIlll(llllllllllllllIllIIIllIIIIIIIIll, llllllllllllllIllIIIllIIIIIIIlII)) {
            ...
            "".length();
            if ((0xF9 ^ 0x93 ^ (0xCA ^ 0xA4)) > "   ".length()) continue;
            return null;
        }
    ...
    private boolean ab() {
        ...
        if (!y.llIIlIIIlIlIIII(Combat.isVenomed() ? 1 : 0) || y.llIIlIIIlIlIlIl(Combat.isPoisoned() ? 1 : 0)) {
            ...
            "".length();
            if (" ".length() >= "  ".length()) {
                return ((0x14 ^ 0x1B ^ (0x5D ^ 5) & ~(0x17 ^ 0x4F)) & (90 + 35 - 3 + 25 ^ 2 + 24 - -109 + 21 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIllIllIIIIlI[0];
        }
    ...
    private static void llIIlIIIlIIlIlI() {
        ...
        y.lIllIllIIIIII[y.lIllIllIIIIlI[0]] = y.llIIlIIIlIIlIII("EDo7LQY=", "THRCm");
        y.lIllIllIIIIII[y.lIllIllIIIIlI[1]] = y.llIIlIIIlIIlIII("CxgxFDE=", "OjXzZ");
        y.lIllIllIIIIII[y.lIllIllIIIIlI[2]] = y.llIIlIIIlIIlIII("NSg7Lwo=", "qZRAa");
        y.lIllIllIIIIII[y.lIllIllIIIIlI[4]] = y.llIIlIIIlIIlIII("NCszHjc6LDQYKQ==", "UEGwG");
        y.lIllIllIIIIII[y.lIllIllIIIIlI[5]] = y.llIIlIIIlIIlIIl("53rqonKVZ0C5KEf9dKImGQ==", "QQYwL");
        y.lIllIllIIIIII[y.lIllIllIIIIlI[6]] = y.llIIlIIIlIIlIII("LT0+A3QaNiQFNA==", "lSJjY");
    }

    private static void llIIlIIIlIIlllI() {
        lIllIllIIIIlI = new int[8];
        y.lIllIllIIIIlI[0] = (0x73 ^ 0x21) & ~(0x32 ^ 0x60);
        y.lIllIllIIIIlI[1] = " ".length();
        y.lIllIllIIIIlI[2] = "  ".length();
        y.lIllIllIIIIlI[3] = 5 ^ 0x60 ^ "   ".length();
        y.lIllIllIIIIlI[4] = "   ".length();
