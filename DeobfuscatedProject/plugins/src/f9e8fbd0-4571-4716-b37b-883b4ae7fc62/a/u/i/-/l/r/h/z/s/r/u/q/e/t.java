...
public class t {
    ...
    private static void llIIIlllIIlIlll() {
        ...
        a.u.i.-.l.r.h.z.s.r.u.q.e.t.lIllIIllllllI[a.u.i.-.l.r.h.z.s.r.u.q.e.t.lIllIlIIIIIIl[0]] = a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIlIIll("HTwCDQ==", "SSlhK");
        a.u.i.-.l.r.h.z.s.r.u.q.e.t.lIllIIllllllI[a.u.i.-.l.r.h.z.s.r.u.q.e.t.lIllIlIIIIIIl[2]] = a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIlIIll("FD0uOC8=", "CTKTK");
        a.u.i.-.l.r.h.z.s.r.u.q.e.t.lIllIIllllllI[a.u.i.-.l.r.h.z.s.r.u.q.e.t.lIllIlIIIIIIl[3]] = a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIlIlII("QOO9Lrd/A3o=", "oyBDN");
        a.u.i.-.l.r.h.z.s.r.u.q.e.t.lIllIIllllllI[a.u.i.-.l.r.h.z.s.r.u.q.e.t.lIllIlIIIIIIl[4]] = a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIlIllI("9aRZdsieqU8=", "nHbhf");
    }
    ...
    public List<Integer> f(int n2) {
        ...
        arrayList.add(n2);
        "".length();
        Iterator<List<Integer>> llllllllllllllIllIIlIIIIlIIIIlII = v.iterator();
        while (a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIlllIl(llllllllllllllIllIIlIIIIlIIIIlII.hasNext() ? 1 : 0)) {
            void llllllllllllllIllIIlIIIIlIIIIllI;
            List<Integer> llllllllllllllIllIIlIIIIlIIIIIll = llllllllllllllIllIIlIIIIlIIIIlII.next();
            if (a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIlllIl(llllllllllllllIllIIlIIIIlIIIIIll.contains((int)llllllllllllllIllIIlIIIIlIIIIllI) ? 1 : 0)) {
                void llllllllllllllIllIIlIIIIlIIIIlIl;
                llllllllllllllIllIIlIIIIlIIIIlIl.addAll(llllllllllllllIllIIlIIIIlIIIIIll);
                "".length();
            }
            "".length();
    ...
    private static String llIIIlllIIlIlII(String llllllllllllllIllIIlIIIIIlIlIlIl, String llllllllllllllIllIIlIIIIIlIlIllI) {
        try {
            ...
            return new String(llllllllllllllIllIIlIIIIIlIllIIl.doFinal(Base64.getDecoder().decode(llllllllllllllIllIIlIIIIIlIlIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String llIIIlllIIlIllI(String llllllllllllllIllIIlIIIIIlIIlIlI, String llllllllllllllIllIIlIIIIIlIIlIIl) {
        ...
        catch (Exception llllllllllllllIllIIlIIIIIlIIlIll) {
            llllllllllllllIllIIlIIIIIlIIlIll.printStackTrace();
            return null;
        }
    }
    ...
    public boolean a(int[] nArray) {
        void llllllllllllllIllIIlIIIIlIIlIIIl;
        void llllllllllllllIllIIlIIIIlIIIllll2;
        ArrayList arrayList = new ArrayList();
        int[] nArray2 = nArray;
        int n2 = nArray2.length;
        int llllllllllllllIllIIlIIIIlIIIlllI = lIllIlIIIIIIl[0];
        while (a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIlllII(llllllllllllllIllIIlIIIIlIIIlllI, (int)llllllllllllllIllIIlIIIIlIIIllll2)) {
            t llllllllllllllIllIIlIIIIlIIlIIll;
            void llllllllllllllIllIIlIIIIlIIlIIII;
            void llllllllllllllIllIIlIIIIlIIIllIl = llllllllllllllIllIIlIIIIlIIlIIII[llllllllllllllIllIIlIIIIlIIIlllI];
            llllllllllllllIllIIlIIIIlIIlIIIl.addAll(Inventory.getAll(arg_0 -> llllllllllllllIllIIlIIIIlIIlIIll.a((int)llllllllllllllIllIIlIIIIlIIIllIl, arg_0)));
            "".length();
            ++llllllllllllllIllIIlIIIIlIIIlllI;
            "".length();
            if ((0xA6 ^ 0xA2) > " ".length()) continue;
            return ((0xA ^ 0x68) & ~(0xA1 ^ 0xC3)) != 0;
        }
        if (a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIlllIl(llllllllllllllIllIIlIIIIlIIlIIIl.isEmpty() ? 1 : 0)) {
            return lIllIlIIIIIIl[0];
        }
        int llllllllllllllIllIIlIIIIlIIlIIII = lIllIlIIIIIIl[0];
        while (a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIlllII(llllllllllllllIllIIlIIIIlIIlIIII, Math.min(llllllllllllllIllIIlIIIIlIIlIIIl.size(), lIllIlIIIIIIl[1]))) {
            Item llllllllllllllIllIIlIIIIlIIIllll2 = (Item)llllllllllllllIllIIlIIIIlIIlIIIl.get(llllllllllllllIllIIlIIIIlIIlIIII);
            llllllllllllllIllIIlIIIIlIIIllll2.interact(string -> {
                ...
                if (a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIllllI(string) && (!a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIlllll(string.equals(lIllIIllllllI[lIllIlIIIIIIl[2]]) ? 1 : 0) || !a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIlllll(string.equals(lIllIIllllllI[lIllIlIIIIIIl[3]]) ? 1 : 0) || a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIlllIl(string.equals(lIllIIllllllI[lIllIlIIIIIIl[4]]) ? 1 : 0))) {
                    n2 = lIllIlIIIIIIl[2];
                    "".length();
                    if (((1 + 175 - 48 + 76 ^ 103 + 74 - 57 + 20) & (18 + 156 - 149 + 169 ^ 125 + 124 - 135 + 16 ^ -" ".length())) >= "   ".length()) {
                        return ((0x63 ^ 0x39 ^ (3 ^ 0x60)) & (0x9E ^ 0x93 ^ (0xA6 ^ 0x92) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIllIlIIIIIIl[0];
                }
            ...
            ++llllllllllllllIllIIlIIIIlIIlIIII;
            "".length();
            if ("  ".length() > ((0xF7 ^ 0xB2) & ~(0xD1 ^ 0x94))) continue;
            return ((3 ^ 0x1E) & ~(0x72 ^ 0x6F)) != 0;
        }
    ...
    private static void llIIIlllIIllIll() {
        ...
        a.u.i.-.l.r.h.z.s.r.u.q.e.t.lIllIlIIIIIIl[0] = (0x17 ^ 0x11 ^ (0x36 ^ 0x61)) & (81 + 94 - 106 + 123 ^ 22 + 39 - -15 + 69 ^ -" ".length());
        a.u.i.-.l.r.h.z.s.r.u.q.e.t.lIllIlIIIIIIl[1] = 0x43 ^ 0x44;
        a.u.i.-.l.r.h.z.s.r.u.q.e.t.lIllIlIIIIIIl[2] = " ".length();
        a.u.i.-.l.r.h.z.s.r.u.q.e.t.lIllIlIIIIIIl[3] = "  ".length();
        a.u.i.-.l.r.h.z.s.r.u.q.e.t.lIllIlIIIIIIl[4] = "   ".length();
    ...
    private static String llIIIlllIIlIIll(String llllllllllllllIllIIlIIIIIllIIlll, String llllllllllllllIllIIlIIIIIllIIllI) {
        llllllllllllllIllIIlIIIIIllIIlll = new String(Base64.getDecoder().decode(llllllllllllllIllIIlIIIIIllIIlll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllIllIIlIIIIIllIlIlI = new StringBuilder();
        char[] llllllllllllllIllIIlIIIIIllIlIIl = llllllllllllllIllIIlIIIIIllIIllI.toCharArray();
        int llllllllllllllIllIIlIIIIIllIlIII = lIllIlIIIIIIl[0];
        char[] llllllllllllllIllIIlIIIIIllIIIlI = llllllllllllllIllIIlIIIIIllIIlll.toCharArray();
        int llllllllllllllIllIIlIIIIIllIIIIl = llllllllllllllIllIIlIIIIIllIIIlI.length;
        int llllllllllllllIllIIlIIIIIllIIIII = lIllIlIIIIIIl[0];
        while (a.u.i.-.l.r.h.z.s.r.u.q.e.t.llIIIlllIIlllII(llllllllllllllIllIIlIIIIIllIIIII, llllllllllllllIllIIlIIIIIllIIIIl)) {
            char llllllllllllllIllIIlIIIIIllIllIl = llllllllllllllIllIIlIIIIIllIIIlI[llllllllllllllIllIIlIIIIIllIIIII];
            llllllllllllllIllIIlIIIIIllIlIlI.append((char)(llllllllllllllIllIIlIIIIIllIllIl ^ llllllllllllllIllIIlIIIIIllIlIIl[llllllllllllllIllIIlIIIIIllIlIII % llllllllllllllIllIIlIIIIIllIlIIl.length]));
            "".length();
            ++llllllllllllllIllIIlIIIIIllIlIII;
            ++llllllllllllllIllIIlIIIIIllIIIII;
            "".length();
