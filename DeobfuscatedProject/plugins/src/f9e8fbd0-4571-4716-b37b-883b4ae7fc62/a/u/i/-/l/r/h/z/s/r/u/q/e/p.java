...
extends Enum<p> {
    ...
    private static void llIIIllllIlIlIl() {
        ...
        p.lIllIlIIlIlIl[3] = " ".length();
        p.lIllIlIIlIlIl[4] = -(0x83 ^ 0x89);
        p.lIllIlIIlIlIl[5] = "  ".length();
        p.lIllIlIIlIlIl[6] = 57 + 83 - 83 + 112 ^ 72 + 100 - 128 + 130;
        p.lIllIlIIlIlIl[7] = "   ".length();
    ...
    private static void llIIIllllIlIlII() {
        ...
        p.lIllIlIIlIlII[p.lIllIlIIlIlIl[0]] = p.llIIIllllIlIIlI("gyMDKyptqZM=", "VbcYc");
        p.lIllIlIIlIlII[p.lIllIlIIlIlIl[3]] = p.llIIIllllIlIIlI("52m55v+GmQ0=", "EfUIf");
        p.lIllIlIIlIlII[p.lIllIlIIlIlIl[5]] = p.llIIIllllIlIIll("Lzw9NjE+", "lysbt");
        p.lIllIlIIlIlII[p.lIllIlIIlIlIl[7]] = p.llIIIllllIlIIll("BysvOz8=", "Tdzow");
    }
