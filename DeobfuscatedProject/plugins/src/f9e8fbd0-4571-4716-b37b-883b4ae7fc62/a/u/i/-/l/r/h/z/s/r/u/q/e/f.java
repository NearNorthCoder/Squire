...
extends Enum<f> {
    ...
    private static void llIIIlllIlllIII() {
        ...
        f.lIllIlIIIIlll[f.lIllIlIIIlIll[0]] = f.llIIIlllIllIIIl("n8tZOn8jSZfyVoKQI9sO5w==", "epbGQ");
        f.lIllIlIIIIlll[f.lIllIlIIIlIll[2]] = f.llIIIlllIllIIlI("jYOclkcNQvc=", "GtOqn");
        f.lIllIlIIIIlll[f.lIllIlIIIlIll[4]] = f.llIIIlllIllIIIl("KlG5Tb8ztumwR1QWvY6R/g==", "oyVCN");
        f.lIllIlIIIIlll[f.lIllIlIIIlIll[6]] = f.llIIIlllIllIIlI("73TDkdpMVA0E5khCLuSYzQ==", "ArQem");
        f.lIllIlIIIIlll[f.lIllIlIIIlIll[8]] = f.llIIIlllIllIlll("LzsqMxwrJyw=", "btdxZ");
    }
