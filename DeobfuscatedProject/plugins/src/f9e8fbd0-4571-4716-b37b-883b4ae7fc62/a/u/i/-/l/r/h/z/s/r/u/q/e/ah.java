...
extends ag {
    ...
    private static void llIIlIIIIllIlIl() {
        ...
        ah.lIllIlIlllIll[0] = (0xBF ^ 0xAD ^ (0x2B ^ 0x6E)) & (62 + 42 - -62 + 68 ^ 172 + 127 - 154 + 44 ^ -" ".length());
        ah.lIllIlIlllIll[1] = " ".length();
        ah.lIllIlIlllIll[2] = -(0xFFFFF3E1 & 0x4E5F) & (0xFFFFFFF5 & 0x6FFF);
        ah.lIllIlIlllIll[3] = "  ".length();
        ah.lIllIlIlllIll[4] = "   ".length();
    }
    ...
    private static String llIIlIIIIllIIll(String llllllllllllllIllIIIllIIlIllllIl, String llllllllllllllIllIIIllIIlIllllII) {
        ...
        while (ah.llIIlIIIIllllII(llllllllllllllIllIIIllIIlIllIIIl, llllllllllllllIllIIIllIIlIllIIlI)) {
            ...
            "".length();
            if (((0x60 ^ 0x69 ^ (0xC4 ^ 0x91)) & (0x72 ^ 0x5D ^ (0x6D ^ 0x1E) ^ -" ".length())) == ((0xC ^ 0x15 ^ (0xC0 ^ 0x9D)) & (0x5B ^ 0x4F ^ (0x37 ^ 0x67) ^ -" ".length()))) continue;
            return null;
        }
    ...
    private static void llIIlIIIIllIlII() {
        ...
        ah.lIllIlIlllIlI[ah.lIllIlIlllIll[0]] = ah.llIIlIIIIllIIll("ICAH", "yEtdE");
        ah.lIllIlIlllIlI[ah.lIllIlIlllIll[1]] = ah.llIIlIIIIllIIll("JTcILQ==", "wRiIX");
        ah.lIllIlIlllIlI[ah.lIllIlIlllIll[3]] = ah.llIIlIIIIllIIll("KgwE", "ompDL");
    }
