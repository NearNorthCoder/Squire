...
extends Task {
    ...
    private static String llIlllIIlIIIlI(String lllllllllllllllIllIlIIllIlIllllI, String lllllllllllllllIllIlIIllIlIlllIl) {
        lllllllllllllllIllIlIIllIlIllllI = new String(Base64.getDecoder().decode(lllllllllllllllIllIlIIllIlIllllI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIllIlIIllIlIlllII = new StringBuilder();
        ...
        char[] lllllllllllllllIllIlIIllIlIlIlII = lllllllllllllllIllIlIIllIlIllllI.toCharArray();
        int lllllllllllllllIllIlIIllIlIlIIll = lllllllllllllllIllIlIIllIlIlIlII.length;
        int lllllllllllllllIllIlIIllIlIlIIlI = lIlIlIIlIIII[0];
        while (ad.llIlllIIlIllIl(lllllllllllllllIllIlIIllIlIlIIlI, lllllllllllllllIllIlIIllIlIlIIll)) {
            char lllllllllllllllIllIlIIllIlIlllll = lllllllllllllllIllIlIIllIlIlIlII[lllllllllllllllIllIlIIllIlIlIIlI];
            lllllllllllllllIllIlIIllIlIlllII.append((char)(lllllllllllllllIllIlIIllIlIlllll ^ lllllllllllllllIllIlIIllIlIllIll[lllllllllllllllIllIlIIllIlIllIlI % lllllllllllllllIllIlIIllIlIllIll.length]));
            "".length();
            ++lllllllllllllllIllIlIIllIlIllIlI;
            ++lllllllllllllllIllIlIIllIlIlIIlI;
            "".length();
            if ((0x72 ^ 0x76) >= 0) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllIllIlIIllIlIlllII);
    }
        ...
        Item item2 = Inventory.getFirst(item -> {
            ...
            if (ad.llIlllIIlIIllI(item.getName().startsWith(lIlIlIIIllll[lIlIlIIlIIII[1]]) ? 1 : 0)) {
                ...
                if (ad.llIlllIIlIIllI(item.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((15 + 18 - -53 + 50 ^ 29 + 122 - 3 + 29) & (84 + 9 - 80 + 175 ^ 108 + 1 - 95 + 119 ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIlIIlIIII[0];
            return n2 != 0;
    ...
    private static void llIlllIIlIIlII() {
        ...
        ad.lIlIlIIIllll[ad.lIlIlIIlIIII[0]] = ad.llIlllIIlIIIlI("EjoDKSM=", "VHjGH");
        ad.lIlIlIIIllll[ad.lIlIlIIlIIII[1]] = ad.llIlllIIlIIIlI("KjszDiQXLnITIg0mPQ0=", "yORcM");
        ad.lIlIlIIIllll[ad.lIlIlIIlIIII[13]] = ad.llIlllIIlIIIll("G//CQFgnma8=", "EXyCS");
    }
    ...
    private static String llIlllIIlIIIll(String lllllllllllllllIllIlIIllIlIIlIIl, String lllllllllllllllIllIlIIllIlIIlIII) {
        try {
            ...
            Cipher lllllllllllllllIllIlIIllIlIIlIll = Cipher.getInstance("Blowfish");
            lllllllllllllllIllIlIIllIlIIlIll.init(lIlIlIIlIIII[13], lllllllllllllllIllIlIIllIlIIllII);
            return new String(lllllllllllllllIllIlIIllIlIIlIll.doFinal(Base64.getDecoder().decode(lllllllllllllllIllIlIIllIlIIlIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public boolean run() {
        int lllllllllllllllIllIlIIllIllIllll;
        ad lllllllllllllllIllIlIIllIlllIIlI;
        if (!ad.llIlllIIlIIllI(u.be() ? 1 : 0) || ad.llIlllIIlIIlll(u.bf() ? 1 : 0)) {
            return lIlIlIIlIIII[0];
        }
        Player lllllllllllllllIllIlIIllIlllIIIl = Players.getLocal();
        if (ad.llIlllIIlIlIII(lllllllllllllllIllIlIIllIlllIIIl)) {
            return lIlIlIIlIIII[0];
        }
        n lllllllllllllllIllIlIIllIlllIIII = lllllllllllllllIllIlIIllIlllIIlI.cF.L();
        if (!ad.llIlllIIlIlIIl(lllllllllllllllIllIlIIllIlllIIlI.cF.L()) || ad.llIlllIIlIIlll(lllllllllllllllIllIlIIllIlllIIlI.cF.L().a((Locatable)lllllllllllllllIllIlIIllIlllIIIl) ? 1 : 0)) {
            return lIlIlIIlIIII[0];
        }
        ...
        if (ad.llIlllIIlIIllI(Inventory.contains((int[])nArray3) ? 1 : 0)) {
            if (ad.llIlllIIlIlIlI((Object)lllllllllllllllIllIlIIllIlllIIII.aM(), (Object)N.ICE_DEMON)) {
            ...
            lllllllllllllllIllIlIIllIllIllll = lIlIlIIlIIII[4] - lllllllllllllllIllIlIIllIlllIIlI.cF.K() + (lIlIlIIlIIII[5] - Skills.getLevel((Skill)Skill.WOODCUTTING)) / lIlIlIIlIIII[6];
            if (ad.llIlllIIlIlIll(lllllllllllllllIllIlIIllIllIllll)) {
        ...
        if (ad.llIlllIIlIIllI(Inventory.contains((int[])nArray6) ? 1 : 0) && ad.llIlllIIlIlIlI((Object)lllllllllllllllIllIlIIllIlllIIII.aM(), (Object)N.ICE_DEMON)) {
        ...
        if (ad.llIlllIIlIIllI(Inventory.contains((int[])nArray8) ? 1 : 0)) {
            if (ad.llIlllIIlIlIlI((Object)lllllllllllllllIllIlIIllIlllIIII.aM(), (Object)N.ICE_DEMON) && ad.llIlllIIlIlIlI((Object)lllllllllllllllIllIlIIllIlllIIII.aM(), (Object)N.MUTTADILES)) {
            ...
            if (ad.llIlllIIlIllII((Object)lllllllllllllllIllIlIIllIlllIIII.aM(), (Object)N.ICE_DEMON) && ad.llIlllIIlIlIll(lllllllllllllllIllIlIIllIllIllll = lIlIlIIlIIII[4] - lllllllllllllllIllIlIIllIlllIIlI.cF.K() + (lIlIlIIlIIII[5] - Skills.getLevel((Skill)Skill.WOODCUTTING)) / lIlIlIIlIIII[6])) {
        ...
        if (ad.llIlllIIlIIllI(Inventory.contains((int[])nArray11) ? 1 : 0) && ad.llIlllIIlIlIlI((Object)lllllllllllllllIllIlIIllIlllIIII.aM(), (Object)N.THIEVING)) {
        ...
        if (ad.llIlllIIlIIllI(Inventory.contains((int[])nArray15) ? 1 : 0) && ad.llIlllIIlIlIlI((Object)lllllllllllllllIllIlIIllIlllIIII.aM(), (Object)N.END)) {
        ...
        if (ad.llIlllIIlIIllI(Inventory.contains((int[])nArray17) ? 1 : 0) && ad.llIlllIIlIlIlI((Object)lllllllllllllllIllIlIIllIlllIIII.aM(), (Object)N.CRABS)) {
