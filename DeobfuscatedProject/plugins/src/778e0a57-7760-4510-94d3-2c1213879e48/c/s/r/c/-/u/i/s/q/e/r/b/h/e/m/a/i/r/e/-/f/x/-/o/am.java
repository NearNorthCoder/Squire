...
public class am {
    ...
    private static void llIllllIIIllIl() {
        ...
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[0]] = am.llIllllIIIlIlI("OC4yTScEJTIIKh9rKR9kCi8iTSUfayoIJRg/ZgIqDmsDACYOLwkPLg4oMg==", "kKFmD");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[1]] = am.llIllllIIIlIlI("MB0iFSE9Bg==", "SrLaD");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[2]] = am.llIllllIIIlIlI("NzwiNSEjIiI=", "BOGGO");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[3]] = am.llIllllIIIlIll("naSEU4bq2dIWGcRLuDeeGg==", "YmVqH");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[4]] = am.llIllllIIIlIlI("BRk+", "qmMEw");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[5]] = am.llIllllIIIlIlI("JSc/FAQ=", "QNKxa");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[6]] = am.llIllllIIIllII("PV9wOLh9CKo0rdZ7oXuVAw==", "yjtDC");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[7]] = am.llIllllIIIlIlI("MQso", "DyDse");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[8]] = am.llIllllIIIlIlI("ATY8ICU=", "bYPOW");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[9]] = am.llIllllIIIllII("LQKQyr8TZjs=", "lfnGk");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[10]] = am.llIllllIIIlIlI("IBQ/PjU8BTw=", "IwPPj");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[11]] = am.llIllllIIIlIlI("LwwWGQE7", "Icymd");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[12]] = am.llIllllIIIlIll("f84LuJ/puR0=", "TfdUx");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[13]] = am.llIllllIIIlIlI("BBc3BiA=", "mzVaE");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[14]] = am.llIllllIIIlIll("UPIJu/u0a68=", "CiPMi");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[15]] = am.llIllllIIIlIll("miUwYO1BHnWe5ynrVg/zXQ==", "FrFtv");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[16]] = am.llIllllIIIlIll("+eATeKp+Tyk=", "DvNpC");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[17]] = am.llIllllIIIlIll("qy9Cbdrz+SE=", "xNVaw");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[18]] = am.llIllllIIIlIlI("ATEiPgYdICE=", "hRMPY");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[19]] = am.llIllllIIIlIll("Ixbp9PTftMs=", "sBnwC");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[20]] = am.llIllllIIIllII("LUzEwmm+wnE=", "dJNfQ");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[21]] = am.llIllllIIIlIll("OAt/F6dKJ1E=", "KXfcq");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[22]] = am.llIllllIIIlIll("WcJ5h5ImvMc=", "Wluuc");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[23]] = am.llIllllIIIlIlI("MRwVIwEk", "WupOe");
        am.lIlIlIlIlIlI[am.lIlIlIlIlIll[24]] = am.llIllllIIIlIll("uT1CWl7ne1Q=", "CfFqw");
    }
    ...
    private static void llIllllIIIlllI() {
        ...
        am.lIlIlIlIlIll[1] = " ".length();
        am.lIlIlIlIlIll[2] = "  ".length();
        am.lIlIlIlIlIll[3] = "   ".length();
        ...
        am.lIlIlIlIlIll[19] = 0x9B ^ 0x8B ^ "   ".length();
    ...
    private static String llIllllIIIlIlI(String lllllllllllllllIllIIllllIlllIlll, String lllllllllllllllIllIIllllIllllIll) {
        ...
        while (am.llIllllIIlIIll(lllllllllllllllIllIIllllIlllIIII, lllllllllllllllIllIIllllIlllIIIl)) {
            ...
            "".length();
            if (((65 + 6 - 4 + 92 ^ 115 + 31 - 46 + 47) & (0xC9 ^ 0xC2 ^ (0x4E ^ 0x49) ^ -" ".length())) != (0xFD ^ 0xA1 ^ (0x3D ^ 0x65))) continue;
            return null;
        }
