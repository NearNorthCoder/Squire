...
extends Task {
    ...
    private static void llIlIllIlIlllI() {
        ...
        aj.lIlIIIllIlII[aj.lIlIIIllIlIl[1]] = aj.llIlIllIlIlIll("JEdTIiePP5M=", "yTGLo");
        aj.lIlIIIllIlII[aj.lIlIIIllIlIl[0]] = aj.llIlIllIlIllII("HKESJu97otg63FnSyNuiNw==", "GAKTF");
        aj.lIlIIIllIlII[aj.lIlIIIllIlIl[5]] = aj.llIlIllIlIllIl("OhYzEQZFAGEZDAY=", "bsAxe");
        aj.lIlIIIllIlII[aj.lIlIIIllIlIl[4]] = aj.llIlIllIlIllII("ssg+WXUQ+wQ=", "ipLTC");
    }
    ...
    public boolean run() {
        ...
        NPC lllllllllllllllIllIllllllIlIlllI = NPCs.getNearest(nPC -> {
            ...
            if (aj.llIlIllIllIllI(nPC.hasAction(stringArray) ? 1 : 0) && aj.llIlIllIllIllI(this.cP.L().a((Locatable)nPC) ? 1 : 0)) {
                ...
                "".length();
                if (" ".length() < 0) {
                    return ((0xED ^ 0x8B ^ (0x73 ^ 7)) & (33 + 28 - -82 + 4 ^ 97 + 66 - 129 + 95 ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIlIIIllIlIl[1];
            }
