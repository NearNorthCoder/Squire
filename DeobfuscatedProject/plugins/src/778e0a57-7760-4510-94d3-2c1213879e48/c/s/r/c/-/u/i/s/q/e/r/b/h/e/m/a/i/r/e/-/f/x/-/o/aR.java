...
extends Task {
        ...
        NPC nPC2 = NPCs.getNearest(nPC -> {
            ...
            if (aR.llIllllIlIllll(nPC.getName().contains(lIlIlIlIllII[lIlIlIllIlIl[27]]) ? 1 : 0)) {
                ...
                if (aR.llIllllIlIllll(nPC.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((148 + 146 - 201 + 105 ^ 83 + 85 - 40 + 1) & (0x30 ^ 0x3B ^ (0xB ^ 0x47) ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIlIllIlIl[0];
            return n2 != 0;
    ...
    protected boolean dv() {
        ...
        if ((!aR.llIllllIllIIII(this.ed.at() ? 1 : 0) || aR.llIllllIlIllll(this.ea.z().aL() ? 1 : 0)) && aR.llIllllIllIIlI(Combat.getSpecEnergy(), lIlIlIllIlIl[6])) {
            ...
            "".length();
            if ("   ".length() <= " ".length()) {
                return ((25 + 125 - 75 + 69 ^ 4 + 41 - -131 + 18) & (218 + 183 - 225 + 44 ^ 86 + 95 - 66 + 27 ^ -" ".length())) != 0;
            }
        } else {
            bl2 = lIlIlIllIlIl[0];
        }
    ...
    protected WorldPoint dK() {
        ...
        if (aR.llIllllIlIllll(this.dG() ? 1 : 0)) {
            n2 = lIlIlIllIlIl[2];
            "".length();
            if (((0x43 ^ 0x52 ^ (0x88 ^ 0xA6)) & (0 ^ 0x2D ^ (0xB4 ^ 0xA6) ^ -" ".length())) != 0) {
                return null;
            }
        } else {
    ...
    protected boolean ct() {
        ...
        if (aR.llIllllIllIlII(lllllllllllllllIllIIlllIllIllIII.getWorldY(), lllllllllllllllIllIIlllIllIllIIl.getWorldY())) {
            ...
            "".length();
            if (null != null) {
                return ((0xF6 ^ 0xBC ^ (0xAC ^ 0xB0)) & (0x20 ^ 0x1F ^ (0xD9 ^ 0xB0) ^ -" ".length())) != 0;
            }
        } else {
            bl2 = lIlIlIllIlIl[0];
        }
        ...
        NPC nPC2 = NPCs.getNearest(nPC -> {
            ...
            if (aR.llIllllIlIllll(nPC.getName().contains(lIlIlIlIllII[lIlIlIllIlIl[25]]) ? 1 : 0)) {
                ...
                if (aR.llIllllIlIllll(nPC.hasAction(stringArray) ? 1 : 0) && aR.llIllllIllIIII(nPC.isDead() ? 1 : 0)) {
                    ...
                    "".length();
                    if (" ".length() <= "  ".length()) return n2 != 0;
                    return ((100 + 59 - 123 + 163 ^ 40 + 156 - 22 + 18) & (0xF4 ^ 0xAF ^ (0x19 ^ 0x45) ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIlIllIlIl[0];
            return n2 != 0;
        ...
        if (aR.llIllllIlIllll(lllllllllllllllIllIIlllIllIIllIl.ed.at() ? 1 : 0)) {
            ...
            if (aR.llIllllIllIlll(lllllllllllllllIllIIlllIllIIllIl.ed.aH(), lllllllllllllllIllIIlllIllIIllIl.dU()) && aR.llIllllIllIllI(lllllllllllllllIllIIlllIllIIllIl.ed.aH(), lIlIlIllIlIl[3])) {
                ...
                if (aR.llIllllIllIIII(lllllllllllllllIllIIlllIllIIllIl.ed.aG())) {
                    bl2 = lIlIlIllIlIl[2];
                    "".length();
                    if ((0x82 ^ 0xBE ^ (0xB6 ^ 0x8E)) < ((149 + 4 - 68 + 163 ^ 80 + 21 - 41 + 121) & (0x55 ^ 0x1B ^ "   ".length() ^ -" ".length()))) {
                        return ((0x48 ^ 0x3C ^ (7 ^ 0x6E)) & (18 + 113 - 13 + 48 ^ 63 + 5 - 56 + 175 ^ -" ".length())) != 0;
                    }
                } else {
                    bl2 = lIlIlIllIlIl[0];
                }
            ...
            if (aR.llIllllIllIllI(lllllllllllllllIllIIlllIllIIllIl.ed.aG(), lIlIlIllIlIl[3]) && aR.llIllllIllIlIl(lllllllllllllllIllIIlllIllIIllIl.ed.aG(), lllllllllllllllIllIIlllIllIIllIl.dV())) {
                ...
                "".length();
                if (-" ".length() == " ".length()) {
                    return ((0x1E ^ 0x24 ^ (0x47 ^ 0x66)) & (0x3E ^ 1 ^ (0xA8 ^ 0x8C) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIlIlIllIlIl[0];
            }
    ...
    private static void llIllllIlIllIl() {
        ...
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[0]] = aR.llIllllIIlIlII("KseFWQfFxdcRvUsiCmZveskSHepZ7L8d", "OMIjV");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[2]] = aR.llIllllIIlIlIl("FjEGEAc8", "WErqd");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[4]] = aR.llIllllIIlIlII("4OhU16vaFuWzdQsuK/x2QlcBrK2n2uPN", "IpDiY");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[5]] = aR.llIllllIIlIlII("8aKe5fSySX4=", "HcdkK");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[1]] = aR.llIllllIIlIlIl("Gww2OmUeBDYqZRwIKyc3HQl4IDUb", "xmXNE");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[7]] = aR.llIllllIIlIllI("TptkLcoabHnsepf3T543fIoFI42UdSlZ", "qsRrw");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[8]] = aR.llIllllIIlIlII("zU22SYWWab8=", "kecnc");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[13]] = aR.llIllllIIlIlII("eQKUYv4zDzk=", "msYsj");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[14]] = aR.llIllllIIlIllI("CY1E4i6jWgw=", "MAgWi");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[15]] = aR.llIllllIIlIllI("OZkOph/qXjUhkb8X3ifjUQ==", "UxjtN");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[10]] = aR.llIllllIIlIlII("RCOADR2xjbo=", "hEqUH");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[16]] = aR.llIllllIIlIlIl("Ox06JgcgGzkkcz8XOTdzPwA4LRRJc1Y=", "hRwcS");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[12]] = aR.llIllllIIlIlII("rg39WCGAzJc=", "LqGAT");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[17]] = aR.llIllllIIlIlII("5DwNefVk81M=", "uLyzm");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[18]] = aR.llIllllIIlIlIl("Hi0EGjY=", "LdCRb");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[19]] = aR.llIllllIIlIlIl("BSc/JQ==", "IbyqO");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[20]] = aR.llIllllIIlIlII("+pn7p0X/hr4=", "ZPuIO");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[11]] = aR.llIllllIIlIlII("2kT+NIwd3x8=", "FEKLB");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[21]] = aR.llIllllIIlIlIl("KBoTCy0g", "eSWOa");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[23]] = aR.llIllllIIlIlII("Enbm3NJMKFSLMRdwQKYO5Q==", "KDSng");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[24]] = aR.llIllllIIlIllI("1tierGS2NNg=", "JAbvM");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[25]] = aR.llIllllIIlIllI("ZG0dJLDJ4ZfX76s66cXr7A==", "MUckR");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[26]] = aR.llIllllIIlIlIl("BwYBEhIt", "Frusq");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[27]] = aR.llIllllIIlIlII("UGRScIwXgWeY6LeZ28xzXQ==", "ETYAf");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[28]] = aR.llIllllIIlIlII("+KEVoRJA7+A=", "vUPMH");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[29]] = aR.llIllllIIlIlIl("CgEQGWIlCBca", "FdvmB");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[30]] = aR.llIllllIIlIllI("biR3ME3+98s=", "LgOOY");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[31]] = aR.llIllllIIlIlIl("FDoyNj1zBzs6", "SHWWI");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[32]] = aR.llIllllIIlIlII("q8bNrkQWFJU=", "qlCJs");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[33]] = aR.llIllllIIlIllI("WfmBBHSHPwEBeY8NzW8YenKbr25wkHeA", "lERGm");
        aR.lIlIlIlIllII[aR.lIlIlIllIlIl[34]] = aR.llIllllIIlIlII("eqoVtdS7q7DLLtacnxWvyw==", "cJpLT");
    }
        ...
        NPC nPC2 = NPCs.getNearest(nPC -> {
            ...
            if (aR.llIllllIlIllll(nPC.getName().contains(lIlIlIlIllII[lIlIlIllIlIl[23]]) ? 1 : 0)) {
                ...
                if (aR.llIllllIlIllll(nPC.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x36 ^ 0x25 ^ (0x6E ^ 0x61)) & (88 + 71 - 34 + 9 ^ 108 + 136 - 194 + 104 ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIlIllIlIl[0];
            return n2 != 0;
    ...
    private static void llIllllIlIlllI() {
        ...
        aR.lIlIlIllIlIl[0] = (0x71 ^ 0x64 ^ (0xB2 ^ 0xBC)) & (197 + 170 - 152 + 7 ^ 39 + 19 - 2 + 141 ^ -" ".length());
        aR.lIlIlIllIlIl[1] = 51 + 53 - 4 + 30 ^ 29 + 66 - -14 + 25;
        aR.lIlIlIllIlIl[2] = " ".length();
        aR.lIlIlIllIlIl[3] = -" ".length();
        aR.lIlIlIllIlIl[4] = "  ".length();
        aR.lIlIlIllIlIl[5] = "   ".length();
    ...
    private static String llIllllIIlIlIl(String lllllllllllllllIllIIlllIIllllllI, String lllllllllllllllIllIIlllIlIIIIIlI) {
        ...
        while (aR.llIllllIllIlll(lllllllllllllllIllIIlllIIlllIlll, lllllllllllllllIllIIlllIIllllIII)) {
            ...
            "".length();
            if ("   ".length() != ((0x1C ^ 0x4A ^ (0xF7 ^ 0xC0)) & (107 + 118 - 152 + 164 ^ 126 + 125 - 206 + 95 ^ -" ".length()))) continue;
            return null;
        }
        ...
        return TileObjects.getNearest(tileObject -> {
            ...
            if (aR.llIllllIlIllll(tileObject.getName().contains(lIlIlIlIllII[lIlIlIllIlIl[33]]) ? 1 : 0)) {
                ...
                if (aR.llIllllIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    "".length();
                    if (-" ".length() >= -" ".length()) return n2 != 0;
                    return ((156 + 2 - -36 + 55 ^ 123 + 33 - 39 + 64) & (0x19 ^ 0x5F ^ (0xAD ^ 0xA7) ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIlIllIlIl[0];
            return n2 != 0;
        ...
        NPC nPC2 = NPCs.getNearest(nPC -> {
            ...
            if (aR.llIllllIlIllll(nPC.getName().equals(lIlIlIlIllII[lIlIlIllIlIl[31]]) ? 1 : 0)) {
                ...
                if (aR.llIllllIlIllll(nPC.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    "".length();
                    if (-"  ".length() <= 0) return n2 != 0;
                    return ((0xE1 ^ 0xAB ^ (1 ^ 0x18)) & (0x6B ^ 0x29 ^ (0x63 ^ 0x72) ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIlIllIlIl[0];
            return n2 != 0;
    ...
    protected boolean dG() {
        ...
        if (aR.llIllllIllIlll(this.ed.ax().getWorldX(), this.bS.getWorldX())) {
            ...
            if ((0x17 ^ 0xC ^ (0x94 ^ 0x8B)) < (0xDF ^ 0xB5 ^ (0x38 ^ 0x56))) {
                return ((0x8C ^ 0x9E ^ (0x89 ^ 0xA9)) & (118 + 68 - 56 + 60 ^ 124 + 121 - 162 + 57 ^ -" ".length())) != 0;
            }
        } else {
            bl2 = lIlIlIllIlIl[0];
        }
