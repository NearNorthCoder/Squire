...
extends Enum<o> {
    ...
    private static String llIlIlIIllIIll(String lllllllllllllllIlllIIIlIlllllIll, String lllllllllllllllIlllIIIlIlllllIlI) {
        lllllllllllllllIlllIIIlIlllllIll = new String(Base64.getDecoder().decode(lllllllllllllllIlllIIIlIlllllIll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIlllIIIlIlllllllI = new StringBuilder();
        char[] lllllllllllllllIlllIIIlIllllllIl = lllllllllllllllIlllIIIlIlllllIlI.toCharArray();
        int lllllllllllllllIlllIIIlIllllllII = lIlIIIIlIIlI[0];
        char[] lllllllllllllllIlllIIIlIllllIllI = lllllllllllllllIlllIIIlIlllllIll.toCharArray();
        int lllllllllllllllIlllIIIlIllllIlIl = lllllllllllllllIlllIIIlIllllIllI.length;
        int lllllllllllllllIlllIIIlIllllIlII = lIlIIIIlIIlI[0];
        while (o.llIlIlIIlllIII(lllllllllllllllIlllIIIlIllllIlII, lllllllllllllllIlllIIIlIllllIlIl)) {
            char lllllllllllllllIlllIIIllIIIIIIIl = lllllllllllllllIlllIIIlIllllIllI[lllllllllllllllIlllIIIlIllllIlII];
            lllllllllllllllIlllIIIlIlllllllI.append((char)(lllllllllllllllIlllIIIllIIIIIIIl ^ lllllllllllllllIlllIIIlIllllllIl[lllllllllllllllIlllIIIlIllllllII % lllllllllllllllIlllIIIlIllllllIl.length]));
            "".length();
            ++lllllllllllllllIlllIIIlIllllllII;
            ++lllllllllllllllIlllIIIlIllllIlII;
            "".length();
    ...
    private static void llIlIlIIllIlll() {
        ...
        o.lIlIIIIlIIlI[0] = (0x3A ^ 0x55 ^ (0x10 ^ 0x32)) & (0x29 ^ 0x55 ^ (0x8A ^ 0xBB) ^ -" ".length());
        o.lIlIIIIlIIlI[1] = -(0xFFFFEEDF & 0x7FF3) & (0xFFFFFFFF & 0x6FFE);
        o.lIlIIIIlIIlI[2] = " ".length();
        ...
        o.lIlIIIIlIIlI[23] = 0x4D ^ 0x73 ^ "  ".length();
    ...
    private static void llIlIlIIllIllI() {
        ...
        o.lIlIIIIlIIIl[o.lIlIIIIlIIlI[0]] = o.llIlIlIIllIIll("OiQjGA==", "lepYM");
        o.lIlIIIIlIIIl[o.lIlIIIIlIIlI[2]] = o.llIlIlIIllIIll("HQgAOT4IGworNQoF", "KISxa");
        o.lIlIIIIlIIIl[o.lIlIIIIlIIlI[13]] = o.llIlIlIIllIlII("+osOGBVNox0=", "ofBAf");
        o.lIlIIIIlIIIl[o.lIlIIIIlIIlI[19]] = o.llIlIlIIllIIll("NwEOEwo+HRYC", "zTZGK");
        o.lIlIIIIlIIIl[o.lIlIIIIlIIlI[25]] = o.llIlIlIIllIlIl("HUZ9JOfWA0oF+NR+TEl2TQ==", "TwkmP");
        o.lIlIIIIlIIIl[o.lIlIIIIlIIlI[27]] = o.llIlIlIIllIIll("MTY2PCA9ODwt", "xuscd");
        o.lIlIIIIlIIIl[o.lIlIIIIlIIlI[31]] = o.llIlIlIIllIlII("8S6Qx1f4nTdf0XFIWNCACw==", "PgGyM");
        o.lIlIIIIlIIIl[o.lIlIIIIlIIlI[35]] = o.llIlIlIIllIIll("HgQFGRQUDhwZEBAGDA==", "QHHFX");
        o.lIlIIIIlIIIl[o.lIlIIIIlIIlI[37]] = o.llIlIlIIllIlII("YabaC2TjI/vpDgUsqTjUNg==", "BHuor");
    }

    private static String llIlIlIIllIlIl(String lllllllllllllllIlllIIIlIllIllllI, String lllllllllllllllIlllIIIlIllIllIll) {
        try {
            SecretKeySpec lllllllllllllllIlllIIIlIlllIIIIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIlllIIIlIllIllIll.getBytes(StandardCharsets.UTF_8)), lIlIIIIlIIlI[37]), "DES");
            Cipher lllllllllllllllIlllIIIlIlllIIIII = Cipher.getInstance("DES");
            lllllllllllllllIlllIIIlIlllIIIII.init(lIlIIIIlIIlI[13], lllllllllllllllIlllIIIlIlllIIIIl);
            return new String(lllllllllllllllIlllIIIlIlllIIIII.doFinal(Base64.getDecoder().decode(lllllllllllllllIlllIIIlIllIllllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String llIlIlIIllIlII(String lllllllllllllllIlllIIIlIlllIlIll, String lllllllllllllllIlllIIIlIlllIlIII) {
        try {
            SecretKeySpec lllllllllllllllIlllIIIlIlllIlllI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIlllIIIlIlllIlIII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIlllIIIlIlllIllIl = Cipher.getInstance("Blowfish");
            lllllllllllllllIlllIIIlIlllIllIl.init(lIlIIIIlIIlI[13], lllllllllllllllIlllIIIlIlllIlllI);
            return new String(lllllllllllllllIlllIIIlIlllIllIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIlllIIIlIlllIlIll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
