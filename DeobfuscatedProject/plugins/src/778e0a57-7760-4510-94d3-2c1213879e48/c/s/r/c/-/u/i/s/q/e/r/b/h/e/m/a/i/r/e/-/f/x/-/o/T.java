...
extends U {
    ...
    private static void llIllIllIIIIIl() {
        ...
        T.lIlIIlllIIlI[T.lIlIIlllIIll[0]] = T.llIllIllIIIIII("jkSygAaAoXKORLKABoChcobgRvK6hNBJ", "thsJh");
    }

    private static void llIllIllIIIIlI() {
        lIlIIlllIIll = new int[3];
        T.lIlIIlllIIll[0] = (139 + 42 - 139 + 148 ^ 161 + 58 - 84 + 40) & (0xAA ^ 0x8D ^ (0x61 ^ 0x57) ^ -" ".length());
        T.lIlIIlllIIll[1] = " ".length();
        T.lIlIIlllIIll[2] = "  ".length();
    }
