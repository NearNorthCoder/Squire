...
public class u {
    ...
    public static boolean bl() {
        ...
        if (u.llIllllllIIIlI(Vars.getBit((int)lIlIlIllllll[7]), lIlIlIllllll[1])) {
            ...
            "".length();
            if (-"   ".length() > 0) {
                return ((0x95 ^ 0x9F ^ (0xA8 ^ 0x88)) & (125 + 121 - 162 + 58 ^ 145 + 0 - 141 + 160 ^ -" ".length())) != 0;
            }
        } else {
            bl2 = lIlIlIllllll[2];
        }
    ...
    public static boolean bm() {
        ...
        if (u.llIllllllIIIlI(v.bq(), lIlIlIllllll[1])) {
            bl2 = lIlIlIllllll[1];
            "".length();
            if ((0 ^ 0x5F ^ (0x5F ^ 4)) == " ".length()) {
                return ((0xC4 ^ 0x99 ^ (0x7A ^ 0x3B)) & (140 + 31 - 94 + 88 ^ 37 + 61 - -83 + 4 ^ -" ".length())) != 0;
            }
        } else {
            bl2 = lIlIlIllllll[2];
        }
    ...
    public static boolean bk() {
        ...
        if (u.llIllllllIIIlI(Vars.getBit((int)lIlIlIllllll[6]), lIlIlIllllll[1])) {
            bl2 = lIlIlIllllll[1];
            "".length();
            if (((139 + 155 - 185 + 57 ^ 47 + 27 - -54 + 14) & (0xE2 ^ 0x9E ^ (0xE3 ^ 0xB7) ^ -" ".length())) != 0) {
                return ((0xF ^ 0x5F ^ (0x52 ^ 0x1B)) & (92 + 6 - -13 + 17 ^ 116 + 141 - 253 + 149 ^ -" ".length())) != 0;
            }
        } else {
            bl2 = lIlIlIllllll[2];
        }
