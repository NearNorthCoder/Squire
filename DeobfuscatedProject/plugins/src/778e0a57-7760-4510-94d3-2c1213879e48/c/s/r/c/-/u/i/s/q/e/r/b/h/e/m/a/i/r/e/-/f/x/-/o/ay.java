...
extends az {
    ...
    private static void llIlIIlIllIlII() {
        ...
        ay.lIIlllllIllI[ay.lIIllllllIll[0]] = ay.llIlIIlIlIllIl("4HCWIBk99IdEO5DFUzhO2w==", "qgPVy");
        ay.lIIlllllIllI[ay.lIIllllllIll[2]] = ay.llIlIIlIlIlllI("hu9C7tRZB9o=", "bOMMI");
        ay.lIIlllllIllI[ay.lIIllllllIll[3]] = ay.llIlIIlIlIllll("PCc2AQ0HNjwdH04gOhIKCg==", "nBUsx");
        ay.lIIlllllIllI[ay.lIIllllllIll[4]] = ay.llIlIIlIlIlllI("fi32YNhwdBo=", "RHfWW");
        ay.lIIlllllIllI[ay.lIIllllllIll[5]] = ay.llIlIIlIlIllIl("OIrLlpSK7Wny8OdRzqvTKlFPH6V2UwDw", "SbwTw");
        ay.lIIlllllIllI[ay.lIIllllllIll[6]] = ay.llIlIIlIlIlllI("YhmE7XZAHiA=", "xcjRA");
        ay.lIIlllllIllI[ay.lIIllllllIll[7]] = ay.llIlIIlIlIllIl("pWXSMA5gfO6Nz0jCG/19yw==", "flXZM");
    }
    ...
    private static void llIlIIlIllIlIl() {
        ...
        ay.lIIllllllIll[0] = (56 + 215 - 245 + 214 ^ 118 + 46 - 109 + 110) & (0x70 ^ 0x3A ^ (0x48 ^ 0x57) ^ -" ".length());
        ay.lIIllllllIll[1] = 0xFFFF81F7 & 0x7FFB;
        ay.lIIllllllIll[2] = " ".length();
        ay.lIIllllllIll[3] = "  ".length();
        ay.lIIllllllIll[4] = "   ".length();
        ...
        TileObjects.getNearest((WorldPoint)lllllllllllllllIlllIIllllllIIllI.cy, tileObject -> {
            ...
            if (ay.llIlIIlIllIllI(tileObject.getName().equals(lIIlllllIllI[lIIllllllIll[5]]) ? 1 : 0)) {
                ...
                if (ay.llIlIIlIllIllI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    n2 = lIIllllllIll[2];
                    "".length();
                    if (((0xBD ^ 0xB9) & ~(0x4F ^ 0x4B)) < "  ".length()) return n2 != 0;
