...
extends Enum<N> {
    ...
    private static void llIlllIIIIIIII() {
        ...
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[1]] = N.llIllIllllllIl("H3kC/GxnY3M=", "zISAQ");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[2]] = N.llIllIlllllllI("GhwMPhc=", "IhmLc");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[3]] = N.llIllIllllllll("hUgsSitbJr8=", "CxCAK");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[4]] = N.llIllIllllllll("IHaUwH/+iz8=", "Utgut");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[5]] = N.llIllIllllllll("pJSsxX0tL93780LvXkkWaA==", "MFbVJ");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[6]] = N.llIllIlllllllI("JxUOIj8aEQomKQ==", "tvoTZ");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[7]] = N.llIllIlllllllI("Fg0rJDkeCw==", "PLyip");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[8]] = N.llIllIllllllIl("dkX810fqpSI=", "KAcFa");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[9]] = N.llIllIllllllIl("KPrlcxkKSZY=", "ubZrk");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[10]] = N.llIllIllllllll("X6xNFr27vLk=", "oqomX");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[11]] = N.llIllIlllllllI("HjYCNiUE", "JsIbj");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[12]] = N.llIllIlllllllI("LCgnOiYW", "xMLNI");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[13]] = N.llIllIllllllll("ZuJshtYYklRUiAv6x3DAFw==", "UYdjW");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[14]] = N.llIllIllllllIl("7vboeyFr9ppVmI0R6r4kPA==", "MKXtl");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[15]] = N.llIllIllllllll("GKIXVB/YIPgiJZuKZyl0lg==", "uLDsX");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[16]] = N.llIllIllllllll("6tEjC1lsotcjjO0qBn7EVA==", "acuGi");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[17]] = N.llIllIllllllll("M/hpaQoKfx4=", "jgppq");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[18]] = N.llIllIllllllll("B8UjVYAhH0s=", "clcUI");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[19]] = N.llIllIllllllll("EA79rcjkR4I=", "QHzyO");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[20]] = N.llIllIlllllllI("NRAQKzAICw==", "fxqFQ");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[21]] = N.llIllIllllllll("XSglXXByl+o=", "pLDwj");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[22]] = N.llIllIllllllIl("wZjUq2g/wA0=", "WniMm");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[23]] = N.llIllIlllllllI("DCYWCSIbNRwd", "ZgXNw");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[24]] = N.llIllIlllllllI("IC4NJDAXPQcw", "vOcCE");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[25]] = N.llIllIlllllllI("BwAHMCQJCg==", "JYTdm");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[26]] = N.llIllIlllllllI("NRwWNg0bFg==", "xeeBd");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[27]] = N.llIllIllllllll("UX3uonvz/hQzjVcnJvwyHQ==", "ulGCk");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[28]] = N.llIllIllllllll("fPMSi3yi0SW0XYauZokPJrc+ZRiqGQAr", "ZdqzT");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[29]] = N.llIllIllllllll("Pf4UOB180OA=", "mcxgj");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[30]] = N.llIllIlllllllI("ChU0KyM=", "IgUIP");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[31]] = N.llIllIlllllllI("HyUWMBUTKxwh", "VfSoQ");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[32]] = N.llIllIllllllIl("QYWqLSLMIjnMTn0yNJGzXw==", "NAbmk");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[0]] = N.llIllIllllllIl("aULdP4AenKQHoJsVgaODgw==", "iRkeX");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[33]] = N.llIllIllllllIl("z2DKR+4nTuAqV9aBX8Xf2Q==", "iOSyD");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[34]] = N.llIllIllllllIl("biwYwWU98gvayPTgTTJ98A==", "hctAy");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[35]] = N.llIllIlllllllI("HjwrLT0jOiU=", "JTBHK");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[36]] = N.llIllIllllllll("cUFgM2YR/IHnUZbs08Lakw==", "RNnsY");
        N.lIlIlIIIIlll[N.lIlIlIIIlIII[37]] = N.llIllIllllllll("T6Ta74AlZP8fYoDCFJunZeKb8t7Hyrtv", "kNMha");
    }

    private static void llIlllIIIIIIIl() {
        lIlIlIIIlIII = new int[39];
        N.lIlIlIIIlIII[0] = 0x6D ^ 0x4D;
        N.lIlIlIIIlIII[1] = (0xE9 ^ 0x93 ^ (0x4D ^ 0x23)) & (132 + 105 - 121 + 21 ^ 111 + 69 - 92 + 69 ^ -" ".length());
        N.lIlIlIIIlIII[2] = " ".length();
        N.lIlIlIIIlIII[3] = "  ".length();
        N.lIlIlIIIlIII[4] = "   ".length();
        ...
        N.lIlIlIIIlIII[22] = 0x5E ^ 0x49 ^ "  ".length();
