...
extends Y {
    ...
    private static void llIlllIlIlllII() {
        ...
        ax.lIlIlIIllllI[ax.lIlIlIIlllll[0]] = ax.llIlllIlIllIIl("Ai4YDjVg", "NKyxP");
        ax.lIlIlIIllllI[ax.lIlIlIIlllll[1]] = ax.llIlllIlIllIIl("DhERHwZs", "Btpic");
        ax.lIlIlIIllllI[ax.lIlIlIIlllll[2]] = ax.llIlllIlIllIlI("Uc/JUvR0XfsfsVoyXUb+aKYOuGiHI4IP", "jWCmx");
        ax.lIlIlIIllllI[ax.lIlIlIIlllll[3]] = ax.llIlllIlIllIlI("UAOTomEQjSw=", "hSzbv");
        ax.lIlIlIIllllI[ax.lIlIlIIlllll[4]] = ax.llIlllIlIllIll("A6HXIeJkbc8=", "msARt");
        ax.lIlIlIIllllI[ax.lIlIlIIlllll[5]] = ax.llIlllIlIllIIl("LjUAGTQ=", "mYitV");
    }
    ...
    private static void llIlllIlIlllIl() {
        ...
        ax.lIlIlIIlllll[1] = " ".length();
        ax.lIlIlIIlllll[2] = "  ".length();
        ax.lIlIlIIlllll[3] = "   ".length();
        ax.lIlIlIIlllll[4] = 0xB ^ 0x7C ^ (0x75 ^ 6);
        ax.lIlIlIIlllll[5] = " ".length() ^ (0x16 ^ 0x12);
        ...
        TileObject lllllllllllllllIllIlIIIlIlIIIIIl = TileObjects.getNearest(tileObject -> {
            ...
            if (ax.llIlllIllIIIII(tileObject.getName().equals(lIlIlIIllllI[lIlIlIIlllll[4]]) ? 1 : 0)) {
                ...
                if (ax.llIlllIllIIIII(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x2F ^ 0x22 ^ (0xEF ^ 0xB2)) & (0x43 ^ 0x6F ^ (0x70 ^ 0xC) ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIlIIlllll[0];
            return n2 != 0;
