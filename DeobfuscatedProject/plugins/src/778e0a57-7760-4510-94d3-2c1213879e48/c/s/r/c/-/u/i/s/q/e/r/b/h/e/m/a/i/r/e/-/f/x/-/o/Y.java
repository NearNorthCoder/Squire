...
extends Task {
    ...
    protected boolean cr() {
        int n2;
        Y lllllllllllllllIllIIllllIIlIllIl;
        Player player = Players.getLocal();
        if (Y.llIllllIIlllll(player)) {
            return lIlIlIllIIII[2];
        }
        if (Y.llIllllIIlllIl(lllllllllllllllIllIIllllIIlIllIl.u.isInInstancedRegion() ? 1 : 0) && Y.llIllllIlIIIII((Object)c.s.r.c.-.u.i.s.q.e.r.b.h.e.m.a.i.r.e.-.f.x.-.o.u.bh(), (Object)w.WAITING_FOR_LEADER_TO_START)) {
            n2 = lIlIlIllIIII[5];
            "".length();
            if ((" ".length() & (" ".length() ^ -" ".length())) < ((0xC0 ^ 0x87 ^ (0xA6 ^ 0xC0)) & (182 + 182 - 231 + 58 ^ 97 + 70 - 33 + 24 ^ -" ".length()))) {
                return ((0xE9 ^ 0xB0 ^ (0x63 ^ 0x24)) & (0x43 ^ 0x21 ^ (0x57 ^ 0x2B) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIlIlIllIIII[2];
        }
    ...
    public boolean run() {
        Y lllllllllllllllIllIIllllIIllIIII;
        if (Y.llIllllIIlllIl(this.k.pause() ? 1 : 0)) {
            return lIlIlIllIIII[2];
        }
        if (Y.llIllllIIllllI(lllllllllllllllIllIIllllIIllIIII.v.G() ? 1 : 0)) {
            return lIlIlIllIIII[2];
        }
        return this.cg();
    }
