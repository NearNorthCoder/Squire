...
extends Task {
    ...
    public boolean run() {
        ...
        Item lllllllllllllllIlllIIIIIlllllIlI = Inventory.getFirst(item -> {
            ...
            if (!ak.llIlIllIIIllIl(item.getName().startsWith(lIlIIIlIlIII[lIlIIIlIlIIl[4]]) ? 1 : 0) || !ak.llIlIllIIIllIl(item.getName().startsWith(lIlIIIlIlIII[lIlIIIlIlIIl[5]]) ? 1 : 0) || ak.llIlIllIIIllll(item.getName().startsWith(lIlIIIlIlIII[lIlIIIlIlIIl[3]]) ? 1 : 0)) {
                ...
                "".length();
                if (" ".length() <= 0) {
                    return ((0x3E ^ 0x68 ^ (1 ^ 0x7A)) & (0x64 ^ 0x43 ^ (0x62 ^ 0x68) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIlIIIlIlIIl[0];
            }
    ...
    private static void llIlIllIIIlIll() {
        ...
        ak.lIlIIIlIlIII[ak.lIlIIIlIlIIl[0]] = ak.llIlIllIIIlIII("KCIsAwc=", "lPEml");
        ak.lIlIIIlIlIII[ak.lIlIIIlIlIIl[4]] = ak.llIlIllIIIlIIl("7P1y4DouekNceaE/v1iVsw==", "IqYXL");
        ak.lIlIIIlIlIII[ak.lIlIIIlIlIIl[5]] = ak.llIlIllIIIlIIl("cy3jSz9wYV4mnbwegb5RkA==", "IXFjZ");
        ak.lIlIIIlIlIII[ak.lIlIIIlIlIIl[3]] = ak.llIlIllIIIlIlI("3seV9AXtAG9WJLDrYgCXuQ==", "XgLip");
    }

    private static void llIlIllIIIllII() {
        lIlIIIlIlIIl = new int[8];
        ak.lIlIIIlIlIIl[0] = (58 + 30 - 66 + 118 ^ 48 + 113 - 98 + 105) & (0x9B ^ 0xB6 ^ (0x90 ^ 0x99) ^ -" ".length());
        ak.lIlIIIlIlIIl[1] = 0xFFFFB77F & 0x5DA9;
        ak.lIlIIIlIlIIl[2] = 0x62 ^ 0x67;
        ak.lIlIIIlIlIIl[3] = "   ".length();
        ak.lIlIIIlIlIIl[4] = " ".length();
        ak.lIlIIIlIlIIl[5] = "  ".length();
