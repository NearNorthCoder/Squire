...
extends bg {
        ...
        TileObject lllllllllllllllIllIIlIlIIlIlllIl = TileObjects.getNearest(tileObject -> {
            ...
            if (aY.lllIIIIIlIIlll(tileObject.getName().toLowerCase().contains(lIlIllIlIlII[lIlIllIlIlIl[10]]) ? 1 : 0)) {
                ...
                if (aY.lllIIIIIlIIlll(tileObject.hasAction(stringArray) ? 1 : 0) && aY.lllIIIIIlIIlll(this.ak.a((Locatable)tileObject) ? 1 : 0)) {
                    ...
                    return ((0x66 ^ 6 ^ (0x86 ^ 0xB9)) & (23 + 140 - 0 + 88 ^ 154 + 56 - 91 + 45 ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIllIlIlIl[0];
            return n2 != 0;
    ...
    private static void lllIIIIIlIIlIl() {
        ...
        aY.lIlIllIlIlIl[0] = (0x5A ^ 0x71 ^ (0x4A ^ 0x5C)) & (0x50 ^ 0xF ^ (0x3C ^ 0x5E) ^ -" ".length());
        aY.lIlIllIlIlIl[1] = " ".length();
        aY.lIlIllIlIlIl[2] = 0x1B ^ 0xD ^ (0x1E ^ 0xD);
        aY.lIlIllIlIlIl[3] = -(0xFFFFBED5 & 0x7B2B) & (0xFFFFFF1F & 0x3BEF);
        aY.lIlIllIlIlIl[4] = 0x3E ^ 0x38;
        aY.lIlIllIlIlIl[5] = "  ".length();
        aY.lIlIllIlIlIl[6] = "   ".length();
    ...
    private static void lllIIIIIlIIlII() {
        ...
        aY.lIlIllIlIlII[aY.lIlIllIlIlIl[0]] = aY.lllIIIIIlIIIlI("/Iit1m99Oqm3UvJMAAbuU1e5vkMpszRg", "ImtGy");
        aY.lIlIllIlIlII[aY.lIlIllIlIlIl[1]] = aY.lllIIIIIlIIIll("KEhI5bO2bWh8e3ZR+VG/MA==", "kUQCJ");
        aY.lIlIllIlIlII[aY.lIlIllIlIlIl[5]] = aY.lllIIIIIlIIIlI("6eN+EyI2JJFgbjVCMLWYNyGFEnFw/9Ou", "jvJBC");
        aY.lIlIllIlIlII[aY.lIlIllIlIlIl[6]] = aY.lllIIIIIlIIIlI("h2QAozaMB3U=", "vCYkW");
        aY.lIlIllIlIlII[aY.lIlIllIlIlIl[10]] = aY.lllIIIIIlIIIll("9NNxwZq+Rzc=", "iGYKR");
        aY.lIlIllIlIlII[aY.lIlIllIlIlIl[2]] = aY.lllIIIIIlIIIlI("WgSWbpmPR/U=", "guWSW");
    }
