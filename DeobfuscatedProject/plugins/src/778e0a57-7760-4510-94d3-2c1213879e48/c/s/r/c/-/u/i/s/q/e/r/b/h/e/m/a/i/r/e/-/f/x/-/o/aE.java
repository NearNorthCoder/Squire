...
extends U {
    ...
    private boolean da() {
        ...
        if (aE.lllIIIIIIIlIlI(lllllllllllllllIllIIlIllIIlllIlI.getId(), lllllllllllllllIllIIlIllIIlllIIl)) {
            ...
            if (-(9 + 17 - -46 + 90 ^ 143 + 103 - 219 + 140) >= 0) {
                return ((114 + 170 - 88 + 24 ^ 63 + 186 - 198 + 137) & (0x34 ^ 0x7C ^ (0xBA ^ 0x92) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIlIllIIllll[2];
        }
        ...
        return TileObjects.getNearest(tileObject -> {
            ...
            if (aE.lllIIIIIIIIllI(tileObject.getName().equals(lIlIllIIllII[lIlIllIIllll[23]]) ? 1 : 0)) {
                ...
                if (aE.lllIIIIIIIIllI(tileObject.hasAction(stringArray) ? 1 : 0) && aE.lllIIIIIIIIllI(this.ak.a((Locatable)tileObject) ? 1 : 0)) {
                    n2 = lIlIllIIllll[5];
                    "".length();
                    if (((7 ^ 0x50) & ~(0x4D ^ 0x1A)) <= "  ".length()) return n2 != 0;
        ...
        TileObject lllllllllllllllIllIIlIlllIIIIIlI = TileObjects.getNearest(tileObject -> {
            ...
            if (aE.lllIIIIIIIIllI(tileObject.getName().contains(lIlIllIIllII[lIlIllIIllll[28]]) ? 1 : 0)) {
                ...
                if (aE.lllIIIIIIIIllI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    n2 = lIlIllIIllll[5];
                    "".length();
                    if (((47 + 80 - 84 + 165 ^ 12 + 161 - -1 + 22) & (0xAB ^ 0x8B ^ (0xB7 ^ 0x83) ^ -" ".length())) < " ".length()) return n2 != 0;
                    return ((0xC ^ 0x29 ^ (0x59 ^ 0x6B)) & (0x88 ^ 0xBC ^ (0x4F ^ 0x6C) ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIllIIllll[2];
            return n2 != 0;
        ...
        if (aE.lllIIIIIIIIllI(lllllllllllllllIllIIlIlllIIIIIIl.isMoving() ? 1 : 0) && aE.lllIIIIIIIllII(lllllllllllllllIllIIlIlllIIIIIIl.getWorldArea().distanceTo((Locatable)lllllllllllllllIllIIlIlllIIIIlII.bS), lIlIllIIllll[7])) {
            ...
            Projectile lllllllllllllllIllIIlIllIlllllll2 = Projectiles.getNearest(projectile -> {
                ...
                if (aE.lllIIIIIIIlIlI(projectile.getId(), lIlIllIIllll[1]) && aE.lllIIIIIIIlIll(WorldPoint.fromLocal((Client)this.cq, (LocalPoint)projectile.getTarget()).distanceTo(lllllllllllllllIllIIlIlllIIIIIII), lIlIllIIllll[5])) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((0x17 ^ 0x1D ^ (0x12 ^ 0x50)) & (0xFD ^ 0x8E ^ (0xAC ^ 0x97) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIlIllIIllll[2];
                }
        ...
        if (aE.lllIIIIIIIlIlI(lllllllllllllllIllIIlIlllIIIIIIl.getPoseAnimation(), lIlIllIIllll[3])) {
            ...
            WorldPoint lllllllllllllllIllIIlIlllIIIIIII = lllllllllllllllIllIIlIlllIIIIIll.createWorldArea(lIlIllIIllll[8]).toWorldPointList().stream().filter(worldPoint -> {
                ...
                if (aE.lllIIIIIIIIllI(Reachable.isWalkable((WorldPoint)worldPoint) ? 1 : 0) && aE.lllIIIIIIIlIlI(lllllllllllllllIllIIlIlllIIIIIIl.getWorldArea().distanceTo(worldPoint), lIlIllIIllll[10])) {
                    n2 = lIlIllIIllll[5];
                    "".length();
                    if (((0x5C ^ 0x7E ^ (0x7F ^ 0x1D)) & (0xD5 ^ 0xAF ^ (0x58 ^ 0x62) ^ -" ".length())) != 0) {
                        return ((0x51 ^ 0x54 ^ (0x76 ^ 0x7D)) & (0x44 ^ 0x34 ^ (0xF1 ^ 0x8F) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIlIllIIllll[2];
                }
    ...
    private int z(int n2) {
        ...
        while (aE.lllIIIIIIlIIIl(lllllllllllllllIllIIlIllIlIllIII, lIlIllIIllll[10])) {
            ...
            return (0x94 ^ 0x98 ^ (0x1D ^ 1)) & (118 + 147 - 161 + 57 ^ 161 + 50 - 146 + 112 ^ -" ".length());
        }
    ...
    private WorldPoint cZ() {
        ...
        while (aE.lllIIIIIIIIllI(lllllllllllllllIllIIlIllIlIIIlII.hasNext() ? 1 : 0)) {
            ...
            "".length();
            "".length();
            if (((119 + 6 - 64 + 73 ^ 5 + 97 - 34 + 74) & (0x2C ^ 0x25 ^ " ".length() ^ -" ".length())) == 0) continue;
            return null;
        }
    ...
    private static void lllIIIIIIIIlII() {
        ...
        aE.lIlIllIIllII[aE.lIlIllIIllll[2]] = aE.llIlllllllIlII("U5WesbyTXqM=", "behAt");
        aE.lIlIllIIllII[aE.lIlIllIIllll[5]] = aE.lllIIIIIIIIIlI("oOrGX4VkNiI=", "BRBfQ");
        aE.lIlIllIIllII[aE.lIlIllIIllll[7]] = aE.llIlllllllIlII("qrff62lKN6A=", "oEfVh");
        aE.lIlIllIIllII[aE.lIlIllIIllll[9]] = aE.lllIIIIIIIIIlI("Ki1ZOqm3L3U=", "RMNvt");
        aE.lIlIllIIllII[aE.lIlIllIIllll[10]] = aE.lllIIIIIIIIIlI("5yxej7PjDGUiO8jjOM0EFA==", "RFaUg");
        aE.lIlIllIIllII[aE.lIlIllIIllll[8]] = aE.lllIIIIIIIIIlI("J9wX9nADaFkY2BiqPer1q/xuh0nI3v/z", "MrneW");
        aE.lIlIllIIllII[aE.lIlIllIIllll[12]] = aE.lllIIIIIIIIIlI("dvk/8VLch1w=", "mNKnZ");
        aE.lIlIllIIllII[aE.lIlIllIIllll[13]] = aE.llIlllllllIlII("BQVQXCE0E/8=", "gEBmj");
        aE.lIlIllIIllII[aE.lIlIllIIllll[18]] = aE.lllIIIIIIIIIlI("BdBAyL0rJCo=", "GUANT");
        aE.lIlIllIIllII[aE.lIlIllIIllll[11]] = aE.llIlllllllIlII("b3Qr6phLSVk=", "WrtkP");
        aE.lIlIllIIllII[aE.lIlIllIIllll[21]] = aE.lllIIIIIIIIIlI("FQTArZIpGTs=", "WFADn");
        aE.lIlIllIIllII[aE.lIlIllIIllll[22]] = aE.lllIIIIIIIIIll("AyAJIyg5", "WEbWG");
        aE.lIlIllIIllII[aE.lIlIllIIllll[23]] = aE.lllIIIIIIIIIlI("cHooSIQyIUg=", "sOSBt");
        aE.lIlIllIIllII[aE.lIlIllIIllll[24]] = aE.lllIIIIIIIIIlI("EKE5VMP5Krc=", "kdCci");
        aE.lIlIllIIllII[aE.lIlIllIIllll[25]] = aE.lllIIIIIIIIIll("NgwuEA0M", "biEdb");
        aE.lIlIllIIllII[aE.lIlIllIIllll[26]] = aE.lllIIIIIIIIIlI("ZBH4/uhlPc0=", "zcGSO");
        aE.lIlIllIIllII[aE.lIlIllIIllll[27]] = aE.llIlllllllIlII("Xesh9zpEDDg=", "QbxvW");
        aE.lIlIllIIllII[aE.lIlIllIIllll[28]] = aE.lllIIIIIIIIIlI("LCmLFjM7izs=", "fFDok");
        aE.lIlIllIIllII[aE.lIlIllIIllll[29]] = aE.llIlllllllIlII("lodEn2tqUIY=", "iAyKx");
    }
    ...
    public boolean ch() {
        ...
        if (aE.lllIIIIIIlIIII((Object)this.ak.bw, (Object)N.TEKTON)) {
            bl2 = lIlIllIIllll[5];
            "".length();
            if (((0xB8 ^ 0xC3 ^ (0x33 ^ 0x6F)) & (0x18 ^ 7 ^ (0xA5 ^ 0x9D) ^ -" ".length())) >= " ".length()) {
                return ((0xD8 ^ 0xA6 ^ (0x27 ^ 0x6B)) & (0xC7 ^ 0x96 ^ (0x51 ^ 0x32) ^ -" ".length())) != 0;
            }
        } else {
            bl2 = lIlIllIIllll[2];
        }
