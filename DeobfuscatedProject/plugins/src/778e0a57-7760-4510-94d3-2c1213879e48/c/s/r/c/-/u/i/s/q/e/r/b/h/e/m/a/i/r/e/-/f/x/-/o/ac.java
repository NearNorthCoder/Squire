...
extends Task {
        ...
        Item item2 = Inventory.getFirst(item -> {
            ...
            if (ac.llIllIIllIlIlI(item.getName().startsWith(lIlIIlIllIll[lIlIIlIlllII[5]]) ? 1 : 0)) {
                ...
                if (ac.llIllIIllIlIlI(item.hasAction(stringArray) ? 1 : 0)) {
                    n2 = lIlIIlIlllII[3];
                    "".length();
                    if ("  ".length() != (6 ^ 0x51 ^ (0xCD ^ 0x9E))) return n2 != 0;
                    return ((145 + 70 - 189 + 169 ^ 79 + 67 - 112 + 112) & (51 + 189 - 98 + 111 ^ 145 + 49 - 109 + 87 ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIIlIlllII[0];
            return n2 != 0;
    ...
    private static void llIllIIllIlIIl() {
        ...
        ac.lIlIIlIlllII[0] = (55 + 146 - 63 + 47 ^ 60 + 77 - 106 + 102) & (0x57 ^ 0x78 ^ (0x23 ^ 0x30) ^ -" ".length());
        ac.lIlIIlIlllII[1] = 137 + 49 - 123 + 80 ^ 94 + 11 - 16 + 56;
        ac.lIlIIlIlllII[2] = 108 + 61 - 105 + 65 ^ 67 + 106 - 72 + 38;
        ac.lIlIIlIlllII[3] = " ".length();
        ac.lIlIIlIlllII[4] = "  ".length();
        ac.lIlIIlIlllII[5] = "   ".length();
    ...
    private static void llIllIIllIlIII() {
        ...
        ac.lIlIIlIllIll[ac.lIlIIlIlllII[0]] = ac.llIllIIllIIlIl("nJw0Qibm3cs=", "IIDeX");
        ac.lIlIIlIllIll[ac.lIlIIlIlllII[3]] = ac.llIllIIllIIllI("y8XbhSQzw/B7LmXau6mlKw==", "Ekose");
        ac.lIlIIlIllIll[ac.lIlIIlIlllII[4]] = ac.llIllIIllIIllI("lU/jAWKFHbc=", "RkPgX");
        ac.lIlIIlIllIll[ac.lIlIIlIlllII[5]] = ac.llIllIIllIIlIl("gZPRjSo719Voj/WLxbI5ag==", "QgHeY");
        ac.lIlIIlIllIll[ac.lIlIIlIlllII[6]] = ac.llIllIIllIIlll("FQY9Iy4=", "QtTME");
    }
