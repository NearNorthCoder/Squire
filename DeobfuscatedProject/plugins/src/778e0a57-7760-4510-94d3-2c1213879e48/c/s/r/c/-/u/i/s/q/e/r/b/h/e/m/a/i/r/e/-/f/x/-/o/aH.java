...
extends U {
        ...
        TileObject tileObject2 = TileObjects.getNearest(tileObject -> {
            ...
            if (aH.llIlIllllIlIIl(tileObject.getName().toLowerCase().contains(lIlIIIlllllI[lIlIIIllllll[11]]) ? 1 : 0)) {
                ...
                if (aH.llIlIllllIlIIl(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x17 ^ 0xA ^ (0x76 ^ 0x2D)) & (7 ^ 0x1A ^ (0x79 ^ 0x22) ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIIIllllll[4];
            return n2 != 0;
    ...
    private static void llIlIllllIIlll() {
        ...
        aH.lIlIIIllllll[0] = -" ".length();
        aH.lIlIIIllllll[1] = -(0xFFFFDBFB & 0x6C17) & (0xFFFFDF3F & 0x7DFB);
        aH.lIlIIIllllll[2] = " ".length();
        aH.lIlIIIllllll[3] = "  ".length();
        aH.lIlIIIllllll[4] = (0x73 ^ 0x3D ^ (0x6C ^ 0x62)) & (0xF7 ^ 0xAC ^ (0xDE ^ 0xC5) ^ -" ".length());
        aH.lIlIIIllllll[5] = 0x7B ^ 0x6B;
        aH.lIlIIIllllll[6] = "   ".length();
    ...
    private static void llIlIllllIIllI() {
        ...
        aH.lIlIIIlllllI[aH.lIlIIIllllll[4]] = aH.llIlIllllIIIll("CGlzgGYZYaA=", "KpzCl");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[2]] = aH.llIlIllllIIlII("HTEmLDsBLyVtIwkyNm08CScnbA==", "hABMO");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[3]] = aH.llIlIllllIIIll("QwwFlOcThrI=", "OXCpB");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[6]] = aH.llIlIllllIIlIl("CdherNXyvtw=", "VgwOW");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[7]] = aH.llIlIllllIIIll("86FhXzym9Ck=", "guWId");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[8]] = aH.llIlIllllIIlIl("8Inq4Ghmx1DQyZD7SoH+VFSNI2SZXXbL", "xVaCx");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[9]] = aH.llIlIllllIIIll("Qo4DG/pHsCYYolZWrD1lwQ7yfEnxjkA06xpl5ihInjEEHxVlp0wZ/w==", "lReEu");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[10]] = aH.llIlIllllIIlII("HzIaYQ==", "FWiOd");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[11]] = aH.llIlIllllIIlII("DT05ESMQNCQ=", "yXWuQ");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[12]] = aH.llIlIllllIIlII("Jw8WCQ==", "wnezt");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[13]] = aH.llIlIllllIIlII("Ai8vAgAxJjAYFSQjNgU=", "PJYkt");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[14]] = aH.llIlIllllIIlIl("VZIiqg41PfUvkuXNbJ0rBw==", "hyKAo");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[15]] = aH.llIlIllllIIlII("OgsFISZFHQ==", "bnwHE");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[16]] = aH.llIlIllllIIlIl("O+PuPd7I+Zn1hbvyaRMaHQ==", "PnJii");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[17]] = aH.llIlIllllIIIll("bQqiWiOxWfI=", "GpgdE");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[18]] = aH.llIlIllllIIlII("BDsmNREeNC0hEB4=", "wZHRd");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[5]] = aH.llIlIllllIIlII("NQs6IhECDw==", "ejIQp");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[19]] = aH.llIlIllllIIIll("7aJNAveBBDQ=", "vEupi");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[20]] = aH.llIlIllllIIlII("ITUeKBEbMQ==", "wPmXd");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[21]] = aH.llIlIllllIIlIl("8iNV7cyrxfvnps3kFS4nYA==", "EKmhj");
        aH.lIlIIIlllllI[aH.lIlIIIllllll[22]] = aH.llIlIllllIIlII("FAIxATYuBg==", "BgBqC");
    }
    ...
    private static String llIlIllllIIlII(String lllllllllllllllIllIlllIllIlIlIII, String lllllllllllllllIllIlllIllIlIIlll) {
        ...
        while (aH.llIlIlllllIIII(lllllllllllllllIllIlllIllIIlllII, lllllllllllllllIllIlllIllIIlllIl)) {
            ...
            "".length();
            if ("   ".length() > ((0xE4 ^ 0xBF) & ~(0xEE ^ 0xB5))) continue;
            return null;
        }
    ...
    private boolean cU() {
        ...
        TileItem lllllllllllllllIllIlllIllllIIlll = TileItems.getNearest(tileItem -> {
            ...
            if (aH.llIlIllllIlIIl(tileItem.getName().startsWith(lIlIIIlllllI[lIlIIIllllll[15]]) ? 1 : 0) && aH.llIlIllllIlIIl(this.ak.a((Locatable)tileItem) ? 1 : 0) && aH.llIlIllllIlIIl(Reachable.isInteractable((Locatable)tileItem) ? 1 : 0)) {
                ...
                "".length();
                if ("   ".length() <= 0) {
                    return ((0x6B ^ 0x4B ^ "   ".length()) & (0x77 ^ 0x68 ^ (0x88 ^ 0xB4) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIlIIIllllll[4];
            }
