...
extends U {
    ...
    private static void llIlIlIlIlllll() {
        ...
        aA.lIlIIIlIIIlI[0] = -" ".length();
        aA.lIlIIIlIIIlI[1] = (0x31 ^ 0xE) & ~(0x30 ^ 0xF);
        aA.lIlIIIlIIIlI[2] = " ".length();
        aA.lIlIIIlIIIlI[3] = "  ".length();
        aA.lIlIIIlIIIlI[4] = 0x36 ^ 0x32;
        aA.lIlIIIlIIIlI[5] = -"  ".length();
        aA.lIlIIIlIIIlI[6] = "   ".length();
    ...
    private static void llIlIlIlIIIlIl() {
        ...
        aA.lIlIIIIllIlI[aA.lIlIIIlIIIlI[1]] = aA.llIlIlIlIIIIlI("21yta/BwfJg=", "AgHJM");
        aA.lIlIIIIllIlI[aA.lIlIIIlIIIlI[2]] = aA.llIlIlIlIIIIll("ECoqD1kKMHBY", "cCPjy");
        aA.lIlIIIIllIlI[aA.lIlIIIlIIIlI[3]] = aA.llIlIlIlIIIlII("4V2iU34YAHk=", "gNPcD");
        aA.lIlIIIIllIlI[aA.lIlIIIlIIIlI[6]] = aA.llIlIlIlIIIIll("NyMaPiUAJw==", "gBiMD");
        aA.lIlIIIIllIlI[aA.lIlIIIlIIIlI[4]] = aA.llIlIlIlIIIIlI("oomHpmkxku0=", "RWxRm");
        aA.lIlIIIIllIlI[aA.lIlIIIlIIIlI[8]] = aA.llIlIlIlIIIlII("Sakz2qcYwsQ3X3/U3/ZquA==", "EjeTU");
        aA.lIlIIIIllIlI[aA.lIlIIIlIIIlI[7]] = aA.llIlIlIlIIIlII("IJnIfvBxS/c=", "yJKRb");
        aA.lIlIIIIllIlI[aA.lIlIIIlIIIlI[10]] = aA.llIlIlIlIIIlII("Mp2MpvWL4XZKhS5thI6mqw==", "dcGBg");
        aA.lIlIIIIllIlI[aA.lIlIIIlIIIlI[11]] = aA.llIlIlIlIIIIlI("eKVVQSA2WEU=", "WYbpb");
        aA.lIlIIIIllIlI[aA.lIlIIIlIIIlI[12]] = aA.llIlIlIlIIIIlI("9mctCgUipDdS3hIF+Jvowg==", "HuSSy");
        aA.lIlIIIIllIlI[aA.lIlIIIlIIIlI[13]] = aA.llIlIlIlIIIIll("BjM7EREs", "GGOpr");
        aA.lIlIIIIllIlI[aA.lIlIIIlIIIlI[14]] = aA.llIlIlIlIIIlII("l1lZ8cZM/KVJqK5mI6fRZg==", "yuKDz");
        aA.lIlIIIIllIlI[aA.lIlIIIlIIIlI[15]] = aA.llIlIlIlIIIlII("ch7gfG/X27o=", "fhjYa");
    }
    ...
    public boolean ch() {
        ...
        if (aA.llIlIlIllIlIIl((Object)this.ak.bw, (Object)N.GUARDIANS)) {
            ...
            if ((0xF4 ^ 0xBA ^ (0x39 ^ 0x73)) <= 0) {
                return ((0xFC ^ 0xC3 ^ (0x88 ^ 0xA3)) & (0x1C ^ 0x2C ^ (0xE5 ^ 0xC1) ^ -" ".length())) != 0;
            }
        } else {
            bl2 = lIlIIIlIIIlI[1];
        }
        ...
        List list = NPCs.getAll(nPC -> {
            ...
            if (aA.llIlIlIllIIIlI(nPC.getName().contains(lIlIIIIllIlI[lIlIIIlIIIlI[12]]) ? 1 : 0)) {
                ...
                if (aA.llIlIlIllIIIlI(nPC.hasAction(stringArray) ? 1 : 0)) {
                    n2 = lIlIIIlIIIlI[2];
                    "".length();
                    if (((0xC7 ^ 0xC1 ^ (0xBA ^ 0x9B)) & (0xDF ^ 0x86 ^ (0x5D ^ 0x23) ^ -" ".length())) == 0) return n2 != 0;
                    return ((0xEA ^ 0x82 ^ (0xA1 ^ 0x83)) & (0xE1 ^ 0xB1 ^ (0x93 ^ 0x89) ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIIIlIIIlI[1];
            return n2 != 0;
        ...
        NPC nPC2 = NPCs.getNearest(nPC -> {
            ...
            if (aA.llIlIlIllIIIlI(nPC.getName().contains(lIlIIIIllIlI[lIlIIIlIIIlI[8]]) ? 1 : 0)) {
                ...
                if (aA.llIlIlIllIIIlI(nPC.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((37 + 82 - 67 + 104 ^ 160 + 75 - 194 + 140) & (109 + 89 - 63 + 0 ^ 165 + 128 - 164 + 45 ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIIIlIIIlI[1];
            return n2 != 0;
    ...
    private static String llIlIlIlIIIIll(String lllllllllllllllIlllIIIIlllIlIIlI, String lllllllllllllllIlllIIIIlllIlIIIl) {
        ...
        while (aA.llIlIlIllIlIII(lllllllllllllllIlllIIIIlllIIlIll, lllllllllllllllIlllIIIIlllIIllII)) {
            ...
            "".length();
            if (((131 + 87 - 167 + 151 ^ 91 + 18 - 14 + 47) & (185 + 60 - 107 + 71 ^ 86 + 129 - 185 + 119 ^ -" ".length())) == 0) continue;
            return null;
        }
