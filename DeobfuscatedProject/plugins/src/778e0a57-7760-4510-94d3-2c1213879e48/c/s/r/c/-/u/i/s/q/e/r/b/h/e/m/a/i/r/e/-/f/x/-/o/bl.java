...
extends U {
    ...
    private static void llIlllIIIllIll() {
        ...
        bl.lIlIlIIIllIl[21] = "   ".length() ^ (0x2A ^ 0x3B);
        ...
        return TileObjects.getNearest(tileObject -> {
            ...
            if (bl.llIlllIIIlllIl(tileObject.getName().equals(lIlIlIIIllII[lIlIlIIIllIl[25]]) ? 1 : 0)) {
                ...
                if (bl.llIlllIIIlllIl(tileObject.hasAction(stringArray) ? 1 : 0) && bl.llIlllIIIlllIl(this.ak.a((Locatable)tileObject) ? 1 : 0)) {
                    n2 = lIlIlIIIllIl[3];
                    "".length();
                    if (((0x64 ^ 0x60) & ~(0xF ^ 0xB)) <= " ".length()) return n2 != 0;
    ...
    private static void llIlllIIIlIIlI() {
        ...
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[4]] = bl.llIlllIIIIllll("BwkzOB0jAi9rCj4VOT8IIA==", "LlJKi");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[3]] = bl.llIlllIIIIllll("CxsHKBQj", "OrtXq");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[5]] = bl.llIlllIIIIllll("LiAFPj8=", "mRjML");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[6]] = bl.llIlllIIIlIIII("8MXvnXiY4U8=", "jtzFp");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[7]] = bl.llIlllIIIlIIII("any+KGxoJWw=", "hipxo");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[8]] = bl.llIlllIIIlIIIl("M37Q2IFLx9x+YBsTnT2jeQ==", "ilRME");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[9]] = bl.llIlllIIIIllll("CAMiARAgH2MYGSsD", "LfCux");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[10]] = bl.llIlllIIIlIIII("y8bOGd4d976/q7Xc5UAt0g==", "uQDHD");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[11]] = bl.llIlllIIIlIIIl("csfOMi75XwA=", "qQlNw");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[12]] = bl.llIlllIIIIllll("BxYbFQYNCwETRRQDARMAFA==", "fbote");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[13]] = bl.llIlllIIIlIIIl("3d8qh9nl8vM=", "DNYox");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[14]] = bl.llIlllIIIIllll("ETAeNyA1OwJkNygsFDA1Ng==", "ZUgDT");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[15]] = bl.llIlllIIIlIIII("aWEDDLGg9W8=", "EDksY");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[16]] = bl.llIlllIIIlIIIl("7zhpoMnLHP1KwQpLL6yYS4je17e5KADP", "xTyOD");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[17]] = bl.llIlllIIIIllll("DwkgOngKASAqeBgBKSYsHgc+K2c=", "lhNNX");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[18]] = bl.llIlllIIIIllll("LiE7GSQ=", "mSTjW");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[19]] = bl.llIlllIIIlIIIl("b8HKbhM47ZkJV8/KNAfDrA==", "vuWrZ");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[20]] = bl.llIlllIIIlIIIl("d+ijbz8mbxgvYXIQ21rZdw==", "huGTR");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[21]] = bl.llIlllIIIlIIIl("6JMhD3iRai4=", "WhaOD");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[22]] = bl.llIlllIIIIllll("DAAPHywkHE4ZJSYCCxk=", "HenkD");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[23]] = bl.llIlllIIIIllll("MgkiDSQaFWMULREJ", "vlCyL");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[24]] = bl.llIlllIIIlIIII("dmr05xRMsxQ=", "JhOxJ");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[25]] = bl.llIlllIIIlIIIl("NuXT/bph4uY=", "KIdKB");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[26]] = bl.llIlllIIIIllll("BBg9LCM=", "AvIIQ");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[27]] = bl.llIlllIIIIllll("KioDLC8CNg==", "nObXG");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[28]] = bl.llIlllIIIlIIII("4vl4+G1CHUxQ8sPPgPkQ1Q==", "QcFWH");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[29]] = bl.llIlllIIIIllll("MSAYJiQ=", "rRwUW");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[30]] = bl.llIlllIIIlIIII("BDjtxelOsw8=", "OmZej");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[31]] = bl.llIlllIIIlIIII("jpMPh/8NwTtsoWWictiO0Q==", "tZpKt");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[32]] = bl.llIlllIIIlIIIl("0uQj3mWzrJs=", "DxEwj");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[33]] = bl.llIlllIIIIllll("HzA7BT8pKjsGNWw6MxogJT0g", "LXRhR");
        bl.lIlIlIIIllII[bl.lIlIlIIIllIl[34]] = bl.llIlllIIIIllll("CScjCTAh", "MNPyU");
    }
    ...
    private static String llIlllIIIIllll(String lllllllllllllllIllIlIIlllIlIlIIl, String lllllllllllllllIllIlIIlllIlIlIII) {
        ...
        while (bl.llIlllIIlIIIIl(lllllllllllllllIllIlIIlllIlIIIlI, lllllllllllllllIllIlIIlllIlIIIll)) {
            ...
            "".length();
            if (" ".length() >= ((0x4B ^ 0x6E) & ~(0xA6 ^ 0x83))) continue;
            return null;
        }
    ...
    public List<Prayer> ci() {
        ...
        NPC lllllllllllllllIllIlIIllllIlIlll = NPCs.getNearest(nPC -> {
            ...
            if (bl.llIlllIIIlllIl(nPC.getName().contains(lIlIlIIIllII[lIlIlIIIllIl[27]]) ? 1 : 0) && bl.llIlllIIIllllI(nPC.getInteracting()) && bl.llIlllIIIlllIl(nPC.getInteracting().equals(Players.getLocal()) ? 1 : 0)) {
                n2 = lIlIlIIIllIl[3];
                "".length();
                if ((0x74 ^ 0x79 ^ (0x49 ^ 0x40)) < -" ".length()) {
                    return ((0x89 ^ 0xA2 ^ (0xFA ^ 0x9D)) & (0xFE ^ 0xBE ^ (0x57 ^ 0x5B) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIlIlIIIllIl[4];
            }
            ...
            lllllllllllllllIllIlIIlllllIIlll = TileObjects.getNearest(tileObject -> {
                ...
                if (bl.llIlllIIIlllIl(tileObject.getName().contains(lIlIlIIIllII[lIlIlIIIllIl[31]]) ? 1 : 0)) {
                    ...
                    if (bl.llIlllIIIlllIl(tileObject.hasAction(stringArray) ? 1 : 0)) {
                        ...
                        return ((0x9D ^ 0xA0 ^ (0x81 ^ 0x86)) & (11 + 100 - 43 + 81 ^ 2 + 164 - 45 + 54 ^ -" ".length())) != 0;
                    }
                }
                n2 = lIlIlIIIllIl[4];
                return n2 != 0;
    ...
    public boolean ch() {
        ...
        if (bl.llIlllIIlIIIII((Object)this.ak.bw, (Object)N.TIGHTROPE)) {
            ...
            "".length();
            if (null != null) {
                return ((74 + 17 - 82 + 171 ^ 18 + 129 - 29 + 15) & (30 + 99 - -13 + 24 ^ 31 + 9 - -22 + 89 ^ -" ".length())) != 0;
            }
        } else {
            bl2 = lIlIlIIIllIl[4];
        }
