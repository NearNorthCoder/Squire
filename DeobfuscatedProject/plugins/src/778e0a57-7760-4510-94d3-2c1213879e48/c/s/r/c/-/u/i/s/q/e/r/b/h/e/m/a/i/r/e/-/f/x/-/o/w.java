...
extends Enum<w> {
    ...
    private static void llIllIIlIIlIIl() {
        ...
        w.lIlIIlIlIlII[1] = " ".length();
        w.lIlIIlIlIlII[2] = "  ".length();
        w.lIlIIlIlIlII[3] = "   ".length();
    ...
    private static void llIllIIlIIlIII() {
        ...
        w.lIlIIlIlIIll[w.lIlIIlIlIlII[0]] = w.llIllIIlIIIlIl("Q8I+3+fczVimFZby3IpNMmdqOtfOGIDjbXDp2YV+bL8=", "hMVWl");
        w.lIlIIlIlIIll[w.lIlIIlIlIlII[1]] = w.llIllIIlIIIllI("EgkEBCYFGBoPNgIBBA07CB0RHiwb", "WQTHi");
        w.lIlIIlIlIIll[w.lIlIIlIlIlII[2]] = w.llIllIIlIIIllI("EDMzNhEHMi04EAYyPjAGDjMkMBU=", "BvruY");
        w.lIlIIlIlIIll[w.lIlIIlIlIlII[3]] = w.llIllIIlIIIllI("GQE1DSAOACsCJxwBJhEkDhIxAg==", "KDtNh");
        w.lIlIIlIlIIll[w.lIlIIlIlIlII[4]] = w.llIllIIlIIIlll("Aie2rWRpVsYUEgqxOVEbUg==", "DtKZo");
        w.lIlIIlIlIIll[w.lIlIIlIlIlII[5]] = w.llIllIIlIIIllI("JggwExs0GQ==", "aMdLT");
    }
