...
extends Enum<C> {
    ...
    private static void llIllIlIIIIllI() {
        ...
        C.lIlIIllIIlII[C.lIlIIllIIlIl[0]] = C.llIllIlIIIIlII("HuKwb/u/ASw=", "EfxfM");
        C.lIlIIllIIlII[C.lIlIIllIIlIl[2]] = C.llIllIlIIIIlIl("hmX+JonS6BM=", "Cafzj");
        C.lIlIIllIIlII[C.lIlIIllIIlIl[4]] = C.llIllIlIIIIlIl("TiMPW2Z3k8yfTGSiVGB4xQ==", "AmSTe");
    }
