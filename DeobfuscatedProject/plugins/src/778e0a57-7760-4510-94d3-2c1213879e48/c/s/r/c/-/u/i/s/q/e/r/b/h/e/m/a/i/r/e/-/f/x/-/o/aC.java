...
extends U {
        ...
        return TileObjects.getNearest(tileObject -> {
            ...
            if (aC.llIllIIIIlIlll(tileObject.getName().equals(lIlIIlIIIllI[lIlIIlIIIlll[10]]) ? 1 : 0)) {
                ...
                if (aC.llIllIIIIlIlll(tileObject.hasAction(stringArray) ? 1 : 0) && aC.llIllIIIIlIlll(this.ak.a((Locatable)tileObject) ? 1 : 0)) {
                    ...
                    return ((0xB2 ^ 0x94 ^ (0x4E ^ 0x74)) & (8 + 101 - -28 + 84 ^ 161 + 189 - 249 + 92 ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIIlIIIlll[1];
            return n2 != 0;
    ...
    private static boolean a(Client client, Tile tile, Tile tile2) {
        ...
        if (aC.llIllIIIlIIIIl(lllllllllllllllIllIlllIIIIllIIII)) {
            ...
            if ((40 + 109 - -6 + 4 ^ 3 + 43 - -74 + 35) <= 0) {
                return ((0xCA ^ 0xA6 ^ (0x7D ^ 0x73)) & (83 + 71 - 61 + 149 ^ 124 + 65 - 168 + 123 ^ -" ".length())) != 0;
            }
        } else {
        ...
        if (aC.llIllIIIlIIIlI(lllllllllllllllIllIlllIIIIlIlllI, lllllllllllllllIllIlllIIIIlIllIl)) {
            ...
            if (aC.llIllIIIlIIIIl(lllllllllllllllIllIlllIIIIlIllll)) {
                ...
                if ((0x93 ^ 0xA9 ^ (0x23 ^ 0x1D)) < 0) {
                    return ((0xF6 ^ 0x8C ^ (0xAB ^ 0x87)) & (0x5B ^ 0x54 ^ (0x6E ^ 0x37) ^ -" ".length())) != 0;
                }
            } else {
        ...
        NPC nPC2 = NPCs.getNearest(nPC -> {
            ...
            if (aC.llIllIIIIlIlll(nPC.getName().contains(lIlIIlIIIllI[lIlIIlIIIlll[6]]) ? 1 : 0)) {
                ...
                if (aC.llIllIIIIlIlll(nPC.hasAction(stringArray) ? 1 : 0)) {
                    n2 = lIlIIlIIIlll[2];
                    "".length();
                    if (((5 ^ 0x30) & ~(0x80 ^ 0xB5)) > -" ".length()) return n2 != 0;
    ...
    public boolean cg() {
        ...
        q lllllllllllllllIllIlllIIlIlIIIII = lllllllllllllllIllIlllIIlIlIIIIl.dG.stream().filter(q2 -> {
            ...
            if (aC.llIllIIIIllIIl(q2.aP()) && aC.llIllIIIIlllII(q2.aR() ? 1 : 0)) {
                ...
                "".length();
                if ("  ".length() <= 0) {
                    return ((140 + 73 - 184 + 128 ^ 63 + 60 - 90 + 165) & (0x5A ^ 0x2F ^ (0x5F ^ 0x71) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIlIIlIIIlll[1];
            }
        ...
        if (aC.llIllIIIIllIII(lllllllllllllllIllIlllIIlIlIIIII)) {
            ...
            if (aC.llIllIIIIlIlll(lllllllllllllllIllIlllIIlIlIIIIl.bS.getWorldLocation().equals((Object)lllllllllllllllIllIlllIIlIIlllll) ? 1 : 0)) {
                ...
                while (aC.llIllIIIIllIlI(lllllllllllllllIllIlllIIlIIllllI, lllllllllllllllIllIlllIIlIlIIIIl.dG.size())) {
                    ...
                    "".length();
                    if (((215 + 215 - 349 + 160 ^ 157 + 137 - 219 + 97) & (126 + 20 - 14 + 71 ^ 74 + 15 - -28 + 33 ^ -" ".length())) == 0) continue;
                    return ((0xA1 ^ 0x82 ^ (0xFE ^ 0x86)) & (0x7D ^ 0x38 ^ (0xA0 ^ 0xBE) ^ -" ".length())) != 0;
                }
    ...
    private static void llIllIIIIlIlIl() {
        ...
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[1]] = aC.llIllIIIIlIIlI("PwouDTkoC28dMCsKPB4+OQ==", "MoOnQ");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[2]] = aC.llIllIIIIlIIll("naJ/UcXDfwU=", "NpNTA");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[3]] = aC.llIllIIIIlIIll("gS3ZZeMM07g=", "DYpah");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[4]] = aC.llIllIIIIlIlII("1+YZspLkB2+EPCeFRzimmkZkIKkOnT3sBglPcr9i89M=", "eliuM");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[5]] = aC.llIllIIIIlIlII("dRXIuLINz1ThN/d8t3+/UYvTqAZyBEeq", "nrHTa");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[8]] = aC.llIllIIIIlIIlI("Egk5DBA=", "WgMib");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[14]] = aC.llIllIIIIlIIll("xTXJGcqVL6U=", "IgZit");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[17]] = aC.llIllIIIIlIIll("ewjEcVmpWz2NwWQ2SsTSkVdLgUUvZ/gOkg6XYYguRvQ=", "fqbYj");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[10]] = aC.llIllIIIIlIIlI("Ki0iIQcdKQ==", "zLQRf");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[18]] = aC.llIllIIIIlIIll("eY8rmLssaog=", "Ohrpi");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[6]] = aC.llIllIIIIlIIll("C/9nP8wdDa0=", "tpruD");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[19]] = aC.llIllIIIIlIIll("j51SYi18v2M=", "KYssT");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[20]] = aC.llIllIIIIlIIll("nUVF6PgixU0dZegKB+OJ7A==", "AhbDd");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[21]] = aC.llIllIIIIlIIll("NCjBhynwSCU=", "dAjEw");
        aC.lIlIIlIIIllI[aC.lIlIIlIIIlll[22]] = aC.llIllIIIIlIIlI("IB40EAsO", "mgGdb");
    }
    ...
    public boolean b(Client client, WorldArea worldArea, WorldArea worldArea2) {
        ...
        if (aC.llIllIIIIlllIl(lllllllllllllllIllIlllIIIlIlIlIl, lllllllllllllllIllIlllIIIlIlIlll)) {
            ...
            "".length();
            if ((0x79 ^ 0x7C ^ " ".length()) < -" ".length()) {
                return ((146 + 82 - 92 + 32 ^ 8 + 16 - -20 + 110) & (41 + 144 - 119 + 97 ^ 88 + 74 - 29 + 12 ^ -" ".length())) != 0;
            }
        ...
        if (aC.llIllIIIIlllIl(lllllllllllllllIllIlllIIIlIlIlll, lllllllllllllllIllIlllIIIlIlIlIl)) {
            ...
            "".length();
            if (((0x42 ^ 0x17 ^ (0x1F ^ 0x67)) & (0x1B ^ 0x63 ^ (0xF2 ^ 0xA7) ^ -" ".length())) != 0) {
            ...
            "".length();
            if (null != null) {
                return ((0x21 ^ 0x76 ^ (0x12 ^ 0x1A)) & (0xF4 ^ 0x9F ^ (0x9D ^ 0xA9) ^ -" ".length())) != 0;
            }
        } else {
        ...
        if (aC.llIllIIIIlllIl(lllllllllllllllIllIlllIIIlIlIllI, lllllllllllllllIllIlllIIIlIlIlII)) {
            ...
            "".length();
            if (((0x28 ^ 0x15 ^ (0x2A ^ 0x36)) & (0x21 ^ 0x4A ^ (0xEE ^ 0xA4) ^ -" ".length())) != 0) {
                return ((198 + 111 - 281 + 187 ^ 26 + 101 - 109 + 122) & (154 + 110 - 213 + 156 ^ 37 + 18 - 2 + 95 ^ -" ".length())) != 0;
            }
        } else {
    ...
    private static void llIllIIIIlIllI() {
        ...
        aC.lIlIIlIIIlll[0] = -" ".length();
        aC.lIlIIlIIIlll[1] = (0x8C ^ 0x9D ^ (0x69 ^ 0x44)) & (0x43 ^ 0x55 ^ (0x3A ^ 0x10) ^ -" ".length());
        aC.lIlIIlIIIlll[2] = " ".length();
        aC.lIlIIlIIIlll[3] = "  ".length();
        aC.lIlIIlIIIlll[4] = "   ".length();
        ...
        aC.lIlIIlIIIlll[11] = "  ".length() + (0x5A ^ 0x5D) - (0x76 ^ 0x71) + (0xB9 ^ 0xC7);
