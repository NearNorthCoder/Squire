...
extends Items {
    ...
    public static boolean a(List<Integer> list) {
        int[] nArray;
        Iterator<Integer> lllllllllllllllIlllIIIlIIlllIlII = list.iterator();
        do {
            void var1_1;
            if (E.llIlIlIlIIllll(lllllllllllllllIlllIIIlIIlllIlII.hasNext() ? 1 : 0)) {
    ...
    private static void llIlIlIlIIllIl() {
        ...
        E.lIlIIIIllllI[0] = " ".length() & ~" ".length();
        E.lIlIIIIllllI[1] = " ".length();
    ...
    public static boolean i(int ... nArray) {
        void lllllllllllllllIlllIIIlIIllllIll;
        int[] nArray2 = nArray;
        int n2 = nArray.length;
        int lllllllllllllllIlllIIIlIIllllIlI = lIlIIIIllllI[0];
        while (E.llIlIlIlIIlllI(lllllllllllllllIlllIIIlIIllllIlI, (int)lllllllllllllllIlllIIIlIIllllIll)) {
            void lllllllllllllllIlllIIIlIIlllllII;
            void lllllllllllllllIlllIIIlIIllllIIl = lllllllllllllllIlllIIIlIIlllllII[lllllllllllllllIlllIIIlIIllllIlI];
            int[] nArray3 = new int[lIlIIIIllllI[1]];
            nArray3[E.lIlIIIIllllI[0]] = lllllllllllllllIlllIIIlIIllllIIl;
            ...
            return ((0x12 ^ 0x4A ^ (0x1F ^ 0x7E)) & (3 + 81 - 33 + 122 ^ 95 + 14 - -14 + 25 ^ -" ".length())) != 0;
        }
        return lIlIIIIllllI[1];
    }
