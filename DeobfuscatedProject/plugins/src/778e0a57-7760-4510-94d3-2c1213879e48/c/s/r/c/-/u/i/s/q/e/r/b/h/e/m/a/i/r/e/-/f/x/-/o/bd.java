...
extends bg {
    ...
    private static void llIllIllIIlIll() {
        ...
        bd.lIlIIlllIlII[bd.lIlIIlllIlIl[0]] = bd.llIllIllIIlIIl("KCUuBh8=", "kIKgq");
        bd.lIlIIlllIlII[bd.lIlIIlllIlIl[1]] = bd.llIllIllIIlIlI("mJ+6+bvj7Wspin3o4QGeOg==", "qBxxL");
        bd.lIlIIlllIlII[bd.lIlIIlllIlIl[5]] = bd.llIllIllIIlIIl("IDMQBwtfJQ==", "xVbnh");
    }
    ...
    public boolean dY() {
        ...
        if (bd.llIllIllIlIIII(Inventory.contains((int[])nArray3) ? 1 : 0)) {
            ...
            while (bd.llIllIllIlIIII(lllllllllllllllIllIlIlllIIIllIll.hasNext() ? 1 : 0)) {
                ...
                return ((0x50 ^ 0x4B ^ (0x51 ^ 0x57)) & (13 + 60 - -29 + 25 ^ (0xEC ^ 0x8E) ^ -" ".length())) != 0;
            }
