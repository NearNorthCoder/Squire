...
extends U {
    ...
    private static void llIllIIlllIIlI() {
        ...
        bk.lIlIIlIlllll[bk.lIlIIllIIIII[7]] = bk.llIllIIllIllll("3lY+2GEDSt8=", "mGGkA");
        bk.lIlIIlIlllll[bk.lIlIIllIIIII[6]] = bk.llIllIIlllIIII("KT8uNw==", "fOKYn");
        bk.lIlIIlIlllll[bk.lIlIIllIIIII[11]] = bk.llIllIIlllIIIl("/N3PMxRVM8w=", "nuRBw");
        bk.lIlIIlIlllll[bk.lIlIIllIIIII[12]] = bk.llIllIIlllIIII("PgY6CRcJAg==", "ngIzv");
        bk.lIlIIlIlllll[bk.lIlIIllIIIII[13]] = bk.llIllIIlllIIII("PTgEEx8=", "xVpvm");
        bk.lIlIIlIlllll[bk.lIlIIllIIIII[14]] = bk.llIllIIllIllll("bp2aiwuZ82o=", "xfGmL");
        bk.lIlIIlIlllll[bk.lIlIIllIIIII[15]] = bk.llIllIIllIllll("QTtDaCW0hfk=", "dvOQa");
        bk.lIlIIlIlllll[bk.lIlIIllIIIII[16]] = bk.llIllIIlllIIIl("cebsgpuebX3WqMwLVPZ3DtsPDGMTXPky", "gclvG");
    }
    ...
    private static String llIllIIlllIIII(String lllllllllllllllIllIllIIlIlIlIlIl, String lllllllllllllllIllIllIIlIlIllIIl) {
        ...
        while (bk.llIllIIlllIllI(lllllllllllllllIllIllIIlIlIIlllI, lllllllllllllllIllIllIIlIlIIllll)) {
            ...
            "".length();
            if (((0x5F ^ 4) & ~(0x3C ^ 0x67)) >= -" ".length()) continue;
            return null;
        }
                ...
                TileObject lllllllllllllllIllIllIIlIlllIIll = TileObjects.getNearest(tileObject -> {
                    ...
                    if (bk.llIllIIllllIlI(tileObject.getName().contains(lIlIIlIlllll[lIlIIllIIIII[14]]) ? 1 : 0)) {
                        ...
                        if (bk.llIllIIllllIlI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                            n2 = lIlIIllIIIII[6];
                            "".length();
                            if (((172 + 178 - 303 + 187 ^ 57 + 153 - 187 + 155) & (126 + 38 - 47 + 108 ^ 13 + 173 - 3 + 2 ^ -" ".length())) <= 0) return n2 != 0;
                            return ((0x69 ^ 0x58 ^ (0x30 ^ 0x3A)) & (0x47 ^ 0x41 ^ (0x1E ^ 0x23) ^ -" ".length())) != 0;
                        }
                    }
                    n2 = lIlIIllIIIII[7];
                    return n2 != 0;
    ...
    private static void llIllIIlllIIll() {
        ...
        bk.lIlIIllIIIII[6] = " ".length();
        bk.lIlIIllIIIII[7] = (0x17 ^ 0x7B ^ (1 ^ 0x65)) & (0xE ^ 0x60 ^ (1 ^ 0x67) ^ -" ".length());
        bk.lIlIIllIIIII[8] = -(0xFFFFB67F & 0x6BE3) & (0xFFFFF7FF & 0x7BF7);
        bk.lIlIIllIIIII[9] = 3 ^ 0x1C ^ (0x4C ^ 0x45);
        bk.lIlIIllIIIII[10] = 0xBF ^ 0xB1;
        bk.lIlIIllIIIII[11] = "  ".length();
        bk.lIlIIllIIIII[12] = "   ".length();
        ...
        return TileObjects.getNearest(tileObject -> {
            ...
            if (bk.llIllIIllllIlI(tileObject.getName().equals(lIlIIlIlllll[lIlIIllIIIII[12]]) ? 1 : 0)) {
                ...
                if (bk.llIllIIllllIlI(tileObject.hasAction(stringArray) ? 1 : 0) && bk.llIllIIllllIlI(this.ak.a((Locatable)tileObject) ? 1 : 0)) {
                    ...
                    return ((0xE3 ^ 0xC7 ^ (0x22 ^ 0x3A)) & (0x71 ^ 0x25 ^ (0x13 ^ 0x7B) ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIIllIIIII[7];
            return n2 != 0;
