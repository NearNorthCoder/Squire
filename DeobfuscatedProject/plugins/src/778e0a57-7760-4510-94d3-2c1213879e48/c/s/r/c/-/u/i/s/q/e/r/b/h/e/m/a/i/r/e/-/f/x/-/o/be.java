...
extends bg {
    ...
    private static void llIlIlIIIIIlll() {
        ...
        be.lIlIIIIIlIII[0] = " ".length();
        be.lIlIIIIIlIII[1] = (0x8A ^ 0xA1 ^ (0x33 ^ 1)) & (0x78 ^ 5 ^ (0x31 ^ 0x55) ^ -" ".length());
        be.lIlIIIIIlIII[2] = -(0xFFFFFE5F & 0x2FF1) & (0xFFFFFFFC & Short.MAX_VALUE);
        be.lIlIIIIIlIII[3] = "  ".length();
    }

    private static void llIlIlIIIIIllI() {
        lIlIIIIIIlll = new String[lIlIIIIIlIII[3]];
        be.lIlIIIIIIlll[be.lIlIIIIIlIII[1]] = be.llIlIlIIIIIlII("JDgADSYaNkMTP1Q5BhQtBw==", "tQcfO");
        be.lIlIIIIIIlll[be.lIlIIIIIlIII[0]] = be.llIlIlIIIIIlIl("ZjXTJGuthxA=", "eiLaO");
    }
