...
extends bg {
        ...
        TileObject lllllllllllllllIllIllIIIIllIIllI = TileObjects.getNearest(tileObject -> {
            ...
            if (ba.llIllIlIIlllIl(tileObject.getName().contains(lIlIIllIlIIl[lIlIIllIlIlI[3]]) ? 1 : 0)) {
                ...
                if (ba.llIllIlIIlllIl(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x3E ^ 0x7F ^ 27 + 29 - -22 + 49) & (0x53 ^ 0x17 ^ (0x6C ^ 0x16) ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIIllIlIlI[0];
            return n2 != 0;
    ...
    private static void llIllIlIIllIlI() {
        ...
        ba.lIlIIllIlIlI[0] = (0x9F ^ 0x8D ^ (0x5F ^ 0x70)) & (0x86 ^ 0x96 ^ (0xB5 ^ 0x98) ^ -" ".length());
        ba.lIlIIllIlIlI[1] = " ".length();
        ...
        ba.lIlIIllIlIlI[6] = "  ".length();
        ba.lIlIIllIlIlI[7] = "   ".length();
        ...
        return TileObjects.getNearest(tileObject -> {
            ...
            if (ba.llIllIlIIlllIl(tileObject.getName().equals(lIlIIllIlIIl[lIlIIllIlIlI[7]]) ? 1 : 0)) {
                ...
                if (ba.llIllIlIIlllIl(tileObject.hasAction(stringArray) ? 1 : 0) && ba.llIllIlIIlllIl(this.ak.a((Locatable)tileObject) ? 1 : 0)) {
                    ...
                    "".length();
                    if (" ".length() != 0) return n2 != 0;
                    return ((188 + 120 - 182 + 82 ^ 20 + 84 - 87 + 133) & (14 + 24 - -35 + 56 ^ 9 + 44 - -54 + 92 ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIIllIlIlI[0];
            return n2 != 0;
    ...
    private static void llIllIlIIllIIl() {
        ...
        ba.lIlIIllIlIIl[ba.lIlIIllIlIlI[0]] = ba.llIllIlIIlIllI("1B5eCR5K4PU=", "DyQsw");
        ba.lIlIIllIlIIl[ba.lIlIIllIlIlI[1]] = ba.llIllIlIIlIlll("MQ0YKQM=", "tclLq");
        ba.lIlIIllIlIIl[ba.lIlIIllIlIlI[6]] = ba.llIllIlIIlIlll("JjQMFw==", "tUgrT");
        ba.lIlIIllIlIIl[ba.lIlIIllIlIlI[7]] = ba.llIllIlIIlIlll("KDkRFiUfPQ==", "xXbeD");
        ba.lIlIIllIlIIl[ba.lIlIIllIlIlI[8]] = ba.llIllIlIIlIlll("Ih81Iio=", "gqAGX");
        ba.lIlIIllIlIIl[ba.lIlIIllIlIlI[3]] = ba.llIllIlIIlIlll("IwcqCzs=", "tbOoH");
        ba.lIlIIllIlIIl[ba.lIlIIllIlIlI[9]] = ba.llIllIlIIllIII("z7Mu5LwM/S4=", "rcFFv");
    }
