...
extends az {
    ...
    private static void llIlIllIlIIIlI() {
        ...
        aw.lIlIIIllIIII[aw.lIlIIIllIIIl[0]] = aw.llIlIllIlIIIII("FAEGGRwuOgI0aAEsDA1oOyZJASc/", "OIiiH");
        aw.lIlIIIllIIII[aw.lIlIIIllIIIl[1]] = aw.llIlIllIlIIIII("Fx8jHSQtJCcwUA82IgMfOHcoCAQpJSEEHil3IxgCbDQ5HwIpOThNByMlIAk=", "LWLmp");
        aw.lIlIIIllIIII[aw.lIlIIIllIIIl[2]] = aw.llIlIllIlIIIII("EjgLOx8oAw8WawcfRCUuLBREPyRpGAs7azoZCiguaQcBayo7FUQqJzsVBS8yaR8KayppFA0tLSwCASU/aQcLOSct", "IpdKK");
        aw.lIlIIIllIIII[aw.lIlIIIllIIIl[3]] = aw.llIlIllIlIIIIl("YYMm1QfAbsDbT1IR4HVJ4nbKTwQcWdk1RRclIYxCbrP8K5r/Bo9ph4wkkcGduL1K", "atzso");
        aw.lIlIIIllIIII[aw.lIlIIIllIIIl[4]] = aw.llIlIllIlIIIII("Exs6JxMpID4KZx88JzsjaDs6JzctIXU+NGg9OiNnJyMwOQ==", "HSUWG");
        aw.lIlIIIllIIII[aw.lIlIIIllIIIl[6]] = aw.llIlIllIlIIIIl("aGebAmh86rECjWdcMZowVusgm435u5aHkUmraB87/iA=", "ZwfKM");
        aw.lIlIIIllIIII[aw.lIlIIIllIIIl[7]] = aw.llIlIllIlIIIIl("p80xYtkDoR8=", "aTqbQ");
    }
    ...
    private static /* synthetic */ boolean a(World world, World world2) {
        ...
        if (aw.llIlIllIlIlIII(world2.getId(), world.getId()) && aw.llIlIllIlIlIIl(world2.isNormal() ? 1 : 0)) {
            ...
            "".length();
            if (null != null) {
                return ((0x76 ^ 2 ^ (0xF1 ^ 0xAC)) & (160 + 126 - 231 + 136 ^ 28 + 73 - -21 + 28 ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIlIIIllIIIl[0];
        }
    ...
    private static void llIlIllIlIIIll() {
        ...
        aw.lIlIIIllIIIl[0] = (0xDF ^ 0xA8 ^ (0x53 ^ 0x75)) & (91 + 203 - 102 + 63 ^ 68 + 2 - -82 + 22 ^ -" ".length());
        aw.lIlIIIllIIIl[1] = " ".length();
        aw.lIlIIIllIIIl[2] = "  ".length();
        aw.lIlIIIllIIIl[3] = "   ".length();
