...
extends Y {
    ...
    public int h(boolean bl2) {
        ...
        if (Z.lllIIIIIIllIIl(bl2 ? 1 : 0)) {
            ...
            "".length();
            if (-" ".length() > " ".length()) {
                return (0xD ^ 0x5F ^ (0x67 ^ 0x6F)) & (100 + 108 - 53 + 66 ^ 86 + 35 - 50 + 64 ^ -" ".length());
            }
        } else {
            n2 = lIlIllIlIIIl[5];
        }
    ...
    private static void lllIIIIIIlIllI() {
        ...
        Z.lIlIllIlIIII[Z.lIlIllIlIIIl[0]] = Z.lllIIIIIIlIIll("KgQZNhEd", "xatYg");
        Z.lIlIllIlIIII[Z.lIlIllIlIIIl[1]] = Z.lllIIIIIIlIIll("BBU9Oww=", "pzERo");
        Z.lIlIllIlIIII[Z.lIlIllIlIIIl[3]] = Z.lllIIIIIIlIlII("dwfHjEhTg5Q=", "sdyvn");
        Z.lIlIllIlIIII[Z.lIlIllIlIIIl[9]] = Z.lllIIIIIIlIlIl("xm0qOeJFsaFcbThVIv1R3Q==", "bpDOo");
        Z.lIlIllIlIIII[Z.lIlIllIlIIIl[11]] = Z.lllIIIIIIlIlII("i5JSGo2ogfU=", "zSfWR");
        Z.lIlIllIlIIII[Z.lIlIllIlIIIl[7]] = Z.lllIIIIIIlIIll("Ix4LJiI5GA==", "WlbBG");
        Z.lIlIllIlIIII[Z.lIlIllIlIIIl[13]] = Z.lllIIIIIIlIlII("whYLsPhzqfs=", "mMMtu");
    }
    ...
    public boolean cg() {
        ...
        if (Z.lllIIIIIIllIII(lllllllllllllllIllIIlIlIlIlllllI.getName().toLowerCase().contains(lIlIllIlIIII[lIlIllIlIIIl[1]]) ? 1 : 0) && Z.lllIIIIIIllIII(lllllllllllllllIllIIlIlIlIlllllI.getName().toLowerCase().contains(lIlIllIlIIII[lIlIllIlIIIl[3]]) ? 1 : 0)) {
            n3 = lIlIllIlIIIl[1];
            "".length();
            if (((0x7E ^ 0x31 ^ (0x78 ^ 0x56)) & (0xEE ^ 0x98 ^ (0x95 ^ 0x82) ^ -" ".length())) > 0) {
                return ((0x70 ^ 0x3D ^ "  ".length()) & (32 + 86 - -83 + 16 ^ 9 + 80 - -3 + 58 ^ -" ".length())) != 0;
            }
        } else {
            n3 = lIlIllIlIIIl[0];
        }
        ...
        if (Z.lllIIIIIIllIIl(lllllllllllllllIllIIlIlIlIllllIl)) {
            ...
            "".length();
            if ("   ".length() == 0) {
                return ((0x9C ^ 0xB6 ^ (0x23 ^ 0x1D)) & (100 + 8 - 90 + 121 ^ 100 + 115 - 99 + 43 ^ -" ".length())) != 0;
            }
        } else {
