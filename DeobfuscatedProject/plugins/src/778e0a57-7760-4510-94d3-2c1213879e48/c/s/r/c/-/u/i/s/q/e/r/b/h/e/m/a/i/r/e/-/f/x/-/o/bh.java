...
extends bg {
    ...
    private static void llIlIIlIlIIllI() {
        ...
        bh.lIIlllllIlIl[1] = "  ".length();
        bh.lIIlllllIlIl[2] = " ".length();
        bh.lIIlllllIlIl[3] = 0xFFFFDB2F & 0x25DF;
        bh.lIIlllllIlIl[4] = 0xE1 ^ 0x89 ^ (8 ^ 0x66);
        bh.lIIlllllIlIl[5] = "   ".length();
    ...
    private static String llIlIIlIlIIIlI(String lllllllllllllllIlllIlIIIIlIIIIll, String lllllllllllllllIlllIlIIIIlIIIIlI) {
        ...
        while (bh.llIlIIlIlIlIII(lllllllllllllllIlllIlIIIIIllIlll, lllllllllllllllIlllIlIIIIIlllIII)) {
            ...
            "".length();
            if (" ".length() != (67 + 174 - 152 + 87 ^ 35 + 93 - 88 + 140)) continue;
            return null;
        }
    ...
    private static void llIlIIlIlIIlIl() {
        ...
        bh.lIIlllllIlII[bh.lIIlllllIlIl[0]] = bh.llIlIIlIlIIIlI("Dg4tKj0gDi0kbjgVJjM=", "HgCCN");
        bh.lIIlllllIlII[bh.lIIlllllIlIl[2]] = bh.llIlIIlIlIIIlI("NA84JVgxBzg1WCQbJiE0Lm4hODwwCyI=", "wNvqx");
        bh.lIIlllllIlII[bh.lIIlllllIlIl[1]] = bh.llIlIIlIlIIIll("JOCUpFhjnESMgg5BGMZdBg==", "DmqUz");
        bh.lIIlllllIlII[bh.lIIlllllIlIl[5]] = bh.llIlIIlIlIIlII("Zd+dcba6EXp8i25PHcbr6HvyhjJOyxbQ", "cIEwg");
        bh.lIIlllllIlII[bh.lIIlllllIlIl[6]] = bh.llIlIIlIlIIIlI("EwE8MSM3Fg==", "CsUGB");
        bh.lIIlllllIlII[bh.lIIlllllIlIl[7]] = bh.llIlIIlIlIIIll("KOFu6VN5nkw=", "PuVsY");
        bh.lIIlllllIlII[bh.lIIlllllIlIl[4]] = bh.llIlIIlIlIIlII("yDFP+dpScVY=", "ytQSv");
        bh.lIIlllllIlII[bh.lIIlllllIlIl[8]] = bh.llIlIIlIlIIIlI("OScZDCEEMg==", "jSxaH");
        bh.lIIlllllIlII[bh.lIIlllllIlIl[9]] = bh.llIlIIlIlIIlII("KiUuvQdj00W8klWP6B6xgg==", "BYOvG");
        bh.lIIlllllIlII[bh.lIIlllllIlIl[10]] = bh.llIlIIlIlIIIlI("HBw2Bxo8Czc=", "SjSuv");
        bh.lIIlllllIlII[bh.lIIlllllIlIl[11]] = bh.llIlIIlIlIIIlI("BwMtPBo6FmwhHCAeIz8=", "TwLQs");
    }
    ...
    public boolean dY() {
        ...
        while (bh.llIlIIlIlIlIII(lllllllllllllllIlllIlIIIIlllIIlI22, lllllllllllllllIlllIlIIIIlllIIll.length)) {
            ...
            "".length();
            if (((0x1F ^ 0x21 ^ (0xB0 ^ 0xBB)) & (8 + 2 - -102 + 58 ^ 67 + 10 - -42 + 40 ^ -" ".length())) == 0) continue;
            return ((81 + 43 - 59 + 76 ^ 37 + 134 - 125 + 124) & (0xF ^ 0x19 ^ (0x28 ^ 0x19) ^ -" ".length())) != 0;
        }
        ...
        while (bh.llIlIIlIlIlIlI(lllllllllllllllIlllIlIIIIllIlllI.hasNext() ? 1 : 0)) {
            ...
            if (bh.llIlIIlIlIllII(lllllllllllllllIlllIlIIIIllIllIl)) {
                "".length();
                if ("   ".length() > ((0x7E ^ 0x20 ^ (0x4F ^ 0x58)) & (67 + 52 - -5 + 15 ^ 44 + 9 - -99 + 42 ^ -" ".length()))) continue;
                return ((129 + 223 - 121 + 22 ^ 52 + 13 - -123 + 9) & (0x4B ^ 0x35 ^ (0x58 ^ 0x1E) ^ -" ".length())) != 0;
            }
            ...
            "".length();
            if (((0x34 ^ 0x11) & ~(0x1E ^ 0x3B)) < " ".length()) continue;
        ...
        if (bh.llIlIIlIlIlIlI(D.bJ() ? 1 : 0)) {
            ...
            while (bh.llIlIIlIlIlIlI(lllllllllllllllIlllIlIIIIllIlllI.hasNext() ? 1 : 0)) {
                ...
                "".length();
                if ((0xB9 ^ 0xB0 ^ (0x8A ^ 0x87)) > "  ".length()) continue;
                return ((0x2C ^ 0x17 ^ (0x79 ^ 0x51)) & (9 ^ 0x25 ^ (6 ^ 0x39) ^ -" ".length())) != 0;
            }
            return lIIlllllIlIl[2];
        }
