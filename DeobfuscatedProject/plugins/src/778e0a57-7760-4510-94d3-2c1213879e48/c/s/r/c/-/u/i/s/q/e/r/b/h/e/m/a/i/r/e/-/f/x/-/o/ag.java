...
extends Task {
    ...
    public boolean run() {
        ...
        if (ag.llIlllllIlIIIl(lllllllllllllllIllIIllIlIlllllll = NPCs.getNearest(nPC -> {
            ...
            if (ag.llIlllllIlIIlI(nPC.hasAction(stringArray) ? 1 : 0) && ag.llIlllllIlIIlI(this.cJ.L().a((Locatable)nPC) ? 1 : 0)) {
                ...
                if (-(30 + 108 - 94 + 107 ^ 17 + 100 - 107 + 136) >= 0) {
                    return ((41 + 102 - -17 + 38 ^ 108 + 118 - 65 + 33) & (0x12 ^ 0x37 ^ (0x41 ^ 0x60) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIlIlIlllIll[0];
            }
        ...
        TileItem lllllllllllllllIllIIllIlIlllllIl = TileItems.getNearest(tileItem -> {
            ...
            if (ag.llIlllllIlIIlI(tileItem.getName().toLowerCase().contains(lIlIlIlllIlI[lIlIlIlllIll[9]]) ? 1 : 0) && ag.llIlllllIlIIlI(this.cJ.L().a((Locatable)tileItem) ? 1 : 0) && ag.llIlllllIlIIlI(Reachable.isWalkable((WorldPoint)tileItem.getWorldLocation()) ? 1 : 0)) {
                ...
                "".length();
                if (" ".length() <= 0) {
                    return ((127 + 15 - 28 + 15 ^ 118 + 127 - 224 + 160) & (149 + 18 - 107 + 123 ^ 43 + 41 - 31 + 78 ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIlIlIlllIll[0];
            }
    ...
    private static void llIlllllIIllIl() {
        ...
        ag.lIlIlIlllIlI[ag.lIlIlIlllIll[0]] = ag.llIlllllIIlIlI("J5djwni7Wik6pNj8wxksoAkI/QLoD/zr", "pNJqX");
        ag.lIlIlIlllIlI[ag.lIlIlIlllIll[1]] = ag.llIlllllIIlIll("c045buXpijE=", "bomrI");
        ag.lIlIlIlllIlI[ag.lIlIlIlllIll[7]] = ag.llIlllllIIlIll("DauP+uLLEO6HuWbSVO8rvA==", "TUeLO");
        ag.lIlIlIlllIlI[ag.lIlIlIlllIll[8]] = ag.llIlllllIIllII("KSccGxZWMU4THBU=", "qBnru");
        ag.lIlIlIlllIlI[ag.lIlIlIlllIll[9]] = ag.llIlllllIIlIll("P9BwUbfpLbYrr4MZSBFx9A==", "nBjRq");
        ag.lIlIlIlllIlI[ag.lIlIlIlllIll[4]] = ag.llIlllllIIllII("LiU8IxoE", "oQHBy");
    }
    ...
    private static void llIlllllIIlllI() {
        ...
        ag.lIlIlIlllIll[7] = "  ".length();
        ag.lIlIlIlllIll[8] = "   ".length();
