...
extends SquirePlugin {
        ...
        while (SquireChambersPlugin.llIlIlIIlIlIII(lllllllllllllllIlllIIIlllIllIIlI, lllllllllllllllIlllIIIlllIllIlIl.h().length)) {
            ...
            if (SquireChambersPlugin.llIlIlIIllIIII(lllllllllllllllIlllIIIlllIllIIIl -= lllllllllllllllIlllIIIlllIllIlll.u.getBaseX(), lIlIIIIlIIII[64])) {
                if (SquireChambersPlugin.llIlIlIIllIIII(lllllllllllllllIlllIIIlllIllIIIl, lIlIIIIlIIII[62])) {
                    "".length();
                    if ((147 + 61 - 78 + 33 ^ 135 + 27 - 72 + 77) != ("  ".length() ^ (0xB9 ^ 0xBF))) {
                        return null;
                    }
                } else {
    ...
    private static void llIlIlIIlIIlIl() {
        ...
        SquireChambersPlugin.lIlIIIIlIIII[3] = " ".length();
        SquireChambersPlugin.lIlIIIIlIIII[4] = "  ".length();
        SquireChambersPlugin.lIlIIIIlIIII[5] = "   ".length();
        ...
        SquireChambersPlugin.lIlIIIIlIIII[60] = -" ".length();
    ...
    private Point v() {
        ...
        while (SquireChambersPlugin.llIlIlIIlIlIII(lllllllllllllllIlllIIIllllIIIlII, lIlIIIIlIIII[62])) {
            ...
            while (SquireChambersPlugin.llIlIlIIlIlIII(lllllllllllllllIlllIIIllllIIIIll, lIlIIIIlIIII[62])) {
                ...
                "".length();
                if ((" ".length() & (" ".length() ^ -" ".length())) == ((113 + 214 - 230 + 149 ^ 38 + 133 - 166 + 182) & (240 + 96 - 197 + 113 ^ 59 + 58 - 26 + 86 ^ -" ".length()))) continue;
                return null;
            }
    ...
    private static void llIlIlIIlIIlII() {
        ...
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[0]] = SquireChambersPlugin.llIlIlIIlIIIIl("5LxZi8NjOlgMqxJLkvsd58PN5o3vDfmdnVZth3gra4mO0m1IKp7a7BnNHDO5w3ZaqyhbyYkRi/cyNRTbnv1ZDLxcDOQtEgwq", "TQkMt");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[3]] = SquireChambersPlugin.llIlIlIIlIIIlI("Pxg1ZykfGDQgJFEnND02HRJhFSMeGjJnPxQbJCQ4FBNtZzwdEiA0KVEEJCspEgNhKiMDEmEXOQsNLSJsIxguKj8=", "qwAGL");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[4]] = SquireChambersPlugin.llIlIlIIlIIIlI("NAIOOiMaFgE7ZwEYACU0Ux4caCIdFg0kIhdXDT0zUxkAaDcaFAQpPxZXCScyHRNPISlTNQ4mLFM7ACkjHAIb", "swoHG");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[5]] = SquireChambersPlugin.llIlIlIIlIIIll("BonNGGKDKV/VfscgJVquOA==", "rKrBz");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[6]] = SquireChambersPlugin.llIlIlIIlIIIIl("E5+lMxgeDKnEgRyRnsvm4A==", "mQMlP");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[7]] = SquireChambersPlugin.llIlIlIIlIIIlI("JQQgHhgoFTUVSyYTJRMY", "AaPqk");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[8]] = SquireChambersPlugin.llIlIlIIlIIIIl("RaVP/3TXm5qJXZ1Ze0YLCg==", "QFIXG");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[9]] = SquireChambersPlugin.llIlIlIIlIIIlI("HSYtDFQ/JjYcDW8vJRtULSIhBlQrLjcbGyMxIQw=", "OGDht");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[10]] = SquireChambersPlugin.llIlIlIIlIIIIl("Wgd69D86wWVU0ziw0TB+0Q==", "WSakg");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[11]] = SquireChambersPlugin.llIlIlIIlIIIIl("vWtsxpC5HkFSxo2T4U0zYw==", "YuEVA");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[12]] = SquireChambersPlugin.llIlIlIIlIIIll("zcqymjYu69HCRNSH1LAU6A==", "erkJf");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[13]] = SquireChambersPlugin.llIlIlIIlIIIIl("BauVMHY2X4los2ghDt4mag==", "DRMnk");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[14]] = SquireChambersPlugin.llIlIlIIlIIIll("j/qkLhGxguwZX866q7gvOLZb/QFnU10MMxPMyBHPtTEzxTMICyc8BPF6tPMvTyBe", "yDACu");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[15]] = SquireChambersPlugin.llIlIlIIlIIIll("2ITvdYtqfPKkThEFAIrEvMuWFFxl9RKV", "wKFdY");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[16]] = SquireChambersPlugin.llIlIlIIlIIIIl("3YhMuH8Kr3gfk2uarGM9ULVb7fqSDiy19NXAit/8a7Y=", "LyUDT");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[17]] = SquireChambersPlugin.llIlIlIIlIIIIl("xAo2BpNDUd9OjkfEeeulkER1tvZZhjV5", "fKeXa");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[18]] = SquireChambersPlugin.llIlIlIIlIIIlI("FyQEMSYHahE8ag4lCjg/EmoJMjMNPxE=", "bJeSJ");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[19]] = SquireChambersPlugin.llIlIlIIlIIIlI("RkI=", "jbIDv");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[20]] = SquireChambersPlugin.llIlIlIIlIIIlI("LzIxKTo3cyUjPDAyLyNvNzwnZiMsPS9nbzgu", "CSHFO");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[21]] = SquireChambersPlugin.llIlIlIIlIIIIl("F+9/mFJpjXsKhtWTV3BRwA==", "aISIO");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[22]] = SquireChambersPlugin.llIlIlIIlIIIlI("KgYcOA8XBEg+AwoTByIVHEMTMQ==", "ychLf");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[23]] = SquireChambersPlugin.llIlIlIIlIIIll("Sb6a7QOPbQ4=", "WjsSF");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[24]] = SquireChambersPlugin.llIlIlIIlIIIlI("IiI5FToEOCs=", "aJXxX");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[25]] = SquireChambersPlugin.llIlIlIIlIIIlI("OCMBLAYC", "lFjXi");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[26]] = SquireChambersPlugin.llIlIlIIlIIIIl("aLE/AfEkGCA2SS11FJay2A==", "UrpwE");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[27]] = SquireChambersPlugin.llIlIlIIlIIIlI("BTsADhV2PBUYEzk8FQ==", "VNpkg");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[28]] = SquireChambersPlugin.llIlIlIIlIIIlI("Mw4+LxtMGA==", "kkLFx");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[29]] = SquireChambersPlugin.llIlIlIIlIIIlI("JBIILRcYHhMiUxUBHzs=", "wszLs");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[30]] = SquireChambersPlugin.llIlIlIIlIIIIl("Jt3DRT7jkl+qUnGVsgObJ3g0bxab67C2", "QMalC");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[31]] = SquireChambersPlugin.llIlIlIIlIIIll("7ldp3lbtMgU=", "EkodY");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[32]] = SquireChambersPlugin.llIlIlIIlIIIll("y1rW8C7/Vyf8MvyJ3c5XPtVNVMzOYctiqkcfoBvdjwJd1sRZWn5kr8LPGf+TT9Y8", "YKqvp");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[33]] = SquireChambersPlugin.llIlIlIIlIIIll("Z9e2p46wFCKWk+zxZf5cDw==", "KhkNX");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[34]] = SquireChambersPlugin.llIlIlIIlIIIIl("XfJ14jK1PTY=", "Aoqkm");
        SquireChambersPlugin.lIlIIIIIllll[SquireChambersPlugin.lIlIIIIlIIII[35]] = SquireChambersPlugin.llIlIlIIlIIIlI("Yl52RXs=", "ArUfX");
    }
    ...
    private Integer a(Point point) {
        ...
        if (SquireChambersPlugin.llIlIlIIlIllII(lllllllllllllllIlllIIIlllIIIIIII[lllllllllllllllIlllIIIlllIIIIIll.getX()][lllllllllllllllIlllIIIlllIIIIIll.getY() + lIlIIIIlIIII[34]])) {
            ...
            "".length();
            if (((44 + 79 - 60 + 78 ^ 45 + 59 - 102 + 160) & (0x26 ^ 0x48 ^ (0x74 ^ 0x35) ^ -" ".length())) < 0) {
                return null;
            }
        } else {
