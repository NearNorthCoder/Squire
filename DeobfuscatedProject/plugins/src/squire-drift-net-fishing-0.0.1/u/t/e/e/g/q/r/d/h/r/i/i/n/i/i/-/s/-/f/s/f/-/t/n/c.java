...
extends Task {
        ...
        if (c.llIlIIlllIIlII(lllllllllllllllIlllIlIIIIIIIIlll.p.g().matchesInventory() ? 1 : 0)) {
            ...
            TileObject lllllllllllllllIlllIlIIIIIIIIlIl = TileObjects.getNearest(tileObject -> {
                ...
                if (c.llIlIIlllIIlII(tileObject.hasAction(stringArray) ? 1 : 0) && c.llIlIIlllIIlII(tileObject.getName().contains(lIlIIIIIlIlI[lIlIIIIIlllI[9]]) ? 1 : 0)) {
                    n = lIlIIIIIlllI[1];
                    "".length();
                    if (((84 + 30 - 52 + 75 ^ 18 + 127 - -15 + 3) & (0x79 ^ 1 ^ (0xE5 ^ 0xB7) ^ -" ".length())) < 0) {
                        return ((89 + 17 - 61 + 130 ^ 60 + 185 - 60 + 6) & (0x66 ^ 0xF ^ (5 ^ 0x7C) ^ -" ".length())) != 0;
                    }
                } else {
                    n = lIlIIIIIlllI[0];
                }
    ...
    private static void llIlIIlllIIIll() {
        ...
        c.lIlIIIIIlllI[0] = (0xEB ^ 0xBC ^ (0xEE ^ 0x94)) & (0x72 ^ 0x2C ^ (0x67 ^ 0x14) ^ -" ".length());
        c.lIlIIIIIlllI[1] = " ".length();
        c.lIlIIIIIlllI[2] = "  ".length();
        c.lIlIIIIIlllI[3] = "   ".length();
    ...
    private static void llIlIIllIlllII() {
        ...
        c.lIlIIIIIlIlI[c.lIlIIIIIlllI[0]] = c.llIlIIllIlIIll("F9zFFmGevJo=", "uyTLL");
        c.lIlIIIIIlIlI[c.lIlIIIIIlllI[1]] = c.llIlIIllIlIIll("rG+xDunthOg=", "ptLyv");
        c.lIlIIIIIlIlI[c.lIlIIIIIlllI[2]] = c.llIlIIllIlIllI("A+4/HP6EkKQ=", "dQdsm");
        c.lIlIIIIIlIlI[c.lIlIIIIIlllI[3]] = c.llIlIIllIlIIll("tVdIlgaVlI8q5dpOreiSLg==", "AIFSp");
        c.lIlIIIIIlIlI[c.lIlIIIIIlllI[4]] = c.llIlIIllIlIllI("epZ4bM+33is=", "dmifw");
        c.lIlIIIIIlIlI[c.lIlIIIIIlllI[6]] = c.llIlIIllIlIIll("z9MMHBGtYio=", "kDPDB");
        c.lIlIIIIIlIlI[c.lIlIIIIIlllI[7]] = c.llIlIIllIllIlI("HxYWaDU0HEM8OylZCy01MABCaAApDQIkdDEcCi88MlkLKSdmDQxoNiNZFiYwIwtDemwtHg==", "FycHT");
        c.lIlIIIIIlIlI[c.lIlIIIIIlllI[8]] = c.llIlIIllIlIIll("ODHqk1ew9KI=", "sRPxK");
        c.lIlIIIIIlIlI[c.lIlIIIIIlllI[9]] = c.llIlIIllIllIlI("FwkNLikkEg==", "EfzLF");
    }
