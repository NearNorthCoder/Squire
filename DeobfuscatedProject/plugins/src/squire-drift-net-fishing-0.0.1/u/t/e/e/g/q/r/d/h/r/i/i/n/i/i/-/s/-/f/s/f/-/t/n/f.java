...
extends Task {
    ...
    private static void llIlIIlIllIIlI() {
        ...
        f.lIlIIIIIIIll[f.lIlIIIIIIlII[0]] = f.llIlIIlIllIIII("WU+r/Zh6EBiFcyLvm7rigiHMSQJ3Zr1hi/GskOeYIv4=", "xSoxv");
        f.lIlIIIIIIIll[f.lIlIIIIIIlII[1]] = f.llIlIIlIllIIIl("T6RBPNxfPQo=", "bVUTJ");
    }
    ...
    private static void llIlIIlIllIlII() {
        ...
        f.lIlIIIIIIlII[0] = (0x50 ^ 0x20 ^ (3 ^ 0x4B)) & (0x4D ^ 0x6A ^ (0xA3 ^ 0xBC) ^ -" ".length());
        f.lIlIIIIIIlII[1] = " ".length();
        f.lIlIIIIIIlII[2] = "  ".length();
