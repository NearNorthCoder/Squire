...
extends Task {
            ...
            if ((!i.llIlIIlllllIlI(lllllllllllllllIlllIIlllIllIIllI, lIlIIIIlIIlI[6]) || i.llIlIIlllllIll(lllllllllllllllIlllIIlllIllIIlIl, lIlIIIIlIIlI[6])) && i.llIlIIllllllII(lllllllllllllllIlllIIlllIllIIIll = TileObjects.getNearest(tileObject -> {
                ...
                if (i.llIlIIllllllIl(tileObject.getName().equals(lIlIIIIlIIIl[lIlIIIIlIIlI[12]]) ? 1 : 0)) {
                    ...
                    if (i.llIlIIllllllIl(tileObject.hasAction(stringArray) ? 1 : 0)) {
                        n = lIlIIIIlIIlI[7];
                        "".length();
                        if (((0x5E ^ 0x10) & ~(0x4E ^ 0)) != "   ".length()) return n != 0;
    ...
    private static void llIlIIllllIllI() {
        ...
        i.lIlIIIIlIIIl[i.lIlIIIIlIIlI[0]] = i.llIlIIlllIllII("/WbkiCXdq3c=", "YOwsP");
        i.lIlIIIIlIIIl[i.lIlIIIIlIIlI[7]] = i.llIlIIlllIllII("jRXiJ/2rSGi35FQTMPBzdw==", "DOCcv");
        i.lIlIIIIlIIIl[i.lIlIIIIlIIlI[4]] = i.llIlIIllllIIll("xtRC8tCzcvDGT61tkMaJ2vkiJYukIf4F", "cOcOQ");
        i.lIlIIIIlIIIl[i.lIlIIIIlIIlI[8]] = i.llIlIIllllIlIl("IRsaFww=", "bwudi");
        i.lIlIIIIlIIIl[i.lIlIIIIlIIlI[10]] = i.llIlIIlllIllII("L2ACPIrqHzKV1gKN0+aE/g==", "uMTLP");
        i.lIlIIIIlIIIl[i.lIlIIIIlIIlI[11]] = i.llIlIIllllIIll("YRz5GaTgCw2SWXa5wvnFdQ==", "GUoxH");
        i.lIlIIIIlIIIl[i.lIlIIIIlIIlI[12]] = i.llIlIIllllIIll("pi3/rKQ9u3QIOzrUhFYCFwT6IXV4N/4e", "nHEem");
        i.lIlIIIIlIIIl[i.lIlIIIIlIIlI[9]] = i.llIlIIlllIllII("uZEk2HJ7f4s=", "bMzkS");
    }
    ...
    private static String llIlIIllllIlIl(String lllllllllllllllIlllIIlllIlIIIIll, String lllllllllllllllIlllIIlllIlIIIIlI) {
        ...
        while (i.llIlIIlllllllI(lllllllllllllllIlllIIlllIIllllII, lllllllllllllllIlllIIlllIIllllIl)) {
            ...
            "".length();
            if ((0xCD ^ 0xB6 ^ 54 + 64 - 55 + 64) > -" ".length()) continue;
            return null;
        }
