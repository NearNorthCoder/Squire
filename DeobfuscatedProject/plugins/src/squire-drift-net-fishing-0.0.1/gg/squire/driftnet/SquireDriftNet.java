...
extends SquirePlugin {
    ...
    private static void llIlIIlllIlIll() {
        ...
        SquireDriftNet.lIlIIIIIllll[SquireDriftNet.lIlIIIIlIIII[3]] = SquireDriftNet.llIlIIlllIlIIl("OjoYYzoROgljKxd1GSsvQyYFLCsPdQIlagU8HitqFzpNMCkCJwhjIxc=", "cUmCJ");
        SquireDriftNet.lIlIIIIIllll[SquireDriftNet.lIlIIIIlIIII[4]] = SquireDriftNet.llIlIIlllIlIIl("MDEyWjQNKj9aPgs2PFozEHkuFSdEKiMIMwo+MhYrRDg5Hg==", "dYWzR");
        SquireDriftNet.lIlIIIIIllll[SquireDriftNet.lIlIIIIlIIII[5]] = SquireDriftNet.llIlIIlllIlIIl("", "RuNvp");
        SquireDriftNet.lIlIIIIIllll[SquireDriftNet.lIlIIIIlIIII[6]] = SquireDriftNet.llIlIIlllIlIIl("MyEfCCcpJw==", "GSvlB");
        SquireDriftNet.lIlIIIIIllll[SquireDriftNet.lIlIIIIlIIII[7]] = SquireDriftNet.llIlIIlllIlIlI("AdmrxkGT3cc=", "mtJjU");
        SquireDriftNet.lIlIIIIIllll[SquireDriftNet.lIlIIIIlIIII[8]] = SquireDriftNet.llIlIIlllIlIlI("/nuJNZliTAI=", "yPqdX");
        SquireDriftNet.lIlIIIIIllll[SquireDriftNet.lIlIIIIlIIII[9]] = SquireDriftNet.llIlIIlllIlIIl("ATkTKCAGNg==", "iXaXO");
    }
    ...
    private static void llIlIIlllIllIl() {
        ...
        SquireDriftNet.lIlIIIIlIIII[2] = " ".length();
        SquireDriftNet.lIlIIIIlIIII[3] = "  ".length();
        SquireDriftNet.lIlIIIIlIIII[4] = "   ".length();
    ...
    public String a() {
        Item item2 = Equipment.getFirst(item -> {
            ...
            if (!SquireDriftNet.llIlIIlllIllll(item.getName().toLowerCase().contains(lIlIIIIIllll[lIlIIIIlIIII[8]]) ? 1 : 0) || SquireDriftNet.llIlIIlllIlllI(item.getName().toLowerCase().contains(lIlIIIIIllll[lIlIIIIlIIII[9]]) ? 1 : 0)) {
                bl = lIlIIIIlIIII[2];
                "".length();
                if (((1 ^ 0x1C ^ (0x58 ^ 0x51)) & (103 + 28 - 25 + 75 ^ 86 + 115 - 184 + 144 ^ -" ".length())) != 0) {
                    return ((9 ^ 3 ^ (0x11 ^ 2)) & (0x11 ^ 0x1B ^ (0x3D ^ 0x2E) ^ -" ".length())) != 0;
                }
            } else {
                bl = lIlIIIIlIIII[0];
            }
        ...
        Item lllllllllllllllIlllIIllllIlllIlI = Inventory.getFirst(item -> {
            ...
            if (!SquireDriftNet.llIlIIlllIllll(item.getName().toLowerCase().contains(lIlIIIIIllll[lIlIIIIlIIII[6]]) ? 1 : 0) || SquireDriftNet.llIlIIlllIlllI(item.getName().toLowerCase().contains(lIlIIIIIllll[lIlIIIIlIIII[7]]) ? 1 : 0)) {
                ...
                "".length();
                if ("   ".length() <= 0) {
                    return ((0x5A ^ 0x78 ^ (0xE8 ^ 0x9F)) & (125 + 52 - 117 + 90 ^ 35 + 104 - 113 + 169 ^ -" ".length())) != 0;
                }
            } else {
                n = lIlIIIIlIIII[0];
            }
