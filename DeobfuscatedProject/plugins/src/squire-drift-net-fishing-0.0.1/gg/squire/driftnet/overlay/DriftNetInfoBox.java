...
extends OverlayPanel {
    ...
    private static String llIlIlIIIIIllI(String lllllllllllllllIlllIIllIlIIllIll, String lllllllllllllllIlllIIllIlIIllIlI) {
        lllllllllllllllIlllIIllIlIIllIll = new String(Base64.getDecoder().decode(lllllllllllllllIlllIIllIlIIllIll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIlllIIllIlIIllllI = new StringBuilder();
        char[] lllllllllllllllIlllIIllIlIIlllIl = lllllllllllllllIlllIIllIlIIllIlI.toCharArray();
        int lllllllllllllllIlllIIllIlIIlllII = lIlIIIIllIlI[1];
        char[] lllllllllllllllIlllIIllIlIIlIllI = lllllllllllllllIlllIIllIlIIllIll.toCharArray();
        int lllllllllllllllIlllIIllIlIIlIlIl = lllllllllllllllIlllIIllIlIIlIllI.length;
        int lllllllllllllllIlllIIllIlIIlIlII = lIlIIIIllIlI[1];
        while (DriftNetInfoBox.llIlIlIIIlIIIl(lllllllllllllllIlllIIllIlIIlIlII, lllllllllllllllIlllIIllIlIIlIlIl)) {
            char lllllllllllllllIlllIIllIlIlIIIIl = lllllllllllllllIlllIIllIlIIlIllI[lllllllllllllllIlllIIllIlIIlIlII];
            lllllllllllllllIlllIIllIlIIllllI.append((char)(lllllllllllllllIlllIIllIlIlIIIIl ^ lllllllllllllllIlllIIllIlIIlllIl[lllllllllllllllIlllIIllIlIIlllII % lllllllllllllllIlllIIllIlIIlllIl.length]));
            "".length();
            ++lllllllllllllllIlllIIllIlIIlllII;
            ++lllllllllllllllIlllIIllIlIIlIlII;
            "".length();
            if ("  ".length() != ((0xFD ^ 0xBE) & ~(0x71 ^ 0x32))) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllIlllIIllIlIIllllI);
    }

    private static String llIlIlIIIIlIII(String lllllllllllllllIlllIIllIlIlllIll, String lllllllllllllllIlllIIllIlIlllIlI) {
        try {
            SecretKeySpec lllllllllllllllIlllIIllIllIIIIII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIlllIIllIlIlllIlI.getBytes(StandardCharsets.UTF_8)), lIlIIIIllIlI[15]), "DES");
            Cipher lllllllllllllllIlllIIllIlIllllll = Cipher.getInstance("DES");
            lllllllllllllllIlllIIllIlIllllll.init(lIlIIIIllIlI[5], lllllllllllllllIlllIIllIllIIIIII);
            return new String(lllllllllllllllIlllIIllIlIllllll.doFinal(Base64.getDecoder().decode(lllllllllllllllIlllIIllIlIlllIll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void llIlIlIIIIlIll() {
        ...
        DriftNetInfoBox.lIlIIIIlIlll[DriftNetInfoBox.lIlIIIIllIlI[1]] = DriftNetInfoBox.llIlIlIIIIIllI("OgIkHR0MUxUGBg8HcToKHVMXHRwBFiM=", "isQto");
        DriftNetInfoBox.lIlIIIIlIlll[DriftNetInfoBox.lIlIIIIllIlI[4]] = DriftNetInfoBox.llIlIlIIIIIlll("BZbvPwyY7nfyZ4BJpgrF+A==", "jhVeL");
        DriftNetInfoBox.lIlIIIIlIlll[DriftNetInfoBox.lIlIIIIllIlI[5]] = DriftNetInfoBox.llIlIlIIIIIllI("EQA8KFJl", "EaOCh");
        DriftNetInfoBox.lIlIIIIlIlll[DriftNetInfoBox.lIlIIIIllIlI[6]] = DriftNetInfoBox.llIlIlIIIIlIII("UP3dJtQ4fSvn0579q3Xfpw==", "JnRvi");
        DriftNetInfoBox.lIlIIIIlIlll[DriftNetInfoBox.lIlIIIIllIlI[7]] = DriftNetInfoBox.llIlIlIIIIIlll("AVCWdu2yc6e57jMuNNoNsQ==", "UAaZt");
        DriftNetInfoBox.lIlIIIIlIlll[DriftNetInfoBox.lIlIIIIllIlI[12]] = DriftNetInfoBox.llIlIlIIIIlIII("0Lx5Apw/ULM=", "gUDmg");
        DriftNetInfoBox.lIlIIIIlIlll[DriftNetInfoBox.lIlIIIIllIlI[13]] = DriftNetInfoBox.llIlIlIIIIlIII("QUgEMKE8C6U=", "vjIhK");
        DriftNetInfoBox.lIlIIIIlIlll[DriftNetInfoBox.lIlIIIIllIlI[14]] = DriftNetInfoBox.llIlIlIIIIIlll("s+KlB+6CYSo=", "GQSDF");
        DriftNetInfoBox.lIlIIIIlIlll[DriftNetInfoBox.lIlIIIIllIlI[15]] = DriftNetInfoBox.llIlIlIIIIIllI("aDZRY2Qpew==", "MRqKA");
    }
    ...
    private static void llIlIlIIIIlllI() {
        ...
        DriftNetInfoBox.lIlIIIIllIlI[4] = " ".length();
        DriftNetInfoBox.lIlIIIIllIlI[5] = "  ".length();
        DriftNetInfoBox.lIlIIIIllIlI[6] = "   ".length();
    ...
    private static String llIlIlIIIIIlll(String lllllllllllllllIlllIIllIlIllIIII, String lllllllllllllllIlllIIllIlIlIllIl) {
        try {
            SecretKeySpec lllllllllllllllIlllIIllIlIllIIll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIlllIIllIlIlIllIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIlllIIllIlIllIIlI = Cipher.getInstance("Blowfish");
            lllllllllllllllIlllIIllIlIllIIlI.init(lIlIIIIllIlI[5], lllllllllllllllIlllIIllIlIllIIll);
