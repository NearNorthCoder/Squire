...
extends Task {
    ...
    private static void lIIllllIlllIIlI() {
        ...
        g.lIIIlIIlIIlIl[g.lIIIlIIlIIllI[0]] = g.lIIllllIlllIIIl("qD0Ot01yEZzElFj8Bm5UClZQVB8n1YH/", "Tmoyc");
    }
    ...
    public boolean run() {
        ...
        Widget lllllllllllllllIIIIlllllllllIllI = Widgets.get((WidgetInfo)Prayer.RAPID_HEAL.getWidgetInfo());
        if (g.lIIllllIlllIlll(lllllllllllllllIIIIlllllllllIllI)) {
            return lIIIlIIlIIllI[0];
        }
        if (g.lIIllllIllllIII(Prayers.isEnabled((Prayer)Prayer.RAPID_HEAL) ? 1 : 0)) {
            WidgetPackets.widgetFirstOption((Widget)lllllllllllllllIIIIlllllllllIllI);
            "".length();
            if (-"   ".length() > 0) {
    ...
    private static String lIIllllIlllIIIl(String lllllllllllllllIIIIllllllllIlIll, String lllllllllllllllIIIIllllllllIllII) {
        try {
            ...
            Cipher lllllllllllllllIIIIllllllllIllll = Cipher.getInstance("Blowfish");
            lllllllllllllllIIIIllllllllIllll.init(lIIIlIIlIIllI[5], lllllllllllllllIIIIlllllllllIIII);
            return new String(lllllllllllllllIIIIllllllllIllll.doFinal(Base64.getDecoder().decode(lllllllllllllllIIIIllllllllIlIll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIIllllIlllIIll() {
        ...
        g.lIIIlIIlIIllI[4] = " ".length();
        g.lIIIlIIlIIllI[5] = "  ".length();
    }
}
