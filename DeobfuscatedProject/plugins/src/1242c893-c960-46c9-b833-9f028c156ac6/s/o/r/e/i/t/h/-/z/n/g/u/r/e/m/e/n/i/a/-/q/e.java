...
extends Task {
    ...
    private static void lIIllllIIllllll() {
        ...
        e.lIIIlIIIlIlII[2] = (0xB8 ^ 0x85 ^ (0x4D ^ 0x3E)) & (70 + 53 - 74 + 164 ^ 62 + 73 - 82 + 102 ^ -" ".length());
        e.lIIIlIIIlIlII[3] = 0xFFFFCFFF & 0x3F73;
        e.lIIIlIIIlIlII[4] = -(0xFFFFF0AF & 0x3FD9) & (0xFFFFBFFD & 0x7FFE);
        e.lIIIlIIIlIlII[5] = " ".length();
        e.lIIIlIIIlIlII[6] = "  ".length();
        e.lIIIlIIIlIlII[7] = "   ".length();
    ...
    private static void lIIllllIIlllIIl() {
        ...
        e.lIIIlIIIlIIIl[e.lIIIlIIIlIlII[2]] = e.lIIllllIIllIlII("tb1uGfN3GuwD7NBjz/C1Dvbbz+878I9AMeCydzdar04=", "adsja");
        e.lIIIlIIIlIIIl[e.lIIIlIIIlIlII[5]] = e.lIIllllIIllIlll("8Ui99kNgg3I=", "bKdAk");
        e.lIIIlIIIlIIIl[e.lIIIlIIIlIlII[6]] = e.lIIllllIIlllIII("JQ8eLAMUGQQsH0RF", "dmmCq");
    }
