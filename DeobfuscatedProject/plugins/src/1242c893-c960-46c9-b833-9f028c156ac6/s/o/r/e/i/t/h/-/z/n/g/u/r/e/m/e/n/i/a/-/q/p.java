...
extends Task {
    ...
    private static void lIIllllIIlIllIl() {
        ...
        p.lIIIlIIIIllll[p.lIIIlIIIlIIII[0]] = p.lIIllllIIlIlIlI("jw8S9g6xFwfsBUZ/wxtL3UP4k7DQNrLQDl/50nZD2mdxi0lnFMMrXQ==", "XzDBX");
        p.lIIIlIIIIllll[p.lIIIlIIIlIIII[2]] = p.lIIllllIIlIlIll("CykEMgInKRd3FDwiETpR", "NGpWp");
        p.lIIIlIIIIllll[p.lIIIlIIIlIIII[5]] = p.lIIllllIIlIlIlI("U9h3S/5aJTM=", "uNhVQ");
        p.lIIIlIIIIllll[p.lIIIlIIIlIIII[6]] = p.lIIllllIIlIllII("oDbxV1GwZYs=", "cMDrn");
        p.lIIIlIIIIllll[p.lIIIlIIIlIIII[7]] = p.lIIllllIIlIlIlI("Ungby1FSeMg=", "yFAdL");
    }
    ...
    private static void lIIllllIIlIlllI() {
        ...
        p.lIIIlIIIlIIII[2] = " ".length();
        p.lIIIlIIIlIIII[3] = 0x29 ^ 0x40 ^ (0x79 ^ 0xE);
        p.lIIIlIIIlIIII[4] = -" ".length();
        p.lIIIlIIIlIIII[5] = "  ".length();
        p.lIIIlIIIlIIII[6] = "   ".length();
