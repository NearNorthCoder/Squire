...
extends Task {
    ...
    private static void lIIllllIlllllII() {
        ...
        m.lIIIlIIlIIlll[m.lIIIlIIlIlIIl[0]] = m.lIIllllIllllIIl("IT8hMA==", "oPOUH");
        m.lIIIlIIlIIlll[m.lIIIlIIlIlIIl[1]] = m.lIIllllIllllIlI("56WKFNaLQUVjky0jFMFwPmJbkH36hNTR", "CnHPV");
        m.lIIIlIIlIIlll[m.lIIIlIIlIlIIl[3]] = m.lIIllllIllllIll("Ac1jbjC+zFIeLCxb2lMdkw==", "ZhJte");
    }
    ...
    private static void lIIlllllIIIIIIl() {
        ...
        m.lIIIlIIlIlIIl[1] = " ".length();
        m.lIIIlIIlIlIIl[2] = 83 + 127 - 168 + 107 ^ 147 + 114 - 203 + 111;
        m.lIIIlIIlIlIIl[3] = "  ".length();
        m.lIIIlIIlIlIIl[4] = "   ".length();
