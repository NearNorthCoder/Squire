...
extends Task {
    ...
    private static void lIIllllIllIIlll() {
        ...
        s.lIIIlIIlIIIIl[s.lIIIlIIlIIlII[0]] = s.lIIllllIllIIlIl("ORI0CBAPBGMKCg4ENw==", "kwCib");
        s.lIIIlIIlIIIIl[s.lIIIlIIlIIlII[1]] = s.lIIllllIllIIlIl("Kw8bAwEQ", "xjzqb");
        s.lIIIlIIlIIIIl[s.lIIIlIIlIIlII[3]] = s.lIIllllIllIIlIl("MRI+WHxD", "sgGuM");
        s.lIIIlIIlIIIIl[s.lIIIlIIlIIlII[4]] = s.lIIllllIllIIllI("S2ZMzF1XrEo=", "pkREW");
    }
    ...
    private static void lIIllllIllIlIlI() {
        ...
        s.lIIIlIIlIIlII[1] = " ".length();
        s.lIIIlIIlIIlII[2] = (0x6B ^ 0x6F) + (7 ^ 0x75) - (0x62 ^ 0x55) + (7 + 137 - 119 + 118);
        s.lIIIlIIlIIlII[3] = "  ".length();
        s.lIIIlIIlIIlII[4] = "   ".length();
