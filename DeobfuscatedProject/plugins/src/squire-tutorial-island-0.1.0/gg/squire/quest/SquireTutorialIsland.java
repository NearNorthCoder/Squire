...
extends SquirePlugin {
    ...
    private static void lIlllIIIIIIlIII() {
        ...
        SquireTutorialIsland.lIlIIIlIlIlll[0] = "  ".length();
        SquireTutorialIsland.lIlIIIlIlIlll[1] = (93 + 85 - 58 + 131 ^ 39 + 125 - 27 + 55) & (54 + 126 - 82 + 37 ^ 8 + 78 - -60 + 42 ^ -" ".length());
        SquireTutorialIsland.lIlIIIlIlIlll[2] = " ".length();
        SquireTutorialIsland.lIlIIIlIlIlll[3] = "   ".length();
    ...
    private static void lIlllIIIIIIIlll() {
        ...
        SquireTutorialIsland.lIlIIIlIlIllI[SquireTutorialIsland.lIlIIIlIlIlll[1]] = SquireTutorialIsland.lIlllIIIIIIIlIl("kS/lJjcqz+t4OWC93pPr2w==", "fJebE");
        SquireTutorialIsland.lIlIIIlIlIllI[SquireTutorialIsland.lIlIIIlIlIlll[2]] = SquireTutorialIsland.lIlllIIIIIIIllI("8tlmHWuFToM=", "HkDPZ");
        ...
        SquireTutorialIsland.lIlIIIlIlIllI[SquireTutorialIsland.lIlIIIlIlIlll[3]] = SquireTutorialIsland.lIlllIIIIIIIlIl("87/Ijsg1f1n8xT1IF24jlJjsWAGdHGC65UDcT30c7mk=", "maeEW");
    }
