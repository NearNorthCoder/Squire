...
public class f {
    ...
    private static void lIlllIIIIllIIII() {
        ...
        f.lIlIIIllIlIll[1] = "   ".length() & ~"   ".length();
        f.lIlIIIllIlIll[2] = " ".length();
        f.lIlIIIllIlIll[3] = "  ".length();
        f.lIlIIIllIlIll[4] = "   ".length();
    ...
    private static void lIlllIIIIlIllll() {
        ...
        f.lIlIIIllIlIlI[f.lIlIIIllIlIll[1]] = f.lIlllIIIIlIllII("GYySPRXsoxwD+PcjqI1QSA==", "VYkoF");
        f.lIlIIIllIlIlI[f.lIlIIIllIlIll[2]] = f.lIlllIIIIlIllIl("K9Xu5qB4HX0wT5eV+JmlZA==", "LTTDt");
        f.lIlIIIllIlIlI[f.lIlIIIllIlIll[3]] = f.lIlllIIIIlIllIl("CsNeVHyXjLTzlbXMzw6zCg==", "uUCLu");
        f.lIlIIIllIlIlI[f.lIlIIIllIlIll[4]] = f.lIlllIIIIlIllIl("XYVu3ht7SC77/p/5Z2odgg==", "iWtze");
        f.lIlIIIllIlIlI[f.lIlIIIllIlIll[0]] = f.lIlllIIIIlIllIl("Eoy0DyV1zZyVMqXrDZrs6g==", "ZkxPM");
        f.lIlIIIllIlIlI[f.lIlIIIllIlIll[5]] = f.lIlllIIIIlIlllI("cA==", "JCETC");
        f.lIlIIIllIlIlI[f.lIlIIIllIlIll[6]] = f.lIlllIIIIlIllIl("ntMjPGlVcrlf9aKbBOh2ZQ==", "RRRSl");
        f.lIlIIIllIlIlI[f.lIlIIIllIlIll[7]] = f.lIlllIIIIlIlllI("MicjIBQkJyMsFTUzJA==", "AVVIf");
        f.lIlIIIllIlIlI[f.lIlIIIllIlIll[8]] = f.lIlllIIIIlIllIl("jweDAuaFs0y9IYelcGrMsQ==", "imGqT");
    }
