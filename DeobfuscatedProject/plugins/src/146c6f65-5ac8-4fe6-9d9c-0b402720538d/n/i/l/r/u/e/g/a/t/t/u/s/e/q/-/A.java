...
extends n {
    ...
    private static String llllllIlllIIll(String lllllllllllllllIlIIlIlIlIIIlIIII, String lllllllllllllllIlIIlIlIlIIIIlIlI) {
        ...
        while (A.llllllIlllllIl(lllllllllllllllIlIIlIlIlIIIIIlII, lllllllllllllllIlIIlIlIlIIIIIlIl)) {
            ...
            "".length();
            if ("   ".length() != ((0x2E ^ 0x6F ^ (0x49 ^ 0x1F)) & (0x44 ^ 7 ^ (0x76 ^ 0x22) ^ -" ".length()))) continue;
            return null;
        }
        ...
        if (A.llllllIllllIII(headIcon, HeadIcon.MAGIC)) {
            Item item2 = Inventory.getFirst(item -> {
                ...
                if (A.llllllIllllIIl(string) && A.llllllIlllIlll(string.contains(llIIllIlIIII[llIIllIlIIIl[10]]) ? 1 : 0)) {
                    ...
                    "".length();
                    if ("   ".length() < "  ".length()) {
                        return ((0x62 ^ 0x2D ^ (0xBB ^ 0xB6)) & (4 + 45 - 26 + 108 ^ 27 + 132 - 121 + 155 ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = llIIllIlIIIl[1];
                }
            ...
            "".length();
            if ((0xC2 ^ 0xA6 ^ (0x4C ^ 0x2C)) == ((135 + 112 - 124 + 88 ^ 133 + 123 - 197 + 140) & (42 + 190 - 201 + 183 ^ 111 + 55 - 147 + 175 ^ -" ".length()))) {
                return ((0xAB ^ 0xC5 ^ (0xDC ^ 0x93)) & (0xF2 ^ 0xA3 ^ (0x75 ^ 5) ^ -" ".length())) != 0;
            }
        } else {
            Item lllllllllllllllIlIIlIlIlIllIIIll = Inventory.getFirst(item -> {
                ...
                if (A.llllllIllllIIl(string) && A.llllllIlllIlll(string.contains(llIIllIlIIII[llIIllIlIIIl[9]]) ? 1 : 0)) {
                    ...
                    "".length();
                    if (-"  ".length() >= 0) {
                        return ((172 + 34 - 167 + 135 ^ 17 + 10 - -29 + 95) & (0x12 ^ 0x72 ^ (0x62 ^ 0x3B) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = llIIllIlIIIl[1];
                }
    ...
    private boolean bA() {
        ...
        if (A.llllllIllllIlI(bK)) {
            ...
            "".length();
            if (null != null) {
                return ((" ".length() ^ (0x2F ^ 0x21)) & (0xF7 ^ 0xC7 ^ (0xA6 ^ 0x99) ^ -" ".length())) != 0;
            }
            ...
            Item lllllllllllllllIlIIlIlIlIlIllIIl = Inventory.getFirst(item -> {
                ...
                if (A.llllllIllllIIl(string) && A.llllllIlllIlll(string.contains(llIIllIlIIII[llIIllIlIIIl[7]]) ? 1 : 0)) {
                    n2 = llIIllIlIIIl[0];
                    "".length();
                    if (((0x7A ^ 0x6B ^ (0xB0 ^ 0xC2)) & (0xA0 ^ 0x90 ^ (0x1C ^ 0x4F) ^ -" ".length())) != 0) {
                        return ((0x36 ^ 0x56 ^ (0xFF ^ 0xB5)) & (0x34 ^ 0x15 ^ (0x93 ^ 0x98) ^ -" ".length()) & ((0xD2 ^ 0x83 ^ (0x66 ^ 8)) & (" ".length() ^ (0x93 ^ 0xAD) ^ -" ".length()) & ((0x79 ^ 0x7F ^ (0xE4 ^ 0xA8)) & (119 + 179 - 147 + 41 ^ 11 + 44 - -13 + 70 ^ -" ".length()) ^ -" ".length()) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = llIIllIlIIIl[1];
                }
            ...
            "".length();
            if ("   ".length() < 0) {
                return ((0x3F ^ 0x2E ^ (0x14 ^ 0x1D)) & (53 + 198 - 132 + 104 ^ 1 + 22 - -91 + 85 ^ -" ".length())) != 0;
            }
    ...
    private static void llllllIlllIlIl() {
        ...
        A.llIIllIlIIII[A.llIIllIlIIIl[1]] = A.llllllIlllIIlI("YO/e0SIoHsE=", "FjBbi");
        A.llIIllIlIIII[A.llIIllIlIIIl[0]] = A.llllllIlllIIll("AyAiOxE=", "TIGWu");
        A.llIIllIlIIII[A.llIIllIlIIIl[2]] = A.llllllIlllIlII("ruu8+4kNytQ=", "xDtpS");
        A.llIIllIlIIII[A.llIIllIlIIIl[4]] = A.llllllIlllIIll("GwQmGyo=", "LmCwN");
        A.llIIllIlIIII[A.llIIllIlIIIl[5]] = A.llllllIlllIIlI("HakYr0RTkqM=", "kvHzo");
        A.llIIllIlIIII[A.llIIllIlIIIl[3]] = A.llllllIlllIIlI("NIAel6yswYE=", "LQbIz");
        A.llIIllIlIIII[A.llIIllIlIIIl[6]] = A.llllllIlllIIlI("BSghh62b8wM=", "OFPra");
        A.llIIllIlIIII[A.llIIllIlIIIl[7]] = A.llllllIlllIIlI("ZcnRjovAgMk=", "KxEqz");
        A.llIIllIlIIII[A.llIIllIlIIIl[8]] = A.llllllIlllIlII("ZWgxZLxGNcs=", "aWiUc");
        A.llIIllIlIIII[A.llIIllIlIIIl[9]] = A.llllllIlllIIll("JxooHyQ=", "TnIyB");
        A.llIIllIlIIII[A.llIIllIlIIIl[10]] = A.llllllIlllIIlI("PEgxIyjdbhI=", "PpsyB");
    }
    ...
    private static void llllllIlllIllI() {
        ...
        A.llIIllIlIIIl[0] = " ".length();
        A.llIIllIlIIIl[1] = (0x59 ^ 0x60 ^ (0x9F ^ 0xAA)) & (73 + 65 - 121 + 150 ^ 170 + 75 - 238 + 164 ^ -" ".length());
        A.llIIllIlIIIl[2] = "  ".length();
        A.llIIllIlIIIl[3] = 9 + 36 - -78 + 64 ^ 40 + 15 - -100 + 35;
        A.llIIllIlIIIl[4] = "   ".length();
