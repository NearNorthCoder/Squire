...
extends n {
    ...
    public void a(ChatMessage chatMessage) {
        ...
        if (X.llllllIIIlllII(lllllllllllllllIlIIllIIIIIIIIlII)) {
            ...
            while (X.llllllIIlIIIII(lllllllllllllllIlIIlIlllllllllll, lllllllllllllllIlIIllIIIIIIIIIII)) {
                ...
                ++lllllllllllllllIlIIlIlllllllllll;
                "".length();
                if ((0x16 ^ 0 ^ (0x56 ^ 0x44)) >= " ".length()) continue;
                return;
            }
        }
    }
    ...
    private static void llllllIIIllIIl() {
        ...
        X.llIIlIlllIlI[X.llIIlIllllll[1]] = X.llllllIIIIIlIl("HDoESgcLIRQYQhE9FEoFBCAfHg4AIQ==", "eUqjb");
        X.llIIlIlllIlI[X.llIIlIllllll[0]] = X.llllllIIIIIlIl("Qg==", "nzZJL");
        X.llIIlIlllIlI[X.llIIlIllllll[2]] = X.llllllIIIIIlIl("XA==", "flbgN");
        X.llIIlIlllIlI[X.llIIlIllllll[4]] = X.llllllIIIIIllI("/23zGZq7ipw=", "Obrck");
        X.llIIlIlllIlI[X.llIIlIllllll[5]] = X.llllllIIIIIlIl("VQ==", "yfgaP");
        X.llIIlIlllIlI[X.llIIlIllllll[6]] = X.llllllIIIIIlIl("Uw==", "iSqRj");
        X.llIIlIlllIlI[X.llIIlIllllll[3]] = X.llllllIIIIIlll("DNamm1gEBJA=", "uBtZd");
    }
