...
extends n {
    ...
    private static void lIIIIIIIIlllIII() {
        ...
        v.llIIllllllII[v.llIIllllllIl[1]] = v.lIIIIIIIIllIllI("AVn6BTDi4AM=", "dXOkW");
        v.llIIllllllII[v.llIIllllllIl[0]] = v.lIIIIIIIIllIlll("DT8dAio=", "IMtlA");
    }
    ...
    private boolean bv() {
        ...
        if (v.lIIIIIIIlIIIIII(NPCs.getAll(nPC -> e.ax.contains(nPC.getId())).size())) {
            ...
            "".length();
            if ("   ".length() < "   ".length()) {
                return ((0x1F ^ 0x20 ^ (0xAC ^ 0x86)) & (0x15 ^ 0x46 ^ (7 ^ 0x41) ^ -" ".length())) != 0;
            }
        } else {
            bl = llIIllllllIl[1];
        }
    ...
    public boolean be() {
        ...
        if (!v.lIIIIIIIIlllIll(Movement.getRunEnergy(), llIIllllllIl[2]) || v.lIIIIIIIIllllII(Skills.getBoostedLevel((Skill)Skill.PRAYER), llIIllllllIl[3])) {
            ...
            if (-(0x2E ^ 0x6D ^ (0xC2 ^ 0x85)) >= 0) {
                return ((168 + 47 - 64 + 57 ^ 126 + 118 - 147 + 34) & (8 ^ 0x39 ^ (0x22 ^ 0x40) ^ -" ".length())) != 0;
            }
        } else {
            n3 = llIIllllllIl[1];
        }
