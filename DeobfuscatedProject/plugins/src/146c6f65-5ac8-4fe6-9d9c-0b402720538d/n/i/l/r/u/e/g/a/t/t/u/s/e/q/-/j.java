...
public class j {
    ...
    private static void lIIIIIIlIIlIlll() {
        ...
        j.llIlIIIlIlII[5] = "   ".length();
        j.llIlIIIlIlII[6] = "  ".length();
    ...
    private static void lIIIIIIlIIlIllI() {
        ...
        j.llIlIIIlIIll[j.llIlIIIlIlII[0]] = j.lIIIIIIlIIlIlII("eiEJMiC0szs=", "bTTJN");
        j.llIlIIIlIIll[j.llIlIIIlIlII[1]] = j.lIIIIIIlIIlIlIl("2vzmDBQ9u9A=", "rIeDa");
    }
    ...
    public int aH() {
        ...
        if (!j.lIIIIIIlIIllIll(n3) || j.lIIIIIIlIIlllII(n3, llIlIIIlIlII[4])) {
            ...
            if ((0x83 ^ 0xAF ^ (0x91 ^ 0xB9)) == 0) {
                return (0x4E ^ 0xF ^ (0xF6 ^ 0x85)) & (150 + 233 - 311 + 169 ^ 8 + 35 - -104 + 48 ^ -" ".length());
            }
        } else {
