...
extends n {
    ...
    private static void lIIIIIIIlIIlIlI() {
        ...
        P.llIlIIIIIIlI[0] = " ".length();
        P.llIlIIIIIIlI[1] = (169 + 168 - 185 + 35 ^ 92 + 154 - 226 + 153) & (42 + 43 - -43 + 82 ^ 71 + 135 - 121 + 111 ^ -" ".length());
        P.llIlIIIIIIlI[2] = 0x78 ^ 0x7D;
        P.llIlIIIIIIlI[3] = "  ".length();
    }
    ...
    public boolean be() {
        ...
        if (P.lIIIIIIIlIIlllI(lllllllllllllllIlIIIlllIllIIIIIl = n3)) {
            ...
            if (-(0x4C ^ 0x24 ^ (0xED ^ 0x81)) >= 0) {
                return ((0xC0 ^ 0xA0 ^ (0x3F ^ 1)) & (0xDF ^ 0x95 ^ (0x8B ^ 0x9F) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIlIIIIIIlI[1];
        }
        if (P.lIIIIIIIlIIllll(lllllllllllllllIlIIIlllIllIIIIII = (NPC)NPCs.getAll((int[])e.as[n2]).stream().filter(nPC -> {
            ...
            if (P.lIIIIIIIlIIllII(nPC.isDead() ? 1 : 0)) {
                bl = llIlIIIIIIlI[0];
                "".length();
                if (((59 + 111 - 151 + 132 ^ 135 + 113 - 238 + 157) & (103 + 47 - -5 + 31 ^ 9 + 108 - 24 + 45 ^ -" ".length())) != 0) {
                    return ((0x60 ^ 9 ^ (0xC3 ^ 0xA3)) & (0x23 ^ 0x63 ^ (0xDF ^ 0x96) ^ -" ".length())) != 0;
                }
            } else {
                bl = llIlIIIIIIlI[1];
            }
    ...
    private static void lIIIIIIIlIIlIIl() {
        ...
        P.llIlIIIIIIIl[P.llIlIIIIIIlI[1]] = P.lIIIIIIIlIIlIII("1Bq3nSBQ+xs=", "bMAFK");
    }
