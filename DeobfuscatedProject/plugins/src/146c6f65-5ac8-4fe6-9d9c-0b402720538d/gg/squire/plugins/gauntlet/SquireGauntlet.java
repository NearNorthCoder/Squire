...
extends SquirePlugin {
    ...
    private static void llllllIlIIIIII() {
        ...
        SquireGauntlet.llIIllIIlIII[SquireGauntlet.llIIllIIlIIl[0]] = SquireGauntlet.llllllIIllllIl("JGXhxEYcPHnhixzUrD2bioThj6JsZCZ8LhayKveAaRQ=", "QIPHh");
        SquireGauntlet.llIIllIIlIII[SquireGauntlet.llIIllIIlIIl[3]] = SquireGauntlet.llllllIIlllllI("OwM19Sat+NN9bCzgofFpOQGxuFbkB6zV", "gPXTI");
        SquireGauntlet.llIIllIIlIII[SquireGauntlet.llIIllIIlIIl[4]] = SquireGauntlet.llllllIIlllllI("g2bZhtZwDPGKMfaP0mIqtsZnBL9lklzy", "kgoVJ");
        SquireGauntlet.llIIllIIlIII[SquireGauntlet.llIIllIIlIIl[6]] = SquireGauntlet.llllllIIllllll("Nz0PIAAhKxs8HDAgHz0=", "DLzIr");
        SquireGauntlet.llIIllIIlIII[SquireGauntlet.llIIllIIlIIl[7]] = SquireGauntlet.llllllIIllllIl("1bCgpFDvFldj8Yk7avcATA==", "ZuSlu");
        SquireGauntlet.llIIllIIlIII[SquireGauntlet.llIIllIIlIIl[1]] = SquireGauntlet.llllllIIllllll("CB0QIB0HFhQhDnMDPgAhczskATs2NCUcMDIuOBo9czIwBnM2IiEcITY+fVUgJzUhBTo9PXA=", "SZQuS");
    }
    ...
    private boolean f() {
        ...
        if (SquireGauntlet.llllllIlIIlllI(SquireGauntlet.llllllIlIIllII(lllllllllllllllIlIIlIllIllIIlIIl, lllllllllllllllIlIIlIllIllIIlIlI.b))) {
            bl = llIIllIIlIIl[3];
            "".length();
            if ("   ".length() == ((0xAD ^ 0xC6 ^ (0x61 ^ 0x5F)) & (203 + 209 - 332 + 166 ^ 72 + 70 - 9 + 30 ^ -" ".length()))) {
    ...
    private static void llllllIlIIIIIl() {
        ...
        SquireGauntlet.llIIllIIlIIl[3] = " ".length();
        SquireGauntlet.llIIllIIlIIl[4] = "  ".length();
        SquireGauntlet.llIIllIIlIIl[5] = 0x5D ^ 0x1E ^ (0x4F ^ 0x29);
        SquireGauntlet.llIIllIIlIIl[6] = "   ".length();
