...
extends Config {
    ...
    default public boolean safeBossFight() {
        return ((125 + 51 - 88 + 55 ^ 169 + 174 - 309 + 148) & (0x42 ^ 0x7D ^ (0x71 ^ 0x77) ^ -" ".length())) != 0;
    }
    ...
    default public boolean goHomeT3() {
        return ((149 + 20 - 163 + 243 ^ 38 + 131 - 128 + 129) & (189 + 135 - 287 + 201 ^ 80 + 4 - -30 + 75 ^ -" ".length())) != 0;
    }
    ...
    default public boolean showDebugOverlay() {
        return ((0x69 ^ 0x72 ^ (0x3C ^ 0x1B)) & (0xD4 ^ 0xAA ^ (0xEE ^ 0xAC) ^ -" ".length())) != 0;
    }
    ...
    default public boolean enableChatting() {
        return ((0x3E ^ 0x6E ^ (8 ^ 0x42)) & (0x3C ^ 0x46 ^ (0xD6 ^ 0xB6) ^ -" ".length())) != 0;
    }
    ...
    default public boolean corruptedMode() {
        return ((0xC8 ^ 0x81 ^ (0x92 ^ 0x82)) & (0x66 ^ 0x1B ^ (0x8E ^ 0xAA) ^ -" ".length())) != 0;
    }
    ...
    default public boolean makeT2Offhand() {
        return ((8 ^ 0x5D ^ (0x1D ^ 0x5D)) & (0x94 ^ 0xA9 ^ (0x34 ^ 0x1C) ^ -" ".length())) != 0;
    }
    ...
    default public int stopAtKc() {
        return ("  ".length() ^ (0x51 ^ 0x45)) & (0x40 ^ 0x73 ^ (0x54 ^ 0x71) ^ -" ".length());
    }
    ...
    default public String alching() {
        ...
        integerArray[(42 + 112 - 18 + 6 ^ 127 + 36 - 64 + 68) & (70 + 13 - 81 + 151 ^ 117 + 79 - 46 + 26 ^ -" ".length()) & ((0xA0 ^ 0xC2 ^ (0xD ^ 0x28)) & (0x2E ^ 0xD ^ (0xE1 ^ 0x85) ^ -" ".length()) ^ -" ".length())] = -(0xFFFFFDE7 & 0x3359) & (0xFFFFBFFB & 0x75FF);
        integerArray[" ".length()] = 0xFFFFD7DB & 0x2CAD;
        integerArray["  ".length()] = -(0xFFFFF87F & 0x17EA) & (0xFFFFDFFF & 0x35FF);
    ...
    default public String dropping() {
        ...
        integerArray[" ".length()] = 24 + 189 - 18 + 0;
        integerArray["  ".length()] = -(0xFFFFF69F & 0xD69) & (0xFFFF8DDE & Short.MAX_VALUE);
