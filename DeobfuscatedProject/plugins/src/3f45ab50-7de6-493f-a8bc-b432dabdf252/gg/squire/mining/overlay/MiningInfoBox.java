...
extends OverlayPanel {
    ...
    private static void lIIlIIlllIIllII() {
        ...
        MiningInfoBox.lllllIlIlIIl[MiningInfoBox.lllllIllIIll[0]] = MiningInfoBox.lIIlIIllIlIlIll("GishLB4sehksAiwo", "IZTEl");
        MiningInfoBox.lllllIlIlIIl[MiningInfoBox.lllllIllIIll[1]] = MiningInfoBox.lIIlIIllIlIllII("UDEjFL/7twA=", "yJEZn");
        MiningInfoBox.lllllIlIlIIl[MiningInfoBox.lllllIllIIll[2]] = MiningInfoBox.lIIlIIllIlIlIll("JzYzHi8ePQ==", "qSAmF");
        MiningInfoBox.lllllIlIlIIl[MiningInfoBox.lllllIllIIll[3]] = MiningInfoBox.lIIlIIllIlIllIl("Q8gMUu5TLV8=", "OKijU");
        MiningInfoBox.lllllIlIlIIl[MiningInfoBox.lllllIllIIll[4]] = MiningInfoBox.lIIlIIllIlIllII("HB+IxjNbsgA=", "KizxD");
        MiningInfoBox.lllllIlIlIIl[MiningInfoBox.lllllIllIIll[7]] = MiningInfoBox.lIIlIIllIlIllII("adzXfFD8Y9/nAE5J42Ywfw==", "eprmp");
        MiningInfoBox.lllllIlIlIIl[MiningInfoBox.lllllIllIIll[8]] = MiningInfoBox.lIIlIIllIlIlIll("XS1GD1FdLUYPUV0t", "xIfsq");
        MiningInfoBox.lllllIlIlIIl[MiningInfoBox.lllllIllIIll[9]] = MiningInfoBox.lIIlIIllIlIlIll("CTsxDVcpMygDTXo=", "ZZRfw");
        MiningInfoBox.lllllIlIlIIl[MiningInfoBox.lllllIllIIll[10]] = MiningInfoBox.lIIlIIllIlIllIl("U38Q5d2VavJQ/rokXXKWTA==", "tpYHq");
        MiningInfoBox.lllllIlIlIIl[MiningInfoBox.lllllIllIIll[11]] = MiningInfoBox.lIIlIIllIlIlIll("AhkCIA8=", "OplEk");
        MiningInfoBox.lllllIlIlIIl[MiningInfoBox.lllllIllIIll[12]] = MiningInfoBox.lIIlIIllIlIlIll("HzovDTA=", "RSAhT");
        MiningInfoBox.lllllIlIlIIl[MiningInfoBox.lllllIllIIll[13]] = MiningInfoBox.lIIlIIllIlIllII("9K7KGyNSpPI0FKLXaBLQUg==", "aNPDW");
    }
    ...
    private static void lIIlIIlllIIllIl() {
        ...
        MiningInfoBox.lllllIllIIll[1] = " ".length();
        MiningInfoBox.lllllIllIIll[2] = "  ".length();
        MiningInfoBox.lllllIllIIll[3] = "   ".length();
