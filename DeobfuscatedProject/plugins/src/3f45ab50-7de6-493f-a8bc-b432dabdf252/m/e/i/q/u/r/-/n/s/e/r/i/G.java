...
extends C {
    ...
    private static void lIIlIIllIIlIlll() {
        ...
        G.lllllIlIIIll[G.lllllIlIlIII[1]] = G.lIIlIIllIIlIllI("BfPSa4esAjE=", "zxjZp");
    }
    ...
    private static void lIIlIIllIlIIlll() {
        ...
        G.lllllIlIlIII[1] = (0x6E ^ 0x53 ^ (0xA8 ^ 0xB8)) & (133 + 39 - 148 + 146 ^ 134 + 128 - 209 + 82 ^ -" ".length());
        G.lllllIlIlIII[2] = -(0xFFFFDF33 & 0x24FF) & (0xFFFFDDF7 & 0x27FF);
        G.lllllIlIlIII[3] = " ".length();
        G.lllllIlIlIII[4] = 0xFFFFAFEC & 0x7EFF;
        G.lllllIlIlIII[5] = "  ".length();
        G.lllllIlIlIII[6] = 0xFFFFE5BF & 0x1BFC;
        G.lllllIlIlIII[7] = "   ".length();
