...
extends Task {
    ...
    public boolean o() {
        ...
        block3: {
            ...
            n2 = lllllIIIllll[3];
            "".length();
            if (" ".length() != (0x9A ^ 0x80 ^ (0xB5 ^ 0xAB))) return n2 != 0;
            return ((49 + 36 - 5 + 138 ^ 127 + 99 - 150 + 72) & (102 + 194 - 258 + 172 ^ 98 + 82 - 48 + 24 ^ -" ".length())) != 0;
        }
        n2 = lllllIIIllll[0];
        return n2 != 0;
    }
    ...
    public boolean run() {
        k lllllllllllllllIIlIIllIIlIIlIlIl;
        ...
        Player lllllllllllllllIIlIIllIIlIIlIlII = Players.getLocal();
        if (k.lIIlIIlIlIIlIlI((Object)lllllllllllllllIIlIIllIIlIIlIlIl.t.activity(), (Object)a.MOTHERLODE_MINE) && k.lIIlIIlIlIIlIll(lllllllllllllllIIlIIllIIlIIlIlIl.u.a(lllllllllllllllIIlIIllIIlIIlIlIl.t.mlmArea()).distanceTo((Locatable)lllllllllllllllIIlIIllIIlIIlIlII), lllllIIIllll[2])) {
            return lllllIIIllll[0];
        }
        Combat.toggleSpec();
    ...
    private static void lIIlIIlIlIIIllI() {
        ...
        k.lllllIIIllll[0] = (0xC3 ^ 0x98 ^ (0xB ^ 0x54)) & (76 + 26 - 86 + 131 ^ 47 + 66 - 15 + 53 ^ -" ".length());
        k.lllllIIIllll[1] = 0xDD ^ 0xB9;
        k.lllllIIIllll[2] = 0x72 ^ 0x77;
        k.lllllIIIllll[3] = " ".length();
