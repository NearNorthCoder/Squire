...
extends Enum<i> {
    ...
    private static void lIIlIlIIIIIllIl() {
        ...
        i.lllllIlllllI[i.lllllIllllll[0]] = i.lIIlIlIIIIIllII("AzeK5fR9YsW99Vvr0VGtbQ==", "qrDBL");
    }

    private static void lIIlIlIIIIIlllI() {
        lllllIllllll = new int[5];
        i.lllllIllllll[0] = (93 + 191 - 211 + 180 ^ 16 + 176 - 30 + 15) & (230 + 115 - 246 + 139 ^ 6 + 81 - 62 + 137 ^ -" ".length());
        i.lllllIllllll[1] = 0xFFFFDFBF & 0x2CDD;
        i.lllllIllllll[2] = 0xFFFFAE4F & 0x5DFB;
        i.lllllIllllll[3] = " ".length();
        i.lllllIllllll[4] = "  ".length();
    }
