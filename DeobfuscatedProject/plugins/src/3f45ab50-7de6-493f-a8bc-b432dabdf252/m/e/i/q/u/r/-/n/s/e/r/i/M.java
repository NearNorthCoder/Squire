...
extends Task {
    ...
    public boolean run() {
        ...
        Player lllllllllllllllIIlIIlIIllllIllIl = Players.getNearest(player -> {
            ...
            if (M.lIIlIIlllIIIlIl(player, Players.getLocal()) && M.lIIlIIlllIIIIll(this.b(player.getAnimation()) ? 1 : 0)) {
                n2 = lllllIllIIII[1];
                "".length();
                if ((0x26 ^ 0x2C ^ (0x28 ^ 0x26)) == ((0x7B ^ 0x39 ^ (0x77 ^ 5)) & (35 + 58 - 78 + 116 ^ 120 + 34 - 91 + 116 ^ -" ".length()))) {
                    return ((18 + 99 - 107 + 129 ^ 6 + 17 - -3 + 172) & (60 + 118 - 124 + 167 ^ 127 + 142 - 130 + 5 ^ -" ".length())) != 0;
                }
            } else {
                n2 = lllllIllIIII[0];
            }
    ...
    private static void lIIlIIlllIIIIIl() {
        ...
        M.lllllIllIIII[0] = (18 + 66 - 61 + 112 ^ 95 + 144 - 74 + 2) & (82 + 109 - 146 + 140 ^ 55 + 131 - 38 + 5 ^ -" ".length());
        M.lllllIllIIII[1] = " ".length();
        M.lllllIllIIII[2] = 9 ^ 0x49 ^ (0x4D ^ 9);
        M.lllllIllIIII[3] = "  ".length();
    }
    ...
    private static void lIIlIIlllIIIIII() {
        ...
        M.lllllIlIllll[M.lllllIllIIII[0]] = M.lIIlIIllIllllll("05dtB6OG4U4=", "nQGDm");
    }
}
