...
extends Task {
    ...
    private static void lIIlIlIIllIllII() {
        ...
        o.llllllIlllII[2] = " ".length();
        o.llllllIlllII[3] = "  ".length();
        o.llllllIlllII[4] = "   ".length();
    ...
    private static void lIIlIlIIllIlIll() {
        ...
        o.llllllIllIll[o.llllllIlllII[0]] = o.lIIlIlIIllIlIIl("OSQG", "lWcpm");
        o.llllllIllIll[o.llllllIlllII[2]] = o.lIIlIlIIllIlIlI("qQGS4I56Ssk=", "aVkyJ");
        o.llllllIllIll[o.llllllIlllII[3]] = o.lIIlIlIIllIlIlI("jDPAN+2gcOg=", "BIDQk");
    }
