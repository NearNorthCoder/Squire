...
extends Task {
    ...
    private static void lIIlIlIIlIIlIlI() {
        ...
        r.llllllIlIlII[1] = ("   ".length() ^ (2 ^ 9)) & (93 + 128 - 171 + 105 ^ 139 + 41 - 93 + 60 ^ -" ".length());
        r.llllllIlIlII[2] = 223 + 121 - 101 + 6;
        r.llllllIlIlII[3] = " ".length();
        r.llllllIlIlII[4] = 121 + 66 - 10 + 74;
        r.llllllIlIlII[5] = "  ".length();
        r.llllllIlIlII[6] = 204 + 54 - 109 + 104;
        r.llllllIlIlII[7] = "   ".length();
        ...
        r.llllllIlIlII[11] = -"  ".length() & (0xFFFFBBBD & 0x5CFF);
    ...
    private static void lIIlIlIIlIIlIIl() {
        ...
        r.llllllIlIIll[r.llllllIlIlII[1]] = r.lIIlIlIIlIIIlll("PSIGMw==", "pKhVQ");
        r.llllllIlIIll[r.llllllIlIlII[3]] = r.lIIlIlIIlIIlIII("ID8DdQ6wARY=", "uMLLG");
    }
    ...
    public boolean run() {
        ...
        TileObject lllllllllllllllIIlIIIllIlIIlllIl = TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIlIlIIlIIllll(tileObject.getId(), llllllIlIlII[14]) && r.lIIlIlIIlIlIIII(tileObject.getWorldX(), llllllIlIlII[15])) {
                ...
                "".length();
                if ("   ".length() <= "  ".length()) {
                    return ((0x6E ^ 0x25 ^ (3 ^ 0x77)) & (0x33 ^ 0x53 ^ (7 ^ 0x58) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llllllIlIlII[1];
            }
