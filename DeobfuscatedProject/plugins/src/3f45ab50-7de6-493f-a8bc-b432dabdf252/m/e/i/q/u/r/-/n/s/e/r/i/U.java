...
public class U {
    ...
    private static void lIIlIlIIIllIllI() {
        ...
        U.llllllIIllIl[1] = " ".length();
        U.llllllIIllIl[2] = -" ".length();
    }
    ...
    public void e(TileObject tileObject) {
        ...
        if (U.lIIlIlIIIlllIlI(tileObject)) {
            ...
            void lllllllllllllllIIlIIIllIlllIlllI;
            lllllllllllllllIIlIIIllIlllIllll.aH = lllllllllllllllIIlIIIllIlllIlllI.getWorldLocation();
            lllllllllllllllIIlIIIllIlllIllll.aI = lllllllllllllllIIlIIIllIlllIlllI.getId();
        }
    }
    ...
    private boolean d(TileObject tileObject) {
        ...
        if (U.lIIlIlIIIlllIIl(tileObject.getId(), this.aI) && U.lIIlIlIIIlllIII(tileObject.getWorldLocation().equals((Object)this.aH) ? 1 : 0)) {
            n2 = llllllIIllIl[1];
            "".length();
            if (((0x94 ^ 0xAB ^ (0xF0 ^ 0xAD)) & (43 + 109 - 32 + 7 ^ (0xA8 ^ 0xB5) ^ -" ".length())) < 0) {
                return ((226 + 140 - 258 + 136 ^ 95 + 32 - -59 + 6) & (0x10 ^ 0x74 ^ (0xF8 ^ 0xA8) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llllllIIllIl[0];
        }
