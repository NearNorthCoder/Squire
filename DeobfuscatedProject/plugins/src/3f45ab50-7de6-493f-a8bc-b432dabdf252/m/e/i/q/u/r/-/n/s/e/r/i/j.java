...
extends Task {
    ...
    private boolean n() {
        ...
        block4: {
            ...
            n2 = lllllIlIllII[3];
            "".length();
            if (((96 + 88 - 152 + 103 ^ 68 + 120 - 60 + 11) & (0xAE ^ 0x83 ^ (0xB4 ^ 0x95) ^ -" ".length())) == 0) return n2 != 0;
            return ((0x86 ^ 0xBB ^ (0x97 ^ 0xA1)) & (0xA ^ 6 ^ (0x13 ^ 0x14) ^ -" ".length())) != 0;
        }
        n2 = lllllIlIllII[1];
        return n2 != 0;
    }
    ...
    public boolean run() {
        j lllllllllllllllIIlIIlIlIIllIlIII;
        block11: {
            block10: {
                if (j.lIIlIIllIllIIll(Game.getState(), GameState.LOGGED_IN)) {
                    return lllllIlIllII[1];
                }
                if (j.lIIlIIllIllIIll((Object)lllllllllllllllIIlIIlIlIIllIlIII.q.activity(), (Object)a.GRANITE) && j.lIIlIIllIllIIll((Object)lllllllllllllllIIlIIlIlIIllIlIII.q.activity(), (Object)a.SANDSTONE)) {
                    return lllllIlIllII[1];
                }
                if (!j.lIIlIIllIllIlII(lllllllllllllllIIlIIlIlIIllIlIII.q.waterskins())) break block10;
                int[] nArray = new int[lllllIlIllII[3]];
        ...
        if (j.lIIlIIllIllIlIl(lllllllllllllllIIlIIlIlIIllIlIII.n() ? 1 : 0)) {
            System.out.println(lllllIlIlIll[lllllIlIllII[1]]);
            return lllllIlIllII[1];
        }
        if (j.lIIlIIllIllIlII(lllllllllllllllIIlIIlIlIIllIlIII.q.humidify() ? 1 : 0) && j.lIIlIIllIllIlIl(Magic.canCast((Spell)SpellBook.Lunar.HUMIDIFY) ? 1 : 0)) {
            System.out.println(lllllIlIlIll[lllllIlIllII[3]]);
            Game.logout();
            return lllllIlIllII[3];
        }
        if (j.lIIlIIllIllIlIl(lllllllllllllllIIlIIlIlIIllIlIII.q.humidify() ? 1 : 0)) {
            int[] nArray = new int[lllllIlIllII[3]];
    ...
    private static String lIIlIIllIlIllll(String lllllllllllllllIIlIIlIlIIlIllllI, String lllllllllllllllIIlIIlIlIIlIlllIl) {
        try {
            SecretKeySpec lllllllllllllllIIlIIlIlIIllIIIIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIlIIlIlIIlIlllIl.getBytes(StandardCharsets.UTF_8)), lllllIlIllII[20]), "DES");
            Cipher lllllllllllllllIIlIIlIlIIllIIIII = Cipher.getInstance("DES");
            lllllllllllllllIIlIIlIlIIllIIIII.init(lllllIlIllII[5], lllllllllllllllIIlIIlIlIIllIIIIl);
            return new String(lllllllllllllllIIlIIlIlIIllIIIII.doFinal(Base64.getDecoder().decode(lllllllllllllllIIlIIlIlIIlIllllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIIlIIllIllIIII(String lllllllllllllllIIlIIlIlIIlIlIIIl, String lllllllllllllllIIlIIlIlIIlIIlllI) {
        try {
            SecretKeySpec lllllllllllllllIIlIIlIlIIlIlIlII = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIlIIlIlIIlIIlllI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIIlIIlIlIIlIlIIll = Cipher.getInstance("Blowfish");
            lllllllllllllllIIlIIlIlIIlIlIIll.init(lllllIlIllII[5], lllllllllllllllIIlIIlIlIIlIlIlII);
    ...
    private static void lIIlIIllIllIIIl() {
        ...
        j.lllllIlIlIll[j.lllllIlIllII[1]] = j.lIIlIIllIlIllll("dscArUnxuVu4uY9q/bUSs24KmMf65OsXYPi7KC6gMUapbrCwaqpaSg==", "YbsxO");
        j.lllllIlIlIll[j.lllllIlIllII[3]] = j.lIIlIIllIllIIII("26mUL9tjeLJhBf5oApObVAhihGkWvDGiN008hxC4uSSESgcOWv+c1Ko34uD2cMMd", "WRapT");
        j.lllllIlIlIll[j.lllllIlIllII[5]] = j.lIIlIIllIllIIII("a4uUzxMmq8DQmTAQ5ErL3y77p+JQ42SarUTsEjN7xP6bNNlt5qvhJeVOnZ6TN5s5sp6ZDHrdaVj/8t1z6De10g==", "dEYEm");
    }
}
