...
extends S {
    ...
    private static void lIIlIlIIIlIlIIl() {
        ...
        Q.llllllIIlIIl[0] = (0x5F ^ 0x18 ^ (0xD5 ^ 0x96)) & (33 + 129 - 32 + 2 ^ 46 + 64 - 100 + 118 ^ -" ".length());
        Q.llllllIIlIIl[1] = " ".length();
    }
    ...
    public boolean t() {
        ...
        SpellBook.Lunar lllllllllllllllIIlIIIlllIIlllIIl = SpellBook.Lunar.HUMIDIFY;
        if (Q.lIIlIlIIIlIlIlI(lllllllllllllllIIlIIIlllIIlllIIl.canCast() ? 1 : 0)) {
            return llllllIIlIIl[0];
        }
