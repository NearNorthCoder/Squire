...
extends Task {
    ...
    private static void lIIlIIllllIIlll() {
        ...
        C.lllllIlllIIl[0] = (0x62 ^ 0x2C ^ (0xB1 ^ 0xBE)) & (0x39 ^ 0x7D ^ (0x46 ^ 0x43) ^ -" ".length());
        C.lllllIlllIIl[1] = 0xFFFFCFAF & 0x3EFB;
        C.lllllIlllIIl[2] = -(0xFFFFE58F & 0x7A73) & (0xFFFFF66E & 0x7FBF);
        C.lllllIlllIIl[3] = " ".length();
    ...
    public boolean run() {
        C lllllllllllllllIIlIIlIIIlllIIllI;
        if (C.lIIlIIllllIlIII((Object)this.X.activity(), (Object)a.MOTHERLODE_MINE)) {
            return lllllIlllIIl[0];
        }
        if (C.lIIlIIllllIlIIl(lllllllllllllllIIlIIlIIIlllIIllI.Z.K() ? 1 : 0)) {
            return lllllIlllIIl[0];
        }
        return this.t();
    }
    ...
    protected TileObject x() {
        C lllllllllllllllIIlIIlIIIlllIIlII;
        if (C.lIIlIIllllIlIlI(this.Z.E())) {
            return this.w();
        }
        if (C.lIIlIIllllIlIll(lllllllllllllllIIlIIlIIIlllIIlII.X.depositUpstairs() ? 1 : 0)) {
            return lllllllllllllllIIlIIlIIIlllIIlII.v();
        }
        return this.w();
    }
