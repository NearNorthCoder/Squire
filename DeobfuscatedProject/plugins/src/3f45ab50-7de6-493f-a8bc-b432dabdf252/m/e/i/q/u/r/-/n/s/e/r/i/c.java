...
extends Enum<c> {
    ...
    private static void lIIlIIlIlIllllI() {
        ...
        c.lllllIIlIlII[8] = "  ".length();
        c.lllllIIlIlII[9] = "   ".length();
    ...
    private static String lIIlIIlIlIlllII(String lllllllllllllllIIlIIllIIIIIIllII, String lllllllllllllllIIlIIllIIIIIIlIll) {
        try {
            SecretKeySpec lllllllllllllllIIlIIllIIIIIlIIIl = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIlIIllIIIIIIlIll.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            return new String(lllllllllllllllIIlIIllIIIIIlIIII.doFinal(Base64.getDecoder().decode(lllllllllllllllIIlIIllIIIIIIllII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIIlIIlIlIlllIl() {
        ...
        c.lllllIIlIIll[c.lllllIIlIlII[0]] = c.lIIlIIlIlIlllII("D5IBcEpwUvK6MnDwJOQZsg==", "aGFOq");
    }
    ...
    public boolean a(WorldPoint worldPoint) {
        void lllllllllllllllIIlIIllIIIIIllIII;
        WorldPoint[] worldPointArray = this.rocks;
        int n2 = worldPointArray.length;
        int lllllllllllllllIIlIIllIIIIIlIlll = lllllIIlIlII[0];
        while (c.lIIlIIlIlIlllll(lllllllllllllllIIlIIllIIIIIlIlll, (int)lllllllllllllllIIlIIllIIIIIllIII)) {
            void lllllllllllllllIIlIIllIIIIIllIlI;
            void lllllllllllllllIIlIIllIIIIIllIIl;
            void lllllllllllllllIIlIIllIIIIIlIllI = lllllllllllllllIIlIIllIIIIIllIIl[lllllllllllllllIIlIIllIIIIIlIlll];
            if (c.lIIlIIlIllIIIII(lllllllllllllllIIlIIllIIIIIlIllI.equals((Object)lllllllllllllllIIlIIllIIIIIllIlI) ? 1 : 0)) {
                return lllllIIlIlII[1];
            }
            ++lllllllllllllllIIlIIllIIIIIlIlll;
            "".length();
