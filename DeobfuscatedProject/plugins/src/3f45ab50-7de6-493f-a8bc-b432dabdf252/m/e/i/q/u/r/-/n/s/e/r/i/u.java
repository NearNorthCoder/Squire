...
extends Task {
    ...
    private static void lIIlIIlIlIllIll() {
        ...
        u.lllllIIlIIlI[u.lllllIlIIlII[0]] = u.lIIlIIlIlIllIlI("HgAEJCkWDA==", "nigOH");
    }

    private static void lIIlIIllIIllIII() {
        lllllIlIIlII = new int[2];
        u.lllllIlIIlII[0] = (114 + 55 - 31 + 68 ^ 36 + 29 - -7 + 56) & (0x92 ^ 0x96 ^ (0x5F ^ 0x15) ^ -" ".length());
        u.lllllIlIIlII[1] = " ".length();
    }
    ...
    public boolean run() {
        ...
        while (u.lIIlIIllIIlllII(lllllllllllllllIIlIIlIlIllIllIII.hasNext() ? 1 : 0)) {
            ...
            if (u.lIIlIIllIIlllII(lllllllllllllllIIlIIlIlIllIllIIl.contains(lllllllllllllllIIlIIlIlIllIlIlll) ? 1 : 0)) {
                ...
                return ((8 ^ 0x3F ^ (0x78 ^ 0xA)) & (197 + 127 - 216 + 98 ^ 80 + 94 - 137 + 102 ^ -" ".length())) != 0;
            }
            ...
            "".length();
            if ((0x70 ^ 0x53 ^ (0x80 ^ 0xA7)) != -" ".length()) continue;
            return ((81 + 109 - 48 + 15 ^ 10 + 100 - -7 + 29) & (0xCC ^ 0xC3 ^ (0x5C ^ 0x5A) & ~(0x30 ^ 0x36) ^ -" ".length())) != 0;
        }
        return lllllIlIIlII[1];
    }
}
