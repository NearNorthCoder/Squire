...
extends Task {
    ...
    private static void lIIlIIllIIIIIII() {
        ...
        t.lllllIIlllIl[t.lllllIIllllI[0]] = t.lIIlIIlIllllllI("xUBHJ4CynH0=", "duCxJ");
        t.lllllIIlllIl[t.lllllIIllllI[3]] = t.lIIlIIlIlllllll("GRUyBRc=", "MgSar");
        t.lllllIIlllIl[t.lllllIIllllI[5]] = t.lIIlIIlIllllllI("sE+YqPO7wBw=", "cDiNn");
    }

    private static void lIIlIIllIIIIIIl() {
        lllllIIllllI = new int[15];
        t.lllllIIllllI[0] = (0xBC ^ 0xA9 ^ (0xB9 ^ 0xB6)) & (56 + 46 - -54 + 34 ^ 91 + 23 - 112 + 162 ^ -" ".length());
        t.lllllIIllllI[1] = 0xA ^ 0xE;
        t.lllllIIllllI[2] = 0xFFFF8FDF & 0x773F;
        t.lllllIIllllI[3] = " ".length();
        t.lllllIIllllI[4] = 0xFFFFC7F1 & 0x3F2F;
        t.lllllIIllllI[5] = "  ".length();
        t.lllllIIllllI[6] = 0xFFFFAF7F & 0x57A3;
        t.lllllIIllllI[7] = "   ".length();
