...
extends Task {
    ...
    public boolean run() {
        S lllllllllllllllIIlIIlIlIllllIIIl;
        ...
        if (S.lIIlIIllIIlIIll(lllllllllllllllIIlIIlIlIllllIIIl.au.waterskins())) {
            return lllllIlIIIlI[1];
        }
        ...
        if (S.lIIlIIllIIlIlIl(lllllllllllllllIIlIIlIlIllllIIIl.y()) && S.lIIlIIllIIlIlII(lllllllllllllllIIlIIlIlIllllIIIl.z() ? 1 : 0)) {
            return lllllIlIIIlI[1];
        }
        return this.t();
    }
    ...
    protected boolean z() {
        ...
        if (!S.lIIlIIllIIlIIII(worldPoint.getX(), lllllIlIIIlI[9]) || S.lIIlIIllIIlIIIl(worldPoint.getY(), lllllIlIIIlI[10])) {
            bl = lllllIlIIIlI[3];
            "".length();
            if (((72 + 198 - 192 + 128 ^ 112 + 73 - 65 + 77) & (0x78 ^ 0x21 ^ (0xEE ^ 0xBC) ^ -" ".length())) >= " ".length()) {
                return ((26 + 24 - -37 + 66 ^ 37 + 6 - -104 + 4) & (0x1F ^ 0xD ^ (0xD ^ 0x11) ^ -" ".length())) != 0;
            }
        } else {
            bl = lllllIlIIIlI[1];
        }
