...
extends Enum<a> {
    ...
    private static void lIIlIIlIlllIlII() {
        ...
        a.lllllIIllIlI[0] = (73 + 118 - 79 + 84 ^ 2 + 34 - -61 + 46) & (0x57 ^ 0x23 ^ (0x9E ^ 0xA1) ^ -" ".length());
        a.lllllIIllIlI[1] = " ".length();
        a.lllllIIllIlI[2] = "  ".length();
        a.lllllIIllIlI[3] = "   ".length();
        ...
        a.lllllIIllIlI[9] = "  ".length() ^ (0x1D ^ 0x16);
    ...
    private static void lIIlIIlIlllIIll() {
        ...
        a.lllllIIllIIl[a.lllllIIllIlI[0]] = a.lIIlIIlIlllIIII("OAgtGQ4nCzYVDioKMB8O", "uGyQK");
        a.lllllIIllIIl[a.lllllIIllIlI[1]] = a.lIIlIIlIlllIIII("BC0jES47LjgdLhYPPhcu", "IBWyK");
        a.lllllIIllIIl[a.lllllIIllIlI[2]] = a.lIIlIIlIlllIIII("PxsLKAA4FQsp", "lZElS");
        a.lllllIIllIIl[a.lllllIIllIlI[3]] = a.lIIlIIlIlllIIIl("1OSSPDAaTBSzuOTxeaVCcg==", "DTvdo");
        a.lllllIIllIIl[a.lllllIIllIlI[4]] = a.lIIlIIlIlllIIIl("cRIr+bkFEgx3hD76UNNWVw==", "VrqWT");
        a.lllllIIllIIl[a.lllllIIllIlI[5]] = a.lIIlIIlIlllIIII("Iz8GaBULOQA7", "dZkHg");
        a.lllllIIllIIl[a.lllllIIllIlI[6]] = a.lIIlIIlIlllIIII("Bj8TFiweIwgVJg==", "AjZZh");
        a.lllllIIllIIl[a.lllllIIllIlI[7]] = a.lIIlIIlIlllIIlI("vbtzGz5Q+/6LPX3NlyjVsA==", "NsOqy");
        a.lllllIIllIIl[a.lllllIIllIlI[8]] = a.lIIlIIlIlllIIII("DwMJHgwHAwIJ", "NQMGS");
        a.lllllIIllIIl[a.lllllIIllIlI[9]] = a.lIIlIIlIlllIIlI("pEKe9Jydlv6mZdhV7XIxGA==", "FoQxy");
        a.lllllIIllIIl[a.lllllIIllIlI[10]] = a.lIIlIIlIlllIIII("KD4GCx87KQ==", "olGEV");
        a.lllllIIllIIl[a.lllllIIllIlI[11]] = a.lIIlIIlIlllIIII("NyooBwsEPQ==", "pXIib");
        a.lllllIIllIIl[a.lllllIIllIlI[12]] = a.lIIlIIlIlllIIIl("P/7xtemYXA/VtBVoRuJEGw==", "IZvAg");
        a.lllllIIllIIl[a.lllllIIllIlI[13]] = a.lIIlIIlIlllIIlI("FWbGQaydVH47LcX2FYBlZQ==", "RgBbo");
        a.lllllIIllIIl[a.lllllIIllIlI[14]] = a.lIIlIIlIlllIIIl("iRCqwFP0Bq1Re/1EycZXDg==", "xqUEH");
        a.lllllIIllIIl[a.lllllIIllIlI[15]] = a.lIIlIIlIlllIIlI("s/pzhU1In17uYXEQ6pUmfA==", "vSDYz");
        a.lllllIIllIIl[a.lllllIIllIlI[16]] = a.lIIlIIlIlllIIII("Nz8JCAssLxgZBikjFwg=", "djYMY");
        a.lllllIIllIIl[a.lllllIIllIlI[17]] = a.lIIlIIlIlllIIIl("aNhAl+bZm80nnaCtgxa/Ig==", "IBSWh");
        a.lllllIIllIIl[a.lllllIIllIlI[18]] = a.lIIlIIlIlllIIIl("N0PYeft6Fp4=", "kgxpq");
        a.lllllIIllIIl[a.lllllIIllIlI[19]] = a.lIIlIIlIlllIIlI("zFvj3VZzYh33uhOH5pNE+g==", "syBrQ");
        a.lllllIIllIIl[a.lllllIIllIlI[20]] = a.lIIlIIlIlllIIlI("5Sdw0LYRtbM=", "PmCZo");
        a.lllllIIllIIl[a.lllllIIllIlI[21]] = a.lIIlIIlIlllIIIl("PNWgPbtM2iZMLnrk1Zvy9g==", "gKtiW");
        a.lllllIIllIIl[a.lllllIIllIlI[22]] = a.lIIlIIlIlllIIlI("x3m16YqNGG4n7t8mPNM9cQ==", "HqxnS");
        a.lllllIIllIIl[a.lllllIIllIlI[23]] = a.lIIlIIlIlllIIlI("41+oVcOwQJbk8O5qH8dffA==", "plaIE");
    }
