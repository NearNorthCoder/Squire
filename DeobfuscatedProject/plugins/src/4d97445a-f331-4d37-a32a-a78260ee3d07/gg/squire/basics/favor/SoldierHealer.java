...
extends SquirePlugin {
    ...
    private static void llIIlIIllIl() {
        lllIlIllI = new int[7];
        SoldierHealer.lllIlIllI[0] = " ".length();
        SoldierHealer.lllIlIllI[1] = (0x1D ^ 0x4D) & ~(0x6A ^ 0x3A);
        SoldierHealer.lllIlIllI[2] = "  ".length();
        SoldierHealer.lllIlIllI[3] = "   ".length();
    ...
    private static void llIIlIIllII() {
        ...
        SoldierHealer.lllIlIlIl[SoldierHealer.lllIlIllI[1]] = SoldierHealer.llIIlIIlIlI("KxwyLhgRET13Dx0QIzYBEw==", "xtSWb");
        SoldierHealer.lllIlIlIl[SoldierHealer.lllIlIllI[0]] = SoldierHealer.llIIlIIlIlI("HSU5H2IkN3oaNyEo", "MDZtB");
        SoldierHealer.lllIlIlIl[SoldierHealer.lllIlIllI[2]] = SoldierHealer.llIIlIIlIll("USXU649jKXUDXiorgYpwCw==", "hWdFS");
        SoldierHealer.lllIlIlIl[SoldierHealer.lllIlIllI[3]] = SoldierHealer.llIIlIIlIlI("GBITJ0ghEhY7", "LsxBe");
        SoldierHealer.lllIlIlIl[SoldierHealer.lllIlIllI[4]] = SoldierHealer.llIIlIIlIll("KQ7LQ8m9djmS3paJX9cLgw==", "HaoRM");
    }
    ...
    private static String llIIlIIlIlI(String lIlIlIIlllllIIl, String lIlIlIIllllIIll) {
        ...
        while (SoldierHealer.llIIlIlIIll(lIlIlIIlllIllIl, lIlIlIIlllIlllI)) {
            ...
            ++lIlIlIIlllIllIl;
            "".length();
            if (-" ".length() < ((0x6A ^ 0x76) & ~(0x36 ^ 0x2A))) continue;
            return null;
        }
