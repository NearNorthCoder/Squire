...
extends SquirePlugin {
    ...
    private static void lIllIIIIl() {
        ...
        SandWorms.lIllIII[5] = "  ".length();
        SandWorms.lIllIII[6] = "   ".length();
    ...
    private static void lIllIIIII() {
        ...
        SandWorms.lIlIlll[SandWorms.lIllIII[1]] = SandWorms.lIlIlllIl("A4hS+paTn14BKjrhoBy9N2dZKWHEjAt4", "PKVAN");
        SandWorms.lIlIlll[SandWorms.lIllIII[0]] = SandWorms.lIlIlllIl("Nntsk+0BgjM=", "evjaQ");
        SandWorms.lIlIlll[SandWorms.lIllIII[5]] = SandWorms.lIlIlllIl("I/ymyuEeyRU=", "qfPoO");
        SandWorms.lIlIlll[SandWorms.lIllIII[6]] = SandWorms.lIlIllllI("GS4bBlQ5IA==", "MOwmy");
        SandWorms.lIlIlll[SandWorms.lIllIII[9]] = SandWorms.lIlIlllll("FQSNhoqLMY4=", "ddIeq");
        SandWorms.lIlIlll[SandWorms.lIllIII[10]] = SandWorms.lIlIlllll("c+OQkTfuGvk=", "rPjuw");
    }
}
