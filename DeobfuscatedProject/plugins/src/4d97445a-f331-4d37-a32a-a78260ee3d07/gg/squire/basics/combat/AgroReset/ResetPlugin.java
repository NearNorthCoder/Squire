...
extends SquirePlugin {
    ...
    private static void lIlIIlIIlIl() {
        lIllllllI = new int[5];
        ResetPlugin.lIllllllI[0] = " ".length();
        ResetPlugin.lIllllllI[1] = (4 ^ 0x2B) & ~(0xE9 ^ 0xC6);
        ResetPlugin.lIllllllI[2] = "  ".length();
    ...
    private long[] ad() {
        ...
        while (ResetPlugin.lIlIIlIllIl(lIlllIIlllIIllI, ((void)lIlllIIlllIlIII).length)) {
            ...
            ++lIlllIIlllIIllI;
            "".length();
            if (" ".length() > ((204 + 110 - 102 + 38 ^ 149 + 28 - 81 + 73) & (134 + 239 - 174 + 52 ^ 94 + 108 - 95 + 61 ^ -" ".length()))) continue;
            return null;
        }
        ...
        List list = Tiles.getAll(tile -> {
            ...
            if (ResetPlugin.lIlIIlIIllI(Reachable.isObstacle((WorldPoint)tile.getWorldLocation()) ? 1 : 0) && ResetPlugin.lIlIIlIlIIl(Stream.of(worldPointArray).noneMatch(worldPoint -> {
                ...
                if (ResetPlugin.lIlIIlIlIlI(worldPoint) && ResetPlugin.lIlIIllIIIl(worldPoint.distanceTo(tile.getWorldLocation()), lIllllllI[4])) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((122 + 86 - 205 + 129 ^ 34 + 102 - 31 + 23) & (0x10 ^ 0x16 ^ "  ".length() ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIllllllI[1];
                }
                ...
                "".length();
                if (" ".length() <= 0) {
                    return ((0x2C ^ 0x16 ^ (0x88 ^ 0x8D)) & (160 + 140 - 201 + 64 ^ 64 + 143 - 113 + 62 ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIllllllI[1];
            }
    ...
    protected Class<?>[] tasks() {
        ...
        classArray[ResetPlugin.lIllllllI[1]] = E.class;
        return classArray;
    }
    ...
    private /* synthetic */ int a(Player player, WorldPoint worldPoint) {
    ...
    public boolean ae() {
        ...
        if (ResetPlugin.lIlIIlIlIIl(ResetPlugin.lIlIIllIIII(this.bu, -1L))) {
            bl2 = lIllllllI[0];
            "".length();
            if (((49 + 103 - 91 + 83 ^ 143 + 36 - 148 + 152) & (0xF5 ^ 0xBD ^ (0xEC ^ 0x83) ^ -" ".length())) > 0) {
                return ((0x52 ^ 0x6E ^ (0x73 ^ 8)) & (0xB2 ^ 0x90 ^ (0xA2 ^ 0xC7) ^ -" ".length())) != 0;
            }
        } else {
            bl2 = lIllllllI[1];
        }
