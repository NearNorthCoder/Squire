...
extends SquirePlugin {
    ...
    private static void lIIIlIIIl() {
        ...
        RingOfLife.lIIIIlI[RingOfLife.lIIlIlI[0]] = RingOfLife.lIIIIIIll("FSA8BTEvOjRVICo4cyYwMz0hEGEWOCYSKCgncxQyZiM2VSYpIHMnKCgzcxonZhg6EyQieg==", "FTSuA");
        RingOfLife.lIIIIlI[RingOfLife.lIIlIlI[1]] = RingOfLife.lIIIIIlII("bvTH3OkC560=", "rVnMg");
        RingOfLife.lIIIIlI[RingOfLife.lIIlIlI[3]] = RingOfLife.lIIIIIlIl("eHxsMSqBnOo=", "Qfkhd");
        RingOfLife.lIIIIlI[RingOfLife.lIIlIlI[2]] = RingOfLife.lIIIIIIll("IyoDKhI=", "tCfFv");
        RingOfLife.lIIIIlI[RingOfLife.lIIlIlI[4]] = RingOfLife.lIIIIIlIl("QPk4f3w77R6mGb1ER7DdT3zFu3mom6kXsn54mpvpwNiKm5y7XnSuRlE0YNq+MYZSlRqJPu2am54U8Nzq4irloGAEAOluutHa", "XaEHY");
    }
                ...
                while (RingOfLife.lIIlIllll(llllIIIIIllIlII, llllIIIIIllIlIl)) {
                    ...
                    if (!RingOfLife.lIIlIllIl(Equipment.contains((int[])llllIIIIIllIIll.av()) ? 1 : 0) || RingOfLife.lIIlIlIll(Inventory.contains((int[])llllIIIIIllIIll.av()) ? 1 : 0)) {
                        if (RingOfLife.lIIlIlIll(Equipment.contains((int[])llllIIIIIllIIll.av()) ? 1 : 0)) {
                            ...
                            "".length();
                            if ((0xDA ^ 0xBD ^ (0xED ^ 0x8E)) >= "   ".length()) break;
                            return;
                        }
                        Inventory.getFirst((int[])llllIIIIIllIIll.av()).interact(llllIIIIIllIIll.au());
                        Log.info((String)lIIIIlI[lIIlIlI[4]]);
                        "".length();
                        if ((0xE2 ^ 0x95 ^ (2 ^ 0x71)) > ((14 + 21 - -63 + 53 ^ 131 + 118 - 167 + 105) & (169 + 14 - 110 + 100 ^ 93 + 58 - 64 + 42 ^ -" ".length()))) break;
                        return;
                    }
                    ++llllIIIIIllIlII;
                    "".length();
    ...
    private static void lIIlIlIII() {
        lIIlIlI = new int[7];
        RingOfLife.lIIlIlI[0] = (0x33 ^ 0x41 ^ (0x84 ^ 0xAF)) & (202 + 16 - 189 + 180 ^ 66 + 107 - 117 + 80 ^ -" ".length());
        RingOfLife.lIIlIlI[1] = " ".length();
        RingOfLife.lIIlIlI[2] = "   ".length();
        RingOfLife.lIIlIlI[3] = "  ".length();
