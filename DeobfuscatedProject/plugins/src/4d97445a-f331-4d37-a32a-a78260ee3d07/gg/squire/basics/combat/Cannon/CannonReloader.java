...
extends SquirePlugin {
    ...
    private static void lIIIIIlIlII() {
        ...
        CannonReloader.lIIlIllII[0] = -" ".length();
        CannonReloader.lIIlIllII[1] = " ".length();
        CannonReloader.lIIlIllII[2] = "   ".length();
        CannonReloader.lIIlIllII[3] = "  ".length();
        CannonReloader.lIIlIllII[4] = (84 + 23 - 17 + 45 ^ 101 + 79 - 130 + 116) & (0x4B ^ 0x74 ^ (0x36 ^ 0x28) ^ -" ".length());
    ...
    public void a(MenuOptionClicked menuOptionClicked) {
        ...
        if (CannonReloader.lIIIIIllIlI(llIIIlllllllIll.getMenuAction(), MenuAction.WIDGET_TARGET_ON_GAME_OBJECT) && CannonReloader.lIIIIIlIllI(llIIIllllllllII.v.getSelectedWidget().getId(), WidgetInfo.INVENTORY.getId())) {
            ...
            "".length();
            if (((59 + 78 - 78 + 171 ^ 118 + 30 - 35 + 79) & (0x91 ^ 0xC1 ^ (0x78 ^ 0xE) ^ -" ".length())) != 0) {
                return;
            }
    ...
    private static void lIIIIIlIIll() {
        ...
        CannonReloader.lIIlIIIll[CannonReloader.lIIlIllII[4]] = CannonReloader.lllllIllll("gR7iidemFBtshu0pG79nbavCANkTy8q5", "hxpuZ");
        CannonReloader.lIIlIIIll[CannonReloader.lIIlIllII[1]] = CannonReloader.llllllIIIl("CgMyWTs6DyxZPiNMMxEucw8mFyU8Ag==", "SlGyK");
        CannonReloader.lIIlIIIll[CannonReloader.lIIlIllII[3]] = CannonReloader.lllllIllll("WZRS1KrULb7hs3AFPr6GW1QRmiIOhJTiP4Pq1qA4QjWTwDmGLUYTu8UvkVFQ+i/k/cc1VTKUbu7G85JxVp6gfA==", "EgKMa");
        CannonReloader.lIIlIIIll[CannonReloader.lIIlIllII[2]] = CannonReloader.llllllIIIl("CwMcJEgxDQc4BzxMATcbcg4MMwZyCAwlHCADEDMMcw==", "RliVh");
        CannonReloader.lIIlIIIll[CannonReloader.lIIlIllII[11]] = CannonReloader.lllllIllll("a65xhffw9fSE/XfLteGf+wFQfh/OsT4jROX397RGqMg=", "DxAFY");
        CannonReloader.lIIlIIIll[CannonReloader.lIIlIllII[12]] = CannonReloader.llllllIlII("k1UG/a0gxxe+5SKpq8oeWWrxelLgWIPl", "cGLve");
        CannonReloader.lIIlIIIll[CannonReloader.lIIlIllII[8]] = CannonReloader.lllllIllll("TiOJE1pk8s/NdqMjN3IWjMZR+g9ifIgpp4VqTGxmrbU=", "cKodk");
    }
}
