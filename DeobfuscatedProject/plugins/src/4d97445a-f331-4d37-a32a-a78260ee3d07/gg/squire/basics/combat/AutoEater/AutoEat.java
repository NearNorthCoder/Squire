...
extends SquirePlugin {
    ...
    public void onGameTick(GameTick gameTick) {
        ...
        if (AutoEat.lIlllIIIII(llIlIllllIIlllI.bF.drinkPrayAt(), Prayers.getPoints()) && AutoEat.lIlllIIIIl(llIlIllllIIllIl = Inventory.getFirst(item -> {
            ...
            if (!AutoEat.lIlllIIlIl(item.getName().contains(llIIllIl[llIIlllI[3]]) ? 1 : 0) || AutoEat.lIlllIIIll(item.getName().contains(llIIllIl[llIIlllI[4]]) ? 1 : 0)) {
                ...
                "".length();
                if (" ".length() == 0) {
                    return ((0x6E ^ 0x43 ^ (0xE ^ 0x3A)) & (0x74 ^ 0x45 ^ (0x63 ^ 0x4B) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIIlllI[1];
            }
        ...
        if (!AutoEat.lIlllIIIlI(Players.getLocal().getInteracting()) || AutoEat.lIlllIIIIl(NPCs.getNearest(nPC -> {
            ...
            if (AutoEat.lIlllIIlII(nPC.getInteracting(), Players.getLocal())) {
                ...
                if (-((0x3A ^ 0x6A) & ~(0x1C ^ 0x4C) ^ (0x3B ^ 0x3F)) >= 0) {
                    return ((106 + 10 - 7 + 22 ^ 181 + 152 - 313 + 177) & (0x8B ^ 0xBC ^ (0x10 ^ 0x61) ^ -" ".length()) & ((0x5C ^ 0x40 ^ (7 ^ 0x31)) & (83 + 54 - 50 + 58 ^ 20 + 83 - 77 + 161 ^ -" ".length()) ^ -" ".length())) != 0;
                }
            } else {
                bl2 = llIIlllI[1];
            }
    ...
    private static void lIllIlllll() {
        llIIlllI = new int[8];
        AutoEat.llIIlllI[0] = -" ".length();
        AutoEat.llIIlllI[1] = (125 + 56 - 177 + 124 ^ 113 + 93 - 64 + 57) & (9 ^ 0x38 ^ (0x71 ^ 7) ^ -" ".length());
        AutoEat.llIIlllI[2] = " ".length();
        AutoEat.llIIlllI[3] = "  ".length();
        AutoEat.llIIlllI[4] = "   ".length();
    ...
    private static String lIllIlllII(String llIlIlllIllllll, String llIlIlllIlllllI) {
        try {
            SecretKeySpec llIlIllllIIIlII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llIlIlllIlllllI.getBytes(StandardCharsets.UTF_8)), llIIlllI[7]), "DES");
            Cipher llIlIllllIIIIll = Cipher.getInstance("DES");
            llIlIllllIIIIll.init(llIIlllI[3], llIlIllllIIIlII);
            return new String(llIlIllllIIIIll.doFinal(Base64.getDecoder().decode(llIlIlllIllllll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIllIlllIl(String llIlIlllIllIlII, String llIlIlllIllIIll) {
        try {
            ...
            Cipher llIlIlllIllIllI = Cipher.getInstance("Blowfish");
            llIlIlllIllIllI.init(llIIlllI[3], llIlIlllIllIlll);
            return new String(llIlIlllIllIllI.doFinal(Base64.getDecoder().decode(llIlIlllIllIlII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIllIllllI() {
        ...
        AutoEat.llIIllIl[AutoEat.llIIlllI[1]] = AutoEat.lIllIlllII("q4vLgJY+oaI=", "KJeHV");
        AutoEat.llIIllIl[AutoEat.llIIlllI[2]] = AutoEat.lIllIlllII("QodcqwnujcA=", "RfCgi");
        AutoEat.llIIllIl[AutoEat.llIIlllI[3]] = AutoEat.lIllIlllII("0zcZo0HgE+A=", "Sjgjx");
        AutoEat.llIIllIl[AutoEat.llIIlllI[4]] = AutoEat.lIllIlllII("xSkH9a+MxvhpbBw+Yw9zEA==", "Vqhps");
        AutoEat.llIIllIl[AutoEat.llIIlllI[5]] = AutoEat.lIllIlllIl("1k1Htgq7C5g=", "xgbND");
    }
