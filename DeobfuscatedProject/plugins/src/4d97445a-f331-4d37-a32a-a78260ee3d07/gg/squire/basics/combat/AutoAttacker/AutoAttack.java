...
extends SquirePlugin {
    ...
    private static String lIlIIIIll(String lllIlllIIIllIll, String lllIlllIIIlIlIl) {
        ...
        while (AutoAttack.lIlIIlllI(lllIlllIIIIllll, lllIlllIIIlIIII)) {
            ...
            ++lllIlllIIIIllll;
            "".length();
            if ("  ".length() != ((0x38 ^ 0x20 ^ (0x6F ^ 0x28)) & (0x67 ^ 2 ^ (0xAF ^ 0x95) ^ -" ".length()))) continue;
            return null;
        }
    ...
    private static void lIlIIIllI() {
        ...
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[2]] = AutoAttack.lIlIIIIll("ExoWCS8=", "DsseK");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[1]] = AutoAttack.lIlIIIlII("0Xzv8MdisHI=", "QsEyV");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[6]] = AutoAttack.lIlIIIlII("xAup22wghhU=", "gWSeS");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[7]] = AutoAttack.lIlIIIIll("IxkhBRI=", "tpDiv");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[8]] = AutoAttack.lIlIIIIll("FyRYHzkvLhYCOCsyWAUnOCgdViM2awgDI3kkFlYkKS4bViA8KggZOXc=", "YKxvW");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[9]] = AutoAttack.lIlIIIIll("DS0zDRAn", "LYGls");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[10]] = AutoAttack.lIlIIIlII("Oc13UTkYEIk2HVtmwuvfAQ==", "FubYA");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[11]] = AutoAttack.lIlIIIlIl("f6VDFHH1qUM=", "GeqIV");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[12]] = AutoAttack.lIlIIIlII("P4NtFJrJEdQ=", "kfJAG");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[13]] = AutoAttack.lIlIIIlII("8FSRO3pGv8gazpvfUfbt7g==", "Dmbhl");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[14]] = AutoAttack.lIlIIIlIl("39o/AOc3NwU=", "pghli");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[15]] = AutoAttack.lIlIIIIll("JzAeLhoN", "fDjOy");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[16]] = AutoAttack.lIlIIIlIl("vy5T6/v+jLNgWKL2foF6IDfnNBLPRbMo", "REcsI");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[17]] = AutoAttack.lIlIIIIll("HBwvBRUKDC4YBgwGPx4=", "omZlg");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[18]] = AutoAttack.lIlIIIIll("HDomCzUGKyYh", "rJEJA");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[19]] = AutoAttack.lIlIIIlII("Sy7rSR5x2hQ=", "CzCRK");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[20]] = AutoAttack.lIlIIIlII("hT3KLRC798KJwDQ5gyoA51WUMCyIWXw3g6pEsrRFwxViceYjjD14qg==", "YAryc");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[21]] = AutoAttack.lIlIIIlIl("6xv3MNL2FD4=", "mYoPV");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[22]] = AutoAttack.lIlIIIlIl("P3o7bpdxQBk=", "nXEWN");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[23]] = AutoAttack.lIlIIIIll("LSQkBQU=", "oVAdn");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[27]] = AutoAttack.lIlIIIlIl("Ag3hc/fQQAA=", "fFFom");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[28]] = AutoAttack.lIlIIIIll("DSszEw==", "oBAwx");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[29]] = AutoAttack.lIlIIIlIl("aoicu+hKCuc=", "aNVsr");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[30]] = AutoAttack.lIlIIIlII("/MEy/pGNgdx1CAeKIn57Qg==", "JLFjP");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[31]] = AutoAttack.lIlIIIIll("OicxJB8gNjEO", "TWRek");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[32]] = AutoAttack.lIlIIIlIl("Yq57xBCD1rogr7G8HbbTUg==", "cRXHG");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[33]] = AutoAttack.lIlIIIIll("IzgtBRE5KS0v", "MHNDe");
        AutoAttack.lIlIIIl[AutoAttack.lIlIIlI[34]] = AutoAttack.lIlIIIIll("Izc4JDAJ", "bCLES");
    }
                ...
                if (AutoAttack.lIlIIllII(lllIlllIllIlIIl) && AutoAttack.lIlIIllll(lllIlllIllIlIIl.getId(), lllIlllIllIlIlI.bz.specWeapon().ar())) {
                    ...
                    if (AutoAttack.lIlIIlIIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                        ...
                        if (AutoAttack.lIlIIlIIl(lllIlllIllIlIlI.bz.specWeapon().at() ? 1 : 0) && AutoAttack.lIlIIlIlI(Inventory.getFreeSlots(), lIlIIlI[6])) {
                            ...
                            "".length();
                            if (((0x42 ^ 0x26 ^ (0xC4 ^ 0xAE)) & (0x2E ^ 0x17 ^ (0x7F ^ 0x48) ^ -" ".length())) != 0) {
                                return;
                            }
                        } else {
        ...
        if (AutoAttack.lIlIIlIII(lllIlllIllIlIlI.bz.exactName() ? 1 : 0)) {
            lllIlllIllIlIII = Combat.getAttackableNPC(nPC -> {
                ...
                if (AutoAttack.lIlIIlIIl(nPC.getName().toLowerCase().contains(this.bz.npcName().toLowerCase()) ? 1 : 0) && AutoAttack.lIlIIlIII(nPC.isDead() ? 1 : 0) && AutoAttack.lIlIlIIlI(nPC.distanceTo((Locatable)Players.getLocal()), this.bz.npcDistance()) && AutoAttack.lIlIlIIlI(Walker.buildPath((WorldPoint)nPC.getWorldLocation()).size(), this.bz.npcDistance())) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((0x6B ^ 3 ^ (0xED ^ 0xB1)) & (0xE2 ^ 0xC4 ^ (0x27 ^ 0x35) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIlIIlI[2];
                }
    ...
    private static void lIlIIIlll() {
        lIlIIlI = new int[36];
        AutoAttack.lIlIIlI[0] = -" ".length();
        AutoAttack.lIlIIlI[1] = " ".length();
        AutoAttack.lIlIIlI[2] = (0xBE ^ 0xC5 ^ (0x58 ^ 0xA)) & (0x61 ^ 0x39 ^ (9 ^ 0x78) ^ -" ".length());
        ...
        AutoAttack.lIlIIlI[6] = "  ".length();
        AutoAttack.lIlIIlI[7] = "   ".length();
