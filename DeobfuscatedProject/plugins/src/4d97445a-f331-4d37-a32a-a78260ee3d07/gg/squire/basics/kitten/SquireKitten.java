...
extends SquirePlugin {
    ...
    private static void lIIIIllIlIl() {
        ...
        SquireKitten.lIIllIlII[1] = " ".length();
        SquireKitten.lIIllIlII[2] = "  ".length();
        SquireKitten.lIIllIlII[3] = "   ".length();
        ...
        SquireKitten.lIIllIlII[8] = -" ".length();
        SquireKitten.lIIllIlII[9] = "  ".length() ^ (0x4E ^ 0x6C);
    ...
    private void v(int n2) {
        ...
        while (SquireKitten.lIIIIlllIll(llIIIllIIlIlIII.length(), lIIllIlII[9])) {
            ...
            "".length();
            "".length();
            if ("   ".length() != ((0x84 ^ 0x9C ^ (0x49 ^ 0x69)) & (109 + 57 - 163 + 248 ^ 6 + 84 - 22 + 127 ^ -" ".length()))) continue;
            return;
        }
    ...
    private static void lIIIIllIlII() {
        ...
        SquireKitten.lIIllIIll[SquireKitten.lIIllIlII[0]] = SquireKitten.lIIIIllIIIl("IDAPUQwdLB4UCVQ/BRMFGD0ZURIEeB4ZAlQ+AwIPWg==", "tXjqg");
        SquireKitten.lIIllIIll[SquireKitten.lIIllIlII[1]] = SquireKitten.lIIIIllIIlI("1rDeZfuBPTqDk0WqI5b8XpiN0pN9GAJAWNPNr0IOK3k=", "VirNq");
        SquireKitten.lIIllIIll[SquireKitten.lIIllIlII[2]] = SquireKitten.lIIIIllIIlI("UJ4CuW8ly8SksMFk+hDTANF0OPGLzuSAJJkADbJVWhw=", "ruXrV");
        SquireKitten.lIIllIIll[SquireKitten.lIIllIlII[3]] = SquireKitten.lIIIIllIIll("g39Jf9DEItta2SkCfzJeArAOnGS5vHDw", "SrtlR");
        SquireKitten.lIIllIIll[SquireKitten.lIIllIlII[4]] = SquireKitten.lIIIIllIIlI("YsOP8Dwju1Zl/E0uaaoBr1D5ynRhJJXLkW4igtsoRXY=", "BWANX");
        SquireKitten.lIIllIIll[SquireKitten.lIIllIlII[5]] = SquireKitten.lIIIIllIIIl("IyATNUIRJhIzBxRvESYMDjxGJhYOKggzCxUhSA==", "zOfGb");
        SquireKitten.lIIllIIll[SquireKitten.lIIllIlII[6]] = SquireKitten.lIIIIllIIlI("C6Oo6D7gzuvjZRLQClgVV0nmaWJtbcX8ecVIFSBCxAyEMSTR8XuHDA==", "VaDFw");
        SquireKitten.lIIllIIll[SquireKitten.lIIllIlII[10]] = SquireKitten.lIIIIllIIIl("YQ==", "QDrXG");
        SquireKitten.lIIllIIll[SquireKitten.lIIllIlII[12]] = SquireKitten.lIIIIllIIll("stXBotnasyc=", "CTQVn");
        SquireKitten.lIIllIIll[SquireKitten.lIIllIlII[23]] = SquireKitten.lIIIIllIIll("nd1PNqzxDEpsKZCJysPp5Q==", "blapw");
        SquireKitten.lIIllIIll[SquireKitten.lIIllIlII[13]] = SquireKitten.lIIIIllIIll("KD25d5439co=", "ciHOk");
    }
    ...
    public void onGameTick(GameTick gameTick) {
        ...
        NPC llIIIllIIlIIIlI = NPCs.getNearest(nPC -> {
            ...
            if (SquireKitten.lIIIIlllIIl(nPC.getId(), this.dO) && SquireKitten.lIIIIlllIII(lIIllIIll[lIIllIlII[13]].equals(nPC.getName()) ? 1 : 0) && SquireKitten.lIIIIllllll(nPC.getInteracting(), Players.getLocal())) {
                ...
                "".length();
                if (null != null) {
                    return ((0x9C ^ 0x8C ^ (0xD9 ^ 0x99)) & (128 + 39 - 157 + 244 ^ 115 + 121 - 200 + 138 ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIllIlII[0];
            }
    ...
    protected Class<?>[] tasks() {
        ...
        classArray[SquireKitten.lIIllIlII[0]] = az.class;
        return classArray;
    }
