...
extends SquirePlugin {
    ...
    private static void llIIIIllII() {
        llIlllIl = new int[5];
        MageArenaOne.llIlllIl[0] = -" ".length();
        MageArenaOne.llIlllIl[1] = (0xC2 ^ 0x85) & ~(0x47 ^ 0);
        MageArenaOne.llIlllIl[2] = " ".length();
        MageArenaOne.llIlllIl[3] = "  ".length();
    ...
    private static void llIIIIlIll() {
        ...
        MageArenaOne.llIlllII[MageArenaOne.llIlllIl[1]] = MageArenaOne.llIIIIlIII("LC0aAyUG", "mYnbF");
        MageArenaOne.llIlllII[MageArenaOne.llIlllIl[2]] = MageArenaOne.llIIIIlIIl("cQN1osyTy/Y=", "fqINY");
    }
        ...
        List list = NPCs.getAll(nPC -> {
            ...
            if (MageArenaOne.llIIIIllll(nPC.getInteracting(), Players.getLocal())) {
                ...
                if (MageArenaOne.llIIIlIIII(nPC.hasAction(stringArray) ? 1 : 0) && MageArenaOne.llIIIlIIII(nPC.getName().contains(llIlllII[llIlllIl[2]]) ? 1 : 0)) {
                    n2 = llIlllIl[2];
                    "".length();
                    if (((0x4D ^ 0x2C) & ~(0x10 ^ 0x71)) < " ".length()) return n2 != 0;
