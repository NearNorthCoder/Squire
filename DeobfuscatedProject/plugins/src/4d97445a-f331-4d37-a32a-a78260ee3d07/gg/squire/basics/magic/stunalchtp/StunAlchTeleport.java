...
extends SquirePlugin {
    ...
    protected Class<?>[] tasks() {
        ...
        classArray[StunAlchTeleport.lIIlllII[0]] = aT.class;
        classArray[StunAlchTeleport.lIIlllII[2]] = aS.class;
        classArray[StunAlchTeleport.lIIlllII[3]] = aU.class;
        return classArray;
    }
    ...
    private static void lIIlIIIllI() {
        ...
        StunAlchTeleport.lIIllIll[StunAlchTeleport.lIIlllII[0]] = StunAlchTeleport.lIIlIIIlIl("GR46KhQmCScQBWoZOyUnPg8r", "JjODU");
        StunAlchTeleport.lIIllIll[StunAlchTeleport.lIIlllII[2]] = StunAlchTeleport.lIIlIIIlIl("KwwlKiUUGzgQNFgLJCsUCB00", "xxPDd");
    }
    ...
    private static String lIIlIIIlIl(String lllIIIIlIIIlIlI, String lllIIIIlIIIlllI) {
        ...
        while (StunAlchTeleport.lIIlIIlIII(lllIIIIlIIIIIll, lllIIIIlIIIIlII)) {
            ...
            ++lllIIIIlIIIIIll;
            "".length();
            if (((0xEF ^ 0x8E ^ (0xC5 ^ 0xBB)) & (0x57 ^ 0x5D ^ (5 ^ 0x10) ^ -" ".length())) <= 0) continue;
            return null;
        }
    ...
    private static void lIIlIIIlll() {
        ...
        StunAlchTeleport.lIIlllII[1] = "   ".length();
        StunAlchTeleport.lIIlllII[2] = " ".length();
        StunAlchTeleport.lIIlllII[3] = "  ".length();
    }
}
