...
extends OverlayPanel {
    ...
    private static void lIllIlIlllI() {
        ...
        QuestInfoBox.llIlIIIII[QuestInfoBox.llIlIIIIl[0]] = QuestInfoBox.lIllIlIlIll("HhcMGSUoRigFMj4SWSEYAQ==", "MfypW");
        QuestInfoBox.llIlIIIII[QuestInfoBox.llIlIIIIl[1]] = QuestInfoBox.lIllIlIlIll("EiUaNDQm", "BDoGQ");
        QuestInfoBox.llIlIIIII[QuestInfoBox.llIlIIIIl[2]] = QuestInfoBox.lIllIlIlIll("Jho=", "huTka");
        QuestInfoBox.llIlIIIII[QuestInfoBox.llIlIIIIl[3]] = QuestInfoBox.lIllIlIllII("22w6SEAGecc=", "onTVx");
        QuestInfoBox.llIlIIIII[QuestInfoBox.llIlIIIIl[4]] = QuestInfoBox.lIllIlIlIll("LQERBSkAAEMmOQsHFw==", "ntcwL");
        QuestInfoBox.llIlIIIII[QuestInfoBox.llIlIIIIl[5]] = QuestInfoBox.lIllIlIllIl("JV05JpzyUhlUrmwQ1nNn3Q==", "XYsFT");
        QuestInfoBox.llIlIIIII[QuestInfoBox.llIlIIIIl[6]] = QuestInfoBox.lIllIlIlIll("ATcVKj8sNkcMOzEp", "BBgXZ");
        QuestInfoBox.llIlIIIII[QuestInfoBox.llIlIIIIl[7]] = QuestInfoBox.lIllIlIlIll("R1VDRHpHVUNEekdVQ0R6R1VDRHpHVUNEekdVQ0R6R1VDRHpH", "jxniW");
    }
    ...
    private static void lIllIlIllll() {
        llIlIIIIl = new int[9];
        QuestInfoBox.llIlIIIIl[0] = (0x68 ^ 4 ^ (0xCC ^ 0x89)) & (0xA1 ^ 0xB7 ^ (0xF9 ^ 0xC6) ^ -" ".length());
        QuestInfoBox.llIlIIIIl[1] = " ".length();
        QuestInfoBox.llIlIIIIl[2] = "  ".length();
        QuestInfoBox.llIlIIIIl[3] = "   ".length();
