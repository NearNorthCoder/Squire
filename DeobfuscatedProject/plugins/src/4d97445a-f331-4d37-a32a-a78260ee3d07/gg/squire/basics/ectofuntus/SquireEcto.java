...
import i.i.b.s.c.q.r.s.s.-.u.a.e.at;
import i.i.b.s.c.q.r.s.s.-.u.a.e.au;
...
extends SquirePlugin {
    ...
    private static String lllIIllll(String lllIIlllIllIlII, String lllIIlllIlllIII) {
        ...
        while (SquireEcto.lllIlIlIl(lllIIlllIlIllIl, lllIIlllIlIlllI)) {
            ...
            ++lllIIlllIlIllIl;
            "".length();
            if ("  ".length() < (0x58 ^ 0x69 ^ (0xF4 ^ 0xC1))) continue;
            return null;
        }
    ...
    private static void lllIlIIIl() {
        ...
        SquireEcto.llllIII[SquireEcto.llllIIl[0]] = SquireEcto.lllIIllll("GRcJCjcPQw==", "jchxC");
        SquireEcto.llllIII[SquireEcto.llllIIl[2]] = SquireEcto.lllIIllll("MCxDDDECLUMDOkcsABY7FyEKAzhHPQxCJhInQxY8AmkTDiEAIA1M", "gIcbT");
        SquireEcto.llllIII[SquireEcto.llllIIl[3]] = SquireEcto.lllIIllll("FhkXBDE=", "StgpH");
        SquireEcto.llllIII[SquireEcto.llllIIl[4]] = SquireEcto.lllIlIIII("gQVpSaGTqks=", "BcODs");
    }
    ...
    private static void lllIlIIlI() {
        ...
        SquireEcto.llllIIl[2] = " ".length();
        SquireEcto.llllIIl[3] = "  ".length();
        SquireEcto.llllIIl[4] = "   ".length();
    ...
    protected Class<?>[] tasks() {
        ...
        classArray[SquireEcto.llllIIl[0]] = aq.class;
        classArray[SquireEcto.llllIIl[2]] = ap.class;
        classArray[SquireEcto.llllIIl[3]] = at.class;
        classArray[SquireEcto.llllIIl[4]] = au.class;
        classArray[SquireEcto.llllIIl[5]] = ar.class;
        return classArray;
    }
