...
extends SquirePlugin {
    ...
    private static void llIllIlIlI() {
        ...
        SecondariesPlugin.lllllIlI[1] = (0xB ^ 0x2D ^ (0x39 ^ 0x51)) & (0x10 ^ 0x14 ^ (0xB ^ 0x41) ^ -" ".length());
        SecondariesPlugin.lllllIlI[2] = " ".length();
        SecondariesPlugin.lllllIlI[3] = "  ".length();
        SecondariesPlugin.lllllIlI[4] = "   ".length();
        SecondariesPlugin.lllllIlI[5] = 0x3C ^ 0x38;
        SecondariesPlugin.lllllIlI[6] = 0x95 ^ 0x90;
        SecondariesPlugin.lllllIlI[7] = -"  ".length();
    }
    ...
    private static String llIllIIlll(String llIlIIIIIlllIll, String llIlIIIIIlllIlI) {
        ...
        while (SecondariesPlugin.llIlllIIII(llIlIIIIIlIllll, llIlIIIIIllIIII)) {
            ...
            ++llIlIIIIIlIllll;
            "".length();
            if ((0x65 ^ 0x3B ^ (0xD9 ^ 0x83)) >= "  ".length()) continue;
            return null;
        }
    ...
    private static void llIllIlIIl() {
        ...
        SecondariesPlugin.lllllIIl[SecondariesPlugin.lllllIlI[1]] = SecondariesPlugin.llIllIIlll("HAo+Lg==", "QkLEG");
        SecondariesPlugin.lllllIIl[SecondariesPlugin.lllllIlI[2]] = SecondariesPlugin.llIllIlIII("aY/zZHgQ2d8=", "ngqvY");
        SecondariesPlugin.lllllIIl[SecondariesPlugin.lllllIlI[3]] = SecondariesPlugin.llIllIIlll("bDYjIFE2My8qWGBr", "PULLl");
    }
