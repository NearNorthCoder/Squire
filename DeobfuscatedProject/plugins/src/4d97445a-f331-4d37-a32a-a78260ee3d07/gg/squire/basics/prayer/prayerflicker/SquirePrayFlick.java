...
import i.i.b.s.c.q.r.s.s.-.u.a.e.bg;
...
extends SquirePlugin {
    ...
    protected Class<?>[] tasks() {
        ...
        classArray[SquirePrayFlick.lIlIIII[0]] = bg.class;
        return classArray;
    }
    ...
    private static void lIlIIIIII() {
        lIlIIII = new int[2];
        SquirePrayFlick.lIlIIII[0] = (0x1B ^ 0x32 ^ (0xA9 ^ 0xA0)) & (76 + 55 - 102 + 138 ^ 16 + 99 - 44 + 64 ^ -" ".length());
        SquirePrayFlick.lIlIIII[1] = " ".length();
    }
}
