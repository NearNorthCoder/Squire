...
extends SquirePlugin {
    ...
    private static void llIIlIIIllI() {
        lllIlIlII = new int[5];
        SquireShopBuyer.lllIlIlII[0] = "   ".length();
        SquireShopBuyer.lllIlIlII[1] = (0x55 ^ 0x6A ^ (0x49 ^ 0x67)) & (0x2A ^ 0x54 ^ (0x46 ^ 0x29) ^ -" ".length());
        SquireShopBuyer.lllIlIlII[2] = " ".length();
        SquireShopBuyer.lllIlIlII[3] = "  ".length();
    ...
    private static void llIIlIIIlIl() {
        ...
        SquireShopBuyer.lllIlIIlI[SquireShopBuyer.lllIlIlII[1]] = SquireShopBuyer.llIIlIIIIll("vVT8b+cnOAEVv047TawiRLykMsLW+qdC", "LRcnh");
    }
    ...
    protected Class<?>[] tasks() {
        ...
        classArray[SquireShopBuyer.lllIlIlII[1]] = bV.class;
        classArray[SquireShopBuyer.lllIlIlII[2]] = bW.class;
        classArray[SquireShopBuyer.lllIlIlII[3]] = bU.class;
        return classArray;
    }
