...
import i.i.b.s.c.q.r.s.s.-.u.a.e.ah;
import i.i.b.s.c.q.r.s.s.-.u.a.e.ai;
...
extends SquirePlugin {
    ...
    private static void lIlIllIlI() {
        ...
        SquireDagannothKings.lIlIllI[2] = " ".length();
        SquireDagannothKings.lIlIllI[3] = "  ".length();
        SquireDagannothKings.lIlIllI[4] = "   ".length();
        SquireDagannothKings.lIlIllI[5] = 0xAC ^ 0xA4;
    }

    private static void lIlIllIIl() {
        lIlIlIl = new String[lIlIllI[2]];
        SquireDagannothKings.lIlIlIl[SquireDagannothKings.lIlIllI[1]] = SquireDagannothKings.lIlIllIII("Kk8SQJjkgD0=", "eKZsp");
    }

    protected Class<?>[] tasks() {
        Class[] classArray = new Class[lIlIllI[0]];
        classArray[SquireDagannothKings.lIlIllI[1]] = ai.class;
        classArray[SquireDagannothKings.lIlIllI[2]] = ah.class;
        classArray[SquireDagannothKings.lIlIllI[3]] = ak.class;
        classArray[SquireDagannothKings.lIlIllI[4]] = ag.class;
        return classArray;
    }
