...
extends SquirePlugin {
    ...
    public void onGameTick(GameTick gameTick) {
        ...
        while (InventoryAssistant.llIIIlIIlIl(lIlIllIIIIIlIll.hasNext() ? 1 : 0)) {
            ...
            "".length();
            if ("  ".length() < (10 + 80 - 57 + 126 ^ 113 + 75 - 54 + 21)) continue;
            return;
        }
    }
    ...
    private static void llIIIlIIIIl() {
        ...
        InventoryAssistant.lllIIlIll[1] = " ".length();
        InventoryAssistant.lllIIlIll[2] = 0x57 ^ 0x5F;
        InventoryAssistant.lllIIlIll[3] = "  ".length();
    }

    private static void llIIIlIIIII() {
        lllIIlIlI = new String[lllIIlIll[3]];
        InventoryAssistant.lllIIlIlI[InventoryAssistant.lllIIlIll[0]] = InventoryAssistant.llIIIIlllll("Zg==", "JmjLz");
        InventoryAssistant.lllIIlIlI[InventoryAssistant.lllIIlIll[1]] = InventoryAssistant.llIIIIlllll("NjkBNw==", "rKnGy");
    }
    ...
    public int[] bO() {
        ...
        while (InventoryAssistant.llIIIlIIIlI(lIlIllIIIIlIlII, ((void)lIlIllIIIIlIllI).length)) {
            ...
            ++lIlIllIIIIlIlII;
            "".length();
            if ("   ".length() >= ((0xA2 ^ 0x83) & ~(0x43 ^ 0x62))) continue;
            return null;
        }
        return nArray;
    }
