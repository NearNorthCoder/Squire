...
extends SquirePlugin {
    ...
    public void onGameTick(GameTick gameTick) {
        ...
        Item lIllllIlIllllII = Inventory.getFirst(item -> {
            ...
            if (!SquireCurer.lIIlllIIlll(item.getName().contains(lIllIIlIl[lIllIIllI[1]]) ? 1 : 0) || SquireCurer.lIIlllIlIIl(item.getName().contains(lIllIIlIl[lIllIIllI[2]]) ? 1 : 0)) {
                ...
                "".length();
                if (-" ".length() >= 0) {
                    return ((0xD ^ 0x24 ^ (0x19 ^ 0x39)) & (0x9A ^ 0xAF ^ (0x50 ^ 0x6C) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIllIIllI[0];
            }
    ...
    private static void lIIlllIIlIl() {
        ...
        SquireCurer.lIllIIlIl[SquireCurer.lIllIIllI[0]] = SquireCurer.lIIlllIIIlI("NREtKB8=", "qcDFt");
        SquireCurer.lIllIIlIl[SquireCurer.lIllIIllI[1]] = SquireCurer.lIIlllIIIll("e8VLzBI8fzLbU/genq0sHg==", "ipGez");
        SquireCurer.lIllIIlIl[SquireCurer.lIllIIllI[2]] = SquireCurer.lIIlllIIlII("3IWS+OO9DMQ=", "BYYdf");
    }
    ...
    private static void lIIlllIIllI() {
        lIllIIllI = new int[5];
        SquireCurer.lIllIIllI[0] = "   ".length() & ("   ".length() ^ -" ".length());
        SquireCurer.lIllIIllI[1] = " ".length();
        SquireCurer.lIllIIllI[2] = "  ".length();
        SquireCurer.lIllIIllI[3] = "   ".length();
