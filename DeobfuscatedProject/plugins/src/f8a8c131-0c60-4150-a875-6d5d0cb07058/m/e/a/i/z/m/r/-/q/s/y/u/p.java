...
extends Task {
    ...
    private static String llIIIlIllIlIlII(String llllllllllllllIllIIlIlIlIIlIIIlI, String llllllllllllllIllIIlIlIlIIIlllII) {
        ...
        while (p.llIIIlIllIlllII(llllllllllllllIllIIlIlIlIIIlIllI, llllllllllllllIllIIlIlIlIIIlIlll)) {
            ...
            "".length();
            if (((34 + 61 - -33 + 49 ^ 14 + 23 - -50 + 67) & (0xD6 ^ 0xB3 ^ (2 ^ 0x4C) ^ -" ".length())) <= 0) continue;
            return null;
        }
    ...
    public boolean run() {
        ...
        Item llllllllllllllIllIIlIlIlIIllllII = Inventory.getFirst(item -> {
            ...
            if (!p.llIIIlIllIllIIl(item.getName().toLowerCase().contains(lIllIIlIIIIlI[lIllIIlIIIIll[2]]) ? 1 : 0) || p.llIIIlIllIllIII(item.getName().toLowerCase().contains(lIllIIlIIIIlI[lIllIIlIIIIll[3]]) ? 1 : 0)) {
                ...
                "".length();
                if (-" ".length() == " ".length()) {
                    return ((144 + 32 - 154 + 166 ^ 115 + 67 - 37 + 6) & (2 + 54 - 14 + 127 ^ 83 + 77 - 69 + 39 ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIllIIlIIIIll[0];
            }
    ...
    private static void llIIIlIllIlIlll() {
        ...
        p.lIllIIlIIIIll[0] = (75 + 72 - -27 + 77 ^ 143 + 11 - 4 + 14) & (0x39 ^ 0x1F ^ (0xFC ^ 0x85) ^ -" ".length());
        p.lIllIIlIIIIll[1] = " ".length();
        p.lIllIIlIIIIll[2] = "  ".length();
        p.lIllIIlIIIIll[3] = "   ".length();
        p.lIllIIlIIIIll[4] = 0x6A ^ 0x6E;
    }

    private static void llIIIlIllIlIllI() {
        lIllIIlIIIIlI = new String[lIllIIlIIIIll[4]];
        p.lIllIIlIIIIlI[p.lIllIIlIIIIll[0]] = p.llIIIlIllIlIlII("CgIVQyUjVxEMIzYYD0MpMAUEEA==", "EwacJ");
        p.lIllIIlIIIIlI[p.lIllIIlIIIIll[1]] = p.llIIIlIllIlIlIl("NQzRAjjD/OI=", "ztJbI");
        p.lIllIIlIIIIlI[p.lIllIIlIIIIll[2]] = p.llIIIlIllIlIlIl("C6Ener9Wa0U=", "AWGnj");
        p.lIllIIlIIIIlI[p.lIllIIlIIIIll[3]] = p.llIIIlIllIlIlII("ARYYCSwF", "rwvoI");
    }
