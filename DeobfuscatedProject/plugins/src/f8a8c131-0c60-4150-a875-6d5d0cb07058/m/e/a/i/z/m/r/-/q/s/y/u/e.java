...
extends Enum<e> {
    ...
    private static void llIIIlIlIIllIlI() {
        ...
        e.lIllIIIllIlIl[e.lIllIIIllIllI[0]] = e.llIIIlIlIIllIII("0bxI+0mqecOk/LAysy9vig==", "ozPJY");
        e.lIllIIIllIlIl[e.lIllIIIllIllI[4]] = e.llIIIlIlIIllIII("lcVdtniXVwvpIRSRATYB+gk0dXMvJ550", "jOtsg");
        e.lIllIIIllIlIl[e.lIllIIIllIllI[8]] = e.llIIIlIlIIllIII("+KtzNy1qti0rZVFSwHEhZA==", "sPZdh");
    }
    ...
    private static void llIIIlIlIIlllII() {
        ...
        e.lIllIIIllIllI[2] = -" ".length();
        e.lIllIIIllIllI[3] = 0x9E ^ 0xC1 ^ (0x28 ^ 0x37);
        e.lIllIIIllIllI[4] = " ".length();
