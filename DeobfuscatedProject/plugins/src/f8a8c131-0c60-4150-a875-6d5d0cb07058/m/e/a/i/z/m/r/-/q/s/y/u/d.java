...
public class d {
    ...
    public boolean k() {
        ...
        if (d.llIIIllIlIIIIlI(this.m) && d.llIIIllIlIIIIll(this.m.isDead() ? 1 : 0) && d.llIIIllIlIIIlII(this.m.getAnimation(), lIllIIllIIlII[0])) {
            ...
            if ((0xB2 ^ 0xA2 ^ (0xD6 ^ 0xC3)) <= 0) {
                return ((34 + 66 - -83 + 25 ^ 106 + 105 - 192 + 110) & (0xE8 ^ 0xB7 ^ (0x1A ^ 0x14) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIllIIllIIlII[2];
        }
    ...
    private static void llIIIllIlIIIIIl() {
        ...
        d.lIllIIllIIlII[1] = " ".length();
        d.lIllIIllIIlII[2] = (0xD9 ^ 0xC6 ^ (0x67 ^ 0x56)) & (0xE7 ^ 0x89 ^ (0x17 ^ 0x57) ^ -" ".length());
    }
