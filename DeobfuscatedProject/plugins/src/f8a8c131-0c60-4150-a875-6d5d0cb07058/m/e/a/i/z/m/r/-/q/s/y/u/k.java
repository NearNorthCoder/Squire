...
public class k {
    ...
    public void a(AnimationChanged animationChanged) {
        void var3_3;
        void llllllllllllllIllIIlIlIIIlIlllIl;
        Actor actor = animationChanged.getActor();
        if (k.llIIIlIlllllIII(actor instanceof Player)) {
            return;
        }
        e llllllllllllllIllIIlIlIIIlIlllII = e.a((NPC)llllllllllllllIllIIlIlIIIlIlllIl);
        if (k.llIIIlIlllllIIl((Object)llllllllllllllIllIIlIlIIIlIlllII)) {
            return;
        }
        if (k.llIIIlIlllllIlI(llllllllllllllIllIIlIlIIIlIlllIl.getAnimation(), llllllllllllllIllIIlIlIIIlIlllII.q())) {
            return;
        }
