...
extends Task {
    ...
    private static void llIIIlIlIIllIll() {
        ...
        r.lIllIIIllIlII[r.lIllIIIllIlll[0]] = r.llIIIlIlIIlIlll("GCMmGxI=", "HFGxz");
        r.lIllIIIllIlII[r.lIllIIIllIlll[2]] = r.llIIIlIlIIlIlll("HAAH", "YasLK");
        r.lIllIIIllIlII[r.lIllIIIllIlll[3]] = r.llIIIlIlIIllIIl("RtCOfQev1A4=", "tAWlH");
        r.lIllIIIllIlII[r.lIllIIIllIlll[4]] = r.llIIIlIlIIlIlll("LzQu", "jUZKP");
    }
    ...
    private static void llIIIlIlIIlllll() {
        ...
        r.lIllIIIllIlll[2] = " ".length();
        r.lIllIIIllIlll[3] = "  ".length();
        r.lIllIIIllIlll[4] = "   ".length();
    ...
    public boolean run() {
        ...
        Item llllllllllllllIllIIlIllIlIIlIlIl = Inventory.getFirst(item -> {
            ...
            if (r.llIIIlIlIlIIIIl(item.getName().equals(lIllIIIllIlII[lIllIIIllIlll[3]]) ? 1 : 0) && r.llIIIlIlIlIIIII(item.hasAction(lIllIIIllIlII[lIllIIIllIlll[4]]::equals) ? 1 : 0)) {
                ...
                "".length();
                if (null != null) {
                    return ((2 ^ 0x26 ^ (0xFA ^ 0x97)) & (0x6F ^ 0xC ^ (0xAB ^ 0x81) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIllIIIllIlll[0];
            }
