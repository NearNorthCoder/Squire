...
extends Task {
    ...
    private static void llIIIllIIIIlIIl() {
        ...
        C.lIllIIlIlIlII[1] = "   ".length() ^ (0x2D ^ 0x2B);
        C.lIllIIlIlIlII[2] = 0x16 ^ 0x10;
        C.lIllIIlIlIlII[3] = " ".length();
        C.lIllIIlIlIlII[4] = "  ".length();
        C.lIllIIlIlIlII[5] = "   ".length();
    }
    ...
    private static void llIIIllIIIIIlIl() {
        ...
        C.lIllIIlIlIIII[C.lIllIIlIlIlII[0]] = C.llIIIlIllllllll("8fdw4yRGM6A=", "pRZzS");
        C.lIllIIlIlIIII[C.lIllIIlIlIlII[3]] = C.llIIIllIIIIIlII("ETc9Ah4NMQ==", "cVSew");
        C.lIllIIlIlIIII[C.lIllIIlIlIlII[4]] = C.llIIIllIIIIIlII("IAs/JRotBA==", "BjLQs");
    }
