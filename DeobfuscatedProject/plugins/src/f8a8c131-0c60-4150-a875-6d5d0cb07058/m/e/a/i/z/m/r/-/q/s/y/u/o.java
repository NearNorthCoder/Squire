...
extends Task {
    ...
    private static void llIIIlIlIIIlIlI() {
        ...
        o.lIllIIIlIlllI[o.lIllIIIlIllll[0]] = o.llIIIlIlIIIIllI("0Ihotv8C3Sc=", "wGzfM");
    }
    ...
    private static void llIIIlIlIIIlIll() {
        ...
        o.lIllIIIlIllll[0] = (0x47 ^ 0x26 ^ (0x10 ^ 0x63)) & (0xE2 ^ 0x8D ^ (0xFC ^ 0x81) ^ -" ".length());
        o.lIllIIIlIllll[1] = "   ".length();
        o.lIllIIIlIllll[2] = " ".length();
        o.lIllIIIlIllll[3] = "  ".length();
    }
