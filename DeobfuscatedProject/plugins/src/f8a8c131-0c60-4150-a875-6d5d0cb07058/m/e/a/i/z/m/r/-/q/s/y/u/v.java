...
extends Task {
    ...
    private static void llIIIlIIllllIIl() {
        ...
        v.lIllIIIlIlIlI[v.lIllIIIlIlIll[0]] = v.llIIIlIIlllIlll("ChA2", "OqBDG");
        v.lIllIIIlIlIlI[v.lIllIIIlIlIll[2]] = v.llIIIlIIllllIII("xydPxwinKBc=", "PlDoS");
        v.lIllIIIlIlIlI[v.lIllIIIlIlIll[4]] = v.llIIIlIIllllIII("i6KladLUkx0=", "fCpkx");
    }
    ...
    private static void llIIIlIIllllIlI() {
        ...
        v.lIllIIIlIlIll[2] = " ".length();
        v.lIllIIIlIlIll[3] = 90 + 108 - 129 + 76 ^ 104 + 134 - 91 + 8;
        v.lIllIIIlIlIll[4] = "  ".length();
        v.lIllIIIlIlIll[5] = "   ".length();
