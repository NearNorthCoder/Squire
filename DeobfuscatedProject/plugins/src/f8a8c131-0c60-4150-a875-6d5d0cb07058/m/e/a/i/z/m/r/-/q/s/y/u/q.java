...
extends Task {
    ...
    private static void llIIIllIIllllII() {
        ...
        q.lIllIIllIIIlI[2] = "   ".length();
        q.lIllIIllIIIlI[3] = " ".length();
        q.lIllIIllIIIlI[4] = "  ".length();
    }
    ...
    private static void llIIIllIIlllIll() {
        ...
        q.lIllIIllIIIIl[q.lIllIIllIIIlI[0]] = q.llIIIllIIlllIlI("lY0OUGha7ck=", "bNuNq");
        q.lIllIIllIIIIl[q.lIllIIllIIIlI[3]] = q.llIIIllIIlllIlI("tWWU3rgwNKc=", "JlepP");
    }
