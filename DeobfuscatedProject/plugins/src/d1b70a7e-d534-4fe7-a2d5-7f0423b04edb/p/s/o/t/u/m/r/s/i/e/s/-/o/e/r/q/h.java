...
extends l {
    ...
    public boolean ak() {
        ...
        if (h.lIllIIlIIIlIIlI(this.ar.l() ? 1 : 0) && h.lIllIIlIIIlIIll(this.ar.L() ? 1 : 0) && h.lIllIIlIIIlIIlI(Inventory.contains(item -> {
            ...
            if (h.lIllIIlIIIlIIll(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                "".length();
                if (" ".length() != 0) return n2 != 0;
                return ((21 + 144 - 109 + 142 ^ 43 + 74 - 36 + 50) & (0x1D ^ 0x50 ^ (0x64 ^ 0x6C) ^ -" ".length())) != 0;
            }
        }
        n2 = lIIlllIIIIIll[0];
        return n2 != 0;
    ...
    private static void lIllIIlIIIlIIIl() {
        ...
        h.lIIlllIIIIIll[1] = "  ".length();
        h.lIIlllIIIIIll[2] = 0xFFFFF3DD & 0x6FFF;
        h.lIIlllIIIIIll[3] = " ".length();
        h.lIIlllIIIIIll[4] = 0xFFFFE7DC & 0x7BFF;
        h.lIIlllIIIIIll[5] = "   ".length();
    ...
    private static String lIllIIlIIIIIlll(String llllllllllllllIlllIllIIllIIllIII, String llllllllllllllIlllIllIIllIIlIlll) {
        ...
        while (h.lIllIIlIIIlIllI(llllllllllllllIlllIllIIllIIlIIIl, llllllllllllllIlllIllIIllIIlIIlI)) {
            ...
            "".length();
            if (((0x1C ^ 0x11 ^ (0x7F ^ 0x5C)) & (0x62 ^ 0x6E ^ (0x83 ^ 0xA1) ^ -" ".length())) < (0x5D ^ 0xB ^ (0xDC ^ 0x8E))) continue;
            return null;
        }
    ...
    private static void lIllIIlIIIIllII() {
        ...
        h.lIIlllIIIIIII[h.lIIlllIIIIIll[0]] = h.lIllIIlIIIIIlIl("aM33n4p8BXT3hT9c9uk4Gg==", "pYjeI");
        h.lIIlllIIIIIII[h.lIIlllIIIIIll[3]] = h.lIllIIlIIIIIllI("fFYI2fR7OFo=", "cUSIq");
        h.lIIlllIIIIIII[h.lIIlllIIIIIll[1]] = h.lIllIIlIIIIIlll("FCMfGi4=", "QNonW");
        h.lIIlllIIIIIII[h.lIIlllIIIIIll[5]] = h.lIllIIlIIIIIllI("W+U0CHs0IjAH6q0u18pRfg==", "bZAui");
        h.lIIlllIIIIIII[h.lIIlllIIIIIll[6]] = h.lIllIIlIIIIIlIl("Yv8cJ//X6ZfMl1kdPsLh0g==", "SzZgZ");
        h.lIIlllIIIIIII[h.lIIlllIIIIIll[8]] = h.lIllIIlIIIIIllI("gIGUu1uFk0o=", "obdPZ");
        h.lIIlllIIIIIII[h.lIIlllIIIIIll[9]] = h.lIllIIlIIIIIllI("EGn6/0sSqRg=", "qvgfu");
        h.lIIlllIIIIIII[h.lIIlllIIIIIll[10]] = h.lIllIIlIIIIIllI("0y8oc+1w4Pw=", "fsxiD");
        h.lIIlllIIIIIII[h.lIIlllIIIIIll[11]] = h.lIllIIlIIIIIlll("NQAWDR0=", "pmfyd");
    }
            ...
            if (h.lIllIIlIIIlIIll(Inventory.contains(item -> {
                ...
                if (h.lIllIIlIIIlIIlI(item.getName().contains(lIIlllIIIIIII[lIIlllIIIIIll[8]]) ? 1 : 0)) {
                    ...
                    if (h.lIllIIlIIIlIIll(item.hasAction(stringArray) ? 1 : 0)) {
                        n2 = lIIlllIIIIIll[3];
                        "".length();
                        if (((0x4A ^ 0xF ^ (0xDF ^ 0x96)) & (0xCF ^ 0x85 ^ (0x3C ^ 0x7A) ^ -" ".length())) == 0) return n2 != 0;
                        return ((0xBB ^ 0xB2 ^ (0x6E ^ 0x6B)) & (0x36 ^ 0x32 ^ (0x2A ^ 0x22) ^ -" ".length())) != 0;
                    }
                }
                n2 = lIIlllIIIIIll[0];
                return n2 != 0;
        ...
        TileObject llllllllllllllIlllIllIIlllIIIIII = TileObjects.getNearest(tileObject -> {
            ...
            if (h.lIllIIlIIIlIIlI(tileObject.getName().contains(lIIlllIIIIIII[lIIlllIIIIIll[5]]) ? 1 : 0)) {
                ...
                if (h.lIllIIlIIIlIIlI(tileObject.hasAction(stringArray) ? 1 : 0) && h.lIllIIlIIIlIllI(tileObject.getWorldLocation().distanceTo(this.ar.N().ag()), lIIlllIIIIIll[7])) {
                    ...
                    return ((45 + 74 - 99 + 116 ^ 59 + 55 - 79 + 98) & (86 + 58 - 79 + 83 ^ 110 + 67 - 151 + 127 ^ -" ".length())) != 0;
                }
            }
            n2 = lIIlllIIIIIll[0];
            return n2 != 0;
        ...
        int n2 = Inventory.getAll(item -> {
            ...
            if (h.lIllIIlIIIlIIlI(item.getName().contains(lIIlllIIIIIII[lIIlllIIIIIll[3]]) ? 1 : 0)) {
                ...
                if (h.lIllIIlIIIlIIll(item.hasAction(stringArray) ? 1 : 0)) {
                    n2 = lIIlllIIIIIll[3];
                    "".length();
                    if ("  ".length() < (0xE6 ^ 0xA1 ^ (9 ^ 0x4A))) return n2 != 0;
                    return ((195 + 180 - 343 + 219 ^ 26 + 159 - 83 + 59) & (7 ^ 0x19 ^ (0xFF ^ 0xBB) ^ -" ".length())) != 0;
                }
            }
            n2 = lIIlllIIIIIll[0];
            return n2 != 0;
