...
extends x {
    ...
    private static void lIllIIlIIIllIII() {
        ...
        v.lIIlllIIIIlII[v.lIIlllIIIIlIl[0]] = v.lIllIIlIIIlIlll("XzMH3brbAVdhDar3atMb9A==", "Kcvxz");
        v.lIIlllIIIIlII[v.lIIlllIIIIlIl[3]] = v.lIllIIlIIIlIlll("TyG9lV5RQBaSd4IgXd+JTQ==", "nEIOb");
    }

    private static void lIllIIlIIIllIIl() {
        lIIlllIIIIlIl = new int[6];
        v.lIIlllIIIIlIl[0] = (76 + 108 - 155 + 117 ^ 173 + 30 - 33 + 6) & (0xCB ^ 0x9E ^ (0xED ^ 0x9A) ^ -" ".length());
        v.lIIlllIIIIlIl[1] = 0xFFFFEC3F & 0x1FFF;
        v.lIIlllIIIIlIl[2] = -(0xFFFFF50F & 0x5AF1) & (0xFFFFDBBB & 0x7F5C);
        v.lIIlllIIIIlIl[3] = " ".length();
        v.lIIlllIIIIlIl[4] = 0xFFFFF95D & 0xA7FB;
        v.lIIlllIIIIlIl[5] = "  ".length();
    }
