...
extends l {
    ...
    @Override
    public boolean al() {
        f llllllllllllllIlllIllIIIIIIlIlll;
        if (f.lIllIIlIlIlIIlI(this.ar.L() ? 1 : 0)) {
            return lIIlllIIlIlIl[1];
        }
        int llllllllllllllIlllIllIIIIIIlIllI = llllllllllllllIlllIllIIIIIIlIlll.au.c();
        if (f.lIllIIlIlIlIIll(llllllllllllllIlllIllIIIIIIlIllI, lIIlllIIlIlIl[3])) {
            return lIIlllIIlIlIl[1];
        }
    ...
    private static void lIllIIlIlIlIIIl() {
        ...
        f.lIIlllIIlIlIl[0] = " ".length();
        f.lIIlllIIlIlIl[1] = (10 + 4 - -140 + 75 ^ 64 + 95 - 65 + 97) & (179 + 56 - 103 + 79 ^ 93 + 124 - 110 + 30 ^ -" ".length());
