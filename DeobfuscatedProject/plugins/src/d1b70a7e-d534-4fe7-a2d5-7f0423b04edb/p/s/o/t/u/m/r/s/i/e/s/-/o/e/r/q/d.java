...
extends Task {
    ...
    private static void lIllIIlIIlIIlII() {
        ...
        d.lIIlllIIIlIII[1] = " ".length();
        d.lIIlllIIIlIII[2] = "  ".length();
        d.lIIlllIIIlIII[3] = "   ".length();
    ...
    private static void lIllIIlIIlIIIll() {
        ...
        d.lIIlllIIIIlll[d.lIIlllIIIlIII[0]] = d.lIllIIlIIIlllll("BEt8hi1e/vQVCK2boMsKT5ASmU4bNbmF", "DEvuP");
        d.lIIlllIIIIlll[d.lIIlllIIIlIII[1]] = d.lIllIIlIIIlllll("B/w95jfvEygKPWKiRIa7OJV352puYt+SPf6JDJslRBA=", "NVWnV");
        d.lIIlllIIIIlll[d.lIIlllIIIlIII[2]] = d.lIllIIlIIlIIIlI("aUbxCS5uxks=", "tJbdP");
    }
}
