...
extends l {
    ...
    private static void lIllIIIlIlIIIII() {
        ...
        s.lIIllIllIlIlI[0] = " ".length();
        s.lIIllIllIlIlI[1] = (138 + 58 - 138 + 83 ^ 10 + 26 - -112 + 2) & (0x38 ^ 0x4A ^ (0xC4 ^ 0xAD) ^ -" ".length());
        s.lIIllIllIlIlI[2] = 0xFFFFEFBF & 0x1177;
        s.lIIllIllIlIlI[3] = "  ".length();
        s.lIIllIllIlIlI[4] = "   ".length();
    }
    ...
    private static void lIllIIIlIIlllll() {
        ...
        s.lIIllIllIIIlI[s.lIIllIllIlIlI[1]] = s.lIllIIIlIIIlIIl("qSB1YElik2Y=", "cozLK");
        s.lIIllIllIIIlI[s.lIIllIllIlIlI[0]] = s.lIllIIIlIIllllI("GBgsAw==", "LyGft");
        s.lIIllIllIIIlI[s.lIIllIllIlIlI[3]] = s.lIllIIIlIIIlIIl("L4ozuXwugU8=", "jvoVD");
    }
