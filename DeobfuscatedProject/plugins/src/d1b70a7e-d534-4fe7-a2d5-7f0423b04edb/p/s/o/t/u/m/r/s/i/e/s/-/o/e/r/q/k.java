...
extends l {
    ...
    private static void lIllIIlIlIIIlll() {
        ...
        k.lIIlllIIIlllI[k.lIIlllIIlIIIl[0]] = k.lIllIIlIlIIIlII("yY5al3QSIYs=", "iuTjo");
        k.lIIlllIIIlllI[k.lIIlllIIlIIIl[3]] = k.lIllIIlIlIIIllI("Dg00Fyc=", "JbAdB");
    }
    ...
    public boolean ak() {
        ...
        block2: {
            ...
            n2 = lIIlllIIlIIIl[3];
            "".length();
            if ("   ".length() < (0xC4 ^ 0xC0)) return n2 != 0;
    ...
    public boolean al() {
        ...
        if (k.lIllIIlIlIllIll(llllllllllllllIlllIllIIIIIIIIIIl)) {
            ...
            "".length();
            if (-" ".length() > " ".length()) {
                return ((0x5F ^ 0x43 ^ (0xA9 ^ 0x89)) & (57 + 137 - 137 + 116 ^ 80 + 139 - 80 + 6 ^ -" ".length())) != 0;
            }
        } else {
        ...
        if (k.lIllIIlIlIllIII(llllllllllllllIlllIlIllllllllllI22 = llllllllllllllIlllIlIlllllllllll.distanceTo((Locatable)v2), lIIlllIIlIIIl[12])) {
            if (k.lIllIIlIlIlIllI(Movement.shouldWalk() ? 1 : 0)) {
                ...
                if (k.lIllIIlIlIllIll(llllllllllllllIlllIllIIIIIIIIIIl)) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((0x89 ^ 0xA6 ^ (0x75 ^ 0x4D)) & (0x17 ^ 0x41 ^ (0x5E ^ 0x1F) ^ -" ".length())) != 0;
                    }
                } else {
