...
public class a {
    ...
    private static void lIllIIIlllIIIll() {
        ...
        a.lIIllIllllIII[0] = (85 + 153 - 159 + 105 ^ 34 + 23 - -11 + 62) & (0x4A ^ 7 ^ (0x56 ^ 0x21) ^ -" ".length());
        a.lIIllIllllIII[1] = " ".length();
        ...
        a.lIIllIllllIII[9] = "  ".length();
        a.lIIllIllllIII[10] = "   ".length();
    ...
    public boolean k() {
        ...
        if (a.lIllIIIlllIIlII(n4, lIIllIllllIII[5]) && (!a.lIllIIIlllIIlII(n3, lIIllIllllIII[6]) || a.lIllIIIlllIIlIl(n3, lIIllIllllIII[7]))) {
            ...
            "".length();
            if (" ".length() < 0) {
                return ((192 + 114 - 102 + 50 ^ 163 + 149 - 144 + 4) & (0x2A ^ 0x72 ^ (0x6D ^ 0x67) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIIllIllllIII[0];
        }
    ...
    public boolean q() {
        ...
        if (a.lIllIIIlllIlIII(this.f.numberOfBuckets(), this.p())) {
            ...
            "".length();
            if ("  ".length() < 0) {
                return ((0x3C ^ 0x24 ^ (0x3F ^ 0x61)) & (0x15 ^ 0xB ^ (0x65 ^ 0x3D) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIllIllllIII[0];
        }
    ...
    public boolean t() {
        ...
        block3: {
            ...
            "".length();
            if (-" ".length() < "  ".length()) return n2 != 0;
            return ((0x8C ^ 0xA1 ^ (0xEC ^ 0xA3)) & (0x55 ^ 0x62 ^ (0x1F ^ 0x4A) ^ -" ".length())) != 0;
        }
        n2 = lIIllIllllIII[0];
        return n2 != 0;
    }
    ...
    public boolean o() {
        ...
        if (a.lIllIIIlllIIlIl(this.f.numberOfBuckets(), this.n())) {
            bl = lIIllIllllIII[1];
            "".length();
            if (((0x39 ^ 0xE ^ (0xA3 ^ 0xB2)) & (0x56 ^ 0x5C ^ (0x23 ^ 0xF) ^ -" ".length())) == "  ".length()) {
                return ((0x44 ^ 0x6D ^ (0x70 ^ 1)) & (0xC0 ^ 0x8E ^ (0x97 ^ 0x81) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIllIllllIII[0];
        }
    ...
    private static void lIllIIIllIllIII() {
        ...
        a.lIIllIlllIllI[a.lIIllIllllIII[0]] = a.lIllIIIllIlIlIl("VqERF/Z9vKeZx6Hrc2L/XWYPwQTgPtKQ", "DCFOr");
        a.lIIllIlllIllI[a.lIIllIllllIII[1]] = a.lIllIIIllIlIllI("MCkICiYXeQAWKA88E1g7DCk=", "cYaxO");
        a.lIIllIlllIllI[a.lIIllIllllIII[9]] = a.lIllIIIllIlIlll("hawIWiuVRZTmNUBmzH7wRz+cD4gpSmfx", "lnyxG");
        a.lIIllIlllIllI[a.lIIllIllllIII[10]] = a.lIllIIIllIlIlIl("Fu5A0VE+M/s9T8cmd0/Kj4AQU/084zhp", "ETHyO");
        a.lIIllIlllIllI[a.lIIllIllllIII[13]] = a.lIllIIIllIlIlIl("KEQbJh1BAWwss8LePxxkpg==", "oSgTg");
        a.lIIllIlllIllI[a.lIIllIllllIII[14]] = a.lIllIIIllIlIlll("kbvZJYgv0u4HbbCRqr/Y2FQV+hSHvZBo", "HGpnL");
        a.lIIllIlllIllI[a.lIIllIllllIII[15]] = a.lIllIIIllIlIlll("uz5yA4tsyiXthNhccEEBwg==", "MKEAZ");
        a.lIIllIlllIllI[a.lIIllIllllIII[17]] = a.lIllIIIllIlIlll("ROEmPCnVDiw=", "LxFLo");
        a.lIIllIlllIllI[a.lIIllIllllIII[18]] = a.lIllIIIllIlIllI("fhU2CH4nEGhUcXJI", "BvYdC");
        a.lIIllIlllIllI[a.lIIllIllllIII[19]] = a.lIllIIIllIlIlll("DPmS47RX9lQ=", "gAfuR");
        a.lIIllIlllIllI[a.lIIllIllllIII[20]] = a.lIllIIIllIlIllI("UF0QIT5S", "lrsNR");
        a.lIIllIlllIllI[a.lIIllIllllIII[21]] = a.lIllIIIllIlIlll("sKGc9dQOECE=", "oUCnN");
        a.lIIllIlllIllI[a.lIIllIllllIII[22]] = a.lIllIIIllIlIlIl("33UaLRlDzGzLFyMr7XQsBokXzA9ljg8Dh6/a0ckxVx4=", "fLTpk");
        a.lIIllIlllIllI[a.lIIllIllllIII[23]] = a.lIllIIIllIlIllI("EwsEajgIEwRqIQIGETlqHgwUajkCABQ4Lwsa", "gcaJJ");
        a.lIIllIlllIllI[a.lIIllIllllIII[24]] = a.lIllIIIllIlIllI("HxsmcS8KBSZxKwcSLiJ4Ah03PngSHDY=", "ksCQX");
        a.lIIllIlllIllI[a.lIIllIllllIII[3]] = a.lIllIIIllIlIlll("6FT/A0+8myU3ZSurPGU3zQzcZQX5K8Db", "PhiAm");
        a.lIIllIlllIllI[a.lIIllIllllIII[16]] = a.lIllIIIllIlIllI("JgI/LBkG", "tgOMp");
        a.lIIllIlllIllI[a.lIIllIllllIII[25]] = a.lIllIIIllIlIlll("TGDJM7Sn9iw=", "gKtOt");
        a.lIIllIlllIllI[a.lIIllIllllIII[26]] = a.lIllIIIllIlIlIl("xtuPkJ7k+Yo=", "DpJtC");
        a.lIIllIlllIllI[a.lIIllIllllIII[27]] = a.lIllIIIllIlIllI("HBoCLBA=", "YwrXi");
        a.lIIllIlllIllI[a.lIIllIllllIII[28]] = a.lIllIIIllIlIlIl("2/7HPemkh/E=", "bgfTj");
        a.lIIllIlllIllI[a.lIIllIllllIII[29]] = a.lIllIIIllIlIllI("AzgqBgcENw==", "kYXvh");
        a.lIIllIlllIllI[a.lIIllIllllIII[30]] = a.lIllIIIllIlIlll("vkR8jiXmSeY=", "UArgI");
        a.lIIllIlllIllI[a.lIIllIllllIII[31]] = a.lIllIIIllIlIllI("CSsgMgVnIig8AQ==", "JCEQn");
    }
    ...
    public boolean l() {
        ...
        if (a.lIllIIIlllIIllI(this.m() ? 1 : 0) && a.lIllIIIlllIIllI(this.r() ? 1 : 0) && a.lIllIIIlllIIllI(this.q() ? 1 : 0)) {
            n2 = lIIllIllllIII[1];
            "".length();
            if (((150 + 214 - 202 + 56 ^ 132 + 70 - 112 + 64) & (0x20 ^ 0x57 ^ (0x42 ^ 0x75) ^ -" ".length())) >= "  ".length()) {
                return ((19 + 102 - 113 + 125 ^ 68 + 148 - 68 + 37) & (103 + 106 - 113 + 51 ^ 123 + 25 - 69 + 96 ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIIllIllllIII[0];
        }
    ...
    public boolean m() {
        ...
        if (!a.lIllIIIlllIIlll(Inventory.contains(item -> item.getName().toLowerCase().contains(lIIllIlllIllI[lIIllIllllIII[29]])) ? 1 : 0) || a.lIllIIIlllIIllI(Equipment.contains(item -> item.getName().toLowerCase().contains(lIIllIlllIllI[lIIllIllllIII[28]])) ? 1 : 0)) {
            ...
            "".length();
            if (null != null) {
                return ((68 + 88 - 30 + 60 ^ 18 + 90 - -17 + 28) & (108 + 52 - 19 + 19 ^ 33 + 69 - -12 + 17 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIllIllllIII[0];
        }
