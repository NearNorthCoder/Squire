...
extends Overlay {
    ...
    private static void lIIIIIl() {
        ...
        b.llII[b.llIl[0]] = b.llllll("6x5dwvBSPR4=", "DBSCr");
        b.llII[b.llIl[2]] = b.lIIIIII("ADcjKzo2ZhMjOypmFS49NjU=", "SFVBH");
        b.llII[b.llIl[3]] = b.llllll("FwcQ4i0Eo4k=", "DNyeY");
        b.llII[b.llIl[4]] = b.llllll("/YmwwbYkXxg=", "oCUiF");
        b.llII[b.llIl[5]] = b.lIIIIII("ERgyOAcxVg==", "BlSLr");
        b.llII[b.llIl[6]] = b.llllll("Le1AgekcXjgmPsCA3OyvJ4zYm3Q2v4QT", "Ostvn");
        b.llII[b.llIl[7]] = b.llllll("OuUwmUn+w6E=", "rkKqY");
    }

    private static void lIIIIlI() {
        llIl = new int[12];
        b.llIl[0] = (93 + 67 - 103 + 87 ^ 150 + 141 - 160 + 23) & (0x99 ^ 0x97 ^ (0x67 ^ 0x63) ^ -" ".length());
