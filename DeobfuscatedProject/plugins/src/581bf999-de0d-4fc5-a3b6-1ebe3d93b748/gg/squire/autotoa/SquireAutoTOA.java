...
extends SquirePlugin {
    ...
    public boolean a(int ... nArray) {
        return this.a((NPC nPC) -> {
            void llllllllllllllllIlIIIIlIIIIlIlIl;
            int[] nArray2 = nArray;
            int n2 = nArray2.length;
            int llllllllllllllllIlIIIIlIIIIlIlII = llIIIllIlll[0];
            while (SquireAutoTOA.lIIllllllllIll(llllllllllllllllIlIIIIlIIIIlIlII, (int)llllllllllllllllIlIIIIlIIIIlIlIl)) {
                void llllllllllllllllIlIIIIlIIIIlIlll;
                void llllllllllllllllIlIIIIlIIIIlIllI;
                void llllllllllllllllIlIIIIlIIIIlIIll = llllllllllllllllIlIIIIlIIIIlIllI[llllllllllllllllIlIIIIlIIIIlIlII];
                if (SquireAutoTOA.lIIlllllllllII((int)llllllllllllllllIlIIIIlIIIIlIIll, llllllllllllllllIlIIIIlIIIIlIlll.getId())) {
                    return llIIIllIlll[3];
                }
                ++llllllllllllllllIlIIIIlIIIIlIlII;
                "".length();
                if ("   ".length() > " ".length()) continue;
                return ((66 + 133 - 196 + 139 ^ 1 + 62 - -90 + 40) & (0x89 ^ 0xB9 ^ 6 + 69 - -34 + 18 ^ -" ".length())) != 0;
            }
    ...
    private static String lIIlllllIIlIlI(String llllllllllllllllIlIIIIIllllIIlII, String llllllllllllllllIlIIIIIllllIIIIl) {
        try {
            SecretKeySpec llllllllllllllllIlIIIIIllllIIlll = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllIlIIIIIllllIIIIl.getBytes(StandardCharsets.UTF_8)), llIIIllIlll[10]), "DES");
            Cipher llllllllllllllllIlIIIIIllllIIllI = Cipher.getInstance("DES");
            llllllllllllllllIlIIIIIllllIIllI.init(llIIIllIlll[4], llllllllllllllllIlIIIIIllllIIlll);
            return new String(llllllllllllllllIlIIIIIllllIIllI.doFinal(Base64.getDecoder().decode(llllllllllllllllIlIIIIIllllIIlII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public void a(ChatMessage chatMessage) {
        void llllllllllllllllIlIIIIlIIIlIllll;
        if (SquireAutoTOA.lIIllllllllIII(chatMessage.getMessage().startsWith(llIIIllIllI[llIIIllIlll[0]]) ? 1 : 0)) {
            this.z += llIIIllIlll[3];
            this.B = llIIIllIlll[0];
        }
        if (SquireAutoTOA.lIIllllllllIII(llllllllllllllllIlIIIIlIIIlIllll.getMessage().contains(llIIIllIllI[llIIIllIlll[3]]) ? 1 : 0)) {
            llllllllllllllllIlIIIIlIIIllIIII.A += llIIIllIlll[3];
            llllllllllllllllIlIIIIlIIIllIIII.B = llIIIllIlll[0];
        }
        if (SquireAutoTOA.lIIllllllllIII(llllllllllllllllIlIIIIlIIIlIllll.getMessage().contains(llIIIllIllI[llIIIllIlll[4]]) ? 1 : 0)) {
            llllllllllllllllIlIIIIlIIIllIIII.B += llIIIllIlll[3];
        }
    }
    ...
    private static void lIIlllllIIlIll() {
        ...
        SquireAutoTOA.llIIIllIllI[SquireAutoTOA.llIIIllIlll[0]] = SquireAutoTOA.lIIlllllIIlIII("ddmadRdPEgbM4oUgrLbHe7bLpLZ4489StCtKNkFh1ec=", "fhKOA");
        SquireAutoTOA.llIIIllIllI[SquireAutoTOA.llIIIllIlll[3]] = SquireAutoTOA.lIIlllllIIlIII("alr6kMfPrl+SB/6acWoSEdznZNJR4eUg", "GnoNW");
        SquireAutoTOA.llIIIllIllI[SquireAutoTOA.llIIIllIlll[4]] = SquireAutoTOA.lIIlllllIIlIIl("IyE3dS8bOCd1IxMrJg==", "zNBUG");
        SquireAutoTOA.llIIIllIllI[SquireAutoTOA.llIIIllIlll[5]] = SquireAutoTOA.lIIlllllIIlIlI("6iesftHNy8g=", "KqNyF");
    }
    ...
    public boolean a(Predicate<NPC> predicate) {
        ...
        if (SquireAutoTOA.lIIllllllllIIl(nPC2) && SquireAutoTOA.lIIllllllllIII(predicate.and(nPC -> {
            ...
            "".length();
            if (-"   ".length() > 0) {
                return ((50 + 45 - -4 + 29 ^ 81 + 80 - 21 + 57) & (0x2A ^ 0x77 ^ (0x3C ^ 0x24) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIIIllIlll[0];
        }
    ...
    private static String lIIlllllIIlIIl(String llllllllllllllllIlIIIIlIIIIIIllI, String llllllllllllllllIlIIIIlIIIIIIlIl) {
        llllllllllllllllIlIIIIlIIIIIIllI = new String(Base64.getDecoder().decode(llllllllllllllllIlIIIIlIIIIIIllI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        ...
        char[] llllllllllllllllIlIIIIIlllllllII = llllllllllllllllIlIIIIlIIIIIIllI.toCharArray();
        int llllllllllllllllIlIIIIIllllllIll = llllllllllllllllIlIIIIIlllllllII.length;
        int llllllllllllllllIlIIIIIllllllIlI = llIIIllIlll[0];
        while (SquireAutoTOA.lIIllllllllIll(llllllllllllllllIlIIIIIllllllIlI, llllllllllllllllIlIIIIIllllllIll)) {
            char llllllllllllllllIlIIIIlIIIIIIlll = llllllllllllllllIlIIIIIlllllllII[llllllllllllllllIlIIIIIllllllIlI];
            ...
            ++llllllllllllllllIlIIIIIllllllIlI;
            "".length();
            if ("   ".length() == "   ".length()) continue;
            return null;
        }
    ...
    private static String lIIlllllIIlIII(String llllllllllllllllIlIIIIIllllIllll, String llllllllllllllllIlIIIIIllllIlllI) {
        try {
            SecretKeySpec llllllllllllllllIlIIIIIlllllIlII = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllIlIIIIIllllIlllI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllIlIIIIIlllllIIll = Cipher.getInstance("Blowfish");
            llllllllllllllllIlIIIIIlllllIIll.init(llIIIllIlll[4], llllllllllllllllIlIIIIIlllllIlII);
            return new String(llllllllllllllllIlIIIIIlllllIIll.doFinal(Base64.getDecoder().decode(llllllllllllllllIlIIIIIllllIllll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIIlllllllIlll() {
        ...
        SquireAutoTOA.llIIIllIlll[0] = (124 + 19 - -26 + 20 ^ 121 + 132 - 144 + 32) & (5 ^ 0x54 ^ (0x74 ^ 0x15) ^ -" ".length());
        SquireAutoTOA.llIIIllIlll[1] = 161 + 9 - 107 + 116 ^ 30 + 37 - -34 + 28;
        SquireAutoTOA.llIIIllIlll[2] = 0xA8 ^ 0xB5 ^ (0x53 ^ 0x2F);
        SquireAutoTOA.llIIIllIlll[3] = " ".length();
        SquireAutoTOA.llIIIllIlll[4] = "  ".length();
        SquireAutoTOA.llIIIllIlll[5] = "   ".length();
        ...
        SquireAutoTOA.llIIIllIlll[21] = "   ".length() ^ (0x91 ^ 0x81);
        SquireAutoTOA.llIIIllIlll[22] = 0xA7 ^ 0xB0 ^ "   ".length();
        SquireAutoTOA.llIIIllIlll[23] = 0x7C ^ 1 ^ (0x2D ^ 0x45);
        SquireAutoTOA.llIIIllIlll[24] = 0x7B ^ 0x6D;
        SquireAutoTOA.llIIIllIlll[25] = 0x82 ^ 0x96 ^ "   ".length();
        ...
        SquireAutoTOA.llIIIllIlll[37] = 1 ^ 0x21 ^ "   ".length();
    ...
    protected void onStart() {
        try {
            SquireAutoTOA llllllllllllllllIlIIIIlIIIllIllI;
            llllllllllllllllIlIIIIlIIIllIllI.v = llIIIllIlll[0];
            llllllllllllllllIlIIIIlIIIllIllI.u = llIIIllIlll[0];
            llllllllllllllllIlIIIIlIIIllIllI.x = llIIIllIlll[0];
            llllllllllllllllIlIIIIlIIIllIllI.z = llIIIllIlll[0];
            llllllllllllllllIlIIIIlIIIllIllI.B = llIIIllIlll[0];
            llllllllllllllllIlIIIIlIIIllIllI.A = llIIIllIlll[0];
            llllllllllllllllIlIIIIlIIIllIllI.f.w();
            llllllllllllllllIlIIIIlIIIllIllI.i.w();
            llllllllllllllllIlIIIIlIIIllIllI.g.w();
            llllllllllllllllIlIIIIlIIIllIllI.j.register((Object)llllllllllllllllIlIIIIlIIIllIllI.f);
            llllllllllllllllIlIIIIlIIIllIllI.j.register((Object)llllllllllllllllIlIIIIlIIIllIllI.g);
            llllllllllllllllIlIIIIlIIIllIllI.j.register((Object)llllllllllllllllIlIIIIlIIIllIllI.h);
            llllllllllllllllIlIIIIlIIIllIllI.j.register((Object)llllllllllllllllIlIIIIlIIIllIllI.i);
            llllllllllllllllIlIIIIlIIIllIllI.j.register((Object)llllllllllllllllIlIIIIlIIIllIllI.t);
            llllllllllllllllIlIIIIlIIIllIllI.j.register((Object)llllllllllllllllIlIIIIlIIIllIllI.e);
            llllllllllllllllIlIIIIlIIIllIllI.k.add((Overlay)llllllllllllllllIlIIIIlIIIllIllI.l);
            "".length();
            llllllllllllllllIlIIIIlIIIllIllI.k.add((Overlay)llllllllllllllllIlIIIIlIIIllIllI.m);
            "".length();
            llllllllllllllllIlIIIIlIIIllIllI.k.add((Overlay)llllllllllllllllIlIIIIlIIIllIllI.n);
            "".length();
            llllllllllllllllIlIIIIlIIIllIllI.k.add((Overlay)llllllllllllllllIlIIIIlIIIllIllI.o);
            "".length();
            llllllllllllllllIlIIIIlIIIllIllI.k.add((Overlay)llllllllllllllllIlIIIIlIIIllIllI.p);
            "".length();
            llllllllllllllllIlIIIIlIIIllIllI.k.add((Overlay)llllllllllllllllIlIIIIlIIIllIllI.q);
            "".length();
            llllllllllllllllIlIIIIlIIIllIllI.k.add((Overlay)llllllllllllllllIlIIIIlIIIllIllI.r);
            "".length();
            llllllllllllllllIlIIIIlIIIllIllI.k.add((Overlay)llllllllllllllllIlIIIIlIIIllIllI.s);
            "".length();
            "".length();
        }
        catch (Exception llllllllllllllllIlIIIIlIIIllIlIl) {
            llllllllllllllllIlIIIIlIIIllIlIl.printStackTrace();
        }
        if (-" ".length() >= 0) {
            return;
        }
