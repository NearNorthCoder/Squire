...
extends aT {
    ...
    private static void lIlIlIIIlIlIlI() {
        ...
        aQ.llIllIIIIlI[aQ.llIllIIIlll[4]] = aQ.lIlIlIIIlIIlll("M7ulymWz7f1cvE9zu09O+g==", "KPsBM");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[2]] = aQ.lIlIlIIIlIlIIl("BRUuHCUpVBgbOCYYIA==", "GtLsJ");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[6]] = aQ.lIlIlIIIlIlIIl("MjAgJBsecQA5FQc9Jzk=", "pQBKt");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[8]] = aQ.lIlIlIIIlIlIII("HlwnyZQs6b60N/RILLkuFw==", "juhvt");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[9]] = aQ.lIlIlIIIlIIlll("UlZtNlpEY9Q=", "TBFbQ");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[10]] = aQ.lIlIlIIIlIIlll("Uc4k4wXL/mVnwl3Wfxzx2A==", "HAPBU");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[12]] = aQ.lIlIlIIIlIIlll("/UYzEVO2o+fW4o6M6GP54A==", "spYVO");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[13]] = aQ.lIlIlIIIlIIlll("nVao+ixZEjNsAVPVhOrlgg==", "VTetc");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[14]] = aQ.lIlIlIIIlIlIII("+QOFZR9YRA/jsdk3ubBEWw==", "hEixA");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[15]] = aQ.lIlIlIIIlIlIII("yqr2kEmorJcVE8UprKKSSA==", "EcXxu");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[16]] = aQ.lIlIlIIIlIlIII("sqyTbrQruBOjVRgE7ph45A==", "zlXyR");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[17]] = aQ.lIlIlIIIlIIlll("kXNuy7cjHjBfId7tjDWwUw==", "tjfZO");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[18]] = aQ.lIlIlIIIlIlIIl("CD4wMisvawAgLCQkLA==", "KKBAN");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[19]] = aQ.lIlIlIIIlIIlll("dN6+RqpjfzWAAOc4i1iDmw==", "GmWJu");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[20]] = aQ.lIlIlIIIlIlIII("tjaWY1FQv5WHalEseI5mQg==", "PIPOC");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[22]] = aQ.lIlIlIIIlIIlll("cMiavvhCf12cGA/8kVhICg==", "PTksv");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[23]] = aQ.lIlIlIIIlIlIII("QS3epBL9wIs8URMyxfHuyQ==", "NDwgN");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[24]] = aQ.lIlIlIIIlIlIII("yu8WOvATzGViSgJ1Wy1WlA==", "Lisok");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[25]] = aQ.lIlIlIIIlIlIIl("JzQkBBgLdRIDBQoiIxk=", "eUFkw");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[26]] = aQ.lIlIlIIIlIlIII("f7cL1+KeqkkgBmFVIHZq/A==", "SOJBg");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[27]] = aQ.lIlIlIIIlIlIIl("FzkzNzo7eAIwNDg5Pw==", "UXQXU");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[28]] = aQ.lIlIlIIIlIIlll("Y5ufYBbSLxH4z5/6ddqo/Q==", "wyjjJ");
        aQ.llIllIIIIlI[aQ.llIllIIIlll[29]] = aQ.lIlIlIIIlIlIII("qtuyiYFpEVnhs9QbUTnpoQ==", "Tfbhd");
    }
    ...
    public boolean bC() {
        ...
        if (aQ.lIlIlIIlIIIllI(this.p(worldPoint3) ? 1 : 0) && aQ.lIlIlIIlIIIlll(worldPoint2 = (WorldPoint)worldPoint3.createWorldArea(llIllIIIlll[2]).toWorldPointList().stream().filter(worldPoint -> {
            ...
            if (aQ.lIlIlIIlIIlIII(this.p((WorldPoint)worldPoint) ? 1 : 0)) {
                bl2 = llIllIIIlll[1];
                "".length();
                if (((0xB4 ^ 0xA8 ^ (0x1D ^ 0x4C)) & (0x28 ^ 0x2F ^ (0x5B ^ 0x11) ^ -" ".length())) > ((0x73 ^ 0x2A ^ (0x2B ^ 0x67)) & (0x50 ^ 2 ^ (0x68 ^ 0x2F) ^ -" ".length()))) {
                    return ((164 + 24 - 64 + 81 ^ 113 + 47 - 96 + 89) & (129 + 180 - 131 + 59 ^ 81 + 111 - 140 + 133 ^ -" ".length())) != 0;
                }
            } else {
                bl2 = llIllIIIlll[0];
            }
        ...
        if (aQ.lIlIlIIlIIlIII(TileObjects.getAll((String[])stringArray).isEmpty() ? 1 : 0) && (!aQ.lIlIlIIlIIlIIl(llllllllllllllllIIlIllllIIlllIll.distanceTo((Locatable)Players.getLocal()), llllllllllllllllIIlIllllIIllllIl.bg()) || aQ.lIlIlIIlIIlIII(Players.getLocal().getWorldArea().hasLineOfSightTo(llllllllllllllllIIlIllllIIllllIl.cu.getTopLevelWorldView(), llllllllllllllllIIlIllllIIlllIll.getWorldLocation()) ? 1 : 0))) {
            ...
            if (aQ.lIlIlIIlIIlIIl(llllllllllllllllIIlIllllIIllllIl.bg(), llIllIIIlll[4])) {
                ...
                "".length();
                if ("  ".length() <= 0) {
                    return ((0x68 ^ 0x27 ^ (0x20 ^ 0x52)) & (" ".length() ^ (0x1F ^ 0x23) ^ -" ".length())) != 0;
                }
            } else {
                n3 = llIllIIIlll[4];
            }
        ...
        if (!aQ.lIlIlIIlIIlIII(llllllllllllllllIIlIllllIIllllIl.ej.equals(llIllIIIIlI[llIllIIIlll[2]]) ? 1 : 0) || aQ.lIlIlIIlIIIllI(llllllllllllllllIIlIllllIIllllIl.ej.equals(llIllIIIIlI[llIllIIIlll[6]]) ? 1 : 0)) {
            ...
            "".length();
            if ("  ".length() != "  ".length()) {
                return ((89 + 78 - 123 + 108 ^ 130 + 159 - 275 + 159) & (0xA1 ^ 0xB0 ^ (0x85 ^ 0xA1) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIllIIIlll[0];
        }
        if (aQ.lIlIlIIlIIIllI(llllllllllllllllIIlIllllIIlllIIl = n2) && aQ.lIlIlIIlIIIllI(llllllllllllllllIIlIllllIIlllIlI2.canCast() ? 1 : 0)) {
            ...
            if (aQ.lIlIlIIlIIlIlI(Skills.getBoostedLevel((Skill)Skill.MAGIC), llIllIIIlll[7])) {
                ...
                if (-(0x27 ^ 0x36 ^ (0x3C ^ 0x29)) >= 0) {
                    return (((0x65 ^ 0x42) & ~(0x63 ^ 0x44) ^ (9 ^ 0x5E)) & (225 + 153 - 353 + 211 ^ 34 + 155 - 28 + 26 ^ -" ".length())) != 0;
                }
            } else {
            ...
            if (aQ.lIlIlIIlIIIllI(llllllllllllllllIIlIllllIIllllIl.ej.equals(llIllIIIIlI[llIllIIIlll[8]]) ? 1 : 0) && aQ.lIlIlIIlIIIllI(llllllllllllllllIIlIllllIIlllIII.canCast() ? 1 : 0)) {
                ...
                "".length();
                if ("   ".length() == " ".length()) {
                    return ((0x6B ^ 0x41 ^ (0x2E ^ 0)) & (0x5B ^ 0x6F ^ (0x89 ^ 0xB9) ^ -" ".length())) != 0;
                }
            } else {
    ...
    public ConfigStorageBox<EquipmentSetup> l(String string) {
        ...
        switch (string2.hashCode()) {
            case 1911983736: {
                ...
                "".length();
                if ("  ".length() > ((0x7C ^ 0x23) & ~(0x67 ^ 0x38))) break;
                return null;
            }
            case 618003550: {
                void llllllllllllllllIIlIllllIIlIIlll;
            ...
            case -857618786: {
                ...
                "".length();
                if (((0x79 ^ 0x47 ^ (0x68 ^ 0x5C)) & (0x99 ^ 0x89 ^ (0x92 ^ 0x88) ^ -" ".length())) == 0) break;
                return null;
            }
            case 1829704903: {
                void llllllllllllllllIIlIllllIIlIIlll;
    ...
    private static void lIlIlIIlIIIlII() {
        ...
        aQ.llIllIIIlll[0] = " ".length() & (" ".length() ^ -" ".length());
        aQ.llIllIIIlll[1] = " ".length();
        aQ.llIllIIIlll[2] = "   ".length();
        aQ.llIllIIIlll[3] = 0xF7 ^ 0x8C ^ (0xE3 ^ 0x81);
        aQ.llIllIIIlll[4] = "  ".length();
        ...
        aQ.llIllIIIlll[27] = "  ".length() ^ (0xD4 ^ 0xC0);
    ...
    private NPC bG() {
        ...
        NPC nPC2 = NPCs.getNearest(this.a(stringArray).and(nPC -> {
            ...
            if (aQ.lIlIlIIlIIlIII(this.ei.contains(nPC) ? 1 : 0)) {
                bl2 = llIllIIIlll[1];
                "".length();
                if ("  ".length() >= (151 + 118 - 207 + 92 ^ 35 + 6 - -115 + 2)) {
                    return ((0xA3 ^ 0xBE ^ (0xB2 ^ 0x9B)) & (2 + 167 - 17 + 39 ^ 47 + 119 - 33 + 6 ^ -" ".length())) != 0;
                }
            } else {
                bl2 = llIllIIIlll[0];
            }
            ...
            return llllllllllllllllIIlIllllIIlIllll.stream().max(Comparator.comparingInt(nPC -> {
                ...
                return NPCs.getAll(this.a(stringArray).and(nPC2 -> {
                    ...
                    if (aQ.lIlIlIIlIIlIlI(nPC2.getWorldLocation().distanceTo(nPC.getWorldLocation()), llIllIIIlll[4])) {
                        ...
                        "".length();
                        if (-" ".length() >= 0) {
                            return ((73 + 74 - 105 + 112 ^ 119 + 64 - 177 + 136) & (135 + 147 - 249 + 148 ^ 149 + 121 - 203 + 94 ^ -" ".length())) != 0;
                        }
                    } else {
                        bl2 = llIllIIIlll[0];
                    }
            ...
            return llllllllllllllllIIlIllllIIlIllll.stream().max(Comparator.comparingInt(nPC -> {
                ...
                return NPCs.getAll(this.a(stringArray).and(nPC2 -> {
                    ...
                    if (aQ.lIlIlIIlIIlIlI(nPC2.getWorldLocation().distanceTo(nPC.getWorldLocation()), llIllIIIlll[4])) {
                        ...
                        "".length();
                        if ("   ".length() == 0) {
                            return ((15 + 153 - 85 + 72 ^ 112 + 118 - 226 + 171) & (0x10 ^ 0x47 ^ (0x14 ^ 0x77) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl2 = llIllIIIlll[0];
                    }
