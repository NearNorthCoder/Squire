...
extends bm {
    ...
    private static void lIIlllIlllIlIl() {
        ...
        bp.llIIIlIIIlI[1] = (0x77 ^ 0x17 ^ (0x43 ^ 0x14)) & (176 + 240 - 218 + 49 ^ 184 + 139 - 162 + 31 ^ -" ".length());
        bp.llIIIlIIIlI[2] = " ".length();
        bp.llIIIlIIIlI[3] = -(0xFFFFFE4F & 0x53FD) & (0xFFFFFFFE & Short.MAX_VALUE);
        bp.llIIIlIIIlI[4] = 6 ^ 0xC;
        bp.llIIIlIIIlI[5] = "  ".length();
        bp.llIIIlIIIlI[6] = "   ".length();
    ...
    private static void lIIlllIlIlIIII() {
        ...
        bp.llIIIIlIIll[bp.llIIIlIIIlI[1]] = bp.lIIlllIlIIllIl("hGBPn2oJx0c=", "WgMOa");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[2]] = bp.lIIlllIlIIlllI("uvXPMU6W4vA=", "dNFKG");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[5]] = bp.lIIlllIlIIllIl("QBWZnu3exP0=", "rGDjI");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[6]] = bp.lIIlllIlIIlllI("TJfOoV1cMgI=", "WEnbo");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[7]] = bp.lIIlllIlIIllIl("rT0IUrxd3o8=", "GitCz");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[8]] = bp.lIIlllIlIIllIl("i6YbtQRI2mc=", "iKeKd");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[0]] = bp.lIIlllIlIIlllI("q/zJwv8uHKI=", "SJgOk");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[9]] = bp.lIIlllIlIIllll("BCI3PiYA", "wJVZI");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[11]] = bp.lIIlllIlIIlllI("PUogPx3ObX4trUGQLADo8SxogJX+Mb48z+dstPpfN5aHt9CacL3RvA8CX3Gy+Yeu", "CESov");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[12]] = bp.lIIlllIlIIllIl("t/golRo010I=", "hbObq");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[4]] = bp.lIIlllIlIIllIl("9MEWhUzGa2U=", "ITkVS");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[13]] = bp.lIIlllIlIIlllI("OKavc/v6VPk=", "eEArL");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[14]] = bp.lIIlllIlIIlllI("CzRu5eW38J8=", "tUgFx");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[15]] = bp.lIIlllIlIIllIl("xEygc1hDPTU=", "rIQff");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[16]] = bp.lIIlllIlIIllll("BQkYBA==", "Rlyva");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[17]] = bp.lIIlllIlIIllll("KSYx", "KIFUS");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[18]] = bp.lIIlllIlIIlllI("dKnvQxtdOVQ=", "CuTDT");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[19]] = bp.lIIlllIlIIllll("OA4MHjE=", "LatwR");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[20]] = bp.lIIlllIlIIllll("NTUsKAkvMw==", "AGELl");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[21]] = bp.lIIlllIlIIllIl("2Qfd4DADn5v+izNkDSBGIA==", "JsnTp");
        bp.llIIIIlIIll[bp.llIIIlIIIlI[22]] = bp.lIIlllIlIIllll("OyAKNh0wPAA=", "YLeAm");
    }
    ...
    private static String lIIlllIlIIllll(String llllllllllllllllIlIIIlIllIIllllI, String llllllllllllllllIlIIIlIllIIlllIl) {
        ...
        while (bp.lIIlllIlllllIl(llllllllllllllllIlIIIlIllIIlIlll, llllllllllllllllIlIIIlIllIIllIII)) {
            ...
            "".length();
            if (((0 ^ 0x4E ^ (0x14 ^ 0x12)) & (222 + 100 - 211 + 144 ^ 125 + 28 - -22 + 8 ^ -" ".length())) == 0) continue;
            return null;
        }
    ...
    private static /* synthetic */ boolean h(WorldPoint worldPoint, NPC nPC) {
        ...
        if (bp.lIIlllIlllllII(nPC.getId(), llIIIlIIIlI[3]) && bp.lIIlllIlllIlll(nPC.getWorldLocation().equals((Object)worldPoint) ? 1 : 0)) {
            ...
            "".length();
            if (-" ".length() > -" ".length()) {
                return ((0x13 ^ 7 ^ (0x8D ^ 0x83)) & (0xD3 ^ 0xB1 ^ (0x5C ^ 0x24) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIIIlIIIlI[1];
        }
