...
extends Z {
    ...
    public boolean bn() {
        ...
        TileItem llllllllllllllllIlIIIIIlllIIlIll = TileItems.getNearest(tileItem -> {
            ...
            if (ao.lIlIIIIIIIIIlI(tileItem.isTradable() ? 1 : 0) && ao.lIlIIIIIIIIIlI(Reachable.isInteractable((Locatable)tileItem) ? 1 : 0) && ao.lIlIIIIIIIIIll(tileItem.getName().equals(llIIlIIIIlI[llIIlIIIIll[7]]) ? 1 : 0)) {
                ...
                "".length();
                if ("  ".length() <= 0) {
                    return ((0x5F ^ 0x13 ^ (0x52 ^ 0x4A)) & (0x67 ^ 0x61 ^ (0x64 ^ 0x36) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIIlIIIIll[0];
            }
        ...
        if (ao.lIlIIIIIIIIIlI(llllllllllllllllIlIIIIIllIllIllI = n2)) {
            ...
            if (ao.lIlIIIIIIIIIlI((int)llllllllllllllllIlIIIIIllIllIlll) && ao.lIlIIIIIIIIIlI(llllllllllllllllIlIIIIIllIlllIIl.f((NPC)llllllllllllllllIlIIIIIllIlllIII) ? 1 : 0)) {
                ...
                if ("   ".length() <= ((167 + 108 - 111 + 34 ^ 97 + 114 - 105 + 30) & (137 + 26 - 10 + 56 ^ 157 + 97 - 97 + 2 ^ -" ".length()))) {
                    return ((166 + 4 - 25 + 79 ^ 132 + 6 - 33 + 72) & (12 + 92 - -54 + 58 ^ 65 + 107 - 155 + 120 ^ -" ".length())) != 0;
                }
            } else {
                n3 = llIIlIIIIll[0];
            }
    ...
    private static void lIlIIIIIIIIIII() {
        ...
        ao.llIIlIIIIlI[ao.llIIlIIIIll[0]] = ao.lIIlllllllllIl("WTex+RfbxBs=", "RpEuv");
        ao.llIIlIIIIlI[ao.llIIlIIIIll[1]] = ao.lIIlllllllllIl("vgCXZmFPsCdfvdmyaj2w/dauTeNVGGxu", "GQuzP");
        ao.llIIlIIIIlI[ao.llIIlIIIIll[6]] = ao.lIIllllllllllI("Nr5/DVDrLsnHxfE4EOOY5A==", "XLAwp");
        ao.llIIlIIIIlI[ao.llIIlIIIIll[7]] = ao.lIIlllllllllll("DCoSGQ==", "ZCsuZ");
    }
    ...
    private static void lIlIIIIIIIIIIl() {
        ...
        ao.llIIlIIIIll[0] = (0xD6 ^ 0x84 ^ (0xAD ^ 0xA6)) & (181 + 113 - 278 + 205 ^ 87 + 80 - 42 + 7 ^ -" ".length());
        ao.llIIlIIIIll[1] = " ".length();
        ...
        ao.llIIlIIIIll[6] = "  ".length();
        ao.llIIlIIIIll[7] = "   ".length();
    ...
    public boolean f(NPC nPC) {
        ...
        while (ao.lIlIIIIIIIIlIl(llllllllllllllllIlIIIIIllIlIIIlI, llllllllllllllllIlIIIIIllIlIIIll)) {
            ...
            return ((0x13 ^ 0x7A ^ (0xA8 ^ 0xA0)) & (0x79 ^ 0x3C ^ (0x41 ^ 0x65) ^ -" ".length())) != 0;
        }
        return llIIlIIIIll[1];
    }
    ...
    public boolean e(boolean bl2) {
        ...
        if (ao.lIlIIIIIIIlIIl(this.bs())) {
            ...
            "".length();
            if (null != null) {
                return ((69 + 1 - -29 + 57 ^ 76 + 13 - -26 + 20) & (58 + 42 - 58 + 147 ^ 81 + 72 - 146 + 159 ^ -" ".length())) != 0;
            }
        } else {
