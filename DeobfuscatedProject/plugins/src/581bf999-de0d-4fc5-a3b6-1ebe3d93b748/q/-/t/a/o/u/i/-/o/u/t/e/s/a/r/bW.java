...
extends W {
    ...
    public void a(ProjectileSpawned projectileSpawned) {
        void llllllllllllllllIlIlIIllllllllII;
        ...
        } else if (bW.lIIlIlIlllIlll(f.E.contains(llllllllllllllllIlIlIIllllllllII.getProjectile().getId()) ? 1 : 0)) {
    ...
    public List<Prayer> aN() {
        bW llllllllllllllllIlIlIlIIIIIIIIlI;
        void llllllllllllllllIlIlIlIIIIIIIIIl;
        NPC nPC = this.cm.b();
        if (bW.lIIlIlIlllIlII(nPC)) {
            return List.of(this.aQ(), this.dE);
        }
        int llllllllllllllllIlIlIlIIIIIIIIII = llllllllllllllllIlIlIlIIIIIIIIIl.getHealthRatio() * lIllIIlIIlI[0] / llllllllllllllllIlIlIlIIIIIIIIIl.getHealthScale();
        if (bW.lIIlIlIlllIlIl(Static.getClient().getTickCount(), llllllllllllllllIlIlIlIIIIIIIIlI.hh) && bW.lIIlIlIlllIllI(llllllllllllllllIlIlIlIIIIIIIIII, lIllIIlIIlI[1])) {
            return List.of(llllllllllllllllIlIlIlIIIIIIIIlI.aQ(), Prayer.PROTECT_FROM_MAGIC);
        }
        return List.of(this.aQ(), this.dE);
    }
