...
extends Z {
    ...
    private static void lIIllllIllllII() {
        ...
        ah.llIIIllIIll[0] = "   ".length();
        ah.llIIIllIIll[1] = (0x98 ^ 0xB3 ^ (0x54 ^ 0x6A)) & (109 + 103 - 137 + 135 ^ 12 + 43 - 1 + 145 ^ -" ".length());
        ah.llIIIllIIll[2] = " ".length();
        ah.llIIIllIIll[3] = "  ".length();
    ...
    private static void lIIllllIlllIll() {
        ...
        ah.llIIIllIIlI[ah.llIIIllIIll[1]] = ah.lIIllllIlllIIl("HQgQLx0=", "YzyAv");
        ah.llIIIllIIlI[ah.llIIIllIIll[2]] = ah.lIIllllIlllIlI("bV2ODZGZw28=", "EGptN");
        ah.llIIIllIIlI[ah.llIIIllIIll[3]] = ah.lIIllllIlllIIl("NTMoABER", "fRFft");
        ah.llIIIllIIlI[ah.llIIIllIIll[0]] = ah.lIIllllIlllIlI("FOXYuzj3NGU=", "ItXsJ");
    }
    ...
    public boolean run() {
        ...
        while (ah.lIIllllIlllllI(llllllllllllllllIlIIIIllIllIIIII, llllllllllllllllIlIIIIllIllIIIIl22)) {
            ...
            return ((0x4F ^ 0x67 ^ (0x14 ^ 0x36)) & (0x8B ^ 0x8C ^ (0x8A ^ 0x87) ^ -" ".length())) != 0;
        }
        ...
        if (!ah.lIIlllllIIIIII(llllllllllllllllIlIIIIllIllIIlIl.aX()) || ah.lIIlllllIIIIIl(NPCs.getNearest(nPC -> {
            ...
            "".length();
            if (-"  ".length() > 0) {
                return ((0xE4 ^ 0xAA ^ (0x5F ^ 0x3A)) & (21 + 128 - 106 + 89 ^ 3 + 8 - -37 + 127 ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIIIllIIll[1];
        }
