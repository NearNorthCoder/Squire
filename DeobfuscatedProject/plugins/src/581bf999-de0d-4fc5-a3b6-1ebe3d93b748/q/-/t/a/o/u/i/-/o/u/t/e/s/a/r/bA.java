...
extends bG {
    ...
    private static void lIIllIIlllIIlI() {
        ...
        bA.lIlllIllIIl[bA.lIlllIllIlI[0]] = bA.lIIllIIllIlllI("Ii0fLTQ=", "uDzAP");
        bA.lIlllIllIIl[bA.lIlllIllIlI[6]] = bA.lIIllIIllIlllI("MiMQOg8=", "vQyTd");
        bA.lIlllIllIIl[bA.lIlllIllIlI[4]] = bA.lIIllIIllIlllI("Fy0eBQg9", "VYjdk");
        bA.lIlllIllIIl[bA.lIlllIllIlI[16]] = bA.lIIllIIllIlllI("FjsdKUolJgAmDzYgBiAPdScfLR07MQs=", "UToLj");
        bA.lIlllIllIIl[bA.lIlllIllIlI[17]] = bA.lIIllIIllIllll("0PUbl4fI3Ls=", "CbGVm");
        bA.lIlllIllIIl[bA.lIlllIllIlI[19]] = bA.lIIllIIlllIIIl("rkzr3MKVIpE=", "Bocnt");
        bA.lIlllIllIIl[bA.lIlllIllIlI[20]] = bA.lIIllIIllIlllI("AjAaCC8o", "CDniL");
    }
    ...
    public boolean bl() {
        ...
        if ((!bA.lIIllIIlllIlIl(llllllllllllllllIlIIllIIIlIllIll) || bA.lIIllIIllllIII(n2)) && bA.lIIllIIllllIIl(llllllllllllllllIlIIllIIIlIlllIl.cu.getTickCount() - llllllllllllllllIlIIllIIIlIlllIl.fU, lIlllIllIlI[8] + (llllllllllllllllIlIIllIIIlIlllIl.fV - lIlllIllIlI[6]) * lIlllIllIlI[9])) {
            ...
            if (bA.lIIllIIllllIlI(llllllllllllllllIlIIllIIIlIlllIl.cW.overlyDraining() ? 1 : 0)) {
                ...
                "".length();
                if (null != null) {
                    return ((102 + 150 - 150 + 58 ^ 81 + 130 - 144 + 71) & (0x6C ^ 0x1A ^ (0x4C ^ 0x10) ^ -" ".length())) != 0;
                }
            } else {
                bl2 = lIlllIllIlI[0];
            }
    ...
    private static void lIIllIIlllIlII() {
        ...
        bA.lIlllIllIlI[3] = -" ".length();
        bA.lIlllIllIlI[4] = "  ".length();
        bA.lIlllIllIlI[5] = -(0xFFFFF90F & 0x56F2) & (0xFFFFFE1F & 0x7FFD);
        bA.lIlllIllIlI[6] = " ".length();
    ...
    public boolean bk() {
        ...
        if (!bA.lIIllIIlllIlIl(NPCs.getNearest((String[])stringArray)) || !bA.lIIllIIllllIll(NPCs.getNearest(nPC -> {
            ...
            bl2 = lIlllIllIlI[6];
            "".length();
            if (((184 + 110 - 191 + 85 ^ 49 + 68 - 91 + 158) & (0x36 ^ 0x10 ^ (0x62 ^ 0x40) ^ -" ".length())) != 0) {
                return ((0x5E ^ 0x56 ^ (0x5E ^ 0x47)) & (0x68 ^ 0x40 ^ (0xAA ^ 0x93) ^ -" ".length())) != 0;
            }
        } else {
            bl2 = lIlllIllIlI[0];
        }
