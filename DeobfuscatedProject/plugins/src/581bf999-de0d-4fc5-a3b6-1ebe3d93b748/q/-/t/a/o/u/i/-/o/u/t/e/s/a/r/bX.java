...
extends ao {
    ...
    private static void lIlIIlIIIIIIlI() {
        ...
        bX.llIIlllllll[bX.llIlIIIIIII[2]] = bX.lIlIIIllllllll("MC8PEjgLOBdXKxYzEAMpCA==", "dJcwH");
        bX.llIIlllllll[bX.llIlIIIIIII[4]] = bX.lIlIIIllllllll("MAc/IgBMJyUk", "arVAk");
        bX.llIIlllllll[bX.llIlIIIIIII[1]] = bX.lIlIIIllllllll("LSQHGRUHJQ==", "nVhwq");
        bX.llIIlllllll[bX.llIlIIIIIII[6]] = bX.lIlIIIllllllll("FhIoBSEtBCs=", "YaEpL");
        bX.llIIlllllll[bX.llIlIIIIIII[7]] = bX.lIlIIlIIIIIIII("5qn6xpLYIgbK20YFwSLDsmc7KmGMdnWX", "HnpIy");
        bX.llIIlllllll[bX.llIlIIIIIII[8]] = bX.lIlIIlIIIIIIII("wvJXLzD72Tv/rJ9ug031tQ==", "FkyEA");
        bX.llIIlllllll[bX.llIlIIIIIII[9]] = bX.lIlIIIllllllll("CSUlKzN1PCkpLj0=", "XPLHX");
        bX.llIIlllllll[bX.llIlIIIIIII[10]] = bX.lIlIIIllllllll("GRAQKwZlCRwpGy0=", "HeyHm");
        bX.llIIlllllll[bX.llIlIIIIIII[11]] = bX.lIlIIlIIIIIIIl("L8necxOGcoI=", "hvzTR");
        bX.llIIlllllll[bX.llIlIIIIIII[17]] = bX.lIlIIlIIIIIIIl("YRB1S/iAtkL70oUPQim8Lw==", "ILuAl");
    }
    ...
    public WorldPoint a(WorldPoint worldPoint3, WorldPoint worldPoint4, Predicate<WorldPoint> predicate, Comparator<WorldPoint> comparator) {
        ...
        return worldArea.toWorldPointList().stream().filter(worldPoint -> {
            ...
            if (bX.lIlIIlIIIIlIlI(this.k(list, (WorldPoint)worldPoint) ? 1 : 0)) {
                ...
                "".length();
                if (null != null) {
                    return ((0x4B ^ 0x6E ^ (0x8C ^ 0x9A)) & (100 + 24 - 106 + 121 ^ 101 + 76 - 52 + 59 ^ -" ".length())) != 0;
                }
            } else {
                bl2 = llIlIIIIIII[2];
            }
            ...
            if (bX.lIlIIlIIIIlIlI(worldArea2.isInMeleeDistance(worldPoint) ? 1 : 0)) {
                ...
                "".length();
                if (null != null) {
                    return ((0xB6 ^ 0xC3 ^ (0xB5 ^ 0x89)) & (0x24 ^ 0x72 ^ (0xBC ^ 0xA3) ^ -" ".length())) != 0;
                }
            } else {
                bl2 = llIlIIIIIII[2];
            }
    ...
    public boolean P(WorldPoint worldPoint) {
        ...
        if (bX.lIlIIlIIIIlIlI(this.p(worldPoint) ? 1 : 0) && bX.lIlIIlIIIIlIlI(worldArea.isInMeleeDistance(worldPoint) ? 1 : 0) && bX.lIlIIlIIIIlIll(worldArea.distanceTo2D(worldPoint), llIlIIIIIII[4])) {
            ...
            "".length();
            if ("   ".length() == 0) {
                return ((0x78 ^ 4 ^ (0x1D ^ 0x4C)) & (0x63 ^ 0x27 ^ (0xD7 ^ 0xBE) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIlIIIIIII[2];
        }
    ...
    private static void lIlIIlIIIIIIll() {
        ...
        bX.llIlIIIIIII[1] = "  ".length();
        bX.llIlIIIIIII[2] = (243 + 80 - 170 + 100 ^ 147 + 161 - 153 + 10) & (28 + 168 - 90 + 135 ^ 112 + 62 - 41 + 36 ^ -" ".length());
        bX.llIlIIIIIII[3] = 0xFFFFFDEB & 0x2F9F;
        bX.llIlIIIIIII[4] = " ".length();
        bX.llIlIIIIIII[5] = -(0xFFFFCD67 & 0x72DB) & (0xFFFFFDEF & 0x6FFB);
        bX.llIlIIIIIII[6] = "   ".length();
        ...
        bX.llIlIIIIIII[11] = 0x28 ^ 0x22 ^ "  ".length();
    ...
    public boolean bk() {
        ...
        while (bX.lIlIIlIIIIIlIl(llllllllllllllllIIlllIIlllIIIllI, (int)llllllllllllllllIIlllIIlllIIIlll)) {
            ...
            "".length();
            if (((0xBD ^ 0x98 ^ (0x89 ^ 0x8D)) & (0x50 ^ 0x6C ^ (0x17 ^ 0xA) ^ -" ".length())) <= "  ".length()) continue;
            return ((95 + 53 - 39 + 43 ^ 127 + 54 - 111 + 101) & ("   ".length() ^ (0xAE ^ 0x9E) ^ -" ".length())) != 0;
        }
    ...
    public List<WorldPoint> cE() {
        ...
        while (bX.lIlIIlIIIIlIIl(llllllllllllllllIIlllIIllIllIIII.hasNext() ? 1 : 0)) {
            ...
            "".length();
            if ("  ".length() < (13 + 34 - -66 + 83 ^ 168 + 58 - 86 + 52)) continue;
            return null;
        }
        return arrayList;
    }
