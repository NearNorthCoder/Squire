...
extends Z {
    ...
    public boolean run() {
        ...
        if (ag.lIIlllIIIIIlII(this.aq() ? 1 : 0)) {
            ...
            "".length();
            if (-" ".length() >= 0) {
                return ((171 + 118 - 154 + 38 ^ 9 + 48 - 48 + 123) & (49 + 20 - 67 + 184 ^ 113 + 114 - 196 + 116 ^ -" ".length())) != 0;
            }
        } else {
        ...
        Item llllllllllllllllIlIIlIIIlIlIIllI = Inventory.getFirst(item -> {
            ...
            if (!ag.lIIlllIIIIlIII(e.TEARS_OF_ELIDINIS.d(item.getId()) ? 1 : 0) || !ag.lIIlllIIIIlIII(item.getName().contains(lIllllllllI[llIIIIIIIII[2]]) ? 1 : 0) || !ag.lIIlllIIIIlIII(item.getName().contains(lIllllllllI[llIIIIIIIII[3]]) ? 1 : 0) || ag.lIIlllIIIIIlII(item.getName().contains(lIllllllllI[llIIIIIIIII[4]]) ? 1 : 0)) {
                ...
                "".length();
                if (null != null) {
                    return ((18 + 124 - 5 + 1 ^ 146 + 13 - 115 + 146) & (0x3E ^ 0x48 ^ (0x6D ^ 0x2F) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIIIIIIIII[1];
            }
    ...
    private static void lIIlllIIIIIIlI() {
        ...
        ag.lIllllllllI[ag.llIIIIIIIII[1]] = ag.lIIlllIIIIIIII("1Vyk2VvmbfI=", "VJued");
        ag.lIllllllllI[ag.llIIIIIIIII[2]] = ag.lIIlllIIIIIIII("fOTlfsg4pFI=", "VfPOb");
        ag.lIllllllllI[ag.llIIIIIIIII[3]] = ag.lIIlllIIIIIIIl("XTO7Man8j7o=", "dslnh");
        ag.lIllllllllI[ag.llIIIIIIIII[4]] = ag.lIIlllIIIIIIII("1+g+uqWDCAU=", "rljNA");
    }
    ...
    private static void lIIlllIIIIIIll() {
        ...
        ag.llIIIIIIIII[1] = "  ".length() & ("  ".length() ^ -" ".length());
        ag.llIIIIIIIII[2] = " ".length();
        ag.llIIIIIIIII[3] = "  ".length();
        ag.llIIIIIIIII[4] = "   ".length();
