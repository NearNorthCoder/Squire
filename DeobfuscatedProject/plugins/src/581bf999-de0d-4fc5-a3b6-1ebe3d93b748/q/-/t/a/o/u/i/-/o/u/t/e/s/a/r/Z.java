...
extends Task {
    ...
    public boolean bc() {
        ...
        if (Z.lIlIIllIlIllII(llllllllllllllllIIllIlIIIIlllIlI.bb() ? 1 : 0) && Z.lIlIIllIlIllII(llllllllllllllllIIllIlIIIIlllIlI.j(llIlIlIIlIl[18]) ? 1 : 0) && Z.lIlIIllIlIllII(llllllllllllllllIIllIlIIIIlllIlI.j(llIlIlIIlIl[19]) ? 1 : 0) && Z.lIlIIllIlIllII(llllllllllllllllIIllIlIIIIlllIlI.j(llIlIlIIlIl[20]) ? 1 : 0)) {
            ...
            "".length();
            if (" ".length() != " ".length()) {
                return ((0xF0 ^ 0x90 ^ (0xA ^ 0x44)) & (142 + 135 - 214 + 103 ^ 119 + 77 - 153 + 93 ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIlIlIIlIl[0];
        }
    ...
    private List<WorldPoint> a(WorldPoint worldPoint, WorldPoint worldPoint3, Predicate<WorldPoint> predicate) {
        ...
        while (Z.lIlIIllIlIllII(llllllllllllllllIIllIlIIIIIIllII.isEmpty() ? 1 : 0)) {
            ...
            if (Z.lIlIIllIllIIIl(llllllllllllllllIIllIlIIIIIIllII.size(), llIlIlIIlIl[14])) {
                "".length();
                if (((0x62 ^ 0x73 ^ (0x1C ^ 0x23)) & (0x49 ^ 0x27 ^ (0xF3 ^ 0xB3) ^ -" ".length())) < "  ".length()) break;
                return null;
            }
    ...
    public boolean bf() {
        ...
        if (Z.lIlIIllIlIllIl(this.bd())) {
            bl2 = llIlIlIIlIl[1];
            "".length();
            if (((52 + 105 - 81 + 95 ^ 119 + 17 - 121 + 118) & (85 + 183 - 119 + 39 ^ 140 + 18 - 138 + 126 ^ -" ".length())) != 0) {
                return ((0x39 ^ 0x48 ^ (0xF1 ^ 0xB6)) & (50 + 117 - 54 + 23 ^ 77 + 126 - 106 + 93 ^ -" ".length())) != 0;
            }
        } else {
            bl2 = llIlIlIIlIl[0];
        }
    ...
    public boolean ba() {
        ...
        if (Z.lIlIIllIlIIlll(Prayers.getPoints(), llIlIlIIlIl[6])) {
            llllllllllllllllIIllIlIIIIllllll2 = Inventory.getFirst(item -> {
                ...
                if (!Z.lIlIIllIlIllII(e.TEARS_OF_ELIDINIS.d(item.getId()) ? 1 : 0) || !Z.lIlIIllIlIllII(item.getName().contains(llIlIlIIlII[llIlIlIIlIl[45]]) ? 1 : 0) || !Z.lIlIIllIlIllII(item.getName().contains(llIlIlIIlII[llIlIlIIlIl[46]]) ? 1 : 0) || Z.lIlIIllIlIlIll(item.getName().contains(llIlIlIIlII[llIlIlIIlIl[47]]) ? 1 : 0)) {
                    ...
                    "".length();
                    if (" ".length() >= "   ".length()) {
                        return ((8 ^ 0x5F ^ (0x83 ^ 0xC3)) & (118 + 95 - 79 + 42 ^ 126 + 0 - 9 + 50 ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = llIlIlIIlIl[0];
                }
        ...
        if (Z.lIlIIllIlIlIll(llllllllllllllllIIllIlIIIlIIIIII.aZ() ? 1 : 0)) {
            ...
            "".length();
            if (" ".length() <= 0) {
                return ((166 + 57 - 52 + 44 ^ 134 + 28 - 111 + 95) & (0x4C ^ 0x23 ^ (0x86 ^ 0xAC) ^ -" ".length())) != 0;
            }
        } else {
        ...
        if (Z.lIlIIllIlIlIll(llllllllllllllllIIllIlIIIlIIIIII.d.overlyDraining() ? 1 : 0)) {
            ...
            if (Z.lIlIIllIlIlIll(llllllllllllllllIIllIlIIIlIIIIII.aZ() ? 1 : 0)) {
                n3 = llIlIlIIlIl[14];
                "".length();
                if (((0x3A ^ 0x30 ^ (0x35 ^ 0x6A)) & (62 + 32 - 2 + 104 ^ 11 + 63 - -61 + 10 ^ -" ".length())) < 0) {
                    return ((0x20 ^ 0x2C ^ (0x74 ^ 0x24)) & (198 + 216 - 284 + 111 ^ 90 + 65 - -15 + 3 ^ -" ".length())) != 0;
                }
            } else {
    ...
    private static void lIlIIllIlIIllI() {
        ...
        Z.llIlIlIIlIl[0] = (105 + 61 - 66 + 44 ^ 23 + 88 - 30 + 112) & (0x2E ^ 0x34 ^ (0xD9 ^ 0x92) ^ -" ".length());
        Z.llIlIlIIlIl[1] = " ".length();
    ...
    public boolean be() {
        ...
        if (Z.lIlIIllIlIllIl(nPC) && Z.lIlIIllIlIlIII(nPC.getAnimation(), llIlIlIIlIl[29])) {
            ...
            if (-(98 + 12 - 58 + 127 ^ 61 + 182 - 85 + 25) > 0) {
                return ((0x3A ^ 0x52 ^ (0x4A ^ 0x73)) & (0xE1 ^ 0x99 ^ (0x71 ^ 0x58) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIlIlIIlIl[0];
        }
    ...
    protected void b(Predicate<Item> predicate) {
        Item item2 = Inventory.getAll(item -> {
            ...
            if (Z.lIlIIllIlIlIll(item.hasAction(stringArray) ? 1 : 0) && Z.lIlIIllIlIlIll(item.getName().contains(llIlIlIIlII[llIlIlIIlIl[44]]) ? 1 : 0)) {
                ...
                "".length();
                if (null != null) {
                    return ((0x75 ^ 0x4C ^ (0x19 ^ 0x2B)) & (0x93 ^ 0xAD ^ (0x47 ^ 0x72) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIlIlIIlIl[0];
            }
    ...
    private static void lIlIIllIlIIlIl() {
        ...
        Z.llIlIlIIlII[Z.llIlIlIIlIl[0]] = Z.lIlIIllIlIIIlI("CTgABB8=", "MJijt");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[1]] = Z.lIlIIllIlIIIlI("FyMuHA8=", "SQGrd");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[8]] = Z.lIlIIllIlIIIll("0FOHyzYsQvo=", "nbxqb");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[27]] = Z.lIlIIllIlIIIll("RhWanhVlUQk9Qxg6LLo8ng==", "TCcor");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[23]] = Z.lIlIIllIlIIIlI("DCYTCi8WIA==", "xTznJ");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[5]] = Z.lIlIIllIlIIIlI("ITo1FjggJy0=", "BHZeK");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[30]] = Z.lIlIIllIlIIlII("FIXiF7io8bQ=", "YxTyM");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[31]] = Z.lIlIIllIlIIIll("9li/5RzXqeY=", "hFtiO");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[32]] = Z.lIlIIllIlIIIlI("CikOAz4O", "yAogQ");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[34]] = Z.lIlIIllIlIIIll("p9Df9lDx54wI1T5O6PiFqQ==", "vErJH");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[33]] = Z.lIlIIllIlIIlII("cZ1wmem4x0DFebU+pNkD1Q==", "NumEa");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[35]] = Z.lIlIIllIlIIIll("/XpO/h2rOd8SIfD3cDIqAfgFkSiecXYPvfDnAMbcREtn5xS8FeuO9DTpKIpqdS97amiQa4efO2Fhn8ebmHr2ig==", "cEHEi");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[36]] = Z.lIlIIllIlIIIlI("NhkrNQ==", "rkDEa");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[37]] = Z.lIlIIllIlIIlII("uB42NwTWps9EOQ3g+JJrfgp5QioHt+P8M+Fchvxa8w9aNtni3G6dHcBo9mD95x9L3IkweUeA297yszNWvCWvRw==", "IiAxn");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[38]] = Z.lIlIIllIlIIIll("U9qRk6jAAN0=", "upCLC");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[39]] = Z.lIlIIllIlIIIlI("ChwjAw==", "NnLsn");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[40]] = Z.lIlIIllIlIIIlI("CyAnLRg=", "NMWYa");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[41]] = Z.lIlIIllIlIIIll("Abt2Gs37kWA=", "boBJB");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[42]] = Z.lIlIIllIlIIIlI("DzQkJA==", "KFKTN");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[43]] = Z.lIlIIllIlIIlII("zdgCFM/lOFE=", "ahtGj");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[44]] = Z.lIlIIllIlIIlII("5ovMFRfHLuY=", "ZbfbW");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[45]] = Z.lIlIIllIlIIlII("F7wMEaLhTUI=", "EvIkr");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[46]] = Z.lIlIIllIlIIIlI("KSYCFwgL", "yTcnm");
        Z.llIlIlIIlII[Z.llIlIlIIlIl[47]] = Z.lIlIIllIlIIIlI("CRYHIBIt", "ZwiFw");
    }
