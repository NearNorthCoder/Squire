...
extends ck {
    ...
    private static void lIlIlIlIlIllII() {
        ...
        ch.llIllIlllll[1] = " ".length();
        ch.llIllIlllll[2] = (108 + 44 - 150 + 130 ^ 113 + 73 - 84 + 41) & (9 ^ 0x28 ^ (0xF ^ 0x25) ^ -" ".length());
        ch.llIllIlllll[3] = 0xFFFFC7D6 & 0x3043869;
        ch.llIllIlllll[4] = "  ".length();
        ch.llIllIlllll[5] = 0xFFFFFFFE & 0xB3F5;
        ch.llIllIlllll[6] = 0xFFFFB3F7 & 0xFFFD;
        ch.llIllIlllll[7] = "   ".length();
    ...
    private static void lIlIlIlIlIlIll() {
        ...
        ch.llIllIllllI[ch.llIllIlllll[2]] = ch.lIlIlIlIlIlIIl("FdZk7jWgBRxeaIQ8opQk43UUVXwS4Ed5L7Tr0tzm5D4=", "MDtns");
        ch.llIllIllllI[ch.llIllIlllll[1]] = ch.lIlIlIlIlIlIlI("a2NCnEunAXuwwZrc5xVwlw==", "MPzZw");
        ch.llIllIllllI[ch.llIllIlllll[4]] = ch.lIlIlIlIlIlIIl("qBZLGcpjmDpoY+4+LfetVL1X1ewvpQNGhzITF1BaJwkrj1SUg05ozg==", "ZEArp");
        ch.llIllIllllI[ch.llIllIlllll[7]] = ch.lIlIlIlIlIlIIl("p1K/BxwNSqw=", "nisoj");
    }
