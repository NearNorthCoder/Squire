...
extends ao {
    ...
    private static void lIIlIlllIIIllI() {
        ...
        by.lIllIlIlIII[by.lIllIllIIII[3]] = by.lIIlIlllIIIIll("Dkm10eBshws=", "ZWNfK");
        by.lIllIlIlIII[by.lIllIllIIII[2]] = by.lIIlIlllIIIlII("zivG3PqC1+RRC6J63oxvrA==", "uFlFW");
        by.lIllIlIlIII[by.lIllIllIIII[5]] = by.lIIlIlllIIIlII("RYNaqav6Mn6SiLmbN2aNoA==", "boqbE");
        by.lIllIlIlIII[by.lIllIllIIII[6]] = by.lIIlIlllIIIIll("+3yb/RaXX/cfrKULDyl9uxddX0tPFidY", "tXUGv");
        by.lIllIlIlIII[by.lIllIllIIII[7]] = by.lIIlIlllIIIlIl("Eyo/", "JOLZJ");
        by.lIllIlIlIII[by.lIllIllIIII[8]] = by.lIIlIlllIIIlIl("HBYQ", "Ieusd");
        by.lIllIlIlIII[by.lIllIllIIII[9]] = by.lIIlIlllIIIlII("S6TwLS44hOQ=", "avNQv");
        by.lIllIlIlIII[by.lIllIllIIII[10]] = by.lIIlIlllIIIlII("V//xqnVdHGE=", "fgLnd");
        by.lIllIlIlIII[by.lIllIllIIII[11]] = by.lIIlIlllIIIIll("dnTVW9W52Z0=", "Fpufy");
        by.lIllIlIlIII[by.lIllIllIIII[12]] = by.lIIlIlllIIIlIl("JgwEIxQf", "qmvGq");
        by.lIllIlIlIII[by.lIllIllIIII[13]] = by.lIIlIlllIIIlII("Cpaf60izzlc=", "quHBC");
    }
    ...
    public boolean bk() {
        ...
        if (by.lIIlIllllIIIIl(nPC)) {
            ...
            if (-(0xD6 ^ 0x97 ^ (0x7E ^ 0x3B)) >= 0) {
                return ((0x15 ^ 0x31 ^ (0xA5 ^ 0x95)) & (8 ^ 0x56 ^ (0xE9 ^ 0xA3) ^ -" ".length())) != 0;
            }
        } else {
            bl2 = lIllIllIIII[3];
        }
    ...
    protected boolean aS() {
        ...
        if (by.lIIlIllllIIIIl(NPCs.getNearest((String[])stringArray)) && by.lIIlIllllIIIIl(NPCs.getNearest(nPC -> {
            ...
            "".length();
            if (-"   ".length() > 0) {
                return (("  ".length() ^ (0x6D ^ 0x31)) & (0xBE ^ 0xAE ^ (0x39 ^ 0x77) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIllIllIIII[3];
        }
    ...
    public boolean bj() {
        ...
        if (by.lIIlIllllIIIII(TileObjects.getNearest((int[])nArray))) {
            ...
            "".length();
            if (-" ".length() > -" ".length()) {
                return ((119 + 218 - 285 + 175 ^ 7 + 78 - 50 + 144) & (0xA5 ^ 0xAE ^ (0xC9 ^ 0x92) ^ -" ".length())) != 0;
            }
        } else {
            bl2 = lIllIllIIII[3];
        }
