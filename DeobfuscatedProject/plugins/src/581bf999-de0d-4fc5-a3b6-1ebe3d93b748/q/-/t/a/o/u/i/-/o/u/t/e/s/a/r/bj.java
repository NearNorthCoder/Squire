...
extends W {
    ...
    private boolean bW() {
        ...
        while (bj.lIIllIlIIllIll(llllllllllllllllIlIIlIllIlllIIlI.hasNext() ? 1 : 0)) {
            ...
            "".length();
            if ("  ".length() > 0) continue;
            return ((155 + 119 - 255 + 170 ^ 110 + 29 - 48 + 50) & (35 + 22 - 30 + 101 ^ 146 + 67 - 178 + 141 ^ -" ".length())) != 0;
        }
    ...
    private static void lIIllIlIIllIlI() {
        ...
        bj.lIllllIIlIl[0] = (0x9D ^ 0xA0 ^ (0xE ^ 0x74)) & (0xCD ^ 0xA7 ^ (0x36 ^ 0x1B) ^ -" ".length());
        bj.lIllllIIlIl[1] = 0x81 ^ 0x87;
        bj.lIllllIIlIl[2] = " ".length();
        bj.lIllllIIlIl[3] = "  ".length();
        bj.lIllllIIlIl[4] = 0xFFFFFF7C & 0x37D7;
        bj.lIllllIIlIl[5] = "   ".length();
    ...
    private static void lIIllIlIIlIlll() {
        ...
        bj.lIllllIIIIl[bj.lIllllIIlIl[0]] = bj.lIIllIlIIlIlIl("WLlY44f4XF2q5v4/zQGWCQ==", "fLKEj");
        bj.lIllllIIIIl[bj.lIllllIIlIl[2]] = bj.lIIllIlIIlIllI("Bgg+ACc8FjBUADYZJRUx", "UxWtS");
        bj.lIllllIIIIl[bj.lIllllIIlIl[3]] = bj.lIIllIlIIlIlIl("Wv16Y0xxP76oiaqd5Yen0Q==", "XgGSn");
    }
