...
extends Enum<t> {
    ...
    private static void lIIlIlllIlIlII() {
        ...
        t.lIllIlIllII[t.lIllIlIllIl[0]] = t.lIIlIlllIlIIlI("fyxLdzm8u44=", "GKVoC");
        t.lIllIlIllII[t.lIllIlIllIl[1]] = t.lIIlIlllIlIIll("FTtSVjqONeaRm45GWn+KeA==", "PvSfR");
    }
    ...
    private static void lIIlIlllIlIlIl() {
        ...
        t.lIllIlIllIl[1] = " ".length();
        t.lIllIlIllIl[2] = "  ".length();
