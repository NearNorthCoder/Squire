...
extends ck {
    ...
    public boolean bl() {
        ...
        if (cl.lIlIIIIIlIlIII(llllllllllllllllIlIIIIIIIIIIIIll)) {
            ...
            "".length();
            if (null != null) {
                return ((0xC6 ^ 0x99 ^ (0x6C ^ 0x61)) & (51 + 179 - 114 + 104 ^ 84 + 24 - 70 + 104 ^ -" ".length())) != 0;
            }
        } else {
    ...
    private static void lIlIIIIIlIIllI() {
        ...
        cl.llIIlIIlIll[cl.llIIlIIllII[0]] = cl.lIlIIIIIlIIlII("YXYjdtvif78=", "zkHqS");
        cl.llIIlIIlIll[cl.llIIlIIllII[1]] = cl.lIlIIIIIlIIlII("IvT/K+i461E=", "zwrrO");
        cl.llIIlIIlIll[cl.llIIlIIllII[7]] = cl.lIlIIIIIlIIlIl("GhU8NisAEw==", "ngURN");
    }
    ...
    public int g(boolean bl2) {
        ...
        if (cl.lIlIIIIIlIlIII(bl2 ? 1 : 0)) {
            ...
            "".length();
            if (-"  ".length() > 0) {
                return (0xE4 ^ 0xC5 ^ (0xEB ^ 0xC3)) & ("   ".length() ^ (0x23 ^ 0x29) ^ -" ".length());
            }
        } else {
            n2 = llIIlIIllII[4];
        }
    ...
    private static void lIlIIIIIlIIlll() {
        ...
        cl.llIIlIIllII[0] = (0x19 ^ 0x2E ^ (0xDC ^ 0xC1)) & (40 + 0 - 20 + 158 ^ 103 + 15 - -2 + 32 ^ -" ".length());
        cl.llIIlIIllII[1] = " ".length();
