...
extends Z {
    ...
    private static String lIlIIllIlllIlI(String llllllllllllllllIIllIIlIIlIlIIIl, String llllllllllllllllIIllIIlIIlIlIlIl) {
        ...
        while (cc.lIlIIlllIllIlI(llllllllllllllllIIllIIlIIlIIlIlI, llllllllllllllllIIllIIlIIlIIlIll)) {
            ...
            "".length();
            if (((0x68 ^ 0x21 ^ (0x52 ^ 0x1F)) & (0 ^ 0xE ^ (0x33 ^ 0x39) ^ -" ".length())) <= 0) continue;
            return null;
        }
    ...
    public boolean run() {
        ...
        while (cc.lIlIIlllIlIlIl(llllllllllllllllIIllIIlIlIIIlllI.hasNext() ? 1 : 0)) {
            ...
            return ((109 + 84 - 67 + 2 ^ 108 + 122 - 133 + 64) & (0x1B ^ 0x27 ^ (0x6E ^ 0x73) ^ -" ".length())) != 0;
        }
    ...
    private static void lIlIIlllIlIIll() {
        ...
        cc.llIlIlIlllI[0] = " ".length();
        cc.llIlIlIlllI[1] = (0x64 ^ 0x31) & ~(0x5A ^ 0xF);
        cc.llIlIlIlllI[2] = "  ".length();
        cc.llIlIlIlllI[3] = "   ".length();
    ...
    private static void lIlIIllIllllIl() {
        ...
        cc.llIlIlIlIIl[cc.llIlIlIlllI[1]] = cc.lIlIIllIlllIlI("GCwzAw==", "NERoX");
        cc.llIlIlIlIIl[cc.llIlIlIlllI[0]] = cc.lIlIIllIlllIll("jbOlV0PB7ho=", "HiOCa");
        cc.llIlIlIlIIl[cc.llIlIlIlllI[2]] = cc.lIlIIllIlllIlI("N30=", "kUilV");
        cc.llIlIlIlIIl[cc.llIlIlIlllI[3]] = cc.lIlIIllIlllIlI("EEs=", "LbrmM");
        cc.llIlIlIlIIl[cc.llIlIlIlllI[4]] = cc.lIlIIllIllllII("By8r9+Qo/Gs=", "ItUoe");
        cc.llIlIlIlIIl[cc.llIlIlIlllI[5]] = cc.lIlIIllIlllIll("nYVmeh3HdEY=", "qwVqA");
        cc.llIlIlIlIIl[cc.llIlIlIlllI[6]] = cc.lIlIIllIllllII("6Bpc/YTzEdM=", "jksQO");
        cc.llIlIlIlIIl[cc.llIlIlIlllI[7]] = cc.lIlIIllIlllIlI("Sg==", "bNQpD");
    }
    ...
    private boolean m(String string) {
        ...
        Item llllllllllllllllIIllIIlIlIIIIIll = llllllllllllllllIIllIIlIlIIIIlIl.stream().filter(item2 -> {
            ...
            if (cc.lIlIIlllIllIII(item2, llllllllllllllllIIllIIlIlIIIIlII)) {
                ...
                "".length();
                if (" ".length() == 0) {
                    return ((109 + 17 - 1 + 11 ^ 18 + 151 - 68 + 71) & (0x42 ^ 0x2B ^ (0x22 ^ 0x6F) ^ -" ".length())) != 0;
                }
            } else {
                bl2 = llIlIlIlllI[1];
            }
