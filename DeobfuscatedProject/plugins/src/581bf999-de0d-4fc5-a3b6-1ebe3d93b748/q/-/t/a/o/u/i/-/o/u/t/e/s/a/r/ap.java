...
extends ao {
    ...
    private static void lIIlIllllllllI() {
        ...
        ap.lIllIlllIII[1] = "  ".length();
        ap.lIllIlllIII[2] = (0x2A ^ 0x30) & ~(0x4E ^ 0x54);
        ap.lIllIlllIII[3] = " ".length();
    ...
    public void g(WorldPoint worldPoint) {
        ...
        if (ap.lIIllIIIIIIIIl(NPCs.getNearest(nPC -> {
            ...
            if (ap.lIIlIlllllllll(nPC.getName()) && ap.lIIllIIIIIIIII(nPC.getName().contains(lIllIllIlII[lIllIlllIII[18]]) ? 1 : 0) && ap.lIIllIIIIIIIll(nPC.getWorldLocation().distanceTo((Locatable)player), lIllIlllIII[4])) {
                ...
                "".length();
                if (" ".length() == "  ".length()) {
                    return ((155 + 39 - 70 + 67 ^ 139 + 39 - 62 + 66) & (0xE3 ^ 0x91 ^ (0x75 ^ 0xE) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIllIlllIII[2];
            }
    ...
    private static void lIIlIlllllIlIl() {
        ...
        ap.lIllIllIlII[ap.lIllIlllIII[2]] = ap.lIIlIllllIlIlI("7RkKXtmkqFKVu/IDic6oSA==", "jdTSP");
        ap.lIllIllIlII[ap.lIllIlllIII[3]] = ap.lIIlIllllIllII("+1WK9jtfaUY=", "eFTsP");
        ap.lIllIllIlII[ap.lIllIlllIII[1]] = ap.lIIlIllllIllII("5pYzybYGSQI3gl7XTGHPZfHplpcePFKj", "cLemO");
        ap.lIllIllIlII[ap.lIllIlllIII[8]] = ap.lIIlIllllIllII("nK7HmaRHQ+Irz6mUAXqL1A==", "SUBMT");
        ap.lIllIllIlII[ap.lIllIlllIII[4]] = ap.lIIlIllllIlIlI("D1xf+qYOyuw=", "GVLSK");
        ap.lIllIllIlII[ap.lIllIlllIII[10]] = ap.lIIlIllllIllII("ofAMBTTruQbMAjPGLTnl9Q==", "ieLWZ");
        ap.lIllIllIlII[ap.lIllIlllIII[11]] = ap.lIIlIlllllIlII("OxcYDwlHDhQNFA8=", "jbqlb");
        ap.lIllIllIlII[ap.lIllIlllIII[12]] = ap.lIIlIlllllIlII("Cw0bBCR3FBcGOT8=", "ZxrgO");
        ap.lIllIllIlII[ap.lIllIlllIII[13]] = ap.lIIlIlllllIlII("MgkvLEESBw==", "fhCGl");
        ap.lIllIllIlII[ap.lIllIlllIII[14]] = ap.lIIlIlllllIlII("IAoJLhZGEkIVHwAFDTE=", "aabFw");
        ap.lIllIllIlII[ap.lIllIlllIII[15]] = ap.lIIlIllllIllII("AVg0S9SbboyhL+BHlm0Afw==", "DUMMW");
        ap.lIllIllIlII[ap.lIllIlllIII[16]] = ap.lIIlIllllIlIlI("h5P9qfWjcQSkSQmx7S+JjQ==", "nNnGo");
        ap.lIllIllIlII[ap.lIllIlllIII[17]] = ap.lIIlIllllIlIlI("MugSPqiIBkY=", "AHkeK");
        ap.lIllIllIlII[ap.lIllIlllIII[18]] = ap.lIIlIlllllIlII("GjE4", "UCZsp");
    }
    ...
    public boolean bu() {
        ...
        if (ap.lIIllIIIIIIIII(llllllllllllllllIlIlIIIIIlIIlIII.cW.butterfly() ? 1 : 0) && ap.lIIllIIIIIIIlI(llllllllllllllllIlIlIIIIIlIIIlll.getId(), lIllIlllIII[5]) && ap.lIIllIIIIIIIII(Movement.isRunEnabled() ? 1 : 0)) {
            n2 = lIllIlllIII[3];
            "".length();
            if (-" ".length() >= (0x4C ^ 0x7F ^ (0xF1 ^ 0xC6))) {
                return ((0x7D ^ 0x21 ^ (0x1F ^ 0x63)) & (94 + 96 - 75 + 19 ^ 4 + 36 - -93 + 33 ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIllIlllIII[2];
        }
