...
extends aI {
    ...
    private static void lIlIIlIllIIIlI() {
        ...
        aK.llIlIIlIlll[0] = -" ".length();
        aK.llIlIIlIlll[1] = (122 + 156 - 124 + 53 ^ 5 + 107 - 54 + 72) & (137 + 73 - 163 + 157 ^ 41 + 88 - 125 + 125 ^ -" ".length());
        aK.llIlIIlIlll[2] = " ".length();
        aK.llIlIIlIlll[3] = -(0xFFFFFB75 & 0x14FB) & (0xFFFFF7FF & 0x3E7F);
        aK.llIlIIlIlll[4] = "   ".length();
        aK.llIlIIlIlll[5] = "  ".length();
        ...
        if (aK.lIlIIlIllIIIll(llllllllllllllllIIllIllIIlllIIIl = n2)) {
            ...
            WorldPoint llllllllllllllllIIllIllIIllIllll = llllllllllllllllIIllIllIIlllIIII.createWorldArea(llIlIIlIlll[2]).toWorldPointList().stream().filter(worldPoint2 -> {
                ...
                if (aK.lIlIIlIllIIlll(Math.abs(worldPoint2.getWorldX() - llllllllllllllllIIllIllIIlllIIII.getWorldX()), llIlIIlIlll[2]) && aK.lIlIIlIllIIlll(Math.abs(worldPoint2.getWorldY() - llllllllllllllllIIllIllIIlllIIII.getWorldY()), llIlIIlIlll[2])) {
                    ...
                    "".length();
                    if ("  ".length() >= "   ".length()) {
                        return ((91 + 203 - 135 + 69 ^ 167 + 62 - 90 + 53) & (0xC7 ^ 0xB4 ^ (0x5C ^ 0xB) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = llIlIIlIlll[1];
                }
                ...
                if (aK.lIlIIlIllIIlIl(llllllllllllllllIIllIllIIlllIIll.contains(worldPoint) ? 1 : 0)) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((0x93 ^ 0xAB ^ (0xD1 ^ 0xA1)) & (105 + 48 - 67 + 114 ^ 106 + 100 - 186 + 108 ^ -" ".length())) != 0;
                    }
                } else {
                    bl2 = llIlIIlIlll[1];
                }
    ...
    private static void lIlIIlIllIIIIl() {
        ...
        aK.llIlIIlIllI[aK.llIlIIlIlll[1]] = aK.lIlIIlIlIlllll("JHZaEliWNiGBuqwnDjidRg==", "lyklH");
        aK.llIlIIlIllI[aK.llIlIIlIlll[2]] = aK.lIlIIlIllIIIII("R6P0NRSX6j8=", "AcUZX");
        aK.llIlIIlIllI[aK.llIlIIlIlll[5]] = aK.lIlIIlIlIlllll("VMpE5i9fIeE=", "bhFbd");
    }
    ...
    private Set<WorldPoint> bF() {
        ...
        while (aK.lIlIIlIllIIIll(llllllllllllllllIIllIllIIllIIlll.hasNext() ? 1 : 0)) {
            ...
            if (aK.lIlIIlIllIlIIl(llllllllllllllllIIllIllIIllIIllI.getId(), llIlIIlIlll[12])) {
                "".length();
                if (((94 + 135 - 154 + 156 ^ 30 + 4 - -123 + 23) & (139 + 209 - 258 + 149 ^ 136 + 18 - 35 + 69 ^ -" ".length())) == 0) continue;
                return null;
            }
            ...
            "".length();
            "".length();
            if (((0x50 ^ 0xB ^ (0x2D ^ 0x73)) & (0xF7 ^ 0x9F ^ (0xA9 ^ 0xC4) ^ -" ".length())) == 0) continue;
            return null;
        }
        return hashSet;
    }
