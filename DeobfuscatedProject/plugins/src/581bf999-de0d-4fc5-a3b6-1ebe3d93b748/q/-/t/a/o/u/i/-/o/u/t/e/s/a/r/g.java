...
extends Enum<g> {
    ...
    private static void lIlIIIlllIllII() {
        ...
        g.llIIlllIlll[g.llIIllllIII[0]] = g.lIlIIIlllIlIIl("M+YnsLySSlU=", "XHqoJ");
        g.llIIlllIlll[g.llIIllllIII[1]] = g.lIlIIIlllIlIlI("KTwcIxE7SA==", "dyPfT");
        g.llIIlllIlll[g.llIIllllIII[2]] = g.lIlIIIlllIlIll("0kZV4CTgrUo=", "lbJLn");
        g.llIIlllIlll[g.llIIllllIII[3]] = g.lIlIIIlllIlIIl("v2WOOJSQlEc=", "gWQdL");
        g.llIIlllIlll[g.llIIllllIII[4]] = g.lIlIIIlllIlIlI("FTEpCy8YQg==", "GpgLj");
        g.llIIlllIlll[g.llIIllllIII[5]] = g.lIlIIIlllIlIlI("KSIQCw==", "dcWNy");
    }
    ...
    private static void lIlIIIlllIllIl() {
        ...
        g.llIIllllIII[1] = " ".length();
        g.llIIllllIII[2] = "  ".length();
        g.llIIllllIII[3] = "   ".length();
