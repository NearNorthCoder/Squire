...
extends az {
    ...
    public boolean bl() {
        ...
        TileObject llllllllllllllllIlIIIIllIIIlIIII = TileObjects.getNearest(tileObject -> {
            ...
            if (aA.lIIlllllIlIlIl(tileObject.getId(), llIIIlllIIl[9]) && aA.lIIlllllIlIIll(Reachable.isInteractable((Locatable)tileObject) ? 1 : 0)) {
                ...
                "".length();
                if ("  ".length() <= 0) {
                    return ((215 + 12 - 73 + 76 ^ 152 + 90 - 105 + 43) & (0xC9 ^ 0xA6 ^ (0xFF ^ 0xC2) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIIIlllIIl[1];
            }
        ...
        if (aA.lIIlllllIlIIll(Inventory.isFull() ? 1 : 0)) {
            ...
            List llllllllllllllllIlIIIIllIIIIllIl = Inventory.getAll(item -> {
                ...
                if (aA.lIIlllllIlIIll(item.hasAction(llIIIlllIII[llIIIlllIIl[5]]::equals) ? 1 : 0) && aA.lIIlllllIlIIll(item.hasAction(llIIIlllIII[llIIIlllIIl[6]]::equals) ? 1 : 0)) {
                    ...
                    "".length();
                    if ("  ".length() < 0) {
                        return ((51 + 18 - -45 + 13 ^ (0xA7 ^ 0xC1)) & (0x43 ^ 0x54 ^ (0x3A ^ 0x34) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = llIIIlllIIl[1];
                }
            ...
            if (aA.lIIlllllIlIIIl(llllllllllllllllIlIIIIllIIIIllIl.isEmpty() ? 1 : 0)) {
                ...
                while (aA.lIIlllllIlIlII(llllllllllllllllIlIIIIllIIIIllII, Math.min(llIIIlllIIl[2], llllllllllllllllIlIIIIllIIIIllIl.size() - llIIIlllIIl[3]))) {
                    ...
                    return ((2 + 45 - 32 + 141 ^ 158 + 121 - 255 + 152) & (21 + 50 - -21 + 79 ^ 17 + 122 - 17 + 13 ^ -" ".length())) != 0;
                }
                return llIIIlllIIl[3];
            }
        }
    ...
    private static void lIIlllllIIllll() {
        ...
        aA.llIIIlllIII[aA.llIIIlllIIl[1]] = aA.lIIlllllIIllII("d2KaTLuo08w=", "zITKL");
        aA.llIIIlllIII[aA.llIIIlllIIl[3]] = aA.lIIlllllIIllII("V3z1hgYmq9W7sNMLGABX3Q==", "DXaVT");
        aA.llIIIlllIII[aA.llIIIlllIIl[4]] = aA.lIIlllllIIllIl("hKqEO/LV8M4=", "aEvpH");
        aA.llIIIlllIII[aA.llIIIlllIIl[2]] = aA.lIIlllllIIllII("3UZeFq9glWAKdK3aOH9EtQ==", "imqtH");
        aA.llIIIlllIII[aA.llIIIlllIIl[5]] = aA.lIIlllllIIlllI("EBUWNj8=", "UxfBF");
        aA.llIIIlllIII[aA.llIIIlllIIl[6]] = aA.lIIlllllIIllII("GEScUlxf1DI=", "MbHAR");
        aA.llIIIlllIII[aA.llIIIlllIIl[7]] = aA.lIIlllllIIllII("/FIlQFiQ+eI=", "nCKmo");
        aA.llIIIlllIII[aA.llIIIlllIIl[8]] = aA.lIIlllllIIlllI("KDQXCg==", "lFxzl");
    }
    ...
    private static void lIIlllllIlIIII() {
        ...
        aA.llIIIlllIIl[1] = (121 + 103 - 174 + 148 ^ 93 + 60 - 12 + 18) & (0x22 ^ 0x13 ^ (5 ^ 0x6D) ^ -" ".length());
        aA.llIIIlllIIl[2] = "   ".length();
        aA.llIIIlllIIl[3] = " ".length();
        aA.llIIIlllIIl[4] = "  ".length();
