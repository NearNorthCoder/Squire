...
extends ao {
    ...
    protected WorldPoint bT() {
        ...
        while (bh.lIIllIIllIIlll(llllllllllllllllIlIIllIIllIIlIII.hasNext() ? 1 : 0)) {
            ...
            "".length();
            if ("  ".length() > ((9 ^ 0x3B ^ (0x96 ^ 0xB1)) & (37 + 3 - -43 + 92 ^ 174 + 83 - 256 + 185 ^ -" ".length()))) continue;
            return null;
        }
    ...
    private static String lIIllIIlIllIll(String llllllllllllllllIlIIllIIlIIlIlII, String llllllllllllllllIlIIllIIlIIllIII) {
        ...
        while (bh.lIIllIIllIllII(llllllllllllllllIlIIllIIlIIIllIl, llllllllllllllllIlIIllIIlIIIlllI)) {
            ...
            "".length();
            if ((146 + 92 - 160 + 80 ^ 7 + 81 - 67 + 133) > "   ".length()) continue;
            return null;
        }
    ...
    private static void lIIllIIllIIlIl() {
        ...
        bh.lIlllIlIllI[1] = "  ".length();
        bh.lIlllIlIllI[2] = (0x45 ^ 0x5D) & ~(0xBD ^ 0xA5);
        bh.lIlllIlIllI[3] = " ".length();
        bh.lIlllIlIllI[4] = "   ".length();
        ...
        bh.lIlllIlIllI[33] = 0x66 ^ 0x74 ^ "  ".length();
    ...
    private static void lIIllIIllIIlII() {
        ...
        bh.lIlllIlIlII[bh.lIlllIlIllI[2]] = bh.lIIllIIlIllIlI("BxN6GDK/QYX8/7h5CeFpIg==", "UuQKz");
        bh.lIlllIlIlII[bh.lIlllIlIllI[3]] = bh.lIIllIIlIllIlI("rFPuJ+20AXBtyOOlSNlhVg==", "VxtJS");
        bh.lIlllIlIlII[bh.lIlllIlIllI[1]] = bh.lIIllIIlIllIll("ERc/BjwqACdDLzcLIBctKQ==", "ErScL");
        bh.lIlllIlIlII[bh.lIlllIlIllI[4]] = bh.lIIllIIlIllIll("ODAvBAZEEDUC", "iEFgm");
        bh.lIlllIlIlII[bh.lIlllIlIllI[5]] = bh.lIIllIIlIlllII("cWzKoP3tu5Gae/3JvWszmA==", "DrOEB");
        bh.lIlllIlIlII[bh.lIlllIlIllI[6]] = bh.lIIllIIlIllIll("HQs1EC4mHTY=", "RxXeC");
        bh.lIlllIlIlII[bh.lIlllIlIllI[7]] = bh.lIIllIIlIllIlI("IvNSwW9m46uQkZ0KACFeIQ==", "ThwRf");
        bh.lIlllIlIlII[bh.lIlllIlIllI[8]] = bh.lIIllIIlIlllII("xJ2+jrl01x40YRgWRYZReQ==", "wEUcI");
        bh.lIlllIlIlII[bh.lIlllIlIllI[9]] = bh.lIIllIIlIllIlI("Tcua8Tvx3SE=", "BnAWC");
    }
