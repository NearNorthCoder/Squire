...
extends aI {
    ...
    private static void lIlIIIlIlIlIll() {
        ...
        aJ.llIIllIlIIl[0] = (0xD8 ^ 0xA1 ^ (8 ^ 0x7D)) & (0x40 ^ 0x33 ^ 69 + 11 - -11 + 36 ^ -" ".length());
        aJ.llIIllIlIIl[1] = " ".length();
        aJ.llIIllIlIIl[2] = 0x55 ^ 0x51;
        aJ.llIIllIlIIl[3] = "  ".length();
        aJ.llIIllIlIIl[4] = "   ".length();
    ...
    public boolean bC() {
        ...
        NPC llllllllllllllllIIlllIllllllllIl = llllllllllllllllIIllllIIIIIIIIlI.stream().filter(nPC -> {
            ...
            if (aJ.lIlIIIlIllIIll(nPC.getId(), llIIllIlIIl[14]) && aJ.lIlIIIlIllIlIl(nPC.isDead() ? 1 : 0)) {
                n2 = llIIllIlIIl[1];
                "".length();
                if ("   ".length() <= ((25 + 141 - 78 + 64 ^ 80 + 58 - 81 + 85) & (0x8E ^ 0x82 ^ (0xD9 ^ 0xC3) ^ -" ".length()))) {
                    return ((0x9E ^ 0x91 ^ (0x47 ^ 0x1E)) & (132 + 46 - 26 + 64 ^ 4 + 16 - -29 + 93 ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIIllIlIIl[0];
            }
        ...
        if (aJ.lIlIIIlIlIllll(llllllllllllllllIIlllIllllllllIl)) {
            ...
            if (aJ.lIlIIIlIlIllII(llllllllllllllllIIllllIIIIIIIIII.stream().allMatch(worldPoint2 -> {
                ...
                if (aJ.lIlIIIlIllIllI(worldPoint2.getWorldX(), llllllllllllllllIIllllIIIIIIIIll.getWorldX())) {
                    ...
                    "".length();
                    if (-" ".length() > " ".length()) {
                        return ((0x7A ^ 0x12 ^ (0x87 ^ 0xB4)) & (101 + 183 - 250 + 206 ^ 140 + 97 - 110 + 44 ^ -" ".length())) != 0;
                    }
                } else {
                    bl2 = llIIllIlIIl[0];
                }
                ...
                if (aJ.lIlIIIlIlIllII(llllllllllllllllIIllllIIIIIIIIII.contains(llllllllllllllllIIllllIIIIIIIIll) ? 1 : 0)) {
                    ...
                    if ((123 + 116 - 104 + 30 ^ 145 + 104 - 148 + 60) <= 0) {
                        return ((0x1F ^ 0x74 ^ (0xD5 ^ 0x97)) & (57 + 125 - 52 + 25 ^ 119 + 23 - -20 + 16 ^ -" ".length())) != 0;
                    }
                    ...
                    "".length();
                    if (null != null) {
                        return ((76 + 111 - 108 + 49 ^ 60 + 85 - 47 + 59) & (81 + 49 - 100 + 110 ^ 140 + 49 - 45 + 1 ^ -" ".length())) != 0;
                    }
                } else {
    ...
    private static void lIlIIIlIIIlIIl() {
        ...
        aJ.llIIllIIIlI[aJ.llIIllIlIIl[0]] = aJ.lIlIIIlIIIIllI("Al+vSs1miTg=", "cZdho");
        aJ.llIIllIIIlI[aJ.llIIllIlIIl[1]] = aJ.lIlIIIlIIIIlll("Kx4LIAQ=", "olbNo");
        aJ.llIIllIIIlI[aJ.llIIllIlIIl[3]] = aJ.lIlIIIlIIIIlll("AwcNCQ0fAQ==", "qfcnd");
        aJ.llIIllIIIlI[aJ.llIIllIlIIl[4]] = aJ.lIlIIIlIIIlIII("saI7Q5jsl8qAbohWEf/Bqw==", "SAyNr");
    }
    ...
    private List<NPC> bD() {
        ...
        while (aJ.lIlIIIlIlIllII(llllllllllllllllIIllllIIIIIlIlIl.hasNext() ? 1 : 0)) {
            ...
            if (aJ.lIlIIIlIlIllIl(llllllllllllllllIIllllIIIIIlIlII.getWorldLocation().getX(), (int)llllllllllllllllIIllllIIIIIlIlll) && aJ.lIlIIIlIlIllII(NPCs.getAll(arg_0 -> aJ.a(llllllllllllllllIIllllIIIIIlIlII, (int)llllllllllllllllIIllllIIIIIlIlll, arg_0)).isEmpty() ? 1 : 0)) {
                ...
                "".length();
                if (((0x15 ^ 0x4A ^ (0x1E ^ 0x70)) & (2 ^ 0x38 ^ (0x5D ^ 0x56) ^ -" ".length())) == 0) break;
                return null;
            }
            "".length();
        ...
        return list.stream().filter(nPC -> {
            ...
            if (aJ.lIlIIIlIllIIll(nPC.getWorldLocation().getX(), n4)) {
                ...
                "".length();
                if (-"   ".length() > 0) {
                    return ((0xC2 ^ 0x94 ^ (0x14 ^ 0x7A)) & (0x17 ^ 0xE ^ (0x40 ^ 0x61) ^ -" ".length())) != 0;
                }
            } else {
                bl2 = llIIllIlIIl[0];
            }
