...
extends ca {
        ...
        return TileObjects.getNearest(tileObject -> {
            ...
            if (bZ.lIIlIllIIlIlll(tileObject.getName().equals(lIllIIllIll[lIllIIlllII[7]]) ? 1 : 0)) {
                ...
                if (bZ.lIIlIllIIlIlll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((84 + 201 - 140 + 91 ^ 0 + 45 - -28 + 90) & (64 + 117 - 74 + 35 ^ 2 + 141 - 66 + 116 ^ -" ".length())) != 0;
                }
            }
            n2 = lIllIIlllII[2];
            return n2 != 0;
    ...
    private static void lIIlIllIIlIlII() {
        ...
        bZ.lIllIIllIll[bZ.lIllIIlllII[2]] = bZ.lIIlIllIIlIIlI("K2OEbt6ClcbNHU+iAwSVsrFJvYjoYJbC", "pHied");
        bZ.lIllIIllIll[bZ.lIllIIlllII[3]] = bZ.lIIlIllIIlIIll("AB0fTgMwHgZOHDYHGE4GNhweDww3FxhA", "Yrjne");
        bZ.lIllIIllIll[bZ.lIllIIlllII[5]] = bZ.lIIlIllIIlIIlI("MW8GYOtGHCa5PyZIUsCBYA==", "tBgDz");
        bZ.lIllIIllIll[bZ.lIllIIlllII[6]] = bZ.lIIlIllIIlIIll("Di8FLQ==", "ZNnHV");
        bZ.lIllIIllIll[bZ.lIllIIlllII[7]] = bZ.lIIlIllIIlIIlI("uQjYaJGUgl4YXlk2ZLCUTg==", "FwzAo");
        bZ.lIllIIllIll[bZ.lIllIIlllII[8]] = bZ.lIIlIllIIlIIll("KS08FA==", "oDPxX");
    }
    ...
    private static void lIIlIllIIlIlIl() {
        ...
        bZ.lIllIIlllII[2] = (0xAF ^ 0xC4 ^ (0x59 ^ 0x7F)) & (0x6C ^ 0x76 ^ (0x5F ^ 8) ^ -" ".length());
        bZ.lIllIIlllII[3] = " ".length();
        bZ.lIllIIlllII[4] = -(0xFFFFD7BF & 0x2D61) & (0xFFFFEFFF & 0x7FBF);
        bZ.lIllIIlllII[5] = "  ".length();
        bZ.lIllIIlllII[6] = "   ".length();
