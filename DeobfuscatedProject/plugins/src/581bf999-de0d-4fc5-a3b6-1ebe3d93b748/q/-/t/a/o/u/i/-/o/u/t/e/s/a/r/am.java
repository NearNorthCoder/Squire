...
extends Z {
    ...
    private static void lIIllIlIIIlIII() {
        ...
        am.lIlllIlllll[0] = (155 + 43 - 108 + 71 ^ 112 + 57 - 114 + 74) & (0x5F ^ 0x4D ^ (0xB6 ^ 0x84) ^ -" ".length());
        am.lIlllIlllll[1] = " ".length();
        am.lIlllIlllll[2] = -(0xFFFF9FFD & 0x657A) & (0xFFFFFF7F & 0x3DFF);
        am.lIlllIlllll[3] = 0x5F ^ 0x4B;
        am.lIlllIlllll[4] = "  ".length();
        am.lIlllIlllll[5] = "   ".length();
    ...
    public boolean run() {
        ...
        Item llllllllllllllllIlIIlIllllIIlIIl = Inventory.getFirst(item -> {
            ...
            if (am.lIIllIlIIIlllI(item.getName().contains(lIlllIlllIl[lIlllIlllll[5]]) ? 1 : 0) && am.lIIllIlIIIlllI(item.getName().contains(lIlllIlllIl[lIlllIlllll[6]]) ? 1 : 0)) {
                ...
                "".length();
                if (" ".length() >= "  ".length()) {
                    return ((0x7F ^ 0x3B ^ (0xD0 ^ 0xAB)) & (0xCF ^ 0xBC ^ (0x41 ^ 0xD) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIlllIlllll[0];
            }
    ...
    private static void lIIllIlIIIIlII() {
        ...
        am.lIlllIlllIl[am.lIlllIlllll[0]] = am.lIIllIlIIIIIIl("LyTYlrrmnFU=", "PrmdL");
        am.lIlllIlllIl[am.lIlllIlllll[1]] = am.lIIllIlIIIIIlI("Bgg0BCE=", "EzAwI");
        am.lIlllIlllIl[am.lIlllIlllll[4]] = am.lIIllIlIIIIIlI("MDcCFQk=", "CVnaz");
        am.lIlllIlllIl[am.lIlllIlllll[5]] = am.lIIllIlIIIIIll("6EtKiEB5Ed0=", "BIZjj");
        am.lIlllIlllIl[am.lIlllIlllll[6]] = am.lIIllIlIIIIIlI("Ug==", "cbqTm");
    }
