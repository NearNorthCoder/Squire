...
extends bh {
    ...
    private static void lIlIIIIlIIIlll() {
        ...
        ba.llIIlIlIlIl[ba.llIIlIlIllI[0]] = ba.lIlIIIIlIIIlIl("AzcdGDIp", "BCiyQ");
        ba.llIIlIlIlIl[ba.llIIlIlIllI[1]] = ba.lIlIIIIlIIIllI("wmf20CLvomdHeDKQv/JqxA==", "ElZKV");
    }
    ...
    private static void lIlIIIIlIIlIII() {
        ...
        ba.llIIlIlIllI[1] = " ".length();
        ba.llIIlIlIllI[2] = "  ".length();
    }
    ...
    protected boolean bL() {
        ...
        NPC nPC2 = NPCs.getNearest(nPC -> {
            ...
            if (ba.lIlIIIIlIIlIll(nPC.getName().equals(llIIlIlIlIl[llIIlIlIllI[1]]) ? 1 : 0) && ba.lIlIIIIlIIllII(nPC.isDead() ? 1 : 0)) {
                n2 = llIIlIlIllI[1];
                "".length();
                if (((44 + 162 - 194 + 202 ^ 36 + 6 - -27 + 65) & (123 + 89 - 190 + 186 ^ 98 + 42 - 57 + 45 ^ -" ".length())) > 0) {
                    return ((39 + 3 - -9 + 93 ^ 42 + 61 - 28 + 61) & (0x2F ^ 0x10 ^ (0x61 ^ 0x46) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIIlIlIllI[0];
            }
