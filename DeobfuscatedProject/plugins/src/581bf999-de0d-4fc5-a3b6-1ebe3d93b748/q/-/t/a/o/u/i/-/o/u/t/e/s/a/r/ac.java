...
extends Z {
    ...
    private static String lIIllIlIIllIII(String llllllllllllllllIlIIlIlIlIlllIIl, String llllllllllllllllIlIIlIlIlIllIllI) {
        try {
            SecretKeySpec llllllllllllllllIlIIlIlIlIllllII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllIlIIlIlIlIllIllI.getBytes(StandardCharsets.UTF_8)), lIllllIllll[4]), "DES");
            Cipher llllllllllllllllIlIIlIlIlIlllIll = Cipher.getInstance("DES");
            llllllllllllllllIlIIlIlIlIlllIll.init(lIllllIllll[5], llllllllllllllllIlIIlIlIlIllllII);
    ...
    private static void lIIllIlIIllIIl() {
        ...
        ac.lIllllIIlII[ac.lIllllIllll[1]] = ac.lIIllIlIIllIII("JMFlz7VNMpA=", "pEBJH");
    }
    ...
    public boolean run() {
        ...
        Item llllllllllllllllIlIIlIlIllIIIIIl = Inventory.getFirst(item -> e.BLESSED_CRYSTAL_SCARAB.d(item.getId()));
        if (ac.lIIllIlIlllIlI(llllllllllllllllIlIIlIlIllIIIIIl)) {
            return lIllllIllll[1];
        }
    ...
    private static void lIIllIlIlllIII() {
        ...
        ac.lIllllIllll[3] = " ".length();
        ac.lIllllIllll[4] = 0x67 ^ 0x49 ^ (0xA6 ^ 0x80);
        ac.lIllllIllll[5] = "  ".length();
    }
}
