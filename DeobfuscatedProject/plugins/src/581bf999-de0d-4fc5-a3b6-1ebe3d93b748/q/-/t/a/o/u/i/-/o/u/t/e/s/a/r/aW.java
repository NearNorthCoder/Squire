...
extends Enum<aW> {
    ...
    private static void lIIlIllllIIlll() {
        ...
        aW.lIllIllIIlI[0] = (0x11 ^ 0x2F ^ (0x58 ^ 0x6C)) & (0xC4 ^ 0x8A ^ (0x55 ^ 0x11) ^ -" ".length());
        aW.lIllIllIIlI[1] = " ".length();
        aW.lIllIllIIlI[2] = "  ".length();
        aW.lIllIllIIlI[3] = 106 + 126 - 218 + 123 ^ 98 + 41 - 19 + 9;
    }

    private static void lIIlIllllIIllI() {
        lIllIllIIIl = new String[lIllIllIIlI[2]];
        aW.lIllIllIIIl[aW.lIllIllIIlI[0]] = aW.lIIlIllllIIlIl("CicGacnGUzo=", "OTAgt");
        aW.lIllIllIIIl[aW.lIllIllIIlI[1]] = aW.lIIlIllllIIlIl("aUtTNcaA42I=", "PttwE");
    }
