...
extends Enum<x> {
    ...
    private static void lIlIIlIlIlllIl() {
        ...
        x.llIlIIlIlIl[0] = (0x26 ^ 0x19 ^ (0x8C ^ 0x99)) & ((0xBB ^ 0x81) & ~(0 ^ 0x3A) ^ (0x31 ^ 0x1B) ^ -" ".length());
        x.llIlIIlIlIl[1] = " ".length();
        x.llIlIIlIlIl[2] = "  ".length();
        x.llIlIIlIlIl[3] = "   ".length();
    }
    ...
    private static void lIlIIlIlIlllII() {
        ...
        x.llIlIIlIlII[x.llIlIIlIlIl[0]] = x.lIlIIlIlIllIlI("6unOBo+axXo=", "oPXcw");
        x.llIlIIlIlII[x.llIlIIlIlIl[1]] = x.lIlIIlIlIllIll("BAAOKg==", "IAIod");
        x.llIlIIlIlII[x.llIlIIlIlIl[2]] = x.lIlIIlIlIllIlI("Fcf9o/YBDrU=", "frELg");
    }
