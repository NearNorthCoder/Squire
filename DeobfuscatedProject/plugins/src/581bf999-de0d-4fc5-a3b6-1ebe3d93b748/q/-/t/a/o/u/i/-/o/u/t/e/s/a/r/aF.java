...
extends W {
    ...
    public void a(AnimationChanged animationChanged) {
        void llllllllllllllllIlIlIIlllIIlllII;
        Actor actor = animationChanged.getActor();
        if (aF.lIIlIllIIIIllI(actor instanceof Player)) {
            return;
        }
        if (aF.lIIlIllIIIIlll(llllllllllllllllIlIlIIlllIIlllII.getAnimation(), lIllIIllIII[6])) {
            Prayer prayer;
            aF llllllllllllllllIlIlIIlllIIllllI;
            if (aF.lIIlIllIIIlIII(llllllllllllllllIlIlIIlllIIllllI.dE, Prayer.PROTECT_FROM_MISSILES)) {
                prayer = Prayer.PROTECT_FROM_MAGIC;
                "".length();
                if (((0x25 ^ 0xD) & ~(0x6C ^ 0x44)) < -" ".length()) {
                    return;
                }
            } else {
                prayer = Prayer.PROTECT_FROM_MISSILES;
            }
            llllllllllllllllIlIlIIlllIIllllI.dE = prayer;
            "".length();
            if (-" ".length() != -" ".length()) {
                return;
            }
        } else if (aF.lIIlIllIIIIlll(llllllllllllllllIlIlIIlllIIlllII.getAnimation(), lIllIIllIII[7])) {
            llllllllllllllllIlIlIIlllIIllllI.dE = Prayer.PROTECT_FROM_MISSILES;
            "".length();
            if ("  ".length() <= -" ".length()) {
                return;
            }
        } else if (aF.lIIlIllIIIIlll(llllllllllllllllIlIlIIlllIIlllII.getAnimation(), lIllIIllIII[8])) {
            llllllllllllllllIlIlIIlllIIllllI.dE = Prayer.PROTECT_FROM_MAGIC;
        }
    }
    ...
    private static void lIIlIllIIIIlII() {
        ...
        aF.lIllIIllIII[1] = "  ".length();
        aF.lIllIIllIII[2] = (0 ^ 0x22) & ~(0x78 ^ 0x5A);
        aF.lIllIIllIII[3] = -" ".length() & (0xFFFFEDF7 & 0x3FF9);
        aF.lIllIIllIII[4] = " ".length();
