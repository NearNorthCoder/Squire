...
public class z {
    ...
    public boolean c(int[] nArray) {
        ...
        if (z.lIlIlIIlIlIIII(Rand.nextInt((int)llIllIIlIII[0], (int)llIllIIlIII[1]), llIllIIlIII[2])) {
            n2 = llIllIIlIII[3];
            "".length();
            if (((0x3E ^ 0x16 ^ (0x60 ^ 0x10)) & (0x54 ^ 0x2D ^ (0xE4 ^ 0xC5) ^ -" ".length())) != 0) {
                return ((129 + 90 - 114 + 56 ^ 90 + 109 - 32 + 17) & (4 + 44 - -115 + 17 ^ 165 + 104 - 262 + 166 ^ -" ".length())) != 0;
            }
        } else {
            n2 = llIllIIlIII[4];
        }
        ...
        while (z.lIlIlIIlIlIIIl(llllllllllllllllIIlIlllIlIllIlIl, llllllllllllllllIIlIlllIlIllIllI)) {
            ...
            if (z.lIlIlIIlIlIIlI(llllllllllllllllIIlIlllIlIlllIII--)) {
                "".length();
                if (((0xB6 ^ 0xBD ^ (0x4E ^ 0x79)) & (0x1C ^ 8 ^ (0xBC ^ 0x94) ^ -" ".length())) <= 0) break;
                return ((75 + 75 - 21 + 52 ^ 82 + 117 - 104 + 42) & (0x53 ^ 0x55 ^ (0xB ^ 0x31) ^ -" ".length())) != 0;
            }
        ...
        if (z.lIlIlIIlIIlllI(llllllllllllllllIIlIlllIlIllIlll.isEmpty() ? 1 : 0)) {
            ...
            "".length();
            if ("   ".length() <= 0) {
                return ((0x16 ^ 0x1B ^ (0x1B ^ 0x22)) & (0x27 ^ 1 ^ (9 ^ 0x1B) ^ -" ".length())) != 0;
            }
        } else {
            bl2 = llIllIIlIII[0];
        }
    ...
    private static void lIlIlIIlIIllIl() {
        ...
        z.llIllIIlIII[0] = (24 + 8 - -36 + 151 ^ 109 + 26 - 46 + 61) & (43 + 32 - -50 + 99 ^ 125 + 79 - 49 + 18 ^ -" ".length());
        z.llIllIIlIII[1] = 23 + 6 - -59 + 41 ^ 3 + 27 - -96 + 26;
        z.llIllIIlIII[2] = " ".length();
        ...
        z.llIllIIlIII[8] = "  ".length();
        z.llIllIIlIII[9] = "   ".length();
    ...
    private static void lIlIlIIlIIIIll() {
        ...
        z.llIllIIIllI[z.llIllIIlIII[0]] = z.lIlIlIIlIIIIII("4L1B4aGTZAk=", "ruxmo");
        z.llIllIIIllI[z.llIllIIlIII[2]] = z.lIlIlIIlIIIIIl("5tv7lZ5JnWQ=", "LqRAp");
        z.llIllIIIllI[z.llIllIIlIII[8]] = z.lIlIlIIlIIIIII("pSBrwVOXIcg=", "ASwMb");
        z.llIllIIIllI[z.llIllIIlIII[9]] = z.lIlIlIIlIIIIlI("HCEmAA==", "XSIpi");
        z.llIllIIIllI[z.llIllIIlIII[3]] = z.lIlIlIIlIIIIIl("+EInAefO5EY=", "AaTkO");
        z.llIllIIIllI[z.llIllIIlIII[10]] = z.lIlIlIIlIIIIII("eJUopWzUyE4=", "PwYKh");
        z.llIllIIIllI[z.llIllIIlIII[11]] = z.lIlIlIIlIIIIII("gPB3eJDf8Jc=", "ggSoI");
        z.llIllIIIllI[z.llIllIIlIII[12]] = z.lIlIlIIlIIIIII("z5tuQeMcA4o=", "wNmhQ");
        z.llIllIIIllI[z.llIllIIlIII[4]] = z.lIlIlIIlIIIIlI("HSo1Ahsc", "yCCku");
        z.llIllIIIllI[z.llIllIIlIII[13]] = z.lIlIlIIlIIIIII("kQjKqFsFDCA=", "ovIsm");
        z.llIllIIIllI[z.llIllIIlIII[14]] = z.lIlIlIIlIIIIIl("so6gsB0jzRQ=", "UTAnU");
        z.llIllIIIllI[z.llIllIIlIII[15]] = z.lIlIlIIlIIIIII("99vOFvC03Xs=", "dCscZ");
        z.llIllIIIllI[z.llIllIIlIII[16]] = z.lIlIlIIlIIIIIl("vI6aVPr/wDg=", "CsZgY");
        z.llIllIIIllI[z.llIllIIlIII[17]] = z.lIlIlIIlIIIIIl("Hc0Edbqp2Gc=", "eFodG");
        z.llIllIIIllI[z.llIllIIlIII[18]] = z.lIlIlIIlIIIIIl("py6VYHeZsoI=", "shBVv");
        z.llIllIIIllI[z.llIllIIlIII[19]] = z.lIlIlIIlIIIIlI("IwYEGRA=", "toaut");
        z.llIllIIIllI[z.llIllIIlIII[20]] = z.lIlIlIIlIIIIlI("DQkSBA==", "Zlsvt");
        z.llIllIIIllI[z.llIllIIlIII[21]] = z.lIlIlIIlIIIIII("xyx/YewFy/8=", "HQLhN");
    }
            ...
            Item llllllllllllllllIIlIlllIlIlIIlll = Inventory.getFirst(item -> {
                ...
                if (!z.lIlIlIIlIIlllI(item.getName().toLowerCase().contains(llIllIIIllI[llIllIIlIII[4]]) ? 1 : 0) || z.lIlIlIIlIIllll(item.getName().toLowerCase().contains(llIllIIIllI[llIllIIlIII[13]]) ? 1 : 0)) {
                    ...
                    if (z.lIlIlIIlIIllll(llllllllllllllllIIlIlllIlIIIllII.hasAction(stringArray) ? 1 : 0)) {
                        n2 = llIllIIlIII[2];
                        "".length();
                        if (-" ".length() <= ((0xC9 ^ 0xC3) & ~(0x15 ^ 0x1F))) return n2 != 0;
