...
extends bm {
    ...
    private static void lIlIIlIlIIIIlI() {
        ...
        br.llIlIIIlIll[br.llIlIIIllII[0]] = br.lIlIIlIlIIIIII("OTggHCAWImMBJBo6JgE=", "xVCuE");
        br.llIlIIIlIll[br.llIlIIIllII[2]] = br.lIlIIlIlIIIIII("OjgeIT8QIg==", "sVmQZ");
        br.llIlIIIlIll[br.llIlIIIllII[4]] = br.lIlIIlIlIIIIIl("xEMZtOIHCZqIqCPaNjwMGQ9YVEftN9+eArk9Aow+JB7p77lI9yOisRTBqRBfXwS0", "WWssN");
        br.llIlIIIlIll[br.llIlIIIllII[10]] = br.lIlIIlIlIIIIIl("Saj8XJJ9Sg2iFbl/FELv6qzOJRakXSSrob2y0WzR9WEzTWfm1Qy3Z2JYV0BXtqJVaKkLa0I3ioXyit+v1MWusA==", "gHCyO");
    }
    ...
    private static void lIlIIlIlIIIIll() {
        ...
        br.llIlIIIllII[0] = (6 ^ 0x14 ^ (2 ^ 0x44)) & (0xC5 ^ 0xA7 ^ (0x32 ^ 4) ^ -" ".length());
        br.llIlIIIllII[1] = 0x7D ^ 0x69;
        br.llIlIIIllII[2] = " ".length();
        br.llIlIIIllII[3] = 0x6D ^ 0x68;
        br.llIlIIIllII[4] = "  ".length();
    ...
    private Set<Integer> b(Tile[][] tileArray, Point point) {
        ...
        while (br.lIlIIlIlIIlIlI(llllllllllllllllIIllIlllIlIIIlll, llIlIIIllII[3])) {
            ...
            "".length();
            if (((231 + 209 - 384 + 184 ^ 33 + 76 - 96 + 162) & (131 + 216 - 332 + 225 ^ 69 + 134 - 199 + 171 ^ -" ".length())) == ((0xE7 ^ 0x9C ^ (0xC ^ 0x59)) & (0xEC ^ 0xB9 ^ (0xC3 ^ 0xB8) ^ -" ".length()))) continue;
            return null;
        }
        return hashSet;
    }
