...
extends Z {
    ...
    private static void lIlIIIIIllIIll() {
        ...
        al.llIIlIlIIlI[0] = (0xB5 ^ 0xC3 ^ (0x61 ^ 7)) & (65 + 128 - 90 + 51 ^ 131 + 95 - 168 + 80 ^ -" ".length());
        al.llIIlIlIIlI[1] = " ".length();
        al.llIIlIlIIlI[2] = "  ".length();
        al.llIIlIlIIlI[3] = "   ".length();
        ...
        Item llllllllllllllllIIlllllllIllIIll = Inventory.getFirst(item -> {
            ...
            if (!al.lIlIIIIIllIlII(item.getName().contains(llIIlIlIIIl[llIIlIlIIlI[1]]) ? 1 : 0) || !al.lIlIIIIIllIlII(item.getName().contains(llIIlIlIIIl[llIIlIlIIlI[2]]) ? 1 : 0) || al.lIlIIIIIllIlIl(item.getName().contains(llIIlIlIIIl[llIIlIlIIlI[3]]) ? 1 : 0)) {
                ...
                if (-(59 + 141 - 99 + 60 ^ 1 + 33 - 28 + 158) >= 0) {
                    return ((0x41 ^ 0x14 ^ (0xBC ^ 0xC5)) & (75 + 38 - 59 + 85 ^ 62 + 72 - 9 + 42 ^ -" ".length())) != 0;
                }
            } else {
                bl2 = llIIlIlIIlI[0];
            }
    ...
    private static void lIlIIIIIllIIlI() {
        ...
        al.llIIlIlIIIl[al.llIIlIlIIlI[0]] = al.lIlIIIIIlIllll("7JRNNxlQStw=", "OJUdC");
        al.llIIlIlIIIl[al.llIIlIlIIlI[1]] = al.lIlIIIIIllIIII("ECwZAw==", "QBmjx");
        al.llIIlIlIIIl[al.llIIlIlIIlI[2]] = al.lIlIIIIIllIIII("NRkxIw==", "QvEFU");
        al.llIIlIlIIIl[al.llIIlIlIIlI[3]] = al.lIlIIIIIlIllll("cJ5mpCd4lno=", "pAfZU");
        al.llIIlIlIIIl[al.llIIlIlIIlI[4]] = al.lIlIIIIIllIIIl("yZurzDbdHZ8=", "FhVdc");
        al.llIIlIlIIIl[al.llIIlIlIIlI[5]] = al.lIlIIIIIllIIIl("XwGmsVt+LdQ=", "JlQXV");
    }
    ...
    private static String lIlIIIIIllIIII(String llllllllllllllllIIlllllllIIlIIlI, String llllllllllllllllIIlllllllIIlIIIl) {
        ...
        while (al.lIlIIIIIllIlll(llllllllllllllllIIlllllllIIIlIll, llllllllllllllllIIlllllllIIIllII)) {
            ...
            "".length();
            if ("  ".length() != ((0x4F ^ 0x11) & ~(0xF5 ^ 0xAB))) continue;
            return null;
        }
