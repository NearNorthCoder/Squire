...
extends Enum<bi> {
    ...
    private static void lIIlllIlIIIlIl() {
        ...
        bi.llIIIIIllll[bi.llIIIIlIlII[0]] = bi.lIIlllIlIIIIII("vITJRIrYv+I=", "FPrxz");
        bi.llIIIIIllll[bi.llIIIIlIlII[1]] = bi.lIIlllIlIIIIIl("Kj4zOyI=", "yirio");
        bi.llIIIIIllll[bi.llIIIIlIlII[2]] = bi.lIIlllIlIIIIlI("6n7akkCrSCI=", "LcXYi");
    }

    private static void lIIlllIlIlIIIl() {
        llIIIIlIlII = new int[5];
        bi.llIIIIlIlII[0] = (0x1A ^ 0x7A ^ (1 ^ 0x5E)) & (0x39 ^ 0x58 ^ (0xE2 ^ 0xBC) ^ -" ".length());
        bi.llIIIIlIlII[1] = " ".length();
        bi.llIIIIlIlII[2] = "  ".length();
        bi.llIIIIlIlII[3] = "   ".length();
