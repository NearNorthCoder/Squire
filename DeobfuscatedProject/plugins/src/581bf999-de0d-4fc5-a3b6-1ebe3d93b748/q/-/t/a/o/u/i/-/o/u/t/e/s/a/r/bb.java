...
extends bh {
    ...
    private static String lIIllIIIlIlIlI(String llllllllllllllllIlIIlllIIIlIllll, String llllllllllllllllIlIIlllIIIllIIll) {
        ...
        while (bb.lIIllIIIlllIII(llllllllllllllllIlIIlllIIIlIlIII, llllllllllllllllIlIIlllIIIlIlIIl)) {
            ...
            "".length();
            if (((0xA4 ^ 0xB9 ^ (0x71 ^ 0x2E)) & (0x5B ^ 0x4D ^ (0xD3 ^ 0x87) ^ -" ".length())) >= -" ".length()) continue;
            return null;
        }
    ...
    private static void lIIllIIIlIlllI() {
        ...
        bb.lIlllIIIlII[bb.lIlllIIIlll[0]] = bb.lIIllIIIlIlIIl("7lylnMmSa8B4ShhIfOQqqA==", "cXcQh");
        bb.lIlllIIIlII[bb.lIlllIIIlll[2]] = bb.lIIllIIIlIlIlI("CBE8Mjoi", "IeHSY");
        bb.lIlllIIIlII[bb.lIlllIIIlll[3]] = bb.lIIllIIIlIlIll("1dY8SXvfH4C+/2TRxjehrw==", "FjIqR");
        bb.lIlllIIIlII[bb.lIlllIIIlll[4]] = bb.lIIllIIIlIlIIl("7k1BEgqS3riHZEBKGM0pFA==", "HIuYT");
    }
    ...
    protected boolean bL() {
        ...
        NPC nPC2 = NPCs.getNearest(nPC -> {
            ...
            if (bb.lIIllIIIllIlIl(List.of(lIlllIIIlII[lIlllIIIlll[3]], lIlllIIIlII[lIlllIIIlll[4]]).contains(nPC.getName()) ? 1 : 0) && bb.lIIllIIIllIlll(nPC.isDead() ? 1 : 0)) {
                n2 = lIlllIIIlll[2];
                "".length();
                if (((0xBF ^ 0xA0 ^ (0x57 ^ 0x67)) & (83 + 22 - -126 + 2 ^ 10 + 47 - -110 + 31 ^ -" ".length())) > 0) {
                    return ((2 + 108 - 48 + 134 ^ 95 + 127 - 86 + 17) & (64 + 93 - 116 + 172 ^ 76 + 27 - 78 + 111 ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIlllIIIlll[0];
            }
        ...
        if (bb.lIIllIIIllIlll(Reachable.isInteractable((Locatable)llllllllllllllllIlIIlllIIllIIIII) ? 1 : 0)) {
            ...
            while (bb.lIIllIIIlllIII(llllllllllllllllIlIIlllIIlIlllII, llllllllllllllllIlIIlllIIlIlllIl)) {
                ...
                return ((3 ^ 0x55 ^ (0x42 ^ 0x1A)) & (12 + 52 - 11 + 78 ^ 84 + 8 - -10 + 39 ^ -" ".length())) != 0;
            }
    ...
    private static void lIIllIIIllIlII() {
        ...
        bb.lIlllIIIlll[2] = " ".length();
        bb.lIlllIIIlll[3] = "  ".length();
        bb.lIlllIIIlll[4] = "   ".length();
