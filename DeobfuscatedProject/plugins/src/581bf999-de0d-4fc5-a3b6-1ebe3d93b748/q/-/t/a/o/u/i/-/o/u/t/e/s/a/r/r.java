...
extends Enum<r> {
    ...
    private static void lIlIIlIlllIIII() {
        ...
        r.llIlIIllIII[r.llIlIIllIIl[0]] = r.lIlIIlIllIllIl("1BsexXCa1SE=", "rkLYA");
        r.llIlIIllIII[r.llIlIIllIIl[1]] = r.lIlIIlIllIlllI("FiQ1LlozPQ==", "FMVEw");
        r.llIlIIllIII[r.llIlIIllIIl[3]] = r.lIlIIlIllIllll("hKiUjARF1Fs=", "tGkRZ");
        r.llIlIIllIII[r.llIlIIllIIl[15]] = r.lIlIIlIllIllIl("DmobyyYHQykBDVbgjtSGvg==", "IftsV");
        r.llIlIIllIII[r.llIlIIllIIl[19]] = r.lIlIIlIllIllll("D/UR3eiaX4I=", "GUlxa");
        r.llIlIIllIII[r.llIlIIllIIl[22]] = r.lIlIIlIllIllIl("DCkcH5sgNoYFAItVBNlMIw==", "exgaZ");
        r.llIlIIllIII[r.llIlIIllIIl[25]] = r.lIlIIlIllIllIl("qhg4O4HgkOQ=", "OgdNu");
        r.llIlIIllIII[r.llIlIIllIIl[29]] = r.lIlIIlIllIllIl("1TOpeIP4duZ9sa0yQP2hxw==", "bhDzb");
        r.llIlIIllIII[r.llIlIIllIIl[30]] = r.lIlIIlIllIllIl("Xyoe37qhBPM=", "inkWy");
        r.llIlIIllIII[r.llIlIIllIIl[31]] = r.lIlIIlIllIllIl("6NcHIU4TTB4=", "sOHde");
        r.llIlIIllIII[r.llIlIIllIIl[33]] = r.lIlIIlIllIlllI("ESg+Igh0", "CgqoW");
        r.llIlIIllIII[r.llIlIIllIIl[34]] = r.lIlIIlIllIllll("atnCogMKnz89o+OBbWuSHQ==", "SUcHJ");
        r.llIlIIllIII[r.llIlIIllIIl[35]] = r.lIlIIlIllIllIl("lEc7hFc0EebAehXFDTMP8g==", "HhhbX");
        r.llIlIIllIII[r.llIlIIllIIl[36]] = r.lIlIIlIllIllll("m9V3F18+qAZ9Y6VOmGD5Fg==", "oPeQL");
    }
    ...
    private static void lIlIIlIlllIIIl() {
        ...
        r.llIlIIllIIl[0] = (0xB0 ^ 0x92 ^ (1 ^ 0x6F)) & (19 + 101 - 69 + 144 ^ 29 + 48 - 8 + 74 ^ -" ".length());
        r.llIlIIllIIl[1] = " ".length();
        r.llIlIIllIIl[2] = 0xFFFFF957 & 0x3FFA;
        r.llIlIIllIIl[3] = "  ".length();
        ...
        while (r.lIlIIlIlllIIlI(llllllllllllllllIIllIlIlIllIlIII, (int)llllllllllllllllIIllIlIlIllIlIIl)) {
            ...
            while (r.lIlIIlIlllIIll(llllllllllllllllIIllIlIlIllIIlIl.hasNext() ? 1 : 0)) {
                ...
                if (r.lIlIIlIlllIlII(llllllllllllllllIIllIlIlIllIlIll.contains(llllllllllllllllIIllIlIlIllIIlII) ? 1 : 0)) {
                    ...
                    "".length();
                    if (((196 + 132 - 175 + 89 ^ 167 + 80 - 224 + 157) & (0xBA ^ 0x85 ^ (0xC ^ 0x75) ^ -" ".length())) == 0) break;
                    return null;
                }
                "".length();
            ...
            if (r.lIlIIlIlllIlII(llllllllllllllllIIllIlIlIllIIllI)) {
                "".length();
                if (((115 + 80 - 160 + 143 ^ 28 + 106 - 122 + 136) & (0xF3 ^ 0xBD ^ (0x21 ^ 0x49) ^ -" ".length())) != 0) {
                    return null;
                }
            } else {
