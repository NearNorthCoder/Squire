...
extends by {
        ...
        if (bx.lIIllIlllIllII(NPCs.getNearest(nPC -> {
            ...
            if (bx.lIIllIlllIllIl(nPC.getName().contains(lIllllllIIl[lIllllllIlI[0]]) ? 1 : 0)) {
                ...
                if (bx.lIIllIlllIllIl(nPC.hasAction(stringArray) ? 1 : 0)) {
                    n2 = lIllllllIlI[1];
                    "".length();
                    if ((0x4E ^ 0x4A) >= "  ".length()) return n2 != 0;
    ...
    private static void lIIllIlllIlIlI() {
        ...
        bx.lIllllllIIl[bx.lIllllllIlI[0]] = bx.lIIllIlllIlIIl("k6OVL3SqwLY=", "BZpFi");
        bx.lIllllllIIl[bx.lIllllllIlI[1]] = bx.lIIllIlllIlIIl("zXpB9jFnuBs=", "IxZqH");
    }
