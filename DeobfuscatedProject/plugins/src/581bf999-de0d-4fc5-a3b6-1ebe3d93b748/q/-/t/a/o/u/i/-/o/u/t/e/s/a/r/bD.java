...
extends bG {
    ...
    @Override
    public boolean bl() {
        WorldPoint llllllllllllllllIlIIlIllIIIIIIII;
        bD llllllllllllllllIlIIlIllIIIIIIIl;
        ...
        if (bD.lIIllIlIlIllII(this.gj)) {
            ...
            llllllllllllllllIlIIlIllIIIIIIII = llllllllllllllllIlIIlIllIIIIIIIl.a(llllllllllllllllIlIIlIllIIIIIIIl.gk);
        }
        if (bD.lIIllIlIlIllll(llllllllllllllllIlIIlIllIIIIIIIl.cu.getLocalPlayer().getWorldLocation().equals((Object)llllllllllllllllIlIIlIllIIIIIIII) ? 1 : 0)) {
            return lIllllIlIIl[0];
        }
        WorldPoint llllllllllllllllIlIIlIlIllllllll = llllllllllllllllIlIIlIllIIIIIIII;
        if (bD.lIIllIlIlIllII(TileObjects.getAll(tileObject -> {
            int n2;
            if (bD.lIIllIlIlIllll(tileObject instanceof GameObject) && bD.lIIllIlIlIllll(((GameObject)tileObject).getWorldArea().contains(llllllllllllllllIlIIlIlIllllllll) ? 1 : 0)) {
                n2 = lIllllIlIIl[1];
                "".length();
                if ((87 + 59 - 62 + 53 ^ 95 + 39 - 42 + 49) < ((0x54 ^ 0xB ^ (0xF ^ 0x4F)) & (0xDB ^ 0xBA ^ (1 ^ 0x7F) ^ -" ".length()))) {
    ...
    public void b(GraphicsObjectCreated graphicsObjectCreated) {
        void llllllllllllllllIlIIlIlIlllllIIl;
        bD llllllllllllllllIlIIlIlIlllllIlI;
        WorldPoint llllllllllllllllIlIIlIlIllllIlll;
        int n2 = graphicsObjectCreated.getGraphicsObject().getId();
        if ((!bD.lIIllIlIllIIII(n2, lIllllIlIIl[3]) || bD.lIIllIlIllIIIl(n2, lIllllIlIIl[4])) && bD.lIIllIlIlIllll((llllllllllllllllIlIIlIlIllllIlll = WorldPoint.fromLocal((Client)llllllllllllllllIlIIlIlIlllllIlI.cu, (LocalPoint)llllllllllllllllIlIIlIlIlllllIIl.getGraphicsObject().getLocation())).equals((Object)llllllllllllllllIlIIlIlIlllllIlI.a(ge)) ? 1 : 0)) {
            Point point;
            int n3;
            void llllllllllllllllIlIIlIlIlllllIII;
            if (bD.lIIllIlIllIIIl((int)llllllllllllllllIlIIlIlIlllllIII, lIllllIlIIl[3])) {
                n3 = lIllllIlIIl[5];
                "".length();
                if (-"   ".length() > 0) {
                    return;
                ...
                n3 = llllllllllllllllIlIIlIlIlllllIlI.gj = lIllllIlIIl[6];
            }
            if (bD.lIIllIlIllIIIl((int)llllllllllllllllIlIIlIlIlllllIII, lIllllIlIIl[3])) {
                point = gf;
                "".length();
            ...
            llllllllllllllllIlIIlIlIlllllIlI.gk = point;
        }
    }
