...
extends Task {
    ...
    private void h() {
        ...
        if (b.lIllllllIIlIlII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
            n2 = lIlIlIlIlIllI[5];
            "".length();
            if (((47 + 131 - 89 + 54 ^ 155 + 91 - 157 + 78) & (0x68 ^ 0x4E ^ (0x8E ^ 0x80) ^ -" ".length())) != 0) {
                return;
            }
        } else {
            n2 = lIlIlIlIlIllI[4];
    ...
    private static void lIllllllIIlIIlI() {
        ...
        b.lIlIlIlIlIllI[0] = (0x4C ^ 0x7B ^ "  ".length()) & (0xCC ^ 0x99 ^ (0x44 ^ 0x24) ^ -" ".length());
        b.lIlIlIlIlIllI[1] = " ".length();
        b.lIlIlIlIlIllI[2] = "  ".length();
        b.lIlIlIlIlIllI[3] = -(0xFFFFEBE6 & 0x7D9F) & (0xFFFFEFDF & 0x7BFF);
        b.lIlIlIlIlIllI[4] = "   ".length();
    ...
    private static void lIllllllIIIIlll() {
        ...
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[0]] = b.lIllllllIIIIIII("dxbpRv6oeTMsh7Qt6FVgjD4ZP1xMClFWIqu9HjHYRVw=", "pklFt");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[1]] = b.lIllllllIIIIIIl("blLdDQFRM0+f2DNsFlWJXk5GEoBzhsulnQ2Usw/QQKw=", "XzIwY");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[2]] = b.lIllllllIIIIIlI("MBAsHyADQiEZbgILORpuFhc7E24UDSAVJkQEOgRuFxI0FSs=", "dbUvN");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[4]] = b.lIllllllIIIIIlI("CRYCACooAUcKJicSD043KRQBBys=", "FfgnC");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[5]] = b.lIllllllIIIIIIl("ng+uVT6kLEc=", "KrzOE");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[6]] = b.lIllllllIIIIIII("y6h7l1hD4B+8IV6O0rYJidyDcBNRZ4af", "DnggO");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[7]] = b.lIllllllIIIIIlI("JjwULS0Y", "sRxBN");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[8]] = b.lIllllllIIIIIlI("MCI7DhsOJTkGWAEpNhUQRS8/BAsR", "eLWax");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[9]] = b.lIllllllIIIIIIl("DPgD0Reezyc=", "YRxZs");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[10]] = b.lIllllllIIIIIIl("GrJHKkKV3BCXiUkB1YAFNw==", "jvDJc");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[11]] = b.lIllllllIIIIIlI("BCwILgM3bQIrAXAkFyIAI20FNQI9bQciDCQlQyQFNT4X", "PMcGm");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[12]] = b.lIllllllIIIIIII("AnT7y+lUOeeImvxIh5dFiQ==", "xBOaS");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[13]] = b.lIllllllIIIIIII("8ikKvCY5A8SjW+8ZrWKHNcfL3itrgLPh", "CPjjS");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[14]] = b.lIllllllIIIIIIl("DxuDJnIJyZ7PdcK6W2kXHtmCJTL1WngvmdCUOxxUOFhAb9O4akHEs61WV8CDrJ2U", "PrlYa");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[15]] = b.lIllllllIIIIIII("uQfnAdl5uhE=", "mQpSJ");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[16]] = b.lIllllllIIIIIIl("AOm9GIfZ5DFO1TimsCAD0w==", "hRhaD");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[17]] = b.lIllllllIIIIIII("haQyDVIh/dU=", "NqBea");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[18]] = b.lIllllllIIIIIlI("ChohIRYqAQ==", "IuMMs");
        b.lIlIlIlIlIIll[b.lIlIlIlIlIllI[19]] = b.lIllllllIIIIIIl("jnIvsCdqo04=", "zPQBE");
    }
    ...
    public boolean run() {
        ...
        if (b.lIllllllIIlIlII(Inventory.isFull() ? 1 : 0)) {
            ...
            if (b.lIllllllIIlIlII(Inventory.contains((int[])llllllllllllllIllIlIlIlIllIIIIII) ? 1 : 0)) {
                ...
                "".length();
                if (null != null) {
                    return ((2 + 74 - -52 + 13 ^ 74 + 16 - 32 + 92) & (133 + 94 - 151 + 65 ^ 131 + 133 - 174 + 60 ^ -" ".length())) != 0;
                }
            } else {
        ...
        if (b.lIllllllIIlIIll(Widgets.isVisible((Widget)llllllllllllllIllIlIlIlIllIIIIIl) ? 1 : 0)) {
            ...
            NPC llllllllllllllIllIlIlIlIllIIIIII = NPCs.getNearest(nPC -> {
                ...
                if (b.lIllllllIIlIlII(nPC.hasAction(stringArray) ? 1 : 0) && b.lIllllllIIlIlII(nPC.getName().equals(lIlIlIlIlIIll[lIlIlIlIlIllI[19]]) ? 1 : 0)) {
                    n2 = lIlIlIlIlIllI[1];
                    "".length();
                    if (("  ".length() ^ (0x99 ^ 0x9F)) < 0) {
                        return ((210 + 242 - 447 + 246 ^ 146 + 130 - 189 + 94) & (126 + 80 - 175 + 187 ^ 75 + 142 - 88 + 19 ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIlIlIlIlIllI[0];
                }
    ...
    private boolean a(Widget[] widgetArray) {
        ...
        while (b.lIllllllIIlIlll(llllllllllllllIllIlIlIlIlIlIllII, (int)llllllllllllllIllIlIlIlIlIlIllIl)) {
            ...
            return ((50 + 132 - 166 + 125 ^ 24 + 113 - 16 + 62) & (0x93 ^ 0x95 ^ (0x25 ^ 0x19) ^ -" ".length())) != 0;
        }
        return lIlIlIlIlIllI[1];
    }
}
