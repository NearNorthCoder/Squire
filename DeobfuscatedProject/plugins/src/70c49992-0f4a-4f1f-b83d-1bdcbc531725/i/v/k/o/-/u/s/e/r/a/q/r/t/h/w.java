...
extends Task {
    ...
    private static void lIlllllIlIIlIIl() {
        ...
        w.lIlIlIlIIlIII[0] = (0xF2 ^ 0x8A ^ (0x16 ^ 0x2C)) & (114 + 181 - 209 + 124 ^ 137 + 1 - 80 + 86 ^ -" ".length());
        w.lIlIlIlIIlIII[1] = 0xFFFFAF3F & 0x73FF;
        w.lIlIlIlIIlIII[2] = " ".length();
        w.lIlIlIlIIlIII[3] = "  ".length();
    ...
    public boolean run() {
        ...
        while (w.lIlllllIlIIlIll(llllllllllllllIllIlIllIIlllllIll, llllllllllllllIllIlIllIIllllllII)) {
            ...
            if (w.lIlllllIlIIllII(llllllllllllllIllIlIllIIlllllIlI, lIlIlIlIIlIII[1])) {
                ...
                return ((26 + 119 - 133 + 164 ^ 93 + 75 - 135 + 148) & (19 + 107 - 104 + 149 ^ 1 + 68 - 45 + 150 ^ -" ".length())) != 0;
            }
            ++llllllllllllllIllIlIllIIlllllIll;
            "".length();
            if ("  ".length() != "   ".length()) continue;
            return ((0x31 ^ 0x56 ^ (0x4E ^ 0x72)) & (0x94 ^ 0xA8 ^ (0x53 ^ 0x34) ^ -" ".length())) != 0;
        }
        if (w.lIlllllIlIIllIl(llllllllllllllIllIlIllIIlllllllI) && w.lIlllllIlIIllIl(llllllllllllllIllIlIllIlIIIIIIII.Q() ? 1 : 0)) {
            n2 = lIlIlIlIIlIII[2];
            "".length();
            if ("  ".length() >= (0x31 ^ 0x3B ^ (0xCE ^ 0xC0))) {
                return ((14 + 71 - 26 + 68 ^ (0x11 ^ 0x6B)) & (67 + 63 - 126 + 170 ^ 33 + 160 - 160 + 138 ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIlIlIlIIlIII[0];
        }
    ...
    private static void lIlllllIlIIlIII() {
        ...
        w.lIlIlIlIIIlll[w.lIlIlIlIIlIII[0]] = w.lIlllllIlIIIllI("EwAW", "VabTq");
        w.lIlIlIlIIIlll[w.lIlIlIlIIlIII[2]] = w.lIlllllIlIIIlll("b+becfABivQ=", "lEREM");
    }
