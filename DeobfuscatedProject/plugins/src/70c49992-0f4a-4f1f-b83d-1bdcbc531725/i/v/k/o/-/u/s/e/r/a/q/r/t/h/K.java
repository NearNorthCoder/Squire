...
extends w {
    ...
    private static void lIlllllllllllII() {
        ...
        K.lIlIlIlllllIl[0] = " ".length();
        K.lIlIlIlllllIl[1] = (91 + 29 - 63 + 181 ^ 161 + 17 - 132 + 132) & (0xB6 ^ 0xC5 ^ (0x7C ^ 0x53) ^ -" ".length());
        ...
        K.lIlIlIlllllIl[5] = "  ".length();
        K.lIlIlIlllllIl[6] = 0xFFFFFD7F & 0x797;
        K.lIlIlIlllllIl[7] = "   ".length();
    ...
    public boolean Q() {
        void var2_2;
        void var1_1;
        K llllllllllllllIllIlIIllllllIlIll;
        if (K.lIlllllllllllIl(this.cg.c(lIlIlIlllllIl[0]))) {
            return lIlIlIlllllIl[1];
        }
        if (K.lIllllllllllllI(llllllllllllllIllIlIIllllllIlIll.ce.alch() ? 1 : 0)) {
            return lIlIlIlllllIl[1];
        }
        SpellBook.Standard llllllllllllllIllIlIIllllllIlIlI = SpellBook.Standard.HIGH_LEVEL_ALCHEMY;
        if (K.lIllllllllllllI(llllllllllllllIllIlIIllllllIlIlI.canCast() ? 1 : 0)) {
            return lIlIlIlllllIl[1];
        }
        Item llllllllllllllIllIlIIllllllIlIIl = llllllllllllllIllIlIIllllllIlIll.af();
        if (K.lIlllllllllllIl(llllllllllllllIllIlIIllllllIlIIl)) {
            return lIlIlIlllllIl[1];
        }
