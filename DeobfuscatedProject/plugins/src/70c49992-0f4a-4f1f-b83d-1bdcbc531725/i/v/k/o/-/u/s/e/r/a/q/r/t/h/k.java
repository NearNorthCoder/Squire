...
public class k {
    ...
    private static void lIlllllIlIIIlII() {
        ...
        k.lIlIlIlIIIlIl[1] = " ".length();
        k.lIlIlIlIIIlIl[2] = "  ".length();
        k.lIlIlIlIIIlIl[3] = "   ".length();
        ...
        k.lIlIlIlIIIlIl[11] = "   ".length() ^ (0xB1 ^ 0xB9);
        ...
        k.lIlIlIlIIIlIl[42] = 0xA1 ^ 0x88 ^ "   ".length();
        ...
        k.lIlIlIlIIIlIl[60] = " ".length() ^ (0x25 ^ 0x18);
        ...
        k.lIlIlIlIIIlIl[66] = 0x85 ^ 0xC6 ^ " ".length();
    ...
    private static void lIlllllIIlllIlI() {
        ...
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[0]] = k.lIlllllIIllIlII("QUKnrV0xJCDeLSfRVvXgRA==", "KEFlC");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[1]] = k.lIlllllIIllIlII("g8klxNbOSdjMpHyyQoWvzA==", "yPdQu");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[2]] = k.lIlllllIIllIlIl("x99iJvh1/bx72fcIsViGQo3ask/ycY3f", "YyOoI");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[3]] = k.lIlllllIIllIlIl("fAdoPW9vaui9eTRdey7zRwkeCbdNVVG5", "MpNZO");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[4]] = k.lIlllllIIllIlIl("bZjQYrJOxPXG/q7+S2WZOA==", "AviVf");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[5]] = k.lIlllllIIllIllI("BhQzJwosDzFkEysVMyMA", "BfRDe");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[6]] = k.lIlllllIIllIllI("PSkmNhMaIy96AAcxIj0T", "nBCZv");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[7]] = k.lIlllllIIllIllI("PRMGLhMHCQRrBRwHESQPTgQZJQQd", "nfvKa");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[8]] = k.lIlllllIIllIlIl("efFYLOVsY6fbHL3EGR4rKA==", "tWLIh");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[9]] = k.lIlllllIIllIlIl("Pl6izR1Fd+lP4j1w4IvB6Q==", "aKBQi");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[10]] = k.lIlllllIIllIllI("GgQlFXcjGD8VJCAYLhwz", "HqKpW");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[11]] = k.lIlllllIIllIlIl("TPUAy8Rxff9qFsdRvIedrg==", "yoDQr");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[12]] = k.lIlllllIIllIlIl("LwznitlchQafiF84wJdgWoF9a2EtOJJy", "nDHlB");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[13]] = k.lIlllllIIllIllI("IjYNHR0IZAAVHAE3GxUAAg==", "fDlzr");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[14]] = k.lIlllllIIllIlII("MbxJqgOJJRh9kU3BTDoBep1f//gWVLKy", "ZRqDW");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[15]] = k.lIlllllIIllIlIl("inKF8+KLFlTZc9t6qP3Rk1lxkBNU+WAQ", "QRIpt");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[16]] = k.lIlllllIIllIllI("NQUbCD1WHw8JKw==", "vmzgN");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[17]] = k.lIlllllIIllIlIl("T6/yclVhLGCBrVfOtc8C1Q==", "oMxqs");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[18]] = k.lIlllllIIllIlIl("RL+/oaLRNNBi6mKBEMN4UQ==", "XqeDm");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[19]] = k.lIlllllIIllIlII("LFmjRpSU+z5/Q6kMw2TqT4rtyXwJ1xAm", "YWxYR");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[20]] = k.lIlllllIIllIlIl("qSKukviXbifTw3X/s+adXw==", "yiYdv");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[21]] = k.lIlllllIIllIlII("4LFKJBZc6sTeT3OJG0+lWzZO1ILrn+u8", "lyaAW");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[22]] = k.lIlllllIIllIlIl("KKWnIbXsSNtE7aXRP+Cwlg==", "mirkl");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[23]] = k.lIlllllIIllIlIl("dFuEcwi9A+QEDFg2B7T0Tw==", "KQQgq");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[24]] = k.lIlllllIIllIlIl("UNqGuz/OlsGMKBXA3FqmPKA9wfdSmZJG", "pxVoq");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[25]] = k.lIlllllIIllIlII("MP/tiKm4BCa9OYhLc5WTHQ==", "JRUOk");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[26]] = k.lIlllllIIllIlII("OzM3NThf7qVZOhvgrNIo5MeAM37MkKCU", "kCbEf");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[27]] = k.lIlllllIIllIlIl("4E6xzcR74ej5mWQQRO272u4ft/c0D+Ow", "vuuTO");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[28]] = k.lIlllllIIllIllI("MAETASkZCFYRJxkYVgchBR8=", "ulvsH");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[29]] = k.lIlllllIIllIllI("OgYbFlgKHBUbWBwaCRw=", "hsyox");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[30]] = k.lIlllllIIllIlII("Hv8v9CkXxSdwq33t0nZJKuemAx8dR/nr", "HLKmZ");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[31]] = k.lIlllllIIllIlIl("BP4VVuYwWWiFbiFDiN5O8bdh14Tb7xCo", "rktig");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[32]] = k.lIlllllIIllIlII("wScBU9AMSsqXmKqlFMCdbQ==", "Tsrvo");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[33]] = k.lIlllllIIllIllI("NRcgCz0OFHILLAQc", "axRxI");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[34]] = k.lIlllllIIllIlIl("Z0wKPj+58wN3olGoV+U8iQ==", "kExTi");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[35]] = k.lIlllllIIllIlIl("scIu8/s3nHwXQQOOCE9hsA==", "Wrkxq");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[36]] = k.lIlllllIIllIlII("32k85wFA3fsJrTwMVWrO8A==", "WgrjQ");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[37]] = k.lIlllllIIllIlIl("AQdW/0KldXMNcg8QzKc67w==", "GPtgT");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[38]] = k.lIlllllIIllIlIl("H+IDMZCIxqRKbcpzDPUWIA==", "HlDgm");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[39]] = k.lIlllllIIllIlII("WY2xhF8F4+SNKx7IYfjYsg==", "pvfgb");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[40]] = k.lIlllllIIllIlII("S6DgUNtih/sanmcGr2unxQ==", "zANET");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[41]] = k.lIlllllIIllIlIl("HSu4A8r+B+RueKdPGVkgCzxulkxa9VYg", "eJIAH");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[42]] = k.lIlllllIIllIlIl("qE2GexQD5o05KGRKUSibww==", "bEfMV");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[43]] = k.lIlllllIIllIlII("Y85MxlhvueTQCDCBlLM+2A==", "fjmZj");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[44]] = k.lIlllllIIllIllI("ACQQNRwndAoiEDc=", "STyGu");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[45]] = k.lIlllllIIllIllI("LSsFBDwHeQIRJgAtRBA2DD0=", "iYdcS");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[46]] = k.lIlllllIIllIlII("5U7j427vFpVa+pV27NDTJQ==", "jbhdb");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[47]] = k.lIlllllIIllIlII("EP676NSJqMM=", "CVMGP");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[48]] = k.lIlllllIIllIlIl("ru2uBBYOwsY=", "FMLpS");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[49]] = k.lIlllllIIllIllI("GyYLJCx2KwMqPA==", "VGlMO");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[50]] = k.lIlllllIIllIllI("FDsDAC95KAwN", "YZmtN");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[51]] = k.lIlllllIIllIllI("KxMXMCEBQRQ4IAoS", "oavWN");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[52]] = k.lIlllllIIllIlIl("57aReML9NFk=", "dJWYt");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[53]] = k.lIlllllIIllIllI("DRoVFR0nGwAdHCw=", "Ihtrr");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[54]] = k.lIlllllIIllIllI("BwsiBjlwDSIeOCMUIhw=", "PyCrQ");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[55]] = k.lIlllllIIllIlII("KnuS7sgGwwtkoG6Pz+AxWIPhgrvDWMhj", "iungZ");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[56]] = k.lIlllllIIllIlII("ZIC9uXp53Ik9O2MAPtATDUxtz49iaidM", "eOLjP");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[57]] = k.lIlllllIIllIlII("aszeP/xexHNgrDMd9VN7IA==", "SqlRS");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[58]] = k.lIlllllIIllIllI("PRQjDyIKQS8HJA==", "oaMfV");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[59]] = k.lIlllllIIllIllI("Gi86PCYxbjw8OjE=", "TNNIT");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[60]] = k.lIlllllIIllIllI("OgQ5LmxaGXc4OwcDMw==", "hqWKL");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[61]] = k.lIlllllIIllIllI("HB8eFHcsCwQFOysLCBQ=", "NjpqW");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[62]] = k.lIlllllIIllIlII("Rgt24Uiql9ES0685fRyVWQ==", "xaNVD");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[63]] = k.lIlllllIIllIlIl("RVoXmLasd/7AO/lJJLvbDg==", "Bmsrs");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[64]] = k.lIlllllIIllIllI("Jy8gAkUUKDwIEg==", "uZNge");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[65]] = k.lIlllllIIllIlIl("LcarPKwwioRoToeeUmFYNw==", "ZIadL");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[66]] = k.lIlllllIIllIlII("LsCVT2TGlEs0V5BovhXDPQ==", "siiKW");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[67]] = k.lIlllllIIllIllI("JSAYIycPchQhLEE6HCgl", "aRyDH");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[68]] = k.lIlllllIIllIlIl("rj0jpYEZffJsKBxC21eLgA==", "DyHEt");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[69]] = k.lIlllllIIllIlII("wdQ2YjP8nnuWriZtFh0gJ9Sfcb7KZivD", "bbvzh");
        k.lIlIlIlIIIIIl[k.lIlIlIlIIIlIl[70]] = k.lIlllllIIllIlII("GBGaPkfQA4woCGbIY+C6Dw==", "zetht");
    }
}
