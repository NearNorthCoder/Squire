...
extends w {
    ...
    public boolean Q() {
        ...
        if (!J.llIIIIIIllIllIl(Combat.isVenomed() ? 1 : 0) || J.llIIIIIIllIlllI(Combat.isPoisoned() ? 1 : 0)) {
            ...
            "".length();
            if (null != null) {
                return ((0xDA ^ 0x92 ^ (0xBB ^ 0xBE)) & (157 + 22 - -8 + 8 ^ 73 + 126 - 197 + 140 ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIlIllIIlllIl[1];
        }
    ...
    private static String llIIIIIIllIlIIl(String llllllllllllllIllIlIIlIIlllIlIlI, String llllllllllllllIllIlIIlIIlllIIlII) {
        ...
        while (J.llIIIIIIlllIIll(llllllllllllllIllIlIIlIIllIllllI, llllllllllllllIllIlIIlIIllIlllll)) {
            ...
            "".length();
            if (((0x4D ^ 0x3A ^ (0x33 ^ 0x52)) & (0x58 ^ 0x3A ^ (0x4E ^ 0x3A) ^ -" ".length())) == 0) continue;
            return null;
        }
    ...
    private static void llIIIIIIllIlIlI() {
        ...
        J.lIlIllIIlllII[J.lIlIllIIlllIl[1]] = J.llIIIIIIllIIlll("ry3sTcBsobA=", "hIYLR");
        J.lIlIllIIlllII[J.lIlIllIIlllIl[0]] = J.llIIIIIIllIIlll("Ops9qhskek4=", "bKSAB");
        J.lIlIllIIlllII[J.lIlIllIIlllIl[4]] = J.llIIIIIIllIIlll("u49h4vYXu3Q=", "WEiQb");
        J.lIlIllIIlllII[J.lIlIllIIlllIl[5]] = J.llIIIIIIllIlIII("VKyox8/4Va8=", "eHmUQ");
        J.lIlIllIIlllII[J.lIlIllIIlllIl[6]] = J.llIIIIIIllIlIIl("KTUiHwA=", "mGKqk");
    }

    private static void llIIIIIIllIlIll() {
        lIlIllIIlllIl = new int[9];
        J.lIlIllIIlllIl[0] = " ".length();
        J.lIlIllIIlllIl[1] = (0xF3 ^ 0xB1) & ~(0xCB ^ 0x89);
        J.lIlIllIIlllIl[2] = 0xFFFF8FDB & 0x75ED;
        J.lIlIllIIlllIl[3] = 0xBC ^ 0xB2 ^ (0x6E ^ 6);
        J.lIlIllIIlllIl[4] = "  ".length();
        J.lIlIllIIlllIl[5] = "   ".length();
