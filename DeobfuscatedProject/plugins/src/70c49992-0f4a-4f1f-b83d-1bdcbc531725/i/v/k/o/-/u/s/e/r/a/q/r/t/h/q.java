...
extends o {
    ...
    @Override
    public boolean run() {
        q llllllllllllllIllIlIlIIIlIIlllIl;
        if (q.lIllllllllIIlIl(this.S() ? 1 : 0)) {
            return lIlIlIlllIIll[0];
        }
        if (q.lIllllllllIIllI(llllllllllllllIllIlIlIIIlIIlllIl.bU.c() ? 1 : 0)) {
            return lIlIlIlllIIll[0];
        }
        if (q.lIllllllllIIlIl(llllllllllllllIllIlIlIIIlIIlllIl.R() ? 1 : 0)) {
            return lIlIlIlllIIll[0];
        }
    ...
    private static void lIllllllllIIlII() {
        ...
        q.lIlIlIlllIIll[0] = (160 + 58 - 208 + 151 ^ 49 + 170 - 115 + 83) & (0xEA ^ 0xC6 ^ (0xA ^ 0x3C) ^ -" ".length());
        q.lIlIlIlllIIll[1] = " ".length();
    }
