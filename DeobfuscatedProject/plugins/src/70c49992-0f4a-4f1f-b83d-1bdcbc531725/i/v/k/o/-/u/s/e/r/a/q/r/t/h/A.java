...
extends w {
    ...
    private List<Prayer> ac() {
        List<Prayer> list;
        A llllllllllllllIllIlIlIIIlIllIIll;
        void llllllllllllllIllIlIlIIIlIllIIlI;
        Item item = Equipment.fromSlot((EquipmentInventorySlot)EquipmentInventorySlot.WEAPON);
        if (A.lIlllllllIlllII(item)) {
            return this.ae();
        }
        WeaponStyle llllllllllllllIllIlIlIIIlIllIIIl = WeaponMap.StyleMap.getOrDefault(llllllllllllllIllIlIlIIIlIllIIlI.getId(), WeaponStyle.MELEE);
        if (A.lIlllllllIllllI(llllllllllllllIllIlIlIIIlIllIIIl, WeaponStyle.MELEE)) {
            list = llllllllllllllIllIlIlIIIlIllIIll.ae();
            "".length();
            if ((3 ^ 7) <= 0) {
                return null;
            }
        } else {
            list = llllllllllllllIllIlIlIIIlIllIIll.ad();
        }
        return list;
    }
