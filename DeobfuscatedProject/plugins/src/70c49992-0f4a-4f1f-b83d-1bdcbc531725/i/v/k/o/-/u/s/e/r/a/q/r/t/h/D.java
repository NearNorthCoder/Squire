...
extends w {
    ...
    public boolean Q() {
        void var2_2;
        D llllllllllllllIllIlIlIIlIlIIlIII;
        void llllllllllllllIllIlIlIIlIlIIIlll;
        ...
        WorldPoint llllllllllllllIllIlIlIIlIlIIIllI = llllllllllllllIllIlIlIIlIlIIIlll.getWorldArea().getCenter().dy(lIlIlIllIIIll[3]);
        if (D.lIlllllllIIIIll(llllllllllllllIllIlIlIIlIlIIlIII.l.q().equals((Object)llllllllllllllIllIlIlIIlIlIIIllI) ? 1 : 0)) {
            return lIlIlIllIIIll[1];
        }
