...
extends w {
    ...
    private static void llIIIIIIIlIIIlI() {
        ...
        C.lIlIllIIIlIIl[0] = " ".length();
        C.lIlIllIIIlIIl[1] = (0xBC ^ 0x86 ^ (0x24 ^ 0x3F)) & (0x29 ^ 0x13 ^ (0xB1 ^ 0xAA) ^ -" ".length());
        C.lIlIllIIIlIIl[2] = "  ".length();
        C.lIlIllIIIlIIl[3] = "   ".length();
    ...
    private static void llIIIIIIIlIIIIl() {
        ...
        C.lIlIllIIIlIII[C.lIlIllIIIlIIl[1]] = C.llIIIIIIIIlllll("hHfQHUMT9Ec=", "dUwod");
        C.lIlIllIIIlIII[C.lIlIllIIIlIIl[0]] = C.llIIIIIIIlIIIII("DR8NNAU=", "ZvhXa");
        C.lIlIllIIIlIII[C.lIlIllIIIlIIl[2]] = C.llIIIIIIIlIIIII("QwJ4", "kgQVy");
        C.lIlIllIIIlIII[C.lIlIllIIIlIIl[3]] = C.llIIIIIIIIlllll("tDoWIEEwZTs=", "jTLQF");
        C.lIlIllIIIlIII[C.lIlIllIIIlIIl[4]] = C.llIIIIIIIIlllll("uP2JuNa33yo=", "oljwr");
        C.lIlIllIIIlIII[C.lIlIllIIIlIIl[5]] = C.llIIIIIIIlIIIII("Jw8NKA==", "UzoQs");
    }
    ...
    private static String llIIIIIIIlIIIII(String llllllllllllllIllIlIIllIlllIlIIl, String llllllllllllllIllIlIIllIlllIIIll) {
        ...
        while (C.llIIIIIIIlIlIII(llllllllllllllIllIlIIllIllIlllIl, llllllllllllllIllIlIIllIllIllllI)) {
            ...
            "".length();
            if (((0xE0 ^ 0xB3 ^ (0x90 ^ 0x94)) & (0xDE ^ 0xC7 ^ (0x4A ^ 4) ^ -" ".length())) == 0) continue;
            return null;
        }
        ...
        if (C.llIIIIIIIlIIllI(llllllllllllllIllIlIIlllIIIIIllI)) {
            llllllllllllllIllIlIIlllIIIIIlIl = Inventory.getFirst(item -> {
                ...
                if (C.llIIIIIIIlIIllI(item.getName().contains(lIlIllIIIlIII[lIlIllIIIlIIl[4]]) ? 1 : 0) && C.llIIIIIIIlIIllI(item.getName().toLowerCase().contains(lIlIllIIIlIII[lIlIllIIIlIIl[5]]) ? 1 : 0)) {
                    ...
                    "".length();
                    if (" ".length() < 0) {
                        return ((34 + 39 - 44 + 157 ^ 89 + 167 - 236 + 149) & (0x77 ^ 0x59 ^ (0x71 ^ 0x4C) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIlIllIIIlIIl[1];
                }
            ...
            if ("  ".length() >= (33 + 140 - 166 + 140 ^ 145 + 4 - 16 + 18)) {
                return ((124 + 175 - 108 + 57 ^ 84 + 56 - 66 + 101) & (129 + 30 - -2 + 51 ^ 93 + 11 - 92 + 119 ^ -" ".length())) != 0;
            }
        } else {
            llllllllllllllIllIlIIlllIIIIIlIl = Inventory.getFirst(item -> {
                int n2;
