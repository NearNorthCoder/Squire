...
public class f {
    ...
    public boolean z() {
        ...
        if (f.lIlllllIlllIIIl(projectile) && f.lIlllllIlllIIlI(projectile.getRemainingCycles(), lIlIlIlIlIIIl[7])) {
            n2 = lIlIlIlIlIIIl[3];
            "".length();
            if (((0xD9 ^ 0x8C ^ (0x12 ^ 0x26)) & (110 + 85 - 97 + 122 ^ 58 + 14 - 11 + 128 ^ -" ".length())) >= " ".length()) {
                return ((154 + 189 - 162 + 25 ^ 114 + 0 - -15 + 30) & (0x1D ^ 0x73 ^ (4 ^ 0x3B) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIlIlIlIlIIIl[1];
        }
    ...
    private static /* synthetic */ boolean c(WorldPoint worldPoint, TileObject tileObject) {
        ...
        if (f.lIlllllIlllIIll(tileObject.getId(), lIlIlIlIlIIIl[5]) && f.lIlllllIlllIlIl(tileObject.getWorldLocation().equals((Object)worldPoint) ? 1 : 0)) {
            n2 = lIlIlIlIlIIIl[3];
            "".length();
            if (((0x37 ^ 0x23 ^ (0xC5 ^ 0xC0)) & (0x6C ^ 0x23 ^ (0x28 ^ 0x76) ^ -" ".length())) >= "   ".length()) {
    ...
    public boolean y() {
        ...
        block5: {
            ...
            return ((0xFD ^ 0x81 ^ (0x59 ^ 0x29)) & (59 + 99 - 42 + 34 ^ 27 + 73 - 65 + 119 ^ -" ".length())) != 0;
        }
        n2 = lIlIlIlIlIIIl[1];
        return n2 != 0;
    }
    ...
    private static String lIlllllIllIIlll(String llllllllllllllIllIlIlIllllIlIIIl, String llllllllllllllIllIlIlIllllIlIIII) {
        ...
        while (f.lIlllllIllllIlI(llllllllllllllIllIlIlIllllIIIlIl, llllllllllllllIllIlIlIllllIIIllI)) {
            ...
            "".length();
            if ((("  ".length() ^ (0x31 ^ 0x2B)) & (0xF6 ^ 0xB2 ^ (0xE3 ^ 0xBF) ^ -" ".length())) < " ".length()) continue;
            return null;
        }
    ...
    private static void lIlllllIllIlIll() {
        ...
        f.lIlIlIlIIllll[f.lIlIlIlIlIIIl[1]] = f.lIlllllIllIIllI("0/qEBX1Ahqs4FmKoJw7fkJJyeLcK0DKf", "XZscT");
        f.lIlIlIlIIllll[f.lIlIlIlIlIIIl[3]] = f.lIlllllIllIIlll("Mw0/AA8jGTAcDWYaNgdKJxB5Gx5mBzYXGWYQNg==", "FcYrj");
        f.lIlIlIlIIllll[f.lIlIlIlIlIIIl[9]] = f.lIlllllIllIlIII("OhE2t0kdWQq4acFgrsTQKQ==", "LrpWc");
        f.lIlIlIlIIllll[f.lIlIlIlIlIIIl[12]] = f.lIlllllIllIlIII("1EU+tTMa9CkSH2quNTL76Q==", "xrilH");
        f.lIlIlIlIIllll[f.lIlIlIlIlIIIl[13]] = f.lIlllllIllIlIII("oao8LVv0nWI=", "VbWVA");
        f.lIlIlIlIIllll[f.lIlIlIlIlIIIl[7]] = f.lIlllllIllIIllI("WqiaXgw5kgU=", "CkhMC");
        f.lIlIlIlIIllll[f.lIlIlIlIlIIIl[11]] = f.lIlllllIllIIlll("ax9m", "CzOjX");
        f.lIlIlIlIIllll[f.lIlIlIlIlIIIl[14]] = f.lIlllllIllIlIII("8tEefnz1ahw=", "uZIMo");
        f.lIlIlIlIIllll[f.lIlIlIlIlIIIl[10]] = f.lIlllllIllIIlll("MiENFTIY", "sUytQ");
        f.lIlIlIlIIllll[f.lIlIlIlIlIIIl[15]] = f.lIlllllIllIIllI("flR15gz3LV0=", "wlXec");
        f.lIlIlIlIIllll[f.lIlIlIlIlIIIl[16]] = f.lIlllllIllIlIII("QKJ2UvGPvzfkdSricMhv6g==", "KIzCD");
    }
    ...
    public EquipmentSetup D() {
        ...
        if (f.lIlllllIlllIlII(llllllllllllllIllIlIllIIIIIIIllI.contains(itemComposition -> {
            ...
            if (f.lIlllllIlllIIIl(itemComposition.getName()) && f.lIlllllIlllIlIl(itemComposition.getName().contains(lIlIlIlIIllll[lIlIlIlIlIIIl[11]]) ? 1 : 0)) {
                ...
                "".length();
                if ("  ".length() == 0) {
                    return ((0x78 ^ 0x2F ^ (0x62 ^ 2)) & (0x96 ^ 0x84 ^ (0x3C ^ 0x19) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIlIlIlIlIIIl[1];
            }
    ...
    public boolean C() {
        ...
        if (f.lIlllllIlllIllI(WeaponMap.StyleMap.getOrDefault(llllllllllllllIllIlIllIIIIIlIIIl.getId(), WeaponStyle.MELEE), WeaponStyle.MELEE)) {
            ...
            "".length();
            if (null != null) {
                return ((0x32 ^ 1 ^ (0xFB ^ 0xC7)) & (80 + 124 - 90 + 16 ^ 55 + 88 - 37 + 35 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlIlIlIlIIIl[1];
        }
        ...
        return NPCs.getNearest(nPC -> {
            ...
            if (f.lIlllllIlllIlIl(nPC.getName().equals(lIlIlIlIIllll[lIlIlIlIlIIIl[14]]) ? 1 : 0)) {
                ...
                if (f.lIlllllIlllIlIl(nPC.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    "".length();
                    if ("  ".length() != 0) return n2 != 0;
                    return ((0xA3 ^ 0xBB ^ (0x8D ^ 0x9E)) & (0x9F ^ 0x89 ^ (0x29 ^ 0x34) ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIlIlIlIIIl[1];
            return n2 != 0;
    ...
    public boolean E() {
        ...
        if (f.lIlllllIllllIlI(Skills.getBoostedLevel((Skill)Skill.HITPOINTS), Skills.getLevel((Skill)Skill.HITPOINTS))) {
            ...
            "".length();
            if (-" ".length() >= "  ".length()) {
                return ((0x3B ^ 0x1A ^ (0x9A ^ 0x81)) & (0x16 ^ 0x36 ^ (0xB8 ^ 0xA2) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlIlIlIlIIIl[1];
        }
