...
public class g {
    ...
    public WorldPoint a(RegionPoint regionPoint) {
        ...
        return collection.stream().filter(worldPoint -> {
            ...
            if (g.llIIIIIIIIIIIll(worldPoint.getPlane(), client.getPlane())) {
                ...
                "".length();
                if ("   ".length() != "   ".length()) {
                    return ((0xFA ^ 0x88 ^ (0xFE ^ 0xA7)) & (0x49 ^ 0x78 ^ (0x1A ^ 0) ^ -" ".length())) != 0;
                }
            } else {
                bl = lIlIllIIIIIIl[0];
            }
    ...
    public boolean c(int n2) {
        void llllllllllllllIllIlIIlllllIlIlll;
        int[] nArray = this.D.getMapRegions();
        int n3 = nArray.length;
        int llllllllllllllIllIlIIlllllIlIllI = lIlIllIIIIIIl[0];
        while (g.llIIIIIIIIIIIlI(llllllllllllllIllIlIIlllllIlIllI, (int)llllllllllllllIllIlIIlllllIlIlll)) {
            void llllllllllllllIllIlIIlllllIllIIl;
            void llllllllllllllIllIlIIlllllIllIII;
            void llllllllllllllIllIlIIlllllIlIlIl = llllllllllllllIllIlIIlllllIllIII[llllllllllllllIllIlIIlllllIlIllI];
            if (g.llIIIIIIIIIIIll((int)llllllllllllllIllIlIIlllllIlIlIl, (int)llllllllllllllIllIlIIlllllIllIIl)) {
                return lIlIllIIIIIIl[1];
            }
            ++llllllllllllllIllIlIIlllllIlIllI;
            "".length();
            if ((65 + 54 - -3 + 10 ^ 118 + 33 - 88 + 65) >= " ".length()) continue;
            return ((0x5B ^ 8 ^ (0x8D ^ 0xC7)) & (0xE8 ^ 0x8A ^ (0x35 ^ 0x4E) ^ -" ".length())) != 0;
        }
