...
extends Task {
    ...
    private static void llllIlllllIIll() {
        ...
        k.llIIlIIIIIIl[k.llIIlIIIIIlI[0]] = k.llllIlllllIIII("PRMELBYbAgMnA1oCAyUBCQ==", "zvjId");
        k.llIIlIIIIIIl[k.llIIlIIIIIlI[9]] = k.llllIlllllIIIl("XgAHSE7c4QRCCL2SvYDsVw==", "SRTtD");
        k.llIIlIIIIIIl[k.llIIlIIIIIlI[17]] = k.llllIlllllIIII("Mi0lBEUUIicTBB8vNg==", "qLSae");
        k.llIIlIIIIIIl[k.llIIlIIIIIlI[5]] = k.llllIlllllIIlI("swf66qCq03U=", "wOrEm");
    }
    ...
    public boolean run() {
        ...
        if (k.llllIlllllIllI(n.al)) {
            k lllllllllllllllIlIlIIIIIlIlIIIIl;
            lllllllllllllllIlIlIIIIIlIlIIIIl.sleep(llIIlIIIIIlI[1]);
        ...
        ArrayList<Prayer> lllllllllllllllIlIlIIIIIlIlIIIII = new ArrayList<Prayer>();
        lllllllllllllllIlIlIIIIIlIlIIIII.addAll(Prayers.getRangePrayers());
        "".length();
        ...
        NPC lllllllllllllllIlIlIIIIIlIIlllII = NPCs.getNearest((int[])c.s);
        NPC lllllllllllllllIlIlIIIIIlIIllIll = NPCs.getNearest((int[])c.t);
        NPC lllllllllllllllIlIlIIIIIlIIllIlI = NPCs.getNearest((int[])c.u);
        NPC lllllllllllllllIlIlIIIIIlIIllIIl = NPCs.getNearest((int[])c.v);
        if (k.llllIlllllIlll(f.p(), llIIlIIIIIlI[10])) {
            if (k.llllIllllllIII(f.D, llIIlIIIIIlI[11])) {
                lllllllllllllllIlIlIIIIIlIlIIIII.add(Prayer.PROTECT_FROM_MELEE);
                "".length();
            }
            if (k.llllIllllllIIl(f.p(), llIIlIIIIIlI[11]) && k.llllIllllllIlI(f.p(), llIIlIIIIIlI[12]) && k.llllIllllllIlI(f.p(), llIIlIIIIIlI[13]) && k.llllIllllllIlI(f.p(), llIIlIIIIIlI[14])) {
                if (!k.llllIlllllIlIl(f.a(Static.getClient(), b.BLOB, Players.getLocal()) ? 1 : 0) || !k.llllIlllllIlIl(f.a(Static.getClient(), b.SMALL_BLOB, Players.getLocal()) ? 1 : 0) || !k.llllIlllllIlIl(f.a(Static.getClient(), b.MELEER, Players.getLocal()) ? 1 : 0) || k.llllIlllllIlll(f.r(), llIIlIIIIIlI[9]) && k.llllIllllllIll(lllllllllllllllIlIlIIIIIlIIllIll) && k.llllIlllllllII(n.c(lllllllllllllllIlIlIIIIIlIIllIll.getWorldArea().toWorldPointList()) ? 1 : 0)) {
                    lllllllllllllllIlIlIIIIIlIlIIIII.add(Prayer.PROTECT_FROM_MELEE);
                    "".length();
                }
                if (!k.llllIlllllIlIl(f.a(Static.getClient(), b.RANGER, Players.getLocal()) ? 1 : 0) || k.llllIlllllIlll(f.u(), llIIlIIIIIlI[9]) && k.llllIllllllIll(lllllllllllllllIlIlIIIIIlIIlllII) && k.llllIlllllIllI(lllllllllllllllIlIlIIIIIlIIllIlI)) {
                    lllllllllllllllIlIlIIIIIlIlIIIII.add(Prayer.PROTECT_FROM_MISSILES);
                    "".length();
                }
                if (!k.llllIlllllIlIl(f.a(Static.getClient(), b.MAGER, Players.getLocal()) ? 1 : 0) || k.llllIlllllIlll(f.t(), llIIlIIIIIlI[9]) && k.llllIllllllIll(lllllllllllllllIlIlIIIIIlIIllIlI)) {
                    lllllllllllllllIlIlIIIIIlIlIIIII.add(Prayer.PROTECT_FROM_MAGIC);
                    "".length();
                }
            }
        ...
        if (k.llllIllllllIll(lllllllllllllllIlIlIIIIIlIIllIIl)) {
            System.out.println(llIIlIIIIIIl[llIIlIIIIIlI[9]]);
            if (k.llllIlllllllIl(lllllllllllllllIlIlIIIIIlIIllIIl.getAnimation(), llIIlIIIIIlI[15])) {
                lllllllllllllllIlIlIIIIIlIlIIIII.add(Prayer.PROTECT_FROM_MAGIC);
                "".length();
                "".length();
                if ((0x16 ^ 0x12) < 0) {
    ...
    private static String llllIlllllIIII(String lllllllllllllllIlIlIIIIIIllIlIll, String lllllllllllllllIlIlIIIIIIllIlIlI) {
        lllllllllllllllIlIlIIIIIIllIlIll = new String(Base64.getDecoder().decode(lllllllllllllllIlIlIIIIIIllIlIll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIlIlIIIIIIllIlllI = new StringBuilder();
        char[] lllllllllllllllIlIlIIIIIIllIllIl = lllllllllllllllIlIlIIIIIIllIlIlI.toCharArray();
        int lllllllllllllllIlIlIIIIIIllIllII = llIIlIIIIIlI[0];
        char[] lllllllllllllllIlIlIIIIIIllIIllI = lllllllllllllllIlIlIIIIIIllIlIll.toCharArray();
        int lllllllllllllllIlIlIIIIIIllIIlIl = lllllllllllllllIlIlIIIIIIllIIllI.length;
        int lllllllllllllllIlIlIIIIIIllIIlII = llIIlIIIIIlI[0];
        while (k.llllIlllllIlll(lllllllllllllllIlIlIIIIIIllIIlII, lllllllllllllllIlIlIIIIIIllIIlIl)) {
            char lllllllllllllllIlIlIIIIIIlllIIIl = lllllllllllllllIlIlIIIIIIllIIllI[lllllllllllllllIlIlIIIIIIllIIlII];
            lllllllllllllllIlIlIIIIIIllIlllI.append((char)(lllllllllllllllIlIlIIIIIIlllIIIl ^ lllllllllllllllIlIlIIIIIIllIllIl[lllllllllllllllIlIlIIIIIIllIllII % lllllllllllllllIlIlIIIIIIllIllIl.length]));
            "".length();
            ++lllllllllllllllIlIlIIIIIIllIllII;
            ++lllllllllllllllIlIlIIIIIIllIIlII;
            "".length();
            if ("  ".length() > " ".length()) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllIlIlIIIIIIllIlllI);
    }
    ...
    public static boolean a(List<Prayer> list) {
        ...
        HashSet lllllllllllllllIlIlIIIIIlIIlIIII = new HashSet();
        Map<Prayer, List<Prayer>> lllllllllllllllIlIlIIIIIlIIIllll = k.y();
        Prayer[] lllllllllllllllIlIlIIIIIlIIIlllI = Prayer.values();
        int lllllllllllllllIlIlIIIIIlIIIllIl = lllllllllllllllIlIlIIIIIlIIIlllI.length;
        int lllllllllllllllIlIlIIIIIlIIIllII = llIIlIIIIIlI[0];
        while (k.llllIlllllIlll(lllllllllllllllIlIlIIIIIlIIIllII, lllllllllllllllIlIlIIIIIlIIIllIl)) {
            List<Prayer> lllllllllllllllIlIlIIIIIlIIlIIIl;
            Prayer lllllllllllllllIlIlIIIIIlIIIlIll = lllllllllllllllIlIlIIIIIlIIIlllI[lllllllllllllllIlIlIIIIIlIIIllII];
            if (k.llllIlllllIlIl(lllllllllllllllIlIlIIIIIlIIlIIIl.contains(lllllllllllllllIlIlIIIIIlIIIlIll) ? 1 : 0) && k.llllIlllllllII(k.a(lllllllllllllllIlIlIIIIIlIIIlIll) ? 1 : 0)) {
                Prayers.toggle((Prayer)lllllllllllllllIlIlIIIIIlIIIlIll, (boolean)llIIlIIIIIlI[9]);
                lllllllllllllllIlIlIIIIIlIIlIIII.addAll(lllllllllllllllIlIlIIIIIlIIIllll.getOrDefault(lllllllllllllllIlIlIIIIIlIIIlIll, Collections.emptyList()));
                "".length();
            }
            ++lllllllllllllllIlIlIIIIIlIIIllII;
            "".length();
            if (" ".length() <= (0xC ^ 8)) continue;
    ...
    private static boolean a(List<Prayer> list, boolean bl, Set<Prayer> set) {
        ...
        Iterator<Prayer> lllllllllllllllIlIlIIIIIlIIIIIII = list.iterator();
        while (true) {
            void lllllllllllllllIlIlIIIIIlIIIIIlI;
            void lllllllllllllllIlIlIIIIIlIIIIIll;
            int lllllllllllllllIlIlIIIIIlIIIIIIl;
            if (k.llllIlllllIlIl(lllllllllllllllIlIlIIIIIlIIIIIII.hasNext() ? 1 : 0)) {
                return lllllllllllllllIlIlIIIIIlIIIIIIl != 0;
            }
            Prayer lllllllllllllllIlIlIIIIIIlllllll = lllllllllllllllIlIlIIIIIlIIIIIII.next();
            if (!k.llllIllllllllI(lllllllllllllllIlIlIIIIIIlllllll, Prayer.PROTECT_ITEM) || k.llllIlllllIlIl((int)lllllllllllllllIlIlIIIIIlIIIIIll) && !k.llllIlllllIlIl(lllllllllllllllIlIlIIIIIlIIIIIlI.contains(lllllllllllllllIlIlIIIIIIlllllll) ? 1 : 0)) continue;
            if (k.llllIlllllIlIl(k.a(lllllllllllllllIlIlIIIIIIlllllll) ? 1 : 0) && k.llllIlllllIlIl((int)lllllllllllllllIlIlIIIIIlIIIIIll)) {
                if (k.llllIlllllIlIl(k.a(lllllllllllllllIlIlIIIIIIlllllll) ? 1 : 0)) {
                    lllllllllllllllIlIlIIIIIlIIIIIIl = llIIlIIIIIlI[9];
                    "".length();
                    if (("   ".length() & ("   ".length() ^ -" ".length())) > 0) {
                        return ((0x54 ^ 0x53 ^ (0xBC ^ 0xAB)) & (0 + 122 - 31 + 44 ^ 110 + 41 - 54 + 54 ^ -" ".length())) != 0;
                    }
                }
            } else {
                Prayers.toggle((Prayer)lllllllllllllllIlIlIIIIIIlllllll, (boolean)llIIlIIIIIlI[9]);
            }
            "".length();
            if (((0xC8 ^ 0xC5 ^ (0x4F ^ 0x71)) & (123 + 155 - 198 + 99 ^ 78 + 42 - 79 + 87 ^ -" ".length())) >= "  ".length()) break;
        }
        return ((3 + 136 - -26 + 25 ^ 118 + 46 - 49 + 37) & (0x14 ^ 0x4F ^ (0x19 ^ 0x64) ^ -" ".length())) != 0;
    }
    ...
    private static String llllIlllllIIlI(String lllllllllllllllIlIlIIIIIIlIllIll, String lllllllllllllllIlIlIIIIIIlIllIII) {
        try {
            SecretKeySpec lllllllllllllllIlIlIIIIIIlIllllI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIlIlIIIIIIlIllIII.getBytes(StandardCharsets.UTF_8)), llIIlIIIIIlI[19]), "DES");
            Cipher lllllllllllllllIlIlIIIIIIlIlllIl = Cipher.getInstance("DES");
            lllllllllllllllIlIlIIIIIIlIlllIl.init(llIIlIIIIIlI[17], lllllllllllllllIlIlIIIIIIlIllllI);
            return new String(lllllllllllllllIlIlIIIIIIlIlllIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIlIlIIIIIIlIllIll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
