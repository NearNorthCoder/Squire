...
extends SquirePlugin {
            ...
            if (SquireFightCavesPlugin.llllIlllIIIlll(n2)) {
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.e.g().filter(e2 -> {
                    ...
                    if (SquireFightCavesPlugin.llllIlllIIIlIl(e2.i(), n2)) {
                        ...
                        "".length();
                        if (-" ".length() >= 0) {
                            return ((18 + 95 - 59 + 91 ^ 74 + 23 - -23 + 46) & (19 + 69 - -88 + 0 ^ 6 + 0 - -117 + 12 ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = llIIIlllIllI[4];
                    }
                ...
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.e.g().filter(e2 -> {
                    ...
                    if (SquireFightCavesPlugin.llllIlllIIIlIl(e2.i(), n2)) {
                        ...
                        "".length();
                        if (-" ".length() != -" ".length()) {
                            return ((0x93 ^ 0xB9 ^ (0xA6 ^ 0x8B)) & (0x5F ^ 0x78 ^ (8 ^ 0x28) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = llIIIlllIllI[4];
                    }
    ...
    private void a(InventoryChanged inventoryChanged) {
        void lllllllllllllllIlIlIIIlIIlIllIlI;
        if (SquireFightCavesPlugin.llllIlllIIIlII(inventoryChanged.getChangeType(), InventoryChanged.ChangeType.ITEM_REMOVED)) {
            return;
        }
        if (SquireFightCavesPlugin.llllIlllIIIlII(lllllllllllllllIlIlIIIlIIlIllIlI.getChangeType(), InventoryChanged.ChangeType.ITEM_ADDED) && SquireFightCavesPlugin.llllIlllIIIlIl(lllllllllllllllIlIlIIIlIIlIllIlI.getItemId(), llIIIlllIllI[14])) {
            i += llIIIlllIllI[6];
            g = llIIIlllIllI[6];
        }
    }
    ...
    private static String llllIlllIIIIII(String lllllllllllllllIlIlIIIlIIIlIlIIl, String lllllllllllllllIlIlIIIlIIIlIlIlI) {
        try {
            ...
            Cipher lllllllllllllllIlIlIIIlIIIlIllIl = Cipher.getInstance("DES");
            lllllllllllllllIlIlIIIlIIIlIllIl.init(llIIIlllIllI[7], lllllllllllllllIlIlIIIlIIIlIlllI);
            return new String(lllllllllllllllIlIlIIIlIIIlIllIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIlIlIIIlIIIlIlIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public void a(AnimationChanged animationChanged) {
        NPC lllllllllllllllIlIlIIIlIIlIIlIII;
        SquireFightCavesPlugin lllllllllllllllIlIlIIIlIIlIIlIlI;
        void lllllllllllllllIlIlIIIlIIlIIlIIl;
        "".length();
        if (SquireFightCavesPlugin.llllIlllIIlIII(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f.n() ? 1 : 0)) {
            ...
            if (SquireFightCavesPlugin.llllIlllIIIllI(lllllllllllllllIlIlIIIlIIlIIlIIl.getActor().equals(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.n.b(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.b.RANGER)) ? 1 : 0) && SquireFightCavesPlugin.llllIlllIIIlIl(lllllllllllllllIlIlIIIlIIlIIlIIl.getActor().getAnimation(), llIIIlllIllI[0])) {
                f cfr_ignored_0 = lllllllllllllllIlIlIIIlIIlIIlIlI.e;
                "".length();
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f.b(llIIIlllIllI[4]);
                f cfr_ignored_1 = lllllllllllllllIlIlIIIlIIlIIlIlI.e;
                "".length();
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f.g(Static.getClient().getTickCount());
                f cfr_ignored_2 = lllllllllllllllIlIlIIIlIIlIIlIlI.e;
                "".length();
                a.info("" + h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f.u());
            }
            if (SquireFightCavesPlugin.llllIlllIIIllI(lllllllllllllllIlIlIIIlIIlIIlIIl.getActor().equals(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.n.b(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.b.MAGER)) ? 1 : 0) && SquireFightCavesPlugin.llllIlllIIIlIl(lllllllllllllllIlIlIIIlIIlIIlIIl.getActor().getAnimation(), llIIIlllIllI[2])) {
                f cfr_ignored_3 = lllllllllllllllIlIlIIIlIIlIIlIlI.e;
                "".length();
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f.b(llIIIlllIllI[4]);
                f cfr_ignored_4 = lllllllllllllllIlIlIIIlIIlIIlIlI.e;
                "".length();
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f.f(Static.getClient().getTickCount());
            }
            if (SquireFightCavesPlugin.llllIlllIIIllI(lllllllllllllllIlIlIIIlIIlIIlIIl.getActor().equals(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.n.b(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.b.MELEER)) ? 1 : 0) && SquireFightCavesPlugin.llllIlllIIIlIl(lllllllllllllllIlIlIIIlIIlIIlIIl.getActor().getAnimation(), llIIIlllIllI[3])) {
                f cfr_ignored_5 = lllllllllllllllIlIlIIIlIIlIIlIlI.e;
                "".length();
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f.b(llIIIlllIllI[4]);
                f cfr_ignored_6 = lllllllllllllllIlIlIIIlIIlIIlIlI.e;
                "".length();
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f.d(Static.getClient().getTickCount());
                a.info("client tick count = " + Static.getClient().getTickCount());
            }
        }
        if (SquireFightCavesPlugin.llllIlllIIlIIl(lllllllllllllllIlIlIIIlIIlIIlIII = NPCs.getNearest((int[])h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.c.v)) && SquireFightCavesPlugin.llllIlllIIIllI(lllllllllllllllIlIlIIIlIIlIIlIIl.getActor().equals(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.n.b(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.b.JAD)) ? 1 : 0)) {
            if (SquireFightCavesPlugin.llllIlllIIIlIl(lllllllllllllllIlIlIIIlIIlIIlIIl.getActor().getAnimation(), llIIIlllIllI[15])) {
                f cfr_ignored_7 = lllllllllllllllIlIlIIIlIIlIIlIlI.e;
                "".length();
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f.c(Static.getClient().getTickCount());
            }
            if (SquireFightCavesPlugin.llllIlllIIIlIl(lllllllllllllllIlIlIIIlIIlIIlIIl.getActor().getAnimation(), llIIIlllIllI[16])) {
                f cfr_ignored_8 = lllllllllllllllIlIlIIIlIIlIIlIlI.e;
                "".length();
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f.c(Static.getClient().getTickCount());
            }
        }
    ...
    private static void llllIlllIIIIlI() {
        ...
        SquireFightCavesPlugin.llIIIlllIlIl[SquireFightCavesPlugin.llIIIlllIllI[4]] = SquireFightCavesPlugin.llllIlllIIIIII("nBDooZ/T4HWwNT97VCffWXuCuv9KSfrN", "UtFXt");
        SquireFightCavesPlugin.llIIIlllIlIl[SquireFightCavesPlugin.llIIIlllIllI[6]] = SquireFightCavesPlugin.llllIlllIIIIII("jafSHxToOP0=", "JKCNv");
        SquireFightCavesPlugin.llIIIlllIlIl[SquireFightCavesPlugin.llIIIlllIllI[7]] = SquireFightCavesPlugin.llllIlllIIIIIl("aAyt71AusMs=", "tJwjq");
        ...
        SquireFightCavesPlugin.llIIIlllIlIl[SquireFightCavesPlugin.llIIIlllIllI[9]] = SquireFightCavesPlugin.llllIlllIIIIII("52PsK5kCWww=", "vJusT");
    }
    ...
    private static void llllIlllIIIIll() {
        ...
        SquireFightCavesPlugin.llIIIlllIllI[6] = " ".length();
        SquireFightCavesPlugin.llIIIlllIllI[7] = "  ".length();
        SquireFightCavesPlugin.llIIIlllIllI[8] = "   ".length();
    ...
    private static String llllIlllIIIIIl(String lllllllllllllllIlIlIIIlIIIllIllI, String lllllllllllllllIlIlIIIlIIIllIlIl) {
        try {
            SecretKeySpec lllllllllllllllIlIlIIIlIIIlllIll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIlIlIIIlIIIllIlIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIlIlIIIlIIIlllIlI = Cipher.getInstance("Blowfish");
            lllllllllllllllIlIlIIIlIIIlllIlI.init(llIIIlllIllI[7], lllllllllllllllIlIlIIIlIIIlllIll);
            return new String(lllllllllllllllIlIlIIIlIIIlllIlI.doFinal(Base64.getDecoder().decode(lllllllllllllllIlIlIIIlIIIllIllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
