...
extends Config {
    ...
    default public boolean stopAfterCape() {
        return ((0x29 ^ 0x6F ^ (0xB ^ 0x41)) & (31 + 125 - 47 + 26 ^ 33 + 99 - 9 + 16 ^ -" ".length())) != 0;
    }
    ...
    default public boolean showExtraInfoOnUI() {
        return ((0x2D ^ 0x68 ^ (0x6C ^ 0x1C)) & (" ".length() ^ (0x18 ^ 0x2C) ^ -" ".length())) != 0;
    }
    ...
    default public boolean avoidDefXp() {
        return ((0x2B ^ 0x3A ^ (0x6F ^ 0x47)) & (0x4C ^ 0x58 ^ (0xAC ^ 0x81) ^ -" ".length())) != 0;
    }
