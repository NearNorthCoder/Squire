...
extends Enum<c> {
    ...
    private static void lIIIlIlIIlIllll() {
        ...
        c.lllIIllIIIII[1] = " ".length();
        c.lllIIllIIIII[2] = "  ".length();
        c.lllIIllIIIII[3] = "   ".length();
    ...
    private static void lIIIlIlIIlIlllI() {
        ...
        c.lllIIlIlllll[c.lllIIllIIIII[0]] = c.lIIIlIlIIlIlIll("IQ0DASE/Cw==", "qLWIh");
        c.lllIIlIlllll[c.lllIIllIIIII[1]] = c.lIIIlIlIIlIllII("2nwIvWuwo9J7mHsVp5KnEw==", "iPgAL");
        c.lllIIlIlllll[c.lllIIllIIIII[2]] = c.lIIIlIlIIlIllII("11zXIyjW8TTclUpszitr7A==", "vQlet");
        c.lllIIlIlllll[c.lllIIllIIIII[3]] = c.lIIIlIlIIlIlIll("HQUOCxgHHwg=", "NQOYL");
        c.lllIIlIlllll[c.lllIIllIIIII[4]] = c.lIIIlIlIIlIllIl("c9R3M2eF0q8U2a+BTtJA0w==", "FSuaK");
        c.lllIIlIlllll[c.lllIIllIIIII[5]] = c.lIIIlIlIIlIllIl("ouDPs6Wgpck=", "sOQuG");
    }
