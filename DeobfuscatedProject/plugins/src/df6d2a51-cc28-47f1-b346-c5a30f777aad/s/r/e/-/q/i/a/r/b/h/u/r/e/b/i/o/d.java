...
extends Task {
    ...
    private static void lIIIlIlIlIllIll() {
        ...
        d.lllIIllIlIll[1] = " ".length();
        d.lllIIllIlIll[2] = 0xF ^ 0x2D ^ (0xBD ^ 0x9A);
        d.lllIIllIlIll[3] = "  ".length();
    }
    ...
    private static void lIIIlIlIlIllIlI() {
        ...
        d.lllIIllIlIlI[d.lllIIllIlIll[0]] = d.lIIIlIlIlIllIII("Pg1kFgMMDGQMCUkfLQwODRolD0YMBiEKARBINBcSAAcqC0YPGisVRh0AIVgECAYv", "ihDxf");
        d.lllIIllIlIlI[d.lllIIllIlIll[1]] = d.lIIIlIlIlIllIIl("t2dlLa2AR6DyyI/cxK+r5k2SlVIRvGP6VgBLLUYI88i/lv6xNi4BKA==", "YiCAg");
    }
