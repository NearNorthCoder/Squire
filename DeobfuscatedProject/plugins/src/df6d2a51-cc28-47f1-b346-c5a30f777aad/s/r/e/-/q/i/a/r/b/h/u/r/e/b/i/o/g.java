...
extends Enum<g> {
    ...
    private static void lIIIlIllIlIIlII() {
        ...
        g.lllIIlllIlIl[g.lllIIlllllIl[0]] = g.lIIIlIllIIIIIlI("Fg==", "WJnKw");
        g.lllIIlllIlIl[g.lllIIlllllIl[1]] = g.lIIIlIllIIIIIll("XrdQt2mnVBg=", "BPadz");
        g.lllIIlllIlIl[g.lllIIlllllIl[2]] = g.lIIIlIllIIIIlIl("FTAtfEqalSk=", "AdmKz");
        g.lllIIlllIlIl[g.lllIIlllllIl[3]] = g.lIIIlIllIIIIIll("yE/lWt53iLU=", "mDrDd");
        g.lllIIlllIlIl[g.lllIIlllllIl[4]] = g.lIIIlIllIIIIIll("fTMiuo52Aeg=", "eupQM");
        g.lllIIlllIlIl[g.lllIIlllllIl[5]] = g.lIIIlIllIIIIlIl("j4dUjQSlZEI=", "mrdfZ");
        g.lllIIlllIlIl[g.lllIIlllllIl[6]] = g.lIIIlIllIIIIIlI("Eg==", "UzzCP");
        g.lllIIlllIlIl[g.lllIIlllllIl[7]] = g.lIIIlIllIIIIlIl("hYmpAJD14pk=", "qhcBU");
        g.lllIIlllIlIl[g.lllIIlllllIl[8]] = g.lIIIlIllIIIIIlI("IA==", "ioXPM");
        g.lllIIlllIlIl[g.lllIIlllllIl[9]] = g.lIIIlIllIIIIlIl("QP2y1DXHgbc=", "mLkzQ");
        g.lllIIlllIlIl[g.lllIIlllllIl[10]] = g.lIIIlIllIIIIIlI("Dw==", "DnINQ");
    }
    ...
    private static void lIIIlIllIlIIlIl() {
        ...
        g.lllIIlllllIl[1] = " ".length();
        g.lllIIlllllIl[2] = "  ".length();
        g.lllIIlllllIl[3] = "   ".length();
