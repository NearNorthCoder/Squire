...
extends Task {
    ...
    private static void lIIIlIlIllllIIl() {
        ...
        l.lllIIlllIlII[1] = " ".length();
        l.lllIIlllIlII[2] = (0xBA ^ 0xA5) & ~(0x88 ^ 0x97);
        l.lllIIlllIlII[3] = 0xB8 ^ 0x9F ^ (5 ^ 0x27);
        l.lllIIlllIlII[4] = "  ".length();
        l.lllIIlllIlII[5] = "   ".length();
    ...
    private static String lIIIlIlIlllIlll(String lllllllllllllllIIllIIllIlllIIlIl, String lllllllllllllllIIllIIllIlllIlIIl) {
        ...
        while (l.lIIIlIlIlllllII(lllllllllllllllIIllIIllIllIllllI, lllllllllllllllIIllIIllIllIlllll)) {
            ...
            "".length();
            if ((0x4D ^ 0x23 ^ (0xFB ^ 0x91)) > " ".length()) continue;
            return null;
        }
    ...
    private static void lIIIlIlIllllIII() {
        ...
        l.lllIIlllIIll[l.lllIIlllIlII[2]] = l.lIIIlIlIlllIlIl("dLWyjXnPeEo=", "lVUTI");
        l.lllIIlllIIll[l.lllIIlllIlII[1]] = l.lIIIlIlIlllIlIl("bhbI4VK+nnU=", "MQzbj");
        l.lllIIlllIIll[l.lllIIlllIlII[4]] = l.lIIIlIlIlllIlIl("fA25aOOFbxI=", "jYcHH");
        l.lllIIlllIIll[l.lllIIlllIlII[5]] = l.lIIIlIlIlllIllI("b6lFHG5DdGk=", "xMrEf");
        l.lllIIlllIIll[l.lllIIlllIlII[6]] = l.lIIIlIlIlllIlll("GSgUL3oCLAUm", "qMfMZ");
        l.lllIIlllIIll[l.lllIIlllIlII[3]] = l.lIIIlIlIlllIlIl("Mcpv0uJw1Tc=", "wOzfS");
        l.lllIIlllIIll[l.lllIIlllIlII[7]] = l.lIIIlIlIlllIlIl("h1e7UXTsOI8=", "iwwtC");
        l.lllIIlllIIll[l.lllIIlllIlII[8]] = l.lIIIlIlIlllIlll("BwE1BCgAAD0=", "itXqD");
    }
            ...
            while (l.lIIIlIlIlllllII(lllllllllllllllIIllIIlllIIIlIIll, lllllllllllllllIIllIIlllIIIlIlII)) {
                ...
                if (l.lIIIlIlIllllIlI(Bank.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    if (l.lIIIlIlIllllIll(lllllllllllllllIIllIIlllIIIlIllI -= lllllllllllllllIIllIIlllIIIlIIIl)) {
                        ...
                        return ((8 + 47 - -113 + 68 ^ 112 + 5 - -40 + 5) & (0x91 ^ 0xB5 ^ (0x30 ^ 0x5A) ^ -" ".length())) != 0;
                    }
                }
                ++lllllllllllllllIIllIIlllIIIlIIll;
                "".length();
                if (null == null) continue;
                return ((0x76 ^ 0x6C ^ (0x5E ^ 0x50)) & (0x18 ^ 5 ^ (0x9D ^ 0x94) ^ -" ".length())) != 0;
            }
