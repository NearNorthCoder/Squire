...
public final class k {
    ...
    public boolean equals(Object object) {
        k lllllllllllllllIIllIIlIlllIlllII;
        void lllllllllllllllIIllIIlIlllIllIll;
        if (k.lIIIlIllIlIIIIl(object, this)) {
            return lllIIlllllII[0];
        }
        if (k.lIIIlIllIlIIIlI(lllllllllllllllIIllIIlIlllIllIll instanceof k)) {
            return lllIIlllllII[1];
        }
        k lllllllllllllllIIllIIlIlllIllIlI = (k)lllllllllllllllIIllIIlIlllIllIll;
        if (k.lIIIlIllIlIIIll(lllllllllllllllIIllIIlIlllIlllII.O(), lllllllllllllllIIllIIlIlllIllIlI.O())) {
            return lllIIlllllII[1];
        }
        if (k.lIIIlIllIlIIIll(lllllllllllllllIIllIIlIlllIlllII.M(), lllllllllllllllIIllIIlIlllIllIlI.M())) {
            return lllIIlllllII[1];
        }
        if (k.lIIIlIllIlIIIll(lllllllllllllllIIllIIlIlllIlllII.N(), lllllllllllllllIIllIIlIlllIllIlI.N())) {
            return lllIIlllllII[1];
        }
        return lllIIlllllII[0];
    }
