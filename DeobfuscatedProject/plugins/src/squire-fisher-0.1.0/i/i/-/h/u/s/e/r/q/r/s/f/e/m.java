...
extends Task {
    ...
    private static void lllIlIllIlIlll() {
        ...
        m.lIlllIlIlllI[m.lIlllIlIllll[1]] = m.lllIlIllIlIlIl("RQicXsA0ZEo=", "Hwpky");
        m.lIlllIlIlllI[m.lIlllIlIllll[3]] = m.lllIlIllIlIlIl("7Kh2RNRk2tEaolHKZWd+WJoAG6fpGyGANnygopGmE3D1jJsfIZr6FA==", "Qydhl");
        m.lIlllIlIlllI[m.lIlllIlIllll[5]] = m.lllIlIllIlIlIl("GOQQM88S2AQpeD4wgOZK8VcIp2njPLBOOLimB96iwFAoIv++dVuo0A==", "GWwCM");
        m.lIlllIlIlllI[m.lIlllIlIllll[7]] = m.lllIlIllIlIlIl("V5dizSTd4qE=", "gFzAR");
        m.lIlllIlIlllI[m.lIlllIlIllll[0]] = m.lllIlIllIlIllI("AS40", "SAQOa");
        m.lIlllIlIlllI[m.lIlllIlIllll[23]] = m.lllIlIllIlIlIl("NUGNY798hUQ=", "VMIWz");
        m.lIlllIlIlllI[m.lIlllIlIllll[24]] = m.lllIlIllIlIlIl("P4uLiRcboWw=", "aYLki");
    }
            ...
            if (m.lllIlIllIllIll(lllllllllllllllIlIlllIllIIIlIlll.V.cutEat() ? 1 : 0)) {
                ...
                Item lllllllllllllllIlIlllIllIIIlIIll = Inventory.getFirst(item -> {
                    ...
                    if (!m.lllIlIllIllIlI(item.getName().equals(lIlllIlIlllI[lIlllIlIllll[0]]) ? 1 : 0) || m.lllIlIllIllIll(item.getName().equals(lIlllIlIlllI[lIlllIlIllll[23]]) ? 1 : 0)) {
                        ...
                        "".length();
                        if (null != null) {
                            return ((80 + 51 - -40 + 20 ^ 29 + 60 - 3 + 75) & (0x54 ^ 3 ^ (0xD4 ^ 0x9D) ^ -" ".length())) != 0;
                        }
                    } else {
                        n = lIlllIlIllll[1];
                    }
    ...
    private static void lllIlIllIllIII() {
        ...
        m.lIlllIlIllll[1] = (0x7F ^ 0x73 ^ (0x80 ^ 0xC4)) & (186 + 120 - 159 + 50 ^ 4 + 19 - -53 + 65 ^ -" ".length());
        m.lIlllIlIllll[2] = 35 + 149 - 117 + 132;
        m.lIlllIlIllll[3] = " ".length();
        m.lIlllIlIllll[4] = 3 + 5 - -15 + 178;
        m.lIlllIlIllll[5] = "  ".length();
        m.lIlllIlIllll[6] = 112 + 129 - 177 + 139;
        m.lIlllIlIllll[7] = "   ".length();
        ...
        if (m.lllIlIllIllIll(Inventory.contains((int[])this.X) ? 1 : 0)) {
            ...
            if (m.lllIlIllIlllIl(Inventory.getCount((boolean)lIlllIlIllll[3], (int[])nArray), lIlllIlIllll[21])) {
                ...
                if (m.lllIlIllIllIll(Inventory.contains((int[])nArray2) ? 1 : 0)) {
                    n = lIlllIlIllll[3];
                    "".length();
                    if ((0x6D ^ 0x44 ^ (0x13 ^ 0x3E)) != -" ".length()) return n != 0;
                    return ((0xA9 ^ 0xB9 ^ (0xD8 ^ 0x90)) & (57 + 162 - 129 + 140 ^ 74 + 122 - 118 + 112 ^ -" ".length())) != 0;
                }
            }
        }
        n = lIlllIlIllll[1];
