...
extends Task {
    ...
    private static void lllIlIlllllIlI() {
        ...
        l.lIlllIllIllI[l.lIlllIllIlll[1]] = l.lllIlIlllllIIl("uknjobqS4PqWb1PJHulZ0jN7i6vxfnhf", "UshoG");
    }
    ...
    private static void lllIlIlllllIll() {
        ...
        l.lIlllIllIlll[5] = " ".length();
        l.lIlllIllIlll[6] = "  ".length();
    }
