...
extends Task {
    ...
    private static String lllIlIlllIIIlI(String lllllllllllllllIlIlllIlIllIIIIlI, String lllllllllllllllIlIlllIlIlIllllll) {
        try {
            SecretKeySpec lllllllllllllllIlIlllIlIllIIIlIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIlIlllIlIlIllllll.getBytes(StandardCharsets.UTF_8)), lIlllIllIIIl[5]), "DES");
    ...
    private static void lllIlIlllIIlII() {
        ...
        d.lIlllIllIIIl[2] = (0x41 ^ 0x67 ^ (0x5E ^ 0x33)) & (0x52 ^ 0x6D ^ (0xA ^ 0x7E) ^ -" ".length());
        d.lIlllIllIIIl[3] = 0x1F ^ 0x3A ^ (0x14 ^ 0x22);
        d.lIlllIllIIIl[4] = " ".length();
        d.lIlllIllIIIl[5] = 0x28 ^ 0x63 ^ (0x5A ^ 0x19);
        d.lIlllIllIIIl[6] = "  ".length();
    }

    public boolean run() {
        d lllllllllllllllIlIlllIlIllIIlIlI;
        if (d.lllIlIlllIIlIl(Widgets.isVisible((Widget)Widgets.get((int)lIlllIllIIIl[0], (int)lIlllIllIIIl[1])) ? 1 : 0)) {
            return lIlllIllIIIl[2];
        }
        if (d.lllIlIlllIIlIl(lllllllllllllllIlIlllIlIllIIlIlI.y.e() ? 1 : 0)) {
            return lIlllIllIIIl[2];
        }
        if (d.lllIlIlllIIllI(Widgets.isVisible((Widget)Widgets.get((int)lIlllIllIIIl[0], (int)lIlllIllIIIl[1])) ? 1 : 0)) {
            ...
            lllllllllllllllIlIlllIlIllIIlIlI.y.a(lIlllIllIIIl[2]);
        }
    ...
    private static void lllIlIlllIIIll() {
        ...
        d.lIlllIllIIII[d.lIlllIllIIIl[2]] = d.lllIlIlllIIIlI("TjU1cL+y00x8pG0m/h0i/w==", "ZqeVc");
    }
}
