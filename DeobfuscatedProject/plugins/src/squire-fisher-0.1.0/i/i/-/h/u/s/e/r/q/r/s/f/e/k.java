...
extends Task {
    ...
    private static void lllIlIllllIIIl() {
        ...
        k.lIlllIllIlII[k.lIlllIllIlIl[0]] = k.lllIlIllllIIII("xVAlnhlQsIuz1SDtT377lg==", "qVGHK");
        k.lIlllIllIlII[k.lIlllIllIlIl[1]] = k.lllIlIllllIIII("1OQnXVgonAteOqoJ9c+ZUg==", "nbuar");
        k.lIlllIllIlII[k.lIlllIllIlIl[8]] = k.lllIlIllllIIII("1MboGYfQ4GTa+qEPb2I4CItLH8Tw29iK", "sbWmA");
    }
    ...
    public boolean run() {
        void var1_1;
        void var2_2;
        k lllllllllllllllIlIlllIlIIllIlIIl;
        ...
        if (k.lllIlIllllIlIl(lllllllllllllllIlIlllIlIIllIlIIl.T.isInInstancedRegion() ? 1 : 0)) {
        ...
        if (k.lllIlIllllIIll(Dialog.isOpen() ? 1 : 0)) {
            if (k.lllIlIllllIIll(Dialog.isEnterInputOpen() ? 1 : 0)) {
                ...
                "".length();
                if (null != null) {
                    return ((175 + 93 - 154 + 118 ^ 149 + 126 - 103 + 2) & (5 + 74 - 4 + 179 ^ 118 + 44 - 112 + 134 ^ -" ".length())) != 0;
                }
        ...
        NPC lllllllllllllllIlIlllIlIIllIlIII = NPCs.getNearest((String[])stringArray);
        if (k.lllIlIllllIllI(Widgets.get((int)lIlllIllIlIl[3], (int)lIlllIllIlIl[0]))) {
            if (!k.lllIlIllllIllI(lllllllllllllllIlIlllIlIIllIlIII) || k.lllIlIllllIlll(lllllllllllllllIlIlllIlIIllIlIII.distanceTo((Locatable)Players.getLocal()), lIlllIllIlIl[4])) {
                Widgets.get((int)lIlllIllIlIl[3], (int)lIlllIllIlIl[5]).interact(lIlllIllIlII[lIlllIllIlIl[1]]);
                "".length();
                if (-"  ".length() >= 0) {
                    return ((158 + 219 - 206 + 65 ^ 139 + 3 - 94 + 129) & (0x4E ^ 0x5E ^ (0x73 ^ 0x3E) ^ -" ".length())) != 0;
                }
            }
        } else {
        ...
        Item lllllllllllllllIlIlllIlIIllIIlll = Inventory.getFirst((int[])nArray);
        if (k.lllIlIlllllIII(lllllllllllllllIlIlllIlIIllIIlll)) {
            return lIlllIllIlIl[0];
        }
    ...
    private static String lllIlIllllIIII(String lllllllllllllllIlIlllIlIIlIlllll, String lllllllllllllllIlIlllIlIIlIlllII) {
        try {
            SecretKeySpec lllllllllllllllIlIlllIlIIllIIIlI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIlIlllIlIIlIlllII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIlIlllIlIIllIIIIl = Cipher.getInstance("Blowfish");
            lllllllllllllllIlIlllIlIIllIIIIl.init(lIlllIllIlIl[8], lllllllllllllllIlIlllIlIIllIIIlI);
