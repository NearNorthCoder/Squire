...
extends Enum<f> {
    ...
    private static String lllIllIIIllIIl(String lllllllllllllllIlIlllIIlIllIlIlI, String lllllllllllllllIlIlllIIlIllIIlII) {
        lllllllllllllllIlIlllIIlIllIlIlI = new String(Base64.getDecoder().decode(lllllllllllllllIlIlllIIlIllIlIlI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIlIlllIIlIllIlIII = new StringBuilder();
        char[] lllllllllllllllIlIlllIIlIllIIlll = lllllllllllllllIlIlllIIlIllIIlII.toCharArray();
        int lllllllllllllllIlIlllIIlIllIIllI = lIllllIIIIII[1];
        char[] lllllllllllllllIlIlllIIlIllIIIII = lllllllllllllllIlIlllIIlIllIlIlI.toCharArray();
        int lllllllllllllllIlIlllIIlIlIlllll = lllllllllllllllIlIlllIIlIllIIIII.length;
        int lllllllllllllllIlIlllIIlIlIllllI = lIllllIIIIII[1];
        while (f.lllIllIIIllllI(lllllllllllllllIlIlllIIlIlIllllI, lllllllllllllllIlIlllIIlIlIlllll)) {
            char lllllllllllllllIlIlllIIlIllIlIll = lllllllllllllllIlIlllIIlIllIIIII[lllllllllllllllIlIlllIIlIlIllllI];
            lllllllllllllllIlIlllIIlIllIlIII.append((char)(lllllllllllllllIlIlllIIlIllIlIll ^ lllllllllllllllIlIlllIIlIllIIlll[lllllllllllllllIlIlllIIlIllIIllI % lllllllllllllllIlIlllIIlIllIIlll.length]));
            "".length();
            ++lllllllllllllllIlIlllIIlIllIIllI;
            ++lllllllllllllllIlIlllIIlIlIllllI;
            "".length();
            if (((0x64 ^ 0x69 ^ (0xC7 ^ 0x9E)) & (0x3B ^ 0xA ^ (0x4C ^ 0x29) ^ -" ".length())) == 0) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllIlIlllIIlIllIlIII);
    }
    ...
    private static String lllIllIIIllIlI(String lllllllllllllllIlIlllIIllIIIIlll, String lllllllllllllllIlIlllIIllIIIIllI) {
        try {
            SecretKeySpec lllllllllllllllIlIlllIIllIIIlIlI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIlIlllIIllIIIIllI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIlIlllIIllIIIlIIl = Cipher.getInstance("Blowfish");
            lllllllllllllllIlIlllIIllIIIlIIl.init(lIllllIIIIII[5], lllllllllllllllIlIlllIIllIIIlIlI);
            return new String(lllllllllllllllIlIlllIIllIIIlIIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIlIlllIIllIIIIlll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    static {
        ...
        PIKE = new f(lIlllIllllll[lIllllIIIIII[43]], lIllllIIIIII[39], nArray7, item -> {
            ...
            if (f.lllIllIIIlllIl(item.getId(), lIllllIIIIII[11])) {
                ...
                "".length();
                if ("   ".length() < -" ".length()) {
                    return ((0x27 ^ 9 ^ (0xDB ^ 0xAE)) & (55 + 117 - 79 + 137 ^ 130 + 37 - 164 + 186 ^ -" ".length())) != 0;
                }
            } else {
                bl = lIllllIIIIII[1];
            }
        ...
        KARAMBWAN = new f(lIlllIllllll[lIllllIIIIII[59]], lIllllIIIIII[73], nArray13, item -> {
            ...
            if (f.lllIllIIIlllIl(item.getId(), lIllllIIIIII[6])) {
                ...
                "".length();
                if (" ".length() < -" ".length()) {
                    return ((85 + 11 - 88 + 242 ^ 99 + 113 - 186 + 143) & (0xC3 ^ 0xAF ^ (0x9E ^ 0xA1) ^ -" ".length())) != 0;
                }
            } else {
                bl = lIllllIIIIII[1];
            }
    ...
    private static String lllIllIIIllIII(String lllllllllllllllIlIlllIIlIllllIlI, String lllllllllllllllIlIlllIIlIlllIlll) {
        try {
            SecretKeySpec lllllllllllllllIlIlllIIlIlllllIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIlIlllIIlIlllIlll.getBytes(StandardCharsets.UTF_8)), lIllllIIIIII[14]), "DES");
            Cipher lllllllllllllllIlIlllIIlIlllllII = Cipher.getInstance("DES");
            lllllllllllllllIlIlllIIlIlllllII.init(lIllllIIIIII[5], lllllllllllllllIlIlllIIlIlllllIl);
            return new String(lllllllllllllllIlIlllIIlIlllllII.doFinal(Base64.getDecoder().decode(lllllllllllllllIlIlllIIlIllllIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lllIllIIIlllII() {
        ...
        f.lIllllIIIIII[0] = " ".length();
        f.lIllllIIIIII[1] = (0xFA ^ 0x8E ^ (5 ^ 0x6F)) & (131 + 76 - 139 + 85 ^ 102 + 23 - 87 + 97 ^ -" ".length());
        f.lIllllIIIIII[2] = -" ".length();
        f.lIllllIIIIII[3] = -(50 + 1 - 2 + 80) & (0xFFFFFEF7 & 0x35FF);
        f.lIllllIIIIII[4] = 0xFFFFBBBB & 0x4577;
        f.lIllllIIIIII[5] = "  ".length();
        f.lIllllIIIIII[6] = 0xFFFFCCCE & 0x3F7F;
        f.lIllllIIIIII[7] = 0xFFFFFFD7 & 0xC7F;
        f.lIllllIIIIII[8] = "   ".length();
        ...
        f.lIllllIIIIII[78] = 0x74 ^ 0x3B ^ "   ".length();
    ...
    private static void lllIllIIIllIll() {
        ...
        f.lIlllIllllll[f.lIllllIIIIII[1]] = f.lllIllIIIllIII("BjLpt0SypuY=", "ZjkjY");
        f.lIlllIllllll[f.lIllllIIIIII[0]] = f.lllIllIIIllIII("pQ5Hik0dTfHT4DzbUcNnLw==", "WZfxA");
        f.lIlllIllllll[f.lIllllIIIIII[5]] = f.lllIllIIIllIII("N6CTOJlOGpg=", "vAbMY");
        f.lIlllIllllll[f.lIllllIIIIII[8]] = f.lllIllIIIllIIl("LjQkMSgpOw==", "FUVAG");
        f.lIlllIllllll[f.lIllllIIIIII[9]] = f.lllIllIIIllIlI("rcQDJVTlyok=", "PRJDv");
        f.lIlllIllllll[f.lIllllIIIIII[10]] = f.lllIllIIIllIlI("byLZcmN6CUQ=", "SDXCD");
        f.lIlllIllllll[f.lIllllIIIIII[12]] = f.lllIllIIIllIII("86GJX4a66+w=", "WIvIG");
        f.lIlllIllllll[f.lIllllIIIIII[13]] = f.lllIllIIIllIlI("DzBz12dnlQ2MBRZfBl81FA==", "GAWEf");
        f.lIlllIllllll[f.lIllllIIIIII[14]] = f.lllIllIIIllIlI("63oBJZFTMcM=", "TBfJP");
        f.lIlllIllllll[f.lIllllIIIIII[15]] = f.lllIllIIIllIIl("NAQjAikX", "glQkD");
        f.lIlllIllllll[f.lIllllIIIIII[19]] = f.lllIllIIIllIlI("CotWy3oxzv8=", "IEJNj");
        f.lIlllIllllll[f.lIllllIIIIII[20]] = f.lllIllIIIllIII("slfGDdc6ky4bLRw93EEiPg==", "mnGLr");
        f.lIlllIllllll[f.lIllllIIIIII[21]] = f.lllIllIIIllIlI("cKYVThCYEME=", "ngVaX");
        f.lIlllIllllll[f.lIllllIIIIII[22]] = f.lllIllIIIllIII("KQF02HzhT6OoHw7Bq1KHYg==", "ZGfBH");
        f.lIlllIllllll[f.lIllllIIIIII[24]] = f.lllIllIIIllIIl("OwgzNQ==", "yiZAg");
        f.lIlllIllllll[f.lIllllIIIIII[25]] = f.lllIllIIIllIIl("CAogIyQBHDMsIwo=", "CKrbi");
        f.lIlllIllllll[f.lIllllIIIIII[26]] = f.lllIllIIIllIlI("D1u4lk/EIRYspXnjHiop0g==", "hQvFv");
        f.lIlllIllllll[f.lIllllIIIIII[27]] = f.lllIllIIIllIlI("98tkTmWPoRk=", "hDOFF");
        f.lIlllIllllll[f.lIllllIIIIII[28]] = f.lllIllIIIllIIl("LhcRHSAxEx4=", "cVRVe");
        f.lIlllIllllll[f.lIllllIIIIII[29]] = f.lllIllIIIllIIl("Dxg7BjYwHDQ=", "ByXmS");
        f.lIlllIllllll[f.lIllllIIIIII[32]] = f.lllIllIIIllIIl("IToEbDwGJw==", "cScLr");
        f.lIlllIllllll[f.lIllllIIIIII[33]] = f.lllIllIIIllIIl("BCMtKAcLPDw+DwU=", "BotwA");
        f.lIlllIllllll[f.lIllllIIIIII[34]] = f.lllIllIIIllIII("hjf2fA+Rk5dTa0uwtXR+pw==", "pggct");
        f.lIlllIllllll[f.lIllllIIIIII[37]] = f.lllIllIIIllIIl("KhYjIA==", "fcQEm");
        f.lIlllIllllll[f.lIllllIIIIII[38]] = f.lllIllIIIllIIl("Figr", "UgoTX");
        f.lIlllIllllll[f.lIllllIIIIII[39]] = f.lllIllIIIllIIl("BCwR", "GCuYN");
        f.lIlllIllllll[f.lIllllIIIIII[41]] = f.lllIllIIIllIIl("DxopawkoBw==", "MsNKG");
        f.lIlllIllllll[f.lIllllIIIIII[42]] = f.lllIllIIIllIlI("I7j61nlyyYY=", "zdnqP");
        f.lIlllIllllll[f.lIllllIIIIII[43]] = f.lllIllIIIllIII("S/WagFlaxZk=", "AKQVD");
        f.lIlllIllllll[f.lIllllIIIIII[45]] = f.lllIllIIIllIIl("EjUvPg==", "PTFJa");
        f.lIlllIllllll[f.lIllllIIIIII[46]] = f.lllIllIIIllIII("ivWcAJZciaI=", "ELyng");
        f.lIlllIllllll[f.lIllllIIIIII[47]] = f.lllIllIIIllIIl("JT8jOw==", "qJMZI");
        f.lIlllIllllll[f.lIllllIIIIII[51]] = f.lllIllIIIllIII("6c/UQXhPAV8=", "BpKDW");
        f.lIlllIllllll[f.lIllllIIIIII[52]] = f.lllIllIIIllIIl("IignMT4rNQ==", "ngebj");
        f.lIlllIllllll[f.lIllllIIIIII[53]] = f.lllIllIIIllIlI("sBIPsMXwTTo=", "mUCQH");
        f.lIlllIllllll[f.lIllllIIIIII[48]] = f.lllIllIIIllIlI("N4zlNNeAgXM=", "mPcQm");
        f.lIlllIllllll[f.lIllllIIIIII[57]] = f.lllIllIIIllIIl("MhU8Hg==", "pToMN");
        f.lIlllIllllll[f.lIllllIIIIII[58]] = f.lllIllIIIllIII("DzdpMqhmxfg=", "GBKIa");
        f.lIlllIllllll[f.lIllllIIIIII[62]] = f.lllIllIIIllIIl("OQ4wIhoeAQ==", "qoBRu");
        f.lIlllIllllll[f.lIllllIIIIII[63]] = f.lllIllIIIllIIl("PAAuECYpHjIK", "oWaBb");
        f.lIlllIllllll[f.lIllllIIIIII[54]] = f.lllIllIIIllIlI("c4i6xnT4w30xHoM5trl5fA==", "ViAJX");
        f.lIlllIllllll[f.lIllllIIIIII[66]] = f.lllIllIIIllIII("0IHEs4r4ipI=", "XvOjc");
        f.lIlllIllllll[f.lIllllIIIIII[67]] = f.lllIllIIIllIII("dyPOAIi+oD+8CEn3qrKPBQ==", "EcwMr");
        f.lIlllIllllll[f.lIllllIIIIII[68]] = f.lllIllIIIllIII("txEW5SIAd5HaQZNRbTYV9w==", "WGMCc");
        f.lIlllIllllll[f.lIllllIIIIII[71]] = f.lllIllIIIllIlI("bpTC/v76AOg=", "cYaeM");
        f.lIlllIllllll[f.lIllllIIIIII[72]] = f.lllIllIIIllIlI("8yV/cEVqEvxe+pYuxR5RUw==", "SXLqG");
        f.lIlllIllllll[f.lIllllIIIIII[59]] = f.lllIllIIIllIIl("MyY+GSsaMC0W", "xGLxF");
        f.lIlllIllllll[f.lIllllIIIIII[75]] = f.lllIllIIIllIlI("hm1XhYmUHuA=", "ECFwe");
        f.lIlllIllllll[f.lIllllIIIIII[76]] = f.lllIllIIIllIIl("OxgJNw87", "hPHeD");
        f.lIlllIllllll[f.lIllllIIIIII[77]] = f.lllIllIIIllIlI("42xvfYzxEes=", "sHgxa");
        f.lIlllIllllll[f.lIllllIIIIII[64]] = f.lllIllIIIllIII("XuM1gu0CKB0=", "zqrvZ");
        f.lIlllIllllll[f.lIllllIIIIII[81]] = f.lllIllIIIllIlI("lo6PdlJz3cPF5vik1ZsaOlkbdpforBnS", "ZughR");
        f.lIlllIllllll[f.lIllllIIIIII[82]] = f.lllIllIIIllIIl("AwM5IwozCyovSwcLOCkCLwU=", "AbKAk");
        f.lIlllIllllll[f.lIllllIIIIII[86]] = f.lllIllIIIllIIl("OzsuZSABLA==", "nHKHR");
        f.lIlllIllllll[f.lIllllIIIIII[87]] = f.lllIllIIIllIIl("BgsLCCscEQ==", "KBEFd");
        f.lIlllIllllll[f.lIllllIIIIII[88]] = f.lllIllIIIllIIl("DDsqAgU2IQ==", "ARDlj");
        f.lIlllIllllll[f.lIllllIIIIII[91]] = f.lllIllIIIllIIl("Mh4WFRtBPRIN", "aswyw");
        f.lIlllIllllll[f.lIllllIIIIII[92]] = f.lllIllIIIllIIl("LCICKhY7JhIg", "dmWyS");
        f.lIlllIllllll[f.lIllllIIIIII[93]] = f.lllIllIIIllIlI("kSZVsidf81bYUYYJoDg4Gg==", "oQoNa");
        f.lIlllIllllll[f.lIllllIIIIII[101]] = f.lllIllIIIllIlI("DUjUc4bnKgs=", "tOKco");
        f.lIlllIllllll[f.lIllllIIIIII[102]] = f.lllIllIIIllIlI("7hSPIW3XC/nJEZO7/Nma2g==", "TcQcs");
        f.lIlllIllllll[f.lIllllIIIIII[103]] = f.lllIllIIIllIII("+PsJWq7jXRj6dnOdFtcrog==", "tCdnC");
        f.lIlllIllllll[f.lIllllIIIIII[69]] = f.lllIllIIIllIlI("m/raBEg0RuU=", "kixGl");
    }
