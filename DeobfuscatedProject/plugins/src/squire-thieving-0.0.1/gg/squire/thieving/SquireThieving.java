...
extends SquirePlugin {
    ...
    public boolean a(Player player, boolean bl) {
        TileObject llllllllllllllIlllIlllIIllIlIlII;
        void llllllllllllllIlllIlllIIllIlIllI;
        SquireThieving llllllllllllllIlllIlllIIllIllIII;
        c llllllllllllllIlllIlllIIllIlIlIl;
        c c2;
        if (SquireThieving.lIllIIIllIlIlII((Object)s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.c.b(player.getWorldLocation()))) {
            ...
            "".length();
            if (((93 + 60 - 83 + 65 ^ 13 + 14 - 25 + 143) & (0x52 ^ 0x25 ^ (0x42 ^ 0x23) ^ -" ".length())) == "   ".length()) {
                return ((102 + 119 - 126 + 35 ^ 57 + 41 - -35 + 13) & (0xC7 ^ 0x93 ^ (0x2F ^ 0x6B) ^ -" ".length())) != 0;
            }
        } else {
            c2 = llllllllllllllIlllIlllIIllIlIlIl = llllllllllllllIlllIlllIIllIllIII.b().t();
        }
        if (SquireThieving.lIllIIIllIllIlI((int)llllllllllllllIlllIlllIIllIlIllI) && SquireThieving.lIllIIIllIllIlI(Movement.isRunEnabled() ? 1 : 0)) {
            Movement.toggleRun();
        }
        if (SquireThieving.lIllIIIllIlIlII(llllllllllllllIlllIlllIIllIlIlII = llllllllllllllIlllIlllIIllIllIII.a(llllllllllllllIlllIlllIIllIlIlIl))) {
            String string;
            String[] stringArray = new String[lIIllIlllIIlI[3]];
            if (SquireThieving.lIllIIIllIlIllI((int)llllllllllllllIlllIlllIIllIlIllI)) {
                string = lIIllIlllIIIl[lIIllIlllIIlI[1]];
                "".length();
                if (" ".length() <= -" ".length()) {
                    return ((0xBE ^ 0x81 ^ (0x4F ^ 0x37)) & (0xE1 ^ 0xA7 ^ " ".length() ^ -" ".length())) != 0;
                }
            } else {
                string = stringArray[SquireThieving.lIIllIlllIIlI[1]] = lIIllIlllIIIl[lIIllIlllIIlI[3]];
            }
            if (SquireThieving.lIllIIIllIlIllI(llllllllllllllIlllIlllIIllIlIlII.hasAction(stringArray) ? 1 : 0)) {
                String string2;
                String string3;
                String string4;
                ...
                if (SquireThieving.lIllIIIllIlIllI((int)llllllllllllllIlllIlllIIllIlIllI)) {
                    ...
                    "".length();
                    if (" ".length() > (0x3A ^ 0x56 ^ (0xF8 ^ 0x90))) {
                        return ((0x3E ^ 0xD ^ (0xA6 ^ 0xB9)) & (0x47 ^ 0x1B ^ (2 ^ 0x72) ^ -" ".length())) != 0;
                    }
                } else {
                    string4 = stringArray2[SquireThieving.lIIllIlllIIlI[1]] = lIIllIlllIIIl[lIIllIlllIIlI[7]];
                }
                if (SquireThieving.lIllIIIllIllIlI(llllllllllllllIlllIlllIIllIlIlII.hasAction(stringArray2) ? 1 : 0)) {
                    Object[] objectArray = new Object[lIIllIlllIIlI[3]];
                    objectArray[SquireThieving.lIIllIlllIIlI[1]] = (boolean)llllllllllllllIlllIlllIIllIlIllI;
                ...
                if (SquireThieving.lIllIIIllIlIllI((int)llllllllllllllIlllIlllIIllIlIllI)) {
                    ...
                    if ((83 + 35 - 26 + 47 ^ 86 + 39 - 104 + 122) <= -" ".length()) {
                        return ((0xC3 ^ 0xA6 ^ (0xC2 ^ 0xAC)) & (0x72 ^ 0x3B ^ (0x18 ^ 0x5A) ^ -" ".length())) != 0;
                    }
                } else {
                    string3 = lIIllIlllIIIl[lIIllIlllIIlI[15]];
                }
                objectArray[n2] = string3;
                objectArray[SquireThieving.lIIllIlllIIlI[3]] = llllllllllllllIlllIlllIIllIlIlII.getId();
                ...
                llllllllllllllIlllIlllIIllIlIlII.interact(string2);
     ...
     */
    public d c() {
        void llllllllllllllIlllIlllIIllIllllI;
        ...
        if (SquireThieving.lIllIIIllIllIIl((int)llllllllllllllIlllIlllIIllIllllI, s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.d.BANDIT_56.u())) {
    ...
    private static void lIllIIIllIlIIll() {
        ...
        SquireThieving.lIIllIlllIIlI[3] = " ".length();
        SquireThieving.lIIllIlllIIlI[4] = 0xFFFFEA97 & 0x7FF9;
        SquireThieving.lIIllIlllIIlI[5] = "  ".length();
        SquireThieving.lIIllIlllIIlI[6] = 0xFFFFFEAD & 0x37F;
        SquireThieving.lIIllIlllIIlI[7] = "   ".length();
        ...
        SquireThieving.lIIllIlllIIlI[38] = -" ".length();
    ...
    private static String lIllIIIllIIllll(String llllllllllllllIlllIlllIIlIlllIlI, String llllllllllllllIlllIlllIIlIlllIll) {
        try {
            ...
            return new String(llllllllllllllIlllIlllIIlIlllllI.doFinal(Base64.getDecoder().decode(llllllllllllllIlllIlllIIlIlllIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIllIIIllIlIIII(String llllllllllllllIlllIlllIIlIIlIlIl, String llllllllllllllIlllIlllIIlIIlIlII) {
        try {
            SecretKeySpec llllllllllllllIlllIlllIIlIIllIlI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllIlllIlllIIlIIlIlII.getBytes(StandardCharsets.UTF_8)), lIIllIlllIIlI[17]), "DES");
            Cipher llllllllllllllIlllIlllIIlIIllIIl = Cipher.getInstance("DES");
            llllllllllllllIlllIlllIIlIIllIIl.init(lIIllIlllIIlI[5], llllllllllllllIlllIlllIIlIIllIlI);
            return new String(llllllllllllllIlllIlllIIlIIllIIl.doFinal(Base64.getDecoder().decode(llllllllllllllIlllIlllIIlIIlIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIllIIIllIlIIlI() {
        ...
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[1]] = SquireThieving.lIllIIIllIIllll("cmbPilvDoZw=", "QIijE");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[3]] = SquireThieving.lIllIIIllIlIIII("X8K+PPcwi0U=", "RBPjr");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[5]] = SquireThieving.lIllIIIllIlIIIl("JwYABw==", "hveiy");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[7]] = SquireThieving.lIllIIIllIIllll("FELBFsTNpRA=", "cnkIN");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[9]] = SquireThieving.lIllIIIllIlIIIl("Dw0YEAUlFkoADSgWTRBEJBkcAUQ4EA9EFiUfAhBELRseDQsiVkoLFCkWUEQfMQ==", "Lxjdd");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[11]] = SquireThieving.lIllIIIllIIllll("xML+ZHHAW57ScGl4PGyi8tNcUBFMGOK0beLxQ61L5JI=", "vYmiM");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[13]] = SquireThieving.lIllIIIllIlIIIl("Fyk2ORg2Pg==", "XYSWq");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[15]] = SquireThieving.lIllIIIllIIllll("6N5CL5M6V4U=", "sReJZ");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[17]] = SquireThieving.lIllIIIllIIllll("Qpx/SqhjHa0=", "VFIQc");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[19]] = SquireThieving.lIllIIIllIlIIII("LD0xPP6AIdk=", "jUYZC");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[0]] = SquireThieving.lIllIIIllIIllll("qQgQZeMbCvRXfQOVB/31sELEqOGPO5gvvJmwE7L4CsIb58BH9AI16Q==", "lUGXa");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[22]] = SquireThieving.lIllIIIllIlIIIl("Kj8YEToDPUwGPB8oCQYnTTkZFycMMwJFNQIoTA08GCkJX3MWJ0BFPB0/AgQxAT9WRSgQ", "mZleS");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[23]] = SquireThieving.lIllIIIllIlIIIl("MjccFhAffx1aEhg2DVobBCpJGQEDLAgTGgJ4MhUCFCoFFRUVPQ0n", "qXizt");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[24]] = SquireThieving.lIllIIIllIlIIII("DyYnq41tfds=", "lFmNT");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[25]] = SquireThieving.lIllIIIllIlIIII("c3oWBHo0R9Y=", "LlIIv");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[26]] = SquireThieving.lIllIIIllIlIIIl("FTYdPWwEPAA=", "fSxYL");
        SquireThieving.lIIllIlllIIIl[SquireThieving.lIIllIlllIIlI[27]] = SquireThieving.lIllIIIllIIllll("juBx3XJLLXw=", "VmLvX");
    }
    ...
    private static String lIllIIIllIlIIIl(String llllllllllllllIlllIlllIIlIlIllII, String llllllllllllllIlllIlllIIlIlIIllI) {
        llllllllllllllIlllIlllIIlIlIllII = new String(Base64.getDecoder().decode(llllllllllllllIlllIlllIIlIlIllII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllIlllIlllIIlIlIlIlI = new StringBuilder();
        char[] llllllllllllllIlllIlllIIlIlIlIIl = llllllllllllllIlllIlllIIlIlIIllI.toCharArray();
        int llllllllllllllIlllIlllIIlIlIlIII = lIIllIlllIIlI[1];
        char[] llllllllllllllIlllIlllIIlIlIIIlI = llllllllllllllIlllIlllIIlIlIllII.toCharArray();
        int llllllllllllllIlllIlllIIlIlIIIIl = llllllllllllllIlllIlllIIlIlIIIlI.length;
        int llllllllllllllIlllIlllIIlIlIIIII = lIIllIlllIIlI[1];
        while (SquireThieving.lIllIIIllIlllII(llllllllllllllIlllIlllIIlIlIIIII, llllllllllllllIlllIlllIIlIlIIIIl)) {
            char llllllllllllllIlllIlllIIlIlIllIl = llllllllllllllIlllIlllIIlIlIIIlI[llllllllllllllIlllIlllIIlIlIIIII];
            llllllllllllllIlllIlllIIlIlIlIlI.append((char)(llllllllllllllIlllIlllIIlIlIllIl ^ llllllllllllllIlllIlllIIlIlIlIIl[llllllllllllllIlllIlllIIlIlIlIII % llllllllllllllIlllIlllIIlIlIlIIl.length]));
            "".length();
            ++llllllllllllllIlllIlllIIlIlIlIII;
            ++llllllllllllllIlllIlllIIlIlIIIII;
            "".length();
    ...
    private void a() {
        SquireThieving llllllllllllllIlllIlllIIlllIIlII;
        ...
        if (SquireThieving.lIllIIIllIlIllI(llllllllllllllIlllIlllIIlllIIlII.e.gemBag() ? 1 : 0)) {
            llllllllllllllIlllIlllIIlllIIlII.h.add(item -> item.getName().toLowerCase().contains(lIIllIlllIIIl[lIIllIlllIIlI[27]]));
            "".length();
        }
        if (SquireThieving.lIllIIIllIlIllI(llllllllllllllIlllIlllIIlllIIlII.e.shadowVeil() ? 1 : 0)) {
            Iterator<Integer> llllllllllllllIlllIlllIIlllIIIll = llllllllllllllIlllIlllIIlllIIlII.b.iterator();
            while (SquireThieving.lIllIIIllIlIllI(llllllllllllllIlllIlllIIlllIIIll.hasNext() ? 1 : 0)) {
                int llllllllllllllIlllIlllIIlllIIIlI = llllllllllllllIlllIlllIIlllIIIll.next();
                int[] nArray = new int[lIIllIlllIIlI[3]];
                nArray[SquireThieving.lIIllIlllIIlI[1]] = llllllllllllllIlllIlllIIlllIIIlI;
                if (SquireThieving.lIllIIIllIlIllI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                    llllllllllllllIlllIlllIIlllIIlII.h.add(llllllllllllllIlllIlllIIlllIIIlI);
                    "".length();
                }
                "".length();
                if (((0x55 ^ 0x2F ^ (0x16 ^ 0x56)) & (0x7E ^ 0x2A ^ (0xF0 ^ 0x9E) ^ -" ".length())) != (20 + 80 - -14 + 31 ^ 13 + 10 - -14 + 112)) continue;
                return;
            }
        }
        if (SquireThieving.lIllIIIllIlIlll((Object)llllllllllllllIlllIlllIIlllIIlII.e.pickpocketFood(), (Object)s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.e.NONE) && SquireThieving.lIllIIIllIllIII(llllllllllllllIlllIlllIIlllIIlII.e.pickpocketFoodAmount())) {
            llllllllllllllIlllIlllIIlllIIlII.h.add(llllllllllllllIlllIlllIIlllIIlII.e.pickpocketFood().x(), llllllllllllllIlllIlllIIlllIIlII.e.pickpocketFoodAmount());
            "".length();
        }
        if (SquireThieving.lIllIIIllIlIllI(llllllllllllllIlllIlllIIlllIIlII.e.dodgyNecklace() ? 1 : 0) && SquireThieving.lIllIIIllIllIII(llllllllllllllIlllIlllIIlllIIlII.e.dodgyNecklaceAmount())) {
            llllllllllllllIlllIlllIIlllIIlII.h.add(lIIllIlllIIlI[42], llllllllllllllIlllIlllIIlllIIlII.e.dodgyNecklaceAmount());
            "".length();
        }
        if (SquireThieving.lIllIIIllIlIllI(llllllllllllllIlllIlllIIlllIIlII.e.useSeedBox() ? 1 : 0)) {
            llllllllllllllIlllIlllIIlllIIlII.h.add(item -> item.getName().toLowerCase().contains(lIIllIlllIIIl[lIIllIlllIIlI[26]]));
            "".length();
        }
    }
        ...
        TileObject tileObject2 = TileObjects.getNearest(tileObject -> {
            ...
            if (SquireThieving.lIllIIIllIlIllI(tileObject.getWorldLocation().equals((Object)c2.s()) ? 1 : 0)) {
                ...
                if (SquireThieving.lIllIIIllIlIllI(bl ? 1 : 0)) {
                    ...
                    "".length();
                    if (-" ".length() >= (0x7C ^ 0x7B ^ "   ".length())) {
                        return ((0x46 ^ 0x78 ^ "  ".length()) & (72 + 12 - -83 + 2 ^ 136 + 134 - 234 + 113 ^ -" ".length())) != 0;
                    }
                } else {
                ...
                if (SquireThieving.lIllIIIllIlIllI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x46 ^ 5 ^ (0xD4 ^ 0x9D)) & (0xD0 ^ 0x88 ^ (0x68 ^ 0x3A) ^ -" ".length())) != 0;
                }
            }
            n2 = lIIllIlllIIlI[1];
            return n2 != 0;
