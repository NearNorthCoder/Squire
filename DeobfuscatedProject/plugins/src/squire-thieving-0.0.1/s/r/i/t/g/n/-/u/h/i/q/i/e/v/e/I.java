...
extends Task {
    ...
    public boolean run() {
        ...
        BankLocation llllllllllllllIlllIllIllIIlIllll = BankLocation.getNearest();
        if (I.lIllIIlIIIIIlll(llllllllllllllIlllIllIllIIlIllll.getArea().distanceTo((Locatable)Players.getLocal()), lIIllIlllllIl[2])) {
            Movement.walkTo((WorldPoint)llllllllllllllIlllIllIllIIlIllll.getArea().getCenter());
            "".length();
            return lIIllIlllllIl[1];
        }
        Bank.open();
