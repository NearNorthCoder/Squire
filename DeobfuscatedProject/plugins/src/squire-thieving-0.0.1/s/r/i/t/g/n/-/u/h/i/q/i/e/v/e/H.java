...
extends Task {
    ...
    public void a(ChatMessage chatMessage) {
        void llllllllllllllIlllIlllIIIIIlllll;
        ...
        String llllllllllllllIlllIlllIIIIIllllI = llllllllllllllIlllIlllIIIIIlllll.getMessage();
        if (H.lIllIIIlllIIlll(llllllllllllllIlllIlllIIIIIllllI.contains(lIIllIllIllll[lIIllIlllIlIl[30]]) ? 1 : 0)) {
    ...
    private static void N() {
        ...
        if (!H.lIllIIIlllIIllI(widget) || H.lIllIIIlllIIlll(widget.isHidden() ? 1 : 0)) {
            ...
            void llllllllllllllIlllIlllIIIIlllllI;
            llllllllllllllIlllIlllIIIIlllllI.interact(lIIllIllIllll[lIIllIlllIlIl[6]]);
        }
    }
    ...
    private static void lIllIIIlllIIlII() {
        ...
        H.lIIllIlllIlIl[0] = " ".length();
        H.lIIllIlllIlIl[1] = (0x36 ^ 0x1D ^ (0x65 ^ 0x68)) & (0x2C ^ 0x27 ^ (0xBE ^ 0x93) ^ -" ".length());
        H.lIIllIlllIlIl[2] = -(0xFFFFD877 & 0x67BB) & (0xFFFFF5FF & 0x5FF2);
        H.lIIllIlllIlIl[3] = "  ".length();
        H.lIIllIlllIlIl[4] = 0xFFFF8AFF & 0x77B0;
        H.lIIllIlllIlIl[5] = 0x11 ^ 0x14;
        H.lIIllIlllIlIl[6] = "   ".length();
        ...
        H.lIIllIlllIlIl[35] = "  ".length() ^ (0xAB ^ 0xBC);
        ...
        H.lIIllIlllIlIl[43] = -"   ".length() & (0xFFFF9FC7 & 0x73FB);
        ...
        H.lIIllIlllIlIl[115] = " ".length() ^ (0x16 ^ 8);
    ...
    public boolean run() {
        H llllllllllllllIlllIlllIIIIlIllll;
        if (!H.lIllIIIlllIlIIl(this.aH ? 1 : 0) || H.lIllIIIlllIlIlI((Object)this.aF.method(), (Object)b.ROGUES_DEN)) {
            return lIIllIlllIlIl[1];
        }
        Player llllllllllllllIlllIlllIIIIlIlllI = Players.getLocal();
        WorldPoint llllllllllllllIlllIlllIIIIlIllIl = llllllllllllllIlllIlllIIIIlIlllI.getWorldLocation();
        if (H.lIllIIIlllIlIll(llllllllllllllIlllIlllIIIIlIllIl.getY(), lIIllIlllIlIl[12])) {
            aD = lIIllIlllIlIl[1];
            llllllllllllllIlllIlllIIIIlIllll.aI = lIIllIlllIlIl[1];
            return llllllllllllllIlllIlllIIIIlIllll.Q();
        }
        RectangularArea llllllllllllllIlllIlllIIIIlIllII = new RectangularArea(lIIllIlllIlIl[13], lIIllIlllIlIl[14], lIIllIlllIlIl[15], lIIllIlllIlIl[16], lIIllIlllIlIl[0]);
        if (H.lIllIIIlllIllII(llllllllllllllIlllIlllIIIIlIlllI.getAnimation(), lIIllIlllIlIl[11]) && H.lIllIIIlllIlIIl(llllllllllllllIlllIlllIIIIlIllII.contains(llllllllllllllIlllIlllIIIIlIllIl) ? 1 : 0)) {
            return lIIllIlllIlIl[0];
        }
        if (H.lIllIIIlllIIlll(llllllllllllllIlllIlllIIIIlIllll.aI ? 1 : 0)) {
            return lIIllIlllIlIl[0];
        }
        Iterator<g> llllllllllllllIlllIlllIIIIlIlIll = aE.iterator();
        while (H.lIllIIIlllIIlll(llllllllllllllIlllIlllIIIIlIlIll.hasNext() ? 1 : 0)) {
            g llllllllllllllIlllIlllIIIIlIlIlI = llllllllllllllIlllIlllIIIIlIlIll.next();
            if (H.lIllIIIlllIIlll(llllllllllllllIlllIlllIIIIlIlIlI.c(llllllllllllllIlllIlllIIIIlIllIl) ? 1 : 0)) {
                llllllllllllllIlllIlllIIIIlIlIlI.y();
                return lIIllIlllIlIl[0];
            }
            "".length();
            if ((0x8B ^ 0xA8 ^ (0x9E ^ 0xB9)) > 0) continue;
            return ((35 + 22 - -16 + 62 ^ 95 + 90 - 151 + 106) & (0x1C ^ 0x20 ^ (0x28 ^ 0x1F) ^ -" ".length())) != 0;
        }
        return lIIllIlllIlIl[1];
    }
    ...
    private static String lIllIIIllIIlIIl(String llllllllllllllIlllIllIlllllIlIIl, String llllllllllllllIlllIllIlllllIlIII) {
        try {
            SecretKeySpec llllllllllllllIlllIllIlllllIlllI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllIlllIllIlllllIlIII.getBytes(StandardCharsets.UTF_8)), lIIllIlllIlIl[20]), "DES");
            Cipher llllllllllllllIlllIllIlllllIllIl = Cipher.getInstance("DES");
            llllllllllllllIlllIllIlllllIllIl.init(lIIllIlllIlIl[3], llllllllllllllIlllIllIlllllIlllI);
            return new String(llllllllllllllIlllIllIlllllIllIl.doFinal(Base64.getDecoder().decode(llllllllllllllIlllIllIlllllIlIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIllIIIllIIlIII(String llllllllllllllIlllIlllIIIIIIlIII, String llllllllllllllIlllIlllIIIIIIllII) {
        llllllllllllllIlllIlllIIIIIIlIII = new String(Base64.getDecoder().decode(llllllllllllllIlllIlllIIIIIIlIII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllIlllIlllIIIIIIlIll = new StringBuilder();
        ...
        char[] llllllllllllllIlllIlllIIIIIIIIll = llllllllllllllIlllIlllIIIIIIlIII.toCharArray();
        int llllllllllllllIlllIlllIIIIIIIIlI = llllllllllllllIlllIlllIIIIIIIIll.length;
        int llllllllllllllIlllIlllIIIIIIIIIl = lIIllIlllIlIl[1];
        while (H.lIllIIIlllIlllI(llllllllllllllIlllIlllIIIIIIIIIl, llllllllllllllIlllIlllIIIIIIIIlI)) {
            char llllllllllllllIlllIlllIIIIIIlllI = llllllllllllllIlllIlllIIIIIIIIll[llllllllllllllIlllIlllIIIIIIIIIl];
            llllllllllllllIlllIlllIIIIIIlIll.append((char)(llllllllllllllIlllIlllIIIIIIlllI ^ llllllllllllllIlllIlllIIIIIIlIlI[llllllllllllllIlllIlllIIIIIIlIIl % llllllllllllllIlllIlllIIIIIIlIlI.length]));
            "".length();
            ++llllllllllllllIlllIlllIIIIIIlIIl;
            ++llllllllllllllIlllIlllIIIIIIIIIl;
            "".length();
            if (" ".length() <= "  ".length()) continue;
            return null;
        }
        return String.valueOf(llllllllllllllIlllIlllIIIIIIlIll);
    }
    ...
    private boolean Q() {
        NPC llllllllllllllIlllIlllIIIIlIIlII;
        Item llllllllllllllIlllIlllIIIIlIIlIl;
        H llllllllllllllIlllIlllIIIIlIIllI;
        if (H.lIllIIIlllIIlll(this.aG ? 1 : 0)) {
            ...
            if (H.lIllIIIlllIIlll(Dialog.isViewingOptions() ? 1 : 0)) {
                if (H.lIllIIIlllIIlll(Dialog.getOptions().stream().anyMatch(widget -> widget.getText().contains(lIIllIllIllll[lIIllIlllIlIl[33]])) ? 1 : 0)) {
                    llllllllllllllIlllIlllIIIIlIIllI.aG = lIIllIlllIlIl[1];
                    return lIIllIlllIlIl[0];
                }
        ...
        if (H.lIllIIIlllIlIIl(Movement.isStaminaBoosted() ? 1 : 0) && H.lIllIIIlllIIlll(llllllllllllllIlllIlllIIIIlIIllI.aF.useStaminaPotion() ? 1 : 0)) {
            llllllllllllllIlllIlllIIIIlIIlIl = Inventory.getFirst(item -> item.getName().startsWith(lIIllIllIllll[lIIllIlllIlIl[32]]));
            if (H.lIllIIIlllIIllI(llllllllllllllIlllIlllIIIIlIIlIl)) {
                llllllllllllllIlllIlllIIIIlIIlIl.interact(lIIllIllIllll[lIIllIlllIlIl[22]]);
                return lIIllIlllIlIl[0];
            }
            ...
            llllllllllllllIlllIlllIIIIlIIlII = NPCs.getNearest((int[])nArray);
            if (H.lIllIIIlllIIllI(llllllllllllllIlllIlllIIIIlIIlII)) {
                llllllllllllllIlllIlllIIIIlIIlII.interact(lIIllIllIllll[lIIllIlllIlIl[24]]);
                return lIIllIlllIlIl[0];
            }
        }
        if (H.lIllIIIlllIlIII(Players.getLocal().getWorldLocation().getY(), lIIllIlllIlIl[12]) && H.lIllIIIlllIIlll(Dialog.canContinue() ? 1 : 0)) {
            llllllllllllllIlllIlllIIIIlIIllI.aG = lIIllIlllIlIl[0];
            return lIIllIlllIlIl[0];
        }
        llllllllllllllIlllIlllIIIIlIIlIl = Static.getClient().getItemContainer(InventoryID.EQUIPMENT);
        if (H.lIllIIIlllIIllI(llllllllllllllIlllIlllIIIIlIIlIl) && H.lIllIIIlllIIlll(Stream.of(llllllllllllllIlllIlllIIIIlIIlIl.getItems()).anyMatch(item -> {
            int n2;
            if (H.lIllIIIlllIIllI(item) && H.lIllIIIlllIllII(item.getId(), lIIllIlllIlIl[11])) {
                n2 = lIIllIlllIlIl[0];
                "".length();
                if (-" ".length() == "  ".length()) {
                    return ((0x39 ^ 0x70 ^ (0x6A ^ 0x37)) & (84 + 37 - 23 + 43 ^ 138 + 83 - 216 + 148 ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIllIlllIlIl[1];
            }
            ...
            llllllllllllllIlllIlllIIIIlIIlII = NPCs.getNearest((int[])nArray);
            if (H.lIllIIIlllIIllI(llllllllllllllIlllIlllIIIIlIIlII)) {
                llllllllllllllIlllIlllIIIIlIIlII.interact(lIIllIllIllll[lIIllIlllIlIl[25]]);
                return lIIllIlllIlIl[0];
            }
            return lIIllIlllIlIl[1];
        }
        if (H.lIllIIIlllIlIIl(Inventory.isEmpty() ? 1 : 0)) {
            ...
            llllllllllllllIlllIlllIIIIlIIlII = NPCs.getNearest((int[])nArray);
            if (H.lIllIIIlllIIllI(llllllllllllllIlllIlllIIIIlIIlII)) {
                llllllllllllllIlllIlllIIIIlIIlII.interact(lIIllIllIllll[lIIllIlllIlIl[26]]);
                return lIIllIlllIlIl[0];
            }
        }
        if (H.lIllIIIlllIIlll(Bank.isOpen() ? 1 : 0)) {
            ...
            if (H.lIllIIIlllIllIl(Bank.getCount((boolean)lIIllIlllIlIl[0], (int[])nArray), lIIllIlllIlIl[5])) {
                llllllllllllllIlllIlllIIIIlIIllI.aH = lIIllIlllIlIl[0];
                return lIIllIlllIlIl[0];
            }
        }
        String[] stringArray = new String[lIIllIlllIlIl[0]];
    ...
    private static void lIllIIIlllIIIll() {
        ...
        H.lIIllIllIllll[H.lIIllIlllIlIl[1]] = H.lIllIIIllIIlIII("GDs+PQ==", "LZUXd");
        H.lIIllIllIllll[H.lIIllIlllIlIl[0]] = H.lIllIIIllIIlIIl("bO84ZvU/pSs=", "wqCnT");
        H.lIIllIllIllll[H.lIIllIlllIlIl[3]] = H.lIllIIIllIIlIIl("hJ4ilzaJsH4=", "bPiSz");
        H.lIIllIllIllll[H.lIIllIlllIlIl[6]] = H.lIllIIIllIIlIII("FSQGDgUy", "FAjkf");
        H.lIIllIllIllll[H.lIIllIlllIlIl[7]] = H.lIllIIIllIIlIII("AQMDNylnHw0zJSId", "GobDA");
        H.lIIllIllIllll[H.lIIllIlllIlIl[5]] = H.lIllIIIllIIlIlI("KH0REQWdSFY=", "ccwRL");
        H.lIIllIllIllll[H.lIIllIlllIlIl[8]] = H.lIllIIIllIIlIII("MQEvIy5XHSEnIhIf", "wmNPF");
        H.lIIllIllIllll[H.lIIllIlllIlIl[17]] = H.lIllIIIllIIlIII("EjcDImQyOQ==", "FVoII");
        H.lIIllIllIllll[H.lIIllIlllIlIl[20]] = H.lIllIIIllIIlIlI("YT6munip+GU9d3rn+MmOOw==", "SNqra");
        H.lIIllIllIllll[H.lIIllIlllIlIl[21]] = H.lIllIIIllIIlIIl("8VWlC9XCSoQ=", "dcKgv");
        H.lIIllIllIllll[H.lIIllIlllIlIl[22]] = H.lIllIIIllIIlIIl("ab6x4ULuK6I=", "iAPle");
        H.lIIllIllIllll[H.lIIllIlllIlIl[24]] = H.lIllIIIllIIlIlI("3bTNHFddpkc=", "dqhvH");
        H.lIIllIllIllll[H.lIIllIlllIlIl[25]] = H.lIllIIIllIIlIlI("gYBuScBDeZs=", "TDVbz");
        H.lIIllIllIllll[H.lIIllIlllIlIl[26]] = H.lIllIIIllIIlIIl("1yXLsg86iRU=", "zUSTn");
        H.lIIllIllIllll[H.lIIllIlllIlIl[28]] = H.lIllIIIllIIlIlI("wjAYtT2zxaM=", "OuVtV");
        H.lIIllIllIllll[H.lIIllIlllIlIl[29]] = H.lIllIIIllIIlIlI("yEXw4yc01s8=", "nHUbd");
        H.lIIllIllIllll[H.lIIllIlllIlIl[30]] = H.lIllIIIllIIlIII("MQUNeDscCwosaAsYGTsjAQQf", "hjxXH");
        H.lIIllIllIllll[H.lIIllIlllIlIl[31]] = H.lIllIIIllIIlIIl("48NQ1CqTazA=", "Lttry");
        H.lIIllIllIllll[H.lIIllIlllIlIl[32]] = H.lIllIIIllIIlIlI("TJim6L1abg4=", "veCUH");
        H.lIIllIllIllll[H.lIIllIlllIlIl[33]] = H.lIllIIIllIIlIlI("uWyoGkeODsn9Cd01x/WW/A==", "wEeCl");
        H.lIIllIllIllll[H.lIIllIlllIlIl[34]] = H.lIllIIIllIIlIII("MRoKMSU=", "ShcPK");
        H.lIIllIllIllll[H.lIIllIlllIlIl[35]] = H.lIllIIIllIIlIII("IRU1Gw5TPScPGRc=", "szRnk");
        H.lIIllIllIllll[H.lIIllIlllIlIl[36]] = H.lIllIIIllIIlIII("HgAHHA==", "JikyL");
        H.lIIllIllIllll[H.lIIllIlllIlIl[66]] = H.lIllIIIllIIlIII("BycMPAY=", "DKeQd");
        H.lIIllIllIllll[H.lIIllIlllIlIl[69]] = H.lIllIIIllIIlIII("Ogs7CiwB", "inZxO");
        H.lIIllIllIllll[H.lIIllIlllIlIl[89]] = H.lIllIIIllIIlIII("Pi4qES0F", "mKKcN");
        H.lIIllIllIllll[H.lIIllIlllIlIl[99]] = H.lIllIIIllIIlIlI("68fykqcU4OE=", "qxtRF");
    }
    ...
    private static void P() {
        ...
        Player llllllllllllllIlllIlllIIIIlllIII = Players.getLocal();
        if (H.lIllIIIlllIIlll(aD ? 1 : 0)) {
            WorldPoint llllllllllllllIlllIlllIIIIllIlll = new WorldPoint(lIIllIlllIlIl[9], lIIllIlllIlIl[10], lIIllIlllIlIl[0]);
            ScenePoint llllllllllllllIlllIlllIIIIllIllI = ScenePoint.fromWorld((WorldPoint)llllllllllllllIlllIlllIIIIllIlll);
            Movement.setDestination((int)llllllllllllllIlllIlllIIIIllIllI.getX(), (int)llllllllllllllIlllIlllIIIIllIllI.getY());
            return;
        }
        NPC llllllllllllllIlllIlllIIIIllIlll = NPCs.getNearest(nPC -> {
            int n2;
            String[] stringArray = new String[lIIllIlllIlIl[0]];
        ...
        if (H.lIllIIIlllIlIII(Players.getLocal().getAnimation(), lIIllIlllIlIl[11]) && H.lIllIIIlllIlIIl(llllllllllllllIlllIlllIIIIlllIII.isMoving() ? 1 : 0) && H.lIllIIIlllIlIII(llllllllllllllIlllIlllIIIIllIlll.getGraphic(), lIIllIlllIlIl[11])) {
            void llllllllllllllIlllIlllIIIIlllIIl;
            llllllllllllllIlllIlllIIIIlllIIl.useOn((Actor)llllllllllllllIlllIlllIIIIllIlll);
        }
    }

    private static String lIllIIIllIIlIlI(String llllllllllllllIlllIllIllllllIllI, String llllllllllllllIlllIllIllllllIlIl) {
        try {
            SecretKeySpec llllllllllllllIlllIllIlllllllIll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllIlllIllIllllllIlIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            return new String(llllllllllllllIlllIllIlllllllIlI.doFinal(Base64.getDecoder().decode(llllllllllllllIlllIllIllllllIllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
