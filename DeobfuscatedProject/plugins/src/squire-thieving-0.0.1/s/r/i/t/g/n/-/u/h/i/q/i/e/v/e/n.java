...
extends Task {
    ...
    private static void lIllIIIIIlIlIlI() {
        ...
        n.lIIllIlIIllll[1] = -" ".length();
        n.lIIllIlIIllll[2] = " ".length();
        n.lIIllIlIIllll[3] = "  ".length();
        n.lIIllIlIIllll[4] = "   ".length();
        n.lIIllIlIIllll[5] = 0xBC ^ 0xB8;
        n.lIIllIlIIllll[6] = 0x2D ^ 0x2A ^ "  ".length();
    ...
    public n(SquireThievingConfig squireThievingConfig, SquireThieving squireThieving) {
        this.P = nPC -> {
            ...
            if (n.lIllIIIIIlIllII(nPC.getName().contains(lIIllIlIIlllI[lIIllIlIIllll[9]]) ? 1 : 0) && n.lIllIIIIIlIllII(nPC.getName().equals(lIIllIlIIlllI[lIIllIlIIllll[10]]) ? 1 : 0)) {
                n2 = lIIllIlIIllll[2];
                "".length();
                if (((0x6D ^ 0x4E ^ (0xA8 ^ 0x83)) & (0x7B ^ 0x25 ^ (0x7D ^ 0x2B) ^ -" ".length())) != 0) {
                    return ((0x57 ^ 0x10 ^ (0xB0 ^ 0xB8)) & (0x31 ^ 0x72 ^ (0x40 ^ 0x4C) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIllIlIIllll[0];
            }
    ...
    private static void lIllIIIIIlIlIIl() {
        ...
        n.lIIllIlIIlllI[n.lIIllIlIIllll[0]] = n.lIllIIIIIlIIllI("9rvzCVIS1xuNks/VtTWjfBg6t1XsmYkjuCs0S3Qtkf9/Mv/7cihdKA==", "nbxWe");
        n.lIIllIlIIlllI[n.lIIllIlIIllll[2]] = n.lIllIIIIIlIIlll("ChUCGSomWjk6DDFAVxEy", "BzwjO");
        n.lIIllIlIIlllI[n.lIIllIlIIllll[3]] = n.lIllIIIIIlIlIII("1nJk3VUyDPmwepf3U+UeHo0I6hKbp68ObNuHgWBmLuSa7Pw8CFNTvwMgq2abi8dN", "LRPJb");
        n.lIIllIlIIlllI[n.lIIllIlIIllll[4]] = n.lIllIIIIIlIlIII("6JiXMyoCcBRR1GNUC2wumDXFQb4Uz76e0F2XeHGz6N2LNOeTGGRgWZf3a1T2KrPGYrUx+shXmkE=", "WuTDP");
        n.lIIllIlIIlllI[n.lIIllIlIIllll[5]] = n.lIllIIIIIlIlIII("95Qtvdn8sNqt3QSoEmybgQ==", "ZADEJ");
        n.lIIllIlIIlllI[n.lIIllIlIIllll[6]] = n.lIllIIIIIlIlIII("/gEbhUHJ0EPYTZr67Wm+Qg==", "yKFJL");
        n.lIIllIlIIlllI[n.lIIllIlIIllll[7]] = n.lIllIIIIIlIlIII("YjVF/ZO28pM=", "ajguf");
        n.lIIllIlIIlllI[n.lIIllIlIIllll[8]] = n.lIllIIIIIlIIllI("ClJqZCLIlO8=", "rojOu");
        n.lIIllIlIIlllI[n.lIIllIlIIllll[9]] = n.lIllIIIIIlIIlll("FgoHMQ==", "DkiPs");
        n.lIIllIlIIlllI[n.lIIllIlIIllll[10]] = n.lIllIIIIIlIlIII("pM6vvudKthJjWaObSXxoXg==", "dZcSc");
    }
    ...
    private boolean C() {
        ...
        if (n.lIllIIIIIlIllIl(llllllllllllllIllllIIIIllIIIlIII, lIIllIlIIllll[1])) {
            ...
            "".length();
            if (" ".length() == 0) {
                return ((0x1A ^ 0x54 ^ (8 ^ 0x60)) & (0x30 ^ 0x6F ^ (0xD1 ^ 0xA8) ^ -" ".length())) != 0;
            }
        } else {
            llllllllllllllIllllIIIIllIIIIlll = Worlds.getFirst(world -> {
                ...
                if (n.lIllIIIIIlIllII(world.isNormal() ? 1 : 0) && n.lIllIIIIIllIIIl(world.getLocation(), Worlds.getCurrentWorld().getLocation()) && n.lIllIIIIIlIllII(world.isMembers() ? 1 : 0) && n.lIllIIIIIlIlllI(world.getId(), Worlds.getCurrentId())) {
                    ...
                    "".length();
                    if (" ".length() == "  ".length()) {
                        return ((0xAA ^ 0xA3 ^ (0xAE ^ 0x8E)) & (0x74 ^ 0x43 ^ (0x19 ^ 7) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIIllIlIIllll[0];
                }
        ...
        if (n.lIllIIIIIllIIII(llllllllllllllIllllIIIIllIIIIlll) && n.lIllIIIIIllIIII(llllllllllllllIllllIIIIllIIIIlll = Worlds.getFirst(world -> {
            ...
            if (n.lIllIIIIIlIllII(world.isNormal() ? 1 : 0) && n.lIllIIIIIlIllII(world.isMembers() ? 1 : 0) && n.lIllIIIIIllIIIl(world.getLocation(), Worlds.getCurrentWorld().getLocation())) {
                n2 = lIIllIlIIllll[2];
                "".length();
                if (((0xF ^ 0x79 ^ (0x5B ^ 0x1D)) & (0xE6 ^ 0xBB ^ (0x26 ^ 0x4B) ^ -" ".length())) > "   ".length()) {
                    return ((30 + 154 - 74 + 65 ^ 115 + 78 - 124 + 80) & (0x1C ^ 7 ^ (0x1D ^ 0x3C) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIllIlIIllll[0];
            }
        ...
        if (n.lIllIIIIIlIlIll(Game.getState(), GameState.LOGGED_IN)) {
            ...
            if (n.lIllIIIIIlIllll(Game.getState(), GameState.HOPPING)) {
                ...
                if ((0x11 ^ 0x30 ^ (0x9D ^ 0xB8)) < 0) {
                    return ((103 + 108 - 116 + 73 ^ 121 + 28 - 138 + 118) & (0x74 ^ 0x54 ^ (0xE ^ 7) ^ -" ".length())) != 0;
                }
            } else {
                bl = lIIllIlIIllll[0];
            }
