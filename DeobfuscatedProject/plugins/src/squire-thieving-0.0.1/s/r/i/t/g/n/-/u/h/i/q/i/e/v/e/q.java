...
extends Task {
        ...
        if (q.lIllIIIlIIIIIll(llllllllllllllIlllIlllllIlllllII.isInArea(worldAreaArray) ? 1 : 0)) {
            ...
            TileObject llllllllllllllIlllIlllllIlllIllI = TileObjects.getNearest(tileObject -> {
                ...
                block2: {
                    ...
                    return ((0xD6 ^ 0xAC ^ (0x87 ^ 0xB0)) & (0xBA ^ 0xC4 ^ (0x64 ^ 0x57) ^ -" ".length())) != 0;
                }
                n2 = lIIllIllIIIIl[0];
                return n2 != 0;
            });
    ...
    private static void lIllIIIIlllllll() {
        ...
        q.lIIllIllIIIIl[0] = (0x14 ^ 0x62 ^ (0x1B ^ 0x73)) & (0x36 ^ 0x70 ^ (7 ^ 0x5F) ^ -" ".length());
        q.lIIllIllIIIIl[1] = " ".length();
        q.lIIllIllIIIIl[2] = "  ".length();
        q.lIIllIllIIIIl[3] = "   ".length();
    ...
    private static void lIllIIIIllllllI() {
        ...
        q.lIIllIllIIIII[q.lIIllIllIIIIl[0]] = q.lIllIIIIllllIll("zm+QtIfFqJRxtrFisBhV95/BMvlLlT3chmLAD+MYD+VOK66yz9GO0ACTEkublX6BI9P4fRX0fZYxhFYtbZaPrg==", "NtzSf");
        q.lIIllIllIIIII[q.lIIllIllIIIIl[1]] = q.lIllIIIIllllIll("kf1bw5C6Ze0fi2jNqfZsIHIAGVawvgqf+RTV8cVn3IGnA8l11qKZpcYFkBXw9MaxtM5rwnOj7os=", "beAhZ");
        q.lIIllIllIIIII[q.lIIllIllIIIIl[2]] = q.lIllIIIIlllllII("roGYaitm1hs=", "DemTR");
        q.lIIllIllIIIII[q.lIIllIllIIIIl[3]] = q.lIllIIIIlllllII("l7BZcgNfB+GoBUkXxXZMS7LiMBkGHBly6adMjhB+Are0BJo1q2NZl4H4gFig1cjdXDzFVlElnT7ngsHXc1MhAXUPQH+dcsfz", "JqgMi");
        q.lIIllIllIIIII[q.lIIllIllIIIIl[6]] = q.lIllIIIIlllllII("bADRWwUJmWXmAtQrA+RUR+stpSh6jNGLCPjkvFqsV/nS0hOrFbmzRxI5v2Vbm/yWe1vmJ84czYI=", "Cstov");
        q.lIIllIllIIIII[q.lIIllIllIIIIl[7]] = q.lIllIIIIlllllII("TTWsKOr9nzv9I0tzce+IHVKYw6Et4qfLOFOWAxB71OOLIspaR+j5/w==", "OUiWv");
        q.lIIllIllIIIII[q.lIIllIllIIIIl[8]] = q.lIllIIIIlllllIl("MhIFEToJ", "awdcY");
        q.lIIllIllIIIII[q.lIIllIllIIIIl[9]] = q.lIllIIIIlllllIl("NC06DAVaNCM=", "wASag");
        q.lIIllIllIIIII[q.lIIllIllIIIIl[10]] = q.lIllIIIIllllIll("Fvkf6GzS3WA=", "aJlYy");
        q.lIIllIllIIIII[q.lIIllIllIIIIl[11]] = q.lIllIIIIlllllIl("AAs6FwtuEiM=", "CgSzi");
        q.lIIllIllIIIII[q.lIIllIllIIIIl[12]] = q.lIllIIIIllllIll("HRvBRcWjxcU=", "CTYJs");
    }
