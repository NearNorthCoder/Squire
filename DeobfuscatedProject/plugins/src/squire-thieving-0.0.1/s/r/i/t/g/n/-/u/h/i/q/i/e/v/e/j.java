...
extends Task {
    ...
    private static void lIllIIIlIIllIlI() {
        ...
        j.lIIllIllIIllI[2] = (0x54 ^ 0x1A ^ (0xCD ^ 0xB4)) & (64 + 212 - 238 + 204 ^ 88 + 21 - 25 + 113 ^ -" ".length());
        j.lIIllIllIIllI[3] = -" ".length();
        j.lIIllIllIIllI[4] = " ".length();
        j.lIIllIllIIllI[5] = "  ".length();
        j.lIIllIllIIllI[6] = "   ".length();
    ...
    private static String lIllIIIlIIlIlll(String llllllllllllllIlllIllllIIlIllIII, String llllllllllllllIlllIllllIIlIlIlll) {
        ...
        while (j.lIllIIIlIlIIIII(llllllllllllllIlllIllllIIlIIllII, llllllllllllllIlllIllllIIlIIllIl)) {
            ...
            "".length();
            if ((0x89 ^ 0x98 ^ (0x67 ^ 0x72)) >= -" ".length()) continue;
            return null;
        }
    ...
    private static void lIllIIIlIIllIIl() {
        ...
        j.lIIllIllIIlIl[j.lIIllIllIIllI[2]] = j.lIllIIIlIIlIllI("DdGaNbidlSgP35oZio57Ew==", "gqhLl");
        j.lIIllIllIIlIl[j.lIIllIllIIllI[4]] = j.lIllIIIlIIlIlll("JzsGHHcUOxoRPw==", "dTorW");
        j.lIIllIllIIlIl[j.lIIllIllIIllI[5]] = j.lIllIIIlIIlIllI("n9+db6V9m/+iZiI/+S1x1Q==", "Pgvrl");
        j.lIIllIllIIlIl[j.lIIllIllIIllI[6]] = j.lIllIIIlIIlIlll("MRslF2UCGzkaLQ==", "rtLyE");
        j.lIIllIllIIlIl[j.lIIllIllIIllI[7]] = j.lIllIIIlIIlIlll("JiMBNEgIPwg=", "iSdZe");
        j.lIIllIllIIlIl[j.lIIllIllIIllI[8]] = j.lIllIIIlIIllIII("N+ycyCeaqX2Fit/gv3Bf7w==", "ePugk");
    }
