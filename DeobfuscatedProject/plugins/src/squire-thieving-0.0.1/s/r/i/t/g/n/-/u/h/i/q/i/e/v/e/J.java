...
extends Task {
    ...
    private static void lIllIIIIlIlllII() {
        ...
        J.lIIllIlIllIll[3] = " ".length();
        J.lIIllIlIllIll[4] = 0xFFFFFF9F & 0x7FF;
        J.lIIllIlIllIll[5] = "  ".length();
        J.lIIllIlIllIll[6] = 0xFFFFE7EF & 0x1FBB;
        J.lIIllIlIllIll[7] = "   ".length();
    ...
    private static void lIllIIIIlIllIll() {
        ...
        J.lIIllIlIllIlI[J.lIIllIlIllIll[1]] = J.lIllIIIIlIllIII("L0a2BQynbbj3POBgq5BgxxJXXt+TguKJTPXea+yfg0pHDP0TJM+Klg==", "yFRHS");
        J.lIIllIlIllIlI[J.lIIllIlIllIll[3]] = J.lIllIIIIlIllIIl("WOCLiAhRMWU=", "pmVaU");
        J.lIIllIlIllIlI[J.lIIllIlIllIll[5]] = J.lIllIIIIlIllIlI("NSAbOR0=", "qRrWv");
        J.lIIllIlIllIlI[J.lIIllIlIllIll[7]] = J.lIllIIIIlIllIlI("FCYDYj93NQgkKD9nHjEqOys=", "WGmEK");
        J.lIIllIlIllIlI[J.lIIllIlIllIll[9]] = J.lIllIIIIlIllIII("jBEDXGXrC49hH/B4F/yEqQ==", "MKSJx");
        J.lIIllIlIllIlI[J.lIIllIlIllIll[11]] = J.lIllIIIIlIllIIl("Lw9q1AOMgqM=", "kwnYZ");
        J.lIIllIlIllIlI[J.lIIllIlIllIll[13]] = J.lIllIIIIlIllIIl("Pb64fvJc4K9XdKegmlPlhA==", "XRoww");
        J.lIIllIlIllIlI[J.lIIllIlIllIll[0]] = J.lIllIIIIlIllIII("PmIqzvACqPCf8IkieeGhxg==", "UsZKe");
    }
    ...
    public boolean run() {
        ...
        List llllllllllllllIllllIIIIIlIIIlllI = Players.getAll(player2 -> {
            ...
            if (J.lIllIIIIllIIIlI(player2) && J.lIllIIIIlIlllIl(player2, llllllllllllllIllllIIIIIlIIlIIIl)) {
                ...
                if (J.lIllIIIIlIlllll(player2.getWorldLocation().isInArea(worldAreaArray) ? 1 : 0)) {
                    n2 = lIIllIlIllIll[3];
                    "".length();
                    if (-" ".length() < (0xA0 ^ 0xC6 ^ (0x6B ^ 9))) return n2 != 0;
                    return ((0x77 ^ 0x1E ^ (0xD9 ^ 0xA1)) & (0xDD ^ 0x9D ^ (0xDD ^ 0x8C) ^ -" ".length())) != 0;
                }
            }
            n2 = lIIllIlIllIll[1];
            return n2 != 0;
        ...
        if (J.lIllIIIIlIlllll(llllllllllllllIllllIIIIIlIIlIIII.A() ? 1 : 0)) {
            ...
            "".length();
            if (((48 + 164 - 107 + 81 ^ 110 + 137 - 110 + 25) & (0x89 ^ 0x9A ^ (0x50 ^ 0x5B) ^ -" ".length())) != 0) {
                return ((13 + 174 - 100 + 151 ^ 188 + 93 - 266 + 181) & (116 + 75 - 137 + 110 ^ 94 + 98 - 52 + 2 ^ -" ".length())) != 0;
            }
        } else {
            tileObject2 = TileObjects.getNearest(tileObject -> {
                int n2;
