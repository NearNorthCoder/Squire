...
public final class g {
    ...
    public g d(WorldPoint worldPoint) {
        return this.a(worldPoint2 -> {
            ...
            if (g.lIllIIIIlIIIIlI(worldPoint2.getX(), worldPoint.getX()) && g.lIllIIIIlIIIIlI(worldPoint2.getY(), worldPoint.getY())) {
                n2 = lIIllIlIlIIll[1];
                "".length();
                if (((0xB7 ^ 0x99 ^ (0x3B ^ 5)) & (14 + 157 - 29 + 33 ^ 119 + 161 - 125 + 36 ^ -" ".length())) > 0) {
                    return null;
                }
            } else {
                n2 = lIIllIlIlIIll[0];
    ...
    private static void lIllIIIIIlllIll() {
        ...
        g.lIIllIlIlIIll[0] = (0xF1 ^ 0xA5 ^ (0xF0 ^ 0x9E)) & (0x17 ^ 0x79 ^ (0x29 ^ 0x7D) ^ -" ".length());
        g.lIIllIlIlIIll[1] = " ".length();
        g.lIIllIlIlIIll[2] = 0x44 ^ 0x58 ^ (0x81 ^ 0x84);
        g.lIIllIlIlIIll[3] = 0x1B ^ 0x11;
        g.lIIllIlIlIIll[4] = -" ".length();
    }
    ...
    public g a(int n2, int n3, int n4, int n5, Integer n6) {
        return this.a(worldPoint -> {
            int n7;
            void llllllllllllllIllllIIIIlIIIIIllI;
            void llllllllllllllIllllIIIIlIIIIIlll;
            void llllllllllllllIllllIIIIlIIIIlIII;
            void llllllllllllllIllllIIIIlIIIIIlIl;
            void llllllllllllllIllllIIIIlIIIIlIIl;
            if (g.lIllIIIIIllllll(n6) && g.lIllIIIIlIIIIII(worldPoint.getPlane(), n6)) {
                return lIIllIlIlIIll[0];
            }
            if (g.lIllIIIIIllllIl((int)llllllllllllllIllllIIIIlIIIIlIIl, llllllllllllllIllllIIIIlIIIIIlIl.getX()) && g.lIllIIIIlIIIIIl((int)llllllllllllllIllllIIIIlIIIIlIII, llllllllllllllIllllIIIIlIIIIIlIl.getX()) && g.lIllIIIIIllllIl((int)llllllllllllllIllllIIIIlIIIIIlll, llllllllllllllIllllIIIIlIIIIIlIl.getY()) && g.lIllIIIIlIIIIIl((int)llllllllllllllIllllIIIIlIIIIIllI, llllllllllllllIllllIIIIlIIIIIlIl.getY())) {
                n7 = lIIllIlIlIIll[1];
                "".length();
                if ("   ".length() <= -" ".length()) {
                    return null;
    ...
    public static g a(int n2, int n3, String string, boolean bl) {
        ...
        return g.a(() -> {
            void llllllllllllllIllllIIIIIllllllII;
            ...
            if (g.lIllIIIIIllllll(tileObject2) && g.lIllIIIIlIIIIlI(Players.getLocal().getAnimation(), lIIllIlIlIIll[4])) {
                if (g.lIllIIIIlIIIIll(string)) {
                    ...
                    void llllllllllllllIllllIIIIIlllllIll;
                    llllllllllllllIllllIIIIIlllllIll.interact((String)llllllllllllllIllllIIIIIllllllII);
                }
                return;
            }
            if (g.lIllIIIIlIIIIll(llllllllllllllIllllIIIIIllllllII)) {
                WorldPoint llllllllllllllIllllIIIIIllllllIl;
                Movement.walk((WorldPoint)llllllllllllllIllllIIIIIllllllIl);
            }
        }).d(bl);
    }
