...
extends a {
    ...
    private boolean K() {
        Item item2 = Inventory.getFirst(item -> {
            ...
            if (D.lIllIIlIlIIIIIl(item.getActions()) && D.lIllIIlIIlllIlI(item.hasAction(av) ? 1 : 0) && D.lIllIIlIlIIIIlI(item.getName().equals(lIIlllIIIlIII[lIIlllIIIlIIl[1]]) ? 1 : 0)) {
                n2 = lIIlllIIIlIIl[1];
                "".length();
                if ((49 + 4 - -42 + 87 ^ 157 + 68 - 150 + 103) <= "  ".length()) {
                    return ((0xB3 ^ 0xC1 ^ (0x6A ^ 0x35)) & (0x4B ^ 0x32 ^ (0x5D ^ 9) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIlllIIIlIIl[0];
            }
    ...
    public boolean l() {
        ...
        int llllllllllllllIlllIllIlIIIIIIIlI = Inventory.getCount(item -> {
            ...
            if (D.lIllIIlIIlllIlI(item.hasAction(av) ? 1 : 0) && D.lIllIIlIlIIIIlI(item.getName().equals(lIIlllIIIlIII[lIIlllIIIlIIl[5]]) ? 1 : 0)) {
                ...
                "".length();
                if ("   ".length() <= "  ".length()) {
                    return ((21 + 4 - -163 + 53 ^ 141 + 112 - 139 + 55) & (0x59 ^ 0x4A ^ (0xFF ^ 0xB4) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIlllIIIlIIl[0];
            }
        ...
        if (D.lIllIIlIIlllIlI(llllllllllllllIlllIllIlIIIIIIIll.p.redemptionHeal() ? 1 : 0) && D.lIllIIlIIlllllI(Prayers.getPoints())) {
            ...
            if (D.lIllIIlIIllllll(Combat.getCurrentHealth(), lIIlllIIIlIIl[4])) {
                n2 = lIIlllIIIlIIl[1];
                "".length();
                if (((153 + 75 - 179 + 119 ^ 130 + 112 - 176 + 69) & (0x50 ^ 0x57 ^ (0x25 ^ 0xD) ^ -" ".length())) != 0) {
                    return (((0x3C ^ 0x10) & ~(0x5A ^ 0x76) ^ (0x55 ^ 0x48)) & (0x25 ^ 0x42 ^ (0xDC ^ 0xA6) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIlllIIIlIIl[0];
            }
    ...
    private static void lIllIIlIIlllIII() {
        ...
        D.lIIlllIIIlIII[D.lIIlllIIIlIIl[0]] = D.lIllIIlIIllIlIl("YXUVfNRfqg4=", "IeEZA");
        D.lIIlllIIIlIII[D.lIIlllIIIlIIl[1]] = D.lIllIIlIIllIlIl("TBN3WMsXcq1OE0/f+HlLvg==", "xJjdr");
        D.lIIlllIIIlIII[D.lIIlllIIIlIIl[5]] = D.lIllIIlIIllIllI("KTsYUAmNLEyChfSRFFzXfA==", "XYkrK");
        D.lIIlllIIIlIII[D.lIIlllIIIlIIl[6]] = D.lIllIIlIIllIlll("PCA4", "yALqR");
        D.lIIlllIIIlIII[D.lIIlllIIIlIIl[7]] = D.lIllIIlIIllIlll("FD4vPCk=", "PLFRB");
    }
