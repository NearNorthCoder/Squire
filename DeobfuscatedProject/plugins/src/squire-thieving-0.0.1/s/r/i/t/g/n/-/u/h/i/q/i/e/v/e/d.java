...
extends Enum<d> {
    ...
    public NPC a(Predicate<NPC> predicate) {
        return NPCs.getNearest((WorldPoint)this.t().r(), nPC -> {
            ...
            if (d.lIllIIIIlIlIllI(this.b((NPC)nPC) ? 1 : 0) && d.lIllIIIIlIlIllI(predicate.test((NPC)nPC) ? 1 : 0)) {
                ...
                "".length();
                if (-" ".length() < -" ".length()) {
                    return ((31 + 115 - 107 + 115 ^ 48 + 60 - -20 + 9) & (0x85 ^ 0xBF ^ (0x16 ^ 0x3F) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIllIlIllIIl[1];
            }
    ...
    public NPC a(d d2) {
        return NPCs.getNearest(nPC -> {
            ...
            if (d.lIllIIIIlIlIllI(this.name.equals(d2.name) ? 1 : 0) && d.lIllIIIIlIlIlll(nPC.getCombatLevel(), d2.combat)) {
                ...
                "".length();
                if (-" ".length() != -" ".length()) {
                    return ((0x9C ^ 0xC1 ^ (0x72 ^ 0x7D)) & (0x86 ^ 0xC6 ^ (0x72 ^ 0x60) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIllIlIllIIl[1];
            }
    ...
    private static String lIllIIIIlIlIIII(String llllllllllllllIlllIllllIllllIIll, String llllllllllllllIlllIllllIllllIIlI) {
        try {
            SecretKeySpec llllllllllllllIlllIllllIlllllIII = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllIlllIllllIllllIIlI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllIlllIllllIllllIlll = Cipher.getInstance("Blowfish");
            llllllllllllllIlllIllllIllllIlll.init(lIIllIlIllIIl[3], llllllllllllllIlllIllllIlllllIII);
            return new String(llllllllllllllIlllIllllIllllIlll.doFinal(Base64.getDecoder().decode(llllllllllllllIlllIllllIllllIIll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
        catch (Exception llllllllllllllIlllIllllIllllIllI) {
            llllllllllllllIlllIllllIllllIllI.printStackTrace();
            return null;
        }
    }
    ...
    public boolean b(NPC nPC) {
        ...
        if (d.lIllIIIIlIlIllI(this.name.equals(nPC.getName()) ? 1 : 0) && d.lIllIIIIlIlIlll(this.combat, nPC.getCombatLevel())) {
            ...
            "".length();
            if (-" ".length() > 0) {
                return ((0x99 ^ 0x9E ^ (0x27 ^ 0x34)) & (177 + 181 - 159 + 14 ^ 35 + 175 - 44 + 27 ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIIllIlIllIIl[1];
        }
    ...
    private static void lIllIIIIlIlIIll() {
        ...
        d.lIIllIlIllIII[d.lIIllIlIllIIl[1]] = d.lIllIIIIlIlIIII("/gBTUQAWqFE=", "lPjpI");
        d.lIIllIlIllIII[d.lIIllIlIllIIl[2]] = d.lIllIIIIlIlIIIl("", "oiTVF");
        d.lIIllIlIllIII[d.lIIllIlIllIIl[3]] = d.lIllIIIIlIlIIII("Y8aEl35GYmtHBVjJo0KQHQ==", "zKJBB");
        d.lIIllIlIllIII[d.lIIllIlIllIIl[4]] = d.lIllIIIIlIlIIIl("BgMpMAc9Hm4UBzgPIg==", "NjNXb");
        d.lIIllIlIllIII[d.lIIllIlIllIIl[5]] = d.lIllIIIIlIlIIIl("PCg8BBc5JCYA", "qmrEG");
        d.lIIllIlIllIII[d.lIIllIlIllIIl[7]] = d.lIllIIIIlIlIIII("yg/+UwYzoWrvfy6ugAiM9w==", "TbmzO");
        d.lIIllIlIllIII[d.lIIllIlIllIIl[9]] = d.lIllIIIIlIlIIIl("DzAvNSYZLlRH", "Mqaqo");
        d.lIIllIlIllIII[d.lIIllIlIllIIl[10]] = d.lIllIIIIlIlIIIl("KRMZDBof", "krwhs");
        d.lIIllIlIllIII[d.lIIllIlIllIIl[12]] = d.lIllIIIIlIlIIlI("HKyhQitbmzel2sxpqhPWkQ==", "QWQDD");
        d.lIIllIlIllIII[d.lIIllIlIllIIl[14]] = d.lIllIIIIlIlIIII("W7K1UobvTWA=", "MkCza");
    }
    ...
    public String toString() {
        ...
        if (d.lIllIIIIlIlIlIl(this.thieving, lIIllIlIllIIl[0])) {
            ...
            "".length();
            if (((0x74 ^ 0x72 ^ (0xF6 ^ 0xBC)) & (123 + 188 - 219 + 109 ^ 106 + 127 - 221 + 121 ^ -" ".length())) >= " ".length()) {
                return null;
            }
        } else {
    ...
    private static String lIllIIIIlIlIIIl(String llllllllllllllIlllIllllIlllIIIII, String llllllllllllllIlllIllllIllIlllll) {
        llllllllllllllIlllIllllIlllIIIII = new String(Base64.getDecoder().decode(llllllllllllllIlllIllllIlllIIIII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllIlllIllllIlllIIIll = new StringBuilder();
        char[] llllllllllllllIlllIllllIlllIIIlI = llllllllllllllIlllIllllIllIlllll.toCharArray();
        int llllllllllllllIlllIllllIlllIIIIl = lIIllIlIllIIl[1];
        char[] llllllllllllllIlllIllllIllIllIll = llllllllllllllIlllIllllIlllIIIII.toCharArray();
        int llllllllllllllIlllIllllIllIllIlI = llllllllllllllIlllIllllIllIllIll.length;
        int llllllllllllllIlllIllllIllIllIIl = lIIllIlIllIIl[1];
        while (d.lIllIIIlIIIlIIl(llllllllllllllIlllIllllIllIllIIl, llllllllllllllIlllIllllIllIllIlI)) {
            char llllllllllllllIlllIllllIlllIIllI = llllllllllllllIlllIllllIllIllIll[llllllllllllllIlllIllllIllIllIIl];
            llllllllllllllIlllIllllIlllIIIll.append((char)(llllllllllllllIlllIllllIlllIIllI ^ llllllllllllllIlllIllllIlllIIIlI[llllllllllllllIlllIllllIlllIIIIl % llllllllllllllIlllIllllIlllIIIlI.length]));
            "".length();
            ++llllllllllllllIlllIllllIlllIIIIl;
            ++llllllllllllllIlllIllllIllIllIIl;
            "".length();
            if (null == null) continue;
            return null;
        }
        return String.valueOf(llllllllllllllIlllIllllIlllIIIll);
    }
    ...
    public NPC b(c c2) {
        return NPCs.getNearest((WorldPoint)c2.p().getCenter(), nPC -> {
            ...
            if (d.lIllIIIIlIlIllI(c2.p().contains((Locatable)nPC) ? 1 : 0) && d.lIllIIIIlIlIllI(this.name.equals(nPC.getName()) ? 1 : 0) && d.lIllIIIIlIlIlll(nPC.getCombatLevel(), this.combat)) {
                ...
                "".length();
                if ("  ".length() <= 0) {
                    return ((0x7C ^ 0x20 ^ " ".length()) & (0x5D ^ 0x2D ^ (0x9B ^ 0xB6) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIllIlIllIIl[1];
            }
    ...
    private static void lIllIIIIlIlIlII() {
        ...
        d.lIIllIlIllIIl[0] = -" ".length();
        d.lIIllIlIllIIl[1] = (0x66 ^ 0x2A ^ (0x1C ^ 0x1B)) & (95 + 54 - 16 + 114 ^ 101 + 85 - 171 + 173 ^ -" ".length());
        d.lIIllIlIllIIl[2] = " ".length();
        d.lIIllIlIllIIl[3] = "  ".length();
        d.lIIllIlIllIIl[4] = "   ".length();
