...
extends Task {
    ...
    private static void lIllIIlIllIlIIl() {
        ...
        m.lIIlllIIlIIII[1] = " ".length();
        m.lIIlllIIlIIII[2] = "  ".length();
        m.lIIlllIIlIIII[3] = 0x18 ^ 0x1C;
        m.lIIlllIIlIIII[4] = 0xAA ^ 0xAF;
        m.lIIlllIIlIIII[5] = "   ".length();
    }
    ...
    private static void lIllIIlIllIlIII() {
        ...
        m.lIIlllIIIllll[m.lIIlllIIlIIII[0]] = m.lIllIIlIllIIllI("FjMSLCYpORoiIg==", "FZqGV");
        m.lIIlllIIIllll[m.lIIlllIIlIIII[1]] = m.lIllIIlIllIIllI("FwcUPzoUUgU5ORETEg==", "srfVT");
        m.lIIlllIIIllll[m.lIIlllIIlIIII[2]] = m.lIllIIlIllIIlll("USo6DEHm6MVjrxl4kUsCTQ==", "pvilZ");
        m.lIIlllIIIllll[m.lIIlllIIlIIII[5]] = m.lIllIIlIllIIllI("CSICKwAj", "HVvJc");
    }
    ...
    public boolean run() {
        ...
        NPC llllllllllllllIlllIllIIIlIlIIlIl = NPCs.getNearest(nPC -> {
            ...
            if (m.lIllIIlIlllIIII(nPC.getInteracting(), llllllllllllllIlllIllIIIlIlIIllI) && m.lIllIIlIllIllIl(nPC.hasAction(lIIlllIIIllll[lIIlllIIlIIII[5]]::equals) ? 1 : 0)) {
                ...
                "".length();
                if (-" ".length() != -" ".length()) {
                    return ((93 + 5 - 12 + 71 ^ 92 + 104 - 69 + 1) & (0xC9 ^ 0xB7 ^ (0x4E ^ 0x2D) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIlllIIlIIII[0];
            }
