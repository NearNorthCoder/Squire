...
extends a {
    ...
    private static void lIllIIIIIllIlIl() {
        ...
        z.lIIllIlIlIIIl[0] = (0x57 ^ 0x68 ^ (0x74 ^ 0x56)) & (90 + 128 - 196 + 152 ^ 47 + 82 - 1 + 51 ^ -" ".length());
        z.lIIllIlIlIIIl[1] = 0xFFFFF643 & 0x39BF;
        z.lIIllIlIlIIIl[2] = " ".length();
        z.lIIllIlIlIIIl[3] = 0xFFFFF9FE & 0x367F;
    }

    @Override
    public boolean l() {
        z llllllllllllllIllllIIIIlIIlIIIlI;
        if (z.lIllIIIIIllIllI(this.p.shadowVeil() ? 1 : 0)) {
            return lIIllIlIlIIIl[0];
        }
        if (z.lIllIIIIIllIlll(llllllllllllllIllllIIIIlIIlIIIlI.o.j() ? 1 : 0)) {
            return lIIllIlIlIIIl[0];
        }
        ...
        NPC llllllllllllllIllllIIIIlIIlIIIIl = llllllllllllllIllllIIIIlIIlIIIlI.a(llllllllllllllIllllIIIIlIIlIIIlI.p.pickpocketTarget());
        if (z.lIllIIIIIlllIIl(llllllllllllllIllllIIIIlIIlIIIIl)) {
            return lIIllIlIlIIIl[0];
        }
