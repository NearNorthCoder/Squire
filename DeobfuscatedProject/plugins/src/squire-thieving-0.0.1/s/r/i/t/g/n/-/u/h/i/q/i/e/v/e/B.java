...
extends a {
    ...
    private static void lIllIIlIIlIIlIl() {
        ...
        B.lIIlllIIIIlII[B.lIIlllIIIIlIl[0]] = B.lIllIIlIIlIIIlI("vbY12MJdkMg=", "vQrQe");
        B.lIIlllIIIIlII[B.lIIlllIIIIlIl[1]] = B.lIllIIlIIlIIIll("DAw1", "ImArd");
        B.lIIlllIIIIlII[B.lIIlllIIIIlIl[2]] = B.lIllIIlIIlIIIlI("w438ekuZI7o=", "IMJRO");
        B.lIIlllIIIIlII[B.lIIlllIIIIlIl[4]] = B.lIllIIlIIlIIIlI("ugZrvtgcxgE=", "WSLgv");
        B.lIIlllIIIIlII[B.lIIlllIIIIlIl[5]] = B.lIllIIlIIlIIlII("oSquF+WXEtM=", "ZYxwh");
        B.lIIlllIIIIlII[B.lIIlllIIIIlIl[6]] = B.lIllIIlIIlIIIll("NwkE", "rhpyF");
        B.lIIlllIIIIlII[B.lIIlllIIIIlIl[7]] = B.lIllIIlIIlIIlII("g8gpiVYM2/4=", "whvgt");
        B.lIIlllIIIIlII[B.lIIlllIIIIlIl[8]] = B.lIllIIlIIlIIIlI("KktZkS4zXsI=", "vXRIm");
        B.lIIlllIIIIlII[B.lIIlllIIIIlIl[9]] = B.lIllIIlIIlIIIll("Hgg2HQ==", "QxSsx");
    }
    ...
    private static void lIllIIlIIlIIllI() {
        ...
        B.lIIlllIIIIlIl[0] = (0xAB ^ 0x86 ^ " ".length()) & (0xC ^ 0x67 ^ (0x3F ^ 0x78) ^ -" ".length());
        B.lIIlllIIIIlIl[1] = " ".length();
        B.lIIlllIIIIlIl[2] = "  ".length();
        B.lIIlllIIIIlIl[3] = 0xFFFFF697 & 0x5BFF;
        B.lIIlllIIIIlIl[4] = "   ".length();
    ...
    public boolean l() {
        ...
        if (B.lIllIIlIIlIIlll(Inventory.contains(item -> {
            ...
            if ("   ".length() <= ((41 + 3 - -51 + 71 ^ 60 + 74 - 46 + 91) & (101 + 38 - 120 + 148 ^ 72 + 147 - 159 + 118 ^ -" ".length()))) {
                return ((0x27 ^ 0x73 ^ (0x36 ^ 0x26)) & (0x43 ^ 0x6D ^ (0xA9 ^ 0xC3) ^ -" ".length())) != 0;
            }
        } else {
        ...
        if (!B.lIllIIlIIlIlIll((Object)llllllllllllllIlllIllIlIlIIIIlIl.p.pickpocketTarget(), (Object)f.VYRE) || B.lIllIIlIIlIllII((Object)llllllllllllllIlllIllIlIlIIIIlIl.p.pickpocketTarget(), (Object)f.ELF)) {
            n2 = lIIlllIIIIlIl[1];
            "".length();
            if (((173 + 22 - 24 + 20 ^ 30 + 66 - -29 + 38) & (0x27 ^ 0x55 ^ (0x53 ^ 0x3D) ^ -" ".length())) == (22 + 105 - 102 + 109 ^ 90 + 84 - 61 + 17)) {
                return ((0x3F ^ 0x22 ^ (0x56 ^ 0x5A)) & (0x5D ^ 0x24 ^ (0x55 ^ 0x3D) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIIlllIIIIlIl[0];
        }
            ...
            if (B.lIllIIlIIlIIlll(llllllllllllllIlllIllIlIlIIIIIll)) {
                ...
                Inventory.getFirst(item -> {
                    ...
                    block3: {
                        ...
                        "".length();
                        if (null == null) return n2 != 0;
                        return ((0x69 ^ 0x61 ^ (0xFC ^ 0xA3)) & (119 + 175 - 69 + 11 ^ 102 + 161 - 143 + 67 ^ -" ".length())) != 0;
                    }
                    n2 = lIIlllIIIIlIl[0];
                    return n2 != 0;
