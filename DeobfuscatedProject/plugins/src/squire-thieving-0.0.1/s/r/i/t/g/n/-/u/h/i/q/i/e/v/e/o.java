...
extends Task {
    ...
    private static void lIllIIlIIIIllll() {
        ...
        o.lIIlllIIIIIII[0] = (0x13 ^ 0x3A ^ (0x6C ^ 3)) & (3 ^ 0x73 ^ (0x69 ^ 0x5F) ^ -" ".length());
        o.lIIlllIIIIIII[1] = -" ".length();
        o.lIIlllIIIIIII[2] = " ".length();
        o.lIIlllIIIIIII[3] = "  ".length();
        o.lIIlllIIIIIII[4] = "   ".length();
    ...
    private static void lIllIIlIIIIlllI() {
        ...
        o.lIIllIlllllll[o.lIIlllIIIIIII[0]] = o.lIllIIlIIIIlIll("Dx8cIQ==", "CjnDd");
        o.lIIllIlllllll[o.lIIlllIIIIIII[2]] = o.lIllIIlIIIIlIll("JQoXGj4VRAIXchIRHxQ2UBQXDDo=", "pdvxR");
        o.lIIllIlllllll[o.lIIlllIIIIIII[3]] = o.lIllIIlIIIIlIll("FDc0IxI+LA==", "WBFWs");
        o.lIIllIlllllll[o.lIIlllIIIIIII[4]] = o.lIllIIlIIIIlIll("BSM3BQ==", "JSRkY");
        o.lIIllIlllllll[o.lIIlllIIIIIII[5]] = o.lIllIIlIIIIllII("yzESLEBsskw=", "ndeQM");
        o.lIIllIlllllll[o.lIIlllIIIIIII[8]] = o.lIllIIlIIIIllII("1m7HADdrxj6EXlM7n11Dvx3Z/PnuavKw", "xIMrT");
        o.lIIllIlllllll[o.lIIlllIIIIIII[10]] = o.lIllIIlIIIIllIl("GOHKA5w+sBw=", "wUllr");
        o.lIIllIlllllll[o.lIIlllIIIIIII[11]] = o.lIllIIlIIIIlIll("CiAhPy0=", "ILNLH");
        o.lIIllIlllllll[o.lIIlllIIIIIII[12]] = o.lIllIIlIIIIlIll("BC4GMC8=", "GBiCJ");
        o.lIIllIlllllll[o.lIIlllIIIIIII[13]] = o.lIllIIlIIIIllII("oz45mTOhXnE=", "VVrmF");
    }
    ...
    public boolean run() {
        ...
        block37: {
            ...
            List llllllllllllllIlllIllIllIIIlIIII = NPCs.getAll(nPC -> {
                ...
                if (o.lIllIIlIIIlIlII(nPC) && o.lIllIIlIIIlIIIl(nPC.getInteracting(), llllllllllllllIlllIllIllIIIlIIlI)) {
                    n2 = lIIlllIIIIIII[2];
                    "".length();
                    if ("   ".length() >= (0xCA ^ 0x9F ^ (0x14 ^ 0x45))) {
                        return ((44 + 127 - 39 + 7 ^ 145 + 52 - 80 + 75) & (0x64 ^ 0x42 ^ (0xC1 ^ 0xAC) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIIlllIIIIIII[0];
                }
            ...
            if (o.lIllIIlIIIlIIlI(llllllllllllllIlllIllIllIIIlIlIl.U.isEmpty() ? 1 : 0) && o.lIllIIlIIIlIlIl(llllllllllllllIlllIllIllIIIlIlIl.V)) {
                ...
                if (!o.lIllIIlIIIlIllI(llllllllllllllIlllIllIllIIIlIIIl.getWorldLocation().equals((Object)llllllllllllllIlllIllIllIIIlIlII.r()) ? 1 : 0) || !o.lIllIIlIIIlIllI(llllllllllllllIlllIllIllIIIlIIlI.getWorldLocation().equals((Object)llllllllllllllIlllIllIllIIIlIlII.r()) ? 1 : 0) || o.lIllIIlIIIlIIlI(llllllllllllllIlllIllIllIIIlIlII.p().contains((Locatable)llllllllllllllIlllIllIllIIIlIIlI) ? 1 : 0)) {
                    n2 = lIIlllIIIIIII[2];
                    "".length();
                    if ((0x40 ^ 0x6B ^ (0x99 ^ 0xB6)) <= " ".length()) {
                        return ((0xDB ^ 0xB0 ^ (0x56 ^ 0x23)) & (0x33 ^ 0x63 ^ (0x22 ^ 0x6C) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIIlllIIIIIII[0];
                }
                ...
                if (o.lIllIIlIIIlIIlI(llllllllllllllIlllIllIllIIIIlllI)) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((0x48 ^ 0x73 ^ (0x1C ^ 0x29)) & (42 + 134 - 56 + 29 ^ 54 + 134 - 169 + 136 ^ -" ".length())) != 0;
                    }
                } else {
            ...
            if (((0x1A ^ 5 ^ (0x58 ^ 0x65)) & (0x57 ^ 0x37 ^ (0xED ^ 0xAF) ^ -" ".length())) != 0) {
                return ((0x3C ^ 0x21 ^ (0x52 ^ 0x12)) & (0x13 ^ 0x52 ^ (0x9B ^ 0x87) ^ -" ".length())) != 0;
            }
            llllllllllllllIlllIllIllIIIlIlIl.V = null;
            return lIIlllIIIIIII[0];
        }
        ...
        while (o.lIllIIlIIIllIII(llllllllllllllIlllIllIllIIIIlIll2, llllllllllllllIlllIllIllIIIlIlIl.U.size())) {
            ...
            if (!o.lIllIIlIIIlIIlI(llllllllllllllIlllIllIllIIIIllIl += Math.abs(llllllllllllllIlllIllIllIIIIlllI.getX() - llllllllllllllIlllIllIllIIIIlIIl.getX())) || o.lIllIIlIIIlIllI(llllllllllllllIlllIllIllIIIIllII += Math.abs(llllllllllllllIlllIllIllIIIIlllI.getY() - llllllllllllllIlllIllIllIIIIlIIl.getY()))) {
                ...
                "".length();
                if (" ".length() >= 0) break;
                return ((" ".length() ^ (0xF ^ 0x4B)) & (0x3B ^ 0x1E ^ (0xCC ^ 0xAC) ^ -" ".length())) != 0;
            }
