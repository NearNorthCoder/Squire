...
extends Task {
    ...
    private static void lIllIIlIIIllllI() {
        ...
        y.lIIlllIIIIIll[0] = (0x53 ^ 0x72 ^ (0xAB ^ 0x85)) & (5 + 119 - 12 + 35 ^ 68 + 16 - -27 + 45 ^ -" ".length());
        y.lIIlllIIIIIll[1] = " ".length();
        y.lIIlllIIIIIll[2] = -(0xFFFFFD3D & 0x2FEB) & (0xFFFFFFFF & 0x7FBF);
        y.lIIlllIIIIIll[3] = 0x99 ^ 0x91;
        y.lIIlllIIIIIll[4] = "  ".length();
    }
    ...
    private static void lIllIIlIIIlllIl() {
        ...
        y.lIIlllIIIIIlI[y.lIIlllIIIIIll[0]] = y.lIllIIlIIIlllII("+d3CGbwkwNY=", "nSFvK");
    }
    ...
    public boolean run() {
        y llllllllllllllIlllIllIlIlIIlllIl;
        if (y.lIllIIlIIIlllll(this.am.dodgyNecklace() ? 1 : 0)) {
            return lIIlllIIIIIll[0];
        }
        if (y.lIllIIlIIlIIIII(llllllllllllllIlllIllIlIlIIlllIl.am.dodgyNecklaceAmount())) {
            return lIIlllIIIIIll[0];
        }
    ...
    private static String lIllIIlIIIlllII(String llllllllllllllIlllIllIlIlIIlIlIl, String llllllllllllllIlllIllIlIlIIlIlII) {
        try {
            SecretKeySpec llllllllllllllIlllIllIlIlIIllIII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllIlllIllIlIlIIlIlII.getBytes(StandardCharsets.UTF_8)), lIIlllIIIIIll[3]), "DES");
            Cipher llllllllllllllIlllIllIlIlIIlIlll = Cipher.getInstance("DES");
            llllllllllllllIlllIllIlIlIIlIlll.init(lIIlllIIIIIll[4], llllllllllllllIlllIllIlIlIIllIII);
            return new String(llllllllllllllIlllIllIlIlIIlIlll.doFinal(Base64.getDecoder().decode(llllllllllllllIlllIllIlIlIIlIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
