...
extends OverlayPanel {
    ...
    private static void lIIlIIIIllIIlll() {
        ...
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[2]] = HydraOverlayPanel.lIIlIIIIlIIIlII("wkHonZxQcZQE0VJbegbMrA==", "aDykG");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[3]] = HydraOverlayPanel.lIIlIIIIllIIlIl("4lsXgHtI8N4DyGhI1zaoPQ==", "pIFkF");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[4]] = HydraOverlayPanel.lIIlIIIIllIIlIl("rW2UNshWziI=", "qPPAj");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[5]] = HydraOverlayPanel.lIIlIIIIllIIllI("CC4HITAjYhwqMiRiCywkITY=", "OBhCQ");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[6]] = HydraOverlayPanel.lIIlIIIIllIIllI("CBczIARsBjs3Bw==", "LrRTl");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[7]] = HydraOverlayPanel.lIIlIIIIlIIIlII("5f/1/rOMOP7jEiyG5MwSjyfq5KCinDvv", "MirYm");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[8]] = HydraOverlayPanel.lIIlIIIIllIIlIl("XFCoJ3l5OVRB5qQSJfm7cQ==", "gJhAr");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[9]] = HydraOverlayPanel.lIIlIIIIlIIIlII("0LoGXGCQhMmcAy8K53r7Jw==", "kGpZq");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[10]] = HydraOverlayPanel.lIIlIIIIllIIlIl("jw+O5pqa37oqFdnc9JHgCQ==", "oYVeF");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[11]] = HydraOverlayPanel.lIIlIIIIllIIllI("Lz0qAipHBToEKgQvbjMkEio6", "gDNpK");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[12]] = HydraOverlayPanel.lIIlIIIIlIIIlII("b7TLaWMZjktcYCoPDlnfkg==", "Sbnxq");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[13]] = HydraOverlayPanel.lIIlIIIIllIIllI("PDAJICNUHQwgJRE9", "tImRB");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[14]] = HydraOverlayPanel.lIIlIIIIllIIllI("HQYsJzg9Dg==", "SiXOQ");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[15]] = HydraOverlayPanel.lIIlIIIIllIIlIl("VYGkvcRFDgo=", "SftQa");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[16]] = HydraOverlayPanel.lIIlIIIIllIIllI("MTAlNStZBC4xIxcu", "yIAGJ");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[17]] = HydraOverlayPanel.lIIlIIIIllIIlIl("EKdDhDRdtgc=", "nxRni");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[18]] = HydraOverlayPanel.lIIlIIIIllIIlIl("Gt+5SFVWYB0=", "sbTbv");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[19]] = HydraOverlayPanel.lIIlIIIIllIIlIl("fcRn9cudyM8=", "CcJAd");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[20]] = HydraOverlayPanel.lIIlIIIIlIIIlII("XDYG69g0oTM=", "SsWap");
        HydraOverlayPanel.llllIlIIIllI[HydraOverlayPanel.llllIlIlIIIl[21]] = HydraOverlayPanel.lIIlIIIIllIIllI("GgM=", "TlWiY");
    }
    ...
    private static String lIIlIIIIllIIllI(String lllllllllllllllIIlIlIIlIIIIIlIIl, String lllllllllllllllIIlIlIIlIIIIIllIl) {
        ...
        while (HydraOverlayPanel.lIIlIIIIllIlllI(lllllllllllllllIIlIlIIlIIIIIIIlI, lllllllllllllllIIlIlIIlIIIIIIIll)) {
            ...
            "".length();
            if (((105 + 175 - 137 + 56 ^ 26 + 27 - -85 + 9) & (0x31 ^ 0x5B ^ (0x54 ^ 0x6A) ^ -" ".length())) == ((0xF4 ^ 0xBF ^ (0x6E ^ 0x10)) & (0x63 ^ 0x22 ^ (0x3D ^ 0x49) ^ -" ".length()))) continue;
            return null;
        }
    ...
    private static void lIIlIIIIllIlIII() {
        ...
        HydraOverlayPanel.llllIlIlIIIl[2] = (1 ^ 4 ^ (0x50 ^ 0x16)) & (2 ^ 0x19 ^ (0x56 ^ 0xE) ^ -" ".length());
        HydraOverlayPanel.llllIlIlIIIl[3] = " ".length();
        HydraOverlayPanel.llllIlIlIIIl[4] = "  ".length();
        HydraOverlayPanel.llllIlIlIIIl[5] = "   ".length();
