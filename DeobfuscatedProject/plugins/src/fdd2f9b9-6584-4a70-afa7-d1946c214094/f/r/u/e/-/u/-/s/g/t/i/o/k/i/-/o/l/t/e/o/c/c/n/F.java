...
implements G {
    ...
    private static void lllIlIIllllI() {
        ...
        F.lIIIlIIlll[0] = (0xE7 ^ 0xBF ^ (0xC8 ^ 0xB8)) & (8 + 235 - 54 + 50 ^ 124 + 154 - 191 + 112 ^ -" ".length());
        F.lIIIlIIlll[1] = " ".length();
        F.lIIIlIIlll[2] = 0x66 ^ 0x38 ^ (0x43 ^ 0x5B);
        F.lIIIlIIlll[3] = "  ".length();
        F.lIIIlIIlll[4] = 0xFFFFB1FF & 0x4F7B;
        F.lIIIlIIlll[5] = "   ".length();
        ...
        F.lIIIlIIlll[55] = 0x4E ^ 0x6F ^ "  ".length();
    ...
    private static void lllIlIIlllIl() {
        ...
        F.lIIIlIIlII[F.lIIIlIIlll[0]] = F.lllIlIIIlllI("Ej8IIAw3ahg9Bz05", "PJqIb");
        F.lIIIlIIlII[F.lIIIlIIlll[1]] = F.lllIlIIIllll("pYHql/OywHORQsGqezMrqQxYSAJQ3WJD9xPD68WUSQxWZwmMsuDKwRRT/9WPWOGS", "obtih");
        F.lIIIlIIlII[F.lIIIlIIlll[3]] = F.lllIlIIlIIIl("Q7IcFNC4Veo=", "JlNBX");
        F.lIIIlIIlII[F.lIIIlIIlll[5]] = F.lllIlIIlIIIl("9naQ+XW1IbM=", "HwUrM");
        F.lIIIlIIlII[F.lIIIlIIlll[6]] = F.lllIlIIIlllI("IzADbRsCcRcsAQY=", "mQuMo");
        F.lIIIlIIlII[F.lIIIlIIlll[7]] = F.lllIlIIIllll("tEBwyT32WtLGvDA/aXrHn0RstUVZ26M5", "Jquxo");
        F.lIIIlIIlII[F.lIIIlIIlll[9]] = F.lllIlIIlIIIl("NkKF1kJBn5j0ri06uLeisiF/JCit0evOgrC2SfvtTsiAFL8KQQ9ZV6mFYEXyDXuzyHOVzfhSn78=", "LIfNJ");
        F.lIIIlIIlII[F.lIIIlIIlll[17]] = F.lllIlIIIlllI("HxUedQM+VBshFiMA", "QthUw");
        F.lIIIlIIlII[F.lIIIlIIlll[18]] = F.lllIlIIIllll("YFNNHLw2ZXKiuEQ4UktxPQ==", "UCimW");
        F.lIIIlIIlII[F.lIIIlIIlll[19]] = F.lllIlIIlIIIl("wIreZSKPhMM=", "Ubona");
        F.lIIIlIIlII[F.lIIIlIIlll[15]] = F.lllIlIIIlllI("EComOg==", "FOIIv");
        F.lIIIlIIlII[F.lIIIlIIlll[20]] = F.lllIlIIIlllI("NjECCRsXMQJIGwExCAQE", "bCghh");
        F.lIIIlIIlII[F.lIIIlIIlll[21]] = F.lllIlIIIlllI("EQ0jNQ==", "FhBGA");
        F.lIIIlIIlII[F.lIIIlIIlll[22]] = F.lllIlIIlIIIl("rfgvEncPyhA=", "tohdJ");
        F.lIIIlIIlII[F.lIIIlIIlll[23]] = F.lllIlIIIlllI("PA4CaRsdTxAgCFJe", "rotIo");
        F.lIIIlIIlII[F.lIIIlIIlll[24]] = F.lllIlIIlIIIl("dtvFgfEEA18=", "omBsE");
        F.lIIIlIIlII[F.lIIIlIIlll[25]] = F.lllIlIIIllll("KknCWSs98NQ=", "zNXDP");
        F.lIIIlIIlII[F.lIIIlIIlll[26]] = F.lllIlIIIllll("063pSAs9Z/0E8UydVVjWww==", "ZlVsR");
        F.lIIIlIIlII[F.lIIIlIIlll[27]] = F.lllIlIIlIIIl("SIescxqx0D0=", "ooROu");
        F.lIIIlIIlII[F.lIIIlIIlll[28]] = F.lllIlIIlIIIl("3W0aoue70Ao=", "TeLWM");
        F.lIIIlIIlII[F.lIIIlIIlll[29]] = F.lllIlIIlIIIl("uFwX6uBs/qoj39ZE6HnU/A==", "hpNob");
        F.lIIIlIIlII[F.lIIIlIIlll[30]] = F.lllIlIIIllll("SHknEEc+2GY=", "PdlKQ");
        F.lIIIlIIlII[F.lIIIlIIlll[31]] = F.lllIlIIIlllI("LCc/", "hNXrg");
        F.lIIIlIIlII[F.lIIIlIIlll[32]] = F.lllIlIIIllll("sv3KF+aiRsxg4V84MOI3+Q==", "wPkZp");
        F.lIIIlIIlII[F.lIIIlIIlll[33]] = F.lllIlIIlIIIl("Ai+6JnzV4gI=", "pnKEv");
        F.lIIIlIIlII[F.lIIIlIIlll[34]] = F.lllIlIIlIIIl("h9Mk0Lpg4To=", "kYnJS");
        F.lIIIlIIlII[F.lIIIlIIlll[35]] = F.lllIlIIIllll("WP4KmgP7vO+XwgQv9hJEN57FT7Iv+BTP", "rFxaG");
        F.lIIIlIIlII[F.lIIIlIIlll[36]] = F.lllIlIIIllll("lxxuKUczTPp6V+8nlAcpMw==", "EtzZm");
        F.lIIIlIIlII[F.lIIIlIIlll[37]] = F.lllIlIIIlllI("FxIGHg==", "AwimO");
        F.lIIIlIIlII[F.lIIIlIIlll[40]] = F.lllIlIIIlllI("KB8TIw0UDVEtBRca", "zjqAd");
        F.lIIIlIIlII[F.lIIIlIIlll[41]] = F.lllIlIIIlllI("HSMt", "OVOBn");
        F.lIIIlIIlII[F.lIIIlIIlll[42]] = F.lllIlIIIlllI("OisfABodJx0CWRoiEhwcGw==", "iNsey");
        F.lIIIlIIlII[F.lIIIlIIlll[43]] = F.lllIlIIIlllI("IyU4PAsC", "pIYEn");
        F.lIIIlIIlII[F.lIIIlIIlll[44]] = F.lllIlIIlIIIl("s7CzWCiqSAI=", "qkkTj");
        F.lIIIlIIlII[F.lIIIlIIlll[45]] = F.lllIlIIlIIIl("Eq8cqvpBPwg=", "JxfHu");
        F.lIIIlIIlII[F.lIIIlIIlll[55]] = F.lllIlIIlIIIl("gOFS1tKSsekcHHJq/P/cbadVxlxH3yv1", "xXqHX");
        F.lIIIlIIlII[F.lIIIlIIlll[56]] = F.lllIlIIIlllI("MwskLUMuBGo9BiAOPiJDaQ==", "AbJJc");
        F.lIIIlIIlII[F.lIIIlIIlll[57]] = F.lllIlIIlIIIl("r5JXSp0/0as=", "xlMPq");
        F.lIIIlIIlII[F.lIIIlIIlll[58]] = F.lllIlIIlIIIl("nfIe7LI7gC4=", "SECgM");
        F.lIIIlIIlII[F.lIIIlIIlll[59]] = F.lllIlIIIllll("lJOz5pw8S34=", "hKkYY");
        F.lIIIlIIlII[F.lIIIlIIlll[53]] = F.lllIlIIIlllI("IzoKAAg=", "DVerq");
        F.lIIIlIIlII[F.lIIIlIIlll[60]] = F.lllIlIIIlllI("MRk2Oyk=", "VuYIP");
        F.lIIIlIIlII[F.lIIIlIIlll[61]] = F.lllIlIIlIIIl("fmhtbRQzOiE=", "dxydn");
        F.lIIIlIIlII[F.lIIIlIIlll[62]] = F.lllIlIIIllll("kn5ItDVIG+vxRw76WDQkbH303lomYFZ5jqMeVQLerP8=", "FXGSs");
        F.lIIIlIIlII[F.lIIIlIIlll[63]] = F.lllIlIIlIIIl("GD8B1hHWGRsRmxU1qEXSBonIFYkFGGotIkn2LntA/GjnPE9iHsgq/w==", "hRbMI");
        F.lIIIlIIlII[F.lIIIlIIlll[64]] = F.lllIlIIIlllI("CCoFMgMrZRkwByE2VywNMDdXPQcpNVY=", "EEwUb");
        F.lIIIlIIlII[F.lIIIlIIlll[65]] = F.lllIlIIlIIIl("45mUwLhvxgA=", "SiuZI");
        F.lIIIlIIlII[F.lIIIlIIlll[66]] = F.lllIlIIIllll("w5XYz8KN+ud7Q7dGrt8EL+tSpxlpgQ8BCgMlfCUUSIY=", "ZyOpb");
        F.lIIIlIIlII[F.lIIIlIIlll[67]] = F.lllIlIIIlllI("CjphUiIgJW0fK2U5KB4+ZSUlFyBr", "EQMrN");
        F.lIIIlIIlII[F.lIIIlIIlll[68]] = F.lllIlIIIlllI("CgwkOwM+TRE2FCkOO3MVKQMkcwspTSQ8RjgMPDhGOAJwKgk5Qw==", "LmPSf");
        F.lIIIlIIlII[F.lIIIlIIlll[69]] = F.lllIlIIIlllI("HzNxBG4wOSJXL3cxPhg9I3Y+Fjs5Ij8ZKXc+PwRuMCQ3ASsuNyQTYA==", "WVVwN");
        F.lIIIlIIlII[F.lIIIlIIlll[70]] = F.lllIlIIIllll("dXfPyr4M96eTURkd57JpJFBQNrQzxEaayWcjniqammGeiFFWXWJ4jA==", "fYaPr");
        F.lIIIlIIlII[F.lIIIlIIlll[71]] = F.lllIlIIIlllI("ABkmMHY=", "SlTUX");
        F.lIIIlIIlII[F.lIIIlIIlll[72]] = F.lllIlIIlIIIl("512fEI3tqzP3q6ZtgC2Wko2tBhdv8T6MM0z3ukC9MyojDcwF9K3QZQ==", "wibrZ");
        F.lIIIlIIlII[F.lIIIlIIlll[73]] = F.lllIlIIlIIIl("GhbkcNKOcyrAJ+hSCsaWBA==", "nSEEQ");
        F.lIIIlIIlII[F.lIIIlIIlll[48]] = F.lllIlIIIlllI("BwUtdjQuBHofdycPNiZo", "OjZVW");
        F.lIIIlIIlII[F.lIIIlIIlll[74]] = F.lllIlIIIllll("sE9rNf4hdAVrEdNssAWYGjyJxj0yyveFsqp6jisG3/8=", "GxYYk");
        F.lIIIlIIlII[F.lIIIlIIlll[75]] = F.lllIlIIIlllI("LxIqbSFMGyEhGFM=", "lsDMh");
    }
    ...
    public int T() {
        ...
        if (null != null) {
            return (0x3A ^ 0x5A ^ (0x91 ^ 0xAE)) & (183 + 10 - 115 + 154 ^ 30 + 96 - 96 + 153 ^ -" ".length());
        }
    ...
    public boolean V() {
        ...
        if (F.lllIlIlIlIlI(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()), lIIIlIIlll[18])) {
            ...
            if (F.lllIlIlIIIll(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                return ((35 + 33 - -74 + 49 ^ 136 + 33 - 51 + 34) & (126 + 25 - 10 + 42 ^ 103 + 14 - 40 + 67 ^ -" ".length())) != 0;
            }
        }
        n2 = lIIIlIIlll[0];
        return n2 != 0;
    ...
    public static void cm() {
        ...
        if (F.lllIlIlIIIll(bt ? 1 : 0)) {
            block49: {
                ...
                if (F.lllIlIlIIIll(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId())) && F.lllIlIlIIIIl(F.ab() ? 1 : 0)) {
                    ...
                    if (F.lllIlIlIlIII(Players.getLocal().getWorldLocation().distanceTo(iq), lIIIlIIlll[3])) {
                        ...
                        f.r.u.e.-.u.-.s.g.t.i.o.k.i.-.o.l.t.e.o.c.c.n.g.a(lIIIlIIlII[lIIIlIIlll[15]], ip, lIIIlIIlll[1]);
                    }
                }
                if (F.lllIlIlIlIIl(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()), lIIIlIIlll[1])) {
                    ...
                    if (F.lllIlIlIIIll(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                        f.r.u.e.-.u.-.s.g.t.i.o.k.i.-.o.l.t.e.o.c.c.n.g.a(ip);
                    }
                }
                ...
                if (F.lllIlIlIlIIl(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()), lIIIlIIlll[9])) {
                    ...
                    if (F.lllIlIlIlIII(Players.getLocal().getWorldLocation().distanceTo(iv), lIIIlIIlll[5])) {
                        ...
                        f.r.u.e.-.u.-.s.g.t.i.o.k.i.-.o.l.t.e.o.c.c.n.g.a(lIIIlIIlII[lIIIlIIlll[37]], ip);
                    }
                }
            ...
            f.r.u.e.-.u.-.s.g.t.i.o.k.i.-.o.l.t.e.o.c.c.n.g.a(new String[lIIIlIIlll[0]]);
        }
    }
}
