...
implements G {
    ...
    private static void lllIllIIIIIl() {
        ...
        B.lIIIlIllII[1] = " ".length();
        B.lIIIlIllII[2] = 0x99 ^ 0x9D;
        B.lIIIlIllII[3] = 77 + 52 - 0 + 45 ^ 34 + 117 - 23 + 51;
        B.lIIIlIllII[4] = "  ".length();
        B.lIIIlIllII[5] = "   ".length();
    ...
    private static void lllIllIIIIII() {
        ...
        B.lIIIlIlIll[B.lIIIlIllII[0]] = B.lllIlIllllIl("Qd3vPzfoWF2v0RHjX4UkPg==", "GBfqi");
        B.lIIIlIlIll[B.lIIIlIllII[1]] = B.lllIlIlllllI("JQYEIzYLCg5qJxYWAyQiQwYeLygQQ0o5MgobCSIsDQhKKCQABEo+KkMeHy82Fw==", "cojJE");
        B.lIIIlIlIll[B.lIIIlIllII[4]] = B.lllIlIllllIl("rLbkVCBeZiKHUtFfSnZDOg==", "vlTix");
        B.lIIIlIlIll[B.lIIIlIllII[5]] = B.lllIlIllllll("ksSuOOmNB1JhD+XmrG05WTbr1GMv6cKV", "ZfFCH");
        B.lIIIlIlIll[B.lIIIlIllII[2]] = B.lllIlIllllll("OoFXn3BMQ/BqqR269eA+y4qrt9YgHjg6t1wo1Cv61is9fZkEXxZi6OEYyn7fb/zbqjBD73O0e74=", "IHGGN");
        B.lIIIlIlIll[B.lIIIlIllII[11]] = B.lllIlIlllllI("HC4CUyY9bwcHMyA7", "ROtsR");
        B.lIIIlIlIll[B.lIIIlIllII[12]] = B.lllIlIllllIl("3khDQVuN/O7YCS9Bf/CHew==", "kfbSX");
        B.lIIIlIlIll[B.lIIIlIllII[13]] = B.lllIlIllllll("TvwQvEAdYV4=", "BequY");
        B.lIIIlIlIll[B.lIIIlIllII[22]] = B.lllIlIllllll("rPn8wLplQw+VYchmaJgee89wjbMWqCHH", "mJkHi");
        B.lIIIlIlIll[B.lIIIlIllII[23]] = B.lllIlIllllll("gYpg5RuRwS8WmkWlHLGGoufrdEXSXHBp", "qjqbP");
        B.lIIIlIlIll[B.lIIIlIllII[14]] = B.lllIlIlllllI("EjY9Si0+InMHNToycwcxcTZzCTU6Mmw=", "QWSjT");
        B.lIIIlIlIll[B.lIIIlIllII[26]] = B.lllIlIllllll("6FwJSjOuiqnkcZjgQhlEKgsJaUAqYxyqPtAxQcJAL29IuUJuVVH+NvO1BNy42qXQ", "hmcuV");
        B.lIIIlIlIll[B.lIIIlIllII[27]] = B.lllIlIlllllI("FSgNByU4JwBeZB1rEhwrI2sOGiEmLlkGK3QtEBwgdD8RGzd0OA0HIjJl", "TKyrD");
        B.lIIIlIlIll[B.lIIIlIllII[28]] = B.lllIlIllllll("Taw2UHCpP24=", "Jaoco");
        B.lIIIlIlIll[B.lIIIlIllII[29]] = B.lllIlIlllllI("PSUTEWgZbQUXIAQqTQ==", "jMreO");
    }
        ...
        if (B.lllIllIIIlll(Inventory.getCount((int[])nArray))) {
            ...
            if (B.lllIllIIIlll(Inventory.getCount((int[])nArray2))) {
                ...
                if (B.lllIllIIIlll(Inventory.getCount((int[])nArray3))) {
                    ...
                    return ((0x46 ^ 0x75 ^ (0x70 ^ 0x21)) & (0x41 ^ 0x22 ^ " ".length() ^ -" ".length())) != 0;
                }
            }
        }
        n2 = lIIIlIllII[0];
    ...
    public int T() {
        ...
        if (null != null) {
            return (0xDD ^ 0xB5 ^ (6 ^ 0x5C)) & (0xDB ^ 0xA0 ^ (0x7D ^ 0x34) ^ -" ".length());
        }
