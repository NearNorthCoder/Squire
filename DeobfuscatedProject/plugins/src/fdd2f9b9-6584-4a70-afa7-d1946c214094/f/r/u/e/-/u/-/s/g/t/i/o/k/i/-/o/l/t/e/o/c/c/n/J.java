...
implements G {
    ...
    private static void lIIIIIlIllllI() {
        ...
        J.lIIllIllII[J.lIIllIllll[0]] = J.lIIIIIlIlIlll("5ndZ8aj4MukkQWTgzhvQjQ==", "CtJRf");
        J.lIIllIllII[J.lIIllIllll[1]] = J.lIIIIIlIllIII("7kz4FpunzOCusM9lcex2XtWryWIr1Pu9mUcZeeJJ69vaQx6eAE9fVNF01q/8qzpCtyYOE369rkw=", "xVNVu");
        J.lIIllIllII[J.lIIllIllll[3]] = J.lIIIIIlIlIlll("Q9i1FH6ovuSn3mxksaeCQND61ap3jy4b", "TJuox");
        J.lIIllIllII[J.lIIllIllll[10]] = J.lIIIIIlIllIII("Xx2w+8ifqa4CoJpzWA6vNv0mZlkeDD6N", "IFQeV");
        J.lIIllIllII[J.lIIllIllll[17]] = J.lIIIIIlIllIIl("NARaKhgGQRciGRAIFCxKEhQfOB5DEg87Gg8IHzhGQxINIh4ACRMlDUMVFWsoNjgzBS0=", "cazKj");
        J.lIIllIllII[J.lIIllIllll[19]] = J.lIIIIIlIlIlll("xlHDOS88Dqo=", "aIBYc");
        J.lIIllIllII[J.lIIllIllll[21]] = J.lIIIIIlIllIII("GVbk9mCMC74=", "dApHL");
        J.lIIllIllII[J.lIIllIllll[23]] = J.lIIIIIlIlIlll("dPWIfPIWSe0=", "kXcHO");
        J.lIIllIllII[J.lIIllIllll[25]] = J.lIIIIIlIllIII("6gQ6sV0Hdt4=", "bWCxI");
        J.lIIllIllII[J.lIIllIllll[27]] = J.lIIIIIlIllIII("l6aAAoaH7B0=", "YHdgv");
        J.lIIllIllII[J.lIIllIllll[12]] = J.lIIIIIlIllIII("F6AVb3AsTQ13u08Hp/b/AdLtQrMSrTbs", "dpkXs");
        J.lIIllIllII[J.lIIllIllll[49]] = J.lIIIIIlIlIlll("2Doe6jG9gGRfMhOHMvR7jw==", "BfJzS");
        J.lIIllIllII[J.lIIllIllll[63]] = J.lIIIIIlIlIlll("Zvuuaz30g/QgIzFgVwtdwQ==", "HFMeJ");
        J.lIIllIllII[J.lIIllIllll[64]] = J.lIIIIIlIllIIl("DRUJM2I7Fxc3PCk=", "ZteXO");
        J.lIIllIllII[J.lIIllIllll[53]] = J.lIIIIIlIlIlll("KoQ17g8ELe8KeMfepbzZDg==", "YzLRO");
        J.lIIllIllII[J.lIIllIllll[39]] = J.lIIIIIlIllIII("i67THZU+346tqoJZcYIfnQ==", "luvUu");
        J.lIIllIllII[J.lIIllIllll[65]] = J.lIIIIIlIllIIl("AC8cFC1uLAMcPQ==", "CCuyO");
        J.lIIllIllII[J.lIIllIllll[66]] = J.lIIIIIlIllIIl("EDYZPzM6NBdyMyE7HjE5", "SZpRQ");
        J.lIIllIllII[J.lIIllIllll[54]] = J.lIIIIIlIllIII("B6OAKkyr1MhsPtpm9QyzqQ==", "BuaWs");
        J.lIIllIllII[J.lIIllIllll[67]] = J.lIIIIIlIllIIl("MQknOjU=", "reNWW");
        J.lIIllIllII[J.lIIllIllll[40]] = J.lIIIIIlIllIII("HLB5FyHkg+11/b9ZRbuVIA==", "npOOG");
        J.lIIllIllII[J.lIIllIllll[79]] = J.lIIIIIlIllIIl("MB85Jw==", "zjTWV");
        J.lIIllIllII[J.lIIllIllll[181]] = J.lIIIIIlIllIIl("MD4pGyVzPikYMw==", "SLFhV");
        J.lIIllIllII[J.lIIllIllll[182]] = J.lIIIIIlIllIII("+U6slGUKKKQ=", "dCDMs");
        J.lIIllIllII[J.lIIllIllll[183]] = J.lIIIIIlIllIIl("DSw/OjspPnItMzd5YQ==", "GYRJR");
        J.lIIllIllII[J.lIIllIllll[184]] = J.lIIIIIlIlIlll("Ot3QsTorjmo=", "IpYcB");
        J.lIIllIllII[J.lIIllIllll[185]] = J.lIIIIIlIllIII("1eQPtq9zovQSsDOsvHB8cA==", "EfwdY");
        J.lIIllIllII[J.lIIllIllll[186]] = J.lIIIIIlIllIII("K2kwDPDIBxA=", "ZvuZC");
        J.lIIllIllII[J.lIIllIllll[187]] = J.lIIIIIlIlIlll("rjeLYOJwpcQ9+fXySs9FGA==", "PbRZI");
        J.lIIllIllII[J.lIIllIllll[188]] = J.lIIIIIlIlIlll("KsR86vSuNXE=", "DHtsV");
        J.lIIllIllII[J.lIIllIllll[194]] = J.lIIIIIlIlIlll("Ka6+/lXZmEtu3WcsaV6JtUtFD/0qNNp4", "WmSso");
        J.lIIllIllII[J.lIIllIllll[203]] = J.lIIIIIlIlIlll("JfwuQj5UgPE=", "UGiEN");
        J.lIIllIllII[J.lIIllIllll[204]] = J.lIIIIIlIllIII("t5KtRg9amGg=", "RYlLI");
        J.lIIllIllII[J.lIIllIllll[205]] = J.lIIIIIlIllIIl("KS8hCS4+Kw==", "YNRzO");
        J.lIIllIllII[J.lIIllIllll[206]] = J.lIIIIIlIlIlll("gP/1UjdVGiM=", "jnRGN");
        J.lIIllIllII[J.lIIllIllll[207]] = J.lIIIIIlIllIIl("ETkrOSYGPQ==", "aXXJG");
        J.lIIllIllII[J.lIIllIllll[208]] = J.lIIIIIlIlIlll("hS87dNRoPNw=", "fLmSn");
        J.lIIllIllII[J.lIIllIllll[211]] = J.lIIIIIlIllIII("xEgktEmn9So=", "yoeCr");
        J.lIIllIllII[J.lIIllIllll[213]] = J.lIIIIIlIllIII("9f8q1G6GpnE=", "aJrLJ");
        J.lIIllIllII[J.lIIllIllll[216]] = J.lIIIIIlIllIII("UPmwcfvbuAN5PcdclP0G3w==", "ikhmy");
        J.lIIllIllII[J.lIIllIllll[218]] = J.lIIIIIlIllIIl("FCwG", "SMvAg");
        J.lIIllIllII[J.lIIllIllll[221]] = J.lIIIIIlIllIIl("PRAG", "zqvGO");
        J.lIIllIllII[J.lIIllIllll[224]] = J.lIIIIIlIllIII("WeK8OSNOAJM=", "TJpra");
        J.lIIllIllII[J.lIIllIllll[226]] = J.lIIIIIlIlIlll("JXmQwLPxaxKn4PDShK+bDQ==", "tYguf");
        J.lIIllIllII[J.lIIllIllll[227]] = J.lIIIIIlIllIII("QdsL2eqFuLg=", "tZQFb");
        J.lIIllIllII[J.lIIllIllll[230]] = J.lIIIIIlIlIlll("fWOQyV34Ex0=", "GTucq");
        J.lIIllIllII[J.lIIllIllll[232]] = J.lIIIIIlIlIlll("FZh/L0I7lb8=", "kLMTO");
        J.lIIllIllII[J.lIIllIllll[233]] = J.lIIIIIlIlIlll("513u5ymNdD8=", "hxCVu");
    }
        ...
        if (J.lIIIIIlllllll(J.cu() ? 1 : 0)) {
            ...
            if (J.lIIIIIlllllIl(lllllllllllllllllllllIIllllIllIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIlIIIIIII(lllllllllllllllllllllIIllllIIllI = TileObjects.getNearest(tileObject -> {
                ...
                if (J.lIIIIIlllllIl(tileObject.getName().contains(lIIllIllII[lIIllIllll[218]]) ? 1 : 0) && J.lIIIIlIIIIlIl(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIllIllll[219], lIIllIllll[220], lIIllIllll[10])), lIIllIllll[3])) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((56 + 157 - 127 + 97 ^ 91 + 164 - 185 + 109) & (46 + 147 - 187 + 143 ^ 39 + 125 - 70 + 51 ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIIllIllll[0];
                }
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIIllllIIlIl)) {
                        ...
                        "".length();
                        if ("   ".length() == 0) {
                            return ((0xDD ^ 0x87 ^ (0xDD ^ 0xBE)) & (0xCD ^ 0xBB ^ (0x7A ^ 0x35) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIllIllll[0];
                    }
            ...
            if (J.lIIIIIlllllIl(lllllllllllllllllllllIIllllIllII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIlIIIIIII(lllllllllllllllllllllIIllllIIllI = TileObjects.getNearest(tileObject -> {
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIIllllIIlIl)) {
                        ...
                        "".length();
                        if (-" ".length() > -" ".length()) {
                            return ((0xA7 ^ 0x81 ^ (0xF1 ^ 0xB6)) & (59 + 131 - 164 + 134 ^ 41 + 124 - -14 + 14 ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIllIllll[0];
                    }
            ...
            if (J.lIIIIIlllllIl(lllllllllllllllllllllIIllllIlIll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIlIIIIIII(lllllllllllllllllllllIIllllIIllI = TileObjects.getNearest(tileObject -> {
                ...
                if (J.lIIIIIlllllIl(tileObject.getName().contains(lIIllIllII[lIIllIllll[213]]) ? 1 : 0) && J.lIIIIlIIIIlIl(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIllIllll[214], lIIllIllll[215], lIIllIllll[3])), lIIllIllll[3])) {
                    ...
                    "".length();
                    if (null != null) {
                        return (" ".length() & ~" ".length() & ~((0x61 ^ 0x36) & ~(0xC ^ 0x5B))) != 0;
                    }
                } else {
                    n2 = lIIllIllll[0];
                }
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIIllllIIlIl)) {
                        ...
                        if (-(11 + 37 - 34 + 153 ^ 153 + 110 - 212 + 112) > 0) {
                            return ((64 + 64 - 118 + 158 ^ 121 + 118 - 137 + 63) & (0xDC ^ 0xB4 ^ (0x28 ^ 0x4D) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIllIllll[0];
                    }
            ...
            if (J.lIIIIIlllllIl(lllllllllllllllllllllIIllllIlIIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIlIIIIIII(lllllllllllllllllllllIIllllIIllI = TileObjects.getNearest(tileObject -> {
                ...
                if (J.lIIIIIlllllIl(tileObject.getName().contains(lIIllIllII[lIIllIllll[208]]) ? 1 : 0) && J.lIIIIlIIIIlIl(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIllIllll[209], lIIllIllll[210], lIIllIllll[3])), lIIllIllll[3])) {
                    ...
                    if (-(174 + 104 - 205 + 108 ^ 12 + 166 - 52 + 51) > 0) {
                        return ((0x2C ^ 0x3C ^ (0x69 ^ 0x6C)) & (0x8A ^ 0xBC ^ (0xA8 ^ 0x8B) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIIllIllll[0];
                }
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIIllllIIlIl)) {
                        ...
                        "".length();
                        if (-"  ".length() > 0) {
                            return ((221 + 12 - 144 + 145 ^ 128 + 137 - 193 + 90) & (0x12 ^ 0x66 ^ (0x67 ^ 0x5B) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIllIllll[0];
                    }
    ...
    private static boolean cu() {
        ...
        if (J.lIIIIlIIIIIII(TileItems.getNearest((int[])nArray))) {
            ...
            while (J.lIIIIIllllllI(lllllllllllllllllllllIIllIllIlll, ((void)lllllllllllllllllllllIIllIlllIII).length)) {
                ...
                "".length();
                if ("   ".length() != ((0xA3 ^ 0xC2) & ~(0x2E ^ 0x4F))) continue;
    ...
    public boolean V() {
        ...
        if (J.lIIIIlIIIIIll(Skills.getLevel((Skill)Skill.AGILITY), lIIllIllll[2])) {
            ...
            "".length();
            if ("  ".length() < -" ".length()) {
                return ((0xBC ^ 0xC2 ^ (0x69 ^ 0x18)) & (29 + 20 - 13 + 106 ^ 66 + 113 - 51 + 1 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIllIllll[0];
        }
                ...
                if (J.lIIIIIlllllIl(lllllllllllllllllllllIlIIIlIIlll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIIlllllll(J.cu() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIlIIIIlllIl)) {
                            ...
                            "".length();
                            if (null != null) {
                                return ((173 + 1 - 13 + 91 ^ 187 + 1 - 58 + 60) & (0 ^ 0x54 ^ (0x8E ^ 0x98) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIllIllll[0];
                        }
                ...
                if (J.lIIIIIlllllIl(lllllllllllllllllllllIlIIIlIIllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIIlllllll(J.cu() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIlIIIIlllIl)) {
                            bl = lIIllIllll[1];
                            "".length();
                            if ((0xF1 ^ 0xBC ^ (0xD ^ 0x44)) <= -" ".length()) {
                                return ((0x25 ^ 0x79 ^ (2 ^ 0x70)) & (95 + 129 - 177 + 117 ^ 84 + 107 - 169 + 116 ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIllIllll[0];
                        }
                ...
                if (J.lIIIIIlllllIl(lllllllllllllllllllllIlIIIlIIlII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIIlllllll(J.cu() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIlIIIIlllIl)) {
                            ...
                            "".length();
                            if ("   ".length() <= 0) {
                                return ((0xD5 ^ 0x81 ^ (0xFC ^ 0xBB)) & (143 + 111 - 102 + 16 ^ 7 + 90 - -74 + 16 ^ -" ".length()) & ((0x82 ^ 0x88 ^ (0xBB ^ 0xBF)) & (30 + 66 - -21 + 49 ^ 108 + 37 - 67 + 90 ^ -" ".length()) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIllIllll[0];
                        }
                ...
                if (J.lIIIIIlllllIl(lllllllllllllllllllllIlIIIlIIIll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIIlllllll(J.cu() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIlIIIIlllIl)) {
                            bl = lIIllIllll[1];
                            "".length();
                            if (((170 + 75 - 79 + 6 ^ 16 + 28 - 37 + 134) & (0x10 ^ 2 ^ (0xB3 ^ 0x80) ^ -" ".length())) != ((196 + 29 - 222 + 231 ^ 162 + 20 - 68 + 60) & (0x58 ^ 0x6F ^ (0x6F ^ 0x1C) ^ -" ".length()))) {
                                return ((104 + 86 - 180 + 117 ^ (0xF9 ^ 0xB0)) & (154 + 100 - 97 + 24 ^ 123 + 95 - 137 + 50 ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIllIllll[0];
                        }
                ...
                if (J.lIIIIIlllllIl(lllllllllllllllllllllIlIIIlIIIlI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIIlllllll(J.cu() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIlIIIIlllIl)) {
                            ...
                            "".length();
                            if ("  ".length() < "  ".length()) {
                                return ((77 + 89 - 95 + 88 ^ 124 + 137 - 144 + 53) & (0xD1 ^ 0x95 ^ (0x3B ^ 0x4A) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIllIllll[0];
                        }
                ...
                if (J.lIIIIIlllllIl(lllllllllllllllllllllIlIIIlIIIIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIIlllllll(J.cu() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIlIIIIlllIl)) {
                            bl = lIIllIllll[1];
                            "".length();
                            if ((("   ".length() ^ (0x6C ^ 0x58)) & (0xE6 ^ 0xA0 ^ (0xC1 ^ 0xB0) ^ -" ".length())) >= " ".length()) {
                                return ((134 + 118 - 150 + 53 ^ 65 + 72 - 31 + 26) & (0x85 ^ 0x8F ^ (0x24 ^ 0x31) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIllIllll[0];
                        }
                ...
                if (J.lIIIIIlllllIl(lllllllllllllllllllllIlIIIlIIIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIIlllllll(J.cu() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIlIIIIlllIl)) {
                            bl = lIIllIllll[1];
                            "".length();
                            if (-" ".length() > ((79 + 87 - 134 + 192 ^ 167 + 106 - 166 + 64) & (220 + 44 - 105 + 87 ^ 146 + 100 - 186 + 129 ^ -" ".length()))) {
                                return (("   ".length() ^ (0xFE ^ 0xA8)) & (0x7A ^ 0x2B ^ (0xA6 ^ 0xA2) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIllIllll[0];
                        }
                ...
                if (J.lIIIIIlllllIl(lllllllllllllllllllllIlIIIIlllll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIIlllllll(J.cu() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIlIIIIlllIl)) {
                            bl = lIIllIllll[1];
                            "".length();
                            if (((0x25 ^ 0x17 ^ (0xA0 ^ 0xB6)) & (5 ^ 0x3D ^ (0x8A ^ 0x96) ^ -" ".length())) == " ".length()) {
                                return ((175 + 99 - 196 + 101 ^ 50 + 137 - 46 + 33) & (103 + 158 - 115 + 14 ^ 34 + 15 - -15 + 125 ^ -" ".length()) & ((110 + 146 - 110 + 50 ^ 60 + 118 - 155 + 105) & (0x27 ^ 0x14 ^ (0xE0 ^ 0x97) ^ -" ".length()) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIllIllll[0];
                        }
            ...
            if (J.lIIIIlIIIIlIl(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllllllllllllllllllIlIIIIIIIlI), lIIllIllll[21])) {
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIlIIIIIIIIl)) {
                        bl = lIIllIllll[1];
                        "".length();
                        if (((0x3E ^ 7 ^ (0x11 ^ 0x6D)) & (" ".length() ^ (9 ^ 0x4D) ^ -" ".length())) > (0xED ^ 0xAF ^ (0x3C ^ 0x7A))) {
                            return ((0x52 ^ 0x5F ^ (2 ^ 0x55)) & (0x5D ^ 0x58 ^ (0x7E ^ 0x21) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIllIllll[0];
                    }
        ...
        if (J.lIIIIIlllllll(J.cu() ? 1 : 0)) {
            ...
            if (J.lIIIIIlllllIl(lllllllllllllllllllllIlIIIIIlIIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIlIIIIIII(lllllllllllllllllllllIlIIIIIIIII = TileObjects.getNearest(tileObject -> {
                ...
                if (J.lIIIIIlllllIl(tileObject.getName().contains(lIIllIllII[lIIllIllll[233]]) ? 1 : 0) && J.lIIIIlIIIIlIl(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIllIllll[234], lIIllIllll[131], lIIllIllll[3])), lIIllIllll[3])) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((0xAB ^ 0x9B ^ (0x71 ^ 0x4E)) & (108 + 5 - 10 + 58 ^ 131 + 139 - 190 + 94 ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIIllIllll[0];
                }
            ...
            if (J.lIIIIIlllllIl(lllllllllllllllllllllIlIIIIIlIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIlIIIIIII(lllllllllllllllllllllIlIIIIIIIII = TileObjects.getNearest(tileObject -> {
                ...
                if (J.lIIIIIlllllIl(tileObject.getName().contains(lIIllIllII[lIIllIllll[232]]) ? 1 : 0) && J.lIIIIlIIIIlIl(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIllIllll[131], lIIllIllll[225], lIIllIllll[3])), lIIllIllll[3])) {
                    ...
                    "".length();
                    if (" ".length() != " ".length()) {
                        return ((0x5E ^ 0x3B ^ (0x73 ^ 0x57)) & (64 + 159 - 137 + 159 ^ 149 + 13 - 140 + 158 ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIIllIllll[0];
                }
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (J.lIIIIlIIIIIIl(Skills.getExperience((Skill)Skill.AGILITY), lllllllllllllllllllllIIlllllllll)) {
                        ...
                        if ((68 + 72 - 73 + 60 ^ (0x71 ^ 0xA)) != (0x3D ^ 0x71 ^ (0xD4 ^ 0x9C))) {
                            return ((155 + 22 - 42 + 22 ^ 57 + 51 - -50 + 30) & (0x74 ^ 0x5B ^ (0xAF ^ 0xA1) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIllIllll[0];
                    }
            ...
            if (J.lIIIIIlllllIl(lllllllllllllllllllllIlIIIIIIlll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIlIIIIIII(lllllllllllllllllllllIlIIIIIIIII = TileObjects.getNearest(tileObject -> {
                ...
                if (J.lIIIIIlllllIl(tileObject.getName().contains(lIIllIllII[lIIllIllll[230]]) ? 1 : 0) && J.lIIIIlIIIIlIl(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIllIllll[139], lIIllIllll[231], lIIllIllll[3])), lIIllIllll[3])) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((0x3F ^ 0xD ^ (0x17 ^ 5)) & (0xF6 ^ 0xC4 ^ (0x94 ^ 0x86) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIIllIllll[0];
                }
            ...
            if (J.lIIIIIlllllIl(lllllllllllllllllllllIlIIIIIIIll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.lIIIIlIIIIIII(lllllllllllllllllllllIlIIIIIIIII = TileObjects.getNearest(tileObject -> {
                ...
                if (J.lIIIIIlllllIl(tileObject.getName().contains(lIIllIllII[lIIllIllll[221]]) ? 1 : 0) && J.lIIIIlIIIIlIl(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIllIllll[222], lIIllIllll[223], lIIllIllll[3])), lIIllIllll[3])) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((0x67 ^ 0x7A ^ (0x39 ^ 0x13)) & (0xE6 ^ 0xAF ^ (0xCD ^ 0xB3) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIIllIllll[0];
                }
