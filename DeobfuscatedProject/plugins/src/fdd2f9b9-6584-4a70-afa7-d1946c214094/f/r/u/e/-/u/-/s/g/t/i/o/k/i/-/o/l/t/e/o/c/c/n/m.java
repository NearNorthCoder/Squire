...
implements G {
                                                ...
                                                block32: {
                                                    ...
                                                    block34: {
                                                                            ...
                                                                            block24: {
                                                                                ...
                                                                                block26: {
                                                                                                            ...
                                                                                                            block16: {
                                                                                                                ...
                                                                                                                block18: {
                                                                                                                    ...
                                                                                                                    if (m.lllllllIllII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                                                                                        n5 = lIIlIllIIl[1];
                                                                                                                        "".length();
                                                                                                                        if (-" ".length() < ((0x65 ^ 0x46) & ~(3 ^ 0x20))) return n5 != 0;
                                                                                    ...
                                                                                    if (m.lllllllIllII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                                                        ...
                                                                                        return ((0x5B ^ 0x66 ^ (0x1E ^ 0x77)) & (0x3D ^ 0x2C ^ (0xD1 ^ 0x94) ^ -" ".length())) != 0;
                                                                                    }
                                                                                }
                                                                                n4 = lIIlIllIIl[0];
                                                                                return n4 != 0;
                                                        ...
                                                        if (m.lllllllIllII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                            n3 = lIIlIllIIl[1];
                                                            "".length();
                                                            if (((0xAC ^ 0x96 ^ (0x70 ^ 0x7B)) & (146 + 41 - 151 + 116 ^ 128 + 56 - 110 + 95 ^ -" ".length())) == 0) return n3 != 0;
                                                            return ((0xB4 ^ 0x81 ^ (0x2C ^ 0xF)) & (0xF6 ^ 0x82 ^ (0x26 ^ 0x44) ^ -" ".length())) != 0;
                                                        }
                                                    }
                                                    n3 = lIIlIllIIl[0];
                                                    return n3 != 0;
    ...
    private static void lllllllIlIll() {
        ...
        m.lIIlIllIIl[1] = " ".length();
        m.lIIlIllIIl[2] = "  ".length();
        m.lIIlIllIIl[3] = "   ".length();
        ...
        m.lIIlIllIIl[32] = "  ".length() ^ (0x7D ^ 0x78);
        ...
        m.lIIlIllIIl[37] = 0xB2 ^ 0xBB ^ "  ".length();
    ...
    public int T() {
        ...
        if (null != null) {
            return (0xA0 ^ 0x8A ^ 64 + 81 - 26 + 8) & ("  ".length() ^ (0x6B ^ 0x3C) ^ -" ".length());
        }
                ...
                if (m.llllllllIIIl(Skills.getLevel((Skill)Skill.RANGED), lIIlIllIIl[27])) {
                    lllllllllllllllllllllllIIIlIIIIl = TileItems.getNearest(tileItem -> {
                        ...
                        if (m.llllllllIIll(tileItem.getId(), lIIlIllIIl[16]) && m.llllllllIIIl(tileItem.getQuantity(), lIIlIllIIl[42])) {
                            ...
                            "".length();
                            if (-" ".length() != -" ".length()) {
                                return ((0x76 ^ 2 ^ (0xDA ^ 0x96)) & (68 + 2 - 54 + 129 ^ 25 + 53 - -47 + 44 ^ -" ".length())) != 0;
                            }
                        } else {
                            n2 = lIIlIllIIl[0];
                        }
    ...
    private static void lllllllIlIIl() {
        ...
        m.lIIlIlIlll[m.lIIlIllIIl[0]] = m.lllllllIIllI("BxYWDDciQwYRPCgQ", "EcoeY");
        m.lIIlIlIlll[m.lIIlIllIIl[1]] = m.lllllllIIlll("b87mWGAlHQzzjfi6QZd+8F3GQ+J6DlnvT0u+LIqDuvKvEBQxYC4Sh5/ZilIPZv+ldstuKmt6wt0=", "MmyVS");
        m.lIIlIlIlll[m.lIIlIllIIl[2]] = m.lllllllIlIII("4oM3BcYXwt1ya1B2ZqIT2QLxalJoVNj6", "TsGWP");
        m.lIIlIlIlll[m.lIIlIllIIl[3]] = m.lllllllIIlll("vYppP5QUvouf6Ckb6nc6nlgPjsciQdrC", "wLQwj");
        m.lIIlIlIlll[m.lIIlIllIIl[6]] = m.lllllllIlIII("uRt23G4uGgkiUqaEug58MZ1FZTF/CbBxTczUaKYGkWhBLWs6ikznYVj9co1hEmNS", "GLzLI");
        m.lIIlIlIlll[m.lIIlIllIIl[5]] = m.lllllllIIlll("KlFag8K47Dg=", "rJCKg");
        m.lIIlIlIlll[m.lIIlIllIIl[30]] = m.lllllllIIlll("+akuzKCmfs4=", "DIWSi");
        m.lIIlIlIlll[m.lIIlIllIIl[32]] = m.lllllllIIllI("HAgkIw==", "KmEQQ");
        m.lIIlIlIlll[m.lIIlIllIIl[33]] = m.lllllllIIllI("EjgPATI=", "EQjmV");
        m.lIIlIlIlll[m.lIIlIllIIl[35]] = m.lllllllIIlll("maNYdrscVrk=", "dhwak");
        m.lIIlIlIlll[m.lIIlIllIIl[24]] = m.lllllllIIlll("/FiRkFe5+7U=", "knvZV");
        m.lIIlIlIlll[m.lIIlIllIIl[37]] = m.lllllllIlIII("ZqgHzXubZeE=", "ErUXb");
        m.lIIlIlIlll[m.lIIlIllIIl[38]] = m.lllllllIIlll("lLXhgz1qA4o=", "EPAIt");
        m.lIIlIlIlll[m.lIIlIllIIl[39]] = m.lllllllIIlll("Cq8PP8uQ3nk=", "mHTsl");
        m.lIIlIlIlll[m.lIIlIllIIl[40]] = m.lllllllIIlll("EtgVCwWGwMk=", "aXxrc");
        m.lIIlIlIlll[m.lIIlIllIIl[42]] = m.lllllllIIllI("JRYAHQ==", "rsaoE");
        m.lIIlIlIlll[m.lIIlIllIIl[43]] = m.lllllllIlIII("RyeseTd+23E=", "Cawuf");
        m.lIIlIlIlll[m.lIIlIllIIl[44]] = m.lllllllIIllI("DysICw==", "XNiyu");
        m.lIIlIlIlll[m.lIIlIllIIl[45]] = m.lllllllIIlll("euvfkN5/RYE=", "PRCTl");
        m.lIIlIlIlll[m.lIIlIllIIl[60]] = m.lllllllIlIII("yte3gMrUG3NVdjK2RC7OzA==", "TkPoi");
        m.lIIlIlIlll[m.lIIlIllIIl[31]] = m.lllllllIIllI("EycnFnAOKGkGNQAiPRlwSQ==", "aNIqP");
        m.lIIlIlIlll[m.lIIlIllIIl[61]] = m.lllllllIlIII("etAgqbMqJWI=", "eVniu");
    }
                                    ...
                                    if (m.lllllllIllII(Bank.contains((int[])nArray5) ? 1 : 0)) {
                                        ...
                                        if (m.lllllllIllII(Bank.contains((int[])nArray6) ? 1 : 0)) {
                                            ...
                                            if (m.lllllllIllII(Bank.contains((int[])nArray7) ? 1 : 0)) {
                                                ...
                                                return ((0xF8 ^ 0x90 ^ (0xE2 ^ 0x8F)) & (117 + 160 - 204 + 89 ^ 42 + 74 - 80 + 131 ^ -" ".length())) != 0;
                                            }
                                        }
                                    }
                                }
