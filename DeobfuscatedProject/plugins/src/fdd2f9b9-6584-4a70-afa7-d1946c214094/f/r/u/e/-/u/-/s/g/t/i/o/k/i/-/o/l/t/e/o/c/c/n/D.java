...
implements G {
    ...
    private static void lIIIIIIlIIlIl() {
        ...
        D.lIIllIIIlI[1] = " ".length();
        D.lIIllIIIlI[2] = 26 + 63 - -4 + 51 + (0x5E ^ 0x7F) - (57 + 99 - 26 + 25) + (85 + 40 - 30 + 43);
        D.lIIllIIIlI[3] = "  ".length();
        D.lIIllIIIlI[4] = "   ".length();
    ...
    private static String lIIIIIIIlIIIl(String llllllllllllllllllllllIIlIIIIlII, String llllllllllllllllllllllIIIllllllI) {
        ...
        while (D.lIIIIIIlIIlll(llllllllllllllllllllllIIIllllIII, llllllllllllllllllllllIIIllllIIl)) {
            ...
            "".length();
            if (((0xD4 ^ 0xC6 ^ (0xA1 ^ 0x9F)) & (0x7E ^ 0x28 ^ (0x75 ^ 0xF) ^ -" ".length())) >= ((0x97 ^ 0x89 ^ (0x55 ^ 0x46)) & (129 + 104 - 154 + 78 ^ 90 + 56 - 58 + 56 ^ -" ".length()))) continue;
            return null;
        }
                                    ...
                                    if (D.lIIIIIIlIIllI(Inventory.contains((int[])nArray4) ? 1 : 0)) {
                                        ...
                                        if (D.lIIIIIIlIIllI(Inventory.contains((int[])nArray5) ? 1 : 0)) {
                                            ...
                                            if (D.lIIIIIIlIIllI(Inventory.contains((String[])stringArray5) ? 1 : 0)) {
                                                n2 = lIIllIIIlI[1];
                                                "".length();
                                                if ("  ".length() <= (0x5D ^ 0x59)) return n2 != 0;
                    ...
                    if (D.lIIIIIIlIIlll(Inventory.getCount((int[])nArray3), lIIllIIIlI[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (D.lIIIIIIlIlIlI(Inventory.getCount((int[])nArray))) {
                                bl = lIIllIIIlI[1];
                                "".length();
                                if (-" ".length() >= (9 ^ 0x19 ^ (1 ^ 0x15))) {
                                    return ((0xAB ^ 0x92 ^ (0xC ^ 3)) & (0 + 120 - 63 + 72 ^ 30 + 5 - -134 + 14 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIllIIIlI[0];
                            }
                    ...
                    if (D.lIIIIIIlIIlll(Inventory.getCount((int[])nArray7), lIIllIIIlI[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (D.lIIIIIIlIlIlI(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if ("   ".length() <= -" ".length()) {
                                    return ((0x2E ^ 0x23 ^ (0xA8 ^ 0x88)) & (3 ^ 0x5A ^ (0xD2 ^ 0xA6) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIllIIIlI[0];
                            }
                    ...
                    if (D.lIIIIIIlIIlll(Inventory.getCount((int[])nArray9), lIIllIIIlI[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (D.lIIIIIIlIlIlI(Inventory.getCount((int[])nArray))) {
                                bl = lIIllIIIlI[1];
                                "".length();
                                if (((0x17 ^ 0x37 ^ (0xDD ^ 0xC7)) & (27 + 52 - 48 + 223 ^ 107 + 47 - 134 + 176 ^ -" ".length())) > 0) {
                                    return ((0x97 ^ 0x99 ^ (0x49 ^ 2)) & (0xB ^ 0x77 ^ (0x99 ^ 0xA0) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIllIIIlI[0];
                            }
                    ...
                    if (D.lIIIIIIlIIlll(Inventory.getCount((int[])nArray13), lIIllIIIlI[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (D.lIIIIIIlIlIlI(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (-" ".length() > 0) {
                                    return ((0x19 ^ 0x3D ^ (0xA6 ^ 0xA9)) & (0x94 ^ 0x9B ^ (0x65 ^ 0x41) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIllIIIlI[0];
                            }
                    ...
                    if (D.lIIIIIIlIIlll(Inventory.getCount((int[])nArray19), lIIllIIIlI[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (D.lIIIIIIlIlIlI(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if ("   ".length() != "   ".length()) {
                                    return ((0xCA ^ 0xBB ^ (0xE2 ^ 0xC2)) & (0xD8 ^ 0xA6 ^ (9 ^ 0x26) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIllIIIlI[0];
                            }
                    ...
                    if (D.lIIIIIIlIIlll(Inventory.getCount((int[])nArray23), lIIllIIIlI[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (D.lIIIIIIlIlIlI(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (null != null) {
                                    return ((0x31 ^ 0x68 ^ (0x6E ^ 0x24)) & (0x2C ^ 0xA ^ (0x6A ^ 0x5F) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIllIIIlI[0];
                            }
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (D.lIIIIIIlIlIlI(Inventory.getCount((int[])nArray))) {
                                            ...
                                            if (-(0xB3 ^ 0xAD ^ (0x28 ^ 0x33)) >= 0) {
                                                return ((0x7F ^ 0x77 ^ (0xCB ^ 0x82)) & (0xA5 ^ 0x85 ^ (0xE9 ^ 0x88) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIllIIIlI[0];
                                        }
                                ...
                                if (D.lIIIIIIlIIlll(Inventory.getCount((int[])nArray17), lIIllIIIlI[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (D.lIIIIIIlIlIlI(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (null != null) {
                                                return ((75 + 68 - 106 + 102 ^ 104 + 159 - 213 + 130) & (0x8E ^ 0xB4 ^ (0x7F ^ 0x7A) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIllIIIlI[0];
                                        }
                                ...
                                if (D.lIIIIIIlIIlll(Inventory.getCount((int[])nArray21), lIIllIIIlI[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (D.lIIIIIIlIlIlI(Inventory.getCount((int[])nArray))) {
                                            bl = lIIllIIIlI[1];
                                            "".length();
                                            if ("   ".length() == ((136 + 112 - 154 + 63 ^ 137 + 104 - 104 + 26) & (0x98 ^ 0x9F ^ (0x7A ^ 0x43) ^ -" ".length()))) {
                                                return ((145 + 85 - 197 + 215 ^ 144 + 48 - 66 + 53) & (191 + 104 - 242 + 193 ^ 102 + 107 - 81 + 61 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIllIIIlI[0];
                                        }
                                ...
                                if (D.lIIIIIIlIIlll(Inventory.getCount((int[])nArray23), lIIllIIIlI[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (D.lIIIIIIlIlIlI(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if ("   ".length() != "   ".length()) {
                                                return ((81 + 229 - 132 + 72 ^ 165 + 117 - 123 + 13) & (0x6D ^ 0x61 ^ (0x14 ^ 0x4E) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIllIIIlI[0];
                                        }
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (D.lIIIIIIlIlIlI(Inventory.getCount((int[])nArray))) {
                                            ...
                                            if ((0x4D ^ 0x27 ^ (0x29 ^ 0x47)) < 0) {
                                                return ((142 + 151 - 214 + 99 ^ 91 + 43 - 21 + 61) & (95 + 2 - 37 + 161 ^ 12 + 114 - 93 + 160 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIllIIIlI[0];
                                        }
                                ...
                                if (D.lIIIIIIlIIlll(Inventory.getCount((int[])nArray33), lIIllIIIlI[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (D.lIIIIIIlIlIlI(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if ("  ".length() <= 0) {
                                                return ((140 + 44 - 118 + 85 ^ 173 + 177 - 301 + 145) & (224 + 233 - 407 + 188 ^ 94 + 177 - 184 + 100 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIllIIIlI[0];
                                        }
    ...
    private static void lIIIIIIlIIlII() {
        ...
        D.lIIlIlllll[D.lIIllIIIlI[0]] = D.lIIIIIIIlIIIl("IRIJOiAERxknKw4U", "cgpSN");
        D.lIIlIlllll[D.lIIllIIIlI[1]] = D.lIIIIIIIlIIlI("GxHDUqM7GN/a2une4+bT73/o7+RJ2zMbNHjVywwlY8OTT43XL8BmQ0FUIOFLfbpyTpIrB/hiY38=", "AbhWd");
        D.lIIlIlllll[D.lIIllIIIlI[3]] = D.lIIIIIIIlIIIl("GTAiGS82JT0eL3clO1AqNj8/", "WQTpH");
        D.lIIlIlllll[D.lIIllIIIlI[4]] = D.lIIIIIIIlIIlI("LHsKDBtfzStPgEEwSLqxJg==", "VhgIE");
        D.lIIlIlllll[D.lIIllIIIlI[6]] = D.lIIIIIIIlIIll("h/qrHdNi9u1kL9BYdhw6V7A83SmsJpwl", "dYVas");
        D.lIIlIlllll[D.lIIllIIIlI[9]] = D.lIIIIIIIlIIIl("GD9pBRMqeiQNEjwzJwNBPC85FA0mPzpIQTwtIBACJzMnA0E7NWkmNBYTByM=", "OZIda");
        D.lIIlIlllll[D.lIIllIIIlI[12]] = D.lIIIIIIIlIIll("ohYPBCR249h3OwJucqtDZ4iX76+p1SHp3l/dgkEuQ9E0ZDgPMnQiv2lylXnFwfE5", "wriNp");
        D.lIIlIlllll[D.lIIllIIIlI[14]] = D.lIIIIIIIlIIll("WTSiCEgB7pMFVW8bY2/+uqBGRQ1sR1AHqlK5cvc+IeH5b2Of9O4vtfU7XcyTbhFX", "xTidb");
        D.lIIlIlllll[D.lIIllIIIlI[16]] = D.lIIIIIIIlIIIl("ATZaNCEzcxc8ICU6FDJzJSYKJT8/Ngl5cyUkEyEwPjoUMnMiPFoXBg8aNBI=", "VSzUS");
        D.lIIlIlllll[D.lIIllIIIlI[18]] = D.lIIIIIIIlIIIl("GQtuDyYrTiMHJz0HIAl0PRs+HjgnCz1CdD0ZJxo3JgcgCXQ6AW4sARcnACk=", "NnNnT");
        D.lIIlIlllll[D.lIIllIIIlI[8]] = D.lIIIIIIIlIIIl("EBxGAwQiWQsLBTQQCAVWNAwWEhouHBVOVjQODxYVLxAIBVYzFkYgIx4wKCU=", "Gyfbv");
        D.lIIlIlllll[D.lIIllIIIlI[19]] = D.lIIIIIIIlIIll("s7XloDB6wyHGUVxk0NptYtUanHgH6UnD", "YYPIB");
        D.lIIlIlllll[D.lIIllIIIlI[32]] = D.lIIIIIIIlIIll("D1MFk7apar059/VkHwe2aQ==", "NJMuF");
        D.lIIlIlllll[D.lIIllIIIlI[33]] = D.lIIIIIIIlIIll("vdu5Fp8WY6w=", "rdLCr");
        D.lIIlIlllll[D.lIIllIIIlI[34]] = D.lIIIIIIIlIIIl("JyYXPj4GKR56IxoiCi4=", "oGyZR");
        D.lIIlIlllll[D.lIIllIIIlI[31]] = D.lIIIIIIIlIIIl("PzAObg4ecQs6GwMl", "qQxNz");
        D.lIIlIlllll[D.lIIllIIIlI[35]] = D.lIIIIIIIlIIlI("0nzh5wBjvbKUYnfz8sNukw==", "NEBJZ");
        D.lIIlIlllll[D.lIIllIIIlI[36]] = D.lIIIIIIIlIIlI("NdjbnqOD2p6CYFZ842zmQwEnY/VummXLSc0Fp9t7nl4=", "vIZQE");
        D.lIIlIlllll[D.lIIllIIIlI[38]] = D.lIIIIIIIlIIll("aJe0ZHpk6/7ea9ySvhKY/g/JpjL258PCz05px6NfdO0=", "ybFaV");
        D.lIIlIlllll[D.lIIllIIIlI[40]] = D.lIIIIIIIlIIll("Sh6pA5JzubPkHsSqiKAeaINQCwQJAdSgyS5xhcfIm0o=", "sKwqc");
        D.lIIlIlllll[D.lIIllIIIlI[30]] = D.lIIIIIIIlIIIl("NwktIhoRTT4jHQIIaSkRFwlpPxtWDzwyVBoEOj8=", "vmIKt");
        D.lIIlIlllll[D.lIIllIIIlI[41]] = D.lIIIIIIIlIIlI("qr7m37skfDrelc2yfR25Jsf8LYlYjrPmUgGW3lxuch0=", "BUtMk");
        D.lIIlIlllll[D.lIIllIIIlI[44]] = D.lIIIIIIIlIIIl("CDUUJTcucRwjOzolFT55PT5QLiwwcRwlKj0=", "IQpLY");
        D.lIIlIlllll[D.lIIllIIIlI[46]] = D.lIIIIIIIlIIlI("jRXFSSLt+AYMOA0oqjGFJ8JPSu3tbG7xtPixSw/mIok=", "EOIgF");
        D.lIIlIlllll[D.lIIllIIIlI[48]] = D.lIIIIIIIlIIll("H1G1w90sPWOBWyx5wlakuzcDxDefAIYijDI/7lWzKlE=", "YYPfW");
        D.lIIlIlllll[D.lIIllIIIlI[49]] = D.lIIIIIIIlIIlI("E2UcL/hIyq0E8aIHtceOYNoDCOfXnm10OwkQ8hARGpU=", "ltoTn");
        D.lIIlIlllll[D.lIIllIIIlI[52]] = D.lIIIIIIIlIIll("5HbztdpfX0wUr8VuHW8eERSVcHG15Kexe5CzZ4kI+2s=", "zfilI");
        D.lIIlIlllll[D.lIIllIIIlI[54]] = D.lIIIIIIIlIIll("2a/UJHyY8bdydQyUYZIl73tAquSTjyJRe2PmxpiOwfc=", "vXKEX");
        D.lIIlIlllll[D.lIIllIIIlI[55]] = D.lIIIIIIIlIIIl("LyEjKi8JZSEiLQI8ZzcgDDZnNy5OJzI6YQIsNDc=", "nEGCA");
        D.lIIlIlllll[D.lIIllIIIlI[56]] = D.lIIIIIIIlIIIl("NT0tIQITeTo8DRkwJykfVC0maA4BIGkkBQct", "tYIHl");
        D.lIIlIlllll[D.lIIllIIIlI[57]] = D.lIIIIIIIlIIll("XKIkwZcf5E3yO8u9pxW2ta8kiRoCreZEuBfZay4irQo=", "mAvcQ");
        D.lIIlIlllll[D.lIIllIIIlI[60]] = D.lIIIIIIIlIIll("5p+zI73RfAKRzyp82IaBgP2NrnXxrMcudvIEzO68fHw=", "cHKgD");
        D.lIIlIlllll[D.lIIllIIIlI[61]] = D.lIIIIIIIlIIlI("5AKMC50u6vEVhOM7we6FtnfXwKARI1Cc9GGZCGrCwQA=", "hRQFO");
        D.lIIlIlllll[D.lIIllIIIlI[62]] = D.lIIIIIIIlIIlI("nsThpjzljlyGqj9gGrptmz7pnKPsyubsgW7lWi6mIDc=", "XOSOl");
        D.lIIlIlllll[D.lIIllIIIlI[63]] = D.lIIIIIIIlIIll("dcCqldLwdRZ5HqVJHP+RN6c8u5+THaWBSNCgZUffGpc=", "iZgnd");
        D.lIIlIlllll[D.lIIllIIIlI[64]] = D.lIIIIIIIlIIll("jltpxpMY045dZoQenmP25U7NMMPxp8nyi1VL5hS33x8=", "zftrZ");
        D.lIIlIlllll[D.lIIllIIIlI[65]] = D.lIIIIIIIlIIll("5ZzCkhZ08xIJvKdAuF6XAdbWnZQWvYHBoo7p7sXOIAQ=", "DonTb");
        D.lIIlIlllll[D.lIIllIIIlI[66]] = D.lIIIIIIIlIIlI("2sLvlPce6hyXXcJtelV2ueGYaAMhM6YTY/hYVHl3aYU=", "bwzlV");
        D.lIIlIlllll[D.lIIllIIIlI[67]] = D.lIIIIIIIlIIIl("MSYQQw4GIhA=", "cCtcl");
        D.lIIlIlllll[D.lIIllIIIlI[68]] = D.lIIIIIIIlIIlI("qp5QnEgODdhuaGVO72LxfA==", "ywncG");
        D.lIIlIlllll[D.lIIllIIIlI[45]] = D.lIIIIIIIlIIIl("NDYZJCNWOB0mLA==", "vZxGH");
        D.lIIlIlllll[D.lIIllIIIlI[69]] = D.lIIIIIIIlIIIl("Azs6OSB0MTYsIQ==", "TSSME");
        D.lIIlIlllll[D.lIIllIIIlI[70]] = D.lIIIIIIIlIIIl("BwUHBysh", "DmbbX");
        D.lIIlIlllll[D.lIIllIIIlI[71]] = D.lIIIIIIIlIIIl("JgMgOT4JFj8+PkgWOXA7CQw9", "hbVPY");
        D.lIIlIlllll[D.lIIllIIIlI[72]] = D.lIIIIIIIlIIll("eDW12DmqFnlHJowG80+KnA==", "vqLKR");
        D.lIIlIlllll[D.lIIllIIIlI[73]] = D.lIIIIIIIlIIlI("q9sff1xPiZy8qNoBqqJ9gP8WjqKgeYio", "cLJrq");
        D.lIIlIlllll[D.lIIllIIIlI[74]] = D.lIIIIIIIlIIll("kWyXrVcL9EgfmII7kVGQnw==", "jSrbF");
        D.lIIlIlllll[D.lIIllIIIlI[75]] = D.lIIIIIIIlIIlI("FzPwVdSLRBIXwnDQBATwmw==", "vSCRQ");
        D.lIIlIlllll[D.lIIllIIIlI[76]] = D.lIIIIIIIlIIIl("ESNkNCIjZik8IzUvKjJwNTM0JTwvIzd5cDUxLSEzLi8qMnAyKWQXBR8PChI=", "FFDUP");
        D.lIIlIlllll[D.lIIllIIIlI[77]] = D.lIIIIIIIlIIll("SULXC86pAJwK7s4zoaobiQ==", "nyhjP");
        D.lIIlIlllll[D.lIIllIIIlI[78]] = D.lIIIIIIIlIIll("GYgb+gzR7EGc+0Fk5IyS0w==", "hmyRe");
        D.lIIlIlllll[D.lIIllIIIlI[79]] = D.lIIIIIIIlIIIl("NgtGBgQETgsOBRIHCABWEhsWFxoICxVLVhIZDxMVCQcIAFYVAUYlIzgnKCA=", "anfgv");
        D.lIIlIlllll[D.lIIllIIIlI[80]] = D.lIIIIIIIlIIll("YmaPgO/WGl2PTKh5dAL9Mg==", "HxuAE");
        D.lIIlIlllll[D.lIIllIIIlI[81]] = D.lIIIIIIIlIIlI("Viq+cBJekNjf1JMEP5JmLA==", "ODsCd");
        D.lIIlIlllll[D.lIIllIIIlI[82]] = D.lIIIIIIIlIIlI("tHpzVebGojjW2wqI5yDMu4KxcWneayhWcT2F18goGet8MIVl5ruWcNemzs2gFMye", "BrkVo");
        D.lIIlIlllll[D.lIIllIIIlI[83]] = D.lIIIIIIIlIIll("hnhNTKz9ZaBwHb2zz98sD7iFacQ4wMiTrb3st5XsySG6tGjALrzigDSI7OKWhR86", "vyFEB");
        D.lIIlIlllll[D.lIIllIIIlI[84]] = D.lIIIIIIIlIIIl("GTweay4xJQ0jCCJxHz4IIyU=", "PQnKm");
        D.lIIlIlllll[D.lIIllIIIlI[85]] = D.lIIIIIIIlIIlI("sK1gD8mrVpFplHehgNZy427H4ip87GQh", "xpqms");
        D.lIIlIlllll[D.lIIllIIIlI[89]] = D.lIIIIIIIlIIll("XNncM1p5K1pNcD/ejUE90g==", "vcuef");
        D.lIIlIlllll[D.lIIllIIIlI[90]] = D.lIIIIIIIlIIlI("faKz6Dgg7M9Ewb8xTDloMi5g+n0TdqEq", "nkWig");
        D.lIIlIlllll[D.lIIllIIIlI[91]] = D.lIIIIIIIlIIll("M88N5gp1IgShVu9KRoYEKQ==", "uwDgf");
        D.lIIlIlllll[D.lIIllIIIlI[92]] = D.lIIIIIIIlIIIl("GSI8ODU0LTFhdBFhIyM7L2E/JTEqJGg5O3gnISMweDUgJCd4Mjw4Mj5v", "XAHMT");
        D.lIIlIlllll[D.lIIllIIIlI[93]] = D.lIIIIIIIlIIIl("HAkZbA==", "EljBE");
        D.lIIlIlllll[D.lIIllIIIlI[94]] = D.lIIIIIIIlIIll("TWD+RQOgoRW0Z80b+bvfhqtAfCJKXzwS", "iiOov");
        D.lIIlIlllll[D.lIIllIIIlI[95]] = D.lIIIIIIIlIIlI("1EleCxxk3fa7uF830PKjcM3R/FfsqHZBNAfqnWsjAZc=", "SQQau");
    }
    ...
    public int T() {
        ...
        if ("  ".length() <= 0) {
            return (0x92 ^ 0x85 ^ (0xB6 ^ 0xBE)) & (35 + 30 - -62 + 44 ^ 160 + 44 - 132 + 108 ^ -" ".length());
        }
