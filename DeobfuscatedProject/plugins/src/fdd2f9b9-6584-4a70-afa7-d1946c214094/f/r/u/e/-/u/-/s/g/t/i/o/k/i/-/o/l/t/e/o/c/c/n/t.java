...
implements G {
    ...
    private static void lIIIIlIlIIllI() {
        ...
        t.lIIlllIllI[t.lIIllllIII[2]] = t.lIIIIlIlIIIII("aIOLhYrFO4EAG2LMHamCDv/2vdp84x99zoZEKKgT8gM7tgDlH3awTjJ8ZFAtdRfU", "KfoKH");
        t.lIIlllIllI[t.lIIllllIII[1]] = t.lIIIIlIlIIIIl("F0M0F5GAnGx094QnDvwsRw==", "SADZo");
        t.lIIlllIllI[t.lIIllllIII[3]] = t.lIIIIlIlIIIIl("EcOYwj841TgFuD9M4hHG0Q==", "OLkDd");
        t.lIIlllIllI[t.lIIllllIII[5]] = t.lIIIIlIlIIIII("3Is7aro2nS4FGsqz6CT7wAGxsBHjI78W", "zujPH");
        t.lIIlllIllI[t.lIIllllIII[6]] = t.lIIIIlIlIIIIl("+Qdn/nQ2kcCCCmLVpQb9lP3yJhOZEZr8q5SYDe0WQKmwkYGTOzZxe97N1s6PWWiRCJZN3h4QXM4=", "WPJiS");
        t.lIIlllIllI[t.lIIllllIII[13]] = t.lIIIIlIlIIIlI("DSsONCo=", "IYgZA");
        t.lIIlllIllI[t.lIIllllIII[15]] = t.lIIIIlIlIIIlI("PikzVBUfaDYAAAI8", "pHEta");
        t.lIIlllIllI[t.lIIllllIII[7]] = t.lIIIIlIlIIIIl("7poXwJRIXG9lgdwNdAc08w==", "DmBdp");
        t.lIIlllIllI[t.lIIllllIII[22]] = t.lIIIIlIlIIIlI("GCw8IBUn", "NIOTg");
        t.lIIlllIllI[t.lIIllllIII[23]] = t.lIIIIlIlIIIlI("KAcnOgYACXQmHQEePCs=", "nnTRo");
        t.lIIlllIllI[t.lIIllllIII[0]] = t.lIIIIlIlIIIIl("56ctU+rFHaivlKrgXIRoWw==", "TWNkY");
        t.lIIlllIllI[t.lIIllllIII[24]] = t.lIIIIlIlIIIIl("kDkRZfoQ+nJA/qqAX0q52w==", "ZoqwV");
        t.lIIlllIllI[t.lIIllllIII[21]] = t.lIIIIlIlIIIII("o3C1GRa7D7w=", "ktddo");
        t.lIIlllIllI[t.lIIllllIII[25]] = t.lIIIIlIlIIIlI("JCAqQzcfKytDNhk3Iw==", "vENcA");
        t.lIIlllIllI[t.lIIllllIII[26]] = t.lIIIIlIlIIIIl("kUtzIvOymv8=", "GgcOa");
        t.lIIlllIllI[t.lIIllllIII[27]] = t.lIIIIlIlIIIII("4+vv7pGpzZw=", "vmPnl");
        t.lIIlllIllI[t.lIIllllIII[28]] = t.lIIIIlIlIIIIl("HbnCFJASh30=", "uBMjK");
        t.lIIlllIllI[t.lIIllllIII[29]] = t.lIIIIlIlIIIIl("OOJbiiwe9M/82QUGvzbSow==", "XXlLE");
        t.lIIlllIllI[t.lIIllllIII[30]] = t.lIIIIlIlIIIII("L26A7wXH3NsM7siRe3hD7w==", "sondd");
        t.lIIlllIllI[t.lIIllllIII[31]] = t.lIIIIlIlIIIII("b/kuh1ZMRvg=", "nQRLN");
        t.lIIlllIllI[t.lIIllllIII[32]] = t.lIIIIlIlIIIII("JydXYWRifARNV8hAW+BIPA==", "xwPBE");
        t.lIIlllIllI[t.lIIllllIII[33]] = t.lIIIIlIlIIIlI("HBgDD3obEB8G", "KyocZ");
        t.lIIlllIllI[t.lIIllllIII[34]] = t.lIIIIlIlIIIlI("BBkBFFoDER0d", "Sxmxz");
        t.lIIlllIllI[t.lIIllllIII[35]] = t.lIIIIlIlIIIIl("Sixghu7t/tM=", "iYpDw");
        t.lIIlllIllI[t.lIIllllIII[36]] = t.lIIIIlIlIIIIl("4teePkyNAtBGlZYXsYM6eA==", "tLfZg");
        t.lIIlllIllI[t.lIIllllIII[37]] = t.lIIIIlIlIIIIl("iBuiJ+2pOTU=", "iiRcE");
        t.lIIlllIllI[t.lIIllllIII[38]] = t.lIIIIlIlIIIlI("IS4ZPRZSORchFhcpDA==", "rZxOb");
        t.lIIlllIllI[t.lIIllllIII[20]] = t.lIIIIlIlIIIII("2OStuQXtAKw=", "mFAgj");
        t.lIIlllIllI[t.lIIllllIII[39]] = t.lIIIIlIlIIIII("SHOSN+W5WjO/Re7Ymnlzwb7GDB5xgjI9Asn/wdo6MK6pC1OhXUYMXLOQgHWK+qjY", "qdmen");
        t.lIIlllIllI[t.lIIllllIII[40]] = t.lIIIIlIlIIIIl("WwQutRQ5hXU=", "EBAuz");
        t.lIIlllIllI[t.lIIllllIII[41]] = t.lIIIIlIlIIIII("bc9RhRYP2FDXwX5rekQ3AQ==", "QxqxZ");
        t.lIIlllIllI[t.lIIllllIII[42]] = t.lIIIIlIlIIIII("IcRHU8J8hoU=", "mrDRX");
        t.lIIlllIllI[t.lIIllllIII[44]] = t.lIIIIlIlIIIIl("3AwMIawZdRg=", "EoHNH");
        t.lIIlllIllI[t.lIIllllIII[45]] = t.lIIIIlIlIIIIl("h9GuY8uFdTVqU2DJ8TtTBA==", "BhQYc");
        t.lIIlllIllI[t.lIIllllIII[46]] = t.lIIIIlIlIIIIl("ofoQ1ZkCJbJeRXI/Pp6z3A==", "UDPBi");
        t.lIIlllIllI[t.lIIllllIII[47]] = t.lIIIIlIlIIIII("z8HSgu6Ek9s=", "xfHdQ");
        t.lIIlllIllI[t.lIIllllIII[48]] = t.lIIIIlIlIIIlI("CRE4MhMhH2suCCAIIyM=", "OxKZz");
        t.lIIlllIllI[t.lIIllllIII[49]] = t.lIIIIlIlIIIII("u1q9R/bie83fqJPLVF0mxg==", "IPGwN");
        t.lIIlllIllI[t.lIIllllIII[50]] = t.lIIIIlIlIIIIl("cQsqNWjx2VHdq8JIyOXcAw==", "mocJU");
        t.lIIlllIllI[t.lIIllllIII[51]] = t.lIIIIlIlIIIIl("nrdYTHoB4II=", "iEOHn");
        t.lIIlllIllI[t.lIIllllIII[52]] = t.lIIIIlIlIIIII("BV1fyZPL7GsvF3bhgv9IKynQ+vknUhQA", "DCVIs");
        t.lIIlllIllI[t.lIIllllIII[53]] = t.lIIIIlIlIIIII("JY5Jw6nOqZI=", "OpSls");
        t.lIIlllIllI[t.lIIllllIII[54]] = t.lIIIIlIlIIIlI("CzsuDTQ=", "XKOiQ");
        t.lIIlllIllI[t.lIIllllIII[55]] = t.lIIIIlIlIIIIl("0UJubfo2leXCjq7cjRDO0Q==", "kHCcm");
        t.lIIlllIllI[t.lIIllllIII[56]] = t.lIIIIlIlIIIIl("GGBAh17lY+Ip5F61qIusMQ==", "WMtBZ");
        t.lIIlllIllI[t.lIIllllIII[63]] = t.lIIIIlIlIIIII("fp/u244htvOpL+6nGUnQww==", "XlPEY");
        t.lIIlllIllI[t.lIIllllIII[64]] = t.lIIIIlIlIIIII("DY/SO928VzPlf44lPPOPOSLQpYOen7kV", "gPoyL");
        t.lIIlllIllI[t.lIIllllIII[67]] = t.lIIIIlIlIIIlI("AVABBSZoBxkKMS0CHwoyaAceBSFoBxcXdSwfAQp1PBgZFzBoAwIFPDoDSQ==", "HpvdU");
        t.lIIlllIllI[t.lIIllllIII[68]] = t.lIIIIlIlIIIlI("BSUsRgc9OWo=", "RMUfi");
        t.lIIlllIllI[t.lIIllllIII[69]] = t.lIIIIlIlIIIII("AQIEDHqHOdgaYs1VkbMo/mL5+pHWuXmyOIcfb2TTB+xFbEQYUjAS54O+ji8fZ0mG", "GElVd");
        t.lIIlllIllI[t.lIIllllIII[19]] = t.lIIIIlIlIIIIl("g2IlWKP51BBVkzG962vo9tPJDEBIbGr9", "pFODu");
        t.lIIlllIllI[t.lIIllllIII[70]] = t.lIIIIlIlIIIII("gURwT+tZi7ZK7evPV0VAouREBNSfGLet9egYGvf/IeY=", "uKanc");
        t.lIIlllIllI[t.lIIllllIII[71]] = t.lIIIIlIlIIIII("usML7wF/iVLjvZW8hsotqEK5QGYAgzlwS7MKSJ5hmp075awgVg4zsw==", "SUTIO");
        t.lIIlllIllI[t.lIIllllIII[72]] = t.lIIIIlIlIIIIl("ZrG5Jgmo+KbOry+iELKF3c2iHQ7qeiw4aEdcDSUkdZlOMUIIv2P2MThRNmdG/Zw5", "kvvJp");
        t.lIIlllIllI[t.lIIllllIII[73]] = t.lIIIIlIlIIIIl("dYf47E9JKgs=", "YQgbH");
    }
    ...
    private static void lIIIIlIlIIlll() {
        ...
        t.lIIllllIII[43] = -"   ".length() & (0xFFFFAFFF & 0x5FF2);
    ...
    private static String lIIIIlIlIIIII(String lllllllllllllllllllllIIIIIllIlII, String lllllllllllllllllllllIIIIIllIIll) {
        try {
            SecretKeySpec lllllllllllllllllllllIIIIIlllIIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllllIIIIIllIIll.getBytes(StandardCharsets.UTF_8)), lIIllllIII[22]), "DES");
            Cipher lllllllllllllllllllllIIIIIlllIII = Cipher.getInstance("DES");
            lllllllllllllllllllllIIIIIlllIII.init(lIIllllIII[3], lllllllllllllllllllllIIIIIlllIIl);
            return new String(lllllllllllllllllllllIIIIIlllIII.doFinal(Base64.getDecoder().decode(lllllllllllllllllllllIIIIIllIlII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIIIIlIlIIIlI(String lllllllllllllllllllllIIIIlIllIII, String lllllllllllllllllllllIIIIlIlIIlI) {
        lllllllllllllllllllllIIIIlIllIII = new String(Base64.getDecoder().decode(lllllllllllllllllllllIIIIlIllIII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllllllIIIIlIlIllI = new StringBuilder();
        char[] lllllllllllllllllllllIIIIlIlIlIl = lllllllllllllllllllllIIIIlIlIIlI.toCharArray();
        int lllllllllllllllllllllIIIIlIlIlII = lIIllllIII[2];
        char[] lllllllllllllllllllllIIIIlIIlllI = lllllllllllllllllllllIIIIlIllIII.toCharArray();
        int lllllllllllllllllllllIIIIlIIllIl = lllllllllllllllllllllIIIIlIIlllI.length;
        int lllllllllllllllllllllIIIIlIIllII = lIIllllIII[2];
        while (t.lIIIIlIlIlIII(lllllllllllllllllllllIIIIlIIllII, lllllllllllllllllllllIIIIlIIllIl)) {
            char lllllllllllllllllllllIIIIlIllIIl = lllllllllllllllllllllIIIIlIIlllI[lllllllllllllllllllllIIIIlIIllII];
            lllllllllllllllllllllIIIIlIlIllI.append((char)(lllllllllllllllllllllIIIIlIllIIl ^ lllllllllllllllllllllIIIIlIlIlIl[lllllllllllllllllllllIIIIlIlIlII % lllllllllllllllllllllIIIIlIlIlIl.length]));
            "".length();
            ++lllllllllllllllllllllIIIIlIlIlII;
            ++lllllllllllllllllllllIIIIlIIllII;
            "".length();
            if ("  ".length() >= 0) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllllllIIIIlIlIllI);
    }
    ...
    private static void af() {
        d lllllllllllllllllllllIIIIllIIlIl;
        Object lllllllllllllllllllllIIIIllIIllI;
        int[] nArray = new int[lIIllllIII[1]];
        ...
        if (t.lIIIIlIlIlIll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lllllllllllllllllllllIIIIllIIllI = new d(lIIllllIII[10], lIIllllIII[1], lIIllllIII[4]);
            bv.add((d)lllllllllllllllllllllIIIIllIIllI);
            "".length();
        }
        int[] nArray3 = new int[lIIllllIII[1]];
        nArray3[t.lIIllllIII[2]] = lIIllllIII[9];
        if (t.lIIIIlIlIlIll(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllllllllIIIIllIIllI = new d(lIIllllIII[9], lIIllllIII[1], lIIllllIII[4]);
            bv.add((d)lllllllllllllllllllllIIIIllIIllI);
            "".length();
        }
        ...
        if (t.lIIIIlIlIlIll(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllllllllIIIIllIIllI = new d(lIIllllIII[14], lIIllllIII[24], lIIllllIII[4]);
            bv.add((d)lllllllllllllllllllllIIIIllIIllI);
            "".length();
        }
        ...
        if (t.lIIIIlIlIlIll(Bank.contains((int[])nArray5) ? 1 : 0)) {
            lllllllllllllllllllllIIIIllIIllI = new d(lIIllllIII[16], lIIllllIII[24], i.bq);
            bv.add((d)lllllllllllllllllllllIIIIllIIllI);
            "".length();
        }
        ...
        if (t.lIIIIlIlIlIll(Bank.contains((int[])nArray6) ? 1 : 0)) {
            lllllllllllllllllllllIIIIllIIllI = new d(lIIllllIII[11], lIIllllIII[0], lIIllllIII[58]);
            bv.add((d)lllllllllllllllllllllIIIIllIIllI);
            "".length();
        }
        if (t.lIIIIlIlIlIll(Bank.contains((Predicate)(lllllllllllllllllllllIIIIllIIllI = item -> item.getName().toLowerCase().contains(lIIlllIllI[lIIllllIII[64]]))) ? 1 : 0)) {
            lllllllllllllllllllllIIIIllIIlIl = new d(lIIllllIII[59], lIIllllIII[13], lIIllllIII[60]);
            bv.add(lllllllllllllllllllllIIIIllIIlIl);
            "".length();
        }
        int[] nArray7 = new int[lIIllllIII[1]];
        nArray7[t.lIIllllIII[2]] = lIIllllIII[8];
        if (t.lIIIIlIlIlIll(Bank.contains((int[])nArray7) ? 1 : 0)) {
            lllllllllllllllllllllIIIIllIIlIl = new d(lIIllllIII[8], lIIllllIII[52], lIIllllIII[61]);
            bv.add(lllllllllllllllllllllIIIIllIIlIl);
            "".length();
        }
    }
    ...
    private static String lIIIIlIlIIIIl(String lllllllllllllllllllllIIIIlIIIIll, String lllllllllllllllllllllIIIIlIIIIII) {
        try {
            SecretKeySpec lllllllllllllllllllllIIIIlIIIllI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllllIIIIlIIIIII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllllllllIIIIlIIIlIl = Cipher.getInstance("Blowfish");
            lllllllllllllllllllllIIIIlIIIlIl.init(lIIllllIII[3], lllllllllllllllllllllIIIIlIIIllI);
            ...
            if (t.lIIIIlIlIlIll(bt ? 1 : 0)) {
                if (t.lIIIIlIlIlIll(t.ab() ? 1 : 0) && t.lIIIIlIlIlIII(e.j(cO), lIIllllIII[1])) {
                    ...
                    if (t.lIIIIlIlIlIll(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                        BankLocation lllllllllllllllllllllIIIIllIlIIl = BankLocation.getNearest();
                        if (t.lIIIIlIlIllII(lllllllllllllllllllllIIIIllIlIIl) && t.lIIIIlIlIlIll(lllllllllllllllllllllIIIIllIlIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            AccBuilderRogues.c = lIIlllIllI[lIIllllIII[3]];
                            a.a(lllllllllllllllllllllIIIIllIlIIl);
                        }
                        if (t.lIIIIlIlIllII(lllllllllllllllllllllIIIIllIlIIl) && t.lIIIIlIlIlIlI(lllllllllllllllllllllIIIIllIlIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
