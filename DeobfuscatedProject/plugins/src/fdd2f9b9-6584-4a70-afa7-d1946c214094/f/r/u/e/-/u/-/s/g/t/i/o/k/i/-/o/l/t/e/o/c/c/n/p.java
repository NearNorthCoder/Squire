...
implements G {
    ...
    private static void lllIlllllIIl() {
        ...
        p.lIIIllIllI[0] = " ".length();
        p.lIIIllIllI[1] = "  ".length();
        p.lIIIllIllI[2] = (10 + 86 - 87 + 132 ^ 90 + 78 - 48 + 38) & (0x47 ^ 0xF ^ (0xD ^ 0x56) ^ -" ".length());
        p.lIIIllIllI[3] = "   ".length();
    ...
    private static void lllIlllllIII() {
        ...
        p.lIIIllIlIl[p.lIIIllIllI[2]] = p.lllIllllIlll("b+yppFV36MM=", "ubtue");
        p.lIIIllIlIl[p.lIIIllIllI[0]] = p.lllIllllIlll("9mvwCzfIQAg1A+rDByHtcPYxQZcfjfMq", "FFQeG");
    ...
    public int T() {
        ...
        if (-" ".length() == "   ".length()) {
            return (92 + 149 - 225 + 147 ^ 142 + 23 - 159 + 167) & (0x52 ^ 0x29 ^ (0xEF ^ 0x9A) ^ -" ".length());
        }
        return lIIIllIllI[7];
    }
}
