...
implements G {
    ...
    private static boolean ab() {
        void llllllllllllllllllllIlllllllIllI;
        ...
        int[] nArray2 = nArray;
        int llllllllllllllllllllIlllllllIlIl = lIIllllIIl[1];
        while (C.lIIIIllIIIIlI(llllllllllllllllllllIlllllllIlIl, ((void)llllllllllllllllllllIlllllllIllI).length)) {
            int[] nArray3 = new int[lIIllllIIl[0]];
            nArray3[C.lIIllllIIl[1]] = llllllllllllllllllllIlllllllIllI[llllllllllllllllllllIlllllllIlIl];
            if (C.lIIIIllIIIIll(Inventory.contains((int[])nArray3) ? 1 : 0)) {
                return lIIllllIIl[1];
            }
            ++llllllllllllllllllllIlllllllIlIl;
            "".length();
            if (null == null) continue;
            return ((0x19 ^ 0x4C) & ~(0x3E ^ 0x6B)) != 0;
        }
        return lIIllllIIl[0];
    }
    ...
    private static void lIIIIlIllllll() {
        ...
        C.lIIllllIIl[0] = " ".length();
        C.lIIllllIIl[1] = (122 + 23 - 134 + 153 ^ 75 + 91 - 44 + 74) & (134 + 104 - 171 + 100 ^ 13 + 1 - 0 + 185 ^ -" ".length());
        C.lIIllllIIl[2] = -(0xFFFFCD24 & 0x7EFF) & (0xFFFFDFBB & 0x7FEF);
        C.lIIllllIIl[3] = "  ".length();
    ...
    public static void bH() {
        block134: {
            BankLocation lllllllllllllllllllllIIIIIIIIllI;
            block135: {
                WorldArea lllllllllllllllllllllIIIIIIIIlII;
                TileItem lllllllllllllllllllllIIIIIIIIlIl;
                block137: {
                    block136: {
                        ...
                        if (C.lIIIIllIIIIll(C.ab() ? 1 : 0) && C.lIIIIllIIIIlI(e.j(hW), lIIllllIIl[0])) {
                            lllllllllllllllllllllIIIIIIIIllI = BankLocation.getNearest();
                            if (C.lIIIIllIIIlII(lllllllllllllllllllllIIIIIIIIllI) && C.lIIIIllIIIIll(lllllllllllllllllllllIIIIIIIIllI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                AccBuilderRogues.c = lIIlllIlll[lIIllllIIl[0]];
                                a.a(lllllllllllllllllllllIIIIIIIIllI);
                            }
                            if (C.lIIIIllIIIlII(lllllllllllllllllllllIIIIIIIIllI) && C.lIIIIllIIIIIl(lllllllllllllllllllllIIIIIIIIllI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (C.lIIIIllIIIIll(Inventory.contains((int[])nArray4) ? 1 : 0)) {
                            ...
                            if (C.lIIIIllIIIIll(Inventory.contains((int[])nArray5) ? 1 : 0)) {
                                ...
                                if (C.lIIIIllIIIIll(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                                    lllllllllllllllllllllIIIIIIIIllI = new WorldPoint(lIIllllIIl[21], lIIllllIIl[22], lIIllllIIl[0]);
                                    ...
                                    if (C.lIIIIllIIIIll(Inventory.contains((int[])nArray6) ? 1 : 0)) {
                                        if (C.lIIIIllIIIlll(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllllllllllllllllllIIIIIIIIllI), lIIllllIIl[14])) {
                                            AccBuilderRogues.c = lIIlllIlll[lIIllllIIl[10]];
                                            Movement.walkTo((WorldPoint)lllllllllllllllllllllIIIIIIIIllI);
                                            "".length();
                                            Time.sleepTicks((int)lIIllllIIl[0]);
                                            "".length();
                                        }
                                        if (C.lIIIIllIIlIII(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllllllllllllllllllIIIIIIIIllI), lIIllllIIl[14])) {
                                            int[] nArray7 = new int[lIIllllIIl[0]];
                                            nArray7[C.lIIllllIIl[1]] = lIIllllIIl[11];
                                            lllllllllllllllllllllIIIIIIIIlIl = TileItems.getNearest((int[])nArray7);
                                            if (C.lIIIIllIIIlII(lllllllllllllllllllllIIIIIIIIlIl)) {
                                                if (C.lIIIIllIIIIll(Reachable.isInteractable((Locatable)lllllllllllllllllllllIIIIIIIIlIl) ? 1 : 0)) {
                                                    AccBuilderRogues.c = lIIlllIlll[lIIllllIIl[23]];
                                                    Movement.walkTo((WorldPoint)lllllllllllllllllllllIIIIIIIIlIl.getWorldLocation());
                                                    "".length();
                                                    Time.sleepTicks((int)lIIllllIIl[0]);
                                                    "".length();
                                                }
                                                if (C.lIIIIllIIIIIl(Reachable.isInteractable((Locatable)lllllllllllllllllllllIIIIIIIIlIl) ? 1 : 0)) {
                                                    AccBuilderRogues.c = lIIlllIlll[lIIllllIIl[24]];
                                                    lllllllllllllllllllllIIIIIIIIlIl.interact(lIIlllIlll[lIIllllIIl[25]]);
                ...
                if (C.lIIIIllIIIIIl(Inventory.contains((String[])stringArray7) ? 1 : 0)) {
                    ...
                    if (C.lIIIIllIIIIIl(Inventory.contains((String[])stringArray8) ? 1 : 0)) {
                        ...
                        if (C.lIIIIllIIIIll(Inventory.contains((String[])stringArray9) ? 1 : 0)) {
                            lllllllllllllllllllllIIIIIIIIllI = new WorldPoint(lIIllllIIl[43], lIIllllIIl[44], lIIllllIIl[1]);
                            lllllllllllllllllllllIIIIIIIIlIl = new WorldPoint(lIIllllIIl[21], lIIllllIIl[44], lIIllllIIl[1]);
                            lllllllllllllllllllllIIIIIIIIlII = new WorldArea(lIIllllIIl[21], lIIllllIIl[45], lIIllllIIl[14], lIIllllIIl[8], lIIllllIIl[1]);
                            if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllllllIIIIIIIIllI) ? 1 : 0) && C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllllllIIIIIIIIlIl) ? 1 : 0) && C.lIIIIllIIIIll(lllllllllllllllllllllIIIIIIIIlII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            if (C.lIIIIllIIIIIl(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllllllIIIIIIIIllI) ? 1 : 0)) {
                            ...
                            if (C.lIIIIllIIIIIl(lllllllllllllllllllllIIIIIIIIlII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (C.lIIIIllIIIIIl(Inventory.contains((String[])stringArray12) ? 1 : 0)) {
                    ...
                    if (C.lIIIIllIIIIll(Inventory.contains((String[])stringArray13) ? 1 : 0)) {
                        lllllllllllllllllllllIIIIIIIIllI = new WorldArea(lIIllllIIl[21], lIIllllIIl[45], lIIllllIIl[14], lIIllllIIl[8], lIIllllIIl[1]);
                        lllllllllllllllllllllIIIIIIIIlIl = new WorldArea(lIIllllIIl[54], lIIllllIIl[55], lIIllllIIl[18], lIIllllIIl[23], lIIllllIIl[1]);
                        if (C.lIIIIllIIIIIl(lllllllllllllllllllllIIIIIIIIllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (C.lIIIIllIIIIll(lllllllllllllllllllllIIIIIIIIlIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && C.lIIIIllIIIIll(hX.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (C.lIIIIllIIIIIl(lllllllllllllllllllllIIIIIIIIlIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (C.lIIIIllIIIIIl(hX.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            WorldPoint llllllllllllllllllllIllllllllIIl;
                            WorldPoint llllllllllllllllllllIllllllllIlI;
                            WorldPoint llllllllllllllllllllIllllllllIll;
                            lllllllllllllllllllllIIIIIIIIlII = new WorldPoint(lIIllllIIl[21], lIIllllIIl[61], lIIllllIIl[1]);
                            WorldPoint lllllllllllllllllllllIIIIIIIIIll = new WorldPoint(lIIllllIIl[62], lIIllllIIl[63], lIIllllIIl[1]);
                            ...
                            WorldPoint lllllllllllllllllllllIIIIIIIIIII = new WorldPoint(lIIllllIIl[67], lIIllllIIl[66], lIIllllIIl[1]);
                            WorldPoint llllllllllllllllllllIlllllllllll = new WorldPoint(lIIllllIIl[67], lIIllllIIl[66], lIIllllIIl[1]);
                            WorldArea llllllllllllllllllllIllllllllllI = new WorldArea(lIIllllIIl[68], lIIllllIIl[69], lIIllllIIl[20], lIIllllIIl[23], lIIllllIIl[1]);
                            WorldArea llllllllllllllllllllIlllllllllIl = new WorldArea(lIIllllIIl[70], lIIllllIIl[71], lIIllllIIl[14], lIIllllIIl[17], lIIllllIIl[1]);
                            WorldArea llllllllllllllllllllIlllllllllII = new WorldArea(lIIllllIIl[72], lIIllllIIl[73], lIIllllIIl[32], lIIllllIIl[25], lIIllllIIl[1]);
                            if (C.lIIIIllIIlIlI(Vars.getBit((int)lIIllllIIl[74]), lIIllllIIl[0]) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[75]))) {
                                if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllllllIIIIIIIIlII) ? 1 : 0)) {
                                    AccBuilderRogues.c = lIIlllIlll[lIIllllIIl[76]];
                                    Movement.walkTo((WorldPoint)lllllllllllllllllllllIIIIIIIIlII);
                                    "".length();
                                    Time.sleepTicks((int)lIIllllIIl[0]);
                                    "".length();
                                }
                                if (C.lIIIIllIIIIIl(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllllllIIIIIIIIlII) ? 1 : 0)) {
                            ...
                            if (C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[74]), lIIllllIIl[0]) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[80])) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[75]))) {
                                if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllllllIIIIIIIIIll) ? 1 : 0)) {
                                    AccBuilderRogues.c = lIIlllIlll[lIIllllIIl[81]];
                                    Movement.walkTo((WorldPoint)lllllllllllllllllllllIIIIIIIIIll);
                                    "".length();
                                    Time.sleepTicks((int)lIIllllIIl[0]);
                                    "".length();
                                }
                                if (C.lIIIIllIIIIIl(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllllllIIIIIIIIIll) ? 1 : 0)) {
                            ...
                            if (C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[74]), lIIllllIIl[0]) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[80]), lIIllllIIl[0]) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[75]))) {
                                if (C.lIIIIllIIIIll(llllllllllllllllllllIllllllllllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    llllllllllllllllllllIllllllllIll = new WorldPoint(lIIllllIIl[21], lIIllllIIl[84], lIIllllIIl[1]);
                                    if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIllllllllIll) ? 1 : 0)) {
                                        AccBuilderRogues.c = lIIlllIlll[lIIllllIIl[85]];
                                        Movement.walkTo((WorldPoint)llllllllllllllllllllIllllllllIll);
                                        "".length();
                                        Time.sleepTicks((int)lIIllllIIl[0]);
                                        "".length();
                                    }
                                    if (C.lIIIIllIIIIIl(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIllllllllIll) ? 1 : 0)) {
                                ...
                                if (C.lIIIIllIIIIIl(llllllllllllllllllllIllllllllllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            if (C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[74]), lIIllllIIl[0]) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[80]), lIIllllIIl[0]) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[75]), lIIllllIIl[0])) {
                                if (C.lIIIIllIIIIIl(llllllllllllllllllllIllllllllllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    llllllllllllllllllllIllllllllIll = new WorldPoint(lIIllllIIl[21], lIIllllIIl[91], lIIllllIIl[1]);
                                    if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIllllllllIll) ? 1 : 0)) {
                            ...
                            if (C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[74])) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[80])) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[75]), lIIllllIIl[0]) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[103])) && C.lIIIIllIIIIll(C.bI() ? 1 : 0)) {
                                if (C.lIIIIllIIIIll(llllllllllllllllllllIlllllllllIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    if (C.lIIIIllIIIIIl(llllllllllllllllllllIlllllllllII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                        llllllllllllllllllllIllllllllIll = new WorldPoint(lIIllllIIl[104], lIIllllIIl[84], lIIllllIIl[1]);
                                        if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIllllllllIll) ? 1 : 0)) {
                                    ...
                                    if (C.lIIIIllIIIIIl((llllllllllllllllllllIllllllllIll = new WorldArea(lIIllllIIl[72], lIIllllIIl[69], lIIllllIIl[14], lIIllllIIl[14], lIIllllIIl[1])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && C.lIIIIllIIIIll(C.bI() ? 1 : 0)) {
                                        llllllllllllllllllllIllllllllIlI = new WorldPoint(lIIllllIIl[108], lIIllllIIl[109], lIIllllIIl[1]);
                                        if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIllllllllIlI) ? 1 : 0)) {
                                            AccBuilderRogues.c = lIIlllIlll[lIIllllIIl[110]];
                                            Movement.walkTo((WorldPoint)llllllllllllllllllllIllllllllIlI);
                                            "".length();
                                            Time.sleepTicks((int)lIIllllIIl[0]);
                                            "".length();
                                        }
                                        if (C.lIIIIllIIIIIl(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIllllllllIlI) ? 1 : 0)) {
                                    ...
                                    if (C.lIIIIllIIIIIl((llllllllllllllllllllIllllllllIlI = new WorldArea(lIIllllIIl[70], lIIllllIIl[69], lIIllllIIl[14], lIIllllIIl[14], lIIllllIIl[1])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                        llllllllllllllllllllIllllllllIIl = new WorldPoint(lIIllllIIl[67], lIIllllIIl[113], lIIllllIIl[1]);
                                        if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIllllllllIIl) ? 1 : 0)) {
                                            AccBuilderRogues.c = lIIlllIlll[lIIllllIIl[114]];
                                            Movement.walkTo((WorldPoint)llllllllllllllllllllIllllllllIIl);
                                            "".length();
                                            Time.sleepTicks((int)lIIllllIIl[0]);
                                            "".length();
                                        }
                                        if (C.lIIIIllIIIIIl(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIllllllllIIl) ? 1 : 0)) {
                                ...
                                if (C.lIIIIllIIIIIl(llllllllllllllllllllIlllllllllIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && C.lIIIIllIIIIll(C.bI() ? 1 : 0)) {
                                    if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllllllIIIIIIIIIII) ? 1 : 0)) {
                                        AccBuilderRogues.c = lIIlllIlll[lIIllllIIl[117]];
                                        Movement.walkTo((WorldPoint)lllllllllllllllllllllIIIIIIIIIII);
                                        "".length();
                                        Time.sleepTicks((int)lIIllllIIl[0]);
                                        "".length();
                                    }
                                    if (C.lIIIIllIIIIIl(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllllllIIIIIIIIIII) ? 1 : 0)) {
                            ...
                            if (C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[74])) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[80])) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[75]), lIIllllIIl[0]) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[103]), lIIllllIIl[0]) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[121]))) {
                                if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIlllllllllll) ? 1 : 0)) {
                                    AccBuilderRogues.c = lIIlllIlll[lIIllllIIl[122]];
                                    Movement.walkTo((WorldPoint)llllllllllllllllllllIlllllllllll);
                                    "".length();
                                    Time.sleepTicks((int)lIIllllIIl[0]);
                                    "".length();
                                }
                                if (C.lIIIIllIIIIIl(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIlllllllllll) ? 1 : 0)) {
                            ...
                            if (C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[74])) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[80])) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[75]), lIIllllIIl[0]) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[103]), lIIllllIIl[0]) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[121]), lIIllllIIl[0]) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[126]))) {
                                llllllllllllllllllllIllllllllIll = new WorldArea(lIIllllIIl[72], lIIllllIIl[71], lIIllllIIl[14], lIIllllIIl[14], lIIllllIIl[1]);
                                if (C.lIIIIllIIIIIl(llllllllllllllllllllIlllllllllIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    llllllllllllllllllllIllllllllIlI = new WorldPoint(lIIllllIIl[127], lIIllllIIl[66], lIIllllIIl[1]);
                                    if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIllllllllIlI) ? 1 : 0)) {
                                ...
                                if (C.lIIIIllIIIIIl(llllllllllllllllllllIllllllllIll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    llllllllllllllllllllIllllllllIlI = new WorldPoint(lIIllllIIl[131], lIIllllIIl[66], lIIllllIIl[1]);
                                    if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIllllllllIlI) ? 1 : 0)) {
                            ...
                            if (C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[74])) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[80])) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[75]), lIIllllIIl[0]) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[103]), lIIllllIIl[0]) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[121]), lIIllllIIl[0]) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[126]), lIIllllIIl[0])) {
                                llllllllllllllllllllIllllllllIll = new WorldArea(lIIllllIIl[72], lIIllllIIl[71], lIIllllIIl[14], lIIllllIIl[14], lIIllllIIl[1]);
                                if (C.lIIIIllIIIIIl(llllllllllllllllllllIllllllllllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    llllllllllllllllllllIllllllllIlI = new WorldPoint(lIIllllIIl[138], lIIllllIIl[66], lIIllllIIl[1]);
                                    if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIllllllllIlI) ? 1 : 0)) {
                                ...
                                if (C.lIIIIllIIIIIl(llllllllllllllllllllIllllllllIll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    llllllllllllllllllllIllllllllIlI = new WorldPoint(lIIllllIIl[108], lIIllllIIl[66], lIIllllIIl[1]);
                                    if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIllllllllIlI) ? 1 : 0)) {
                            ...
                            if (C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[74])) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[80])) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[75]), lIIllllIIl[0]) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[103])) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[121]), lIIllllIIl[0]) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[126]), lIIllllIIl[0])) {
                                ...
                                if (C.lIIIIllIIIIIl(llllllllllllllllllllIllllllllIll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    llllllllllllllllllllIllllllllIlI = new WorldPoint(lIIllllIIl[104], lIIllllIIl[152], lIIllllIIl[1]);
                                    if (C.lIIIIllIIIIll(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllllIllllllllIlI) ? 1 : 0)) {
                                ...
                                if (C.lIIIIllIIIIIl((llllllllllllllllllllIllllllllIlI = new WorldArea(lIIllllIIl[72], lIIllllIIl[69], lIIllllIIl[14], lIIllllIIl[14], lIIllllIIl[1])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && C.lIIIIllIIIIll(Players.getLocal().isMoving() ? 1 : 0)) {
                                ...
                                if (C.lIIIIllIIIIIl((llllllllllllllllllllIllllllllIIl = new WorldArea(lIIllllIIl[161], lIIllllIIl[162], lIIllllIIl[23], lIIllllIIl[14], lIIllllIIl[1])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (C.lIIIIllIIIIIl(Inventory.contains((String[])stringArray38) ? 1 : 0)) {
                    ...
                    if (C.lIIIIllIIIIIl(Inventory.contains((String[])stringArray39) ? 1 : 0)) {
                        lllllllllllllllllllllIIIIIIIIllI = new WorldArea(lIIllllIIl[161], lIIllllIIl[162], lIIllllIIl[23], lIIllllIIl[14], lIIllllIIl[1]);
                        if (C.lIIIIllIIIIIl(lllllllllllllllllllllIIIIIIIIllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            int[] nArray = new int[lIIllllIIl[0]];
                            nArray[C.lIIllllIIl[1]] = lIIllllIIl[159];
                        ...
                        if (C.lIIIIllIIlIII(Players.getLocal().getWorldLocation().distanceTo(hV), lIIllllIIl[10])) {
                            lllllllllllllllllllllIIIIIIIIlIl = TileObjects.getNearest(tileObject -> {
                                int n2;
                            ...
                            if (C.lIIIIllIIIlII(lllllllllllllllllllllIIIIIIIIlIl)) {
                                lllllllllllllllllllllIIIIIIIIlIl.interact(lIIlllIlll[lIIllllIIl[170]]);
                                Time.sleepTicks((int)lIIllllIIl[8]);
                                "".length();
                            }
                            if (C.lIIIIllIIlIll(lllllllllllllllllllllIIIIIIIIlIl)) {
            ...
            if (C.lIIIIllIIlIIl(e.j(hW), lIIllllIIl[3])) {
                ...
                if (C.lIIIIllIIlIII(Players.getLocal().getWorldLocation().distanceTo(hV), lIIllllIIl[10])) {
                    lllllllllllllllllllllIIIIIIIIllI = TileObjects.getNearest(tileObject -> {
                        int n2;
                        if (C.lIIIIllIIIIIl(tileObject.getName().contains(lIIlllIlll[lIIllllIIl[182]]) ? 1 : 0)) {
                            ...
                            if (C.lIIIIllIIIIIl(tileObject.hasAction(stringArray) ? 1 : 0) && C.lIIIIllIIlIII(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIllllIIl[21], lIIllllIIl[184], lIIllllIIl[3])), lIIllllIIl[3])) {
                                ...
                                return ((18 + 141 - 53 + 55 ^ 43 + 31 - -99 + 12) & (21 + 17 - 28 + 118 ^ 129 + 72 - 159 + 110 ^ -" ".length())) != 0;
                            }
                        }
                        n2 = lIIllllIIl[1];
                        return n2 != 0;
                    });
                    if (C.lIIIIllIIIlII(lllllllllllllllllllllIIIIIIIIllI)) {
                        lllllllllllllllllllllIIIIIIIIllI.interact(lIIlllIlll[lIIllllIIl[173]]);
                        Time.sleepTicks((int)lIIllllIIl[8]);
                        "".length();
                    }
                    if (C.lIIIIllIIlIll(lllllllllllllllllllllIIIIIIIIllI)) {
    ...
    static boolean bI() {
        ...
        if (C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[74])) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[80])) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[75]), lIIllllIIl[0]) && C.lIIIIllIIIIll(Vars.getBit((int)lIIllllIIl[103])) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[121]), lIIllllIIl[0]) && C.lIIIIllIIlIIl(Vars.getBit((int)lIIllllIIl[126]), lIIllllIIl[0])) {
            n2 = lIIllllIIl[0];
            "".length();
            if (((0x57 ^ 0x60) & ~(0x4F ^ 0x78)) >= "   ".length()) {
                return ((0x73 ^ 0x3B) & ~(0x6C ^ 0x24)) != 0;
            }
        } else {
            n2 = lIIllllIIl[1];
        }
    ...
    private static String lIIIIlIlIIlIl(String llllllllllllllllllllIlllllIlIIll, String llllllllllllllllllllIlllllIIllIl) {
        llllllllllllllllllllIlllllIlIIll = new String(Base64.getDecoder().decode(llllllllllllllllllllIlllllIlIIll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllllIlllllIlIIIl = new StringBuilder();
        char[] llllllllllllllllllllIlllllIlIIII = llllllllllllllllllllIlllllIIllIl.toCharArray();
        int llllllllllllllllllllIlllllIIllll = lIIllllIIl[1];
        char[] llllllllllllllllllllIlllllIIlIIl = llllllllllllllllllllIlllllIlIIll.toCharArray();
        int llllllllllllllllllllIlllllIIlIII = llllllllllllllllllllIlllllIIlIIl.length;
        int llllllllllllllllllllIlllllIIIlll = lIIllllIIl[1];
        while (C.lIIIIllIIIIlI(llllllllllllllllllllIlllllIIIlll, llllllllllllllllllllIlllllIIlIII)) {
            char llllllllllllllllllllIlllllIlIlII = llllllllllllllllllllIlllllIIlIIl[llllllllllllllllllllIlllllIIIlll];
            ...
            ++llllllllllllllllllllIlllllIIIlll;
            "".length();
            if (null == null) continue;
            return null;
        }
    ...
    public boolean V() {
        ...
        if (C.lIIIIllIIllII(e.j(lIIllllIIl[47]), lIIllllIIl[8])) {
            bl = lIIllllIIl[0];
            "".length();
            if ((21 + 73 - 11 + 106 ^ 29 + 157 - 104 + 103) <= "   ".length()) {
                return ((0xC1 ^ 0x9A ^ (0x30 ^ 0x3C)) & (0xB ^ 0x65 ^ (0xD ^ 0x34) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIllllIIl[1];
        }
    ...
    private static void lIIIIlIllIIIl() {
        ...
        C.lIIlllIlll[C.lIIllllIIl[1]] = C.lIIIIlIlIIIll("RBZX+BNYYjLKeUtXADvIQiS7WTfgzFe9G47kOPHYrK6+E69VBjQjsqfUSPZfPk2J", "cneTz");
        C.lIIlllIlll[C.lIIllllIIl[0]] = C.lIIIIlIlIIlII("CoHxHv3ZAaG5V+Nv8tA8vg==", "UZCro");
        C.lIIlllIlll[C.lIIllllIIl[3]] = C.lIIIIlIlIIIll("WRnf3wsyKnAyuhoWteZfO44ICRAYHAQ0", "WRYjZ");
        C.lIIlllIlll[C.lIIllllIIl[8]] = C.lIIIIlIlIIIll("px22TP5Dg09yDmc4C2WZz5ldMLv6zrOX2vpL6C9QzDMmb1+v8F5vysc9CTyi5QebSavPVKoJO8Y=", "eMBub");
        C.lIIlllIlll[C.lIIllllIIl[4]] = C.lIIIIlIlIIlIl("PBMzGAY=", "xaZvm");
        C.lIIlllIlll[C.lIIllllIIl[14]] = C.lIIIIlIlIIIll("rCfgeBWhWKI=", "GgydB");
        C.lIIlllIlll[C.lIIllllIIl[17]] = C.lIIIIlIlIIIll("CPXr7QtOfVlH4Hhw+HA7gA==", "RDjLT");
        C.lIIlllIlll[C.lIIllllIIl[18]] = C.lIIIIlIlIIlIl("Oz0gPSxIODQqKxw=", "hIAOX");
        C.lIIlllIlll[C.lIIllllIIl[16]] = C.lIIIIlIlIIlII("CyUf57mh0F/0SjIhnW9nVg==", "PuLeh");
        C.lIIlllIlll[C.lIIllllIIl[20]] = C.lIIIIlIlIIlII("ySR/BZTNfc4=", "wOYOk");
        C.lIIlllIlll[C.lIIllllIIl[10]] = C.lIIIIlIlIIlII("NO/NzJ80hBaEJXrvfkPmMnd/+86sX4PG", "XqAlQ");
        C.lIIlllIlll[C.lIIllllIIl[23]] = C.lIIIIlIlIIIll("9N8heQS/TeN5eCMhLcoJgt/3Azw//Czc", "FIPMf");
        C.lIIlllIlll[C.lIIllllIIl[24]] = C.lIIIIlIlIIlII("dyKKRayDcHsG/W50O0BiNQ==", "ljNmI");
        C.lIIlllIlll[C.lIIllllIIl[25]] = C.lIIIIlIlIIlIl("HwknBA==", "KhLaT");
        C.lIIlllIlll[C.lIIllllIIl[26]] = C.lIIIIlIlIIIll("oBGxYusKh2UZEEdF1hsx7dUHRPyRT4zE", "vJkWF");
        C.lIIlllIlll[C.lIIllllIIl[27]] = C.lIIIIlIlIIlIl("ISwN", "jItyo");
        C.lIIlllIlll[C.lIIllllIIl[28]] = C.lIIIIlIlIIlII("C6skvZX9nzObdsHFo6UtEA==", "vFKKb");
        C.lIIlllIlll[C.lIIllllIIl[29]] = C.lIIIIlIlIIlII("MHeNDPywVPc=", "lxzXf");
        C.lIIlllIlll[C.lIIllllIIl[30]] = C.lIIIIlIlIIlIl("BRcZJCU1DFQ8LycI", "FxtTJ");
        C.lIIlllIlll[C.lIIllllIIl[31]] = C.lIIIIlIlIIIll("2q7OQunM3e0=", "UOTyL");
        C.lIIlllIlll[C.lIIllllIIl[32]] = C.lIIIIlIlIIlIl("BDc+", "ORGXo");
        C.lIIlllIlll[C.lIIllllIIl[33]] = C.lIIIIlIlIIlIl("FzQ/QRw2dS8OHTchKAgG", "YUIah");
        C.lIIlllIlll[C.lIIllllIIl[34]] = C.lIIIIlIlIIlII("l3umkhoGrS1CR8ztf0qZhQ==", "baCtH");
        C.lIIlllIlll[C.lIIllllIIl[35]] = C.lIIIIlIlIIIll("r00UqbgJZG8=", "PxFZM");
        C.lIIlllIlll[C.lIIllllIIl[36]] = C.lIIIIlIlIIIll("WCk//dZGGj3FqMPtSK/A0w==", "FXQRe");
        C.lIIlllIlll[C.lIIllllIIl[37]] = C.lIIIIlIlIIIll("xMthGV3ZcmT1sY+ytJz0cQ==", "VADZX");
        C.lIIlllIlll[C.lIIllllIIl[38]] = C.lIIIIlIlIIlII("XQOWiHC9CnSgBX94m8V0fg==", "UxbZt");
        C.lIIlllIlll[C.lIIllllIIl[39]] = C.lIIIIlIlIIlIl("MTYxOCIK", "bSPJA");
        C.lIIlllIlll[C.lIIllllIIl[40]] = C.lIIIIlIlIIlII("hhYifZs+Xzk=", "PuCKR");
        C.lIIlllIlll[C.lIIllllIIl[41]] = C.lIIIIlIlIIlIl("GR8wEic8HzBBMygYMgQ=", "ImUaT");
        C.lIIlllIlll[C.lIIllllIIl[42]] = C.lIIIIlIlIIlII("yWnhzPU2IYrOld/uvtY3bA==", "UwHOr");
        C.lIIlllIlll[C.lIIllllIIl[46]] = C.lIIIIlIlIIlII("CD+uT2Zq89tpWE3XY7WPxA==", "Pbpki");
        C.lIIlllIlll[C.lIIllllIIl[47]] = C.lIIIIlIlIIlII("8P4EM5EJDq8=", "wcOOy");
        C.lIIlllIlll[C.lIIllllIIl[48]] = C.lIIIIlIlIIlIl("CSY3NA==", "FVRZf");
        C.lIIlllIlll[C.lIIllllIIl[49]] = C.lIIIIlIlIIIll("lEq6ib1teZnZ9393YjK1qw==", "GYCar");
        C.lIIlllIlll[C.lIIllllIIl[50]] = C.lIIIIlIlIIIll("XTUUyCL1i10pCyO4UjTepQ==", "pfoEy");
        C.lIIlllIlll[C.lIIllllIIl[51]] = C.lIIIIlIlIIlIl("HSskDw==", "IJOjR");
        C.lIIlllIlll[C.lIIllllIIl[52]] = C.lIIIIlIlIIlII("sdZMQI8MvxmAz+vJOmtKJw==", "IFSMP");
        C.lIIlllIlll[C.lIIllllIIl[53]] = C.lIIIIlIlIIIll("tqBoMCp8sTc=", "TlJmU");
        C.lIIlllIlll[C.lIIllllIIl[56]] = C.lIIIIlIlIIlIl("MQEdNA==", "unrFT");
        C.lIIlllIlll[C.lIIllllIIl[57]] = C.lIIIIlIlIIIll("9OBJVtzyIhA=", "Lhenv");
        C.lIIlllIlll[C.lIIllllIIl[58]] = C.lIIIIlIlIIlIl("Jzs1UxoGeiUaAAg2YwEBBjc=", "iZCsn");
        C.lIIlllIlll[C.lIIllllIIl[59]] = C.lIIIIlIlIIlII("C+KARuJFQ0Q=", "YdUlT");
        C.lIIlllIlll[C.lIIllllIIl[60]] = C.lIIIIlIlIIIll("wPluOeY2gXp32j5NMJ4Dcw==", "GjWeT");
        C.lIIlllIlll[C.lIIllllIIl[76]] = C.lIIIIlIlIIlIl("GgMxYg47QiY=", "TbGBz");
        C.lIIlllIlll[C.lIIllllIIl[77]] = C.lIIIIlIlIIlII("KVFgmn2b5YATSV77Tnjnbg==", "cTZdE");
        C.lIIlllIlll[C.lIIllllIIl[78]] = C.lIIIIlIlIIlIl("KgQcNB9GIA==", "fajQm");
        C.lIIlllIlll[C.lIIllllIIl[79]] = C.lIIIIlIlIIlII("btV1TAFF8J8=", "fDbld");
        C.lIIlllIlll[C.lIIllllIIl[81]] = C.lIIIIlIlIIlIl("HxkPaS4+WBs=", "QxyIZ");
        C.lIIlllIlll[C.lIIllllIIl[82]] = C.lIIIIlIlIIlII("pnV6Roljx06TNBDzfUKGlg==", "hWbOg");
        C.lIIlllIlll[C.lIIllllIIl[15]] = C.lIIIIlIlIIIll("ZK6Jo/CnSkQ=", "GFRsN");
        C.lIIlllIlll[C.lIIllllIIl[83]] = C.lIIIIlIlIIlII("6SVNAeZtrIA=", "AWSau");
        C.lIIlllIlll[C.lIIllllIIl[85]] = C.lIIIIlIlIIIll("j9r8BCs61sYy5nNQjaZBrg==", "YlBjI");
        C.lIIlllIlll[C.lIIllllIIl[86]] = C.lIIIIlIlIIIll("rXfUwq8uCOQ=", "QAqiX");
        C.lIIlllIlll[C.lIIllllIIl[87]] = C.lIIIIlIlIIlIl("FjsPAg==", "YKjlL");
        C.lIIlllIlll[C.lIIllllIIl[88]] = C.lIIIIlIlIIIll("yvQgymN3W+qOr4YY/CaiqA==", "gkyMc");
        C.lIIlllIlll[C.lIIllllIIl[89]] = C.lIIIIlIlIIIll("ZhHwIhNHwfE=", "EgmuB");
        C.lIIlllIlll[C.lIIllllIIl[90]] = C.lIIIIlIlIIlIl("BRcpLw==", "UbECV");
        C.lIIlllIlll[C.lIIllllIIl[92]] = C.lIIIIlIlIIIll("7QOvpQBq+3nogIFnzUW9Hg==", "peFME");
        C.lIIlllIlll[C.lIIllllIIl[93]] = C.lIIIIlIlIIlIl("PSMgJw==", "yLOUi");
        C.lIIlllIlll[C.lIIllllIIl[94]] = C.lIIIIlIlIIlII("O1zBUS+wHSs=", "rnZfT");
        C.lIIlllIlll[C.lIIllllIIl[95]] = C.lIIIIlIlIIlIl("IA0idyMBTDY=", "nlTWW");
        C.lIIlllIlll[C.lIIllllIIl[96]] = C.lIIIIlIlIIIll("PeeXU+1jNzDdxZZuphQRSA==", "tJsxx");
        C.lIIlllIlll[C.lIIllllIIl[97]] = C.lIIIIlIlIIIll("OfhGPf929s4=", "pJsEY");
        C.lIIlllIlll[C.lIIllllIIl[98]] = C.lIIIIlIlIIIll("3g/cwJvWTIc=", "ZLDXE");
        C.lIIlllIlll[C.lIIllllIIl[99]] = C.lIIIIlIlIIIll("RIxFl0mOJ9iMRGAtG9u+Uw==", "ltTBq");
        C.lIIlllIlll[C.lIIllllIIl[100]] = C.lIIIIlIlIIlII("zzpYaUYp/RH7AkKvyuVVPA==", "lNAKo");
        C.lIIlllIlll[C.lIIllllIIl[101]] = C.lIIIIlIlIIlIl("Kw8MACtHKw==", "gjzeY");
        C.lIIlllIlll[C.lIIllllIIl[102]] = C.lIIIIlIlIIlII("pq+SGFpB8Xc=", "bgLHf");
        C.lIIlllIlll[C.lIIllllIIl[105]] = C.lIIIIlIlIIIll("d5giVU8r1z8jqveoD8o2zg==", "sXTZK");
        C.lIIlllIlll[C.lIIllllIIl[106]] = C.lIIIIlIlIIlII("0HS7O6u8/14=", "TTcLm");
        C.lIIlllIlll[C.lIIllllIIl[107]] = C.lIIIIlIlIIIll("buYtJc+FpbI=", "OriVm");
        C.lIIlllIlll[C.lIIllllIIl[110]] = C.lIIIIlIlIIIll("R+AuqrJlz9TbS0mC9tF0dA==", "UhQvJ");
        C.lIIlllIlll[C.lIIllllIIl[111]] = C.lIIIIlIlIIlIl("Ix0bKg==", "grtXr");
        C.lIIlllIlll[C.lIIllllIIl[112]] = C.lIIIIlIlIIIll("8HnAoyB/Irg=", "AMRyy");
        C.lIIlllIlll[C.lIIllllIIl[114]] = C.lIIIIlIlIIlII("1pba0NCUmBcM4f2Ntx3aFQ==", "dmwfG");
        C.lIIlllIlll[C.lIIllllIIl[115]] = C.lIIIIlIlIIlII("eA6aARsAvF0=", "KqPef");
        C.lIIlllIlll[C.lIIllllIIl[116]] = C.lIIIIlIlIIlII("jFajeKGsHrU=", "JBosj");
        C.lIIlllIlll[C.lIIllllIIl[117]] = C.lIIIIlIlIIlII("bUc0kq/RaBJQzaBuRWFVFQ==", "wsHPz");
        C.lIIlllIlll[C.lIIllllIIl[118]] = C.lIIIIlIlIIlIl("PwIOKnkDEhQjKw==", "owbFY");
        C.lIIlllIlll[C.lIIllllIIl[119]] = C.lIIIIlIlIIlIl("ORI0CiFVMg==", "uwBoS");
        C.lIIlllIlll[C.lIIllllIIl[120]] = C.lIIIIlIlIIlII("OBw7uALQfns=", "lVgfm");
        C.lIIlllIlll[C.lIIllllIIl[122]] = C.lIIIIlIlIIlIl("LyoCcTEOaxI=", "aKtQE");
        C.lIIlllIlll[C.lIIllllIIl[123]] = C.lIIIIlIlIIlIl("KiYBIUsWNhsoGQ==", "zSmMk");
        C.lIIlllIlll[C.lIIllllIIl[124]] = C.lIIIIlIlIIlII("nRk1LH21fqA=", "GaUsL");
        C.lIIlllIlll[C.lIIllllIIl[125]] = C.lIIIIlIlIIlIl("Gz0ODg==", "KHbbq");
        C.lIIlllIlll[C.lIIllllIIl[128]] = C.lIIIIlIlIIlII("/6G1+BiqW5yg7dTGy+sJlQ==", "Scmif");
        C.lIIlllIlll[C.lIIllllIIl[129]] = C.lIIIIlIlIIIll("693T9J6U1+c=", "gzFsq");
        C.lIIlllIlll[C.lIIllllIIl[130]] = C.lIIIIlIlIIIll("T7tNP3G+MhA=", "mOMWA");
        C.lIIlllIlll[C.lIIllllIIl[132]] = C.lIIIIlIlIIlIl("OgE1KFADAWMpHxgc", "wnCMp");
        C.lIIlllIlll[C.lIIllllIIl[133]] = C.lIIIIlIlIIlII("s3VMtB4jqsc=", "HtcEU");
        C.lIIlllIlll[C.lIIllllIIl[134]] = C.lIIIIlIlIIIll("lhFQ7Un7BWM=", "erPkm");
        C.lIIlllIlll[C.lIIllllIIl[135]] = C.lIIIIlIlIIIll("fDD0dOiLytzG263daZO2Og==", "Icbaw");
        C.lIIlllIlll[C.lIIllllIIl[136]] = C.lIIIIlIlIIlII("OOoRuftz+CM=", "ELbhP");
        C.lIIlllIlll[C.lIIllllIIl[137]] = C.lIIIIlIlIIIll("Vf63fAnI2l4=", "EdlXV");
        C.lIIlllIlll[C.lIIllllIIl[139]] = C.lIIIIlIlIIlII("08zD7h6i65INom7PbwDCGQ==", "PxKvl");
        C.lIIlllIlll[C.lIIllllIIl[140]] = C.lIIIIlIlIIlIl("MgUGOw==", "vjiIb");
        C.lIIlllIlll[C.lIIllllIIl[141]] = C.lIIIIlIlIIlII("mwitVQ1Yhxg=", "Fxrhp");
        C.lIIlllIlll[C.lIIllllIIl[142]] = C.lIIIIlIlIIIll("qjEjaxOp7LY1bjZl6NM7hg==", "qjpzQ");
        C.lIIlllIlll[C.lIIllllIIl[143]] = C.lIIIIlIlIIlIl("Lz8NEw==", "kPban");
        C.lIIlllIlll[C.lIIllllIIl[144]] = C.lIIIIlIlIIIll("8YUJ+fc5knQ=", "XNxsO");
        C.lIIlllIlll[C.lIIllllIIl[145]] = C.lIIIIlIlIIlIl("BBESSiAlUAE=", "JpdjT");
        C.lIIlllIlll[C.lIIllllIIl[146]] = C.lIIIIlIlIIIll("mIo8LOWAKmUOnBT90w3ykA==", "MGgAR");
        C.lIIlllIlll[C.lIIllllIIl[147]] = C.lIIIIlIlIIlIl("Ag4xFTFuLg==", "NkGpC");
        C.lIIlllIlll[C.lIIllllIIl[148]] = C.lIIIIlIlIIlIl("NSMbKA==", "eVwDF");
        C.lIIlllIlll[C.lIIllllIIl[149]] = C.lIIIIlIlIIlIl("Bi4SAkk/LkQDBiQz", "KAdgi");
        C.lIIlllIlll[C.lIIllllIIl[150]] = C.lIIIIlIlIIIll("XIcVgP4itwI=", "iudgu");
        C.lIIlllIlll[C.lIIllllIIl[151]] = C.lIIIIlIlIIlIl("DjYjPg==", "AFFPw");
        C.lIIlllIlll[C.lIIllllIIl[153]] = C.lIIIIlIlIIIll("yj5UEVR5Oaw+H3v8YICJYA==", "SVPsu");
        C.lIIlllIlll[C.lIIllllIIl[154]] = C.lIIIIlIlIIlII("iuSF4Q6GLGE=", "XTLMZ");
        C.lIIlllIlll[C.lIIllllIIl[155]] = C.lIIIIlIlIIlII("1f8N549ZwfI=", "MnRKg");
        C.lIIlllIlll[C.lIIllllIIl[156]] = C.lIIIIlIlIIlII("X36B5z849yLzAKg+EI4j5w==", "BtNvt");
        C.lIIlllIlll[C.lIIllllIIl[158]] = C.lIIIIlIlIIIll("TTIom577tfM=", "Pasxj");
        C.lIIlllIlll[C.lIIllllIIl[160]] = C.lIIIIlIlIIIll("u56IQEGbXx4=", "RTTgj");
        C.lIIlllIlll[C.lIIllllIIl[163]] = C.lIIIIlIlIIlIl("DTACRAwjNw==", "BYndo");
        C.lIIlllIlll[C.lIIllllIIl[164]] = C.lIIIIlIlIIlII("ygoARX3z1Rw=", "APpeU");
        C.lIIlllIlll[C.lIIllllIIl[165]] = C.lIIIIlIlIIlII("7W/yW8qWv2o=", "twRSY");
        C.lIIlllIlll[C.lIIllllIIl[166]] = C.lIIIIlIlIIIll("QvzlK92qnFBLhWC3939+hQ==", "WhzXf");
        C.lIIlllIlll[C.lIIllllIIl[167]] = C.lIIIIlIlIIlII("63TmxIA8iCs=", "dVAHg");
        C.lIIlllIlll[C.lIIllllIIl[168]] = C.lIIIIlIlIIlII("jtmf+Ee/3xk=", "kFigf");
        C.lIIlllIlll[C.lIIllllIIl[169]] = C.lIIIIlIlIIlIl("IhQfSyEDVRkZOgoQGhg6Hg==", "luikU");
        C.lIIlllIlll[C.lIIllllIIl[170]] = C.lIIIIlIlIIlII("C6LH3L7HYYM=", "AuAMt");
        C.lIIlllIlll[C.lIIllllIIl[171]] = C.lIIIIlIlIIIll("oquzobw+meWp65qv+sK4v5G9QtfTsk9+", "AWhlo");
        C.lIIlllIlll[C.lIIllllIIl[172]] = C.lIIIIlIlIIlII("2jbTy+NA8nZ8lS7GieKEUi5l844RLkoX", "UkVin");
        C.lIIlllIlll[C.lIIllllIIl[173]] = C.lIIIIlIlIIlII("F45hyfxo85o=", "ZyrEm");
        C.lIIlllIlll[C.lIIllllIIl[174]] = C.lIIIIlIlIIlIl("Kgo4IyMJCzg3ZjUcMyAoCQwyLCg=", "zxWEF");
        C.lIIlllIlll[C.lIIllllIIl[180]] = C.lIIIIlIlIIIll("sppIJA+TVBFeQxihwkwvAM/mF887RB2o", "mUIfx");
        C.lIIlllIlll[C.lIIllllIIl[181]] = C.lIIIIlIlIIIll("LNpL5oNj06th4IHj2gZj45K4l4IB9z4x", "lDsRG");
        C.lIIlllIlll[C.lIIllllIIl[182]] = C.lIIIIlIlIIlII("ms6QtTabjmU=", "czSWb");
        C.lIIlllIlll[C.lIIllllIIl[183]] = C.lIIIIlIlIIlII("ay6YKZQioQQ=", "iugIg");
        C.lIIlllIlll[C.lIIllllIIl[185]] = C.lIIIIlIlIIlII("2WjJuw9sYs8=", "hOpNl");
        C.lIIlllIlll[C.lIIllllIIl[186]] = C.lIIIIlIlIIlII("FHpiic3v+rI=", "mBNBJ");
        C.lIIlllIlll[C.lIIllllIIl[193]] = C.lIIIIlIlIIlII("IhoXk3dsG7k=", "msBsG");
        C.lIIlllIlll[C.lIIllllIIl[194]] = C.lIIIIlIlIIlIl("A0kbZyMlAR0uIS1OECg9ag9WIDozThUmIyYLEmcKOAATNDtk", "JnvGO");
        C.lIIlllIlll[C.lIIllllIIl[195]] = C.lIIIIlIlIIlII("ZfcgygrziqCmNgYthjft7ALz/2SGyxVFFOfXuRYqUQ27g4xLxaXrBl+Go2ymlXh3GT1LYqUyKwFR0pEwDuGA8Q==", "SGAxl");
    }
    ...
    private static void af() {
        block14: {
            d llllllllllllllllllllIlllllllIIIl;
            block13: {
                block12: {
                    block11: {
                        Object llllllllllllllllllllIlllllllIIlI;
                        int[] nArray = new int[lIIllllIIl[0]];
                        ...
                        if (C.lIIIIllIIIIll(Bank.contains((int[])nArray2) ? 1 : 0)) {
                            llllllllllllllllllllIlllllllIIlI = new d(lIIllllIIl[7], lIIllllIIl[0], lIIllllIIl[175]);
                            bv.add((d)llllllllllllllllllllIlllllllIIlI);
                            "".length();
                        }
                        int[] nArray3 = new int[lIIllllIIl[0]];
                        nArray3[C.lIIllllIIl[1]] = lIIllllIIl[9];
                        if (C.lIIIIllIIIIll(Bank.contains((int[])nArray3) ? 1 : 0)) {
                            llllllllllllllllllllIlllllllIIlI = new d(lIIllllIIl[9], lIIllllIIl[0], lIIllllIIl[175]);
                            bv.add((d)llllllllllllllllllllIlllllllIIlI);
                            "".length();
                        }
                        if (C.lIIIIllIIIIll(Bank.contains((Predicate)(llllllllllllllllllllIlllllllIIlI = item -> item.getName().toLowerCase().contains(lIIlllIlll[lIIllllIIl[181]]))) ? 1 : 0)) {
                            llllllllllllllllllllIlllllllIIIl = new d(lIIllllIIl[176], lIIllllIIl[14], lIIllllIIl[177]);
                            bv.add(llllllllllllllllllllIlllllllIIIl);
                            "".length();
                        }
                        int[] nArray4 = new int[lIIllllIIl[0]];
                        nArray4[C.lIIllllIIl[1]] = lIIllllIIl[12];
                        if (C.lIIIIllIIIIll(Bank.contains((int[])nArray4) ? 1 : 0)) {
                            llllllllllllllllllllIlllllllIIIl = new d(lIIllllIIl[12], lIIllllIIl[4], i.bq);
                            bv.add(llllllllllllllllllllIlllllllIIIl);
                            "".length();
                        }
                        int[] nArray5 = new int[lIIllllIIl[0]];
                    ...
                    llllllllllllllllllllIlllllllIIIl = new d(lIIllllIIl[13], lIIllllIIl[10], lIIllllIIl[178]);
                    bv.add(llllllllllllllllllllIlllllllIIIl);
                    "".length();
                }
                int[] nArray = new int[lIIllllIIl[0]];
            ...
            llllllllllllllllllllIlllllllIIIl = new d(lIIllllIIl[5], lIIllllIIl[57], lIIllllIIl[179]);
            bv.add(llllllllllllllllllllIlllllllIIIl);
            "".length();
        }
    }
    ...
    private static String lIIIIlIlIIlII(String llllllllllllllllllllIllllllIIIll, String llllllllllllllllllllIllllllIIIII) {
        try {
            SecretKeySpec llllllllllllllllllllIllllllIIllI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllllIllllllIIIII.getBytes(StandardCharsets.UTF_8)), lIIllllIIl[16]), "DES");
            Cipher llllllllllllllllllllIllllllIIlIl = Cipher.getInstance("DES");
            llllllllllllllllllllIllllllIIlIl.init(lIIllllIIl[3], llllllllllllllllllllIllllllIIllI);
            return new String(llllllllllllllllllllIllllllIIlIl.doFinal(Base64.getDecoder().decode(llllllllllllllllllllIllllllIIIll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public int T() {
        ...
        if (null != null) {
            return (0x25 ^ 0x18) & ~(0xB3 ^ 0x8E);
        }
        return lIIllllIIl[144];
    }

    private static String lIIIIlIlIIIll(String llllllllllllllllllllIllllIllllII, String llllllllllllllllllllIllllIllllIl) {
        try {
            SecretKeySpec llllllllllllllllllllIlllllIIIIIl = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllllIllllIllllIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllllllIlllllIIIIII = Cipher.getInstance("Blowfish");
            llllllllllllllllllllIlllllIIIIII.init(lIIllllIIl[3], llllllllllllllllllllIlllllIIIIIl);
            return new String(llllllllllllllllllllIlllllIIIIII.doFinal(Base64.getDecoder().decode(llllllllllllllllllllIllllIllllII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
