...
import f.r.u.e.-.u.-.s.g.t.i.o.k.i.-.o.l.t.e.o.c.c.n.x;
...
implements G {
                        ...
                        if (w.lIIIIlIIIlllI(Inventory.contains((int[])nArray5) ? 1 : 0)) {
                            ...
                            if (w.lIIIIlIIIlllI(Inventory.contains((int[])nArray6) ? 1 : 0)) {
                                ...
                                if (w.lIIIIlIIIlllI(Inventory.contains((int[])nArray7) ? 1 : 0)) {
                                    ...
                                    return ((0x1D ^ 0x64 ^ (0x3E ^ 8)) & (178 + 112 - 196 + 138 ^ 81 + 77 - 91 + 100 ^ -" ".length())) != 0;
                                }
                            }
                        }
                    }
    ...
    public int T() {
        ...
        if (" ".length() == 0) {
            return (0x57 ^ 0x50 ^ (0xAC ^ 0xA5)) & (75 + 97 - 135 + 141 ^ 140 + 13 - 105 + 140 ^ -" ".length());
        }
    ...
    public boolean V() {
        ...
        if (w.lIIIIlIIlIllI(Quests.getState((Quest)Quest.RECIPE_FOR_DISASTER__MOUNTAIN_DWARF), QuestState.FINISHED)) {
            ...
            if ((0x35 ^ 0x7C ^ (0xF3 ^ 0xBF)) == 0) {
                return ((117 + 150 - 152 + 59 ^ 72 + 15 - 38 + 118) & (4 ^ 0x5F ^ (0x17 ^ 0x45) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIlllIIll[6];
        }
    ...
    private static void lIIIIlIIIlIIl() {
        ...
        w.lIIlllIIlI[w.lIIlllIIll[6]] = w.lIIIIlIIIIllI("6EtxlyTy1GN7kcgVo5sG+dQrP4irIucSp2PuEfg75WzTNo580asxHMJ2jsFdeo4i", "pmtjq");
        w.lIIlllIIlI[w.lIIlllIIll[5]] = w.lIIIIlIIIIllI("930XMsMPGCrcQDTTvYtyZw==", "gkoVe");
        w.lIIlllIIlI[w.lIIlllIIll[8]] = w.lIIIIlIIIIlll("IhspDB4DFCBIEAsULAEcDQ==", "jzGhr");
        w.lIIlllIIlI[w.lIIlllIIll[1]] = w.lIIIIlIIIlIII("y3HYZtb43iTbi+l+JbOaVDA8Ikv0V1O1QqtHtgJxCEv4lA1+a0CgxIY4VI3wiOtPZMeOHNp0GbU=", "dmdxx");
        w.lIIlllIIlI[w.lIIlllIIll[9]] = w.lIIIIlIIIIlll("MSJpKxsDZyQjGhUuJy1JFzIsOR1GNDw6GQouLDlFRjQ+Ix0FLyAkDkYzJmorMx4ABC4=", "fGIJi");
        w.lIIlllIIlI[w.lIIlllIIll[3]] = w.lIIIIlIIIIllI("oxsb4FFZmaM=", "JJYkn");
        w.lIIlllIIlI[w.lIIlllIIll[18]] = w.lIIIIlIIIlIII("IMBsfWGEKNA=", "pPvHz");
        w.lIIlllIIlI[w.lIIlllIIll[20]] = w.lIIIIlIIIIllI("zRtbXigQTrZRp7wEl0LYCA==", "SAyzS");
        w.lIIlllIIlI[w.lIIlllIIll[21]] = w.lIIIIlIIIIllI("yP0uGTlQJf4=", "PMgBv");
        w.lIIlllIIlI[w.lIIlllIIll[23]] = w.lIIIIlIIIIlll("EhMuIys=", "VdOQM");
        w.lIIlllIIlI[w.lIIlllIIll[4]] = w.lIIIIlIIIIllI("JVAjLDyUBdY=", "cqXvP");
        w.lIIlllIIlI[w.lIIlllIIll[2]] = w.lIIIIlIIIIllI("5Kfboep93eevyfwi8F6GMTRMYBc4kqDJ", "wgLfG");
        w.lIIlllIIlI[w.lIIlllIIll[29]] = w.lIIIIlIIIIllI("p7UE4IPYTIUmtGBFQVqsaw==", "zkrUR");
        w.lIIlllIIlI[w.lIIlllIIll[30]] = w.lIIIIlIIIIlll("ARchGj0v", "JvXvX");
        w.lIIlllIIlI[w.lIIlllIIll[31]] = w.lIIIIlIIIIllI("GT1JZLr3Oh5gIhmfvyyRYqc7VrnA4IIV", "oWdDn");
        w.lIIlllIIlI[w.lIIlllIIll[32]] = w.lIIIIlIIIlIII("+00LxDYS05Ak+EvAztYDoQ==", "ZpiJM");
        w.lIIlllIIlI[w.lIIlllIIll[33]] = w.lIIIIlIIIlIII("PdGhOpcEsxkSHjRlrd33Aw==", "zkhCV");
        w.lIIlllIIlI[w.lIIlllIIll[36]] = w.lIIIIlIIIlIII("D4Au2ikHmKSrQ6sT7teBKmV/Qegt6Vny", "tmkcp");
        w.lIIlllIIlI[w.lIIlllIIll[37]] = w.lIIIIlIIIIllI("Pl0UvZC3LSk0taZ4H0L5qQ==", "xUWMb");
        w.lIIlllIIlI[w.lIIlllIIll[38]] = w.lIIIIlIIIIllI("s/Rd6mkBoPNvbj8AAvLTow==", "fnWDf");
        w.lIIlllIIlI[w.lIIlllIIll[34]] = w.lIIIIlIIIIlll("ERUJIgg=", "CzaCc");
        w.lIIlllIIlI[w.lIIlllIIll[39]] = w.lIIIIlIIIlIII("bG9XRao93m+lbQTQmrbFAw==", "TQtxd");
        w.lIIlllIIlI[w.lIIlllIIll[40]] = w.lIIIIlIIIIllI("Ou6Gk2FxexQ=", "AZYnu");
        w.lIIlllIIlI[w.lIIlllIIll[43]] = w.lIIIIlIIIIlll("KyovMTUGayI9OBc=", "cKAUY");
        w.lIIlllIIlI[w.lIIlllIIll[44]] = w.lIIIIlIIIIllI("x+6lCDf45vE=", "bVbVA");
        w.lIIlllIIlI[w.lIIlllIIll[45]] = w.lIIIIlIIIIlll("BRMOIw==", "RvoQb");
        w.lIIlllIIlI[w.lIIlllIIll[47]] = w.lIIIIlIIIIllI("6ElNfCIk40Q=", "VkqCi");
        w.lIIlllIIlI[w.lIIlllIIll[48]] = w.lIIIIlIIIlIII("PmjLTePdlk0=", "AVhIY");
        w.lIIlllIIlI[w.lIIlllIIll[49]] = w.lIIIIlIIIIlll("HScbZw48ZgQkHzUvCCke", "SFmGz");
        w.lIIlllIIlI[w.lIIlllIIll[50]] = w.lIIIIlIIIIlll("CAQYGRQiUAUbEi8ZCRYT", "Iplxw");
        w.lIIlllIIlI[w.lIIlllIIll[41]] = w.lIIIIlIIIlIII("uff7vVC9qzlSkxkarhHf3Q==", "uFtdt");
        w.lIIlllIIlI[w.lIIlllIIll[51]] = w.lIIIIlIIIlIII("vSICqtVqiNA=", "tVEjb");
        w.lIIlllIIlI[w.lIIlllIIll[55]] = w.lIIIIlIIIIlll("FjgxMA==", "WJXCh");
        w.lIIlllIIlI[w.lIIlllIIll[56]] = w.lIIIIlIIIIlll("KDkHVAcJeAMSF0YqHhse", "fXqts");
        w.lIIlllIIlI[w.lIIlllIIll[57]] = w.lIIIIlIIIIllI("GUqNDMMBHis=", "RDAMS");
        w.lIIlllIIlI[w.lIIlllIIll[58]] = w.lIIIIlIIIlIII("rcrxJNEbC1vlLPAvF+bpLQ==", "EQPQA");
        w.lIIlllIIlI[w.lIIlllIIll[59]] = w.lIIIIlIIIIllI("PZpV39eXhms=", "eYowu");
        w.lIIlllIIlI[w.lIIlllIIll[66]] = w.lIIIIlIIIIlll("HxUoWDM6Mh4eVzwmCQsD", "MSlxw");
        w.lIIlllIIlI[w.lIIlllIIll[67]] = w.lIIIIlIIIIllI("a2Q47pPPZ6n/I4cI637mXbWw4Rc0Funj", "snzHX");
        w.lIIlllIIlI[w.lIIlllIIll[76]] = w.lIIIIlIIIlIII("rq10F9cdKyo=", "rpPKq");
        w.lIIlllIIlI[w.lIIlllIIll[42]] = w.lIIIIlIIIIlll("BwcjF2kzDixDMD8aYhcsPANiDixwDiAMPCRPJhQoIhknEGkxASZDKDwKfQ==", "PoBcI");
        w.lIIlllIIlI[w.lIIlllIIll[77]] = w.lIIIIlIIIIlll("OFgXCj8dHFQKLBcdBkUzHg1UFiUcHVQMJFEKERE/AxZYRSIeD1QEKB4NAEV4QUhUAiUdHEs=", "qxteJ");
    }

    private static String lIIIIlIIIIlll(String lllllllllllllllllllllIIIlllIllIl, String lllllllllllllllllllllIIIlllIllII) {
        lllllllllllllllllllllIIIlllIllIl = new String(Base64.getDecoder().decode(lllllllllllllllllllllIIIlllIllIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllllllIIIllllIIII = new StringBuilder();
        char[] lllllllllllllllllllllIIIlllIllll = lllllllllllllllllllllIIIlllIllII.toCharArray();
        int lllllllllllllllllllllIIIlllIlllI = lIIlllIIll[6];
        char[] lllllllllllllllllllllIIIlllIlIII = lllllllllllllllllllllIIIlllIllIl.toCharArray();
        int lllllllllllllllllllllIIIlllIIlll = lllllllllllllllllllllIIIlllIlIII.length;
        int lllllllllllllllllllllIIIlllIIllI = lIIlllIIll[6];
        while (w.lIIIIlIIIlIll(lllllllllllllllllllllIIIlllIIllI, lllllllllllllllllllllIIIlllIIlll)) {
            char lllllllllllllllllllllIIIllllIIll = lllllllllllllllllllllIIIlllIlIII[lllllllllllllllllllllIIIlllIIllI];
            lllllllllllllllllllllIIIllllIIII.append((char)(lllllllllllllllllllllIIIllllIIll ^ lllllllllllllllllllllIIIlllIllll[lllllllllllllllllllllIIIlllIlllI % lllllllllllllllllllllIIIlllIllll.length]));
            "".length();
            ++lllllllllllllllllllllIIIlllIlllI;
            ++lllllllllllllllllllllIIIlllIIllI;
            "".length();
            if (((0x5B ^ 0x19) & ~(0x5B ^ 0x19)) != " ".length()) continue;
            return null;
        }
    ...
    public static void bf() {
        block50: {
            block58: {
                block57: {
                    BankLocation lllllllllllllllllllllIIlIIIlllIl;
                    block56: {
                        block51: {
                            block55: {
                                block53: {
                                    block54: {
                                        block52: {
                                            ...
                                            lllllllllllllllllllllIIlIIIlllIl = BankLocation.getNearest();
                                            if (w.lIIIIlIIlIIII(lllllllllllllllllllllIIlIIIlllIl) && w.lIIIIlIIIllll(lllllllllllllllllllllIIlIIIlllIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                                AccBuilderRogues.c = lIIlllIIlI[lIIlllIIll[5]];
                                                a.a(lllllllllllllllllllllIIlIIIlllIl);
                                            }
                                            if (!w.lIIIIlIIlIIII(lllllllllllllllllllllIIlIIIlllIl) || !w.lIIIIlIIIlllI(lllllllllllllllllllllIIlIIIlllIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block51;
                        ...
                        lllllllllllllllllllllIIlIIIlllIl = new WorldPoint(lIIlllIIll[53], lIIlllIIll[54], lIIlllIIll[6]);
                    ...
                    if (!w.lIIIIlIIlIlIl(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllllllllllllllllllIIlIIIlllIl), lIIlllIIll[41])) break block58;
                }
    ...
    private static void af() {
        d lllllllllllllllllllllIIlIIIllIIl;
        Object lllllllllllllllllllllIIlIIIllIlI;
        block27: {
            block26: {
                block25: {
                    block24: {
                        block23: {
                            block22: {
                                block21: {
                                    ...
                                    lllllllllllllllllllllIIlIIIllIlI = new d(lIIlllIIll[11], lIIlllIIll[3], i.bq);
                                    bv.add((d)lllllllllllllllllllllIIlIIIllIlI);
                                    "".length();
                                }
                                int[] nArray = new int[lIIlllIIll[5]];
                                nArray[w.lIIlllIIll[6]] = lIIlllIIll[25];
                                if (w.lIIIIlIIIllll(Bank.contains((int[])nArray) ? 1 : 0)) {
                                    lllllllllllllllllllllIIlIIIllIlI = new d(lIIlllIIll[25], lIIlllIIll[5], lIIlllIIll[60]);
                                    bv.add((d)lllllllllllllllllllllIIlIIIllIlI);
                                    "".length();
                                }
                                int[] nArray4 = new int[lIIlllIIll[5]];
                                ...
                                if (w.lIIIIlIIIllll(Bank.contains((int[])nArray4) ? 1 : 0)) {
                                    lllllllllllllllllllllIIlIIIllIlI = new d(lIIlllIIll[22], lIIlllIIll[5], lIIlllIIll[60]);
                                    bv.add((d)lllllllllllllllllllllIIlIIIllIlI);
                                    "".length();
                                }
                                int[] nArray5 = new int[lIIlllIIll[5]];
                            ...
                            lllllllllllllllllllllIIlIIIllIlI = new d(lIIlllIIll[10], lIIlllIIll[9], lIIlllIIll[61]);
                            bv.add((d)lllllllllllllllllllllIIlIIIllIlI);
                            "".length();
                        }
                        int[] nArray = new int[lIIlllIIll[5]];
                        ...
                        if (w.lIIIIlIIIllll(Bank.contains((int[])nArray) ? 1 : 0)) {
                            lllllllllllllllllllllIIlIIIllIlI = new d(lIIlllIIll[19], lIIlllIIll[5], lIIlllIIll[60]);
                            bv.add((d)lllllllllllllllllllllIIlIIIllIlI);
                            "".length();
                        }
                        int[] nArray8 = new int[lIIlllIIll[5]];
                        ...
                        if (w.lIIIIlIIIllll(Bank.contains((int[])nArray8) ? 1 : 0)) {
                            lllllllllllllllllllllIIlIIIllIlI = new d(lIIlllIIll[17], lIIlllIIll[5], lIIlllIIll[60]);
                            bv.add((d)lllllllllllllllllllllIIlIIIllIlI);
                            "".length();
                        }
                        int[] nArray9 = new int[lIIlllIIll[5]];
                        ...
                        if (w.lIIIIlIIIllll(Bank.contains((int[])nArray9) ? 1 : 0)) {
                            lllllllllllllllllllllIIlIIIllIlI = new d(lIIlllIIll[15], lIIlllIIll[5], lIIlllIIll[60]);
                            bv.add((d)lllllllllllllllllllllIIlIIIllIlI);
                            "".length();
                        }
                        int[] nArray10 = new int[lIIlllIIll[5]];
                        ...
                        if (w.lIIIIlIIIllll(Bank.contains((int[])nArray10) ? 1 : 0)) {
                            lllllllllllllllllllllIIlIIIllIlI = new d(lIIlllIIll[16], lIIlllIIll[5], lIIlllIIll[60]);
                            bv.add((d)lllllllllllllllllllllIIlIIIllIlI);
                            "".length();
                        }
                        int[] nArray11 = new int[lIIlllIIll[5]];
                    ...
                    lllllllllllllllllllllIIlIIIllIlI = new d(lIIlllIIll[14], lIIlllIIll[4], lIIlllIIll[62]);
                    bv.add((d)lllllllllllllllllllllIIlIIIllIlI);
                    "".length();
                }
                int[] nArray = new int[lIIlllIIll[5]];
            ...
            lllllllllllllllllllllIIlIIIllIlI = new d(lIIlllIIll[12], lIIlllIIll[4], lIIlllIIll[62]);
            bv.add((d)lllllllllllllllllllllIIlIIIllIlI);
            "".length();
        }
        if (w.lIIIIlIIIllll(Bank.contains((Predicate)(lllllllllllllllllllllIIlIIIllIlI = item -> item.getName().toLowerCase().contains(lIIlllIIlI[lIIlllIIll[67]]))) ? 1 : 0)) {
            lllllllllllllllllllllIIlIIIllIIl = new d(lIIlllIIll[63], lIIlllIIll[3], lIIlllIIll[64]);
            bv.add(lllllllllllllllllllllIIlIIIllIIl);
            "".length();
        }
        int[] nArray = new int[lIIlllIIll[5]];
        nArray[w.lIIlllIIll[6]] = lIIlllIIll[13];
        if (w.lIIIIlIIIllll(Bank.contains((int[])nArray) ? 1 : 0)) {
            lllllllllllllllllllllIIlIIIllIIl = new d(lIIlllIIll[13], lIIlllIIll[42], lIIlllIIll[62]);
            bv.add(lllllllllllllllllllllIIlIIIllIIl);
            "".length();
        }
    }
    ...
    private static String lIIIIlIIIlIII(String lllllllllllllllllllllIIlIIIIllIl, String lllllllllllllllllllllIIlIIIIlllI) {
        try {
            SecretKeySpec lllllllllllllllllllllIIlIIIlIIlI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllllIIlIIIIlllI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllllllllIIlIIIlIIIl = Cipher.getInstance("Blowfish");
            lllllllllllllllllllllIIlIIIlIIIl.init(lIIlllIIll[8], lllllllllllllllllllllIIlIIIlIIlI);
            return new String(lllllllllllllllllllllIIlIIIlIIIl.doFinal(Base64.getDecoder().decode(lllllllllllllllllllllIIlIIIIllIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIIIIlIIIIllI(String lllllllllllllllllllllIIlIIIIIIII, String lllllllllllllllllllllIIIllllllll) {
        try {
            SecretKeySpec lllllllllllllllllllllIIlIIIIIlIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllllIIIllllllll.getBytes(StandardCharsets.UTF_8)), lIIlllIIll[21]), "DES");
            Cipher lllllllllllllllllllllIIlIIIIIlII = Cipher.getInstance("DES");
            lllllllllllllllllllllIIlIIIIIlII.init(lIIlllIIll[8], lllllllllllllllllllllIIlIIIIIlIl);
            return new String(lllllllllllllllllllllIIlIIIIIlII.doFinal(Base64.getDecoder().decode(lllllllllllllllllllllIIlIIIIIIII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIIIIlIIIlIlI() {
        ...
        w.lIIlllIIll[1] = "   ".length();
        w.lIIlllIIll[2] = 9 ^ 2;
        w.lIIlllIIll[3] = 183 + 174 - 179 + 12 ^ 184 + 23 - 185 + 165;
        w.lIIlllIIll[4] = 0x69 ^ 0x24 ^ (0x36 ^ 0x71);
        w.lIIlllIIll[5] = " ".length();
        w.lIIlllIIll[6] = (0x97 ^ 0xC5 ^ (0x7E ^ 0x6C)) & (172 + 16 - -5 + 54 ^ 2 + 159 - -13 + 9 ^ -" ".length());
        w.lIIlllIIll[7] = 0xFFFFB3EA & 0x5F9D;
        w.lIIlllIIll[8] = "  ".length();
