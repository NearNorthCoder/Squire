...
implements G {
                        ...
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    ...
                                    return ((0x20 ^ 0x41 ^ (6 ^ 0x49)) & (0xD ^ 0x78 ^ (0x4B ^ 0x10) ^ -" ".length())) != 0;
                                }
                                n4 = lIIlllllll[0];
                                return n4 != 0;
                            }
                                ...
                                if (M.lIIIIlllIIlIl(Inventory.getCount((int[])nArray4), lIIlllllll[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (M.lIIIIlllIlIII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (null != null) {
                                                return (("   ".length() ^ (0x25 ^ 9)) & (0xDA ^ 0xAC ^ (0xF4 ^ 0xAD) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIlllllll[0];
                                        }
                                ...
                                if (M.lIIIIlllIIlIl(Inventory.getCount((int[])nArray8), lIIlllllll[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (M.lIIIIlllIlIII(Inventory.getCount((int[])nArray))) {
                                            bl = lIIlllllll[1];
                                            "".length();
                                            if ((45 + 165 - 22 + 6 ^ 72 + 143 - 158 + 141) < "  ".length()) {
                                                return ((0x4C ^ 7 ^ (0x5B ^ 0x5F)) & (0x15 ^ 9 ^ (0x48 ^ 0x1B) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIlllllll[0];
                                        }
        ...
        if (M.lIIIIlllIlIll(Players.getLocal().getInteracting())) {
            NPC llllllllllllllllllllIllIlIlIlllI = NPCs.getNearest(nPC -> {
                ...
                if (M.lIIIIlllIIlII(nPC.getName().contains(lIIllllllI[lIIlllllll[76]]) ? 1 : 0) && M.lIIIIlllIIllI(nPC.isDead() ? 1 : 0)) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((0xDC ^ 0x95 ^ (0x2D ^ 0x4D)) & (91 + 96 - 80 + 38 ^ 180 + 103 - 191 + 92 ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIIlllllll[0];
                }
            ...
            List llllllllllllllllllllIllIlIlIllIl = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                ...
                if (M.lIIIIlllIlllI(nPC.getInteracting(), Players.getLocal())) {
                    ...
                    "".length();
                    if (-"   ".length() >= 0) {
                        return ((0x9C ^ 0x8F ^ (0xCE ^ 0x83)) & (220 + 80 - 96 + 36 ^ 74 + 81 - 89 + 108 ^ -" ".length())) != 0;
                    }
                } else {
                    bl = lIIlllllll[0];
                }
    ...
    private static void lIIIIlllIIIlI() {
        ...
        M.lIIllllllI[M.lIIlllllll[0]] = M.lIIIIllIlllll("cN+6pgwGpDWomsrOUot+YA==", "LlTXw");
        M.lIIllllllI[M.lIIlllllll[1]] = M.lIIIIlllIIIII("MQElIgkfDS9rGAIRIiUdVwE/LhcERGs4DR4cKCMTGQ9rKRsUA2s/FVcFKiwTFEg/ORseBiIlHQ==", "whKKz");
        M.lIIllllllI[M.lIIlllllll[2]] = M.lIIIIlllIIIIl("JMnwrAtkiQ+Li70om9R8Up4C5iObKVhl", "ERPqu");
        M.lIIllllllI[M.lIIlllllll[3]] = M.lIIIIlllIIIII("DCMlITotLCxlNCUsICw4Iw==", "DBKEV");
        M.lIIllllllI[M.lIIlllllll[6]] = M.lIIIIllIlllll("qzimJkMMBo2K8DCK+w7m7fEvdEMWjvAbajx8kM/GsIrRyZEBWgLUFWOq8ODEj11Q", "vJCTd");
        M.lIIllllllI[M.lIIlllllll[18]] = M.lIIIIllIlllll("nr3/tfhus4KWbQAohX08PQ==", "WuhHe");
        M.lIIllllllI[M.lIIlllllll[5]] = M.lIIIIlllIIIII("AxgeLzUpBQQpdiEDHT0=", "BljNV");
        M.lIIllllllI[M.lIIlllllll[26]] = M.lIIIIlllIIIIl("pxDYMZQFwSOtfIIeqLIK9qtSZxAmASUT", "qRwVS");
        M.lIIllllllI[M.lIIlllllll[29]] = M.lIIIIllIlllll("xm52H2tnsWLtrU4QGrgMaD6jdZnbBGo/", "EGqxv");
        M.lIIllllllI[M.lIIlllllll[31]] = M.lIIIIlllIIIIl("AzUFk8PU+PcwLzvZesdz0kL4OeuQDHZD", "XIraR");
        M.lIIllllllI[M.lIIlllllll[32]] = M.lIIIIlllIIIII("GS8cBhg0KU8REDcjFlIFPyIK", "ZNorq");
        M.lIIllllllI[M.lIIlllllll[33]] = M.lIIIIllIlllll("xKpKDMhlgZA=", "hHBZT");
        M.lIIllllllI[M.lIIlllllll[36]] = M.lIIIIlllIIIII("GCM2LQk=", "OJSAm");
        M.lIIllllllI[M.lIIlllllll[38]] = M.lIIIIllIlllll("Fk3T++awHOw7sdd6oOln7jojvq4z5tVe", "QegwU");
        M.lIIllllllI[M.lIIlllllll[42]] = M.lIIIIlllIIIII("HBY6RRI9Vy8KESE=", "RwLef");
        M.lIIllllllI[M.lIIlllllll[43]] = M.lIIIIllIlllll("CQT9yxRGa3buPdtFuDdYcQ==", "fXBUC");
        M.lIIllllllI[M.lIIlllllll[44]] = M.lIIIIllIlllll("QAzPRuxlwng=", "ZNKQp");
        M.lIIllllllI[M.lIIlllllll[45]] = M.lIIIIlllIIIII("DyYB", "LIvru");
        M.lIIllllllI[M.lIIlllllll[46]] = M.lIIIIlllIIIIl("iwGhuu5Iw4g=", "MNLvt");
        M.lIIllllllI[M.lIIlllllll[48]] = M.lIIIIllIlllll("NVWWdptvcK8=", "zZOUs");
        M.lIIllllllI[M.lIIlllllll[52]] = M.lIIIIllIlllll("vd5JGwC4ZORNXs81lAmG0VqqdNwzJtrZ", "AAJje");
        M.lIIllllllI[M.lIIlllllll[53]] = M.lIIIIlllIIIII("Jw48HzcBRiAAIQgK", "dfSpD");
        M.lIIllllllI[M.lIIlllllll[55]] = M.lIIIIllIlllll("cXIvKtLF8UWo6DXjAcUMoA==", "QnVOC");
        M.lIIllllllI[M.lIIlllllll[56]] = M.lIIIIllIlllll("+bOy4sbR4hSoytBUkGcpCA==", "lvMwk");
        M.lIIllllllI[M.lIIlllllll[57]] = M.lIIIIlllIIIII("CiMaMwNvERw1AiQn", "OBhGk");
        M.lIIllllllI[M.lIIlllllll[20]] = M.lIIIIlllIIIIl("y/Qh44MBxIDMxECdsLpuHQ==", "LsKjP");
        M.lIIllllllI[M.lIIlllllll[51]] = M.lIIIIlllIIIII("MAccMEklGhw8AhM=", "vnnUi");
        M.lIIllllllI[M.lIIlllllll[73]] = M.lIIIIllIlllll("ZgkSxFmE/tVPpzh2dSTV1A==", "LpNJG");
        M.lIIllllllI[M.lIIlllllll[75]] = M.lIIIIllIlllll("iW0tGdquh+P8sqrfFMNuRnxa+suw8iDy", "izOmz");
        M.lIIllllllI[M.lIIlllllll[76]] = M.lIIIIllIlllll("3DM2syoDj1g=", "FGYYz");
    }
    ...
    public boolean V() {
        ...
        if (M.lIIIIlllIlIIl(Skills.getLevel((Skill)Skill.MAGIC), lIIlllllll[74])) {
            ...
            if ((0x84 ^ 0xC7 ^ (0xC1 ^ 0x87)) <= 0) {
                return ((0x47 ^ 0x39 ^ (0x1F ^ 0x75)) & (0xBE ^ 0x83 ^ (0x11 ^ 0x38) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIlllllll[0];
        }
    ...
    private static void lIIIIlllIIIll() {
        ...
        M.lIIlllllll[1] = " ".length();
        M.lIIlllllll[2] = "  ".length();
        M.lIIlllllll[3] = "   ".length();
                    ...
                    block27: {
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    block24: {
                                        block19: {
                                            ...
                                            block20: {
                                                ...
                                                n5 = lIIlllllll[1];
                                                "".length();
                                                if ((29 + 50 - 51 + 133 ^ 37 + 39 - -51 + 38) >= "  ".length()) return n5 != 0;
                                                return ((6 ^ 0x45 ^ (0xCD ^ 0xBF)) & ((0x42 ^ 0x72) & ~(0x98 ^ 0xA8) ^ (0x5F ^ 0x6E) ^ -" ".length())) != 0;
                                            }
                                            n5 = lIIlllllll[0];
                                            return n5 != 0;
                                        }
                                    ...
                                    n4 = lIIlllllll[1];
                                    "".length();
                                    if (((0x39 ^ 0x6D ^ (0x4B ^ 0x31)) & (160 + 57 - 187 + 133 ^ 12 + 124 - 95 + 100 ^ -" ".length())) == 0) return n4 != 0;
                                    return ((78 + 119 - 103 + 95 ^ 19 + 30 - -56 + 54) & (0x75 ^ 0x2F ^ (0x3E ^ 0x46) ^ -" ".length())) != 0;
                                }
                                n4 = lIIlllllll[0];
                                return n4 != 0;
                            }
                        ...
                        if (M.lIIIIlllIIlII(Bank.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (M.lIIIIlllIIlII(Bank.contains((int[])nArray14) ? 1 : 0)) {
                                ...
                                return ((3 + 228 - 187 + 202 ^ 101 + 143 - 160 + 104) & (0x76 ^ 7 ^ (1 ^ 0x3A) ^ -" ".length())) != 0;
                            }
                        }
                    }
                    n3 = lIIlllllll[0];
                    ...
                    if (M.lIIIIlllIlIIl(Bank.getFirst((int[])nArray17).getQuantity(), lIIlllllll[18])) {
                        ...
                        if (M.lIIIIlllIIlII(Bank.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (M.lIIIIlllIIlII(Bank.contains((int[])nArray19) ? 1 : 0)) {
                                n2 = lIIlllllll[1];
                                "".length();
                                if (((0x32 ^ 0x54 ^ (0x3C ^ 8)) & (6 ^ 0x5E ^ (0xA7 ^ 0xAD) ^ -" ".length())) == 0) return n2 != 0;
                                return ((0x9D ^ 0x8E ^ (0x22 ^ 0x65)) & (106 + 239 - 297 + 204 ^ 147 + 103 - 215 + 133 ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
