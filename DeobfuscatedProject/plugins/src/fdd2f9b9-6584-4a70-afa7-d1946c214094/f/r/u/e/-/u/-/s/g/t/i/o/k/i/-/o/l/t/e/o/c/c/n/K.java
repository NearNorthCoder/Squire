...
implements G {
    ...
    private static String llllllIIIIIl(String lllllllllllllllllllllllIlllIlIll, String lllllllllllllllllllllllIlllIlIlI) {
        lllllllllllllllllllllllIlllIlIll = new String(Base64.getDecoder().decode(lllllllllllllllllllllllIlllIlIll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllllllllIlllIlIIl = new StringBuilder();
        char[] lllllllllllllllllllllllIlllIlIII = lllllllllllllllllllllllIlllIlIlI.toCharArray();
        int lllllllllllllllllllllllIlllIIlll = lIIlIlIIll[0];
        char[] lllllllllllllllllllllllIlllIIIIl = lllllllllllllllllllllllIlllIlIll.toCharArray();
        int lllllllllllllllllllllllIlllIIIII = lllllllllllllllllllllllIlllIIIIl.length;
        int lllllllllllllllllllllllIllIlllll = lIIlIlIIll[0];
        while (K.llllllIIIllI(lllllllllllllllllllllllIllIlllll, lllllllllllllllllllllllIlllIIIII)) {
            char lllllllllllllllllllllllIlllIllII = lllllllllllllllllllllllIlllIIIIl[lllllllllllllllllllllllIllIlllll];
            lllllllllllllllllllllllIlllIlIIl.append((char)(lllllllllllllllllllllllIlllIllII ^ lllllllllllllllllllllllIlllIlIII[lllllllllllllllllllllllIlllIIlll % lllllllllllllllllllllllIlllIlIII.length]));
            "".length();
            ++lllllllllllllllllllllllIlllIIlll;
            ++lllllllllllllllllllllllIllIlllll;
            "".length();
    ...
    private static void llllllIIIIlI() {
        ...
        K.lIIlIIllll[K.lIIlIlIIll[0]] = K.lllllIllIIII("vfvSijaJiSvEZtA5aUUppg==", "IWowU");
        K.lIIlIIllll[K.lIIlIlIIll[1]] = K.llllllIIIIII("50igqm795r4qARrVwA7tiRNzqSzICGnVCYkf7vGtjcwdAJd41QSNaUys7j3f+twTa18Q73Fm7Dg=", "OxDko");
        K.lIIlIIllll[K.lIIlIlIIll[3]] = K.llllllIIIIIl("JwIkEQ0IFzsWDUkXPVgICA05", "icRxj");
        K.lIIlIIllll[K.lIIlIlIIll[4]] = K.llllllIIIIII("EOu0pN9SDvcQo7+qxe2QYxpodt/y/HAk", "JgPKq");
        K.lIIlIIllll[K.lIIlIlIIll[6]] = K.lllllIllIIII("4YFg1VRd32Nrhbry34GuzRFyA4Fzml3nq+E4DIzXbnpk8f1A4KHUC9aFybGyIrTa", "ItLMz");
        K.lIIlIIllll[K.lIIlIlIIll[10]] = K.llllllIIIIII("LZ1DmpKZRUlE6P5LpbcGAg==", "rDpvR");
        K.lIIlIIllll[K.lIIlIlIIll[14]] = K.llllllIIIIIl("IA4jHyBTCSUTIRoOJwg=", "szFzL");
        K.lIIlIIllll[K.lIIlIlIIll[15]] = K.lllllIllIIII("c+m/TyCcgJ6CCUbk2FA0g1qYZu3kaxAW", "evPeT");
        K.lIIlIIllll[K.lIIlIlIIll[18]] = K.llllllIIIIII("fFYKc03ZNE4=", "BQMkn");
        K.lIIlIIllll[K.lIIlIlIIll[20]] = K.lllllIllIIII("Cj0ZvpkreT4YT+ZhaVw5lbHrAYa0yIEH", "fYfzp");
        K.lIIlIIllll[K.lIIlIlIIll[21]] = K.llllllIIIIII("lvF84G2PdfRFfydIhL03LA==", "aYzRA");
        K.lIIlIIllll[K.lIIlIlIIll[22]] = K.lllllIllIIII("v2NfHzFaEQA=", "LHcDS");
        K.lIIlIIllll[K.lIIlIlIIll[23]] = K.llllllIIIIII("qhyX0AdILQs=", "oLGvc");
        K.lIIlIIllll[K.lIIlIlIIll[24]] = K.llllllIIIIIl("CCYNIxsi", "IRyBx");
        K.lIIlIIllll[K.lIIlIlIIll[25]] = K.llllllIIIIII("zjKJSj3XC0g=", "lPNzE");
        K.lIIlIIllll[K.lIIlIlIIll[13]] = K.lllllIllIIII("C6B1mqq1agTsml/1B41S2w==", "bpfHl");
        K.lIIlIIllll[K.lIIlIlIIll[26]] = K.lllllIllIIII("zG/I0RqSK/o=", "PHMcy");
        K.lIIlIIllll[K.lIIlIlIIll[29]] = K.lllllIllIIII("VaedjHtwxRCd+qhouz3Shw==", "wZcMS");
        K.lIIlIIllll[K.lIIlIlIIll[30]] = K.llllllIIIIII("vDJjZ/x12uUu9tVcJ08ucg==", "jvyuw");
        K.lIIlIIllll[K.lIIlIlIIll[31]] = K.lllllIllIIII("JRfYKdmdp98=", "tQcoX");
        K.lIIlIIllll[K.lIIlIlIIll[19]] = K.llllllIIIIII("e3TYe1ccj1wTPIrzj0rJbQ==", "Ndkag");
        K.lIIlIIllll[K.lIIlIlIIll[32]] = K.llllllIIIIII("56Yfwn4cYtIF6CrlW+H1xQ==", "aqYBR");
        K.lIIlIIllll[K.lIIlIlIIll[33]] = K.llllllIIIIII("ROwHIWYDv8E=", "dJVeA");
        K.lIIlIIllll[K.lIIlIlIIll[35]] = K.lllllIllIIII("H3GPZtuU7JsrK7vBDOCq68RxjeUzy2+Y", "zIiou");
        K.lIIlIIllll[K.lIIlIlIIll[36]] = K.llllllIIIIIl("PQcgOTgZAnQiKRkDPSUrAg==", "pnTQJ");
        K.lIIlIIllll[K.lIIlIlIIll[37]] = K.llllllIIIIIl("BQMyFQo=", "RjWyn");
        K.lIIlIIllll[K.lIIlIlIIll[38]] = K.llllllIIIIIl("Hj4LHio=", "IWnrN");
        K.lIIlIIllll[K.lIIlIlIIll[39]] = K.lllllIllIIII("cuGFJwff+yk=", "lxlhD");
        K.lIIlIIllll[K.lIIlIlIIll[41]] = K.llllllIIIIII("MAqk8MWKRqw=", "AKdgf");
        K.lIIlIIllll[K.lIIlIlIIll[43]] = K.lllllIllIIII("rozOFR12sWE=", "OIuvH");
        K.lIIlIIllll[K.lIIlIlIIll[34]] = K.lllllIllIIII("IxmOmdRkqAw=", "QDvtT");
        K.lIIlIIllll[K.lIIlIlIIll[46]] = K.lllllIllIIII("sd2wiHLBXTk=", "qCQJi");
        K.lIIlIIllll[K.lIIlIlIIll[48]] = K.llllllIIIIII("4h3exYKHvWQ=", "apkiI");
        K.lIIlIIllll[K.lIIlIlIIll[50]] = K.lllllIllIIII("OiQYKtP5k3Y=", "KMrck");
        K.lIIlIIllll[K.lIIlIlIIll[57]] = K.lllllIllIIII("AJj+07ur6BQ=", "CEqVv");
        K.lIIlIIllll[K.lIIlIlIIll[58]] = K.llllllIIIIII("KxsZbpdjbqA=", "dJDWE");
    }
    ...
    public static void af() {
        ...
        if (K.llllllIIIlll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            llllllllllllllllllllllllIIIIlIIl = new d(lIIlIlIIll[52], lIIlIlIIll[10], lIIlIlIIll[51]);
            bv.add(llllllllllllllllllllllllIIIIlIIl);
            "".length();
        }
        int[] nArray3 = new int[lIIlIlIIll[1]];
        nArray3[K.lIIlIlIIll[0]] = lIIlIlIIll[49];
        if (K.llllllIIIlll(Bank.contains((int[])nArray3) ? 1 : 0)) {
            llllllllllllllllllllllllIIIIlIIl = new d(lIIlIlIIll[49], lIIlIlIIll[1], lIIlIlIIll[53]);
            bv.add(llllllllllllllllllllllllIIIIlIIl);
            "".length();
        }
        ...
        if (K.llllllIIIlll(Bank.contains((int[])nArray4) ? 1 : 0)) {
            llllllllllllllllllllllllIIIIlIIl = new d(lIIlIlIIll[47], lIIlIlIIll[1], lIIlIlIIll[54]);
            bv.add(llllllllllllllllllllllllIIIIlIIl);
            "".length();
        }
        ...
        if (K.llllllIIIlll(Bank.contains((int[])nArray5) ? 1 : 0)) {
            llllllllllllllllllllllllIIIIlIIl = new d(lIIlIlIIll[11], lIIlIlIIll[12], lIIlIlIIll[55]);
            bv.add(llllllllllllllllllllllllIIIIlIIl);
            "".length();
        }
        ...
        if (K.llllllIIIlll(Bank.contains((int[])nArray6) ? 1 : 0)) {
            llllllllllllllllllllllllIIIIlIIl = new d(lIIlIlIIll[40], lIIlIlIIll[1], lIIlIlIIll[56]);
            bv.add(llllllllllllllllllllllllIIIIlIIl);
            "".length();
        }
        ...
        if (K.llllllIIIlll(Bank.contains((int[])nArray7) ? 1 : 0)) {
            llllllllllllllllllllllllIIIIlIIl = new d(lIIlIlIIll[44], lIIlIlIIll[1], lIIlIlIIll[56]);
            bv.add(llllllllllllllllllllllllIIIIlIIl);
            "".length();
        }
        ...
        if (K.llllllIIIlll(Bank.contains((int[])nArray8) ? 1 : 0)) {
            llllllllllllllllllllllllIIIIlIIl = new d(lIIlIlIIll[45], lIIlIlIIll[1], lIIlIlIIll[56]);
            bv.add(llllllllllllllllllllllllIIIIlIIl);
            "".length();
        }
        ...
        if (K.llllllIIIlll(Bank.contains((int[])nArray9) ? 1 : 0)) {
            llllllllllllllllllllllllIIIIlIIl = new d(lIIlIlIIll[42], lIIlIlIIll[1], lIIlIlIIll[56]);
            bv.add(llllllllllllllllllllllllIIIIlIIl);
            "".length();
        }
        if (K.llllllIIlIlI(Skills.getLevel((Skill)Skill.ATTACK), lIIlIlIIll[2])) {
            ...
            if (K.llllllIIIlll(Bank.contains((int[])nArray10) ? 1 : 0)) {
                llllllllllllllllllllllllIIIIlIIl = new d(lIIlIlIIll[17], lIIlIlIIll[1], lIIlIlIIll[54]);
                bv.add(llllllllllllllllllllllllIIIIlIIl);
                "".length();
            }
        }
        ...
        if (K.llllllIIIlll(Bank.contains((int[])nArray11) ? 1 : 0)) {
            llllllllllllllllllllllllIIIIlIIl = new d(lIIlIlIIll[16], lIIlIlIIll[1], lIIlIlIIll[56]);
            bv.add(llllllllllllllllllllllllIIIIlIIl);
            "".length();
        }
    }
    ...
    public static boolean cy() {
        ...
        block15: {
                                        ...
                                        block14: {
                                            block4: {
                                                ...
                                                block6: {
                                                    ...
                                                    return ((0x92 ^ 0xBB ^ (0xC4 ^ 0xA3)) & (17 + 5 - -44 + 61 ^ (0x31 ^ 0) ^ -" ".length())) != 0;
                                                }
                                                n3 = lIIlIlIIll[0];
                                                return n3 != 0;
                                            }
            ...
            return ((0xF1 ^ 0xC5 ^ (0x27 ^ 0x3A)) & (0x53 ^ 0x10 ^ (0x31 ^ 0x5B) ^ -" ".length())) != 0;
        }
        n2 = lIIlIlIIll[0];
        return n2 != 0;
    }
    ...
    private static String lllllIllIIII(String lllllllllllllllllllllllIllIlIllI, String lllllllllllllllllllllllIllIlIlIl) {
        try {
            SecretKeySpec lllllllllllllllllllllllIllIllIIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllllllIllIlIlIl.getBytes(StandardCharsets.UTF_8)), lIIlIlIIll[18]), "DES");
            Cipher lllllllllllllllllllllllIllIllIII = Cipher.getInstance("DES");
            lllllllllllllllllllllllIllIllIII.init(lIIlIlIIll[3], lllllllllllllllllllllllIllIllIIl);
    ...
    public static boolean bo() {
        ...
        block18: {
                                        ...
                                        block8: {
                                            ...
                                            block10: {
                                                ...
                                                if (K.llllllIIIlIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                    ...
                                                    return ((0x2C ^ 0x29 ^ (0xE7 ^ 0xC1)) & (0x1D ^ 0x7C ^ (0xFB ^ 0xB9) ^ -" ".length())) != 0;
                                                }
                                            }
                                            n3 = lIIlIlIIll[0];
                                            return n3 != 0;
            ...
            if (K.llllllIIIlIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                n2 = lIIlIlIIll[1];
                "".length();
                if (((0x55 ^ 4 ^ (0x91 ^ 0x96)) & (0x45 ^ 0x72 ^ (0xA4 ^ 0xC5) ^ -" ".length()) & ((139 + 119 - 196 + 173 ^ 150 + 46 - 109 + 111) & (0x7A ^ 0x73 ^ (0xB ^ 0x2F) ^ -" ".length()) ^ -" ".length())) == ((0x1B ^ 0x7A ^ (0x61 ^ 0x12)) & (0x44 ^ 2 ^ (0x3E ^ 0x6A) ^ -" ".length()))) return n2 != 0;
                return ((0x57 ^ 0x51 ^ (0x9F ^ 0xBD)) & (0x34 ^ 0x3F ^ (0x57 ^ 0x78) ^ -" ".length())) != 0;
            }
        }
        n2 = lIIlIlIIll[0];
        return n2 != 0;
            ...
            block19: {
                block18: {
                    ...
                    if (K.llllllIIIlll(K.bo() ? 1 : 0) && K.llllllIIIllI(Skills.getLevel((Skill)Skill.DEFENCE), lIIlIlIIll[2])) {
                        BankLocation llllllllllllllllllllllllIIIIllll = BankLocation.getNearest();
                        if (K.llllllIIlIII(llllllllllllllllllllllllIIIIllll) && K.llllllIIIlll(llllllllllllllllllllllllIIIIllll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            AccBuilderRogues.c = lIIlIIllll[lIIlIlIIll[3]];
                            a.a(llllllllllllllllllllllllIIIIllll);
                        }
                        if (K.llllllIIlIII(llllllllllllllllllllllllIIIIllll) && K.llllllIIIlIl(llllllllllllllllllllllllIIIIllll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    public boolean V() {
        ...
        if (K.llllllIIlIlI(Skills.getLevel((Skill)Skill.DEFENCE), lIIlIlIIll[2])) {
            ...
            "".length();
            if ("  ".length() <= 0) {
                return ((183 + 26 - 192 + 201 ^ 184 + 96 - 238 + 145) & (202 + 180 - 235 + 87 ^ 61 + 38 - -27 + 13 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIlIlIIll[0];
        }
    ...
    private static void llllllIIIIll() {
        ...
        K.lIIlIlIIll[0] = (0x2E ^ 0x12 ^ (0x6A ^ 0x1C)) & (210 + 78 - 60 + 17 ^ 120 + 188 - 158 + 41 ^ -" ".length());
        K.lIIlIlIIll[1] = " ".length();
        K.lIIlIlIIll[2] = 0x5F ^ 0x77;
        K.lIIlIlIIll[3] = "  ".length();
        K.lIIlIlIIll[4] = "   ".length();
        K.lIIlIlIIll[5] = 0xFFFFF7FD & 0x1B8A;
        K.lIIlIlIIll[6] = 178 + 144 - 217 + 80 ^ 94 + 181 - 252 + 166;
        K.lIIlIlIIll[7] = -(0 ^ 0xD) & (0xFFFFDFFF & 0x23EF);
        K.lIIlIlIIll[8] = -(0xFFFFF69E & 0x6D79) & (0xFFFFF7FF & 0x6FFF);
        K.lIIlIlIIll[9] = 0xFFFF9FCF & 0x7F77;
        K.lIIlIlIIll[10] = 0x59 ^ 0x5C;
        K.lIIlIlIIll[11] = 0xFFFFFB7B & 0x5FF;
        K.lIIlIlIIll[12] = 0x5B ^ 0x3F;
        K.lIIlIlIIll[13] = 0x4E ^ 0x41;
        K.lIIlIlIIll[14] = 0x62 ^ 0x6A ^ (0x98 ^ 0x96);
        K.lIIlIlIIll[15] = 0x95 ^ 0x92;
        K.lIIlIlIIll[16] = 0xFFFFA7B7 & 0x5D7B;
        K.lIIlIlIIll[17] = -(0xFFFFFFF3 & 0x724D) & (0xFFFFFF7F & 0x77F5);
        K.lIIlIlIIll[18] = 0x94 ^ 0x9C ^ (0x8A ^ 0x81) & ~(0x37 ^ 0x3C);
        K.lIIlIlIIll[19] = 141 + 51 - 110 + 78 ^ 133 + 13 - 14 + 48;
        K.lIIlIlIIll[20] = 0x1A ^ 0x13;
        K.lIIlIlIIll[21] = 34 + 52 - -18 + 73 ^ 105 + 39 - -30 + 13;
        K.lIIlIlIIll[22] = 5 + 146 - -3 + 27 ^ 64 + 41 - -15 + 70;
        K.lIIlIlIIll[23] = 0x4C ^ 0x40;
        K.lIIlIlIIll[24] = 73 + 25 - -30 + 21 ^ 110 + 101 - 118 + 59;
        K.lIIlIlIIll[25] = 0x46 ^ 0x50 ^ (0x71 ^ 0x69);
        K.lIIlIlIIll[26] = 43 + 196 - 69 + 40 ^ 136 + 149 - 240 + 149;
        K.lIIlIlIIll[27] = -" ".length();
        K.lIIlIlIIll[28] = 0xFFFFAC7F & 0x251539E;
        K.lIIlIlIIll[29] = 0x61 ^ 0x70;
        K.lIIlIlIIll[30] = 0x24 ^ 0x36;
        K.lIIlIlIIll[31] = 0x68 ^ 0x7B;
        K.lIIlIlIIll[32] = 57 + 40 - 78 + 148 ^ 36 + 142 - 150 + 150;
        K.lIIlIlIIll[33] = 0x1B ^ 0x28 ^ (0xA5 ^ 0x80);
        K.lIIlIlIIll[34] = 0x7F ^ 0x2B ^ (0x2A ^ 0x60);
        K.lIIlIlIIll[35] = 0x9D ^ 0x8B ^ " ".length();
        K.lIIlIlIIll[36] = 0x79 ^ 0x2A ^ (0xE5 ^ 0xAE);
        K.lIIlIlIIll[37] = 0x25 ^ 0x3C;
        K.lIIlIlIIll[38] = 0x55 ^ 0x67 ^ (0x65 ^ 0x4D);
        K.lIIlIlIIll[39] = "   ".length() ^ (0x8E ^ 0x96);
        K.lIIlIlIIll[40] = 0xFFFFB4A9 & 0x4FDF;
        K.lIIlIlIIll[41] = 13 + 122 - 40 + 43 ^ 37 + 43 - 70 + 140;
        K.lIIlIlIIll[42] = -(0xFFFFDF9B & 0x7BF5) & (0xFFFFFFF7 & 0x5FFB);
        K.lIIlIlIIll[43] = 0xB6 ^ 0xAB;
        K.lIIlIlIIll[44] = 0xFFFFAE73 & 0x55BD;
        K.lIIlIlIIll[45] = -(0xFFFFFF93 & 0x4A7D) & (0xFFFFEEFF & 0x5FBF);
        K.lIIlIlIIll[46] = 0x98 ^ 0x87;
        K.lIIlIlIIll[47] = 0xFFFF86BD & 0x7FEA;
        K.lIIlIlIIll[48] = 10 + 105 - -53 + 14 ^ 119 + 70 - 74 + 35;
        K.lIIlIlIIll[49] = -(0xFFFFF6BF & 0x59C2) & (0xFFFFFBFF & 0x7FF7);
        K.lIIlIlIIll[50] = 0x9D ^ 0xBC;
        K.lIIlIlIIll[51] = -(0xFFFFFAF4 & 0x4D4F) & (0xFFFFDBEF & 0x6FD7);
        K.lIIlIlIIll[52] = 0xFFFFBFDA & 0x5F6D;
        K.lIIlIlIIll[53] = 0xFFFF8EF9 & 0xF9BE;
        K.lIIlIlIIll[54] = -(0xFFFFFBF5 & 0xC5E) & (0xFFFFFDFB & 0x6BFF);
        K.lIIlIlIIll[55] = -(0xFFFFDF37 & 0x7CCB) & (0xFFFFDDF7 & 0x7FFE);
        K.lIIlIlIIll[56] = -(0xFFFFC585 & 0x7B7F) & (0xFFFFFFDD & 0x7BBE);
        K.lIIlIlIIll[57] = 0xB6 ^ 0x9F ^ (0x19 ^ 0x12);
        K.lIIlIlIIll[58] = 40 + 67 - 88 + 112 ^ 64 + 130 - 56 + 22;
        K.lIIlIlIIll[59] = 0xFFFFDCDB & 0x2FBD;
        K.lIIlIlIIll[60] = 0xFFFFDCFF & 0x2FDA;
        K.lIIlIlIIll[61] = -(0xFFFFBB57 & 0x76BC) & (0xFFFFBEBF & Short.MAX_VALUE);
        K.lIIlIlIIll[62] = -(0xFFFF9B0F & 0x77F7) & (0xFFFFFFDF & 0x1FF6);
        K.lIIlIlIIll[63] = 0xFFFF8DF7 & 0x7E79;
        K.lIIlIlIIll[64] = 0xFFFFFEFF & 0xD5F;
        K.lIIlIlIIll[65] = 103 + 138 - 178 + 110 ^ 15 + 74 - -17 + 51;
        K.lIIlIlIIll[66] = 0xFFFFBDAD & 0x4EDF;
        K.lIIlIlIIll[67] = -(0xFFFFA3A3 & 0x7CDF) & (0xFFFFEDFF & 0x3EEF);
        K.lIIlIlIIll[68] = 0xFFFFACFF & 0x5FB6;
        K.lIIlIlIIll[69] = -(0xFFFF9497 & 0x7B69) & (0xFFFF9F9F & 0x7CFF);
        K.lIIlIlIIll[70] = 0xFFFFBCFB & 0x4FE4;
        K.lIIlIlIIll[71] = 0x5C ^ 0x78;
    }
    ...
    public int T() {
        ...
        catch (Exception llllllllllllllllllllllllIIIIIlll) {
            llllllllllllllllllllllllIIIIIlll.printStackTrace();
        }
        if ((0x19 ^ 0x4D ^ (0xE7 ^ 0xB7)) < 0) {
            return (0xEB ^ 0x85 ^ (4 ^ 0x3B)) & (0x7E ^ 0x7B ^ (0xC9 ^ 0x9D) ^ -" ".length());
        }
        return lIIlIlIIll[0];
    }
    ...
    private static String llllllIIIIII(String lllllllllllllllllllllllIlllllIIl, String lllllllllllllllllllllllIlllllIlI) {
        try {
            SecretKeySpec lllllllllllllllllllllllIlllllllI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllllllIlllllIlI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            return new String(lllllllllllllllllllllllIllllllIl.doFinal(Base64.getDecoder().decode(lllllllllllllllllllllllIlllllIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void aa() {
        ...
        if (K.llllllIIIlIl(iF.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (K.llllllIIllII(Players.getLocal().getInteracting())) {
                NPC llllllllllllllllllllllllIIIIllII = NPCs.getNearest(nPC -> {
                    int n2;
                ...
                List llllllllllllllllllllllllIIIIlIll = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                    boolean bl;
                    if (K.llllllIIlllI(nPC.getInteracting(), Players.getLocal())) {
                        bl = lIIlIlIIll[1];
                        "".length();
                        if (-" ".length() >= 0) {
                            return ((82 + 134 - 177 + 107 ^ 2 + 39 - -106 + 4) & (0xA ^ 0x49 ^ (0xDB ^ 0x9D) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIIlIlIIll[0];
                    }
                ...
                if (K.llllllIIIlll(llllllllllllllllllllllllIIIIlIll.isEmpty() ? 1 : 0)) {
                    ((NPC)llllllllllllllllllllllllIIIIlIll.get(lIIlIlIIll[0])).interact(lIIlIIllll[lIIlIlIIll[24]]);
                    Time.sleepTicks((int)lIIlIlIIll[3]);
                    "".length();
                }
                if (K.llllllIIlIII(llllllllllllllllllllllllIIIIllII) && K.llllllIIIlll(Players.getLocal().isMoving() ? 1 : 0) && K.llllllIIIlIl(llllllllllllllllllllllllIIIIlIll.isEmpty() ? 1 : 0)) {
                    llllllllllllllllllllllllIIIIllII.interact(lIIlIIllll[lIIlIlIIll[25]]);
                    Time.sleepTicks((int)lIIlIlIIll[3]);
                    "".length();
                }
            }
