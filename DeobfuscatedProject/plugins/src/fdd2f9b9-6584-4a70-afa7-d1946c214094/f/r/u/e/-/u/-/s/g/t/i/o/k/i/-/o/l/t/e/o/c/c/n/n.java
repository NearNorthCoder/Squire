...
implements G {
    ...
    private static void lIIIIIllIllIl() {
        ...
        n.lIIlllIIIl[0] = " ".length();
        n.lIIlllIIIl[1] = (0x79 ^ 0x6F ^ (0xFE ^ 0xA7)) & (0 ^ 0x1D ^ (0xEF ^ 0xBD) ^ -" ".length());
        n.lIIlllIIIl[2] = -(0xFFFFF361 & 0x7E9F) & (0xFFFFFB7F & 0x77FB);
        n.lIIlllIIIl[3] = "  ".length();
        ...
        n.lIIlllIIIl[61] = "   ".length() ^ (0x1D ^ 0xB);
    ...
    private static void lIIIIIllIllII() {
        ...
        n.lIIlllIIII[n.lIIlllIIIl[1]] = n.lIIIIIllIlIIl("ERYLFBBDEh8WFgxTDBgJBgE=", "csxqd");
        n.lIIlllIIII[n.lIIlllIIIl[0]] = n.lIIIIIllIlIlI("kNWD823X+FbXOfj2Bfkg48xxtpxO81vQ", "azxaW");
        n.lIIlllIIII[n.lIIlllIIIl[3]] = n.lIIIIIllIlIlI("oA7FBpvOtlA2cQMpAxpq9/27YUtYBOxg", "YrECF");
        n.lIIlllIIII[n.lIIlllIIIl[10]] = n.lIIIIIllIlIll("9q6axcc7NGyUDBIDcBONR8C1DM8b3Vts", "jwDaR");
        n.lIIlllIIII[n.lIIlllIIIl[12]] = n.lIIIIIllIlIIl("IxkqBSI=", "gkCkI");
        n.lIIlllIIII[n.lIIlllIIIl[13]] = n.lIIIIIllIlIIl("DxIjUQ4uUyMUFTI=", "AsUqz");
        n.lIIlllIIII[n.lIIlllIIIl[14]] = n.lIIIIIllIlIIl("OTYpFw4UdzEWDQJ3JBsDBQ==", "qWGsb");
        n.lIIlllIIII[n.lIIlllIIIl[15]] = n.lIIIIIllIlIIl("OTI6HQ==", "oWUnA");
        n.lIIlllIIII[n.lIIlllIIIl[16]] = n.lIIIIIllIlIll("zz+dNYTYX6HNM79ieaHo6MUJ5a+NiFJH", "JLDOS");
        n.lIIlllIIII[n.lIIlllIIIl[17]] = n.lIIIIIllIlIlI("FSXKBbOjx1Qdo5OJfvOYQOkqwC++Za+g", "EyaPb");
        n.lIIlllIIII[n.lIIlllIIIl[8]] = n.lIIIIIllIlIll("LqjLPFTI7J9Bnug+G/nWgCFZSzwva6qh", "QIFnA");
        n.lIIlllIIII[n.lIIlllIIIl[18]] = n.lIIIIIllIlIll("vxeGx5dWrZs=", "SinlE");
        n.lIIlllIIII[n.lIIlllIIIl[19]] = n.lIIIIIllIlIll("KOgbI+EY3VY=", "lOHDH");
        n.lIIlllIIII[n.lIIlllIIIl[20]] = n.lIIIIIllIlIIl("DigECy0obgYMYzw+ABY=", "ONobC");
        n.lIIlllIIII[n.lIIlllIIIl[21]] = n.lIIIIIllIlIIl("BDYRCQ1mMAoGGS42HA==", "FSxgj");
        n.lIIlllIIII[n.lIIlllIIIl[22]] = n.lIIIIIllIlIIl("NycFECcdOh8WZBUhEAIsEzc=", "vSqqD");
        n.lIIlllIIII[n.lIIlllIIIl[23]] = n.lIIIIIllIlIIl("IjoCEAYI", "cNvqe");
        n.lIIlllIIII[n.lIIlllIIIl[30]] = n.lIIIIIllIlIIl("CyE+PAItLSM+", "YDMYv");
        n.lIIlllIIII[n.lIIlllIIIl[34]] = n.lIIIIIllIlIIl("KyQkLE47NysqHQ==", "xEJHn");
        n.lIIlllIIII[n.lIIlllIIIl[36]] = n.lIIIIIllIlIIl("OAYqNGcoFSUy", "KgDPG");
        n.lIIlllIIII[n.lIIlllIIIl[60]] = n.lIIIIIllIlIlI("aLyvqpj5xEHeXNxlmmCnDevjrEhoEaf9tcbjcneLk0shhB1m8KMryGvG8HSOZj7I", "BCqRh");
        n.lIIlllIIII[n.lIIlllIIIl[61]] = n.lIIIIIllIlIIl("ICQ6RQsMMHQREwggdAgXQzE7RTURIDURUigqIRcXDSFr", "cETer");
        n.lIIlllIIII[n.lIIlllIIIl[62]] = n.lIIIIIllIlIll("U2J94P8TfYjTJxgWorHLFQ==", "NkiuI");
    }
            ...
            while (n.lIIIIIllIlllI(lllllllllllllllllllllIlIlIlIIlll, lllllllllllllllllllllIlIlIlIlIII.size())) {
                ...
                if (n.lIIIIIlllIIIl(((Player)lllllllllllllllllllllIlIlIlIlIII.get(lllllllllllllllllllllIlIlIlIIlll)).equals(Players.getLocal()) ? 1 : 0)) {
                    ...
                    if ((0xC4 ^ 0xA5 ^ (0x7E ^ 0x1A)) == 0) {
                        return ((0x4C ^ 0x62 ^ (0xFC ^ 0xB1)) & (0xC4 ^ 0xB5 ^ (0x79 ^ 0x6B) ^ -" ".length())) != 0;
                    }
    ...
    static NPC au() {
        ...
        if (n.lIIIIIlllIIII(list)) {
            ...
            while (n.lIIIIIllIlllI(lllllllllllllllllllllIlIlIlIllIl, lllllllllllllllllllllIlIlIlIllll.size())) {
                ...
                "".length();
                if (((0x4E ^ 0x5C) & ~(0x69 ^ 0x7B)) <= "  ".length()) continue;
                return null;
            }
        }
        return null;
