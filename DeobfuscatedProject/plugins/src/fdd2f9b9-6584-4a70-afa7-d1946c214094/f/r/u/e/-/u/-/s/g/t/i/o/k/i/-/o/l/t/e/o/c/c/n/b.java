...
public class b {
    ...
    private static void llllIlllIIll() {
        ...
        b.lIIlIIIllI[b.lIIlIIIlll[0]] = b.llllIlllIIII("1QcldbVPino=", "lZjSk");
        b.lIIlIIIllI[b.lIIlIIIlll[1]] = b.llllIlllIIIl("z7cl6CPAALZJCf7j+js0GQ==", "sWRXQ");
        b.lIIlIIIllI[b.lIIlIIIlll[8]] = b.llllIlllIIlI("DwtNLlsWSU0GDCMBTRwGZhYaAR0lDU0cBmYETThbFkUaBxsqAUFIDCgBBAYOZhYOGgA2EQ==", "Femhi");
        b.lIIlIIIllI[b.lIIlIIIlll[4]] = b.llllIlllIIIl("D0sjhPxAK8puBvsWkAIt+7dHEeg1Njun", "aADSq");
        b.lIIlIIIllI[b.lIIlIIIlll[7]] = b.llllIlllIIIl("JFG8Cch+4R+GNSeqjn3FGfVb5VEyh5uB", "KgdiP");
        b.lIIlIIIllI[b.lIIlIIIlll[25]] = b.llllIlllIIIl("ZEOIOdk1zxQ=", "oMpPP");
        b.lIIlIIIllI[b.lIIlIIIlll[26]] = b.llllIlllIIII("PVUUuAW6c3C79CwmpfPlAQ==", "DRGoG");
        b.lIIlIIIllI[b.lIIlIIIlll[13]] = b.llllIlllIIlI("", "Usoby");
        b.lIIlIIIllI[b.lIIlIIIlll[28]] = b.llllIlllIIII("ghDBY6aFk3I=", "EbXnq");
        b.lIIlIIIllI[b.lIIlIIIlll[29]] = b.llllIlllIIlI("ICkEBT4/", "WLeiJ");
        b.lIIlIIIllI[b.lIIlIIIlll[3]] = b.llllIlllIIIl("Klgg0K4BPHM=", "pXPEI");
        b.lIIlIIIllI[b.lIIlIIIlll[27]] = b.llllIlllIIII("tJeScdJkKOrz9K+Oe/olyvP+QAMNZUYT", "yAFwV");
    }
    ...
    private static void llllIlllIlII() {
        ...
        b.lIIlIIIlll[0] = (19 + 80 - 23 + 52 ^ 171 + 37 - 182 + 153) & (70 + 100 - 63 + 31 ^ 16 + 78 - 21 + 112 ^ -" ".length());
        b.lIIlIIIlll[1] = " ".length();
        b.lIIlIIIlll[2] = 0xFFFFD7EF & 0x2BF3;
        b.lIIlIIIlll[3] = 16 + 124 - 18 + 49 ^ 126 + 88 - 116 + 63;
        b.lIIlIIIlll[4] = "   ".length();
                    ...
                    if (b.llllIlllIlIl(GrandExchange.isSelling() ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (b.llllIlllllIl(GrandExchange.getItemId(), (Integer)llllIIIIl.get(lllIlllll))) {
                                ...
                                "".length();
                                if ("   ".length() <= -" ".length()) {
                                    return ((0x68 ^ 0x1A ^ (0x33 ^ 0x50)) & (80 + 26 - 98 + 162 ^ 2 + 57 - 7 + 135 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIlIIIlll[0];
                            }
                        ...
                        if (b.llllIllllIll(GrandExchange.getPrice(), lIIlIIIlll[24])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (b.llllIlllllIl(GrandExchange.getPrice(), lIIlIIIlll[1])) {
                                    ...
                                    "".length();
                                    if (-" ".length() > "  ".length()) {
                                        return ((62 + 196 - 257 + 225 ^ 34 + 166 - 150 + 129) & (0x4B ^ 0x1F ^ (0x60 ^ 0x65) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIlIIIlll[0];
                                }
    ...
    public static boolean a(String string) {
        ...
        if (b.llllIlllIlIl(list.isEmpty() ? 1 : 0)) {
            ...
            while (b.llllIlllIlll(lllIlIllI, lllIllIII.size())) {
                ...
                return ((59 + 109 - 68 + 80 ^ 122 + 115 - 213 + 113) & (0xB9 ^ 0xC0 ^ (0x39 ^ 0x7D) ^ -" ".length())) != 0;
            }
        }
        return lIIlIIIlll[0];
    }
            ...
            while (b.llllIlllIlll(llllIllIl2, K.size())) {
                ...
                while (b.llllIlllIlIl(b.a(llllIllII) ? 1 : 0)) {
                    block69: {
                        block70: {
                                        ...
                                        if (b.llllIlllIlIl(GrandExchange.canCollect() ? 1 : 0)) {
                                            ...
                                            if (b.llllIlllllII(GrandExchange.getOffers().stream().filter(grandExchangeOffer -> {
                                                ...
                                                if (b.llllIlllllIl(grandExchangeOffer.getItemId(), K.get(llllIlIll))) {
                                                    ...
                                                    "".length();
                                                    if ("   ".length() < -" ".length()) {
                                                        return ((5 + 170 - 36 + 88 ^ 54 + 2 - 54 + 160) & (0x72 ^ 0xB ^ (0xB3 ^ 0x8B) ^ -" ".length())) != 0;
                                                    }
                                                } else {
                                                    bl = lIIlIIIlll[0];
                                                }
                                            ...
                                            if (b.llllIlllIllI(llllIlIlI = n2) && b.llllIllllIIl(GrandExchange.getOffers().stream().filter(grandExchangeOffer -> {
                                                ...
                                                if (b.llllIlllllIl(grandExchangeOffer.getItemId(), K.get(llllIlIll))) {
                                                    ...
                                                    "".length();
                                                    if (-" ".length() > 0) {
                                                        return ((0x2C ^ 0x51 ^ (0x24 ^ 0x6C)) & (0xF5 ^ 0xBB ^ (0xCE ^ 0xB5) ^ -" ".length())) != 0;
                                                    }
                                                } else {
                                                    bl = lIIlIIIlll[0];
                                                }
                                            ...
                                            Time.sleepUntil(() -> {
                                                ...
                                                if (b.llllIlllIlIl(GrandExchange.canCollect() ? 1 : 0)) {
                                                    ...
                                                    if ((24 + 109 - 55 + 72 ^ 87 + 11 - -16 + 32) <= 0) {
                                                        return ((0x5B ^ 0x43 ^ (0x11 ^ 7)) & (18 + 157 - 116 + 102 ^ 128 + 143 - 270 + 174 ^ -" ".length())) != 0;
                                                    }
                                                } else {
                                                    bl = lIIlIIIlll[0];
                                                }
                            ...
                            if (b.llllIlllllIl(K.get(llllIllIl2), lIIlIIIlll[16])) {
                                ...
                                if (b.llllIlllIllI(Inventory.contains((int[])nArray8) ? 1 : 0)) {
                                    ...
                                    "".length();
                                    "".length();
                                    if (((0xEB ^ 0xBF ^ (0x2B ^ 0x38)) & (0x28 ^ 0x7B ^ (0xB3 ^ 0xA7) ^ -" ".length())) == 0) continue;
                                    return;
                                }
                            }
                            if (b.llllIlllllIl(K.get(llllIllIl2), lIIlIIIlll[17])) {
                                ...
                                if (b.llllIlllIllI(Inventory.contains((int[])nArray9) ? 1 : 0)) {
                                    ...
                                    "".length();
                                    "".length();
                                    if (((0x95 ^ 0xA1) & ~(0x97 ^ 0xA3)) < "   ".length()) continue;
                                    return;
                                }
                            }
                        ...
                        "".length();
                        "".length();
                        if ("   ".length() > ((58 + 64 - -19 + 67 ^ 124 + 21 - 36 + 35) & (0x67 ^ 0x28 ^ (0x37 ^ 0x38) ^ -" ".length()))) continue;
                        return;
                    }
