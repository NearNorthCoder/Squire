...
implements G {
    ...
    private static String lIIIIIIIIlllI(String llllllllllllllllllllllIIllllIlll, String llllllllllllllllllllllIIllllIllI) {
        llllllllllllllllllllllIIllllIlll = new String(Base64.getDecoder().decode(llllllllllllllllllllllIIllllIlll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllllllIIlllllIlI = new StringBuilder();
        char[] llllllllllllllllllllllIIlllllIIl = llllllllllllllllllllllIIllllIllI.toCharArray();
        int llllllllllllllllllllllIIlllllIII = lIIllIIIII[4];
        char[] llllllllllllllllllllllIIllllIIlI = llllllllllllllllllllllIIllllIlll.toCharArray();
        int llllllllllllllllllllllIIllllIIIl = llllllllllllllllllllllIIllllIIlI.length;
        int llllllllllllllllllllllIIllllIIII = lIIllIIIII[4];
        while (x.lIIIIIIIlIllI(llllllllllllllllllllllIIllllIIII, llllllllllllllllllllllIIllllIIIl)) {
            char llllllllllllllllllllllIIllllllIl = llllllllllllllllllllllIIllllIIlI[llllllllllllllllllllllIIllllIIII];
            llllllllllllllllllllllIIlllllIlI.append((char)(llllllllllllllllllllllIIllllllIl ^ llllllllllllllllllllllIIlllllIIl[llllllllllllllllllllllIIlllllIII % llllllllllllllllllllllIIlllllIIl.length]));
            "".length();
            ++llllllllllllllllllllllIIlllllIII;
            ++llllllllllllllllllllllIIllllIIII;
            "".length();
    ...
    private static void af() {
        block16: {
            d llllllllllllllllllllllIlIIIIlIIl;
            block15: {
                Object llllllllllllllllllllllIlIIIIlIlI;
                block14: {
                    block13: {
                        int[] nArray = new int[lIIllIIIII[3]];
                        ...
                        if (x.lIIIIIIIllIlI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                            llllllllllllllllllllllIlIIIIlIlI = new d(lIIllIIIII[11], lIIllIIIII[3], lIIllIIIII[51]);
                            bv.add((d)llllllllllllllllllllllIlIIIIlIlI);
                            "".length();
                        }
                        int[] nArray3 = new int[lIIllIIIII[3]];
                        nArray3[x.lIIllIIIII[4]] = lIIllIIIII[14];
                        if (x.lIIIIIIIllIlI(Bank.contains((int[])nArray3) ? 1 : 0)) {
                            llllllllllllllllllllllIlIIIIlIlI = new d(lIIllIIIII[14], lIIllIIIII[3], lIIllIIIII[51]);
                            bv.add((d)llllllllllllllllllllllIlIIIIlIlI);
                            "".length();
                        }
                        ...
                        if (x.lIIIIIIIllIlI(Bank.contains((int[])nArray4) ? 1 : 0)) {
                            llllllllllllllllllllllIlIIIIlIlI = new d(lIIllIIIII[18], lIIllIIIII[3], lIIllIIIII[51]);
                            bv.add((d)llllllllllllllllllllllIlIIIIlIlI);
                            "".length();
                        }
                        ...
                        if (x.lIIIIIIIllIlI(Bank.contains((int[])nArray5) ? 1 : 0)) {
                            llllllllllllllllllllllIlIIIIlIlI = new d(lIIllIIIII[16], lIIllIIIII[3], lIIllIIIII[51]);
                            bv.add((d)llllllllllllllllllllllIlIIIIlIlI);
                            "".length();
                        }
                        ...
                        if (x.lIIIIIIIllIlI(Bank.contains((int[])nArray6) ? 1 : 0)) {
                            llllllllllllllllllllllIlIIIIlIlI = new d(lIIllIIIII[13], lIIllIIIII[3], lIIllIIIII[52]);
                            bv.add((d)llllllllllllllllllllllIlIIIIlIlI);
                            "".length();
                        }
                    ...
                    llllllllllllllllllllllIlIIIIlIlI = new d(lIIllIIIII[10], lIIllIIIII[2], lIIllIIIII[53]);
                    bv.add((d)llllllllllllllllllllllIlIIIIlIlI);
                    "".length();
                }
                if (x.lIIIIIIIllIlI(Bank.contains((Predicate)(llllllllllllllllllllllIlIIIIlIlI = item -> item.getName().toLowerCase().contains(lIIlIllllI[lIIllIIIII[59]]))) ? 1 : 0)) {
                    llllllllllllllllllllllIlIIIIlIIl = new d(lIIllIIIII[54], lIIllIIIII[15], lIIllIIIII[55]);
                    bv.add(llllllllllllllllllllllIlIIIIlIIl);
                    "".length();
                }
                int[] nArray = new int[lIIllIIIII[3]];
            ...
            llllllllllllllllllllllIlIIIIlIIl = new d(lIIllIIIII[9], lIIllIIIII[56], lIIllIIIII[52]);
            bv.add(llllllllllllllllllllllIlIIIIlIIl);
            "".length();
        }
    }

    private static String lIIIIIIIlIIII(String llllllllllllllllllllllIIlllIIlIl, String llllllllllllllllllllllIIlllIIllI) {
        try {
            SecretKeySpec llllllllllllllllllllllIIlllIlIlI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllllllIIlllIIllI.getBytes(StandardCharsets.UTF_8)), lIIllIIIII[23]), "DES");
            Cipher llllllllllllllllllllllIIlllIlIIl = Cipher.getInstance("DES");
            llllllllllllllllllllllIIlllIlIIl.init(lIIllIIIII[1], llllllllllllllllllllllIIlllIlIlI);
            return new String(llllllllllllllllllllllIIlllIlIIl.doFinal(Base64.getDecoder().decode(llllllllllllllllllllllIIlllIIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIIIIIIIlIlIl() {
        ...
        x.lIIllIIIII[1] = "  ".length();
        x.lIIllIIIII[2] = 0x1C ^ 0x23 ^ (0x17 ^ 0x22);
        x.lIIllIIIII[3] = " ".length();
        x.lIIllIIIII[4] = (210 + 231 - 440 + 246 ^ 11 + 108 - 53 + 98) & (147 + 140 - 178 + 106 ^ 56 + 111 - 56 + 21 ^ -" ".length());
        ...
        x.lIIllIIIII[77] = 0xB7 ^ 0x85 ^ "  ".length();
    ...
    public static void bh() {
        ...
        if (x.lIIIIIIIllIII(Skills.getLevel((Skill)Skill.COOKING), lIIllIIIII[2]) && x.lIIIIIIIlIlll(e.j(lIIllIIIII[0]), lIIllIIIII[1])) {
            ...
            if (x.lIIIIIIIllIlI(bt ? 1 : 0)) {
                BankLocation llllllllllllllllllllllIlIIIIllIl;
                if (x.lIIIIIIIllIlI(x.ab() ? 1 : 0) && x.lIIIIIIIllIlI(e.j(lIIllIIIII[5]))) {
                    llllllllllllllllllllllIlIIIIllIl = BankLocation.getNearest();
                    if (x.lIIIIIIIllIll(llllllllllllllllllllllIlIIIIllIl) && x.lIIIIIIIllIlI(llllllllllllllllllllllIlIIIIllIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderRogues.c = lIIlIllllI[lIIllIIIII[3]];
                        a.a(llllllllllllllllllllllIlIIIIllIl);
                    }
                    if (x.lIIIIIIIllIll(llllllllllllllllllllllIlIIIIllIl) && x.lIIIIIIIllIIl(llllllllllllllllllllllIlIIIIllIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (x.lIIIIIIIllIlI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                        ...
                        if (x.lIIIIIIIllIlI(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                            ...
                            if (x.lIIIIIIIlllIl(Players.getLocal().getWorldLocation().distanceTo(dk), lIIllIIIII[7])) {
                                ...
                                llllllllllllllllllllllIlIIIIllIl = new WorldArea(lIIllIIIII[25], lIIllIIIII[26], lIIllIIIII[27], lIIllIIIII[28], lIIllIIIII[4]);
                                if (x.lIIIIIIIllIlI(llllllllllllllllllllllIlIIIIllIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                ...
                                if (x.lIIIIIIIllIIl(llllllllllllllllllllllIlIIIIllIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String lIIIIIIIIllll(String llllllllllllllllllllllIIllIllIlI, String llllllllllllllllllllllIIllIlIlll) {
        try {
            SecretKeySpec llllllllllllllllllllllIIllIlllIl = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllllllIIllIlIlll.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllllllllIIllIlllII = Cipher.getInstance("Blowfish");
            llllllllllllllllllllllIIllIlllII.init(lIIllIIIII[1], llllllllllllllllllllllIIllIlllIl);
    ...
    private static void lIIIIIIIlIlII() {
        ...
        x.lIIlIllllI[x.lIIllIIIII[4]] = x.lIIIIIIIIlllI("BCQtESUqKCdYNDc0KhYxYiQ3HTsxYWMLISs5IBA/LCpjGjchJmMMOWI8Nh0lNg==", "BMCxV");
        x.lIIlIllllI[x.lIIllIIIII[3]] = x.lIIIIIIIIllll("v2VAqVZ+7c5PuyVu7ey/FA==", "iElCR");
        x.lIIlIllllI[x.lIIllIIIII[1]] = x.lIIIIIIIIllll("rSlwrK4habW76xg1dW8i8K4VDP260NX7", "aspVc");
        x.lIIlIllllI[x.lIIllIIIII[12]] = x.lIIIIIIIIllll("fwR4TIqyxo45AZlrCvLlXtv+aA4zYCKiEVzhscTBqIXPr5V0J1apjmBOE8tGDD352DHZaZwuVCA=", "cGxNU");
        x.lIIlIllllI[x.lIIllIIIII[7]] = x.lIIIIIIIlIIII("ONVzTad/iqA=", "RLZZN");
        x.lIIlIllllI[x.lIIllIIIII[15]] = x.lIIIIIIIIlllI("KCA5UwQJYTwHERQ1", "fAOsp");
        x.lIIlIllllI[x.lIIllIIIII[17]] = x.lIIIIIIIlIIII("AiOelxV/xeP/P8DaYrIJXQ==", "jwuQR");
        x.lIIlIllllI[x.lIIllIIIII[8]] = x.lIIIIIIIIllll("LEd+gk+4GAk=", "lXTnj");
        x.lIIlIllllI[x.lIIllIIIII[23]] = x.lIIIIIIIIllll("Ft28/awofdcGZ1Evg8VZnQ==", "ISROy");
        x.lIIlIllllI[x.lIIllIIIII[24]] = x.lIIIIIIIlIIII("vWGyKjig9DU/N2FlwQ0PleF6DxcksNbB", "XlbOC");
        x.lIIlIllllI[x.lIIllIIIII[2]] = x.lIIIIIIIIlllI("Hy80Mw==", "HJUAy");
        x.lIIlIllllI[x.lIIllIIIII[30]] = x.lIIIIIIIlIIII("lJVtFg0j6LzfDbd/zgL+HA==", "HXoBK");
        x.lIIlIllllI[x.lIIllIIIII[31]] = x.lIIIIIIIlIIII("hVRbl6ePx41yeYNovIdzyw==", "HBjdm");
        x.lIIlIllllI[x.lIIllIIIII[33]] = x.lIIIIIIIlIIII("vBg6Wf3Mq/k=", "sJrJt");
        x.lIIlIllllI[x.lIIllIIIII[34]] = x.lIIIIIIIIlllI("KAQU", "jqmZm");
        x.lIIlIllllI[x.lIIllIIIII[36]] = x.lIIIIIIIIllll("8zkXpa/fH0U=", "ivScM");
        x.lIIlIllllI[x.lIIllIIIII[35]] = x.lIIIIIIIlIIII("/QAmsijT+xk=", "WMaRi");
        x.lIIlIllllI[x.lIIllIIIII[37]] = x.lIIIIIIIIlllI("My0IBhtXJhYTEQM=", "wDzrb");
        x.lIIlIllllI[x.lIIllIIIII[38]] = x.lIIIIIIIIlllI("NjU+OgQ=", "uYQIa");
        x.lIIlIllllI[x.lIIllIIIII[39]] = x.lIIIIIIIIllll("wHtECnEHenA/m8VQ4cUkAA==", "GBbyP");
        x.lIIlIllllI[x.lIIllIIIII[40]] = x.lIIIIIIIIllll("x2S8AkqN5k96s3L2/SuzNA==", "DDxRx");
        x.lIIlIllllI[x.lIIllIIIII[41]] = x.lIIIIIIIIllll("Cb5SV+3LZo4=", "Hkhqy");
        x.lIIlIllllI[x.lIIllIIIII[42]] = x.lIIIIIIIIlllI("IAAoEBwBDyFUFAEAKhsX", "haFtp");
        x.lIIlIllllI[x.lIIllIIIII[43]] = x.lIIIIIIIIlllI("ER8HHg==", "Rphup");
        x.lIIlIllllI[x.lIIllIIIII[44]] = x.lIIIIIIIlIIII("DanzC133Zkg=", "FKLWg");
        x.lIIlIllllI[x.lIIllIIIII[45]] = x.lIIIIIIIIllll("bs7bmKLBkOM=", "Cmfvj");
        x.lIIlIllllI[x.lIIllIIIII[46]] = x.lIIIIIIIIlllI("MzcgKQ==", "rEIZj");
        x.lIIlIllllI[x.lIIllIIIII[47]] = x.lIIIIIIIIlllI("EDYlEhU8NjZXFTo3PA==", "UXQwg");
        x.lIIlIllllI[x.lIIllIIIII[48]] = x.lIIIIIIIIlllI("Eic2Cw==", "VHYyM");
        x.lIIlIllllI[x.lIIllIIIII[0]] = x.lIIIIIIIIlllI("PzcmHw==", "pGCqN");
        x.lIIlIllllI[x.lIIllIIIII[49]] = x.lIIIIIIIIllll("WpT2hweNR6rWIDZGaYKJxw==", "ASBNr");
        x.lIIlIllllI[x.lIIllIIIII[50]] = x.lIIIIIIIIlllI("CCo9ESduOiQZIDo=", "NXHxS");
        x.lIIlIllllI[x.lIIllIIIII[58]] = x.lIIIIIIIlIIII("6pdUQeUHEMuzNmXtoafgWQ==", "dZpMZ");
        x.lIIlIllllI[x.lIIllIIIII[59]] = x.lIIIIIIIIllll("Kx4FW3CNiJnw/riMGE0S5i5Cxm0kR8AZ", "vykir");
        x.lIIlIllllI[x.lIIllIIIII[60]] = x.lIIIIIIIlIIII("gjn+fmyEKWI=", "xlJFV");
        x.lIIlIllllI[x.lIIllIIIII[61]] = x.lIIIIIIIlIIII("GQJaUIhPBts=", "rlJNy");
        x.lIIlIllllI[x.lIIllIIIII[62]] = x.lIIIIIIIIlllI("PR8rIwY3DQ==", "YjNOo");
        x.lIIlIllllI[x.lIIllIIIII[63]] = x.lIIIIIIIIlllI("Ii0RIiUoPw==", "FXtNL");
        x.lIIlIllllI[x.lIIllIIIII[64]] = x.lIIIIIIIIllll("ikdVBrU9A5M=", "BdtYD");
        x.lIIlIllllI[x.lIIllIIIII[65]] = x.lIIIIIIIIllll("0Krgay5tcQ0=", "djeqs");
        x.lIIlIllllI[x.lIIllIIIII[56]] = x.lIIIIIIIIllll("uamrroVH+qM=", "mdAtt");
        x.lIIlIllllI[x.lIIllIIIII[66]] = x.lIIIIIIIlIIII("bxsIxpx5OSQ=", "VlhXR");
        x.lIIlIllllI[x.lIIllIIIII[71]] = x.lIIIIIIIlIIII("HXYIpgfEDIoilLnpLVe4X8tzE1CWBNyE", "PqFHV");
        x.lIIlIllllI[x.lIIllIIIII[72]] = x.lIIIIIIIlIIII("dMU/x+UwEK3btSjFDKYwJtyVuDNy/eSs2CiI5yENWX3x8x2Nw0RwXmNQu6Xu8gvd", "QdyGS");
        x.lIIlIllllI[x.lIIllIIIII[73]] = x.lIIIIIIIIlllI("FgkcOCI7BhFhYx5KAyMsIEofJSYlD0g5LHcMASMndx4AJDB3GRw4JTFE", "WjhMC");
        x.lIIlIllllI[x.lIIllIIIII[74]] = x.lIIIIIIIIllll("rRClBDt/PI0=", "duhng");
        x.lIIlIllllI[x.lIIllIIIII[75]] = x.lIIIIIIIIlllI("BhEgE0oiWTYVAj8efg==", "QyAgm");
        x.lIIlIllllI[x.lIIllIIIII[76]] = x.lIIIIIIIlIIII("wT9RCMjfyua8CieBvLXqW+K/Tuyt8gAuhbmfzcy35K1qjGTaFgWFcA==", "ZUxHt");
        x.lIIlIllllI[x.lIIllIIIII[77]] = x.lIIIIIIIIllll("1HymH92y3noJ38S5rxNYH7m9XcZ1x1ZT/LuU2NLrgt0=", "GoIBI");
        x.lIIlIllllI[x.lIIllIIIII[78]] = x.lIIIIIIIIllll("Q9SBkcYOa4h275IRufuIe7/gY3cziVf96Teh49AgGoU=", "KYTDE");
    }
    ...
    public boolean V() {
        ...
        if (x.lIIIIIIlIIIII(Quests.getState((Quest)Quest.RECIPE_FOR_DISASTER__ANOTHER_COOKS_QUEST), QuestState.FINISHED)) {
            ...
            "".length();
            if (null != null) {
                return ((93 + 57 - 74 + 55 ^ 158 + 167 - 224 + 68) & (122 + 213 - 319 + 220 ^ 59 + 124 - 10 + 25 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIllIIIII[4];
        }
