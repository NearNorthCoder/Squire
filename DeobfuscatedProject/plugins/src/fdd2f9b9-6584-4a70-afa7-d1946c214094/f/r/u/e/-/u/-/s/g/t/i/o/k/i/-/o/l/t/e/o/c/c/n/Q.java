...
implements G {
                    ...
                    if (Q.lllIllllIIlI(Inventory.getCount((int[])nArray4), lIIIllIlII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (Q.lllIllllIlII(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (-" ".length() >= "   ".length()) {
                                    return ((0xC0 ^ 0xA6 ^ (0x4F ^ 0x3E)) & (20 + 38 - -82 + 14 ^ 46 + 64 - 9 + 40 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIIIllIlII[0];
                            }
                        ...
                        if (Q.lllIllllIlII(Inventory.getCount((int[])nArray7))) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (Q.lllIllllIlII(Inventory.getCount((int[])nArray))) {
                                    bl = lIIIllIlII[1];
                                    "".length();
                                    if (((0xAF ^ 0xB8 ^ (0x64 ^ 0x7F)) & (0x37 ^ 0x71 ^ (0x5C ^ 0x16) ^ -" ".length())) == "   ".length()) {
                                        return ((54 + 60 - 0 + 77 ^ 5 + 119 - 16 + 52) & (0x6C ^ 0x7D ^ (3 ^ 0xD) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIllIlII[0];
                                }
                        ...
                        if (Q.lllIllllIllI(Skills.getLevel((Skill)Skill.CRAFTING), lIIIllIlII[6]) && Q.lllIllllIIlI(Skills.getLevel((Skill)Skill.CRAFTING), lIIIllIlII[14])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!Q.lllIllllIllI(Inventory.getCount((int[])nArray), lIIIllIlII[1]) || Q.lllIllllIIIl(Dialog.isOpen() ? 1 : 0)) {
                                    bl = lIIIllIlII[1];
                                    "".length();
                                    if (" ".length() <= ((79 + 19 - 30 + 122 ^ 89 + 13 - -81 + 1) & (0x9A ^ 0xBF ^ (0x69 ^ 0x4A) ^ -" ".length()))) {
                        ...
                        if (Q.lllIllllIllI(Skills.getLevel((Skill)Skill.CRAFTING), lIIIllIlII[14]) && Q.lllIllllIIlI(Skills.getLevel((Skill)Skill.CRAFTING), lIIIllIlII[16])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!Q.lllIllllIllI(Inventory.getCount((int[])nArray), lIIIllIlII[1]) || Q.lllIllllIIIl(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (null != null) {
                                        return ((0x7F ^ 0x69 ^ (0x55 ^ 0x6E)) & (0xB3 ^ 0x88 ^ (0x85 ^ 0x93) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIllIlII[0];
                                }
                        ...
                        if (Q.lllIllllIllI(Skills.getLevel((Skill)Skill.CRAFTING), lIIIllIlII[19]) && Q.lllIllllIIlI(Skills.getLevel((Skill)Skill.CRAFTING), lIIIllIlII[21])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!Q.lllIllllIllI(Inventory.getCount((int[])nArray), lIIIllIlII[1]) || Q.lllIllllIIIl(Dialog.isOpen() ? 1 : 0)) {
                                    bl = lIIIllIlII[1];
                                    "".length();
                                    if (((0xEC ^ 0x95 ^ (0xE2 ^ 0x9E)) & (0xDF ^ 0xBA ^ (0x7A ^ 0x1A) ^ -" ".length())) > 0) {
                                        return (((0x71 ^ 0x3D) & ~(0x69 ^ 0x25) ^ (1 ^ 0x31)) & (0xF1 ^ 0xB1 ^ (0x60 ^ 0x10) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIllIlII[0];
                                }
                        ...
                        if (Q.lllIllllIllI(Skills.getLevel((Skill)Skill.CRAFTING), lIIIllIlII[24]) && Q.lllIllllIIlI(Skills.getLevel((Skill)Skill.CRAFTING), lIIIllIlII[27])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!Q.lllIllllIllI(Inventory.getCount((int[])nArray), lIIIllIlII[1]) || Q.lllIllllIIIl(Dialog.isOpen() ? 1 : 0)) {
                                    bl = lIIIllIlII[1];
                                    "".length();
                                    if (((0x41 ^ 0x4A ^ (0x31 ^ 0x19)) & (75 + 92 - 133 + 94 ^ 43 + 98 - 65 + 87 ^ -" ".length())) > 0) {
                                        return ((24 + 150 - 155 + 134 ^ 139 + 104 - 76 + 27) & (17 + 51 - 48 + 192 ^ 124 + 121 - 193 + 91 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIllIlII[0];
                                }
                        ...
                        if (Q.lllIllllIllI(Skills.getLevel((Skill)Skill.CRAFTING), lIIIllIlII[27])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!Q.lllIllllIllI(Inventory.getCount((int[])nArray), lIIIllIlII[1]) || Q.lllIllllIIIl(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (" ".length() != " ".length()) {
                                        return ((63 + 193 - 184 + 137 ^ 40 + 43 - 21 + 81) & (213 + 0 - 137 + 142 ^ 92 + 75 - 35 + 0 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIllIlII[0];
                                }
    ...
    private static void lllIllllIIII() {
        ...
        Q.lIIIllIlII[0] = (0xB8 ^ 0x8E ^ (0x5D ^ 0x64)) & (0x42 ^ 0x1E ^ (0x1C ^ 0x4F) ^ -" ".length());
        Q.lIIIllIlII[1] = " ".length();
        Q.lIIIllIlII[2] = 0xFFFF87E7 & 0x7BFB;
        Q.lIIIllIlII[3] = "  ".length();
        Q.lIIIllIlII[4] = "   ".length();
        ...
        Q.lIIIllIlII[33] = -"  ".length() & (0xFFFFC73B & 0x3FFF);
    ...
    private static String lllIlllIllIl(String llllIIlIlII, String llllIIlIIll) {
        ...
        while (Q.lllIllllIIlI(llllIIIllIl, llllIIIlllI)) {
            ...
            ++llllIIIllIl;
            "".length();
            if ((67 + 96 - 54 + 24 ^ 28 + 4 - -59 + 38) != "  ".length()) continue;
            return null;
        }
    ...
    private static void lllIlllIlllI() {
        ...
        Q.lIIIllIIll[Q.lIIIllIlII[0]] = Q.lllIlllIlIll("4GK1/Prs0UJvUP7FA/MllQ==", "zfijv");
        Q.lIIIllIIll[Q.lIIIllIlII[1]] = Q.lllIlllIlIll("2oCmAayUCsdtcJwaV/dT13gAoUtE1srs5RMVr7bhdHp2mUwa4TD/aiIiByIfopzSQkspn09MvIg=", "HZDXi");
        Q.lIIIllIIll[Q.lIIIllIlII[3]] = Q.lllIlllIllII("mWCcj2qCVcP8jmygfzw93lyLFfmw6C5+", "YmmdO");
        Q.lIIIllIIll[Q.lIIIllIlII[4]] = Q.lllIlllIlIll("osWbHoxQDb0kx//2rwroiA==", "Qpcgo");
        Q.lIIIllIIll[Q.lIIIllIlII[6]] = Q.lllIlllIlIll("ZOH2DwaxLIAQZjSXRNR0l/W0NI7vsGrg", "fMAXk");
        Q.lIIIllIIll[Q.lIIIllIlII[9]] = Q.lllIlllIllII("Jnj0UGOjvSinqZoy3bC92y+pVVbH5hy+Hsjyp46rdxpHlaw3DkUl0xfd3DySU15g", "SQoxV");
        Q.lIIIllIIll[Q.lIIIllIlII[10]] = Q.lllIlllIllII("5LSvYrgl+tEWYFMe8iopJA==", "bHzbA");
        Q.lIIIllIIll[Q.lIIIllIlII[11]] = Q.lllIlllIllIl("FBsbPyU+Bx15NjsICSo=", "WizYQ");
        Q.lIIIllIIll[Q.lIIIllIlII[12]] = Q.lllIlllIllII("mwf6jNKNZnIwWH+yaalUHg==", "AxjsL");
        Q.lIIIllIIll[Q.lIIIllIlII[15]] = Q.lllIlllIllII("HQh+PcWN3tvynZ0C8zAjYrTTh+5AStO2", "vfXXr");
        Q.lIIIllIIll[Q.lIIIllIlII[17]] = Q.lllIlllIllII("HC46du+8EdyKGk1nKTIAkw==", "VSJyU");
        Q.lIIIllIIll[Q.lIIIllIlII[18]] = Q.lllIlllIllII("OIRVh6fA7YdWvlKXnOzW0w==", "ORnAf");
        Q.lIIIllIIll[Q.lIIIllIlII[14]] = Q.lllIlllIllII("qFniI8f5YWrewXZSVMwBvw==", "EOYwj");
        Q.lIIIllIIll[Q.lIIIllIlII[20]] = Q.lllIlllIlIll("KvbEaDtPcP4=", "dRVAt");
        Q.lIIIllIIll[Q.lIIIllIlII[22]] = Q.lllIlllIllIl("FxwtAyI9ACtFMD0dJAc5IwI=", "TnLeV");
        Q.lIIIllIIll[Q.lIIIllIlII[23]] = Q.lllIlllIllII("04tkeccCu41ftn4JLc3MLQ==", "dwEIA");
        Q.lIIIllIIll[Q.lIIIllIlII[25]] = Q.lllIlllIllIl("Ah8jBRMoAyVDCDMP", "AmBcg");
        Q.lIIIllIIll[Q.lIIIllIlII[26]] = Q.lllIlllIlIll("B2fg4kYP0Nk3wrQ5XL3OaDmF+BM0L+0d", "ROCTV");
        Q.lIIIllIIll[Q.lIIIllIlII[28]] = Q.lllIlllIllIl("GhsNLAYwBwtqHjwHHw==", "YilJr");
        Q.lIIIllIIll[Q.lIIIllIlII[29]] = Q.lllIlllIllIl("BzsWGQg5NFgBCCUp", "KZxmm");
        Q.lIIIllIIll[Q.lIIIllIlII[30]] = Q.lllIlllIlIll("uw0Mj470XXIf8VdSMJy9WZMDIRGA8qrE", "OdFUk");
        Q.lIIIllIIll[Q.lIIIllIlII[31]] = Q.lllIlllIlIll("OL1LXtfnzFeb4CoxSYmOrA==", "yhIGZ");
        Q.lIIIllIIll[Q.lIIIllIlII[32]] = Q.lllIlllIllII("YQ6cWxJ35OjvSXapAL7poCsEXZephZgS", "rMocZ");
        Q.lIIIllIIll[Q.lIIIllIlII[35]] = Q.lllIlllIllII("usIOr/Zzb92j7AdM5NyHFo9YlKO4De3rzRqajCXi3P0=", "xWYOR");
        Q.lIIIllIIll[Q.lIIIllIlII[43]] = Q.lllIlllIlIll("pz8qMtX7FrnbgUQ/Q+uuTw==", "Zlhaw");
        Q.lIIIllIIll[Q.lIIIllIlII[45]] = Q.lllIlllIlIll("gROuIbuhfY/h+dA27iT2ceNfXCsEMabx", "laZNT");
    }
