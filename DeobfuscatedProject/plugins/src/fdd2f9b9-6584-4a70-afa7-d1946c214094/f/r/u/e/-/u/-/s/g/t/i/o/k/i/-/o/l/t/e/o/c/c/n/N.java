...
implements G {
    ...
    private static void llllllllIlll() {
        ...
        N.lIIlIllIlI[N.lIIlIllIll[1]] = N.llllllllIlII("z0DiVwsgX6Ht0yndzHOQEg==", "WLQDu");
        N.lIIlIllIlI[N.lIIlIllIll[2]] = N.llllllllIlII("ZYdqtFtihoIBWC7wma7D5ua1c4IHkwQ4v8M637kSlySfiek3gClFqAoP7XgAo+DT", "ItkqT");
        N.lIIlIllIlI[N.lIIlIllIll[4]] = N.llllllllIlIl("HwoeEQ8wHwEWD3EfB1gKMAUD", "Qkhxh");
        N.lIIlIllIlI[N.lIIlIllIll[5]] = N.llllllllIlII("JfrqitXtqJwgjSuAwH465463NwMPgkCO", "QMpOy");
        N.lIIlIllIlI[N.lIIlIllIll[7]] = N.llllllllIlII("JXMg3eF0b++IIwrfkLabdpGpNo+RluqhJH633Vp8EmozZzRcK16vpO+Yy1TtISkiqBDeMl0KEvQ=", "EbUdF");
        N.lIIlIllIlI[N.lIIlIllIll[14]] = N.llllllllIlII("nCiJy23a6Ag=", "OiVEY");
        N.lIIlIllIlI[N.lIIlIllIll[16]] = N.llllllllIlIl("IB06J3YAF3Y1PxgcLw==", "txVBV");
        N.lIIlIllIlI[N.lIIlIllIll[18]] = N.llllllllIlII("KeIAhiHPyCw=", "WPEwJ");
        N.lIIlIllIlI[N.lIIlIllIll[19]] = N.llllllllIlIl("Oy4CDGY6Lg4I", "wOtmF");
        N.lIIlIllIlI[N.lIIlIllIll[20]] = N.llllllllIlIl("IzkCD0FMJgYaCBw9EQJNGD1DGggaNw9WWV1yNB8BCDcRGAgfIU0=", "lRcvm");
        N.lIIlIllIlI[N.lIIlIllIll[22]] = N.llllllllIlIl("OxY8TwIaVysDAhQF", "uwJov");
        N.lIIlIllIlI[N.lIIlIllIll[42]] = N.llllllllIlII("YshyETb+H/KUtbzfKRyZ1A==", "WGsgT");
        N.lIIlIllIlI[N.lIIlIllIll[45]] = N.llllllllIlII("jkHtPV30GUWZTkuawFK19w==", "yCzRx");
        N.lIIlIllIlI[N.lIIlIllIll[21]] = N.llllllllIlII("qdvBJATLXWjKHtcoPqP2ww==", "Bxxgs");
        N.lIIlIllIlI[N.lIIlIllIll[47]] = N.llllllllIlII("BQH1lSvtIW4=", "dHVpm");
        N.lIIlIllIlI[N.lIIlIllIll[48]] = N.llllllllIlIl("CSoQNg==", "FZuXl");
        N.lIIlIllIlI[N.lIIlIllIll[49]] = N.llllllllIlII("ET93jo4jTTA=", "FMflq");
        N.lIIlIllIlI[N.lIIlIllIll[50]] = N.llllllllIllI("Tk5ADcunmKY4m4qLmuvdPw==", "reNPd");
        N.lIIlIllIlI[N.lIIlIllIll[52]] = N.llllllllIlIl("FAITTQU1QwQBBTsR", "Zcemq");
        N.lIIlIllIlI[N.lIIlIllIll[53]] = N.llllllllIlIl("Nh8kPgAKHy1xFgwfLyI=", "cqJQt");
        N.lIIlIllIlI[N.lIIlIllIll[15]] = N.llllllllIlII("n9+l85Cc4XVlrD2DvMotIVtzQtzGxDaO", "kqrlr");
        N.lIIlIllIlI[N.lIIlIllIll[54]] = N.llllllllIllI("cgcFTmy+vjJiNwnbCuOz1w==", "ErROz");
        N.lIIlIllIlI[N.lIIlIllIll[55]] = N.llllllllIlIl("KCUuDw==", "gUKax");
        N.lIIlIllIlI[N.lIIlIllIll[56]] = N.llllllllIlII("4hyW4Vd6x+c=", "YSyVC");
        N.lIIlIllIlI[N.lIIlIllIll[57]] = N.llllllllIllI("VhvS0OCRltQ=", "LXkME");
        N.lIIlIllIlI[N.lIIlIllIll[58]] = N.llllllllIlII("l1tuKhYVVyN1Bx3MNH78wQ==", "VyLLz");
        N.lIIlIllIlI[N.lIIlIllIll[59]] = N.llllllllIlII("8VlxyS+mZ0Frj/6akd066g==", "LsnkT");
        N.lIIlIllIlI[N.lIIlIllIll[60]] = N.llllllllIlII("p/YYgT9+d0MCpY2Tc2SvBg==", "rPeYi");
        N.lIIlIllIlI[N.lIIlIllIll[61]] = N.llllllllIlII("bILCknG5fNh3+EG2Yo/lOA==", "vIzgV");
        N.lIIlIllIlI[N.lIIlIllIll[62]] = N.llllllllIllI("lFCTinyG1GPNUdGSg6YTaQ==", "hIdmA");
        N.lIIlIllIlI[N.lIIlIllIll[63]] = N.llllllllIlII("3w1P3lOoL94=", "LPYfw");
        N.lIIlIllIlI[N.lIIlIllIll[75]] = N.llllllllIlIl("KgIEHAAIUBEXBBMeDAsC", "zpeee");
        N.lIIlIllIlI[N.lIIlIllIll[76]] = N.llllllllIlIl("PSg3FHcgJ3kEMi4tLRt3Zw==", "OAYsW");
    }

    private static void af() {
        d llllllllllllllllllllllIlIllIIIll;
        Object llllllllllllllllllllllIlIllIIlII;
        int[] nArray = new int[lIIlIllIll[2]];
        ...
        if (N.lIIIIIIIIIllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            llllllllllllllllllllllIlIllIIlII = new d(lIIlIllIll[0], N.cC(), lIIlIllIll[64]);
            bv.add((d)llllllllllllllllllllllIlIllIIlII);
            "".length();
        }
        int[] nArray3 = new int[lIIlIllIll[2]];
        nArray3[N.lIIlIllIll[1]] = lIIlIllIll[8];
        if (N.lIIIIIIIIIllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
            llllllllllllllllllllllIlIllIIlII = new d(lIIlIllIll[8], lIIlIllIll[4], lIIlIllIll[6]);
            bv.add((d)llllllllllllllllllllllIlIllIIlII);
            "".length();
        }
        if (N.lIIIIIIIIIllI(Bank.contains((Predicate)(llllllllllllllllllllllIlIllIIlII = item -> item.getName().toLowerCase().contains(lIIlIllIlI[lIIlIllIll[76]]))) ? 1 : 0)) {
            llllllllllllllllllllllIlIllIIIll = new d(lIIlIllIll[65], lIIlIllIll[14], lIIlIllIll[66]);
            bv.add(llllllllllllllllllllllIlIllIIIll);
            "".length();
        }
        int[] nArray4 = new int[lIIlIllIll[2]];
        nArray4[N.lIIlIllIll[1]] = lIIlIllIll[67];
        if (N.lIIIIIIIIIllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
            llllllllllllllllllllllIlIllIIIll = new d(lIIlIllIll[67], lIIlIllIll[68], lIIlIllIll[69]);
            bv.add(llllllllllllllllllllllIlIllIIIll);
            "".length();
        }
    }
    ...
    private static void lIIIIIIIIIIll() {
        ...
        N.lIIlIllIll[1] = (0x29 ^ 0x39 ^ (0x6E ^ 0x51)) & (0x28 ^ 0x31 ^ (0x7F ^ 0x49) ^ -" ".length());
        N.lIIlIllIll[2] = " ".length();
        N.lIIlIllIll[3] = 0xAC ^ 0x81;
        N.lIIlIllIll[4] = "  ".length();
        N.lIIlIllIll[5] = "   ".length();
        ...
        N.lIIlIllIll[12] = (0x79 ^ 0x61) + "  ".length() - (0xA1 ^ 0xB9) + (42 + 125 - 0 + 31);
        ...
        N.lIIlIllIll[49] = " ".length() ^ (0x1C ^ 0xD);
    ...
    private static String llllllllIlII(String llllllllllllllllllllllIlIIlllIll, String llllllllllllllllllllllIlIIlllIlI) {
        try {
            SecretKeySpec llllllllllllllllllllllIlIlIIIIII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllllllIlIIlllIlI.getBytes(StandardCharsets.UTF_8)), lIIlIllIll[19]), "DES");
            Cipher llllllllllllllllllllllIlIIllllll = Cipher.getInstance("DES");
            llllllllllllllllllllllIlIIllllll.init(lIIlIllIll[4], llllllllllllllllllllllIlIlIIIIII);
            return new String(llllllllllllllllllllllIlIIllllll.doFinal(Base64.getDecoder().decode(llllllllllllllllllllllIlIIlllIll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public boolean V() {
        ...
        if (N.lIIIIIIIIllII(Skills.getLevel((Skill)Skill.PRAYER), lIIlIllIll[3])) {
            ...
            "".length();
            if (null != null) {
                return ((135 + 98 - 231 + 136 ^ 9 + 159 - 73 + 93) & (227 + 106 - 176 + 87 ^ 152 + 91 - 214 + 165 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIlIllIll[1];
        }
    ...
    public static void cB() {
        block44: {
            TileItem llllllllllllllllllllllIlIllIlIlI;
            block45: {
                ...
                if (N.lIIIIIIIIIllI(N.ab() ? 1 : 0) && N.lIIIIIIIIIlIl(Game.getWildyLevel(), lIIlIllIll[2])) {
                    llllllllllllllllllllllIlIllIlIlI = BankLocation.getNearest();
                    if (N.lIIIIIIIIIlll(llllllllllllllllllllllIlIllIlIlI) && N.lIIIIIIIIIllI(llllllllllllllllllllllIlIllIlIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderRogues.c = lIIlIllIlI[lIIlIllIll[4]];
                        a.a((BankLocation)llllllllllllllllllllllIlIllIlIlI);
                    }
                    if (N.lIIIIIIIIIlll(llllllllllllllllllllllIlIllIlIlI) && N.lIIIIIIIIIlII(llllllllllllllllllllllIlIllIlIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (N.lIIIIIIIIIlII(N.ab() ? 1 : 0)) {
                    ...
                    if (N.lIIIIIIIIlIII(Game.getWildyLevel())) {
                        TileObject llllllllllllllllllllllIlIllIlIIl;
                        int[] nArray = new int[lIIlIllIll[2]];
                        ...
                        if (N.lIIIIIIIIIlII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            if (N.lIIIIIIIIlIIl(Players.getLocal().getWorldLocation().distanceTo(iL), lIIlIllIll[21])) {
                                ...
                                llllllllllllllllllllllIlIllIlIlI = tileItem;
                                Walker.walkAlong(Arrays.asList(llllllllllllllllllllllIlIllIlIlI), new HashMap());
                                "".length();
                                Time.sleepTicks((int)lIIlIllIll[2]);
                                "".length();
                            }
                            if (N.lIIIIIIIIlIll(Players.getLocal().getWorldLocation().distanceTo(iL), lIIlIllIll[21])) {
                                ...
                                llllllllllllllllllllllIlIllIlIlI = TileObjects.getNearest((String[])stringArray);
                                String[] stringArray2 = new String[lIIlIllIll[2]];
                                stringArray2[N.lIIlIllIll[1]] = lIIlIllIlI[lIIlIllIll[21]];
                                llllllllllllllllllllllIlIllIlIIl = TileObjects.getNearest((String[])stringArray2);
                                String[] stringArray3 = new String[lIIlIllIll[2]];
                                stringArray3[N.lIIlIllIll[1]] = lIIlIllIlI[lIIlIllIll[47]];
                                if (N.lIIIIIIIIIlII(llllllllllllllllllllllIlIllIlIIl.hasAction(stringArray3) ? 1 : 0)) {
                                    llllllllllllllllllllllIlIllIlIIl.interact(lIIlIllIlI[lIIlIllIll[48]]);
                                }
                                if (N.lIIIIIIIIIlll(llllllllllllllllllllllIlIllIlIlI)) {
                                    String[] stringArray4 = new String[lIIlIllIll[2]];
                                    stringArray4[N.lIIlIllIll[1]] = lIIlIllIlI[lIIlIllIll[49]];
                                    if (N.lIIIIIIIIIllI(llllllllllllllllllllllIlIllIlIIl.hasAction(stringArray4) ? 1 : 0)) {
                                        int llllllllllllllllllllllIlIllIlIII = Skills.getExperience((Skill)Skill.PRAYER);
                                        int[] nArray3 = new int[lIIlIllIll[2]];
                                        nArray3[N.lIIlIllIll[1]] = lIIlIllIll[0];
                        ...
                        if (N.lIIIIIIIIIllI(Inventory.contains((int[])nArray4) ? 1 : 0)) {
                            ...
                            if (N.lIIIIIIIIIlII(Inventory.contains((int[])nArray5) ? 1 : 0)) {
                                if (N.lIIIIIIIIlIIl(Players.getLocal().getWorldLocation().distanceTo(iL), lIIlIllIll[21])) {
                                    ...
                                    llllllllllllllllllllllIlIllIlIlI = worldPointArray;
                                    Walker.walkAlong(Arrays.asList(llllllllllllllllllllllIlIllIlIlI), new HashMap());
                                    "".length();
                                    Time.sleepTicks((int)lIIlIllIll[2]);
                                    "".length();
                                ...
                                if (N.lIIIIIIIIlIll(Players.getLocal().getWorldLocation().distanceTo(iL), lIIlIllIll[21])) {
                                    ...
                                    llllllllllllllllllllllIlIllIlIlI = NPCs.getNearest((String[])stringArray);
                                    String[] stringArray6 = new String[lIIlIllIll[2]];
                                    stringArray6[N.lIIlIllIll[1]] = lIIlIllIlI[lIIlIllIll[54]];
                                    llllllllllllllllllllllIlIllIlIIl = TileObjects.getNearest((String[])stringArray6);
                                    String[] stringArray7 = new String[lIIlIllIll[2]];
                                    stringArray7[N.lIIlIllIll[1]] = lIIlIllIlI[lIIlIllIll[55]];
                                    if (N.lIIIIIIIIIlII(llllllllllllllllllllllIlIllIlIIl.hasAction(stringArray7) ? 1 : 0)) {
                                        llllllllllllllllllllllIlIllIlIIl.interact(lIIlIllIlI[lIIlIllIll[56]]);
                                    }
                                    if (N.lIIIIIIIIIlll(llllllllllllllllllllllIlIllIlIlI)) {
                                        String[] stringArray8 = new String[lIIlIllIll[2]];
                                        stringArray8[N.lIIlIllIll[1]] = lIIlIllIlI[lIIlIllIll[57]];
                                        if (N.lIIIIIIIIIllI(llllllllllllllllllllllIlIllIlIIl.hasAction(stringArray8) ? 1 : 0)) {
                                            List llllllllllllllllllllllIlIllIlIII;
                                            if (N.lIIIIIIIIIllI(Dialog.isOpen() ? 1 : 0)) {
                                                int[] nArray6 = new int[lIIlIllIll[2]];
                                                nArray6[N.lIIlIllIll[1]] = lIIlIllIll[51];
                                                Inventory.getFirst((int[])nArray6).useOn((Actor)llllllllllllllllllllllIlIllIlIlI);
                                                Time.sleepTicks((int)lIIlIllIll[4]);
                                                "".length();
                                            }
                                            if (N.lIIIIIIIIIlII(Dialog.isOpen() ? 1 : 0) && N.lIIIIIIIIIllI((llllllllllllllllllllllIlIllIlIII = Dialog.getOptions()).isEmpty() ? 1 : 0)) {
                                                int llllllllllllllllllllllIlIllIIlll = lIIlIllIll[1];
                                                while (N.lIIIIIIIIIlIl(llllllllllllllllllllllIlIllIIlll, llllllllllllllllllllllIlIllIlIII.size())) {
                                                    int[] nArray7 = new int[lIIlIllIll[2]];
                                                    nArray7[N.lIIlIllIll[1]] = lIIlIllIll[51];
                                                    if (N.lIIIIIIIIlIlI(((Item)Inventory.getAll((int[])nArray7).get(lIIlIllIll[1])).getQuantity(), lIIlIllIll[2]) && N.lIIIIIIIIIlII(((Widget)llllllllllllllllllllllIlIllIlIII.get(llllllllllllllllllllllIlIllIIlll)).getText().contains(lIIlIllIlI[lIIlIllIll[58]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)llllllllllllllllllllllIlIllIlIII.get(llllllllllllllllllllllIlIllIIlll)).getClickPoint().getX(), (int)((Widget)llllllllllllllllllllllIlIllIlIII.get(llllllllllllllllllllllIlIllIIlll)).getClickPoint().getY(), (boolean)lIIlIllIll[2]);
                                                        Time.sleepTicks((int)lIIlIllIll[4]);
                                                        "".length();
                                                    }
                                                    int[] nArray8 = new int[lIIlIllIll[2]];
                                                    nArray8[N.lIIlIllIll[1]] = lIIlIllIll[51];
                                                    if (N.lIIIIIIIIlIlI(((Item)Inventory.getAll((int[])nArray8).get(lIIlIllIll[1])).getQuantity(), lIIlIllIll[14]) && N.lIIIIIIIIIlII(((Widget)llllllllllllllllllllllIlIllIlIII.get(llllllllllllllllllllllIlIllIIlll)).getText().contains(lIIlIllIlI[lIIlIllIll[59]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)llllllllllllllllllllllIlIllIlIII.get(llllllllllllllllllllllIlIllIIlll)).getClickPoint().getX(), (int)((Widget)llllllllllllllllllllllIlIllIlIII.get(llllllllllllllllllllllIlIllIIlll)).getClickPoint().getY(), (boolean)lIIlIllIll[2]);
                                                        Time.sleepTicks((int)lIIlIllIll[4]);
                                                        "".length();
                                                    }
                                                    if (N.lIIIIIIIIIlII(((Widget)llllllllllllllllllllllIlIllIlIII.get(llllllllllllllllllllllIlIllIIlll)).getText().contains(lIIlIllIlI[lIIlIllIll[60]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)llllllllllllllllllllllIlIllIlIII.get(llllllllllllllllllllllIlIllIIlll)).getClickPoint().getX(), (int)((Widget)llllllllllllllllllllllIlIllIlIII.get(llllllllllllllllllllllIlIllIIlll)).getClickPoint().getY(), (boolean)lIIlIllIll[2]);
                                                        Time.sleepTicks((int)lIIlIllIll[4]);
                                                        "".length();
                                                    }
                                                    ++llllllllllllllllllllllIlIllIIlll;
                                                    "".length();
            ...
            if (N.lIIIIIIIIlIll(Players.getLocal().getWorldLocation().distanceTo(iL), lIIlIllIll[21])) {
                ...
                llllllllllllllllllllllIlIllIlIlI = TileItems.getNearest((String[])stringArray);
                if (N.lIIIIIIIIIlll(llllllllllllllllllllllIlIllIlIlI)) {
                    llllllllllllllllllllllIlIllIlIlI.interact(lIIlIllIlI[lIIlIllIll[63]]);
                }
            }
        }
    }
    ...
    public int T() {
        ...
        if (" ".length() < " ".length()) {
            return (0x45 ^ 0x73 ^ (0x6D ^ 0x62)) & (0x22 ^ 1 ^ (0x3A ^ 0x20) ^ -" ".length());
        }
        return lIIlIllIll[74];
    }

    private static String llllllllIlIl(String llllllllllllllllllllllIlIlIIllIl, String llllllllllllllllllllllIlIlIIllII) {
        llllllllllllllllllllllIlIlIIllIl = new String(Base64.getDecoder().decode(llllllllllllllllllllllIlIlIIllIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllllllIlIlIlIIII = new StringBuilder();
        char[] llllllllllllllllllllllIlIlIIllll = llllllllllllllllllllllIlIlIIllII.toCharArray();
        int llllllllllllllllllllllIlIlIIlllI = lIIlIllIll[1];
        char[] llllllllllllllllllllllIlIlIIlIII = llllllllllllllllllllllIlIlIIllIl.toCharArray();
        int llllllllllllllllllllllIlIlIIIlll = llllllllllllllllllllllIlIlIIlIII.length;
        int llllllllllllllllllllllIlIlIIIllI = lIIlIllIll[1];
        while (N.lIIIIIIIIIlIl(llllllllllllllllllllllIlIlIIIllI, llllllllllllllllllllllIlIlIIIlll)) {
            char llllllllllllllllllllllIlIlIlIIll = llllllllllllllllllllllIlIlIIlIII[llllllllllllllllllllllIlIlIIIllI];
            llllllllllllllllllllllIlIlIlIIII.append((char)(llllllllllllllllllllllIlIlIlIIll ^ llllllllllllllllllllllIlIlIIllll[llllllllllllllllllllllIlIlIIlllI % llllllllllllllllllllllIlIlIIllll.length]));
            "".length();
            ++llllllllllllllllllllllIlIlIIlllI;
            ++llllllllllllllllllllllIlIlIIIllI;
            "".length();
            if ("   ".length() > 0) continue;
            return null;
        }
        return String.valueOf(llllllllllllllllllllllIlIlIlIIII);
    }
