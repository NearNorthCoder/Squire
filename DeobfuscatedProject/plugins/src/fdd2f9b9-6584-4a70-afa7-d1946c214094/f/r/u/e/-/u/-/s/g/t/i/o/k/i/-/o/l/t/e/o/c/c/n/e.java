...
public class e {
    ...
    public static int c(int n2, int n3) {
        ...
        if (e.lllIlIIIIlII(Math.abs(lIllllIIlIlI), lIIIlIIIll[0])) {
            ...
            if (e.lllIlIIIIlIl(S.nextBoolean() ? 1 : 0)) {
                ...
                "".length();
                if ("  ".length() <= " ".length()) {
                    return (0xEC ^ 0x88 ^ (0xE4 ^ 0xBF)) & (0xF6 ^ 0xAB ^ (0x6D ^ 0xF) ^ -" ".length());
                }
            } else {
                n5 = lIllllIIlIll;
            }
        ...
        World world2 = Worlds.getRandom(world -> {
            ...
            if (e.lllIlIIIIlIl(world.isMembers() ? 1 : 0) && e.lllIlIIIlIII(world.getPlayerCount(), lIIIlIIIll[75]) && e.lllIlIIIlIll(world.getId(), Worlds.getCurrentId()) && e.lllIlIIIIIll(world.getActivity().endsWith(lIIIlIIIlI[lIIIlIIIll[76]]) ? 1 : 0) && e.lllIlIIIIIll(world.getActivity().endsWith(lIIIlIIIlI[lIIIlIIIll[77]]) ? 1 : 0) && e.lllIlIIIIIll(world.getActivity().startsWith(lIIIlIIIlI[lIIIlIIIll[78]]) ? 1 : 0) && e.lllIlIIIIIll(world.getActivity().startsWith(lIIIlIIIlI[lIIIlIIIll[71]]) ? 1 : 0) && e.lllIlIIIlIll(world.getId(), lIIIlIIIll[79]) && e.lllIlIIIlIll(world.getId(), lIIIlIIIll[80]) && e.lllIlIIIlIll(world.getId(), lIIIlIIIll[80]) && e.lllIlIIIIIll(world.getActivity().contains(lIIIlIIIlI[lIIIlIIIll[81]]) ? 1 : 0) && e.lllIlIIIIIll(world.getActivity().contains(lIIIlIIIlI[lIIIlIIIll[82]]) ? 1 : 0) && e.lllIlIIIIIll(world.getActivity().contains(lIIIlIIIlI[lIIIlIIIll[83]]) ? 1 : 0) && e.lllIlIIIIIll(world.getActivity().startsWith(lIIIlIIIlI[lIIIlIIIll[84]]) ? 1 : 0) && e.lllIlIIIIIll(world.getActivity().endsWith(lIIIlIIIlI[lIIIlIIIll[85]]) ? 1 : 0) && e.lllIlIIIIIll(world.getActivity().endsWith(lIIIlIIIlI[lIIIlIIIll[86]]) ? 1 : 0) && e.lllIlIIIIIll(world.getActivity().endsWith(lIIIlIIIlI[lIIIlIIIll[87]]) ? 1 : 0) && e.lllIlIIIIIll(world.getActivity().startsWith(lIIIlIIIlI[lIIIlIIIll[88]]) ? 1 : 0) && e.lllIlIIIIlll(world.getPlayerCount(), lIIIlIIIll[89])) {
                ...
                if ((0x67 ^ 4 ^ (0x4E ^ 0x29)) == 0) {
                    return ((0x22 ^ 0x2C ^ (0xAD ^ 0x8A)) & (5 ^ 0x10 ^ (0xB2 ^ 0x8E) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIIlIIIll[2];
            }
    ...
    public static boolean F() {
        ...
        if (!e.lllIlIIIIIll(T.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !e.lllIlIIIIIll(U.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !e.lllIlIIIIlll(Players.getLocal().getWorldLocation().distanceTo(aa), lIIIlIIIll[71]) || e.lllIlIIIIlIl(ab.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            bl = lIIIlIIIll[0];
            "".length();
            if ("  ".length() < ((0x31 ^ 0x77 ^ (0xD6 ^ 0x98)) & (0x2D ^ 0x4D ^ (0xEC ^ 0x84) ^ -" ".length()))) {
                return ((0x6A ^ 0 ^ (0x9D ^ 0xAE)) & (0x16 ^ 1 ^ (0xF5 ^ 0xBB) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIlIIIll[2];
        }
    ...
    private static void lllIlIIIIIlI() {
        ...
        e.lIIIlIIIll[0] = " ".length();
        e.lIIIlIIIll[1] = "   ".length();
        e.lIIIlIIIll[2] = " ".length() & ~" ".length();
        e.lIIIlIIIll[3] = "  ".length();
    ...
    public static boolean b(int[] nArray) {
        ...
        while (e.lllIlIIIlIlI(lIllllIIIIII, lIllllIIIIIl.length)) {
            ...
            return ((0x61 ^ 1 ^ (0x7A ^ 0x21)) & (0x7A ^ 0x63 ^ (0xE7 ^ 0xC5) ^ -" ".length())) != 0;
        }
        return lIIIlIIIll[0];
    }
    ...
    public static void E() {
        block9: {
            ...
            do {
                            ...
                            List lIllIllIlIlI = lIllIllIlIll.stream().filter(widget -> {
                                ...
                                if (e.lllIlIIIIIll(widget.getText().contains(lIIIlIIIlI[lIIIlIIIll[74]]) ? 1 : 0)) {
                                    ...
                                    if (-(0xAB ^ 0xA4 ^ (0x70 ^ 0x7B)) >= 0) {
                                        return ((0x8B ^ 0xBE ^ (0xB ^ 0x67)) & (0x7F ^ 0x65 ^ (0x63 ^ 0x20) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIlIIIll[2];
                                }
                ...
                "".length();
                "".length();
            } while ("   ".length() >= ((0x67 ^ 0x72 ^ (0x53 ^ 0x1A)) & (0x31 ^ 9 ^ (0xA0 ^ 0xC4) ^ -" ".length())));
            return;
        }
    }
    ...
    public static void a(HashMap<Integer, Integer> hashMap, boolean bl, boolean bl2) {
        if (e.lllIlIIIIlll(Players.getLocal().getWorldLocation().distanceTo(Y), lIIIlIIIll[4])) {
            ...
            if (e.lllIlIIIIIll(worldArea.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                n2 = lIIIlIIIll[0];
                "".length();
                if (" ".length() <= ((36 + 115 - 26 + 10 ^ 39 + 74 - 108 + 141) & (0xC9 ^ 0x91 ^ (0x3E ^ 0x73) ^ -" ".length()))) {
                    return;
                }
            } else {
                n2 = lIIIlIIIll[2];
    ...
    public static void c(WorldPoint worldPoint) {
        ...
        if (e.lllIlIIIlIIl(lIllIllllIII)) {
            ...
            "".length();
            if (((0x93 ^ 0xBD ^ (0x11 ^ 0x18)) & (67 + 121 - 116 + 60 ^ 47 + 98 - 108 + 126 ^ -" ".length())) == -" ".length()) {
                return;
            }
        } else {
            int lIllIlllIlll;
    ...
    private static String lllIIlllIlII(String lIllIIlllIlI, String lIllIIlllIIl) {
        ...
        while (e.lllIlIIIlIlI(lIllIIllIIll, lIllIIllIlII)) {
            ...
            ++lIllIIllIIll;
            "".length();
            if (((18 + 46 - -124 + 48 ^ 182 + 13 - 130 + 127) & (66 + 17 - -12 + 60 ^ 145 + 135 - 109 + 12 ^ -" ".length())) == 0) continue;
            return null;
        }
    ...
    public static boolean z() {
        ...
        if (e.lllIlIIIlIIl(Widgets.get((int)lIIIlIIIll[25], (int)lIIIlIIIll[0]))) {
            ...
            "".length();
            if (null != null) {
                return ((0x31 ^ 0x75 ^ (0x5B ^ 0x48)) & (5 ^ 0x22 ^ (0x37 ^ 0x47) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIlIIIll[2];
        }
    ...
    private static void lllIIlllIlll() {
        ...
        e.lIIIlIIIlI[e.lIIIlIIIll[2]] = e.lllIIlllIlII("OhAASAEbUQANGgc=", "tqvhu");
        e.lIIIlIIIlI[e.lIIIlIIIll[0]] = e.lllIIlllIlII("DAUKHi0hRBIfLjdEBxIgMA==", "DddzA");
        e.lIIIlIIIlI[e.lIIIlIIIll[3]] = e.lllIIlllIlIl("2+cqcRcbr6oag/J0fNd+7y5M9vL5ARB2", "kynDu");
        e.lIIIlIIIlI[e.lIIIlIIIll[1]] = e.lllIIlllIlII("PisTF3A+LRIAMRwtDQolHQ==", "nDacP");
        e.lIIIlIIIlI[e.lIIIlIIIll[4]] = e.lllIIlllIlIl("6W7dRNspVNAe1H0gWugeljOZ8e0q2Ix0", "kCBKf");
        e.lIIIlIIIlI[e.lIIIlIIIll[5]] = e.lllIIlllIllI("FIP2+hjv/Y8=", "sJTIm");
        e.lIIIlIIIlI[e.lIIIlIIIll[6]] = e.lllIIlllIlII("AAcJJwxjJAQ3QgsDGSwHMRI=", "CfkNb");
        e.lIIIlIIIlI[e.lIIIlIIIll[7]] = e.lllIIlllIllI("FAEneAKSPNnLBGdD5VNoFdkBFIULtvt3", "AoXTZ");
        e.lIIIlIIIlI[e.lIIIlIIIll[8]] = e.lllIIlllIlIl("xZ801ziMc2TRh8EBJOySlgAmxxM2kZFi", "bIWaR");
        e.lIIIlIIIlI[e.lIIIlIIIll[9]] = e.lllIIlllIlIl("pGzuYUAaJUYrHqVt4npQfqeqjYQbu2NM", "XCojH");
        e.lIIIlIIIlI[e.lIIIlIIIll[10]] = e.lllIIlllIllI("S4dxQY6mHBejyq5o1k/GBVZmNe+7AQLL", "AHkTa");
        e.lIIIlIIIlI[e.lIIIlIIIll[11]] = e.lllIIlllIlIl("zy/Da64qytY=", "cZXRC");
        e.lIIIlIIIlI[e.lIIIlIIIll[12]] = e.lllIIlllIlII("Fk4sLSQwBgMkGTwXGyQWJQQ0GSM0KCIXNjgdHh8LewACETU6ACw/ODEHPQ07MCgdDTswWgQAIw==", "UtpxW");
        e.lIIIlIIIlI[e.lIIIlIIIll[13]] = e.lllIIlllIlII("ADMtNXQfPzMxKA0uLCI=", "lZCPZ");
        e.lIIIlIIIlI[e.lIIIlIIIll[16]] = e.lllIIlllIllI("pTGmb5NbMdo=", "diAVs");
        e.lIIIlIIIlI[e.lIIIlIIIll[17]] = e.lllIIlllIlII("GSw+QTE4bR4ANyUiKwplAG0qACs8", "WMHaE");
        e.lIIIlIIIlI[e.lIIIlIIIll[23]] = e.lllIIlllIllI("x8kogwjlAts=", "JTawJ");
        e.lIIIlIIIlI[e.lIIIlIIIll[24]] = e.lllIIlllIlII("GgUHER47Cg5VEDMKAhwcNQ==", "Rdiur");
        e.lIIIlIIIlI[e.lIIIlIIIll[27]] = e.lllIIlllIllI("KUmRBUUPsH0lSWtSrQgHmQ==", "KYvyL");
        e.lIIIlIIIlI[e.lIIIlIIIll[29]] = e.lllIIlllIlIl("y6K4hIgI10E=", "LEiyU");
        e.lIIIlIIIlI[e.lIIIlIIIll[30]] = e.lllIIlllIllI("i+GfbGmMjsY=", "xketq");
        e.lIIIlIIIlI[e.lIIIlIIIll[33]] = e.lllIIlllIllI("3uhIwQautfM=", "cJKRf");
        e.lIIIlIIIlI[e.lIIIlIIIll[36]] = e.lllIIlllIllI("2vdOrqPw9bmkkiZOKcbHIw==", "SGopE");
        e.lIIIlIIIlI[e.lIIIlIIIll[26]] = e.lllIIlllIllI("/TZ5vIlieXo=", "rtEJz");
        e.lIIIlIIIlI[e.lIIIlIIIll[37]] = e.lllIIlllIlIl("wiB2es6m81o=", "RnNYJ");
        e.lIIIlIIIlI[e.lIIIlIIIll[38]] = e.lllIIlllIllI("GeBkXvGmvWs=", "yzbuU");
        e.lIIIlIIIlI[e.lIIIlIIIll[39]] = e.lllIIlllIlIl("nXvGTKKMYHI=", "GsDRK");
        e.lIIIlIIIlI[e.lIIIlIIIll[40]] = e.lllIIlllIllI("cQuCQi+MbiQ=", "iAZHP");
        e.lIIIlIIIlI[e.lIIIlIIIll[41]] = e.lllIIlllIlII("Cig9PSo=", "OYHTZ");
        e.lIIIlIIIlI[e.lIIIlIIIll[15]] = e.lllIIlllIlIl("vJw6uoLYdKuUSV2yG90wMb8UXAAdEI6L", "XLaPF");
        e.lIIIlIIIlI[e.lIIIlIIIll[54]] = e.lllIIlllIlII("IwYhYxUCRzg2FR4OMyZBCgYjJg==", "mgWCa");
        e.lIIIlIIIlI[e.lIIIlIIIll[55]] = e.lllIIlllIlIl("pFSzUA62frI=", "WSlhS");
        e.lIIIlIIIlI[e.lIIIlIIIll[35]] = e.lllIIlllIllI("4sEymPLn6Lc=", "vqZke");
        e.lIIIlIIIlI[e.lIIIlIIIll[56]] = e.lllIIlllIlII("PTg7EzxCdwBGKE42aQMsGncrFDYXeQ==", "nWIaE");
        e.lIIIlIIIlI[e.lIIIlIIIll[57]] = e.lllIIlllIlII("LQcVWCUMRhAMIwwIBBA+DwJDDDgPAw==", "cfcxQ");
        e.lIIIlIIIlI[e.lIIIlIIIll[47]] = e.lllIIlllIlII("IgckAw==", "rHwWv");
        e.lIIIlIIIlI[e.lIIIlIIIll[60]] = e.lllIIlllIlII("GyoCNQc2MUEVGygg", "XElAb");
        e.lIIIlIIIlI[e.lIIIlIIIll[61]] = e.lllIIlllIlIl("Kb4SRVx8Q3xQCsm1RP35e+MJwH5J3ag5", "OBiCK");
        e.lIIIlIIIlI[e.lIIIlIIIll[65]] = e.lllIIlllIlII("JC0GKEoXPQYmBgw5BiI=", "eXrGj");
        e.lIIIlIIIlI[e.lIIIlIIIll[66]] = e.lllIIlllIllI("fv7CMhB6JtzizCRE+/Gvbw==", "XQrsE");
        e.lIIIlIIIlI[e.lIIIlIIIll[21]] = e.lllIIlllIllI("TSZsBzHO+0CjVsCJzZVCrg==", "ZRJAz");
        e.lIIIlIIIlI[e.lIIIlIIIll[32]] = e.lllIIlllIlIl("3xUdTh14buv83833Kd6DPQ==", "uxhzn");
        e.lIIIlIIIlI[e.lIIIlIIIll[67]] = e.lllIIlllIlII("Li8nHi4=", "jJFjF");
        e.lIIIlIIIlI[e.lIIIlIIIll[68]] = e.lllIIlllIlIl("sCtKIoaoHFs=", "BCpdE");
        e.lIIIlIIIlI[e.lIIIlIIIll[69]] = e.lllIIlllIlIl("0iw7CrsPkBY=", "ClhEb");
        e.lIIIlIIIlI[e.lIIIlIIIll[70]] = e.lllIIlllIlIl("M9TMrm5mLTU=", "ufBTD");
        e.lIIIlIIIlI[e.lIIIlIIIll[74]] = e.lllIIlllIlIl("XwrUp8TZ4r4=", "XFVYV");
        e.lIIIlIIIlI[e.lIIIlIIIll[76]] = e.lllIIlllIlII("MisxNgE=", "FDEWm");
        e.lIIIlIIIlI[e.lIIIlIIIll[77]] = e.lllIIlllIllI("nPwcnfaXVqI=", "sBAgF");
        e.lIIIlIIIlI[e.lIIIlIIIll[78]] = e.lllIIlllIlIl("mwz1uQ5wjhU=", "RSIfM");
        e.lIIIlIIIlI[e.lIIIlIIIll[71]] = e.lllIIlllIlII("HAoIMA==", "TcoXm");
        e.lIIIlIIIlI[e.lIIIlIIIll[81]] = e.lllIIlllIllI("Zr17o7k7m5U=", "qfjbq");
        e.lIIIlIIIlI[e.lIIIlIIIll[82]] = e.lllIIlllIlIl("pI0RhauzqFA=", "JaQkB");
        e.lIIIlIIIlI[e.lIIIlIIIll[83]] = e.lllIIlllIlIl("AdAKKvStKX4=", "FSOgn");
        e.lIIIlIIIlI[e.lIIIlIIIll[84]] = e.lllIIlllIlII("HTYLChQ4PQ==", "YSjny");
        e.lIIIlIIIlI[e.lIIIlIIIll[85]] = e.lllIIlllIlIl("hUOt5xRSJ2k=", "QQnxE");
        e.lIIIlIIIlI[e.lIIIlIIIll[86]] = e.lllIIlllIlII("MTg1CzIQPT4APwwv", "bHPnV");
        e.lIIIlIIIlI[e.lIIIlIIIll[87]] = e.lllIIlllIlII("BiUQFD8=", "rJduS");
        e.lIIIlIIIlI[e.lIIIlIIIll[88]] = e.lllIIlllIlIl("y49LWC8kJ4A=", "lSYlI");
        e.lIIIlIIIlI[e.lIIIlIIIll[90]] = e.lllIIlllIlII("Fh8QP1IWGREoEzQZDiIHNQ==", "FpbKr");
        e.lIIIlIIIlI[e.lIIIlIIIll[91]] = e.lllIIlllIlIl("0xN2fUtum4OCjXxGQCb6SuRUxz9KSaj36mPOv7oLbnrNsXKF147J0Zvs0OoSt59smRseno0B4hg=", "WJCAM");
    }
