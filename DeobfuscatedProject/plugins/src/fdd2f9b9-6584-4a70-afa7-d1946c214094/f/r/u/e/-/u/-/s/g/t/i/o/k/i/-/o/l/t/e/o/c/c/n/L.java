...
implements G {
    ...
    private static String llllIIIIIIII(String llIllllllII, String llIllllIllI) {
        ...
        while (L.llllIIIlIIIl(llIllllIIII, llIllllIIIl)) {
            ...
            ++llIllllIIII;
            "".length();
            if (((0x7C ^ 0x34 ^ (0x78 ^ 0xC)) & (0xA4 ^ 0x8B ^ (0xBC ^ 0xAF) ^ -" ".length())) >= ("  ".length() & ("  ".length() ^ -" ".length()))) continue;
            return null;
        }
    ...
    private static void llllIIIIllll() {
        ...
        L.lIIIlllIIl[0] = (0x33 ^ 0x40 ^ (0xE4 ^ 0xC1)) & (8 + 48 - 37 + 131 ^ 96 + 71 - 86 + 111 ^ -" ".length());
        L.lIIIlllIIl[1] = " ".length();
        L.lIIIlllIIl[2] = 0x5D ^ 0xB ^ (0xE ^ 0x6A);
        L.lIIIlllIIl[3] = "  ".length();
        L.lIIIlllIIl[4] = "   ".length();
                        ...
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    block24: {
                                        block19: {
                                            ...
                                            block20: {
                                                ...
                                                return ((2 + 217 - 136 + 138 ^ 98 + 59 - 135 + 109) & (0xF1 ^ 0xB5 ^ (0x46 ^ 0x5C) ^ -" ".length())) != 0;
                                            }
                                            n5 = lIIIlllIIl[0];
                                            return n5 != 0;
                                        }
                                    ...
                                    return ((0x65 ^ 0x47 ^ (0x45 ^ 0x50)) & (124 + 45 - 79 + 54 ^ 133 + 109 - 216 + 141 ^ -" ".length())) != 0;
                                }
                                n4 = lIIIlllIIl[0];
                                return n4 != 0;
                            }
                    ...
                    if (L.llllIIIlIlIl(Bank.getFirst((int[])nArray17).getQuantity(), lIIIlllIIl[19])) {
                        ...
                        if (L.llllIIIlIIII(Bank.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (L.llllIIIlIIII(Bank.contains((int[])nArray19) ? 1 : 0)) {
                                ...
                                return ((0x2E ^ 0x3E ^ (0x49 ^ 0x47)) & (0x7C ^ 0x5D ^ (0xAA ^ 0x95) ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
    ...
    private static void llllIIIIlllI() {
        ...
        L.lIIIllIlll[L.lIIIlllIIl[0]] = L.lllIllllllll("blPQTiVMZnJIriTVrWSuLQ==", "tVLrx");
        L.lIIIllIlll[L.lIIIlllIIl[1]] = L.llllIIIIIIII("DxA+PiUhHDR3NDwAOTkxaRAkMjs6VXAkISANMz8/Jx5wNTcqEnAjOWkUMTA/KlkkJTcgFzk5MQ==", "IyPWV");
        L.lIIIllIlll[L.lIIIlllIIl[3]] = L.lllIllllllll("zUQq6p0689p5m3BvrVkKhEZvATDVKRL/", "dOxcr");
        L.lIIIllIlll[L.lIIIlllIIl[4]] = L.llllIIIIllIl("T8aO/Wdf6hUZgUqxIn/qu5SAF/3usbji", "VLCOa");
        L.lIIIllIlll[L.lIIIlllIIl[7]] = L.llllIIIIIIII("BzxnJCg1eSosKSMwKSJ6Iyw3NTY5PDRpeiMuLjE5ODApInokNmcHDwkQCQI=", "PYGEZ");
        L.lIIIllIlll[L.lIIIlllIIl[19]] = L.lllIllllllll("EKH9d1W9QbEpbQnDx3lG+A==", "FHLoD");
        L.lIIIllIlll[L.lIIIlllIIl[6]] = L.lllIllllllll("kuLJ28GtyaArYIB0pNa+rg==", "KhMPW");
        L.lIIIllIlll[L.lIIIlllIIl[27]] = L.llllIIIIIIII("GjgKFQI3PlkXCisrFgIAeS0cDQ4=", "YYyak");
        L.lIIIllIlll[L.lIIIlllIIl[30]] = L.llllIIIIllIl("0yy2+jrDNjHfncGBdtK3vo5diBDpTtUN", "iaKJJ");
        L.lIIIllIlll[L.lIIIlllIIl[32]] = L.llllIIIIllIl("FI0wJGPwbsQOjnSTryQki1awSCEHPly0", "pTlOp");
        L.lIIIllIlll[L.lIIIlllIIl[33]] = L.lllIllllllll("FN9BiUdfOyPmY9yweToyxCOZ8iN8rQ75", "BYRzT");
        L.lIIIllIlll[L.lIIIlllIIl[34]] = L.llllIIIIIIII("Fi8LDR45JA==", "WChew");
        L.lIIIllIlll[L.lIIIlllIIl[37]] = L.lllIllllllll("6sQlGOgbaQc=", "qsasP");
        L.lIIIllIlll[L.lIIIlllIIl[39]] = L.llllIIIIIIII("BTsmP208O3A7ISs8cCk9JyA=", "HTPZM");
        L.lIIIllIlll[L.lIIIlllIIl[41]] = L.lllIllllllll("hD2QjWxJHLr+1GoUaKjdKg==", "VSwlv");
        L.lIIIllIlll[L.lIIIlllIIl[42]] = L.lllIllllllll("R3Y3BNel0CcrsZ6Tnvafow==", "VXrmH");
        L.lIIIllIlll[L.lIIIlllIIl[43]] = L.lllIllllllll("e6V0RVKKAIg=", "zisgp");
        L.lIIIllIlll[L.lIIIlllIIl[44]] = L.llllIIIIIIII("GjU1", "YZBup");
        L.lIIIllIlll[L.lIIIlllIIl[45]] = L.llllIIIIllIl("wPFr/9/xEEM=", "mOdbh");
        L.lIIIllIlll[L.lIIIlllIIl[47]] = L.llllIIIIIIII("EhYhKzM4", "SbUJP");
        L.lIIIllIlll[L.lIIIlllIIl[51]] = L.llllIIIIIIII("Igg9BA4DH3gLEhkXOwsUGQ==", "mxXjg");
        L.lIIIllIlll[L.lIIIlllIIl[52]] = L.lllIllllllll("ml8eWm+tJhNfVguS7HQqqA==", "zbVoF");
        L.lIIIllIlll[L.lIIIlllIIl[54]] = L.llllIIIIllIl("alnrmaWI0sKCie3S9Now8A==", "gifkD");
        L.lIIIllIlll[L.lIIIlllIIl[55]] = L.llllIIIIIIII("AicwHxZ1FTAIDT4j", "UFDzd");
        L.lIIIllIlll[L.lIIIlllIIl[56]] = L.llllIIIIllIl("BotYtiMo1VMEPaRpajAAaw==", "zBfMw");
        L.lIIIllIlll[L.lIIIlllIIl[21]] = L.llllIIIIllIl("z7dTHH5c4y8yusNshGruig==", "udOsH");
        L.lIIIllIlll[L.lIIIlllIIl[50]] = L.lllIllllllll("TsIsPdIo6sAyMQzL6gZ0Ew==", "yQFCf");
        L.lIIIllIlll[L.lIIIlllIIl[73]] = L.llllIIIIIIII("PSICOhFQNxcyGx4qCzQ=", "pCeSr");
        L.lIIIllIlll[L.lIIIlllIIl[74]] = L.llllIIIIllIl("Ste3bEI/mH9++QLkrNf1vEhRYyigIXEh", "TMLxa");
        L.lIIIllIlll[L.lIIIlllIIl[75]] = L.lllIllllllll("aav4WE0k0O4=", "MeYwf");
    }
        ...
        if (L.llllIIIlIlll(Players.getLocal().getInteracting())) {
            ...
            List lllIIIlIlIl = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                ...
                if (L.llllIIIllIlI(nPC.getInteracting(), Players.getLocal())) {
                    bl = lIIIlllIIl[1];
                    "".length();
                    if ("   ".length() <= ((0x6C ^ 0x57) & ~(0xA3 ^ 0x98))) {
                        return ((0x3B ^ 0x5B) & ~(0x21 ^ 0x41)) != 0;
                    }
                } else {
                    bl = lIIIlllIIl[0];
                }
                    ...
                    block27: {
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    ...
                                    "".length();
                                    if (null == null) return n4 != 0;
                                    return ((82 + 100 - 58 + 36 ^ 108 + 37 - 87 + 111) & (0x49 ^ 0x78 ^ (0xBB ^ 0x83) ^ -" ".length())) != 0;
                                }
                                n4 = lIIIlllIIl[0];
                                return n4 != 0;
                            }
                        ...
                        if (L.llllIIIlIIII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (L.llllIIIlIIII(Inventory.contains((int[])nArray14) ? 1 : 0)) {
                                ...
                                return ((0x94 ^ 0xB7 ^ (0x37 ^ 0x20)) & (43 + 92 - 101 + 97 ^ 175 + 122 - 189 + 75 ^ -" ".length())) != 0;
                            }
                        }
                    }
                    n3 = lIIIlllIIl[0];
                                ...
                                if (L.llllIIIlIIIl(Inventory.getCount((int[])nArray4), lIIIlllIIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (L.llllIIIlIlII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (-" ".length() > 0) {
                                                return ((0xC0 ^ 0xB1 ^ (0xF1 ^ 0x87)) & (136 + 186 - 190 + 63 ^ 72 + 134 - 17 + 7 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIIlllIIl[0];
                                        }
                                ...
                                if (L.llllIIIlIIIl(Inventory.getCount((int[])nArray6), lIIIlllIIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (L.llllIIIlIlII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (" ".length() < 0) {
                                                return ((0xBF ^ 0x90 ^ (0x75 ^ 0x6A)) & (73 + 66 - 28 + 46 ^ 9 + 50 - 5 + 119 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIIlllIIl[0];
                                        }
                                ...
                                if (L.llllIIIlIIIl(Inventory.getCount((int[])nArray10), lIIIlllIIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (L.llllIIIlIlII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if ("  ".length() >= "   ".length()) {
                                                return ((0x32 ^ 0x7F ^ (0x31 ^ 0x3A)) & (0xF7 ^ 0x96 ^ (0xE7 ^ 0xC0) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIIlllIIl[0];
                                        }
                                ...
                                if (L.llllIIIlIIIl(Inventory.getCount((int[])nArray14), lIIIlllIIl[1]) && L.llllIIIlIIIl(Skills.getLevel((Skill)Skill.MAGIC), lIIIlllIIl[21])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (L.llllIIIlIlII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (null != null) {
                                                return ((0x3E ^ 0x10 ^ "  ".length()) & (0x1A ^ 0x1C ^ (0x35 ^ 0x1F) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIIIlllIIl[0];
                                        }
                        ...
                        if (L.llllIIIlIIll(lllIIIllIll) && L.llllIIIlIIll(lllIIIllIlI) && L.llllIIIlIllI(Players.getLocal().getAnimation(), lIIIlllIIl[28])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (L.llllIIIllIll(Skills.getExperience((Skill)Skill.MAGIC), lllIIIllIIl)) {
                                    ...
                                    "".length();
                                    if ("   ".length() < 0) {
                                        return ((0xD ^ 0x41 ^ (0x3E ^ 0x30)) & (0xE8 ^ 0x90 ^ (0x75 ^ 0x4F) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIlllIIl[0];
                                }
