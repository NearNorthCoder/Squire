...
implements G {
    ...
    private static void lIIIIIlIlllll() {
        ...
        S.lIIllIlllI[1] = (0xCB ^ 0xB8 ^ (0xA8 ^ 0x81)) & (37 + 82 - 29 + 117 ^ 23 + 91 - 10 + 45 ^ -" ".length());
        S.lIIllIlllI[2] = " ".length();
        S.lIIllIlllI[3] = "  ".length();
        S.lIIllIlllI[4] = "   ".length();
        ...
        S.lIIllIlllI[29] = -"   ".length() & (0xFFFF8EFF & 0x7FF7);
        ...
        S.lIIllIlllI[81] = -"   ".length() & (0xFFFF8FEB & 0x7EFF);
    ...
    public int T() {
        ...
        if ("   ".length() < ((0x71 ^ 0xD ^ (0x4C ^ 0x26)) & (0x5B ^ 0x47 ^ (0xA9 ^ 0xA3) ^ -" ".length()))) {
            return (133 + 106 - 73 + 45 ^ 45 + 17 - 53 + 129) & (0xC7 ^ 0xAC ^ (0x93 ^ 0xA1) ^ -" ".length());
        }
    ...
    private static String lIIIIIlIlllII(String lllllllllllllllllllllIllIIIIlllI, String lllllllllllllllllllllIllIIIIllIl) {
        lllllllllllllllllllllIllIIIIlllI = new String(Base64.getDecoder().decode(lllllllllllllllllllllIllIIIIlllI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllllllIllIIIIllII = new StringBuilder();
        ...
        char[] lllllllllllllllllllllIllIIIIIlII = lllllllllllllllllllllIllIIIIlllI.toCharArray();
        int lllllllllllllllllllllIllIIIIIIll = lllllllllllllllllllllIllIIIIIlII.length;
        int lllllllllllllllllllllIllIIIIIIlI = lIIllIlllI[1];
        while (S.lIIIIIllIIIIl(lllllllllllllllllllllIllIIIIIIlI, lllllllllllllllllllllIllIIIIIIll)) {
            char lllllllllllllllllllllIllIIIIllll = lllllllllllllllllllllIllIIIIIlII[lllllllllllllllllllllIllIIIIIIlI];
            lllllllllllllllllllllIllIIIIllII.append((char)(lllllllllllllllllllllIllIIIIllll ^ lllllllllllllllllllllIllIIIIlIll[lllllllllllllllllllllIllIIIIlIlI % lllllllllllllllllllllIllIIIIlIll.length]));
            "".length();
            ++lllllllllllllllllllllIllIIIIlIlI;
            ++lllllllllllllllllllllIllIIIIIIlI;
            "".length();
            if ("   ".length() >= " ".length()) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllllllIllIIIIllII);
    }
    ...
    private static String lIIIIIlIllIll(String lllllllllllllllllllllIlIlllllIIl, String lllllllllllllllllllllIlIlllllIII) {
        try {
            ...
            Cipher lllllllllllllllllllllIlIlllllIll = Cipher.getInstance("DES");
            lllllllllllllllllllllIlIlllllIll.init(lIIllIlllI[3], lllllllllllllllllllllIlIllllllII);
            return new String(lllllllllllllllllllllIlIlllllIll.doFinal(Base64.getDecoder().decode(lllllllllllllllllllllIlIlllllIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIIIIIlIllIlI(String lllllllllllllllllllllIlIlllIlIlI, String lllllllllllllllllllllIlIlllIlIIl) {
        try {
            SecretKeySpec lllllllllllllllllllllIlIlllIllll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllllIlIlllIlIIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            return new String(lllllllllllllllllllllIlIlllIlllI.doFinal(Base64.getDecoder().decode(lllllllllllllllllllllIlIlllIlIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void af() {
        d lllllllllllllllllllllIllIIIlllll;
        Object lllllllllllllllllllllIllIIlIIIII;
        ...
        if (S.lIIIIIllIIIlI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lllllllllllllllllllllIllIIlIIIII = new d(lIIllIlllI[0], S.cC(), lIIllIlllI[63]);
            bv.add((d)lllllllllllllllllllllIllIIlIIIII);
            "".length();
        }
        int[] nArray3 = new int[lIIllIlllI[2]];
        nArray3[S.lIIllIlllI[1]] = lIIllIlllI[7];
        if (S.lIIIIIllIIIlI(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllllllllIllIIlIIIII = new d(lIIllIlllI[7], lIIllIlllI[3], lIIllIlllI[5]);
            bv.add((d)lllllllllllllllllllllIllIIlIIIII);
            "".length();
        }
        if (S.lIIIIIllIIIlI(Bank.contains((Predicate)(lllllllllllllllllllllIllIIlIIIII = item -> item.getName().toLowerCase().contains(lIIllIllIl[lIIllIlllI[77]]))) ? 1 : 0)) {
            lllllllllllllllllllllIllIIIlllll = new d(lIIllIlllI[64], lIIllIlllI[13], lIIllIlllI[65]);
            bv.add(lllllllllllllllllllllIllIIIlllll);
            "".length();
        }
        int[] nArray4 = new int[lIIllIlllI[2]];
        nArray4[S.lIIllIlllI[1]] = lIIllIlllI[66];
        if (S.lIIIIIllIIIlI(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllllllllIllIIIlllll = new d(lIIllIlllI[66], lIIllIlllI[67], lIIllIlllI[68]);
            bv.add(lllllllllllllllllllllIllIIIlllll);
            "".length();
        }
    }
    ...
    private static void lIIIIIlIlllIl() {
        ...
        S.lIIllIllIl[S.lIIllIlllI[1]] = S.lIIIIIlIllIlI("ui47BHm4pUfBThd2bAWfgA==", "WaBko");
        S.lIIllIllIl[S.lIIllIlllI[2]] = S.lIIIIIlIllIll("O7YBf8RqwfcZdLmqll7hGf8QqlGuYV3gXMyaZSg878xRhmGj4tDksJVCjbY/N/wB", "TmNew");
        S.lIIllIllIl[S.lIIllIlllI[3]] = S.lIIIIIlIlllII("JTEkKhEKJDstEUskPWMUCj45", "kPRCv");
        S.lIIllIllIl[S.lIIllIlllI[4]] = S.lIIIIIlIllIlI("mZiX3axDNxKqIIxrTK56h3WTl6sBbx9Z", "Bjuzb");
        S.lIIllIllIl[S.lIIllIlllI[6]] = S.lIIIIIlIllIll("KpHyyvB0llbbzXu5Ez+oDOJMjzl84xs3c5yeizkRvJ59l06Fhj4ahj4TtK0z3XkurWAEDJWsuTI=", "iHFgD");
        S.lIIllIllIl[S.lIIllIlllI[13]] = S.lIIIIIlIlllII("MhsBJhM=", "vihHx");
        S.lIIllIllIl[S.lIIllIlllI[15]] = S.lIIIIIlIlllII("BS8pFlElJWUEGD0uPA==", "QJEsq");
        S.lIIllIllIl[S.lIIllIlllI[17]] = S.lIIIIIlIllIll("lITQFGyigf8=", "lTFPP");
        S.lIIllIllIl[S.lIIllIlllI[18]] = S.lIIIIIlIlllII("GBgUDkcZGBgK", "Tybog");
        S.lIIllIllIl[S.lIIllIlllI[19]] = S.lIIIIIlIllIll("kv9Zh3SnQ27fFSwwxhMF8Ea+tBD9hPZ9hY7PELjRlQK0dKGaIeTRVg==", "DWGRw");
        S.lIIllIllIl[S.lIIllIlllI[21]] = S.lIIIIIlIlllII("NzQXSA4WdQAEDhgn", "yUahz");
        S.lIIllIllIl[S.lIIllIlllI[41]] = S.lIIIIIlIlllII("eVUNJisjVQk9KTE=", "HuyOH");
        S.lIIllIllIl[S.lIIllIlllI[44]] = S.lIIIIIlIlllII("KSssIhFKIiE5Axg=", "jCMMb");
        S.lIIllIllIl[S.lIIllIlllI[20]] = S.lIIIIIlIllIll("Kc5LyKaVQMnglDUEWsfCww==", "uxLdI");
        S.lIIllIllIl[S.lIIllIlllI[46]] = S.lIIIIIlIllIlI("oAqcjHKIVbM=", "JpJml");
        S.lIIllIllIl[S.lIIllIlllI[47]] = S.lIIIIIlIllIlI("0UDgUvmcrC0=", "WRazU");
        S.lIIllIllIl[S.lIIllIlllI[48]] = S.lIIIIIlIllIlI("rmXUSDA4RJI=", "rgFDk");
        S.lIIllIllIl[S.lIIllIlllI[49]] = S.lIIIIIlIllIlI("X/UR9vPTui+TpZP1Zedvwg==", "etluw");
        S.lIIllIllIl[S.lIIllIlllI[51]] = S.lIIIIIlIllIll("uupjjON+k73USp5B1CJTYQ==", "fzWbb");
        S.lIIllIllIl[S.lIIllIlllI[52]] = S.lIIIIIlIllIlI("Io379sImKrctQKZPAkFWiQ==", "uAttw");
        S.lIIllIllIl[S.lIIllIlllI[14]] = S.lIIIIIlIllIll("DOBUQ1dNo6WPhS+CSWtQ+GwTNjnz3TR7", "ocHAv");
        S.lIIllIllIl[S.lIIllIlllI[53]] = S.lIIIIIlIllIlI("1TMlILit0Qp8pZABKb3SbQ==", "sOJnP");
        S.lIIllIllIl[S.lIIllIlllI[54]] = S.lIIIIIlIllIll("vWk8uWhSaSY=", "pvQCk");
        S.lIIllIllIl[S.lIIllIlllI[55]] = S.lIIIIIlIlllII("JRMiBg==", "jcGhJ");
        S.lIIllIllIl[S.lIIllIlllI[56]] = S.lIIIIIlIlllII("DBUdOA==", "CexVI");
        S.lIIllIllIl[S.lIIllIlllI[57]] = S.lIIIIIlIlllII("MSIuDRYaPSg=", "tZMew");
        S.lIIllIllIl[S.lIIllIlllI[58]] = S.lIIIIIlIlllII("ETIVIjM6LRNqZw==", "TJvJR");
        S.lIIllIllIl[S.lIIllIlllI[59]] = S.lIIIIIlIlllII("KDANLzgDLwtnGAEk", "mHnGY");
        S.lIIllIllIl[S.lIIllIlllI[60]] = S.lIIIIIlIllIlI("qb1KkMARczAaeNKprkbSXw==", "GydYJ");
        S.lIIllIllIl[S.lIIllIlllI[61]] = S.lIIIIIlIlllII("AyYfD1g7KVEQGTkgAwsT", "TOqjx");
        S.lIIllIllIl[S.lIIllIlllI[62]] = S.lIIIIIlIllIll("q+w9quCo+No=", "zgPcw");
        S.lIIllIllIl[S.lIIllIlllI[75]] = S.lIIIIIlIllIll("DQ1uBC45vy//0MLtk5Rn4g==", "HVirc");
        S.lIIllIllIl[S.lIIllIlllI[77]] = S.lIIIIIlIllIlI("g86JNuuS4oute1b1jrxSxQ5OmdR0FTF+", "XYcyq");
    }
    ...
    private static boolean ab() {
        ...
        block2: {
            ...
            n2 = lIIllIlllI[2];
            "".length();
            if (((0x7F ^ 0x23 ^ (0x3A ^ 0x74)) & (145 + 168 - 269 + 166 ^ 78 + 152 - 81 + 43 ^ -" ".length())) == 0) return n2 != 0;
            return ((0x3F ^ 0x76 ^ (0x4E ^ 0x33)) & (0x52 ^ 0x1A ^ (0xCE ^ 0xB2) ^ -" ".length())) != 0;
        }
        n2 = lIIllIlllI[1];
        return n2 != 0;
    }
    ...
    public static void cB() {
        block44: {
            TileItem lllllllllllllllllllllIllIIlIIllI;
            block45: {
                ...
                if (S.lIIIIIllIIIlI(S.ab() ? 1 : 0) && S.lIIIIIllIIIIl(Game.getWildyLevel(), lIIllIlllI[2])) {
                    lllllllllllllllllllllIllIIlIIllI = BankLocation.getNearest();
                    if (S.lIIIIIllIIIll(lllllllllllllllllllllIllIIlIIllI) && S.lIIIIIllIIIlI(lllllllllllllllllllllIllIIlIIllI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderRogues.c = lIIllIllIl[lIIllIlllI[3]];
                        a.a((BankLocation)lllllllllllllllllllllIllIIlIIllI);
                    }
                    if (S.lIIIIIllIIIll(lllllllllllllllllllllIllIIlIIllI) && S.lIIIIIllIIIII(lllllllllllllllllllllIllIIlIIllI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (S.lIIIIIllIIIII(S.ab() ? 1 : 0)) {
                    ...
                    if (S.lIIIIIllIIlII(Game.getWildyLevel())) {
                        TileObject lllllllllllllllllllllIllIIlIIlIl;
                        int[] nArray = new int[lIIllIlllI[2]];
                        ...
                        if (S.lIIIIIllIIIII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            if (S.lIIIIIllIIlIl(Players.getLocal().getWorldLocation().distanceTo(jv), lIIllIlllI[20])) {
                                ...
                                lllllllllllllllllllllIllIIlIIllI = tileItem;
                                Walker.walkAlong(Arrays.asList(lllllllllllllllllllllIllIIlIIllI), new HashMap());
                                "".length();
                                Time.sleepTicks((int)lIIllIlllI[2]);
                                "".length();
                            }
                            if (S.lIIIIIllIIlll(Players.getLocal().getWorldLocation().distanceTo(jv), lIIllIlllI[20])) {
                                ...
                                lllllllllllllllllllllIllIIlIIllI = TileObjects.getNearest((String[])stringArray);
                                String[] stringArray2 = new String[lIIllIlllI[2]];
                                stringArray2[S.lIIllIlllI[1]] = lIIllIllIl[lIIllIlllI[20]];
                                lllllllllllllllllllllIllIIlIIlIl = TileObjects.getNearest((String[])stringArray2);
                                String[] stringArray3 = new String[lIIllIlllI[2]];
                                stringArray3[S.lIIllIlllI[1]] = lIIllIllIl[lIIllIlllI[46]];
                                if (S.lIIIIIllIIIII(lllllllllllllllllllllIllIIlIIlIl.hasAction(stringArray3) ? 1 : 0)) {
                                    lllllllllllllllllllllIllIIlIIlIl.interact(lIIllIllIl[lIIllIlllI[47]]);
                                }
                                if (S.lIIIIIllIIIll(lllllllllllllllllllllIllIIlIIllI)) {
                                    String[] stringArray4 = new String[lIIllIlllI[2]];
                                    stringArray4[S.lIIllIlllI[1]] = lIIllIllIl[lIIllIlllI[48]];
                                    if (S.lIIIIIllIIIlI(lllllllllllllllllllllIllIIlIIlIl.hasAction(stringArray4) ? 1 : 0)) {
                                        int lllllllllllllllllllllIllIIlIIlII = Skills.getExperience((Skill)Skill.PRAYER);
                                        int[] nArray3 = new int[lIIllIlllI[2]];
                                        nArray3[S.lIIllIlllI[1]] = lIIllIlllI[0];
                        ...
                        if (S.lIIIIIllIIIlI(Inventory.contains((int[])nArray4) ? 1 : 0)) {
                            ...
                            if (S.lIIIIIllIIIII(Inventory.contains((int[])nArray5) ? 1 : 0)) {
                                if (S.lIIIIIllIIlIl(Players.getLocal().getWorldLocation().distanceTo(jv), lIIllIlllI[20])) {
                                    ...
                                    lllllllllllllllllllllIllIIlIIllI = worldPointArray;
                                    Walker.walkAlong(Arrays.asList(lllllllllllllllllllllIllIIlIIllI), new HashMap());
                                    "".length();
                                    Time.sleepTicks((int)lIIllIlllI[2]);
                                    "".length();
                                ...
                                if (S.lIIIIIllIIlll(Players.getLocal().getWorldLocation().distanceTo(jv), lIIllIlllI[20])) {
                                    ...
                                    lllllllllllllllllllllIllIIlIIllI = NPCs.getNearest((String[])stringArray);
                                    String[] stringArray6 = new String[lIIllIlllI[2]];
                                    stringArray6[S.lIIllIlllI[1]] = lIIllIllIl[lIIllIlllI[53]];
                                    lllllllllllllllllllllIllIIlIIlIl = TileObjects.getNearest((String[])stringArray6);
                                    String[] stringArray7 = new String[lIIllIlllI[2]];
                                    stringArray7[S.lIIllIlllI[1]] = lIIllIllIl[lIIllIlllI[54]];
                                    if (S.lIIIIIllIIIII(lllllllllllllllllllllIllIIlIIlIl.hasAction(stringArray7) ? 1 : 0)) {
                                        lllllllllllllllllllllIllIIlIIlIl.interact(lIIllIllIl[lIIllIlllI[55]]);
                                    }
                                    if (S.lIIIIIllIIIll(lllllllllllllllllllllIllIIlIIllI)) {
                                        String[] stringArray8 = new String[lIIllIlllI[2]];
                                        stringArray8[S.lIIllIlllI[1]] = lIIllIllIl[lIIllIlllI[56]];
                                        if (S.lIIIIIllIIIlI(lllllllllllllllllllllIllIIlIIlIl.hasAction(stringArray8) ? 1 : 0)) {
                                            List lllllllllllllllllllllIllIIlIIlII;
                                            if (S.lIIIIIllIIIlI(Dialog.isOpen() ? 1 : 0)) {
                                                int[] nArray6 = new int[lIIllIlllI[2]];
                                                nArray6[S.lIIllIlllI[1]] = lIIllIlllI[50];
                                                Inventory.getFirst((int[])nArray6).useOn((Actor)lllllllllllllllllllllIllIIlIIllI);
                                                Time.sleepTicks((int)lIIllIlllI[3]);
                                                "".length();
                                            }
                                            if (S.lIIIIIllIIIII(Dialog.isOpen() ? 1 : 0) && S.lIIIIIllIIIlI((lllllllllllllllllllllIllIIlIIlII = Dialog.getOptions()).isEmpty() ? 1 : 0)) {
                                                int lllllllllllllllllllllIllIIlIIIll = lIIllIlllI[1];
                                                while (S.lIIIIIllIIIIl(lllllllllllllllllllllIllIIlIIIll, lllllllllllllllllllllIllIIlIIlII.size())) {
                                                    int[] nArray7 = new int[lIIllIlllI[2]];
                                                    nArray7[S.lIIllIlllI[1]] = lIIllIlllI[50];
                                                    if (S.lIIIIIllIIllI(((Item)Inventory.getAll((int[])nArray7).get(lIIllIlllI[1])).getQuantity(), lIIllIlllI[2]) && S.lIIIIIllIIIII(((Widget)lllllllllllllllllllllIllIIlIIlII.get(lllllllllllllllllllllIllIIlIIIll)).getText().contains(lIIllIllIl[lIIllIlllI[57]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)lllllllllllllllllllllIllIIlIIlII.get(lllllllllllllllllllllIllIIlIIIll)).getClickPoint().getX(), (int)((Widget)lllllllllllllllllllllIllIIlIIlII.get(lllllllllllllllllllllIllIIlIIIll)).getClickPoint().getY(), (boolean)lIIllIlllI[2]);
                                                        Time.sleepTicks((int)lIIllIlllI[3]);
                                                        "".length();
                                                    }
                                                    int[] nArray8 = new int[lIIllIlllI[2]];
                                                    nArray8[S.lIIllIlllI[1]] = lIIllIlllI[50];
                                                    if (S.lIIIIIllIIllI(((Item)Inventory.getAll((int[])nArray8).get(lIIllIlllI[1])).getQuantity(), lIIllIlllI[13]) && S.lIIIIIllIIIII(((Widget)lllllllllllllllllllllIllIIlIIlII.get(lllllllllllllllllllllIllIIlIIIll)).getText().contains(lIIllIllIl[lIIllIlllI[58]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)lllllllllllllllllllllIllIIlIIlII.get(lllllllllllllllllllllIllIIlIIIll)).getClickPoint().getX(), (int)((Widget)lllllllllllllllllllllIllIIlIIlII.get(lllllllllllllllllllllIllIIlIIIll)).getClickPoint().getY(), (boolean)lIIllIlllI[2]);
                                                        Time.sleepTicks((int)lIIllIlllI[3]);
                                                        "".length();
                                                    }
                                                    if (S.lIIIIIllIIIII(((Widget)lllllllllllllllllllllIllIIlIIlII.get(lllllllllllllllllllllIllIIlIIIll)).getText().contains(lIIllIllIl[lIIllIlllI[59]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)lllllllllllllllllllllIllIIlIIlII.get(lllllllllllllllllllllIllIIlIIIll)).getClickPoint().getX(), (int)((Widget)lllllllllllllllllllllIllIIlIIlII.get(lllllllllllllllllllllIllIIlIIIll)).getClickPoint().getY(), (boolean)lIIllIlllI[2]);
                                                        Time.sleepTicks((int)lIIllIlllI[3]);
                                                        "".length();
                                                    }
                                                    ++lllllllllllllllllllllIllIIlIIIll;
                                                    "".length();
            ...
            if (S.lIIIIIllIIlll(Players.getLocal().getWorldLocation().distanceTo(jv), lIIllIlllI[20])) {
                ...
                lllllllllllllllllllllIllIIlIIllI = TileItems.getNearest((String[])stringArray);
                if (S.lIIIIIllIIIll(lllllllllllllllllllllIllIIlIIllI)) {
                    lllllllllllllllllllllIllIIlIIllI.interact(lIIllIllIl[lIIllIlllI[62]]);
                }
            }
        }
    }
