...
implements G {
    ...
    private static void llllIIIlllll() {
        ...
        E.lIIIlllIlI[E.lIIIllllII[0]] = E.llllIIIlllII("DTATEQIoZQMMCSI2", "OEjxl");
        E.lIIIlllIlI[E.lIIIllllII[1]] = E.llllIIIlllIl("F8PBwMXb6iQSGEGnBn42qKKuEHkCPc4Yr3/0jmg7yMJlwhkqgaZXFV8Vxgszi0jQ", "vAuaN");
        E.lIIIlllIlI[E.lIIIllllII[3]] = E.llllIIIlllIl("o4GKgSwmfU4=", "GKpbB");
        E.lIIIlllIlI[E.lIIIllllII[5]] = E.llllIIIllllI("4VIolVAB8/s=", "HROKo");
        E.lIIIlllIlI[E.lIIIllllII[7]] = E.llllIIIllllI("QT1PVfidcDaN9ExrzMx+sA==", "ArgQE");
        E.lIIIlllIlI[E.lIIIllllII[8]] = E.llllIIIlllII("BiQAJjgnKwliNi8rBSs6KQ==", "NEnBT");
        E.lIIIlllIlI[E.lIIIllllII[14]] = E.llllIIIllllI("LaBdePU0Ww8d0QlNnuFWuEhDr4xRnCTjU5E7qGw9Gzyi0chTcGIxGg7Fm5XN5RYpfNaOLo/Lp3k=", "yVRFz");
        E.lIIIlllIlI[E.lIIIllllII[20]] = E.llllIIIllllI("DPPoRdXLHSeemPbY7u/Yjw==", "VzhvG");
        E.lIIIlllIlI[E.lIIIllllII[18]] = E.llllIIIlllII("IgY/YwwDRzo3GR4T", "lgICx");
        E.lIIIlllIlI[E.lIIIllllII[21]] = E.llllIIIlllIl("JffAyzlVot6Upzih6R3MzA==", "HufCP");
        E.lIIIlllIlI[E.lIIIllllII[15]] = E.llllIIIllllI("Qqx/aUr4Yvxhq3aTL3opbg==", "DMglv");
        E.lIIIlllIlI[E.lIIIllllII[19]] = E.llllIIIlllII("FzYcaRE2dwQsBjI7CyoAeTAfMA==", "YWjIe");
        E.lIIIlllIlI[E.lIIIllllII[22]] = E.llllIIIllllI("sUPPkvTp/PbkcjKUriK5rw==", "pxjFZ");
        E.lIIIlllIlI[E.lIIIllllII[23]] = E.llllIIIlllIl("6V/ecHWl7pA=", "cHezF");
        E.lIIIlllIlI[E.lIIIllllII[24]] = E.llllIIIlllII("JSUQIA==", "jUuNw");
        E.lIIIlllIlI[E.lIIIllllII[25]] = E.llllIIIlllII("JDEOOA==", "kAkVr");
        E.lIIIlllIlI[E.lIIIllllII[26]] = E.llllIIIllllI("nlWbyUyA6dvXWLdnBteO8g==", "aEqWs");
        E.lIIIlllIlI[E.lIIIllllII[28]] = E.llllIIIlllIl("9+/6cdndJ30=", "mRpqB");
        E.lIIIlllIlI[E.lIIIllllII[29]] = E.llllIIIllllI("FLCnE3cq9PpnEPG/E2FysA==", "rTAnM");
        E.lIIIlllIlI[E.lIIIllllII[30]] = E.llllIIIllllI("AkBkzC3bcnvFNQqpJvF1vw==", "KJwyO");
        E.lIIIlllIlI[E.lIIIllllII[31]] = E.llllIIIlllIl("/wNzxvBd9YPDxiLmkU0HFg==", "QcYhQ");
        E.lIIIlllIlI[E.lIIIllllII[32]] = E.llllIIIlllIl("spcf5tgVoveBhbWHHfz6KA==", "VgfdL");
        E.lIIIlllIlI[E.lIIIllllII[33]] = E.llllIIIllllI("V+B87SaoA9A=", "BvEVz");
        E.lIIIlllIlI[E.lIIIllllII[34]] = E.llllIIIlllIl("tNxmoauIqJ8=", "KTSsa");
        E.lIIIlllIlI[E.lIIIllllII[35]] = E.llllIIIllllI("Os3C1KxE7JuvHQ+x9VV3NQ==", "noVoX");
        E.lIIIlllIlI[E.lIIIllllII[36]] = E.llllIIIlllIl("itlBqpIHywUL8YyXbNSXpA==", "sYVaT");
        E.lIIIlllIlI[E.lIIIllllII[37]] = E.llllIIIlllII("DyAdFgE=", "NLiws");
        E.lIIIlllIlI[E.lIIIllllII[38]] = E.llllIIIlllII("NCggJxUP", "gMAUv");
        E.lIIIlllIlI[E.lIIIllllII[39]] = E.llllIIIllllI("I7wbeBlwyeA=", "cYKWs");
        E.lIIIlllIlI[E.lIIIllllII[40]] = E.llllIIIlllII("Jwg/VBoGSSobCA8AJw==", "iiItn");
        E.lIIIlllIlI[E.lIIIllllII[41]] = E.llllIIIlllII("IjMqIQkDPCNlBgU0IiwL", "jRDEe");
        E.lIIIlllIlI[E.lIIIllllII[42]] = E.llllIIIlllII("MAE3MxEd", "snQUx");
        E.lIIIlllIlI[E.lIIIllllII[43]] = E.llllIIIlllIl("TBvUOuNoIFA=", "jDEgh");
        E.lIIIlllIlI[E.lIIIllllII[44]] = E.llllIIIlllIl("pLpKSlQJL58=", "hNeBi");
        E.lIIIlllIlI[E.lIIIllllII[45]] = E.llllIIIllllI("BiGmjmddzqgkEqPnInDpMw==", "KAVBd");
        E.lIIIlllIlI[E.lIIIllllII[52]] = E.llllIIIllllI("IKw/C7/t1y03P70tehBaMpc9GXlS4a/S", "lnDul");
        E.lIIIlllIlI[E.lIIIllllII[53]] = E.llllIIIlllIl("H7wMKTF6zd94PdAlWzTUx59AJos8sRUK", "mkzQC");
        E.lIIIlllIlI[E.lIIIllllII[54]] = E.llllIIIllllI("SQ23luaqij9ffuQLUMITTi2lSFrHPLTBP1Jqyxdjl4I=", "tVMKk");
        E.lIIIlllIlI[E.lIIIllllII[55]] = E.llllIIIlllIl("xVLS6xI24DRikWqpCDx8542ssmY50rbotTHPavCmZq4wbp83nHvW9Q==", "SLBVr");
        E.lIIIlllIlI[E.lIIIllllII[56]] = E.llllIIIlllIl("SzJl4l1Xi7Q4rHTFvsCxbjBVrRuMN7B3", "lFqyb");
        E.lIIIlllIlI[E.lIIIllllII[57]] = E.llllIIIlllII("Ky0XQw==", "rHdmT");
        E.lIIIlllIlI[E.lIIIllllII[58]] = E.llllIIIllllI("VPGsPbyzmqzrJ/VBBLuBx4aISWnTV2qyas7NNzl0N3k=", "MMzBg");
        E.lIIIlllIlI[E.lIIIllllII[59]] = E.llllIIIlllII("LCZvSScGOWMELkMlJgU7QzkrDCVN", "cMCiK");
        E.lIIIlllIlI[E.lIIIllllII[60]] = E.llllIIIlllIl("Xb20QBzjn4gGK0d+uIuXE6SpBCiMaqJSMqs4VWGV8YyAo/dhu3jKlA==", "vhzUy");
        E.lIIIlllIlI[E.lIIIllllII[61]] = E.llllIIIlllIl("F63fhaPvaV/TsC0En8eczTzmSZJJcPYbsemwT1JTc09FqO4dzQ0QH/Ag+ifCXaAP", "pgsbk");
        E.lIIIlllIlI[E.lIIIllllII[62]] = E.llllIIIlllII("DzIKSWQ4OA1FMDM7FkUpM3cNDSUidw4NIXYnCAomOjIXRS0leQ==", "VWzeD");
        E.lIIIlllIlI[E.lIIIllllII[63]] = E.llllIIIlllII("KTk/F00=", "zLMrc");
        E.lIIIlllIlI[E.lIIIllllII[64]] = E.llllIIIlllIl("fb+k6vdK6kSqwlKo/ZuIXL/nP9JPmF1C5TxINe2FEkLIcpJTqHTc7g==", "ZYheO");
        E.lIIIlllIlI[E.lIIIllllII[65]] = E.llllIIIlllII("NRImQ1AlUDhPAxkFMEE=", "lwUop");
        E.lIIIlllIlI[E.lIIIllllII[66]] = E.llllIIIlllII("EBUYSyk5FE8iajAfAxt1", "XzokJ");
    }
    ...
    private static void llllIIlIIIll() {
        ...
        E.lIIIllllII[52] = "  ".length() ^ (0x31 ^ 0x10);
        ...
        if (E.llllIIlIIlIl(Inventory.contains((int[])nArray) ? 1 : 0) && (!E.llllIIlIIlll(Inventory.contains((int[])f.aR) ? 1 : 0) || E.llllIIlIIlIl(Equipment.contains((int[])f.aR) ? 1 : 0)) && E.llllIIlIIlIl(Inventory.contains((int[])f.aV) ? 1 : 0)) {
            ...
            if (E.llllIIlIIlIl(Inventory.contains((int[])nArray2) ? 1 : 0)) {
                ...
                if (E.llllIIlIIlIl(Inventory.contains((int[])nArray3) ? 1 : 0)) {
                    ...
                    return ((0x6A ^ 0x71 ^ (0xCC ^ 0x91)) & (0xB9 ^ 0x9E ^ (0xE8 ^ 0x89) ^ -" ".length())) != 0;
                }
            }
        }
        n2 = lIIIllllII[0];
