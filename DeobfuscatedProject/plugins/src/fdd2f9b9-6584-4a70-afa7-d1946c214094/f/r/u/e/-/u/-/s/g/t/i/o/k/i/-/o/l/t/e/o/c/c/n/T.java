...
implements G {
    ...
    private static void lllIllIIllIl() {
        ...
        T.lIIIlIllIl[T.lIIIlIlllI[0]] = T.lllIllIIlIlI("jjzJcFiD/ER+ivjdgSZSYg==", "clLKG");
        T.lIIIlIllIl[T.lIIIlIlllI[1]] = T.lllIllIIlIll("sNK+qrAv6pWHtG+K9TlQn5h3DmOmQQn6ULC2i6cQ12FQr//3WVwgP45PXL0bNZ4u/GJhIEHT6y4=", "UhepP");
        T.lIIIlIllIl[T.lIIIlIlllI[3]] = T.lllIllIIllII("NjAMIwkZJRMkCVglFWoMGT8R", "xQzJn");
        T.lIIIlIllIl[T.lIIIlIlllI[4]] = T.lllIllIIlIll("AvbWR1Il4gBVXkGLEoG0Fg==", "tndTd");
        T.lIIIlIllIl[T.lIIIlIlllI[6]] = T.lllIllIIlIlI("elrQ6+XEnwIrFtazsUS3narrGSR101vS", "HREZm");
        T.lIIIlIllIl[T.lIIIlIlllI[12]] = T.lllIllIIlIlI("A8YB+kO8wQe+sGfVo4N6LADua7u430dCwgpd6XR79FIbDVU9NN+xS0l59G6VgwXP", "FQlgr");
        T.lIIIlIllIl[T.lIIIlIlllI[13]] = T.lllIllIIlIlI("wb+TgH+5aNLMIaICt4y1Hw==", "ERFuD");
        T.lIIIlIllIl[T.lIIIlIlllI[14]] = T.lllIllIIllII("JjEjKDwLLSt4IA0kPw==", "bCLXL");
        T.lIIIlIllIl[T.lIIIlIlllI[16]] = T.lllIllIIlIll("zDjoSRw53TxqmfzCuDBf/kXqH3XBgF3g", "FsOcv");
        T.lIIIlIllIl[T.lIIIlIlllI[17]] = T.lllIllIIlIll("ReHmRL64DCGpwrG/v0cCJw==", "PxcxO");
        T.lIIIlIllIl[T.lIIIlIlllI[18]] = T.lllIllIIllII("EwINGSE5BAVJPT8NEQ==", "PjbiQ");
        T.lIIIlIllIl[T.lIIIlIlllI[19]] = T.lllIllIIlIll("i1+PJ3B66RHULO+Fdwu/zw==", "uqztP");
        T.lIIIlIllIl[T.lIIIlIlllI[20]] = T.lllIllIIlIlI("bXQ8346OdCWU1V9Lw81esQtV9n95JkSy", "FNIFK");
        T.lIIIlIllIl[T.lIIIlIlllI[21]] = T.lllIllIIlIlI("jn18c/Anp9F+p/Y3QD3xyQ==", "rKptR");
        T.lIIIlIllIl[T.lIIIlIlllI[22]] = T.lllIllIIlIll("2S+Hq/UZIL0GeZDlNzY0Qh6L2opJQS2g", "QNJbU");
        T.lIIIlIllIl[T.lIIIlIlllI[15]] = T.lllIllIIlIll("HEZ2bsU7Xfr0WPlGBcoBow==", "UEhpO");
        T.lIIIlIllIl[T.lIIIlIlllI[34]] = T.lllIllIIlIlI("r3Lac9gEA8Ml5klA+gX45Q==", "adekm");
        T.lIIIlIllIl[T.lIIIlIlllI[36]] = T.lllIllIIlIlI("S+qA4q+uQsdXbmlOeZfAZ6d1Pp2iuOM9", "yyRoz");
    }
    ...
    public boolean V() {
        ...
        if (T.lllIllIlIlIl(Skills.getLevel((Skill)Skill.WOODCUTTING), lIIIlIlllI[35])) {
            bl = lIIIlIlllI[1];
            "".length();
            if ((0x15 ^ 0xF ^ (0x41 ^ 0x5F)) <= "  ".length()) {
                return ((0xE7 ^ 0xAE ^ (5 ^ 0x77)) & (0xD4 ^ 0x98 ^ (0xD2 ^ 0xA5) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIlIlllI[0];
        }
                ...
                if (T.lllIllIlIIll(Inventory.getCount((int[])nArray5))) {
                    ...
                    if (T.lllIllIlIIll(Inventory.getCount((int[])nArray6))) {
                        ...
                        if (T.lllIllIlIIll(Inventory.getCount((int[])nArray7))) {
                            n5 = lIIIlIlllI[1];
                            "".length();
                            if (((0xC9 ^ 0xC7 ^ (0x14 ^ 0x45)) & (8 ^ 0x55 ^ "  ".length() ^ -" ".length())) == ((5 ^ 0x62 ^ (0x64 ^ 0x63)) & (0x59 ^ 0x4A ^ (0x34 ^ 0x47) ^ -" ".length()))) return n5 != 0;
                            return ((0xE6 ^ 0x97 ^ (0x33 ^ 0x1C)) & (0xA8 ^ 0xC5 ^ (0x54 ^ 0x67) ^ -" ".length())) != 0;
                        }
                    }
                }
            }
                ...
                if (T.lllIllIlIIll(Inventory.getCount((int[])nArray9))) {
                    ...
                    if (T.lllIllIlIIll(Inventory.getCount((int[])nArray10))) {
                        ...
                        if (T.lllIllIlIIll(Inventory.getCount((int[])nArray11))) {
                            ...
                            return ((74 + 100 - 142 + 114 ^ 144 + 14 - 104 + 141) & (103 + 91 - 8 + 37 ^ 6 + 72 - -2 + 62 ^ -" ".length())) != 0;
                        }
                    }
                }
            }
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (T.lllIllIlIIll(Inventory.getCount((int[])nArray))) {
                            ...
                            if ((0x6C ^ 0x46 ^ (0x69 ^ 0x47)) > (0xD8 ^ 0xAD ^ (0x35 ^ 0x44))) {
                                return ((0x3A ^ 0x16 ^ (0xC7 ^ 0xB3)) & (0xB8 ^ 0x8B ^ (0xC4 ^ 0xAF) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIIlIlllI[0];
                        }
                ...
                if (T.lllIllIlIIII(Bank.contains((int[])nArray8) ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (T.lllIllIlIIll(Inventory.getCount((int[])nArray))) {
                            bl = lIIIlIlllI[1];
                            "".length();
                            if ("  ".length() <= ((0x86 ^ 0x90) & ~(0xB ^ 0x1D))) {
                                return ((0x30 ^ 0x36) & ~(0x75 ^ 0x73)) != 0;
                            }
                        } else {
                            bl = lIIIlIlllI[0];
                        }
                ...
                if (T.lllIllIlIIII(Bank.contains((int[])nArray9) ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (T.lllIllIlIIll(Inventory.getCount((int[])nArray))) {
                            ...
                            "".length();
                            if (" ".length() <= 0) {
                                return ((0xA ^ 0x54 ^ (0xEA ^ 0x91)) & (0xB3 ^ 0xA8 ^ (0xFB ^ 0xC5) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIIlIlllI[0];
                        }
                ...
                if (T.lllIllIlIIII(Bank.contains((int[])nArray10) ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (T.lllIllIlIIll(Inventory.getCount((int[])nArray))) {
                            ...
                            "".length();
                            if (-" ".length() != -" ".length()) {
                                return ((158 + 86 - 224 + 214 ^ 91 + 115 - 129 + 84) & (0xDB ^ 0xB1 ^ (8 ^ 0x29) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIIIlIlllI[0];
                        }
    ...
    private static void lllIllIIllll() {
        ...
        T.lIIIlIlllI[0] = (0x56 ^ 0x66 ^ (0x37 ^ 0x3D)) & (38 + 123 - 121 + 110 ^ 132 + 62 - 128 + 106 ^ -" ".length());
        T.lIIIlIlllI[1] = " ".length();
        T.lIIIlIlllI[2] = -(0xFFFFEBD9 & 0x5C2F) & (0xFFFFDFFB & 0x6BEF);
        T.lIIIlIlllI[3] = "  ".length();
        T.lIIIlIlllI[4] = "   ".length();
        ...
        T.lIIIlIlllI[18] = 0x94 ^ 0x9C ^ "  ".length();
