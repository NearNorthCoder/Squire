...
extends Script {
    ...
    public void a(ChatMessage chatMessage) {
        void llllllllllllllllllllIlllIIlIIIll;
        ...
        if (AccBuilderRogues.lIIIIllIlIllI(llllllllllllllllllllIlllIIlIIIll.getMessage().contains(lIIlllllII[lIIlllllIl[25]]) ? 1 : 0)) {
        ...
        if (AccBuilderRogues.lIIIIllIlIllI(llllllllllllllllllllIlllIIlIIIll.getMessage().contains(lIIlllllII[lIIlllllIl[29]]) ? 1 : 0) && AccBuilderRogues.lIIIIllIllIIl(Players.getLocal().getWorldLocation().distanceTo(C.hV), lIIlllllIl[18])) {
        ...
        if (AccBuilderRogues.lIIIIllIlIllI(llllllllllllllllllllIlllIIlIIIll.getMessage().contains(lIIlllllII[lIIlllllIl[35]]) ? 1 : 0)) {
            Movement.walkTo((WorldPoint)new WorldPoint(lIIlllllIl[36], lIIlllllIl[37], lIIlllllIl[4]));
            "".length();
            Time.sleepTicks((int)lIIlllllIl[5]);
            "".length();
        }
        if (AccBuilderRogues.lIIIIllIlIllI(llllllllllllllllllllIlllIIlIIIll.getMessage().contains(lIIlllllII[lIIlllllIl[38]]) ? 1 : 0)) {
    ...
    private static String lIIIIllIIllll(String llllllllllllllllllllIlllIIIIlIIl, String llllllllllllllllllllIlllIIIIlIII) {
        try {
            SecretKeySpec llllllllllllllllllllIlllIIIIlllI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllllIlllIIIIlIII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            return new String(llllllllllllllllllllIlllIIIIllIl.doFinal(Base64.getDecoder().decode(llllllllllllllllllllIlllIIIIlIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public void a(GameTick gameTick) {
        block5: {
            AccBuilderRogues llllllllllllllllllllIlllIIllIlIl;
            block6: {
                ...
                Player player3 = Players.getNearest(player2 -> {
                    ...
                    if (AccBuilderRogues.lIIIIllIlllIl(player2, player) && AccBuilderRogues.lIIIIllIlIllI(this.a(n2, n3, (Player)player2) ? 1 : 0)) {
                        n4 = lIIlllllIl[5];
                        "".length();
                        if ("  ".length() <= ((0x8B ^ 0xA5 ^ (0xB3 ^ 0x93)) & (106 + 91 - 73 + 3 ^ (3 ^ 0x72) ^ -" ".length()))) {
                            return ((0x6F ^ 7 ^ (0x56 ^ 0x12)) & (67 + 182 - 157 + 91 ^ 94 + 76 - 131 + 116 ^ -" ".length())) != 0;
                        }
                    } else {
                        n4 = lIIlllllIl[4];
                    }
            ...
            if (AccBuilderRogues.lIIIIllIlIIll(llllllllllllllllllllIlllIIllIlIl.r.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                Game.logout();
            }
        }
    ...
    private static void lIIIIllIlIIIl() {
        ...
        AccBuilderRogues.lIIlllllIl[5] = " ".length();
        ...
        AccBuilderRogues.lIIlllllIl[9] = "  ".length();
        AccBuilderRogues.lIIlllllIl[10] = "   ".length();
    ...
    private void a(LoginStateChanged loginStateChanged) {
        ...
        if (AccBuilderRogues.lIIIIllIlIIll(n)) {
            AccBuilderRogues llllllllllllllllllllIlllIIIlllll;
            f.r.u.e.-.u.-.s.g.t.i.o.k.i.-.o.l.t.e.o.c.c.n.e.a(llllllllllllllllllllIlllIIIlllll.s, "rsn: " + k + " account has been banned? - Acc builder " + o);
            n += lIIlllllIl[5];
        }
    }
    ...
    private static void lIIIIllIlIIII() {
        ...
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[4]] = AccBuilderRogues.lIIIIllIIllIl("DR42GTpfRW0NIBYJLRstSwktBGYEGitGPgAIKgYmDhltWHtUX3ZYf1ddcFt9Ulp0W3xcUm0KOAkSclsPFwQmHC5SLCA5DTE5MgMfEyY6PnwJKXUBKxFfCTx7Ci0gHSJIEHoGB1YPBCMnUF4bDhYrWSouJFQpcygCIw==", "ejBiI");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[5]] = AccBuilderRogues.lIIIIllIIlllI("E1LI4P7ajtQ=", "NBERV");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[9]] = AccBuilderRogues.lIIIIllIIllIl("NQoFLiYdChgoZDYmVjglAw0fISM=", "qcvOD");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[10]] = AccBuilderRogues.lIIIIllIIllll("pGCK65WM2lCr/5C1ABsaw0Sitx7P1/EX", "zbpiw");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[11]] = AccBuilderRogues.lIIIIllIIllIl("Jxk+PSQJFTR0NgITPyE5FQ==", "apPTW");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[13]] = AccBuilderRogues.lIIIIllIIllIl("WhUeNC83JyAFegAiOz8zPm49LDsiOic2PXA7PlI=", "PNNXZ");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[14]] = AccBuilderRogues.lIIIIllIIlllI("sx1/sP4sNdDMZCkTOEZWZw==", "AnMeR");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[15]] = AccBuilderRogues.lIIIIllIIllIl("OgY+BDABGDkXcx0edz89DFEUHDoKGnciPA4EMgNzJgQjFjodUTYTMAYEOQQ=", "iqWpS");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[16]] = AccBuilderRogues.lIIIIllIIlllI("80pPwe9SxxSKir09oWJwMQ==", "WpEuo");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[17]] = AccBuilderRogues.lIIIIllIIllIl("LzYGJxkvPA==", "JXgEu");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[18]] = AccBuilderRogues.lIIIIllIIllll("TUh0eWbzwsCawbSOPM9aTdW0CP2Oz9DqJPfOy2WDaQ8=", "OiScH");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[22]] = AccBuilderRogues.lIIIIllIIllIl("Myk1KXQzJDxlPy4iPg==", "GLYET");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[23]] = AccBuilderRogues.lIIIIllIIllll("VM8kSmLIjvTtFFMr/KkTPyRpO3+Cx0lj", "OhsJV");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[24]] = AccBuilderRogues.lIIIIllIIllIl("Jyk8eCIHKT0/L0khJzQjSSAnKmcLMzExKQ4=", "iFHXG");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[25]] = AccBuilderRogues.lIIIIllIIlllI("2q2Un0kV3z01V62c91M0zHUU0kMbvoER", "DHQrB");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[26]] = AccBuilderRogues.lIIIIllIIllIl("ACdWNzwSBldSVW1q", "WBvsu");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[27]] = AccBuilderRogues.lIIIIllIIllIl("EDskJ3B5cgQtND08JmMjNyAoMyRuchEvNTUhJGMiMSIuMSR0JSkiJHQjNCYjIHIoN3AwOyQncDs8YSI+MHItLDM1JigsPnghNSYgdDsnYyk7J2EwMSM=", "TRACP");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[28]] = AccBuilderRogues.lIIIIllIIlllI("R05lWscYisDQ9YzGON3XOQ2tkZn8u9lyyS41M47xKCX+V/Bi5OFO1BWcVfu6CV7CDFy947Dq4TUFp/6svE1eCZzfVc6XJYIGtPVs3jU1PKdD+QV3Btm9DGNtQr37qhHQ04IaTFid2uoAcz/++ROWKfuytI5m3tG4ycXQO5pc5ZY=", "BPyXg");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[29]] = AccBuilderRogues.lIIIIllIIllll("91acibrDM1IGxv18a3l/1xfgXxBK2SSg", "ThDzZ");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[30]] = AccBuilderRogues.lIIIIllIIllll("kcMQTjOZ4f8=", "IaRLU");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[19]] = AccBuilderRogues.lIIIIllIIlllI("jaI03b5DTJ0=", "KMWvn");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[31]] = AccBuilderRogues.lIIIIllIIllIl("BRohHQ==", "JjDsR");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[32]] = AccBuilderRogues.lIIIIllIIlllI("4QRtFiS8W0OqOhr/yy0wlg==", "FYTqO");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[33]] = AccBuilderRogues.lIIIIllIIllIl("JCIqH3A0PyAI", "pPOzP");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[34]] = AccBuilderRogues.lIIIIllIIllIl("KzsyFw==", "dKWyF");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[35]] = AccBuilderRogues.lIIIIllIIlllI("Fjgws1d2eM0I5x3ow2DumWDyhHetPKOD", "meVbd");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[38]] = AccBuilderRogues.lIIIIllIIllll("G+0okapZ9uKhD0AIY7DGtyzH7dTwXCJO", "ORAdT");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[40]] = AccBuilderRogues.lIIIIllIIlllI("/gcNXH0nc9U=", "JetMp");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[41]] = AccBuilderRogues.lIIIIllIIlllI("iWpRChDDa08=", "JzAFG");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[42]] = AccBuilderRogues.lIIIIllIIllll("vcdHxDZ8jrQ=", "tzyVb");
        AccBuilderRogues.lIIlllllII[AccBuilderRogues.lIIlllllIl[43]] = AccBuilderRogues.lIIIIllIIlllI("AvzWY2ltiaQ=", "ikaAZ");
    }

    private static String lIIIIllIIllIl(String llllllllllllllllllllIllIlllllIll, String llllllllllllllllllllIllIllllIlIl) {
        llllllllllllllllllllIllIlllllIll = new String(Base64.getDecoder().decode(llllllllllllllllllllIllIlllllIll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllllIllIlllllIIl = new StringBuilder();
        char[] llllllllllllllllllllIllIlllllIII = llllllllllllllllllllIllIllllIlIl.toCharArray();
        int llllllllllllllllllllIllIllllIlll = lIIlllllIl[4];
        char[] llllllllllllllllllllIllIllllIIIl = llllllllllllllllllllIllIlllllIll.toCharArray();
        int llllllllllllllllllllIllIllllIIII = llllllllllllllllllllIllIllllIIIl.length;
        int llllllllllllllllllllIllIlllIllll = lIIlllllIl[4];
        while (AccBuilderRogues.lIIIIllIllllI(llllllllllllllllllllIllIlllIllll, llllllllllllllllllllIllIllllIIII)) {
            char llllllllllllllllllllIllIllllllII = llllllllllllllllllllIllIllllIIIl[llllllllllllllllllllIllIlllIllll];
            llllllllllllllllllllIllIlllllIIl.append((char)(llllllllllllllllllllIllIllllllII ^ llllllllllllllllllllIllIlllllIII[llllllllllllllllllllIllIllllIlll % llllllllllllllllllllIllIlllllIII.length]));
            "".length();
            ++llllllllllllllllllllIllIllllIlll;
            ++llllllllllllllllllllIllIlllIllll;
            "".length();
    ...
    protected int loop() {
        block10: {
            block11: {
                ...
                int llllllllllllllllllllIlllIlIIIIII = lIIlllllIl[4];
                try {
                    llllllllllllllllllllIlllIlIIIIII = a.get(lIIlllllIl[4]).T();
                    "".length();
                }
                catch (Exception llllllllllllllllllllIlllIIllllll) {
                    llllllllllllllllllllIlllIIllllll.printStackTrace();
                }
                if (" ".length() == -" ".length()) {
                    return (0xD9 ^ 0xBF ^ (0xE2 ^ 0xA7)) & (0x64 ^ 0x7C ^ (0x71 ^ 0x4A) ^ -" ".length());
                }
                return llllllllllllllllllllIlllIlIIIIII;
            }
    ...
    private static String lIIIIllIIlllI(String llllllllllllllllllllIllIlllIIllI, String llllllllllllllllllllIllIlllIIlIl) {
        try {
            ...
            Cipher llllllllllllllllllllIllIlllIlIII = Cipher.getInstance("DES");
            llllllllllllllllllllIllIlllIlIII.init(lIIlllllIl[9], llllllllllllllllllllIllIlllIlIIl);
            return new String(llllllllllllllllllllIllIlllIlIII.doFinal(Base64.getDecoder().decode(llllllllllllllllllllIllIlllIIllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
