...
extends SquirePlugin {
    ...
    private static void lIIIllIlIlIllIl() {
        ...
        SquireNightmarePlugin.lllIllIllIll[0] = " ".length();
        SquireNightmarePlugin.lllIllIllIll[1] = (56 + 88 - 87 + 75 ^ 187 + 66 - 166 + 105) & (96 + 71 - 116 + 82 ^ 87 + 172 - 235 + 169 ^ -" ".length());
        SquireNightmarePlugin.lllIllIllIll[2] = 0xFFFFF7ED & 0x6CFF;
        SquireNightmarePlugin.lllIllIllIll[3] = 0xFFFFD7E3 & 0x7F9C;
        SquireNightmarePlugin.lllIllIllIll[4] = "  ".length();
        SquireNightmarePlugin.lllIllIllIll[5] = "   ".length();
        ...
        SquireNightmarePlugin.lllIllIllIll[46] = -" ".length();
        ...
        SquireNightmarePlugin.lllIllIllIll[56] = " ".length() ^ (0x15 ^ 0x38);
        ...
        SquireNightmarePlugin.lllIllIllIll[94] = -"  ".length() & (0xFFFFE4FF & 0x3FDB);
    ...
    public static int a() {
        return Inventory.getAll(item -> {
            ...
            if (!SquireNightmarePlugin.lIIIllIlIllIIII(string.contains(lllIllIllIIl[lllIllIllIll[6]]) ? 1 : 0) || SquireNightmarePlugin.lIIIllIlIlIlllI(string.contains(lllIllIllIIl[lllIllIllIll[56]]) ? 1 : 0)) {
                bl = lllIllIllIll[0];
                "".length();
                if (((6 + 44 - 33 + 122 ^ 124 + 50 - 160 + 162) & (0x6A ^ 0x17 ^ (0x69 ^ 0x2F) ^ -" ".length())) > ((27 + 68 - -83 + 6 ^ 24 + 69 - 59 + 142) & (21 + 62 - 39 + 111 ^ 8 + 17 - -21 + 101 ^ -" ".length()))) {
                    return (("  ".length() ^ (0x6A ^ 0x56)) & (0xD6 ^ 0xB5 ^ (0x30 ^ 0x6D) ^ -" ".length())) != 0;
                }
            } else {
                bl = lllIllIllIll[1];
            }
    ...
    private static String lIIIllIlIlIlIII(String lllllllllllllllIIllIIllIIllllIlI, String lllllllllllllllIIllIIllIIllllllI) {
        ...
        while (SquireNightmarePlugin.lIIIllIlIlllIIl(lllllllllllllllIIllIIllIIlllIIll, lllllllllllllllIIllIIllIIlllIlII)) {
            ...
            "".length();
            if (((42 + 127 - -37 + 33 ^ 12 + 24 - 21 + 183) & (98 + 46 - 0 + 17 ^ 121 + 64 - 129 + 80 ^ -" ".length())) == 0) continue;
            return null;
        }
    ...
    private static void lIIIllIlIlIllII() {
        ...
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[1]] = SquireNightmarePlugin.lIIIllIlIlIIllI("Gku8cfaw5yg=", "iOcVK");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[0]] = SquireNightmarePlugin.lIIIllIlIlIIllI("V/GMf17UGbY=", "kMTOI");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[4]] = SquireNightmarePlugin.lIIIllIlIlIIlll("EX2E+mUnytc=", "wdZQJ");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[5]] = SquireNightmarePlugin.lIIIllIlIlIIlll("bB/nvJfRk4F8cbev2oz1jaXcD8lVUIZflSI/QSrbanC3RxYaWt7pwKUZQH/ZQhnP", "UDQJh");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[7]] = SquireNightmarePlugin.lIIIllIlIlIlIII("Hg8KLzs9Bx8ibyMSDDU7NQI=", "PfmGO");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[8]] = SquireNightmarePlugin.lIIIllIlIlIlIII("NDIiJhoOMm4oEBAkLyIQQyUrJhAKISshWUMgK2URDHcgKgFDPy8zEEMjIWUeBjI+ZRkMMCksGwR5", "cWNEu");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[9]] = SquireNightmarePlugin.lIIIllIlIlIlIII("Pjg2ZgcOOy9mEgJ3LykXADInZh8SIw==", "gWCFp");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[10]] = SquireNightmarePlugin.lIIIllIlIlIlIII("ASVMKAg2P0wpDi0qHzUEISVAZhorawQnGytrGClNIiQLZgI7P0wyAm45CTUIOmsYLghufQRmGScmCTRD", "NKlFm");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[11]] = SquireNightmarePlugin.lIIIllIlIlIIllI("tBOyerLvUbh4tusJ8SlW5g==", "oLxtp");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[12]] = SquireNightmarePlugin.lIIIllIlIlIlIII("EQw0ZxgcDDAoARwD", "ymGGj");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[13]] = SquireNightmarePlugin.lIIIllIlIlIIlll("LNZ8l1BKrh/1aLNqKPgmOiTTZ9AC7qTCAicg77rRkaRP06ccvzOTq2hkiLw8/szN", "Tdehb");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[14]] = SquireNightmarePlugin.lIIIllIlIlIlIII("Oh0kOWYhDDUmLzYfIDhmIAwzIi8wDA==", "SiATF");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[15]] = SquireNightmarePlugin.lIIIllIlIlIIllI("B3SJc7adYrAlukoEVKQ1TngfMLxo8bkxczjhLfA+xUs=", "OZeWJ");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[16]] = SquireNightmarePlugin.lIIIllIlIlIIllI("8sE7MiHdK39crK2OUiB4HRb06raImrydTzRWHSLWDjrqQ1V2xlOJsjAgKijI/234FsrFUwIwIgo=", "HXIdD");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[17]] = SquireNightmarePlugin.lIIIllIlIlIlIII("GzI/Hw0EMyQe", "hZJyk");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[18]] = SquireNightmarePlugin.lIIIllIlIlIIlll("iH6mv4Dv/YWrWsLjOgvVyA5ZnpXF66b4", "tiYYM");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[19]] = SquireNightmarePlugin.lIIIllIlIlIlIII("PwUaCCM/VR0bMClVHBQgKRYBHyJsDBoP", "LuuzF");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[20]] = SquireNightmarePlugin.lIIIllIlIlIlIII("MDsvRDoNNCIQGQUhL0MHRDokAhEHJyMLGkQ7KxdUEzw4ClQLNSw=", "dSJdt");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[21]] = SquireNightmarePlugin.lIIIllIlIlIIlll("gamWMh9L8PQAImrM8zkXZPJ1G3A5MEMF", "YjdxQ");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[22]] = SquireNightmarePlugin.lIIIllIlIlIIllI("cIApoIzDVpSrFLJLuzjELoWwC5/bOcL03QaKivHEBokmixyeRj9uYfGztAOcaN8yhoXdp5vpyb8=", "wgOms");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[23]] = SquireNightmarePlugin.lIIIllIlIlIIllI("DQW0+0RQMXKrCsHPPSXwRMqTdYiPZyQa8G4yfare0OvsrCpmk9SPY8GDGvxX9TKQP3lstqvjNlxh6G0zyrVddxv/HKYCQPSk", "ovpjX");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[24]] = SquireNightmarePlugin.lIIIllIlIlIlIII("DRoWC0oyHBUMSj0OVkcFMBYIBgYqUxsRDzQSHQJKMhoXAlBmCAc=", "Fszgj");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[25]] = SquireNightmarePlugin.lIIIllIlIlIIllI("VG+WmXh3toxyffwks/7MAA==", "DMznU");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[26]] = SquireNightmarePlugin.lIIIllIlIlIIlll("vuQQ53eLePyujPqCiC5uilpNN8vq1G8o8yKiaM+bZFGRnEvhhWt7Ag==", "XXLrm");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[27]] = SquireNightmarePlugin.lIIIllIlIlIIlll("CqZc6rT8vvLVQogPjx6fS1ED65DFiphQ+RrPKrspukP+Oxq1ZosJ2ld3eQlPCSED", "ddjcf");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[28]] = SquireNightmarePlugin.lIIIllIlIlIIlll("QVWkIfN5cKmwzwZKt/t8hb9vo+94QxKU1w9Efu3266Rp1uuBOS/LbT6o/fjdCbPgGLBw9TpNRvXvKtNED0OEwkr+MoYO2h/RE1JuNTMEIDw=", "hrDJJ");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[29]] = SquireNightmarePlugin.lIIIllIlIlIIlll("islSDLk93oDKEQZqR/otLQ==", "BEWWh");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[30]] = SquireNightmarePlugin.lIIIllIlIlIlIII("JBg8DTQ=", "auLyM");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[31]] = SquireNightmarePlugin.lIIIllIlIlIIlll("goJNL+0aWlAKuEULZDCaKEbmwLNmuoSeC+yvwbj3fjQF9b7/pvKJwztboGLGy4BDv0fgjYYjuO/LNibpYfzNpGkgWsv9PdlEvZElN0p76Fc=", "VlSNk");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[32]] = SquireNightmarePlugin.lIIIllIlIlIlIII("Jhcn", "cvSzZ");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[33]] = SquireNightmarePlugin.lIIIllIlIlIIllI("btrACiFUT5g=", "esayJ");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[34]] = SquireNightmarePlugin.lIIIllIlIlIlIII("CAEMAwcqCUsNAGhOGQEdIRpLUgZkAgQDTiICCgNA", "Dnkdn");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[35]] = SquireNightmarePlugin.lIIIllIlIlIlIII("OyseOjUoIxAlOA==", "ZEyVP");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[36]] = SquireNightmarePlugin.lIIIllIlIlIlIII("MCoKBCkjIgQbJA==", "QDmhL");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[37]] = SquireNightmarePlugin.lIIIllIlIlIIlll("SUN3P7C7WLU=", "CCyTm");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[38]] = SquireNightmarePlugin.lIIIllIlIlIlIII("CQYODRw=", "Mtgcw");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[39]] = SquireNightmarePlugin.lIIIllIlIlIIllI("C4167UJqTtpgYbJf9/G7uSWN2kU5m6gC", "BVKff");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[40]] = SquireNightmarePlugin.lIIIllIlIlIIlll("+6SZDCeR7HQ=", "maRTx");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[41]] = SquireNightmarePlugin.lIIIllIlIlIlIII("DQcx", "HfEKO");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[42]] = SquireNightmarePlugin.lIIIllIlIlIIllI("JN72Q/LnV2v+A1+pcaYKJA==", "twNxg");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[43]] = SquireNightmarePlugin.lIIIllIlIlIIllI("E7HYx+2wuVPNPD86ncv3bg==", "rEOxX");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[44]] = SquireNightmarePlugin.lIIIllIlIlIlIII("IhkCKwZxHwY8ET8LBiY=", "QlrNt");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[45]] = SquireNightmarePlugin.lIIIllIlIlIIlll("mV+3qF/cAtU=", "ExKHF");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[6]] = SquireNightmarePlugin.lIIIllIlIlIlIII("EBQIFwoU", "cufqo");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[56]] = SquireNightmarePlugin.lIIIllIlIlIIllI("/YerLGhGkPI=", "XfwVs");
        SquireNightmarePlugin.lllIllIllIIl[SquireNightmarePlugin.lllIllIllIll[78]] = SquireNightmarePlugin.lIIIllIlIlIlIII("eklDQGc=", "IgwnU");
    }
        ...
        TileObject tileObject2 = TileObjects.getNearest(tileObject -> {
            ...
            if (SquireNightmarePlugin.lIIIllIlIlIlllI(tileObject.getName().toLowerCase().contains(lllIllIllIIl[lllIllIllIll[37]]) ? 1 : 0)) {
                ...
                if (SquireNightmarePlugin.lIIIllIlIlIlllI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x90 ^ 0xAB ^ (0x81 ^ 0xAB)) & (0xC ^ 1 ^ (0xB5 ^ 0xA9) ^ -" ".length())) != 0;
                }
            }
            n2 = lllIllIllIll[1];
            return n2 != 0;
    ...
    public boolean m() {
        ...
        if (SquireNightmarePlugin.lIIIllIlIllIllI((Object)lllllllllllllllIIllIIllIlIllIllI.aw.bankLocation(), (Object)s.i.e.i.m.r.-.q.e.g.h.u.n.t.r.a.w.VER_SINHAZA)) {
            ...
            if (SquireNightmarePlugin.lIIIllIlIlIllll(Inventory.getFirst((int[])nArray))) {
                ...
                "".length();
                if (-" ".length() != -" ".length()) {
                    return ((83 + 124 - 28 + 12 ^ 74 + 105 - 151 + 105) & (59 + 95 - 56 + 36 ^ 24 + 54 - 18 + 128 ^ -" ".length())) != 0;
                }
            }
        } else {
            n2 = lllIllIllIll[48];
