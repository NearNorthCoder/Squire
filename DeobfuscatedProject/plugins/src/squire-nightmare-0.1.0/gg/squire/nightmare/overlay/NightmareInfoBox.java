...
extends OverlayPanel {
    ...
    private static void lIIlIIIlllllIIl() {
        ...
        NightmareInfoBox.llllIlllIllI[2] = " ".length();
        NightmareInfoBox.llllIlllIllI[3] = "  ".length();
        NightmareInfoBox.llllIlllIllI[4] = "   ".length();
    ...
    public Dimension render(Graphics2D graphics2D) {
        ...
        if (NightmareInfoBox.lIIlIIIllllllIl(lllllllllllllllIIlIlIllIIIlllIlI.cw.ae() ? 1 : 0)) {
            ...
            "".length();
            if (-" ".length() > ((0xD4 ^ 0x98 ^ (0x10 ^ 0x1C)) & (40 + 92 - -63 + 2 ^ 125 + 18 - 26 + 16 ^ -" ".length()))) {
                return null;
            }
        } else {
    ...
    private static String lIIlIIIlllIllll(String lllllllllllllllIIlIlIllIIIIIIlll, String lllllllllllllllIIlIlIllIIIIIIllI) {
        ...
        while (NightmareInfoBox.lIIlIIIlllllllI(lllllllllllllllIIlIlIllIIIIIIIII, lllllllllllllllIIlIlIllIIIIIIIIl)) {
            ...
            "".length();
            if ((140 + 154 - 216 + 78 ^ 36 + 14 - 36 + 138) > "  ".length()) continue;
            return null;
        }
    ...
    private static void lIIlIIIlllllIII() {
        ...
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[1]] = NightmareInfoBox.lIIlIIIlllIlllI("jnjrVFetbqI=", "YOPHo");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[2]] = NightmareInfoBox.lIIlIIIlllIllll("XWFJEDg=", "xOyvs");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[3]] = NightmareInfoBox.lIIlIIIlllIlllI("PuHb0HY9lyw=", "nnqqJ");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[4]] = NightmareInfoBox.lIIlIIIllllIIIl("/R3jroWYJi4=", "jQapV");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[5]] = NightmareInfoBox.lIIlIIIllllIIIl("urPn6behN48=", "QzRiU");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[7]] = NightmareInfoBox.lIIlIIIllllIIIl("EzJHGGcoPD8V17Gd6XkZdskrfBE9JQxwUf+54p+Ninw=", "GWqoJ");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[8]] = NightmareInfoBox.lIIlIIIlllIllll("JiEfADgZMQ==", "tTqtQ");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[9]] = NightmareInfoBox.lIIlIIIllllIIIl("kYGHapUwv8U=", "tuVRw");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[10]] = NightmareInfoBox.lIIlIIIlllIllll("RU1BQXo=", "vcuoH");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[11]] = NightmareInfoBox.lIIlIIIlllIllll("PDUEHlJI", "hTwuh");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[6]] = NightmareInfoBox.lIIlIIIlllIllll("BCAjPR0kbmI=", "WTBIh");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[12]] = NightmareInfoBox.lIIlIIIlllIlllI("zoRo0hLkbZJCMGwt7ZEwtA==", "OyEsV");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[13]] = NightmareInfoBox.lIIlIIIllllIIIl("3NvJeG4KkLA=", "ljiAe");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[14]] = NightmareInfoBox.lIIlIIIllllIIIl("V9Pji+XXgCw=", "nWKil");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[15]] = NightmareInfoBox.lIIlIIIlllIllll("ORMgHwdSKikBVDoVOQE=", "rzLst");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[16]] = NightmareInfoBox.lIIlIIIlllIllll("CRUffnMLNkQY", "LfkPS");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[17]] = NightmareInfoBox.lIIlIIIlllIlllI("2LAQnuQ6LFl6Vl4zGm4M4g==", "tPBGU");
        NightmareInfoBox.llllIlllIIll[NightmareInfoBox.llllIlllIllI[18]] = NightmareInfoBox.lIIlIIIllllIIIl("MOy8aT2dYMs=", "gOsmX");
    }
}
