...
public class g {
    ...
    public boolean l(int n2) {
        void lllllllllllllllIIlIllIlIllIIlllI;
        int[] nArray = this.bv.getMapRegions();
        int n3 = nArray.length;
        int lllllllllllllllIIlIllIlIllIIllIl = llllIlIIllIl[0];
        while (g.lIIlIIIIlIIllll(lllllllllllllllIIlIllIlIllIIllIl, (int)lllllllllllllllIIlIllIlIllIIlllI)) {
            void lllllllllllllllIIlIllIlIllIlIIII;
            void lllllllllllllllIIlIllIlIllIIllll;
            void lllllllllllllllIIlIllIlIllIIllII = lllllllllllllllIIlIllIlIllIIllll[lllllllllllllllIIlIllIlIllIIllIl];
            if (g.lIIlIIIIlIlIIII((int)lllllllllllllllIIlIllIlIllIIllII, (int)lllllllllllllllIIlIllIlIllIlIIII)) {
                return llllIlIIllIl[1];
            }
            ++lllllllllllllllIIlIllIlIllIIllIl;
            "".length();
            if (" ".length() != 0) continue;
            return ((0xD3 ^ 0xB1) & ~(0x1D ^ 0x7F)) != 0;
        }
