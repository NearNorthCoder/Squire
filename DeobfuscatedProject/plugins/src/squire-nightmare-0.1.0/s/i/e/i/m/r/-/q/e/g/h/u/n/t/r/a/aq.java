...
extends Task {
        ...
        block16: {
            ...
            lllllllllllllllIIllIIlIlIlIIlIIl = NPCs.getNearest(nPC -> {
                ...
                if (aq.lIIIllIllIlIlIl(nPC.getName().equals(lllIlllIIIIl[lllIlllIIIlI[19]]) ? 1 : 0) && aq.lIIIllIllIlllII(nPC.getAnimation(), lllIlllIIIlI[20])) {
                    ...
                    "".length();
                    if ("   ".length() <= 0) {
                        return ((0x64 ^ 7 ^ (0x70 ^ 0x45)) & (0xC7 ^ 0xC0 ^ (0x2F ^ 0x7E) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lllIlllIIIlI[0];
                }
    ...
    private boolean cD() {
        ...
        if (!aq.lIIIllIllIlIlII(lllllllllllllllIIllIIlIlIlIIIlll.d().hasAction(stringArray) ? 1 : 0) || aq.lIIIllIllIlllII(lllllllllllllllIIllIIlIlIlIIIlll.d().getAnimation(), lllIlllIIIlI[18])) {
            ...
            if (-(0x48 ^ 5 ^ (0xC5 ^ 0x8C)) >= 0) {
                return ((149 + 119 - 134 + 84 ^ 136 + 132 - 207 + 95) & (84 + 172 - 178 + 117 ^ 77 + 99 - 152 + 109 ^ -" ".length())) != 0;
            }
        } else {
            bl = lllIlllIIIlI[0];
        }
    ...
    private static void lIIIllIllIlIIIl() {
        ...
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[0]] = aq.lIIIllIllIIlllI("lsdf5v41+7E=", "UGFbZ");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[1]] = aq.lIIIllIllIIllll("MDYALgoSdwAyChR3AChEEyIYK0QdMhUrEB0=", "uWtGd");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[3]] = aq.lIIIllIllIIlllI("cGfAm9E3Vl8=", "zpUpI");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[4]] = aq.lIIIllIllIIlllI("Fb/mR13HUqs=", "OktOl");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[5]] = aq.lIIIllIllIIllll("Fg07MDk8", "WyOQZ");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[6]] = aq.lIIIllIllIIllll("DikCIjgsaBAkOS9oBSI4KC1WPDNrIBc9M2ssGTw4PyEbLnprKRgvdjwtUTkzayoTJzk8aA02diM4WA==", "KHvKV");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[7]] = aq.lIIIllIllIlIIII("4l2mBAINihI=", "LTEkT");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[9]] = aq.lIIIllIllIIllll("ABBZHTVPGVkULxZYFBI+ClgQB3obEAscLwgQWRI0C1gOFnoIFw0SegoZDVM0AA9ZPxUj", "oxysZ");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[10]] = aq.lIIIllIllIIlllI("zeKbmDdAFLE=", "WRXlA");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[11]] = aq.lIIIllIllIlIIII("e8hI8UX2q699MlMdZgwQpuQ+jL76i26lRi10nbM70ncD5LjhiaM0RGMD+ICRcjYJD8GlFOXhupQ=", "RKBnq");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[12]] = aq.lIIIllIllIIllll("CxE6", "NpNvv");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[13]] = aq.lIIIllIllIIllll("IAIfJxA3EQI7HnIBBDodaEcQKFk/Dg94HzsAAyFZIQ4FNhxyEA51ETMRDnULPQgGdFkbE0wmWSkaSyEQPgIYdRglBhJ5WTMJD3UJPApLPApyExk0FyEOHzwWPA4FMlc=", "RgkUy");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[14]] = aq.lIIIllIllIIllll("Bw46DQ==", "SoQhK");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[15]] = aq.lIIIllIllIIlllI("yo6H6n04JZ8XmJEw8kMPbUmgwsHSMKxxt1vKi3MPIY25O1Gzrv/kTJMGt82Hi82lq1isAz2omjE=", "InwEZ");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[16]] = aq.lIIIllIllIIllll("GgslLw==", "NjNJC");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[17]] = aq.lIIIllIllIIllll("DDgXIwc6Mw==", "HQdWr");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[19]] = aq.lIIIllIllIIllll("PwkDAz4bBAoNKx4=", "leffN");
        aq.lllIlllIIIIl[aq.lllIlllIIIlI[21]] = aq.lIIIllIllIIllll("FiUZ", "SDmdC");
    }
    ...
    private static void lIIIllIllIlIIlI() {
        ...
        aq.lllIlllIIIlI[0] = (3 + 79 - -42 + 16 ^ 89 + 13 - -54 + 28) & (96 + 55 - 125 + 148 ^ 139 + 152 - 203 + 66 ^ -" ".length());
        aq.lllIlllIIIlI[1] = " ".length();
        aq.lllIlllIIIlI[2] = -(0xFFFFCCDD & 0x7733) & (0xFFFFE7FD & 0x5D7F);
        aq.lllIlllIIIlI[3] = "  ".length();
        aq.lllIlllIIIlI[4] = "   ".length();
