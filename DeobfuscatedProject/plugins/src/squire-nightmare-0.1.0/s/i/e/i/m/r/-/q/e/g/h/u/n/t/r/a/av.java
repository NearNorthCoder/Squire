...
extends Enum<av> {
    ...
    private static void lIIIlllllIIIIll() {
        ...
        av.llllIIlIIllI[1] = " ".length();
        av.llllIIlIIllI[2] = "  ".length();
        av.llllIIlIIllI[3] = "   ".length();
    ...
    private static void lIIIlllllIIIIlI() {
        ...
        av.llllIIlIIlIl[av.llllIIlIIllI[0]] = av.lIIIllllIllllll("fzuXf5hiue4=", "YSOma");
        av.llllIIlIIlIl[av.llllIIlIIllI[1]] = av.lIIIllllIllllll("bw4m8dVyl5U=", "pcTfQ");
        av.llllIIlIIlIl[av.llllIIlIIllI[2]] = av.lIIIlllllIIIIII("LwoZIw==", "jKJwX");
        av.llllIIlIIlIl[av.llllIIlIIllI[3]] = av.lIIIlllllIIIIIl("YtrMr8AjiRs=", "nMpiq");
    }
