...
public class e {
    ...
    public static RectangularArea ay() {
        ...
        void var2_2;
        void var1_1;
        void lllllllllllllllIIllIIIlIllIIIlII;
        List<TileObject> list = j.aW();
        if (e.lIIIlllIIlIIlll(list.isEmpty() ? 1 : 0)) {
            return null;
        }
        int lllllllllllllllIIllIIIlIllIIIIll = lllIlllllIII[6];
        int lllllllllllllllIIllIIIlIllIIIIlI = lllIlllllIII[6];
        int lllllllllllllllIIllIIIlIllIIIIIl = Integer.MIN_VALUE;
        int lllllllllllllllIIllIIIlIllIIIIII = Integer.MIN_VALUE;
        Iterator lllllllllllllllIIllIIIlIlIllllll = lllllllllllllllIIllIIIlIllIIIlII.iterator();
        while (e.lIIIlllIIlIIlll(lllllllllllllllIIllIIIlIlIllllll.hasNext() ? 1 : 0)) {
            TileObject lllllllllllllllIIllIIIlIlIlllllI = (TileObject)lllllllllllllllIIllIIIlIlIllllll.next();
            lllllllllllllllIIllIIIlIllIIIIll = Math.min(lllllllllllllllIIllIIIlIllIIIIll, lllllllllllllllIIllIIIlIlIlllllI.getWorldLocation().getX());
            lllllllllllllllIIllIIIlIllIIIIlI = Math.min(lllllllllllllllIIllIIIlIllIIIIlI, lllllllllllllllIIllIIIlIlIlllllI.getWorldLocation().getY());
            lllllllllllllllIIllIIIlIllIIIIIl = Math.max(lllllllllllllllIIllIIIlIllIIIIIl, lllllllllllllllIIllIIIlIlIlllllI.getWorldLocation().getX());
            lllllllllllllllIIllIIIlIllIIIIII = Math.max(lllllllllllllllIIllIIIlIllIIIIII, lllllllllllllllIIllIIIlIlIlllllI.getWorldLocation().getY());
            "".length();
    ...
    public int hashCode() {
        ...
        if (e.lIIIlllIIlIllIl(worldArea)) {
            ...
            void lllllllllllllllIIllIIIlIlIlIllII;
            n2 = lllllllllllllllIIllIIIlIlIlIllII.hashCode();
        }
        n4 = n5 + n2;
        return n4;
    }
    ...
    public boolean equals(Object object) {
        block9: {
            block10: {
                WorldArea lllllllllllllllIIllIIIlIlIllIlII;
                WorldArea lllllllllllllllIIllIIIlIlIllIlIl;
                block8: {
                    e lllllllllllllllIIllIIIlIlIlllIII;
                    void lllllllllllllllIIllIIIlIlIllIlll;
                    if (e.lIIIlllIIlIlIIl(object, this)) {
                        return lllIlllllIII[4];
                    }
                    if (e.lIIIlllIIlIlIll(lllllllllllllllIIllIIIlIlIllIlll instanceof e)) {
                        return lllIlllllIII[2];
                    }
                    e lllllllllllllllIIllIIIlIlIllIllI = (e)lllllllllllllllIIllIIIlIlIllIlll;
                    if (e.lIIIlllIIlIlIll(lllllllllllllllIIllIIIlIlIllIllI.a(lllllllllllllllIIllIIIlIlIlllIII) ? 1 : 0)) {
                        return lllIlllllIII[2];
                    }
                    lllllllllllllllIIllIIIlIlIllIlIl = lllllllllllllllIIllIIIlIlIlllIII.az();
                    lllllllllllllllIIllIIIlIlIllIlII = lllllllllllllllIIllIIIlIlIllIllI.az();
                    if (!e.lIIIlllIIlIllIl(lllllllllllllllIIllIIIlIlIllIlIl)) break block8;
                    if (!e.lIIIlllIIlIlllI(lllllllllllllllIIllIIIlIlIllIlII)) break block9;
                    "".length();
                    if (null != null) {
                        return ((0x12 ^ 0xE) & ~(0xA0 ^ 0xBC)) != 0;
                    }
                    break block10;
                }
                if (!e.lIIIlllIIlIlIll(lllllllllllllllIIllIIIlIlIllIlIl.equals(lllllllllllllllIIllIIIlIlIllIlII) ? 1 : 0)) break block9;
            }
            return lllIlllllIII[2];
        }
        return lllIlllllIII[4];
