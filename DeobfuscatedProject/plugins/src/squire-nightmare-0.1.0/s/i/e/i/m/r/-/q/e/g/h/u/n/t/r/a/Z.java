...
extends C {
    ...
    @Override
    public boolean bY() {
        Z lllllllllllllllIIllIIlIIllllIllI;
        if (Z.lIIIllIlllIIIII(this.cK.useFireSpells() ? 1 : 0)) {
            return lllIlllIIlIl[0];
        }
        if (Z.lIIIllIlllIIIII(lllllllllllllllIIllIIlIIllllIllI.cM.av() ? 1 : 0)) {
            return lllIlllIIlIl[0];
        }
        EquipmentSetup lllllllllllllllIIllIIlIIllllIlIl = (EquipmentSetup)lllllllllllllllIIllIIlIIllllIllI.cK.totemGear().selected(EquipmentSetup.class);
        if (Z.lIIIllIlllIIIII(lllllllllllllllIIllIIlIIllllIlIl.isFullyEquipped() ? 1 : 0)) {
            lllllllllllllllIIllIIlIIllllIlIl.swap();
            return lllIlllIIlIl[1];
        }
        if (Z.lIIIllIlllIIIII(Magic.isAutoCasting() ? 1 : 0)) {
            Magic.autoCast((Spell)lllllllllllllllIIllIIlIIllllIllI.cK.fireSpell().bF());
            "".length();
            lllllllllllllllIIllIIlIIllllIllI.cM.t(lllIlllIIlIl[0]);
            return lllIlllIIlIl[1];
        }
        return lllIlllIIlIl[0];
    }
