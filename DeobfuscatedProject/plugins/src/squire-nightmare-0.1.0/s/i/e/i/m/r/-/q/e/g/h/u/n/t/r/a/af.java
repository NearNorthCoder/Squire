...
extends al {
    ...
    @Override
    public boolean cr() {
        af lllllllllllllllIIllIIIlIlllIlIlI;
        if (af.lIIIlllIIlIIIII(this.cK.assistantMode() ? 1 : 0)) {
            return lllIllllIllI[0];
        }
        if (af.lIIIlllIIlIIIIl(lllllllllllllllIIllIIIlIlllIlIlI.cs() ? 1 : 0)) {
            return lllIllllIllI[0];
        }
        if (af.lIIIlllIIlIIIlI(lllllllllllllllIIllIIIlIlllIlIlI.cS.getId(), lllIllllIllI[1])) {
            if (af.lIIIlllIIlIIIII(lllllllllllllllIIllIIIlIlllIlIlI.cu() ? 1 : 0)) {
                return lllllllllllllllIIllIIIlIlllIlIlI.x(lllllllllllllllIIllIIIlIlllIlIlI.cS);
            }
            return lllIllllIllI[0];
        }
        if (af.lIIIlllIIlIIIII(lllllllllllllllIIllIIIlIlllIlIlI.ct() ? 1 : 0)) {
            return lllllllllllllllIIllIIIlIlllIlIlI.x(lllllllllllllllIIllIIIlIlllIlIlI.cS);
        }
        return lllIllllIllI[0];
    }
    ...
    protected boolean cs() {
        boolean bl;
        af lllllllllllllllIIllIIIlIlllIIlll;
        NPC nPC = SquireNightmarePlugin.d();
        if (af.lIIIlllIIlIIIll(nPC)) {
            return lllIllllIllI[0];
        }
        if (af.lIIIlllIIlIIIIl(lllllllllllllllIIllIIIlIlllIIlll.cu() ? 1 : 0)) {
            return lllIllllIllI[0];
        }
        if (af.lIIIlllIIlIIIII(lllllllllllllllIIllIIIlIlllIIlll.cw() ? 1 : 0)) {
            return lllIllllIllI[0];
        }
        if (af.lIIIlllIIlIIIII(lllllllllllllllIIllIIIlIlllIIlll.cx() ? 1 : 0)) {
            return lllIllllIllI[0];
        }
        if (af.lIIIlllIIlIIlII(lllllllllllllllIIllIIIlIlllIIlll.cM.at())) {
            return lllIllllIllI[0];
        }
        if (af.lIIIlllIIlIIIIl(lllllllllllllllIIllIIIlIlllIIlll.cM.aq() ? 1 : 0)) {
            bl = lllIllllIllI[2];
            "".length();
            if (" ".length() == ((0x33 ^ 0x72) & ~(0x5D ^ 0x1C))) {
