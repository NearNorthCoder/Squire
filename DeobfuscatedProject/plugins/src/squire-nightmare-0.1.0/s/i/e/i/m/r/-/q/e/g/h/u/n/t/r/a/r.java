...
extends Enum<r> {
    ...
    private static String lIIIllIlllllIIl(String lllllllllllllllIIllIIIlllllllIll, String lllllllllllllllIIllIIIlllllllIlI) {
        lllllllllllllllIIllIIIlllllllIll = new String(Base64.getDecoder().decode(lllllllllllllllIIllIIIlllllllIll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIllIIIlllllllllI = new StringBuilder();
        char[] lllllllllllllllIIllIIIllllllllIl = lllllllllllllllIIllIIIlllllllIlI.toCharArray();
        int lllllllllllllllIIllIIIllllllllII = lllIllllIIII[0];
        char[] lllllllllllllllIIllIIIllllllIllI = lllllllllllllllIIllIIIlllllllIll.toCharArray();
        int lllllllllllllllIIllIIIllllllIlIl = lllllllllllllllIIllIIIllllllIllI.length;
        int lllllllllllllllIIllIIIllllllIlII = lllIllllIIII[0];
        while (r.lIIIlllIIIIllIl(lllllllllllllllIIllIIIllllllIlII, lllllllllllllllIIllIIIllllllIlIl)) {
            char lllllllllllllllIIllIIlIIIIIIIIIl = lllllllllllllllIIllIIIllllllIllI[lllllllllllllllIIllIIIllllllIlII];
            lllllllllllllllIIllIIIlllllllllI.append((char)(lllllllllllllllIIllIIlIIIIIIIIIl ^ lllllllllllllllIIllIIIllllllllIl[lllllllllllllllIIllIIIllllllllII % lllllllllllllllIIllIIIllllllllIl.length]));
            "".length();
            ++lllllllllllllllIIllIIIllllllllII;
            ++lllllllllllllllIIllIIIllllllIlII;
            "".length();
            if ((0x7F ^ 0x7B) > "   ".length()) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllIIllIIIlllllllllI);
    }

    private static void lIIIlllIIIIlIIl() {
        lllIllllIIII = new int[31];
        r.lllIllllIIII[0] = (0x6A ^ 0x73 ^ (0x69 ^ 0x36)) & (103 + 127 - 112 + 128 ^ 37 + 36 - -19 + 84 ^ -" ".length());
        r.lllIllllIIII[1] = 0x34 ^ 1 ^ (0x1E ^ 0x2F);
        r.lllIllllIIII[2] = " ".length();
        r.lllIllllIIII[3] = "  ".length();
        r.lllIllllIIII[4] = "   ".length();
    ...
    private static String lIIIllIllllIlll(String lllllllllllllllIIllIIIlllllIlIIl, String lllllllllllllllIIllIIIlllllIlIII) {
        try {
            SecretKeySpec lllllllllllllllIIllIIIlllllIlllI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIllIIIlllllIlIII.getBytes(StandardCharsets.UTF_8)), lllIllllIIII[8]), "DES");
            Cipher lllllllllllllllIIllIIIlllllIllIl = Cipher.getInstance("DES");
            lllllllllllllllIIllIIIlllllIllIl.init(lllIllllIIII[3], lllllllllllllllIIllIIIlllllIlllI);
            return new String(lllllllllllllllIIllIIIlllllIllIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIIllIIIlllllIlIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
        catch (Exception lllllllllllllllIIllIIIlllllIllII) {
            lllllllllllllllIIllIIIlllllIllII.printStackTrace();
            return null;
        }
    }
    ...
    private static void lIIIlllIIIIlIII() {
        ...
        r.lllIlllIllIl[r.lllIllllIIII[0]] = r.lIIIllIllllIlll("cATCEGXYLgE=", "QAXuX");
        r.lllIlllIllIl[r.lllIllllIIII[2]] = r.lIIIllIlllllIII("UdUaCAa/fec=", "nUvpt");
        r.lllIlllIllIl[r.lllIllllIIII[3]] = r.lIIIllIlllllIII("Oeg+4UmwYIVcAIzUbDHz/w==", "MOGEQ");
        r.lllIlllIllIl[r.lllIllllIIII[4]] = r.lIIIllIllllIlll("gSbrsVJGYjc=", "ntutd");
        r.lllIlllIllIl[r.lllIllllIIII[1]] = r.lIIIllIlllllIIl("KRsiLw==", "jWcxX");
        r.lllIlllIllIl[r.lllIllllIIII[5]] = r.lIIIllIlllllIII("ngiEffvRPkD884e2XpX4TA==", "Ckupz");
        r.lllIlllIllIl[r.lllIllllIIII[6]] = r.lIIIllIlllllIII("MolJ2u7F2Zn25zol02iWVw==", "sxCYf");
        r.lllIlllIllIl[r.lllIllllIIII[7]] = r.lIIIllIlllllIII("T3yWtj/zPOAsIPWRtl5iBA==", "HepaI");
        r.lllIlllIllIl[r.lllIllllIIII[8]] = r.lIIIllIlllllIII("4XJoAHkP+jc=", "hhoiW");
        r.lllIlllIllIl[r.lllIllllIIII[9]] = r.lIIIllIlllllIII("TgosEybQsmBB2wTl0XUWkQ==", "afISw");
        r.lllIlllIllIl[r.lllIllllIIII[10]] = r.lIIIllIlllllIIl("LjkkPSo7IC8nJiU9PC0wPg==", "znkbb");
        r.lllIlllIllIl[r.lllIllllIIII[11]] = r.lIIIllIlllllIII("84goNZ10Rxo=", "vhZxg");
        r.lllIlllIllIl[r.lllIllllIIII[12]] = r.lIIIllIlllllIIl("BA8UCjweCg==", "LNXHy");
        r.lllIlllIllIl[r.lllIllllIIII[13]] = r.lIIIllIllllIlll("fZoFVNorqPG9E8+mQ55KjA==", "jaAdI");
        r.lllIlllIllIl[r.lllIllllIIII[14]] = r.lIIIllIlllllIIl("IhkrBjk0", "qZrRq");
        r.lllIlllIllIl[r.lllIllllIIII[15]] = r.lIIIllIlllllIII("3K61sDOWIUA=", "yYCmN");
        r.lllIlllIllIl[r.lllIllllIIII[16]] = r.lIIIllIllllIlll("6lWAxajZzR3IhHVTk4eHWA==", "vETWu");
        r.lllIlllIllIl[r.lllIllllIIII[17]] = r.lIIIllIlllllIIl("NC0NGA8uNwsFHjA2Hh4=", "gyLZM");
        r.lllIlllIllIl[r.lllIllllIIII[18]] = r.lIIIllIlllllIII("wK2b7qtRSho=", "lFolz");
        r.lllIlllIllIl[r.lllIllllIIII[19]] = r.lIIIllIllllIlll("MOsXKi8Am8ZtyKdCI4LoFw==", "qwfDc");
        r.lllIlllIllIl[r.lllIllllIIII[20]] = r.lIIIllIlllllIIl("IwUTMw==", "tMZcq");
        r.lllIlllIllIl[r.lllIllllIIII[21]] = r.lIIIllIlllllIIl("ODw1BjU+LycWMTw2", "zptBp");
        r.lllIlllIllIl[r.lllIllllIIII[22]] = r.lIIIllIlllllIIl("DRQ6ARVrfw==", "YMjDJ");
        r.lllIlllIllIl[r.lllIllllIIII[23]] = r.lIIIllIllllIlll("Kq9p/ZmxSPZIZ6TaVykRLQ==", "roAVC");
        r.lllIlllIllIl[r.lllIllllIIII[24]] = r.lIIIllIlllllIIl("Pw0BIS5ZYA==", "kTQdq");
        r.lllIlllIllIl[r.lllIllllIIII[25]] = r.lIIIllIlllllIIl("PykWNClZRQ==", "kpFqv");
        r.lllIlllIllIl[r.lllIllllIIII[26]] = r.lIIIllIlllllIII("2eDqBD1wgvaFCAM6y4E1WnJ9cNqJmnsy", "UQXta");
        r.lllIlllIllIl[r.lllIllllIIII[27]] = r.lIIIllIllllIlll("7SOyIDyt8q0=", "ACsps");
        r.lllIlllIllIl[r.lllIllllIIII[28]] = r.lIIIllIlllllIIl("OQEYMjNfYA==", "mXHwl");
        r.lllIlllIllIl[r.lllIllllIIII[29]] = r.lIIIllIlllllIII("V67Rrbes2bA=", "WyuDE");
    }
    ...
    private static String lIIIllIlllllIII(String lllllllllllllllIIllIIIllllIlllII, String lllllllllllllllIIllIIIllllIlllIl) {
        try {
            SecretKeySpec lllllllllllllllIIllIIIlllllIIIIl = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIllIIIllllIlllIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            return new String(lllllllllllllllIIllIIIlllllIIIII.doFinal(Base64.getDecoder().decode(lllllllllllllllIIllIIIllllIlllII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
