...
extends C {
    ...
    private static String lIIlIIIIIIlIlII(String lllllllllllllllIIlIlllIIIIIIIllI, String lllllllllllllllIIlIlllIIIIIIIlll) {
        try {
            ...
            Cipher lllllllllllllllIIlIlllIIIIIIlIlI = Cipher.getInstance("DES");
            lllllllllllllllIIlIlllIIIIIIlIlI.init(llllIIllllIl[1], lllllllllllllllIIlIlllIIIIIIlIll);
            return new String(lllllllllllllllIIlIlllIIIIIIlIlI.doFinal(Base64.getDecoder().decode(lllllllllllllllIIlIlllIIIIIIIllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIIlIIIIIIlIlIl() {
        ...
        as.llllIIllllII[as.llllIIllllIl[0]] = as.lIIlIIIIIIlIlII("jTFyiDbcvh3Eh1dhgCJY/w==", "tmJyl");
    }
    ...
    private static void lIIlIIIIIIlIllI() {
        ...
        as.llllIIllllIl[0] = (1 + 82 - 49 + 144 ^ 102 + 6 - -18 + 24) & (60 + 97 - 79 + 69 ^ 102 + 86 - 82 + 77 ^ -" ".length());
        as.llllIIllllIl[1] = "  ".length();
        as.llllIIllllIl[2] = 0xFFFFF9F4 & 0x56FF;
        as.llllIIllllIl[3] = " ".length();
        as.llllIIllllIl[4] = -" ".length() & (0xFFFFEFFB & 0x7BFD);
    ...
    public boolean bY() {
        ...
        Item lllllllllllllllIIlIlllIIIIIlIIIl = Inventory.getFirst((int[])nArray);
        if (as.lIIlIIIIIIllIIl(lllllllllllllllIIlIlllIIIIIlIIIl)) {
            return llllIIllllIl[0];
        }
        int lllllllllllllllIIlIlllIIIIIlIIII = Vars.getBit((int)llllIIllllIl[5]);
        if (as.lIIlIIIIIIllIlI(lllllllllllllllIIlIlllIIIIIlIIII)) {
            return llllIIllllIl[0];
        }
