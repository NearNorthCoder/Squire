...
extends Y {
    ...
    private static void lIIlIIIlIlIlIlI() {
        ...
        W.llllIllIIIlI[W.llllIllIIIll[0]] = W.lIIlIIIlIlIIlll("TLpOYQTnWTC2xtms1SB9R2WaZUpHQWXrzC3SC3NqdpVz05XnrDXVaw==", "zuGuY");
        W.llllIllIIIlI[W.llllIllIIIll[1]] = W.lIIlIIIlIlIlIII("KCEOHxwIOg==", "kNbsy");
        W.llllIllIIIlI[W.llllIllIIIll[4]] = W.lIIlIIIlIlIlIII("PRYGMTMucgA/KyoXACQuKRweUAkJci4VCwM3YxcCByBjAwIKNyAEAgJ+YxMGCDwsBEcFPS8cAgUmYxkTAz8wUQ==", "fRCpg");
        W.llllIllIIIlI[W.llllIllIIIll[5]] = W.lIIlIIIlIlIIlll("JOuHAAiGICh41kcU/U3rrEwHaykmMmBeVMVlf0vCKc1n9lsf7l6Fjw==", "bcDPQ");
        W.llllIllIIIlI[W.llllIllIIIll[6]] = W.lIIlIIIlIlIlIIl("isoJrmAl87c=", "KIasv");
        W.llllIllIIIlI[W.llllIllIIIll[7]] = W.lIIlIIIlIlIlIII("DyUvJyY8YSkpPjgkKTI7Oy8XKj07NWolPTgtLyUmPS4kZiU9JS0jJnQ1Lz4mdHxqPS8=", "TAJFR");
        W.llllIllIIIlI[W.llllIllIIIll[8]] = W.lIIlIIIlIlIlIII("LjI8OAwddjo2FBkzOi0RGjgENRcaInk6Fxk6PDoMHDk3eQ8cMj48DFU6MDcdBnZkeQMI", "uVYYx");
        W.llllIllIIIlI[W.llllIllIIIll[9]] = W.lIIlIIIlIlIIlll("FPyMqtERsdM=", "wIhEn");
        W.llllIllIIIlI[W.llllIllIIIll[10]] = W.lIIlIIIlIlIlIII("HTQhFTUOUCcbLQo1JwAoCT45dAcvHg0nCSMURDcOKhwBNxUvHwp0CDIVCSdPaF4QJgghFwEmBCJQBi1BeEBY", "FpdTa");
        W.llllIllIIIlI[W.llllIllIIIll[11]] = W.lIIlIIIlIlIlIIl("eqr3OP6qkq9TVEH0IvFUypHdMbsWVzHoYW2nzTaerkDIU8Z60apUakyDA2oKtrGb/AZ5nSZoQbs=", "QwBgf");
        W.llllIllIIIlI[W.llllIllIIIll[12]] = W.lIIlIIIlIlIIlll("gSDXLTXMkDo=", "wmFAt");
        W.llllIllIIIlI[W.llllIllIIIll[13]] = W.lIIlIIIlIlIlIII("EyU9Chct", "FKQet");
        W.llllIllIIIlI[W.llllIllIIIll[14]] = W.lIIlIIIlIlIlIIl("P7+d1TwLpkZXzJAk1QNMtw==", "kCRko");
        W.llllIllIIIlI[W.llllIllIIIll[15]] = W.lIIlIIIlIlIlIII("LRgbUQNpHxQAEmkWGw8DIR4bEVcvGAdWDiYC", "Iwuvw");
        W.llllIllIIIlI[W.llllIllIIIll[16]] = W.lIIlIIIlIlIlIII("LDYkGzw/UiIVJDs3Ig4hODw8ekAYHDYzDBAXFRIBExYENCsfEw89DRNbQTwBGRsSMg0TUgI1BBsXAi4BGBxBMxwSHxJ0Rlk=", "wraZh");
        W.llllIllIIIlI[W.llllIllIIIll[19]] = W.lIIlIIIlIlIlIIl("u3zWR51hZYSLoakZdMBqnw==", "wAjLM");
        W.llllIllIIIlI[W.llllIllIIIll[20]] = W.lIIlIIIlIlIIlll("tbnAES8QR0w=", "MiGxR");
        W.llllIllIIIlI[W.llllIllIIIll[21]] = W.lIIlIIIlIlIlIII("CyYDUSQGMwIYMxUiFFElDCoVUTkFZwkeIxFnGQUzDjQ=", "cGpqV");
        W.llllIllIIIlI[W.llllIllIIIll[22]] = W.lIIlIIIlIlIlIIl("4vPdKqMGdx9q++kuNZmxGKOj+KVMsPmE", "rdVUI");
        W.llllIllIIIlI[W.llllIllIIIll[23]] = W.lIIlIIIlIlIIlll("amEOGOspjPyJrt3+lGwBjZa/c/7lNSHKaOalr0Ak50uMaGrKbIziqA==", "mIwaR");
        W.llllIllIIIlI[W.llllIllIIIll[24]] = W.lIIlIIIlIlIlIIl("EjhKSIeSDyo=", "IkudZ");
        W.llllIllIIIlI[W.llllIllIIIll[25]] = W.lIIlIIIlIlIlIIl("PcZaGAUXadE=", "GsAGk");
        W.llllIllIIIlI[W.llllIllIIIll[26]] = W.lIIlIIIlIlIIlll("Mk3lDAOXW8M=", "SrhJs");
    }
        ...
        NPC lllllllllllllllIIlIllIIIlIIIllIl = NPCs.getNearest(nPC -> {
            ...
            if (W.lIIlIIIlIlIllII(nPC.getName().contains(llllIllIIIlI[llllIllIIIll[25]]) ? 1 : 0)) {
                ...
                if (W.lIIlIIIlIlIllII(nPC.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0xD3 ^ 0xA8 ^ (0x4D ^ 0x19)) & (35 + 59 - -56 + 28 ^ 99 + 18 - -8 + 32 ^ -" ".length())) != 0;
                }
            }
            n2 = llllIllIIIll[0];
            return n2 != 0;
