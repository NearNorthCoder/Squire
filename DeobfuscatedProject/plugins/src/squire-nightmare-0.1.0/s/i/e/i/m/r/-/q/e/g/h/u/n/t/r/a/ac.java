...
extends Task {
    ...
    static {
        ac.lIIIllIlIIllIlI();
        dH = LoggerFactory.getLogger(ac.class);
    }
    ...
    public boolean run() {
        ...
        NPC lllllllllllllllIIllIIlllIIIIIIll = SquireNightmarePlugin.d();
        if (ac.lIIIllIlIIlllII(lllllllllllllllIIllIIlllIIIIIIll)) {
            return lllIllIlIlII[0];
        }
        int[] nArray = new int[lllIllIlIlII[1]];
        nArray[ac.lllIllIlIlII[0]] = lllIllIlIlII[2];
        List lllllllllllllllIIllIIlllIIIIIIlI = Inventory.getAll((int[])nArray);
        if (ac.lIIIllIlIIlllIl(lllllllllllllllIIllIIlllIIIIIIlI.isEmpty() ? 1 : 0)) {
            return lllIllIlIlII[0];
        }
