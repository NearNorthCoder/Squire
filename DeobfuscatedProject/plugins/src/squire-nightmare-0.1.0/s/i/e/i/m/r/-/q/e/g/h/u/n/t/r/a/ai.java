...
extends al {
    ...
    private static void lIIIlllIlIllllI() {
        ...
        ai.llllIIIIlIll[0] = (5 ^ 0x5E ^ (0x3F ^ 0x47)) & (139 + 180 - 284 + 147 ^ 71 + 61 - 31 + 48 ^ -" ".length());
        ai.llllIIIIlIll[1] = -(0xFFFFF4ED & 0x5F7F) & (0xFFFFFFFF & 0x7FFE);
        ai.llllIIIIlIll[2] = " ".length();
        ai.llllIIIIlIll[3] = "  ".length();
    ...
    private static void lIIIlllIIlllllI() {
        ...
        ai.lllIllllllll[ai.llllIIIIlIll[0]] = ai.lIIIlllIIllllII("Iw4BNwAJ", "bzuVc");
        ai.lllIllllllll[ai.llllIIIIlIll[2]] = ai.lIIIlllIIllllII("FS0xKxwRIDglCRQ=", "fATNl");
        ai.lllIllllllll[ai.llllIIIIlIll[3]] = ai.lIIIlllIIllllIl("XcVBMTQVPtm9furyw6eFUA==", "jryif");
    }
