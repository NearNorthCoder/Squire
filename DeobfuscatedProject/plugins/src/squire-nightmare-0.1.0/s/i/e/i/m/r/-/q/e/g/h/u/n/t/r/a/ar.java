...
extends Task {
    ...
    public boolean run() {
        ...
        Item lllllllllllllllIIlIlllIlIlIIIIll = Inventory.getFirst(item -> {
            ...
            if (!ar.lIIIllllllIllIl(string.contains(llllIIlIlllI[llllIIllIIII[2]]) ? 1 : 0) || !ar.lIIIllllllIllIl(string.contains(llllIIlIlllI[llllIIllIIII[3]]) ? 1 : 0) || ar.lIIIllllllIlllI(string.contains(llllIIlIlllI[llllIIllIIII[1]]) ? 1 : 0)) {
                ...
                "".length();
                if ("  ".length() == 0) {
                    return ((0x42 ^ 0x46 ^ (4 ^ 0xF)) & (0xFD ^ 0xBA ^ (0x76 ^ 0x3E) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llllIIllIIII[0];
            }
    ...
    private static void lIIIllllllIlIlI() {
        ...
        ar.llllIIlIlllI[ar.llllIIllIIII[0]] = ar.lIIIllllllIIlIl("UhRiaBjnlcc=", "nLDZg");
        ar.llllIIlIlllI[ar.llllIIllIIII[2]] = ar.lIIIllllllIIlll("wQFzM0yzbmI=", "QvjId");
        ar.llllIIlIlllI[ar.llllIIllIIII[3]] = ar.lIIIllllllIIlIl("M7sXonMqW1k=", "HAjNS");
        ar.llllIIlIlllI[ar.llllIIllIIII[1]] = ar.lIIIllllllIIlll("YTvEj8PxbMU=", "PGsaa");
    }
    ...
    private static void lIIIllllllIlIll() {
        ...
        ar.llllIIllIIII[0] = (0x6A ^ 0x4A ^ (0xD2 ^ 0xBA)) & (63 + 32 - -39 + 68 ^ 23 + 94 - 56 + 69 ^ -" ".length());
        ar.llllIIllIIII[1] = "   ".length();
        ar.llllIIllIIII[2] = " ".length();
        ar.llllIIllIIII[3] = "  ".length();
