...
extends N {
    ...
    private static void lIIlIIIIIlIIIII() {
        ...
        K.llllIlIIIIII[2] = "   ".length();
        K.llllIlIIIIII[3] = (0x8F ^ 0x84) & ~(0x5E ^ 0x55);
        K.llllIlIIIIII[4] = "  ".length();
        K.llllIlIIIIII[5] = " ".length();
    ...
    private static void lIIlIIIIIIllllI() {
        ...
        K.llllIIllllll[K.llllIlIIIIII[3]] = K.lIIlIIIIIIlllIl("yjYKOT09B8bQNnOWsyqYgF2dyUzDb9qMNLGOELYRBAvBhvbOFDIH8niggrKdziMm", "lFOTF");
    }
