...
extends D {
    ...
    protected boolean cm() {
        return Inventory.getAll().stream().noneMatch(item -> {
            ...
            if (S.lIIIllIllllIllI(item.isNoted() ? 1 : 0)) {
                ...
                "".length();
                if (-" ".length() > 0) {
                    return ((29 + 160 - 86 + 117 ^ 89 + 50 - 106 + 118) & (0x7F ^ 0x21 ^ (0x3C ^ 0x29) ^ -" ".length())) != 0;
                }
            } else {
                Item lllllllllllllllIIllIIlIIIllllIll;
                n2 = lllllllllllllllIIllIIlIIIllllIll.getId();
            }
    ...
    @Override
    public boolean bY() {
        S lllllllllllllllIIllIIlIIIllllllI;
        if (S.lIIIllIllllIlIl(this.cV.enableRestocking() ? 1 : 0)) {
            return lllIlllIllII[0];
        }
        if (S.lIIIllIllllIlIl(lllllllllllllllIIllIIlIIIllllllI.cW.ae() ? 1 : 0)) {
            return lllIlllIllII[0];
        }
        Player lllllllllllllllIIllIIlIIIlllllIl = Players.getLocal();
        if (S.lIIIllIllllIlII(lllllllllllllllIIllIIlIIIlllllIl)) {
            return lllIlllIllII[0];
        }
        return this.ci();
    }
