...
extends C {
    ...
    private static void lIIlIIIIIlllIII() {
        ...
        A.llllIlIIIlll[0] = (0x7C ^ 0x56 ^ (0x69 ^ 0x20)) & (115 + 65 - -2 + 33 ^ 45 + 34 - -89 + 12 ^ -" ".length());
        A.llllIlIIIlll[1] = " ".length();
        A.llllIlIIIlll[2] = "  ".length();
    ...
    private static void lIIlIIIIIllIllI() {
        ...
        A.llllIlIIIlII[A.llllIlIIIlll[0]] = A.lIIlIIIIIllIlII("EP4L4K7gTARtqqVy4TXgDfno2YbP2H0BKJ/A2sIG0UKHc7DWdfnALc/ThlpiD7I3ZN+dTgbz5Ss=", "djjdf");
        A.llllIlIIIlII[A.llllIlIIIlll[1]] = A.lIIlIIIIIllIlIl("NLtFvLUIov5b6V62O7cFkD802ryScuwBb0of7MlhBIy3IWbU2wLye5whSwBUqpP5RnCY9GcF626NHwicjsxxStidjlo4T6Qo0qULxvQiQ1m0uWKtZy8GQw==", "wdEEz");
    }
