...
extends A {
    ...
    private static void lIIlIIIlllIIllI() {
        ...
        aw.llllIlllIIII[1] = "   ".length();
        aw.llllIlllIIII[2] = " ".length();
        aw.llllIlllIIII[3] = "  ".length();
    }
        ...
        if (aw.lIIlIIIlllIlIII(lllllllllllllllIIlIlIllIlIIlllll.bZ() ? 1 : 0)) {
            ...
            lllllllllllllllIIlIlIllIlIIllIIl = stream.filter(arg_0 -> ((RectangularArea)v1).contains(arg_0)).filter(worldPoint -> {
                ...
                if (aw.lIIlIIIlllIlIlI(lllllllllllllllIIlIlIllIlIIllIlI.getWorldArea().contains(worldPoint.getWorldLocation()) ? 1 : 0)) {
                    ...
                    "".length();
                    if ("  ".length() <= " ".length()) {
                        return ((29 + 41 - 34 + 197 ^ 187 + 94 - 108 + 21) & (0xB5 ^ 0xAA ^ (0x7F ^ 0x4B) ^ -" ".length())) != 0;
                    }
                } else {
                    bl = llllIlllIIII[0];
                }
    ...
    private static void lIIlIIIlllIIlIl() {
        ...
        aw.llllIllIlllI[aw.llllIlllIIII[0]] = aw.lIIlIIIllIlllll("vJgu9MNxXDZUSWSQZ3uMrmNkQZtvlL5dtJf5fRJtKznFM3UQMFPkiiC2SuvuK8aR9ZMIInfKDYh7u1iktFwi1iRhMX1x+sojkWQBJQ8aZulWaVRA9e3/1A==", "xrDrj");
    }
