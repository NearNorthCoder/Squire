...
extends C {
    ...
    private static void lIIlIIIIllIIlIl() {
        ...
        ap.llllIlIlIIII[0] = (4 ^ 0x78 ^ (0x63 ^ 0x25)) & (89 + 54 - -32 + 14 ^ 42 + 113 - 41 + 21 ^ -" ".length());
        ap.llllIlIlIIII[1] = " ".length();
        ap.llllIlIlIIII[2] = "   ".length();
        ap.llllIlIlIIII[3] = "  ".length();
    ...
    private static void lIIlIIIIlIlIlIl() {
        ...
        ap.llllIlIIllII[ap.llllIlIlIIII[0]] = ap.lIIlIIIIlIIllIl("MNKJkTKpztg=", "HTVbf");
        ap.llllIlIIllII[ap.llllIlIlIIII[1]] = ap.lIIlIIIIlIlIIIl("T+rWIUUwsKY=", "uPicB");
        ap.llllIlIIllII[ap.llllIlIlIIII[3]] = ap.lIIlIIIIlIlIIIl("Hu//aztyvhs=", "JBbJr");
        ap.llllIlIIllII[ap.llllIlIlIIII[2]] = ap.lIIlIIIIlIlIIll("GCc6JydLMz42NAg5", "kRJBU");
        ap.llllIlIIllII[ap.llllIlIlIIII[7]] = ap.lIIlIIIIlIlIIll("EA81ERNDGzEAAAAR", "czEta");
        ap.llllIlIIllII[ap.llllIlIlIIII[4]] = ap.lIIlIIIIlIlIIIl("VBP6wS6XdtKXobSUDV2leg==", "aaMvQ");
        ap.llllIlIIllII[ap.llllIlIlIIII[8]] = ap.lIIlIIIIlIlIIll("BDknCwBXPyMcFxkrIwY=", "wLWnr");
    }
        ...
        Item lllllllllllllllIIlIllIlIIlIllllI = Inventory.getFirst(item -> {
            ...
            if (!ap.lIIlIIIIllIIllI(item.getName().toLowerCase().contains(llllIlIIllII[llllIlIlIIII[4]]) ? 1 : 0) || ap.lIIlIIIIllIIlll(item.getName().toLowerCase().contains(llllIlIIllII[llllIlIlIIII[8]]) ? 1 : 0)) {
                ...
                if ((49 + 4 - 34 + 132 ^ 94 + 50 - 99 + 101) <= 0) {
                    return ((0xD3 ^ 0x9A ^ (0x6A ^ 0x73)) & (0xE4 ^ 0x83 ^ (0xB0 ^ 0x87) ^ -" ".length())) != 0;
                }
            } else {
                bl = llllIlIlIIII[0];
            }
