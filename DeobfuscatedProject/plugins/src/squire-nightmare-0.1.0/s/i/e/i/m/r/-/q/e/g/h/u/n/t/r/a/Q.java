...
extends S {
    ...
    private static void lIIlIIIlIIIllIl() {
        ...
        Q.llllIlIlllII[1] = " ".length();
        Q.llllIlIlllII[2] = -(0xFFFFBD77 & 0x6A9D) & (0xFFFFAFF7 & 0x7BFF);
        Q.llllIlIlllII[3] = "  ".length();
        Q.llllIlIlllII[4] = "   ".length();
    ...
    private static void lIIlIIIlIIIllII() {
        ...
        Q.llllIlIllIll[Q.llllIlIlllII[0]] = Q.lIIlIIIlIIIlIll("HAA4PiQiNR4yGjcuJCIZGnhtCQVnISIuBDRiJClKLiw7IgQzLT8+RmchISgZLiwqZy0CbA==", "GBMGj");
        Q.llllIlIllIll[Q.llllIlIlllII[1]] = Q.lIIlIIIlIIIlIll("OS15ACMSLypJIxhiOxwuW2I2G3cZLXkbMhQqOBswEmI4BDgCLC1JJBI2dUkkAy0pGT4ZJXkbMgQ2Ngo8Hiw+", "wBYiW");
        Q.llllIlIllIll[Q.llllIlIlllII[3]] = Q.lIIlIIIlIIIlIll("OAU0LAMGMBIgPRMrKDA+Pn1hAihDLyAjKEMmLTltDCFhISUGZzMwPBYuMzApQy41MCAQa2EmOQw3MTwjBGczMD4XKCI+JA0gbw==", "cGAUM");
        Q.llllIlIllIll[Q.llllIlIlllII[4]] = Q.lIIlIIIlIIIlIll("DQE9IAkzNBssNyYvITw0C3loDiJ2KykvInY4NXkkOSomKmc0Njx5KTMmLHk8K2M8Nmc0NjF5PCtjJz9nLT4=", "VCHYG");
    }
    ...
    public boolean ci() {
        ...
        while (Q.lIIlIIIlIIIllll(lllllllllllllllIIlIllIIlIIIlllII.hasNext() ? 1 : 0)) {
            ...
            if (Q.lIIlIIIlIIIlllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                ...
                return ((0x76 ^ 0x3A ^ (0x40 ^ 0xA)) & (109 + 21 - 0 + 2 ^ 49 + 128 - 90 + 43 ^ -" ".length())) != 0;
            }
