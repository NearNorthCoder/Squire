...
extends Task {
    ...
    private static void lIIIllIlllIlllI() {
        ...
        P.lllIlllIlIIl[P.lllIlllIlIlI[0]] = P.lIIIllIlllIllIl("bz3LY/P6hwo=", "NLMWi");
    }
    ...
    private static void lIIIllIlllIllll() {
        ...
        P.lllIlllIlIlI[0] = (98 + 91 - 162 + 115 ^ 147 + 79 - 220 + 173) & (0xC ^ 0x5F ^ (0x20 ^ 0x4E) ^ -" ".length());
        P.lllIlllIlIlI[1] = " ".length();
        P.lllIlllIlIlI[2] = 0x44 ^ 0x4C;
        P.lllIlllIlIlI[3] = "  ".length();
    }

    private static String lIIIllIlllIllIl(String lllllllllllllllIIllIIlIIlIIIlllI, String lllllllllllllllIIllIIlIIlIIIllll) {
        try {
            SecretKeySpec lllllllllllllllIIllIIlIIlIIlIIll = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIllIIlIIlIIIllll.getBytes(StandardCharsets.UTF_8)), lllIlllIlIlI[2]), "DES");
            Cipher lllllllllllllllIIllIIlIIlIIlIIlI = Cipher.getInstance("DES");
            lllllllllllllllIIllIIlIIlIIlIIlI.init(lllIlllIlIlI[3], lllllllllllllllIIllIIlIIlIIlIIll);
            return new String(lllllllllllllllIIllIIlIIlIIlIIlI.doFinal(Base64.getDecoder().decode(lllllllllllllllIIllIIlIIlIIIlllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
