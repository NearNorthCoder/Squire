...
extends af {
    ...
    public boolean cC() {
        ...
        if (an.lIIIlllIIIIIIlI(lllllllllllllllIIllIIlIIIlIllllI.cM.Q(), lllIlllIllll[6])) {
            ...
            "".length();
            if (null != null) {
                return ((0x33 ^ 0x45 ^ (0x25 ^ 0x30)) & (0xA7 ^ 0xB2 ^ (4 ^ 0x72) ^ -" ".length())) != 0;
            }
        } else {
    ...
    private static void lIIIllIllllllIl() {
        ...
        an.lllIlllIlllI[an.lllIlllIllll[0]] = an.lIIIllIlllllIlI("Dgg6chwyEzoiTy4IOiBPJBcqMU8gAi4iADlHPDcbIhdvJQYjD28zTyACLiIAOUc7Og4jRyczHHcJIHIcJwIsc052", "WgORo");
        an.lllIlllIlllI[an.lllIlllIllll[3]] = an.lIIIllIlllllIlI("ByYmAy9EJzwbawEoJ08tCyY3Tz8LaTUdLgFpJh9rFzkyDC5ELzwdaxc5NgxrFz4yH3Rb", "dISoK");
        an.lllIlllIlllI[an.lllIlllIllll[4]] = an.lIIIllIlllllIll("RYer7sThQypjKyxr7xUFrjc8bwQG41dpOveoP6RMf/cmEm+BxkqBMUSEavN3gQM5/hTs0f5Ih8X4a2jng0/z5UYZq0uVbVsobkd/MBpvmXey5nEQM9gLadZBMVaDtdJPiOpyzVzJQyE8r2exRGwRqw==", "oCciw");
        an.lllIlllIlllI[an.lllIlllIllll[5]] = an.lIIIllIlllllIlI("BTMEPwA=", "AAmQk");
        an.lllIlllIlllI[an.lllIlllIllll[6]] = an.lIIIllIlllllIll("qGHZC+ZBA3G1NRvWsBNeNYaA0leGfOX6KhN0rijAIW+iLmpRfQI56Glg8PEkc/mEFRFLEbFQX4o=", "gNkMc");
        an.lllIlllIlllI[an.lllIlllIllll[7]] = an.lIIIllIllllllII("JpcjrBW9S2Y=", "zkuiu");
        an.lllIlllIlllI[an.lllIlllIllll[8]] = an.lIIIllIlllllIlI("Nh0lJDYc", "wiQEU");
        an.lllIlllIlllI[an.lllIlllIllll[11]] = an.lIIIllIlllllIll("lqlkdkr/nAJwk7SCDKUYDQ==", "RXatf");
        an.lllIlllIlllI[an.lllIlllIllll[12]] = an.lIIIllIlllllIll("Pby945kyX3A=", "TlOXb");
        an.lllIlllIlllI[an.lllIlllIllll[13]] = an.lIIIllIlllllIlI("ODcgDw==", "ZEExS");
        an.lllIlllIlllI[an.lllIlllIllll[9]] = an.lIIIllIllllllII("jqsCPwyVMgQ=", "BQRWf");
    }
    ...
    private static void lIIIllIlllllllI() {
        ...
        an.lllIlllIllll[3] = " ".length();
        an.lllIlllIllll[4] = "  ".length();
        an.lllIlllIllll[5] = "   ".length();
        ...
        if (an.lIIIllIllllllll(SquireNightmarePlugin.D.contains(lllllllllllllllIIllIIlIIIlllIIIl.cS.getId()) ? 1 : 0)) {
            ...
            int lllllllllllllllIIllIIlIIIllIllll = Arrays.stream(Static.getClient().getEnum(lllIlllIllll[1]).getKeys()).anyMatch(n3 -> {
                ...
                if (an.lIIIlllIIIIIIlI(n3, lllllllllllllllIIllIIlIIIlllIIII)) {
                    bl = lllIlllIllll[3];
                    "".length();
                    if (((78 + 83 - 40 + 41 ^ 87 + 38 - 37 + 102) & (0x1A ^ 0x30 ^ (0xB4 ^ 0x82) ^ -" ".length())) < 0) {
                        return ((0x35 ^ 0x3F ^ (0x73 ^ 0x56)) & (0x11 ^ 3 ^ (0x37 ^ 0xA) ^ -" ".length())) != 0;
                    }
                } else {
                    bl = lllIlllIllll[0];
                }
