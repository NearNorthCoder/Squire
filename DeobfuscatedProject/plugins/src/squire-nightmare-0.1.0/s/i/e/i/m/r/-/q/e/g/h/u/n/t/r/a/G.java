...
extends Task {
    ...
    private static void lIIlIIIllIlIIlI() {
        ...
        G.llllIllIlIll[G.llllIllIllII[0]] = G.lIIlIIIllIIllll("axLrRSxXh90=", "MpKPe");
        G.llllIllIlIll[G.llllIllIllII[2]] = G.lIIlIIIllIIllll("aHie2S5HEA3rjqGl4LL0DBqf3nSOGMDvL/aRXJKJfw9VwR53+tFBzRiUhILG5+HR3QyMdX33YHuxx7QGZv0wr60cyVHdHlsUwQuJ4lDfC7Wx4LQ1sSQepyF7WK6Sme8eb1xFxo6bkosoOy2cgmYBoA==", "FKXNI");
        G.llllIllIlIll[G.llllIllIllII[6]] = G.lIIlIIIllIlIIII("HQ0EKCshLQcuIBItBSgpKTodEGNmHwxqKyNoBjgtZicPbT8pJw1tOCgsSTo8YToMbTcpPEkoLyMmSSQ3ZjwBKHkgIQcsNWY4ASwqI2RJOTwqLRkiKzIhByp5KT0dYw==", "FHiMY");
        G.llllIllIlIll[G.llllIllIllII[1]] = G.lIIlIIIllIlIIII("JRxEKicqCiEoTks2CR8HDDYKGQxLJwEWEBs8Fg4cBTREFQAfcxAVVQkyChE=", "kSdzu");
        G.llllIllIlIll[G.llllIllIllII[7]] = G.lIIlIIIllIlIIIl("FXfOURNQshU=", "zFggQ");
        G.llllIllIlIll[G.llllIllIllII[8]] = G.lIIlIIIllIIllll("3jg50o37sP4=", "oCaty");
        G.llllIllIlIll[G.llllIllIllII[9]] = G.lIIlIIIllIlIIII("NDMdHAAw", "GRsze");
        G.llllIllIlIll[G.llllIllIllII[10]] = G.lIIlIIIllIlIIII("Bh0KDj4iEAMAKyc=", "UqokN");
        G.llllIllIlIll[G.llllIllIllII[12]] = G.lIIlIIIllIlIIII("AjgN", "GYyct");
    }

    private static void lIIlIIIllIlIIll() {
        llllIllIllII = new int[14];
        G.llllIllIllII[0] = (0x4D ^ 0x47 ^ (0x64 ^ 0x38)) & (0xD3 ^ 0xA0 ^ (0x23 ^ 6) ^ -" ".length());
        G.llllIllIllII[1] = "   ".length();
        G.llllIllIllII[2] = " ".length();
        G.llllIllIllII[3] = 0xFFFFB7BD & 0x69E6;
        G.llllIllIllII[4] = -(0xFFFFCC37 & 0x7FEB) & (0xFFFFEDBF & 0x7FFE);
        G.llllIllIllII[5] = 0xFFFFBB92 & 0x6FFF;
        G.llllIllIllII[6] = "  ".length();
            ...
            if (G.lIIlIIIllIllIII(lllllllllllllllIIlIlIlllIIIlIllI.getId(), llllIllIllII[5])) {
                NPC lllllllllllllllIIlIlIlllIIIlIlII = NPCs.getNearest(nPC -> {
                    ...
                    if (G.lIIlIIIllIlIlII(nPC.getName().equals(llllIllIlIll[llllIllIllII[10]]) ? 1 : 0) && G.lIIlIIIllIllIII(nPC.getAnimation(), llllIllIllII[11])) {
                        n2 = llllIllIllII[2];
                        "".length();
                        if (((0xAD ^ 0xA4 ^ (0x8D ^ 0x9B)) & (0x24 ^ 0x1F ^ (3 ^ 0x27) ^ -" ".length())) == -" ".length()) {
                            return ((126 + 32 - 103 + 90 ^ 0 + 18 - -32 + 131) & (131 + 162 - 264 + 160 ^ 119 + 15 - 62 + 81 ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = llllIllIllII[0];
                    }
