...
extends A {
            ...
            if (ax.lIIIlllIIIlIIlI(lllllllllllllllIIllIIIlllIlIlllI)) {
                ...
                lllllllllllllllIIllIIIlllIlIlllI = lllllllllllllllIIllIIIlllIllIIIl.stream().filter(worldPoint -> {
                    ...
                    if (ax.lIIIlllIIIlIIIl(this.cM.Y().contains(worldPoint) ? 1 : 0)) {
                        ...
                        "".length();
                        if (-"   ".length() >= 0) {
                            return ((0xF0 ^ 0xA8 ^ (0x7F ^ 0x6F)) & (158 + 103 - 167 + 148 ^ 118 + 80 - 154 + 142 ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lllIllllIIlI[1];
                    }
    ...
    private WorldPoint cH() {
        ...
        NPC nPC2 = NPCs.getAll((int[])nArray).stream().filter(nPC -> {
            ...
            if (ax.lIIIlllIIIlIIIl(nPC.isDead() ? 1 : 0)) {
                ...
                if (ax.lIIIlllIIIlIIII(nPC.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((121 + 59 - 168 + 121 ^ 77 + 41 - -8 + 11) & (50 + 109 - 157 + 139 ^ 118 + 92 - 109 + 28 ^ -" ".length())) != 0;
                }
            }
            n2 = lllIllllIIlI[1];
            return n2 != 0;
            ...
            if (ax.lIIIlllIIIlIIII(this.cM.ag.containsKey(nPC.getId()) ? 1 : 0) && ax.lIIIlllIIIlIlIl(this.cM.ag.get(nPC.getId()), lllIllllIIlI[8])) {
                n2 = lllIllllIIlI[0];
                "".length();
                if (" ".length() >= (0x26 ^ 0x33 ^ (0x61 ^ 0x70))) {
                    return ((150 + 61 - 208 + 155 ^ 137 + 127 - 261 + 151) & (0x48 ^ 0 ^ (0xE8 ^ 0xA4) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lllIllllIIlI[1];
            }
        ...
        list = list.stream().filter(worldPoint -> {
            ...
            if (ax.lIIIlllIIIlIlII(worldPoint.distanceTo(this.ez), n2)) {
                ...
                "".length();
                if (" ".length() == "  ".length()) {
                    return ((24 + 14 - -75 + 16 ^ 128 + 117 - 192 + 85) & (79 + 125 - 175 + 106 ^ 82 + 126 - 152 + 84 ^ -" ".length())) != 0;
                }
            } else {
                bl = lllIllllIIlI[1];
            }
    ...
    private static /* synthetic */ boolean j(WorldPoint worldPoint, WorldPoint worldPoint2) {
        ...
        if (ax.lIIIlllIIIlIlII(worldPoint2.distanceTo(worldPoint), lllIllllIIlI[7])) {
            bl = lllIllllIIlI[0];
            "".length();
            if (((175 + 17 - 174 + 159 ^ 70 + 56 - 5 + 19) & (100 + 25 - 65 + 80 ^ 93 + 47 - -25 + 12 ^ -" ".length())) <= -" ".length()) {
                return ((0xD5 ^ 0x81 ^ (0x65 ^ 0x37)) & (0x76 ^ 0x4C ^ (0x78 ^ 0x44) ^ -" ".length())) != 0;
            }
        } else {
            bl = lllIllllIIlI[1];
        }
    ...
    private static void lIIIlllIIIIllll() {
        ...
        ax.lllIllllIIlI[0] = " ".length();
        ax.lllIllllIIlI[1] = (70 + 77 - -17 + 8 ^ 112 + 115 - 202 + 126) & (0xD8 ^ 0x93 ^ (0xFC ^ 0x8C) ^ -" ".length());
        ax.lllIllllIIlI[2] = "  ".length();
        ax.lllIllllIIlI[3] = "   ".length();
    ...
    private Stream<WorldPoint> b(Stream<WorldPoint> stream) {
        return stream.filter(worldPoint -> {
            ...
            if (ax.lIIIlllIIIlIlII(worldPoint.distanceTo((Locatable)Players.getLocal()), lllIllllIIlI[5])) {
                ...
                "".length();
                if ("   ".length() == 0) {
                    return ((0xBA ^ 0xBC ^ (0x82 ^ 0x9D)) & (24 + 62 - -7 + 38 ^ 96 + 54 - 72 + 76 ^ -" ".length())) != 0;
                }
            } else {
                bl = lllIllllIIlI[1];
            }
    ...
    public boolean bY() {
        ...
        if (ax.lIIIlllIIIlIIII(this.cM.ap())) {
            n2 = lllIllllIIlI[0];
            "".length();
            if ((60 + 89 - -3 + 13 ^ 74 + 24 - 57 + 120) == ((42 + 81 - -10 + 87 ^ 57 + 85 - -3 + 4) & (0x64 ^ 0x47 ^ (0x78 ^ 0x12) ^ -" ".length()))) {
                return ((0x45 ^ 0x49 ^ (0x9D ^ 0x98)) & (0x89 ^ 0xBF ^ (0x79 ^ 0x46) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lllIllllIIlI[1];
        }
    ...
    private static /* synthetic */ boolean g(WorldPoint worldPoint, WorldPoint worldPoint2) {
        ...
        if (ax.lIIIlllIIIlIlII(worldPoint2.distanceTo(worldPoint), lllIllllIIlI[7])) {
            ...
            "".length();
            if (null != null) {
                return ((187 + 85 - 113 + 72 ^ 94 + 43 - 36 + 62) & (0x2F ^ 0x46 ^ (0xEB ^ 0xC6) ^ -" ".length())) != 0;
            }
        } else {
            bl = lllIllllIIlI[1];
        }
    ...
    private static void lIIIlllIIIIlllI() {
        ...
        ax.lllIllllIIIl[ax.lllIllllIIlI[1]] = ax.lIIIlllIIIIlIlI("EAklHg8vGzsQAiQ/ICxcawY8UQcoPDoHA2s8PAUDJjtzFwk+JjddRjwpPxoPJS9zBQlrKzwDCC46", "KHSqf");
        ax.lllIllllIIIl[ax.lllIllllIIlI[0]] = ax.lIIIlllIIIIlIll("SVYt0FaQJCcyV22tY4FKuPDCCOvxIhZaknrKUWWKSYqCX6X7lYo/2/Z3+H/KVErzgdEEN5TMYcqfWE2gu5DkYg==", "hDllo");
        ax.lllIllllIIIl[ax.lllIllllIIlI[2]] = ax.lIIIlllIIIIlIlI("GRclBCAmBTsKLS0hIDZzYhg8SzoqJDwEJDF2PBlpJDo8HCwwJXMbOyclNgU9bnY9BDsvNz9LLS0yNAInJXYnBGk2OScOJA==", "BVSkI");
        ax.lllIllllIIIl[ax.lllIllllIIlI[3]] = ax.lIIIlllIIIIllII("FGVbg0/3rDH+itlSj1vkot4YkVjn3yx3ziro4mcofPamedNeZYAi8p3OgwWwldkn89GS1WRacTeTqCQztptVjxP5litLxS+/", "Urgrq");
        ax.lllIllllIIIl[ax.lllIllllIIlI[4]] = ax.lIIIlllIIIIllII("HaDXAfKfSm9d34CJrGbc2C+oMOGjZlbNBDWOVMQSVRetmbaKHdwpAS9ys5kqErGeKg/rZ5U7swjEZ6A+T3pqMqCfkFM02YwQRBINGTK/JZwUPf2LEicTSg==", "HFbjB");
        ax.lllIllllIIIl[ax.lllIllllIIlI[6]] = ax.lIIIlllIIIIlIlI("GAMQKSwnEQ4nISw1FRt/Y2ogCgoUBzQVbGMXFS8rJGIIKTcuIwpmKCYuAyNlIjQJLyEiLAUjZTUrB2Y1LyMfIzdjIxQjJGMyCS8rNzFI", "CBfFE");
        ax.lllIllllIIIl[ax.lllIllllIIlI[7]] = ax.lIIIlllIIIIlIll("jGhwmagiETg=", "vfbzo");
        ax.lllIllllIIIl[ax.lllIllllIIlI[9]] = ax.lIIIlllIIIIlIll("6mnSy8tM+aQ=", "Nlspa");
    }
