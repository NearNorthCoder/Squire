...
extends Enum<t> {
    ...
    private static void lIIIllllllIllII() {
        ...
        t.llllIIllIIIl[0] = " ".length() & ~" ".length();
        t.llllIIllIIIl[1] = -(0xFFFFCC87 & 0x7F79) & (0xFFFFFDB7 & Short.MAX_VALUE);
        t.llllIIllIIIl[2] = " ".length();
        t.llllIIllIIIl[3] = 0xFFFFDB76 & 0x7FC9;
        t.llllIIllIIIl[4] = "  ".length();
        t.llllIIllIIIl[5] = -" ".length();
        t.llllIIllIIIl[6] = "   ".length();
        t.llllIIllIIIl[7] = "   ".length() ^ (0x2C ^ 0x27);
    }
    ...
    private static void lIIIllllllIlIIl() {
        ...
        t.llllIIlIllll[t.llllIIllIIIl[0]] = t.lIIIllllllIIllI("GwNgQyfU5PmmDHGsEBzU+DIWA4Y8Roz7", "SyunI");
        t.llllIIlIllll[t.llllIIllIIIl[2]] = t.lIIIllllllIIllI("oOmRTyJpx3TB6FnQk/EwHg==", "bhPlL");
        t.llllIIlIllll[t.llllIIllIIIl[4]] = t.lIIIllllllIlIII("Ojmy7VdYUsY=", "XoETw");
    }
