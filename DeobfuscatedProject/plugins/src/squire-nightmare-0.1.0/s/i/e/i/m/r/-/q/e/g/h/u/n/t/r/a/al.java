...
extends C {
    ...
    private static void lIIIlllllllIIlI() {
        ...
        al.llllIIllIlIl[0] = (0x6F ^ 0x38 ^ (0x43 ^ 0x2F)) & (3 ^ 0x29 ^ (0x18 ^ 9) ^ -" ".length());
        al.llllIIllIlIl[1] = " ".length();
    }
    ...
    protected boolean cw() {
        ...
        if (al.lIIIlllllllIlll(tileObject) && al.lIIIlllllllIlll(rectangularArea) && al.lIIIlllllllIlIl(rectangularArea.contains(player.getWorldLocation()) ? 1 : 0)) {
            n2 = llllIIllIlIl[1];
            "".length();
            if ((0x6A ^ 0x64 ^ (0x33 ^ 0x39)) < "   ".length()) {
                return ((0x1C ^ 0x40 ^ (0x11 ^ 0x57)) & (142 + 78 - 131 + 88 ^ 61 + 80 - -23 + 7 ^ -" ".length())) != 0;
            }
        } else {
            n2 = llllIIllIlIl[0];
        }
    ...
    protected boolean cu() {
        int n2;
        al lllllllllllllllIIlIlllIlIIIlIlll;
        if (al.lIIIlllllllIlII(this.cM.ap(), llllIIllIlIl[1]) && al.lIIIlllllllIlIl(this.cz() ? 1 : 0) && !al.lIIIlllllllIIll(this.cv() ? 1 : 0) || al.lIIIlllllllIllI(lllllllllllllllIIlIlllIlIIIlIlll.cM.ap()) && al.lIIIlllllllIIll(lllllllllllllllIIlIlllIlIIIlIlll.cy() ? 1 : 0)) {
            n2 = llllIIllIlIl[1];
            "".length();
            if ("   ".length() <= 0) {
