...
extends D {
    ...
    protected boolean a(Predicate<Item> predicate, int n2) {
        void lllllllllllllllIIllIIIllIIIlllll;
        ...
        if (F.lIIIlllIIIllllI(Inventory.getFreeSlots(), (int)lllllllllllllllIIllIIIllIIIlllll)) {
    ...
    @Override
    public boolean run() {
        F lllllllllllllllIIllIIIllIIlIlIIl;
        if (F.lIIIlllIIIllIlI(this.cV.enableBanking() ? 1 : 0)) {
            return lllIllllIlII[0];
        }
        if (F.lIIIlllIIIllIll(lllllllllllllllIIllIIIllIIlIlIIl.cc() ? 1 : 0)) {
            lllllllllllllllIIllIIIllIIlIlIIl.cW.b(lllllllllllllllIIllIIIllIIlIlIIl.ce().needsToBank());
        }
        if (F.lIIIlllIIIllIlI(lllllllllllllllIIllIIIllIIlIlIIl.cW.s() ? 1 : 0)) {
            return lllIllllIlII[0];
        }
    ...
    private static String lIIIlllIIIlIlll(String lllllllllllllllIIllIIIllIIIIIlll, String lllllllllllllllIIllIIIllIIIIIllI) {
        lllllllllllllllIIllIIIllIIIIIlll = new String(Base64.getDecoder().decode(lllllllllllllllIIllIIIllIIIIIlll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIllIIIllIIIIIlIl = new StringBuilder();
        ...
        char[] lllllllllllllllIIllIIIlIllllllIl = lllllllllllllllIIllIIIllIIIIIlll.toCharArray();
        int lllllllllllllllIIllIIIlIllllllII = lllllllllllllllIIllIIIlIllllllIl.length;
        int lllllllllllllllIIllIIIlIlllllIll = lllIllllIlII[0];
        while (F.lIIIlllIIIllllI(lllllllllllllllIIllIIIlIlllllIll, lllllllllllllllIIllIIIlIllllllII)) {
            char lllllllllllllllIIllIIIllIIIIlIII = lllllllllllllllIIllIIIlIllllllIl[lllllllllllllllIIllIIIlIlllllIll];
            lllllllllllllllIIllIIIllIIIIIlIl.append((char)(lllllllllllllllIIllIIIllIIIIlIII ^ lllllllllllllllIIllIIIllIIIIIlII[lllllllllllllllIIllIIIllIIIIIIll % lllllllllllllllIIllIIIllIIIIIlII.length]));
            "".length();
        ...
        return String.valueOf(lllllllllllllllIIllIIIllIIIIIlIl);
    }

    private static String lIIIlllIIIlIllI(String lllllllllllllllIIllIIIllIIIlIlIl, String lllllllllllllllIIllIIIllIIIlIlII) {
        try {
            SecretKeySpec lllllllllllllllIIllIIIllIIIllIlI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIllIIIllIIIlIlII.getBytes(StandardCharsets.UTF_8)), lllIllllIlII[6]), "DES");
            Cipher lllllllllllllllIIllIIIllIIIllIIl = Cipher.getInstance("DES");
            lllllllllllllllIIllIIIllIIIllIIl.init(lllIllllIlII[3], lllllllllllllllIIllIIIllIIIllIlI);
            return new String(lllllllllllllllIIllIIIllIIIllIIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIIllIIIllIIIlIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    protected boolean cd() {
        int n2;
        void lllllllllllllllIIllIIIllIIlIIIll;
        ...
        if (F.lIIIlllIIIlllII(tileObject) && F.lIIIlllIIIllIll(Reachable.isInteractable((Locatable)tileObject) ? 1 : 0) && !F.lIIIlllIIIlllIl(Players.getLocal().distanceTo((Locatable)tileObject), lllIllllIlII[2]) || F.lIIIlllIIIlllII(lllllllllllllllIIllIIIllIIlIIIll) && F.lIIIlllIIIllIll(Reachable.isInteractable((Locatable)lllllllllllllllIIllIIIllIIlIIIll) ? 1 : 0) && F.lIIIlllIIIllllI(Players.getLocal().distanceTo((Locatable)lllllllllllllllIIllIIIllIIlIIIll), lllIllllIlII[2])) {
            n2 = lllIllllIlII[1];
            "".length();
            if (" ".length() < 0) {
    ...
    private static void lIIIlllIIIllIIl() {
        ...
        F.lllIllllIlII[1] = " ".length();
        F.lllIllllIlII[2] = 0xD4 ^ 0xB6 ^ (0x30 ^ 0x5E);
        F.lllIllllIlII[3] = "  ".length();
        F.lllIllllIlII[4] = "   ".length();
    ...
    protected boolean cc() {
        ...
        if (!F.lIIIlllIIIllIlI(this.cd() ? 1 : 0) || F.lIIIlllIIIllIll(this.cZ.m(this.cV.bankLocation().bJ()) ? 1 : 0)) {
            bl = lllIllllIlII[1];
            "".length();
            if ((71 + 34 - 1 + 57 ^ 129 + 150 - 237 + 123) < ((0x38 ^ 0x4A ^ (0xBB ^ 0xC0)) & (4 ^ 0x5F ^ (0x2B ^ 0x79) ^ -" ".length()))) {
                return ((134 + 98 - 179 + 86 ^ 41 + 109 - 117 + 155) & (0x85 ^ 0xC7 ^ (0xF5 ^ 0x80) ^ -" ".length())) != 0;
            }
        } else {
            bl = lllIllllIlII[0];
        }
    ...
    private static void lIIIlllIIIllIII() {
        ...
        F.lllIllllIIll[F.lllIllllIlII[0]] = F.lIIIlllIIIlIllI("oWW64RqjJ6SomDDCU1L84A==", "frXnH");
        F.lllIllllIIll[F.lllIllllIlII[1]] = F.lIIIlllIIIlIlll("MSU8EjMB", "sDRyV");
        F.lllIllllIIll[F.lllIllllIlII[3]] = F.lIIIlllIIIlIlll("AwsiGCM=", "GyKvH");
        F.lllIllllIIll[F.lllIllllIlII[4]] = F.lIIIlllIIIlIlll("IAYj", "egWvk");
    }
}
