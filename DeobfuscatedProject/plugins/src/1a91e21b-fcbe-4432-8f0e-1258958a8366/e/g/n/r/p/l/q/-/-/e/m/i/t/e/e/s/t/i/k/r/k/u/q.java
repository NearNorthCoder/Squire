...
extends Task {
    ...
    public boolean run() {
        q llllllllllllllIlllIlllllIlllIIIl;
        Widget widget;
        ...
        Player llllllllllllllIlllIlllllIlllIIII = Players.getLocal();
        if (q.lIllIIIIIlllllI(llllllllllllllIlllIlllllIlllIIII)) {
            return lIIllIlIIlIlI[6];
        }
        if (!q.lIllIIIIIllllll(llllllllllllllIlllIlllllIlllIIIl.R.f().contains((Locatable)llllllllllllllIlllIlllllIlllIIII) ? 1 : 0) || q.lIllIIIIIllllII(llllllllllllllIlllIlllllIlllIIIl.R.g().contains((Locatable)llllllllllllllIlllIlllllIlllIIII) ? 1 : 0)) {
            return lIIllIlIIlIlI[6];
        }
        if (!q.lIllIIIIIllllll(llllllllllllllIlllIlllllIlllIIII.isMoving() ? 1 : 0) || q.lIllIIIIIllllII(llllllllllllllIlllIlllllIlllIIII.isAnimating() ? 1 : 0)) {
            if (q.lIllIIIIIllllll(Movement.isRunEnabled() ? 1 : 0) && q.lIllIIIIlIIIIII(Movement.getRunEnergy(), llllllllllllllIlllIlllllIlllIIIl.U)) {
                Movement.toggleRun();
                llllllllllllllIlllIlllllIlllIIIl.U = llllllllllllllIlllIlllllIlllIIIl.T.nextInt(lIIllIlIIlIlI[0]) + lIIllIlIIlIlI[1];
                return lIIllIlIIlIlI[3];
            }
            return lIIllIlIIlIlI[6];
        }
    ...
    private static void lIllIIIIIlllIll() {
        ...
        q.lIIllIlIIlIlI[3] = " ".length();
        q.lIIllIlIIlIlI[4] = 0x1D ^ 0x24;
        q.lIIllIlIIlIlI[5] = -" ".length();
