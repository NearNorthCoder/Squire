...
extends Task {
    ...
    private static void lIllIIIlIIIIIII() {
        ...
        n.lIIllIllIIIII[0] = (0x41 ^ 0x36 ^ (0x6F ^ 9)) & (0x40 ^ 0x37 ^ (0xC4 ^ 0xA2) ^ -" ".length());
        n.lIIllIllIIIII[1] = " ".length();
        n.lIIllIllIIIII[2] = "  ".length();
    }

    private static void lIllIIIIlllllll() {
        lIIllIlIlllll = new String[lIIllIllIIIII[1]];
        n.lIIllIlIlllll[n.lIIllIllIIIII[0]] = n.lIllIIIIllllllI("hJKjdVNJRhyED2zyKnzRSuZn/u0GZDvOaNQl2aDhR9w=", "wZwTr");
    }
