...
extends Task {
    ...
    private static void lIllIIIIIIllllI() {
        ...
        m.lIIllIIllllII[m.lIIllIIlllllI[0]] = m.lIllIIIIIIllIlI("LNIj7r9/D9E=", "okpos");
    }
    ...
    private static void lIllIIIIIIlllll() {
        ...
        m.lIIllIIlllllI[0] = (0x2C ^ 0x12 ^ 74 + 121 - 83 + 15) & (0x2C ^ 8 ^ (0x1D ^ 0x78) ^ -" ".length());
        m.lIIllIIlllllI[1] = " ".length();
        m.lIIllIIlllllI[2] = 0xB3 ^ 0xB4 ^ (0x36 ^ 0x39);
        m.lIIllIIlllllI[3] = "  ".length();
    }
