...
extends x {
    ...
    private static void lIllIIIIlIIlIII() {
        ...
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[1]] = v.lIllIIIIIlllIII("NDg3FxgZIjxOBQUyMg==", "wWYcq");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[3]] = v.lIllIIIIIlllIIl("n0e+r1TG2KE=", "idXMU");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[0]] = v.lIllIIIIIlllIIl("884oNe4B/bM=", "ibyZi");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[5]] = v.lIllIIIIIlllIIl("CKwwV0KmPRIi9wcuukxtnQ==", "cjCSa");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[6]] = v.lIllIIIIIlllIIl("72UTbbPW/oIc+sJTAEPQIg==", "meYqN");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[7]] = v.lIllIIIIIlllIlI("ekx3Aieh7hw=", "WDZWf");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[8]] = v.lIllIIIIIlllIIl("56JRIh90Kp8=", "FGhVd");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[9]] = v.lIllIIIIIlllIII("FgYGG3MxAR4F", "UnikS");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[2]] = v.lIllIIIIIlllIII("AT4bGQA=", "QRzwk");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[10]] = v.lIllIIIIIlllIIl("eAO4CmctHHw=", "LHzsC");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[11]] = v.lIllIIIIIlllIlI("HYXc6p8X7lA=", "xsZpq");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[4]] = v.lIllIIIIIlllIlI("MZiWlkCyydc=", "TuGOD");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[12]] = v.lIllIIIIIlllIlI("+icMfsjjHpU=", "CEmto");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[13]] = v.lIllIIIIIlllIII("PDkJKgANdyE6DAsyHyUACjw=", "iWmOa");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[17]] = v.lIllIIIIIlllIII("FQM1NVQlFDE0", "QfTQt");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[18]] = v.lIllIIIIIlllIIl("cpIr2/bw7X4GKVeP15abfw==", "LaQwP");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[19]] = v.lIllIIIIIlllIII("NhULMwAx", "TgbWg");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[20]] = v.lIllIIIIIlllIIl("4T8iKO++/D9dtLlM/em+3w==", "OTWIP");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[21]] = v.lIllIIIIIlllIII("IhUGHQQ=", "aginw");
        v.lIIllIlIIlIII[v.lIIllIlIIlllI[22]] = v.lIllIIIIIlllIIl("mvwCoFhJNqeayUMt2XvSjQ==", "jntne");
    }
    ...
    public boolean z() {
        ...
        TileObject tileObject3 = TileObjects.getNearest(tileObject -> {
            ...
            if (v.lIllIIIIlIIllll(tileObject.hasAction(stringArray) ? 1 : 0) && v.lIllIIIIlIIllll(tileObject.getName().equals(lIIllIlIIlIII[lIIllIlIIlllI[22]]) ? 1 : 0)) {
                n2 = lIIllIlIIlllI[3];
                "".length();
                if ("  ".length() >= (0xE7 ^ 0x90 ^ (0x70 ^ 3))) {
                    return ((82 + 119 - 170 + 105 ^ 179 + 65 - 71 + 24) & (0xD ^ 0x7D ^ (0xB3 ^ 0x8E) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIllIlIIlllI[1];
            }
        ...
        if (v.lIllIIIIlIIllIl(llllllllllllllIlllIlllllIIllIIll)) {
            ...
            if (v.lIllIIIIlIIllll(llllllllllllllIlllIlllllIIllIIll.getName().contains(lIIllIlIIlIII[lIIllIlIIlllI[0]]) ? 1 : 0)) {
                ...
                "".length();
                if (" ".length() < -" ".length()) {
                    return ((0xB8 ^ 0x9B ^ (0xE0 ^ 0x93)) & (108 + 58 - 159 + 203 ^ 84 + 126 - 207 + 127 ^ -" ".length())) != 0;
                }
                ...
                "".length();
                if (((0xE1 ^ 0x91 ^ (0xCA ^ 0x92)) & (70 + 72 - 9 + 104 ^ 122 + 162 - 136 + 49 ^ -" ".length())) != 0) {
                    return ((0xF ^ 0x6A ^ (0x68 ^ 0x37)) & (0x89 ^ 0xBB ^ (0x94 ^ 0x9C) ^ -" ".length())) != 0;
                }
    ...
    private static void lIllIIIIlIIllII() {
        ...
        v.lIIllIlIIlllI[0] = "  ".length();
        v.lIIllIlIIlllI[1] = (187 + 158 - 269 + 115 ^ 164 + 134 - 257 + 131) & (106 + 67 - 140 + 115 ^ 5 + 128 - 97 + 99 ^ -" ".length());
        v.lIIllIlIIlllI[2] = 0x7C ^ 0x74;
        v.lIIllIlIIlllI[3] = " ".length();
        v.lIIllIlIIlllI[4] = 8 + 98 - 102 + 158 ^ 64 + 6 - -31 + 68;
        v.lIIllIlIIlllI[5] = "   ".length();
