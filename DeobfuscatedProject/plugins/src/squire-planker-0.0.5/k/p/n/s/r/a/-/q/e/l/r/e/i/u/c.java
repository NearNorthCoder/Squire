...
extends Task {
    ...
    private static void lIIlIIllllIIIll() {
        ...
        c.llllllIIIIII[0] = " ".length();
        c.llllllIIIIII[1] = (3 ^ 0x20 ^ (0x1F ^ 0x7C)) & (3 + 60 - -83 + 91 ^ 125 + 42 - 82 + 88 ^ -" ".length());
        c.llllllIIIIII[2] = "  ".length();
        c.llllllIIIIII[3] = 0x90 ^ 0x95;
        c.llllllIIIIII[4] = -(0xFFFFDFF7 & 0x3C09) & (0xFFFFBF73 & 0x5DFE);
        c.llllllIIIIII[5] = "   ".length();
    ...
    private static void lIIlIIllllIIIlI() {
        ...
        c.lllllIllllll[c.llllllIIIIII[1]] = c.lIIlIIllllIIIII("JRUUJ0wEHB8/GA==", "gtzLl");
        c.lllllIllllll[c.llllllIIIIII[0]] = c.lIIlIIllllIIIIl("N4YViLqWXC2pqSeUZTgDBw==", "DHEbq");
        c.lllllIllllll[c.llllllIIIIII[2]] = c.lIIlIIllllIIIIl("YyfmI0Lo4wI=", "aaaSc");
        c.lllllIllllll[c.llllllIIIIII[5]] = c.lIIlIIllllIIIII("OxgrBksrHDUcChYN", "xyGjk");
        c.lllllIllllll[c.llllllIIIIII[7]] = c.lIIlIIllllIIIIl("TN8RBQy6q3dPV2R5NuWJnVLUIhUM65mk", "AZLRd");
    }
}
