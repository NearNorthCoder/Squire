...
extends Task {
    ...
    public boolean run() {
        ...
        if (e.lIIlIIllllllIII(Inventory.contains((int[])nArray) ? 1 : 0) && e.lIIlIIllllllIIl(lllllllllllllllIIlIIlllllIIlIIIl)) {
            ...
            "".length();
            if (null != null) {
                return ((0x8D ^ 0xA8 ^ (0x1E ^ 0x64)) & (0xF ^ 0x17 ^ (0x72 ^ 0x35) ^ -" ".length())) != 0;
            }
        } else {
    ...
    private static void lIIlIIlllllIlIl() {
        ...
        e.llllllIIIIll[e.llllllIIIlII[0]] = e.lIIlIIlllllIIlI("XW34fLwgCf5mywd+Nj3P5A==", "rjtlp");
        e.llllllIIIIll[e.llllllIIIlII[2]] = e.lIIlIIlllllIIlI("2oh3+5Qn2g63kP+pcjMguw==", "DCOAB");
        e.llllllIIIIll[e.llllllIIIlII[1]] = e.lIIlIIlllllIIll("GCg2OSw0", "QFEPH");
        e.llllllIIIIll[e.llllllIIIlII[3]] = e.lIIlIIlllllIIll("JSYfGxMJ", "lHlrw");
        e.llllllIIIIll[e.llllllIIIlII[4]] = e.lIIlIIlllllIIll("FwIpOQ==", "TcZMg");
        e.llllllIIIIll[e.llllllIIIlII[5]] = e.lIIlIIlllllIIlI("z4YErh+aK9dzZPJHYl6ZMTbk5V5iH7LASgBxQtuLpLq73TCS+wHaroSoJ21PqM2R", "pFfyp");
        e.llllllIIIIll[e.llllllIIIlII[7]] = e.lIIlIIlllllIlII("WcvuK1+u+iQ=", "zFcGh");
        e.llllllIIIIll[e.llllllIIIlII[8]] = e.lIIlIIlllllIIll("HiEoEDI=", "MDMbA");
        e.llllllIIIIll[e.llllllIIIlII[9]] = e.lIIlIIlllllIIlI("KWXyw9Mo3o4=", "TVKZd");
    }
    ...
    private static void lIIlIIlllllIllI() {
        ...
        e.llllllIIIlII[0] = (0xCF ^ 0x88 ^ (0xE0 ^ 0xA9)) & (62 + 165 - 115 + 66 ^ 142 + 128 - 152 + 70 ^ -" ".length());
        e.llllllIIIlII[1] = "  ".length();
        e.llllllIIIlII[2] = " ".length();
        e.llllllIIIlII[3] = "   ".length();
