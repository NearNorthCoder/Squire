...
extends Task {
    ...
    public boolean run() {
        void var1_1;
        void var2_2;
        f lllllllllllllllIIlIlIIIIIllIllII;
        if (f.lIIlIIlllIlIIlI(this.p.spell() ? 1 : 0)) {
            return lllllIllIlll[0];
        }
        int[] nArray = new int[lllllIllIlll[1]];
        nArray[f.lllllIllIlll[0]] = lllllllllllllllIIlIlIIIIIllIllII.p.plank().d();
        Item lllllllllllllllIIlIlIIIIIllIlIll = Inventory.getFirst((int[])nArray);
        if (f.lIIlIIlllIlIIll(lllllllllllllllIIlIlIIIIIllIlIll)) {
            return lllllIllIlll[0];
        }
        SpellBook.Lunar lllllllllllllllIIlIlIIIIIllIlIlI = SpellBook.Lunar.PLANK_MAKE;
        if (f.lIIlIIlllIlIIlI(lllllllllllllllIIlIlIIIIIllIlIlI.canCast() ? 1 : 0)) {
            return lllllIllIlll[0];
        }
    ...
    private static void lIIlIIlllIlIIIl() {
        ...
        f.lllllIllIlll[1] = " ".length();
        f.lllllIllIlll[2] = "  ".length();
    }
