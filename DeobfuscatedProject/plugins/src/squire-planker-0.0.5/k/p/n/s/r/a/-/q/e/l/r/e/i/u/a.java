...
extends Enum<a> {
    ...
    private static void lIIlIIlllIlllIl() {
        ...
        a.lllllIllllII[a.lllllIllllIl[0]] = a.lIIlIIlllIllIll("GClCPiesk8s=", "twqZq");
        a.lllllIllllII[a.lllllIllllIl[4]] = a.lIIlIIlllIlllII("BhcA", "IVKov");
        a.lllllIllllII[a.lllllIllllIl[8]] = a.lIIlIIlllIlllII("LjQLJg==", "zqJmB");
        a.lllllIllllII[a.lllllIllllIl[12]] = a.lIIlIIlllIllIll("kcaSwRxfXQ23e3dq6naohw==", "wTlVD");
    }

    private static void lIIlIIlllIllllI() {
        lllllIllllIl = new int[18];
        a.lllllIllllIl[0] = (0xC2 ^ 0xA6 ^ (0x11 ^ 0x3F)) & (81 + 160 - 203 + 154 ^ 60 + 29 - -25 + 24 ^ -" ".length());
