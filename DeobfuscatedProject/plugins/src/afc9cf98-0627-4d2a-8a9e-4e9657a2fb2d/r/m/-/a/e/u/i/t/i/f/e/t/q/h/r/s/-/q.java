...
extends Task {
    ...
    private static void lIllIlIlllllIlI() {
        ...
        q.lIIlllllIllII[q.lIIlllllIlllI[0]] = q.lIllIlIllllIIll("zBsbINs0hFQ=", "rNkgf");
        q.lIIlllllIllII[q.lIIlllllIlllI[3]] = q.lIllIlIllllIlII("BwYIGQ==", "Tgkrb");
        q.lIIlllllIllII[q.lIIlllllIlllI[4]] = q.lIllIlIllllIlIl("059Z6jZUrdU=", "pabrA");
        q.lIIlllllIllII[q.lIIlllllIlllI[5]] = q.lIllIlIllllIIll("Mg/zb36ubikZVM/E1lWqag==", "cRVqh");
        q.lIIlllllIllII[q.lIIlllllIlllI[6]] = q.lIllIlIllllIlIl("dKNkmGLdtkU=", "zRayB");
        q.lIIlllllIllII[q.lIIlllllIlllI[7]] = q.lIllIlIllllIlIl("JGlbt2g60qvhtkKZ59TzLQ==", "MDKRC");
        q.lIIlllllIllII[q.lIIlllllIlllI[8]] = q.lIllIlIllllIIll("HmmPxV+3IBs=", "LphDc");
        q.lIIlllllIllII[q.lIIlllllIlllI[9]] = q.lIllIlIllllIIll("3iebL8L3M4c=", "ViCog");
    }
        ...
        if (q.lIllIlIlllllllI(Inventory.contains(item -> item.getName().toLowerCase().contains(lIIlllllIllII[lIIlllllIlllI[8]])) ? 1 : 0)) {
            ...
            if (q.lIllIlIllllllll(llllllllllllllIlllIIllIIIIlllIII.size())) {
                ...
                while (q.lIllIlIlllllllI(llllllllllllllIlllIIllIIIIllIlll.hasNext() ? 1 : 0)) {
                    ...
                    "".length();
                    if (((0x37 ^ 0xF ^ (0x5D ^ 0x6A)) & (0x30 ^ 0x43 ^ (0x26 ^ 0x5A) ^ -" ".length())) == 0) continue;
                    return ((0x6B ^ 0x18 ^ (0xC0 ^ 0x98)) & (157 + 90 - 213 + 125 ^ 104 + 5 - -24 + 47 ^ -" ".length())) != 0;
                }
                return lIIlllllIlllI[3];
            }
            String[] stringArray = new String[lIIlllllIlllI[3]];
    ...
    private static void lIllIlIlllllIll() {
        ...
        q.lIIlllllIlllI[0] = (0x6D ^ 0x36 ^ (0x16 ^ 0x7D)) & (13 + 26 - -68 + 65 ^ 142 + 6 - 61 + 69 ^ -" ".length());
        q.lIIlllllIlllI[1] = 0xFFFFD3FD & 0x3F1F;
        q.lIIlllllIlllI[2] = 0xFFFFF4DF & 0x3F39;
        q.lIIlllllIlllI[3] = " ".length();
        q.lIIlllllIlllI[4] = "  ".length();
        q.lIIlllllIlllI[5] = "   ".length();
