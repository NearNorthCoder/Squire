...
extends r {
    ...
    public boolean run() {
        ...
        TileObject llllllllllllllIlllIIllIlIlIllIII = llllllllllllllIlllIIllIlIlIllIll.Z.a(tileObject -> {
            ...
            if (s.lIllIlIllIlllIl((Object)f.d(tileObject.getId()), (Object)f.EMPTY)) {
                ...
                "".length();
                if (-" ".length() == "  ".length()) {
                    return ((0x6A ^ 0x51 ^ (0xC2 ^ 0xA7)) & (0x2D ^ 0x1B ^ (0x15 ^ 0x7D) ^ -" ".length())) != 0;
                }
            } else {
                bl = lIIlllllIIllI[0];
            }
    ...
    private static void lIllIlIllIlIllI() {
        ...
        s.lIIlllllIIllI[0] = " ".length() & (" ".length() ^ -" ".length());
        s.lIIlllllIIllI[1] = 0x64 ^ 0xF ^ (0xCC ^ 0xA3);
        s.lIIlllllIIllI[2] = 39 + 57 - 70 + 187 ^ 100 + 134 - 78 + 21;
        s.lIIlllllIIllI[3] = " ".length();
        s.lIIlllllIIllI[4] = "  ".length();
        s.lIIlllllIIllI[5] = "   ".length();
    ...
    private static void lIllIlIllIlIlIl() {
        ...
        s.lIIlllllIIlIl[s.lIIlllllIIllI[0]] = s.lIllIlIllIlIIlI("JhMUGw==", "qvuim");
        s.lIIlllllIIlIl[s.lIIlllllIIllI[3]] = s.lIllIlIllIlIIll("Yi7vBIH/xctZrNGfQq4u/w==", "HUxdM");
        s.lIIlllllIIlIl[s.lIIlllllIIllI[4]] = s.lIllIlIllIlIlII("Spgn5ykqScg=", "qJwNU");
    }
