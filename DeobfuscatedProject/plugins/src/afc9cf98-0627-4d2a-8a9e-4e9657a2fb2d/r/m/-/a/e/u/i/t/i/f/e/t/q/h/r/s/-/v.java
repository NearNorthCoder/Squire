...
extends r {
    ...
    private static void lIllIlIlllIIIII() {
        ...
        v.lIIlllllIlIII[0] = " ".length();
        v.lIIlllllIlIII[1] = (235 + 102 - 258 + 165 ^ 69 + 100 - 95 + 125) & (0x24 ^ 0x3C ^ (0 ^ 0x2B) ^ -" ".length());
        v.lIIlllllIlIII[2] = -(0xFFFFEAD5 & 0x55AF) & (0xFFFFFCEF & 0x77BD);
        v.lIIlllllIlIII[3] = "  ".length();
        ...
        if (v.lIllIlIlllIIIIl(Inventory.contains(item -> {
            ...
            if (v.lIllIlIlllIIlII(item.getId(), lIIlllllIlIII[4]) && v.lIllIlIlllIIlIl(item.getId(), lIIlllllIlIII[5])) {
                ...
                if (-(0x33 ^ 0x39 ^ (0x64 ^ 0x6A)) > 0) {
                    return ((127 + 130 - 80 + 6 ^ 31 + 29 - 54 + 128) & (0x49 ^ 0x37 ^ (0x6A ^ 0x25) ^ -" ".length())) != 0;
                }
            } else {
                n2 = lIIlllllIlIII[1];
            }
    ...
    private static void lIllIlIllIlllll() {
        ...
        v.lIIlllllIIlll[v.lIIlllllIlIII[1]] = v.lIllIlIllIllllI("BRszMiA=", "RzGWR");
        v.lIIlllllIIlll[v.lIIlllllIlIII[0]] = v.lIllIlIllIllllI("Li4ANyE=", "yOtRS");
    }
