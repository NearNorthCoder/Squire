...
extends Task {
    ...
    private static void lIllIllIlIlIIlI() {
        ...
        n.lIlIIIIIIlIlI[n.lIlIIIIIIlIll[0]] = n.lIllIllIlIIllll("Ex6BcyMGuXY=", "dtXIA");
        n.lIlIIIIIIlIlI[n.lIlIIIIIIlIll[1]] = n.lIllIllIlIIllll("R745wFc+wbQ=", "wGqvM");
        n.lIlIIIIIIlIlI[n.lIlIIIIIIlIll[2]] = n.lIllIllIlIIllll("diheUcx67og=", "zUnfK");
        n.lIlIIIIIIlIlI[n.lIlIIIIIIlIll[3]] = n.lIllIllIlIlIIII("JCodGQs4", "ADxkl");
        n.lIlIIIIIIlIlI[n.lIlIIIIIIlIll[4]] = n.lIllIllIlIlIIIl("8vSOgFM1qNg=", "KxFQP");
        n.lIlIIIIIIlIlI[n.lIlIIIIIIlIll[5]] = n.lIllIllIlIIllll("U0/wKlLgdDA=", "aacgk");
    }

    private static void lIllIllIlIlIIll() {
        lIlIIIIIIlIll = new int[8];
        n.lIlIIIIIIlIll[0] = (0xC4 ^ 0x8B) & ~(0x54 ^ 0x1B);
        n.lIlIIIIIIlIll[1] = " ".length();
        n.lIlIIIIIIlIll[2] = "  ".length();
        n.lIlIIIIIIlIll[3] = "   ".length();
