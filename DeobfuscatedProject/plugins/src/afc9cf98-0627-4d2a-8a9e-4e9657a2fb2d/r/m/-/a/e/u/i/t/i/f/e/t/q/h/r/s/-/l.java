...
extends r {
    ...
    private static void lIllIllIIIllIll() {
        ...
        l.lIIlllllllIII[l.lIIlllllllIlI[0]] = l.lIllIllIIIllIlI("LqfDXZrLSQY=", "DLGxS");
        l.lIIlllllllIII[l.lIIlllllllIlI[1]] = l.lIllIllIIIllIlI("gJNW5BRR7SE=", "XzeVt");
    }

    private static void lIllIllIIIllllI() {
        lIIlllllllIlI = new int[3];
        l.lIIlllllllIlI[0] = (0xB2 ^ 0x94 ^ (0x9E ^ 0x88)) & (86 + 191 - 243 + 207 ^ 162 + 79 - 110 + 62 ^ -" ".length());
        l.lIIlllllllIlI[1] = " ".length();
        l.lIIlllllllIlI[2] = "  ".length();
    }
