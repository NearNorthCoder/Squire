...
extends r {
    ...
    private static void lIllIllIlllllIl() {
        ...
        p.lIlIIIIIlIIll[p.lIlIIIIIlIlIl[0]] = p.lIllIllIlllIlII("9N0ItudF6oY=", "eGOcW");
        p.lIlIIIIIlIIll[p.lIlIIIIIlIlIl[1]] = p.lIllIllIlllIlII("nYp+WMDIxa4=", "OHWev");
        p.lIlIIIIIlIIll[p.lIlIIIIIlIlIl[2]] = p.lIllIllIlllllII("HgdB6zysO6w=", "pizWV");
    }

    private static void lIllIllIllllllI() {
        lIlIIIIIlIlIl = new int[5];
        p.lIlIIIIIlIlIl[0] = (0x66 ^ 0x5A) & ~(0xC ^ 0x30);
        p.lIlIIIIIlIlIl[1] = " ".length();
        p.lIlIIIIIlIlIl[2] = "  ".length();
        p.lIlIIIIIlIlIl[3] = "   ".length();
