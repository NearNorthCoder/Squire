...
extends Enum<f> {
    ...
    private static void lIllIllIIlllllI() {
        ...
        f.lIlIIIIIIIlII[0] = (0x6C ^ 0x1A ^ (0xD0 ^ 0x97)) & (0x14 ^ 0x55 ^ (0x36 ^ 0x46) ^ -" ".length());
        f.lIlIIIIIIIlII[1] = " ".length();
        f.lIlIIIIIIIlII[2] = -(0xFFFF97B9 & 0x7C4F) & (0xFFFFFFFF & 0x7EFF);
        f.lIlIIIIIIIlII[3] = "  ".length();
        f.lIlIIIIIIIlII[4] = "   ".length();
        ...
        f.lIlIIIIIIIlII[8] = -" ".length() & (0xFFFFEBFF & 0x7EF9);
    ...
    private static void lIllIllIIllllII() {
        ...
        f.lIlIIIIIIIIlI[f.lIlIIIIIIIlII[0]] = f.lIllIllIIlllIIl("B/x+1Bvw+dA=", "fVkLM");
        f.lIlIIIIIIIIlI[f.lIlIIIIIIIlII[1]] = f.lIllIllIIlllIIl("TOnY68HTqfU=", "qKFSE");
        f.lIlIIIIIIIIlI[f.lIlIIIIIIIlII[3]] = f.lIllIllIIlllIIl("OZzkgH1976BgrZePsIUD8g==", "oHWSn");
        f.lIlIIIIIIIIlI[f.lIlIIIIIIIlII[4]] = f.lIllIllIIlllIll("EA0dBR42DB4cCQ==", "Wbqjh");
        f.lIlIIIIIIIIlI[f.lIlIIIIIIIlII[11]] = f.lIllIllIIlllIll("MyoZAhMwKxo=", "qeUMT");
        f.lIlIIIIIIIIlI[f.lIlIIIIIIIlII[13]] = f.lIllIllIIlllIll("GgYtIww5By4=", "XiALk");
        f.lIlIIIIIIIIlI[f.lIlIIIIIIIlII[15]] = f.lIllIllIIlllIll("Cj8CIDUHPgo=", "FpEac");
        f.lIlIIIIIIIIlI[f.lIlIIIIIIIlII[17]] = f.lIllIllIIlllIIl("UV/oiU9gHYdM6bNWhMVQEQ==", "BDCsq");
    }
