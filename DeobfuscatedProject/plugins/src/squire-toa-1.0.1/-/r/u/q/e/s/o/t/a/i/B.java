...
extends Task {
    ...
    private boolean M() {
        boolean bl;
        B llllllllllllllIlllIIllIlllllIlll;
        int llllllllllllllIlllIIllIlllllIllI;
        int n2 = this.M.getKeyboardIdleTicks();
        if (B.lIllIlIlllIIIIl(this.M.getMouseIdleTicks(), n2)) {
            llllllllllllllIlllIIllIlllllIllI = this.M.getMouseIdleTicks();
        }
        if (B.lIllIlIlllIIIlI(B.lIllIlIlllIIIII(llllllllllllllIlllIIllIlllllIllI, llllllllllllllIlllIIllIlllllIlll.aV))) {
            bl = lIlIIIIIIIllI[0];
            "".length();
            if (-" ".length() > " ".length()) {
