...
extends Enum<o> {
    ...
    private static void lIllIllIIlllllI() {
        ...
        o.lIlIIIIIllIll[o.lIlIIIIIlllII[0]] = o.lIllIllIIllllII("iEphhhSrsVg=", "QVBkr");
        o.lIlIIIIIllIll[o.lIlIIIIIlllII[1]] = o.lIllIllIIllllIl("JxgkNRQ9HDo8", "bYcyQ");
    }
    ...
    private static void lIllIllIIllllll() {
        ...
        o.lIlIIIIIlllII[0] = (93 + 136 - 184 + 148 ^ 2 + 114 - 67 + 90) & (0xD1 ^ 0x86 ^ (0x4E ^ 0x53) ^ -" ".length());
        o.lIlIIIIIlllII[1] = " ".length();
        o.lIlIIIIIlllII[2] = "  ".length();
