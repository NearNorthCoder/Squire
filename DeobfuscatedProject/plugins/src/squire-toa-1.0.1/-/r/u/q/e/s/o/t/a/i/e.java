...
public class e {
    ...
    public void a(GraphicsObjectCreated graphicsObjectCreated) {
        ...
        if (!e.lIllIllIlIIlIll(n2, lIlIIIIlIIIII[1]) || !e.lIllIllIlIIlIll(n2, lIlIIIIlIIIII[2]) || !e.lIllIllIlIIlIll(n2, lIlIIIIlIIIII[3]) || e.lIllIllIlIIllII(n2, lIlIIIIlIIIII[4])) {
            void llllllllllllllIlllIIlIlIlIlllIlI;
            e llllllllllllllIlllIIlIlIlIllllII;
            llllllllllllllIlllIIlIlIlIllllII.t.add((GraphicsObject)llllllllllllllIlllIIlIlIlIlllIlI);
            "".length();
        }
    }
    ...
    public void a(AnimationChanged animationChanged) {
        void llllllllllllllIlllIIlIlIlIllIIIl;
        Actor actor = animationChanged.getActor();
        if (e.lIllIllIlIIllIl(actor instanceof Player)) {
            return;
        }
        NPC llllllllllllllIlllIIlIlIlIllIIII = (NPC)llllllllllllllIlllIIlIlIlIllIIIl;
        int llllllllllllllIlllIIlIlIlIlIllll = llllllllllllllIlllIIlIlIlIllIIII.getAnimation();
        if (e.lIllIllIlIIllII(llllllllllllllIlllIIlIlIlIlIllll, lIlIIIIlIIIII[5])) {
            return;
        }
        this.t.clear();
    }
