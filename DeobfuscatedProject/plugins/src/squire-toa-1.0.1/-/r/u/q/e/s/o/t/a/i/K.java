...
extends y {
    ...
    private static void lIllIllIlIlIlll() {
        ...
        K.lIlIIIIlIIllI[1] = " ".length();
        K.lIlIIIIlIIllI[2] = "  ".length();
        K.lIlIIIIlIIllI[3] = 0xFFFFAF67 & 0x7E9F;
        K.lIlIIIIlIIllI[4] = "   ".length();
        K.lIlIIIIlIIllI[5] = 54 + 117 - 91 + 52 ^ 105 + 17 - 45 + 63;
    }

    private static void lIllIllIlIlIllI() {
        lIlIIIIlIIlIl = new String[lIlIIIIlIIllI[4]];
        K.lIlIIIIlIIlIl[K.lIlIIIIlIIllI[0]] = K.lIllIllIlIlIlII("ZNCO2O0vkhY=", "kizdP");
        K.lIlIIIIlIIlIl[K.lIlIIIIlIIllI[1]] = K.lIllIllIlIlIlIl("wZbSys7OzzA=", "avQhc");
        K.lIlIIIIlIIlIl[K.lIlIIIIlIIllI[2]] = K.lIllIllIlIlIlII("J8rvph3STJs=", "ZVHMu");
    }
