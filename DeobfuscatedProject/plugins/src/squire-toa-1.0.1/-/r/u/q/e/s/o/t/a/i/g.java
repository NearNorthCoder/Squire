...
public class g {
    ...
    public void a(GameObjectSpawned gameObjectSpawned) {
        void llllllllllllllIlllIlIIlIIIlllllI;
        GameObject gameObject = gameObjectSpawned.getGameObject();
        if (g.lIllIlIIlIIlIIl(A.contains(gameObject.getId()) ? 1 : 0)) {
            this.E.add(gameObject);
            "".length();
        }
        if (g.lIllIlIIlIIlIlI(llllllllllllllIlllIlIIlIIIlllllI.getId(), lIIllllIIllll[0])) {
            g llllllllllllllIlllIlIIlIIlIIIIII;
            llllllllllllllIlllIlIIlIIlIIIIII.G.add((GameObject)llllllllllllllIlllIlIIlIIIlllllI);
            "".length();
        }
    }
    ...
    public void a(NpcSpawned npcSpawned) {
        void llllllllllllllIlllIlIIlIIIlllIII;
        NPC nPC = npcSpawned.getNpc();
        if (g.lIllIlIIlIIlIlI(nPC.getId(), lIIllllIIllll[1])) {
            this.F.add(nPC);
            "".length();
        }
        if (g.lIllIlIIlIIlIlI(llllllllllllllIlllIlIIlIIIlllIII.getId(), lIIllllIIllll[2])) {
            g llllllllllllllIlllIlIIlIIIlllIlI;
            llllllllllllllIlllIlIIlIIIlllIlI.F.add((NPC)llllllllllllllIlllIlIIlIIIlllIII);
            "".length();
        }
    }
}
