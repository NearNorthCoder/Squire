...
extends OverlayPanel {
    ...
    private static void lIllIlIlIlIIIll() {
        ...
        DebugOverlay.lIIllllllIIII[1] = " ".length();
        DebugOverlay.lIIllllllIIII[2] = "  ".length();
    ...
    private static void lIllIlIlIlIIIlI() {
        ...
        DebugOverlay.lIIlllllIllll[DebugOverlay.lIIllllllIIII[0]] = DebugOverlay.lIllIlIlIlIIIII("YhMlDzXDmoOOBsljPCWQhQ==", "rohmP");
        DebugOverlay.lIIlllllIllll[DebugOverlay.lIIllllllIIII[1]] = DebugOverlay.lIllIlIlIlIIIIl("MiwZEwkQJAIbAUIdCgYN", "bIkuf");
    }
