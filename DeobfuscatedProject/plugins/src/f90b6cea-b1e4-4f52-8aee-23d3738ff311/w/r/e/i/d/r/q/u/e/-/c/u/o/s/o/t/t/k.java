...
extends Task {
    ...
    private static void llIIIIlllllllll() {
        ...
        k.lIllIIIIIlIIl[k.lIllIIIIIlIlI[0]] = k.llIIIIlllllllIl("6OS4mfOMS5ocwr2qSZgKrg==", "FcqGv");
        k.lIllIIIIIlIIl[k.lIllIIIIIlIlI[2]] = k.llIIIIllllllllI("tGYIXPfZ+o+ytVfYz68SkeWFEhhr2S8sKi3lrs48N7SWOsafaaI3Hw==", "bUyhJ");
        k.lIllIIIIIlIIl[k.lIllIIIIIlIlI[4]] = k.llIIIIllllllllI("7e7a5BZUh3O+oRDoQN9vkg==", "dHHNB");
        k.lIllIIIIIlIIl[k.lIllIIIIIlIlI[5]] = k.llIIIIllllllllI("4Eraqo6VJzPcK5EidrPKBw==", "EiPgH");
        k.lIllIIIIIlIIl[k.lIllIIIIIlIlI[1]] = k.llIIIIlllllllIl("1DkIAxjkdFqnw5TA5Qpv9g==", "ctHKx");
    }
    ...
    private static void llIIIlIIIIIIIII() {
        ...
        k.lIllIIIIIlIlI[2] = " ".length();
        k.lIllIIIIIlIlI[3] = 0x55 ^ 0x40 ^ (0x3E ^ 0x27);
        k.lIllIIIIIlIlI[4] = "  ".length();
        k.lIllIIIIIlIlI[5] = "   ".length();
        ...
        if (k.llIIIlIIIIIIlII(llllllllllllllIllIIllIlIlIIlIlll = TileObjects.getNearest(tileObject -> {
            ...
            if (k.llIIIlIIIIIIIlI(tileObject.getName().equals(this.K.tree().r() + " tree") ? 1 : 0)) {
                ...
                if (k.llIIIlIIIIIIIlI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((156 + 13 - 92 + 117 ^ 3 + 69 - 24 + 82) & (0x74 ^ 0x1D ^ (0x5C ^ 0x75) ^ -" ".length())) != 0;
                }
            }
            n = lIllIIIIIlIlI[0];
            return n != 0;
