...
extends Task {
    ...
    public boolean run() {
        ...
        while (l.llIIIlIIlIlIIII(llllllllllllllIllIIllIIIlIIlllII.hasNext() ? 1 : 0)) {
            ...
            if (l.llIIIlIIlIlIIlI(llllllllllllllIllIIllIIIlIIllIlI)) {
                ...
                return ((0x77 ^ 0x16 ^ (0x52 ^ 0x70)) & (9 + 7 - -132 + 67 ^ 97 + 110 - 77 + 18 ^ -" ".length())) != 0;
            }
    ...
    private static void llIIIlIIlIIlllI() {
        ...
        l.lIllIIIIlllll[l.lIllIIIlIIIII[0]] = l.llIIIlIIlIIllIl("BhEtMUohFz05Gg==", "RcHTj");
    }
}
