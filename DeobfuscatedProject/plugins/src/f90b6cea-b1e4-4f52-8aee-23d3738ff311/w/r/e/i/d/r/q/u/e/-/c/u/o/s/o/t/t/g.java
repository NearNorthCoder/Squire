...
extends Task {
    ...
    public boolean run() {
        g llllllllllllllIllIIllIIIllIIllll;
        if (g.llIIIlIIlIIIIII(this.t() ? 1 : 0)) {
            return lIllIIIIllIll[0];
        }
        if (g.llIIIlIIlIIIIIl(llllllllllllllIllIIllIIIllIIllll.E.p() ? 1 : 0)) {
            return lIllIIIIllIll[0];
        }
    ...
    public boolean t() {
        ...
        block3: {
            ...
            n = lIllIIIIllIll[2];
            "".length();
            if ((("  ".length() ^ (0x3F ^ 0x18)) & (0xC7 ^ 0x9B ^ (0x7C ^ 5) ^ -" ".length())) <= " ".length()) return n != 0;
            return ((0x78 ^ 0x28 ^ (0x15 ^ 0x64)) & (0x1D ^ 0x43 ^ 34 + 51 - 26 + 68 ^ -" ".length())) != 0;
        }
        n = lIllIIIIllIll[0];
        return n != 0;
    }
