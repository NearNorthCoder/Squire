...
extends Task {
    ...
    private static void llIIIlIIIIlllII() {
        ...
        j.lIllIIIIlIIIl[j.lIllIIIIlIIlI[0]] = j.llIIIlIIIIllIlI("hacDbSsDpo+WNkTnFIVFmw==", "LRxVL");
        j.lIllIIIIlIIIl[j.lIllIIIIlIIlI[2]] = j.llIIIlIIIIllIll("Xyqzqki0jUO5H2toO9ivPw==", "VBdJe");
    }
        ...
        TileObject llllllllllllllIllIIllIIllllIllIl = TileObjects.getNearest(tileObject -> {
            ...
            if (j.llIIIlIIIIlllll(tileObject.getName().equals(this.J.tree().r() + " tree") ? 1 : 0)) {
                ...
                if (j.llIIIlIIIIlllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0xDC ^ 0x8B ^ (0x18 ^ 0x6C)) & ("  ".length() ^ (0x39 ^ 0x18) ^ -" ".length())) != 0;
                }
            }
            n = lIllIIIIlIIlI[0];
            return n != 0;
