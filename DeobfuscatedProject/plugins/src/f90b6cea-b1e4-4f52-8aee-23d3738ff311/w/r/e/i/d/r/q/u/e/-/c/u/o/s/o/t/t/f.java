...
extends Task {
    ...
    private static void llIIIlIIIIIlIIl() {
        ...
        f.lIllIIIIIllIl[f.lIllIIIIIlllI[0]] = f.llIIIlIIIIIlIII("NxIRFQ==", "cszpi");
        f.lIllIIIIIllIl[f.lIllIIIIIlllI[2]] = f.llIIIlIIIIIlIII("GxUDOQ==", "uppMw");
    }
    ...
    private static void llIIIlIIIIIlIlI() {
        ...
        f.lIllIIIIIlllI[2] = " ".length();
        f.lIllIIIIIlllI[3] = "  ".length();
    }
