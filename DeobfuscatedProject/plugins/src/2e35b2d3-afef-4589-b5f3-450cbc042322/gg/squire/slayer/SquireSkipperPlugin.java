...
extends SquirePlugin {
    ...
    private static String lIlllIlIIIllIIl(String llllllllllllllIllIllllIIIIIlIIlI, String llllllllllllllIllIllllIIIIIIllII) {
        llllllllllllllIllIllllIIIIIlIIlI = new String(Base64.getDecoder().decode(llllllllllllllIllIllllIIIIIlIIlI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllIllIllllIIIIIlIIII = new StringBuilder();
        char[] llllllllllllllIllIllllIIIIIIllll = llllllllllllllIllIllllIIIIIIllII.toCharArray();
        int llllllllllllllIllIllllIIIIIIlllI = lIlIIlIIIllIl[1];
        char[] llllllllllllllIllIllllIIIIIIlIII = llllllllllllllIllIllllIIIIIlIIlI.toCharArray();
        int llllllllllllllIllIllllIIIIIIIlll = llllllllllllllIllIllllIIIIIIlIII.length;
        int llllllllllllllIllIllllIIIIIIIllI = lIlIIlIIIllIl[1];
        while (SquireSkipperPlugin.lIlllIlIIlIIIlI(llllllllllllllIllIllllIIIIIIIllI, llllllllllllllIllIllllIIIIIIIlll)) {
            char llllllllllllllIllIllllIIIIIlIIll = llllllllllllllIllIllllIIIIIIlIII[llllllllllllllIllIllllIIIIIIIllI];
            llllllllllllllIllIllllIIIIIlIIII.append((char)(llllllllllllllIllIllllIIIIIlIIll ^ llllllllllllllIllIllllIIIIIIllll[llllllllllllllIllIllllIIIIIIlllI % llllllllllllllIllIllllIIIIIIllll.length]));
            "".length();
            ++llllllllllllllIllIllllIIIIIIlllI;
            ++llllllllllllllIllIllllIIIIIIIllI;
            "".length();
    ...
    public void a(ChatMessage chatMessage) {
        Matcher llllllllllllllIllIllllIIIIlIIIlI;
        SquireSkipperPlugin llllllllllllllIllIllllIIIIlIIlIl;
        void llllllllllllllIllIllllIIIIlIIlII;
        ...
        String llllllllllllllIllIllllIIIIlIIIll = Text.removeTags((String)llllllllllllllIllIllllIIIIlIIlII.getMessage());
        if (SquireSkipperPlugin.lIlllIlIIIlllll(llllllllllllllIllIllllIIIIlIIIll.contains(lIlIIlIIIllII[lIlIIlIIIllIl[1]]) ? 1 : 0)) {
            llllllllllllllIllIllllIIIIlIIlIl.a((b)null);
            llllllllllllllIllIllllIIIIlIIlIl.a(lIlIIlIIIllIl[0]);
            llllllllllllllIllIllllIIIIlIIlIl.b(lIlIIlIIIllIl[1]);
        }
        if (SquireSkipperPlugin.lIlllIlIIIlllll(llllllllllllllIllIllllIIIIlIIIll.contains(lIlIIlIIIllII[lIlIIlIIIllIl[0]]) ? 1 : 0)) {
            llllllllllllllIllIllllIIIIlIIlIl.a(lIlIIlIIIllIl[0]);
            llllllllllllllIllIllllIIIIlIIlIl.a((b)null);
            llllllllllllllIllIllllIIIIlIIlIl.b(lIlIIlIIIllIl[1]);
            llllllllllllllIllIllllIIIIlIIlIl.k += lIlIIlIIIllIl[0];
        }
        if (SquireSkipperPlugin.lIlllIlIIIlllll((llllllllllllllIllIllllIIIIlIIIlI = b.matcher(llllllllllllllIllIllllIIIIlIIIll)).find() ? 1 : 0)) {
            String llllllllllllllIllIllllIIIIlIIIIl = llllllllllllllIllIllllIIIIlIIIlI.group(lIlIIlIIIllII[lIlIIlIIIllIl[2]]);
            b llllllllllllllIllIllllIIIIlIIIII = s.s.e.u.p.i.r.r.-.q.a.e.k.r.l.u.i.p.e.t.-.b.b(llllllllllllllIllIllllIIIIlIIIIl);
            if (SquireSkipperPlugin.lIlllIlIIlIIIII((Object)llllllllllllllIllIllllIIIIlIIIII)) {
                llllllllllllllIllIllllIIIIlIIlIl.b(lIlIIlIIIllIl[0]);
                llllllllllllllIllIllllIIIIlIIlIl.a(lIlIIlIIIllIl[0]);
                llllllllllllllIllIllllIIIIlIIlIl.a((b)null);
                llllllllllllllIllIllllIIIIlIIlIl.b(lIlIIlIIIllIl[1]);
                return;
            ...
            llllllllllllllIllIllllIIIIlIIlIl.b(lIlIIlIIIllIl[1]);
            int llllllllllllllIllIllllIIIIIlllll = Integer.parseInt(llllllllllllllIllIllllIIIIlIIIlI.group(lIlIIlIIIllII[lIlIIlIIIllIl[3]]));
            llllllllllllllIllIllllIIIIlIIlIl.b(llllllllllllllIllIllllIIIIIlllll);
            llllllllllllllIllIllllIIIIlIIlIl.a(llllllllllllllIllIllllIIIIlIIIII);
        }
    }
    ...
    private static String lIlllIlIIIllIlI(String llllllllllllllIllIlllIlllllIlllI, String llllllllllllllIllIlllIlllllIllIl) {
        try {
            SecretKeySpec llllllllllllllIllIlllIllllllIIll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllIllIlllIlllllIllIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            return new String(llllllllllllllIllIlllIllllllIIlI.doFinal(Base64.getDecoder().decode(llllllllllllllIllIlllIlllllIlllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlllIlIIIllIll(String llllllllllllllIllIlllIllllllllIl, String llllllllllllllIllIlllIlllllllIlI) {
        try {
            SecretKeySpec llllllllllllllIllIllllIIIIIIIIII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllIllIlllIlllllllIlI.getBytes(StandardCharsets.UTF_8)), lIlIIlIIIllIl[11]), "DES");
    ...
    private static void lIlllIlIIIlllIl() {
        ...
        SquireSkipperPlugin.lIlIIlIIIllIl[0] = " ".length();
        SquireSkipperPlugin.lIlIIlIIIllIl[1] = (95 + 125 - 47 + 10 ^ 60 + 47 - -8 + 76) & (0xA8 ^ 0x9D ^ (0xA3 ^ 0x9E) ^ -" ".length());
        SquireSkipperPlugin.lIlIIlIIIllIl[2] = "  ".length();
        SquireSkipperPlugin.lIlIIlIIIllIl[3] = "   ".length();
    ...
    private static void lIlllIlIIIlllII() {
        ...
        SquireSkipperPlugin.lIlIIlIIIllII[SquireSkipperPlugin.lIlIIlIIIllIl[1]] = SquireSkipperPlugin.lIlllIlIIIllIIl("Hz0lPyYEOyY9cgI3P3omA3IgLzwY", "lRHZR");
        SquireSkipperPlugin.lIlIIlIIIllII[SquireSkipperPlugin.lIlIIlIIIllIl[0]] = SquireSkipperPlugin.lIlllIlIIIllIIl("DS4ZPQkLNREpRRcuAT9FGiAHJg==", "nAtMe");
        SquireSkipperPlugin.lIlIIlIIIllII[SquireSkipperPlugin.lIlIIlIIIllIl[2]] = SquireSkipperPlugin.lIlllIlIIIllIlI("SC3GfHb9X0A=", "sRTOH");
        SquireSkipperPlugin.lIlIIlIIIllII[SquireSkipperPlugin.lIlIIlIIIllIl[3]] = SquireSkipperPlugin.lIlllIlIIIllIlI("QYYZQyWR+U4=", "YUuIH");
        SquireSkipperPlugin.lIlIIlIIIllII[SquireSkipperPlugin.lIlIIlIIIllIl[7]] = SquireSkipperPlugin.lIlllIlIIIllIll("QOcrI3Id+dZNrj2PCqYFnFmQ9QXOZri0ZwRGv9tt0B4=", "ucrza");
        SquireSkipperPlugin.lIlIIlIIIllII[SquireSkipperPlugin.lIlIIlIIIllIl[8]] = SquireSkipperPlugin.lIlllIlIIIllIIl("", "ltwBg");
    }
    ...
    public boolean a(int n2) {
        ...
        if (SquireSkipperPlugin.lIlllIlIIlIIIIl(n2 % lIlIIlIIIllIl[4], lIlIIlIIIllIl[5])) {
            ...
            "".length();
            if ("  ".length() <= " ".length()) {
                return ((0x80 ^ 0x85 ^ (0x2C ^ 0x1D)) & (0x29 ^ 0x78 ^ (0x72 ^ 0x17) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlIIlIIIllIl[1];
        }
