...
extends Task {
    ...
    private static void lIlllIlIIlIllll() {
        ...
        g.lIlIIlIIlIIlI[g.lIlIIlIIlIIll[0]] = g.lIlllIlIIlIlllI("Mhk/LS0=", "vkVCF");
        g.lIlIIlIIlIIlI[g.lIlIIlIIlIIll[2]] = g.lIlllIlIIlIlllI("IxwlIAIeCQ==", "phDMk");
    }
    ...
    private static void lIlllIlIIllIIII() {
        ...
        g.lIlIIlIIlIIll[0] = (0xE3 ^ 0x96 ^ (0x85 ^ 0xAA)) & (0x40 ^ 0x3B ^ (0xA ^ 0x2B) ^ -" ".length());
        g.lIlIIlIIlIIll[1] = 11 + 108 - 51 + 77 ^ 108 + 47 - 119 + 122;
        g.lIlIIlIIlIIll[2] = " ".length();
        g.lIlIIlIIlIIll[3] = "  ".length();
    }
