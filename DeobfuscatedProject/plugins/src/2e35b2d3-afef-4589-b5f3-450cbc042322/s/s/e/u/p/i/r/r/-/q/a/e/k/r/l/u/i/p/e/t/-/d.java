...
extends Task {
    ...
    private boolean a(int[] nArray) {
        ...
        while (d.lIlllIllIIIlIIl(llllllllllllllIllIlllIIlIIlllllI, (int)llllllllllllllIllIlllIIlIIllllll)) {
            ...
            "".length();
            if (" ".length() < (30 + 46 - -48 + 36 ^ 19 + 124 - 127 + 148)) continue;
            return ((124 + 164 - 97 + 17 ^ 8 + 127 - 72 + 70) & (98 + 100 - 164 + 181 ^ 128 + 71 - 117 + 48 ^ -" ".length())) != 0;
        }
        ...
        if (d.lIlllIllIIIIllI((Object)(llllllllllllllIllIlllIIlIllIIllI = llllllllllllllIllIlllIIlIllIlIII.w.b()))) {
            ...
            if (d.lIlllIllIIIIIll(llllllllllllllIllIlllIIlIllIIllI.o() ? 1 : 0) && d.lIlllIllIIIIlIl(llllllllllllllIllIlllIIlIllIlIII.a(t) ? 1 : 0)) {
                ...
                if (d.lIlllIllIIIIlll(Inventory.getFreeSlots(), lIlIIlIIlllll[5])) {
                    ...
                    "".length();
                    if (null != null) {
                        return ((0xCF ^ 0x8D ^ (0x6C ^ 8)) & (92 + 40 - 45 + 77 ^ 24 + 91 - 94 + 109 ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIlIIlIIlllll[1];
                }
            ...
            if (d.lIlllIllIIIIllI(llllllllllllllIllIlllIIlIllIIlIl2 = llllllllllllllIllIlllIIlIllIIllI.p())) {
                ...
                while (d.lIlllIllIIIIIll(llllllllllllllIllIlllIIlIllIIlII.hasNext() ? 1 : 0)) {
                    ...
                    if (d.lIlllIllIIIIIll(llllllllllllllIllIlllIIlIllIlIII.h(llllllllllllllIllIlllIIlIllIIIll) ? 1 : 0) && d.lIlllIllIIIIIll(llllllllllllllIllIlllIIlIllIlIII.i(lIlIIlIIllllI[lIlIIlIIlllll[5]]) ? 1 : 0)) {
                        ...
                        return ((0x33 ^ 0x4D ^ (0x69 ^ 0x26)) & (18 + 88 - 80 + 141 ^ 119 + 148 - 266 + 149 ^ -" ".length())) != 0;
                    }
    ...
    private boolean i(String string) {
        ...
        if (!d.lIlllIllIIIIlIl(Inventory.contains(item -> item.getName().toLowerCase().contains(string.toLowerCase())) ? 1 : 0) || d.lIlllIllIIIIIll(Equipment.contains(item -> item.getName().toLowerCase().contains(string.toLowerCase())) ? 1 : 0)) {
            ...
            "".length();
            if (" ".length() <= -" ".length()) {
                return ((0x9B ^ 0x87 ^ (0xC6 ^ 0x95)) & (0x19 ^ 0x76 ^ (0x56 ^ 0x76) ^ -" ".length()) & ((0x4F ^ 0x56 ^ (0x16 ^ 0x5B)) & (145 + 34 - 105 + 127 ^ 66 + 145 - 165 + 111 ^ -" ".length()) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlIIlIIlllll[0];
        }
    ...
    private boolean h(int n2) {
        ...
        while (d.lIlllIllIIIlIIl(llllllllllllllIllIlllIIlIIllIlII, (int)llllllllllllllIllIlllIIlIIllIlIl)) {
            ...
            "".length();
            if (" ".length() == " ".length()) continue;
            return ((7 ^ 0x2B ^ (0x3D ^ 0x1E)) & (0xFB ^ 0xC6 ^ (3 ^ 0x31) ^ -" ".length())) != 0;
        }
        return lIlIIlIIlllll[0];
    }
    ...
    private static void lIlllIllIIIIIlI() {
        ...
        d.lIlIIlIIlllll[0] = (245 + 34 - 168 + 138 ^ 131 + 62 - 87 + 76) & (119 + 16 - 55 + 170 ^ 77 + 121 - 95 + 78 ^ -" ".length());
        d.lIlIIlIIlllll[1] = " ".length();
        d.lIlIIlIIlllll[2] = "  ".length();
        d.lIlIIlIIlllll[3] = "   ".length();
        d.lIlIIlIIlllll[4] = 9 ^ 0x16 ^ (0x8F ^ 0x94);
        d.lIlIIlIIlllll[5] = 0xB9 ^ 0xBC;
        d.lIlIIlIIlllll[6] = -" ".length();
        d.lIlIIlIIlllll[7] = -(0xFFFFB3CF & 0x6DB7) & (0xFFFFBBBF & 0x7FEE);
        d.lIlIIlIIlllll[8] = -" ".length() & (0xFFFFFFFF & Integer.MAX_VALUE);
    ...
    private static void lIlllIlIllIlIlI() {
        ...
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[0]] = d.lIlllIlIllIIIlI("uVZS4EOyKxjH06BiXm6Qk7ZOzES/bhuy2SIBpK7/mYg=", "zYVqi");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[1]] = d.lIlllIlIllIIIlI("ciCZAvfmnVY=", "uUVfs");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[2]] = d.lIlllIlIllIIIlI("ECv3gPuQ1mw=", "VGOmd");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[3]] = d.lIlllIlIllIIIll("AO7x25euWsUnTw4xXat37KKluDf548mS", "eCOPd");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[4]] = d.lIlllIlIllIIIlI("0qNxOzkD60qR+01NZEQecA==", "zYqIF");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[5]] = d.lIlllIlIllIIIlI("F2XoVe7z7mEcf6iPH0buwQ==", "rmtPj");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[9]] = d.lIlllIlIllIlIII("AD8MMTwBcwUtNR4=", "sSmHY");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[10]] = d.lIlllIlIllIIIll("aHeIxJIv0+EeA5iTe9VK0A==", "qUnCz");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[11]] = d.lIlllIlIllIlIII("Kg8uLw==", "KaZFC");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[12]] = d.lIlllIlIllIlIII("IAoHAT4=", "dxnoU");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[13]] = d.lIlllIlIllIIIll("5WMWOwGWW4I=", "jEnfv");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[14]] = d.lIlllIlIllIIIll("9UsJWJYDV34=", "CYpdQ");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[15]] = d.lIlllIlIllIIIll("C+db3KFbqHE=", "ItCcg");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[16]] = d.lIlllIlIllIIIll("e5k8SRSPLVT7nmu4Ifulww==", "luyDM");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[17]] = d.lIlllIlIllIlIII("GwQ8Nx8/DiE8RQ==", "LeHRm");
        d.lIlIIlIIllllI[d.lIlIIlIIlllll[18]] = d.lIlllIlIllIIIll("mQbIbX3OA10cqmHwhsDXQg==", "BYGlr");
    }
        ...
        if (d.lIlllIllIIIIIll(llllllllllllllIllIlllIIlIlIlIIIl.x.antiPoison() ? 1 : 0) && d.lIlllIllIIIIlIl(Inventory.contains(item -> {
            ...
            if (d.lIlllIllIIIIIll(item.getName().toLowerCase().contains(lIlIIlIIllllI[lIlIIlIIlllll[11]]) ? 1 : 0)) {
                ...
                if (d.lIlllIllIIIIIll(item.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x4B ^ 0x59 ^ (0x1D ^ 0x42)) & (0x17 ^ 0x20 ^ (0xBC ^ 0xC6) ^ -" ".length())) != 0;
                }
            }
            n2 = lIlIIlIIlllll[0];
            return n2 != 0;
        ...
        if (d.lIlllIllIIIIllI((Object)llllllllllllllIllIlllIIlIlIlIIII)) {
            ...
            if (d.lIlllIllIIIIllI(llllllllllllllIllIlllIIlIlIIllll)) {
                ...
                while (d.lIlllIllIIIIIll(llllllllllllllIllIlllIIlIlIIlllI.hasNext() ? 1 : 0)) {
                    ...
                    "".length();
                    if ("   ".length() > ((0xE2 ^ 0xAC) & ~(0x7E ^ 0x30))) continue;
