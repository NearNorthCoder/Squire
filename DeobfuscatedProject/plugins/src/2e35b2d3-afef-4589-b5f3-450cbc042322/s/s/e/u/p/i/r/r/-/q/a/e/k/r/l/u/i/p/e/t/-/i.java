...
extends Task {
    ...
    private static void lIlllIlIIlllllI() {
        ...
        i.lIlIIlIIlIlII[i.lIlIIlIIlIllI[0]] = i.lIlllIlIIlllIll("aOc4z5MIYWfzelrxAsIpf33TYlkTnoNk0FY3quLM/tY=", "ZreHb");
        i.lIlIIlIIlIlII[i.lIlIIlIIlIllI[1]] = i.lIlllIlIIlllIll("MEe7G+5WrqghFER8PrtRqE2TV5fdgY+B", "Cvehq");
        i.lIlIIlIIlIlII[i.lIlIIlIIlIllI[2]] = i.lIlllIlIIllllII("HBpDKDMgXg==", "SrcQV");
        i.lIlIIlIIlIlII[i.lIlIIlIIlIllI[3]] = i.lIlllIlIIllllII("LyELChcOaBEMChpoBwIKAg==", "iHscy");
        i.lIlIIlIIlIlII[i.lIlIIlIIlIllI[4]] = i.lIlllIlIIllllIl("owEabd62aD/ahG29gshJGSR97ixzSqh2", "oeHLj");
    }

    private static void lIlllIlIlIIIIlI() {
        lIlIIlIIlIllI = new int[7];
        i.lIlIIlIIlIllI[0] = (0x29 ^ 0x69 ^ (0xC7 ^ 0xA2)) & (0x23 ^ 0x6F ^ (0xEE ^ 0x87) ^ -" ".length());
        i.lIlIIlIIlIllI[1] = " ".length();
        i.lIlIIlIIlIllI[2] = "  ".length();
        i.lIlIIlIIlIllI[3] = "   ".length();
    ...
    private static String lIlllIlIIllllII(String llllllllllllllIllIlllIllIIllIIlI, String llllllllllllllIllIlllIllIIllIllI) {
        ...
        while (i.lIlllIlIlIIIlIl(llllllllllllllIllIlllIllIIlIlIll, llllllllllllllIllIlllIllIIlIllII)) {
            ...
            "".length();
            if (((18 + 21 - -47 + 163 ^ 88 + 91 - 26 + 16) & (196 + 100 - 242 + 197 ^ 138 + 142 - 161 + 52 ^ -" ".length())) <= (98 + 41 - 48 + 62 ^ 37 + 75 - 87 + 132)) continue;
            return null;
        }
