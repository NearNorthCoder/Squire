...
extends Task {
    ...
    private static void lIlllIlIllIllll() {
        ...
        j.lIlIIlIlIIIIl[0] = (12 + 139 - -30 + 0 ^ 81 + 92 - 117 + 98) & (114 + 60 - 142 + 97 ^ 125 + 114 - 170 + 105 ^ -" ".length());
        j.lIlIIlIlIIIIl[1] = " ".length();
        j.lIlIIlIlIIIIl[2] = 0x51 ^ 0x55;
        j.lIlIIlIlIIIIl[3] = "  ".length();
        j.lIlIIlIlIIIIl[4] = "   ".length();
    ...
    public boolean j(String string) {
        ...
        if (j.lIlllIlIlllIIlI(string2.contains(lIlIIlIlIIIII[lIlIIlIlIIIIl[4]]) ? 1 : 0)) {
            ...
            while (j.lIlllIlIlllIIll(llllllllllllllIllIlllIIlllllIIlI, (int)llllllllllllllIllIlllIIlllllIIll)) {
                ...
                return ((0xF0 ^ 0x83 ^ (0x60 ^ 0x73)) & (159 + 134 - 154 + 27 ^ 13 + 131 - 10 + 64 ^ -" ".length())) != 0;
            }
        }
    ...
    private static void lIlllIlIllIlllI() {
        ...
        j.lIlIIlIlIIIII[j.lIlIIlIlIIIIl[0]] = j.lIlllIlIllIlIll("Io4jTSQNNkHIjh/StECGDU8EENuVgCzEOkrGZ+eoaxSlafzz4hkjCQ==", "OLlzO");
        j.lIlIIlIlIIIII[j.lIlIIlIlIIIIl[1]] = j.lIlllIlIllIllII("MTcrOVAUPyspUBojKzkZHDFlIBEBIiA/", "rVEMp");
        j.lIlIIlIlIIIII[j.lIlIIlIlIIIIl[3]] = j.lIlllIlIllIllII("BAEcIy0rHwokPg==", "EroJJ");
        j.lIlIIlIlIIIII[j.lIlIIlIlIIIIl[4]] = j.lIlllIlIllIllII("QQ==", "mkftI");
        j.lIlIIlIlIIIII[j.lIlIIlIlIIIIl[2]] = j.lIlllIlIllIllIl("rfqe2OsAvYQ=", "SlfEr");
        j.lIlIIlIlIIIII[j.lIlIIlIlIIIIl[5]] = j.lIlllIlIllIllIl("ZTet5IjTG8dU1IJayFwt1bDhfFUcbQ+eFDiePtLHJfEvfqeAujdk2w==", "AQMUQ");
        j.lIlIIlIlIIIII[j.lIlIIlIlIIIIl[6]] = j.lIlllIlIllIllII("JAQYPR0eHhBhTREfAiMJVwQfKE0fBRk5CBNQAyweHFE=", "wpwMm");
        j.lIlIIlIlIIIII[j.lIlIIlIlIIIIl[7]] = j.lIlllIlIllIllII("KQk0EwoGFyIUGQ==", "hzGzm");
    }
