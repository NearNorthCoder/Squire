...
extends Task {
    ...
    private static void lIlllIlIlIIlIlI() {
        ...
        c.lIlIIlIIllIII[0] = (0xB8 ^ 0x8E ^ (2 ^ 0x16)) & (0xF8 ^ 0xB3 ^ (0xF6 ^ 0x9F) ^ -" ".length());
        c.lIlIIlIIllIII[1] = " ".length();
        c.lIlIIlIIllIII[2] = "  ".length();
        c.lIlIIlIIllIII[3] = "   ".length();
    ...
    private static void lIlllIlIlIIlIIl() {
        ...
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[0]] = c.lIlllIlIIllllll("7PkvgL8vtESJepxHC6qv8Q==", "lbvNA");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[1]] = c.lIlllIlIlIIIIII("VOPK0lerBQQ948DxhYRETGXW6wDtyJ3nsqDagY+Kd93jix+eD9XNrylREdO6An00", "DfUOU");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[2]] = c.lIlllIlIlIIIIIl("HwAbBAc7CgYPXXhI", "Haoau");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[3]] = c.lIlllIlIlIIIIII("E74MSy6/pylMwvNXVTLO5A==", "zNCZO");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[4]] = c.lIlllIlIIllllll("gtoMrpKVcZc=", "BmDMK");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[6]] = c.lIlllIlIIllllll("LWVDYlwbCrzdKoCO2EiKqsmtczTRVPZO", "vePFb");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[7]] = c.lIlllIlIlIIIIII("WAkAGWc1WGyzZOOb6Xm5GoDdJD7daakOuerdP35aofQ=", "JyeWJ");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[9]] = c.lIlllIlIIllllll("rzlKH0v3mJ9PqgD1C4DJkFGrdAuxKCr9", "JWbnV");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[10]] = c.lIlllIlIlIIIIII("GZY8QeHySZE=", "CNUKk");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[11]] = c.lIlllIlIIllllll("WxKrUSKgLjA=", "PAdrm");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[12]] = c.lIlllIlIlIIIIII("g2G87ZllQ7s=", "XCxgx");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[13]] = c.lIlllIlIlIIIIII("+/HIfyj/F3M=", "iKLUE");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[14]] = c.lIlllIlIlIIIIII("+zNXuYHPjIE=", "SRmvd");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[15]] = c.lIlllIlIlIIIIII("fj1vhr58fSs=", "CXnKJ");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[16]] = c.lIlllIlIIllllll("gy3B7dyN24Y=", "ZDqHK");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[5]] = c.lIlllIlIlIIIIII("1PsVbgo4A4U=", "miXju");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[17]] = c.lIlllIlIlIIIIII("l1apBCDo5SM=", "RMwFB");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[18]] = c.lIlllIlIlIIIIIl("KCA=", "FOuwl");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[19]] = c.lIlllIlIlIIIIIl("ByYGHxUB", "uCvpg");
        c.lIlIIlIIlIlIl[c.lIlIIlIIllIII[20]] = c.lIlllIlIIllllll("zaJiO9YhNEU=", "aeZll");
    }
