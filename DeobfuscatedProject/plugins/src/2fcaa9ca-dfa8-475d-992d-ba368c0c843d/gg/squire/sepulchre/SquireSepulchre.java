...
extends SquirePlugin {
     ...
     */
    private void b() {
        x lllllllllllllllIIllIllIllIIlIlll;
        q lllllllllllllllIIllIllIllIIllIII;
        w lllllllllllllllIIllIllIllIIllIlI;
        SquireSepulchre lllllllllllllllIIllIllIllIIlllII;
        void lllllllllllllllIIllIllIllIIllIll;
        this.j().add(item -> {
            boolean bl;
        ...
        if (SquireSepulchre.lIIIlIIlIllIllI(lllllllllllllllIIllIllIllIIllIll, (Object)y.OAK_MITHRIL)) {
            lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[11], lllIIIllIlII[7]);
            "".length();
            lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[12]);
            "".length();
        }
        if (SquireSepulchre.lIIIlIIlIllIllI(lllllllllllllllIIllIllIllIIllIll, (Object)y.TEAK_ADAMANT)) {
            lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[13], lllIIIllIlII[7]);
            "".length();
            lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[14]);
            "".length();
        }
        if (SquireSepulchre.lIIIlIIlIllIllI(lllllllllllllllIIllIllIllIIllIll, (Object)y.MAHOGANY_RUNE)) {
            lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[15], lllIIIllIlII[7]);
            "".length();
            lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[16]);
            "".length();
        }
        if (SquireSepulchre.lIIIlIIlIllIllI((Object)(lllllllllllllllIIllIllIllIIllIlI = lllllllllllllllIIllIllIllIIlllII.m.hammer()), (Object)w.HAMMER)) {
            lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[17], lllIIIllIlII[1]);
            "".length();
            lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[18], lllIIIllIlII[1]);
            "".length();
        }
        if (SquireSepulchre.lIIIlIIlIllIllI((Object)lllllllllllllllIIllIllIllIIllIlI, (Object)w.HALLOWED_HAMMER)) {
            lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[19], lllIIIllIlII[1]);
            "".length();
            lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[18], lllIIIllIlII[1]);
            "".length();
        }
        lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[20], lllllllllllllllIIllIllIllIIlllII.m.dust());
        "".length();
        z lllllllllllllllIIllIllIllIIllIIl = lllllllllllllllIIllIllIllIIlllII.m.portal();
        if (SquireSepulchre.lIIIlIIlIllIlll((Object)lllllllllllllllIIllIllIllIIllIIl, (Object)z.NONE)) {
            lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[21]);
            "".length();
            if (SquireSepulchre.lIIIlIIlIllIllI((Object)lllllllllllllllIIllIllIllIIllIIl, (Object)z.LV1_ENCHANT)) {
                lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[22]);
                "".length();
                "".length();
                if (((178 + 125 - 214 + 94 ^ 143 + 145 - 210 + 68) & (108 + 179 - 204 + 107 ^ 26 + 6 - -73 + 50 ^ -" ".length())) != 0) {
                    return;
                }
            } else if (SquireSepulchre.lIIIlIIlIllIllI((Object)lllllllllllllllIIllIllIllIIllIIl, (Object)z.LV2_ENCHANT)) {
                lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[23]);
                "".length();
                "".length();
                if ("   ".length() > "   ".length()) {
                    return;
                }
            } else if (SquireSepulchre.lIIIlIIlIllIllI((Object)lllllllllllllllIIllIllIllIIllIIl, (Object)z.LV3_ENCHANT)) {
                lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[24]);
                "".length();
                "".length();
                if ((0x6F ^ 0x6B) <= "   ".length()) {
                    return;
                }
            } else if (SquireSepulchre.lIIIlIIlIllIllI((Object)lllllllllllllllIIllIllIllIIllIIl, (Object)z.LV4_ENCHANT)) {
                lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[25]);
                "".length();
                "".length();
                if (((116 + 64 - 61 + 38 ^ 12 + 124 - 83 + 85) & (0x7E ^ 0x3B ^ (0x42 ^ 0x10) ^ -" ".length())) < -" ".length()) {
                    return;
                }
            } else if (SquireSepulchre.lIIIlIIlIllIllI((Object)lllllllllllllllIIllIllIllIIllIIl, (Object)z.LV5_ENCHANT)) {
                lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[25]);
                "".length();
                lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[22]);
                "".length();
            ...
            } else if (SquireSepulchre.lIIIlIIlIllIllI((Object)lllllllllllllllIIllIllIllIIllIIl, (Object)z.LV6_ENCHANT)) {
                lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[25]);
                "".length();
                lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[24]);
                "".length();
        ...
        if (SquireSepulchre.lIIIlIIlIlllIII((Object)(lllllllllllllllIIllIllIllIIllIII = lllllllllllllllIIllIllIllIIlllII.m.food()))) {
            lllllllllllllllIIllIllIllIIlllII.j().add(lllllllllllllllIIllIllIllIIllIII.V(), lllllllllllllllIIllIllIllIIlllII.m.foodAmount());
            "".length();
        }
        if (SquireSepulchre.lIIIlIIlIllIllI((Object)(lllllllllllllllIIllIllIllIIlIlll = lllllllllllllllIIllIllIllIIlllII.m.lockpick()), (Object)x.STRANGE_LOCKPICK)) {
            lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[26], lllIIIllIlII[1]);
            "".length();
        }
        if (SquireSepulchre.lIIIlIIlIllIllI((Object)lllllllllllllllIIllIllIllIIlIlll, (Object)x.LOCKPICK)) {
            lllllllllllllllIIllIllIllIIlllII.j().add(lllIIIllIlII[27], lllIIIllIlII[1]);
            "".length();
        }
    }
    ...
    public void a(List<WorldArea> list) {
        this.f.clear();
        Iterator<WorldArea> lllllllllllllllIIllIllIllIlIIlII = list.iterator();
        while (SquireSepulchre.lIIIlIIlIllIlIl(lllllllllllllllIIllIllIllIlIIlII.hasNext() ? 1 : 0)) {
            SquireSepulchre lllllllllllllllIIllIllIllIlIIllI;
            WorldArea lllllllllllllllIIllIllIllIlIIIll = lllllllllllllllIIllIllIllIlIIlII.next();
            lllllllllllllllIIllIllIllIlIIllI.f.addAll(lllllllllllllllIIllIllIllIlIIIll.toWorldPointList());
            "".length();
            "".length();
            if ((0x67 ^ 0x53 ^ (0x77 ^ 0x47)) > "   ".length()) continue;
            return;
        }
    }
    ...
    private static String lIIIlIIlIllIIIl(String lllllllllllllllIIllIllIllIIIllIl, String lllllllllllllllIIllIllIllIIIllII) {
        try {
            SecretKeySpec lllllllllllllllIIllIllIllIIlIIII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIllIllIllIIIllII.getBytes(StandardCharsets.UTF_8)), lllIIIllIlII[2]), "DES");
            Cipher lllllllllllllllIIllIllIllIIIllll = Cipher.getInstance("DES");
            lllllllllllllllIIllIllIllIIIllll.init(lllIIIllIlII[3], lllllllllllllllIIllIllIllIIlIIII);
            return new String(lllllllllllllllIIllIllIllIIIllll.doFinal(Base64.getDecoder().decode(lllllllllllllllIIllIllIllIIIllIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIIIlIIlIllIIll() {
        ...
        SquireSepulchre.lllIIIllIlII[1] = " ".length();
        SquireSepulchre.lllIIIllIlII[2] = 0x10 ^ 0x18;
        SquireSepulchre.lllIIIllIlII[3] = "  ".length();
        SquireSepulchre.lllIIIllIlII[4] = "   ".length();
