...
extends Enum<w> {
    ...
    private static void lIIIlIIIIlIllII() {
        ...
        w.lllIIIIIllll[w.lllIIIIlIIIl[0]] = w.lIIIlIIIIlIlIlI("FRYtb5gkZQE=", "YNSUh");
        w.lllIIIIIllll[w.lllIIIIlIIIl[1]] = w.lIIIlIIIIlIlIll("PjL+8IStxZs=", "AlLse");
        w.lllIIIIIllll[w.lllIIIIlIIIl[2]] = w.lIIIlIIIIlIlIll("VktYtZNlcZ8=", "agcUj");
        w.lllIIIIIllll[w.lllIIIIlIIIl[3]] = w.lIIIlIIIIlIlIll("vYV7rM2oGPs=", "QDZjJ");
        w.lllIIIIIllll[w.lllIIIIlIIIl[4]] = w.lIIIlIIIIlIlIlI("o0fCCw9ObRpwPRhdcZTQ1Q==", "NIecm");
        w.lllIIIIIllll[w.lllIIIIlIIIl[5]] = w.lIIIlIIIIlIlIlI("r3ZDejkROy7l5mtivQZnoA==", "nhlfl");
    }
    ...
    private static void lIIIlIIIIlllIIl() {
        ...
        w.lllIIIIlIIIl[1] = " ".length();
        w.lllIIIIlIIIl[2] = "  ".length();
        w.lllIIIIlIIIl[3] = "   ".length();
