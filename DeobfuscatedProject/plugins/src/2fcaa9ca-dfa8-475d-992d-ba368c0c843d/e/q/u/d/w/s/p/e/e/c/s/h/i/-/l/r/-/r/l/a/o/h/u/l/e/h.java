...
extends Enum<h> {
    ...
    private static void lIIIlIIlIIlllll() {
        ...
        h.lllIIIlIllll[0] = "  ".length() & ~"  ".length();
        h.lllIIIlIllll[1] = " ".length();
        h.lllIIIlIllll[2] = 85 + 105 - 140 + 188 ^ 24 + 121 - 113 + 158;
        h.lllIIIlIllll[3] = "  ".length();
        h.lllIIIlIllll[4] = "   ".length();
    ...
    private static String lIIIlIIlIIllIlI(String lllllllllllllllIIllIlllIlIIlIIII, String lllllllllllllllIIllIlllIlIIlIIIl) {
        try {
            SecretKeySpec lllllllllllllllIIllIlllIlIIlIlIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIllIlllIlIIlIIIl.getBytes(StandardCharsets.UTF_8)), lllIIIlIllll[9]), "DES");
            Cipher lllllllllllllllIIllIlllIlIIlIlII = Cipher.getInstance("DES");
            lllllllllllllllIIllIlllIlIIlIlII.init(lllIIIlIllll[3], lllllllllllllllIIllIlllIlIIlIlIl);
            return new String(lllllllllllllllIIllIlllIlIIlIlII.doFinal(Base64.getDecoder().decode(lllllllllllllllIIllIlllIlIIlIIII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public boolean J() {
        void var3_3;
        void lllllllllllllllIIllIlllIllIIlIll;
        h lllllllllllllllIIllIlllIllIIllII;
        Player player = Players.getLocal();
        if (h.lIIIlIIlIlIIIII(player)) {
            return lllIIIlIllll[0];
        }
        if (h.lIIIlIIlIlIIIIl(lllllllllllllllIIllIlllIllIIllII.a((Locatable)lllllllllllllllIIllIlllIllIIlIll) ? 1 : 0)) {
            return lllIIIlIllll[0];
        }
        TileObject lllllllllllllllIIllIlllIllIIlIlI = TileObjects.getNearest(tileObject -> {
            int n2;
        ...
        if (h.lIIIlIIlIlIIIII(lllllllllllllllIIllIlllIllIIlIlI)) {
            Log.error((String)lllIIIlIllIl[lllIIIlIllll[0]]);
            return lllIIIlIllll[0];
        }
        if (h.lIIIlIIlIlIIIlI(Skills.getLevel((Skill)Skill.AGILITY), lllllllllllllllIIllIlllIllIIllII.nextReq)) {
            lllllllllllllllIIllIlllIllIIlIlI.interact(lllIIIlIllIl[lllIIIlIllll[1]]);
            return lllIIIlIllll[1];
        }
        if (h.lIIIlIIlIlIIIlI(Movement.getRunEnergy(), lllIIIlIllll[2])) {
            lllllllllllllllIIllIlllIllIIlIlI.interact(lllIIIlIllIl[lllIIIlIllll[3]]);
            return lllIIIlIllll[1];
        }
        TileObject lllllllllllllllIIllIlllIllIIlIIl = TileObjects.getNearest(tileObject -> {
            int n2;
            if (h.lIIIlIIlIlIIIll(tileObject.getName().startsWith(lllIIIlIllIl[lllIIIlIllll[7]]) ? 1 : 0)) {
                ...
                if (h.lIIIlIIlIlIIIll(tileObject.hasAction(stringArray) ? 1 : 0) && h.lIIIlIIlIlIIIll(this.area.get().contains((Locatable)tileObject) ? 1 : 0)) {
                    ...
                    return ((0x14 ^ 0x28 ^ (0x2D ^ 0x18)) & (67 + 0 - 59 + 125 ^ 123 + 16 - 33 + 34 ^ -" ".length())) != 0;
                }
            }
            n2 = lllIIIlIllll[0];
            return n2 != 0;
        });
        if (h.lIIIlIIlIlIIIII(lllllllllllllllIIllIlllIllIIlIIl)) {
            lllllllllllllllIIllIlllIllIIlIlI.interact(lllIIIlIllIl[lllIIIlIllll[4]]);
    ...
    private static void lIIIlIIlIIlllIl() {
        ...
        h.lllIIIlIllIl[h.lllIIIlIllll[0]] = h.lIIIlIIlIIlIlll("OgUiGC4mDGcdNHUJMhgr", "UgGtG");
        h.lllIIIlIllIl[h.lllIIIlIllll[1]] = h.lIIIlIIlIIllIII("11TiiCSY6o46ldVerwS3kw==", "LuvLr");
        h.lllIIIlIllIl[h.lllIIIlIllll[3]] = h.lIIIlIIlIIlIlll("NToePDgVLQ8=", "tYjUN");
        h.lllIIIlIllIl[h.lllIIIlIllll[4]] = h.lIIIlIIlIIllIlI("eYrCK/UW4lUr+0b/L18tzQ==", "iQiHF");
        h.lllIIIlIllIl[h.lllIIIlIllll[5]] = h.lIIIlIIlIIllIII("9c3R6suME6I=", "uiSFJ");
        h.lllIIIlIllIl[h.lllIIIlIllll[6]] = h.lIIIlIIlIIlIlll("KR4aCDpHFhwSNg==", "jrseX");
        h.lllIIIlIllIl[h.lllIIIlIllll[7]] = h.lIIIlIIlIIllIlI("Oxko/1ir1ks=", "uJLJo");
        h.lllIIIlIllIl[h.lllIIIlIllll[8]] = h.lIIIlIIlIIlIlll("Dw4TOhFhBhUgHQ==", "LbzWs");
        h.lllIIIlIllIl[h.lllIIIlIllll[9]] = h.lIIIlIIlIIllIII("3wlZ4dwwYNAMrjbOdJXuPw==", "SMmpX");
        h.lllIIIlIllIl[h.lllIIIlIllll[10]] = h.lIIIlIIlIIllIlI("5DYQbk3SKTtyfd+Wk8NVTw==", "TJTcI");
        h.lllIIIlIllIl[h.lllIIIlIllll[11]] = h.lIIIlIIlIIlIlll("CzAEGwB3IBURHw==", "ZEmxk");
        h.lllIIIlIllIl[h.lllIIIlIllll[12]] = h.lIIIlIIlIIlIlll("JRg+Jhc8HQ==", "cTqiE");
        h.lllIIIlIllIl[h.lllIIIlIllll[15]] = h.lIIIlIIlIIllIII("l6SMklGqcq8gZL+stNVUAg==", "UmREs");
        h.lllIIIlIllIl[h.lllIIIlIllll[17]] = h.lIIIlIIlIIllIlI("goKHmx8mVSJU8UFR6bSygQ==", "IUsgy");
        h.lllIIIlIllIl[h.lllIIIlIllll[20]] = h.lIIIlIIlIIlIlll("KBU/KiIxECY=", "nYpep");
        h.lllIIIlIllIl[h.lllIIIlIllll[23]] = h.lIIIlIIlIIlIlll("JC06KzE9Nw==", "baudc");
    }
    ...
    private static String lIIIlIIlIIlIlll(String lllllllllllllllIIllIlllIlIlIllll, String lllllllllllllllIIllIlllIlIllIIll) {
        lllllllllllllllIIllIlllIlIlIllll = new String(Base64.getDecoder().decode(lllllllllllllllIIllIlllIlIlIllll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIllIlllIlIllIIlI = new StringBuilder();
        ...
        char[] lllllllllllllllIIllIlllIlIlIlIlI = lllllllllllllllIIllIlllIlIlIllll.toCharArray();
        int lllllllllllllllIIllIlllIlIlIlIIl = lllllllllllllllIIllIlllIlIlIlIlI.length;
        int lllllllllllllllIIllIlllIlIlIlIII = lllIIIlIllll[0];
        while (h.lIIIlIIlIlIIIlI(lllllllllllllllIIllIlllIlIlIlIII, lllllllllllllllIIllIlllIlIlIlIIl)) {
            char lllllllllllllllIIllIlllIlIllIlIl = lllllllllllllllIIllIlllIlIlIlIlI[lllllllllllllllIIllIlllIlIlIlIII];
            lllllllllllllllIIllIlllIlIllIIlI.append((char)(lllllllllllllllIIllIlllIlIllIlIl ^ lllllllllllllllIIllIlllIlIllIIIl[lllllllllllllllIIllIlllIlIllIIII % lllllllllllllllIIllIlllIlIllIIIl.length]));
            "".length();
            ++lllllllllllllllIIllIlllIlIllIIII;
            ++lllllllllllllllIIllIlllIlIlIlIII;
            "".length();
            if (-"  ".length() <= 0) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllIIllIlllIlIllIIlI);
    }
    ...
    private static String lIIIlIIlIIllIII(String lllllllllllllllIIllIlllIlIIlllll, String lllllllllllllllIIllIlllIlIIllllI) {
        try {
            ...
            Cipher lllllllllllllllIIllIlllIlIlIIIIl = Cipher.getInstance("Blowfish");
            lllllllllllllllIIllIlllIlIlIIIIl.init(lllIIIlIllll[3], lllllllllllllllIIllIlllIlIlIIIlI);
            return new String(lllllllllllllllIIllIlllIlIlIIIIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIIllIlllIlIIlllll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
