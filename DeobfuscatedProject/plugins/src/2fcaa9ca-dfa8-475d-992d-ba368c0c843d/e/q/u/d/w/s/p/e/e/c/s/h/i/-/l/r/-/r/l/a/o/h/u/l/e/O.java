...
extends Task {
    ...
    private static void lIIIlIlIIIIIlII() {
        ...
        O.lllIIlIIllll[0] = (22 + 22 - 3 + 205 ^ 39 + 85 - 99 + 157) & (71 + 105 - 126 + 84 ^ 194 + 88 - 191 + 107 ^ -" ".length());
        O.lllIIlIIllll[1] = " ".length();
        O.lllIIlIIllll[2] = "   ".length();
        O.lllIIlIIllll[3] = "  ".length();
    ...
    private static String lIIIlIlIIIIIIII(String lllllllllllllllIIllIlIlIllllIlIl, String lllllllllllllllIIllIlIlIllllIlII) {
        ...
        while (O.lIIIlIlIIIIlIII(lllllllllllllllIIllIlIlIlllIlIIl, lllllllllllllllIIllIlIlIlllIlIlI)) {
            ...
            "".length();
            if ("   ".length() < (0x70 ^ 9 ^ (0xE3 ^ 0x9E))) continue;
            return null;
        }
        ...
        if (O.lIIIlIlIIIIIllI(Inventory.contains((String[])stringArray) ? 1 : 0)) {
            Item lllllllllllllllIIllIlIllIIIIllll = Inventory.getFirst(item -> {
                ...
                if (O.lIIIlIlIIIIIllI(item.hasAction(stringArray) ? 1 : 0) && O.lIIIlIlIIIIIllI(item.getName().equals(lllIIlIIlllI[lllIIlIIllll[5]]) ? 1 : 0)) {
                    ...
                    "".length();
                    if (" ".length() < 0) {
                        return ((98 + 56 - 85 + 163 ^ 126 + 31 - 0 + 20) & (98 + 214 - 158 + 96 ^ 12 + 159 - 157 + 149 ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lllIIlIIllll[0];
                }
    ...
    private static void lIIIlIlIIIIIIll() {
        ...
        O.lllIIlIIlllI[O.lllIIlIIllll[0]] = O.lIIIlIlIIIIIIII("PAM6LCQYHzw=", "qlTGB");
        O.lllIIlIIlllI[O.lllIIlIIllll[1]] = O.lIIIlIlIIIIIIIl("V5Z2YlJkvLo=", "YvwFk");
        O.lllIIlIIlllI[O.lllIIlIIllll[3]] = O.lIIIlIlIIIIIIIl("jNgx6cJM3q0=", "lDwjn");
        O.lllIIlIIlllI[O.lllIIlIIllll[2]] = O.lIIIlIlIIIIIIII("KjgY", "oYlLm");
        O.lllIIlIIlllI[O.lllIIlIIllll[4]] = O.lIIIlIlIIIIIIlI("PbVunEWy5vg=", "lnMbq");
        O.lllIIlIIlllI[O.lllIIlIIllll[5]] = O.lIIIlIlIIIIIIIl("Bwca+D/g/DdTDCTw6B6amg==", "CNMxw");
    }
