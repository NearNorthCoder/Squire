...
extends Enum<r> {
    ...
    private r(List<Triple<RegionPoint, Integer, Integer>> list, RegionPoint regionPoint, RegionPoint regionPoint2, Supplier<TileObject> supplier, s s2) {
        this.startAreas = () -> {
            ...
            Iterator lllllllllllllllIIllIlllIIIlIIIII = list.iterator();
            while (r.lIIIlIIlIlIllll(lllllllllllllllIIllIlllIIIlIIIII.hasNext() ? 1 : 0)) {
                void lllllllllllllllIIllIlllIIIlIIIIl;
                Triple lllllllllllllllIIllIlllIIIIlllll = (Triple)lllllllllllllllIIllIlllIIIlIIIII.next();
                lllllllllllllllIIllIlllIIIlIIIIl.add(new WorldArea(SquireSepulchre.a((RegionPoint)lllllllllllllllIIllIlllIIIIlllll.getFirst()), ((Integer)lllllllllllllllIIllIlllIIIIlllll.getSecond()).intValue(), ((Integer)lllllllllllllllIIllIlllIIIIlllll.getThird()).intValue()));
                "".length();
                "".length();
                if ((0x8C ^ 0x88) >= "   ".length()) continue;
                return null;
            }
            return arrayList;
        };
    ...
    private static void lIIIlIIlIlIllII() {
        ...
        r.lllIIIllIIIl[0] = (0x13 ^ 0x7C ^ (0xDF ^ 0x87)) & (133 + 84 - 134 + 70 ^ 23 + 111 - 103 + 143 ^ -" ".length());
        r.lllIIIllIIIl[1] = " ".length();
        r.lllIIIllIIIl[2] = "   ".length();
        r.lllIIIllIIIl[3] = "  ".length();
        ...
        r.lllIIIllIIIl[18] = 0x3F ^ 0x2C ^ " ".length();
        ...
        r.lllIIIllIIIl[62] = "   ".length() ^ (0xA2 ^ 0x9D);
    ...
    private static String lIIIlIIlIlIIlIl(String lllllllllllllllIIllIllIlllIIIlIl, String lllllllllllllllIIllIllIlllIIlIIl) {
        lllllllllllllllIIllIllIlllIIIlIl = new String(Base64.getDecoder().decode(lllllllllllllllIIllIllIlllIIIlIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIllIllIlllIIlIII = new StringBuilder();
        ...
        char[] lllllllllllllllIIllIllIlllIIIIII = lllllllllllllllIIllIllIlllIIIlIl.toCharArray();
        int lllllllllllllllIIllIllIllIllllll = lllllllllllllllIIllIllIlllIIIIII.length;
        int lllllllllllllllIIllIllIllIlllllI = lllIIIllIIIl[0];
        while (r.lIIIlIIlIllIIII(lllllllllllllllIIllIllIllIlllllI, lllllllllllllllIIllIllIllIllllll)) {
            char lllllllllllllllIIllIllIlllIIlIll = lllllllllllllllIIllIllIlllIIIIII[lllllllllllllllIIllIllIllIlllllI];
            lllllllllllllllIIllIllIlllIIlIII.append((char)(lllllllllllllllIIllIllIlllIIlIll ^ lllllllllllllllIIllIllIlllIIIlll[lllllllllllllllIIllIllIlllIIIllI % lllllllllllllllIIllIllIlllIIIlll.length]));
            "".length();
            ++lllllllllllllllIIllIllIlllIIIllI;
            ++lllllllllllllllIIllIllIllIlllllI;
            "".length();
            if (((67 + 77 - 101 + 145 ^ 149 + 143 - 155 + 49) & (0xDD ^ 0x8D ^ (0xCA ^ 0x9C) ^ -" ".length())) >= -" ".length()) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllIIllIllIlllIIlIII);
    }
        ...
        WEST_I_V = new r(new RegionPoint(lllIIIllIIIl[21], lllIIIllIIIl[37], lllIIIllIIIl[3], b.C), lllIIIllIIIl[2], lllIIIllIIIl[12], new RegionPoint(lllIIIllIIIl[22], lllIIIllIIIl[37], lllIIIllIIIl[3], b.C), new RegionPoint(lllIIIllIIIl[22], lllIIIllIIIl[37], lllIIIllIIIl[3], b.C), () -> TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIIlIIlIlIllll(tileObject.getName().equals(lllIIIllIIII[lllIIIllIIIl[50]]) ? 1 : 0)) {
                ...
                if (r.lIIIlIIlIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((114 + 78 - 72 + 10 ^ 31 + 71 - 95 + 139) & (62 + 80 - 85 + 79 ^ 70 + 3 - -3 + 76 ^ -" ".length()) & ((126 + 114 - 119 + 70 ^ 46 + 130 - 53 + 19) & (0x86 ^ 0x89 ^ (0x1C ^ 0x22) ^ -" ".length()) ^ -" ".length())) != 0;
                }
            }
            n2 = lllIIIllIIIl[0];
            return n2 != 0;
        ...
        WEST_I_VI = new r(new RegionPoint(lllIIIllIIIl[21], lllIIIllIIIl[29], lllIIIllIIIl[1], b.C), lllIIIllIIIl[2], lllIIIllIIIl[6], new RegionPoint(lllIIIllIIIl[23], lllIIIllIIIl[32], lllIIIllIIIl[1], b.C), new RegionPoint(lllIIIllIIIl[23], lllIIIllIIIl[32], lllIIIllIIIl[1], b.C), () -> TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIIlIIlIlIllll(tileObject.getName().equals(lllIIIllIIII[lllIIIllIIIl[48]]) ? 1 : 0)) {
                ...
                if (r.lIIIlIIlIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    n2 = lllIIIllIIIl[1];
                    "".length();
                    if (((0xCD ^ 0x94 ^ (0x6C ^ 0x16)) & (124 + 58 - 117 + 110 ^ 11 + 34 - -52 + 43 ^ -" ".length())) == 0) return n2 != 0;
                    return ((2 ^ 0x73 ^ (0x6B ^ 0x42)) & (16 + 38 - -82 + 21 ^ 168 + 185 - 207 + 51 ^ -" ".length())) != 0;
                }
            }
            n2 = lllIIIllIIIl[0];
            return n2 != 0;
        ...
        NORTH_I_V = new r(new RegionPoint(lllIIIllIIIl[41], lllIIIllIIIl[37], lllIIIllIIIl[3], b.C), lllIIIllIIIl[2], lllIIIllIIIl[5], new RegionPoint(lllIIIllIIIl[42], lllIIIllIIIl[37], lllIIIllIIIl[3], b.C), new RegionPoint(lllIIIllIIIl[42], lllIIIllIIIl[37], lllIIIllIIIl[3], b.C), () -> TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIIlIIlIlIllll(tileObject.getName().equals(lllIIIllIIII[lllIIIllIIIl[46]]) ? 1 : 0)) {
                ...
                if (r.lIIIlIIlIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x44 ^ 0x4F ^ (0xEE ^ 0xB6)) & (26 + 98 - -97 + 16 ^ 77 + 10 - -94 + 9 ^ -" ".length())) != 0;
                }
            }
            n2 = lllIIIllIIIl[0];
            return n2 != 0;
        ...
        WEST_II_VIII = new r(new RegionPoint(lllIIIllIIIl[61], lllIIIllIIIl[31], lllIIIllIIIl[1], b.I), lllIIIllIIIl[25], lllIIIllIIIl[2], new RegionPoint(lllIIIllIIIl[23], lllIIIllIIIl[32], lllIIIllIIIl[1], b.G), new RegionPoint(lllIIIllIIIl[23], lllIIIllIIIl[32], lllIIIllIIIl[1], b.G), () -> TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIIlIIlIlIllll(tileObject.getName().equals(lllIIIllIIII[lllIIIllIIIl[36]]) ? 1 : 0)) {
                ...
                if (r.lIIIlIIlIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x12 ^ 0x52 ^ (0x23 ^ 0x7C)) & (2 ^ 5 ^ (0x31 ^ 0x29) ^ -" ".length())) != 0;
                }
            }
            n2 = lllIIIllIIIl[0];
            return n2 != 0;
        ...
        EAST_II_VII = new r(new RegionPoint(lllIIIllIIIl[33], lllIIIllIIIl[2], lllIIIllIIIl[3], b.G), lllIIIllIIIl[13], lllIIIllIIIl[7], new RegionPoint(lllIIIllIIIl[40], lllIIIllIIIl[7], lllIIIllIIIl[3], b.G), new RegionPoint(lllIIIllIIIl[40], lllIIIllIIIl[7], lllIIIllIIIl[3], b.G), () -> TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIIlIIlIlIllll(tileObject.getName().equals(lllIIIllIIII[lllIIIllIIIl[30]]) ? 1 : 0)) {
                ...
                if (r.lIIIlIIlIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x7C ^ 0x3C ^ (0x3A ^ 0x5B)) & (26 + 153 - 91 + 81 ^ 100 + 18 - 39 + 57 ^ -" ".length())) != 0;
                }
            }
            n2 = lllIIIllIIIl[0];
            return n2 != 0;
        ...
        NORTH_II_I = new r(new RegionPoint(lllIIIllIIIl[21], lllIIIllIIIl[36], lllIIIllIIIl[3], b.G), lllIIIllIIIl[15], lllIIIllIIIl[12], new RegionPoint(lllIIIllIIIl[22], lllIIIllIIIl[47], lllIIIllIIIl[3], b.G), new RegionPoint(lllIIIllIIIl[3], lllIIIllIIIl[47], lllIIIllIIIl[3], b.G), () -> TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIIlIIlIlIllll(tileObject.getName().equals(lllIIIllIIII[lllIIIllIIIl[26]]) ? 1 : 0)) {
                ...
                if (r.lIIIlIIlIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    "".length();
                    if ("  ".length() > 0) return n2 != 0;
                    return ((0x86 ^ 0x81 ^ (0x72 ^ 0x78)) & (0x7C ^ 0x57 ^ (0x2F ^ 9) ^ -" ".length())) != 0;
                }
            }
            n2 = lllIIIllIIIl[0];
            return n2 != 0;
        ...
        NORTH_II_IV = new r(new RegionPoint(lllIIIllIIIl[38], lllIIIllIIIl[51], lllIIIllIIIl[3], b.G), lllIIIllIIIl[15], lllIIIllIIIl[12], new RegionPoint(lllIIIllIIIl[22], lllIIIllIIIl[47], lllIIIllIIIl[3], b.G), new RegionPoint(lllIIIllIIIl[3], lllIIIllIIIl[47], lllIIIllIIIl[3], b.G), () -> TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIIlIIlIlIllll(tileObject.getName().equals(lllIIIllIIII[lllIIIllIIIl[24]]) ? 1 : 0)) {
                ...
                if (r.lIIIlIIlIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    n2 = lllIIIllIIIl[1];
                    "".length();
                    if (((0x42 ^ 0) & ~(0x48 ^ 0xA)) >= -" ".length()) return n2 != 0;
        ...
        EAST_III_VIII = new r(new RegionPoint(lllIIIllIIIl[38], lllIIIllIIIl[2], lllIIIllIIIl[3], b.J), lllIIIllIIIl[8], lllIIIllIIIl[14], new RegionPoint(lllIIIllIIIl[38], lllIIIllIIIl[4], lllIIIllIIIl[3], b.J), new RegionPoint(lllIIIllIIIl[38], lllIIIllIIIl[4], lllIIIllIIIl[3], b.J), () -> TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIIlIIlIlIllll(tileObject.getName().equals(lllIIIllIIII[lllIIIllIIIl[20]]) ? 1 : 0)) {
                ...
                if (r.lIIIlIIlIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    "".length();
                    if (" ".length() < "   ".length()) return n2 != 0;
                    return ((0xB3 ^ 0x87 ^ (0x63 ^ 0x5A)) & (0x4E ^ 0x14 ^ (0x1C ^ 0x4B) ^ -" ".length())) != 0;
                }
            }
            n2 = lllIIIllIIIl[0];
            return n2 != 0;
        ...
        SOUTH_III_II = new r(new RegionPoint(lllIIIllIIIl[27], lllIIIllIIIl[21], lllIIIllIIIl[1], b.J), lllIIIllIIIl[11], lllIIIllIIIl[10], new RegionPoint(lllIIIllIIIl[27], lllIIIllIIIl[30], lllIIIllIIIl[1], b.J), new RegionPoint(lllIIIllIIIl[27], lllIIIllIIIl[30], lllIIIllIIIl[1], b.J), () -> TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIIlIIlIlIllll(tileObject.getName().equals(lllIIIllIIII[lllIIIllIIIl[18]]) ? 1 : 0)) {
                ...
                if (r.lIIIlIIlIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    n2 = lllIIIllIIIl[1];
                    "".length();
                    if (((0x62 ^ 0x7D ^ (0x11 ^ 0x39)) & (0x8C ^ 0x98 ^ (0x8C ^ 0xAF) ^ -" ".length())) == 0) return n2 != 0;
                    return ((0x99 ^ 0x92 ^ (0x18 ^ 0x37)) & (0x4D ^ 0x78 ^ (0xD4 ^ 0xC5) ^ -" ".length())) != 0;
                }
            }
            n2 = lllIIIllIIIl[0];
            return n2 != 0;
        ...
        WEST_III_VI = new r(List.of(new Triple((Object)new RegionPoint(lllIIIllIIIl[4], lllIIIllIIIl[12], lllIIIllIIIl[3], b.J), (Object)lllIIIllIIIl[21], (Object)lllIIIllIIIl[2]), new Triple((Object)new RegionPoint(lllIIIllIIIl[19], lllIIIllIIIl[2], lllIIIllIIIl[3], b.J), (Object)lllIIIllIIIl[8], (Object)lllIIIllIIIl[9])), new RegionPoint(lllIIIllIIIl[26], lllIIIllIIIl[5], lllIIIllIIIl[3], b.J), new RegionPoint(lllIIIllIIIl[26], lllIIIllIIIl[5], lllIIIllIIIl[3], b.J), () -> TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIIlIIlIlIllll(tileObject.getName().equals(lllIIIllIIII[lllIIIllIIIl[16]]) ? 1 : 0)) {
                ...
                if (r.lIIIlIIlIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x6D ^ 0x14 ^ (0x94 ^ 0xB3)) & (0x4F ^ 0x1D ^ (0x6B ^ 0x67) ^ -" ".length())) != 0;
                }
            }
            n2 = lllIIIllIIIl[0];
            return n2 != 0;
        ...
        SOUTH_IV_VI = new r(List.of(new Triple((Object)new RegionPoint(lllIIIllIIIl[31], lllIIIllIIIl[5], lllIIIllIIIl[1], b.L), (Object)lllIIIllIIIl[2], (Object)lllIIIllIIIl[16]), new Triple((Object)new RegionPoint(lllIIIllIIIl[34], lllIIIllIIIl[17], lllIIIllIIIl[1], b.L), (Object)lllIIIllIIIl[8], (Object)lllIIIllIIIl[2])), new RegionPoint(lllIIIllIIIl[32], lllIIIllIIIl[20], lllIIIllIIIl[1], b.L), new RegionPoint(lllIIIllIIIl[32], lllIIIllIIIl[20], lllIIIllIIIl[1], b.L), () -> TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIIlIIlIlIllll(tileObject.getName().equals(lllIIIllIIII[lllIIIllIIIl[10]]) ? 1 : 0)) {
                ...
                if (r.lIIIlIIlIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    "".length();
                    if ("   ".length() >= 0) return n2 != 0;
                    return ((158 + 69 - 163 + 115 ^ 9 + 83 - -41 + 18) & (138 + 64 - 112 + 55 ^ 78 + 38 - 89 + 154 ^ -" ".length())) != 0;
                }
            }
            n2 = lllIIIllIIIl[0];
            return n2 != 0;
        ...
        TOP_V_VIII = new r(new RegionPoint(lllIIIllIIIl[2], lllIIIllIIIl[3], lllIIIllIIIl[3], b.N), lllIIIllIIIl[2], lllIIIllIIIl[14], new RegionPoint(lllIIIllIIIl[5], lllIIIllIIIl[4], lllIIIllIIIl[3], b.N), new RegionPoint(lllIIIllIIIl[5], lllIIIllIIIl[4], lllIIIllIIIl[3], b.N), () -> TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIIlIIlIlIllll(tileObject.getName().equals(lllIIIllIIII[lllIIIllIIIl[8]]) ? 1 : 0)) {
                ...
                if (r.lIIIlIIlIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x4A ^ 0x3C ^ (0x71 ^ 0x1F)) & ("   ".length() ^ (0x44 ^ 0x5F) ^ -" ".length())) != 0;
                }
            }
            n2 = lllIIIllIIIl[0];
            return n2 != 0;
        ...
        BOTTOM_V_IV = new r(new RegionPoint(lllIIIllIIIl[25], lllIIIllIIIl[41], lllIIIllIIIl[0], b.N), lllIIIllIIIl[19], lllIIIllIIIl[6], new RegionPoint(lllIIIllIIIl[32], lllIIIllIIIl[41], lllIIIllIIIl[0], b.N), new RegionPoint(lllIIIllIIIl[32], lllIIIllIIIl[41], lllIIIllIIIl[0], b.N), () -> TileObjects.getNearest(tileObject -> {
            ...
            if (r.lIIIlIIlIlIllll(tileObject.getName().equals(lllIIIllIIII[lllIIIllIIIl[4]]) ? 1 : 0)) {
                ...
                if (r.lIIIlIIlIlIllll(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    "".length();
                    if (-" ".length() <= 0) return n2 != 0;
                    return ((221 + 84 - 104 + 23 ^ 165 + 79 - 111 + 43) & (239 + 73 - 109 + 46 ^ 113 + 121 - 166 + 101 ^ -" ".length())) != 0;
                }
            }
            n2 = lllIIIllIIIl[0];
            return n2 != 0;
    ...
    private static String lIIIlIIlIlIIlII(String lllllllllllllllIIllIllIllllIIlIl, String lllllllllllllllIIllIllIllllIIlII) {
        try {
            SecretKeySpec lllllllllllllllIIllIllIllllIlIlI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIllIllIllllIIlII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIIllIllIllllIlIIl = Cipher.getInstance("Blowfish");
            lllllllllllllllIIllIllIllllIlIIl.init(lllIIIllIIIl[3], lllllllllllllllIIllIllIllllIlIlI);
            return new String(lllllllllllllllIIllIllIllllIlIIl.doFinal(Base64.getDecoder().decode(lllllllllllllllIIllIllIllllIIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public boolean a(d d2, SquireSepulchre squireSepulchre) {
        void lllllllllllllllIIllIlllIIIllIIll;
        r lllllllllllllllIIllIlllIIIllIlIl;
        Player player = Players.getLocal();
        if (r.lIIIlIIlIlIllIl(player)) {
            return lllIIIllIIIl[0];
        }
        if (r.lIIIlIIlIlIlllI(lllllllllllllllIIllIlllIIIllIlIl.a((Locatable)lllllllllllllllIIllIlllIIIllIIll) ? 1 : 0)) {
            return lllIIIllIIIl[0];
        }
    ...
    private static String lIIIlIIlIlIIllI(String lllllllllllllllIIllIllIlllIllIII, String lllllllllllllllIIllIllIlllIllIIl) {
        try {
            SecretKeySpec lllllllllllllllIIllIllIlllIlllIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIllIllIlllIllIIl.getBytes(StandardCharsets.UTF_8)), lllIIIllIIIl[8]), "DES");
            Cipher lllllllllllllllIIllIllIlllIlllII = Cipher.getInstance("DES");
            lllllllllllllllIIllIllIlllIlllII.init(lllIIIllIIIl[3], lllllllllllllllIIllIllIlllIlllIl);
            return new String(lllllllllllllllIIllIllIlllIlllII.doFinal(Base64.getDecoder().decode(lllllllllllllllIIllIllIlllIllIII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIIIlIIlIlIIlll() {
        ...
        r.lllIIIllIIII[r.lllIIIllIIIl[0]] = r.lIIIlIIlIlIIlII("dgx2ujaW9ct2JoEg7pmenQ==", "JGFzq");
        r.lllIIIllIIII[r.lllIIIllIIIl[1]] = r.lIIIlIIlIlIIlII("MhYEwtoKcoE=", "njXKT");
        r.lllIIIllIIII[r.lllIIIllIIIl[3]] = r.lIIIlIIlIlIIlIl("Agk9NwlsATstBQ==", "AeTZk");
        r.lllIIIllIIII[r.lllIIIllIIIl[2]] = r.lIIIlIIlIlIIllI("FLAPHxtZ12IUjUJhBR/W8Q==", "NdFre");
        r.lllIIIllIIII[r.lllIIIllIIIl[4]] = r.lIIIlIIlIlIIlII("VXyEfROvQxhd4A/wfHpl6A==", "jTYFe");
        r.lllIIIllIIII[r.lllIIIllIIIl[5]] = r.lIIIlIIlIlIIlII("CH1sdiJD8t4=", "plXHY");
        r.lllIIIllIIII[r.lllIIIllIIIl[6]] = r.lIIIlIIlIlIIlII("VTXF4vlHWSs=", "qFVCt");
        r.lllIIIllIIII[r.lllIIIllIIIl[7]] = r.lIIIlIIlIlIIllI("Wt3W6OZg/Z4=", "nBpDX");
        r.lllIIIllIIII[r.lllIIIllIIIl[8]] = r.lIIIlIIlIlIIllI("/VYFGkdOKWs=", "yYYFV");
        r.lllIIIllIIII[r.lllIIIllIIIl[9]] = r.lIIIlIIlIlIIllI("y1utfOrvgeI=", "sRqVx");
        r.lllIIIllIIII[r.lllIIIllIIIl[10]] = r.lIIIlIIlIlIIlIl("NQMTBw==", "rbgbJ");
        r.lllIIIllIIII[r.lllIIIllIIIl[11]] = r.lIIIlIIlIlIIlII("MOdfD2vQBGvfRIGucoDMpw==", "gKYmJ");
        r.lllIIIllIIII[r.lllIIIllIIIl[12]] = r.lIIIlIIlIlIIllI("VJLVnl8xtas=", "sQJbS");
        r.lllIIIllIIII[r.lllIIIllIIIl[13]] = r.lIIIlIIlIlIIlIl("KQw4Kg==", "cyUZj");
        r.lllIIIllIIII[r.lllIIIllIIIl[14]] = r.lIIIlIIlIlIIllI("Y/cuqkTWeqY=", "yOvfE");
        r.lllIIIllIIII[r.lllIIIllIIIl[15]] = r.lIIIlIIlIlIIlIl("OQAoGCZXCC4CKg==", "zlAuD");
        r.lllIIIllIIII[r.lllIIIllIIIl[16]] = r.lIIIlIIlIlIIlIl("OToPHBoZ", "jNnuh");
        r.lllIIIllIIII[r.lllIIIllIIIl[17]] = r.lIIIlIIlIlIIlII("KB+P12/13Xg=", "MWFiP");
        r.lllIIIllIIII[r.lllIIIllIIIl[18]] = r.lIIIlIIlIlIIlIl("NCgNNhYLNgE=", "dDlBp");
        r.lllIIIllIIII[r.lllIIIllIIIl[19]] = r.lIIIlIIlIlIIlII("q+nsPbrwvcc=", "VPKZX");
        r.lllIIIllIIII[r.lllIIIllIIIl[20]] = r.lIIIlIIlIlIIllI("vCbj+LqQ250=", "XZPGq");
        r.lllIIIllIIII[r.lllIIIllIIIl[21]] = r.lIIIlIIlIlIIlIl("AzIaPQ==", "IGwMR");
        r.lllIIIllIIII[r.lllIIIllIIIl[22]] = r.lIIIlIIlIlIIlII("tBTJVnMK+6qH79PgEyg2Rg==", "fyFPq");
        r.lllIIIllIIII[r.lllIIIllIIIl[23]] = r.lIIIlIIlIlIIllI("tSHwHFxmP6A=", "FtzwH");
        r.lllIIIllIIII[r.lllIIIllIIIl[24]] = r.lIIIlIIlIlIIlII("80f5rJ2kwqg=", "tDkqi");
        r.lllIIIllIIII[r.lllIIIllIIIl[25]] = r.lIIIlIIlIlIIllI("9wjxsKmKtjJ5jqG+jYt+sA==", "evRRG");
        r.lllIIIllIIII[r.lllIIIllIIIl[26]] = r.lIIIlIIlIlIIlIl("AAIqNyI/HCY=", "PnKCD");
        r.lllIIIllIIII[r.lllIIIllIIIl[27]] = r.lIIIlIIlIlIIlIl("CC09Fw==", "BXPgi");
        r.lllIIIllIIII[r.lllIIIllIIIl[28]] = r.lIIIlIIlIlIIllI("QBJFVOVwwe7YYwxf5yQykQ==", "xjWFV");
        r.lllIIIllIIII[r.lllIIIllIIIl[29]] = r.lIIIlIIlIlIIlIl("AAwkEw==", "JyIcQ");
        r.lllIIIllIIII[r.lllIIIllIIIl[30]] = r.lIIIlIIlIlIIllI("6UfC7FcddeM=", "fkpCZ");
        r.lllIIIllIIII[r.lllIIIllIIIl[31]] = r.lIIIlIIlIlIIllI("3gomXQUrbJqjiGaL9CS8kA==", "WcZud");
        r.lllIIIllIIII[r.lllIIIllIIIl[32]] = r.lIIIlIIlIlIIllI("MCE90POE3F773Cxzjhyc3Q==", "gDqxG");
        r.lllIIIllIIII[r.lllIIIllIIIl[33]] = r.lIIIlIIlIlIIlIl("IC84Ow==", "jZUKQ");
        r.lllIIIllIIII[r.lllIIIllIIIl[34]] = r.lIIIlIIlIlIIlII("NbAXvtCdJYE=", "wLYda");
        r.lllIIIllIIII[r.lllIIIllIIIl[35]] = r.lIIIlIIlIlIIllI("Lz0ABWalTut55SHk4sZYvA==", "WPCul");
        r.lllIIIllIIII[r.lllIIIllIIIl[36]] = r.lIIIlIIlIlIIllI("MOJ9lPKlEnFJYOdACBXHiA==", "uyujg");
        r.lllIIIllIIII[r.lllIIIllIIIl[37]] = r.lIIIlIIlIlIIllI("ybSqJLoC1Dg=", "WWeCD");
        r.lllIIIllIIII[r.lllIIIllIIIl[38]] = r.lIIIlIIlIlIIllI("xIXA088Je5Q=", "bbkEY");
        r.lllIIIllIIII[r.lllIIIllIIIl[39]] = r.lIIIlIIlIlIIlII("RVVihKpynhE=", "wUkGz");
        r.lllIIIllIIII[r.lllIIIllIIIl[40]] = r.lIIIlIIlIlIIlIl("IiAgBzAC", "qTAnB");
        r.lllIIIllIIII[r.lllIIIllIIIl[41]] = r.lIIIlIIlIlIIlII("9pX4iSRPwM2sx86Ofob4Aw==", "DNLZm");
        r.lllIIIllIIII[r.lllIIIllIIIl[42]] = r.lIIIlIIlIlIIlII("/oC88PpXX68=", "arICR");
        r.lllIIIllIIII[r.lllIIIllIIIl[43]] = r.lIIIlIIlIlIIlIl("NQoIIyFbAg45LQ==", "vfaNC");
        r.lllIIIllIIII[r.lllIIIllIIIl[44]] = r.lIIIlIIlIlIIllI("mnbZmFfSOuRqgYfw5PW5eg==", "kwZEo");
        r.lllIIIllIIII[r.lllIIIllIIIl[45]] = r.lIIIlIIlIlIIllI("17CQeHGwaS8=", "MPUvo");
        r.lllIIIllIIII[r.lllIIIllIIIl[46]] = r.lIIIlIIlIlIIlII("/RPMsraZIpY=", "lSlBG");
        r.lllIIIllIIII[r.lllIIIllIIIl[47]] = r.lIIIlIIlIlIIlIl("LjMbKA==", "dFvXt");
        r.lllIIIllIIII[r.lllIIIllIIIl[48]] = r.lIIIlIIlIlIIlIl("OCImDjAHPCo=", "hNGzV");
        r.lllIIIllIIII[r.lllIIIllIIIl[49]] = r.lIIIlIIlIlIIlIl("ITcAMg==", "kBmBm");
        r.lllIIIllIIII[r.lllIIIllIIIl[50]] = r.lIIIlIIlIlIIlII("vR5eMaK2His=", "UmCvR");
        r.lllIIIllIIII[r.lllIIIllIIIl[51]] = r.lIIIlIIlIlIIllI("H+QyESwPGOk=", "MRkYO");
        r.lllIIIllIIII[r.lllIIIllIIIl[52]] = r.lIIIlIIlIlIIlIl("DyIfBicROBo=", "XgLRx");
        r.lllIIIllIIII[r.lllIIIllIIIl[53]] = r.lIIIlIIlIlIIllI("7XnWffbqfAOZlO3Op+ZxUw==", "AkBnH");
        r.lllIIIllIIII[r.lllIIIllIIIl[54]] = r.lIIIlIIlIlIIllI("IYBjc2302jj0PilnbZ1kgQ==", "FIZTm");
        r.lllIIIllIIII[r.lllIIIllIIIl[55]] = r.lIIIlIIlIlIIllI("3hAgtiELyX/IIw+OZmMm0Q==", "vFsau");
        r.lllIIIllIIII[r.lllIIIllIIIl[56]] = r.lIIIlIIlIlIIlIl("OAQTJiA0Ahkk", "kKFrh");
        r.lllIIIllIIII[r.lllIIIllIIIl[57]] = r.lIIIlIIlIlIIlII("A5qntqFXke4nwG+5TGub4g==", "ZaHPJ");
        r.lllIIIllIIII[r.lllIIIllIIIl[58]] = r.lIIIlIIlIlIIlII("3/dP7cC2s4az9vV5P/CRrA==", "UVAMf");
        r.lllIIIllIIII[r.lllIIIllIIIl[60]] = r.lIIIlIIlIlIIlII("v82iadhZu7ikZ8OoxD3v/A==", "IXqZk");
        r.lllIIIllIIII[r.lllIIIllIIIl[62]] = r.lIIIlIIlIlIIlII("O9u6b/XkjUgcx+kdMv2ICg==", "UgLcC");
        r.lllIIIllIIII[r.lllIIIllIIIl[59]] = r.lIIIlIIlIlIIllI("6jP+pdqh1nIGh/x4KNAFtw==", "xqfBl");
        r.lllIIIllIIII[r.lllIIIllIIIl[63]] = r.lIIIlIIlIlIIllI("woXFA3GpgG7US8d9Q0T7zw==", "TVquD");
        r.lllIIIllIIII[r.lllIIIllIIIl[61]] = r.lIIIlIIlIlIIllI("z2l6dJW9UGa11Ownku4Npg==", "NMOVN");
        r.lllIIIllIIII[r.lllIIIllIIIl[64]] = r.lIIIlIIlIlIIllI("pb0ZLnb2RrspGc257ZySvg==", "uQiOv");
        r.lllIIIllIIII[r.lllIIIllIIIl[65]] = r.lIIIlIIlIlIIlII("3DtBcxw2uBROkDeVGVl1ag==", "Lebuq");
        r.lllIIIllIIII[r.lllIIIllIIIl[66]] = r.lIIIlIIlIlIIllI("KWMmxE9ke+FVVkjxZl747g==", "UZmdI");
        r.lllIIIllIIII[r.lllIIIllIIIl[67]] = r.lIIIlIIlIlIIlII("rcJYJ0oxCPWJoo6WWcSf5w==", "NHNWW");
        r.lllIIIllIIII[r.lllIIIllIIIl[68]] = r.lIIIlIIlIlIIlIl("HgccAgUSAQAfEgQB", "MHIVM");
        r.lllIIIllIIII[r.lllIIIllIIIl[69]] = r.lIIIlIIlIlIIllI("sQRiVgBc4BhriHzg/6Z8XQ==", "TJfPV");
        r.lllIIIllIIII[r.lllIIIllIIIl[70]] = r.lIIIlIIlIlIIlIl("ET4gPgodOCM1FAs4", "BqujB");
        r.lllIIIllIIII[r.lllIIIllIIIl[71]] = r.lIIIlIIlIlIIlII("h37FsxAaVvJJgzMLXwWOYg==", "obSPh");
        r.lllIIIllIIII[r.lllIIIllIIIl[72]] = r.lIIIlIIlIlIIlII("SPedwrtD+HUKdaKbZwbqsw==", "UAPQf");
        r.lllIIIllIIII[r.lllIIIllIIIl[73]] = r.lIIIlIIlIlIIlII("XkDrbAmQbAwG+yWXAhrtPg==", "vJnHl");
        r.lllIIIllIIII[r.lllIIIllIIIl[74]] = r.lIIIlIIlIlIIlIl("DiI9CQMGNC8SFxUiMA==", "CkyMO");
        r.lllIIIllIIII[r.lllIIIllIIIl[75]] = r.lIIIlIIlIlIIlII("QSxcehhT4B7aJvU8n7WXjw==", "bOoFZ");
    }
    ...
    public boolean a(Locatable locatable) {
        Iterator<WorldArea> lllllllllllllllIIllIlllIIIlIllII = this.startAreas.get().iterator();
        while (r.lIIIlIIlIlIllll(lllllllllllllllIIllIlllIIIlIllII.hasNext() ? 1 : 0)) {
            void lllllllllllllllIIllIlllIIIlIllIl;
            WorldArea lllllllllllllllIIllIlllIIIlIlIll = lllllllllllllllIIllIlllIIIlIllII.next();
            if (r.lIIIlIIlIlIllll(lllllllllllllllIIllIlllIIIlIlIll.contains((Locatable)lllllllllllllllIIllIlllIIIlIllIl) ? 1 : 0)) {
                return lllIIIllIIIl[1];
            }
            "".length();
