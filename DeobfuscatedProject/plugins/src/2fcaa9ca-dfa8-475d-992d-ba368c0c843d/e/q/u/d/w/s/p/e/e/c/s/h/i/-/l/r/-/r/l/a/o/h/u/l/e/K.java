...
extends Enum<K> {
    ...
    public boolean a(d d2, SquireSepulchre squireSepulchre) {
        void lllllllllllllllIIlllIIIIllIlllIl;
        K lllllllllllllllIIlllIIIIllIlllll;
        Player player = Players.getLocal();
        if (K.lIIIlIIIlIllIIl(player)) {
            return lllIIIIllIlI[0];
        }
        if (K.lIIIlIIIlIllIlI(lllllllllllllllIIlllIIIIllIlllll.a((Locatable)lllllllllllllllIIlllIIIIllIlllIl) ? 1 : 0)) {
            return lllIIIIllIlI[0];
        }
    ...
    private static String lIIIlIIIIllIllI(String lllllllllllllllIIlllIIIIlIllllIl, String lllllllllllllllIIlllIIIIlIllllII) {
        lllllllllllllllIIlllIIIIlIllllIl = new String(Base64.getDecoder().decode(lllllllllllllllIIlllIIIIlIllllIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIlllIIIIllIIIIII = new StringBuilder();
        char[] lllllllllllllllIIlllIIIIlIllllll = lllllllllllllllIIlllIIIIlIllllII.toCharArray();
        int lllllllllllllllIIlllIIIIlIlllllI = lllIIIIllIlI[0];
        char[] lllllllllllllllIIlllIIIIlIlllIII = lllllllllllllllIIlllIIIIlIllllIl.toCharArray();
        int lllllllllllllllIIlllIIIIlIllIlll = lllllllllllllllIIlllIIIIlIlllIII.length;
        int lllllllllllllllIIlllIIIIlIllIllI = lllIIIIllIlI[0];
        while (K.lIIIlIIIlIlllII(lllllllllllllllIIlllIIIIlIllIllI, lllllllllllllllIIlllIIIIlIllIlll)) {
            char lllllllllllllllIIlllIIIIllIIIIll = lllllllllllllllIIlllIIIIlIlllIII[lllllllllllllllIIlllIIIIlIllIllI];
            lllllllllllllllIIlllIIIIllIIIIII.append((char)(lllllllllllllllIIlllIIIIllIIIIll ^ lllllllllllllllIIlllIIIIlIllllll[lllllllllllllllIIlllIIIIlIlllllI % lllllllllllllllIIlllIIIIlIllllll.length]));
            "".length();
    ...
    private static void lIIIlIIIlIlIlll() {
        ...
        K.lllIIIIlIIII[K.lllIIIIllIlI[0]] = K.lIIIlIIIIllIllI("DR9FBCEWFEQ=", "dqelD");
        K.lllIIIIlIIII[K.lllIIIIllIlI[1]] = K.lIIIlIIIIllIlll("qj51V5aAS7V60YawjKzfOg==", "hrQqO");
        K.lllIIIIlIIII[K.lllIIIIllIlI[4]] = K.lIIIlIIIIlllIII("j5u/yQDsXMl11Q1E8ZljQ/dHwaf2kji6", "LHPqh");
        K.lllIIIIlIIII[K.lllIIIIllIlI[10]] = K.lIIIlIIIIllIllI("HwczPAUTAS83BAU=", "LHfhM");
        K.lllIIIIlIIII[K.lllIIIIllIlI[18]] = K.lIIIlIIIIlllIII("9eByLpDw5IzSmlDoYWXnfA==", "bLAgm");
        K.lllIIIIlIIII[K.lllIIIIllIlI[22]] = K.lIIIlIIIIlllIII("LUBFJkOu+OjrJPEzLPtthA==", "XOxdq");
        K.lllIIIIlIIII[K.lllIIIIllIlI[14]] = K.lIIIlIIIIllIlll("y1ZqC3lxkx+7Al62NQ7P/ZrKHZIkc9kl", "mLUYY");
        K.lllIIIIlIIII[K.lllIIIIllIlI[31]] = K.lIIIlIIIIlllIII("dD46r9fYqUjo3Dv2cn2ZAQ==", "ByiGe");
        K.lllIIIIlIIII[K.lllIIIIllIlI[2]] = K.lIIIlIIIIllIllI("IjkAHA0zPwQXDA==", "lvRHE");
        K.lllIIIIlIIII[K.lllIIIIllIlI[38]] = K.lIIIlIIIIlllIII("bHgsw/2KSk6xy9/ySoGHEg==", "IYNmI");
        K.lllIIIIlIIII[K.lllIIIIllIlI[5]] = K.lIIIlIIIIlllIII("7JbhCgR8Hd9QRDrCthQLnA==", "tFQAk");
        K.lllIIIIlIIII[K.lllIIIIllIlI[16]] = K.lIIIlIIIIlllIII("t88zMyQCUYLtVOUF8CKJwA==", "FTvex");
        K.lllIIIIlIIII[K.lllIIIIllIlI[9]] = K.lIIIlIIIIllIlll("ELszunrIVAlKdXpR2OPyDw==", "TWOSt");
        K.lllIIIIlIIII[K.lllIIIIllIlI[40]] = K.lIIIlIIIIllIllI("EQQSIxMdEx4+Gg==", "TEAwL");
        K.lllIIIIlIIII[K.lllIIIIllIlI[36]] = K.lIIIlIIIIllIllI("Nw4gMTs7GSwz", "rOsed");
        K.lllIIIIlIIII[K.lllIIIIllIlI[17]] = K.lIIIlIIIIllIlll("2TwNs3i6CAFPHQx9P4pS7Q==", "tEHil");
        K.lllIIIIlIIII[K.lllIIIIllIlI[15]] = K.lIIIlIIIIlllIII("6FdWnCydkES/8NzbwL3pYw==", "JFZAo");
        K.lllIIIIlIIII[K.lllIIIIllIlI[13]] = K.lIIIlIIIIllIllI("FD87EjUKLDcPPA==", "CzhFj");
        K.lllIIIIlIIII[K.lllIIIIllIlI[45]] = K.lIIIlIIIIllIlll("NBWK7OfSaacGuSdy560KRw==", "CZrdf");
        K.lllIIIIlIIII[K.lllIIIIllIlI[47]] = K.lIIIlIIIIlllIII("wZyrl4OHGcEmSG5XKdZHHQ==", "qEvxY");
        K.lllIIIIlIIII[K.lllIIIIllIlI[28]] = K.lIIIlIIIIllIlll("puZ7pZTIfPZM//ruRL5GLw==", "NwFNS");
        K.lllIIIIlIIII[K.lllIIIIllIlI[43]] = K.lIIIlIIIIllIllI("OyUyPB4wPCsq", "ojbcH");
        K.lllIIIIlIIII[K.lllIIIIllIlI[46]] = K.lIIIlIIIIllIllI("HTkgJQ4VLzI+Cxk=", "PpdaB");
        K.lllIIIIlIIII[K.lllIIIIllIlI[21]] = K.lIIIlIIIIlllIII("F7Ueu7FJ10oXUWD0l1J10A==", "RePym");
        K.lllIIIIlIIII[K.lllIIIIllIlI[34]] = K.lIIIlIIIIllIlll("6jTy8JPLMnvgpDk056h4vg==", "aFwsV");
        K.lllIIIIlIIII[K.lllIIIIllIlI[51]] = K.lIIIlIIIIlllIII("hNf7Yx6Pjr2abnPjA8cieg==", "zqKoJ");
        K.lllIIIIlIIII[K.lllIIIIllIlI[20]] = K.lIIIlIIIIllIlll("rE1HNh2xPYIiM1cfUA023Q==", "iQvOl");
    }
    ...
    public boolean a(Locatable locatable) {
        Iterator<WorldArea> lllllllllllllllIIlllIIIIllIlIllI = this.startAreas.get().iterator();
        while (K.lIIIlIIIlIllIll(lllllllllllllllIIlllIIIIllIlIllI.hasNext() ? 1 : 0)) {
            void lllllllllllllllIIlllIIIIllIlIlll;
            WorldArea lllllllllllllllIIlllIIIIllIlIlIl = lllllllllllllllIIlllIIIIllIlIllI.next();
            if (K.lIIIlIIIlIllIll(lllllllllllllllIIlllIIIIllIlIlIl.contains((Locatable)lllllllllllllllIIlllIIIIllIlIlll) ? 1 : 0)) {
                return lllIIIIllIlI[1];
            }
            "".length();
            if (null == null) continue;
            return ((93 + 102 - 135 + 133 ^ 83 + 38 - -26 + 10) & (0x50 ^ 0x42 ^ (0xCF ^ 0x81) ^ -" ".length())) != 0;
        }
        return lllIIIIllIlI[0];
    }
    ...
    private static String lIIIlIIIIllIlll(String lllllllllllllllIIlllIIIIlIlIllIl, String lllllllllllllllIIlllIIIIlIlIllII) {
        try {
            ...
            Cipher lllllllllllllllIIlllIIIIlIlIllll = Cipher.getInstance("DES");
            lllllllllllllllIIlllIIIIlIlIllll.init(lllIIIIllIlI[4], lllllllllllllllIIlllIIIIlIllIIII);
            return new String(lllllllllllllllIIlllIIIIlIlIllll.doFinal(Base64.getDecoder().decode(lllllllllllllllIIlllIIIIlIlIllIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIIIlIIIIlllIII(String lllllllllllllllIIlllIIIIlIlIIIII, String lllllllllllllllIIlllIIIIlIIlllll) {
        try {
            SecretKeySpec lllllllllllllllIIlllIIIIlIlIIIll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIlllIIIIlIIlllll.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIIlllIIIIlIlIIIlI = Cipher.getInstance("Blowfish");
            lllllllllllllllIIlllIIIIlIlIIIlI.init(lllIIIIllIlI[4], lllllllllllllllIIlllIIIIlIlIIIll);
    ...
    private K(List<Triple<RegionPoint, Integer, Integer>> list, RegionPoint regionPoint, RegionPoint regionPoint2, L l2) {
        this.startAreas = () -> {
            ...
            Iterator lllllllllllllllIIlllIIIIllIIlllI = list.iterator();
            while (K.lIIIlIIIlIllIll(lllllllllllllllIIlllIIIIllIIlllI.hasNext() ? 1 : 0)) {
                void lllllllllllllllIIlllIIIIllIIllll;
                Triple lllllllllllllllIIlllIIIIllIIllIl = (Triple)lllllllllllllllIIlllIIIIllIIlllI.next();
                lllllllllllllllIIlllIIIIllIIllll.add(new WorldArea(SquireSepulchre.a((RegionPoint)lllllllllllllllIIlllIIIIllIIllIl.getFirst()), ((Integer)lllllllllllllllIIlllIIIIllIIllIl.getSecond()).intValue(), ((Integer)lllllllllllllllIIlllIIIIllIIllIl.getThird()).intValue()));
                "".length();
                "".length();
                if ("   ".length() == "   ".length()) continue;
                return null;
