...
extends Enum<z> {
    ...
    private static void lIIIlIIlllllllI() {
        ...
        z.lllIIlIIllIl[1] = " ".length();
        z.lllIIlIIllIl[2] = "  ".length();
        z.lllIIlIIllIl[3] = "   ".length();
    ...
    private static void lIIIlIIllllllIl() {
        ...
        z.lllIIlIIllII[z.lllIIlIIllIl[0]] = z.lIIIlIIlllllIlI("OY7zf/EKGKE=", "jfRni");
        z.lllIIlIIllII[z.lllIIlIIllIl[1]] = z.lIIIlIIlllllIll("gVmEMV+pdO5yOFQ24EwrlA==", "KhFFF");
        z.lllIIlIIllII[z.lllIIlIIllIl[2]] = z.lIIIlIIlllllIlI("f/qVcTXaXc/We9c5dPVjWw==", "CWNCj");
        z.lllIIlIIllII[z.lllIIlIIllIl[3]] = z.lIIIlIIlllllIll("Oq9z84umFQV/kTNRbPo1OQ==", "cIWzO");
        z.lllIIlIIllII[z.lllIIlIIllIl[4]] = z.lIIIlIIlllllIll("p0GgdMVZ9/wpRey4p3hA1g==", "cWdxY");
        z.lllIIlIIllII[z.lllIIlIIllIl[5]] = z.lIIIlIIllllllII("Lx5hOQItCxwnCTc=", "cHTfG");
        z.lllIIlIIllII[z.lllIIlIIllIl[6]] = z.lIIIlIIllllllII("NhJkOyc0BxolLC4=", "zDRdb");
    }
