...
extends Enum<u> {
    ...
    private static void lIIIlIIIIlllllI() {
        ...
        u.lllIIIIlIIll[1] = " ".length();
        u.lllIIIIlIIll[2] = "  ".length();
        u.lllIIIIlIIll[3] = "   ".length();
    ...
    private static void lIIIlIIIIllllIl() {
        ...
        u.lllIIIIlIIlI[u.lllIIIIlIIll[0]] = u.lIIIlIIIIlllIlI("QTUa/Z+2rQrzmXzU2ZQcTw==", "QzPXI");
        u.lllIIIIlIIlI[u.lllIIIIlIIll[1]] = u.lIIIlIIIIlllIll("PiM6NTs0LSQ+LTM+", "vlvld");
        u.lllIIIIlIIlI[u.lllIIIIlIIll[2]] = u.lIIIlIIIIlllIll("AhkeBjYRFx8GKA0=", "AXMRi");
        u.lllIIIIlIIlI[u.lllIIIIlIIll[3]] = u.lIIIlIIIIlllIll("JjQiOB4hNA==", "dfcbW");
        u.lllIIIIlIIlI[u.lllIIIIlIIll[4]] = u.lIIIlIIIIllllII("nSkT02XTIOQ=", "IAyhE");
    }
