...
extends Enum<t> {
    ...
    private t(List<Triple<RegionPoint, Integer, Integer>> list, RegionPoint regionPoint, int n3, int n4, u u2) {
        this.startAreas = () -> {
            ...
            Iterator lllllllllllllllIIlllIlIIIIllIIIl = list.iterator();
            while (t.lIIIIllllllIllI(lllllllllllllllIIlllIlIIIIllIIIl.hasNext() ? 1 : 0)) {
                void lllllllllllllllIIlllIlIIIIllIIlI;
                Triple lllllllllllllllIIlllIlIIIIllIIII = (Triple)lllllllllllllllIIlllIlIIIIllIIIl.next();
                lllllllllllllllIIlllIlIIIIllIIlI.add(new WorldArea(SquireSepulchre.a((RegionPoint)lllllllllllllllIIlllIlIIIIllIIII.getFirst()), ((Integer)lllllllllllllllIIlllIlIIIIllIIII.getSecond()).intValue(), ((Integer)lllllllllllllllIIlllIlIIIIllIIII.getThird()).intValue()));
                "".length();
                "".length();
    ...
    private static String lIIIIlllllIIIlI(String lllllllllllllllIIlllIlIIIIlIlIII, String lllllllllllllllIIlllIlIIIIlIIlIl) {
        try {
            SecretKeySpec lllllllllllllllIIlllIlIIIIlIlIll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIlllIlIIIIlIIlIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllIIlllIlIIIIlIlIlI = Cipher.getInstance("Blowfish");
            lllllllllllllllIIlllIlIIIIlIlIlI.init(llIlllllllII[2], lllllllllllllllIIlllIlIIIIlIlIll);
    ...
    public boolean a(d d2, SquireSepulchre squireSepulchre) {
        void var6_6;
        void lllllllllllllllIIlllIlIIIlIlIlII;
        void lllllllllllllllIIlllIlIIIlIlIIll;
        t lllllllllllllllIIlllIlIIIlIlIlIl;
        Player player = Players.getLocal();
        if (t.lIIIIllllllIIIl(player)) {
            return llIlllllllII[0];
        }
        if (t.lIIIIllllllIIlI(lllllllllllllllIIlllIlIIIlIlIlIl.a((Locatable)lllllllllllllllIIlllIlIIIlIlIIll) ? 1 : 0)) {
            return llIlllllllII[0];
        }
        System.out.println(llIllllllIlI[llIlllllllII[0]]);
        TileObject lllllllllllllllIIlllIlIIIlIlIIlI = null;
        int lllllllllllllllIIlllIlIIIlIlIIIl = lllllllllllllllIIlllIlIIIlIlIlII.c();
        System.out.println("Time: " + lllllllllllllllIIlllIlIIIlIlIIIl);
        TileObject lllllllllllllllIIlllIlIIIlIlIIII = null;
        if (t.lIIIIllllllIIll(lllllllllllllllIIlllIlIIIlIlIIIl, llIlllllllII[1])) {
            lllllllllllllllIIlllIlIIIlIlIIII = TileObjects.getNearest(tileObject -> {
                int n2;
        ...
        if (t.lIIIIllllllIlII((Object)lllllllllllllllIIlllIlIIIlIlIlIl.type, (Object)u.HOLY_BARRIER)) {
            lllllllllllllllIIlllIlIIIlIlIIlI = TileObjects.getNearest(tileObject -> {
                int n2;
                if (t.lIIIIllllllIllI(tileObject.getName().toLowerCase().equals(llIllllllIlI[llIlllllllII[36]]) ? 1 : 0)) {
                    ...
                    if (t.lIIIIllllllIllI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                        ...
                        return ((0x1C ^ 7 ^ (0x12 ^ 0x15)) & (0x50 ^ 3 ^ (0xF0 ^ 0xBF) ^ -" ".length())) != 0;
                    }
                }
                n2 = llIlllllllII[0];
                return n2 != 0;
        ...
        } else if (t.lIIIIllllllIlII((Object)lllllllllllllllIIlllIlIIIlIlIlIl.type, (Object)u.FIX_BRIDGE)) {
            lllllllllllllllIIlllIlIIIlIlIIlI = TileObjects.getNearest(tileObject -> {
                int n2;
        ...
        } else if (t.lIIIIllllllIlII((Object)lllllllllllllllIIlllIlIIIlIlIlIl.type, (Object)u.CAST_PORTAL)) {
            lllllllllllllllIIlllIlIIIlIlIIlI = TileObjects.getNearest(tileObject -> {
                int n2;
                if (t.lIIIIllllllIllI(tileObject.getName().toLowerCase().contains(llIllllllIlI[llIlllllllII[30]]) ? 1 : 0)) {
                    ...
                    if (t.lIIIIllllllIllI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                        n2 = llIlllllllII[1];
                        "".length();
                        if (((0x86 ^ 0x8F) & ~(0x89 ^ 0x80)) != -" ".length()) return n2 != 0;
        ...
        } else if (t.lIIIIllllllIlII((Object)lllllllllllllllIIlllIlIIIlIlIlIl.type, (Object)u.BRAZIER)) {
            lllllllllllllllIIlllIlIIIlIlIIlI = TileObjects.getNearest(tileObject -> {
                int n2;
                if (t.lIIIIllllllIllI(tileObject.getName().toLowerCase().contains(llIllllllIlI[llIlllllllII[28]]) ? 1 : 0)) {
                    ...
                    if (t.lIIIIllllllIllI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                        n2 = llIlllllllII[1];
                        "".length();
                        if (-" ".length() < (13 + 46 - -51 + 18 ^ 41 + 4 - -45 + 42)) return n2 != 0;
                        return ((0x51 ^ 0x25 ^ (0x52 ^ 0x66)) & (0xE8 ^ 0x9D ^ (0 ^ 0x35) ^ -" ".length())) != 0;
                    }
                }
                n2 = llIlllllllII[0];
                return n2 != 0;
            ...
            if (-(0x34 ^ 0x61 ^ (0x24 ^ 0x75)) > 0) {
                return ((0x35 ^ 0x21 ^ (6 ^ 0x2F)) & (0x45 ^ 0x1D ^ (0x67 ^ 2) ^ -" ".length())) != 0;
            }
        } else if (t.lIIIIllllllIlII((Object)lllllllllllllllIIlllIlIIIlIlIlIl.type, (Object)u.GRAPPLE)) {
            lllllllllllllllIIlllIlIIIlIlIIlI = TileObjects.getNearest(tileObject -> {
                int n2;
        ...
        if (t.lIIIIllllllIIIl(lllllllllllllllIIlllIlIIIlIlIIlI)) {
            System.out.println(llIllllllIlI[llIlllllllII[1]]);
            if (t.lIIIIllllllIlIl((Object)lllllllllllllllIIlllIlIIIlIlIlIl.type, (Object)u.BRAZIER)) {
                return llIlllllllII[0];
            }
            lllllllllllllllIIlllIlIIIlIlIIlI = TileObjects.getNearest(tileObject -> {
                int n2;
        ...
        if (t.lIIIIllllllIIlI(lllllllllllllllIIlllIlIIIlIlIlIl.d((Locatable)lllllllllllllllIIlllIlIIIlIlIIll) ? 1 : 0)) {
            if (t.lIIIIllllllIIIl(lllllllllllllllIIlllIlIIIlIlIIII)) {
                System.out.println(llIllllllIlI[llIlllllllII[2]]);
                return llIlllllllII[0];
            }
            if (t.lIIIIllllllIlII((Object)lllllllllllllllIIlllIlIIIlIlIlIl.type, (Object)u.FIX_BRIDGE)) {
                ...
                if (t.lIIIIllllllIIlI(a.a(lllllllllllllllIIlllIlIIIlIlIlII.a()) ? 1 : 0)) {
            ...
            lllllllllllllllIIlllIlIIIlIlIIlI.interact(stringArray);
    ...
    private static void lIIIIllllllIIII() {
        ...
        t.llIlllllllII[0] = (0xE ^ 0x4E ^ (0x98 ^ 0xC3)) & (0xEF ^ 0xC7 ^ (0x1B ^ 0x28) ^ -" ".length());
        t.llIlllllllII[1] = " ".length();
        t.llIlllllllII[2] = "  ".length();
        t.llIlllllllII[3] = "   ".length();
    ...
    public boolean a(Locatable locatable) {
        t lllllllllllllllIIlllIlIIIlIIlIll;
        if (t.lIIIIllllllIllI(this.lootArea.get().contains(locatable) ? 1 : 0)) {
            return llIlllllllII[1];
        }
        Iterator<WorldArea> lllllllllllllllIIlllIlIIIlIIlIIl = lllllllllllllllIIlllIlIIIlIIlIll.startAreas.get().iterator();
        while (t.lIIIIllllllIllI(lllllllllllllllIIlllIlIIIlIIlIIl.hasNext() ? 1 : 0)) {
            void lllllllllllllllIIlllIlIIIlIIlIlI;
            WorldArea lllllllllllllllIIlllIlIIIlIIlIII = lllllllllllllllIIlllIlIIIlIIlIIl.next();
            if (t.lIIIIllllllIllI(lllllllllllllllIIlllIlIIIlIIlIII.contains((Locatable)lllllllllllllllIIlllIlIIIlIIlIlI) ? 1 : 0)) {
                return llIlllllllII[1];
            }
            "".length();
    ...
    private static String lIIIIlllllIlllI(String lllllllllllllllIIlllIlIIIIIIIIll, String lllllllllllllllIIlllIlIIIIIIIIlI) {
        try {
            SecretKeySpec lllllllllllllllIIlllIlIIIIIIIllI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIlllIlIIIIIIIIlI.getBytes(StandardCharsets.UTF_8)), llIlllllllII[8]), "DES");
            Cipher lllllllllllllllIIlllIlIIIIIIIlIl = Cipher.getInstance("DES");
            lllllllllllllllIIlllIlIIIIIIIlIl.init(llIlllllllII[2], lllllllllllllllIIlllIlIIIIIIIllI);
    ...
    private static void lIIIIlllllIllll() {
        ...
        t.llIllllllIlI[t.llIlllllllII[0]] = t.lIIIIlllllIIIlI("mm/WyYyAsY3kolDdziiFiA==", "LDnPN");
        t.llIllllllIlI[t.llIlllllllII[1]] = t.lIIIIlllllIIIlI("L2yQsCQorE7KwMwRSq86yr0brVhgVMM/", "AfWPm");
        t.llIllllllIlI[t.llIlllllllII[2]] = t.lIIIIlllllIllIl("ESwgFCwcYy8BZRw2Kh4=", "rCFrE");
        t.llIllllllIlI[t.llIlllllllII[3]] = t.lIIIIlllllIlllI("rG85ByVdwSFK7fXMnHyrKYrAHsX+Aeak5P3FJcEP+IiGwrvJEod0kA==", "RMBGd");
        t.llIllllllIlI[t.llIlllllllII[4]] = t.lIIIIlllllIllIl("JgAYE2wgBgJHJTMMGxRsIQYERzwoGwIGIGcKHg4pIUlMTw==", "GivgL");
        t.llIllllllIlI[t.llIlllllllII[5]] = t.lIIIIlllllIIIlI("mWrxK2f9/OjAas2FDZdB/7FwjL1LyHop", "AYxuE");
        t.llIllllllIlI[t.llIlllllllII[6]] = t.lIIIIlllllIlllI("gmGUOboI2ii9kWGk2U0r09luNCmJCNow6EtFme44HWE=", "pDrCw");
        t.llIllllllIlI[t.llIlllllllII[7]] = t.lIIIIlllllIllIl("IgEyFRwqDDJQBzhPKAUCJ08uHQMsCg==", "KoFpn");
        t.llIllllllIlI[t.llIlllllllII[8]] = t.lIIIIlllllIlllI("BVdIhBcNN+H0d+AJnIZANDZWi2qcpDerjMIE2cR+iP4=", "JHAeu");
        t.llIllllllIlI[t.llIlllllllII[9]] = t.lIIIIlllllIllIl("BTcBP0YhPgAjHjI+", "UVrLk");
        t.llIllllllIlI[t.llIlllllllII[10]] = t.lIIIIlllllIllIl("ISot", "gCUXQ");
        t.llIllllllIlI[t.llIlllllllII[11]] = t.lIIIIlllllIlllI("BeR8WeHND3NsUUjAsMaaMg==", "AwCBf");
        t.llIllllllIlI[t.llIlllllllII[12]] = t.lIIIIlllllIIIlI("g88u/fYfPeA=", "FvySq");
        t.llIllllllIlI[t.llIlllllllII[13]] = t.lIIIIlllllIllIl("ECU8AU8oMjUY", "GDPjb");
        t.llIllllllIlI[t.llIlllllllII[14]] = t.lIIIIlllllIIIlI("EXYYZtfSFdQ=", "cuaPD");
        t.llIllllllIlI[t.llIlllllllII[15]] = t.lIIIIlllllIllIl("ND0oHB82P2kLBD05", "XXIjv");
        t.llIllllllIlI[t.llIlllllllII[16]] = t.lIIIIlllllIlllI("P2Er0yapQSQh2K/gU6l0MQ==", "fVwEK");
        t.llIllllllIlI[t.llIlllllllII[17]] = t.lIIIIlllllIllIl("PDsa", "zRbnm");
        t.llIllllllIlI[t.llIlllllllII[18]] = t.lIIIIlllllIllIl("PzQhEQ8KPCEG", "lUBcf");
        t.llIllllllIlI[t.llIlllllllII[19]] = t.lIIIIlllllIlllI("hdvaoiaIgGw=", "hrZdg");
        t.llIllllllIlI[t.llIlllllllII[20]] = t.lIIIIlllllIllIl("GA8kI1sgGC06", "OnHHv");
        t.llIllllllIlI[t.llIlllllllII[21]] = t.lIIIIlllllIllIl("NBMrOQEfBA==", "saJIq");
        t.llIllllllIlI[t.llIlllllllII[22]] = t.lIIIIlllllIlllI("EguX3jsOtIZJgemnPAc47Q==", "HHDXK");
        t.llIllllllIlI[t.llIlllllllII[23]] = t.lIIIIlllllIllIl("Ai4sJhU5Zis7BHw/PzUGIg==", "QKMTv");
        t.llIllllllIlI[t.llIlllllllII[24]] = t.lIIIIlllllIlllI("QJQMEEDmT+NVweBjknJyqA==", "DMAMI");
        t.llIllllllIlI[t.llIlllllllII[25]] = t.lIIIIlllllIIIlI("EJ6WZE1R+PAV0kJpEWlbgA==", "ZjqIT");
        t.llIllllllIlI[t.llIlllllllII[26]] = t.lIIIIlllllIllIl("AwIfHwwB", "skssm");
        t.llIllllllIlI[t.llIlllllllII[27]] = t.lIIIIlllllIIIlI("jxr8bsjmRuE=", "BkJWb");
        t.llIllllllIlI[t.llIlllllllII[28]] = t.lIIIIlllllIllIl("HjE7KwgCPSAkTA8iKDAFCCI=", "mPIJl");
        t.llIllllllIlI[t.llIlllllllII[29]] = t.lIIIIlllllIllIl("FAgxOjEhADEt", "GiRHX");
        t.llIllllllIlI[t.llIlllllllII[30]] = t.lIIIIlllllIIIlI("GaJOnyk7Lcs=", "dSJMj");
        t.llIllllllIlI[t.llIlllllllII[31]] = t.lIIIIlllllIlllI("4SaSqnY0Apk=", "tBDff");
        t.llIllllllIlI[t.llIlllllllII[32]] = t.lIIIIlllllIlllI("hswJ49C+9o0rbtkogNlfVw==", "DgCTh");
        t.llIllllllIlI[t.llIlllllllII[33]] = t.lIIIIlllllIllIl("LhgYBwop", "Ljqcm");
        t.llIllllllIlI[t.llIlllllllII[34]] = t.lIIIIlllllIlllI("HwIkMFWYZjk=", "bpbvv");
        t.llIllllllIlI[t.llIlllllllII[35]] = t.lIIIIlllllIllIl("FA8rAEIsGCIZ", "CnGko");
        t.llIllllllIlI[t.llIlllllllII[36]] = t.lIIIIlllllIIIlI("rSx2Pk8O+9nePJLLhpHgaw==", "mbFRV");
        t.llIllllllIlI[t.llIlllllllII[37]] = t.lIIIIlllllIllIl("BAY9PWIgDzwhOjMP", "TgNNO");
        t.llIllllllIlI[t.llIlllllllII[38]] = t.lIIIIlllllIllIl("LiUkIx0D", "mJBEt");
        t.llIllllllIlI[t.llIlllllllII[39]] = t.lIIIIlllllIIIlI("fW9Uht7dHUBlo6JZeQs3oUm4zP2B+U0b", "KuIXp");
        t.llIllllllIlI[t.llIlllllllII[40]] = t.lIIIIlllllIllIl("DSEqCyEAMSUbNwcxPwI9GiY=", "NnlMh");
        t.llIllllllIlI[t.llIlllllllII[43]] = t.lIIIIlllllIllIl("Ox8rDSo2DyQdPDEPIwQxLBg=", "xPmKc");
        t.llIllllllIlI[t.llIlllllllII[45]] = t.lIIIIlllllIIIlI("LVnal8cOiVKCIWUwN6aYsQ==", "wIein");
        t.llIllllllIlI[t.llIlllllllII[46]] = t.lIIIIlllllIlllI("8286GLr0wZbIKYSFXSV9Jw==", "AjUMY");
        t.llIllllllIlI[t.llIlllllllII[47]] = t.lIIIIlllllIIIlI("7CTcwLcb18EmsWaicSDVQQ==", "ulUAK");
        t.llIllllllIlI[t.llIlllllllII[48]] = t.lIIIIlllllIIIlI("YdX+JWBAGhWrx0z8kxtEeQ==", "HYgmP");
        t.llIllllllIlI[t.llIlllllllII[49]] = t.lIIIIlllllIlllI("hY3uFaR9aK45oCeAu3ryhw==", "IJVMd");
    }
    ...
    private static String lIIIIlllllIllIl(String lllllllllllllllIIlllIlIIIIIlIIll, String lllllllllllllllIIlllIlIIIIIlIIlI) {
        lllllllllllllllIIlllIlIIIIIlIIll = new String(Base64.getDecoder().decode(lllllllllllllllIIlllIlIIIIIlIIll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllIIlllIlIIIIIlIllI = new StringBuilder();
        char[] lllllllllllllllIIlllIlIIIIIlIlIl = lllllllllllllllIIlllIlIIIIIlIIlI.toCharArray();
        int lllllllllllllllIIlllIlIIIIIlIlII = llIlllllllII[0];
        char[] lllllllllllllllIIlllIlIIIIIIlllI = lllllllllllllllIIlllIlIIIIIlIIll.toCharArray();
        int lllllllllllllllIIlllIlIIIIIIllIl = lllllllllllllllIIlllIlIIIIIIlllI.length;
        int lllllllllllllllIIlllIlIIIIIIllII = llIlllllllII[0];
        while (t.lIIIIllllllIlll(lllllllllllllllIIlllIlIIIIIIllII, lllllllllllllllIIlllIlIIIIIIllIl)) {
            char lllllllllllllllIIlllIlIIIIIllIIl = lllllllllllllllIIlllIlIIIIIIlllI[lllllllllllllllIIlllIlIIIIIIllII];
            ...
            ++lllllllllllllllIIlllIlIIIIIIllII;
            "".length();
