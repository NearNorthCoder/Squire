...
extends Enum<i> {
    ...
    private static /* synthetic */ boolean a(Player player, TileObject tileObject) {
        ...
        if (i.lIIIlIlIIlIIllI(tileObject.getWorldY() - player.getWorldY(), lllIIlIllIlI[17]) && i.lIIIlIlIIlIIllI(Math.abs(player.getWorldX() - tileObject.getWorldX()), lllIIlIllIlI[6]) && i.lIIIlIlIIlIIIII(player.getPlane(), tileObject.getPlane()) && i.lIIIlIlIIIlllIl(tileObject.getName().equals(lllIIlIIIlIl[lllIIlIllIlI[18]]) ? 1 : 0)) {
            n2 = lllIIlIllIlI[1];
            "".length();
            if (((0xF8 ^ 0x91 ^ (0xB2 ^ 0x8E)) & (0x34 ^ 0x18 ^ (0xF8 ^ 0x81) ^ -" ".length())) != 0) {
    ...
    public boolean O() {
            ...
            while (i.lIIIlIlIIIlllIl(lllllllllllllllIIllIlIlIIIIIIllI.hasNext() ? 1 : 0)) {
                ...
                if (i.lIIIlIlIIlIIIll(lllllllllllllllIIllIlIlIIIIIIlII, b.x)) {
                    if (!i.lIIIlIlIIlIIlIl((Object)lllllllllllllllIIllIlIlIIIIIlllI.type, (Object)k.SOUTH) || !i.lIIIlIlIIlIIlIl((Object)lllllllllllllllIIllIlIlIIIIIlllI.type, (Object)k.NORTH) || i.lIIIlIlIIIlllll((Object)lllllllllllllllIIllIlIlIIIIIlllI.type, (Object)k.SOUTH_BLADE)) {
                        ...
                        return ((8 + 108 - 65 + 79 ^ 150 + 37 - 131 + 95) & (33 + 60 - 15 + 69 ^ 44 + 33 - -48 + 9 ^ -" ".length())) != 0;
                    }
                    ...
                    "".length();
                    "".length();
                    if (-" ".length() != ((0x3C ^ 8 ^ (0x1B ^ 0xC)) & (4 ^ 0x75 ^ (0xF4 ^ 0xA6) ^ -" ".length()))) continue;
                    return ((0x92 ^ 0xB0 ^ (0x5C ^ 0x47)) & (165 + 42 - 64 + 42 ^ 42 + 109 - 127 + 104 ^ -" ".length())) != 0;
                }
        ...
        while (i.lIIIlIlIIlIIllI(lllllllllllllllIIllIlIlIIIIIIllI, lllIIlIllIlI[5])) {
            ...
            if (!i.lIIIlIlIIlIIlIl((Object)lllllllllllllllIIllIlIlIIIIIlllI.type, (Object)k.SOUTH) || i.lIIIlIlIIIlllll((Object)lllllllllllllllIIllIlIlIIIIIlllI.type, (Object)k.SOUTH_BLADE)) {
                if (i.lIIIlIlIIlIIllI(lllllllllllllllIIllIlIlIIIIIIlIl.getWorldY(), lllllllllllllllIIllIlIlIIIIIllIl.getWorldY())) {
                    ...
                    "".length();
                    if (-" ".length() <= ((0x1D ^ 0x7E) & ~(0x7A ^ 0x19))) continue;
            ...
            if (i.lIIIlIlIIIlllll((Object)lllllllllllllllIIllIlIlIIIIIlllI.type, (Object)k.EAST)) {
                if (i.lIIIlIlIIlIlIII(lllllllllllllllIIllIlIlIIIIIIlIl.getWorldX(), lllllllllllllllIIllIlIlIIIIIllIl.getWorldX())) {
                    ...
                    ++lllllllllllllllIIllIlIlIIIIIIllI;
                    "".length();
                    if (" ".length() >= ((0x62 ^ 0x25) & ~(0xD7 ^ 0x90))) continue;
            ...
            if (i.lIIIlIlIIIlllll((Object)lllllllllllllllIIllIlIlIIIIIlllI.type, (Object)k.NORTH)) {
                if (i.lIIIlIlIIlIlIII(lllllllllllllllIIllIlIlIIIIIIlIl.getWorldY(), lllllllllllllllIIllIlIlIIIIIllIl.getWorldY())) {
                    ...
                    return ((143 + 182 - 230 + 101 ^ 64 + 43 - 71 + 112) & (0x41 ^ 0x6E ^ 55 + 9 - 62 + 125 ^ -" ".length())) != 0;
                }
                lllllllllllllllIIllIlIlIIIIIIlll.remove(lllllllllllllllIIllIlIlIIIIIIllI);
                "".length();
            }
            "".length();
            if ((0x9F ^ 0x9B) >= "   ".length()) continue;
        ...
        if (!i.lIIIlIlIIlIIlIl((Object)lllllllllllllllIIllIlIlIIIIIlllI.type, (Object)k.SOUTH) || !i.lIIIlIlIIlIIlIl((Object)lllllllllllllllIIllIlIlIIIIIlllI.type, (Object)k.NORTH) || i.lIIIlIlIIIlllll((Object)lllllllllllllllIIllIlIlIIIIIlllI.type, (Object)k.SOUTH_BLADE)) {
            ...
            "".length();
            if (" ".length() != " ".length()) {
                return ((206 + 147 - 245 + 116 ^ 31 + 26 - -24 + 97) & (0x34 ^ 0x20 ^ (0xD5 ^ 0x93) ^ -" ".length())) != 0;
            }
        } else if (!i.lIIIlIlIIlIIlIl((Object)lllllllllllllllIIllIlIlIIIIIlllI.type, (Object)k.WEST) || i.lIIIlIlIIIlllll((Object)lllllllllllllllIIllIlIlIIIIIlllI.type, (Object)k.EAST)) {
            lllllllllllllllIIllIlIlIIIIIlIll.removeIf(worldPoint -> lllllllllllllllIIllIlIlIIIIIlIIl.contains(worldPoint.getWorldY()));
            "".length();
    ...
    private static void lIIIlIlIIIllIlI() {
        ...
        i.lllIIlIIIlIl[i.lllIIlIllIlI[0]] = i.lIIIlIIllllIIIl("vtUDytWzqCGnVa0MPP8Ocg==", "wrAfh");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[1]] = i.lIIIlIIllllIIll("Iw0BBhAcQzsVGRwWDQ==", "hchax");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[5]] = i.lIIIlIIllllIlII("3YQgyFr3/rglJ5n3WzCCsw==", "iMdJR");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[6]] = i.lIIIlIIllllIIll("BBoCFC8TUgsILR4BBUEqBFILAC8EFw==", "wrmaC");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[2]] = i.lIIIlIIllllIlII("9yVBBgzrq+48gRkZK7RBlg==", "EpgXy");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[8]] = i.lIIIlIIllllIIIl("LsaBUv4soZbIZbhV1QeLew==", "yAYSh");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[9]] = i.lIIIlIIllllIIll("Mj8mIh4UM2ctERQ2Iw==", "qWGLy");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[10]] = i.lIIIlIIllllIIIl("5iMgxOprD6Cse8BkVbUvPg==", "WoDUb");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[11]] = i.lIIIlIIllllIlII("u1AVPP/+GSWjg8VSSkl3Ig==", "UaBsC");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[12]] = i.lIIIlIIllllIIIl("ipefsnZbl6o=", "ZHlyp");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[13]] = i.lIIIlIIllllIlII("IG0sXhkJJMqak0mIfcmW+A==", "iASbT");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[14]] = i.lIIIlIIllllIIIl("T2SUtU+C2MJ6WrADPxZBhuNTsPjaF8ih", "oBUYN");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[4]] = i.lIIIlIIllllIIIl("PqsbfdusZhg=", "RnjmT");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[15]] = i.lIIIlIIllllIIll("MiQFHTVMZQAIKh0sGQ5mFy0SCCI=", "vEwiF");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[16]] = i.lIIIlIIllllIIll("LR4lBDBp", "HlWkB");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[18]] = i.lIIIlIIllllIlII("yOfEFpam9CUh+iht7XPHpthyPDj8hsIk", "FjHYG");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[19]] = i.lIIIlIIllllIIIl("BkPocArvNzW4PK7rnLiG8RA//zioXkbY", "znFPE");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[20]] = i.lIIIlIIllllIlII("1qmjJ+Uu19Zboo9rzobmlRBCu37JAtnQ", "gcgis");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[17]] = i.lIIIlIIllllIIIl("170GGqHrJOZcObgloJkeXZ0xtpqrUJXF", "LrwIY");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[21]] = i.lIIIlIIllllIIll("ASUmNiQQIysr", "Ojtbl");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[3]] = i.lIIIlIIllllIIll("JBYgATg6DDoD", "sSsUg");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[36]] = i.lIIIlIIllllIIIl("rKscDzuQ3AuicWAS3G2Kag==", "Wurmk");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[38]] = i.lIIIlIIllllIIIl("15ywSA9eHeglSMuLkvUchw==", "DefOD");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[23]] = i.lIIIlIIllllIlII("wobbdOzAgPXI3S/UtDMPoQ==", "JCRUg");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[40]] = i.lIIIlIIllllIIll("Cw4UAxkHBhgB", "NOGWF");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[42]] = i.lIIIlIIllllIIIl("jPrT2Y6JcC/WK5Ai0E87jQ==", "JiDWs");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[27]] = i.lIIIlIIllllIIIl("MMkAVpsqrbKKKztHbrjZXA==", "ScglZ");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[49]] = i.lIIIlIIllllIIIl("SlcNMWSIwZVH0kF5GbPuaQ==", "FKrhB");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[24]] = i.lIIIlIIllllIIll("IDA7GBk+PCETEA==", "wuhLF");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[26]] = i.lIIIlIIllllIIll("Fx8CPgIbGQE1HA0=", "DPWjJ");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[39]] = i.lIIIlIIllllIIll("GRk4JRsIHzwuBQ==", "WVjqS");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[37]] = i.lIIIlIIllllIlII("AyeB+3NVXTHD/dxhIL2L0g==", "eKiBO");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[59]] = i.lIIIlIIllllIlII("X+nIgns5CjY53wXOclOr0w==", "SViCE");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[62]] = i.lIIIlIIllllIIll("FAMkPT4YFCggKBg=", "QBwia");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[47]] = i.lIIIlIIllllIIll("AS4wFhQfPTwU", "VkcBK");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[50]] = i.lIIIlIIllllIlII("pk9ZLvALBK5i9dc5QvURPQ==", "GwFsf");
        i.lllIIlIIIlIl[i.lllIIlIllIlI[51]] = i.lIIIlIIllllIIIl("dM4RW7XtKwCX23gwY0ntOw==", "mYqwT");
    }
    ...
    private static /* synthetic */ boolean e(Player player, NPC nPC) {
        ...
        if (i.lIIIlIlIIIlllIl(b.z.contains(nPC.getId()) ? 1 : 0) && i.lIIIlIlIIlIIllI(nPC.getWorldY(), player.getWorldY() + lllIIlIllIlI[1]) && i.lIIIlIlIIlIIllI(Math.abs(nPC.getWorldX() - player.getWorldX()), lllIIlIllIlI[2]) && i.lIIIlIlIIlIlIII(nPC.getWorldY(), player.getWorldY() - lllIIlIllIlI[3]) && i.lIIIlIlIIlIIIII(nPC.getPlane(), player.getPlane())) {
            ...
            "".length();
            if ("   ".length() == -" ".length()) {
                return ((8 ^ 0x4C ^ (0x19 ^ 0x69)) & (0xD5 ^ 0x92 ^ (0x7B ^ 8) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lllIIlIllIlI[0];
        }
    ...
    private static /* synthetic */ boolean b(Player player, TileObject tileObject) {
        ...
        if (i.lIIIlIlIIlIIllI(tileObject.getWorldX() - player.getWorldX(), lllIIlIllIlI[17]) && i.lIIIlIlIIlIIllI(Math.abs(player.getWorldY() - tileObject.getWorldY()), lllIIlIllIlI[6]) && i.lIIIlIlIIlIIIII(player.getPlane(), tileObject.getPlane()) && i.lIIIlIlIIIlllIl(tileObject.getName().equals(lllIIlIIIlIl[lllIIlIllIlI[19]]) ? 1 : 0)) {
            n2 = lllIIlIllIlI[1];
            "".length();
            if ((0xD6 ^ 0xC0 ^ (0x11 ^ 3)) < (0x6A ^ 0x6F ^ " ".length())) {
                return ((0x58 ^ 0x19 ^ (0xF4 ^ 0x8C)) & (0x54 ^ 0x41 ^ (0x67 ^ 0x4B) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lllIIlIllIlI[0];
        }
    ...
    private static /* synthetic */ boolean d(Player player, TileObject tileObject) {
        ...
        if (i.lIIIlIlIIlIIllI(player.getWorldY() - tileObject.getWorldY(), lllIIlIllIlI[17]) && i.lIIIlIlIIlIIllI(Math.abs(player.getWorldX() - tileObject.getWorldX()), lllIIlIllIlI[6]) && i.lIIIlIlIIlIIIII(player.getPlane(), tileObject.getPlane()) && i.lIIIlIlIIIlllIl(tileObject.getName().equals(lllIIlIIIlIl[lllIIlIllIlI[17]]) ? 1 : 0)) {
            ...
            if ((29 + 90 - 111 + 136 ^ 97 + 116 - 199 + 134) == 0) {
                return ((48 + 127 - 126 + 170 ^ 158 + 141 - 151 + 50) & (0x45 ^ 0x54 ^ (0x2A ^ 0x26) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lllIIlIllIlI[0];
        }
    ...
    private static /* synthetic */ boolean b(Player player, NPC nPC) {
        ...
        if (i.lIIIlIlIIIlllIl(b.z.contains(nPC.getId()) ? 1 : 0) && i.lIIIlIlIIlIlIII(nPC.getWorldY(), player.getWorldY() - lllIIlIllIlI[1]) && i.lIIIlIlIIlIIllI(Math.abs(nPC.getWorldX() - player.getWorldX()), lllIIlIllIlI[2]) && i.lIIIlIlIIlIIllI(nPC.getWorldY(), player.getWorldY() + lllIIlIllIlI[3]) && i.lIIIlIlIIlIIIII(nPC.getPlane(), player.getPlane())) {
            ...
            if ((0x32 ^ 0x3F ^ (0x94 ^ 0x9C)) <= 0) {
                return ((0x4B ^ 0x17 ^ (0x1F ^ 0x15)) & (55 + 90 - -3 + 60 ^ 88 + 70 - 50 + 26 ^ -" ".length())) != 0;
            }
        } else {
            n2 = lllIIlIllIlI[0];
        }
    ...
    private static String lIIIlIIllllIIll(String lllllllllllllllIIllIlIIllIlIlIlI, String lllllllllllllllIIllIlIIllIlIlllI) {
        ...
        while (i.lIIIlIlIIlIIllI(lllllllllllllllIIllIlIIllIlIIIll, lllllllllllllllIIllIlIIllIlIIlII)) {
            ...
            "".length();
            if ("  ".length() != (0xDD ^ 0x9F ^ (0x40 ^ 6))) continue;
            return null;
        }
    ...
    private static /* synthetic */ boolean d(Player player, NPC nPC) {
        ...
        if (i.lIIIlIlIIIlllIl(b.z.contains(nPC.getId()) ? 1 : 0) && i.lIIIlIlIIlIIllI(nPC.getWorldX(), player.getWorldX() + lllIIlIllIlI[1]) && i.lIIIlIlIIlIIllI(Math.abs(nPC.getWorldY() - player.getWorldY()), lllIIlIllIlI[2]) && i.lIIIlIlIIlIlIII(nPC.getWorldX(), player.getWorldX() - lllIIlIllIlI[3]) && i.lIIIlIlIIlIIIII(nPC.getPlane(), player.getPlane())) {
            ...
            "".length();
            if (-" ".length() > -" ".length()) {
                return ((0x1F ^ 0x4E ^ (0x32 ^ 0x6F)) & (40 + 19 - 25 + 99 ^ 25 + 131 - 58 + 39 ^ -" ".length())) != 0;
            }
        } else {
            n2 = lllIIlIllIlI[0];
        }
    ...
    private static void lIIIlIlIIIllIll() {
        ...
        i.lllIIlIllIlI[0] = (106 + 149 - 181 + 151 ^ 154 + 42 - 150 + 138) & (0x48 ^ 0x21 ^ (0x66 ^ 0x56) ^ -" ".length());
        i.lllIIlIllIlI[1] = " ".length();
        i.lllIIlIllIlI[2] = 0xA1 ^ 0xA5;
        i.lllIIlIllIlI[3] = 0x51 ^ 0x45;
        i.lllIIlIllIlI[4] = 3 ^ 0xF;
        i.lllIIlIllIlI[5] = "  ".length();
        i.lllIIlIllIlI[6] = "   ".length();
        i.lllIIlIllIlI[7] = -" ".length();
        ...
        i.lllIIlIllIlI[36] = "  ".length() ^ (0x86 ^ 0x91);
