...
extends Enum<I> {
    ...
    private static void lIIIlIIlIlIlIIl() {
        ...
        I.lllIIIllIIlI[0] = (0x30 ^ 0x3D ^ (0x5C ^ 0x63)) & (37 + 142 - 82 + 56 ^ 104 + 81 - 83 + 69 ^ -" ".length());
        I.lllIIIllIIlI[1] = "  ".length();
        I.lllIIIllIIlI[2] = " ".length();
        I.lllIIIllIIlI[3] = 0xA ^ 0x3D ^ (0xC ^ 3);
        I.lllIIIllIIlI[4] = 106 + 85 - 145 + 103 ^ 134 + 110 - 243 + 152;
        I.lllIIIllIIlI[5] = "   ".length();
    ...
    public static List<WorldPoint> aC() {
        ...
        while (I.lIIIlIIlIlIlIlI(lllllllllllllllIIllIlllIIllllIlI, (int)lllllllllllllllIIllIlllIIllllIll)) {
            ...
            "".length();
            if ((0x4B ^ 0xA ^ (0xCB ^ 0x8E)) > " ".length()) continue;
            return null;
        }
        return arrayList;
    }
    ...
    private List<WorldPoint> aD() {
        ...
        list.removeIf(worldPoint -> {
            ...
            if (I.lIIIlIIlIlIlIll((n3 + n2) % lllIIIllIIlI[1])) {
                ...
                "".length();
                if (null != null) {
                    return ((0xF1 ^ 0xA9 ^ (0x26 ^ 0x6A)) & (0xB1 ^ 0xAA ^ (0x17 ^ 0x18) ^ -" ".length())) != 0;
                }
            } else {
                bl = lllIIIllIIlI[0];
            }
    ...
    private static void lIIIlIIlIlIlIII() {
        ...
        I.lllIIIlIlllI[I.lllIIIllIIlI[0]] = I.lIIIlIIlIIllIll("AgA9LSITGjcq", "VHhcf");
        I.lllIIIlIlllI[I.lllIIIllIIlI[2]] = I.lIIIlIIlIIlllII("BjNtde1dnvimlCyrA/6TpQ==", "eeEiv");
        I.lllIIIlIlllI[I.lllIIIllIIlI[1]] = I.lIIIlIIlIIlllII("9BjUxWHBOIJtxyIrEL4zkA==", "cnuRZ");
        I.lllIIIlIlllI[I.lllIIIllIIlI[5]] = I.lIIIlIIlIIllllI("AFdjMy5HHBtWVvQrL4vRcw==", "okyGU");
        I.lllIIIlIlllI[I.lllIIIllIIlI[11]] = I.lIIIlIIlIIlllII("KILOMoupNbQ+JCPQv0ceSw==", "NPwBt");
        I.lllIIIlIlllI[I.lllIIIllIIlI[6]] = I.lIIIlIIlIIllllI("Y/WY/4QS6M27TqBA8fCjeQ==", "bvbZa");
        I.lllIIIlIlllI[I.lllIIIllIIlI[15]] = I.lIIIlIIlIIllIll("Iy4iPSgyNCglJT4=", "wfwsl");
        I.lllIIIlIlllI[I.lllIIIllIIlI[16]] = I.lIIIlIIlIIllIll("OhE/OSgrCzUhJScQ", "nYjwl");
    }
