...
extends Task {
    ...
    private static void llIIIIllIIIIIll() {
        ...
        f.lIlIllllIlIlI[f.lIlIllllIllIl[0]] = f.llIIIIlIlllllIl("EP84ftDodcrQf3uOq09qPg==", "KzBeM");
        f.lIlIllllIlIlI[f.lIlIllllIllIl[1]] = f.llIIIIlIlllllIl("9nMSRHq+NtQ=", "iMPQi");
        f.lIlIllllIlIlI[f.lIlIllllIllIl[4]] = f.llIIIIlIlllllIl("habKwYx+cm0zpW0V+FFSJzW2Feo9RzTe", "oLQlp");
        f.lIlIllllIlIlI[f.lIlIllllIllIl[5]] = f.llIIIIllIIIIIIl("VORvwV5Q3oQhmEuV0/3TLQ==", "wOpfO");
        f.lIlIllllIlIlI[f.lIlIllllIllIl[6]] = f.llIIIIllIIIIIIl("umRmHfaKM6mL5EN6lbxMdQ==", "hbtsE");
        f.lIlIllllIlIlI[f.lIlIllllIllIl[7]] = f.llIIIIllIIIIIIl("3XQ7UAbSwdqJFwQhVCz0fg==", "aSNWt");
    }
    ...
    private boolean B() {
        ...
        block3: {
            ...
            bl = lIlIllllIllIl[1];
            "".length();
            if (((114 + 121 - 214 + 143 ^ 87 + 123 - 110 + 74) & (107 + 144 - 230 + 159 ^ 31 + 86 - 84 + 157 ^ -" ".length())) == 0) return bl;
            return ((0x84 ^ 0xAA ^ (0x77 ^ 0x11)) & (113 + 71 - 18 + 49 ^ 72 + 146 - 173 + 114 ^ -" ".length())) != 0;
        }
        bl = lIlIllllIllIl[0];
        return bl;
    }
