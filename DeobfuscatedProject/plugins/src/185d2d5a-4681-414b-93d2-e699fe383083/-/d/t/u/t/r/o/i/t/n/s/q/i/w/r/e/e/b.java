...
public class b {
    ...
    public boolean i() {
        ...
        if (b.llIIIIllIIIIlll(llllllllllllllIllIIlllIllllIlIII.getWorldLocation().getRegionID(), lIlIllllIllII[13])) {
            ...
            "".length();
            if (" ".length() == "   ".length()) {
                return ((51 + 32 - 70 + 145 ^ 113 + 125 - 122 + 26) & (0x73 ^ 0x11 ^ (6 ^ 0x74) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlIllllIllII[4];
        }
    ...
    private static void llIIIIllIIIIIII() {
        ...
        b.lIlIllllIlIll[b.lIlIllllIllII[4]] = b.llIIIIlIllllllI("aG8=", "ROtVD");
        b.lIlIllllIlIll[b.lIlIllllIllII[7]] = b.llIIIIlIllllllI("Qw==", "fVrNU");
        b.lIlIllllIlIll[b.lIlIllllIllII[9]] = b.llIIIIlIlllllll("6hCAAfqC+bk=", "HHorJ");
        b.lIlIllllIlIll[b.lIlIllllIllII[11]] = b.llIIIIlIlllllll("AJPNceKMCWg=", "qKajr");
        b.lIlIllllIlIll[b.lIlIllllIllII[12]] = b.llIIIIlIllllllI("Rg==", "cxieW");
        b.lIlIllllIlIll[b.lIlIllllIllII[2]] = b.llIIIIlIllllllI("", "CiHZH");
        b.lIlIllllIlIll[b.lIlIllllIllII[17]] = b.llIIIIlIllllllI("KzwxARx4MDoFAHggOwQdeDs7Hwor", "XYTqo");
        b.lIlIllllIlIll[b.lIlIllllIllII[3]] = b.llIIIIlIllllllI("BR03CxMnBiwAADIbNgIS", "FrYla");
        b.lIlIllllIlIll[b.lIlIllllIllII[18]] = b.llIIIIlIlllllll("v8ZlCyhYIkIGTjkomgQLoiUaKHkmrM0L", "DwzEU");
        b.lIlIllllIlIll[b.lIlIllllIllII[19]] = b.llIIIIlIllllllI("OB4Gcg45HQVyHCM=", "LqiRh");
        b.lIlIllllIlIll[b.lIlIllllIllII[22]] = b.llIIIIlIllllllI("AiQM", "GExcb");
        b.lIlIllllIlIll[b.lIlIllllIllII[23]] = b.llIIIIlIlllllll("ziuVRjxfdsw=", "VjOIt");
        b.lIlIllllIlIll[b.lIlIllllIllII[24]] = b.llIIIIlIllllllI("WgoxeUs=", "rVURb");
    }
    ...
    private static void llIIIIllIIIIIlI() {
        ...
        b.lIlIllllIllII[4] = (64 + 131 - 68 + 71 ^ 13 + 120 - 52 + 66) & (0x84 ^ 0xA3 ^ (0xB6 ^ 0xC4) ^ -" ".length());
        b.lIlIllllIllII[5] = -" ".length();
        b.lIlIllllIllII[6] = 0xFFFFCBFC & 0x358F;
        b.lIlIllllIllII[7] = " ".length();
        b.lIlIllllIllII[8] = 0x44 ^ 0x5E;
        b.lIlIllllIllII[9] = "  ".length();
        b.lIlIllllIllII[10] = 133 + 163 - 174 + 45 ^ 166 + 157 - 209 + 65;
        b.lIlIllllIllII[11] = "   ".length();
    ...
    public void r() {
        ...
        if (b.llIIIIllIIIllII((Object)this.u, (Object)a.WEST)) {
            a2 = a.EAST;
            "".length();
            if (((0x31 ^ 0x5D ^ (0x19 ^ 0x32)) & (21 + 149 - 15 + 69 ^ 4 + 4 - -126 + 33 ^ -" ".length())) >= "  ".length()) {
                return;
            }
        } else {
            a2 = a.WEST;
