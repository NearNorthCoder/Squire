...
extends Task {
    ...
    private static void llIIIIlIllIIIlI() {
        ...
        g.lIlIllllIIlIl[0] = (99 + 11 - -9 + 23 ^ 71 + 69 - 73 + 85) & ((0x69 ^ 0x32) & ~(0xC4 ^ 0x9F) ^ (0x14 ^ 2) ^ -" ".length());
        g.lIlIllllIIlIl[1] = " ".length();
        ...
        g.lIlIllllIIlIl[5] = "   ".length();
        g.lIlIllllIIlIl[6] = "  ".length();
        g.lIlIllllIIlIl[7] = 0xC2 ^ 0xC6;
        g.lIlIllllIIlIl[8] = 0x7C ^ 0x79;
        g.lIlIllllIIlIl[9] = 0x4D ^ 0x57 ^ (0x38 ^ 0x24);
        g.lIlIllllIIlIl[10] = 0xB ^ 2 ^ " ".length();
    }

    private static void llIIIIlIllIIIII() {
        lIlIllllIIlII = new String[lIlIllllIIlIl[9]];
        g.lIlIllllIIlII[g.lIlIllllIIlIl[0]] = g.llIIIIlIlIllllI("jdpeA1s1+pE=", "JqmnU");
        g.lIlIllllIIlII[g.lIlIllllIIlIl[1]] = g.llIIIIlIlIlllll("IAmkHLcd8J0=", "tDrhp");
        g.lIlIllllIIlII[g.lIlIllllIIlIl[6]] = g.llIIIIlIlIlllll("LqqZOGFcfWFvvZc7PPf8T+4Y6Bbpolo4", "Cwqgk");
        g.lIlIllllIIlII[g.lIlIllllIIlIl[5]] = g.llIIIIlIlIllllI("bkJRCeQ0c8O5qpQerebfzw==", "fdMiw");
        g.lIlIllllIIlII[g.lIlIllllIIlIl[7]] = g.llIIIIlIlIllllI("KlBpfkW050U=", "ouLau");
        g.lIlIllllIIlII[g.lIlIllllIIlIl[8]] = g.llIIIIlIlIlllll("Pc5qBgg4qUM=", "wvZFu");
    }
