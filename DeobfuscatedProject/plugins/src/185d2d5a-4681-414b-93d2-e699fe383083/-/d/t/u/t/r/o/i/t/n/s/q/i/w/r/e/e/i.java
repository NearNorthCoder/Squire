...
extends Task {
    ...
    private static void llIIIIllIllIlll() {
        ...
        i.lIlIllllllIIl[0] = (0xD2 ^ 0xAF ^ (0x5B ^ 0x19)) & (0x95 ^ 0xB7 ^ (0x24 ^ 0x39) ^ -" ".length());
        i.lIlIllllllIIl[1] = "   ".length();
        i.lIlIllllllIIl[2] = -" ".length();
        i.lIlIllllllIIl[3] = " ".length();
        i.lIlIllllllIIl[4] = 0xFFFFEFE3 & 0x785E;
    }

    private static void llIIIIllIllIllI() {
        lIlIllllllIII = new String[lIlIllllllIIl[3]];
        i.lIlIllllllIII[i.lIlIllllllIIl[0]] = i.llIIIIllIllIlIl("KAoqGAgvCg==", "JxKba");
    }
