...
implements S {
    ...
    private static void llIllIIllIllI() {
        ...
        Y.lIIIIIIIIlI[0] = ("   ".length() ^ (0x8A ^ 0xB9)) & (0x68 ^ 3 ^ (0x51 ^ 0xA) ^ -" ".length());
        Y.lIIIIIIIIlI[1] = " ".length();
        Y.lIIIIIIIIlI[2] = -(0xFFFFB2DD & 0x7D2F) & (0xFFFFB7FF & 0x7BEF);
        Y.lIIIIIIIIlI[3] = "  ".length();
        Y.lIIIIIIIIlI[4] = "   ".length();
    ...
    public boolean V() {
        ...
        if (Y.llIllIIllllII(Skills.getLevel((Skill)Skill.CRAFTING), lIIIIIIIIlI[44])) {
            bl = lIIIIIIIIlI[1];
            "".length();
            if (-" ".length() > (0x18 ^ 6 ^ (0x9A ^ 0x80))) {
                return ((1 ^ 0xF ^ (5 ^ 0x17)) & (0xC5 ^ 0x9A ^ (7 ^ 0x44) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIIIIIIlI[0];
        }
    ...
    public static boolean aa() {
        ...
        if (Y.llIllIIlllIlI(Inventory.getCount((int[])nArray))) {
            ...
            if (Y.llIllIIlllIlI(Inventory.getCount((int[])nArray2))) {
                ...
                return ((0xF8 ^ 0xB5 ^ (0x16 ^ 0x1E)) & (0x14 ^ 0x7F ^ (0x63 ^ 0x4D) ^ -" ".length())) != 0;
            }
        }
        n2 = lIIIIIIIIlI[0];
        return n2 != 0;
                        ...
                        if (Y.llIllIIlllIII(Skills.getLevel((Skill)Skill.CRAFTING), lIIIIIIIIlI[6])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!Y.llIllIIllllII(Inventory.getCount((int[])nArray), lIIIIIIIIlI[1]) || Y.llIllIIllIlll(Dialog.isOpen() ? 1 : 0)) {
                                    bl = lIIIIIIIIlI[1];
                                    "".length();
                                    if (" ".length() >= (0x37 ^ 3 ^ (0x6D ^ 0x5D))) {
                                        return ((0x3E ^ 0x68 ^ (0x39 ^ 0x75)) & (0x4F ^ 0x72 ^ (0x57 ^ 0x70) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIIIIIIlI[0];
                                }
                        ...
                        if (Y.llIllIIllllII(Skills.getLevel((Skill)Skill.CRAFTING), lIIIIIIIIlI[6]) && Y.llIllIIlllIII(Skills.getLevel((Skill)Skill.CRAFTING), lIIIIIIIIlI[14])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!Y.llIllIIllllII(Inventory.getCount((int[])nArray), lIIIIIIIIlI[1]) || Y.llIllIIllIlll(Dialog.isOpen() ? 1 : 0)) {
                                    bl = lIIIIIIIIlI[1];
                                    "".length();
                                    if (((0xDF ^ 0x9F ^ 51 + 26 - -47 + 3) & (118 + 77 - 48 + 14 ^ 151 + 118 - 139 + 28 ^ -" ".length())) <= -" ".length()) {
                                        return ((128 + 17 - 124 + 188 ^ 30 + 155 - 71 + 62) & (0x2D ^ 0x60 ^ (0xB3 ^ 0x9F) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIIIIIIlI[0];
                                }
                        ...
                        if (Y.llIllIIllllII(Skills.getLevel((Skill)Skill.CRAFTING), lIIIIIIIIlI[21]) && Y.llIllIIlllIII(Skills.getLevel((Skill)Skill.CRAFTING), lIIIIIIIIlI[24])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!Y.llIllIIllllII(Inventory.getCount((int[])nArray), lIIIIIIIIlI[1]) || Y.llIllIIllIlll(Dialog.isOpen() ? 1 : 0)) {
                                    bl = lIIIIIIIIlI[1];
                                    "".length();
                                    if ("   ".length() < ((0xF1 ^ 0xA5 ^ (0x83 ^ 0x91)) & (0x34 ^ 0x27 ^ (0x41 ^ 0x14) ^ -" ".length()))) {
                                        return ((100 + 185 - 112 + 17 ^ 131 + 43 - 115 + 81) & (16 + 133 - 117 + 112 ^ 14 + 3 - -115 + 30 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIIIIIIlI[0];
                                }
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!Y.llIllIIllllII(Inventory.getCount((int[])nArray), lIIIIIIIIlI[1]) || Y.llIllIIllIlll(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    if (-(0x45 ^ 0x4E ^ (0x68 ^ 0x67)) >= 0) {
                                        return ((0xA4 ^ 0xAD ^ (0x4A ^ 0x10)) & (0x7A ^ 0x7F ^ (0x2B ^ 0x7D) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIIIIIIIIlI[0];
                                }
    ...
    private static void llIllIIllIlIl() {
        ...
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[0]] = Y.llIllIIllIIlI("Lh0dKhgLSA03EwEb", "lhdCv");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[1]] = Y.llIllIIllIIll("pk/8zEfk+hbSHbYQQl0BcgVapTV0x1dz5sKlXT5tnZMxjJIR0EF1ol6wjZsK9EcLO32TBlsqCAk=", "STxCi");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[3]] = Y.llIllIIllIIlI("LBQUGCMDAQsfI0IBDVEmAxsJ", "bubqD");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[4]] = Y.llIllIIllIIlI("NzsKOQwWLE81BBYg", "xKoWe");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[6]] = Y.llIllIIllIlII("ZWJODGfU2kwlU/VlaBcUxpq5H0ODDk/S", "BdDcW");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[9]] = Y.llIllIIllIlII("g/mGmX9YeCJtNYPNW0Nt2TBX42XqZmiIhNFPrjaraGdvHyYZWUR58IkhoksQv6D2", "RFhhm");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[10]] = Y.llIllIIllIlII("JbyTRzlWFmAjhBhkiqu/Fw==", "wmInY");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[11]] = Y.llIllIIllIIlI("AR80CjYrAzJMJS4MJh8=", "BmUlB");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[12]] = Y.llIllIIllIlII("tFypHK1171lCdi5LtnZt8g==", "bEKRB");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[15]] = Y.llIllIIllIlII("3UTs//aMETkA7yCWFc0z5FUDMYR2yfhg", "eweSm");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[17]] = Y.llIllIIllIlII("a+ydAF/8f/Um/T87vaYMeQ==", "biijd");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[18]] = Y.llIllIIllIIll("k0w25dfpBzNbIKKhAI+9kw==", "yguzM");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[14]] = Y.llIllIIllIIlI("CD0NMTYiIQt3NCIuAA==", "KOlWB");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[20]] = Y.llIllIIllIlII("iK6NeXB5V8k=", "ZpAjM");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[22]] = Y.llIllIIllIlII("/A47J4bkBOywc3C3XiDvMkiBLI1nDqNW", "Dcjvd");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[23]] = Y.llIllIIllIIll("kw635kHRvRldomxnW7iCfQ==", "tzeBF");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[25]] = Y.llIllIIllIlII("5P/9DMYwV3i/Y+RTnC2AUw==", "ZBaFw");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[26]] = Y.llIllIIllIIll("CRIBaflUXqk3oVu9xck0FZZsHJtMM6SK", "mknbg");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[28]] = Y.llIllIIllIlII("aiM0XfzbPa0c65POAySJwg==", "Lmcmr");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[29]] = Y.llIllIIllIlII("TEb/AcoY0FwQuRSEsCfoaQ==", "jjzFP");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[30]] = Y.llIllIIllIIll("/OroW3cEvNIOXxEy++ymHcom+zPWZUch", "CiwKV");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[31]] = Y.llIllIIllIlII("MaM/6B5sNQm2wLGXnK2JhQ==", "DnmDd");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[32]] = Y.llIllIIllIIlI("MDwxPhoVaSU4GAYsJncTHig7JA==", "rIHWt");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[35]] = Y.llIllIIllIlII("kChFfX6kWw2LLjQH6qz3WIrMykB2iNymFbFw/b3zchI=", "hlMUN");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[43]] = Y.llIllIIllIIlI("AQM3ADwrHzE=", "BqVfH");
        Y.lIIIIIIIIIl[Y.lIIIIIIIIlI[45]] = Y.llIllIIllIIlI("Mx44NEsuEXYkDiAbIjtLaQ==", "AwVSk");
    }
