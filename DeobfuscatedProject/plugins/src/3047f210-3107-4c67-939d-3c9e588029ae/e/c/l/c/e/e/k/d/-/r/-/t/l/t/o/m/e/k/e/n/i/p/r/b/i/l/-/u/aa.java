...
implements S {
    ...
    private static void llIllIllllllI() {
        ...
        aa.lIIIIIIllII[1] = (0xB3 ^ 0xAE ^ (0x19 ^ 0x3C)) & (40 + 28 - 44 + 139 ^ 127 + 123 - 169 + 74 ^ -" ".length());
        aa.lIIIIIIllII[2] = " ".length();
        aa.lIIIIIIllII[3] = "  ".length();
        aa.lIIIIIIllII[4] = "   ".length();
        ...
        aa.lIIIIIIllII[54] = " ".length() ^ (0x29 ^ 0x3E);
    ...
    public boolean V() {
        ...
        if (aa.llIlllIIIIlll(Skills.getLevel((Skill)Skill.PRAYER), lIIIIIIllII[76])) {
            bl = lIIIIIIllII[2];
            "".length();
            if ((0x72 ^ 0xC ^ (0x7A ^ 0)) <= "  ".length()) {
                return ((0x5C ^ 0x51 ^ (0x5C ^ 0x56)) & (11 + 13 - 13 + 121 ^ 35 + 4 - -35 + 57 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIIIIllII[1];
        }
    ...
    private static void llIllIlllllIl() {
        ...
        aa.lIIIIIIlIll[aa.lIIIIIIllII[1]] = aa.llIllIllllIlI("FRgYPyowTQgiIToe", "WmaVD");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[2]] = aa.llIllIllllIll("4PE7xi0knfRehYDUV51B5xPC29bzN+qfkRhUUBoI9XB3W/7oAFjDxbkLaoDW4sHT", "McDjU");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[3]] = aa.llIllIllllIlI("ACkuIB8vPDEnH248N2kaLyYz", "NHXIx");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[4]] = aa.llIllIllllIlI("Bio6CQAnJTNNDi8lPwQCKQ==", "NKTml");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[6]] = aa.llIllIlllllII("qfWagQmReq7fv3aoAAnc+c10UiV1QVHOeSUDPjRLjz6qz3VqGUvAUT19C8wZGvvXZlPTTvQJEys=", "iIpkD");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[13]] = aa.llIllIllllIll("uESEDamzZQI=", "hMiVa");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[15]] = aa.llIllIllllIlI("IwgEBG0DAkgWJBsJEQ==", "wmhaM");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[17]] = aa.llIllIllllIll("TR2H7Ik9bQM=", "LzYbG");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[18]] = aa.llIllIlllllII("VMZ6H1RZytes4QRt6oBUmQ==", "rMABL");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[19]] = aa.llIllIllllIlI("KjIHEWlFLQMEIBU2FBxlETZGBCATPApIcVR5MQEpATwUBiAWKkg=", "eYfhE");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[21]] = aa.llIllIlllllII("ei+lCBmVU13Q0d6RVAnidA==", "WrObr");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[41]] = aa.llIllIllllIlI("R2wGPQgdbAImCg8=", "vLrTk");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[44]] = aa.llIllIllllIll("aMmEnz0OxWSIVhIahuq9Yg==", "Lzdoq");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[20]] = aa.llIllIlllllII("f33WNTl/M7nr5WW4MUBD/Q==", "BWNIA");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[46]] = aa.llIllIllllIlI("CD4tLw==", "GNHAA");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[47]] = aa.llIllIlllllII("VXbF2djNXvA=", "MwvXp");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[48]] = aa.llIllIllllIll("Dx3b/ALQY9Y=", "BFQtV");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[49]] = aa.llIllIllllIll("6yi7JfXX7aTcWD7IXc6ehg==", "TafPm");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[51]] = aa.llIllIlllllII("GpzCzN1ElPX8prI+EXNcBw==", "yZBCH");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[52]] = aa.llIllIllllIll("nWM67pNyELHpV7kl8uwIFg==", "sBWJm");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[14]] = aa.llIllIlllllII("7Jm155quZvqXVKd2yprPeVBP/w59222l", "qGHYy");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[53]] = aa.llIllIllllIll("QN+OXmRZWczT7j/C/LrT/w==", "MLMbx");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[54]] = aa.llIllIllllIlI("CwQ/Pg==", "DtZPt");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[55]] = aa.llIllIlllllII("0HvlXqdvumk=", "ivMOy");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[56]] = aa.llIllIllllIlI("GBEJLw==", "WalAT");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[57]] = aa.llIllIllllIll("L2+yD+KjzTl6R2fExiJaSA==", "rcMrJ");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[58]] = aa.llIllIlllllII("pLDf0J+phbEUegO0SgIMsg==", "xCZvP");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[59]] = aa.llIllIllllIlI("Nz4sGiQcISpSBB4q", "rFOrE");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[60]] = aa.llIllIlllllII("VHkk9BQRtjbgY7kvYp1qqQ==", "piqSV");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[61]] = aa.llIllIllllIll("j6//AHFBxUYMnJIlQuEEPg==", "pIIkS");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[62]] = aa.llIllIlllllII("8wCsQe8bWUE=", "MCtwH");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[75]] = aa.llIllIllllIll("nBtpShlrp3Akl1YzzI7zwg==", "qoiLX");
        aa.lIIIIIIlIll[aa.lIIIIIIllII[77]] = aa.llIllIllllIlI("GC0LAmoFIkUSLwsoEQ1qQg==", "jDeeJ");
    }
                                        ...
                                        if (aa.llIlllIIIIIIl(lllllllllllllllllIIlllllIIIIllll.hasAction(stringArray8) ? 1 : 0)) {
                                            ...
                                            if (aa.llIllIlllllll(Dialog.isOpen() ? 1 : 0) && aa.llIlllIIIIIIl((lllllllllllllllllIIlllllIIIIlllI = Dialog.getOptions()).isEmpty() ? 1 : 0)) {
                                                ...
                                                while (aa.llIlllIIIIIII(lllllllllllllllllIIlllllIIIIllIl, lllllllllllllllllIIlllllIIIIlllI.size())) {
                                                    ...
                                                    "".length();
                                                    if (((94 + 119 - 92 + 23 ^ 39 + 122 - 146 + 145) & (140 + 118 - 152 + 70 ^ 81 + 57 - 93 + 83 ^ -" ".length())) == 0) continue;
                                                    return;
                                                }
                                            }
                                        }
    ...
    private static boolean aa() {
        ...
        block2: {
            ...
            return ((129 + 157 - 190 + 98 ^ 121 + 123 - 200 + 153) & (0xFD ^ 0x83 ^ (0xF8 ^ 0x81) ^ -" ".length())) != 0;
        }
        n2 = lIIIIIIllII[1];
        return n2 != 0;
    }
