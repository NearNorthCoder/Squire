...
implements S {
                        ...
                        block25: {
                            block23: {
                                block24: {
                                    ...
                                    BankLocation lllllllllllllllllIlIIlIllIlIllIl = BankLocation.getNearest();
                                    if (ab.llIlIIlllIIII(lllllllllllllllllIlIIlIllIlIllIl) && ab.llIlIIllIllll(lllllllllllllllllIlIIlIllIlIllIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                        AccBuilderTempleTrek.c = lllllIIllI[lllllIIlll[2]];
                                        a.a(lllllllllllllllllIlIIlIllIlIllIl);
                                    }
                                    if (!ab.llIlIIlllIIII(lllllllllllllllllIlIIlIllIlIllIl) || !ab.llIlIIllIllIl(lllllllllllllllllIlIIlIllIlIllIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block22;
    ...
    private static void llIlIIllIllII() {
        ...
        ab.lllllIIlll[1] = " ".length();
        ab.lllllIIlll[2] = "  ".length();
        ab.lllllIIlll[3] = "   ".length();
        ...
        ab.lllllIIlll[48] = 0x16 ^ 0x73 ^ " ".length();
        ...
        ab.lllllIIlll[67] = 0x18 ^ 0x34 ^ " ".length();
    ...
    public static void ae() {
        d lllllllllllllllllIlIIlIllIlIlIll;
        int[] nArray = new int[lllllIIlll[1]];
        nArray[ab.lllllIIlll[0]] = lllllIIlll[9];
        ...
        if (ab.llIlIIllIllll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lllllllllllllllllIlIIlIllIlIlIll = new d(lllllIIlll[10], lllllIIlll[13], lllllIIlll[43]);
            bu.add(lllllllllllllllllIlIIlIllIlIlIll);
            "".length();
        }
        int[] nArray3 = new int[lllllIIlll[1]];
        nArray3[ab.lllllIIlll[0]] = lllllIIlll[11];
        if (ab.llIlIIllIllll(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllllIlIIlIllIlIlIll = new d(lllllIIlll[11], lllllIIlll[40], lllllIIlll[44]);
            bu.add(lllllllllllllllllIlIIlIllIlIlIll);
            "".length();
        }
        int[] nArray4 = new int[lllllIIlll[1]];
        ...
        if (ab.llIlIIllIllll(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllllIlIIlIllIlIlIll = new d(lllllIIlll[45], lllllIIlll[12], i.bp);
            bu.add(lllllllllllllllllIlIIlIllIlIlIll);
            "".length();
        }
        if (ab.llIlIIlllIIlI(Skills.getLevel((Skill)Skill.THIEVING), lllllIIlll[5])) {
            ...
            if (ab.llIlIIllIllll(Bank.contains((int[])nArray5) ? 1 : 0)) {
                lllllllllllllllllIlIIlIllIlIlIll = new d(lllllIIlll[7], lllllIIlll[46], lllllIIlll[20]);
                bu.add(lllllllllllllllllIlIIlIllIlIlIll);
                "".length();
            }
            ...
            if (ab.llIlIIllIllll(Bank.contains((int[])nArray6) ? 1 : 0)) {
                lllllllllllllllllIlIIlIllIlIlIll = new d(lllllIIlll[6], lllllIIlll[44], lllllIIlll[47]);
                bu.add(lllllllllllllllllIlIIlIllIlIlIll);
                "".length();
            }
        }
    ...
    private static String llIlIIllIlIII(String lllllllllllllllllIlIIlIllIlIIIII, String lllllllllllllllllIlIIlIllIIlllll) {
        lllllllllllllllllIlIIlIllIlIIIII = new String(Base64.getDecoder().decode(lllllllllllllllllIlIIlIllIlIIIII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllIlIIlIllIIllllI = new StringBuilder();
        char[] lllllllllllllllllIlIIlIllIIlllIl = lllllllllllllllllIlIIlIllIIlllll.toCharArray();
        int lllllllllllllllllIlIIlIllIIlllII = lllllIIlll[0];
        char[] lllllllllllllllllIlIIlIllIIlIllI = lllllllllllllllllIlIIlIllIlIIIII.toCharArray();
        int lllllllllllllllllIlIIlIllIIlIlIl = lllllllllllllllllIlIIlIllIIlIllI.length;
        int lllllllllllllllllIlIIlIllIIlIlII = lllllIIlll[0];
        while (ab.llIlIIllIlllI(lllllllllllllllllIlIIlIllIIlIlII, lllllllllllllllllIlIIlIllIIlIlIl)) {
            char lllllllllllllllllIlIIlIllIlIIIIl = lllllllllllllllllIlIIlIllIIlIllI[lllllllllllllllllIlIIlIllIIlIlII];
            lllllllllllllllllIlIIlIllIIllllI.append((char)(lllllllllllllllllIlIIlIllIlIIIIl ^ lllllllllllllllllIlIIlIllIIlllIl[lllllllllllllllllIlIIlIllIIlllII % lllllllllllllllllIlIIlIllIIlllIl.length]));
            "".length();
            ++lllllllllllllllllIlIIlIllIIlllII;
            ++lllllllllllllllllIlIIlIllIIlIlII;
            "".length();
            if (-(149 + 148 - 195 + 51 ^ 76 + 63 - 11 + 28) < 0) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllIlIIlIllIIllllI);
    }
    ...
    private static String llIlIIllIlIlI(String lllllllllllllllllIlIIlIlIlllllII, String lllllllllllllllllIlIIlIlIllllIll) {
        try {
            SecretKeySpec lllllllllllllllllIlIIlIllIIIIIIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIlIIlIlIllllIll.getBytes(StandardCharsets.UTF_8)), lllllIIlll[20]), "DES");
            ...
            return new String(lllllllllllllllllIlIIlIllIIIIIII.doFinal(Base64.getDecoder().decode(lllllllllllllllllIlIIlIlIlllllII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void llIlIIllIlIll() {
        ...
        ab.lllllIIllI[ab.lllllIIlll[0]] = ab.llIlIIllIlIII("GyM/HCM+di8BKDQl", "YVFuM");
        ab.lllllIIllI[ab.lllllIIlll[1]] = ab.llIlIIllIlIIl("woNK9kjtHSW+1CkUmzyP/pwqWHLC19XF2Qd6VfKP04VXMDGtnDZKavQXk4fcOqXA", "Qkzwq");
        ab.lllllIIllI[ab.lllllIIlll[2]] = ab.llIlIIllIlIII("HSMzHAUyNiwbBXM2KlUAMiwu", "SBEub");
        ab.lllllIIllI[ab.lllllIIlll[3]] = ab.llIlIIllIlIIl("YubtgW+UCUiVizZGui0YsAxUb27XxM4z", "DkrEj");
        ab.lllllIIllI[ab.lllllIIlll[8]] = ab.llIlIIllIlIIl("Rf2U7qDd+1K5TyynLQTc9agEbaZooAgOwG1t5NX7jXJWTsX+VM1yQxgbwKybSzGv", "KWElo");
        ab.lllllIIllI[ab.lllllIIlll[12]] = ab.llIlIIllIlIIl("yrm89cvY7S/YeFlOSWpJKqolQ1fKuVycu4DpHTNK1G9Y78pqes3jd0JpvUPweaJC", "SDpgr");
        ab.lllllIIllI[ab.lllllIIlll[17]] = ab.llIlIIllIlIIl("3MFizy8pkEA=", "XXwhZ");
        ab.lllllIIllI[ab.lllllIIlll[18]] = ab.llIlIIllIlIIl("VjHxKpKEbXTD10GKdGlVbA==", "iCZxy");
        ab.lllllIIllI[ab.lllllIIlll[20]] = ab.llIlIIllIlIII("ICISGyQfKBoVIBklFg==", "pKqpT");
        ab.lllllIIllI[ab.lllllIIlll[21]] = ab.llIlIIllIlIIl("xDkEpZY/0iCchWrJvVtMpw==", "eUKbs");
        ab.lllllIIllI[ab.lllllIIlll[13]] = ab.llIlIIllIlIlI("/VvzTtVgPZ2EEKPdo2dSTA==", "bkzeQ");
        ab.lllllIIllI[ab.lllllIIlll[22]] = ab.llIlIIllIlIlI("eB2PlskepCJFA+VViEstPw==", "BjrYu");
        ab.lllllIIllI[ab.lllllIIlll[23]] = ab.llIlIIllIlIIl("Ac+O8IbSJSg=", "fnvwg");
        ab.lllllIIllI[ab.lllllIIlll[24]] = ab.llIlIIllIlIII("DSodHzE=", "IXtqZ");
        ab.lllllIIllI[ab.lllllIIlll[25]] = ab.llIlIIllIlIII("Pw0R", "uxvCU");
        ab.lllllIIllI[ab.lllllIIlll[16]] = ab.llIlIIllIlIII("Oh0s", "phKLd");
        ab.lllllIIllI[ab.lllllIIlll[26]] = ab.llIlIIllIlIII("FDcOTR81dhUIBQ==", "ZVxmk");
        ab.lllllIIllI[ab.lllllIIlll[27]] = ab.llIlIIllIlIIl("+Qncr0rbaTqa9PnT8BUbvQ==", "iArQu");
        ab.lllllIIllI[ab.lllllIIlll[29]] = ab.llIlIIllIlIIl("OC4UdFaZp8IzQER35yX1Ig==", "uVBXm");
        ab.lllllIIllI[ab.lllllIIlll[30]] = ab.llIlIIllIlIIl("WfwdRixxclk=", "nIobs");
        ab.lllllIIllI[ab.lllllIIlll[14]] = ab.llIlIIllIlIIl("mYyTnE+qRuA=", "dGMfu");
        ab.lllllIIllI[ab.lllllIIlll[31]] = ab.llIlIIllIlIII("HQwPKBMiBgcmFw==", "MelCc");
        ab.lllllIIllI[ab.lllllIIlll[32]] = ab.llIlIIllIlIII("JSYSKCcTNg==", "vRgFI");
        ab.lllllIIllI[ab.lllllIIlll[33]] = ab.llIlIIllIlIlI("BVw+Nf6Vb10=", "ClKiP");
        ab.lllllIIllI[ab.lllllIIlll[34]] = ab.llIlIIllIlIII("ABE4bBIhUDopB24EJyAD", "NpNLf");
        ab.lllllIIllI[ab.lllllIIlll[28]] = ab.llIlIIllIlIlI("BDA18/ykvD0714yn/TFc0w==", "hpEbh");
        ab.lllllIIllI[ab.lllllIIlll[35]] = ab.llIlIIllIlIII("Jj42GCQcJDQ=", "uJSyH");
        ab.lllllIIllI[ab.lllllIIlll[36]] = ab.llIlIIllIlIIl("ESZ+gtpAkmS+bFmhkQ78mg==", "pRVnM");
        ab.lllllIIllI[ab.lllllIIlll[37]] = ab.llIlIIllIlIlI("tincwnNYTpMwNd0eDJdDOg==", "zmVtF");
        ab.lllllIIllI[ab.lllllIIlll[38]] = ab.llIlIIllIlIlI("HHZ2Fd2M1YJlQ4fJYEqNqw==", "preja");
        ab.lllllIIllI[ab.lllllIIlll[40]] = ab.llIlIIllIlIlI("rdbPCPeb25hLts6hk7ioXg==", "uQxoN");
        ab.lllllIIllI[ab.lllllIIlll[49]] = ab.llIlIIllIlIII("HywwEzQiKj4=", "KDYvB");
        ab.lllllIIllI[ab.lllllIIlll[51]] = ab.llIlIIllIlIIl("YjhkZSlaZEc=", "HNiJm");
        ab.lllllIIllI[ab.lllllIIlll[52]] = ab.llIlIIllIlIIl("5zDexO2JIXI=", "MPDGE");
        ab.lllllIIllI[ab.lllllIIlll[53]] = ab.llIlIIllIlIII("HDQxdR88MDw5", "HQPUl");
        ab.lllllIIllI[ab.lllllIIlll[54]] = ab.llIlIIllIlIlI("Em7eVbQow9M=", "OQlCr");
        ab.lllllIIllI[ab.lllllIIlll[55]] = ab.llIlIIllIlIII("PBwoAQ==", "xnGqM");
        ab.lllllIIllI[ab.lllllIIlll[56]] = ab.llIlIIllIlIIl("5M5Sr24e0tc=", "lSzxl");
        ab.lllllIIllI[ab.lllllIIlll[5]] = ab.llIlIIllIlIIl("QnC7fFi2eVfBrX0V3xfTkQ==", "FfiWZ");
        ab.lllllIIllI[ab.lllllIIlll[61]] = ab.llIlIIllIlIIl("zD/N/u3lHzqvk4BV7zFs7Q==", "FQkrD");
        ab.lllllIIllI[ab.lllllIIlll[62]] = ab.llIlIIllIlIII("GjUqNzI+MWgmNjww", "YTHUS");
        ab.lllllIIllI[ab.lllllIIlll[63]] = ab.llIlIIllIlIlI("GJvuKMBqWiOiiK8h7BL4cw==", "Enoxx");
        ab.lllllIIllI[ab.lllllIIlll[64]] = ab.llIlIIllIlIII("EjglOBstdyI8CiY=", "BWQYo");
        ab.lllllIIllI[ab.lllllIIlll[65]] = ab.llIlIIllIlIIl("gx43zGX81o9dGrxfoMH9gA==", "WlaEn");
        ab.lllllIIllI[ab.lllllIIlll[66]] = ab.llIlIIllIlIII("BgQrFwA6ETEWGGgWPQYR", "HeXcu");
        ab.lllllIIllI[ab.lllllIIlll[67]] = ab.llIlIIllIlIlI("0gsTy72F763fgl7Lt+Zp3Q==", "uibwD");
        ab.lllllIIllI[ab.lllllIIlll[68]] = ab.llIlIIllIlIlI("g6/qa2xRXOLoI2qKEG+qYMy2UF1YE0sG", "HgWsZ");
        ab.lllllIIllI[ab.lllllIIlll[69]] = ab.llIlIIllIlIlI("17VVGmL/uh5KrwUGO0HAYw==", "Ytsum");
        ab.lllllIIllI[ab.lllllIIlll[70]] = ab.llIlIIllIlIlI("slXEHq0W2qkJb4DcbvW8wQ==", "ktlBX");
        ab.lllllIIllI[ab.lllllIIlll[71]] = ab.llIlIIllIlIIl("/+tNRvv/4o9xkQFTs9/2Zw==", "FEwqY");
        ab.lllllIIllI[ab.lllllIIlll[72]] = ab.llIlIIllIlIlI("2lymnZghIsdxfdFl5x3y6Q==", "cYcJQ");
        ab.lllllIIllI[ab.lllllIIlll[73]] = ab.llIlIIllIlIIl("evxjF5TAtva3DEJXfdNqAyOLptDaUCi1", "slyRZ");
        ab.lllllIIllI[ab.lllllIIlll[74]] = ab.llIlIIllIlIII("OjgeKwoDMAJ5Fgs8CA==", "nYlYe");
        ab.lllllIIllI[ab.lllllIIlll[75]] = ab.llIlIIllIlIII("Azc+KCUwKjRtOzQ9KQ==", "QXMMH");
        ab.lllllIIllI[ab.lllllIIlll[76]] = ab.llIlIIllIlIIl("gtbrU9G+tHDCz5kpoNcvMA==", "mwYYQ");
        ab.lllllIIllI[ab.lllllIIlll[77]] = ab.llIlIIllIlIlI("CslBSb/y1GcmNX1uzX6rVYyWX84iFXKY", "OePUz");
        ab.lllllIIllI[ab.lllllIIlll[78]] = ab.llIlIIllIlIlI("1YTEMfIun2NwBDGSMWeTOA==", "dbRfl");
        ab.lllllIIllI[ab.lllllIIlll[79]] = ab.llIlIIllIlIlI("PjRAOoh6i2Brvonf/8o4rw==", "SWmUh");
        ab.lllllIIllI[ab.lllllIIlll[80]] = ab.llIlIIllIlIlI("3z6HB1wwy5kgGfG4kZlNyg==", "GVwXT");
        ab.lllllIIllI[ab.lllllIIlll[81]] = ab.llIlIIllIlIlI("4zhk9owAb4aAEj0wzALb4w==", "zKDEs");
        ab.lllllIIllI[ab.lllllIIlll[82]] = ab.llIlIIllIlIII("ChgGDz8oFRBGKyIcEA==", "GytfX");
        ab.lllllIIllI[ab.lllllIIlll[83]] = ab.llIlIIllIlIIl("wZbqjMs5BwNH8dI+hFYwhA==", "DEDaJ");
        ab.lllllIIllI[ab.lllllIIlll[84]] = ab.llIlIIllIlIlI("tfgNfsilBr3hMeNiUgMIs4+rT5aV5lQr", "KcXbX");
        ab.lllllIIllI[ab.lllllIIlll[85]] = ab.llIlIIllIlIlI("nA9aEICD7C9OZJRF4voBUQ==", "BQDyj");
        ab.lllllIIllI[ab.lllllIIlll[86]] = ab.llIlIIllIlIlI("8IghEpRfQE+JSEOJZKAm1lU/0bQba+zD", "HKFdH");
        ab.lllllIIllI[ab.lllllIIlll[87]] = ab.llIlIIllIlIII("KBY6GSYWWTocMFgKNg8t", "xySjI");
        ab.lllllIIllI[ab.lllllIIlll[88]] = ab.llIlIIllIlIlI("fd7AzV9xgFBXgnGlqg4x2Q==", "oPbLt");
        ab.lllllIIllI[ab.lllllIIlll[89]] = ab.llIlIIllIlIIl("eM6luRB3iEFIjfn0px5dKg==", "mgyIi");
        ab.lllllIIllI[ab.lllllIIlll[90]] = ab.llIlIIllIlIlI("T56hxj4RmPeoO8rstQdf2Q==", "ajOuw");
        ab.lllllIIllI[ab.lllllIIlll[91]] = ab.llIlIIllIlIII("ECIFGi40IhkMKipjBA0qPA==", "XCwhO");
        ab.lllllIIllI[ab.lllllIIlll[92]] = ab.llIlIIllIlIIl("7xVebBXdSuyuqqdcsoo9Qw==", "ziykb");
        ab.lllllIIllI[ab.lllllIIlll[93]] = ab.llIlIIllIlIII("OAEiABEeCyACEVoXKwkU", "zdNlp");
        ab.lllllIIllI[ab.lllllIIlll[94]] = ab.llIlIIllIlIIl("V0DJ9vILMNfQcNrR1aHq8g==", "ZZrjk");
        ab.lllllIIllI[ab.lllllIIlll[95]] = ab.llIlIIllIlIII("Mw4nIhwMQTAiCxcUIGMbBgQ3", "caSCh");
        ab.lllllIIllI[ab.lllllIIlll[96]] = ab.llIlIIllIlIII("CwQN", "AqjuF");
    }

    private static String llIlIIllIlIIl(String lllllllllllllllllIlIIlIllIIIlIIl, String lllllllllllllllllIlIIlIllIIIlIlI) {
        try {
            ...
            return new String(lllllllllllllllllIlIIlIllIIIllIl.doFinal(Base64.getDecoder().decode(lllllllllllllllllIlIIlIllIIIlIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
                ...
                if (ab.llIlIIllIlllI(Skills.getLevel((Skill)Skill.THIEVING), lllllIIlll[12])) {
                    ...
                    if (ab.llIlIIllIllIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                        ...
                        if (ab.llIlIIllIllIl(Inventory.contains((int[])nArray2) & Inventory.contains((int[])nArray3)) && ab.llIlIIlllIIIl(bS)) {
                            ...
                            return ((27 + 40 - 54 + 152 ^ 23 + 147 - 32 + 14) & (218 + 77 - 144 + 103 ^ 77 + 48 - -38 + 32 ^ -" ".length())) != 0;
                        }
                    }
                    n3 = lllllIIlll[0];
                    return n3 != 0;
