...
public class b {
    ...
    private static void llIIlIIlllIll() {
        ...
        b.lllIlllIlI[b.lllIlllIll[0]] = b.llIIlIIlIllII("gFh5lktcn/A=", "XqVxj");
        b.lllIlllIlI[b.lllIlllIll[1]] = b.llIIlIIlIllIl("TxRBzFE1d2IYcRVCYI+wDA==", "YhuWJ");
        b.lllIlllIlI[b.lllIlllIll[8]] = b.llIIlIIlIllIl("dQUfJEfZrWZ3dA0nOQBQ49xikOBsnFYyEGbaNuilR4vbC8Q3yveZD8xWrvFX9VnH7eqk7bN7svE=", "FCNmj");
        b.lllIlllIlI[b.lllIlllIll[4]] = b.llIIlIIlllIlI("JywlPSgaOWQgLgAxKz5pQHE=", "tXDPA");
        b.lllIlllIlI[b.lllIlllIll[7]] = b.llIIlIIlIllIl("SC6W8SWRtIeS9fnHEhxyRpE6ErgGA7Zu", "xDeFd");
        b.lllIlllIlI[b.lllIlllIll[25]] = b.llIIlIIlllIlI("Ag42Hz8C", "voTsZ");
        b.lllIlllIlI[b.lllIlllIll[26]] = b.llIIlIIlIllIl("Kw1LXl1v6RUrascpAzkiDQ==", "pKSyb");
        b.lllIlllIlI[b.lllIlllIll[13]] = b.llIIlIIlllIlI("", "JaieJ");
        b.lllIlllIlI[b.lllIlllIll[28]] = b.llIIlIIlllIlI("MQAcEQM=", "rlsbf");
        b.lllIlllIlI[b.lllIlllIll[29]] = b.llIIlIIlIllII("tqKa+SeU8hs=", "RAPHT");
        b.lllIlllIlI[b.lllIlllIll[3]] = b.llIIlIIlIllIl("Se/r2RwMop4=", "SMYze");
        b.lllIlllIlI[b.lllIlllIll[27]] = b.llIIlIIlllIlI("ADsCHVcdNEwNEhM+GBJXWg==", "rRlzw");
    }
    ...
    public static boolean a(String string) {
        ...
        if (b.llIIlIIllllIl(list.isEmpty() ? 1 : 0)) {
            ...
            while (b.llIIlIIllllll(lllllllllllllllllIllIIllIIlIIIIl, lllllllllllllllllIllIIllIIlIIIll.size())) {
                ...
                "".length();
                if ("  ".length() < (0xE9 ^ 0x8B ^ (0xB ^ 0x6D))) continue;
                    ...
                    if (b.llIIlIIllllIl(GrandExchange.isSelling() ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (b.llIIlIlIIIlIl(GrandExchange.getItemId(), (Integer)lllllllllllllllllIllIIllIIlIllII.get(lllllllllllllllllIllIIllIIlIlIlI))) {
                                ...
                                "".length();
                                if ("   ".length() < " ".length()) {
                                    return ((44 + 24 - 66 + 132 ^ 91 + 20 - 35 + 60) & (3 + 134 - 66 + 79 ^ 148 + 108 - 208 + 104 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lllIlllIll[0];
                            }
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (b.llIIlIIllllIl(GrandExchange.canCollect() ? 1 : 0)) {
                                ...
                                if ((109 + 176 - 166 + 70 ^ 175 + 173 - 246 + 83) < 0) {
                                    return ((5 ^ 0x35 ^ (0x4C ^ 0x5E)) & (0 ^ 0x5B ^ (0xD8 ^ 0xA1) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lllIlllIll[0];
                            }
    ...
    public static void a(int n2) {
        ...
        if (b.llIIlIIlllllI(Static.getClient().isItemDefinitionCached(lllllllllllllllllIllIIllIIIllIll) ? 1 : 0)) {
            ...
            "".length();
            if ("   ".length() < ((0x77 ^ 0x45 ^ " ".length()) & (30 + 14 - -65 + 35 ^ 36 + 113 - 120 + 134 ^ -" ".length()))) {
                return;
            }
        } else {
        ...
        block65: {
                        ...
                        if (b.llIIlIIlllllI(Bank.contains((int[])nArray2) ? 1 : 0) && b.llIIlIlIIIIIl(Players.getLocal().getWorldLocation().distanceTo(I), lllIlllIll[3])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (b.llIIlIlIIIlII(Inventory.getCount((int[])nArray))) {
                                    bl = lllIlllIll[1];
                                    "".length();
                                    if (((65 + 217 - 175 + 120 ^ 56 + 167 - 54 + 19) & (0xAC ^ 0xC1 ^ (0x53 ^ 0x61) ^ -" ".length())) > 0) {
                                        return ((0xA ^ 0x29 ^ (0x26 ^ 0x3E)) & (0xD5 ^ 0xA9 ^ (0x69 ^ 0x2E) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lllIlllIll[0];
                                }
            ...
            while (b.llIIlIIllllll(lllllllllllllllllIllIIllIIlllIII2, J.size())) {
                ...
                while (b.llIIlIIllllIl(b.a(lllllllllllllllllIllIIllIIllIlll) ? 1 : 0)) {
                                        ...
                                        if (b.llIIlIIllllIl(GrandExchange.canCollect() ? 1 : 0)) {
                                            ...
                                            if (b.llIIlIlIIIlII(GrandExchange.getOffers().stream().filter(grandExchangeOffer -> {
                                                ...
                                                if (b.llIIlIlIIIlIl(grandExchangeOffer.getItemId(), J.get(lllllllllllllllllIllIIllIIllIllI))) {
                                                    bl = lllIlllIll[1];
                                                    "".length();
                                                    if (" ".length() < ((0xD0 ^ 0x98 ^ (0xF6 ^ 0xB2)) & (0xBA ^ 0x91 ^ (4 ^ 0x23) ^ -" ".length()))) {
                                                        return ((18 + 37 - -24 + 79 ^ 73 + 31 - 27 + 60) & (0x39 ^ 0x4E ^ (0x1E ^ 0x7E) ^ -" ".length())) != 0;
                                                    }
                                                } else {
                                                    bl = lllIlllIll[0];
                                                }
                                            ...
                                            if (b.llIIlIIllllIl(lllllllllllllllllIllIIllIIllIlIl)) {
                                                ...
                                                if (b.llIIlIlIIIIII(lllllllllllllllllIllIIllIIllIIll, lllllllllllllllllIllIIllIIllIlII)) {
                                                    ...
                                                    if (b.llIIlIlIIIIIl(lllllllllllllllllIllIIllIIllIIll, lllIlllIll[12])) {
                                                        ...
                                                        "".length();
                                                        if (((0xC ^ 0x3B ^ (0xCE ^ 0xB0)) & (128 + 64 - 97 + 45 ^ 64 + 50 - 74 + 157 ^ -" ".length())) > (150 + 55 - 97 + 54 ^ 16 + 105 - 25 + 70)) {
                                                            return;
                                                        }
                                                    } else {
                    ...
                    "".length();
                    "".length();
                    if ((0x64 ^ 0x3C ^ (0 ^ 0x5C)) >= "  ".length()) continue;
                    return;
                }
                if (b.llIIlIIlllllI(GrandExchange.canCollect() ? 1 : 0)) {
                    GrandExchange.collect();
    ...
    private static void llIIlIIllllII() {
        ...
        b.lllIlllIll[0] = (0x62 ^ 0x5A ^ (0x2D ^ 0x1E)) & (0xB2 ^ 0xAF ^ (0xB7 ^ 0xA1) ^ -" ".length());
        b.lllIlllIll[1] = " ".length();
        b.lllIlllIll[2] = 0xFFFFFBEB & 0x7F7;
        b.lllIlllIll[3] = 0x4E ^ 0x44;
        b.lllIlllIll[4] = "   ".length();
