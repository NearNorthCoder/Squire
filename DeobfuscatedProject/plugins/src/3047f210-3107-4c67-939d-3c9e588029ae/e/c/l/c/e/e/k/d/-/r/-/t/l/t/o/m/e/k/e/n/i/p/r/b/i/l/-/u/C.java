...
implements S {
    ...
    public int T() {
        ...
        catch (Exception lllllllllllllllllIllIIlllllllIII) {
            lllllllllllllllllIllIIlllllllIII.printStackTrace();
        }
        if (null != null) {
            return (0x51 ^ 0x28 ^ (0xD2 ^ 0x98)) & (7 ^ 0x55 ^ (0xF9 ^ 0x98) ^ -" ".length());
        }
    ...
    public static void cb() {
        block22: {
            BankLocation lllllllllllllllllIllIlIIIIIIIIII;
            block23: {
                block27: {
                    block25: {
                        block26: {
                            block24: {
                                ...
                                lllllllllllllllllIllIlIIIIIIIIII = BankLocation.getNearest();
                                if (C.llIIlIIlIlIII(lllllllllllllllllIllIlIIIIIIIIII) && C.llIIlIIlIIllI(lllllllllllllllllIllIlIIIIIIIIII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    AccBuilderTempleTrek.c = lllIlllIII[lllIlllIIl[5]];
                                    a.a(lllllllllllllllllIllIlIIIIIIIIII);
                                    Time.sleepTicks((int)lllIlllIIl[3]);
                                    "".length();
                                }
                                if (!C.llIIlIIlIlIII(lllllllllllllllllIllIlIIIIIIIIII) || !C.llIIlIIlIIlII(lllllllllllllllllIllIlIIIIIIIIII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block23;
            ...
            if ((!C.llIIlIIlIIllI(C.aa() ? 1 : 0) || C.llIIlIIlIlIll(Players.getLocal().getWorldLocation().distanceTo(gL), lllIlllIIl[12])) && C.llIIlIIlIIlIl(e.j(lllIlllIIl[4]), lllIlllIIl[14])) {
                ...
                if (C.llIIlIIlIlIll(Players.getLocal().getWorldLocation().distanceTo(gL), lllIlllIIl[9])) {
                    ...
                    lllllllllllllllllIllIlIIIIIIIIII = TileObjects.getNearest((String[])stringArray);
                    if (C.llIIlIIlIlIII(lllllllllllllllllIllIlIIIIIIIIII)) {
                        String[] stringArray2 = new String[lllIlllIIl[1]];
                        stringArray2[C.lllIlllIIl[0]] = lllIlllIII[lllIlllIIl[18]];
                        if (C.llIIlIIlIIlII(lllllllllllllllllIllIlIIIIIIIIII.hasAction(stringArray2) ? 1 : 0)) {
                            lllllllllllllllllIllIlIIIIIIIIII.interact(lllIlllIII[lllIlllIIl[19]]);
    ...
    private static String llIIlIIlIIIII(String lllllllllllllllllIllIIllllIIlIIl, String lllllllllllllllllIllIIllllIIlIII) {
        try {
            SecretKeySpec lllllllllllllllllIllIIllllIIlllI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIllIIllllIIlIII.getBytes(StandardCharsets.UTF_8)), lllIlllIIl[16]), "DES");
            ...
            return new String(lllllllllllllllllIllIIllllIIllIl.doFinal(Base64.getDecoder().decode(lllllllllllllllllIllIIllllIIlIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String llIIlIIIlllll(String lllllllllllllllllIllIIllllllIIII, String lllllllllllllllllIllIIlllllIllIl) {
        try {
            SecretKeySpec lllllllllllllllllIllIIllllllIIll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIllIIlllllIllIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllllIllIIllllllIIlI = Cipher.getInstance("Blowfish");
            lllllllllllllllllIllIIllllllIIlI.init(lllIlllIIl[3], lllllllllllllllllIllIIllllllIIll);
            return new String(lllllllllllllllllIllIIllllllIIlI.doFinal(Base64.getDecoder().decode(lllllllllllllllllIllIIllllllIIII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void llIIlIIlIIIlI() {
        ...
        C.lllIlllIII[C.lllIlllIIl[0]] = C.llIIlIIIlllll("aEV+DuUaueYVr1U4uRXUSw==", "MFGvO");
        C.lllIlllIII[C.lllIlllIIl[1]] = C.llIIlIIlIIIII("ZCX+uW/P1vHnZLQnGinA471YYjmKi8u0hpiPPmKPaHjGN4zelmO2Ok1Yv2E96DKM", "WdTPi");
        C.lllIlllIII[C.lllIlllIIl[3]] = C.llIIlIIlIIIII("WR7DdFT/sCc=", "kkZVX");
        C.lllIlllIII[C.lllIlllIIl[5]] = C.llIIlIIlIIIII("TwwAS22rL3vEj6g0gaR4ig==", "coxfH");
        C.lllIlllIII[C.lllIlllIIl[6]] = C.llIIlIIlIIIIl("EiQAJTszKwlhNTsrBSg5PQ==", "ZEnAW");
        C.lllIlllIII[C.lllIlllIIl[12]] = C.llIIlIIlIIIII("WlxvucSh/8y8RoUiGh+eCxdoSorjrGMlk37DnodGfOJo0bUjZdhwFrSSPhBWZXKabZsBPxRx1pk=", "rpDWJ");
        C.lllIlllIII[C.lllIlllIIl[9]] = C.llIIlIIlIIIIl("EQthDwYjTiwHBzUHLwlUNxskHQBmHTQeBCoHJB1YZh02BwAlBigAE2YaLk42EzcIIDM=", "FnAnt");
        C.lllIlllIII[C.lllIlllIIl[15]] = C.llIIlIIIlllll("pRQLRp6pT2xwuxB/cfldFg==", "tJUIz");
        C.lllIlllIII[C.lllIlllIIl[16]] = C.llIIlIIIlllll("rJnDcW3tmORW5pSOx0RDvQ==", "IoFUb");
        C.lllIlllIII[C.lllIlllIIl[17]] = C.llIIlIIIlllll("RSjcTRkPTDI=", "eXlUv");
        C.lllIlllIII[C.lllIlllIIl[18]] = C.llIIlIIlIIIIl("GyYJIg==", "TVlLy");
        C.lllIlllIII[C.lllIlllIIl[19]] = C.llIIlIIIlllll("UsU3cjvhAzA=", "aYWaP");
        C.lllIlllIII[C.lllIlllIIl[20]] = C.llIIlIIIlllll("pfdSinNXv64=", "CQYrE");
        C.lllIlllIII[C.lllIlllIIl[21]] = C.llIIlIIIlllll("MaGeD4hW17jhiFvbaXZOIQ==", "GITqp");
        C.lllIlllIII[C.lllIlllIIl[22]] = C.llIIlIIIlllll("UlT87YpF6SKmMbn7RI1Ws5HJNw7kjaRH", "UVcde");
        C.lllIlllIII[C.lllIlllIIl[23]] = C.llIIlIIIlllll("KNwPicC2v4GvnPbNhzQuwgsSJnZymlq+HqS8zRS9rCnNfJhWWUByd+yXZEc8d5MPlEsoqz3NMJ8=", "lSzKw");
        C.lllIlllIII[C.lllIlllIIl[30]] = C.llIIlIIlIIIII("GtNAV0qy4gVLP8RkbVn7cQ==", "YQdVP");
        C.lllIlllIII[C.lllIlllIIl[31]] = C.llIIlIIlIIIII("OCK6WOm7E2iUjoOQFZAWt2dMW796GXhp", "ecIAy");
        C.lllIlllIII[C.lllIlllIIl[34]] = C.llIIlIIIlllll("VBbMploDvOfAVJtpvQbnuvhisu6TFzvkjI7YitkIFg8=", "gneQD");
        C.lllIlllIII[C.lllIlllIIl[35]] = C.llIIlIIlIIIIl("ES4Sek4BaxY/AiRrBjMaaDIOI048IwR2Ayk/BCQHKScSeA==", "HKaVn");
        C.lllIlllIII[C.lllIlllIIl[36]] = C.llIIlIIlIIIII("SHpV6DXzfk2xvdVOIFKhQ0t8GQgM4wIRpIGzu5IGOLw=", "sEWXU");
        C.lllIlllIII[C.lllIlllIIl[37]] = C.llIIlIIIlllll("layVIftE94g=", "NnIoL");
    }
    ...
    private static void llIIlIIlIIIll() {
        ...
        C.lllIlllIIl[1] = " ".length();
        C.lllIlllIIl[2] = 0x1B ^ 0x65 ^ (0xD8 ^ 0x94);
        C.lllIlllIIl[3] = "  ".length();
        C.lllIlllIIl[4] = 0x77 ^ 0x68;
        C.lllIlllIIl[5] = "   ".length();
    ...
    private static void ae() {
        d lllllllllllllllllIllIIlllllllIlI;
        Object lllllllllllllllllIllIIlllllllIll;
        block17: {
            block16: {
                block15: {
                    block14: {
                        block13: {
                            ...
                            lllllllllllllllllIllIIlllllllIll = new d(lllIlllIIl[8], lllIlllIIl[9], lllIlllIIl[24]);
                            bu.add((d)lllllllllllllllllIllIIlllllllIll);
                            "".length();
                        }
                        int[] nArray = new int[lllIlllIIl[1]];
                        nArray[C.lllIlllIIl[0]] = lllIlllIIl[10];
                    ...
                    lllllllllllllllllIllIIlllllllIll = new d(lllIlllIIl[10], lllIlllIIl[3], lllIlllIIl[24]);
                    bu.add((d)lllllllllllllllllIllIIlllllllIll);
                    "".length();
                }
                int[] nArray = new int[lllIlllIIl[1]];
            ...
            lllllllllllllllllIllIIlllllllIll = new d(lllIlllIIl[11], lllIlllIIl[6], lllIlllIIl[24]);
            bu.add((d)lllllllllllllllllIllIIlllllllIll);
            "".length();
        }
        int[] nArray = new int[lllIlllIIl[1]];
        ...
        if (C.llIIlIIlIIllI(Bank.contains((int[])nArray) ? 1 : 0)) {
            lllllllllllllllllIllIIlllllllIll = new d(lllIlllIIl[13], lllIlllIIl[12], lllIlllIIl[7]);
            bu.add((d)lllllllllllllllllIllIIlllllllIll);
            "".length();
        }
        if (C.llIIlIIlIIllI(Bank.contains((Predicate)(lllllllllllllllllIllIIlllllllIll = item -> item.getName().toLowerCase().contains(lllIlllIII[lllIlllIIl[31]]))) ? 1 : 0)) {
            lllllllllllllllllIllIIlllllllIlI = new d(lllIlllIIl[25], lllIlllIIl[12], lllIlllIIl[26]);
            bu.add(lllllllllllllllllIllIIlllllllIlI);
            "".length();
        }
        int[] nArray8 = new int[lllIlllIIl[1]];
        nArray8[C.lllIlllIIl[0]] = lllIlllIIl[27];
        if (C.llIIlIIlIIllI(Bank.contains((int[])nArray8) ? 1 : 0)) {
            lllllllllllllllllIllIIlllllllIlI = new d(lllIlllIIl[27], lllIlllIIl[28], lllIlllIIl[29]);
            bu.add(lllllllllllllllllIllIIlllllllIlI);
            "".length();
        }
    }
    ...
    private static String llIIlIIlIIIIl(String lllllllllllllllllIllIIlllllIIIII, String lllllllllllllllllIllIIllllIlllll) {
        lllllllllllllllllIllIIlllllIIIII = new String(Base64.getDecoder().decode(lllllllllllllllllIllIIlllllIIIII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllIllIIllllIllllI = new StringBuilder();
        char[] lllllllllllllllllIllIIllllIlllIl = lllllllllllllllllIllIIllllIlllll.toCharArray();
        int lllllllllllllllllIllIIllllIlllII = lllIlllIIl[0];
        char[] lllllllllllllllllIllIIllllIlIllI = lllllllllllllllllIllIIlllllIIIII.toCharArray();
        int lllllllllllllllllIllIIllllIlIlIl = lllllllllllllllllIllIIllllIlIllI.length;
        int lllllllllllllllllIllIIllllIlIlII = lllIlllIIl[0];
        while (C.llIIlIIlIIlIl(lllllllllllllllllIllIIllllIlIlII, lllllllllllllllllIllIIllllIlIlIl)) {
            char lllllllllllllllllIllIIlllllIIIIl = lllllllllllllllllIllIIllllIlIllI[lllllllllllllllllIllIIllllIlIlII];
            lllllllllllllllllIllIIllllIllllI.append((char)(lllllllllllllllllIllIIlllllIIIIl ^ lllllllllllllllllIllIIllllIlllIl[lllllllllllllllllIllIIllllIlllII % lllllllllllllllllIllIIllllIlllIl.length]));
            "".length();
            ++lllllllllllllllllIllIIllllIlllII;
            ++lllllllllllllllllIllIIllllIlIlII;
            "".length();
    ...
    private static void cc() {
        void lllllllllllllllllIllIIlllllllllI;
        ...
        if (C.llIIlIIlIlIII(lllllllllllllllllIllIIlllllllllI) && C.llIIlIIlIIlII(lllllllllllllllllIllIIlllllllllI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
