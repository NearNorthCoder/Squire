...
implements S {
        ...
        if (F.llIIllIIlIlIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (F.llIIllIIlIlIl(Inventory.contains((int[])nArray2) ? 1 : 0)) {
                ...
                if (F.llIIllIIlIlIl(Inventory.contains((int[])nArray3) ? 1 : 0)) {
                    ...
                    return ((0xE6 ^ 0x8F ^ (0xE ^ 0x25)) & (0xB8 ^ 0xA9 ^ (0x4F ^ 0x1C) ^ -" ".length())) != 0;
                }
            }
        }
        n2 = llllIIlIII[0];
    ...
    private static void llIIllIIlIlII() {
        ...
        F.llllIIlIII[1] = " ".length();
        F.llllIIlIII[2] = 0x28 ^ 0x63;
        F.llllIIlIII[3] = "  ".length();
        F.llllIIlIII[4] = 0xA7 ^ 0x99;
        F.llllIIlIII[5] = "   ".length();
    ...
    public int T() {
        ...
        if (((8 ^ 0xD ^ (0x18 ^ 0x2F)) & (0x7D ^ 0x6C ^ (0x4F ^ 0x6C) ^ -" ".length())) >= "  ".length()) {
            return (0x71 ^ 0x7C ^ (0x50 ^ 2) & ~(0x5B ^ 9)) & (0x24 ^ 0x46 ^ (0x6E ^ 1) ^ -" ".length());
        }
    ...
    private static void llIIllIIlIIll() {
        ...
        F.llllIIIlII[F.llllIIlIII[0]] = F.llIIlIlllllII("wM4RNBo+4q2S2f9QQssKRQ==", "zvJpq");
        F.llllIIIlII[F.llllIIlIII[1]] = F.llIIlIlllllIl("Ez4DHjw9MglXLSAuBBkodT4ZEiIme00EODwjDh8mOzBNFS42PE0DIHUmGBI8IQ==", "UWmwO");
        F.llllIIIlII[F.llllIIlIII[3]] = F.llIIlIllllllI("0EHy/BBo03k=", "gkdbL");
        F.llllIIIlII[F.llllIIlIII[5]] = F.llIIlIllllllI("R2QegSauLqGL6R8f2SsyzS5ZmWSeMCaB", "NBAWv");
        F.llllIIIlII[F.llllIIlIII[6]] = F.llIIlIlllllII("oGAVbK3jKjMZ83VE7oKHWw==", "gHPwv");
        F.llllIIIlII[F.llllIIlIII[8]] = F.llIIlIllllllI("k+ItL7U7LHvsP/puFN5ur6gQEXaPrAAQ", "FWSvQ");
        F.llllIIIlII[F.llllIIlIII[10]] = F.llIIlIllllllI("9CELv9Fvjn4L+yKr5zYB84QJQvkwTqJYCw/d9/ITQgGt1Hx+VgH845yxe9DvwxuMfnHMUvHxK9w=", "zkBOG");
        F.llllIIIlII[F.llllIIlIII[15]] = F.llIIlIlllllII("+1eEj6HBdCVFbY3/sxfIO+tW+2xE1axFtDv4GHLgio5KZLHjgobwqqwW5X042Zy+7/LILITWbAY=", "VFOJa");
        F.llllIIIlII[F.llllIIlIII[16]] = F.llIIlIlllllII("XcgGDTCSAnVSsHsH3I+4rw==", "tRxCC");
        F.llllIIIlII[F.llllIIlIII[17]] = F.llIIlIlllllII("scQNFaC6lquJ5FHmfW8x1A==", "kPslN");
        F.llllIIIlII[F.llllIIlIII[18]] = F.llIIlIlllllIl("HxAUEAFzFQkYFg==", "Sqfwd");
        F.llllIIIlII[F.llllIIlIII[19]] = F.llIIlIllllllI("VbvN1biaiys=", "VLdyu");
        F.llllIIIlII[F.llllIIlIII[20]] = F.llIIlIllllllI("NQUB9eDOugA=", "xnnUo");
        F.llllIIIlII[F.llllIIlIII[21]] = F.llIIlIlllllIl("EwwMJiY1BUIBMTodDCwuMQ==", "TibCT");
        F.llllIIIlII[F.llllIIlIII[25]] = F.llIIlIllllllI("PxGkTeCCUHoIpxb3Xs9Ynw==", "wlkue");
        F.llllIIIlII[F.llllIIlIII[26]] = F.llIIlIllllllI("bVpGmTdaw/s1afqH+/0T1g==", "jFqjZ");
        F.llllIIIlII[F.llllIIlIII[27]] = F.llIIlIlllllIl("AQgmCAJlED0LCjc=", "EqOfe");
        F.llllIIIlII[F.llllIIlIII[28]] = F.llIIlIlllllII("rWsc/7SuoqoKUmn7M0RPvw==", "qggac");
        F.llllIIIlII[F.llllIIlIII[29]] = F.llIIlIllllllI("ZI+aODLjYUfGupdc6Oxgbw==", "AybFr");
        F.llllIIIlII[F.llllIIlIII[30]] = F.llIIlIllllllI("jYfxOMHgQeiW5yrBa+kJUdtni6WSvwLW", "qEpPS");
        F.llllIIIlII[F.llllIIlIII[31]] = F.llIIlIllllllI("s4qYAbEh1eav8//TSUhHuAq/jzA/mszf", "brcwh");
        F.llllIIIlII[F.llllIIlIII[32]] = F.llIIlIlllllII("kyVV6h2wuRXE3MA1oloAeQ==", "OFfnd");
        F.llllIIIlII[F.llllIIlIII[33]] = F.llIIlIlllllIl("PRACGwwHAlAcC0kKAhQLDgA=", "iepue");
        F.llllIIIlII[F.llllIIlIII[34]] = F.llIIlIlllllIl("FQcLKCMzDkUPNDwWCyIrNw==", "RbeMQ");
        F.llllIIIlII[F.llllIIlIII[36]] = F.llIIlIlllllII("Hmkd+chGTB6LItX4gPKvnltzLgve/kIH", "JIbuB");
        F.llllIIIlII[F.llllIIlIII[37]] = F.llIIlIlllllIl("BAkhCkshCjYDAihFOQ4CKg==", "FeTok");
        F.llllIIIlII[F.llllIIlIII[38]] = F.llIIlIllllllI("aJnc1XxYVlozZx/CInx3/A==", "jqqQv");
        F.llllIIIlII[F.llllIIlIII[39]] = F.llIIlIlllllIl("IiUALy8YN1IoKFYyHjQj", "vPrAF");
        F.llllIIIlII[F.llllIIlIII[40]] = F.llIIlIlllllIl("PgoZPAsYA1cbHBcbGTYDHA==", "yowYy");
        F.llllIIIlII[F.llllIIlIII[42]] = F.llIIlIlllllIl("OAw8OwoCHm48DUwbPDoUAg==", "lyNUc");
        F.llllIIIlII[F.llllIIlIII[43]] = F.llIIlIlllllIl("JSUyUzMEZDcHJhkw", "kDDsG");
        F.llllIIIlII[F.llllIIlIII[44]] = F.llIIlIllllllI("Azy1NxUXXpbwdLN5Bv26pMTuWqT/C5FU", "SXhFL");
        F.llllIIIlII[F.llllIIlIII[46]] = F.llIIlIllllllI("Zj3sRnkX+4rwljlEyIWKPPeZVwsTPDy+", "uUoQG");
        F.llllIIIlII[F.llllIIlIII[47]] = F.llIIlIlllllIl("JDomGB8FLWMUFwUh", "kJCvv");
        F.llllIIIlII[F.llllIIlIII[48]] = F.llIIlIllllllI("qeAAuBMDqWai4UtOb28ScKQ/iFzDctd7", "GFJkC");
        F.llllIIIlII[F.llllIIlIII[49]] = F.llIIlIllllllI("vckK+vVdKjT+XOn91s3pU9YkAucLEmQpkj2P+zsWOr4s36aUOBOacRzl5Ec0l3P8MUFqmbUBaM0=", "owzHz");
        F.llllIIIlII[F.llllIIlIII[50]] = F.llIIlIlllllIl("OyhiKB0JbS8gHB8kLC5PHTgnOhtMPjc5HwAkJzpDTD41IBsPJSsnCEw5LWktORQLByg=", "lMBIo");
        F.llllIIIlII[F.llllIIlIII[51]] = F.llIIlIlllllII("rpu1zMFgqaKb7DBLNvptxQ==", "phbTi");
        F.llllIIIlII[F.llllIIlIII[52]] = F.llIIlIlllllII("R8EIOGo3GqUF5E5oi8LOXw==", "sVEPt");
        F.llllIIIlII[F.llllIIlIII[53]] = F.llIIlIlllllII("63f9NSRyJy6a9tKOdMSThQ==", "UPoJp");
        F.llllIIIlII[F.llllIIlIII[54]] = F.llIIlIlllllIl("KzojBz0BaCYQPw==", "dHBiZ");
        F.llllIIIlII[F.llllIIlIII[55]] = F.llIIlIlllllII("IB5gZYttgbWajpcvczrCXw==", "fLOfx");
        F.llllIIIlII[F.llllIIlIII[62]] = F.llIIlIlllllIl("EQAVOSc4TzM8PjoAGjQtLw==", "VowUN");
        F.llllIIIlII[F.llllIIlIII[63]] = F.llIIlIllllllI("pKCjy+GDO3x3zNOivtl4I+1NAthczepb", "cyHzB");
        F.llllIIIlII[F.llllIIlIII[64]] = F.llIIlIlllllII("iqPCKssdSn8=", "YLwSm");
        F.llllIIIlII[F.llllIIlIII[65]] = F.llIIlIlllllII("Z+chZF6Sea9GHH2NKJDlbCeygUttI8k8EFvoxhVJBwnpsqT4/+GwCJq47MvWhWz+NZgt1T5VDeg=", "bRIzo");
        F.llllIIIlII[F.llllIIlIII[66]] = F.llIIlIlllllII("KJFIKu2a5uaTE0yYZj/FTc9tTtaehCaWcz0Z/U9CpJo=", "QwMSX");
        F.llllIIIlII[F.llllIIlIII[67]] = F.llIIlIlllllIl("O2w6Cg8XbCEEFBdsPRkYHCs3SxgAIT0eC1IkNxkcXA==", "rLRky");
        F.llllIIIlII[F.llllIIlIII[68]] = F.llIIlIllllllI("/0tgXEEwU6g1+uGj8V3pF+BG+q1aRh4GJiAKuhLJyGI=", "sVMMA");
        F.llllIIIlII[F.llllIIlIII[69]] = F.llIIlIllllllI("EovH5JSyP7M0ueNiaJuhV90aqaMd4s5gwqtAve1DATs=", "whvPu");
        F.llllIIIlII[F.llllIIlIII[70]] = F.llIIlIllllllI("+GEdtsGYzyEBkV6p9/XTcC4eC21dfibC", "qKIfN");
    }
