...
implements S {
    ...
    private static String llIlIlIlIIlIl(String lllllllllllllllllIlIIlIIIlIIIllI, String lllllllllllllllllIlIIlIIIlIIIIll) {
        try {
            SecretKeySpec lllllllllllllllllIlIIlIIIlIIlIIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIlIIlIIIlIIIIll.getBytes(StandardCharsets.UTF_8)), lllllIlllI[26]), "DES");
            Cipher lllllllllllllllllIlIIlIIIlIIlIII = Cipher.getInstance("DES");
            lllllllllllllllllIlIIlIIIlIIlIII.init(lllllIlllI[2], lllllllllllllllllIlIIlIIIlIIlIIl);
            return new String(lllllllllllllllllIlIIlIIIlIIlIII.doFinal(Base64.getDecoder().decode(lllllllllllllllllIlIIlIIIlIIIllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void llIlIlIlIlIII() {
        ...
        Z.lllllIlllI[0] = (57 + 56 - -31 + 95 ^ 62 + 6 - -89 + 17) & (2 ^ 0x2C ^ (0x2D ^ 0x42) ^ -" ".length());
        Z.lllllIlllI[1] = " ".length();
        Z.lllllIlllI[2] = "  ".length();
        Z.lllllIlllI[3] = "   ".length();
            ...
            if (Z.llIlIlIlIllIl(Inventory.getCount((int[])nArray))) {
                ...
                if (Z.llIlIlIlIllIl(Inventory.getCount((int[])nArray3))) {
                    ...
                    if (Z.llIlIlIlIllIl(Inventory.getCount((int[])nArray4))) {
                        n4 = lllllIlllI[1];
                        "".length();
                        if ("  ".length() <= (0x48 ^ 0x4C)) return n4 != 0;
                        return ((0xAE ^ 0x9A) & ~(0x76 ^ 0x42)) != 0;
                    }
                }
            }
            n4 = lllllIlllI[0];
                ...
                if (Z.llIlIlIlIllIl(Inventory.getCount((int[])nArray9))) {
                    ...
                    if (Z.llIlIlIlIllIl(Inventory.getCount((int[])nArray10))) {
                        ...
                        if (Z.llIlIlIlIllIl(Inventory.getCount((int[])nArray11))) {
                            ...
                            return ((4 + 28 - -48 + 62 ^ 107 + 31 - 27 + 21) & (26 + 142 - 4 + 0 ^ 132 + 156 - 127 + 13 ^ -" ".length())) != 0;
                        }
                    }
                }
            }
    ...
    private static String llIlIlIlIIllI(String lllllllllllllllllIlIIlIIIllIlIll, String lllllllllllllllllIlIIlIIIllIlIlI) {
        try {
            ...
            Cipher lllllllllllllllllIlIIlIIIllIllIl = Cipher.getInstance("Blowfish");
            lllllllllllllllllIlIIlIIIllIllIl.init(lllllIlllI[2], lllllllllllllllllIlIIlIIIllIlllI);
            return new String(lllllllllllllllllIlIIlIIIllIllIl.doFinal(Base64.getDecoder().decode(lllllllllllllllllIlIIlIIIllIlIll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void llIlIlIlIIlll() {
        ...
        Z.lllllIllIl[Z.lllllIlllI[0]] = Z.llIlIlIlIIlII("NwcbEDsSUgsNMBgB", "urbyU");
        Z.lllllIllIl[Z.lllllIlllI[1]] = Z.llIlIlIlIIlII("Iz8EIgcNMw5rFhAvAyUTRT8eLhkWeko4AwwiCSMdCzFKKRUGPUo/G0U7AyUdCzE=", "eVjKt");
        Z.lllllIllIl[Z.lllllIlllI[2]] = Z.llIlIlIlIIlIl("1H2DepDB/fRwdEYaVqmc7g0O8CUdBpOy", "zTOrW");
        Z.lllllIllIl[Z.lllllIlllI[3]] = Z.llIlIlIlIIlII("ADc/BzshODZDNSk4Ogo5Lw==", "HVQcW");
        Z.lllllIllIl[Z.lllllIlllI[5]] = Z.llIlIlIlIIlIl("eRR+CsUfCDysWe2gwRPBoDrUFpxfO0d11cEfMBwcBMmz1VmayB8q+3Cl4M4nzEom", "hOoRM");
        Z.lllllIllIl[Z.lllllIlllI[23]] = Z.llIlIlIlIIlIl("mvji3vr7/VbRiI54fUtxpA==", "iirMt");
        Z.lllllIllIl[Z.lllllIlllI[21]] = Z.llIlIlIlIIllI("1AGu1brc2PQNJrkQ4C74eA==", "gwnrA");
        Z.lllllIllIl[Z.lllllIlllI[25]] = Z.llIlIlIlIIlII("IBo4IisKUzUkNR0WJA==", "msVKE");
        Z.lllllIllIl[Z.lllllIlllI[26]] = Z.llIlIlIlIIlIl("I/Rb+XsjU0k=", "lQaAk");
        Z.lllllIllIl[Z.lllllIlllI[27]] = Z.llIlIlIlIIllI("coN7+r1BTURJ6YzLuQv73svh2hZPaKPd", "GaUpo");
        Z.lllllIllIl[Z.lllllIlllI[28]] = Z.llIlIlIlIIlIl("QVi+suH2A451rGf4FXn9bQ==", "PMatu");
        Z.lllllIllIl[Z.lllllIlllI[29]] = Z.llIlIlIlIIlIl("BrT2+LrQCkM=", "OqzvI");
        Z.lllllIllIl[Z.lllllIlllI[41]] = Z.llIlIlIlIIlII("CRobIyoj", "DsuJD");
        Z.lllllIllIl[Z.lllllIlllI[43]] = Z.llIlIlIlIIlIl("CWKlju/xteCpK89YvqUhPS27G3VXfpAm", "oZnve");
    }
    ...
    public static void es() {
        block32: {
            BankLocation lllllllllllllllllIlIIlIIIllllIIl;
            block33: {
                block39: {
                    block35: {
                        block38: {
                            block37: {
                                block36: {
                                    block34: {
                                        ...
                                        lllllllllllllllllIlIIlIIIllllIIl = BankLocation.getNearest();
                                        if (Z.llIlIlIlIllII(lllllllllllllllllIlIIlIIIllllIIl) && Z.llIlIlIlIlIll(lllllllllllllllllIlIIlIIIllllIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                            AccBuilderTempleTrek.c = lllllIllIl[lllllIlllI[2]];
                                            a.a(lllllllllllllllllIlIIlIIIllllIIl);
                                        }
                                        if (!Z.llIlIlIlIllII(lllllllllllllllllIlIIlIIIllllIIl) || !Z.llIlIlIlIlIIl(lllllllllllllllllIlIIlIIIllllIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block33;
                    ...
                    if (Z.llIlIlIlIlIIl(Bank.contains((int[])nArray10) ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (Z.llIlIlIlIllIl(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if ("   ".length() != "   ".length()) {
                                    return ((71 + 11 - -26 + 50 ^ 90 + 114 - 177 + 113) & (0xE4 ^ 0x93 ^ (0x1C ^ 0x79) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lllllIlllI[0];
                            }
                    ...
                    if (Z.llIlIlIlIlIIl(Bank.contains((int[])nArray11) ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (Z.llIlIlIlIllIl(Inventory.getCount((int[])nArray))) {
                                bl = lllllIlllI[1];
                                "".length();
                                if ((("  ".length() ^ (0xEE ^ 0xA5)) & (0x7E ^ 0x46 ^ (0x1D ^ 0x6C) ^ -" ".length())) > " ".length()) {
                                    return ((0xC ^ 0x45 ^ (0xC8 ^ 0xA6)) & (0x6F ^ 0x4F ^ (6 ^ 1) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lllllIlllI[0];
                            }
                    ...
                    if (Z.llIlIlIlIlIIl(Bank.contains((int[])nArray14) ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (Z.llIlIlIlIllIl(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if ("   ".length() <= -" ".length()) {
                                    return ((0xB0 ^ 0xBA ^ (0xCD ^ 0x88)) & (0x3A ^ 0x18 ^ (0xC6 ^ 0xAB) ^ -" ".length()) & ((108 + 28 - -70 + 45 ^ 50 + 117 - 134 + 130) & (0xA3 ^ 0x95 ^ (0x57 ^ 0x39) ^ -" ".length()) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lllllIlllI[0];
                            }
                ...
                if (Z.llIlIlIlIlIll(Inventory.isFull() ? 1 : 0)) {
                    if (Z.llIlIlIlIlIlI(Skills.getLevel((Skill)Skill.MINING), lllllIlllI[24])) {
                        ...
                        if (Z.llIlIlIlIlIIl(y.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            lllllllllllllllllIlIIlIIIllllIIl = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (int[])jr);
                            if (Z.llIlIlIlIlIll(Players.getLocal().isAnimating() ? 1 : 0) && Z.llIlIlIlIlIll(Players.getLocal().isMoving() ? 1 : 0) && Z.llIlIlIlIllII(lllllllllllllllllIlIIlIIIllllIIl)) {
                                lllllllllllllllllIlIIlIIIllllIIl.interact(lllllIllIl[lllllIlllI[26]]);
                                Time.sleepTicks((int)lllllIlllI[2]);
                                "".length();
                            }
                        }
                    ...
                    if (Z.llIlIlIlIlllI(Skills.getLevel((Skill)Skill.MINING), lllllIlllI[24])) {
                        ...
                        if (Z.llIlIlIlIlIIl(y.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            lllllllllllllllllIlIIlIIIllllIIl = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (int[])jq);
                            if (Z.llIlIlIlIlIll(Players.getLocal().isAnimating() ? 1 : 0) && Z.llIlIlIlIlIll(Players.getLocal().isMoving() ? 1 : 0) && Z.llIlIlIlIllII(lllllllllllllllllIlIIlIIIllllIIl)) {
                                lllllllllllllllllIlIIlIIIllllIIl.interact(lllllIllIl[lllllIlllI[29]]);
                                Time.sleepTicks((int)lllllIlllI[2]);
                                "".length();
                            }
                        }
    ...
    public boolean V() {
        ...
        if (Z.llIlIlIlIlllI(Skills.getLevel((Skill)Skill.MINING), lllllIlllI[42])) {
            ...
            if ((152 + 33 - 78 + 46 ^ 122 + 112 - 115 + 38) != (0x29 ^ 0x13 ^ (0xAD ^ 0x93))) {
                return (("   ".length() ^ (0xA3 ^ 0xBD)) & (0xBE ^ 0x80 ^ (0xBB ^ 0x98) ^ -" ".length())) != 0;
            }
        } else {
            bl = lllllIlllI[0];
        }
    ...
    public static void ae() {
        d lllllllllllllllllIlIIlIIIlllIIll;
        Object lllllllllllllllllIlIIlIIIlllIlII;
        ...
        if (Z.llIlIlIlIlIll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lllllllllllllllllIlIIlIIIlllIlII = new d(lllllIlllI[7], lllllIlllI[1], lllllIlllI[4]);
            bu.add((d)lllllllllllllllllIlIIlIIIlllIlII);
            "".length();
        }
        int[] nArray3 = new int[lllllIlllI[1]];
        nArray3[Z.lllllIlllI[0]] = lllllIlllI[8];
        if (Z.llIlIlIlIlIll(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllllIlIIlIIIlllIlII = new d(lllllIlllI[8], lllllIlllI[1], lllllIlllI[34]);
            bu.add((d)lllllllllllllllllIlIIlIIIlllIlII);
            "".length();
        }
        int[] nArray4 = new int[lllllIlllI[1]];
        ...
        if (Z.llIlIlIlIlIll(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllllIlIIlIIIlllIlII = new d(lllllIlllI[9], lllllIlllI[1], lllllIlllI[35]);
            bu.add((d)lllllllllllllllllIlIIlIIIlllIlII);
            "".length();
        }
        int[] nArray5 = new int[lllllIlllI[1]];
        ...
        if (Z.llIlIlIlIlIll(Bank.contains((int[])nArray5) ? 1 : 0)) {
            lllllllllllllllllIlIIlIIIlllIlII = new d(lllllIlllI[10], lllllIlllI[1], lllllIlllI[36]);
            bu.add((d)lllllllllllllllllIlIIlIIIlllIlII);
            "".length();
        }
        if (Z.llIlIlIlIlIll(Bank.contains((Predicate)(lllllllllllllllllIlIIlIIIlllIlII = item -> item.getName().toLowerCase().contains(lllllIllIl[lllllIlllI[43]]))) ? 1 : 0)) {
            lllllllllllllllllIlIIlIIIlllIIll = new d(lllllIlllI[19], lllllIlllI[23], lllllIlllI[36]);
            bu.add(lllllllllllllllllIlIIlIIIlllIIll);
            "".length();
        }
        int[] nArray6 = new int[lllllIlllI[1]];
        nArray6[Z.lllllIlllI[0]] = lllllIlllI[37];
        if (Z.llIlIlIlIlIll(Bank.contains((int[])nArray6) ? 1 : 0)) {
            lllllllllllllllllIlIIlIIIlllIIll = new d(lllllIlllI[37], lllllIlllI[38], lllllIlllI[39]);
            bu.add(lllllllllllllllllIlIIlIIIlllIIll);
            "".length();
        }
    }
    ...
    private static String llIlIlIlIIlII(String lllllllllllllllllIlIIlIIIlIllIll, String lllllllllllllllllIlIIlIIIlIllIlI) {
        lllllllllllllllllIlIIlIIIlIllIll = new String(Base64.getDecoder().decode(lllllllllllllllllIlIIlIIIlIllIll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllIlIIlIIIlIllIIl = new StringBuilder();
        char[] lllllllllllllllllIlIIlIIIlIllIII = lllllllllllllllllIlIIlIIIlIllIlI.toCharArray();
        int lllllllllllllllllIlIIlIIIlIlIlll = lllllIlllI[0];
        char[] lllllllllllllllllIlIIlIIIlIlIIIl = lllllllllllllllllIlIIlIIIlIllIll.toCharArray();
        int lllllllllllllllllIlIIlIIIlIlIIII = lllllllllllllllllIlIIlIIIlIlIIIl.length;
        int lllllllllllllllllIlIIlIIIlIIllll = lllllIlllI[0];
        while (Z.llIlIlIlIlIlI(lllllllllllllllllIlIIlIIIlIIllll, lllllllllllllllllIlIIlIIIlIlIIII)) {
            char lllllllllllllllllIlIIlIIIlIlllII = lllllllllllllllllIlIIlIIIlIlIIIl[lllllllllllllllllIlIIlIIIlIIllll];
            lllllllllllllllllIlIIlIIIlIllIIl.append((char)(lllllllllllllllllIlIIlIIIlIlllII ^ lllllllllllllllllIlIIlIIIlIllIII[lllllllllllllllllIlIIlIIIlIlIlll % lllllllllllllllllIlIIlIIIlIllIII.length]));
            "".length();
