...
public class e {
    ...
    private static void llIIlIllIIlIl() {
        ...
        e.lllIllllll[e.llllIIIIIl[1]] = e.llIIlIlIlIllI("LePO6wGIsFk=", "ClfmW");
        e.lllIllllll[e.llllIIIIIl[0]] = e.llIIlIlIlIlll("LFE/BB8KGRANIgYICA0tHxsnMBgONzE+DQICDTYwQR8ROA4AHz8WAwsYLiQACjcOJAAKRRcpGA==", "okcQl");
        e.lllIllllll[e.llllIIIIIl[2]] = e.llIIlIlIlIlll("GC0ZH1cHIQcbCxUwGAg=", "tDwzy");
        e.lllIllllll[e.llllIIIIIl[6]] = e.llIIlIlIllIII("ZqDXv61SiS4=", "RvibQ");
        e.lllIllllll[e.llllIIIIIl[3]] = e.llIIlIlIllIII("lI4sKuePWQXSfHcYP5VpUA==", "KBToE");
        e.lllIllllll[e.llllIIIIIl[14]] = e.llIIlIlIlIllI("wDy3mA/bkk0=", "WGvAN");
        e.lllIllllll[e.llllIIIIIl[17]] = e.llIIlIlIllIII("yFRRLqsSA9c=", "ATiWG");
        e.lllIllllll[e.llllIIIIIl[9]] = e.llIIlIlIllIII("9DSM+v7VDB4=", "oSbLE");
        e.lllIllllll[e.llllIIIIIl[20]] = e.llIIlIlIlIllI("XVjwNVDy8MVLOd+xUTsjqQ==", "muUxK");
        e.lllIllllll[e.llllIIIIIl[21]] = e.llIIlIlIllIII("hpfoz42rZBU=", "AoXob");
        e.lllIllllll[e.llllIIIIIl[22]] = e.llIIlIlIllIII("8axIkVH8Dyw=", "vTHGi");
        e.lllIllllll[e.llllIIIIIl[23]] = e.llIIlIlIlIllI("2PAbmLQY7G0=", "ZjLHt");
        e.lllIllllll[e.llllIIIIIl[24]] = e.llIIlIlIlIllI("YKqGLgl6Dak=", "rwUgS");
        e.lllIllllll[e.llllIIIIIl[25]] = e.llIIlIlIlIllI("O0M6gqvIQWY=", "mKoZO");
        e.lllIllllll[e.llllIIIIIl[26]] = e.llIIlIlIlIlll("HQsyIwA=", "XzGJp");
        e.lllIllllll[e.llllIIIIIl[28]] = e.llIIlIlIllIII("hGOaBA/12CN2KDlW2qJrdk6a3M2VkgvO", "MhFgZ");
        e.lllIllllll[e.llllIIIIIl[40]] = e.llIIlIlIlIllI("Chcem4xeikzPJ/EYhgKE8RDQV7W6oWV2", "VUrve");
        e.lllIllllll[e.llllIIIIIl[41]] = e.llIIlIlIlIlll("NzA1Ng==", "pQASZ");
        e.lllIllllll[e.llllIIIIIl[42]] = e.llIIlIlIlIllI("H9uAS+KupyU=", "trLRq");
        e.lllIllllll[e.llllIIIIIl[11]] = e.llIIlIlIllIII("Af6HtcWA7gbEHeFb3kMpnepNDN7Nglq2", "nGZVV");
        e.lllIllllll[e.llllIIIIIl[13]] = e.llIIlIlIlIllI("NWEQ1fGxGwlxoyFas2cp16iihE9GjdeR", "uymwv");
        e.lllIllllll[e.llllIIIIIl[45]] = e.llIIlIlIlIllI("S1EVRgnfQic=", "lNvJQ");
        e.lllIllllll[e.llllIIIIIl[46]] = e.llIIlIlIllIII("cDfy8DJ8NBNlDCzR50QwJA==", "NqEKb");
        e.lllIllllll[e.llllIIIIIl[8]] = e.llIIlIlIlIllI("9V7oBsP19rGFxH98QKJkxVFJyZLQX1hb", "zzHYs");
        e.lllIllllll[e.llllIIIIIl[51]] = e.llIIlIlIllIII("f50qHQrbGpoF6cygD8RSuA==", "SCIBh");
        e.lllIllllll[e.llllIIIIIl[52]] = e.llIIlIlIlIlll("DiQCOEs9NAI2ByYwAjI=", "OQvWk");
        e.lllIllllll[e.llllIIIIIl[53]] = e.llIIlIlIllIII("f8L7Va/Bct6Ue5Ix0JRu+g==", "HMSnl");
        e.lllIllllll[e.llllIIIIIl[54]] = e.llIIlIlIlIllI("vn72DeX4D1zljy2OwJo/Ag==", "Pxvtx");
        e.lllIllllll[e.llllIIIIIl[55]] = e.llIIlIlIllIII("AdRIlmA4t7U=", "tsteK");
        e.lllIllllll[e.llllIIIIIl[5]] = e.llIIlIlIllIII("AMIJDfNTwc8=", "LICUP");
        e.lllIllllll[e.llllIIIIIl[50]] = e.llIIlIlIlIlll("ASIVNwk9", "QMgCh");
        e.lllIllllll[e.llllIIIIIl[56]] = e.llIIlIlIlIlll("DDY9", "YEXnM");
        e.lllIllllll[e.llllIIIIIl[19]] = e.llIIlIlIllIII("N73kike0jsU=", "yMEJh");
        e.lllIllllll[e.llllIIIIIl[61]] = e.llIIlIlIlIlll("MTgADQo=", "EWtlf");
        e.lllIllllll[e.llllIIIIIl[62]] = e.llIIlIlIllIII("dhUboBRREpk=", "INBuv");
        e.lllIllllll[e.llllIIIIIl[33]] = e.llIIlIlIlIllI("Q5kEb4Ho8uk=", "aeWZF");
        e.lllIllllll[e.llllIIIIIl[63]] = e.llIIlIlIlIllI("Tb40UCZINt0=", "armvW");
        e.lllIllllll[e.llllIIIIIl[66]] = e.llIIlIlIlIllI("e5MiNmT2/pI=", "xMDdb");
        e.lllIllllll[e.llllIIIIIl[67]] = e.llIIlIlIlIlll("Og8aMA==", "xjnQH");
        e.lllIllllll[e.llllIIIIIl[68]] = e.llIIlIlIllIII("/iGaju+zbQ4=", "nPmQk");
        e.lllIllllll[e.llllIIIIIl[12]] = e.llIIlIlIlIlll("MT0DAzgUNg==", "uXbgU");
        e.lllIllllll[e.llllIIIIIl[16]] = e.llIIlIlIlIllI("+P+jFEiIpcI=", "WccJE");
        e.lllIllllll[e.llllIIIIIl[69]] = e.llIIlIlIllIII("+mGa4lpgrjMiCVvVZ5BC1A==", "nDcJc");
        e.lllIllllll[e.llllIIIIIl[70]] = e.llIIlIlIllIII("XpBYw8E6G/Q=", "PokYH");
        e.lllIllllll[e.llllIIIIIl[71]] = e.llIIlIlIlIllI("0cZlnShu8js=", "okkOx");
        e.lllIllllll[e.llllIIIIIl[73]] = e.llIIlIlIllIII("xEk3OAt7cKa6ST2ldcV1/WkJWNKPSzs6T60HNy9FeAzIY+QWfOno5YQxTe3n1f5ZSE56yvo1xqI=", "kpicd");
    }

    public static void C() {
        if (e.llIIlIllIIlll(e.j(llllIIIIIl[48]))) {
            Widget lllllllllllllllllIllIIlIIIIlIlII;
            if (e.llIIlIllIIlll(Tabs.isOpen((Tab)Tab.COMBAT) ? 1 : 0)) {
                Tabs.open((Tab)Tab.COMBAT);
                Time.sleepTicks((int)llllIIIIIl[0]);
                "".length();
            }
            if (e.llIIlIllIlIIl(Tabs.isOpen((Tab)Tab.COMBAT) ? 1 : 0) && e.llIIlIllIlllI(lllllllllllllllllIllIIlIIIIlIlII = Widgets.get((int)llllIIIIIl[49], (int)llllIIIIIl[50]))) {
                lllllllllllllllllIllIIlIIIIlIlII.interact(lllIllllll[llllIIIIIl[51]]);
                Time.sleepTicks((int)llllIIIIIl[0]);
                "".length();
            }
        }
    ...
    public static void E() {
        block9: {
            int lllllllllllllllllIllIIlIIIIIllIl = llllIIIIIl[1];
            do {
                ...
                NPC lllllllllllllllllIllIIlIIIIIllII = NPCs.getNearest((String[])stringArray2);
                if (e.llIIlIllIIlll(lllllllllllllllllIllIIlIIIIIllIl)) {
                    if (e.llIIlIllIIlll(Dialog.isOpen() ? 1 : 0)) {
                        lllllllllllllllllIllIIlIIIIIllII.interact(lllIllllll[llllIIIIIl[5]]);
                    }
                    if (e.llIIlIllIlIIl(Dialog.isOpen() ? 1 : 0)) {
                        List lllllllllllllllllIllIIlIIIIIlIll;
                        if (e.llIIlIllIIlll(Dialog.canContinueNPC() ? 1 : 0) && e.llIIlIllIIlll(Dialog.canContinue() ? 1 : 0) && e.llIIlIllIIlll((lllllllllllllllllIllIIlIIIIIlIll = Dialog.getOptions()).isEmpty() ? 1 : 0)) {
                            List lllllllllllllllllIllIIlIIIIIlIlI = lllllllllllllllllIllIIlIIIIIlIll.stream().filter(widget -> {
                                boolean bl;
                                if (e.llIIlIllIIlll(widget.getText().contains(lllIllllll[llllIIIIIl[19]]) ? 1 : 0)) {
                                    bl = llllIIIIIl[0];
                                    "".length();
                                    if (((0xAE ^ 0xA8) & ~(0xA5 ^ 0xA3)) != 0) {
                                        return ((0xC9 ^ 0x9B) & ~(0xC3 ^ 0x91)) != 0;
                                    }
                                } else {
                                    bl = llllIIIIIl[1];
                                }
                            ...
                            if (e.llIIlIllIIlll(lllllllllllllllllIllIIlIIIIIlIlI.isEmpty() ? 1 : 0)) {
                                Mouse.click((int)((Widget)lllllllllllllllllIllIIlIIIIIlIlI.get(llllIIIIIl[1])).getClickPoint().getX(), (int)((Widget)lllllllllllllllllIllIIlIIIIIlIlI.get(llllIIIIIl[1])).getClickPoint().getY(), (boolean)llllIIIIIl[0]);
                                Time.sleepTicks((int)llllIIIIIl[6]);
                                "".length();
                            }
                            if (e.llIIlIllIlIII(lllllllllllllllllIllIIlIIIIIlIlI.size(), llllIIIIIl[0])) {
                                lllllllllllllllllIllIIlIIIIIllIl = llllIIIIIl[0];
                            }
                        }
                ...
                if (e.llIIlIllIlIIl(lllllllllllllllllIllIIlIIIIIllIl)) {
    ...
    public static void y() {
        Widget lllllllllllllllllIllIIlIIlIIIlII;
        if (e.llIIlIllIlIIl(Dialog.isOpen() ? 1 : 0)) {
            Dialog.close();
        }
        if (e.llIIlIllIlIIl(e.x() ? 1 : 0)) {
            ...
            if (e.llIIlIllIlIIl(e.z() ? 1 : 0)) {
                Widget lllllllllllllllllIllIIlIIlIIIIlI;
                Widget lllllllllllllllllIllIIlIIlIIIIll;
                lllllllllllllllllIllIIlIIlIIIlII = Widgets.get((int)llllIIIIIl[7], (int)llllIIIIIl[8], (int)llllIIIIIl[9]);
                if (e.llIIlIllIlllI(lllllllllllllllllIllIIlIIlIIIlII)) {
                    lllllllllllllllllIllIIlIIlIIIlII.interact(lllIllllll[llllIIIIIl[3]]);
                    Time.sleepTicks((int)llllIIIIIl[0]);
                    "".length();
                }
                if (e.llIIlIllIIlll(Vars.getBit((int)llllIIIIIl[10])) && e.llIIlIllIlllI(lllllllllllllllllIllIIlIIlIIIIll = Widgets.get((int)llllIIIIIl[7], (int)llllIIIIIl[11], (int)llllIIIIIl[12]))) {
                    if (e.llIIlIllIIlll(lllllllllllllllllIllIIlIIlIIIIll.isVisible() ? 1 : 0)) {
                        lllllllllllllllllIllIIlIIlIIIIlI = Widgets.get((int)llllIIIIIl[7], (int)llllIIIIIl[13], (int)llllIIIIIl[14]);
                        Mouse.click((int)lllllllllllllllllIllIIlIIlIIIIlI.getClickPoint().getX(), (int)lllllllllllllllllIllIIlIIlIIIIlI.getClickPoint().getY(), (boolean)llllIIIIIl[0]);
                        Time.sleepTicks((int)llllIIIIIl[0]);
                        "".length();
                    }
                    if (e.llIIlIllIlIIl(lllllllllllllllllIllIIlIIlIIIIll.isVisible() ? 1 : 0)) {
                        lllllllllllllllllIllIIlIIlIIIIll.interact(lllIllllll[llllIIIIIl[14]]);
                        Time.sleepTicks((int)llllIIIIIl[0]);
                        "".length();
                    }
                }
                if (e.llIIlIllIIlll(Vars.getBit((int)llllIIIIIl[15])) && e.llIIlIllIlllI(lllllllllllllllllIllIIlIIlIIIIll = Widgets.get((int)llllIIIIIl[7], (int)llllIIIIIl[11], (int)llllIIIIIl[16]))) {
                    if (e.llIIlIllIIlll(lllllllllllllllllIllIIlIIlIIIIll.isVisible() ? 1 : 0)) {
                        lllllllllllllllllIllIIlIIlIIIIlI = Widgets.get((int)llllIIIIIl[7], (int)llllIIIIIl[13], (int)llllIIIIIl[14]);
                        Mouse.click((int)lllllllllllllllllIllIIlIIlIIIIlI.getClickPoint().getX(), (int)lllllllllllllllllIllIIlIIlIIIIlI.getClickPoint().getY(), (boolean)llllIIIIIl[0]);
                        Time.sleepTicks((int)llllIIIIIl[0]);
                    ...
                    if (e.llIIlIllIlIIl(lllllllllllllllllIllIIlIIlIIIIll.isVisible() ? 1 : 0)) {
                        lllllllllllllllllIllIIlIIlIIIIll.interact(lllIllllll[llllIIIIIl[17]]);
        ...
        if (e.llIIlIllIlllI(lllllllllllllllllIllIIlIIlIIIlII = Widgets.get((int)llllIIIIIl[7], (int)llllIIIIIl[3]))) {
            lllllllllllllllllIllIIlIIlIIIlII.interact(lllIllllll[llllIIIIIl[9]]);
            Time.sleepTicks((int)llllIIIIIl[0]);
            "".length();
        }
    }
    ...
    public static void a(String lllllllllllllllllIllIIlIIIlIlllI, String lllllllllllllllllIllIIlIIIlIllIl) {
        try {
            URL lllllllllllllllllIllIIlIIIlIllII = new URL(lllllllllllllllllIllIIlIIIlIlllI);
            HttpURLConnection lllllllllllllllllIllIIlIIIlIlIll = (HttpURLConnection)lllllllllllllllllIllIIlIIIlIllII.openConnection();
            lllllllllllllllllIllIIlIIIlIlIll.setRequestMethod(lllIllllll[llllIIIIIl[45]]);
            lllllllllllllllllIllIIlIIIlIlIll.setRequestProperty(lllIllllll[llllIIIIIl[46]], lllIllllll[llllIIIIIl[8]]);
            lllllllllllllllllIllIIlIIIlIlIll.setDoOutput(llllIIIIIl[0]);
            String lllllllllllllllllIllIIlIIIlIlIlI = "{\"content\": \"" + lllllllllllllllllIllIIlIIIlIllIl + "\"}";
            DataOutputStream lllllllllllllllllIllIIlIIIlIlIIl = new DataOutputStream(lllllllllllllllllIllIIlIIIlIlIll.getOutputStream());
            lllllllllllllllllIllIIlIIIlIlIIl.writeBytes(lllllllllllllllllIllIIlIIIlIlIlI);
            lllllllllllllllllIllIIlIIIlIlIIl.flush();
            lllllllllllllllllIllIIlIIIlIlIIl.close();
            int lllllllllllllllllIllIIlIIIlIlIII = lllllllllllllllllIllIIlIIIlIlIll.getResponseCode();
            System.out.println("Response Code: " + lllllllllllllllllIllIIlIIIlIlIII);
            lllllllllllllllllIllIIlIIIlIlIll.disconnect();
            "".length();
        }
        catch (Exception lllllllllllllllllIllIIlIIIlIllII) {
            lllllllllllllllllIllIIlIIIlIllII.printStackTrace();
        }
        if ("   ".length() == 0) {
            return;
        }
    ...
    private static String llIIlIlIlIllI(String lllllllllllllllllIllIIIlllIlIlIl, String lllllllllllllllllIllIIIlllIlIllI) {
        try {
            SecretKeySpec lllllllllllllllllIllIIIlllIllIlI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIllIIIlllIlIllI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllllIllIIIlllIllIIl = Cipher.getInstance("Blowfish");
            lllllllllllllllllIllIIIlllIllIIl.init(llllIIIIIl[2], lllllllllllllllllIllIIIlllIllIlI);
            return new String(lllllllllllllllllIllIIIlllIllIIl.doFinal(Base64.getDecoder().decode(lllllllllllllllllIllIIIlllIlIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static int c(int n2, int n3) {
        void lllllllllllllllllIllIIlIIlIlIlll;
        int lllllllllllllllllIllIIlIIlIlIllI;
        int lllllllllllllllllIllIIlIIlIllIII;
        int n4 = n3 - n2;
        if (e.llIIlIllIIlll(n4)) {
            return lllllllllllllllllIllIIlIIlIllIII;
        }
        if (e.llIIlIllIlIII(Math.abs(lllllllllllllllllIllIIlIIlIlIllI), llllIIIIIl[0])) {
            int n5;
            if (e.llIIlIllIlIIl(R.nextBoolean() ? 1 : 0)) {
                n5 = lllllllllllllllllIllIIlIIlIllIII;
                "".length();
                if ((0x6D ^ 0x68) == 0) {
                    return (0x2D ^ 0x32) & ~(0x1D ^ 2);
                }
            } else {
                n5 = lllllllllllllllllIllIIlIIlIlIlll;
            }
            return n5;
        }
        if (e.llIIlIllIlIlI(lllllllllllllllllIllIIlIIlIlIllI)) {
            lllllllllllllllllIllIIlIIlIlIllI = lllllllllllllllllIllIIlIIlIllIII;
            lllllllllllllllllIllIIlIIlIllIII = lllllllllllllllllIllIIlIIlIlIlll;
            n3 = lllllllllllllllllIllIIlIIlIlIllI;
        }
    ...
    public static boolean x() {
        ...
        if (!e.llIIlIllIlIIl((Integer)GameThread.invokeLater(() -> Static.getClient().getVarbitValue(llllIIIIIl[10]))) || e.llIIlIllIIlll((Integer)GameThread.invokeLater(() -> Static.getClient().getVarbitValue(llllIIIIIl[15])))) {
            ...
            "".length();
            if (-" ".length() == "   ".length()) {
                return ((0x92 ^ 0x8A ^ (3 ^ 0x28)) & (0x5F ^ 0x38 ^ (0xFD ^ 0xA9) ^ -" ".length())) != 0;
            }
        } else {
            bl = llllIIIIIl[1];
        }
    ...
    public static void D() {
        if (e.llIIlIllIlIII(e.j(llllIIIIIl[48]), llllIIIIIl[0])) {
            Widget lllllllllllllllllIllIIlIIIIlIIlI;
            if (e.llIIlIllIIlll(Tabs.isOpen((Tab)Tab.COMBAT) ? 1 : 0)) {
                Tabs.open((Tab)Tab.COMBAT);
                Time.sleepTicks((int)llllIIIIIl[0]);
                "".length();
            }
            if (e.llIIlIllIlIIl(Tabs.isOpen((Tab)Tab.COMBAT) ? 1 : 0) && e.llIIlIllIlllI(lllllllllllllllllIllIIlIIIIlIIlI = Widgets.get((int)llllIIIIIl[49], (int)llllIIIIIl[50]))) {
                lllllllllllllllllIllIIlIIIIlIIlI.interact(lllIllllll[llllIIIIIl[52]]);
                Time.sleepTicks((int)llllIIIIIl[0]);
                "".length();
            }
        }
    ...
    private static String llIIlIlIlIlll(String lllllllllllllllllIllIIIllllIllII, String lllllllllllllllllIllIIIllllIIllI) {
        lllllllllllllllllIllIIIllllIllII = new String(Base64.getDecoder().decode(lllllllllllllllllIllIIIllllIllII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllIllIIIllllIlIlI = new StringBuilder();
        char[] lllllllllllllllllIllIIIllllIlIIl = lllllllllllllllllIllIIIllllIIllI.toCharArray();
        int lllllllllllllllllIllIIIllllIlIII = llllIIIIIl[1];
        char[] lllllllllllllllllIllIIIllllIIIlI = lllllllllllllllllIllIIIllllIllII.toCharArray();
        int lllllllllllllllllIllIIIllllIIIIl = lllllllllllllllllIllIIIllllIIIlI.length;
        int lllllllllllllllllIllIIIllllIIIII = llllIIIIIl[1];
        while (e.llIIlIllIlIll(lllllllllllllllllIllIIIllllIIIII, lllllllllllllllllIllIIIllllIIIIl)) {
            char lllllllllllllllllIllIIIllllIllIl = lllllllllllllllllIllIIIllllIIIlI[lllllllllllllllllIllIIIllllIIIII];
            lllllllllllllllllIllIIIllllIlIlI.append((char)(lllllllllllllllllIllIIIllllIllIl ^ lllllllllllllllllIllIIIllllIlIIl[lllllllllllllllllIllIIIllllIlIII % lllllllllllllllllIllIIIllllIlIIl.length]));
            "".length();
            ++lllllllllllllllllIllIIIllllIlIII;
            ++lllllllllllllllllIllIIIllllIIIII;
            "".length();
            if (((123 + 35 - 35 + 77 ^ 100 + 86 - 182 + 151) & (0xFF ^ 0xC0 ^ (0xE6 ^ 0x8A) ^ -" ".length())) < " ".length()) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllIllIIIllllIlIlI);
    }
    ...
    public static boolean b(int[] nArray) {
        int[] lllllllllllllllllIllIIlIIlIlIIll;
        int lllllllllllllllllIllIIlIIlIlIIlI = llllIIIIIl[1];
        while (e.llIIlIllIlIll(lllllllllllllllllIllIIlIIlIlIIlI, lllllllllllllllllIllIIlIIlIlIIll.length)) {
            if (e.llIIlIllIIlll(e.i(lllllllllllllllllIllIIlIIlIlIIll[lllllllllllllllllIllIIlIIlIlIIlI]) ? 1 : 0)) {
                System.out.println("Missing ID: " + lllllllllllllllllIllIIlIIlIlIIll[lllllllllllllllllIllIIlIIlIlIIlI]);
                return llllIIIIIl[1];
            }
            ++lllllllllllllllllIllIIlIIlIlIIlI;
            "".length();
            if ((0xFB ^ 0xBE ^ (0x3E ^ 0x7F)) != 0) continue;
            return ((0x60 ^ 0x49 ^ (0x27 ^ 0)) & (0x78 ^ 0x45 ^ (0xB0 ^ 0x83) ^ -" ".length())) != 0;
        }
        return llllIIIIIl[0];
    }
    ...
    private static void llIIlIllIIllI() {
        ...
        e.llllIIIIIl[0] = " ".length();
        e.llllIIIIIl[1] = (0x59 ^ 0x44 ^ (0x84 ^ 0xC0)) & (0x7C ^ 0x6F ^ (2 ^ 0x48) ^ -" ".length());
        e.llllIIIIIl[2] = "  ".length();
        e.llllIIIIIl[3] = 0x21 ^ 0x25;
        e.llllIIIIIl[4] = -(0xFFFF8D6F & 0x7FD3) & (0xFFFF8FFB & 0x7FDE);
        e.llllIIIIIl[5] = 0x7F ^ 0x62;
        e.llllIIIIIl[6] = "   ".length();
        ...
        e.llllIIIIIl[71] = "   ".length() ^ (0x62 ^ 0x4D);
        ...
        e.llllIIIIIl[158] = 0x12 ^ 0x2F ^ "   ".length();
    ...
    public static void l(int n2) {
        ...
        if (e.llIIlIllIlIIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (e.llIIlIllIIlll(Equipment.contains((int[])nArray2) ? 1 : 0)) {
                int lllllllllllllllllIllIIlIIIlllllI;
                ...
                nArray5[e.llllIIIIIl[1]] = lllllllllllllllllIllIIlIIIlllllI;
                String[] stringArray2 = new String[llllIIIIIl[0]];
                ...
                if (e.llIIlIllIlIIl(Inventory.getFirst((int[])nArray5).hasAction(stringArray2) ? 1 : 0)) {
                    ...
                    nArray6[e.llllIIIIIl[1]] = lllllllllllllllllIllIIlIIIlllllI;
                    Inventory.getFirst((int[])nArray6).interact(lllIllllll[llllIIIIIl[24]]);
                }
                int[] nArray7 = new int[llllIIIIIl[0]];
                nArray7[e.llllIIIIIl[1]] = lllllllllllllllllIllIIlIIIlllllI;
                String[] stringArray3 = new String[llllIIIIIl[0]];
                ...
                if (e.llIIlIllIlIIl(Inventory.getFirst((int[])nArray7).hasAction(stringArray3) ? 1 : 0)) {
                    ...
                    nArray8[e.llllIIIIIl[1]] = lllllllllllllllllIllIIlIIIlllllI;
                    Inventory.getFirst((int[])nArray8).interact(lllIllllll[llllIIIIIl[26]]);
                }
                if (e.llIIlIllIlIII(lllllllllllllllllIllIIlIIIlllllI, llllIIIIIl[27])) {
                    Time.sleepTicks((int)llllIIIIIl[6]);
                    "".length();
    ...
    public static void b(WorldPoint worldPoint) {
        ...
        int n2;
        int n3;
        int lllllllllllllllllIllIIlIIIIllIIl;
        void lllllllllllllllllIllIIlIIIIlllIl;
        WorldPoint lllllllllllllllllIllIIlIIIIllllI;
        Client client = Static.getClient();
        Player player = client.getLocalPlayer();
        if (e.llIIlIllIllIl(player)) {
            return;
        }
        WorldPoint lllllllllllllllllIllIIlIIIIllIll = lllllllllllllllllIllIIlIIIIllllI;
        int lllllllllllllllllIllIIlIIIIllIlI = lllllllllllllllllIllIIlIIIIllIll.getX() - lllllllllllllllllIllIIlIIIIlllIl.getBaseX();
        Point lllllllllllllllllIllIIlIIIIllIII = Perspective.localToCanvas((Client)lllllllllllllllllIllIIlIIIIlllIl, (LocalPoint)LocalPoint.fromScene((int)lllllllllllllllllIllIIlIIIIllIlI, (int)(lllllllllllllllllIllIIlIIIIllIIl = lllllllllllllllllIllIIlIIIIllIll.getY() - lllllllllllllllllIllIIlIIIIlllIl.getBaseY())), (int)lllllllllllllllllIllIIlIIIIlllIl.getPlane());
        if (e.llIIlIllIlllI(lllllllllllllllllIllIIlIIIIllIII)) {
            n3 = lllllllllllllllllIllIIlIIIIllIII.getX();
            "".length();
            if ("   ".length() == 0) {
                return;
            }
        } else {
            int lllllllllllllllllIllIIlIIIIlIlll;
            n3 = lllllllllllllllllIllIIlIIIIlIlll = llllIIIIIl[47];
        }
        if (e.llIIlIllIlllI(lllllllllllllllllIllIIlIIIIllIII)) {
            n2 = lllllllllllllllllIllIIlIIIIllIII.getY();
            "".length();
            if (" ".length() >= "  ".length()) {
                return;
            }
    ...
    public static void a(WorldPoint worldPoint) {
        void lllllllllllllllllIllIIlIIIllIllI;
        void lllllllllllllllllIllIIlIIIllIlll;
        void lllllllllllllllllIllIIlIIIlllIII;
        ...
        if (e.llIIlIllIllll(Players.getLocal().getWorldLocation().distanceTo(worldPoint2), llllIIIIIl[17]) && e.llIIlIllIIlll(worldArea.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && e.llIIlIllIIlll(worldArea2.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && e.llIIlIllIllll(Players.getLocal().getWorldLocation().distanceTo(new WorldPoint(llllIIIIIl[38], llllIIIIIl[39], llllIIIIIl[0])), llllIIIIIl[13])) {
            ...
            Movement.walkTo((WorldPoint)lllllllllllllllllIllIIlIIIlllIII);
            "".length();
            Time.sleepTicks((int)llllIIIIIl[0]);
            "".length();
        }
        if (e.llIIlIlllIIII(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllllllllllllllIllIIlIIIlllIII), llllIIIIIl[17]) && e.llIIlIlllIIII(Players.getLocal().getWorldLocation().getY(), llllIIIIIl[30])) {
            if (e.llIIlIllIIlll(Dialog.isOpen() ? 1 : 0)) {
                String[] stringArray = new String[llllIIIIIl[0]];
        ...
        if (e.llIIlIllIllll(Players.getLocal().getWorldLocation().getY(), llllIIIIIl[30]) && (!e.llIIlIllIIlll(lllllllllllllllllIllIIlIIIllIlll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !e.llIIlIllIIlll(lllllllllllllllllIllIIlIIIllIllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || e.llIIlIlllIIII(Players.getLocal().getWorldLocation().distanceTo(new WorldPoint(llllIIIIIl[38], llllIIIIIl[39], llllIIIIIl[0])), llllIIIIIl[13]))) {
            WorldPoint lllllllllllllllllIllIIlIIIlllIIl;
            ...
            Movement.walkTo((WorldPoint)lllllllllllllllllIllIIlIIIlllIIl);
            "".length();
            Time.sleepTicks((int)llllIIIIIl[0]);
            "".length();
        }
    ...
    public static void k(int n2) {
        if (e.llIIlIllIllII(Static.getClient().getWorld(), n2)) {
            void lllllllllllllllllIllIIlIIlIIlIll;
            ...
            World lllllllllllllllllIllIIlIIlIIlIlI = Static.getClient().createWorld();
            lllllllllllllllllIllIIlIIlIIlIlI.setActivity(lllllllllllllllllIllIIlIIlIIlIll.getActivity());
            lllllllllllllllllIllIIlIIlIIlIlI.setAddress(lllllllllllllllllIllIIlIIlIIlIll.getAddress());
            lllllllllllllllllIllIIlIIlIIlIlI.setId(lllllllllllllllllIllIIlIIlIIlIll.getId());
            lllllllllllllllllIllIIlIIlIIlIlI.setPlayerCount(lllllllllllllllllIllIIlIIlIIlIll.getPlayers());
            lllllllllllllllllIllIIlIIlIIlIlI.setLocation(lllllllllllllllllIllIIlIIlIIlIll.getLocation());
            lllllllllllllllllIllIIlIIlIIlIlI.setTypes(WorldUtil.toWorldTypes((EnumSet)lllllllllllllllllIllIIlIIlIIlIll.getTypes()));
            Worlds.hopTo((World)lllllllllllllllllIllIIlIIlIIlIlI);
        }
    }
}
