...
implements S {
    ...
    private static String llIIllIllIIlI(String lllllllllllllllllIlIlIllIlIIlllI, String lllllllllllllllllIlIlIllIlIIlIll) {
        try {
            SecretKeySpec lllllllllllllllllIlIlIllIlIlIIIl = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIlIlIllIlIIlIll.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllllIlIlIllIlIlIIII = Cipher.getInstance("Blowfish");
            lllllllllllllllllIlIlIllIlIlIIII.init(llllIlIlII[2], lllllllllllllllllIlIlIllIlIlIIIl);
            return new String(lllllllllllllllllIlIlIllIlIlIIII.doFinal(Base64.getDecoder().decode(lllllllllllllllllIlIlIllIlIIlllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static boolean aa() {
        void lllllllllllllllllIlIlIllIlllllII;
        ...
        int[] nArray2 = nArray;
        int lllllllllllllllllIlIlIllIllllIll = llllIlIlII[0];
        while (D.llIIllllIllIl(lllllllllllllllllIlIlIllIllllIll, ((void)lllllllllllllllllIlIlIllIlllllII).length)) {
            int[] nArray3 = new int[llllIlIlII[1]];
            nArray3[D.llllIlIlII[0]] = lllllllllllllllllIlIlIllIlllllII[lllllllllllllllllIlIlIllIllllIll];
            if (D.llIIllllIlllI(Inventory.contains((int[])nArray3) ? 1 : 0)) {
                return llllIlIlII[0];
            }
            ++lllllllllllllllllIlIlIllIllllIll;
            "".length();
            if ("   ".length() != 0) continue;
            return ((0x1C ^ 0x2D) & ~(0x19 ^ 0x28)) != 0;
        }
        return llllIlIlII[1];
    }
    ...
    private static void ae() {
        block50: {
            d lllllllllllllllllIlIlIllIlllIlll;
            block49: {
                block48: {
                    block47: {
                        block46: {
                            block45: {
                                Object lllllllllllllllllIlIlIllIllllIII;
                                block44: {
                                    block43: {
                                        block42: {
                                            block41: {
                                                block40: {
                                                    block39: {
                                                        block38: {
                                                            block37: {
                                                                block36: {
                                                                    ...
                                                                    lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[27], llllIlIlII[7], llllIlIlII[309]);
                                                                    bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                                                    "".length();
                                                                }
                                                                int[] nArray = new int[llllIlIlII[1]];
                                                            ...
                                                            lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[35], llllIlIlII[63], llllIlIlII[309]);
                                                            bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                                            "".length();
                                                        }
                                                        int[] nArray = new int[llllIlIlII[1]];
                                                        ...
                                                        if (D.llIIllllIlllI(Bank.contains((int[])nArray) ? 1 : 0)) {
                                                            lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[39], llllIlIlII[1], llllIlIlII[310]);
                                                            bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                                            "".length();
                                                        }
                                                        ...
                                                        if (D.llIIllllIlllI(Bank.contains((int[])nArray6) ? 1 : 0)) {
                                                            lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[41], llllIlIlII[1], llllIlIlII[311]);
                                                            bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                                            "".length();
                                                        }
                                                        ...
                                                        if (D.llIIllllIlllI(Bank.contains((int[])nArray7) ? 1 : 0)) {
                                                            lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[44], llllIlIlII[1], llllIlIlII[312]);
                                                            bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                                            "".length();
                                                        }
                                                        ...
                                                        if (D.llIIllllIlllI(Bank.contains((int[])nArray8) ? 1 : 0)) {
                                                            lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[42], llllIlIlII[7], llllIlIlII[310]);
                                                            bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                                            "".length();
                                                        }
                                                    ...
                                                    lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[24], llllIlIlII[25], llllIlIlII[309]);
                                                    bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                                    "".length();
                                                }
                                                int[] nArray = new int[llllIlIlII[1]];
                                                ...
                                                if (D.llIIllllIlllI(Bank.contains((int[])nArray) ? 1 : 0)) {
                                                    lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[36], llllIlIlII[1], i.bp);
                                                    bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                                    "".length();
                                                }
                                                ...
                                                if (D.llIIllllIlllI(Bank.contains((int[])nArray12) ? 1 : 0)) {
                                                    lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[34], llllIlIlII[1], i.bp);
                                                    bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                                    "".length();
                                                }
                                                ...
                                                if (D.llIIllllIlllI(Bank.contains((int[])nArray13) ? 1 : 0)) {
                                                    lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[33], llllIlIlII[1], i.bp);
                                                    bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                                    "".length();
                                                }
                                                ...
                                                if (D.llIIllllIlllI(Bank.contains((int[])nArray14) ? 1 : 0)) {
                                                    lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[32], llllIlIlII[1], i.bp);
                                                    bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                                    "".length();
                                                }
                                                ...
                                                if (D.llIIllllIlllI(Bank.contains((int[])nArray15) ? 1 : 0)) {
                                                    lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[30], llllIlIlII[1], i.bp);
                                                    bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                                    "".length();
                                                }
                                                ...
                                                if (D.llIIllllIlllI(Bank.contains((int[])nArray16) ? 1 : 0)) {
                                                    lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[31], llllIlIlII[1], i.bp);
                                                    bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                                    "".length();
                                                }
                                            ...
                                            lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[37], llllIlIlII[23], i.bp);
                                            bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                            "".length();
                                        }
                                        int[] nArray = new int[llllIlIlII[1]];
                                    ...
                                    lllllllllllllllllIlIlIllIllllIII = new d(llllIlIlII[45], llllIlIlII[23], llllIlIlII[47]);
                                    bu.add((d)lllllllllllllllllIlIlIllIllllIII);
                                    "".length();
                                }
                                if (D.llIIllllIlllI(Bank.contains((Predicate)(lllllllllllllllllIlIlIllIllllIII = item -> item.getName().toLowerCase().contains(llllIIllII[llllIlIlII[316]]))) ? 1 : 0)) {
                                    lllllllllllllllllIlIlIllIlllIlll = new d(llllIlIlII[313], llllIlIlII[11], llllIlIlII[311]);
                                    bu.add(lllllllllllllllllIlIlIllIlllIlll);
                                    "".length();
                                }
                                int[] nArray = new int[llllIlIlII[1]];
                                nArray[D.llllIlIlII[0]] = llllIlIlII[19];
                            ...
                            lllllllllllllllllIlIlIllIlllIlll = new d(llllIlIlII[19], llllIlIlII[10], llllIlIlII[314]);
                            bu.add(lllllllllllllllllIlIlIllIlllIlll);
                            "".length();
                        }
                        int[] nArray = new int[llllIlIlII[1]];
                    ...
                    lllllllllllllllllIlIlIllIlllIlll = new d(llllIlIlII[22], llllIlIlII[10], llllIlIlII[314]);
                    bu.add(lllllllllllllllllIlIlIllIlllIlll);
                    "".length();
                }
                int[] nArray = new int[llllIlIlII[1]];
            ...
            lllllllllllllllllIlIlIllIlllIlll = new d(llllIlIlII[21], llllIlIlII[10], llllIlIlII[314]);
            bu.add(lllllllllllllllllIlIlIllIlllIlll);
            "".length();
        }
    }
    ...
    private static void ci() {
        void lllllllllllllllllIlIlIllIlllllll;
        ...
        if (D.llIIlllllIIlI(lllllllllllllllllIlIlIllIlllllll) && D.llIIllllIllII(lllllllllllllllllIlIlIllIlllllll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String llIIllIllIlII(String lllllllllllllllllIlIlIllIIlllIIl, String lllllllllllllllllIlIlIllIIlllIII) {
        lllllllllllllllllIlIlIllIIlllIIl = new String(Base64.getDecoder().decode(lllllllllllllllllIlIlIllIIlllIIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllIlIlIllIIllllII = new StringBuilder();
        char[] lllllllllllllllllIlIlIllIIlllIll = lllllllllllllllllIlIlIllIIlllIII.toCharArray();
        int lllllllllllllllllIlIlIllIIlllIlI = llllIlIlII[0];
        char[] lllllllllllllllllIlIlIllIIllIlII = lllllllllllllllllIlIlIllIIlllIIl.toCharArray();
        int lllllllllllllllllIlIlIllIIllIIll = lllllllllllllllllIlIlIllIIllIlII.length;
        int lllllllllllllllllIlIlIllIIllIIlI = llllIlIlII[0];
        while (D.llIIllllIllIl(lllllllllllllllllIlIlIllIIllIIlI, lllllllllllllllllIlIlIllIIllIIll)) {
            char lllllllllllllllllIlIlIllIIllllll = lllllllllllllllllIlIlIllIIllIlII[lllllllllllllllllIlIlIllIIllIIlI];
            lllllllllllllllllIlIlIllIIllllII.append((char)(lllllllllllllllllIlIlIllIIllllll ^ lllllllllllllllllIlIlIllIIlllIll[lllllllllllllllllIlIlIllIIlllIlI % lllllllllllllllllIlIlIllIIlllIll.length]));
            "".length();
            ++lllllllllllllllllIlIlIllIIlllIlI;
            ++lllllllllllllllllIlIlIllIIllIIlI;
            "".length();
            if ((112 + 115 - 132 + 53 ^ 116 + 102 - 112 + 38) >= 0) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllIlIlIllIIllllII);
    }
    ...
    public static void cf() {
        block211: {
            WorldPoint lllllllllllllllllIlIlIlllIIIlllI;
            WorldPoint lllllllllllllllllIlIlIlllIIIllll;
            BankLocation lllllllllllllllllIlIlIlllIIlIIII;
            block217: {
                block219: {
                    block221: {
                        block220: {
                            block218: {
                                        ...
                                        block214: {
                                            block215: {
                                                block213: {
                                                    ...
                                                    lllllllllllllllllIlIlIlllIIlIIII = BankLocation.getNearest();
                                                    if (D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIlIIII) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIlIIII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                                        AccBuilderTempleTrek.c = llllIIllII[llllIlIlII[16]];
                                                        Movement.walkTo((BankLocation)lllllllllllllllllIlIlIlllIIlIIII);
                                                        "".length();
                                                        Time.sleepTicks((int)llllIlIlII[2]);
                                                        "".length();
                                                    }
                                                    if (!D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIlIIII) || !D.llIIllllIllII(lllllllllllllllllIlIlIlllIIlIIII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block212;
                                ...
                                if (D.llIIlllllIlIl(e.j(llllIlIlII[14]), llllIlIlII[1]) && D.llIIllllIllII(D.aa() ? 1 : 0)) {
                                    lllllllllllllllllIlIlIlllIIlIIII = new WorldPoint(llllIlIlII[48], llllIlIlII[49], llllIlIlII[0]);
                                    if (D.llIIlllllIIll(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllllllllllllllIlIlIlllIIlIIII), llllIlIlII[16])) {
                                        AccBuilderTempleTrek.c = llllIIllII[llllIlIlII[29]];
                                        Movement.walkTo((WorldPoint)lllllllllllllllllIlIlIlllIIlIIII);
                                        "".length();
                                        Time.sleepTicks((int)llllIlIlII[1]);
                                        "".length();
                                    }
                                    if (D.llIIlllllIlII(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllllllllllllllIlIlIlllIIlIIII), llllIlIlII[16])) {
                ...
                if ((D.llIIllllIlllI(Vars.getBit((int)llllIlIlII[54])) && D.llIIllllIlllI(Vars.getBit((int)llllIlIlII[67])) && !D.llIIllllIllII(Vars.getBit((int)llllIlIlII[62])) || D.llIIlllllIlIl(e.j(llllIlIlII[72]), llllIlIlII[20])) && D.llIIllllIlllI(Vars.getBit((int)llllIlIlII[73]))) {
                    ...
                    if (D.llIIllllIllII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                        lllllllllllllllllIlIlIlllIIlIIII = new WorldPoint(llllIlIlII[75], llllIlIlII[76], llllIlIlII[0]);
                ...
                if (D.llIIlllllIlIl(Vars.getBit((int)llllIlIlII[73]), llllIlIlII[1]) && (!D.llIIllllIllII(Vars.getBit((int)llllIlIlII[81])) || D.llIIllllIlllI(gR ? 1 : 0))) {
                    ...
                    if (D.llIIllllIllII(Inventory.contains((String[])stringArray6) ? 1 : 0)) {
                        lllllllllllllllllIlIlIlllIIlIIII = new WorldPoint(llllIlIlII[85], llllIlIlII[86], llllIlIlII[0]);
                        if (D.llIIlllllIIll(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllllllllllllllIlIlIlllIIlIIII), llllIlIlII[9]) && D.llIIllllIlllI(Vars.getBit((int)llllIlIlII[81]))) {
                        ...
                        if (D.llIIlllllIlII(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllllllllllllllIlIlIlllIIlIIII), llllIlIlII[23])) {
                            ...
                            if (D.llIIlllllIlIl(Vars.getBit((int)llllIlIlII[81]), llllIlIlII[1])) {
                                ...
                                lllllllllllllllllIlIlIlllIIIllll = TileObjects.getNearest((String[])stringArray31);
                                if (D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIIllll) && D.llIIllllIlllI(gR ? 1 : 0)) {
                                    if (D.llIIllllIlllI(Reachable.isInteractable((Locatable)lllllllllllllllllIlIlIlllIIIllll) ? 1 : 0)) {
                                    ...
                                    if (D.llIIllllIllII(Reachable.isInteractable((Locatable)lllllllllllllllllIlIlIlllIIIllll) ? 1 : 0) && D.llIIllllIlllI(Dialog.isOpen() ? 1 : 0)) {
                                        String[] stringArray33 = new String[llllIlIlII[1]];
                                        stringArray33[D.llllIlIlII[0]] = llllIIllII[llllIlIlII[115]];
                                        if (D.llIIllllIllII(lllllllllllllllllIlIlIlllIIIllll.hasAction(stringArray33) ? 1 : 0)) {
                                            lllllllllllllllllIlIlIlllIIIllll.interact(llllIIllII[llllIlIlII[116]]);
                                            Time.sleepTicks((int)llllIlIlII[9]);
                                            "".length();
                                        }
                                        String[] stringArray34 = new String[llllIlIlII[1]];
                                        stringArray34[D.llllIlIlII[0]] = llllIIllII[llllIlIlII[117]];
                                        if (D.llIIllllIllII(lllllllllllllllllIlIlIlllIIIllll.hasAction(stringArray34) ? 1 : 0)) {
                                            lllllllllllllllllIlIlIlllIIIllll.interact(llllIIllII[llllIlIlII[118]]);
                                            Time.sleepTicks((int)llllIlIlII[9]);
                                            "".length();
                                        }
                                    }
                ...
                if (D.llIIlllllIlIl(Vars.getBit((int)llllIlIlII[81]), llllIlIlII[1]) && D.llIIllllIlllI(gR ? 1 : 0)) {
                    ...
                    lllllllllllllllllIlIlIlllIIlIIII = TileObjects.getNearest((String[])stringArray46);
                    if (D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIlIIII) && D.llIIllllIlllI(gR ? 1 : 0)) {
                        if (D.llIIllllIlllI(Reachable.isInteractable((Locatable)lllllllllllllllllIlIlIlllIIlIIII) ? 1 : 0)) {
                        ...
                        if (D.llIIllllIllII(Reachable.isInteractable((Locatable)lllllllllllllllllIlIlIlllIIlIIII) ? 1 : 0) && D.llIIllllIlllI(Dialog.isOpen() ? 1 : 0)) {
                            String[] stringArray48 = new String[llllIlIlII[1]];
                            stringArray48[D.llllIlIlII[0]] = llllIIllII[llllIlIlII[133]];
                            if (D.llIIllllIllII(lllllllllllllllllIlIlIlllIIlIIII.hasAction(stringArray48) ? 1 : 0)) {
                                lllllllllllllllllIlIlIlllIIlIIII.interact(llllIIllII[llllIlIlII[134]]);
                                Time.sleepTicks((int)llllIlIlII[9]);
                                "".length();
                            }
                            String[] stringArray49 = new String[llllIlIlII[1]];
                            stringArray49[D.llllIlIlII[0]] = llllIIllII[llllIlIlII[135]];
                            if (D.llIIllllIllII(lllllllllllllllllIlIlIlllIIlIIII.hasAction(stringArray49) ? 1 : 0)) {
                                lllllllllllllllllIlIlIlllIIlIIII.interact(llllIIllII[llllIlIlII[136]]);
                                Time.sleepTicks((int)llllIlIlII[9]);
                                "".length();
                            }
                        }
                ...
                if (D.llIIllllIllII(gR ? 1 : 0) && D.llIIllllIlllI(gS ? 1 : 0)) {
                    ...
                    lllllllllllllllllIlIlIlllIIIllll = new WorldPoint(llllIlIlII[138], llllIlIlII[139], llllIlIlII[0]);
                    if (D.llIIllllIlllI(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIlIlllIIIllll) ? 1 : 0)) {
                        AccBuilderTempleTrek.c = llllIIllII[llllIlIlII[140]];
                        if (D.llIIllllIlllI(Dialog.isOpen() ? 1 : 0)) {
                            Movement.walkTo((WorldPoint)lllllllllllllllllIlIlIlllIIIllll);
                            "".length();
                            Time.sleepTicks((int)llllIlIlII[1]);
                            "".length();
                        }
                    ...
                    if (D.llIIllllIllII(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIlIlllIIIllll) ? 1 : 0)) {
                ...
                if (D.llIIllllIllII(gR ? 1 : 0) && D.llIIllllIllII(gS ? 1 : 0) && D.llIIllllIlllI(gT ? 1 : 0)) {
                    TileObject lllllllllllllllllIlIlIlllIIIlIlI;
                    TileObject lllllllllllllllllIlIlIlllIIIlIll;
                    WorldArea lllllllllllllllllIlIlIlllIIIllII;
                    String[] stringArray = new String[llllIlIlII[1]];
                    ...
                    lllllllllllllllllIlIlIlllIIlIIII = new WorldArea(llllIlIlII[149], llllIlIlII[150], llllIlIlII[51], llllIlIlII[10], llllIlIlII[0]);
                    lllllllllllllllllIlIlIlllIIIllll = new WorldArea(llllIlIlII[151], llllIlIlII[152], llllIlIlII[58], llllIlIlII[58], llllIlIlII[0]);
                    if (D.llIIllllIlllI(Players.getLocal().getWorldLocation().getPlane()) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIlIIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIllll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        lllllllllllllllllIlIlIlllIIIlllI = new WorldPoint(llllIlIlII[153], llllIlIlII[154], llllIlIlII[0]);
                        if (D.llIIlllllIIll(Players.getLocal().getWorldLocation().distanceTo(lllllllllllllllllIlIlIlllIIIlllI), llllIlIlII[2])) {
                            AccBuilderTempleTrek.c = llllIIllII[llllIlIlII[155]];
                            Movement.walkTo((WorldPoint)lllllllllllllllllIlIlIlllIIIlllI);
                            "".length();
                            Time.sleepTicks((int)llllIlIlII[1]);
                            "".length();
                        }
                        if (D.llIIlllllIlII(Players.getLocal().getWorldLocation().distanceTo(lllllllllllllllllIlIlIlllIIIlllI), llllIlIlII[2])) {
                    ...
                    lllllllllllllllllIlIlIlllIIIlllI = new WorldArea(llllIlIlII[158], llllIlIlII[159], llllIlIlII[11], llllIlIlII[16], llllIlIlII[0]);
                    WorldArea lllllllllllllllllIlIlIlllIIIllIl = new WorldArea(llllIlIlII[160], llllIlIlII[161], llllIlIlII[13], llllIlIlII[7], llllIlIlII[0]);
                    if (D.llIIllllIlllI(Players.getLocal().getWorldLocation().getPlane()) && D.llIIllllIllII(lllllllllllllllllIlIlIlllIIlIIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        int[] nArray = new int[llllIlIlII[1]];
                        nArray[D.llllIlIlII[0]] = llllIlIlII[162];
                        if (D.llIIllllIlllI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            int[] nArray15 = new int[llllIlIlII[1]];
                            nArray15[D.llllIlIlII[0]] = llllIlIlII[162];
                            if (D.llIIlllllIlll(TileItems.getNearest((int[])nArray15)) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIllIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIlllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.llIIllllIlllI(new WorldArea(llllIlIlII[163], llllIlIlII[164], llllIlIlII[26], llllIlIlII[12], llllIlIlII[0]).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (D.llIIllllIllII(Inventory.contains((int[])nArray19) ? 1 : 0) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIlllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIllIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            lllllllllllllllllIlIlIlllIIIllII = new WorldPoint(llllIlIlII[169], llllIlIlII[170], llllIlIlII[0]);
                            if (D.llIIllllIlllI(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIlIlllIIIllII) ? 1 : 0)) {
                                AccBuilderTempleTrek.c = llllIIllII[llllIlIlII[171]];
                                e.b((WorldPoint)lllllllllllllllllIlIlIlllIIIllII);
                                Time.sleepTicks((int)llllIlIlII[2]);
                                "".length();
                            }
                            if (D.llIIllllIllII(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIlIlllIIIllII) ? 1 : 0)) {
                        ...
                        if (!D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIlllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || D.llIIllllIllII(lllllllllllllllllIlIlIlllIIIllIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            lllllllllllllllllIlIlIlllIIIllII = TileObjects.getNearest(tileObject -> {
                                int n2;
                                if (D.llIIllllIllII(tileObject.getName().contains(llllIIllII[llllIlIlII[334]]) ? 1 : 0) && D.llIIllllIllII(Reachable.isInteractable((Locatable)tileObject) ? 1 : 0)) {
                                    n2 = llllIlIlII[1];
                                    "".length();
                                    if ((132 + 76 - 90 + 21 ^ 20 + 56 - -3 + 64) == -" ".length()) {
                                        return ((69 + 35 - 82 + 208 ^ 39 + 160 - 126 + 108) & (0x12 ^ 0x69 ^ (0xE8 ^ 0xC0) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    n2 = llllIlIlII[0];
                                }
                            ...
                            if (D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIIllII)) {
                                lllllllllllllllllIlIlIlllIIIllII.interact(llllIIllII[llllIlIlII[175]]);
                                Time.sleepTicks((int)llllIlIlII[7]);
                                "".length();
                            }
                        }
                    ...
                    if (D.llIIlllllIlIl(Players.getLocal().getWorldLocation().getPlane(), llllIlIlII[1]) && D.llIIllllIlllI(new WorldArea(llllIlIlII[176], llllIlIlII[177], llllIlIlII[11], llllIlIlII[13], llllIlIlII[1]).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (D.llIIllllIlllI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (D.llIIlllllIlll(TileItems.getNearest((int[])nArray20))) {
                                ...
                                lllllllllllllllllIlIlIlllIIIllII = NPCs.getNearest(nPC -> {
                                    int n2;
                                ...
                                if (D.llIIlllllIlll(Players.getLocal().getInteracting()) && D.llIIlllllIlll(lllllllllllllllllIlIlIlllIIIllII)) {
                                    int[] nArray21 = new int[llllIlIlII[1]];
                        ...
                        lllllllllllllllllIlIlIlllIIIllII = new WorldArea(llllIlIlII[183], llllIlIlII[184], llllIlIlII[12], llllIlIlII[11], llllIlIlII[1]);
                        int[] nArray24 = new int[llllIlIlII[1]];
                        nArray24[D.llllIlIlII[0]] = llllIlIlII[178];
                        if (D.llIIllllIllII(Inventory.contains((int[])nArray24) ? 1 : 0) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIllII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            lllllllllllllllllIlIlIlllIIIlIll = new WorldPoint(llllIlIlII[163], llllIlIlII[170], llllIlIlII[1]);
                            if (D.llIIllllIlllI(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIlIlllIIIlIll) ? 1 : 0)) {
                                AccBuilderTempleTrek.c = llllIIllII[llllIlIlII[185]];
                                e.b((WorldPoint)lllllllllllllllllIlIlIlllIIIlIll);
                                Time.sleepTicks((int)llllIlIlII[2]);
                                "".length();
                            }
                            if (D.llIIllllIllII(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIlIlllIIIlIll) ? 1 : 0)) {
                        ...
                        if (D.llIIllllIllII(lllllllllllllllllIlIlIlllIIIllII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIIlIll = TileObjects.getNearest(tileObject -> {
                            int n2;
                            if (D.llIIllllIllII(tileObject.getName().contains(llllIIllII[llllIlIlII[332]]) ? 1 : 0) && D.llIIllllIllII(Reachable.isInteractable((Locatable)tileObject) ? 1 : 0)) {
                                n2 = llllIlIlII[1];
                                "".length();
                                if (((0x50 ^ 0x65 ^ (0xF1 ^ 0xA6)) & (0xEA ^ 0xA8 ^ (0x58 ^ 0x78) ^ -" ".length())) != 0) {
                                    return ((0x28 ^ 0x14 ^ (0x3D ^ 0xB)) & (0x20 ^ 0x43 ^ (0x60 ^ 9) ^ -" ".length())) != 0;
                                }
                            } else {
                                n2 = llllIlIlII[0];
                            }
                            ...
                            lllllllllllllllllIlIlIlllIIIlIll.interact(llllIIllII[llllIlIlII[188]]);
                            Time.sleepTicks((int)llllIlIlII[7]);
                            "".length();
                        }
                    }
                    if (D.llIIlllllIlIl(Players.getLocal().getWorldLocation().getPlane(), llllIlIlII[2])) {
                                ...
                                lllllllllllllllllIlIlIlllIIIllII = NPCs.getNearest(nPC -> {
                                    ...
                                    if (D.llIIllllIllII(nPC.getName().contains(llllIIllII[llllIlIlII[331]]) ? 1 : 0) && D.llIIllllllIII(nPC.getInteracting(), Players.getLocal()) && D.llIIlllllIlII(nPC.getWorldLocation().distanceTo(Players.getLocal().getWorldLocation()), llllIlIlII[1])) {
                                        ...
                                        if ((0x3D ^ 0x5C ^ (0xC0 ^ 0xA5)) == 0) {
                                            return ((0x5E ^ 0x17 ^ (5 ^ 0xC)) & (208 + 246 - 451 + 249 ^ 73 + 24 - -28 + 63 ^ -" ".length())) != 0;
                                        }
                                    } else {
                                        n2 = llllIlIlII[0];
                                    }
                        ...
                        lllllllllllllllllIlIlIlllIIIllII = new WorldArea(llllIlIlII[149], llllIlIlII[164], llllIlIlII[10], llllIlIlII[38], llllIlIlII[2]);
                        int[] nArray29 = new int[llllIlIlII[1]];
                        nArray29[D.llllIlIlII[0]] = llllIlIlII[189];
                        if (D.llIIllllIllII(Inventory.contains((int[])nArray29) ? 1 : 0) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIllII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            lllllllllllllllllIlIlIlllIIIlIll = new WorldPoint(llllIlIlII[194], llllIlIlII[159], llllIlIlII[2]);
                            if (D.llIIllllIlllI(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIlIlllIIIlIll) ? 1 : 0)) {
                        ...
                        if (D.llIIllllIllII(lllllllllllllllllIlIlIlllIIIllII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIIlIll = TileObjects.getNearest(tileObject -> {
                            ...
                            if (D.llIIllllIllII(tileObject.getName().contains(llllIIllII[llllIlIlII[330]]) ? 1 : 0) && D.llIIllllIllII(Reachable.isInteractable((Locatable)tileObject) ? 1 : 0)) {
                                n2 = llllIlIlII[1];
                                "".length();
                                if (" ".length() > (13 + 128 - 110 + 141 ^ 36 + 114 - 105 + 123)) {
                                    return ((93 + 40 - 36 + 75 ^ 92 + 10 - -33 + 43) & (0x3A ^ 0x75 ^ (0xC7 ^ 0x96) ^ -" ".length())) != 0;
                                }
                            } else {
                                n2 = llllIlIlII[0];
                            }
                            ...
                            lllllllllllllllllIlIlIlllIIIlIll.interact(llllIIllII[llllIlIlII[198]]);
                            Time.sleepTicks((int)llllIlIlII[7]);
                            "".length();
                        }
                    }
                    if ((!D.llIIllllIlllI((lllllllllllllllllIlIlIlllIIIllII = new WorldArea(llllIlIlII[176], llllIlIlII[177], llllIlIlII[11], llllIlIlII[13], llllIlIlII[1])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || D.llIIllllIllII(Players.getLocal().getWorldLocation().equals((Object)new WorldPoint(llllIlIlII[199], llllIlIlII[200], llllIlIlII[1])) ? 1 : 0)) && D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIIlIll = TileObjects.getNearest(tileObject -> {
                        int n2;
                        if (D.llIIllllIllII(tileObject.getName().contains(llllIIllII[llllIlIlII[328]]) ? 1 : 0) && D.llIIllllIllII(Reachable.isInteractable((Locatable)tileObject) ? 1 : 0)) {
                            ...
                            if (D.llIIllllIllII(tileObject.hasAction(stringArray) ? 1 : 0)) {
                                ...
                                return ((0x8E ^ 0x8B) & ~(0x8B ^ 0x8E)) != 0;
                            }
                        }
                        n2 = llllIlIlII[0];
                        return n2 != 0;
                    }))) {
                        lllllllllllllllllIlIlIlllIIIlIll.interact(llllIIllII[llllIlIlII[201]]);
                        Time.sleepTicks((int)llllIlIlII[7]);
                        "".length();
                    }
                    if (D.llIIllllIllII((lllllllllllllllllIlIlIlllIIIlIll = new WorldArea(llllIlIlII[163], llllIlIlII[164], llllIlIlII[26], llllIlIlII[12], llllIlIlII[0])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIIlIlI = TileObjects.getNearest(tileObject -> {
                        int n2;
                        if (D.llIIllllIllII(tileObject.getName().contains(llllIIllII[llllIlIlII[326]]) ? 1 : 0) && D.llIIllllIllII(Reachable.isInteractable((Locatable)tileObject) ? 1 : 0)) {
                            ...
                            if (D.llIIllllIllII(tileObject.hasAction(stringArray) ? 1 : 0)) {
                                ...
                                return ((0xF3 ^ 0xC5) & ~(0x4A ^ 0x7C)) != 0;
                            }
                        }
                        n2 = llllIlIlII[0];
                        return n2 != 0;
                    }))) {
                        lllllllllllllllllIlIlIlllIIIlIlI.interact(llllIIllII[llllIlIlII[202]]);
                        Time.sleepTicks((int)llllIlIlII[7]);
                        "".length();
                    }
                    lllllllllllllllllIlIlIlllIIIlIlI = new WorldArea(llllIlIlII[194], llllIlIlII[203], llllIlIlII[43], llllIlIlII[9], llllIlIlII[0]);
                    WorldArea lllllllllllllllllIlIlIlllIIIlIIl = new WorldArea(llllIlIlII[204], llllIlIlII[205], llllIlIlII[13], llllIlIlII[23], llllIlIlII[0]);
                    WorldArea lllllllllllllllllIlIlIlllIIIlIII = new WorldArea(llllIlIlII[169], llllIlIlII[206], llllIlIlII[11], llllIlIlII[17], llllIlIlII[0]);
                    if (D.llIIllllIllII(lllllllllllllllllIlIlIlllIIIllll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        WorldPoint lllllllllllllllllIlIlIlllIIIIlIl;
                        WorldPoint lllllllllllllllllIlIlIlllIIIIllI;
                        WorldArea lllllllllllllllllIlIlIlllIIIIlll;
                        int[] nArray = new int[llllIlIlII[1]];
                        nArray[D.llllIlIlII[0]] = llllIlIlII[207];
                        if (D.llIIllllIlllI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            int[] nArray30 = new int[llllIlIlII[1]];
                            nArray30[D.llllIlIlII[0]] = llllIlIlII[207];
                            if (D.llIIlllllIlll(TileItems.getNearest((int[])nArray30)) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIlIlI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIlIIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIlIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                AccBuilderTempleTrek.c = llllIIllII[llllIlIlII[208]];
                                lllllllllllllllllIlIlIlllIIIIlll = NPCs.getNearest(nPC -> {
                                    int n2;
                                    if (D.llIIllllIllII(nPC.getName().contains(llllIIllII[llllIlIlII[325]]) ? 1 : 0) && D.llIIllllllIII(nPC.getInteracting(), Players.getLocal()) && D.llIIlllllIlII(nPC.getWorldLocation().distanceTo(Players.getLocal().getWorldLocation()), llllIlIlII[1])) {
                                        ...
                                        "".length();
                                        if (" ".length() < 0) {
                                            return ((0x8F ^ 0xC7 ^ (0x59 ^ 0x73)) & (188 + 184 - 334 + 159 ^ 6 + 144 - 8 + 25 ^ -" ".length())) != 0;
                                        }
                                    } else {
                                        n2 = llllIlIlII[0];
                                    }
                                ...
                                if (D.llIIlllllIlll(Players.getLocal().getInteracting()) && D.llIIlllllIlll(lllllllllllllllllIlIlIlllIIIIlll)) {
                        ...
                        lllllllllllllllllIlIlIlllIIIIlll = new WorldArea(llllIlIlII[169], llllIlIlII[206], llllIlIlII[11], llllIlIlII[17], llllIlIlII[0]);
                        int[] nArray34 = new int[llllIlIlII[1]];
                        nArray34[D.llllIlIlII[0]] = llllIlIlII[207];
                        if (D.llIIllllIllII(Inventory.contains((int[])nArray34) ? 1 : 0) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIIlll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            lllllllllllllllllIlIlIlllIIIIllI = new WorldPoint(llllIlIlII[183], llllIlIlII[212], llllIlIlII[0]);
                            if (D.llIIllllIlllI(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIlIlllIIIIllI) ? 1 : 0)) {
                                AccBuilderTempleTrek.c = llllIIllII[llllIlIlII[213]];
                                e.b(lllllllllllllllllIlIlIlllIIIIllI);
                                Time.sleepTicks((int)llllIlIlII[2]);
                                "".length();
                            }
                            if (D.llIIllllIllII(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIlIlllIIIIllI) ? 1 : 0)) {
                        ...
                        if (D.llIIllllIllII(lllllllllllllllllIlIlIlllIIIIlll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            lllllllllllllllllIlIlIlllIIIIllI = new WorldArea(llllIlIlII[169], llllIlIlII[206], llllIlIlII[11], llllIlIlII[17], llllIlIlII[0]);
                            int[] nArray40 = new int[llllIlIlII[1]];
                            nArray40[D.llllIlIlII[0]] = llllIlIlII[216];
                            if (D.llIIllllIllII(Inventory.contains((int[])nArray40) ? 1 : 0) && D.llIIllllIllII(lllllllllllllllllIlIlIlllIIIIllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIlIIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIlIlI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                lllllllllllllllllIlIlIlllIIIIlIl = new WorldPoint(llllIlIlII[221], llllIlIlII[222], llllIlIlII[0]);
                                if (D.llIIllllIlllI(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIlIlllIIIIlIl) ? 1 : 0)) {
                                    AccBuilderTempleTrek.c = llllIIllII[llllIlIlII[223]];
                                    e.b(lllllllllllllllllIlIlIlllIIIIlIl);
                                    Time.sleepTicks((int)llllIlIlII[2]);
                                    "".length();
                                }
                                if (D.llIIllllIllII(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIlIlllIIIIlIl) ? 1 : 0)) {
                        ...
                        if (!D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIIlIlI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || D.llIIllllIllII(lllllllllllllllllIlIlIlllIIIlIIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            String[] stringArray57 = new String[llllIlIlII[1]];
                            stringArray57[D.llllIlIlII[0]] = llllIIllII[llllIlIlII[226]];
                            lllllllllllllllllIlIlIlllIIIIllI = NPCs.getNearest((String[])stringArray57);
                            if (D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIIIllI)) {
                                ...
                                if (D.llIIllllIlllI(Inventory.contains((int[])nArray41) ? 1 : 0) && D.llIIlllllIlll(Players.getLocal().getInteracting())) {
                                    ...
                                    lllllllllllllllllIlIlIlllIIIIllI.interact(llllIIllII[llllIlIlII[228]]);
                                    Time.sleepTicks((int)llllIlIlII[7]);
                                    "".length();
                                }
                            }
                            ...
                            if (D.llIIllllIllII(Inventory.contains((int[])nArray44) ? 1 : 0)) {
                                lllllllllllllllllIlIlIlllIIIIlIl = new WorldPoint(llllIlIlII[176], llllIlIlII[230], llllIlIlII[0]);
                                if (D.llIIllllIlllI(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIlIlllIIIIlIl) ? 1 : 0)) {
                        ...
                        if (D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIIIllI = TileObjects.getNearest(tileObject -> {
                            int n2;
                            ...
                            if (D.llIIllllIlllI(Dialog.isOpen() ? 1 : 0)) {
                                ...
                                if (D.llIIllllIllII(lllllllllllllllllIlIlIlllIIIIllI.hasAction(stringArray59) ? 1 : 0)) {
                                    lllllllllllllllllIlIlIlllIIIIllI.interact(llllIIllII[llllIlIlII[235]]);
                                    Time.sleepTicks((int)llllIlIlII[9]);
                                    "".length();
                                }
                                String[] stringArray60 = new String[llllIlIlII[1]];
                                stringArray60[D.llllIlIlII[0]] = llllIIllII[llllIlIlII[236]];
                                if (D.llIIllllIllII(lllllllllllllllllIlIlIlllIIIIllI.hasAction(stringArray60) ? 1 : 0)) {
                                    lllllllllllllllllIlIlIlllIIIIllI.interact(llllIIllII[llllIlIlII[237]]);
                                    Time.sleepTicks((int)llllIlIlII[9]);
                                    "".length();
                                }
                            }
            ...
            if (D.llIIlllllIlIl(e.j(llllIlIlII[14]), llllIlIlII[7])) {
                ...
                lllllllllllllllllIlIlIlllIIlIIII = NPCs.getNearest((String[])stringArray);
                if (D.llIIlllllIlll(lllllllllllllllllIlIlIlllIIlIIII) && D.llIIllllIlllI(Players.getLocal().getWorldLocation().getPlane())) {
                ...
                if (D.llIIlllllIlll(lllllllllllllllllIlIlIlllIIlIIII) && D.llIIlllllIlIl(Players.getLocal().getWorldLocation().getPlane(), llllIlIlII[1])) {
                ...
                if (D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIlIIII) && D.llIIlllllIlIl(Players.getLocal().getWorldLocation().getPlane(), llllIlIlII[1])) {
            ...
            if (D.llIIlllllIlIl(e.j(llllIlIlII[14]), llllIlIlII[12])) {
                ...
                lllllllllllllllllIlIlIlllIIlIIII = NPCs.getNearest((String[])stringArray);
                if (D.llIIlllllIlll(lllllllllllllllllIlIlIlllIIlIIII)) {
                ...
                if (D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIlIIII)) {
            ...
            if (D.llIIlllllIlIl(e.j(llllIlIlII[14]), llllIlIlII[16])) {
                lllllllllllllllllIlIlIlllIIlIIII = new WorldArea(llllIlIlII[269], llllIlIlII[270], llllIlIlII[89], llllIlIlII[79], llllIlIlII[0]);
                if (D.llIIllllIlllI(lllllllllllllllllIlIlIlllIIlIIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    lllllllllllllllllIlIlIlllIIIllll = new WorldPoint(llllIlIlII[271], llllIlIlII[259], llllIlIlII[0]);
                    if (D.llIIlllllIIll(Players.getLocal().getWorldLocation().distanceTo(lllllllllllllllllIlIlIlllIIIllll), llllIlIlII[7])) {
                    ...
                    if (D.llIIlllllIlII(Players.getLocal().getWorldLocation().distanceTo(lllllllllllllllllIlIlIlllIIIllll), llllIlIlII[7])) {
                        String[] stringArray = new String[llllIlIlII[1]];
                ...
                if (D.llIIllllIllII(lllllllllllllllllIlIlIlllIIlIIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    String[] stringArray = new String[llllIlIlII[1]];
                    stringArray[D.llllIlIlII[0]] = llllIIllII[llllIlIlII[275]];
                    lllllllllllllllllIlIlIlllIIIllll = NPCs.getNearest((String[])stringArray);
                    lllllllllllllllllIlIlIlllIIIlllI = new WorldPoint(llllIlIlII[276], llllIlIlII[152], llllIlIlII[0]);
                    if (D.llIIlllllIIll(Players.getLocal().getWorldLocation().distanceTo(lllllllllllllllllIlIlIlllIIIlllI), llllIlIlII[7]) && D.llIIlllllIlll(lllllllllllllllllIlIlIlllIIIllll)) {
                    ...
                    if (D.llIIlllllIIll(Players.getLocal().getWorldLocation().distanceTo(lllllllllllllllllIlIlIlllIIIlllI), llllIlIlII[7]) && D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIIllll) && D.llIIllllIlllI(Reachable.isInteractable((Locatable)lllllllllllllllllIlIlIlllIIIllll) ? 1 : 0)) {
                    ...
                    if (D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIIllll) && D.llIIllllIlllI(Reachable.isInteractable((Locatable)lllllllllllllllllIlIlIlllIIIllll) ? 1 : 0) && D.llIIlllllIlII(Players.getLocal().getWorldLocation().distanceTo(lllllllllllllllllIlIlIlllIIIlllI), llllIlIlII[7]) && D.llIIllllIlllI(Dialog.isOpen() ? 1 : 0)) {
                    ...
                    if (D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIIllll) && D.llIIllllIllII(Reachable.isInteractable((Locatable)lllllllllllllllllIlIlIlllIIIllll) ? 1 : 0)) {
                        ...
                        if (D.llIIlllllIlll(Players.getLocal().getInteracting())) {
                            lllllllllllllllllIlIlIlllIIIllll.interact(llllIIllII[llllIlIlII[293]]);
                            Time.sleepTicks((int)llllIlIlII[1]);
                            "".length();
                        }
                    }
            ...
            if (D.llIIlllllIlIl(e.j(llllIlIlII[14]), llllIlIlII[17])) {
                Prayers.disableAll();
                lllllllllllllllllIlIlIlllIIlIIII = new WorldPoint(llllIlIlII[48], llllIlIlII[49], llllIlIlII[0]);
                if (D.llIIlllllIIll(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllllllllllllllIlIlIlllIIlIIII), llllIlIlII[16]) && D.llIIlllllIlIl(Players.getLocal().getAnimation(), llllIlIlII[294])) {
    ...
    private static void cg() {
        void lllllllllllllllllIlIlIlllIIIIIll;
        BankLocation bankLocation = BankLocation.getNearest();
        if (D.llIIlllllIIlI(bankLocation) && D.llIIllllIlllI(bankLocation.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
        ...
        if (D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIIIIll) && D.llIIllllIllII(lllllllllllllllllIlIlIlllIIIIIll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String llIIllIllIIll(String lllllllllllllllllIlIlIllIlIllIll, String lllllllllllllllllIlIlIllIlIllIlI) {
        try {
            SecretKeySpec lllllllllllllllllIlIlIllIlIllllI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIlIlIllIlIllIlI.getBytes(StandardCharsets.UTF_8)), llllIlIlII[16]), "DES");
            Cipher lllllllllllllllllIlIlIllIlIlllIl = Cipher.getInstance("DES");
            lllllllllllllllllIlIlIllIlIlllIl.init(llllIlIlII[2], lllllllllllllllllIlIlIllIlIllllI);
            return new String(lllllllllllllllllIlIlIllIlIlllIl.doFinal(Base64.getDecoder().decode(lllllllllllllllllIlIlIllIlIllIll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void llIIllllIlIII() {
        ...
        D.llllIIllII[D.llllIlIlII[0]] = D.llIIllIllIIlI("Ikh2K/8O2sMCvp/dkorhBw==", "oTbuk");
        D.llllIIllII[D.llllIlIlII[1]] = D.llIIllIllIIll("dLubdeVKOykKE4sjocUU6q8PWUTvQi1uytieSuoDGS7XdC7Ky0lKTjgwzbePpZbs", "zPXje");
        D.llllIIllII[D.llllIlIlII[2]] = D.llIIllIllIIlI("oCWBSd6dS3PnEB7vXk9aNg==", "CNQdT");
        D.llllIIllII[D.llllIlIlII[7]] = D.llIIllIllIIlI("adZSrknnM+Y=", "DYtRh");
        D.llllIIllII[D.llllIlIlII[9]] = D.llIIllIllIIll("cwqIaY1w2rU=", "pTNgb");
        D.llllIIllII[D.llllIlIlII[11]] = D.llIIllIllIIlI("4gqPzyHUQEI=", "KoORt");
        D.llllIIllII[D.llllIlIlII[12]] = D.llIIllIllIIll("kI6/v9DmnJw=", "MdsIU");
        D.llllIIllII[D.llllIlIlII[13]] = D.llIIllIllIlII("LhIH", "kssBN");
        D.llllIIllII[D.llllIlIlII[16]] = D.llIIllIllIlII("HgASWgE/QQYbGzs=", "Padzu");
        D.llllIIllII[D.llllIlIlII[17]] = D.llIIllIllIIlI("zfr1uH5gHxFArdW9YS3CeIc+ggPGi62F", "jjgAr");
        D.llllIIllII[D.llllIlIlII[23]] = D.llIIllIllIIll("UNvJU8YH1EfFAGwj917BJS8FI0yH/mftmNg0P52Yt/Es6XLL2W+g3Z5wL0otL8LJ", "jASmE");
        D.llllIIllII[D.llllIlIlII[26]] = D.llIIllIllIlII("Dgx5LSQ8STQlJSoANyt2Kh08KTp5BzglOipFeT8hMB06JD83Dnk4OXkrDBUfFy4=", "YiYLV");
        D.llllIIllII[D.llllIlIlII[28]] = D.llIIllIllIIll("QiJTTuJrMfgmc3+E31qgK5KXCtFxXQY0l3YmpeSiY0I2XspCTR9mKTQEWK2G2TG/", "nlYqp");
        D.llllIIllII[D.llllIlIlII[38]] = D.llIIllIllIlII("Bj9iEBY0ei8YFyIzLBZEIC8nAhBxKTcBFD0zJwJIcSk1GBAyMisfA3EuLVEmBAMLPyM=", "QZBqd");
        D.llllIIllII[D.llllIlIlII[40]] = D.llIIllIllIlII("JBQXThUFVQIGAAcFQQkUAxkF", "juana");
        D.llllIIllII[D.llllIlIlII[20]] = D.llIIllIllIlII("EhkgOxgoHw==", "FxLPq");
        D.llllIIllII[D.llllIlIlII[43]] = D.llIIllIllIIll("fUBgTdR/yz8Ho6nWq0OVWw==", "HXlMb");
        D.llllIIllII[D.llllIlIlII[29]] = D.llIIllIllIIll("UuzvLTpPb/ZyqLbxyK8Btw==", "rVeRx");
        D.llllIIllII[D.llllIlIlII[50]] = D.llIIllIllIIlI("ZCnEu6ld8Yk=", "zzyla");
        D.llllIIllII[D.llllIlIlII[51]] = D.llIIllIllIlII("BB8dMFMlCRo4GiILAQ==", "VjsUs");
        D.llllIIllII[D.llllIlIlII[10]] = D.llIIllIllIIlI("BnO7udwfS5s=", "vDUeK");
        D.llllIIllII[D.llllIlIlII[52]] = D.llIIllIllIIlI("fh+kcjKbaiA=", "wFbTI");
        D.llllIIllII[D.llllIlIlII[53]] = D.llIIllIllIIlI("HjlA5m3K/4U=", "InEEt");
        D.llllIIllII[D.llllIlIlII[55]] = D.llIIllIllIIll("iJhxOJKPVH3k47/TrenTqg==", "IRdri");
        D.llllIIllII[D.llllIlIlII[8]] = D.llIIllIllIlII("Gg4xdxM7TyQ/BjkfZzASPQMj", "ToGWg");
        D.llllIIllII[D.llllIlIlII[56]] = D.llIIllIllIIll("uzW9INTngts=", "gLKNf");
        D.llllIIllII[D.llllIlIlII[57]] = D.llIIllIllIlII("MhchOiAIEQ==", "fvMQI");
        D.llllIIllII[D.llllIlIlII[58]] = D.llIIllIllIIlI("9LR2PJ2L/OVucxF/NW4u5w==", "ebGVd");
        D.llllIIllII[D.llllIlIlII[60]] = D.llIIllIllIIll("pIOLfzV93y2u3lLtpHRDZ/Z+HXd8/bclF9LwPFJioh25QEokKSYSCw==", "VuxZY");
        D.llllIIllII[D.llllIlIlII[61]] = D.llIIllIllIIll("TTkxOv/BqKEHcGgeJXDKT8XQNVqfk2N+", "CkdZG");
        D.llllIIllII[D.llllIlIlII[63]] = D.llIIllIllIlII("CyQPUDEiJVg5cjM5FwQ3ID9YHSswLhQWciU5Fx1yNyMdUDYxKh8fPGQ4WBIgJioMGG0=", "CKxpR");
        D.llllIIllII[D.llllIlIlII[65]] = D.llIIllIllIIll("jkU/RUNDPCJYStFCoSpg5w==", "XMuei");
        D.llllIIllII[D.llllIlIlII[15]] = D.llIIllIllIIlI("zEOPAdxiqC4Y/03zFEWP4rtrhO3Ypk4cLdNENIPVzMmb2V1P+EcBRQ==", "sKPkz");
        D.llllIIllII[D.llllIlIlII[66]] = D.llIIllIllIIll("DRIDcSSR2wwKzHxo3xnSjupzrpM+vXhCGTJ61p/iYAo=", "dApnE");
        D.llllIIllII[D.llllIlIlII[68]] = D.llIIllIllIIlI("I4LQXLAu0YE7qEsjY+6WKjQA54pzCS0NCL46QLoGOYW/0MWTxo+pHQ==", "gGEVL");
        D.llllIIllII[D.llllIlIlII[69]] = D.llIIllIllIIll("lqcHhN2CoCrszQ2Lco4mFNSLD9VTX9Y4hIm+RZJ4/HM=", "LfKuT");
        D.llllIIllII[D.llllIlIlII[70]] = D.llIIllIllIlII("LQMzZQkEAmQMSgMFKiFKEQQhZRgKGTAgShEDZAYYBAIgKhha", "elDEj");
        D.llllIIllII[D.llllIlIlII[71]] = D.llIIllIllIIll("HJHpor26ArcZRHZdRf9ZYVyjvP45mXuNledRv7Jm2EQ=", "ugefz");
        D.llllIIllII[D.llllIlIlII[74]] = D.llIIllIllIlII("BQcrJEMjAyg=", "HfQAc");
        D.llllIIllII[D.llllIlIlII[77]] = D.llIIllIllIlII("CjEEKzwg", "ECeHP");
        D.llllIIllII[D.llllIlIlII[78]] = D.llIIllIllIIll("6HSn4aYSUH0erhnEW9zrDQ==", "DLocf");
        D.llllIIllII[D.llllIlIlII[79]] = D.llIIllIllIlII("OygmGwcR", "tZGxk");
        D.llllIIllII[D.llllIlIlII[80]] = D.llIIllIllIlII("AzU0KAgp", "LGUKd");
        D.llllIIllII[D.llllIlIlII[82]] = D.llIIllIllIIlI("nlaim+QtHWsyw/fk1Y/yvg==", "QQAzj");
        D.llllIIllII[D.llllIlIlII[84]] = D.llIIllIllIlII("BDcIGCEtKkobOjw=", "HXjkU");
        D.llllIIllII[D.llllIlIlII[87]] = D.llIIllIllIlII("GRgQTxM4WQsOAD4aRgsIOAs=", "Wyfog");
        D.llllIIllII[D.llllIlIlII[88]] = D.llIIllIllIIlI("oBKhxgxAFUiUyyae8UPBN/OVCvSSNWAE", "lEmqL");
        D.llllIIllII[D.llllIlIlII[89]] = D.llIIllIllIIlI("MaAwNLweoc8=", "hnjmT");
        D.llllIIllII[D.llllIlIlII[90]] = D.llIIllIllIIll("IGDyllUOiIc=", "hxgld");
        D.llllIIllII[D.llllIlIlII[91]] = D.llIIllIllIIlI("OCh48qec1evF3ycB5O5YHQ==", "KJNKl");
        D.llllIIllII[D.llllIlIlII[6]] = D.llIIllIllIlII("AjYEFiMrK0YVODo=", "NYfeW");
        D.llllIIllII[D.llllIlIlII[92]] = D.llIIllIllIIll("7hgIyE1N718g3z6GRSwcZg==", "ZalIG");
        D.llllIIllII[D.llllIlIlII[93]] = D.llIIllIllIlII("ATIIPC5sNwA6Pw==", "LSoUM");
        D.llllIIllII[D.llllIlIlII[94]] = D.llIIllIllIIlI("qh25r0+EgujPrJDfcyXAYQ==", "ggxdi");
        D.llllIIllII[D.llllIlIlII[95]] = D.llIIllIllIIll("6uCNM5kXcMfWL+isuu4LDA==", "rUJcT");
        D.llllIIllII[D.llllIlIlII[96]] = D.llIIllIllIIll("W6hxWTMmGxH64i9TSJG1sA==", "cDsMj");
        D.llllIIllII[D.llllIlIlII[97]] = D.llIIllIllIlII("LigUDSUdZh1MOhAvCkw1FiwM", "yAnlW");
        D.llllIIllII[D.llllIlIlII[98]] = D.llIIllIllIIlI("2rE3V1CUdBqZv+P+0/OIYHrJ/xrApGSD", "MgBCk");
        D.llllIIllII[D.llllIlIlII[99]] = D.llIIllIllIlII("BhEdORZrFBU/Bw==", "KpzPu");
        D.llllIIllII[D.llllIlIlII[100]] = D.llIIllIllIlII("JwUeBQ==", "tlrnf");
        D.llllIIllII[D.llllIlIlII[101]] = D.llIIllIllIIlI("n5mErl6Jnqc=", "ZdpOo");
        D.llllIIllII[D.llllIlIlII[102]] = D.llIIllIllIIll("Rp25TLRnNX3gSkBwnD8vVQ==", "yttHf");
        D.llllIIllII[D.llllIlIlII[103]] = D.llIIllIllIIll("0bOUgtS84k3Ol0sauCbpGQ==", "hYISN");
        D.llllIIllII[D.llllIlIlII[104]] = D.llIIllIllIIlI("frwGtWCb+QNXEE5aXu2K6Q==", "Atplo");
        D.llllIIllII[D.llllIlIlII[105]] = D.llIIllIllIlII("OhEXLAFXFB8qEA==", "wppEb");
        D.llllIIllII[D.llllIlIlII[106]] = D.llIIllIllIlII("Hy82BREvJXAODD0t", "JAPlc");
        D.llllIIllII[D.llllIlIlII[107]] = D.llIIllIllIIlI("Ez8cHBsafhu7Vt7HnTZ3Ew==", "SWbSW");
        D.llllIIllII[D.llllIlIlII[108]] = D.llIIllIllIIll("V1wKPfnkMrrywvqVuB+5VQ==", "WZOLz");
        D.llllIIllII[D.llllIlIlII[109]] = D.llIIllIllIlII("BS84MSo2YTFwNTsoJnA6PSsg", "RFBPX");
        D.llllIIllII[D.llllIlIlII[110]] = D.llIIllIllIIll("EzElUCqhMUXIpCk6GICvxdKk0QuKdTIF", "nUjKH");
        D.llllIIllII[D.llllIlIlII[111]] = D.llIIllIllIIll("AtN8TIQXiDjIGJIx4zFNGw==", "aynxX");
        D.llllIIllII[D.llllIlIlII[112]] = D.llIIllIllIIll("uDU+Ft1Tk8k=", "DYYfY");
        D.llllIIllII[D.llllIlIlII[113]] = D.llIIllIllIIlI("N5/OuPJPXdybjjqnhtLV5A==", "Urbdl");
        D.llllIIllII[D.llllIlIlII[114]] = D.llIIllIllIlII("Nx88Pg==", "xoYPY");
        D.llllIIllII[D.llllIlIlII[115]] = D.llIIllIllIIll("HoCl/BRnjFw=", "wIFTf");
        D.llllIIllII[D.llllIlIlII[116]] = D.llIIllIllIIll("uDTAOqGX16E=", "YyYcI");
        D.llllIIllII[D.llllIlIlII[117]] = D.llIIllIllIIlI("OXhm8qgZNsw=", "LtCYU");
        D.llllIIllII[D.llllIlIlII[118]] = D.llIIllIllIIll("7TQ7M3TuFIk=", "qSakt");
        D.llllIIllII[D.llllIlIlII[119]] = D.llIIllIllIIll("p1kFZcBGFAw=", "iepjC");
        D.llllIIllII[D.llllIlIlII[120]] = D.llIIllIllIIlI("9Ese3so5VQ4=", "NhCPm");
        D.llllIIllII[D.llllIlIlII[121]] = D.llIIllIllIIlI("yZflABL12tGykqbHXaWs9Q==", "klSiT");
        D.llllIIllII[D.llllIlIlII[122]] = D.llIIllIllIIll("H5Gdo3bKG8dyyzN7fIfh1g==", "rgwLk");
        D.llllIIllII[D.llllIlIlII[123]] = D.llIIllIllIIll("sorkEoWDTQ4i+DQkuZIwaw==", "ZgLCV");
        D.llllIIllII[D.llllIlIlII[124]] = D.llIIllIllIlII("JiYQOQRLIxg/FQ==", "kGwPg");
        D.llllIIllII[D.llllIlIlII[125]] = D.llIIllIllIIll("VMdDymHSzJK0TU22SOq9VA==", "NOxot");
        D.llllIIllII[D.llllIlIlII[126]] = D.llIIllIllIIll("TcWr9/3VPhSYIHH/qntcgw==", "UJCCl");
        D.llllIIllII[D.llllIlIlII[127]] = D.llIIllIllIlII("ARAfKyZsFRctNw==", "LqxBE");
        D.llllIIllII[D.llllIlIlII[128]] = D.llIIllIllIIll("gbgMXrfOCnf7RlWeKehk3eQco7nhjcBf", "KIqjZ");
        D.llllIIllII[D.llllIlIlII[129]] = D.llIIllIllIIlI("BRsm4LMF0Jf98r+tqe6LgaQLrk6y4VRm", "vwXHe");
        D.llllIIllII[D.llllIlIlII[130]] = D.llIIllIllIlII("JjQmDAFLMS4KEA==", "kUAeb");
        D.llllIIllII[D.llllIlIlII[25]] = D.llIIllIllIlII("FD8yHD4=", "WWWoJ");
        D.llllIIllII[D.llllIlIlII[131]] = D.llIIllIllIIlI("7mxIlE1gqVtYq9NZogWQkw==", "TMXTM");
        D.llllIIllII[D.llllIlIlII[132]] = D.llIIllIllIIlI("EhBlgOZ0lOE=", "UrlLp");
        D.llllIIllII[D.llllIlIlII[133]] = D.llIIllIllIIlI("ZJmMmi5h1gE=", "HlDaN");
        D.llllIIllII[D.llllIlIlII[134]] = D.llIIllIllIIlI("GQA7pJ1N894=", "Mpdzx");
        D.llllIIllII[D.llllIlIlII[135]] = D.llIIllIllIlII("GRIAEzYi", "JwaaU");
        D.llllIIllII[D.llllIlIlII[136]] = D.llIIllIllIlII("MBUDIxUL", "cpbQv");
        D.llllIIllII[D.llllIlIlII[137]] = D.llIIllIllIlII("JTQQMy4=", "gFuRE");
        D.llllIIllII[D.llllIlIlII[140]] = D.llIIllIllIIll("o6G7UF+EgXr8k5aQ69vJJAicbt8WGSvk", "Mjkmh");
        D.llllIIllII[D.llllIlIlII[141]] = D.llIIllIllIIlI("/4yz1Tgk/ewLPdLYOG8blM2p/NtA+PA4bjEy7Typc/k=", "Wprbb");
        D.llllIIllII[D.llllIlIlII[142]] = D.llIIllIllIIll("6+MRUbZVT9ehP+Vgy2MsbiZtlUoC+TQEtm1UJp+G4h5oxoqATF+YMg==", "vCEwn");
        D.llllIIllII[D.llllIlIlII[143]] = D.llIIllIllIIlI("wIZjPRPwwy0=", "KdNNc");
        D.llllIIllII[D.llllIlIlII[144]] = D.llIIllIllIlII("GQg8LTojDg==", "MiPFS");
        D.llllIIllII[D.llllIlIlII[145]] = D.llIIllIllIIlI("ksA59vtnrUqzrZVCyewMIA==", "CxgJV");
        D.llllIIllII[D.llllIlIlII[146]] = D.llIIllIllIIlI("Mootp2/Us9UX9gkMkziXsA==", "NWfeg");
        D.llllIIllII[D.llllIlIlII[147]] = D.llIIllIllIIll("NpRCRl42khpYpdh+4qFBBQ==", "TShJC");
        D.llllIIllII[D.llllIlIlII[148]] = D.llIIllIllIIll("uQxhou4ATXk=", "gMOXT");
        D.llllIIllII[D.llllIlIlII[155]] = D.llIIllIllIlII("CCYdWAQpZwYZCiM=", "FGkxp");
        D.llllIIllII[D.llllIlIlII[156]] = D.llIIllIllIIlI("WRzWE/XjFLk=", "mCFAQ");
        D.llllIIllII[D.llllIlIlII[157]] = D.llIIllIllIlII("Ozw0Hw==", "tLQqq");
        D.llllIIllII[D.llllIlIlII[165]] = D.llIIllIllIIlI("xPo69zG7mACkzqcVBaxzNg==", "qgsCq");
        D.llllIIllII[D.llllIlIlII[167]] = D.llIIllIllIIll("L4SFcjst1JI=", "KOjIe");
        D.llllIIllII[D.llllIlIlII[168]] = D.llIIllIllIIll("6gPTNFFfZds=", "ksOXv");
        D.llllIIllII[D.llllIlIlII[171]] = D.llIIllIllIIlI("Kxvrip2G/VToa5W3dlqh4w==", "OLPZS");
        D.llllIIllII[D.llllIlIlII[172]] = D.llIIllIllIIlI("EGVentiQLiO7089+W7VOSg==", "jbCrx");
        D.llllIIllII[D.llllIlIlII[173]] = D.llIIllIllIlII("CTwdCw==", "FLxex");
        D.llllIIllII[D.llllIlIlII[174]] = D.llIIllIllIlII("MDppAgg=", "wUIwx");
        D.llllIIllII[D.llllIlIlII[175]] = D.llIIllIllIIlI("oNbMtSS4ZQzNUJpTqNI0PQ==", "bXnQc");
        D.llllIIllII[D.llllIlIlII[179]] = D.llIIllIllIlII("LTcWBxsENUIYFxM=", "jRbsr");
        D.llllIIllII[D.llllIlIlII[181]] = D.llIIllIllIIlI("oinJh5jRvE0=", "nOxap");
        D.llllIIllII[D.llllIlIlII[182]] = D.llIIllIllIIll("3AcpS2cRNas=", "BghfV");
        D.llllIIllII[D.llllIlIlII[185]] = D.llIIllIllIIll("8gY6hGc3M+1MqTz56J7p6D2dJNS+eHfZ", "VxacO");
        D.llllIIllII[D.llllIlIlII[186]] = D.llIIllIllIIlI("PznCAHJ88uxx8PtliVymTw==", "zyhYK");
        D.llllIIllII[D.llllIlIlII[187]] = D.llIIllIllIIll("VN6GwV0Vvnk=", "zZVzV");
        D.llllIIllII[D.llllIlIlII[188]] = D.llIIllIllIlII("EjkCHhd8IBs=", "QUksu");
        D.llllIIllII[D.llllIlIlII[190]] = D.llIIllIllIIll("PCgZHaWMrDtNkx+h6LAw/Q==", "XMqvK");
        D.llllIIllII[D.llllIlIlII[192]] = D.llIIllIllIIll("FmIaFbKMtY4=", "AQeFw");
        D.llllIIllII[D.llllIlIlII[193]] = D.llIIllIllIlII("OhQnFg==", "nuLst");
        D.llllIIllII[D.llllIlIlII[195]] = D.llIIllIllIlII("GRssWjg4WiMfIDsVLVooOBUo", "WzZzL");
        D.llllIIllII[D.llllIlIlII[196]] = D.llIIllIllIIlI("xHeO7pUg0TrT09iY98ycFQ==", "okcHG");
        D.llllIIllII[D.llllIlIlII[197]] = D.llIIllIllIIlI("7z0OARPflCA=", "mHRlb");
        D.llllIIllII[D.llllIlIlII[198]] = D.llIIllIllIIll("FN0d6XSE961HgVXep5gsKw==", "xRgJy");
        D.llllIIllII[D.llllIlIlII[201]] = D.llIIllIllIIlI("StK7sGfJZdEUcRhlbT+A7A==", "HzoGw");
        D.llllIIllII[D.llllIlIlII[202]] = D.llIIllIllIIlI("bclKG/bjukCkCu6jJNTCZA==", "RAtcV");
        D.llllIIllII[D.llllIlIlII[208]] = D.llIIllIllIIlI("/mVj1QcU6BzqT1+qmNHNxB/jJTpoqR7B", "zcddy");
        D.llllIIllII[D.llllIlIlII[210]] = D.llIIllIllIIll("hwpEoxqlf18=", "ABKuE");
        D.llllIIllII[D.llllIlIlII[211]] = D.llIIllIllIlII("LBs6Ng==", "xzQSM");
        D.llllIIllII[D.llllIlIlII[213]] = D.llIIllIllIIlI("+pzRAuPVAnmWH8pv9yeur9WvcBwN0XgU", "NTfvM");
        D.llllIIllII[D.llllIlIlII[214]] = D.llIIllIllIIlI("2Rj+/GmI/CzJ149GKPP4ZA==", "OoVWC");
        D.llllIIllII[D.llllIlIlII[215]] = D.llIIllIllIIlI("yzxXuSeAAEI=", "qCJlK");
        D.llllIIllII[D.llllIlIlII[217]] = D.llIIllIllIlII("Hgc6Di03BW4RISA=", "YbNzD");
        D.llllIIllII[D.llllIlIlII[219]] = D.llIIllIllIlII("IhclJTkI", "ccQDZ");
        D.llllIIllII[D.llllIlIlII[220]] = D.llIIllIllIIlI("VtP6a1tiyuo=", "RNNzt");
        D.llllIIllII[D.llllIlIlII[223]] = D.llIIllIllIIlI("Av0ZbWaE6iY8fi1AzOmXwjLoPvhCS4tE", "peaUK");
        D.llllIIllII[D.llllIlIlII[224]] = D.llIIllIllIIlI("zt6xml0LZAr3vxmZxQeIOg==", "JSuvO");
        D.llllIIllII[D.llllIlIlII[225]] = D.llIIllIllIIll("sRtvlyGx2bY=", "VQXNV");
        D.llllIIllII[D.llllIlIlII[226]] = D.llIIllIllIlII("OiwiEgAEaTUECBkn", "vIQae");
        D.llllIIllII[D.llllIlIlII[228]] = D.llIIllIllIIll("ZbDsuboaJfQ=", "CpoPT");
        D.llllIIllII[D.llllIlIlII[229]] = D.llIIllIllIlII("NgIDFA==", "bchqw");
        D.llllIIllII[D.llllIlIlII[231]] = D.llIIllIllIlII("GyU1SyU6ZCQZNDAqYw8+OjY=", "UDCkQ");
        D.llllIIllII[D.llllIlIlII[232]] = D.llIIllIllIIlI("bOrq4WqkPigcaZk81BRSnw==", "moQYt");
        D.llllIIllII[D.llllIlIlII[233]] = D.llIIllIllIlII("GSMIGw==", "VSmuS");
        D.llllIIllII[D.llllIlIlII[234]] = D.llIIllIllIIlI("oi1ozvgVAwM=", "MWMHs");
        D.llllIIllII[D.llllIlIlII[235]] = D.llIIllIllIIll("D+ZKpFRPmlQ=", "rsPcW");
        D.llllIIllII[D.llllIlIlII[236]] = D.llIIllIllIIlI("cRcWeXHs5n8=", "lqvJO");
        D.llllIIllII[D.llllIlIlII[237]] = D.llIIllIllIIll("hjnJxNUE48Y=", "tQNCG");
        D.llllIIllII[D.llllIlIlII[238]] = D.llIIllIllIIll("wuMzjmcXiLc=", "Sgmwy");
        D.llllIIllII[D.llllIlIlII[239]] = D.llIIllIllIlII("OTg2OhM=", "iTWTx");
        D.llllIIllII[D.llllIlIlII[240]] = D.llIIllIllIlII("ATsEZT8gehAqKjs=", "OZrEK");
        D.llllIIllII[D.llllIlIlII[241]] = D.llIIllIllIIll("CcrWVXnQP0IEgSCcY3lsmA==", "mOlaQ");
        D.llllIIllII[D.llllIlIlII[242]] = D.llIIllIllIIlI("DviDKjzYBECu/lQtY56g4++Rr5VSu1Q+tRT6LvW09qA=", "LWQCG");
        D.llllIIllII[D.llllIlIlII[243]] = D.llIIllIllIIlI("FBWcPaL27MBorTviYel1sDR3VJCxdix8aLxSPNsLB5qL+/YivetEnA==", "JShrZ");
        D.llllIIllII[D.llllIlIlII[244]] = D.llIIllIllIIlI("NDn1ks9P6z0=", "HJGJK");
        D.llllIIllII[D.llllIlIlII[245]] = D.llIIllIllIlII("AgcOIxcnGAo=", "IkoQr");
        D.llllIIllII[D.llllIlIlII[246]] = D.llIIllIllIlII("ARsFMARiGAggSggfCTIDLAk=", "BzgYj");
        D.llllIIllII[D.llllIlIlII[247]] = D.llIIllIllIlII("KAANFD0DAQtGOwUOGA==", "jolfY");
        D.llllIIllII[D.llllIlIlII[248]] = D.llIIllIllIIll("HbL8FhJYLEKwAXED1wdi9w==", "ejYPp");
        D.llllIIllII[D.llllIlIlII[249]] = D.llIIllIllIIll("MD5ZCmZeSWM=", "MBAWj");
        D.llllIIllII[D.llllIlIlII[250]] = D.llIIllIllIlII("IS0gKzEaJjdqKxwkNQ==", "sHPJC");
        D.llllIIllII[D.llllIlIlII[251]] = D.llIIllIllIIlI("aHTV7+sGFL0=", "cPCBT");
        D.llllIIllII[D.llllIlIlII[252]] = D.llIIllIllIlII("KgcIDwMK", "xbxnj");
        D.llllIIllII[D.llllIlIlII[253]] = D.llIIllIllIIlI("0SsDS8mwt0g=", "aqDDQ");
        D.llllIIllII[D.llllIlIlII[254]] = D.llIIllIllIIll("TulFEarHyLYV4WL2EzwWlw==", "vhBie");
        D.llllIIllII[D.llllIlIlII[255]] = D.llIIllIllIlII("Ojo6HjgVcyYSMg==", "rSHwV");
        D.llllIIllII[D.llllIlIlII[256]] = D.llIIllIllIIlI("kU7qAOk3N8M=", "qLAVW");
        D.llllIIllII[D.llllIlIlII[257]] = D.llIIllIllIlII("DT04DQAmPXkiByUjOBML", "IOYtn");
        D.llllIIllII[D.llllIlIlII[14]] = D.llIIllIllIIlI("7RrjVVYFu3o=", "ZFFGn");
        D.llllIIllII[D.llllIlIlII[72]] = D.llIIllIllIIll("q6VJdgDhOda8UI63GDhaPw==", "LVVCA");
        D.llllIIllII[D.llllIlIlII[260]] = D.llIIllIllIlII("Jw8xbSwGTiUiOR0=", "inGMX");
        D.llllIIllII[D.llllIlIlII[261]] = D.llIIllIllIlII("LhIxMyMAFGIoKgsOISI+", "mgBGL");
        D.llllIIllII[D.llllIlIlII[262]] = D.llIIllIllIIlI("U5iOVIHV0hdEzhyfRo1Zo2DjXOKnATsP0KZVOowkJ8w=", "iAOZh");
        D.llllIIllII[D.llllIlIlII[263]] = D.llIIllIllIIll("IJSb+u/r7YPVz02yH13e4t7KVoqd1ZpyxE2LQ3aG0ktWJ8NOblRdrA==", "uaVYv");
        D.llllIIllII[D.llllIlIlII[264]] = D.llIIllIllIIll("CQRkH6c/cnw=", "sPEjM");
        D.llllIIllII[D.llllIlIlII[265]] = D.llIIllIllIlII("IBcIEAYLFwgc", "gvfwv");
        D.llllIIllII[D.llllIlIlII[266]] = D.llIIllIllIlII("BCU5BSM=", "GWVvP");
        D.llllIIllII[D.llllIlIlII[267]] = D.llIIllIllIIll("lp42QkanitA8WUbxATbScA==", "IoaVR");
        D.llllIIllII[D.llllIlIlII[268]] = D.llIIllIllIlII("KjslHhgANHUkHA0=", "iZUjy");
        D.llllIIllII[D.llllIlIlII[272]] = D.llIIllIllIlII("JQobVT4ESwgbPhkKAxYv", "kkmuJ");
        D.llllIIllII[D.llllIlIlII[273]] = D.llIIllIllIlII("JSk1CQ==", "mFYlC");
        D.llllIIllII[D.llllIlIlII[274]] = D.llIIllIllIIll("8qV7XlYjMjw=", "uPWEU");
        D.llllIIllII[D.llllIlIlII[275]] = D.llIIllIllIIll("Ye0oYajiHKk=", "ltWdF");
        D.llllIIllII[D.llllIlIlII[277]] = D.llIIllIllIIlI("8o6+hHINKuZjGTIi4bGkgg==", "zTaQk");
        D.llllIIllII[D.llllIlIlII[278]] = D.llIIllIllIlII("KzUsVgUKdDwfFg0g", "eTZvq");
        D.llllIIllII[D.llllIlIlII[279]] = D.llIIllIllIIlI("IxrQkRt3L48=", "vJVeZ");
        D.llllIIllII[D.llllIlIlII[280]] = D.llIIllIllIIll("QUlVlNpe3OM=", "PzkXp");
        D.llllIIllII[D.llllIlIlII[281]] = D.llIIllIllIIll("94avcqK/658=", "aDoJb");
        D.llllIIllII[D.llllIlIlII[282]] = D.llIIllIllIIlI("MBsoo2S+oR8=", "nZYCL");
        D.llllIIllII[D.llllIlIlII[283]] = D.llIIllIllIIll("eZyHiG+dQuclkszcNxJjZA==", "FigFF");
        D.llllIIllII[D.llllIlIlII[284]] = D.llIIllIllIIll("Gg2VdvpbVFAaBc8CWNoAvTKB6/cReOsD", "XSQPY");
        D.llllIIllII[D.llllIlIlII[285]] = D.llIIllIllIlII("ByUtJg==", "QLLJc");
        D.llllIIllII[D.llllIlIlII[286]] = D.llIIllIllIIlI("lYwUu1tSpzc=", "WPrrj");
        D.llllIIllII[D.llllIlIlII[287]] = D.llIIllIllIIlI("1GOf5YirbMo=", "AbeYL");
        D.llllIIllII[D.llllIlIlII[288]] = D.llIIllIllIIll("UCPdYh+LGGM=", "jLcrp");
        D.llllIIllII[D.llllIlIlII[289]] = D.llIIllIllIIll("oTAvX8zLf5w=", "Qbyig");
        D.llllIIllII[D.llllIlIlII[290]] = D.llIIllIllIlII("DwMgJCY=", "KqIJM");
        D.llllIIllII[D.llllIlIlII[292]] = D.llIIllIllIIlI("XlulqctIUZY=", "BppUM");
        D.llllIIllII[D.llllIlIlII[293]] = D.llIIllIllIlII("KiI1FQoA", "kVAti");
        D.llllIIllII[D.llllIlIlII[295]] = D.llIIllIllIlII("KjUsTCILdDUWPwU3Mg==", "dTZlV");
        D.llllIIllII[D.llllIlIlII[296]] = D.llIIllIllIIlI("RJ00sT8Furw=", "rpMCy");
        D.llllIIllII[D.llllIlIlII[297]] = D.llIIllIllIIll("Jlql5/8bqkk=", "qgtwo");
        D.llllIIllII[D.llllIlIlII[298]] = D.llIIllIllIIll("MMQIlA47pZbDA3ZqLIoBxQ==", "DhWQd");
        D.llllIIllII[D.llllIlIlII[299]] = D.llIIllIllIIlI("aN/UAigHVKc=", "hhBnT");
        D.llllIIllII[D.llllIlIlII[300]] = D.llIIllIllIIlI("KhGoZJvULxk=", "EBIgc");
        D.llllIIllII[D.llllIlIlII[301]] = D.llIIllIllIlII("FBg8dQE1WSg0GzE=", "ZyJUu");
        D.llllIIllII[D.llllIlIlII[302]] = D.llIIllIllIIll("s17hAg9uwgA5X70aYRQTPNlqfflDKrM/", "ZXuER");
        D.llllIIllII[D.llllIlIlII[303]] = D.llIIllIllIIll("g+Fn5RHe2/C8OnrnjyEXcg==", "littS");
        D.llllIIllII[D.llllIlIlII[304]] = D.llIIllIllIlII("DRs0LzksFD1rNyQUMSI7Ig==", "EzZKU");
        D.llllIIllII[D.llllIlIlII[306]] = D.llIIllIllIIll("ZyIDDc94Dow3zPUL5hTnnQ==", "UEtej");
        D.llllIIllII[D.llllIlIlII[307]] = D.llIIllIllIIlI("31K0h8TQcxcxytQe3mWKEtj3nQNKexr9", "PXgLT");
        D.llllIIllII[D.llllIlIlII[308]] = D.llIIllIllIIlI("Uqj5TMi0D3hnVSJ14kJfFA==", "kWcCo");
        D.llllIIllII[D.llllIlIlII[315]] = D.llIIllIllIIlI("tYqY2yagGrbHhNc/7T1A+zCBa2Yr4///", "RGNnk");
        D.llllIIllII[D.llllIlIlII[316]] = D.llIIllIllIIlI("NGz16W0nvS88AHLbnJtoF8KkDR+JHFbQ", "apfbw");
        D.llllIIllII[D.llllIlIlII[317]] = D.llIIllIllIIlI("dSOEAcKdSNTBhmQbQGUWoA==", "cmNXL");
        D.llllIIllII[D.llllIlIlII[318]] = D.llIIllIllIlII("Lho6Aw8GBis=", "otNji");
        D.llllIIllII[D.llllIlIlII[319]] = D.llIIllIllIlII("Gx0gEjAM", "xrMpQ");
        D.llllIIllII[D.llllIlIlII[320]] = D.llIIllIllIlII("GyAYLgwM", "xOuLm");
        D.llllIIllII[D.llllIlIlII[321]] = D.llIIllIllIlII("CSggPiIhNDE=", "HFTWD");
        D.llllIIllII[D.llllIlIlII[322]] = D.llIIllIllIIlI("CWaDre5gE+D0iWXqDdREDQ==", "fZVwo");
        D.llllIIllII[D.llllIlIlII[323]] = D.llIIllIllIIlI("MoFpU+ghHu4=", "OdVve");
        D.llllIIllII[D.llllIlIlII[324]] = D.llIIllIllIIlI("1BP01EWN8Jk=", "wBmFY");
        D.llllIIllII[D.llllIlIlII[325]] = D.llIIllIllIlII("AyIqFh88", "YMGtv");
        D.llllIIllII[D.llllIlIlII[326]] = D.llIIllIllIIlI("6aWHsYoVN+4=", "Xoxqa");
        D.llllIIllII[D.llllIlIlII[327]] = D.llIIllIllIlII("NjUYIiNYPR44Lw==", "uYqOA");
        D.llllIIllII[D.llllIlIlII[328]] = D.llIIllIllIIll("xDKhcNNn3D8=", "JNeXk");
        D.llllIIllII[D.llllIlIlII[329]] = D.llIIllIllIIlI("M3pWhz7inrZ9+0CfmVUFig==", "CUPEG");
        D.llllIIllII[D.llllIlIlII[330]] = D.llIIllIllIIlI("EZPrya/XEmo=", "ajcxC");
        D.llllIIllII[D.llllIlIlII[331]] = D.llIIllIllIlII("PwMwGBwYBzs=", "lhUty");
        D.llllIIllII[D.llllIlIlII[332]] = D.llIIllIllIIll("caW54VCj804=", "RyewF");
        D.llllIIllII[D.llllIlIlII[333]] = D.llIIllIllIIll("8WvXmpqQMXg=", "fCMXX");
        D.llllIIllII[D.llllIlIlII[334]] = D.llIIllIllIIlI("K84PoN12gww=", "ZlNee");
        D.llllIIllII[D.llllIlIlII[335]] = D.llIIllIllIlII("PC4WFiYj", "KKwzR");
        D.llllIIllII[D.llllIlIlII[336]] = D.llIIllIllIIlI("71HW4AEJAQ4=", "bkMYl");
        D.llllIIllII[D.llllIlIlII[337]] = D.llIIllIllIIlI("WFAfxSQle4A=", "CXobG");
        D.llllIIllII[D.llllIlIlII[338]] = D.llIIllIllIIlI("lWxkJmUDMm4=", "mtLRK");
        D.llllIIllII[D.llllIlIlII[339]] = D.llIIllIllIlII("IhkgJhQ=", "EuOTm");
        D.llllIIllII[D.llllIlIlII[340]] = D.llIIllIllIIlI("ZSu/7A/+yjg=", "mGACr");
        D.llllIIllII[D.llllIlIlII[349]] = D.llIIllIllIIlI("jsIYnPP2IStgQ4RVOIBS3sFFXTZE2e9p", "VpDxl");
        D.llllIIllII[D.llllIlIlII[350]] = D.llIIllIllIIll("YhccGPjbgLQ=", "kMehS");
        D.llllIIllII[D.llllIlIlII[351]] = D.llIIllIllIIll("vZ8zjQmTQSxaML8qEN0PiQ32vhW/p5Mm7iWTRRINMZXrnf+1s3wW6g==", "PYzvV");
        D.llllIIllII[D.llllIlIlII[352]] = D.llIIllIllIIlI("owd0jwvsa4OgUKpzBmAhgJmJzUzToOTA8qlfVa89/3scoiJKGJCr9/VvfsJhydqe0P33WEP5f+4=", "Cfofg");
        D.llllIIllII[D.llllIlIlII[353]] = D.llIIllIllIlII("InobJjwePQc6cxI1Gm4kDigKbjQEMwEpcx81Tyk6HT9PIzZLO08/Jg4pG2A=", "kZoNS");
        D.llllIIllII[D.llllIlIlII[354]] = D.llIIllIllIIll("569+ZFIqeCqa/4quZckq5MvgpaofNVURTNKTLIr0QyA=", "eTdyQ");
        D.llllIIllII[D.llllIlIlII[355]] = D.llIIllIllIIll("V2+OI/YyQVEW9ww0B/7DMRb3lbm7+A3c", "ksdHY");
        D.llllIIllII[D.llllIlIlII[356]] = D.llIIllIllIIll("VapKJi2mEyjQ9YFRK03SszKyE3kF3R+SGexAibF5Cs5ekGc+o/CF2g==", "iTKAx");
        D.llllIIllII[D.llllIlIlII[357]] = D.llIIllIllIIll("HG63DolwPM86uv/NxThVbbmBN2WwBpyu2b4zUSfr0MZLpIMVQAsya221odBMhaGfAMnuybbf320=", "ZkAYn");
        D.llllIIllII[D.llllIlIlII[358]] = D.llIIllIllIIlI("apWSxSS7TA57TXUQYs2rwP+zRoaOLfrOjieKaS5bFxc9sw9J+kbN53iirIUWkbn5t5BKg3ttwTs=", "cMqfj");
        D.llllIIllII[D.llllIlIlII[359]] = D.llIIllIllIIlI("2FDgnAszwSBMqB2o/hDKQatK+85iO+8uWvCA9EAu1xSsIrXP6npvnOQS12bJQTZm", "sVjDe");
        D.llllIIllII[D.llllIlIlII[360]] = D.llIIllIllIIll("a6pjfDejiBqibgMPr9Rj7MHFDHbiXSWJUcC8cxS9Sok=", "xykxE");
        D.llllIIllII[D.llllIlIlII[361]] = D.llIIllIllIIlI("lRplJ3sdIyxPzdO09+jwZxiFKUxqFuwm", "mVOHD");
        D.llllIIllII[D.llllIlIlII[362]] = D.llIIllIllIIll("AlyF0ZJRvvEHggVhFQ4ux33xwMWQQ44M", "YeHQS");
        D.llllIIllII[D.llllIlIlII[363]] = D.llIIllIllIIlI("Ap6+hXKkaesNxwkpojnsohEj3Yp6LzAG9WKEtnEnthVo0apoACia16axAmVK1Ls8", "mnKdG");
        D.llllIIllII[D.llllIlIlII[364]] = D.llIIllIllIIll("shF/0CdSkBpG8qWmFd9zqA==", "rNAOq");
    }
    ...
    private static void llIIllllIlIlI() {
        ...
        D.llllIlIlII[0] = (0x43 ^ 0x19 ^ (0xB4 ^ 0xB9)) & (0xA8 ^ 0xAD ^ (0x7C ^ 0x2E) ^ -" ".length());
        D.llllIlIlII[1] = " ".length();
        D.llllIlIlII[2] = "  ".length();
        ...
        D.llllIlIlII[173] = 0xDB ^ 0xAA ^ "  ".length();
        ...
        D.llllIlIlII[201] = (0x5E ^ 0x74) + (0x44 ^ 0x43) - -(0x3D ^ 0x6F) + " ".length();
        ...
        D.llllIlIlII[224] = (0x9D ^ 0xA9) + (8 ^ 0x40) - "   ".length() + (0x42 ^ 0x55);
        ...
        D.llllIlIlII[324] = " ".length() + (0x1D ^ 0x49) - (0xAC ^ 0x8E) + (68 + 64 - -18 + 28);
        D.llllIlIlII[325] = (0xA ^ 0x29) + (0x11 ^ 0x18) - -"  ".length() + (9 + 173 - 76 + 78);
    ...
    private static void ch() {
        void lllllllllllllllllIlIlIlllIIIIIIl;
        BankLocation bankLocation = BankLocation.getNearest();
        if (D.llIIlllllIIlI(bankLocation) && D.llIIllllIlllI(bankLocation.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
        ...
        if (D.llIIlllllIIlI(lllllllllllllllllIlIlIlllIIIIIIl) && D.llIIllllIllII(lllllllllllllllllIlIlIlllIIIIIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
