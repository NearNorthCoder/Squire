...
implements S {
    ...
    private static void ae() {
        d lllllllllllllllllIllIIIllIlIlllI;
        Object lllllllllllllllllIllIIIllIlIllll;
        ...
        if (z.llIIlIllIIIII(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lllllllllllllllllIllIIIllIlIllll = new d(llllIIIIII[8], llllIIIIII[1], llllIIIIII[6]);
            bu.add((d)lllllllllllllllllIllIIIllIlIllll);
            "".length();
        }
        int[] nArray3 = new int[llllIIIIII[1]];
        nArray3[z.llllIIIIII[0]] = llllIIIIII[7];
        if (z.llIIlIllIIIII(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllllIllIIIllIlIllll = new d(llllIIIIII[7], llllIIIIII[1], llllIIIIII[6]);
            bu.add((d)lllllllllllllllllIllIIIllIlIllll);
            "".length();
        }
        ...
        if (z.llIIlIllIIIII(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllllIllIIIllIlIllll = new d(llllIIIIII[10], llllIIIIII[14], llllIIIIII[15]);
            bu.add((d)lllllllllllllllllIllIIIllIlIllll);
            "".length();
        }
        if (z.llIIlIllIIIII(Bank.contains((Predicate)(lllllllllllllllllIllIIIllIlIllll = item -> item.getName().toLowerCase().contains(lllIlllllI[llllIIIIII[23]]))) ? 1 : 0)) {
            lllllllllllllllllIllIIIllIlIlllI = new d(llllIIIIII[16], llllIIIIII[11], llllIIIIII[17]);
            bu.add(lllllllllllllllllIllIIIllIlIlllI);
            "".length();
        }
        int[] nArray5 = new int[llllIIIIII[1]];
        nArray5[z.llllIIIIII[0]] = llllIIIIII[18];
        if (z.llIIlIllIIIII(Bank.contains((int[])nArray5) ? 1 : 0)) {
            lllllllllllllllllIllIIIllIlIlllI = new d(llllIIIIII[18], llllIIIIII[19], llllIIIIII[20]);
            bu.add(lllllllllllllllllIllIIIllIlIlllI);
            "".length();
        }
    }
        ...
        if (z.llIIlIllIIIll(Inventory.getCount((int[])nArray))) {
            ...
            if (z.llIIlIllIIIll(Inventory.getCount((int[])nArray2))) {
                ...
                if (z.llIIlIllIIIll(Inventory.getCount((int[])nArray3))) {
                    n2 = llllIIIIII[1];
                    "".length();
                    if (((99 + 57 - 23 + 87 ^ 79 + 16 - -32 + 7) & (0x6D ^ 0x51 ^ (0x3B ^ 0x5D) ^ -" ".length())) < " ".length()) return n2 != 0;
                    return ((72 + 14 - 43 + 98 ^ 100 + 137 - 233 + 154) & (84 + 184 - 103 + 48 ^ 168 + 108 - 172 + 94 ^ -" ".length())) != 0;
                }
            }
        }
        n2 = llllIIIIII[0];
    ...
    public boolean V() {
        ...
        if (z.llIIlIlllIIIl(e.j(llllIIIIII[3]), llllIIIIII[4])) {
            ...
            "".length();
            if ("   ".length() < 0) {
                return ((0xAA ^ 0x9D ^ "  ".length()) & (0xD9 ^ 0x9F ^ (0xE5 ^ 0x96) ^ -" ".length())) != 0;
            }
        } else {
            bl = llllIIIIII[0];
        }
    ...
    private static String llIIlIlIllIlI(String lllllllllllllllllIllIIIllIlIIIlI, String lllllllllllllllllIllIIIllIlIIIll) {
        try {
            ...
            return new String(lllllllllllllllllIllIIIllIlIIllI.doFinal(Base64.getDecoder().decode(lllllllllllllllllIllIIIllIlIIIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void bU() {
        ...
        if (z.llIIlIllIIIII(bs ? 1 : 0)) {
            if (z.llIIlIllIIIII(z.aa() ? 1 : 0) && z.llIIlIllIIIIl(Players.getLocal().getWorldLocation().distanceTo(gu), llllIIIIII[2]) && z.llIIlIlIlllll(e.j(llllIIIIII[3]), llllIIIIII[4])) {
                BankLocation lllllllllllllllllIllIIIllIllIIlI = BankLocation.getNearest();
                if (z.llIIlIllIIIlI(lllllllllllllllllIllIIIllIllIIlI) && z.llIIlIllIIIII(lllllllllllllllllIllIIIllIllIIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderTempleTrek.c = lllIlllllI[llllIIIIII[4]];
                    a.a(lllllllllllllllllIllIIIllIllIIlI);
                }
                if (z.llIIlIllIIIlI(lllllllllllllllllIllIIIllIllIIlI) && z.llIIlIlIllllI(lllllllllllllllllIllIIIllIllIIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    public int T() {
        ...
        catch (Exception lllllllllllllllllIllIIIllIlIllII) {
            lllllllllllllllllIllIIIllIlIllII.printStackTrace();
        }
        if ((0x2F ^ 6 ^ (0x31 ^ 0x1C)) != (0x7D ^ 0x2F ^ (0x11 ^ 0x47))) {
            return (20 + 72 - -95 + 1 ^ 180 + 11 - 140 + 133) & (0xE6 ^ 0xA9 ^ (0x6B ^ 0x20) ^ -" ".length());
        }
    ...
    private static void llIIlIlIlllII() {
        ...
        z.lllIlllllI[z.llllIIIIII[0]] = z.llIIlIlIllIIl("OD8tHxgdaj0CExc5", "zJTvv");
        z.lllIlllllI[z.llllIIIIII[1]] = z.llIIlIlIllIlI("wCeRHt6QgkfD7JLvxm+j3Iub+8DFoNeP4+i0R38ONQ1K0XZAMbI5iKimM+xipT/F", "MDOuh");
        z.lllIlllllI[z.llllIIIIII[4]] = z.llIIlIlIllIlI("a/eMIkfaJQW81zLRKYM3ew==", "EcLPN");
        z.lllIlllllI[z.llllIIIIII[5]] = z.llIIlIlIllIIl("BgQWHj0nCx9aMy8LExM/KQ==", "NexzQ");
        z.lllIlllllI[z.llllIIIIII[2]] = z.llIIlIlIllIlI("vHvEVzaFONphPNuzGb5M8Yia6y17gA+4gandyfLVznTtx+pHqRe+e1Drml8VYRfH9QqOvg4g4j0=", "JuVaA");
        z.lllIlllllI[z.llllIIIIII[11]] = z.llIIlIlIllIlI("QDHDf5v5UrKZWc5sIT8/kA==", "veIQI");
        z.lllIlllllI[z.llllIIIIII[12]] = z.llIIlIlIllIIl("OysUJzgaJB1jMBorFiwz", "sJzCT");
        z.lllIlllllI[z.llllIIIIII[13]] = z.llIIlIlIllIlI("ZWahxn32WPA=", "pivwj");
        z.lllIlllllI[z.llllIIIIII[22]] = z.llIIlIlIllIll("NFj4smh3w24kyDLjKAvpVCMbYrQxZcII", "rkkZy");
        z.lllIlllllI[z.llllIIIIII[23]] = z.llIIlIlIllIll("VlaYgQmWeIR+cfoo1F464XqFCWcemmMa", "zZxIa");
        z.lllIlllllI[z.llllIIIIII[14]] = z.llIIlIlIllIlI("4sPM5M0xjTqw5g6piu0AIEH7JwFzX4Je", "RmYNK");
        z.lllIlllllI[z.llllIIIIII[26]] = z.llIIlIlIllIll("dMQqZMpjyd1mE0xEHFX9VWQrfTKlqGuXkSwdXyCZPlebsxBlTNqJWNbESWiqXqX1", "lXsaO");
        z.lllIlllllI[z.llllIIIIII[27]] = z.llIIlIlIllIll("Nn0II0inzJT+MER2to8xtuFuRT6UiMsDGSJe/7ZLgCPKRX7M5GLBAs1yTpDx/av/", "OxnLR");
        z.lllIlllllI[z.llllIIIIII[28]] = z.llIIlIlIllIIl("CDUBYQ==", "QPrOI");
        z.lllIlllllI[z.llllIIIIII[29]] = z.llIIlIlIllIll("QCQArTmza2ts1+tuJo6wCQ==", "KBYrp");
    }
    ...
    private static String llIIlIlIllIIl(String lllllllllllllllllIllIIIllIIIIlll, String lllllllllllllllllIllIIIllIIIIllI) {
        lllllllllllllllllIllIIIllIIIIlll = new String(Base64.getDecoder().decode(lllllllllllllllllIllIIIllIIIIlll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllIllIIIllIIIIlIl = new StringBuilder();
        char[] lllllllllllllllllIllIIIllIIIIlII = lllllllllllllllllIllIIIllIIIIllI.toCharArray();
        int lllllllllllllllllIllIIIllIIIIIll = llllIIIIII[0];
        char[] lllllllllllllllllIllIIIlIlllllIl = lllllllllllllllllIllIIIllIIIIlll.toCharArray();
        int lllllllllllllllllIllIIIlIlllllII = lllllllllllllllllIllIIIlIlllllIl.length;
        int lllllllllllllllllIllIIIlIllllIll = llllIIIIII[0];
        while (z.llIIlIlIlllll(lllllllllllllllllIllIIIlIllllIll, lllllllllllllllllIllIIIlIlllllII)) {
            char lllllllllllllllllIllIIIllIIIlIII = lllllllllllllllllIllIIIlIlllllIl[lllllllllllllllllIllIIIlIllllIll];
            lllllllllllllllllIllIIIllIIIIlIl.append((char)(lllllllllllllllllIllIIIllIIIlIII ^ lllllllllllllllllIllIIIllIIIIlII[lllllllllllllllllIllIIIllIIIIIll % lllllllllllllllllIllIIIllIIIIlII.length]));
            "".length();
            ++lllllllllllllllllIllIIIllIIIIIll;
            ++lllllllllllllllllIllIIIlIllllIll;
            "".length();
    ...
    private static void llIIlIlIlllIl() {
        ...
        z.llllIIIIII[1] = " ".length();
        z.llllIIIIII[2] = 0x63 ^ 0x6B ^ (0x64 ^ 0x68);
        z.llllIIIIII[3] = 0x7E ^ 0x63;
        z.llllIIIIII[4] = "  ".length();
        z.llllIIIIII[5] = "   ".length();
        ...
        z.llllIIIIII[22] = 0xBF ^ 0xB6 ^ " ".length();
