...
extends HashMap<Integer, String> {
    ...
    private static void llIlllIIlllIl() {
        ...
        B.lIIIIIlIIII[1] = " ".length();
        B.lIIIIIlIIII[2] = "  ".length();
        B.lIIIIIlIIII[3] = "   ".length();
    ...
    private static void llIlllIIlllII() {
        ...
        B.lIIIIIIllll[B.lIIIIIlIIII[0]] = B.llIlllIIllIIl("KyQIFT0F", "hEzyX");
        B.lIIIIIIllll[B.lIIIIIlIIII[1]] = B.llIlllIIllIlI("b5uLSghdISc=", "yqpfV");
        B.lIIIIIIllll[B.lIIIIIlIIII[2]] = B.llIlllIIllIIl("MhMhMhwYHDg/Gxw=", "qrLWn");
        B.lIIIIIIllll[B.lIIIIIlIIII[3]] = B.llIlllIIllIll("R4cBfiAzgCg=", "aJGjb");
        B.lIIIIIIllll[B.lIIIIIlIIII[4]] = B.llIlllIIllIlI("Gvo1lgwtn/Q=", "MskXB");
    }
