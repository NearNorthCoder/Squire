...
implements S {
    ...
    private static String llIllIllllIII(String lllllllllllllllllIIllllIlIIIIlll, String lllllllllllllllllIIllllIlIIIIllI) {
        try {
            SecretKeySpec lllllllllllllllllIIllllIlIIIlIlI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIIllllIlIIIIllI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllllIIllllIlIIIlIIl = Cipher.getInstance("Blowfish");
            lllllllllllllllllIIllllIlIIIlIIl.init(lIIIIIIllIl[6], lllllllllllllllllIIllllIlIIIlIlI);
    ...
    private static String llIllIllllIIl(String lllllllllllllllllIIllllIlIIlIlll, String lllllllllllllllllIIllllIlIIllIll) {
        lllllllllllllllllIIllllIlIIlIlll = new String(Base64.getDecoder().decode(lllllllllllllllllIIllllIlIIlIlll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllIIllllIlIIllIlI = new StringBuilder();
        ...
        char[] lllllllllllllllllIIllllIlIIlIIlI = lllllllllllllllllIIllllIlIIlIlll.toCharArray();
        int lllllllllllllllllIIllllIlIIlIIIl = lllllllllllllllllIIllllIlIIlIIlI.length;
        int lllllllllllllllllIIllllIlIIlIIII = lIIIIIIllIl[1];
        while (H.llIlllIIIllII(lllllllllllllllllIIllllIlIIlIIII, lllllllllllllllllIIllllIlIIlIIIl)) {
            char lllllllllllllllllIIllllIlIIlllIl = lllllllllllllllllIIllllIlIIlIIlI[lllllllllllllllllIIllllIlIIlIIII];
            lllllllllllllllllIIllllIlIIllIlI.append((char)(lllllllllllllllllIIllllIlIIlllIl ^ lllllllllllllllllIIllllIlIIllIIl[lllllllllllllllllIIllllIlIIllIII % lllllllllllllllllIIllllIlIIllIIl.length]));
            "".length();
            ++lllllllllllllllllIIllllIlIIllIII;
            ++lllllllllllllllllIIllllIlIIlIIII;
            "".length();
            if (((6 ^ 1) & ~(0x6C ^ 0x6B)) == 0) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllIIllllIlIIllIlI);
    }
                    ...
                    if (H.llIlllIIlIIII(Inventory.getCount((int[])nArray4))) {
                        ...
                        if (H.llIlllIIlIIII(Inventory.getCount((int[])nArray5))) {
                            ...
                            if (H.llIlllIIlIIII(Inventory.getCount((int[])nArray6)) && H.llIlllIIlIIII(Inventory.getCount((int[])f.aU))) {
                                n2 = lIIIIIIllIl[0];
                                "".length();
                                if (((180 + 35 - 27 + 16 ^ 161 + 63 - 60 + 34) & (0x62 ^ 0x17 ^ 71 + 26 - 39 + 69 ^ -" ".length())) == 0) return n2 != 0;
                                return ((0x58 ^ 0x7E ^ (5 ^ 3)) & (73 + 87 - 69 + 60 ^ 99 + 71 - 160 + 173 ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
    ...
    private static void llIlllIIIlIIl() {
        ...
        H.lIIIIIIllIl[21] = 0x45 ^ 0x4F ^ "  ".length();
    ...
    private static void llIlllIIIlIII() {
        ...
        H.lIIIIIIlIlI[H.lIIIIIIllIl[1]] = H.llIllIlllIlll("/DplS0S3bkILsmBBkGsJKETGGd2zWSCN6z1f7Nq6+BhkwSUMKkMMSlFgicXFixWi", "zoyPK");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[0]] = H.llIllIllllIII("p3Ka9j3FJhZZ89I9B//Iqw==", "YjYWd");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[6]] = H.llIllIllllIII("MStJOXlVSWZS+yyQmzztA+g51I5I8uRB", "ixMsT");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[9]] = H.llIllIllllIII("BRgDja670mmRcwoasACkixIawFPTqtau/mKHC1Z8vifb8dnURXV07pxhWBHb2cAvAroT4Ia15as=", "mLvdJ");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[7]] = H.llIllIlllIlll("gpWTZkYqYyesvu03OfEPyhVrQYqVN3Xs6wAiquHMjMo4cd15ckMPFRpJ6rEV8LsXqRxG9Mvtvg8=", "Kstyz");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[15]] = H.llIllIllllIIl("NjwlHC8=", "rNLrD");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[17]] = H.llIllIllllIII("63Y0RF/J588=", "qyBNf");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[10]] = H.llIllIllllIII("FiMOJgovFdec+8ljL24Z8A==", "seClY");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[21]] = H.llIllIllllIIl("JSIlJCUfOCN2IAMzNyI=", "vVDVQ");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[22]] = H.llIllIllllIII("VnuEzB+ahKs=", "NnoCN");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[19]] = H.llIllIllllIII("So3SXFFjlJJozK3DwS7ZagxwwXMtI0DA", "UAfKn");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[23]] = H.llIllIllllIIl("HREUH2Q9H1gYLSsCGQY9aRcNDQ==", "IpxtD");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[24]] = H.llIllIllllIII("WRjFhv0dNkg=", "karkt");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[25]] = H.llIllIllllIIl("KhEVZgwLUCcROTY2", "dpcFx");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[26]] = H.llIllIlllIlll("lK6zyNfoTaAqkg9Tl0KMig==", "hygWT");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[27]] = H.llIllIlllIlll("81tWzK8d0+Y=", "RrUCR");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[28]] = H.llIllIllllIIl("GyYfcDY6ZwYiJ3UzADwn", "UGiPB");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[29]] = H.llIllIllllIIl("Czo6CWw0PDcH", "FSTlL");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[30]] = H.llIllIllllIIl("GicLAQ==", "WNedV");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[31]] = H.llIllIlllIlll("JNmS64Rg5gM47LYkGMydHg==", "sINkI");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[32]] = H.llIllIllllIII("S1mvJmq2I+BPPDU2Ri7rsg==", "WzHyf");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[33]] = H.llIllIllllIII("cH4iDhzCR/g=", "LXuGs");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[34]] = H.llIllIllllIIl("DyUePjo5LEsjISg=", "MIkLS");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[35]] = H.llIllIllllIII("EuNVY/r/nkoY0vXL8oVehA==", "fKHTj");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[36]] = H.llIllIlllIlll("nP7RtkSgLe45pesng/SePA==", "UJnJq");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[37]] = H.llIllIllllIII("+61VlOerapm0e8w4Emzk3UX6QftDYvA3", "bJnqi");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[40]] = H.llIllIllllIIl("PCQadDQWOwE6", "oMhTb");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[42]] = H.llIllIllllIII("pArG1zQVFuE=", "KKBqi");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[43]] = H.llIllIllllIIl("LDICHg==", "cBgpB");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[45]] = H.llIllIlllIlll("Q6mgYd+WYhQ=", "oJijy");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[46]] = H.llIllIllllIIl("PDwQBRkH", "oYqwz");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[2]] = H.llIllIllllIIl("AAQ5GA02DWwFFic=", "BhLjd");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[47]] = H.llIllIllllIII("EfIIx+Bqi6PconB4NTlREw==", "fVLBe");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[48]] = H.llIllIlllIlll("dv3lL/5L0fMdv2SNLuly7w==", "xctsW");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[49]] = H.llIllIllllIII("ks9MY65AWHKYVtKyFAztvQ==", "AdgdJ");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[50]] = H.llIllIllllIII("nt3RDOSlTlI=", "LERJO");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[51]] = H.llIllIllllIII("ewP/O+A24DKrSYTb/+7yGg==", "RxDSQ");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[52]] = H.llIllIlllIlll("q4AZS4FxGbBjrdIRf1rZZw==", "kMIlV");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[53]] = H.llIllIllllIIl("CwMSbj4qQiAZCxck", "EbdNJ");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[54]] = H.llIllIllllIII("wKL8xU9iJhlKszNyXgaRKQ==", "teprY");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[55]] = H.llIllIllllIIl("FwkzGTIs", "CaFkU");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[56]] = H.llIllIllllIIl("JgYZBj8QD0wHIQsYCA==", "djltV");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[57]] = H.llIllIllllIII("pyFD26ngAjY8iZVmVC8fGA==", "JzvMh");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[58]] = H.llIllIllllIII("BrIyA8V1K/9taSzs8tEllQ==", "KoNeN");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[59]] = H.llIllIllllIII("5Sj7p/obCNg=", "mfJDe");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[64]] = H.llIllIllllIII("WWiKGjcosQHJ0U8pNnFi5A==", "SgcwE");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[65]] = H.llIllIllllIIl("ORghNUwkF28lCSodOzpMYw==", "KqORl");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[78]] = H.llIllIllllIII("iaoulWj3bGUFEe5MeLVbC2C10CXU41uBGrBdDR5kVOM=", "PowsI");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[79]] = H.llIllIlllIlll("TWHaFcPkbzWY5s1sUWXWiCdjynY9WIvqXKD5Cp/LoEQFteeTjFIR/A==", "oJxEq");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[80]] = H.llIllIlllIlll("RE5CzjiaLLNdyAo5SglkbheY2qquWASEsZTuhgqBXNKhC+gQVkJhBVxiKp+YwFRW", "LGYwH");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[20]] = H.llIllIllllIII("DWoYOBG41WO0rIhjc2wQqoXxxxZmkrKz", "BntUe");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[81]] = H.llIllIllllIIl("ETEqBXYiNmsIOTN5IB85MXkqEzkzLWsFPiN5Ahw1JzcvHnYiLioDICMqdA==", "FYKqV");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[82]] = H.llIllIllllIIl("AikZKD85LxoqazQqByhl", "QFtMK");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[83]] = H.llIllIllllIIl("DwwyICt4Gig5bzQKLClvOUM1KSs6BjU+NngTLilw", "XcGLO");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[84]] = H.llIllIllllIIl("NgsJZggaH0crEB4PRydRBhoCJRgUBkc1BhoYA2YXGhhHKxRK", "ujgFq");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[85]] = H.llIllIllllIIl("NzcdABJWIRoUElYmBRoUEntcWw==", "vUruf");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[86]] = H.llIllIlllIlll("CZoaSUhgHwgz21rGHn7VHYXoRPGBVd2e+2FSYmWxEn6FYkClmUxyXEHxUGtmafTu", "iFaMN");
        H.lIIIIIIlIlI[H.lIIIIIIllIl[87]] = H.llIllIllllIII("p65xvYIZIwk=", "ViiZH");
    }
    ...
    private static void ae() {
        d lllllllllllllllllIIllllIlIlIlIIl;
        Object lllllllllllllllllIIllllIlIlIlIlI;
        block11: {
            block10: {
                int[] nArray = new int[lIIIIIIllIl[0]];
                ...
                if (H.llIlllIIIllIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
                    lllllllllllllllllIIllllIlIlIlIlI = new d(lIIIIIIllIl[13], lIIIIIIllIl[0], i.bp);
                    bu.add((d)lllllllllllllllllIIllllIlIlIlIlI);
                    "".length();
                }
                int[] nArray3 = new int[lIIIIIIllIl[0]];
                nArray3[H.lIIIIIIllIl[1]] = lIIIIIIllIl[8];
            ...
            lllllllllllllllllIIllllIlIlIlIlI = new d(lIIIIIIllIl[8], lIIIIIIllIl[6], i.bp);
            bu.add((d)lllllllllllllllllIIllllIlIlIlIlI);
            "".length();
        }
        int[] nArray = new int[lIIIIIIllIl[0]];
        ...
        if (H.llIlllIIIllIl(Bank.contains((int[])nArray) ? 1 : 0)) {
            lllllllllllllllllIIllllIlIlIlIlI = new d(lIIIIIIllIl[14], lIIIIIIllIl[0], i.bp);
            bu.add((d)lllllllllllllllllIIllllIlIlIlIlI);
            "".length();
        }
        int[] nArray6 = new int[lIIIIIIllIl[0]];
        ...
        if (H.llIlllIIIllIl(Bank.contains((int[])nArray6) ? 1 : 0)) {
            lllllllllllllllllIIllllIlIlIlIlI = new d(lIIIIIIllIl[16], lIIIIIIllIl[27], lIIIIIIllIl[60]);
            bu.add((d)lllllllllllllllllIIllllIlIlIlIlI);
            "".length();
        }
        ...
        if (H.llIlllIIIllIl(Bank.contains((int[])nArray7) ? 1 : 0)) {
            lllllllllllllllllIIllllIlIlIlIlI = new d(lIIIIIIllIl[12], lIIIIIIllIl[19], lIIIIIIllIl[61]);
            bu.add((d)lllllllllllllllllIIllllIlIlIlIlI);
            "".length();
        }
        if (H.llIlllIIIllIl(Bank.contains((Predicate)(lllllllllllllllllIIllllIlIlIlIlI = item -> item.getName().toLowerCase().contains(lIIIIIIlIlI[lIIIIIIllIl[65]]))) ? 1 : 0)) {
            lllllllllllllllllIIllllIlIlIlIIl = new d(lIIIIIIllIl[62], lIIIIIIllIl[15], lIIIIIIllIl[63]);
            bu.add(lllllllllllllllllIIllllIlIlIlIIl);
            "".length();
        }
        int[] nArray8 = new int[lIIIIIIllIl[0]];
        nArray8[H.lIIIIIIllIl[1]] = lIIIIIIllIl[11];
        if (H.llIlllIIIllIl(Bank.contains((int[])nArray8) ? 1 : 0)) {
            lllllllllllllllllIIllllIlIlIlIIl = new d(lIIIIIIllIl[11], lIIIIIIllIl[55], lIIIIIIllIl[61]);
            bu.add(lllllllllllllllllIIllllIlIlIlIIl);
            "".length();
        }
    }

    private static String llIllIlllIlll(String lllllllllllllllllIIllllIIllllIlI, String lllllllllllllllllIIllllIIlllIlll) {
        try {
            SecretKeySpec lllllllllllllllllIIllllIIlllllIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIIllllIIlllIlll.getBytes(StandardCharsets.UTF_8)), lIIIIIIllIl[21]), "DES");
            Cipher lllllllllllllllllIIllllIIlllllII = Cipher.getInstance("DES");
            lllllllllllllllllIIllllIIlllllII.init(lIIIIIIllIl[6], lllllllllllllllllIIllllIIlllllIl);
            return new String(lllllllllllllllllIIllllIIlllllII.doFinal(Base64.getDecoder().decode(lllllllllllllllllIIllllIIllllIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public boolean V() {
        ...
        if (H.llIlllIIIlllI(e.j(lIIIIIIllIl[4]), lIIIIIIllIl[10])) {
            ...
            if ((72 + 9 - -19 + 63 ^ 58 + 121 - 76 + 63) == 0) {
                return ((0xAE ^ 0xC6 ^ (0xF7 ^ 0xA2)) & ((0x8B ^ 0x80) & ~(0x50 ^ 0x5B) ^ (0xA ^ 0x37) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIIIIIllIl[1];
        }
    ...
    public static void cS() {
        ...
        if (H.llIlllIIIllIl(bs ? 1 : 0)) {
            BankLocation lllllllllllllllllIIllllIlIllIIII;
            ...
            if (H.llIlllIIIllIl(H.aa() ? 1 : 0) && H.llIlllIIIlllI(e.j(lIIIIIIllIl[2]), lIIIIIIllIl[3]) && H.llIlllIIIllII(e.j(lIIIIIIllIl[4]), lIIIIIIllIl[0])) {
                lllllllllllllllllIIllllIlIllIIII = BankLocation.getNearest();
                if (H.llIlllIIIllll(lllllllllllllllllIIllllIlIllIIII) && H.llIlllIIIllIl(lllllllllllllllllIIllllIlIllIIII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderTempleTrek.c = lIIIIIIlIlI[lIIIIIIllIl[0]];
                    a.a(lllllllllllllllllIIllllIlIllIIII);
                }
                if (H.llIlllIIIllll(lllllllllllllllllIIllllIlIllIIII) && H.llIlllIIIlIll(lllllllllllllllllIIllllIlIllIIII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (H.llIlllIIIlIll(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    ...
                    if (H.llIlllIIIllIl(Inventory.contains((String[])stringArray2) ? 1 : 0)) {
                        ...
                        if (H.llIlllIIlIIll(Players.getLocal().getWorldLocation().distanceTo(ht), lIIIIIIllIl[9])) {
                            ...
                            lllllllllllllllllIIllllIlIllIIII = new WorldArea(lIIIIIIllIl[38], lIIIIIIllIl[39], lIIIIIIllIl[21], lIIIIIIllIl[7], lIIIIIIllIl[6]);
                            String[] stringArray3 = new String[lIIIIIIllIl[0]];
                            stringArray3[H.lIIIIIIllIl[1]] = lIIIIIIlIlI[lIIIIIIllIl[40]];
                            NPC lllllllllllllllllIIllllIlIlIllll = NPCs.getNearest((String[])stringArray3);
                            if (H.llIlllIIIllll(lllllllllllllllllIIllllIlIlIllll) && H.llIlllIIIlIll(lllllllllllllllllIIllllIlIllIIII.contains(lllllllllllllllllIIllllIlIlIllll.getWorldLocation()) ? 1 : 0)) {
                                e.B();
                            }
                            int[] nArray = new int[lIIIIIIllIl[0]];
                            nArray[H.lIIIIIIllIl[1]] = lIIIIIIllIl[41];
                            TileObject lllllllllllllllllIIllllIlIlIlllI = TileObjects.getNearest((int[])nArray);
                            if (H.llIlllIIIllll(lllllllllllllllllIIllllIlIlIlllI)) {
                                String[] stringArray4 = new String[lIIIIIIllIl[0]];
                                stringArray4[H.lIIIIIIllIl[1]] = lIIIIIIlIlI[lIIIIIIllIl[42]];
                                if (H.llIlllIIIlIll(lllllllllllllllllIIllllIlIlIlllI.hasAction(stringArray4) ? 1 : 0)) {
                                    lllllllllllllllllIIllllIlIlIlllI.interact(lIIIIIIlIlI[lIIIIIIllIl[43]]);
                                    Time.sleepTicks((int)lIIIIIIllIl[6]);
                                    "".length();
                                }
                            }
                            ...
                            TileObject lllllllllllllllllIIllllIlIlIllIl = TileObjects.getNearest((int[])nArray8);
                            if (H.llIlllIIIllll(lllllllllllllllllIIllllIlIlIllIl)) {
                                String[] stringArray5 = new String[lIIIIIIllIl[0]];
                                stringArray5[H.lIIIIIIllIl[1]] = lIIIIIIlIlI[lIIIIIIllIl[45]];
                                if (H.llIlllIIIlIll(lllllllllllllllllIIllllIlIlIllIl.hasAction(stringArray5) ? 1 : 0)) {
                                    lllllllllllllllllIIllllIlIlIllIl.interact(lIIIIIIlIlI[lIIIIIIllIl[46]]);
                                    Time.sleepTicks((int)lIIIIIIllIl[6]);
                                    "".length();
                                    if (H.llIlllIIIlIll(Dialog.isOpen() ? 1 : 0)) {
