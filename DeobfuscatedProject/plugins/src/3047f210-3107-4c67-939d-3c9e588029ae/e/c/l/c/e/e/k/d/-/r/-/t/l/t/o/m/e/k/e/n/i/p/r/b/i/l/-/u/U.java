...
implements S {
    ...
    private static String llIIIlllllIll(String lllllllllllllllllIllIlIIlIlllllI, String lllllllllllllllllIllIlIIlIllllll) {
        try {
            ...
            return new String(lllllllllllllllllIllIlIIllIIIIlI.doFinal(Base64.getDecoder().decode(lllllllllllllllllIllIlIIlIlllllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
            ...
            block19: {
                block18: {
                    ...
                    if (U.llIIlIIIIIIll(U.bz() ? 1 : 0) && U.llIIlIIIIIIlI(Skills.getLevel((Skill)Skill.DEFENCE), lllIllIIlI[2])) {
                        BankLocation lllllllllllllllllIllIlIIllIlIlII = BankLocation.getNearest();
                        if (U.llIIlIIIIIlII(lllllllllllllllllIllIlIIllIlIlII) && U.llIIlIIIIIIll(lllllllllllllllllIllIlIIllIlIlII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            AccBuilderTempleTrek.c = lllIllIIIl[lllIllIIlI[3]];
                            a.a(lllllllllllllllllIllIlIIllIlIlII);
                        }
                        if (U.llIIlIIIIIlII(lllllllllllllllllIllIlIIllIlIlII) && U.llIIlIIIIIIIl(lllllllllllllllllIllIlIIllIlIlII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    public static void ae() {
        d lllllllllllllllllIllIlIIllIIlllI;
        int[] nArray = new int[lllIllIIlI[1]];
        ...
        if (U.llIIlIIIIIIll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lllllllllllllllllIllIlIIllIIlllI = new d(lllIllIIlI[52], lllIllIIlI[10], lllIllIIlI[51]);
            bu.add(lllllllllllllllllIllIlIIllIIlllI);
            "".length();
        }
        int[] nArray3 = new int[lllIllIIlI[1]];
        nArray3[U.lllIllIIlI[0]] = lllIllIIlI[49];
        if (U.llIIlIIIIIIll(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllllIllIlIIllIIlllI = new d(lllIllIIlI[49], lllIllIIlI[1], lllIllIIlI[53]);
            bu.add(lllllllllllllllllIllIlIIllIIlllI);
            "".length();
        }
        ...
        if (U.llIIlIIIIIIll(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllllIllIlIIllIIlllI = new d(lllIllIIlI[47], lllIllIIlI[1], lllIllIIlI[54]);
            bu.add(lllllllllllllllllIllIlIIllIIlllI);
            "".length();
        }
        ...
        if (U.llIIlIIIIIIll(Bank.contains((int[])nArray5) ? 1 : 0)) {
            lllllllllllllllllIllIlIIllIIlllI = new d(lllIllIIlI[11], lllIllIIlI[12], lllIllIIlI[55]);
            bu.add(lllllllllllllllllIllIlIIllIIlllI);
            "".length();
        }
        ...
        if (U.llIIlIIIIIIll(Bank.contains((int[])nArray6) ? 1 : 0)) {
            lllllllllllllllllIllIlIIllIIlllI = new d(lllIllIIlI[40], lllIllIIlI[1], lllIllIIlI[56]);
            bu.add(lllllllllllllllllIllIlIIllIIlllI);
            "".length();
        }
        ...
        if (U.llIIlIIIIIIll(Bank.contains((int[])nArray7) ? 1 : 0)) {
            lllllllllllllllllIllIlIIllIIlllI = new d(lllIllIIlI[44], lllIllIIlI[1], lllIllIIlI[56]);
            bu.add(lllllllllllllllllIllIlIIllIIlllI);
            "".length();
        }
        ...
        if (U.llIIlIIIIIIll(Bank.contains((int[])nArray8) ? 1 : 0)) {
            lllllllllllllllllIllIlIIllIIlllI = new d(lllIllIIlI[45], lllIllIIlI[1], lllIllIIlI[56]);
            bu.add(lllllllllllllllllIllIlIIllIIlllI);
            "".length();
        }
        ...
        if (U.llIIlIIIIIIll(Bank.contains((int[])nArray9) ? 1 : 0)) {
            lllllllllllllllllIllIlIIllIIlllI = new d(lllIllIIlI[42], lllIllIIlI[1], lllIllIIlI[56]);
            bu.add(lllllllllllllllllIllIlIIllIIlllI);
            "".length();
        }
        if (U.llIIlIIIIIllI(Skills.getLevel((Skill)Skill.ATTACK), lllIllIIlI[2])) {
            ...
            if (U.llIIlIIIIIIll(Bank.contains((int[])nArray10) ? 1 : 0)) {
                lllllllllllllllllIllIlIIllIIlllI = new d(lllIllIIlI[17], lllIllIIlI[1], lllIllIIlI[54]);
                bu.add(lllllllllllllllllIllIlIIllIIlllI);
                "".length();
            }
        }
        ...
        if (U.llIIlIIIIIIll(Bank.contains((int[])nArray11) ? 1 : 0)) {
            lllllllllllllllllIllIlIIllIIlllI = new d(lllIllIIlI[16], lllIllIIlI[1], lllIllIIlI[56]);
            bu.add(lllllllllllllllllIllIlIIllIIlllI);
            "".length();
        }
    }

    private static String llIIIllllllIl(String lllllllllllllllllIllIlIIlIIllIll, String lllllllllllllllllIllIlIIlIIllIII) {
        try {
            SecretKeySpec lllllllllllllllllIllIlIIlIIllllI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIllIlIIlIIllIII.getBytes(StandardCharsets.UTF_8)), lllIllIIlI[18]), "DES");
            Cipher lllllllllllllllllIllIlIIlIIlllIl = Cipher.getInstance("DES");
            lllllllllllllllllIllIlIIlIIlllIl.init(lllIllIIlI[3], lllllllllllllllllIllIlIIlIIllllI);
    ...
    public int T() {
        ...
        catch (Exception lllllllllllllllllIllIlIIllIIllII) {
            lllllllllllllllllIllIlIIllIIllII.printStackTrace();
        }
        if (" ".length() <= ((0x84 ^ 0x90) & ~(0x42 ^ 0x56))) {
    ...
    public static boolean bz() {
        ...
        block18: {
            ...
            if (U.llIIlIIIIIIIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                return ((0xE5 ^ 0x8D ^ (0xE ^ 0x63)) & (0x76 ^ 0x7B ^ (9 ^ 1) ^ -" ".length())) != 0;
            }
        }
        n2 = lllIllIIlI[0];
        return n2 != 0;
    ...
    private static void llIIIllllllll() {
        ...
        U.lllIllIIlI[0] = (135 + 0 - 29 + 41 ^ 81 + 116 - 114 + 80) & (71 + 108 - 109 + 62 ^ 162 + 60 - 158 + 116 ^ -" ".length());
        U.lllIllIIlI[1] = " ".length();
        U.lllIllIIlI[2] = 0xEC ^ 0x88 ^ (0x23 ^ 0x6F);
        U.lllIllIIlI[3] = "  ".length();
        U.lllIllIIlI[4] = "   ".length();
    ...
    private static void llIIIlllllllI() {
        ...
        U.lllIllIIIl[U.lllIllIIlI[0]] = U.llIIIlllllIll("kgrRn9KHf4TGy1Ti15A/gw==", "JnrLj");
        U.lllIllIIIl[U.lllIllIIlI[1]] = U.llIIIlllllIll("Yysqhnl5XCHW/lyDFkfMltXB7T/n39fXq1SfzE44wHi7wFg0sl7MCpC43eiYxiZVuvidzJMBZXI=", "xmgju");
        U.lllIllIIIl[U.lllIllIIlI[3]] = U.llIIIllllllII("CDsYHignLgcZKGYuAVctJzQF", "FZnwO");
        U.lllIllIIIl[U.lllIllIIlI[4]] = U.llIIIllllllIl("EgYRq+Fkp0rWqsytCpgzDn+sioFfi2XM", "IwUzl");
        U.lllIllIIIl[U.lllIllIIlI[6]] = U.llIIIlllllIll("//4o1Ep8oc0UZJPcyi/4WRcW71UgdjnLsL7ZnurRDrNM39+2fX1sUx+t9wbcR/nc", "URFrw");
        U.lllIllIIIl[U.lllIllIIlI[10]] = U.llIIIllllllII("DgoCBWQ0GwQGLTMZHw==", "GxmkD");
        U.lllIllIIIl[U.lllIllIIlI[14]] = U.llIIIllllllIl("uTb2b9CmivdQrdLvtNWNdw==", "LYEoi");
        U.lllIllIIIl[U.lllIllIIlI[15]] = U.llIIIllllllII("LBkDGysIHFcAOggdHgc4Ew==", "apwsY");
        U.lllIllIIIl[U.lllIllIIlI[18]] = U.llIIIllllllII("IBY2", "ewBBZ");
        U.lllIllIIIl[U.lllIllIIlI[20]] = U.llIIIllllllII("EwAdPSMqBlEiJWQCHiFqJRMUNw==", "DaqVJ");
        U.lllIllIIIl[U.lllIllIIlI[21]] = U.llIIIllllllIl("41TPI8iqHX5DzsUgWGrWtw==", "kmtAY");
        U.lllIllIIIl[U.lllIllIIlI[22]] = U.llIIIlllllIll("Dl3YFOJbg6s=", "XLlFk");
        U.lllIllIIIl[U.lllIllIIlI[23]] = U.llIIIllllllII("Mxww", "PsGmw");
        U.lllIllIIIl[U.lllIllIIlI[24]] = U.llIIIllllllIl("58Ssp+UtXa8=", "WdCSA");
        U.lllIllIIIl[U.lllIllIIlI[25]] = U.llIIIlllllIll("2VgFklEyAVY=", "tlOgF");
        U.lllIllIIIl[U.lllIllIIlI[13]] = U.llIIIlllllIll("TbkhDSKbgYOMGakydY3CPg==", "HXZyV");
        U.lllIllIIIl[U.lllIllIIlI[26]] = U.llIIIllllllIl("57z/gM/0tns=", "Bxvmn");
        U.lllIllIIIl[U.lllIllIIlI[29]] = U.llIIIllllllIl("Dizjr2DrLFx7tXIXje/xZQ==", "ngyxf");
        U.lllIllIIIl[U.lllIllIIlI[30]] = U.llIIIllllllII("EDU9BnUqJDsFPC0mIA==", "YGRhU");
        U.lllIllIIIl[U.lllIllIIlI[31]] = U.llIIIllllllII("Fiw/HDc=", "AEZpS");
        U.lllIllIIIl[U.lllIllIIlI[19]] = U.llIIIlllllIll("67q+W1D2w4+2AV73gfzWRQ==", "qWVmD");
        U.lllIllIIIl[U.lllIllIIlI[32]] = U.llIIIllllllIl("tShKO1Sho3ygsXErRBM1ag==", "irJwe");
        U.lllIllIIIl[U.lllIllIIlI[33]] = U.llIIIllllllIl("dPTBBP9PvfI=", "iPSEd");
        U.lllIllIIIl[U.lllIllIIlI[35]] = U.llIIIllllllIl("wZxf8UEMDZqJZJMomyg987Nq/gDesFhI", "AelYn");
        U.lllIllIIIl[U.lllIllIIlI[36]] = U.llIIIllllllIl("4MwFW8zcYdDThw7mv8fj5li6+8FeHJ81", "yNCrk");
        U.lllIllIIIl[U.lllIllIIlI[37]] = U.llIIIllllllII("JgsyHBQ=", "qbWpp");
        U.lllIllIIIl[U.lllIllIIlI[38]] = U.llIIIlllllIll("OU8f8itR1wU=", "lqBhQ");
        U.lllIllIIIl[U.lllIllIIlI[39]] = U.llIIIlllllIll("L3GiEjtYWPk=", "oJyTh");
        U.lllIllIIIl[U.lllIllIIlI[41]] = U.llIIIlllllIll("3givbN0pAa0=", "hxlmq");
        U.lllIllIIIl[U.lllIllIIlI[43]] = U.llIIIllllllIl("IyIiC2rcyow=", "OxEJG");
        U.lllIllIIIl[U.lllIllIIlI[34]] = U.llIIIllllllIl("tMbUfZPTVfs=", "OnvoI");
        U.lllIllIIIl[U.lllIllIIlI[46]] = U.llIIIlllllIll("WsEgW0ecWq8=", "HQMAn");
        U.lllIllIIIl[U.lllIllIIlI[48]] = U.llIIIllllllII("BRQqBA==", "RqKvS");
        U.lllIllIIIl[U.lllIllIIlI[50]] = U.llIIIllllllII("DQAPJA==", "ZenVs");
        U.lllIllIIIl[U.lllIllIIlI[57]] = U.llIIIlllllIll("F543WICAGYc=", "UbuPJ");
        U.lllIllIIIl[U.lllIllIIlI[58]] = U.llIIIllllllII("ADo/", "CUHXe");
    }
    ...
    public static void Z() {
        ...
        if (U.llIIlIIIIIIIl(jb.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (U.llIIlIIIIlIII(Players.getLocal().getInteracting())) {
                NPC lllllllllllllllllIllIlIIllIlIIIl = NPCs.getNearest(nPC -> {
                    int n2;
                    if (U.llIIlIIIIIIIl(nPC.getName().contains(lllIllIIIl[lllIllIIlI[58]]) ? 1 : 0) && U.llIIlIIIIlIII(nPC.getInteracting()) && U.llIIlIIIIIIll(nPC.isDead() ? 1 : 0)) {
                        n2 = lllIllIIlI[1];
                        "".length();
                        if (" ".length() <= ((0xF3 ^ 0xB2 ^ (0x43 ^ 0x16)) & (0xEC ^ 0xB8 ^ (0x1A ^ 0x5A) ^ -" ".length()))) {
                            return ((0x77 ^ 0x3A ^ (0xA5 ^ 0xC5)) & (0xAE ^ 0x85 ^ (6 ^ 0) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lllIllIIlI[0];
                    }
                ...
                List lllllllllllllllllIllIlIIllIlIIII = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                    boolean bl;
                    if (U.llIIlIIIIlIlI(nPC.getInteracting(), Players.getLocal())) {
                        bl = lllIllIIlI[1];
                        "".length();
                        if (((0x47 ^ 0x78) & ~(0x9C ^ 0xA3)) != ((0x8E ^ 0x89) & ~(0x88 ^ 0x8F))) {
                            return ((0x58 ^ 0x39) & ~(0xED ^ 0x8C)) != 0;
                        }
                    } else {
                        bl = lllIllIIlI[0];
                    }
                ...
                if (U.llIIlIIIIIIll(lllllllllllllllllIllIlIIllIlIIII.isEmpty() ? 1 : 0)) {
                    ((NPC)lllllllllllllllllIllIlIIllIlIIII.get(lllIllIIlI[0])).interact(lllIllIIIl[lllIllIIlI[24]]);
                    Time.sleepTicks((int)lllIllIIlI[3]);
                    "".length();
                }
                if (U.llIIlIIIIIlII(lllllllllllllllllIllIlIIllIlIIIl) && U.llIIlIIIIIIll(Players.getLocal().isMoving() ? 1 : 0) && U.llIIlIIIIIIIl(lllllllllllllllllIllIlIIllIlIIII.isEmpty() ? 1 : 0)) {
                    lllllllllllllllllIllIlIIllIlIIIl.interact(lllIllIIIl[lllIllIIlI[25]]);
                    Time.sleepTicks((int)lllIllIIlI[3]);
                    "".length();
                }
            }
    ...
    public static boolean dB() {
        ...
        block15: {
                                        ...
                                        block14: {
                                            block4: {
                                                ...
                                                block6: {
                                                    ...
                                                    return ((136 + 9 - -4 + 17 ^ 91 + 58 - 36 + 25) & (0x24 ^ 0x35 ^ (0x7D ^ 0x40) ^ -" ".length())) != 0;
                                                }
                                                n3 = lllIllIIlI[0];
                                                return n3 != 0;
                                            }
            ...
            return ((115 + 177 - 167 + 101 ^ 135 + 58 - 61 + 49) & (96 + 179 - 140 + 57 ^ 54 + 57 - 68 + 108 ^ -" ".length())) != 0;
        }
        n2 = lllIllIIlI[0];
        return n2 != 0;
    }
    ...
    private static String llIIIllllllII(String lllllllllllllllllIllIlIIlIllIIII, String lllllllllllllllllIllIlIIlIlIllll) {
        lllllllllllllllllIllIlIIlIllIIII = new String(Base64.getDecoder().decode(lllllllllllllllllIllIlIIlIllIIII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllIllIlIIlIlIlllI = new StringBuilder();
        ...
        char[] lllllllllllllllllIllIlIIlIlIIllI = lllllllllllllllllIllIlIIlIllIIII.toCharArray();
        int lllllllllllllllllIllIlIIlIlIIlIl = lllllllllllllllllIllIlIIlIlIIllI.length;
        int lllllllllllllllllIllIlIIlIlIIlII = lllIllIIlI[0];
        while (U.llIIlIIIIIIlI(lllllllllllllllllIllIlIIlIlIIlII, lllllllllllllllllIllIlIIlIlIIlIl)) {
            char lllllllllllllllllIllIlIIlIllIIIl = lllllllllllllllllIllIlIIlIlIIllI[lllllllllllllllllIllIlIIlIlIIlII];
            lllllllllllllllllIllIlIIlIlIlllI.append((char)(lllllllllllllllllIllIlIIlIllIIIl ^ lllllllllllllllllIllIlIIlIlIllIl[lllllllllllllllllIllIlIIlIlIllII % lllllllllllllllllIllIlIIlIlIllIl.length]));
            "".length();
        ...
        return String.valueOf(lllllllllllllllllIllIlIIlIlIlllI);
    }
