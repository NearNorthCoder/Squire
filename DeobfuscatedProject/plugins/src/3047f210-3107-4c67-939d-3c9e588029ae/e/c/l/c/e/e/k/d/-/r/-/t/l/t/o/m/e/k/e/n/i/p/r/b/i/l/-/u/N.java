...
implements S {
    ...
    private static void ae() {
        d lllllllllllllllllIllIIlIlIllIIII;
        Object lllllllllllllllllIllIIlIlIllIIIl;
        block8: {
            block7: {
            ...
            lllllllllllllllllIllIIlIlIllIIIl = new d(lllIllllIl[9], lllIllllIl[10], lllIllllIl[25]);
            bu.add((d)lllllllllllllllllIllIIlIlIllIIIl);
            "".length();
        }
        int[] nArray = new int[lllIllllIl[1]];
        nArray[N.lllIllllIl[0]] = lllIllllIl[12];
        if (N.llIIlIlIIlllI(Bank.contains((int[])nArray) ? 1 : 0)) {
            lllllllllllllllllIllIIlIlIllIIIl = new d(lllIllllIl[12], lllIllllIl[18], lllIllllIl[25]);
            bu.add((d)lllllllllllllllllIllIIlIlIllIIIl);
            "".length();
        }
        if (N.llIIlIlIIlllI(Bank.contains((Predicate)(lllllllllllllllllIllIIlIlIllIIIl = item -> item.getName().toLowerCase().contains(lllIllllII[lllIllllIl[33]]))) ? 1 : 0)) {
            lllllllllllllllllIllIIlIlIllIIII = new d(lllIllllIl[26], lllIllllIl[8], lllIllllIl[27]);
            bu.add(lllllllllllllllllIllIIlIlIllIIII);
            "".length();
        }
        int[] nArray4 = new int[lllIllllIl[1]];
        nArray4[N.lllIllllIl[0]] = lllIllllIl[13];
        if (N.llIIlIlIIlllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllllIllIIlIlIllIIII = new d(lllIllllIl[13], lllIllllIl[28], lllIllllIl[25]);
            bu.add(lllllllllllllllllIllIIlIlIllIIII);
            "".length();
        }
        if (N.llIIlIlIIlllI(Bank.contains((int[])f.aU) ? 1 : 0)) {
            lllllllllllllllllIllIIlIlIllIIII = new d(lllIllllIl[29], lllIllllIl[8], i.bp);
            bu.add(lllllllllllllllllIllIIlIlIllIIII);
            "".length();
        }
    }
    ...
    private static void llIIlIlIIlIlI() {
        ...
        N.lllIllllII[N.lllIllllIl[0]] = N.llIIlIlIIIlll("EB4TOD81SwMlND8Y", "RkjQQ");
        N.lllIllllII[N.lllIllllIl[1]] = N.llIIlIlIIlIII("5T53NwPtqgYDVg0zYq1i7aDPTPyRhKf1Y2e5YbA7fqWL5T0tBe0P8ph2olnyocDP7+rdcMief5k=", "wJNyn");
        N.lllIllllII[N.lllIllllIl[3]] = N.llIIlIlIIIlll("LTMOCRg=", "iAggs");
        N.lllIllllII[N.lllIllllIl[5]] = N.llIIlIlIIlIII("YYp8pbrn6Eccq+UHBlAAp/CaV2+jF9mG", "ZAYle");
        N.lllIllllII[N.lllIllllIl[6]] = N.llIIlIlIIIlll("KRssBhAIDGkKGAgA", "fkIhy");
        N.lllIllllII[N.lllIllllIl[8]] = N.llIIlIlIIlIII("Jc7Ark6Ooy2sznOrrh9Xvj8ROAnP/QzC", "FboXr");
        N.lllIllllII[N.lllIllllIl[11]] = N.llIIlIlIIlIII("F+0VFqKesv1umu3h5exc2APHDtoWbtN10ufNyDgrKY5m5EE62qVPq86foxR5LtDB", "unWcY");
        N.lllIllllII[N.lllIllllIl[14]] = N.llIIlIlIIlIII("SQlj0pKBaPlS/iokcLBS67bgfQfEBa5z2tg/Wwo6mz7U6bmfl5EdhJoeIZFoCk0D", "loNAk");
        N.lllIllllII[N.lllIllllIl[16]] = N.llIIlIlIIlIIl("btx1sRjsaN68BHrKcvrqrg==", "naRYk");
        N.lllIllllII[N.lllIllllIl[17]] = N.llIIlIlIIlIIl("OHwp0TV+uG8bBweK/zEBkA==", "rfuir");
        N.lllIllllII[N.lllIllllIl[18]] = N.llIIlIlIIlIIl("Df/Cc0wJa5Nxo4qYZ4kGrQ==", "OacBJ");
        N.lllIllllII[N.lllIllllIl[19]] = N.llIIlIlIIlIIl("xZJZJMeete1er/LbtXR9Sw==", "oLLWT");
        N.lllIllllII[N.lllIllllIl[20]] = N.llIIlIlIIlIII("0QInn2gqaxA=", "inpUX");
        N.lllIllllII[N.lllIllllIl[22]] = N.llIIlIlIIIlll("KFYjRg4OHiUPDAZRKAkQQRBuFxcEAjpI", "aqNfb");
        N.lllIllllII[N.lllIllllIl[23]] = N.llIIlIlIIlIII("aubphuPTsFKpe6mBFeVxSuwMTHo3rgLipwHljZnkrXE=", "ffhFr");
        N.lllIllllII[N.lllIllllIl[24]] = N.llIIlIlIIlIII("rzphcZnRur4=", "vLleZ");
        N.lllIllllII[N.lllIllllIl[31]] = N.llIIlIlIIIlll("OhE1KQBJCjgpERscImwBHBwjOA==", "iyPLp");
        N.lllIllllII[N.lllIllllIl[33]] = N.llIIlIlIIlIIl("QXFoAz0pycKbNxpdT4AjqyWapxR4j7o5", "LBwPj");
        N.lllIllllII[N.lllIllllIl[36]] = N.llIIlIlIIlIIl("z63HZ1z+nLfTHrVSV+VsBB22XJgDPTiWi/K2a1bOgHQ=", "BQqEv");
        N.lllIllllII[N.lllIllllIl[37]] = N.llIIlIlIIIlll("Cy00dEs9IyYhRXIBZzsKPGgjN0smICYsRQ==", "RHGXk");
        N.lllIllllII[N.lllIllllIl[10]] = N.llIIlIlIIlIII("jSS1pEXItaE=", "QEEiD");
    }

    private static String llIIlIlIIlIIl(String lllllllllllllllllIllIIlIlIIllIIl, String lllllllllllllllllIllIIlIlIIlIllI) {
        try {
            SecretKeySpec lllllllllllllllllIllIIlIlIIlllII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIllIIlIlIIlIllI.getBytes(StandardCharsets.UTF_8)), lllIllllIl[16]), "DES");
            Cipher lllllllllllllllllIllIIlIlIIllIll = Cipher.getInstance("DES");
            lllllllllllllllllIllIIlIlIIllIll.init(lllIllllIl[3], lllllllllllllllllIllIIlIlIIlllII);
            return new String(lllllllllllllllllIllIIlIlIIllIll.doFinal(Base64.getDecoder().decode(lllllllllllllllllIllIIlIlIIllIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void dg() {
        List lllllllllllllllllIllIIlIlIllIlIl;
        ...
        if (N.llIIlIlIIllII(Dialog.isOpen() ? 1 : 0) && N.llIIlIlIIllII(Dialog.isViewingOptions() ? 1 : 0) && N.llIIlIlIIlllI((lllllllllllllllllIllIIlIlIllIlIl = Dialog.getOptions()).isEmpty() ? 1 : 0)) {
            int lllllllllllllllllIllIIlIlIllIlII = lllIllllIl[0];
            while (N.llIIlIlIIllIl(lllllllllllllllllIllIIlIlIllIlII, lllllllllllllllllIllIIlIlIllIlIl.size())) {
                if (N.llIIlIlIIllII(((Widget)lllllllllllllllllIllIIlIlIllIlIl.get(lllllllllllllllllIllIIlIlIllIlII)).getText().equalsIgnoreCase(lllIllllII[lllIllllIl[22]]) ? 1 : 0)) {
                    String[] stringArray = new String[lllIllllIl[1]];
                    stringArray[N.lllIllllIl[0]] = ((Widget)lllllllllllllllllIllIIlIlIllIlIl.get(lllllllllllllllllIllIIlIlIllIlII)).getText();
                ...
                if (N.llIIlIlIIllII(((Widget)lllllllllllllllllIllIIlIlIllIlIl.get(lllllllllllllllllIllIIlIlIllIlII)).getText().equalsIgnoreCase(lllIllllII[lllIllllIl[23]]) ? 1 : 0)) {
                    String[] stringArray = new String[lllIllllIl[1]];
                    stringArray[N.lllIllllIl[0]] = ((Widget)lllllllllllllllllIllIIlIlIllIlIl.get(lllllllllllllllllIllIIlIlIllIlII)).getText();
                    Dialog.chooseOption((String[])stringArray);
                    "".length();
                ...
                if (N.llIIlIlIIllII(((Widget)lllllllllllllllllIllIIlIlIllIlIl.get(lllllllllllllllllIllIIlIlIllIlII)).getText().equalsIgnoreCase(lllIllllII[lllIllllIl[24]]) ? 1 : 0)) {
                    String[] stringArray = new String[lllIllllIl[1]];
                    stringArray[N.lllIllllIl[0]] = ((Widget)lllllllllllllllllIllIIlIlIllIlIl.get(lllllllllllllllllIllIIlIlIllIlII)).getText();
                    Dialog.chooseOption((String[])stringArray);
                    "".length();
                ...
                ++lllllllllllllllllIllIIlIlIllIlII;
                "".length();
    ...
    private static String llIIlIlIIIlll(String lllllllllllllllllIllIIlIlIIIlIIl, String lllllllllllllllllIllIIlIlIIIlIII) {
        lllllllllllllllllIllIIlIlIIIlIIl = new String(Base64.getDecoder().decode(lllllllllllllllllIllIIlIlIIIlIIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        ...
        char[] lllllllllllllllllIllIIlIIlllllll = lllllllllllllllllIllIIlIlIIIlIIl.toCharArray();
        int lllllllllllllllllIllIIlIIllllllI = lllllllllllllllllIllIIlIIlllllll.length;
        int lllllllllllllllllIllIIlIIlllllIl = lllIllllIl[0];
        while (N.llIIlIlIIllIl(lllllllllllllllllIllIIlIIlllllIl, lllllllllllllllllIllIIlIIllllllI)) {
            char lllllllllllllllllIllIIlIlIIIlIlI = lllllllllllllllllIllIIlIIlllllll[lllllllllllllllllIllIIlIIlllllIl];
            lllllllllllllllllIllIIlIlIIIIlll.append((char)(lllllllllllllllllIllIIlIlIIIlIlI ^ lllllllllllllllllIllIIlIlIIIIllI[lllllllllllllllllIllIIlIlIIIIlIl % lllllllllllllllllIllIIlIlIIIIllI.length]));
            "".length();
            ++lllllllllllllllllIllIIlIlIIIIlIl;
            ++lllllllllllllllllIllIIlIIlllllIl;
            "".length();
            if (((135 + 0 - 70 + 118 ^ 83 + 115 - 118 + 73) & (22 + 50 - 38 + 127 ^ 29 + 19 - -52 + 43 ^ -" ".length())) > -" ".length()) continue;
            return null;
        }
    ...
    private static void llIIlIlIIlIll() {
        ...
        N.lllIllllIl[0] = (128 + 220 - 330 + 234 ^ 40 + 125 - 98 + 103) & (0xCE ^ 0x99 ^ " ".length() ^ -" ".length());
        N.lllIllllIl[1] = " ".length();
        N.lllIllllIl[2] = 0x57 ^ 0x65;
        N.lllIllllIl[3] = "  ".length();
        N.lllIllllIl[4] = (0x24 ^ 2) + (0x86 ^ 0xAD) - (0x3A ^ 0x7C) + (136 + 22 - -7 + 3);
        N.lllIllllIl[5] = "   ".length();
    ...
    public static void df() {
        block22: {
            block23: {
                BankLocation lllllllllllllllllIllIIlIlIlllIII;
                block24: {
                    block26: {
                        block25: {
                            ...
                            lllllllllllllllllIllIIlIlIlllIII = BankLocation.getNearest();
                            if (N.llIIlIlIIllll(lllllllllllllllllIllIIlIlIlllIII) && N.llIIlIlIIlllI(lllllllllllllllllIllIIlIlIlllIII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                AccBuilderTempleTrek.c = lllIllllII[lllIllllIl[5]];
                                a.a(lllllllllllllllllIllIIlIlIlllIII);
                            }
                            if (!N.llIIlIlIIllll(lllllllllllllllllIllIIlIlIlllIII) || !N.llIIlIlIIllII(lllllllllllllllllIllIIlIlIlllIII.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block24;
                ...
                if (N.llIIlIlIIllII(N.bz() ? 1 : 0)) {
                    ...
                    if (N.llIIlIlIlIIlI(Players.getLocal().getWorldLocation().distanceTo(ig), lllIllllIl[3])) {
                        ...
                        lllllllllllllllllIllIIlIlIlllIII = NPCs.getNearest((String[])stringArray);
                        if (N.llIIlIlIIllll(lllllllllllllllllIllIIlIlIlllIII) && N.llIIlIlIlIIIl(lllllllllllllllllIllIIlIlIlllIII.getWorldLocation().distanceTo(ig), lllIllllIl[3])) {
                            e.v();
                        }
    ...
    public int T() {
        ...
        if (-"   ".length() > 0) {
            return (1 ^ 0x24 ^ (0x40 ^ 0x72)) & (0 ^ 8 ^ (0x66 ^ 0x79) ^ -" ".length());
        }
