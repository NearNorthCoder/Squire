...
implements S {
    ...
    public boolean V() {
        ...
        if (y.llIlIlIllllll(e.j(gp), llllllIIII[6])) {
            bl = llllllIIII[0];
            "".length();
            if (((0x8D ^ 0x8B ^ (0x83 ^ 0xC6)) & (133 + 94 - 194 + 177 ^ 49 + 95 - 25 + 26 ^ -" ".length())) == -" ".length()) {
                return ((0x5C ^ 0x5B ^ (0x5E ^ 0x41)) & (0x59 ^ 0x4F ^ (8 ^ 6) ^ -" ".length())) != 0;
            }
        } else {
            bl = llllllIIII[1];
        }
    ...
    private static void llIlIlIllIlII() {
        ...
        y.llllllIIII[95] = "   ".length() ^ (0xAA ^ 0x96);
        ...
        y.llllllIIII[139] = -"   ".length() & (0xFFFFC77E & 0x3FEF);
    ...
    private static boolean aa() {
        ...
        while (y.llIlIlIllIlll(lllllllllllllllllIlIIlIIIIIIIlll, ((void)lllllllllllllllllIlIIlIIIIIIlIII).length)) {
            ...
            return ((182 + 162 - 328 + 192 ^ 25 + 104 - 104 + 109) & (60 + 137 - 30 + 64 ^ 37 + 52 - 47 + 135 ^ -" ".length())) != 0;
        }
        return llllllIIII[0];
    }
    ...
    private static void llIlIlIllIIll() {
        ...
        y.lllllIllII[y.llllllIIII[1]] = y.llIlIlIlIIIIl("5D71sonCqtKDGiLkLADyxNzaVT3PxbrDmpbTSNxJ8nkyfj4dPiLPMYeMDMLuKvFM", "OwXdk");
        y.lllllIllII[y.llllllIIII[0]] = y.llIlIlIlIIIlI("HwYkIXpgUWEUCg==", "QcAEZ");
        y.lllllIllII[y.llllllIIII[3]] = y.llIlIlIlIIIll("wQuMmrwTUFYa0TzL9s4feQ==", "OSxtO");
        y.lllllIllII[y.llllllIIII[5]] = y.llIlIlIlIIIll("4YCpascIZRSd7wWu1KkkWoOl3z3ZoHnJ", "hRcxv");
        y.lllllIllII[y.llllllIIII[6]] = y.llIlIlIlIIIIl("4K04D/vb7EPkbB+aWdG14JGMU4SEXkfdaNAciM0SEnc7Ucw/jh0RcdKVQ7maMTL44eUQQCBOQo8=", "nVRxN");
        y.lllllIllII[y.llllllIIII[7]] = y.llIlIlIlIIIIl("0XiZ3DA4q1I=", "jQYwE");
        y.lllllIllII[y.llllllIIII[18]] = y.llIlIlIlIIIll("GPTsekotRdU=", "mrDOf");
        y.lllllIllII[y.llllllIIII[19]] = y.llIlIlIlIIIIl("la2wBoQDNDfNy1J7RhNUJA==", "NyHBX");
        y.lllllIllII[y.llllllIIII[20]] = y.llIlIlIlIIIlI("IzwKRicdPBNGMBEnAgM=", "pUxff");
        y.lllllIllII[y.llllllIIII[34]] = y.llIlIlIlIIIlI("CQIGVCcoQxYbITMRFQcg", "GcptS");
        y.lllllIllII[y.llllllIIII[13]] = y.llIlIlIlIIIIl("ezgSy1L5yNMurJD31xqaKA==", "TFrxi");
        y.lllllIllII[y.llllllIIII[38]] = y.llIlIlIlIIIIl("yLpVW7CBc13TAB9qd5DK7w==", "GlZlL");
        y.lllllIllII[y.llllllIIII[2]] = y.llIlIlIlIIIIl("WXqqze3gkGiTvvn8QfBE8A==", "soWnX");
        y.lllllIllII[y.llllllIIII[35]] = y.llIlIlIlIIIIl("Gc7/UmIv8Wm0wqAOXwPm0Q==", "vViFy");
        y.lllllIllII[y.llllllIIII[39]] = y.llIlIlIlIIIll("EYJwWhWWE4g=", "DKReL");
        y.lllllIllII[y.llllllIIII[16]] = y.llIlIlIlIIIll("xLe+nWTLW34nyhdgfsDi4w==", "rGAil");
        y.lllllIllII[y.llllllIIII[40]] = y.llIlIlIlIIIlI("MBs/PUQaATE6ChsGNCo=", "yiPSd");
        y.lllllIllII[y.llllllIIII[41]] = y.llIlIlIlIIIll("JCYb7pSOHO4=", "ACore");
        y.lllllIllII[y.llllllIIII[42]] = y.llIlIlIlIIIll("ybspwPeLfSg=", "GJKla");
        y.lllllIllII[y.llllllIIII[29]] = y.llIlIlIlIIIlI("LRQ6PCIKRjg3PE8OMD41", "ofURX");
        y.lllllIllII[y.llllllIIII[26]] = y.llIlIlIlIIIlI("HAACGWw2GgweIjcdCQ4=", "UrmwL");
        y.lllllIllII[y.llllllIIII[43]] = y.llIlIlIlIIIIl("c4R1JkjUhmcAze9X2USJRw==", "PvxCd");
        y.lllllIllII[y.llllllIIII[44]] = y.llIlIlIlIIIll("HZpVZE2iMxI=", "apSZn");
        y.lllllIllII[y.llllllIIII[45]] = y.llIlIlIlIIIlI("AiI9LkYlNiIq", "RWNFf");
        y.lllllIllII[y.llllllIIII[31]] = y.llIlIlIlIIIll("YF98EsJlO6U=", "pWXyg");
        y.lllllIllII[y.llllllIIII[46]] = y.llIlIlIlIIIIl("TRxFhFjNkXk=", "LrIzV");
        y.lllllIllII[y.llllllIIII[49]] = y.llIlIlIlIIIlI("JgQsBy5FHTVKKgwaNh5sCQkhDikX", "ehEjL");
        y.lllllIllII[y.llllllIIII[50]] = y.llIlIlIlIIIIl("IPYk7DXyKfZSsuWehC2HGQ==", "tlcec");
        y.lllllIllII[y.llllllIIII[51]] = y.llIlIlIlIIIll("BpEb5CXJOlK5L04O27FQ3JoMuYmMvePd", "zyJRz");
        y.lllllIllII[y.llllllIIII[28]] = y.llIlIlIlIIIlI("Nw0QNwdZFAk=", "tayZe");
        y.lllllIllII[y.llllllIIII[25]] = y.llIlIlIlIIIll("34Py/aSu7kqt6Mvgk2B4v198EuQCCcih", "ELdyk");
        y.lllllIllII[y.llllllIIII[54]] = y.llIlIlIlIIIIl("ZKCJ1AZTYiPbqTWhPcXAjA==", "nqEBZ");
        y.lllllIllII[y.llllllIIII[57]] = y.llIlIlIlIIIlI("Cww6FjQmTTAdNzFNNRw8YwE1FjwmH3QHKA==", "CmTrX");
        y.lllllIllII[y.llllllIIII[58]] = y.llIlIlIlIIIlI("AxctGQ==", "GxBky");
        y.lllllIllII[y.llllllIIII[59]] = y.llIlIlIlIIIIl("6WM5HHl0MYY=", "qkRPu");
        y.lllllIllII[y.llllllIIII[60]] = y.llIlIlIlIIIIl("yo3cevBmyKU=", "NqEXa");
        y.lllllIllII[y.llllllIIII[61]] = y.llIlIlIlIIIlI("BxcDPw==", "HgfQw");
        y.lllllIllII[y.llllllIIII[62]] = y.llIlIlIlIIIIl("zSAi6fCxox4=", "AFEOO");
        y.lllllIllII[y.llllllIIII[63]] = y.llIlIlIlIIIll("AI0aOwWd/bg=", "LERrW");
        y.lllllIllII[y.llllllIIII[65]] = y.llIlIlIlIIIll("s2ubw7qWYrw=", "VTQxE");
        y.lllllIllII[y.llllllIIII[66]] = y.llIlIlIlIIIIl("9hN7s0rEkA8dYfXbi2fOdw==", "kKZaR");
        y.lllllIllII[y.llllllIIII[68]] = y.llIlIlIlIIIll("AvO70HrAtVvno3om/Tm1GMEWSlrL0IEg81G86fgDZHM=", "LiNat");
        y.lllllIllII[y.llllllIIII[69]] = y.llIlIlIlIIIlI("DSwBNx0z", "AMeSx");
        y.lllllIllII[y.llllllIIII[70]] = y.llIlIlIlIIIlI("JjoYFCtIMh4OJw==", "eVqyI");
        y.lllllIllII[y.llllllIIII[73]] = y.llIlIlIlIIIlI("BBgNKCkuTBw1IiU=", "WlxZM");
        y.lllllIllII[y.llllllIIII[74]] = y.llIlIlIlIIIIl("94IvkNQM69M=", "xCsUE");
        y.lllllIllII[y.llllllIIII[75]] = y.llIlIlIlIIIIl("QkgV0bs/CakJCIhEda6esQ==", "qScWS");
        y.lllllIllII[y.llllllIIII[76]] = y.llIlIlIlIIIll("TKGTdPf/ZxE=", "hCLJQ");
        y.lllllIllII[y.llllllIIII[77]] = y.llIlIlIlIIIIl("PxhkC6c48Z1cxeY8Z8TGvw==", "NUwss");
        y.lllllIllII[y.llllllIIII[78]] = y.llIlIlIlIIIlI("CQk3Fw==", "FyRya");
        y.lllllIllII[y.llllllIIII[17]] = y.llIlIlIlIIIIl("6fxPH4g64oxvMs5fDnFDxA==", "zLNHR");
        y.lllllIllII[y.llllllIIII[79]] = y.llIlIlIlIIIIl("77nVDVjxrlQ=", "UjSyT");
        y.lllllIllII[y.llllllIIII[80]] = y.llIlIlIlIIIll("VUatdVprRHdCod5ApG5MIw==", "EzFOK");
        y.lllllIllII[y.llllllIIII[81]] = y.llIlIlIlIIIlI("Ch07Axo=", "MoRov");
        y.lllllIllII[y.llllllIIII[82]] = y.llIlIlIlIIIIl("m+HenJhXnKaAcTrGzodTRA==", "aMtOC");
        y.lllllIllII[y.llllllIIII[85]] = y.llIlIlIlIIIIl("8LnMXh5mk31Wht2A43ahUg==", "bgxAN");
        y.lllllIllII[y.llllllIIII[86]] = y.llIlIlIlIIIlI("GhglDS0k", "VyAiH");
        y.lllllIllII[y.llllllIIII[87]] = y.llIlIlIlIIIll("2Arm/uI1hg2lx/RBM3vTVA==", "yINyA");
        y.lllllIllII[y.llllllIIII[90]] = y.llIlIlIlIIIlI("IwU9I3NW", "gjRQS");
        y.lllllIllII[y.llllllIIII[91]] = y.llIlIlIlIIIll("im1zlBHgPcA2kM/laLyZeA==", "OQzhH");
        y.lllllIllII[y.llllllIIII[92]] = y.llIlIlIlIIIIl("zZhSYFPf+SA=", "Uypzr");
        y.lllllIllII[y.llllllIIII[93]] = y.llIlIlIlIIIlI("PjQMKB0gdR08WGA=", "RUhLx");
        y.lllllIllII[y.llllllIIII[94]] = y.llIlIlIlIIIIl("+aiXHbl8GPo=", "YJvhi");
        y.lllllIllII[y.llllllIIII[95]] = y.llIlIlIlIIIll("KX60UZaMziKbnHEvJmLR0g==", "QdSUE");
        y.lllllIllII[y.llllllIIII[96]] = y.llIlIlIlIIIIl("1GM6N/soivx7jZG0IABE80hoFAS8oIXatP81/QcKFbs=", "QOTve");
        y.lllllIllII[y.llllllIIII[97]] = y.llIlIlIlIIIIl("mQ0zn8kOixVtd8J05ji3uA==", "tgBjf");
        y.lllllIllII[y.llllllIIII[98]] = y.llIlIlIlIIIlI("GDIxHAsm", "TSUxn");
        y.lllllIllII[y.llllllIIII[99]] = y.llIlIlIlIIIll("XAizZHuQSY8/AXkSNyAHbA==", "vKHRw");
        y.lllllIllII[y.llllllIIII[100]] = y.llIlIlIlIIIlI("KyQLPg==", "oKdLs");
        y.lllllIllII[y.llllllIIII[101]] = y.llIlIlIlIIIll("YJ6vhUbR9xA=", "ATBCp");
        y.lllllIllII[y.llllllIIII[102]] = y.llIlIlIlIIIlI("PDkkFQ==", "xVKgv");
        y.lllllIllII[y.llllllIIII[103]] = y.llIlIlIlIIIlI("HykLKg==", "PYnDa");
        y.lllllIllII[y.llllllIIII[104]] = y.llIlIlIlIIIll("EGHKyHUlzTc=", "bhIDb");
        y.lllllIllII[y.llllllIIII[105]] = y.llIlIlIlIIIIl("xVwZdHUO6Vs=", "YrGMm");
        y.lllllIllII[y.llllllIIII[106]] = y.llIlIlIlIIIIl("MqU4x63T/ao=", "FmfQo");
        y.lllllIllII[y.llllllIIII[107]] = y.llIlIlIlIIIlI("OyUjGilVPDo=", "xIJwK");
        y.lllllIllII[y.llllllIIII[110]] = y.llIlIlIlIIIIl("BbhXFFOFZKU=", "OpmYA");
        y.lllllIllII[y.llllllIIII[111]] = y.llIlIlIlIIIIl("Q9f6oW+Wen6PTQcPI5vlqQ==", "DQcBZ");
        y.lllllIllII[y.llllllIIII[112]] = y.llIlIlIlIIIll("4jdo0I2NsUk58mlVW3Eh9w==", "IebXX");
        y.lllllIllII[y.llllllIIII[113]] = y.llIlIlIlIIIIl("tf5EAQnd3L8=", "ViGeF");
        y.lllllIllII[y.llllllIIII[114]] = y.llIlIlIlIIIlI("Mh46MA==", "bkIXU");
        y.lllllIllII[y.llllllIIII[116]] = y.llIlIlIlIIIlI("AzYACw==", "GYoyu");
        y.lllllIllII[y.llllllIIII[117]] = y.llIlIlIlIIIIl("cWjYx0PUkWs=", "NeWew");
        y.lllllIllII[y.llllllIIII[118]] = y.llIlIlIlIIIll("6O5Uj+nSDBk9dm/C8wce3w==", "pOJNl");
        y.lllllIllII[y.llllllIIII[120]] = y.llIlIlIlIIIll("I/dUnTMPV3M=", "LFLNI");
        y.lllllIllII[y.llllllIIII[121]] = y.llIlIlIlIIIIl("QT1QkOIpQ9s=", "voxDE");
        y.lllllIllII[y.llllllIIII[122]] = y.llIlIlIlIIIll("Xl2Gyb/XOHc=", "YEYMe");
        y.lllllIllII[y.llllllIIII[123]] = y.llIlIlIlIIIIl("KUo5CedQugj3yWiTVpJY/w==", "mMRac");
        y.lllllIllII[y.llllllIIII[125]] = y.llIlIlIlIIIlI("EBYtByE=", "TdDiJ");
        y.lllllIllII[y.llllllIIII[126]] = y.llIlIlIlIIIlI("DTYCBg==", "ZWnjo");
        y.lllllIllII[y.llllllIIII[127]] = y.llIlIlIlIIIlI("Iz0wPQ==", "sHCUj");
        y.lllllIllII[y.llllllIIII[128]] = y.llIlIlIlIIIIl("rp4dKejlMoo=", "QWsLt");
        y.lllllIllII[y.llllllIIII[129]] = y.llIlIlIlIIIll("SFD6A+j8XCM=", "YNYrn");
        y.lllllIllII[y.llllllIIII[130]] = y.llIlIlIlIIIll("3xMIjCh3fW0=", "OzjKF");
        y.lllllIllII[y.llllllIIII[131]] = y.llIlIlIlIIIIl("FutNtvxMPQg=", "ttXgo");
        y.lllllIllII[y.llllllIIII[132]] = y.llIlIlIlIIIIl("Y9Qan61nLVR39ReJm05NLA==", "xPqJM");
        y.lllllIllII[y.llllllIIII[133]] = y.llIlIlIlIIIlI("FRM3RAgrEy5EHycIPwE=", "FzEdI");
        y.lllllIllII[y.llllllIIII[141]] = y.llIlIlIlIIIll("ozAQBLaPUZrOQO8EgM+3WXulcXLteDE8", "BQxlC");
        y.lllllIllII[y.llllllIIII[142]] = y.llIlIlIlIIIll("v3wlcjzfvjpOYYUxrKocOf4hK0nbPj/S", "HEcTH");
        y.lllllIllII[y.llllllIIII[143]] = y.llIlIlIlIIIll("c3SISakhYgA=", "isDan");
        y.lllllIllII[y.llllllIIII[140]] = y.llIlIlIlIIIIl("G15K90Fqy3g=", "epnbS");
        y.lllllIllII[y.llllllIIII[144]] = y.llIlIlIlIIIlI("OxUXFzcl", "WtssR");
        y.lllllIllII[y.llllllIIII[145]] = y.llIlIlIlIIIll("tnieOPE6CxJ+B7E3czjtYg==", "RKWqN");
        y.lllllIllII[y.llllllIIII[146]] = y.llIlIlIlIIIlI("CRMQAxE3", "Ertgt");
        y.lllllIllII[y.llllllIIII[147]] = y.llIlIlIlIIIlI("CSYiAytnLiQZJw==", "JJKnI");
        y.lllllIllII[y.llllllIIII[148]] = y.llIlIlIlIIIIl("KApBibF+luY=", "EUxmJ");
        y.lllllIllII[y.llllllIIII[149]] = y.llIlIlIlIIIll("+gJDF6OzkVU3OzHspVI1eA==", "lNcCw");
        y.lllllIllII[y.llllllIIII[150]] = y.llIlIlIlIIIlI("GQ80HhQH", "unPzq");
        y.lllllIllII[y.llllllIIII[151]] = y.llIlIlIlIIIlI("GToZKhR3IwA=", "ZVpGv");
        y.lllllIllII[y.llllllIIII[152]] = y.llIlIlIlIIIlI("OgMGIxIk", "VbbGw");
        y.lllllIllII[y.llllllIIII[153]] = y.llIlIlIlIIIlI("Gh4ZFSZ0BwA=", "YrpxD");
        y.lllllIllII[y.llllllIIII[158]] = y.llIlIlIlIIIll("yLh6FQsnjlE=", "RqcEE");
        y.lllllIllII[y.llllllIIII[159]] = y.llIlIlIlIIIIl("etOY/rwKly5JNJzeLHKEcQ==", "LGAqJ");
        y.lllllIllII[y.llllllIIII[160]] = y.llIlIlIlIIIIl("4i9cnVNm3/8ZNC5SQYGCjkhsBD92Ei02Y/VFppNAMh4=", "DpGMI");
        y.lllllIllII[y.llllllIIII[161]] = y.llIlIlIlIIIlI("GEYqCTx2Em4FMyMDYEYbdgtuAT04CClGOz9GLwgrJgc3SA==", "QfNfR");
    }
                        ...
                        TileObjects.getNearest(tileObject -> {
                            ...
                            if (y.llIlIlIllIllI(tileObject.getName().equalsIgnoreCase(lllllIllII[llllllIIII[146]]) ? 1 : 0)) {
                                ...
                                if (y.llIlIlIllIllI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                                    ...
                                    return ((0x7C ^ 0x66 ^ (0x63 ^ 0x27)) & (51 + 36 - 6 + 73 ^ 166 + 107 - 247 + 170 ^ -" ".length())) != 0;
                                }
                            }
                            n2 = llllllIIII[1];
                            return n2 != 0;
            ...
            if (y.llIlIlIllllll(e.j(gp), llllllIIII[3])) {
                    ...
                    TileObjects.getNearest(tileObject -> {
                        ...
                        if (y.llIlIlIllIllI(tileObject.getName().equalsIgnoreCase(lllllIllII[llllllIIII[144]]) ? 1 : 0)) {
                            ...
                            if (y.llIlIlIllIllI(tileObject.hasAction(stringArray) ? 1 : 0)) {
                                ...
                                return ((105 + 13 - 8 + 137 ^ 168 + 108 - 177 + 78) & (6 ^ 0x34 ^ (0x62 ^ 0x16) ^ -" ".length())) != 0;
                            }
                        }
                        n2 = llllllIIII[1];
                        return n2 != 0;
                ...
                lllllllllllllllllIlIIlIIIIIlIlIl = NPCs.getNearest(nPC -> {
                    ...
                    if (y.llIlIlIllIllI(nPC.getName().contains(lllllIllII[llllllIIII[140]]) ? 1 : 0) && y.llIlIlIllllIl(nPC.getWorldLocation().distanceTo(new WorldPoint(llllllIIII[88], llllllIIII[22], llllllIIII[1])), llllllIIII[0]) && y.llIlIllIIIIlI(nPC.getInteracting(), Players.getLocal())) {
                        n2 = llllllIIII[0];
                        "".length();
                        if ((0xAC ^ 0xA9 ^ " ".length()) <= 0) {
                            return ((0x2C ^ 0x31 ^ (0x2D ^ 0x16)) & (0xF6 ^ 0x81 ^ (0x61 ^ 0x30) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = llllllIIII[1];
                    }
