...
import e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.j;
...
implements S {
    ...
    private static String llIlIlIIIIIlI(String lllllllllllllllllIlIIlIlIIlIllIl, String lllllllllllllllllIlIIlIlIIlIllII) {
        lllllllllllllllllIlIIlIlIIlIllIl = new String(Base64.getDecoder().decode(lllllllllllllllllIlIIlIlIIlIllIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllIlIIlIlIIlIlIll = new StringBuilder();
        char[] lllllllllllllllllIlIIlIlIIlIlIlI = lllllllllllllllllIlIIlIlIIlIllII.toCharArray();
        int lllllllllllllllllIlIIlIlIIlIlIIl = lllllIlIlI[0];
        char[] lllllllllllllllllIlIIlIlIIlIIIll = lllllllllllllllllIlIIlIlIIlIllIl.toCharArray();
        int lllllllllllllllllIlIIlIlIIlIIIlI = lllllllllllllllllIlIIlIlIIlIIIll.length;
        int lllllllllllllllllIlIIlIlIIlIIIIl = lllllIlIlI[0];
        while (V.llIlIlIIIIlll(lllllllllllllllllIlIIlIlIIlIIIIl, lllllllllllllllllIlIIlIlIIlIIIlI)) {
            char lllllllllllllllllIlIIlIlIIlIlllI = lllllllllllllllllIlIIlIlIIlIIIll[lllllllllllllllllIlIIlIlIIlIIIIl];
            lllllllllllllllllIlIIlIlIIlIlIll.append((char)(lllllllllllllllllIlIIlIlIIlIlllI ^ lllllllllllllllllIlIIlIlIIlIlIlI[lllllllllllllllllIlIIlIlIIlIlIIl % lllllllllllllllllIlIIlIlIIlIlIlI.length]));
            "".length();
            ++lllllllllllllllllIlIIlIlIIlIlIIl;
            ++lllllllllllllllllIlIIlIlIIlIIIIl;
            "".length();
    ...
    public static void Z() {
        ...
        if (V.llIlIlIIIIllI(jb.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (V.llIlIlIIIllIl(Players.getLocal().getInteracting())) {
                NPC lllllllllllllllllIlIIlIlIlIIlllI = NPCs.getNearest(nPC -> {
                    int n2;
                    if (V.llIlIlIIIIllI(nPC.getName().contains(lllllIlIIl[lllllIlIlI[60]]) ? 1 : 0) && V.llIlIlIIIllIl(nPC.getInteracting()) && V.llIlIlIIIlIII(nPC.isDead() ? 1 : 0)) {
                        n2 = lllllIlIlI[1];
                        "".length();
                        if (((0x33 ^ 0x64 ^ (0 ^ 0x4D)) & (217 + 21 - 209 + 189 ^ 59 + 8 - -48 + 77 ^ -" ".length())) > " ".length()) {
                            return ((13 + 86 - -84 + 2 ^ 66 + 21 - -24 + 18) & (0x87 ^ 0x88 ^ (0x86 ^ 0xB1) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lllllIlIlI[0];
                    }
                ...
                List lllllllllllllllllIlIIlIlIlIIllIl = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                    boolean bl;
                    if (V.llIlIlIIlIIII(nPC.getInteracting(), Players.getLocal())) {
                        bl = lllllIlIlI[1];
                        "".length();
                        if ("  ".length() < -" ".length()) {
                            return ((0x30 ^ 0x76) & ~(0x26 ^ 0x60)) != 0;
                        }
                    } else {
                        bl = lllllIlIlI[0];
                    }
                ...
                if (V.llIlIlIIIlIII(lllllllllllllllllIlIIlIlIlIIllIl.isEmpty() ? 1 : 0)) {
                    ((NPC)lllllllllllllllllIlIIlIlIlIIllIl.get(lllllIlIlI[0])).interact(lllllIlIIl[lllllIlIlI[25]]);
                    Time.sleepTicks((int)lllllIlIlI[4]);
                    "".length();
                }
                if (V.llIlIlIIIlIlI(lllllllllllllllllIlIIlIlIlIIlllI) && V.llIlIlIIIlIII(Players.getLocal().isMoving() ? 1 : 0) && V.llIlIlIIIIllI(lllllllllllllllllIlIIlIlIlIIllIl.isEmpty() ? 1 : 0)) {
                    lllllllllllllllllIlIIlIlIlIIlllI.interact(lllllIlIIl[lllllIlIlI[26]]);
                    Time.sleepTicks((int)lllllIlIlI[4]);
                    "".length();
                }
            }
    ...
    public int T() {
        ...
        catch (Exception lllllllllllllllllIlIIlIlIlIIlIIl) {
            lllllllllllllllllIlIIlIlIlIIlIIl.printStackTrace();
        }
        if (-"   ".length() >= 0) {
            ...
            block19: {
                block18: {
                    ...
                    if (V.llIlIlIIIlIII(V.bz() ? 1 : 0) && (!V.llIlIlIIIlIIl(Skills.getLevel((Skill)Skill.DEFENCE), lllllIlIlI[2]) || !V.llIlIlIIIlIIl(Skills.getLevel((Skill)Skill.ATTACK), lllllIlIlI[3]) || V.llIlIlIIIIlll(Skills.getLevel((Skill)Skill.STRENGTH), lllllIlIlI[3]))) {
                        BankLocation lllllllllllllllllIlIIlIlIlIlIIIl = BankLocation.getNearest();
                        if (V.llIlIlIIIlIlI(lllllllllllllllllIlIIlIlIlIlIIIl) && V.llIlIlIIIlIII(lllllllllllllllllIlIIlIlIlIlIIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            AccBuilderTempleTrek.c = lllllIlIIl[lllllIlIlI[4]];
                            a.a(lllllllllllllllllIlIIlIlIlIlIIIl);
                        }
                        if (V.llIlIlIIIlIlI(lllllllllllllllllIlIIlIlIlIlIIIl) && V.llIlIlIIIIllI(lllllllllllllllllIlIIlIlIlIlIIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String llIlIlIIIIIIl(String lllllllllllllllllIlIIlIlIIllllIl, String lllllllllllllllllIlIIlIlIIllllII) {
        try {
            SecretKeySpec lllllllllllllllllIlIIlIlIlIIIIII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIlIIlIlIIllllII.getBytes(StandardCharsets.UTF_8)), lllllIlIlI[19]), "DES");
            Cipher lllllllllllllllllIlIIlIlIIllllll = Cipher.getInstance("DES");
            lllllllllllllllllIlIIlIlIIllllll.init(lllllIlIlI[4], lllllllllllllllllIlIIlIlIlIIIIII);
            return new String(lllllllllllllllllIlIIlIlIIllllll.doFinal(Base64.getDecoder().decode(lllllllllllllllllIlIIlIlIIllllIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static boolean bz() {
        ...
        block18: {
            ...
            if (V.llIlIlIIIIllI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                return ((0x3F ^ 0x3B ^ (0x5A ^ 0x52)) & (131 + 102 - 161 + 77 ^ 140 + 144 - 262 + 131 ^ -" ".length())) != 0;
            }
        }
        n2 = lllllIlIlI[0];
        return n2 != 0;
    ...
    private static String llIlIlIIIIIII(String lllllllllllllllllIlIIlIlIIIllIII, String lllllllllllllllllIlIIlIlIIIlIlIl) {
        try {
            SecretKeySpec lllllllllllllllllIlIIlIlIIIllIll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllIlIIlIlIIIlIlIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
    ...
    private static void llIlIlIIIIIll() {
        ...
        V.lllllIlIIl[V.lllllIlIlI[0]] = V.llIlIlIIIIIII("lloZvt+11MhhAs5d1SpDJA==", "fYDZA");
        V.lllllIlIIl[V.lllllIlIlI[1]] = V.llIlIlIIIIIIl("L2cGX6Hbxpt+BRD0r9XmcArrGZB5/xRH28q1MIdUuy6//OQcQWTxGpnx3EnkgyAUF+Xc1EUwKBk=", "nowFa");
        V.lllllIlIIl[V.lllllIlIlI[4]] = V.llIlIlIIIIIII("VdqJK6e0BKkECGRePBnW08GnT4vWrZvr", "REXwo");
        V.lllllIlIIl[V.lllllIlIlI[5]] = V.llIlIlIIIIIII("l8H1dA/XAi1yZz3JeNAlsRy6aMf7Ji3K", "eDOFT");
        V.lllllIlIIl[V.lllllIlIlI[7]] = V.llIlIlIIIIIIl("ZBHde2adpGg01wLoKQrIT+6KErm8qA+VF2AWVkHG43Wq3WJLvowel+Va1ownEUgJ", "coBKF");
        V.lllllIlIIl[V.lllllIlIlI[11]] = V.llIlIlIIIIIII("nlrCBZPOgWQl4sO2/Cs8kw==", "evqBg");
        V.lllllIlIIl[V.lllllIlIlI[15]] = V.llIlIlIIIIIIl("sgm3NHbKWFa6U63P2+4iQw==", "cIYgp");
        V.lllllIlIIl[V.lllllIlIlI[16]] = V.llIlIlIIIIIIl("DQIrbj3P95Q/Mzw51mefaO/VInbtD2Dp", "dulnv");
        V.lllllIlIIl[V.lllllIlIlI[19]] = V.llIlIlIIIIIIl("pVnE5gRnutg=", "ExrqK");
        V.lllllIlIIl[V.lllllIlIlI[21]] = V.llIlIlIIIIIII("C1OD9y2xTDSNwDg/uyqUFJfp5jiZbMye", "gwPhs");
        V.lllllIlIIl[V.lllllIlIlI[22]] = V.llIlIlIIIIIII("8Tvx/UbRq99Bl2O2JMof6w==", "GJxZF");
        V.lllllIlIIl[V.lllllIlIlI[23]] = V.llIlIlIIIIIlI("DAUk", "OjSrW");
        V.lllllIlIIl[V.lllllIlIlI[24]] = V.llIlIlIIIIIIl("9Se4e0QAd3Y=", "GcHPY");
        V.lllllIlIIl[V.lllllIlIlI[25]] = V.llIlIlIIIIIlI("IyAzNDcJ", "bTGUT");
        V.lllllIlIIl[V.lllllIlIlI[26]] = V.llIlIlIIIIIIl("F9yYrbF2Rxo=", "BmKEy");
        V.lllllIlIIl[V.lllllIlIlI[14]] = V.llIlIlIIIIIII("XYZ9HoTlIonG3lGxbbkuw6eNLhfQ5bdU", "muAkR");
        V.lllllIlIIl[V.lllllIlIlI[27]] = V.llIlIlIIIIIlI("LwMjIHUcEyMuOQcXIyo=", "nvWOU");
        V.lllllIlIIl[V.lllllIlIlI[28]] = V.llIlIlIIIIIlI("", "hmCuO");
        V.lllllIlIIl[V.lllllIlIlI[31]] = V.llIlIlIIIIIII("EwC1ifQhz6RO7bjGZG28SQ==", "eWqTQ");
        V.lllllIlIIl[V.lllllIlIlI[32]] = V.llIlIlIIIIIlI("Ah4ZKHk4Dx8rMD8NBA==", "KlvFY");
        V.lllllIlIIl[V.lllllIlIlI[20]] = V.llIlIlIIIIIIl("cbw3YllpXws=", "yRyTL");
        V.lllllIlIIl[V.lllllIlIlI[33]] = V.llIlIlIIIIIII("jCcQDhZq2KJbZFWkkJDBbA==", "EDwUf");
        V.lllllIlIIl[V.lllllIlIlI[34]] = V.llIlIlIIIIIlI("BxUoIDl0Ei4sOD0VLDc=", "TaMEU");
        V.lllllIlIIl[V.lllllIlIlI[35]] = V.llIlIlIIIIIIl("3noM5BUKcJg=", "Gyfje");
        V.lllllIlIIl[V.lllllIlIlI[36]] = V.llIlIlIIIIIII("y/TXrQicg88OMwjj4PAvL2UdA9kr0lgh", "CIdHm");
        V.lllllIlIIl[V.lllllIlIlI[37]] = V.llIlIlIIIIIlI("PQM7JTUZBm8+JBkHJjkmAg==", "pjOMG");
        V.lllllIlIIl[V.lllllIlIlI[38]] = V.llIlIlIIIIIII("iA68pLsTv60=", "QctIx");
        V.lllllIlIIl[V.lllllIlIlI[40]] = V.llIlIlIIIIIlI("GCYJCws=", "OOlgo");
        V.lllllIlIIl[V.lllllIlIlI[41]] = V.llIlIlIIIIIlI("NRwIDQE=", "bumae");
        V.lllllIlIIl[V.lllllIlIlI[43]] = V.llIlIlIIIIIIl("/SM6FJ9Osd8=", "rgVHf");
        V.lllllIlIIl[V.lllllIlIlI[2]] = V.llIlIlIIIIIlI("BQ0MAg==", "Rhmpz");
        V.lllllIlIIl[V.lllllIlIlI[46]] = V.llIlIlIIIIIIl("ROOYj/8AoQ4=", "nBWvH");
        V.lllllIlIIl[V.lllllIlIlI[48]] = V.llIlIlIIIIIlI("HTIyEQ==", "JWScg");
        V.lllllIlIIl[V.lllllIlIlI[50]] = V.llIlIlIIIIIII("YQnyUXRKT6I=", "beSpL");
        V.lllllIlIIl[V.lllllIlIlI[52]] = V.llIlIlIIIIIlI("HxwTHA==", "HyrnE");
        V.lllllIlIIl[V.lllllIlIlI[59]] = V.llIlIlIIIIIlI("eVJ4FB4/", "MbXGj");
        V.lllllIlIIl[V.lllllIlIlI[60]] = V.llIlIlIIIIIIl("pwSv+6DcSIo=", "eCsLc");
    }
    ...
    public static boolean dB() {
        ...
        block15: {
                                        ...
                                        block14: {
                                            block4: {
                                                ...
                                                block6: {
                                                    ...
                                                    return ((0xB5 ^ 0xBB ^ (0x15 ^ 0x2E)) & (0xD4 ^ 0xB2 ^ (0x64 ^ 0x37) ^ -" ".length())) != 0;
                                                }
                                                n3 = lllllIlIlI[0];
                                                return n3 != 0;
                                            }
            ...
            return ((0xA6 ^ 0xB0 ^ (0xDB ^ 0x8E)) & (7 + 30 - -5 + 171 ^ 145 + 14 - 55 + 46 ^ -" ".length())) != 0;
        }
        n2 = lllllIlIlI[0];
        return n2 != 0;
    }
    ...
    private static void llIlIlIIIIlII() {
        ...
        V.lllllIlIlI[0] = (74 + 65 - 111 + 214 ^ 45 + 118 - 54 + 67) & (0xAE ^ 0x85 ^ (7 ^ 0x6E) ^ -" ".length());
        V.lllllIlIlI[1] = " ".length();
        V.lllllIlIlI[2] = 75 + 81 - 120 + 105 ^ 113 + 78 - 137 + 93;
        V.lllllIlIlI[3] = 0x54 ^ 0x66;
        V.lllllIlIlI[4] = "  ".length();
        V.lllllIlIlI[5] = "   ".length();
        ...
        V.lllllIlIlI[54] = -"   ".length() & (0xFFFFDF6A & 0x3FDF);
    ...
    public static void ae() {
        d lllllllllllllllllIlIIlIlIlIIlIll;
        int[] nArray = new int[lllllIlIlI[1]];
        ...
        if (V.llIlIlIIIlIII(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lllllllllllllllllIlIIlIlIlIIlIll = new d(lllllIlIlI[54], lllllIlIlI[11], lllllIlIlI[53]);
            bu.add(lllllllllllllllllIlIIlIlIlIIlIll);
            "".length();
        }
        int[] nArray3 = new int[lllllIlIlI[1]];
        nArray3[V.lllllIlIlI[0]] = lllllIlIlI[51];
        if (V.llIlIlIIIlIII(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllllIlIIlIlIlIIlIll = new d(lllllIlIlI[51], lllllIlIlI[1], lllllIlIlI[55]);
            bu.add(lllllllllllllllllIlIIlIlIlIIlIll);
            "".length();
        }
        int[] nArray4 = new int[lllllIlIlI[1]];
        ...
        if (V.llIlIlIIIlIII(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllllIlIIlIlIlIIlIll = new d(lllllIlIlI[49], lllllIlIlI[1], lllllIlIlI[56]);
            bu.add(lllllllllllllllllIlIIlIlIlIIlIll);
            "".length();
        }
        int[] nArray5 = new int[lllllIlIlI[1]];
        ...
        if (V.llIlIlIIIlIII(Bank.contains((int[])nArray5) ? 1 : 0)) {
            lllllllllllllllllIlIIlIlIlIIlIll = new d(lllllIlIlI[12], lllllIlIlI[13], lllllIlIlI[57]);
            bu.add(lllllllllllllllllIlIIlIlIlIIlIll);
            "".length();
        }
        int[] nArray6 = new int[lllllIlIlI[1]];
        ...
        if (V.llIlIlIIIlIII(Bank.contains((int[])nArray6) ? 1 : 0)) {
            lllllllllllllllllIlIIlIlIlIIlIll = new d(lllllIlIlI[42], lllllIlIlI[1], lllllIlIlI[58]);
            bu.add(lllllllllllllllllIlIIlIlIlIIlIll);
            "".length();
        }
        int[] nArray7 = new int[lllllIlIlI[1]];
        ...
        if (V.llIlIlIIIlIII(Bank.contains((int[])nArray7) ? 1 : 0)) {
            lllllllllllllllllIlIIlIlIlIIlIll = new d(lllllIlIlI[45], lllllIlIlI[1], lllllIlIlI[58]);
            bu.add(lllllllllllllllllIlIIlIlIlIIlIll);
            "".length();
        }
        int[] nArray8 = new int[lllllIlIlI[1]];
        ...
        if (V.llIlIlIIIlIII(Bank.contains((int[])nArray8) ? 1 : 0)) {
            lllllllllllllllllIlIIlIlIlIIlIll = new d(lllllIlIlI[47], lllllIlIlI[1], lllllIlIlI[58]);
            bu.add(lllllllllllllllllIlIIlIlIlIIlIll);
            "".length();
        }
        int[] nArray9 = new int[lllllIlIlI[1]];
        ...
        if (V.llIlIlIIIlIII(Bank.contains((int[])nArray9) ? 1 : 0)) {
            lllllllllllllllllIlIIlIlIlIIlIll = new d(lllllIlIlI[44], lllllIlIlI[1], lllllIlIlI[58]);
            bu.add(lllllllllllllllllIlIIlIlIlIIlIll);
            "".length();
        }
        if (V.llIlIlIIIlIIl(Skills.getLevel((Skill)Skill.ATTACK), lllllIlIlI[39])) {
            ...
            if (V.llIlIlIIIlIII(Bank.contains((int[])nArray10) ? 1 : 0)) {
                lllllllllllllllllIlIIlIlIlIIlIll = new d(lllllIlIlI[18], lllllIlIlI[1], lllllIlIlI[56]);
                bu.add(lllllllllllllllllIlIIlIlIlIIlIll);
                "".length();
            }
        }
        ...
        if (V.llIlIlIIIlIII(Bank.contains((int[])nArray11) ? 1 : 0)) {
            lllllllllllllllllIlIIlIlIlIIlIll = new d(lllllIlIlI[17], lllllIlIlI[1], lllllIlIlI[58]);
            bu.add(lllllllllllllllllIlIIlIlIlIIlIll);
            "".length();
        }
    }
