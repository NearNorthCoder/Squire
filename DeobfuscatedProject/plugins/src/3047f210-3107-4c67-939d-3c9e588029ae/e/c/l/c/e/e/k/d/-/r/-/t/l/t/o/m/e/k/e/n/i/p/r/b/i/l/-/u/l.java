...
implements S {
        ...
        if (l.llIllIlIIIIll(list.isEmpty() ? 1 : 0) && l.llIllIlIIlIlI(list.size(), lIIIIIIIlII[0])) {
            ...
            while (l.llIllIlIIIIlI(lllllllllllllllllIlIIIIIlIIlIIll, lllllllllllllllllIlIIIIIlIIlIlII.size())) {
                ...
                if (l.llIllIlIIIlIl(((Player)lllllllllllllllllIlIIIIIlIIlIlII.get(lllllllllllllllllIlIIIIIlIIlIIll)).equals(Players.getLocal()) ? 1 : 0)) {
                    "".length();
                    if ("   ".length() >= (0xF6 ^ 0xB3 ^ (0x3D ^ 0x7C))) {
                        return ((0xBF ^ 0x9B ^ (0xD1 ^ 0xA2)) & (0x7B ^ 0x6D ^ (0x74 ^ 0x35) ^ -" ".length())) != 0;
                    }
                ...
                "".length();
                if (((0x7F ^ 0x61) & ~(0x57 ^ 0x49)) > -" ".length()) continue;
    ...
    public boolean V() {
        ...
        if (l.llIllIlIIllll(Skills.getLevel((Skill)Skill.RANGED), lIIIIIIIlII[35]) && l.llIllIlIIllll(Skills.getLevel((Skill)Skill.DEFENCE), lIIIIIIIlII[35])) {
            ...
            "".length();
            if (-" ".length() >= 0) {
                return ((0x33 ^ 0x7C ^ (0xF5 ^ 0x9F)) & (0x6C ^ 0x22 ^ (1 ^ 0x6A) ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIIIIIIIlII[1];
        }
    ...
    private static void llIllIlIIIIII() {
        ...
        l.lIIIIIIIIll[l.lIIIIIIIlII[1]] = l.llIllIIllllIl("vv5UuZF7+8f2WDYZ2ZHmXaZ5fEfs3Ln3", "ZwGpx");
        l.lIIIIIIIIll[l.lIIIIIIIlII[0]] = l.llIllIIlllllI("s3QcKi+1YmpAW4Wxd6Vun+6VPmIuYnH8", "bXonk");
        l.lIIIIIIIIll[l.lIIIIIIIlII[3]] = l.llIllIIlllllI("dVl5N//ZprOv2/aQ0QcMViI5urKDfWju", "RIvxo");
        l.lIIIIIIIIll[l.lIIIIIIIlII[10]] = l.llIllIIllllIl("M4M4qrf0izad06jueYnCfN4BH0tnXIog", "Mpyvv");
        l.lIIIIIIIIll[l.lIIIIIIIlII[12]] = l.llIllIIllllll("BQMFJzk=", "AqlIR");
        l.lIIIIIIIIll[l.lIIIIIIIlII[13]] = l.llIllIIlllllI("pS/vJDjbWb0yu7sYPXz9iQ==", "swkTQ");
        l.lIIIIIIIIll[l.lIIIIIIIlII[14]] = l.llIllIIllllll("BTgeJxQoeQYmFz55EysZOQ==", "MYpCx");
        l.lIIIIIIIIll[l.lIIIIIIIlII[15]] = l.llIllIIlllllI("TrYK0S3co58=", "IDhtZ");
        l.lIIIIIIIIll[l.lIIIIIIIlII[16]] = l.llIllIIllllIl("TPQlz8BmqVabbMfKIHMDF/trNn9eJu+b", "FldeE");
        l.lIIIIIIIIll[l.lIIIIIIIlII[17]] = l.llIllIIlllllI("tw6ZguSsaM+ew2JmbBL7LqdxJu/Pus20", "bWmPn");
        l.lIIIIIIIIll[l.lIIIIIIIlII[8]] = l.llIllIIlllllI("KDowinUmhnD9q7eGB0cR+kfQ1PtfynHw", "IOHkz");
        l.lIIIIIIIIll[l.lIIIIIIIlII[18]] = l.llIllIIllllIl("TfmlBN08D+A=", "CYsaT");
        l.lIIIIIIIIll[l.lIIIIIIIlII[19]] = l.llIllIIlllllI("OftE3aTDdXs=", "Yidnd");
        l.lIIIIIIIIll[l.lIIIIIIIlII[20]] = l.llIllIIlllllI("YVMx9L9o5/CrywBNUivX5Q==", "tWRoj");
        l.lIIIIIIIIll[l.lIIIIIIIlII[21]] = l.llIllIIllllIl("F25YaN2TjgsO9K3GoyNUWg==", "YcEcJ");
        l.lIIIIIIIIll[l.lIIIIIIIlII[22]] = l.llIllIIlllllI("2322gvxJSWp3yqPaRh0yI+6VF9xo6+9L", "PCmLc");
        l.lIIIIIIIIll[l.lIIIIIIIlII[23]] = l.llIllIIllllll("NzoNBREd", "vNydr");
        l.lIIIIIIIIll[l.lIIIIIIIlII[30]] = l.llIllIIllllIl("bNpZdrikfXYieNd65hO7xg==", "wccFG");
        l.lIIIIIIIIll[l.lIIIIIIIlII[34]] = l.llIllIIlllllI("XqOZKrv8dBzyZ6ciqzf/qw==", "CHPMe");
        l.lIIIIIIIIll[l.lIIIIIIIlII[36]] = l.llIllIIlllllI("VVxQcv4UkCwVHyt9x17DnQ==", "EqICj");
        l.lIIIIIIIIll[l.lIIIIIIIlII[60]] = l.llIllIIllllll("JhoJBUsBUg8DCRMGRFEPExxICAMHUhwQBxdSBRRMBhoNAwlSAgQUDQEXVw==", "rrhql");
        l.lIIIIIIIIll[l.lIIIIIIIlII[61]] = l.llIllIIllllIl("qc9ndSbkUrdpvSWH3hIiiP5lSUHb0pzgA7GJ/OMSEwDrqi5MUE3CBA==", "DNWLn");
        l.lIIIIIIIIll[l.lIIIIIIIlII[62]] = l.llIllIIlllllI("POrNYRzVUh4Cs84c9dJS+w==", "mIRCt");
    }
}
