...
extends Task {
    ...
    private static void lIlIllllIllIlII() {
        ...
        d.lIIllIIIlllll[0] = ("  ".length() ^ (0x9A ^ 0x96)) & (0x7E ^ 0x61 ^ (0x5E ^ 0x4F) ^ -" ".length());
        d.lIIllIIIlllll[1] = " ".length();
        d.lIIllIIIlllll[2] = 0xFFFFBE7F & 0x6BDD;
        d.lIIllIIIlllll[3] = "  ".length();
    ...
    public boolean run() {
        d llllllllllllllIllllIIIlIlIlIlIlI;
        if (d.lIlIllllIllIlIl((Object)this.u.botActivity(), (Object)a.MAKE)) {
            return lIIllIIIlllll[0];
        }
        if (d.lIlIllllIllIllI(llllllllllllllIllllIIIlIlIlIlIlI.v() ? 1 : 0)) {
            llllllllllllllIllllIIIlIlIlIlIlI.w();
            return lIIllIIIlllll[1];
        }
        return this.u();
    }
    ...
    private void w() {
        ...
        int llllllllllllllIllllIIIlIlIlIIlIl = lIIllIIIlllll[0];
        while (d.lIlIllllIlllIII(llllllllllllllIllllIIIlIlIlIIlIl, Inventory.getAll().size())) {
            Item llllllllllllllIllllIIIlIlIlIIlII = Inventory.getItem((int)llllllllllllllIllllIIIlIlIlIIlIl);
            if (d.lIlIllllIlllIIl(llllllllllllllIllllIIIlIlIlIIlII) && d.lIlIllllIlllIlI(llllllllllllllIllllIIIlIlIlIIlII.getId(), lIIllIIIlllll[2])) {
                void llllllllllllllIllllIIIlIlIlIIllI;
                llllllllllllllIllllIIIlIlIlIIllI.useOn(llllllllllllllIllllIIIlIlIlIIlII);
            }
            ++llllllllllllllIllllIIIlIlIlIIlIl;
            "".length();
            if ((0xC ^ 8) >= 0) continue;
            return;
        }
