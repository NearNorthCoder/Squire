...
extends Task {
    ...
    private static void lIlIlllllIlllll() {
        ...
        c.lIIllIIlIlIII[c.lIIllIIlIlIIl[0]] = c.lIlIlllllIllIIl("Y8CLYQJsR/k=", "viqki");
        c.lIIllIIlIlIII[c.lIIllIIlIlIIl[1]] = c.lIlIlllllIllIIl("ZBhj4WGrodo=", "jwzbQ");
        c.lIIllIIlIlIII[c.lIIllIIlIlIIl[6]] = c.lIlIlllllIllllI("PZAUhoUZ9WQ=", "ntCHo");
    }
    ...
    public boolean run() {
        ...
        if (c.lIlIllllllIIIlI(llllllllllllllIllllIIIIllIIlIllI.s() ? 1 : 0)) {
            ...
            "".length();
            if (((38 + 29 - -19 + 149 ^ 136 + 60 - 95 + 97) & (0xBD ^ 0xAF ^ (0xD ^ 0x32) ^ -" ".length())) == "  ".length()) {
                return ((0xC4 ^ 0x83 ^ (0 ^ 0x50)) & (62 + 21 - 57 + 128 ^ 14 + 12 - -92 + 23 ^ -" ".length())) != 0;
            }
        } else {
