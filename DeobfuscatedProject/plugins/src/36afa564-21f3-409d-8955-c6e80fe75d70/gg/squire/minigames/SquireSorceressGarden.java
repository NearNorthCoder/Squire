...
import r.g.q.-.s.r.s.u.i.e.r.r.n.c.s.-.e.s.e.o.e.d.a.b;
import r.g.q.-.s.r.s.u.i.e.r.r.n.c.s.-.e.s.e.o.e.d.a.c;
import r.g.q.-.s.r.s.u.i.e.r.r.n.c.s.-.e.s.e.o.e.d.a.d;
import r.g.q.-.s.r.s.u.i.e.r.r.n.c.s.-.e.s.e.o.e.d.a.e;
...
extends SquirePlugin {
    ...
    private static void lIlIlllllIIIIII() {
        ...
        SquireSorceressGarden.lIIllIIlIIIlI[1] = (6 ^ 0x33 ^ (0xAC ^ 0x85)) & (26 + 72 - 10 + 43 ^ 12 + 147 - 122 + 122 ^ -" ".length());
        SquireSorceressGarden.lIIllIIlIIIlI[2] = " ".length();
        SquireSorceressGarden.lIIllIIlIIIlI[3] = "  ".length();
        SquireSorceressGarden.lIIllIIlIIIlI[4] = "   ".length();
    ...
    private static void lIlIllllIlllllI() {
        ...
        SquireSorceressGarden.lIIllIIlIIIII[SquireSorceressGarden.lIIllIIlIIIlI[1]] = SquireSorceressGarden.lIlIllllIllllIl("Gwg6MQ==", "YiTZU");
    }
    ...
    public void a(InventoryChanged inventoryChanged) {
        if (SquireSorceressGarden.lIlIlllllIIIIIl(inventoryChanged.getChangeType(), InventoryChanged.ChangeType.ITEM_ADDED)) {
            void llllllllllllllIllllIIIlIlIIIIlII;
            SquireSorceressGarden llllllllllllllIllllIIIlIlIIIIlIl;
            void llllllllllllllIllllIIIlIlIIIIIlI;
            void llllllllllllllIllllIIIlIlIIIIIll;
            ...
            if (SquireSorceressGarden.lIlIlllllIIIIll(IntStream.of((int[])llllllllllllllIllllIIIlIlIIIIIll).anyMatch(arg_0 -> SquireSorceressGarden.a((int)llllllllllllllIllllIIIlIlIIIIIlI, arg_0)) ? 1 : 0)) {
                llllllllllllllIllllIIIlIlIIIIlIl.b(llllllllllllllIllllIIIlIlIIIIlIl.b() + lIIllIIlIIIlI[2]);
            }
            switch (llllllllllllllIllllIIIlIlIIIIlII.getItemId()) {
                case 249: {
                    llllllllllllllIllllIIIlIlIIIIlIl.c(llllllllllllllIllllIIIlIlIIIIlIl.c() + lIIllIIlIIIlI[2]);
                    "".length();
                    if (" ".length() > -" ".length()) break;
                    return;
                }
                case 251: {
                    llllllllllllllIllllIIIlIlIIIIlIl.d(llllllllllllllIllllIIIlIlIIIIlIl.d() + lIIllIIlIIIlI[2]);
                    "".length();
                    if (-" ".length() <= (0x14 ^ 0x10)) break;
                    return;
                }
                case 253: {
                    llllllllllllllIllllIIIlIlIIIIlIl.e(llllllllllllllIllllIIIlIlIIIIlIl.e() + lIIllIIlIIIlI[2]);
                    "".length();
                    if (null == null) break;
                    return;
                }
                case 255: {
                    llllllllllllllIllllIIIlIlIIIIlIl.f(llllllllllllllIllllIIIlIlIIIIlIl.f() + lIIllIIlIIIlI[2]);
                    "".length();
                    if ((74 + 75 - 83 + 85 ^ 115 + 46 - 99 + 85) != 0) break;
                    return;
                }
                case 259: {
                    llllllllllllllIllllIIIlIlIIIIlIl.g(llllllllllllllIllllIIIlIlIIIIlIl.g() + lIIllIIlIIIlI[2]);
                    "".length();
                    if ("  ".length() >= "  ".length()) break;
                    return;
                }
                case 261: {
                    llllllllllllllIllllIIIlIlIIIIlIl.h(llllllllllllllIllllIIIlIlIIIIlIl.h() + lIIllIIlIIIlI[2]);
                    "".length();
                    if (" ".length() < "   ".length()) break;
                    return;
                }
                case 257: {
                    llllllllllllllIllllIIIlIlIIIIlIl.i(llllllllllllllIllllIIIlIlIIIIlIl.i() + lIIllIIlIIIlI[2]);
                    "".length();
                    if (" ".length() != 0) break;
                    return;
                }
                case 263: {
                    llllllllllllllIllllIIIlIlIIIIlIl.j(llllllllllllllIllllIIIlIlIIIIlIl.j() + lIIllIIlIIIlI[2]);
                    "".length();
                    if (null == null) break;
                    return;
                }
                case 265: {
                    llllllllllllllIllllIIIlIlIIIIlIl.k(llllllllllllllIllllIIIlIlIIIIlIl.k() + lIIllIIlIIIlI[2]);
                    "".length();
                    if (null == null) break;
                    return;
                }
                case 2481: {
                    llllllllllllllIllllIIIlIlIIIIlIl.l(llllllllllllllIllllIIIlIlIIIIlIl.l() + lIIllIIlIIIlI[2]);
                    "".length();
                    if (((0x6C ^ 0x52 ^ (0x25 ^ 0x49)) & (120 + 130 - 39 + 7 ^ 51 + 106 - 113 + 92 ^ -" ".length())) == 0) break;
                    return;
                }
                case 267: {
                    llllllllllllllIllllIIIlIlIIIIlIl.m(llllllllllllllIllllIIIlIlIIIIlIl.m() + lIIllIIlIIIlI[2]);
                }
            }
        }
    }
    ...
    private static String lIlIllllIllllIl(String llllllllllllllIllllIIIlIIlllIIll, String llllllllllllllIllllIIIlIIlllIIlI) {
        llllllllllllllIllllIIIlIIlllIIll = new String(Base64.getDecoder().decode(llllllllllllllIllllIIIlIIlllIIll.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        ...
        char[] llllllllllllllIllllIIIlIIllIlIIl = llllllllllllllIllllIIIlIIlllIIll.toCharArray();
        int llllllllllllllIllllIIIlIIllIlIII = llllllllllllllIllllIIIlIIllIlIIl.length;
        int llllllllllllllIllllIIIlIIllIIlll = lIIllIIlIIIlI[1];
        while (SquireSorceressGarden.lIlIlllllIIIlII(llllllllllllllIllllIIIlIIllIIlll, llllllllllllllIllllIIIlIIllIlIII)) {
            char llllllllllllllIllllIIIlIIlllIlII = llllllllllllllIllllIIIlIIllIlIIl[llllllllllllllIllllIIIlIIllIIlll];
            llllllllllllllIllllIIIlIIlllIIIl.append((char)(llllllllllllllIllllIIIlIIlllIlII ^ llllllllllllllIllllIIIlIIlllIIII[llllllllllllllIllllIIIlIIllIllll % llllllllllllllIllllIIIlIIlllIIII.length]));
            "".length();
            ++llllllllllllllIllllIIIlIIllIllll;
            ++llllllllllllllIllllIIIlIIllIIlll;
            "".length();
