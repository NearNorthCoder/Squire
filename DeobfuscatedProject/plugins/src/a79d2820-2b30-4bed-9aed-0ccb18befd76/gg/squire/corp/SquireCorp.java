...
extends SquirePlugin {
    ...
    private static void lllIIIIllIllll() {
        ...
        SquireCorp.lIlIlllIlIIl[SquireCorp.lIlIlllIlIlI[0]] = SquireCorp.lllIIIIllIlllI("JMnbbZMS7/hQi73oMsBhjagvEgMAaTq/0vwCM/I0XVR9x+QgTF3PhA==", "jKhqp");
    }
    ...
    private static void lllIIIIlllIIII() {
        ...
        SquireCorp.lIlIlllIlIlI[0] = (0xC4 ^ 0x9A ^ (0x7B ^ 0xE)) & (11 + 71 - -36 + 47 ^ 45 + 112 - 116 + 101 ^ -" ".length());
        SquireCorp.lIlIlllIlIlI[1] = 0xF5 ^ 0xA1 ^ (0xEF ^ 0xB4);
        SquireCorp.lIlIlllIlIlI[2] = " ".length();
        SquireCorp.lIlIlllIlIlI[3] = "  ".length();
        SquireCorp.lIlIlllIlIlI[4] = "   ".length();
