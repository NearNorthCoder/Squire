...
extends Enum<d> {
    ...
    private static void lIIlIlIlIIlIIIl() {
        ...
        d.lllllllIIlIl[d.lllllllIIllI[0]] = d.lIIlIlIlIIIllll("Ag0JMCgOCQI=", "ODGyo");
        d.lllllllIIlIl[d.lllllllIIllI[1]] = d.lIIlIlIlIIlIIII("d1wz+cwTfnHvQJ8GevQF+A==", "GMJLK");
    }
    ...
    private static void lIIlIlIlIIlIIlI() {
        ...
        d.lllllllIIllI[0] = (0x38 ^ 0x5B ^ (0xC4 ^ 0xBA)) & (69 + 108 - 71 + 41 ^ 128 + 38 - 129 + 105 ^ -" ".length());
        d.lllllllIIllI[1] = " ".length();
        d.lllllllIIllI[2] = "  ".length();
    }
