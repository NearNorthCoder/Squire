...
extends Enum<f> {
    ...
    private static void lIIlIllIIlIIlIl() {
        ...
        f.lIIIIIIIIIlll[f.lIIIIIIIIlIII[0]] = f.lIIlIllIIlIIIll("ITMCEi43JQMHJjco", "rzLUb");
        f.lIIIIIIIIIlll[f.lIIIIIIIIlIII[1]] = f.lIIlIllIIlIIlII("5LC12YADVLr0n83G7pvz5Q==", "UoFnR");
    }
    ...
    private static void lIIlIllIIlIIllI() {
        ...
        f.lIIIIIIIIlIII[0] = (0xF6 ^ 0xBE ^ (0xE0 ^ 0x89)) & (0xAD ^ 0x84 ^ (0x8F ^ 0x87) ^ -" ".length());
        f.lIIIIIIIIlIII[1] = " ".length();
        f.lIIIIIIIIlIII[2] = "  ".length();
