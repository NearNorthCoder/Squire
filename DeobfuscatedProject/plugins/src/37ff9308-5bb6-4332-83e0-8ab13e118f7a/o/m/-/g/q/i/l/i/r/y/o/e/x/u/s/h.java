...
extends Task {
    ...
    private static String lIIlIlIllIIIlII(String lllllllllllllllIIlIIIIlllIIlIllI, String lllllllllllllllIIlIIIIlllIIllIlI) {
        ...
        while (h.lIIlIlIllIIllII(lllllllllllllllIIlIIIIlllIIIllll, lllllllllllllllIIlIIIIlllIIlIIII)) {
            ...
            "".length();
            if (((0x90 ^ 0xA4 ^ (0xB0 ^ 0xC2)) & (0x64 ^ 0x55 ^ (3 ^ 0x74) ^ -" ".length())) == ((0xBF ^ 0x9A ^ "   ".length()) & (211 + 176 - 248 + 92 ^ 6 + 18 - -22 + 147 ^ -" ".length()))) continue;
            return null;
        }
    ...
    private static void lIIlIlIllIIlIII() {
        ...
        h.llllllllIIlI[5] = " ".length();
        h.llllllllIIlI[6] = "  ".length();
        h.llllllllIIlI[7] = "   ".length();
    ...
    private static void lIIlIlIllIIIlll() {
        ...
        h.llllllllIIIl[h.llllllllIIlI[3]] = h.lIIlIlIllIIIlII("JiAcG2cnKRcDMw==", "dArpG");
        h.llllllllIIIl[h.llllllllIIlI[5]] = h.lIIlIlIllIIIlIl("U0kpzyMJCtj+TqPJRKK4FA==", "vGxAR");
        h.llllllllIIIl[h.llllllllIIlI[6]] = h.lIIlIlIllIIIllI("w7bx8MoWHRU=", "AtZvH");
        h.llllllllIIIl[h.llllllllIIlI[7]] = h.lIIlIlIllIIIllI("1NymvRL4HrrDralrjQa8y7HwCntnPkcI", "SjrOa");
        h.llllllllIIIl[h.llllllllIIlI[10]] = h.lIIlIlIllIIIlII("GAQIdDM0GAQx", "UkpTC");
        h.llllllllIIIl[h.llllllllIIlI[11]] = h.lIIlIlIllIIIlII("PDArdDwROjox", "pINTL");
        h.llllllllIIIl[h.llllllllIIlI[12]] = h.lIIlIlIllIIIlII("GAUvaD04ETot", "YbNHM");
        h.llllllllIIIl[h.llllllllIIlI[13]] = h.lIIlIlIllIIIllI("XKLirGKe/1Ug+rqxYN5clg==", "bVGMR");
        h.llllllllIIIl[h.llllllllIIlI[14]] = h.lIIlIlIllIIIlIl("NiutquKTHucTa2RfclLq7R43sC9HK+gP", "ZtyRs");
        h.llllllllIIIl[h.llllllllIIlI[15]] = h.lIIlIlIllIIIlIl("iEoXMVpTS0c=", "GbMyo");
        h.llllllllIIIl[h.llllllllIIlI[17]] = h.lIIlIlIllIIIlII("IycqByUeMg==", "pSKjL");
        h.llllllllIIIl[h.llllllllIIlI[18]] = h.lIIlIlIllIIIlIl("bXAsFn4efTo=", "mFPbN");
        h.llllllllIIIl[h.llllllllIIlI[19]] = h.lIIlIlIllIIIllI("ca5oy3kNBCQ=", "fXCzA");
        h.llllllllIIIl[h.llllllllIIlI[20]] = h.lIIlIlIllIIIllI("M1+UQfV8PKk=", "DLPFL");
    }
