...
extends Enum<a> {
    ...
    private static void lIIlIlIlllIIllI() {
        ...
        a.lllllllllIlI[0] = (0x29 ^ 0x43 ^ (0x54 ^ 9)) & (0xC3 ^ 0x93 ^ (0x49 ^ 0x2E) ^ -" ".length());
        a.lllllllllIlI[1] = " ".length();
        a.lllllllllIlI[2] = 0xFFFFCB9F & 0x3563;
        a.lllllllllIlI[3] = "  ".length();
        a.lllllllllIlI[4] = "   ".length();
        ...
        a.lllllllllIlI[9] = 0x9E ^ 0x9A ^ "  ".length();
    ...
    private static void lIIlIlIlllIIlIl() {
        ...
        a.llllllllIlll[a.lllllllllIlI[0]] = a.lIIlIlIllIlllll("MD0xAic1KjkQ", "yoxVx");
        a.llllllllIlll[a.lllllllllIlI[1]] = a.lIIlIlIlllIIIII("OMXQMRNF30Y5T4Q0q8lDbg==", "xFQbW");
        a.llllllllIlll[a.lllllllllIlI[3]] = a.lIIlIlIllIlllll("EyIVCwQEKh8P", "PcQJJ");
        a.llllllllIlll[a.lllllllllIlI[4]] = a.lIIlIlIlllIIIII("dyYW8MwQNpc+Ui+8E0zMug==", "bKWrz");
        a.llllllllIlll[a.lllllllllIlI[6]] = a.lIIlIlIlllIIIII("wNQGJPAWcnQjZKj2MzSbCw==", "Mumgb");
        a.llllllllIlll[a.lllllllllIlI[7]] = a.lIIlIlIlllIIIIl("6HQQW0WSA80y1wWlvelrrQ==", "CUPYr");
        a.llllllllIlll[a.lllllllllIlI[9]] = a.lIIlIlIlllIIIIl("0s2kj+j1jyjg7nOszFsxLw==", "AItgM");
        a.llllllllIlll[a.lllllllllIlI[10]] = a.lIIlIlIlllIIIIl("wrigTpOEwoc/aVDG0/xsIw==", "ACAhp");
        a.llllllllIlll[a.lllllllllIlI[12]] = a.lIIlIlIlllIIIII("bz51DZaoxO0=", "IXIkk");
        a.llllllllIlll[a.lllllllllIlI[13]] = a.lIIlIlIllIlllll("ECg9CTErKw==", "DGOzE");
        a.llllllllIlll[a.lllllllllIlI[15]] = a.lIIlIlIlllIIIIl("jzyUPY/QE45t1ETdv1yvrw==", "jXiZQ");
        a.llllllllIlll[a.lllllllllIlI[16]] = a.lIIlIlIllIlllll("GSEHJGsgPBo5JD5zRiUlNno=", "PSnPK");
        a.llllllllIlll[a.lllllllllIlI[18]] = a.lIIlIlIlllIIIII("ZIVvidNUY5UDRdksWao/vmeyLyl96ljr", "yJYAk");
        a.llllllllIlll[a.lllllllllIlI[19]] = a.lIIlIlIlllIIIII("Xqh2in4TFfExx3LIX9/sIIye4J88oNDg", "IAZZO");
        a.llllllllIlll[a.lllllllllIlI[21]] = a.lIIlIlIlllIIIIl("WVFznKr9Fz5OjFz5wY9cPQ==", "gMnds");
        a.llllllllIlll[a.lllllllllIlI[22]] = a.lIIlIlIllIlllll("IyYqJzELPik2cB8oMDo/AWdsJj4Jbg==", "oGDSP");
        a.llllllllIlll[a.lllllllllIlI[24]] = a.lIIlIlIlllIIIIl("LOR/D3gUKnyfONPX7NwnVRSZH0quPu6T", "nvONz");
        a.llllllllIlll[a.lllllllllIlI[25]] = a.lIIlIlIllIlllll("KA0KER5MDQ4GHEwKBBcRAxRLSw0CHEI=", "lzkcx");
        a.llllllllIlll[a.lllllllllIlI[27]] = a.lIIlIlIlllIIIIl("eBvlKuMBBj0yU6JVDyS4ZQ==", "FQQFy");
        a.llllllllIlll[a.lllllllllIlI[28]] = a.lIIlIlIlllIIIIl("XIH3Hgq2xptGv/KEPIYhC98yzjBQYkCm", "mZdyy");
    }
