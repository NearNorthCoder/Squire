...
extends Task {
    ...
    private static String lIIlIlIllIlIlIl(String lllllllllllllllIIlIIIIllIIIllIlI, String lllllllllllllllIIlIIIIllIIIllIll) {
        try {
            SecretKeySpec lllllllllllllllIIlIIIIllIIIlllll = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllIIlIIIIllIIIllIll.getBytes(StandardCharsets.UTF_8)), llllllllIllI[5]), "DES");
            Cipher lllllllllllllllIIlIIIIllIIIllllI = Cipher.getInstance("DES");
            lllllllllllllllIIlIIIIllIIIllllI.init(llllllllIllI[6], lllllllllllllllIIlIIIIllIIIlllll);
            return new String(lllllllllllllllIIlIIIIllIIIllllI.doFinal(Base64.getDecoder().decode(lllllllllllllllIIlIIIIllIIIllIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public boolean run() {
        l lllllllllllllllIIlIIIIllIIlIlIll;
        if (l.lIIlIlIllIllIII(s.e() ? 1 : 0)) {
            return llllllllIllI[1];
        }
        int[] nArray = new int[llllllllIllI[2]];
        nArray[l.llllllllIllI[1]] = llllllllIllI[3];
        TileObject lllllllllllllllIIlIIIIllIIlIlIlI = TileObjects.getNearest((int[])nArray);
        if (l.lIIlIlIllIllIII(lllllllllllllllIIlIIIIllIIlIlIll.a(lllllllllllllllIIlIIIIllIIlIlIlI) ? 1 : 0)) {
            return llllllllIllI[1];
        }
        if (l.lIIlIlIllIllIIl((Object)lllllllllllllllIIlIIIIllIIlIlIll.V.pluginMode(), (Object)d.MINIGAME)) {
            return llllllllIllI[1];
        }
        if (l.lIIlIlIllIllIIl((Object)lllllllllllllllIIlIIIIllIIlIlIll.V.potionStrategy(), (Object)f.MULTI_ORDER) && l.lIIlIlIllIllIlI(SquireMixology.r, llllllllIllI[0])) {
            return llllllllIllI[1];
        }
        if (l.lIIlIlIllIllIll((Object)lllllllllllllllIIlIIIIllIIlIlIll.V.potionStrategy(), (Object)f.MULTI_ORDER)) {
            if (l.lIIlIlIllIllIII(lllllllllllllllIIlIIIIllIIlIlIll.a(lllllllllllllllIIlIIIIllIIlIlIlI) ? 1 : 0)) {
                return llllllllIllI[1];
            }
            s.j();
    ...
    private static void lIIlIlIllIlIllI() {
        ...
        l.llllllllIlIl[l.llllllllIllI[1]] = l.lIIlIlIllIlIlIl("q1AD51olYLA8JiO9iIedHw==", "esDZV");
    }
    ...
    private boolean a(TileObject tileObject) {
        ...
        if (l.lIIlIlIllIlllII(tileObject.getWorldLocation().distanceTo(Players.getLocal().getWorldLocation()), llllllllIllI[2])) {
            n2 = llllllllIllI[2];
            "".length();
            if ("  ".length() < ((0x2A ^ 6 ^ (0x3D ^ 0x20)) & (0x19 ^ 0x36 ^ (0x22 ^ 0x3C) ^ -" ".length()))) {
                return ((0xA8 ^ 0x83 ^ (0x6C ^ 3)) & (0x1E ^ 0x14 ^ (0xC1 ^ 0x8F) ^ -" ".length())) != 0;
            }
        } else {
            n2 = llllllllIllI[1];
        }
        int lllllllllllllllIIlIIIIllIIlIIlIl = n2;
        int n3 = Players.getLocal().isAnimating();
        if (l.lIIlIlIllIlllIl(lllllllllllllllIIlIIIIllIIlIIlIl) && l.lIIlIlIllIlllIl(n3)) {
