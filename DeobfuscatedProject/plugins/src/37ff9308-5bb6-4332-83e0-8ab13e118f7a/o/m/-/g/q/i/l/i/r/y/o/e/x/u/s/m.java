...
extends Task {
    ...
    private static void lIIlIllIIIIIlII() {
        ...
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[0]] = m.lIIlIllIIIIIIIl("OzcKbCDQk4Q=", "FmuQX");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[2]] = m.lIIlIllIIIIIIlI("HuJpgMcSXiKLkoO9xKU2TA==", "iMqFD");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[3]] = m.lIIlIllIIIIIIIl("TA/STvSp7IYF+SUDJuD4Hg==", "edwRI");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[4]] = m.lIIlIllIIIIIIlI("+S/AYANaJVU=", "FwyPe");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[5]] = m.lIIlIllIIIIIIIl("tcG4O0zKND2YlCoc4sUIJQ==", "ivkvb");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[6]] = m.lIIlIllIIIIIIll("OCwVciIVJgQ3", "tUpRR");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[7]] = m.lIIlIllIIIIIIll("AykJ", "NFqxc");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[8]] = m.lIIlIllIIIIIIll("GSgKaCE1NAYt", "TGrHQ");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[9]] = m.lIIlIllIIIIIIlI("v+cK87BWrtMYLbNEJzv9hw==", "zrzfR");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[10]] = m.lIIlIllIIIIIIIl("mokpTMXzvRUFbiL0HFsdAw==", "weooE");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[11]] = m.lIIlIllIIIIIIlI("8LD/bFAqNyIQsDQA23RLyQ==", "OZVfO");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[12]] = m.lIIlIllIIIIIIlI("437facKfAYo=", "fByzR");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[13]] = m.lIIlIllIIIIIIll("JQoOZTwJFgIg", "hevEL");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[14]] = m.lIIlIllIIIIIIIl("8+cOMGtIIn8dSKvjq7+cWQ==", "nKrCa");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[15]] = m.lIIlIllIIIIIIll("GyAraB87ND4t", "ZGJHo");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[16]] = m.lIIlIllIIIIIIlI("8Z6xpR7g0XqNN9V7E2+x2g==", "rrTNw");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[17]] = m.lIIlIllIIIIIIlI("bZCzrFIjT9T/h4pnulKE4Q==", "Xjrcb");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[18]] = m.lIIlIllIIIIIIlI("rjVDyq6xtf4=", "iqkNG");
        m.lIIIIIIIIIIII[m.lIIIIIIIIIIIl[19]] = m.lIIlIllIIIIIIll("Bx0cBCQ8CA==", "HmyvE");
    }
    ...
    public boolean d() {
        ...
        while (m.lIIlIllIIIIIlll(lllllllllllllllIIlIIIIIlIlIlllIl, (int)lllllllllllllllIIlIIIIIlIlIllllI)) {
            ...
            return ((163 + 53 - 57 + 55 ^ 34 + 53 - -23 + 31) & (154 + 52 - 18 + 29 ^ 79 + 34 - 82 + 99 ^ -" ".length())) != 0;
        }
        return lIIIIIIIIIIIl[0];
    }
    ...
    private static void lIIlIllIIIIIlIl() {
        ...
        m.lIIIIIIIIIIIl[2] = " ".length();
        m.lIIIIIIIIIIIl[3] = "  ".length();
        m.lIIIIIIIIIIIl[4] = "   ".length();
