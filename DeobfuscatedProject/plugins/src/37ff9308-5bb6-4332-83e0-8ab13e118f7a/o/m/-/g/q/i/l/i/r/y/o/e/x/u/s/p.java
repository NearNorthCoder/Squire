...
extends Task {
    ...
    private static void lIIlIlIlIIlIlll() {
        ...
        p.lllllllIlIII[1] = " ".length();
        p.lllllllIlIII[2] = (0xFB ^ 0xB3 ^ (0x67 ^ 0x7D)) & (0x1A ^ 0x7F ^ (0x51 ^ 0x66) ^ -" ".length());
        p.lllllllIlIII[3] = "  ".length();
    ...
    private static void lIIlIlIlIIlIllI() {
        ...
        p.lllllllIIlll[p.lllllllIlIII[2]] = p.lIIlIlIlIIlIlII("W/OTEgYvSuJVKPM/O6bqaQ==", "qGfQB");
        p.lllllllIIlll[p.lllllllIlIII[1]] = p.lIIlIlIlIIlIlIl("4eTCglKyFmY=", "dyudZ");
    }
}
