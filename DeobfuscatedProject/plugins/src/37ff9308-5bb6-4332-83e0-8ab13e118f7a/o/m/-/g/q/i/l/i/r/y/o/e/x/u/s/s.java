...
public class s {
    ...
    public static boolean h() {
        ...
        while (s.lIIlIlIllllIlII(lllllllllllllllIIlIIIIlIIlIIIIIl, (int)lllllllllllllllIIlIIIIlIIlIIIIlI)) {
            ...
            return (((0xBE ^ 0xB4) & ~(0xC ^ 6) ^ (0x6F ^ 0x37)) & (7 + 154 - 16 + 63 ^ 43 + 46 - 8 + 55 ^ -" ".length())) != 0;
        }
    ...
    private static t a(t ... tArray) {
        ...
        while (s.lIIlIlIllllIlII(lllllllllllllllIIlIIIIlIIlllIIIl, (int)lllllllllllllllIIlIIIIlIIlllIIlI)) {
            ...
            "".length();
            if (((30 + 19 - 27 + 105 ^ (0x24 ^ 0x76)) & (1 + 124 - 29 + 58 ^ 125 + 37 - 31 + 52 ^ -" ".length())) == 0) continue;
            return null;
        }
        return t2;
    }
    ...
    private static void lIIlIlIllllIIIl() {
        ...
        s.llllllllllIl[0] = "   ".length();
        s.llllllllllIl[1] = (0x97 ^ 0xA0 ^ (0x5A ^ 0x73)) & (0xCD ^ 0x80 ^ (0x7A ^ 0x29) ^ -" ".length());
        s.llllllllllIl[2] = " ".length();
        s.llllllllllIl[3] = "  ".length();
    ...
    public static int f(String string) {
        ...
        while (s.lIIlIlIllllIlII(lllllllllllllllIIlIIIIIlllllIlll, (int)lllllllllllllllIIlIIIIIllllllIII)) {
            ...
            "".length();
            if (((0x59 ^ 9 ^ (0x7F ^ 0x64)) & (126 + 18 - 54 + 51 ^ 131 + 127 - 122 + 62 ^ -" ".length())) == 0) continue;
            return (34 + 198 - 134 + 124 ^ 64 + 18 - 69 + 115) & (0xF3 ^ 0x96 ^ (0x43 ^ 0x78) ^ -" ".length());
        }
        return llllllllllIl[8];
    }
    ...
    private static void lIIlIlIllllIIII() {
        ...
        s.lllllllllIIl[s.llllllllllIl[1]] = s.lIIlIlIlllIIIlI("zoCR/b+dUwltLWBKL7qZrQ==", "tKaDp");
        s.lllllllllIIl[s.llllllllllIl[2]] = s.lIIlIlIlllIIIll("", "ciqDk");
        s.lllllllllIIl[s.llllllllllIl[3]] = s.lIIlIlIlllIIlII("iF86HhQlYor+DgknIIqtgg==", "ZdsED");
        s.lllllllllIIl[s.llllllllllIl[0]] = s.lIIlIlIlllIIIlI("25wiB9orx6o=", "OlnXD");
        s.lllllllllIIl[s.llllllllllIl[5]] = s.lIIlIlIlllIIIll("MTZDCUdDb1YJRg==", "mEiUo");
        s.lllllllllIIl[s.llllllllllIl[7]] = s.lIIlIlIlllIIIlI("48aqkaJ7YAg=", "UJNMh");
        s.lllllllllIIl[s.llllllllllIl[6]] = s.lIIlIlIlllIIlII("Gs1oEUmRyygP8O5fcWREUa0Cy9qP3aKF", "OkAvs");
        s.lllllllllIIl[s.llllllllllIl[9]] = s.lIIlIlIlllIIIll("DT8pbBwkMCk+", "AFLLp");
        s.lllllllllIIl[s.llllllllllIl[10]] = s.lIIlIlIlllIIIlI("b0f9WYIKaBZgbsvNE0qwCw==", "rdPjN");
        s.lllllllllIIl[s.llllllllllIl[11]] = s.lIIlIlIlllIIIlI("4eae5eEKKCVwHSLNcKLf2Q==", "jgWZd");
        s.lllllllllIIl[s.llllllllllIl[15]] = s.lIIlIlIlllIIIll("DT4BGSo2K0QHMiduCA49Jzw=", "BNdkK");
        s.lllllllllIIl[s.llllllllllIl[16]] = s.lIIlIlIlllIIIll("OxYrChMAAw==", "tfNxr");
        s.lllllllllIIl[s.llllllllllIl[17]] = s.lIIlIlIlllIIIll("AQAWKhU6FVM1GzZQHz0CKwI=", "NpsXt");
        s.lllllllllIIl[s.llllllllllIl[18]] = s.lIIlIlIlllIIIlI("ZJsqR1vQS2A=", "jBEwb");
        s.lllllllllIIl[s.llllllllllIl[19]] = s.lIIlIlIlllIIIlI("5IWmapZHsPeWEYMCbsP2IAnsSGgS9Amx", "IxkxO");
        s.lllllllllIIl[s.llllllllllIl[20]] = s.lIIlIlIlllIIlII("5dfuU954IXc=", "pklTe");
        s.lllllllllIIl[s.llllllllllIl[21]] = s.lIIlIlIlllIIIll("DgknNjc1HGIoLyRZLiEgJAs=", "AyBDV");
        s.lllllllllIIl[s.llllllllllIl[22]] = s.lIIlIlIlllIIIlI("Q5JVYvX7E3k=", "EAJaJ");
        s.lllllllllIIl[s.llllllllllIl[23]] = s.lIIlIlIlllIIlII("Oa6QxSnNFpHW76hf07wFEr8e7AmT6H8V", "TCylh");
        s.lllllllllIIl[s.llllllllllIl[24]] = s.lIIlIlIlllIIIll("DBULPAk3AA==", "CenNh");
        s.lllllllllIIl[s.llllllllllIl[25]] = s.lIIlIlIlllIIIll("PBMCFysHBkcELRJDCwA8FhE=", "scgeJ");
        s.lllllllllIIl[s.llllllllllIl[26]] = s.lIIlIlIlllIIIlI("tVs3b/A1+78=", "VAVAh");
        s.lllllllllIIl[s.llllllllllIl[27]] = s.lIIlIlIlllIIlII("yxPidehDYVgh8is+oPanNn11Lic89E9f", "FglYE");
        s.lllllllllIIl[s.llllllllllIl[28]] = s.lIIlIlIlllIIlII("sJAu4QQxLcU=", "XHjtT");
        s.lllllllllIIl[s.llllllllllIl[29]] = s.lIIlIlIlllIIIlI("rP7QUl15Uf/eCNoAI57eotUD1+LHPyqd", "DJwrx");
        s.lllllllllIIl[s.llllllllllIl[30]] = s.lIIlIlIlllIIIlI("nkBu6Qp+zYU=", "gRccs");
        s.lllllllllIIl[s.llllllllllIl[31]] = s.lIIlIlIlllIIIll("GCEAIg4jNEUxCDZxCTUZMiM=", "WQePo");
        s.lllllllllIIl[s.llllllllllIl[32]] = s.lIIlIlIlllIIIll("Kh8SFAwRCg==", "eowfm");
        s.lllllllllIIl[s.llllllllllIl[36]] = s.lIIlIlIlllIIIlI("HWSEy84tqMkS4XWz2vaLsHndcqWKu52rFdAJ5/ZtvNK24I7HRuWsrw==", "shbGF");
        s.lllllllllIIl[s.llllllllllIl[37]] = s.lIIlIlIlllIIIlI("lX8S97hu4oUHXbfhtaxDEcnZQOCFL1geztkQ8ltvUg0Bpe+7UGf+Dg==", "aUMQl");
        s.lllllllllIIl[s.llllllllllIl[38]] = s.lIIlIlIlllIIlII("wxHvWRVJpCzuHlOrQ/qal/v1wz9GazZgcXmaURNSf4vpD+txfkrzAQ==", "wPdDR");
        s.lllllllllIIl[s.llllllllllIl[39]] = s.lIIlIlIlllIIIll("FwA9AxdxHycZU2NPLgQdOBwgCBdxDiYJUyEAPE1BcQY7TRYgGikBUyUAaB0cJU97", "QoHms");
        s.lllllllllIIl[s.llllllllllIl[40]] = s.lIIlIlIlllIIIll("Nyx0OQkNQ2dpBxcHdC8JDA0waRYWF3R6RgwNMg==", "ycTIf");
    }
    ...
    public static boolean b(String string, String string2, String string3) {
        ...
        while (s.lIIlIlIllllIlII(lllllllllllllllIIlIIIIlIIIlIIIll, (int)lllllllllllllllIIlIIIIlIIIlIIlII)) {
            ...
            if (s.lIIlIlIllllIlIl(lllllllllllllllIIlIIIIlIIIlIIIlI.a().equalsIgnoreCase(lllllllllllllllIIlIIIIlIIIlIlIll) ? 1 : 0)) {
                ...
                "".length();
                if (((0xC ^ 0x1C ^ (0x22 ^ 0x27)) & (0x65 ^ 0x57 ^ (0x50 ^ 0x77) ^ -" ".length())) != 0) {
                    return ((0xD2 ^ 0xAE ^ (0x93 ^ 0xC0)) & (109 + 41 - 93 + 180 ^ 63 + 153 - 40 + 18 ^ -" ".length())) != 0;
                }
                ...
                "".length();
                if (" ".length() != " ".length()) {
                    return ((63 + 138 - 193 + 162 ^ 99 + 57 - 71 + 50) & (0x57 ^ 0x26 ^ (0xC9 ^ 0x95) ^ -" ".length())) != 0;
                }
            }
            ++lllllllllllllllIIlIIIIlIIIlIIIll;
            "".length();
            if (" ".length() >= ((0x51 ^ 0x3B ^ (0xA ^ 0x58)) & (0x3E ^ 0x67 ^ (0xA1 ^ 0xC0) ^ -" ".length()))) continue;
            return ((0xD0 ^ 0xA2 ^ (0xC6 ^ 0xBC)) & (0xC9 ^ 0xAB ^ (0xFB ^ 0x91) ^ -" ".length())) != 0;
        }
        int[] nArray = new int[llllllllllIl[2]];
