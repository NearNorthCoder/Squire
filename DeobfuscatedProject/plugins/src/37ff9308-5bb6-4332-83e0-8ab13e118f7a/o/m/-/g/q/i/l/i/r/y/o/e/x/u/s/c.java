...
extends Enum<c> {
    ...
    private static void lIIlIlIllIlIIlI() {
        ...
        c.llllllllIIll[c.llllllllIlII[0]] = c.lIIlIlIllIIllll("4qiLoj9WOCEabbPEjeODUg==", "BTqvv");
        c.llllllllIIll[c.llllllllIlII[1]] = c.lIIlIlIllIlIIII("JRg6CygFWSMPPxM=", "wyTjZ");
        c.llllllllIIll[c.llllllllIlII[3]] = c.lIIlIlIllIIllll("XMY7VUjaupFwbeASkZDfHA==", "CgDTi");
        c.llllllllIIll[c.llllllllIlII[4]] = c.lIIlIlIllIlIIII("FykGJhYvJx8=", "CFgBp");
        c.llllllllIIll[c.llllllllIlII[6]] = c.lIIlIlIllIlIIIl("Z9f6NXhM8Hw=", "OdQbq");
        c.llllllllIIll[c.llllllllIlII[7]] = c.lIIlIlIllIIllll("QN5DN/hf5BY=", "WyIei");
        c.llllllllIIll[c.llllllllIlII[9]] = c.lIIlIlIllIlIIII("KTM4LwYv", "bdmnT");
        c.llllllllIIll[c.llllllllIlII[10]] = c.lIIlIlIllIlIIII("DwIDLT4p", "DuvLL");
        c.llllllllIIll[c.llllllllIlII[12]] = c.lIIlIlIllIlIIII("NCs7ADQ1JD0fPg==", "gezPp");
        c.llllllllIIll[c.llllllllIlII[13]] = c.lIIlIlIllIlIIIl("2yCi3NWsJpPMQzdIFB6XuQ==", "wXIiX");
        c.llllllllIIll[c.llllllllIlII[15]] = c.lIIlIlIllIlIIII("IQUcNBghGwI6HiwRHDM=", "sDRuJ");
        c.llllllllIIll[c.llllllllIlII[16]] = c.lIIlIlIllIlIIII("GhklCjE6WDsENyEXJUtrPRYtQg==", "HxKkC");
        c.llllllllIIll[c.llllllllIlII[18]] = c.lIIlIlIllIlIIIl("cpY/7Hfy+W36wtaF3HUUaczwkzgOGgi0", "bmHUj");
        c.llllllllIIll[c.llllllllIlII[19]] = c.lIIlIlIllIlIIIl("fz3rdCQP4TOiK7EgVw7MDoC9juSO2dGb", "GcUTE");
        c.llllllllIIll[c.llllllllIlII[21]] = c.lIIlIlIllIlIIII("AhAwKyQMAy41PxcZJCs2", "CFqep");
        c.llllllllIIll[c.llllllllIlII[22]] = c.lIIlIlIllIlIIIl("GlqdEDfVcLUefhDTv+xSI2EN+4ySujEP", "wtoiN");
        c.llllllllIIll[c.llllllllIlII[24]] = c.lIIlIlIllIIllll("cSKtj5u2b0B+0Ktg1ItUiQ==", "QPwFV");
        c.llllllllIIll[c.llllllllIlII[25]] = c.lIIlIlIllIlIIII("OC8gMQgeeCU/Dho3O3BSBjYzeQ==", "sXUPz");
        c.llllllllIIll[c.llllllllIlII[27]] = c.lIIlIlIllIlIIII("PDkAFR09NgYKFzAnDhEGOjkH", "owAEY");
        c.llllllllIIll[c.llllllllIlII[28]] = c.lIIlIlIllIlIIIl("xeRU3BGewJdT0NcHG/026Ow7P90FXDEd", "gDXBH");
    }

    private static void lIIlIlIllIlIIll() {
        llllllllIlII = new int[31];
        c.llllllllIlII[0] = (1 ^ 0x10) & ~(0x7F ^ 0x6E);
        c.llllllllIlII[1] = " ".length();
        c.llllllllIlII[2] = 0xFFFF93DD & 0x6D23;
        c.llllllllIlII[3] = "  ".length();
        c.llllllllIlII[4] = "   ".length();
