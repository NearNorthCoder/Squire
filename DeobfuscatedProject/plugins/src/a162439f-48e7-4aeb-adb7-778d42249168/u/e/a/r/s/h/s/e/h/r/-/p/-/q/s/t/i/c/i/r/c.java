...
extends Task {
    ...
    private static boolean h() {
        ...
        if (u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lllIIIIlIlIlII(Players.getLocal().getAnimation(), lIlIlllIIIIl[10])) {
            ...
            if (u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lllIIIIlIlIlIl(Inventory.getCount((int[])nArray))) {
                ...
                return ((0x3F ^ 0x20 ^ (0x4D ^ 6)) & (47 + 56 - -63 + 75 ^ 70 + 36 - -14 + 45 ^ -" ".length())) != 0;
            }
        }
        n = lIlIlllIIIIl[1];
        return n != 0;
        ...
        while (u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lllIIIIlIlIIll(lllllllllllllllIllIIlIIlIIIllIIl, (int)lllllllllllllllIllIIlIIlIIIllIlI)) {
            ...
            if (u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lllIIIIlIlIIII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lllIIIIlIlIIIl((int)lllllllllllllllIllIIlIIlIIIlllII, lIlIlllIIIIl[3])) {
                    "".length();
                    if (-" ".length() > "   ".length()) {
                        return (0x76 ^ 0x4F ^ (0xD2 ^ 0xB6)) & (0xB0 ^ 0x85 ^ (0xE9 ^ 0x81) ^ -" ".length());
                    }
                } else {
            ...
            "".length();
            if (((0x57 ^ 6 ^ (0x1C ^ 0x2F)) & (0xB3 ^ 0xAF ^ (9 ^ 0x77) ^ -" ".length())) == 0) continue;
            return (71 + 109 - 72 + 25 ^ 95 + 139 - 114 + 23) & (0x58 ^ 0x7A ^ (0x6A ^ 0x42) ^ -" ".length());
        }
        return n;
    }
    ...
    private static void lllIIIIlIIllll() {
        ...
        u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lIlIlllIIIIl[2] = " ".length();
        ...
        u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lIlIlllIIIIl[5] = "  ".length();
        ...
        u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lIlIlllIIIIl[14] = "   ".length();
    ...
    private static boolean i() {
        ...
        if (u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lllIIIIlIlIIII(Inventory.isFull() ? 1 : 0)) {
            ...
            if (u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lllIIIIlIlIllI(Inventory.getCount((int[])nArray))) {
                ...
                return ((0xF4 ^ 0x84 ^ (0x2C ^ 0x40)) & (88 + 81 - 119 + 128 ^ 71 + 83 - 138 + 158 ^ -" ".length())) != 0;
            }
        }
        n = lIlIlllIIIIl[1];
        return n != 0;
    ...
    private static void lllIIIIlIIllIl() {
        ...
        u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lIlIllIllllI[u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lIlIlllIIIIl[1]] = u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lllIIIIlIIlIlI("JTMLEzc=", "qAjwR");
        u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lIlIllIllllI[u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lIlIlllIIIIl[2]] = u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lllIIIIlIIlIlI("KxMoKgARCSB6Eh0EJi8DHUcwP1AZFSJ6Hw0TZzUWWAQoMx4L", "xgGZp");
        u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lIlIllIllllI[u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lIlIlllIIIIl[5]] = u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lllIIIIlIIlIlI("MDgtKDYKIiV4JAYvIy01Bmw1PWYALSw2KRdsITk1F2wxLTYGPiU0JxA/YjUnCCk=", "cLBXF");
        u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lIlIllIllllI[u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lIlIlllIIIIl[14]] = u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lllIIIIlIIlIll("fu2cnrtnm20=", "HMGPg");
        u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lIlIllIllllI[u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lIlIlllIIIIl[0]] = u.e.a.r.s.h.s.e.h.r.-.p.-.q.s.t.i.c.i.r.c.lllIIIIlIIllII("UUtbZx0GfqQ=", "LnJYP");
    }
}
