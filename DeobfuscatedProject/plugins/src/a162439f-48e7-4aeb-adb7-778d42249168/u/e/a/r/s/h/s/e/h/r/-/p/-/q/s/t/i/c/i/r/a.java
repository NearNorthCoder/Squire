...
extends Enum<a> {
    ...
    private static void lllIIIIlIIIIlI() {
        ...
        a.lIlIllIllIll[5] = "  ".length();
        a.lIlIllIllIll[6] = 0xFFFF97ED & 0x79BF;
        a.lIlIllIllIll[7] = " ".length() ^ (0x2A ^ 0x27);
        a.lIlIllIllIll[8] = "   ".length();
    ...
    private static void lllIIIIlIIIIIl() {
        ...
        a.lIlIllIllIlI[a.lIlIllIllIll[1]] = a.lllIIIIIlllllI("B4W8fAy5XQoSuNJhK8iquA==", "eZoeE");
        a.lIlIllIllIlI[a.lIlIllIllIll[0]] = a.lllIIIIIllllll("CgoIAS4MFAoELB0OFAs=", "IKFEb");
        a.lIlIllIllIlI[a.lIlIllIllIll[5]] = a.lllIIIIlIIIIII("ri9fEYuYx1o0arR2cWOzVA==", "MHsKt");
        a.lIlIllIllIlI[a.lIlIllIllIll[8]] = a.lllIIIIIlllllI("kjQ6XxzNNhA=", "AZTOt");
        a.lIlIllIllIlI[a.lIlIllIllIll[4]] = a.lllIIIIIllllll("KCIzEQAyKSoWES8gNAk=", "mocEY");
        a.lIlIllIllIlI[a.lIlIllIllIll[13]] = a.lllIIIIIllllll("Aw8GFQETExMeCRkTFA==", "VAVZV");
        a.lIlIllIllIlI[a.lIlIllIllIll[16]] = a.lllIIIIIlllllI("1fDASXpmgiiotx6LTatxhA==", "SUobm");
        a.lIlIllIllIlI[a.lIlIllIllIll[19]] = a.lllIIIIIllllll("DgwfOzEUDQYoIB8eAD0q", "KAOoh");
    }
