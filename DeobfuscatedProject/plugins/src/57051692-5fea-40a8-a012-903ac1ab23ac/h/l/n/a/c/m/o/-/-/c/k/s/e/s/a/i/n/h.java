...
public class h {
    ...
    private static void lIIllIIlIIlIl() {
        ...
        h.lIllIlIIII[1] = " ".length();
        h.lIllIlIIII[2] = "  ".length();
        h.lIllIlIIII[3] = "   ".length();
        ...
        h.lIllIlIIII[79] = "   ".length() ^ (0xA4 ^ 0x9B);
    ...
    private static void lIIllIIIlIIll() {
        ...
        h.lIllIIllll[h.lIllIlIIII[0]] = h.lIIllIIIlIIII("AXk/NS4LLio=", "gKOXK");
        h.lIllIIllll[h.lIllIlIIII[1]] = h.lIIllIIIlIIII("NEQCPwQ3BQY=", "RvrNq");
        h.lIllIIllll[h.lIllIlIIII[2]] = h.lIIllIIIlIIIl("LH2InbgHwWE=", "xtjby");
        h.lIllIIllll[h.lIllIlIIII[3]] = h.lIIllIIIlIIII("NykxEw==", "ZHVvB");
        h.lIllIIllll[h.lIllIlIIII[4]] = h.lIIllIIIlIIlI("W5LS2GIzMNY=", "nvSVy");
        h.lIllIIllll[h.lIllIlIIII[5]] = h.lIIllIIIlIIII("FTwVEh8qJicEGw==", "dIpak");
        h.lIllIIllll[h.lIllIlIIII[6]] = h.lIIllIIIlIIlI("uGBBYHTiFrs=", "tKOtg");
        h.lIllIIllll[h.lIllIlIIII[7]] = h.lIIllIIIlIIII("JzQlLR0yKg==", "FSLAt");
        h.lIllIIllll[h.lIllIlIIII[8]] = h.lIIllIIIlIIIl("3t1L55CQvQvZAYJZVOxrlw==", "zDNUL");
        h.lIllIIllll[h.lIllIlIIII[9]] = h.lIIllIIIlIIII("FCILBQ8oLh8=", "fCebj");
        h.lIllIIllll[h.lIllIlIIII[10]] = h.lIIllIIIlIIII("ODI6KRoHOi4oEUoWJTgcGj4xIwFQ", "jSTMu");
        h.lIllIIllll[h.lIllIlIIII[11]] = h.lIIllIIIlIIlI("qq5thURvba51VsgvtqHylA==", "pTCqc");
        h.lIllIIllll[h.lIllIlIIII[12]] = h.lIIllIIIlIIII("JxgnADEJFC1JIBQIIAclQRg9DC8SXWkaNQgFKgErDxZpCyMCGmkdLUEDKAcmDhwODCMTGCcO", "aqIiB");
        h.lIllIIllll[h.lIllIlIIII[13]] = h.lIIllIIIlIIlI("BKOiYgIsYo0ITVVbkoLeXuUH7APyTN3C", "RUdjs");
        h.lIllIIllll[h.lIllIlIIII[14]] = h.lIIllIIIlIIlI("+wUCtFRQt453CFU5YR7QKlHb65EfjqpX", "MTIVY");
        h.lIllIIllll[h.lIllIlIIII[19]] = h.lIIllIIIlIIlI("JLU2bTS3F+6JlXdNwCxV7ZRyhgJ76dbM9hDgJtmc81h+PVd1uOd0Oz+BIDFIyAVc", "hdbAj");
        h.lIllIIllll[h.lIllIlIIII[20]] = h.lIIllIIIlIIlI("SFLOir27AQ9ZLIITsor1zjc2sQwGu58JdcXxa0jYbgHoflvngblAstnKNfBShb7z", "dzLlW");
        h.lIllIIllll[h.lIllIlIIII[21]] = h.lIIllIIIlIIlI("75CnuEMWpyKeN2F0THE9res/aMLThC9p2MhLkwpdblllfklE2maGFmsH07OrvUR7", "zqzIP");
        h.lIllIIllll[h.lIllIlIIII[24]] = h.lIIllIIIlIIlI("/UO+sb/C9X8xo1dr/5zlT7Re4Sh40mev", "KkDqk");
        h.lIllIIllll[h.lIllIlIIII[216]] = h.lIIllIIIlIIlI("BQ8e2t8nFdKVYhTTDMyN+h9zkp4qlmOrl9uWpx8bYmBOaDvdA5SEpFteBSQsPfIx1NEfQ+5/G7A=", "WUTVy");
        h.lIllIIllll[h.lIllIlIIII[46]] = h.lIIllIIIlIIII("NhQPECAJVQYRLhZVDR08EAZBNwMhNDMxCw==", "duatO");
        h.lIllIIllll[h.lIllIlIIII[217]] = h.lIIllIIIlIIII("NC4zBAcr", "CKRhs");
    }
    ...
    public static boolean b(int[] nArray) {
        int[] lllllllllllllllllllIIIlIlIlIlIlI;
        int lllllllllllllllllllIIIlIlIlIlIIl = lIllIlIIII[0];
        while (h.lIIllIIlIlIII(lllllllllllllllllllIIIlIlIlIlIIl, lllllllllllllllllllIIIlIlIlIlIlI.length)) {
            if (h.lIIllIIlIlIlI(lllllllllllllllllllIIIlIlIlIlIlI[lllllllllllllllllllIIIlIlIlIlIIl])) {
                int[] nArray2 = new int[lIllIlIIII[1]];
                nArray2[h.lIllIlIIII[0]] = lllllllllllllllllllIIIlIlIlIlIlI[lllllllllllllllllllIIIlIlIlIlIIl];
                if (h.lIIllIIlIIlll(Bank.contains((int[])nArray2) ? 1 : 0)) {
                    System.out.println("Missing ID: " + lllllllllllllllllllIIIlIlIlIlIlI[lllllllllllllllllllIIIlIlIlIlIIl]);
                    return lIllIlIIII[0];
                }
            }
            ++lllllllllllllllllllIIIlIlIlIlIIl;
            "".length();
            if (((0x58 ^ 0x36 ^ (0xEA ^ 0x83)) & (67 + 7 - 23 + 76 ^ (0x1C ^ 0x64) ^ -" ".length())) == 0) continue;
            return ((0xA1 ^ 0xC1 ^ (0x74 ^ 0x19)) & (0x30 ^ 0x34 ^ (0x74 ^ 0x7D) ^ -" ".length())) != 0;
        }
        return lIllIlIIII[1];
    }
    ...
    public static void d(String string) {
        if (!h.lIIllIIlIIllI(bB) || h.lIIllIIlIIlll(bH)) {
            String lllllllllllllllllllIIIlIlIlIllll;
            if (h.lIIllIIlIIllI(lllllllllllllllllllIIIlIlIlIllll.equalsIgnoreCase(lIllIIllll[lIllIlIIII[0]]) ? 1 : 0)) {
                h.P();
            }
            if (h.lIIllIIlIIllI(lllllllllllllllllllIIIlIlIlIllll.equalsIgnoreCase(lIllIIllll[lIllIlIIII[1]]) ? 1 : 0)) {
                // empty if block
            }
            if (h.lIIllIIlIIllI(lllllllllllllllllllIIIlIlIlIllll.equalsIgnoreCase(lIllIIllll[lIllIlIIII[2]]) ? 1 : 0)) {
                h.T();
            }
            if (h.lIIllIIlIIllI(lllllllllllllllllllIIIlIlIlIllll.equalsIgnoreCase(lIllIIllll[lIllIlIIII[3]]) ? 1 : 0)) {
                // empty if block
            }
            if (h.lIIllIIlIIllI(lllllllllllllllllllIIIlIlIlIllll.equalsIgnoreCase(lIllIIllll[lIllIlIIII[4]]) ? 1 : 0)) {
                // empty if block
            }
            if (h.lIIllIIlIIllI(lllllllllllllllllllIIIlIlIlIllll.equalsIgnoreCase(lIllIIllll[lIllIlIIII[5]]) ? 1 : 0)) {
                // empty if block
            }
            if (h.lIIllIIlIIllI(lllllllllllllllllllIIIlIlIlIllll.equalsIgnoreCase(lIllIIllll[lIllIlIIII[6]]) ? 1 : 0)) {
                h.Q();
            }
            if (h.lIIllIIlIIllI(lllllllllllllllllllIIIlIlIlIllll.equalsIgnoreCase(lIllIIllll[lIllIlIIII[7]]) ? 1 : 0)) {
                // empty if block
            }
            if (h.lIIllIIlIIllI(lllllllllllllllllllIIIlIlIlIllll.equalsIgnoreCase(lIllIIllll[lIllIlIIII[8]]) ? 1 : 0)) {
                h.S();
            }
            if (h.lIIllIIlIIllI(lllllllllllllllllllIIIlIlIlIllll.equalsIgnoreCase(lIllIIllll[lIllIlIIII[9]]) ? 1 : 0)) {
                h.R();
            }
            h.U();
        ...
        if (h.lIIllIIlIIllI(bB) && h.lIIllIIlIIllI(bH)) {
            ...
            if (h.lIIllIIlIIlll(bn ? 1 : 0)) {
                BankLocation lllllllllllllllllllIIIlIlIlIlllI = BankLocation.getNearest();
                if (h.lIIllIIlIlIIl(lllllllllllllllllllIIIlIlIlIlllI) && h.lIIllIIlIIlll(lllllllllllllllllllIIIlIlIlIlllI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderShamans.c = lIllIIllll[lIllIlIIII[13]];
                    a.a(lllllllllllllllllllIIIlIlIlIlllI);
                }
                if (h.lIIllIIlIlIIl(lllllllllllllllllllIIIlIlIlIlllI) && h.lIIllIIlIIllI(lllllllllllllllllllIIIlIlIlIlllI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (h.lIIllIIlIIllI(Bank.isOpen() ? 1 : 0)) {
                        ...
                        if (h.lIIllIIlIIllI(h.n(bL) ? 1 : 0)) {
                            ...
                            nArray[h.lIllIlIIII[9]] = bK;
                            nArray[h.lIllIlIIII[10]] = bL;
                            int[] lllllllllllllllllllIIIlIlIlIllIl = nArray;
                            if (h.lIIllIIlIlIll(bL, lIllIlIIII[16])) {
                            ...
                            a.a(lllllllllllllllllllIIIlIlIlIllIl, lIllIlIIII[1]);
                            ...
                            while (!h.lIIllIIlIIlll(Inventory.contains((int[])lllllllllllllllllllIIIlIlIlIllIl) ? 1 : 0) || h.lIIllIIlIIllI(Inventory.contains(item -> {
                                int n2;
    ...
    private static String lIIllIIIlIIIl(String lllllllllllllllllllIIIlIIllIlIlI, String lllllllllllllllllllIIIlIIllIIlll) {
        try {
            SecretKeySpec lllllllllllllllllllIIIlIIllIllIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIIIlIIllIIlll.getBytes(StandardCharsets.UTF_8)), lIllIlIIII[8]), "DES");
            ...
            return new String(lllllllllllllllllllIIIlIIllIllII.doFinal(Base64.getDecoder().decode(lllllllllllllllllllIIIlIIllIlIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static int a(Map<Integer, Integer> map, Random random) {
        Map<Integer, Integer> lllllllllllllllllllIIIlIlIIllllI;
        void lllllllllllllllllllIIIlIlIIlllIl;
        if (h.lIIllIIlIIllI(map.isEmpty() ? 1 : 0)) {
            return lIllIlIIII[0];
        }
        int lllllllllllllllllllIIIlIlIIlllII = lllllllllllllllllllIIIlIlIIlllIl.nextInt(lllllllllllllllllllIIIlIlIIllllI.size());
        int lllllllllllllllllllIIIlIlIIllIll = lIllIlIIII[0];
        Iterator<Integer> lllllllllllllllllllIIIlIlIIllIlI = lllllllllllllllllllIIIlIlIIllllI.keySet().iterator();
        while (h.lIIllIIlIIllI(lllllllllllllllllllIIIlIlIIllIlI.hasNext() ? 1 : 0)) {
            int lllllllllllllllllllIIIlIlIIllIIl = lllllllllllllllllllIIIlIlIIllIlI.next();
            if (h.lIIllIIlIlIll(lllllllllllllllllllIIIlIlIIllIll, lllllllllllllllllllIIIlIlIIlllII)) {
                return lllllllllllllllllllIIIlIlIIllIIl;
            }
            ++lllllllllllllllllllIIIlIlIIllIll;
            "".length();
    ...
    private static String lIIllIIIlIIII(String lllllllllllllllllllIIIlIlIIIllII, String lllllllllllllllllllIIIlIlIIIIllI) {
        lllllllllllllllllllIIIlIlIIIllII = new String(Base64.getDecoder().decode(lllllllllllllllllllIIIlIlIIIllII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllllIIIlIlIIIlIlI = new StringBuilder();
        char[] lllllllllllllllllllIIIlIlIIIlIIl = lllllllllllllllllllIIIlIlIIIIllI.toCharArray();
        int lllllllllllllllllllIIIlIlIIIlIII = lIllIlIIII[0];
        char[] lllllllllllllllllllIIIlIlIIIIIlI = lllllllllllllllllllIIIlIlIIIllII.toCharArray();
        int lllllllllllllllllllIIIlIlIIIIIIl = lllllllllllllllllllIIIlIlIIIIIlI.length;
        int lllllllllllllllllllIIIlIlIIIIIII = lIllIlIIII[0];
        while (h.lIIllIIlIlIII(lllllllllllllllllllIIIlIlIIIIIII, lllllllllllllllllllIIIlIlIIIIIIl)) {
            char lllllllllllllllllllIIIlIlIIIllIl = lllllllllllllllllllIIIlIlIIIIIlI[lllllllllllllllllllIIIlIlIIIIIII];
            lllllllllllllllllllIIIlIlIIIlIlI.append((char)(lllllllllllllllllllIIIlIlIIIllIl ^ lllllllllllllllllllIIIlIlIIIlIIl[lllllllllllllllllllIIIlIlIIIlIII % lllllllllllllllllllIIIlIlIIIlIIl.length]));
            "".length();
            ++lllllllllllllllllllIIIlIlIIIlIII;
            ++lllllllllllllllllllIIIlIlIIIIIII;
            "".length();
            if (-"  ".length() <= 0) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllllIIIlIlIIIlIlI);
    }
    ...
    private static String lIIllIIIlIIlI(String lllllllllllllllllllIIIlIIlllIlll, String lllllllllllllllllllIIIlIIlllIlII) {
        try {
            SecretKeySpec lllllllllllllllllllIIIlIIllllIlI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIIIlIIlllIlII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
    ...
    private static void O() {
        d lllllllllllllllllllIIIlIlIlIIlIl;
        ...
        if (h.lIIllIIlIIllI(bC)) {
            ...
            if (h.lIIllIIlIIlll(Bank.contains((int[])nArray) ? 1 : 0)) {
                lllllllllllllllllllIIIlIlIlIIlIl = new d(bC, lIllIlIIII[1], bN);
                bp.add(lllllllllllllllllllIIIlIlIlIIlIl);
                "".length();
            }
        }
        if (h.lIIllIIlIIllI(bD)) {
            ...
            if (h.lIIllIIlIIlll(Bank.contains((int[])nArray) ? 1 : 0)) {
                lllllllllllllllllllIIIlIlIlIIlIl = new d(bD, lIllIlIIII[1], bO);
                bp.add(lllllllllllllllllllIIIlIlIlIIlIl);
                "".length();
            }
        }
        if (h.lIIllIIlIIllI(bE)) {
            ...
            if (h.lIIllIIlIIlll(Bank.contains((int[])nArray) ? 1 : 0)) {
                lllllllllllllllllllIIIlIlIlIIlIl = new d(bE, lIllIlIIII[1], bP);
                bp.add(lllllllllllllllllllIIIlIlIlIIlIl);
                "".length();
            }
        }
        if (h.lIIllIIlIIllI(bF)) {
            ...
            if (h.lIIllIIlIIlll(Bank.contains((int[])nArray) ? 1 : 0)) {
                lllllllllllllllllllIIIlIlIlIIlIl = new d(bF, lIllIlIIII[1], bQ);
                bp.add(lllllllllllllllllllIIIlIlIlIIlIl);
                "".length();
            }
        }
        if (h.lIIllIIlIIllI(bG)) {
            ...
            if (h.lIIllIIlIIlll(Bank.contains((int[])nArray) ? 1 : 0)) {
                lllllllllllllllllllIIIlIlIlIIlIl = new d(bG, lIllIlIIII[1], bR);
                bp.add(lllllllllllllllllllIIIlIlIlIIlIl);
                "".length();
            }
        }
        if (h.lIIllIIlIIllI(bH)) {
            ...
            if (h.lIIllIIlIIlll(Bank.contains((int[])nArray) ? 1 : 0)) {
                lllllllllllllllllllIIIlIlIlIIlIl = new d(bH, lIllIlIIII[1], bS);
                bp.add(lllllllllllllllllllIIIlIlIlIIlIl);
                "".length();
            }
        }
        if (h.lIIllIIlIIllI(bI)) {
            ...
            if (h.lIIllIIlIIlll(Bank.contains((int[])nArray) ? 1 : 0)) {
                lllllllllllllllllllIIIlIlIlIIlIl = new d(bI, lIllIlIIII[1], bT);
                bp.add(lllllllllllllllllllIIIlIlIlIIlIl);
                "".length();
            }
        }
        if (h.lIIllIIlIIllI(bJ)) {
            ...
            if (h.lIIllIIlIIlll(Bank.contains((int[])nArray) ? 1 : 0)) {
                lllllllllllllllllllIIIlIlIlIIlIl = new d(bJ, lIllIlIIII[1], bU);
                bp.add(lllllllllllllllllllIIIlIlIlIIlIl);
                "".length();
            }
        }
        if (h.lIIllIIlIIllI(bK)) {
            ...
            if (h.lIIllIIlIIlll(Bank.contains((int[])nArray) ? 1 : 0)) {
                lllllllllllllllllllIIIlIlIlIIlIl = new d(bK, lIllIlIIII[1], bV);
                bp.add(lllllllllllllllllllIIIlIlIlIIlIl);
                "".length();
            }
        }
                    ...
                    if (h.lIIllIIlIIlll(Bank.contains((int[])nArray2) ? 1 : 0)) {
                        ...
                        if (h.lIIllIIlIIlll(Bank.contains((int[])nArray3) ? 1 : 0)) {
                            ...
                            if (h.lIIllIIlIIlll(Bank.contains((int[])nArray4) ? 1 : 0)) {
                                lllllllllllllllllllIIIlIlIlIIlIl = new d(bL, lIllIlIIII[1], bW);
                                bp.add(lllllllllllllllllllIIIlIlIlIIlIl);
                                "".length();
                                "".length();
                                if (null != null) {
