...
public class g {
    ...
    private static void lIIlIlIIlIllI() {
        ...
        g.lIlIllllIl[g.lIlIlllllI[3]] = g.lIIlIlIIlIIll("LQsCEkINBQ==", "yjnyo");
        g.lIlIllllIl[g.lIlIlllllI[2]] = g.lIIlIlIIlIlII("s78+x4mqoE4=", "IvnYz");
        g.lIlIllllIl[g.lIlIlllllI[6]] = g.lIIlIlIIlIlIl("QSxnmvN/O/vUnT9UMzcQjQ==", "cUfJs");
        g.lIlIllllIl[g.lIlIlllllI[7]] = g.lIIlIlIIlIlII("MssZh2TMIzQ=", "xqLxR");
        g.lIlIllllIl[g.lIlIlllllI[8]] = g.lIIlIlIIlIlII("uhPQOoNyJ8k=", "WcVCy");
        g.lIlIllllIl[g.lIlIlllllI[4]] = g.lIIlIlIIlIIll("KAAiGDACBipXJwIJIRgk", "khMwC");
        g.lIlIllllIl[g.lIlIlllllI[9]] = g.lIIlIlIIlIlIl("swoVou/jxWg=", "gLotY");
        g.lIlIllllIl[g.lIlIlllllI[10]] = g.lIIlIlIIlIIll("GS0oGSUzKyBWMjMkKxkx", "ZEGvV");
    }
