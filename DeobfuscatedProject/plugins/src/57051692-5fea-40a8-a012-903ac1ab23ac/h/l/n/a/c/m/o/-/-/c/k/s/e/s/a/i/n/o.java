...
implements K {
    ...
    private static void lIIllIlIlIIIl() {
        ...
        o.lIllIlllIl[36] = 0x6B ^ 0x7A ^ "  ".length();
    ...
    static NPC aD() {
        ...
        if (o.lIIllIlIlIlII(list)) {
            ...
            while (o.lIIllIlIlIIlI(lllllllllllllllllllIIIIlIIllIlll, lllllllllllllllllllIIIIlIIlllIIl.size())) {
                ...
                "".length();
                if ("  ".length() > ((0x26 ^ 0x13) & ~(0x43 ^ 0x76))) continue;
                return null;
            }
        }
        return null;
            ...
            while (o.lIIllIlIlIIlI(lllllllllllllllllllIIIIlIIllIIIl, lllllllllllllllllllIIIIlIIllIIlI.size())) {
                ...
                if (o.lIIllIlIlIlIl(((Player)lllllllllllllllllllIIIIlIIllIIlI.get(lllllllllllllllllllIIIIlIIllIIIl)).equals(Players.getLocal()) ? 1 : 0)) {
                    ...
                    if ((23 + 98 - 109 + 137 ^ 51 + 76 - 67 + 84) == 0) {
                        return ((0xFA ^ 0xB6 ^ (0xA3 ^ 0xC5)) & (26 + 62 - -14 + 69 ^ 119 + 88 - 98 + 20 ^ -" ".length())) != 0;
                    }
                ...
                "".length();
                if ("   ".length() >= ((164 + 194 - 294 + 161 ^ 134 + 155 - 154 + 32) & (212 + 217 - 297 + 97 ^ 72 + 107 - 76 + 60 ^ -" ".length()))) continue;
                return ((11 + 56 - -15 + 76 ^ 96 + 138 - 83 + 10) & (7 ^ 9 ^ (0x78 ^ 0x49) ^ -" ".length())) != 0;
            }
        }
        return lIllIlllIl[1];
    }
    ...
    private static void lIIllIlIlIIII() {
        ...
        o.lIllIlllII[o.lIllIlllIl[1]] = o.lIIllIlIIllIl("aumsglPoHaCyGRGe7FqoHSi2Xgrh1mD1", "DkFqx");
        o.lIllIlllII[o.lIllIlllIl[0]] = o.lIIllIlIIllIl("OHbPRJtV6nSfsEij34HBdzCWY+faRKdj", "nNqWn");
        o.lIllIlllII[o.lIllIlllIl[3]] = o.lIIllIlIIlllI("KRDmzTGD+Ap1LP/fl4eNbU6O3PPT1I13", "TPMhL");
        o.lIllIlllII[o.lIllIlllIl[10]] = o.lIIllIlIIllll("Gi8faA47bhopFDBuCjobNj0=", "TNiHz");
        o.lIllIlllII[o.lIllIlllIl[12]] = o.lIIllIlIIllIl("y3D3iAFd0b8=", "bGpqd");
        o.lIllIlllII[o.lIllIlllIl[13]] = o.lIIllIlIIlllI("A7SszBdVUl4ySDLiXTO5hQ==", "WUipz");
        o.lIllIlllII[o.lIllIlllIl[14]] = o.lIIllIlIIllll("BAYXBjopRw8HOT9HGgo3OA==", "LgybV");
        o.lIllIlllII[o.lIllIlllIl[15]] = o.lIIllIlIIlllI("2u+yyS7tUAg=", "CBbLM");
        o.lIllIlllII[o.lIllIlllIl[16]] = o.lIIllIlIIllIl("8q9RAwfaB2VbH1r8gMXgOWLwSp9gXEG8", "bSdpF");
        o.lIllIlllII[o.lIllIlllIl[17]] = o.lIIllIlIIllll("KS47GEwpKDoPDQsoJQUZCg==", "yAIll");
        o.lIllIlllII[o.lIllIlllIl[8]] = o.lIIllIlIIllIl("gKG1wlugdWBwaSLXaJohbNjeJRq3B2Y1", "tLnDp");
        o.lIllIlllII[o.lIllIlllIl[18]] = o.lIIllIlIIllIl("cZmU35OAMmg=", "XITla");
        o.lIllIlllII[o.lIllIlllIl[19]] = o.lIIllIlIIllIl("FTTulN5sLKs=", "HYCOM");
        o.lIllIlllII[o.lIllIlllIl[20]] = o.lIIllIlIIllIl("RIpdwiJyYO278zSIrvLPxg==", "zqXZK");
        o.lIllIlllII[o.lIllIlllIl[21]] = o.lIIllIlIIllll("ID8vAD1COTQPKQo/Ig==", "bZFnZ");
        o.lIllIlllII[o.lIllIlllIl[22]] = o.lIIllIlIIllll("Ihs4KgsIBiIsSAAdLTgABgs=", "coLKh");
        o.lIllIlllII[o.lIllIlllIl[23]] = o.lIIllIlIIlllI("Nw10xsDh1VY=", "PCmul");
        o.lIllIlllII[o.lIllIlllIl[30]] = o.lIIllIlIIllIl("vj7ACOE9a4gPEANQLy5Q8g==", "xmxCs");
        o.lIllIlllII[o.lIllIlllIl[34]] = o.lIIllIlIIllIl("VIhHx6pbDvKB602OPe+4mw==", "JtMuu");
        o.lIllIlllII[o.lIllIlllIl[36]] = o.lIIllIlIIllll("ASIbAG4RMRQG", "rCudN");
        o.lIllIlllII[o.lIllIlllIl[60]] = o.lIIllIlIIllll("LRsVAGsKUxMGKRgHWFQvGB1UDSMMUwAVJxxTGRFsDRsRBilZAxgRLQoWSw==", "ysttL");
        o.lIllIlllII[o.lIllIlllIl[61]] = o.lIIllIlIIllll("GQcGSA81E0gcFzEDSAUTehIHSDEoAwkcVhEJHRoTNAJX", "Zfhhv");
        o.lIllIlllII[o.lIllIlllIl[62]] = o.lIIllIlIIllIl("EwWoyqEqPT5WZxYU2onfLA==", "AuaFa");
    }
