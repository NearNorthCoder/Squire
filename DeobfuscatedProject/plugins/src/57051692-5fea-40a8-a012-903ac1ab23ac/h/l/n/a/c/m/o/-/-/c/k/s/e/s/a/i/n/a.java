...
public class a {
    ...
    private static void lIIIlllIlllII() {
        ...
        a.lIlIIlllll[a.lIlIlIIIII[2]] = a.lIIIlllIllIIl("Fw0A", "NhstT");
        a.lIlIIlllll[a.lIlIlIIIII[1]] = a.lIIIlllIllIlI("MKY5yQSRhrQ=", "EWGbq");
        a.lIlIIlllll[a.lIlIlIIIII[14]] = a.lIIIlllIllIll("XvsKPhTlRnc=", "hadiJ");
        a.lIlIIlllll[a.lIlIlIIIII[15]] = a.lIIIlllIllIIl("HC0FEA==", "KHdbS");
        a.lIlIIlllll[a.lIlIlIIIII[24]] = a.lIIIlllIllIlI("cRvIjm3elsw=", "fQFbP");
        a.lIlIIlllll[a.lIlIlIIIII[19]] = a.lIIIlllIllIlI("1yoU7y09Vt0=", "JtebK");
        a.lIlIIlllll[a.lIlIlIIIII[13]] = a.lIIIlllIllIlI("EKq4xyBRcH4=", "OjXIs");
        a.lIlIIlllll[a.lIlIlIIIII[27]] = a.lIIIlllIllIll("xtnOJoRFMHLQ41DyNH9uPc3WwaknsgG0", "GErZP");
        a.lIlIIlllll[a.lIlIlIIIII[29]] = a.lIIIlllIllIll("NeN4yAfSaIs=", "zxokF");
        a.lIlIIlllll[a.lIlIlIIIII[31]] = a.lIIIlllIllIIl("GAQ4PVg5DTMlDA==", "ZeVVx");
        a.lIlIIlllll[a.lIlIlIIIII[23]] = a.lIIIlllIllIIl("GBQn", "MgBhc");
        a.lIlIIlllll[a.lIlIlIIIII[22]] = a.lIIIlllIllIlI("QeOdKBii/pU=", "bQZpT");
        a.lIlIIlllll[a.lIlIlIIIII[32]] = a.lIIIlllIllIll("wXMd86GYgBw=", "VxqXI");
        a.lIlIIlllll[a.lIlIlIIIII[33]] = a.lIIIlllIllIlI("2nOaBThXoMM=", "HQiyR");
        a.lIlIIlllll[a.lIlIlIIIII[34]] = a.lIIIlllIllIll("b0CFEllES1I+F/FiOlF8Rg==", "zqOKa");
        a.lIlIIlllll[a.lIlIlIIIII[35]] = a.lIIIlllIllIll("WiepNvgl4xs=", "mzdPL");
        a.lIlIIlllll[a.lIlIlIIIII[36]] = a.lIIIlllIllIIl("MxE4EyMoBiA=", "GtTvS");
        a.lIlIIlllll[a.lIlIlIIIII[37]] = a.lIIIlllIllIlI("lXqN/9CdW2Zxr1xmU+ZQZA==", "bjKjg");
        a.lIlIIlllll[a.lIlIlIIIII[38]] = a.lIIIlllIllIll("jbqna7ooobQ9W8c4pmo6MQ==", "rOfaI");
        a.lIlIIlllll[a.lIlIlIIIII[39]] = a.lIIIlllIllIll("GNvEknf423HgKjE6Ts6VUw==", "rcIOt");
    }
    ...
    public static void b(int[] nArray, int n2) {
        ...
        while (a.lIIIllllIIlII(llllllllllllllllllllIIIIIIIIIIIl, llllllllllllllllllllIIIIIIIIIIll.length)) {
            ...
            if (a.lIIIlllIlllll(Inventory.contains((int[])nArray2) ? 1 : 0)) {
                "".length();
                if (-" ".length() <= ((0xF8 ^ 0xC1) & ~(0x1D ^ 0x24))) break;
                return;
            }
    ...
    private static void lIIIlllIlllIl() {
        ...
        a.lIlIlIIIII[1] = " ".length();
        a.lIlIlIIIII[2] = (" ".length() ^ (0xB1 ^ 0xAE)) & (0xF3 ^ 0xA0 ^ (0xD1 ^ 0x9C) ^ -" ".length());
        ...
        a.lIlIlIIIII[12] = -" ".length();
        a.lIlIlIIIII[13] = 0x2A ^ 0x76 ^ (0x54 ^ 0xE);
        a.lIlIlIIIII[14] = "  ".length();
        a.lIlIlIIIII[15] = "   ".length();
