...
implements K {
    ...
    private static void lIIllIIlllIll() {
        ...
        Y.lIllIllIIl[Y.lIllIllIlI[0]] = Y.lIIllIIlllIII("ChAYJgcvRQg7DCUW", "HeaOi");
        Y.lIllIllIIl[Y.lIllIllIlI[1]] = Y.lIIllIIlllIIl("kTih+o78Z7zggTadp5bwrsXc9vyAWTffPxv9cRUgidrKENPVtwLmHg2lGEl3PDjN3YjQEMs7+YU=", "rdsUs");
        Y.lIllIllIIl[Y.lIllIllIlI[3]] = Y.lIIllIIlllIlI("IiNq5Br1pcyy4NLw//r8lDSq0RZ7qMJJ", "xKXhD");
        Y.lIllIllIIl[Y.lIllIllIlI[4]] = Y.lIIllIIlllIlI("IIZRXz3AI7ZA0HOmhqg/wg==", "hLyoi");
        Y.lIllIllIIl[Y.lIllIllIlI[6]] = Y.lIIllIIlllIlI("KyeY8qp+6RLusNXRN9dcQ8kiyApLi/Zu", "fUIuF");
        Y.lIllIllIIl[Y.lIllIllIlI[12]] = Y.lIIllIIlllIII("HDJ0JCMudzksIjg+OiJxOz43LjAzMidpcTggPTEyIz46InE/OHQHBBIeGgI=", "KWTEQ");
        Y.lIllIllIIl[Y.lIllIllIlI[13]] = Y.lIIllIIlllIII("CSU8HjYkOTROKiIwIA==", "MWSnF");
        Y.lIllIllIIl[Y.lIllIllIlI[14]] = Y.lIIllIIlllIII("Bjk9JzwrJTV3IC0sIQ==", "BKRWL");
        Y.lIllIllIIl[Y.lIllIllIlI[16]] = Y.lIIllIIlllIIl("yZaFUvNEgG6nn+YXr4zfxkbR8Jz9IL6F", "EMfoa");
        Y.lIllIllIIl[Y.lIllIllIlI[17]] = Y.lIIllIIlllIII("MjoJODwYPAE=", "qRfHL");
        Y.lIllIllIIl[Y.lIllIllIlI[18]] = Y.lIIllIIlllIlI("KAEqJsVTzdjBZYtZZD4kog==", "lqOCC");
        Y.lIllIllIIl[Y.lIllIllIlI[19]] = Y.lIIllIIlllIIl("QK1a2rsonl1bvPJ6RBTI0Q==", "sxfcb");
        Y.lIllIllIIl[Y.lIllIllIlI[20]] = Y.lIIllIIlllIII("ExgmEycqHmoMIWQWKxNuMAsvHT0=", "DyJxN");
        Y.lIllIllIIl[Y.lIllIllIlI[21]] = Y.lIIllIIlllIIl("xenTL+cF64rZrzbYUfr8Xg==", "eJpBQ");
        Y.lIllIllIIl[Y.lIllIllIlI[22]] = Y.lIIllIIlllIlI("yfq+RkNtlxWLQa+n6uxlcrqcfuU8DQk/", "DCxrm");
        Y.lIllIllIIl[Y.lIllIllIlI[15]] = Y.lIIllIIlllIII("LQYDBWwKARsb", "nnluL");
        Y.lIllIllIIl[Y.lIllIllIlI[34]] = Y.lIIllIIlllIIl("+prbG8RmdoMFcdrqHy8PoA==", "mjdum");
        Y.lIllIllIIl[Y.lIllIllIlI[36]] = Y.lIIllIIlllIII("ARgaBHUcF1QUMBIdAAt1Ww==", "sqtcU");
    }
                ...
                if (Y.lIIllIIllllIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (Y.lIIllIlIIIIII(Inventory.getCount((int[])nArray))) {
                            ...
                            "".length();
                            if (" ".length() < 0) {
                                return ((0x52 ^ 9 ^ (0x68 ^ 0xF)) & (19 + 38 - -36 + 51 ^ 91 + 132 - 137 + 86 ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIllIllIlI[0];
                        }
                ...
                if (Y.lIIllIIllllIl(Bank.contains((int[])nArray8) ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (Y.lIIllIlIIIIII(Inventory.getCount((int[])nArray))) {
                            ...
                            "".length();
                            if (" ".length() <= -" ".length()) {
                                return ((0xA ^ 0x39 ^ (0x54 ^ 0x5C)) & (170 + 151 - 318 + 171 ^ 125 + 73 - 101 + 52 ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIllIllIlI[0];
                        }
    ...
    public static boolean al() {
        ...
        if (Y.lIIllIlIIIIlI(Skills.getLevel((Skill)Skill.WOODCUTTING), lIllIllIlI[23])) {
            ...
            if (Y.lIIllIlIIIIII(Inventory.getCount((int[])nArray))) {
                ...
                return ((0xC6 ^ 0xBD ^ (6 ^ 0x2E)) & (82 + 5 - 26 + 185 ^ 15 + 51 - -2 + 97 ^ -" ".length())) != 0;
            }
            bl = lIllIllIlI[0];
            return bl;
        }
                ...
                if (Y.lIIllIlIIIIII(Inventory.getCount((int[])nArray9))) {
                    ...
                    if (Y.lIIllIlIIIIII(Inventory.getCount((int[])nArray10))) {
                        ...
                        if (Y.lIIllIlIIIIII(Inventory.getCount((int[])nArray11))) {
                            ...
                            return ((59 + 18 - -27 + 36 ^ 115 + 27 - 49 + 57) & (0x3F ^ 0x52 ^ (0x7E ^ 9) ^ -" ".length())) != 0;
                        }
                    }
                }
            }
    ...
    private static String lIIllIIlllIII(String lllllllllllllllllllIIIIlllIllIIl, String lllllllllllllllllllIIIIlllIlllIl) {
        ...
        while (Y.lIIllIIlllllI(lllllllllllllllllllIIIIlllIlIIlI, lllllllllllllllllllIIIIlllIlIIll)) {
            ...
            "".length();
            if (((0x46 ^ 0x48) & ~(0x44 ^ 0x4A)) <= " ".length()) continue;
            return null;
        }
    ...
    private static void lIIllIIllllII() {
        ...
        Y.lIllIllIlI[1] = " ".length();
        Y.lIllIllIlI[2] = 0xFFFFFBF3 & 0x7EF;
        Y.lIllIllIlI[3] = "  ".length();
        Y.lIllIllIlI[4] = "   ".length();
