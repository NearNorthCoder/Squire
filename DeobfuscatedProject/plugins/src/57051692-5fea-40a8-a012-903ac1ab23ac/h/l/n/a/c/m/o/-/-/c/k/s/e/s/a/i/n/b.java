...
public class b {
    ...
    private static void lIIIlIlIllIIl() {
        ...
        b.lIlIIIlllI[b.lIlIIlIIII[0]] = b.lIIIlIlIlIlIl("N8yQgy1EM98=", "KzhrD");
        b.lIlIIIlllI[b.lIlIIlIIII[1]] = b.lIIIlIlIlIlIl("UU3h6eycEzq59wt++DzwdA==", "gUmtC");
        b.lIlIIIlllI[b.lIlIIlIIII[8]] = b.lIIIlIlIlIllI("cq9eSzNY4vs3IPAquxXK6q60HZpEWMHr6rwTxguxnDIqVUKs7OmJCtiz6V4BqlnugDL6B+yQdy4=", "PAzZE");
        b.lIlIIIlllI[b.lIlIIlIIII[4]] = b.lIIIlIlIlIlll("AAYCJBs9E0M5HScbDCdaZ1s=", "SrcIr");
        b.lIlIIIlllI[b.lIlIIlIIII[7]] = b.lIIIlIlIlIlll("FjYOKiMrI083JTErAClqbXZG", "EBoGJ");
        b.lIlIIIlllI[b.lIlIIlIIII[25]] = b.lIIIlIlIlIlll("FyojOygX", "cKAWM");
        b.lIlIIIlllI[b.lIlIIlIIII[26]] = b.lIIIlIlIlIllI("KsYEO9bbUcigylPcXIMH4g==", "QCXOL");
        b.lIlIIIlllI[b.lIlIIlIIII[13]] = b.lIIIlIlIlIlIl("bUrPDKEH424=", "GgLzE");
        b.lIlIIIlllI[b.lIlIIlIIII[28]] = b.lIIIlIlIlIlIl("GcZNw6u1+os=", "bARoe");
        b.lIlIIIlllI[b.lIlIIlIIII[29]] = b.lIIIlIlIlIlIl("Ag3cpVoZFLg=", "xwjgz");
        b.lIlIIIlllI[b.lIlIIlIIII[3]] = b.lIIIlIlIlIlIl("Ml1eWMfJhK8=", "yMZmA");
        b.lIlIIIlllI[b.lIlIIlIIII[27]] = b.lIIIlIlIlIlll("AwIKA3IeDUQTNxAHEAxyWQ==", "qkddR");
    }
    ...
    public static boolean a(String string) {
        ...
        if (b.lIIIlIlIlllIl(list.isEmpty() ? 1 : 0)) {
            void llllllllllllllllllllIIlllIlIIlII;
            String llllllllllllllllllllIIlllIlIIIll;
            Object var2_2 = null;
            if (b.lIIIlIlIllllI(string.contains(lIlIIIlllI[lIlIIlIIII[25]]) ? 1 : 0)) {
                llllllllllllllllllllIIlllIlIIIll = string.replace(lIlIIIlllI[lIlIIlIIII[26]], lIlIIIlllI[lIlIIlIIII[13]]).trim();
            }
            int llllllllllllllllllllIIlllIlIIIlI = lIlIIlIIII[0];
            while (b.lIIIlIlIlllll(llllllllllllllllllllIIlllIlIIIlI, llllllllllllllllllllIIlllIlIIlII.size())) {
                String llllllllllllllllllllIIlllIlIIIIl = ((Item)llllllllllllllllllllIIlllIlIIlII.get(llllllllllllllllllllIIlllIlIIIlI)).getName();
                if (b.lIIIlIllIIllI(llllllllllllllllllllIIlllIlIIIIl)) {
                    String llllllllllllllllllllIIlllIlIIlIl;
                    if (b.lIIIlIlIllllI(llllllllllllllllllllIIlllIlIIIIl.contains(llllllllllllllllllllIIlllIlIIlIl) ? 1 : 0)) {
                        return lIlIIlIIII[1];
                    }
                    if (b.lIIIlIllIIllI(llllllllllllllllllllIIlllIlIIIll) && b.lIIIlIlIllllI(llllllllllllllllllllIIlllIlIIIIl.contains(llllllllllllllllllllIIlllIlIIIll) ? 1 : 0)) {
                        return lIlIIlIIII[1];
                    }
                }
                ++llllllllllllllllllllIIlllIlIIIlI;
                "".length();
                if ("   ".length() == "   ".length()) continue;
                return ((0x63 ^ 0x29) & ~(0xC8 ^ 0x82)) != 0;
            }
        }
        return lIlIIlIIII[0];
    }
    ...
    public static void a(int n2) {
        int llllllllllllllllllllIIlllIIllIll;
        int n3;
        int llllllllllllllllllllIIlllIIlllII;
        if (b.lIIIlIlIlllIl(GrandExchange.isBuying() ? 1 : 0)) {
            GrandExchange.createBuyOffer();
        }
        if (b.lIIIlIlIllllI(Static.getClient().isItemDefinitionCached(llllllllllllllllllllIIlllIIlllII) ? 1 : 0)) {
            n3 = Static.getClient().getItemComposition(llllllllllllllllllllIIlllIIlllII).getLinkedNoteId();
            "".length();
            if ("  ".length() != "  ".length()) {
                return;
            }
        } else {
            n3 = llllllllllllllllllllIIlllIIllIll = ((Integer)GameThread.invokeLater(() -> Static.getClient().getItemComposition(llllllllllllllllllllIIlllIIlllII).getLinkedNoteId())).intValue();
        }
        if (!b.lIIIlIllIIIll(GrandExchange.getItemId(), lIlIIlIIII[24]) || b.lIIIlIllIIIll(GrandExchange.getItemId(), llllllllllllllllllllIIlllIIlllII) && b.lIIIlIllIIIll(GrandExchange.getItemId(), llllllllllllllllllllIIlllIIllIll)) {
            if (b.lIIIlIlIlllIl(GrandExchange.isSearchingItem() ? 1 : 0)) {
                GrandExchange.openItemSearch();
            }
            GrandExchange.setItem((int)llllllllllllllllllllIIlllIIlllII);
        }
    }
    ...
    private static String lIIIlIlIlIlll(String llllllllllllllllllllIIllIlllIlIl, String llllllllllllllllllllIIllIlllIlII) {
        llllllllllllllllllllIIllIlllIlIl = new String(Base64.getDecoder().decode(llllllllllllllllllllIIllIlllIlIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllllIIllIlllIIll = new StringBuilder();
        char[] llllllllllllllllllllIIllIlllIIlI = llllllllllllllllllllIIllIlllIlII.toCharArray();
        int llllllllllllllllllllIIllIlllIIIl = lIlIIlIIII[0];
        char[] llllllllllllllllllllIIllIllIlIll = llllllllllllllllllllIIllIlllIlIl.toCharArray();
        int llllllllllllllllllllIIllIllIlIlI = llllllllllllllllllllIIllIllIlIll.length;
        int llllllllllllllllllllIIllIllIlIIl = lIlIIlIIII[0];
        while (b.lIIIlIlIlllll(llllllllllllllllllllIIllIllIlIIl, llllllllllllllllllllIIllIllIlIlI)) {
            char llllllllllllllllllllIIllIlllIllI = llllllllllllllllllllIIllIllIlIll[llllllllllllllllllllIIllIllIlIIl];
            llllllllllllllllllllIIllIlllIIll.append((char)(llllllllllllllllllllIIllIlllIllI ^ llllllllllllllllllllIIllIlllIIlI[llllllllllllllllllllIIllIlllIIIl % llllllllllllllllllllIIllIlllIIlI.length]));
            "".length();
            ++llllllllllllllllllllIIllIlllIIIl;
            ++llllllllllllllllllllIIllIllIlIIl;
            "".length();
            if ("   ".length() != ((97 + 48 - 22 + 39 ^ 120 + 122 - 169 + 114) & ((0xB4 ^ 0xBF) & ~(0x7F ^ 0x74) ^ (0xB8 ^ 0xA1) ^ -" ".length()))) continue;
            return null;
        }
        return String.valueOf(llllllllllllllllllllIIllIlllIIll);
    }

    private static void lIIIlIlIlllII() {
        lIlIIlIIII = new int[33];
        b.lIlIIlIIII[0] = (0x73 ^ 0x2C) & ~(0x6B ^ 0x34);
        b.lIlIIlIIII[1] = " ".length();
        b.lIlIIlIIII[2] = 0xFFFFDFEB & 0x23F7;
        b.lIlIIlIIII[3] = 0x1A ^ 0x10;
        b.lIlIIlIIII[4] = "   ".length();
        b.lIlIIlIIII[5] = -(0xFFFFFE3C & 0x4DCB) & (0xFFFFDFBF & 0x7FCF);
        b.lIlIIlIIII[6] = 0xFFFFBF77 & 0x5FCF;
        b.lIlIIlIIII[7] = 0x7B ^ 0x7F;
        b.lIlIIlIIII[8] = "  ".length();
    ...
    private static String lIIIlIlIlIllI(String llllllllllllllllllllIIllIlIllllI, String llllllllllllllllllllIIllIlIlllIl) {
        try {
            SecretKeySpec llllllllllllllllllllIIllIllIIIll = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllllIIllIlIlllIl.getBytes(StandardCharsets.UTF_8)), lIlIIlIIII[28]), "DES");
            Cipher llllllllllllllllllllIIllIllIIIlI = Cipher.getInstance("DES");
            llllllllllllllllllllIIllIllIIIlI.init(lIlIIlIIII[8], llllllllllllllllllllIIllIllIIIll);
            return new String(llllllllllllllllllllIIllIllIIIlI.doFinal(Base64.getDecoder().decode(llllllllllllllllllllIIllIlIllllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIIIlIlIlIlIl(String llllllllllllllllllllIIlllIIIIlIl, String llllllllllllllllllllIIlllIIIIIlI) {
        try {
            SecretKeySpec llllllllllllllllllllIIlllIIIlIII = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllllIIlllIIIIIlI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
    ...
    public static void b(List<Integer> list) {
        ...
        if (b.lIIIlIlIllllI(GrandExchange.isOpen() ? 1 : 0)) {
            List<Integer> llllllllllllllllllllIIlllIlIllIl;
            Time.sleepTicks((int)lIlIIlIIII[8]);
            "".length();
            int llllllllllllllllllllIIlllIlIllII = lIlIIlIIII[0];
            while (b.lIIIlIlIlllll(llllllllllllllllllllIIlllIlIllII, llllllllllllllllllllIIlllIlIllIl.size())) {
                int[] nArray = new int[lIlIIlIIII[1]];
                nArray[b.lIlIIlIIII[0]] = llllllllllllllllllllIIlllIlIllIl.get(llllllllllllllllllllIIlllIlIllII);
                if (b.lIIIlIllIIlII(Inventory.getCount((int[])nArray))) {
                    int llllllllllllllllllllIIlllIlIlIll;
                    if (b.lIIIlIlIlllIl(GrandExchange.isSelling() ? 1 : 0)) {
                        int[] nArray2 = new int[lIlIIlIIII[1]];
                        nArray2[b.lIlIIlIIII[0]] = llllllllllllllllllllIIlllIlIllIl.get(llllllllllllllllllllIIlllIlIllII);
                        GrandExchange.sell((int[])nArray2);
                        Time.sleepTicks((int)lIlIIlIIII[8]);
                        "".length();
                        llllllllllllllllllllIIlllIlIlIll = llllllllllllllllllllIIlllIlIllII;
                        Time.sleepUntil(() -> {
                            boolean bl;
                            if (b.lIIIlIllIIlIl(GrandExchange.getItemId(), (Integer)llllllllllllllllllllIIlllIlIllIl.get(llllllllllllllllllllIIlllIlIlIll))) {
                                bl = lIlIIlIIII[1];
                                "".length();
                                if ("   ".length() < "   ".length()) {
                                    return ((0x69 ^ 0x59 ^ (0x68 ^ 0x6D)) & (0x73 ^ 7 ^ (0x54 ^ 0x15) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlIIlIIII[0];
                            }
                        ...
                        if (b.lIIIlIllIIIll(GrandExchange.getPrice(), lIlIIlIIII[24])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (b.lIIIlIllIIlIl(GrandExchange.getPrice(), lIlIIlIIII[1])) {
                                    bl = lIlIIlIIII[1];
                                    "".length();
                                    if (((0x78 ^ 0x4B ^ (0x1A ^ 0x72)) & (0xFA ^ 0x8F ^ (0x22 ^ 0xC) ^ -" ".length())) != ((" ".length() ^ (0xB7 ^ 0x98)) & (71 + 30 - 10 + 50 ^ 68 + 151 - 207 + 151 ^ -" ".length()))) {
                                        return ((88 + 122 - 118 + 109 ^ 142 + 151 - 165 + 30) & (0x4A ^ 0x54 ^ (0x4F ^ 6) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlIIlIIII[0];
                                }
                    ...
                    if (b.lIIIlIlIllllI(GrandExchange.canCollect() ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (b.lIIIlIlIlllIl(GrandExchange.canCollect() ? 1 : 0)) {
                                ...
                                "".length();
                                if (-" ".length() >= 0) {
                                    return ((0xE2 ^ 0x96 ^ (0xC0 ^ 0xA2)) & (0xA7 ^ 0x87 ^ (0xA4 ^ 0x92) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlIIlIIII[0];
                            }
                ...
                ++llllllllllllllllllllIIlllIlIllII;
                "".length();
    ...
    public static void a(List<d> list) {
        block65: {
            List<d> llllllllllllllllllllIIlllIlllIlI;
            ...
            if (b.lIIIlIlIlllIl(list.isEmpty() ? 1 : 0) && b.lIIIlIlIllllI(J.isEmpty() ? 1 : 0)) {
                ...
                while (b.lIIIlIlIlllll(llllllllllllllllllllIIlllIlllIIl2, llllllllllllllllllllIIlllIlllIlI.size())) {
                    J.add(llllllllllllllllllllIIlllIlllIlI.get(llllllllllllllllllllIIlllIlllIIl2).p());
                    "".length();
                    K.add(llllllllllllllllllllIIlllIlllIlI.get(llllllllllllllllllllIIlllIlllIIl2).q());
                    "".length();
                    L.add(llllllllllllllllllllIIlllIlllIlI.get(llllllllllllllllllllIIlllIlllIIl2).r());
                    "".length();
                    ...
                    if (b.lIIIlIlIllllI(Bank.contains(llllllllllllllllllllIIlllIlllIIl2) ? 1 : 0) && b.lIIIlIlIlllIl(Inventory.contains(item -> item.getName().contains(lIlIIIlllI[lIlIIlIIII[3]])) ? 1 : 0) && b.lIIIlIllIIIIl(Players.getLocal().getWorldLocation().distanceTo(I), lIlIIlIIII[3])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (b.lIIIlIllIIlII(Inventory.getCount((Predicate)llllllllllllllllllllIIlllIlllIIl2))) {
                                bl = lIlIIlIIII[1];
                                "".length();
                                if ((2 + 82 - 56 + 128 ^ 122 + 13 - -6 + 11) == "   ".length()) {
                                    return ((0x3E ^ 0x2F ^ (0xA4 ^ 0xAC)) & (42 + 110 - -11 + 23 ^ 101 + 40 - 97 + 119 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlIIlIIII[0];
                            }
            ...
            while (b.lIIIlIlIlllll(llllllllllllllllllllIIlllIlllIIl2, J.size())) {
                String llllllllllllllllllllIIlllIlllIII = c.c(J.get(llllllllllllllllllllIIlllIlllIIl2));
                System.out.println("Buying " + llllllllllllllllllllIIlllIlllIII + " and itemID is: " + String.valueOf(J.get(llllllllllllllllllllIIlllIlllIIl2)));
                while (b.lIIIlIlIlllIl(b.a(llllllllllllllllllllIIlllIlllIII) ? 1 : 0)) {
                    block69: {
                        block70: {
                            block68: {
                                block67: {
                                    block66: {
                                        if (b.lIIIlIlIlllIl(GrandExchange.canCollect() ? 1 : 0)) {
                                            int llllllllllllllllllllIIlllIllIllI;
                                            int n2;
                                            int llllllllllllllllllllIIlllIllIlll = llllllllllllllllllllIIlllIlllIIl2;
                                            if (b.lIIIlIllIIlII(GrandExchange.getOffers().stream().filter(grandExchangeOffer -> {
                                                boolean bl;
                                                if (b.lIIIlIllIIlIl(grandExchangeOffer.getItemId(), J.get(llllllllllllllllllllIIlllIllIlll))) {
                                                    bl = lIlIIlIIII[1];
                                                    "".length();
                                                    if ("  ".length() < 0) {
                                                        return ((0x42 ^ 0xB) & ~(0x76 ^ 0x3F)) != 0;
                                                    }
                                                } else {
                                                    bl = lIlIIlIIII[0];
                                                }
                                            ...
                                            if (b.lIIIlIlIllllI(llllllllllllllllllllIIlllIllIllI = n2) && b.lIIIlIllIIIIl(GrandExchange.getOffers().stream().filter(grandExchangeOffer -> {
                                                boolean bl;
                                                if (b.lIIIlIllIIlIl(grandExchangeOffer.getItemId(), J.get(llllllllllllllllllllIIlllIllIlll))) {
                                                    bl = lIlIIlIIII[1];
                                                    "".length();
                                            ...
                                            if (b.lIIIlIlIlllIl(llllllllllllllllllllIIlllIllIllI)) {
                                                ...
                                                int llllllllllllllllllllIIlllIllIlIl = L.get(llllllllllllllllllllIIlllIlllIIl2);
                                                int llllllllllllllllllllIIlllIllIlII = lIlIIlIIII[0];
                                                Widget llllllllllllllllllllIIlllIllIIll = Widgets.get((int)lIlIIlIIII[10], (int)lIlIIlIIII[11]);
                                                if (b.lIIIlIlIllllI(GrandExchange.isOpen() ? 1 : 0) && b.lIIIlIlIllllI(GrandExchange.isBuying() ? 1 : 0) && b.lIIIlIllIIllI(llllllllllllllllllllIIlllIllIIll) && b.lIIIlIlIlllIl(llllllllllllllllllllIIlllIllIIll.getText().isEmpty() ? 1 : 0)) {
                                                    int llllllllllllllllllllIIlllIllIIlI;
                                                    llllllllllllllllllllIIlllIllIlII = llllllllllllllllllllIIlllIllIIlI = GrandExchange.getGuidePrice();
                                                    System.out.println("Guide price: " + llllllllllllllllllllIIlllIllIIlI + "|Given price: " + String.valueOf(L.get(llllllllllllllllllllIIlllIlllIIl2)));
                                                }
                                                if (b.lIIIlIllIIIII(llllllllllllllllllllIIlllIllIlII, llllllllllllllllllllIIlllIllIlIl)) {
                                                    double llllllllllllllllllllIIlllIllIIlI;
                                                    if (b.lIIIlIllIIIIl(llllllllllllllllllllIIlllIllIlII, lIlIIlIIII[12])) {
                                                        llllllllllllllllllllIIlllIllIIlI = 0.1;
                                                        "".length();
                                                        if ((0x85 ^ 0x80) <= 0) {
                                                            return;
                                                        }
                                                    } else {
                                                        llllllllllllllllllllIIlllIllIIlI = 0.3;
                                                    }
                                                    int llllllllllllllllllllIIlllIllIIIl = (int)((double)llllllllllllllllllllIIlllIllIlII + (double)llllllllllllllllllllIIlllIllIlII * llllllllllllllllllllIIlllIllIIlI);
                                                    System.out.println("Increased price: " + llllllllllllllllllllIIlllIllIIIl);
                                                    if (b.lIIIlIllIIlIl(GrandExchange.getItemId(), J.get(llllllllllllllllllllIIlllIlllIIl2)) && b.lIIIlIllIIIll(GrandExchange.getPrice(), llllllllllllllllllllIIlllIllIIIl)) {
                                                        GrandExchange.setPrice((int)llllllllllllllllllllIIlllIllIIIl);
                                                    }
                                                    if (b.lIIIlIllIIlIl(GrandExchange.getItemId(), J.get(llllllllllllllllllllIIlllIlllIIl2)) && b.lIIIlIllIIlIl(GrandExchange.getPrice(), llllllllllllllllllllIIlllIllIIIl)) {
                                                        GrandExchange.confirm();
                                                    }
                                                    "".length();
                                                    if (((0x1F ^ 0x36 ^ (0xC5 ^ 0xAB)) & (74 + 196 - 259 + 193 ^ 128 + 48 - 121 + 84 ^ -" ".length())) != 0) {
                                                        return;
                                                    }
                                                } else {
                                            ...
                                            Time.sleepUntil(() -> {
                                                ...
                                                if (b.lIIIlIlIlllIl(GrandExchange.canCollect() ? 1 : 0)) {
                                                    ...
                                                    if (("   ".length() & ("   ".length() ^ -" ".length())) != 0) {
                                                        return ((10 + 61 - -129 + 54 ^ 109 + 43 - 70 + 76) & (0x4C ^ 0x5E ^ (0x41 ^ 0x33) ^ -" ".length())) != 0;
                                                    }
                                                } else {
                                                    bl = lIlIIlIIII[0];
                                                }
                                ...
                                "".length();
                                llllllllllllllllllllIIlllIlllIlI.remove(lIlIIlIIII[0]);
                                "".length();
                                Time.sleepTicks((int)lIlIIlIIII[8]);
                                "".length();
                                "".length();
                            ...
                            if (b.lIIIlIllIIlIl(J.get(llllllllllllllllllllIIlllIlllIIl2), lIlIIlIIII[16])) {
                                ...
                                if (b.lIIIlIlIllllI(Inventory.contains((int[])nArray8) ? 1 : 0)) {
                                    ...
                                    "".length();
                                    "".length();
                                    if ("   ".length() >= ((0x6A ^ 0x2C) & ~(0x30 ^ 0x76))) continue;
                                    return;
                                }
                            }
                            if (b.lIIIlIllIIlIl(J.get(llllllllllllllllllllIIlllIlllIIl2), lIlIIlIIII[17])) {
                                ...
                                if (b.lIIIlIlIllllI(Inventory.contains((int[])nArray9) ? 1 : 0)) {
                                    ...
                                    "".length();
                                    "".length();
                                    if (((139 + 214 - 202 + 87 ^ 12 + 43 - 24 + 132) & (0xED ^ 0x88 ^ (0x8F ^ 0xA7) ^ -" ".length())) <= 0) continue;
                                    return;
                                }
                            }
                    ...
                    if (!b.lIIIlIlIlllIl(b.a(llllllllllllllllllllIIlllIlllIII) ? 1 : 0)) break;
                ...
                System.out.println(llllllllllllllllllllIIlllIlllIlI.get(llllllllllllllllllllIIlllIlllIIl2).p());
                ...
                if (b.lIIIlIlIllllI(b.a(llllllllllllllllllllIIlllIlllIII) ? 1 : 0)) {
                    J.remove(lIlIIlIIII[0]);
                    "".length();
                    K.remove(lIlIIlIIII[0]);
                    "".length();
                ...
                ++llllllllllllllllllllIIlllIlllIIl2;
                "".length();
                if ((0x49 ^ 0xF ^ (0x6B ^ 0x29)) > "   ".length()) continue;
                return;
            }
        }
    }
