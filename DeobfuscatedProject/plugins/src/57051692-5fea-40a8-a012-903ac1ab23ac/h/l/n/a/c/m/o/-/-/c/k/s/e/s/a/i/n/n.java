...
implements K {
    ...
    private static void lIIlIlIIIIlll() {
        ...
        n.lIlIlllIll[1] = " ".length();
        n.lIlIlllIll[2] = "  ".length();
        n.lIlIlllIll[3] = "   ".length();
    ...
    private static void lIIlIlIIIIllI() {
        ...
        n.lIlIlllIlI[n.lIlIlllIll[0]] = n.lIIlIIlllIlIl("BB4dOCshSw0lICsY", "FkdQE");
        n.lIlIlllIlI[n.lIlIlllIll[1]] = n.lIIlIIlllIlIl("AD4bBQcuMhFMFjMuHAITZj4BCRk1e1UfAy8jFgQdKDBVDhUlPFUYG2Y6FAsdJXcBHhUvORwCEw==", "FWult");
        n.lIlIlllIlI[n.lIlIlllIll[2]] = n.lIIlIIlllIllI("5ZtqkdBf2IlE3lnIXPN0C7eVxmjlpmoJ", "iYSRi");
        n.lIlIlllIlI[n.lIlIlllIll[3]] = n.lIIlIIlllIlll("XH71gVrlrSninL2kNODjGs0OFQznzDpX", "mSLvp");
        n.lIlIlllIlI[n.lIlIlllIll[6]] = n.lIIlIIlllIlll("kSO7A73IA2ESinqB7sWN4ZFNHpJEXAANAufK3q9da+XUiWDKCj9Au+eOlWnd1Inm", "lKTJO");
        n.lIlIlllIlI[n.lIlIlllIll[5]] = n.lIIlIIlllIllI("bleb7wxx5G4=", "itFuX");
        n.lIlIlllIlI[n.lIlIlllIll[30]] = n.lIIlIIlllIlIl("GDszIQk=", "ORVMm");
        n.lIlIlllIlI[n.lIlIlllIll[32]] = n.lIIlIIlllIlll("VMuTur5+w7I=", "NTNMe");
        n.lIlIlllIlI[n.lIlIlllIll[33]] = n.lIIlIIlllIllI("N58VdFTwhpM=", "OuguX");
        n.lIlIlllIlI[n.lIlIlllIll[34]] = n.lIIlIIlllIlIl("ITE3Mw==", "vTVAM");
        n.lIlIlllIlI[n.lIlIlllIll[24]] = n.lIIlIIlllIllI("r8GncUJTi1o=", "IfJyp");
        n.lIlIlllIlI[n.lIlIlllIll[36]] = n.lIIlIIlllIlIl("GTE3NQo=", "NXRYn");
        n.lIlIlllIlI[n.lIlIlllIll[37]] = n.lIIlIIlllIllI("ED6vDlRQKLU=", "GVNZG");
        n.lIlIlllIlI[n.lIlIlllIll[39]] = n.lIIlIIlllIlll("s9ZbvX9YeBRFJ7rPz6JMmA==", "cbvim");
        n.lIlIlllIlI[n.lIlIlllIll[40]] = n.lIIlIIlllIlIl("HTAlMD40J2QmOTUs", "QUDDV");
        n.lIlIlllIlI[n.lIlIlllIll[41]] = n.lIIlIIlllIllI("xOWNyqY+I9I=", "uVbhT");
        n.lIlIlllIlI[n.lIlIlllIll[42]] = n.lIIlIIlllIllI("5huSMKqA4PKSMmK2sEbw4Q==", "pwJPG");
        n.lIlIlllIlI[n.lIlIlllIll[43]] = n.lIIlIIlllIlIl("AjIiEh4rJWMFHi8nMA==", "NWCfv");
        n.lIlIlllIlI[n.lIlIlllIll[44]] = n.lIIlIIlllIlll("tx1cWXfOp2E=", "gXRnJ");
        n.lIlIlllIlI[n.lIlIlllIll[45]] = n.lIIlIIlllIllI("CgUrmAjHWOJkGnUxEhCk+w==", "ybEWH");
        n.lIlIlllIlI[n.lIlIlllIll[31]] = n.lIIlIIlllIllI("3OFOgoNHaGdwVzDbmMCKYw==", "nrEIv");
        n.lIlIlllIlI[n.lIlIlllIll[46]] = n.lIIlIIlllIlll("O3mZj381RDI=", "OiVpw");
        n.lIlIlllIlI[n.lIlIlllIll[47]] = n.lIIlIIlllIlll("UKfqIihhEcQ=", "qsIqX");
        n.lIlIlllIlI[n.lIlIlllIll[49]] = n.lIIlIIlllIlll("nzU5X2L5kTM=", "flenj");
        n.lIlIlllIlI[n.lIlIlllIll[50]] = n.lIIlIIlllIlIl("ECwXNQ==", "GIvGB");
        n.lIlIlllIlI[n.lIlIlllIll[51]] = n.lIIlIIlllIlIl("IywFFg==", "tIddN");
        n.lIlIlllIlI[n.lIlIlllIll[52]] = n.lIIlIIlllIllI("on1fcYNit4U=", "nNzee");
        n.lIlIlllIlI[n.lIlIlllIll[53]] = n.lIIlIIlllIlIl("DDYxMQ==", "OYXWL");
        n.lIlIlllIlI[n.lIlIlllIll[54]] = n.lIIlIIlllIlIl("ACMdNA==", "CLtRd");
        n.lIlIlllIlI[n.lIlIlllIll[55]] = n.lIIlIIlllIllI("FmoUJR7yWbiG9Dj9Yifiiw==", "edHLn");
        n.lIlIlllIlI[n.lIlIlllIll[27]] = n.lIIlIIlllIllI("AXAE7bJ+46j4Mk3MpdQwlQ==", "zXhsy");
        n.lIlIlllIlI[n.lIlIlllIll[56]] = n.lIIlIIlllIlll("QzDw4zW9xC8=", "fPjcI");
        n.lIlIlllIlI[n.lIlIlllIll[57]] = n.lIIlIIlllIllI("Mq9eHaXH7aDfyJGwjL/JAA==", "XykIm");
        n.lIlIlllIlI[n.lIlIlllIll[58]] = n.lIIlIIlllIlIl("GiMuOwczNG8tADI/", "VFOOo");
        n.lIlIlllIlI[n.lIlIlllIll[59]] = n.lIIlIIlllIlll("4p/8lUpQhXQ=", "iPbMr");
        n.lIlIlllIlI[n.lIlIlllIll[60]] = n.lIIlIIlllIlIl("DiECEg==", "MNkti");
        n.lIlIlllIlI[n.lIlIlllIll[61]] = n.lIIlIIlllIllI("tqcwUdNWSPUbfFGblL0kMg==", "DuaQQ");
        n.lIlIlllIlI[n.lIlIlllIll[62]] = n.lIIlIIlllIllI("2eIbZYmhoaR3MtqPb8Br+Q==", "YULko");
        n.lIlIlllIlI[n.lIlIlllIll[63]] = n.lIIlIIlllIllI("Lyew82FBtws=", "MwZXT");
        n.lIlIlllIlI[n.lIlIlllIll[64]] = n.lIIlIIlllIlll("DTQyxg3Fj6GYmzyJ22yJjQ==", "EjBVF");
        n.lIlIlllIlI[n.lIlIlllIll[38]] = n.lIIlIIlllIllI("cS2/wATbz3nSrW63CvlerQ==", "lnGhE");
        n.lIlIlllIlI[n.lIlIlllIll[65]] = n.lIIlIIlllIlIl("ACIMIC4pNU02KSg+", "LGmTF");
        n.lIlIlllIlI[n.lIlIlllIll[66]] = n.lIIlIIlllIlIl("DSsWPS0kPFcrKiU3", "ANwIE");
        n.lIlIlllIlI[n.lIlIlllIll[67]] = n.lIIlIIlllIlIl("Kzk9Ng==", "hVTPB");
        n.lIlIlllIlI[n.lIlIlllIll[68]] = n.lIIlIIlllIlIl("JhcoMQ==", "exAWI");
        n.lIlIlllIlI[n.lIlIlllIll[69]] = n.lIIlIIlllIlIl("Dgw6ASo5QzURKi4GOwY/", "McWcK");
        n.lIlIlllIlI[n.lIlIlllIll[70]] = n.lIIlIIlllIllI("AAWePT7U+U4tbVon6xrzZw==", "uBObt");
        n.lIlIlllIlI[n.lIlIlllIll[71]] = n.lIIlIIlllIlIl("OSozKy0QNw==", "uEQXY");
        n.lIlIlllIlI[n.lIlIlllIll[72]] = n.lIIlIIlllIlIl("Lg4VAhkHGVQVGQMbBw==", "bktvq");
        n.lIlIlllIlI[n.lIlIlllIll[73]] = n.lIIlIIlllIllI("BUujNxA/MjMBsW1h2BmYkg==", "oFirh");
        n.lIlIlllIlI[n.lIlIlllIll[7]] = n.lIIlIIlllIlIl("JyYIBTEOMUkTNg86", "kCiqY");
        n.lIlIlllIlI[n.lIlIlllIll[74]] = n.lIIlIIlllIlIl("BQ8yJgksGHMwDi0T", "IjSRa");
        n.lIlIlllIlI[n.lIlIlllIll[75]] = n.lIIlIIlllIllI("9LBX+nmSSkI=", "YzUbt");
        n.lIlIlllIlI[n.lIlIlllIll[76]] = n.lIIlIIlllIlIl("BQQmCg==", "FkOlC");
        n.lIlIlllIlI[n.lIlIlllIll[77]] = n.lIIlIIlllIllI("5m7D0ZNov2vgGJfBuCdLcg==", "DMeWC");
        n.lIlIlllIlI[n.lIlIlllIll[78]] = n.lIIlIIlllIlll("RiUljcwyJ8e2G5Puas9anA==", "VAUZS");
        n.lIlIlllIlI[n.lIlIlllIll[79]] = n.lIIlIIlllIlll("GNDFe3N5neY=", "LPmtI");
        n.lIlIlllIlI[n.lIlIlllIll[93]] = n.lIIlIIlllIlll("W5lWwmDnkr/YFd1Z5EsNHg==", "XwEvs");
        n.lIlIlllIlI[n.lIlIlllIll[94]] = n.lIIlIIlllIllI("mbnnsqECuUJNMZrXFIendO5QT6jwi0JC", "cnSan");
        n.lIlIlllIlI[n.lIlIlllIll[95]] = n.lIIlIIlllIlll("zsCg4UfolA8=", "QdIHY");
    }
    ...
    private static boolean al() {
        ...
        block40: {
                                                ...
                                                block32: {
                                                    ...
                                                    block34: {
                                                                                                            ...
                                                                                                            block16: {
                                                                                                                ...
                                                                                                                block18: {
                                                                                                                    ...
                                                                                                                    if (n.lIIlIlIIIlIII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                                                                                                                        n5 = lIlIlllIll[1];
                                                                                                                        "".length();
                                                                                                                        if ("   ".length() >= ((0xC ^ 0x34) & ~(5 ^ 0x3D))) return n5 != 0;
                                                                                                                        return ((2 ^ 0x12) & ~(0x29 ^ 0x39)) != 0;
                                                                                                                    }
                                                                                                                }
                                                                                                                n5 = lIlIlllIll[0];
                                                                                                                return n5 != 0;
                                                        ...
                                                        if (n.lIIlIlIIIlIII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                                                            n3 = lIlIlllIll[1];
                                                            "".length();
                                                            if (" ".length() != ((0x6C ^ 0xA ^ (0x79 ^ 0xA)) & (107 + 111 - 85 + 32 ^ 172 + 165 - 221 + 60 ^ -" ".length()))) return n3 != 0;
                                                            return ((0x4D ^ 0x71 ^ (0x38 ^ 0x18)) & (184 + 98 - 89 + 24 ^ 43 + 93 - 87 + 148 ^ -" ".length())) != 0;
                                                        }
                                                    }
                                                    n3 = lIlIlllIll[0];
                                                    return n3 != 0;
            ...
            if (n.lIIlIlIIIlIII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                ...
                return ((75 + 131 - 105 + 99 ^ 126 + 84 - 125 + 55) & (124 + 106 - 104 + 78 ^ 135 + 47 - 59 + 13 ^ -" ".length())) != 0;
            }
        }
        n2 = lIlIlllIll[0];
        return n2 != 0;
    ...
    private static void O() {
        block30: {
            d lllllllllllllllllllIIlllllIllIIl;
            block29: {
                block28: {
                    block27: {
                        Object lllllllllllllllllllIIlllllIllIlI;
                        block25: {
                            block26: {
                                ...
                                if (n.lIIlIlIIIlIlI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                                    lllllllllllllllllllIIlllllIllIlI = new d(lIlIlllIll[13], lIlIlllIll[1], lIlIlllIll[80]);
                                    bp.add((d)lllllllllllllllllllIIlllllIllIlI);
                                    "".length();
                                }
                                int[] nArray3 = new int[lIlIlllIll[1]];
                                nArray3[n.lIlIlllIll[0]] = lIlIlllIll[14];
                                if (n.lIIlIlIIIlIlI(Bank.contains((int[])nArray3) ? 1 : 0)) {
                                    lllllllllllllllllllIIlllllIllIlI = new d(lIlIlllIll[14], lIlIlllIll[1], lIlIlllIll[80]);
                                    bp.add((d)lllllllllllllllllllIIlllllIllIlI);
                                    "".length();
                                }
                                int[] nArray4 = new int[lIlIlllIll[1]];
                            ...
                            lllllllllllllllllllIIlllllIllIlI = new d(lIlIlllIll[15], lIlIlllIll[82], lIlIlllIll[34]);
                            bp.add((d)lllllllllllllllllllIIlllllIllIlI);
                            "".length();
                        }
                        int[] nArray = new int[lIlIlllIll[1]];
                        ...
                        if (n.lIIlIlIIIlIlI(Bank.contains((int[])nArray) ? 1 : 0)) {
                            lllllllllllllllllllIIlllllIllIlI = new d(lIlIlllIll[18], lIlIlllIll[1], lIlIlllIll[83]);
                            bp.add((d)lllllllllllllllllllIIlllllIllIlI);
                            "".length();
                        }
                        int[] nArray6 = new int[lIlIlllIll[1]];
                        ...
                        if (n.lIIlIlIIIlIlI(Bank.contains((int[])nArray6) ? 1 : 0)) {
                            lllllllllllllllllllIIlllllIllIlI = new d(lIlIlllIll[19], lIlIlllIll[1], lIlIlllIll[83]);
                            bp.add((d)lllllllllllllllllllIIlllllIllIlI);
                            "".length();
                        }
                        int[] nArray7 = new int[lIlIlllIll[1]];
                        ...
                        if (n.lIIlIlIIIlIlI(Bank.contains((int[])nArray7) ? 1 : 0)) {
                            lllllllllllllllllllIIlllllIllIlI = new d(lIlIlllIll[17], lIlIlllIll[1], lIlIlllIll[83]);
                            bp.add((d)lllllllllllllllllllIIlllllIllIlI);
                            "".length();
                        }
                        int[] nArray8 = new int[lIlIlllIll[1]];
                        ...
                        if (n.lIIlIlIIIlIlI(Bank.contains((int[])nArray8) ? 1 : 0)) {
                            lllllllllllllllllllIIlllllIllIlI = new d(lIlIlllIll[20], lIlIlllIll[1], lIlIlllIll[84]);
                            bp.add((d)lllllllllllllllllllIIlllllIllIlI);
                            "".length();
                        }
                        if (n.lIIlIlIIIlIIl(Skills.getLevel((Skill)Skill.RANGED), lIlIlllIll[7])) {
                            ...
                            if (n.lIIlIlIIIlIlI(Bank.contains((int[])nArray9) ? 1 : 0)) {
                                lllllllllllllllllllIIlllllIllIlI = new d(lIlIlllIll[16], lIlIlllIll[85], lIlIlllIll[41]);
                                bp.add((d)lllllllllllllllllllIIlllllIllIlI);
                                "".length();
                            }
                        }
                        ...
                        if (n.lIIlIlIIIlIlI(Bank.contains((int[])nArray10) ? 1 : 0)) {
                            lllllllllllllllllllIIlllllIllIlI = new d(lIlIlllIll[9], lIlIlllIll[1], lIlIlllIll[86]);
                            bp.add((d)lllllllllllllllllllIIlllllIllIlI);
                            "".length();
                        }
                        int[] nArray11 = new int[lIlIlllIll[1]];
                        ...
                        if (n.lIIlIlIIIlIlI(Bank.contains((int[])nArray11) ? 1 : 0)) {
                            lllllllllllllllllllIIlllllIllIlI = new d(lIlIlllIll[10], lIlIlllIll[1], lIlIlllIll[86]);
                            bp.add((d)lllllllllllllllllllIIlllllIllIlI);
                            "".length();
                        }
                        if (n.lIIlIlIIIllIl(Skills.getLevel((Skill)Skill.RANGED), lIlIlllIll[7])) {
                            ...
                            if (n.lIIlIlIIIlIlI(Bank.contains((int[])nArray12) ? 1 : 0)) {
                                lllllllllllllllllllIIlllllIllIlI = new d(lIlIlllIll[11], lIlIlllIll[82], lIlIlllIll[60]);
                                bp.add((d)lllllllllllllllllllIIlllllIllIlI);
                                "".length();
                            }
                        }
                        ...
                        if (n.lIIlIlIIIlIlI(Bank.contains((int[])nArray13) ? 1 : 0)) {
                            lllllllllllllllllllIIlllllIllIlI = new d(lIlIlllIll[22], lIlIlllIll[1], j.bZ);
                            bp.add((d)lllllllllllllllllllIIlllllIllIlI);
                            "".length();
                        }
                        int[] nArray14 = new int[lIlIlllIll[1]];
                        ...
                        if (n.lIIlIlIIIlIlI(Bank.contains((int[])nArray14) ? 1 : 0)) {
                            lllllllllllllllllllIIlllllIllIlI = new d(lIlIlllIll[26], lIlIlllIll[87], lIlIlllIll[88]);
                            bp.add((d)lllllllllllllllllllIIlllllIllIlI);
                            "".length();
                        }
                        if (n.lIIlIlIIIlIlI(Bank.contains((Predicate)(lllllllllllllllllllIIlllllIllIlI = item -> item.getName().toLowerCase().contains(lIlIlllIlI[lIlIlllIll[94]]))) ? 1 : 0)) {
                            lllllllllllllllllllIIlllllIllIIl = new d(lIlIlllIll[89], lIlIlllIll[5], lIlIlllIll[90]);
                            bp.add(lllllllllllllllllllIIlllllIllIIl);
                            "".length();
                        }
                    ...
                    lllllllllllllllllllIIlllllIllIIl = new d(lIlIlllIll[91], lIlIlllIll[24], lIlIlllIll[92]);
                    bp.add(lllllllllllllllllllIIlllllIllIIl);
                    "".length();
                }
                int[] nArray = new int[lIlIlllIll[1]];
            ...
            lllllllllllllllllllIIlllllIllIIl = new d(lIlIlllIll[23], lIlIlllIll[24], lIlIlllIll[92]);
            bp.add(lllllllllllllllllllIIlllllIllIIl);
            "".length();
        }
    }

    private static String lIIlIIlllIlll(String lllllllllllllllllllIIllllIlIIllI, String lllllllllllllllllllIIllllIlIIlll) {
        try {
            SecretKeySpec lllllllllllllllllllIIllllIlIlIll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIIllllIlIIlll.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllllllIIllllIlIlIlI = Cipher.getInstance("Blowfish");
            lllllllllllllllllllIIllllIlIlIlI.init(lIlIlllIll[2], lllllllllllllllllllIIllllIlIlIll);
            return new String(lllllllllllllllllllIIllllIlIlIlI.doFinal(Base64.getDecoder().decode(lllllllllllllllllllIIllllIlIIllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
        catch (Exception lllllllllllllllllllIIllllIlIlIIl) {
            lllllllllllllllllllIIllllIlIlIIl.printStackTrace();
            return null;
        }
    }
                                    ...
                                    if (n.lIIlIlIIIlIII(Bank.contains((int[])nArray5) ? 1 : 0)) {
                                        ...
                                        if (n.lIIlIlIIIlIII(Bank.contains((int[])nArray6) ? 1 : 0)) {
                                            ...
                                            if (n.lIIlIlIIIlIII(Bank.contains((int[])nArray7) ? 1 : 0)) {
                                                ...
                                                return ((65 + 114 - 109 + 80 ^ 187 + 148 - 156 + 14) & (0x3E ^ 0x6B ^ "  ".length() ^ -" ".length())) != 0;
                                            }
                                        }
                                    }
                                }
                                ...
                                if (n.lIIlIlIIIlIII(Bank.contains((int[])nArray10) ? 1 : 0)) {
                                    ...
                                    if (n.lIIlIlIIIlIII(Bank.contains((int[])nArray11) ? 1 : 0)) {
                                        ...
                                        if (n.lIIlIlIIIlIII(Bank.contains((int[])nArray12) ? 1 : 0)) {
                                            ...
                                            return ((0xB8 ^ 0x80 ^ (0x3E ^ 0x67)) & (0xB7 ^ 0x8B ^ (0x9C ^ 0xC1) ^ -" ".length())) != 0;
                                        }
                                    }
                                }
                            }
    ...
    private static String lIIlIIlllIlIl(String lllllllllllllllllllIIlllllIIIlIl, String lllllllllllllllllllIIlllllIIIlII) {
        lllllllllllllllllllIIlllllIIIlIl = new String(Base64.getDecoder().decode(lllllllllllllllllllIIlllllIIIlIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllllIIlllllIIlIII = new StringBuilder();
        char[] lllllllllllllllllllIIlllllIIIlll = lllllllllllllllllllIIlllllIIIlII.toCharArray();
        int lllllllllllllllllllIIlllllIIIllI = lIlIlllIll[0];
        char[] lllllllllllllllllllIIlllllIIIIII = lllllllllllllllllllIIlllllIIIlIl.toCharArray();
        int lllllllllllllllllllIIllllIllllll = lllllllllllllllllllIIlllllIIIIII.length;
        int lllllllllllllllllllIIllllIlllllI = lIlIlllIll[0];
        while (n.lIIlIlIIIlIIl(lllllllllllllllllllIIllllIlllllI, lllllllllllllllllllIIllllIllllll)) {
            char lllllllllllllllllllIIlllllIIlIll = lllllllllllllllllllIIlllllIIIIII[lllllllllllllllllllIIllllIlllllI];
            lllllllllllllllllllIIlllllIIlIII.append((char)(lllllllllllllllllllIIlllllIIlIll ^ lllllllllllllllllllIIlllllIIIlll[lllllllllllllllllllIIlllllIIIllI % lllllllllllllllllllIIlllllIIIlll.length]));
            "".length();
            ++lllllllllllllllllllIIlllllIIIllI;
            ++lllllllllllllllllllIIllllIlllllI;
            "".length();
            if (null == null) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllllIIlllllIIlIII);
    }
    ...
    public static void ay() {
        ...
        if (n.lIIlIlIIIlIlI(bn ? 1 : 0)) {
            BankLocation lllllllllllllllllllIIlllllIlllIl;
            if (n.lIIlIlIIIlIlI(n.al() ? 1 : 0)) {
                lllllllllllllllllllIIlllllIlllIl = BankLocation.getNearest();
                if (n.lIIlIlIIIlIll(lllllllllllllllllllIIlllllIlllIl) && n.lIIlIlIIIlIlI(lllllllllllllllllllIIlllllIlllIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderShamans.c = lIlIlllIlI[lIlIlllIll[2]];
                    a.a(lllllllllllllllllllIIlllllIlllIl);
                }
                if (n.lIIlIlIIIlIll(lllllllllllllllllllIIlllllIlllIl) && n.lIIlIlIIIlIII(lllllllllllllllllllIIlllllIlllIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (n.lIIlIlIIIlIII(n.al() ? 1 : 0)) {
                ...
                if (n.lIIlIlIIIllIl(Skills.getLevel((Skill)Skill.RANGED), lIlIlllIll[27])) {
                    lllllllllllllllllllIIlllllIlllIl = TileItems.getNearest(tileItem -> {
                        int n2;
                        if (n.lIIlIlIIIllll(tileItem.getId(), lIlIlllIll[16]) && n.lIIlIlIIIllIl(tileItem.getQuantity(), lIlIlllIll[41])) {
                            n2 = lIlIlllIll[1];
                            "".length();
                            if (" ".length() < ("   ".length() & ("   ".length() ^ -" ".length()))) {
                                return ((0x42 ^ 0x21 ^ (0x3E ^ 0x6D)) & (18 + 48 - 61 + 155 ^ 0 + 117 - 13 + 40 ^ -" ".length())) != 0;
                            }
                        } else {
                            n2 = lIlIlllIll[0];
                        }
                    ...
                    if (n.lIIlIlIIIlIll(lllllllllllllllllllIIlllllIlllIl)) {
                        lllllllllllllllllllIIlllllIlllIl.interact(lIlIlllIlI[lIlIlllIll[5]]);
    ...
    public boolean af() {
        ...
        if (n.lIIlIlIIIllIl(Skills.getLevel((Skill)Skill.RANGED), lIlIlllIll[7])) {
            bl = lIlIlllIll[1];
            "".length();
            if ((127 + 36 - 87 + 111 ^ 170 + 93 - 120 + 48) < "   ".length()) {
                return ((0x48 ^ 0x7A ^ (0x3C ^ 0x53)) & (0x16 ^ 0x67 ^ (0xB7 ^ 0x9B) ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlIlllIll[0];
        }
    ...
    private static String lIIlIIlllIllI(String lllllllllllllllllllIIllllIllIlIl, String lllllllllllllllllllIIllllIllIIlI) {
        try {
            SecretKeySpec lllllllllllllllllllIIllllIlllIII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIIllllIllIIlI.getBytes(StandardCharsets.UTF_8)), lIlIlllIll[33]), "DES");
            Cipher lllllllllllllllllllIIllllIllIlll = Cipher.getInstance("DES");
            lllllllllllllllllllIIllllIllIlll.init(lIlIlllIll[2], lllllllllllllllllllIIllllIlllIII);
            return new String(lllllllllllllllllllIIllllIllIlll.doFinal(Base64.getDecoder().decode(lllllllllllllllllllIIllllIllIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
        catch (Exception lllllllllllllllllllIIllllIllIllI) {
            lllllllllllllllllllIIllllIllIllI.printStackTrace();
            return null;
        }
    }
