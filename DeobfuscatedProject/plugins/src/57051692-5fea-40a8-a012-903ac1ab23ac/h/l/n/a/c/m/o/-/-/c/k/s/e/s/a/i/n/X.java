...
implements K {
    ...
    private static boolean al() {
        ...
        block2: {
            ...
            n2 = lIlIIIlIll[2];
            "".length();
            if (((0x9C ^ 0xA6 ^ (0x30 ^ 0x20)) & (68 + 40 - 3 + 45 ^ 73 + 168 - 214 + 161 ^ -" ".length())) > -" ".length()) return n2 != 0;
            return ((0x51 ^ 0x5F ^ (0x51 ^ 0x17)) & (114 + 27 - 99 + 165 ^ 21 + 86 - 54 + 82 ^ -" ".length())) != 0;
        }
        n2 = lIlIIIlIll[1];
        return n2 != 0;
    }
    ...
    private static void lIIIlIIllIlII() {
        ...
        X.lIlIIIlIII[X.lIlIIIlIll[1]] = X.lIIIlIIlIlllI("Jt+aod2m6567+dnCEO8tfQ==", "ylkRZ");
        X.lIlIIIlIII[X.lIlIIIlIll[2]] = X.lIIIlIIlIllll("BRsXAiorFx1LOzYLEAU+YxsNDjQwXlkYLioGGgMwLRVZCTggGVkfNmMCCwogJgA=", "CrykY");
        X.lIlIIIlIII[X.lIlIIIlIll[3]] = X.lIIIlIIlIlllI("fYBd2Qr9TV7+b1Mfne6zlNKtC+o8zTlL", "QxXrE");
        X.lIlIIIlIII[X.lIlIIIlIll[4]] = X.lIIIlIIllIIII("TeMfkGgUirNy6HVN07VQYudgypZS8Ykx", "YWuNT");
        X.lIlIIIlIII[X.lIlIIIlIll[6]] = X.lIIIlIIllIIII("E8M2BSRMsww82hw7KhoU0NIjM2m86G4+EklisFOXU2wt2zpVRvy3xVuzLHTQb00Zf1zML2IFKrs=", "HwhcA");
        X.lIlIIIlIII[X.lIlIIIlIll[13]] = X.lIIIlIIlIlllI("uy0zI1NoXns=", "MpKAE");
        X.lIlIIIlIII[X.lIlIIIlIll[15]] = X.lIIIlIIlIlllI("A+MLdDTugGTMpv6E/dQAnQ==", "IYsWU");
        X.lIlIIIlIII[X.lIlIIIlIll[17]] = X.lIIIlIIlIllll("JzoP", "uOmdD");
        X.lIlIIIlIII[X.lIlIIIlIll[18]] = X.lIIIlIIlIlllI("MCol8ejhiTHf2SpRP64w9g==", "uZGiN");
        X.lIlIIIlIII[X.lIlIIIlIll[19]] = X.lIIIlIIlIlllI("IAixMQSlJseE47S27tmE4t6zJZPcLQMH1kPOZvsCCuOCGOtUQbGnhw==", "gAKka");
        X.lIlIIIlIII[X.lIlIIIlIll[21]] = X.lIIIlIIllIIII("iAuwx3SvmtwrODn++BXphQ==", "xQlLm");
        X.lIlIIIlIII[X.lIlIIIlIll[41]] = X.lIIIlIIllIIII("TZEWau3dhV0nHMGncTbR4g==", "YRMek");
        X.lIlIIIlIII[X.lIlIIIlIll[44]] = X.lIIIlIIlIllll("OjE1BiZZODgdNAs=", "yYTiU");
        X.lIlIIIlIII[X.lIlIIIlIll[20]] = X.lIIIlIIllIIII("JajX2kpawdKEESo9vhRGiQ==", "SqNIO");
        X.lIlIIIlIII[X.lIlIIIlIll[46]] = X.lIIIlIIlIllll("AwIDJQ==", "LrfKr");
        X.lIlIIIlIII[X.lIlIIIlIll[47]] = X.lIIIlIIlIlllI("otyIANnBtqs=", "ShtbQ");
        X.lIlIIIlIII[X.lIlIIIlIll[48]] = X.lIIIlIIlIllll("KhImDw==", "ebCaX");
        X.lIlIIIlIII[X.lIlIIIlIll[49]] = X.lIIIlIIlIllll("GhkwHBV5ED0HBys=", "YqQsf");
        X.lIlIIIlIII[X.lIlIIIlIll[51]] = X.lIIIlIIlIlllI("3fH1Ut1JgjnA+fzFaL1Y0A==", "wvtbq");
        X.lIlIIIlIII[X.lIlIIIlIll[52]] = X.lIIIlIIlIlllI("uf+EiEHNzDIWBpXuWGbXXw==", "daxTX");
        X.lIlIIIlIII[X.lIlIIIlIll[14]] = X.lIIIlIIlIlllI("CSuxo45Jnl46Yclh6Ckyb7V0Nl7VsFBi", "WZixo");
        X.lIlIIIlIII[X.lIlIIIlIll[53]] = X.lIIIlIIlIlllI("ydpfLpmLEvalwxnne8rqFg==", "QbJvX");
        X.lIlIIIlIII[X.lIlIIIlIll[54]] = X.lIIIlIIlIllll("JAUnKA==", "kuBFT");
        X.lIlIIIlIII[X.lIlIIIlIll[55]] = X.lIIIlIIllIIII("cm+feTyfMLE=", "QrnCp");
        X.lIlIIIlIII[X.lIlIIIlIll[56]] = X.lIIIlIIlIlllI("Dap+a+PPRkg=", "HMvEv");
        X.lIlIIIlIII[X.lIlIIIlIll[57]] = X.lIIIlIIlIllll("NS4SHTEeMRQ=", "pVquP");
        X.lIlIIIlIII[X.lIlIIIlIll[58]] = X.lIIIlIIllIIII("PNreP0sQOAWoNZMquI6r1A==", "qehkb");
        X.lIlIIIlIII[X.lIlIIIlIll[59]] = X.lIIIlIIllIIII("Ae7PIIXkdoTKJoVMzOoOKQ==", "uwhzQ");
        X.lIlIIIlIII[X.lIlIIIlIll[60]] = X.lIIIlIIlIlllI("SKnO8qHqUJaBCJmPCq6wuw==", "aFSrn");
        X.lIlIIIlIII[X.lIlIIIlIll[61]] = X.lIIIlIIlIlllI("CwTOmrBXIc8AIda24g5T7w==", "olKab");
        X.lIlIIIlIII[X.lIlIIIlIll[62]] = X.lIIIlIIllIIII("QWoY7Q8J+GY=", "kLAXE");
        X.lIlIIIlIII[X.lIlIIIlIll[75]] = X.lIIIlIIlIllll("NT05ND0Xbyw/OQwhMSM/", "eOXMX");
        X.lIlIIIlIII[X.lIlIIIlIll[77]] = X.lIIIlIIllIIII("xo2ybnbeLBLzCBcmd+zFMpY4xZhFu5Hx", "legnN");
    }
    ...
    private static void lIIIlIIllllIl() {
        ...
        X.lIlIIIlIll[1] = " ".length() & ~" ".length();
        X.lIlIIIlIll[2] = " ".length();
        X.lIlIIIlIll[3] = "  ".length();
        X.lIlIIIlIll[4] = "   ".length();
        ...
        X.lIlIIIlIll[61] = " ".length() ^ (0xA0 ^ 0xBC);
                                        ...
                                        if (X.lIIIlIlIIIIII(llllllllllllllllllllIlIIlIllIlIl.hasAction(stringArray8) ? 1 : 0)) {
                                            ...
                                            if (X.lIIIlIIlllllI(Dialog.isOpen() ? 1 : 0) && X.lIIIlIlIIIIII((llllllllllllllllllllIlIIlIllIlII = Dialog.getOptions()).isEmpty() ? 1 : 0)) {
                                                ...
                                                while (X.lIIIlIIllllll(llllllllllllllllllllIlIIlIllIIll, llllllllllllllllllllIlIIlIllIlII.size())) {
                                                    ...
                                                    "".length();
                                                    if ((0xBF ^ 0xA7 ^ (0x20 ^ 0x3C)) > "  ".length()) continue;
                                                    return;
                                                }
                                            }
                                        }
    ...
    public int ad() {
        ...
        if ("   ".length() <= 0) {
            return (0x77 ^ 0xF ^ (0xAA ^ 0x8D)) & (0xE0 ^ 0x8A ^ (0x39 ^ 0xC) ^ -" ".length());
        }
    ...
    private static String lIIIlIIlIllll(String llllllllllllllllllllIlIIIlllllll, String llllllllllllllllllllIlIIlIIIIIll) {
        ...
        while (X.lIIIlIIllllll(llllllllllllllllllllIlIIIllllIII, llllllllllllllllllllIlIIIllllIIl)) {
            ...
            "".length();
            if (((0xD4 ^ 0x9F ^ (0x4A ^ 0x4D)) & (0xA8 ^ 0xB6 ^ (0xE2 ^ 0xB0) ^ -" ".length())) >= ((0xD8 ^ 0xA0 ^ (0x3A ^ 0x49)) & (0xEE ^ 0xC6 ^ (0x81 ^ 0xA2) ^ -" ".length()) & ((229 + 20 - 38 + 19 ^ 111 + 141 - 241 + 151) & (24 + 133 - 141 + 197 ^ 35 + 136 - 124 + 98 ^ -" ".length()) ^ -" ".length()))) continue;
            return null;
        }
