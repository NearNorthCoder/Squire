...
implements K {
    ...
    private static void O() {
        d llllllllllllllllllllIIIIllIlllll;
        Object llllllllllllllllllllIIIIlllIIIII;
        if (m.lIIIllIlllIlI(Skills.getLevel((Skill)Skill.MAGIC), lIlIIllIll[6])) {
            ...
            if (m.lIIIllIlllIll(Bank.contains((int[])nArray2) ? 1 : 0)) {
                llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[7], lIlIIllIll[59], lIlIIllIll[24]);
                bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                "".length();
            }
            int[] nArray3 = new int[lIlIIllIll[1]];
            nArray3[m.lIlIIllIll[0]] = lIlIIllIll[9];
            if (m.lIIIllIlllIll(Bank.contains((int[])nArray3) ? 1 : 0)) {
                llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[9], lIlIIllIll[60], lIlIIllIll[24]);
                bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                "".length();
            }
            ...
            if (m.lIIIllIlllIll(Bank.contains((int[])nArray4) ? 1 : 0)) {
                llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[11], lIlIIllIll[61], lIlIIllIll[24]);
                bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                "".length();
            }
            ...
            if (m.lIIIllIlllIll(Bank.contains((int[])nArray5) ? 1 : 0)) {
                llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[12], lIlIIllIll[4], lIlIIllIll[24]);
                bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                "".length();
            }
            ...
            if (m.lIIIllIlllIll(Bank.contains((int[])nArray6) ? 1 : 0)) {
                llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[44], lIlIIllIll[1], e.c(lIlIIllIll[62], lIlIIllIll[63]));
                bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                "".length();
            }
        }
        if (m.lIIIllIlllllI(Skills.getLevel((Skill)Skill.MAGIC), lIlIIllIll[6])) {
            ...
            if (m.lIIIllIlllIIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (m.lIIIllIlllIlI(Bank.getFirst((int[])nArray7).getQuantity(), lIlIIllIll[61])) {
                    ...
                    llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[22], lIlIIllIll[61] - Bank.getFirst((int[])nArray8).getQuantity(), lIlIIllIll[64]);
                    bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                    "".length();
                }
            }
            ...
            if (m.lIIIllIlllIll(Bank.contains((int[])nArray9) ? 1 : 0)) {
                llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[22], lIlIIllIll[61], lIlIIllIll[64]);
                bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                "".length();
            }
            ...
            if (m.lIIIllIlllIIl(Bank.contains((int[])nArray10) ? 1 : 0)) {
                ...
                if (m.lIIIllIlllIlI(Bank.getFirst((int[])nArray11).getQuantity(), lIlIIllIll[61])) {
                    ...
                    llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[23], lIlIIllIll[61] - Bank.getFirst((int[])nArray12).getQuantity(), lIlIIllIll[65]);
                    bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                    "".length();
                }
            }
            ...
            if (m.lIIIllIlllIll(Bank.contains((int[])nArray13) ? 1 : 0)) {
                llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[23], lIlIIllIll[61], lIlIIllIll[65]);
                bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                "".length();
            }
            ...
            if (m.lIIIllIlllIll(Bank.contains((int[])nArray14) ? 1 : 0)) {
                ...
                if (m.lIIIllIlllIll(Equipment.contains((int[])nArray15) ? 1 : 0)) {
                    llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[20], lIlIIllIll[1], lIlIIllIll[66]);
                    bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                    "".length();
                }
            }
            if (m.lIIIllIlllIIl(cc ? 1 : 0)) {
                ...
                if (m.lIIIllIlllIIl(Bank.contains((int[])nArray16) ? 1 : 0)) {
                    ...
                    if (m.lIIIllIlllIlI(Bank.getFirst((int[])nArray17).getQuantity(), lIlIIllIll[61])) {
                        ...
                        llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[14], lIlIIllIll[61] - Bank.getFirst((int[])nArray18).getQuantity(), lIlIIllIll[58]);
                        bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                        "".length();
                    }
                }
                ...
                if (m.lIIIllIlllIll(Bank.contains((int[])nArray19) ? 1 : 0)) {
                    llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[14], lIlIIllIll[61], lIlIIllIll[58]);
                    bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                    "".length();
                }
                ...
                if (m.lIIIllIlllIIl(Bank.contains((int[])nArray20) ? 1 : 0)) {
                    ...
                    if (m.lIIIllIlllIlI(Bank.getFirst((int[])nArray21).getQuantity(), lIlIIllIll[66])) {
                        ...
                        llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[21], lIlIIllIll[66] - Bank.getFirst((int[])nArray22).getQuantity(), lIlIIllIll[24]);
                        bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                        "".length();
                    }
                }
                ...
                if (m.lIIIllIlllIll(Bank.contains((int[])nArray23) ? 1 : 0)) {
                    llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[21], lIlIIllIll[66], lIlIIllIll[24]);
                    bp.add((d)llllllllllllllllllllIIIIlllIIIII);
                    "".length();
                }
            }
        ...
        if (m.lIIIllIlllIll(Bank.contains((int[])nArray) ? 1 : 0)) {
            llllllllllllllllllllIIIIlllIIIII = new d(lIlIIllIll[18], lIlIIllIll[67], lIlIIllIll[37]);
            bp.add((d)llllllllllllllllllllIIIIlllIIIII);
            "".length();
        }
        if (m.lIIIllIlllIll(Bank.contains(llllllllllllllllllllIIIIlllIIIII = item -> item.getName().toLowerCase().contains(lIlIIllIlI[lIlIIllIll[74]])) ? 1 : 0)) {
            llllllllllllllllllllIIIIllIlllll = new d(lIlIIllIll[68], lIlIIllIll[17], lIlIIllIll[69]);
            bp.add(llllllllllllllllllllIIIIllIlllll);
            "".length();
        }
        int[] nArray24 = new int[lIlIIllIll[1]];
        nArray24[m.lIlIIllIll[0]] = lIlIIllIll[70];
        if (m.lIIIllIlllIll(Bank.contains((int[])nArray24) ? 1 : 0)) {
            llllllllllllllllllllIIIIllIlllll = new d(lIlIIllIll[70], lIlIIllIll[32], lIlIIllIll[71]);
            bp.add(llllllllllllllllllllIIIIllIlllll);
            "".length();
        }
        ...
        if (m.lIIIllIlllIll(Bank.contains((int[])nArray25) ? 1 : 0)) {
            llllllllllllllllllllIIIIllIlllll = new d(lIlIIllIll[16], lIlIIllIll[32], lIlIIllIll[71]);
            bp.add(llllllllllllllllllllIIIIllIlllll);
            "".length();
        }
    }
                        ...
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    ...
                                    n4 = lIlIIllIll[1];
                                    "".length();
                                    if (-" ".length() <= (129 + 39 - 121 + 94 ^ 60 + 12 - 17 + 82)) return n4 != 0;
                                    return ((13 + 152 - 124 + 129 ^ 87 + 85 - 102 + 71) & (0x51 ^ 0x59 ^ (0x8E ^ 0xA1) ^ -" ".length())) != 0;
                                }
                                n4 = lIlIIllIll[0];
                                return n4 != 0;
                            }
                    ...
                    if (m.lIIIllIlllllI(Bank.getFirst((int[])nArray17).getQuantity(), lIlIIllIll[17])) {
                        ...
                        if (m.lIIIllIlllIIl(Bank.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (m.lIIIllIlllIIl(Bank.contains((int[])nArray19) ? 1 : 0)) {
                                ...
                                return ((96 + 18 - -18 + 27 ^ 64 + 123 - 73 + 31) & (5 + 83 - 35 + 111 ^ 30 + 101 - 80 + 119 ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
                    ...
                    block27: {
                        ...
                        if (m.lIIIllIlllIIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (m.lIIIllIlllIIl(Inventory.contains((int[])nArray14) ? 1 : 0)) {
                                n3 = lIlIIllIll[1];
                                "".length();
                                if ((0xD4 ^ 0xC4 ^ (0x8A ^ 0x9E)) > "   ".length()) return n3 != 0;
                                return ((105 + 183 - 114 + 39 ^ 78 + 55 - 40 + 45) & (0xE4 ^ 0xA4 ^ (0xB2 ^ 0xAD) ^ -" ".length())) != 0;
                            }
                        }
                    }
                    n3 = lIlIIllIll[0];
                    ...
                    if (m.lIIIllIlllllI(Inventory.getFirst((int[])nArray17).getQuantity(), lIlIIllIll[17])) {
                        ...
                        if (m.lIIIllIlllIIl(Inventory.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (m.lIIIllIlllIIl(Inventory.contains((int[])nArray19) ? 1 : 0)) {
                                n2 = lIlIIllIll[1];
                                "".length();
                                if (((0x47 ^ 0x2E ^ (0xE2 ^ 0x87)) & (0x7F ^ 0x38 ^ (0x51 ^ 0x1A) ^ -" ".length())) != -" ".length()) return n2 != 0;
                                return ((73 + 5 - -31 + 28 ^ 14 + 15 - 23 + 176) & (0x2C ^ 0x43 ^ (0x18 ^ 0x48) ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
    ...
    public static void ai() {
        ...
        if (m.lIIIllIlllIll(bn ? 1 : 0)) {
            BankLocation llllllllllllllllllllIIIIlllIlIIl;
            if (m.lIIIllIlllIll(m.al() ? 1 : 0)) {
                llllllllllllllllllllIIIIlllIlIIl = BankLocation.getNearest();
                if (m.lIIIllIllllII(llllllllllllllllllllIIIIlllIlIIl) && m.lIIIllIlllIll(llllllllllllllllllllIIIIlllIlIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderShamans.c = lIlIIllIlI[lIlIIllIll[2]];
                    a.a(llllllllllllllllllllIIIIlllIlIIl);
                }
                if (m.lIIIllIllllII(llllllllllllllllllllIIIIlllIlIIl) && m.lIIIllIlllIIl(llllllllllllllllllllIIIIlllIlIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (m.lIIIllIlllIIl(Bank.isOpen() ? 1 : 0)) {
                        ...
                        while (m.lIIIllIlllIlI(Skills.getLevel((Skill)Skill.MAGIC), lIlIIllIll[6]) && m.lIIIllIlllIll(y.bv() ? 1 : 0)) {
                            ...
                            "".length();
                            "".length();
                            if (((0x73 ^ 0x6C ^ (0x1E ^ 0x33)) & (0xCE ^ 0x8A ^ (0xE6 ^ 0x90) ^ -" ".length())) == 0) continue;
                            return;
                        }
                                ...
                                if (m.lIIIllIlllIlI(Inventory.getCount((int[])nArray2), lIlIIllIll[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (m.lIIIllIllllIl(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (null != null) {
                                                return ((0xED ^ 0xB9 ^ (0x4B ^ 0xF)) & (0xAC ^ 0xAA ^ (0x73 ^ 0x65) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlIIllIll[0];
                                        }
                                ...
                                if (m.lIIIllIlllIlI(Inventory.getCount((int[])nArray4), lIlIIllIll[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (m.lIIIllIllllIl(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (-" ".length() > 0) {
                                                return ((0x5C ^ 2 ^ (0x12 ^ 0x7D)) & (0x63 ^ 0x6D ^ (0xFE ^ 0xC1) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlIIllIll[0];
                                        }
                                ...
                                if (m.lIIIllIlllIlI(Inventory.getCount((int[])nArray8), lIlIIllIll[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (m.lIIIllIllllIl(Inventory.getCount((int[])nArray))) {
                                            bl = lIlIIllIll[1];
                                            "".length();
                                            if (((0x75 ^ 0x7C ^ (0x35 ^ 0x3B)) & (17 + 3 - 7 + 164 ^ 112 + 176 - 246 + 140 ^ -" ".length())) < -" ".length()) {
                                                return ((0x3E ^ 0x39 ^ (0xB4 ^ 0xA6)) & (0xC5 ^ 0xAD ^ (0x23 ^ 0x5E) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlIIllIll[0];
                                        }
                                ...
                                if (m.lIIIllIlllIlI(Inventory.getCount((int[])nArray10), lIlIIllIll[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (m.lIIIllIllllIl(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (null != null) {
                                                return ((0xC1 ^ 0xA7 ^ (0x5B ^ 0x25)) & (96 + 23 - 100 + 154 ^ 137 + 177 - 157 + 24 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlIIllIll[0];
                                        }
                                ...
                                if (m.lIIIllIlllIlI(Inventory.getCount((int[])nArray14), lIlIIllIll[1]) && m.lIIIllIlllIlI(Skills.getLevel((Skill)Skill.MAGIC), lIlIIllIll[19])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (m.lIIIllIllllIl(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (-" ".length() > -" ".length()) {
                                                return ((0xFE ^ 0xA2 ^ (0x14 ^ 0x55)) & (0x50 ^ 0x1D ^ (0x45 ^ 0x15) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlIIllIll[0];
                                        }
            ...
            if (m.lIIIllIlllIIl(m.al() ? 1 : 0)) {
                ...
                if (m.lIIIllIlllllI(Skills.getLevel((Skill)Skill.MAGIC), lIlIIllIll[6])) {
                    int llllllllllllllllllllIIIIlllIIlll;
                    ...
                    llllllllllllllllllllIIIIlllIlIIl = Inventory.getFirst((int[])nArray17);
                    int[] nArray18 = new int[lIlIIllIll[1]];
                    nArray18[m.lIlIIllIll[0]] = lIlIIllIll[35];
                    Item llllllllllllllllllllIIIIlllIlIII = Inventory.getFirst((int[])nArray18);
                    if (m.lIIIllIlllIll(cc ? 1 : 0)) {
                        ...
                        if (m.lIIIllIlllIIl(Players.getLocal().getWorldLocation().equals((Object)cf) ? 1 : 0) && m.lIIIllIllllII(llllllllllllllllllllIIIIlllIlIIl) && m.lIIIllIllllII(llllllllllllllllllllIIIIlllIlIII)) {
                            llllllllllllllllllllIIIIlllIIlll = Skills.getExperience((Skill)Skill.MAGIC);
                            Magic.cast((Spell)SpellBook.Standard.HIGH_LEVEL_ALCHEMY, (Item)llllllllllllllllllllIIIIlllIlIII);
                            Time.sleepUntil(() -> {
                                boolean bl;
                                if (m.lIIIlllIIIlII(Skills.getExperience((Skill)Skill.MAGIC), llllllllllllllllllllIIIIlllIIlll)) {
                                    bl = lIlIIllIll[1];
                                    "".length();
                                    if (-" ".length() >= 0) {
                                        return ((0xD1 ^ 0xB4 ^ (0x58 ^ 0x75)) & (15 + 119 - -50 + 9 ^ 130 + 123 - 204 + 88 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlIIllIll[0];
                                }
                    ...
                    if (m.lIIIllIlllIIl(cc ? 1 : 0)) {
                        if (m.lIIIllIllllII(llllllllllllllllllllIIIIlllIlIIl) && m.lIIIllIllllII(llllllllllllllllllllIIIIlllIlIII) && m.lIIIllIllllll(Players.getLocal().getAnimation(), lIlIIllIll[27])) {
                            llllllllllllllllllllIIIIlllIIlll = Skills.getExperience((Skill)Skill.MAGIC);
                            Magic.cast((Spell)SpellBook.Standard.HIGH_LEVEL_ALCHEMY, (Item)llllllllllllllllllllIIIIlllIlIII);
                            Time.sleepUntil(() -> {
                                boolean bl;
    ...
    private static String lIIIllIllIlII(String llllllllllllllllllllIIIIllIIllIl, String llllllllllllllllllllIIIIllIIlIlI) {
        try {
            SecretKeySpec llllllllllllllllllllIIIIllIlIIII = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllllIIIIllIIlIlI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllllllIIIIllIIllll = Cipher.getInstance("Blowfish");
            llllllllllllllllllllIIIIllIIllll.init(lIlIIllIll[2], llllllllllllllllllllIIIIllIlIIII);
    ...
    private static void lIIIllIllIlll() {
        ...
        m.lIlIIllIlI[m.lIlIIllIll[0]] = m.lIIIllIllIlII("iV8lgc/ogcQdv5hs2Vxr9w==", "dPedI");
        m.lIlIIllIlI[m.lIlIIllIll[1]] = m.lIIIllIllIlIl("BRsWMzkrFxx6KDYLETQtYxsMPycwXlgpPSoGGzIjLRVYOCsgGVguJWMfGT0jIFIMKCsqHBE0LQ==", "CrxZJ");
        m.lIlIIllIlI[m.lIlIIllIll[2]] = m.lIIIllIllIlII("11Gh7QsfomQYbP12KSfrcIZMApDVdo05", "RVEhN");
        m.lIlIIllIlI[m.lIlIIllIll[3]] = m.lIIIllIllIlII("LGeJ8T6syE/5IWJOYTQZNlkXJ8fzCMUt", "uFGwA");
        m.lIlIIllIlI[m.lIlIIllIll[5]] = m.lIIIllIllIlIl("ACxaJCAyaRcsISQgFCJyJDwKNT4+LAlpciQ+EzExPyAUInIjJloHBw4ANAI=", "WIzER");
        m.lIlIIllIlI[m.lIlIIllIll[17]] = m.lIIIllIllIlII("ogC7biv9YTb95GV/HBK1lA==", "PVfyx");
        m.lIlIIllIlI[m.lIlIIllIll[24]] = m.lIIIllIllIlIl("ETccBhU7KgYAVjMsHxQ=", "PChgv");
        m.lIlIIllIlI[m.lIlIIllIll[26]] = m.lIIIllIllIllI("DwGbI/o2RiW6F8NPwZxn+vfdKpI9HPJA", "JrVWQ");
        m.lIlIIllIlI[m.lIlIIllIll[29]] = m.lIIIllIllIlIl("NS0pIR0YK3o5ARsuI3UAEyA/", "vLZUt");
        m.lIlIIllIlI[m.lIlIIllIll[31]] = m.lIIIllIllIlII("l7l77eM6NqAfhnS1TZU3P1JRJ5pcZ68I", "pvRlL");
        m.lIlIIllIlI[m.lIlIIllIll[32]] = m.lIIIllIllIllI("aZgRttD1vYWHcslgfGH4YKok8M+tDS1z", "OYVCD");
        m.lIlIIllIlI[m.lIlIIllIll[33]] = m.lIIIllIllIllI("IrrK6RaupM4=", "xOqQf");
        m.lIlIIllIlI[m.lIlIIllIll[34]] = m.lIIIllIllIllI("krH6JczFDS4=", "VklvM");
        m.lIlIIllIlI[m.lIlIIllIll[36]] = m.lIIIllIllIlII("+ZG9yBYPTcWbt2a1rv7iS+JOvt/2PJnw", "JGTvy");
        m.lIlIIllIlI[m.lIlIIllIll[40]] = m.lIIIllIllIlIl("Og8FUxYbThAcFQc=", "tnssb");
        m.lIlIIllIlI[m.lIlIIllIll[41]] = m.lIIIllIllIllI("OCPHlB4pLEo=", "WHsmr");
        m.lIlIIllIlI[m.lIlIIllIll[42]] = m.lIIIllIllIllI("ZjDfNH4pNF8=", "DzrBX");
        m.lIlIIllIlI[m.lIlIIllIll[43]] = m.lIIIllIllIlIl("FRck", "vxShB");
        m.lIlIIllIlI[m.lIlIIllIll[45]] = m.lIIIllIllIlIl("MAcuMRMaGjQ3UBIcLSM=", "qsZPp");
        m.lIlIIllIlI[m.lIlIIllIll[46]] = m.lIIIllIllIllI("kdJawDqcOmU=", "QVwOv");
        m.lIlIIllIlI[m.lIlIIllIll[47]] = m.lIIIllIllIllI("ZauBCq0m5/+x1bflklm+Hg==", "RMHvN");
        m.lIlIIllIlI[m.lIlIIllIll[51]] = m.lIIIllIllIllI("OS8QmjVRJsiJY2oHhHaMfjdxvRrYhglh", "CIExI");
        m.lIlIIllIlI[m.lIlIIllIll[52]] = m.lIIIllIllIlII("ZsXxRXPYWBwS3Mg3rEpYag==", "pullf");
        m.lIlIIllIlI[m.lIlIIllIll[54]] = m.lIIIllIllIlIl("EREIAGQVDBQNLyM=", "FxfdD");
        m.lIlIIllIlI[m.lIlIIllIll[55]] = m.lIIIllIllIllI("7aK5lwhLUkPN7vW5u4QHuA==", "BYFSB");
        m.lIlIIllIlI[m.lIlIIllIll[19]] = m.lIIIllIllIlII("1poBi0IbvhIedVAQQKaK6Q==", "PcAxz");
        m.lIlIIllIlI[m.lIlIIllIll[50]] = m.lIIIllIllIlII("ybQUsk70zu842lDp0qzPug==", "nVILZ");
        m.lIlIIllIlI[m.lIlIIllIll[56]] = m.lIIIllIllIlII("E0nph2tfbEkqvr9oxXAx0w==", "PveaI");
        m.lIlIIllIlI[m.lIlIIllIll[72]] = m.lIIIllIllIlII("U4TLWlLTW9X1wcF5/H55zw==", "gwtDk");
        m.lIlIIllIlI[m.lIlIIllIll[74]] = m.lIIIllIllIllI("1GlZr35j6Vk2OFFFMa1asU1ybJOe6Po7", "aeGPi");
        m.lIlIIllIlI[m.lIlIIllIll[75]] = m.lIIIllIllIlIl("Ng4m", "uaQKQ");
    }
    ...
    private static void ak() {
        ...
        if (m.lIIIlllIIIIlI(Players.getLocal().getInteracting())) {
            NPC llllllllllllllllllllIIIIlllIIlII = NPCs.getNearest(nPC -> {
                int n2;
                if (m.lIIIllIlllIIl(nPC.getName().contains(lIlIIllIlI[lIlIIllIll[75]]) ? 1 : 0) && m.lIIIllIlllIll(nPC.isDead() ? 1 : 0)) {
                    n2 = lIlIIllIll[1];
                    "".length();
                    if ("  ".length() <= ((0x39 ^ 0xA ^ (0xAD ^ 0xC1)) & (0x35 ^ 0x1F ^ (0xC6 ^ 0xB3) ^ -" ".length()))) {
                        return ((0x17 ^ 0xF ^ (0xBC ^ 0xA2)) & (0x1E ^ 0x2B ^ (0x9F ^ 0xAC) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIlIIllIll[0];
                }
            ...
            if (m.lIIIllIllllII(llllllllllllllllllllIIIIlllIIlII) && m.lIIIllIlllIll(Players.getLocal().isMoving() ? 1 : 0)) {
                AccBuilderShamans.c = lIlIIllIlI[lIlIIllIll[45]];
                llllllllllllllllllllIIIIlllIIlII.interact(lIlIIllIlI[lIlIIllIll[46]]);
    ...
    private static void lIIIllIlllIII() {
        ...
        m.lIlIIllIll[1] = " ".length();
        m.lIlIIllIll[2] = "  ".length();
        m.lIlIIllIll[3] = "   ".length();
    ...
    private static String lIIIllIllIlIl(String llllllllllllllllllllIIIIlIllIIII, String llllllllllllllllllllIIIIlIlIlIlI) {
        llllllllllllllllllllIIIIlIllIIII = new String(Base64.getDecoder().decode(llllllllllllllllllllIIIIlIllIIII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllllIIIIlIlIlllI = new StringBuilder();
        char[] llllllllllllllllllllIIIIlIlIllIl = llllllllllllllllllllIIIIlIlIlIlI.toCharArray();
        int llllllllllllllllllllIIIIlIlIllII = lIlIIllIll[0];
        char[] llllllllllllllllllllIIIIlIlIIllI = llllllllllllllllllllIIIIlIllIIII.toCharArray();
        int llllllllllllllllllllIIIIlIlIIlIl = llllllllllllllllllllIIIIlIlIIllI.length;
        int llllllllllllllllllllIIIIlIlIIlII = lIlIIllIll[0];
        while (m.lIIIllIlllIlI(llllllllllllllllllllIIIIlIlIIlII, llllllllllllllllllllIIIIlIlIIlIl)) {
            char llllllllllllllllllllIIIIlIllIIIl = llllllllllllllllllllIIIIlIlIIllI[llllllllllllllllllllIIIIlIlIIlII];
            llllllllllllllllllllIIIIlIlIlllI.append((char)(llllllllllllllllllllIIIIlIllIIIl ^ llllllllllllllllllllIIIIlIlIllIl[llllllllllllllllllllIIIIlIlIllII % llllllllllllllllllllIIIIlIlIllIl.length]));
            "".length();
            ++llllllllllllllllllllIIIIlIlIllII;
            ++llllllllllllllllllllIIIIlIlIIlII;
            "".length();
            if (null == null) continue;
            return null;
        }
        return String.valueOf(llllllllllllllllllllIIIIlIlIlllI);
    }
}
