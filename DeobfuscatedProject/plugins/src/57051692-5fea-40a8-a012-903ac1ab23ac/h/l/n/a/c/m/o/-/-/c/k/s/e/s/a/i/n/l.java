...
public class l {
    ...
    private static void lIIllIllIIlII() {
        ...
        l.lIllIlllll[29] = 0x40 ^ 0x4F ^ "  ".length();
            ...
            if (l.lIIllIllIllIl(Players.getLocal().getInteracting()) && l.lIIllIllIlllI(Players.getLocal().getHealthRatio(), lIllIlllll[21])) {
                ...
                lllllllllllllllllllIIIIIlllIIllI = NPCs.getNearest(nPC -> {
                    ...
                    if (l.lIIllIllIIlll(nPC.getName().contains(lIllIllllI[lIllIlllll[28]]) ? 1 : 0) && l.lIIllIllIllll(nPC.getInteracting()) && l.lIIllIllIIllI(nPC.isDead() ? 1 : 0)) {
                        ...
                        "".length();
                        if (-" ".length() >= "   ".length()) {
                            return ((0xEF ^ 0xB2 ^ (0x35 ^ 0x4D)) & (139 + 5 - -12 + 14 ^ 110 + 136 - 238 + 135 ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lIllIlllll[4];
                    }
            ...
            if (l.lIIllIllIllll(Players.getLocal().getInteracting())) {
                lllllllllllllllllllIIIIIlllIIlll = NPCs.getNearest(nPC -> {
                    ...
                    if (l.lIIllIllIIlll(nPC.getName().contains(lIllIllllI[lIllIlllll[27]]) ? 1 : 0) && l.lIIllIllIllll(nPC.getInteracting()) && l.lIIllIllIIllI(nPC.isDead() ? 1 : 0)) {
                        n2 = lIllIlllll[15];
                        "".length();
                        if ((("  ".length() ^ (0x8D ^ 0xA9)) & (11 + 153 - 149 + 155 ^ 32 + 67 - 52 + 93 ^ -" ".length())) >= "   ".length()) {
                            return ((0x37 ^ 0x3A ^ (0x70 ^ 0x5F)) & (0x95 ^ 0xC1 ^ (0xB3 ^ 0xC5) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lIllIlllll[4];
                    }
                ...
                lllllllllllllllllllIIIIIlllIIllI = NPCs.getNearest(nPC -> {
                    ...
                    if (l.lIIllIllIIlll(nPC.getName().contains(lIllIllllI[lIllIlllll[26]]) ? 1 : 0) && l.lIIllIlllIIII(nPC.getInteracting(), Players.getLocal()) && l.lIIllIllIIllI(nPC.isDead() ? 1 : 0)) {
                        ...
                        "".length();
                        if (null != null) {
                            return ((4 ^ 0x66 ^ (0xE ^ 0x79)) & (0xD7 ^ 0x9B ^ (0xE4 ^ 0xBD) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lIllIlllll[4];
                    }
    ...
    private static void lIIllIllIIIll() {
        ...
        l.lIllIllllI[l.lIllIlllll[4]] = l.lIIllIllIIIII("CgUZah8rRAcjByhECCMKKhAc", "DdoJk");
        l.lIllIllllI[l.lIllIlllll[15]] = l.lIIllIllIIIIl("2ZdcVtHHIxLdYfgqegJuNA==", "CUGos");
        l.lIllIllllI[l.lIllIlllll[17]] = l.lIIllIllIIIlI("q05iI4WUfwkGTlBuPvqqhA==", "eitDW");
        l.lIllIllllI[l.lIllIlllll[19]] = l.lIIllIllIIIlI("aWBWjOVeAxQ=", "ALjUs");
        l.lIllIllllI[l.lIllIlllll[20]] = l.lIIllIllIIIIl("FSxS7fXYIP/cyitUu8JqgQ==", "srrPr");
        l.lIllIllllI[l.lIllIlllll[22]] = l.lIIllIllIIIII("LAcXGw0G", "msczn");
        l.lIllIllllI[l.lIllIlllll[16]] = l.lIIllIllIIIII("MAECNTcaHBgzdBkcGjh0FhwXOiA=", "quvTT");
        l.lIllIllllI[l.lIllIlllll[23]] = l.lIIllIllIIIIl("MmuakNs703A=", "JgBfn");
        l.lIllIllllI[l.lIllIlllll[24]] = l.lIIllIllIIIIl("gYEsGdkE692GkUeNnl756R/qS9r5azCT", "fkPDt");
        l.lIllIllllI[l.lIllIlllll[25]] = l.lIIllIllIIIlI("usCdyZKuiLc=", "NuohQ");
        l.lIllIllllI[l.lIllIlllll[26]] = l.lIIllIllIIIIl("mempZqgRcg8=", "HUWPj");
        l.lIllIllllI[l.lIllIlllll[27]] = l.lIIllIllIIIII("Bj02PA==", "NTZPi");
        l.lIllIllllI[l.lIllIlllll[28]] = l.lIIllIllIIIlI("ZrQdrP9y6Ss=", "PqKIl");
        l.lIllIllllI[l.lIllIlllll[29]] = l.lIIllIllIIIlI("iw4niPfB7bY=", "ArLdH");
    }
