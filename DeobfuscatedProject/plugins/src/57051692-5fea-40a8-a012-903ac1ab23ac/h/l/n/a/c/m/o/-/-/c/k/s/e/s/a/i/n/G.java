...
implements K {
    ...
    private static void lIIlIIIlIlllI() {
        ...
        G.lIlIlIllII[0] = (31 + 35 - 61 + 124 ^ 138 + 147 - 256 + 135) & (0x30 ^ 0x5A ^ (0x7E ^ 0x31) ^ -" ".length());
        G.lIlIlIllII[1] = " ".length();
        G.lIlIlIllII[2] = (0x11 ^ 0x34) + (0x3E ^ 0xC) - (0xBF ^ 0xA6) + (0x40 ^ 0x22);
        G.lIlIlIllII[3] = "  ".length();
        G.lIlIlIllII[4] = "   ".length();
        ...
        G.lIlIlIllII[89] = 0xFA ^ 0xC3 ^ "   ".length();
    ...
    private static String lIIlIIIlIlIII(String lllllllllllllllllllIllIlllIlIlII, String lllllllllllllllllllIllIlllIIlllI) {
        lllllllllllllllllllIllIlllIlIlII = new String(Base64.getDecoder().decode(lllllllllllllllllllIllIlllIlIlII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllllIllIlllIlIIlI = new StringBuilder();
        char[] lllllllllllllllllllIllIlllIlIIIl = lllllllllllllllllllIllIlllIIlllI.toCharArray();
        int lllllllllllllllllllIllIlllIlIIII = lIlIlIllII[0];
        char[] lllllllllllllllllllIllIlllIIlIlI = lllllllllllllllllllIllIlllIlIlII.toCharArray();
        int lllllllllllllllllllIllIlllIIlIIl = lllllllllllllllllllIllIlllIIlIlI.length;
        int lllllllllllllllllllIllIlllIIlIII = lIlIlIllII[0];
        while (G.lIIlIIIllIIII(lllllllllllllllllllIllIlllIIlIII, lllllllllllllllllllIllIlllIIlIIl)) {
            char lllllllllllllllllllIllIlllIlIlIl = lllllllllllllllllllIllIlllIIlIlI[lllllllllllllllllllIllIlllIIlIII];
            lllllllllllllllllllIllIlllIlIIlI.append((char)(lllllllllllllllllllIllIlllIlIlIl ^ lllllllllllllllllllIllIlllIlIIIl[lllllllllllllllllllIllIlllIlIIII % lllllllllllllllllllIllIlllIlIIIl.length]));
            "".length();
            ++lllllllllllllllllllIllIlllIlIIII;
            ++lllllllllllllllllllIllIlllIIlIII;
            "".length();
            if (((" ".length() ^ (0x62 ^ 0x7D)) & (0xA9 ^ 0x82 ^ (0x7D ^ 0x48) ^ -" ".length())) == 0) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllllIllIlllIlIIlI);
    }
    ...
    private static void lIIlIIIlIllIl() {
        ...
        G.lIlIlIlIlI[G.lIlIlIllII[0]] = G.lIIlIIIlIIlll("iGotk5SfTyKxC2Jh0m7dag==", "QiSFi");
        G.lIlIlIlIlI[G.lIlIlIllII[1]] = G.lIIlIIIlIlIII("CAUJHiomCQNXOzsVDhk+bgUTEjQ9QEcELicYBB8wIAtHFTgtB0cDNm4dEhIqOgUJEA==", "NlgwY");
        G.lIlIlIlIlI[G.lIlIlIllII[3]] = G.lIIlIIIlIlIII("FA4SCzE7Gw0MMXobC0I0OwEP", "ZodbV");
        G.lIlIlIlIlI[G.lIlIlIllII[4]] = G.lIIlIIIlIlIII("LSM/PSoMNHoxIgw4", "bSZSC");
        G.lIlIlIlIlI[G.lIlIlIllII[6]] = G.lIIlIIIlIlIII("MTsBHRgQNAhZFhg0BBAaHg==", "yZoyt");
        G.lIlIlIlIlI[G.lIlIlIllII[9]] = G.lIIlIIIlIIlll("xxiSy7QX75Zm7PMPMSlcSgkAmFqoYv8R5f4ydN5hcC1ZDncxDOyJEsSQZAkeV/dk", "WFsxe");
        G.lIlIlIlIlI[G.lIlIlIllII[12]] = G.lIIlIIIlIIlll("Ldv8TlbXwehkO5DL2pyPPltS8B3OxpGZVHdkJoU3GtqV8Z/SNJPLH5O2F/VAgoZu", "DWuBA");
        G.lIlIlIlIlI[G.lIlIlIllII[14]] = G.lIIlIIIlIIlll("+2aNtypUcj7vWoTimjax9sbu/TheFKRe/HVy+bS+Cncg3MT/sX9futQO3bvlpz1T", "CdXwE");
        G.lIlIlIlIlI[G.lIlIlIllII[16]] = G.lIIlIIIlIIlll("Kp6NuKSkIYtHHN6MOVWPfNkitPDC7N2gAiDl2eAAy49TsW2DymIkIB0I9VHov9L5", "IfSEY");
        G.lIlIlIlIlI[G.lIlIlIllII[18]] = G.lIIlIIIlIIlll("4oYG8yAjifxEpKHCVO7hG+pXVOnwmQqp5O7VeSsqSI1SEzwgD7wwZq7L/Ck63ZWS", "RGuDX");
        G.lIlIlIlIlI[G.lIlIlIllII[8]] = G.lIIlIIIlIIlll("mGXrRwdNITluLG6q9V6/rGONqW8XVglxWFuXPFKDtFysNzV/P3mXglntWZtwOYm6", "HaiQR");
        G.lIlIlIlIlI[G.lIlIlIllII[19]] = G.lIIlIIIlIIlll("9dxLn3Q3yxWQ9ApLbZEG9PDMxQD/1t4O", "QfxHk");
        G.lIlIlIlIlI[G.lIlIlIllII[32]] = G.lIIlIIIlIlIII("Fyg+CjF6GTYRJjsl", "ZIYcR");
        G.lIlIlIlIlI[G.lIlIlIllII[33]] = G.lIIlIIIlIlIIl("DZ/8ACPONrs=", "ggyrz");
        G.lIlIlIlIlI[G.lIlIlIllII[34]] = G.lIIlIIIlIIlll("TRzN/H2DSObfX+09DQWQiw==", "Hpmct");
        G.lIlIlIlIlI[G.lIlIlIllII[31]] = G.lIIlIIIlIlIII("NhURZgIXVBQyFwoA", "xtgFv");
        G.lIlIlIlIlI[G.lIlIlIllII[35]] = G.lIIlIIIlIIlll("h2zzXoQNbdfAuCgpJ8lQTg==", "FMIrP");
        G.lIlIlIlIlI[G.lIlIlIllII[36]] = G.lIIlIIIlIlIIl("gkxfHFDHYOu60FYJvv8d9z52qya4pJuPCt1DrWuD47E=", "FcpPU");
        G.lIlIlIlIlI[G.lIlIlIllII[38]] = G.lIIlIIIlIIlll("Orqj5m14a7AzX+dryo/nV/W5AT3DQw4P5iPh1Rh/R+Y=", "iHzuJ");
        G.lIlIlIlIlI[G.lIlIlIllII[40]] = G.lIIlIIIlIlIII("MT4KIT0XegwkMhMxTio2ET5OPDxQOBsxcxwzHTw=", "pZnHS");
        G.lIlIlIlIlI[G.lIlIlIllII[30]] = G.lIIlIIIlIIlll("C0I84pvXxsqFH5kIAl9kV/HtiARth4vERPSY4bP3hZ4=", "CEfjc");
        G.lIlIlIlIlI[G.lIlIlIllII[41]] = G.lIIlIIIlIIlll("gAGWxfGIdxufnbIe8LitPdTxpv2UPwDiZ5hgGfZwuvg=", "TYKSG");
        G.lIlIlIlIlI[G.lIlIlIllII[44]] = G.lIIlIIIlIIlll("3PVribca8nmHfokj46nmhlt1p0CzfHKquunmrHBM2jI=", "tdmPA");
        G.lIlIlIlIlI[G.lIlIlIllII[46]] = G.lIIlIIIlIIlll("5J2FaV/6tSI3bexqem8yNF8/2SOCSHIjJ1xZz20BiGE=", "XYmSg");
        G.lIlIlIlIlI[G.lIlIlIllII[48]] = G.lIIlIIIlIIlll("SXM6YvUurL0UQaQS/F1P/PHg8WASNTo9uiSDXnvNNLQ=", "LjqEN");
        G.lIlIlIlIlI[G.lIlIlIllII[49]] = G.lIIlIIIlIlIII("EBEcChw2VQ8GEz0BEEMGPlUaFgtxGREQBg==", "Quxcr");
        G.lIlIlIlIlI[G.lIlIlIllII[52]] = G.lIIlIIIlIlIIl("GG/qZdIhpZ8uaoAIenBKrn9lTLzFTyBQzX0LxA6wHtU=", "vKIpT");
        G.lIlIlIlIlI[G.lIlIlIllII[54]] = G.lIIlIIIlIlIII("KiwVJh4MaBcuHAcxUTsRCTtROx9LKgQ2UAchAjs=", "kHqOp");
        G.lIlIlIlIlI[G.lIlIlIllII[55]] = G.lIIlIIIlIIlll("v3/GMH7U9lEdQs5BSA4spNodPZL6HkUXjl4LT6pfGw4=", "VRiwW");
        G.lIlIlIlIlI[G.lIlIlIllII[56]] = G.lIIlIIIlIlIIl("panSJQnppmi5nynSTBL7IYcaeXObJGIS2e20zig4Oz8=", "RNsuW");
        G.lIlIlIlIlI[G.lIlIlIllII[57]] = G.lIIlIIIlIlIII("Cj4LJyYsegInJi96HTsmLilPOidrOBo3aCczHDo=", "KZoNH");
        G.lIlIlIlIlI[G.lIlIlIllII[60]] = G.lIIlIIIlIlIII("GAUjHQ0+QSYdEXkTMhoGKkEzG0M7FD5UDzASMw==", "YaGtc");
        G.lIlIlIlIlI[G.lIlIlIllII[61]] = G.lIIlIIIlIlIII("GCUMPzo+YR83IDwzSCQhNyQbdiA2YQojLXktASUg", "YAhVT");
        G.lIlIlIlIlI[G.lIlIlIllII[62]] = G.lIIlIIIlIlIIl("ApT6c1toqGve5ZFZAtYUNDn2VTMh9NZJ/Wmc4wAa3f4=", "kQOqs");
        G.lIlIlIlIlI[G.lIlIlIllII[63]] = G.lIIlIIIlIlIII("FgM2ITQwRzMhKHcVJyY/JEcmJ3o1EitoNj4UJg==", "WgRHZ");
        G.lIlIlIlIlI[G.lIlIlIllII[64]] = G.lIIlIIIlIlIII("MTQmMwQXcDU7HhUiYigfHjUxeh4fcCAvE1A8Kyke", "pPBZj");
        G.lIlIlIlIlI[G.lIlIlIllII[65]] = G.lIIlIIIlIlIIl("5j6UqCyONRxpWI094kuFRH69LICQDbPPuu2caUQJ8io=", "idIEh");
        G.lIlIlIlIlI[G.lIlIlIllII[66]] = G.lIIlIIIlIlIIl("A2vCUUT8v22YIe5go4hoGfj9mXQwCVWxx3g9RSjs6H0=", "TIAuc");
        G.lIlIlIlIlI[G.lIlIlIllII[67]] = G.lIIlIIIlIIlll("uS2Try1FqsWU93EerCrvrw==", "svBVh");
        G.lIlIlIlIlI[G.lIlIlIllII[68]] = G.lIIlIIIlIlIII("EzYLKiI9cwUjLC4=", "JSgFM");
        G.lIlIlIlIlI[G.lIlIlIllII[45]] = G.lIIlIIIlIlIII("BiAmEA5kLiISAQ==", "DLGse");
        G.lIlIlIlIlI[G.lIlIlIllII[69]] = G.lIIlIIIlIlIII("NT4fAiRCNBMXJQ==", "bVvvA");
        G.lIlIlIlIlI[G.lIlIlIllII[70]] = G.lIIlIIIlIlIIl("Fbx5tbo02WE=", "SEhqR");
        G.lIlIlIlIlI[G.lIlIlIllII[71]] = G.lIIlIIIlIIlll("FjGEi2z8Rv9mzMR293RO7Q39uQQr42Gd", "uPcjp");
        G.lIlIlIlIlI[G.lIlIlIllII[72]] = G.lIIlIIIlIlIII("GRYHJD84AUIoNzgN", "VfbJV");
        G.lIlIlIlIlI[G.lIlIlIllII[73]] = G.lIIlIIIlIlIII("DDI/NggtPTZyBiU9OjsKIw==", "DSQRd");
        G.lIlIlIlIlI[G.lIlIlIllII[74]] = G.lIIlIIIlIIlll("SdPGXxdB9HvJPx8vDAt/Ag==", "mSTfg");
        G.lIlIlIlIlI[G.lIlIlIllII[75]] = G.lIIlIIIlIIlll("qH1IaI98lUViV46tQNbAuw==", "WVjyx");
        G.lIlIlIlIlI[G.lIlIlIllII[76]] = G.lIIlIIIlIIlll("2C49iKxzan9fo4+c3zksM0+I01rZrFuy4//v9d8fadCz2RwSvIugWwcJLkQgvMgs", "dddyG");
        G.lIlIlIlIlI[G.lIlIlIllII[77]] = G.lIIlIIIlIlIII("KwU6MAxOFj0qAQ==", "ndHDd");
        G.lIlIlIlIlI[G.lIlIlIllII[78]] = G.lIIlIIIlIlIII("MjsKDgdXKA0UCg==", "wZxzo");
        G.lIlIlIlIlI[G.lIlIlIllII[79]] = G.lIIlIIIlIIlll("j3qSW7fYWWbWtmhlcWvABMu9G83ez57CdrXCr19XBaTdCYYGIh42db32AJD8p6SF", "xjjRB");
        G.lIlIlIlIlI[G.lIlIlIllII[80]] = G.lIIlIIIlIlIIl("mV0uhJVuh7luLc8PzyRafQ==", "fmTFl");
        G.lIlIlIlIlI[G.lIlIlIllII[81]] = G.lIIlIIIlIlIIl("5KZFPf1bh/gnluo4Ka73Xg==", "utHle");
        G.lIlIlIlIlI[G.lIlIlIllII[82]] = G.lIIlIIIlIlIII("ISJGND8TZws8PgUuCDJtBTIWJSEfIhV5bQUwDyEuHi4IMm0CKEYXGC8OKBI=", "vGfUM");
        G.lIlIlIlIlI[G.lIlIlIllII[83]] = G.lIIlIIIlIlIII("LSBiNxAfZS8/EQksLDFCCTAyJg4TIDF6QgkyKyIBEiwsMUIOKmIUNyMMDBE=", "zEBVb");
        G.lIlIlIlIlI[G.lIlIlIllII[84]] = G.lIIlIIIlIIlll("Dt/oCJ72/XZRnunl1m0eUU3UM5+flWZq", "MUHqM");
        G.lIlIlIlIlI[G.lIlIlIllII[85]] = G.lIIlIIIlIIlll("nx3loNPXQR6SbYqV24tXHVi8ijvapsJd", "icLpO");
        G.lIlIlIlIlI[G.lIlIlIllII[89]] = G.lIIlIIIlIIlll("DU+dRyltPgM1NA2xJGVZKg==", "gglZN");
        G.lIlIlIlIlI[G.lIlIlIllII[90]] = G.lIIlIIIlIIlll("s6/6xLmlF7kBpjnndMRMuhDbJWWA5AIR", "NysnK");
        G.lIlIlIlIlI[G.lIlIlIllII[91]] = G.lIIlIIIlIIlll("xdTAVg9LZcyN3o+rpoGRdQ==", "PtVTY");
        G.lIlIlIlIlI[G.lIlIlIllII[92]] = G.lIIlIIIlIlIIl("5D5LrpLSxIWfapb/Jx+kV3xWotwS7FWNIigKsY7OPh4M1sQIon0q7cVTLmLXDbZJ", "LpDGu");
        G.lIlIlIlIlI[G.lIlIlIllII[93]] = G.lIIlIIIlIIlll("J1mhL4t2Cr0=", "NTBMl");
        G.lIlIlIlIlI[G.lIlIlIllII[94]] = G.lIIlIIIlIlIII("HRk7JGU5US44J2ocOyQ2LwNl", "JqZPB");
        G.lIlIlIlIlI[G.lIlIlIllII[95]] = G.lIIlIIIlIlIII("HRhgYxN1HyBjKTcWbDQyMwdsCnoxEiJjPj1d", "RsLCZ");
    }
    ...
    private static void ci() {
        void lllllllllllllllllllIllIllllllIll;
        ...
        if (G.lIIlIIIllIIlI(lllllllllllllllllllIllIllllllIll) && G.lIIlIIIlIllll(lllllllllllllllllllIllIllllllIll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (G.lIIlIIIlIllll(Bank.isOpen() ? 1 : 0)) {
                ...
                while (G.lIIlIIIllIIIl(y.bv() ? 1 : 0)) {
                    ...
                    "".length();
                    "".length();
                    if ((0x13 ^ 0x4A ^ (0xED ^ 0xB0)) >= " ".length()) continue;
                    return;
                }
                if (G.lIIlIIIllIIIl(Bank.isOpen() ? 1 : 0)) {
                    a.a();
                    ...
                    if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray3), lIlIlIllII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                bl = lIlIlIllII[1];
                                "".length();
                                if ("  ".length() <= ((0x7E ^ 0x1B ^ (0x76 ^ 0x57)) & (104 + 22 - -3 + 6 ^ 66 + 35 - -63 + 31 ^ -" ".length()))) {
                                    return ((83 + 86 - -50 + 9 ^ 19 + 85 - 8 + 84) & (68 + 131 - 50 + 88 ^ 112 + 151 - 140 + 66 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlIlIllII[0];
                            }
                    ...
                    if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray5), lIlIlIllII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (-"  ".length() >= 0) {
                                    return ((0x6F ^ 0x45 ^ (0x17 ^ 0x7D)) & (0x84 ^ 0xC4 ^ (0x6F ^ 0x43) & ~(0x66 ^ 0x4A) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlIlIllII[0];
                            }
                    ...
                    if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray13), lIlIlIllII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (null != null) {
                                    return ((123 + 177 - 199 + 82 ^ 107 + 117 - 127 + 79) & (42 + 46 - 28 + 119 ^ 152 + 175 - 255 + 108 ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlIlIllII[0];
                            }
                    ...
                    if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray15), lIlIlIllII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (-"   ".length() > 0) {
                                    return ((0x71 ^ 0x47 ^ (0x3E ^ 0x2D)) & (0x4F ^ 0x73 ^ (0x71 ^ 0x68) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlIlIllII[0];
                            }
                    ...
                    if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray17), lIlIlIllII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                bl = lIlIlIllII[1];
                                "".length();
                                if (((0x67 ^ 0x3F) & ~(0x68 ^ 0x30)) == -" ".length()) {
                                    return ((0x10 ^ 0x32) & ~(0xAF ^ 0x8D)) != 0;
                                }
                            } else {
                                bl = lIlIlIllII[0];
                            }
                    ...
                    if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray19), lIlIlIllII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if (" ".length() == 0) {
                                    return ((54 + 121 - 136 + 112 ^ 170 + 85 - 234 + 178) & (8 ^ 0x6A ^ (0x21 ^ 0x13) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlIlIllII[0];
                            }
                    ...
                    if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray23), lIlIlIllII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                bl = lIlIlIllII[1];
                                "".length();
                                if (((28 + 59 - -102 + 41 ^ 37 + 125 - 76 + 106) & (0x92 ^ 0x85 ^ (0x53 ^ 0x62) ^ -" ".length())) < 0) {
                                    return ((0xC9 ^ 0x86 ^ (0xF6 ^ 0xB2)) & (0xDF ^ 0xBA ^ (0xCB ^ 0xA5) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlIlIllII[0];
                            }
    ...
    public static void ch() {
        ...
        if (G.lIIlIIIllIIIl(bn ? 1 : 0)) {
            if (G.lIIlIIIllIIIl(e.j(lIlIlIllII[2]))) {
                BankLocation lllllllllllllllllllIlllIIIIIIIIl;
                if (G.lIIlIIIllIIIl(G.aK() ? 1 : 0)) {
                    lllllllllllllllllllIlllIIIIIIIIl = BankLocation.getNearest();
                    if (G.lIIlIIIllIIlI(lllllllllllllllllllIlllIIIIIIIIl) && G.lIIlIIIllIIIl(lllllllllllllllllllIlllIIIIIIIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderShamans.c = lIlIlIlIlI[lIlIlIllII[3]];
                        a.a(lllllllllllllllllllIlllIIIIIIIIl);
                    }
                    if (G.lIIlIIIllIIlI(lllllllllllllllllllIlllIIIIIIIIl) && G.lIIlIIIlIllll(lllllllllllllllllllIlllIIIIIIIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        if (G.lIIlIIIllIIIl(Bank.isOpen() ? 1 : 0)) {
                        ...
                        if (G.lIIlIIIlIllll(Bank.isOpen() ? 1 : 0)) {
                            ...
                            while (G.lIIlIIIllIIIl(y.bv() ? 1 : 0)) {
                                ...
                                "".length();
                                "".length();
                                if (" ".length() > ((0x1C ^ 0x7C ^ (0xCB ^ 0xA4)) & (8 ^ 0x27 ^ (0x83 ^ 0xA3) ^ -" ".length()))) continue;
                                return;
                            }
                            if (G.lIIlIIIllIIIl(Bank.isOpen() ? 1 : 0)) {
                                a.a();
                                ...
                                if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray15), lIlIlIllII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if (null != null) {
                                                return ((54 + 202 - 126 + 109 ^ 64 + 87 - 48 + 37) & (0xD6 ^ 0x95 ^ (0x1A ^ 0x3A) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlIlIllII[0];
                                        }
                                ...
                                if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray17), lIlIlIllII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                            bl = lIlIlIllII[1];
                                            "".length();
                                            if ((0x4F ^ 0x76 ^ (0x20 ^ 0x1D)) <= "  ".length()) {
                                                return ((130 + 124 - 230 + 144 ^ 80 + 39 - 63 + 86) & (0x27 ^ 0x3D ^ (0xB4 ^ 0x88) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlIlIllII[0];
                                        }
                                ...
                                if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray19), lIlIlIllII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                            bl = lIlIlIllII[1];
                                            "".length();
                                            if (((141 + 94 - 96 + 23 ^ 122 + 67 - 22 + 5) & (0x3F ^ 0x26 ^ (0xD2 ^ 0xC5) ^ -" ".length())) == "   ".length()) {
                                                return ((85 + 118 - 91 + 61 ^ 20 + 46 - -96 + 0) & (0x30 ^ 0x34 ^ (8 ^ 3) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlIlIllII[0];
                                        }
                                ...
                                if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray21), lIlIlIllII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if ("   ".length() != "   ".length()) {
                                                return ((0x66 ^ 0x56 ^ (0x26 ^ 0x49)) & (11 + 105 - 84 + 221 ^ 42 + 14 - -28 + 78 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlIlIllII[0];
                                        }
                                ...
                                if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray29), lIlIlIllII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                            bl = lIlIlIllII[1];
                                            "".length();
                                            if (-" ".length() == ((0xF5 ^ 0xAA) & ~(0x33 ^ 0x6C))) {
                                                return ((0x30 ^ 0x67) & ~(0x33 ^ 0x64)) != 0;
                                            }
                                        } else {
                                            bl = lIlIlIllII[0];
                                        }
                                ...
                                if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray33), lIlIlIllII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                            bl = lIlIlIllII[1];
                                            "".length();
                                            if ((35 + 117 - -5 + 3 ^ 120 + 106 - 83 + 21) < "  ".length()) {
                                                return ((0xDA ^ 0x81 ^ (0x94 ^ 0x9E)) & (0x32 ^ 0x54 ^ (0x77 ^ 0x40) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlIlIllII[0];
                                        }
                ...
                if (G.lIIlIIIllIlII(Players.getLocal().getWorldLocation().distanceTo(iM), lIlIlIllII[6]) && G.lIIlIIIllIlIl(Players.getLocal().getWorldLocation().getPlane(), lIlIlIllII[3]) && G.lIIlIIIlIllll(G.aK() ? 1 : 0)) {
                    ...
                    if (G.lIIlIIIllIIIl(Bank.isOpen() ? 1 : 0)) {
                        ...
                        if (G.lIIlIIIlIllll((lllllllllllllllllllIlllIIIIIIIIl = new WorldArea(lIlIlIllII[28], lIlIlIllII[29], lIlIlIllII[30], lIlIlIllII[31], lIlIlIllII[3])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            String[] stringArray = new String[lIlIlIllII[1]];
    ...
    private static String lIIlIIIlIIlll(String lllllllllllllllllllIllIllllIllll, String lllllllllllllllllllIllIlllllIIII) {
        try {
            SecretKeySpec lllllllllllllllllllIllIlllllIlII = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIllIlllllIIII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllllllIllIlllllIIll = Cipher.getInstance("Blowfish");
            lllllllllllllllllllIllIlllllIIll.init(lIlIlIllII[3], lllllllllllllllllllIllIlllllIlII);
            return new String(lllllllllllllllllllIllIlllllIIll.doFinal(Base64.getDecoder().decode(lllllllllllllllllllIllIllllIllll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
        catch (Exception lllllllllllllllllllIllIlllllIIlI) {
            lllllllllllllllllllIllIlllllIIlI.printStackTrace();
            return null;
        }
    }
    ...
    public int ad() {
        ...
        catch (Exception lllllllllllllllllllIllIllllllIIl) {
            lllllllllllllllllllIllIllllllIIl.printStackTrace();
        }
        if ("   ".length() < 0) {
    ...
    private static String lIIlIIIlIlIIl(String lllllllllllllllllllIllIllllIIIlI, String lllllllllllllllllllIllIllllIIIIl) {
        try {
            SecretKeySpec lllllllllllllllllllIllIllllIIlll = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIllIllllIIIIl.getBytes(StandardCharsets.UTF_8)), lIlIlIllII[16]), "DES");
            Cipher lllllllllllllllllllIllIllllIIllI = Cipher.getInstance("DES");
            lllllllllllllllllllIllIllllIIllI.init(lIlIlIllII[3], lllllllllllllllllllIllIllllIIlll);
            return new String(lllllllllllllllllllIllIllllIIllI.doFinal(Base64.getDecoder().decode(lllllllllllllllllllIllIllllIIIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
                                    ...
                                    if (G.lIIlIIIlIllll(Inventory.contains((int[])nArray4) ? 1 : 0)) {
                                        ...
                                        if (G.lIIlIIIlIllll(Inventory.contains((int[])nArray5) ? 1 : 0)) {
                                            ...
                                            if (G.lIIlIIIlIllll(Inventory.contains((String[])stringArray5) ? 1 : 0)) {
                                                n2 = lIlIlIllII[1];
                                                "".length();
                                                if (((0x57 ^ 0x36 ^ (0x4D ^ 0x36)) & (156 + 74 - 102 + 61 ^ 14 + 40 - -43 + 70 ^ -" ".length())) == 0) return n2 != 0;
                                                return ((0x42 ^ 0x6E ^ (0xBE ^ 0xB3)) & (0x9A ^ 0x87 ^ (0xAA ^ 0x96) ^ -" ".length())) != 0;
                                            }
                                        }
                                    }
                                }
    ...
    private static void O() {
        d lllllllllllllllllllIllIlllllllIl;
        block37: {
            block36: {
                block35: {
                    block34: {
                        Object lllllllllllllllllllIllIllllllllI;
                        block33: {
                            block32: {
                                int[] nArray = new int[lIlIlIllII[1]];
                                nArray[G.lIlIlIllII[0]] = lIlIlIllII[21];
                                ...
                                if (G.lIIlIIIllIIIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
                                    ...
                                    lllllllllllllllllllIllIllllllllI = new d(lIlIlIllII[22], lIlIlIllII[1], lIlIlIllII[39]);
                                    bp.add((d)lllllllllllllllllllIllIllllllllI);
                                    "".length();
                                }
                                int[] nArray3 = new int[lIlIlIllII[1]];
                                ...
                                if (G.lIIlIIIllIIIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
                                    ...
                                    lllllllllllllllllllIllIllllllllI = new d(lIlIlIllII[23], lIlIlIllII[1], lIlIlIllII[39]);
                                    bp.add((d)lllllllllllllllllllIllIllllllllI);
                                    "".length();
                                }
                                int[] nArray4 = new int[lIlIlIllII[1]];
                                ...
                                if (G.lIIlIIIllIIIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
                                    ...
                                    lllllllllllllllllllIllIllllllllI = new d(lIlIlIllII[24], lIlIlIllII[1], lIlIlIllII[39]);
                                    bp.add((d)lllllllllllllllllllIllIllllllllI);
                                    "".length();
                                }
                                int[] nArray5 = new int[lIlIlIllII[1]];
                                ...
                                if (G.lIIlIIIllIIIl(Bank.contains((int[])nArray5) ? 1 : 0)) {
                                    ...
                                    lllllllllllllllllllIllIllllllllI = new d(lIlIlIllII[25], lIlIlIllII[42], lIlIlIllII[43]);
                                    bp.add((d)lllllllllllllllllllIllIllllllllI);
                                    "".length();
                                }
                                int[] nArray6 = new int[lIlIlIllII[1]];
                                ...
                                if (G.lIIlIIIlIllll(Bank.contains((int[])nArray6) ? 1 : 0)) {
                                    ...
                                    if (G.lIIlIIIllIIII(Bank.getFirst((int[])nArray7).getQuantity(), lIlIlIllII[30])) {
                                        ...
                                        lllllllllllllllllllIllIllllllllI = new d(lIlIlIllII[25], lIlIlIllII[45], lIlIlIllII[43]);
                                        bp.add((d)lllllllllllllllllllIllIllllllllI);
                                        "".length();
                                    }
                                }
                                ...
                                if (G.lIIlIIIllIIIl(Bank.contains((int[])nArray8) ? 1 : 0)) {
                                    ...
                                    lllllllllllllllllllIllIllllllllI = new d(lIlIlIllII[17], lIlIlIllII[9], lIlIlIllII[47]);
                                    bp.add((d)lllllllllllllllllllIllIllllllllI);
                                    "".length();
                                }
                                int[] nArray9 = new int[lIlIlIllII[1]];
                        ...
                        if (G.lIIlIIIllIIIl(Bank.contains((Predicate)(lllllllllllllllllllIllIllllllllI = item -> item.getName().toLowerCase().contains(lIlIlIlIlI[lIlIlIllII[85]]))) ? 1 : 0)) {
                            System.out.println(lIlIlIlIlI[lIlIlIllII[49]]);
                            lllllllllllllllllllIllIlllllllIl = new d(lIlIlIllII[50], lIlIlIllII[38], lIlIlIllII[51]);
                            bp.add(lllllllllllllllllllIllIlllllllIl);
                            "".length();
                        }
                        int[] nArray = new int[lIlIlIllII[1]];
                        nArray[G.lIlIlIllII[0]] = lIlIlIllII[20];
                    ...
                    lllllllllllllllllllIllIlllllllIl = new d(lIlIlIllII[20], lIlIlIllII[45], lIlIlIllII[53]);
                    bp.add(lllllllllllllllllllIllIlllllllIl);
                    "".length();
                }
                int[] nArray = new int[lIlIlIllII[1]];
                ...
                if (G.lIIlIIIllIIIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    lllllllllllllllllllIllIlllllllIl = new d(lIlIlIllII[7], lIlIlIllII[30], lIlIlIllII[53]);
                    bp.add(lllllllllllllllllllIllIlllllllIl);
                    "".length();
                }
                int[] nArray14 = new int[lIlIlIllII[1]];
        ...
        if (G.lIIlIIIllIIIl(Bank.contains((int[])nArray) ? 1 : 0)) {
            ...
            lllllllllllllllllllIllIlllllllIl = new d(lIlIlIllII[27], lIlIlIllII[9], j.bZ);
            bp.add(lllllllllllllllllllIllIlllllllIl);
            "".length();
        }
        int[] nArray17 = new int[lIlIlIllII[1]];
        ...
        if (G.lIIlIIIlIllll(Bank.contains((int[])nArray17) ? 1 : 0)) {
            ...
            if (G.lIIlIIIllIIII(Bank.getFirst((int[])nArray18).getQuantity(), lIlIlIllII[11])) {
                ...
                lllllllllllllllllllIllIlllllllIl = new d(lIlIlIllII[10], lIlIlIllII[58], lIlIlIllII[14]);
                bp.add(lllllllllllllllllllIllIlllllllIl);
                "".length();
            }
        }
        ...
        if (G.lIIlIIIlIllll(Bank.contains((int[])nArray19) ? 1 : 0)) {
            ...
            if (G.lIIlIIIllIIII(Bank.getFirst((int[])nArray20).getQuantity(), lIlIlIllII[11])) {
                ...
                lllllllllllllllllllIllIlllllllIl = new d(lIlIlIllII[59], lIlIlIllII[58], lIlIlIllII[14]);
                bp.add(lllllllllllllllllllIllIlllllllIl);
                "".length();
            }
        }
        ...
        if (G.lIIlIIIlIllll(Bank.contains((int[])nArray21) ? 1 : 0)) {
            ...
            if (G.lIIlIIIllIIII(Bank.getFirst((int[])nArray22).getQuantity(), lIlIlIllII[11])) {
                ...
                lllllllllllllllllllIllIlllllllIl = new d(lIlIlIllII[15], lIlIlIllII[58], lIlIlIllII[14]);
                bp.add(lllllllllllllllllllIllIlllllllIl);
                "".length();
            }
        }
        ...
        if (G.lIIlIIIlIllll(Bank.contains((int[])nArray23) ? 1 : 0)) {
            ...
            if (G.lIIlIIIllIIII(Bank.getFirst((int[])nArray24).getQuantity(), lIlIlIllII[11])) {
                ...
                lllllllllllllllllllIllIlllllllIl = new d(lIlIlIllII[13], lIlIlIllII[58], lIlIlIllII[14]);
                bp.add(lllllllllllllllllllIllIlllllllIl);
                "".length();
            }
        }
