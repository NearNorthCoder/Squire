...
implements K {
                    ...
                    block27: {
                                    ...
                                    block24: {
                                        block19: {
                                            ...
                                            block20: {
                                                ...
                                                return ((0x1D ^ 0xE ^ (0xDA ^ 0x8E)) & (99 + 179 - 137 + 81 ^ 116 + 31 - 73 + 79 ^ -" ".length())) != 0;
                                            }
                                            n5 = lIlllIlIII[0];
                                            return n5 != 0;
                                        }
                        ...
                        if (R.lIIlllIlIIlII(Bank.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (R.lIIlllIlIIlII(Bank.contains((int[])nArray14) ? 1 : 0)) {
                                ...
                                return ((176 + 26 - 55 + 54 ^ 83 + 118 - 104 + 45) & (226 + 124 - 260 + 145 ^ 139 + 128 - 250 + 155 ^ -" ".length())) != 0;
                            }
                        }
                    }
                    n3 = lIlllIlIII[0];
                    ...
                    if (R.lIIlllIlIlIIl(Bank.getFirst((int[])nArray17).getQuantity(), lIlllIlIII[19])) {
                        ...
                        if (R.lIIlllIlIIlII(Bank.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (R.lIIlllIlIIlII(Bank.contains((int[])nArray19) ? 1 : 0)) {
                                ...
                                return ((0x28 ^ 0x72 ^ (0x5E ^ 0x53)) & (0x4A ^ 0x27 ^ (0xAD ^ 0x97) ^ -" ".length())) != 0;
                            }
                        }
                    }
                }
    ...
    private static String lIIlllIIlllII(String llllllllllllllllllIlllllIIIlllII, String llllllllllllllllllIlllllIIIllIll) {
        try {
            SecretKeySpec llllllllllllllllllIlllllIIlIIIIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIlllllIIIllIll.getBytes(StandardCharsets.UTF_8)), lIlllIlIII[30]), "DES");
            Cipher llllllllllllllllllIlllllIIlIIIII = Cipher.getInstance("DES");
            llllllllllllllllllIlllllIIlIIIII.init(lIlllIlIII[3], llllllllllllllllllIlllllIIlIIIIl);
            return new String(llllllllllllllllllIlllllIIlIIIII.doFinal(Base64.getDecoder().decode(llllllllllllllllllIlllllIIIlllII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIIlllIIlllIl(String llllllllllllllllllIlllllIIlIlllI, String llllllllllllllllllIlllllIIlIllIl) {
        llllllllllllllllllIlllllIIlIlllI = new String(Base64.getDecoder().decode(llllllllllllllllllIlllllIIlIlllI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllIlllllIIllIIIl = new StringBuilder();
        char[] llllllllllllllllllIlllllIIllIIII = llllllllllllllllllIlllllIIlIllIl.toCharArray();
        int llllllllllllllllllIlllllIIlIllll = lIlllIlIII[0];
        char[] llllllllllllllllllIlllllIIlIlIIl = llllllllllllllllllIlllllIIlIlllI.toCharArray();
        int llllllllllllllllllIlllllIIlIlIII = llllllllllllllllllIlllllIIlIlIIl.length;
        int llllllllllllllllllIlllllIIlIIlll = lIlllIlIII[0];
        while (R.lIIlllIlIIlIl(llllllllllllllllllIlllllIIlIIlll, llllllllllllllllllIlllllIIlIlIII)) {
            char llllllllllllllllllIlllllIIllIlII = llllllllllllllllllIlllllIIlIlIIl[llllllllllllllllllIlllllIIlIIlll];
            llllllllllllllllllIlllllIIllIIIl.append((char)(llllllllllllllllllIlllllIIllIlII ^ llllllllllllllllllIlllllIIllIIII[llllllllllllllllllIlllllIIlIllll % llllllllllllllllllIlllllIIllIIII.length]));
            "".length();
            ++llllllllllllllllllIlllllIIlIllll;
            ++llllllllllllllllllIlllllIIlIIlll;
            "".length();
            if (((0xAA ^ 0xB8) & ~(0xA1 ^ 0xB3)) == 0) continue;
            return null;
        }
        return String.valueOf(llllllllllllllllllIlllllIIllIIIl);
    }
    ...
    public int ad() {
        ...
        if (-" ".length() > 0) {
            return (0x22 ^ 0x44 ^ (0x1E ^ 0x52)) & (0x16 ^ 0x4A ^ (0x21 ^ 0x57) ^ -" ".length());
        }
    ...
    private static void O() {
        d llllllllllllllllllIlllllIlIlIlIl;
        Object llllllllllllllllllIlllllIlIlIllI;
        if (R.lIIlllIlIIlIl(Skills.getLevel((Skill)Skill.MAGIC), lIlllIlIII[8])) {
            ...
            if (R.lIIlllIlIIllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[9], lIlllIlIII[61], lIlllIlIII[6]);
                bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                "".length();
            }
            int[] nArray3 = new int[lIlllIlIII[1]];
            nArray3[R.lIlllIlIII[0]] = lIlllIlIII[11];
            if (R.lIIlllIlIIllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
                llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[11], lIlllIlIII[62], lIlllIlIII[6]);
                bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                "".length();
            }
            int[] nArray4 = new int[lIlllIlIII[1]];
            ...
            if (R.lIIlllIlIIllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
                llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[13], lIlllIlIII[63], lIlllIlIII[6]);
                bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                "".length();
            }
            int[] nArray5 = new int[lIlllIlIII[1]];
            ...
            if (R.lIIlllIlIIllI(Bank.contains((int[])nArray5) ? 1 : 0)) {
                llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[14], lIlllIlIII[5], lIlllIlIII[6]);
                bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                "".length();
            }
            int[] nArray6 = new int[lIlllIlIII[1]];
            ...
            if (R.lIIlllIlIIllI(Bank.contains((int[])nArray6) ? 1 : 0)) {
                llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[48], lIlllIlIII[1], e.c(lIlllIlIII[64], lIlllIlIII[65]));
                bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                "".length();
            }
        }
        if (R.lIIlllIlIlIIl(Skills.getLevel((Skill)Skill.MAGIC), lIlllIlIII[8])) {
            ...
            if (R.lIIlllIlIIlII(Bank.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (R.lIIlllIlIIlIl(Bank.getFirst((int[])nArray7).getQuantity(), lIlllIlIII[63])) {
                    ...
                    llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[24], lIlllIlIII[63] - Bank.getFirst((int[])nArray8).getQuantity(), lIlllIlIII[66]);
                    bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                    "".length();
                }
            }
            ...
            if (R.lIIlllIlIIllI(Bank.contains((int[])nArray9) ? 1 : 0)) {
                llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[24], lIlllIlIII[63], lIlllIlIII[66]);
                bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                "".length();
            }
            int[] nArray10 = new int[lIlllIlIII[1]];
            ...
            if (R.lIIlllIlIIlII(Bank.contains((int[])nArray10) ? 1 : 0)) {
                ...
                if (R.lIIlllIlIIlIl(Bank.getFirst((int[])nArray11).getQuantity(), lIlllIlIII[63])) {
                    ...
                    llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[25], lIlllIlIII[63] - Bank.getFirst((int[])nArray12).getQuantity(), lIlllIlIII[67]);
                    bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                    "".length();
                }
            }
            ...
            if (R.lIIlllIlIIllI(Bank.contains((int[])nArray13) ? 1 : 0)) {
                llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[25], lIlllIlIII[63], lIlllIlIII[67]);
                bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                "".length();
            }
            int[] nArray14 = new int[lIlllIlIII[1]];
            ...
            if (R.lIIlllIlIIllI(Bank.contains((int[])nArray14) ? 1 : 0)) {
                ...
                if (R.lIIlllIlIIllI(Equipment.contains((int[])nArray15) ? 1 : 0)) {
                    llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[22], lIlllIlIII[1], lIlllIlIII[68]);
                    bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                    "".length();
                }
            }
            if (R.lIIlllIlIIlII(cc ? 1 : 0)) {
                ...
                if (R.lIIlllIlIIlII(Bank.contains((int[])nArray16) ? 1 : 0)) {
                    ...
                    if (R.lIIlllIlIIlIl(Bank.getFirst((int[])nArray17).getQuantity(), lIlllIlIII[63])) {
                        ...
                        llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[16], lIlllIlIII[63] - Bank.getFirst((int[])nArray18).getQuantity(), lIlllIlIII[60]);
                        bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                        "".length();
                    }
                }
                ...
                if (R.lIIlllIlIIllI(Bank.contains((int[])nArray19) ? 1 : 0)) {
                    llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[16], lIlllIlIII[63], lIlllIlIII[60]);
                    bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                    "".length();
                }
                ...
                if (R.lIIlllIlIIlII(Bank.contains((int[])nArray20) ? 1 : 0)) {
                    ...
                    if (R.lIIlllIlIIlIl(Bank.getFirst((int[])nArray21).getQuantity(), lIlllIlIII[68])) {
                        ...
                        llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[23], lIlllIlIII[68] - Bank.getFirst((int[])nArray22).getQuantity(), lIlllIlIII[6]);
                        bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                        "".length();
                    }
                }
                ...
                if (R.lIIlllIlIIllI(Bank.contains((int[])nArray23) ? 1 : 0)) {
                    llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[23], lIlllIlIII[68], lIlllIlIII[6]);
                    bp.add((d)llllllllllllllllllIlllllIlIlIllI);
                    "".length();
                }
            }
        ...
        if (R.lIIlllIlIIllI(Bank.contains((int[])nArray) ? 1 : 0)) {
            llllllllllllllllllIlllllIlIlIllI = new d(lIlllIlIII[20], lIlllIlIII[69], lIlllIlIII[40]);
            bp.add((d)llllllllllllllllllIlllllIlIlIllI);
            "".length();
        }
        if (R.lIIlllIlIIllI(Bank.contains(llllllllllllllllllIlllllIlIlIllI = item -> item.getName().toLowerCase().contains(lIlllIIllI[lIlllIlIII[75]])) ? 1 : 0)) {
            llllllllllllllllllIlllllIlIlIlIl = new d(lIlllIlIII[70], lIlllIlIII[19], lIlllIlIII[71]);
            bp.add(llllllllllllllllllIlllllIlIlIlIl);
            "".length();
        }
        int[] nArray24 = new int[lIlllIlIII[1]];
        nArray24[R.lIlllIlIII[0]] = lIlllIlIII[72];
        if (R.lIIlllIlIIllI(Bank.contains((int[])nArray24) ? 1 : 0)) {
            llllllllllllllllllIlllllIlIlIlIl = new d(lIlllIlIII[72], lIlllIlIII[33], lIlllIlIII[73]);
            bp.add(llllllllllllllllllIlllllIlIlIlIl);
            "".length();
        }
        ...
        if (R.lIIlllIlIIllI(Bank.contains((int[])nArray25) ? 1 : 0)) {
            llllllllllllllllllIlllllIlIlIlIl = new d(lIlllIlIII[18], lIlllIlIII[33], lIlllIlIII[73]);
            bp.add(llllllllllllllllllIlllllIlIlIlIl);
            "".length();
        }
    }
    ...
    public boolean af() {
        ...
        if (R.lIIlllIlIlIIl(Skills.getLevel((Skill)Skill.MAGIC), lIlllIlIII[2])) {
            bl = lIlllIlIII[1];
            "".length();
            if ((106 + 71 - 76 + 52 ^ 8 + 152 - 125 + 122) <= "   ".length()) {
                return ((0x75 ^ 0xB ^ (0xF3 ^ 0xAB)) & (44 + 91 - 5 + 38 ^ 141 + 48 - 87 + 40 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlllIlIII[0];
        }
    ...
    public static void ai() {
        ...
        if (R.lIIlllIlIIllI(bn ? 1 : 0) && R.lIIlllIlIIlIl(Skills.getLevel((Skill)Skill.MAGIC), lIlllIlIII[2])) {
            BankLocation llllllllllllllllllIlllllIlIlllll;
            if (R.lIIlllIlIIllI(R.al() ? 1 : 0)) {
                llllllllllllllllllIlllllIlIlllll = BankLocation.getNearest();
                if (R.lIIlllIlIIlll(llllllllllllllllllIlllllIlIlllll) && R.lIIlllIlIIllI(llllllllllllllllllIlllllIlIlllll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderShamans.c = lIlllIIllI[lIlllIlIII[3]];
                    a.a(llllllllllllllllllIlllllIlIlllll);
                }
                if (R.lIIlllIlIIlll(llllllllllllllllllIlllllIlIlllll) && R.lIIlllIlIIlII(llllllllllllllllllIlllllIlIlllll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                ...
                                if (R.lIIlllIlIIlIl(Inventory.getCount((int[])nArray2), lIlllIlIII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (R.lIIlllIlIlIII(Inventory.getCount((int[])nArray))) {
                                            bl = lIlllIlIII[1];
                                            "".length();
                                            if (((0x77 ^ 0x37 ^ (0x31 ^ 0x61)) & (31 + 136 - 137 + 120 ^ 94 + 121 - 144 + 63 ^ -" ".length())) != 0) {
                                                return ((0xEE ^ 0xA4 ^ (0x5E ^ 0x53)) & (182 + 33 - -5 + 10 ^ 30 + 138 - 135 + 128 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlllIlIII[0];
                                        }
                                ...
                                if (R.lIIlllIlIIlIl(Inventory.getCount((int[])nArray8), lIlllIlIII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (R.lIIlllIlIlIII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            "".length();
                                            if ("   ".length() <= 0) {
                                                return ((53 + 121 - 125 + 85 ^ 155 + 90 - 211 + 152) & (0x73 ^ 4 ^ (0xB ^ 0x40) ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlllIlIII[0];
                                        }
                                ...
                                if (R.lIIlllIlIIlIl(Inventory.getCount((int[])nArray10), lIlllIlIII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (R.lIIlllIlIlIII(Inventory.getCount((int[])nArray))) {
                                            bl = lIlllIlIII[1];
                                            "".length();
                                            if (((7 ^ 0x27 ^ (0x71 ^ 0xB)) & (160 + 195 - 227 + 118 ^ 127 + 42 - 113 + 116 ^ -" ".length())) != 0) {
                                                return ((0x2F ^ 0xC ^ (0x2E ^ 0x3F)) & (131 + 23 - -5 + 11 ^ 151 + 22 - 107 + 86 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlllIlIII[0];
                                        }
                                ...
                                if (R.lIIlllIlIIlIl(Inventory.getCount((int[])nArray14), lIlllIlIII[1]) && R.lIIlllIlIIlIl(Skills.getLevel((Skill)Skill.MAGIC), lIlllIlIII[21])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (R.lIIlllIlIlIII(Inventory.getCount((int[])nArray))) {
                                            bl = lIlllIlIII[1];
                                            "".length();
                                            if (" ".length() <= ((0xE ^ 0x35 ^ (0x73 ^ 0x5D)) & (0x73 ^ 0x12 ^ (0xB ^ 0x7F) ^ -" ".length()))) {
                                                return ((0xFA ^ 0xAE ^ (0x5E ^ 0x45)) & (134 + 188 - 144 + 17 ^ 96 + 42 - 34 + 36 ^ -" ".length())) != 0;
                                            }
                                        } else {
                                            bl = lIlllIlIII[0];
                                        }
            ...
            if (R.lIIlllIlIIlII(R.al() ? 1 : 0)) {
                ...
                if (R.lIIlllIlIlIIl(Skills.getLevel((Skill)Skill.MAGIC), lIlllIlIII[8])) {
                    int llllllllllllllllllIlllllIlIlllIl;
                    ...
                    llllllllllllllllllIlllllIlIlllll = Inventory.getFirst((int[])nArray17);
                    int[] nArray18 = new int[lIlllIlIII[1]];
                    nArray18[R.lIlllIlIII[0]] = lIlllIlIII[38];
                    Item llllllllllllllllllIlllllIlIllllI = Inventory.getFirst((int[])nArray18);
                    if (R.lIIlllIlIIllI(cc ? 1 : 0) && R.lIIlllIlIIlll(cf)) {
                        ...
                        if (R.lIIlllIlIIlII(Players.getLocal().getWorldLocation().equals((Object)cf) ? 1 : 0) && R.lIIlllIlIIlll(llllllllllllllllllIlllllIlIlllll) && R.lIIlllIlIIlll(llllllllllllllllllIlllllIlIllllI)) {
                            llllllllllllllllllIlllllIlIlllIl = Skills.getExperience((Skill)Skill.MAGIC);
                            Magic.cast((Spell)SpellBook.Standard.HIGH_LEVEL_ALCHEMY, (Item)llllllllllllllllllIlllllIlIllllI);
                            Time.sleepUntil(() -> {
                                boolean bl;
                                if (R.lIIlllIlIllll(Skills.getExperience((Skill)Skill.MAGIC), llllllllllllllllllIlllllIlIlllIl)) {
                                    bl = lIlllIlIII[1];
                                    "".length();
                                    if (null != null) {
                                        return ((0xE9 ^ 0xBD) & ~(0x5A ^ 0xE)) != 0;
                                    }
                                } else {
                                    bl = lIlllIlIII[0];
                                }
                    ...
                    if (R.lIIlllIlIIlII(cc ? 1 : 0)) {
                        if (R.lIIlllIlIIlll(llllllllllllllllllIlllllIlIlllll) && R.lIIlllIlIIlll(llllllllllllllllllIlllllIlIllllI) && R.lIIlllIlIlIlI(Players.getLocal().getAnimation(), lIlllIlIII[28])) {
                            llllllllllllllllllIlllllIlIlllIl = Skills.getExperience((Skill)Skill.MAGIC);
                            Magic.cast((Spell)SpellBook.Standard.HIGH_LEVEL_ALCHEMY, (Item)llllllllllllllllllIlllllIlIllllI);
                            Time.sleepUntil(() -> {
                                boolean bl;
                                if (R.lIIlllIlIllll(Skills.getExperience((Skill)Skill.MAGIC), llllllllllllllllllIlllllIlIlllIl)) {
                                    bl = lIlllIlIII[1];
                                    "".length();
                                    if (((0x74 ^ 0x71 ^ (0x14 ^ 0x31)) & (0xED ^ 0x87 ^ (0x39 ^ 0x73) ^ -" ".length())) < 0) {
                                        return ((0x45 ^ 0x11 ^ (0x6D ^ 6)) & (205 + 240 - 343 + 147 ^ 83 + 173 - 94 + 36 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlllIlIII[0];
                                }
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (R.lIIlllIlIlIlI(Players.getLocal().getAnimation(), lIlllIlIII[28])) {
                                bl = lIlllIlIII[1];
                                "".length();
                                if (-" ".length() >= ((0xC2 ^ 0xA8 ^ (0x53 ^ 8)) & (74 + 96 - 123 + 84 ^ 160 + 4 - -12 + 2 ^ -" ".length()))) {
                                    return ((23 + 9 - -117 + 72 ^ 24 + 34 - 30 + 160) & (0x65 ^ 0x28 ^ (0xED ^ 0xC1) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlllIlIII[0];
                            }
                        ...
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    block24: {
                                        block19: {
                                            ...
                                            block20: {
                                                ...
                                                return ((0xF2 ^ 0xA6 ^ (0x89 ^ 0x99)) & (0x34 ^ 0x10 ^ (0xD8 ^ 0xB8) ^ -" ".length())) != 0;
                                            }
                                            n5 = lIlllIlIII[0];
                                            return n5 != 0;
                                        }
                                    ...
                                    return ((0xA5 ^ 0x9A ^ " ".length()) & (0x67 ^ 0x68 ^ (0x2D ^ 0x1C) ^ -" ".length())) != 0;
                                }
                                n4 = lIlllIlIII[0];
                                return n4 != 0;
                            }
                    ...
                    if (R.lIIlllIlIlIIl(Inventory.getFirst((int[])nArray17).getQuantity(), lIlllIlIII[19])) {
                        ...
                        if (R.lIIlllIlIIlII(Inventory.contains((int[])nArray18) ? 1 : 0)) {
                            ...
                            if (R.lIIlllIlIIlII(Inventory.contains((int[])nArray19) ? 1 : 0)) {
                                n2 = lIlllIlIII[1];
                                "".length();
                                if ((0xC2 ^ 0xC6) >= -" ".length()) return n2 != 0;
                                return ((0x15 ^ 0x28) & ~(0x2D ^ 0x10)) != 0;
                            }
                        }
                    }
                }
    ...
    private static void lIIlllIlIIIlI() {
        ...
        R.lIlllIIllI[R.lIlllIlIII[0]] = R.lIIlllIIlllII("H8ZtQPpBu455/Me5O91p+g==", "xnHyJ");
        R.lIlllIIllI[R.lIlllIlIII[1]] = R.lIIlllIIlllIl("AB8hJjEuEytvIDMPJiElZh87Ki81Wm88NS8CLCcrKBFvLSMlHW87LWYbLigrJVY7PSMvGCYhJQ==", "FvOOB");
        R.lIlllIIllI[R.lIlllIlIII[3]] = R.lIIlllIIlllII("twW9UdQOZnhHXLzquhbth1r6HqB2I9VY", "csXCD");
        R.lIlllIIllI[R.lIlllIlIII[4]] = R.lIIlllIIlllII("CA4l6UCauNGVmrWcaXUdfkY+mhHg2yGF", "TKOYM");
        R.lIlllIIllI[R.lIlllIlIII[7]] = R.lIIlllIIllllI("WusHdsu1n6LQEKOc1VoYml2rG7969BrIiDW/L+PjaGU6zaWLnilY4RLa1/rjAuqO", "kSxYK");
        R.lIlllIIllI[R.lIlllIlIII[19]] = R.lIIlllIIlllII("Pi/dRF18qu+Vf4EwM6Kqxg==", "ZhiAi");
        R.lIlllIIllI[R.lIlllIlIII[6]] = R.lIIlllIIlllIl("GywMCxExMRYNUjk3Dxk=", "ZXxjr");
        R.lIlllIIllI[R.lIlllIlIII[27]] = R.lIIlllIIllllI("rZDvjPgusREe5IpAphsPUIfsk9HcyYOQ", "MCtPO");
        R.lIlllIIllI[R.lIlllIlIII[30]] = R.lIIlllIIlllII("VlWzOeG7ZUQi8TZe5MZZyd2W0xXfy/Zk", "hcXRV");
        R.lIlllIIllI[R.lIlllIlIII[32]] = R.lIIlllIIllllI("t+6hc7+yw/4uKsPeNO29An6K07MWptx3", "cbnhd");
        R.lIlllIIllI[R.lIlllIlIII[33]] = R.lIIlllIIllllI("YeOFwgvY5vegL7Z9wYWeje7Rxx/5QmDn", "mrovG");
        R.lIlllIIllI[R.lIlllIlIII[34]] = R.lIIlllIIlllII("bI13NVb2G8Y=", "eGUEL");
        R.lIlllIIllI[R.lIlllIlIII[37]] = R.lIIlllIIlllII("QqBdOzEp0wY=", "zPmsh");
        R.lIlllIIllI[R.lIlllIlIII[39]] = R.lIIlllIIllllI("0A6XUktfhTxw6l0SEORPh+hGVk00gBX2", "HKerE");
        R.lIlllIIllI[R.lIlllIlIII[43]] = R.lIIlllIIlllIl("CCUXSzwpZAIEPzU=", "FDakH");
        R.lIlllIIllI[R.lIlllIlIII[44]] = R.lIIlllIIllllI("nK5x18NDBiW8BC9TWHej3w==", "LETnd");
        R.lIlllIIllI[R.lIlllIlIII[45]] = R.lIIlllIIllllI("v+IIaEJ7+W8=", "gdfkd");
        R.lIlllIIllI[R.lIlllIlIII[46]] = R.lIIlllIIlllIl("ED04", "SROnI");
        R.lIlllIIllI[R.lIlllIlIII[47]] = R.lIIlllIIlllII("HLP4j6AAoI4=", "KIQUo");
        R.lIlllIIllI[R.lIlllIlIII[49]] = R.lIIlllIIlllII("+LzqzmJaVxQ=", "swLXo");
        R.lIlllIIllI[R.lIlllIlIII[53]] = R.lIIlllIIllllI("wCmjKaNnp1DwS+2OaBd1HibzkkNIxzTm", "fPEsU");
        R.lIlllIIllI[R.lIlllIlIII[54]] = R.lIIlllIIlllII("R4O32CPla4tXwypbAjy0Hw==", "PEsrD");
        R.lIlllIIllI[R.lIlllIlIII[56]] = R.lIIlllIIlllIl("Jws4KmUjFiQnLhU=", "pbVNE");
        R.lIlllIIllI[R.lIlllIlIII[57]] = R.lIIlllIIlllII("72CijQ/10vXu3WmE788KYQ==", "EcuQQ");
        R.lIlllIIllI[R.lIlllIlIII[58]] = R.lIIlllIIllllI("h8S7PYRKpI/yA2THK1IiSw==", "iGwZL");
        R.lIlllIIllI[R.lIlllIlIII[21]] = R.lIIlllIIlllIl("Ni4YOA9THB4+Dhgq", "sOjLg");
        R.lIlllIIllI[R.lIlllIlIII[52]] = R.lIIlllIIlllIl("CwIfFE4eHx8YBSg=", "Mkmqn");
        R.lIlllIIllI[R.lIlllIlIII[74]] = R.lIIlllIIllllI("b5T7R1f8NXA4CjB0s3f6IA==", "VGsbT");
        R.lIlllIIllI[R.lIlllIlIII[75]] = R.lIIlllIIllllI("EtTyhHQAbw66uFxgFE+DfaS+rzFfUDsR", "LsgEL");
        R.lIlllIIllI[R.lIlllIlIII[76]] = R.lIIlllIIlllII("VF0XXohxHSc=", "BbxpN");
    }

    private static void lIIlllIlIIIll() {
        lIlllIlIII = new int[82];
        R.lIlllIlIII[0] = (0x8A ^ 0xAD) & ~(0x52 ^ 0x75);
        R.lIlllIlIII[1] = " ".length();
        R.lIlllIlIII[2] = 0xED ^ 0xA6;
        R.lIlllIlIII[3] = "  ".length();
        R.lIlllIlIII[4] = "   ".length();
        ...
        R.lIlllIlIII[35] = -"  ".length() & (0xFFFFECDB & 0x1F7F);
    ...
    private static String lIIlllIIllllI(String llllllllllllllllllIlllllIlIIIIIl, String llllllllllllllllllIlllllIlIIIIII) {
        try {
            SecretKeySpec llllllllllllllllllIlllllIlIIIllI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllIlllllIlIIIIII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher llllllllllllllllllIlllllIlIIIlIl = Cipher.getInstance("Blowfish");
            llllllllllllllllllIlllllIlIIIlIl.init(lIlllIlIII[3], llllllllllllllllllIlllllIlIIIllI);
            return new String(llllllllllllllllllIlllllIlIIIlIl.doFinal(Base64.getDecoder().decode(llllllllllllllllllIlllllIlIIIIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void ak() {
        ...
        if (R.lIIlllIlIlIll(Players.getLocal().getInteracting())) {
            NPC llllllllllllllllllIlllllIlIllIlI = NPCs.getNearest(nPC -> {
                int n2;
                if (R.lIIlllIlIIlII(nPC.getName().contains(lIlllIIllI[lIlllIlIII[76]]) ? 1 : 0) && R.lIIlllIlIIllI(nPC.isDead() ? 1 : 0)) {
                    n2 = lIlllIlIII[1];
                    "".length();
                    if ("   ".length() <= 0) {
                        return ((54 + 173 - 32 + 6 ^ 5 + 33 - 30 + 150) & (0xAA ^ 0xB9 ^ (0xD1 ^ 0x95) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = lIlllIlIII[0];
                }
            ...
            List llllllllllllllllllIlllllIlIllIIl = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                ...
                if (R.lIIlllIlIlllI(nPC.getInteracting(), Players.getLocal())) {
                    bl = lIlllIlIII[1];
                    "".length();
                    if (((97 + 83 - 121 + 73 ^ 68 + 77 - 117 + 111) & (0xE5 ^ 0xAA ^ (0x34 ^ 0x74) ^ -" ".length())) >= " ".length()) {
                        return ((0xF0 ^ 0xA0 ^ (0xCD ^ 0xC7)) & (0xBC ^ 0xA8 ^ (0xF ^ 0x41) ^ -" ".length())) != 0;
                    }
                } else {
                    bl = lIlllIlIII[0];
                }
            ...
            if (R.lIIlllIlIIlll(llllllllllllllllllIlllllIlIllIlI) && R.lIIlllIlIIllI(Players.getLocal().isMoving() ? 1 : 0)) {
                llllllllllllllllllIlllllIlIllIlI.interact(lIlllIIllI[lIlllIlIII[49]]);
                Time.sleepTicks((int)lIlllIlIII[4]);
                "".length();
            }
        }
