...
implements K {
    ...
    private static String lIIlIllIIlIll(String lllllllllllllllllllIIlIIIlIlllll, String lllllllllllllllllllIIlIIIllIIIII) {
        try {
            SecretKeySpec lllllllllllllllllllIIlIIIllIIlII = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIIlIIIllIIIII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllllllIIlIIIllIIIll = Cipher.getInstance("Blowfish");
            lllllllllllllllllllIIlIIIllIIIll.init(lIllIIIlll[1], lllllllllllllllllllIIlIIIllIIlII);
            return new String(lllllllllllllllllllIIlIIIllIIIll.doFinal(Base64.getDecoder().decode(lllllllllllllllllllIIlIIIlIlllll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIIlIllIIlIlI(String lllllllllllllllllllIIlIIIlllIIIl, String lllllllllllllllllllIIlIIIlllIlIl) {
        lllllllllllllllllllIIlIIIlllIIIl = new String(Base64.getDecoder().decode(lllllllllllllllllllIIlIIIlllIIIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllllIIlIIIlllIlII = new StringBuilder();
        char[] lllllllllllllllllllIIlIIIlllIIll = lllllllllllllllllllIIlIIIlllIlIl.toCharArray();
        int lllllllllllllllllllIIlIIIlllIIlI = lIllIIIlll[4];
        char[] lllllllllllllllllllIIlIIIllIllII = lllllllllllllllllllIIlIIIlllIIIl.toCharArray();
        int lllllllllllllllllllIIlIIIllIlIll = lllllllllllllllllllIIlIIIllIllII.length;
        int lllllllllllllllllllIIlIIIllIlIlI = lIllIIIlll[4];
        while (A.lIIlIllIlllII(lllllllllllllllllllIIlIIIllIlIlI, lllllllllllllllllllIIlIIIllIlIll)) {
            char lllllllllllllllllllIIlIIIlllIlll = lllllllllllllllllllIIlIIIllIllII[lllllllllllllllllllIIlIIIllIlIlI];
            lllllllllllllllllllIIlIIIlllIlII.append((char)(lllllllllllllllllllIIlIIIlllIlll ^ lllllllllllllllllllIIlIIIlllIIll[lllllllllllllllllllIIlIIIlllIIlI % lllllllllllllllllllIIlIIIlllIIll.length]));
            "".length();
            ++lllllllllllllllllllIIlIIIlllIIlI;
            ++lllllllllllllllllllIIlIIIllIlIlI;
            "".length();
            if (-(0x24 ^ 0x21) < 0) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllllIIlIIIlllIlII);
    }
                ...
                if (A.lIIlIllIlllll(Inventory.contains((String[])stringArray2) ? 1 : 0)) {
                    ...
                    if (A.lIIlIllIlllll(Inventory.contains((int[])nArray2) ? 1 : 0)) {
                        ...
                        if (A.lIIlIllIlllll(Inventory.contains((int[])nArray3) ? 1 : 0)) {
                            ...
                            return ((0xF ^ 0x58 ^ "  ".length()) & (0xFB ^ 0x8B ^ (0x99 ^ 0xBC) ^ -" ".length())) != 0;
                        }
                    }
                }
            }
    ...
    private static String lIIlIllIIlIIl(String lllllllllllllllllllIIlIIIlIlIIlI, String lllllllllllllllllllIIlIIIlIlIIIl) {
        try {
            SecretKeySpec lllllllllllllllllllIIlIIIlIlIlll = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIIlIIIlIlIIIl.getBytes(StandardCharsets.UTF_8)), lIllIIIlll[23]), "DES");
            Cipher lllllllllllllllllllIIlIIIlIlIllI = Cipher.getInstance("DES");
            lllllllllllllllllllIIlIIIlIlIllI.init(lIllIIIlll[1], lllllllllllllllllllIIlIIIlIlIlll);
            return new String(lllllllllllllllllllIIlIIIlIlIllI.doFinal(Base64.getDecoder().decode(lllllllllllllllllllIIlIIIlIlIIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void O() {
        block16: {
            d lllllllllllllllllllIIlIIlIIIIIll;
            block15: {
                Object lllllllllllllllllllIIlIIlIIIIlII;
                block14: {
                    block13: {
                        int[] nArray = new int[lIllIIIlll[3]];
                        ...
                        if (A.lIIlIlllIIIII(Bank.contains((int[])nArray2) ? 1 : 0)) {
                            lllllllllllllllllllIIlIIlIIIIlII = new d(lIllIIIlll[11], lIllIIIlll[3], lIllIIIlll[51]);
                            bp.add((d)lllllllllllllllllllIIlIIlIIIIlII);
                            "".length();
                        }
                        int[] nArray3 = new int[lIllIIIlll[3]];
                        nArray3[A.lIllIIIlll[4]] = lIllIIIlll[14];
                        if (A.lIIlIlllIIIII(Bank.contains((int[])nArray3) ? 1 : 0)) {
                            lllllllllllllllllllIIlIIlIIIIlII = new d(lIllIIIlll[14], lIllIIIlll[3], lIllIIIlll[51]);
                            bp.add((d)lllllllllllllllllllIIlIIlIIIIlII);
                            "".length();
                        }
                        ...
                        if (A.lIIlIlllIIIII(Bank.contains((int[])nArray4) ? 1 : 0)) {
                            lllllllllllllllllllIIlIIlIIIIlII = new d(lIllIIIlll[18], lIllIIIlll[3], lIllIIIlll[51]);
                            bp.add((d)lllllllllllllllllllIIlIIlIIIIlII);
                            "".length();
                        }
                        ...
                        if (A.lIIlIlllIIIII(Bank.contains((int[])nArray5) ? 1 : 0)) {
                            lllllllllllllllllllIIlIIlIIIIlII = new d(lIllIIIlll[16], lIllIIIlll[3], lIllIIIlll[51]);
                            bp.add((d)lllllllllllllllllllIIlIIlIIIIlII);
                            "".length();
                        }
                        ...
                        if (A.lIIlIlllIIIII(Bank.contains((int[])nArray6) ? 1 : 0)) {
                            lllllllllllllllllllIIlIIlIIIIlII = new d(lIllIIIlll[13], lIllIIIlll[3], lIllIIIlll[52]);
                            bp.add((d)lllllllllllllllllllIIlIIlIIIIlII);
                            "".length();
                        }
                    ...
                    lllllllllllllllllllIIlIIlIIIIlII = new d(lIllIIIlll[10], lIllIIIlll[2], lIllIIIlll[53]);
                    bp.add((d)lllllllllllllllllllIIlIIlIIIIlII);
                    "".length();
                }
                if (A.lIIlIlllIIIII(Bank.contains((Predicate)(lllllllllllllllllllIIlIIlIIIIlII = item -> item.getName().toLowerCase().contains(lIllIIIlIl[lIllIIIlll[59]]))) ? 1 : 0)) {
                    lllllllllllllllllllIIlIIlIIIIIll = new d(lIllIIIlll[54], lIllIIIlll[15], lIllIIIlll[55]);
                    bp.add(lllllllllllllllllllIIlIIlIIIIIll);
                    "".length();
                }
                int[] nArray = new int[lIllIIIlll[3]];
            ...
            lllllllllllllllllllIIlIIlIIIIIll = new d(lIllIIIlll[9], lIllIIIlll[56], lIllIIIlll[52]);
            bp.add(lllllllllllllllllllIIlIIlIIIIIll);
            "".length();
        }
    }
    ...
    private static void lIIlIllIllIlI() {
        ...
        A.lIllIIIlIl[A.lIllIIIlll[4]] = A.lIIlIllIIlIIl("4znJdtND9WpykpSR2TwqsQDgRaBi4PUKuJsphH+UrcQQwho/6IxUJRzH2nlYBlyw", "nXfRx");
        A.lIllIIIlIl[A.lIllIIIlll[3]] = A.lIIlIllIIlIIl("zFSgOhhAPi8Sm4WZOnFTrw==", "oUVOJ");
        A.lIllIIIlIl[A.lIllIIIlll[1]] = A.lIIlIllIIlIIl("IYuXC+BOoduICooyob9KBUvtV9R4JQ+V", "ucsrt");
        A.lIllIIIlIl[A.lIllIIIlll[12]] = A.lIIlIllIIlIlI("IDd2MDAScjs4MQQ7ODZiBiczIjZXISMhMhs7MyJuVyEhODYUOj8/JVcmOXEAIgsfHwU=", "wRVQB");
        A.lIllIIIlIl[A.lIllIIIlll[7]] = A.lIIlIllIIlIlI("CQYaNjw=", "MtsXW");
        A.lIllIIIlIl[A.lIllIIIlll[15]] = A.lIIlIllIIlIIl("Mct74o6OsLe347hTzMnyJg==", "ZeaJh");
        A.lIllIIIlIl[A.lIllIIIlll[17]] = A.lIIlIllIIlIlI("IyYIAzYCKQFHPgImCgg9", "kGfgZ");
        A.lIllIIIlIl[A.lIllIIIlll[8]] = A.lIIlIllIIlIlI("Lg4BGw==", "manpV");
        A.lIllIIIlIl[A.lIllIIIlll[23]] = A.lIIlIllIIlIlI("HD0LHiN4NhULKSw=", "XTyjZ");
        A.lIllIIIlIl[A.lIllIIIlll[24]] = A.lIIlIllIIlIll("yfm/o5b1PLNABRKfx+3oQurTeOgbXJxp", "yEWMI");
        A.lIllIIIlIl[A.lIllIIIlll[2]] = A.lIIlIllIIlIlI("MCAoJw==", "gEIUw");
        A.lIllIIIlIl[A.lIllIIIlll[30]] = A.lIIlIllIIlIlI("AxE5ZAkhAgcl", "SgiDH");
        A.lIllIIIlIl[A.lIllIIIlll[31]] = A.lIIlIllIIlIlI("Hz81PQ82PWE9CTU7NSY=", "XZAIf");
        A.lIllIIIlIl[A.lIllIIIlll[33]] = A.lIIlIllIIlIIl("nnddknQzNcQ=", "RoMJD");
        A.lIllIIIlIl[A.lIllIIIlll[34]] = A.lIIlIllIIlIIl("pBeVBnvYlts=", "qzsGn");
        A.lIllIIIlIl[A.lIllIIIlll[36]] = A.lIIlIllIIlIll("ibO7h70Btk8=", "VVncc");
        A.lIllIIIlIl[A.lIllIIIlll[35]] = A.lIIlIllIIlIIl("FgeAfYdasJ0=", "JJcfD");
        A.lIllIIIlIl[A.lIllIIIlll[37]] = A.lIIlIllIIlIll("CBFGM3tS+du2R0C+eElfKA==", "ietRW");
        A.lIllIIIlIl[A.lIllIIIlll[38]] = A.lIIlIllIIlIIl("GMxmGN+1a7o=", "HGucE");
        A.lIllIIIlIl[A.lIllIIIlll[39]] = A.lIIlIllIIlIIl("+jTWEd25GaYifUQ1fKDNJQ==", "bVctR");
        A.lIllIIIlIl[A.lIllIIIlll[40]] = A.lIIlIllIIlIll("Pl3bTxLywjQViV2lyVZbjw==", "xhKEK");
        A.lIllIIIlIl[A.lIllIIIlll[41]] = A.lIIlIllIIlIll("xPdeI70/oa4=", "wndMK");
        A.lIllIIIlIl[A.lIllIIIlll[42]] = A.lIIlIllIIlIll("0BIq2jk744nXUnaISe6HwA==", "QdOii");
        A.lIllIIIlIl[A.lIllIIIlll[43]] = A.lIIlIllIIlIlI("GwMFGg==", "XljqN");
        A.lIllIIIlIl[A.lIllIIIlll[44]] = A.lIIlIllIIlIIl("X8bcmpI0gOI=", "UZfqF");
        A.lIllIIIlIl[A.lIllIIIlll[45]] = A.lIIlIllIIlIIl("px6HtE8Cc7Q=", "suLuf");
        A.lIllIIIlIl[A.lIllIIIlll[46]] = A.lIIlIllIIlIll("jL3cgy8q8uQ=", "iEGHe");
        A.lIllIIIlIl[A.lIllIIIlll[47]] = A.lIIlIllIIlIIl("RdUgiW11JlEadklC1n1kKw==", "QzLNt");
        A.lIllIIIlIl[A.lIllIIIlll[48]] = A.lIIlIllIIlIll("U7hWqKnrc/w=", "pMVOY");
        A.lIllIIIlIl[A.lIllIIIlll[0]] = A.lIIlIllIIlIll("7lLFz5NvA/U=", "toujc");
        A.lIllIIIlIl[A.lIllIIIlll[49]] = A.lIIlIllIIlIll("8prae+ss4VH5vIf4dJFstQ==", "mNYVM");
        A.lIllIIIlIl[A.lIllIIIlll[50]] = A.lIIlIllIIlIlI("BxY7GiBhBiISJzU=", "AdNsT");
        A.lIllIIIlIl[A.lIllIIIlll[58]] = A.lIIlIllIIlIlI("PSk+UzUbDggHZh4aHwAy", "oozsF");
        A.lIllIIIlIl[A.lIllIIIlll[59]] = A.lIIlIllIIlIll("NzN2z+1wEZeYsFz4XmKYjpS2LeO1wLL5", "AndYS");
        A.lIllIIIlIl[A.lIllIIIlll[60]] = A.lIIlIllIIlIlI("LzYsFjMlJA==", "KCIzZ");
        A.lIllIIIlIl[A.lIllIIIlll[61]] = A.lIIlIllIIlIIl("BVOg/7uTjAE=", "egrqh");
        A.lIllIIIlIl[A.lIllIIIlll[62]] = A.lIIlIllIIlIlI("Mzk0AjM5Kw==", "WLQnZ");
        A.lIllIIIlIl[A.lIllIIIlll[63]] = A.lIIlIllIIlIll("z14Fup0378k=", "LKWPj");
        A.lIllIIIlIl[A.lIllIIIlll[64]] = A.lIIlIllIIlIIl("vQIOK2WJAaw=", "bPlfl");
        A.lIllIIIlIl[A.lIllIIIlll[65]] = A.lIIlIllIIlIIl("QjnWH2o80kg=", "WHirb");
        A.lIllIIIlIl[A.lIllIIIlll[56]] = A.lIIlIllIIlIlI("NBIvCA4+AA==", "PgJdg");
        A.lIllIIIlIl[A.lIllIIIlll[66]] = A.lIIlIllIIlIll("fZ4SkdYBJP0=", "VgWRy");
        A.lIllIIIlIl[A.lIllIIIlll[71]] = A.lIIlIllIIlIll("xrr05/lCJblKc3sSsEAoxrrVxLhz9CSM", "ImNbk");
        A.lIllIIIlIl[A.lIllIIIlll[72]] = A.lIIlIllIIlIIl("MnXkTExO77xYa6W03Fk6rpCs/xlHgPT5EhUAJhDB5eljSjIwAoJi60uyG/4GvX0m", "hvqQg");
        A.lIllIIIlIl[A.lIllIIIlll[73]] = A.lIIlIllIIlIIl("8Cs1v7rC+EQG4tpMRVMMqfFWXvzGv6ZW/gP6wensXqNO1wYeY1Qg7lfHt7dygMeu", "DmkoK");
        A.lIllIIIlIl[A.lIllIIIlll[74]] = A.lIIlIllIIlIIl("U6kVXn0ipqs=", "oYOoY");
        A.lIllIIIlIl[A.lIllIIIlll[75]] = A.lIIlIllIIlIll("6OPCs9/3l+KO7b0A+w0EdQ==", "gyguP");
        A.lIllIIIlIl[A.lIllIIIlll[76]] = A.lIIlIllIIlIlI("KhpFDRcbVQ0VDgtVBBoBThoRHB0cVRQBHR0BFlQeAQdFGR1R", "nuetx");
        A.lIllIIIlIl[A.lIllIIIlll[77]] = A.lIIlIllIIlIIl("V5nU0t3WYZLe4VQC7l4V00Fg/zneKEo2DKDPvVItT7A=", "YSqeW");
        A.lIllIIIlIl[A.lIllIIIlll[78]] = A.lIIlIllIIlIll("RMNMchRrll/zxkkGA5zSlhrt+QBI+9U1WvDiS9NLb/g=", "XxfFi");
    }
    ...
    public static void bF() {
        ...
        if (A.lIIlIllIllllI(Skills.getLevel((Skill)Skill.COOKING), lIllIIIlll[2]) && A.lIIlIllIlllIl(e.j(lIllIIIlll[0]), lIllIIIlll[1])) {
            ...
            if (A.lIIlIlllIIIII(bn ? 1 : 0)) {
                BankLocation lllllllllllllllllllIIlIIlIIIIlll;
                if (A.lIIlIlllIIIII(A.al() ? 1 : 0) && A.lIIlIlllIIIII(e.j(lIllIIIlll[5]))) {
                    lllllllllllllllllllIIlIIlIIIIlll = BankLocation.getNearest();
                    if (A.lIIlIlllIIIIl(lllllllllllllllllllIIlIIlIIIIlll) && A.lIIlIlllIIIII(lllllllllllllllllllIIlIIlIIIIlll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderShamans.c = lIllIIIlIl[lIllIIIlll[3]];
                        a.a(lllllllllllllllllllIIlIIlIIIIlll);
                    }
                    if (A.lIIlIlllIIIIl(lllllllllllllllllllIIlIIlIIIIlll) && A.lIIlIllIlllll(lllllllllllllllllllIIlIIlIIIIlll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (A.lIIlIlllIIIII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                        ...
                        if (A.lIIlIlllIIIII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                            ...
                            if (A.lIIlIlllIIIll(Players.getLocal().getWorldLocation().distanceTo(dY), lIllIIIlll[7])) {
                                ...
                                lllllllllllllllllllIIlIIlIIIIlll = new WorldArea(lIllIIIlll[25], lIllIIIlll[26], lIllIIIlll[27], lIllIIIlll[28], lIllIIIlll[4]);
                                if (A.lIIlIlllIIIII(lllllllllllllllllllIIlIIlIIIIlll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                ...
                                if (A.lIIlIllIlllll(lllllllllllllllllllIIlIIlIIIIlll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static void lIIlIllIllIll() {
        ...
        A.lIllIIIlll[1] = "  ".length();
        A.lIllIIIlll[2] = 0x58 ^ 0xB ^ (0xC ^ 0x55);
        A.lIllIIIlll[3] = " ".length();
        A.lIllIIIlll[4] = (65 + 191 - 171 + 133 ^ 47 + 124 - 24 + 11) & (26 + 224 - 175 + 152 ^ 77 + 123 - 149 + 116 ^ -" ".length());
        ...
        A.lIllIIIlll[34] = 0x95 ^ 0x98 ^ "   ".length();
        ...
        A.lIllIIIlll[40] = 0x9A ^ 0x8D ^ "   ".length();
