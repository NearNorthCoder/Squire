...
implements K {
    ...
    public static void bS() {
        ...
        NPC lllllllllllllllllllIlllllIlIllIl = NPCs.getNearest((int[])nArray);
        ...
        if (D.lIIIllllIlIlI(Inventory.contains((int[])nArray2) ? 1 : 0)) {
            if (D.lIIIllllIlIIl(hy.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.lIIIllllIllIl(lllllllllllllllllllIlllllIlIllIl) && D.lIIIllllIlIIl(hE.contains(lllllllllllllllllllIlllllIlIllIl.getWorldLocation()) ? 1 : 0)) {
            ...
            if (D.lIIIllllIlIIl(hz.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.lIIIllllIllIl(lllllllllllllllllllIlllllIlIllIl) && D.lIIIllllIlIIl(hB.contains(lllllllllllllllllllIlllllIlIllIl.getWorldLocation()) ? 1 : 0)) {
                while (D.lIIIllllIlIll(Players.getLocal().getWorldLocation().distanceTo(hw), lIlIlIIIIl[3]) && D.lIIIllllIlIlI(AccBuilderShamans.d ? 1 : 0)) {
                    ...
                    "".length();
                    "".length();
                    if (((0xB7 ^ 0xA0) & ~(0x60 ^ 0x77)) < "   ".length()) continue;
                    return;
                }
            }
            if (D.lIIIllllIlIIl(hA.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.lIIIllllIllIl(lllllllllllllllllllIlllllIlIllIl) && D.lIIIllllIlIIl(hF.contains(lllllllllllllllllllIlllllIlIllIl.getWorldLocation()) ? 1 : 0)) {
            ...
            if (D.lIIIllllIlIIl(hD.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.lIIIllllIllIl(lllllllllllllllllllIlllllIlIllIl) && D.lIIIllllIlIIl(hF.contains(lllllllllllllllllllIlllllIlIllIl.getWorldLocation()) ? 1 : 0)) {
            ...
            if (D.lIIIllllIllII(Players.getLocal().getWorldLocation().distanceTo(ii), lIlIlIIIIl[12])) {
                ...
                TileObject lllllllllllllllllllIlllllIlIllII = TileObjects.getNearest((String[])stringArray);
                if (D.lIIIllllIllIl(lllllllllllllllllllIlllllIlIllII)) {
                    lllllllllllllllllllIlllllIlIllII.interact(lIlIIlllIl[lIlIlIIIIl[89]]);
                    Time.sleepTicks((int)lIlIlIIIIl[1]);
                    "".length();
                    Widget lllllllllllllllllllIlllllIlIlIll = Widgets.get((int)lIlIlIIIIl[23], (int)lIlIlIIIIl[3]);
                    if (D.lIIIllllIllIl(lllllllllllllllllllIlllllIlIlIll)) {
                        lllllllllllllllllllIlllllIlIlIll.interact(lIlIIlllIl[lIlIlIIIIl[90]]);
                        lllllllllllllllllllIlllllIlIlIll.interact(lIlIlIIIIl[4]);
                        lllllllllllllllllllIlllllIlIlIll.interact(lIlIIlllIl[lIlIlIIIIl[91]]);
        ...
        if (D.lIIIllllIlIIl(Inventory.contains((int[])nArray3) ? 1 : 0)) {
            ...
            if (D.lIIIllllIllII(Players.getLocal().getWorldLocation().distanceTo(new WorldPoint(lIlIlIIIIl[93], lIlIlIIIIl[94], lIlIlIIIIl[4])), lIlIlIIIIl[1]) && D.lIIIllllIllIl(lllllllllllllllllllIlllllIlIllIl) && D.lIIIllllIlIIl(hE.contains(lllllllllllllllllllIlllllIlIllIl.getWorldLocation()) ? 1 : 0)) {
                while (D.lIIIllllIlIll(Players.getLocal().getWorldLocation().distanceTo(hw), lIlIlIIIIl[3]) && D.lIIIllllIlIlI(AccBuilderShamans.d ? 1 : 0)) {
    ...
    private static void O() {
        d lllllllllllllllllllIlllllIlIIlIl;
        block21: {
            block20: {
                Object lllllllllllllllllllIlllllIlIIllI;
                block19: {
                    block18: {
                        int[] nArray = new int[lIlIlIIIIl[3]];
                        ...
                        if (D.lIIIllllIlIIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
                            ...
                            if (D.lIIIllllIIlll(Bank.getFirst((int[])nArray3).getQuantity(), lIlIlIIIIl[33])) {
                                lllllllllllllllllllIlllllIlIIllI = new d(lIlIlIIIIl[8], lIlIlIIIIl[54], lIlIlIIIIl[110]);
                                bp.add((d)lllllllllllllllllllIlllllIlIIllI);
                                "".length();
                            }
                        }
                    ...
                    lllllllllllllllllllIlllllIlIIllI = new d(lIlIlIIIIl[9], lIlIlIIIIl[13], lIlIlIIIIl[111]);
                    bp.add((d)lllllllllllllllllllIlllllIlIIllI);
                    "".length();
                }
                if (D.lIIIllllIlIlI(Bank.contains((Predicate)(lllllllllllllllllllIlllllIlIIllI = item -> item.getName().toLowerCase().contains(lIlIIlllIl[lIlIlIIIIl[117]]))) ? 1 : 0)) {
                    lllllllllllllllllllIlllllIlIIlIl = new d(lIlIlIIIIl[112], lIlIlIIIIl[31], lIlIlIIIIl[113]);
                    bp.add(lllllllllllllllllllIlllllIlIIlIl);
                    "".length();
                }
                int[] nArray = new int[lIlIlIIIIl[3]];
                nArray[D.lIlIlIIIIl[4]] = lIlIlIIIIl[105];
                if (D.lIIIllllIlIlI(Bank.contains((int[])nArray) ? 1 : 0)) {
                    lllllllllllllllllllIlllllIlIIlIl = new d(lIlIlIIIIl[105], lIlIlIIIIl[54], lIlIlIIIIl[114]);
                    bp.add(lllllllllllllllllllIlllllIlIIlIl);
                    "".length();
                }
            ...
            lllllllllllllllllllIlllllIlIIlIl = new d(lIlIlIIIIl[10], lIlIlIIIIl[33], lIlIlIIIIl[114]);
            bp.add(lllllllllllllllllllIlllllIlIIlIl);
            "".length();
        }
        int[] nArray = new int[lIlIlIIIIl[3]];
        ...
        if (D.lIIIllllIlIlI(Bank.contains((int[])nArray) ? 1 : 0)) {
            lllllllllllllllllllIlllllIlIIlIl = new d(lIlIlIIIIl[108], lIlIlIIIIl[13], j.bZ);
            bp.add(lllllllllllllllllllIlllllIlIIlIl);
            "".length();
        }
        ...
        if (D.lIIIllllIlIIl(Bank.contains((int[])nArray10) ? 1 : 0)) {
            ...
            if (D.lIIIllllIIlll(Bank.getFirst((int[])nArray11).getQuantity(), lIlIlIIIIl[101])) {
                lllllllllllllllllllIlllllIlIIlIl = new d(lIlIlIIIIl[7], lIlIlIIIIl[115], lIlIlIIIIl[18]);
                bp.add(lllllllllllllllllllIlllllIlIIlIl);
                "".length();
            }
        }
        ...
        if (D.lIIIllllIlIIl(Bank.contains((int[])nArray12) ? 1 : 0)) {
            ...
            if (D.lIIIllllIIlll(Bank.getFirst((int[])nArray13).getQuantity(), lIlIlIIIIl[101])) {
                lllllllllllllllllllIlllllIlIIlIl = new d(lIlIlIIIIl[5], lIlIlIIIIl[115], lIlIlIIIIl[18]);
                bp.add(lllllllllllllllllllIlllllIlIIlIl);
                "".length();
            }
        }
        ...
        if (D.lIIIllllIlIIl(Bank.contains((int[])nArray14) ? 1 : 0)) {
            ...
            if (D.lIIIllllIIlll(Bank.getFirst((int[])nArray15).getQuantity(), lIlIlIIIIl[101])) {
                lllllllllllllllllllIlllllIlIIlIl = new d(lIlIlIIIIl[6], lIlIlIIIIl[115], lIlIlIIIIl[18]);
                bp.add(lllllllllllllllllllIlllllIlIIlIl);
                "".length();
            }
        }
    ...
    private static void lIIIllllIIllI() {
        ...
        D.lIlIlIIIIl[1] = "  ".length();
        D.lIlIlIIIIl[2] = 194 + 97 - 152 + 87;
        D.lIlIlIIIIl[3] = " ".length();
        ...
        D.lIlIlIIIIl[20] = 0x5B ^ 0x52 ^ " ".length();
        ...
        D.lIlIlIIIIl[96] = 0x6C ^ 0x26 ^ " ".length();
        ...
        block91: {
            block93: {
                block92: {
                    block89: {
                        block90: {
                            Widget lllllllllllllllllllIlllllIllIIIl;
                                ...
                                if (D.lIIIllllIllII(Players.getLocal().getWorldLocation().distanceTo(hX), lIlIlIIIIl[15]) && D.lIIIllllIlIlI(Players.getLocal().isMoving() ? 1 : 0)) {
                                    ...
                                    if (D.lIIIllllIlIlI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                        ...
                                        if (D.lIIIllllIlIlI(Inventory.isFull() ? 1 : 0)) {
                                            ...
                                            if (D.lIIIllllIllIl(lllllllllllllllllllIlllllIllIIIl = Widgets.get((int)lIlIlIIIIl[23], (int)lIlIlIIIIl[3]))) {
                                                lllllllllllllllllllIlllllIllIIIl.interact(lIlIIlllIl[lIlIlIIIIl[24]]);
                                                lllllllllllllllllllIlllllIllIIIl.interact(lIlIlIIIIl[4]);
                                                lllllllllllllllllllIlllllIllIIIl.interact(lIlIIlllIl[lIlIlIIIIl[25]]);
                                    ...
                                    if (D.lIIIllllIllII(Players.getLocal().getWorldLocation().distanceTo(ib), lIlIlIIIIl[3])) {
                                        ...
                                        if (D.lIIIllllIllIl(lllllllllllllllllllIlllllIllIIlI2)) {
                                            ...
                                            if (D.lIIIllllIlIIl(lllllllllllllllllllIlllllIllIIlI2.hasAction(stringArray3) ? 1 : 0)) {
                                                ...
                                                Time.sleepTicks((int)lIlIlIIIIl[1]);
                                                "".length();
                                                lllllllllllllllllllIlllllIllIIIl = Widgets.get((int)lIlIlIIIIl[23], (int)lIlIlIIIIl[3]);
                                                if (D.lIIIllllIllIl(lllllllllllllllllllIlllllIllIIIl)) {
                                                    lllllllllllllllllllIlllllIllIIIl.interact(lIlIIlllIl[lIlIlIIIIl[36]]);
                                                    lllllllllllllllllllIlllllIllIIIl.interact(lIlIlIIIIl[4]);
                                                    lllllllllllllllllllIlllllIllIIIl.interact(lIlIIlllIl[lIlIlIIIIl[37]]);
                            ...
                            if (D.lIIIllllIlIII(e.j(lIlIlIIIIl[0]), lIlIlIIIIl[1]) && D.lIIIllllIlIII(e.j(lIlIlIIIIl[2]), lIlIlIIIIl[1])) {
                                ...
                                if (D.lIIIllllIllII(Players.getLocal().getWorldLocation().distanceTo(hU), lIlIlIIIIl[22])) {
                                    while (D.lIIIllllIlIll(Players.getLocal().getWorldLocation().distanceTo(hX), lIlIlIIIIl[1]) && D.lIIIllllIlIlI(AccBuilderShamans.d ? 1 : 0)) {
                                        ...
                                        "".length();
                                        "".length();
                                        if (((0xCF ^ 0x86 ^ (0x60 ^ 0x1C)) & (8 ^ 0x23 ^ (0x1F ^ 1) ^ -" ".length())) == 0) continue;
                                        return;
                                    }
                                }
                                int[] nArray = new int[lIlIlIIIIl[3]];
                                    ...
                                    if (D.lIIIllllIllII(Players.getLocal().getWorldLocation().distanceTo(ib), lIlIlIIIIl[3])) {
                                        ...
                                        if (D.lIIIllllIllIl(lllllllllllllllllllIlllllIllIIlI2)) {
                                            ...
                                            if (D.lIIIllllIlIIl(lllllllllllllllllllIlllllIllIIlI2.hasAction(stringArray5) ? 1 : 0)) {
                                                ...
                                                lllllllllllllllllllIlllllIllIIIl = Widgets.get((int)lIlIlIIIIl[23], (int)lIlIlIIIIl[3]);
                                                if (D.lIIIllllIllIl(lllllllllllllllllllIlllllIllIIIl)) {
                                                    lllllllllllllllllllIlllllIllIIIl.interact(lIlIIlllIl[lIlIlIIIIl[47]]);
                                                    lllllllllllllllllllIlllllIllIIIl.interact(lIlIlIIIIl[4]);
                                                    lllllllllllllllllllIlllllIllIIIl.interact(lIlIIlllIl[lIlIlIIIIl[48]]);
                                ...
                                if (D.lIIIllllIllII(Players.getLocal().getWorldLocation().distanceTo(hY), lIlIlIIIIl[1])) {
                                    ...
                                    lllllllllllllllllllIlllllIllIIIl = NPCs.getNearest((String[])stringArray6);
                                    if (D.lIIIllllIllIl(lllllllllllllllllllIlllllIllIIlI2) && D.lIIIllllIlllI(lllllllllllllllllllIlllllIllIIIl)) {
                                    ...
                                    if (D.lIIIllllIllIl(lllllllllllllllllllIlllllIllIIIl)) {
                                        ...
                                        if (D.lIIIllllIlIIl(Inventory.contains((int[])nArray11) ? 1 : 0)) {
                                            ...
                                            Inventory.getFirst((int[])nArray12).useOn((Actor)lllllllllllllllllllIlllllIllIIIl);
                                        }
                                        Time.sleepTicks((int)lIlIlIIIIl[3]);
                                        "".length();
                                    }
    ...
    private static String lIIIlllIIlIlI(String lllllllllllllllllllIllllIllllIII, String lllllllllllllllllllIllllIlllIlIl) {
        try {
            SecretKeySpec lllllllllllllllllllIllllIllllIll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIllllIlllIlIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
    ...
    private static String lIIIlllIIlIIl(String lllllllllllllllllllIlllllIIlIlIl, String lllllllllllllllllllIlllllIIlIlII) {
        lllllllllllllllllllIlllllIIlIlIl = new String(Base64.getDecoder().decode(lllllllllllllllllllIlllllIIlIlIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllllIlllllIIllIII = new StringBuilder();
        char[] lllllllllllllllllllIlllllIIlIlll = lllllllllllllllllllIlllllIIlIlII.toCharArray();
        int lllllllllllllllllllIlllllIIlIllI = lIlIlIIIIl[4];
        char[] lllllllllllllllllllIlllllIIlIIII = lllllllllllllllllllIlllllIIlIlIl.toCharArray();
        int lllllllllllllllllllIlllllIIIllll = lllllllllllllllllllIlllllIIlIIII.length;
        int lllllllllllllllllllIlllllIIIlllI = lIlIlIIIIl[4];
        while (D.lIIIllllIIlll(lllllllllllllllllllIlllllIIIlllI, lllllllllllllllllllIlllllIIIllll)) {
            char lllllllllllllllllllIlllllIIllIll = lllllllllllllllllllIlllllIIlIIII[lllllllllllllllllllIlllllIIIlllI];
            lllllllllllllllllllIlllllIIllIII.append((char)(lllllllllllllllllllIlllllIIllIll ^ lllllllllllllllllllIlllllIIlIlll[lllllllllllllllllllIlllllIIlIllI % lllllllllllllllllllIlllllIIlIlll.length]));
            "".length();
            ++lllllllllllllllllllIlllllIIlIllI;
            ++lllllllllllllllllllIlllllIIIlllI;
            "".length();
            if (-" ".length() != (0xA5 ^ 0xB8 ^ (0xD9 ^ 0xC0))) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllllIlllllIIllIII);
    }
    ...
    private static void lIIIllllIIlIl() {
        ...
        D.lIlIIlllIl[D.lIlIlIIIIl[4]] = D.lIIIlllIIlIII("PZ8bm4IuDosdztN/b7c6rQ==", "wPbDp");
        D.lIlIIlllIl[D.lIlIlIIIIl[3]] = D.lIIIlllIIlIIl("NzMaOBkZPxBxCAQjHT8NUTMANAcCdlQiHRguFzkDHz1UMwsSMVQlBVErATQZBTMaNg==", "qZtQj");
        D.lIlIIlllIl[D.lIlIlIIIIl[1]] = D.lIIIlllIIlIIl("AycsJQcoOy5kGCA3", "AUIDl");
        D.lIlIIlllIl[D.lIlIlIIIIl[12]] = D.lIIIlllIIlIII("X8QHvTLr1cQ=", "SdNtT");
        D.lIlIIlllIl[D.lIlIlIIIIl[15]] = D.lIIIlllIIlIlI("6K+jMD9abJ8prNtzIlhMbg==", "xlLnX");
        D.lIlIIlllIl[D.lIlIlIIIIl[13]] = D.lIIIlllIIlIlI("H3cTFzO/+rE=", "TRfXi");
        D.lIlIIlllIl[D.lIlIlIIIIl[14]] = D.lIIIlllIIlIIl("Mg4a", "pacHH");
        D.lIlIIlllIl[D.lIlIlIIIIl[18]] = D.lIIIlllIIlIlI("JRDpFgpxTFRlKuvUDTM9ffRbSFsnK5d6N3XQv+eiXdI=", "OmGgz");
        D.lIlIIlllIl[D.lIlIlIIIIl[20]] = D.lIIIlllIIlIIl("ND4/Ag==", "pLPrT");
        D.lIlIIlllIl[D.lIlIlIIIIl[21]] = D.lIIIlllIIlIlI("0XuucpBv7RHCOY8cgEjonA==", "qiNWR");
        D.lIlIIlllIl[D.lIlIlIIIIl[22]] = D.lIIIlllIIlIIl("Bhk4BUw/GDMLEw==", "JvWna");
        D.lIlIIlllIl[D.lIlIlIIIIl[24]] = D.lIIIlllIIlIIl("EB8hAxM9BSo=", "SpOwz");
        D.lIlIIlllIl[D.lIlIlIIIIl[25]] = D.lIIIlllIIlIIl("Aw0YCA==", "mxtdE");
        D.lIlIIlllIl[D.lIlIlIIIIl[26]] = D.lIIIlllIIlIIl("aQ==", "IkOAK");
        D.lIlIIlllIl[D.lIlIlIIIIl[27]] = D.lIIIlllIIlIIl("KiM1RTELYi4EIgonN0UnCzo=", "dBCeE");
        D.lIlIIlllIl[D.lIlIlIIIIl[28]] = D.lIIIlllIIlIII("xUXjLLisE8GI1ozEtFh3qu+PVYxHzuvA", "lTygM");
        D.lIlIIlllIl[D.lIlIlIIIIl[29]] = D.lIIIlllIIlIII("/S2tCpsf+SweMYyzFUnOTQ==", "xYIcR");
        D.lIlIIlllIl[D.lIlIlIIIIl[30]] = D.lIIIlllIIlIlI("LiNyrt6bMMucroC2N+wmEg==", "ihBKi");
        D.lIlIIlllIl[D.lIlIlIIIIl[31]] = D.lIIIlllIIlIlI("Koj5SP71sao=", "nfsri");
        D.lIlIIlllIl[D.lIlIlIIIIl[32]] = D.lIIIlllIIlIlI("dI2fGkv6+TU=", "GzPdw");
        D.lIlIIlllIl[D.lIlIlIIIIl[33]] = D.lIIIlllIIlIIl("IwkqOw==", "lyOUj");
        D.lIlIIlllIl[D.lIlIlIIIIl[34]] = D.lIIIlllIIlIlI("RgDNx6eqbW0=", "gaBYL");
        D.lIlIIlllIl[D.lIlIlIIIIl[35]] = D.lIIIlllIIlIlI("yrIZGB5oqeQ=", "QthEp");
        D.lIlIIlllIl[D.lIlIlIIIIl[36]] = D.lIIIlllIIlIlI("8WbqDpT8ddh5BYGsE5fRWw==", "lJwuh");
        D.lIlIIlllIl[D.lIlIlIIIIl[37]] = D.lIIIlllIIlIIl("FgQmKg==", "xqJFN");
        D.lIlIIlllIl[D.lIlIlIIIIl[38]] = D.lIIIlllIIlIIl("Rw==", "gPvRA");
        D.lIlIIlllIl[D.lIlIlIIIIl[40]] = D.lIIIlllIIlIII("Z8Pbz12zb/PSIUiFDgys/iJv0dXfb43Y", "DECWZ");
        D.lIlIIlllIl[D.lIlIlIIIIl[41]] = D.lIIIlllIIlIlI("y3O0rQYHQGmMfkc9m8hd/w==", "rpEBN");
        D.lIlIIlllIl[D.lIlIlIIIIl[42]] = D.lIIIlllIIlIII("oStSI9emht8Ps89v9sFXdg==", "ylyMH");
        D.lIlIIlllIl[D.lIlIlIIIIl[43]] = D.lIIIlllIIlIIl("AzozDQ==", "LJVcT");
        D.lIlIIlllIl[D.lIlIlIIIIl[44]] = D.lIIIlllIIlIIl("Kj0xCQ==", "eMTgn");
        D.lIlIIlllIl[D.lIlIlIIIIl[45]] = D.lIIIlllIIlIIl("IDwSIxAb", "sYsQs");
        D.lIlIIlllIl[D.lIlIlIIIIl[46]] = D.lIIIlllIIlIIl("JQcEIS8e", "vbeSL");
        D.lIlIIlllIl[D.lIlIlIIIIl[47]] = D.lIIIlllIIlIII("ubhjltlubs3gIWjhWrRGig==", "GEWPj");
        D.lIlIIlllIl[D.lIlIlIIIIl[48]] = D.lIIIlllIIlIlI("5yfikuvH7UY=", "LsQMH");
        D.lIlIIlllIl[D.lIlIlIIIIl[49]] = D.lIIIlllIIlIIl("Rg==", "fCurO");
        D.lIlIIlllIl[D.lIlIlIIIIl[50]] = D.lIIIlllIIlIlI("NrMY3bo/VuOw3k6cAvSzM6aaaT9rTAZc", "sNCVK");
        D.lIlIIlllIl[D.lIlIlIIIIl[51]] = D.lIIIlllIIlIIl("GxwTCgJ2GwkVAg==", "Vsfyg");
        D.lIlIIlllIl[D.lIlIlIIIIl[52]] = D.lIIIlllIIlIlI("p9rIoK9ZFYE=", "BIIzc");
        D.lIlIIlllIl[D.lIlIlIIIIl[53]] = D.lIIIlllIIlIlI("1Ty3nl7JDoQ6bVcCtmvlVg==", "izPsi");
        D.lIlIIlllIl[D.lIlIlIIIIl[54]] = D.lIIIlllIIlIII("3JAlWTUzODA=", "JRdRv");
        D.lIlIIlllIl[D.lIlIlIIIIl[55]] = D.lIIIlllIIlIlI("bd3aJUXefEY=", "NVVKo");
        D.lIlIIlllIl[D.lIlIlIIIIl[56]] = D.lIIIlllIIlIIl("Pi4tCAsTby4DEgUq", "vOClg");
        D.lIlIIlllIl[D.lIlIlIIIIl[57]] = D.lIIIlllIIlIII("XN6lUPtUTQg4w9acjugGwA==", "tEsRQ");
        D.lIlIIlllIl[D.lIlIlIIIIl[61]] = D.lIIIlllIIlIIl("Og8oEzkbACFXIhMCLR47FQ==", "rnFwU");
        D.lIlIIlllIl[D.lIlIlIIIIl[63]] = D.lIIIlllIIlIlI("GsjYb7KLk00=", "UYMEn");
        D.lIlIIlllIl[D.lIlIlIIIIl[64]] = D.lIIIlllIIlIlI("CUsuIJ5BGFrwy6u7UE3/IQ==", "mboBV");
        D.lIlIIlllIl[D.lIlIlIIIIl[65]] = D.lIIIlllIIlIlI("HVPR9hSgopTSdc2QdOVnNiafJzyLArM+", "dzDyv");
        D.lIlIIlllIl[D.lIlIlIIIIl[66]] = D.lIIIlllIIlIlI("tEBz/hYByDQ=", "rKSCF");
        D.lIlIIlllIl[D.lIlIlIIIIl[67]] = D.lIIIlllIIlIlI("HqNZb/hQIPtCml4hAm2Ndw==", "XifJT");
        D.lIlIIlllIl[D.lIlIlIIIIl[68]] = D.lIIIlllIIlIIl("FSM+BnMhPyIG", "SJLcS");
        D.lIlIIlllIl[D.lIlIlIIIIl[69]] = D.lIIIlllIIlIlI("CUlc9oUcB8Cki5OBSFHaRQ==", "aTIID");
        D.lIlIIlllIl[D.lIlIlIIIIl[70]] = D.lIIIlllIIlIlI("EF9fJY3yqnw=", "wkYcP");
        D.lIlIIlllIl[D.lIlIlIIIIl[71]] = D.lIIIlllIIlIlI("FRl+uuwEV5Y=", "MHRQG");
        D.lIlIIlllIl[D.lIlIlIIIIl[72]] = D.lIIIlllIIlIIl("BQMlMAk2Qiw4Cz0=", "QbNYg");
        D.lIlIIlllIl[D.lIlIlIIIIl[73]] = D.lIIIlllIIlIIl("LRsyKg==", "yzYOD");
        D.lIlIIlllIl[D.lIlIlIIIIl[74]] = D.lIIIlllIIlIIl("KAsZGg==", "jjuvS");
        D.lIlIIlllIl[D.lIlIlIIIIl[75]] = D.lIIIlllIIlIlI("QKDpWvPCFwhfOieFIGSPnA==", "drFqZ");
        D.lIlIIlllIl[D.lIlIlIIIIl[76]] = D.lIIIlllIIlIlI("9hA3lFpjpWQ=", "bMtTe");
        D.lIlIIlllIl[D.lIlIlIIIIl[77]] = D.lIIIlllIIlIlI("LhqGxeRvT1PZXwpkXpwqhWmk/V5+CN7z", "pxEil");
        D.lIlIIlllIl[D.lIlIlIIIIl[78]] = D.lIIIlllIIlIII("rIfxDtw+GYd/a6heUhr1+DcSFBIudSVj", "wrAXh");
        D.lIlIIlllIl[D.lIlIlIIIIl[79]] = D.lIIIlllIIlIIl("NCEU", "vNmIp");
        D.lIlIIlllIl[D.lIlIlIIIIl[80]] = D.lIIIlllIIlIIl("NCM9PwA=", "pQTQk");
        D.lIlIIlllIl[D.lIlIlIIIIl[81]] = D.lIIIlllIIlIlI("Wc8n6qPMdjbAR7QoCKtC7A==", "GdcpZ");
        D.lIlIIlllIl[D.lIlIlIIIIl[83]] = D.lIIIlllIIlIlI("mFtHEgD6GtXpZfUOfvdqOw2DFZE9eVsE", "qzQJa");
        D.lIlIIlllIl[D.lIlIlIIIIl[84]] = D.lIIIlllIIlIII("o6vAZ5osFqim/y0nKlF7MR9fPytwNqi/", "dLCvi");
        D.lIlIIlllIl[D.lIlIlIIIIl[85]] = D.lIIIlllIIlIII("maUAtLCaZoMe/Zyfw2VFYW3iw1yooUxJ", "SFRSn");
        D.lIlIIlllIl[D.lIlIlIIIIl[86]] = D.lIIIlllIIlIlI("yxKIB0R8SGEciIelXDtchQ==", "txAdn");
        D.lIlIIlllIl[D.lIlIlIIIIl[87]] = D.lIIIlllIIlIIl("CAYQDgUhBEQRCTY=", "Ocdzl");
        D.lIlIIlllIl[D.lIlIlIIIIl[88]] = D.lIIIlllIIlIlI("yXtjZqmjMVsGCuhiyLqQxA==", "UQcEK");
        D.lIlIIlllIl[D.lIlIlIIIIl[89]] = D.lIIIlllIIlIII("fGUM2G4FWNc=", "QEesd");
        D.lIlIIlllIl[D.lIlIlIIIIl[90]] = D.lIIIlllIIlIII("3rKW+BJed81G7+3NGCAN2A==", "uiVoh");
        D.lIlIIlllIl[D.lIlIlIIIIl[91]] = D.lIIIlllIIlIlI("KtneKP3Jupg=", "lovCf");
        D.lIlIIlllIl[D.lIlIlIIIIl[92]] = D.lIIIlllIIlIlI("25003MHdyaU=", "Tsxqm");
        D.lIlIIlllIl[D.lIlIlIIIIl[95]] = D.lIIIlllIIlIII("znxlKRlFSvcmzhRLJFJBdPoD1AdoHb6t", "YlZip");
        D.lIlIIlllIl[D.lIlIlIIIIl[96]] = D.lIIIlllIIlIIl("OxIwcDIaUzU4IxFTNSApAQ==", "usFPF");
        D.lIlIIlllIl[D.lIlIlIIIIl[97]] = D.lIIIlllIIlIlI("xLceaQeoLc6J3vJOT6ayFUzEaN2vQBCw", "OYsbs");
        D.lIlIIlllIl[D.lIlIlIIIIl[98]] = D.lIIIlllIIlIlI("sQOAjN7IzJu+0+C4QaVHkw==", "Nmile");
        D.lIlIIlllIl[D.lIlIlIIIIl[100]] = D.lIIIlllIIlIIl("GysfIAA6JBZkDjIkGi0CNA==", "SJqDl");
        D.lIlIIlllIl[D.lIlIlIIIIl[102]] = D.lIIIlllIIlIIl("JRFoMQEXVCU5AAEdJjdTAQE4IB8bETt8UwEDISQQGh0mN1MGG2gSJis9Bhc=", "rtHPs");
        D.lIlIIlllIl[D.lIlIlIIIIl[16]] = D.lIIIlllIIlIlI("obYxRZjAGNmq8j8zVA7TxjKEbbiks4bdTne6i8KwTD9aBymCH2ZRqkc1LK5HWt3X", "LihIK");
        D.lIlIIlllIl[D.lIlIlIIIIl[103]] = D.lIIIlllIIlIlI("JBMfRzkcHlg0JrqqoQx0N+8uCW1KckL4hrDjp7M+RfjqEKkfiejvaBngwy9Ieo1S", "MyRxC");
        D.lIlIIlllIl[D.lIlIlIIIIl[104]] = D.lIIIlllIIlIIl("GShIDwsrbQUHCj0kBglZPTgYHhUnKBtCWT06ARoaJiQGCVk6IkgsLBcEJik=", "NMhny");
        D.lIlIIlllIl[D.lIlIlIIIIl[106]] = D.lIIIlllIIlIIl("Dy5qEgc9aycaBisiJBRVKz46AxkxLjlfVSs8IwcWMCIkFFUsJGoxIAECBDQ=", "XKJsu");
        D.lIlIIlllIl[D.lIlIlIIIIl[116]] = D.lIIIlllIIlIlI("3q/EuLge0jGkfTkiZ6lyNxZpIrUeMLkJ", "UaFUE");
        D.lIlIIlllIl[D.lIlIlIIIIl[117]] = D.lIIIlllIIlIlI("mS7sYP2o/38RFxkjJNi2p0zE14M9Z0wT", "BrRXq");
        D.lIlIIlllIl[D.lIlIlIIIIl[163]] = D.lIIIlllIIlIII("Ifi7yMoDIb2bsexUds/O6g==", "vqpDg");
        D.lIlIIlllIl[D.lIlIlIIIIl[164]] = D.lIIIlllIIlIlI("bXGFPzk0tE8iMxUomVayINifyCu9QS7s", "BkSuc");
        D.lIlIIlllIl[D.lIlIlIIIIl[165]] = D.lIIIlllIIlIIl("LkgZGFYTHQxa", "goutv");
        D.lIlIIlllIl[D.lIlIlIIIIl[166]] = D.lIIIlllIIlIIl("ES0fHBc8IhJFVhluAAcZJ24cARMiK0sdGXAoAgcScDoDAAVwPR8cEDZg", "PNkiv");
        D.lIlIIlllIl[D.lIlIlIIIIl[167]] = D.lIIIlllIIlIIl("CxUaXA==", "RpirP");
        D.lIlIIlllIl[D.lIlIlIIIIl[168]] = D.lIIIlllIIlIII("G0T1Z8BGBIiGMohxW5RhyzUT4Bfx8v5s", "sREzb");
        D.lIlIIlllIl[D.lIlIlIIIIl[169]] = D.lIIIlllIIlIII("rNXe6JdzG0MIxj+0QRgSkIW+VTZUPx7DunNn02jsMCs=", "CsBPU");
    }
    ...
    private static String lIIIlllIIlIII(String lllllllllllllllllllIlllllIIIIlIl, String lllllllllllllllllllIlllllIIIIlII) {
        try {
            SecretKeySpec lllllllllllllllllllIlllllIIIlIII = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIlllllIIIIlII.getBytes(StandardCharsets.UTF_8)), lIlIlIIIIl[20]), "DES");
            Cipher lllllllllllllllllllIlllllIIIIlll = Cipher.getInstance("DES");
            lllllllllllllllllllIlllllIIIIlll.init(lIlIlIIIIl[1], lllllllllllllllllllIlllllIIIlIII);
            return new String(lllllllllllllllllllIlllllIIIIlll.doFinal(Base64.getDecoder().decode(lllllllllllllllllllIlllllIIIIlIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public boolean af() {
        ...
        if (D.lIIIllllIllll(e.j(lIlIlIIIIl[2]), lIlIlIIIIl[18])) {
            bl = lIlIlIIIIl[3];
            "".length();
            if ((0x2E ^ 0x22 ^ (0x5C ^ 0x54)) <= " ".length()) {
                return ((0x76 ^ 0x16 ^ (0xD9 ^ 0x97)) & (28 + 128 - 62 + 40 ^ 113 + 149 - 216 + 122 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIlIlIIIIl[4];
        }
        ...
        block30: {
            block34: {
                block32: {
                    block33: {
                        block31: {
                            void lllllllllllllllllllIlllllIlIlIIl;
                            ...
                            if (!D.lIIIllllIllIl(lllllllllllllllllllIlllllIlIlIIl) || !D.lIIIllllIlIIl(lllllllllllllllllllIlllllIlIlIIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block30;
                ...
                if (D.lIIIllllIIlll(Inventory.getCount((int[])nArray12), lIlIlIIIIl[3])) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (D.lIIIlllllIIII(Inventory.getCount((int[])nArray))) {
                            ...
                            "".length();
                            if (null != null) {
                                return ((97 + 46 - 53 + 57 ^ 1 + 105 - 47 + 99) & (122 + 76 - 42 + 7 ^ 122 + 13 - 11 + 50 ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIlIlIIIIl[4];
                        }
                ...
                if (D.lIIIllllIIlll(Inventory.getCount((int[])nArray18), lIlIlIIIIl[3])) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (D.lIIIlllllIIII(Inventory.getCount((int[])nArray))) {
                            ...
                            "".length();
                            if (" ".length() != " ".length()) {
                                return ((49 + 157 - 201 + 244 ^ 79 + 24 - 2 + 96) & (0x7F ^ 0x73 ^ (0x35 ^ 5) ^ -" ".length())) != 0;
                            }
                        } else {
                            bl = lIlIlIIIIl[4];
                        }
