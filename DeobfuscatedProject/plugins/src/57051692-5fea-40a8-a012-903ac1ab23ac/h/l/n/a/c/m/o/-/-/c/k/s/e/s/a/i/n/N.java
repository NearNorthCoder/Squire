...
implements K {
    ...
    private static String lIIIllIlIIllI(String llllllllllllllllllllIIIlIIIIlllI, String llllllllllllllllllllIIIlIIIIlIll) {
        try {
            SecretKeySpec llllllllllllllllllllIIIlIIIlIIIl = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllllIIIlIIIIlIll.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            block19: {
                block18: {
                    ...
                    if (N.lIIIllIlIllII(N.aK() ? 1 : 0) && N.lIIIllIlIlIll(Skills.getLevel((Skill)Skill.DEFENCE), lIlIIllIIl[2])) {
                        BankLocation llllllllllllllllllllIIIlIlIIIlll = BankLocation.getNearest();
                        if (N.lIIIllIlIllIl(llllllllllllllllllllIIIlIlIIIlll) && N.lIIIllIlIllII(llllllllllllllllllllIIIlIlIIIlll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            AccBuilderShamans.c = lIlIIllIII[lIlIIllIIl[3]];
                            a.a(llllllllllllllllllllIIIlIlIIIlll);
                        }
                        if (N.lIIIllIlIllIl(llllllllllllllllllllIIIlIlIIIlll) && N.lIIIllIlIlIlI(llllllllllllllllllllIIIlIlIIIlll.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                        ...
                                        block8: {
                                            ...
                                            block10: {
                                                ...
                                                if (N.lIIIllIlIlIlI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                                                    ...
                                                    return ((92 + 151 - 71 + 1 ^ 116 + 7 - 83 + 112) & (0x23 ^ 0x4A ^ (0xC3 ^ 0x9F) ^ -" ".length())) != 0;
                                                }
                                            }
                                            n3 = lIlIIllIIl[0];
                                            return n3 != 0;
    ...
    private static String lIIIllIlIIlIl(String llllllllllllllllllllIIIlIIIllllI, String llllllllllllllllllllIIIlIIlIIIlI) {
        llllllllllllllllllllIIIlIIIllllI = new String(Base64.getDecoder().decode(llllllllllllllllllllIIIlIIIllllI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllllIIIlIIlIIIIl = new StringBuilder();
        char[] llllllllllllllllllllIIIlIIlIIIII = llllllllllllllllllllIIIlIIlIIIlI.toCharArray();
        int llllllllllllllllllllIIIlIIIlllll = lIlIIllIIl[0];
        char[] llllllllllllllllllllIIIlIIIllIIl = llllllllllllllllllllIIIlIIIllllI.toCharArray();
        int llllllllllllllllllllIIIlIIIllIII = llllllllllllllllllllIIIlIIIllIIl.length;
        int llllllllllllllllllllIIIlIIIlIlll = lIlIIllIIl[0];
        while (N.lIIIllIlIlIll(llllllllllllllllllllIIIlIIIlIlll, llllllllllllllllllllIIIlIIIllIII)) {
            char llllllllllllllllllllIIIlIIlIIlII = llllllllllllllllllllIIIlIIIllIIl[llllllllllllllllllllIIIlIIIlIlll];
            llllllllllllllllllllIIIlIIlIIIIl.append((char)(llllllllllllllllllllIIIlIIlIIlII ^ llllllllllllllllllllIIIlIIlIIIII[llllllllllllllllllllIIIlIIIlllll % llllllllllllllllllllIIIlIIlIIIII.length]));
            "".length();
            ++llllllllllllllllllllIIIlIIIlllll;
            ++llllllllllllllllllllIIIlIIIlIlll;
            "".length();
            if (-(0xB7 ^ 0xBA ^ (0x27 ^ 0x2E)) < 0) continue;
            return null;
        }
        return String.valueOf(llllllllllllllllllllIIIlIIlIIIIl);
    }
    ...
    private static void lIIIllIlIlIII() {
        ...
        N.lIlIIllIIl[0] = (104 + 136 - 233 + 180 ^ 170 + 4 - 122 + 121) & (0xE9 ^ 0x86 ^ (0x70 ^ 9) ^ -" ".length());
        N.lIlIIllIIl[1] = " ".length();
        N.lIlIIllIIl[2] = 0x42 ^ 0x6A;
        N.lIlIIllIIl[3] = "  ".length();
        N.lIlIIllIIl[4] = "   ".length();
        ...
        N.lIlIIllIIl[12] = 0xCE ^ 0xA9 ^ "   ".length();
        ...
        N.lIlIIllIIl[50] = 0x31 ^ 0x11 ^ " ".length();
    ...
    public static boolean aL() {
        ...
        block15: {
            ...
            n2 = lIlIIllIIl[1];
            "".length();
            if (((71 + 98 - 128 + 90 ^ 80 + 2 - 42 + 120) & (0xBC ^ 0xB6 ^ (0x63 ^ 0x4A) ^ -" ".length())) == 0) return n2 != 0;
            return ((0x57 ^ 0x1F ^ (0xF ^ 0x49)) & (82 + 43 - -2 + 10 ^ 108 + 28 - 34 + 33 ^ -" ".length())) != 0;
        }
        n2 = lIlIIllIIl[0];
        return n2 != 0;
    }
    ...
    public static void ak() {
        ...
        if (N.lIIIllIlIlIlI(cG.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (N.lIIIllIllIIIl(Players.getLocal().getInteracting())) {
                NPC llllllllllllllllllllIIIlIlIIIlII = NPCs.getNearest(nPC -> {
                    int n2;
                    if (N.lIIIllIlIlIlI(nPC.getName().contains(lIlIIllIII[lIlIIllIIl[58]]) ? 1 : 0) && N.lIIIllIllIIIl(nPC.getInteracting()) && N.lIIIllIlIllII(nPC.isDead() ? 1 : 0)) {
                        n2 = lIlIIllIIl[1];
                        "".length();
                        if (((0xC7 ^ 0xA3 ^ (0xD8 ^ 0x9A)) & (172 + 44 - 78 + 44 ^ 7 + 29 - 32 + 140 ^ -" ".length())) > 0) {
                            return ((101 + 62 - 62 + 53 ^ 31 + 23 - -89 + 48) & (0x83 ^ 0xAC ^ (0xCA ^ 0xC0) ^ -" ".length())) != 0;
                        }
                    } else {
                        n2 = lIlIIllIIl[0];
                    }
                ...
                List llllllllllllllllllllIIIlIlIIIIll = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                    boolean bl;
                ...
                if (N.lIIIllIlIllII(llllllllllllllllllllIIIlIlIIIIll.isEmpty() ? 1 : 0)) {
                    ((NPC)llllllllllllllllllllIIIlIlIIIIll.get(lIlIIllIIl[0])).interact(lIlIIllIII[lIlIIllIIl[24]]);
                    Time.sleepTicks((int)lIlIIllIIl[3]);
                    "".length();
                }
                if (N.lIIIllIlIllIl(llllllllllllllllllllIIIlIlIIIlII) && N.lIIIllIlIllII(Players.getLocal().isMoving() ? 1 : 0) && N.lIIIllIlIlIlI(llllllllllllllllllllIIIlIlIIIIll.isEmpty() ? 1 : 0)) {
                    llllllllllllllllllllIIIlIlIIIlII.interact(lIlIIllIII[lIlIIllIIl[25]]);
                    Time.sleepTicks((int)lIlIIllIIl[3]);
                    "".length();
                }
            }
    ...
    private static void lIIIllIlIIlll() {
        ...
        N.lIlIIllIII[N.lIlIIllIIl[0]] = N.lIIIllIlIIlII("KA+q/jc4cdv8eTKNcFQhWA==", "wLciY");
        N.lIlIIllIII[N.lIlIIllIIl[1]] = N.lIIIllIlIIlII("zbT/K/QM5c+BFchD37W5vZCOEMR89w2nkwRhKjCJ6MYGn/2cPe1ZYBdwCr2hh5AVFOT5rT9xQ8w=", "gNOGM");
        N.lIlIIllIII[N.lIlIIllIIl[3]] = N.lIIIllIlIIlIl("AAoyEzEvHy0UMW4fK1o0LwUv", "NkDzV");
        N.lIlIIllIII[N.lIlIIllIIl[4]] = N.lIIIllIlIIlIl("EQYHNT4wCQ5xMDgJAjg8Pg==", "YgiQR");
        N.lIlIIllIII[N.lIlIIllIIl[6]] = N.lIIIllIlIIllI("WzzLPn5xTG/SeeIlqfLiurMeyY6wKyTLATg+XsxHIagUIfArRvFjKbLSZnoZeifu", "nWzMq");
        N.lIlIIllIII[N.lIlIIllIIl[10]] = N.lIIIllIlIIlIl("HxE+BW4lADgGJyICIw==", "VcQkN");
        N.lIlIIllIII[N.lIlIIllIIl[14]] = N.lIIIllIlIIllI("leFRH/2aCDDnL0P/ZySb0g==", "yHqpi");
        N.lIlIIllIII[N.lIlIIllIIl[15]] = N.lIIIllIlIIllI("Mcw4rGEA6JCmCF9BBUYlRd6yQF1qhlkW", "ITsPG");
        N.lIlIIllIII[N.lIlIIllIIl[18]] = N.lIIIllIlIIllI("+BoIrBByF6E=", "VOnOE");
        N.lIlIIllIII[N.lIlIIllIIl[20]] = N.lIIIllIlIIlIl("Bi0FKT0/K0k2O3EvBjV0MD4MIw==", "QLiBT");
        N.lIlIIllIII[N.lIlIIllIIl[21]] = N.lIIIllIlIIlII("zEfWJ/0rw/HXpE/vXjo/nA==", "GEkXf");
        N.lIlIIllIII[N.lIlIIllIIl[22]] = N.lIIIllIlIIllI("KJ8ANFPYt2M=", "xeugz");
        N.lIlIIllIII[N.lIlIIllIIl[23]] = N.lIIIllIlIIllI("w+HiwPEc+8A=", "mLHXL");
        N.lIlIIllIII[N.lIlIIllIIl[24]] = N.lIIIllIlIIlIl("OBs6Dy8S", "yoNnL");
        N.lIlIIllIII[N.lIlIIllIIl[25]] = N.lIIIllIlIIlIl("KR0GGzMD", "hirzP");
        N.lIlIIllIII[N.lIlIIllIIl[13]] = N.lIIIllIlIIlIl("AB4xLnEzDjEgPSgKMSQ=", "AkEAQ");
        N.lIlIIllIII[N.lIlIIllIIl[26]] = N.lIIIllIlIIlII("Kl2LbYRR7iE=", "iIHkU");
        N.lIlIIllIII[N.lIlIIllIIl[29]] = N.lIIIllIlIIllI("7RcKgfb8guFWlQPtm6ufhg==", "MMRbE");
        N.lIlIIllIII[N.lIlIIllIIl[30]] = N.lIIIllIlIIllI("jzF7GE7YuCabQ0Hlmo32Hw==", "VcIru");
        N.lIlIIllIII[N.lIlIIllIIl[31]] = N.lIIIllIlIIlIl("FA0VNQU=", "CdpYa");
        N.lIlIIllIII[N.lIlIIllIIl[19]] = N.lIIIllIlIIlII("f+UPMCCF71Xf61p97zoKlQ==", "gsaPp");
        N.lIlIIllIII[N.lIlIIllIIl[32]] = N.lIIIllIlIIllI("/PmaFqAtoCs+Q6rMT36vrA==", "QceVQ");
        N.lIlIIllIII[N.lIlIIllIIl[33]] = N.lIIIllIlIIllI("y62WGSIs22A=", "OgziK");
        N.lIlIIllIII[N.lIlIIllIIl[35]] = N.lIIIllIlIIlII("M6INhyR+w9OJjfioSvE4n0jlo4bGHcw3", "DDXWf");
        N.lIlIIllIII[N.lIlIIllIIl[36]] = N.lIIIllIlIIllI("BitWpkTDU6vqKUMRX+Hxpd2ewL5fcR2j", "iDgJe");
        N.lIlIIllIII[N.lIlIIllIIl[37]] = N.lIIIllIlIIllI("5swaPq7th5g=", "wUITH");
        N.lIlIIllIII[N.lIlIIllIIl[38]] = N.lIIIllIlIIllI("azU01qdV+Og=", "rviZa");
        N.lIlIIllIII[N.lIlIIllIIl[39]] = N.lIIIllIlIIllI("tobTiMTp1JA=", "naHgJ");
        N.lIlIIllIII[N.lIlIIllIIl[41]] = N.lIIIllIlIIlIl("OAYKBg==", "ocktB");
        N.lIlIIllIII[N.lIlIIllIIl[43]] = N.lIIIllIlIIlII("rrmWRYrlEgs=", "wLSFa");
        N.lIlIIllIII[N.lIlIIllIIl[34]] = N.lIIIllIlIIllI("1PEsbW4n8k8=", "xDOMs");
        N.lIlIIllIII[N.lIlIIllIIl[46]] = N.lIIIllIlIIlIl("LQoKAA==", "zokrB");
        N.lIlIIllIII[N.lIlIIllIIl[48]] = N.lIIIllIlIIllI("2irWh1XTOWE=", "SrEGZ");
        N.lIlIIllIII[N.lIlIIllIIl[50]] = N.lIIIllIlIIlII("4mBAhd0ghjU=", "oefOi");
        N.lIlIIllIII[N.lIlIIllIIl[57]] = N.lIIIllIlIIlII("eY1p4kiU5xc=", "gYacX");
        N.lIlIIllIII[N.lIlIIllIIl[58]] = N.lIIIllIlIIllI("L0uBzom1gUk=", "EsDQw");
    }
    ...
    private static String lIIIllIlIIlII(String llllllllllllllllllllIIIlIIllIIIl, String llllllllllllllllllllIIIlIIllIIII) {
        try {
            SecretKeySpec llllllllllllllllllllIIIlIIllIllI = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllllIIIlIIllIIII.getBytes(StandardCharsets.UTF_8)), lIlIIllIIl[18]), "DES");
            Cipher llllllllllllllllllllIIIlIIllIlIl = Cipher.getInstance("DES");
            llllllllllllllllllllIIIlIIllIlIl.init(lIlIIllIIl[3], llllllllllllllllllllIIIlIIllIllI);
            return new String(llllllllllllllllllllIIIlIIllIlIl.doFinal(Base64.getDecoder().decode(llllllllllllllllllllIIIlIIllIIIl.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public int ad() {
        ...
        if ((0x44 ^ 0x49 ^ (0x3A ^ 0x33)) <= "   ".length()) {
            return (0xB4 ^ 0x8B ^ (3 ^ 0x37)) & (0x68 ^ 0x7C ^ (0x4C ^ 0x53) ^ -" ".length());
        }
        return lIlIIllIIl[0];
    }
    ...
    public static void O() {
        d llllllllllllllllllllIIIlIlIIIIIl;
        int[] nArray = new int[lIlIIllIIl[1]];
        ...
        if (N.lIIIllIlIllII(Bank.contains((int[])nArray2) ? 1 : 0)) {
            llllllllllllllllllllIIIlIlIIIIIl = new d(lIlIIllIIl[52], lIlIIllIIl[10], lIlIIllIIl[51]);
            bp.add(llllllllllllllllllllIIIlIlIIIIIl);
            "".length();
        }
        int[] nArray3 = new int[lIlIIllIIl[1]];
        nArray3[N.lIlIIllIIl[0]] = lIlIIllIIl[49];
        if (N.lIIIllIlIllII(Bank.contains((int[])nArray3) ? 1 : 0)) {
            llllllllllllllllllllIIIlIlIIIIIl = new d(lIlIIllIIl[49], lIlIIllIIl[1], lIlIIllIIl[53]);
            bp.add(llllllllllllllllllllIIIlIlIIIIIl);
            "".length();
        }
        int[] nArray4 = new int[lIlIIllIIl[1]];
        ...
        if (N.lIIIllIlIllII(Bank.contains((int[])nArray4) ? 1 : 0)) {
            llllllllllllllllllllIIIlIlIIIIIl = new d(lIlIIllIIl[47], lIlIIllIIl[1], lIlIIllIIl[54]);
            bp.add(llllllllllllllllllllIIIlIlIIIIIl);
            "".length();
        }
        int[] nArray5 = new int[lIlIIllIIl[1]];
        ...
        if (N.lIIIllIlIllII(Bank.contains((int[])nArray5) ? 1 : 0)) {
            llllllllllllllllllllIIIlIlIIIIIl = new d(lIlIIllIIl[11], lIlIIllIIl[12], lIlIIllIIl[55]);
            bp.add(llllllllllllllllllllIIIlIlIIIIIl);
            "".length();
        }
        int[] nArray6 = new int[lIlIIllIIl[1]];
        ...
        if (N.lIIIllIlIllII(Bank.contains((int[])nArray6) ? 1 : 0)) {
            llllllllllllllllllllIIIlIlIIIIIl = new d(lIlIIllIIl[40], lIlIIllIIl[1], lIlIIllIIl[56]);
            bp.add(llllllllllllllllllllIIIlIlIIIIIl);
            "".length();
        }
        int[] nArray7 = new int[lIlIIllIIl[1]];
        ...
        if (N.lIIIllIlIllII(Bank.contains((int[])nArray7) ? 1 : 0)) {
            llllllllllllllllllllIIIlIlIIIIIl = new d(lIlIIllIIl[44], lIlIIllIIl[1], lIlIIllIIl[56]);
            bp.add(llllllllllllllllllllIIIlIlIIIIIl);
            "".length();
        }
        int[] nArray8 = new int[lIlIIllIIl[1]];
        ...
        if (N.lIIIllIlIllII(Bank.contains((int[])nArray8) ? 1 : 0)) {
            llllllllllllllllllllIIIlIlIIIIIl = new d(lIlIIllIIl[45], lIlIIllIIl[1], lIlIIllIIl[56]);
            bp.add(llllllllllllllllllllIIIlIlIIIIIl);
            "".length();
        }
        int[] nArray9 = new int[lIlIIllIIl[1]];
        ...
        if (N.lIIIllIlIllII(Bank.contains((int[])nArray9) ? 1 : 0)) {
            llllllllllllllllllllIIIlIlIIIIIl = new d(lIlIIllIIl[42], lIlIIllIIl[1], lIlIIllIIl[56]);
            bp.add(llllllllllllllllllllIIIlIlIIIIIl);
            "".length();
        }
        if (N.lIIIllIlIllll(Skills.getLevel((Skill)Skill.ATTACK), lIlIIllIIl[2])) {
            ...
            if (N.lIIIllIlIllII(Bank.contains((int[])nArray10) ? 1 : 0)) {
                llllllllllllllllllllIIIlIlIIIIIl = new d(lIlIIllIIl[17], lIlIIllIIl[1], lIlIIllIIl[54]);
                bp.add(llllllllllllllllllllIIIlIlIIIIIl);
                "".length();
            }
        }
        ...
        if (N.lIIIllIlIllII(Bank.contains((int[])nArray11) ? 1 : 0)) {
            llllllllllllllllllllIIIlIlIIIIIl = new d(lIlIIllIIl[16], lIlIIllIIl[1], lIlIIllIIl[56]);
            bp.add(llllllllllllllllllllIIIlIlIIIIIl);
            "".length();
        }
    }
