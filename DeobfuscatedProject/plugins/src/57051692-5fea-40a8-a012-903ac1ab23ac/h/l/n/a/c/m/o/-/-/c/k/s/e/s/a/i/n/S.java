...
implements K {
    ...
    private static void lIIlIllllIlIl() {
        ...
        S.lIllIIllIl[1] = " ".length();
        S.lIllIIllIl[2] = 0xE ^ 0x10;
        S.lIllIIllIl[3] = 0x44 ^ 0x76;
        S.lIllIIllIl[4] = "  ".length();
        S.lIllIIllIl[5] = "   ".length();
        S.lIllIIllIl[6] = -"  ".length() & (0xFFFF97B9 & 0x7BCF);
        S.lIllIIllIl[7] = " ".length() ^ (0x49 ^ 0x4C);
        ...
        S.lIllIIllIl[28] = "   ".length() ^ (0x9C ^ 0x8F);
        S.lIllIIllIl[29] = 116 + 56 - 92 + 88 ^ 86 + 114 - 126 + 111;
        S.lIllIIllIl[30] = -" ".length();
    ...
    public static void O() {
        d lllllllllllllllllllIIIlllllIllll;
        ...
        if (S.lIIlIlllllIIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
            lllllllllllllllllllIIIlllllIllll = new d(lIllIIllIl[54], lIllIIllIl[11], lIllIIllIl[53]);
            bp.add(lllllllllllllllllllIIIlllllIllll);
            "".length();
        }
        int[] nArray3 = new int[lIllIIllIl[1]];
        nArray3[S.lIllIIllIl[0]] = lIllIIllIl[51];
        if (S.lIIlIlllllIIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllllllIIIlllllIllll = new d(lIllIIllIl[51], lIllIIllIl[1], lIllIIllIl[55]);
            bp.add(lllllllllllllllllllIIIlllllIllll);
            "".length();
        }
        ...
        if (S.lIIlIlllllIIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
            lllllllllllllllllllIIIlllllIllll = new d(lIllIIllIl[49], lIllIIllIl[1], lIllIIllIl[56]);
            bp.add(lllllllllllllllllllIIIlllllIllll);
            "".length();
        }
        ...
        if (S.lIIlIlllllIIl(Bank.contains((int[])nArray5) ? 1 : 0)) {
            lllllllllllllllllllIIIlllllIllll = new d(lIllIIllIl[12], lIllIIllIl[13], lIllIIllIl[57]);
            bp.add(lllllllllllllllllllIIIlllllIllll);
            "".length();
        }
        ...
        if (S.lIIlIlllllIIl(Bank.contains((int[])nArray6) ? 1 : 0)) {
            lllllllllllllllllllIIIlllllIllll = new d(lIllIIllIl[42], lIllIIllIl[1], lIllIIllIl[58]);
            bp.add(lllllllllllllllllllIIIlllllIllll);
            "".length();
        }
        ...
        if (S.lIIlIlllllIIl(Bank.contains((int[])nArray7) ? 1 : 0)) {
            lllllllllllllllllllIIIlllllIllll = new d(lIllIIllIl[45], lIllIIllIl[1], lIllIIllIl[58]);
            bp.add(lllllllllllllllllllIIIlllllIllll);
            "".length();
        }
        ...
        if (S.lIIlIlllllIIl(Bank.contains((int[])nArray8) ? 1 : 0)) {
            lllllllllllllllllllIIIlllllIllll = new d(lIllIIllIl[47], lIllIIllIl[1], lIllIIllIl[58]);
            bp.add(lllllllllllllllllllIIIlllllIllll);
            "".length();
        }
        ...
        if (S.lIIlIlllllIIl(Bank.contains((int[])nArray9) ? 1 : 0)) {
            lllllllllllllllllllIIIlllllIllll = new d(lIllIIllIl[44], lIllIIllIl[1], lIllIIllIl[58]);
            bp.add(lllllllllllllllllllIIIlllllIllll);
            "".length();
        }
        if (S.lIIlIlllllIlI(Skills.getLevel((Skill)Skill.ATTACK), lIllIIllIl[21])) {
            ...
            if (S.lIIlIlllllIIl(Bank.contains((int[])nArray10) ? 1 : 0)) {
                lllllllllllllllllllIIIlllllIllll = new d(lIllIIllIl[18], lIllIIllIl[1], lIllIIllIl[56]);
                bp.add(lllllllllllllllllllIIIlllllIllll);
                "".length();
            }
        }
        ...
        if (S.lIIlIlllllIIl(Bank.contains((int[])nArray11) ? 1 : 0)) {
            lllllllllllllllllllIIIlllllIllll = new d(lIllIIllIl[17], lIllIIllIl[1], lIllIIllIl[58]);
            bp.add(lllllllllllllllllllIIIlllllIllll);
            "".length();
        }
    }
    ...
    private static String lIIlIllllIIll(String lllllllllllllllllllIIIllllIlllll, String lllllllllllllllllllIIIllllIllllI) {
        try {
            SecretKeySpec lllllllllllllllllllIIIlllllIIlII = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIIIllllIllllI.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllllllIIIlllllIIIll = Cipher.getInstance("Blowfish");
            lllllllllllllllllllIIIlllllIIIll.init(lIllIIllIl[4], lllllllllllllllllllIIIlllllIIlII);
            return new String(lllllllllllllllllllIIIlllllIIIll.doFinal(Base64.getDecoder().decode(lllllllllllllllllllIIIllllIlllll.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIIlIllllIIlI(String lllllllllllllllllllIIIllllIlIIIl, String lllllllllllllllllllIIIllllIlIIII) {
        lllllllllllllllllllIIIllllIlIIIl = new String(Base64.getDecoder().decode(lllllllllllllllllllIIIllllIlIIIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllllIIIllllIIllll = new StringBuilder();
        char[] lllllllllllllllllllIIIllllIIlllI = lllllllllllllllllllIIIllllIlIIII.toCharArray();
        int lllllllllllllllllllIIIllllIIllIl = lIllIIllIl[0];
        char[] lllllllllllllllllllIIIllllIIIlll = lllllllllllllllllllIIIllllIlIIIl.toCharArray();
        int lllllllllllllllllllIIIllllIIIllI = lllllllllllllllllllIIIllllIIIlll.length;
        int lllllllllllllllllllIIIllllIIIlIl = lIllIIllIl[0];
        while (S.lIIlIlllllIII(lllllllllllllllllllIIIllllIIIlIl, lllllllllllllllllllIIIllllIIIllI)) {
            char lllllllllllllllllllIIIllllIlIIlI = lllllllllllllllllllIIIllllIIIlll[lllllllllllllllllllIIIllllIIIlIl];
            lllllllllllllllllllIIIllllIIllll.append((char)(lllllllllllllllllllIIIllllIlIIlI ^ lllllllllllllllllllIIIllllIIlllI[lllllllllllllllllllIIIllllIIllIl % lllllllllllllllllllIIIllllIIlllI.length]));
            "".length();
            ++lllllllllllllllllllIIIllllIIllIl;
            ++lllllllllllllllllllIIIllllIIIlIl;
            "".length();
            if (null == null) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllllIIIllllIIllll);
    }
    ...
    public boolean af() {
        ...
        if (S.lIIlIlllllIlI(Skills.getLevel((Skill)Skill.ATTACK), lIllIIllIl[3]) && S.lIIlIlllllIlI(Skills.getLevel((Skill)Skill.STRENGTH), lIllIIllIl[3]) && S.lIIlIlllllIlI(Skills.getLevel((Skill)Skill.DEFENCE), lIllIIllIl[2])) {
            ...
            if (-(181 + 7 - 18 + 14 ^ 122 + 105 - 159 + 121) >= 0) {
                return ((0x46 ^ 0x3F ^ (0x42 ^ 0x17)) & (9 + 106 - 11 + 30 ^ 150 + 96 - 104 + 28 ^ -" ".length())) != 0;
            }
        } else {
            n2 = lIllIIllIl[0];
        }
    ...
    private static String lIIlIllllIIIl(String lllllllllllllllllllIIIlllIllllII, String lllllllllllllllllllIIIlllIlllIIl) {
        try {
            SecretKeySpec lllllllllllllllllllIIIlllIllllll = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIIIlllIlllIIl.getBytes(StandardCharsets.UTF_8)), lIllIIllIl[19]), "DES");
            Cipher lllllllllllllllllllIIIlllIlllllI = Cipher.getInstance("DES");
            lllllllllllllllllllIIIlllIlllllI.init(lIllIIllIl[4], lllllllllllllllllllIIIlllIllllll);
            return new String(lllllllllllllllllllIIIlllIlllllI.doFinal(Base64.getDecoder().decode(lllllllllllllllllllIIIlllIllllII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static boolean aK() {
        ...
        block18: {
            ...
            if (S.lIIlIllllIlll(Inventory.contains((int[])nArray) ? 1 : 0)) {
                n2 = lIllIIllIl[1];
                "".length();
                if (((0x37 ^ 0x72) & ~(0xC3 ^ 0x86)) > -" ".length()) return n2 != 0;
                return ((0x72 ^ 0x28) & ~(0xD3 ^ 0x89)) != 0;
            }
        }
        n2 = lIllIIllIl[0];
        return n2 != 0;
            ...
            block20: {
                block19: {
                    ...
                    if (S.lIIlIlllllIIl(S.aK() ? 1 : 0) && (!S.lIIlIlllllIlI(Skills.getLevel((Skill)Skill.DEFENCE), lIllIIllIl[2]) || !S.lIIlIlllllIlI(Skills.getLevel((Skill)Skill.ATTACK), lIllIIllIl[3]) || S.lIIlIlllllIII(Skills.getLevel((Skill)Skill.STRENGTH), lIllIIllIl[3]))) {
                        BankLocation lllllllllllllllllllIIIllllllIlIl = BankLocation.getNearest();
                        if (S.lIIlIlllllIll(lllllllllllllllllllIIIllllllIlIl) && S.lIIlIlllllIIl(lllllllllllllllllllIIIllllllIlIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            AccBuilderShamans.c = lIllIIllII[lIllIIllIl[4]];
                            a.a(lllllllllllllllllllIIIllllllIlIl);
                        }
                        if (S.lIIlIlllllIll(lllllllllllllllllllIIIllllllIlIl) && S.lIIlIllllIlll(lllllllllllllllllllIIIllllllIlIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static void lIIlIllllIlII() {
        ...
        S.lIllIIllII[S.lIllIIllIl[0]] = S.lIIlIllllIIIl("VVIqLlu3IY7esBH7xrDoGw==", "tKKdp");
        S.lIllIIllII[S.lIllIIllIl[1]] = S.lIIlIllllIIlI("ISI4GwkPLjJSGBIyPxwdRyIiFxcUZ3YBDQ4/NRoTCSx2EBsEIHYGFUcmMx4fAmsiABsOJT8cHQ==", "gKVrz");
        S.lIllIIllII[S.lIllIIllIl[4]] = S.lIIlIllllIIlI("BhYnHigpAzgZKGgDPlctKRk6", "HwQwO");
        S.lIllIIllII[S.lIllIIllIl[5]] = S.lIIlIllllIIIl("N3guYUSOY5rkaiTRe8AiZaYQP871bdac", "Timhf");
        S.lIllIIllII[S.lIllIIllIl[7]] = S.lIIlIllllIIll("v3pDEakC4hI4il9WfOTEwqFKYKmhN6il1xuqGLWxPIUHeYrvGPVUkRHYinYvl02e", "dTkHE");
        S.lIllIIllII[S.lIllIIllIl[11]] = S.lIIlIllllIIIl("5JM9+u1bMe2Jneq7fGxIYg==", "nnCPz");
        S.lIllIIllII[S.lIllIIllIl[15]] = S.lIIlIllllIIlI("FRYkNgpmESI6Cy8WICE=", "FbASf");
        S.lIllIIllII[S.lIllIIllIl[16]] = S.lIIlIllllIIIl("LlmFvoedcAn8oVTZWzC9Sd6flyWInTVn", "ifkAk");
        S.lIllIIllII[S.lIllIIllIl[19]] = S.lIIlIllllIIll("kjzx+mGm6KU=", "LQKfG");
        S.lIllIIllII[S.lIllIIllIl[22]] = S.lIIlIllllIIlI("JBQ9GCQdEnEHIlMWPgRtEgc0Eg==", "suQsM");
        S.lIllIIllII[S.lIllIIllIl[23]] = S.lIIlIllllIIIl("qY9nuAO8j4NyMtjEMPJqzA==", "ojRAW");
        S.lIllIIllII[S.lIllIIllIl[24]] = S.lIIlIllllIIlI("Egsd", "Qdjft");
        S.lIllIIllII[S.lIllIIllIl[25]] = S.lIIlIllllIIIl("RwouyQiulJQ=", "GkDTp");
        S.lIllIIllII[S.lIllIIllIl[26]] = S.lIIlIllllIIll("L4/Gr2NTRqo=", "QGFpK");
        S.lIllIIllII[S.lIllIIllIl[27]] = S.lIIlIllllIIll("Bz56dnve0Lo=", "WtSHb");
        S.lIllIIllII[S.lIllIIllIl[14]] = S.lIIlIllllIIIl("APbW0jk4D7sHL5cM0XtAti0XvQywNxRs", "aWDbA");
        S.lIllIIllII[S.lIllIIllIl[28]] = S.lIIlIllllIIll("TtxBuF528RQARkBY0+/trw==", "eOKCE");
        S.lIllIIllII[S.lIllIIllIl[29]] = S.lIIlIllllIIlI("", "gNOQa");
        S.lIllIIllII[S.lIllIIllIl[32]] = S.lIIlIllllIIIl("SG+Bt6c2KDohXvKwqzzGLw==", "OsRxH");
        S.lIllIIllII[S.lIllIIllIl[33]] = S.lIIlIllllIIIl("CsOSLP/XT6T1eGFy/v3+sQ==", "VumVb");
        S.lIllIIllII[S.lIllIIllIl[20]] = S.lIIlIllllIIll("y0KI5Octul4=", "eFoZB");
        S.lIllIIllII[S.lIllIIllIl[34]] = S.lIIlIllllIIll("TXoGW8FKqNYinguZPhgpmg==", "AWDxA");
        S.lIllIIllII[S.lIllIIllIl[35]] = S.lIIlIllllIIlI("NDU2FBtHMjAYGg41MgM=", "gASqw");
        S.lIllIIllII[S.lIllIIllIl[36]] = S.lIIlIllllIIIl("e4GHYIPxE3E=", "mavBh");
        S.lIllIIllII[S.lIllIIllIl[37]] = S.lIIlIllllIIIl("I9He9jtyQvhnYcNsOWmygXHapOiDCcqC", "dxyhA");
        S.lIllIIllII[S.lIllIIllIl[38]] = S.lIIlIllllIIIl("gimMGoRwwHp44WXJgiMJFdfqQmhCuVFA", "PPwpx");
        S.lIllIIllII[S.lIllIIllIl[39]] = S.lIIlIllllIIll("vdJfD6w56y4=", "yOPpl");
        S.lIllIIllII[S.lIllIIllIl[40]] = S.lIIlIllllIIlI("BzwTCgs=", "PUvfo");
        S.lIllIIllII[S.lIllIIllIl[41]] = S.lIIlIllllIIIl("VT3LhBcKHzw=", "STGAm");
        S.lIllIIllII[S.lIllIIllIl[43]] = S.lIIlIllllIIIl("88/s5vaNnfI=", "UlikZ");
        S.lIllIIllII[S.lIllIIllIl[2]] = S.lIIlIllllIIIl("FLxphHhHsU0=", "ovLZd");
        S.lIllIIllII[S.lIllIIllIl[46]] = S.lIIlIllllIIIl("jj8ms577DwM=", "yEJxN");
        S.lIllIIllII[S.lIllIIllIl[48]] = S.lIIlIllllIIll("+At69z4Lx/0=", "nFAzi");
        S.lIllIIllII[S.lIllIIllIl[50]] = S.lIIlIllllIIIl("XlQZWb/FfFE=", "TZfkX");
        S.lIllIIllII[S.lIllIIllIl[52]] = S.lIIlIllllIIIl("eD4Mqflb4qg=", "qAlIl");
        S.lIllIIllII[S.lIllIIllIl[59]] = S.lIIlIllllIIll("o5yhFqYgSv32E3+poiP1wA==", "PDyxy");
        S.lIllIIllII[S.lIllIIllIl[60]] = S.lIIlIllllIIlI("Mz8+", "pPIXo");
    }
    ...
    public int ad() {
        ...
        catch (Exception lllllllllllllllllllIIIlllllIllIl) {
            lllllllllllllllllllIIIlllllIllIl.printStackTrace();
        }
        if (-"   ".length() > 0) {
            return (0xE4 ^ 0x94 ^ (0x6D ^ 0x45)) & (47 + 190 - 197 + 215 ^ 64 + 44 - -36 + 23 ^ -" ".length());
        }
        return lIllIIllIl[0];
    }
    ...
    public static void ak() {
        ...
        if (S.lIIlIllllIlll(cG.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (S.lIIlIlllllllI(Players.getLocal().getInteracting())) {
                NPC lllllllllllllllllllIIIllllllIIlI = NPCs.getNearest(nPC -> {
                    int n2;
                ...
                List lllllllllllllllllllIIIllllllIIIl = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                    boolean bl;
                    if (S.lIIllIIIIIIIl(nPC.getInteracting(), Players.getLocal())) {
                        bl = lIllIIllIl[1];
                        "".length();
                        if (-"   ".length() > 0) {
                            return ((0x16 ^ 0xA ^ (0x58 ^ 0x5C)) & (0x3E ^ 0x1B ^ (1 ^ 0x3C) ^ -" ".length())) != 0;
                        }
                    } else {
                        bl = lIllIIllIl[0];
                    }
                ...
                if (S.lIIlIlllllIIl(lllllllllllllllllllIIIllllllIIIl.isEmpty() ? 1 : 0)) {
                    ((NPC)lllllllllllllllllllIIIllllllIIIl.get(lIllIIllIl[0])).interact(lIllIIllII[lIllIIllIl[26]]);
                    Time.sleepTicks((int)lIllIIllIl[4]);
                    "".length();
                }
                if (S.lIIlIlllllIll(lllllllllllllllllllIIIllllllIIlI) && S.lIIlIlllllIIl(Players.getLocal().isMoving() ? 1 : 0) && S.lIIlIllllIlll(lllllllllllllllllllIIIllllllIIIl.isEmpty() ? 1 : 0)) {
                    lllllllllllllllllllIIIllllllIIlI.interact(lIllIIllII[lIllIIllIl[27]]);
                    Time.sleepTicks((int)lIllIIllIl[4]);
                    "".length();
                }
            }
