...
implements K {
    ...
    public static boolean al() {
        ...
        if (V.lIIlIIlllIIIl(Inventory.getCount((int[])nArray))) {
            ...
            if (V.lIIlIIlllIIIl(Inventory.getCount((int[])nArray2))) {
                n2 = lIlIlllIII[1];
                "".length();
                if (((0x37 ^ 0x32) & ~(0x92 ^ 0x97)) >= -" ".length()) return n2 != 0;
                return ((0x92 ^ 0xA9) & ~(0x1D ^ 0x26)) != 0;
            }
        }
        n2 = lIlIlllIII[0];
        return n2 != 0;
    ...
    public static void O() {
        d lllllllllllllllllllIlIIIlIIIlIIl;
        Object lllllllllllllllllllIlIIIlIIIlIlI;
        int[] nArray = new int[lIlIlllIII[1]];
        nArray[V.lIlIlllIII[0]] = lIlIlllIII[7];
        ...
        if (V.lIIlIIlllIIII(Bank.contains((int[])nArray2) ? 1 : 0)) {
            ...
            lllllllllllllllllllIlIIIlIIIlIlI = new d(lIlIlllIII[8], lIlIlllIII[1], lIlIlllIII[36]);
            bp.add((d)lllllllllllllllllllIlIIIlIIIlIlI);
            "".length();
        }
        if (V.lIIlIIlllIIII(Bank.contains(lllllllllllllllllllIlIIIlIIIlIlI = item -> item.getName().toLowerCase().contains(lIlIllIlll[lIlIlllIII[45]])) ? 1 : 0)) {
            lllllllllllllllllllIlIIIlIIIlIIl = new d(lIlIlllIII[37], lIlIlllIII[9], lIlIlllIII[38]);
            bp.add(lllllllllllllllllllIlIIIlIIIlIIl);
            "".length();
        }
        int[] nArray3 = new int[lIlIlllIII[1]];
        nArray3[V.lIlIlllIII[0]] = lIlIlllIII[39];
        if (V.lIIlIIlllIIII(Bank.contains((int[])nArray3) ? 1 : 0)) {
            lllllllllllllllllllIlIIIlIIIlIIl = new d(lIlIlllIII[39], lIlIlllIII[40], lIlIlllIII[41]);
            bp.add(lllllllllllllllllllIlIIIlIIIlIIl);
            "".length();
        }
    }
    ...
    private static String lIIlIIllIlIIl(String lllllllllllllllllllIlIIIIlIllIlI, String lllllllllllllllllllIlIIIIlIllIIl) {
        try {
            SecretKeySpec lllllllllllllllllllIlIIIIlIlllll = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIlIIIIlIllIIl.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            ...
            return new String(lllllllllllllllllllIlIIIIlIllllI.doFinal(Base64.getDecoder().decode(lllllllllllllllllllIlIIIIlIllIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIIlIIllIlIlI(String lllllllllllllllllllIlIIIIllIllII, String lllllllllllllllllllIlIIIIllIlIll) {
        lllllllllllllllllllIlIIIIllIllII = new String(Base64.getDecoder().decode(lllllllllllllllllllIlIIIIllIllII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllllIlIIIIllIllll = new StringBuilder();
        char[] lllllllllllllllllllIlIIIIllIlllI = lllllllllllllllllllIlIIIIllIlIll.toCharArray();
        int lllllllllllllllllllIlIIIIllIllIl = lIlIlllIII[0];
        char[] lllllllllllllllllllIlIIIIllIIlll = lllllllllllllllllllIlIIIIllIllII.toCharArray();
        int lllllllllllllllllllIlIIIIllIIllI = lllllllllllllllllllIlIIIIllIIlll.length;
        int lllllllllllllllllllIlIIIIllIIlIl = lIlIlllIII[0];
        while (V.lIIlIIllIllll(lllllllllllllllllllIlIIIIllIIlIl, lllllllllllllllllllIlIIIIllIIllI)) {
            char lllllllllllllllllllIlIIIIlllIIlI = lllllllllllllllllllIlIIIIllIIlll[lllllllllllllllllllIlIIIIllIIlIl];
            lllllllllllllllllllIlIIIIllIllll.append((char)(lllllllllllllllllllIlIIIIlllIIlI ^ lllllllllllllllllllIlIIIIllIlllI[lllllllllllllllllllIlIIIIllIllIl % lllllllllllllllllllIlIIIIllIlllI.length]));
            "".length();
    ...
    private static void lIIlIIllIllIl() {
        ...
        V.lIlIlllIII[0] = (3 + 56 - -80 + 72 ^ 15 + 43 - -86 + 12) & (0xDC ^ 0x9A ^ (0xB9 ^ 0xB0) ^ -" ".length());
        V.lIlIlllIII[1] = " ".length();
        V.lIlIlllIII[2] = 0xFFFFE7F7 & 0x1BEB;
        V.lIlIlllIII[3] = "  ".length();
        V.lIlIlllIII[4] = "   ".length();
        ...
        V.lIlIlllIII[45] = 0x93 ^ 0x8B ^ " ".length();
    ...
    public static void dr() {
        block29: {
            BankLocation lllllllllllllllllllIlIIIlIIIlllI;
            block31: {
                block34: {
                    block33: {
                        block32: {
                            ...
                            if (V.lIIlIIlllIIlI(lllllllllllllllllllIlIIIlIIIlllI = BankLocation.getNearest()) && V.lIIlIIlllIIII(lllllllllllllllllllIlIIIlIIIlllI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                AccBuilderShamans.c = lIlIllIlll[lIlIlllIII[3]];
                                a.a(lllllllllllllllllllIlIIIlIIIlllI);
                            }
                            if (!V.lIIlIIlllIIlI(lllllllllllllllllllIlIIIlIIIlllI) || !V.lIIlIIllIlllI(lllllllllllllllllllIlIIIlIIIlllI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block31;
                    ...
                    if (V.lIIlIIllIllll(Inventory.getCount((int[])nArray4), lIlIlllIII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (V.lIIlIIlllIIIl(Inventory.getCount((int[])nArray))) {
                                bl = lIlIlllIII[1];
                                "".length();
                                if (" ".length() == ((122 + 4 - 3 + 89 ^ 59 + 9 - 7 + 133) & (0x5D ^ 0x45 ^ (0xBC ^ 0xB2) ^ -" ".length()))) {
                                    return ((133 + 146 - 241 + 143 ^ 111 + 85 - 103 + 41) & (0x24 ^ 0x61 ^ (0x5D ^ 0x2B) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIlIlllIII[0];
                            }
                        ...
                        if (V.lIIlIIlllIIIl(Inventory.getCount((int[])nArray7))) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (V.lIIlIIlllIIIl(Inventory.getCount((int[])nArray))) {
                                    bl = lIlIlllIII[1];
                                    "".length();
                                    if (-" ".length() > ((86 + 131 - 189 + 105 ^ 95 + 13 - 87 + 108) & (93 + 46 - 119 + 153 ^ 10 + 58 - -6 + 95 ^ -" ".length()))) {
                                        return ((0x3A ^ 0x63 ^ (0x21 ^ 0x2F)) & (199 + 34 - 125 + 124 ^ 5 + 87 - -49 + 50 ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlIlllIII[0];
                                }
            ...
            if (V.lIIlIIllIlllI(V.al() ? 1 : 0)) {
                ...
                if (V.lIIlIIlllIIII(Bank.isOpen() ? 1 : 0) && V.lIIlIIlllIIII(Players.getLocal().isAnimating() ? 1 : 0)) {
                    ...
                    if (V.lIIlIIlllIIII(Production.isOpen() ? 1 : 0)) {
                        ...
                        int[] nArray = new int[lIlIlllIII[1]];
                        nArray[V.lIlIlllIII[0]] = lIlIlllIII[8];
                        lllllllllllllllllllIlIIIlIIIlllI = Inventory.getFirst((int[])nArray);
                        int[] nArray8 = new int[lIlIlllIII[1]];
                        nArray8[V.lIlIlllIII[0]] = lIlIlllIII[7];
                        Item lllllllllllllllllllIlIIIlIIIllIl = Inventory.getFirst((int[])nArray8);
                        if (V.lIIlIIlllIIlI(lllllllllllllllllllIlIIIlIIIlllI) && V.lIIlIIlllIIlI(lllllllllllllllllllIlIIIlIIIllIl)) {
                            lllllllllllllllllllIlIIIlIIIlllI.useOn(lllllllllllllllllllIlIIIlIIIllIl);
                        ...
                        if (V.lIIlIIlllIIll(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlllIII[6]) && V.lIIlIIllIllll(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlllIII[14])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!V.lIIlIIlllIIll(Inventory.getCount((int[])nArray), lIlIlllIII[1]) || V.lIIlIIllIlllI(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if ("  ".length() <= 0) {
                                        return ((0x4E ^ 0x13 ^ (0x25 ^ 0x36)) & (0xB6 ^ 0x90 ^ (0xD2 ^ 0xBA) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlIlllIII[0];
                                }
                        ...
                        if (V.lIIlIIlllIIll(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlllIII[16]) && V.lIIlIIllIllll(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlllIII[19])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!V.lIIlIIlllIIll(Inventory.getCount((int[])nArray), lIlIlllIII[1]) || V.lIIlIIllIlllI(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (-" ".length() < -" ".length()) {
                                        return ((52 + 128 - 32 + 0 ^ 10 + 33 - -112 + 5) & (0xFC ^ 0x9F ^ (0xD1 ^ 0x86) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlIlllIII[0];
                                }
                        ...
                        if (V.lIIlIIlllIIll(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlllIII[19]) && V.lIIlIIllIllll(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlllIII[21])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!V.lIIlIIlllIIll(Inventory.getCount((int[])nArray), lIlIlllIII[1]) || V.lIIlIIllIlllI(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (null != null) {
                                        return ((0x5F ^ 0xF ^ (0x3B ^ 0x5C)) & (0x92 ^ 0x97 ^ (0x84 ^ 0xB6) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlIlllIII[0];
                                }
                        ...
                        if (V.lIIlIIlllIIll(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlllIII[21]) && V.lIIlIIllIllll(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlllIII[24])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!V.lIIlIIlllIIll(Inventory.getCount((int[])nArray), lIlIlllIII[1]) || V.lIIlIIllIlllI(Dialog.isOpen() ? 1 : 0)) {
                                    bl = lIlIlllIII[1];
                                    "".length();
                                    if (((0xB5 ^ 0xBD ^ (0x1D ^ 0x25)) & (98 + 24 - 63 + 116 ^ 134 + 111 - 204 + 118 ^ -" ".length())) != 0) {
                                        return ((0x51 ^ 0x68 ^ (0x2D ^ 0x2A)) & (0xB0 ^ 0xB7 ^ (0x4F ^ 0x76) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlIlllIII[0];
                                }
                        ...
                        if (V.lIIlIIlllIIll(Skills.getLevel((Skill)Skill.CRAFTING), lIlIlllIII[27])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!V.lIIlIIlllIIll(Inventory.getCount((int[])nArray), lIlIlllIII[1]) || V.lIIlIIllIlllI(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    "".length();
                                    if (null != null) {
                                        return ((0xC8 ^ 0xB3 ^ (0x41 ^ 0x16)) & (0x6E ^ 0x5F ^ (0xF ^ 0x12) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIlIlllIII[0];
                                }
    ...
    private static void lIIlIIllIllII() {
        ...
        V.lIlIllIlll[V.lIlIlllIII[0]] = V.lIIlIIllIlIIl("lhp1HwzXjzkHAa+APpK+3g==", "paFiC");
        V.lIlIllIlll[V.lIlIlllIII[1]] = V.lIIlIIllIlIlI("EB0iJwQ+EShuFSMNJSAQdh04KxolWGw9AD8ALyYeOBNsLBY1H2w6GHYXPi8RIh0iKQ==", "VtLNw");
        V.lIlIllIlll[V.lIlIlllIII[3]] = V.lIIlIIllIlIll("utxTkIyHY9XuqwshNjMv+2A6mm0ED5J3", "Jrmha");
        V.lIlIllIlll[V.lIlIlllIII[4]] = V.lIIlIIllIlIlI("BT4rDSckKW4BLyQl", "JNNcN");
        V.lIlIllIlll[V.lIlIlllIII[6]] = V.lIIlIIllIlIlI("PCQ2CgUdKz9OCxUrMwcHEw==", "tEXni");
        V.lIlIllIlll[V.lIlIlllIII[9]] = V.lIIlIIllIlIIl("A0VT3D4Af5sNAKyHJiEkS2odqQ8tZ8Dcn4sveFKhVGr1X7Ml9/lxXAhIAhtC1IUm", "ZEBme");
        V.lIlIllIlll[V.lIlIlllIII[10]] = V.lIIlIIllIlIll("PY4D0wIuIWBsCOP2mHBnrw==", "cxSrk");
        V.lIlIllIlll[V.lIlIlllIII[11]] = V.lIIlIIllIlIlI("OhU2ISMQCTBnMBUGJDQ=", "ygWGW");
        V.lIlIllIlll[V.lIlIlllIII[12]] = V.lIIlIIllIlIll("16WbZfqCrwAi+evc6pY0iA==", "cAYqL");
        V.lIlIllIlll[V.lIlIlllIII[15]] = V.lIIlIIllIlIIl("ZSpBjiD3sf1o1WmA5CqPXG4GAiO29BBl", "jVaQn");
        V.lIlIllIlll[V.lIlIlllIII[17]] = V.lIIlIIllIlIlI("ECIAKTE6PgZvKTI9EQ==", "SPaOE");
        V.lIlIllIlll[V.lIlIlllIII[18]] = V.lIIlIIllIlIlI("KTAPcSEHNBM=", "fYcQM");
        V.lIlIllIlll[V.lIlIlllIII[14]] = V.lIIlIIllIlIll("AqEJPJGa9+DQ01Pq5B10/Q==", "Lwsyn");
        V.lIlIllIlll[V.lIlIlllIII[20]] = V.lIIlIIllIlIlI("HiULPg==", "HLjRn");
        V.lIlIllIlll[V.lIlIlllIII[22]] = V.lIIlIIllIlIlI("CigFDD4gNANKLCApDAglPjY=", "IZdjJ");
        V.lIlIllIlll[V.lIlIlllIII[23]] = V.lIIlIIllIlIIl("eUZfaDTECHpx60XCLzacLA==", "nlSXg");
        V.lIlIllIlll[V.lIlIlllIII[25]] = V.lIIlIIllIlIlI("IBYpDi4KCi9INREG", "cdHhZ");
        V.lIlIllIlll[V.lIlIlllIII[26]] = V.lIIlIIllIlIll("n5IZRvd+FybmsNL8Wczg5TIhrWnLYGw0", "DrGAM");
        V.lIlIllIlll[V.lIlIlllIII[28]] = V.lIIlIIllIlIll("qpJOE2u2miqY8749LqGtFw==", "bhfqU");
        V.lIlIllIlll[V.lIlIlllIII[29]] = V.lIIlIIllIlIlI("OTUJBjUHOkceNRsn", "uTgrP");
        V.lIlIllIlll[V.lIlIlllIII[30]] = V.lIIlIIllIlIIl("mwN0YBdeJRQu2kt+w2NdjyAQM78aDLnd", "mcDwh");
        V.lIlIllIlll[V.lIlIlllIII[31]] = V.lIIlIIllIlIll("iUWcN6hlDgiDwkY1KeOoRw==", "dYUvC");
        V.lIlIllIlll[V.lIlIlllIII[32]] = V.lIIlIIllIlIll("JYujHd+fhzIoF89rH7S12ugVPrvz/7m9", "TsZjO");
        V.lIlIllIlll[V.lIlIlllIII[35]] = V.lIIlIIllIlIll("wFqe1FKKPNNmu9Y2y1XRjkgdVGPcqaFTCBqeQgBj7Bs=", "gpGqX");
        V.lIlIllIlll[V.lIlIlllIII[43]] = V.lIIlIIllIlIll("6WVYg8/8rO62P+paxxTkpQ==", "udmWy");
        V.lIlIllIlll[V.lIlIlllIII[45]] = V.lIIlIIllIlIll("RiVp8Fmt1tukxq5oUd/kqZNH+ax4uOv+", "aIiWj");
    }
