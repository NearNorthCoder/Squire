...
implements K {
    ...
    public int ad() {
        ...
        if (((0x42 ^ 0xC ^ (0xD0 ^ 0xBB)) & (0xE1 ^ 0xB6 ^ (0xEC ^ 0x9E) ^ -" ".length())) == "  ".length()) {
            return (0x6F ^ 0x5F ^ " ".length()) & (0x10 ^ 0x7A ^ (0xF7 ^ 0xAC) ^ -" ".length());
        }
    ...
    private static void lIIllllIIIIII() {
        ...
        E.lIlllIlIll[1] = " ".length();
        E.lIlllIlIll[2] = 98 + 32 - 58 + 60 ^ 10 + 106 - 30 + 42;
        E.lIlllIlIll[3] = 0x31 ^ 0x2C;
        E.lIlllIlIll[4] = "  ".length();
        E.lIlllIlIll[5] = "   ".length();
        ...
        if (E.lIIllllIIIllI(Inventory.getCount((int[])nArray))) {
            ...
            if (E.lIIllllIIIllI(Inventory.getCount((int[])nArray2))) {
                ...
                if (E.lIIllllIIIllI(Inventory.getCount((int[])nArray3))) {
                    n2 = lIlllIlIll[1];
                    "".length();
                    if (((0x94 ^ 0xA5 ^ (0xC0 ^ 0xC7)) & (0xAA ^ 0x82 ^ (0x7C ^ 0x62) ^ -" ".length())) >= 0) return n2 != 0;
                    return ((0xAC ^ 0x87 ^ (0x45 ^ 0x25)) & (88 + 77 - 68 + 39 ^ 88 + 97 - 99 + 109 ^ -" ".length())) != 0;
                }
            }
        }
        n2 = lIlllIlIll[0];
    ...
    private static void lIIlllIllllll() {
        ...
        E.lIlllIlIlI[E.lIlllIlIll[0]] = E.lIIlllIllllII("OzA8LAMeZSwxCBQ2", "yEEEm");
        E.lIlllIlIlI[E.lIlllIlIll[1]] = E.lIIlllIllllIl("SpA/7bW1szhjTh9w/81DesiMH7/+OxTcaWqHTq4UE3MN/H0XmTbm0Npyk5pP7VFE", "DeEWG");
        E.lIlllIlIlI[E.lIlllIlIll[4]] = E.lIIlllIlllllI("2yIIiw8iTvdLkEicG0QEow==", "hFghD");
        E.lIlllIlIlI[E.lIlllIlIll[5]] = E.lIIlllIllllIl("hLraILDQDQMlCvK+dZxKVsf5HUonwFhN", "nUxxC");
        E.lIlllIlIlI[E.lIlllIlIll[2]] = E.lIIlllIllllIl("+6jyGL+gnColf5XFFszM/lJThur7HWSepzPy7Cjj1SQNG4Fqvm2Zyt+LJAPxiqwy+OArJkOka2w=", "cyTHZ");
        E.lIlllIlIlI[E.lIlllIlIll[11]] = E.lIIlllIllllIl("GcDud4SUNxvK+14Z9gfGDQ==", "HJOIP");
        E.lIlllIlIlI[E.lIlllIlIll[12]] = E.lIIlllIlllllI("dZPdaOqltx2/1JRz36Gebg==", "bOmAf");
        E.lIlllIlIlI[E.lIlllIlIll[13]] = E.lIIlllIllllIl("ZqqKq6iEUAo=", "GUzHz");
        E.lIlllIlIlI[E.lIlllIlIll[22]] = E.lIIlllIlllllI("3O5sBYeiYV3Y8keVscFbb3Xouq4DzjEv", "wiBPZ");
        E.lIlllIlIlI[E.lIlllIlIll[23]] = E.lIIlllIllllIl("5NmQSHOHMHbf9lLrwgZvo0MU22LRgPV1", "WIoRW");
        E.lIlllIlIlI[E.lIlllIlIll[14]] = E.lIIlllIlllllI("BhIIhkBBWoE0BBTWOOeQB8RVuQdUEhEy", "uHOBD");
        E.lIlllIlIlI[E.lIlllIlIll[26]] = E.lIIlllIlllllI("6pLwe8duIm2IDqFir3XRBMTdnUzGpPTXApb/QXWZ9Pu8+JJMNWIEiIwUh/gynvXs", "FZtKj");
        E.lIlllIlIlI[E.lIlllIlIll[27]] = E.lIIlllIlllllI("s/jmwXcUHnRqkGVz1mzOE0RRfPH0iLfIZ+BcRZJIO2F0BG1Zu0QDRRCm6dIAgtad", "wsxDI");
        E.lIlllIlIlI[E.lIlllIlIll[28]] = E.lIIlllIlllllI("vtWqG2dDDjk=", "PPzvi");
        E.lIlllIlIlI[E.lIlllIlIll[29]] = E.lIIlllIllllIl("fjiyEdpbIegzZbfpx3tAxA==", "GdFeM");
    }
