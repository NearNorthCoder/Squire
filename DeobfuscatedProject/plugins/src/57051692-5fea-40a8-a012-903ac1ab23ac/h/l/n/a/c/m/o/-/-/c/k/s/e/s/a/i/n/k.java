...
implements K {
    ...
    private static void ab() {
        NPC lllllllllllllllllllIIlIlllllIIlI;
        NPC lllllllllllllllllllIIlIlllllIIll;
        void lllllllllllllllllllIIlIlllllIllI;
        ...
        if (k.lIIlIlIllIIII(lllllllllllllllllllIIlIlllllIllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            void lllllllllllllllllllIIlIlllllIlIl;
            AccBuilderShamans.c = lIllIIIIlI[lIllIIIIll[20]];
            lllllllllllllllllllIIlIlllllIIll = new WorldArea(lIllIIIIll[21], lIllIIIIll[22], lIllIIIIll[23], lIllIIIIll[24], lIllIIIIll[1]);
            if (k.lIIlIlIllIIII(lllllllllllllllllllIIlIlllllIIll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                lllllllllllllllllllIIlIlllllIIlI = new WorldPoint(lIllIIIIll[25], lIllIIIIll[26], lIllIIIIll[1]);
                if (k.lIIlIlIllIllI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllllllllllllllllIIlIlllllIIlI), lIllIIIIll[27])) {
                    Movement.walkTo((WorldPoint)lllllllllllllllllllIIlIlllllIIlI);
                    "".length();
                    Time.sleepTicks((int)lIllIIIIll[0]);
                    "".length();
                }
                if (k.lIIlIlIllIlll(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lllllllllllllllllllIIlIlllllIIlI), lIllIIIIll[27])) {
            ...
            if (k.lIIlIlIllIIlI(lllllllllllllllllllIIlIlllllIIll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && k.lIIlIlIllIIII(lllllllllllllllllllIIlIlllllIlIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                void lllllllllllllllllllIIlIlllllIlII;
                Movement.walkTo((WorldPoint)lllllllllllllllllllIIlIlllllIlII);
                "".length();
                Time.sleepTicks((int)lIllIIIIll[0]);
                "".length();
            }
            if (k.lIIlIlIllIIlI(lllllllllllllllllllIIlIlllllIlIl.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                lllllllllllllllllllIIlIlllllIIlI = TileObjects.getNearest(arg_0 -> k.a((WorldArea)lllllllllllllllllllIIlIlllllIlIl, arg_0));
                if (k.lIIlIlIlllIII(lllllllllllllllllllIIlIlllllIIlI)) {
                    ...
                    WorldPoint[] lllllllllllllllllllIIlIlllllIIIl = worldPointArray;
                    Walker.walkAlong(Arrays.asList(lllllllllllllllllllIIlIlllllIIIl), new HashMap());
                    "".length();
                }
                if (k.lIIlIlIllIIIl(lllllllllllllllllllIIlIlllllIIlI)) {
                    lllllllllllllllllllIIlIlllllIIlI.interact(lIllIIIIlI[lIllIIIIll[27]]);
                    Time.sleepTicks((int)lIllIIIIll[20]);
                    "".length();
                }
            }
        }
        if (k.lIIlIlIllIIlI(lllllllllllllllllllIIlIlllllIllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            if (k.lIIlIlIlllIII(Players.getLocal().getInteracting())) {
                AccBuilderShamans.c = lIllIIIIlI[lIllIIIIll[34]];
                lllllllllllllllllllIIlIlllllIIll = NPCs.getNearest(nPC -> {
                    int n2;
                    if (k.lIIlIlIllIIlI(nPC.getName().contains(lIllIIIIlI[lIllIIIIll[42]]) ? 1 : 0)) {
                        ...
                        if (k.lIIlIlIllIIlI(nPC.hasAction(stringArray) ? 1 : 0) && k.lIIlIlIllIIII(nPC.isDead() ? 1 : 0) && k.lIIlIlIlllIII(nPC.getInteracting())) {
                            n2 = lIllIIIIll[0];
                            "".length();
                            if (((0xF0 ^ 0x92) & ~(0x18 ^ 0x7A)) == (" ".length() & ~" ".length())) return n2 != 0;
                            return ((0x6A ^ 0x71) & ~(0xC ^ 0x17)) != 0;
                        }
                    }
                    n2 = lIllIIIIll[1];
                    return n2 != 0;
                });
                lllllllllllllllllllIIlIlllllIIlI = NPCs.getNearest(nPC -> {
                    int n2;
                    if (k.lIIlIlIllIIlI(nPC.getName().contains(lIllIIIIlI[lIllIIIIll[40]]) ? 1 : 0) && k.lIIlIlIllIIII(nPC.isDead() ? 1 : 0)) {
                        ...
                        if (k.lIIlIlIllIIlI(nPC.hasAction(stringArray) ? 1 : 0) && k.lIIlIlIlllIlI(nPC.getInteracting(), Players.getLocal())) {
                            n2 = lIllIIIIll[0];
                            "".length();
                            if (((66 + 9 - 54 + 142 ^ 118 + 102 - 107 + 28) & (113 + 70 - 168 + 113 ^ 157 + 67 - 157 + 107 ^ -" ".length())) == 0) return n2 != 0;
                            return ((88 + 8 - -14 + 106 ^ 136 + 95 - 182 + 137) & (40 + 139 - 175 + 158 ^ 78 + 168 - 189 + 135 ^ -" ".length())) != 0;
                        }
                    }
                    n2 = lIllIIIIll[1];
                    return n2 != 0;
                });
                if (k.lIIlIlIllIIIl(lllllllllllllllllllIIlIlllllIIll) && k.lIIlIlIlllIII(lllllllllllllllllllIIlIlllllIIlI)) {
                    AccBuilderShamans.c = lIllIIIIlI[lIllIIIIll[35]];
                    lllllllllllllllllllIIlIlllllIIll.interact(lIllIIIIlI[lIllIIIIll[36]]);
                    Time.sleepTicks((int)lIllIIIIll[10]);
                    "".length();
                }
                if (k.lIIlIlIllIIIl(lllllllllllllllllllIIlIlllllIIlI)) {
                    AccBuilderShamans.c = lIllIIIIlI[lIllIIIIll[7]];
                    lllllllllllllllllllIIlIlllllIIlI.interact(lIllIIIIlI[lIllIIIIll[13]]);
                    Time.sleepTicks((int)lIllIIIIll[20]);
                    "".length();
                }
            }
    ...
    public static void aa() {
        ...
        if (k.lIIlIlIllIIII(Inventory.contains((int[])nArray) ? 1 : 0)) {
            void lllllllllllllllllllIIllIIIIIIlIl;
            ...
            if (k.lIIlIlIllIIIl(lllllllllllllllllllIIllIIIIIIlIl) && k.lIIlIlIllIIlI(lllllllllllllllllllIIllIIIIIIlIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static void lIIlIlIlIllll() {
        ...
        k.lIllIIIIll[0] = " ".length();
        k.lIllIIIIll[1] = (6 + 35 - 17 + 138 ^ 26 + 133 - 104 + 86) & (61 + 41 - -4 + 54 ^ 10 + 66 - 14 + 81 ^ -" ".length());
    ...
    public boolean af() {
        ...
        if (k.lIIlIlIlllIIl(Skills.getLevel((Skill)Skill.RANGED), lIllIIIIll[39])) {
            ...
            "".length();
            if (null != null) {
                return ((0xA ^ 0x4A ^ (0xEB ^ 0xB8)) & (133 + 27 - 111 + 115 ^ 1 + 110 - -58 + 14 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIllIIIIll[1];
        }
    ...
    private static String lIIlIlIlIlIll(String lllllllllllllllllllIIlIlllIlIIlI, String lllllllllllllllllllIIlIlllIlIIIl) {
        try {
            SecretKeySpec lllllllllllllllllllIIlIlllIlIlIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIIlIlllIlIIIl.getBytes(StandardCharsets.UTF_8)), lIllIIIIll[35]), "DES");
            Cipher lllllllllllllllllllIIlIlllIlIlII = Cipher.getInstance("DES");
            lllllllllllllllllllIIlIlllIlIlII.init(lIllIIIIll[10], lllllllllllllllllllIIlIlllIlIlIl);
            return new String(lllllllllllllllllllIIlIlllIlIlII.doFinal(Base64.getDecoder().decode(lllllllllllllllllllIIlIlllIlIIlI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void lIIlIlIlIlllI() {
        ...
        k.lIllIIIIlI[k.lIllIIIIll[1]] = k.lIIlIlIlIlIll("zY+SfsV6tPUqwvIqcALfLebuhDfIo95d", "SwYVp");
        k.lIllIIIIlI[k.lIllIIIIll[0]] = k.lIIlIlIlIllII("EBIsIhkxHSVmFzkdKS8bPw==", "XsBFu");
        k.lIllIIIIlI[k.lIllIIIIll[10]] = k.lIIlIlIlIlIll("DESyfBqAnmQ=", "QIBuZ");
        k.lIllIIIIlI[k.lIllIIIIll[20]] = k.lIIlIlIlIllIl("aHtDGdCJlHWKziebeDrkmg==", "sFPMX");
        k.lIllIIIIlI[k.lIllIIIIll[28]] = k.lIIlIlIlIllII("Pg0lH0w6AyIATD0NIgcNAQ==", "mbPsl");
        k.lIllIIIIlI[k.lIllIIIIll[29]] = k.lIIlIlIlIlIll("HWPvipMU/C0=", "LAOeS");
        k.lIllIIIIlI[k.lIllIIIIll[27]] = k.lIIlIlIlIllIl("tjsBbgGWXi1cag1/bDd1Xg==", "ZtNno");
        k.lIllIIIIlI[k.lIllIIIIll[34]] = k.lIIlIlIlIllII("AjwkAh4tOyRKGSsgLxk=", "DUCjj");
        k.lIllIIIIlI[k.lIllIIIIll[35]] = k.lIIlIlIlIlIll("7wI+7KDf7eIpXXPOsQUgZg==", "FCVGk");
        k.lIllIIIIlI[k.lIllIIIIll[36]] = k.lIIlIlIlIllII("IAYZFgIK", "armwa");
        k.lIllIIIIlI[k.lIllIIIIll[7]] = k.lIIlIlIlIlIll("vHa9lcI42LVYTHANHp5J+A==", "NEqlI");
        k.lIllIIIIlI[k.lIllIIIIll[13]] = k.lIIlIlIlIllII("Bz8uNjEt", "FKZWR");
        k.lIllIIIIlI[k.lIllIIIIll[37]] = k.lIIlIlIlIllIl("AbGyafmGvWq0RkqMi3OUNw==", "iAGdb");
        k.lIllIIIIlI[k.lIllIIIIll[14]] = k.lIIlIlIlIllII("NyQRMDYFPwY5eSIkFjsq", "qKcWY");
        k.lIllIIIIlI[k.lIllIIIIll[40]] = k.lIIlIlIlIllIl("yGxPwOQf8O8=", "IlFvk");
        k.lIllIIIIlI[k.lIllIIIIll[41]] = k.lIIlIlIlIllIl("ui6K84RMio0=", "vKZcZ");
        k.lIllIIIIlI[k.lIllIIIIll[42]] = k.lIIlIlIlIllII("OAojOg==", "keVVn");
        k.lIllIIIIlI[k.lIllIIIIll[43]] = k.lIIlIlIlIllII("GQE1FTsz", "XuAtX");
        k.lIllIIIIlI[k.lIllIIIIll[44]] = k.lIIlIlIlIllII("EhUoLgIiADoi", "AaIGp");
    }

    private static String lIIlIlIlIllII(String lllllllllllllllllllIIlIllIllllIl, String lllllllllllllllllllIIlIlllIIIIIl) {
        lllllllllllllllllllIIlIllIllllIl = new String(Base64.getDecoder().decode(lllllllllllllllllllIIlIllIllllIl.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllllIIlIlllIIIIII = new StringBuilder();
        char[] lllllllllllllllllllIIlIllIllllll = lllllllllllllllllllIIlIlllIIIIIl.toCharArray();
        int lllllllllllllllllllIIlIllIlllllI = lIllIIIIll[1];
        char[] lllllllllllllllllllIIlIllIlllIII = lllllllllllllllllllIIlIllIllllIl.toCharArray();
        int lllllllllllllllllllIIlIllIllIlll = lllllllllllllllllllIIlIllIlllIII.length;
        int lllllllllllllllllllIIlIllIllIllI = lIllIIIIll[1];
        while (k.lIIlIlIlllIll(lllllllllllllllllllIIlIllIllIllI, lllllllllllllllllllIIlIllIllIlll)) {
            char lllllllllllllllllllIIlIlllIIIIll = lllllllllllllllllllIIlIllIlllIII[lllllllllllllllllllIIlIllIllIllI];
            lllllllllllllllllllIIlIlllIIIIII.append((char)(lllllllllllllllllllIIlIlllIIIIll ^ lllllllllllllllllllIIlIllIllllll[lllllllllllllllllllIIlIllIlllllI % lllllllllllllllllllIIlIllIllllll.length]));
            "".length();
            ++lllllllllllllllllllIIlIllIlllllI;
            ++lllllllllllllllllllIIlIllIllIllI;
            "".length();
