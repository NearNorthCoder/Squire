...
implements K {
    ...
    private static void lIIIIllllIllI() {
        ...
        J.lIlIIIIIIl[J.lIlIIIIIlI[0]] = J.lIIIIllllIIll("W3K3Ezn0zcS7ukGJc4+cpw==", "WIZMZ");
        J.lIlIIIIIIl[J.lIlIIIIIlI[1]] = J.lIIIIllllIlII("EhM5GzQ8HzNSJSEDPhwgdBMjFyonVncBMD0ONBouOh13ECY3EXcGKHQLIhc0IA==", "TzWrG");
        J.lIlIIIIIIl[J.lIlIIIIIlI[3]] = J.lIIIIllllIlIl("ekSH9I4jXyw=", "yVtkl");
        J.lIlIIIIIIl[J.lIlIIIIIlI[5]] = J.lIIIIllllIIll("+ieUGOuUs5k=", "osUdO");
        J.lIlIIIIIIl[J.lIlIIIIIlI[6]] = J.lIIIIllllIlII("FC83RwQ1biMGHjE=", "ZNAgp");
        J.lIlIIIIIIl[J.lIlIIIIIlI[7]] = J.lIIIIllllIIll("VMj99nE/ieRag2XxC0mMVl0FqhtDYXfx", "pttCF");
        J.lIlIIIIIIl[J.lIlIIIIIlI[9]] = J.lIIIIllllIlII("BgtUJCg0ThksKSIHGiJ6IBsRNi5xHQE1Kj0HETZ2cR0DLC4yBh0rPXEaG2UYBDc9Cx0=", "QntEZ");
        J.lIlIIIIIIl[J.lIlIIIIIlI[17]] = J.lIIIIllllIlII("PwIRcSAeQxQlNQMX", "qcgQT");
        J.lIlIIIIIIl[J.lIlIIIIIlI[18]] = J.lIIIIllllIIll("Jg0zxVMil70IRjtYXlc7xA==", "kiPDm");
        J.lIlIIIIIIl[J.lIlIIIIIlI[19]] = J.lIIIIllllIlIl("KNW8F270yFg=", "yhLVw");
        J.lIlIIIIIIl[J.lIlIIIIIlI[15]] = J.lIIIIllllIIll("4r/jHKuLVrw=", "KUUgQ");
        J.lIlIIIIIIl[J.lIlIIIIIlI[20]] = J.lIIIIllllIlII("JRMiBQEEEyJEARITKAge", "qaGdr");
        J.lIlIIIIIIl[J.lIlIIIIIlI[21]] = J.lIIIIllllIIll("5r+4E8PPA9U=", "aOPRk");
        J.lIlIIIIIIl[J.lIlIIIIIlI[22]] = J.lIIIIllllIlII("IwwrFQ==", "tiJgb");
        J.lIlIIIIIIl[J.lIlIIIIIlI[23]] = J.lIIIIllllIIll("OKsD+pXFoOEOvaGFIqe9gw==", "BaXwY");
        J.lIlIIIIIIl[J.lIlIIIIIlI[24]] = J.lIIIIllllIlIl("GvOdi2RzlcY=", "Nhosm");
        J.lIlIIIIIIl[J.lIlIIIIIlI[25]] = J.lIIIIllllIlII("Ly0w", "kDWcE");
        J.lIlIIIIIIl[J.lIlIIIIIlI[26]] = J.lIIIIllllIlIl("ef2QIx0Lsi+jwm20RC0gjg==", "TYxql");
        J.lIlIIIIIIl[J.lIlIIIIIlI[27]] = J.lIIIIllllIlII("Fxg0NB8=", "DhUPz");
        J.lIlIIIIIIl[J.lIlIIIIIlI[28]] = J.lIIIIllllIlII("KRkP", "mpheY");
        J.lIlIIIIIIl[J.lIlIIIIIlI[29]] = J.lIIIIllllIlII("DQc3ZxksRiUuCmNV", "CfAGm");
        J.lIlIIIIIIl[J.lIlIIIIIlI[30]] = J.lIIIIllllIlIl("GOHRjKOEmIM=", "NTocy");
        J.lIlIIIIIIl[J.lIlIIIIIlI[31]] = J.lIIIIllllIlIl("ctsk/cgYN7Y=", "rtloQ");
        J.lIlIIIIIIl[J.lIlIIIIIlI[32]] = J.lIIIIllllIlIl("kko4QLj8x+MLOx6OridqKg==", "JLqUS");
        J.lIlIIIIIIl[J.lIlIIIIIlI[33]] = J.lIIIIllllIlIl("APaBwszuTj4=", "TodJf");
        J.lIlIIIIIIl[J.lIlIIIIIlI[34]] = J.lIIIIllllIIll("WoWsy3sIq6w=", "FeRZX");
        J.lIlIIIIIIl[J.lIlIIIIIlI[35]] = J.lIIIIllllIlII("LQ8SbiIMThIrORBOAic4Ch0M", "cndNV");
        J.lIlIIIIIIl[J.lIlIIIIIlI[36]] = J.lIIIIllllIIll("EvvFkRsbCD42ZV4Vxkg+JA==", "iimKd");
        J.lIlIIIIIIl[J.lIlIIIIIlI[37]] = J.lIIIIllllIlIl("C/JtzqYdNM0=", "HWsMH");
        J.lIlIIIIIIl[J.lIlIIIIIlI[40]] = J.lIIIIllllIIll("TFPMHpZ5F+S1vVDKmMXThg==", "YfqkV");
        J.lIlIIIIIIl[J.lIlIIIIIlI[41]] = J.lIIIIllllIIll("RuEXEYk/H7k=", "JZppy");
        J.lIlIIIIIIl[J.lIlIIIIIlI[42]] = J.lIIIIllllIlIl("MRhRdLePp73ZwU5d/vHj1gdKYn1vqtzU", "qZXJP");
        J.lIlIIIIIIl[J.lIlIIIIIlI[43]] = J.lIIIIllllIlII("Pj8SPgYf", "mSsGc");
        J.lIlIIIIIIl[J.lIlIIIIIlI[44]] = J.lIIIIllllIlII("IT0rICwQPw==", "bREFE");
        J.lIlIIIIIIl[J.lIlIIIIIlI[45]] = J.lIIIIllllIlIl("43gjGXBNN84=", "WeIap");
        J.lIlIIIIIIl[J.lIlIIIIIlI[55]] = J.lIIIIllllIIll("eydP6i/NCI/OwFJbXArNX8ZsFjPoqmrO", "DZGRn");
        J.lIlIIIIIIl[J.lIlIIIIIlI[56]] = J.lIIIIllllIlII("Pjk3LnkjNnk+PC08LSF5ZA==", "LPYIY");
        J.lIlIIIIIIl[J.lIlIIIIIlI[57]] = J.lIIIIllllIIll("K9d+YxPD36A=", "Vkcav");
        J.lIlIIIIIIl[J.lIlIIIIIlI[58]] = J.lIIIIllllIIll("5XF231hSR/g=", "xwZYU");
        J.lIlIIIIIIl[J.lIlIIIIIlI[59]] = J.lIIIIllllIlII("LwopOjAw", "XoHVD");
        J.lIlIIIIIIl[J.lIlIIIIIlI[53]] = J.lIIIIllllIlII("HRo/Fy0=", "zvPeT");
        J.lIlIIIIIIl[J.lIlIIIIIlI[60]] = J.lIIIIllllIlIl("cnk/ZrlYlGs=", "RcCSm");
        J.lIlIIIIIIl[J.lIlIIIIIlI[61]] = J.lIIIIllllIIll("eKJZRVVZ2Sk=", "tzFVM");
        J.lIlIIIIIIl[J.lIlIIIIIlI[62]] = J.lIIIIllllIlII("OxxaSRFTGlYcKFQRGRt4FRlWCDwCEhgdLQYSWA==", "twviX");
        J.lIlIIIIIIl[J.lIlIIIIIlI[63]] = J.lIIIIllllIlIl("eLnBhAeYiHYIgLlzNjL7KHMz8rRgjZJ90802rJjhCMaY8XZRH/hsZw==", "vmghn");
        J.lIlIIIIIIl[J.lIlIIIIIlI[64]] = J.lIIIIllllIlII("Cys1PxkoZCk9HSI3ZyEXMzZnMB0qNGY=", "FDGXx");
        J.lIlIIIIIIl[J.lIlIIIIIlI[65]] = J.lIIIIllllIlII("AA4+aQ==", "YkMGU");
        J.lIlIIIIIIl[J.lIlIIIIIlI[66]] = J.lIIIIllllIlIl("hC+ya97nBq+UWdLo1AyNYuKKOpBHkJUOLLCGgekcs4E=", "EyMnU");
        J.lIlIIIIIIl[J.lIlIIIIIlI[67]] = J.lIIIIllllIlII("JAFuSCYOHmIFL0sCJwQ6Sx4qDSRF", "kjBhJ");
        J.lIlIIIIIIl[J.lIlIIIIIlI[68]] = J.lIIIIllllIlII("NQ0XPykBTCIyPhYPCHc/FgIXdyEWTBc4bAcNDzxsBwNDLiMGQg==", "slcWL");
        J.lIlIIIIIIl[J.lIlIIIIIlI[69]] = J.lIIIIllllIIll("7N/tLiwgelFKJG36B9QdEGwBFvdhTUwWO/igplF0djxvXReoaHGLCwnnMm9QBs/a", "GNeie");
        J.lIlIIIIIIl[J.lIlIIIIIlI[70]] = J.lIIIIllllIlIl("RukqMV4NMw1jmYQe9hVgKSiOwUuwGNXP0NbdcemCb/pXMsmnzXVwDA==", "psylT");
        J.lIlIIIIIIl[J.lIlIIIIIlI[71]] = J.lIIIIllllIlIl("uz+W3A5cydg=", "WUgbi");
        J.lIlIIIIIIl[J.lIlIIIIIlI[72]] = J.lIIIIllllIlII("CF4sRDkkGDMNICZZIApuIBQ0CCs1WS4CbiYRLhc6YQoxAS8qWA==", "AyAdN");
        J.lIlIIIIIIl[J.lIlIIIIIlI[73]] = J.lIIIIllllIlII("Ez8+a2gDfSBnOz8oKGk=", "JZMGH");
        J.lIlIIIIIIl[J.lIlIIIIIlI[48]] = J.lIIIIllllIlII("ERcOWRI4FlkwUTEdFQlO", "Yxyyq");
        J.lIlIIIIIIl[J.lIlIIIIIlI[74]] = J.lIIIIllllIlIl("7UgieFECSdmxv6hP1uL3Gbf7kwr5XyQZ5BS1SeSHA4Q=", "ptGYU");
        J.lIlIIIIIIl[J.lIlIIIIIlI[75]] = J.lIIIIllllIIll("JRN1jEixkMswdtb9/fUOgA==", "YbElc");
    }

    private static void lIIIIllllIlll() {
        lIlIIIIIlI = new int[89];
        J.lIlIIIIIlI[0] = (0x9A ^ 0xB2) & ~(1 ^ 0x29);
        J.lIlIIIIIlI[1] = " ".length();
        J.lIlIIIIIlI[2] = 0xCB ^ 0x8D;
        J.lIlIIIIIlI[3] = "  ".length();
        J.lIlIIIIIlI[4] = 0xFFFFE77F & 0x19FB;
        J.lIlIIIIIlI[5] = "   ".length();
        ...
        J.lIlIIIIIlI[75] = "  ".length() ^ (0x50 ^ 0x6B);
    ...
    private static String lIIIIllllIIll(String llllllllllllllllllllIllIIIlIlllI, String llllllllllllllllllllIllIIIlIlIll) {
        try {
            SecretKeySpec llllllllllllllllllllIllIIIllIIIl = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(llllllllllllllllllllIllIIIlIlIll.getBytes(StandardCharsets.UTF_8)), lIlIIIIIlI[18]), "DES");
            Cipher llllllllllllllllllllIllIIIllIIII = Cipher.getInstance("DES");
            llllllllllllllllllllIllIIIllIIII.init(lIlIIIIIlI[3], llllllllllllllllllllIllIIIllIIIl);
            return new String(llllllllllllllllllllIllIIIllIIII.doFinal(Base64.getDecoder().decode(llllllllllllllllllllIllIIIlIlllI.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIIIIllllIlIl(String llllllllllllllllllllIllIIIlllIll, String llllllllllllllllllllIllIIIlllIII) {
        try {
            SecretKeySpec llllllllllllllllllllIllIIIlllllI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(llllllllllllllllllllIllIIIlllIII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
    ...
    public int ad() {
        ...
        if (" ".length() >= "  ".length()) {
            return ("   ".length() ^ (0x89 ^ 0x86)) & (0x18 ^ 0x47 ^ (0x3C ^ 0x6F) ^ -" ".length());
        }
    ...
    private static String lIIIIllllIlII(String llllllllllllllllllllIllIIIIllllI, String llllllllllllllllllllIllIIIIllIII) {
        llllllllllllllllllllIllIIIIllllI = new String(Base64.getDecoder().decode(llllllllllllllllllllIllIIIIllllI.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder llllllllllllllllllllIllIIIIlllII = new StringBuilder();
        char[] llllllllllllllllllllIllIIIIllIll = llllllllllllllllllllIllIIIIllIII.toCharArray();
        int llllllllllllllllllllIllIIIIllIlI = lIlIIIIIlI[0];
        char[] llllllllllllllllllllIllIIIIlIlII = llllllllllllllllllllIllIIIIllllI.toCharArray();
        int llllllllllllllllllllIllIIIIlIIll = llllllllllllllllllllIllIIIIlIlII.length;
        int llllllllllllllllllllIllIIIIlIIlI = lIlIIIIIlI[0];
        while (J.lIIIIlllllIll(llllllllllllllllllllIllIIIIlIIlI, llllllllllllllllllllIllIIIIlIIll)) {
            char llllllllllllllllllllIllIIIIlllll = llllllllllllllllllllIllIIIIlIlII[llllllllllllllllllllIllIIIIlIIlI];
            llllllllllllllllllllIllIIIIlllII.append((char)(llllllllllllllllllllIllIIIIlllll ^ llllllllllllllllllllIllIIIIllIll[llllllllllllllllllllIllIIIIllIlI % llllllllllllllllllllIllIIIIllIll.length]));
            "".length();
            ++llllllllllllllllllllIllIIIIllIlI;
            ++llllllllllllllllllllIllIIIIlIIlI;
            "".length();
    ...
    public static void cL() {
        ...
        if (J.lIIIIllllllII(bn ? 1 : 0)) {
            block49: {
                BankLocation llllllllllllllllllllIllIIlIIlIlI;
                ...
                if (J.lIIIIllllllII(J.al() ? 1 : 0) && J.lIIIIllllllII(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()))) {
                    llllllllllllllllllllIllIIlIIlIlI = BankLocation.getNearest();
                    if (J.lIIIIllllllll(llllllllllllllllllllIllIIlIIlIlI) && J.lIIIIllllllII(llllllllllllllllllllIllIIlIIlIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderShamans.c = lIlIIIIIIl[lIlIIIIIlI[6]];
                        a.a(llllllllllllllllllllIllIIlIIlIlI);
                        Time.sleepTicks((int)lIlIIIIIlI[3]);
                        "".length();
                    }
                    if (J.lIIIIllllllll(llllllllllllllllllllIllIIlIIlIlI) && J.lIIIIlllllIlI(llllllllllllllllllllIllIIlIIlIlI.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (J.lIIIIllllllII(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId())) && J.lIIIIlllllIlI(J.al() ? 1 : 0)) {
                    ...
                    if (J.lIIIlIIIIIIIl(Players.getLocal().getWorldLocation().distanceTo(jl), lIlIIIIIlI[3])) {
                        ...
                        h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.g.a(lIlIIIIIIl[lIlIIIIIlI[15]], jk, lIlIIIIIlI[1]);
                    }
                }
                if (J.lIIIlIIIIIIlI(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()), lIlIIIIIlI[1])) {
                    ...
                    if (J.lIIIIllllllII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                        h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.g.a(jk);
                    }
                }
                ...
                if (J.lIIIlIIIIIIlI(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()), lIlIIIIIlI[9])) {
                    ...
                    if (J.lIIIlIIIIIIIl(Players.getLocal().getWorldLocation().distanceTo(jq), lIlIIIIIlI[5])) {
                        ...
                        h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.g.a(lIlIIIIIIl[lIlIIIIIlI[37]], jk);
                    }
                }
                ...
                do {
                    ...
                    if (J.lIIIIllllllll(Widgets.get((int)lIlIIIIIlI[39]))) {
                        Widget llllllllllllllllllllIllIIlIIlIIl;
                        ...
                        llllllllllllllllllllIllIIlIIlIlI = Widgets.get((int)lIlIIIIIlI[39], (int)lIlIIIIIlI[23]);
                        if (J.lIIIIllllllll(llllllllllllllllllllIllIIlIIlIlI)) {
                            llllllllllllllllllllIllIIlIIlIlI.interact(lIlIIIIIIl[lIlIIIIIlI[43]]);
                            Time.sleepTicks((int)lIlIIIIIlI[1]);
                            "".length();
                        }
                        if (J.lIIIIllllllll(llllllllllllllllllllIllIIlIIlIIl = Widgets.get((int)lIlIIIIIlI[39], (int)lIlIIIIIlI[35]))) {
                            llllllllllllllllllllIllIIlIIlIIl.interact(lIlIIIIIIl[lIlIIIIIlI[44]]);
                            Time.sleepTicks((int)lIlIIIIIlI[3]);
                            "".length();
                        }
                    }
            ...
            h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.g.a(new String[lIlIIIIIlI[0]]);
        }
    }

    private static void O() {
        d llllllllllllllllllllIllIIlIIIlIl;
        Object llllllllllllllllllllIllIIlIIIllI;
        int[] nArray = new int[lIlIIIIIlI[1]];
        nArray[J.lIlIIIIIlI[0]] = lIlIIIIIlI[10];
        ...
        if (J.lIIIIllllllII(Bank.contains((int[])nArray2) ? 1 : 0)) {
            llllllllllllllllllllIllIIlIIIllI = new d(lIlIIIIIlI[14], lIlIIIIIlI[1], lIlIIIIIlI[47]);
            bp.add((d)llllllllllllllllllllIllIIlIIIllI);
            "".length();
        }
        int[] nArray3 = new int[lIlIIIIIlI[1]];
        nArray3[J.lIlIIIIIlI[0]] = lIlIIIIIlI[4];
        if (J.lIIIIllllllII(Bank.contains((int[])nArray3) ? 1 : 0)) {
            llllllllllllllllllllIllIIlIIIllI = new d(lIlIIIIIlI[4], lIlIIIIIlI[48], lIlIIIIIlI[49]);
            bp.add((d)llllllllllllllllllllIllIIlIIIllI);
            "".length();
        }
        if (J.lIIIIllllllII(Bank.contains((Predicate)(llllllllllllllllllllIllIIlIIIllI = item -> item.getName().toLowerCase().contains(lIlIIIIIIl[lIlIIIIIlI[56]]))) ? 1 : 0)) {
            llllllllllllllllllllIllIIlIIIlIl = new d(lIlIIIIIlI[50], lIlIIIIIlI[7], lIlIIIIIlI[51]);
            bp.add(llllllllllllllllllllIllIIlIIIlIl);
            "".length();
        }
        int[] nArray4 = new int[lIlIIIIIlI[1]];
        nArray4[J.lIlIIIIIlI[0]] = lIlIIIIIlI[11];
        if (J.lIIIIllllllII(Bank.contains((int[])nArray4) ? 1 : 0)) {
            llllllllllllllllllllIllIIlIIIlIl = new d(lIlIIIIIlI[11], lIlIIIIIlI[15], lIlIIIIIlI[52]);
            bp.add(llllllllllllllllllllIllIIlIIIlIl);
            "".length();
        }
        ...
        if (J.lIIIIllllllII(Bank.contains((int[])nArray5) ? 1 : 0)) {
            llllllllllllllllllllIllIIlIIIlIl = new d(lIlIIIIIlI[16], lIlIIIIIlI[15], lIlIIIIIlI[52]);
            bp.add(llllllllllllllllllllIllIIlIIIlIl);
            "".length();
        }
        ...
        if (J.lIIIIllllllII(Bank.contains((int[])nArray6) ? 1 : 0)) {
            llllllllllllllllllllIllIIlIIIlIl = new d(lIlIIIIIlI[13], lIlIIIIIlI[53], lIlIIIIIlI[52]);
            bp.add(llllllllllllllllllllIllIIlIIIlIl);
            "".length();
        }
        ...
        if (J.lIIIIllllllII(Bank.contains((int[])nArray7) ? 1 : 0)) {
            llllllllllllllllllllIllIIlIIIlIl = new d(lIlIIIIIlI[12], lIlIIIIIlI[7], j.bZ);
            bp.add(llllllllllllllllllllIllIIlIIIlIl);
            "".length();
        }
    }
