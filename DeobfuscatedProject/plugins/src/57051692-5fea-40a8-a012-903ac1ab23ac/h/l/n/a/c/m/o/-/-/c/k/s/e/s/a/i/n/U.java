...
implements K {
    ...
    private static void lIIllIlIIIIll() {
        ...
        U.lIllIlIlIl[U.lIllIllIll[0]] = U.lIIllIIlIlllI("DJ089WnbLiPCD7qZ+JfGmg==", "UjKvd");
        U.lIllIlIlIl[U.lIllIllIll[1]] = U.lIIllIIlIlllI("ek/RTKk0HkJ5s299wHaO8GuHrQ3ZfUVV85aQaDcVowCZL+7fDFweXtRGJFS0atLUZa6hOYWTT90=", "bVDJl");
        U.lIllIlIlIl[U.lIllIllIll[2]] = U.lIIllIIlIllll("AioMOAMtPxM/A2w/FXEGLSUR", "LKzQd");
        U.lIllIlIlIl[U.lIllIllIll[3]] = U.lIIllIIlIllll("HSYIKBg8KQFsFjQpDSUaMg==", "UGfLt");
        U.lIllIlIlIl[U.lIllIllIll[7]] = U.lIIllIIlIlllI("PC9af6Xk6YnBizw0V6FJ54aZseHDhu2NOPuU2FxbHJ2Zb8cty40LUnJpSjOjToeo", "BbfgJ");
        U.lIllIlIlIl[U.lIllIllIll[10]] = U.lIIllIIlIllll("Jwp0DDMVTzkEMgMGOgphAxokHS0ZCidBYQMYPRkiGAY6CmEEAHQvFCkmGio=", "poTmA");
        U.lIllIlIlIl[U.lIllIllIll[12]] = U.lIIllIIlIlllI("SGlZ3Xwjr5ZwO2em2C1HzbW4Mxlv0Uw6rXSER1tteiZLnSeZPwNaAXA1/lyLZWyJ", "GKeib");
        U.lIllIlIlIl[U.lIllIllIll[15]] = U.lIIllIIlIllll("NhQdKxwaCw9iCAYABA==", "sehBl");
        U.lIllIlIlIl[U.lIllIllIll[16]] = U.lIIllIIlIllll("BwAuFw==", "PeOeR");
        U.lIllIlIlIl[U.lIllIllIll[17]] = U.lIIllIIlIllll("GRUFOBY2ABZxBThUATAfMBE=", "WtsQq");
        U.lIllIlIlIl[U.lIllIllIll[18]] = U.lIIllIIllIIII("FUOu3TQXqe4=", "TQMhK");
        U.lIllIlIlIl[U.lIllIllIll[19]] = U.lIIllIIlIlllI("xGteQFqjoo0=", "fHcvG");
        U.lIllIlIlIl[U.lIllIllIll[20]] = U.lIIllIIllIIII("2PVkoK5/quM=", "LlydC");
        U.lIllIlIlIl[U.lIllIllIll[34]] = U.lIIllIIlIlllI("Ju36F9N7AHc=", "hLWsR");
        U.lIllIlIlIl[U.lIllIllIll[36]] = U.lIIllIIlIlllI("8cyW4DmkxeszHc2hJYFcMl106sfs9/gt", "MlPsx");
        U.lIllIlIlIl[U.lIllIllIll[5]] = U.lIIllIIlIllll("IBgoLkI9F2YtFzcdLycFeg==", "RqFIb");
    }
    ...
    private static void lIIllIlIIIlII() {
        ...
        U.lIllIllIll[0] = (0x6E ^ 0x4A ^ (0x65 ^ 0x6F)) & (7 ^ 0x19 ^ (0xA0 ^ 0x90) ^ -" ".length());
        U.lIllIllIll[1] = " ".length();
        U.lIllIllIll[2] = "  ".length();
        U.lIllIllIll[3] = "   ".length();
    ...
    private static String lIIllIIlIlllI(String lllllllllllllllllllIIIIlIlllllll, String lllllllllllllllllllIIIIlIlllllII) {
        try {
            SecretKeySpec lllllllllllllllllllIIIIllIIIIIlI = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(lllllllllllllllllllIIIIlIlllllII.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher lllllllllllllllllllIIIIllIIIIIIl = Cipher.getInstance("Blowfish");
            lllllllllllllllllllIIIIllIIIIIIl.init(lIllIllIll[2], lllllllllllllllllllIIIIllIIIIIlI);
    ...
    private static String lIIllIIlIllll(String lllllllllllllllllllIIIIllIIlIlII, String lllllllllllllllllllIIIIllIIIlllI) {
        lllllllllllllllllllIIIIllIIlIlII = new String(Base64.getDecoder().decode(lllllllllllllllllllIIIIllIIlIlII.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder lllllllllllllllllllIIIIllIIlIIlI = new StringBuilder();
        char[] lllllllllllllllllllIIIIllIIlIIIl = lllllllllllllllllllIIIIllIIIlllI.toCharArray();
        int lllllllllllllllllllIIIIllIIlIIII = lIllIllIll[0];
        char[] lllllllllllllllllllIIIIllIIIlIlI = lllllllllllllllllllIIIIllIIlIlII.toCharArray();
        int lllllllllllllllllllIIIIllIIIlIIl = lllllllllllllllllllIIIIllIIIlIlI.length;
        int lllllllllllllllllllIIIIllIIIlIII = lIllIllIll[0];
        while (U.lIIllIlIIIllI(lllllllllllllllllllIIIIllIIIlIII, lllllllllllllllllllIIIIllIIIlIIl)) {
            char lllllllllllllllllllIIIIllIIlIlIl = lllllllllllllllllllIIIIllIIIlIlI[lllllllllllllllllllIIIIllIIIlIII];
            lllllllllllllllllllIIIIllIIlIIlI.append((char)(lllllllllllllllllllIIIIllIIlIlIl ^ lllllllllllllllllllIIIIllIIlIIIl[lllllllllllllllllllIIIIllIIlIIII % lllllllllllllllllllIIIIllIIlIIIl.length]));
            "".length();
            ++lllllllllllllllllllIIIIllIIlIIII;
            ++lllllllllllllllllllIIIIllIIIlIII;
            "".length();
            if ((0xD4 ^ 0x86 ^ (0x28 ^ 0x7E)) != -" ".length()) continue;
            return null;
        }
        return String.valueOf(lllllllllllllllllllIIIIllIIlIIlI);
    }
    ...
    public static void dj() {
        ...
        if (U.lIIllIlIIIlll(bn ? 1 : 0)) {
            BankLocation lllllllllllllllllllIIIIllIlIIlIl;
            if (U.lIIllIlIIIlll(U.al() ? 1 : 0)) {
                lllllllllllllllllllIIIIllIlIIlIl = BankLocation.getNearest();
                if (U.lIIllIlIIlIII(lllllllllllllllllllIIIIllIlIIlIl) && U.lIIllIlIIIlll(lllllllllllllllllllIIIIllIlIIlIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderShamans.c = lIllIlIlIl[lIllIllIll[2]];
                    a.a(lllllllllllllllllllIIIIllIlIIlIl);
                }
                if (U.lIIllIlIIlIII(lllllllllllllllllllIIIIllIlIIlIl) && U.lIIllIlIIIlIl(lllllllllllllllllllIIIIllIlIIlIl.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (U.lIIllIlIIIllI(Skills.getLevel((Skill)Skill.COOKING), lIllIllIll[5])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (U.lIIllIlIIlIIl(Inventory.getCount((int[])nArray))) {
                                ...
                                "".length();
                                if ("   ".length() < "   ".length()) {
                                    return ((0xF ^ 0x55 ^ (0xD8 ^ 0x9F)) & (0xEA ^ 0x83 ^ (0x31 ^ 0x45) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIllIllIll[0];
                            }
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (U.lIIllIlIIlIIl(Inventory.getCount((int[])nArray))) {
                                ...
                                if ((92 + 154 - 130 + 41 ^ 45 + 63 - -8 + 37) != (150 + 0 - 7 + 33 ^ 62 + 136 - 189 + 171)) {
                                    return ((133 + 135 - 249 + 132 ^ 126 + 49 - 115 + 92) & (0xE3 ^ 0xAB ^ (0x66 ^ 0x21) ^ -" ".length())) != 0;
                                }
                            } else {
                                bl = lIllIllIll[0];
                            }
            ...
            if (U.lIIllIlIIIlIl(U.al() ? 1 : 0)) {
                ...
                if (U.lIIllIlIIIlIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    if (U.lIIllIlIIIlll(Equipment.contains((int[])nArray2) ? 1 : 0)) {
                        ...
                        lllllllllllllllllllIIIIllIlIIlIl = Inventory.getFirst((int[])nArray3);
                        if (U.lIIllIlIIlIII(lllllllllllllllllllIIIIllIlIIlIl)) {
                            lllllllllllllllllllIIIIllIlIIlIl.interact(lIllIlIlIl[lIllIllIll[16]]);
                ...
                if (U.lIIllIlIIllII(Players.getLocal().getWorldLocation().distanceTo(kE), lIllIllIll[10])) {
                    ...
                    lllllllllllllllllllIIIIllIlIIlIl = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (String[])stringArray);
                    if (U.lIIllIlIIlIII(lllllllllllllllllllIIIIllIlIIlIl)) {
                        if (U.lIIllIlIIIlll(Production.isOpen() ? 1 : 0)) {
                            lllllllllllllllllllIIIIllIlIIlIl.interact(lIllIlIlIl[lIllIllIll[20]]);
                            Time.sleepTicks((int)lIllIllIll[2]);
                            "".length();
                        ...
                        if (U.lIIllIlIIIlIl(Production.isOpen() ? 1 : 0)) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!U.lIIllIlIIIlIl(U.al() ? 1 : 0) || U.lIIllIlIIIlIl(Dialog.isOpen() ? 1 : 0)) {
                                    bl = lIllIllIll[1];
                                    "".length();
                                    if ((138 + 102 - 71 + 2 ^ 130 + 165 - 212 + 92) < -" ".length()) {
                                        return ((84 + 12 - -23 + 85 ^ 5 + 195 - 193 + 192) & (0x6E ^ 0x45 ^ (0xA6 ^ 0x86) ^ -" ".length())) != 0;
                                    }
                                } else {
                                    bl = lIllIllIll[0];
                                }
    ...
    private static void O() {
        d lllllllllllllllllllIIIIllIIlllll;
        Object lllllllllllllllllllIIIIllIlIIIII;
        Object lllllllllllllllllllIIIIllIlIIIIl;
        if (U.lIIllIlIIIllI(Skills.getLevel((Skill)Skill.COOKING), lIllIllIll[5])) {
        ...
        if (U.lIIllIlIIlIlI(Skills.getLevel((Skill)Skill.COOKING), lIllIllIll[5]) && U.lIIllIlIIIllI(Skills.getLevel((Skill)Skill.COOKING), lIllIllIll[8])) {
            lllllllllllllllllllIIIIllIlIIIIl = new d(lIllIllIll[9], lIllIllIll[24], lIllIllIll[25]);
            bp.add((d)lllllllllllllllllllIIIIllIlIIIIl);
            "".length();
        }
        if (U.lIIllIlIIlIlI(Skills.getLevel((Skill)Skill.COOKING), lIllIllIll[8])) {
            lllllllllllllllllllIIIIllIlIIIIl = new d(lIllIllIll[11], lIllIllIll[24], lIllIllIll[25]);
            bp.add((d)lllllllllllllllllllIIIIllIlIIIIl);
            "".length();
        }
        if (U.lIIllIlIIIlll(Bank.contains(lllllllllllllllllllIIIIllIlIIIIl = item -> item.getName().toLowerCase().contains(lIllIlIlIl[lIllIllIll[5]])) ? 1 : 0)) {
            lllllllllllllllllllIIIIllIlIIIII = new d(lIllIllIll[13], lIllIllIll[26], lIllIllIll[27]);
            bp.add((d)lllllllllllllllllllIIIIllIlIIIII);
            "".length();
        }
        if (U.lIIllIlIIIlll(Bank.contains(lllllllllllllllllllIIIIllIlIIIII = item -> item.getName().toLowerCase().contains(lIllIlIlIl[lIllIllIll[36]])) ? 1 : 0)) {
            lllllllllllllllllllIIIIllIIlllll = new d(lIllIllIll[28], lIllIllIll[10], lIllIllIll[29]);
            bp.add(lllllllllllllllllllIIIIllIIlllll);
            "".length();
        }
        int[] nArray = new int[lIllIllIll[1]];
        nArray[U.lIllIllIll[0]] = lIllIllIll[30];
        if (U.lIIllIlIIIlll(Bank.contains((int[])nArray) ? 1 : 0)) {
            lllllllllllllllllllIIIIllIIlllll = new d(lIllIllIll[30], lIllIllIll[31], lIllIllIll[32]);
            bp.add(lllllllllllllllllllIIIIllIIlllll);
            "".length();
        }
    }

    private static String lIIllIIllIIII(String lllllllllllllllllllIIIIlIlllIIII, String lllllllllllllllllllIIIIlIlllIIIl) {
        try {
            ...
            return new String(lllllllllllllllllllIIIIlIlllIlII.doFinal(Base64.getDecoder().decode(lllllllllllllllllllIIIIlIlllIIII.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
