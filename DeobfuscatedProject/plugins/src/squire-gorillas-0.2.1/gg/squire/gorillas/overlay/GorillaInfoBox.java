...
extends OverlayPanel {
    ...
    private static void lllllIlIIlllll() {
        ...
        GorillaInfoBox.llIIlIlIIIIl[GorillaInfoBox.llIIlIlIIIlI[1]] = GorillaInfoBox.lllllIlIIlllII("jYPsHzTZicND18hkmnZgXw==", "rTKrr");
        GorillaInfoBox.llIIlIlIIIIl[GorillaInfoBox.llIIlIlIIIlI[2]] = GorillaInfoBox.lllllIlIIlllIl("0FdaQoFeLrk=", "cqGYJ");
        GorillaInfoBox.llIIlIlIIIIl[GorillaInfoBox.llIIlIlIIIlI[3]] = GorillaInfoBox.lllllIlIIlllIl("9U5l3bVRYXQ=", "lxPIS");
        GorillaInfoBox.llIIlIlIIIIl[GorillaInfoBox.llIIlIlIIIlI[4]] = GorillaInfoBox.lllllIlIIllllI("PC0IGTADPQ==", "nXfmY");
        GorillaInfoBox.llIIlIlIIIIl[GorillaInfoBox.llIIlIlIIIlI[5]] = GorillaInfoBox.lllllIlIIlllIl("8v+JxEPyRwM=", "slRsb");
        GorillaInfoBox.llIIlIlIIIIl[GorillaInfoBox.llIIlIlIIIlI[6]] = GorillaInfoBox.lllllIlIIllllI("HgUOAwc=", "Ulbot");
    }
    ...
    private static void lllllIlIlIIIII() {
        ...
        GorillaInfoBox.llIIlIlIIIlI[2] = " ".length();
        GorillaInfoBox.llIIlIlIIIlI[3] = "  ".length();
        GorillaInfoBox.llIIlIlIIIlI[4] = "   ".length();
