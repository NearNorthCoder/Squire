...
extends Task {
    ...
    private static void lllllIlIllllII() {
        ...
        z.llIIlIlIlllI[0] = (98 + 95 - 68 + 5 ^ 10 + 130 - 29 + 63) & (0x92 ^ 0xC1 ^ 57 + 53 - 2 + 19 ^ -" ".length());
        z.llIIlIlIlllI[1] = " ".length();
        z.llIIlIlIlllI[2] = 0xFFFFDFFE & 0x6C6D;
        z.llIIlIlIlllI[3] = "  ".length();
        z.llIIlIlIlllI[4] = "   ".length();
    ...
    private static void lllllIlIlllIll() {
        ...
        z.llIIlIlIllIl[z.llIIlIlIlllI[0]] = z.lllllIlIlllIIl("CBgnASQlEg==", "KwJlQ");
        z.llIIlIlIllIl[z.llIIlIlIlllI[1]] = z.lllllIlIlllIlI("IVu/FsysqUM=", "uKDVg");
        z.llIIlIlIllIl[z.llIIlIlIlllI[3]] = z.lllllIlIlllIIl("KDEa", "mPnuV");
    }
    ...
    public boolean run() {
        ...
        NPC lllllllllllllllIlIIllllIlIIlIIIl = NPCs.getNearest(nPC -> {
            ...
            if (z.lllllIlIllllIl(nPC.hasAction(llIIlIlIllIl[llIIlIlIlllI[1]]::equals) ? 1 : 0) && z.lllllIlIllllll(nPC.getInteracting(), Players.getLocal())) {
                n2 = llIIlIlIlllI[1];
                "".length();
                if (((250 + 222 - 467 + 250 ^ 141 + 26 - 73 + 105) & (0x4E ^ 0x6B ^ (0x82 ^ 0x9F) ^ -" ".length())) >= "  ".length()) {
                    return ((0xAE ^ 0xC5 ^ (5 ^ 0x74)) & (126 + 29 - 72 + 65 ^ 40 + 136 - 74 + 40 ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIIlIlIlllI[0];
            }
