...
extends Enum<h> {
    ...
    private static void lllllIIlllIIlI() {
        ...
        h.llIIlIIlIlII[h.llIIlIIlIlIl[0]] = h.lllllIIlllIIII("LwagkjDnDjE=", "rpcVN");
        h.llIIlIIlIlII[h.llIIlIIlIlIl[1]] = h.lllllIIlllIIIl("+3nfHq+JXi2XYQGeqE8UzQ==", "uLipt");
    }
    ...
    private static void lllllIIlllIIll() {
        ...
        h.llIIlIIlIlIl[0] = (0xBC ^ 0xAA ^ (0x1A ^ 0x17)) & (162 + 9 - 31 + 32 ^ 104 + 34 - 20 + 65 ^ -" ".length());
        h.llIIlIIlIlIl[1] = " ".length();
        h.llIIlIIlIlIl[2] = "  ".length();
