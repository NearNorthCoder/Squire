...
extends Task {
    ...
    private static void lllllIllllllIl() {
        ...
        o.llIIllIIIIll[o.llIIllIIIlII[1]] = o.lllllIlllllIlI("u/KgHtXnfWyAnBaHtDOOPW9Gu60hYKL11o9JuGxybYjoc2Yvonl9tQ==", "cMNpC");
        o.llIIllIIIIll[o.llIIllIIIlII[3]] = o.lllllIlllllIlI("2llb1ViRmkwZOuT448MFjYHvYgB+DdRWYJm64450Nb4JNTwR4vsn3g==", "WFYcX");
        o.llIIllIIIIll[o.llIIllIIIlII[4]] = o.lllllIlllllIll("OywJAxwMbQEEHRxtBk0UFz8OAR8ZbRMCUxk5EwwQEw==", "xMgms");
        o.llIIllIIIIll[o.llIIllIIIlII[2]] = o.lllllIllllllII("Lg53t6uLmJM=", "JlARK");
        o.llIIllIIIIll[o.llIIllIIIlII[5]] = o.lllllIllllllII("BKqxvPLHgSk=", "oGwjD");
        o.llIIllIIIIll[o.llIIllIIIlII[6]] = o.lllllIlllllIll("GQgzBjo/AiVSKCIVKB4jLA==", "MgArO");
    }
    ...
    private static void lllllIlllllllI() {
        ...
        o.llIIllIIIlII[2] = "   ".length();
        o.llIIllIIIlII[3] = " ".length();
        o.llIIllIIIlII[4] = "  ".length();
    ...
    public boolean run() {
        ...
        NPC lllllllllllllllIlIIlllIIlllIlIII = NPCs.getNearest(nPC -> {
            ...
            if (o.llllllIIIIIIII(nPC.getName().equals(llIIllIIIIll[llIIllIIIlII[6]]) ? 1 : 0) && o.llllllIIIIIlIl(nPC.getInteracting(), lllllllllllllllIlIIlllIIlllIlIIl)) {
                ...
                "".length();
                if (" ".length() > " ".length()) {
                    return ((0x12 ^ 0x51 ^ (0x25 ^ 0x47)) & (108 + 103 - 78 + 37 ^ 46 + 23 - 14 + 84 ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIIllIIIlII[1];
            }
        ...
        if (o.llllllIIIIIIlI(lllllllllllllllIlIIlllIIlllIIlll) && o.llllllIIIIIIlI(lllllllllllllllIlIIlllIIlllIIlll = NPCs.getNearest(nPC -> {
            ...
            if (o.llllllIIIIIIlI(nPC.getInteracting()) && o.llllllIIIIIIII(Y.contains((Locatable)nPC) ? 1 : 0) && o.llllllIIIIIIII(SquireGorillaPlugin.a(nPC.getId()) ? 1 : 0)) {
                ...
                if (-(0x95 ^ 0x8E ^ (0x7A ^ 0x65)) > 0) {
                    return ((128 + 28 - 88 + 171 ^ 52 + 105 - 65 + 75) & (0xAF ^ 0xC0 ^ (0x82 ^ 0xA5) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIIllIIIlII[1];
            }
        ...
        while (o.llllllIIIIIIll(lllllllllllllllIlIIlllIIlllIIIII, (int)lllllllllllllllIlIIlllIIlllIIIIl)) {
            ...
            if (o.llllllIIIIIlII((int)lllllllllllllllIlIIlllIIllIlllll, llIIllIIIlII[0])) {
                ...
                if (o.llllllIIIIIIIl(NPCs.getNearest(nPC -> nPC.getName().toLowerCase().contains(llIIllIIIIll[llIIllIIIlII[5]])))) {
                    bl = llIIllIIIlII[3];
                    "".length();
                    if (((0x7F ^ 0x2D ^ (0x43 ^ 0x58)) & (27 + 159 - -33 + 17 ^ 33 + 70 - 31 + 93 ^ -" ".length())) != 0) {
                        return ((0x23 ^ 0x67 ^ (0x34 ^ 0x3E)) & (37 + 69 - 31 + 61 ^ 145 + 77 - 142 + 118 ^ -" ".length())) != 0;
                    }
                } else {
                    bl = llIIllIIIlII[1];
                }
            ...
            "".length();
            if (((0x72 ^ 0x68 ^ (0x4F ^ 0xC)) & (0xA6 ^ 0x9A ^ (0x41 ^ 0x24) ^ -" ".length())) == 0) continue;
            return ((102 + 95 - 86 + 27 ^ 118 + 102 - 180 + 135) & (15 + 125 - 77 + 90 ^ 144 + 10 - -18 + 16 ^ -" ".length())) != 0;
        }
        return llIIllIIIlII[1];
    }
}
