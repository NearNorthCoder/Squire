...
extends Enum<d> {
    ...
    private static void lllllIllIlllll() {
        ...
        d.llIIlIllIllI[0] = (181 + 200 - 196 + 41 ^ 18 + 31 - -26 + 85) & (0x88 ^ 0x9E ^ (0xF2 ^ 0xA6) ^ -" ".length());
        d.llIIlIllIllI[1] = " ".length();
        d.llIIlIllIllI[2] = "  ".length();
        d.llIIlIllIllI[3] = "   ".length();
    ...
    private static void lllllIllIllllI() {
        ...
        d.llIIlIllIlIl[d.llIIlIllIllI[0]] = d.lllllIllIllIll("GQkMCCs=", "THKAh");
        d.llIIlIllIlIl[d.llIIlIllIllI[1]] = d.lllllIllIlllII("rqRSXFJb9TE=", "rdNsu");
        d.llIIlIllIlIl[d.llIIlIllIllI[2]] = d.lllllIllIlllIl("s3so0nxeUFY=", "lmZfC");
        d.llIIlIllIlIl[d.llIIlIllIllI[3]] = d.lllllIllIlllIl("UYDduRrguiQ=", "LntjS");
    }
