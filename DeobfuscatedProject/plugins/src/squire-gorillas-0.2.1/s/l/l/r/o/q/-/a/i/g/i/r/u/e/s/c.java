...
public class c {
    ...
    private static void lllllIlIlIIIll() {
        ...
        c.llIIlIlIIlII[1] = "   ".length();
        c.llIIlIlIIlII[2] = -" ".length();
        c.llIIlIlIIlII[3] = (0x74 ^ 0x68 ^ (0x4B ^ 0x76)) & (0xCB ^ 0xA9 ^ (0xC6 ^ 0x85) ^ -" ".length());
        ...
        c.llIIlIlIIlII[10] = " ".length();
        c.llIIlIlIIlII[11] = "  ".length();
    }
