...
extends Task {
    ...
    public boolean a(ConfigStorageBox<EquipmentSetup> configStorageBox) {
        ...
        if (r.lllllIlIIlIIII(equipmentSetup)) {
            ...
            if ((0xAD ^ 0xB3 ^ (0x48 ^ 0x52)) != (0xD2 ^ 0x9F ^ (0x51 ^ 0x18))) {
                return ((62 + 152 - 168 + 197 ^ 97 + 71 - 91 + 108) & (0xBA ^ 0x89 ^ (0xF6 ^ 0x8F) ^ -" ".length())) != 0;
            }
        } else {
        ...
        while (r.lllllIlIIlIlII(lllllllllllllllIlIIllllllllIllIl, Math.min(lllllllllllllllIlIIllllllllIlllI.size(), llIIlIIllllI[8]))) {
            ...
            lllllllllllllllIlIIllllllllIllII.interact(string -> {
                ...
                if (r.lllllIlIIlIIII(string) && (!r.lllllIlIIlIIIl(string.equals(llIIlIIlllIl[llIIlIIllllI[9]]) ? 1 : 0) || !r.lllllIlIIlIIIl(string.equals(llIIlIIlllIl[llIIlIIllllI[10]]) ? 1 : 0) || r.lllllIlIIIlllI(string.equals(llIIlIIlllIl[llIIlIIllllI[8]]) ? 1 : 0))) {
                    ...
                    "".length();
                    if ("   ".length() != "   ".length()) {
                        return ((48 + 39 - -6 + 66 ^ 124 + 107 - 84 + 36) & (5 ^ 0x45 ^ (0xF9 ^ 0x91) ^ -" ".length())) != 0;
                    }
                } else {
                    n2 = llIIlIIllllI[0];
                }
            ...
            return ((0xE5 ^ 0xA7 ^ (0x7D ^ 0x26)) & (0xBE ^ 0x98 ^ (0xA9 ^ 0x96) ^ -" ".length())) != 0;
        }
    ...
    private static void lllllIlIIIlIll() {
        ...
        r.llIIlIIlllIl[r.llIIlIIllllI[0]] = r.lllllIlIIIlIII("oMuQM5/4X1M=", "iPwst");
        r.llIIlIIlllIl[r.llIIlIIllllI[1]] = r.lllllIlIIIlIIl("si4FjrNT2ko=", "HQzQt");
        r.llIIlIIlllIl[r.llIIlIIllllI[4]] = r.lllllIlIIIlIIl("jFycXmogJPk=", "gGfIP");
        r.llIIlIIlllIl[r.llIIlIIllllI[5]] = r.lllllIlIIIlIII("uu2mh7LOfLI=", "AXsoy");
        r.llIIlIIlllIl[r.llIIlIIllllI[6]] = r.lllllIlIIIlIlI("EDkYKRM6", "QMlHp");
        r.llIIlIIlllIl[r.llIIlIIllllI[7]] = r.lllllIlIIIlIIl("CoBjo2JpvMQ=", "OXMaO");
        r.llIIlIIlllIl[r.llIIlIIllllI[9]] = r.lllllIlIIIlIII("6nfgxIucGfY=", "QhKrc");
        r.llIIlIIlllIl[r.llIIlIIllllI[10]] = r.lllllIlIIIlIII("/Gpcwi8KkcU=", "PVgyj");
        r.llIIlIIlllIl[r.llIIlIIllllI[8]] = r.lllllIlIIIlIIl("Flsf8KnKC3E=", "EmTgB");
        r.llIIlIIlllIl[r.llIIlIIllllI[11]] = r.lllllIlIIIlIlI("JDkMOg1wNBg8GQ==", "PVtSn");
        r.llIIlIIlllIl[r.llIIlIIllllI[12]] = r.lllllIlIIIlIIl("rm05oiCvD0oe0YxJ0psVbw==", "pClTX");
        r.llIIlIIlllIl[r.llIIlIIllllI[13]] = r.lllllIlIIIlIlI("Hy4kIDEDIj8vdQsgMg==", "lOVAU");
        r.llIIlIIlllIl[r.llIIlIIllllI[14]] = r.lllllIlIIIlIII("HSsY+fvlypQ=", "ouyvO");
        r.llIIlIIlllIl[r.llIIlIIllllI[15]] = r.lllllIlIIIlIII("z/p7peExbnc=", "nQQSW");
        r.llIIlIIlllIl[r.llIIlIIllllI[16]] = r.lllllIlIIIlIII("0cQeTpSNr6w=", "swWcC");
        r.llIIlIIlllIl[r.llIIlIIllllI[17]] = r.lllllIlIIIlIIl("YfpPbNs2iis=", "cMNAQ");
        r.llIIlIIlllIl[r.llIIlIIllllI[18]] = r.lllllIlIIIlIII("QZguCkGMtMU=", "goIJr");
    }
    ...
    private static void lllllIlIIIllII() {
        ...
        r.llIIlIIllllI[1] = " ".length();
        r.llIIlIIllllI[2] = 0x1C ^ 0x2E;
        r.llIIlIIllllI[3] = 0x2B ^ 0x35;
        r.llIIlIIllllI[4] = "  ".length();
        r.llIIlIIllllI[5] = "   ".length();
        ...
        r.llIIlIIllllI[11] = 0x66 ^ 0x6D ^ "  ".length();
    ...
    public boolean run() {
        ...
        if (r.lllllIlIIIllIl(Players.getLocal().getInteracting())) {
            nPC2 = NPCs.getNearest(nPC -> {
                ...
                if (r.lllllIlIIIllll(nPC.getInteracting(), Players.getLocal())) {
                    ...
                    "".length();
                    if ("   ".length() == 0) {
                        return ((0x55 ^ 0x70 ^ (0x24 ^ 0x44)) & (115 + 83 - 193 + 212 ^ 22 + 42 - -63 + 29 ^ -" ".length())) != 0;
                    }
                } else {
                    bl = llIIlIIllllI[0];
                }
            ...
            "".length();
            if (null != null) {
                return ((0x4D ^ 0x65 ^ (0x9A ^ 0xA4)) & (0xEF ^ 0xA2 ^ (0x35 ^ 0x6E) ^ -" ".length())) != 0;
            }
        } else {
        ...
        if (r.lllllIlIIIlllI(((EquipmentSetup)lllllllllllllllIlIIllllllllllllI.ac.melee().selected(EquipmentSetup.class)).contains(itemComposition -> {
            ...
            if (!r.lllllIlIIlIIIl(lllllllllllllllIlIIllllllllIIlII.contains(llIIlIIlllIl[llIIlIIllllI[16]]) ? 1 : 0) || !r.lllllIlIIlIIIl(lllllllllllllllIlIIllllllllIIlII.contains(llIIlIIlllIl[llIIlIIllllI[17]]) ? 1 : 0) || r.lllllIlIIIlllI(lllllllllllllllIlIIllllllllIIlII.contains(llIIlIIlllIl[llIIlIIllllI[18]]) ? 1 : 0)) {
                ...
                if (-(121 + 117 - 156 + 91 ^ 11 + 11 - -29 + 118) >= 0) {
                    return ((123 + 72 - 84 + 16 ^ (0xA4 ^ 0x80)) & (0x17 ^ 0x7C ^ (0xA7 ^ 0x97) ^ -" ".length())) != 0;
                }
            } else {
                bl = llIIlIIllllI[0];
            }
        ...
        if (!r.lllllIlIIlIIIl(lllllllllllllllIlIIllllllllllIlI) || r.lllllIlIIIlllI(lllllllllllllllIlIIllllllllllIll)) {
            ...
            "".length();
            if (((145 + 34 - -3 + 45 ^ 36 + 59 - 12 + 77) & (0xCD ^ 0x9F ^ (0x4F ^ 0x5E) ^ -" ".length())) < 0) {
                return ((0x1E ^ 0x7E ^ (0x1A ^ 0x26)) & (0xD4 ^ 0x81 ^ (0x27 ^ 0x2E) ^ -" ".length())) != 0;
            }
        } else {
