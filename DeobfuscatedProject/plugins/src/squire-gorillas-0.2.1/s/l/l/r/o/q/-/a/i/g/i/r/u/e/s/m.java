...
extends j {
    ...
    private boolean M() {
        ...
        while (m.lllllIlIIIIlll(lllllllllllllllIlIlIIIIIIlIIllIl, (int)lllllllllllllllIlIlIIIIIIlIIlllI)) {
            ...
            return ((0xE7 ^ 0xBB ^ (0x68 ^ 0x56)) & (75 + 7 - 27 + 112 ^ 16 + 20 - -54 + 107 ^ -" ".length())) != 0;
        }
    ...
    private static void lllllIlIIIIIIl() {
        ...
        m.llIIlIIllIll[1] = (0x5D ^ 0x5A ^ (0x12 ^ 0x1E)) & (0x70 ^ 0x26 ^ (0x1C ^ 0x41) ^ -" ".length());
        m.llIIlIIllIll[2] = " ".length();
        m.llIIlIIllIll[3] = "  ".length();
        m.llIIlIIllIll[4] = 0xB7 ^ 0xBD;
        m.llIIlIIllIll[5] = "   ".length();
    ...
    private boolean K() {
        ...
        Item lllllllllllllllIlIlIIIIIIlIllIII = Inventory.getFirst(item -> {
            ...
            if (!m.lllllIlIIIIIlI(item.getName().startsWith(llIIlIIllIlI[llIIlIIllIll[9]]) ? 1 : 0) || m.lllllIlIIIIIll(item.getName().startsWith(llIIlIIllIlI[llIIlIIllIll[10]]) ? 1 : 0)) {
                ...
                "".length();
                if ("  ".length() > "  ".length()) {
                    return ((44 + 2 - -102 + 27 ^ 95 + 58 - 74 + 79) & (0xA1 ^ 0xA4 ^ (0x4E ^ 0x7A) ^ -" ".length())) != 0;
                }
            } else {
                n2 = llIIlIIllIll[1];
            }
    ...
    private static void lllllIlIIIIIII() {
        ...
        m.llIIlIIllIlI[m.llIIlIIllIll[1]] = m.lllllIIlllllIl("0x1qQzmB1bU=", "afbnu");
        m.llIIlIIllIlI[m.llIIlIIllIll[2]] = m.lllllIIllllllI("FyQi", "REVEy");
        m.llIIlIIllIlI[m.llIIlIIllIll[3]] = m.lllllIIlllllll("sAc3zthbTzs=", "NJoOr");
        m.llIIlIIllIlI[m.llIIlIIllIll[5]] = m.lllllIIlllllll("rsn4ZL9/VnU=", "PCNFB");
        m.llIIlIIllIlI[m.llIIlIIllIll[6]] = m.lllllIIlllllIl("j42EXVcttZ4=", "zwJmy");
        m.llIIlIIllIlI[m.llIIlIIllIll[7]] = m.lllllIIlllllIl("LX+58hBQz08=", "kgqQZ");
        m.llIIlIIllIlI[m.llIIlIIllIll[8]] = m.lllllIIlllllIl("emnHrlIdc5wcc6lDgk4J/A==", "GYuvS");
        m.llIIlIIllIlI[m.llIIlIIllIll[9]] = m.lllllIIllllllI("IDs1DCcC", "pITuB");
        m.llIIlIIllIlI[m.llIIlIIllIll[10]] = m.lllllIIllllllI("MQI4LxhCBS05Hg0FLQ==", "bwHJj");
    }
