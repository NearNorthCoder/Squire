...
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.f;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.g;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.h;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.j;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.k;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.l;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.m;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.n;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.o;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.p;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.q;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.r;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.s;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.t;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.u;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.v;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.w;
import r.r.s.u.-.s.i.e.u.u.r.i.q.c.s.x;
...
extends SquirePlugin {
    ...
    private static void lIlIllIlIlllIlI() {
        ...
        SquireScurrius.lIIlIllIlllIl[0] = " ".length();
        SquireScurrius.lIIlIllIlllIl[1] = (65 + 78 - 4 + 45 ^ 92 + 24 - 97 + 113) & (145 + 105 - 145 + 66 ^ 40 + 50 - 26 + 87 ^ -" ".length());
        SquireScurrius.lIIlIllIlllIl[2] = 0xA5 ^ 0xB6;
        SquireScurrius.lIIlIllIlllIl[3] = "  ".length();
        SquireScurrius.lIIlIllIlllIl[4] = "   ".length();
    ...
    public boolean f() {
        ...
        if (!SquireScurrius.lIlIllIlIllllII(LocalPlayer.getAccountType().isIronman() ? 1 : 0) || SquireScurrius.lIlIllIlIlllIll(LocalPlayer.getAccountType().isGroupIronman() ? 1 : 0)) {
            ...
            if (-(40 + 31 - -24 + 66 ^ 102 + 163 - 195 + 94) >= 0) {
                return ((0x4D ^ 0x26 ^ (0x4D ^ 0x2A)) & (5 + 90 - 42 + 134 ^ 95 + 130 - 175 + 133 ^ -" ".length())) != 0;
            }
        } else {
            bl = lIIlIllIlllIl[1];
        }
    ...
    public void b(List<WorldArea> list) {
        Iterator<WorldArea> llllllllllllllIllllIlIIlIllIlIII = list.iterator();
        while (SquireScurrius.lIlIllIlIlllIll(llllllllllllllIllllIlIIlIllIlIII.hasNext() ? 1 : 0)) {
            SquireScurrius llllllllllllllIllllIlIIlIllIlIlI;
            WorldArea llllllllllllllIllllIlIIlIllIIlll = llllllllllllllIllllIlIIlIllIlIII.next();
            llllllllllllllIllllIlIIlIllIlIlI.j.addAll(llllllllllllllIllllIlIIlIllIIlll.toWorldPointList());
            "".length();
            "".length();
    ...
    public void a(List<WorldArea> list) {
        this.j.clear();
        Iterator<WorldArea> llllllllllllllIllllIlIIlIlllIIII = list.iterator();
        while (SquireScurrius.lIlIllIlIlllIll(llllllllllllllIllllIlIIlIlllIIII.hasNext() ? 1 : 0)) {
            SquireScurrius llllllllllllllIllllIlIIlIlllIIlI;
            WorldArea llllllllllllllIllllIlIIlIllIllll = llllllllllllllIllllIlIIlIlllIIII.next();
            llllllllllllllIllllIlIIlIlllIIlI.j.addAll(llllllllllllllIllllIlIIlIllIllll.toWorldPointList());
            "".length();
            "".length();
