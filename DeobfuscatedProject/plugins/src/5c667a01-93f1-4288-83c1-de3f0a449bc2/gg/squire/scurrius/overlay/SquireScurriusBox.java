...
extends OverlayPanel {
    ...
    private static void lIlIllIIllIlIII() {
        ...
        SquireScurriusBox.lIIlIllIIIlll[SquireScurriusBox.lIIlIllIIlIII[1]] = SquireScurriusBox.lIlIllIIllIIlIl("gmV2aoavUEmR8VHsmhqC4w==", "ZLFYO");
        SquireScurriusBox.lIIlIllIIIlll[SquireScurriusBox.lIIlIllIIlIII[4]] = SquireScurriusBox.lIlIllIIllIIllI("CHi4P1dliQLcmuCh8S6IYA==", "kYjju");
        SquireScurriusBox.lIIlIllIIIlll[SquireScurriusBox.lIIlIllIIlIII[5]] = SquireScurriusBox.lIlIllIIllIIlll("GRMZPjJoWg==", "RzuRA");
        SquireScurriusBox.lIIlIllIIIlll[SquireScurriusBox.lIIlIllIIlIII[6]] = SquireScurriusBox.lIlIllIIllIIlIl("KVIG4gGBUnDK8XIB6C0dWA==", "YohuR");
        SquireScurriusBox.lIIlIllIIIlll[SquireScurriusBox.lIIlIllIIlIII[7]] = SquireScurriusBox.lIlIllIIllIIlll("ASo1GkA=", "UKFqz");
    }
    ...
    private static String lIlIllIIllIIlll(String llllllllllllllIllllIlIlllIIllIIl, String llllllllllllllIllllIlIlllIIllIII) {
        ...
        while (SquireScurriusBox.lIlIllIIllIllII(llllllllllllllIllllIlIlllIIlIIlI, llllllllllllllIllllIlIlllIIlIIll)) {
            ...
            "".length();
            if (((0x38 ^ 0x3E) & ~(0 ^ 6)) > -" ".length()) continue;
            return null;
        }
    ...
    private static void lIlIllIIllIlIIl() {
        ...
        SquireScurriusBox.lIIlIllIIlIII[4] = " ".length();
        SquireScurriusBox.lIIlIllIIlIII[5] = "  ".length();
        SquireScurriusBox.lIIlIllIIlIII[6] = "   ".length();
