...
extends SquirePlugin {
    ...
    private static void llIIIIIlIlllIIl() {
        ...
        SquireWhisperer.lIlIllIllIIII[2] = " ".length();
        SquireWhisperer.lIlIllIllIIII[3] = "  ".length();
        SquireWhisperer.lIlIllIllIIII[4] = "   ".length();
        ...
        SquireWhisperer.lIlIllIllIIII[20] = "  ".length() ^ (0x82 ^ 0x93);
    ...
    private static void llIIIIIlIllIlIl() {
        ...
        SquireWhisperer.lIlIllIlIllII[SquireWhisperer.lIlIllIllIIII[0]] = SquireWhisperer.llIIIIIlIllIIll("rr2t3tbLmivJ30qY+qa1lSMbjeRbdxKh", "zTQEF");
        SquireWhisperer.lIlIllIlIllII[SquireWhisperer.lIlIllIllIIII[2]] = SquireWhisperer.llIIIIIlIllIlII("HeRcIOiPbDCSPnlmb0DWVqbWHMI/QQST", "RMkJx");
        SquireWhisperer.lIlIllIlIllII[SquireWhisperer.lIlIllIllIIII[3]] = SquireWhisperer.llIIIIIlIllIlII("ZS/xxq4fc5j8qH6k1oX89PvrFtDKGFebpwmC2V8b5OCDKilYmuSyJxGCFx67HusmgWOmlDB93OUcCtvNpkISXw==", "sfOpo");
    }
