...
extends SquirePlugin {
    ...
    private static void llIII() {
        ...
        CoinPouchReopener.lIlI[1] = " ".length();
        CoinPouchReopener.lIlI[2] = 1 ^ 0x15;
        CoinPouchReopener.lIlI[3] = "  ".length();
        CoinPouchReopener.lIlI[4] = "   ".length();
    ...
    private static void lIlll() {
        ...
        CoinPouchReopener.lIII[CoinPouchReopener.lIlI[0]] = CoinPouchReopener.lIll("FShJtTDU1c+IMvY4+ToYdA==", "NImAu");
        CoinPouchReopener.lIII[CoinPouchReopener.lIlI[1]] = CoinPouchReopener.lIlIl("DU7nlWvSk4pcHLl/Ga2qqQ==", "rDErm");
        CoinPouchReopener.lIII[CoinPouchReopener.lIlI[3]] = CoinPouchReopener.lIllI("KiQQOHQEOBk=", "eTuVY");
        CoinPouchReopener.lIII[CoinPouchReopener.lIlI[4]] = CoinPouchReopener.lIllI("NCYoOjkLLCA0PQ==", "dOKQI");
        CoinPouchReopener.lIII[CoinPouchReopener.lIlI[5]] = CoinPouchReopener.lIllI("NS8LPAgKJQMyDA==", "eFhWx");
    }
