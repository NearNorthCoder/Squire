...
extends SquirePlugin {
    ...
    private static void lIIIlIl() {
        ...
        GemCrafter.lIlIl[GemCrafter.lIllI[0]] = GemCrafter.lIIIIll("b5Tni/FhQuUv7xJiZESdPg==", "EQdhc");
        GemCrafter.lIlIl[GemCrafter.lIllI[1]] = GemCrafter.lIIIlII("MQgmIgc=", "ezGFb");
        GemCrafter.lIlIl[GemCrafter.lIllI[5]] = GemCrafter.lIIIIll("H7nLIZDkfSrk2aq5dreuCQ==", "qALDk");
        GemCrafter.lIlIl[GemCrafter.lIllI[7]] = GemCrafter.lIIIlII("AxcUPiY=", "WeuZC");
    }
    ...
    public void onGameTick(GameTick gameTick) {
        ...
        while (GemCrafter.lIIlIlI(llllllIIIIIllll, lIllI[8])) {
            ...
            ++llllllIIIIIllll;
            "".length();
            if (((5 ^ 0x2A ^ (0x5E ^ 0x48)) & (0x2F ^ 0x62 ^ (0x36 ^ 0x42) ^ -" ".length())) == 0) continue;
            return;
        }
    }
    ...
    private static void lIIIllI() {
        lIllI = new int[9];
        GemCrafter.lIllI[0] = (0x75 ^ 0x19 ^ (0xF5 ^ 0xC5)) & (0x20 ^ 0x10 ^ (0xEB ^ 0x87) ^ -" ".length());
        GemCrafter.lIllI[1] = " ".length();
