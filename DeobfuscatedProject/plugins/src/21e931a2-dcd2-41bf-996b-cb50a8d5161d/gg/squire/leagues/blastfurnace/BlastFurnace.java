...
extends SquirePlugin {
    ...
    private static String lIlIII(String llllllIlIlIllIl, String llllllIlIlIllII) {
        ...
        while (BlastFurnace.lIlllI(llllllIlIlIIllI, llllllIlIlIIlll)) {
            ...
            ++llllllIlIlIIllI;
            "".length();
            if (-" ".length() <= ((0x65 ^ 0x62) & ~(0 ^ 7))) continue;
            return null;
        }
    ...
    public void onGameTick(GameTick gameTick) {
        ...
        Item item3 = Inventory.getFirst(item -> {
            ...
            if (BlastFurnace.llIlII(item.getId(), lIIII[5]) && BlastFurnace.lIllll(item.isNoted() ? 1 : 0)) {
                ...
                "".length();
                if (-" ".length() > "   ".length()) {
                    return ((2 ^ 0x5A ^ (0x43 ^ 0x24)) & (0xB0 ^ 0x9E ^ (0x3D ^ 0x2C) ^ -" ".length())) != 0;
                }
            } else {
                n = lIIII[0];
            }
        ...
        TileObject tileObject2 = TileObjects.getNearest(tileObject -> {
            ...
            if (BlastFurnace.lIllII(tileObject.getName().contains(llll[lIIII[6]]) ? 1 : 0)) {
                ...
                if (BlastFurnace.lIllII(tileObject.hasAction(stringArray) ? 1 : 0)) {
                    ...
                    return ((0x52 ^ 0x72 ^ (0xB7 ^ 0x90)) & (0x73 ^ 0x68 ^ (0x33 ^ 0x2F) ^ -" ".length())) != 0;
                }
            }
            n = lIIII[0];
            return n != 0;
    ...
    private static void lIlIIl() {
        ...
        BlastFurnace.llll[BlastFurnace.lIIII[0]] = BlastFurnace.lIIlll("ugB0bmPV8hJuNY1xg0LvAw==", "woyzw");
        BlastFurnace.llll[BlastFurnace.lIIII[1]] = BlastFurnace.lIIlll("RcxwksnQirdQDIY1JbLjpXzAqpBJVs1xL8TF43peRtcyFTjud32I1zQLgVzjCZ5k", "KBuZm");
        BlastFurnace.llll[BlastFurnace.lIIII[2]] = BlastFurnace.lIlIII("DC0NA1IJIxMUUg0wDgpSHyoERxYCMRECHBgnEw==", "kBagr");
        BlastFurnace.llll[BlastFurnace.lIIII[6]] = BlastFurnace.lIlIII("KQgqIg8TCDZ0CA8LMA==", "jgDTj");
        BlastFurnace.llll[BlastFurnace.lIIII[7]] = BlastFurnace.lIIlll("PqEKLY8V8hrZGudCSqd6nQ==", "RRGtK");
        BlastFurnace.llll[BlastFurnace.lIIII[9]] = BlastFurnace.lIIlll("afzB6i7rz6zhoeALM/jiJA==", "jKdxq");
    }
    ...
    private static void lIlIlI() {
        ...
        BlastFurnace.lIIII[1] = " ".length();
        BlastFurnace.lIIII[2] = "  ".length();
