...
extends GameEnum10 {
    ...
    public an f(int n2) {
        ...
        if (((int)var2 >= 1) && ((int)var2 <= 2)) {
            return new an(au.BELLADONNA, n.GROWING, (int)(var2 - 1));
        }
        if (((int)var2 == 3)) {
            return new an(au.BELLADONNA, n.HARVESTABLE, 4);
        }
        if (((int)var2 >= 5) && ((int)var2 <= 6)) {
            return new an(au.BELLADONNA, n.DISEASED, (int)(var2 - 3));
        }
        if (((int)var2 >= 7) && ((int)var2 <= 8)) {
            return new an(au.BELLADONNA, n.DEAD, (int)(var2 - 6));
        }
