...
extends Config {
    public static final  String AUTOWEED;
    public static final  String FARM_TICK_OFFSET;
    public static final  String FARMING_LOCATION_BUSH;
    @ConfigSection(name="Default", description="Default Seeds", position=1, keyName="default")
    public static final  String DEFAULT;
    public static final  String FARMING_LOCATION_ALLOTMENT_NORTH;
    public static final  String CONFIG_GROUP;
    public static final  String FARMING_LOCATION_ENABLED;
    @ConfigSection(name="General", description="General settings", position=0, keyName="generalSection")
    public static final  String GENERAL;
    public static final  String FARM_TICK_OFFSET_PRECISION;
    public static final  String FARMING_LOCATION_SEAWEED;
    public static final  String TIME_CONFIG_GROUP;
    ...
    public static final  String FOSSIL_ISLAND_UNDERWATER;
    public static final  String FARMING_LOCATION_BIRDHOUSE;
    @ConfigSection(name="Birdhouses", description="Birdhouse settings", position=15, keyName="birdhouses")
    public static final  String BIRDHOUSES;
    ...
    public static final  String FARMING_LOCATION_FLOWER;
    ...
    public static final  String MONASTERY;
    public static final  String FARMING_LOCATION_GRAPES;
    @ConfigSection(name="Morytania", description="Morytania settings", position=5, keyName="morytania")
    public static final  String MORYTANIA;
    public static final  String FARMING_LOCATION_ALLOTMENT_SOUTH;
    public static final  String FARMING_LOCATION_BINS;
    public static final  String FARMING_LOCATION_HERB;
    @ConfigSection(name="Harmony", description="Harmony settings", position=8, keyName="harmony")
    public static final  String HARMONY;
    public static final  String STOPWATCHES;
    public static final  String NOTIFY;
    public static final  String BIRD_HOUSE;
    ...
    default public boolean harmonyCompostBin() {
        return ((6 ^ 0x5E ^ (0xBF ^ 0xA1)) & (52 + 8 - -64 + 8 ^ 141 + 128 - 262 + 187 ^ -1)) != 0;
    }
    ...
    default public boolean weissCompostBin() {
        return ((182 + 230 - 253 + 95 ^ 43 + 74 - 2 + 82) & (0x1C ^ 0x75 ^ (0xC2 ^ 0x90) ^ -1)) != 0;
    }
