...
extends Config {
    ...
    public static final  String fishingTrawlerSettings;
    @ConfigSection(name="Fish Settings", description="Settings related to fishing", position=10)
    public static final  String fishSettings;
    ...
    default public boolean tickFishing() {
        return ((0xD0 ^ 0xB1 ^ (0xE8 ^ 0xAC)) & (0x96 ^ 0xB2 ^ 1 ^ -1)) != 0;
    }
    ...
    default public boolean butlerBanking() {
        return ((0x64 ^ 0x62 ^ (0x63 ^ 0x71)) & (0x28 ^ 0x6C ^ (0x6F ^ 0x3F) ^ -1)) != 0;
    }
    ...
    default public boolean fishingTrawler() {
        return ((0x90 ^ 0x8E ^ (0x13 ^ 0x25)) & (1 ^ (0x1B ^ 0x32) ^ -1)) != 0;
    }
    ...
    default public boolean banking() {
        return ((23 + 3 - 21 + 167 ^ 25 + 55 - -5 + 62) & (15 + 58 - -65 + 15 ^ 18 + 160 - 86 + 74 ^ -1)) != 0;
    }
