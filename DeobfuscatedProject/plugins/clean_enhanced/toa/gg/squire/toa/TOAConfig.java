...
extends Config {
    ...
    public static final  String SCABARAS_SECTION_PUZZLE;
    ...
    public static final  String HET_SECTION_MIRRORS;
    ...
    default public int gearSwapDelay() {
        return (0xDB ^ 0xBF ^ (0xFA ^ 0xBA)) & (161 + 129 - 260 + 158 ^ 102 + 15 - 98 + 133 ^ -1);
    }
