...
extends Config {
    public static final  String SQUIRE_SARA_GROUP;
    ...
    default public boolean useBlowpipe() {
        return ((0x1F ^ 0x23 ^ (0x70 ^ 0x14)) & (0xD5 ^ 0x85 ^ (0xB0 ^ 0xB8) ^ -1)) != 0;
    }
    ...
    default public boolean turnOffRun() {
        return ((0x42 ^ 0x38 ^ (0x37 ^ 0x75)) & (127 + 115 - 194 + 87 ^ 61 + 40 - -9 + 81 ^ -1)) != 0;
    }
