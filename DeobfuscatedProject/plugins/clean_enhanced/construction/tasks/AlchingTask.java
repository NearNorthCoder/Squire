...
extends Task {
    private final  SquireAlchTeleportConfig eP;
    private static  int[] lIllIlI;
    private final  StunAlchTeleport eO;
    ...
    public boolean run() {
        ...
        if (aS.lIllIlIIl(var1.eP.stunAlchOnly() ? 1 : 0) && aS.lIllIlIlI(Players.getLocal().getAnimation(), lIllIlI[1])) {
            return lIllIlI[0];
        }
        Item var2 = Inventory.getFirst(Item::isNoted);
        if (aS.lIllIlIll(var2) && aS.lIllIlIll(var2 = Inventory.getFirst(item -> {
            boolean bl2;
        ...
        if (aS.lIllIllII(Skills.getLevel((SkiSkill.MAGIC), lIllIlI[2])) {
        ...
        Magic.cast((Spestandard2, (Item)var1_1);
        return lIllIlI[3];
    }
    ...
    @Inject
    public AlchingTask(StunAlchTeleport stunAlchTeleport, SquireAlchTeleportConfig squireAlchTeleportConfig) {
