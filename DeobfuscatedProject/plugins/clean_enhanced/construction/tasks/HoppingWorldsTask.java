...
extends Task {
    private  boolean an;
    private static  String[] llllll;
    private static  int[] lIIIIll;

    @Inject
    public HoppingWorldsTask() {
        this.an = lIIIIll[0];
    }
    ...
    public void b(ChatMessage chatMessage) {
        ...
        if (l.lIIIIlIlI(var2.contains(llllll[lIIIIll[0]]) ? 1 : 0)) {
            var3.an = lIIIIll[1];
        }
    }
    ...
    private static void lIIIIIllI() {
        ...
        l.llllll[l.lIIIIll[0]] = "Cerberus is already dealing";
    }
