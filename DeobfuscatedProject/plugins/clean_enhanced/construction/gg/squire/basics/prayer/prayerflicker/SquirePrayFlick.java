...
extends SquirePlugin {
    ...
    public void onGameTick(GameTick gameTick) {
        if (SquirePrayFlick.lIlIIIIIl(this.fu) && SquirePrayFlick.lIlIIIIlI(Prayers.isQuickPrayerEnabled() ? 1 : 0) && SquirePrayFlick.lIlIIIIIl(this.ft.keepPrayerOn() ? 1 : 0)) {
