...
extends SquirePlugin {
    ...
    public void onGameTick(GameTick gameTick) {
        PickupNoterPlugin var1;
        int n = l[1];
        if (PickupNoterPlugin.l(this.v.isEmpty() ? 1 : 0)) {
            return;
        }
        Iterator var2 = Inventory.getAll(item -> this.v.contains(item.getId())).iterator();
        while (PickupNoterPlugin.l(var2.hasNext() ? 1 : 0)) {
            void var3;
            Item var4 = (Item)var2.next();
            Inventory.use((int)var4.getId(), (int)var3);
            0;
            0;
            if (-2 <= 0) continue;
            return;
