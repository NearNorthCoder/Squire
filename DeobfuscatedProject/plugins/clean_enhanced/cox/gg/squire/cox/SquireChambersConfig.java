...
extends Config {
    ...
    default public boolean extraInfo() {
        return ((0x75 ^ 0x3A ^ (0x4B ^ 0x42)) & (0xE ^ 0x17 ^ (0x6A ^ 0x35) ^ -1)) != 0;
    }
    ...
    default public boolean pickupBrews() {
        return ((0x47 ^ 6 ^ (6 ^ 0)) & (50 + 85 - 77 + 159 ^ 43 + 133 - 148 + 130 ^ -1)) != 0;
    }
