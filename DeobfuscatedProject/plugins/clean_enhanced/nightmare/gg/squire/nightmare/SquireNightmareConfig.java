...
extends Config {
    ...
    public static final  String OUTSIDE_SETTINGS;
    ...
    public static final  String MISC_SETTINGS;
    ...
    default public boolean enableRestocking() {
        return ((0x73 ^ 0x6F ^ (0x15 ^ 0x29)) & (128 + 44 - 19 + 24 ^ 39 + 143 - 166 + 129 ^ -1)) != 0;
    }
    ...
    default public boolean neverTeleport() {
        return ((0x60 ^ 0x68 ^ (0x6F ^ 0x5D)) & (84 + 66 - 34 + 60 ^ 14 + 37 - -47 + 40 ^ -1)) != 0;
    }
    ...
    default public boolean lowerDamageFinalPhase() {
        return ((0xB1 ^ 0xA6 ^ (0x6D ^ 0x1A)) & (23 + 143 - 134 + 207 ^ 104 + 35 - 25 + 29 ^ -1)) != 0;
    }
    ...
    default public boolean restoreInPOH() {
        return ((70 + 81 - 83 + 131 ^ 86 + 49 - 60 + 59) & (0xE8 ^ 0xB1 ^ (0x13 ^ 0xB) ^ -1)) != 0;
    }
    ...
    default public boolean assistantMode() {
        return ((0x66 ^ 2 ^ (0x2C ^ 0x1E)) & (0xAE ^ 0xC4 ^ (0x90 ^ 0xAC) ^ -1)) != 0;
    }
