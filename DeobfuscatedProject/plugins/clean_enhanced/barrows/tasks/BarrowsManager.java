...
public class BarrowsManager {
    ...
    public int[] d(d d2) {
        switch (b.v[d2.ordinal()]) {
            case 1: {
                a var2;
                return var2.BarrowsManager(var2.u.ahrimSpecGear());
            }
            case 2: {
                a var2;
                return var2.BarrowsManager(var2.u.karilSpecGear());
            }
        }
    ...
    public int[] c(d d2) {
        switch (b.v[d2.ordinal()]) {
            case 1: {
                a var4;
                return var4.BarrowsManager(var4.u.ahrimGear());
            }
            case 2: {
                a var4;
                return var4.BarrowsManager(var4.u.karilGear());
            }
        }
    ...
    private static void var5() {
        var1 = new int[1];
        a.var1[0] = (4 ^ 0x66 ^ (0x72 ^ 0x19)) & (0xB3 ^ 0xB5 ^ (0x73 ^ 0x7C) ^ -1);
    }
