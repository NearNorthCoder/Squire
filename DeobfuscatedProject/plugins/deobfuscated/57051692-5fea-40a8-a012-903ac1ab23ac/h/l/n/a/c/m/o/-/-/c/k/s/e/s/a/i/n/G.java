                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                ...
                                if (2 <= ((0x7E ^ 0x1B ^ (0x76 ^ 0x57)) & (104 + 22 - -3 + 6 ^ 66 + 35 - -63 + 31 ^ -1))) {
                                    return ((83 + 86 - -50 + 9 ^ 19 + 85 - 8 + 84) & (68 + 131 - 50 + 88 ^ 112 + 151 - 140 + 66 ^ -1)) != 0;
                                }
                            } else {
                                bl = lIlIlIllII[0];
                            }
                    ...
                    if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray13), lIlIlIllII[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                ...
                                0;
                                if (null != null) {
                                    return ((123 + 177 - 199 + 82 ^ 107 + 117 - 127 + 79) & (42 + 46 - 28 + 119 ^ 152 + 175 - 255 + 108 ^ -1)) != 0;
                                }
                            } else {
                                bl = lIlIlIllII[0];
                            }
                                ...
                                if (G.lIIlIIIllIIII(Inventory.getCount((int[])nArray15), lIlIlIllII[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (G.lIIlIIIllIIll(Inventory.getCount((int[])nArray))) {
                                            ...
                                            0;
                                            if (null != null) {
                                                return ((54 + 202 - 126 + 109 ^ 64 + 87 - 48 + 37) & (0xD6 ^ 0x95 ^ (0x1A ^ 0x3A) ^ -1)) != 0;
                                            }
                                        } else {
                                            bl = lIlIlIllII[0];
                                        }
