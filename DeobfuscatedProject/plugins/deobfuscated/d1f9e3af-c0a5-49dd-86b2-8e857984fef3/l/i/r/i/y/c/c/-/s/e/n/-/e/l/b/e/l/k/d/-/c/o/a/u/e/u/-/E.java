...
implements W {
    ...
    private static void lllllIllIll() {
        ...
        E.lIIlIlllI[1] = (130 + 12 - 134 + 150 ^ 103 + 65 - 101 + 73) & (0x9E ^ 0xA6 ^ (0xA0 ^ 0x8A) ^ -1);
        E.lIIlIlllI[2] = 1;
    ...
    private static boolean ab() {
        ...
        if (E.llllllIIIII(Inventory.getCount((int[])f.aV))) {
            ...
            if (E.llllllIIIII(Inventory.getCount((int[])nArray))) {
                ...
                return ((192 + 82 - 202 + 157 ^ 1 + 31 - -132 + 20) & (82 + 46 - 57 + 82 ^ 31 + 191 - 160 + 134 ^ -1)) != 0;
            }
        }
        n2 = lIIlIlllI[1];
        return n2 != 0;
    ...
    private static void lllllIllIlI() {
        ...
        E.lIIlIllIl[E.lIIlIlllI[1]] = E."Drink";
        E.lIIlIllIl[E.lIIlIlllI[2]] = E."Finished buying items, switching back to quest";
        E.lIIlIllIl[E.lIIlIlllI[6]] = E."We are missing quest supplies, switching to BUYING";
        E.lIIlIllIl[E.lIIlIlllI[12]] = E."Break";
        E.lIIlIllIl[E.lIIlIlllI[5]] = E."Nav to start";
        E.lIIlIllIl[E.lIIlIlllI[10]] = E."Orlando Smith";
        E.lIIlIllIl[E.lIIlIlllI[16]] = E."Solving terror bird";
        E.lIIlIllIl[E.lIIlIlllI[21]] = E."Solving kalphite";
        E.lIIlIllIl[E.lIIlIlllI[13]] = E."Solving Monkey";
        E.lIIlIllIl[E.lIIlIlllI[17]] = E."Solving sea slug";
        E.lIIlIllIl[E.lIIlIlllI[9]] = E."Solving snake";
        E.lIIlIllIl[E.lIIlIlllI[30]] = E."Solving east snail";
        E.lIIlIllIl[E.lIIlIlllI[33]] = E."Solving wyvern";
        E.lIIlIllIl[E.lIIlIlllI[36]] = E."Solving dragon";
        E.lIIlIllIl[E.lIIlIlllI[39]] = E."Solving tort";
        E.lIIlIllIl[E.lIIlIlllI[42]] = E."Solving croc";
        E.lIIlIllIl[E.lIIlIlllI[45]] = E."Solving leech";
        E.lIIlIllIl[E.lIIlIlllI[48]] = E."Solving camel";
        E.lIIlIllIl[E.lIIlIlllI[51]] = E."Solving mole";
        E.lIIlIllIl[E.lIIlIlllI[54]] = E."Solving leech";
        E.lIIlIllIl[E.lIIlIlllI[57]] = E."Handing in quest";
        E.lIIlIllIl[E.lIIlIlllI[58]] = E."Nav to start";
        E.lIIlIllIl[E.lIIlIlllI[59]] = E."Talking";
        E.lIIlIllIl[E.lIIlIlllI[60]] = E."Orlando Smith";
        E.lIIlIllIl[E.lIIlIlllI[62]] = E."null question";
        E.lIIlIllIl[E.lIIlIlllI[63]] = E."Found answer";
        E.lIIlIllIl[E.lIIlIlllI[64]] = E."Study";
        E.lIIlIllIl[E.lIIlIlllI[69]] = E."Varrock Quiz";
        E.lIIlIllIl[E.lIIlIlllI[61]] = E."ring of wealth (";
        E.lIIlIllIl[E.lIIlIlllI[70]] = E."Spitting acid";
        E.lIIlIllIl[E.lIIlIlllI[71]] = E."Scarab beetles";
        E.lIIlIllIl[E.lIIlIlllI[72]] = E."Sight";
        E.lIIlIllIl[E.lIIlIlllI[73]] = E."Anti-dragon-breath shield";
        E.lIIlIllIl[E.lIIlIlllI[74]] = E."Twenty years";
        E.lIIlIllIl[E.lIIlIlllI[75]] = E."Al Kharid";
        E.lIIlIllIl[E.lIIlIlllI[76]] = E."Below room temperature";
        E.lIIlIllIl[E.lIIlIlllI[77]] = E."Harmless";
        E.lIIlIllIl[E.lIIlIlllI[78]] = E."Nematocysts";
        E.lIIlIllIl[E.lIIlIlllI[79]] = E."Reptiles";
        E.lIIlIllIl[E.lIIlIlllI[80]] = E."Old battle sites";
        E.lIIlIllIl[E.lIIlIlllI[11]] = E."The Slayer Masters";
        E.lIIlIllIl[E.lIIlIlllI[81]] = E."Stones";
        E.lIIlIllIl[E.lIIlIlllI[82]] = E."Stomach acid";
        E.lIIlIllIl[E.lIIlIlllI[83]] = E."During breeding";
        E.lIIlIllIl[E.lIIlIlllI[84]] = E."Ardougne";
        E.lIIlIllIl[E.lIIlIlllI[85]] = E."Red";
        E.lIIlIllIl[E.lIIlIlllI[86]] = E."Lamellae";
        E.lIIlIllIl[E.lIIlIlllI[87]] = E."Subterranean";
        E.lIIlIllIl[E.lIIlIlllI[88]] = E."It is resistant to acid";
        E.lIIlIllIl[E.lIIlIlllI[89]] = E."Sunlight";
        E.lIIlIllIl[E.lIIlIlllI[0]] = E."Scabaras";
        E.lIIlIllIl[E.lIIlIlllI[90]] = E."Pasha";
        E.lIIlIllIl[E.lIIlIlllI[91]] = E."Eating plants";
        E.lIIlIllIl[E.lIIlIlllI[92]] = E."It doubles in size";
        E.lIIlIllIl[E.lIIlIlllI[93]] = E."Unknown";
        E.lIIlIllIl[E.lIIlIlllI[94]] = E."Defence";
        E.lIIlIllIl[E.lIIlIlllI[95]] = E."Vegetables";
        E.lIIlIllIl[E.lIIlIlllI[96]] = E."Bitternuts";
        E.lIIlIllIl[E.lIIlIlllI[97]] = E."Cold";
        E.lIIlIllIl[E.lIIlIlllI[98]] = E."They attack by jumping";
        E.lIIlIllIl[E.lIIlIlllI[99]] = E."Annoyed";
        E.lIIlIllIl[E.lIIlIlllI[100]] = E."Gnomes";
        E.lIIlIllIl[E.lIIlIlllI[101]] = E."Twelve";
        E.lIIlIllIl[E.lIIlIlllI[102]] = E."Wyson the Gardener";
        E.lIIlIllIl[E.lIIlIlllI[103]] = E."Hair";
        E.lIIlIllIl[E.lIIlIlllI[104]] = E."The Talpidae family";
        E.lIIlIllIl[E.lIIlIlllI[105]] = E."Squamata";
        E.lIIlIllIl[E.lIIlIlllI[106]] = E."Mibbiwocket";
        E.lIIlIllIl[E.lIIlIlllI[107]] = E."Apples";
        E.lIIlIllIl[E.lIIlIlllI[108]] = E."Four";
        E.lIIlIllIl[E.lIIlIlllI[109]] = E."Squamata";
        E.lIIlIllIl[E.lIIlIlllI[110]] = E."Worker";
        E.lIIlIllIl[E.lIIlIlllI[111]] = E."'Y'-shaped";
        E.lIIlIllIl[E.lIIlIlllI[112]] = E."An operculum";
        E.lIIlIllIl[E.lIIlIlllI[113]] = E."Climate change";
        E.lIIlIllIl[E.lIIlIlllI[114]] = E."Three";
        E.lIIlIllIl[E.lIIlIlllI[115]] = E."Dragons";
        E.lIIlIllIl[E.lIIlIlllI[116]] = E."Social";
        E.lIIlIllIl[E.lIIlIlllI[117]] = E."Acid-spitting snail";
        E.lIIlIllIl[E.lIIlIlllI[118]] = E."Milk";
        E.lIIlIllIl[E.lIIlIlllI[119]] = E."Seaweed";
        E.lIIlIllIl[E.lIIlIlllI[120]] = E."Orlando Smith";
        E.lIIlIllIl[E.lIIlIlllI[121]] = E."Simian";
        E.lIIlIllIl[E.lIIlIlllI[122]] = E."Omnivore";
        E.lIIlIllIl[E.lIIlIlllI[123]] = E."Runite";
        E.lIIlIllIl[E.lIIlIlllI[124]] = E."It becomes sleepy";
        E.lIIlIllIl[E.lIIlIlllI[125]] = E."They have";
        E.lIIlIllIl[E.lIIlIlllI[126]] = E."Admiral Bake";
        E.lIIlIllIl[E.lIIlIlllI[127]] = E."Two";
        E.lIIlIllIl[E.lIIlIlllI[128]] = E."Toxic dung";
        E.lIIlIllIl[E.lIIlIlllI[129]] = E."Constriction";
        E.lIIlIllIl[E.lIIlIlllI[130]] = E."Elemental";
        E.lIIlIllIl[E.lIIlIlllI[131]] = E."Seaweed";
        E.lIIlIllIl[E.lIIlIlllI[132]] = E."A layer of fat";
        E.lIIlIllIl[E.lIIlIlllI[133]] = E."Anywhere";
        E.lIIlIllIl[E.lIIlIlllI[134]] = E."Fireproof oil";
        E.lIIlIllIl[E.lIIlIlllI[135]] = E."Asgarnia";
        E.lIIlIllIl[E.lIIlIlllI[136]] = E."0";
        E.lIIlIllIl[E.lIIlIlllI[137]] = E."Contracting and stretching";
        E.lIIlIllIl[E.lIIlIlllI[138]] = E."Insects and other invertebrates";
        E.lIIlIllIl[E.lIIlIlllI[68]] = E."Environment";
        E.lIIlIllIl[E.lIIlIlllI[139]] = E."The researchers";
        E.lIIlIllIl[E.lIIlIlllI[140]] = E."A labour";
        E.lIIlIllIl[E.lIIlIlllI[141]] = E."Water";
        E.lIIlIllIl[E.lIIlIlllI[142]] = E."Anything";
        E.lIIlIllIl[E.lIIlIlllI[143]] = E."Gnomes";
        E.lIIlIllIl[E.lIIlIlllI[144]] = E."Planning";
        E.lIIlIllIl[E.lIIlIlllI[145]] = E."Hard shell";
        E.lIIlIllIl[E.lIIlIlllI[146]] = E."Seeing how you smell";
        E.lIIlIllIl[E.lIIlIlllI[147]] = E."Tongue";
        E.lIIlIllIl[E.lIIlIlllI[148]] = E."Two";
        E.lIIlIllIl[E.lIIlIlllI[149]] = E."Carnivores";
        E.lIIlIllIl[E.lIIlIlllI[150]] = E."They dig holes";
        E.lIIlIllIl[E.lIIlIlllI[165]] = E."Sure thing.";
    }
