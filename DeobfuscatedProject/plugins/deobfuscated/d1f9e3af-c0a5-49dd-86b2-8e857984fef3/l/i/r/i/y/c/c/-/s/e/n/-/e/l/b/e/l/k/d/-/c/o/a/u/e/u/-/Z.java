...
implements W {
    ...
    public int T() {
        ...
        if (null != null) {
            return (0x2D ^ 0x1A ^ (0xBC ^ 0x87)) & (0xF2 ^ 0xA9 ^ (0x18 ^ 0x4F) ^ -1);
        }
        return llIIIIlll[0];
    }
    ...
    private static String lIlIIIlllIIl(String lIlllIIllllIll, String lIlllIIllllIlI) {
        ...
        while (Z.lIlIIlIIlIlI(lIlllIIllIllll, lIlllIIlllIIII)) {
            ...
            ++lIlllIIllIllll;
            0;
            if (((0xA0 ^ 0x96 ^ (0x3D ^ 0x25)) & (184 + 155 - 243 + 141 ^ 36 + 120 - -11 + 28 ^ -1)) == 0) continue;
            return null;
        }
    ...
    private static void lIlIIlIIIllI() {
        ...
        Z.llIIIIlIl[Z.llIIIIlll[0]] = Z."Buying items";
        Z.llIIIIlIl[Z.llIIIIlll[1]] = Z."Finished buying items, switching back to melee training";
        Z.llIIIIlIl[Z.llIIIIlll[3]] = Z."Navigating to bank";
        Z.llIIIIlIl[Z.llIIIIlll[4]] = Z."Handling banking";
        Z.llIIIIlIl[Z.llIIIIlll[6]] = Z."We are missing supplies, switching to BUYING";
        Z.llIIIIlIl[Z.llIIIIlll[10]] = Z."Iron scimitar";
        Z.llIIIIlIl[Z.llIIIIlll[14]] = Z."Steel scimitar";
        Z.llIIIIlIl[Z.llIIIIlll[15]] = Z."Mithril scimitar";
        Z.llIIIIlIl[Z.llIIIIlll[18]] = Z."Eat";
        Z.llIIIIlIl[Z.llIIIIlll[19]] = Z."Walking to cow area";
        Z.llIIIIlIl[Z.llIIIIlll[20]] = Z."Killing cows";
        Z.llIIIIlIl[Z.llIIIIlll[21]] = Z."Cow";
        Z.llIIIIlIl[Z.llIIIIlll[22]] = Z."cow";
        Z.llIIIIlIl[Z.llIIIIlll[23]] = Z."Attack";
        Z.llIIIIlIl[Z.llIIIIlll[24]] = Z."Attack";
        Z.llIIIIlIl[Z.llIIIIlll[13]] = Z."Auto retaliate";
        Z.llIIIIlIl[Z.llIIIIlll[25]] = Z."";
        Z.llIIIIlIl[Z.llIIIIlll[28]] = Z."Iron scimitar";
        Z.llIIIIlIl[Z.llIIIIlll[29]] = Z."Iron scimitar";
        Z.llIIIIlIl[Z.llIIIIlll[30]] = Z."Wield";
        Z.llIIIIlIl[Z.llIIIIlll[2]] = Z."Steel scimitar";
        Z.llIIIIlIl[Z.llIIIIlll[31]] = Z."Steel scimitar";
        Z.llIIIIlIl[Z.llIIIIlll[32]] = Z."Wield";
        Z.llIIIIlIl[Z.llIIIIlll[34]] = Z."Mithril scimitar";
        Z.llIIIIlIl[Z.llIIIIlll[35]] = Z."Mithril scimitar";
        Z.llIIIIlIl[Z.llIIIIlll[36]] = Z."Wield";
        Z.llIIIIlIl[Z.llIIIIlll[38]] = Z."Wield";
        Z.llIIIIlIl[Z.llIIIIlll[39]] = Z."Wield";
        Z.llIIIIlIl[Z.llIIIIlll[41]] = Z."Wear";
        Z.llIIIIlIl[Z.llIIIIlll[43]] = Z."Wear";
        Z.llIIIIlIl[Z.llIIIIlll[33]] = Z."Wear";
        Z.llIIIIlIl[Z.llIIIIlll[46]] = Z."Wear";
        Z.llIIIIlIl[Z.llIIIIlll[48]] = Z."Wear";
        Z.llIIIIlIl[Z.llIIIIlll[50]] = Z."Wear";
        Z.llIIIIlIl[Z.llIIIIlll[57]] = Z."20 Def";
        Z.llIIIIlIl[Z.llIIIIlll[58]] = Z."Cow";
    }
    ...
    public boolean V() {
        ...
        if (Z.lIlIIlIIlllI(Skills.getLevel((Skill)Skill.DEFENCE), llIIIIlll[2])) {
            ...
            0;
            if (2 > 2) {
                return ((0x40 ^ 0x47 ^ (0x49 ^ 0x10)) & (60 + 163 - 45 + 29 ^ 126 + 50 - 101 + 70 ^ -1)) != 0;
            }
        } else {
            bl = llIIIIlll[0];
        }
