...
implements W {
    ...
    private static boolean ab() {
        ...
        if (ag.lIIllIllIIII(Skills.getLevel((Skill)Skill.COOKING), lIlllIIlI[5]) && ag.lIIllIlIllII(Skills.getLevel((Skill)Skill.COOKING), lIlllIIlI[8])) {
            ...
            if (ag.lIIllIlIllll(Inventory.getCount((int[])nArray))) {
                ...
                0;
                if (null != null) {
                    return ((0xAE ^ 0x9E ^ (0xB2 ^ 0x99)) & (0x43 ^ 0x69 ^ (0x19 ^ 0x28) ^ -1)) != 0;
                }
            } else {
                bl3 = lIlllIIlI[0];
            }
    ...
    private static void lIIllIlIlIIl() {
        ...
        ag.lIlllIIIl[ag.lIlllIIlI[0]] = ag."Buying items";
        ag.lIlllIIIl[ag.lIlllIIlI[1]] = ag."Finished buying items, switching back to cooking";
        ag.lIlllIIIl[ag.lIlllIIlI[2]] = ag."Navigating to bank";
        ag.lIlllIIIl[ag.lIlllIIlI[3]] = ag."Handling banking";
        ag.lIlllIIIl[ag.lIlllIIlI[7]] = ag."We are missing supplies, switching to BUYING";
        ag.lIlllIIIl[ag.lIlllIIlI[10]] = ag."We are missing supplies, switching to BUYING";
        ag.lIlllIIIl[ag.lIlllIIlI[12]] = ag."We are missing supplies, switching to BUYING";
        ag.lIlllIIIl[ag.lIlllIIlI[15]] = ag."Equiping duel";
        ag.lIlllIIIl[ag.lIlllIIlI[16]] = ag."Wear";
        ag.lIlllIIIl[ag.lIlllIIlI[17]] = ag."Navigate to range";
        ag.lIlllIIIl[ag.lIlllIIlI[18]] = ag."Cooking";
        ag.lIlllIIIl[ag.lIlllIIlI[19]] = ag."Range";
        ag.lIlllIIIl[ag.lIlllIIlI[20]] = ag."Cook";
        ag.lIlllIIIl[ag.lIlllIIlI[34]] = ag."Cooking";
        ag.lIlllIIIl[ag.lIlllIIlI[36]] = ag."ring of wealth (";
        ag.lIlllIIIl[ag.lIlllIIlI[5]] = ag."ring of dueling(";
    }
