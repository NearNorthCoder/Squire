...
implements W {
    ...
    private static void lIIIllllIIlI() {
        ...
        n.lIlIlIIll[n.lIlIlIlIl[1]] = n."reset aggro timer";
        n.lIlIlIIll[n.lIlIlIlIl[0]] = n."Navigating to bank";
        n.lIlIlIIll[n.lIlIlIlIl[3]] = n."Handling banking";
        n.lIlIlIIll[n.lIlIlIlIl[10]] = n."Nav to sand crabs";
        n.lIlIlIIll[n.lIlIlIlIl[12]] = n."Drink";
        n.lIlIlIIll[n.lIlIlIlIl[13]] = n."Nav to veos";
        n.lIlIlIIll[n.lIlIlIlIl[14]] = n."Handle veos chat";
        n.lIlIlIIll[n.lIlIlIlIl[15]] = n."Veos";
        n.lIlIlIIll[n.lIlIlIlIl[16]] = n."Port Piscarilius";
        n.lIlIlIIll[n.lIlIlIlIl[17]] = n."Port Piscarilius";
        n.lIlIlIIll[n.lIlIlIlIl[8]] = n."Port Piscarilius";
        n.lIlIlIIll[n.lIlIlIlIl[18]] = n."Veos";
        n.lIlIlIIll[n.lIlIlIlIl[19]] = n."Eat";
        n.lIlIlIIll[n.lIlIlIlIl[20]] = n."Afking in spot";
        n.lIlIlIIll[n.lIlIlIlIl[21]] = n."Being crashed";
        n.lIlIlIIll[n.lIlIlIlIl[22]] = n."Attacking crashed";
        n.lIlIlIIll[n.lIlIlIlIl[23]] = n."Attack";
        n.lIlIlIIll[n.lIlIlIlIl[30]] = n."Resetting";
        n.lIlIlIIll[n.lIlIlIlIl[34]] = n."Sand Crabs";
        n.lIlIlIIll[n.lIlIlIlIl[36]] = n."sand crab";
        n.lIlIlIIll[n.lIlIlIlIl[60]] = n."That's great, can you take me there please?";
        n.lIlIlIIll[n.lIlIlIlIl[61]] = n."Can you take me to Great Kourend?";
        n.lIlIlIIll[n.lIlIlIlIl[62]] = n."Goodbye.";
    }
    ...
    private static String lIIIlllIllIl(String lllIIlllIlllll, String lllIIlllIllllI) {
        ...
        while (n.lIIIllllIlII(lllIIlllIlIIll, lllIIlllIlIlII)) {
            ...
            ++lllIIlllIlIIll;
            0;
            if ((0x2F ^ 0x20 ^ (0x4C ^ 0x47)) >= 1) continue;
            return null;
        }
        ...
        if (n.lIIIllllIlIl(list.isEmpty() ? 1 : 0) && n.lIIIllllllII(list.size(), lIlIlIlIl[0])) {
            ...
            while (n.lIIIllllIlII(lllIIllllIlllI, lllIIllllIllll.size())) {
                ...
                if (n.lIIIllllIlll(((Player)lllIIllllIllll.get(lllIIllllIlllI)).equals(Players.getLocal()) ? 1 : 0)) {
                    0;
                    if (((103 + 45 - 93 + 72 ^ (0x36 ^ 0x56)) & (0xC0 ^ 0xBE ^ (0xF4 ^ 0x95) ^ -1)) > 1) {
                        return ((0xE2 ^ 0x9A ^ (0x3B ^ 0x5D)) & (7 + 24 - -87 + 103 ^ 154 + 183 - 152 + 10 ^ -1)) != 0;
                    }
                ...
                0;
                if (2 >= 2) continue;
                return ((0x63 ^ 2 ^ (0x37 ^ 0x77)) & (0xA1 ^ 0xAC ^ (0x17 ^ 0x3B) ^ -1)) != 0;
            }
        }
        return lIlIlIlIl[1];
    }
    ...
    public int T() {
        ...
        if (null != null) {
            return (0x33 ^ 0x10 ^ (0x90 ^ 0x87)) & (3 ^ (0x6F ^ 0x58) ^ -1);
        }
        return lIlIlIlIl[33];
    }
