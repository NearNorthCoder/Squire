...
public class v {
    ...
    private static void lllIIllIlIII() {
        ...
        v.lIIIIllllI[v.lIIIIlllll[0]] = v."Buying items";
        v.lIIIIllllI[v.lIIIIlllll[1]] = v."Finished buying items, switching back to gearing";
        v.lIIIIllllI[v.lIIIIlllll[2]] = v."Get Mage Gear Util";
        v.lIIIIllllI[v.lIIIIlllll[3]] = v."Navigating to bank";
        v.lIIIIllllI[v.lIIIIlllll[4]] = v."Opening bank";
        v.lIIIIllllI[v.lIIIIlllll[6]] = v."Handling banking";
        v.lIIIIllllI[v.lIIIIlllll[9]] = v."We are missing supplies, switching to BUYING Util";
        v.lIIIIllllI[v.lIIIIlllll[10]] = v."Wear";
        v.lIIIIllllI[v.lIIIIlllll[11]] = v."Wear";
        v.lIIIIllllI[v.lIIIIlllll[12]] = v."Wield";
        v.lIIIIllllI[v.lIIIIlllll[13]] = v."Wield";
        v.lIIIIllllI[v.lIIIIlllll[14]] = v."Equip";
        v.lIIIIllllI[v.lIIIIlllll[15]] = v."Equip";
        v.lIIIIllllI[v.lIIIIlllll[17]] = v."Staff of air";
        v.lIIIIllllI[v.lIIIIlllll[18]] = v."Leather gloves";
        v.lIIIIllllI[v.lIIIIlllll[19]] = v."Staff of air";
        v.lIIIIllllI[v.lIIIIlllll[20]] = v."Leather gloves";
        v.lIIIIllllI[v.lIIIIlllll[38]] = v."Wear";
        v.lIIIIllllI[v.lIIIIlllll[39]] = v."Wear";
        v.lIIIIllllI[v.lIIIIlllll[40]] = v."ring of wealth (";
    }
                    ...
                    if (v.lllIIllIlIll(Inventory.getCount((int[])nArray12), lIIIIlllll[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (v.lllIIllIlllI(Inventory.getCount((int[])nArray))) {
                                ...
                                0;
                                if (3 == 0) {
                                    return ((146 + 46 - 19 + 27 ^ 47 + 146 - 187 + 150) & (63 + 68 - -38 + 27 ^ 77 + 142 - 164 + 89 ^ -1)) != 0;
                                }
                            } else {
                                bl = lIIIIlllll[0];
                            }
