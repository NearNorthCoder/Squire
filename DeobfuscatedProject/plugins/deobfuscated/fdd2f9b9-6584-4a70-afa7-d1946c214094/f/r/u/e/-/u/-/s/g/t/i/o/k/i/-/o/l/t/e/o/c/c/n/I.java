...
implements G {
        ...
        if (I.lllIllIlllII(I.cu() ? 1 : 0)) {
            ...
            if (I.lllIllIllIlI(lIIIlllIIlll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && I.lllIllIlllIl(lIIIlllIIIIl = TileObjects.getNearest(tileObject -> {
                ...
                if (I.lllIllIllIlI(tileObject.getName().contains(lIIIlIlIlI[lIIIllIIII[216]]) ? 1 : 0) && I.lllIlllIIIlI(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIIllIIII[217], lIIIllIIII[128], lIIIllIIII[3])), lIIIllIIII[3])) {
                    ...
                    0;
                    if (3 != 3) {
                        return ((0x69 ^ 8 ^ (0x79 ^ 0x37)) & (0xA5 ^ 0xC4 ^ (0x8D ^ 0xC3) ^ -1)) != 0;
                    }
                } else {
                    n2 = lIIIllIIII[0];
                }
            ...
            if (I.lllIllIllIlI(lIIIlllIIllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && I.lllIllIlllIl(lIIIlllIIIIl = TileObjects.getNearest(tileObject -> {
                ...
                if (I.lllIllIllIlI(tileObject.getName().contains(lIIIlIlIlI[lIIIllIIII[213]]) ? 1 : 0) && I.lllIlllIIIlI(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIIllIIII[214], lIIIllIIII[215], lIIIllIIII[3])), lIIIllIIII[3])) {
                    n2 = lIIIllIIII[1];
                    0;
                    if (((0x25 ^ 0x12 ^ (0xF ^ 0x6B)) & (170 + 7 - 168 + 210 ^ 64 + 70 - 97 + 99 ^ -1)) < 0) {
                        return ((66 + 39 - 50 + 107 ^ 101 + 117 - 128 + 38) & (0x34 ^ 0x5B ^ (0x44 ^ 9) ^ -1)) != 0;
                    }
                } else {
                    n2 = lIIIllIIII[0];
                }
            ...
            if (I.lllIllIllIlI(lIIIlllIIlII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && I.lllIllIlllIl(lIIIlllIIIIl = TileObjects.getNearest(tileObject -> {
                ...
                if (I.lllIllIllIlI(tileObject.getName().contains(lIIIlIlIlI[lIIIllIIII[208]]) ? 1 : 0) && I.lllIlllIIIlI(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIIllIIII[209], lIIIllIIII[210], lIIIllIIII[3])), lIIIllIIII[3])) {
                    n2 = lIIIllIIII[1];
                    0;
                    if (((0xF9 ^ 0x89 ^ (0xE3 ^ 0xB0)) & (0x95 ^ 0xB8 ^ (0x51 ^ 0x5F) ^ -1)) > 0) {
                        return ((3 ^ 0x2D ^ (0x8A ^ 0x8D)) & (55 + 30 - 70 + 170 ^ 131 + 139 - 180 + 54 ^ -1)) != 0;
                    }
                } else {
                    n2 = lIIIllIIII[0];
                }
                ...
                if (I.lllIllIllIlI(lIIlIIlIIIII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && I.lllIllIlllII(I.cu() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (I.lllIllIllllI(Skills.getExperience((Skill)Skill.AGILITY), lIIlIIIllIII)) {
                            ...
                            0;
                            if (null != null) {
                                return ((37 + 151 - -11 + 20 ^ 77 + 151 - 155 + 123) & (0x5C ^ 0x50 ^ (0x53 ^ 0x40) ^ -1)) != 0;
                            }
                        } else {
                            bl = lIIIllIIII[0];
                        }
                ...
                if (I.lllIllIllIlI(lIIlIIIlllll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && I.lllIllIlllII(I.cu() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (I.lllIllIllllI(Skills.getExperience((Skill)Skill.AGILITY), lIIlIIIllIII)) {
                            ...
                            0;
                            if (1 < 0) {
                                return ((0x96 ^ 0xB5 ^ (0xB ^ 0x79)) & (0xEF ^ 0x9B ^ (0x10 ^ 0x35) ^ -1)) != 0;
                            }
                        } else {
                            bl = lIIIllIIII[0];
                        }
                ...
                if (I.lllIllIllIlI(lIIlIIIllIlI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && I.lllIllIlllII(I.cu() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (I.lllIllIllllI(Skills.getExperience((Skill)Skill.AGILITY), lIIlIIIllIII)) {
                            ...
                            0;
                            if (3 != 3) {
                                return ((230 + 226 - 287 + 73 ^ 119 + 113 - 46 + 3) & (0x48 ^ 3 ^ (0x71 ^ 0x75) ^ -1)) != 0;
                            }
                        } else {
                            bl = lIIIllIIII[0];
                        }
        ...
        if (I.lllIllIllIlI(Inventory.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (I.lllIllIllIlI(Inventory.contains((int[])nArray4) ? 1 : 0)) {
                ...
                if (!(!I.lllIllIllIlI(Inventory.contains((int[])nArray5) ? 1 : 0) || I.lllIllIlllII(Inventory.contains(item -> item.getName().contains(lIIIlIlIlI[lIIIllIIII[205]])) ? 1 : 0) && !I.lllIllIllIlI(Equipment.contains(item -> item.getName().contains(lIIIlIlIlI[lIIIllIIII[204]])) ? 1 : 0) || I.lllIllIlllII(Inventory.contains((int[])f.bf) ? 1 : 0) && !I.lllIllIllIlI(Equipment.contains((int[])f.bf) ? 1 : 0))) {
                    ...
                    0;
                    if (-2 <= 0) return n2 != 0;
                    return ((3 ^ 0x5F ^ (0xDA ^ 0xAF)) & (166 + 80 - 72 + 14 ^ 67 + 98 - 106 + 90 ^ -1)) != 0;
                }
            }
        }
        n2 = lIIIllIIII[0];
    ...
    private static void lllIllIIlllI() {
        ...
        I.lIIIlIlIlI[I.lIIIllIIII[0]] = I."Buying items";
        I.lIIIlIlIlI[I.lIIIllIIII[1]] = I."Finished buying items, switching back to agility";
        I.lIIIlIlIlI[I.lIIIllIIII[3]] = I."Navigating to bank";
        I.lIIIlIlIlI[I.lIIIllIIII[10]] = I."Handling banking";
        I.lIIIlIlIlI[I.lIIIllIIII[17]] = I."We are missing quest supplies, switching to BUYING";
        I.lIIIlIlIlI[I.lIIIllIIII[2]] = I."Vial";
        I.lIIIlIlIlI[I.lIIIllIIII[20]] = I."Vial";
        I.lIIIlIlIlI[I.lIIIllIIII[22]] = I."Drop";
        I.lIIIlIlIlI[I.lIIIllIIII[24]] = I."Drink";
        I.lIIIlIlIlI[I.lIIIllIIII[26]] = I."Eat";
        I.lIIIlIlIlI[I.lIIIllIIII[12]] = I."Nav to gnome course";
        I.lIIIlIlIlI[I.lIIIllIIII[49]] = I."Crossing log";
        I.lIIIlIlIlI[I.lIIIllIIII[63]] = I."Log balance";
        I.lIIIlIlIlI[I.lIIIllIIII[64]] = I."Walk-across";
        I.lIIIlIlIlI[I.lIIIllIIII[53]] = I."Climbing net";
        I.lIIIlIlIlI[I.lIIIllIIII[38]] = I."Obstacle net";
        I.lIIIlIlIlI[I.lIIIllIIII[65]] = I."Climb-over";
        I.lIIIlIlIlI[I.lIIIllIIII[66]] = I."Climbing branch";
        I.lIIIlIlIlI[I.lIIIllIIII[54]] = I."Tree branch";
        I.lIIIlIlIlI[I.lIIIllIIII[67]] = I."Climb";
        I.lIIIlIlIlI[I.lIIIllIIII[40]] = I."Crossing rope";
        I.lIIIlIlIlI[I.lIIIllIIII[68]] = I."Balancing rope";
        I.lIIIlIlIlI[I.lIIIllIIII[61]] = I."Walk-on";
        I.lIIIlIlIlI[I.lIIIllIIII[69]] = I."Climbing down";
        I.lIIIlIlIlI[I.lIIIllIIII[70]] = I."Tree branch";
        I.lIIIlIlIlI[I.lIIIllIIII[41]] = I."Climb-down";
        I.lIIIlIlIlI[I.lIIIllIIII[71]] = I."Climbing net";
        I.lIIIlIlIlI[I.lIIIllIIII[72]] = I."Obstacle net";
        I.lIIIlIlIlI[I.lIIIllIIII[73]] = I."Climb-over";
        I.lIIIlIlIlI[I.lIIIllIIII[74]] = I."Crossing pipe";
        I.lIIIlIlIlI[I.lIIIllIIII[42]] = I."Obstacle pipe";
        I.lIIIlIlIlI[I.lIIIllIIII[75]] = I."Squeeze-through";
        I.lIIIlIlIlI[I.lIIIllIIII[95]] = I."Nav to start";
        I.lIIIlIlIlI[I.lIIIllIIII[97]] = I."Mark of grace";
        I.lIIIlIlIlI[I.lIIIllIIII[98]] = I."Taking mark";
        I.lIIIlIlIlI[I.lIIIllIIII[99]] = I."Found mark on ground";
        I.lIIIlIlIlI[I.lIIIllIIII[100]] = I."Take";
        I.lIIIlIlIlI[I.lIIIllIIII[101]] = I."Starting course";
        I.lIIIlIlIlI[I.lIIIllIIII[102]] = I."Rough wall";
        I.lIIIlIlIlI[I.lIIIllIIII[103]] = I."Climb";
        I.lIIIlIlIlI[I.lIIIllIIII[37]] = I."Crossing clothes line";
        I.lIIIlIlIlI[I.lIIIllIIII[105]] = I."Clothes line";
        I.lIIIlIlIlI[I.lIIIllIIII[106]] = I."Cross";
        I.lIIIlIlIlI[I.lIIIllIIII[107]] = I."Leaping";
        I.lIIIlIlIlI[I.lIIIllIIII[108]] = I."Gap";
        I.lIIIlIlIlI[I.lIIIllIIII[109]] = I."Leap";
        I.lIIIlIlIlI[I.lIIIllIIII[110]] = I."Balancing";
        I.lIIIlIlIlI[I.lIIIllIIII[111]] = I."Wall";
        I.lIIIlIlIlI[I.lIIIllIIII[112]] = I."Balance";
        I.lIIIlIlIlI[I.lIIIllIIII[113]] = I."Jumping gap";
        I.lIIIlIlIlI[I.lIIIllIIII[39]] = I."Gap";
        I.lIIIlIlIlI[I.lIIIllIIII[7]] = I."Leap";
        I.lIIIlIlIlI[I.lIIIllIIII[114]] = I."Jumping gap 2";
        I.lIIIlIlIlI[I.lIIIllIIII[116]] = I."Leap";
        I.lIIIlIlIlI[I.lIIIllIIII[117]] = I."Jumping gap 3";
        I.lIIIlIlIlI[I.lIIIllIIII[119]] = I."Leap";
        I.lIIIlIlIlI[I.lIIIllIIII[120]] = I."Hurdle roof";
        I.lIIIlIlIlI[I.lIIIllIIII[122]] = I."Hurdle";
        I.lIIIlIlIlI[I.lIIIllIIII[123]] = I."Finishing course";
        I.lIIIlIlIlI[I.lIIIllIIII[124]] = I."Edge";
        I.lIIIlIlIlI[I.lIIIllIIII[44]] = I."Jump-off";
        I.lIIIlIlIlI[I.lIIIllIIII[140]] = I."Nav to canafis course";
        I.lIIIlIlIlI[I.lIIIllIIII[6]] = I."Nav to start";
        I.lIIIlIlIlI[I.lIIIllIIII[141]] = I."Starting course";
        I.lIIIlIlIlI[I.lIIIllIIII[142]] = I."Tall tree";
        I.lIIIlIlIlI[I.lIIIllIIII[143]] = I."Climb";
        I.lIIIlIlIlI[I.lIIIllIIII[144]] = I."Mark of grace";
        I.lIIIlIlIlI[I.lIIIllIIII[145]] = I."Taking mark";
        I.lIIIlIlIlI[I.lIIIllIIII[146]] = I."Found mark on ground";
        I.lIIIlIlIlI[I.lIIIllIIII[147]] = I."Take";
        I.lIIIlIlIlI[I.lIIIllIIII[148]] = I."Jumping gap 1";
        I.lIIIlIlIlI[I.lIIIllIIII[149]] = I."Jump";
        I.lIIIlIlIlI[I.lIIIllIIII[150]] = I."Jumping gap 2";
        I.lIIIlIlIlI[I.lIIIllIIII[151]] = I."Jump";
        I.lIIIlIlIlI[I.lIIIllIIII[152]] = I."Jumping gap 3";
        I.lIIIlIlIlI[I.lIIIllIIII[153]] = I."Jump";
        I.lIIIlIlIlI[I.lIIIllIIII[154]] = I."Jumping gap 4";
        I.lIIIlIlIlI[I.lIIIllIIII[155]] = I."Jump";
        I.lIIIlIlIlI[I.lIIIllIIII[156]] = I."Vaulting";
        I.lIIIlIlIlI[I.lIIIllIIII[157]] = I."Vault";
        I.lIIIlIlIlI[I.lIIIllIIII[158]] = I."Jumping gap 5";
        I.lIIIlIlIlI[I.lIIIllIIII[159]] = I."Jump";
        I.lIIIlIlIlI[I.lIIIllIIII[160]] = I."Jumping gap 6";
        I.lIIIlIlIlI[I.lIIIllIIII[161]] = I."Jump";
        I.lIIIlIlIlI[I.lIIIllIIII[172]] = I."Nav to canafis course";
        I.lIIIlIlIlI[I.lIIIllIIII[173]] = I."Nav to start";
        I.lIIIlIlIlI[I.lIIIllIIII[174]] = I."Starting course";
        I.lIIIlIlIlI[I.lIIIllIIII[175]] = I."Wall";
        I.lIIIlIlIlI[I.lIIIllIIII[35]] = I."Climb-up";
        I.lIIIlIlIlI[I.lIIIllIIII[176]] = I."Mark of grace";
        I.lIIIlIlIlI[I.lIIIllIIII[177]] = I."Taking mark";
        I.lIIIlIlIlI[I.lIIIllIIII[178]] = I."Found mark on ground";
        I.lIIIlIlIlI[I.lIIIllIIII[179]] = I."Take";
        I.lIIIlIlIlI[I.lIIIllIIII[180]] = I."Jumping gap 1";
        I.lIIIlIlIlI[I.lIIIllIIII[79]] = I."Jump";
        I.lIIIlIlIlI[I.lIIIllIIII[181]] = I."cross rope";
        I.lIIIlIlIlI[I.lIIIllIIII[182]] = I."Cross";
        I.lIIIlIlIlI[I.lIIIllIIII[183]] = I."Jumping gap 3";
        I.lIIIlIlIlI[I.lIIIllIIII[184]] = I."Jump";
        I.lIIIlIlIlI[I.lIIIllIIII[185]] = I."Jumping gap 4";
        I.lIIIlIlIlI[I.lIIIllIIII[186]] = I."Jump";
        I.lIIIlIlIlI[I.lIIIllIIII[187]] = I."Jumping Edge";
        I.lIIIlIlIlI[I.lIIIllIIII[188]] = I."Jump";
        I.lIIIlIlIlI[I.lIIIllIIII[194]] = I."Found mark on ground";
        I.lIIIlIlIlI[I.lIIIllIIII[203]] = I."Agility";
        I.lIIIlIlIlI[I.lIIIllIIII[204]] = I."passage";
        I.lIIIlIlIlI[I.lIIIllIIII[205]] = I."passage";
        I.lIIIlIlIlI[I.lIIIllIIII[206]] = I."passage";
        I.lIIIlIlIlI[I.lIIIllIIII[207]] = I."passage";
        I.lIIIlIlIlI[I.lIIIllIIII[208]] = I."Edge";
        I.lIIIlIlIlI[I.lIIIllIIII[211]] = I."Gap";
        I.lIIIlIlIlI[I.lIIIllIIII[213]] = I."Gap";
        I.lIIIlIlIlI[I.lIIIllIIII[216]] = I."Tightrope";
        I.lIIIlIlIlI[I.lIIIllIIII[218]] = I."Gap";
        I.lIIIlIlIlI[I.lIIIllIIII[221]] = I."Gap";
        I.lIIIlIlIlI[I.lIIIllIIII[224]] = I."Gap";
        I.lIIIlIlIlI[I.lIIIllIIII[226]] = I."Pole-vault";
        I.lIIIlIlIlI[I.lIIIllIIII[227]] = I."Gap";
        I.lIIIlIlIlI[I.lIIIllIIII[230]] = I."Gap";
        I.lIIIlIlIlI[I.lIIIllIIII[232]] = I."Gap";
        I.lIIIlIlIlI[I.lIIIllIIII[233]] = I."Gap";
    }
    ...
    private static void lllIllIllIIl() {
        ...
        I.lIIIllIIII[0] = (0x5F ^ 0x33 ^ (0x29 ^ 0x61)) & (0x14 ^ 0x4B ^ (0xC3 ^ 0xB8) ^ -1);
        I.lIIIllIIII[1] = 1;
            ...
            if (I.lllIlllIIIlI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)lIIIllllllIl), lIIIllIIII[20])) {
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (I.lllIllIllllI(Skills.getExperience((Skill)Skill.AGILITY), lIIIllllllII)) {
                        bl = lIIIllIIII[1];
                        0;
                        if ((0xFE ^ 0xBD ^ (0x2F ^ 0x68)) < 3) {
                            return ((0x55 ^ 0x5F ^ (0 ^ 0x11)) & (15 + 42 - 50 + 121 ^ 39 + 75 - -22 + 19 ^ -1)) != 0;
                        }
                    } else {
                        bl = lIIIllIIII[0];
                    }
        ...
        if (I.lllIllIlllII(I.cu() ? 1 : 0)) {
            ...
            if (I.lllIllIllIlI(lIIlIIIIIlII.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && I.lllIllIlllIl(lIIIlllllIll = TileObjects.getNearest(tileObject -> {
                ...
                if (I.lllIllIllIlI(tileObject.getName().contains(lIIIlIlIlI[lIIIllIIII[233]]) ? 1 : 0) && I.lllIlllIIIlI(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIIllIIII[234], lIIIllIIII[131], lIIIllIIII[3])), lIIIllIIII[3])) {
                    ...
                    0;
                    if (2 > 3) {
                        return ((0x81 ^ 0x89 ^ (0x35 ^ 0x1F)) & (0x5A ^ 8 ^ (0xF3 ^ 0x83) ^ -1)) != 0;
                    }
                } else {
                    n2 = lIIIllIIII[0];
                }
            ...
            if (I.lllIllIllIlI(lIIlIIIIIIll.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && I.lllIllIlllIl(lIIIlllllIll = TileObjects.getNearest(tileObject -> {
                ...
                Time.sleepUntil(() -> {
                    ...
                    if (I.lllIllIllllI(Skills.getExperience((Skill)Skill.AGILITY), lIIIlllllIlI)) {
                        bl = lIIIllIIII[1];
                        0;
                        if (((186 + 6 - 189 + 204 ^ 80 + 75 - 139 + 181) & (0x1F ^ 0x20 ^ (0x21 ^ 0x14) ^ -1)) > 0) {
                            return ((103 + 12 - 39 + 83 ^ 18 + 65 - -38 + 11) & (0x1F ^ 0x6C ^ (0x3C ^ 0x54) ^ -1)) != 0;
                        }
                    } else {
                        bl = lIIIllIIII[0];
                    }
            ...
            if (I.lllIllIllIlI(lIIlIIIIIIlI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && I.lllIllIlllIl(lIIIlllllIll = TileObjects.getNearest(tileObject -> {
                ...
                if (I.lllIllIllIlI(tileObject.getName().contains(lIIIlIlIlI[lIIIllIIII[230]]) ? 1 : 0) && I.lllIlllIIIlI(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIIllIIII[139], lIIIllIIII[231], lIIIllIIII[3])), lIIIllIIII[3])) {
                    n2 = lIIIllIIII[1];
                    0;
                    if (((175 + 140 - 184 + 51 ^ 11 + 85 - 57 + 113) & (138 + 121 - 199 + 114 ^ 38 + 112 - 34 + 12 ^ -1)) == -1) {
                        return ((7 ^ 0x48 ^ (9 ^ 0x4B)) & (0x7E ^ 0x12 ^ (5 ^ 0x64) ^ -1)) != 0;
                    }
                } else {
                    n2 = lIIIllIIII[0];
                }
            ...
            if (I.lllIllIllIlI(lIIIlllllllI.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && I.lllIllIlllIl(lIIIlllllIll = TileObjects.getNearest(tileObject -> {
                ...
                if (I.lllIllIllIlI(tileObject.getName().contains(lIIIlIlIlI[lIIIllIIII[221]]) ? 1 : 0) && I.lllIlllIIIlI(tileObject.getWorldLocation().distanceTo(new WorldPoint(lIIIllIIII[222], lIIIllIIII[223], lIIIllIIII[3])), lIIIllIIII[3])) {
                    ...
                    0;
                    if (null != null) {
                        return ((0x4F ^ 0x15 ^ (0x64 ^ 0x18)) & (130 + 1 - 59 + 76 ^ 33 + 54 - -19 + 72 ^ -1)) != 0;
                    }
                } else {
                    n2 = lIIIllIIII[0];
                }
