...
implements ab {
    ...
    private static void llIlIllIIlll() {
        ...
        ag.lllllIlll[ag.llllllIII[0]] = ag."Buying items";
        ag.lllllIlll[ag.llllllIII[1]] = ag."Finished buying items, switching back to magic training";
        ag.lllllIlll[ag.llllllIII[3]] = ag."Navigating to bank";
        ag.lllllIlll[ag.llllllIII[4]] = ag."Handling banking";
        ag.lllllIlll[ag.llllllIII[7]] = ag."We are missing supplies, switching to BUYING";
        ag.lllllIlll[ag.llllllIII[19]] = ag."Nav to cows";
        ag.lllllIlll[ag.llllllIII[6]] = ag."Attacking cows";
        ag.lllllIlll[ag.llllllIII[27]] = ag."Casting varrock tele";
        ag.lllllIlll[ag.llllllIII[30]] = ag."Casting lumby tele";
        ag.lllllIlll[ag.llllllIII[32]] = ag."Casting fally tele";
        ag.lllllIlll[ag.llllllIII[33]] = ag."Casting cammy tele";
        ag.lllllIlll[ag.llllllIII[34]] = ag."Alching";
        ag.lllllIlll[ag.llllllIII[37]] = ag."Wield";
        ag.lllllIlll[ag.llllllIII[39]] = ag."Move to alch spot";
        ag.lllllIlll[ag.llllllIII[43]] = ag."Nav to cows";
        ag.lllllIlll[ag.llllllIII[44]] = ag."Attacking cows";
        ag.lllllIlll[ag.llllllIII[45]] = ag."Eat";
        ag.lllllIlll[ag.llllllIII[46]] = ag."Cow";
        ag.lllllIlll[ag.llllllIII[47]] = ag."cow";
        ag.lllllIlll[ag.llllllIII[49]] = ag."Attack";
        ag.lllllIlll[ag.llllllIII[53]] = ag."Opening autocast";
        ag.lllllIlll[ag.llllllIII[54]] = ag."Choose spell";
        ag.lllllIlll[ag.llllllIII[56]] = ag."Wind Strike";
        ag.lllllIlll[ag.llllllIII[57]] = ag."Water Strike";
        ag.lllllIlll[ag.llllllIII[58]] = ag."Earth Strike";
        ag.lllllIlll[ag.llllllIII[21]] = ag."Earth Strike";
        ag.lllllIlll[ag.llllllIII[52]] = ag."Fire Strike";
        ag.lllllIlll[ag.llllllIII[74]] = ag."Magic training";
        ag.lllllIlll[ag.llllllIII[75]] = ag."ring of wealth (";
        ag.lllllIlll[ag.llllllIII[76]] = ag."Cow";
    }
                        ...
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    ...
                                    return ((178 + 75 - 127 + 99 ^ 5 + 1 - -90 + 72) & (0x57 ^ 0x61 ^ 46 + 83 - 114 + 112 ^ -1)) != 0;
                                }
                                n4 = llllllIII[0];
                                return n4 != 0;
                            }
    ...
    private static String llIlIlIlIlll(String lIlIlIlIllIII, String lIlIlIlIlIIlI) {
        ...
        while (ag.llIlIllIlIlI(lIlIlIlIIllII, lIlIlIlIIllIl)) {
            ...
            ++lIlIlIlIIllII;
            0;
            if (1 >= ((0x50 ^ 0x6E) & ~(0x8A ^ 0xB4))) continue;
            return null;
        }
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (ag.llIlIllIllIl(Inventory.getCount((int[])nArray))) {
                                            ...
                                            if (((106 + 55 - 60 + 52 ^ 102 + 36 - 83 + 77) & (0xBE ^ 0xAE ^ (0x27 ^ 0x2A) ^ -1)) != 0) {
                                                return ((124 + 35 - 17 + 31 ^ 49 + 42 - 86 + 140) & (107 + 130 - 155 + 68 ^ 6 + 106 - 44 + 102 ^ -1)) != 0;
                                            }
                                        } else {
                                            bl = llllllIII[0];
                                        }
