...
implements ab {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (am.lllIIlIIIIIl(Inventory.getCount((int[])nArray))) {
                                ...
                                if ((0x23 ^ 0x7A ^ (0x59 ^ 4)) == 3) {
                                    return ((126 + 229 - 321 + 217 ^ 120 + 126 - 203 + 156) & (1 + 88 - 32 + 71 ^ 72 + 123 - 127 + 120 ^ -1)) != 0;
                                }
                            } else {
                                bl = lIIIIllIlI[0];
                            }
                        ...
                        if (am.lllIIIllllIl(Production.isOpen() ? 1 : 0)) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (!am.lllIIIllllIl(am.an() ? 1 : 0) || am.lllIIIllllIl(Dialog.isOpen() ? 1 : 0)) {
                                    ...
                                    0;
                                    if (null != null) {
                                        return ((0xB4 ^ 0xA3 ^ (0x64 ^ 0x24)) & (156 + 53 - 38 + 28 ^ 26 + 55 - 35 + 98 ^ -1)) != 0;
                                    }
                                } else {
                                    bl = lIIIIllIlI[0];
                                }
    ...
    public boolean ah() {
        ...
        if (am.lllIIlIIIIlI(Skills.getLevel((Skill)Skill.COOKING), lIIIIllIlI[35])) {
            ...
            0;
            if (-1 > 0) {
                return ((134 + 116 - 245 + 199 ^ 81 + 130 - 78 + 16) & (0x6B ^ 0x4D ^ 108 + 101 - 186 + 104 ^ -1)) != 0;
            }
        } else {
            bl = lIIIIllIlI[0];
        }
