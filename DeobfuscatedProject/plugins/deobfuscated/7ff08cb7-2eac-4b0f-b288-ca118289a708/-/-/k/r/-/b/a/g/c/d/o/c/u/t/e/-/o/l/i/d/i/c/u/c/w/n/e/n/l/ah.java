...
implements ab {
                        ...
                        block26: {
                            block22: {
                                ...
                                block23: {
                                    ...
                                    return ((73 + 152 - 88 + 101 ^ 118 + 36 - 136 + 154) & (123 + 175 - 168 + 64 ^ 35 + 16 - -58 + 19 ^ -1)) != 0;
                                }
                                n4 = lllIlIlIl[0];
                                return n4 != 0;
                            }
    ...
    public int af() {
        ...
        if (null != null) {
            return (1 ^ (0x18 ^ 0x3D)) & (19 + 83 - 73 + 112 ^ 63 + 153 - 151 + 104 ^ -1);
        }
        return lllIlIlIl[68];
    }
                                ...
                                if (ah.llIIIllIlllI(Inventory.getCount((int[])nArray4), lllIlIlIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (ah.llIIIlllIIIl(Inventory.getCount((int[])nArray))) {
                                            ...
                                            0;
                                            if (null != null) {
                                                return ((0x16 ^ 0x27 ^ (5 ^ 0x54)) & (0x58 ^ 0x7F ^ (0x38 ^ 0x7F) ^ -1)) != 0;
                                            }
                                        } else {
                                            bl = lllIlIlIl[0];
                                        }
                                ...
                                if (ah.llIIIllIlllI(Inventory.getCount((int[])nArray8), lllIlIlIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (ah.llIIIlllIIIl(Inventory.getCount((int[])nArray))) {
                                            ...
                                            0;
                                            if (null != null) {
                                                return ((0xBD ^ 0xB6 ^ (0x2F ^ 0x79)) & (0x29 ^ 0x57 ^ (0x2F ^ 0xC) ^ -1)) != 0;
                                            }
                                        } else {
                                            bl = lllIlIlIl[0];
                                        }
                                ...
                                if (ah.llIIIllIlllI(Inventory.getCount((int[])nArray10), lllIlIlIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (ah.llIIIlllIIIl(Inventory.getCount((int[])nArray))) {
                                            ...
                                            0;
                                            if (-3 >= 0) {
                                                return ((0xEF ^ 0xB0 ^ (0x26 ^ 0x2C)) & (0x58 ^ 0x73 ^ (0x16 ^ 0x68) ^ -1)) != 0;
                                            }
                                        } else {
                                            bl = lllIlIlIl[0];
                                        }
                        ...
                        if (ah.llIIIllIllIl(Players.getLocal().getWorldLocation().equals((Object)cn) ? 1 : 0) && ah.llIIIlllIIII(llIlllllIIIlI) && ah.llIIIlllIIII(llIlllllIIIIl)) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (ah.llIIIllllIII(Skills.getExperience((Skill)Skill.MAGIC), llIlllllIIIII)) {
                                    ...
                                    0;
                                    if (2 == 0) {
                                        return ((86 + 149 - 222 + 156 ^ 41 + 103 - 139 + 142) & (149 + 82 - 122 + 46 ^ 149 + 28 - 130 + 114 ^ -1)) != 0;
                                    }
                                } else {
                                    bl = lllIlIlIl[0];
                                }
    ...
    private static void llIIIllIlIll() {
        ...
        ah.lllIlIlII[ah.lllIlIlIl[0]] = ah."Buying items";
        ah.lllIlIlII[ah.lllIlIlIl[1]] = ah."Finished buying items, switching back to magic training";
        ah.lllIlIlII[ah.lllIlIlIl[2]] = ah."Navigating to bank";
        ah.lllIlIlII[ah.lllIlIlIl[3]] = ah."Handling banking";
        ah.lllIlIlII[ah.lllIlIlIl[6]] = ah."We are missing supplies, switching to BUYING";
        ah.lllIlIlII[ah.lllIlIlIl[18]] = ah."Nav to cows";
        ah.lllIlIlII[ah.lllIlIlIl[5]] = ah."Attacking cows";
        ah.lllIlIlII[ah.lllIlIlIl[26]] = ah."Casting varrock tele";
        ah.lllIlIlII[ah.lllIlIlIl[29]] = ah."Casting lumby tele";
        ah.lllIlIlII[ah.lllIlIlIl[31]] = ah."Casting fally tele";
        ah.lllIlIlII[ah.lllIlIlIl[32]] = ah."Casting cammy tele";
        ah.lllIlIlII[ah.lllIlIlIl[33]] = ah."Alching";
        ah.lllIlIlII[ah.lllIlIlIl[36]] = ah."Wield";
        ah.lllIlIlII[ah.lllIlIlIl[38]] = ah."Move to alch spot";
        ah.lllIlIlII[ah.lllIlIlIl[42]] = ah."Nav to cows";
        ah.lllIlIlII[ah.lllIlIlIl[43]] = ah."Attacking cows";
        ah.lllIlIlII[ah.lllIlIlIl[44]] = ah."Eat";
        ah.lllIlIlII[ah.lllIlIlIl[45]] = ah."Cow";
        ah.lllIlIlII[ah.lllIlIlIl[46]] = ah."cow";
        ah.lllIlIlII[ah.lllIlIlIl[48]] = ah."Attack";
        ah.lllIlIlII[ah.lllIlIlIl[52]] = ah."Opening autocast";
        ah.lllIlIlII[ah.lllIlIlIl[53]] = ah."Choose spell";
        ah.lllIlIlII[ah.lllIlIlIl[55]] = ah."Wind Strike";
        ah.lllIlIlII[ah.lllIlIlIl[56]] = ah."Water Strike";
        ah.lllIlIlII[ah.lllIlIlIl[57]] = ah."Earth Strike";
        ah.lllIlIlII[ah.lllIlIlIl[20]] = ah."Earth Strike";
        ah.lllIlIlII[ah.lllIlIlIl[51]] = ah."Fire Strike";
        ah.lllIlIlII[ah.lllIlIlIl[73]] = ah."Magic training";
        ah.lllIlIlII[ah.lllIlIlIl[75]] = ah."ring of wealth (";
        ah.lllIlIlII[ah.lllIlIlIl[76]] = ah."Cow";
    }
