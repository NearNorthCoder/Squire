...
implements ab {
    ...
    private static void llIIIlllllII() {
        ...
        A.lllIlIlll[A.lllIllIII[1]] = A."Finished buying items, switching back to quest";
        A.lllIlIlll[A.lllIllIII[0]] = A."Nav to bank";
        A.lllIlIlll[A.lllIllIII[5]] = A."Handling banking";
        A.lllIlIlll[A.lllIllIII[11]] = A."We are missing runes, switching to BUYING";
        A.lllIlIlll[A.lllIllIII[6]] = A."We are missing quest supplies, switching to BUYING";
        A.lllIlIlll[A.lllIllIII[16]] = A."Drink";
        A.lllIlIlll[A.lllIllIII[12]] = A."Drink";
        A.lllIlIlll[A.lllIllIII[22]] = A."Nav to start";
        A.lllIlIlll[A.lllIllIII[23]] = A."Lady Servil";
        A.lllIlIlll[A.lllIllIII[24]] = A."Nav to armour";
        A.lllIlIlll[A.lllIllIII[18]] = A."Getting armour";
        A.lllIlIlll[A.lllIllIII[25]] = A."Door";
        A.lllIlIlll[A.lllIllIII[26]] = A."Open";
        A.lllIlIlll[A.lllIllIII[3]] = A."Chest";
        A.lllIlIlll[A.lllIllIII[27]] = A."Door";
        A.lllIlIlll[A.lllIllIII[28]] = A."Open";
        A.lllIlIlll[A.lllIllIII[29]] = A."Chest";
        A.lllIlIlll[A.lllIllIII[30]] = A."Chest";
        A.lllIlIlll[A.lllIllIII[31]] = A."Open";
        A.lllIlIlll[A.lllIllIII[32]] = A."Chest";
        A.lllIlIlll[A.lllIllIII[33]] = A."Open";
        A.lllIlIlll[A.lllIllIII[34]] = A."Chest";
        A.lllIlIlll[A.lllIllIII[35]] = A."Search";
        A.lllIlIlll[A.lllIllIII[36]] = A."Chest";
        A.lllIlIlll[A.lllIllIII[37]] = A."Search";
        A.lllIlIlll[A.lllIllIII[21]] = A."Wear";
        A.lllIlIlll[A.lllIllIII[40]] = A."Wear";
        A.lllIlIlll[A.lllIllIII[41]] = A."Nav to jail";
        A.lllIlIlll[A.lllIllIII[42]] = A."Door";
        A.lllIlIlll[A.lllIllIII[43]] = A."Open";
        A.lllIlIlll[A.lllIllIII[44]] = A."Nav to guard";
        A.lllIlIlll[A.lllIllIII[45]] = A."Head Guard";
        A.lllIlIlll[A.lllIllIII[46]] = A."Khali brew";
        A.lllIlIlll[A.lllIllIII[47]] = A."Nav to brew";
        A.lllIlIlll[A.lllIllIII[48]] = A."Khazard Barman";
        A.lllIlIlll[A.lllIllIII[49]] = A."Khali brew";
        A.lllIlIlll[A.lllIllIII[50]] = A."Nav to guard";
        A.lllIlIlll[A.lllIllIII[51]] = A."Nav to guard";
        A.lllIlIlll[A.lllIllIII[52]] = A."Head Guard";
        A.lllIlIlll[A.lllIllIII[53]] = A."Nav to  sammy";
        A.lllIlIlll[A.lllIllIII[54]] = A."Khazard cell keys";
        A.lllIlIlll[A.lllIllIII[55]] = A."Khazard Ogre";
        A.lllIlIlll[A.lllIllIII[56]] = A."Khazard Ogre";
        A.lllIlIlll[A.lllIllIII[57]] = A."Attack";
        A.lllIlIlll[A.lllIllIII[58]] = A."Sammy Servil";
        A.lllIlIlll[A.lllIllIII[2]] = A."Hengrad";
        A.lllIlIlll[A.lllIllIII[59]] = A."Hengrad";
        A.lllIlIlll[A.lllIllIII[60]] = A."Hengrad";
        A.lllIlIlll[A.lllIllIII[61]] = A."Khazard Scorpion";
        A.lllIlIlll[A.lllIllIII[62]] = A."Khazard Scorpion";
        A.lllIlIlll[A.lllIllIII[20]] = A."Attack";
        A.lllIlIlll[A.lllIllIII[63]] = A."Bouncer";
        A.lllIlIlll[A.lllIllIII[64]] = A."Bouncer";
        A.lllIlIlll[A.lllIllIII[65]] = A."Attack";
        A.lllIlIlll[A.lllIllIII[66]] = A."General Khazard";
        A.lllIlIlll[A.lllIllIII[67]] = A."Break";
        A.lllIlIlll[A.lllIllIII[71]] = A."Nav to start";
        A.lllIlIlll[A.lllIllIII[72]] = A."General Khazard";
        A.lllIlIlll[A.lllIllIII[76]] = A."Castle Wars";
        A.lllIlIlll[A.lllIllIII[79]] = A."Lady Servil";
        A.lllIlIlll[A.lllIllIII[86]] = A."Fight Arena";
        A.lllIlIlll[A.lllIllIII[87]] = A."ring of wealth (";
        A.lllIlIlll[A.lllIllIII[88]] = A."dueling";
        A.lllIlIlll[A.lllIllIII[89]] = A."dueling";
        A.lllIlIlll[A.lllIllIII[90]] = A."Prison Gate";
        A.lllIlIlll[A.lllIllIII[109]] = A."Can I help you?";
        A.lllIlIlll[A.lllIllIII[110]] = A."I'd like a Khali Brew please.";
        A.lllIlIlll[A.lllIllIII[111]] = A."Yes.";
    }
    ...
    private static void llIIIlllllIl() {
        ...
        A.lllIllIII[13] = -1 & (0xFFFFBFCF & 0x5F77);
        ...
        A.lllIllIII[91] = -1 & (0xFFFFDAE7 & 0x2F1F);
