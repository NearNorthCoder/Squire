...
extends Enum<a> {
    ...
    private static String llIIIlIIIIlIIIl(String var4, String var15) {
        var4 = new String(Base64.getDecoder().decode(var4.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var9 = new StringBuilder();
        char[] var13 = var15.toCharArray();
        int var10 = lIllIIIIlIlII[0];
        char[] var7 = var4.toCharArray();
        int var8 = var7.length;
        int var12 = lIllIIIIlIlII[0];
        while (a.llIIIlIIIlIlIIl(var12, var8)) {
            char var11 = var7[var12];
            var9.append((char)(var11 ^ var13[var10 % var13.length]));
            0;
            ++var10;
            ++var12;
            0;
    ...
    private static void llIIIlIIIlIIlIl() {
        ...
        a.lIllIIIIIllll[a.lIllIIIIlIlII[0]] = a."TREE";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[1]] = a."Tree";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[3]] = a."OAK";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[4]] = a."Oak";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[6]] = a."WILLOW";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[7]] = a."Willow";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[9]] = a."TEAK";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[10]] = a."Teak";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[12]] = a."MAPLE";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[13]] = a."Maple";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[15]] = a."MAHOGANY";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[16]] = a."Mahogany";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[18]] = a."YEW";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[19]] = a."Yew";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[21]] = a."BLISTERWOOD";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[22]] = a."Blisterwood";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[24]] = a."MAGIC";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[25]] = a."Magic";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[27]] = a."REDWOOD";
        a.lIllIIIIIllll[a.lIllIIIIlIlII[28]] = a."Redwood";
    }
    ...
    private static String llIIIlIIIIlIIII(String var14, String var1) {
        try {
            ...
            var2.init(lIllIIIIlIlII[3], var18);
    ...
    private static String llIIIlIIIIlIIlI(String var6, String var3) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var3.getBytes(StandardCharsets.UTF_8)), lIllIIIIlIlII[12]), "DES");
            Cipher var19 = Cipher.getInstance("DES");
            var19.init(lIllIIIIlIlII[3], var5);
