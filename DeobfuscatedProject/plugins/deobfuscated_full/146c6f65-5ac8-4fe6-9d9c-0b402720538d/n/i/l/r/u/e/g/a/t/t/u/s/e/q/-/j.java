...
public class j {
    ...
    public HeadIcon aD() {
        if (j.lIIIIIIlIIllIII(this.aQ)) {
            ...
            lllllllllllllllIlIIIllIIlllllllI.aR = HeadIcon.values()[var2[llIlIIIlIlII[0]]];
        }
        return this.aR;
    }
    ...
    private static String lIIIIIIlIIlIlII(String var12, String var1) {
        try {
            SecretKeySpec var7 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var1.getBytes(StandardCharsets.UTF_8)), llIlIIIlIlII[7]), "DES");
            Cipher var9 = Cipher.getInstance("DES");
            var9.init(llIlIIIlIlII[6], var7);
    ...
    private static String lIIIIIIlIIlIlIl(String var6, String var5) {
        try {
            ...
            var4.init(llIlIIIlIlII[6], var11);
