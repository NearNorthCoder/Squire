...
/* TASK: Swapping weapon -> SwappingweaponTask */
...
extends n {
    ...
    private static String llllllIlllIIll(String var28, String var10) {
        ...
        int var1 = llIIllIlIIIl[1];
        char[] var16 = var28.toCharArray();
        int var23 = var16.length;
        int var25 = llIIllIlIIIl[1];
        while (A.llllllIlllllIl(var25, var23)) {
            char var12 = var16[var25];
            var7.append((char)(var12 ^ var20[var1 % var20.length]));
            0;
            ++var1;
            ++var25;
            0;
    ...
    private static String llllllIlllIIlI(String var13, String var24) {
        try {
            SecretKeySpec var22 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var24.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var9 = Cipher.getInstance("Blowfish");
            var9.init(llIIllIlIIIl[2], var22);
    ...
    public void a(NpcChanged npcChanged) {
        ...
        if (A.llllllIllllIIl(nPC) && A.llllllIllllIIl(nPC.getName()) && A.llllllIlllIlll(e.aw.contains(nPC.getName()) ? 1 : 0)) {
            ...
            lllllllllllllllIlIIlIlIlIlIIllll.bN = HeadIcon.values()[var21[llIIllIlIIIl[1]]];
            bK = llIIllIlIIIl[1];
        }
    }

    private static String llllllIlllIlII(String var5, String var26) {
        try {
            SecretKeySpec var18 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var26.getBytes(StandardCharsets.UTF_8)), llIIllIlIIIl[8]), "DES");
            Cipher var19 = Cipher.getInstance("DES");
            var19.init(llIIllIlIIIl[2], var18);
    ...
    private boolean bz() {
        ...
        if (A.llllllIllllIII(headIcon, HeadIcon.MAGIC)) {
            ...
            if (A.llllllIllllIIl(var8)) {
                var8.interact(llIIllIlIIII[llIIllIlIIIl[0]]);
                return llIIllIlIIIl[0];
            }
        }
    ...
    private boolean bA() {
        ...
        if (A.llllllIllllIlI(bK)) {
        ...
        } else if (A.llllllIllllIll(bK, llIIllIlIIIl[3]) && A.llllllIllllIlI(HeadIcon.RANGED.equals((Object)var14) ? 1 : 0)) {
            ...
            if (A.llllllIllllIIl(var2)) {
                var2.interact(llIIllIlIIII[llIIllIlIIIl[4]]);
                return llIIllIlIIIl[0];
            }
            0;
            if (3 < 0) {
            ...
            WorldPoint var11 = var27.getWorldLocation();
            if (A.llllllIllllIIl(var2)) {
                A var6;
                Item var17;
                if (A.llllllIllllIlI(Inventory.getFreeSlots()) && A.llllllIllllIIl(var17 = Inventory.getFirst(item -> {
                    String[] stringArray = new String[llIIllIlIIIl[0]];
                    stringArray[A.llIIllIlIIIl[1]] = llIIllIlIIII[llIIllIlIIIl[6]];
                    return item.hasAction(stringArray);
                }))) {
                    var17.interact(llIIllIlIIII[llIIllIlIIIl[5]]);
                }
                var17 = ScenePoint.fromWorld((WorldPoint)var11);
                List<WorldPoint> var4 = var6.bM.c(var11, var6.ba.X().aI().getWorldLocation());
                u u2 = var6.bM;
                Stream stream = var4.stream();
                u u3 = var6.bM;
                ...
                var2.interact(llIIllIlIIII[llIIllIlIIIl[3]]);
                return llIIllIlIIIl[0];
            }
        }
        return llIIllIlIIIl[1];
