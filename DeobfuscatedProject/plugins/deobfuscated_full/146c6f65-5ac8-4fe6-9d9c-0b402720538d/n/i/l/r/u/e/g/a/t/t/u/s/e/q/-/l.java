...
public class l {
    ...
    public int hashCode() {
        ...
        int var16 = n8 + n5;
        WorldPoint var12 = var20.aW();
        int n9 = var16 * llIIllIIllll[7];
        if (l.llllllIlllIIII(var12)) {
            n4 = llIIllIIllll[10];
            0;
            if (1 == (0xBA ^ 0xBE)) {
        ...
        var16 = n9 + n4;
        Point var10 = var20.aX();
        int n10 = var16 * llIIllIIllll[7];
        if (l.llllllIlllIIII(var10)) {
            n3 = llIIllIIllll[10];
            0;
            if ((1 ^ 5) <= 0) {
        ...
        var16 = n10 + n3;
        g var6 = var20.aZ();
        int n11 = var16 * llIIllIIllll[7];
        if (l.llllllIlllIIII((Object)var6)) {
            n2 = llIIllIIllll[10];
            0;
            if (2 != 2) {
    ...
    public boolean aS() {
        ...
        int n3 = point.getX();
        int n4 = point.getY();
        if (l.llllllIllIlIlI(n3 % llIIllIIllll[3]) && !l.llllllIllIlIll(Math.abs(n4 - llIIllIIllll[4]), llIIllIIllll[5]) || l.llllllIllIlIlI((int)(var19 % llIIllIIllll[3])) && l.llllllIllIllII(Math.abs((int)(var9 - llIIllIIllll[4])), llIIllIIllll[5])) {
            n2 = llIIllIIllll[5];
            0;
            if (-1 >= 1) {
    ...
    public boolean equals(Object object) {
        block26: {
            block27: {
                ...
                block25: {
                    ...
                    block23: {
                        block24: {
                                ...
                                block20: {
                                    block21: {
                                        ...
                                        block19: {
                                            ...
                                            if (l.llllllIllIlIlI(var2 instanceof l)) {
                                                return llIIllIIllll[6];
                                            }
                                            var3 = (l)var2;
                                            if (l.llllllIllIlIlI(var3.a(var13) ? 1 : 0)) {
                                                return llIIllIIllll[6];
                                            }
                                            if (l.llllllIllIlllI(var13.aY() ? 1 : 0, var3.aY() ? 1 : 0)) {
                                                return llIIllIIllll[6];
                                            }
                                            var7 = var13.aW();
                                            var17 = var3.aW();
                                            if (!l.llllllIlllIIII(var7)) break block19;
                                            if (!l.llllllIllIlIIl(var17)) break block20;
                                            0;
                                        ...
                                        if (!l.llllllIllIlIlI(var7.equals(var17) ? 1 : 0)) break block20;
                                    }
                                    return llIIllIIllll[6];
                                }
                                var18 = var13.aX();
                                var15 = var3.aX();
                                if (!l.llllllIlllIIII(var18)) break block22;
                                if (!l.llllllIllIlIIl(var15)) break block23;
                                0;
                                if (1 == 0) {
                            ...
                            if (!l.llllllIllIlIlI(var18.equals(var15) ? 1 : 0)) break block23;
                        }
                        return llIIllIIllll[6];
                    }
                    var4 = var13.aZ();
                    var5 = var3.aZ();
                    if (!l.llllllIlllIIII((Object)var4)) break block25;
                    if (!l.llllllIllIlIIl((Object)var5)) break block26;
                    0;
                    if (2 <= -1) {
                ...
                if (!l.llllllIllIlIlI(((Object)((Object)var4)).equals((Object)var5) ? 1 : 0)) break block26;
            }
            return llIIllIIllll[6];
        }
        return llIIllIIllll[5];
    ...
    public boolean e(l l2) {
        ...
        int n5 = point2.getX();
        int n6 = point2.getY();
        if (l.llllllIllIllIl(n3, n5) && !l.llllllIllIlllI(Math.abs(n4 - n6), llIIllIIllll[5]) || l.llllllIllIllIl((int)var11, (int)var1) && l.llllllIllIllIl(Math.abs((int)(var14 - var8)), llIIllIIllll[5])) {
            n2 = llIIllIIllll[5];
            0;
