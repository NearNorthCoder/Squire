...
extends Enum<h> {
    ...
    static h c(WorldPoint worldPoint) {
        ...
        int var3 = lllIIllIIIlI[0];
        while (h.lIIIlIlIIllIlIl(var3, (int)var7)) {
            WorldPoint var4;
            void var15;
            void var14 = var15[var3];
            if (h.lIIIlIlIIllIllI(var14.l().equals((Object)var4) ? 1 : 0)) {
                return var14;
            }
            ++var3;
            0;
    ...
    private static String lIIIlIlIIllIIIl(String var11, String var2) {
        try {
            ...
            var5.init(lllIIllIIIlI[6], var10);
    ...
    private static String lIIIlIlIIllIIlI(String var12, String var8) {
        try {
            SecretKeySpec var13 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var8.getBytes(StandardCharsets.UTF_8)), lllIIllIIIlI[16]), "DES");
            Cipher var1 = Cipher.getInstance("DES");
            var1.init(lllIIllIIIlI[6], var13);
