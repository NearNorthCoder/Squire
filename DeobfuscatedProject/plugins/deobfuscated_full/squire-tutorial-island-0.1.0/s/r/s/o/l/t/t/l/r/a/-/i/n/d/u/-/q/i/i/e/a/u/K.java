...
public class K {
    ...
    private static String lIlllIIIlIIIIlI(String var16, String var27) {
        var16 = new String(Base64.getDecoder().decode(var16.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var11 = new StringBuilder();
        char[] var8 = var27.toCharArray();
        int var13 = lIlIIlIIlIlII[1];
        char[] var29 = var16.toCharArray();
        int var21 = var29.length;
        int var7 = lIlIIlIIlIlII[1];
        while (K.lIlllIIlIIllIlI(var7, var21)) {
            char var1 = var29[var7];
            var11.append((char)(var1 ^ var8[var13 % var8.length]));
            0;
            ++var13;
            ++var7;
            0;
    ...
    private static String lIlllIIIlIIIIIl(String var22, String var12) {
        try {
            ...
            var30.init(lIlIIlIIlIlII[3], var28);
    ...
    public static String f(String string) {
        ...
        int var35 = lIlIIlIIlIlII[0];
        char[] var3 = var33.toCharArray();
        int var9 = var3.length;
        int var25 = lIlIIlIIlIlII[1];
        while (K.lIlllIIlIIllIlI(var25, var9)) {
            char var34 = var3[var25];
            if (K.lIlllIIlIIllIIl(Character.isSpaceChar(var34) ? 1 : 0)) {
                var35 = lIlIIlIIlIlII[0];
                0;
                
                }
            } else if (K.lIlllIIlIIllIIl(var35)) {
                var34 = Character.toTitleCase(var34);
                var35 = lIlIIlIIlIlII[1];
                0;
    ...
    public static String F() {
        ...
        int var24 = lIlIIlIIlIlII[1];
        while (K.lIlllIIlIIllIlI(var24, (int)var26)) {
            void var31;
            Object var14;
            void var32;
            String var15 = var32[L.a(0.0, ((void)var32).length - lIlIIlIIlIlII[0])];
            switch (L.a(0.0, 4.0)) {
                case 0: {
            ...
            if (K.lIlllIIlIIllIll(((String)var14).length() + var15.length(), (int)var31)) {
                var14 = (String)var14 + var15;
                0;
                ...
                if (K.lIlllIIlIIlllII(L.a(0.0, 1.0), lIlIIlIIlIlII[0])) {
                    var20 = ((String)var14 + var15).substring(lIlIIlIIlIlII[1], (int)var31);
                    0;
                    if (1 == ((119 + 37 - 60 + 86 ^ 62 + 116 - 28 + 15) & (98 + 9 - 84 + 118 ^ 33 + 45 - -52 + 28 ^ -1))) {
                        return null;
                    }
                } else {
                    int var2 = L.a(9.0, (double)var31);
                    var20 = ((String)var14 + var15).substring(lIlIIlIIlIlII[1], var2);
                    int var23 = var2;
                    while (K.lIlllIIlIIllIlI(var23, lIlIIlIIlIlII[13])) {
                        if (K.lIlllIIlIIlllII(L.a(0.0, 1.0), lIlIIlIIlIlII[0])) {
                            var20 = (String)var20 + L.a(0.0, 9.0);
                            0;
                            if ((0 ^ 0x24 ^ (0x72 ^ 0x52)) == 2) {
                                return null;
                            }
                        } else {
                            var20 = L.a(0.0, 9.0) + (String)var20;
                        }
                        ++var23;
                        0;
    ...
    private static void lIlllIIlIIlIllI() {
        ...
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[1]] = K."420";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[0]] = K."Bane";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[3]] = K."Bear";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[4]] = K."Behemoth";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[5]] = K."Big";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[6]] = K."Black";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[7]] = K."Blade";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[8]] = K."Bleed";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[9]] = K."Blood";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[10]] = K."Blow";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[11]] = K."Boar";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[12]] = K."Boi";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[13]] = K."Bolt";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[14]] = K."Boulder";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[15]] = K."Boy";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[16]] = K."Break";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[17]] = K."Brow";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[18]] = K."Challenger";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[19]] = K."Chaser";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[20]] = K."Colossal";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[21]] = K."Colossus";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[22]] = K."Corrupter";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[23]] = K."Crow";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[24]] = K."Danger";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[25]] = K."Dark";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[26]] = K."Dead";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[27]] = K."pelt";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[28]] = K."Death";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[29]] = K."Deceiver";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[30]] = K."Die";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[31]] = K."Dire";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[32]] = K."Doom";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[33]] = K."Dragon";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[34]] = K."Dwarf";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[35]] = K."Dwarven";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[36]] = K."Fang";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[37]] = K."Fierce";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[38]] = K."Fist";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[39]] = K."Flurry";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[40]] = K."Freak";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[41]] = K."Fury";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[42]] = K."Fuse";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[43]] = K."Giant";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[44]] = K."Girl";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[45]] = K."Gold";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[46]] = K."Great";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[47]] = K."Grim";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[48]] = K."Grotesque";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[49]] = K."Guthix";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[50]] = K."Hallow";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[51]] = K."Helm";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[52]] = K."Hit";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[53]] = K."Hollow";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[54]] = K."Homie";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[55]] = K."Hunter";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[56]] = K."Insane";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[57]] = K."Invincible";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[58]] = K."Iron";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[59]] = K."Ironfist";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[60]] = K."Ironman";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[61]] = K."Kill";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[62]] = K."Killa";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[63]] = K."Lion";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[64]] = K."Lone";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[65]] = K."Mammoth";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[66]] = K."Man";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[67]] = K."Mane";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[68]] = K."Me";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[69]] = K."Might";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[70]] = K."Mighty";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[71]] = K."Mithril";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[72]] = K."Molten";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[73]] = K."Myth";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[74]] = K."Mythic";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[75]] = K."Night";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[76]] = K."Night";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[77]] = K."owl";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[78]] = K."One";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[79]] = K."PK";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[80]] = K."Paragon";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[81]] = K."Pelt";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[82]] = K."Poison";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[83]] = K."Proud";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[84]] = K."Pur3";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[85]] = K."Pure";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[86]] = K."Rage";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[87]] = K."Raven";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[88]] = K."Rebel";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[89]] = K."Rock";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[90]] = K."Rumble";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[91]] = K."Savage";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[92]] = K."Scar";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[93]] = K."Sexy";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[94]] = K."Shade";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[95]] = K."Shield";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[96]] = K."Shout";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[97]] = K."Silent";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[98]] = K."Silver";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[99]] = K."Sk1ll";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[100]] = K."Skill";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[101]] = K."Skull";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[102]] = K."Slayer";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[103]] = K."Spirit";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[104]] = K."Spook";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[105]] = K."Steel";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[106]] = K."Storm";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[107]] = K."Stout";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[108]] = K."Strong";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[109]] = K."Swift";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[110]] = K."Tempest";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[111]] = K."The";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[112]] = K."Thirst";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[113]] = K."Thunder";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[114]] = K."Tower";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[115]] = K."True";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[116]] = K."Voidmane";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[117]] = K."White";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[118]] = K."Wild";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[119]] = K."Wildfist";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[120]] = K."Wolf";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[121]] = K."Zam";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[122]] = K."Zammy";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[123]] = K."Zero";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[124]] = K."_";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[125]] = K."axe";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[126]] = K."bolt";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[127]] = K."bow";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[128]] = K."bronze";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[129]] = K."brow";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[130]] = K."chaser";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[131]] = K."cleaver";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[132]] = K."cold";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[133]] = K."earth";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[134]] = K."fang";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[135]] = K."fierce";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[136]] = K."fire";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[137]] = K."flayer";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[138]] = K."gaze";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[139]] = K."hero";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[140]] = K."hot";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[141]] = K."ice";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[142]] = K."killa";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[143]] = K."knight";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[144]] = K."mage";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[145]] = K."man";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[146]] = K."metal";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[147]] = K."might";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[148]] = K."rage";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[149]] = K."scar";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[150]] = K."snarl";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[151]] = K."song";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[152]] = K."sorrow";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[153]] = K."stride";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[154]] = K."strike";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[155]] = K."strong";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[156]] = K."sword";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[157]] = K."sworn";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[158]] = K."thorn";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[159]] = K."throw";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[160]] = K."tongue";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[161]] = K."warrior";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[162]] = K."wind";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[163]] = K."wizard";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[164]] = K."xX";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[165]] = K."xox";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[166]] = K."xxx";
        K.lIlIIIlllIIIl[K.lIlIIlIIlIlII[2]] = K."";
    }
    ...
    private static void lIlllIIlIIlIlll() {
        ...
        K.lIlIIlIIlIlII[55] = 0xA9 ^ 0x9C ^ 3;
        ...
        K.lIlIIlIIlIlII[65] = 0x7B ^ 0x38 ^ 3;
        ...
        K.lIlIIlIIlIlII[94] = 0x2C ^ 0x72 ^ 3;
    ...
    private static String lIlllIIIlIIIIll(String var18, String var6) {
        try {
            SecretKeySpec var4 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var6.getBytes(StandardCharsets.UTF_8)), lIlIIlIIlIlII[9]), "DES");
            Cipher var10 = Cipher.getInstance("DES");
            var10.init(lIlIIlIIlIlII[3], var4);
