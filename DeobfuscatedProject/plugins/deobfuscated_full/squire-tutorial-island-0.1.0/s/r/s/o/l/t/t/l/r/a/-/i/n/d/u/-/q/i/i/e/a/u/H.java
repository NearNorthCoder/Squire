...
implements o {
    ...
    public void E() {
        ...
        aE = M.G();
        Widget var7 = Widgets.get((int)lIlIIlIIIlIlI[2], (int)lIlIIlIIIlIlI[14]);
        if (H.lIlllIIlIIIIIIl(var7)) {
            var7.interact(lIlIIlIIIlIIl[lIlIIlIIIlIlI[1]]);
            aE = M.G();
        }
    }
    ...
    private static String lIlllIIIlllllIl(String var10, String var6) {
        var10 = new String(Base64.getDecoder().decode(var10.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var12 = new StringBuilder();
        char[] var15 = var6.toCharArray();
        int var14 = lIlIIlIIIlIlI[0];
        char[] var11 = var10.toCharArray();
        int var4 = var11.length;
        int var1 = lIlIIlIIIlIlI[0];
        while (H.lIlllIIlIIIIIlI(var1, var4)) {
            char var3 = var11[var1];
            var12.append((char)(var3 ^ var15[var14 % var15.length]));
            0;
            ++var14;
            ++var1;
            0;
    ...
    private static String lIlllIIIlllllII(String var8, String var9) {
        try {
            ...
            var5.init(lIlIIlIIIlIlI[3], var2);
