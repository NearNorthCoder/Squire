...
extends Enum<av> {
    ...
    private static String llllIlIIlllIIl(String var6, String var15) {
        var6 = new String(Base64.getDecoder().decode(var6.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var17 = new StringBuilder();
        char[] var20 = var15.toCharArray();
        int var19 = llIIIlIlIlll[1];
        char[] var18 = var6.toCharArray();
        int var1 = var18.length;
        int var11 = llIIIlIlIlll[1];
        while (av.llllIlIlIlIIlI(var11, var1)) {
            char var26 = var18[var11];
            var17.append((char)(var26 ^ var20[var19 % var20.length]));
            0;
            ++var19;
            ++var11;
            0;
    ...
    public static boolean H(N n2) {
        ...
        int var24 = llIIIlIlIlll[1];
        while (av.llllIlIlIlIIlI(var24, (int)var10)) {
            void var12;
            void var30;
            void var27 = var30[var24];
            au var23 = var27.aY();
            if (av.llllIlIlIlIlII((Object)var23.bh(), var12)) {
                0;
                ...
                nArray[av.llIIIlIlIlll[1]] = var27.aA();
                if (av.llllIlIlIlIlIl(Inventory.getCount((boolean)llIIIlIlIlll[0], (int[])nArray), var27.bl())) {
    ...
    private static String llllIlIIlllIlI(String var22, String var21) {
        try {
            SecretKeySpec var25 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var21.getBytes(StandardCharsets.UTF_8)), llIIIlIlIlll[16]), "DES");
            Cipher var29 = Cipher.getInstance("DES");
            var29.init(llIIIlIlIlll[4], var25);
    ...
    private static String llllIlIIlllIll(String var3, String var31) {
        try {
            SecretKeySpec var4 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var31.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var28 = Cipher.getInstance("Blowfish");
            var28.init(llIIIlIlIlll[4], var4);
            return new String(var28.doFinal(Base64.getDecoder().decode(var3.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static List<Integer> c(P p2) {
        ...
        int var13 = llIIIlIlIlll[1];
        while (av.llllIlIlIlIIlI(var13, (int)var32)) {
            P var7;
            void var9;
            void var2 = var9[var13];
            au var5 = var2.aY();
            if (av.llllIlIlIlIIll((Object)var5.bh(), (Object)var7)) {
                void var16;
                var16.add(var2.aA());
                0;
            }
