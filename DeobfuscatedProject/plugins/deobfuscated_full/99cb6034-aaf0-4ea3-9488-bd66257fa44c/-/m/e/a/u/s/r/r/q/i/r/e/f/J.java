...
extends Enum<J> {
    ...
    private static String llllIIlIIIIlll(String var1, String var3) {
        try {
    ...
    private static void llllIIlIIIlIII() {
        ...
        J.llIIIIlIIIIl[J.llIIIIlIIIlI[0]] = J."WATERMELON";
        J.llIIIIlIIIIl[J.llIIIIlIIIlI[1]] = J."ONIONS";
        J.llIIIIlIIIIl[J.llIIIIlIIIlI[2]] = J."STRAWBERRIES";
    }

    private static void llllIIlIIIlIIl() {
        llIIIIlIIIlI = new int[4];
        J.llIIIIlIIIlI[0] = (0xDC ^ 0xA0 ^ (0x31 ^ 0x6E)) & (0x61 ^ 0x77 ^ (0x34 ^ 1) ^ -1);
        J.llIIIIlIIIlI[1] = 1;
        J.llIIIIlIIIlI[2] = 2;
        J.llIIIIlIIIlI[3] = 3;
    }
