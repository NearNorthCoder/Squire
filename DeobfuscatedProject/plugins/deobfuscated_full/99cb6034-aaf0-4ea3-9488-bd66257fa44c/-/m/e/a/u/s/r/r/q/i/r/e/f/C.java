...
extends Enum<C> {
    ...
    private static String lllIllIlIlIIII(String var7, String var17) {
        try {
            SecretKeySpec var2 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var17.getBytes(StandardCharsets.UTF_8)), lIlllIllllIl[16]), "DES");
            Cipher var6 = Cipher.getInstance("DES");
            var6.init(lIlllIllllIl[5], var2);
    ...
    private static String lllIllIlIlIIIl(String var4, String var18) {
        var4 = new String(Base64.getDecoder().decode(var4.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var15 = new StringBuilder();
        char[] var11 = var18.toCharArray();
        int var10 = lIlllIllllIl[2];
        char[] var19 = var4.toCharArray();
        int var13 = var19.length;
        int var16 = lIlllIllllIl[2];
        while (C.lllIllIlIlIllI(var16, var13)) {
            char var8 = var19[var16];
            var15.append((char)(var8 ^ var11[var10 % var11.length]));
            0;
            ++var10;
            ++var16;
            0;
    ...
    private static String lllIllIlIIllll(String var5, String var12) {
        try {
