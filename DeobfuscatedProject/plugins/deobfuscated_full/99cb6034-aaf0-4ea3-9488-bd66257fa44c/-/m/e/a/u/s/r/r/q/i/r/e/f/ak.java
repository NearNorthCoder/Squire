...
extends P {
    ...
    private static void llllIIIlIllIll() {
        ...
        ak.llIIIIIlIIlI[56] = (0x4B ^ 0x36) + (0xCF ^ 0xB2) - (0x59 ^ 0x38) + 1;
        ...
        ak.llIIIIIlIIlI[59] = (0xBA ^ 0xC7) + (111 + 83 - 67 + 32) - (0xDE ^ 0xA3) + 2;
        ...
        ak.llIIIIIlIIlI[74] = 1 + (0x17 ^ 5) - -(0x83 ^ 0xB8) + (87 + 13 - 51 + 78);
        ...
        ak.llIIIIIlIIlI[78] = (0x61 ^ 0x4D) + 1 - -(40 + 58 - -58 + 4) + (0x85 ^ 0x88);
