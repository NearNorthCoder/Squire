...
/* TASK: Noting produce -> NotingproduceTask */
...
extends az {
    ...
    public boolean run() {
        ...
        } else if (!be.llllIIIlllIIlI(Inventory.isFull() ? 1 : 0) || !be.llllIIIlllIIll(var1) || be.llllIIIlllIIlI(var1.isInScene(var2.bT) ? 1 : 0)) {
            var2.cS = llIIIIIlllII[1];
        }
        if (be.llllIIIlllIIlI(var2.cR.K() ? 1 : 0)) {
            return llIIIIIlllII[0];
        }
        if (be.llllIIIlllIlII(var2.cS ? 1 : 0) && be.llllIIIlllIlII(var2.cR.J() ? 1 : 0)) {
            n2 = llIIIIIlllII[1];
            0;
            if (-1 > 1) {
