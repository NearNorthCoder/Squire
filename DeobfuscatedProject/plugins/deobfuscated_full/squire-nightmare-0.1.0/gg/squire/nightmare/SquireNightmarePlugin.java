...
extends SquirePlugin {
    ...
    public boolean n() {
        ...
        if (!SquireNightmarePlugin.lIIIllIlIllIlII(s.i.e.i.m.r.-.q.e.g.h.u.n.t.r.a.N.ch(), lllIllIllIll[46]) || SquireNightmarePlugin.lIIIllIlIlllIIl(s.i.e.i.m.r.-.q.e.g.h.u.n.t.r.a.N.ch(), var43.aw.rechargeStaffAt())) {
            bl = lllIllIllIll[0];
            0;
    ...
    public boolean m() {
        ...
        if (SquireNightmarePlugin.lIIIllIlIllIllI((Object)var17.aw.bankLocation(), (Object)s.i.e.i.m.r.-.q.e.g.h.u.n.t.r.a.w.VER_SINHAZA)) {
            int[] nArray = new int[lllIllIllIll[0]];
