...
implements ab {
    ...
    private static void lIllIIlIIlIl() {
        ...
        Z.llIlIIlll[Z.llIlIlIII[0]] = Z."Buying items";
        Z.llIlIIlll[Z.llIlIlIII[1]] = Z."Finished buying items, switching back to quest";
        Z.llIlIIlll[Z.llIlIlIII[5]] = Z."Drink";
        Z.llIlIIlll[Z.llIlIlIII[7]] = Z."Eat";
        Z.llIlIIlll[Z.llIlIlIII[10]] = Z."Nav to bank";
        Z.llIlIIlll[Z.llIlIlIII[11]] = Z."Handling banking";
        Z.llIlIIlll[Z.llIlIlIII[18]] = Z."We are missing quest supplies, switching to BUYING";
        Z.llIlIIlll[Z.llIlIlIII[20]] = Z."Nav to start";
        Z.llIlIIlll[Z.llIlIlIII[21]] = Z."Wear";
        Z.llIlIIlll[Z.llIlIlIII[22]] = Z."Talking npc";
        Z.llIlIIlll[Z.llIlIlIII[3]] = Z."Morgan";
        Z.llIlIIlll[Z.llIlIlIII[23]] = Z."Nav to pub";
        Z.llIlIIlll[Z.llIlIlIII[24]] = Z."Talk to drunk";
        Z.llIlIIlll[Z.llIlIlIII[25]] = Z."Dr Harlow";
        Z.llIlIIlll[Z.llIlIlIII[26]] = Z."Beer";
        Z.llIlIIlll[Z.llIlIlIII[27]] = Z."Stake";
        Z.llIlIIlll[Z.llIlIlIII[28]] = Z."Talk to drunk";
        Z.llIlIIlll[Z.llIlIlIII[29]] = Z."Dr Harlow";
        Z.llIlIIlll[Z.llIlIlIII[30]] = Z."Beer";
        Z.llIlIIlll[Z.llIlIlIII[31]] = Z."Stake";
        Z.llIlIIlll[Z.llIlIlIII[32]] = Z."Nav to stairs";
        Z.llIlIIlll[Z.llIlIlIII[34]] = Z."Draynor Village";
        Z.llIlIIlll[Z.llIlIlIII[35]] = Z."Walking down stairs";
        Z.llIlIIlll[Z.llIlIlIII[36]] = Z."Stairs";
        Z.llIlIIlll[Z.llIlIlIII[37]] = Z."Walk-Down";
        Z.llIlIIlll[Z.llIlIlIII[38]] = Z."Count Draynor";
        Z.llIlIIlll[Z.llIlIlIII[39]] = Z."Starting fight";
        Z.llIlIIlll[Z.llIlIlIII[40]] = Z."Coffin";
        Z.llIlIIlll[Z.llIlIlIII[41]] = Z."Open";
        Z.llIlIIlll[Z.llIlIlIII[42]] = Z."Count Draynor";
        Z.llIlIIlll[Z.llIlIlIII[43]] = Z."Fighting";
        Z.llIlIIlll[Z.llIlIlIII[44]] = Z."Wield";
        Z.llIlIIlll[Z.llIlIlIII[45]] = Z."Attack";
        Z.llIlIIlll[Z.llIlIlIII[46]] = Z."Break";
        Z.llIlIIlll[Z.llIlIlIII[47]] = Z."Beer";
        Z.llIlIIlll[Z.llIlIlIII[48]] = Z."Garlic";
        Z.llIlIIlll[Z.llIlIlIII[49]] = Z."Hammer";
        Z.llIlIIlll[Z.llIlIlIII[60]] = Z."Vampire slayer quest";
        Z.llIlIIlll[Z.llIlIlIII[61]] = Z."ring of wealth (";
        Z.llIlIIlll[Z.llIlIlIII[70]] = Z."Ok, I'm up for an adventure.";
        Z.llIlIIlll[Z.llIlIlIII[53]] = Z."A glass of your finest ale please.";
        Z.llIlIIlll[Z.llIlIlIII[71]] = Z."Morgan needs your help!";
        Z.llIlIIlll[Z.llIlIlIII[72]] = Z."Yes.";
    }
    ...
    private static void lIllIIlIIllI() {
        ...
        Z.llIlIlIII[0] = (6 ^ 8 ^ (0xAE ^ 0xB6)) & (0x50 ^ 9 ^ (0x49 ^ 6) ^ -1);
        Z.llIlIlIII[1] = 1;
    ...
    public boolean ah() {
        ...
        if (Z.lIllIIllIIll(e.j(llIlIlIII[9]), llIlIlIII[7]) && Z.lIllIIlIllll(Players.getLocal().getWorldLocation().distanceTo(lP), llIlIlIII[43])) {
            n2 = llIlIlIII[1];
            0;
            if (-1 > ((5 ^ 0x6C ^ (0x35 ^ 0x14)) & (0xBE ^ 0xA2 ^ (0xED ^ 0xB9) ^ -1))) {
                return ((0x14 ^ 0x5A ^ (0xBE ^ 0xA9)) & (0x32 ^ 0x5E ^ (0x92 ^ 0xA7) ^ -1)) != 0;
            }
        } else {
            n2 = llIlIlIII[0];
        }
