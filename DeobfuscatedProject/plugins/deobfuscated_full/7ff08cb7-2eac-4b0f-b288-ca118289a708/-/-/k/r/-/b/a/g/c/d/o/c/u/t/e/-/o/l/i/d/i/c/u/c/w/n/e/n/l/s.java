...
implements ab {
    ...
    private static void llIlIIlIllII() {
        ...
        s.llllIllIl[s.llllIlllI[2]] = s."- Vamp Slayer";
        s.llllIllIl[s.llllIlllI[5]] = s."- Lost City";
        s.llllIllIl[s.llllIlllI[8]] = s."- Fight Arena";
        s.llllIllIl[s.llllIlllI[1]] = s."- Tree Gnome village";
        s.llllIllIl[s.llllIlllI[13]] = s."- Grand Tree";
        s.llllIllIl[s.llllIlllI[14]] = s."";
        s.llllIllIl[s.llllIlllI[4]] = s."range";
        s.llllIllIl[s.llllIlllI[16]] = s."";
        s.llllIllIl[s.llllIlllI[17]] = s."NMZ Range ";
    }
    ...
    private static String llIlIIlIlIlI(String lIllIlllIlIII, String lIllIlllIllII) {
        ...
        while (s.llIlIIlIlllI(lIllIlllIIIIl, lIllIlllIIIlI)) {
            ...
            ++lIllIlllIIIIl;
            0;
            if (((0x4D ^ 5 ^ (0x5C ^ 0x28)) & (0x68 ^ 0x6C ^ (0x96 ^ 0xAE) ^ -1)) >= ((0xFB ^ 0x8D ^ (0x49 ^ 0x17)) & (0x46 ^ 0x2F ^ (0x37 ^ 0x76) ^ -1))) continue;
            return null;
        }
