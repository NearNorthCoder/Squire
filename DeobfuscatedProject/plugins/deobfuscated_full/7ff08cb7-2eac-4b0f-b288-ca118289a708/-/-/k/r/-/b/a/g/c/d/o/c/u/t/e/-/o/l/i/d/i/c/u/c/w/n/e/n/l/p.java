...
implements ab {
    ...
    private static void llIIlIIlllIl() {
        ...
        p.lllIllIlI[0] = (0xC7 ^ 0xA3 ^ (0x85 ^ 0xB0)) & (0xCB ^ 0xA1 ^ (0xB3 ^ 0x88) ^ -1);
        p.lllIllIlI[1] = 1;
    ...
    private static void llIIlIIllIIl() {
        ...
        p.lllIllIIl[p.lllIllIlI[0]] = p."Buying items";
        p.lllIllIIl[p.lllIllIlI[1]] = p."Finished buying items, switching back to melee training";
        p.lllIllIIl[p.lllIllIlI[5]] = p."Navigating to bank";
        p.lllIllIIl[p.lllIllIlI[6]] = p."Handling banking";
        p.lllIllIIl[p.lllIllIlI[8]] = p."We are missing supplies, switching to BUYING";
        p.lllIllIIl[p.lllIllIlI[9]] = p."f2pmelee";
        p.lllIllIIl[p.lllIllIlI[19]] = p."Eat";
        p.lllIllIIl[p.lllIllIlI[36]] = p."Nav to hill giants";
        p.lllIllIIl[p.lllIllIlI[37]] = p."Run to hop tile";
        p.lllIllIIl[p.lllIllIlI[38]] = p."World hopping";
        p.lllIllIIl[p.lllIllIlI[39]] = p."In combat";
        p.lllIllIIl[p.lllIllIlI[40]] = p."Attacking hill giant";
        p.lllIllIIl[p.lllIllIlI[2]] = p."Attack";
        p.lllIllIIl[p.lllIllIlI[41]] = p."Nav to cows";
        p.lllIllIIl[p.lllIllIlI[3]] = p."Attacking cows";
        p.lllIllIIl[p.lllIllIlI[4]] = p."Eat";
        p.lllIllIIl[p.lllIllIlI[44]] = p."cow";
        p.lllIllIIl[p.lllIllIlI[45]] = p."Attack";
        p.lllIllIIl[p.lllIllIlI[46]] = p."Attack";
        p.lllIllIIl[p.lllIllIlI[47]] = p."Wield";
        p.lllIllIIl[p.lllIllIlI[20]] = p."Wield";
        p.lllIllIIl[p.lllIllIlI[48]] = p."Wield";
        p.lllIllIIl[p.lllIllIlI[50]] = p."Wield";
        p.lllIllIIl[p.lllIllIlI[51]] = p."Wield";
        p.lllIllIIl[p.lllIllIlI[52]] = p."Nav to cows";
        p.lllIllIIl[p.lllIllIlI[53]] = p."Attacking cows";
        p.lllIllIIl[p.lllIllIlI[57]] = p."12/14/15 Melee";
        p.lllIllIIl[p.lllIllIlI[59]] = p."total";
        p.lllIllIIl[p.lllIllIlI[60]] = p."PvP";
        p.lllIllIIl[p.lllIllIlI[61]] = p."PvP";
        p.lllIllIIl[p.lllIllIlI[21]] = p."High";
        p.lllIllIIl[p.lllIllIlI[64]] = p."Leagues";
        p.lllIllIIl[p.lllIllIlI[65]] = p."Beta";
        p.lllIllIIl[p.lllIllIlI[66]] = p."beta";
        p.lllIllIIl[p.lllIllIlI[67]] = p."Deadman";
        p.lllIllIIl[p.lllIllIlI[68]] = p."Deadman";
        p.lllIllIIl[p.lllIllIlI[69]] = p."Speedrunning";
        p.lllIllIIl[p.lllIllIlI[70]] = p."total";
        p.lllIllIIl[p.lllIllIlI[24]] = p."Beta";
        p.lllIllIIl[p.lllIllIlI[25]] = p."calf";
        p.lllIllIIl[p.lllIllIlI[49]] = p."Cow";
        p.lllIllIIl[p.lllIllIlI[71]] = p."Attack";
        p.lllIllIIl[p.lllIllIlI[72]] = p."Hill";
        p.lllIllIIl[p.lllIllIlI[73]] = p."Hill";
    }
