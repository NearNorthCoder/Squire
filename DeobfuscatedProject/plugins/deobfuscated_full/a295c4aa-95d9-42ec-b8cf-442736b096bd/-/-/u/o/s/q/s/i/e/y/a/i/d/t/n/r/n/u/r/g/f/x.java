...
/* TASK: Pouring crucible -> PouringcrucibleTask */
...
extends j {
    ...
    private static void lIIIIIllIlIlIlI() {
        ...
        x.llIlIlIllIll[x.llIlIlIlllII[0]] = x."Pour";
        x.llIlIlIllIll[x.llIlIlIlllII[2]] = x."Pour";
    }
    ...
    private static String lIIIIIllIlIlIIl(String var3, String var4) {
        try {
