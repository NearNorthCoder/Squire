...
extends Task {
    ...
    public boolean run() {
        ...
        if (i.lIIIIIlllllIIII(var1.P.m(), llIlIlllIIII[1])) {
            return llIlIlllIIII[0];
        }
        if (i.lIIIIIlllllIIIl(var1.P.f() ? 1 : 0)) {
            return llIlIlllIIII[0];
        }
        if (i.lIIIIIlllllIIIl(var1.P.n() ? 1 : 0)) {
            return llIlIlllIIII[0];
        }
        if (i.lIIIIIlllllIIlI(var1.P.a(var1.Q) ? 1 : 0)) {
            return var1.N();
        }
