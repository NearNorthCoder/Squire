...
/* TASK: Completing Sheep Shearer -> CompletingsheepshearerTask */
...
extends Task {
    ...
    private static String lIlIIIlIIIlIIll(String var3, String var12) {
        try {
            ...
            var8.init(lIIIllIIllIll[10], var4);
    ...
    public boolean run() {
        ...
        block27: {
            block26: {
                block25: {
                    ...
                    if (A.lIlIIIlIIIlIlll(var19.Q(), lIIIllIIllIll[1])) {
                        return lIIIllIIllIll[0];
                    }
                    System.out.println(var19.Q());
            ...
            if (A.lIlIIIlIIIllIIl(Bank.isOpen() ? 1 : 0) && A.lIlIIIlIIIllIIl(var19.cx() ? 1 : 0)) {
                Bank.withdraw((int)lIIIllIIllIll[6], (int)lIIIllIIllIll[3], (Bank.WithdrawMode)Bank.WithdrawMode.ITEM);
                var19.sleep(lIIIllIIllIll[3]);
            }
        }
        if (A.lIlIIIlIIIllIIl(Bank.isOpen() ? 1 : 0) && A.lIlIIIlIIIllIIl(var19.cx() ? 1 : 0)) {
            Bank.withdraw((int)lIIIllIIllIll[6], (int)lIIIllIIllIll[3], (Bank.WithdrawMode)Bank.WithdrawMode.ITEM);
        ...
        if (A.lIlIIIlIIIllIIl(Inventory.contains((int[])nArray5) ? 1 : 0) && A.lIlIIIlIIIllIII(var19.cb(), lIIIllIIllIll[2])) {
        ...
        if (A.lIlIIIlIIIllIlI(var19.cb(), lIIIllIIllIll[2])) {
    ...
    private static void lIlIIIlIIIlIlII() {
        ...
        A.lIIIllIIllIlI[A.lIIIllIIllIll[0]] = A."Bank booth";
        A.lIIIllIIllIlI[A.lIIIllIIllIll[3]] = A."Bank";
        A.lIIIllIIllIlI[A.lIIIllIIllIll[10]] = A."Shop keeper";
        A.lIIIllIIllIlI[A.lIIIllIIllIll[12]] = A."Trade";
        A.lIIIllIIllIlI[A.lIIIllIIllIll[16]] = A."Shear";
        A.lIIIllIIllIlI[A.lIIIllIIllIll[20]] = A."Spinning wheel";
        A.lIIIllIIllIlI[A.lIIIllIIllIll[21]] = A."Spin";
        A.lIIIllIIllIlI[A.lIIIllIIllIll[22]] = A."Ball of Wool";
        A.lIIIllIIllIlI[A.lIIIllIIllIll[25]] = A."Talk-to";
        A.lIIIllIIllIlI[A.lIIIllIIllIll[26]] = A."We need coins";
        A.lIIIllIIllIlI[A.lIIIllIIllIll[27]] = A."Sheep";
        A.lIIIllIIllIlI[A.lIIIllIIllIll[28]] = A."Shear";
    }
    ...
    private static String lIlIIIlIIIlIIlI(String var18, String var13) {
        var18 = new String(Base64.getDecoder().decode(var18.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var17 = new StringBuilder();
        char[] var1 = var13.toCharArray();
        int var9 = lIIIllIIllIll[0];
        char[] var6 = var18.toCharArray();
        int var15 = var6.length;
        int var7 = lIIIllIIllIll[0];
        while (A.lIlIIIlIIIllIII(var7, var15)) {
            char var20 = var6[var7];
            var17.append((char)(var20 ^ var1[var9 % var1.length]));
            0;
            ++var9;
            ++var7;
            0;
    ...
    private static String lIlIIIlIIIlIIIl(String var16, String var5) {
        try {
            SecretKeySpec var14 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var5.getBytes(StandardCharsets.UTF_8)), lIIIllIIllIll[25]), "DES");
            Cipher var10 = Cipher.getInstance("DES");
            var10.init(lIIIllIIllIll[10], var14);
