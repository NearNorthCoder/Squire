...
extends Task {
    ...
    private static String lIlIIIlIlIlllII(String var17, String var10) {
        try {
            SecretKeySpec var16 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var10.getBytes(StandardCharsets.UTF_8)), lIIIllIlIllIl[22]), "DES");
            Cipher var1 = Cipher.getInstance("DES");
            var1.init(lIIIllIlIllIl[8], var16);
    ...
    private static String lIlIIIlIlIlllIl(String var11, String var12) {
        var11 = new String(Base64.getDecoder().decode(var11.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var3 = new StringBuilder();
        char[] var13 = var12.toCharArray();
        int var15 = lIIIllIlIllIl[0];
        char[] var5 = var11.toCharArray();
        int var7 = var5.length;
        int var2 = lIIIllIlIllIl[0];
        while (l.lIlIIIlIllIIlIl(var2, var7)) {
            char var6 = var5[var2];
            var3.append((char)(var6 ^ var13[var15 % var13.length]));
            0;
            ++var15;
            ++var2;
            0;
    ...
    public boolean run() {
        ...
        if (l.lIlIIIlIllIIIIl(var9.a(Quest.BELOW_ICE_MOUNTAIN.getId()))) {
            return lIIIllIlIllIl[0];
        }
        ...
        if (l.lIlIIIlIllIIIlI(Inventory.contains((int[])nArray) ? 1 : 0)) {
            ...
            var4 = TileItems.getFirstAt((WorldPoint)new WorldPoint(lIIIllIlIllIl[3], lIIIllIlIllIl[4], lIIIllIlIllIl[0]), (int[])nArray2);
            if (l.lIlIIIlIllIIIll(var4)) {
                ...
                var4.interact(lIIIllIlIllII[lIIIllIlIllIl[0]]);
            }
        }
        ...
        if (l.lIlIIIlIllIIIlI(Inventory.contains((int[])nArray3) ? 1 : 0)) {
            ...
            if (l.lIlIIIlIllIIIlI(Inventory.contains((int[])nArray4) ? 1 : 0)) {
                ...
                TileItem var14 = TileItems.getNearest((int[])nArray5);
                if (l.lIlIIIlIllIIIll(var14)) {
                    if (l.lIlIIIlIllIIlII(var4)) {
                        var4.interact(lIIIllIlIllII[lIIIllIlIllIl[8]]);
                        0;
                    ...
                    var14.interact(lIIIllIlIllII[lIIIllIlIllIl[9]]);
                }
                0;
                ...
                if (l.lIlIIIlIllIIIll(var14)) {
                    ...
                    Inventory.getFirst((int[])nArray6).useOn(var14);
                }
            }
        }
        ...
        if (l.lIlIIIlIllIIIlI(Inventory.contains((int[])nArray11) ? 1 : 0)) {
            ...
            if (l.lIlIIIlIllIIllI(Inventory.getCount((boolean)lIIIllIlIllIl[1], (int[])nArray12), lIIIllIlIllIl[14])) {
                ...
                if (l.lIlIIIlIllIIIIl(Shop.isOpen() ? 1 : 0)) {
                ...
                } else if (l.lIlIIIlIllIIIll(var4)) {
                    ...
                    var4.interact(lIIIllIlIllII[lIIIllIlIllIl[20]]);
                }
            }
        }
        return lIIIllIlIllIl[0];
    ...
    private static void lIlIIIlIlIllllI() {
        ...
        l.lIIIllIlIllII[l.lIIIllIlIllIl[0]] = l."Take";
        l.lIIIllIlIllII[l.lIIIllIlIllIl[1]] = l."Giant rat";
        l.lIIIllIlIllII[l.lIIIllIlIllIl[8]] = l."Attack";
        l.lIIIllIlIllII[l.lIIIllIlIllIl[9]] = l."Take";
        l.lIIIllIlIllII[l.lIIIllIlIllIl[10]] = l."Cooking range";
        l.lIIIllIlIllII[l.lIIIllIlIllIl[16]] = l."Open-all";
        l.lIIIllIlIllII[l.lIIIllIlIllIl[18]] = l."Wydin";
        l.lIIIllIlIllII[l.lIIIllIlIllIl[20]] = l."Trade";
        l.lIIIllIlIllII[l.lIIIllIlIllIl[22]] = l."Man";
        l.lIIIllIlIllII[l.lIIIllIlIllIl[23]] = l."Woman";
        l.lIIIllIlIllII[l.lIIIllIlIllIl[24]] = l."Pickpocket";
        l.lIIIllIlIllII[l.lIIIllIlIllIl[25]] = l."No health, waiting to heal";
    }
