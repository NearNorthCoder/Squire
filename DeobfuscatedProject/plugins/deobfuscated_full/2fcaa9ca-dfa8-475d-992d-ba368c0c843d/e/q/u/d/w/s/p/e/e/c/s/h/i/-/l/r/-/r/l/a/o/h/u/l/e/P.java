...
/* TASK: Enter Sepulchre -> EntersepulchreTask */
...
extends Task {
    ...
    public boolean run() {
        ...
        if (P.lIIIlIIlIIlIlIl(b.B.contains((Locatable)var2) ? 1 : 0)) {
            return lllIIIlIllII[0];
        }
        if (P.lIIIlIIlIIlIlIl(var11.am.j().matchesInventory() ? 1 : 0)) {
            return lllIIIlIllII[0];
        }
        if (P.lIIIlIIlIIlIllI(Dialog.isEnterInputOpen() ? 1 : 0)) {
            Dialog.enterAmount((int)lllIIIlIllII[0]);
        }
        if (P.lIIIlIIlIIlIlII(var3 = TileObjects.getNearest(tileObject -> {
            int n2;
    ...
    private static void lIIIlIIlIIlIIlI() {
        ...
        P.lllIIIlIlIIl[P.lllIIIlIllII[0]] = P."Climb-down";
        P.lllIIIlIlIIl[P.lllIIIlIllII[1]] = P."Climb-down";
        P.lllIIIlIlIIl[P.lllIIIlIllII[2]] = P."Stairs";
    }

    private static String lIIIlIIlIIlIIIl(String var4, String var9) {
        var4 = new String(Base64.getDecoder().decode(var4.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var5 = new StringBuilder();
        char[] var10 = var9.toCharArray();
        int var6 = lllIIIlIllII[0];
        char[] var8 = var4.toCharArray();
        int var12 = var8.length;
        int var1 = lllIIIlIllII[0];
        while (P.lIIIlIIlIIllIIl(var1, var12)) {
            char var7 = var8[var1];
            var5.append((char)(var7 ^ var10[var6 % var10.length]));
            0;
            ++var6;
            ++var1;
            0;
