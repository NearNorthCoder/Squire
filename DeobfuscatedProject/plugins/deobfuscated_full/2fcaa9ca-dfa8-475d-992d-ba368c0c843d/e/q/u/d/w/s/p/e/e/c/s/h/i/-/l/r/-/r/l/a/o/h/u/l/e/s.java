...
extends Enum<s> {
    ...
    private static String lIIIlIlIIIIllll(String var1, String var3) {
        try {
            SecretKeySpec var4 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var3.getBytes(StandardCharsets.UTF_8)), lllIIlIlIlll[2]), "DES");
            Cipher var5 = Cipher.getInstance("DES");
            var5.init(lllIIlIlIlll[3], var4);
    ...
    private static void lIIIlIlIIIlIIIl() {
        ...
        s.lllIIlIlIlll[0] = (106 + 123 - 121 + 66 ^ 27 + 89 - -30 + 0) & (51 + 112 - 151 + 128 ^ 107 + 143 - 175 + 101 ^ -1);
        s.lllIIlIlIlll[1] = 1;
    ...
    private static void lIIIlIlIIIlIIII() {
        ...
        s.lllIIlIlIllI[s.lllIIlIlIlll[0]] = s."INTERACT";
    }
