...
extends OverlayPanel {
    ...
    private static void lllIIllIlllIIl() {
        ...
        SquireDukeSucellusInfoBox.lIllIlIIIlIl[SquireDukeSucellusInfoBox.lIllIlIIIllI[1]] = SquireDukeSucellusInfoBox."Squire Duke Sucellus";
        SquireDukeSucellusInfoBox.lIllIlIIIlIl[SquireDukeSucellusInfoBox.lIllIlIIIllI[4]] = SquireDukeSucellusInfoBox."Runtime:";
        SquireDukeSucellusInfoBox.lIllIlIIIlIl[SquireDukeSucellusInfoBox.lIllIlIIIllI[5]] = SquireDukeSucellusInfoBox."Kills: ";
        SquireDukeSucellusInfoBox.lIllIlIIIlIl[SquireDukeSucellusInfoBox.lIllIlIIIllI[6]] = SquireDukeSucellusInfoBox."%d (%.1f/h)";
        SquireDukeSucellusInfoBox.lIllIlIIIlIl[SquireDukeSucellusInfoBox.lIllIlIIIllI[7]] = SquireDukeSucellusInfoBox."Task:";
    }
    ...
    private static String lllIIllIlllIII(String var17, String var13) {
        try {
            ...
            var6.init(lIllIlIIIllI[5], var15);
    ...
    private static String lllIIllIllIllI(String var12, String var11) {
        try {
            SecretKeySpec var4 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var11.getBytes(StandardCharsets.UTF_8)), lIllIlIIIllI[9]), "DES");
            Cipher var7 = Cipher.getInstance("DES");
            var7.init(lIllIlIIIllI[5], var4);
    ...
    private static String lllIIllIllIlll(String var5, String var1) {
        var5 = new String(Base64.getDecoder().decode(var5.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var10 = new StringBuilder();
        char[] var3 = var1.toCharArray();
        int var8 = lIllIlIIIllI[1];
        char[] var2 = var5.toCharArray();
        int var14 = var2.length;
        int var9 = lIllIlIIIllI[1];
        while (SquireDukeSucellusInfoBox.lllIIllIllllIl(var9, var14)) {
            char var16 = var2[var9];
            var10.append((char)(var16 ^ var3[var8 % var3.length]));
            0;
            ++var8;
            ++var9;
            0;
    ...
    private static void lllIIllIlllIlI() {
        ...
        SquireDukeSucellusInfoBox.lIllIlIIIllI[1] = (57 + 10 - -40 + 47 ^ 117 + 40 - 0 + 26) & (54 + 66 - 23 + 43 ^ 112 + 130 - 220 + 139 ^ -1);
        SquireDukeSucellusInfoBox.lIllIlIIIllI[2] = 134 + 79 - 36 + 16;
        SquireDukeSucellusInfoBox.lIllIlIIIllI[3] = 68 + 26 - -11 + 24 ^ 56 + 47 - 40 + 86;
        SquireDukeSucellusInfoBox.lIllIlIIIllI[4] = 1;
        SquireDukeSucellusInfoBox.lIllIlIIIllI[5] = 2;
        SquireDukeSucellusInfoBox.lIllIlIIIllI[6] = 3;
