...
extends SquirePlugin {
    ...
    private static void llIl() {
        lIIl = new int[9];
        TickCooker.lIIl[0] = (0x3F ^ 0x6B ^ (0x6F ^ 0x25)) & (0x56 ^ 0x6F ^ (0xAC ^ 0x8B) ^ -1);
        TickCooker.lIIl[1] = 1;
    ...
    private static void llII() {
        ...
        TickCooker.lll[TickCooker.lIIl[0]] = TickCooker."Cook";
        TickCooker.lll[TickCooker.lIIl[1]] = TickCooker."Cook";
        TickCooker.lll[TickCooker.lIIl[4]] = TickCooker."Eat";
        TickCooker.lll[TickCooker.lIIl[5]] = TickCooker."Eat";
        TickCooker.lll[TickCooker.lIIl[6]] = TickCooker."Burnt";
    }
