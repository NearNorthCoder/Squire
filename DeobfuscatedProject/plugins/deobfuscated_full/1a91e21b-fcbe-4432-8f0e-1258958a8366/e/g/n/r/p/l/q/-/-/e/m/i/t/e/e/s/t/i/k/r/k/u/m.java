...
extends Task {
    ...
    private static String lIllIIIIIIllIlI(String var5, String var1) {
        try {
            SecretKeySpec var3 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var1.getBytes(StandardCharsets.UTF_8)), lIIllIIlllllI[2]), "DES");
            Cipher var4 = Cipher.getInstance("DES");
            var4.init(lIIllIIlllllI[3], var3);
