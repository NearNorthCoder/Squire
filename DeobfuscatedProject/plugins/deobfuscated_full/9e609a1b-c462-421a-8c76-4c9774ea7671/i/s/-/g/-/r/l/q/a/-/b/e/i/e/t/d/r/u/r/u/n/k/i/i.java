...
implements M {
    ...
    private static String lIlIIlIIlllIlII(String var19, String var24) {
        try {
            ...
            var6.init(lIIIllllIIIII[2], var17);
    ...
    private static String lIlIIlIIlllIIlI(String var2, String var23) {
        var2 = new String(Base64.getDecoder().decode(var2.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var10 = new StringBuilder();
        char[] var15 = var23.toCharArray();
        int var13 = lIIIllllIIIII[0];
        char[] var5 = var2.toCharArray();
        int var20 = var5.length;
        int var25 = lIIIllllIIIII[0];
        while (i.lIlIIlIlIIlIlIl(var25, var20)) {
            char var21 = var5[var25];
            var10.append((char)(var21 ^ var15[var13 % var15.length]));
            0;
            ++var13;
            ++var25;
            0;
    ...
    private static void R() {
        ...
        if (i.lIlIIlIlIIlllIl(Players.getLocal().getInteracting())) {
            ...
            if (i.lIlIIlIlIIlIlll(var11) && i.lIlIIlIlIIlIllI(Players.getLocal().isMoving() ? 1 : 0)) {
                AccBuilderRat.c = lIIIlllIllIll[lIIIllllIIIII[45]];
                var11.interact(lIIIlllIllIll[lIIIllllIIIII[46]]);
        ...
        if (i.lIlIIlIlIIlIllI(by ? 1 : 0)) {
            ...
            if (i.lIlIIlIlIIlIlII(i.S() ? 1 : 0)) {
                ...
                if (i.lIlIIlIlIIllIIl(Skills.getLevel((Skill)Skill.MAGIC), lIIIllllIIIII[6])) {
                    ...
                    Item var1 = Inventory.getFirst((int[])nArray18);
                    if (i.lIlIIlIlIIlIllI(bz ? 1 : 0)) {
                        ...
                        if (i.lIlIIlIlIIlIlII(Players.getLocal().getWorldLocation().equals((Object)bD) ? 1 : 0) && i.lIlIIlIlIIlIlll(var4) && i.lIlIIlIlIIlIlll(var1)) {
                            var14 = Skills.getExperience((Skill)Skill.MAGIC);
                            Magic.cast((Spell)SpellBook.Standard.HIGH_LEVEL_ALCHEMY, (Item)var1);
                            Time.sleepUntil(() -> {
                                boolean bl;
                                if (i.lIlIIlIlIIlllll(Skills.getExperience((Skill)Skill.MAGIC), var14)) {
                                    bl = lIIIllllIIIII[1];
                                    0;
                    ...
                    if (i.lIlIIlIlIIlIlII(bz ? 1 : 0)) {
                        if (i.lIlIIlIlIIlIlll(var4) && i.lIlIIlIlIIlIlll(var1) && i.lIlIIlIlIIllIlI(Players.getLocal().getAnimation(), lIIIllllIIIII[27])) {
                            var14 = Skills.getExperience((Skill)Skill.MAGIC);
                            Magic.cast((Spell)SpellBook.Standard.HIGH_LEVEL_ALCHEMY, (Item)var1);
                            Time.sleepUntil(() -> {
                                boolean bl;
    ...
    private static String lIlIIlIIlllIIll(String var22, String var3) {
        try {
            SecretKeySpec var12 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var3.getBytes(StandardCharsets.UTF_8)), lIIIllllIIIII[29]), "DES");
            Cipher var16 = Cipher.getInstance("DES");
            var16.init(lIIIllllIIIII[2], var12);
    ...
    private static void W() {
        ...
        if (i.lIlIIlIlIIlIlIl(Skills.getLevel((Skill)Skill.MAGIC), lIIIllllIIIII[6])) {
            ...
            if (i.lIlIIlIlIIlIllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                var7 = new d(lIIIllllIIIII[7], lIIIllllIIIII[59], lIIIllllIIIII[24]);
                bA.add((d)var7);
                0;
            }
            int[] nArray3 = new int[lIIIllllIIIII[1]];
            ...
            if (i.lIlIIlIlIIlIllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
                var7 = new d(lIIIllllIIIII[9], lIIIllllIIIII[60], lIIIllllIIIII[24]);
                bA.add((d)var7);
                0;
            }
            int[] nArray4 = new int[lIIIllllIIIII[1]];
            ...
            if (i.lIlIIlIlIIlIllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
                var7 = new d(lIIIllllIIIII[11], lIIIllllIIIII[61], lIIIllllIIIII[24]);
                bA.add((d)var7);
                0;
            }
            int[] nArray5 = new int[lIIIllllIIIII[1]];
            ...
            if (i.lIlIIlIlIIlIllI(Bank.contains((int[])nArray5) ? 1 : 0)) {
                var7 = new d(lIIIllllIIIII[12], lIIIllllIIIII[4], lIIIllllIIIII[24]);
                bA.add((d)var7);
                0;
            }
            int[] nArray6 = new int[lIIIllllIIIII[1]];
            ...
            if (i.lIlIIlIlIIlIllI(Bank.contains((int[])nArray6) ? 1 : 0)) {
                var7 = new d(lIIIllllIIIII[44], lIIIllllIIIII[1], e.c(lIIIllllIIIII[62], lIIIllllIIIII[63]));
                bA.add((d)var7);
                0;
            }
        }
        if (i.lIlIIlIlIIllIIl(Skills.getLevel((Skill)Skill.MAGIC), lIIIllllIIIII[6])) {
            ...
            if (i.lIlIIlIlIIlIlII(Bank.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (i.lIlIIlIlIIlIlIl(Bank.getFirst((int[])nArray7).getQuantity(), lIIIllllIIIII[61])) {
                    ...
                    var7 = new d(lIIIllllIIIII[22], lIIIllllIIIII[61] - Bank.getFirst((int[])nArray8).getQuantity(), lIIIllllIIIII[64]);
                    bA.add((d)var7);
                    0;
                }
            }
            ...
            if (i.lIlIIlIlIIlIllI(Bank.contains((int[])nArray9) ? 1 : 0)) {
                var7 = new d(lIIIllllIIIII[22], lIIIllllIIIII[61], lIIIllllIIIII[64]);
                bA.add((d)var7);
                0;
            }
            int[] nArray10 = new int[lIIIllllIIIII[1]];
            ...
            if (i.lIlIIlIlIIlIlII(Bank.contains((int[])nArray10) ? 1 : 0)) {
                ...
                if (i.lIlIIlIlIIlIlIl(Bank.getFirst((int[])nArray11).getQuantity(), lIIIllllIIIII[61])) {
                    ...
                    var7 = new d(lIIIllllIIIII[23], lIIIllllIIIII[61] - Bank.getFirst((int[])nArray12).getQuantity(), lIIIllllIIIII[65]);
                    bA.add((d)var7);
                    0;
                }
            }
            ...
            if (i.lIlIIlIlIIlIllI(Bank.contains((int[])nArray13) ? 1 : 0)) {
                var7 = new d(lIIIllllIIIII[23], lIIIllllIIIII[61], lIIIllllIIIII[65]);
                bA.add((d)var7);
                0;
            }
            int[] nArray14 = new int[lIIIllllIIIII[1]];
            ...
            if (i.lIlIIlIlIIlIllI(Bank.contains((int[])nArray14) ? 1 : 0)) {
                ...
                nArray15[i.lIIIllllIIIII[0]] = lIIIllllIIIII[20];
                if (i.lIlIIlIlIIlIllI(Equipment.contains((int[])nArray15) ? 1 : 0)) {
                    var7 = new d(lIIIllllIIIII[20], lIIIllllIIIII[1], lIIIllllIIIII[66]);
                    bA.add((d)var7);
                    0;
                }
            }
            if (i.lIlIIlIlIIlIlII(bz ? 1 : 0)) {
                ...
                if (i.lIlIIlIlIIlIlII(Bank.contains((int[])nArray16) ? 1 : 0)) {
                    ...
                    if (i.lIlIIlIlIIlIlIl(Bank.getFirst((int[])nArray17).getQuantity(), lIIIllllIIIII[61])) {
                        ...
                        var7 = new d(lIIIllllIIIII[14], lIIIllllIIIII[61] - Bank.getFirst((int[])nArray18).getQuantity(), lIIIllllIIIII[58]);
                        bA.add((d)var7);
                        0;
                    }
                }
                ...
                if (i.lIlIIlIlIIlIllI(Bank.contains((int[])nArray19) ? 1 : 0)) {
                    var7 = new d(lIIIllllIIIII[14], lIIIllllIIIII[61], lIIIllllIIIII[58]);
                    bA.add((d)var7);
                    0;
                }
                ...
                if (i.lIlIIlIlIIlIlII(Bank.contains((int[])nArray20) ? 1 : 0)) {
                    ...
                    if (i.lIlIIlIlIIlIlIl(Bank.getFirst((int[])nArray21).getQuantity(), lIIIllllIIIII[66])) {
                        ...
                        var7 = new d(lIIIllllIIIII[21], lIIIllllIIIII[66] - Bank.getFirst((int[])nArray22).getQuantity(), lIIIllllIIIII[24]);
                        bA.add((d)var7);
                        0;
                    }
                }
                ...
                if (i.lIlIIlIlIIlIllI(Bank.contains((int[])nArray23) ? 1 : 0)) {
                    var7 = new d(lIIIllllIIIII[21], lIIIllllIIIII[66], lIIIllllIIIII[24]);
                    bA.add((d)var7);
                    0;
                }
            }
        ...
        nArray[i.lIIIllllIIIII[0]] = lIIIllllIIIII[18];
        if (i.lIlIIlIlIIlIllI(Bank.contains((int[])nArray) ? 1 : 0)) {
            var7 = new d(lIIIllllIIIII[18], lIIIllllIIIII[67], lIIIllllIIIII[37]);
            bA.add((d)var7);
            0;
        }
        if (i.lIlIIlIlIIlIllI(Bank.contains(var7 = item -> item.getName().toLowerCase().contains(lIIIlllIllIll[lIIIllllIIIII[74]])) ? 1 : 0)) {
            var18 = new d(lIIIllllIIIII[68], lIIIllllIIIII[17], lIIIllllIIIII[69]);
            bA.add(var18);
            0;
        }
        ...
        if (i.lIlIIlIlIIlIllI(Bank.contains((int[])nArray24) ? 1 : 0)) {
            var18 = new d(lIIIllllIIIII[70], lIIIllllIIIII[32], lIIIllllIIIII[71]);
            bA.add(var18);
            0;
        }
        ...
        if (i.lIlIIlIlIIlIllI(Bank.contains((int[])nArray25) ? 1 : 0)) {
            var18 = new d(lIIIllllIIIII[16], lIIIllllIIIII[32], lIIIllllIIIII[71]);
            bA.add(var18);
            0;
        }
    }
