...
implements M {
    ...
    private static String lIlIIllIlIllIlI(String var18, String var1) {
        try {
            SecretKeySpec var22 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var1.getBytes(StandardCharsets.UTF_8)), lIIIllllllllI[16]), "DES");
            Cipher var12 = Cipher.getInstance("DES");
            var12.init(lIIIllllllllI[3], var22);
    ...
    private static void bm() {
        ...
        if (y.lIlIIllIllIIIII(var27) && y.lIlIIllIlIlllIl(var27.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String lIlIIllIlIllIII(String var25, String var28) {
        var25 = new String(Base64.getDecoder().decode(var25.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var9 = new StringBuilder();
        char[] var11 = var28.toCharArray();
        int var5 = lIIIllllllllI[0];
        char[] var6 = var25.toCharArray();
        int var17 = var6.length;
        int var3 = lIIIllllllllI[0];
        while (y.lIlIIllIlIllllI(var3, var17)) {
            char var20 = var6[var3];
            var9.append((char)(var20 ^ var11[var5 % var11.length]));
            0;
            ++var5;
            ++var3;
            0;
    ...
    private static void bB() {
        block8: {
            ...
            if (y.lIlIIllIlIlllIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                Item var24 = Inventory.getFirst((String[])stringArray3);
                int[] nArray2 = new int[lIIIllllllllI[1]];
                nArray2[y.lIIIllllllllI[0]] = lIIIllllllllI[9];
                Item var8 = Inventory.getFirst((int[])nArray2);
                if (y.lIlIIllIllIIIII(var16) && y.lIlIIllIllIIIII(var8)) {
                    var16.useOn(var8);
                    Time.sleepTicks((int)lIIIllllllllI[1]);
                    0;
                }
                int[] nArray3 = new int[lIIIllllllllI[1]];
                nArray3[y.lIIIllllllllI[0]] = lIIIllllllllI[9];
                var8 = Inventory.getFirst((int[])nArray3);
                if (y.lIlIIllIllIIIII(var24) && y.lIlIIllIllIIIII(var8)) {
                    var24.useOn(var8);
                }
            }
        }
    ...
    private static String lIlIIllIlIllIIl(String var2, String var21) {
        try {
            SecretKeySpec var26 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var21.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var7 = Cipher.getInstance("Blowfish");
            var7.init(lIIIllllllllI[3], var26);
    ...
    private static void W() {
        ...
        block10: {
            block9: {
                ...
                if (y.lIlIIllIlIlllll(Bank.contains((int[])nArray2) ? 1 : 0)) {
                    var14 = new d(lIIIllllllllI[12], lIIIllllllllI[1], lIIIllllllllI[56]);
                    bA.add((d)var14);
                    0;
                }
                int[] nArray3 = new int[lIIIllllllllI[1]];
            ...
            var14 = new d(lIIIllllllllI[9], lIIIllllllllI[5], lIIIllllllllI[56]);
            bA.add((d)var14);
            0;
        }
        int[] nArray = new int[lIIIllllllllI[1]];
        ...
        if (y.lIlIIllIlIlllll(Bank.contains((int[])nArray) ? 1 : 0)) {
            var14 = new d(lIIIllllllllI[14], lIIIllllllllI[8], lIIIllllllllI[56]);
            bA.add((d)var14);
            0;
        }
        if (y.lIlIIllIlIlllll(Bank.contains((Predicate)(var14 = item -> item.getName().toLowerCase().contains(lIIIlllllllIl[lIIIllllllllI[63]]))) ? 1 : 0)) {
            var4 = new d(lIIIllllllllI[57], lIIIllllllllI[8], lIIIllllllllI[58]);
            bA.add(var4);
            0;
        }
        ...
        if (y.lIlIIllIlIlllll(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var4 = new d(lIIIllllllllI[59], lIIIllllllllI[54], lIIIllllllllI[60]);
            bA.add(var4);
            0;
        }
        ...
        if (y.lIlIIllIlIlllll(Bank.contains((int[])nArray7) ? 1 : 0)) {
            var4 = new d(lIIIllllllllI[13], lIIIllllllllI[8], h.bv);
            bA.add(var4);
            0;
        }
    }
    ...
    private static void lIlIIllIlIllIll() {
        ...
        y.lIIIlllllllIl[y.lIIIllllllllI[0]] = y."Buying items";
        y.lIIIlllllllIl[y.lIIIllllllllI[1]] = y."Finished buying items, switching back to quest";
        y.lIIIlllllllIl[y.lIIIllllllllI[3]] = y."Drink";
        y.lIIIlllllllIl[y.lIIIllllllllI[5]] = y."Navigating to bank";
        y.lIIIlllllllIl[y.lIIIllllllllI[6]] = y."Opening bank";
        y.lIIIlllllllIl[y.lIIIllllllllI[8]] = y."Handling banking";
        y.lIIIlllllllIl[y.lIIIllllllllI[10]] = y."We are missing quest supplies, switching to BUYING";
        y.lIIIlllllllIl[y.lIIIllllllllI[15]] = y."We are missing quest supplies, switching to BUYING";
        y.lIIIlllllllIl[y.lIIIllllllllI[16]] = y."Nav to start";
        y.lIIIlllllllIl[y.lIIIllllllllI[17]] = y."Starting quest";
        y.lIIIlllllllIl[y.lIIIllllllllI[18]] = y."Large door";
        y.lIIIlllllllIl[y.lIIIllllllllI[19]] = y."Open";
        y.lIIIlllllllIl[y.lIIIllllllllI[20]] = y."Open";
        y.lIIIlllllllIl[y.lIIIllllllllI[21]] = y."General Bentnoze";
        y.lIIIlllllllIl[y.lIIIllllllllI[25]] = y."Blue dye";
        y.lIIIlllllllIl[y.lIIIllllllllI[26]] = y."Orange dye";
        y.lIIIlllllllIl[y.lIIIllllllllI[27]] = y."Dying armor";
        y.lIIIlllllllIl[y.lIIIllllllllI[28]] = y."Orange dye";
        y.lIIIlllllllIl[y.lIIIllllllllI[29]] = y."Blue dye";
        y.lIIIlllllllIl[y.lIIIllllllllI[30]] = y."Orange goblin mail";
        y.lIIIlllllllIl[y.lIIIllllllllI[31]] = y."Orange goblin mail";
        y.lIIIlllllllIl[y.lIIIllllllllI[32]] = y."Nav to start";
        y.lIIIlllllllIl[y.lIIIllllllllI[33]] = y."Turning in orange";
        y.lIIIlllllllIl[y.lIIIllllllllI[34]] = y."General Bentnoze";
        y.lIIIlllllllIl[y.lIIIllllllllI[36]] = y."Blue goblin mail";
        y.lIIIlllllllIl[y.lIIIllllllllI[37]] = y."Blue goblin mail";
        y.lIIIlllllllIl[y.lIIIllllllllI[38]] = y."Nav to start";
        y.lIIIlllllllIl[y.lIIIllllllllI[39]] = y."Turning in blue";
        y.lIIIlllllllIl[y.lIIIllllllllI[40]] = y."General Bentnoze";
        y.lIIIlllllllIl[y.lIIIllllllllI[42]] = y."Turning in brown";
        y.lIIIlllllllIl[y.lIIIllllllllI[43]] = y."Nav to start";
        y.lIIIlllllllIl[y.lIIIllllllllI[44]] = y."General Bentnoze";
        y.lIIIlllllllIl[y.lIIIllllllllI[46]] = y."Navigating to bank";
        y.lIIIlllllllIl[y.lIIIllllllllI[47]] = y."Opening bank";
        y.lIIIlllllllIl[y.lIIIllllllllI[48]] = y."Handling banking";
        y.lIIIlllllllIl[y.lIIIllllllllI[49]] = y."We are missing quest supplies, switching to BUYING";
        y.lIIIlllllllIl[y.lIIIllllllllI[50]] = y."We are missing quest supplies, switching to BUYING";
        y.lIIIlllllllIl[y.lIIIllllllllI[51]] = y."Blue dye";
        y.lIIIlllllllIl[y.lIIIllllllllI[52]] = y."Orange dye";
        y.lIIIlllllllIl[y.lIIIllllllllI[53]] = y."Dying armor";
        y.lIIIlllllllIl[y.lIIIllllllllI[54]] = y."Orange dye";
        y.lIIIlllllllIl[y.lIIIllllllllI[55]] = y."Blue dye";
        y.lIIIlllllllIl[y.lIIIllllllllI[62]] = y."Goblin Diplomacy";
        y.lIIIlllllllIl[y.lIIIllllllllI[63]] = y."ring of wealth (";
        y.lIIIlllllllIl[y.lIIIllllllllI[64]] = y."Yes.";
        y.lIIIlllllllIl[y.lIIIllllllllI[65]] = y."Do you want me to pick an armour colour for you?";
        y.lIIIlllllllIl[y.lIIIllllllllI[66]] = y."What about a different colour?";
        y.lIIIlllllllIl[y.lIIIllllllllI[67]] = y."I have some orange armour here.";
        y.lIIIlllllllIl[y.lIIIllllllllI[68]] = y."I have some blue armour here.";
        y.lIIIlllllllIl[y.lIIIllllllllI[69]] = y."I have some brown armour here.";
        y.lIIIlllllllIl[y.lIIIllllllllI[70]] = y."I'll leave you to it.";
    }
        ...
        block49: {
            ...
            block52: {
                    ...
                    block51: {
                        block50: {
                            ...
                            if (y.lIlIIllIlIlllll(y.S() ? 1 : 0) && y.lIlIIllIlIllllI(e.j(lIIIllllllllI[4]), lIIIllllllllI[1])) {
                                ...
                                if (y.lIlIIllIllIIIII(var13) && y.lIlIIllIlIlllll(var13.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    AccBuilderRat.c = lIIIlllllllIl[lIIIllllllllI[5]];
                                    a.a(var13);
                                }
                                if (y.lIlIIllIllIIIII(var13) && y.lIlIIllIlIlllIl(var13.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    if (y.lIlIIllIlIlllll(Bank.isOpen() ? 1 : 0)) {
                            ...
                            if (y.lIlIIllIlIlllIl(y.S() ? 1 : 0) && y.lIlIIllIlIllllI(e.j(lIIIllllllllI[4]), lIIIllllllllI[1])) {
                                ...
                                if (y.lIlIIllIllIIIIl(bY)) {
                                    ...
                                    if (y.lIlIIllIllIIIll(Players.getLocal().getWorldLocation().distanceTo(ga), lIIIllllllllI[8])) {
                                        ...
                                        if (y.lIlIIllIllIIIII(var13)) {
                                            String[] stringArray2 = new String[lIIIllllllllI[1]];
                                            stringArray2[y.lIIIllllllllI[0]] = lIIIlllllllIl[lIIIllllllllI[19]];
                                            if (y.lIlIIllIlIlllIl(var13.hasAction(stringArray2) ? 1 : 0)) {
                                                var13.interact(lIIIlllllllIl[lIIIllllllllI[20]]);
                                                Time.sleepTicks((int)lIIIllllllllI[5]);
                                                0;
                                            }
                                        }
                ...
                if (y.lIlIIllIlIlllIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    var13 = Inventory.getFirst((String[])stringArray);
                    String[] stringArray4 = new String[lIIIllllllllI[1]];
                    stringArray4[y.lIIIllllllllI[0]] = lIIIlllllllIl[lIIIllllllllI[29]];
                    Item var10 = Inventory.getFirst((String[])stringArray4);
                    int[] nArray6 = new int[lIIIllllllllI[1]];
                    nArray6[y.lIIIllllllllI[0]] = lIIIllllllllI[9];
                    Item var23 = Inventory.getFirst((int[])nArray6);
                    if (y.lIlIIllIllIIIII(var13) && y.lIlIIllIllIIIII(var23)) {
                        var13.useOn(var23);
                        Time.sleepTicks((int)lIIIllllllllI[1]);
                        0;
                    }
                    ...
                    var23 = Inventory.getFirst((int[])nArray7);
                    if (y.lIlIIllIllIIIII(var10) && y.lIlIIllIllIIIII(var23)) {
                        var10.useOn(var23);
                    }
                }
            }
            ...
            if (y.lIlIIllIllIIIII(var13 = Widgets.get((int)lIIIllllllllI[45], (int)lIIIllllllllI[26]))) {
                var13.interact(lIIIllllllllI[0]);
            }
