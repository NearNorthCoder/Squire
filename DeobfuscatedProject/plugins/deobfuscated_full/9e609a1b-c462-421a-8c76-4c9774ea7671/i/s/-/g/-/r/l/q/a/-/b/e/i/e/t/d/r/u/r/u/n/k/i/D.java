...
implements M {
    ...
    public static void ci() {
        ...
        if (D.lIlIIllllIllllI(by ? 1 : 0)) {
            ...
            if (D.lIlIIllllIllllI(D.S() ? 1 : 0) && D.lIlIIllllIlllIl(e.j(lIIlIIIIlIIll[2]), lIIlIIIIlIIll[0])) {
                ...
                if (D.lIlIIllllIlllll(var8) && D.lIlIIllllIllllI(var8.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderRat.c = lIIlIIIIlIIlI[lIIlIIIIlIIll[0]];
                    a.a((BankLocation)var8);
                }
                if (D.lIlIIllllIlllll(var8) && D.lIlIIllllIlllII(var8.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (D.lIlIIllllIlllII(Inventory.contains((String[])stringArray2) ? 1 : 0)) {
                    ...
                    if (D.lIlIIllllIllllI(Inventory.contains((String[])stringArray3) ? 1 : 0)) {
                        ...
                        if (D.lIlIIllllIllllI(Inventory.contains((int[])nArray8) ? 1 : 0)) {
                            ...
                            var8 = NPCs.getNearest((String[])stringArray5);
                            ...
                            if (!D.lIlIIllllIlllll(var8) || D.lIlIIllllIlllll(var8) && D.lIlIIllllIllllI(Reachable.isInteractable((Locatable)var8) ? 1 : 0)) {
                                Movement.walkTo((WorldPoint)hb);
                                0;
                                Time.sleepTicks((int)lIIlIIIIlIIll[0]);
                                0;
                            }
                            if (D.lIlIIllllIlllll(var8)) {
                    ...
                    if (D.lIlIIllllIlllII(Inventory.contains((String[])stringArray7) ? 1 : 0)) {
                        ...
                        if (D.lIlIIllllIllllI(Inventory.contains((String[])stringArray8) ? 1 : 0) && D.lIlIIllllIllllI(he ? 1 : 0)) {
                            ...
                            if (D.lIlIIlllllIIIll(Players.getLocal().getWorldLocation().distanceTo(hc), lIIlIIIIlIIll[18])) {
                                var8 = new WorldPoint(lIIlIIIIlIIll[47], lIIlIIIIlIIll[48], lIIlIIIIlIIll[1]);
                                llllllllllllllIlllllllIIIllllIIl2 = new WorldPoint(lIIlIIIIlIIll[47], lIIlIIIIlIIll[49], lIIlIIIIlIIll[1]);
                                if ((!D.lIlIIllllIllllI(Players.getLocal().getWorldLocation().equals(var8) ? 1 : 0) || D.lIlIIllllIlllII(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllIlllllllIIIllllIIl2) ? 1 : 0)) && D.lIlIIllllIllllI(Players.getLocal().isMoving() ? 1 : 0)) {
                    ...
                    if (D.lIlIIllllIlllII(Inventory.contains((String[])stringArray10) ? 1 : 0)) {
                        ...
                        if (D.lIlIIllllIlllII(Inventory.contains((String[])stringArray11) ? 1 : 0) && D.lIlIIllllIllllI(he ? 1 : 0)) {
                            ...
                            if (D.lIlIIlllllIIIll(Players.getLocal().getWorldLocation().distanceTo(gZ), lIIlIIIIlIIll[14])) {
                                ...
                                var8 = Dialog.getOptions();
                                if (D.lIlIIllllIllllI(var8.isEmpty() ? 1 : 0)) {
                                    int llllllllllllllIlllllllIIIllllIIl2 = lIIlIIIIlIIll[1];
                                    while (D.lIlIIllllIlllIl(llllllllllllllIlllllllIIIllllIIl2, var8.size())) {
                                        if (D.lIlIIllllIlllII(((Widget)var8.get(llllllllllllllIlllllllIIIllllIIl2)).getText().contains(lIIlIIIIlIIlI[lIIlIIIIlIIll[57]]) ? 1 : 0)) {
                                            System.out.println(lIIlIIIIlIIlI[lIIlIIIIlIIll[58]]);
                                            he = lIIlIIIIlIIll[0];
                                        }
                                        ++llllllllllllllIlllllllIIIllllIIl2;
                                        0;
                                        if (2 >= ((0x2D ^ 1) & ~(0xEC ^ 0xC0))) continue;
                                        return;
                                    }
                                }
                            }
                    ...
                    if (D.lIlIIllllIlllII(Inventory.contains((String[])stringArray12) ? 1 : 0)) {
                        ...
                        if (D.lIlIIllllIlllII(Inventory.contains((String[])stringArray13) ? 1 : 0)) {
                            ...
                            if (D.lIlIIllllIllllI(var8.isEmpty() ? 1 : 0)) {
                                int llllllllllllllIlllllllIIIllllIIl2 = lIIlIIIIlIIll[1];
                                while (D.lIlIIllllIlllIl(llllllllllllllIlllllllIIIllllIIl2, var8.size())) {
                                    if (D.lIlIIllllIlllII(((Widget)var8.get(llllllllllllllIlllllllIIIllllIIl2)).getText().contains(lIIlIIIIlIIlI[lIIlIIIIlIIll[62]]) ? 1 : 0)) {
            ...
            if (!D.lIlIIlllllIIlIl(e.j(lIIlIIIIlIIll[2]), lIIlIIIIlIIll[57]) || D.lIlIIlllllIIlII(e.j(lIIlIIIIlIIll[2]), lIIlIIIIlIIll[58])) {
                ...
                if (D.lIlIIllllIlllII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    var8 = new WorldArea(lIIlIIIIlIIll[71], lIIlIIIIlIIll[72], lIIlIIIIlIIll[24], lIIlIIIIlIIll[18], lIIlIIIIlIIll[1]);
                    g.a(bW);
                    if (D.lIlIIllllIllllI(var8.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (D.lIlIIllllIlllII(var8.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (D.lIlIIlllllIIlII(e.j(lIIlIIIIlIIll[2]), lIIlIIIIlIIll[32])) {
                var8 = new WorldArea(lIIlIIIIlIIll[71], lIIlIIIIlIIll[72], lIIlIIIIlIIll[14], lIIlIIIIlIIll[5], lIIlIIIIlIIll[1]);
                if (D.lIlIIllllIllllI(var8.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (D.lIlIIlllllIIlII(e.j(lIIlIIIIlIIll[2]), lIIlIIIIlIIll[83])) {
                if (D.lIlIIlllllIIIlI(Players.getLocal().getWorldLocation().distanceTo(fd), lIIlIIIIlIIll[18])) {
                    WorldArea llllllllllllllIlllllllIIIllllIIl2;
                    var8 = new WorldArea(lIIlIIIIlIIll[71], lIIlIIIIlIIll[72], lIIlIIIIlIIll[14], lIIlIIIIlIIll[5], lIIlIIIIlIIll[1]);
                    if (D.lIlIIllllIlllII(var8.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && D.lIlIIllllIllllI(Equipment.contains((int[])f.aW) ? 1 : 0)) {
    ...
    private static String lIlIIllllIllIII(String var11, String var10) {
        try {
            ...
            var23.init(lIIlIIIIlIIll[4], var14);
    ...
    private static void W() {
        block22: {
            ...
            block21: {
                ...
                block20: {
                    block19: {
                        ...
                        if (D.lIlIIllllIllllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                            var4 = new d(lIIlIIIIlIIll[26], lIIlIIIIlIIll[0], lIIlIIIIlIIll[93]);
                            bA.add((d)var4);
                            0;
                        }
                        ...
                        if (D.lIlIIllllIllllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
                            var4 = new d(lIIlIIIIlIIll[23], lIIlIIIIlIIll[0], lIIlIIIIlIIll[93]);
                            bA.add((d)var4);
                            0;
                        }
                        ...
                        if (D.lIlIIllllIllllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
                            var4 = new d(lIIlIIIIlIIll[21], lIIlIIIIlIIll[0], lIIlIIIIlIIll[93]);
                            bA.add((d)var4);
                            0;
                        }
                        int[] nArray5 = new int[lIIlIIIIlIIll[0]];
                    ...
                    var4 = new d(lIIlIIIIlIIll[6], lIIlIIIIlIIll[7], lIIlIIIIlIIll[93]);
                    bA.add((d)var4);
                    0;
                }
                int[] nArray = new int[lIIlIIIIlIIll[0]];
                ...
                if (D.lIlIIllllIllllI(Bank.contains((int[])nArray) ? 1 : 0)) {
                    var4 = new d(lIIlIIIIlIIll[15], lIIlIIIIlIIll[0], lIIlIIIIlIIll[93]);
                    bA.add((d)var4);
                    0;
                }
                int[] nArray8 = new int[lIIlIIIIlIIll[0]];
                ...
                if (D.lIlIIllllIllllI(Bank.contains((int[])nArray8) ? 1 : 0)) {
                    var4 = new d(lIIlIIIIlIIll[17], lIIlIIIIlIIll[0], lIIlIIIIlIIll[93]);
                    bA.add((d)var4);
                    0;
                }
                int[] nArray9 = new int[lIIlIIIIlIIll[0]];
                ...
                if (D.lIlIIllllIllllI(Bank.contains((int[])nArray9) ? 1 : 0)) {
                    var4 = new d(lIIlIIIIlIIll[19], lIIlIIIIlIIll[0], lIIlIIIIlIIll[93]);
                    bA.add((d)var4);
                    0;
                }
                int[] nArray10 = new int[lIIlIIIIlIIll[0]];
                ...
                if (D.lIlIIllllIllllI(Bank.contains((int[])nArray10) ? 1 : 0)) {
                    var4 = new d(lIIlIIIIlIIll[13], lIIlIIIIlIIll[0], lIIlIIIIlIIll[93]);
                    bA.add((d)var4);
                    0;
                }
                ...
                if (D.lIlIIllllIllllI(Bank.contains((int[])nArray11) ? 1 : 0)) {
                    var4 = new d(lIIlIIIIlIIll[12], lIIlIIIIlIIll[0], lIIlIIIIlIIll[93]);
                    bA.add((d)var4);
                    0;
                }
                ...
                if (D.lIlIIllllIllllI(Bank.contains((int[])nArray12) ? 1 : 0)) {
                    var4 = new d(lIIlIIIIlIIll[11], lIIlIIIIlIIll[7], lIIlIIIIlIIll[93]);
                    bA.add((d)var4);
                    0;
                }
                ...
                if (D.lIlIIllllIllllI(Bank.contains((int[])nArray13) ? 1 : 0)) {
                    var4 = new d(lIIlIIIIlIIll[10], lIIlIIIIlIIll[0], lIIlIIIIlIIll[93]);
                    bA.add((d)var4);
                    0;
                }
                if (D.lIlIIllllIllllI(Bank.contains((Predicate)(var4 = item -> item.getName().toLowerCase().contains(lIIlIIIIlIIlI[lIIlIIIIlIIll[99]]))) ? 1 : 0)) {
                    var15 = new d(lIIlIIIIlIIll[94], lIIlIIIIlIIll[14], lIIlIIIIlIIll[95]);
                    bA.add(var15);
                    0;
                }
                ...
                if (D.lIlIIllllIllllI(Bank.contains((int[])nArray14) ? 1 : 0)) {
                    var15 = new d(lIIlIIIIlIIll[29], lIIlIIIIlIIll[5], h.bv);
                    bA.add(var15);
                    0;
                }
            ...
            var15 = new d(lIIlIIIIlIIll[9], lIIlIIIIlIIll[67], lIIlIIIIlIIll[96]);
            bA.add(var15);
            0;
        }
    }
    ...
    private static void lIlIIllllIllIlI() {
        ...
        D.lIIlIIIIlIIll[60] = 1 ^ (0x52 ^ 0x72);
        ...
        D.lIIlIIIIlIIll[69] = 0x38 ^ 0x11 ^ 3;
        ...
        D.lIIlIIIIlIIll[87] = 1 ^ (0x47 ^ 0x7E);
    ...
    private static boolean S() {
        ...
        int[] nArray2 = nArray;
        int var19 = lIIlIIIIlIIll[1];
        while (D.lIlIIllllIlllIl(var19, ((void)var21).length)) {
            int[] nArray3 = new int[lIIlIIIIlIIll[0]];
            nArray3[D.lIIlIIIIlIIll[1]] = var21[var19];
    ...
    private static void lIlIIllllIllIIl() {
        ...
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[1]] = D."Finished buying items, switching back to quest";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[0]] = D."Nav to bank";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[4]] = D."Handling banking";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[7]] = D."We are missing quest supplies, switching to BUYING";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[5]] = D."We are missing quest supplies, switching to BUYING";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[14]] = D."Drink";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[16]] = D."Eat";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[18]] = D."Nav to start";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[20]] = D."Chancellor Hassan";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[22]] = D."Nav to osman";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[24]] = D."Osman";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[25]] = D."Wig";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[8]] = D."Wear";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[34]] = D."Nav to ned";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[35]] = D."Ned";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[36]] = D."Wig";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[37]] = D."Paste";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[38]] = D."Wig";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[39]] = D."Aggie";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[42]] = D."Aggie";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[33]] = D."Wig";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[43]] = D."Paste";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[44]] = D."Key print";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[46]] = D."Nav to keli";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[52]] = D."Lady Keli";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[45]] = D."Wig";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[53]] = D."Paste";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[54]] = D."Key print";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[55]] = D."Nav to osman";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[56]] = D."Osman";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[57]] = D."Draynor is";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[58]] = D."go to leela";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[59]] = D."Wig";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[60]] = D."Paste";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[61]] = D."Osman";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[62]] = D."Draynor is";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[63]] = D."go to leela";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[64]] = D."Wig";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[65]] = D."Paste";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[66]] = D."Wear";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[67]] = D."I'll get going.";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[68]] = D."Nav to leela";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[69]] = D."Leela";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[70]] = D."Bronze key";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[73]] = D."Nav to jail";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[74]] = D."Give beer";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[75]] = D."Joe";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[76]] = D."Rope";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[77]] = D."Tying up";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[78]] = D."Rope";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[32]] = D."Lady Keli";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[79]] = D."Entering jail";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[80]] = D."Bronze key";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[81]] = D."Prison Gate";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[82]] = D."Prince Ali";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[84]] = D."Break";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[87]] = D."Open gate";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[88]] = D."Gate";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[89]] = D."Open";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[90]] = D."Nav to start";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[91]] = D."Chancellor Hassan";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[97]] = D."Prince Ali Rescue";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[99]] = D."ring of wealth (";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[100]] = D."glory";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[101]] = D."glory";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[102]] = D."glory";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[103]] = D."glory";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[116]] = D."Yes.";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[117]] = D."Is there anything I can help you with?";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[118]] = D."Could you make other things apart from rope?";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[119]] = D."How about some sort of wig?";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[120]] = D."I have them here. Please make me a wig.";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[121]] = D."Can you make skin paste?";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[122]] = D."Yes please. Mix me some skin paste.";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[123]] = D."Heard of you? You're famous in Gielinor!";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[124]] = D."What's your latest plan then?";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[125]] = D."How do you know someone won't try to free him?";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[126]] = D."Could I see the key please?";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[127]] = D."Could I touch the key for a moment please?";
        D.lIIlIIIIlIIlI[D.lIIlIIIIlIIll[128]] = D."I have some beer here. Fancy one?";
    }
    ...
    private static String lIlIIllllIlIlll(String var17, String var22) {
        var17 = new String(Base64.getDecoder().decode(var17.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var13 = new StringBuilder();
        char[] var9 = var22.toCharArray();
        int var20 = lIIlIIIIlIIll[1];
        char[] var16 = var17.toCharArray();
        int var18 = var16.length;
        int var1 = lIIlIIIIlIIll[1];
        while (D.lIlIIllllIlllIl(var1, var18)) {
            char var2 = var16[var1];
            var13.append((char)(var2 ^ var9[var20 % var9.length]));
            0;
            ++var20;
            ++var1;
            0;
            if (((0 + 64 - 25 + 94 ^ 27 + 122 - 13 + 12) & (0x18 ^ 0x38 ^ (0xAF ^ 0x9E) ^ -1)) == ((104 + 56 - 32 + 54 ^ 116 + 6 - -22 + 1) & (0x69 ^ 0x34 ^ (0xDF ^ 0xA5) ^ -1))) continue;
            return null;
        }
    ...
    private static String lIlIIllllIlIllI(String var6, String var24) {
        try {
            SecretKeySpec var3 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var24.getBytes(StandardCharsets.UTF_8)), lIIlIIIIlIIll[20]), "DES");
            Cipher var5 = Cipher.getInstance("DES");
            var5.init(lIIlIIIIlIIll[4], var3);
