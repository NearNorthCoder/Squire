...
implements M {
    ...
    private static String lIlIIllIlllIllI(String var14, String var9) {
        try {
            ...
            var7.init(lIIlIIIIIIIlI[3], var10);
    ...
    private static String lIlIIllIlllIlII(String var18, String var4) {
        var18 = new String(Base64.getDecoder().decode(var18.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var6 = new StringBuilder();
        char[] var1 = var4.toCharArray();
        int var11 = lIIlIIIIIIIlI[0];
        char[] var13 = var18.toCharArray();
        int var19 = var13.length;
        int var8 = lIIlIIIIIIIlI[0];
        while (G.lIlIIllIllllIlI(var8, var19)) {
            char var22 = var13[var8];
            var6.append((char)(var22 ^ var1[var11 % var1.length]));
            0;
            ++var11;
            ++var8;
            0;
            if (((31 + 1 - -157 + 29 ^ 113 + 142 - 137 + 29) & (0x42 ^ 0x23 ^ (0x8E ^ 0xA6) ^ -1)) == 0) continue;
            return null;
        }
                    ...
                    if (G.lIlIIllIlllllll(Players.getLocal().getWorldLocation().distanceTo(ho), lIIlIIIIIIIlI[7])) {
                        ...
                        llllllllllllllIlllllllllIIllIlIl2 = TileObjects.getNearest(tileObject -> {
                            ...
                            if (G.lIlIIllIllllIIl(tileObject.getName().equalsIgnoreCase(lIIlIIIIIIIIl[lIIlIIIIIIIlI[44]]) ? 1 : 0) && G.lIlIIllIlllllll(tileObject.getWorldLocation().distanceTo(ho), lIIlIIIIIIIlI[9])) {
                                n2 = lIIlIIIIIIIlI[1];
                                0;
                                if ((0x3A ^ 0x2A ^ (0x1E ^ 0xA)) < -1) {
                                    return ((0x93 ^ 0xAE ^ (0x64 ^ 0x13)) & (161 + 93 - 238 + 176 ^ 128 + 16 - 28 + 22 ^ -1)) != 0;
                                }
                            } else {
                                n2 = lIIlIIIIIIIlI[0];
                            }
    ...
    private static void W() {
        ...
        if (G.lIlIIllIllllIll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var17 = new d(lIIlIIIIIIIlI[11], lIIlIIIIIIIlI[14], lIIlIIIIIIIlI[36]);
            bA.add((d)var17);
            0;
        }
        ...
        if (G.lIlIIllIllllIll(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var17 = new d(lIIlIIIIIIIlI[12], lIIlIIIIIIIlI[1], lIIlIIIIIIIlI[37]);
            bA.add((d)var17);
            0;
        }
        if (G.lIlIIllIllllIll(Bank.contains((Predicate)(var17 = item -> item.getName().toLowerCase().contains(lIIlIIIIIIIIl[lIIlIIIIIIIlI[43]]))) ? 1 : 0)) {
            var15 = new d(lIIlIIIIIIIlI[38], lIIlIIIIIIIlI[9], lIIlIIIIIIIlI[37]);
            bA.add(var15);
            0;
        }
        ...
        if (G.lIlIIllIllllIll(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var15 = new d(lIIlIIIIIIIlI[10], lIIlIIIIIIIlI[39], lIIlIIIIIIIlI[36]);
            bA.add(var15);
            0;
        }
        if (G.lIlIIllIllllIll(Bank.contains((int[])f.ba) ? 1 : 0)) {
            var15 = new d(lIIlIIIIIIIlI[40], lIIlIIIIIIIlI[9], h.bv);
            bA.add(var15);
            0;
        }
    }
    ...
    private static void lIlIIllIllllIII() {
        ...
        G.lIIlIIIIIIIlI[25] = 0x65 ^ 0x74 ^ 3;
    ...
    private static void lIlIIllIlllIlll() {
        ...
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[0]] = G."Buying items";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[1]] = G."Finished buying items, switching back to quest";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[3]] = G."Drink";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[6]] = G."Navigating to bank";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[7]] = G."Opening bank";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[9]] = G."Handling banking";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[13]] = G."We are missing quest supplies, switching to BUYING";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[15]] = G."Wear";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[16]] = G."Navigating to start";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[17]] = G."Handling dialogue";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[14]] = G."Open";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[18]] = G."Open";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[19]] = G."Duke Horacio";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[20]] = G."Handling dialogue";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[21]] = G."Duke Horacio";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[22]] = G."Air talisman";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[23]] = G."Navigating to 2nd step";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[24]] = G."Handling chat";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[25]] = G."Archmage Sedridor";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[26]] = G."Navigate to Aubury";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[27]] = G."Handling chat";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[28]] = G."Aubury";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[29]] = G."Research notes";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[30]] = G."Navigating to sedridor";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[31]] = G."Draynor Village";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[32]] = G."Handling chat";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[33]] = G."Archmage Sedridor";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[34]] = G."Handling chat";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[35]] = G."Archmage Sedridor";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[42]] = G."Rune mystery quest";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[43]] = G."ring of wealth (";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[44]] = G."Door";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[51]] = G."Have you any quests for me?";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[52]] = G."Sure, no problem.";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[53]] = G."I'm looking for the head wizard.";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[54]] = G."Okay, here you are.";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[55]] = G."Yes, certainly.";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[56]] = G."I've been sent here with a package for you.";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[57]] = G."Yes.";
        G.lIIlIIIIIIIIl[G.lIIlIIIIIIIlI[58]] = G."Go ahead.";
    }

    private static String lIlIIllIlllIlIl(String var16, String var21) {
        try {
            SecretKeySpec var3 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var21.getBytes(StandardCharsets.UTF_8)), lIIlIIIIIIIlI[16]), "DES");
            Cipher var5 = Cipher.getInstance("DES");
            var5.init(lIIlIIIIIIIlI[3], var3);
