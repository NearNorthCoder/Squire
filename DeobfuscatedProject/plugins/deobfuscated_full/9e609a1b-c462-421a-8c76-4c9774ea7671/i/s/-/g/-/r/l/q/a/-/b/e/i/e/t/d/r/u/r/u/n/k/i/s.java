...
implements M {
    ...
    private static void lIlIIlIIIIIlIlI() {
        ...
        s.lIIIlllIIllII[s.lIIIlllIIlllI[0]] = s."Buying items";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[1]] = s."Finished buying items, switching back to quest";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[4]] = s."Walking to bank";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[5]] = s."Handling banking";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[2]] = s."We are missing quest supplies, switching to BUYING";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[11]] = s."Nav to start";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[12]] = s."Handling dialog";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[13]] = s."Cook";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[22]] = s."Cooks Assistant Quest";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[23]] = s."ring of wealth (";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[14]] = s."Can you make me a cake?";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[26]] = s."I'm always happy to help a cook in distress.";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[27]] = s."Actually, I know where to find this stuff.";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[28]] = s."Yes.";
        s.lIIIlllIIllII[s.lIIIlllIIlllI[29]] = s."What's wrong?";
    }

    private static String lIlIIlIIIIIIlII(String var3, String var1) {
        try {
            SecretKeySpec var2 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var1.getBytes(StandardCharsets.UTF_8)), lIIIlllIIlllI[22]), "DES");
            Cipher var23 = Cipher.getInstance("DES");
            var23.init(lIIIlllIIlllI[4], var2);
            return new String(var23.doFinal(Base64.getDecoder().decode(var3.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlIIlIIIIIIlIl(String var14, String var20) {
        var14 = new String(Base64.getDecoder().decode(var14.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var17 = new StringBuilder();
        char[] var6 = var20.toCharArray();
        int var16 = lIIIlllIIlllI[0];
        char[] var22 = var14.toCharArray();
        int var4 = var22.length;
        int var18 = lIIIlllIIlllI[0];
        while (s.lIlIIlIIIIIllIl(var18, var4)) {
            char var21 = var22[var18];
            var17.append((char)(var21 ^ var6[var16 % var6.length]));
            0;
            ++var16;
            ++var18;
            0;
    ...
    public static void be() {
        ...
        if (s.lIlIIlIIIIIlllI(by ? 1 : 0)) {
            if (s.lIlIIlIIIIIlllI(s.S() ? 1 : 0) && s.lIlIIlIIIIIllll(Players.getLocal().getWorldLocation().distanceTo(fs), lIIIlllIIlllI[2]) && s.lIlIIlIIIIIllIl(e.j(lIIIlllIIlllI[3]), lIIIlllIIlllI[4])) {
                ...
                if (s.lIlIIlIIIIlIIII(var19) && s.lIlIIlIIIIIlllI(var19.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderRat.c = lIIIlllIIllII[lIIIlllIIlllI[4]];
                    a.a(var19);
                }
                if (s.lIlIIlIIIIlIIII(var19) && s.lIlIIlIIIIIllII(var19.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static void W() {
        ...
        if (s.lIlIIlIIIIIlllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var9 = new d(lIIIlllIIlllI[8], lIIIlllIIlllI[1], lIIIlllIIlllI[6]);
            bA.add((d)var9);
            0;
        }
        int[] nArray3 = new int[lIIIlllIIlllI[1]];
        ...
        if (s.lIlIIlIIIIIlllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var9 = new d(lIIIlllIIlllI[7], lIIIlllIIlllI[1], lIIIlllIIlllI[6]);
            bA.add((d)var9);
            0;
        }
        ...
        if (s.lIlIIlIIIIIlllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var9 = new d(lIIIlllIIlllI[10], lIIIlllIIlllI[14], lIIIlllIIlllI[15]);
            bA.add((d)var9);
            0;
        }
        if (s.lIlIIlIIIIIlllI(Bank.contains((Predicate)(var9 = item -> item.getName().toLowerCase().contains(lIIIlllIIllII[lIIIlllIIlllI[23]]))) ? 1 : 0)) {
            var5 = new d(lIIIlllIIlllI[16], lIIIlllIIlllI[11], lIIIlllIIlllI[17]);
            bA.add(var5);
            0;
        }
        ...
        if (s.lIlIIlIIIIIlllI(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var5 = new d(lIIIlllIIlllI[18], lIIIlllIIlllI[19], lIIIlllIIlllI[20]);
            bA.add(var5);
            0;
        }
    }
    ...
    private static String lIlIIlIIIIIIllI(String var15, String var13) {
        try {
            ...
            var8.init(lIIIlllIIlllI[4], var11);
