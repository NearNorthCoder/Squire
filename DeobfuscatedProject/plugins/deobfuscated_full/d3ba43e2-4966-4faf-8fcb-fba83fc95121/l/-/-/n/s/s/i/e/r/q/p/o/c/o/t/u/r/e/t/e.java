...
extends Enum<e> {
    ...
    private static void lIIllllllIIlIll() {
        ...
        e.lIIIlIIllllIl[e.lIIIlIIllllll[0]] = e."BRAWLER";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[1]] = e."Brawler";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[2]] = e."SPINNER";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[3]] = e."Spinner";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[4]] = e."PORTAL";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[5]] = e."Portal";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[6]] = e."DEFILER";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[7]] = e."Defiler";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[8]] = e."RAVAGER";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[9]] = e."Ravager";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[10]] = e."SHIFTER";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[11]] = e."Shifter";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[12]] = e."TORCHER";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[13]] = e."Torcher";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[14]] = e."SPLATTER";
        e.lIIIlIIllllIl[e.lIIIlIIllllll[15]] = e."Splatter";
    }
    ...
    private static String lIIllllllIIIlll(String var13, String var9) {
        try {
            SecretKeySpec var6 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var9.getBytes(StandardCharsets.UTF_8)), lIIIlIIllllll[8]), "DES");
            Cipher var18 = Cipher.getInstance("DES");
            var18.init(lIIIlIIllllll[2], var6);
    ...
    private static String lIIllllllIIIlII(String var5, String var10) {
        var5 = new String(Base64.getDecoder().decode(var5.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var3 = new StringBuilder();
        char[] var14 = var10.toCharArray();
        int var8 = lIIIlIIllllll[0];
        char[] var1 = var5.toCharArray();
        int var19 = var1.length;
        int var2 = lIIIlIIllllll[0];
        while (e.lIIlllllllllIIl(var2, var19)) {
            char var12 = var1[var2];
            var3.append((char)(var12 ^ var14[var8 % var14.length]));
            0;
            ++var8;
            ++var2;
            0;
    ...
    private static String lIIllllllIIIIll(String var15, String var16) {
        try {
            ...
            var4.init(lIIIlIIllllll[2], var17);
