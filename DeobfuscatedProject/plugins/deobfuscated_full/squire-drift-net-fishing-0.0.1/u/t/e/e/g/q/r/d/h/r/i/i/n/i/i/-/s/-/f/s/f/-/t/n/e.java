...
/* TASK: Enter instance -> EnterinstanceTask */
...
extends Task {
    ...
    private static String llIlIIlIlIllIl(String var19, String var20) {
        try {
            SecretKeySpec var3 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var20.getBytes(StandardCharsets.UTF_8)), lIlIIIIIIlIl[10]), "DES");
            Cipher var5 = Cipher.getInstance("DES");
            var5.init(lIlIIIIIIlIl[4], var3);
    ...
    private static String llIlIIlIlIllll(String var9, String var4) {
        try {
            ...
            var15.init(lIlIIIIIIlIl[4], var14);
    ...
    public boolean run() {
        ...
        if (e.llIlIIlIlllIIl(var16.w.isInInstancedRegion() ? 1 : 0)) {
            ...
            if (e.llIlIIlIlllIlI(var22) && e.llIlIIlIlllIll(var16.r.getWorldLocation().getX(), var22.getWorldLocation().getX())) {
                var22.interact(lIlIIIIIIIIl[lIlIIIIIIlIl[2]]);
                return lIlIIIIIIlIl[2];
            }
            Item var6 = Equipment.fromSlot((EquipmentInventorySlot)EquipmentInventorySlot.WEAPON);
            if (e.llIlIIlIlllIlI(var6) && (!e.llIlIIlIllllII(var6.getName().toLowerCase().contains(lIlIIIIIIIIl[lIlIIIIIIlIl[4]]) ? 1 : 0) || e.llIlIIlIlllIIl(var6.getName().toLowerCase().contains(lIlIIIIIIIIl[lIlIIIIIIlIl[5]]) ? 1 : 0))) {
                return lIlIIIIIIlIl[3];
            }
            ...
            if (e.llIlIIlIlllIlI(var6)) {
                var6.interact(lIlIIIIIIIIl[lIlIIIIIIlIl[7]]);
            }
            return lIlIIIIIIlIl[2];
        }
        if (!e.llIlIIlIlllIIl(Dialog.isViewingOptions() ? 1 : 0) || e.llIlIIlIllllII(Dialog.hasOption(string -> string.toLowerCase().contains(lIlIIIIIIIIl[lIlIIIIIIlIl[15]])) ? 1 : 0)) {
            ...
            TileObject var22 = TileObjects.getFirstAt((WorldPoint)var16.x, (String[])stringArray);
            if (e.llIlIIlIlllIlI(var22)) {
                var22.interact(lIlIIIIIIIIl[lIlIIIIIIlIl[9]]);
                return lIlIIIIIIlIl[2];
            }
            return lIlIIIIIIlIl[3];
        }
    ...
    private static String llIlIIlIlIlllI(String var7, String var21) {
        var7 = new String(Base64.getDecoder().decode(var7.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var2 = new StringBuilder();
        char[] var8 = var21.toCharArray();
        int var13 = lIlIIIIIIlIl[3];
        char[] var17 = var7.toCharArray();
        int var12 = var17.length;
        int var11 = lIlIIIIIIlIl[3];
        while (e.llIlIIlIllllIl(var11, var12)) {
            char var18 = var17[var11];
            var2.append((char)(var18 ^ var8[var13 % var8.length]));
            0;
            ++var13;
            ++var11;
            0;
