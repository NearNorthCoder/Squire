...
extends Task {
    ...
    private static void lIIlIlIIIIlIIII() {
        ...
        d.llllllIIlIlI[0] = 1;
        d.llllllIIlIlI[1] = (0x8F ^ 0xC6 ^ 2) & (119 + 99 - 201 + 214 ^ 66 + 44 - 42 + 104 ^ -1);
    ...
    private static String lIIlIlIIIIIllIl(String var3, String var11) {
        try {
            SecretKeySpec var4 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var11.getBytes(StandardCharsets.UTF_8)), llllllIIlIlI[7]), "DES");
            Cipher var7 = Cipher.getInstance("DES");
            var7.init(llllllIIlIlI[6], var4);
    ...
    private static void lIIlIlIIIIIllll() {
        ...
        d.llllllIIlIIl[d.llllllIIlIlI[1]] = d."We do not have enough food to go on, stopping plugin.";
        d.llllllIIlIIl[d.llllllIIlIlI[0]] = d."We do not have enough anti-poison to go on, stopping plugin.";
    }
    ...
    public boolean run() {
        ...
        if (d.lIIlIlIIIIlIIlI(var9.u.getVarbitValue(llllllIIlIlI[2]))) {
            return llllllIIlIlI[1];
        }
        ...
        if (d.lIIlIlIIIIlIIlI(Bank.isOpen() ? 1 : 0)) {
            if (d.lIIlIlIIIIlIIlI(var9.t.foodAmount())) {
                int[] nArray2 = new int[llllllIIlIlI[0]];
                nArray2[d.llllllIIlIlI[1]] = var9.t.foodID();
                if (d.lIIlIlIIIIlIlIl(Bank.getCount((boolean)llllllIIlIlI[0], (int[])nArray2), var9.t.foodAmount())) {
                    Log.info((String)llllllIIlIIl[llllllIIlIlI[1]]);
                    var9.r.forceStop();
                    return llllllIIlIlI[0];
                }
            }
            if (d.lIIlIlIIIIlIIlI(var9.t.antiAmount()) && d.lIIlIlIIIIlIlIl(Bank.getCount((boolean)llllllIIlIlI[0], item -> item.getName().startsWith(this.t.antiPoison())), var9.t.antiAmount())) {
        ...
        if (d.lIIlIlIIIIlIlII(Bank.open() ? 1 : 0)) {
            ...
            nArray3[d.llllllIIlIlI[1]] = var9.t.foodID();
            System.out.println("Walking to bank; Food in inventory: " + Inventory.getCount((int[])nArray3) + " amount wanted " + var9.t.minFoodAmount());
    ...
    private static String lIIlIlIIIIIlllI(String var1, String var6) {
        try {
