...
extends OverlayPanel {
    ...
    private static void llIIlIlllll() {
        ...
        EctoOverlay.lllIllIlI[1] = 1;
        EctoOverlay.lllIllIlI[2] = 2;
        EctoOverlay.lllIllIlI[3] = 3;
    ...
    private static void llIIlIllllI() {
        ...
        EctoOverlay.lllIllIIl[EctoOverlay.lllIllIlI[0]] = EctoOverlay."Squire Ectofuntus";
        EctoOverlay.lllIllIIl[EctoOverlay.lllIllIlI[1]] = EctoOverlay."Runtime: ";
        EctoOverlay.lllIllIIl[EctoOverlay.lllIllIlI[2]] = EctoOverlay."Current Task: ";
        EctoOverlay.lllIllIIl[EctoOverlay.lllIllIlI[3]] = EctoOverlay."Banking: ";
        EctoOverlay.lllIllIIl[EctoOverlay.lllIllIlI[4]] = EctoOverlay."Yes";
        EctoOverlay.lllIllIIl[EctoOverlay.lllIllIlI[5]] = EctoOverlay."No";
        EctoOverlay.lllIllIIl[EctoOverlay.lllIllIlI[6]] = EctoOverlay."Prayed Bones: ";
        EctoOverlay.lllIllIIl[EctoOverlay.lllIllIlI[7]] = EctoOverlay."Ground Bones: ";
        EctoOverlay.lllIllIIl[EctoOverlay.lllIllIlI[8]] = EctoOverlay."Slime Collected: ";
    }
