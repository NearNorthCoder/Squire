...
extends SquirePlugin {
    ...
    private static void lIlllllIll() {
        ...
        MahoganyTables.llIlIlIl[MahoganyTables.llIlIllI[1]] = MahoganyTables."Talk-to";
        MahoganyTables.llIlIlIl[MahoganyTables.llIlIllI[0]] = MahoganyTables."Talk-to";
        MahoganyTables.llIlIlIl[MahoganyTables.llIlIllI[5]] = MahoganyTables."Build";
        MahoganyTables.llIlIlIl[MahoganyTables.llIlIllI[6]] = MahoganyTables."Yes";
        MahoganyTables.llIlIlIl[MahoganyTables.llIlIllI[4]] = MahoganyTables."Remove";
    }
