...
extends Overlay {
    ...
    public Dimension render(Graphics2D graphics2D) {
        ...
        if (a.lIIlIlllIlIIllI(list.isEmpty() ? 1 : 0)) {
            void var6;
            int var15 = lIIIIIIlIIIlI[1];
            while (a.lIIlIlllIlIIlll(var15, var6.size())) {
                void var11;
                Color lllllllllllllllIIIllllIIllIlIIll = new Color(lIIIIIIlIIIlI[7], lIIIIIIlIIIlI[1], lIIIIIIlIIIlI[1], lIIIIIIlIIIlI[8]);
                Polygon var12 = Perspective.getCanvasTilePoly((Client)Static.getClient(), (LocalPoint)((NPC)var6.get(var15)).getLocalLocation());
                if (a.lIIlIlllIlIlIII(var12)) {
                    System.out.println(lIIIIIIlIIIIl[lIIIIIIlIIIlI[1]]);
                    return null;
                }
                OverlayUtil.renderPolygon((Graphics2D)var11, (Shape)var12, (Color)Color.GREEN, (Stroke)new BasicStroke(1.0f));
                ++var15;
                0;
                if (-3 <= 0) continue;
                return null;
    ...
    private static String lIIlIlllIlIIIll(String var10, String var14) {
        try {
            ...
            var1.init(lIIIIIIlIIIlI[5], var13);
        ...
        block9: {
            block10: {
                ...
                block8: {
                    ...
                    if (a.lIIlIlllIlIIllI(var2 instanceof a)) {
                        return lIIIIIIlIIIlI[1];
                    }
                    a var3 = (a)var2;
                    if (a.lIIlIlllIlIIllI(var3.a((Object)var9) ? 1 : 0)) {
                        return lIIIIIIlIIIlI[1];
                    }
                    var8 = var9.a();
                    var7 = var3.a();
                    if (!a.lIIlIlllIlIlIII((Object)var8)) break block8;
                    if (!a.lIIlIlllIlIlIlI((Object)var7)) break block9;
                    0;
                ...
                if (!a.lIIlIlllIlIIllI(((Object)((Object)var8)).equals((Object)var7) ? 1 : 0)) break block9;
            }
            return lIIIIIIlIIIlI[1];
        }
        return lIIIIIIlIIIlI[3];
    ...
    private static void lIIlIlllIlIIlII() {
        ...
        a.lIIIIIIlIIIIl[a.lIIIIIIlIIIlI[1]] = a."poly is null";
    }

    private static void lIIlIlllIlIIlIl() {
        lIIIIIIlIIIlI = new int[11];
        a.lIIIIIIlIIIlI[0] = 3;
        a.lIIIIIIlIIIlI[1] = (0x63 ^ 0x33 ^ (0x3B ^ 0x7C)) & (7 ^ 0x16 ^ (0xAF ^ 0xA9) ^ -1);
