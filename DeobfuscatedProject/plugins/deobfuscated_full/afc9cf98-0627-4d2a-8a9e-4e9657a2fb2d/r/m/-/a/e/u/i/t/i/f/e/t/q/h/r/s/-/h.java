...
extends Enum<h> {
    ...
    private static String lIllIllIlIlIlll(String var5, String var7) {
        var5 = new String(Base64.getDecoder().decode(var5.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var1 = new StringBuilder();
        char[] var2 = var7.toCharArray();
        int var3 = lIlIIIIIIllIl[0];
        char[] var4 = var5.toCharArray();
        int var9 = var4.length;
        int var6 = lIlIIIIIIllIl[0];
        while (h.lIllIllIlIllIlI(var6, var9)) {
            char var8 = var4[var6];
            var1.append((char)(var8 ^ var2[var3 % var2.length]));
            0;
            ++var3;
            ++var6;
            0;
