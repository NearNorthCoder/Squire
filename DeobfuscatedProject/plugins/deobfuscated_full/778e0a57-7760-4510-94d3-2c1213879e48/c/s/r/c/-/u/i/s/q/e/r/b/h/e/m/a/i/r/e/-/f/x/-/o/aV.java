...
/* TASK: Scavangers (Prep) -> Scavangers(Prep)Task */
...
extends U {
    ...
    public boolean cg() {
        ...
        if (aV.llIllIIIllIlIl(Inventory.getCount((boolean)lIlIIlIIllIl[1], (int[])nArray), lIlIIlIIllIl[4])) {
            ...
            if (aV.llIllIIIllIlIl(Inventory.getCount((boolean)lIlIIlIIllIl[1], (int[])nArray2), lIlIIlIIllIl[6])) {
                if (aV.llIllIIIllIlII(Reachable.isWalkable((WorldPoint)var5.ak.bt) ? 1 : 0)) {
                    Movement.setDestination((WorldPoint)var5.al.bs);
                    return lIlIIlIIllIl[1];
                }
                if (aV.llIllIIIllIlII(Reachable.isWalkable((WorldPoint)var5.ak.bs) ? 1 : 0)) {
                    Movement.setDestination((WorldPoint)var5.ak.bt);
        ...
        if (aV.llIllIIIllIllI(var6)) {
            if (aV.llIllIIIllIlII(var5.bS.isMoving() ? 1 : 0)) {
                return lIlIIlIIllIl[2];
            }
            var6.interact(lIlIIlIIllII[lIlIIlIIllIl[1]]);
            return lIlIIlIIllIl[1];
        }
        String[] stringArray = new String[lIlIIlIIllIl[1]];
        stringArray[aV.lIlIIlIIllIl[2]] = lIlIIlIIllII[lIlIIlIIllIl[7]];
        NPC var21 = NPCs.getNearest((String[])stringArray);
        if (aV.llIllIIIllIlll(var21)) {
            WorldPoint var23 = var5.ak.br.getCenter();
            if (aV.llIllIIIlllIII(var23.distanceTo((Locatable)var5.bS), lIlIIlIIllIl[8])) {
                return lIlIIlIIllIl[2];
            }
        ...
        if (aV.llIllIIIllIllI(var5.bS.getInteracting()) && aV.llIllIIIllIlII(var5.bS.getInteracting().getName().contains(lIlIIlIIllII[lIlIIlIIllIl[6]]) ? 1 : 0)) {
            return lIlIIlIIllIl[2];
        }
    ...
    private static String llIllIIIllIIII(String var26, String var13) {
        try {
            ...
            var24.init(lIlIIlIIllIl[7], var2);
    ...
    public boolean ch() {
        ...
        var4.am = var4.co.N();
        var4.al = var4.co.M();
        if (aV.llIllIIIlllIlI((Object)var4.ak.bw, (Object)N.SCAVENGERS)) {
            bl2 = lIlIIlIIllIl[1];
            0;
    ...
    private static String llIllIIIllIIIl(String var3, String var12) {
        ...
        int var11 = lIlIIlIIllIl[2];
        char[] var18 = var3.toCharArray();
        int var9 = var18.length;
        int var14 = lIlIIlIIllIl[2];
        while (aV.llIllIIIlllIII(var14, var9)) {
            char var19 = var18[var14];
            var1.append((char)(var19 ^ var22[var11 % var22.length]));
            0;
            ++var11;
            ++var14;
            0;
    ...
    public List<Prayer> ci() {
        ...
        if (aV.llIllIIIlllIII(var20.bS.distanceTo((Locatable)var8), lIlIIlIIllIl[10])) {
    ...
    private static String llIllIIIlIllll(String var16, String var10) {
        try {
            SecretKeySpec var25 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var10.getBytes(StandardCharsets.UTF_8)), lIlIIlIIllIl[13]), "DES");
            Cipher var7 = Cipher.getInstance("DES");
            var7.init(lIlIIlIIllIl[7], var25);
