...
extends Enum<N> {
    ...
    private static String llIllIllllllll(String var12, String var8) {
        try {
            SecretKeySpec var17 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var8.getBytes(StandardCharsets.UTF_8)), lIlIlIIIlIII[9]), "DES");
            Cipher var11 = Cipher.getInstance("DES");
            var11.init(lIlIlIIIlIII[3], var17);
    ...
    private static String llIllIllllllIl(String var10, String var14) {
        try {
            ...
            var18.init(lIlIlIIIlIII[3], var16);
    ...
    private static String llIllIlllllllI(String var15, String var6) {
        ...
        int var13 = lIlIlIIIlIII[1];
        char[] var5 = var15.toCharArray();
        int var7 = var5.length;
        int var2 = lIlIlIIIlIII[1];
        while (N.llIlllIIIIIIlI(var2, var7)) {
            char var1 = var5[var2];
            var19.append((char)(var1 ^ var3[var13 % var3.length]));
            0;
            ++var13;
            ++var2;
            0;
