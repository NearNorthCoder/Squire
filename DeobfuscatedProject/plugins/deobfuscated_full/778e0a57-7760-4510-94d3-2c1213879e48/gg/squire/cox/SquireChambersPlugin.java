...
extends SquirePlugin {
    ...
    private void t() {
        ...
        var41 = var65.aa.c();
        c.s.r.c.-.u.i.s.q.e.r.b.h.e.m.a.i.r.e.-.f.x.-.o.R.b(var41);
        0;
        var65.aa.a((N[])var41);
    ...
    private void a(ChatMessage chatMessage, String string) {
        ...
        String var4 = Joiner.on((String)lIlIIIIIllll[lIlIIIIlIIII[19]]).join(Arrays.stream(var27).map(layoutRoom -> c.s.r.c.-.u.i.s.q.e.r.b.h.e.m.a.i.r.e.-.f.x.-.o.N.valueOf(layoutRoom.name())).filter(n2 -> {
            boolean bl2;
