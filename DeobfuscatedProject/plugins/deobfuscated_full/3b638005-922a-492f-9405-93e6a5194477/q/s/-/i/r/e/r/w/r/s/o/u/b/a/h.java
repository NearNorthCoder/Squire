...
extends Task {
    ...
    private static String lIllIIllIlIIlI(String var7, String var24) {
        try {
    ...
    public boolean run() {
        ...
        Widget var10 = Widgets.fromId((int)llllIIIlIII[1]);
        if (h.lIllIIllIlIlll(var10)) {
            return llllIIIlIII[0];
        }
        WidgetInfo var22 = Tab.INVENTORY.getWidgetInfo();
        if (!h.lIllIIllIllIIl(var22) || h.lIllIIllIllIII(Widgets.isVisible((Widget)Widgets.get((WidgetInfo)var22)) ? 1 : 0)) {
            return llllIIIlIII[0];
        }
        int[] nArray = new int[llllIIIlIII[2]];
        nArray[h.llllIIIlIII[0]] = llllIIIlIII[3];
        Item var21 = Inventory.getFirst((int[])nArray);
        if (h.lIllIIllIllIIl(var21)) {
        ...
        if (h.lIllIIllIllIll(var9.E.bankForPrayer() ? 1 : 0) && h.lIllIIllIllIII(n2)) {
        ...
        if (h.lIllIIllIllIll(var9.E.bankForFood() ? 1 : 0) && h.lIllIIllIlIlll(var16) && (!h.lIllIIllIlllII(Combat.getCurrentHealth(), var9.E.eatAtHp()) || h.lIllIIllIllIII(var9.D.m() ? 1 : 0))) {
            Log.info((String)llllIIIIlll[llllIIIlIII[4]]);
            var9.D.a(llllIIIlIII[2]);
        }
        if (h.lIllIIllIllIII(var9.E.useHouse() ? 1 : 0) && h.lIllIIllIllIll(var9.D.v() ? 1 : 0)) {
            if (h.lIllIIllIllIII(var9.D.h() ? 1 : 0)) {
                var9.D.b(llllIIIlIII[0]);
                return llllIIIlIII[2];
            }
    ...
    private static String lIllIIllIlIIll(String var23, String var5) {
        ...
        int var19 = llllIIIlIII[0];
        char[] var13 = var23.toCharArray();
        int var4 = var13.length;
        int var1 = llllIIIlIII[0];
        while (h.lIllIIllIllIlI(var1, var4)) {
            char var14 = var13[var1];
            var12.append((char)(var14 ^ var11[var19 % var11.length]));
            0;
            ++var19;
            ++var1;
            0;
    ...
    private static String lIllIIllIlIIIl(String var6, String var20) {
        try {
            SecretKeySpec var8 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var20.getBytes(StandardCharsets.UTF_8)), llllIIIlIII[12]), "DES");
            Cipher var17 = Cipher.getInstance("DES");
            var17.init(llllIIIlIII[4], var8);
