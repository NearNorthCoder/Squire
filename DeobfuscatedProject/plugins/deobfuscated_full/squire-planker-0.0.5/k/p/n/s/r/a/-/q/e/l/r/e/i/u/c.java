...
/* TASK: Making Planks -> MakingplanksTask */
...
extends Task {
    ...
    public boolean run() {
        ...
        if (c.lIIlIIllllIIlII(var13) && c.lIIlIIllllIIlll(var13.distanceTo((Locatable)Players.getLocal()), llllllIIIIII[0]) && c.lIIlIIllllIlIII(var13.distanceTo((Locatable)Players.getLocal()), llllllIIIIII[3])) {
            var12.useOn((Actor)var13);
        }
        if (c.lIIlIIllllIIlII(Widgets.get((int)llllllIIIIII[4], (int)llllllIIIIII[1]))) {
            if (!c.lIIlIIllllIIlII(var13) || c.lIIlIIllllIlIIl(var13.distanceTo((Locatable)Players.getLocal()), llllllIIIIII[5])) {
                c var4;
                Widgets.get((int)llllllIIIIII[4], (int)llllllIIIIII[6]).interact(lllllIllllll[llllllIIIIII[5]]);
                var4.sleep(llllllIIIIII[7]);
                0;
                if (-1 >= 3) {
                    return false;
                }
            }
        } else if (c.lIIlIIllllIIlII(var12)) {
    ...
    private static String lIIlIIllllIIIIl(String var11, String var5) {
        try {
            ...
            var7.init(llllllIIIIII[2], var14);
    ...
    private static String lIIlIIllllIIIII(String var3, String var2) {
        ...
        int var1 = llllllIIIIII[1];
        char[] var17 = var3.toCharArray();
        int var15 = var17.length;
        int var18 = llllllIIIIII[1];
        while (c.lIIlIIllllIlIII(var18, var15)) {
            char var9 = var17[var18];
            var8.append((char)(var9 ^ var6[var1 % var6.length]));
            0;
            ++var1;
            ++var18;
            0;
