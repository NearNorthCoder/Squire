...
extends OverlayPanel {
    ...
    private static String lllllllIIIlI(String var19, String var2) {
        ...
        int var14 = lIIlIlIllI[1];
        char[] var5 = var19.toCharArray();
        int var16 = var5.length;
        int var15 = lIIlIlIllI[1];
        while (BuilderInfoBox.lllllllIIlIl(var15, var16)) {
            char var4 = var5[var15];
            var9.append((char)(var4 ^ var10[var14 % var10.length]));
            0;
            ++var14;
            ++var15;
            0;
    ...
    private static String lllllllIIIII(String var1, String var11) {
        try {
            SecretKeySpec var17 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var11.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var18 = Cipher.getInstance("Blowfish");
            var18.init(lIIlIlIllI[3], var17);
    ...
    private static String lllllllIIIIl(String var6, String var13) {
        try {
            SecretKeySpec var7 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var13.getBytes(StandardCharsets.UTF_8)), lIIlIlIllI[10]), "DES");
            Cipher var8 = Cipher.getInstance("DES");
            var8.init(lIIlIlIllI[3], var7);
