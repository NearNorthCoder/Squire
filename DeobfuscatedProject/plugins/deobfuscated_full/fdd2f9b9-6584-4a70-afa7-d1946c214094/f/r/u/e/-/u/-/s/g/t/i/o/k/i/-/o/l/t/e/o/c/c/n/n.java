...
implements G {
    ...
    public static void aw() {
        ...
        if (n.lIIIIIllllIlI((int)var29, lIIlllIIIl[3])) {
            bP = bG;
            bF = bH;
        }
        if (n.lIIIIIllllIlI((int)var29, lIIlllIIIl[10])) {
            bP = bI;
            bF = bJ;
        }
        if (n.lIIIIIllllIlI((int)var29, lIIlllIIIl[12])) {
            bP = bK;
            bF = bL;
        }
        if (n.lIIIIIllllIlI((int)var29, lIIlllIIIl[13])) {
            bP = bM;
            bF = bN;
        }
    }
    ...
    private static String lIIIIIllIlIIl(String var24, String var4) {
        ...
        int var15 = lIIlllIIIl[1];
        char[] var9 = var24.toCharArray();
        int var6 = var9.length;
        int var16 = lIIlllIIIl[1];
        while (n.lIIIIIllIlllI(var16, var6)) {
            char var1 = var9[var16];
            var7.append((char)(var1 ^ var21[var15 % var21.length]));
            0;
            ++var15;
            ++var16;
            0;
    ...
    private static String lIIIIIllIlIll(String var10, String var17) {
        try {
            SecretKeySpec var20 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var17.getBytes(StandardCharsets.UTF_8)), lIIlllIIIl[16]), "DES");
            Cipher var26 = Cipher.getInstance("DES");
            var26.init(lIIlllIIIl[3], var20);
            return new String(var26.doFinal(Base64.getDecoder().decode(var10.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void as() {
        ...
        if (n.lIIIIIllIllll(Inventory.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (n.lIIIIIlllIIII(var8) && n.lIIIIIllIllll(var8.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                AccBuilderRogues.c = lIIlllIIII[lIIlllIIIl[0]];
                a.a(var8);
            }
            if (n.lIIIIIlllIIII(var8) && n.lIIIIIlllIIIl(var8.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    public static void at() {
        ...
        if (n.lIIIIIlllIlIl(n.lIIIIIlllIIll(e.a(bQ), lIIlllIIIl[9] + bV))) {
            if (n.lIIIIIllIllll(Players.getLocal().getWorldLocation().equals((Object)bP) ? 1 : 0)) {
                ...
                if (n.lIIIIIllIllll(bS.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (n.lIIIIIlllIlll(Players.getLocal().getWorldLocation().distanceTo(bO), lIIlllIIIl[10])) {
                        ...
                        var19 = NPCs.getNearest((String[])stringArray);
                        if (n.lIIIIIlllIIII(var19)) {
                            String[] stringArray2 = new String[lIIlllIIIl[0]];
                            stringArray2[n.lIIlllIIIl[1]] = lIIlllIIII[lIIlllIIIl[16]];
                            if (n.lIIIIIlllIIIl(var19.hasAction(stringArray2) ? 1 : 0)) {
                                var19.interact(lIIlllIIII[lIIlllIIIl[17]]);
                            ...
                            if (n.lIIIIIllIllll(var19.hasAction(stringArray3) ? 1 : 0)) {
            ...
            if (n.lIIIIIlllIIIl(Players.getLocal().getWorldLocation().equals((Object)bP) ? 1 : 0)) {
                ...
                if (n.lIIIIIlllIIIl(n.av() ? 1 : 0)) {
                    var19 = new WorldArea(bP, lIIlllIIIl[3], lIIlllIIIl[3]);
                    var18 = n.au();
                    AccBuilderRogues.c = lIIlllIIII[lIIlllIIIl[21]];
                    if (n.lIIIIIllllIII(Players.getLocal().getInteracting()) && n.lIIIIIlllIIII(var18) && n.lIIIIIllIllll(var18.isDead() ? 1 : 0)) {
                        System.out.println(lIIlllIIII[lIIlllIIIl[22]]);
                        var18.interact(lIIlllIIII[lIIlllIIIl[23]]);
        ...
        if (n.lIIIIIllllIIl(n.lIIIIIlllIIll(e.a(bQ), lIIlllIIIl[9] + bV))) {
            var19 = new WorldArea(lIIlllIIIl[24], lIIlllIIIl[25], lIIlllIIIl[26], lIIlllIIIl[27], lIIlllIIIl[1]);
            var18 = new WorldPoint(lIIlllIIIl[28], lIIlllIIIl[29], lIIlllIIIl[1]);
            if (n.lIIIIIlllIIIl(var19.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && n.lIIIIIlllIllI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var18), lIIlllIIIl[13])) {
    ...
    public static boolean av() {
        ...
        if (n.lIIIIIllIllll(list.isEmpty() ? 1 : 0) && n.lIIIIIlllIllI(list.size(), lIIlllIIIl[0])) {
            void var27;
            int var22 = lIIlllIIIl[1];
            while (n.lIIIIIllIlllI(var22, var27.size())) {
                void var11;
                if (n.lIIIIIlllIIIl(((Player)var27.get(var22)).equals(Players.getLocal()) ? 1 : 0)) {
                    0;
                    if ((0xC4 ^ 0xA5 ^ (0x7E ^ 0x1A)) == 0) {
                        return ((0x4C ^ 0x62 ^ (0xFC ^ 0xB1)) & (0xC4 ^ 0xB5 ^ (0x79 ^ 0x6B) ^ -1)) != 0;
                    }
                } else if (n.lIIIIIlllIIIl(var11.contains(((Player)var27.get(var22)).getWorldLocation()) ? 1 : 0)) {
                    return lIIlllIIIl[0];
                }
                ++var22;
                0;
    ...
    private static String lIIIIIllIlIlI(String var14, String var2) {
        try {
            ...
            var28.init(lIIlllIIIl[3], var25);
            return new String(var28.doFinal(Base64.getDecoder().decode(var14.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    static NPC au() {
        ...
        if (n.lIIIIIlllIIII(list)) {
            ...
            int var13 = lIIlllIIIl[1];
            while (n.lIIIIIllIlllI(var13, var3.size())) {
                void var23;
                if (n.lIIIIIlllIIIl(var23.contains(((NPC)var3.get(var13)).getWorldLocation()) ? 1 : 0)) {
                    return (NPC)var3.get(var13);
                }
                ++var13;
                0;
