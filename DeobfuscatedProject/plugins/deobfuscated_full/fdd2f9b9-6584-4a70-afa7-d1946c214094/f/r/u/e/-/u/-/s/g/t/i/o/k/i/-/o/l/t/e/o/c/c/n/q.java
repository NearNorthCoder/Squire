...
implements G {
    ...
    private static String lllllIlllllI(String var15, String var12) {
        try {
    ...
    public boolean V() {
        ...
        if (q.llllllIlllII(Vars.getBit((int)QuestVarbits.QUEST_A_PORCINE_OF_INTEREST.getId()), lIIlIlIIlI[57])) {
            bl = lIIlIlIIlI[0];
            0;
            if ((137 + 102 - 90 + 6 ^ 133 + 102 - 186 + 110) < 3) {
                return ((0x50 ^ 0x6E ^ (0x67 ^ 0xA)) & (0x7C ^ 0x1B ^ (3 ^ 0x37) ^ -1)) != 0;
            }
        } else {
            bl = lIIlIlIIlI[1];
        }
            ...
            block64: {
                block65: {
                    ...
                    if (q.llllllIlIIll(q.ab() ? 1 : 0) && q.llllllIlIIll(Vars.getBit((int)QuestVarbits.QUEST_A_PORCINE_OF_INTEREST.getId()))) {
                        ...
                        if (q.llllllIlIlII(var8) && q.llllllIlIIll(var8.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            AccBuilderRogues.c = lIIlIlIIIl[lIIlIlIIlI[0]];
                            a.a(var8);
                        }
                        if (q.llllllIlIlII(var8) && q.llllllIlIIIl(var8.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String lllllIllllII(String var14, String var5) {
        try {
            SecretKeySpec var22 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var5.getBytes(StandardCharsets.UTF_8)), lIIlIlIIlI[16]), "DES");
            Cipher var10 = Cipher.getInstance("DES");
            var10.init(lIIlIlIIlI[3], var22);
    ...
    private static void lllllIllllll() {
        ...
        q.lIIlIlIIIl[q.lIIlIlIIlI[1]] = q."Finished buying items, switching back to quest";
        q.lIIlIlIIIl[q.lIIlIlIIlI[0]] = q."Nav to bank";
        q.lIIlIlIIIl[q.lIIlIlIIlI[3]] = q."Handling banking";
        q.lIIlIlIIIl[q.lIIlIlIIlI[9]] = q."We are missing quest supplies, switching to BUYING";
        q.lIIlIlIIIl[q.lIIlIlIIlI[4]] = q."Drink";
        q.lIIlIlIIIl[q.lIIlIlIIlI[12]] = q."Wear";
        q.lIIlIlIIIl[q.lIIlIlIIlI[5]] = q."Nav to start";
        q.lIIlIlIIIl[q.lIIlIlIIlI[18]] = q."Starting quest";
        q.lIIlIlIIIl[q.lIIlIlIIlI[16]] = q."Notice board";
        q.lIIlIlIIIl[q.lIIlIlIIlI[19]] = q."Check";
        q.lIIlIlIIIl[q.lIIlIlIIlI[14]] = q."Nav to sarah";
        q.lIIlIlIIIl[q.lIIlIlIIlI[22]] = q."Stuck, clicking out";
        q.lIIlIlIIIl[q.lIIlIlIIlI[25]] = q."Talking sarah";
        q.lIIlIlIIIl[q.lIIlIlIIlI[26]] = q."Sarah";
        q.lIIlIlIIIl[q.lIIlIlIIlI[27]] = q."Nav to hole";
        q.lIIlIlIIIl[q.lIIlIlIIlI[28]] = q."Strange hole";
        q.lIIlIlIIIl[q.lIIlIlIIlI[29]] = q."Wield";
        q.lIIlIlIIIl[q.lIIlIlIIlI[30]] = q."Strange hole";
        q.lIIlIlIIIl[q.lIIlIlIIlI[31]] = q."Climb-down";
        q.lIIlIlIIIl[q.lIIlIlIIlI[35]] = q."Skeleton";
        q.lIIlIlIIIl[q.lIIlIlIIlI[36]] = q."Skeleton";
        q.lIIlIlIIIl[q.lIIlIlIIlI[38]] = q."Blockage";
        q.lIIlIlIIIl[q.lIIlIlIIlI[39]] = q."Pig Thing";
        q.lIIlIlIIIl[q.lIIlIlIIlI[40]] = q."Climb over blockage";
        q.lIIlIlIIIl[q.lIIlIlIIlI[41]] = q."Blockage";
        q.lIIlIlIIIl[q.lIIlIlIIlI[42]] = q."Climb-over";
        q.lIIlIlIIIl[q.lIIlIlIIlI[43]] = q."Pig Thing";
        q.lIIlIlIIIl[q.lIIlIlIIlI[44]] = q."Interact skele";
        q.lIIlIlIIIl[q.lIIlIlIIlI[45]] = q."Skeleton";
        q.lIIlIlIIIl[q.lIIlIlIIlI[46]] = q."Investigate";
        q.lIIlIlIIIl[q.lIIlIlIIlI[47]] = q."Interacting Spira";
        q.lIIlIlIIIl[q.lIIlIlIIlI[48]] = q."Spria";
        q.lIIlIlIIIl[q.lIIlIlIIlI[49]] = q."Sourhog";
        q.lIIlIlIIIl[q.lIIlIlIIlI[50]] = q."Reinforced goggles";
        q.lIIlIlIIIl[q.lIIlIlIIlI[51]] = q."Reinforced goggles";
        q.lIIlIlIIIl[q.lIIlIlIIlI[52]] = q."Reinforced goggles";
        q.lIIlIlIIIl[q.lIIlIlIIlI[53]] = q."Wear";
        q.lIIlIlIIIl[q.lIIlIlIIlI[54]] = q."Nav to hole";
        q.lIIlIlIIIl[q.lIIlIlIIlI[55]] = q."Climb down hole";
        q.lIIlIlIIIl[q.lIIlIlIIlI[56]] = q."Strange hole";
        q.lIIlIlIIIl[q.lIIlIlIIlI[57]] = q."Strange hole";
        q.lIIlIlIIIl[q.lIIlIlIIlI[58]] = q."Climb-down";
        q.lIIlIlIIIl[q.lIIlIlIIlI[59]] = q."Blockage";
        q.lIIlIlIIIl[q.lIIlIlIIlI[60]] = q."Climb over blockage";
        q.lIIlIlIIIl[q.lIIlIlIIlI[61]] = q."Blockage";
        q.lIIlIlIIIl[q.lIIlIlIIlI[62]] = q."Climb-over";
        q.lIIlIlIIIl[q.lIIlIlIIlI[63]] = q."Reinforced goggles";
        q.lIIlIlIIIl[q.lIIlIlIIlI[64]] = q."Reinforced goggles";
        q.lIIlIlIIIl[q.lIIlIlIIlI[65]] = q."Reinforced goggles";
        q.lIIlIlIIIl[q.lIIlIlIIlI[66]] = q."Wear";
        q.lIIlIlIIIl[q.lIIlIlIIlI[34]] = q."Wield";
        q.lIIlIlIIIl[q.lIIlIlIIlI[67]] = q."Sourhog";
        q.lIIlIlIIIl[q.lIIlIlIIlI[68]] = q."Attack";
        q.lIIlIlIIIl[q.lIIlIlIIlI[69]] = q."Eat";
        q.lIIlIlIIIl[q.lIIlIlIIlI[70]] = q."Sourhog foot";
        q.lIIlIlIIIl[q.lIIlIlIIlI[71]] = q."Cutting foot";
        q.lIIlIlIIIl[q.lIIlIlIIlI[72]] = q."Dead sourhog";
        q.lIIlIlIIIl[q.lIIlIlIIlI[73]] = q."Cut-foot";
        q.lIIlIlIIIl[q.lIIlIlIIlI[74]] = q."Sourhog foot";
        q.lIIlIlIIIl[q.lIIlIlIIlI[75]] = q."Nav to sarah";
        q.lIIlIlIIIl[q.lIIlIlIIlI[76]] = q."Stuck, clicking out";
        q.lIIlIlIIIl[q.lIIlIlIIlI[77]] = q."Talking sarah";
        q.lIIlIlIIIl[q.lIIlIlIIlI[78]] = q."Sarah";
        q.lIIlIlIIIl[q.lIIlIlIIlI[79]] = q."Nav to Spria";
        q.lIIlIlIIIl[q.lIIlIlIIlI[80]] = q."Talking spria";
        q.lIIlIlIIIl[q.lIIlIlIIlI[17]] = q."Spria";
        q.lIIlIlIIIl[q.lIIlIlIIlI[86]] = q."A porceline of interest";
        q.lIIlIlIIIl[q.lIIlIlIIlI[87]] = q."ring of wealth (";
        q.lIIlIlIIIl[q.lIIlIlIIlI[96]] = q."Yes.";
        q.lIIlIlIIIl[q.lIIlIlIIlI[97]] = q."Talk about the bounty.";
        q.lIIlIlIIIl[q.lIIlIlIIlI[98]] = q."I think that'll be all for now.";
        q.lIIlIlIIIl[q.lIIlIlIIlI[99]] = q."Yes";
    }
    ...
    private static String lllllIllllIl(String var9, String var4) {
        ...
        int var16 = lIIlIlIIlI[1];
        char[] var3 = var9.toCharArray();
        int var2 = var3.length;
        int var17 = lIIlIlIIlI[1];
        while (q.llllllIlIIlI(var17, var2)) {
            char var7 = var3[var17];
            var11.append((char)(var7 ^ var1[var16 % var1.length]));
            0;
            ++var16;
            ++var17;
            0;
    ...
    private static void af() {
        ...
        block10: {
            block9: {
                ...
                if (q.llllllIlIIll(Bank.contains((int[])nArray2) ? 1 : 0)) {
                    var20 = new d(lIIlIlIIlI[10], lIIlIlIIlI[0], lIIlIlIIlI[81]);
                    bv.add((d)var20);
                    0;
                }
                int[] nArray3 = new int[lIIlIlIIlI[0]];
                ...
                if (q.llllllIlIIll(Bank.contains((int[])nArray3) ? 1 : 0)) {
                    var20 = new d(lIIlIlIIlI[13], lIIlIlIIlI[50], lIIlIlIIlI[82]);
                    bv.add((d)var20);
                    0;
                }
                int[] nArray4 = new int[lIIlIlIIlI[0]];
                ...
                if (q.llllllIlIIll(Bank.contains((int[])nArray4) ? 1 : 0)) {
                    var20 = new d(lIIlIlIIlI[11], lIIlIlIIlI[12], i.bq);
                    bv.add((d)var20);
                    0;
                }
                if (q.llllllIlIIll(Bank.contains((Predicate)(var20 = item -> item.getName().toLowerCase().contains(lIIlIlIIIl[lIIlIlIIlI[87]]))) ? 1 : 0)) {
                    var19 = new d(lIIlIlIIlI[83], lIIlIlIIlI[12], lIIlIlIIlI[84]);
                    bv.add(var19);
                    0;
                }
                int[] nArray5 = new int[lIIlIlIIlI[0]];
            ...
            var19 = new d(lIIlIlIIlI[7], lIIlIlIIlI[28], lIIlIlIIlI[82]);
            bv.add(var19);
            0;
        }
        int[] nArray = new int[lIIlIlIIlI[0]];
        nArray[q.lIIlIlIIlI[1]] = lIIlIlIIlI[6];
        if (q.llllllIlIIll(Bank.contains((int[])nArray) ? 1 : 0)) {
            var19 = new d(lIIlIlIIlI[6], lIIlIlIIlI[57], lIIlIlIIlI[82]);
            bv.add(var19);
            0;
        }
    }
    ...
    public int T() {
        ...
        if (((0xD2 ^ 0x8D ^ 1) & (0x70 ^ 0x57 ^ (0x35 ^ 0x4C) ^ -1)) <= -1) {
            return (49 + 120 - 69 + 53 ^ 2 + 145 - 81 + 90) & (0x7F ^ 0x3E ^ (0xD8 ^ 0x9C) ^ -1);
        }
