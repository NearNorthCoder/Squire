...
/* TASK: Teleporting to Zul-andra -> TeleportToZulAndraTask */
...
extends Task {
    ...
    public boolean run() {
        ...
        if (ao.llIIlIIIIIlIIlI((Object)var5.aN.transport(), (Object)q.ZUL_ANDRA_TELEPORT)) {
            return lIllIlIlIllIl[0];
        }
        if (ao.llIIlIIIIIlIIll(var5.ab.h(lIllIlIlIllIl[1]) ? 1 : 0)) {
            return lIllIlIlIllIl[0];
        }
        int[] nArray = new int[lIllIlIlIllIl[2]];
        nArray[ao.lIllIlIlIllIl[0]] = lIllIlIlIllIl[3];
        Item var3 = Inventory.getFirst((int[])nArray);
        if (ao.llIIlIIIIIlIlII(var3)) {
            return lIllIlIlIllIl[0];
        }
    ...
    private static String llIIlIIIIIIllIl(String var2, String var7) {
        try {
            SecretKeySpec var1 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var7.getBytes(StandardCharsets.UTF_8)), lIllIlIlIllIl[4]), "DES");
            Cipher var4 = Cipher.getInstance("DES");
            var4.init(lIllIlIlIllIl[5], var1);
