...
extends Task {
    ...
    private static String llIIlIIIlIllIII(String var3, String var4) {
        try {
            SecretKeySpec var2 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var4.getBytes(StandardCharsets.UTF_8)), lIllIllIIIlIl[2]), "DES");
            Cipher var5 = Cipher.getInstance("DES");
            var5.init(lIllIllIIIlIl[3], var2);
    ...
    private static void llIIlIIIlIllIIl() {
        ...
        B.lIllIllIIIIll[B.lIllIllIIIlIl[0]] = B."priestess rows you";
    }
}
