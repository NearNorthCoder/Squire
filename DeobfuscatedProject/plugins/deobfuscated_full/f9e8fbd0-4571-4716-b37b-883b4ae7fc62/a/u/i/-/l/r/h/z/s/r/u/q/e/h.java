...
extends Enum<h> {
    ...
    private static String llIIlIIlIlIllll(String var10, String var7) {
        var10 = new String(Base64.getDecoder().decode(var10.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var17 = new StringBuilder();
        char[] var15 = var7.toCharArray();
        int var14 = lIllIlllIIlll[0];
        char[] var5 = var10.toCharArray();
        int var8 = var5.length;
        int var13 = lIllIlllIIlll[0];
        while (h.llIIlIIlIlllllI(var13, var8)) {
            char var19 = var5[var13];
            var17.append((char)(var19 ^ var15[var14 % var15.length]));
            0;
            ++var14;
            ++var13;
            0;
    ...
    private static String llIIlIIlIlIlIlI(String var16, String var4) {
        try {
            ...
            var11.init(lIllIlllIIlll[5], var12);
    ...
    private static String llIIlIIlIllIIII(String var2, String var3) {
        try {
            SecretKeySpec var9 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var3.getBytes(StandardCharsets.UTF_8)), lIllIlllIIlll[2]), "DES");
            Cipher var6 = Cipher.getInstance("DES");
            var6.init(lIllIlllIIlll[5], var9);
    ...
    private static void llIIlIIlIlllIII() {
        ...
        h.lIllIllIllllI[h.lIllIlllIIlll[0]] = h."RING_OF_DUELING";
        h.lIllIllIllllI[h.lIllIlllIIlll[1]] = h."Ferox Enclave";
        h.lIllIllIllllI[h.lIllIlllIIlll[5]] = h."ARDOUGNE_CLOAK";
        h.lIllIllIllllI[h.lIllIlllIIlll[7]] = h."Monastery Teleport";
        h.lIllIllIllllI[h.lIllIlllIIlll[9]] = h."AMULET_OF_GLORY";
        h.lIllIllIllllI[h.lIllIlllIIlll[11]] = h."Edgeville";
        h.lIllIllIllllI[h.lIllIlllIIlll[13]] = h."RADAS_BLESSING";
        h.lIllIllIllllI[h.lIllIlllIIlll[15]] = h."Mount Karuulm";
        h.lIllIllIllllI[h.lIllIlllIIlll[2]] = h."HOUSE_TELEPORT";
        h.lIllIllIllllI[h.lIllIlllIIlll[28]] = h."Break";
        h.lIllIllIllllI[h.lIllIlllIIlll[30]] = h."ZULANDRA_TELEPORT";
        h.lIllIllIllllI[h.lIllIlllIIlll[31]] = h."Teleport";
        h.lIllIllIllllI[h.lIllIlllIIlll[33]] = h."ROYAL_SEED_POD";
        h.lIllIllIllllI[h.lIllIlllIIlll[34]] = h."Commune";
        h.lIllIllIllllI[h.lIllIlllIIlll[36]] = h."ECTOPHIAL";
        h.lIllIllIllllI[h.lIllIlllIIlll[37]] = h."Empty";
        h.lIllIllIllllI[h.lIllIlllIIlll[39]] = h."CONSTRUCTION_CAPE";
        h.lIllIllIllllI[h.lIllIlllIIlll[40]] = h."Tele to POH";
        h.lIllIllIllllI[h.lIllIlllIIlll[43]] = h."QUEST_CAPE";
        h.lIllIllIllllI[h.lIllIlllIIlll[44]] = h."Teleport";
        h.lIllIllIllllI[h.lIllIlllIIlll[47]] = h."MAX_CAPE";
        h.lIllIllIllllI[h.lIllIlllIIlll[48]] = h."Tele to POH";
        h.lIllIllIllllI[h.lIllIlllIIlll[52]] = h."CRAFTING_CAPE";
        h.lIllIllIllllI[h.lIllIlllIIlll[53]] = h."Teleport";
        h.lIllIllIllllI[h.lIllIlllIIlll[56]] = h."FISHING_CAPE";
        h.lIllIllIllllI[h.lIllIlllIIlll[57]] = h."Fishing Guild";
        h.lIllIllIllllI[h.lIllIlllIIlll[60]] = h."EXPLORERS_RING";
        h.lIllIllIllllI[h.lIllIlllIIlll[61]] = h."Teleport";
    }
