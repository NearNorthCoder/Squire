...
extends OverlayPanel {
    ...
    private static String lllIIIIlIllIIl(String var2, String var19) {
        try {
            ...
            var5.init(lIlIlllIIlII[3], var11);
    ...
    private static String lllIIIIlIllIII(String var4, String var8) {
        try {
            SecretKeySpec var10 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var8.getBytes(StandardCharsets.UTF_8)), lIlIlllIIlII[9]), "DES");
            Cipher var7 = Cipher.getInstance("DES");
            var7.init(lIlIlllIIlII[3], var10);
    ...
    private static String lllIIIIlIlIlll(String var12, String var14) {
        var12 = new String(Base64.getDecoder().decode(var12.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var16 = new StringBuilder();
        char[] var3 = var14.toCharArray();
        int var6 = lIlIlllIIlII[1];
        char[] var18 = var12.toCharArray();
        int var13 = var18.length;
        int var9 = lIlIlllIIlII[1];
        while (CorpInfoBox.lllIIIIlIllllI(var9, var13)) {
            char var1 = var18[var9];
            var16.append((char)(var1 ^ var3[var6 % var3.length]));
            0;
            ++var6;
            ++var9;
            0;
