...
/* TASK: Tick Manipulating -> TickmanipulatingTask */
...
extends Task {
    ...
    private static String lllIlIllIlIllI(String var8, String var17) {
        var8 = new String(Base64.getDecoder().decode(var8.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var7 = new StringBuilder();
        char[] var12 = var17.toCharArray();
        int var2 = lIlllIlIllll[1];
        char[] var19 = var8.toCharArray();
        int var13 = var19.length;
        int var5 = lIlllIlIllll[1];
        while (m.lllIlIlllIIIIl(var5, var13)) {
            char var16 = var19[var5];
            var7.append((char)(var16 ^ var12[var2 % var12.length]));
            0;
            ++var2;
            ++var5;
            0;
    ...
    public boolean run() {
        ...
        if (m.lllIlIllIllIlI(var10.V.tickFishing() ? 1 : 0)) {
            return lIlllIlIllll[1];
        }
        ...
        if (m.lllIlIllIllIlI(Inventory.contains((int[])var10.X) ? 1 : 0) && m.lllIlIllIllIll(Inventory.contains((int[])var10.W) ? 1 : 0)) {
            Inventory.getFirst((int[])var10.W).interact(lIlllIlIlllI[lIlllIlIllll[1]]);
            return lIlllIlIllll[3];
        }
        if (m.lllIlIllIllIlI(var10.r() ? 1 : 0) && m.lllIlIllIllIlI(var10.q() ? 1 : 0)) {
            if (m.lllIlIllIllIlI(var10.r() ? 1 : 0)) {
                System.out.println(lIlllIlIlllI[lIlllIlIllll[3]]);
            }
            if (m.lllIlIllIllIlI(var10.q() ? 1 : 0)) {
                System.out.println(lIlllIlIlllI[lIlllIlIllll[5]]);
            }
            return lIlllIlIllll[1];
        }
        int var18 = Players.getLocal().getAnimation();
        NPC var15 = NPCs.getNearest(nPC -> nPC.hasAction(this.V.fish().n()));
        if (m.lllIlIllIlllII(var15)) {
            return lIlllIlIllll[1];
        }
        if (m.lllIlIllIlllIl(var15.distanceTo((Locatable)Players.getLocal()), lIlllIlIllll[0])) {
            return lIlllIlIllll[1];
        }
        if (!m.lllIlIllIllllI(var18, lIlllIlIllll[15]) || m.lllIlIllIlllll(var18, lIlllIlIllll[16])) {
            if (m.lllIlIllIllIll(var10.V.cutEat() ? 1 : 0)) {
                Item var1 = Inventory.getFirst(item -> item.getName().contains(lIlllIlIlllI[lIlllIlIllll[24]]));
                ...
                if (m.lllIlIlllIIIII(var1) && m.lllIlIlllIIIII(var9)) {
                    int[] nArray = new int[lIlllIlIllll[3]];
                    nArray[m.lIlllIlIllll[1]] = lIlllIlIllll[17];
                    Inventory.getFirst((int[])nArray).useOn(var1);
                    var9.interact(lIlllIlIlllI[lIlllIlIllll[7]]);
                    return lIlllIlIllll[3];
                }
                if (m.lllIlIllIlllII(var9)) {
                    int[] nArray = new int[lIlllIlIllll[3]];
                    nArray[m.lIlllIlIllll[1]] = lIlllIlIllll[17];
                    Inventory.getFirst((int[])nArray).useOn(var1);
                }
            }
            if (m.lllIlIllIllIll(var10.q() ? 1 : 0)) {
                int[] nArray = new int[lIlllIlIllll[3]];
                nArray[m.lIlllIlIllll[1]] = lIlllIlIllll[18];
                Inventory.getFirst((int[])var10.X).useOn(Inventory.getFirst((int[])nArray));
                return lIlllIlIllll[3];
            }
            if (m.lllIlIllIllIll(var10.r() ? 1 : 0)) {
                int[] nArray = new int[lIlllIlIllll[3]];
                nArray[m.lIlllIlIllll[1]] = lIlllIlIllll[17];
                Inventory.getFirst((int[])var10.Y).useOn(Inventory.getFirst((int[])nArray));
                return lIlllIlIllll[3];
            }
        }
        if (!m.lllIlIllIllllI(var18, lIlllIlIllll[19]) || m.lllIlIllIlllll(var18, lIlllIlIllll[20])) {
            var15.interact(var10.V.fish().n());
            var10.sleep(lIlllIlIllll[5]);
            return lIlllIlIllll[3];
        }
        return lIlllIlIllll[1];
    }
    ...
    private static String lllIlIllIlIlIl(String var6, String var4) {
        try {
            ...
            var3.init(lIlllIlIllll[5], var11);
