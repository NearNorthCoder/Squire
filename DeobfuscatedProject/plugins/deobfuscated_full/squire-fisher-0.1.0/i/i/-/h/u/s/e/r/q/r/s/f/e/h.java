...
/* TASK: Dropping Fish -> DroppingfishTask */
...
extends Task {
    ...
    public boolean run() {
        ...
        if (h.lllIlIlIlIlIIl(Inventory.isFull() ? 1 : 0) && h.lllIlIlIlIlIlI((Object)var2.K.fish(), (Object)f.HOUSE_KEY)) {
            ...
            if (h.lllIlIlIlIlIll(Inventory.getCount((int[])nArray), lIlllIlIIlIl[1])) {
                ...
                List var1 = Inventory.getAll((int[])nArray2);
                var1.subList(lIlllIlIIlIl[0], var1.size() - lIlllIlIIlIl[3]).forEach(Item::drop);
                if (h.lllIlIlIlIlIll(var1.size(), lIlllIlIIlIl[4])) {
                    return lIlllIlIIlIl[1];
                }
            }
        }
        if (h.lllIlIlIlIllII(Inventory.contains((int[])var2.K.fish().j()) ? 1 : 0)) {
            return lIlllIlIIlIl[0];
        }
        if (h.lllIlIlIlIlIIl(var2.K.tickFishing() ? 1 : 0) && h.lllIlIlIlIlIIl(var2.a(Players.getLocal()) ? 1 : 0)) {
            return lIlllIlIIlIl[0];
        }
        if (h.lllIlIlIlIllIl(Inventory.getCount((int[])var2.K.fish().j()), Rand.nextInt((int)lIlllIlIIlIl[5], (int)lIlllIlIIlIl[6]))) {
            return lIlllIlIIlIl[0];
        }
        if (h.lllIlIlIlIlIIl(var2.K.cutEat() ? 1 : 0) && h.lllIlIlIlIlllI(Inventory.getFreeSlots(), lIlllIlIIlIl[5])) {
            return lIlllIlIIlIl[0];
        }
    ...
    private static void lllIlIlIlIlIII() {
        ...
        h.lIlllIlIIlIl[0] = (1 ^ 0x49 ^ (0x68 ^ 0x66)) & (0x16 ^ 0x19 ^ (0x89 ^ 0xC0) ^ -1);
        h.lIlllIlIIlIl[1] = 1;
