...
extends Task {
    ...
    private static String lllIlIlllllIIl(String var5, String var7) {
        try {
    ...
    public boolean run() {
        ...
        if (l.lllIlIllllllIl(Combat.isSpecEnabled() ? 1 : 0)) {
            ...
            if (l.lllIlIlllllllI(var6)) {
                return lIlllIllIlll[1];
            }
            if (l.lllIlIllllllll(var6.getId(), lIlllIllIlll[2])) {
                Widget var3 = Widgets.get((int)lIlllIllIlll[3], (int)lIlllIllIlll[4]);
                if (l.lllIllIIIIIIII(var3)) {
                    System.out.println(lIlllIllIllI[lIlllIllIlll[1]]);
                    var3.interact(lIlllIllIlll[1]);
                }
                0;
