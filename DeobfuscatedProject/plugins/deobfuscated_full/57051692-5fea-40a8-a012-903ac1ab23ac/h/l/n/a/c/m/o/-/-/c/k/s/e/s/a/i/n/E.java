...
implements K {
    ...
    private static String lIIlllIllllIl(String var10, String var6) {
        try {
            SecretKeySpec var4 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var6.getBytes(StandardCharsets.UTF_8)), lIlllIlIll[22]), "DES");
            Cipher var20 = Cipher.getInstance("DES");
            var20.init(lIlllIlIll[4], var4);
    ...
    public static void cc() {
        ...
        if (E.lIIllllIIIIll(bn ? 1 : 0)) {
            if (E.lIIllllIIIIll(E.al() ? 1 : 0) && E.lIIllllIIIlII(Players.getLocal().getWorldLocation().distanceTo(iD), lIlllIlIll[2]) && E.lIIllllIIIIlI(e.j(lIlllIlIll[3]), lIlllIlIll[4])) {
                ...
                if (E.lIIllllIIIlIl(var16) && E.lIIllllIIIIll(var16.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderShamans.c = lIlllIlIlI[lIlllIlIll[4]];
                    a.a(var16);
                }
                if (E.lIIllllIIIlIl(var16) && E.lIIllllIIIIIl(var16.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String lIIlllIllllII(String var18, String var9) {
        var18 = new String(Base64.getDecoder().decode(var18.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var13 = new StringBuilder();
        char[] var1 = var9.toCharArray();
        int var17 = lIlllIlIll[0];
        char[] var15 = var18.toCharArray();
        int var11 = var15.length;
        int var3 = lIlllIlIll[0];
        while (E.lIIllllIIIIlI(var3, var11)) {
            char var8 = var15[var3];
            var13.append((char)(var8 ^ var1[var17 % var1.length]));
            0;
            ++var17;
            ++var3;
            0;
    ...
    private static String lIIlllIlllllI(String var5, String var12) {
        try {
    ...
    private static void O() {
        ...
        if (E.lIIllllIIIIll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var14 = new d(lIlllIlIll[8], lIlllIlIll[1], lIlllIlIll[6]);
            bp.add((d)var14);
            0;
        }
        int[] nArray3 = new int[lIlllIlIll[1]];
        ...
        if (E.lIIllllIIIIll(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var14 = new d(lIlllIlIll[7], lIlllIlIll[1], lIlllIlIll[6]);
            bp.add((d)var14);
            0;
        }
        ...
        if (E.lIIllllIIIIll(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var14 = new d(lIlllIlIll[10], lIlllIlIll[14], lIlllIlIll[15]);
            bp.add((d)var14);
            0;
        }
        if (E.lIIllllIIIIll(Bank.contains((Predicate)(var14 = item -> item.getName().toLowerCase().contains(lIlllIlIlI[lIlllIlIll[23]]))) ? 1 : 0)) {
            var23 = new d(lIlllIlIll[16], lIlllIlIll[11], lIlllIlIll[17]);
            bp.add(var23);
            0;
        }
        ...
        if (E.lIIllllIIIIll(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var23 = new d(lIlllIlIll[18], lIlllIlIll[19], lIlllIlIll[20]);
            bp.add(var23);
            0;
        }
    }
