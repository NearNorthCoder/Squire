...
implements K {
    ...
    static NPC aD() {
        ...
        if (o.lIIllIlIlIlII(list)) {
            ...
            int var25 = lIllIlllIl[1];
            while (o.lIIllIlIlIIlI(var25, var17.size())) {
                void var8;
                if (o.lIIllIlIlIlIl(var8.contains(((NPC)var17.get(var25)).getWorldLocation()) ? 1 : 0)) {
                    return (NPC)var17.get(var25);
                }
                ++var25;
                0;
    ...
    private static String lIIllIlIIllll(String var15, String var2) {
        ...
        int var18 = lIllIlllIl[1];
        char[] var22 = var15.toCharArray();
        int var26 = var22.length;
        int var6 = lIllIlllIl[1];
        while (o.lIIllIlIlIIlI(var6, var26)) {
            char var3 = var22[var6];
            var27.append((char)(var3 ^ var11[var18 % var11.length]));
            0;
            ++var18;
            ++var6;
            0;
    ...
    public static void aC() {
        ...
        if (o.lIIllIlIllIIl(o.lIIllIlIlIlll(e.a(cx), lIllIlllIl[9] + cC))) {
            if (o.lIIllIlIlIIll(Players.getLocal().getWorldLocation().equals((Object)cw) ? 1 : 0)) {
                ...
                if (o.lIIllIlIlIIll(cz.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (o.lIIllIlIllIll(Players.getLocal().getWorldLocation().distanceTo(cv), lIllIlllIl[10])) {
                        ...
                        if (o.lIIllIlIlIlII(var29)) {
                            String[] stringArray2 = new String[lIllIlllIl[0]];
                            stringArray2[o.lIllIlllIl[1]] = lIllIlllII[lIllIlllIl[16]];
                            if (o.lIIllIlIlIlIl(var29.hasAction(stringArray2) ? 1 : 0)) {
                                var29.interact(lIllIlllII[lIllIlllIl[17]]);
                            ...
                            if (o.lIIllIlIlIIll(var29.hasAction(stringArray3) ? 1 : 0)) {
            ...
            if (o.lIIllIlIlIlIl(Players.getLocal().getWorldLocation().equals((Object)cw) ? 1 : 0)) {
                ...
                if (o.lIIllIlIlIlIl(o.aE() ? 1 : 0)) {
                    var29 = new WorldArea(cw, lIllIlllIl[3], lIllIlllIl[3]);
                    var12 = o.aD();
                    AccBuilderShamans.c = lIllIlllII[lIllIlllIl[21]];
                    if (o.lIIllIlIlllII(Players.getLocal().getInteracting()) && o.lIIllIlIlIlII(var12) && o.lIIllIlIlIIll(var12.isDead() ? 1 : 0)) {
                        System.out.println(lIllIlllII[lIllIlllIl[22]]);
                        var12.interact(lIllIlllII[lIllIlllIl[23]]);
        ...
        if (o.lIIllIlIlllIl(o.lIIllIlIlIlll(e.a(cx), lIllIlllIl[9] + cC))) {
            var29 = new WorldArea(lIllIlllIl[24], lIllIlllIl[25], lIllIlllIl[26], lIllIlllIl[27], lIllIlllIl[1]);
            var12 = new WorldPoint(lIllIlllIl[28], lIllIlllIl[29], lIllIlllIl[1]);
            if (o.lIIllIlIlIlIl(var29.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && o.lIIllIlIllIlI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var12), lIllIlllIl[13])) {
    ...
    private static String lIIllIlIIllIl(String var21, String var23) {
        try {
            SecretKeySpec var19 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var23.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var28 = Cipher.getInstance("Blowfish");
            var28.init(lIllIlllIl[3], var19);
            return new String(var28.doFinal(Base64.getDecoder().decode(var21.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static boolean aE() {
        ...
        if (o.lIIllIlIlIIll(list.isEmpty() ? 1 : 0) && o.lIIllIlIllIlI(list.size(), lIllIlllIl[0])) {
            void var5;
            int var24 = lIllIlllIl[1];
            while (o.lIIllIlIlIIlI(var24, var5.size())) {
                void var20;
                if (o.lIIllIlIlIlIl(((Player)var5.get(var24)).equals(Players.getLocal()) ? 1 : 0)) {
                    0;
                    if ((23 + 98 - 109 + 137 ^ 51 + 76 - 67 + 84) == 0) {
                        return ((0xFA ^ 0xB6 ^ (0xA3 ^ 0xC5)) & (26 + 62 - -14 + 69 ^ 119 + 88 - 98 + 20 ^ -1)) != 0;
                    }
                } else if (o.lIIllIlIlIlIl(var20.contains(((Player)var5.get(var24)).getWorldLocation()) ? 1 : 0)) {
                    return lIllIlllIl[0];
                }
                ++var24;
                0;
    ...
    private static void aB() {
        ...
        if (o.lIIllIlIlIIll(Inventory.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (o.lIIllIlIlIlII(var9) && o.lIIllIlIlIIll(var9.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                AccBuilderShamans.c = lIllIlllII[lIllIlllIl[0]];
                a.a(var9);
            }
            if (o.lIIllIlIlIlII(var9) && o.lIIllIlIlIlIl(var9.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String lIIllIlIIlllI(String var1, String var16) {
        try {
            SecretKeySpec var13 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var16.getBytes(StandardCharsets.UTF_8)), lIllIlllIl[16]), "DES");
            Cipher var4 = Cipher.getInstance("DES");
            var4.init(lIllIlllIl[3], var13);
    ...
    public static void aF() {
        ...
        if (o.lIIllIlIllllI((int)var7, lIllIlllIl[3])) {
            cw = cn;
            cm = co;
        }
        if (o.lIIllIlIllllI((int)var7, lIllIlllIl[10])) {
            cw = cp;
            cm = cq;
        }
        if (o.lIIllIlIllllI((int)var7, lIllIlllIl[12])) {
            cw = cr;
            cm = cs;
        }
        if (o.lIIllIlIllllI((int)var7, lIllIlllIl[13])) {
            cw = ct;
            cm = cu;
        }
    }
