...
implements K {
    ...
    private static String lIIlIIIIIIlII(String var16, String var8) {
        try {
            ...
            var9.init(lIlIlIlIIl[3], var14);
            return new String(var9.doFinal(Base64.getDecoder().decode(var16.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
            ...
            block64: {
                block65: {
                    ...
                    if (t.lIIlIIIIlllIl(t.al() ? 1 : 0) && t.lIIlIIIIlllIl(Vars.getBit((int)QuestVarbits.QUEST_A_PORCINE_OF_INTEREST.getId()))) {
                        ...
                        if (t.lIIlIIIIllllI(var13) && t.lIIlIIIIlllIl(var13.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            AccBuilderShamans.c = lIlIlIIllI[lIlIlIlIIl[0]];
                            a.a(var13);
                        }
                        if (t.lIIlIIIIllllI(var13) && t.lIIlIIIIllIll(var13.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String lIIlIIIIIIllI(String var15, String var21) {
        var15 = new String(Base64.getDecoder().decode(var15.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var2 = new StringBuilder();
        char[] var22 = var21.toCharArray();
        int var5 = lIlIlIlIIl[1];
        char[] var20 = var15.toCharArray();
        int var1 = var20.length;
        int var19 = lIlIlIlIIl[1];
        while (t.lIIlIIIIlllII(var19, var1)) {
            char var7 = var20[var19];
            var2.append((char)(var7 ^ var22[var5 % var22.length]));
            0;
            ++var5;
            ++var19;
            0;
    ...
    private static String lIIlIIIIIIlIl(String var6, String var4) {
        try {
            SecretKeySpec var10 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var4.getBytes(StandardCharsets.UTF_8)), lIlIlIlIIl[16]), "DES");
            Cipher var3 = Cipher.getInstance("DES");
            var3.init(lIlIlIlIIl[3], var10);
    ...
    private static void O() {
        ...
        block10: {
            block9: {
                ...
                if (t.lIIlIIIIlllIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
                    var11 = new d(lIlIlIlIIl[10], lIlIlIlIIl[0], lIlIlIlIIl[81]);
                    bp.add((d)var11);
                    0;
                }
                int[] nArray3 = new int[lIlIlIlIIl[0]];
                ...
                if (t.lIIlIIIIlllIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
                    var11 = new d(lIlIlIlIIl[13], lIlIlIlIIl[50], lIlIlIlIIl[82]);
                    bp.add((d)var11);
                    0;
                }
                int[] nArray4 = new int[lIlIlIlIIl[0]];
                ...
                if (t.lIIlIIIIlllIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
                    var11 = new d(lIlIlIlIIl[11], lIlIlIlIIl[12], j.bZ);
                    bp.add((d)var11);
                    0;
                }
                if (t.lIIlIIIIlllIl(Bank.contains((Predicate)(var11 = item -> item.getName().toLowerCase().contains(lIlIlIIllI[lIlIlIlIIl[87]]))) ? 1 : 0)) {
                    var17 = new d(lIlIlIlIIl[83], lIlIlIlIIl[12], lIlIlIlIIl[84]);
                    bp.add(var17);
                    0;
                }
                int[] nArray5 = new int[lIlIlIlIIl[0]];
            ...
            var17 = new d(lIlIlIlIIl[7], lIlIlIlIIl[28], lIlIlIlIIl[82]);
            bp.add(var17);
            0;
        }
        int[] nArray = new int[lIlIlIlIIl[0]];
        nArray[t.lIlIlIlIIl[1]] = lIlIlIlIIl[6];
        if (t.lIIlIIIIlllIl(Bank.contains((int[])nArray) ? 1 : 0)) {
            var17 = new d(lIlIlIlIIl[6], lIlIlIlIIl[57], lIlIlIlIIl[82]);
            bp.add(var17);
            0;
        }
    }
