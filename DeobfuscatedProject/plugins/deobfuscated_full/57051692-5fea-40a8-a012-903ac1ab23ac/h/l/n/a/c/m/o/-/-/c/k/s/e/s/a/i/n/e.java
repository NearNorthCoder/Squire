...
public class e {
    ...
    public static void a(HashMap<Integer, Integer> hashMap, boolean bl, boolean bl2) {
        ...
        if (e.lIIIllIIllllI(Players.getLocal().getWorldLocation().distanceTo(X), lIlIIlIlll[4])) {
            ...
            if (e.lIIIllIIllIll((int)var40) && e.lIIIllIlIIIll(Inventory.getAll().size())) {
                Bank.depositInventory();
                Time.sleepTicks((int)lIlIIlIlll[4]);
                0;
            }
            if (e.lIIIllIIllIll((int)var4) && e.lIIIllIlIIIll(Equipment.getAll().size())) {
                Bank.depositEquipment();
                Time.sleepTicks((int)lIlIIlIlll[3]);
                0;
            }
            Iterator<Map.Entry<Integer, Integer>> var28 = var39.entrySet().iterator();
            while (e.lIIIllIIllIll(var28.hasNext() ? 1 : 0)) {
                Map.Entry<Integer, Integer> var49 = var28.next();
                int var46 = var49.getKey();
                int var64 = var49.getValue();
                System.out.println("Key: " + var46 + ", Value: " + var64);
                a.a(var46, var64);
                Time.sleepTicks((int)lIlIIlIlll[0]);
                0;
                0;
                if ((0x7C ^ 0x78) > -1) continue;
                return;
            }
        }
    }
    ...
    public static int c(int n2, int n3) {
        ...
        if (e.lIIIllIIllIlI(Math.abs(var15), lIlIIlIlll[0])) {
            int n5;
    ...
    public static boolean b(int[] nArray) {
        int[] var11;
        int var13 = lIlIIlIlll[2];
        while (e.lIIIllIlIIIII(var13, var11.length)) {
            if (e.lIIIllIIllIIl(e.i(var11[var13]) ? 1 : 0)) {
                System.out.println("Missing ID: " + var11[var13]);
                return lIlIIlIlll[2];
            }
            ++var13;
            0;
            if (3 == 3) continue;
            return ((0xDD ^ 0xAD ^ (0x49 ^ 0x79)) & (0x1C ^ 0x71 ^ (0x12 ^ 0x3F) ^ -1)) != 0;
        }
        return lIlIIlIlll[0];
    }
    ...
    private static String lIIIllIIIIllI(String var56, String var12) {
        try {
            SecretKeySpec var25 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var12.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var1 = Cipher.getInstance("Blowfish");
            var1.init(lIlIIlIlll[3], var25);
            return new String(var1.doFinal(Base64.getDecoder().decode(var56.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
        ...
        if (e.lIIIllIIllIll(Inventory.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (e.lIIIllIIllIIl(Equipment.contains((int[])nArray2) ? 1 : 0)) {
                ...
                if (e.lIIIllIIllIll(Inventory.getFirst((int[])nArray7).hasAction(stringArray3) ? 1 : 0)) {
                    ...
                    nArray8[e.lIlIIlIlll[2]] = var8;
                    Inventory.getFirst((int[])nArray8).interact(lIlIIlIlIl[lIlIIlIlll[41]]);
                }
                if (e.lIIIllIIllIlI(var8, lIlIIlIlll[42])) {
    ...
    public static void E() {
        block9: {
            ...
            do {
                ...
                NPC var60 = NPCs.getNearest((String[])stringArray2);
                if (e.lIIIllIIllIIl(var16)) {
                    if (e.lIIIllIIllIIl(Dialog.isOpen() ? 1 : 0)) {
                        var60.interact(lIlIIlIlIl[lIlIIlIlll[68]]);
                    }
                    if (e.lIIIllIIllIll(Dialog.isOpen() ? 1 : 0)) {
                        List var29;
                        if (e.lIIIllIIllIIl(Dialog.canContinueNPC() ? 1 : 0) && e.lIIIllIIllIIl(Dialog.canContinue() ? 1 : 0) && e.lIIIllIIllIIl((var29 = Dialog.getOptions()).isEmpty() ? 1 : 0)) {
                            List var42 = var29.stream().filter(widget -> {
                                boolean bl;
                                if (e.lIIIllIIllIIl(widget.getText().contains(lIlIIlIlIl[lIlIIlIlll[74]]) ? 1 : 0)) {
                                    bl = lIlIIlIlll[0];
                                    0;
                                    if (-(66 + 33 - -60 + 34 ^ 143 + 191 - 162 + 24) >= 0) {
                                        return ((0x81 ^ 0xB7 ^ (0xBD ^ 0xC0)) & (0x3B ^ 0x27 ^ (0xDF ^ 0x88) ^ -1)) != 0;
                                    }
                                } else {
                                    bl = lIlIIlIlll[2];
                                }
                            ...
                            if (e.lIIIllIIllIIl(var42.isEmpty() ? 1 : 0)) {
                                Mouse.click((int)((Widget)var42.get(lIlIIlIlll[2])).getClickPoint().getX(), (int)((Widget)var42.get(lIlIIlIlll[2])).getClickPoint().getY(), (boolean)lIlIIlIlll[0]);
                                Time.sleepTicks((int)lIlIIlIlll[1]);
                                0;
                            }
                            if (e.lIIIllIIllIlI(var42.size(), lIlIIlIlll[0])) {
                                var16 = lIlIIlIlll[0];
                            }
                        }
    ...
    public static void k(int n2) {
        if (e.lIIIllIlIIIIl(Static.getClient().getWorld(), n2)) {
            ...
            World var55 = Static.getClient().createWorld();
            var55.setActivity(var43.getActivity());
            var55.setAddress(var43.getAddress());
            var55.setId(var43.getId());
            var55.setPlayerCount(var43.getPlayers());
            var55.setLocation(var43.getLocation());
            var55.setTypes(WorldUtil.toWorldTypes((EnumSet)var43.getTypes()));
            Worlds.hopTo((World)var55);
        }
    }

    private static String lIIIllIIIIlIl(String var27, String var23) {
        var27 = new String(Base64.getDecoder().decode(var27.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var7 = new StringBuilder();
        char[] var47 = var23.toCharArray();
        int var35 = lIlIIlIlll[2];
        char[] var57 = var27.toCharArray();
        int var37 = var57.length;
        int var51 = lIlIIlIlll[2];
        while (e.lIIIllIlIIIII(var51, var37)) {
            char var22 = var57[var51];
            var7.append((char)(var22 ^ var47[var35 % var47.length]));
            0;
            ++var35;
            ++var51;
            0;
    ...
    private static void lIIIllIIIlIII() {
        ...
        e.lIlIIlIlIl[e.lIlIIlIlll[2]] = e."Nav to veos";
        e.lIlIIlIlIl[e.lIlIIlIlll[0]] = e."Handle veos chat";
        e.lIlIIlIlIl[e.lIlIIlIlll[3]] = e."Port Piscarilius";
        e.lIlIIlIlIl[e.lIlIIlIlll[1]] = e."Port Piscarilius";
        e.lIlIIlIlIl[e.lIlIIlIlll[4]] = e."Port Piscarilius";
        e.lIlIIlIlIl[e.lIlIIlIlll[5]] = e."Veos";
        e.lIlIIlIlIl[e.lIlIIlIlll[6]] = e."Cabin Boy Herbert";
        e.lIlIIlIlIl[e.lIlIIlIlll[7]] = e."Port Piscarilius";
        e.lIlIIlIlIl[e.lIlIIlIlll[8]] = e."Port Piscarilius";
        e.lIlIIlIlIl[e.lIlIIlIlll[9]] = e."Port Piscarilius";
        e.lIlIIlIlIl[e.lIlIIlIlll[10]] = e."Cabin Boy Herbert";
        e.lIlIIlIlIl[e.lIlIIlIlll[11]] = e."%%0%dd";
        e.lIlIIlIlIl[e.lIlIIlIlll[12]] = e."C:\\Users\\Nick\\AppData\\Roaming\\.tribot\\GodsMule\\mule.txt";
        e.lIlIIlIlIl[e.lIlIIlIlll[13]] = e."line.separator";
        e.lIlIIlIlIl[e.lIlIIlIlll[16]] = e."Close";
        e.lIlIIlIlIl[e.lIlIIlIlll[17]] = e."Nav to Varrock W bank";
        e.lIlIIlIlIl[e.lIlIIlIlll[23]] = e."Break";
        e.lIlIIlIlIl[e.lIlIIlIlll[24]] = e."Handling banking";
        e.lIlIIlIlIl[e.lIlIIlIlll[27]] = e."Select Warnings";
        e.lIlIIlIlIl[e.lIlIIlIlll[29]] = e."Toggle";
        e.lIlIIlIlIl[e.lIlIIlIlll[30]] = e."Toggle";
        e.lIlIIlIlIl[e.lIlIIlIlll[33]] = e."Close";
        e.lIlIIlIlIl[e.lIlIIlIlll[36]] = e."All Settings";
        e.lIlIIlIlIl[e.lIlIIlIlll[26]] = e."Wear";
        e.lIlIIlIlIl[e.lIlIIlIlll[37]] = e."Wear";
        e.lIlIIlIlIl[e.lIlIIlIlll[38]] = e."Wield";
        e.lIlIIlIlIl[e.lIlIIlIlll[39]] = e."Wield";
        e.lIlIIlIlIl[e.lIlIIlIlll[40]] = e."Equip";
        e.lIlIIlIlIl[e.lIlIIlIlll[41]] = e."Equip";
        e.lIlIIlIlIl[e.lIlIIlIlll[15]] = e."Give me a PK skull.";
        e.lIlIIlIlIl[e.lIlIIlIlll[54]] = e."Nav to outside gate";
        e.lIlIIlIlIl[e.lIlIIlIlll[55]] = e."Gate";
        e.lIlIIlIlIl[e.lIlIIlIlll[35]] = e."Open";
        e.lIlIIlIlIl[e.lIlIIlIlll[56]] = e."Sorry, I'm a bit busy.";
        e.lIlIIlIlIl[e.lIlIIlIlll[57]] = e."Nav to stronghold tile";
        e.lIlIIlIlIl[e.lIlIIlIlll[47]] = e."POST";
        e.lIlIIlIlIl[e.lIlIIlIlll[60]] = e."Content-Type";
        e.lIlIIlIlIl[e.lIlIIlIlll[61]] = e."application/json";
        e.lIlIIlIlIl[e.lIlIIlIlll[65]] = e."Auto retaliate";
        e.lIlIIlIlIl[e.lIlIIlIlll[66]] = e."Auto retaliate";
        e.lIlIIlIlIl[e.lIlIIlIlll[21]] = e."Death's Coffer";
        e.lIlIIlIlIl[e.lIlIIlIlll[32]] = e."Handling death";
        e.lIlIIlIlIl[e.lIlIIlIlll[67]] = e."Death";
        e.lIlIIlIlIl[e.lIlIIlIlll[68]] = e."Talk-to";
        e.lIlIIlIlIl[e.lIlIIlIlll[69]] = e."Portal";
        e.lIlIIlIlIl[e.lIlIIlIlll[70]] = e."Use";
        e.lIlIIlIlIl[e.lIlIIlIlll[74]] = e."<str>";
        e.lIlIIlIlIl[e.lIlIIlIlll[76]] = e."total";
        e.lIlIIlIlIl[e.lIlIIlIlll[77]] = e."PvP";
        e.lIlIIlIlIl[e.lIlIIlIlll[78]] = e."PvP";
        e.lIlIIlIlIl[e.lIlIIlIlll[71]] = e."High";
        e.lIlIIlIlIl[e.lIlIIlIlll[81]] = e."Leagues";
        e.lIlIIlIlIl[e.lIlIIlIlll[82]] = e."Beta";
        e.lIlIIlIlIl[e.lIlIIlIlll[83]] = e."beta";
        e.lIlIIlIlIl[e.lIlIIlIlll[84]] = e."Deadman";
        e.lIlIIlIlIl[e.lIlIIlIlll[85]] = e."Deadman";
        e.lIlIIlIlIl[e.lIlIIlIlll[86]] = e."Speedrunning";
        e.lIlIIlIlIl[e.lIlIIlIlll[87]] = e."total";
        e.lIlIIlIlIl[e.lIlIIlIlll[88]] = e."Beta";
        e.lIlIIlIlIl[e.lIlIIlIlll[90]] = e."Port Piscarilius";
        e.lIlIIlIlIl[e.lIlIIlIlll[91]] = e."C:\\Users\\Nick\\AppData\\Roaming\\.tribot\\GodsMule\\mule.txt";
    }
    ...
    public static void c(WorldPoint worldPoint) {
        ...
        WorldPoint var14 = var63;
        int var48 = var14.getX() - var30.getBaseX();
        Point var6 = Perspective.localToCanvas((Client)var30, (LocalPoint)LocalPoint.fromScene((int)var48, (int)(var26 = var14.getY() - var30.getBaseY())), (int)var30.getPlane());
        if (e.lIIIllIIlllll(var6)) {
            n3 = var6.getX();
            0;
            if (3 == ((0xA0 ^ 0x98 ^ (0x79 ^ 0x7E)) & (0x4A ^ 0x41 ^ (0x85 ^ 0xB1) ^ -1))) {
                return;
            }
        } else {
            int var50;
            n3 = var50 = lIlIIlIlll[62];
        }
        if (e.lIIIllIIlllll(var6)) {
            n2 = var6.getY();
            0;
    ...
    public static void C() {
        if (e.lIIIllIIllIIl(e.j(lIlIIlIlll[63]))) {
            ...
            if (e.lIIIllIIllIll(Tabs.isOpen((Tab)Tab.COMBAT) ? 1 : 0) && e.lIIIllIIlllll(var45 = Widgets.get((int)lIlIIlIlll[64], (int)lIlIIlIlll[54]))) {
                var45.interact(lIlIIlIlIl[lIlIIlIlll[65]]);
                Time.sleepTicks((int)lIlIIlIlll[0]);
                0;
            }
        }
    ...
    public static void a(WorldPoint worldPoint) {
        if (e.lIIIllIIllIIl(o.cz.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (e.lIIIllIIllllI(Players.getLocal().getWorldLocation().distanceTo(o.cv), lIlIIlIlll[1])) {
                ...
                if (e.lIIIllIIlllll(var59 = NPCs.getNearest(nPC -> {
                    String[] stringArray = new String[lIlIIlIlll[0]];
                    ...
                    if (e.lIIIllIIllIll(var59.hasAction(stringArray) ? 1 : 0)) {
                        var59.interact(lIlIIlIlIl[lIlIIlIlll[1]]);
                        Time.sleepTicks((int)lIlIIlIlll[1]);
                        0;
                    }
                    String[] stringArray2 = new String[lIlIIlIlll[0]];
                    stringArray2[e.lIlIIlIlll[2]] = lIlIIlIlIl[lIlIIlIlll[4]];
                    if (e.lIIIllIIllIIl(var59.hasAction(stringArray2) ? 1 : 0)) {
                ...
                if (e.lIIIllIIlllll(var34)) {
                    String[] stringArray3 = new String[lIlIIlIlll[0]];
                    stringArray3[e.lIlIIlIlll[2]] = lIlIIlIlIl[lIlIIlIlll[7]];
                    if (e.lIIIllIIllIll(var34.hasAction(stringArray3) ? 1 : 0)) {
                        var34.interact(lIlIIlIlIl[lIlIIlIlll[8]]);
                        Time.sleepTicks((int)lIlIIlIlll[1]);
                        0;
                    }
                    String[] stringArray4 = new String[lIlIIlIlll[0]];
                    stringArray4[e.lIlIIlIlll[2]] = lIlIIlIlIl[lIlIIlIlll[9]];
                    if (e.lIIIllIIllIIl(var34.hasAction(stringArray4) ? 1 : 0)) {
    ...
    private static String lIIIllIIIIlll(String var54, String var10) {
        try {
            SecretKeySpec var21 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var10.getBytes(StandardCharsets.UTF_8)), lIlIIlIlll[8]), "DES");
            Cipher var5 = Cipher.getInstance("DES");
            var5.init(lIlIIlIlll[3], var21);
            return new String(var5.doFinal(Base64.getDecoder().decode(var54.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void b(WorldPoint worldPoint) {
        ...
        if (e.lIIIllIIllllI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var24), lIlIIlIlll[6]) && e.lIIIllIIllllI(Players.getLocal().getWorldLocation().getY(), lIlIIlIlll[44])) {
            if (e.lIIIllIIllIIl(Dialog.isOpen() ? 1 : 0)) {
                String[] stringArray = new String[lIlIIlIlll[0]];
        ...
        if (e.lIIIllIIlllIl(Players.getLocal().getWorldLocation().getY(), lIlIIlIlll[44]) && (!e.lIIIllIIllIIl(var18.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !e.lIIIllIIllIIl(var41.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || e.lIIIllIIllllI(Players.getLocal().getWorldLocation().distanceTo(new WorldPoint(lIlIIlIlll[52], lIlIIlIlll[53], lIlIIlIlll[0])), lIlIIlIlll[30]))) {
            WorldPoint var58;
            ...
            Movement.walkTo((WorldPoint)var58);
            0;
            Time.sleepTicks((int)lIlIIlIlll[0]);
            0;
        }
    ...
    public static void a(String var17, String var31) {
        try {
            URL var36 = new URL(var17);
            HttpURLConnection var62 = (HttpURLConnection)var36.openConnection();
            var62.setRequestMethod(lIlIIlIlIl[lIlIIlIlll[47]]);
            var62.setRequestProperty(lIlIIlIlIl[lIlIIlIlll[60]], lIlIIlIlIl[lIlIIlIlll[61]]);
            var62.setDoOutput(lIlIIlIlll[0]);
            String var61 = "{\"content\": \"" + var31 + "\"}";
            DataOutputStream var52 = new DataOutputStream(var62.getOutputStream());
            var52.writeBytes(var61);
            var52.flush();
            var52.close();
            int var44 = var62.getResponseCode();
            System.out.println("Response Code: " + var44);
            var62.disconnect();
            0;
        }
    ...
    public static boolean x() {
        ...
        if (!e.lIIIllIIllIll((Integer)GameThread.invokeLater(() -> Static.getClient().getVarbitValue(lIlIIlIlll[28]))) || e.lIIIllIIllIIl((Integer)GameThread.invokeLater(() -> Static.getClient().getVarbitValue(lIlIIlIlll[31])))) {
            ...
            if ((91 + 113 - 203 + 126 ^ (0xDC ^ 0xA7)) == 0) {
                return ((0x36 ^ 0x30 ^ (0xE ^ 0x37)) & (0x46 ^ 0x5C ^ (0x66 ^ 0x43) ^ -1)) != 0;
            }
        } else {
            bl = lIlIIlIlll[2];
        }
    ...
    public static void D() {
        if (e.lIIIllIIllIlI(e.j(lIlIIlIlll[63]), lIlIIlIlll[0])) {
            ...
            if (e.lIIIllIIllIll(Tabs.isOpen((Tab)Tab.COMBAT) ? 1 : 0) && e.lIIIllIIlllll(var2 = Widgets.get((int)lIlIIlIlll[64], (int)lIlIIlIlll[54]))) {
                var2.interact(lIlIIlIlIl[lIlIIlIlll[66]]);
                Time.sleepTicks((int)lIlIIlIlll[0]);
                0;
            }
        }
    ...
    public static void y() {
        ...
        if (e.lIIIllIIllIll(e.x() ? 1 : 0)) {
            ...
            if (e.lIIIllIIllIll(e.z() ? 1 : 0)) {
                Widget var32;
                Widget var20;
                var53 = Widgets.get((int)lIlIIlIlll[25], (int)lIlIIlIlll[26], (int)lIlIIlIlll[7]);
                if (e.lIIIllIIlllll(var53)) {
                    var53.interact(lIlIIlIlIl[lIlIIlIlll[27]]);
                    Time.sleepTicks((int)lIlIIlIlll[0]);
                    0;
                }
                if (e.lIIIllIIllIIl(Vars.getBit((int)lIlIIlIlll[28])) && e.lIIIllIIlllll(var20 = Widgets.get((int)lIlIIlIlll[25], (int)lIlIIlIlll[29], (int)lIlIIlIlll[21]))) {
                    if (e.lIIIllIIllIIl(var20.isVisible() ? 1 : 0)) {
                        var32 = Widgets.get((int)lIlIIlIlll[25], (int)lIlIIlIlll[30], (int)lIlIIlIlll[5]);
                        Mouse.click((int)var32.getClickPoint().getX(), (int)var32.getClickPoint().getY(), (boolean)lIlIIlIlll[0]);
                        Time.sleepTicks((int)lIlIIlIlll[0]);
                        0;
                    }
                    if (e.lIIIllIIllIll(var20.isVisible() ? 1 : 0)) {
                        var20.interact(lIlIIlIlIl[lIlIIlIlll[29]]);
                        Time.sleepTicks((int)lIlIIlIlll[0]);
                        0;
                    }
                }
                if (e.lIIIllIIllIIl(Vars.getBit((int)lIlIIlIlll[31])) && e.lIIIllIIlllll(var20 = Widgets.get((int)lIlIIlIlll[25], (int)lIlIIlIlll[29], (int)lIlIIlIlll[32]))) {
                    if (e.lIIIllIIllIIl(var20.isVisible() ? 1 : 0)) {
                        var32 = Widgets.get((int)lIlIIlIlll[25], (int)lIlIIlIlll[30], (int)lIlIIlIlll[5]);
                        Mouse.click((int)var32.getClickPoint().getX(), (int)var32.getClickPoint().getY(), (boolean)lIlIIlIlll[0]);
                        Time.sleepTicks((int)lIlIIlIlll[0]);
                    ...
                    if (e.lIIIllIIllIll(var20.isVisible() ? 1 : 0)) {
                        var20.interact(lIlIIlIlIl[lIlIIlIlll[30]]);
                        Time.sleepTicks((int)lIlIIlIlll[3]);
                        0;
                    }
                }
        ...
        if (e.lIIIllIIlllll(var53 = Widgets.get((int)lIlIIlIlll[25], (int)lIlIIlIlll[4]))) {
            var53.interact(lIlIIlIlIl[lIlIIlIlll[33]]);
            Time.sleepTicks((int)lIlIIlIlll[0]);
            0;
        }
    }
    ...
    private static void lIIIllIIllIII() {
        ...
        e.lIlIIlIlll[0] = 1;
        e.lIlIIlIlll[1] = 3;
        e.lIlIIlIlll[2] = (0x42 ^ 0x39 ^ (0x2D ^ 0x1A)) & (0x50 ^ 6 ^ (0xD ^ 0x17) ^ -1);
        e.lIlIIlIlll[3] = 2;
