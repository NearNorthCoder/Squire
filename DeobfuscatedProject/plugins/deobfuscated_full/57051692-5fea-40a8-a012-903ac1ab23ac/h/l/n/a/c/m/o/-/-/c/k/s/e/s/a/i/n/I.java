...
implements K {
    ...
    private static String lIIllIIIIlllI(String var4, String var7) {
        try {
            SecretKeySpec var13 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var7.getBytes(StandardCharsets.UTF_8)), lIllIlIIIl[18]), "DES");
            Cipher var16 = Cipher.getInstance("DES");
            var16.init(lIllIlIIIl[3], var13);
    ...
    private static void O() {
        ...
        if (I.lIIllIIIllIIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var3 = new d(lIllIlIIIl[4], lIllIlIIIl[15], lIllIlIIIl[47]);
            bp.add((d)var3);
            0;
        }
        if (I.lIIllIIIllIIl(Bank.contains(var3 = item -> item.getName().toLowerCase().contains(lIllIIlllI[lIllIlIIIl[53]])) ? 1 : 0)) {
            var11 = new d(lIllIlIIIl[48], lIllIlIIIl[8], lIllIlIIIl[49]);
            bp.add(var11);
            0;
        }
        int[] nArray3 = new int[lIllIlIIIl[1]];
        ...
        if (I.lIIllIIIllIIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var11 = new d(lIllIlIIIl[11], lIllIlIIIl[15], lIllIlIIIl[50]);
            bp.add(var11);
            0;
        }
        ...
        if (I.lIIllIIIllIIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var11 = new d(lIllIlIIIl[13], lIllIlIIIl[31], lIllIlIIIl[50]);
            bp.add(var11);
            0;
        }
        ...
        if (I.lIIllIIIllIIl(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var11 = new d(lIllIlIIIl[12], lIllIlIIIl[8], j.bZ);
            bp.add(var11);
            0;
        }
    }
    ...
    public static void cJ() {
        ...
        if (I.lIIllIIIllIIl(bn ? 1 : 0)) {
            ...
            if (I.lIIllIIIllIIl(I.al() ? 1 : 0) && I.lIIllIIIllIII(e.j(lIllIlIIIl[6]), lIllIlIIIl[1])) {
                ...
                if (I.lIIllIIIlllII(var2) && I.lIIllIIIllIIl(var2.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderShamans.c = lIllIIlllI[lIllIlIIIl[7]];
                    a.a(var2);
                    Time.sleepTicks((int)lIllIlIIIl[3]);
                    0;
                }
                if (I.lIIllIIIlllII(var2) && I.lIIllIIIlIlll(var2.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (I.lIIllIIIlIlll(I.al() ? 1 : 0) && I.lIIllIIIllIII(e.j(lIllIlIIIl[6]), lIllIlIIIl[1])) {
                var2 = new WorldArea(lIllIlIIIl[16], lIllIlIIIl[17], lIllIlIIIl[18], lIllIlIIIl[19], lIllIlIIIl[0]);
                ...
                if (I.lIIllIIIlllIl(var5) && I.lIIllIIIllllI(Players.getLocal().getWorldLocation().distanceTo(jg), lIllIlIIIl[5]) && I.lIIllIIIllIIl(AccBuilderShamans.d ? 1 : 0)) {
            ...
            if (I.lIIllIIIlllll(e.j(lIllIlIIIl[6]), lIllIlIIIl[1])) {
                ...
                if (I.lIIllIIlIIIII(Players.getLocal().getWorldLocation().distanceTo(jh), lIllIlIIIl[14])) {
                    ...
                    if (I.lIIllIIIlllII(var2)) {
                        String[] stringArray2 = new String[lIllIlIIIl[1]];
                        stringArray2[I.lIllIlIIIl[0]] = lIllIIlllI[lIllIlIIIl[24]];
                        if (I.lIIllIIIlIlll(var2.hasAction(stringArray2) ? 1 : 0)) {
                            var2.interact(lIllIIlllI[lIllIlIIIl[25]]);
            ...
            if (I.lIIllIIIlllll(e.j(lIllIlIIIl[6]), lIllIlIIIl[5])) {
                ...
                if (I.lIIllIIlIIIII(Players.getLocal().getWorldLocation().distanceTo(jj), lIllIlIIIl[5])) {
                    ...
                    var2 = TileObjects.getNearest((String[])stringArray);
                    if (I.lIIllIIIlllII(var2)) {
                        var2.interact(lIllIIlllI[lIllIlIIIl[38]]);
                    }
                }
            }
            if (I.lIIllIIIlllll(e.j(lIllIlIIIl[6]), lIllIlIIIl[7])) {
                ...
                if (I.lIIllIIlIIIII(Players.getLocal().getWorldLocation().distanceTo(ji), lIllIlIIIl[3])) {
                    ...
                    if (I.lIIllIIIlllII(var2)) {
                        ...
                        if (I.lIIllIIIlIlll(var2.hasAction(stringArray4) ? 1 : 0)) {
                            var2.interact(lIllIIlllI[lIllIlIIIl[44]]);
                            Time.sleepTicks((int)lIllIlIIIl[3]);
                            0;
                        }
                        String[] stringArray5 = new String[lIllIlIIIl[1]];
                        stringArray5[I.lIllIlIIIl[0]] = lIllIIlllI[lIllIlIIIl[45]];
                        var5 = Inventory.getFirst((String[])stringArray5);
                        if (I.lIIllIIIlllII(var5)) {
    ...
    private static String lIIllIIIIllll(String var23, String var17) {
        ...
        int var19 = lIllIlIIIl[0];
        char[] var1 = var23.toCharArray();
        int var12 = var1.length;
        int var22 = lIllIlIIIl[0];
        while (I.lIIllIIIllIII(var22, var12)) {
            char var9 = var1[var22];
            var20.append((char)(var9 ^ var10[var19 % var10.length]));
            0;
            ++var19;
            ++var22;
            0;
    ...
    private static void lIIllIIIlIlII() {
        ...
        I.lIllIIlllI[I.lIllIlIIIl[0]] = I."Buying items";
        I.lIllIIlllI[I.lIllIlIIIl[1]] = I."Finished buying items, switching back to quest";
        I.lIllIIlllI[I.lIllIlIIIl[3]] = I."Drink";
        I.lIllIIlllI[I.lIllIlIIIl[5]] = I."Eat";
        I.lIllIIlllI[I.lIllIlIIIl[7]] = I."Nav to bank";
        I.lIllIIlllI[I.lIllIlIIIl[8]] = I."Handling banking";
        I.lIllIIlllI[I.lIllIlIIIl[14]] = I."We are missing quest supplies, switching to BUYING";
        I.lIllIIlllI[I.lIllIlIIIl[20]] = I."Father Aereck";
        I.lIllIIlllI[I.lIllIlIIIl[18]] = I."Nav to start";
        I.lIllIIlllI[I.lIllIlIIIl[21]] = I."Starting quest";
        I.lIllIIlllI[I.lIllIlIIIl[15]] = I."Father Aereck";
        I.lIllIIlllI[I.lIllIlIIIl[19]] = I."Nav to necklace guy";
        I.lIllIIlllI[I.lIllIlIIIl[22]] = I."Interacting npc";
        I.lIllIIlllI[I.lIllIlIIIl[23]] = I."Door";
        I.lIllIIlllI[I.lIllIlIIIl[24]] = I."Open";
        I.lIllIIlllI[I.lIllIlIIIl[25]] = I."Open";
        I.lIllIIlllI[I.lIllIlIIIl[26]] = I."Father Urhney";
        I.lIllIIlllI[I.lIllIlIIIl[28]] = I."Wear";
        I.lIllIIlllI[I.lIllIlIIIl[29]] = I."Nav to coffin";
        I.lIllIIlllI[I.lIllIlIIIl[30]] = I."Handling coffin";
        I.lIllIIlllI[I.lIllIlIIIl[31]] = I."Restless ghost";
        I.lIllIIlllI[I.lIllIlIIIl[32]] = I."Restless ghost";
        I.lIllIIlllI[I.lIllIlIIIl[33]] = I."Coffin";
        I.lIllIIlllI[I.lIllIlIIIl[34]] = I."Open";
        I.lIllIIlllI[I.lIllIlIIIl[35]] = I."Nav to skull";
        I.lIllIIlllI[I.lIllIlIIIl[36]] = I."Getting skull";
        I.lIllIIlllI[I.lIllIlIIIl[37]] = I."Altar";
        I.lIllIIlllI[I.lIllIlIIIl[38]] = I."Search";
        I.lIllIIlllI[I.lIllIlIIIl[39]] = I."Wear";
        I.lIllIIlllI[I.lIllIlIIIl[40]] = I."Nav to coffin";
        I.lIllIIlllI[I.lIllIlIIIl[41]] = I."Handling coffin";
        I.lIllIIlllI[I.lIllIlIIIl[42]] = I."Coffin";
        I.lIllIIlllI[I.lIllIlIIIl[43]] = I."Open";
        I.lIllIIlllI[I.lIllIlIIIl[44]] = I."Open";
        I.lIllIIlllI[I.lIllIlIIIl[45]] = I."Ghost's skull";
        I.lIllIIlllI[I.lIllIlIIIl[52]] = I."Restless ghost quest";
        I.lIllIIlllI[I.lIllIlIIIl[53]] = I."ring of wealth (";
        I.lIllIIlllI[I.lIllIlIIIl[54]] = I."Ok, I'm up for an adventure.";
        I.lIllIIlllI[I.lIllIlIIIl[55]] = I."A glass of your finest ale please.";
        I.lIllIIlllI[I.lIllIlIIIl[56]] = I."Morgan needs your help!";
        I.lIllIIlllI[I.lIllIlIIIl[57]] = I."Yes.";
        I.lIllIIlllI[I.lIllIlIIIl[58]] = I."I'm looking for a quest!";
        I.lIllIIlllI[I.lIllIlIIIl[59]] = I."Ok, let me help then.";
        I.lIllIIlllI[I.lIllIlIIIl[60]] = I."Father Aereck sent me to talk to you.";
        I.lIllIIlllI[I.lIllIlIIIl[61]] = I."He's got a ghost haunting his graveyard.";
        I.lIllIIlllI[I.lIllIlIIIl[62]] = I."Yep, now tell me what the problem is.";
        I.lIllIIlllI[I.lIllIlIIIl[63]] = I."Sure.";
        I.lIllIIlllI[I.lIllIlIIIl[64]] = I."I'm wearing an amulet of ghost speak!";
        I.lIllIIlllI[I.lIllIlIIIl[65]] = I."Yes, I'm sure.";
        I.lIllIIlllI[I.lIllIlIIIl[66]] = I."How can I help?";
    }

    private static String lIIllIIIIllIl(String var6, String var18) {
        try {
            ...
            var21.init(lIllIlIIIl[3], var15);
            return new String(var21.doFinal(Base64.getDecoder().decode(var6.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
