...
implements K {
    ...
    private static void O() {
        ...
        if (X.lIIIlIlIIIIII(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var12 = new d(lIlIIIlIll[0], X.dh(), lIlIIIlIll[63]);
            bp.add((d)var12);
            0;
        }
        ...
        if (X.lIIIlIlIIIIII(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var12 = new d(lIlIIIlIll[7], lIlIIIlIll[3], lIlIIIlIll[5]);
            bp.add((d)var12);
            0;
        }
        if (X.lIIIlIlIIIIII(Bank.contains((Predicate)(var12 = item -> item.getName().toLowerCase().contains(lIlIIIlIII[lIlIIIlIll[77]]))) ? 1 : 0)) {
            var3 = new d(lIlIIIlIll[64], lIlIIIlIll[13], lIlIIIlIll[65]);
            bp.add(var3);
            0;
        }
        ...
        if (X.lIIIlIlIIIIII(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var3 = new d(lIlIIIlIll[66], lIlIIIlIll[67], lIlIIIlIll[68]);
            bp.add(var3);
            0;
        }
    }
        ...
        block44: {
            ...
            block45: {
                ...
                if (X.lIIIlIlIIIIII(X.al() ? 1 : 0) && X.lIIIlIIllllll(Game.getWildyLevel(), lIlIIIlIll[2])) {
                    ...
                    if (X.lIIIlIlIIIIIl(var7) && X.lIIIlIlIIIIII(var7.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderShamans.c = lIlIIIlIII[lIlIIIlIll[3]];
                        a.a((BankLocation)var7);
                    }
                    if (X.lIIIlIlIIIIIl(var7) && X.lIIIlIIlllllI(var7.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (X.lIIIlIlIIIIlI(Game.getWildyLevel())) {
                        ...
                        if (X.lIIIlIIlllllI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (X.lIIIlIlIIIlIl(Players.getLocal().getWorldLocation().distanceTo(kN), lIlIIIlIll[20])) {
                                ...
                                var25 = TileObjects.getNearest((String[])stringArray2);
                                String[] stringArray3 = new String[lIlIIIlIll[2]];
                                stringArray3[X.lIlIIIlIll[1]] = lIlIIIlIII[lIlIIIlIll[46]];
                                if (X.lIIIlIIlllllI(var25.hasAction(stringArray3) ? 1 : 0)) {
                                    var25.interact(lIlIIIlIII[lIlIIIlIll[47]]);
                                }
                                if (X.lIIIlIlIIIIIl(var7)) {
                                    String[] stringArray4 = new String[lIlIIIlIll[2]];
                                    stringArray4[X.lIlIIIlIll[1]] = lIlIIIlIII[lIlIIIlIll[48]];
                                    if (X.lIIIlIlIIIIII(var25.hasAction(stringArray4) ? 1 : 0)) {
                                ...
                                if (X.lIIIlIlIIIlIl(Players.getLocal().getWorldLocation().distanceTo(kN), lIlIIIlIll[20])) {
                                    ...
                                    if (X.lIIIlIlIIIIIl(var7)) {
                                        ...
                                        if (X.lIIIlIlIIIIII(var25.hasAction(stringArray8) ? 1 : 0)) {
                                            ...
                                            if (X.lIIIlIIlllllI(Dialog.isOpen() ? 1 : 0) && X.lIIIlIlIIIIII((var14 = Dialog.getOptions()).isEmpty() ? 1 : 0)) {
                                                int var18 = lIlIIIlIll[1];
                                                while (X.lIIIlIIllllll(var18, var14.size())) {
                                                    int[] nArray7 = new int[lIlIIIlIll[2]];
                                                    nArray7[X.lIlIIIlIll[1]] = lIlIIIlIll[50];
                                                    if (X.lIIIlIlIIIlII(((Item)Inventory.getAll((int[])nArray7).get(lIlIIIlIll[1])).getQuantity(), lIlIIIlIll[2]) && X.lIIIlIIlllllI(((Widget)var14.get(var18)).getText().contains(lIlIIIlIII[lIlIIIlIll[57]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)var14.get(var18)).getClickPoint().getX(), (int)((Widget)var14.get(var18)).getClickPoint().getY(), (boolean)lIlIIIlIll[2]);
                                                        Time.sleepTicks((int)lIlIIIlIll[3]);
                                                        0;
                                                    }
                                                    int[] nArray8 = new int[lIlIIIlIll[2]];
                                                    nArray8[X.lIlIIIlIll[1]] = lIlIIIlIll[50];
                                                    if (X.lIIIlIlIIIlII(((Item)Inventory.getAll((int[])nArray8).get(lIlIIIlIll[1])).getQuantity(), lIlIIIlIll[13]) && X.lIIIlIIlllllI(((Widget)var14.get(var18)).getText().contains(lIlIIIlIII[lIlIIIlIll[58]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)var14.get(var18)).getClickPoint().getX(), (int)((Widget)var14.get(var18)).getClickPoint().getY(), (boolean)lIlIIIlIll[2]);
                                                        Time.sleepTicks((int)lIlIIIlIll[3]);
                                                        0;
                                                    }
                                                    if (X.lIIIlIIlllllI(((Widget)var14.get(var18)).getText().contains(lIlIIIlIII[lIlIIIlIll[59]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)var14.get(var18)).getClickPoint().getX(), (int)((Widget)var14.get(var18)).getClickPoint().getY(), (boolean)lIlIIIlIll[2]);
                                                        Time.sleepTicks((int)lIlIIIlIll[3]);
                                                        0;
                                                    }
            ...
            if (X.lIIIlIlIIIlIl(Players.getLocal().getWorldLocation().distanceTo(kN), lIlIIIlIll[20])) {
                ...
                if (X.lIIIlIlIIIIIl(var7)) {
                    var7.interact(lIlIIIlIII[lIlIIIlIll[62]]);
                }
            }
        }
    }
    ...
    private static String lIIIlIIlIllll(String var20, String var17) {
        ...
        int var11 = lIlIIIlIll[1];
        char[] var5 = var20.toCharArray();
        int var22 = var5.length;
        int var2 = lIlIIIlIll[1];
        while (X.lIIIlIIllllll(var2, var22)) {
            char var23 = var5[var2];
            var8.append((char)(var23 ^ var21[var11 % var21.length]));
            0;
            ++var11;
            ++var2;
            0;
    ...
    private static String lIIIlIIllIIII(String var1, String var9) {
        try {
    ...
    private static String lIIIlIIlIlllI(String var10, String var6) {
        try {
            SecretKeySpec var15 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var6.getBytes(StandardCharsets.UTF_8)), lIlIIIlIll[18]), "DES");
            Cipher var24 = Cipher.getInstance("DES");
            var24.init(lIlIIIlIll[3], var15);
