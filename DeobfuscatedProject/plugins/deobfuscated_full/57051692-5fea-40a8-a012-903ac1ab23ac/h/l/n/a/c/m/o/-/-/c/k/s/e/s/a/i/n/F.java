...
implements K {
    ...
    private static boolean al() {
        ...
        int[] nArray2 = nArray;
        int var21 = lIlIIlIllI[1];
        while (F.lIIIllIIIllIl(var21, ((void)var9).length)) {
            int[] nArray3 = new int[lIlIIlIllI[0]];
            nArray3[F.lIlIIlIllI[1]] = var9[var21];
    ...
    private static String lIIIllIIIIlII(String var17, String var24) {
        var17 = new String(Base64.getDecoder().decode(var17.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var15 = new StringBuilder();
        char[] var18 = var24.toCharArray();
        int var26 = lIlIIlIllI[1];
        char[] var32 = var17.toCharArray();
        int var4 = var32.length;
        int var20 = lIlIIlIllI[1];
        while (F.lIIIllIIIllIl(var20, var4)) {
            char var30 = var32[var20];
            var15.append((char)(var30 ^ var18[var26 % var18.length]));
            0;
            ++var26;
            ++var20;
            0;
    ...
    private static void O() {
        block14: {
                ...
                block12: {
                    block11: {
                        ...
                        if (F.lIIIllIIIlllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                            var1 = new d(lIlIIlIllI[7], lIlIIlIllI[0], lIlIIlIllI[175]);
                            bp.add((d)var1);
                            0;
                        }
                        int[] nArray3 = new int[lIlIIlIllI[0]];
                        ...
                        if (F.lIIIllIIIlllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
                            var1 = new d(lIlIIlIllI[9], lIlIIlIllI[0], lIlIIlIllI[175]);
                            bp.add((d)var1);
                            0;
                        }
                        if (F.lIIIllIIIlllI(Bank.contains((Predicate)(var1 = item -> item.getName().toLowerCase().contains(lIlIIlIlII[lIlIIlIllI[181]]))) ? 1 : 0)) {
                            var35 = new d(lIlIIlIllI[176], lIlIIlIllI[14], lIlIIlIllI[177]);
                            bp.add(var35);
                            0;
                        }
                        ...
                        if (F.lIIIllIIIlllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
                            var35 = new d(lIlIIlIllI[12], lIlIIlIllI[4], j.bZ);
                            bp.add(var35);
                            0;
                        }
                    ...
                    var35 = new d(lIlIIlIllI[13], lIlIIlIllI[10], lIlIIlIllI[178]);
                    bp.add(var35);
                    0;
                }
                int[] nArray = new int[lIlIIlIllI[0]];
            ...
            var35 = new d(lIlIIlIllI[5], lIlIIlIllI[57], lIlIIlIllI[179]);
            bp.add(var35);
            0;
        }
    }

    private static String lIIIllIIIIIll(String var13, String var6) {
        try {
            SecretKeySpec var25 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var6.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var16 = Cipher.getInstance("Blowfish");
            var16.init(lIlIIlIllI[3], var25);
        ...
        block134: {
            ...
            block135: {
                ...
                block137: {
                    block136: {
                        ...
                        if (F.lIIIllIIIlllI(F.al() ? 1 : 0) && F.lIIIllIIIllIl(e.j(iK), lIlIIlIllI[0])) {
                            var28 = BankLocation.getNearest();
                            if (F.lIIIllIIIllll(var28) && F.lIIIllIIIlllI(var28.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                AccBuilderShamans.c = lIlIIlIlII[lIlIIlIllI[0]];
                                a.a(var28);
                            }
                            if (F.lIIIllIIIllll(var28) && F.lIIIllIIIllII(var28.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (F.lIIIllIIIlllI(Inventory.contains((int[])nArray4) ? 1 : 0)) {
                            ...
                            if (F.lIIIllIIIlllI(Inventory.contains((int[])nArray5) ? 1 : 0)) {
                                ...
                                if (F.lIIIllIIIlllI(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                                    var28 = new WorldPoint(lIlIIlIllI[21], lIlIIlIllI[22], lIlIIlIllI[0]);
                                    int[] nArray6 = new int[lIlIIlIllI[0]];
                                    nArray6[F.lIlIIlIllI[1]] = lIlIIlIllI[11];
                                    if (F.lIIIllIIIlllI(Inventory.contains((int[])nArray6) ? 1 : 0)) {
                                        if (F.lIIIllIIlIIlI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var28), lIlIIlIllI[14])) {
                                        ...
                                        if (F.lIIIllIIlIIll(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var28), lIlIIlIllI[14])) {
                                            int[] nArray7 = new int[lIlIIlIllI[0]];
                                            nArray7[F.lIlIIlIllI[1]] = lIlIIlIllI[11];
                                            var5 = TileItems.getNearest((int[])nArray7);
                                            if (F.lIIIllIIIllll(var5)) {
                                                if (F.lIIIllIIIlllI(Reachable.isInteractable((Locatable)var5) ? 1 : 0)) {
                                                ...
                                                if (F.lIIIllIIIllII(Reachable.isInteractable((Locatable)var5) ? 1 : 0)) {
                                                    AccBuilderShamans.c = lIlIIlIlII[lIlIIlIllI[24]];
                                                    var5.interact(lIlIIlIlII[lIlIIlIllI[25]]);
                ...
                if (F.lIIIllIIIllII(Inventory.contains((String[])stringArray7) ? 1 : 0)) {
                    ...
                    if (F.lIIIllIIIllII(Inventory.contains((String[])stringArray8) ? 1 : 0)) {
                        ...
                        if (F.lIIIllIIIlllI(Inventory.contains((String[])stringArray9) ? 1 : 0)) {
                            var28 = new WorldPoint(lIlIIlIllI[43], lIlIIlIllI[44], lIlIIlIllI[1]);
                            var5 = new WorldPoint(lIlIIlIllI[21], lIlIIlIllI[44], lIlIIlIllI[1]);
                            var34 = new WorldArea(lIlIIlIllI[21], lIlIIlIllI[45], lIlIIlIllI[14], lIlIIlIllI[8], lIlIIlIllI[1]);
                            if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var28) ? 1 : 0) && F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var5) ? 1 : 0) && F.lIIIllIIIlllI(var34.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            if (F.lIIIllIIIllII(Players.getLocal().getWorldLocation().equals((Object)var28) ? 1 : 0)) {
                            ...
                            if (F.lIIIllIIIllII(var34.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (F.lIIIllIIIllII(Inventory.contains((String[])stringArray12) ? 1 : 0)) {
                    ...
                    if (F.lIIIllIIIlllI(Inventory.contains((String[])stringArray13) ? 1 : 0)) {
                        var28 = new WorldArea(lIlIIlIllI[21], lIlIIlIllI[45], lIlIIlIllI[14], lIlIIlIllI[8], lIlIIlIllI[1]);
                        var5 = new WorldArea(lIlIIlIllI[54], lIlIIlIllI[55], lIlIIlIllI[18], lIlIIlIllI[23], lIlIIlIllI[1]);
                        if (F.lIIIllIIIllII(var28.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (F.lIIIllIIIlllI(var5.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && F.lIIIllIIIlllI(iL.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (F.lIIIllIIIllII(var5.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (F.lIIIllIIIllII(iL.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            WorldPoint var14;
                            WorldPoint var10;
                            var34 = new WorldPoint(lIlIIlIllI[21], lIlIIlIllI[61], lIlIIlIllI[1]);
                            WorldPoint var27 = new WorldPoint(lIlIIlIllI[62], lIlIIlIllI[63], lIlIIlIllI[1]);
                            ...
                            WorldPoint var3 = new WorldPoint(lIlIIlIllI[67], lIlIIlIllI[66], lIlIIlIllI[1]);
                            WorldPoint var22 = new WorldPoint(lIlIIlIllI[67], lIlIIlIllI[66], lIlIIlIllI[1]);
                            WorldArea var23 = new WorldArea(lIlIIlIllI[68], lIlIIlIllI[69], lIlIIlIllI[20], lIlIIlIllI[23], lIlIIlIllI[1]);
                            WorldArea var29 = new WorldArea(lIlIIlIllI[70], lIlIIlIllI[71], lIlIIlIllI[14], lIlIIlIllI[17], lIlIIlIllI[1]);
                            WorldArea var8 = new WorldArea(lIlIIlIllI[72], lIlIIlIllI[73], lIlIIlIllI[32], lIlIIlIllI[25], lIlIIlIllI[1]);
                            if (F.lIIIllIIlIlIl(Vars.getBit((int)lIlIIlIllI[74]), lIlIIlIllI[0]) && F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[75]))) {
                                if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var34) ? 1 : 0)) {
                                ...
                                if (F.lIIIllIIIllII(Players.getLocal().getWorldLocation().equals((Object)var34) ? 1 : 0)) {
                            ...
                            if (F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[74]), lIlIIlIllI[0]) && F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[80])) && F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[75]))) {
                                if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var27) ? 1 : 0)) {
                                ...
                                if (F.lIIIllIIIllII(Players.getLocal().getWorldLocation().equals((Object)var27) ? 1 : 0)) {
                            ...
                            if (F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[74]), lIlIIlIllI[0]) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[80]), lIlIIlIllI[0]) && F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[75]))) {
                                if (F.lIIIllIIIlllI(var23.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    var10 = new WorldPoint(lIlIIlIllI[21], lIlIIlIllI[84], lIlIIlIllI[1]);
                                    if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var10) ? 1 : 0)) {
                                    ...
                                    if (F.lIIIllIIIllII(Players.getLocal().getWorldLocation().equals((Object)var10) ? 1 : 0)) {
                                ...
                                if (F.lIIIllIIIllII(var23.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            if (F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[74]), lIlIIlIllI[0]) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[80]), lIlIIlIllI[0]) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[75]), lIlIIlIllI[0])) {
                                if (F.lIIIllIIIllII(var23.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    var10 = new WorldPoint(lIlIIlIllI[21], lIlIIlIllI[91], lIlIIlIllI[1]);
                                    if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var10) ? 1 : 0)) {
                            ...
                            if (F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[74])) && F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[80])) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[75]), lIlIIlIllI[0]) && F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[103])) && F.lIIIllIIIlllI(F.cf() ? 1 : 0)) {
                                if (F.lIIIllIIIlllI(var29.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    if (F.lIIIllIIIllII(var8.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                        var10 = new WorldPoint(lIlIIlIllI[104], lIlIIlIllI[84], lIlIIlIllI[1]);
                                        if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var10) ? 1 : 0)) {
                                    ...
                                    if (F.lIIIllIIIllII((var10 = new WorldArea(lIlIIlIllI[72], lIlIIlIllI[69], lIlIIlIllI[14], lIlIIlIllI[14], lIlIIlIllI[1])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && F.lIIIllIIIlllI(F.cf() ? 1 : 0)) {
                                        var14 = new WorldPoint(lIlIIlIllI[108], lIlIIlIllI[109], lIlIIlIllI[1]);
                                        if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var14) ? 1 : 0)) {
                                        ...
                                        if (F.lIIIllIIIllII(Players.getLocal().getWorldLocation().equals((Object)var14) ? 1 : 0)) {
                                    ...
                                    if (F.lIIIllIIIllII((var14 = new WorldArea(lIlIIlIllI[70], lIlIIlIllI[69], lIlIIlIllI[14], lIlIIlIllI[14], lIlIIlIllI[1])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                        var31 = new WorldPoint(lIlIIlIllI[67], lIlIIlIllI[113], lIlIIlIllI[1]);
                                        if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var31) ? 1 : 0)) {
                                        ...
                                        if (F.lIIIllIIIllII(Players.getLocal().getWorldLocation().equals((Object)var31) ? 1 : 0)) {
                                ...
                                if (F.lIIIllIIIllII(var29.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && F.lIIIllIIIlllI(F.cf() ? 1 : 0)) {
                                    if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var3) ? 1 : 0)) {
                                    ...
                                    if (F.lIIIllIIIllII(Players.getLocal().getWorldLocation().equals((Object)var3) ? 1 : 0)) {
                            ...
                            if (F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[74])) && F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[80])) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[75]), lIlIIlIllI[0]) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[103]), lIlIIlIllI[0]) && F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[121]))) {
                                if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var22) ? 1 : 0)) {
                                ...
                                if (F.lIIIllIIIllII(Players.getLocal().getWorldLocation().equals((Object)var22) ? 1 : 0)) {
                            ...
                            if (F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[74])) && F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[80])) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[75]), lIlIIlIllI[0]) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[103]), lIlIIlIllI[0]) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[121]), lIlIIlIllI[0]) && F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[126]))) {
                                var10 = new WorldArea(lIlIIlIllI[72], lIlIIlIllI[71], lIlIIlIllI[14], lIlIIlIllI[14], lIlIIlIllI[1]);
                                if (F.lIIIllIIIllII(var29.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    var14 = new WorldPoint(lIlIIlIllI[127], lIlIIlIllI[66], lIlIIlIllI[1]);
                                    if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var14) ? 1 : 0)) {
                                ...
                                if (F.lIIIllIIIllII(var10.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    var14 = new WorldPoint(lIlIIlIllI[131], lIlIIlIllI[66], lIlIIlIllI[1]);
                                    if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var14) ? 1 : 0)) {
                            ...
                            if (F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[74])) && F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[80])) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[75]), lIlIIlIllI[0]) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[103]), lIlIIlIllI[0]) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[121]), lIlIIlIllI[0]) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[126]), lIlIIlIllI[0])) {
                                var10 = new WorldArea(lIlIIlIllI[72], lIlIIlIllI[71], lIlIIlIllI[14], lIlIIlIllI[14], lIlIIlIllI[1]);
                                if (F.lIIIllIIIllII(var23.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    var14 = new WorldPoint(lIlIIlIllI[138], lIlIIlIllI[66], lIlIIlIllI[1]);
                                    if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var14) ? 1 : 0)) {
                                ...
                                if (F.lIIIllIIIllII(var10.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    var14 = new WorldPoint(lIlIIlIllI[108], lIlIIlIllI[66], lIlIIlIllI[1]);
                                    if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var14) ? 1 : 0)) {
                            ...
                            if (F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[74])) && F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[80])) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[75]), lIlIIlIllI[0]) && F.lIIIllIIIlllI(Vars.getBit((int)lIlIIlIllI[103])) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[121]), lIlIIlIllI[0]) && F.lIIIllIIlIlII(Vars.getBit((int)lIlIIlIllI[126]), lIlIIlIllI[0])) {
                                ...
                                if (F.lIIIllIIIllII(var10.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    var14 = new WorldPoint(lIlIIlIllI[104], lIlIIlIllI[152], lIlIIlIllI[1]);
                                    if (F.lIIIllIIIlllI(Players.getLocal().getWorldLocation().equals((Object)var14) ? 1 : 0)) {
                                ...
                                if (F.lIIIllIIIllII((var14 = new WorldArea(lIlIIlIllI[72], lIlIIlIllI[69], lIlIIlIllI[14], lIlIIlIllI[14], lIlIIlIllI[1])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && F.lIIIllIIIlllI(Players.getLocal().isMoving() ? 1 : 0)) {
                                ...
                                if (F.lIIIllIIIllII((var31 = new WorldArea(lIlIIlIllI[161], lIlIIlIllI[162], lIlIIlIllI[23], lIlIIlIllI[14], lIlIIlIllI[1])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (F.lIIIllIIIllII(Inventory.contains((String[])stringArray38) ? 1 : 0)) {
                    ...
                    if (F.lIIIllIIIllII(Inventory.contains((String[])stringArray39) ? 1 : 0)) {
                        var28 = new WorldArea(lIlIIlIllI[161], lIlIIlIllI[162], lIlIIlIllI[23], lIlIIlIllI[14], lIlIIlIllI[1]);
                        if (F.lIIIllIIIllII(var28.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            int[] nArray = new int[lIlIIlIllI[0]];
                            nArray[F.lIlIIlIllI[1]] = lIlIIlIllI[159];
                        ...
                        if (F.lIIIllIIlIIll(Players.getLocal().getWorldLocation().distanceTo(iJ), lIlIIlIllI[10])) {
                            ...
                            if (F.lIIIllIIIllll(var5)) {
                                var5.interact(lIlIIlIlII[lIlIIlIllI[170]]);
                                Time.sleepTicks((int)lIlIIlIllI[8]);
                                0;
                            }
                            if (F.lIIIllIIlIllI(var5)) {
            ...
            if (F.lIIIllIIlIlII(e.j(iK), lIlIIlIllI[3])) {
                ...
                if (F.lIIIllIIlIIll(Players.getLocal().getWorldLocation().distanceTo(iJ), lIlIIlIllI[10])) {
                    ...
                    if (F.lIIIllIIIllll(var28)) {
                        var28.interact(lIlIIlIlII[lIlIIlIllI[173]]);
                        Time.sleepTicks((int)lIlIIlIllI[8]);
                        0;
                    }
                    if (F.lIIIllIIlIllI(var28)) {
    ...
    private static String lIIIllIIIIIlI(String var12, String var11) {
        try {
            SecretKeySpec var7 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var11.getBytes(StandardCharsets.UTF_8)), lIlIIlIllI[16]), "DES");
            Cipher var33 = Cipher.getInstance("DES");
            var33.init(lIlIIlIllI[3], var7);
            return new String(var33.doFinal(Base64.getDecoder().decode(var12.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
