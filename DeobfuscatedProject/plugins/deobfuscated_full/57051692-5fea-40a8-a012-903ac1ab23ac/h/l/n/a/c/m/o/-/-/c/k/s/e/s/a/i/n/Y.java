...
implements K {
    ...
    private static String lIIllIIlllIIl(String var20, String var22) {
        try {
                            ...
                            block31: {
                                block30: {
                                    block28: {
                                        ...
                                        if (Y.lIIllIlIIIIIl(var16 = BankLocation.getNearest()) && Y.lIIllIIllllll(var16.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                            AccBuilderShamans.c = lIllIllIIl[lIllIllIlI[3]];
                                            a.a(var16);
                                        }
                                        if (!Y.lIIllIlIIIIIl(var16) || !Y.lIIllIIllllIl(var16.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block27;
                ...
                if (Y.lIIllIIllllll(Inventory.isFull() ? 1 : 0)) {
                    if (Y.lIIllIIlllllI(Skills.getLevel((Skill)Skill.WOODCUTTING), lIllIllIlI[15])) {
                        ...
                        if (Y.lIIllIIllllIl(kY.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            var16 = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (int[])lb);
                            if (Y.lIIllIIllllll(Players.getLocal().isAnimating() ? 1 : 0) && Y.lIIllIIllllll(Players.getLocal().isMoving() ? 1 : 0) && Y.lIIllIlIIIIIl(var16)) {
                                System.out.println(lIllIllIIl[lIllIllIlI[18]]);
                                var16.interact(lIllIllIIl[lIllIllIlI[19]]);
                    ...
                    if (Y.lIIllIlIIIIlI(Skills.getLevel((Skill)Skill.WOODCUTTING), lIllIllIlI[15])) {
                        ...
                        if (Y.lIIllIIllllIl(kZ.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            var16 = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (int[])lc);
                            if (Y.lIIllIIllllll(Players.getLocal().isAnimating() ? 1 : 0) && Y.lIIllIIllllll(Players.getLocal().isMoving() ? 1 : 0) && Y.lIIllIlIIIIIl(var16)) {
                                System.out.println(lIllIllIIl[lIllIllIlI[22]]);
                                var16.interact(lIllIllIIl[lIllIllIlI[15]]);
                                Time.sleepTicks((int)lIllIllIlI[4]);
                                0;
                            }
                        }
    ...
    private static String lIIllIIlllIII(String var6, String var18) {
        var6 = new String(Base64.getDecoder().decode(var6.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var11 = new StringBuilder();
        char[] var1 = var18.toCharArray();
        int var2 = lIllIllIlI[0];
        char[] var3 = var6.toCharArray();
        int var9 = var3.length;
        int var4 = lIllIllIlI[0];
        while (Y.lIIllIIlllllI(var4, var9)) {
            char var12 = var3[var4];
            var11.append((char)(var12 ^ var1[var2 % var1.length]));
            0;
            ++var2;
            ++var4;
            0;
    ...
    public static void O() {
        ...
        if (Y.lIIllIIllllll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var13 = new d(lIllIllIlI[8], lIllIllIlI[1], lIllIllIlI[5]);
            bp.add((d)var13);
            0;
        }
        int[] nArray3 = new int[lIllIllIlI[1]];
        ...
        if (Y.lIIllIIllllll(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var13 = new d(lIllIllIlI[9], lIllIllIlI[1], lIllIllIlI[26]);
            bp.add((d)var13);
            0;
        }
        int[] nArray4 = new int[lIllIllIlI[1]];
        ...
        if (Y.lIIllIIllllll(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var13 = new d(lIllIllIlI[10], lIllIllIlI[1], lIllIllIlI[27]);
            bp.add((d)var13);
            0;
        }
        int[] nArray5 = new int[lIllIllIlI[1]];
        ...
        if (Y.lIIllIIllllll(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var13 = new d(lIllIllIlI[11], lIllIllIlI[1], lIllIllIlI[28]);
            bp.add((d)var13);
            0;
        }
        if (Y.lIIllIIllllll(Bank.contains((Predicate)(var13 = item -> item.getName().toLowerCase().contains(lIllIllIIl[lIllIllIlI[36]]))) ? 1 : 0)) {
            var21 = new d(lIllIllIlI[29], lIllIllIlI[12], lIllIllIlI[28]);
            bp.add(var21);
            0;
        }
        int[] nArray6 = new int[lIllIllIlI[1]];
        ...
        if (Y.lIIllIIllllll(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var21 = new d(lIllIllIlI[30], lIllIllIlI[31], lIllIllIlI[32]);
            bp.add(var21);
            0;
        }
    }

    private static String lIIllIIlllIlI(String var17, String var10) {
        try {
            SecretKeySpec var15 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var10.getBytes(StandardCharsets.UTF_8)), lIllIllIlI[16]), "DES");
            Cipher var5 = Cipher.getInstance("DES");
            var5.init(lIllIllIlI[3], var15);
