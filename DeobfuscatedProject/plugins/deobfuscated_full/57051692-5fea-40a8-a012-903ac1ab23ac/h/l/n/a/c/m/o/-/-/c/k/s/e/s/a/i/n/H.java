...
implements K {
    ...
    public static void cH() {
        ...
        if (H.lIIlllIIIlIII(bn ? 1 : 0)) {
            ...
            if (H.lIIlllIIIlIII(H.al() ? 1 : 0) && H.lIIlllIIIIlll(e.j(lIlllIIIll[2]), lIlllIIIll[0])) {
                ...
                if (H.lIIlllIIIlIIl(var4) && H.lIIlllIIIlIII(var4.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderShamans.c = lIlllIIIIl[lIlllIIIll[0]];
                    a.a((BankLocation)var4);
                }
                if (H.lIIlllIIIlIIl(var4) && H.lIIlllIIIIllI(var4.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (H.lIIlllIIIIllI(Inventory.contains((String[])stringArray2) ? 1 : 0)) {
                    ...
                    if (H.lIIlllIIIlIII(Inventory.contains((String[])stringArray3) ? 1 : 0)) {
                        ...
                        if (H.lIIlllIIIlIII(Inventory.contains((int[])nArray8) ? 1 : 0)) {
                            ...
                            var4 = NPCs.getNearest((String[])stringArray5);
                            lllllllllllllllllllIIIIIIIIIlIll2 = new WorldArea(lIlllIIIll[40], lIlllIIIll[41], lIlllIIIll[14], lIlllIIIll[16], lIlllIIIll[1]);
                            if (!H.lIIlllIIIlIIl(var4) || H.lIIlllIIIlIIl(var4) && H.lIIlllIIIlIII(Reachable.isInteractable((Locatable)var4) ? 1 : 0)) {
                                Movement.walkTo((WorldPoint)jb);
                                0;
                                Time.sleepTicks((int)lIlllIIIll[0]);
                                0;
                            }
                            if (H.lIIlllIIIlIIl(var4)) {
                    ...
                    if (H.lIIlllIIIIllI(Inventory.contains((String[])stringArray7) ? 1 : 0)) {
                        ...
                        if (H.lIIlllIIIlIII(Inventory.contains((String[])stringArray8) ? 1 : 0) && H.lIIlllIIIlIII(je ? 1 : 0)) {
                            ...
                            if (H.lIIlllIIIllIl(Players.getLocal().getWorldLocation().distanceTo(jc), lIlllIIIll[18])) {
                                var4 = new WorldPoint(lIlllIIIll[47], lIlllIIIll[48], lIlllIIIll[1]);
                                lllllllllllllllllllIIIIIIIIIlIll2 = new WorldPoint(lIlllIIIll[47], lIlllIIIll[49], lIlllIIIll[1]);
                                if ((!H.lIIlllIIIlIII(Players.getLocal().getWorldLocation().equals(var4) ? 1 : 0) || H.lIIlllIIIIllI(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllllIIIIIIIIIlIll2) ? 1 : 0)) && H.lIIlllIIIlIII(Players.getLocal().isMoving() ? 1 : 0)) {
                    ...
                    if (H.lIIlllIIIIllI(Inventory.contains((String[])stringArray10) ? 1 : 0)) {
                        ...
                        if (H.lIIlllIIIIllI(Inventory.contains((String[])stringArray11) ? 1 : 0) && H.lIIlllIIIlIII(je ? 1 : 0)) {
                            ...
                            if (H.lIIlllIIIllIl(Players.getLocal().getWorldLocation().distanceTo(iZ), lIlllIIIll[14])) {
                                ...
                                var4 = Dialog.getOptions();
                                if (H.lIIlllIIIlIII(var4.isEmpty() ? 1 : 0)) {
                                    int lllllllllllllllllllIIIIIIIIIlIll2 = lIlllIIIll[1];
                                    while (H.lIIlllIIIIlll(lllllllllllllllllllIIIIIIIIIlIll2, var4.size())) {
                                        if (H.lIIlllIIIIllI(((Widget)var4.get(lllllllllllllllllllIIIIIIIIIlIll2)).getText().contains(lIlllIIIIl[lIlllIIIll[57]]) ? 1 : 0)) {
                    ...
                    if (H.lIIlllIIIIllI(Inventory.contains((String[])stringArray12) ? 1 : 0)) {
                        ...
                        if (H.lIIlllIIIIllI(Inventory.contains((String[])stringArray13) ? 1 : 0)) {
                            ...
                            if (H.lIIlllIIIlIII(var4.isEmpty() ? 1 : 0)) {
                                int lllllllllllllllllllIIIIIIIIIlIll2 = lIlllIIIll[1];
                                while (H.lIIlllIIIIlll(lllllllllllllllllllIIIIIIIIIlIll2, var4.size())) {
                                    if (H.lIIlllIIIIllI(((Widget)var4.get(lllllllllllllllllllIIIIIIIIIlIll2)).getText().contains(lIlllIIIIl[lIlllIIIll[62]]) ? 1 : 0)) {
            ...
            if (!H.lIIlllIIIllll(e.j(lIlllIIIll[2]), lIlllIIIll[57]) || H.lIIlllIIIlllI(e.j(lIlllIIIll[2]), lIlllIIIll[58])) {
                ...
                if (H.lIIlllIIIIllI(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    var4 = new WorldArea(lIlllIIIll[71], lIlllIIIll[72], lIlllIIIll[24], lIlllIIIll[18], lIlllIIIll[1]);
                    g.a(cy);
                    if (H.lIIlllIIIlIII(var4.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (H.lIIlllIIIIllI(var4.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (H.lIIlllIIIlllI(e.j(lIlllIIIll[2]), lIlllIIIll[32])) {
                var4 = new WorldArea(lIlllIIIll[71], lIlllIIIll[72], lIlllIIIll[14], lIlllIIIll[5], lIlllIIIll[1]);
                if (H.lIIlllIIIlIII(var4.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (H.lIIlllIIIlllI(e.j(lIlllIIIll[2]), lIlllIIIll[83])) {
                if (H.lIIlllIIIllII(Players.getLocal().getWorldLocation().distanceTo(cV), lIlllIIIll[18])) {
                    WorldArea lllllllllllllllllllIIIIIIIIIlIll2;
                    var4 = new WorldArea(lIlllIIIll[71], lIlllIIIll[72], lIlllIIIll[14], lIlllIIIll[5], lIlllIIIll[1]);
                    if (H.lIIlllIIIIllI(var4.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && H.lIIlllIIIlIII(Equipment.contains((int[])f.aQ) ? 1 : 0)) {
    ...
    private static void O() {
        block22: {
            ...
            block21: {
                ...
                block20: {
                    block19: {
                        ...
                        if (H.lIIlllIIIlIII(Bank.contains((int[])nArray2) ? 1 : 0)) {
                            var8 = new d(lIlllIIIll[26], lIlllIIIll[0], lIlllIIIll[93]);
                            bp.add((d)var8);
                            0;
                        }
                        ...
                        if (H.lIIlllIIIlIII(Bank.contains((int[])nArray3) ? 1 : 0)) {
                            var8 = new d(lIlllIIIll[23], lIlllIIIll[0], lIlllIIIll[93]);
                            bp.add((d)var8);
                            0;
                        }
                        ...
                        if (H.lIIlllIIIlIII(Bank.contains((int[])nArray4) ? 1 : 0)) {
                            var8 = new d(lIlllIIIll[21], lIlllIIIll[0], lIlllIIIll[93]);
                            bp.add((d)var8);
                            0;
                        }
                        int[] nArray5 = new int[lIlllIIIll[0]];
                    ...
                    var8 = new d(lIlllIIIll[6], lIlllIIIll[7], lIlllIIIll[93]);
                    bp.add((d)var8);
                    0;
                }
                int[] nArray = new int[lIlllIIIll[0]];
                ...
                if (H.lIIlllIIIlIII(Bank.contains((int[])nArray) ? 1 : 0)) {
                    var8 = new d(lIlllIIIll[15], lIlllIIIll[0], lIlllIIIll[93]);
                    bp.add((d)var8);
                    0;
                }
                int[] nArray8 = new int[lIlllIIIll[0]];
                ...
                if (H.lIIlllIIIlIII(Bank.contains((int[])nArray8) ? 1 : 0)) {
                    var8 = new d(lIlllIIIll[17], lIlllIIIll[0], lIlllIIIll[93]);
                    bp.add((d)var8);
                    0;
                }
                int[] nArray9 = new int[lIlllIIIll[0]];
                ...
                if (H.lIIlllIIIlIII(Bank.contains((int[])nArray9) ? 1 : 0)) {
                    var8 = new d(lIlllIIIll[19], lIlllIIIll[0], lIlllIIIll[93]);
                    bp.add((d)var8);
                    0;
                }
                int[] nArray10 = new int[lIlllIIIll[0]];
                ...
                if (H.lIIlllIIIlIII(Bank.contains((int[])nArray10) ? 1 : 0)) {
                    var8 = new d(lIlllIIIll[13], lIlllIIIll[0], lIlllIIIll[93]);
                    bp.add((d)var8);
                    0;
                }
                ...
                if (H.lIIlllIIIlIII(Bank.contains((int[])nArray11) ? 1 : 0)) {
                    var8 = new d(lIlllIIIll[12], lIlllIIIll[0], lIlllIIIll[93]);
                    bp.add((d)var8);
                    0;
                }
                ...
                if (H.lIIlllIIIlIII(Bank.contains((int[])nArray12) ? 1 : 0)) {
                    var8 = new d(lIlllIIIll[11], lIlllIIIll[7], lIlllIIIll[93]);
                    bp.add((d)var8);
                    0;
                }
                ...
                if (H.lIIlllIIIlIII(Bank.contains((int[])nArray13) ? 1 : 0)) {
                    var8 = new d(lIlllIIIll[10], lIlllIIIll[0], lIlllIIIll[93]);
                    bp.add((d)var8);
                    0;
                }
                if (H.lIIlllIIIlIII(Bank.contains((Predicate)(var8 = item -> item.getName().toLowerCase().contains(lIlllIIIIl[lIlllIIIll[99]]))) ? 1 : 0)) {
                    var22 = new d(lIlllIIIll[94], lIlllIIIll[14], lIlllIIIll[95]);
                    bp.add(var22);
                    0;
                }
                ...
                if (H.lIIlllIIIlIII(Bank.contains((int[])nArray14) ? 1 : 0)) {
                    var22 = new d(lIlllIIIll[29], lIlllIIIll[5], j.bZ);
                    bp.add(var22);
                    0;
                }
            ...
            var22 = new d(lIlllIIIll[9], lIlllIIIll[67], lIlllIIIll[96]);
            bp.add(var22);
            0;
        }
    }
    ...
    private static String lIIllIlllIlIl(String var2, String var6) {
        var2 = new String(Base64.getDecoder().decode(var2.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var24 = new StringBuilder();
        char[] var11 = var6.toCharArray();
        int var23 = lIlllIIIll[1];
        char[] var9 = var2.toCharArray();
        int var7 = var9.length;
        int var1 = lIlllIIIll[1];
        while (H.lIIlllIIIIlll(var1, var7)) {
            char var17 = var9[var1];
            var24.append((char)(var17 ^ var11[var23 % var11.length]));
            0;
            ++var23;
            ++var1;
            0;
    ...
    private static String lIIllIlllIlII(String var14, String var16) {
        try {
    ...
    private static String lIIllIlllIllI(String var13, String var10) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var10.getBytes(StandardCharsets.UTF_8)), lIlllIIIll[20]), "DES");
            Cipher var15 = Cipher.getInstance("DES");
            var15.init(lIlllIIIll[4], var5);
    ...
    private static boolean al() {
        ...
        int[] nArray2 = nArray;
        int var12 = lIlllIIIll[1];
        while (H.lIIlllIIIIlll(var12, ((void)var18).length)) {
            int[] nArray3 = new int[lIlllIIIll[0]];
            nArray3[H.lIlllIIIll[1]] = var18[var12];
