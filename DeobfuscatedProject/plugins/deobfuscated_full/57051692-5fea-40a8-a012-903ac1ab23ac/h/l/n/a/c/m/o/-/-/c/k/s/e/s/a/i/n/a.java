...
public class a {
    ...
    public static void a() {
        ...
        if (!a.lIIIllllIIIII(BankLocation.GRAND_EXCHANGE_BANK.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || a.lIIIlllIlllll(w.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            TileObject var28 = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (String[])stringArray);
            if (a.lIIIllllIIIlI(var28)) {
                String[] stringArray2 = new String[lIlIlIIIII[1]];
                stringArray2[a.lIlIlIIIII[2]] = lIlIIlllll[lIlIlIIIII[23]];
                if (a.lIIIlllIlllll(var28.hasAction(stringArray2) ? 1 : 0)) {
                    var28.interact(lIlIIlllll[lIlIlIIIII[22]]);
                    Time.sleepTicks((int)lIlIlIIIII[15]);
                    0;
                    Time.sleepUntil(() -> Bank.isOpen(), (int)lIlIlIIIII[30]);
                    0;
                ...
                if (a.lIIIlllIlllll(var28.hasAction(stringArray3) ? 1 : 0)) {
                    var28.interact(lIlIIlllll[lIlIlIIIII[33]]);
                    Time.sleepTicks((int)lIlIlIIIII[15]);
                    0;
                    Time.sleepUntil(() -> Bank.isOpen(), (int)lIlIlIIIII[30]);
                    0;
            ...
            TileObject var28 = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (String[])stringArray);
            if (a.lIIIllllIIIlI(var28)) {
                var28.interact(lIlIIlllll[lIlIlIIIII[35]]);
                Time.sleepTicks((int)lIlIlIIIII[15]);
                0;
                Time.sleepUntil(() -> Bank.isOpen(), (int)lIlIlIIIII[30]);
                0;
    ...
    public static void b(int[] nArray, int n2) {
        int[] var9;
        int var34 = lIlIlIIIII[2];
        while (a.lIIIllllIIlII(var34, var9.length)) {
            void var4;
            Bank.withdraw((int)var9[var34], (int)var4, (Bank.WithdrawMode)Bank.WithdrawMode.DEFAULT);
            Time.sleepTicks((int)lIlIlIIIII[1]);
            0;
            int[] nArray2 = new int[lIlIlIIIII[1]];
            nArray2[a.lIlIlIIIII[2]] = var9[var34];
    ...
    public static void a(int[] nArray) {
        int[] var17;
        int var2 = lIlIlIIIII[2];
        while (a.lIIIllllIIlII(var2, var17.length)) {
            Bank.withdraw((int)var17[var2], (int)lIlIlIIIII[1], (Bank.WithdrawMode)Bank.WithdrawMode.DEFAULT);
            Time.sleepTicks((int)lIlIlIIIII[1]);
            0;
            ++var2;
            0;
    ...
    private static String lIIIlllIllIlI(String var12, String var38) {
        try {
            SecretKeySpec var35 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var38.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var15 = Cipher.getInstance("Blowfish");
            var15.init(lIlIlIIIII[14], var35);
    ...
    public static void a(BankLocation bankLocation) {
        ...
        WorldPoint var3 = new WorldPoint(lIlIlIIIII[3], lIlIlIIIII[4], lIlIlIIIII[2]);
        WorldPoint var21 = new WorldPoint(lIlIlIIIII[5], lIlIlIIIII[6], lIlIlIIIII[2]);
        WorldArea var37 = new WorldArea(lIlIlIIIII[7], lIlIlIIIII[8], lIlIlIIIII[9], lIlIlIIIII[10], lIlIlIIIII[2]);
        if ((!a.lIIIllllIIIII(Players.getLocal().getWorldLocation().equals((Object)var3) ? 1 : 0) || !a.lIIIllllIIIIl(Players.getLocal().getWorldLocation().distanceTo(var21), lIlIlIIIII[11]) || a.lIIIlllIlllll(var37.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) && a.lIIIlllIlllll(Inventory.contains(item -> item.getName().contains(lIlIIlllll[lIlIlIIIII[39]])) ? 1 : 0) && a.lIIIlllIllllI(Players.getLocal().getAnimation(), lIlIlIIIII[12])) {
        ...
        if (!a.lIIIllllIIIIl(Players.getLocal().getWorldLocation().distanceTo(x), lIlIlIIIII[11]) || a.lIIIlllIlllll(z.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            BankLocation var24;
            WorldArea var5;
            WorldArea var13 = new WorldArea(lIlIlIIIII[17], lIlIlIIIII[18], lIlIlIIIII[13], lIlIlIIIII[19], lIlIlIIIII[2]);
            WorldArea var32 = new WorldArea(lIlIlIIIII[20], lIlIlIIIII[21], lIlIlIIIII[22], lIlIlIIIII[23], lIlIlIIIII[2]);
            if ((!a.lIIIllllIIIII(var13.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || a.lIIIlllIlllll(var32.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) && a.lIIIlllIlllll(Inventory.contains(item -> item.getName().contains(lIlIIlllll[lIlIlIIIII[37]])) ? 1 : 0)) {
            ...
            if (a.lIIIlllIlllll((var5 = new WorldArea(lIlIlIIIII[25], lIlIlIIIII[26], lIlIlIIIII[27], lIlIlIIIII[13], lIlIlIIIII[2])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                String[] stringArray = new String[lIlIlIIIII[1]];
                stringArray[a.lIlIlIIIII[2]] = lIlIIlllll[lIlIlIIIII[19]];
                TileObject var10 = TileObjects.getNearest((String[])stringArray);
                if (a.lIIIllllIIIlI(var10)) {
                    var10.interact(lIlIIlllll[lIlIlIIIII[13]]);
                    Time.sleepTicks((int)lIlIlIIIII[24]);
                    0;
                }
            }
            Movement.walkTo((BankLocation)var24);
            0;
            Time.sleepTicks((int)lIlIlIIIII[14]);
            0;
        }
    ...
    public static void a(int[] nArray, int n2) {
        int[] var11;
        int var20 = lIlIlIIIII[2];
        while (a.lIIIllllIIlII(var20, var11.length)) {
            void var8;
            Bank.withdraw((int)var11[var20], (int)var8, (Bank.WithdrawMode)Bank.WithdrawMode.DEFAULT);
            Time.sleepTicks((int)lIlIlIIIII[1]);
            0;
            ++var20;
            0;
    ...
    private static String lIIIlllIllIIl(String var36, String var25) {
        ...
        int var27 = lIlIlIIIII[2];
        char[] var18 = var36.toCharArray();
        int var6 = var18.length;
        int var1 = lIlIlIIIII[2];
        while (a.lIIIllllIIlII(var1, var6)) {
            char var19 = var18[var1];
            var26.append((char)(var19 ^ var16[var27 % var16.length]));
            0;
            ++var27;
            ++var1;
            0;
    ...
    private static String lIIIlllIllIll(String var22, String var14) {
        try {
            SecretKeySpec var23 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var14.getBytes(StandardCharsets.UTF_8)), lIlIlIIIII[29]), "DES");
            Cipher var7 = Cipher.getInstance("DES");
            var7.init(lIlIlIIIII[14], var23);
            return new String(var7.doFinal(Base64.getDecoder().decode(var22.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void a(int n2, int n3) {
        ...
        int[] nArray2 = new int[lIlIlIIIII[1]];
        nArray2[a.lIlIlIIIII[2]] = var30;
        if (a.lIIIlllIlllll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            void var31;
            Bank.withdraw((int)var30, (int)var31, (Bank.WithdrawMode)Bank.WithdrawMode.DEFAULT);
            Time.sleepTicks((int)lIlIlIIIII[1]);
            0;
        }
    }
