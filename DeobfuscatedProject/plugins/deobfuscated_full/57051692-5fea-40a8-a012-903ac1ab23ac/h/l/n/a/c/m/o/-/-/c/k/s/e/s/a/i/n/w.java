...
implements K {
    ...
    private static String lIIIlIllIlIIl(String var13, String var14) {
        var13 = new String(Base64.getDecoder().decode(var13.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var12 = new StringBuilder();
        char[] var9 = var14.toCharArray();
        int var19 = lIlIIlIIlI[2];
        char[] var1 = var13.toCharArray();
        int var11 = var1.length;
        int var20 = lIlIIlIIlI[2];
        while (w.lIIIlIllIllII(var20, var11)) {
            char var22 = var1[var20];
            var12.append((char)(var22 ^ var9[var19 % var9.length]));
            0;
            ++var19;
            ++var20;
            0;
    ...
    private static String lIIIlIllIIlll(String var5, String var17) {
        try {
    ...
    private static void O() {
        ...
        if (w.lIIIlIllIllll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var16 = new d(lIlIIlIIlI[10], lIlIIlIIlI[1], lIlIIlIIlI[4]);
            bp.add((d)var16);
            0;
        }
        ...
        if (w.lIIIlIllIllll(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var16 = new d(lIlIIlIIlI[9], lIlIIlIIlI[1], lIlIIlIIlI[4]);
            bp.add((d)var16);
            0;
        }
        ...
        if (w.lIIIlIllIllll(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var16 = new d(lIlIIlIIlI[14], lIlIIlIIlI[24], lIlIIlIIlI[4]);
            bp.add((d)var16);
            0;
        }
        ...
        if (w.lIIIlIllIllll(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var16 = new d(lIlIIlIIlI[16], lIlIIlIIlI[24], j.bZ);
            bp.add((d)var16);
            0;
        }
        ...
        if (w.lIIIlIllIllll(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var16 = new d(lIlIIlIIlI[11], lIlIIlIIlI[0], lIlIIlIIlI[58]);
            bp.add((d)var16);
            0;
        }
        if (w.lIIIlIllIllll(Bank.contains((Predicate)(var16 = item -> item.getName().toLowerCase().contains(lIlIIlIIIl[lIlIIlIIlI[64]]))) ? 1 : 0)) {
            var21 = new d(lIlIIlIIlI[59], lIlIIlIIlI[13], lIlIIlIIlI[60]);
            bp.add(var21);
            0;
        }
        ...
        if (w.lIIIlIllIllll(Bank.contains((int[])nArray7) ? 1 : 0)) {
            var21 = new d(lIlIIlIIlI[8], lIlIIlIIlI[52], lIlIIlIIlI[61]);
            bp.add(var21);
            0;
        }
    }
            ...
            if (w.lIIIlIllIllll(bn ? 1 : 0)) {
                if (w.lIIIlIllIllll(w.al() ? 1 : 0) && w.lIIIlIllIllII(e.j(dG), lIlIIlIIlI[1])) {
                    ...
                    if (w.lIIIlIllIllll(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                        ...
                        if (w.lIIIlIlllIIII(var15) && w.lIIIlIllIllll(var15.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            AccBuilderShamans.c = lIlIIlIIIl[lIlIIlIIlI[3]];
                            a.a(var15);
                        }
                        if (w.lIIIlIlllIIII(var15) && w.lIIIlIllIlllI(var15.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String lIIIlIllIlIII(String var10, String var3) {
        try {
            SecretKeySpec var6 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var3.getBytes(StandardCharsets.UTF_8)), lIlIIlIIlI[22]), "DES");
            Cipher var8 = Cipher.getInstance("DES");
            var8.init(lIlIIlIIlI[3], var6);
    ...
    private static void lIIIlIllIlIlI() {
        ...
        w.lIlIIlIIIl[w.lIlIIlIIlI[2]] = w."Finished buying items, switching back to quest";
        w.lIlIIlIIIl[w.lIlIIlIIlI[1]] = w."Fishing pass";
        w.lIlIIlIIIl[w.lIlIIlIIlI[3]] = w."Nav to bank";
        w.lIlIIlIIIl[w.lIlIIlIIlI[5]] = w."Handling banking";
        w.lIlIIlIIIl[w.lIlIIlIIlI[6]] = w."We are missing quest supplies, switching to BUYING";
        w.lIlIIlIIIl[w.lIlIIlIIlI[13]] = w."Drink";
        w.lIlIIlIIIl[w.lIlIIlIIlI[15]] = w."Nav to start";
        w.lIlIIlIIIl[w.lIlIIlIIlI[7]] = w."Starting quest";
        w.lIlIIlIIIl[w.lIlIIlIIlI[22]] = w."Vestri";
        w.lIlIIlIIIl[w.lIlIIlIIlI[23]] = w."Fishing trophy";
        w.lIlIIlIIIl[w.lIlIIlIIlI[0]] = w."Red vine worm";
        w.lIlIIlIIIl[w.lIlIIlIIlI[24]] = w."Nav to vine";
        w.lIlIIlIIIl[w.lIlIIlIIlI[21]] = w."Digging";
        w.lIlIIlIIIl[w.lIlIIlIIlI[25]] = w."Red vine worm";
        w.lIlIIlIIIl[w.lIlIIlIIlI[26]] = w."Vine";
        w.lIlIIlIIIl[w.lIlIIlIIlI[27]] = w."Vine";
        w.lIlIIlIIIl[w.lIlIIlIIlI[28]] = w."Check";
        w.lIlIIlIIIl[w.lIlIIlIIlI[29]] = w."Red vine worm";
        w.lIlIIlIIIl[w.lIlIIlIIlI[30]] = w."Nav to contest";
        w.lIlIIlIIIl[w.lIlIIlIIlI[31]] = w."Garlic";
        w.lIlIIlIIIl[w.lIlIIlIIlI[32]] = w."Using garlic";
        w.lIlIIlIIIl[w.lIlIIlIIlI[33]] = w."Wall Pipe";
        w.lIlIIlIIIl[w.lIlIIlIIlI[34]] = w."Wall Pipe";
        w.lIlIIlIIIl[w.lIlIIlIIlI[35]] = w."Garlic";
        w.lIlIIlIIIl[w.lIlIIlIIlI[36]] = w."Wall Pipe";
        w.lIlIIlIIIl[w.lIlIIlIIlI[37]] = w."Garlic";
        w.lIlIIlIIIl[w.lIlIIlIIlI[38]] = w."Start contest";
        w.lIlIIlIIIl[w.lIlIIlIIlI[20]] = w."Bonzo";
        w.lIlIIlIIIl[w.lIlIIlIIlI[39]] = w."I might still be able to find a bigger fish";
        w.lIlIIlIIIl[w.lIlIIlIIlI[40]] = w."Garlic";
        w.lIlIIlIIIl[w.lIlIIlIIlI[41]] = w."Raw giant carp";
        w.lIlIIlIIIl[w.lIlIIlIIlI[42]] = w."Fishing";
        w.lIlIIlIIIl[w.lIlIIlIIlI[44]] = w."Bait";
        w.lIlIIlIIIl[w.lIlIIlIIlI[45]] = w."Raw giant carp";
        w.lIlIIlIIIl[w.lIlIIlIIlI[46]] = w."Handing in fish";
        w.lIlIIlIIIl[w.lIlIIlIIlI[47]] = w."Bonzo";
        w.lIlIIlIIIl[w.lIlIIlIIlI[48]] = w."Fishing trophy";
        w.lIlIIlIIIl[w.lIlIIlIIlI[49]] = w."Nav to start";
        w.lIlIIlIIIl[w.lIlIIlIIlI[50]] = w."Finishing quest";
        w.lIlIIlIIIl[w.lIlIIlIIlI[51]] = w."Vestri";
        w.lIlIIlIIIl[w.lIlIIlIIlI[52]] = w."Camelot teleport";
        w.lIlIIlIIIl[w.lIlIIlIIlI[53]] = w."Garlic";
        w.lIlIIlIIIl[w.lIlIIlIIlI[54]] = w."Spade";
        w.lIlIIlIIIl[w.lIlIIlIIlI[55]] = w."Fishing rod";
        w.lIlIIlIIIl[w.lIlIIlIIlI[56]] = w."Fishing bait";
        w.lIlIIlIIIl[w.lIlIIlIIlI[63]] = w."Fishing contest";
        w.lIlIIlIIIl[w.lIlIIlIIlI[64]] = w."ring of wealth (";
        w.lIlIIlIIIl[w.lIlIIlIIlI[67]] = w."I was wondering what was down those stairs?";
        w.lIlIIlIIIl[w.lIlIIlIIlI[68]] = w."Why not?";
        w.lIlIIlIIIl[w.lIlIIlIIlI[69]] = w."If you were my friend I wouldn't mind it.";
        w.lIlIIlIIIl[w.lIlIIlIIlI[19]] = w."Well, let's be friends!";
        w.lIlIIlIIIl[w.lIlIIlIIlI[70]] = w."And how am I meant to do that?";
        w.lIlIIlIIIl[w.lIlIIlIIlI[71]] = w."I'll enter the competition please.";
        w.lIlIIlIIIl[w.lIlIIlIIlI[72]] = w."I have this big fish. Is it enough to win?";
        w.lIlIIlIIIl[w.lIlIIlIIlI[73]] = w."Yes.";
    }
}
