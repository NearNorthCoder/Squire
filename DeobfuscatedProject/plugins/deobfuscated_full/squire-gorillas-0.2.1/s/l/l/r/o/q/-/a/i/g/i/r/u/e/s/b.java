...
extends Enum<b> {
    ...
    private static String lllllIlIllIlIl(String var13, String var11) {
        try {
            SecretKeySpec var1 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var11.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var16 = Cipher.getInstance("Blowfish");
            var16.init(llIIlIlIllII[6], var1);
    ...
    private static String lllllIlIllIIll(String var18, String var10) {
        var18 = new String(Base64.getDecoder().decode(var18.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var2 = new StringBuilder();
        char[] var9 = var10.toCharArray();
        int var4 = llIIlIlIllII[1];
        char[] var14 = var18.toCharArray();
        int var12 = var14.length;
        int var19 = llIIlIlIllII[1];
        while (b.lllllIlIlllIII(var19, var12)) {
            char var15 = var14[var19];
            var2.append((char)(var15 ^ var9[var4 % var9.length]));
            0;
            ++var4;
            ++var19;
            0;
    ...
    private static String lllllIlIllIlII(String var5, String var8) {
        try {
            SecretKeySpec var6 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var8.getBytes(StandardCharsets.UTF_8)), llIIlIlIllII[10]), "DES");
            Cipher var3 = Cipher.getInstance("DES");
            var3.init(llIIlIlIllII[6], var6);
