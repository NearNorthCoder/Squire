...
extends SquirePlugin {
    ...
    private void a(c c2, d d3) {
        ...
        if (SquireGorillaPlugin.llllllIIIllIlI(var49, (Object)s.l.l.r.o.q.-.a.i.g.i.r.u.e.s.d.BOULDER)) {
            ...
            if (SquireGorillaPlugin.llllllIIIlIllI(var31)) {
                ...
                if (SquireGorillaPlugin.llllllIIIllIlI(var49, (Object)s.l.l.r.o.q.-.a.i.g.i.r.u.e.s.d.MAGIC)) {
                ...
                } else if (SquireGorillaPlugin.llllllIIIllIlI(var49, (Object)s.l.l.r.o.q.-.a.i.g.i.r.u.e.s.d.RANGED) && SquireGorillaPlugin.llllllIIIllIIl(lllllllllllllllIlIIlllIIIIIIlIIl2 = (lllllllllllllllIlIIlllIIIIIIlIlI2 = var39.i.get(var29)).r())) {
                    int var52 = var44.m().getWorldArea().distanceTo(lllllllllllllllIlIIlllIIIIIIlIIl2);
            ...
            if (SquireGorillaPlugin.llllllIIIlIllI(var44.n().isEmpty() ? 1 : 0)) {
                int n3;
                var44.a(Arrays.stream(s.l.l.r.o.q.-.a.i.g.i.r.u.e.s.c.l).filter(arg_0 -> SquireGorillaPlugin.a((d)var49, arg_0)).collect(Collectors.toList()));
    ...
    private void a(c c2, d ... dArray) {
        if (!SquireGorillaPlugin.llllllIIIlIlll(c2.o()) || SquireGorillaPlugin.llllllIIIlIllI(c2.n().isEmpty() ? 1 : 0)) {
            void var12;
            void var40;
            var40.a(Arrays.stream(s.l.l.r.o.q.-.a.i.g.i.r.u.e.s.c.l).filter(arg_0 -> SquireGorillaPlugin.a((d[])var12, arg_0)).collect(Collectors.toList()));
        ...
        while (SquireGorillaPlugin.llllllIIIlIllI(var25.hasNext() ? 1 : 0)) {
            ...
            if (SquireGorillaPlugin.llllllIIIlIllI(var45.v() ? 1 : 0) && SquireGorillaPlugin.llllllIIIlllIl((int)var50, var45.p() + llIIllIIllII[11])) {
                ...
                if (SquireGorillaPlugin.llllllIIIlIlIl(var18, llIIllIIllII[23])) {
                    var47.a(var45, s.l.l.r.o.q.-.a.i.g.i.r.u.e.s.d.MELEE);
                    0;
                    if (-1 >= 1) {
                        return;
                    }
                } else if (SquireGorillaPlugin.llllllIIIlIlIl(var18, llIIllIIllII[24])) {
                    var47.a(var45, s.l.l.r.o.q.-.a.i.g.i.r.u.e.s.d.MAGIC);
                    0;
                    
                    }
                } else if (SquireGorillaPlugin.llllllIIIlIlIl(var18, llIIllIIllII[25])) {
                    var47.a(var45, s.l.l.r.o.q.-.a.i.g.i.r.u.e.s.d.RANGED);
                    0;
                    if (1 < 0) {
                        return;
                    }
                    ...
                    if (SquireGorillaPlugin.llllllIIIllIlI(var45.l(), var45.A())) {
                        var47.a(var45, s.l.l.r.o.q.-.a.i.g.i.r.u.e.s.d.BOULDER);
                        0;
    ...
    private d a(Player player) {
        ...
        switch (s.l.l.r.o.q.-.a.i.g.i.r.u.e.s.a.k[var14.ordinal()]) {
            case 1: {
