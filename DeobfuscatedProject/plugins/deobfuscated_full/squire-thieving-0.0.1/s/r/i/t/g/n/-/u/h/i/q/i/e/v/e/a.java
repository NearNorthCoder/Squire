...
extends Task {
    ...
    private static String lIllIIlIIIIlIIl(String var19, String var23) {
        try {
            SecretKeySpec var15 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var23.getBytes(StandardCharsets.UTF_8)), lIIlllIIIlllI[12]), "DES");
            Cipher var18 = Cipher.getInstance("DES");
            var18.init(lIIlllIIIlllI[6], var15);
    ...
    private static String lIllIIlIIIIlIlI(String var13, String var12) {
        try {
            ...
            var24.init(lIIlllIIIlllI[6], var25);
    ...
    private static String lIllIIlIIIIlIII(String var10, String var4) {
        var10 = new String(Base64.getDecoder().decode(var10.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var14 = new StringBuilder();
        char[] var9 = var4.toCharArray();
        int var20 = lIIlllIIIlllI[0];
        char[] var3 = var10.toCharArray();
        int var2 = var3.length;
        int var1 = lIIlllIIIlllI[0];
        while (a.lIllIIlIllIIlIl(var1, var2)) {
            char var11 = var3[var1];
            var14.append((char)(var11 ^ var9[var20 % var9.length]));
            0;
            ++var20;
            ++var1;
            0;
    ...
    protected void a(NPC nPC) {
        ...
        if (a.lIllIIlIlIlllll(Reachable.isInteractable((Locatable)var5) ? 1 : 0)) {
            a var21;
            if (a.lIllIIlIllIIIlI((Object)var21.p.pickpocketTarget(), (Object)f.VYRE) && a.lIllIIlIllIIIll(var5.getWorldLocation().distanceTo((Locatable)Players.getLocal()), lIIlllIIIlllI[3])) {
                ...
                Iterator var6 = Inventory.getAll((int[])nArray).iterator();
                while (a.lIllIIlIlIlllll(var6.hasNext() ? 1 : 0)) {
                    Item var8 = (Item)var6.next();
                    var8.interact(lIIllIllllllI[lIIlllIIIlllI[0]]);
                    0;
                    if (-(0xB6 ^ 0xB3) < 0) continue;
                    return;
                }
            }
            if (a.lIllIIlIlIlllll(var21.p.gemBag() ? 1 : 0) && a.lIllIIlIlIlllll(var21.o.k() ? 1 : 0)) {
                var21.o.c(lIIlllIIIlllI[0]);
            }
            var5.interact(lIIllIllllllI[lIIlllIIIlllI[2]]);
            0;
    ...
    protected NPC a(f f2) {
        ...
        if (a.lIllIIlIllIIIlI(var7, (Object)f.VYRE)) {
            a var17;
            return var17.n();
        }
