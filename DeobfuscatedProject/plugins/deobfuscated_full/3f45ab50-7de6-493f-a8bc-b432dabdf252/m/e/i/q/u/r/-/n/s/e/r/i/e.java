...
extends Enum<e> {
    ...
    private static String lIIlIlIIIIllIII(String var2, String var9) {
        try {
    ...
    public boolean a(WorldPoint worldPoint) {
        ...
        int var7 = llllllIIIIll[0];
        while (e.lIIlIlIIIIllIll(var7, (int)var1)) {
            void var3;
            void var4;
            void var10 = var4[var7];
            if (e.lIIlIlIIIIlllII(var10.equals((Object)var3) ? 1 : 0)) {
    ...
    private static void lIIlIlIIIIllIIl() {
        ...
        e.llllllIIIIlI[e.llllllIIIIll[0]] = e."WEST_FOUR";
        e.llllllIIIIlI[e.llllllIIIIll[1]] = e."WEST_TWO";
    }
    ...
    private static void lIIlIlIIIIllIlI() {
        ...
        e.llllllIIIIll[0] = (0x1F ^ 0xA ^ (0x1F ^ 0x36)) & (0x83 ^ 0xC4 ^ (0xD2 ^ 0xA9) ^ -1);
        e.llllllIIIIll[1] = 1;
