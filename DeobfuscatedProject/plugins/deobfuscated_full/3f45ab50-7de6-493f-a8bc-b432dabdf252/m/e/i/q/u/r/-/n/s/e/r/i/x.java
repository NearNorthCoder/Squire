...
/* TASK: Mining amethyst -> MiningamethystTask */
...
extends Task {
    ...
    private static void lIIlIIlIIIlllll() {
        ...
        x.lllllIIIIlII[x.lllllIIIIlIl[0]] = x."Mine";
    }
    ...
    private static String lIIlIIlIIIllllI(String var5, String var4) {
        try {
            SecretKeySpec var6 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var4.getBytes(StandardCharsets.UTF_8)), lllllIIIIlIl[1]), "DES");
            Cipher var1 = Cipher.getInstance("DES");
            var1.init(lllllIIIIlIl[11], var6);
    ...
    public boolean run() {
        ...
        if (x.lIIlIIlIIlIIIlI(Players.getLocal().isAnimating() ? 1 : 0)) {
            x var2;
            var2.sleep(Rand.nextInt((int)lllllIIIIlIl[1], (int)lllllIIIIlIl[2]));
            return lllllIIIIlIl[0];
        }
        ...
        if (x.lIIlIIlIIlIIlII(var7 = TileObjects.getNearest((WorldPoint)(var8 = worldPoint), tileObject -> {
            int n2;
