...
/* TASK: Moving towards Shantay -> MovingtowardsshantayTask */
...
extends S {
    ...
    private static void lIIlIlIIllIIIll() {
        ...
        R.llllllIllIIl[R.llllllIllIlI[0]] = R."Go-through";
    }
    ...
    private static void lIIlIlIIllIIlII() {
        ...
        R.llllllIllIlI[0] = (1 ^ 0x6D ^ (0xE5 ^ 0x90)) & (155 + 5 - 156 + 178 ^ 83 + 146 - 144 + 90 ^ -1);
        R.llllllIllIlI[1] = 1;
    ...
    private static String lIIlIlIIllIIIlI(String var4, String var6) {
        try {
