...
/* TASK: Depositing ores -> DepositingoresTask */
...
extends C {
    ...
    private static String lIIlIIllIIlIllI(String var3, String var4) {
        try {
            SecretKeySpec var1 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var4.getBytes(StandardCharsets.UTF_8)), lllllIlIlIII[17]), "DES");
            Cipher var5 = Cipher.getInstance("DES");
            var5.init(lllllIlIlIII[5], var1);
    ...
    public boolean t() {
        ...
        if (G.lIIlIIllIlIlIII(Inventory.contains(item -> T.av.contains(item.getId())) ? 1 : 0)) {
            if (G.lIIlIIllIlIlIII(var2.Z.D())) {
                var2.Z.a(lllllIlIlIII[1]);
            }
            return lllllIlIlIII[1];
        }
        ...
        if (G.lIIlIIllIlIlIIl(DepositBox.isOpen() ? 1 : 0)) {
            DepositBox.depositAllItems((int[])var2.ad);
            return lllllIlIlIII[3];
        }
        ...
        if (G.lIIlIIllIlIlIlI(var7)) {
            return lllllIlIlIII[1];
        }
        if (G.lIIlIIllIlIlIII(Reachable.isInteractable((Locatable)var7) ? 1 : 0)) {
            Movement.walkTo((Locatable)var7);
            0;
            return lllllIlIlIII[3];
        }
        if (G.lIIlIIllIlIlIIl(Movement.shouldWalk() ? 1 : 0)) {
            var7.interact(lllllIlIIIll[lllllIlIlIII[1]]);
        }
        return lllllIlIlIII[3];
    }
