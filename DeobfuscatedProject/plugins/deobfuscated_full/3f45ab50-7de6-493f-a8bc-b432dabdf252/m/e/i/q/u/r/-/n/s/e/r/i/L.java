...
/* TASK: Mining (Superheat) -> Mining(Superheat)Task */
...
extends Task {
    ...
    private static String lIIlIIlIlIIlllI(String var4, String var1) {
        try {
            SecretKeySpec var20 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var1.getBytes(StandardCharsets.UTF_8)), lllllIIlIIIl[20]), "DES");
            Cipher var22 = Cipher.getInstance("DES");
            var22.init(lllllIIlIIIl[5], var20);
    ...
    private static String lIIlIIlIlIIllIl(String var15, String var16) {
        ...
        int var19 = lllllIIlIIIl[1];
        char[] var23 = var15.toCharArray();
        int var8 = var23.length;
        int var18 = lllllIIlIIIl[1];
        while (L.lIIlIIlIlIllIIl(var18, var8)) {
            char var12 = var23[var18];
            var26.append((char)(var12 ^ var9[var19 % var9.length]));
            0;
            ++var19;
            ++var18;
            0;
    ...
    private static String lIIlIIlIlIIllII(String var17, String var13) {
        try {
            ...
            var25.init(lllllIIlIIIl[5], var7);
    ...
    public boolean run() {
        ...
        if (!L.lIIlIIlIlIlIIll(var14) || L.lIIlIIlIlIlIlII(var14.distanceTo(var5.getWorldLocation()), lllllIIlIIIl[9])) {
            Item var10 = Equipment.getFirst(item -> item.getName().contains(lllllIIlIIII[lllllIIlIIIl[20]]));
            if (L.lIIlIIlIlIlIlIl(var10)) {
                var10 = Inventory.getFirst(item -> item.getName().contains(lllllIIlIIII[lllllIIlIIIl[19]]));
            }
            if (L.lIIlIIlIlIlIlIl(var10)) {
        ...
        SpellBook.Standard var3 = SpellBook.Standard.SUPERHEAT_ITEM;
        if (L.lIIlIIlIlIlIIll(var10) && L.lIIlIIlIlIlIlll(var5.getAnimation(), lllllIIlIIIl[11])) {
            if (L.lIIlIIlIlIlIllI(var3.canCast() ? 1 : 0)) {
                Log.info((String)lllllIIlIIII[lllllIIlIIIl[0]]);
                var24.l.forceStop();
            }
            int[] nArray2 = new int[lllllIIlIIIl[3]];
            nArray2[L.lllllIIlIIIl[1]] = lllllIIlIIIl[10];
            var3.castOn((Interactable)Inventory.getFirst((int[])nArray2));
        }
        WorldPoint var21 = var14.getWorldLocation();
        WorldPoint var2 = Players.getLocal().getWorldLocation();
        if (L.lIIlIIlIlIlIIlI(var2.toWorldArea().isInMeleeDistance(var21) ? 1 : 0)) {
            var14.interact(lllllIIlIIII[lllllIIlIIIl[12]]);
            var24.sleep(lllllIIlIIIl[3]);
            return lllllIIlIIIl[3];
        }
        if (L.lIIlIIlIlIlIIlI(var24.n() ? 1 : 0) && L.lIIlIIlIlIllIII(var5.distanceTo((Locatable)var14), lllllIIlIIIl[7])) {
            var24.r();
        }
    ...
    private static void lIIlIIlIlIIllll() {
        ...
        L.lllllIIlIIII[L.lllllIIlIIIl[1]] = L."No ardy cloak found";
        L.lllllIIlIIII[L.lllllIIlIIIl[3]] = L."Monastery Teleport";
        L.lllllIIlIIII[L.lllllIIlIIIl[5]] = L."Ardougne Monastery";
        L.lllllIIlIIII[L.lllllIIlIIIl[7]] = L."Enabling run as we're mining";
        L.lllllIIlIIII[L.lllllIIlIIIl[0]] = L."We can't cast superheat, stopping.";
        L.lllllIIlIIII[L.lllllIIlIIIl[12]] = L."Mine";
        L.lllllIIlIIII[L.lllllIIlIIIl[13]] = L."Mine";
        L.lllllIIlIIII[L.lllllIIlIIIl[19]] = L."Ardougne cloak";
        L.lllllIIlIIII[L.lllllIIlIIIl[20]] = L."Ardougne cloak";
    }
}
