...
/* TASK: Mining essenece -> MiningesseneceTask */
...
extends Task {
    ...
    private static void lIIlIlIIIIllllI() {
        ...
        p.llllllIIIlII[p.llllllIIIlIl[0]] = p."Mine";
    }
    ...
    private static String lIIlIlIIIIlllIl(String var1, String var3) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var3.getBytes(StandardCharsets.UTF_8)), llllllIIIlIl[7]), "DES");
            Cipher var4 = Cipher.getInstance("DES");
            var4.init(llllllIIIlIl[5], var5);
    ...
    private static void lIIlIlIIIIlllll() {
        ...
        p.llllllIIIlIl[0] = (0x2F ^ 0x58 ^ (0x52 ^ 8)) & (0xF2 ^ 0xAE ^ (0xB4 ^ 0xC5) ^ -1);
        p.llllllIIIlIl[1] = 3;
        p.llllllIIIlIl[2] = -1 & (0xFFFFBD36 & 0x7EFB);
        p.llllllIIIlIl[3] = 1;
