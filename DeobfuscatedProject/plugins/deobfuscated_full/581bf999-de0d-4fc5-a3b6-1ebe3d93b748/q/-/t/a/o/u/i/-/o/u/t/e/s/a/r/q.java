...
extends Enum<q> {
    ...
    private static String lIIllIIIIIllll(String var6, String var4) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var4.getBytes(StandardCharsets.UTF_8)), lIlllIIIIII[17]), "DES");
            Cipher var12 = Cipher.getInstance("DES");
            var12.init(lIlllIIIIII[8], var5);
    ...
    private static void lIIllIIIIlllII() {
        ...
        q.lIlllIIIIII[0] = (0xED ^ 0x8B ^ (0x5B ^ 0x25)) & (0x78 ^ 0x55 ^ (0x6E ^ 0x5B) ^ -1);
    ...
    private static String lIIllIIIIlIIIl(String var16, String var13) {
        var16 = new String(Base64.getDecoder().decode(var16.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var1 = new StringBuilder();
        char[] var17 = var13.toCharArray();
        int var3 = lIlllIIIIII[0];
        char[] var14 = var16.toCharArray();
        int var15 = var14.length;
        int var7 = lIlllIIIIII[0];
        while (q.lIIllIIIIlllIl(var7, var15)) {
            char var18 = var14[var7];
            var1.append((char)(var18 ^ var17[var3 % var17.length]));
            0;
            ++var3;
            ++var7;
            0;
    ...
    private static void lIIllIIIIllIll() {
        ...
        q.lIllIllllll[q.lIlllIIIIII[0]] = q."FIRST";
        q.lIllIllllll[q.lIlllIIIIII[6]] = q."SECOND";
        q.lIllIllllll[q.lIlllIIIIII[8]] = q."THIRD";
        q.lIllIllllll[q.lIlllIIIIII[12]] = q."FOURTH";
        q.lIllIllllll[q.lIlllIIIIII[14]] = q."FIFTH";
    }
    ...
    private static String lIIllIIIIlIIlI(String var10, String var8) {
        try {
