...
/* TASK: Attacking Zebak -> AttackingzebakTask */
...
extends bX {
    ...
    public boolean bL() {
        ...
        int n2 = Gear.isEquipped((int[])Gear.matching(var1.cW.gearSwapZebak()));
        if (bN.lIIllIlIIIlIll(var4.getInteracting()) && bN.lIIllIlIIIllIl(n2)) {
            return lIllllIIIII[0];
        }
        int var3 = var4.distanceTo(var1.a(gR));
        int var2 = var1.a((NPC)var8, lIllllIIIII[1]) ? 1 : 0;
        if (bN.lIIllIlIIIllll(var2) && bN.lIIllIlIIlIIIl(var3, var1.bg()) && bN.lIIllIlIIlIIlI((Object)var1.cF(), (Object)bY.ATTACK)) {
            return lIllllIIIII[0];
        }
    ...
    private static String lIIllIlIIIIlIl(String var7, String var10) {
        try {
