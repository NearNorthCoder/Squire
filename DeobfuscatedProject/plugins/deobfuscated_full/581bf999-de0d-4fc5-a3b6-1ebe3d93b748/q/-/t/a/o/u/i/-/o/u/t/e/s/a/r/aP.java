...
/* TASK: Moving next to rubble -> MovingnexttorubbleTask */
...
extends aI {
    ...
    private static String lIIlllllIlllII(String var10, String var9) {
        try {
            SecretKeySpec var15 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var9.getBytes(StandardCharsets.UTF_8)), llIIIllllIl[3]), "DES");
            Cipher var8 = Cipher.getInstance("DES");
            var8.init(llIIIllllIl[2], var15);
    ...
    private static String lIIlllllIllIll(String var16, String var12) {
        var16 = new String(Base64.getDecoder().decode(var16.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var13 = new StringBuilder();
        char[] var11 = var12.toCharArray();
        int var5 = llIIIllllIl[0];
        char[] var6 = var16.toCharArray();
        int var1 = var6.length;
        int var14 = llIIIllllIl[0];
        while (aP.lIIllllllIIIlI(var14, var1)) {
            char var3 = var6[var14];
            var13.append((char)(var3 ^ var11[var5 % var11.length]));
            0;
            ++var5;
            ++var14;
            0;
    ...
    public boolean bC() {
        ...
        if (aP.lIIllllllIIIIl(var17.eh ? 1 : 0)) {
            return llIIIllllIl[0];
        }
        WorldPoint var7 = Players.getLocal().getWorldLocation();
        if (aP.lIIllllllIIIII(var2.getWorldArea().isInMeleeDistance(var7) ? 1 : 0)) {
