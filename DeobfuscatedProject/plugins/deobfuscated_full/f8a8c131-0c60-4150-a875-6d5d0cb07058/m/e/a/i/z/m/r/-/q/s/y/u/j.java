...
extends HashMap<String, Integer> {
    ...
    private static String llIIIlIIllIIlll(String var12, String var8) {
        try {
            SecretKeySpec var7 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var8.getBytes(StandardCharsets.UTF_8)), lIllIIIlIIlIl[10]), "DES");
            Cipher var15 = Cipher.getInstance("DES");
            var15.init(lIllIIIlIIlIl[3], var7);
    ...
    private static String llIIIlIIllIIllI(String var18, String var10) {
        try {
            ...
            var2.init(lIllIIIlIIlIl[3], var16);
    ...
    private static String llIIIlIIllIIlIl(String var1, String var4) {
        var1 = new String(Base64.getDecoder().decode(var1.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var14 = new StringBuilder();
        char[] var9 = var4.toCharArray();
        int var5 = lIllIIIlIIlIl[0];
        char[] var17 = var1.toCharArray();
        int var19 = var17.length;
        int var3 = lIllIIIlIIlIl[0];
        while (j.llIIIlIIllIlIlI(var3, var19)) {
            char var13 = var17[var3];
            var14.append((char)(var13 ^ var9[var5 % var9.length]));
            0;
            ++var5;
            ++var3;
            0;
