...
extends z {
    ...
    private static String lIllIlIllIIlIlI(String var3, String var6) {
        try {
            SecretKeySpec var4 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var6.getBytes(StandardCharsets.UTF_8)), lIIlllllllllI[16]), "DES");
            Cipher var9 = Cipher.getInstance("DES");
            var9.init(lIIlllllllllI[6], var4);
    ...
    public void a(AnimationChanged animationChanged) {
        ...
        if (G.lIllIlIllIIllll(var7.getAnimation(), lIIlllllllllI[14])) {
            var10.ba = Prayer.PROTECT_FROM_MISSILES;
            0;
            
            }
        } else if (G.lIllIlIllIIllll(var7.getAnimation(), lIIlllllllllI[15])) {
            var10.ba = Prayer.PROTECT_FROM_MAGIC;
        }
    }
    ...
    public void a(ChatMessage chatMessage) {
        ...
        if (G.lIllIlIllIIlllI(var8.contains(lIIllllllllIl[lIIlllllllllI[2]]) ? 1 : 0)) {
            var5.ba = Prayer.PROTECT_FROM_MELEE;
            0;
            if (1 < 0) {
                return;
            }
        } else if (G.lIllIlIllIIlllI(var8.contains(lIIllllllllIl[lIIlllllllllI[4]]) ? 1 : 0)) {
            var5.ba = Prayer.PROTECT_FROM_MAGIC;
            0;
            if (2 < ((0x5B ^ 0x6B) & ~(0x2F ^ 0x1F))) {
                return;
            }
        } else if (G.lIllIlIllIIlllI(var8.contains(lIIllllllllIl[lIIlllllllllI[6]]) ? 1 : 0)) {
