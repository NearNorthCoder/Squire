...
extends z {
    ...
    public void a(AnimationChanged animationChanged) {
        ...
        if (I.lIllIllIIIllllI(var2.getAnimation(), lIlIIIIIlIllI[6])) {
            Prayer prayer;
            I var1;
            if (I.lIllIllIIIlllll(var1.ba, Prayer.PROTECT_FROM_MISSILES)) {
        ...
        } else if (I.lIllIllIIIllllI(var2.getAnimation(), lIlIIIIIlIllI[7])) {
            var1.ba = Prayer.PROTECT_FROM_MISSILES;
            0;
            if (-3 > 0) {
                return;
            }
        } else if (I.lIllIllIIIllllI(var2.getAnimation(), lIlIIIIIlIllI[8])) {
            var1.ba = Prayer.PROTECT_FROM_MAGIC;
        }
    }
