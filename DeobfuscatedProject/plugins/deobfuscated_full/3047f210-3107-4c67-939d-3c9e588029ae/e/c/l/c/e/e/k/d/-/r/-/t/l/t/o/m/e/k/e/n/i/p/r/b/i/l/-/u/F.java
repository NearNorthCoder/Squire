...
implements S {
        ...
        block49: {
            ...
            block52: {
                    ...
                    block51: {
                        block50: {
                            ...
                            if (F.llIIllIIlIlll(F.aa() ? 1 : 0) && F.llIIllIIlIllI(e.j(llllIIlIII[4]), llllIIlIII[1])) {
                                ...
                                if (F.llIIllIIllIII(var21) && F.llIIllIIlIlll(var21.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    AccBuilderTempleTrek.c = llllIIIlII[llllIIlIII[5]];
                                    a.a(var21);
                                }
                                if (F.llIIllIIllIII(var21) && F.llIIllIIlIlIl(var21.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            if (F.llIIllIIlIlIl(F.aa() ? 1 : 0) && F.llIIllIIlIllI(e.j(llllIIlIII[4]), llllIIlIII[1])) {
                                ...
                                if (F.llIIllIIllIIl(bS)) {
                                    ...
                                    if (F.llIIllIIllIll(Players.getLocal().getWorldLocation().distanceTo(hc), llllIIlIII[8])) {
                                        ...
                                        var21 = TileObjects.getNearest((String[])stringArray);
                                        if (F.llIIllIIllIII(var21)) {
                                            String[] stringArray2 = new String[llllIIlIII[1]];
                                            stringArray2[F.llllIIlIII[0]] = llllIIIlII[llllIIlIII[19]];
                                            if (F.llIIllIIlIlIl(var21.hasAction(stringArray2) ? 1 : 0)) {
                                                var21.interact(llllIIIlII[llllIIlIII[20]]);
                                                Time.sleepTicks((int)llllIIlIII[5]);
                                                0;
                                            }
                                        }
                ...
                if (F.llIIllIIlIlIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    if (F.llIIllIIllIII(var21) && F.llIIllIIllIII(var23)) {
                        var21.useOn(var23);
                        Time.sleepTicks((int)llllIIlIII[1]);
                        0;
                    }
                    ...
                    if (F.llIIllIIllIII(var10) && F.llIIllIIllIII(var23)) {
                        var10.useOn(var23);
                    }
                }
            }
            ...
            if (F.llIIllIIllIII(var21 = Widgets.get((int)llllIIlIII[45], (int)llllIIlIII[26]))) {
                var21.interact(llllIIlIII[0]);
            }
    ...
    private static void ae() {
        ...
        block10: {
            block9: {
                ...
                if (F.llIIllIIlIlll(Bank.contains((int[])nArray2) ? 1 : 0)) {
                    var24 = new d(llllIIlIII[12], llllIIlIII[1], llllIIlIII[56]);
                    bu.add((d)var24);
                    0;
                }
                int[] nArray3 = new int[llllIIlIII[1]];
            ...
            var24 = new d(llllIIlIII[9], llllIIlIII[5], llllIIlIII[56]);
            bu.add((d)var24);
            0;
        }
        int[] nArray = new int[llllIIlIII[1]];
        ...
        if (F.llIIllIIlIlll(Bank.contains((int[])nArray) ? 1 : 0)) {
            var24 = new d(llllIIlIII[14], llllIIlIII[8], llllIIlIII[56]);
            bu.add((d)var24);
            0;
        }
        if (F.llIIllIIlIlll(Bank.contains((Predicate)(var24 = item -> item.getName().toLowerCase().contains(llllIIIlII[llllIIlIII[63]]))) ? 1 : 0)) {
            var9 = new d(llllIIlIII[57], llllIIlIII[8], llllIIlIII[58]);
            bu.add(var9);
            0;
        }
        int[] nArray6 = new int[llllIIlIII[1]];
        ...
        if (F.llIIllIIlIlll(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var9 = new d(llllIIlIII[59], llllIIlIII[54], llllIIlIII[60]);
            bu.add(var9);
            0;
        }
        int[] nArray7 = new int[llllIIlIII[1]];
        ...
        if (F.llIIllIIlIlll(Bank.contains((int[])nArray7) ? 1 : 0)) {
            var9 = new d(llllIIlIII[13], llllIIlIII[8], i.bp);
            bu.add(var9);
            0;
        }
    }
    ...
    private static void cr() {
        block8: {
            ...
            if (F.llIIllIIlIlIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                Item var20 = Inventory.getFirst((String[])stringArray3);
                int[] nArray2 = new int[llllIIlIII[1]];
                nArray2[F.llllIIlIII[0]] = llllIIlIII[9];
                Item var28 = Inventory.getFirst((int[])nArray2);
                if (F.llIIllIIllIII(var14) && F.llIIllIIllIII(var28)) {
                    var14.useOn(var28);
                    Time.sleepTicks((int)llllIIlIII[1]);
                    0;
                }
                int[] nArray3 = new int[llllIIlIII[1]];
                nArray3[F.llllIIlIII[0]] = llllIIlIII[9];
                var28 = Inventory.getFirst((int[])nArray3);
                if (F.llIIllIIllIII(var20) && F.llIIllIIllIII(var28)) {
                    var20.useOn(var28);
                }
            }
        }
    ...
    private static String llIIlIlllllII(String var15, String var26) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var26.getBytes(StandardCharsets.UTF_8)), llllIIlIII[16]), "DES");
            Cipher var17 = Cipher.getInstance("DES");
            var17.init(llllIIlIII[3], var5);
    ...
    private static void cc() {
        ...
        if (F.llIIllIIllIII(var3) && F.llIIllIIlIlIl(var3.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            if (F.llIIllIIlIlll(Bank.isOpen() ? 1 : 0)) {
    ...
    private static String llIIlIlllllIl(String var11, String var6) {
        var11 = new String(Base64.getDecoder().decode(var11.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var4 = new StringBuilder();
        char[] var8 = var6.toCharArray();
        int var7 = llllIIlIII[0];
        char[] var13 = var11.toCharArray();
        int var2 = var13.length;
        int var12 = llllIIlIII[0];
        while (F.llIIllIIlIllI(var12, var2)) {
            char var1 = var13[var12];
            var4.append((char)(var1 ^ var8[var7 % var8.length]));
            0;
            ++var7;
            ++var12;
            0;
    ...
    private static String llIIlIllllllI(String var16, String var27) {
        try {
            SecretKeySpec var19 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var27.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var22 = Cipher.getInstance("Blowfish");
            var22.init(llllIIlIII[3], var19);
            return new String(var22.doFinal(Base64.getDecoder().decode(var16.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
