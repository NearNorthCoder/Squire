...
implements S {
    ...
    private static void bY() {
        ...
        if (A.llIllIIIlIlIl(var18) && A.llIllIIIlIIlI(var18.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            block78: {
                ...
                block80: {
                    block79: {
                        ...
                        if (A.llIllIIIlIlII(A.aa() ? 1 : 0) && A.llIllIIIlIlII(Vars.getBit((int)QuestVarbits.QUEST_DEMON_SLAYER.getId()))) {
                            ...
                            if (A.llIllIIIlIlIl(var28) && A.llIllIIIlIlII(var28.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                AccBuilderTempleTrek.c = lllllllIII[llllllllII[1]];
                                a.a((BankLocation)var28);
                            }
                            if (A.llIllIIIlIlIl(var28) && A.llIllIIIlIIlI(var28.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                if (A.llIllIIIlIlII(Bank.isOpen() ? 1 : 0)) {
                                    a.a();
                                    Time.sleepUntil(() -> Bank.isOpen(), (int)llllllllII[2]);
                                    0;
                        ...
                        if (A.llIllIIIllIlI(Vars.getBit((int)QuestVarbits.QUEST_DEMON_SLAYER.getId()), llllllllII[1])) {
                            var28 = new WorldArea(llllllllII[21], llllllllII[22], llllllllII[19], llllllllII[18], llllllllII[0]);
                            if (A.llIllIIIlIlII(var28.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            if (A.llIllIIIlIIlI(var28.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (A.llIllIIIlIlIl(var28 = NPCs.getNearest(nPC -> {
                        int n2;
                        ...
                        var28.interact(lllllllIII[llllllllII[62]]);
                        Time.sleepTicks((int)llllllllII[3]);
                        0;
                    }
                    if (A.llIllIIIlllII(var28) && A.llIllIIIlllII(Players.getLocal().getInteracting())) {
                        String[] stringArray = new String[llllllllII[1]];
                    ...
                    if (A.llIllIIIlIIlI(Dialog.isOpen() ? 1 : 0)) {
                        ...
                        List var5 = Dialog.getOptions();
                        if (A.llIllIIIlIlII(var5.isEmpty() ? 1 : 0)) {
                            int var21 = llllllllII[0];
                            while (A.llIllIIIlIIll(var21, var5.size())) {
                                if (A.llIllIIIlIIlI(((Widget)var5.get(var21)).getText().contains(lllllllIII[llllllllII[67]]) ? 1 : 0)) {
                                    String[] stringArray = new String[llllllllII[1]];
                                    stringArray[A.llllllllII[0]] = ((Widget)var5.get(var21)).getText();
                ...
                if (A.llIllIIIlIlIl(NPCs.getNearest((String[])stringArray))) {
                    ...
                    if (A.llIllIIIlIIlI(Dialog.isOpen() ? 1 : 0)) {
                        ...
                        var28 = Dialog.getOptions();
                        if (A.llIllIIIlIlII(var28.isEmpty() ? 1 : 0)) {
                            int var5 = llllllllII[0];
                            while (A.llIllIIIlIIll(var5, var28.size())) {
                                String var21 = gG[var5];
                                int var13 = llllllllII[0];
                                while (A.llIllIIIlIIll(var13, var28.size())) {
                                    if (A.llIllIIIlIIlI(((Widget)var28.get(var13)).getText().contains(var21) ? 1 : 0)) {
                                        System.out.println("Selecting: " + ((Widget)var28.get(var13)).getText());
                                        Time.sleepTicks((int)llllllllII[3]);
                                        0;
                                        String[] stringArray23 = new String[llllllllII[1]];
                                        stringArray23[A.llllllllII[0]] = ((Widget)var28.get(var13)).getText();
    ...
    private static String llIlIllllllIl(String var24, String var7) {
        ...
        int var6 = llllllllII[0];
        char[] var3 = var24.toCharArray();
        int var23 = var3.length;
        int var26 = llllllllII[0];
        while (A.llIllIIIlIIll(var26, var23)) {
            char var27 = var3[var26];
            var19.append((char)(var27 ^ var20[var6 % var20.length]));
            0;
            ++var6;
            ++var26;
            0;
    ...
    private static void ae() {
        block17: {
            ...
            block16: {
                block15: {
                    block14: {
                        ...
                        block13: {
                            ...
                            var15 = new d(llllllllII[7], llllllllII[9], llllllllII[80]);
                            bu.add((d)var15);
                            0;
                        }
                        int[] nArray = new int[llllllllII[1]];
                        ...
                        if (A.llIllIIIlIlII(Bank.contains((int[])nArray) ? 1 : 0)) {
                            var15 = new d(llllllllII[8], llllllllII[1], llllllllII[81]);
                            bu.add((d)var15);
                            0;
                        }
                        if (A.llIllIIIlIlII(Bank.contains((Predicate)(var15 = item -> item.getName().toLowerCase().contains(lllllllIII[llllllllII[88]]))) ? 1 : 0)) {
                            var1 = new d(llllllllII[82], llllllllII[10], llllllllII[83]);
                            bu.add(var1);
                            0;
                        }
                    ...
                    var1 = new d(llllllllII[17], llllllllII[12], llllllllII[84]);
                    bu.add(var1);
                    0;
                }
                int[] nArray = new int[llllllllII[1]];
                ...
                if (A.llIllIIIlIlII(Bank.contains((int[])nArray) ? 1 : 0)) {
                    var1 = new d(llllllllII[11], llllllllII[4], i.bp);
                    bu.add(var1);
                    0;
                }
                int[] nArray7 = new int[llllllllII[1]];
            ...
            var1 = new d(llllllllII[6], llllllllII[54], llllllllII[85]);
            bu.add(var1);
            0;
        }
    }
    ...
    private static void llIllIIIIllll() {
        ...
        A.lllllllIII[A.llllllllII[0]] = A."Finished buying items, switching back to quest";
        A.lllllllIII[A.llllllllII[1]] = A."Nav to bank";
        A.lllllllIII[A.llllllllII[3]] = A."Handling banking";
        A.lllllllIII[A.llllllllII[5]] = A."We are missing quest supplies, switching to BUYING";
        A.lllllllIII[A.llllllllII[4]] = A."We are missing quest supplies, switching to BUYING";
        A.lllllllIII[A.llllllllII[10]] = A."Wear";
        A.lllllllIII[A.llllllllII[16]] = A."Drink";
        A.lllllllIII[A.llllllllII[18]] = A."Eat";
        A.lllllllIII[A.llllllllII[19]] = A."Nav to start";
        A.lllllllIII[A.llllllllII[20]] = A."Aris";
        A.lllllllIII[A.llllllllII[12]] = A."Nav to sir pyrsin";
        A.lllllllIII[A.llllllllII[23]] = A."Sir Prysin";
        A.lllllllIII[A.llllllllII[25]] = A."Silverlight";
        A.lllllllIII[A.llllllllII[26]] = A."Nav to captain";
        A.lllllllIII[A.llllllllII[27]] = A."Captain Rovin";
        A.lllllllIII[A.llllllllII[28]] = A."Bucket of water";
        A.lllllllIII[A.llllllllII[29]] = A."Nav to drain";
        A.lllllllIII[A.llllllllII[30]] = A."Bucket of water";
        A.lllllllIII[A.llllllllII[31]] = A."Drain";
        A.lllllllIII[A.llllllllII[32]] = A."Bucket of water";
        A.lllllllIII[A.llllllllII[33]] = A."Nav to sewer key";
        A.lllllllIII[A.llllllllII[34]] = A."Manhole";
        A.lllllllIII[A.llllllllII[35]] = A."Manhole";
        A.lllllllIII[A.llllllllII[36]] = A."Open";
        A.lllllllIII[A.llllllllII[37]] = A."Manhole";
        A.lllllllIII[A.llllllllII[9]] = A."Open";
        A.lllllllIII[A.llllllllII[38]] = A."Manhole";
        A.lllllllIII[A.llllllllII[39]] = A."Manhole";
        A.lllllllIII[A.llllllllII[40]] = A."Climb-down";
        A.lllllllIII[A.llllllllII[41]] = A."Manhole";
        A.lllllllIII[A.llllllllII[42]] = A."Climb-down";
        A.lllllllIII[A.llllllllII[43]] = A."Rusty key";
        A.lllllllIII[A.llllllllII[44]] = A."Rusty key";
        A.lllllllIII[A.llllllllII[45]] = A."Take";
        A.lllllllIII[A.llllllllII[47]] = A."Silverlight";
        A.lllllllIII[A.llllllllII[49]] = A."Bones";
        A.lllllllIII[A.llllllllII[50]] = A."Bones";
        A.lllllllIII[A.llllllllII[51]] = A."Nav to wizard";
        A.lllllllIII[A.llllllllII[52]] = A."Wizard Traiborn";
        A.lllllllIII[A.llllllllII[53]] = A."Silverlight";
        A.lllllllIII[A.llllllllII[54]] = A."Nav to sir pyrsin";
        A.lllllllIII[A.llllllllII[55]] = A."Sir Prysin";
        A.lllllllIII[A.llllllllII[56]] = A."Silverlight";
        A.lllllllIII[A.llllllllII[57]] = A."Delrith";
        A.lllllllIII[A.llllllllII[58]] = A."Weakened Delrith";
        A.lllllllIII[A.llllllllII[59]] = A."Nav to demon";
        A.lllllllIII[A.llllllllII[60]] = A."Delrith";
        A.lllllllIII[A.llllllllII[61]] = A."Weakened Delrith";
        A.lllllllIII[A.llllllllII[62]] = A."Attack";
        A.lllllllIII[A.llllllllII[63]] = A."Delrith";
        A.lllllllIII[A.llllllllII[15]] = A."Delrith";
        A.lllllllIII[A.llllllllII[64]] = A."Delrith";
        A.lllllllIII[A.llllllllII[65]] = A."Attack";
        A.lllllllIII[A.llllllllII[66]] = A."Banishing";
        A.lllllllIII[A.llllllllII[67]] = A."[";
        A.lllllllIII[A.llllllllII[68]] = A."Weakened Delrith";
        A.lllllllIII[A.llllllllII[69]] = A."Banishing";
        A.lllllllIII[A.llllllllII[75]] = A.", ";
        A.lllllllIII[A.llllllllII[76]] = A."Nav to bank";
        A.lllllllIII[A.llllllllII[77]] = A."Handling banking";
        A.lllllllIII[A.llllllllII[79]] = A."Wear";
        A.lllllllIII[A.llllllllII[87]] = A."Demon Slayer";
        A.lllllllIII[A.llllllllII[88]] = A."ring of wealth (";
        A.lllllllIII[A.llllllllII[89]] = A."wizard";
        A.lllllllIII[A.llllllllII[90]] = A."Now what was that incantation again?";
        A.lllllllIII[A.llllllllII[103]] = A."Yes.";
        A.lllllllIII[A.llllllllII[104]] = A."The Demon Slayer Quest";
        A.lllllllIII[A.llllllllII[105]] = A."Okay, where is he? I'll kill him for you!";
        A.lllllllIII[A.llllllllII[106]] = A."So how did Wally kill Delrith?";
        A.lllllllIII[A.llllllllII[107]] = A."What is the magical incantation?";
        A.lllllllIII[A.llllllllII[108]] = A."Aris said I should come and talk to you.";
        A.lllllllIII[A.llllllllII[109]] = A."I need to find Silverlight.";
        A.lllllllIII[A.llllllllII[110]] = A."He's back and unfortunately I've got to deal with him.";
        A.lllllllIII[A.llllllllII[111]] = A."So give me the keys!";
        A.lllllllIII[A.llllllllII[112]] = A."Yes I know, but this is important.";
        A.lllllllIII[A.llllllllII[113]] = A."There's a demon who wants to invade this city.";
        A.lllllllIII[A.llllllllII[114]] = A."Yes, very.";
        A.lllllllIII[A.llllllllII[115]] = A."It's not them who are going to fight the demon, it's me.";
        A.lllllllIII[A.llllllllII[116]] = A."Sir Prysin said you would give me the key.";
        A.lllllllIII[A.llllllllII[117]] = A."Why did he give you one of the keys then?";
        A.lllllllIII[A.llllllllII[118]] = A."Talk about Demon Slayer.";
        A.lllllllIII[A.llllllllII[119]] = A."Well, have you got any keys knocking around?";
        A.lllllllIII[A.llllllllII[120]] = A."I'll get the bones for you.";
    }
    ...
    private static String llIlIllllllII(String var17, String var10) {
        try {
    ...
    private static String llIlIlllllllI(String var12, String var4) {
        try {
            SecretKeySpec var11 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var4.getBytes(StandardCharsets.UTF_8)), llllllllII[19]), "DES");
            Cipher var14 = Cipher.getInstance("DES");
            var14.init(llllllllII[3], var11);
    ...
    private static boolean aa() {
        ...
        int[] nArray2 = nArray;
        int var25 = llllllllII[0];
        while (A.llIllIIIlIIll(var25, ((void)var9).length)) {
            int[] nArray3 = new int[llllllllII[1]];
            nArray3[A.llllllllII[0]] = var9[var25];
