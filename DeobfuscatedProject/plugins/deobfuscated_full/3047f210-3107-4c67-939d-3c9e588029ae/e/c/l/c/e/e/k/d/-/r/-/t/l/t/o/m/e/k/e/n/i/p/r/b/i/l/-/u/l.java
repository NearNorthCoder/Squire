...
implements S {
    ...
    public static boolean ar() {
        ...
        if (l.llIllIlIIIIll(list.isEmpty() ? 1 : 0) && l.llIllIlIIlIlI(list.size(), lIIIIIIIlII[0])) {
            void var8;
            int var29 = lIIIIIIIlII[1];
            while (l.llIllIlIIIIlI(var29, var8.size())) {
                void var1;
                if (l.llIllIlIIIlIl(((Player)var8.get(var29)).equals(Players.getLocal()) ? 1 : 0)) {
                    0;
                    if (3 >= (0xF6 ^ 0xB3 ^ (0x3D ^ 0x7C))) {
                        return ((0xBF ^ 0x9B ^ (0xD1 ^ 0xA2)) & (0x7B ^ 0x6D ^ (0x74 ^ 0x35) ^ -1)) != 0;
                    }
                } else if (l.llIllIlIIIlIl(var1.contains(((Player)var8.get(var29)).getWorldLocation()) ? 1 : 0)) {
    ...
    public static void ap() {
        ...
        if (l.llIllIlIIlIIl(l.llIllIlIIIlll(e.a(bP), lIIIIIIIlII[9] + bU))) {
            if (l.llIllIlIIIIll(Players.getLocal().getWorldLocation().equals((Object)bO) ? 1 : 0)) {
                ...
                if (l.llIllIlIIIIll(bR.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (l.llIllIlIIlIll(Players.getLocal().getWorldLocation().distanceTo(bN), lIIIIIIIlII[10])) {
                        ...
                        if (l.llIllIlIIIlII(var24)) {
                            String[] stringArray2 = new String[lIIIIIIIlII[0]];
                            stringArray2[l.lIIIIIIIlII[1]] = lIIIIIIIIll[lIIIIIIIlII[16]];
                            if (l.llIllIlIIIlIl(var24.hasAction(stringArray2) ? 1 : 0)) {
                                var24.interact(lIIIIIIIIll[lIIIIIIIlII[17]]);
                            ...
                            if (l.llIllIlIIIIll(var24.hasAction(stringArray3) ? 1 : 0)) {
            ...
            if (l.llIllIlIIIlIl(Players.getLocal().getWorldLocation().equals((Object)bO) ? 1 : 0)) {
                ...
                if (l.llIllIlIIIlIl(l.ar() ? 1 : 0)) {
                    var24 = new WorldArea(bO, lIIIIIIIlII[3], lIIIIIIIlII[3]);
                    var12 = l.aq();
                    AccBuilderTempleTrek.c = lIIIIIIIIll[lIIIIIIIlII[21]];
                    if (l.llIllIlIIllII(Players.getLocal().getInteracting()) && l.llIllIlIIIlII(var12) && l.llIllIlIIIIll(var12.isDead() ? 1 : 0)) {
                        System.out.println(lIIIIIIIIll[lIIIIIIIlII[22]]);
                        var12.interact(lIIIIIIIIll[lIIIIIIIlII[23]]);
        ...
        if (l.llIllIlIIllIl(l.llIllIlIIIlll(e.a(bP), lIIIIIIIlII[9] + bU))) {
            var24 = new WorldArea(lIIIIIIIlII[24], lIIIIIIIlII[25], lIIIIIIIlII[26], lIIIIIIIlII[27], lIIIIIIIlII[1]);
            var12 = new WorldPoint(lIIIIIIIlII[28], lIIIIIIIlII[29], lIIIIIIIlII[1]);
            if (l.llIllIlIIIlIl(var24.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && l.llIllIlIIlIlI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var12), lIIIIIIIlII[13])) {
    ...
    private static String llIllIIllllIl(String var19, String var4) {
        try {
            SecretKeySpec var9 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var4.getBytes(StandardCharsets.UTF_8)), lIIIIIIIlII[16]), "DES");
            Cipher var7 = Cipher.getInstance("DES");
            var7.init(lIIIIIIIlII[3], var9);
    ...
    private static String llIllIIllllll(String var18, String var5) {
        var18 = new String(Base64.getDecoder().decode(var18.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var14 = new StringBuilder();
        char[] var26 = var5.toCharArray();
        int var2 = lIIIIIIIlII[1];
        char[] var11 = var18.toCharArray();
        int var10 = var11.length;
        int var15 = lIIIIIIIlII[1];
        while (l.llIllIlIIIIlI(var15, var10)) {
            char var20 = var11[var15];
            var14.append((char)(var20 ^ var26[var2 % var26.length]));
            0;
            ++var2;
            ++var15;
            0;
    ...
    static NPC aq() {
        ...
        if (l.llIllIlIIIlII(list)) {
            ...
            int var23 = lIIIIIIIlII[1];
            while (l.llIllIlIIIIlI(var23, var16.size())) {
                void var22;
                if (l.llIllIlIIIlIl(var22.contains(((NPC)var16.get(var23)).getWorldLocation()) ? 1 : 0)) {
                    return (NPC)var16.get(var23);
                }
                ++var23;
                0;
                if (2 == 2) continue;
    ...
    public static void as() {
        ...
        if (l.llIllIlIIlllI((int)var25, lIIIIIIIlII[3])) {
            bO = bF;
            bE = bG;
        }
        if (l.llIllIlIIlllI((int)var25, lIIIIIIIlII[10])) {
            bO = bH;
            bE = bI;
        }
        if (l.llIllIlIIlllI((int)var25, lIIIIIIIlII[12])) {
            bO = bJ;
            bE = bK;
        }
        if (l.llIllIlIIlllI((int)var25, lIIIIIIIlII[13])) {
            bO = bL;
            bE = bM;
        }
    }
    ...
    private static void ao() {
        ...
        if (l.llIllIlIIIIll(Inventory.contains((int[])nArray) ? 1 : 0)) {
            BankLocation var21 = BankLocation.getNearest();
            if (l.llIllIlIIIlII(var21) && l.llIllIlIIIIll(var21.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                AccBuilderTempleTrek.c = lIIIIIIIIll[lIIIIIIIlII[0]];
                a.a(var21);
            }
            if (l.llIllIlIIIlII(var21) && l.llIllIlIIIlIl(var21.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String llIllIIlllllI(String var6, String var13) {
        try {
            SecretKeySpec var28 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var13.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var3 = Cipher.getInstance("Blowfish");
            var3.init(lIIIIIIIlII[3], var28);
