...
implements S {
    ...
    private static boolean aa() {
        ...
        int[] nArray2 = nArray;
        int var23 = llllllIIII[1];
        while (y.llIlIlIllIlll(var23, ((void)var9).length)) {
            int[] nArray3 = new int[llllllIIII[0]];
            nArray3[y.llllllIIII[1]] = var9[var23];
        ...
        block19: {
            ...
            block18: {
                ...
                block17: {
                        ...
                        block15: {
                            block14: {
                                ...
                                if (y.llIlIlIlllIII(Bank.contains((int[])nArray2) ? 1 : 0)) {
                                    var38 = new d(llllllIIII[10], llllllIIII[0], llllllIIII[134]);
                                    bu.add((d)var38);
                                    0;
                                }
                                int[] nArray3 = new int[llllllIIII[0]];
                                ...
                                if (y.llIlIlIlllIII(Bank.contains((int[])nArray3) ? 1 : 0)) {
                                    var38 = new d(llllllIIII[12], llllllIIII[0], llllllIIII[134]);
                                    bu.add((d)var38);
                                    0;
                                }
                            ...
                            var38 = new d(llllllIIII[9], llllllIIII[13], llllllIIII[135]);
                            bu.add((d)var38);
                            0;
                        }
                        int[] nArray = new int[llllllIIII[0]];
                    ...
                    var38 = new d(llllllIIII[15], llllllIIII[13], llllllIIII[136]);
                    bu.add((d)var38);
                    0;
                }
                if (y.llIlIlIlllIII(Bank.contains((Predicate)(var38 = item -> item.getName().toLowerCase().contains(lllllIllII[llllllIIII[142]]))) ? 1 : 0)) {
                    var15 = new d(llllllIIII[137], llllllIIII[7], llllllIIII[138]);
                    bu.add(var15);
                    0;
                }
                int[] nArray = new int[llllllIIII[0]];
                ...
                if (y.llIlIlIlllIII(Bank.contains((int[])nArray) ? 1 : 0)) {
                    var15 = new d(llllllIIII[14], llllllIIII[6], i.bp);
                    bu.add(var15);
                    0;
                }
            ...
            var15 = new d(llllllIIII[8], llllllIIII[66], llllllIIII[139]);
            bu.add(var15);
            0;
        }
    }
    ...
    public static void bS() {
        block81: {
            ...
            block82: {
                    ...
                    block85: {
                        block84: {
                            ...
                            if (y.llIlIlIlllIII(y.aa() ? 1 : 0) && y.llIlIlIllIlll(e.j(gp), llllllIIII[0]) && y.llIlIlIlllIIl(e.H(), llllllIIII[2])) {
                                ...
                                if (y.llIlIlIlllIlI(var2) && y.llIlIlIlllIII(var2.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    AccBuilderTempleTrek.c = lllllIllII[llllllIIII[3]];
                                    a.a(var2);
                                }
                                if (y.llIlIlIlllIlI(var2) && y.llIlIlIllIllI(var2.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            ck = llllllIIII[1];
                            var2 = new WorldArea(llllllIIII[21], llllllIIII[22], llllllIIII[18], llllllIIII[3], llllllIIII[1]);
                            var36 = new WorldArea(llllllIIII[23], llllllIIII[24], llllllIIII[25], llllllIIII[26], llllllIIII[0]);
                            var11 = new WorldArea(llllllIIII[23], llllllIIII[27], llllllIIII[28], llllllIIII[29], llllllIIII[3]);
                            var26 = new WorldArea(llllllIIII[30], llllllIIII[22], llllllIIII[31], llllllIIII[18], llllllIIII[1]);
                            var3 = new WorldArea(llllllIIII[32], llllllIIII[33], llllllIIII[34], llllllIIII[35], llllllIIII[1]);
                            var28 = new WorldArea(llllllIIII[36], llllllIIII[37], llllllIIII[38], llllllIIII[34], llllllIIII[1]);
                            if (!y.llIlIlIlllIII(var2.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !y.llIlIlIlllIII(var36.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !y.llIlIlIlllIII(var11.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !y.llIlIlIlllIII(var26.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !y.llIlIlIlllIII(var3.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !y.llIlIlIlllIII(var28.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block83;
                ...
                if (y.llIlIlIllIllI(var2.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                var10 = new WorldArea(llllllIIII[47], llllllIIII[48], llllllIIII[6], llllllIIII[5], llllllIIII[1]);
                var31 = new WorldArea(llllllIIII[47], llllllIIII[48], llllllIIII[6], llllllIIII[5], llllllIIII[0]);
                if (y.llIlIlIllIllI(var10.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    var30.interact(lllllIllII[llllllIIII[50]]);
                    Time.sleepTicks((int)llllllIIII[3]);
                    0;
                }
                if (y.llIlIlIllIllI(var31.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    var30.interact(lllllIllII[llllllIIII[28]]);
                    Time.sleepTicks((int)llllllIIII[3]);
                    0;
                }
                var30 = new WorldArea(llllllIIII[21], llllllIIII[52], llllllIIII[18], llllllIIII[18], llllllIIII[3]);
                var5 = new WorldPoint(llllllIIII[53], llllllIIII[22], llllllIIII[3]);
                if (y.llIlIlIllIllI(var30.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (y.llIlIlIllllIl(Players.getLocal().getWorldLocation().distanceTo(var5), llllllIIII[0])) {
                        ...
                        var18.interact(lllllIllII[llllllIIII[54]]);
                        Time.sleepTicks((int)llllllIIII[3]);
                        0;
                    }
                }
                if (y.llIlIlIllIllI((var18 = new WorldArea(llllllIIII[55], llllllIIII[56], llllllIIII[13], llllllIIII[7], llllllIIII[0])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (y.llIlIlIllIllI((var22 = new WorldArea(llllllIIII[36], llllllIIII[67], llllllIIII[19], llllllIIII[18], llllllIIII[3])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                WorldArea var21 = new WorldArea(llllllIIII[32], llllllIIII[37], llllllIIII[7], llllllIIII[19], llllllIIII[0]);
                WorldArea var17 = new WorldArea(llllllIIII[71], llllllIIII[72], llllllIIII[19], llllllIIII[6], llllllIIII[0]);
                WorldArea var8 = new WorldArea(llllllIIII[71], llllllIIII[33], llllllIIII[18], llllllIIII[19], llllllIIII[0]);
                ...
                if (!y.llIlIlIlllIII(var17.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || y.llIlIlIllIllI(var21.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    if (y.llIlIlIllIllI(var17.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        String[] stringArray = new String[llllllIIII[0]];
                ...
                WorldArea var12 = new WorldArea(llllllIIII[71], llllllIIII[37], llllllIIII[19], llllllIIII[0], llllllIIII[1]);
                WorldArea var6 = new WorldArea(llllllIIII[32], llllllIIII[33], llllllIIII[3], llllllIIII[7], llllllIIII[1]);
                if (!y.llIlIlIlllIII(var12.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || y.llIlIlIllIllI(var6.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (y.llIlIlIllllll(e.j(gp), llllllIIII[3])) {
                ...
                var2 = new WorldArea(llllllIIII[88], llllllIIII[72], llllllIIII[18], llllllIIII[6], llllllIIII[0]);
                var36 = new WorldPoint(llllllIIII[32], llllllIIII[67], llllllIIII[0]);
                var11 = new WorldPoint(llllllIIII[32], llllllIIII[37], llllllIIII[0]);
                var26 = new WorldPoint(llllllIIII[32], llllllIIII[56], llllllIIII[0]);
                if (!(y.llIlIlIlllIII(Players.getLocal().getWorldLocation().equals((Object)new WorldPoint(llllllIIII[89], llllllIIII[37], llllllIIII[0])) ? 1 : 0) && y.llIlIlIlllIII(var2.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && y.llIlIlIlllIII(Players.getLocal().getWorldLocation().equals((Object)var36) ? 1 : 0) && y.llIlIlIlllIII(Players.getLocal().getWorldLocation().equals((Object)var11) ? 1 : 0) && !y.llIlIlIllIllI(Players.getLocal().getWorldLocation().equals((Object)var26) ? 1 : 0))) {
                ...
                if (y.llIlIlIllIllI((var3 = new WorldArea(llllllIIII[55], llllllIIII[56], llllllIIII[13], llllllIIII[7], llllllIIII[0])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    String[] stringArray = new String[llllllIIII[0]];
                ...
                var28 = new WorldArea(llllllIIII[30], llllllIIII[22], llllllIIII[35], llllllIIII[3], llllllIIII[1]);
                ...
                if (y.llIlIlIllIllI(var28.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && y.llIlIlIlllIlI(var10)) {
                ...
                if (!y.llIlIlIlllIII(Players.getLocal().getWorldLocation().equals((Object)new WorldPoint(llllllIIII[88], llllllIIII[22], llllllIIII[1])) ? 1 : 0) || y.llIlIlIllIllI(var28.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    var10 = NPCs.getNearest(nPC -> {
                        int n2;
                    ...
                    if (y.llIlIlIlllIII(Dialog.isOpen() ? 1 : 0) && y.llIlIllIIIIIl(var10)) {
                        String[] stringArray = new String[llllllIIII[0]];
                ...
                var31 = new WorldArea(llllllIIII[89], llllllIIII[48], llllllIIII[38], llllllIIII[5], llllllIIII[0]);
                var30 = new WorldArea(llllllIIII[124], llllllIIII[67], llllllIIII[6], llllllIIII[34], llllllIIII[0]);
                if (!y.llIlIlIlllIII(Players.getLocal().getWorldLocation().equals((Object)new WorldPoint(llllllIIII[89], llllllIIII[48], llllllIIII[0])) ? 1 : 0) || !y.llIlIlIlllIII(var31.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || y.llIlIlIllIllI(var30.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (y.llIlIlIllllll(e.j(gp), llllllIIII[5])) {
                var2 = new WorldArea(llllllIIII[32], llllllIIII[27], llllllIIII[34], llllllIIII[19], llllllIIII[0]);
                if (y.llIlIlIllIllI(var2.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    int[] nArray = new int[llllllIIII[0]];
                ...
                if (y.llIlIlIlllIII(var2.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    if (!y.llIlIlIllllIl(Players.getLocal().getWorldLocation().distanceTo(gf), llllllIIII[7]) || y.llIlIlIlllllI(Players.getLocal().getWorldLocation().getPlane(), llllllIIII[3])) {
    ...
    private static String llIlIlIlIIIll(String var24, String var37) {
        try {
            SecretKeySpec var27 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var37.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var1 = Cipher.getInstance("Blowfish");
            var1.init(llllllIIII[3], var27);
    ...
    private static String llIlIlIlIIIlI(String var19, String var4) {
        ...
        char[] var25 = var4.toCharArray();
        int var34 = llllllIIII[1];
        char[] var14 = var19.toCharArray();
        int var35 = var14.length;
        int var29 = llllllIIII[1];
        while (y.llIlIlIllIlll(var29, var35)) {
            char var40 = var14[var29];
            var33.append((char)(var40 ^ var25[var34 % var25.length]));
            0;
            ++var34;
            ++var29;
            0;
    ...
    private static String llIlIlIlIIIIl(String var32, String var20) {
        try {
            SecretKeySpec var7 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var20.getBytes(StandardCharsets.UTF_8)), llllllIIII[20]), "DES");
            Cipher var39 = Cipher.getInstance("DES");
            var39.init(llllllIIII[3], var7);
            return new String(var39.doFinal(Base64.getDecoder().decode(var32.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
