...
implements S {
    ...
    private static void ae() {
        ...
        if (K.llIllIIlIlIlI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var6 = new d(llllllllll[4], llllllllll[15], llllllllll[47]);
            bu.add((d)var6);
            0;
        }
        if (K.llIllIIlIlIlI(Bank.contains(var6 = item -> item.getName().toLowerCase().contains(lllllllllI[llllllllll[53]])) ? 1 : 0)) {
            var12 = new d(llllllllll[48], llllllllll[8], llllllllll[49]);
            bu.add(var12);
            0;
        }
        int[] nArray3 = new int[llllllllll[1]];
        ...
        if (K.llIllIIlIlIlI(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var12 = new d(llllllllll[11], llllllllll[15], llllllllll[50]);
            bu.add(var12);
            0;
        }
        ...
        if (K.llIllIIlIlIlI(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var12 = new d(llllllllll[13], llllllllll[31], llllllllll[50]);
            bu.add(var12);
            0;
        }
        ...
        if (K.llIllIIlIlIlI(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var12 = new d(llllllllll[12], llllllllll[8], i.bp);
            bu.add(var12);
            0;
        }
    }
    ...
    private static String llIllIIlIIIIl(String var21, String var15) {
        ...
        int var3 = llllllllll[0];
        char[] var17 = var21.toCharArray();
        int var2 = var17.length;
        int var22 = llllllllll[0];
        while (K.llIllIIlIlIIl(var22, var2)) {
            char var16 = var17[var22];
            var4.append((char)(var16 ^ var19[var3 % var19.length]));
            0;
            ++var3;
            ++var22;
            0;
    ...
    private static String llIllIIlIIIII(String var8, String var7) {
        try {
            SecretKeySpec var14 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var7.getBytes(StandardCharsets.UTF_8)), llllllllll[18]), "DES");
            Cipher var18 = Cipher.getInstance("DES");
            var18.init(llllllllll[3], var14);
    ...
    public static void cY() {
        ...
        if (K.llIllIIlIlIlI(bs ? 1 : 0)) {
            ...
            if (K.llIllIIlIlIlI(K.aa() ? 1 : 0) && K.llIllIIlIlIIl(e.j(llllllllll[6]), llllllllll[1])) {
                ...
                if (K.llIllIIlIllIl(var11) && K.llIllIIlIlIlI(var11.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderTempleTrek.c = lllllllllI[llllllllll[7]];
                    a.a(var11);
                    Time.sleepTicks((int)llllllllll[3]);
                    0;
                }
                if (K.llIllIIlIllIl(var11) && K.llIllIIlIlIII(var11.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (K.llIllIIlIlIII(K.aa() ? 1 : 0) && K.llIllIIlIlIIl(e.j(llllllllll[6]), llllllllll[1])) {
                var11 = new WorldArea(llllllllll[16], llllllllll[17], llllllllll[18], llllllllll[19], llllllllll[0]);
                ...
                if (K.llIllIIlIlllI(var9) && K.llIllIIlIllll(Players.getLocal().getWorldLocation().distanceTo(hU), llllllllll[5]) && K.llIllIIlIlIlI(AccBuilderTempleTrek.d ? 1 : 0)) {
            ...
            if (K.llIllIIllIIII(e.j(llllllllll[6]), llllllllll[1])) {
                ...
                if (K.llIllIIllIIIl(Players.getLocal().getWorldLocation().distanceTo(hV), llllllllll[14])) {
                    ...
                    if (K.llIllIIlIllIl(var11)) {
                        String[] stringArray2 = new String[llllllllll[1]];
                        stringArray2[K.llllllllll[0]] = lllllllllI[llllllllll[24]];
                        if (K.llIllIIlIlIII(var11.hasAction(stringArray2) ? 1 : 0)) {
                            var11.interact(lllllllllI[llllllllll[25]]);
            ...
            if (K.llIllIIllIIII(e.j(llllllllll[6]), llllllllll[3])) {
                ...
                if (K.llIllIIllIIIl(Players.getLocal().getWorldLocation().distanceTo(hW), llllllllll[3])) {
                    ...
                    var11 = NPCs.getNearest((String[])stringArray);
                    if (K.llIllIIlIllIl(var11)) {
                        g.a(lllllllllI[llllllllll[32]], hT);
                    }
                    if (K.llIllIIlIlllI(var11)) {
            ...
            if (K.llIllIIllIIII(e.j(llllllllll[6]), llllllllll[5])) {
                ...
                if (K.llIllIIllIIIl(Players.getLocal().getWorldLocation().distanceTo(hX), llllllllll[5])) {
                    ...
                    var11 = TileObjects.getNearest((String[])stringArray);
                    if (K.llIllIIlIllIl(var11)) {
                        var11.interact(lllllllllI[llllllllll[38]]);
                    }
                }
            }
            if (K.llIllIIllIIII(e.j(llllllllll[6]), llllllllll[7])) {
                ...
                if (K.llIllIIllIIIl(Players.getLocal().getWorldLocation().distanceTo(hW), llllllllll[3])) {
                    ...
                    if (K.llIllIIlIllIl(var11)) {
                        ...
                        if (K.llIllIIlIlIII(var11.hasAction(stringArray4) ? 1 : 0)) {
                            var11.interact(lllllllllI[llllllllll[44]]);
                            Time.sleepTicks((int)llllllllll[3]);
                            0;
                        }
    ...
    private static String llIllIIlIIIlI(String var13, String var20) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var20.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var1 = Cipher.getInstance("Blowfish");
            var1.init(llllllllll[3], var5);
