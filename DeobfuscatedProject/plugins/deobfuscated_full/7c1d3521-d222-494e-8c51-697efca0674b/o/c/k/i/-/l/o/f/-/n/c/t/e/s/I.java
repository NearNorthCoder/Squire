...
public class I {
    ...
    private static String llIIIIIllllll(String var12, String var9) {
        ...
        int var4 = lllIIllIlI[0];
        while (I.llIIIIlIIIlIl(var4, var3)) {
            char var6 = var18[var4];
            var19.append((char)(var6 ^ var10[var2 % var10.length]));
            0;
            ++var2;
            ++var4;
            0;
    ...
    private static String llIIIIlIIIIII(String var14, String var5) {
        try {
    ...
    private static String llIIIIlIIIIIl(String var1, String var15) {
        try {
            SecretKeySpec var11 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var15.getBytes(StandardCharsets.UTF_8)), lllIIllIlI[11]), "DES");
            Cipher var8 = Cipher.getInstance("DES");
            var8.init(lllIIllIlI[2], var11);
        ...
        block28: {
                        ...
                        block33: {
                            block32: {
                                block30: {
                                    ...
                                    if (I.llIIIIlIIIlll(var22) && I.llIIIIlIIIllI(var22.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                        AccBuilderSotf.c = lllIIllIIl[lllIIllIlI[3]];
                                        a.a(var22);
                                    }
                                    if (!I.llIIIIlIIIlll(var22) || !I.llIIIIlIIIlII(var22.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block29;
            ...
            if (I.llIIIIlIIIlII(I.cn() ? 1 : 0)) {
                ...
                if (I.llIIIIlIIIllI(Bank.isOpen() ? 1 : 0)) {
                    ...
                    int var22 = lllIIllIlI[0];
                    while (I.llIIIIlIIIlIl(var22, ge.length)) {
                        int[] nArray = new int[lllIIllIlI[1]];
                        nArray[I.lllIIllIlI[0]] = ge[var22];
                        Item var7 = Inventory.getFirst((int[])nArray);
                        if (I.llIIIIlIIIlll(var7)) {
                            int[] nArray13 = new int[lllIIllIlI[1]];
                            nArray13[I.lllIIllIlI[0]] = var7.getId();
                            if (I.llIIIIlIIIlII(Inventory.contains((int[])nArray13) ? 1 : 0)) {
                                String[] stringArray = new String[lllIIllIlI[1]];
                                stringArray[I.lllIIllIlI[0]] = lllIIllIIl[lllIIllIlI[10]];
                                if (I.llIIIIlIIIlII(var7.hasAction(stringArray) ? 1 : 0)) {
                                    var7.interact(lllIIllIIl[lllIIllIlI[11]]);
                                    Time.sleepTicks((int)lllIIllIlI[1]);
                                    0;
                                }
                                String[] stringArray2 = new String[lllIIllIlI[1]];
                                stringArray2[I.lllIIllIlI[0]] = lllIIllIIl[lllIIllIlI[12]];
                                if (I.llIIIIlIIIlII(var7.hasAction(stringArray2) ? 1 : 0)) {
                                    var7.interact(lllIIllIIl[lllIIllIlI[13]]);
                                    Time.sleepTicks((int)lllIIllIlI[1]);
                                    0;
                                }
                                String[] stringArray3 = new String[lllIIllIlI[1]];
                                stringArray3[I.lllIIllIlI[0]] = lllIIllIIl[lllIIllIlI[14]];
                                if (I.llIIIIlIIIlII(var7.hasAction(stringArray3) ? 1 : 0)) {
                                    var7.interact(lllIIllIIl[lllIIllIlI[15]]);
                                    Time.sleepTicks((int)lllIIllIlI[1]);
                                    0;
                                }
                                Time.sleepTicks((int)lllIIllIlI[1]);
    ...
    public static void Q() {
        ...
        if (I.llIIIIlIIIllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var21 = new d(gd, lllIIllIlI[1], lllIIllIlI[22]);
            bv.add((d)var21);
            0;
        }
        int[] nArray3 = new int[lllIIllIlI[1]];
        ...
        if (I.llIIIIlIIIllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var21 = new d(lllIIllIlI[8], lllIIllIlI[1], lllIIllIlI[23]);
            bv.add((d)var21);
            0;
        }
        int[] nArray4 = new int[lllIIllIlI[1]];
        ...
        if (I.llIIIIlIIIllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var21 = new d(lllIIllIlI[7], lllIIllIlI[1], lllIIllIlI[24]);
            bv.add((d)var21);
            0;
        }
        int[] nArray5 = new int[lllIIllIlI[1]];
        ...
        if (I.llIIIIlIIIllI(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var21 = new d(lllIIllIlI[25], lllIIllIlI[5], lllIIllIlI[13]);
            bv.add((d)var21);
            0;
        }
        int[] nArray6 = new int[lllIIllIlI[1]];
        ...
        if (I.llIIIIlIIIllI(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var21 = new d(lllIIllIlI[26], lllIIllIlI[27], lllIIllIlI[13]);
            bv.add((d)var21);
            0;
        }
        int[] nArray7 = new int[lllIIllIlI[1]];
        ...
        if (I.llIIIIlIIIllI(Bank.contains((int[])nArray7) ? 1 : 0)) {
            var21 = new d(lllIIllIlI[28], lllIIllIlI[29], lllIIllIlI[13]);
            bv.add((d)var21);
            0;
        }
        int[] nArray8 = new int[lllIIllIlI[1]];
        ...
        if (I.llIIIIlIIIllI(Bank.contains((int[])nArray8) ? 1 : 0)) {
            var21 = new d(lllIIllIlI[30], lllIIllIlI[31], lllIIllIlI[13]);
            bv.add((d)var21);
            0;
        }
        int[] nArray9 = new int[lllIIllIlI[1]];
        ...
        if (I.llIIIIlIIIllI(Bank.contains((Predicate)(var21 = item -> item.getName().toLowerCase().contains(lllIIllIIl[lllIIllIlI[40]]))) ? 1 : 0)) {
            var17 = new d(lllIIllIlI[33], lllIIllIlI[6], lllIIllIlI[34]);
            bv.add(var17);
            0;
        }
        ...
        if (I.llIIIIlIIIllI(Bank.contains((int[])nArray17) ? 1 : 0)) {
            var17 = new d(lllIIllIlI[35], lllIIllIlI[36], lllIIllIlI[37]);
            bv.add(var17);
            0;
        }
    }
