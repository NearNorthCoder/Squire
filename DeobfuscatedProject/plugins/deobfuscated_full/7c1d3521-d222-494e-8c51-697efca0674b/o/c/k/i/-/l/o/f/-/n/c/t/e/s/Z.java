...
implements ac {
    ...
    private static String lIllIIllIIIlI(String var12, String var13) {
        try {
    ...
    private static void Q() {
        ...
        if (Z.lIllIIllIllll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var3 = new d(llIlIlIlll[9], llIlIlIlll[1], llIlIlIlll[49]);
            bv.add((d)var3);
            0;
        }
        if (Z.lIllIIllIllll(Bank.contains(var3 = item -> item.getName().toLowerCase().contains(llIlIlIIIl[llIlIlIlll[54]])) ? 1 : 0)) {
            var1 = new d(llIlIlIlll[50], llIlIlIlll[10], llIlIlIlll[51]);
            bv.add(var1);
            0;
        }
        ...
        if (Z.lIllIIllIllll(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var1 = new d(llIlIlIlll[11], llIlIlIlll[20], llIlIlIlll[52]);
            bv.add(var1);
            0;
        }
    }
    ...
    private static String lIllIIllIIIIl(String var7, String var23) {
        var7 = new String(Base64.getDecoder().decode(var7.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var15 = new StringBuilder();
        char[] var19 = var23.toCharArray();
        int var16 = llIlIlIlll[0];
        char[] var5 = var7.toCharArray();
        int var2 = var5.length;
        int var18 = llIlIlIlll[0];
        while (Z.lIllIIllIlllI(var18, var2)) {
            char var11 = var5[var18];
            var15.append((char)(var11 ^ var19[var16 % var19.length]));
            0;
            ++var16;
            ++var18;
            0;
    ...
    private static void dA() {
        ...
        if (Z.lIllIIlllIIIl(var10) && Z.lIllIIllIllIl(var10.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String lIllIIllIIIll(String var20, String var22) {
        try {
            SecretKeySpec var21 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var22.getBytes(StandardCharsets.UTF_8)), llIlIlIlll[13]), "DES");
            Cipher var4 = Cipher.getInstance("DES");
            var4.init(llIlIlIlll[3], var21);
        ...
        block52: {
            ...
            block54: {
                ...
                if (Z.lIllIIllIlllI(e.j(llIlIlIlll[5]), llIlIlIlll[1])) {
                    ...
                    if (Z.lIllIIlllIIIl(var14) && Z.lIllIIllIllll(var14.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderSotf.c = llIlIlIIIl[llIlIlIlll[6]];
                        a.a(var14);
                        Time.sleepTicks((int)llIlIlIlll[3]);
                        0;
                    }
                    if (Z.lIllIIlllIIIl(var14) && Z.lIllIIllIllIl(var14.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (Z.lIllIIlllIlII(e.j(llIlIlIlll[5]), llIlIlIlll[12])) {
                ...
                if (Z.lIllIIlllIIll(Players.getLocal().getWorldLocation().distanceTo(mE), llIlIlIlll[3])) {
                    ...
                    if (Z.lIllIIlllIIIl(var14)) {
                        var14.interact(llIlIlIIIl[llIlIlIlll[18]]);
            ...
            if (Z.lIllIIlllIlII(e.j(llIlIlIlll[5]), llIlIlIlll[2])) {
                ...
                if (Z.lIllIIllIllIl(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    ...
                    if (Z.lIllIIlllIIll(Players.getLocal().getWorldLocation().distanceTo(mE), llIlIlIlll[3])) {
                        ...
                        if (Z.lIllIIlllIIIl(var14)) {
                            var14.interact(llIlIlIIIl[llIlIlIlll[39]]);
                            Time.sleepTicks((int)llIlIlIlll[6]);
                            0;
                        }
