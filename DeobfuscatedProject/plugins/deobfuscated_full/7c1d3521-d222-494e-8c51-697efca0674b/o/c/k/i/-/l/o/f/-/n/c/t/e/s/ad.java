...
implements ac {
    ...
    private static String lIlllIIIIIIlI(String var31, String var49) {
        ...
        char[] var14 = var49.toCharArray();
        int var7 = llIlllIIII[0];
        char[] var54 = var31.toCharArray();
        int var15 = var54.length;
        int var47 = llIlllIIII[0];
        while (ad.lIlllIIlIlIIl(var47, var15)) {
            char var45 = var54[var47];
            var68.append((char)(var45 ^ var14[var7 % var14.length]));
            0;
            ++var7;
            ++var47;
            0;
    ...
    private static String lIlllIIIIIIll(String var16, String var52) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var52.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var17 = Cipher.getInstance("Blowfish");
            var17.init(llIlllIIII[3], var5);
    ...
    private static void eC() {
        ...
        if (ad.lIlllIIlIllll(Players.getLocal().getAnimation(), llIlllIIII[62]) && ad.lIlllIIlIlIlI(Players.getLocal().isMoving() ? 1 : 0)) {
            ...
            TileItem var55 = TileItems.getNearest((String[])stringArray);
            if (ad.lIlllIIlIlIll(var55) && ad.lIlllIIlIlIII(ad.eF() ? 1 : 0)) {
                AccBuilderSotf.c = llIllIllIl[llIlllIIII[98]];
                System.out.println(llIllIllIl[llIlllIIII[99]]);
                var55.interact(llIllIllIl[llIlllIIII[100]]);
            ...
            if (ad.lIlllIIlIlIlI(ad.eF() ? 1 : 0)) {
                ...
                int var42;
                void var41;
                if (ad.lIlllIIlIlIII(var41.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(ad.eF() ? 1 : 0)) {
                    AccBuilderSotf.c = llIllIllIl[llIlllIIII[101]];
                    var42 = Skills.getExperience((Skill)Skill.AGILITY);
                    ...
                    Time.sleepUntil(() -> {
                        boolean bl;
                        if (ad.lIlllIIlIllII(Skills.getExperience((Skill)Skill.AGILITY), var42)) {
                            bl = llIlllIIII[1];
                            0;
                            if (((96 + 161 - 88 + 80 ^ 21 + 39 - -2 + 135) & (0x48 ^ 0x4D ^ (0xA2 ^ 0x9B) ^ -1)) >= 2) {
                                return ((0xC5 ^ 0xAD ^ (0xBC ^ 0x8E)) & (0x46 ^ 0x14 ^ (0x61 ^ 0x69) ^ -1)) != 0;
                            }
                        } else {
                            bl = llIlllIIII[0];
                        }
                ...
                if (ad.lIlllIIlIlIII(var4.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(ad.eF() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (ad.lIlllIIlIllII(Skills.getExperience((Skill)Skill.AGILITY), var42)) {
                            ...
                            0;
                            if (3 <= 2) {
                                return ((31 + 2 - 32 + 211 ^ 122 + 102 - 206 + 136) & (0x6C ^ 0x7B ^ (0x51 ^ 8) ^ -1)) != 0;
                            }
                        } else {
                            bl = llIlllIIII[0];
                        }
                ...
                if (ad.lIlllIIlIlIII(var27.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(ad.eF() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (ad.lIlllIIlIllII(Skills.getExperience((Skill)Skill.AGILITY), var42)) {
                            bl = llIlllIIII[1];
                            0;
                            if (((0xB6 ^ 0xC1 ^ (0x37 ^ 0x47)) & (0xC ^ 0x24 ^ (0x2D ^ 2) ^ -1)) >= 2) {
                                return ((55 + 61 - 45 + 81 ^ 67 + 77 - 131 + 121) & (0x71 ^ 0x19 ^ (0xC6 ^ 0xB0) ^ -1)) != 0;
                            }
                        } else {
                            bl = llIlllIIII[0];
                        }
                ...
                if (ad.lIlllIIlIlIII(var70.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(ad.eF() ? 1 : 0)) {
                ...
                if (ad.lIlllIIlIlIII(var62.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(ad.eF() ? 1 : 0)) {
                ...
                if (ad.lIlllIIlIlIII(var26.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(ad.eF() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (ad.lIlllIIlIllII(Skills.getExperience((Skill)Skill.AGILITY), var42)) {
                            ...
                            0;
                            if (-3 > 0) {
                                return ((0xD4 ^ 0xA2 ^ (0x8D ^ 0xAE)) & (0x55 ^ 0x1E ^ (0xBF ^ 0xA1) ^ -1)) != 0;
                            }
                        } else {
                            bl = llIlllIIII[0];
                        }
                ...
                if (ad.lIlllIIlIlIII(var40.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(ad.eF() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (ad.lIlllIIlIllII(Skills.getExperience((Skill)Skill.AGILITY), var42)) {
                            bl = llIlllIIII[1];
                            0;
                            if (((0xCC ^ 0xB4 ^ (0x5B ^ 0x3A)) & (46 + 201 - 135 + 109 ^ 109 + 107 - 92 + 72 ^ -1)) != 0) {
                                return ((0x6C ^ 0x32 ^ (0x4A ^ 0x26)) & (0x76 ^ 0x45 ^ 1 ^ -1)) != 0;
                            }
                        } else {
                            bl = llIlllIIII[0];
                        }
                ...
                if (ad.lIlllIIlIlIII(var33.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(ad.eF() ? 1 : 0)) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (ad.lIlllIIlIllII(Skills.getExperience((Skill)Skill.AGILITY), var42)) {
                            bl = llIlllIIII[1];
                            0;
                            if ((0x3A ^ 0x70 ^ (0x67 ^ 0x29)) <= ((136 + 75 - 185 + 193 ^ 94 + 15 - 51 + 84) & (39 + 188 - 72 + 66 ^ 10 + 135 - 68 + 59 ^ -1))) {
                                return ((0x4F ^ 0x3D ^ (0xB8 ^ 0x8E)) & (0x96 ^ 0xA1 ^ (0x5E ^ 0x2D) ^ -1)) != 0;
                            }
                        } else {
                            bl = llIlllIIII[0];
                        }
                ...
                if (ad.lIlllIIlIlIII(var32.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(ad.eF() ? 1 : 0)) {
    ...
    public static void eA() {
        ...
        if (ad.lIlllIIlIlIlI(bt ? 1 : 0) && ad.lIlllIIlIlIIl(Skills.getLevel((Skill)Skill.AGILITY), llIlllIIII[2])) {
            if (ad.lIlllIIlIlIlI(ad.an() ? 1 : 0)) {
                BankLocation var53 = BankLocation.getNearest();
                if (ad.lIlllIIlIlIll(var53) && ad.lIlllIIlIlIlI(var53.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderSotf.c = llIllIllIl[llIlllIIII[3]];
                    WorldArea var1 = new WorldArea(llIlllIIII[4], llIlllIIII[5], llIlllIIII[6], llIlllIIII[7], llIlllIIII[0]);
                    if (ad.lIlllIIlIlIII(var1.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        WorldPoint var39 = new WorldPoint(llIlllIIII[8], llIlllIIII[9], llIlllIIII[0]);
                        if (ad.lIlllIIlIllII(Players.getLocal().getWorldLocation().distanceTo(var39), llIlllIIII[10])) {
                            Movement.walkTo((WorldPoint)var39);
                            0;
                            Time.sleepTicks((int)llIlllIIII[1]);
                            0;
                        }
                ...
                if (ad.lIlllIIlIlIll(var53) && ad.lIlllIIlIlIII(var53.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (ad.lIlllIIlIlIII(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (ad.lIlllIIlIlIII(Inventory.contains((int[])nArray2) ? 1 : 0)) {
                    ...
                    if (!(!ad.lIlllIIlIlIII(Inventory.contains((int[])nArray3) ? 1 : 0) || ad.lIlllIIlIlIlI(Inventory.contains(item -> item.getName().contains(llIllIllIl[llIlllIIII[207]])) ? 1 : 0) && !ad.lIlllIIlIlIII(Equipment.contains(item -> item.getName().contains(llIllIllIl[llIlllIIII[206]])) ? 1 : 0) || ad.lIlllIIlIlIlI(Inventory.contains((int[])f.bk) ? 1 : 0) && !ad.lIlllIIlIlIII(Equipment.contains((int[])f.bk) ? 1 : 0))) {
                        ...
                        return ((165 + 243 - 253 + 99 ^ 86 + 156 - 181 + 116) & (5 ^ 0x53 ^ (0x5F ^ 0x46) ^ -1)) != 0;
                    }
                }
            }
            n3 = llIlllIIII[0];
    ...
    private static boolean eF() {
        ...
        if (ad.lIlllIIlIlIll(TileItems.getNearest((int[])nArray))) {
            ...
            int var10 = llIlllIIII[0];
            while (ad.lIlllIIlIlIIl(var10, ((void)var63).length)) {
                int[] nArray2 = new int[llIlllIIII[1]];
                nArray2[ad.llIlllIIII[0]] = llIlllIIII[193];
                if (ad.lIlllIIlIlIII(var63[var10].contains(TileItems.getNearest((int[])nArray2).getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIII(var63[var10].contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    return llIlllIIII[1];
                }
                ++var10;
                0;
                if (2 >= ((0xC9 ^ 0x9D ^ (0x1F ^ 0x54)) & (0x1F ^ 0xC ^ (0xCC ^ 0xC0) ^ -1))) continue;
                return ((78 + 7 - -72 + 38 ^ 11 + 100 - -1 + 25) & (0x83 ^ 0x85 ^ (0x1C ^ 0x50) ^ -1)) != 0;
            }
        }
        return llIlllIIII[0];
    }
    ...
    private static void eE() {
        ...
        if (ad.lIlllIIlIlIlI(var24.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(var59.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(var48.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(var19.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
        ...
        if (ad.lIlllIIlIlIII(var24.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            if (ad.lIlllIIlIllII(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var18), llIlllIIII[21])) {
            ...
            if (ad.lIlllIIllIIII(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var18), llIlllIIII[21])) {
                AccBuilderSotf.c = llIllIllIl[llIlllIIII[174]];
                int var51 = Skills.getExperience((Skill)Skill.AGILITY);
                String[] stringArray = new String[llIlllIIII[1]];
                ...
                Time.sleepUntil(() -> {
                    boolean bl;
                    if (ad.lIlllIIlIllII(Skills.getExperience((Skill)Skill.AGILITY), var51)) {
                        bl = llIlllIIII[1];
                        0;
                        if ((0x29 ^ 0x2C) == 0) {
                            return false;
        ...
        TileItem var51 = TileItems.getNearest((String[])stringArray);
        if (ad.lIlllIIlIlIll(var51) && ad.lIlllIIlIlIII(ad.eF() ? 1 : 0)) {
            AccBuilderSotf.c = llIllIllIl[llIlllIIII[177]];
            System.out.println(llIllIllIl[llIlllIIII[178]]);
            var51.interact(llIllIllIl[llIlllIIII[179]]);
            Time.sleepTicks((int)llIlllIIII[10]);
            0;
        }
        if (ad.lIlllIIlIlIlI(ad.eF() ? 1 : 0)) {
            ...
            TileObject var71;
            void var6;
            if (ad.lIlllIIlIlIII(var6.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIll(var71 = TileObjects.getNearest(tileObject -> {
                int n2;
                if (ad.lIlllIIlIlIII(tileObject.getName().contains(llIllIllIl[llIlllIIII[218]]) ? 1 : 0) && ad.lIlllIIllIIII(tileObject.getWorldLocation().distanceTo(new WorldPoint(llIlllIIII[219], llIlllIIII[220], llIlllIIII[10])), llIlllIIII[3])) {
                    n2 = llIlllIIII[1];
                    0;
                    if (((0x6E ^ 0x67 ^ (0x4B ^ 0x77)) & (0x72 ^ 0x5B ^ (0xA5 ^ 0xB9) ^ -1)) == 1) {
                        return ((0x2E ^ 0x78 ^ (0x41 ^ 0xC)) & (0x11 ^ 0x7F ^ (0x3F ^ 0x4A) ^ -1)) != 0;
                    }
                } else {
                    n2 = llIlllIIII[0];
                }
                ...
                var71.interact(llIllIllIl[llIlllIIII[79]]);
                Time.sleepTicks((int)e.c(llIlllIIII[1], llIlllIIII[3]));
                0;
                Time.sleepUntil(() -> {
                    boolean bl;
                    if (ad.lIlllIIlIllII(Skills.getExperience((Skill)Skill.AGILITY), var43)) {
                        bl = llIlllIIII[1];
                        0;
                        if (2 != 2) {
                            return false;
            ...
            if (ad.lIlllIIlIlIII(var20.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIll(var71 = TileObjects.getNearest(tileObject -> {
                int n2;
                if (ad.lIlllIIlIlIII(tileObject.getName().contains(llIllIllIl[llIlllIIII[216]]) ? 1 : 0) && ad.lIlllIIllIIII(tileObject.getWorldLocation().distanceTo(new WorldPoint(llIlllIIII[217], llIlllIIII[128], llIlllIIII[3])), llIlllIIII[3])) {
                    n2 = llIlllIIII[1];
                    0;
                    if (((9 + 155 - 8 + 37 ^ 128 + 30 - 20 + 7) & (0x5F ^ 0x63 ^ (5 ^ 0x69) ^ -1)) != 0) {
                        return ((187 + 174 - 280 + 173 ^ 32 + 51 - 54 + 134) & (0x50 ^ 0x22 ^ (0x76 ^ 0x59) ^ -1)) != 0;
                    }
                } else {
                    n2 = llIlllIIII[0];
                }
                ...
                var43 = Skills.getExperience((Skill)Skill.AGILITY);
                var71.interact(llIllIllIl[llIlllIIII[182]]);
                Time.sleepTicks((int)e.c(llIlllIIII[1], llIlllIIII[3]));
                0;
                Time.sleepUntil(() -> {
                    boolean bl;
                    if (ad.lIlllIIlIllII(Skills.getExperience((Skill)Skill.AGILITY), var43)) {
                        bl = llIlllIIII[1];
                        0;
                        if (((0xAB ^ 0x89 ^ (0xB7 ^ 0xB1) & ~(5 ^ 3)) & (141 + 74 - 78 + 11 ^ 61 + 96 - 99 + 124 ^ -1)) < 0) {
                            return false;
                        }
                    } else {
                        bl = llIlllIIII[0];
            ...
            if (ad.lIlllIIlIlIII(var37.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIll(var71 = TileObjects.getNearest(tileObject -> {
                int n2;
                ...
                var43 = Skills.getExperience((Skill)Skill.AGILITY);
                var71.interact(llIllIllIl[llIlllIIII[184]]);
                Time.sleepTicks((int)e.c(llIlllIIII[1], llIlllIIII[3]));
                0;
                Time.sleepUntil(() -> {
                    boolean bl;
            ...
            if (ad.lIlllIIlIlIII(var56.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIll(var71 = TileObjects.getNearest(tileObject -> {
                int n2;
                ...
                var43 = Skills.getExperience((Skill)Skill.AGILITY);
                var71.interact(llIllIllIl[llIlllIIII[186]]);
                Time.sleepTicks((int)e.c(llIlllIIII[1], llIlllIIII[3]));
                0;
                Time.sleepUntil(() -> {
                    boolean bl;
                    if (ad.lIlllIIlIllII(Skills.getExperience((Skill)Skill.AGILITY), var43)) {
                        ...
                        0;
                        if (2 <= 0) {
                            return ((87 + 158 - 123 + 42 ^ 175 + 8 - 174 + 179) & (0xB0 ^ 0xB9 ^ (0x93 ^ 0x82) ^ -1)) != 0;
                        }
                    } else {
                        bl = llIlllIIII[0];
                    }
            ...
            if (ad.lIlllIIlIlIII(var69.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIll(var71 = TileObjects.getNearest(tileObject -> {
                int n2;
                ...
                var43 = Skills.getExperience((Skill)Skill.AGILITY);
                var71.interact(llIllIllIl[llIlllIIII[188]]);
                Time.sleepTicks((int)e.c(llIlllIIII[1], llIlllIIII[3]));
                0;
                Time.sleepUntil(() -> {
                    boolean bl;
                    if (ad.lIlllIIlIllII(Skills.getExperience((Skill)Skill.AGILITY), var43)) {
                        ...
                        0;
                        if (3 <= 0) {
                            return ((0x53 ^ 0x4E ^ (0x3A ^ 1)) & (147 + 85 - 127 + 85 ^ 74 + 69 - 111 + 120 ^ -1)) != 0;
                        }
                    } else {
                        bl = llIlllIIII[0];
                    }
    ...
    private static void eB() {
        ...
        if ((!ad.lIlllIIlIlIlI(mW.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !ad.lIlllIIlIlIlI(mX.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || ad.lIlllIIlIlIII(mY.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) && ad.lIlllIIlIllll(Players.getLocal().getAnimation(), llIlllIIII[62]) && ad.lIlllIIlIlIlI(Players.getLocal().isMoving() ? 1 : 0)) {
            ...
            void var60;
            void var21;
            if (ad.lIlllIIlIlIII(var21.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (ad.lIlllIIlIlIII(var60.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (ad.lIlllIIlIlIII(var65.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (ad.lIlllIIlIlIII(var9.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (ad.lIlllIIlIlIII(var34.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (ad.lIlllIIlIlIII(var38.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (ad.lIlllIIlIlIII(var8.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static void lIlllIIIIllll() {
        ...
        ad.llIllIllIl[ad.llIlllIIII[0]] = ad."Buying items";
        ad.llIllIllIl[ad.llIlllIIII[1]] = ad."Finished buying items, switching back to agility";
        ad.llIllIllIl[ad.llIlllIIII[3]] = ad."Navigating to bank";
        ad.llIllIllIl[ad.llIlllIIII[10]] = ad."Handling banking";
        ad.llIllIllIl[ad.llIlllIIII[17]] = ad."We are missing quest supplies, switching to BUYING";
        ad.llIllIllIl[ad.llIlllIIII[19]] = ad."Vial";
        ad.llIllIllIl[ad.llIlllIIII[21]] = ad."Vial";
        ad.llIllIllIl[ad.llIlllIIII[23]] = ad."Drop";
        ad.llIllIllIl[ad.llIlllIIII[25]] = ad."Drink";
        ad.llIllIllIl[ad.llIlllIIII[27]] = ad."Eat";
        ad.llIllIllIl[ad.llIlllIIII[12]] = ad."Nav to gnome course";
        ad.llIllIllIl[ad.llIlllIIII[49]] = ad."Crossing log";
        ad.llIllIllIl[ad.llIlllIIII[63]] = ad."Log balance";
        ad.llIllIllIl[ad.llIlllIIII[64]] = ad."Walk-across";
        ad.llIllIllIl[ad.llIlllIIII[53]] = ad."Climbing net";
        ad.llIllIllIl[ad.llIlllIIII[39]] = ad."Obstacle net";
        ad.llIllIllIl[ad.llIlllIIII[65]] = ad."Climb-over";
        ad.llIllIllIl[ad.llIlllIIII[66]] = ad."Climbing branch";
        ad.llIllIllIl[ad.llIlllIIII[54]] = ad."Tree branch";
        ad.llIllIllIl[ad.llIlllIIII[67]] = ad."Climb";
        ad.llIllIllIl[ad.llIlllIIII[41]] = ad."Crossing rope";
        ad.llIllIllIl[ad.llIlllIIII[68]] = ad."Balancing rope";
        ad.llIllIllIl[ad.llIlllIIII[61]] = ad."Walk-on";
        ad.llIllIllIl[ad.llIlllIIII[69]] = ad."Climbing down";
        ad.llIllIllIl[ad.llIlllIIII[70]] = ad."Tree branch";
        ad.llIllIllIl[ad.llIlllIIII[42]] = ad."Climb-down";
        ad.llIllIllIl[ad.llIlllIIII[71]] = ad."Climbing net";
        ad.llIllIllIl[ad.llIlllIIII[72]] = ad."Obstacle net";
        ad.llIllIllIl[ad.llIlllIIII[73]] = ad."Climb-over";
        ad.llIllIllIl[ad.llIlllIIII[74]] = ad."Crossing pipe";
        ad.llIllIllIl[ad.llIlllIIII[2]] = ad."Obstacle pipe";
        ad.llIllIllIl[ad.llIlllIIII[75]] = ad."Squeeze-through";
        ad.llIllIllIl[ad.llIlllIIII[95]] = ad."Nav to start";
        ad.llIllIllIl[ad.llIlllIIII[97]] = ad."Mark of grace";
        ad.llIllIllIl[ad.llIlllIIII[98]] = ad."Taking mark";
        ad.llIllIllIl[ad.llIlllIIII[99]] = ad."Found mark on ground";
        ad.llIllIllIl[ad.llIlllIIII[100]] = ad."Take";
        ad.llIllIllIl[ad.llIlllIIII[101]] = ad."Starting course";
        ad.llIllIllIl[ad.llIlllIIII[102]] = ad."Rough wall";
        ad.llIllIllIl[ad.llIlllIIII[103]] = ad."Climb";
        ad.llIllIllIl[ad.llIlllIIII[38]] = ad."Crossing clothes line";
        ad.llIllIllIl[ad.llIlllIIII[105]] = ad."Clothes line";
        ad.llIllIllIl[ad.llIlllIIII[106]] = ad."Cross";
        ad.llIllIllIl[ad.llIlllIIII[107]] = ad."Leaping";
        ad.llIllIllIl[ad.llIlllIIII[108]] = ad."Gap";
        ad.llIllIllIl[ad.llIlllIIII[109]] = ad."Leap";
        ad.llIllIllIl[ad.llIlllIIII[110]] = ad."Balancing";
        ad.llIllIllIl[ad.llIlllIIII[111]] = ad."Wall";
        ad.llIllIllIl[ad.llIlllIIII[112]] = ad."Balance";
        ad.llIllIllIl[ad.llIlllIIII[113]] = ad."Jumping gap";
        ad.llIllIllIl[ad.llIlllIIII[40]] = ad."Gap";
        ad.llIllIllIl[ad.llIlllIIII[7]] = ad."Leap";
        ad.llIllIllIl[ad.llIlllIIII[114]] = ad."Jumping gap 2";
        ad.llIllIllIl[ad.llIlllIIII[116]] = ad."Leap";
        ad.llIllIllIl[ad.llIlllIIII[117]] = ad."Jumping gap 3";
        ad.llIllIllIl[ad.llIlllIIII[119]] = ad."Leap";
        ad.llIllIllIl[ad.llIlllIIII[120]] = ad."Hurdle roof";
        ad.llIllIllIl[ad.llIlllIIII[122]] = ad."Hurdle";
        ad.llIllIllIl[ad.llIlllIIII[123]] = ad."Finishing course";
        ad.llIllIllIl[ad.llIlllIIII[124]] = ad."Edge";
        ad.llIllIllIl[ad.llIlllIIII[44]] = ad."Jump-off";
        ad.llIllIllIl[ad.llIlllIIII[140]] = ad."Nav to canafis course";
        ad.llIllIllIl[ad.llIlllIIII[6]] = ad."Nav to start";
        ad.llIllIllIl[ad.llIlllIIII[141]] = ad."Starting course";
        ad.llIllIllIl[ad.llIlllIIII[142]] = ad."Tall tree";
        ad.llIllIllIl[ad.llIlllIIII[143]] = ad."Climb";
        ad.llIllIllIl[ad.llIlllIIII[144]] = ad."Mark of grace";
        ad.llIllIllIl[ad.llIlllIIII[145]] = ad."Taking mark";
        ad.llIllIllIl[ad.llIlllIIII[146]] = ad."Found mark on ground";
        ad.llIllIllIl[ad.llIlllIIII[147]] = ad."Take";
        ad.llIllIllIl[ad.llIlllIIII[148]] = ad."Jumping gap 1";
        ad.llIllIllIl[ad.llIlllIIII[149]] = ad."Jump";
        ad.llIllIllIl[ad.llIlllIIII[150]] = ad."Jumping gap 2";
        ad.llIllIllIl[ad.llIlllIIII[151]] = ad."Jump";
        ad.llIllIllIl[ad.llIlllIIII[152]] = ad."Jumping gap 3";
        ad.llIllIllIl[ad.llIlllIIII[153]] = ad."Jump";
        ad.llIllIllIl[ad.llIlllIIII[154]] = ad."Jumping gap 4";
        ad.llIllIllIl[ad.llIlllIIII[155]] = ad."Jump";
        ad.llIllIllIl[ad.llIlllIIII[156]] = ad."Vaulting";
        ad.llIllIllIl[ad.llIlllIIII[157]] = ad."Vault";
        ad.llIllIllIl[ad.llIlllIIII[158]] = ad."Jumping gap 5";
        ad.llIllIllIl[ad.llIlllIIII[159]] = ad."Jump";
        ad.llIllIllIl[ad.llIlllIIII[160]] = ad."Jumping gap 6";
        ad.llIllIllIl[ad.llIlllIIII[161]] = ad."Jump";
        ad.llIllIllIl[ad.llIlllIIII[172]] = ad."Nav to canafis course";
        ad.llIllIllIl[ad.llIlllIIII[173]] = ad."Nav to start";
        ad.llIllIllIl[ad.llIlllIIII[174]] = ad."Starting course";
        ad.llIllIllIl[ad.llIlllIIII[175]] = ad."Wall";
        ad.llIllIllIl[ad.llIlllIIII[36]] = ad."Climb-up";
        ad.llIllIllIl[ad.llIlllIIII[176]] = ad."Mark of grace";
        ad.llIllIllIl[ad.llIlllIIII[177]] = ad."Taking mark";
        ad.llIllIllIl[ad.llIlllIIII[178]] = ad."Found mark on ground";
        ad.llIllIllIl[ad.llIlllIIII[179]] = ad."Take";
        ad.llIllIllIl[ad.llIlllIIII[180]] = ad."Jumping gap 1";
        ad.llIllIllIl[ad.llIlllIIII[79]] = ad."Jump";
        ad.llIllIllIl[ad.llIlllIIII[181]] = ad."cross rope";
        ad.llIllIllIl[ad.llIlllIIII[182]] = ad."Cross";
        ad.llIllIllIl[ad.llIlllIIII[183]] = ad."Jumping gap 3";
        ad.llIllIllIl[ad.llIlllIIII[184]] = ad."Jump";
        ad.llIllIllIl[ad.llIlllIIII[185]] = ad."Jumping gap 4";
        ad.llIllIllIl[ad.llIlllIIII[186]] = ad."Jump";
        ad.llIllIllIl[ad.llIlllIIII[187]] = ad."Jumping Edge";
        ad.llIllIllIl[ad.llIlllIIII[188]] = ad."Jump";
        ad.llIllIllIl[ad.llIlllIIII[194]] = ad."Found mark on ground";
        ad.llIllIllIl[ad.llIlllIIII[203]] = ad."Agility";
        ad.llIllIllIl[ad.llIlllIIII[204]] = ad."passage";
        ad.llIllIllIl[ad.llIlllIIII[205]] = ad."passage";
        ad.llIllIllIl[ad.llIlllIIII[206]] = ad."passage";
        ad.llIllIllIl[ad.llIlllIIII[207]] = ad."passage";
        ad.llIllIllIl[ad.llIlllIIII[208]] = ad."Edge";
        ad.llIllIllIl[ad.llIlllIIII[211]] = ad."Gap";
        ad.llIllIllIl[ad.llIlllIIII[213]] = ad."Gap";
        ad.llIllIllIl[ad.llIlllIIII[216]] = ad."Tightrope";
        ad.llIllIllIl[ad.llIlllIIII[218]] = ad."Gap";
        ad.llIllIllIl[ad.llIlllIIII[221]] = ad."Gap";
        ad.llIllIllIl[ad.llIlllIIII[224]] = ad."Gap";
        ad.llIllIllIl[ad.llIlllIIII[226]] = ad."Pole-vault";
        ad.llIllIllIl[ad.llIlllIIII[227]] = ad."Gap";
        ad.llIllIllIl[ad.llIlllIIII[230]] = ad."Gap";
        ad.llIllIllIl[ad.llIlllIIII[232]] = ad."Gap";
        ad.llIllIllIl[ad.llIlllIIII[233]] = ad."Gap";
    }
    ...
    private static void eD() {
        ...
        if (ad.lIlllIIlIlIlI(var36.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(var57.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(var2.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIlI(var66.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
        ...
        if (ad.lIlllIIlIlIII(var36.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            if (ad.lIlllIIlIllII(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var64), llIlllIIII[21])) {
            ...
            if (ad.lIlllIIllIIII(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var64), llIlllIIII[21])) {
                AccBuilderSotf.c = llIllIllIl[llIlllIIII[141]];
                int var11 = Skills.getExperience((Skill)Skill.AGILITY);
                String[] stringArray = new String[llIlllIIII[1]];
                ...
                Time.sleepUntil(() -> {
                    boolean bl;
                    if (ad.lIlllIIlIllII(Skills.getExperience((Skill)Skill.AGILITY), var11)) {
                        bl = llIlllIIII[1];
                        0;
                        if ((34 + 10 - 38 + 179 ^ 52 + 35 - -86 + 16) == 1) {
                            return ((31 + 152 - 167 + 143 ^ 3 + 99 - -39 + 6) & (0xDF ^ 0xBD ^ (0xFA ^ 0x94) ^ -1)) != 0;
                        }
                    } else {
                        bl = llIlllIIII[0];
                    }
        ...
        TileItem var11 = TileItems.getNearest((String[])stringArray);
        if (ad.lIlllIIlIlIll(var11) && ad.lIlllIIlIlIII(ad.eF() ? 1 : 0)) {
            AccBuilderSotf.c = llIllIllIl[llIlllIIII[145]];
            System.out.println(llIllIllIl[llIlllIIII[146]]);
            var11.interact(llIllIllIl[llIlllIIII[147]]);
            Time.sleepTicks((int)llIlllIIII[10]);
            0;
        }
        if (ad.lIlllIIlIlIlI(ad.eF() ? 1 : 0)) {
            ...
            TileObject var67;
            void var25;
            if (ad.lIlllIIlIlIII(var25.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIll(var67 = TileObjects.getNearest(tileObject -> {
                int n2;
                if (ad.lIlllIIlIlIII(tileObject.getName().contains(llIllIllIl[llIlllIIII[233]]) ? 1 : 0) && ad.lIlllIIllIIII(tileObject.getWorldLocation().distanceTo(new WorldPoint(llIlllIIII[234], llIlllIIII[131], llIlllIIII[3])), llIlllIIII[3])) {
                    n2 = llIlllIIII[1];
                    0;
                    if (((0x59 ^ 0x6F ^ (0x48 ^ 0x58)) & (0xEB ^ 0xA7 ^ (0xAE ^ 0xC4) ^ -1)) != 0) {
                        return ((0xB6 ^ 0xA2 ^ (0x39 ^ 0x69)) & (0x32 ^ 0x1B ^ (0x65 ^ 8) ^ -1)) != 0;
                    }
                } else {
                    n2 = llIlllIIII[0];
                }
                ...
                var44 = Skills.getExperience((Skill)Skill.AGILITY);
                AccBuilderSotf.c = llIllIllIl[llIlllIIII[148]];
                var67.interact(llIllIllIl[llIlllIIII[149]]);
                Time.sleepTicks((int)e.c(llIlllIIII[1], llIlllIIII[3]));
                0;
                Time.sleepUntil(() -> {
                    boolean bl;
                    if (ad.lIlllIIlIllII(Skills.getExperience((Skill)Skill.AGILITY), var44)) {
                        bl = llIlllIIII[1];
                        0;
                        if ((0x82 ^ 0x86) == 0) {
                            return false;
            ...
            if (ad.lIlllIIlIlIII(var50.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIll(var67 = TileObjects.getNearest(tileObject -> {
                int n2;
                ...
                var44 = Skills.getExperience((Skill)Skill.AGILITY);
                var67.interact(llIllIllIl[llIlllIIII[151]]);
                Time.sleepTicks((int)e.c(llIlllIIII[1], llIlllIIII[3]));
                0;
                Time.sleepUntil(() -> {
                    boolean bl;
            ...
            if (ad.lIlllIIlIlIII(var3.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIll(var67 = TileObjects.getNearest(tileObject -> {
                int n2;
                ...
                var44 = Skills.getExperience((Skill)Skill.AGILITY);
                var67.interact(llIllIllIl[llIlllIIII[153]]);
                Time.sleepTicks((int)e.c(llIlllIIII[1], llIlllIIII[3]));
                0;
                Time.sleepUntil(() -> {
                    boolean bl;
            ...
            if (ad.lIlllIIlIlIII(var58.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIll(var67 = TileObjects.getNearest(tileObject -> {
                int n2;
                ...
                var44 = Skills.getExperience((Skill)Skill.AGILITY);
                var67.interact(llIllIllIl[llIlllIIII[155]]);
                Time.sleepTicks((int)e.c(llIlllIIII[1], llIlllIIII[3]));
                0;
                Time.sleepUntil(() -> {
                    boolean bl;
            ...
            if (ad.lIlllIIlIlIII(var12.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIll(var67 = TileObjects.getNearest(tileObject -> {
                int n2;
                if (ad.lIlllIIlIlIII(tileObject.getName().contains(llIllIllIl[llIlllIIII[226]]) ? 1 : 0) && ad.lIlllIIllIIII(tileObject.getWorldLocation().distanceTo(new WorldPoint(llIlllIIII[9], llIlllIIII[130], llIlllIIII[3])), llIlllIIII[3])) {
                    ...
                    if (-(0xB3 ^ 0x88 ^ (0x1D ^ 0x22)) > 0) {
                        return ((0x7E ^ 0x1E ^ (6 ^ 0x7B)) & (8 ^ 0x1B ^ (0x9B ^ 0x95) ^ -1)) != 0;
                    }
                } else {
                    n2 = llIlllIIII[0];
                }
                ...
                var44 = Skills.getExperience((Skill)Skill.AGILITY);
                var67.interact(llIllIllIl[llIlllIIII[157]]);
                Time.sleepTicks((int)e.c(llIlllIIII[1], llIlllIIII[3]));
                0;
                Time.sleepUntil(() -> {
                    boolean bl;
            ...
            if (ad.lIlllIIlIlIII(var13.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIll(var67 = TileObjects.getNearest(tileObject -> {
                int n2;
                ...
                var44 = Skills.getExperience((Skill)Skill.AGILITY);
                var67.interact(llIllIllIl[llIlllIIII[159]]);
                Time.sleepTicks((int)e.c(llIlllIIII[1], llIlllIIII[3]));
                0;
                Time.sleepUntil(() -> {
                    boolean bl;
            ...
            if (ad.lIlllIIlIlIII(var46.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ad.lIlllIIlIlIll(var67 = TileObjects.getNearest(tileObject -> {
                int n2;
                ...
                var44 = Skills.getExperience((Skill)Skill.AGILITY);
                var67.interact(llIllIllIl[llIlllIIII[161]]);
                Time.sleepTicks((int)e.c(llIlllIIII[1], llIlllIIII[3]));
                0;
                Time.sleepUntil(() -> {
                    boolean bl;
    ...
    private static void lIlllIIlIIlll() {
        ...
        ad.llIlllIIII[15] = -3 & (0xFFFFBFDB & 0x5F6F);
    ...
    private static String lIlllIIIIIIIl(String var23, String var22) {
        try {
            SecretKeySpec var28 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var22.getBytes(StandardCharsets.UTF_8)), llIlllIIII[25]), "DES");
            Cipher var30 = Cipher.getInstance("DES");
            var30.init(llIlllIIII[3], var28);
            return new String(var30.doFinal(Base64.getDecoder().decode(var23.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void Q() {
        ...
        block18: {
                ...
                block16: {
                    block15: {
                        ...
                        if (ad.lIlllIIlIlIlI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                            var35 = new d(llIlllIIII[18], llIlllIIII[3], llIlllIIII[196]);
                            bv.add(var35);
                            0;
                        }
                        int[] nArray3 = new int[llIlllIIII[1]];
                        ...
                        if (ad.lIlllIIlIlIlI(Bank.contains((int[])nArray3) ? 1 : 0)) {
                            var35 = new d(llIlllIIII[28], llIlllIIII[3], llIlllIIII[196]);
                            bv.add(var35);
                            0;
                        }
                        int[] nArray4 = new int[llIlllIIII[1]];
                        ...
                        if (ad.lIlllIIlIlIlI(Bank.contains((int[])nArray4) ? 1 : 0)) {
                            var35 = new d(llIlllIIII[13], llIlllIIII[12], llIlllIIII[197]);
                            bv.add(var35);
                            0;
                        }
                        int[] nArray5 = new int[llIlllIIII[1]];
                        ...
                        if (ad.lIlllIIlIlIlI(Bank.contains((int[])nArray5) ? 1 : 0)) {
                            var35 = new d(llIlllIIII[22], llIlllIIII[12], llIlllIIII[198]);
                            bv.add(var35);
                            0;
                        }
                        int[] nArray6 = new int[llIlllIIII[1]];
                        ...
                        if (ad.lIlllIIlIlIlI(Bank.contains((int[])nArray6) ? 1 : 0)) {
                            var35 = new d(llIlllIIII[15], llIlllIIII[12], llIlllIIII[198]);
                            bv.add(var35);
                            0;
                        }
                        ...
                        if (ad.lIlllIIlIlIlI(Bank.contains((int[])nArray7) ? 1 : 0)) {
                            var35 = new d(llIlllIIII[14], llIlllIIII[12], llIlllIIII[198]);
                            bv.add(var35);
                            0;
                        }
                    ...
                    var35 = new d(mU, llIlllIIII[44], llIlllIIII[199]);
                    bv.add(var35);
                    0;
                }
                int[] nArray = new int[llIlllIIII[1]];
            ...
            var35 = new d(llIlllIIII[26], llIlllIIII[12], llIlllIIII[200]);
            bv.add(var35);
            0;
        }
        int[] nArray = new int[llIlllIIII[1]];
        ...
        if (ad.lIlllIIlIlIlI(Bank.contains((int[])nArray) ? 1 : 0)) {
            var35 = new d(llIlllIIII[201], llIlllIIII[1], llIlllIIII[202]);
            bv.add(var35);
            0;
        }
        ...
        if (ad.lIlllIIlIlIlI(Bank.contains((int[])nArray13) ? 1 : 0)) {
            var35 = new d(llIlllIIII[20], llIlllIIII[41], j.cf);
            bv.add(var35);
            0;
        }
    }
