...
implements ac {
    ...
    private static String lIlIllIIIIIll(String var4, String var6) {
        var4 = new String(Base64.getDecoder().decode(var4.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var10 = new StringBuilder();
        char[] var17 = var6.toCharArray();
        int var8 = llIIllIlII[1];
        char[] var25 = var4.toCharArray();
        int var15 = var25.length;
        int var22 = llIIllIlII[1];
        while (A.lIlIllIIllIII(var22, var15)) {
            char var3 = var25[var22];
            var10.append((char)(var3 ^ var17[var8 % var17.length]));
            0;
            ++var8;
            ++var22;
            0;
    ...
    private static boolean an() {
        ...
        int[] nArray2 = nArray;
        int var19 = llIIllIlII[1];
        while (A.lIlIllIIllIII(var19, ((void)var12).length)) {
            int[] nArray3 = new int[llIIllIlII[0]];
            nArray3[A.llIIllIlII[1]] = var12[var19];
    ...
    private static void Q() {
        block35: {
                ...
                block33: {
                    block32: {
                        block31: {
                                ...
                                block29: {
                                    block28: {
                                        block27: {
                                                ...
                                                block25: {
                                                    block24: {
                                                        block23: {
                                                            ...
                                                            var18 = new d(llIIllIlII[9], llIIllIlII[8], llIIllIlII[18]);
                                                            bv.add((d)var18);
                                                            0;
                                                        }
                                                        int[] nArray = new int[llIIllIlII[0]];
                                                    ...
                                                    var18 = new d(llIIllIlII[7], llIIllIlII[8], llIIllIlII[18]);
                                                    bv.add((d)var18);
                                                    0;
                                                }
                                                int[] nArray = new int[llIIllIlII[0]];
                                            ...
                                            var18 = new d(llIIllIlII[10], llIIllIlII[8], llIIllIlII[18]);
                                            bv.add((d)var18);
                                            0;
                                        }
                                        int[] nArray = new int[llIIllIlII[0]];
                                    ...
                                    var18 = new d(llIIllIlII[15], llIIllIlII[33], llIIllIlII[80]);
                                    bv.add((d)var18);
                                    0;
                                }
                                if (A.lIlIllIIllIIl(Bank.contains((Predicate)(var18 = item -> item.getName().toLowerCase().contains(llIIllIIIl[llIIllIlII[87]]))) ? 1 : 0)) {
                                    var21 = new d(llIIllIlII[81], llIIllIlII[16], llIIllIlII[82]);
                                    bv.add(var21);
                                    0;
                                }
                                int[] nArray = new int[llIIllIlII[0]];
                            ...
                            var21 = new d(llIIllIlII[14], llIIllIlII[6], j.cf);
                            bv.add(var21);
                            0;
                        }
                        int[] nArray = new int[llIIllIlII[0]];
                    ...
                    var21 = new d(llIIllIlII[17], llIIllIlII[11], llIIllIlII[83]);
                    bv.add(var21);
                    0;
                }
                int[] nArray = new int[llIIllIlII[0]];
            ...
            var21 = new d(llIIllIlII[13], llIIllIlII[54], llIIllIlII[84]);
            bv.add(var21);
            0;
        }
    }
    ...
    private static String lIlIllIIIIlII(String var23, String var26) {
        try {
            SecretKeySpec var7 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var26.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var1 = Cipher.getInstance("Blowfish");
            var1.init(llIIllIlII[5], var7);
            ...
            block82: {
                block84: {
                    block83: {
                                ...
                                block79: {
                                    block80: {
                                        block78: {
                                            ...
                                            if (A.lIlIllIIllIll(var5) && A.lIlIllIIllIIl(var5.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                                AccBuilderSotf.c = llIIllIIIl[llIIllIlII[0]];
                                                a.a(var5);
                                            }
                                            if (!A.lIlIllIIllIll(var5) || !A.lIlIllIIlIlll(var5.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block77;
                        ...
                        var5 = new WorldPoint(llIIllIlII[68], llIIllIlII[69], llIIllIlII[1]);
                        if (A.lIlIllIIllllI(Players.getLocal().getWorldLocation().distanceTo(b.I), llIIllIlII[70]) && A.lIlIllIIlllIl(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var5), llIIllIlII[6])) {
                        ...
                        if (A.lIlIllIIllllI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var5), llIIllIlII[6]) && !A.lIlIllIIllllI(Players.getLocal().getWorldLocation().distanceTo(eh), llIIllIlII[54])) break block83;
                        ...
                        if (!A.lIlIllIlIIIII(NPCs.getNearest((String[])stringArray18)) || !A.lIlIllIIlllIl(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var5), llIIllIlII[70])) break block84;
                    }
                    WorldArea var14 = new WorldArea(llIIllIlII[73], llIIllIlII[74], llIIllIlII[43], llIIllIlII[37], llIIllIlII[1]);
                    ...
                    if (A.lIlIllIIlIlll(var14.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        WorldPoint var2 = new WorldPoint(llIIllIlII[77], llIIllIlII[78], llIIllIlII[1]);
                        Movement.walkTo((WorldPoint)var2);
                        0;
                        Time.sleepTicks((int)llIIllIlII[0]);
                        0;
                    }
                    if (A.lIlIllIIllIIl(var14.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        Movement.walkTo((WorldPoint)ed);
                        0;
                        Time.sleepTicks((int)llIIllIlII[0]);
                        0;
    ...
    private static String lIlIllIIIIlIl(String var20, String var24) {
        try {
            SecretKeySpec var9 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var24.getBytes(StandardCharsets.UTF_8)), llIIllIlII[23]), "DES");
            Cipher var11 = Cipher.getInstance("DES");
            var11.init(llIIllIlII[5], var9);
