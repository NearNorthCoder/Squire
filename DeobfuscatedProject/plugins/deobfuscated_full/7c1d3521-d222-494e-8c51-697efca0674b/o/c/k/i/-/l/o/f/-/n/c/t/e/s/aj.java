...
implements ac {
    ...
    private static int fM() {
        ...
        if (aj.llIIIIIlIIIlI(Skills.getLevel((Skill)Skill.HERBLORE), lllIIlIlII[8]) && aj.llIIIIIIlllIl(Skills.getLevel((Skill)Skill.HERBLORE), lllIIlIlII[12])) {
            void var15;
            return (int)((var15 - Skills.getExperience((Skill)Skill.HERBLORE)) / lllIIlIlII[29] + lllIIlIlII[30]);
        }
        return lllIIlIlII[1];
    }
    ...
    private static String llIIIIIIllIII(String var1, String var10) {
        try {
    ...
    private static String llIIIIIIlIlll(String var21, String var3) {
        ...
        int var18 = lllIIlIlII[0];
        char[] var20 = var21.toCharArray();
        int var5 = var20.length;
        int var22 = lllIIlIlII[0];
        while (aj.llIIIIIIlllIl(var22, var5)) {
            char var7 = var20[var22];
            var19.append((char)(var7 ^ var14[var18 % var14.length]));
            0;
            ++var18;
            ++var22;
            0;
    ...
    public static void Q() {
        ...
        if (aj.llIIIIIIlllIl(Skills.getLevel((Skill)Skill.HERBLORE), lllIIlIlII[8])) {
            ...
            if (aj.llIIIIIIllllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                var9 = new d(lllIIlIlII[11], aj.fM(), lllIIlIlII[22]);
                bv.add(var9);
                0;
            }
        }
        if (aj.llIIIIIlIIIlI(Skills.getLevel((Skill)Skill.HERBLORE), lllIIlIlII[8]) && aj.llIIIIIIlllIl(Skills.getLevel((Skill)Skill.HERBLORE), lllIIlIlII[12])) {
            ...
            nArray[aj.lllIIlIlII[0]] = lllIIlIlII[13];
            if (aj.llIIIIIIllllI(Bank.contains((int[])nArray) ? 1 : 0)) {
                var9 = new d(lllIIlIlII[13], aj.fM(), lllIIlIlII[23]);
                bv.add(var9);
                0;
            }
            int[] nArray3 = new int[lllIIlIlII[1]];
            ...
            if (aj.llIIIIIIllllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
                var9 = new d(lllIIlIlII[14], aj.fM(), lllIIlIlII[24]);
                bv.add(var9);
                0;
            }
        }
        if (aj.llIIIIIlIIIlI(Skills.getLevel((Skill)Skill.HERBLORE), lllIIlIlII[12])) {
            ...
            nArray[aj.lllIIlIlII[0]] = lllIIlIlII[9];
            if (aj.llIIIIIIllllI(Bank.contains((int[])nArray) ? 1 : 0)) {
                var9 = new d(lllIIlIlII[9], lllIIlIlII[20], lllIIlIlII[21]);
                bv.add(var9);
                0;
            }
            int[] nArray4 = new int[lllIIlIlII[1]];
            ...
            if (aj.llIIIIIIllllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
                var9 = new d(lllIIlIlII[15], lllIIlIlII[20], lllIIlIlII[25]);
                bv.add(var9);
                0;
            }
        }
    ...
    private static String llIIIIIIllIIl(String var2, String var16) {
        try {
            SecretKeySpec var4 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var16.getBytes(StandardCharsets.UTF_8)), lllIIlIlII[33]), "DES");
            Cipher var12 = Cipher.getInstance("DES");
            var12.init(lllIIlIlII[5], var4);
    ...
    public static void fL() {
        block26: {
            ...
            block28: {
                block27: {
                    ...
                    if (aj.llIIIIIIllllI(aj.an() ? 1 : 0) && aj.llIIIIIIlllll(e.j(lllIIlIlII[3]), lllIIlIlII[4])) {
                        ...
                        if (aj.llIIIIIlIIIII(var13) && aj.llIIIIIIllllI(var13.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            AccBuilderSotf.c = lllIIlIIll[lllIIlIlII[5]];
                            a.a(var13);
                        }
                        if (aj.llIIIIIlIIIII(var13) && aj.llIIIIIIlllII(var13.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (aj.llIIIIIlIIIII(var13 = Widgets.get((int)lllIIlIlII[17], (int)lllIIlIlII[18]))) {
