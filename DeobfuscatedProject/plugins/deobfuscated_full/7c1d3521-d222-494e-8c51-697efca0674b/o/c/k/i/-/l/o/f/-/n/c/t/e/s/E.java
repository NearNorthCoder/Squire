...
implements ac {
    ...
    private static String lIllIlIllIIll(String var3, String var13) {
        ...
        int var14 = llIllIIlIl[1];
        char[] var2 = var3.toCharArray();
        int var7 = var2.length;
        int var25 = llIllIIlIl[1];
        while (E.lIllIllIIlIll(var25, var7)) {
            char var11 = var2[var25];
            var5.append((char)(var11 ^ var12[var14 % var12.length]));
            0;
            ++var14;
            ++var25;
            0;
    ...
    private static String lIllIlIllIIlI(String var15, String var1) {
        try {
            SecretKeySpec var10 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var1.getBytes(StandardCharsets.UTF_8)), llIllIIlIl[23]), "DES");
            Cipher var24 = Cipher.getInstance("DES");
            var24.init(llIllIIlIl[4], var10);
    ...
    private static void lIllIllIIlIII() {
        ...
        E.llIllIIlIl[0] = 1;
        E.llIllIIlIl[1] = (0x6B ^ 0x4B ^ (0x29 ^ 0x33)) & (0x4A ^ 0x6A ^ (0xBC ^ 0xA6) ^ -1);
    ...
    private static String lIllIlIllIlII(String var17, String var18) {
        try {
            SecretKeySpec var23 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var18.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var9 = Cipher.getInstance("Blowfish");
            var9.init(llIllIIlIl[4], var23);
    ...
    public static void bV() {
        ...
        if (E.lIllIllIIllII(bt ? 1 : 0)) {
            ...
            if (E.lIllIllIIllII(E.an() ? 1 : 0) && E.lIllIllIIllIl(Skills.getLevel((Skill)Skill.AGILITY), llIllIIlIl[2]) && E.lIllIllIIllIl(Skills.getLevel((Skill)Skill.PRAYER), llIllIIlIl[3]) && E.lIllIllIIlIll(e.j(llIllIIlIl[9]), llIllIIlIl[0]) && E.lIllIllIIllIl(e.j(llIllIIlIl[5]), llIllIIlIl[6])) {
                ...
                if (E.lIllIllIIlllI(var22) && E.lIllIllIIllII(var22.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderSotf.c = llIllIIIlI[llIllIIlIl[10]];
                    a.a((BankLocation)var22);
                }
                if (E.lIllIllIIlllI(var22) && E.lIllIllIIlIlI(var22.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (!E.lIllIllIlIlII(e.j(llIllIIlIl[9]), llIllIIlIl[10]) || !E.lIllIllIlIlII(e.j(llIllIIlIl[9]), llIllIIlIl[27]) || E.lIllIllIlIIll(e.j(llIllIIlIl[9]), llIllIIlIl[37])) {
                ...
                if (E.lIllIllIlIIlI(Players.getLocal().getWorldLocation().distanceTo(fo), llIllIIlIl[27])) {
                    ...
                    if (E.lIllIllIIllII(var22.isEmpty() ? 1 : 0) && E.lIllIllIIlllI(llllllllllllllllllIIIlIIlllIlIll2 = (NPC)var22.stream().filter(nPC -> {
                        boolean bl;
                        ...
                        int var21 = llIllIIlIl[0];
                        int var8 = Static.getClient().getWorld();
                        while (E.lIllIllIIlIlI(var21)) {
                            ...
                            if (!E.lIllIllIlIlII(Static.getClient().getWorld(), var8)) continue;
                            var21 = llIllIIlIl[1];
                            0;
                            if (2 != 0) break;
                            return;
            ...
            if (E.lIllIllIlIIll(e.j(llIllIIlIl[9]), llIllIIlIl[54]) && E.lIllIllIIlIlI(fu.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                di = llIllIIlIl[1];
                var22 = new WorldPoint(llIllIIlIl[60], llIllIIlIl[61], llIllIIlIl[1]);
                llllllllllllllllllIIIlIIlllIlIll2 = new WorldPoint(llIllIIlIl[60], llIllIIlIl[62], llIllIIlIl[1]);
                WorldPoint var21 = new WorldPoint(llIllIIlIl[60], llIllIIlIl[63], llIllIIlIl[1]);
                WorldPoint var8 = new WorldPoint(llIllIIlIl[60], llIllIIlIl[64], llIllIIlIl[1]);
                if (E.lIllIllIlIIIl(Players.getLocal().getWorldLocation().distanceTo(fq), llIllIIlIl[10]) && E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals(var22) ? 1 : 0) && E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllIIIlIIlllIlIll2) ? 1 : 0) && E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals((Object)var8) ? 1 : 0) && E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals((Object)var21) ? 1 : 0) && E.lIllIllIIllII(ft.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (E.lIllIllIlIIlI(Players.getLocal().getWorldLocation().distanceTo(fq), llIllIIlIl[10]) && E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals(var22) ? 1 : 0) && E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllIIIlIIlllIlIll2) ? 1 : 0) && E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals((Object)var8) ? 1 : 0) && E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals((Object)var21) ? 1 : 0)) {
                    String[] stringArray = new String[llIllIIlIl[0]];
                ...
                if (!E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals(var22) ? 1 : 0) || !E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllIIIlIIlllIlIll2) ? 1 : 0) || !E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals((Object)var8) ? 1 : 0) || E.lIllIllIIlIlI(Players.getLocal().getWorldLocation().equals((Object)var21) ? 1 : 0)) {
                    String[] stringArray = new String[llIllIIlIl[0]];
                    stringArray[E.llIllIIlIl[1]] = llIllIIIlI[llIllIIlIl[68]];
                    TileObject var20 = TileObjects.getNearest((String[])stringArray);
                    if (E.lIllIllIIlllI(var20)) {
                        String[] stringArray2 = new String[llIllIIlIl[0]];
                        stringArray2[E.llIllIIlIl[1]] = llIllIIIlI[llIllIIlIl[69]];
                        if (E.lIllIllIIlIlI(var20.hasAction(stringArray2) ? 1 : 0)) {
                            AccBuilderSotf.c = llIllIIIlI[llIllIIlIl[70]];
                            var20.interact(llIllIIIlI[llIllIIlIl[71]]);
                            Time.sleepTicks((int)llIllIIlIl[4]);
                            0;
                        }
                    }
                }
                if (E.lIllIllIIlIlI(Players.getLocal().getWorldLocation().equals((Object)var8) ? 1 : 0)) {
                    String[] stringArray = new String[llIllIIlIl[0]];
                ...
                if (E.lIllIllIIlIlI(ft.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals(var22) ? 1 : 0) && E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals((Object)llllllllllllllllllIIIlIIlllIlIll2) ? 1 : 0) && E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals((Object)var8) ? 1 : 0) && E.lIllIllIIllII(Players.getLocal().getWorldLocation().equals((Object)var21) ? 1 : 0)) {
            ...
            if (E.lIllIllIlIIll(e.j(llIllIIlIl[9]), llIllIIlIl[77])) {
                if (E.lIllIllIIllII(Dialog.isOpen() ? 1 : 0)) {
                    ...
                    var22 = NPCs.getAll((String[])stringArray);
                    if (E.lIllIllIIllll(var22.size())) {
                        ((NPC)var22.get(llIllIIlIl[1])).interact(llIllIIIlI[llIllIIlIl[3]]);
                ...
                if (E.lIllIllIIlIlI(Dialog.isOpen() ? 1 : 0)) {
                    ...
                    if (E.lIllIllIIllII((var22 = Widgets.getChildren((int)llIllIIlIl[80], (int)llIllIIlIl[0], widget -> widget.isVisible())).isEmpty() ? 1 : 0)) {
                        int llllllllllllllllllIIIlIIlllIlIll2 = llIllIIlIl[1];
                        while (E.lIllIllIIlIll(llllllllllllllllllIIIlIIlllIlIll2, var22.size())) {
                            if ((!E.lIllIllIIllII(((Widget)var22.get(llIllIIlIl[1])).getText().contains(llIllIIIlI[llIllIIlIl[81]]) ? 1 : 0) || E.lIllIllIIlIlI(((Widget)var22.get(llIllIIlIl[1])).getText().contains(llIllIIIlI[llIllIIlIl[82]]) ? 1 : 0)) && E.lIllIllIIlIlI(((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getText().contains(llIllIIIlI[llIllIIlIl[83]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getX(), (int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getY(), (boolean)llIllIIlIl[0]);
                                Time.sleepTicks((int)llIllIIlIl[4]);
                                0;
                            }
                            if (E.lIllIllIIlIlI(((Widget)var22.get(llIllIIlIl[1])).getText().contains(llIllIIIlI[llIllIIlIl[84]]) ? 1 : 0) && E.lIllIllIIlIlI(((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getText().contains(llIllIIIlI[llIllIIlIl[42]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getX(), (int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getY(), (boolean)llIllIIlIl[0]);
                                Time.sleepTicks((int)llIllIIlIl[4]);
                                0;
                            }
                            if ((!E.lIllIllIIllII(((Widget)var22.get(llIllIIlIl[1])).getText().contains(llIllIIIlI[llIllIIlIl[85]]) ? 1 : 0) || E.lIllIllIIlIlI(((Widget)var22.get(llIllIIlIl[1])).getText().contains(llIllIIIlI[llIllIIlIl[77]]) ? 1 : 0)) && E.lIllIllIIlIlI(((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getText().contains(llIllIIIlI[llIllIIlIl[86]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getX(), (int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getY(), (boolean)llIllIIlIl[0]);
                                Time.sleepTicks((int)llIllIIlIl[4]);
                                0;
                            }
                            if (E.lIllIllIIlIlI(((Widget)var22.get(llIllIIlIl[1])).getText().contains(llIllIIIlI[llIllIIlIl[87]]) ? 1 : 0) && E.lIllIllIIlIlI(((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getText().contains(llIllIIIlI[llIllIIlIl[88]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getX(), (int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getY(), (boolean)llIllIIlIl[0]);
                                Time.sleepTicks((int)llIllIIlIl[4]);
                                0;
                            }
                            if (E.lIllIllIIlIlI(((Widget)var22.get(llIllIIlIl[1])).getText().contains(llIllIIIlI[llIllIIlIl[89]]) ? 1 : 0) && E.lIllIllIIlIlI(((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getText().contains(llIllIIIlI[llIllIIlIl[90]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getX(), (int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getY(), (boolean)llIllIIlIl[0]);
                                Time.sleepTicks((int)llIllIIlIl[4]);
                                0;
                            }
                            if (E.lIllIllIIlIlI(((Widget)var22.get(llIllIIlIl[1])).getText().contains(llIllIIIlI[llIllIIlIl[91]]) ? 1 : 0) && E.lIllIllIIlIlI(((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getText().contains(llIllIIIlI[llIllIIlIl[92]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getX(), (int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getY(), (boolean)llIllIIlIl[0]);
                                Time.sleepTicks((int)llIllIIlIl[4]);
                                0;
                            }
                            if (E.lIllIllIIlIlI(((Widget)var22.get(llIllIIlIl[1])).getText().contains(llIllIIIlI[llIllIIlIl[93]]) ? 1 : 0) && E.lIllIllIIlIlI(((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getText().contains(llIllIIIlI[llIllIIlIl[94]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getX(), (int)((Widget)var22.get(llllllllllllllllllIIIlIIlllIlIll2)).getClickPoint().getY(), (boolean)llIllIIlIl[0]);
                                Time.sleepTicks((int)llIllIIlIl[4]);
                                0;
                            }
    ...
    private static void Q() {
        ...
        block52: {
            block51: {
                block50: {
                        ...
                        block48: {
                            block47: {
                                block46: {
                                        ...
                                        block44: {
                                            block43: {
                                                block42: {
                                                        ...
                                                        block40: {
                                                            block39: {
                                                                block38: {
                                                                        ...
                                                                        block36: {
                                                                            block35: {
                                                                                ...
                                                                                if (E.lIllIllIIllII(Bank.contains((int[])nArray2) ? 1 : 0)) {
                                                                                    var16 = new d(llIllIIlIl[16], llIllIIlIl[0], llIllIIlIl[141]);
                                                                                    bv.add((d)var16);
                                                                                    0;
                                                                                }
                                                                                int[] nArray3 = new int[llIllIIlIl[0]];
                                                                                ...
                                                                                if (E.lIllIllIIllII(Bank.contains((int[])nArray3) ? 1 : 0)) {
                                                                                    var16 = new d(llIllIIlIl[17], llIllIIlIl[0], llIllIIlIl[141]);
                                                                                    bv.add((d)var16);
                                                                                    0;
                                                                                }
                                                                                int[] nArray4 = new int[llIllIIlIl[0]];
                                                                                ...
                                                                                if (E.lIllIllIIllII(Bank.contains((int[])nArray4) ? 1 : 0)) {
                                                                                    var16 = new d(llIllIIlIl[18], llIllIIlIl[0], llIllIIlIl[141]);
                                                                                    bv.add((d)var16);
                                                                                    0;
                                                                                }
                                                                                int[] nArray5 = new int[llIllIIlIl[0]];
                                                                                ...
                                                                                if (E.lIllIllIIllII(Bank.contains((int[])nArray5) ? 1 : 0)) {
                                                                                    var16 = new d(llIllIIlIl[22], llIllIIlIl[0], llIllIIlIl[141]);
                                                                                    bv.add((d)var16);
                                                                                    0;
                                                                                }
                                                                                int[] nArray6 = new int[llIllIIlIl[0]];
                                                                            ...
                                                                            var16 = new d(llIllIIlIl[19], llIllIIlIl[4], llIllIIlIl[141]);
                                                                            bv.add((d)var16);
                                                                            0;
                                                                        }
                                                                        int[] nArray = new int[llIllIIlIl[0]];
                                                                    ...
                                                                    var16 = new d(llIllIIlIl[32], llIllIIlIl[43], llIllIIlIl[142]);
                                                                    bv.add((d)var16);
                                                                    0;
                                                                }
                                                                int[] nArray = new int[llIllIIlIl[0]];
                                                            ...
                                                            var16 = new d(llIllIIlIl[20], llIllIIlIl[39], llIllIIlIl[114]);
                                                            bv.add((d)var16);
                                                            0;
                                                        }
                                                        int[] nArray = new int[llIllIIlIl[0]];
                                                    ...
                                                    var16 = new d(llIllIIlIl[24], llIllIIlIl[12], llIllIIlIl[41]);
                                                    bv.add((d)var16);
                                                    0;
                                                }
                                                int[] nArray = new int[llIllIIlIl[0]];
                                            ...
                                            var16 = new d(llIllIIlIl[26], llIllIIlIl[25], llIllIIlIl[41]);
                                            bv.add((d)var16);
                                            0;
                                        }
                                        int[] nArray = new int[llIllIIlIl[0]];
                                    ...
                                    var16 = new d(llIllIIlIl[28], llIllIIlIl[8], llIllIIlIl[143]);
                                    bv.add((d)var16);
                                    0;
                                }
                                int[] nArray = new int[llIllIIlIl[0]];
                            ...
                            var16 = new d(llIllIIlIl[30], llIllIIlIl[21], j.cf);
                            bv.add((d)var16);
                            0;
                        }
                        int[] nArray = new int[llIllIIlIl[0]];
                    ...
                    var16 = new d(llIllIIlIl[36], llIllIIlIl[27], e.c(llIllIIlIl[144], llIllIIlIl[145]));
                    bv.add((d)var16);
                    0;
                }
                int[] nArray = new int[llIllIIlIl[0]];
            ...
            var16 = new d(llIllIIlIl[34], llIllIIlIl[10], e.c(llIllIIlIl[146], llIllIIlIl[147]));
            bv.add((d)var16);
            0;
        }
        int[] nArray = new int[llIllIIlIl[0]];
        nArray[E.llIllIIlIl[1]] = llIllIIlIl[15];
        if (E.lIllIllIIllII(Bank.contains((int[])nArray) ? 1 : 0)) {
            var16 = new d(llIllIIlIl[15], llIllIIlIl[0], llIllIIlIl[141]);
            bv.add((d)var16);
            0;
        }
        if (E.lIllIllIIllII(Bank.contains((Predicate)(var16 = item -> item.getName().toLowerCase().contains(llIllIIIlI[llIllIIlIl[151]]))) ? 1 : 0)) {
            var4 = new d(llIllIIlIl[148], llIllIIlIl[10], llIllIIlIl[149]);
            bv.add(var4);
            0;
        }
        ...
        if (E.lIllIllIIllII(Bank.contains((int[])nArray25) ? 1 : 0)) {
            var4 = new d(llIllIIlIl[14], llIllIIlIl[73], llIllIIlIl[150]);
            bv.add(var4);
            0;
        }
    }
    ...
    private static void lIllIllIIIlll() {
        ...
        E.llIllIIIlI[E.llIllIIlIl[1]] = E."Finished buying items, switching back to quest";
        E.llIllIIIlI[E.llIllIIlIl[0]] = E."- Agility";
        E.llIllIIIlI[E.llIllIIlIl[4]] = E."- Prayer";
        E.llIllIIIlI[E.llIllIIlIl[7]] = E."Drop";
        E.llIllIIIlI[E.llIllIIlIl[8]] = E."- Nature Spirit";
        E.llIllIIIlI[E.llIllIIlIl[10]] = E."Nav to bank";
        E.llIllIIIlI[E.llIllIIlIl[12]] = E."Handling banking";
        E.llIllIIIlI[E.llIllIIlIl[21]] = E."We are missing quest supplies, switching to BUYING";
        E.llIllIIIlI[E.llIllIIlIl[23]] = E."Wield";
        E.llIllIIIlI[E.llIllIIlIl[25]] = E."Druid pouch";
        E.llIllIIIlI[E.llIllIIlIl[27]] = E."Drink";
        E.llIllIIIlI[E.llIllIIlIl[29]] = E."Eat";
        E.llIllIIIlI[E.llIllIIlIl[31]] = E."";
        E.llIllIIIlI[E.llIllIIlIl[33]] = E."Nav to start";
        E.llIllIIIlI[E.llIllIIlIl[35]] = E."Wield";
        E.llIllIIIlI[E.llIllIIlIl[37]] = E."Break";
        E.llIllIIIlI[E.llIllIIlIl[13]] = E."Starting quest";
        E.llIllIIIlI[E.llIllIIlIl[45]] = E."Vanstrom Klause";
        E.llIllIIIlI[E.llIllIIlIl[46]] = E."Filling pouch";
        E.llIllIIIlI[E.llIllIIlIl[47]] = E."Druid pouch";
        E.llIllIIIlI[E.llIllIIlIl[43]] = E."Fill";
        E.llIllIIIlI[E.llIllIIlIl[48]] = E."Breaking tab";
        E.llIllIIIlI[E.llIllIIlIl[49]] = E."Break";
        E.llIllIIIlI[E.llIllIIlIl[50]] = E."Nav to boat";
        E.llIllIIIlI[E.llIllIIlIl[51]] = E."Handle boat chat";
        E.llIllIIIlI[E.llIllIIlIl[54]] = E."Nav to hop spot";
        E.llIllIIIlI[E.llIllIIlIl[2]] = E."Cyreg Paddlehorn";
        E.llIllIIIlI[E.llIllIIlIl[55]] = E."Swamp Boaty";
        E.llIllIIIlI[E.llIllIIlIl[56]] = E."Board";
        E.llIllIIIlI[E.llIllIIlIl[57]] = E."Nav to bridge";
        E.llIllIIIlI[E.llIllIIlIl[58]] = E."Tree";
        E.llIllIIIlI[E.llIllIIlIl[59]] = E."Climb";
        E.llIllIIIlI[E.llIllIIlIl[65]] = E."Nav to bridge";
        E.llIllIIIlI[E.llIllIIlIl[66]] = E."Tree";
        E.llIllIIIlI[E.llIllIIlIl[67]] = E."Climb";
        E.llIllIIIlI[E.llIllIIlIl[68]] = E."Broken rope bridge";
        E.llIllIIIlI[E.llIllIIlIl[69]] = E."Repair";
        E.llIllIIIlI[E.llIllIIlIl[70]] = E."Repairing bridge";
        E.llIllIIIlI[E.llIllIIlIl[71]] = E."Repair";
        E.llIllIIIlI[E.llIllIIlIl[72]] = E."Tree";
        E.llIllIIIlI[E.llIllIIlIl[73]] = E."Climb";
        E.llIllIIIlI[E.llIllIIlIl[74]] = E."Nav to door";
        E.llIllIIIlI[E.llIllIIlIl[75]] = E."Handling chat";
        E.llIllIIIlI[E.llIllIIlIl[76]] = E."Curpile Fyod";
        E.llIllIIIlI[E.llIllIIlIl[78]] = E."Curpile Fyod";
        E.llIllIIIlI[E.llIllIIlIl[3]] = E."Talk-to";
        E.llIllIIIlI[E.llIllIIlIl[81]] = E."Who is the only female in the Myreque?";
        E.llIllIIIlI[E.llIllIIlIl[82]] = E."female";
        E.llIllIIIlI[E.llIllIIlIl[83]] = E."Sani Piliu";
        E.llIllIIIlI[E.llIllIIlIl[84]] = E."leader";
        E.llIllIIIlI[E.llIllIIlIl[42]] = E."Veliaf Hurtz";
        E.llIllIIIlI[E.llIllIIlIl[85]] = E."boatman's";
        E.llIllIIIlI[E.llIllIIlIl[77]] = E."boatman";
        E.llIllIIIlI[E.llIllIIlIl[86]] = E."Cyreg Paddlehorn";
        E.llIllIIIlI[E.llIllIIlIl[87]] = E."scholar?";
        E.llIllIIIlI[E.llIllIIlIl[88]] = E."Polmafi Ferdygris";
        E.llIllIIIlI[E.llIllIIlIl[89]] = E."vampyre family";
        E.llIllIIIlI[E.llIllIIlIl[90]] = E."Drakan";
        E.llIllIIIlI[E.llIllIIlIl[91]] = E."youngest";
        E.llIllIIIlI[E.llIllIIlIl[92]] = E."Ivan Strom";
        E.llIllIIIlI[E.llIllIIlIl[93]] = E."Myreque mean?";
        E.llIllIIIlI[E.llIllIIlIl[94]] = E."Hidden in Myre";
        E.llIllIIIlI[E.llIllIIlIl[95]] = E."Entering doors";
        E.llIllIIIlI[E.llIllIIlIl[96]] = E."Wooden doors";
        E.llIllIIIlI[E.llIllIIlIl[97]] = E."Open";
        E.llIllIIIlI[E.llIllIIlIl[98]] = E."Nav to cave";
        E.llIllIIIlI[E.llIllIIlIl[99]] = E."Entering cave";
        E.llIllIIIlI[E.llIllIIlIl[100]] = E."Cave entrance";
        E.llIllIIIlI[E.llIllIIlIl[101]] = E."Enter";
        E.llIllIIIlI[E.llIllIIlIl[102]] = E."Talking";
        E.llIllIIIlI[E.llIllIIlIl[103]] = E."Veliaf Hurtz";
        E.llIllIIIlI[E.llIllIIlIl[104]] = E."Talking";
        E.llIllIIIlI[E.llIllIIlIl[106]] = E."Harold Evans";
        E.llIllIIIlI[E.llIllIIlIl[107]] = E."Radigad Ponfit";
        E.llIllIIIlI[E.llIllIIlIl[108]] = E."Talk-to";
        E.llIllIIIlI[E.llIllIIlIl[109]] = E."Radigad Ponfit";
        E.llIllIIIlI[E.llIllIIlIl[110]] = E."Sani Piliu";
        E.llIllIIIlI[E.llIllIIlIl[111]] = E."Talk-to";
        E.llIllIIIlI[E.llIllIIlIl[112]] = E."Sani Piliu";
        E.llIllIIIlI[E.llIllIIlIl[113]] = E."Polmafi Ferdygris";
        E.llIllIIIlI[E.llIllIIlIl[114]] = E."Talk-to";
        E.llIllIIIlI[E.llIllIIlIl[115]] = E."Polmafi Ferdygris";
        E.llIllIIIlI[E.llIllIIlIl[116]] = E."Ivan Strom";
        E.llIllIIIlI[E.llIllIIlIl[117]] = E."Talk-to";
        E.llIllIIIlI[E.llIllIIlIl[118]] = E."Ivan Strom";
        E.llIllIIIlI[E.llIllIIlIl[119]] = E."Veliaf Hurtz";
        E.llIllIIIlI[E.llIllIIlIl[120]] = E."Let's talk about the weapons.";
        E.llIllIIIlI[E.llIllIIlIl[121]] = E."I'll be back later.";
        E.llIllIIIlI[E.llIllIIlIl[122]] = E."Talking";
        E.llIllIIIlI[E.llIllIIlIl[123]] = E."Veliaf Hurtz";
        E.llIllIIIlI[E.llIllIIlIl[124]] = E."Handling chat";
        E.llIllIIIlI[E.llIllIIlIl[125]] = E."BOSS FIGHT";
        E.llIllIIIlI[E.llIllIIlIl[126]] = E."Drink";
        E.llIllIIIlI[E.llIllIIlIl[127]] = E."Wield";
        E.llIllIIIlI[E.llIllIIlIl[129]] = E."Attack";
        E.llIllIIIlI[E.llIllIIlIl[130]] = E."Talking";
        E.llIllIIIlI[E.llIllIIlIl[131]] = E."Veliaf Hurtz";
        E.llIllIIIlI[E.llIllIIlIl[132]] = E."Exiting cave";
        E.llIllIIIlI[E.llIllIIlIl[134]] = E."Cave entrance";
        E.llIllIIIlI[E.llIllIIlIl[135]] = E."Enter";
        E.llIllIIIlI[E.llIllIIlIl[133]] = E."Nav to start";
        E.llIllIIIlI[E.llIllIIlIl[136]] = E."Finishing quest";
        E.llIllIIIlI[E.llIllIIlIl[137]] = E."Stranger";
        E.llIllIIIlI[E.llIllIIlIl[138]] = E."Break";
        E.llIllIIIlI[E.llIllIIlIl[139]] = E."Druid pouch";
        E.llIllIIIlI[E.llIllIIlIl[151]] = E."ring of wealth (";
        E.llIllIIIlI[E.llIllIIlIl[152]] = E."Loar Shadow";
        E.llIllIIIlI[E.llIllIIlIl[153]] = E."Afflicted";
        E.llIllIIIlI[E.llIllIIlIl[170]] = E."Why do they need help? Are they in trouble?";
        E.llIllIIIlI[E.llIllIIlIl[171]] = E."Perhaps I could help you out here.";
        E.llIllIIIlI[E.llIllIIlIl[6]] = E."Yes, I'll do it!";
        E.llIllIIIlI[E.llIllIIlIl[172]] = E."Yes.";
        E.llIllIIIlI[E.llIllIIlIl[173]] = E."Well, I guess they'll just die without weapons.";
        E.llIllIIIlI[E.llIllIIlIl[174]] = E."Resourceful enough to get their own steel weapons?";
        E.llIllIIIlI[E.llIllIIlIl[175]] = E."If you don't tell me, their deaths are on your head!";
        E.llIllIIIlI[E.llIllIIlIl[176]] = E."Why do you say that this place is 'forsaken'?";
        E.llIllIIIlI[E.llIllIIlIl[177]] = E."Give wooden planks to Cyreg";
        E.llIllIIIlI[E.llIllIIlIl[178]] = E."Yes, I'll pay the ten gold.";
        E.llIllIIIlI[E.llIllIIlIl[179]] = E."Yes, I'll pay ten gold.";
        E.llIllIIIlI[E.llIllIIlIl[180]] = E."Yes. I'll pay the ten gold.";
        E.llIllIIIlI[E.llIllIIlIl[181]] = E."I've come to help the Myreque. I've brought weapons.";
        E.llIllIIIlI[E.llIllIIlIl[182]] = E."Sani Piliu";
        E.llIllIIIlI[E.llIllIIlIl[183]] = E."Veliaf Hurtz";
        E.llIllIIIlI[E.llIllIIlIl[184]] = E."Cyreg Paddlehorn";
        E.llIllIIIlI[E.llIllIIlIl[185]] = E."Drakan";
        E.llIllIIIlI[E.llIllIIlIl[186]] = E."Ivan Strom";
        E.llIllIIIlI[E.llIllIIlIl[187]] = E."Hidden in Myre";
        E.llIllIIIlI[E.llIllIIlIl[188]] = E."Polmafi Ferdygris";
        E.llIllIIIlI[E.llIllIIlIl[189]] = E."How do I get out of here?";
        E.llIllIIIlI[E.llIllIIlIl[190]] = E."Ok, thanks.";
        E.llIllIIIlI[E.llIllIIlIl[191]] = E."What kind of a man are you to say that you don't care?";
        E.llIllIIIlI[E.llIllIIlIl[192]] = E."Here are some planks for you.";
        E.llIllIIIlI[E.llIllIIlIl[193]] = E."Let's talk about the weapons.";
        E.llIllIIIlI[E.llIllIIlIl[194]] = E."";
    }
}
