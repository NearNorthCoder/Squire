...
public class b {
    ...
    public void a(GraphicsObjectCreated graphicsObjectCreated) {
        ...
        } else if (b.llIIIIllIIIIlll(var16.getGraphicsObject().getId(), lIlIllllIllII[21])) {
            b var12;
            var12.r.add(var16.getGraphicsObject().getLocation());
            0;
        }
    }
    ...
    public int g() {
        ...
        Widget var21 = Widgets.get((int)lIlIllllIllII[6], (int)lIlIllllIllII[8]);
        if (b.llIIIIllIIIIllI(Widgets.isVisible((Widget)var21) ? 1 : 0)) {
            return lIlIllllIllII[4];
        }
        String var9 = var21.getText();
        if (b.llIIIIllIIIIlII(var9)) {
            return lIlIllllIllII[4];
        }
    ...
    public boolean i() {
        ...
        if (b.llIIIIllIIIIlll(var19.getWorldLocation().getRegionID(), lIlIllllIllII[13])) {
            bl = lIlIllllIllII[7];
            0;
            if (1 == 3) {
    ...
    public int f() {
        ...
        String var14 = var24.getText();
        Matcher var7 = m.matcher(var14);
        if (b.llIIIIllIIIIlIl(var7.find() ? 1 : 0)) {
            return Integer.parseInt(var7.group(lIlIllllIllII[7]));
        }
        return lIlIllllIllII[4];
    }
    ...
    private static String llIIIIlIlllllll(String var8, String var28) {
        try {
            SecretKeySpec var11 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var28.getBytes(StandardCharsets.UTF_8)), lIlIllllIllII[18]), "DES");
            Cipher var1 = Cipher.getInstance("DES");
            var1.init(lIlIllllIllII[9], var11);
    ...
    public void a(ChatMessage chatMessage) {
        ...
        String var26 = var30.getMessage();
        if (!b.llIIIIllIIIIllI(var26.contains(lIlIllllIlIll[lIlIllllIllII[17]]) ? 1 : 0) || b.llIIIIllIIIIlIl(var26.contains(lIlIllllIlIll[lIlIllllIllII[3]]) ? 1 : 0)) {
            var22.s = lIlIllllIllII[4];
        }
        if (b.llIIIIllIIIIlIl(var26.contains(lIlIllllIlIll[lIlIllllIllII[18]]) ? 1 : 0)) {
            var22.a(lIlIllllIllII[7]);
        }
        if (b.llIIIIllIIIIlIl(var26.contains(lIlIllllIlIll[lIlIllllIllII[19]]) ? 1 : 0)) {
            var22.a(lIlIllllIllII[4]);
        }
    }
    ...
    public void a(GameTick gameTick) {
        ...
        if (b.llIIIIllIIIlIlI(var10.getAnimation(), lIlIllllIllII[5])) {
            var20.s = var20.m();
        }
        int var15 = Inventory.getFreeSlots();
        ...
        int var5 = Inventory.getCount((int[])nArray2);
        if (b.llIIIIllIIIlIll(var5, var20.g()) && b.llIIIIllIIIIlIl(var20.t ? 1 : 0)) {
            var20.a(lIlIllllIllII[4]);
        }
        if (b.llIIIIllIIIIllI(var15) && b.llIIIIllIIIIlIl(var20.t ? 1 : 0)) {
            var20.a(lIlIllllIllII[4]);
            0;
            if ((0x84 ^ 0x80) < 2) {
                return;
            }
        } else if (b.llIIIIllIIIlIII(var15) && b.llIIIIllIIIIllI(n2) && b.llIIIIllIIIIllI(var20.t ? 1 : 0)) {
            var20.a(lIlIllllIllII[7]);
        }
    }
    ...
    public int h() {
        ...
        Widget var29 = Widgets.get((int)lIlIllllIllII[6], (int)lIlIllllIllII[10]);
        if (b.llIIIIllIIIIllI(Widgets.isVisible((Widget)var29) ? 1 : 0)) {
            return lIlIllllIllII[4];
        }
        String var2 = var29.getText();
        if (b.llIIIIllIIIIlII(var2)) {
            return lIlIllllIllII[4];
        }
    ...
    private static String llIIIIlIllllllI(String var17, String var25) {
        var17 = new String(Base64.getDecoder().decode(var17.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var13 = new StringBuilder();
        char[] var31 = var25.toCharArray();
        int var27 = lIlIllllIllII[4];
        char[] var23 = var17.toCharArray();
        int var4 = var23.length;
        int var18 = lIlIllllIllII[4];
        while (b.llIIIIllIIIllIl(var18, var4)) {
            char var6 = var23[var18];
            var13.append((char)(var6 ^ var31[var27 % var31.length]));
            0;
            ++var27;
            ++var18;
            0;
