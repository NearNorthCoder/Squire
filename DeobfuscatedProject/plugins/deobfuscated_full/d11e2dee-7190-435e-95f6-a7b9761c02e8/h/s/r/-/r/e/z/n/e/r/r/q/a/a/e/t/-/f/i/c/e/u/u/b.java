...
/* TASK: Activating Blood Essence -> ActivatingbloodessenceTask */
...
extends Task {
    ...
    private static String llIIIllIllllIll(String var6, String var4) {
        var6 = new String(Base64.getDecoder().decode(var6.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var7 = new StringBuilder();
        char[] var2 = var4.toCharArray();
        int var5 = lIllIIlllIllI[0];
        char[] var9 = var6.toCharArray();
        int var3 = var9.length;
        int var8 = lIllIIlllIllI[0];
        while (b.llIIIlllIIIIIlI(var8, var3)) {
            char var1 = var9[var8];
            var7.append((char)(var1 ^ var2[var5 % var2.length]));
            0;
            ++var5;
            ++var8;
            0;
