...
extends w {
    ...
    private boolean Z() {
        ...
        if (!i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIlIlII(var18.X() ? 1 : 0) || !i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIlIIll(Combat.isVenomed() ? 1 : 0) || !i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIlIlll(Combat.getCurrentHealth(), var16) || i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIlIIll(Inventory.contains(item -> item.getName().startsWith(var8)) ? 1 : 0)) {
            n2 = lIlIllIIIIlIl[0];
            0;
            if (1 > 2) {
    ...
    private static String llIIIIIIIIIllll(String var17, String var7) {
        ...
        while (i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIllIIl(var14, var15)) {
    ...
    private static void llIIIIIIIIlIIlI() {
        ...
        i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlIl[0] = 1;
        ...
        i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlIl[3] = 2;
        i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlIl[4] = 3;
    ...
    private boolean aa() {
        ...
        if (i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIlIlll(var19.cf.getBoostedSkillLevel(Skill.HITPOINTS), lIlIllIIIIlIl[7])) {
            n4 = lIlIllIIIIlIl[0];
            0;
        ...
        if (i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIlIlIl(var19.cf.getTickCount() - var19.cg.F(), lIlIllIIIIlIl[5])) {
            n3 = lIlIllIIIIlIl[0];
            0;
            if (2 < 1) {
                return false;
        ...
        if (i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIlIIll(var13) && i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIlIlII(var25) && i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIlIIll(var19.ab() ? 1 : 0)) {
            n2 = lIlIllIIIIlIl[0];
            0;
            if (-1 >= 1) {
                return (3 & (3 ^ -1)) != 0;
    ...
    private static void llIIIIIIIIlIIIl() {
        ...
        i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlII[i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlIl[1]] = i.v.k.o.-.u.s.e.r.a.q.r.t.h.x."Teleport";
        i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlII[i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlIl[0]] = i.v.k.o.-.u.s.e.r.a.q.r.t.h.x."Fleeing since we don't have food that we need";
        i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlII[i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlIl[3]] = i.v.k.o.-.u.s.e.r.a.q.r.t.h.x."Fleeing since we need prayer and don't have any";
        i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlII[i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlIl[4]] = i.v.k.o.-.u.s.e.r.a.q.r.t.h.x."Fleeing since we need a venom cure";
        i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlII[i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlIl[5]] = i.v.k.o.-.u.s.e.r.a.q.r.t.h.x."Fleeing since we can be killed currently";
        i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlII[i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlIl[8]] = i.v.k.o.-.u.s.e.r.a.q.r.t.h.x."anti";
        i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlII[i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlIl[9]] = i.v.k.o.-.u.s.e.r.a.q.r.t.h.x."Prayer pot";
        i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlII[i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.lIlIllIIIIlIl[10]] = i.v.k.o.-.u.s.e.r.a.q.r.t.h.x."Eat";
    }
    ...
    public boolean Q() {
        ...
        if (i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIlIlII(var23.Y() ? 1 : 0)) {
            Log.info((String)lIlIllIIIIlII[lIlIllIIIIlIl[3]]);
            var4 = lIlIllIIIIlIl[0];
        }
        if (i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIlIlII(var23.Z() ? 1 : 0)) {
            Log.info((String)lIlIllIIIIlII[lIlIllIIIIlIl[4]]);
            var4 = lIlIllIIIIlIl[0];
        }
        if (i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIlIIll(var23.aa() ? 1 : 0)) {
            Log.info((String)lIlIllIIIIlII[lIlIllIIIIlIl[5]]);
            var4 = lIlIllIIIIlIl[0];
        }
        if (i.v.k.o.-.u.s.e.r.a.q.r.t.h.x.llIIIIIIIIlIlII(var4)) {
