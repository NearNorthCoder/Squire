...
extends HashMap<String, Integer> {
    ...
    private static String lIlIllIllIlIIl(String var8, String var2) {
        try {
            SecretKeySpec var13 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var2.getBytes(StandardCharsets.UTF_8)), lllIIIlIllI[10]), "DES");
            Cipher var14 = Cipher.getInstance("DES");
            var14.init(lllIIIlIllI[3], var13);
    ...
    private static String lIlIllIllIlIlI(String var10, String var6) {
        try {
    ...
    private static String lIlIllIllIlIII(String var12, String var11) {
        var12 = new String(Base64.getDecoder().decode(var12.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var4 = new StringBuilder();
        char[] var17 = var11.toCharArray();
        int var15 = lllIIIlIllI[0];
        char[] var1 = var12.toCharArray();
        int var9 = var1.length;
        int var18 = lllIIIlIllI[0];
        while (j.lIlIllIllllIII(var18, var9)) {
            char var19 = var1[var18];
            var4.append((char)(var19 ^ var17[var15 % var17.length]));
            0;
            ++var15;
            ++var18;
            0;
