...
extends z_Unknown {
    ...
    private static void lIllIlIlIlIIlll() {
        ...
        L.lIIllllllIIIl[L.lIIllllllIIlI[1]] = L."Ba-Ba";
    }
    ...
    private static void lIllIlIlIlIlIII() {
        ...
        L.lIIllllllIIlI[0] = 1;
        L.lIIllllllIIlI[1] = (2 ^ (0 ^ 0x28)) & (0xF7 ^ 0xAF ^ (0x7B ^ 9) ^ -1);
    ...
    private static String lIllIlIlIlIIllI(String var1, String var3) {
        try {
            SecretKeySpec var2 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var3.getBytes(StandardCharsets.UTF_8)), lIIllllllIIlI[8]), "DES");
            Cipher var4 = Cipher.getInstance("DES");
            var4.init(lIIllllllIIlI[7], var2);
