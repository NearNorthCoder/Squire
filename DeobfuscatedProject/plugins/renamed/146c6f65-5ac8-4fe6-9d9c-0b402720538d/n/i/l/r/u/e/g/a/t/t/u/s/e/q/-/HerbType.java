...
extends Enum<i> {
    ...
    private static String llllllIIlIllIl(String var8, String var12) {
        try {
            SecretKeySpec var17 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var12.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var13 = Cipher.getInstance("Blowfish");
            var13.init(llIIllIIIIll[3], var17);
    ...
    private static String llllllIIlIllII(String var3, String var15) {
        ...
        int var18 = llIIllIIIIll[2];
        char[] var5 = var3.toCharArray();
        int var2 = var5.length;
        int var6 = llIIllIIIIll[2];
        while (i.llllllIIllIIlI(var6, var2)) {
            char var11 = var5[var6];
            var16.append((char)(var11 ^ var4[var18 % var4.length]));
            0;
            ++var18;
            ++var6;
            0;
    ...
    private static void llllllIIlIllll() {
        ...
        i.llIIllIIIIlI[i.llIIllIIIIll[2]] = i."ORE";
        i.llIIllIIIIlI[i.llIIllIIIIll[1]] = i."HERB";
        i.llIIllIIIIlI[i.llIIllIIIIll[3]] = i."WOOL";
        i.llIIllIIIIlI[i.llIIllIIIIll[18]] = i."BARK";
        i.llIIllIIIIlI[i.llIIllIIIIll[25]] = i."FISH";
        i.llIIllIIIIlI[i.llIIllIIIIll[31]] = i."CRYSTAL_SHARD";
        i.llIIllIIIIlI[i.llIIllIIIIll[34]] = i."CRYSTAL_DUST";
        i.llIIllIIIIlI[i.llIIllIIIIll[37]] = i."WEAPON_FRAME";
        i.llIIllIIIIlI[i.llIIllIIIIll[40]] = i."CRYSTAL_ORB";
        i.llIIllIIIIlI[i.llIIllIIIIll[43]] = i."CRYSTALLINE_BOWSTRING";
    }
    ...
    private static String llllllIIlIlllI(String var9, String var1) {
        try {
            SecretKeySpec var14 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var1.getBytes(StandardCharsets.UTF_8)), llIIllIIIIll[40]), "DES");
            Cipher var19 = Cipher.getInstance("DES");
            var19.init(llIIllIIIIll[3], var14);
