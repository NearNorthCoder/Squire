...
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.HandlingSpecAndGearTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.LootingTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.PrayerFlickingTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.UsingThrallTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.GrabbingDeathItemsDeathTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.GrabbingFairyRingItemDeathTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.WalkingToVardorvisDeathTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.b_Unknown;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.e_Unknown;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.m_Unknown;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.TogglingRunTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.StaminaHandlerTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.StartFightTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.WalkingToTheBankTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.PathingToBossTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.WithdrawingItemsTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.AttackBossTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.ClickingSporesTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.DodgingAxeTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.DrinkingBoostTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.DrinkingPrayerTask;
import r.o.u.a.r.v.s.i.s.v.q.d.r.i.-.e.EatingFoodTask;
...
extends SquirePlugin {
    ...
    private static String lIlllllIIIlIlIl(String var9, String var6) {
        try {
            ...
            var3.init(lIlIlIIlllIIl[3], var4);
    ...
    private static void lIlllllIIIlIllI() {
        ...
        SquireVardorvis.lIlIlIIlllIII[SquireVardorvis.lIlIlIIlllIIl[1]] = SquireVardorvis."Oh dear, you are dead!";
    }
    ...
    public void a(List<WorldArea> list) {
        ...
        while (SquireVardorvis.lIlllllIIIllIII(var7.hasNext() ? 1 : 0)) {
            SquireVardorvis var11;
            WorldArea var10 = var7.next();
            var11.c.addAll(var10.toWorldPointList());
            0;
            0;
    ...
    public void b(List<WorldArea> list) {
        ...
        while (SquireVardorvis.lIlllllIIIllIII(var8.hasNext() ? 1 : 0)) {
            SquireVardorvis var1;
            WorldArea var2 = var8.next();
            var1.c.addAll(var2.toWorldPointList());
            0;
            0;
            if (-1 == -1) continue;
            return;
    ...
    private static void lIlllllIIIlIlll() {
        ...
        SquireVardorvis.lIlIlIIlllIIl[0] = 1;
        SquireVardorvis.lIlIlIIlllIIl[1] = (73 + 179 - 65 + 12 ^ 51 + 109 - 58 + 49) & (0x4A ^ 0x40 ^ (0x4F ^ 0x15) ^ -1);
        SquireVardorvis.lIlIlIIlllIIl[2] = 0x6F ^ 0x7B;
        SquireVardorvis.lIlIlIIlllIIl[3] = 2;
        SquireVardorvis.lIlIlIIlllIIl[4] = 3;
