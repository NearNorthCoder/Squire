...
extends OverlayPanel {
    ...
    private static String lIllllIllllllIl(String var7, String var10) {
        try {
            SecretKeySpec var6 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var10.getBytes(StandardCharsets.UTF_8)), lIlIlIIlIllIl[10]), "DES");
            Cipher var15 = Cipher.getInstance("DES");
            var15.init(lIlIlIIlIllIl[5], var6);
    ...
    private static String lIllllIlllllllI(String var13, String var11) {
        try {
            SecretKeySpec var16 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var11.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var12 = Cipher.getInstance("Blowfish");
            var12.init(lIlIlIIlIllIl[5], var16);
    ...
    private static String lIllllIllllllll(String var4, String var17) {
        var4 = new String(Base64.getDecoder().decode(var4.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var2 = new StringBuilder();
        char[] var8 = var17.toCharArray();
        int var9 = lIlIlIIlIllIl[1];
        char[] var14 = var4.toCharArray();
        int var18 = var14.length;
        int var19 = lIlIlIIlIllIl[1];
        while (SquireVardorvisBox.lIlllllIIIIIlII(var19, var18)) {
            char var5 = var14[var19];
            var2.append((char)(var5 ^ var8[var9 % var8.length]));
            0;
            ++var9;
            ++var19;
            0;
