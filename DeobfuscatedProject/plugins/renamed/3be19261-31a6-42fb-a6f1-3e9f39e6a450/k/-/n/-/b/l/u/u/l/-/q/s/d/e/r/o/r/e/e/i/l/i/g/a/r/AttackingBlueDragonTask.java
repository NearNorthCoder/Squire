...
import k.-.n.-.b.l.u.u.l.-.q.s.d.e.r.o.r.e.e.i.l.i.g.a.r.a_Unknown;
...
/* TASK: Attacking Blue Dragon -> AttackingbluedragonTask */
...
extends Task {
    ...
    private static String llIlIIIlllIIII(String var6, String var3) {
        try {
    ...
    private boolean u() {
        int n;
        g var4;
        if (g.llIlIIIlllIlIl(Players.getLocal().getInteracting()) && (g.llIlIIIlllIIll(this.v() ? 1 : 0) && !g.llIlIIIlllIlII(this.x() ? 1 : 0) || g.llIlIIIlllIlII(var4.v() ? 1 : 0))) {
            n = lIIllllIIllI[1];
            0;
            if (1 < 0) {
    ...
    private static void llIlIIIlllIIIl() {
        ...
        g.lIIllllIIlIl[g.lIIllllIIllI[0]] = g."is no ammo left in your";
        g.lIIllllIIlIl[g.lIIllllIIllI[1]] = g."We're out of bolts, banking.";
    }
    ...
    public boolean run() {
        ...
        if (g.llIlIIIlllIIll(var9.z.b() ? 1 : 0)) {
            var9.z.a(lIIllllIIllI[1]);
            return lIIllllIIllI[0];
        }
        if (g.llIlIIIlllIIll(var9.s() ? 1 : 0)) {
            return lIIllllIIllI[0];
        }
        this.w();
