...
import k.-.n.-.b.l.u.u.l.-.q.s.d.e.r.o.r.e.e.i.l.i.g.a.r.d_Unknown;
import k.-.n.-.b.l.u.u.l.-.q.s.d.e.r.o.r.e.e.i.l.i.g.a.r.StartingTask;
import k.-.n.-.b.l.u.u.l.-.q.s.d.e.r.o.r.e.e.i.l.i.g.a.r.BankingForItemsTask;
import k.-.n.-.b.l.u.u.l.-.q.s.d.e.r.o.r.e.e.i.l.i.g.a.r.AttackingBlueDragonTask;
import k.-.n.-.b.l.u.u.l.-.q.s.d.e.r.o.r.e.e.i.l.i.g.a.r.EatingTask;
import k.-.n.-.b.l.u.u.l.-.q.s.d.e.r.o.r.e.e.i.l.i.g.a.r.FlickingPrayerTask;
import k.-.n.-.b.l.u.u.l.-.q.s.d.e.r.o.r.e.e.i.l.i.g.a.r.LootingTask;
import k.-.n.-.b.l.u.u.l.-.q.s.d.e.r.o.r.e.e.i.l.i.g.a.r.WalkingToBankTask;
import k.-.n.-.b.l.u.u.l.-.q.s.d.e.r.o.r.e.e.i.l.i.g.a.r.WalkingToBlueDragonsTask;
...
extends SquirePlugin {
    ...
    private void a(InventoryChanged inventoryChanged) {
        if (SquireBlueDragonKiller.llIlIIIllIIIlI(inventoryChanged.getChangeType(), InventoryChanged.ChangeType.ITEM_ADDED)) {
            SquireBlueDragonKiller var19;
            void var21;
            if (SquireBlueDragonKiller.llIlIIIllIIIll(inventoryChanged.getItemId(), lIIllllIIIIl[9])) {
                this.b(this.d() + lIIllllIIIIl[0]);
            }
            if (SquireBlueDragonKiller.llIlIIIllIIIll(var21.getItemId(), lIIllllIIIIl[10])) {
                var19.c(var19.e() + lIIllllIIIIl[0]);
            }
            if (SquireBlueDragonKiller.llIlIIIllIIIll(var21.getItemId(), lIIllllIIIIl[11])) {
                var19.d(var19.f() + lIIllllIIIIl[0]);
            }
            if (SquireBlueDragonKiller.llIlIIIllIIIll(var21.getItemId(), lIIllllIIIIl[12])) {
                var19.e(var19.g() + lIIllllIIIIl[0]);
            }
        }
    }
    ...
    private static String llIlIIIlIllIll(String var15, String var20) {
        ...
        int var14 = lIIllllIIIIl[2];
        char[] var12 = var15.toCharArray();
        int var7 = var12.length;
        int var23 = lIIllllIIIIl[2];
        while (SquireBlueDragonKiller.llIlIIIllIIllI(var23, var7)) {
            char var4 = var12[var23];
            var2.append((char)(var4 ^ var18[var14 % var18.length]));
            0;
            ++var14;
            ++var23;
            0;
    ...
    private static void llIlIIIlIlllIl() {
        ...
        SquireBlueDragonKiller.lIIllllIIIII[SquireBlueDragonKiller.lIIllllIIIIl[2]] = SquireBlueDragonKiller."squirebdk";
        SquireBlueDragonKiller.lIIllllIIIII[SquireBlueDragonKiller.lIIllllIIIIl[0]] = SquireBlueDragonKiller."Eat";
        SquireBlueDragonKiller.lIIllllIIIII[SquireBlueDragonKiller.lIIllllIIIIl[3]] = SquireBlueDragonKiller."Eat";
    }
    ...
    public boolean b() {
        ...
        if (SquireBlueDragonKiller.llIlIIIllIIIII(Inventory.isFull() ? 1 : 0) && SquireBlueDragonKiller.llIlIIIlIlllll(Inventory.contains(item -> {
            ...
            var22.a(lIIllllIIIIl[0]);
            return lIIllllIIIIl[0];
        }
        BankLoadout var8 = (BankLoadout)var22.j.loadout().selected(BankLoadout.class);
        if (SquireBlueDragonKiller.llIlIIIllIIIlI((Object)var22.j.attackStyle(), (Object)k.-.n.-.b.l.u.u.l.-.q.s.d.e.r.o.r.e.e.i.l.i.g.a.r.CEnum.RANGE) && SquireBlueDragonKiller.llIlIIIllIIIIl(var8.getEquipmentSetup().get(EquipmentInventorySlot.AMMO), Equipment.fromSlot((EquipmentInventorySlot)EquipmentInventorySlot.AMMO).getId())) {
            var22.a(lIIllllIIIIl[0]);
            return lIIllllIIIIl[0];
        }
    ...
    private static String llIlIIIlIlllII(String var5, String var10) {
        try {
            ...
            var11.init(lIIllllIIIIl[3], var1);
    ...
    private static void llIlIIIlIllllI() {
        ...
        SquireBlueDragonKiller.lIIllllIIIIl[0] = 1;
        SquireBlueDragonKiller.lIIllllIIIIl[1] = 0x41 ^ 0x49;
        SquireBlueDragonKiller.lIIllllIIIIl[2] = (0xB3 ^ 0x94) & ~(0x4D ^ 0x6A);
        SquireBlueDragonKiller.lIIllllIIIIl[3] = 2;
        SquireBlueDragonKiller.lIIllllIIIIl[4] = 3;
    ...
    private boolean a(int n) {
        ...
        block3: {
            block2: {
                void var9;
                void var17;
                SquireBlueDragonKiller var13;
                ItemComposition itemComposition = Static.getClient().getItemDefinition(n);
                if (SquireBlueDragonKiller.llIlIIIllIIIII(this.j.lootBones() ? 1 : 0) && !SquireBlueDragonKiller.llIlIIIllIIIIl(n, lIIllllIIIIl[9]) || SquireBlueDragonKiller.llIlIIIllIIIII(var13.j.lootHides() ? 1 : 0) && !SquireBlueDragonKiller.llIlIIIllIIIIl((int)var17, lIIllllIIIIl[10]) || SquireBlueDragonKiller.llIlIIIllIIIII(var13.j.lootScales() ? 1 : 0) && !SquireBlueDragonKiller.llIlIIIllIIIIl((int)var17, lIIllllIIIIl[11]) || SquireBlueDragonKiller.llIlIIIllIIIII(var13.j.lootEnsouled() ? 1 : 0) && !SquireBlueDragonKiller.llIlIIIllIIIIl((int)var17, lIIllllIIIIl[12])) break block2;
                if (!SquireBlueDragonKiller.llIlIIIllIIIII(var9.isStackable() ? 1 : 0)) break block3;
                int[] nArray = new int[lIIllllIIIIl[0]];
                nArray[SquireBlueDragonKiller.lIIllllIIIIl[2]] = var17;
    ...
    private void a(ItemSpawned itemSpawned) {
        ...
        if (SquireBlueDragonKiller.llIlIIIlIlllll(var16.a(var6.getId()) ? 1 : 0)) {
            return;
        }
        d d2 = new d();
        d2.f(tileItem.getId());
