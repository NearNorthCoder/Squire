...
public class k_Unknown {
    ...
    private static String lIlllllIIllIlIl(String var12, String var10) {
        try {
            SecretKeySpec var17 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var10.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var6 = Cipher.getInstance("Blowfish");
            var6.init(lIlIlIlIIIlIl[2], var17);
    ...
    private static String lIlllllIIllIlII(String var7, String var9) {
        try {
            SecretKeySpec var3 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var9.getBytes(StandardCharsets.UTF_8)), lIlIlIlIIIlIl[8]), "DES");
            Cipher var4 = Cipher.getInstance("DES");
            var4.init(lIlIlIlIIIlIl[2], var3);
    ...
    private static String lIlllllIIllIllI(String var1, String var8) {
        ...
        int var14 = lIlIlIlIIIlIl[0];
        char[] var16 = var1.toCharArray();
        int var18 = var16.length;
        int var19 = lIlIlIlIIIlIl[0];
        while (k.lIlllllIlIIIlIl(var19, var18)) {
            char var15 = var16[var19];
            var11.append((char)(var15 ^ var2[var14 % var2.length]));
            0;
            ++var14;
            ++var19;
            0;
