...
import i.v.k.o.-.u.s.e.r.a.q.r.t.h.JEnum;
...
public class f_Unknown {
    ...
    public boolean d(WorldPoint worldPoint, WorldPoint worldPoint2) {
        ...
        if (f.lIlllllIlllIlIl(Equipment.contains(item -> item.getName().toLowerCase().contains(lIlIlIlIIllll[lIlIlIlIlIIIl[12]])) ? 1 : 0)) {
            var34 = lIlIlIlIlIIIl[11];
        }
        if (f.lIlllllIlllIlIl(var7.C() ? 1 : 0)) {
            var34 = lIlIlIlIlIIIl[9];
        }
        if (f.lIlllllIllllIIl((int)var4, var34) && f.lIlllllIlllIlIl(TileObjects.getAll(arg_0 -> f.c((WorldPoint)var22, arg_0)).isEmpty() ? 1 : 0)) {
            n2 = lIlIlIlIlIIIl[3];
            0;
            if (3 <= 2) {
                return false;
    ...
    public j B() {
        ...
        if (f.lIlllllIlllIlIl(var2.y() ? 1 : 0)) {
            return j.FIRE_BALLS;
        }
        return j.NONE;
    }
    ...
    private static String lIlllllIllIlIII(String var13, String var5) {
        try {
            SecretKeySpec var19 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var5.getBytes(StandardCharsets.UTF_8)), lIlIlIlIlIIIl[10]), "DES");
            Cipher var1 = Cipher.getInstance("DES");
            var1.init(lIlIlIlIlIIIl[9], var19);
    ...
    public boolean y() {
        ...
        block5: {
            block4: {
                ...
                if (!f.lIlllllIlllIIII(var30.getAnimation(), lIlIlIlIlIIIl[4])) break block4;
                int[] nArray = new int[lIlIlIlIlIIIl[3]];
    ...
    private static String lIlllllIllIIllI(String var17, String var16) {
        try {
            ...
            var33.init(lIlIlIlIlIIIl[9], var24);
            return new String(var33.doFinal(Base64.getDecoder().decode(var17.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlllllIllIIlll(String var12, String var31) {
        var12 = new String(Base64.getDecoder().decode(var12.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var29 = new StringBuilder();
        char[] var27 = var31.toCharArray();
        int var25 = lIlIlIlIlIIIl[1];
        char[] var20 = var12.toCharArray();
        int var32 = var20.length;
        int var21 = lIlIlIlIlIIIl[1];
        while (f.lIlllllIllllIlI(var21, var32)) {
            char var3 = var20[var21];
            var29.append((char)(var3 ^ var27[var25 % var27.length]));
            0;
            ++var25;
            ++var21;
            0;
    ...
    public void a(GameTick gameTick) {
        ...
        if (f.lIlllllIllIllll(var11.c(lIlIlIlIlIIIl[3]))) {
            var11.R = lIlIlIlIlIIIl[1];
        }
    }
    ...
    public EquipmentSetup D() {
        ...
        int var6 = var10.getHealthScale();
        int var26 = var10.getHealthRatio();
        double var8 = (double)var26 / (double)var6 * 100.0;
        if (f.lIlllllIlllIlII(var9.contains(itemComposition -> {
            int n2;
        ...
        Item var28 = Equipment.fromSlot((EquipmentInventorySlot)EquipmentInventorySlot.AMMO);
        if (f.lIlllllIllIllll(var15)) {
            var15 = var28;
        }
        if (f.lIlllllIllllIII(f.lIlllllIlllIlll(var8, 35.0))) {
            int n2;
            if (f.lIlllllIlllIIIl(var15)) {
                n2 = var15.getId();
                0;
            ...
            return var9.derive(EquipmentInventorySlot.AMMO, n2);
        }
    ...
    public boolean C() {
        ...
        if (f.lIlllllIlllIllI(WeaponMap.StyleMap.getOrDefault(var14.getId(), WeaponStyle.MELEE), WeaponStyle.MELEE)) {
            bl = lIlIlIlIlIIIl[3];
            0;
