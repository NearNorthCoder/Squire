...
import i.v.k.o.-.u.s.e.r.a.q.r.t.h.BankingTask;
import net.runelite.api.Client;
import net.unethicalite.api.items.Bank;
import net.unethicalite.api.widgets.Dialog;

/* TASK: Teleporting to Relleka -> TeleportingtorellekaTask */
...
extends BankingTask {
    ...
    private static void llIIIIIIIlIlllI() {
        ...
        t.lIlIllIIIllIl[1] = (77 + 220 - 279 + 226 ^ 8 + 104 - 66 + 104) & (0x6A ^ 0x21 ^ (0x1E ^ 0x37) ^ -1);
        t.lIlIllIIIllIl[2] = 1;
    }
