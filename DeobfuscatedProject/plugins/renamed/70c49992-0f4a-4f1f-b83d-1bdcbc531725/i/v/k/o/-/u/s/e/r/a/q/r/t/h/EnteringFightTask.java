...
import i.v.k.o.-.u.s.e.r.a.q.r.t.h.Q_Unknown;
...
/* TASK: Entering fight -> EnteringfightTask */
...
extends Q_Unknown {
    ...
    private static String lIllllllIllIIlI(String var6, String var2) {
        var6 = new String(Base64.getDecoder().decode(var6.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var10 = new StringBuilder();
        char[] var7 = var2.toCharArray();
        int var3 = lIlIlIlIllllI[0];
        char[] var5 = var6.toCharArray();
        int var4 = var5.length;
        int var1 = lIlIlIlIllllI[0];
        while (P.lIllllllIllIlll(var1, var4)) {
            char var8 = var5[var1];
            var10.append((char)(var8 ^ var7[var3 % var7.length]));
            0;
            ++var3;
            ++var1;
            0;
