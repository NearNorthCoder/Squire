...
import k.-.u.u.l.i.s.r.c.d.-.q.u.e.u.e.e.s.s.l.DEnum;
...
extends Config {
    ...
    default public boolean lowHpSpec() {
        return ((0xC9 ^ 0xAF ^ (0x13 ^ 0x7E)) & (164 + 55 - 85 + 53 ^ 121 + 85 - 139 + 109 ^ -1) & ((220 + 212 - 252 + 56 ^ 168 + 85 - 218 + 155) & (0x1B ^ 0x37 ^ (0xFD ^ 0x83) ^ -1) ^ -1)) != 0;
    }
    ...
    default public boolean lightbearer() {
        return ((0xA9 ^ 0xA7 ^ 2) & (0xD6 ^ 0xB3 ^ (0x77 ^ 0x1E) ^ -1)) != 0;
    }
    ...
    default public boolean safeDodge() {
        return ((0x5C ^ 0x56 ^ (0x72 ^ 0x56)) & (0x28 ^ 0x7A ^ (0xC8 ^ 0xB4) ^ -1)) != 0;
    }
