...
import o.m.-.g.q.i.l.i.r.y.o.e.x.u.s.TEnum;
...
public class s_Unknown {
    ...
    public static boolean h() {
        ...
        int var53 = llllllllllIl[1];
        while (s.lIIlIlIllllIlII(var53, (int)var20)) {
            void var62;
            void var48 = var62[var53];
            int[] nArray = new int[llllllllllIl[2]];
            nArray[s.llllllllllIl[1]] = var48.o();
    ...
    public static t d(String string) {
        ...
        t[] tArray = t.values();
        int n2 = tArray.length;
        int var45 = llllllllllIl[1];
        while (s.lIIlIlIllllIlII(var45, (int)var85)) {
            String var73;
            void var31;
            void var17 = var31[var45];
            if (s.lIIlIlIllllIlIl(var17.a().equalsIgnoreCase(var73) ? 1 : 0)) {
                return var17;
            }
            ++var45;
            0;
    ...
    private static t a(t ... tArray) {
        ...
        int var67 = llllllllllIl[1];
        while (s.lIIlIlIllllIlII(var67, (int)var63)) {
            int var59;
            void var54;
            void var69 = var54[var67];
            if (s.lIIlIlIllllIIlI(var69) && s.lIIlIlIllllIllI(var69.p(), var59)) {
                var59 = var69.p();
                void lllllllllllllllIIlIIIIlIIlllIlIl = var69;
            }
            ++var67;
            0;
    ...
    private static String lIIlIlIlllIIIll(String var8, String var35) {
        var8 = new String(Base64.getDecoder().decode(var8.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var7 = new StringBuilder();
        char[] var37 = var35.toCharArray();
        int var5 = llllllllllIl[1];
        char[] var32 = var8.toCharArray();
        int var13 = var32.length;
        int var42 = llllllllllIl[1];
        while (s.lIIlIlIllllIlII(var42, var13)) {
            char var39 = var32[var42];
            var7.append((char)(var39 ^ var37[var5 % var37.length]));
            0;
            ++var5;
            ++var42;
            0;
    ...
    public static boolean f() {
        ...
        t[] tArray = t.values();
        int n2 = tArray.length;
        int var11 = llllllllllIl[1];
        while (s.lIIlIlIllllIlII(var11, (int)var82)) {
            block4: {
                block3: {
                    void var27;
                    void var6 = var27[var11];
                    int[] nArray = new int[llllllllllIl[2]];
                    nArray[s.llllllllllIl[1]] = var6.n();
                    if (!s.lIIlIlIllllIIll(Inventory.contains((int[])nArray) ? 1 : 0)) break block3;
                    int[] nArray2 = new int[llllllllllIl[2]];
                    nArray2[s.llllllllllIl[1]] = var6.o();
    ...
    private static String lIIlIlIlllIIIlI(String var87, String var78) {
        try {
            SecretKeySpec var47 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var78.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var76 = Cipher.getInstance("Blowfish");
            var76.init(llllllllllIl[3], var47);
            return new String(var76.doFinal(Base64.getDecoder().decode(var87.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static int e(String string) {
        ...
        t[] tArray = t.values();
        int n2 = tArray.length;
        int var65 = llllllllllIl[1];
        while (s.lIIlIlIllllIlII(var65, (int)var74)) {
            String var52;
            void var15;
            void var57 = var15[var65];
            if (s.lIIlIlIllllIlIl(var57.a().equalsIgnoreCase(var52) ? 1 : 0)) {
                return var57.o();
            }
            ++var65;
            0;
    ...
    public static t a(String string, String string2, String string3, String string4) {
        ...
        if (s.lIIlIlIllllIIlI(var71) && s.lIIlIlIllllIIlI(var16 = s.d((String)var71))) {
            var77.add(var16);
            0;
        }
        if (s.lIIlIlIllllIIlI(var41) && s.lIIlIlIllllIIlI(var16 = s.d((String)var41))) {
            var77.add(var16);
            0;
        }
        if (s.lIIlIlIllllIIll((var16 = var77.stream().filter(t2 -> t2.q().equalsIgnoreCase(var60)).collect(Collectors.toList())).isEmpty() ? 1 : 0)) {
            return var16.stream().max(Comparator.comparingInt(t::p)).orElse(null);
        }
    ...
    public static boolean c(String string) {
        ...
        TileObject var12 = TileObjects.getNearest((String[])stringArray2);
        String[] stringArray3 = new String[llllllllllIl[2]];
        stringArray3[s.llllllllllIl[1]] = lllllllllIIl[llllllllllIl[11]];
        TileObject var49 = TileObjects.getNearest((String[])stringArray3);
        int var88 = llllllllllIl[12];
        int var83 = llllllllllIl[13];
        int var50 = llllllllllIl[14];
        if (s.lIIlIlIlllllIII(Vars.getBit((int)var88), var66.m()) && s.lIIlIlIllllIIll(Vars.getBit((int)var88))) {
            if (s.lIIlIlIlllllIIl(var66.m(), llllllllllIl[0])) {
                SquireMixology.g = lllllllllIIl[llllllllllIl[15]];
                var10.interact(lllllllllIIl[llllllllllIl[16]]);
                return llllllllllIl[1];
            }
            if (s.lIIlIlIlllllIIl(var66.m(), llllllllllIl[2])) {
                SquireMixology.g = lllllllllIIl[llllllllllIl[17]];
                var12.interact(lllllllllIIl[llllllllllIl[18]]);
                return llllllllllIl[1];
            }
            if (s.lIIlIlIlllllIIl(var66.m(), llllllllllIl[3])) {
                SquireMixology.g = lllllllllIIl[llllllllllIl[19]];
                var49.interact(lllllllllIIl[llllllllllIl[20]]);
                return llllllllllIl[1];
            }
            return llllllllllIl[1];
        }
        if (s.lIIlIlIlllllIII(Vars.getBit((int)var83), var66.k()) && s.lIIlIlIllllIIll(Vars.getBit((int)var83))) {
            if (s.lIIlIlIlllllIIl(var66.k(), llllllllllIl[0])) {
                SquireMixology.g = lllllllllIIl[llllllllllIl[21]];
                var10.interact(lllllllllIIl[llllllllllIl[22]]);
                return llllllllllIl[1];
            }
            if (s.lIIlIlIlllllIIl(var66.k(), llllllllllIl[2])) {
                SquireMixology.g = lllllllllIIl[llllllllllIl[23]];
                var12.interact(lllllllllIIl[llllllllllIl[24]]);
                return llllllllllIl[1];
            }
            if (s.lIIlIlIlllllIIl(var66.k(), llllllllllIl[3])) {
                SquireMixology.g = lllllllllIIl[llllllllllIl[25]];
                var49.interact(lllllllllIIl[llllllllllIl[26]]);
                return llllllllllIl[1];
            }
            return llllllllllIl[1];
        }
        if (s.lIIlIlIlllllIII(Vars.getBit((int)var50), var66.l()) && s.lIIlIlIllllIIll(Vars.getBit((int)var50))) {
            if (s.lIIlIlIlllllIIl(var66.l(), llllllllllIl[0])) {
                SquireMixology.g = lllllllllIIl[llllllllllIl[27]];
                var10.interact(lllllllllIIl[llllllllllIl[28]]);
                return llllllllllIl[1];
            }
            if (s.lIIlIlIlllllIIl(var66.l(), llllllllllIl[2])) {
                SquireMixology.g = lllllllllIIl[llllllllllIl[29]];
                var12.interact(lllllllllIIl[llllllllllIl[30]]);
                return llllllllllIl[1];
            }
            if (s.lIIlIlIlllllIIl(var66.l(), llllllllllIl[3])) {
                SquireMixology.g = lllllllllIIl[llllllllllIl[31]];
                var49.interact(lllllllllIIl[llllllllllIl[32]]);
                return llllllllllIl[1];
            }
            return llllllllllIl[1];
        }
    ...
    private static String lIIlIlIlllIIlII(String var18, String var2) {
        try {
            SecretKeySpec var22 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var2.getBytes(StandardCharsets.UTF_8)), llllllllllIl[10]), "DES");
            Cipher var28 = Cipher.getInstance("DES");
            var28.init(llllllllllIl[3], var22);
            return new String(var28.doFinal(Base64.getDecoder().decode(var18.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static int f(String string) {
        ...
        t[] tArray = t.values();
        int n2 = tArray.length;
        int var36 = llllllllllIl[1];
        while (s.lIIlIlIllllIlII(var36, (int)var29)) {
            String var33;
            void var34;
            void var61 = var34[var36];
            if (s.lIIlIlIllllIlIl(var61.a().equalsIgnoreCase(var33) ? 1 : 0)) {
                return var61.n();
            }
            ++var36;
            0;
    ...
    private static t a(String string) {
        ...
        t[] tArray = t.values();
        int n2 = tArray.length;
        int var79 = llllllllllIl[1];
        while (s.lIIlIlIllllIlII(var79, (int)var72)) {
            String var51;
            void var56;
            void var1 = var56[var79];
            if (s.lIIlIlIllllIlIl(var1.a().equalsIgnoreCase(var51) ? 1 : 0)) {
                return var1;
            }
            ++var79;
            0;
    ...
    public static boolean a(int n2, int n3, int n4) {
        ...
        if (s.lIIlIlIlllllIlI(Vars.getBit((int)var26)) && s.lIIlIlIllllIIll(Players.getLocal().isAnimating() ? 1 : 0)) {
            return llllllllllIl[2];
        }
    ...
    public static void j() {
        ...
        nArray3[s.llllllllllIl[1]] = var30;
        if (s.lIIlIlIllllIlIl(Inventory.contains((int[])nArray3) ? 1 : 0) && s.lIIlIlIllllIlIl(var55.equalsIgnoreCase((String)var89) ? 1 : 0)) {
            int[] nArray4 = new int[llllllllllIl[2]];
            nArray4[s.llllllllllIl[1]] = var14;
            if (s.lIIlIlIllllIlIl(Inventory.contains((int[])nArray4) ? 1 : 0)) {
                int[] nArray5 = new int[llllllllllIl[2]];
                nArray5[s.llllllllllIl[1]] = var30;
        ...
        nArray6[s.llllllllllIl[1]] = var30;
        if (s.lIIlIlIllllIlIl(Inventory.contains((int[])nArray6) ? 1 : 0) && s.lIIlIlIllllIlIl(var89.equalsIgnoreCase((String)var3) ? 1 : 0)) {
            int[] nArray7 = new int[llllllllllIl[2]];
            nArray7[s.llllllllllIl[1]] = var40;
            if (s.lIIlIlIllllIlIl(Inventory.contains((int[])nArray7) ? 1 : 0)) {
                int[] nArray8 = new int[llllllllllIl[2]];
                nArray8[s.llllllllllIl[1]] = var30;
        ...
        nArray9[s.llllllllllIl[1]] = var30;
        if (s.lIIlIlIllllIlIl(Inventory.contains((int[])nArray9) ? 1 : 0) && s.lIIlIlIllllIlIl(var89.equalsIgnoreCase((String)var3) ? 1 : 0)) {
            int[] nArray10 = new int[llllllllllIl[2]];
            nArray10[s.llllllllllIl[1]] = var40;
            if (s.lIIlIlIllllIlIl(Inventory.contains((int[])nArray10) ? 1 : 0)) {
                int[] nArray11 = new int[llllllllllIl[2]];
                nArray11[s.llllllllllIl[1]] = var30;
        ...
        nArray14[s.llllllllllIl[1]] = var38;
        if (s.lIIlIlIllllIlIl(Inventory.contains((int[])nArray14) ? 1 : 0) && s.lIIlIlIllllIlIl(var55.equalsIgnoreCase((String)var3) ? 1 : 0)) {
            int[] nArray15 = new int[llllllllllIl[2]];
            nArray15[s.llllllllllIl[1]] = var40;
    ...
    public static boolean g() {
        ...
        while (s.lIIlIlIllllIlII(var25, (int)var4)) {
            void var21;
            void var75 = var21[var25];
            int[] nArray = new int[llllllllllIl[2]];
            nArray[s.llllllllllIl[1]] = var75.n();
            if (s.lIIlIlIllllIlIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                return llllllllllIl[2];
            }
            ++var25;
    ...
    public static boolean b(String string, String string2, String string3) {
        ...
        int var58 = llllllllllIl[1];
        while (s.lIIlIlIllllIlII(var58, (int)var43)) {
            void var80;
            void var19;
            String var70;
            void var46;
            void var44 = var46[var58];
            if (s.lIIlIlIllllIlIl(var44.a().equalsIgnoreCase(var70) ? 1 : 0)) {
                var9 = var44.o();
                0;
                
                }
            } else if (s.lIIlIlIllllIlIl(var44.a().equalsIgnoreCase((String)var19) ? 1 : 0)) {
                var86 = var44.o();
                0;
                if (((0xC ^ 0x1C ^ (0x22 ^ 0x27)) & (0x65 ^ 0x57 ^ (0x50 ^ 0x77) ^ -1)) != 0) {
                    return ((0xD2 ^ 0xAE ^ (0x93 ^ 0xC0)) & (109 + 41 - 93 + 180 ^ 63 + 153 - 40 + 18 ^ -1)) != 0;
                }
            } else if (s.lIIlIlIllllIlIl(var44.a().equalsIgnoreCase((String)var80) ? 1 : 0)) {
                var81 = var44.o();
                0;
                if (1 != 1) {
        ...
        int[] nArray = new int[llllllllllIl[2]];
        nArray[s.llllllllllIl[1]] = var9;
        if (s.lIIlIlIllllIlIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
            int[] nArray2 = new int[llllllllllIl[2]];
            nArray2[s.llllllllllIl[1]] = var86;
            if (s.lIIlIlIllllIlIl(Inventory.contains((int[])nArray2) ? 1 : 0)) {
                int[] nArray3 = new int[llllllllllIl[2]];
                nArray3[s.llllllllllIl[1]] = var81;
