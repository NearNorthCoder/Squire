...
import i.i.-.h.u.s.e.r.q.r.s.f.e.ChoppingTentacleTask;
import i.i.-.h.u.s.e.r.q.r.s.f.e.ClimbingUpLadderTask;
import i.i.-.h.u.s.e.r.q.r.s.f.e.LootingTask;
import i.i.-.h.u.s.e.r.q.r.s.f.e.DepositingLootTask;
import i.i.-.h.u.s.e.r.q.r.s.f.e.EnteringFishingTrawlerTask;
import i.i.-.h.u.s.e.r.q.r.s.f.e.BankingTask;
import i.i.-.h.u.s.e.r.q.r.s.f.e.DroppingFishTask;
import i.i.-.h.u.s.e.r.q.r.s.f.e.OpeningTheBarrelTask;
import i.i.-.h.u.s.e.r.q.r.s.f.e.FishingTask;
import i.i.-.h.u.s.e.r.q.r.s.f.e.BankingThroughButlerTask;
import i.i.-.h.u.s.e.r.q.r.s.f.e.UsingSpecialAttackTask;
import i.i.-.h.u.s.e.r.q.r.s.f.e.TickManipulatingTask;
