...
import u.t.e.e.g.q.r.d.h.r.i.i.n.i.i.-.s.-.f.s.f.-.t.n.BankingTask;
import u.t.e.e.g.q.r.d.h.r.i.i.n.i.i.-.s.-.f.s.f.-.t.n.ChasingFishTask;
import u.t.e.e.g.q.r.d.h.r.i.i.n.i.i.-.s.-.f.s.f.-.t.n.EnterInstanceTask;
import u.t.e.e.g.q.r.d.h.r.i.i.n.i.i.-.s.-.f.s.f.-.t.n.StartBankingTask;
import u.t.e.e.g.q.r.d.h.r.i.i.n.i.i.-.s.-.f.s.f.-.t.n.FiguringOutWhatHarpoonWeAreUsingTask;
import u.t.e.e.g.q.r.d.h.r.i.i.n.i.i.-.s.-.f.s.f.-.t.n.PlacingNetTask;
import u.t.e.e.g.q.r.d.h.r.i.i.n.i.i.-.s.-.f.s.f.-.t.n.RemovingNetTask;
import u.t.e.e.g.q.r.d.h.r.i.i.n.i.i.-.s.-.f.s.f.-.t.n.StopDivingTask;
import u.t.e.e.g.q.r.d.h.r.i.i.n.i.i.-.s.-.f.s.f.-.t.n.RemovingNetTask;
...
extends SquirePlugin {
    ...
    private static String llIlIIlllIlIlI(String var21, String var13) {
        try {
            ...
            var19.init(lIlIIIIlIIII[3], var14);
    ...
    public void b() {
        if (SquireDriftNet.llIlIIlllIllll(this.b.isEmpty() ? 1 : 0)) {
            ...
            var20.g().add(var20.b, lIlIIIIlIIII[2]);
            0;
            var20.g().add(lIlIIIIlIIII[10]);
            0;
        }
    }

    private static String llIlIIlllIlIIl(String var10, String var3) {
        var10 = new String(Base64.getDecoder().decode(var10.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var11 = new StringBuilder();
        char[] var9 = var3.toCharArray();
        int var7 = lIlIIIIlIIII[0];
        char[] var2 = var10.toCharArray();
        int var18 = var2.length;
        int var5 = lIlIIIIlIIII[0];
        while (SquireDriftNet.llIlIIllllIlII(var5, var18)) {
            char var4 = var2[var5];
            var11.append((char)(var4 ^ var9[var7 % var9.length]));
            0;
            ++var7;
            ++var5;
            0;
    ...
    public String a() {
        ...
        if (SquireDriftNet.llIlIIllllIIII(var6)) {
            return var6.getName();
        }
        return lIlIIIIIllll[lIlIIIIlIIII[5]];
    }

    private static String llIlIIlllIIIlI(String var15, String var16) {
        try {
            SecretKeySpec var12 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var16.getBytes(StandardCharsets.UTF_8)), lIlIIIIlIIII[9]), "DES");
            Cipher var1 = Cipher.getInstance("DES");
            var1.init(lIlIIIIlIIII[3], var12);
