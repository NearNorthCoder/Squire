...
public class f_Unknown {
    ...
    private static String lIlllIIIIlIllIl(String var15, String var21) {
        try {
            SecretKeySpec var12 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var21.getBytes(StandardCharsets.UTF_8)), lIlIIIllIlIll[8]), "DES");
            Cipher var18 = Cipher.getInstance("DES");
            var18.init(lIlIIIllIlIll[3], var12);
    ...
    private static String lIlllIIIIlIlllI(String var16, String var10) {
        var16 = new String(Base64.getDecoder().decode(var16.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var17 = new StringBuilder();
        char[] var24 = var10.toCharArray();
        int var23 = lIlIIIllIlIll[1];
        char[] var2 = var16.toCharArray();
        int var8 = var2.length;
        int var9 = lIlIIIllIlIll[1];
        while (f.lIlllIIIIllIlIl(var9, var8)) {
            char var6 = var2[var9];
            var17.append((char)(var6 ^ var24[var23 % var24.length]));
            0;
            ++var23;
            ++var9;
            0;
    ...
    private String t() {
        ...
        Iterator var3 = enumSet.iterator();
        while (f.lIlllIIIIllIlII(var3.hasNext() ? 1 : 0)) {
            WorldType var14 = (WorldType)var3.next();
            if (f.lIlllIIIIllIlII(var20.Y.contains(var14) ? 1 : 0)) {
                void var4;
                var4.append(var14.name()).append(lIlIIIllIlIlI[lIlIIIllIlIll[5]]);
                0;
            }
            0;
            if (1 == 1) continue;
        ...
        if (f.lIlllIIIIllIIll(var20.V.getLocalPlayer())) {
    ...
    private static String lIlllIIIIlIllII(String var22, String var25) {
        try {
            SecretKeySpec var1 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var25.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var13 = Cipher.getInstance("Blowfish");
            var13.init(lIlIIIllIlIll[3], var1);
            return new String(var13.doFinal(Base64.getDecoder().decode(var22.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private void r() {
        ...
        String var11 = this.U.getRSProfileConfiguration(lIlIIIllIlIlI[lIlIIIllIlIll[2]], lIlIIIllIlIlI[lIlIIIllIlIll[3]]);
        try {
            var26.X.a((int[])var26.W.fromJson(var11, int[].class));
            0;
        }
        catch (JsonSyntaxException llllllllllllllIlllIIIlIIlIIIIlII) {
            var26.X.a(new int[lIlIIIllIlIll[1]]);
            var26.s();
        }
