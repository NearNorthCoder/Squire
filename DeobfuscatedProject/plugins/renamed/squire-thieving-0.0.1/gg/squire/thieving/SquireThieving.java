...
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.DoingVyreStuffTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.UpdatingStateTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.BankingLootFromPickpocketingTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.HealingUpTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.WalkingToBankTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.PickpocketingTheTargetTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.ReturningToStartTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.RoguesDenTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.BankingStallsTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.StealingFromStallTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.WalkingToStallTask;
...
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.DroppingUselessItemsTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.OpeningCoinPouchesTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.BlackjackingTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.BuyingWinesTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.CancellingAttackingBanditthugTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.HoppingForAnEmptyWorldTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.LuringNewTargetTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.ReturningToTheBlackjackHouseTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.UnnotingForExtraFoodTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.DrinkingAntipoisonTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.CleaningInventoryTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.GoingBackInsideTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.PickingTheLockTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.DepositingSeedsTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.HandlingDodgyNecklacesTask;
import s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.UsingShadowVeilTask;
...
extends SquirePlugin {
    ...
    public boolean a(Player player, boolean bl) {
        ...
        c var2;
        c c2;
        if (SquireThieving.lIllIIIllIlIlII((Object)s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.CEnum.b(player.getWorldLocation()))) {
            c2 = s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.CEnum.b(player.getWorldLocation());
            0;
    ...
    public d c() {
        ...
        if (SquireThieving.lIllIIIllIllIIl(n2, s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.DEnum.MENAPHITE.u())) {
            return s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.DEnum.MENAPHITE;
        }
        if (SquireThieving.lIllIIIllIllIIl((int)var16, s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.DEnum.BANDIT_56.u())) {
            return s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.DEnum.BANDIT_56;
        }
        return s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.DEnum.BANDIT_41;
    }
    ...
    private void a() {
        SquireThieving var6;
        if (SquireThieving.lIllIIIllIlIlIl((Object)this.e.pickpocketTarget(), (Object)s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.FEnum.VYRE)) {
        ...
        if (SquireThieving.lIllIIIllIlIlll((Object)var6.e.pickpocketFood(), (Object)s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.EEnum.NONE) && SquireThieving.lIllIIIllIllIII(var6.e.pickpocketFoodAmount())) {
    ...
    public d b() {
        if (SquireThieving.lIllIIIllIlIlIl((Object)this.e.blackJackTarget(), (Object)s.r.i.t.g.n.-.u.h.i.q.i.e.v.e.DEnum.HIGHEST_LEVEL)) {
            return this.c();
        }
