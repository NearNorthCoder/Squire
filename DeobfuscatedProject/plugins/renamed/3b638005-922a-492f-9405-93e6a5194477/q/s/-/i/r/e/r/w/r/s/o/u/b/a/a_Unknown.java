...
import q.s.-.i.r.e.r.w.r.s.o.u.b.a.b_Unknown;
...
public class a_Unknown {
    ...
    public int[] d(d d2) {
        switch (b.v[d2.ordinal()]) {
            case 1: {
                a var2;
                return var2.a(var2.u.ahrimSpecGear());
            }
            case 2: {
                a var2;
                return var2.a(var2.u.karilSpecGear());
            }
        }
    ...
    public int[] c(d d2) {
        switch (b.v[d2.ordinal()]) {
            case 1: {
                a var1;
                return var1.a(var1.u.ahrimGear());
            }
            case 2: {
                a var1;
                return var1.a(var1.u.karilGear());
            }
        }
    ...
    private static void lIllIIlIllIIIl() {
        ...
        a.llllIIIIIII[0] = (4 ^ 0x66 ^ (0x72 ^ 0x19)) & (0xB3 ^ 0xB5 ^ (0x73 ^ 0x7C) ^ -1);
    }
