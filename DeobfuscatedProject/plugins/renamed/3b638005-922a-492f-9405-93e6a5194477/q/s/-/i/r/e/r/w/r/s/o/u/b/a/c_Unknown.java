...
import q.s.-.i.r.e.r.w.r.s.o.u.b.a.EEnum;
...
public class c_Unknown {
    ...
    public List<String> c(int n2) {
        ...
        int var5 = llllIIIIllI[5];
        while (c.lIllIIllIIllIl(var5, var4)) {
            void var6;
            e var7 = var2[var5];
            if (c.lIllIIllIIlllI(var7.G(), (int)var6)) {
                void var3;
                var3.add(var7.H());
                0;
            }
    ...
    private static void lIllIIllIIlIIl() {
        ...
        c.llllIIIIllI[5] = (59 + 110 - 32 + 25 ^ 7 + 110 - 89 + 108) & (172 + 45 - 119 + 77 ^ 95 + 74 - 39 + 3 ^ -1);
        c.llllIIIIllI[6] = 1;
    }
