...
import m.u.a.-.e.s.q.t.i.r.DEnum;
...
extends w_Unknown<e> {
    ...
    private static String lIIIlIllllIIlIl(String var22, String var4) {
        try {
            SecretKeySpec var20 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var4.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var11 = Cipher.getInstance("Blowfish");
            var11.init(lllIlIlIIIII[3], var20);
    ...
    private static String lIIIlIllllIIllI(String var16, String var12) {
        var16 = new String(Base64.getDecoder().decode(var16.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var17 = new StringBuilder();
        char[] var2 = var12.toCharArray();
        int var5 = lllIlIlIIIII[1];
        char[] var21 = var16.toCharArray();
        int var1 = var21.length;
        int var19 = lllIlIlIIIII[1];
        while (r.lIIIlIlllllIIII(var19, var1)) {
            char var15 = var21[var19];
            var17.append((char)(var15 ^ var2[var5 % var2.length]));
            0;
            ++var5;
            ++var19;
            0;
    ...
    public boolean M() {
        ...
        int var18 = Inventory.getCount((boolean)lllIlIlIIIII[2], (String[])stringArray);
        if (r.lIIIlIllllIlIlI(var18, var13.au)) {
            ...
            if (r.lIIIlIllllIlIIl(var8)) {
                return lllIlIlIIIII[1];
            }
            var8.interact(lllIlIlIIIII[1]);
            return lllIlIlIIIII[2];
        }
        if (r.lIIIlIllllIlIll(var18)) {
            var13.au = Rand.nextInt((int)lllIlIlIIIII[4], (int)lllIlIlIIIII[5]);
        }
        int[] nArray = new int[lllIlIlIIIII[2]];
        nArray[r.lllIlIlIIIII[1]] = ((e)var13.aB).l().i();
        Item var8 = Inventory.getFirst((int[])nArray);
        if (r.lIIIlIllllIllII(var8)) {
            Magic.cast((Spell)var13.L(), (Item)var8);
            return lllIlIlIIIII[2];
        }
        if (r.lIIIlIllllIllIl(Inventory.isFull() ? 1 : 0)) {
            Item var14 = Inventory.getFirst(item -> Stream.of(d.values()).anyMatch(d2 -> {
                boolean bl;
            ...
            if (r.lIIIlIllllIlIIl(var14)) {
                return lllIlIlIIIII[1];
            }
            Magic.cast((Spell)var13.L(), (Item)var14);
            return lllIlIlIIIII[2];
        }
        if (r.lIIIlIllllIlllI((Object)var24.s(), (Object)d.EMPTY)) {
            System.out.println(lllIlIIlllll[lllIlIlIIIII[6]]);
            Arrays.stream(((e)var13.aB).p()).filter(g2 -> g2.s().j().equals(lllIlIIlllll[lllIlIlIIIII[8]])).findFirst().ifPresent(g2 -> g2.r().interact(lllIlIlIIIII[1]));
            return lllIlIlIIIII[2];
        }
    ...
    private static String lIIIlIllllIIlII(String var9, String var3) {
        try {
            SecretKeySpec var10 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var3.getBytes(StandardCharsets.UTF_8)), lllIlIlIIIII[11]), "DES");
            Cipher var6 = Cipher.getInstance("DES");
            var6.init(lllIlIlIIIII[3], var10);
