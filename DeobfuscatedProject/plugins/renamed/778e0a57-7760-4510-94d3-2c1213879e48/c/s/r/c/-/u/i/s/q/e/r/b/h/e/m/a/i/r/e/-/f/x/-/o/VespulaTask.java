...
extends U_Unknown {
    ...
    public boolean cg() {
        ...
        if (aH.llIlIllllIlIlI(var19.bS.distanceTo(var19.ak.bs), lIlIIIllllll[2]) && aH.llIlIllllIlIIl(var19.dm() ? 1 : 0)) {
            return lIlIIIllllll[2];
        }
        var19.dl();
        0;
        var19.db();
        if (aH.llIlIllllIlIlI(var19.cq.getTickCount() - var19.dX, lIlIIIllllll[3]) && aH.llIlIllllIlIll(Prayers.getPoints())) {
            void var14;
            if (aH.llIlIllllIlIII(var14)) {
                return lIlIIIllllll[4];
            }
            var14.interact(lIlIIIlllllI[lIlIIIllllll[4]]);
            return lIlIIIllllll[2];
        }
        WorldPoint var11 = H.VESPULA_ATTACK_POINT.c(var19.ak);
        if (aH.llIlIllllIlIIl(var19.bS.getWorldLocation().equals((Object)var11) ? 1 : 0)) {
            System.out.println(lIlIIIlllllI[lIlIIIllllll[2]]);
            var19.dX = var19.cq.getTickCount();
            return lIlIIIllllll[2];
        }
    ...
    public List<Prayer> ci() {
        ...
        if (aH.llIlIllllIlIlI(var21.bS.distanceTo(var21.ak.bs), lIlIIIllllll[2])) {
            return null;
        }
    ...
    private static String llIlIllllIIlII(String var25, String var8) {
        ...
        int var27 = lIlIIIllllll[4];
        char[] var20 = var25.toCharArray();
        int var26 = var20.length;
        int var24 = lIlIIIllllll[4];
        while (aH.llIlIlllllIIII(var24, var26)) {
            char var16 = var20[var24];
            var13.append((char)(var16 ^ var18[var27 % var18.length]));
            0;
            ++var27;
            ++var24;
            0;
    ...
    private boolean cS() {
        ...
        TileObject var9 = var10.cR();
        if (aH.llIlIllllIlIII(var9)) {
            Movement.setDestination((WorldPoint)var10.ak.bq.dx(lIlIIIllllll[5]).dy(lIlIIIllllll[5]));
            return lIlIIIllllll[2];
        }
        if (!aH.llIlIllllIlllI(var10.bS.isMoving() ? 1 : 0) || aH.llIlIllllIlIIl(var10.bS.isAnimating() ? 1 : 0)) {
            return lIlIIIllllll[4];
        }
    ...
    private boolean dl() {
        ...
        int var4 = Static.getClient().getVarbitValue(lIlIIIllllll[1]);
        if (aH.llIlIllllIlIll(var4)) {
            return lIlIIIllllll[4];
        }
    ...
    private boolean cU() {
        ...
        if (aH.llIlIllllIlllI(Inventory.contains(item -> item.getName().startsWith(lIlIIIlllllI[lIlIIIllllll[14]])) ? 1 : 0)) {
            var15 = TileItems.getNearest(tileItem -> {
                int n2;
    ...
    private static String llIlIllllIIlIl(String var7, String var5) {
        try {
            SecretKeySpec var6 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var5.getBytes(StandardCharsets.UTF_8)), lIlIIIllllll[11]), "DES");
            Cipher var2 = Cipher.getInstance("DES");
            var2.init(lIlIIIllllll[3], var6);
    ...
    private static String llIlIllllIIIll(String var1, String var17) {
        try {
            SecretKeySpec var23 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var17.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var22 = Cipher.getInstance("Blowfish");
            var22.init(lIlIIIllllll[3], var23);
