...
public class h_Unknown {
    ...
    public void a(GameTick gameTick) {
        h var1;
        int n2 = c.s.r.c.-.u.i.s.q.e.r.b.h.e.m.a.i.r.e.-.f.x.-.o.u_Unknown.bo();
        if (h.llIllIlllllIlI(n2, this.aw)) {
            this.aw = n2;
        }
        if (h.llIllIlllllIll(c.s.r.c.-.u.i.s.q.e.r.b.h.e.m.a.i.r.e.-.f.x.-.o.u_Unknown.be() ? 1 : 0) && h.llIllIllllllII(var1.aw)) {
            var1.av += var1.aw;
