...
public abstract class aR_Unknown
extends Task {
    ...
    protected void cm() {
        ...
        if (aR.llIllllIlIllll(var36.isEquipped() ? 1 : 0)) {
            return;
        }
    ...
    protected List<WorldPoint> l(String string) {
        ...
        int n2 = var21.dG();
        void var28 = var9;
        int var24 = lIlIlIllIlIl[3];
        switch (var28.hashCode()) {
            case -2021012075: {
                if (!aR.llIllllIlIllll(var28.equals(lIlIlIlIllII[lIlIlIllIlIl[13]]) ? 1 : 0)) break;
                var24 = lIlIlIllIlIl[0];
                0;
                if (1 > 0) break;
                return null;
            }
            case 2332679: {
                if (!aR.llIllllIlIllll(var28.equals(lIlIlIlIllII[lIlIlIllIlIl[14]]) ? 1 : 0)) break;
                var24 = lIlIlIllIlIl[2];
                0;
                if (1 == 1) break;
                return null;
            }
            case -1691410980: {
                if (!aR.llIllllIlIllll(var28.equals(lIlIlIlIllII[lIlIlIllIlIl[15]]) ? 1 : 0)) break;
                var24 = lIlIlIllIlIl[4];
                0;
                if (null == null) break;
                return null;
            }
            case 77974012: {
                if (!aR.llIllllIlIllll(var28.equals(lIlIlIlIllII[lIlIlIllIlIl[10]]) ? 1 : 0)) break;
                var24 = lIlIlIllIlIl[5];
            }
        }
        switch (var24) {
            case 0: {
                if (aR.llIllllIlIllll(var21.dC().contains((Locatable)var21.bS) ? 1 : 0)) {
                    return var21.dB().toWorldPointList();
                }
                List var20 = var21.dD().toWorldPointList();
                List var7 = var21.dB().toWorldPointList();
                var20.addAll(var7);
                0;
                return var20;
            }
            case 1: {
                if (aR.llIllllIlIllll(n2)) {
                    return var21.dC().toWorldPointList();
                }
                return var21.dE().toWorldPointList();
            }
            case 2: {
                if (aR.llIllllIllIIII(n2)) {
                    return var21.dB().toWorldPointList();
                }
                return var21.dD().toWorldPointList();
            }
            case 3: {
                if (aR.llIllllIllIIII(n2)) {
                    return var21.dC().toWorldPointList();
    ...
    protected boolean ds() {
        ...
        if (aR.llIllllIlIllll(var12.ed.at() ? 1 : 0)) {
            boolean bl2;
            if (!aR.llIllllIllIlIl(var12.ed.aG(), var12.dV()) || !aR.llIllllIllIllI(var12.ed.aG(), lIlIlIllIlIl[3]) || aR.llIllllIllIlll(var12.ed.aH(), var12.dU()) && aR.llIllllIllIllI(var12.ed.aH(), lIlIlIllIlIl[3])) {
                bl2 = lIlIlIllIlIl[2];
                0;
    ...
    protected WorldPoint dK() {
        ...
        if (aR.llIllllIlIllll(this.dG() ? 1 : 0)) {
            ...
            n2 = var4 = lIlIlIllIlIl[3];
        }
        if (aR.llIllllIlIllll(var8.dG() ? 1 : 0)) {
            return var8.dJ().dx(var4 * lIlIlIllIlIl[0]).dy(var4 * lIlIlIllIlIl[1]);
        }
    ...
    protected String k(boolean bl2) {
        ...
        int n2 = var26.dG();
        if (aR.llIllllIlIllll(var26.dB().contains((Locatable)var26.bS) ? 1 : 0)) {
            if (aR.llIllllIlIllll(n2)) {
                return lIlIlIlIllII[lIlIlIllIlIl[12]];
            }
            return lIlIlIlIllII[lIlIlIllIlIl[17]];
        }
        if (aR.llIllllIlIllll(var26.dD().contains((Locatable)var26.bS) ? 1 : 0)) {
            if (aR.llIllllIllIIII(n2)) {
                return lIlIlIlIllII[lIlIlIllIlIl[18]];
            }
            return lIlIlIlIllII[lIlIlIllIlIl[19]];
        }
        if (aR.llIllllIlIllll((int)var31)) {
            if (aR.llIllllIlIllll(n2) && aR.llIllllIlIllll(var26.dC().contains((Locatable)var26.bS) ? 1 : 0)) {
                return lIlIlIlIllII[lIlIlIllIlIl[20]];
            }
            if (aR.llIllllIllIIII(n2) && aR.llIllllIlIllll(var26.dE().contains((Locatable)var26.bS) ? 1 : 0)) {
    ...
    protected boolean ct() {
        ...
        TileObject var33 = var30.dq();
        if (aR.llIllllIllIIIl(var33)) {
            return lIlIlIllIlIl[0];
        }
        Player var6 = Players.getLocal();
        if (aR.llIllllIllIIIl(var6)) {
            return lIlIlIllIlIl[0];
        }
        if (aR.llIllllIllIlII(var6.getWorldY(), var33.getWorldY())) {
            bl2 = lIlIlIllIlIl[2];
            0;
    ...
    protected boolean du() {
        ...
        if (aR.llIllllIlIllll(var15.ed.at() ? 1 : 0)) {
            int n2;
            if (aR.llIllllIllIlll(var15.ed.aH(), var15.dU()) && aR.llIllllIllIllI(var15.ed.aH(), lIlIlIllIlIl[3])) {
                boolean bl2;
                if (aR.llIllllIllIIII(var15.ed.aG())) {
                    bl2 = lIlIlIllIlIl[2];
                    0;
            ...
            if (aR.llIllllIllIllI(var15.ed.aG(), lIlIlIllIlIl[3]) && aR.llIllllIllIlIl(var15.ed.aG(), var15.dV())) {
                n2 = lIlIlIllIlIl[2];
                0;
                if (-1 == 1) {
    ...
    public boolean run() {
        ...
        if (aR.llIllllIllIIII(var23.ec.isInInstancedRegion() ? 1 : 0)) {
            return lIlIlIllIlIl[0];
        }
        var23.bS = Players.getLocal();
        if (aR.llIllllIllIIIl(var23.bS)) {
            return lIlIlIllIlIl[0];
        }
        if (!aR.llIllllIllIIlI(u.bg(), lIlIlIllIlIl[1]) || aR.llIllllIlIllll(var23.bS.getPlane())) {
            return lIlIlIllIlIl[0];
        }
        return this.cg();
    }
    ...
    private static String llIllllIIlIlIl(String var18, String var1) {
        var18 = new String(Base64.getDecoder().decode(var18.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var16 = new StringBuilder();
        char[] var22 = var1.toCharArray();
        int var32 = lIlIlIllIlIl[0];
        char[] var10 = var18.toCharArray();
        int var29 = var10.length;
        int var25 = lIlIlIllIlIl[0];
        while (aR.llIllllIllIlll(var25, var29)) {
            char var35 = var10[var25];
            var16.append((char)(var35 ^ var22[var32 % var22.length]));
            0;
            ++var32;
            ++var25;
            0;
    ...
    private static String llIllllIIlIllI(String var17, String var19) {
        try {
            SecretKeySpec var34 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var19.getBytes(StandardCharsets.UTF_8)), lIlIlIllIlIl[14]), "DES");
            Cipher var3 = Cipher.getInstance("DES");
            var3.init(lIlIlIllIlIl[4], var34);
    ...
    private static String llIllllIIlIlII(String var5, String var2) {
        try {
            ...
            var27.init(lIlIlIllIlIl[4], var13);
            return new String(var27.doFinal(Base64.getDecoder().decode(var5.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
