...
extends aR_Unknown {
    ...
    public boolean cg() {
        ...
        if (aS.llIllIlIllllII(var1.ed.at() ? 1 : 0)) {
            return lIlIIlllIIIl[1];
        }
        ArrayList var2 = new ArrayList();
        Iterator var3 = var1.ec.getGraphicsObjects().iterator();
        while (aS.llIllIlIllllII(var3.hasNext() ? 1 : 0)) {
            GraphicsObject var4 = (GraphicsObject)var3.next();
            if (!aS.llIllIlIllllIl(var4.getId(), lIlIIlllIIIl[2]) || aS.llIllIlIlllllI(var4.getId(), lIlIIlllIIIl[3])) {
                WorldPoint var7 = WorldPoint.fromLocal((Client)var1.ec, (LocalPoint)var4.getLocation());
                List var5 = var7.createWorldArea(lIlIIlllIIIl[0]).toWorldPointList();
                var2.addAll(var5);
                0;
            }
            0;
        ...
        if (aS.llIllIlIllllII(var2.isEmpty() ? 1 : 0)) {
            if (aS.llIllIlIllllll(var1.ed.ax())) {
                if (aS.llIllIlIllllII(var1.bS.getWorldLocation().equals((Object)var1.dW()) ? 1 : 0)) {
                    return lIlIIlllIIIl[1];
                }
                Movement.setDestination((WorldPoint)var1.dW());
                return lIlIIlllIIIl[0];
            }
            return lIlIIlllIIIl[1];
        }
        if (aS.llIllIlIlllIll(var2.contains(var1.bS.getWorldLocation()) ? 1 : 0) && aS.llIllIlIlllIll(var1.ed.ap().contains(var1.bS.getWorldLocation()) ? 1 : 0)) {
            return lIlIIlllIIIl[1];
        }
