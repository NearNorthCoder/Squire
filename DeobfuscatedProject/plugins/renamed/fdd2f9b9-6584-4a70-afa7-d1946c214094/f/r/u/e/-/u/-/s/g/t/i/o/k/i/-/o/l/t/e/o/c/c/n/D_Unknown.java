...
implements G {
    ...
    private static String lIIIIIIIlIIIl(String var13, String var12) {
        var13 = new String(Base64.getDecoder().decode(var13.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var20 = new StringBuilder();
        char[] var1 = var12.toCharArray();
        int var5 = lIIllIIIlI[0];
        char[] var23 = var13.toCharArray();
        int var6 = var23.length;
        int var16 = lIIllIIIlI[0];
        while (D.lIIIIIIlIIlll(var16, var6)) {
            char var18 = var23[var16];
            var20.append((char)(var18 ^ var1[var5 % var1.length]));
            0;
            ++var5;
            ++var16;
            0;
    ...
    private static String lIIIIIIIlIIlI(String var15, String var2) {
        try {
    ...
    private static String lIIIIIIIlIIll(String var9, String var24) {
        try {
            SecretKeySpec var19 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var24.getBytes(StandardCharsets.UTF_8)), lIIllIIIlI[16]), "DES");
            Cipher var11 = Cipher.getInstance("DES");
            var11.init(lIIllIIIlI[3], var19);
    ...
    private static void bL() {
        ...
        if (D.lIIIIIIlIlIIl(var8) && D.lIIIIIIlIIllI(var8.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static void af() {
            ...
            block36: {
                block35: {
                    block34: {
                        ...
                        block33: {
                            block32: {
                                ...
                                if (D.lIIIIIIlIlIII(Bank.contains((int[])nArray2) ? 1 : 0)) {
                                    ...
                                    var22 = new d(lIIllIIIlI[22], lIIllIIIlI[1], lIIllIIIlI[39]);
                                    bv.add((d)var22);
                                    0;
                                }
                                int[] nArray3 = new int[lIIllIIIlI[1]];
                                ...
                                if (D.lIIIIIIlIlIII(Bank.contains((int[])nArray3) ? 1 : 0)) {
                                    ...
                                    var22 = new d(lIIllIIIlI[23], lIIllIIIlI[1], lIIllIIIlI[39]);
                                    bv.add((d)var22);
                                    0;
                                }
                                int[] nArray4 = new int[lIIllIIIlI[1]];
                                ...
                                if (D.lIIIIIIlIlIII(Bank.contains((int[])nArray4) ? 1 : 0)) {
                                    ...
                                    var22 = new d(lIIllIIIlI[24], lIIllIIIlI[1], lIIllIIIlI[39]);
                                    bv.add((d)var22);
                                    0;
                                }
                                int[] nArray5 = new int[lIIllIIIlI[1]];
                                ...
                                if (D.lIIIIIIlIlIII(Bank.contains((int[])nArray5) ? 1 : 0)) {
                                    ...
                                    var22 = new d(lIIllIIIlI[25], lIIllIIIlI[42], lIIllIIIlI[43]);
                                    bv.add((d)var22);
                                    0;
                                }
                                int[] nArray6 = new int[lIIllIIIlI[1]];
                                ...
                                if (D.lIIIIIIlIIllI(Bank.contains((int[])nArray6) ? 1 : 0)) {
                                    ...
                                    if (D.lIIIIIIlIIlll(Bank.getFirst((int[])nArray7).getQuantity(), lIIllIIIlI[30])) {
                                        ...
                                        var22 = new d(lIIllIIIlI[25], lIIllIIIlI[45], lIIllIIIlI[43]);
                                        bv.add((d)var22);
                                        0;
                                    }
                                }
                                ...
                                if (D.lIIIIIIlIlIII(Bank.contains((int[])nArray8) ? 1 : 0)) {
                                    ...
                                    var22 = new d(lIIllIIIlI[17], lIIllIIIlI[9], lIIllIIIlI[47]);
                                    bv.add((d)var22);
                                    0;
                                }
                                int[] nArray9 = new int[lIIllIIIlI[1]];
                        ...
                        if (D.lIIIIIIlIlIII(Bank.contains((Predicate)(var22 = item -> item.getName().toLowerCase().contains(lIIlIlllll[lIIllIIIlI[85]]))) ? 1 : 0)) {
                            System.out.println(lIIlIlllll[lIIllIIIlI[49]]);
                            var3 = new d(lIIllIIIlI[50], lIIllIIIlI[38], lIIllIIIlI[51]);
                            bv.add(var3);
                            0;
                        }
                        int[] nArray = new int[lIIllIIIlI[1]];
                    ...
                    var3 = new d(lIIllIIIlI[20], lIIllIIIlI[45], lIIllIIIlI[53]);
                    bv.add(var3);
                    0;
                }
                int[] nArray = new int[lIIllIIIlI[1]];
                ...
                if (D.lIIIIIIlIlIII(Bank.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    var3 = new d(lIIllIIIlI[7], lIIllIIIlI[30], lIIllIIIlI[53]);
                    bv.add(var3);
                    0;
                }
                int[] nArray14 = new int[lIIllIIIlI[1]];
        ...
        if (D.lIIIIIIlIlIII(Bank.contains((int[])nArray) ? 1 : 0)) {
            ...
            var3 = new d(lIIllIIIlI[27], lIIllIIIlI[9], i.bq);
            bv.add(var3);
            0;
        }
        int[] nArray17 = new int[lIIllIIIlI[1]];
        ...
        if (D.lIIIIIIlIIllI(Bank.contains((int[])nArray17) ? 1 : 0)) {
            ...
            if (D.lIIIIIIlIIlll(Bank.getFirst((int[])nArray18).getQuantity(), lIIllIIIlI[11])) {
                ...
                var3 = new d(lIIllIIIlI[10], lIIllIIIlI[58], lIIllIIIlI[14]);
                bv.add(var3);
                0;
            }
        }
        ...
        if (D.lIIIIIIlIIllI(Bank.contains((int[])nArray19) ? 1 : 0)) {
            ...
            if (D.lIIIIIIlIIlll(Bank.getFirst((int[])nArray20).getQuantity(), lIIllIIIlI[11])) {
                ...
                var3 = new d(lIIllIIIlI[59], lIIllIIIlI[58], lIIllIIIlI[14]);
                bv.add(var3);
                0;
            }
        }
        ...
        if (D.lIIIIIIlIIllI(Bank.contains((int[])nArray21) ? 1 : 0)) {
            ...
            if (D.lIIIIIIlIIlll(Bank.getFirst((int[])nArray22).getQuantity(), lIIllIIIlI[11])) {
                ...
                var3 = new d(lIIllIIIlI[15], lIIllIIIlI[58], lIIllIIIlI[14]);
                bv.add(var3);
                0;
            }
        }
        ...
        if (D.lIIIIIIlIIllI(Bank.contains((int[])nArray23) ? 1 : 0)) {
            ...
            if (D.lIIIIIIlIIlll(Bank.getFirst((int[])nArray24).getQuantity(), lIIllIIIlI[11])) {
                ...
                var3 = new d(lIIllIIIlI[13], lIIllIIIlI[58], lIIllIIIlI[14]);
                bv.add(var3);
                0;
            }
        }
        ...
        if (D.lIIIIIIlIlIII(bt ? 1 : 0)) {
            if (D.lIIIIIIlIlIII(e.j(lIIllIIIlI[2]))) {
                ...
                if (D.lIIIIIIlIlIII(D.bo() ? 1 : 0)) {
                    ...
                    if (D.lIIIIIIlIlIIl(var17) && D.lIIIIIIlIlIII(var17.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderRogues.c = lIIlIlllll[lIIllIIIlI[3]];
                        a.a(var17);
                    }
                    if (D.lIIIIIIlIlIIl(var17) && D.lIIIIIIlIIllI(var17.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        if (D.lIIIIIIlIlIII(Bank.isOpen() ? 1 : 0)) {
                ...
                if (D.lIIIIIIlIlIll(Players.getLocal().getWorldLocation().distanceTo(hY), lIIllIIIlI[6]) && D.lIIIIIIlIllII(Players.getLocal().getWorldLocation().getPlane(), lIIllIIIlI[3]) && D.lIIIIIIlIIllI(D.bo() ? 1 : 0)) {
                    ...
                    if (D.lIIIIIIlIlIII(Bank.isOpen() ? 1 : 0)) {
                        ...
                        if (D.lIIIIIIlIIllI((var17 = new WorldArea(lIIllIIIlI[28], lIIllIIIlI[29], lIIllIIIlI[30], lIIllIIIlI[31], lIIllIIIlI[3])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            String[] stringArray = new String[lIIllIIIlI[1]];
