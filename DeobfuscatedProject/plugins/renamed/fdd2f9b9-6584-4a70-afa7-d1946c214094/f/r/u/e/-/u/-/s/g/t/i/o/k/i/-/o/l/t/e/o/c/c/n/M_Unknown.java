...
import f.r.u.e.-.u.-.s.g.t.i.o.k.i.-.o.l.t.e.o.c.c.n.v_Unknown;
...
implements G {
    ...
    public static void Y() {
        ...
        if (M.lIIIIlllIIllI(bt ? 1 : 0)) {
            ...
            if (M.lIIIIlllIIllI(M.ab() ? 1 : 0)) {
                ...
                if (M.lIIIIlllIIlll(var13) && M.lIIIIlllIIllI(var13.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderRogues.c = lIIllllllI[lIIlllllll[2]];
                    a.a(var13);
                }
                if (M.lIIIIlllIIlll(var13) && M.lIIIIlllIIlII(var13.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (M.lIIIIlllIIlII(M.ab() ? 1 : 0)) {
                ...
                if (M.lIIIIlllIlIIl(Skills.getLevel((Skill)Skill.MAGIC), lIIlllllll[7])) {
                    ...
                    if (M.lIIIIlllIIllI(bu ? 1 : 0) && M.lIIIIlllIIlll(by)) {
                        ...
                        if (M.lIIIIlllIIlII(Players.getLocal().getWorldLocation().equals((Object)by) ? 1 : 0) && M.lIIIIlllIIlll(var13) && M.lIIIIlllIIlll(var6)) {
                            var14 = Skills.getExperience((Skill)Skill.MAGIC);
                            Magic.cast((Spell)SpellBook.Standard.HIGH_LEVEL_ALCHEMY, (Item)var6);
                            Time.sleepUntil(() -> {
                                boolean bl;
                                if (M.lIIIIlllIllll(Skills.getExperience((Skill)Skill.MAGIC), var14)) {
                                    bl = lIIlllllll[1];
                                    0;
                                    if (3 < 3) {
                                        return (3 & (3 ^ -1)) != 0;
                    ...
                    if (M.lIIIIlllIIlII(bu ? 1 : 0)) {
                        if (M.lIIIIlllIIlll(var13) && M.lIIIIlllIIlll(var6) && M.lIIIIlllIlIlI(Players.getLocal().getAnimation(), lIIlllllll[27])) {
                            var14 = Skills.getExperience((Skill)Skill.MAGIC);
                            Magic.cast((Spell)SpellBook.Standard.HIGH_LEVEL_ALCHEMY, (Item)var6);
                            Time.sleepUntil(() -> {
                                boolean bl;
    ...
    private static void aa() {
        ...
        if (M.lIIIIlllIlIll(Players.getLocal().getInteracting())) {
            ...
            if (M.lIIIIlllIIlll(var4) && M.lIIIIlllIIllI(Players.getLocal().isMoving() ? 1 : 0)) {
                var4.interact(lIIllllllI[lIIlllllll[48]]);
                Time.sleepTicks((int)lIIlllllll[3]);
                0;
            }
        }
    ...
    private static String lIIIIlllIIIIl(String var7, String var20) {
        try {
            SecretKeySpec var1 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var20.getBytes(StandardCharsets.UTF_8)), lIIlllllll[29]), "DES");
            Cipher var8 = Cipher.getInstance("DES");
            var8.init(lIIlllllll[2], var1);
    ...
    private static void af() {
        ...
        if (M.lIIIIlllIIlIl(Skills.getLevel((Skill)Skill.MAGIC), lIIlllllll[7])) {
            ...
            if (M.lIIIIlllIIllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                var18 = new d(lIIlllllll[8], lIIlllllll[60], lIIlllllll[5]);
                bv.add((d)var18);
                0;
            }
            int[] nArray3 = new int[lIIlllllll[1]];
            ...
            if (M.lIIIIlllIIllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
                var18 = new d(lIIlllllll[10], lIIlllllll[61], lIIlllllll[5]);
                bv.add((d)var18);
                0;
            }
            int[] nArray4 = new int[lIIlllllll[1]];
            ...
            if (M.lIIIIlllIIllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
                var18 = new d(lIIlllllll[12], lIIlllllll[62], lIIlllllll[5]);
                bv.add((d)var18);
                0;
            }
            int[] nArray5 = new int[lIIlllllll[1]];
            ...
            if (M.lIIIIlllIIllI(Bank.contains((int[])nArray5) ? 1 : 0)) {
                var18 = new d(lIIlllllll[13], lIIlllllll[4], lIIlllllll[5]);
                bv.add((d)var18);
                0;
            }
            int[] nArray6 = new int[lIIlllllll[1]];
            ...
            if (M.lIIIIlllIIllI(Bank.contains((int[])nArray6) ? 1 : 0)) {
                var18 = new d(lIIlllllll[47], lIIlllllll[1], e.c(lIIlllllll[63], lIIlllllll[64]));
                bv.add((d)var18);
                0;
            }
        }
        if (M.lIIIIlllIlIIl(Skills.getLevel((Skill)Skill.MAGIC), lIIlllllll[7])) {
            ...
            if (M.lIIIIlllIIlII(Bank.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (M.lIIIIlllIIlIl(Bank.getFirst((int[])nArray7).getQuantity(), lIIlllllll[62])) {
                    ...
                    var18 = new d(lIIlllllll[23], lIIlllllll[62] - Bank.getFirst((int[])nArray8).getQuantity(), lIIlllllll[65]);
                    bv.add((d)var18);
                    0;
                }
            }
            ...
            if (M.lIIIIlllIIllI(Bank.contains((int[])nArray9) ? 1 : 0)) {
                var18 = new d(lIIlllllll[23], lIIlllllll[62], lIIlllllll[65]);
                bv.add((d)var18);
                0;
            }
            int[] nArray10 = new int[lIIlllllll[1]];
            ...
            if (M.lIIIIlllIIlII(Bank.contains((int[])nArray10) ? 1 : 0)) {
                ...
                if (M.lIIIIlllIIlIl(Bank.getFirst((int[])nArray11).getQuantity(), lIIlllllll[62])) {
                    ...
                    var18 = new d(lIIlllllll[24], lIIlllllll[62] - Bank.getFirst((int[])nArray12).getQuantity(), lIIlllllll[66]);
                    bv.add((d)var18);
                    0;
                }
            }
            ...
            if (M.lIIIIlllIIllI(Bank.contains((int[])nArray13) ? 1 : 0)) {
                var18 = new d(lIIlllllll[24], lIIlllllll[62], lIIlllllll[66]);
                bv.add((d)var18);
                0;
            }
            int[] nArray14 = new int[lIIlllllll[1]];
            ...
            if (M.lIIIIlllIIllI(Bank.contains((int[])nArray14) ? 1 : 0)) {
                ...
                nArray15[M.lIIlllllll[0]] = lIIlllllll[21];
                if (M.lIIIIlllIIllI(Equipment.contains((int[])nArray15) ? 1 : 0)) {
                    var18 = new d(lIIlllllll[21], lIIlllllll[1], lIIlllllll[67]);
                    bv.add((d)var18);
                    0;
                }
            }
            if (M.lIIIIlllIIlII(bu ? 1 : 0)) {
                ...
                if (M.lIIIIlllIIlII(Bank.contains((int[])nArray16) ? 1 : 0)) {
                    ...
                    if (M.lIIIIlllIIlIl(Bank.getFirst((int[])nArray17).getQuantity(), lIIlllllll[62])) {
                        ...
                        var18 = new d(lIIlllllll[15], lIIlllllll[62] - Bank.getFirst((int[])nArray18).getQuantity(), lIIlllllll[59]);
                        bv.add((d)var18);
                        0;
                    }
                }
                ...
                if (M.lIIIIlllIIllI(Bank.contains((int[])nArray19) ? 1 : 0)) {
                    var18 = new d(lIIlllllll[15], lIIlllllll[62], lIIlllllll[59]);
                    bv.add((d)var18);
                    0;
                }
                ...
                if (M.lIIIIlllIIlII(Bank.contains((int[])nArray20) ? 1 : 0)) {
                    ...
                    if (M.lIIIIlllIIlIl(Bank.getFirst((int[])nArray21).getQuantity(), lIIlllllll[67])) {
                        ...
                        var18 = new d(lIIlllllll[22], lIIlllllll[67] - Bank.getFirst((int[])nArray22).getQuantity(), lIIlllllll[5]);
                        bv.add((d)var18);
                        0;
                    }
                }
                ...
                if (M.lIIIIlllIIllI(Bank.contains((int[])nArray23) ? 1 : 0)) {
                    var18 = new d(lIIlllllll[22], lIIlllllll[67], lIIlllllll[5]);
                    bv.add((d)var18);
                    0;
                }
            }
        ...
        nArray[M.lIIlllllll[0]] = lIIlllllll[19];
        if (M.lIIIIlllIIllI(Bank.contains((int[])nArray) ? 1 : 0)) {
            var18 = new d(lIIlllllll[19], lIIlllllll[68], lIIlllllll[39]);
            bv.add((d)var18);
            0;
        }
        if (M.lIIIIlllIIllI(Bank.contains(var18 = item -> item.getName().toLowerCase().contains(lIIllllllI[lIIlllllll[75]])) ? 1 : 0)) {
            var9 = new d(lIIlllllll[69], lIIlllllll[18], lIIlllllll[70]);
            bv.add(var9);
            0;
        }
        ...
        if (M.lIIIIlllIIllI(Bank.contains((int[])nArray24) ? 1 : 0)) {
            var9 = new d(lIIlllllll[71], lIIlllllll[32], lIIlllllll[72]);
            bv.add(var9);
            0;
        }
        ...
        if (M.lIIIIlllIIllI(Bank.contains((int[])nArray25) ? 1 : 0)) {
            var9 = new d(lIIlllllll[17], lIIlllllll[32], lIIlllllll[72]);
            bv.add(var9);
            0;
        }
    }
    ...
    private static String lIIIIlllIIIII(String var21, String var5) {
        ...
        int var3 = lIIlllllll[0];
        char[] var23 = var21.toCharArray();
        int var11 = var23.length;
        int var10 = lIIlllllll[0];
        while (M.lIIIIlllIIlIl(var10, var11)) {
            char var2 = var23[var10];
            var24.append((char)(var2 ^ var15[var3 % var15.length]));
            0;
            ++var3;
            ++var10;
            0;
    ...
    private static String lIIIIllIlllll(String var12, String var25) {
        try {
            SecretKeySpec var22 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var25.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var19 = Cipher.getInstance("Blowfish");
            var19.init(lIIlllllll[2], var22);
