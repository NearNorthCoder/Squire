...
extends Task {
    ...
    private static String llIIIllIIllIIlI(String var12, String var4) {
        try {
            ...
            var13.init(lIllIIllIIIII[4], var14);
    ...
    private void M() {
        if (n.llIIIllIIllIlll(this.K.altarTeleport() ? 1 : 0)) {
            ...
            var6.interact(lIllIIlIlllll[lIllIIllIIIII[0]]);
            0;
            ...
            if (n.llIIIllIIlllIIl(var6)) {
                return;
            }
            var6.interact(lIllIIlIlllll[lIllIIllIIIII[4]]);
        }
    }
    ...
    private static String llIIIllIIllIIll(String var7, String var11) {
        var7 = new String(Base64.getDecoder().decode(var7.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var8 = new StringBuilder();
        char[] var10 = var11.toCharArray();
        int var15 = lIllIIllIIIII[1];
        char[] var1 = var7.toCharArray();
        int var16 = var1.length;
        int var3 = lIllIIllIIIII[1];
        while (n.llIIIllIIlllIII(var3, var16)) {
            char var9 = var1[var3];
            var8.append((char)(var9 ^ var10[var15 % var10.length]));
            0;
            ++var15;
            ++var3;
            0;
    ...
    public boolean run() {
        ...
        if (n.llIIIllIIllIllI(Inventory.contains(item -> item.getName().startsWith(lIllIIlIlllll[lIllIIllIIIII[7]])) ? 1 : 0)) {
            ...
            n2 = var2 = lIllIIllIIIII[1];
        }
        if (n.llIIIllIIllIllI(Inventory.contains(item -> item.hasAction(lIllIIlIlllll[lIllIIllIIIII[6]]::equals)) ? 1 : 0)) {
            if (n.llIIIllIIllIlll(var17.J.A() ? 1 : 0) && n.llIIIllIIlllIII(Combat.getCurrentHealth(), lIllIIllIIIII[2])) {
                var2 = lIllIIllIIIII[0];
                0;
                if ((0x14 ^ 0x10) == 1) {
                    return false;
                }
            } else if (n.llIIIllIIllIllI(var17.J.A() ? 1 : 0) && n.llIIIllIIlllIII(Combat.getCurrentHealth(), lIllIIllIIIII[3])) {
                var2 = lIllIIllIIIII[0];
            }
        }
        if (n.llIIIllIIllIlll(var2)) {
            if (n.llIIIllIIllIllI(var17.J.B() ? 1 : 0)) {
                var17.L.forceStop();
                0;
