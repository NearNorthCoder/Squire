...
extends Enum<e> {
    ...
    private static String llIIIlIlIIllIII(String var15, String var13) {
        try {
            SecretKeySpec var3 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var13.getBytes(StandardCharsets.UTF_8)), lIllIIIllIllI[13]), "DES");
            Cipher var2 = Cipher.getInstance("DES");
            var2.init(lIllIIIllIllI[8], var3);
    ...
    public static e a(Projectile projectile) {
        ...
        int var10 = lIllIIIllIllI[0];
        while (e.llIIIlIlIIlllIl(var10, (int)var9)) {
            Projectile var14;
            void var1;
            void var4 = var1[var10];
            if (e.llIIIlIlIIllllI(var4.p(), var14.getId())) {
                return var4;
            }
            ++var10;
            0;
    ...
    public static e a(NPC nPC) {
        ...
        e[] eArray = e.values();
        int n2 = eArray.length;
        int var8 = lIllIIIllIllI[0];
        while (e.llIIIlIlIIlllIl(var8, (int)var6)) {
            NPC var11;
            void var12;
            void var7 = var12[var8];
            if (e.llIIIlIlIIllllI(var7.n(), var11.getId())) {
                return var7;
            }
            ++var8;
            0;
