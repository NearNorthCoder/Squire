...
extends Task {
    ...
    public boolean run() {
        ...
        if (E.llIIIlIllIIlllI(var7.getInteracting())) {
            return lIllIIlIIIIIl[0];
        }
    ...
    private int R() {
        ...
        if (E.llIIIlIllIlIIIl(var15.aK.getVarbitValue(lIllIIlIIIIIl[7]), lIllIIlIIIIIl[4])) {
            return lIllIIlIIIIIl[8];
        }
        if (E.llIIIlIllIlIIIl(var15.aK.getVarbitValue(lIllIIlIIIIIl[9]), lIllIIlIIIIIl[4])) {
            return lIllIIlIIIIIl[10];
        }
        if (E.llIIIlIllIlIIIl(var15.aK.getVarbitValue(lIllIIlIIIIIl[11]), lIllIIlIIIIIl[4])) {
    ...
    private static String llIIIlIllIIlIIl(String var18, String var16) {
        try {
            SecretKeySpec var11 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var16.getBytes(StandardCharsets.UTF_8)), lIllIIlIIIIIl[17]), "DES");
            Cipher var12 = Cipher.getInstance("DES");
            var12.init(lIllIIlIIIIIl[4], var11);
    ...
    private static String llIIIlIllIIlIII(String var4, String var17) {
        var4 = new String(Base64.getDecoder().decode(var4.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var2 = new StringBuilder();
        char[] var13 = var17.toCharArray();
        int var3 = lIllIIlIIIIIl[0];
        char[] var9 = var4.toCharArray();
        int var5 = var9.length;
        int var10 = lIllIIlIIIIIl[0];
        while (E.llIIIlIllIlIIll(var10, var5)) {
            char var14 = var9[var10];
            var2.append((char)(var14 ^ var13[var3 % var13.length]));
            0;
            ++var3;
            ++var10;
            0;
