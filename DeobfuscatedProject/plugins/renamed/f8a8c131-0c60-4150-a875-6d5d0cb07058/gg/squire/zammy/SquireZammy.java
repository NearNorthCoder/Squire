...
import m.e.a.i.z.m.r.-.q.s.y.u.KillingMinionsTask;
import m.e.a.i.z.m.r.-.q.s.y.u.PlacingCannonBaseTask;
import m.e.a.i.z.m.r.-.q.s.y.u.DrinkingRangePotionTask;
import m.e.a.i.z.m.r.-.q.s.y.u.MovingToStartingTileTask;
import m.e.a.i.z.m.r.-.q.s.y.u.GettingKillcountTask;
import m.e.a.i.z.m.r.-.q.s.y.u.k_Unknown;
import m.e.a.i.z.m.r.-.q.s.y.u.l_Unknown;
import m.e.a.i.z.m.r.-.q.s.y.u.TeleportingOutTask;
import m.e.a.i.z.m.r.-.q.s.y.u.AttackingZamorakTask;
import m.e.a.i.z.m.r.-.q.s.y.u.DrinkingPoisonCureTask;
import m.e.a.i.z.m.r.-.q.s.y.u.DrinkingStaminaDoseTask;
import m.e.a.i.z.m.r.-.q.s.y.u.EatingFoodTask;
import m.e.a.i.z.m.r.-.q.s.y.u.FlickingPrayersTask;
import m.e.a.i.z.m.r.-.q.s.y.u.RecoveringFromGettingStuckOnATileTask;
import m.e.a.i.z.m.r.-.q.s.y.u.MovingToNextTileTask;
import m.e.a.i.z.m.r.-.q.s.y.u.LootingItemsTask;
import m.e.a.i.z.m.r.-.q.s.y.u.BloodBarraginRestTask;
import m.e.a.i.z.m.r.-.q.s.y.u.EquippingMageGearTask;
import m.e.a.i.z.m.r.-.q.s.y.u.EquippingRangedGearTask;
import m.e.a.i.z.m.r.-.q.s.y.u.KillingLastMinionWithRangedTask;
...
extends SquirePlugin {
    ...
    private static String llIIIlIlIIIlIII(String var4, String var14) {
        try {
            ...
            var3.init(lIllIIIllIIII[3], var6);
    ...
    private static String llIIIlIlIIIIlll(String var1, String var10) {
        ...
        int var13 = lIllIIIllIIII[1];
        char[] var2 = var1.toCharArray();
        int var5 = var2.length;
        int var12 = lIllIIIllIIII[1];
        while (SquireZammy.llIIIlIlIIlIIlI(var12, var5)) {
            char var8 = var2[var12];
            var11.append((char)(var8 ^ var7[var13 % var7.length]));
            0;
            ++var13;
            ++var12;
            0;
    ...
    private static void llIIIlIlIIIlIIl() {
        ...
        SquireZammy.lIllIIIlIlllI[SquireZammy.lIllIIIllIIII[1]] = SquireZammy."squirezammy";
        SquireZammy.lIllIIIlIlllI[SquireZammy.lIllIIIllIIII[2]] = SquireZammy.".copy";
        SquireZammy.lIllIIIlIlllI[SquireZammy.lIllIIIllIIII[3]] = SquireZammy."";
    }
    ...
    private static void llIIIlIlIIlIIII() {
        ...
        SquireZammy.lIllIIIllIIII[2] = 1;
        SquireZammy.lIllIIIllIIII[3] = 2;
        SquireZammy.lIllIIIllIIII[4] = 3;
