...
extends ao_Unknown {
    ...
    public boolean bn() {
        ...
        if (bM.lIlIIIIlIlIlll(var3.hasAction(stringArray) ? 1 : 0)) {
            return llIIlIlIlll[2];
        }
    ...
    private static String lIlIIIIIlllIII(String var13, String var11) {
        try {
    ...
    private static String lIlIIIIlIIlllI(String var2, String var14) {
        ...
        int var9 = llIIlIlIlll[2];
        char[] var10 = var2.toCharArray();
        int var5 = var10.length;
        int var7 = llIIlIlIlll[2];
        while (bM.lIlIIIIlIllIIl(var7, var5)) {
            char var15 = var10[var7];
            var6.append((char)(var15 ^ var8[var9 % var8.length]));
            0;
            ++var9;
            ++var7;
            0;
