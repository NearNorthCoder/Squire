...
import q.-.t.a.o.u.i.-.o.u.t.e.s.a.r.BSEnum;
import q.-.t.a.o.u.i.-.o.u.t.e.s.a.r.p_Unknown;
import q.-.t.a.o.u.i.-.o.u.t.e.s.a.r.z_Unknown;

/* TASK: Doing pressure plates puzzle -> DoingpressureplatespuzzleTask */
...
extends bm_Unknown {
    ...
    private static String lIlIIlIlIIIIII(String var12, String var9) {
        var12 = new String(Base64.getDecoder().decode(var12.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var2 = new StringBuilder();
        char[] var18 = var9.toCharArray();
        int var6 = llIlIIIllII[0];
        char[] var35 = var12.toCharArray();
        int var3 = var35.length;
        int var34 = llIlIIIllII[0];
        while (br.lIlIIlIlIIlIlI(var34, var3)) {
            char var14 = var35[var34];
            var2.append((char)(var14 ^ var18[var6 % var18.length]));
            0;
            ++var6;
            ++var34;
            0;
    ...
    public void a(ChatMessage chatMessage) {
        ...
        Matcher var5 = fA.matcher(Text.removeTags((String)var17.getMessage()));
        if (br.lIlIIlIlIIIllI(var5.matches() ? 1 : 0)) {
            return;
        }
    ...
    private Set<Integer> b(Tile[][] tileArray, Point point) {
        ...
        int var21 = llIlIIIllII[0];
        while (br.lIlIIlIlIIlIlI(var21, llIlIIIllII[3])) {
            int var36 = llIlIIIllII[0];
            while (br.lIlIIlIlIIlIlI(var36, llIlIIIllII[3])) {
                void var4;
                void var15;
                void var31 = var15[var4.getX() + var36][var4.getY() - var21];
                IntStream intStream = Arrays.stream(var31.getGameObjects()).filter(Objects::nonNull).mapToInt(TileObject::getId);
                Set<Integer> set = fw;
                ...
                if (br.lIlIIlIlIIlIII(n2)) {
                    void var19;
                    var19.add(var21 * llIlIIIllII[3] + var36);
                    0;
                }
                ++var36;
                0;
    ...
    private Point a(Tile[][] tileArray) {
        ...
        int var7 = llIlIIIllII[0];
        while (br.lIlIIlIlIIlIlI(var7, (int)var26)) {
            void var11;
            void var27;
            void var24 = var27[var7];
            void var1 = var11[var24.getX()][var24.getY()];
            GroundObject var25 = var1.getGroundObject();
            if (br.lIlIIlIlIIlIll(var25) && br.lIlIIlIlIIllII(var25.getId(), bs.FOOT.ch())) {
                return var24;
            }
            ++var7;
            0;
    ...
    private static String lIlIIlIlIIIIIl(String var22, String var13) {
        try {
            SecretKeySpec var23 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var13.getBytes(StandardCharsets.UTF_8)), llIlIIIllII[22]), "DES");
            Cipher var32 = Cipher.getInstance("DES");
            var32.init(llIlIIIllII[4], var23);
            return new String(var32.doFinal(Base64.getDecoder().decode(var22.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public boolean bY() {
        ...
        if (br.lIlIIlIlIIlIII(var29.fo.isEmpty() ? 1 : 0)) {
            String[] stringArray = new String[llIlIIIllII[2]];
            stringArray[br.llIlIIIllII[0]] = llIlIIIlIll[llIlIIIllII[0]];
            TileObject var33 = TileObjects.getNearest((String[])stringArray);
            if (br.lIlIIlIlIIIlII(var33)) {
                return llIlIIIllII[0];
            }
            var33.interact(llIlIIIlIll[llIlIIIllII[2]]);
            return llIlIIIllII[2];
        }
        WorldPoint var33 = var29.cu.getLocalPlayer().getWorldLocation();
        WorldPoint var20 = var29.fo.stream().filter(worldPoint -> TileObjects.getAll(tileObject -> fw.contains(tileObject.getId())).stream().noneMatch(tileObject -> tileObject.getWorldLocation().equals(worldPoint))).min(Comparator.comparingInt(WorldPoint::getX).thenComparingDouble(worldPoint -> worldPoint.distanceTo2DHypotenuse(Players.getLocal().getWorldLocation()))).orElse(null);
        if (br.lIlIIlIlIIIlII(var20)) {
            return llIlIIIllII[0];
        }
        long var10 = var20.pathTo(var29.cu, var20).stream().filter(worldPoint -> TileObjects.getAll(tileObject -> fx.contains(tileObject.getId())).stream().anyMatch(tileObject -> tileObject.getWorldLocation().equals(worldPoint))).count();
        if (br.lIlIIlIlIIlIIl(br.lIlIIlIlIIIlIl(var10, 1L))) {
            return llIlIIIllII[0];
        }
    ...
    private void ca() {
        ...
        var8.fm = llIlIIIllII[2];
        Tile[][] var28 = var8.cu.getScene().getTiles()[var8.cu.getPlane()];
        Point var30 = var8.a(var28);
        if (br.lIlIIlIlIIIlII(var30)) {
            return;
        }
