...
import q.-.t.a.o.u.i.-.o.u.t.e.s.a.r.A_Unknown;
...
extends Task {
    ...
    public void a(WorldPoint worldPoint, Predicate<WorldPoint> predicate) {
        ...
        if (Z.lIlIIllIlIllII(var34.test(var38) ? 1 : 0)) {
            Movement.setDestination((WorldPoint)var20);
            return;
        }
        List<WorldPoint> var39 = var47.a(var38, (WorldPoint)var20, (Predicate<WorldPoint>)var34);
        if (Z.lIlIIllIllIIII(var39.size(), llIlIlIIlIl[1])) {
            Movement.setDestination((WorldPoint)var20);
            return;
        }
    ...
    public boolean bc() {
        ...
        if (Z.lIlIIllIlIllII(var4.bb() ? 1 : 0) && Z.lIlIIllIlIllII(var4.j(llIlIlIIlIl[18]) ? 1 : 0) && Z.lIlIIllIlIllII(var4.j(llIlIlIIlIl[19]) ? 1 : 0) && Z.lIlIIllIlIllII(var4.j(llIlIlIIlIl[20]) ? 1 : 0)) {
            n2 = llIlIlIIlIl[1];
            0;
            if (1 != 1) {
    ...
    private List<WorldPoint> a(WorldPoint worldPoint, WorldPoint worldPoint3, Predicate<WorldPoint> predicate) {
        ...
        0;
        while (Z.lIlIIllIlIllII(var44.isEmpty() ? 1 : 0)) {
            void var43;
            if (Z.lIlIIllIllIIIl(var44.size(), llIlIlIIlIl[14])) {
                0;
                if (((0x62 ^ 0x73 ^ (0x1C ^ 0x23)) & (0x49 ^ 0x27 ^ (0xF3 ^ 0xB3) ^ -1)) < 2) break;
                return null;
            }
            var16 = (WorldPoint)var44.poll();
            var43.add(var16);
            0;
            if (Z.lIlIIllIlIlIll(var28.equals((Object)var16) ? 1 : 0)) {
                0;
                if (1 == 1) break;
                return null;
            }
            var24 = var16.createWorldArea(llIlIlIIlIl[8]).toWorldPointList();
            Iterator var13 = var24.iterator();
            while (Z.lIlIIllIlIlIll(var13.hasNext() ? 1 : 0)) {
                void var50;
                void var25;
                Z var22;
                WorldPoint var32 = (WorldPoint)var13.next();
                if (!Z.lIlIIllIlIllII(var43.contains(var32) ? 1 : 0) || !Z.lIlIIllIlIlIll(var32.isInScene(var22.cu) ? 1 : 0) || !Z.lIlIIllIlIlIll(var25.test(var32) ? 1 : 0)) continue;
                if (Z.lIlIIllIlIlIll(Reachable.isObstacle((WorldPoint)var32) ? 1 : 0)) {
                    0;
                    if (1 != 0) continue;
                    return null;
                }
                int var36 = (Integer)var50.get(var16) + llIlIlIIlIl[1];
                if (Z.lIlIIllIlIlIll(var50.containsKey(var32) ? 1 : 0) && Z.lIlIIllIlIIlll((Integer)var50.get(var32), var36)) {
                    0;
                    if (-(0xD1 ^ 0x82 ^ (0x95 ^ 0xC3)) < 0) continue;
                    return null;
                }
                if (Z.lIlIIllIlIllII(var32.isInScene(var22.cu) ? 1 : 0)) {
                    0;
                    
                    return null;
                }
                if (!Z.lIlIIllIlIllII(var32.equals((Object)var16) ? 1 : 0) || !Z.lIlIIllIlIlIll(var25.test(var32) ? 1 : 0)) continue;
                if (Z.lIlIIllIlIllII(Reachable.isWalkable((WorldPoint)var32) ? 1 : 0)) {
                    0;
                    if ((0x1D ^ 0x19) > 3) continue;
                    return null;
                }
                var50.put(var32, var36);
                0;
                var37.put(var32, var16);
                0;
                var44.add(var32);
                0;
                0;
        ...
        if (Z.lIlIIllIlIllII(var37.containsKey(var28) ? 1 : 0)) {
            return Collections.emptyList();
        }
        var16 = new LinkedList();
        var24 = var28;
        while (Z.lIlIIllIlIllII(var24.equals(var42) ? 1 : 0)) {
            var16.add(var24);
            0;
            if (Z.lIlIIllIlIllII(var37.containsKey(var24) ? 1 : 0)) {
                0;
                if (-1 < 0) break;
                return null;
            }
            var24 = (WorldPoint)var37.get(var24);
            0;
    ...
    public int bg() {
        ...
        String var46 = var21.getName().toLowerCase();
        if (Z.lIlIIllIlIlIll(var46.contains(llIlIlIIlII[llIlIlIIlIl[27]]) ? 1 : 0)) {
            return llIlIlIIlIl[5];
        }
        if (!Z.lIlIIllIlIllII(var46.contains(llIlIlIIlII[llIlIlIIlIl[23]]) ? 1 : 0) || !Z.lIlIIllIlIllII(var46.contains(llIlIlIIlII[llIlIlIIlIl[5]]) ? 1 : 0) || !Z.lIlIIllIlIllII(var46.contains(llIlIlIIlII[llIlIlIIlIl[30]]) ? 1 : 0) || Z.lIlIIllIlIlIll(var46.contains(llIlIlIIlII[llIlIlIIlIl[31]]) ? 1 : 0)) {
            return llIlIlIIlIl[32];
        }
        if (Z.lIlIIllIlIlIll(var46.contains(llIlIlIIlII[llIlIlIIlIl[32]]) ? 1 : 0)) {
            return llIlIlIIlIl[33];
        }
        if (!Z.lIlIIllIlIllII(var46.contains(llIlIlIIlII[llIlIlIIlIl[34]]) ? 1 : 0) || Z.lIlIIllIlIlIll(var46.contains(llIlIlIIlII[llIlIlIIlIl[33]]) ? 1 : 0)) {
            return llIlIlIIlIl[33];
        }
        WeaponStyle var19 = WeaponMap.StyleMap.getOrDefault(var21.getId(), WeaponStyle.MELEE);
        if (Z.lIlIIllIlIllll(var19, WeaponStyle.MELEE)) {
            return llIlIlIIlIl[1];
        }
        return llIlIlIIlIl[5];
    }
    ...
    public boolean j(int n2) {
        ...
        int var17 = llIlIlIIlIl[0];
        while (Z.lIlIIllIlIIlll(var17, (int)var23)) {
            void var30;
            void var5;
            void var8 = var5[var17];
            if (Z.lIlIIllIlIlIII((int)var8, (int)var30)) {
                return llIlIlIIlIl[1];
            }
            ++var17;
            0;
    ...
    public boolean ba() {
        ...
        } else if (Z.lIlIIllIlIlIll(var12.d.dehydration() ? 1 : 0) && Z.lIlIIllIlIllII(var12.aZ() ? 1 : 0) && Z.lIlIIllIlIlIll(var12.aq() ? 1 : 0)) {
        ...
        if (Z.lIlIIllIlIlIll(var12.aZ() ? 1 : 0)) {
            n2 = llIlIlIIlIl[12];
            0;
            if (1 <= 0) {
            ...
            n2 = var26 = llIlIlIIlIl[13];
        }
        if (Z.lIlIIllIlIlIll(var12.d.overlyDraining() ? 1 : 0)) {
            int n3;
            if (Z.lIlIIllIlIlIll(var12.aZ() ? 1 : 0)) {
                n3 = llIlIlIIlIl[14];
                0;
                ...
                n3 = var26 = llIlIlIIlIl[15];
            }
        }
        if (Z.lIlIIllIlIIlll(llllllllllllllllIIllIlIIIIllllll2, var26)) {
            var12.aY.c();
            return llIlIlIIlIl[0];
        }
        var12.aY.c(llIlIlIIlIl[1]);
        Item var49 = Equipment.fromSlot((EquipmentInventorySlot)EquipmentInventorySlot.WEAPON);
        if (!Z.lIlIIllIlIllIl(var49) || Z.lIlIIllIlIlllI(var49.getId(), llIlIlIIlIl[16])) {
            int[] nArray = new int[llIlIlIIlIl[1]];
            nArray[Z.llIlIlIIlIl[0]] = llIlIlIIlIl[16];
            Item var41 = Inventory.getFirst((int[])nArray);
            if (Z.lIlIIllIlIlIlI(var41)) {
                return llIlIlIIlIl[0];
            }
            var41.interact(llIlIlIIlII[llIlIlIIlIl[8]]);
        }
        Combat.toggleSpec();
        this.t.ao();
        this.t.an();
    ...
    private static String lIlIIllIlIIIll(String var29, String var45) {
        try {
            SecretKeySpec var40 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var45.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var11 = Cipher.getInstance("Blowfish");
            var11.init(llIlIlIIlIl[8], var40);
            return new String(var11.doFinal(Base64.getDecoder().decode(var29.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlIIllIlIIIlI(String var7, String var33) {
        var7 = new String(Base64.getDecoder().decode(var7.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var31 = new StringBuilder();
        char[] var48 = var33.toCharArray();
        int var35 = llIlIlIIlIl[0];
        char[] var2 = var7.toCharArray();
        int var18 = var2.length;
        int var10 = llIlIlIIlIl[0];
        while (Z.lIlIIllIlIIlll(var10, var18)) {
            char var27 = var2[var10];
            var31.append((char)(var27 ^ var48[var35 % var48.length]));
            0;
            ++var35;
            ++var10;
            0;
    ...
    private static String lIlIIllIlIIlII(String var15, String var3) {
        try {
            SecretKeySpec var1 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var3.getBytes(StandardCharsets.UTF_8)), llIlIlIIlIl[32]), "DES");
            Cipher var6 = Cipher.getInstance("DES");
            var6.init(llIlIlIIlIl[8], var1);
