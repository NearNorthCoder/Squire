...
/* TASK: Dodging Solidify Attack -> DodgingsolidifyattackTask */
...
extends bG_Unknown {
    ...
    private static void lIIlllIllIlIll() {
        ...
        bC.llIIIIllllI[0] = 1;
        bC.llIIIIllllI[1] = (0xDE ^ 0x90 ^ (0xC0 ^ 0xC5)) & (0x53 ^ 0 ^ (0x8B ^ 0x93) ^ -1);
    ...
    public boolean bl() {
        ...
        if (bC.lIIlllIllIllIl(var1.gc) && bC.lIIlllIllIlllI((var2 = var1.gc.dy(llIIIIllllI[0])).equals((Object)Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            Movement.setDestination((WorldPoint)var2);
            var1.gd.sleep(llIIIIllllI[3]);
            var1.gc = null;
