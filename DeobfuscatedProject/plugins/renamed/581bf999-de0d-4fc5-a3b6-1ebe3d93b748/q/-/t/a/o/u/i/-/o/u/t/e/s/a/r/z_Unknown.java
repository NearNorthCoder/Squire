...
public class z_Unknown {
    ...
    public List<Integer> i(int n2) {
        ...
        arrayList.add(n2);
        0;
        Iterator<List<Integer>> var9 = aW.iterator();
        while (z.lIlIlIIlIIllll(var9.hasNext() ? 1 : 0)) {
            void var31;
            List<Integer> var6 = var9.next();
            if (z.lIlIlIIlIIllll(var6.contains((int)var31) ? 1 : 0)) {
                void var10;
                var10.addAll(var6);
                0;
            }
    ...
    private static String lIlIlIIlIIIIIl(String var26, String var40) {
        try {
            SecretKeySpec var29 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var40.getBytes(StandardCharsets.UTF_8)), llIllIIlIII[4]), "DES");
            Cipher var1 = Cipher.getInstance("DES");
            var1.init(llIllIIlIII[8], var29);
    ...
    public boolean c(int[] nArray) {
        ...
        if (z.lIlIlIIlIIllll(var39.aY.g() ? 1 : 0)) {
            return llIllIIlIII[0];
        }
        ...
        int var33 = n2;
        List var15 = var43;
        int var11 = ((void)var15).length;
        int var34 = llIllIIlIII[0];
        while (z.lIlIlIIlIlIIIl(var34, var11)) {
            void var13 = var15[var34];
            if (z.lIlIlIIlIlIIlI(var33--)) {
                0;
                if (((0xB6 ^ 0xBD ^ (0x4E ^ 0x79)) & (0x1C ^ 8 ^ (0xBC ^ 0x94) ^ -1)) <= 0) break;
                return ((75 + 75 - 21 + 52 ^ 82 + 117 - 104 + 42) & (0x53 ^ 0x55 ^ (0xB ^ 0x31) ^ -1)) != 0;
            }
            var23.addAll(Inventory.getAll(arg_0 -> var39.a((int)var13, arg_0)));
            0;
            ++var34;
            0;
            if (-2 < 0) continue;
        ...
        if (z.lIlIlIIlIIllll(var11 = (int)((var15 = var23.stream().filter(item -> {
            ...
            return n2 != 0;
        }) ? 1 : 0)) && z.lIlIlIIlIlIIll(Equipment.fromSlot((EquipmentInventorySlot)EquipmentInventorySlot.SHIELD)) && z.lIlIlIIlIIllll(Inventory.isFull() ? 1 : 0) && z.lIlIlIIlIlIIll(var34 = var39.ai())) {
            var34.interact(llIllIIIllI[llIllIIlIII[0]]);
            return llIllIIlIII[2];
        }
        Gear.swapTo((int[])var43);
        0;
        if (z.lIlIlIIlIIlllI(var15.isEmpty() ? 1 : 0)) {
            bl2 = llIllIIlIII[2];
            0;
            if (3 <= 0) {
    ...
    private static String lIlIlIIlIIIIII(String var32, String var12) {
        try {
            SecretKeySpec var36 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var12.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var18 = Cipher.getInstance("Blowfish");
            var18.init(llIllIIlIII[8], var36);
            return new String(var18.doFinal(Base64.getDecoder().decode(var32.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlIlIIlIIIIlI(String var38, String var28) {
        ...
        int var3 = llIllIIlIII[0];
        char[] var25 = var38.toCharArray();
        int var30 = var25.length;
        int var19 = llIllIIlIII[0];
        while (z.lIlIlIIlIlIIIl(var19, var30)) {
            char var37 = var25[var19];
            var8.append((char)(var37 ^ var24[var3 % var24.length]));
            0;
            ++var3;
            ++var19;
            0;
    ...
    private Item ai() {
        ...
        int var44 = var42.j(llIllIIlIII[5]) ? 1 : 0;
        if (z.lIlIlIIlIIllll(var44)) {
        ...
        if (!z.lIlIlIIlIIlllI(var42.j(llIllIIlIII[6]) ? 1 : 0) || z.lIlIlIIlIIllll(var42.j(llIllIIlIII[7]) ? 1 : 0)) {
            n2 = llIllIIlIII[2];
            0;
            if (-2 > 0) {
                return null;
        ...
        if (z.lIlIlIIlIIllll(var17 = n2)) {
            var41 = Inventory.getFirst(item -> item.getName().toLowerCase().contains(llIllIIIllI[llIllIIlIII[15]]));
            if (z.lIlIlIIlIlIIll(var41)) {
                return var41;
            }
            Item var5 = Inventory.getFirst(item -> {
                ...
                if (!z.lIlIlIIlIIlllI(item.getName().toLowerCase().contains(llIllIIIllI[llIllIIlIII[4]]) ? 1 : 0) || z.lIlIlIIlIIllll(item.getName().toLowerCase().contains(llIllIIIllI[llIllIIlIII[13]]) ? 1 : 0)) {
                    ...
                    if (z.lIlIlIIlIIllll(var20.hasAction(stringArray) ? 1 : 0)) {
                        n2 = llIllIIlIII[2];
                        0;
            ...
            if (z.lIlIlIIlIlIIll(var21)) {
                return var21;
            }
        }
        if (z.lIlIlIIlIlIlII(var41 = (Item)Inventory.getAll(item -> {
            String[] stringArray = new String[llIllIIlIII[2]];
    ...
    public boolean j(int n2) {
        ...
        int var16 = llIllIIlIII[0];
        while (z.lIlIlIIlIlIIIl(var16, (int)var14)) {
            void var22;
            void var4;
            void var7 = var4[var16];
            if (z.lIlIlIIlIlIIII((int)var7, (int)var22)) {
                return llIllIIlIII[2];
            }
            ++var16;
            0;
