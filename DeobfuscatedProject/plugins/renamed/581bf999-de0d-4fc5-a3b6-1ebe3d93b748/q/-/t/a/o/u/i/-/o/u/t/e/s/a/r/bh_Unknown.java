...
import q.-.t.a.o.u.i.-.o.u.t.e.s.a.r.BIEnum;
import q.-.t.a.o.u.i.-.o.u.t.e.s.a.r.z_Unknown;

public abstract class bh_Unknown
extends ao_Unknown {
    ...
    protected Set<WorldPoint> bU() {
        ...
        Iterator var28 = this.cu.getGraphicsObjects().iterator();
        while (bh.lIIllIIllIIlll(var28.hasNext() ? 1 : 0)) {
            GraphicsObject var29 = (GraphicsObject)var28.next();
            if (!bh.lIIllIIlllIIII(var29.getId(), lIlllIlIllI[12]) || !bh.lIIllIIlllIIII(var29.getId(), lIlllIlIllI[13]) || !bh.lIIllIIlllIIII(var29.getId(), lIlllIlIllI[14]) || bh.lIIllIIllIlIll(var29.getId(), lIlllIlIllI[15])) {
                void var15;
                bh var19;
                LocalPoint var26 = var29.getLocation();
                if (bh.lIIllIIllIlIlI(var26)) {
                    0;
                    if ((0x45 ^ 0x41) > ((0x25 ^ 0x66) & ~(0xE3 ^ 0xA0))) continue;
                    return null;
                }
                WorldPoint var23 = WorldPoint.fromLocal((Client)var19.cu, (LocalPoint)var26);
                var15.add(var23);
                0;
            }
            0;
    ...
    public boolean bQ() {
        ...
        if (bh.lIIllIIllIIlll(Movement.isRunEnabled() ? 1 : 0)) {
            ...
            n2 = var30 = lIlllIlIllI[3];
        }
        if (!bh.lIIllIIllIIllI(var5) || bh.lIIllIIllIllIl(var5.distanceTo2D(var7.getWorldLocation()), var30)) {
            bl2 = lIlllIlIllI[3];
            0;
            if (2 >= (0x34 ^ 0x30)) {
                return false;
    ...
    public boolean bn() {
        ...
        if (bh.lIIllIIllIlIlI(var3)) {
            return lIlllIlIllI[2];
        }
        String[] stringArray2 = new String[lIlllIlIllI[3]];
        stringArray2[bh.lIlllIlIllI[2]] = lIlllIlIlII[lIlllIlIllI[7]];
        if (bh.lIIllIIllIIlll(var3.hasAction(stringArray2) ? 1 : 0)) {
            var3.interact(lIlllIlIlII[lIlllIlIllI[8]]);
            return lIlllIlIllI[3];
        }
    ...
    private static String lIIllIIlIllIlI(String var33, String var32) {
        try {
            SecretKeySpec var17 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var32.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var8 = Cipher.getInstance("Blowfish");
            var8.init(lIlllIlIllI[1], var17);
            return new String(var8.doFinal(Base64.getDecoder().decode(var33.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    protected WorldPoint bT() {
        ...
        bh var6;
        Point var13;
        Iterator<Point> var4 = eN.iterator();
        while (bh.lIIllIIllIIlll(var4.hasNext() ? 1 : 0)) {
            WorldPoint var10;
            var13 = var4.next();
            var2 = var6.a(var13);
            if (bh.lIIllIIllIlIIl(TileObjects.getAll(tileObject -> {
                int n2;
                if (bh.lIIllIIllIIlll(tileObject.getWorldLocation().equals((Object)var2) ? 1 : 0) && bh.lIIllIIllIlIll(tileObject.getId(), lIlllIlIllI[10])) {
                    n2 = lIlllIlIllI[3];
                    0;
                ...
                return n2 != 0;
            }).isEmpty() ? 1 : 0) && bh.lIIllIIllIIlll(Reachable.isWalkable((WorldPoint)(var10 = var6.a(var13))) ? 1 : 0)) {
                return var10;
            }
            0;
            if (2 < 3) continue;
        ...
        while (bh.lIIllIIllIIlll(var4.hasNext() ? 1 : 0)) {
            ...
            if (bh.lIIllIIllIIlll(TileObjects.getAll(tileObject -> {
                ...
                return n2 != 0;
            }).isEmpty() ? 1 : 0) && bh.lIIllIIllIIlll(Reachable.isWalkable((WorldPoint)var2) ? 1 : 0)) {
                return var2;
            }
            0;
    ...
    private static String lIIllIIlIlllII(String var24, String var12) {
        try {
            SecretKeySpec var9 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var12.getBytes(StandardCharsets.UTF_8)), lIlllIlIllI[9]), "DES");
            Cipher var18 = Cipher.getInstance("DES");
            var18.init(lIlllIlIllI[1], var9);
    ...
    private static String lIIllIIlIllIll(String var16, String var14) {
        var16 = new String(Base64.getDecoder().decode(var16.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var34 = new StringBuilder();
        char[] var27 = var14.toCharArray();
        int var11 = lIlllIlIllI[2];
        char[] var22 = var16.toCharArray();
        int var31 = var22.length;
        int var25 = lIlllIlIllI[2];
        while (bh.lIIllIIllIllII(var25, var31)) {
            char var20 = var22[var25];
            var34.append((char)(var20 ^ var27[var11 % var27.length]));
            0;
            ++var11;
            ++var25;
            0;
