...
public abstract class bX_Unknown
extends ao_Unknown {
    ...
    public NPC cA() {
        return NPCs.getNearest(nPC -> {
            boolean bl2;
            NPC var13;
            if ((!bX.lIlIIlIIIIllII(nPC.getId(), llIlIIIIIII[16]) || bX.lIlIIlIIIIlIIl(nPC.getName().equals(llIIlllllll[llIlIIIIIII[17]]) ? 1 : 0)) && bX.lIlIIlIIIIlIlI(var13.isDead() ? 1 : 0)) {
                bl2 = llIlIIIIIII[4];
                0;
                if (1 <= 0) {
                    return false;
    ...
    public boolean bk() {
        ...
        int var20 = llIlIIIIIII[2];
        while (bX.lIlIIlIIIIIlIl(var20, (int)var28)) {
            bX var9;
            void var29;
            void var14 = var29[var20];
            if (bX.lIlIIlIIIIIllI(var9.aX(), (int)var14)) {
    ...
    public boolean bn() {
        ...
        if (bX.lIlIIlIIIIlIII(var27)) {
            return llIlIIIIIII[2];
        }
        if (bX.lIlIIlIIIIlIlI(Reachable.isInteractable((Locatable)var27) ? 1 : 0)) {
            String[] stringArray2 = new String[llIlIIIIIII[4]];
            stringArray2[bX.llIlIIIIIII[2]] = llIIlllllll[llIlIIIIIII[7]];
            TileObject var17 = TileObjects.getNearest((String[])stringArray2);
            if (bX.lIlIIlIIIIlIII(var17)) {
                return llIlIIIIIII[2];
            }
            var17.interact(llIIlllllll[llIlIIIIIII[8]]);
            return llIlIIIIIII[4];
        }
        f.r();
        String[] stringArray3 = new String[llIlIIIIIII[4]];
        stringArray3[bX.llIlIIIIIII[2]] = llIIlllllll[llIlIIIIIII[9]];
        if (bX.lIlIIlIIIIlIIl(var27.hasAction(stringArray3) ? 1 : 0)) {
            var27.interact(llIIlllllll[llIlIIIIIII[10]]);
            return llIlIIIIIII[4];
        }
    ...
    private static String lIlIIlIIIIIIII(String var1, String var34) {
        try {
            SecretKeySpec var8 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var34.getBytes(StandardCharsets.UTF_8)), llIlIIIIIII[11]), "DES");
            Cipher var4 = Cipher.getInstance("DES");
            var4.init(llIlIIIIIII[1], var8);
    ...
    public List<WorldPoint> cE() {
        ...
        Iterator<Projectile> var18 = this.cG().iterator();
        while (bX.lIlIIlIIIIlIIl(var18.hasNext() ? 1 : 0)) {
            void var33;
            bX var15;
            Projectile var10 = var18.next();
            LocalPoint var7 = var10.getTarget();
            if (bX.lIlIIlIIIIlIII(var7)) {
                0;
                if (-1 == -1) continue;
                return null;
            }
            WorldPoint var25 = WorldPoint.fromLocal((Client)var15.cu, (LocalPoint)var7);
            if (bX.lIlIIlIIIIIllI(var10.getId(), llIlIIIIIII[13])) {
                var33.addAll(var25.toWorldArea().offset(llIlIIIIIII[1]).toWorldPointList());
                0;
                0;
                if (3 < 0) {
                    return null;
    ...
    private static String lIlIIlIIIIIIIl(String var26, String var23) {
        try {
            SecretKeySpec var24 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var23.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var11 = Cipher.getInstance("Blowfish");
            var11.init(llIlIIIIIII[1], var24);
            return new String(var11.doFinal(Base64.getDecoder().decode(var26.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlIIIllllllll(String var16, String var3) {
        var16 = new String(Base64.getDecoder().decode(var16.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var31 = new StringBuilder();
        char[] var6 = var3.toCharArray();
        int var5 = llIlIIIIIII[2];
        char[] var19 = var16.toCharArray();
        int var12 = var19.length;
        int var2 = llIlIIIIIII[2];
        while (bX.lIlIIlIIIIIlIl(var2, var12)) {
            char var32 = var19[var2];
            var31.append((char)(var32 ^ var6[var5 % var6.length]));
            0;
            ++var5;
            ++var2;
            0;
