...
import q.-.t.a.o.u.i.-.o.u.t.e.s.a.r.by_Unknown;
    ...
    public boolean bl() {
        ...
        if (bz.lIlIlIlIIIllII(Prayers.getPoints(), llIllIllIII[1])) {
            Item var15 = Inventory.getFirst(item -> {
                int n2;
                if (!bz.lIlIlIlIIIlIll(q.-.t.a.o.u.i.-.o.u.t.e.s.a.r.EEnum.TEARS_OF_ELIDINIS.d(item.getId()) ? 1 : 0) || !bz.lIlIlIlIIIlIll(item.getName().contains(llIllIlIlll[llIllIllIII[19]]) ? 1 : 0) || !bz.lIlIlIlIIIlIll(item.getName().contains(llIllIlIlll[llIllIllIII[17]]) ? 1 : 0) || bz.lIlIlIlIIIlllI(item.getName().contains(llIllIlIlll[llIllIllIII[20]]) ? 1 : 0)) {
                    n2 = llIllIllIII[2];
                    0;
                    if (2 > 2) {
