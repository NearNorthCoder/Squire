...
/* TASK: Moving to best spot -> MovingtobestspotTask */
...
extends bh_Unknown {
    ...
    protected boolean bL() {
        ...
        if (!bl.lIlIIIIllIlIll(var1.bR() ? 1 : 0) || bl.lIlIIIIllIllII(bl.bV() ? 1 : 0)) {
            return llIIlIlllIl[0];
        }
        Set<WorldPoint> var6 = var1.bU();
        if (bl.lIlIIIIllIlIll(var6.isEmpty() ? 1 : 0)) {
            return llIIlIlllIl[0];
        }
        List<WorldPoint> var3 = var1.bS();
        WorldPoint var5 = var1.bT();
        WorldPoint var4 = var2.getWorldArea().offset(llIIlIlllIl[1]).toWorldPointList().stream().filter(arg_0 -> bl.g((NPC)var2, arg_0)).filter(arg_0 -> bl.f((NPC)var2, arg_0)).filter(Reachable::isWalkable).filter(worldPoint -> {
            boolean bl2;
            if (bl.lIlIIIIllIlIll(var3.contains(worldPoint) ? 1 : 0)) {
                bl2 = llIIlIlllIl[1];
                0;
                if (3 < 0) {
        ...
        if (!bl.lIlIIIIllIllIl(var4) || bl.lIlIIIIllIlllI(var4.distanceTo2D(Players.getLocal().getWorldLocation()), llIIlIlllIl[2])) {
            return llIIlIlllIl[0];
        }
    ...
    private static void lIlIIIIllIlIIl() {
        ...
        bl.llIIlIlllIl[0] = (0xA ^ 0x42 ^ (0x2B ^ 0x7F)) & (0x6A ^ 0x7E ^ (0x2A ^ 0x22) ^ -1);
        bl.llIIlIlllIl[1] = 1;
        bl.llIIlIlllIl[2] = 2;
