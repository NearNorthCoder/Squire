...
extends S_Unknown {
    ...
    private void b(Graphics2D graphics2D) {
        ...
        while (N.lIlIIIIIIllIIl(var1.hasNext() ? 1 : 0)) {
            void var4;
            NPC var2 = var1.next();
            Shape var3 = var2.getConvexHull();
            if (N.lIlIIIIIIllIlI(var3)) {
                0;
                if ((0x3F ^ 0x3B) > 3) continue;
                return;
            }
            OverlayUtil.renderPolygon((Graphics2D)var4, (Shape)var3, (Color)Color.BLUE, (Stroke)new BasicStroke(1.0f));
            0;
