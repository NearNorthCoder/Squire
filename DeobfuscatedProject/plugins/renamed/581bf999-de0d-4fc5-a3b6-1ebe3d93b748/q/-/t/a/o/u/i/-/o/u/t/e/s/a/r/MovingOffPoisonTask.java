...
/* TASK: Moving off poison -> MovingoffpoisonTask */
...
extends bX_Unknown {
    ...
    private static String lIIllIlIlllIll(String var8, String var1) {
        try {
            SecretKeySpec var3 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var1.getBytes(StandardCharsets.UTF_8)), lIlllllIIIl[3]), "DES");
            Cipher var9 = Cipher.getInstance("DES");
            var9.init(lIlllllIIIl[1], var3);
    ...
    public boolean bL() {
        ...
        if (bU.lIIllIlIllllll(var5.stream().noneMatch(arg_0 -> bU.c((Player)var6, arg_0)) ? 1 : 0)) {
            return lIlllllIIIl[0];
        }
        Log.info((String)lIlllllIIII[lIlllllIIIl[0]]);
        WorldArea var4 = var6.getWorldArea().offset(lIlllllIIIl[1]);
        WorldPoint var7 = var4.toWorldPointList().stream().filter(arg_0 -> bU.j((Set)var5, arg_0)).min(Comparator.comparingInt(arg_0 -> bU.f((Player)var6, arg_0))).orElse(null);
        if (bU.lIIllIllIIIIII(var7)) {
            return lIlllllIIIl[0];
        }
