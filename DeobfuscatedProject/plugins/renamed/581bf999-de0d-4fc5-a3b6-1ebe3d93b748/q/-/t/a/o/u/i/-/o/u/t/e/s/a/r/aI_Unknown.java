...
public abstract class aI_Unknown
extends ao_Unknown {
    ...
    private static String lIIllIIlIllIII(String var6, String var5) {
        try {
            SecretKeySpec var16 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var5.getBytes(StandardCharsets.UTF_8)), lIlllIlIlIl[9]), "DES");
            Cipher var1 = Cipher.getInstance("DES");
            var1.init(lIlllIlIlIl[1], var16);
    ...
    public boolean bj() {
        ...
        if (aI.lIIllIIlIllllI(nPC) && aI.lIIllIIlIlllll(Reachable.isInteractable((Locatable)nPC) ? 1 : 0)) {
            ...
            0;
            if (2 == 0) {
                return ((1 ^ (0x95 ^ 0xB6)) & (31 + 67 - 52 + 82 ^ 100 + 20 - 73 + 115 ^ -1)) != 0;
            }
        } else {
            n2 = lIlllIlIlIl[2];
        }
    ...
    private static String lIIllIIlIlIlll(String var7, String var9) {
        var7 = new String(Base64.getDecoder().decode(var7.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var12 = new StringBuilder();
        char[] var11 = var9.toCharArray();
        int var4 = lIlllIlIlIl[2];
        char[] var8 = var7.toCharArray();
        int var13 = var8.length;
        int var3 = lIlllIlIlIl[2];
        while (aI.lIIllIIllIIIll(var3, var13)) {
            char var14 = var8[var3];
            var12.append((char)(var14 ^ var11[var4 % var11.length]));
            0;
            ++var4;
            ++var3;
            0;
    ...
    public int bA() {
        ...
        if (aI.lIIllIIllIIIlI(aI.lIIllIIllIIIIl((double)var2, 33.0))) {
    ...
    public boolean bn() {
        ...
        if (aI.lIIllIIllIIIII(var15)) {
            return lIlllIlIlIl[2];
        }
        String[] stringArray2 = new String[lIlllIlIlIl[3]];
        stringArray2[aI.lIlllIlIlIl[2]] = lIlllIlIIll[lIlllIlIlIl[7]];
        if (aI.lIIllIIlIlllll(var15.hasAction(stringArray2) ? 1 : 0)) {
            var15.interact(lIlllIlIIll[lIlllIlIlIl[8]]);
            return lIlllIlIlIl[3];
        }
    ...
    private static void lIIllIIlIllIIl() {
        ...
        aI.lIlllIlIIll[aI.lIlllIlIlIl[2]] = aI."Apmeken";
        aI.lIlllIlIIll[aI.lIlllIlIlIl[3]] = aI."Osmumten";
        aI.lIlllIlIIll[aI.lIlllIlIlIl[1]] = aI."Teleport crystal";
        aI.lIlllIlIIll[aI.lIlllIlIlIl[4]] = aI."Quick-Use";
        aI.lIlllIlIIll[aI.lIlllIlIlIl[5]] = aI."Apmeken";
        aI.lIlllIlIIll[aI.lIlllIlIlIl[6]] = aI."Osmumten";
        aI.lIlllIlIIll[aI.lIlllIlIlIl[7]] = aI."Quick-leave";
        aI.lIlllIlIIll[aI.lIlllIlIlIl[8]] = aI."Quick-leave";
        aI.lIlllIlIIll[aI.lIlllIlIlIl[9]] = aI."Talk-to";
    }
    ...
    private static void lIIllIIlIlllIl() {
        ...
        aI.lIlllIlIlIl[1] = 2;
        aI.lIlllIlIlIl[2] = (0x8A ^ 0x97 ^ (0x73 ^ 0x44)) & (0x99 ^ 0xBD ^ (0xA4 ^ 0xAA) ^ -1);
        aI.lIlllIlIlIl[3] = 1;
        aI.lIlllIlIlIl[4] = 3;
