...
public abstract class bG_Unknown
extends ao_Unknown {
    ...
    private static String lIlIIlIIlIIIIl(String var1, String var18) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var18.getBytes(StandardCharsets.UTF_8)), llIlIIIIllI[19]), "DES");
            Cipher var11 = Cipher.getInstance("DES");
            var11.init(llIlIIIIllI[11], var5);
    ...
    public boolean bj() {
        ...
        int var7 = var17.aX();
        if (!bG.lIlIIlIIlIIlll(var7, llIlIIIIllI[3]) || !bG.lIlIIlIIlIIlll(var7, llIlIIIIllI[4]) || !bG.lIlIIlIIlIIlll(var7, llIlIIIIllI[5]) || bG.lIlIIlIIlIlIII(var7, llIlIIIIllI[6])) {
            bl2 = llIlIIIIllI[2];
            0;
    ...
    private static String lIlIIlIIlIIIll(String var9, String var19) {
        try {
            ...
            var8.init(llIlIIIIllI[11], var14);
    ...
    private static String lIlIIlIIlIIIlI(String var3, String var21) {
        var3 = new String(Base64.getDecoder().decode(var3.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var20 = new StringBuilder();
        char[] var10 = var21.toCharArray();
        int var13 = llIlIIIIllI[7];
        char[] var12 = var3.toCharArray();
        int var2 = var12.length;
        int var15 = llIlIIIIllI[7];
        while (bG.lIlIIlIIlIlIll(var15, var2)) {
            char var16 = var12[var15];
            var20.append((char)(var16 ^ var10[var13 % var10.length]));
            0;
            ++var13;
            ++var15;
            0;
