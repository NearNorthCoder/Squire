...
@Singleton
/* TASK: Attacking kephri -> AttackingkephriTask */
...
extends bh_Unknown {
    ...
    public void a(ChatMessage chatMessage) {
        ...
        if (aZ.lIIlIlllIIlIII(var3.getMessage().contains(lIllIlIIlll[lIllIlIlIIl[2]]) ? 1 : 0)) {
    ...
    private static String lIIlIlllIIIIII(String var2, String var11) {
        var2 = new String(Base64.getDecoder().decode(var2.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var16 = new StringBuilder();
        char[] var13 = var11.toCharArray();
        int var24 = lIllIlIlIIl[0];
        char[] var17 = var2.toCharArray();
        int var15 = var17.length;
        int var19 = lIllIlIlIIl[0];
        while (aZ.lIIlIlllIIlIIl(var19, var15)) {
            char var1 = var17[var19];
            var16.append((char)(var1 ^ var13[var24 % var13.length]));
            0;
            ++var24;
            ++var19;
            0;
    ...
    private static String lIIlIlllIIIIIl(String var21, String var18) {
        try {
    ...
    public ConfigStorageBox<EquipmentSetup> br() {
        if (aZ.lIIlIlllIIlIII(this.eB ? 1 : 0)) {
            ...
            return var14.cW.rangeGearAkkha();
        }
        return super.br();
    }
    ...
    private static String lIIlIllIllllll(String var12, String var6) {
        try {
            SecretKeySpec var8 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var6.getBytes(StandardCharsets.UTF_8)), lIllIlIlIIl[6]), "DES");
            Cipher var20 = Cipher.getInstance("DES");
            var20.init(lIllIlIlIIl[3], var8);
    ...
    protected boolean bL() {
        ...
        NPC var9 = var22.bO();
        if (aZ.lIIlIlllIIllII(var9)) {
            var22.eB = lIllIlIlIIl[0];
            return lIllIlIlIIl[0];
        }
        if (!aZ.lIIlIlllIIlIll(var22.bR() ? 1 : 0) || aZ.lIIlIlllIIlIII(aZ.bV() ? 1 : 0)) {
            return lIllIlIlIIl[0];
        }
        if (aZ.lIIlIlllIIlIII(var9.getWorldArea().isInMeleeDistance(var10.getWorldLocation()) ? 1 : 0)) {
            var22.eB = lIllIlIlIIl[0];
        }
