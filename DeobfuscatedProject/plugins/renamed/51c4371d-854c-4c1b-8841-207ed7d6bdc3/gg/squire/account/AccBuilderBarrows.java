...
import -.a.c.u.c.l.o.d.-.r.e.o.n.b.l.e.i.w.k.b.-.r.i.s.r.O_Unknown;
...
extends Script {
    ...
    public void a(GameTick gameTick) {
        block5: {
            ...
            block6: {
                -.a.c.u.c.l.o.d.-.r.e.o.n.b.l.e.i.w.k.b.-.r.i.s.r.e_Unknown.x();
        ...
        if (AccBuilderBarrows.lIlIlIIIllI(Dialog.isOpen() ? 1 : 0) && AccBuilderBarrows.lIlIlIIIlII(Dialog.getText()) && AccBuilderBarrows.lIlIlIIIllI(Dialog.getText().contains(llIIlIIl[llIIlIlI[22]]) ? 1 : 0)) {
            -.a.c.u.c.l.o.d.-.r.e.o.n.b.l.e.i.w.k.b.-.r.i.s.r.t_Unknown.cV = llIIlIlI[5];
        }
        -.a.c.u.c.l.o.d.-.r.e.o.n.b.l.e.i.w.k.b.-.r.i.s.r.e_Unknown.H();
    }
    ...
    private void a(LoginStateChanged loginStateChanged) {
        ...
        if (AccBuilderBarrows.lIlIlIIIIll(n)) {
            ...
            -.a.c.u.c.l.o.d.-.r.e.o.n.b.l.e.i.w.k.b.-.r.i.s.r.e_Unknown.a(lIlIlIlIllllllI.s, "rsn: " + k + " account has been banned? - Acc builder " + o);
            n += llIIlIlI[5];
        }
    }
    ...
    protected int loop() {
        block10: {
            block11: {
                ...
                while (AccBuilderBarrows.lIlIlIIIllI(-.a.c.u.c.l.o.d.-.r.e.o.n.b.l.e.i.w.k.b.-.r.i.s.r.e_Unknown.y() ? 1 : 0) && AccBuilderBarrows.lIlIlIIIIll(d ? 1 : 0) && AccBuilderBarrows.lIlIlIIIlll(-.a.c.u.c.l.o.d.-.r.e.o.n.b.l.e.i.w.k.b.-.r.i.s.r.e_Unknown.j(llIIlIlI[7]), llIIlIlI[8]) && AccBuilderBarrows.lIlIlIIIIll(Dialog.isOpen() ? 1 : 0)) {
                    c = llIIlIIl[llIIlIlI[9]];
                    -.a.c.u.c.l.o.d.-.r.e.o.n.b.l.e.i.w.k.b.-.r.i.s.r.e_Unknown.z();
                    Time.sleepTicks((int)llIIlIlI[5]);
                    0;
                    0;
    ...
    private static void lIlIIllIIll() {
        ...
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[4]] = AccBuilderBarrows."https://discord.com/api/webhooks/1193421866459725834/O4zTPyFZMm83vMwkEnq6zlsGdAzLR4AGiJhhz0hFc0JZsJzMFQ-ivS8oiytVIzgMDJhM";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[5]] = AccBuilderBarrows."quest";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[9]] = AccBuilderBarrows."Disabling GE warning";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[10]] = AccBuilderBarrows."Navigating to GE";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[11]] = AccBuilderBarrows."Finished account";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[13]] = AccBuilderBarrows."\n[Plugin] Plugin starting up\n";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[14]] = AccBuilderBarrows."Barrows";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[15]] = AccBuilderBarrows."Switching to One Click Barrows account";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[16]] = AccBuilderBarrows."hootfighter";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[17]] = AccBuilderBarrows."enabled";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[18]] = AccBuilderBarrows."\n[Plugin] Plugin shut down\n";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[22]] = AccBuilderBarrows."tell the king";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[23]] = AccBuilderBarrows."You haven't got enough";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[24]] = AccBuilderBarrows."Not enough gold for buying";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[25]] = AccBuilderBarrows."Oh dear, you are dead!";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[26]] = AccBuilderBarrows."We DIED!! :(";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[27]] = AccBuilderBarrows."Died - Ending script: Please report what quest it died on and location,step if you saw";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[28]] = AccBuilderBarrows."We died during or after prayer, should be continuing script, report if you see this and it wasn't during or right after prayer";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[29]] = AccBuilderBarrows."can't reach that";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[30]] = AccBuilderBarrows."Door";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[19]] = AccBuilderBarrows."Door";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[31]] = AccBuilderBarrows."Open";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[32]] = AccBuilderBarrows."Tree Door";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[33]] = AccBuilderBarrows."Tree Door";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[34]] = AccBuilderBarrows."Open";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[35]] = AccBuilderBarrows."think that facing North";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[38]] = AccBuilderBarrows."already some rum";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[40]] = AccBuilderBarrows."Drop";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[41]] = AccBuilderBarrows."Burning";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[42]] = AccBuilderBarrows."Burning";
        AccBuilderBarrows.llIIlIIl[AccBuilderBarrows.llIIlIlI[43]] = AccBuilderBarrows."";
    }
}
