...
import c.r.s.u.e.l.a.o.l.s.l.o.e.v.s.r.l.y.e.c.-.-.-.h_Unknown;
import c.r.s.u.e.l.a.o.l.s.l.o.e.v.s.r.l.y.e.c.-.-.-.m_Unknown;
...
public class g_Unknown {
    ...
    private static void llIllll() {
        ...
        g.lIllI[g.lIlll[2]] = g."Yes";
        g.lIllI[g.lIlll[1]] = g."Break";
        g.lIllI[g.lIlll[14]] = g."Wear";
        g.lIllI[g.lIlll[15]] = g."Wear";
        g.lIllI[g.lIlll[32]] = g."Break";
        g.lIllI[g.lIlll[21]] = g."Lever";
        g.lIllI[g.lIlll[13]] = g."Pull";
        g.lIllI[g.lIlll[35]] = g."Emerald Benedict";
        g.lIllI[g.lIlll[37]] = g."Bank";
        g.lIllI[g.lIlll[39]] = g."Bank chest";
        g.lIllI[g.lIlll[27]] = g."Use";
        g.lIllI[g.lIlll[26]] = g."Use";
        g.lIllI[g.lIlll[40]] = g."Bank";
        g.lIllI[g.lIlll[41]] = g."Bank";
        g.lIllI[g.lIlll[42]] = g."Open chest";
        g.lIllI[g.lIlll[43]] = g."Bank chest";
        g.lIllI[g.lIlll[44]] = g."Bank";
        g.lIllI[g.lIlll[45]] = g."Bank";
        g.lIllI[g.lIlll[46]] = g."Use";
        g.lIllI[g.lIlll[47]] = g."Use";
        g.lIllI[g.lIlll[11]] = g."Bank counter";
        g.lIllI[g.lIlll[48]] = g."Bank";
        g.lIllI[g.lIlll[49]] = g."Bank";
        g.lIllI[g.lIlll[50]] = g."Bank booth";
        g.lIllI[g.lIlll[51]] = g."Bank";
        g.lIllI[g.lIlll[52]] = g."teleport";
        g.lIllI[g.lIlll[53]] = g."teleport";
        g.lIllI[g.lIlll[54]] = g."teleport";
        g.lIllI[g.lIlll[55]] = g."teleport";
    }
    ...
    private static void lllIIII() {
        ...
        g.lIlll[1] = 1;
        g.lIlll[2] = (0xB0 ^ 0xAE ^ (0x2E ^ 0x62)) & (0x19 ^ 0x70 ^ (0x26 ^ 0x1D) ^ -1);
