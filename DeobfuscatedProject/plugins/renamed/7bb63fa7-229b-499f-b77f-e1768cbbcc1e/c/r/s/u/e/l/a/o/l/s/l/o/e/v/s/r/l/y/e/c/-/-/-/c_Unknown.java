...
import c.r.s.u.e.l.a.o.l.s.l.o.e.v.s.r.l.y.e.c.-.-.-.d_Unknown;
import c.r.s.u.e.l.a.o.l.s.l.o.e.v.s.r.l.y.e.c.-.-.-.f_Unknown;
...
public class c_Unknown {
    ...
    private static String llllIII(String llllIllIlIIIIII, String llllIllIlIIIlII) {
        ...
        while (c.lIIIlIlI(llllIllIIlllIIl, llllIllIIlllIlI)) {
            ...
            ++llllIllIIlllIIl;
            0;
            if (-1 < ((110 + 80 - 63 + 30 ^ 93 + 108 - 69 + 44) & (139 + 55 - 64 + 29 ^ 17 + 40 - -64 + 57 ^ -1))) continue;
            return null;
        }
    ...
    private static void lllllll() {
        ...
        c.llIII[c.llIll[0]] = c."Got a clue";
        c.llIII[c.llIll[1]] = c."Pick-lock";
        c.llIII[c.llIll[2]] = c."Barrier";
        c.llIII[c.llIll[3]] = c."Handling barrier dialogue";
        c.llIII[c.llIll[11]] = c."Yes, and don't ask again.";
        c.llIII[c.llIll[12]] = c."yes, and don't ask again.";
        c.llIII[c.llIll[17]] = c."Break";
        c.llIII[c.llIll[21]] = c."Jumping into pool";
        c.llIII[c.llIll[22]] = c."Whirlpool";
        c.llIII[c.llIll[23]] = c."Dive in";
        c.llIII[c.llIll[19]] = c."Reward casket (easy)";
        c.llIII[c.llIll[24]] = c."Reward casket (easy)";
        c.llIII[c.llIll[25]] = c."Open";
        c.llIII[c.llIll[15]] = c."Coin pouch";
        c.llIII[c.llIll[26]] = c."Coin pouch";
        c.llIII[c.llIll[20]] = c."Open-all";
        c.llIII[c.llIll[27]] = c."Door";
        c.llIII[c.llIll[28]] = c."Pick-lock";
        c.llIII[c.llIll[29]] = c."Clue";
        c.llIII[c.llIll[30]] = c."master";
    }
    ...
    private static void lIIIIlII() {
        llIll = new int[34];
        c.llIll[0] = (6 + 46 - -58 + 40 ^ 105 + 127 - 91 + 28) & (0x34 ^ 0x4D ^ (0x38 ^ 0x7E) ^ -1);
        c.llIll[1] = 1;
        c.llIll[2] = 2;
        c.llIll[3] = 3;
