...
/* TASK: Chopping (fast) -> Chopping(Fast)Task */
...
extends Task {
    ...
    private static String llIIIIllllllllI(String var12, String var10) {
        try {
            SecretKeySpec var7 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var10.getBytes(StandardCharsets.UTF_8)), lIllIIIIIlIlI[7]), "DES");
            Cipher var8 = Cipher.getInstance("DES");
            var8.init(lIllIIIIIlIlI[4], var7);
    ...
    private static String llIIIIlllllllIl(String var6, String var13) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var13.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var3 = Cipher.getInstance("Blowfish");
            var3.init(lIllIIIIIlIlI[4], var5);
    ...
    public boolean run() {
        ...
        if (k.llIIIlIIIIIIIlI(var1.L.p() ? 1 : 0)) {
            return lIllIIIIIlIlI[0];
        }
        ...
        if (k.llIIIlIIIIIIlII(var14)) {
            return lIllIIIIIlIlI[0];
        }
        WorldArea[] worldAreaArray = new WorldArea[lIllIIIIIlIlI[2]];
        worldAreaArray[k.lIllIIIIIlIlI[0]] = var1.L.j();
        if (k.llIIIlIIIIIIIlI(var14.getWorldLocation().isInArea(worldAreaArray) ? 1 : 0) && k.llIIIlIIIIIIIIl(Movement.isRunEnabled() ? 1 : 0)) {
            Movement.toggleRun();
        }
        if (k.llIIIlIIIIIIlII(var2 = TileObjects.getNearest(tileObject -> {
            int n;
        ...
        i var11 = i.b(var2);
        if (k.llIIIlIIIIIIlII((Object)var11)) {
            Log.info((String)lIllIIIIIlIIl[lIllIIIIIlIlI[0]]);
            return lIllIIIIIlIlI[0];
        }
        if (k.llIIIlIIIIIIlIl(var1.L.q(), lIllIIIIIlIlI[3]) && k.llIIIlIIIIIIIIl(var1.K.bank() ? 1 : 0) && k.llIIIlIIIIIIllI(var2.distanceTo((Locatable)var14), var1.L.m()) && k.llIIIlIIIIIIIIl(var14.isMoving() ? 1 : 0) && k.llIIIlIIIIIIIlI(Inventory.contains(item -> item.getName().contains(this.K.tree().r())) ? 1 : 0)) {
            Log.info((String)lIllIIIIIlIIl[lIllIIIIIlIlI[2]]);
            var2.interact(lIllIIIIIlIIl[lIllIIIIIlIlI[4]]);
            return lIllIIIIIlIlI[2];
        }
        if (k.llIIIlIIIIIIlIl(var2.distanceTo((Locatable)var14), var1.L.m())) {
            return lIllIIIIIlIlI[0];
        }
        if (k.llIIIlIIIIIIIlI(var1.L.b() ? 1 : 0)) {
            var2.interact(lIllIIIIIlIIl[lIllIIIIIlIlI[5]]);
            var1.sleep(lIllIIIIIlIlI[2]);
            return lIllIIIIIlIlI[2];
        }
        return lIllIIIIIlIlI[0];
    }
