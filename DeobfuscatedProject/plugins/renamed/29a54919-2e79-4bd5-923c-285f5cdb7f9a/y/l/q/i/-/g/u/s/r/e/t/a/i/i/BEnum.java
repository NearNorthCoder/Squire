...
import y.l.q.i.-.g.u.s.r.e.t.a.i.i.a_Unknown;
...
extends Enum<b> {
    ...
    public static b b(int n) {
        ...
        int var11 = lIllIIIIIII[1];
        while (b.lIIlIlIIlllIlI(var11, (int)var20)) {
            int var5;
            void var21;
            void var14 = var21[var11];
            if (b.lIIlIlIIlllIll(var14.regionId.contains(var5) ? 1 : 0)) {
                return var14;
            }
            ++var11;
            0;
    ...
    public c k() {
        ...
        int n = cArray.length;
        int var16 = lIllIIIIIII[1];
        while (b.lIIlIlIIlllIlI(var16, (int)var31)) {
            void var27;
            void var32 = var27[var16];
            if (b.lIIlIlIIlllIll(var32.m().a((Locatable)Players.getLocal()) ? 1 : 0)) {
                return var32;
            }
            ++var16;
            0;
        ...
        if (b.lIIlIlIIllllII(var4.getWorldLocation().getPlane(), lIllIIIIIII[2])) {
            return null;
        }
        return c2;
    }
    ...
    private static String lIIlIlIIIlIIIl(String var19, String var2) {
        try {
            ...
            var15.init(lIllIIIIIII[10], var13);
    ...
    private static String lIIlIlIIIIllll(String var26, String var28) {
        try {
            SecretKeySpec var30 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var28.getBytes(StandardCharsets.UTF_8)), lIllIIIIIII[27]), "DES");
            Cipher var3 = Cipher.getInstance("DES");
            var3.init(lIllIIIIIII[10], var30);
            return new String(var3.doFinal(Base64.getDecoder().decode(var26.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static b j() {
        b[] bArray = b.values();
        int var22 = bArray.length - lIllIIIIIII[0];
        while (b.lIIlIlIIllIllI(var22)) {
            void var1;
            void var29 = var1[var22];
            if (b.lIIlIlIIllIlll(var29, (Object)CANIFIS_ROOFTOP) && b.lIIlIlIIlllIII(Quests.isFinished((Quest)Quest.PRIEST_IN_PERIL) ? 1 : 0)) {
                0;
                if (-1 >= 3) {
                    return null;
                }
            } else if (b.lIIlIlIIlllIIl(Skills.getLevel((Skill)Skill.AGILITY), var29.level)) {
                return var29;
            }
            --var22;
            0;
    ...
    private static String lIIlIlIIIlIIII(String var8, String var17) {
        var8 = new String(Base64.getDecoder().decode(var8.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var9 = new StringBuilder();
        char[] var25 = var17.toCharArray();
        int var23 = lIllIIIIIII[1];
        char[] var12 = var8.toCharArray();
        int var18 = var12.length;
        int var10 = lIllIIIIIII[1];
        while (b.lIIlIlIIlllIlI(var10, var18)) {
            char var6 = var12[var10];
            var9.append((char)(var6 ^ var25[var23 % var25.length]));
            0;
            ++var23;
            ++var10;
            0;
