...
implements Locatable {
    ...
    public TileObject r() {
        ...
        } else if (c.lIIlIlIIlIllll(var2.o)) {
            void var3;
            var4 = TileObjects.getNearest((WorldPoint)var3, var2::a);
        }
        if (c.lIIlIlIIlIllll(var4)) {
            tileObject = var4;
            0;
            if (3 == 0) {
                return null;
            ...
            String[] stringArray = new String[lIllIIIIIlI[2]];
            stringArray[c.lIllIIIIIlI[0]] = var2.m;
    ...
    private static void lIIlIlIIlIlIll() {
        ...
        c.lIllIIIIIlI[0] = (60 + 109 - 47 + 25 ^ 21 + 101 - -13 + 22) & (0xC9 ^ 0xAD ^ (0x53 ^ 0x39) ^ -1);
        c.lIllIIIIIlI[1] = 3;
        c.lIllIIIIIlI[2] = 1;
        c.lIllIIIIIlI[3] = -1 & (0xFFFFFFFF & Integer.MAX_VALUE);
    }
