...
extends OverlayPanel {
    ...
    public static String a(double d2) {
        ...
        if (NightmareInfoBox.lIIlIIIlllllIll(NightmareInfoBox.lIIlIIIlllllIlI(var23, 1000.0))) {
            double var6 = var23 / 1000.0;
            if (NightmareInfoBox.lIIlIIIllllllII(NightmareInfoBox.lIIlIIIlllllIlI(var6 % 1.0, 0.0))) {
                Object[] objectArray = new Object[llllIlllIllI[2]];
                objectArray[NightmareInfoBox.llllIlllIllI[1]] = var6;
        ...
        if (NightmareInfoBox.lIIlIIIllllllII(NightmareInfoBox.lIIlIIIlllllIlI(var23 % 1.0, 0.0))) {
            Object[] objectArray = new Object[llllIlllIllI[2]];
            objectArray[NightmareInfoBox.llllIlllIllI[1]] = var23;
    ...
    public Dimension render(Graphics2D graphics2D) {
        String string;
        NightmareInfoBox var2;
        if (NightmareInfoBox.lIIlIIIllllllIl(this.cw.isPaintDisabled() ? 1 : 0)) {
            return null;
        }
        Duration var21 = Duration.between(var2.cw.getStarted(), Instant.now());
        var2.panelComponent.setBorder(new Rectangle(llllIlllIllI[6], llllIlllIllI[6], llllIlllIllI[6], llllIlllIllI[6]));
        var2.panelComponent.getChildren().add(TitleComponent.builder().color(ColorScheme.BRAND_ORANGE).text(llllIlllIIll[llllIlllIllI[7]]).build());
        0;
        var2.panelComponent.getChildren().add(LineComponent.builder().left(llllIlllIIll[llllIlllIllI[8]]).right(Time.format((Duration)var21)).build());
        0;
        var2.panelComponent.getChildren().add(LineComponent.builder().left(llllIlllIIll[llllIlllIllI[9]]).right(llllIlllIIll[llllIlllIllI[10]]).build());
        0;
        var2.panelComponent.getChildren().add(LineComponent.builder().left(llllIlllIIll[llllIlllIllI[11]]).right(var2.cx.getCurrentTask()).build());
        0;
        ...
        if (NightmareInfoBox.lIIlIIIllllllIl(var2.cw.ae() ? 1 : 0)) {
    ...
    private static String lIIlIIIlllIlllI(String var19, String var4) {
        try {
            ...
            var10.init(llllIlllIllI[3], var16);
    ...
    private static String lIIlIIIllllIIIl(String var7, String var20) {
        try {
            SecretKeySpec var11 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var20.getBytes(StandardCharsets.UTF_8)), llllIlllIllI[10]), "DES");
            Cipher var13 = Cipher.getInstance("DES");
            var13.init(llllIlllIllI[3], var11);
    ...
    private static String lIIlIIIlllIllll(String var1, String var18) {
        ...
        int var8 = llllIlllIllI[1];
        char[] var14 = var1.toCharArray();
        int var9 = var14.length;
        int var12 = llllIlllIllI[1];
        while (NightmareInfoBox.lIIlIIIlllllllI(var12, var9)) {
            char var17 = var14[var12];
            var5.append((char)(var17 ^ var22[var8 % var22.length]));
            0;
            ++var8;
            ++var12;
            0;
