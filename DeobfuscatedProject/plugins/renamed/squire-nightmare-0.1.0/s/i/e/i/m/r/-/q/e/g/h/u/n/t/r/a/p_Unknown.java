...
public final class p_Unknown {
    ...
    public static boolean bv() {
        ...
        return Arrays.stream(Static.getClient().getEnum(llllIIIIlIIl[9]).getKeys()).anyMatch(n3 -> {
            ...
            if (p.lIIIlllIlIlIlIl(n3, n2)) {
                ...
                0;
                if (1 > 1) {
                    return ((0xC8 ^ 0x9B ^ (0xF6 ^ 0xA1)) & (18 + 81 - 21 + 96 ^ 10 + 101 - -52 + 7 ^ -1)) != 0;
                }
            } else {
                bl = llllIIIIlIIl[2];
            }
    ...
    public static boolean w(boolean bl) {
        ...
        if (p.lIIIlllIlIllIlI(var3 = p.bu())) {
            boolean var2;
            var3.interact(llllIIIIlIII[llllIIIIlIIl[2]]);
            return Time.sleepUntil(() -> {
                boolean bl2;
                if (p.lIIIlllIlIlIlIl(p.bt() ? 1 : 0, var2 ? 1 : 0)) {
                    bl2 = llllIIIIlIIl[5];
                    0;
                    if (-1 >= ((92 + 63 - 25 + 33 ^ 110 + 83 - 171 + 117) & (0xB9 ^ 0x87 ^ (0x27 ^ 0x31) ^ -1))) {
                        return ((0xCF ^ 0xB6 ^ (0x9C ^ 0xAB)) & (0x92 ^ 0xC7 ^ (0x6A ^ 0x71) ^ -1)) != 0;
                    }
                } else {
                    bl2 = llllIIIIlIIl[2];
                }
    ...
    private static void lIIIlllIlIlIIll() {
        ...
        p.llllIIIIlIII[p.llllIIIIlIIl[2]] = p."Auto retaliate";
        p.llllIIIIlIII[p.llllIIIIlIIl[5]] = p."Auto retaliate";
    }
    ...
    public static boolean bt() {
        ...
        if (p.lIIIlllIlIllIIl(Vars.getVarp((int)llllIIIIlIIl[4]))) {
            ...
            0;
            if (-1 > 2) {
                return ((0xE1 ^ 0x8B ^ (0x78 ^ 0x3D)) & (0xB8 ^ 0xB1 ^ (0x9E ^ 0xB8) ^ -1)) != 0;
            }
        } else {
            bl = llllIIIIlIIl[2];
        }
    ...
    private static String lIIIlllIlIlIIlI(String var6, String var7) {
        try {
            ...
            var1.init(llllIIIIlIIl[17], var8);
    ...
    public static o bq() {
        ...
        r var14 = p.bs();
        if (p.lIIIlllIlIlIllI((Object)var14)) {
            return null;
        }
        return var1_1.bE()[n2];
    }
    ...
    public static r bs() {
        ...
        if (p.lIIIlllIlIlIlll(n2, llllIIIIlIIl[1])) {
            ...
            int var4 = llllIIIIlIIl[2];
            while (p.lIIIlllIlIllIII(var4, (int)var11)) {
                void var5;
                void var13;
                void var12 = var13[var4];
                if (p.lIIIlllIlIlIlIl((int)var5, var12.bD())) {
                    return var12;
                }
                ++var4;
                0;
                if ((8 + 23 - -31 + 70 ^ 88 + 22 - 79 + 97) > ((0xAC ^ 0xA6 ^ (0x50 ^ 0x18)) & (61 + 178 - -2 + 9 ^ 120 + 162 - 247 + 149 ^ -1))) continue;
                return null;
            }
        }
        return null;
