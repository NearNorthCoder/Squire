...
/* TASK: Selling drops (Restocking) -> Sellingdrops(Restocking)Task */
...
extends S_Unknown {
    ...
    public boolean ci() {
        ...
        if (T.lIIlIIIIlllllII(var17.cW.C() ? 1 : 0)) {
            return llllIlIlIlII[0];
        }
        Player var1 = Players.getLocal();
        if (T.lIIlIIIIllllIll(ds.contains(var1.getWorldLocation()) ? 1 : 0)) {
            return llllIlIlIlII[0];
        }
        if (T.lIIlIIIIlllllII(Bank.isOpen() ? 1 : 0) && T.lIIlIIIIllllIll(var17.cl() ? 1 : 0) && T.lIIlIIIIlllllII(var17.cm() ? 1 : 0)) {
            Log.info((String)llllIlIlIIIl[llllIlIlIlII[0]]);
            Object[] objectArray = new Object[llllIlIlIlII[2]];
            objectArray[T.llllIlIlIlII[0]] = var17.cl();
            objectArray[T.llllIlIlIlII[1]] = var17.cm();
            Log.info((String)llllIlIlIIIl[llllIlIlIlII[1]], (Object[])objectArray);
            var17.cW.f(llllIlIlIlII[0]);
            var17.cW.e(llllIlIlIlII[1]);
        ...
        if (T.lIIlIIIIlllllIl(var7)) {
            Log.info((String)llllIlIlIIIl[llllIlIlIlII[3]]);
            if (T.lIIlIIIIlllllII(var17.cm() ? 1 : 0) && T.lIIlIIIIlllllII(GrandExchange.isEmpty() ? 1 : 0)) {
        ...
        if (T.lIIlIIIIllllIll(GrandExchange.isSelling() ? 1 : 0)) {
            ...
            nArray[T.llllIlIlIlII[0]] = var7.getId();
            GrandExchange.sell((int[])nArray);
            0;
            
            }
        } else {
            int var11 = (int)((double)Prices.getItemPrice((int)var7.getId()) * 0.8);
            Log.info((String)("[SellDrops]: Setting price to " + var11 + " GP"));
            GrandExchange.setPrice((int)var11);
    ...
    private static String lIIlIIIIllIlIll(String var4, String var9) {
        var4 = new String(Base64.getDecoder().decode(var4.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var10 = new StringBuilder();
        char[] var2 = var9.toCharArray();
        int var15 = llllIlIlIlII[0];
        char[] var18 = var4.toCharArray();
        int var14 = var18.length;
        int var16 = llllIlIlIlII[0];
        while (T.lIIlIIIIllllllI(var16, var14)) {
            char var19 = var18[var16];
            var10.append((char)(var19 ^ var2[var15 % var2.length]));
            0;
            ++var15;
            ++var16;
            0;
    ...
    private static String lIIlIIIIllIllIl(String var8, String var22) {
        try {
    ...
    private static String lIIlIIIIlllIIIl(String var21, String var20) {
        try {
            SecretKeySpec var12 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var20.getBytes(StandardCharsets.UTF_8)), llllIlIlIlII[7]), "DES");
            Cipher var13 = Cipher.getInstance("DES");
            var13.init(llllIlIlIlII[2], var12);
