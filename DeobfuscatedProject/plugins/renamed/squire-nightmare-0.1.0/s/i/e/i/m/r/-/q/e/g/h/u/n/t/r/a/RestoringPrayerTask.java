...
extends Task {
    ...
    public boolean run() {
        ...
        if (ar.lIIIllllllIlllI(var2.ep.aq() ? 1 : 0)) {
            return llllIIllIIII[0];
        }
        ...
        if (ar.lIIIllllllIllll(Prayers.getPoints(), var2.eo.restorePrayerAt())) {
            return llllIIllIIII[0];
        }
        if (ar.lIIIlllllllIIII(var1)) {
            return llllIIllIIII[0];
        }
    ...
    private static String lIIIllllllIIlll(String var10, String var11) {
        try {
            ...
            var8.init(llllIIllIIII[3], var12);
    ...
    private static String lIIIllllllIIlIl(String var3, String var9) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var9.getBytes(StandardCharsets.UTF_8)), llllIIllIIII[5]), "DES");
            Cipher var7 = Cipher.getInstance("DES");
            var7.init(llllIIllIIII[3], var5);
