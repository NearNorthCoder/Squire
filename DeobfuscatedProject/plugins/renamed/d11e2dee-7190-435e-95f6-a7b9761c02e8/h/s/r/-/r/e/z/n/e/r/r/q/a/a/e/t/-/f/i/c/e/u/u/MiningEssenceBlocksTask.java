...
/* TASK: Mining Essence Blocks -> MiningessenceblocksTask */
...
extends Task {
    ...
    private static String llIIIllIlIllIll(String var5, String var4) {
        try {
            ...
            var3.init(lIllIIllIllII[19], var1);
    ...
    private static void llIIIllIllIIIII() {
        ...
        g.lIllIIllIllII[0] = (0x2A ^ 0x5C ^ (0xEA ^ 0x82)) & (54 + 104 - 144 + 203 ^ 69 + 21 - 46 + 155 ^ -1);
        g.lIllIIllIllII[1] = 1;
        ...
        g.lIllIIllIllII[12] = -2 & (0xFFFFD7AF & 0x2EFF);
    ...
    private static void llIIIllIlIlllII() {
        ...
        g.lIllIIllIlIlI[g.lIllIIllIllII[0]] = g."Chip";
        g.lIllIIllIlIlI[g.lIllIIllIllII[1]] = g."Climb";
    }
