...
/* TASK: Creating Dark Essence -> CreatingdarkessenceTask */
...
extends Task {
    ...
    private static String llIIIllIllIllIl(String var2, String var6) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var6.getBytes(StandardCharsets.UTF_8)), lIllIIlllIIIl[7]), "DES");
            Cipher var1 = Cipher.getInstance("DES");
            var1.init(lIllIIlllIIIl[8], var5);
