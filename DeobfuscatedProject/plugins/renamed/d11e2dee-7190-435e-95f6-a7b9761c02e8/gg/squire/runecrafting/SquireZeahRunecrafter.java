...
import h.s.r.-.r.e.z.n.e.r.r.q.a.a.e.t.-.f.i.c.e.u.u.ActivatingBloodEssenceTask;
import h.s.r.-.r.e.z.n.e.r.r.q.a.a.e.t.-.f.i.c.e.u.u.BreakingEssenceBlocksTask;
import h.s.r.-.r.e.z.n.e.r.r.q.a.a.e.t.-.f.i.c.e.u.u.CraftingBloodRunesTask;
import h.s.r.-.r.e.z.n.e.r.r.q.a.a.e.t.-.f.i.c.e.u.u.CreatingDarkEssenceTask;
import h.s.r.-.r.e.z.n.e.r.r.q.a.a.e.t.-.f.i.c.e.u.u.InitializationTask;
import h.s.r.-.r.e.z.n.e.r.r.q.a.a.e.t.-.f.i.c.e.u.u.MiningEssenceBlocksTask;
...
extends SquirePlugin {
    ...
    private static void llIIIllIlIllIII() {
        ...
        SquireZeahRunecrafter.lIllIIllIlIIl[1] = (8 + 89 - 36 + 170 ^ 65 + 166 - 221 + 177) & (0x81 ^ 0xA6 ^ (9 ^ 0x72) ^ -1);
        SquireZeahRunecrafter.lIllIIllIlIIl[2] = 1;
        SquireZeahRunecrafter.lIllIIllIlIIl[3] = 2;
        SquireZeahRunecrafter.lIllIIllIlIIl[4] = 3;
        SquireZeahRunecrafter.lIllIIllIlIIl[5] = 0xA6 ^ 0xA2;
        SquireZeahRunecrafter.lIllIIllIlIIl[6] = 0xC3 ^ 0x90 ^ (0x20 ^ 0x76);
        SquireZeahRunecrafter.lIllIIllIlIIl[7] = -1;
    ...
    public void a(InventoryChanged inventoryChanged) {
        ...
        if (SquireZeahRunecrafter.llIIIllIlIllIIl(inventoryChanged.getChangeType().equals((Object)InventoryChanged.ChangeType.ITEM_REMOVED) ? 1 : 0)) {
            ...
            if (SquireZeahRunecrafter.llIIIllIlIllIlI(var1.getItemId(), lIllIIllIlIIl[9])) {
                var2.d.c(var2.d.j() + lIllIIllIlIIl[5]);
            }
        }
        if (SquireZeahRunecrafter.llIIIllIlIllIIl(var1.getChangeType().equals((Object)InventoryChanged.ChangeType.ITEM_ADDED) ? 1 : 0) && SquireZeahRunecrafter.llIIIllIlIllIlI(var1.getItemId(), lIllIIllIlIIl[10])) {
            var2.a(var2.b() + var1.getAmount());
            var2.b(var2.c() + Prices.getItemPrice((int)var1.getItemId()) * var1.getAmount());
        }
    }
