...
extends Enum<p> {
    ...
    private static String llIIIllllIlIIll(String var2, String var10) {
        ...
        int var8 = lIllIlIIlIlIl[0];
        char[] var14 = var2.toCharArray();
        int var11 = var14.length;
        int var5 = lIllIlIIlIlIl[0];
        while (p.llIIIllllIlIlll(var5, var11)) {
            char var4 = var14[var5];
            var7.append((char)(var4 ^ var3[var8 % var3.length]));
            0;
            ++var8;
            ++var5;
            0;
    ...
    private static String llIIIllllIlIIlI(String var9, String var12) {
        try {
            SecretKeySpec var6 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var12.getBytes(StandardCharsets.UTF_8)), lIllIlIIlIlIl[10]), "DES");
            Cipher var1 = Cipher.getInstance("DES");
            var1.init(lIllIlIIlIlIl[5], var6);
