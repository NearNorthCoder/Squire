...
extends Overlay {
    ...
    public Dimension render(Graphics2D graphics2D) {
        ...
        if (x.llIIlIIIIIIlIlI(var2.P.isInInstancedRegion() ? 1 : 0)) {
            return null;
        }
        WorldPoint var4 = var2.R.X();
        if (x.llIIlIIIIIIlIll(var4)) {
            return null;
        }
        LocalPoint var1 = LocalPoint.fromWorld((Client)var2.P, (WorldPoint)var2.R.V().C().a(var4));
        LocalPoint var3 = LocalPoint.fromWorld((Client)var2.P, (WorldPoint)var2.R.X());
        if (!x.llIIlIIIIIIllII(var3) || x.llIIlIIIIIIlIll(var1)) {
            return null;
        }
