...
public abstract class P_Unknown
extends Task {
    ...
    protected boolean ah() {
        ...
        int var1 = lIllIllIlIIlI[1];
        while (P.llIIlIIlIIIlIII(var1, (int)var4)) {
            void var2;
            void var3 = var2[var1];
            if (P.llIIlIIlIIIlIIl((int)var3, lIllIllIlIIlI[2])) {
                return lIllIllIlIIlI[0];
            }
            ++var1;
            0;
            if (((0xFC ^ 0x8C ^ (0x61 ^ 0x2A)) & (0x95 ^ 0xAF ^ 1 ^ -1)) <= 1) continue;
            return ((0x79 ^ 0x2A ^ 22 + 41 - -58 + 6) & (0x33 ^ 0x36 ^ (0x6F ^ 0x46) ^ -1)) != 0;
        }
