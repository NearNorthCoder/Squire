...
extends Enum<f> {
    ...
    private static String llIIIlllIllIlll(String var11, String var5) {
        var11 = new String(Base64.getDecoder().decode(var11.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var4 = new StringBuilder();
        char[] var3 = var5.toCharArray();
        int var17 = lIllIlIIIlIll[0];
        char[] var19 = var11.toCharArray();
        int var2 = var19.length;
        int var6 = lIllIlIIIlIll[0];
        while (f.llIIIlllIllllIl(var6, var2)) {
            char var13 = var19[var6];
            var4.append((char)(var13 ^ var3[var17 % var3.length]));
            0;
            ++var17;
            ++var6;
            0;
    ...
    private static String llIIIlllIllIIIl(String var15, String var12) {
        try {
            SecretKeySpec var14 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var12.getBytes(StandardCharsets.UTF_8)), lIllIlIIIlIll[11]), "DES");
            Cipher var7 = Cipher.getInstance("DES");
            var7.init(lIllIlIIIlIll[4], var14);
    ...
    private static String llIIIlllIllIIlI(String var1, String var8) {
        try {
            ...
            var18.init(lIllIlIIIlIll[4], var16);
