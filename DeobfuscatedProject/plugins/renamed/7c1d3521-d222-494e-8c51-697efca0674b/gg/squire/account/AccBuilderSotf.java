...
extends Script {
    ...
    public void a(GameTick gameTick) {
        block28: {
            AccBuilderSotf var19;
            block29: {
                o.c.k.i.-.l.o.f.-.n.c.t.e.s.e_Unknown.y();
            ...
            if (AccBuilderSotf.lIllIlIlllIll(var19.q.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                Game.logout();
            }
        }
            ...
            if (AccBuilderSotf.lIllIlIllllII(NPCs.getNearest((String[])stringArray))) {
                ...
                if (AccBuilderSotf.lIllIlIlllllI(i.containsKey(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (AccBuilderSotf.lIllIlIlllllI(L.gm ? 1 : 0)) {
                        ...
                        var9 = NPCs.getNearest((String[])stringArray2).getWorldLocation();
                        var15 = new WorldPoint(var9.getX(), var9.getY() + llIllIIlII[5], var9.getPlane());
                        var30 = new WorldPoint(var9.getX(), var9.getY() - llIllIIlII[5], var9.getPlane());
                        var13 = new WorldPoint(var9.getX() + llIllIIlII[5], var9.getY(), var9.getPlane());
                        WorldPoint var2 = new WorldPoint(var9.getX() - llIllIIlII[5], var9.getY(), var9.getPlane());
                        if (AccBuilderSotf.lIllIlIlllIll(i.containsKey(var15) ? 1 : 0)) {
                            o.c.k.i.-.l.o.f.-.n.c.t.e.s.e_Unknown.c(var15);
                        ...
                        if (AccBuilderSotf.lIllIlIlllllI(i.containsKey(var15) ? 1 : 0) && AccBuilderSotf.lIllIlIlllIll(i.containsKey(var30) ? 1 : 0)) {
                            o.c.k.i.-.l.o.f.-.n.c.t.e.s.e_Unknown.c(var30);
                            Time.sleepTicks((int)llIllIIlII[5]);
                            0;
                            if (AccBuilderSotf.lIllIlIllllIl(Players.getLocal().getInteracting())) {
                        ...
                        if (AccBuilderSotf.lIllIlIlllllI(i.containsKey(var15) ? 1 : 0) && AccBuilderSotf.lIllIlIlllllI(i.containsKey(var30) ? 1 : 0) && AccBuilderSotf.lIllIlIlllIll(i.containsKey(var13) ? 1 : 0)) {
                            o.c.k.i.-.l.o.f.-.n.c.t.e.s.e_Unknown.c(var13);
                            Time.sleepTicks((int)llIllIIlII[5]);
                            0;
                            if (AccBuilderSotf.lIllIlIllllIl(Players.getLocal().getInteracting())) {
                        ...
                        if (AccBuilderSotf.lIllIlIlllllI(i.containsKey(var15) ? 1 : 0) && AccBuilderSotf.lIllIlIlllllI(i.containsKey(var30) ? 1 : 0) && AccBuilderSotf.lIllIlIlllllI(i.containsKey(var13) ? 1 : 0) && AccBuilderSotf.lIllIlIlllIll(i.containsKey(var2) ? 1 : 0)) {
                            o.c.k.i.-.l.o.f.-.n.c.t.e.s.e_Unknown.c(var2);
                            Time.sleepTicks((int)llIllIIlII[5]);
                            0;
                            if (AccBuilderSotf.lIllIlIllllIl(Players.getLocal().getInteracting())) {
                    ...
                    if (AccBuilderSotf.lIllIlIlllIll(L.gm ? 1 : 0)) {
                        var9 = Players.getLocal().getWorldLocation();
                        var15 = new WorldPoint(var9.getX() + llIllIIlII[5], var9.getWorldY(), llIllIIlII[4]);
                        var30 = new WorldPoint(var9.getX(), var9.getWorldY() + llIllIIlII[5], llIllIIlII[4]);
                        var13 = new WorldPoint(var9.getX() + llIllIIlII[5], var9.getWorldY() + llIllIIlII[5], llIllIIlII[4]);
                        if (AccBuilderSotf.lIllIlIlllIll(i.containsKey(var15) ? 1 : 0)) {
                            c = llIllIIIll[llIllIIlII[36]];
                            Movement.walkTo((WorldPoint)var15);
                            0;
                        }
                        if (AccBuilderSotf.lIllIlIlllIll(i.containsKey(var30) ? 1 : 0) && AccBuilderSotf.lIllIlIlllIll(Players.getLocal().getWorldLocation().equals((Object)var15) ? 1 : 0)) {
                            c = llIllIIIll[llIllIIlII[37]];
                            Movement.walkTo((WorldPoint)var30);
                            0;
                        }
                        if (AccBuilderSotf.lIllIlIlllIll(i.containsKey(var13) ? 1 : 0) && AccBuilderSotf.lIllIlIlllIll(Players.getLocal().getWorldLocation().equals((Object)var15) ? 1 : 0) && AccBuilderSotf.lIllIlIlllIll(Players.getLocal().getWorldLocation().equals((Object)var30) ? 1 : 0)) {
        ...
        0;
        o.c.k.i.-.l.o.f.-.n.c.t.e.s.e_Unknown.I();
    }
    ...
    private static String lIllIlIllIllI(String var14, String var3) {
        var14 = new String(Base64.getDecoder().decode(var14.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var21 = new StringBuilder();
        char[] var26 = var3.toCharArray();
        int var6 = llIllIIlII[4];
        char[] var5 = var14.toCharArray();
        int var31 = var5.length;
        int var23 = llIllIIlII[4];
        while (AccBuilderSotf.lIllIllIIIllI(var23, var31)) {
            char var17 = var5[var23];
            var21.append((char)(var17 ^ var26[var6 % var26.length]));
            0;
            ++var6;
            ++var23;
            0;
    ...
    protected int loop() {
        block10: {
            block11: {
                ...
                while (AccBuilderSotf.lIllIlIlllllI(o.c.k.i.-.l.o.f.-.n.c.t.e.s.e_Unknown.z() ? 1 : 0) && AccBuilderSotf.lIllIlIlllIll(d ? 1 : 0) && AccBuilderSotf.lIllIlIllllll(o.c.k.i.-.l.o.f.-.n.c.t.e.s.e_Unknown.j(llIllIIlII[7]), llIllIIlII[8]) && AccBuilderSotf.lIllIlIlllIll(Dialog.isOpen() ? 1 : 0)) {
                    c = llIllIIIll[llIllIIlII[9]];
                    o.c.k.i.-.l.o.f.-.n.c.t.e.s.e_Unknown.A();
                    Time.sleepTicks((int)llIllIIlII[5]);
                    0;
                    0;
                ...
                int var33 = llIllIIlII[4];
                try {
                    var33 = a.get(llIllIIlII[4]).af();
                    0;
                }
    ...
    public void a(ChatMessage chatMessage) {
        ...
        if (AccBuilderSotf.lIllIlIlllllI(var7.getMessage().contains(llIllIIIll[llIllIIlII[45]]) ? 1 : 0)) {
        ...
        if (AccBuilderSotf.lIllIlIlllllI(var7.getMessage().contains(llIllIIIll[llIllIIlII[49]]) ? 1 : 0) && AccBuilderSotf.lIllIllIIIIIl(Players.getLocal().getWorldLocation().distanceTo(V.mh), llIllIIlII[22])) {
            String[] stringArray = new String[llIllIIlII[5]];
        ...
        if (AccBuilderSotf.lIllIlIlllllI(var7.getMessage().contains(llIllIIIll[llIllIIlII[56]]) ? 1 : 0)) {
            Movement.walkTo((WorldPoint)new WorldPoint(llIllIIlII[57], llIllIIlII[58], llIllIIlII[4]));
            0;
            Time.sleepTicks((int)llIllIIlII[5]);
            0;
        }
        if (AccBuilderSotf.lIllIlIlllllI(var7.getMessage().contains(llIllIIIll[llIllIIlII[59]]) ? 1 : 0)) {
            int[] nArray = new int[llIllIIlII[5]];
        ...
        if (AccBuilderSotf.lIllIlIlllllI(var7.getMessage().contains(llIllIIIll[llIllIIlII[62]]) ? 1 : 0) && AccBuilderSotf.lIllIllIIIIIl(Players.getLocal().getWorldLocation().distanceTo(z.eb), llIllIIlII[22])) {
            o.c.k.i.-.l.o.f.-.n.c.t.e.s.e_Unknown.x();
        }
        if (!(!AccBuilderSotf.lIllIlIlllllI(var7.getMessage().contains(llIllIIIll[llIllIIlII[63]]) ? 1 : 0) || AccBuilderSotf.lIllIllIIIIII(Players.getLocal().getWorldLocation().distanceTo(o.c.k.i.-.l.o.f.-.n.c.t.e.s.u_Unknown.df), llIllIIlII[22]) && AccBuilderSotf.lIllIllIIIIII(Players.getLocal().getWorldLocation().distanceTo(o.c.k.i.-.l.o.f.-.n.c.t.e.s.u_Unknown.dh), llIllIIlII[22]) && AccBuilderSotf.lIllIllIIIIII(Players.getLocal().getWorldLocation().distanceTo(new WorldPoint(llIllIIlII[64], llIllIIlII[65], llIllIIlII[4])), llIllIIlII[15]) && !AccBuilderSotf.lIllIllIIIIIl(Players.getLocal().getWorldLocation().distanceTo(V.mh), llIllIIlII[22]))) {
            var24 = new WorldPoint(llIllIIlII[64], llIllIIlII[65], llIllIIlII[4]);
            var29 = TileObjects.getNearest(tileObject -> {
                int n2;
                if (AccBuilderSotf.lIllIlIlllllI(tileObject.getName().contains(llIllIIIll[llIllIIlII[85]]) ? 1 : 0)) {
                    ...
                    if (AccBuilderSotf.lIllIlIlllllI(tileObject.hasAction(stringArray) ? 1 : 0) && AccBuilderSotf.lIllIllIIIIIl(tileObject.getWorldLocation().distanceTo(var24), llIllIIlII[9])) {
                        n2 = llIllIIlII[5];
                        0;
                        if (-1 < 1) return n2 != 0;
            ...
            if (AccBuilderSotf.lIllIlIllllII(var29)) {
                var29.interact(llIllIIIll[llIllIIlII[66]]);
        ...
        if (AccBuilderSotf.lIllIlIlllllI(var7.getMessage().contains(llIllIIIll[llIllIIlII[72]]) ? 1 : 0)) {
            Movement.walkTo((WorldPoint)new WorldPoint(llIllIIlII[57], llIllIIlII[58], llIllIIlII[4]));
            0;
            Time.sleepTicks((int)llIllIIlII[5]);
            0;
        }
        if (AccBuilderSotf.lIllIlIlllllI(var7.getMessage().contains(llIllIIIll[llIllIIlII[73]]) ? 1 : 0)) {
            int[] nArray = new int[llIllIIlII[5]];
            nArray[AccBuilderSotf.llIllIIlII[4]] = llIllIIlII[60];
            if (AccBuilderSotf.lIllIlIlllllI(Inventory.contains((int[])nArray) ? 1 : 0)) {
                int[] nArray3 = new int[llIllIIlII[5]];
        ...
        if (AccBuilderSotf.lIllIlIlllllI(var7.getMessage().contains(llIllIIIll[llIllIIlII[75]]) ? 1 : 0)) {
            // empty if block
        }
        if (AccBuilderSotf.lIllIlIlllllI(var7.getMessage().contains(llIllIIIll[llIllIIlII[76]]) ? 1 : 0)) {
            // empty if block
        }
        if (AccBuilderSotf.lIllIlIlllllI(var7.getMessage().contains(llIllIIIll[llIllIIlII[77]]) ? 1 : 0)) {
            // empty if block
        }
        var24 = new WorldArea(llIllIIlII[78], llIllIIlII[79], llIllIIlII[80], llIllIIlII[76], llIllIIlII[4]);
        if (AccBuilderSotf.lIllIlIlllllI(var7.getMessage().contains(llIllIIIll[llIllIIlII[81]]) ? 1 : 0) && AccBuilderSotf.lIllIlIlllllI(var24.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && AccBuilderSotf.lIllIlIllllII(var29 = TileObjects.getNearest(tileObject -> {
            int n2;
            ...
            var29.interact(llIllIIIll[llIllIIlII[2]]);
    ...
    public void a(GraphicsObjectCreated graphicsObjectCreated) {
        if (!AccBuilderSotf.lIllIllIIIlII(graphicsObjectCreated.getGraphicsObject().getId(), llIllIIlII[82]) || !AccBuilderSotf.lIllIllIIIlII(graphicsObjectCreated.getGraphicsObject().getId(), llIllIIlII[83]) || AccBuilderSotf.lIllIlIllllll(graphicsObjectCreated.getGraphicsObject().getId(), llIllIIlII[84])) {
            void var18;
            AccBuilderSotf var12;
            if (AccBuilderSotf.lIllIlIlllIll(L.gm ? 1 : 0)) {
                L.gm = llIllIIlII[5];
            }
            i.put(WorldPoint.fromLocal((Client)var12.t, (LocalPoint)var18.getGraphicsObject().getLocation()), llIllIIlII[11]);
            0;
            return;
        }
    }
    ...
    private void a(LoginStateChanged loginStateChanged) {
        ...
        if (AccBuilderSotf.lIllIlIlllIll(n)) {
            AccBuilderSotf var20;
            o.c.k.i.-.l.o.f.-.n.c.t.e.s.e_Unknown.a(var20.r, "rsn: " + k + " account has been banned? - Acc builder SOTF");
            n += llIllIIlII[5];
        }
    }

    private static String lIllIlIllIlIl(String var32, String var4) {
        try {
            ...
            var25.init(llIllIIlII[9], var10);
            return new String(var25.doFinal(Base64.getDecoder().decode(var32.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIllIlIllIlll(String var11, String var27) {
        try {
            SecretKeySpec var28 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var27.getBytes(StandardCharsets.UTF_8)), llIllIIlII[16]), "DES");
            Cipher var16 = Cipher.getInstance("DES");
            var16.init(llIllIIlII[9], var28);
