...
implements ac {
    ...
    private static void lIIllllllIlll() {
        ...
        X.lIllllIlIl[0] = (0xAF ^ 0x99 ^ (0xB7 ^ 0x95)) & (0x14 ^ 0x65 ^ (0xF6 ^ 0x93) ^ -1);
        X.lIllllIlIl[1] = 1;
    ...
    private static String lIIllllllIIlI(String var11, String var19) {
        var11 = new String(Base64.getDecoder().decode(var11.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var7 = new StringBuilder();
        char[] var1 = var19.toCharArray();
        int var2 = lIllllIlIl[0];
        char[] var15 = var11.toCharArray();
        int var18 = var15.length;
        int var12 = lIllllIlIl[0];
        while (X.lIIllllllllIl(var12, var18)) {
            char var14 = var15[var12];
            var7.append((char)(var14 ^ var1[var2 % var1.length]));
            0;
            ++var2;
            ++var12;
            0;
    ...
    private static void lIIllllllIlIl() {
        ...
        X.lIllllIlII[X.lIllllIlIl[0]] = X."Buying items";
        X.lIllllIlII[X.lIllllIlIl[1]] = X."Finished buying items, switching back to questing";
        X.lIllllIlII[X.lIllllIlIl[3]] = X."Navigating to bank";
        X.lIllllIlII[X.lIllllIlIl[4]] = X."Opening bank";
        X.lIllllIlII[X.lIllllIlIl[6]] = X."Handling banking";
        X.lIllllIlII[X.lIllllIlIl[9]] = X."We are missing supplies, switching to BUYING";
        X.lIllllIlII[X.lIllllIlIl[12]] = X."We are missing supplies, switching to BUYING";
        X.lIllllIlII[X.lIllllIlIl[14]] = X."We are missing supplies, switching to BUYING";
        X.lIllllIlII[X.lIllllIlIl[16]] = X."We are missing supplies, switching to BUYING";
        X.lIllllIlII[X.lIllllIlIl[18]] = X."We are missing supplies, switching to BUYING";
        X.lIllllIlII[X.lIllllIlIl[8]] = X."We are missing supplies, switching to BUYING";
        X.lIllllIlII[X.lIllllIlIl[19]] = X."Walking to imp start";
        X.lIllllIlII[X.lIllllIlIl[32]] = X."Magic Portal";
        X.lIllllIlII[X.lIllllIlIl[33]] = X."Enter";
        X.lIllllIlII[X.lIllllIlIl[34]] = X."Handling quest";
        X.lIllllIlII[X.lIllllIlIl[31]] = X."Nav to start";
        X.lIllllIlII[X.lIllllIlIl[35]] = X."Finishing quest";
        X.lIllllIlII[X.lIllllIlIl[36]] = X."Adding red bead to buy list";
        X.lIllllIlII[X.lIllllIlIl[38]] = X."Adding yellow bead to buy list";
        X.lIllllIlII[X.lIllllIlIl[40]] = X."Adding black bead to buy list";
        X.lIllllIlII[X.lIllllIlIl[30]] = X."Adding white bead to buy list";
        X.lIllllIlII[X.lIllllIlIl[41]] = X."Adding lobster to buy list";
        X.lIllllIlII[X.lIllllIlIl[44]] = X."Adding lobster to buy list";
        X.lIllllIlII[X.lIllllIlIl[46]] = X."Adding cheese to buy list";
        X.lIllllIlII[X.lIllllIlIl[48]] = X."Adding cheese to buy list";
        X.lIllllIlII[X.lIllllIlIl[49]] = X."Adding wealth to buy list";
        X.lIllllIlII[X.lIllllIlIl[52]] = X."Adding varrock tabs to buy list";
        X.lIllllIlII[X.lIllllIlIl[54]] = X."Adding fally tabs to buy list";
        X.lIllllIlII[X.lIllllIlIl[55]] = X."Adding fally tabs to buy list";
        X.lIllllIlII[X.lIllllIlIl[56]] = X."Adding staminas to buy list";
        X.lIllllIlII[X.lIllllIlIl[57]] = X."Adding mind runes to buy list";
        X.lIllllIlII[X.lIllllIlIl[60]] = X."Adding air runes to buy list";
        X.lIllllIlII[X.lIllllIlIl[61]] = X."Adding water runes to buy list";
        X.lIllllIlII[X.lIllllIlIl[62]] = X."Adding earth runes to buy list";
        X.lIllllIlII[X.lIllllIlIl[63]] = X."Adding air runes to buy list";
        X.lIllllIlII[X.lIllllIlIl[64]] = X."Adding water runes to buy list";
        X.lIllllIlII[X.lIllllIlIl[65]] = X."Adding earth runes to buy list";
        X.lIllllIlII[X.lIllllIlIl[66]] = X."Adding mind runes to buy list";
        X.lIllllIlII[X.lIllllIlIl[67]] = X."Red bead";
        X.lIllllIlII[X.lIllllIlIl[68]] = X."Yellow bead";
        X.lIllllIlII[X.lIllllIlIl[45]] = X."Black bead";
        X.lIllllIlII[X.lIllllIlIl[69]] = X."White bead";
        X.lIllllIlII[X.lIllllIlIl[70]] = X."Cheese";
        X.lIllllIlII[X.lIllllIlIl[71]] = X."Navigating to bank";
        X.lIllllIlII[X.lIllllIlIl[72]] = X."Opening bank";
        X.lIllllIlII[X.lIllllIlIl[73]] = X."Handling banking";
        X.lIllllIlII[X.lIllllIlIl[74]] = X."Mind rune";
        X.lIllllIlII[X.lIllllIlIl[75]] = X."Mind rune";
        X.lIllllIlII[X.lIllllIlIl[76]] = X."We are missing supplies, switching to BUYING";
        X.lIllllIlII[X.lIllllIlIl[77]] = X."Earth rune";
        X.lIllllIlII[X.lIllllIlIl[78]] = X."Earth rune";
        X.lIllllIlII[X.lIllllIlIl[79]] = X."We are missing supplies, switching to BUYING";
        X.lIllllIlII[X.lIllllIlIl[80]] = X."Water rune";
        X.lIllllIlII[X.lIllllIlIl[81]] = X."Water rune";
        X.lIllllIlII[X.lIllllIlIl[82]] = X."We are missing supplies, switching to BUYING";
        X.lIllllIlII[X.lIllllIlIl[83]] = X."We are missing supplies, switching to BUYING";
        X.lIllllIlII[X.lIllllIlIl[84]] = X."Imp Catcher quest";
        X.lIllllIlII[X.lIllllIlIl[85]] = X."ring of wealth (";
        X.lIllllIlII[X.lIllllIlIl[89]] = X."Wizard Mizgog";
        X.lIllllIlII[X.lIllllIlIl[90]] = X."Give me a quest please.";
        X.lIllllIlII[X.lIllllIlIl[91]] = X."I'll try.";
        X.lIllllIlII[X.lIllllIlIl[92]] = X."Actually, I know where to find this stuff.";
        X.lIllllIlII[X.lIllllIlIl[93]] = X."Yes.";
        X.lIllllIlII[X.lIllllIlIl[94]] = X."What's the matter?";
        X.lIllllIlII[X.lIllllIlIl[95]] = X."Ok, I'll see what I can do.";
    }
    ...
    private static void dA() {
        ...
        if (X.lIIllllllllll(var4) && X.lIIllllllllII(var4.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (X.lIIllllllllIl(Inventory.getCount((int[])nArray3), lIllllIlIl[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (X.lIlIIIIIIIIII(Inventory.getCount((int[])nArray))) {
                                ...
                                0;
                                if (-1 >= 2) {
                                    return ((0x3F ^ 0x76 ^ (0x99 ^ 0x8C)) & (4 + 224 - 120 + 136 ^ 140 + 86 - 130 + 72 ^ -1)) != 0;
                                }
                            } else {
                                bl = lIllllIlIl[0];
                            }
                    ...
                    if (X.lIIllllllllIl(Inventory.getCount((int[])nArray7), lIllllIlIl[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (X.lIlIIIIIIIIII(Inventory.getCount((int[])nArray))) {
                                bl = lIllllIlIl[1];
                                0;
                                if (((0x76 ^ 0x6F ^ (5 ^ 0x22)) & (71 + 163 - 78 + 97 ^ 76 + 64 - 138 + 193 ^ -1)) != 0) {
                                    return ((0x41 ^ 3 ^ (0x23 ^ 0x65)) & (58 + 114 - 133 + 108 ^ 63 + 92 - 74 + 70 ^ -1)) != 0;
                                }
                            } else {
                                bl = lIllllIlIl[0];
                            }
                    ...
                    if (X.lIIllllllllIl(Inventory.getCount((int[])nArray19), lIllllIlIl[1])) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (X.lIlIIIIIIIIII(Inventory.getCount((int[])nArray))) {
                                bl = lIllllIlIl[1];
                                0;
                                if ((0x7A ^ 0x37 ^ (7 ^ 0x4E)) < -1) {
                                    return ((30 + 123 - 27 + 4 ^ 129 + 134 - 153 + 87) & (0x1C ^ 0x7F ^ (0x51 ^ 0x75) ^ -1)) != 0;
                                }
                            } else {
                                bl = lIllllIlIl[0];
                            }
    ...
    private static void Q() {
            ...
            block36: {
                block35: {
                    block34: {
                        ...
                        block33: {
                            block32: {
                                ...
                                if (X.lIIlllllllllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                                    ...
                                    var20 = new d(lIllllIlIl[22], lIllllIlIl[1], lIllllIlIl[39]);
                                    bv.add((d)var20);
                                    0;
                                }
                                int[] nArray3 = new int[lIllllIlIl[1]];
                                ...
                                if (X.lIIlllllllllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
                                    ...
                                    var20 = new d(lIllllIlIl[23], lIllllIlIl[1], lIllllIlIl[39]);
                                    bv.add((d)var20);
                                    0;
                                }
                                int[] nArray4 = new int[lIllllIlIl[1]];
                                ...
                                if (X.lIIlllllllllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
                                    ...
                                    var20 = new d(lIllllIlIl[24], lIllllIlIl[1], lIllllIlIl[39]);
                                    bv.add((d)var20);
                                    0;
                                }
                                int[] nArray5 = new int[lIllllIlIl[1]];
                                ...
                                if (X.lIIlllllllllI(Bank.contains((int[])nArray5) ? 1 : 0)) {
                                    ...
                                    var20 = new d(lIllllIlIl[25], lIllllIlIl[42], lIllllIlIl[43]);
                                    bv.add((d)var20);
                                    0;
                                }
                                int[] nArray6 = new int[lIllllIlIl[1]];
                                ...
                                if (X.lIIllllllllII(Bank.contains((int[])nArray6) ? 1 : 0)) {
                                    ...
                                    if (X.lIIllllllllIl(Bank.getFirst((int[])nArray7).getQuantity(), lIllllIlIl[30])) {
                                        ...
                                        var20 = new d(lIllllIlIl[25], lIllllIlIl[45], lIllllIlIl[43]);
                                        bv.add((d)var20);
                                        0;
                                    }
                                }
                                ...
                                if (X.lIIlllllllllI(Bank.contains((int[])nArray8) ? 1 : 0)) {
                                    ...
                                    var20 = new d(lIllllIlIl[17], lIllllIlIl[9], lIllllIlIl[47]);
                                    bv.add((d)var20);
                                    0;
                                }
                                int[] nArray9 = new int[lIllllIlIl[1]];
                        ...
                        if (X.lIIlllllllllI(Bank.contains((Predicate)(var20 = item -> item.getName().toLowerCase().contains(lIllllIlII[lIllllIlIl[85]]))) ? 1 : 0)) {
                            System.out.println(lIllllIlII[lIllllIlIl[49]]);
                            var5 = new d(lIllllIlIl[50], lIllllIlIl[38], lIllllIlIl[51]);
                            bv.add(var5);
                            0;
                        }
                        int[] nArray = new int[lIllllIlIl[1]];
                    ...
                    var5 = new d(lIllllIlIl[20], lIllllIlIl[45], lIllllIlIl[53]);
                    bv.add(var5);
                    0;
                }
                int[] nArray = new int[lIllllIlIl[1]];
                ...
                if (X.lIIlllllllllI(Bank.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    var5 = new d(lIllllIlIl[7], lIllllIlIl[30], lIllllIlIl[53]);
                    bv.add(var5);
                    0;
                }
                int[] nArray14 = new int[lIllllIlIl[1]];
        ...
        if (X.lIIlllllllllI(Bank.contains((int[])nArray) ? 1 : 0)) {
            ...
            var5 = new d(lIllllIlIl[27], lIllllIlIl[9], j.cf);
            bv.add(var5);
            0;
        }
        int[] nArray17 = new int[lIllllIlIl[1]];
        ...
        if (X.lIIllllllllII(Bank.contains((int[])nArray17) ? 1 : 0)) {
            ...
            if (X.lIIllllllllIl(Bank.getFirst((int[])nArray18).getQuantity(), lIllllIlIl[11])) {
                ...
                var5 = new d(lIllllIlIl[10], lIllllIlIl[58], lIllllIlIl[14]);
                bv.add(var5);
                0;
            }
        }
        ...
        if (X.lIIllllllllII(Bank.contains((int[])nArray19) ? 1 : 0)) {
            ...
            if (X.lIIllllllllIl(Bank.getFirst((int[])nArray20).getQuantity(), lIllllIlIl[11])) {
                ...
                var5 = new d(lIllllIlIl[59], lIllllIlIl[58], lIllllIlIl[14]);
                bv.add(var5);
                0;
            }
        }
        ...
        if (X.lIIllllllllII(Bank.contains((int[])nArray21) ? 1 : 0)) {
            ...
            if (X.lIIllllllllIl(Bank.getFirst((int[])nArray22).getQuantity(), lIllllIlIl[11])) {
                ...
                var5 = new d(lIllllIlIl[15], lIllllIlIl[58], lIllllIlIl[14]);
                bv.add(var5);
                0;
            }
        }
        ...
        if (X.lIIllllllllII(Bank.contains((int[])nArray23) ? 1 : 0)) {
            ...
            if (X.lIIllllllllIl(Bank.getFirst((int[])nArray24).getQuantity(), lIllllIlIl[11])) {
                ...
                var5 = new d(lIllllIlIl[13], lIllllIlIl[58], lIllllIlIl[14]);
                bv.add(var5);
                0;
            }
        }
    ...
    private static String lIIllllllIlII(String var13, String var23) {
        try {
    ...
    private static String lIIllllllIIll(String var6, String var9) {
        try {
            SecretKeySpec var22 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var9.getBytes(StandardCharsets.UTF_8)), lIllllIlIl[16]), "DES");
            Cipher var17 = Cipher.getInstance("DES");
            var17.init(lIllllIlIl[3], var22);
        ...
        if (X.lIIlllllllllI(bt ? 1 : 0)) {
            if (X.lIIlllllllllI(e.j(lIllllIlIl[2]))) {
                ...
                if (X.lIIlllllllllI(X.aM() ? 1 : 0)) {
                    ...
                    if (X.lIIllllllllll(var24) && X.lIIlllllllllI(var24.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderSotf.c = lIllllIlII[lIllllIlIl[3]];
                        a.a(var24);
                    }
                    if (X.lIIllllllllll(var24) && X.lIIllllllllII(var24.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        if (X.lIIlllllllllI(Bank.isOpen() ? 1 : 0)) {
                                ...
                                if (X.lIIllllllllIl(Inventory.getCount((int[])nArray21), lIllllIlIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (X.lIlIIIIIIIIII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            0;
                                            if (3 <= 0) {
                                                return ((0x4C ^ 0x38 ^ (0x6C ^ 0x1E)) & (0xC5 ^ 0xBD ^ (0x67 ^ 0x19) ^ -1)) != 0;
                                            }
                                        } else {
                                            bl = lIllllIlIl[0];
                                        }
                                ...
                                if (X.lIIllllllllIl(Inventory.getCount((int[])nArray23), lIllllIlIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (X.lIlIIIIIIIIII(Inventory.getCount((int[])nArray))) {
                                            bl = lIllllIlIl[1];
                                            0;
                                            if (((0x4B ^ 0x5B ^ (0xEE ^ 0xBC)) & (0x42 ^ 0x32 ^ (0x6E ^ 0x5C) ^ -1)) >= 3) {
                                                return ((0x52 ^ 0x63 ^ (0xAF ^ 0x95)) & (0xE8 ^ 0xA0 ^ (0x77 ^ 0x34) ^ -1)) != 0;
                                            }
                                        } else {
                                            bl = lIllllIlIl[0];
                                        }
                                ...
                                if (X.lIIllllllllIl(Inventory.getCount((int[])nArray25), lIllllIlIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (X.lIlIIIIIIIIII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            0;
                                            if (3 != 3) {
                                                return ((92 + 49 - 109 + 169 ^ 137 + 131 - 253 + 130) & (86 + 59 - 61 + 43 ^ (0xA1 ^ 0x86) ^ -1)) != 0;
                                            }
                                        } else {
                                            bl = lIllllIlIl[0];
                                        }
                                ...
                                if (X.lIIllllllllIl(Inventory.getCount((int[])nArray29), lIllllIlIl[1])) {
                                    ...
                                    Time.sleepUntil(() -> {
                                        ...
                                        if (X.lIlIIIIIIIIII(Inventory.getCount((int[])nArray))) {
                                            ...
                                            0;
                                            if (2 == 0) {
                                                return ((0x3B ^ 0x33 ^ (0x3F ^ 0x13)) & (36 + 19 - 34 + 134 ^ 40 + 65 - 61 + 147 ^ -1)) != 0;
                                            }
                                        } else {
                                            bl = lIllllIlIl[0];
                                        }
                ...
                if (X.lIlIIIIIIIIlI(Players.getLocal().getWorldLocation().distanceTo(mm), lIllllIlIl[6]) && X.lIlIIIIIIIIll(Players.getLocal().getWorldLocation().getPlane(), lIllllIlIl[3]) && X.lIIllllllllII(X.aM() ? 1 : 0)) {
                    ...
                    if (X.lIIlllllllllI(Bank.isOpen() ? 1 : 0)) {
                        ...
                        if (X.lIIllllllllII((var24 = new WorldArea(lIllllIlIl[28], lIllllIlIl[29], lIllllIlIl[30], lIllllIlIl[31], lIllllIlIl[3])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            String[] stringArray = new String[lIllllIlIl[1]];
    ...
    public boolean ah() {
        ...
        if (X.lIlIIIIIIIllI(e.j(lIllllIlIl[2]), lIllllIlIl[3])) {
            bl = lIllllIlIl[1];
            0;
            if (((0x78 ^ 0x26 ^ (0x59 ^ 0x4F)) & (36 + 81 - -74 + 25 ^ 5 + 98 - -37 + 4 ^ -1)) != 0) {
                return ((2 + 11 - -61 + 181 ^ 156 + 136 - 264 + 166) & (0x76 ^ 0x50 ^ (0x2A ^ 0x31) ^ -1)) != 0;
            }
        } else {
            bl = lIllllIlIl[0];
        }
