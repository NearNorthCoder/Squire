...
implements ac {
    ...
    private static String lIllIlIlIlIIl(String var16, String var3) {
        try {
            SecretKeySpec var22 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var3.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var7 = Cipher.getInstance("Blowfish");
            var7.init(llIlIlllll[2], var22);
    ...
    private static String lIllIlIlIIlll(String var20, String var5) {
        try {
            SecretKeySpec var15 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var5.getBytes(StandardCharsets.UTF_8)), llIlIlllll[15]), "DES");
            Cipher var9 = Cipher.getInstance("DES");
            var9.init(llIlIlllll[2], var15);
    ...
    private static String lIllIlIlIlIII(String var21, String var8) {
        ...
        int var2 = llIlIlllll[0];
        char[] var11 = var21.toCharArray();
        int var19 = var11.length;
        int var18 = llIlIlllll[0];
        while (aA.lIllIlIlIllIl(var18, var19)) {
            char var12 = var11[var18];
            var10.append((char)(var12 ^ var14[var2 % var14.length]));
            0;
            ++var2;
            ++var18;
            0;
    ...
    private static void Q() {
        ...
        if (aA.lIllIlIllIIIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[6]) && aA.lIllIlIlIllIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[10])) {
            var13 = new d(llIlIlllll[7], llIlIlllll[33], llIlIlllll[11]);
            var17 = new d(llIlIlllll[11], llIlIlllll[34], llIlIlllll[36]);
            bv.add((d)var13);
            0;
            bv.add(var17);
            0;
        ...
        if (aA.lIllIlIllIIIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[10]) && aA.lIllIlIlIllIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[19])) {
            var13 = new d(llIlIlllll[32], llIlIlllll[37], llIlIlllll[38]);
            var17 = new d(llIlIlllll[13], llIlIlllll[1], llIlIlllll[4]);
            bv.add((d)var13);
            0;
            bv.add(var17);
            0;
        ...
        if (aA.lIllIlIllIIIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[19]) && aA.lIllIlIlIllIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[26])) {
            var13 = new d(llIlIlllll[31], llIlIlllll[33], llIlIlllll[38]);
            var17 = new d(llIlIlllll[13], llIlIlllll[1], llIlIlllll[4]);
            bv.add((d)var13);
            0;
            bv.add(var17);
        ...
        if (aA.lIllIlIllIIIl(Skills.getLevel((Skill)Skill.FLETCHING), llIlIlllll[26])) {
            var13 = new d(llIlIlllll[30], llIlIlllll[33], llIlIlllll[38]);
            var17 = new d(llIlIlllll[13], llIlIlllll[1], llIlIlllll[4]);
            bv.add((d)var13);
            0;
            bv.add(var17);
        ...
        if (aA.lIllIlIlIlllI(Bank.contains((Predicate)(var13 = item -> item.getName().toLowerCase().contains(llIlIllllI[llIlIlllll[45]]))) ? 1 : 0)) {
            var17 = new d(llIlIlllll[39], llIlIlllll[9], llIlIlllll[40]);
            bv.add(var17);
            0;
        }
        int[] nArray = new int[llIlIlllll[1]];
        ...
        if (aA.lIllIlIlIlllI(Bank.contains((int[])nArray) ? 1 : 0)) {
            var17 = new d(llIlIlllll[41], llIlIlllll[11], llIlIlllll[42]);
            bv.add(var17);
            0;
        }
    }
                                                ...
                                                block34: {
                                                    block33: {
                                                        block32: {
                                                            ...
                                                            if (aA.lIllIlIlIllll(var1) && aA.lIllIlIlIlllI(var1.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                                                AccBuilderSotf.c = llIlIllllI[llIlIlllll[2]];
                                                                a.a(var1);
                                                            }
                                                            if (!aA.lIllIlIlIllll(var1) || !aA.lIllIlIlIllII(var1.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block30;
            ...
            if (aA.lIllIlIlIllII(aA.an() ? 1 : 0)) {
                ...
                if (aA.lIllIlIlIlllI(Bank.isOpen() ? 1 : 0) && aA.lIllIlIlIlllI(Players.getLocal().isAnimating() ? 1 : 0)) {
                    ...
                    if (aA.lIllIlIlIlllI(Production.isOpen() ? 1 : 0)) {
                        ...
                        Item var6 = Inventory.getFirst((int[])nArray9);
                        if (aA.lIllIlIlIllll(var1) && aA.lIllIlIlIllll(var6)) {
