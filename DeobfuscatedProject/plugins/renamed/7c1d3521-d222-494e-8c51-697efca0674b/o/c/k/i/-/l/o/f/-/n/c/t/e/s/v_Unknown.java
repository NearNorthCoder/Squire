...
implements ac {
    ...
    private static String llIIIIIlIIlII(String var33, String var9) {
        try {
            SecretKeySpec var7 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var9.getBytes(StandardCharsets.UTF_8)), lllIIlllII[13]), "DES");
            Cipher var17 = Cipher.getInstance("DES");
            var17.init(lllIIlllII[6], var7);
    ...
    private static String llIIIIIlIIllI(String var10, String var43) {
        var10 = new String(Base64.getDecoder().decode(var10.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var18 = new StringBuilder();
        char[] var41 = var43.toCharArray();
        int var1 = lllIIlllII[1];
        char[] var24 = var10.toCharArray();
        int var38 = var24.length;
        int var16 = lllIIlllII[1];
        while (v.llIIIIlIlIIlI(var16, var38)) {
            char var22 = var24[var16];
            var18.append((char)(var22 ^ var41[var1 % var41.length]));
            0;
            ++var1;
            ++var16;
            0;
    ...
    private static String llIIIIIlIIlIl(String var39, String var30) {
        try {
            SecretKeySpec var11 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var30.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var4 = Cipher.getInstance("Blowfish");
            var4.init(lllIIlllII[6], var11);
            return new String(var4.doFinal(Base64.getDecoder().decode(var39.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void bc() {
        ...
        if (v.llIIIIlIllIII(Players.getLocal().getWorldLocation().distanceTo(y.dQ), lllIIlllII[4]) && v.llIIIIlIlIIll(worldArea2.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (v.llIIIIlIllIII(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var21), lllIIlllII[9])) {
        ...
        if (v.llIIIIlIlIIIl(var36.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
        ...
        if (v.llIIIIlIlIIIl((var37 = new WorldArea(lllIIlllII[81], lllIIlllII[380], lllIIlllII[10], lllIIlllII[10], lllIIlllII[1])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
        ...
        WorldArea var2 = new WorldArea(lllIIlllII[384], lllIIlllII[385], lllIIlllII[10], lllIIlllII[9], lllIIlllII[0]);
        WorldArea var6 = new WorldArea(lllIIlllII[386], lllIIlllII[387], lllIIlllII[9], lllIIlllII[12], lllIIlllII[0]);
        WorldPoint var26 = new WorldPoint(lllIIlllII[81], lllIIlllII[388], lllIIlllII[0]);
        if (v.llIIIIlIlIIIl(var6.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            if (v.llIIIIlIlIIll(Players.getLocal().getWorldLocation().equals((Object)var26) ? 1 : 0)) {
                AccBuilderSotf.c = lllIIlIIlI[lllIIlllII[389]];
                Movement.walkTo((WorldPoint)var26);
                0;
            }
            if (v.llIIIIlIlIIIl(Players.getLocal().getWorldLocation().equals((Object)var26) ? 1 : 0)) {
                int[] nArray = new int[lllIIlllII[0]];
        ...
        WorldArea var20 = new WorldArea(lllIIlllII[67], lllIIlllII[385], lllIIlllII[101], lllIIlllII[75], lllIIlllII[1]);
        WorldPoint var42 = new WorldPoint(lllIIlllII[395], lllIIlllII[396], lllIIlllII[1]);
        if (v.llIIIIlIlIIIl(var20.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && v.llIIIIlIlIIll(var35.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            if (v.llIIIIlIlIlll(Players.getLocal().getWorldLocation().distanceTo(var42), lllIIlllII[9])) {
                AccBuilderSotf.c = lllIIlIIlI[lllIIlllII[397]];
                Movement.walkTo((WorldPoint)var42);
                0;
                Time.sleepTicks((int)lllIIlllII[0]);
                0;
            }
            if (v.llIIIIlIllIII(Players.getLocal().getWorldLocation().distanceTo(var42), lllIIlllII[9])) {
        ...
        if (v.llIIIIlIlIIIl(var35.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static void Q() {
        block55: {
            ...
            block54: {
                ...
                block53: {
                    block52: {
                        block51: {
                                ...
                                block49: {
                                    block48: {
                                        block47: {
                                                ...
                                                block45: {
                                                    block44: {
                                                        block43: {
                                                                ...
                                                                block41: {
                                                                    block40: {
                                                                        ...
                                                                        if (v.llIIIIlIlIIll(Bank.contains((int[])nArray2) ? 1 : 0)) {
                                                                            var19 = new d(lllIIlllII[40], lllIIlllII[0], e.c(lllIIlllII[402], lllIIlllII[403]));
                                                                            bv.add((d)var19);
                                                                            0;
                                                                        }
                                                                        int[] nArray3 = new int[lllIIlllII[0]];
                                                                        ...
                                                                        if (v.llIIIIlIlIIll(Bank.contains((int[])nArray3) ? 1 : 0)) {
                                                                            var19 = new d(lllIIlllII[41], lllIIlllII[0], e.c(lllIIlllII[404], lllIIlllII[405]));
                                                                            bv.add((d)var19);
                                                                            0;
                                                                        }
                                                                        int[] nArray4 = new int[lllIIlllII[0]];
                                                                        ...
                                                                        if (v.llIIIIlIlIIll(Bank.contains((int[])nArray4) ? 1 : 0)) {
                                                                            var19 = new d(lllIIlllII[42], lllIIlllII[0], e.c(lllIIlllII[406], lllIIlllII[407]));
                                                                            bv.add((d)var19);
                                                                            0;
                                                                        }
                                                                        int[] nArray5 = new int[lllIIlllII[0]];
                                                                        ...
                                                                        if (v.llIIIIlIlIIll(Bank.contains((int[])nArray5) ? 1 : 0)) {
                                                                            var19 = new d(lllIIlllII[43], lllIIlllII[0], e.c(lllIIlllII[408], lllIIlllII[409]));
                                                                            bv.add((d)var19);
                                                                            0;
                                                                        }
                                                                        int[] nArray6 = new int[lllIIlllII[0]];
                                                                        ...
                                                                        if (v.llIIIIlIlIIll(Bank.contains((int[])nArray6) ? 1 : 0)) {
                                                                            var19 = new d(lllIIlllII[45], lllIIlllII[0], e.c(lllIIlllII[410], lllIIlllII[411]));
                                                                            bv.add((d)var19);
                                                                            0;
                                                                        }
                                                                        int[] nArray7 = new int[lllIIlllII[0]];
                                                                        ...
                                                                        if (v.llIIIIlIlIIll(Bank.contains((int[])nArray7) ? 1 : 0)) {
                                                                            var19 = new d(lllIIlllII[47], lllIIlllII[0], e.c(lllIIlllII[412], lllIIlllII[413]));
                                                                            bv.add((d)var19);
                                                                            0;
                                                                        }
                                                                        int[] nArray8 = new int[lllIIlllII[0]];
                                                                        ...
                                                                        if (v.llIIIIlIlIIll(Bank.contains((int[])nArray8) ? 1 : 0)) {
                                                                            var19 = new d(lllIIlllII[49], lllIIlllII[0], e.c(lllIIlllII[414], lllIIlllII[415]));
                                                                            bv.add((d)var19);
                                                                            0;
                                                                        }
                                                                        int[] nArray9 = new int[lllIIlllII[0]];
                                                                        ...
                                                                        if (v.llIIIIlIlIIll(Bank.contains((int[])nArray9) ? 1 : 0)) {
                                                                            var19 = new d(lllIIlllII[36], lllIIlllII[0], e.c(lllIIlllII[416], lllIIlllII[417]));
                                                                            bv.add((d)var19);
                                                                            0;
                                                                        }
                                                                        int[] nArray10 = new int[lllIIlllII[0]];
                                                                    ...
                                                                    var19 = new d(lllIIlllII[18], lllIIlllII[15], e.c(lllIIlllII[418], lllIIlllII[419]));
                                                                    bv.add((d)var19);
                                                                    0;
                                                                }
                                                                int[] nArray = new int[lllIIlllII[0]];
                                                            ...
                                                            var19 = new d(lllIIlllII[19], lllIIlllII[15], e.c(lllIIlllII[418], lllIIlllII[419]));
                                                            bv.add((d)var19);
                                                            0;
                                                        }
                                                        int[] nArray = new int[lllIIlllII[0]];
                                                        ...
                                                        if (v.llIIIIlIlIIll(Bank.contains((int[])nArray) ? 1 : 0)) {
                                                            var19 = new d(lllIIlllII[38], lllIIlllII[0], e.c(lllIIlllII[418], lllIIlllII[419]));
                                                            bv.add((d)var19);
                                                            0;
                                                        }
                                                        int[] nArray15 = new int[lllIIlllII[0]];
                                                    ...
                                                    var19 = new d(lllIIlllII[23], lllIIlllII[160], e.c(lllIIlllII[29], lllIIlllII[58]));
                                                    bv.add((d)var19);
                                                    0;
                                                }
                                                int[] nArray = new int[lllIIlllII[0]];
                                            ...
                                            var19 = new d(lllIIlllII[21], lllIIlllII[22], e.c(lllIIlllII[29], lllIIlllII[58]));
                                            bv.add((d)var19);
                                            0;
                                        }
                                        int[] nArray = new int[lllIIlllII[0]];
                                        ...
                                        if (v.llIIIIlIlIIll(Bank.contains((int[])nArray) ? 1 : 0)) {
                                            var19 = new d(lllIIlllII[34], lllIIlllII[0], e.c(lllIIlllII[420], lllIIlllII[421]));
                                            bv.add((d)var19);
                                            0;
                                        }
                                        int[] nArray20 = new int[lllIIlllII[0]];
                                        ...
                                        if (v.llIIIIlIlIIll(Bank.contains((int[])nArray20) ? 1 : 0)) {
                                            var19 = new d(lllIIlllII[35], lllIIlllII[0], e.c(lllIIlllII[422], lllIIlllII[417]));
                                            bv.add((d)var19);
                                            0;
                                        }
                                        int[] nArray21 = new int[lllIIlllII[0]];
                                        ...
                                        if (v.llIIIIlIlIIll(Bank.contains((int[])nArray21) ? 1 : 0)) {
                                            var19 = new d(lllIIlllII[33], lllIIlllII[0], e.c(lllIIlllII[420], lllIIlllII[421]));
                                            bv.add((d)var19);
                                            0;
                                        }
                                        int[] nArray22 = new int[lllIIlllII[0]];
                                        ...
                                        if (v.llIIIIlIlIIll(Bank.contains((int[])nArray22) ? 1 : 0)) {
                                            var19 = new d(lllIIlllII[37], lllIIlllII[0], e.c(lllIIlllII[420], lllIIlllII[421]));
                                            bv.add((d)var19);
                                            0;
                                        }
                                        int[] nArray23 = new int[lllIIlllII[0]];
                                    ...
                                    var19 = new d(lllIIlllII[25], lllIIlllII[26], e.c(lllIIlllII[423], lllIIlllII[424]));
                                    bv.add((d)var19);
                                    0;
                                }
                                int[] nArray = new int[lllIIlllII[0]];
                            ...
                            var19 = new d(lllIIlllII[31], lllIIlllII[28], e.c(lllIIlllII[425], lllIIlllII[417]));
                            bv.add((d)var19);
                            0;
                        }
                        int[] nArray = new int[lllIIlllII[0]];
                    ...
                    var19 = new d(lllIIlllII[39], lllIIlllII[58], e.c(lllIIlllII[426], lllIIlllII[427]));
                    bv.add((d)var19);
                    0;
                }
                if (v.llIIIIlIlIIll(Bank.contains((Predicate)(var19 = item -> item.getName().toLowerCase().contains(lllIIlIIlI[lllIIlllII[434]]))) ? 1 : 0)) {
                    var5 = new d(lllIIlllII[428], lllIIlllII[9], e.c(lllIIlllII[429], lllIIlllII[430]));
                    bv.add(var5);
                    0;
                }
                int[] nArray = new int[lllIIlllII[0]];
                ...
                if (v.llIIIIlIlIIll(Bank.contains((int[])nArray) ? 1 : 0)) {
                    var5 = new d(lllIIlllII[51], lllIIlllII[8], j.cf);
                    bv.add(var5);
                    0;
                }
                int[] nArray30 = new int[lllIIlllII[0]];
            ...
            var5 = new d(lllIIlllII[30], lllIIlllII[4], e.c(lllIIlllII[431], lllIIlllII[432]));
            bv.add(var5);
            0;
        }
    }
    ...
    private static boolean an() {
        ...
        int[] nArray2 = nArray;
        int var3 = lllIIlllII[1];
        while (v.llIIIIlIlIIlI(var3, ((void)var31).length)) {
            int[] nArray3 = new int[lllIIlllII[0]];
            nArray3[v.lllIIlllII[1]] = var31[var3];
    ...
    public static void aZ() {
        block290: {
                            ...
                            block294: {
                                block293: {
                                    block292: {
                                        ...
                                        if (v.llIIIIlIlIlIl(var15) && v.llIIIIlIlIIll(var15.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                            AccBuilderSotf.c = lllIIlIIlI[lllIIlllII[15]];
                                            a.a((BankLocation)var15);
                                        }
                                        if (!v.llIIIIlIlIlIl(var15) || !v.llIIIIlIlIIIl(var15.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block291;
                                        if (v.llIIIIlIlIIll(Bank.isOpen() ? 1 : 0)) {
                                            a.a();
            ...
            if (v.llIIIIlIlIIIl(v.an() ? 1 : 0) && v.llIIIIlIllIIl(Vars.getBit((int)QuestVarbits.QUEST_A_TASTE_OF_HOPE.getId()), lllIIlllII[28])) {
                var15 = new WorldArea(lllIIlllII[61], lllIIlllII[62], lllIIlllII[63], lllIIlllII[64], lllIIlllII[1]);
                var27 = new WorldArea(lllIIlllII[65], lllIIlllII[66], lllIIlllII[50], lllIIlllII[13], lllIIlllII[1]);
                var13 = new WorldArea(lllIIlllII[67], lllIIlllII[68], lllIIlllII[29], lllIIlllII[69], lllIIlllII[1]);
                if (v.llIIIIlIlIIll(var13.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && v.llIIIIlIlIIll(var27.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && v.llIIIIlIlIIIl(var15.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (v.llIIIIlIllIIl(Vars.getBit((int)QuestVarbits.QUEST_A_TASTE_OF_HOPE.getId()), lllIIlllII[4])) {
                ...
                var15 = new WorldArea(lllIIlllII[81], lllIIlllII[82], lllIIlllII[24], lllIIlllII[28], lllIIlllII[0]);
                var27 = new WorldArea(lllIIlllII[83], lllIIlllII[84], lllIIlllII[20], lllIIlllII[46], lllIIlllII[6]);
                var13 = new WorldArea(lllIIlllII[81], lllIIlllII[85], lllIIlllII[20], lllIIlllII[24], lllIIlllII[0]);
                var14 = new WorldArea(lllIIlllII[86], lllIIlllII[87], lllIIlllII[59], lllIIlllII[15], lllIIlllII[6]);
                var40 = new WorldArea(lllIIlllII[88], lllIIlllII[89], lllIIlllII[73], lllIIlllII[57], lllIIlllII[6]);
                WorldPoint var28 = new WorldPoint(lllIIlllII[90], lllIIlllII[91], lllIIlllII[6]);
                WorldPoint var8 = new WorldPoint(lllIIlllII[92], lllIIlllII[93], lllIIlllII[0]);
                WorldPoint var32 = new WorldPoint(lllIIlllII[94], lllIIlllII[95], lllIIlllII[0]);
                WorldPoint var25 = new WorldPoint(lllIIlllII[96], lllIIlllII[85], lllIIlllII[6]);
                if (v.llIIIIlIlIIIl(var15.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (v.llIIIIlIlIIIl(Players.getLocal().getWorldLocation().equals((Object)var8) ? 1 : 0) && v.llIIIIlIlIIll(AccBuilderSotf.i.containsKey(var34 = new WorldPoint(lllIIlllII[96], lllIIlllII[93], lllIIlllII[0])) ? 1 : 0)) {
                ...
                if (v.llIIIIlIlIIIl(var27.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    if (v.llIIIIlIlIlll(Players.getLocal().getWorldLocation().distanceTo(var25), lllIIlllII[6])) {
                    ...
                    if (v.llIIIIlIllIII(Players.getLocal().getWorldLocation().distanceTo(var25), lllIIlllII[6])) {
                ...
                if (v.llIIIIlIlIIIl(var13.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    if (v.llIIIIlIlIIll(Players.getLocal().getWorldLocation().equals((Object)var32) ? 1 : 0)) {
                    ...
                    if (v.llIIIIlIlIIIl(Players.getLocal().getWorldLocation().equals((Object)var32) ? 1 : 0) && v.llIIIIlIlIIll(AccBuilderSotf.i.containsKey(var34 = new WorldPoint(lllIIlllII[94], lllIIlllII[104], lllIIlllII[0])) ? 1 : 0)) {
                ...
                if (v.llIIIIlIlIIIl(var14.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && v.llIIIIlIlIlIl(var34 = TileObjects.getNearest(tileObject -> {
                    int n2;
                    ...
                    var34.interact(lllIIlIIlI[lllIIlllII[22]]);
                    Time.sleepTicks((int)lllIIlllII[6]);
                    0;
                }
                if (v.llIIIIlIlIIIl((var34 = new WorldArea(lllIIlllII[106], lllIIlllII[107], lllIIlllII[58], lllIIlllII[48], lllIIlllII[7])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    String[] stringArray15 = new String[lllIIlllII[0]];
                    stringArray15[v.lllIIlllII[1]] = lllIIlIIlI[lllIIlllII[108]];
                    List var23 = TileObjects.getAll((String[])stringArray15).stream().filter(tileObject -> {
                        boolean bl;
                    ...
                    if (v.llIIIIlIlIIll(var23.isEmpty() ? 1 : 0)) {
                        ((TileObject)var23.get(lllIIlllII[1])).interact(lllIIlIIlI[lllIIlllII[109]]);
                        Time.sleepTicks((int)lllIIlllII[9]);
                        0;
                    }
                }
                if (v.llIIIIlIlIIIl(var40.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    if (v.llIIIIlIlIlll(Players.getLocal().getWorldLocation().distanceTo(var28), lllIIlllII[8])) {
                    ...
                    if (v.llIIIIlIllIII(Players.getLocal().getWorldLocation().distanceTo(var28), lllIIlllII[8]) && v.llIIIIlIlIIll(Dialog.isOpen() ? 1 : 0)) {
            ...
            if (v.llIIIIlIllIIl(Vars.getBit((int)QuestVarbits.QUEST_A_TASTE_OF_HOPE.getId()), lllIIlllII[3])) {
                ...
                if (v.llIIIIlIlIIIl(var15.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && v.llIIIIlIlIIll(Dialog.isOpen() ? 1 : 0)) {
                    int[] nArray = new int[lllIIlllII[0]];
                    nArray[v.lllIIlllII[1]] = lllIIlllII[31];
                ...
                if (v.llIIIIlIlIIIl(Inventory.contains((int[])nArray29) ? 1 : 0)) {
                    var27 = new WorldArea(lllIIlllII[67], lllIIlllII[119], lllIIlllII[111], lllIIlllII[120], lllIIlllII[1]);
                    var13 = new WorldArea(lllIIlllII[67], lllIIlllII[119], lllIIlllII[111], lllIIlllII[120], lllIIlllII[0]);
                    var14 = new WorldArea(lllIIlllII[67], lllIIlllII[119], lllIIlllII[111], lllIIlllII[120], lllIIlllII[6]);
                    var40 = new WorldArea(lllIIlllII[67], lllIIlllII[119], lllIIlllII[111], lllIIlllII[120], lllIIlllII[7]);
                    if (v.llIIIIlIlIIIl(Dialog.isOpen() ? 1 : 0)) {
                        Dialog.close();
                    }
                    if (v.llIIIIlIlIIll(do.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && v.llIIIIlIlIlll(Players.getLocal().getWorldLocation().distanceTo(y.dQ), lllIIlllII[4]) && v.llIIIIlIlIIll(var27.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && v.llIIIIlIlIIll(var13.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && v.llIIIIlIlIIll(var14.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && v.llIIIIlIlIIll(var40.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (v.llIIIIlIllIIl(Vars.getBit((int)QuestVarbits.QUEST_A_TASTE_OF_HOPE.getId()), lllIIlllII[145])) {
                var15 = new WorldArea(lllIIlllII[183], lllIIlllII[184], lllIIlllII[12], lllIIlllII[9], lllIIlllII[1]);
                if (v.llIIIIlIlIIll(var15.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (v.llIIIIlIllIIl(Vars.getBit((int)QuestVarbits.QUEST_A_TASTE_OF_HOPE.getId()), lllIIlllII[150])) {
                var15 = new WorldArea(lllIIlllII[198], lllIIlllII[199], lllIIlllII[24], lllIIlllII[48], lllIIlllII[1]);
                while (v.llIIIIlIlIIIl(var15.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    int[] nArray = new int[lllIIlllII[0]];
                    nArray[v.lllIIlllII[1]] = lllIIlllII[31];
            ...
            if (v.llIIIIlIllIIl(Vars.getBit((int)QuestVarbits.QUEST_A_TASTE_OF_HOPE.getId()), lllIIlllII[170])) {
                ...
                if (v.llIIIIlIlIIll(Inventory.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    if (v.llIIIIlIlIlll(Players.getLocal().getWorldLocation().distanceTo(D.fa), lllIIlllII[13])) {
                        ...
                        var15 = new WorldArea(lllIIlllII[227], lllIIlllII[228], lllIIlllII[222], lllIIlllII[229], lllIIlllII[1]);
                        if (v.llIIIIlIlIIll(var15.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (v.llIIIIlIllIIl(Vars.getBit((int)QuestVarbits.QUEST_A_TASTE_OF_HOPE.getId()), lllIIlllII[204])) {
                ...
                var15 = NPCs.getNearest((String[])stringArray122);
                if (v.llIIIIlIlllII(var15)) {
                    if (v.llIIIIlIlIIIl(v.ba() ? 1 : 0)) {
                        if (v.llIIIIlIllIll(v.llIIIIlIIllll(e.w(), 100.0))) {
                ...
                if (v.llIIIIlIlIlIl(var15)) {
                    if (v.llIIIIlIlllII(dr)) {
                        dr = var15.getWorldLocation();
                    ...
                    if (v.llIIIIlIlIIll(Inventory.contains((String[])stringArray127) ? 1 : 0) && !v.llIIIIlIlllIl(v.llIIIIlIIllll(e.w(), 50.0)) || v.llIIIIlIlIIll(Inventory.contains((int[])f.aX) ? 1 : 0) && v.llIIIIlIllIII(Prayers.getPoints(), lllIIlllII[7])) {
                        ...
                        var27 = TileObjects.getNearest(tileObject -> {
                            int n2;
                        ...
                        if (v.llIIIIlIlIlIl(var27)) {
                            var27.interact(lllIIlIIlI[lllIIlllII[318]]);
                            Time.sleepTicks((int)lllIIlllII[8]);
                            0;
                        }
                    }
                    if (v.llIIIIlIlIIIl(AccBuilderSotf.i.containsKey(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        var13 = TileObjects.getAll(tileObject -> {
                            int n2;
                        ...
                        if (v.llIIIIlIlIlII(var14.distanceTo(ds), lllIIlllII[7])) {
                            Movement.walkTo((WorldPoint)ds);
                            0;
                        }
                        if (v.llIIIIlIlIlII(var14.distanceTo(dr), lllIIlllII[7]) && v.llIIIIlIlIIll(Players.getLocal().isMoving() ? 1 : 0)) {
                    ...
                    if (v.llIIIIlIlIlIl(NPCs.getNearest((String[])stringArray128))) {
                        ...
                        if (v.llIIIIlIlIIIl(NPCs.getNearest((String[])stringArray129).hasAction(stringArray130) ? 1 : 0)) {
                            ...
                            if (v.llIIIIlIlIIll(var15.hasAction(stringArray131) ? 1 : 0)) {
                    ...
                    if (v.llIIIIlIlIlIl(NPCs.getNearest((String[])stringArray133))) {
                        ...
                        if (v.llIIIIlIlIIll(NPCs.getNearest((String[])stringArray134).hasAction(stringArray135) ? 1 : 0)) {
                            ...
                            if (v.llIIIIlIlIIIl(var15.hasAction(stringArray136) ? 1 : 0)) {
                                if (v.llIIIIlIlIlll(var15.getHealthRatio(), lllIIlllII[29])) {
                                ...
                                if (v.llIIIIlIllIII(var15.getHealthRatio(), lllIIlllII[29]) && v.llIIIIlIlIIll(Prayers.isEnabled((Prayer)Prayer.PROTECT_FROM_MELEE) ? 1 : 0)) {
                                    Prayers.toggle((Prayer)Prayer.PROTECT_FROM_MELEE);
                                }
                                if (v.llIIIIlIllIIl(var15.getAnimation(), lllIIlllII[330])) {
                                    AccBuilderSotf.c = lllIIlIIlI[lllIIlllII[331]];
                                    var27 = TileObjects.getAll(arg_0 -> v.b((NPC)var15, arg_0));
                                    var13 = TileObjects.getAll(arg_0 -> v.a((NPC)var15, arg_0));
                                    Movement.walkTo((WorldPoint)ds);
                                    0;
                                    Time.sleepTicks((int)lllIIlllII[0]);
                                    0;
                                }
                                if (v.llIIIIlIllIlI(var15.getAnimation(), lllIIlllII[330]) && v.llIIIIlIlllII(Players.getLocal().getInteracting())) {
                                    var15.interact(lllIIlIIlI[lllIIlllII[332]]);
                                    Time.sleepTicks((int)lllIIlllII[0]);
                                    0;
                                }
                            }
                    ...
                    if (v.llIIIIlIlllII(NPCs.getNearest((String[])stringArray137))) {
                        ...
                        if (v.llIIIIlIlIIIl(var15.hasAction(stringArray138) ? 1 : 0)) {
                            if (v.llIIIIlIlIIll(Prayers.isEnabled((Prayer)Prayer.INCREDIBLE_REFLEXES) ? 1 : 0)) {
                                Prayers.toggle((Prayer)Prayer.INCREDIBLE_REFLEXES);
                            }
                            if (v.llIIIIlIlIlll(var15.getHealthRatio(), lllIIlllII[29]) && v.llIIIIlIlIIll(Prayers.isEnabled((Prayer)Prayer.PROTECT_FROM_MAGIC) ? 1 : 0)) {
                                Prayers.toggle((Prayer)Prayer.PROTECT_FROM_MAGIC);
                            }
                            if (v.llIIIIlIllIII(var15.getHealthRatio(), lllIIlllII[29]) && v.llIIIIlIlIIll(Prayers.isEnabled((Prayer)Prayer.PROTECT_FROM_MELEE) ? 1 : 0)) {
                                Prayers.toggle((Prayer)Prayer.PROTECT_FROM_MELEE);
                            ...
                            if (v.llIIIIlIllIlI(var15.getAnimation(), lllIIlllII[330]) && v.llIIIIlIlllII(Players.getLocal().getInteracting())) {
                                var15.interact(lllIIlIIlI[lllIIlllII[335]]);
                                Time.sleepTicks((int)lllIIlllII[0]);
                                0;
                            }
                        }
            ...
            if (v.llIIIIlIlIlIl(var15 = Widgets.get((int)lllIIlllII[308], (int)lllIIlllII[14]))) {
                var15.interact(lllIIlIIlI[lllIIlllII[354]]);
                Time.sleepTicks((int)lllIIlllII[0]);
                0;
            }
            if (v.llIIIIlIlIlIl(var27 = Widgets.get((int)lllIIlllII[308], (int)lllIIlllII[70]))) {
                var27.interact(lllIIlIIlI[lllIIlllII[355]]);
                Time.sleepTicks((int)lllIIlllII[6]);
                0;
            }
            g.a(cE);
