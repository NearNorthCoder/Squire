...
implements ac {
    ...
    private static void Q() {
        ...
        if (x.lIlIlIIIlllIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var17 = new d(llIIlIIIIl[11], llIIlIIIIl[13], j.cf);
            bv.add((d)var17);
            0;
        }
        if (x.lIlIlIIIlllIl(Bank.contains(var17 = item -> item.getName().toLowerCase().contains(llIIIlllIl[llIIlIIIIl[80]])) ? 1 : 0)) {
            var12 = new d(llIIlIIIIl[75], llIIlIIIIl[13], llIIlIIIIl[76]);
            bv.add(var12);
            0;
        }
        ...
        if (x.lIlIlIIIlllIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var12 = new d(llIIlIIIIl[7], llIIlIIIIl[53], llIIlIIIIl[74]);
            bv.add(var12);
            0;
        }
        ...
        if (x.lIlIlIIIlllIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var12 = new d(llIIlIIIIl[8], llIIlIIIIl[12], llIIlIIIIl[74]);
            bv.add(var12);
            0;
        }
    }
    ...
    private static String lIlIIlllIllll(String var3, String var16) {
        ...
        int var9 = llIIlIIIIl[1];
        char[] var11 = var3.toCharArray();
        int var8 = var11.length;
        int var23 = llIIlIIIIl[1];
        while (x.lIlIlIIIllIll(var23, var8)) {
            char var21 = var11[var23];
            var5.append((char)(var21 ^ var14[var9 % var14.length]));
            0;
            ++var9;
            ++var23;
            0;
    ...
    private static String lIlIIllllIIII(String var19, String var13) {
        try {
    ...
    public static void bj() {
        ...
        if (x.lIlIlIIIllIII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
            if (x.lIlIlIIlIIIIl(Widgets.get((int)llIIlIIIIl[59]))) {
                ...
                if (x.lIlIlIIlIIIIl(var18 = Widgets.get((int)llIIlIIIIl[59], (int)llIIlIIIIl[39]))) {
                    var18.interact(llIIIlllIl[llIIlIIIIl[72]]);
    ...
    private static String lIlIIlllIlllI(String var6, String var10) {
        try {
            SecretKeySpec var2 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var10.getBytes(StandardCharsets.UTF_8)), llIIlIIIIl[2]), "DES");
            Cipher var20 = Cipher.getInstance("DES");
            var20.init(llIIlIIIIl[5], var2);
        ...
        block80: {
            ...
            if (x.lIlIlIIIlllIl(x.an() ? 1 : 0) && x.lIlIlIIIllIll(Vars.getBit((int)QuestVarbits.QUEST_CLIENT_OF_KOUREND.getId()), llIIlIIIIl[0]) && x.lIlIlIIlIIIII(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()), llIIlIIIIl[2])) {
                ...
                if (x.lIlIlIIIlllIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                    ...
                    if (x.lIlIlIIlIIIIl(var15) && x.lIlIlIIIlllIl(var15.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderSotf.c = llIIIlllIl[llIIlIIIIl[0]];
                        a.a((BankLocation)var15);
                    }
                    if (x.lIlIlIIlIIIIl(var15) && x.lIlIlIIIllIII(var15.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (x.lIlIlIIIlllIl(dA ? 1 : 0)) {
                    ...
                    if (x.lIlIlIIIllIII(Inventory.contains((String[])stringArray6) ? 1 : 0)) {
                        ...
                        if (x.lIlIlIIlIIlII(Players.getLocal().getWorldLocation().distanceTo(dH), llIIlIIIIl[2])) {
                            ...
                            var1 = new ArrayList();
                            if (x.lIlIlIIIlllIl(var15.isEmpty() ? 1 : 0)) {
                                var24 = llIIlIIIIl[1];
                                while (x.lIlIlIIIllIll(var24, var15.size())) {
                                    var1.add(((Widget)var15.get(var24)).getText());
                                    0;
                                    ++var24;
                                    0;
                                    if (2 == 2) continue;
                                ...
                                var24 = var1.stream().anyMatch(string -> string.equalsIgnoreCase(llIIIlllIl[llIIlIIIIl[90]])) ? 1 : 0;
                                int n2 = var1.stream().noneMatch(string -> string.equalsIgnoreCase(llIIIlllIl[llIIlIIIIl[89]]));
                                if (x.lIlIlIIIllIII(var24) && x.lIlIlIIIllIII(n2)) {
                ...
                if (x.lIlIlIIIlllIl(dB ? 1 : 0) && x.lIlIlIIIllIII(dA ? 1 : 0)) {
                    ...
                    if (x.lIlIlIIlIIlII(Players.getLocal().getWorldLocation().distanceTo(dI), llIIlIIIIl[18])) {
                        ...
                        if (x.lIlIlIIIlllIl(var15.isEmpty() ? 1 : 0)) {
                            ...
                            var24 = var1.stream().anyMatch(string -> string.equalsIgnoreCase(llIIIlllIl[llIIlIIIIl[88]])) ? 1 : 0;
                            int n3 = var1.stream().noneMatch(string -> string.equalsIgnoreCase(llIIIlllIl[llIIlIIIIl[87]]));
                            if (x.lIlIlIIIllIII(var24) && x.lIlIlIIIllIII(n3)) {
                ...
                if (x.lIlIlIIIlllIl(dC ? 1 : 0) && x.lIlIlIIIllIII(dB ? 1 : 0) && x.lIlIlIIIllIII(dA ? 1 : 0)) {
                    ...
                    if (x.lIlIlIIlIIlII(Players.getLocal().getWorldLocation().distanceTo(dJ), llIIlIIIIl[18])) {
                        ...
                        if (x.lIlIlIIIlllIl(var15.isEmpty() ? 1 : 0)) {
                            ...
                            var24 = var1.stream().anyMatch(string -> string.equalsIgnoreCase(llIIIlllIl[llIIlIIIIl[86]])) ? 1 : 0;
                            int n4 = var1.stream().noneMatch(string -> string.equalsIgnoreCase(llIIIlllIl[llIIlIIIIl[85]]));
                            if (x.lIlIlIIIllIII(var24) && x.lIlIlIIIllIII(n4)) {
                ...
                if (x.lIlIlIIIlllIl(dD ? 1 : 0) && x.lIlIlIIIllIII(dC ? 1 : 0) && x.lIlIlIIIllIII(dB ? 1 : 0) && x.lIlIlIIIllIII(dA ? 1 : 0)) {
                    ...
                    if (x.lIlIlIIlIIlII(Players.getLocal().getWorldLocation().distanceTo(dK), llIIlIIIIl[18])) {
                        ...
                        if (x.lIlIlIIIlllIl(var15.isEmpty() ? 1 : 0)) {
                            ...
                            var24 = var1.stream().anyMatch(string -> string.equalsIgnoreCase(llIIIlllIl[llIIlIIIIl[84]])) ? 1 : 0;
                            int n5 = var1.stream().noneMatch(string -> string.equalsIgnoreCase(llIIIlllIl[llIIlIIIIl[83]]));
                            if (x.lIlIlIIIllIII(var24) && x.lIlIlIIIllIII(n5)) {
                ...
                if (x.lIlIlIIIlllIl(dE ? 1 : 0) && x.lIlIlIIIllIII(dD ? 1 : 0) && x.lIlIlIIIllIII(dC ? 1 : 0) && x.lIlIlIIIllIII(dB ? 1 : 0) && x.lIlIlIIIllIII(dA ? 1 : 0)) {
                    ...
                    if (x.lIlIlIIlIIlII(Players.getLocal().getWorldLocation().distanceTo(dL), llIIlIIIIl[18])) {
                        ...
                        if (x.lIlIlIIIlllIl(var15.isEmpty() ? 1 : 0)) {
                            ...
                            var24 = var1.stream().anyMatch(string -> string.equalsIgnoreCase(llIIIlllIl[llIIlIIIIl[16]])) ? 1 : 0;
                            int n6 = var1.stream().anyMatch(string -> string.contains(llIIIlllIl[llIIlIIIIl[82]]));
                            int n7 = var1.stream().noneMatch(string -> string.equalsIgnoreCase(llIIIlllIl[llIIlIIIIl[81]]));
                            if ((!x.lIlIlIIIlllIl(var24) || x.lIlIlIIIllIII(n6)) && x.lIlIlIIIllIII(n7)) {
            ...
            if (!x.lIlIlIIlIlIlI(Vars.getBit((int)QuestVarbits.QUEST_CLIENT_OF_KOUREND.getId()), llIIlIIIIl[18]) || x.lIlIlIIlIIIII(Vars.getBit((int)QuestVarbits.QUEST_CLIENT_OF_KOUREND.getId()), llIIlIIIIl[2])) {
                ...
                if (x.lIlIlIIIllIII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    if (x.lIlIlIIlIIIIl(Widgets.get((int)llIIlIIIIl[59]))) {
                        ...
                        var15 = Widgets.get((int)llIIlIIIIl[59], (int)llIIlIIIIl[27]);
                        if (x.lIlIlIIlIIIIl(var15)) {
                            var15.interact(llIIIlllIl[llIIlIIIIl[64]]);
                            Time.sleepTicks((int)llIIlIIIIl[0]);
                            0;
                        }
                        if (x.lIlIlIIlIIIIl(var1 = Widgets.get((int)llIIlIIIIl[59], (int)llIIlIIIIl[39]))) {
                            var1.interact(llIIIlllIl[llIIlIIIIl[65]]);
                            Time.sleepTicks((int)llIIlIIIIl[5]);
                            0;
                        }
                    }
