...
import o.c.k.i.-.l.o.f.-.n.c.t.e.s.S_Unknown;
...
implements ac {
    ...
    public int af() {
        ...
        if (1 >= 3) {
            return (0x4D ^ 0x12 ^ (0x22 ^ 0x36)) & (0x69 ^ 0x59 ^ (0x69 ^ 0x12) ^ -1);
        }
            ...
            block78: {
                ...
                block80: {
                    block79: {
                        ...
                        if (R.llIIIIIIIllII(R.an() ? 1 : 0) && R.llIIIIIIIllII(Vars.getBit((int)QuestVarbits.QUEST_DEMON_SLAYER.getId()))) {
                            ...
                            if (R.llIIIIIIIllIl(var6) && R.llIIIIIIIllII(var6.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                AccBuilderSotf.c = lllIIIllII[lllIIIllll[1]];
                                a.a((BankLocation)var6);
                            }
                            if (R.llIIIIIIIllIl(var6) && R.llIIIIIIIlIlI(var6.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (R.llIIIIIIlIIlI(Vars.getBit((int)QuestVarbits.QUEST_DEMON_SLAYER.getId()), lllIIIllll[1])) {
                            var6 = new WorldArea(lllIIIllll[21], lllIIIllll[22], lllIIIllll[19], lllIIIllll[18], lllIIIllll[0]);
                            if (R.llIIIIIIIllII(var6.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            if (R.llIIIIIIIlIlI(var6.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (R.llIIIIIIIllIl(var6 = NPCs.getNearest(nPC -> {
                        int n2;
                        ...
                        var6.interact(lllIIIllII[lllIIIllll[62]]);
                        Time.sleepTicks((int)lllIIIllll[3]);
                        0;
                    }
                    if (R.llIIIIIIlIlII(var6) && R.llIIIIIIlIlII(Players.getLocal().getInteracting())) {
                        String[] stringArray = new String[lllIIIllll[1]];
                    ...
                    if (R.llIIIIIIIlIlI(Dialog.isOpen() ? 1 : 0)) {
                        ...
                        List var16 = Dialog.getOptions();
                        if (R.llIIIIIIIllII(var16.isEmpty() ? 1 : 0)) {
                            int var25 = lllIIIllll[0];
                            while (R.llIIIIIIIlIll(var25, var16.size())) {
                                if (R.llIIIIIIIlIlI(((Widget)var16.get(var25)).getText().contains(lllIIIllII[lllIIIllll[67]]) ? 1 : 0)) {
                                    String[] stringArray = new String[lllIIIllll[1]];
                                    stringArray[R.lllIIIllll[0]] = ((Widget)var16.get(var25)).getText();
                ...
                if (R.llIIIIIIIllIl(NPCs.getNearest((String[])stringArray))) {
                    ...
                    if (R.llIIIIIIIlIlI(Dialog.isOpen() ? 1 : 0)) {
                        ...
                        if (R.llIIIIIIIllII(var6.isEmpty() ? 1 : 0)) {
                            int var16 = lllIIIllll[0];
                            while (R.llIIIIIIIlIll(var16, var6.size())) {
                                String var25 = lP[var16];
                                int var11 = lllIIIllll[0];
                                while (R.llIIIIIIIlIll(var11, var6.size())) {
                                    if (R.llIIIIIIIlIlI(((Widget)var6.get(var11)).getText().contains(var25) ? 1 : 0)) {
                                        System.out.println("Selecting: " + ((Widget)var6.get(var11)).getText());
                                        Time.sleepTicks((int)lllIIIllll[3]);
                                        0;
                                        String[] stringArray23 = new String[lllIIIllll[1]];
                                        stringArray23[R.lllIIIllll[0]] = ((Widget)var6.get(var11)).getText();
                                ...
                                ++var16;
                                0;
                                if ((124 + 83 - 149 + 82 ^ 132 + 135 - 177 + 46) >= -1) continue;
                                return;
                            }
                        }
                    }
    ...
    private static void Q() {
        block17: {
            ...
            block16: {
                block15: {
                    block14: {
                        ...
                        block13: {
                            ...
                            var28 = new d(lllIIIllll[7], lllIIIllll[9], lllIIIllll[80]);
                            bv.add((d)var28);
                            0;
                        }
                        int[] nArray = new int[lllIIIllll[1]];
                        ...
                        if (R.llIIIIIIIllII(Bank.contains((int[])nArray) ? 1 : 0)) {
                            var28 = new d(lllIIIllll[8], lllIIIllll[1], lllIIIllll[81]);
                            bv.add((d)var28);
                            0;
                        }
                        if (R.llIIIIIIIllII(Bank.contains((Predicate)(var28 = item -> item.getName().toLowerCase().contains(lllIIIllII[lllIIIllll[88]]))) ? 1 : 0)) {
                            var24 = new d(lllIIIllll[82], lllIIIllll[10], lllIIIllll[83]);
                            bv.add(var24);
                            0;
                        }
                    ...
                    var24 = new d(lllIIIllll[17], lllIIIllll[12], lllIIIllll[84]);
                    bv.add(var24);
                    0;
                }
                int[] nArray = new int[lllIIIllll[1]];
                ...
                if (R.llIIIIIIIllII(Bank.contains((int[])nArray) ? 1 : 0)) {
                    var24 = new d(lllIIIllll[11], lllIIIllll[4], j.cf);
                    bv.add(var24);
                    0;
                }
                int[] nArray7 = new int[lllIIIllll[1]];
            ...
            var24 = new d(lllIIIllll[6], lllIIIllll[54], lllIIIllll[85]);
            bv.add(var24);
            0;
        }
    }
    ...
    private static void dw() {
        ...
        if (R.llIIIIIIIllIl(var1) && R.llIIIIIIIlIlI(var1.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            if (R.llIIIIIIIllII(Bank.isOpen() ? 1 : 0)) {
                a.a();
                Time.sleepUntil(() -> Bank.isOpen(), (int)lllIIIllll[2]);
                0;
    ...
    private static String lIlllllllIlIl(String var27, String var7) {
        ...
        int var19 = lllIIIllll[0];
        char[] var13 = var27.toCharArray();
        int var2 = var13.length;
        int var4 = lllIIIllll[0];
        while (R.llIIIIIIIlIll(var4, var2)) {
            char var10 = var13[var4];
            var17.append((char)(var10 ^ var22[var19 % var22.length]));
            0;
            ++var19;
            ++var4;
            0;
    ...
    private static boolean an() {
        ...
        int[] nArray2 = nArray;
        int var8 = lllIIIllll[0];
        while (R.llIIIIIIIlIll(var8, ((void)var21).length)) {
            int[] nArray3 = new int[lllIIIllll[1]];
            nArray3[R.lllIIIllll[0]] = var21[var8];
            ...
            return ((67 + 87 - -4 + 7 ^ 46 + 108 - 135 + 129) & (0x67 ^ 0x4F ^ (0x5C ^ 0x45) ^ -1)) != 0;
        }
        return lllIIIllll[1];
    }
    ...
    private static String lIlllllllIllI(String var23, String var12) {
        try {
            SecretKeySpec var15 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var12.getBytes(StandardCharsets.UTF_8)), lllIIIllll[19]), "DES");
            Cipher var18 = Cipher.getInstance("DES");
            var18.init(lllIIIllll[3], var15);
    ...
    private static void lIllllllllIll() {
        ...
        R.lllIIIllII[R.lllIIIllll[0]] = R."Finished buying items, switching back to quest";
        R.lllIIIllII[R.lllIIIllll[1]] = R."Nav to bank";
        R.lllIIIllII[R.lllIIIllll[3]] = R."Handling banking";
        R.lllIIIllII[R.lllIIIllll[5]] = R."We are missing quest supplies, switching to BUYING";
        R.lllIIIllII[R.lllIIIllll[4]] = R."We are missing quest supplies, switching to BUYING";
        R.lllIIIllII[R.lllIIIllll[10]] = R."Wear";
        R.lllIIIllII[R.lllIIIllll[16]] = R."Drink";
        R.lllIIIllII[R.lllIIIllll[18]] = R."Eat";
        R.lllIIIllII[R.lllIIIllll[19]] = R."Nav to start";
        R.lllIIIllII[R.lllIIIllll[20]] = R."Aris";
        R.lllIIIllII[R.lllIIIllll[12]] = R."Nav to sir pyrsin";
        R.lllIIIllII[R.lllIIIllll[23]] = R."Sir Prysin";
        R.lllIIIllII[R.lllIIIllll[25]] = R."Silverlight";
        R.lllIIIllII[R.lllIIIllll[26]] = R."Nav to captain";
        R.lllIIIllII[R.lllIIIllll[27]] = R."Captain Rovin";
        R.lllIIIllII[R.lllIIIllll[28]] = R."Bucket of water";
        R.lllIIIllII[R.lllIIIllll[29]] = R."Nav to drain";
        R.lllIIIllII[R.lllIIIllll[30]] = R."Bucket of water";
        R.lllIIIllII[R.lllIIIllll[31]] = R."Drain";
        R.lllIIIllII[R.lllIIIllll[32]] = R."Bucket of water";
        R.lllIIIllII[R.lllIIIllll[33]] = R."Nav to sewer key";
        R.lllIIIllII[R.lllIIIllll[34]] = R."Manhole";
        R.lllIIIllII[R.lllIIIllll[35]] = R."Manhole";
        R.lllIIIllII[R.lllIIIllll[36]] = R."Open";
        R.lllIIIllII[R.lllIIIllll[37]] = R."Manhole";
        R.lllIIIllII[R.lllIIIllll[9]] = R."Open";
        R.lllIIIllII[R.lllIIIllll[38]] = R."Manhole";
        R.lllIIIllII[R.lllIIIllll[39]] = R."Manhole";
        R.lllIIIllII[R.lllIIIllll[40]] = R."Climb-down";
        R.lllIIIllII[R.lllIIIllll[41]] = R."Manhole";
        R.lllIIIllII[R.lllIIIllll[42]] = R."Climb-down";
        R.lllIIIllII[R.lllIIIllll[43]] = R."Rusty key";
        R.lllIIIllII[R.lllIIIllll[44]] = R."Rusty key";
        R.lllIIIllII[R.lllIIIllll[45]] = R."Take";
        R.lllIIIllII[R.lllIIIllll[47]] = R."Silverlight";
        R.lllIIIllII[R.lllIIIllll[49]] = R."Bones";
        R.lllIIIllII[R.lllIIIllll[50]] = R."Bones";
        R.lllIIIllII[R.lllIIIllll[51]] = R."Nav to wizard";
        R.lllIIIllII[R.lllIIIllll[52]] = R."Wizard Traiborn";
        R.lllIIIllII[R.lllIIIllll[53]] = R."Silverlight";
        R.lllIIIllII[R.lllIIIllll[54]] = R."Nav to sir pyrsin";
        R.lllIIIllII[R.lllIIIllll[55]] = R."Sir Prysin";
        R.lllIIIllII[R.lllIIIllll[56]] = R."Silverlight";
        R.lllIIIllII[R.lllIIIllll[57]] = R."Delrith";
        R.lllIIIllII[R.lllIIIllll[58]] = R."Weakened Delrith";
        R.lllIIIllII[R.lllIIIllll[59]] = R."Nav to demon";
        R.lllIIIllII[R.lllIIIllll[60]] = R."Delrith";
        R.lllIIIllII[R.lllIIIllll[61]] = R."Weakened Delrith";
        R.lllIIIllII[R.lllIIIllll[62]] = R."Attack";
        R.lllIIIllII[R.lllIIIllll[63]] = R."Delrith";
        R.lllIIIllII[R.lllIIIllll[15]] = R."Delrith";
        R.lllIIIllII[R.lllIIIllll[64]] = R."Delrith";
        R.lllIIIllII[R.lllIIIllll[65]] = R."Attack";
        R.lllIIIllII[R.lllIIIllll[66]] = R."Banishing";
        R.lllIIIllII[R.lllIIIllll[67]] = R."[";
        R.lllIIIllII[R.lllIIIllll[68]] = R."Weakened Delrith";
        R.lllIIIllII[R.lllIIIllll[69]] = R."Banishing";
        R.lllIIIllII[R.lllIIIllll[75]] = R.", ";
        R.lllIIIllII[R.lllIIIllll[76]] = R."Nav to bank";
        R.lllIIIllII[R.lllIIIllll[77]] = R."Handling banking";
        R.lllIIIllII[R.lllIIIllll[79]] = R."Wear";
        R.lllIIIllII[R.lllIIIllll[87]] = R."Demon Slayer";
        R.lllIIIllII[R.lllIIIllll[88]] = R."ring of wealth (";
        R.lllIIIllII[R.lllIIIllll[89]] = R."wizard";
        R.lllIIIllII[R.lllIIIllll[90]] = R."Now what was that incantation again?";
        R.lllIIIllII[R.lllIIIllll[103]] = R."Yes.";
        R.lllIIIllII[R.lllIIIllll[104]] = R."The Demon Slayer Quest";
        R.lllIIIllII[R.lllIIIllll[105]] = R."Okay, where is he? I'll kill him for you!";
        R.lllIIIllII[R.lllIIIllll[106]] = R."So how did Wally kill Delrith?";
        R.lllIIIllII[R.lllIIIllll[107]] = R."What is the magical incantation?";
        R.lllIIIllII[R.lllIIIllll[108]] = R."Aris said I should come and talk to you.";
        R.lllIIIllII[R.lllIIIllll[109]] = R."I need to find Silverlight.";
        R.lllIIIllII[R.lllIIIllll[110]] = R."He's back and unfortunately I've got to deal with him.";
        R.lllIIIllII[R.lllIIIllll[111]] = R."So give me the keys!";
        R.lllIIIllII[R.lllIIIllll[112]] = R."Yes I know, but this is important.";
        R.lllIIIllII[R.lllIIIllll[113]] = R."There's a demon who wants to invade this city.";
        R.lllIIIllII[R.lllIIIllll[114]] = R."Yes, very.";
        R.lllIIIllII[R.lllIIIllll[115]] = R."It's not them who are going to fight the demon, it's me.";
        R.lllIIIllII[R.lllIIIllll[116]] = R."Sir Prysin said you would give me the key.";
        R.lllIIIllII[R.lllIIIllll[117]] = R."Why did he give you one of the keys then?";
        R.lllIIIllII[R.lllIIIllll[118]] = R."Talk about Demon Slayer.";
        R.lllIIIllII[R.lllIIIllll[119]] = R."Well, have you got any keys knocking around?";
        R.lllIIIllII[R.lllIIIllll[120]] = R."I'll get the bones for you.";
    }
    ...
    private static String lIlllllllIlII(String var5, String var3) {
        try {
