...
public class q_Unknown {
    ...
    private static void g(String string) {
        block52: {
                    ...
                    block51: {
                        block54: {
                            block55: {
                                ...
                                if (!q.lIlIlIIlIIlIl(var28) || !q.lIlIlIIIllIIl(var28.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block52;
                                ...
                                if (!q.lIlIlIIIllIIl(var16.equalsIgnoreCase(llIIlIIIlI[llIIlIIIll[121]]) ? 1 : 0)) break block53;
            ...
            while (q.lIlIlIIIllIlI(h.bu ? 1 : 0) && q.lIlIlIIIllIlI(AccBuilderSotf.d ? 1 : 0)) {
                if (q.lIlIlIIIllIIl(var16.equalsIgnoreCase(llIIlIIIlI[llIIlIIIll[129]]) ? 1 : 0)) {
                    h.d(llIIlIIIlI[llIIlIIIll[130]]);
                }
                if (q.lIlIlIIIllIIl(var16.equalsIgnoreCase(llIIlIIIlI[llIIlIIIll[131]]) ? 1 : 0)) {
            ...
            if (q.lIlIlIIIllIIl(var16.equalsIgnoreCase(llIIlIIIlI[llIIlIIIll[133]]) ? 1 : 0)) {
                int[] nArray = new int[llIIlIIIll[0]];
                nArray[q.llIIlIIIll[3]] = llIIlIIIll[92];
            ...
            if (q.lIlIlIIIllIIl(q.an() ? 1 : 0) && (!q.lIlIlIIIllIlI(q.f(llIIlIIIlI[llIIlIIIll[139]]) ? 1 : 0) || q.lIlIlIIIllIIl(q.f(llIIlIIIlI[llIIlIIIll[140]]) ? 1 : 0))) {
                ...
                if (q.lIlIlIIIllIIl(cT.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (q.lIlIlIIIllIIl(var16.equalsIgnoreCase(llIIlIIIlI[llIIlIIIll[145]]) ? 1 : 0)) {
                        Bank.withdrawAll((int)llIIlIIIll[92], (Bank.WithdrawMode)Bank.WithdrawMode.ITEM);
                        Time.sleepTicks((int)llIIlIIIll[4]);
                        0;
                    }
    ...
    private static String lIlIlIIIlIIlI(String var19, String var27) {
        try {
            SecretKeySpec var24 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var27.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var38 = Cipher.getInstance("Blowfish");
            var38.init(llIIlIIIll[4], var24);
            return new String(var38.doFinal(Base64.getDecoder().decode(var19.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlIlIIIlIIll(String var39, String var33) {
        try {
            SecretKeySpec var4 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var33.getBytes(StandardCharsets.UTF_8)), llIIlIIIll[11]), "DES");
            Cipher var6 = Cipher.getInstance("DES");
            var6.init(llIIlIIIll[4], var4);
            return new String(var6.doFinal(Base64.getDecoder().decode(var39.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void e(String string) {
        ...
        if (q.lIlIlIIIllIlI(bt ? 1 : 0)) {
            String var37;
            if (q.lIlIlIIIllIlI(q.f(var37) ? 1 : 0) && q.lIlIlIIIllIIl(Static.getClient().isInInstancedRegion() ? 1 : 0)) {
            ...
            if ((!q.lIlIlIIIllIIl(q.f(var37) ? 1 : 0) || q.lIlIlIIIllIlI(Inventory.contains(item -> {
                int n2;
                ...
                if (q.lIlIlIIIllIIl(var37.equalsIgnoreCase(llIIlIIIlI[llIIlIIIll[11]]) ? 1 : 0)) {
                    q.g(llIIlIIIlI[llIIlIIIll[12]]);
                }
                if (q.lIlIlIIIllIIl(var37.equalsIgnoreCase(llIIlIIIlI[llIIlIIIll[13]]) ? 1 : 0)) {
                    q.g(llIIlIIIlI[llIIlIIIll[14]]);
                }
            }
            if (q.lIlIlIIIllIIl(q.f(var37) ? 1 : 0) && q.lIlIlIIIlllII(Vars.getBit((int)cX), llIIlIIIll[15]) && q.lIlIlIIIllIIl(cT.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                int[] nArray = new int[llIIlIIIll[0]];
            ...
            if (q.lIlIlIIIllIIl(q.f(var37) ? 1 : 0) && q.lIlIlIIIllIlI(cT.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && q.lIlIlIIIllIlI(Static.getClient().isInInstancedRegion() ? 1 : 0)) {
                q.g(var37);
            }
            if (q.lIlIlIIIllIIl(q.f(var37) ? 1 : 0) && q.lIlIlIIIllIIl(Inventory.contains(item -> {
                int n2;
                ...
                if (q.lIlIlIIlIIlll(Players.getLocal().getWorldLocation().distanceTo(cV), llIIlIIIll[13])) {
                    if (q.lIlIlIIIllllI(Vars.getBit((int)cX), llIIlIIIll[15]) && q.lIlIlIIIlllII(Vars.getBit((int)cW), llIIlIIIll[27]) && q.lIlIlIIIllllI(e.j(llIIlIIIll[1]), llIIlIIIll[2])) {
                        while (q.lIlIlIIIlllII(Vars.getBit((int)cW), llIIlIIIll[27]) && q.lIlIlIIIllllI(e.j(llIIlIIIll[1]), llIIlIIIll[2]) && q.lIlIlIIIllIlI(AccBuilderSotf.d ? 1 : 0)) {
                            ...
                            if (q.lIlIlIIIllIlI(Widgets.get((int)llIIlIIIll[28]).isEmpty() ? 1 : 0)) {
                                var18 = Widgets.get((int)llIIlIIIll[28], (int)llIIlIIIll[4]).getChild(llIIlIIIll[7]);
                                Widget var26 = Widgets.get((int)llIIlIIIll[28], (int)llIIlIIIll[9]).getChild(llIIlIIIll[9]);
                                if (q.lIlIlIIlIIlIl(var26)) {
                                    AccBuilderSotf.c = llIIlIIIlI[llIIlIIIll[32]];
                                    var26.interact(llIIlIIIlI[llIIlIIIll[33]]);
                                }
                                if (q.lIlIlIIlIlIII(var26)) {
                    ...
                    if (q.lIlIlIIIllllI(Vars.getBit((int)llIIlIIIll[58]), llIIlIIIll[15]) && q.lIlIlIIlIlIIl(Vars.getBit((int)llIIlIIIll[48]))) {
                        ...
                        if (q.lIlIlIIIllIlI(Widgets.get((int)llIIlIIIll[59]).isEmpty() ? 1 : 0)) {
                            ...
                            var18 = Widgets.get((int)llIIlIIIll[59], (int)llIIlIIIll[9]);
                            int var26 = llIIlIIIll[63];
                            int var35 = llIIlIIIll[64];
                            int var8 = llIIlIIIll[3];
                            int var31 = llIIlIIIll[3];
                            Widget[] var1 = Widgets.get((int)llIIlIIIll[59], (int)llIIlIIIll[18]).getChildren();
                            int var34 = llIIlIIIll[3];
                            while (q.lIlIlIIIlllII(var34, var1.length)) {
                                if (q.lIlIlIIlIlIll(var1[var34].getTextColor(), var35)) {
                                    ++var31;
                                    0;
                                    if (3 < 0) {
                                        return;
                            ...
                            if (q.lIlIlIIlIIllI(var31, llIIlIIIll[8]) && q.lIlIlIIlIIlIl(var34 = Widgets.get((int)llIIlIIIll[59], (int)llIIlIIIll[11]))) {
                                Mouse.click((int)var34.getClickPoint().getX(), (int)var34.getClickPoint().getY(), (boolean)llIIlIIIll[0]);
                                Time.sleepTicks((int)llIIlIIIll[0]);
                                0;
                            }
                            if (q.lIlIlIIIlllII(var31, llIIlIIIll[8])) {
                                var34 = llIIlIIIll[3];
                                int var36 = llIIlIIIll[3];
                                int var17 = llIIlIIIll[3];
                                int var15 = llIIlIIIll[3];
                                int var30 = llIIlIIIll[3];
                                int var21 = llIIlIIIll[3];
                                while (q.lIlIlIIIlllII(var21, var1.length)) {
                                    if (q.lIlIlIIIllIIl(var1[var21].getName().contains(llIIlIIIlI[llIIlIIIll[65]]) ? 1 : 0) && q.lIlIlIIIllIlI(var34)) {
                                        AccBuilderSotf.c = llIIlIIIlI[llIIlIIIll[66]];
                                        var1[var21].interact(llIIlIIIlI[llIIlIIIll[67]]);
                                        Time.sleepTicks((int)llIIlIIIll[0]);
                                        0;
                                        var34 = llIIlIIIll[0];
                                    }
                                    if (q.lIlIlIIIllIIl(var1[var21].getName().contains(llIIlIIIlI[llIIlIIIll[68]]) ? 1 : 0) && q.lIlIlIIIllIlI(var36)) {
                                        AccBuilderSotf.c = llIIlIIIlI[llIIlIIIll[69]];
                                        var1[var21].interact(llIIlIIIlI[llIIlIIIll[70]]);
                                        Time.sleepTicks((int)llIIlIIIll[0]);
                                        0;
                                        var36 = llIIlIIIll[0];
                                    }
                                    if (q.lIlIlIIIllIIl(var1[var21].getName().contains(llIIlIIIlI[llIIlIIIll[71]]) ? 1 : 0) && q.lIlIlIIIllIlI(var17)) {
                                        AccBuilderSotf.c = llIIlIIIlI[llIIlIIIll[72]];
                                        var1[var21].interact(llIIlIIIlI[llIIlIIIll[73]]);
                                        Time.sleepTicks((int)llIIlIIIll[0]);
                                        0;
                                        var17 = llIIlIIIll[0];
                                    }
                                    if (q.lIlIlIIIllIIl(var1[var21].getName().contains(llIIlIIIlI[llIIlIIIll[74]]) ? 1 : 0) && q.lIlIlIIIllIlI(var15)) {
                                        AccBuilderSotf.c = llIIlIIIlI[llIIlIIIll[75]];
                                        var1[var21].interact(llIIlIIIlI[llIIlIIIll[76]]);
                                        Time.sleepTicks((int)llIIlIIIll[0]);
                                        0;
                                        var15 = llIIlIIIll[0];
                                    }
                                    if (q.lIlIlIIIllIIl(var1[var21].getName().contains(llIIlIIIlI[llIIlIIIll[77]]) ? 1 : 0) && q.lIlIlIIIllIlI(var30)) {
                                        AccBuilderSotf.c = llIIlIIIlI[llIIlIIIll[78]];
                                        var1[var21].interact(llIIlIIIlI[llIIlIIIll[79]]);
                                        Time.sleepTicks((int)llIIlIIIll[0]);
                                        0;
                                        var30 = llIIlIIIll[0];
                                    }
                            ...
                            if (q.lIlIlIIlIlIll(var31, llIIlIIIll[8])) {
                                AccBuilderSotf.c = llIIlIIIlI[llIIlIIIll[80]];
                                if (q.lIlIlIIlIIlIl(var18)) {
                                    Mouse.click((int)var18.getClickPoint().getX(), (int)var18.getClickPoint().getY(), (boolean)llIIlIIIll[0]);
                ...
                if (q.lIlIlIIIllIIl(Static.getClient().isInInstancedRegion() ? 1 : 0) && q.lIlIlIIlIIlIl(cR)) {
                    ...
                    if (q.lIlIlIIlIIlll(Players.getLocal().getWorldLocation().distanceTo(cS), llIIlIIIll[5])) {
                        ...
                        if (q.lIlIlIIlIlIII(TileObjects.getNearest((String[])stringArray13))) {
                            ...
                            var18 = NPCs.getAll(nPC -> nPC.getName().contains(llIIlIIIlI[llIIlIIIll[204]]));
                            if (q.lIlIlIIIllllI(var18.size(), llIIlIIIll[5]) && q.lIlIlIIlIlIII(Players.getLocal().getInteracting())) {
                                ((NPC)var18.get(llIIlIIIll[3])).interact(llIIlIIIlI[llIIlIIIll[87]]);
                                Time.sleepTicks((int)llIIlIIIll[4]);
                                0;
                            }
                            if (q.lIlIlIIlIIlIl(var26 = Inventory.getFirst(item -> item.getName().contains(llIIlIIIlI[llIIlIIIll[203]]))) && q.lIlIlIIlIlIll(Skills.getLevel((Skill)Skill.STRENGTH), Skills.getBoostedLevel((Skill)Skill.STRENGTH)) && q.lIlIlIIIllllI(Skills.getBoostedLevel((Skill)Skill.HITPOINTS), llIIlIIIll[65])) {
                                var26.interact(llIIlIIIlI[llIIlIIIll[88]]);
                                Time.sleepTicks((int)llIIlIIIll[5]);
                                0;
                                ...
                                block40: {
                                    block39: {
                                        block37: {
                                                                                ...
                                                                                block27: {
                                                                                    block29: {
                                                                                        block28: {
                                                                                            ...
                                                                                            if (!q.lIlIlIIIllIIl(var10.equalsIgnoreCase(llIIlIIIlI[llIIlIIIll[95]]) ? 1 : 0)) break block25;
                                            ...
                                            if (!q.lIlIlIIIllIIl(var10.equalsIgnoreCase(llIIlIIIlI[llIIlIIIll[110]]) ? 1 : 0)) return llIIlIIIll[3];
                                            int[] nArray = new int[llIIlIIIll[0]];
        ...
        block53: {
            ...
            block55: {
                block54: {
                    ...
                    block52: {
                        ...
                        var12 = new d(llIIlIIIll[152], llIIlIIIll[13], j.cf);
                        bv.add(var12);
                        0;
                    }
                    int[] nArray = new int[llIIlIIIll[0]];
                    ...
                    if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray) ? 1 : 0)) {
                        var12 = new d(llIIlIIIll[164], llIIlIIIll[13], llIIlIIIll[165]);
                        bv.add(var12);
                        0;
                    }
                    int[] nArray4 = new int[llIIlIIIll[0]];
                    ...
                    if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray4) ? 1 : 0)) {
                        var12 = new d(llIIlIIIll[153], llIIlIIIll[50], llIIlIIIll[166]);
                        bv.add(var12);
                        0;
                    }
                    int[] nArray5 = new int[llIIlIIIll[0]];
                    ...
                    if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray5) ? 1 : 0)) {
                        var12 = new d(llIIlIIIll[151], llIIlIIIll[50], llIIlIIIll[166]);
                        bv.add(var12);
                        0;
                    }
                    if (q.lIlIlIIIllIIl(var11.equalsIgnoreCase(llIIlIIIlI[llIIlIIIll[167]]) ? 1 : 0)) {
                        int[] nArray6 = new int[llIIlIIIll[0]];
                        nArray6[q.llIIlIIIll[3]] = llIIlIIIll[105];
                        if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray6) ? 1 : 0)) {
                            var12 = new d(llIIlIIIll[105], llIIlIIIll[0], llIIlIIIll[168]);
                            bv.add(var12);
                            0;
                        }
                        if (q.lIlIlIIIllllI(Skills.getLevel((Skill)Skill.ATTACK), llIIlIIIll[74]) && q.lIlIlIIIllllI(Skills.getLevel((Skill)Skill.DEFENCE), llIIlIIIll[74]) && q.lIlIlIIIllllI(Skills.getLevel((Skill)Skill.STRENGTH), llIIlIIIll[74])) {
                            ...
                            if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray7) ? 1 : 0)) {
                                var12 = new d(llIIlIIIll[111], llIIlIIIll[0], e.c(llIIlIIIll[169], llIIlIIIll[170]));
                                bv.add(var12);
                                0;
                            }
                            int[] nArray8 = new int[llIIlIIIll[0]];
                            ...
                            if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray8) ? 1 : 0)) {
                                var12 = new d(llIIlIIIll[171], llIIlIIIll[0], e.c(llIIlIIIll[172], llIIlIIIll[173]));
                                bv.add(var12);
                                0;
                            }
                            int[] nArray9 = new int[llIIlIIIll[0]];
                            ...
                            if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray9) ? 1 : 0)) {
                                var12 = new d(llIIlIIIll[116], llIIlIIIll[0], e.c(llIIlIIIll[174], llIIlIIIll[175]));
                                bv.add(var12);
                                0;
                            }
                            int[] nArray10 = new int[llIIlIIIll[0]];
                            ...
                            if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray10) ? 1 : 0)) {
                                var12 = new d(llIIlIIIll[114], llIIlIIIll[0], e.c(llIIlIIIll[174], llIIlIIIll[175]));
                                bv.add(var12);
                                0;
                            }
                            int[] nArray11 = new int[llIIlIIIll[0]];
                            ...
                            if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray11) ? 1 : 0)) {
                                var12 = new d(llIIlIIIll[112], llIIlIIIll[0], e.c(llIIlIIIll[176], llIIlIIIll[177]));
                                bv.add(var12);
                                0;
                            }
                            int[] nArray12 = new int[llIIlIIIll[0]];
                            ...
                            if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray12) ? 1 : 0)) {
                                var12 = new d(llIIlIIIll[113], llIIlIIIll[0], e.c(llIIlIIIll[178], llIIlIIIll[179]));
                                bv.add(var12);
                                0;
                            }
                            int[] nArray13 = new int[llIIlIIIll[0]];
                            ...
                            if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray13) ? 1 : 0)) {
                                var12 = new d(llIIlIIIll[115], llIIlIIIll[0], e.c(llIIlIIIll[180], llIIlIIIll[181]));
                                bv.add(var12);
                                0;
                            }
                            int[] nArray14 = new int[llIIlIIIll[0]];
                            ...
                            if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray14) ? 1 : 0)) {
                                var12 = new d(llIIlIIIll[117], llIIlIIIll[0], e.c(llIIlIIIll[182], llIIlIIIll[183]));
                                bv.add(var12);
                                0;
                            }
                        }
                    }
                    if (!q.lIlIlIIIllIIl(var11.equalsIgnoreCase(llIIlIIIlI[llIIlIIIll[184]]) ? 1 : 0)) break block53;
                    int[] nArray15 = new int[llIIlIIIll[0]];
                    ...
                    if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray15) ? 1 : 0)) {
                        ...
                        if (q.lIlIlIIIllIlI(Equipment.contains((int[])nArray16) ? 1 : 0)) {
                            var12 = new d(llIIlIIIll[103], llIIlIIIll[0], e.c(llIIlIIIll[185], llIIlIIIll[186]));
                            bv.add(var12);
                            0;
                        }
                    }
                    ...
                    if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray17) ? 1 : 0)) {
                        var12 = new d(llIIlIIIll[100], llIIlIIIll[4], llIIlIIIll[187]);
                        bv.add(var12);
                        0;
                    }
                    int[] nArray18 = new int[llIIlIIIll[0]];
                    ...
                    if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray18) ? 1 : 0)) {
                        var12 = new d(llIIlIIIll[98], llIIlIIIll[4], llIIlIIIll[187]);
                        bv.add(var12);
                        0;
                    }
                    int[] nArray19 = new int[llIIlIIIll[0]];
                ...
                var12 = new d(llIIlIIIll[92], llIIlIIIll[188], e.c(llIIlIIIll[189], llIIlIIIll[190]));
                bv.add(var12);
                0;
            }
            int[] nArray = new int[llIIlIIIll[0]];
            ...
            if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (q.lIlIlIIIllIlI(Equipment.contains((int[])nArray22) ? 1 : 0)) {
                    ...
                    if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray23) ? 1 : 0)) {
                        var12 = new d(llIIlIIIll[122], llIIlIIIll[0], e.c(llIIlIIIll[191], llIIlIIIll[192]));
                        bv.add(var12);
                        0;
                    }
                    int[] nArray24 = new int[llIIlIIIll[0]];
                    ...
                    if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray24) ? 1 : 0)) {
                        var12 = new d(llIIlIIIll[101], llIIlIIIll[4], llIIlIIIll[187]);
                        bv.add(var12);
                        0;
                    }
                }
            ...
            if (q.lIlIlIIIlllII(Skills.getBoostedLevel((Skill)Skill.RANGED), llIIlIIIll[74])) {
                ...
                if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray25) ? 1 : 0)) {
                    var12 = new d(llIIlIIIll[97], llIIlIIIll[4], llIIlIIIll[187]);
                    bv.add(var12);
                    0;
                }
                int[] nArray26 = new int[llIIlIIIll[0]];
                ...
                if (q.lIlIlIIIllIIl(Bank.contains((int[])nArray26) ? 1 : 0)) {
                    ...
                    if (q.lIlIlIIIlllII(Bank.getFirst((int[])nArray27).getQuantity(), llIIlIIIll[4])) {
                        ...
                        var12 = new d(llIIlIIIll[97], llIIlIIIll[4] - Bank.getFirst((int[])nArray28).getQuantity(), llIIlIIIll[187]);
                        bv.add(var12);
                        0;
                    }
                }
                ...
                if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray29) ? 1 : 0)) {
                    var12 = new d(llIIlIIIll[96], llIIlIIIll[4], llIIlIIIll[187]);
                    bv.add(var12);
                    0;
                }
                int[] nArray30 = new int[llIIlIIIll[0]];
                ...
                if (q.lIlIlIIIllIIl(Bank.contains((int[])nArray30) ? 1 : 0)) {
                    ...
                    if (q.lIlIlIIIlllII(Bank.getFirst((int[])nArray31).getQuantity(), llIIlIIIll[4])) {
                        ...
                        var12 = new d(llIIlIIIll[96], llIIlIIIll[4] - Bank.getFirst((int[])nArray32).getQuantity(), llIIlIIIll[187]);
                        bv.add(var12);
                        0;
                    }
                }
            ...
            if (q.lIlIlIIIllllI(Skills.getLevel((Skill)Skill.RANGED), llIIlIIIll[74]) && q.lIlIlIIIlllII(Skills.getLevel((Skill)Skill.RANGED), llIIlIIIll[84])) {
                ...
                if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray33) ? 1 : 0)) {
                    var12 = new d(llIIlIIIll[107], llIIlIIIll[4], llIIlIIIll[193]);
                    bv.add(var12);
                    0;
                }
                ...
                if (q.lIlIlIIIllIIl(Bank.contains((int[])nArray34) ? 1 : 0)) {
                    ...
                    if (q.lIlIlIIIlllII(Bank.getFirst((int[])nArray35).getQuantity(), llIIlIIIll[4])) {
                        ...
                        var12 = new d(llIIlIIIll[107], llIIlIIIll[4] - Bank.getFirst((int[])nArray36).getQuantity(), llIIlIIIll[193]);
                        bv.add(var12);
                        0;
                    }
                }
                ...
                if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray37) ? 1 : 0)) {
                    var12 = new d(llIIlIIIll[106], llIIlIIIll[4], llIIlIIIll[194]);
                    bv.add(var12);
                    0;
                }
                ...
                if (q.lIlIlIIIllIIl(Bank.contains((int[])nArray38) ? 1 : 0)) {
                    ...
                    if (q.lIlIlIIIlllII(Bank.getFirst((int[])nArray39).getQuantity(), llIIlIIIll[4])) {
                        ...
                        var12 = new d(llIIlIIIll[106], llIIlIIIll[4] - Bank.getFirst((int[])nArray40).getQuantity(), llIIlIIIll[194]);
                        bv.add(var12);
                        0;
                    }
                }
            ...
            if (q.lIlIlIIIllllI(Skills.getLevel((Skill)Skill.RANGED), llIIlIIIll[84])) {
                ...
                if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray41) ? 1 : 0)) {
                    var12 = new d(llIIlIIIll[109], llIIlIIIll[4], llIIlIIIll[193]);
                    bv.add(var12);
                    0;
                }
                ...
                if (q.lIlIlIIIllIIl(Bank.contains((int[])nArray42) ? 1 : 0)) {
                    ...
                    if (q.lIlIlIIIlllII(Bank.getFirst((int[])nArray43).getQuantity(), llIIlIIIll[4])) {
                        ...
                        var12 = new d(llIIlIIIll[109], llIIlIIIll[4] - Bank.getFirst((int[])nArray44).getQuantity(), llIIlIIIll[193]);
                        bv.add(var12);
                        0;
                    }
                }
                ...
                if (q.lIlIlIIIllIlI(Bank.contains((int[])nArray45) ? 1 : 0)) {
                    var12 = new d(llIIlIIIll[108], llIIlIIIll[4], llIIlIIIll[6]);
                    bv.add(var12);
                    0;
                }
                ...
                if (q.lIlIlIIIllIIl(Bank.contains((int[])nArray46) ? 1 : 0)) {
                    ...
                    if (q.lIlIlIIIlllII(Bank.getFirst((int[])nArray47).getQuantity(), llIIlIIIll[4])) {
                        ...
                        var12 = new d(llIIlIIIll[108], llIIlIIIll[4] - Bank.getFirst((int[])nArray48).getQuantity(), llIIlIIIll[6]);
                        bv.add(var12);
                        0;
                    }
                }
    ...
    private static void aR() {
        ...
        if (q.lIlIlIIlIIlIl(var5) && q.lIlIlIIlIIlll(Vars.getBit((int)llIIlIIIll[156]), llIIlIIIll[62]) && q.lIlIlIIlIllIl(Skills.getLevel((Skill)Skill.STRENGTH), Skills.getBoostedLevel((Skill)Skill.STRENGTH)) && q.lIlIlIIIlllII(Skills.getBoostedLevel((Skill)Skill.HITPOINTS), llIIlIIIll[65])) {
            while (q.lIlIlIIIlllII(Vars.getBit((int)llIIlIIIll[156]), llIIlIIIll[157])) {
                if (q.lIlIlIIlIIlIl(var5)) {
                    var5.interact(llIIlIIIlI[llIIlIIIll[158]]);
                    Time.sleepTicks((int)llIIlIIIll[0]);
                    0;
                }
                if (!q.lIlIlIIlIlIII(var5 = Inventory.getFirst(item -> item.getName().contains(llIIlIIIlI[llIIlIIIll[195]])))) continue;
                0;
        ...
        Item var20 = Inventory.getFirst((String[])stringArray);
        if (q.lIlIlIIlIIlIl(var20) && q.lIlIlIIlIllIl(Skills.getLevel((Skill)Skill.STRENGTH), Skills.getBoostedLevel((Skill)Skill.STRENGTH)) && q.lIlIlIIIlllII(Skills.getBoostedLevel((Skill)Skill.HITPOINTS), llIIlIIIll[65]) && q.lIlIlIIlIIllI(Skills.getBoostedLevel((Skill)Skill.HITPOINTS), llIIlIIIll[0])) {
            var20.interact(llIIlIIIlI[llIIlIIIll[160]]);
            cI = e.c(llIIlIIIll[0], llIIlIIIll[4]);
        }
    }
    ...
    private static String lIlIlIIIlIlII(String var14, String var32) {
        var14 = new String(Base64.getDecoder().decode(var14.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var9 = new StringBuilder();
        char[] var23 = var32.toCharArray();
        int var7 = llIIlIIIll[3];
        char[] var25 = var14.toCharArray();
        int var2 = var25.length;
        int var3 = llIIlIIIll[3];
        while (q.lIlIlIIIlllII(var3, var2)) {
            char var29 = var25[var3];
            var9.append((char)(var29 ^ var23[var7 % var23.length]));
            0;
            ++var7;
            ++var3;
            0;
