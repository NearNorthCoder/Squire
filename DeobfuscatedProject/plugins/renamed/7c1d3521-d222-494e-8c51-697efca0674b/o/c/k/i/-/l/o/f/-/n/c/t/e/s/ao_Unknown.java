...
implements ac {
    ...
    private static String lIllIIIIllIIl(String var4, String var5) {
        var4 = new String(Base64.getDecoder().decode(var4.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var1 = new StringBuilder();
        char[] var7 = var5.toCharArray();
        int var16 = llIlIIIlIl[0];
        char[] var20 = var4.toCharArray();
        int var17 = var20.length;
        int var10 = llIlIIIlIl[0];
        while (ao.lIllIIIIlllIl(var10, var17)) {
            char var22 = var20[var10];
            var1.append((char)(var22 ^ var7[var16 % var7.length]));
            0;
            ++var16;
            ++var10;
            0;
    ...
    private static String lIllIIIIllIII(String var11, String var3) {
        try {
            SecretKeySpec var19 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var3.getBytes(StandardCharsets.UTF_8)), llIlIIIlIl[27]), "DES");
            Cipher var13 = Cipher.getInstance("DES");
            var13.init(llIlIIIlIl[3], var19);
    ...
    public static void Q() {
        ...
        if (ao.lIllIIIIllllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var12 = new d(llIlIIIlIl[8], llIlIIIlIl[1], llIlIIIlIl[5]);
            bv.add((d)var12);
            0;
        }
        int[] nArray3 = new int[llIlIIIlIl[1]];
        ...
        if (ao.lIllIIIIllllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var12 = new d(llIlIIIlIl[9], llIlIIIlIl[1], llIlIIIlIl[35]);
            bv.add((d)var12);
            0;
        }
        int[] nArray4 = new int[llIlIIIlIl[1]];
        ...
        if (ao.lIllIIIIllllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var12 = new d(llIlIIIlIl[10], llIlIIIlIl[1], llIlIIIlIl[36]);
            bv.add((d)var12);
            0;
        }
        int[] nArray5 = new int[llIlIIIlIl[1]];
        ...
        if (ao.lIllIIIIllllI(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var12 = new d(llIlIIIlIl[11], llIlIIIlIl[1], llIlIIIlIl[37]);
            bv.add((d)var12);
            0;
        }
        if (ao.lIllIIIIllllI(Bank.contains((Predicate)(var12 = item -> item.getName().toLowerCase().contains(llIlIIIlII[llIlIIIlIl[43]]))) ? 1 : 0)) {
            var6 = new d(llIlIIIlIl[20], llIlIIIlIl[24], llIlIIIlIl[37]);
            bv.add(var6);
            0;
        }
        int[] nArray6 = new int[llIlIIIlIl[1]];
        ...
        if (ao.lIllIIIIllllI(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var6 = new d(llIlIIIlIl[38], llIlIIIlIl[39], llIlIIIlIl[40]);
            bv.add(var6);
            0;
        }
    }
                            ...
                            block37: {
                                block36: {
                                    block34: {
                                        ...
                                        if (ao.lIllIIIIlllll(var21) && ao.lIllIIIIllllI(var21.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                            AccBuilderSotf.c = llIlIIIlII[llIlIIIlIl[3]];
                                            a.a(var21);
                                        }
                                        if (!ao.lIllIIIIlllll(var21) || !ao.lIllIIIIlllII(var21.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block33;
                ...
                if (ao.lIllIIIIllllI(Inventory.isFull() ? 1 : 0)) {
                    if (ao.lIllIIIIlllIl(Skills.getLevel((Skill)Skill.MINING), llIlIIIlIl[25])) {
                        ...
                        if (ao.lIllIIIIlllII(y.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            var21 = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (int[])ny);
                            if (ao.lIllIIIIllllI(Players.getLocal().isAnimating() ? 1 : 0) && ao.lIllIIIIllllI(Players.getLocal().isMoving() ? 1 : 0) && ao.lIllIIIIlllll(var21)) {
                                var21.interact(llIlIIIlII[llIlIIIlIl[27]]);
                                Time.sleepTicks((int)llIlIIIlIl[3]);
                                0;
                            }
                        }
                    ...
                    if (ao.lIllIIIlIIIIl(Skills.getLevel((Skill)Skill.MINING), llIlIIIlIl[25])) {
                        ...
                        if (ao.lIllIIIIlllII(y.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            var21 = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (int[])nx);
                            if (ao.lIllIIIIllllI(Players.getLocal().isAnimating() ? 1 : 0) && ao.lIllIIIIllllI(Players.getLocal().isMoving() ? 1 : 0) && ao.lIllIIIIlllll(var21)) {
                                var21.interact(llIlIIIlII[llIlIIIlIl[30]]);
                                Time.sleepTicks((int)llIlIIIlIl[3]);
                                0;
                            }
                        }
    ...
    private static String lIllIIIIlIlll(String var14, String var15) {
        try {
            SecretKeySpec var2 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var15.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var8 = Cipher.getInstance("Blowfish");
            var8.init(llIlIIIlIl[3], var2);
