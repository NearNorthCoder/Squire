...
implements ac {
    ...
    private static void aD() {
        ...
        if (o.lIlllIIIlIllI(Inventory.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (o.lIlllIIIlIlll(var3) && o.lIlllIIIlIllI(var3.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                AccBuilderSotf.c = llIllIllll[llIlllIIIl[0]];
                a.a(var3);
            }
            if (o.lIlllIIIlIlll(var3) && o.lIlllIIIllIII(var3.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    public static void aH() {
        ...
        if (o.lIlllIIlIIIIl((int)var4, llIlllIIIl[3])) {
            cC = ct;
            cs = cu;
        }
        if (o.lIlllIIlIIIIl((int)var4, llIlllIIIl[10])) {
            cC = cv;
            cs = cw;
        }
        if (o.lIlllIIlIIIIl((int)var4, llIlllIIIl[12])) {
            cC = cx;
            cs = cy;
        }
        if (o.lIlllIIlIIIIl((int)var4, llIlllIIIl[13])) {
            cC = cz;
            cs = cA;
        }
    }
    ...
    private static String lIlllIIIlIIlI(String var1, String var9) {
        try {
    ...
    public static boolean aG() {
        ...
        if (o.lIlllIIIlIllI(list.isEmpty() ? 1 : 0) && o.lIlllIIIlllIl(list.size(), llIlllIIIl[0])) {
            void var6;
            int var19 = llIlllIIIl[1];
            while (o.lIlllIIIlIlIl(var19, var6.size())) {
                void var11;
                if (o.lIlllIIIllIII(((Player)var6.get(var19)).equals(Players.getLocal()) ? 1 : 0)) {
                    0;
                    if (((0xB ^ 0x4F ^ (0x42 ^ 0x56)) & (1 ^ (0x72 ^ 0x23) ^ -1)) >= (0xBE ^ 0x99 ^ (0x85 ^ 0xA6))) {
                        return ((138 + 83 - 161 + 95 ^ 81 + 143 - 73 + 36) & (0x7E ^ 0x3C ^ (0x42 ^ 0x20) ^ -1)) != 0;
                    }
                } else if (o.lIlllIIIllIII(var11.contains(((Player)var6.get(var19)).getWorldLocation()) ? 1 : 0)) {
                    return llIlllIIIl[0];
                }
                ++var19;
                0;
    ...
    private static String lIlllIIIlIIII(String var25, String var10) {
        try {
            SecretKeySpec var29 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var10.getBytes(StandardCharsets.UTF_8)), llIlllIIIl[16]), "DES");
            Cipher var14 = Cipher.getInstance("DES");
            var14.init(llIlllIIIl[3], var29);
            return new String(var14.doFinal(Base64.getDecoder().decode(var25.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlllIIIlIIIl(String var26, String var18) {
        ...
        int var24 = llIlllIIIl[1];
        char[] var16 = var26.toCharArray();
        int var27 = var16.length;
        int var20 = llIlllIIIl[1];
        while (o.lIlllIIIlIlIl(var20, var27)) {
            char var15 = var16[var20];
            var28.append((char)(var15 ^ var5[var24 % var5.length]));
            0;
            ++var24;
            ++var20;
            0;
    ...
    public static void aE() {
        ...
        if (o.lIlllIIIlllII(o.lIlllIIIllIlI(e.a(cD), llIlllIIIl[9] + cI))) {
            if (o.lIlllIIIlIllI(Players.getLocal().getWorldLocation().equals((Object)cC) ? 1 : 0)) {
                ...
                if (o.lIlllIIIlIllI(cF.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (o.lIlllIIIllllI(Players.getLocal().getWorldLocation().distanceTo(cB), llIlllIIIl[10])) {
                        ...
                        if (o.lIlllIIIlIlll(var17)) {
                            String[] stringArray2 = new String[llIlllIIIl[0]];
                            stringArray2[o.llIlllIIIl[1]] = llIllIllll[llIlllIIIl[16]];
                            if (o.lIlllIIIllIII(var17.hasAction(stringArray2) ? 1 : 0)) {
                                var17.interact(llIllIllll[llIlllIIIl[17]]);
                            ...
                            if (o.lIlllIIIlIllI(var17.hasAction(stringArray3) ? 1 : 0)) {
            ...
            if (o.lIlllIIIllIII(Players.getLocal().getWorldLocation().equals((Object)cC) ? 1 : 0)) {
                ...
                if (o.lIlllIIIllIII(o.aG() ? 1 : 0)) {
                    var17 = new WorldArea(cC, llIlllIIIl[3], llIlllIIIl[3]);
                    var21 = o.aF();
                    AccBuilderSotf.c = llIllIllll[llIlllIIIl[21]];
                    if (o.lIlllIIIlllll(Players.getLocal().getInteracting()) && o.lIlllIIIlIlll(var21) && o.lIlllIIIlIllI(var21.isDead() ? 1 : 0)) {
                        System.out.println(llIllIllll[llIlllIIIl[22]]);
                        var21.interact(llIllIllll[llIlllIIIl[23]]);
        ...
        if (o.lIlllIIlIIIII(o.lIlllIIIllIlI(e.a(cD), llIlllIIIl[9] + cI))) {
            var17 = new WorldArea(llIlllIIIl[24], llIlllIIIl[25], llIlllIIIl[26], llIlllIIIl[27], llIlllIIIl[1]);
            var21 = new WorldPoint(llIlllIIIl[28], llIlllIIIl[29], llIlllIIIl[1]);
            if (o.lIlllIIIllIII(var17.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && o.lIlllIIIlllIl(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var21), llIlllIIIl[13])) {
    ...
    static NPC aF() {
        ...
        if (o.lIlllIIIlIlll(list)) {
            ...
            int var13 = llIlllIIIl[1];
            while (o.lIlllIIIlIlIl(var13, var2.size())) {
                void var22;
                if (o.lIlllIIIllIII(var22.contains(((NPC)var2.get(var13)).getWorldLocation()) ? 1 : 0)) {
                    return (NPC)var2.get(var13);
                }
                ++var13;
                0;
