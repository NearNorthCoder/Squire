...
implements ac {
    ...
    public static void b(int[] nArray) {
        if (ar.lIlIlIllIlIIl(Inventory.contains((int[])nArray) ? 1 : 0) && ar.lIlIlIllIlIll(Equipment.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (ar.lIlIlIllIlIIl(Inventory.getFirst((int[])var47).hasAction(stringArray2) ? 1 : 0)) {
                Inventory.getFirst((int[])var47).interact(llIIlIlIlI[llIIlIllIl[203]]);
            }
            String[] stringArray3 = new String[llIIlIllIl[1]];
            stringArray3[ar.llIIlIllIl[0]] = llIIlIlIlI[llIIlIllIl[204]];
            if (ar.lIlIlIllIlIIl(Inventory.getFirst((int[])var47).hasAction(stringArray3) ? 1 : 0)) {
                Inventory.getFirst((int[])var47).interact(llIIlIlIlI[llIIlIllIl[205]]);
            }
        }
    }
    ...
    private static List<WorldPoint> a(as as2) {
        void var1_1;
        as var20;
        ArrayList<WorldPoint> var31 = new ArrayList<WorldPoint>();
        while (ar.lIlIlIllIlllI(var20)) {
            var31.add(var20.nT);
            0;
            var20 = var20.nU;
            0;
    ...
    public static void gc() {
        ...
        block117: {
            ...
            block118: {
                ...
                block120: {
                    block119: {
                                                            ...
                                                            block108: {
                                                                block107: {
                                                                    ...
                                                                    block105: {
                                                                        ...
                                                                        if (ar.lIlIlIllIllII(Players.getLocal().getWorldLocation().distanceTo(b.I), llIIlIllIl[27])) {
                                                                            ...
                                                                            if (ar.lIlIlIllIllll(TileObjects.getNearest((String[])stringArray))) {
                                                                                ...
                                                                                var33 = TileObjects.getNearest((Predicate)var16);
                                                                                if (ar.lIlIlIllIlllI(var33)) {
                                                                                    var33.interact(llIIlIlIlI[llIIlIllIl[64]]);
                                                                                    Time.sleepUntil(() -> {
                                                                                        boolean bl;
                                                                    ...
                                                                    if (ar.lIlIlIllIlllI(NPCs.getNearest((String[])stringArray)) && ar.lIlIlIllIlIll(nH.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && ar.lIlIlIllIllII(Players.getLocal().getWorldLocation().distanceTo(nI), llIIlIllIl[68])) {
                                                                        ...
                                                                        var33 = TileObjects.getNearest((Predicate)var16);
                                                                        if (ar.lIlIlIllIlllI(var33)) {
                                                                            var33.interact(llIIlIlIlI[llIIlIllIl[70]]);
                                                                            Time.sleepUntil(() -> {
                                                                                boolean bl;
                                                                                if (ar.lIlIlIllIlIll(LocalPlayer.get().isMoving() ? 1 : 0)) {
                                                                                    bl = llIIlIllIl[1];
                                                                    ...
                                                                    var16 = TileObjects.getNearest(tileObject -> tileObject.getName().contains(llIIlIlIlI[llIIlIllIl[264]]));
                                                                    ...
                                                                    if (ar.lIlIlIllIllll(TileObjects.getNearest((String[])stringArray9))) {
                                                                        ...
                                                                        var33 = TileItems.getNearest((String[])stringArray10);
                                                                        if (ar.lIlIlIllIlllI(var33)) {
                                                                            var33.interact(llIIlIlIlI[llIIlIllIl[74]]);
                                                                            Time.sleepTicks((int)llIIlIllIl[1]);
                                                                            0;
                                                                        }
                                                                        if (ar.lIlIlIllIlllI(var41 = TileItems.getNearest(tileItem -> tileItem.getName().contains(llIIlIlIlI[llIIlIllIl[263]])))) {
                                                                            // empty if block
                                                                        }
                                                                        String[] stringArray11 = new String[llIIlIllIl[1]];
                                                                        stringArray11[ar.llIIlIllIl[0]] = llIIlIlIlI[llIIlIllIl[75]];
                                                                        var22 = NPCs.getNearest((String[])stringArray11);
                                                                        if (ar.lIlIlIllIlllI(var22) && ar.lIlIlIlllIlII(LocalPlayer.get().getInteracting(), var22) && ar.lIlIlIllIlIll(var22.isDead() ? 1 : 0) && ar.lIlIlIllIlIIl(Reachable.isInteractable((Locatable)var22) ? 1 : 0)) {
                                                                            var22.interact(llIIlIlIlI[llIIlIllIl[76]]);
                                                                        }
                                                                    }
                        ...
                        if (ar.lIlIlIllIlllI(TileObjects.getNearest((String[])stringArray))) {
                            ...
                            var33 = TileObjects.getAll((String[])stringArray43);
                            var41 = var33.stream().filter(tileObject -> {
                                String[] stringArray = new String[llIIlIllIl[1]];
                            ...
                            if (ar.lIlIlIllIlllI(var4)) {
                                if (ar.lIlIlIlllIIIl(Players.getLocal().getWorldX(), var4.getWorldX())) {
                                    var22 = TileObjects.getNearest(tileObject -> {
                                        String[] stringArray = new String[llIIlIllIl[1]];
                                        stringArray[ar.llIIlIllIl[0]] = llIIlIlIlI[llIIlIllIl[259]];
                                        return tileObject.hasAction(stringArray);
                                    });
                                    if (ar.lIlIlIllIlllI(var22)) {
                                        AccBuilderSotf.c = llIIlIlIlI[llIIlIllIl[126]];
                                        var22.interact(llIIlIlIlI[llIIlIllIl[127]]);
                                    ...
                                    var4.interact(llIIlIlIlI[llIIlIllIl[129]]);
                        ...
                        var33 = TileObjects.getAll((String[])stringArray45);
                        var41 = var33.stream().filter(tileObject -> {
                            String[] stringArray = new String[llIIlIllIl[1]];
                            stringArray[ar.llIIlIllIl[0]] = llIIlIlIlI[llIIlIllIl[258]];
                            return tileObject.hasAction(stringArray);
                        }).collect(Collectors.toList());
                        if (!ar.lIlIlIllIlIll(var41.isEmpty() ? 1 : 0)) break block117;
                        if (!ar.lIlIlIllIlIll(Reachable.isInteractable((Locatable)((Locatable)var41.get(llIIlIllIl[0]))) ? 1 : 0)) break block118;
                    ...
                    var22 = TileObjects.getAll((String[])stringArray);
                    var4 = var22.stream().filter(tileObject -> {
                        String[] stringArray = new String[llIIlIllIl[1]];
                        stringArray[ar.llIIlIllIl[0]] = llIIlIlIlI[llIIlIllIl[257]];
                        return tileObject.hasAction(stringArray);
                    }).collect(Collectors.toList());
                    if (ar.lIlIlIllIlIll(var4.isEmpty() ? 1 : 0)) {
                        ((TileObject)var4.get(llIIlIllIl[0])).interact(llIIlIlIlI[llIIlIllIl[136]]);
                        Time.sleepTicks((int)llIIlIllIl[2]);
                        0;
                    }
                }
                ...
                var22 = TileObjects.getAll((String[])stringArray53);
                var4 = var22.stream().filter(tileObject -> {
                    String[] stringArray = new String[llIIlIllIl[1]];
                ...
                if (ar.lIlIlIllIlIll(var4.isEmpty() ? 1 : 0)) {
                    ((TileObject)var4.get(llIIlIllIl[0])).interact(llIIlIlIlI[llIIlIllIl[145]]);
                    Time.sleepTicks((int)llIIlIllIl[15]);
                    0;
                }
            }
            if (ar.lIlIlIllIlIIl(Reachable.isInteractable((Locatable)((Locatable)var41.get(llIIlIllIl[0]))) ? 1 : 0)) {
                AccBuilderSotf.c = llIIlIlIlI[llIIlIllIl[146]];
                ((TileObject)var41.get(llIIlIllIl[0])).interact(llIIlIlIlI[llIIlIllIl[147]]);
                Time.sleepTicks((int)e.c(llIIlIllIl[10], llIIlIllIl[14]));
                0;
            }
        }
        ...
        if (ar.lIlIlIllIlllI(TileObjects.getNearest((String[])stringArray))) {
            block103: {
                ...
                do {
                    ...
                    int var4 = llIIlIllIl[0];
                    if (ar.lIlIlIllIlIIl(var33.isEmpty() ? 1 : 0)) {
                        Time.sleepTicks((int)llIIlIllIl[15]);
                        0;
                        System.out.println(llIIlIlIlI[llIIlIllIl[152]]);
                        var33 = TileObjects.getAll(tileObject -> {
                            boolean bl;
                        ...
                        if (ar.lIlIlIllIlllI(var19) && ar.lIlIlIllIllII(var19.getWorldLocation().getY(), nR.getY() + llIIlIllIl[17])) {
                            var4 = llIIlIllIl[1];
                        }
                    }
                    System.out.println("Version: " + (var4 != 0));
                    if (ar.lIlIlIllIlIll(var4)) {
                        if (ar.lIlIlIllIlllI(nR) && ar.lIlIlIllIllII(Players.getLocal().getWorldLocation().getY(), nR.getY() - llIIlIllIl[17])) {
                            var19 = var33.stream().map(tileObject -> tileObject.getWorldLocation()).collect(Collectors.toList());
                            ...
                            var13 = Arrays.asList(worldPointArray);
                            System.out.println("Start tiles: " + var13.size());
                            var28 = llIIlIllIl[0];
                            var59 = llIIlIllIl[0];
                            while (ar.lIlIlIllIlIlI(var59, var13.size())) {
                                AccBuilderSotf.c = llIIlIlIlI[llIIlIllIl[155]];
                                var7 = ar.a(var13.get(var59), nR.getY() - llIIlIllIl[17], (List<WorldPoint>)var19);
                                if (ar.lIlIlIllIlIll(var7.isEmpty() ? 1 : 0)) {
                                    System.out.println(llIIlIlIlI[llIIlIllIl[156]]);
                                    var30 = var7.iterator();
                                    while (ar.lIlIlIllIlIIl(var30.hasNext() ? 1 : 0)) {
                                        var32 = var30.next();
                                        System.out.println("(" + var32.getX() + ", " + var32.getY() + ", " + var32.getPlane() + ")");
                                        0;
                                        if (-(0x31 ^ 0x34) < 0) continue;
                                        return;
                                    }
                                    var28 = llIIlIllIl[1];
                                    while (ar.lIlIlIllIlIIl(var28) && ar.lIlIlIllIlIll(var7.isEmpty() ? 1 : 0)) {
                                        if (ar.lIlIlIllIlIll(Players.getLocal().getWorldLocation().equals((Object)var7.get(llIIlIllIl[0])) ? 1 : 0)) {
                                            if (ar.lIlIlIllIllII(Players.getLocal().getWorldLocation().getY(), nR.getY() - llIIlIllIl[11])) {
                                                ...
                                                var30 = TileObjects.getAt((WorldPoint)var7.get(llIIlIllIl[0]), (String[])stringArray56);
                                                if (ar.lIlIlIllIlIll(var30.isEmpty() ? 1 : 0)) {
                                                    System.out.println("Bog size: " + var30.size());
                                                    ((TileObject)var30.get(llIIlIllIl[0])).interact(llIIlIlIlI[llIIlIllIl[162]]);
                                                    Time.sleepTicks((int)llIIlIllIl[2]);
                                                    0;
                                                }
                                                if (ar.lIlIlIllIlIIl(var30.isEmpty() ? 1 : 0)) {
                                                    System.out.println("Bog is null at: " + String.valueOf(var7.get(llIIlIllIl[0])));
                                                    Game.logout();
                                                    Time.sleepTicks((int)llIIlIllIl[2]);
                                                    0;
                                                    0;
                                        ...
                                        if (ar.lIlIlIllIlIIl(Players.getLocal().getWorldLocation().equals((Object)var7.get(llIIlIllIl[0])) ? 1 : 0)) {
                                            System.out.println(llIIlIlIlI[llIIlIllIl[163]]);
                                            var7.remove(llIIlIllIl[0]);
                                            0;
                                            Time.sleepTicks((int)llIIlIllIl[2]);
                                            0;
                                        }
                            ...
                            if (ar.lIlIlIllIlIll(var28)) {
                                System.out.println(llIIlIlIlI[llIIlIllIl[165]]);
                            }
                            System.out.println(var33.size());
                        }
                                    ...
                                    while (ar.lIlIlIllIlIIl(var28) && ar.lIlIlIllIlIll(var7.isEmpty() ? 1 : 0)) {
                                        if (ar.lIlIlIllIlIll(Players.getLocal().getWorldLocation().equals((Object)var7.get(llIIlIllIl[0])) ? 1 : 0)) {
                                            if (ar.lIlIlIllIlIlI(Players.getLocal().getWorldLocation().getY(), nR.getY() + llIIlIllIl[11])) {
                                                ...
                                                var30 = TileObjects.getAt((WorldPoint)var7.get(llIIlIllIl[0]), (String[])stringArray58);
                                                if (ar.lIlIlIllIlIll(var30.isEmpty() ? 1 : 0)) {
                                                    System.out.println("Bog size: " + var30.size());
                                                    ((TileObject)var30.get(llIIlIllIl[0])).interact(llIIlIlIlI[llIIlIllIl[174]]);
                                                    Time.sleepTicks((int)llIIlIllIl[2]);
                                                    0;
                                                }
                                                if (ar.lIlIlIllIlIIl(var30.isEmpty() ? 1 : 0)) {
                                        ...
                                        System.out.println("Path size lefT: " + var7.size());
                                        Time.sleepTicks((int)llIIlIllIl[1]);
                                        0;
                                        0;
                                        if (2 != 0) continue;
                    ...
                    if (ar.lIlIlIlllIIII(ar.lIlIlIlllIIlI(System.currentTimeMillis(), var41 + 45000L))) {
                        AccBuilderSotf.c = llIIlIlIlI[llIIlIllIl[181]];
                        Game.logout();
                        var41 = System.currentTimeMillis();
                    }
                    0;
                } while (2 != 3);
                return;
    ...
    private static List<as> a(as as2, List<WorldPoint> list) {
        ...
        int var21 = llIIlIllIl[0];
        while (ar.lIlIlIllIlIlI(var21, (int)var37)) {
            void var15;
            int var25;
            int var11;
            as var38;
            void var46;
            void var52 = var46[var21];
            int var51 = var38.nT.getX() + var52[llIIlIllIl[0]];
            WorldPoint var54 = new WorldPoint(var51, var11 = var38.nT.getY() + var52[llIIlIllIl[1]], var25 = var38.nT.getPlane());
            if (ar.lIlIlIllIlIIl(var15.contains(var54) ? 1 : 0)) {
                void var23;
                var23.add(new as(var54, var38, llIIlIllIl[0], ar.d(var11, nR.getY() + llIIlIllIl[17])));
                0;
            }
            ++var21;
            0;
    ...
    private static String lIlIlIlIlIIll(String var14, String var39) {
        try {
            SecretKeySpec var27 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var39.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var24 = Cipher.getInstance("Blowfish");
            var24.init(llIIlIllIl[2], var27);
            return new String(var24.doFinal(Base64.getDecoder().decode(var14.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIlIlIlIlIlIl(String var49, String var53) {
        var49 = new String(Base64.getDecoder().decode(var49.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var17 = new StringBuilder();
        char[] var42 = var53.toCharArray();
        int var55 = llIIlIllIl[0];
        char[] var58 = var49.toCharArray();
        int var40 = var58.length;
        int var48 = llIIlIllIl[0];
        while (ar.lIlIlIllIlIlI(var48, var40)) {
            char var56 = var58[var48];
            var17.append((char)(var56 ^ var42[var55 % var42.length]));
            0;
            ++var55;
            ++var48;
            0;
    ...
    private static String lIlIlIlIlIlII(String var29, String var44) {
        try {
            SecretKeySpec var34 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var44.getBytes(StandardCharsets.UTF_8)), llIIlIllIl[16]), "DES");
            Cipher var43 = Cipher.getInstance("DES");
            var43.init(llIIlIllIl[2], var34);
            return new String(var43.doFinal(Base64.getDecoder().decode(var29.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static List<WorldPoint> a(WorldPoint worldPoint, int n2, List<WorldPoint> list) {
        ...
        0;
        while (ar.lIlIlIllIlIll(var8.isEmpty() ? 1 : 0)) {
            void var5;
            void var12;
            void var9;
            as var45 = (as)var8.poll();
            if (ar.lIlIlIlllIlIl(var45.nT.getY(), (int)var9)) {
                return ar.a(var45);
            }
            var12.add(var45);
            0;
            Iterator<as> var18 = ar.a(var45, (List<WorldPoint>)var5).iterator();
            while (ar.lIlIlIllIlIIl(var18.hasNext() ? 1 : 0)) {
                as var10 = var18.next();
                int var6 = var45.nV + llIIlIllIl[1];
                if (ar.lIlIlIllIlIIl(ar.b(var10, (List<as>)var12) ? 1 : 0)) {
                    0;
                    if (2 >= 1) continue;
                    return null;
                }
                if (!ar.lIlIlIllIlIIl(ar.a(var10, (PriorityQueue<as>)var8) ? 1 : 0) || ar.lIlIlIllIlIlI(var6, var10.nV)) {
                    var8.add(var10);
                    0;
                }
                0;
    ...
    public static void t(String string) {
        ...
        if (ar.lIlIlIllIlIIl(Inventory.contains((String[])stringArray) ? 1 : 0)) {
            ...
            if (!ar.lIlIlIllIllll(Widgets.get((int)llIIlIllIl[210], (int)llIIlIllIl[15])) || ar.lIlIlIllIlIll(Widgets.get((int)llIIlIllIl[210]).isEmpty() ? 1 : 0)) {
                ...
                if (ar.lIlIlIllIlIIl(var57.contains(llIIlIlIlI[llIIlIllIl[212]]) ? 1 : 0) && ar.lIlIlIllIlllI(var3 = Widgets.get((int)llIIlIllIl[210], (int)llIIlIllIl[15]))) {
                    Time.sleepTicks((int)llIIlIllIl[2]);
                    0;
                    var3.getChild(llIIlIllIl[3]).interact(llIIlIlIlI[llIIlIllIl[213]]);
                    Time.sleepTicks((int)llIIlIllIl[1]);
                    0;
                }
                if (ar.lIlIlIllIlIIl(var57.contains(llIIlIlIlI[llIIlIllIl[214]]) ? 1 : 0) && ar.lIlIlIllIlllI(var3 = Widgets.get((int)llIIlIllIl[210], (int)llIIlIllIl[15]))) {
                    Time.sleepTicks((int)llIIlIllIl[2]);
                    0;
                    var3.getChild(llIIlIllIl[1]).interact(llIIlIlIlI[llIIlIllIl[215]]);
                    Time.sleepTicks((int)e.c(llIIlIllIl[10], llIIlIllIl[11]));
                    0;
                }
                if (ar.lIlIlIllIlIIl(var57.contains(llIIlIlIlI[llIIlIllIl[216]]) ? 1 : 0) && ar.lIlIlIllIlllI(var3 = Widgets.get((int)llIIlIllIl[210], (int)llIIlIllIl[15]))) {
                    Time.sleepTicks((int)llIIlIllIl[2]);
                    0;
                    var3.getChild(llIIlIllIl[0]).interact(llIIlIlIlI[llIIlIllIl[217]]);
                    Time.sleepTicks((int)e.c(llIIlIllIl[10], llIIlIllIl[11]));
                    0;
                }
                if (ar.lIlIlIllIlIIl(var57.contains(llIIlIlIlI[llIIlIllIl[218]]) ? 1 : 0) && ar.lIlIlIllIlllI(var3 = Widgets.get((int)llIIlIllIl[210], (int)llIIlIllIl[15]))) {
                    Time.sleepTicks((int)llIIlIllIl[2]);
                    0;
                    var3.getChild(llIIlIllIl[2]).interact(llIIlIlIlI[llIIlIllIl[219]]);
                    Time.sleepTicks((int)e.c(llIIlIllIl[10], llIIlIllIl[11]));
                    0;
                }
                if (ar.lIlIlIllIlIIl(var57.contains(llIIlIlIlI[llIIlIllIl[220]]) ? 1 : 0) && ar.lIlIlIllIlllI(var3 = Widgets.get((int)llIIlIllIl[210], (int)llIIlIllIl[15]))) {
                    Time.sleepTicks((int)llIIlIllIl[2]);
                    0;
                    var3.getChild(llIIlIllIl[10]).interact(llIIlIlIlI[llIIlIllIl[221]]);
                    Time.sleepTicks((int)e.c(llIIlIllIl[10], llIIlIllIl[11]));
                    0;
                }
                if (ar.lIlIlIllIlIIl(var57.contains(llIIlIlIlI[llIIlIllIl[222]]) ? 1 : 0) && ar.lIlIlIllIlllI(var3 = Widgets.get((int)llIIlIllIl[210], (int)llIIlIllIl[15]))) {
                    Time.sleepTicks((int)llIIlIllIl[2]);
                    0;
                    var3.getChild(llIIlIllIl[11]).interact(llIIlIlIlI[llIIlIllIl[223]]);
                    Time.sleepTicks((int)e.c(llIIlIllIl[10], llIIlIllIl[11]));
                    0;
                }
                AccBuilderSotf.c = llIIlIlIlI[llIIlIllIl[224]];
                var3 = Widgets.fromId((int)llIIlIllIl[225]);
                if (ar.lIlIlIllIlllI(var3) && ar.lIlIlIllIlIIl(var3.isVisible() ? 1 : 0)) {
                    Time.sleepTick();
                    0;
                    var3.interact(llIIlIlIlI[llIIlIllIl[226]]);
                    Time.sleepTicks((int)llIIlIllIl[2]);
                    0;
                }
            }
        }
        if (ar.lIlIlIllIlIIl(Inventory.contains(var3 = item -> item.getName().toLowerCase().contains(llIIlIlIlI[llIIlIllIl[250]])) ? 1 : 0)) {
            Inventory.getFirst(var3).interact(llIIlIlIlI[llIIlIllIl[227]]);
            Time.sleepTicks((int)llIIlIllIl[1]);
            0;
        }
    }
        ...
        block65: {
            block66: {
                block67: {
                    ...
                    ar.t(nN);
                    Predicate<Item> var35 = item -> item.getName().toLowerCase().contains(llIIlIlIlI[llIIlIllIl[274]]);
                    if (ar.lIlIlIllIlIIl(Inventory.contains(var35) ? 1 : 0)) {
                        Inventory.getFirst(var35).interact(llIIlIlIlI[llIIlIllIl[2]]);
                        Time.sleepTicks((int)llIIlIllIl[1]);
                        0;
                    }
                    ...
                    if (ar.lIlIlIllIlIIl(ar.an() ? 1 : 0)) {
                        ...
                        ar.t(nN);
                        Predicate<Item> var36 = item -> item.getName().toLowerCase().contains(llIIlIlIlI[llIIlIllIl[273]]);
                        if (ar.lIlIlIllIlIIl(Inventory.contains(var36) ? 1 : 0)) {
                            Inventory.getFirst(var36).interact(llIIlIlIlI[llIIlIllIl[30]]);
                            Time.sleepTicks((int)llIIlIllIl[1]);
                            0;
                        }
                        if (ar.lIlIlIllIlIIl(nO.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            if (ar.lIlIlIllIlIll(Inventory.contains((String[])stringArray5) ? 1 : 0) && ar.lIlIlIllIlIll(Inventory.contains(var36) ? 1 : 0)) {
                                ...
                                if (ar.lIlIlIlllIIIl(Skills.getBoostedLevel((Skill)Skill.HITPOINTS), nK)) {
                                    ...
                                    if (ar.lIlIlIllIllIl(Players.getLocal().getWorldLocation().distanceTo(nP), llIIlIllIl[16])) {
                                        ...
                                        if (ar.lIlIlIllIlIll(Dialog.isOpen() ? 1 : 0) && ar.lIlIlIllIlIll(Static.getClient().isInInstancedRegion() ? 1 : 0)) {
                                            ...
                                            if (ar.lIlIlIllIlIll(Inventory.contains((String[])stringArray6) ? 1 : 0) && ar.lIlIlIllIlIll(Inventory.contains(var36) ? 1 : 0) && ar.lIlIlIllIlIIl(Widgets.get((int)llIIlIllIl[34]).isEmpty() ? 1 : 0) && ar.lIlIlIllIlIll(Vars.getBit((int)llIIlIllIl[35]))) {
                        ...
                        if (ar.lIlIlIllIlIIl(nL.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            if (ar.lIlIlIllIlIll(Inventory.contains((String[])stringArray8) ? 1 : 0) && ar.lIlIlIllIlIll(Inventory.contains(var36) ? 1 : 0)) {
                                if (ar.lIlIlIlllIIIl(Skills.getBoostedLevel((Skill)Skill.HITPOINTS), nK)) {
                                    ...
                                    if (ar.lIlIlIllIlIll(Dialog.isOpen() ? 1 : 0) && ar.lIlIlIllIlIll(Static.getClient().isInInstancedRegion() ? 1 : 0)) {
                                        ...
                                        if (ar.lIlIlIllIlIll(Inventory.contains((String[])stringArray9) ? 1 : 0) && ar.lIlIlIllIlIll(Inventory.contains(var36) ? 1 : 0)) {
                                            if (ar.lIlIlIllIlIlI(cG, llIIlIllIl[1]) && ar.lIlIlIlllIIIl(Movement.getRunEnergy(), llIIlIllIl[29])) {
                                                Movement.toggleRun();
                                                cG += llIIlIllIl[1];
                                            }
        ...
        if (ar.lIlIlIllIlIIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (ar.lIlIlIllIlIll(Equipment.contains((int[])nArray2) ? 1 : 0)) {
                ...
                if (ar.lIlIlIllIlIIl(Inventory.getFirst((int[])nArray7).hasAction(stringArray3) ? 1 : 0)) {
                    int[] nArray8 = new int[llIIlIllIl[1]];
                    nArray8[ar.llIIlIllIl[0]] = var50;
                    Inventory.getFirst((int[])nArray8).interact(llIIlIlIlI[llIIlIllIl[197]]);
                }
                if (ar.lIlIlIlllIlIl(var50, llIIlIllIl[198])) {
                    Time.sleepTicks((int)llIIlIllIl[10]);
                    0;
                    String[] stringArray4 = new String[llIIlIllIl[1]];
                            ...
                            block28: {
                                block26: {
                                    ...
                                    if (ar.lIlIlIllIlIll(Bank.isOpen() ? 1 : 0)) {
                                        ...
                                        if (ar.lIlIlIllIllIl(Players.getLocal().getWorldLocation().distanceTo(nQ), llIIlIllIl[28]) && ar.lIlIlIllIlllI(var1 = TileObjects.getNearest(tileObject -> {
                                            int n2;
                                            ...
                                            var1.interact(llIIlIlIlI[llIIlIllIl[183]]);
    ...
    public static void Q() {
        ...
        block19: {
                ...
                block17: {
                    block16: {
                        ...
                        if (ar.lIlIlIllIlIll(Bank.contains((int[])nArray2) ? 1 : 0)) {
                            var2 = new d(llIIlIllIl[230], llIIlIllIl[2], llIIlIllIl[231]);
                            bv.add(var2);
                            0;
                        }
                        int[] nArray3 = new int[llIIlIllIl[1]];
                        ...
                        if (ar.lIlIlIllIlIll(Bank.contains((int[])nArray3) ? 1 : 0)) {
                            var2 = new d(llIIlIllIl[232], llIIlIllIl[18], llIIlIllIl[233]);
                            bv.add(var2);
                            0;
                        }
                        int[] nArray4 = new int[llIIlIllIl[1]];
                        ...
                        if (ar.lIlIlIllIlIll(Bank.contains((int[])nArray4) ? 1 : 0)) {
                            var2 = new d(llIIlIllIl[22], llIIlIllIl[1], e.c(llIIlIllIl[234], llIIlIllIl[235]));
                            bv.add(var2);
                            0;
                        }
                        int[] nArray5 = new int[llIIlIllIl[1]];
                        ...
                        if (ar.lIlIlIllIlIll(Bank.contains((int[])nArray5) ? 1 : 0)) {
                            var2 = new d(llIIlIllIl[23], llIIlIllIl[1], e.c(llIIlIllIl[234], llIIlIllIl[235]));
                            bv.add(var2);
                            0;
                        }
                        int[] nArray6 = new int[llIIlIllIl[1]];
                    ...
                    var2 = new d(llIIlIllIl[185], llIIlIllIl[236], e.c(llIIlIllIl[237], llIIlIllIl[238]));
                    bv.add(var2);
                    0;
                }
                int[] nArray = new int[llIIlIllIl[1]];
            ...
            var2 = new d(llIIlIllIl[9], llIIlIllIl[4], e.c(llIIlIllIl[159], llIIlIllIl[239]));
            bv.add(var2);
            0;
        }
        int[] nArray = new int[llIIlIllIl[1]];
        ...
        if (ar.lIlIlIllIlIll(Bank.contains((int[])nArray) ? 1 : 0)) {
            var2 = new d(llIIlIllIl[240], llIIlIllIl[18], llIIlIllIl[241]);
            bv.add(var2);
            0;
        }
        int[] nArray11 = new int[llIIlIllIl[1]];
        ...
        if (ar.lIlIlIllIlIll(Bank.contains((int[])nArray11) ? 1 : 0)) {
            var2 = new d(mU, llIIlIllIl[59], llIIlIllIl[243]);
            bv.add(var2);
            0;
        }
        int[] nArray12 = new int[llIIlIllIl[1]];
        ...
        if (ar.lIlIlIllIlIll(Bank.contains((int[])nArray12) ? 1 : 0)) {
            var2 = new d(llIIlIllIl[244], llIIlIllIl[1], llIIlIllIl[245]);
            bv.add(var2);
            0;
        }
        int[] nArray13 = new int[llIIlIllIl[1]];
        ...
        if (ar.lIlIlIllIlIll(Bank.contains((int[])nArray13) ? 1 : 0)) {
            var2 = new d(llIIlIllIl[7], llIIlIllIl[1], e.c(llIIlIllIl[246], llIIlIllIl[247]));
            bv.add(var2);
            0;
        }
        int[] nArray14 = new int[llIIlIllIl[1]];
        ...
        if (ar.lIlIlIllIlIll(Bank.contains((int[])nArray14) ? 1 : 0)) {
            var2 = new d(llIIlIllIl[248], llIIlIllIl[36], j.cf);
            bv.add(var2);
            0;
        }
    }
