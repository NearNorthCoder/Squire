...
implements ac {
    ...
    private static String lIllIllIllIlI(String var19, String var14) {
        ...
        int var8 = llIllIlIIl[0];
        char[] var1 = var19.toCharArray();
        int var18 = var1.length;
        int var13 = llIllIlIIl[0];
        while (aq.lIllIllllIlII(var13, var18)) {
            char var17 = var1[var13];
            var3.append((char)(var17 ^ var16[var8 % var16.length]));
            0;
            ++var8;
            ++var13;
            0;
    ...
    private static String lIllIllIlllII(String var12, String var4) {
        try {
    ...
    private static void Q() {
        block30: {
            ...
            block29: {
                block28: {
                    block27: {
                        ...
                        block25: {
                            block26: {
                                ...
                                if (aq.lIllIllllIlIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
                                    var20 = new d(llIllIlIIl[13], llIllIlIIl[1], llIllIlIIl[49]);
                                    bv.add((d)var20);
                                    0;
                                }
                                int[] nArray3 = new int[llIllIlIIl[1]];
                                ...
                                if (aq.lIllIllllIlIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
                                    var20 = new d(llIllIlIIl[14], llIllIlIIl[1], llIllIlIIl[49]);
                                    bv.add((d)var20);
                                    0;
                                }
                                int[] nArray4 = new int[llIllIlIIl[1]];
                            ...
                            var20 = new d(llIllIlIIl[15], llIllIlIIl[51], llIllIlIIl[36]);
                            bv.add((d)var20);
                            0;
                        }
                        int[] nArray = new int[llIllIlIIl[1]];
                        nArray[aq.llIllIlIIl[0]] = llIllIlIIl[18];
                        if (aq.lIllIllllIlIl(Bank.contains((int[])nArray) ? 1 : 0)) {
                            var20 = new d(llIllIlIIl[18], llIllIlIIl[1], llIllIlIIl[52]);
                            bv.add((d)var20);
                            0;
                        }
                        int[] nArray6 = new int[llIllIlIIl[1]];
                        ...
                        if (aq.lIllIllllIlIl(Bank.contains((int[])nArray6) ? 1 : 0)) {
                            var20 = new d(llIllIlIIl[19], llIllIlIIl[1], llIllIlIIl[52]);
                            bv.add((d)var20);
                            0;
                        }
                        int[] nArray7 = new int[llIllIlIIl[1]];
                        ...
                        if (aq.lIllIllllIlIl(Bank.contains((int[])nArray7) ? 1 : 0)) {
                            var20 = new d(llIllIlIIl[17], llIllIlIIl[1], llIllIlIIl[52]);
                            bv.add((d)var20);
                            0;
                        }
                        int[] nArray8 = new int[llIllIlIIl[1]];
                        ...
                        if (aq.lIllIllllIlIl(Bank.contains((int[])nArray8) ? 1 : 0)) {
                            var20 = new d(llIllIlIIl[20], llIllIlIIl[1], llIllIlIIl[53]);
                            bv.add((d)var20);
                            0;
                        }
                        if (aq.lIllIllllIlII(Skills.getLevel((Skill)Skill.RANGED), llIllIlIIl[2])) {
                            ...
                            if (aq.lIllIllllIlIl(Bank.contains((int[])nArray9) ? 1 : 0)) {
                                var20 = new d(llIllIlIIl[16], llIllIlIIl[54], llIllIlIIl[43]);
                                bv.add((d)var20);
                                0;
                            }
                        }
                        ...
                        if (aq.lIllIllllIlIl(Bank.contains((int[])nArray10) ? 1 : 0)) {
                            var20 = new d(llIllIlIIl[9], llIllIlIIl[1], llIllIlIIl[55]);
                            bv.add((d)var20);
                            0;
                        }
                        int[] nArray11 = new int[llIllIlIIl[1]];
                        ...
                        if (aq.lIllIllllIlIl(Bank.contains((int[])nArray11) ? 1 : 0)) {
                            var20 = new d(llIllIlIIl[10], llIllIlIIl[1], llIllIlIIl[55]);
                            bv.add((d)var20);
                            0;
                        }
                        if (aq.lIllIlllllIII(Skills.getLevel((Skill)Skill.RANGED), llIllIlIIl[2])) {
                            ...
                            if (aq.lIllIllllIlIl(Bank.contains((int[])nArray12) ? 1 : 0)) {
                                var20 = new d(llIllIlIIl[11], llIllIlIIl[51], llIllIlIIl[56]);
                                bv.add((d)var20);
                                0;
                            }
                        }
                        ...
                        if (aq.lIllIllllIlIl(Bank.contains((int[])nArray13) ? 1 : 0)) {
                            var20 = new d(llIllIlIIl[22], llIllIlIIl[1], j.cf);
                            bv.add((d)var20);
                            0;
                        }
                        int[] nArray14 = new int[llIllIlIIl[1]];
                        ...
                        if (aq.lIllIllllIlIl(Bank.contains((int[])nArray14) ? 1 : 0)) {
                            var20 = new d(llIllIlIIl[26], llIllIlIIl[57], llIllIlIIl[58]);
                            bv.add((d)var20);
                            0;
                        }
                        if (aq.lIllIllllIlIl(Bank.contains((Predicate)(var20 = item -> item.getName().toLowerCase().contains(llIllIIlll[llIllIlIIl[63]]))) ? 1 : 0)) {
                            var21 = new d(llIllIlIIl[59], llIllIlIIl[6], llIllIlIIl[60]);
                            bv.add(var21);
                            0;
                        }
                        int[] nArray15 = new int[llIllIlIIl[1]];
                    ...
                    var21 = new d(llIllIlIIl[61], llIllIlIIl[24], llIllIlIIl[62]);
                    bv.add(var21);
                    0;
                }
                int[] nArray = new int[llIllIlIIl[1]];
            ...
            var21 = new d(llIllIlIIl[23], llIllIlIIl[24], llIllIlIIl[62]);
            bv.add(var21);
            0;
        }
    }
    ...
    public static void aA() {
        ...
        if (aq.lIllIllllIlIl(bt ? 1 : 0) && aq.lIllIllllIlII(Skills.getLevel((Skill)Skill.RANGED), llIllIlIIl[2])) {
            ...
            if (aq.lIllIllllIlIl(aq.an() ? 1 : 0)) {
                ...
                if (aq.lIllIllllIllI(var22) && aq.lIllIllllIlIl(var22.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderSotf.c = llIllIIlll[llIllIlIIl[3]];
                    a.a(var22);
                }
                if (aq.lIllIllllIllI(var22) && aq.lIllIllllIIll(var22.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (aq.lIllIllllIIll(aq.an() ? 1 : 0)) {
                ...
                if (aq.lIllIlllllIII(Skills.getLevel((Skill)Skill.RANGED), llIllIlIIl[27]) && aq.lIllIllllIlII(Skills.getLevel((Skill)Skill.RANGED), llIllIlIIl[2])) {
                    var22 = TileItems.getNearest(tileItem -> {
                        int n2;
                    ...
                    if (aq.lIllIllllIllI(var22)) {
                        var22.interact(llIllIIlll[llIllIlIIl[6]]);
    ...
    private static String lIllIllIllIll(String var6, String var7) {
        try {
            SecretKeySpec var10 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var7.getBytes(StandardCharsets.UTF_8)), llIllIlIIl[35]), "DES");
            Cipher var11 = Cipher.getInstance("DES");
            var11.init(llIllIlIIl[3], var10);
    ...
    private static void lIllIllllIIlI() {
        ...
        aq.llIllIlIIl[0] = (12 + 125 - 61 + 83 ^ 58 + 145 - 183 + 135) & (0x55 ^ 0x7D ^ (0xB7 ^ 0x9B) ^ -1);
        aq.llIllIlIIl[1] = 1;
    ...
    private static void lIllIlllIlllI() {
        ...
        aq.llIllIIlll[aq.llIllIlIIl[0]] = aq."Buying items";
        aq.llIllIIlll[aq.llIllIlIIl[1]] = aq."Finished buying items, switching back to magic training";
        aq.llIllIIlll[aq.llIllIlIIl[3]] = aq."Navigating to bank";
        aq.llIllIIlll[aq.llIllIlIIl[4]] = aq."Handling banking";
        aq.llIllIIlll[aq.llIllIlIIl[7]] = aq."We are missing supplies, switching to BUYING";
        aq.llIllIIlll[aq.llIllIlIIl[6]] = aq."Take";
        aq.llIllIIlll[aq.llIllIlIIl[30]] = aq."Remove";
        aq.llIllIIlll[aq.llIllIlIIl[33]] = aq."Wield";
        aq.llIllIIlll[aq.llIllIlIIl[35]] = aq."Wear";
        aq.llIllIIlll[aq.llIllIlIIl[36]] = aq."Wield";
        aq.llIllIIlll[aq.llIllIlIIl[24]] = aq."Wield";
        aq.llIllIIlll[aq.llIllIlIIl[38]] = aq."Wield";
        aq.llIllIIlll[aq.llIllIlIIl[40]] = aq."Wear";
        aq.llIllIIlll[aq.llIllIlIIl[41]] = aq."Wear";
        aq.llIllIIlll[aq.llIllIlIIl[42]] = aq."Wear";
        aq.llIllIIlll[aq.llIllIlIIl[43]] = aq."Wear";
        aq.llIllIIlll[aq.llIllIlIIl[45]] = aq."Wear";
        aq.llIllIIlll[aq.llIllIlIIl[46]] = aq."Wear";
        aq.llIllIIlll[aq.llIllIlIIl[47]] = aq."Wear";
        aq.llIllIIlll[aq.llIllIlIIl[48]] = aq."Wield";
        aq.llIllIIlll[aq.llIllIlIIl[34]] = aq."Range training";
        aq.llIllIIlll[aq.llIllIlIIl[63]] = aq."ring of wealth (";
        aq.llIllIIlll[aq.llIllIlIIl[64]] = aq."bow";
    }
