...
implements ac {
    ...
    private static String lIIllllIIlIlI(String var18, String var12) {
        var18 = new String(Base64.getDecoder().decode(var18.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var4 = new StringBuilder();
        char[] var15 = var12.toCharArray();
        int var2 = lIlllIllIl[0];
        char[] var3 = var18.toCharArray();
        int var9 = var3.length;
        int var21 = lIlllIllIl[0];
        while (aC.lIIllllIIllll(var21, var9)) {
            char var11 = var3[var21];
            var4.append((char)(var11 ^ var15[var2 % var15.length]));
            0;
            ++var2;
            ++var21;
            0;
    ...
    public static void Q() {
        ...
        if (aC.lIIllllIlIIII(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var22 = new d(lIlllIllIl[7], lIlllIllIl[1], lIlllIllIl[4]);
            bv.add((d)var22);
            0;
        }
        ...
        if (aC.lIIllllIlIIII(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var22 = new d(lIlllIllIl[8], lIlllIllIl[1], lIlllIllIl[34]);
            bv.add((d)var22);
            0;
        }
        ...
        if (aC.lIIllllIlIIII(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var22 = new d(lIlllIllIl[9], lIlllIllIl[1], lIlllIllIl[35]);
            bv.add((d)var22);
            0;
        }
        ...
        if (aC.lIIllllIlIIII(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var22 = new d(lIlllIllIl[10], lIlllIllIl[1], lIlllIllIl[36]);
            bv.add((d)var22);
            0;
        }
        if (aC.lIIllllIlIIII(Bank.contains((Predicate)(var22 = item -> item.getName().toLowerCase().contains(lIlllIllII[lIlllIllIl[43]]))) ? 1 : 0)) {
            var6 = new d(lIlllIllIl[19], lIlllIllIl[23], lIlllIllIl[36]);
            bv.add(var6);
            0;
        }
        ...
        if (aC.lIIllllIlIIII(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var6 = new d(lIlllIllIl[37], lIlllIllIl[38], lIlllIllIl[39]);
            bv.add(var6);
            0;
        }
    }
                            ...
                            block37: {
                                block36: {
                                    block34: {
                                        ...
                                        if (aC.lIIllllIlIIIl(var17) && aC.lIIllllIlIIII(var17.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                            AccBuilderSotf.c = lIlllIllII[lIlllIllIl[2]];
                                            a.a(var17);
                                        }
                                        if (!aC.lIIllllIlIIIl(var17) || !aC.lIIllllIIlllI(var17.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block33;
                ...
                if (aC.lIIllllIlIIII(Inventory.isFull() ? 1 : 0)) {
                    if (aC.lIIllllIIllll(Skills.getLevel((Skill)Skill.MINING), lIlllIllIl[24])) {
                        ...
                        if (aC.lIIllllIIlllI(y.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            var17 = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (int[])ny);
                            if (aC.lIIllllIlIIII(Players.getLocal().isAnimating() ? 1 : 0) && aC.lIIllllIlIIII(Players.getLocal().isMoving() ? 1 : 0) && aC.lIIllllIlIIIl(var17)) {
                                var17.interact(lIlllIllII[lIlllIllIl[26]]);
                                Time.sleepTicks((int)lIlllIllIl[2]);
                                0;
                            }
                        }
                    ...
                    if (aC.lIIllllIlIIll(Skills.getLevel((Skill)Skill.MINING), lIlllIllIl[24])) {
                        ...
                        if (aC.lIIllllIIlllI(y.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            var17 = TileObjects.getNearest((WorldPoint)Players.getLocal().getWorldLocation(), (int[])nx);
                            if (aC.lIIllllIlIIII(Players.getLocal().isAnimating() ? 1 : 0) && aC.lIIllllIlIIII(Players.getLocal().isMoving() ? 1 : 0) && aC.lIIllllIlIIIl(var17)) {
                                var17.interact(lIlllIllII[lIlllIllIl[29]]);
                                Time.sleepTicks((int)lIlllIllIl[2]);
                                0;
                            }
                        }
    ...
    private static String lIIllllIIlIll(String var13, String var8) {
        try {
            SecretKeySpec var1 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var8.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var10 = Cipher.getInstance("Blowfish");
            var10.init(lIlllIllIl[2], var1);
    ...
    private static String lIIllllIIlIIl(String var16, String var7) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var7.getBytes(StandardCharsets.UTF_8)), lIlllIllIl[26]), "DES");
            Cipher var19 = Cipher.getInstance("DES");
            var19.init(lIlllIllIl[2], var5);
