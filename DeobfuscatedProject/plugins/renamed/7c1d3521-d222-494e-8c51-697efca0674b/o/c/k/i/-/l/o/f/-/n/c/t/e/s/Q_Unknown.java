...
implements ac {
    ...
    private static String lIllIIIlIlIII(String var9, String var11) {
        ...
        int var3 = llIlIIlIII[0];
        char[] var17 = var9.toCharArray();
        int var7 = var17.length;
        int var23 = llIlIIlIII[0];
        while (Q.lIllIIIlIllII(var23, var7)) {
            char var14 = var17[var23];
            var4.append((char)(var14 ^ var12[var3 % var12.length]));
            0;
            ++var3;
            ++var23;
            0;
    ...
    public static void ds() {
        ...
        if (Q.lIllIIIlIllIl(bt ? 1 : 0)) {
            if (Q.lIllIIIlIllIl(Q.an() ? 1 : 0) && Q.lIllIIIlIlllI(Players.getLocal().getWorldLocation().distanceTo(lD), llIlIIlIII[2]) && Q.lIllIIIlIllII(e.j(llIlIIlIII[3]), llIlIIlIII[4])) {
                ...
                if (Q.lIllIIIlIllll(var16) && Q.lIllIIIlIllIl(var16.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderSotf.c = llIlIIIlll[llIlIIlIII[4]];
                    a.a(var16);
                }
                if (Q.lIllIIIlIllll(var16) && Q.lIllIIIlIlIll(var16.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static String lIllIIIlIIlll(String var2, String var5) {
        try {
            SecretKeySpec var10 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var5.getBytes(StandardCharsets.UTF_8)), llIlIIlIII[22]), "DES");
            Cipher var19 = Cipher.getInstance("DES");
            var19.init(llIlIIlIII[4], var10);
    ...
    private static void Q() {
        ...
        if (Q.lIllIIIlIllIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var13 = new d(llIlIIlIII[8], llIlIIlIII[1], llIlIIlIII[6]);
            bv.add((d)var13);
            0;
        }
        int[] nArray3 = new int[llIlIIlIII[1]];
        ...
        if (Q.lIllIIIlIllIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var13 = new d(llIlIIlIII[7], llIlIIlIII[1], llIlIIlIII[6]);
            bv.add((d)var13);
            0;
        }
        ...
        if (Q.lIllIIIlIllIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var13 = new d(llIlIIlIII[10], llIlIIlIII[14], llIlIIlIII[15]);
            bv.add((d)var13);
            0;
        }
        if (Q.lIllIIIlIllIl(Bank.contains((Predicate)(var13 = item -> item.getName().toLowerCase().contains(llIlIIIlll[llIlIIlIII[23]]))) ? 1 : 0)) {
            var6 = new d(llIlIIlIII[16], llIlIIlIII[11], llIlIIlIII[17]);
            bv.add(var6);
            0;
        }
        ...
        if (Q.lIllIIIlIllIl(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var6 = new d(llIlIIlIII[18], llIlIIlIII[19], llIlIIlIII[20]);
            bv.add(var6);
            0;
        }
    }
    ...
    private static String lIllIIIlIIllI(String var1, String var15) {
        try {
            SecretKeySpec var22 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var15.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var21 = Cipher.getInstance("Blowfish");
            var21.init(llIlIIlIII[4], var22);
