...
import o.c.k.i.-.l.o.f.-.n.c.t.e.s.J_Unknown;
...
import o.c.k.i.-.l.o.f.-.n.c.t.e.s.x_Unknown;
...
implements ac {
    ...
    private static void lIIlllllIlIll() {
        ...
        w.lIllllIIll[176] = 0x40 ^ 0x22 ^ 1;
        w.lIllllIIll[177] = 0xD2 ^ 0xB7;
        w.lIllllIIll[178] = 0xA4 ^ 0xC0 ^ 2;
    ...
    private static void Q() {
        block46: {
            ...
            block45: {
                block44: {
                    block43: {
                        ...
                        block42: {
                            block41: {
                                block40: {
                                        ...
                                        block38: {
                                            block37: {
                                                block36: {
                                                        ...
                                                        block34: {
                                                            block33: {
                                                                block32: {
                                                                    ...
                                                                    var25 = new d(lIllllIIll[43], lIllllIIll[4], e.c(lIllllIIll[147], lIllllIIll[148]));
                                                                    bv.add((d)var25);
                                                                    0;
                                                                }
                                                                int[] nArray = new int[lIllllIIll[0]];
                                                            ...
                                                            var25 = new d(lIllllIIll[30], lIllllIIll[16], lIllllIIll[149]);
                                                            bv.add((d)var25);
                                                            0;
                                                        }
                                                        int[] nArray = new int[lIllllIIll[0]];
                                                    ...
                                                    var25 = new d(lIllllIIll[31], lIllllIIll[28], lIllllIIll[150]);
                                                    bv.add((d)var25);
                                                    0;
                                                }
                                                int[] nArray = new int[lIllllIIll[0]];
                                                ...
                                                if (w.lIIlllllIllll(Bank.contains((int[])nArray) ? 1 : 0)) {
                                                    var25 = new d(lIllllIIll[103], lIllllIIll[8], lIllllIIll[151]);
                                                    bv.add((d)var25);
                                                    0;
                                                }
                                                ...
                                                if (w.lIIlllllIllll(Bank.contains((int[])nArray8) ? 1 : 0)) {
                                                    var25 = new d(lIllllIIll[37], lIllllIIll[0], lIllllIIll[27]);
                                                    bv.add((d)var25);
                                                    0;
                                                }
                                            ...
                                            var25 = new d(lIllllIIll[32], lIllllIIll[13], lIllllIIll[27]);
                                            bv.add((d)var25);
                                            0;
                                        }
                                        int[] nArray = new int[lIllllIIll[0]];
                                    ...
                                    var25 = new d(lIllllIIll[33], lIllllIIll[8], lIllllIIll[27]);
                                    bv.add((d)var25);
                                    0;
                                }
                                int[] nArray = new int[lIllllIIll[0]];
                            ...
                            var25 = new d(lIllllIIll[29], lIllllIIll[13], lIllllIIll[27]);
                            bv.add((d)var25);
                            0;
                        }
                        int[] nArray = new int[lIllllIIll[0]];
                        ...
                        if (w.lIIlllllIllll(Bank.contains((int[])nArray) ? 1 : 0)) {
                            var25 = new d(lIllllIIll[39], lIllllIIll[0], lIllllIIll[27]);
                            bv.add((d)var25);
                            0;
                        }
                        ...
                        if (w.lIIlllllIllll(Bank.contains((int[])nArray16) ? 1 : 0)) {
                            var25 = new d(lIllllIIll[38], lIllllIIll[0], lIllllIIll[27]);
                            bv.add((d)var25);
                            0;
                        }
                        ...
                        if (w.lIIlllllIllll(Bank.contains((int[])nArray17) ? 1 : 0)) {
                            var25 = new d(lIllllIIll[40], lIllllIIll[0], lIllllIIll[152]);
                            bv.add((d)var25);
                            0;
                        }
                        ...
                        if (w.lIIlllllIllll(Bank.contains((int[])nArray18) ? 1 : 0)) {
                            var25 = new d(lIllllIIll[41], lIllllIIll[0], lIllllIIll[153] + e.c(lIllllIIll[154], lIllllIIll[155]));
                            bv.add((d)var25);
                            0;
                        }
                        if (w.lIIlllllIllll(Bank.contains((Predicate)(var25 = item -> item.getName().toLowerCase().contains(lIllllIIIl[lIllllIIll[161]]))) ? 1 : 0)) {
                            var23 = new d(lIllllIIll[156], lIllllIIll[8], lIllllIIll[157]);
                            bv.add(var23);
                            0;
                        }
                    ...
                    var23 = new d(lIllllIIll[34], lIllllIIll[13], j.cf);
                    bv.add(var23);
                    0;
                }
                int[] nArray = new int[lIllllIIll[0]];
            ...
            var23 = new d(lIllllIIll[36], lIllllIIll[22], lIllllIIll[158]);
            bv.add(var23);
            0;
        }
    }
    ...
    private static void lIIlllllIlIlI() {
        ...
        w.lIllllIIIl[w.lIllllIIll[1]] = w."Finished buying items, switching back to quest";
        w.lIllllIIIl[w.lIllllIIll[0]] = w."Waterfall";
        w.lIllllIIIl[w.lIllllIIll[9]] = w."Priest in Peril";
        w.lIllllIIIl[w.lIllllIIll[11]] = w."Ernest the Chicken";
        w.lIllllIIIl[w.lIllllIIll[13]] = w."Crafting";
        w.lIllllIIIl[w.lIllllIIll[8]] = w."Woodcutting";
        w.lIllllIIIl[w.lIllllIIll[16]] = w."Training range";
        w.lIllllIIIl[w.lIllllIIll[20]] = w."Varrock Quiz";
        w.lIllllIIIl[w.lIllllIIll[21]] = w."RFD Dwarf";
        w.lIllllIIIl[w.lIllllIIll[19]] = w."A Porcine";
        w.lIllllIIIl[w.lIllllIIll[4]] = w."Antique lamp";
        w.lIllllIIIl[w.lIllllIIll[23]] = w."Client of Kourend";
        w.lIllllIIIl[w.lIllllIIll[24]] = w."Antique lamp";
        w.lIllllIIIl[w.lIllllIIll[25]] = w."";
        w.lIllllIIIl[w.lIllllIIll[26]] = w."Nav to bank";
        w.lIllllIIIl[w.lIllllIIll[28]] = w."Handling banking";
        w.lIllllIIIl[w.lIllllIIll[35]] = w."We are missing quest supplies, switching to BUYING";
        w.lIllllIIIl[w.lIllllIIll[42]] = w."We are missing quest supplies, switching to BUYING";
        w.lIllllIIIl[w.lIllllIIll[46]] = w."Drink";
        w.lIllllIIIl[w.lIllllIIll[12]] = w."Drink";
        w.lIllllIIIl[w.lIllllIIll[48]] = w."Shark";
        w.lIllllIIIl[w.lIllllIIll[49]] = w."Shark";
        w.lIllllIIIl[w.lIllllIIll[50]] = w."Eat";
        w.lIllllIIIl[w.lIllllIIll[51]] = w."Nav to start";
        w.lIllllIIIl[w.lIllllIIll[47]] = w."Ava";
        w.lIllllIIIl[w.lIllllIIll[54]] = w."Bookcase";
        w.lIllllIIIl[w.lIllllIIll[55]] = w."Search";
        w.lIllllIIIl[w.lIllllIIll[57]] = w."Bookcase";
        w.lIllllIIIl[w.lIllllIIll[58]] = w."Search";
        w.lIllllIIIl[w.lIllllIIll[59]] = w."Wear";
        w.lIllllIIIl[w.lIllllIIll[64]] = w."Nav to charter";
        w.lIllllIIIl[w.lIllllIIll[65]] = w."Trader Crewmember";
        w.lIllllIIIl[w.lIllllIIll[10]] = w."Trade";
        w.lIllllIIIl[w.lIllllIIll[66]] = w."Break";
        w.lIllllIIIl[w.lIllllIIll[67]] = w."Nav to ecto";
        w.lIllllIIIl[w.lIllllIIll[14]] = w."Bones";
        w.lIllllIIIl[w.lIllllIIll[68]] = w."Staircase";
        w.lIllllIIIl[w.lIllllIIll[69]] = w."Climb-up";
        w.lIllllIIIl[w.lIllllIIll[70]] = w."Loader";
        w.lIllllIIIl[w.lIllllIIll[71]] = w."Bones";
        w.lIllllIIIl[w.lIllllIIll[22]] = w."Bones";
        w.lIllllIIIl[w.lIllllIIll[72]] = w."Loader";
        w.lIllllIIIl[w.lIllllIIll[75]] = w."Bones";
        w.lIllllIIIl[w.lIllllIIll[76]] = w."Staircase";
        w.lIllllIIIl[w.lIllllIIll[77]] = w."Climb-down";
        w.lIllllIIIl[w.lIllllIIll[78]] = w."Bonemeal";
        w.lIllllIIIl[w.lIllllIIll[79]] = w."Ectofuntus";
        w.lIllllIIIl[w.lIllllIIll[80]] = w."Worship";
        w.lIllllIIIl[w.lIllllIIll[81]] = w."Bonemeal";
        w.lIllllIIIl[w.lIllllIIll[82]] = w."Ghost disciple";
        w.lIllllIIIl[w.lIllllIIll[15]] = w."Malcolm";
        w.lIllllIIIl[w.lIllllIIll[84]] = w."Alice";
        w.lIllllIIIl[w.lIllllIIll[85]] = w."Malcolm";
        w.lIllllIIIl[w.lIllllIIll[86]] = w."Alice";
        w.lIllllIIIl[w.lIllllIIll[87]] = w."Malcolm";
        w.lIllllIIIl[w.lIllllIIll[88]] = w."Alice";
        w.lIllllIIIl[w.lIllllIIll[93]] = w."Nav to crone";
        w.lIllllIIIl[w.lIllllIIll[94]] = w."Old crone";
        w.lIllllIIIl[w.lIllllIIll[96]] = w."Malcolm";
        w.lIllllIIIl[w.lIllllIIll[98]] = w."Malcolm";
        w.lIllllIIIl[w.lIllllIIll[6]] = w."Malcolm";
        w.lIllllIIIl[w.lIllllIIll[101]] = w."Undead chicken";
        w.lIllllIIIl[w.lIllllIIll[102]] = w."Iron bar";
        w.lIllllIIIl[w.lIllllIIll[104]] = w."Iron bar";
        w.lIllllIIIl[w.lIllllIIll[107]] = w."Witch";
        w.lIllllIIIl[w.lIllllIIll[3]] = w."Witch";
        w.lIllllIIIl[w.lIllllIIll[109]] = w."Bar magnet";
        w.lIllllIIIl[w.lIllllIIll[113]] = w."Nav to mine";
        w.lIllllIIIl[w.lIllllIIll[114]] = w."Hammer";
        w.lIllllIIIl[w.lIllllIIll[115]] = w."Selected iron";
        w.lIllllIIIl[w.lIllllIIll[89]] = w."Bar magnet";
        w.lIllllIIIl[w.lIllllIIll[119]] = w."Undead tree";
        w.lIllllIIIl[w.lIllllIIll[120]] = w."Chop";
        w.lIllllIIIl[w.lIllllIIll[90]] = w."Wear";
        w.lIllllIIIl[w.lIllllIIll[125]] = w."Nav to npc";
        w.lIllllIIIl[w.lIllllIIll[126]] = w."Turael";
        w.lIllllIIIl[w.lIllllIIll[95]] = w."Turael";
        w.lIllllIIIl[w.lIllllIIll[128]] = w."Undead twigs";
        w.lIllllIIIl[w.lIllllIIll[129]] = w."Undead tree";
        w.lIllllIIIl[w.lIllllIIll[130]] = w."Chop";
        w.lIllllIIIl[w.lIllllIIll[97]] = w."Undead twigs";
        w.lIllllIIIl[w.lIllllIIll[134]] = w."Research notes";
        w.lIllllIIIl[w.lIllllIIll[135]] = w."Translate";
        w.lIllllIIIl[w.lIllllIIll[138]] = w."A pattern";
        w.lIllllIIIl[w.lIllllIIll[139]] = w."A pattern";
        w.lIllllIIIl[w.lIllllIIll[140]] = w."Hard leather";
        w.lIllllIIIl[w.lIllllIIll[142]] = w."Bookcase";
        w.lIllllIIIl[w.lIllllIIll[143]] = w."Search";
        w.lIllllIIIl[w.lIllllIIll[144]] = w."Nav to start";
        w.lIllllIIIl[w.lIllllIIll[145]] = w."Ava";
        w.lIllllIIIl[w.lIllllIIll[99]] = w."Bookcase";
        w.lIllllIIIl[w.lIllllIIll[146]] = w."Search";
        w.lIllllIIIl[w.lIllllIIll[159]] = w."";
        w.lIllllIIIl[w.lIllllIIll[160]] = w."Animal Magnetism";
        w.lIllllIIIl[w.lIllllIIll[161]] = w."ring of wealth (";
        w.lIllllIIIl[w.lIllllIIll[162]] = w."Drop";
        w.lIllllIIIl[w.lIllllIIll[173]] = w."Yes.";
        w.lIllllIIIl[w.lIllllIIll[174]] = w."I'm here about a quest.";
        w.lIllllIIIl[w.lIllllIIll[175]] = w."Okay, you need it more than I do, I suppose.";
        w.lIllllIIIl[w.lIllllIIll[176]] = w."Could I buy those chickens now, then?";
        w.lIllllIIIl[w.lIllllIIll[100]] = w."Could I buy 2 chickens?";
        w.lIllllIIIl[w.lIllllIIll[177]] = w."I'm here about a quest.";
        w.lIllllIIIl[w.lIllllIIll[178]] = w."Hello, I'm here about those trees again.";
        w.lIllllIIIl[w.lIllllIIll[179]] = w."I'd love one, thanks.";
        w.lIllllIIIl[w.lIllllIIll[180]] = w."";
    }
    ...
    private static boolean an() {
        ...
        int[] nArray2 = nArray;
        int var20 = lIllllIIll[1];
        while (w.lIIlllllIlllI(var20, ((void)var9).length)) {
            int[] nArray3 = new int[lIllllIIll[0]];
            nArray3[w.lIllllIIll[1]] = var9[var20];
    ...
    private static String lIIllllIllIll(String var12, String var16) {
        var12 = new String(Base64.getDecoder().decode(var12.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var11 = new StringBuilder();
        char[] var17 = var16.toCharArray();
        int var15 = lIllllIIll[1];
        char[] var19 = var12.toCharArray();
        int var7 = var19.length;
        int var3 = lIllllIIll[1];
        while (w.lIIlllllIlllI(var3, var7)) {
            char var4 = var19[var3];
            var11.append((char)(var4 ^ var17[var15 % var17.length]));
            0;
            ++var15;
            ++var3;
            0;
    ...
    public static void bf() {
        block115: {
                                ...
                                block120: {
                                    block119: {
                                        block117: {
                                            ...
                                            if (w.lIIllllllIllI(var21) && w.lIIlllllIllll(var21.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                                AccBuilderSotf.c = lIllllIIIl[lIllllIIll[26]];
                                                a.a((BankLocation)var21);
                                            }
                                            if (!w.lIIllllllIllI(var21) || !w.lIIlllllIllIl(var21.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block116;
            ...
            if (w.lIIlllllIllIl(w.an() ? 1 : 0) && w.lIIlllllIllll(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()))) {
                ...
                if (w.lIIlllllIllIl((var21 = new WorldArea(lIllllIIll[52], lIllllIIll[56], lIllllIIll[16], lIllllIIll[4], lIllllIIll[1])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    String[] stringArray = new String[lIllllIIll[0]];
            ...
            if (w.lIIllllllIIII(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIllllIIll[4])) {
                ...
                if (w.lIIlllllIllll(Inventory.contains((int[])nArray10) ? 1 : 0)) {
                    block114: {
                        var21 = new WorldPoint(lIllllIIll[61], lIllllIIll[62], lIllllIIll[1]);
                        int[] nArray11 = new int[lIllllIIll[0]];
                        nArray11[w.lIllllIIll[1]] = lIllllIIll[63];
                        if (w.lIIlllllIllll(Inventory.contains((int[])nArray11) ? 1 : 0) && w.lIIlllllllIlI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var21), lIllllIIll[48])) {
                        ...
                        if (w.lIIlllllIllIl(Inventory.contains((int[])nArray12) ? 1 : 0)) {
                            ...
                            if (!w.lIIlllllIllll(dv.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || w.lIIlllllIllIl(dw.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                var5 = new WorldPoint(lIllllIIll[61], lIllllIIll[62], lIllllIIll[1]);
                                if (w.lIIlllllllIlI(Players.getLocal().getWorldLocation().distanceTo(var5), lIllllIIll[8]) && w.lIIlllllIllll(Players.getLocal().getWorldLocation().getPlane())) {
                                ...
                                if (w.lIIlllllIllIl(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                                    if (w.lIIlllllllIll(Players.getLocal().getWorldLocation().distanceTo(var5), lIllllIIll[8]) && w.lIIlllllIllll(Players.getLocal().getWorldLocation().getPlane())) {
                    ...
                    if (w.lIIlllllIllll(Inventory.contains((int[])nArray15) ? 1 : 0)) {
                        ...
                        if (w.lIIlllllIllll(Inventory.contains((String[])stringArray) ? 1 : 0) && w.lIIlllllllIll(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var21), lIllllIIll[48])) {
            ...
            if (!w.lIlIIIIIIIIIl(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIllllIIll[89]) || w.lIIllllllIIII(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIllllIIll[90])) {
                var21 = new WorldPoint(lIllllIIll[91], lIllllIIll[92], lIllllIIll[1]);
                if (w.lIIlllllllIlI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var21), lIllllIIll[11])) {
                ...
                if (w.lIIlllllllIll(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var21), lIllllIIll[11])) {
            ...
            if (w.lIIllllllIIII(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIllllIIll[100])) {
                ...
                if (w.lIIlllllIllIl(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    ...
                    if (w.lIIlllllIllll(Inventory.contains((String[])stringArray12) ? 1 : 0)) {
                        var21 = new HashMap();
                        ((HashMap)var21).put(lIllllIIll[33], lIllllIIll[8]);
                        0;
                        ((HashMap)var21).put(lIllllIIll[38], lIllllIIll[0]);
                        0;
                        ((HashMap)var21).put(lIllllIIll[39], lIllllIIll[0]);
                        0;
                        ((HashMap)var21).put(lIllllIIll[103], lIllllIIll[0]);
                        0;
                        e.a((HashMap<Integer, Integer>)var21, lIllllIIll[1], lIllllIIll[1]);
                    }
            ...
            if (!w.lIlIIIIIIIIIl(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIllllIIll[105]) || w.lIIllllllIIII(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIllllIIll[106])) {
                ...
                var21 = NPCs.getNearest((String[])stringArray);
                if (w.lIIllllllIllI(var21)) {
                    if (w.lIIlllllIllIl(Reachable.isInteractable((Locatable)var21) ? 1 : 0)) {
                        g.a(lIllllIIIl[lIllllIIll[3]], cE);
                    }
                    if (w.lIIlllllIllll(Reachable.isInteractable((Locatable)var21) ? 1 : 0)) {
                        Movement.walkTo((Locatable)var21);
                        0;
                        Time.sleepTicks((int)lIllllIIll[0]);
                        0;
                    }
            ...
            if (w.lIIllllllIIII(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIllllIIll[108])) {
                ...
                if (w.lIIlllllIllll(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    var21 = new WorldPoint(lIllllIIll[110], lIllllIIll[111], lIllllIIll[1]);
                    var5 = new WorldPoint(lIllllIIll[110], lIllllIIll[112], lIllllIIll[1]);
                    if (w.lIIlllllIllll(Players.getLocal().getWorldLocation().equals(var21) ? 1 : 0) && w.lIIlllllIllll(Players.getLocal().getWorldLocation().equals((Object)var5) ? 1 : 0)) {
                    ...
                    if (w.lIIlllllIllIl(Players.getLocal().getWorldLocation().equals(var21) ? 1 : 0) && w.lIIlllllIllll(Players.getLocal().getWorldLocation().equals((Object)var5) ? 1 : 0)) {
                        Movement.walkTo((WorldPoint)var5);
                        0;
                    }
                    if (w.lIIlllllIllIl(Players.getLocal().getWorldLocation().equals((Object)var5) ? 1 : 0)) {
            ...
            if (w.lIIllllllIIII(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIllllIIll[116])) {
                var21 = new WorldPoint(lIllllIIll[117], lIllllIIll[118], lIllllIIll[1]);
                if (w.lIIlllllIllll(Players.getLocal().getWorldLocation().equals(var21) ? 1 : 0)) {
                    Movement.walkTo((WorldPoint)var21);
                    0;
                    Time.sleepTicks((int)lIllllIIll[0]);
                    0;
                }
                if (w.lIIlllllIllIl(Players.getLocal().getWorldLocation().equals(var21) ? 1 : 0)) {
                    String[] stringArray = new String[lIllllIIll[0]];
            ...
            if (!w.lIlIIIIIIIIIl(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIllllIIll[121]) || w.lIIllllllIIII(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIllllIIll[122])) {
                var21 = new WorldPoint(lIllllIIll[123], lIllllIIll[124], lIllllIIll[1]);
                if (w.lIIlllllllIlI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var21), lIllllIIll[9])) {
                ...
                if (w.lIIlllllllIll(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var21), lIllllIIll[9])) {
                    String[] stringArray = new String[lIllllIIll[0]];
                    stringArray[w.lIllllIIll[1]] = lIllllIIIl[lIllllIIll[126]];
                    var5 = NPCs.getNearest((String[])stringArray);
                    if (w.lIIllllllIllI(var5)) {
                        if (w.lIIlllllIllIl(Reachable.isInteractable((Locatable)var5) ? 1 : 0)) {
                            g.a(lIllllIIIl[lIllllIIll[95]], cE);
                        }
                        if (w.lIIlllllIllll(Reachable.isInteractable((Locatable)var5) ? 1 : 0)) {
    ...
    private static String lIIllllIllIIl(String var6, String var13) {
        try {
            SecretKeySpec var18 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var13.getBytes(StandardCharsets.UTF_8)), lIllllIIll[21]), "DES");
            Cipher var24 = Cipher.getInstance("DES");
            var24.init(lIllllIIll[9], var18);
            return new String(var24.doFinal(Base64.getDecoder().decode(var6.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static String lIIllllIllIlI(String var8, String var10) {
        try {
