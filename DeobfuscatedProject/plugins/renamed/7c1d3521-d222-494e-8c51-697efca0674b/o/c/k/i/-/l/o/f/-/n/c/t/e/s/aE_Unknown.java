...
implements ac {
    ...
    public static void Q() {
        ...
        if (aE.lIllIlllIIIII(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var16 = new d(llIllIlIII[10], llIllIlIII[13], llIllIlIII[43]);
            bv.add(var16);
            0;
        }
        ...
        if (aE.lIllIlllIIIII(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var16 = new d(llIllIlIII[11], llIllIlIII[40], llIllIlIII[44]);
            bv.add(var16);
            0;
        }
        ...
        if (aE.lIllIlllIIIII(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var16 = new d(llIllIlIII[45], llIllIlIII[12], j.cf);
            bv.add(var16);
            0;
        }
        if (aE.lIllIlllIIIll(Skills.getLevel((Skill)Skill.THIEVING), llIllIlIII[5])) {
            ...
            if (aE.lIllIlllIIIII(Bank.contains((int[])nArray5) ? 1 : 0)) {
                var16 = new d(llIllIlIII[7], llIllIlIII[46], llIllIlIII[20]);
                bv.add(var16);
                0;
            }
            ...
            if (aE.lIllIlllIIIII(Bank.contains((int[])nArray6) ? 1 : 0)) {
                var16 = new d(llIllIlIII[6], llIllIlIII[44], llIllIlIII[47]);
                bv.add(var16);
                0;
            }
        }
    ...
    private static void lIllIllIllIIl() {
        ...
        aE.llIllIIllI[aE.llIllIlIII[0]] = aE."Buying items";
        aE.llIllIIllI[aE.llIllIlIII[1]] = aE."Finished buying items, switching back to mining";
        aE.llIllIIllI[aE.llIllIlIII[2]] = aE."Navigating to bank";
        aE.llIllIIllI[aE.llIllIlIII[3]] = aE."Handling banking";
        aE.llIllIIllI[aE.llIllIlIII[8]] = aE."We are missing supplies, switching to BUYING";
        aE.llIllIIllI[aE.llIllIlIII[12]] = aE."We are missing supplies, switching to BUYING";
        aE.llIllIIllI[aE.llIllIlIII[17]] = aE."Wear";
        aE.llIllIIllI[aE.llIllIlIII[18]] = aE."Nav to farmer";
        aE.llIllIIllI[aE.llIllIlIII[20]] = aE."Pickpocketing";
        aE.llIllIIllI[aE.llIllIlIII[21]] = aE."Master Farmer";
        aE.llIllIIllI[aE.llIllIlIII[13]] = aE."Master Farmer";
        aE.llIllIIllI[aE.llIllIlIII[22]] = aE."Pickpocket";
        aE.llIllIIllI[aE.llIllIlIII[23]] = aE."Stunned";
        aE.llIllIIllI[aE.llIllIlIII[24]] = aE."Drink";
        aE.llIllIIllI[aE.llIllIlIII[25]] = aE."Jug";
        aE.llIllIIllI[aE.llIllIlIII[16]] = aE."Jug";
        aE.llIllIIllI[aE.llIllIlIII[26]] = aE."Nav to men";
        aE.llIllIIllI[aE.llIllIlIII[27]] = aE."Pickpocketing";
        aE.llIllIIllI[aE.llIllIlIII[29]] = aE."Open-all";
        aE.llIllIIllI[aE.llIllIlIII[30]] = aE."Man";
        aE.llIllIIllI[aE.llIllIlIII[14]] = aE."Man";
        aE.llIllIIllI[aE.llIllIlIII[31]] = aE."Pickpocket";
        aE.llIllIIllI[aE.llIllIlIII[32]] = aE."Stunned";
        aE.llIllIIllI[aE.llIllIlIII[33]] = aE."Eat";
        aE.llIllIIllI[aE.llIllIlIII[34]] = aE."Nav to tea tile";
        aE.llIllIIllI[aE.llIllIlIII[28]] = aE."Open-all";
        aE.llIllIIllI[aE.llIllIlIII[35]] = aE."Stealing";
        aE.llIllIIllI[aE.llIllIlIII[36]] = aE."Tea stall";
        aE.llIllIIllI[aE.llIllIlIII[37]] = aE."Tea stall";
        aE.llIllIIllI[aE.llIllIlIII[38]] = aE."Steal-from";
        aE.llIllIIllI[aE.llIllIlIII[40]] = aE."Dropping";
        aE.llIllIIllI[aE.llIllIlIII[49]] = aE."Thieving";
        aE.llIllIIllI[aE.llIllIlIII[51]] = aE."Drop";
        aE.llIllIIllI[aE.llIllIlIII[52]] = aE."Drop";
        aE.llIllIIllI[aE.llIllIlIII[53]] = aE."Tea stall";
        aE.llIllIIllI[aE.llIllIlIII[54]] = aE."Drop";
        aE.llIllIIllI[aE.llIllIlIII[55]] = aE."Drop";
        aE.llIllIIllI[aE.llIllIlIII[56]] = aE."Drop";
        aE.llIllIIllI[aE.llIllIlIII[5]] = aE."Onion seed";
        aE.llIllIIllI[aE.llIllIlIII[61]] = aE."Marigold seed";
        aE.llIllIIllI[aE.llIllIlIII[62]] = aE."Cabbage seed";
        aE.llIllIIllI[aE.llIllIlIII[63]] = aE."Jute seed";
        aE.llIllIIllI[aE.llIllIlIII[64]] = aE."Potato seed";
        aE.llIllIIllI[aE.llIllIlIII[65]] = aE."Tomato seed";
        aE.llIllIIllI[aE.llIllIlIII[66]] = aE."Nasturtium seed";
        aE.llIllIIllI[aE.llIllIlIII[67]] = aE."Holy handegg";
        aE.llIllIIllI[aE.llIllIlIII[68]] = aE."Peaceful handegg";
        aE.llIllIIllI[aE.llIllIlIII[69]] = aE."Chaotic handegg";
        aE.llIllIIllI[aE.llIllIlIII[70]] = aE."Sweetcorn seed";
        aE.llIllIIllI[aE.llIllIlIII[71]] = aE."Woad seed";
        aE.llIllIIllI[aE.llIllIlIII[72]] = aE."Redberry seed";
        aE.llIllIIllI[aE.llIllIlIII[73]] = aE."Jangerberry seed";
        aE.llIllIIllI[aE.llIllIlIII[74]] = aE."Tarromin seed";
        aE.llIllIIllI[aE.llIllIlIII[75]] = aE."Rosemary seed";
        aE.llIllIIllI[aE.llIllIlIII[76]] = aE."Strawberry seed";
        aE.llIllIIllI[aE.llIllIlIII[77]] = aE."Hammerstone seed";
        aE.llIllIIllI[aE.llIllIlIII[78]] = aE."Asgarnian seed";
        aE.llIllIIllI[aE.llIllIlIII[79]] = aE."Yanillian seed";
        aE.llIllIIllI[aE.llIllIlIII[80]] = aE."Krandorian seed";
        aE.llIllIIllI[aE.llIllIlIII[81]] = aE."Wildblood seed";
        aE.llIllIIllI[aE.llIllIlIII[82]] = aE."Marigold seed";
        aE.llIllIIllI[aE.llIllIlIII[83]] = aE."Rosemary seed";
        aE.llIllIIllI[aE.llIllIlIII[84]] = aE."Cadavaberry seed";
        aE.llIllIIllI[aE.llIllIlIII[85]] = aE."Dwellberry seed";
        aE.llIllIIllI[aE.llIllIlIII[86]] = aE."Jangerberry seed";
        aE.llIllIIllI[aE.llIllIlIII[87]] = aE."Poison ivy seed";
        aE.llIllIIllI[aE.llIllIlIII[88]] = aE."Guam seed";
        aE.llIllIIllI[aE.llIllIlIII[89]] = aE."Marrentill seed";
        aE.llIllIIllI[aE.llIllIlIII[90]] = aE."Tarromin seed";
        aE.llIllIIllI[aE.llIllIlIII[91]] = aE."Harralander seed";
        aE.llIllIIllI[aE.llIllIlIII[92]] = aE."Mushroom spore";
        aE.llIllIIllI[aE.llIllIlIII[93]] = aE."Belladonna seed";
        aE.llIllIIllI[aE.llIllIlIII[94]] = aE."Cactus seed";
        aE.llIllIIllI[aE.llIllIlIII[95]] = aE."Potato cactus seed";
        aE.llIllIIllI[aE.llIllIlIII[96]] = aE."Jug";
    }
                ...
                if (aE.lIllIlllIIIIl(TileObjects.getNearest((String[])stringArray))) {
                    ...
                    Time.sleepUntil(() -> {
                        ...
                        if (aE.lIllIlllIlIII(TileObjects.getNearest((String[])stringArray))) {
                            ...
                            0;
                            if (-2 > 0) {
                                return ((0xE4 ^ 0xAD ^ (0x37 ^ 0x6C)) & (13 + 63 - 25 + 90 ^ 11 + 34 - -102 + 12 ^ -1)) != 0;
                            }
                        } else {
                            bl = llIllIlIII[0];
                        }
    ...
    private static String lIllIllIllIII(String var12, String var4) {
        var12 = new String(Base64.getDecoder().decode(var12.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var19 = new StringBuilder();
        char[] var17 = var4.toCharArray();
        int var10 = llIllIlIII[0];
        char[] var3 = var12.toCharArray();
        int var20 = var3.length;
        int var21 = llIllIlIII[0];
        while (aE.lIllIllIlllll(var21, var20)) {
            char var14 = var3[var21];
            var19.append((char)(var14 ^ var17[var10 % var17.length]));
            0;
            ++var10;
            ++var21;
            0;
    ...
    private static void lIllIllIlllIl() {
        ...
        aE.llIllIlIII[0] = (0x3A ^ 2 ^ (0x3B ^ 0x24)) & (0x98 ^ 0xB7 ^ (0x9F ^ 0x97) ^ -1);
        aE.llIllIlIII[1] = 1;
        aE.llIllIlIII[2] = 2;
        aE.llIllIlIII[3] = 3;
    ...
    private static String lIllIllIlIllI(String var18, String var6) {
        try {
            SecretKeySpec var11 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var6.getBytes(StandardCharsets.UTF_8)), llIllIlIII[20]), "DES");
            Cipher var15 = Cipher.getInstance("DES");
            var15.init(llIllIlIII[2], var11);
    ...
    private static String lIllIllIlIlll(String var13, String var8) {
        try {
                        ...
                        block25: {
                            block23: {
                                block24: {
                                    ...
                                    if (aE.lIllIlllIIIIl(var1) && aE.lIllIlllIIIII(var1.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                        AccBuilderSotf.c = llIllIIllI[llIllIlIII[2]];
                                        a.a(var1);
                                    }
                                    if (!aE.lIllIlllIIIIl(var1) || !aE.lIllIllIllllI(var1.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block22;
