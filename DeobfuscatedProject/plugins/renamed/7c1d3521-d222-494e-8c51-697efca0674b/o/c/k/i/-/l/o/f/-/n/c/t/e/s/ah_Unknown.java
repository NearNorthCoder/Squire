...
implements ac {
    ...
    private static String lIlIllIIIIIIl(String var1, String var3) {
        try {
    ...
    public static void Q() {
        ...
        if (ah.lIlIllIIIlIlI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var17 = new d(llIIllIIlI[52], llIIllIIlI[10], llIIllIIlI[51]);
            bv.add(var17);
            0;
        }
        ...
        if (ah.lIlIllIIIlIlI(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var17 = new d(llIIllIIlI[49], llIIllIIlI[1], llIIllIIlI[53]);
            bv.add(var17);
            0;
        }
        ...
        if (ah.lIlIllIIIlIlI(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var17 = new d(llIIllIIlI[47], llIIllIIlI[1], llIIllIIlI[54]);
            bv.add(var17);
            0;
        }
        ...
        if (ah.lIlIllIIIlIlI(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var17 = new d(llIIllIIlI[11], llIIllIIlI[12], llIIllIIlI[55]);
            bv.add(var17);
            0;
        }
        ...
        if (ah.lIlIllIIIlIlI(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var17 = new d(llIIllIIlI[40], llIIllIIlI[1], llIIllIIlI[56]);
            bv.add(var17);
            0;
        }
        ...
        if (ah.lIlIllIIIlIlI(Bank.contains((int[])nArray7) ? 1 : 0)) {
            var17 = new d(llIIllIIlI[44], llIIllIIlI[1], llIIllIIlI[56]);
            bv.add(var17);
            0;
        }
        ...
        if (ah.lIlIllIIIlIlI(Bank.contains((int[])nArray8) ? 1 : 0)) {
            var17 = new d(llIIllIIlI[45], llIIllIIlI[1], llIIllIIlI[56]);
            bv.add(var17);
            0;
        }
        ...
        if (ah.lIlIllIIIlIlI(Bank.contains((int[])nArray9) ? 1 : 0)) {
            var17 = new d(llIIllIIlI[42], llIIllIIlI[1], llIIllIIlI[56]);
            bv.add(var17);
            0;
        }
        if (ah.lIlIllIIIllIl(Skills.getLevel((Skill)Skill.ATTACK), llIIllIIlI[2])) {
            ...
            if (ah.lIlIllIIIlIlI(Bank.contains((int[])nArray10) ? 1 : 0)) {
                var17 = new d(llIIllIIlI[17], llIIllIIlI[1], llIIllIIlI[54]);
                bv.add(var17);
                0;
            }
        }
        ...
        if (ah.lIlIllIIIlIlI(Bank.contains((int[])nArray11) ? 1 : 0)) {
            var17 = new d(llIIllIIlI[16], llIIllIIlI[1], llIIllIIlI[56]);
            bv.add(var17);
            0;
        }
    }

    private static String lIlIllIIIIIII(String var18, String var20) {
        var18 = new String(Base64.getDecoder().decode(var18.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var21 = new StringBuilder();
        char[] var8 = var20.toCharArray();
        int var22 = llIIllIIlI[0];
        char[] var4 = var18.toCharArray();
        int var14 = var4.length;
        int var11 = llIIllIIlI[0];
        while (ah.lIlIllIIIlIIl(var11, var14)) {
            char var19 = var4[var11];
            var21.append((char)(var19 ^ var8[var22 % var8.length]));
            0;
            ++var22;
            ++var11;
            0;
    ...
    private static String lIlIlIlllllll(String var10, String var12) {
        try {
            SecretKeySpec var15 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var12.getBytes(StandardCharsets.UTF_8)), llIIllIIlI[18]), "DES");
            Cipher var5 = Cipher.getInstance("DES");
            var5.init(llIIllIIlI[3], var15);
    ...
    public static void am() {
        ...
        if (ah.lIlIllIIIlIII(cM.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (ah.lIlIllIIIllll(Players.getLocal().getInteracting())) {
                ...
                List var2 = NPCs.getAll((String[])stringArray).stream().filter(nPC -> {
                    boolean bl;
                ...
                if (ah.lIlIllIIIlIlI(var2.isEmpty() ? 1 : 0)) {
                    ((NPC)var2.get(llIIllIIlI[0])).interact(llIIllIIII[llIIllIIlI[24]]);
                    Time.sleepTicks((int)llIIllIIlI[3]);
                    0;
                }
                if (ah.lIlIllIIIlIll(var24) && ah.lIlIllIIIlIlI(Players.getLocal().isMoving() ? 1 : 0) && ah.lIlIllIIIlIII(var2.isEmpty() ? 1 : 0)) {
                    var24.interact(llIIllIIII[llIIllIIlI[25]]);
                    Time.sleepTicks((int)llIIllIIlI[3]);
                    0;
                }
            }
            ...
            block19: {
                block18: {
                    ...
                    if (ah.lIlIllIIIlIlI(ah.aM() ? 1 : 0) && ah.lIlIllIIIlIIl(Skills.getLevel((Skill)Skill.DEFENCE), llIIllIIlI[2])) {
                        ...
                        if (ah.lIlIllIIIlIll(var13) && ah.lIlIllIIIlIlI(var13.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            AccBuilderSotf.c = llIIllIIII[llIIllIIlI[3]];
                            a.a(var13);
                        }
                        if (ah.lIlIllIIIlIll(var13) && ah.lIlIllIIIlIII(var13.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
