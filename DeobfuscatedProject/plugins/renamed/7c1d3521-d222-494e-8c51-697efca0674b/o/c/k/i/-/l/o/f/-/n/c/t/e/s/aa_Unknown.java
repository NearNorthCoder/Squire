...
implements ac {
                ...
                block48: {
                    block46: {
                        ...
                        if (aa.lIllllIllIIlI(e.j(lllIIIIIll[9]), lllIIIIIll[1])) {
                            ...
                            if (aa.lIllllIllIlll(var21) && aa.lIllllIllIIll(var21.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                AccBuilderSotf.c = lllIIIIIlI[lllIIIIIll[10]];
                                a.a(var21);
                                Time.sleepTicks((int)lllIIIIIll[5]);
                                0;
                            }
                            if (aa.lIllllIllIlll(var21) && aa.lIllllIllIIIl(var21.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (aa.lIllllIllIIll(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    ...
                    if (aa.lIllllIllIIIl(Inventory.contains((String[])stringArray3) ? 1 : 0)) {
                        ...
                        if (aa.lIllllIlllIIl(Players.getLocal().getWorldLocation().distanceTo(mJ), lllIIIIIll[10])) {
                            ...
                            var21 = TileObjects.getNearest((String[])stringArray4);
                            var21.interact(lllIIIIIlI[lllIIIIIll[37]]);
                            Time.sleepTicks((int)lllIIIIIll[7]);
                            0;
                        }
                        if (aa.lIllllIlllIIl(Players.getLocal().getWorldLocation().distanceTo(mK), lllIIIIIll[3])) {
                            ...
                            var21 = NPCs.getNearest((String[])stringArray7);
                            if (aa.lIllllIllIlll(var21)) {
                                ...
                                if (aa.lIllllIlllIll(Players.getLocal().getInteracting()) && aa.lIllllIllIIll(var21.isDead() ? 1 : 0)) {
                                    var21.interact(lllIIIIIlI[lllIIIIIll[45]]);
                                    Time.sleepTicks((int)lllIIIIIll[5]);
                                    0;
                                }
                            }
    ...
    private static String lIllllIlIllII(String var2, String var18) {
        ...
        int var19 = lllIIIIIll[0];
        char[] var4 = var2.toCharArray();
        int var22 = var4.length;
        int var13 = lllIIIIIll[0];
        while (aa.lIllllIllIIlI(var13, var22)) {
            char var3 = var4[var13];
            var5.append((char)(var3 ^ var16[var19 % var16.length]));
            0;
            ++var19;
            ++var13;
            0;
    ...
    private static String lIllllIlIlIll(String var9, String var7) {
        try {
            SecretKeySpec var20 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var7.getBytes(StandardCharsets.UTF_8)), lllIIIIIll[21]), "DES");
            Cipher var14 = Cipher.getInstance("DES");
            var14.init(lllIIIIIll[5], var20);
    ...
    private static void Q() {
        ...
        if (aa.lIllllIllIIll(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var10 = new d(lllIIIIIll[15], lllIIIIIll[1], lllIIIIIll[50]);
            bv.add((d)var10);
            0;
        }
        int[] nArray3 = new int[lllIIIIIll[1]];
        ...
        if (aa.lIllllIllIIll(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var10 = new d(lllIIIIIll[17], lllIIIIIll[1], lllIIIIIll[51]);
            bv.add((d)var10);
            0;
        }
        int[] nArray4 = new int[lllIIIIIll[1]];
        ...
        if (aa.lIllllIllIIll(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var10 = new d(lllIIIIIll[14], lllIIIIIll[1], lllIIIIIll[50]);
            bv.add((d)var10);
            0;
        }
        int[] nArray5 = new int[lllIIIIIll[1]];
        ...
        if (aa.lIllllIllIIll(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var10 = new d(lllIIIIIll[19], lllIIIIIll[1], lllIIIIIll[52]);
            bv.add((d)var10);
            0;
        }
        ...
        if (aa.lIllllIllIIll(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var10 = new d(lllIIIIIll[6], lllIIIIIll[3], lllIIIIIll[50]);
            bv.add((d)var10);
            0;
        }
        ...
        if (aa.lIllllIllIIIl(Bank.contains((int[])nArray7) ? 1 : 0)) {
            ...
            if (aa.lIllllIllIIlI(Bank.getFirst((int[])nArray8).getQuantity(), lllIIIIIll[32])) {
                var10 = new d(lllIIIIIll[6], lllIIIIIll[53], lllIIIIIll[54]);
                bv.add((d)var10);
                0;
            }
        }
        if (aa.lIllllIllIIll(Bank.contains((Predicate)(var10 = item -> item.getName().toLowerCase().contains(lllIIIIIlI[lllIIIIIll[61]]))) ? 1 : 0)) {
            var15 = new d(lllIIIIIll[55], lllIIIIIll[11], lllIIIIIll[56]);
            bv.add(var15);
            0;
        }
        ...
        if (aa.lIllllIllIIll(Bank.contains((int[])nArray9) ? 1 : 0)) {
            var15 = new d(lllIIIIIll[16], lllIIIIIll[53], lllIIIIIll[57]);
            bv.add(var15);
            0;
        }
        ...
        if (aa.lIllllIllIIll(Bank.contains((int[])nArray10) ? 1 : 0)) {
            var15 = new d(lllIIIIIll[58], lllIIIIIll[11], j.cf);
            bv.add(var15);
            0;
        }
    }
    ...
    private static String lIllllIlIllIl(String var11, String var1) {
        try {
            SecretKeySpec var12 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var1.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var8 = Cipher.getInstance("Blowfish");
            var8.init(lllIIIIIll[5], var12);
