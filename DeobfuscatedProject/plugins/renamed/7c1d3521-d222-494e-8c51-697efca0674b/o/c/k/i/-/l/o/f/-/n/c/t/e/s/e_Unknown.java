...
public class e_Unknown {
    ...
    private static String lIlIlIIIIIIll(String var42, String var14) {
        try {
            SecretKeySpec var55 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var14.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var38 = Cipher.getInstance("Blowfish");
            var38.init(llIIlIIIII[9], var55);
            return new String(var38.doFinal(Base64.getDecoder().decode(var42.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void a(HashMap<Integer, Integer> hashMap, boolean bl, boolean bl2) {
        ...
        if (e.lIlIlIIIIlllI(Players.getLocal().getWorldLocation().distanceTo(ad), llIIlIIIII[10])) {
            ...
            if (e.lIlIlIIIIlIll((int)var6) && e.lIlIlIIIIIllI(Inventory.getAll().size())) {
                Bank.depositInventory();
                Time.sleepTicks((int)llIIlIIIII[10]);
                0;
            }
            if (e.lIlIlIIIIlIll((int)var13) && e.lIlIlIIIIIllI(Equipment.getAll().size())) {
                Bank.depositEquipment();
                Time.sleepTicks((int)llIIlIIIII[9]);
                0;
            }
            Iterator<Map.Entry<Integer, Integer>> var67 = var63.entrySet().iterator();
            while (e.lIlIlIIIIlIll(var67.hasNext() ? 1 : 0)) {
                Map.Entry<Integer, Integer> var9 = var67.next();
                int var37 = var9.getKey();
                int var23 = var9.getValue();
                System.out.println("Key: " + var37 + ", Value: " + var23);
                a.a(var37, var23);
                Time.sleepTicks((int)llIIlIIIII[1]);
                0;
                0;
    ...
    private static String lIlIlIIIIIIlI(String var26, String var18) {
        try {
            SecretKeySpec var35 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var18.getBytes(StandardCharsets.UTF_8)), llIIlIIIII[14]), "DES");
            Cipher var15 = Cipher.getInstance("DES");
            var15.init(llIIlIIIII[9], var35);
            return new String(var15.doFinal(Base64.getDecoder().decode(var26.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    public static void a(WorldPoint worldPoint) {
        if (e.lIlIlIIIIlIII(o.cF.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (e.lIlIlIIIIlllI(Players.getLocal().getWorldLocation().distanceTo(o.cB), llIIlIIIII[5])) {
                ...
                if (e.lIlIlIIIIlIIl(var52 = NPCs.getNearest(nPC -> {
                    ...
                    if (e.lIlIlIIIIlIll(var52.hasAction(stringArray) ? 1 : 0)) {
                        var52.interact(llIIIlllll[llIIlIIIII[10]]);
                    ...
                    if (e.lIlIlIIIIlIII(var52.hasAction(stringArray2) ? 1 : 0)) {
                ...
                NPC var57 = NPCs.getNearest((String[])stringArray);
                if (e.lIlIlIIIIlIIl(var57)) {
                    String[] stringArray3 = new String[llIIlIIIII[1]];
                    stringArray3[e.llIIlIIIII[2]] = llIIIlllll[llIIlIIIII[14]];
                    if (e.lIlIlIIIIlIll(var57.hasAction(stringArray3) ? 1 : 0)) {
                        var57.interact(llIIIlllll[llIIlIIIII[15]]);
                        Time.sleepTicks((int)llIIlIIIII[5]);
                        0;
                    }
                    String[] stringArray4 = new String[llIIlIIIII[1]];
                    stringArray4[e.llIIlIIIII[2]] = llIIIlllll[llIIlIIIII[16]];
                    if (e.lIlIlIIIIlIII(var57.hasAction(stringArray4) ? 1 : 0)) {
    ...
    public static void G() {
        block9: {
            ...
            do {
                ...
                NPC var30 = NPCs.getNearest((String[])stringArray2);
                if (e.lIlIlIIIIlIII(var59)) {
                    if (e.lIlIlIIIIlIII(Dialog.isOpen() ? 1 : 0)) {
                        var30.interact(llIIIlllll[llIIlIIIII[75]]);
                    }
                    if (e.lIlIlIIIIlIll(Dialog.isOpen() ? 1 : 0)) {
                        List var43;
                        if (e.lIlIlIIIIlIII(Dialog.canContinueNPC() ? 1 : 0) && e.lIlIlIIIIlIII(Dialog.canContinue() ? 1 : 0) && e.lIlIlIIIIlIII((var43 = Dialog.getOptions()).isEmpty() ? 1 : 0)) {
                            List var56 = var43.stream().filter(widget -> {
                                boolean bl;
                            ...
                            if (e.lIlIlIIIIlIII(var56.isEmpty() ? 1 : 0)) {
                                Mouse.click((int)((Widget)var56.get(llIIlIIIII[2])).getClickPoint().getX(), (int)((Widget)var56.get(llIIlIIIII[2])).getClickPoint().getY(), (boolean)llIIlIIIII[1]);
                                Time.sleepTicks((int)llIIlIIIII[5]);
                                0;
                            }
                            if (e.lIlIlIIIIlIlI(var56.size(), llIIlIIIII[1])) {
                                var59 = llIIlIIIII[1];
                            }
                        }
    ...
    public static void A() {
        ...
        if (e.lIlIlIIIIlIll(e.z() ? 1 : 0)) {
            ...
            if (e.lIlIlIIIIlIll(e.B() ? 1 : 0)) {
                Widget var40;
                Widget var32;
                var31 = Widgets.get((int)llIIlIIIII[32], (int)llIIlIIIII[33], (int)llIIlIIIII[13]);
                if (e.lIlIlIIIIlIIl(var31)) {
                    var31.interact(llIIIlllll[llIIlIIIII[34]]);
                    Time.sleepTicks((int)llIIlIIIII[1]);
                    0;
                }
                if (e.lIlIlIIIIlIII(Vars.getBit((int)llIIlIIIII[35])) && e.lIlIlIIIIlIIl(var32 = Widgets.get((int)llIIlIIIII[32], (int)llIIlIIIII[34], (int)llIIlIIIII[28]))) {
                    if (e.lIlIlIIIIlIII(var32.isVisible() ? 1 : 0)) {
                        var40 = Widgets.get((int)llIIlIIIII[32], (int)llIIlIIIII[36], (int)llIIlIIIII[11]);
                        Mouse.click((int)var40.getClickPoint().getX(), (int)var40.getClickPoint().getY(), (boolean)llIIlIIIII[1]);
                        Time.sleepTicks((int)llIIlIIIII[1]);
                        0;
                    }
                    if (e.lIlIlIIIIlIll(var32.isVisible() ? 1 : 0)) {
                        var32.interact(llIIIlllll[llIIlIIIII[36]]);
                        Time.sleepTicks((int)llIIlIIIII[1]);
                        0;
                    }
                }
                if (e.lIlIlIIIIlIII(Vars.getBit((int)llIIlIIIII[37])) && e.lIlIlIIIIlIIl(var32 = Widgets.get((int)llIIlIIIII[32], (int)llIIlIIIII[34], (int)llIIlIIIII[38]))) {
                    if (e.lIlIlIIIIlIII(var32.isVisible() ? 1 : 0)) {
                        var40 = Widgets.get((int)llIIlIIIII[32], (int)llIIlIIIII[36], (int)llIIlIIIII[11]);
                        Mouse.click((int)var40.getClickPoint().getX(), (int)var40.getClickPoint().getY(), (boolean)llIIlIIIII[1]);
                        Time.sleepTicks((int)llIIlIIIII[1]);
                    ...
                    if (e.lIlIlIIIIlIll(var32.isVisible() ? 1 : 0)) {
                        var32.interact(llIIIlllll[llIIlIIIII[39]]);
                        Time.sleepTicks((int)llIIlIIIII[9]);
                        0;
                    }
                }
        ...
        if (e.lIlIlIIIIlIIl(var31 = Widgets.get((int)llIIlIIIII[32], (int)llIIlIIIII[10]))) {
            var31.interact(llIIIlllll[llIIlIIIII[40]]);
            Time.sleepTicks((int)llIIlIIIII[1]);
            0;
        }
    }
    ...
    public static void t() {
        ...
        int var41 = llIIlIIIII[2];
        while (e.lIlIlIIIIIlll(var41, ac.length)) {
            Widget var58 = Widgets.get((int)ac[var41], widget -> widget.getText().contains(llIIIlllll[llIIlIIIII[27]]));
            if (e.lIlIlIIIIlIIl(var58)) {
                Keyboard.sendSpace();
                System.out.println("Found Conversation continue window :" + ac[var41]);
            }
            ++var41;
            0;
            if (1 > 0) continue;
    ...
    public static void c(WorldPoint worldPoint) {
        ...
        WorldPoint var64 = var24;
        int var44 = var64.getX() - var22.getBaseX();
        Point var68 = Perspective.localToCanvas((Client)var22, (LocalPoint)LocalPoint.fromScene((int)var44, (int)(var4 = var64.getY() - var22.getBaseY())), (int)var22.getPlane());
        if (e.lIlIlIIIIlIIl(var68)) {
            n3 = var68.getX();
            0;
    ...
    public static void a(String var1, String var10) {
        try {
            URL var36 = new URL(var1);
            HttpURLConnection var47 = (HttpURLConnection)var36.openConnection();
            var47.setRequestMethod(llIIIlllll[llIIlIIIII[66]]);
            var47.setRequestProperty(llIIIlllll[llIIlIIIII[67]], llIIIlllll[llIIlIIIII[68]]);
            var47.setDoOutput(llIIlIIIII[1]);
            String var16 = "{\"content\": \"" + var10 + "\"}";
            DataOutputStream var51 = new DataOutputStream(var47.getOutputStream());
            var51.writeBytes(var16);
            var51.flush();
            var51.close();
            int var34 = var47.getResponseCode();
            System.out.println("Response Code: " + var34);
            var47.disconnect();
            0;
        }
    ...
    private static String lIlIlIIIIIIIl(String var8, String var21) {
        var8 = new String(Base64.getDecoder().decode(var8.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var53 = new StringBuilder();
        char[] var60 = var21.toCharArray();
        int var33 = llIIlIIIII[2];
        char[] var2 = var8.toCharArray();
        int var54 = var2.length;
        int var48 = llIIlIIIII[2];
        while (e.lIlIlIIIIIlll(var48, var54)) {
            char var45 = var2[var48];
            var53.append((char)(var45 ^ var60[var33 % var60.length]));
            0;
            ++var33;
            ++var48;
            0;
    ...
    public static int c(int n2, int n3) {
        ...
        if (e.lIlIlIIIIlIlI(Math.abs(var27), llIIlIIIII[1])) {
            int n5;
    ...
    public static void b(WorldPoint worldPoint) {
        ...
        if (e.lIlIlIIIIlllI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var61), llIIlIIIII[12]) && e.lIlIlIIIIlllI(Players.getLocal().getWorldLocation().getY(), llIIlIIIII[51])) {
            if (e.lIlIlIIIIlIII(Dialog.isOpen() ? 1 : 0)) {
                String[] stringArray = new String[llIIlIIIII[1]];
        ...
        if (e.lIlIlIIIIllIl(Players.getLocal().getWorldLocation().getY(), llIIlIIIII[51]) && (!e.lIlIlIIIIlIII(var29.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !e.lIlIlIIIIlIII(var19.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || e.lIlIlIIIIlllI(Players.getLocal().getWorldLocation().distanceTo(new WorldPoint(llIIlIIIII[59], llIIlIIIII[60], llIIlIIIII[1])), llIIlIIIII[36]))) {
            WorldPoint var3;
    ...
    public static boolean c(int[] nArray) {
        int[] var5;
        int var49 = llIIlIIIII[2];
        while (e.lIlIlIIIIIlll(var49, var5.length)) {
            if (e.lIlIlIIIIlIII(e.i(var5[var49]) ? 1 : 0)) {
                System.out.println("Missing ID: " + var5[var49]);
                return llIIlIIIII[2];
            }
            ++var49;
            0;
    ...
    public static void k(int n2) {
        if (e.lIlIlIIIIllll(Static.getClient().getWorld(), n2)) {
            ...
            World var50 = Static.getClient().createWorld();
            var50.setActivity(var46.getActivity());
            var50.setAddress(var46.getAddress());
            var50.setId(var46.getId());
            var50.setPlayerCount(var46.getPlayers());
            var50.setLocation(var46.getLocation());
            var50.setTypes(WorldUtil.toWorldTypes((EnumSet)var46.getTypes()));
            Worlds.hopTo((World)var50);
        }
    }
    ...
    public static void E() {
        if (e.lIlIlIIIIlIII(e.j(llIIlIIIII[70]))) {
            ...
            if (e.lIlIlIIIIlIll(Tabs.isOpen((Tab)Tab.COMBAT) ? 1 : 0) && e.lIlIlIIIIlIIl(var20 = Widgets.get((int)llIIlIIIII[71], (int)llIIlIIIII[49]))) {
                var20.interact(llIIIlllll[llIIlIIIII[72]]);
                Time.sleepTicks((int)llIIlIIIII[1]);
                0;
            }
        }
        ...
        if (e.lIlIlIIIIlIll(Inventory.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (e.lIlIlIIIIlIII(Equipment.contains((int[])nArray2) ? 1 : 0)) {
                ...
                if (e.lIlIlIIIIlIll(Inventory.getFirst((int[])nArray7).hasAction(stringArray3) ? 1 : 0)) {
                    ...
                    nArray8[e.llIIlIIIII[2]] = var12;
                    Inventory.getFirst((int[])nArray8).interact(llIIIlllll[llIIlIIIII[22]]);
                }
                if (e.lIlIlIIIIlIlI(var12, llIIlIIIII[48])) {
                    Time.sleepTicks((int)llIIlIIIII[5]);
                    0;
                    String[] stringArray4 = new String[llIIlIIIII[1]];
    ...
    public static void F() {
        if (e.lIlIlIIIIlIlI(e.j(llIIlIIIII[70]), llIIlIIIII[1])) {
            ...
            if (e.lIlIlIIIIlIll(Tabs.isOpen((Tab)Tab.COMBAT) ? 1 : 0) && e.lIlIlIIIIlIIl(var7 = Widgets.get((int)llIIlIIIII[71], (int)llIIlIIIII[49]))) {
                var7.interact(llIIIlllll[llIIlIIIII[28]]);
                Time.sleepTicks((int)llIIlIIIII[1]);
                0;
            }
        }
    ...
    public static void b(int[] nArray) {
        int[] var25;
        int var65 = llIIlIIIII[2];
        while (e.lIlIlIIIIIlll(var65, var25.length)) {
            AccBuilderSotf.c = llIIIlllll[llIIlIIIII[2]];
            if (e.lIlIlIIIIlIII(var25[var65])) {
                0;
