...
import q.i.e.u.s.s.o.e.i.n.l.f.-.r.o.-.p.-.m.r.o.CaveNavTask;
import q.i.e.u.s.s.o.e.i.n.l.f.-.r.o.-.p.-.m.r.o.l_Unknown;

/* TASK: Prep supplies -> PrepsuppliesTask */
...
extends Task {
    ...
    private static String lIIlIlllIIIIIll(String var10, String var25) {
        var10 = new String(Base64.getDecoder().decode(var10.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var6 = new StringBuilder();
        char[] var2 = var25.toCharArray();
        int var13 = lIIIIIIIlllll[0];
        char[] var1 = var10.toCharArray();
        int var12 = var1.length;
        int var24 = lIIIIIIIlllll[0];
        while (k.lIIlIlllIIllIlI(var24, var12)) {
            char var4 = var1[var24];
            var6.append((char)(var4 ^ var2[var13 % var2.length]));
            0;
            ++var13;
            ++var24;
            0;
    ...
    private static String lIIlIlllIIIIlII(String var5, String var8) {
        try {
            SecretKeySpec var27 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var8.getBytes(StandardCharsets.UTF_8)), lIIIIIIIlllll[9]), "DES");
            Cipher var18 = Cipher.getInstance("DES");
            var18.init(lIIIIIIIlllll[2], var27);
    ...
    private static String lIIlIlllIIIIlIl(String var11, String var23) {
        try {
            ...
            var14.init(lIIIIIIIlllll[2], var20);
    ...
    private static void g() {
        ...
        if (k.lIIlIlllIIlIllI(var16)) {
            void var3;
            void var9;
            String[] stringArray4 = new String[lIIIIIIIlllll[1]];
            stringArray4[k.lIIIIIIIlllll[0]] = lIIIIIIIllllI[lIIIIIIIlllll[4]];
            List var7 = Inventory.getAll((String[])stringArray4);
            if (k.lIIlIlllIIlIlll(var7.size(), lIIIIIIIlllll[2])) {
                ((Item)var7.get(lIIIIIIIlllll[0])).useOn((Item)var7.get(lIIIIIIIlllll[1]));
                return;
            }
            if (k.lIIlIlllIIlIllI(var9)) {
                var9.useOn((Item)var16);
                return;
            }
            if (k.lIIlIlllIIlIllI(var3)) {
                var16.useOn((Item)var3);
                return;
            }
        }
    ...
    private static void i() {
        ...
        if (k.lIIlIlllIIlIIll(au.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            var21 = new WorldPoint(lIIIIIIIlllll[11], lIIIIIIIlllll[12], lIIIIIIIlllll[1]);
            var19 = TileObjects.getNearest(tileObject -> {
                int n;
                if (k.lIIlIlllIIlIIll(tileObject.getName().contains(lIIIIIIIllllI[lIIIIIIIlllll[87]]) ? 1 : 0) && k.lIIlIlllIIlllll(tileObject.getWorldLocation().distanceTo(var21), lIIIIIIIlllll[5])) {
                    n = lIIIIIIIlllll[1];
                    0;
            ...
            if (k.lIIlIlllIIllIll(var19)) {
                SquireMoonsOfPeril.g = lIIIIIIIllllI[lIIIIIIIlllll[62]];
                Movement.walkTo((WorldPoint)var21);
                0;
                return;
            }
            if (k.lIIlIlllIIlIllI(var19)) {
                SquireMoonsOfPeril.g = lIIIIIIIllllI[lIIIIIIIlllll[63]];
                var19.interact(lIIIIIIIllllI[lIIIIIIIlllll[64]]);
                return;
            }
        }
        if (k.lIIlIlllIIlIIll(ar.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            var21 = new WorldPoint(lIIIIIIIlllll[16], lIIIIIIIlllll[17], lIIIIIIIlllll[0]);
            var19 = TileObjects.getNearest(tileObject -> {
                int n;
                if (k.lIIlIlllIIlIIll(tileObject.getName().contains(lIIIIIIIllllI[lIIIIIIIlllll[86]]) ? 1 : 0) && k.lIIlIlllIIlllll(tileObject.getWorldLocation().distanceTo(var21), lIIIIIIIlllll[5])) {
                    n = lIIIIIIIlllll[1];
                    0;
                    if (2 == 0) {
                        return false;
            ...
            if (k.lIIlIlllIIlIllI(var19)) {
                ...
                var19.interact(lIIIIIIIllllI[lIIIIIIIlllll[67]]);
                return;
            }
        }
        if (k.lIIlIlllIIlIIll(as.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            var21 = new WorldPoint(lIIIIIIIlllll[21], lIIIIIIIlllll[22], lIIIIIIIlllll[0]);
            var19 = TileObjects.getNearest(tileObject -> {
                int n;
                if (k.lIIlIlllIIlIIll(tileObject.getName().contains(lIIIIIIIllllI[lIIIIIIIlllll[85]]) ? 1 : 0) && k.lIIlIlllIIlllll(tileObject.getWorldLocation().distanceTo(var21), lIIIIIIIlllll[7])) {
                    n = lIIIIIIIlllll[1];
                    0;
                    if (2 < 2) {
                        return false;
            ...
            if (k.lIIlIlllIIlIllI(var19)) {
                ...
                var19.interact(lIIIIIIIllllI[lIIIIIIIlllll[70]]);
                return;
            }
        }
                ...
                if (!k.lIIlIlllIIlIIll(Inventory.contains((String[])stringArray) ? 1 : 0) || k.lIIlIlllIlIIIlI(Inventory.getFreeSlots())) {
                    ...
                    if (k.lIIlIlllIIlllIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                        ...
                        if (k.lIIlIlllIIlllll(Players.getLocal().getWorldLocation().distanceTo(al), lIIIIIIIlllll[9])) {
                            ...
                            var21 = TileObjects.getNearest((String[])stringArray2);
                            if (k.lIIlIlllIIlIllI(var21)) {
                                var21.interact(lIIIIIIIlllll[1]);
                                return;
                            }
                        }
                    }
                    ...
                    if (k.lIIlIlllIIlIIll(Inventory.contains((int[])nArray2) ? 1 : 0)) {
                        ...
                        if (k.lIIlIlllIIlllll(Players.getLocal().getWorldLocation().distanceTo(ak), lIIIIIIIlllll[9]) && k.lIIlIlllIIlIllI(var21 = TileObjects.getNearest(tileObject -> {
                            int n;
                            ...
                            var21.interact(lIIIIIIIllllI[lIIIIIIIlllll[78]]);
                            return;
                        }
                    }
                }
            ...
            if (k.lIIlIlllIIlIIll(Inventory.isFull() ? 1 : 0)) {
                ...
                if (k.lIIlIlllIIlIIll(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    ...
                    if (k.lIIlIlllIIlllll(Players.getLocal().getWorldLocation().distanceTo(al), lIIIIIIIlllll[9])) {
                        ...
                        var21 = TileObjects.getNearest((String[])stringArray3);
                        if (k.lIIlIlllIIlIllI(var21) && k.lIIlIlllIIllIlI(am, lIIIIIIIlllll[3])) {
                            var21.interact(lIIIIIIIllllI[lIIIIIIIlllll[83]]);
                            am += lIIIIIIIlllll[1];
                            return;
                        }
                    }
        ...
        block31: {
            block34: {
                block36: {
                    ...
                    block35: {
                        block33: {
                            block32: {
                                ...
                                if (k.lIIlIlllIIlIIll(au.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    var22 = new WorldPoint(lIIIIIIIlllll[11], lIIIIIIIlllll[12], lIIIIIIIlllll[1]);
                                    var17 = TileObjects.getNearest(tileObject -> {
                                        int n;
                                        if (k.lIIlIlllIIlIIll(tileObject.getName().contains(lIIIIIIIllllI[lIIIIIIIlllll[91]]) ? 1 : 0) && k.lIIlIlllIIlllll(tileObject.getWorldLocation().distanceTo(var22), lIIIIIIIlllll[5])) {
                                            n = lIIIIIIIlllll[1];
                                            0;
                                            if (-(0x49 ^ 0x4C) >= 0) {
                                                return false;
                                    ...
                                    if (k.lIIlIlllIIllIll(var17)) {
                                        SquireMoonsOfPeril.g = lIIIIIIIllllI[lIIIIIIIlllll[13]];
                                        Movement.walkTo((WorldPoint)var22);
                                        0;
                                        return;
                                    }
                                    if (k.lIIlIlllIIlIllI(var17)) {
                                        SquireMoonsOfPeril.g = lIIIIIIIllllI[lIIIIIIIlllll[14]];
                                        var17.interact(lIIIIIIIllllI[lIIIIIIIlllll[15]]);
                                        return;
                                    }
                                }
                                if (k.lIIlIlllIIlIIll(ar.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    var22 = new WorldPoint(lIIIIIIIlllll[16], lIIIIIIIlllll[17], lIIIIIIIlllll[0]);
                                    var17 = TileObjects.getNearest(tileObject -> {
                                        int n;
                                        if (k.lIIlIlllIIlIIll(tileObject.getName().contains(lIIIIIIIllllI[lIIIIIIIlllll[90]]) ? 1 : 0) && k.lIIlIlllIIlllll(tileObject.getWorldLocation().distanceTo(var22), lIIIIIIIlllll[5])) {
                                            n = lIIIIIIIlllll[1];
                                            0;
                                            if (3 < 0) {
                                                return false;
                                    ...
                                    if (k.lIIlIlllIIlIllI(var17)) {
                                        ...
                                        var17.interact(lIIIIIIIllllI[lIIIIIIIlllll[20]]);
                                        return;
                                    }
                                }
                                if (k.lIIlIlllIIlIIll(as.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                    var22 = new WorldPoint(lIIIIIIIlllll[21], lIIIIIIIlllll[22], lIIIIIIIlllll[0]);
                                    var17 = TileObjects.getNearest(tileObject -> {
                                        int n;
                                        if (k.lIIlIlllIIlIIll(tileObject.getName().contains(lIIIIIIIllllI[lIIIIIIIlllll[89]]) ? 1 : 0) && k.lIIlIlllIIlllll(tileObject.getWorldLocation().distanceTo(var22), lIIIIIIIlllll[7])) {
                                            n = lIIIIIIIlllll[1];
                                            0;
                                            if (-3 > 0) {
                                                return false;
                                    ...
                                    if (k.lIIlIlllIIlIllI(var17)) {
                                        ...
                                        var17.interact(lIIIIIIIllllI[lIIIIIIIlllll[25]]);
                                        return;
                                    }
                                }
                            ...
                            if (k.lIIlIlllIIlllll(Players.getLocal().getWorldLocation().distanceTo(al), lIIIIIIIlllll[9])) {
                                ...
                                if (k.lIIlIlllIIlIllI(var22)) {
                                    var22.interact(lIIIIIIIlllll[3]);
                                    return;
                                }
                            }
                        }
                    ...
                    var22 = new WorldPoint(lIIIIIIIlllll[44], lIIIIIIIlllll[45], lIIIIIIIlllll[0]);
                    if (k.lIIlIlllIIllllI(Players.getLocal().getWorldLocation().distanceTo(var22), lIIIIIIIlllll[13])) {
                        am = lIIIIIIIlllll[0];
                        ao = System.currentTimeMillis() + (long)l.a(lIIIIIIIlllll[46], lIIIIIIIlllll[47]);
                    ...
                    if (k.lIIlIlllIIlllll(Players.getLocal().getWorldLocation().distanceTo(var22), lIIIIIIIlllll[13])) {
                        ...
                        var17 = TileObjects.getNearest((String[])stringArray);
                        if (k.lIIlIlllIIlIllI(var17) && k.lIIlIlllIIllIlI(am, lIIIIIIIlllll[3])) {
                            var17.interact(lIIIIIIIllllI[lIIIIIIIlllll[51]]);
                            am += lIIIIIIIlllll[1];
                            return;
                        }
                    }
