...
import a.n.q.u.l.-.e.-.e.s.a.b.r.i.s.u.t.r.c.f.I_Unknown;
import a.n.q.u.l.-.e.-.e.s.a.b.r.i.s.u.t.r.c.f.K_Unknown;
import a.n.q.u.l.-.e.-.e.s.a.b.r.i.s.u.t.r.c.f.L_Unknown;
import a.n.q.u.l.-.e.-.e.s.a.b.r.i.s.u.t.r.c.f.M_Unknown;
import a.n.q.u.l.-.e.-.e.s.a.b.r.i.s.u.t.r.c.f.N_Unknown;
import a.n.q.u.l.-.e.-.e.s.a.b.r.i.s.u.t.r.c.f.O_Unknown;
import a.n.q.u.l.-.e.-.e.s.a.b.r.i.s.u.t.r.c.f.P_Unknown;
import a.n.q.u.l.-.e.-.e.s.a.b.r.i.s.u.t.r.c.f.BankFillingCoalBagTask;
import a.n.q.u.l.-.e.-.e.s.a.b.r.i.s.u.t.r.c.f.DefaultStepTask;
import a.n.q.u.l.-.e.-.e.s.a.b.r.i.s.u.t.r.c.f.EquippingGauntletsTask;
import a.n.q.u.l.-.e.-.e.s.a.b.r.i.s.u.t.r.c.f.TurningRunOnTask;
import a.n.q.u.l.-.e.-.e.s.a.b.r.i.s.u.t.r.c.f.o_Unknown;
...
extends SquirePlugin {
    ...
    private static String llIIlllIIlIlll(String var24, String var13) {
        try {
            SecretKeySpec var27 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var13.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var4 = Cipher.getInstance("Blowfish");
            var4.init(lIIllIIlIIlI[3], var27);
    ...
    public void a(OverlayMenuClicked overlayMenuClicked) {
        ...
        if (SquireBlastFurnace.llIIlllIIlllll(var1.getOverlay(), (Object)var18.m) && SquireBlastFurnace.llIIlllIIlllIl(var1.getEntry().getOption().equals(lIIllIIlIIIl[lIIllIIlIIlI[4]]) ? 1 : 0)) {
            var18.u.T();
        }
    }
    ...
    private static String llIIlllIIlIllI(String var8, String var22) {
        try {
            SecretKeySpec var28 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var22.getBytes(StandardCharsets.UTF_8)), lIIllIIlIIlI[12]), "DES");
            Cipher var31 = Cipher.getInstance("DES");
            var31.init(lIIllIIlIIlI[3], var28);
    ...
    public void a(MenuOptionClicked menuOptionClicked) {
        SquireBlastFurnace var5;
        void var15;
        if (SquireBlastFurnace.llIIlllIIlllIl(menuOptionClicked.getMenuOption().equals(I.bA) ? 1 : 0)) {
            this.j.k().u();
        }
        if (SquireBlastFurnace.llIIlllIIlllIl(var15.getMenuOption().equals(I.bB) ? 1 : 0)) {
            var5.j.k().t();
        }
        if (SquireBlastFurnace.llIIlllIIlllIl(var15.getMenuOption().equals(I.bC) ? 1 : 0)) {
            var5.u.Z();
        }
        this.t.S();
        0;
    ...
    public void a(GameObjectSpawned gameObjectSpawned) {
        ...
        switch (gameObject.getId()) {
            case 26707: {
                void var21;
                SquireBlastFurnace var25;
                var25.k.a((GameObject)var21);
                0;
    ...
    private static String llIIlllIIlIlIl(String var19, String var20) {
        ...
        char[] var26 = var20.toCharArray();
        int var6 = lIIllIIlIIlI[0];
        char[] var7 = var19.toCharArray();
        int var14 = var7.length;
        int var12 = lIIllIIlIIlI[0];
        while (SquireBlastFurnace.llIIlllIlIIIII(var12, var14)) {
            char var2 = var7[var12];
            var30.append((char)(var2 ^ var26[var6 % var26.length]));
            0;
            ++var6;
            ++var12;
            0;
    ...
    public void a(ChatMessage chatMessage) {
        ...
        String var9 = var29.getMessage();
        if (SquireBlastFurnace.llIIlllIIlllII(var3.j.k().w(), lIIllIIlIIlI[5])) {
            n2 = lIIllIIlIIlI[3];
            0;
            if (-1 >= 3) {
                return;
        ...
        int var32 = n2;
        Matcher var17 = f.matcher(var9);
        Matcher var11 = e.matcher(var9);
        if (SquireBlastFurnace.llIIlllIIlllIl(var17.matches() ? 1 : 0)) {
            var3.j.k().t();
            0;
            if (3 < 0) {
                return;
            }
        } else if (SquireBlastFurnace.llIIlllIIlllIl(var11.matches() ? 1 : 0)) {
            var3.j.k().u();
        }
        if (SquireBlastFurnace.llIIlllIIlllIl(var9.equals(lIIllIIlIIIl[lIIllIIlIIlI[2]]) ? 1 : 0)) {
            ...
            if (SquireBlastFurnace.llIIlllIIlllIl(Inventory.contains((int[])nArray) ? 1 : 0)) {
                var3.j.k().c(new int[lIIllIIlIIlI[0]]);
                0;
                if (-1 != -1) {
                    return;
                }
        ...
        if (SquireBlastFurnace.llIIlllIIlllII(var32, var3.j.k().x())) {
            int[] nArray = new int[lIIllIIlIIlI[2]];
            nArray[SquireBlastFurnace.lIIllIIlIIlI[0]] = lIIllIIlIIlI[0];
            var3.j.k().c(nArray);
            if (SquireBlastFurnace.llIIlllIIllllI(var3.j.k().v(), lIIllIIlIIlI[2])) {
                var3.j.k().b(lIIllIIlIIlI[0]);
            }
        }
        this.t.S();
        0;
