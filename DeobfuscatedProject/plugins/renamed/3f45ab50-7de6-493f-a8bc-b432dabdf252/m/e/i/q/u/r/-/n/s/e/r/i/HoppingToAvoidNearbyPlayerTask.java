...
/* TASK: Hopping to avoid nearby player -> HoppingtoavoidnearbyplayerTask */
...
extends Task {
    ...
    public boolean b(int n2) {
        ...
        int var3 = lllllIllIIII[0];
        while (M.lIIlIIlllIIIIlI(var3, (int)var1)) {
            void var2;
            void var10 = var2[var3];
            if (M.lIIlIIlllIIIIll(var10.getName().startsWith(lllllIlIllll[lllllIllIIII[0]]) ? 1 : 0)) {
                try {
                    void var9;
                    int var7 = var10.getInt(null);
                    if (M.lIIlIIlllIIIlII(var7, (int)var9)) {
    ...
    private static String lIIlIIllIllllll(String var12, String var4) {
        try {
