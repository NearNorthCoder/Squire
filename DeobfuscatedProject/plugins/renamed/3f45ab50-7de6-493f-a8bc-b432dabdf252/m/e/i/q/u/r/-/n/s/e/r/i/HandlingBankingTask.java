...
/* TASK: Handling banking -> HandlingbankingTask */
...
extends Task {
    ...
    private static String lIIlIIlIIllIlII(String var1, String var16) {
        ...
        int var7 = lllllIIIlIll[0];
        char[] var10 = var1.toCharArray();
        int var13 = var10.length;
        int var6 = lllllIIIlIll[0];
        while (n.lIIlIIlIIllllII(var6, var13)) {
            char var4 = var10[var6];
            var12.append((char)(var4 ^ var11[var7 % var11.length]));
            0;
            ++var7;
            ++var6;
            0;
    ...
    private static String lIIlIIlIIllIlIl(String var9, String var14) {
        try {
            SecretKeySpec var8 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var14.getBytes(StandardCharsets.UTF_8)), lllllIIIlIll[12]), "DES");
            Cipher var2 = Cipher.getInstance("DES");
            var2.init(lllllIIIlIll[2], var8);
