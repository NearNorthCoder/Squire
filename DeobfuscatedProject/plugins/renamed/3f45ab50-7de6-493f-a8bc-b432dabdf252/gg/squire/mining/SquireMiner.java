...
import m.e.i.q.u.r.-.n.s.e.r.i.HoppingWorldsTask;
import m.e.i.q.u.r.-.n.s.e.r.i.MiningOreVeinTask;
import m.e.i.q.u.r.-.n.s.e.r.i.RepairingStrutsTask;
import m.e.i.q.u.r.-.n.s.e.r.i.WalkingToHopperTask;
import m.e.i.q.u.r.-.n.s.e.r.i.WalkingToVeinsTask;
import m.e.i.q.u.r.-.n.s.e.r.i.DepositingOresTask;
import m.e.i.q.u.r.-.n.s.e.r.i.WithdrawingOresTask;
import m.e.i.q.u.r.-.n.s.e.r.i.DepositingIntoGrinderTask;
import m.e.i.q.u.r.-.n.s.e.r.i.MiningSandstoneTask;
import m.e.i.q.u.r.-.n.s.e.r.i.BankingSuperheatTask;
import m.e.i.q.u.r.-.n.s.e.r.i.MiningSuperheatTask;
import m.e.i.q.u.r.-.n.s.e.r.i.HoppingToAvoidNearbyPlayerTask;
import m.e.i.q.u.r.-.n.s.e.r.i.MiningVolcanicAshTask;
import m.e.i.q.u.r.-.n.s.e.r.i.BuyingWaterskinsTask;
import m.e.i.q.u.r.-.n.s.e.r.i.GoingBackThroughPassTask;
import m.e.i.q.u.r.-.n.s.e.r.i.CastingHumidifyTask;
import m.e.i.q.u.r.-.n.s.e.r.i.MovingTowardsShantayTask;
import m.e.i.q.u.r.-.n.s.e.r.i.T_Unknown;
import m.e.i.q.u.r.-.n.s.e.r.i.U_Unknown;
import m.e.i.q.u.r.-.n.s.e.r.i.LoggingOutTask;
import m.e.i.q.u.r.-.n.s.e.r.i.UsingSpecialAttackTask;
import m.e.i.q.u.r.-.n.s.e.r.i.MiningBoneShardsTask;
import m.e.i.q.u.r.-.n.s.e.r.i.MiningDaeyaltEssenceTask;
import m.e.i.q.u.r.-.n.s.e.r.i.HandlingBankingTask;
import m.e.i.q.u.r.-.n.s.e.r.i.LeavingEssenceMineTask;
import m.e.i.q.u.r.-.n.s.e.r.i.MiningEsseneceTask;
import m.e.i.q.u.r.-.n.s.e.r.i.BankingGemRocksTask;
import m.e.i.q.u.r.-.n.s.e.r.i.DoingGemRocksTask;
import m.e.i.q.u.r.-.n.s.e.r.i.MiningTask;
import m.e.i.q.u.r.-.n.s.e.r.i.BankingAtGuildTask;
import m.e.i.q.u.r.-.n.s.e.r.i.MiningGuildIronTask;
import m.e.i.q.u.r.-.n.s.e.r.i.ChiselingAmethystTask;
import m.e.i.q.u.r.-.n.s.e.r.i.MiningAmethystTask;
import m.e.i.q.u.r.-.n.s.e.r.i.DoingArdyRocksTask;
import m.e.i.q.u.r.-.n.s.e.r.i.DepositingInHopperTask;
...
extends SquirePlugin {
    ...
    private static void lIIlIlIlIIIlIlI() {
        ...
        SquireMiner.llllllIlllll[SquireMiner.lllllllIIlII[1]] = SquireMiner."Drop";
        SquireMiner.llllllIlllll[SquireMiner.lllllllIIlII[3]] = SquireMiner."Clean";
        SquireMiner.llllllIlllll[SquireMiner.lllllllIIlII[5]] = SquireMiner."Drop";
        SquireMiner.llllllIlllll[SquireMiner.lllllllIIlII[7]] = SquireMiner."Drop";
        SquireMiner.llllllIlllll[SquireMiner.lllllllIIlII[0]] = SquireMiner."quarry some";
        SquireMiner.llllllIlllll[SquireMiner.lllllllIIlII[14]] = SquireMiner."additional ore";
        SquireMiner.llllllIlllll[SquireMiner.lllllllIIlII[15]] = SquireMiner."Sandstone";
        SquireMiner.llllllIlllll[SquireMiner.lllllllIIlII[16]] = SquireMiner."Sandstone";
        SquireMiner.llllllIlllll[SquireMiner.lllllllIIlII[17]] = SquireMiner."Granite";
        SquireMiner.llllllIlllll[SquireMiner.lllllllIIlII[18]] = SquireMiner."Granite";
        SquireMiner.llllllIlllll[SquireMiner.lllllllIIlII[19]] = SquireMiner."geode";
        SquireMiner.llllllIlllll[SquireMiner.lllllllIIlII[20]] = SquireMiner."geode";
    }
    ...
    public void a(ChatMessage chatMessage) {
        ...
        if (SquireMiner.lIIlIlIlIIIllII(var19.contains(llllllIlllll[lllllllIIlII[14]]) ? 1 : 0)) {
    ...
    private static String lIIlIlIIlllIlll(String var17, String var20) {
        try {
            SecretKeySpec var4 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var20.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var7 = Cipher.getInstance("Blowfish");
            var7.init(lllllllIIlII[5], var4);
    ...
    private static void lIIlIlIlIIIlIll() {
        ...
        SquireMiner.lllllllIIlII[3] = 1;
        SquireMiner.lllllllIIlII[4] = 170 + 64 - 210 + 227;
        SquireMiner.lllllllIIlII[5] = 2;
        SquireMiner.lllllllIIlII[6] = 231 + 149 - 324 + 197;
        SquireMiner.lllllllIIlII[7] = 3;
        ...
        SquireMiner.lllllllIIlII[31] = 3 ^ (0x29 ^ 0x3C);
    ...
    private static String lIIlIlIIllllIII(String var10, String var6) {
        try {
            SecretKeySpec var16 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var6.getBytes(StandardCharsets.UTF_8)), lllllllIIlII[17]), "DES");
            Cipher var1 = Cipher.getInstance("DES");
            var1.init(lllllllIIlII[5], var16);
    ...
    public void a() {
        ...
        if (SquireMiner.lIIlIlIlIIIllIl(Inventory.contains((int[])var15.a) ? 1 : 0) && SquireMiner.lIIlIlIlIIIllII(Inventory.contains((int[])var15.b) ? 1 : 0)) {
            Inventory.getFirst((int[])var15.b).interact(llllllIlllll[lllllllIIlII[3]]);
        }
        ...
        if (SquireMiner.lIIlIlIlIIIllIl(var15.f.deposit() ? 1 : 0) && SquireMiner.lIIlIlIlIIIllII(Inventory.contains(item -> item.getName().contains(llllllIlllll[lllllllIIlII[16]])) ? 1 : 0)) {
            Inventory.getFirst(item -> item.getName().contains(llllllIlllll[lllllllIIlII[15]])).interact(llllllIlllll[lllllllIIlII[7]]);
        }
        if (SquireMiner.lIIlIlIlIIIllII(Inventory.contains((int[])var15.a) ? 1 : 0)) {
            int[] nArray = new int[lllllllIIlII[3]];
            nArray[SquireMiner.lllllllIIlII[1]] = lllllllIIlII[42];
            Inventory.getFirst((int[])var15.a).useOn(Inventory.getFirst((int[])nArray));
        }
        int[] nArray = new int[lllllllIIlII[3]];
    ...
    private static String lIIlIlIIlllIllI(String var21, String var2) {
        ...
        int var18 = lllllllIIlII[1];
        char[] var13 = var21.toCharArray();
        int var3 = var13.length;
        int var9 = lllllllIIlII[1];
        while (SquireMiner.lIIlIlIlIIIlllI(var9, var3)) {
            char var12 = var13[var9];
            var11.append((char)(var12 ^ var8[var18 % var8.length]));
            0;
            ++var18;
            ++var9;
            0;
