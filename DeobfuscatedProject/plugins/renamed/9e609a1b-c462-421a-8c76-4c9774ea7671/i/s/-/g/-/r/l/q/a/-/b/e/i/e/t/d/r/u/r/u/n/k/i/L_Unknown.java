...
implements M {
    ...
    private static String lIlIlIIIIIlIlIl(String var20, String var16) {
        try {
            SecretKeySpec var15 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var16.getBytes(StandardCharsets.UTF_8)), lIIlIIIIllIlI[18]), "DES");
            Cipher var18 = Cipher.getInstance("DES");
            var18.init(lIIlIIIIllIlI[3], var15);
    ...
    private static String lIlIlIIIIIlIlII(String var6, String var3) {
        try {
            ...
            var19.init(lIIlIIIIllIlI[3], var12);
            return new String(var19.doFinal(Base64.getDecoder().decode(var6.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void W() {
        ...
        if (L.lIlIlIIIIIlllIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var23 = new d(lIIlIIIIllIlI[14], lIIlIIIIllIlI[1], lIIlIIIIllIlI[47]);
            bA.add((d)var23);
            0;
        }
        ...
        if (L.lIlIlIIIIIlllIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var23 = new d(lIIlIIIIllIlI[4], lIIlIIIIllIlI[48], lIIlIIIIllIlI[49]);
            bA.add((d)var23);
            0;
        }
        if (L.lIlIlIIIIIlllIl(Bank.contains((Predicate)(var23 = item -> item.getName().toLowerCase().contains(lIIlIIIIllIIl[lIIlIIIIllIlI[56]]))) ? 1 : 0)) {
            var4 = new d(lIIlIIIIllIlI[50], lIIlIIIIllIlI[7], lIIlIIIIllIlI[51]);
            bA.add(var4);
            0;
        }
        ...
        if (L.lIlIlIIIIIlllIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var4 = new d(lIIlIIIIllIlI[11], lIIlIIIIllIlI[15], lIIlIIIIllIlI[52]);
            bA.add(var4);
            0;
        }
        ...
        if (L.lIlIlIIIIIlllIl(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var4 = new d(lIIlIIIIllIlI[16], lIIlIIIIllIlI[15], lIIlIIIIllIlI[52]);
            bA.add(var4);
            0;
        }
        ...
        if (L.lIlIlIIIIIlllIl(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var4 = new d(lIIlIIIIllIlI[13], lIIlIIIIllIlI[53], lIIlIIIIllIlI[52]);
            bA.add(var4);
            0;
        }
        ...
        if (L.lIlIlIIIIIlllIl(Bank.contains((int[])nArray7) ? 1 : 0)) {
            var4 = new d(lIIlIIIIllIlI[12], lIIlIIIIllIlI[7], h.bv);
            bA.add(var4);
            0;
        }
    }
    ...
    private static String lIlIlIIIIIlIllI(String var1, String var5) {
        ...
        int var13 = lIIlIIIIllIlI[0];
        char[] var7 = var1.toCharArray();
        int var17 = var7.length;
        int var10 = lIIlIIIIllIlI[0];
        while (L.lIlIlIIIIIlllII(var10, var17)) {
            char var21 = var7[var10];
            var22.append((char)(var21 ^ var8[var13 % var8.length]));
            0;
            ++var13;
            ++var10;
            0;
        ...
        if (L.lIlIlIIIIIlllIl(by ? 1 : 0)) {
            block49: {
                ...
                if (L.lIlIlIIIIIlllIl(L.S() ? 1 : 0) && L.lIlIlIIIIIlllIl(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()))) {
                    ...
                    if (L.lIlIlIIIIlIIIII(var14) && L.lIlIlIIIIIlllIl(var14.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderRat.c = lIIlIIIIllIIl[lIIlIIIIllIlI[6]];
                        a.a(var14);
                        Time.sleepTicks((int)lIIlIIIIllIlI[3]);
                        0;
                    }
                    if (L.lIlIlIIIIlIIIII(var14) && L.lIlIlIIIIIllIll(var14.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (L.lIlIlIIIIIlllIl(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId())) && L.lIlIlIIIIIllIll(L.S() ? 1 : 0)) {
                    ...
                    if (L.lIlIlIIIIlIIIlI(Players.getLocal().getWorldLocation().distanceTo(hY), lIIlIIIIllIlI[3])) {
                        ...
                        i.s.-.g.-.r.l.q.a.-.b.e.i.e.t.d.r.u.r.u.n.k.i.g_Unknown.a(lIIlIIIIllIIl[lIIlIIIIllIlI[15]], hX, lIIlIIIIllIlI[1]);
                    }
                }
                if (L.lIlIlIIIIlIIIll(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()), lIIlIIIIllIlI[1])) {
                    ...
                    if (L.lIlIlIIIIIlllIl(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                        i.s.-.g.-.r.l.q.a.-.b.e.i.e.t.d.r.u.r.u.n.k.i.g_Unknown.a(hX);
                    }
                }
                ...
                if (L.lIlIlIIIIlIIIll(Vars.getBit((int)QuestVarbits.QUEST_X_MARKS_THE_SPOT.getId()), lIIlIIIIllIlI[9])) {
                    ...
                    if (L.lIlIlIIIIlIIIlI(Players.getLocal().getWorldLocation().distanceTo(id), lIIlIIIIllIlI[5])) {
                        ...
                        i.s.-.g.-.r.l.q.a.-.b.e.i.e.t.d.r.u.r.u.n.k.i.g_Unknown.a(lIIlIIIIllIIl[lIIlIIIIllIlI[37]], hX);
                    }
                }
                ...
                do {
                    ...
                    if (L.lIlIlIIIIlIIIII(Widgets.get((int)lIIlIIIIllIlI[39]))) {
                        ...
                        var14 = Widgets.get((int)lIIlIIIIllIlI[39], (int)lIIlIIIIllIlI[23]);
                        if (L.lIlIlIIIIlIIIII(var14)) {
                            var14.interact(lIIlIIIIllIIl[lIIlIIIIllIlI[43]]);
                            Time.sleepTicks((int)lIIlIIIIllIlI[1]);
                            0;
                        }
                        if (L.lIlIlIIIIlIIIII(var9 = Widgets.get((int)lIIlIIIIllIlI[39], (int)lIIlIIIIllIlI[35]))) {
                            var9.interact(lIIlIIIIllIIl[lIIlIIIIllIlI[44]]);
                            Time.sleepTicks((int)lIIlIIIIllIlI[3]);
                            0;
                        }
                    }
            ...
            i.s.-.g.-.r.l.q.a.-.b.e.i.e.t.d.r.u.r.u.n.k.i.g_Unknown.a(new String[lIIlIIIIllIlI[0]]);
        }
    }
