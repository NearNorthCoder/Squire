...
implements M {
        ...
        block48: {
                ...
                block52: {
                    block50: {
                        ...
                        if (K.lIlIIlIlllllIIl(e.j(lIIIllllIllIl[7]), lIIIllllIllIl[1])) {
                            ...
                            if (K.lIlIIlIllllllIl(var7) && K.lIlIIlIlllllIlI(var7.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            if (K.lIlIIlIllllllIl(var7) && K.lIlIIlIlllllIII(var7.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (K.lIlIIlIlllllIIl(e.j(lIIIllllIllIl[7]), lIIIllllIllIl[1]) && K.lIlIIlIlllllIII(K.S() ? 1 : 0)) {
                        ...
                        if (K.lIlIIlIllllllll(Players.getLocal().getWorldLocation().distanceTo(hT), lIIIllllIllIl[9])) {
                            ...
                            if (K.lIlIIlIllllllIl(var7)) {
                                String[] stringArray2 = new String[lIIIllllIllIl[1]];
                                stringArray2[K.lIIIllllIllIl[0]] = lIIIllllIlIlI[lIIIllllIllIl[18]];
                                if (K.lIlIIlIlllllIII(var7.hasAction(stringArray2) ? 1 : 0) && K.lIlIIlIllllllll(var7.getWorldLocation().distanceTo(hT), lIIIllllIllIl[16])) {
                                    var7.interact(lIIIllllIlIlI[lIIIllllIllIl[22]]);
                ...
                if (K.lIlIIlIllllllII(Inventory.getCount((String[])stringArray))) {
                    ...
                    if (K.lIlIIlIlllllIIl(Inventory.getCount((String[])stringArray8), lIIIllllIllIl[1])) {
                        ...
                        if (K.lIlIIlIllllllll(Players.getLocal().getWorldLocation().distanceTo(hV), lIIIllllIllIl[3])) {
                            ...
                            var7 = TileItems.getNearest((String[])stringArray9);
                            if (K.lIlIIllIIIIIIlI(var7)) {
                            ...
                            if (K.lIlIIlIllllllIl(var7)) {
                                var7.interact(lIIIllllIlIlI[lIIIllllIllIl[39]]);
                                Time.sleepTicks((int)lIIIllllIllIl[3]);
                                0;
                            }
                        }
            ...
            if (K.lIlIIllIIIIIIII(e.j(lIIIllllIllIl[7]), lIIIllllIllIl[3])) {
                ...
                if (K.lIlIIlIllllllIl(var7)) {
                    ...
                    if (K.lIlIIlIlllllIII(var7.hasAction(stringArray12) ? 1 : 0)) {
                        ...
                        var7.interact(lIIIllllIlIlI[lIIIllllIllIl[47]]);
                        Time.sleepTicks((int)lIIIllllIllIl[5]);
                        0;
                    }
                }
    ...
    private static String lIlIIlIlllIIlIl(String var10, String var18) {
        try {
            SecretKeySpec var21 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var18.getBytes(StandardCharsets.UTF_8)), lIIIllllIllIl[20]), "DES");
            Cipher var2 = Cipher.getInstance("DES");
            var2.init(lIIIllllIllIl[3], var21);
    ...
    private static String lIlIIlIlllIIlII(String var15, String var11) {
        ...
        int var12 = lIIIllllIllIl[0];
        char[] var3 = var15.toCharArray();
        int var4 = var3.length;
        int var9 = lIIIllllIllIl[0];
        while (K.lIlIIlIlllllIIl(var9, var4)) {
            char var14 = var3[var9];
            var1.append((char)(var14 ^ var17[var12 % var17.length]));
            0;
            ++var12;
            ++var9;
            0;
    ...
    private static void W() {
        ...
        if (K.lIlIIlIlllllIlI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var22 = new d(lIIIllllIllIl[11], lIIIllllIllIl[1], lIIIllllIllIl[49]);
            bA.add((d)var22);
            0;
        }
        int[] nArray3 = new int[lIIIllllIllIl[1]];
        ...
        if (K.lIlIIlIlllllIlI(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var22 = new d(lIIIllllIllIl[14], lIIIllllIllIl[1], lIIIllllIllIl[49]);
            bA.add((d)var22);
            0;
        }
        if (K.lIlIIlIlllllIlI(Bank.contains((Predicate)(var22 = item -> item.getName().toLowerCase().contains(lIIIllllIlIlI[lIIIllllIllIl[56]]))) ? 1 : 0)) {
            var23 = new d(lIIIllllIllIl[50], lIIIllllIllIl[9], lIIIllllIllIl[51]);
            bA.add(var23);
            0;
        }
        ...
        if (K.lIlIIlIlllllIlI(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var23 = new d(lIIIllllIllIl[17], lIIIllllIllIl[18], lIIIllllIllIl[52]);
            bA.add(var23);
            0;
        }
        ...
        if (K.lIlIIlIlllllIlI(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var23 = new d(lIIIllllIllIl[13], lIIIllllIllIl[53], lIIIllllIllIl[52]);
            bA.add(var23);
            0;
        }
        ...
        if (K.lIlIIlIlllllIlI(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var23 = new d(lIIIllllIllIl[12], lIIIllllIllIl[9], h.bv);
            bA.add(var23);
            0;
        }
    }

    private static String lIlIIlIlllIIIll(String var5, String var19) {
        try {
            ...
            var8.init(lIIIllllIllIl[3], var20);
