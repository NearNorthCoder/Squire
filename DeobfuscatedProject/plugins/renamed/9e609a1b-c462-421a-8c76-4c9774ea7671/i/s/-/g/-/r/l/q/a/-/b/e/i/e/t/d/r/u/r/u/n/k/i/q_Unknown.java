...
implements M {
    ...
    private static boolean S() {
        ...
        int[] nArray2 = nArray;
        int var9 = lIIIlllIlIIII[4];
        while (q.lIlIIlIIIIllIll(var9, ((void)var5).length)) {
            int[] nArray3 = new int[lIIIlllIlIIII[5]];
            nArray3[q.lIIIlllIlIIII[4]] = var5[var9];
    ...
    private static String lIlIIlIIIIlIllI(String var8, String var11) {
        var8 = new String(Base64.getDecoder().decode(var8.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var14 = new StringBuilder();
        char[] var19 = var11.toCharArray();
        int var4 = lIIIlllIlIIII[4];
        char[] var7 = var8.toCharArray();
        int var21 = var7.length;
        int var20 = lIIIlllIlIIII[4];
        while (q.lIlIIlIIIIllIll(var20, var21)) {
            char var3 = var7[var20];
            var14.append((char)(var3 ^ var19[var4 % var19.length]));
            0;
            ++var4;
            ++var20;
            0;
    ...
    private static String lIlIIlIIIIlIlII(String var2, String var22) {
        try {
            SecretKeySpec var15 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var22.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var24 = Cipher.getInstance("Blowfish");
            var24.init(lIIIlllIlIIII[6], var15);
        ...
        block12: {
            ...
            block11: {
                ...
                if (q.lIlIIlIIIIlllII(Bank.contains((int[])nArray2) ? 1 : 0)) {
                    var18 = new d(lIIIlllIlIIII[24], lIIIlllIlIIII[5], lIIIlllIlIIII[88]);
                    bA.add((d)var18);
                    0;
                }
                int[] nArray3 = new int[lIIIlllIlIIII[5]];
                ...
                if (q.lIlIIlIIIIlllII(Bank.contains((int[])nArray3) ? 1 : 0)) {
                    var18 = new d(lIIIlllIlIIII[16], lIIIlllIlIIII[5], lIIIlllIlIIII[88]);
                    bA.add((d)var18);
                    0;
                }
                ...
                if (q.lIlIIlIIIIlllII(Bank.contains((int[])nArray4) ? 1 : 0)) {
                    var18 = new d(lIIIlllIlIIII[20], lIIIlllIlIIII[5], lIIIlllIlIIII[89]);
                    bA.add((d)var18);
                    0;
                }
                ...
                if (q.lIlIIlIIIIlllII(Bank.contains((int[])nArray5) ? 1 : 0)) {
                    var18 = new d(lIIIlllIlIIII[17], lIIIlllIlIIII[5], lIIIlllIlIIII[89]);
                    bA.add((d)var18);
                    0;
                }
                ...
                if (q.lIlIIlIIIIlllII(Bank.contains((int[])nArray6) ? 1 : 0)) {
                    var18 = new d(lIIIlllIlIIII[22], lIIIlllIlIIII[25], lIIIlllIlIIII[90]);
                    bA.add((d)var18);
                    0;
                }
                if (q.lIlIIlIIIIlllII(Bank.contains((Predicate)(var18 = item -> item.getName().toLowerCase().contains(lIIIlllIIllll[lIIIlllIlIIII[95]]))) ? 1 : 0)) {
                    var10 = new d(lIIIlllIlIIII[91], lIIIlllIlIIII[19], lIIIlllIlIIII[92]);
                    bA.add(var10);
                    0;
                }
                ...
                if (q.lIlIIlIIIIlllII(Bank.contains((int[])nArray7) ? 1 : 0)) {
                    var10 = new d(lIIIlllIlIIII[15], lIIIlllIlIIII[12], h.bv);
                    bA.add(var10);
                    0;
                }
            ...
            var10 = new d(lIIIlllIlIIII[14], lIIIlllIlIIII[50], lIIIlllIlIIII[93]);
            bA.add(var10);
            0;
        }
    }

    private static String lIlIIlIIIIlIlIl(String var17, String var23) {
        try {
            SecretKeySpec var13 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var23.getBytes(StandardCharsets.UTF_8)), lIIIlllIlIIII[13]), "DES");
            Cipher var6 = Cipher.getInstance("DES");
            var6.init(lIIIlllIlIIII[6], var13);
    ...
    public static void ba() {
        ...
        if (q.lIlIIlIIIIlllII(by ? 1 : 0)) {
            ...
            if (q.lIlIIlIIIIlllII(q.S() ? 1 : 0) && q.lIlIIlIIIIlllII(Vars.getBit((int)QuestVarbits.QUEST_BELOW_ICE_MOUNTAIN.getId())) && q.lIlIIlIIIIlllIl(e.j(lIIIlllIlIIII[7]), lIIIlllIlIIII[8]) && q.lIlIIlIIIIllllI(e.I(), lIIIlllIlIIII[9])) {
                ...
                if (q.lIlIIlIIIIlllll(var1) && q.lIlIIlIIIIlllII(var1.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderRat.c = lIIIlllIIllll[lIIIlllIlIIII[6]];
                    a.a((BankLocation)var1);
                }
                if (q.lIlIIlIIIIlllll(var1) && q.lIlIIlIIIIllIlI(var1.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (q.lIlIIlIIIIlllIl(Vars.getBit((int)QuestVarbits.QUEST_BELOW_ICE_MOUNTAIN.getId()), lIIIlllIlIIII[25])) {
                ...
                if (q.lIlIIlIIIIlllIl(Vars.getBit((int)lIIIlllIlIIII[33]), lIIIlllIlIIII[19])) {
                    var1 = new WorldArea(lIIIlllIlIIII[54], lIIIlllIlIIII[40], lIIIlllIlIIII[32], lIIIlllIlIIII[25], lIIIlllIlIIII[4]);
                    if (q.lIlIIlIIIIlllII(var1.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (q.lIlIIlIIIIllIlI(var1.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (q.lIlIIlIIIIlllIl(Vars.getBit((int)QuestVarbits.QUEST_BELOW_ICE_MOUNTAIN.getId()), lIIIlllIlIIII[70])) {
                ...
                if (q.lIlIIlIIIIlllll(var1 = TileObjects.getNearest(tileObject -> {
                    int n2;
                    ...
                    var1.interact(lIIIlllIIllll[lIIIlllIlIIII[30]]);
                    Time.sleepTicks((int)lIIIlllIlIIII[12]);
                    0;
                }
