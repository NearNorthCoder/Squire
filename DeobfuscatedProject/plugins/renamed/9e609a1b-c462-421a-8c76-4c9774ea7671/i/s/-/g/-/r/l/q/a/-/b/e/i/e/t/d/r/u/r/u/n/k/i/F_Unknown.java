...
implements M {
        ...
        block52: {
            ...
            block54: {
                ...
                if (F.lIlIIlIIlIIllII(e.j(lIIIlllIlIllI[5]), lIIIlllIlIllI[1])) {
                    ...
                    if (F.lIlIIlIIlIIllll(var8) && F.lIlIIlIIlIIllIl(var8.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderRat.c = lIIIlllIlIlII[lIIIlllIlIllI[6]];
                        a.a(var8);
                        Time.sleepTicks((int)lIIIlllIlIllI[3]);
                        0;
                    }
                    if (F.lIlIIlIIlIIllll(var8) && F.lIlIIlIIlIIlIll(var8.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (F.lIlIIlIIlIlIIlI(e.j(lIIIlllIlIllI[5]), lIIIlllIlIllI[12])) {
                ...
                if (F.lIlIIlIIlIlIIIl(Players.getLocal().getWorldLocation().distanceTo(hl), lIIIlllIlIllI[3])) {
                    ...
                    if (F.lIlIIlIIlIIllll(var8)) {
                        var8.interact(lIIIlllIlIlII[lIIIlllIlIllI[18]]);
            ...
            if (F.lIlIIlIIlIlIIlI(e.j(lIIIlllIlIllI[5]), lIIIlllIlIllI[2])) {
                ...
                if (F.lIlIIlIIlIIlIll(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    ...
                    if (F.lIlIIlIIlIlIIIl(Players.getLocal().getWorldLocation().distanceTo(hl), lIIIlllIlIllI[3])) {
                        ...
                        if (F.lIlIIlIIlIIllll(var8)) {
                            var8.interact(lIIIlllIlIlII[lIIIlllIlIllI[39]]);
                            Time.sleepTicks((int)lIIIlllIlIllI[6]);
                            0;
                        }
    ...
    private static String lIlIIlIIlIIIlII(String var22, String var13) {
        try {
            SecretKeySpec var9 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var13.getBytes(StandardCharsets.UTF_8)), lIIIlllIlIllI[13]), "DES");
            Cipher var4 = Cipher.getInstance("DES");
            var4.init(lIIIlllIlIllI[3], var9);
    ...
    private static String lIlIIlIIlIIIlIl(String var14, String var2) {
        try {
            ...
            var23.init(lIIIlllIlIllI[3], var12);
    ...
    private static String lIlIIlIIlIIIIll(String var5, String var19) {
        var5 = new String(Base64.getDecoder().decode(var5.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var7 = new StringBuilder();
        char[] var18 = var19.toCharArray();
        int var15 = lIIIlllIlIllI[0];
        char[] var10 = var5.toCharArray();
        int var3 = var10.length;
        int var6 = lIIIlllIlIllI[0];
        while (F.lIlIIlIIlIIllII(var6, var3)) {
            char var20 = var10[var6];
            var7.append((char)(var20 ^ var18[var15 % var18.length]));
            0;
            ++var15;
            ++var6;
            0;
    ...
    private static void bm() {
        ...
        if (F.lIlIIlIIlIIllll(var11) && F.lIlIIlIIlIIlIll(var11.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
    ...
    private static void W() {
        ...
        if (F.lIlIIlIIlIIllIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var17 = new d(lIIIlllIlIllI[9], lIIIlllIlIllI[1], lIIIlllIlIllI[49]);
            bA.add((d)var17);
            0;
        }
        if (F.lIlIIlIIlIIllIl(Bank.contains(var17 = item -> item.getName().toLowerCase().contains(lIIIlllIlIlII[lIIIlllIlIllI[54]])) ? 1 : 0)) {
            var16 = new d(lIIIlllIlIllI[50], lIIIlllIlIllI[10], lIIIlllIlIllI[51]);
            bA.add(var16);
            0;
        }
        ...
        if (F.lIlIIlIIlIIllIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var16 = new d(lIIIlllIlIllI[11], lIIIlllIlIllI[20], lIIIlllIlIllI[52]);
            bA.add(var16);
            0;
        }
    }
