...
implements M {
    ...
    public static void cg() {
        ...
        if (C.lIlIIllIIIIllII(by ? 1 : 0)) {
            ...
            if (C.lIlIIllIIIIllII(C.S() ? 1 : 0) && C.lIlIIllIIIIllII(Vars.getVarp((int)QuestVarPlayer.QUEST_PIRATES_TREASURE.getId()))) {
                ...
                if (C.lIlIIllIIIIllll(var20) && C.lIlIIllIIIIllII(var20.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderRat.c = lIIIllllIlllI[lIIIllllIllll[6]];
                    a.a((BankLocation)var20);
                    Time.sleepTicks((int)lIIIllllIllll[3]);
                    0;
                }
                if (C.lIlIIllIIIIllll(var20) && C.lIlIIllIIIIlIlI(var20.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (C.lIlIIllIIIlIIlI(Vars.getVarp((int)QuestVarPlayer.QUEST_PIRATES_TREASURE.getId()), lIIIllllIllll[1])) {
                ...
                if (C.lIlIIllIIIIllII(gT ? 1 : 0)) {
                    ...
                    if (C.lIlIIllIIIlIIIl(Players.getLocal().getWorldLocation().distanceTo(gN), lIIIllllIllll[5])) {
                        ...
                        if (C.lIlIIllIIIIllII(var20.isEmpty() ? 1 : 0)) {
                            var6 = lIIIllllIllll[0];
                            while (C.lIlIIllIIIIlIll(var6, var20.size())) {
                                if (C.lIlIIllIIIIlIlI(((Widget)var20.get(var6)).getText().contains(lIIIllllIlllI[lIIIllllIllll[25]]) ? 1 : 0)) {
                                    gT = lIIIllllIllll[1];
                                }
                                ++var6;
                                0;
                ...
                if (C.lIlIIllIIIIlIlI(gT ? 1 : 0) && C.lIlIIllIIIIllII(gV ? 1 : 0)) {
                    ...
                    if (C.lIlIIllIIIlIIIl(Players.getLocal().getWorldLocation().distanceTo(gO), lIIIllllIllll[20])) {
                        ...
                        var20 = Widgets.get((int)lIIIllllIllll[28], (int)lIIIllllIllll[29], (int)lIIIllllIllll[3]);
                        if (C.lIlIIllIIIlIIll(var20)) {
                            String[] stringArray = new String[lIIIllllIllll[1]];
                        ...
                        if (C.lIlIIllIIIIllll(var20)) {
                            var20.interact(lIIIllllIlllI[lIIIllllIllll[31]]);
                            Time.sleepTicks((int)lIIIllllIllll[1]);
                            0;
                        }
                    }
                ...
                if (C.lIlIIllIIIIlIlI(gU ? 1 : 0) && C.lIlIIllIIIIlIlI(gT ? 1 : 0) && C.lIlIIllIIIIlIlI(gV ? 1 : 0) && C.lIlIIllIIIIllII(gW ? 1 : 0)) {
                    ...
                    if (C.lIlIIllIIIIllll(var20) && C.lIlIIllIIIIlIlI(((String)var20).contains(lIIIllllIlllI[lIIIllllIllll[39]]) ? 1 : 0)) {
                        gW = lIIIllllIllll[1];
                    }
                }
                if (C.lIlIIllIIIIlIlI(gU ? 1 : 0) && C.lIlIIllIIIIlIlI(gT ? 1 : 0) && C.lIlIIllIIIIlIlI(gV ? 1 : 0) && C.lIlIIllIIIIlIlI(gW ? 1 : 0) && C.lIlIIllIIIIllII(gX ? 1 : 0)) {
                    ...
                    if (C.lIlIIllIIIIllII((var20 = Dialog.getOptions()).isEmpty() ? 1 : 0)) {
                        var6 = lIIIllllIllll[0];
                        while (C.lIlIIllIIIIlIll(var6, var20.size())) {
                            if (C.lIlIIllIIIIlIlI(((Widget)var20.get(var6)).getText().contains(lIIIllllIlllI[lIIIllllIllll[43]]) ? 1 : 0)) {
                                gX = lIIIllllIllll[1];
                            }
                            ++var6;
                            0;
        ...
        block12: {
            ...
            block11: {
                ...
                if (C.lIlIIllIIIIllII(Bank.contains((int[])nArray2) ? 1 : 0)) {
                    var21 = new d(lIIIllllIllll[14], lIIIllllIllll[1], lIIIllllIllll[64]);
                    bA.add((d)var21);
                    0;
                }
                int[] nArray3 = new int[lIIIllllIllll[1]];
                ...
                if (C.lIlIIllIIIIllII(Bank.contains((int[])nArray3) ? 1 : 0)) {
                    var21 = new d(lIIIllllIllll[11], lIIIllllIllll[16], lIIIllllIllll[65]);
                    bA.add((d)var21);
                    0;
                }
                int[] nArray4 = new int[lIIIllllIllll[1]];
                ...
                if (C.lIlIIllIIIIllII(Bank.contains((int[])nArray4) ? 1 : 0)) {
                    var21 = new d(lIIIllllIllll[10], lIIIllllIllll[1], lIIIllllIllll[66]);
                    bA.add((d)var21);
                    0;
                }
                if (C.lIlIIllIIIIllII(Bank.contains((Predicate)(var21 = item -> item.getName().toLowerCase().contains(lIIIllllIlllI[lIIIllllIllll[73]]))) ? 1 : 0)) {
                    var15 = new d(lIIIllllIllll[67], lIIIllllIllll[7], lIIIllllIllll[68]);
                    bA.add(var15);
                    0;
                }
                int[] nArray5 = new int[lIIIllllIllll[1]];
                ...
                if (C.lIlIIllIIIIllII(Bank.contains((int[])nArray5) ? 1 : 0)) {
                    var15 = new d(lIIIllllIllll[69], lIIIllllIllll[16], lIIIllllIllll[70]);
                    bA.add(var15);
                    0;
                }
                int[] nArray6 = new int[lIIIllllIllll[1]];
                ...
                if (C.lIlIIllIIIIllII(Bank.contains((int[])nArray6) ? 1 : 0)) {
                    var15 = new d(lIIIllllIllll[17], lIIIllllIllll[16], lIIIllllIllll[70]);
                    bA.add(var15);
                    0;
                }
                int[] nArray7 = new int[lIIIllllIllll[1]];
                ...
                if (C.lIlIIllIIIIllII(Bank.contains((int[])nArray7) ? 1 : 0)) {
                    var15 = new d(lIIIllllIllll[13], lIIIllllIllll[59], lIIIllllIllll[70]);
                    bA.add(var15);
                    0;
                }
                int[] nArray8 = new int[lIIIllllIllll[1]];
            ...
            var15 = new d(lIIIllllIllll[12], lIIIllllIllll[6], h.bv);
            bA.add(var15);
            0;
        }
    }
    ...
    private static String lIlIIllIIIIIllI(String var5, String var16) {
        try {
            SecretKeySpec var9 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var16.getBytes(StandardCharsets.UTF_8)), lIIIllllIllll[20]), "DES");
            Cipher var11 = Cipher.getInstance("DES");
            var11.init(lIIIllllIllll[3], var9);
    ...
    private static String lIlIIllIIIIIlII(String var13, String var2) {
        var13 = new String(Base64.getDecoder().decode(var13.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var18 = new StringBuilder();
        char[] var22 = var2.toCharArray();
        int var3 = lIIIllllIllll[0];
        char[] var14 = var13.toCharArray();
        int var7 = var14.length;
        int var19 = lIIIllllIllll[0];
        while (C.lIlIIllIIIIlIll(var19, var7)) {
            char var17 = var14[var19];
            var18.append((char)(var17 ^ var22[var3 % var22.length]));
            0;
            ++var3;
            ++var19;
            0;
    ...
    private static String lIlIIllIIIIIlIl(String var4, String var1) {
        try {
            ...
            var10.init(lIIIllllIllll[3], var23);
