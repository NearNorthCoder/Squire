...
extends Task {
    ...
    private static String lIIIlIlIIIIIIII(String var18, String var15) {
        var18 = new String(Base64.getDecoder().decode(var18.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var13 = new StringBuilder();
        char[] var4 = var15.toCharArray();
        int var17 = lllIIlIIllll[0];
        char[] var16 = var18.toCharArray();
        int var8 = var16.length;
        int var20 = lllIIlIIllll[0];
        while (O.lIIIlIlIIIIlIII(var20, var8)) {
            char var21 = var16[var20];
            var13.append((char)(var21 ^ var4[var17 % var4.length]));
            0;
            ++var17;
            ++var20;
            0;
    ...
    private static String lIIIlIlIIIIIIlI(String var10, String var6) {
        try {
            SecretKeySpec var12 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var6.getBytes(StandardCharsets.UTF_8)), lllIIlIIllll[7]), "DES");
            Cipher var5 = Cipher.getInstance("DES");
            var5.init(lllIIlIIllll[3], var12);
    ...
    public boolean run() {
        ...
        if (O.lIIIlIlIIIIIllI(Inventory.contains((String[])stringArray) ? 1 : 0)) {
            ...
            var7.sleep(lllIIlIIllll[2]);
            return lllIIlIIllll[1];
        }
        if (O.lIIIlIlIIIIIlll(Combat.getCurrentHealth(), var7.al.hpToEatAt())) {
            return lllIIlIIllll[0];
        }
    ...
    private static String lIIIlIlIIIIIIIl(String var9, String var2) {
        try {
            ...
            var11.init(lllIIlIIllll[3], var1);
