...
import e.q.u.d.w.s.p.e.e.c.s.h.i.-.l.r.-.r.l.a.o.h.u.l.e.CEnum;
...
extends Enum<A> {
    ...
    public boolean a(d d2, SquireSepulchre squireSepulchre) {
        ...
        if (A.lIIIlIIIIlIllll(var25.a((Locatable)var15) ? 1 : 0)) {
            return lllIIIIIIllI[0];
        }
        var25.a((SquireSepulchre)var27);
        if (A.lIIIlIIIIllIlIl(var25.a((d)var20) ? 1 : 0)) {
            System.out.println(lllIIIIIIlIl[lllIIIIIIllI[2]]);
            Movement.setDestination((WorldPoint)var25.destination.get());
    ...
    public boolean a(d d2) {
        ...
        System.out.println("ID: " + var21.aG() + " | ticks:" + var21.aF());
        Player var8 = Players.getLocal();
        if (A.lIIIlIIIIlIlllI(var8)) {
            return lllIIIIIIllI[0];
        }
        if (A.lIIIlIIIIlIllll(var8.getWorldLocation().equals((Object)var14.startPoint.get()) ? 1 : 0)) {
            return lllIIIIIIllI[0];
        }
        switch (B.U[var14.type.ordinal()]) {
            case 1: {
                if (A.lIIIlIIIIllIIII(var21.aG(), b.o) && A.lIIIlIIIIllIIII(var21.aF(), lllIIIIIIllI[1])) {
                    return lllIIIIIIllI[2];
                }
                if (A.lIIIlIIIIllIIII(var21.aG(), b.o) && A.lIIIlIIIIllIIII(var21.aF(), lllIIIIIIllI[3])) {
                    return lllIIIIIIllI[2];
                }
                return lllIIIIIIllI[0];
            }
            case 2: {
                if (A.lIIIlIIIIllIIII(var21.aG(), b.o) && A.lIIIlIIIIllIIIl(var21.aF(), lllIIIIIIllI[1])) {
                    return lllIIIIIIllI[2];
                }
                if (A.lIIIlIIIIllIIII(var21.aG(), b.n)) {
                    return lllIIIIIIllI[2];
                }
                return lllIIIIIIllI[0];
            }
            ...
            case 4: {
                ...
                if (!A.lIIIlIIIIllIIlI(var21.aG(), b.p) || A.lIIIlIIIIllIIII(var21.aG(), b.n)) {
                    return lllIIIIIIllI[2];
                }
                return lllIIIIIIllI[0];
            }
            ...
            case 7: {
                ...
                if (A.lIIIlIIIIllIIII(var21.aG(), b.p) && A.lIIIlIIIIllIIll(var21.aF(), lllIIIIIIllI[4])) {
                    return lllIIIIIIllI[2];
                }
                if (A.lIIIlIIIIllIIII(var21.aG(), b.n)) {
                    return lllIIIIIIllI[2];
            ...
            case 9: {
                if (A.lIIIlIIIIllIIII(var21.aG(), b.o) && A.lIIIlIIIIllIlII(var21.aF(), lllIIIIIIllI[2])) {
                    return lllIIIIIIllI[2];
                }
                return lllIIIIIIllI[0];
            }
            case 10: {
                if (A.lIIIlIIIIllIIII(var21.aG(), b.o) && A.lIIIlIIIIllIIII(var21.aF(), lllIIIIIIllI[2])) {
                    return lllIIIIIIllI[2];
                }
                return lllIIIIIIllI[0];
            }
            case 11: {
                if (A.lIIIlIIIIllIIII(var21.aG(), b.o) && (!A.lIIIlIIIIllIIlI(var21.aF(), lllIIIIIIllI[2]) || !A.lIIIlIIIIllIIlI(var21.aF(), lllIIIIIIllI[1])) || A.lIIIlIIIIllIIII(var21.aG(), b.n)) {
                    return lllIIIIIIllI[2];
                }
                if (A.lIIIlIIIIllIIII(var21.aG(), b.p) && A.lIIIlIIIIllIlII(var21.aF(), lllIIIIIIllI[2]) && A.lIIIlIIIIllIIll(var21.aF(), lllIIIIIIllI[4])) {
                    return lllIIIIIIllI[2];
                }
                return lllIIIIIIllI[0];
            }
    ...
    private static String lIIIlIIIIIIllll(String var19, String var13) {
        try {
            SecretKeySpec var28 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var13.getBytes(StandardCharsets.UTF_8)), lllIIIIIIllI[16]), "DES");
            Cipher var7 = Cipher.getInstance("DES");
            var7.init(lllIIIIIIllI[1], var28);
    ...
    private static String lIIIlIIIIIIlllI(String var10, String var1) {
        try {
            SecretKeySpec var31 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var1.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var16 = Cipher.getInstance("Blowfish");
            var16.init(lllIIIIIIllI[1], var31);
    ...
    public boolean a(Locatable locatable) {
        ...
        while (A.lIIIlIIIIllIlIl(var17.hasNext() ? 1 : 0)) {
            void var23;
            WorldArea var22 = var17.next();
            if (A.lIIIlIIIIllIlIl(var22.contains((Locatable)var23) ? 1 : 0)) {
                return lllIIIIIIllI[2];
            }
            0;
    ...
    private A(List<Triple<RegionPoint, Integer, Integer>> list, RegionPoint regionPoint, RegionPoint regionPoint2, Supplier<TileObject> supplier, C c2) {
        this.startAreas = () -> {
            ...
            while (A.lIIIlIIIIllIlIl(var32.hasNext() ? 1 : 0)) {
                void var12;
                Triple var24 = (Triple)var32.next();
                var12.add(new WorldArea(SquireSepulchre.a((RegionPoint)var24.getFirst()), ((Integer)var24.getSecond()).intValue(), ((Integer)var24.getThird()).intValue()));
                0;
                0;
    ...
    private static String lIIIlIIIIIlIIII(String var26, String var3) {
        ...
        char[] var30 = var3.toCharArray();
        int var2 = lllIIIIIIllI[0];
        char[] var18 = var26.toCharArray();
        int var4 = var18.length;
        int var11 = lllIIIIIIllI[0];
        while (A.lIIIlIIIIllIIll(var11, var4)) {
            char var5 = var18[var11];
            var29.append((char)(var5 ^ var30[var2 % var30.length]));
            0;
            ++var2;
            ++var11;
            0;
