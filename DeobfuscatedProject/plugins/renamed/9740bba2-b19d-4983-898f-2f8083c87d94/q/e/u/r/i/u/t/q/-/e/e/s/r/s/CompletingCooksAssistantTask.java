...
/* TASK: Completing Cooks Assistant -> CompletingcooksassistantTask */
...
extends Task {
    ...
    private void R() {
        ...
        if (p.lIlIIIlIlIIllll(var7.V() ? 1 : 0)) {
            ...
            if (p.lIlIIIlIlIIllll(Inventory.contains((int[])nArray) ? 1 : 0)) {
                ...
                if (p.lIlIIIlIlIIllll(Inventory.contains((int[])nArray2) ? 1 : 0)) {
                    ...
                    TileItem var13 = TileItems.getNearest((String[])stringArray);
                    if (p.lIlIIIlIlIlIIlI(var13)) {
                        var13.interact(lIIIllIlIIlll[lIIIllIlIlIII[2]]);
                    }
        ...
        if (p.lIlIIIlIlIlIIIl(var7.V() ? 1 : 0)) {
            String[] stringArray = new String[lIIIllIlIlIII[3]];
            stringArray[p.lIIIllIlIlIII[0]] = lIIIllIlIIlll[lIIIllIlIlIII[9]];
            NPC var13 = NPCs.getNearest((String[])stringArray);
            if (p.lIlIIIlIlIlIIlI(var13)) {
                var13.interact(lIIIllIlIIlll[lIIIllIlIlIII[5]]);
                var7.sleepWhile(lIIIllIlIlIII[17], () -> {
                    boolean bl;
    ...
    private static String lIlIIIlIlIIllII(String var20, String var11) {
        try {
            ...
            var10.init(lIIIllIlIlIII[1], var23);
    ...
    private void U() {
        ...
        if (p.lIlIIIlIlIlIIIl(Inventory.contains((int[])nArray3) ? 1 : 0)) {
            ...
            if (p.lIlIIIlIlIIllll(Inventory.contains((int[])nArray4) ? 1 : 0)) {
                ...
                if (p.lIlIIIlIlIlIIlI(TileObjects.getNearest((String[])stringArray)) && p.lIlIIIlIlIIllll(var14.as.a() ? 1 : 0)) {
        ...
        if (p.lIlIIIlIlIlIIIl(var14.as.a() ? 1 : 0)) {
            int[] nArray5 = new int[lIIIllIlIlIII[3]];
            nArray5[p.lIIIllIlIlIII[0]] = lIIIllIlIlIII[11];
    ...
    private static String lIlIIIlIlIIlIll(String var2, String var3) {
        ...
        int var16 = lIIIllIlIlIII[0];
        char[] var1 = var2.toCharArray();
        int var22 = var1.length;
        int var8 = lIIIllIlIlIII[0];
        while (p.lIlIIIlIlIlIlII(var8, var22)) {
            char var24 = var1[var8];
            var15.append((char)(var24 ^ var26[var16 % var26.length]));
            0;
            ++var16;
            ++var8;
            0;
        ...
        if (p.lIlIIIlIlIIllll(Inventory.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (p.lIlIIIlIlIlIIlI(TileObjects.getNearest((String[])stringArray))) {
                ...
                if (p.lIlIIIlIlIlIIIl(Reachable.isInteractable((Locatable)TileObjects.getNearest((String[])stringArray2)) ? 1 : 0)) {
                    ...
                    void var25;
                    String[] stringArray4 = new String[lIIIllIlIlIII[3]];
                    stringArray4[p.lIIIllIlIlIII[0]] = var25;
                ...
                Walker.walkTo((WorldPoint)var27);
                0;
            }
        }
    }
    ...
    public boolean run() {
        ...
        int var6 = var4.Q();
        System.out.println("[COOKS ASSISTANT] Current Progress: " + var6);
        if (p.lIlIIIlIlIlIIII(var6, lIIIllIlIlIII[1])) {
            return lIIIllIlIlIII[0];
        }
        switch (var6) {
            case 0: {
    ...
    private static String lIlIIIlIlIIlIlI(String var17, String var9) {
        try {
            SecretKeySpec var19 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var9.getBytes(StandardCharsets.UTF_8)), lIIIllIlIlIII[5]), "DES");
            Cipher var5 = Cipher.getInstance("DES");
            var5.init(lIIIllIlIlIII[1], var19);
    ...
    public void b(int n2, WorldPoint worldPoint) {
        ...
        if (p.lIlIIIlIlIIllll(Inventory.contains((int[])nArray) ? 1 : 0)) {
            ...
            if (p.lIlIIIlIlIlIIll(tileObject)) {
                ...
                void var18;
                var18.interact(lIIIllIlIIlll[lIIIllIlIlIII[50]]);
            }
        }
    }
