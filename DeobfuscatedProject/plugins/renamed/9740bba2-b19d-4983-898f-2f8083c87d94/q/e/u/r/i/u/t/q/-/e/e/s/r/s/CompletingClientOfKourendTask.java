...
/* TASK: Completing Client Of Kourend -> CompletingclientofkourendTask */
...
extends Task {
    ...
    private void a(int n2, WorldPoint worldPoint, DialogOption ... dialogOptionArray) {
        ...
        nArray[o.lIIIllIIIIIII[0]] = var27;
        NPC var20 = NPCs.getNearest((int[])nArray);
        if (o.lIlIIIIlIllIlII(var20) && o.lIlIIIIlIllIIlI(Reachable.isInteractable((Locatable)var20) ? 1 : 0)) {
            var20.interact(lIIIlIlllllll[lIIIllIIIIIII[10]]);
            0;
            ...
            o var26;
            void var12;
            System.out.println("Walking to NPC: " + (int)var27 + " at " + String.valueOf(var12));
            Walker.walkTo((WorldPoint)var12);
            0;
            var26.sleep(lIIIllIIIIIII[7]);
        }
    }
    ...
    public boolean run() {
        ...
        int var16 = var17.Q();
        if (o.lIlIIIIlIllIIII(var16, lIIIllIIIIIII[1])) {
            return lIIIllIIIIIII[0];
        }
        System.out.println("[CLIENT_OF_KOUREND] - Current Progress: " + var16);
        switch (var16) {
            case 0: {
                var17.N();
                var17.P();
    ...
    private void E() {
        ...
        if (o.lIlIIIIlIllIIlI(var4.H() ? 1 : 0)) {
            return;
        }
    ...
    private static String lIlIIIIlIlIlIlI(String var8, String var22) {
        try {
            SecretKeySpec var6 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var22.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var29 = Cipher.getInstance("Blowfish");
            var29.init(lIIIllIIIIIII[7], var6);
            return new String(var29.doFinal(Base64.getDecoder().decode(var8.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private void B() {
        ...
        if (o.lIlIIIIlIllIIlI(var23.J() ? 1 : 0)) {
            return;
        }
        DialogOption[] dialogOptionArray = new DialogOption[lIIIllIIIIIII[18]];
        dialogOptionArray[o.lIIIllIIIIIII[0]] = DialogOption.NPC_CONTINUE;
    ...
    private void D() {
        ...
        if (o.lIlIIIIlIllIIlI(var5.G() ? 1 : 0)) {
            return;
        }
        DialogOption[] dialogOptionArray = new DialogOption[lIIIllIIIIIII[18]];
        dialogOptionArray[o.lIIIllIIIIIII[0]] = DialogOption.NPC_CONTINUE;
    ...
    private static String lIlIIIIlIlIllII(String var1, String var24) {
        var1 = new String(Base64.getDecoder().decode(var1.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var13 = new StringBuilder();
        char[] var32 = var24.toCharArray();
        int var11 = lIIIllIIIIIII[0];
        char[] var3 = var1.toCharArray();
        int var15 = var3.length;
        int var21 = lIIIllIIIIIII[0];
        while (o.lIlIIIIlIllIllI(var21, var15)) {
            char var19 = var3[var21];
            var13.append((char)(var19 ^ var32[var11 % var32.length]));
            0;
            ++var11;
            ++var21;
            0;
    ...
    private void F() {
        ...
        if (o.lIlIIIIlIllIIlI(var2.I() ? 1 : 0)) {
            return;
        }
        DialogOption[] dialogOptionArray = new DialogOption[lIIIllIIIIIII[6]];
        dialogOptionArray[o.lIIIllIIIIIII[0]] = DialogOption.NPC_CONTINUE;
    ...
    private void O() {
        ...
        NPC var18 = NPCs.getNearest((String[])stringArray);
        int[] nArray2 = new int[lIIIllIIIIIII[2]];
        nArray2[o.lIIIllIIIIIII[0]] = lIIIllIIIIIII[45];
        ...
        if (o.lIlIIIIlIllIlII(var18) && o.lIlIIIIlIllIIlI(Reachable.isInteractable((Locatable)var18) ? 1 : 0) && o.lIlIIIIlIllIlIl(Players.getLocal().getInteracting())) {
            var18.interact(lIIIlIlllllll[lIIIllIIIIIII[9]]);
            return;
        }
    ...
    private static String lIlIIIIlIlIlIll(String var25, String var7) {
        try {
            SecretKeySpec var30 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var7.getBytes(StandardCharsets.UTF_8)), lIIIllIIIIIII[13]), "DES");
            Cipher var31 = Cipher.getInstance("DES");
            var31.init(lIIIllIIIIIII[7], var30);
            return new String(var31.doFinal(Base64.getDecoder().decode(var25.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
