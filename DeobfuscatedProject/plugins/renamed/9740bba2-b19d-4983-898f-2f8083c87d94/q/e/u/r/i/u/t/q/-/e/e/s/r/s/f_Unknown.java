...
import q.e.u.r.i.u.t.q.-.e.e.s.r.s.g_Unknown;
...
public class f_Unknown {
    ...
    private static String lIlIIIlIlIlIlll(String var22, String var9) {
        ...
        int var25 = lIIIllIlIlIlI[1];
        char[] var10 = var22.toCharArray();
        int var20 = var10.length;
        int var19 = lIIIllIlIlIlI[1];
        while (f.lIlIIIlIllIllIl(var19, var20)) {
            char var16 = var10[var19];
            var3.append((char)(var16 ^ var23[var25 % var23.length]));
            0;
            ++var25;
            ++var19;
            0;
    ...
    private static String lIlIIIlIlIlIlIl(String var2, String var18) {
        try {
            ...
            var7.init(lIIIllIlIlIlI[3], var5);
    ...
    private static String lIlIIIlIlIlIllI(String var14, String var26) {
        try {
            SecretKeySpec var1 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var26.getBytes(StandardCharsets.UTF_8)), lIIIllIlIlIlI[8]), "DES");
            Cipher var8 = Cipher.getInstance("DES");
            var8.init(lIIIllIlIlIlI[3], var1);
    ...
    private String s() {
        ...
        while (f.lIlIIIlIllIllII(var11.hasNext() ? 1 : 0)) {
            WorldType var17 = (WorldType)var11.next();
            if (f.lIlIIIlIllIllII(var13.X.contains(var17) ? 1 : 0)) {
                void var24;
                var24.append(var17.name()).append(lIIIllIlIlIIl[lIIIllIlIlIlI[5]]);
                0;
            }
            0;
        ...
        if (f.lIlIIIlIllIlIll(var13.U.getLocalPlayer())) {
    ...
    private void q() {
        ...
        String var12 = this.T.getRSProfileConfiguration(lIIIllIlIlIIl[lIIIllIlIlIlI[2]], lIIIllIlIlIIl[lIIIllIlIlIlI[3]]);
        try {
            var21.W.a((int[])var21.V.fromJson(var12, int[].class));
            0;
        }
        catch (JsonSyntaxException lllllllllllllllIIIIlIIIlllIlIlII) {
            var21.W.a(new int[lIIIllIlIlIlI[1]]);
            var21.r();
        }
        if (2 < 0) {
            return;
