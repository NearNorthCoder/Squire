...
extends Script {
    ...
    public void a(ChatMessage chatMessage) {
        ...
        if (AccBuilderShamans.lIIIllllllIlI(var22.getMessage().contains(lIlIlIIIlI[lIlIlIIIll[24]]) ? 1 : 0)) {
        ...
        if (AccBuilderShamans.lIIIllllllIlI(var22.getMessage().contains(lIlIlIIIlI[lIlIlIIIll[28]]) ? 1 : 0) && AccBuilderShamans.lIIIlllllllIl(Players.getLocal().getWorldLocation().distanceTo(F.iJ), lIlIlIIIll[21])) {
        ...
        if (AccBuilderShamans.lIIIllllllIlI(var22.getMessage().contains(lIlIlIIIlI[lIlIlIIIll[34]]) ? 1 : 0)) {
            Movement.walkTo((WorldPoint)new WorldPoint(lIlIlIIIll[35], lIlIlIIIll[36], lIlIlIIIll[4]));
            0;
            Time.sleepTicks((int)lIlIlIIIll[5]);
            0;
        }
        if (AccBuilderShamans.lIIIllllllIlI(var22.getMessage().contains(lIlIlIIIlI[lIlIlIIIll[37]]) ? 1 : 0)) {
    ...
    protected int loop() {
        block10: {
            block11: {
                ...
                while (AccBuilderShamans.lIIIllllllIlI(h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.e_Unknown.x() ? 1 : 0) && AccBuilderShamans.lIIIlllllIlll(d ? 1 : 0) && AccBuilderShamans.lIIIllllllIll(h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.e_Unknown.j(lIlIlIIIll[7]), lIlIlIIIll[8]) && AccBuilderShamans.lIIIlllllIlll(Dialog.isOpen() ? 1 : 0)) {
                    c = lIlIlIIIlI[lIlIlIIIll[9]];
                    h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.e_Unknown.y();
                    Time.sleepTicks((int)lIlIlIIIll[5]);
                    0;
                    0;
                ...
                int var16 = lIlIlIIIll[4];
                try {
                    var16 = a.get(lIlIlIIIll[4]).ad();
                    0;
                }
    ...
    private void a(LoginStateChanged loginStateChanged) {
        ...
        if (AccBuilderShamans.lIIIlllllIlll(n)) {
            AccBuilderShamans var23;
            h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.e_Unknown.a(var23.r, "rsn: " + k + " account has been banned? - Acc builder SHAMANS");
            n += lIlIlIIIll[5];
        }
    }

    private static String lIIIlllllIIIl(String var24, String var1) {
        var24 = new String(Base64.getDecoder().decode(var24.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var21 = new StringBuilder();
        char[] var4 = var1.toCharArray();
        int var9 = lIlIlIIIll[4];
        char[] var3 = var24.toCharArray();
        int var20 = var3.length;
        int var6 = lIlIlIIIll[4];
        while (AccBuilderShamans.lIIlIIIIIIIlI(var6, var20)) {
            char var10 = var3[var6];
            var21.append((char)(var10 ^ var4[var9 % var4.length]));
            0;
            ++var9;
            ++var6;
            0;
    ...
    public void a(GameTick gameTick) {
        block5: {
            AccBuilderShamans var12;
            block6: {
                h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.e_Unknown.w();
            ...
            if (AccBuilderShamans.lIIIlllllIlll(var12.q.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                Game.logout();
            }
        }
        ...
        h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.e_Unknown.G();
    }
    ...
    private static String lIIIlllllIIlI(String var8, String var5) {
        try {
    ...
    private static String lIIIlllllIIll(String var19, String var7) {
        try {
            SecretKeySpec var18 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var7.getBytes(StandardCharsets.UTF_8)), lIlIlIIIll[16]), "DES");
            Cipher var17 = Cipher.getInstance("DES");
            var17.init(lIlIlIIIll[9], var18);
