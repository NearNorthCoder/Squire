...
import h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.V_Unknown;
...
import h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.v_Unknown;
import h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.x_Unknown;
import h.l.n.a.c.m.o.-.-.c.k.s.e.s.a.i.n.z_Unknown;
...
implements K {
    ...
    private static String lIIlIIllIIlll(String var7, String var17) {
        var7 = new String(Base64.getDecoder().decode(var7.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var22 = new StringBuilder();
        char[] var5 = var17.toCharArray();
        int var1 = lIlIlllIIl[1];
        char[] var3 = var7.toCharArray();
        int var18 = var3.length;
        int var4 = lIlIlllIIl[1];
        while (u.lIIlIIllllIll(var4, var18)) {
            char var25 = var3[var4];
            var22.append((char)(var25 ^ var5[var1 % var5.length]));
            0;
            ++var1;
            ++var4;
            0;
    ...
    public static void bc() {
        block115: {
                                ...
                                block120: {
                                    block119: {
                                        block117: {
                                            ...
                                            if (u.lIIlIIlllllll(var13) && u.lIIlIIlllllII(var13.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                                AccBuilderShamans.c = lIlIllIllI[lIlIlllIIl[26]];
                                                a.a((BankLocation)var13);
                                            }
                                            if (!u.lIIlIIlllllll(var13) || !u.lIIlIIllllIlI(var13.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block116;
            ...
            if (u.lIIlIIllllIlI(u.al() ? 1 : 0) && u.lIIlIIlllllII(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()))) {
                ...
                if (u.lIIlIIllllIlI((var13 = new WorldArea(lIlIlllIIl[52], lIlIlllIIl[56], lIlIlllIIl[16], lIlIlllIIl[4], lIlIlllIIl[1])).contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    String[] stringArray = new String[lIlIlllIIl[0]];
            ...
            if (u.lIIlIIlllllIl(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIlIlllIIl[4])) {
                ...
                if (u.lIIlIIlllllII(Inventory.contains((int[])nArray10) ? 1 : 0)) {
                    block114: {
                        var13 = new WorldPoint(lIlIlllIIl[61], lIlIlllIIl[62], lIlIlllIIl[1]);
                        int[] nArray11 = new int[lIlIlllIIl[0]];
                        nArray11[u.lIlIlllIIl[1]] = lIlIlllIIl[63];
                        if (u.lIIlIIlllllII(Inventory.contains((int[])nArray11) ? 1 : 0) && u.lIIlIlIIIIIlI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var13), lIlIlllIIl[48])) {
                    ...
                    if (u.lIIlIIlllllII(Inventory.contains((int[])nArray15) ? 1 : 0)) {
                        ...
                        if (u.lIIlIIlllllII(Inventory.contains((String[])stringArray) ? 1 : 0) && u.lIIlIlIIIIIll(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var13), lIlIlllIIl[48])) {
            ...
            if (!u.lIIlIlIIIIlII(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIlIlllIIl[89]) || u.lIIlIIlllllIl(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIlIlllIIl[90])) {
                var13 = new WorldPoint(lIlIlllIIl[91], lIlIlllIIl[92], lIlIlllIIl[1]);
                if (u.lIIlIlIIIIIlI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var13), lIlIlllIIl[11])) {
                ...
                if (u.lIIlIlIIIIIll(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var13), lIlIlllIIl[11])) {
            ...
            if (u.lIIlIIlllllIl(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIlIlllIIl[100])) {
                ...
                if (u.lIIlIIllllIlI(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    ...
                    if (u.lIIlIIlllllII(Inventory.contains((String[])stringArray12) ? 1 : 0)) {
                        var13 = new HashMap();
                        ((HashMap)var13).put(lIlIlllIIl[33], lIlIlllIIl[8]);
                        0;
                        ((HashMap)var13).put(lIlIlllIIl[38], lIlIlllIIl[0]);
                        0;
                        ((HashMap)var13).put(lIlIlllIIl[39], lIlIlllIIl[0]);
                        0;
                        ((HashMap)var13).put(lIlIlllIIl[103], lIlIlllIIl[0]);
                        0;
                        e.a((HashMap<Integer, Integer>)var13, lIlIlllIIl[1], lIlIlllIIl[1]);
                    }
            ...
            if (!u.lIIlIlIIIIlII(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIlIlllIIl[105]) || u.lIIlIIlllllIl(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIlIlllIIl[106])) {
                ...
                var13 = NPCs.getNearest((String[])stringArray);
                if (u.lIIlIIlllllll(var13)) {
                    if (u.lIIlIIllllIlI(Reachable.isInteractable((Locatable)var13) ? 1 : 0)) {
                        g.a(lIlIllIllI[lIlIlllIIl[3]], cy);
                    }
                    if (u.lIIlIIlllllII(Reachable.isInteractable((Locatable)var13) ? 1 : 0)) {
                        Movement.walkTo((Locatable)var13);
                        0;
                        Time.sleepTicks((int)lIlIlllIIl[0]);
                        0;
                    }
            ...
            if (u.lIIlIIlllllIl(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIlIlllIIl[108])) {
                ...
                if (u.lIIlIIlllllII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    var13 = new WorldPoint(lIlIlllIIl[110], lIlIlllIIl[111], lIlIlllIIl[1]);
                    var2 = new WorldPoint(lIlIlllIIl[110], lIlIlllIIl[112], lIlIlllIIl[1]);
                    if (u.lIIlIIlllllII(Players.getLocal().getWorldLocation().equals(var13) ? 1 : 0) && u.lIIlIIlllllII(Players.getLocal().getWorldLocation().equals((Object)var2) ? 1 : 0)) {
                    ...
                    if (u.lIIlIIllllIlI(Players.getLocal().getWorldLocation().equals(var13) ? 1 : 0) && u.lIIlIIlllllII(Players.getLocal().getWorldLocation().equals((Object)var2) ? 1 : 0)) {
                        Movement.walkTo((WorldPoint)var2);
                        0;
                    }
            ...
            if (u.lIIlIIlllllIl(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIlIlllIIl[116])) {
                var13 = new WorldPoint(lIlIlllIIl[117], lIlIlllIIl[118], lIlIlllIIl[1]);
                if (u.lIIlIIlllllII(Players.getLocal().getWorldLocation().equals(var13) ? 1 : 0)) {
                    Movement.walkTo((WorldPoint)var13);
                    0;
                    Time.sleepTicks((int)lIlIlllIIl[0]);
                    0;
                }
                if (u.lIIlIIllllIlI(Players.getLocal().getWorldLocation().equals(var13) ? 1 : 0)) {
                    String[] stringArray = new String[lIlIlllIIl[0]];
            ...
            if (!u.lIIlIlIIIIlII(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIlIlllIIl[121]) || u.lIIlIIlllllIl(Vars.getBit((int)QuestVarbits.QUEST_ANIMAL_MAGNETISM.getId()), lIlIlllIIl[122])) {
                var13 = new WorldPoint(lIlIlllIIl[123], lIlIlllIIl[124], lIlIlllIIl[1]);
                if (u.lIIlIlIIIIIlI(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var13), lIlIlllIIl[9])) {
                ...
                if (u.lIIlIlIIIIIll(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var13), lIlIlllIIl[9])) {
                    String[] stringArray = new String[lIlIlllIIl[0]];
    ...
    private static boolean al() {
        ...
        int[] nArray2 = nArray;
        int var23 = lIlIlllIIl[1];
        while (u.lIIlIIllllIll(var23, ((void)var6).length)) {
            int[] nArray3 = new int[lIlIlllIIl[0]];
            nArray3[u.lIlIlllIIl[1]] = var6[var23];
    ...
    private static void O() {
        block46: {
            ...
            block45: {
                block44: {
                    block43: {
                        ...
                        block42: {
                            block41: {
                                block40: {
                                        ...
                                        block38: {
                                            block37: {
                                                block36: {
                                                        ...
                                                        block34: {
                                                            block33: {
                                                                block32: {
                                                                    ...
                                                                    var16 = new d(lIlIlllIIl[43], lIlIlllIIl[4], e.c(lIlIlllIIl[147], lIlIlllIIl[148]));
                                                                    bp.add((d)var16);
                                                                    0;
                                                                }
                                                                int[] nArray = new int[lIlIlllIIl[0]];
                                                            ...
                                                            var16 = new d(lIlIlllIIl[30], lIlIlllIIl[16], lIlIlllIIl[149]);
                                                            bp.add((d)var16);
                                                            0;
                                                        }
                                                        int[] nArray = new int[lIlIlllIIl[0]];
                                                    ...
                                                    var16 = new d(lIlIlllIIl[31], lIlIlllIIl[28], lIlIlllIIl[150]);
                                                    bp.add((d)var16);
                                                    0;
                                                }
                                                int[] nArray = new int[lIlIlllIIl[0]];
                                                ...
                                                if (u.lIIlIIlllllII(Bank.contains((int[])nArray) ? 1 : 0)) {
                                                    var16 = new d(lIlIlllIIl[103], lIlIlllIIl[8], lIlIlllIIl[151]);
                                                    bp.add((d)var16);
                                                    0;
                                                }
                                                ...
                                                if (u.lIIlIIlllllII(Bank.contains((int[])nArray8) ? 1 : 0)) {
                                                    var16 = new d(lIlIlllIIl[37], lIlIlllIIl[0], lIlIlllIIl[27]);
                                                    bp.add((d)var16);
                                                    0;
                                                }
                                                int[] nArray9 = new int[lIlIlllIIl[0]];
                                            ...
                                            var16 = new d(lIlIlllIIl[32], lIlIlllIIl[13], lIlIlllIIl[27]);
                                            bp.add((d)var16);
                                            0;
                                        }
                                        int[] nArray = new int[lIlIlllIIl[0]];
                                    ...
                                    var16 = new d(lIlIlllIIl[33], lIlIlllIIl[8], lIlIlllIIl[27]);
                                    bp.add((d)var16);
                                    0;
                                }
                                int[] nArray = new int[lIlIlllIIl[0]];
                            ...
                            var16 = new d(lIlIlllIIl[29], lIlIlllIIl[13], lIlIlllIIl[27]);
                            bp.add((d)var16);
                            0;
                        }
                        int[] nArray = new int[lIlIlllIIl[0]];
                        ...
                        if (u.lIIlIIlllllII(Bank.contains((int[])nArray) ? 1 : 0)) {
                            var16 = new d(lIlIlllIIl[39], lIlIlllIIl[0], lIlIlllIIl[27]);
                            bp.add((d)var16);
                            0;
                        }
                        int[] nArray16 = new int[lIlIlllIIl[0]];
                        ...
                        if (u.lIIlIIlllllII(Bank.contains((int[])nArray16) ? 1 : 0)) {
                            var16 = new d(lIlIlllIIl[38], lIlIlllIIl[0], lIlIlllIIl[27]);
                            bp.add((d)var16);
                            0;
                        }
                        ...
                        if (u.lIIlIIlllllII(Bank.contains((int[])nArray17) ? 1 : 0)) {
                            var16 = new d(lIlIlllIIl[40], lIlIlllIIl[0], lIlIlllIIl[152]);
                            bp.add((d)var16);
                            0;
                        }
                        ...
                        if (u.lIIlIIlllllII(Bank.contains((int[])nArray18) ? 1 : 0)) {
                            var16 = new d(lIlIlllIIl[41], lIlIlllIIl[0], lIlIlllIIl[153] + e.c(lIlIlllIIl[154], lIlIlllIIl[155]));
                            bp.add((d)var16);
                            0;
                        }
                        if (u.lIIlIIlllllII(Bank.contains((Predicate)(var16 = item -> item.getName().toLowerCase().contains(lIlIllIllI[lIlIlllIIl[161]]))) ? 1 : 0)) {
                            var21 = new d(lIlIlllIIl[156], lIlIlllIIl[8], lIlIlllIIl[157]);
                            bp.add(var21);
                            0;
                        }
                    ...
                    var21 = new d(lIlIlllIIl[34], lIlIlllIIl[13], j.bZ);
                    bp.add(var21);
                    0;
                }
                int[] nArray = new int[lIlIlllIIl[0]];
            ...
            var21 = new d(lIlIlllIIl[36], lIlIlllIIl[22], lIlIlllIIl[158]);
            bp.add(var21);
            0;
        }
    }
    ...
    private static String lIIlIIllIlIII(String var24, String var20) {
        try {
            SecretKeySpec var15 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var20.getBytes(StandardCharsets.UTF_8)), lIlIlllIIl[21]), "DES");
            Cipher var10 = Cipher.getInstance("DES");
            var10.init(lIlIlllIIl[9], var15);
    ...
    private static String lIIlIIllIIllI(String var19, String var11) {
        try {
