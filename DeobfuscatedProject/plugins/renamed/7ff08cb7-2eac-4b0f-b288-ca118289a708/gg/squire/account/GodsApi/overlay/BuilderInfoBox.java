...
extends OverlayPanel {
    ...
    private static void llIlIIlIIlll() {
        ...
        BuilderInfoBox.llllIlIll[BuilderInfoBox.llllIllII[1]] = BuilderInfoBox."Squire GWD Builder";
        BuilderInfoBox.llllIlIll[BuilderInfoBox.llllIllII[2]] = BuilderInfoBox."Version";
        BuilderInfoBox.llllIlIll[BuilderInfoBox.llllIllII[3]] = BuilderInfoBox."Runtime";
        BuilderInfoBox.llllIlIll[BuilderInfoBox.llllIllII[4]] = BuilderInfoBox."Status:";
        BuilderInfoBox.llllIlIll[BuilderInfoBox.llllIllII[5]] = BuilderInfoBox."Current Quest:";
        BuilderInfoBox.llllIlIll[BuilderInfoBox.llllIllII[6]] = BuilderInfoBox."Tasks Completed:";
    }
    ...
    private static void llIlIIlIlIII() {
        ...
        BuilderInfoBox.llllIllII[2] = 1;
        BuilderInfoBox.llllIllII[3] = 2;
        BuilderInfoBox.llllIllII[4] = 3;
