...
import -.-.k.r.-.b.a.g.c.d.o.c.u.t.e.-.o.l.i.d.i.c.u.c.w.n.e.n.l.aa_Unknown;
...
implements ab {
    ...
    private static String llIIllIIIIlI(String llIIlIlIIIIII, String llIIlIIllllll) {
        ...
        while (w.llIIllIllIII(llIIlIIllIlII, llIIlIIllIlIl)) {
            ...
            ++llIIlIIllIlII;
            0;
            if (1 > ((0x87 ^ 0x97 ^ (0xF5 ^ 0xAB)) & (1 ^ 0x4C ^ 3 ^ -1))) continue;
            return null;
        }
    ...
    private static void llIIllIlIllI() {
        ...
        w.llllIIIIl[0] = 1;
        w.llllIIIIl[1] = (1 ^ (0x46 ^ 0x5F)) & (6 ^ 0x2C ^ (0x83 ^ 0xB1) ^ -1);
        ...
        w.llllIIIIl[92] = -1 & (0xFFFFAF6F & 0x5EFA);
    ...
    private static void llIIllIlIlIl() {
        ...
        w.lllIllllI[w.llllIIIIl[1]] = w."Finished buying items, switching back to quest";
        w.lllIllllI[w.llllIIIIl[0]] = w."Nav to bank";
        w.lllIllllI[w.llllIIIIl[5]] = w."Handling banking";
        w.lllIllllI[w.llllIIIIl[10]] = w."We are missing quest supplies, switching to BUYING";
        w.lllIllllI[w.llllIIIIl[6]] = w."Eat";
        w.lllIllllI[w.llllIIIIl[13]] = w."Drink";
        w.lllIllllI[w.llllIIIIl[17]] = w."Nav to start";
        w.lllIllllI[w.llllIIIIl[18]] = w."Starting quest";
        w.lllIllllI[w.llllIIIIl[2]] = w."Veos";
        w.lllIllllI[w.llllIIIIl[24]] = w."Enchanted scroll";
        w.lllIllllI[w.llllIIIIl[12]] = w."Feather";
        w.lllIllllI[w.llllIIIIl[25]] = w."Enchanted quill";
        w.lllIllllI[w.llllIIIIl[15]] = w."Enchanted scroll";
        w.lllIllllI[w.llllIIIIl[26]] = w."Feather";
        w.lllIllllI[w.llllIIIIl[27]] = w."Enchanted quill";
        w.lllIllllI[w.llllIIIIl[28]] = w."Nav to pisc tile";
        w.lllIllllI[w.llllIIIIl[29]] = w."Talking pisc";
        w.lllIllllI[w.llllIIIIl[30]] = w."Leenz";
        w.lllIllllI[w.llllIIIIl[31]] = w."Finished pisc";
        w.lllIllllI[w.llllIIIIl[32]] = w."Nav to arc tile";
        w.lllIllllI[w.llllIIIIl[33]] = w."Talking arc";
        w.lllIllllI[w.llllIIIIl[34]] = w."Regath";
        w.lllIllllI[w.llllIIIIl[35]] = w."Finished arc";
        w.lllIllllI[w.llllIIIIl[36]] = w."Nav to lova tile";
        w.lllIllllI[w.llllIIIIl[37]] = w."Talking lova";
        w.lllIllllI[w.llllIIIIl[38]] = w."Munty";
        w.lllIllllI[w.llllIIIIl[39]] = w."Finished munty";
        w.lllIllllI[w.llllIIIIl[40]] = w."Nav to shyzien tile";
        w.lllIllllI[w.llllIIIIl[41]] = w."Talking shyzien";
        w.lllIllllI[w.llllIIIIl[42]] = w."Jennifer";
        w.lllIllllI[w.llllIIIIl[43]] = w."Finished shyzien";
        w.lllIllllI[w.llllIIIIl[44]] = w."Nav to hosidius tile";
        w.lllIllllI[w.llllIIIIl[45]] = w."Talking hosidius";
        w.lllIllllI[w.llllIIIIl[46]] = w."Horace";
        w.lllIllllI[w.llllIIIIl[47]] = w."Finished hosidius";
        w.lllIllllI[w.llllIIIIl[48]] = w."Nav to start";
        w.lllIllllI[w.llllIIIIl[49]] = w."talking veos";
        w.lllIllllI[w.llllIIIIl[50]] = w."Veos";
        w.lllIllllI[w.llllIIIIl[51]] = w."Nav to dark altar";
        w.lllIllllI[w.llllIIIIl[52]] = w."Mysterious orb";
        w.lllIllllI[w.llllIIIIl[53]] = w."Mysterious orb";
        w.lllIllllI[w.llllIIIIl[54]] = w."Activate";
        w.lllIllllI[w.llllIIIIl[55]] = w."Nav to start";
        w.lllIllllI[w.llllIIIIl[56]] = w."talking veos";
        w.lllIllllI[w.llllIIIIl[57]] = w."Veos";
        w.lllIllllI[w.llllIIIIl[58]] = w."Antique lamp";
        w.lllIllllI[w.llllIIIIl[60]] = w."Rubbing lamp";
        w.lllIllllI[w.llllIIIIl[61]] = w."Antique lamp";
        w.lllIllllI[w.llllIIIIl[62]] = w."Rub";
        w.lllIllllI[w.llllIIIIl[63]] = w."Selecting slayer";
        w.lllIllllI[w.llllIIIIl[64]] = w."Slayer";
        w.lllIllllI[w.llllIIIIl[65]] = w."Confirm";
        w.lllIllllI[w.llllIIIIl[66]] = w."Antique lamp";
        w.lllIllllI[w.llllIIIIl[67]] = w."Rubbing lamp";
        w.lllIllllI[w.llllIIIIl[68]] = w."Antique lamp";
        w.lllIllllI[w.llllIIIIl[69]] = w."Rub";
        w.lllIllllI[w.llllIIIIl[70]] = w."Selecting slayer";
        w.lllIllllI[w.llllIIIIl[71]] = w."Slayer";
        w.lllIllllI[w.llllIIIIl[72]] = w."Confirm";
        w.lllIllllI[w.llllIIIIl[73]] = w."Feather";
        w.lllIllllI[w.llllIIIIl[78]] = w."Client of Kourend";
        w.lllIllllI[w.llllIIIIl[79]] = w."Antique lamp";
        w.lllIllllI[w.llllIIIIl[80]] = w."ring of wealth (";
        w.lllIllllI[w.llllIIIIl[81]] = w."Can I ask you about Hosidius?";
        w.lllIllllI[w.llllIIIIl[82]] = w."let's trade.";
        w.lllIllllI[w.llllIIIIl[16]] = w."Let's trade.";
        w.lllIllllI[w.llllIIIIl[83]] = w."Can I ask you about Shayzien?";
        w.lllIllllI[w.llllIIIIl[84]] = w."Let's trade.";
        w.lllIllllI[w.llllIIIIl[85]] = w."Can I ask you about Lovakengj?";
        w.lllIllllI[w.llllIIIIl[86]] = w."Let's trade.";
        w.lllIllllI[w.llllIIIIl[87]] = w."Can I ask you about Arceuus?";
        w.lllIllllI[w.llllIIIIl[88]] = w."I don't need anything.";
        w.lllIllllI[w.llllIIIIl[89]] = w."Can I ask you about Port Piscarilius?";
        w.lllIllllI[w.llllIIIIl[90]] = w."I don't need anything right now.";
        w.lllIllllI[w.llllIIIIl[105]] = w."Have you got any quests for me?";
        w.lllIllllI[w.llllIIIIl[106]] = w."Yes.";
        w.lllIllllI[w.llllIIIIl[107]] = w."yes.";
        w.lllIllllI[w.llllIIIIl[108]] = w."Can I ask you about Port Piscarilius?";
        w.lllIllllI[w.llllIIIIl[109]] = w."Why should I gain favour with Port Piscarilius?";
        w.lllIllllI[w.llllIIIIl[110]] = w."Can I ask you about Port Arceuus?";
        w.lllIllllI[w.llllIIIIl[111]] = w."Can I ask you about Arceuus?";
        w.lllIllllI[w.llllIIIIl[112]] = w."Why should I gain favour with Arceuus?";
        w.lllIllllI[w.llllIIIIl[113]] = w."Can I ask you about Lovakengj?";
        w.lllIllllI[w.llllIIIIl[114]] = w."Why should I gain favour with Lovakengj?";
        w.lllIllllI[w.llllIIIIl[115]] = w."Can I ask you about Shayzien?";
        w.lllIllllI[w.llllIIIIl[116]] = w."Why should I gain favour with Shayzien?";
        w.lllIllllI[w.llllIIIIl[117]] = w."Can I ask you about Hosidius?";
        w.lllIllllI[w.llllIIIIl[118]] = w."Why should I gain favour with Hosidius?";
        w.lllIllllI[w.llllIIIIl[119]] = w."What is there to do in Port Piscarilius?";
        w.lllIllllI[w.llllIIIIl[120]] = w."What is there to do in Arceuus?";
        w.lllIllllI[w.llllIIIIl[121]] = w."What is there to do in Lovakengj?";
        w.lllIllllI[w.llllIIIIl[122]] = w."What is there to do in Shayzien?";
        w.lllIllllI[w.llllIIIIl[123]] = w."What is there to do in Hosidius?";
        w.lllIllllI[w.llllIIIIl[124]] = w."Let's talk about your client...";
    }
