...
implements ab {
    ...
    private static void llIIIIlllIll() {
        ...
        ar.lllIIllII[ar.lllIIllIl[0]] = ar."Buying items";
        ar.lllIIllII[ar.lllIIllIl[1]] = ar."Finished buying items, switching back to woodcutting";
        ar.lllIIllII[ar.lllIIllIl[3]] = ar."Navigating to bank";
        ar.lllIIllII[ar.lllIIllIl[4]] = ar."Opening bank";
        ar.lllIIllII[ar.lllIIllIl[6]] = ar."Handling banking";
        ar.lllIIllII[ar.lllIIllIl[12]] = ar."We are missing pickaxes, switching to BUYING";
        ar.lllIIllII[ar.lllIIllIl[13]] = ar."Dropping logs";
        ar.lllIIllII[ar.lllIIllIl[14]] = ar."Dropping logs";
        ar.lllIIllII[ar.lllIIllIl[16]] = ar."Walking to trees";
        ar.lllIIllII[ar.lllIIllIl[17]] = ar."Chopping";
        ar.lllIIllII[ar.lllIIllIl[18]] = ar."Chopping logs";
        ar.lllIIllII[ar.lllIIllIl[19]] = ar."Chop down";
        ar.lllIIllII[ar.lllIIllIl[20]] = ar."Walking to oak trees";
        ar.lllIIllII[ar.lllIIllIl[21]] = ar."Chopping oaks";
        ar.lllIIllII[ar.lllIIllIl[22]] = ar."Chopping oak logs";
        ar.lllIIllII[ar.lllIIllIl[15]] = ar."Chop down";
        ar.lllIIllII[ar.lllIIllIl[34]] = ar."Woodcutting";
        ar.lllIIllII[ar.lllIIllIl[36]] = ar."ring of wealth (";
    }
