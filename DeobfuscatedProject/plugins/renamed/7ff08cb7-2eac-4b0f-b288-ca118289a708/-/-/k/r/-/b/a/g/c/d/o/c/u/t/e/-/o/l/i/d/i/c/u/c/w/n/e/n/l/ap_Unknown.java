...
implements ab {
    ...
    private static void lIlIlIIIIlII() {
        ...
        ap.llIIlIIII[0] = (0xA3 ^ 0x88 ^ (7 ^ 0xA)) & (0x7D ^ 0x1C ^ (0xE ^ 0x49) ^ -1);
        ap.llIIlIIII[1] = 1;
    ...
    public boolean ah() {
        ...
        if (ap.lIlIlIIIlIll(Skills.getLevel((Skill)Skill.HERBLORE), llIIlIIII[31])) {
            ...
            0;
            if (-1 > 0) {
                return ((0x4B ^ 0x63 ^ (0x7A ^ 7)) & (0x19 ^ 0x5E ^ (0x27 ^ 0x35) ^ -1)) != 0;
            }
        } else {
            bl = llIIlIIII[0];
        }
    ...
    private static void lIlIlIIIIIll() {
        ...
        ap.llIIIlllI[ap.llIIlIIII[0]] = ap."Buying items";
        ap.llIIIlllI[ap.llIIlIIII[1]] = ap."Finished buying items, switching back to herblore";
        ap.llIIIlllI[ap.llIIlIIII[4]] = ap."Navigating to bank";
        ap.llIIIlllI[ap.llIIlIIII[5]] = ap."Handling banking";
        ap.llIIIlllI[ap.llIIlIIII[3]] = ap."We are missing supplies, switching to BUYING";
        ap.llIIIlllI[ap.llIIlIIII[15]] = ap."Mixing potions";
        ap.llIIIlllI[ap.llIIlIIII[30]] = ap."Herblore";
        ap.llIIIlllI[ap.llIIlIIII[32]] = ap."Uncut";
        ap.llIIIlllI[ap.llIIlIIII[33]] = ap."Chisel";
        ap.llIIIlllI[ap.llIIlIIII[34]] = ap."Chisel";
    }
