...
import l.-.-.n.s.s.i.e.r.q.p.o.c.o.t.u.r.e.t.b_Unknown;
import l.-.-.n.s.s.i.e.r.q.p.o.c.o.t.u.r.e.t.CEnum;
import l.-.-.n.s.s.i.e.r.q.p.o.c.o.t.u.r.e.t.DEnum;
...
public class a_Unknown {
    ...
    public void i() {
        switch (b.m[l.ordinal()]) {
            case 1: {
                a var1;
                var1.a(lIIIlIlIIIlII[2], lIIIlIlIIIlII[3], lIIIlIlIIIlII[1]);
                0;
                if (null == null) break;
                return;
            }
            case 2: {
                a var1;
                var1.a(lIIIlIlIIIlII[4], lIIIlIlIIIlII[3], lIIIlIlIIIlII[1]);
                0;
                if (null == null) break;
                return;
            }
            case 3: {
                a var1;
                var1.a(lIIIlIlIIIlII[5], lIIIlIlIIIlII[6], lIIIlIlIIIlII[1]);
            }
        }
    }
