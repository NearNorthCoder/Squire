...
extends OverlayPanel {
    ...
    private static void llIIlIlIlll() {
        ...
        ToaderOverlay.lllIlIlll[ToaderOverlay.lllIllIII[0]] = ToaderOverlay."Squire Toad Killer";
        ToaderOverlay.lllIlIlll[ToaderOverlay.lllIllIII[1]] = ToaderOverlay."Runtime";
        ToaderOverlay.lllIlIlll[ToaderOverlay.lllIllIII[2]] = ToaderOverlay."Version";
        ToaderOverlay.lllIlIlll[ToaderOverlay.lllIllIII[3]] = ToaderOverlay."1.0.0";
        ToaderOverlay.lllIlIlll[ToaderOverlay.lllIllIII[4]] = ToaderOverlay."Task: ";
        ToaderOverlay.lllIlIlll[ToaderOverlay.lllIllIII[5]] = ToaderOverlay."Killed birds: ";
    }

    private static void llIIlIllIII() {
        lllIllIII = new int[10];
        ToaderOverlay.lllIllIII[0] = (0x24 ^ 0x22) & ~(0x43 ^ 0x45);
        ToaderOverlay.lllIllIII[1] = 1;
        ToaderOverlay.lllIllIII[2] = 2;
        ToaderOverlay.lllIllIII[3] = 3;
