...
import i.i.b.s.c.q.r.s.s.-.u.a.e.TypingTask;
...
extends SquirePlugin {
    ...
    private static void llllIIII() {
        llllIl = new int[2];
        SquireTyper.llllIl[0] = 1;
        SquireTyper.llllIl[1] = (3 ^ (0xB7 ^ 0x9B)) & (0x98 ^ 0x89 ^ (0x9C ^ 0xA2) ^ -1);
    }

    protected Class<?>[] tasks() {
        Class[] classArray = new Class[llllIl[0]];
        classArray[SquireTyper.llllIl[1]] = TypingTask.class;
        return classArray;
    }
