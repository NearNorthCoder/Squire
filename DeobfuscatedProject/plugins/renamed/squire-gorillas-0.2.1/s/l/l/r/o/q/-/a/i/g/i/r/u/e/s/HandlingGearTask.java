...
/* TASK: Handling Gear -> HandlinggearTask */
...
extends Task {
    ...
    public boolean a(ConfigStorageBox<EquipmentSetup> configStorageBox) {
        ...
        if (r.lllllIlIIIlllI((var6 = Inventory.getAll((int[])(var23 = nArray))).isEmpty() ? 1 : 0)) {
            return llIIlIIllllI[0];
        }
        int var13 = llIIlIIllllI[0];
        while (r.lllllIlIIlIlII(var13, Math.min(var6.size(), llIIlIIllllI[8]))) {
            Item var12 = (Item)var6.get(var13);
    ...
    private static String lllllIlIIIlIlI(String var20, String var16) {
        ...
        int var22 = llIIlIIllllI[0];
        char[] var5 = var20.toCharArray();
        int var25 = var5.length;
        int var8 = llIIlIIllllI[0];
        while (r.lllllIlIIlIlII(var8, var25)) {
            char var28 = var5[var8];
            var27.append((char)(var28 ^ var7[var22 % var7.length]));
            0;
            ++var22;
            ++var8;
            0;
    ...
    private static String lllllIlIIIlIII(String var10, String var11) {
        try {
            ...
            var3.init(llIIlIIllllI[4], var14);
    ...
    public boolean run() {
        ...
        if (r.lllllIlIIIllIl(var29 = nPC2)) {
            return llIIlIIllllI[0];
        }
        c var24 = var26.ab.a(var29);
        if (r.lllllIlIIIllIl(var24)) {
            return llIIlIIllllI[0];
        }
        if (r.lllllIlIIIllIl(var24.A())) {
            return llIIlIIllllI[0];
        }
        if (r.lllllIlIIIlllI(((EquipmentSetup)var26.ac.melee().selected(EquipmentSetup.class)).contains(itemComposition -> {
            boolean bl;
            void var18;
            ...
            String var31 = var18.toLowerCase();
            if (!r.lllllIlIIlIIIl(var31.contains(llIIlIIlllIl[llIIlIIllllI[16]]) ? 1 : 0) || !r.lllllIlIIlIIIl(var31.contains(llIIlIIlllIl[llIIlIIllllI[17]]) ? 1 : 0) || r.lllllIlIIIlllI(var31.contains(llIIlIIlllIl[llIIlIIllllI[18]]) ? 1 : 0)) {
                bl = llIIlIIllllI[1];
                0;
            ...
            return bl;
        }) ? 1 : 0) && r.lllllIlIIIllll(var24.A(), HeadIcon.MAGIC)) {
            n3 = llIIlIIllllI[1];
            0;
            if (1 > 1) {
                return false;
            ...
            n3 = var32 = llIIlIIllllI[0];
        }
        if (r.lllllIlIIIllll(var24.A(), HeadIcon.MELEE)) {
            n2 = llIIlIIllllI[1];
            0;
            if (-1 >= 0) {
                return false;
        ...
        if (r.lllllIlIIIlllI(var15 = n2) && r.lllllIlIIlIIII(Equipment.fromSlot((EquipmentInventorySlot)EquipmentInventorySlot.SHIELD)) && r.lllllIlIIlIIIl(Inventory.getFreeSlots())) {
            ...
            if (r.lllllIlIIlIIII(var2)) {
                var2.interact(llIIlIIlllIl[llIIlIIllllI[0]]);
                return llIIlIIllllI[1];
            }
            ...
            if (r.lllllIlIIlIIII(var17)) {
                var17.interact(llIIlIIlllIl[llIIlIIllllI[1]]);
                return llIIlIIllllI[1];
            }
            return llIIlIIllllI[0];
        }
        if (r.lllllIlIIlIIIl(var15) && r.lllllIlIIlIIlI(Combat.getSpecEnergy(), llIIlIIllllI[2]) && r.lllllIlIIlIIll(Combat.getMissingHealth(), llIIlIIllllI[3]) && r.lllllIlIIIlllI(Inventory.contains(item -> item.getName().toLowerCase().contains(llIIlIIlllIl[llIIlIIllllI[13]])) ? 1 : 0)) {
            Item var2 = Inventory.getFirst(item -> item.getName().toLowerCase().contains(llIIlIIlllIl[llIIlIIllllI[12]]));
            var2.interact(llIIlIIlllIl[llIIlIIllllI[4]]);
            Combat.toggleSpec();
            var29.interact(llIIlIIlllIl[llIIlIIllllI[5]]);
            return llIIlIIllllI[1];
        }
        if (r.lllllIlIIIlllI(var15) && r.lllllIlIIlIIlI(Combat.getSpecEnergy(), llIIlIIllllI[2]) && r.lllllIlIIlIIll(Combat.getMissingHealth(), llIIlIIllllI[3]) && r.lllllIlIIIlllI(Equipment.contains(item -> item.getName().toLowerCase().contains(llIIlIIlllIl[llIIlIIllllI[11]])) ? 1 : 0)) {
            Combat.toggleSpec();
            var29.interact(llIIlIIlllIl[llIIlIIllllI[6]]);
            return llIIlIIllllI[1];
        }
        if (!r.lllllIlIIlIIIl(var15) || r.lllllIlIIIlllI(var32)) {
            configStorageBox = var26.ac.ranged();
            0;
            if (((145 + 34 - -3 + 45 ^ 36 + 59 - 12 + 77) & (0xCD ^ 0x9F ^ (0x4F ^ 0x5E) ^ -1)) < 0) {
                return ((0x1E ^ 0x7E ^ (0x1A ^ 0x26)) & (0xD4 ^ 0x81 ^ (0x27 ^ 0x2E) ^ -1)) != 0;
            }
        } else {
            configStorageBox = var26.ac.melee();
        }
        if (r.lllllIlIIIlllI(var26.a(configStorageBox) ? 1 : 0)) {
            var29.interact(llIIlIIlllIl[llIIlIIllllI[7]]);
            return llIIlIIllllI[1];
        }
        return llIIlIIllllI[0];
    }

    private static String lllllIlIIIlIIl(String var19, String var30) {
        try {
            SecretKeySpec var21 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var30.getBytes(StandardCharsets.UTF_8)), llIIlIIllllI[8]), "DES");
            Cipher var9 = Cipher.getInstance("DES");
            var9.init(llIIlIIllllI[4], var21);
