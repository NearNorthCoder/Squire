...
/* TASK: Walking to gate -> WalkingtogateTask */
...
extends j_Unknown {
    ...
    private static String lllllIllIIIIlI(String var3, String var16) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var16.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var1 = Cipher.getInstance("Blowfish");
            var1.init(llIIlIllIIII[5], var5);
    ...
    private static String lllllIllIIIIIl(String var14, String var13) {
        var14 = new String(Base64.getDecoder().decode(var14.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var15 = new StringBuilder();
        char[] var7 = var13.toCharArray();
        int var4 = llIIlIllIIII[1];
        char[] var11 = var14.toCharArray();
        int var8 = var11.length;
        int var10 = llIIlIllIIII[1];
        while (n.lllllIllIIlIII(var10, var8)) {
            char var6 = var11[var10];
            var15.append((char)(var6 ^ var7[var4 % var7.length]));
            0;
            ++var4;
            ++var10;
            0;
    ...
    public boolean run() {
        ...
        if (n.lllllIllIIIllI(var9.J() ? 1 : 0)) {
            return llIIlIllIIII[1];
        }
        ...
        if (!n.lllllIllIIIlll(var12) || n.lllllIllIIIlIl(Reachable.isInteractable((Locatable)var12) ? 1 : 0)) {
