...
import k.p.n.s.r.a.-.q.e.l.r.e.i.u.AEnum;
...
extends Config {
    ...
    default public boolean slowmode() {
        return ((84 + 6 - 2 + 79 ^ 10 + 122 - 50 + 57) & (0x2D ^ 0x6A ^ (0x29 ^ 0x42) ^ -1)) != 0;
    }
    ...
    default public boolean spell() {
        return ((0x31 ^ 0x3B ^ (0xC2 ^ 0x97)) & (0x31 ^ 0x71 ^ (0x7F ^ 0x60) ^ -1)) != 0;
    }
    ...
    default public boolean ironMode() {
        return ((0x60 ^ 0x6A ^ (0x20 ^ 0x39)) & (93 + 79 - 47 + 22 ^ 103 + 52 - 113 + 86 ^ -1)) != 0;
    }
