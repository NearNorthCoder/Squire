...
import e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.H_Unknown;
import e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.N_Unknown;
...
import e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.e_Unknown;
import e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.m_Unknown;
import e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.s_Unknown;
...
extends Script {
    ...
    public void a(GameTick gameTick) {
        block5: {
            AccBuilderTempleTrek var15;
            block6: {
                e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.e_Unknown.w();
            ...
            if (AccBuilderTempleTrek.llIllllIIIlIl(var15.q.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                Game.logout();
            }
        }
        if (AccBuilderTempleTrek.llIllllIIlIII(Dialog.isOpen() ? 1 : 0) && AccBuilderTempleTrek.llIllllIIIllI(Dialog.getText()) && AccBuilderTempleTrek.llIllllIIlIII(Dialog.getText().contains(lIIIIIllIII[lIIIIIllIIl[21]]) ? 1 : 0)) {
            e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.s_Unknown.dq = lIIIIIllIIl[5];
        }
        e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.e_Unknown.G();
    }
    ...
    private void a(LoginStateChanged loginStateChanged) {
        ...
        if (AccBuilderTempleTrek.llIllllIIIlIl(n)) {
            AccBuilderTempleTrek var9;
            e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.e_Unknown.a(var9.r, "rsn: " + k + " account has been banned? - Acc builder");
            n += lIIIIIllIIl[5];
        }
    }
    ...
    private static String llIllllIIIIII(String var17, String var8) {
        try {
            SecretKeySpec var3 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var8.getBytes(StandardCharsets.UTF_8)), lIIIIIllIIl[16]), "DES");
            Cipher var10 = Cipher.getInstance("DES");
            var10.init(lIIIIIllIIl[9], var3);
    ...
    private static String llIlllIllllll(String var18, String var12) {
        try {
            SecretKeySpec var24 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var12.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var22 = Cipher.getInstance("Blowfish");
            var22.init(lIIIIIllIIl[9], var24);
    ...
    public void a(ChatMessage chatMessage) {
        ...
        if (AccBuilderTempleTrek.llIllllIIlIII(var23.getMessage().contains(lIIIIIllIII[lIIIIIllIIl[24]]) ? 1 : 0)) {
        ...
        if (AccBuilderTempleTrek.llIllllIIlIII(var23.getMessage().contains(lIIIIIllIII[lIIIIIllIIl[28]]) ? 1 : 0) && AccBuilderTempleTrek.llIllllIIlIll(Players.getLocal().getWorldLocation().distanceTo(N.ig), lIIIIIllIIl[21])) {
            e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.e_Unknown.v();
        }
        if (AccBuilderTempleTrek.llIllllIIlIII(var23.getMessage().contains(lIIIIIllIII[lIIIIIllIIl[29]]) ? 1 : 0) && (!AccBuilderTempleTrek.llIllllIIlIlI(Players.getLocal().getWorldLocation().distanceTo(H.ht), lIIIIIllIIl[15]) || AccBuilderTempleTrek.llIllllIIlIll(Players.getLocal().getWorldLocation().distanceTo(E.gY), lIIIIIllIIl[21]))) {
        ...
        if (AccBuilderTempleTrek.llIllllIIlIII(var23.getMessage().contains(lIIIIIllIII[lIIIIIllIIl[35]]) ? 1 : 0)) {
            Movement.walkTo((WorldPoint)new WorldPoint(lIIIIIllIIl[36], lIIIIIllIIl[37], lIIIIIllIIl[4]));
            0;
            Time.sleepTicks((int)lIIIIIllIIl[5]);
            0;
        }
        if (AccBuilderTempleTrek.llIllllIIlIII(var23.getMessage().contains(lIIIIIllIII[lIIIIIllIIl[38]]) ? 1 : 0)) {
            int[] nArray = new int[lIIIIIllIIl[5]];
    ...
    protected int loop() {
        block10: {
            block11: {
                ...
                while (AccBuilderTempleTrek.llIllllIIlIII(e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.e_Unknown.x() ? 1 : 0) && AccBuilderTempleTrek.llIllllIIIlIl(d ? 1 : 0) && AccBuilderTempleTrek.llIllllIIlIIl(e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.e_Unknown.j(lIIIIIllIIl[7]), lIIIIIllIIl[8]) && AccBuilderTempleTrek.llIllllIIIlIl(Dialog.isOpen() ? 1 : 0)) {
                    c = lIIIIIllIII[lIIIIIllIIl[9]];
                    e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.e_Unknown.y();
                    Time.sleepTicks((int)lIIIIIllIIl[5]);
                    0;
                    0;
                    if (1 < 2) continue;
    ...
    private static String llIllllIIIIIl(String var7, String var20) {
        var7 = new String(Base64.getDecoder().decode(var7.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var5 = new StringBuilder();
        char[] var19 = var20.toCharArray();
        int var2 = lIIIIIllIIl[4];
        char[] var21 = var7.toCharArray();
        int var13 = var21.length;
        int var16 = lIIIIIllIIl[4];
        while (AccBuilderTempleTrek.llIllllIlIIII(var16, var13)) {
            char var1 = var21[var16];
            var5.append((char)(var1 ^ var19[var2 % var19.length]));
            0;
            ++var2;
            ++var16;
            0;
