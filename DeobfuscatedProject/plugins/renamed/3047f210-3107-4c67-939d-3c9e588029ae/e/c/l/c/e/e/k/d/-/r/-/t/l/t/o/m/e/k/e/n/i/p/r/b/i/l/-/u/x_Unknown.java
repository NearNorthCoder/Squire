...
import e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.C_Unknown;
...
implements S {
    ...
    private static boolean aa() {
        ...
        int[] nArray2 = nArray;
        int var18 = llllIIlIlI[4];
        while (x.llIIllIlIlIII(var18, ((void)var9).length)) {
            int[] nArray3 = new int[llllIIlIlI[5]];
            nArray3[x.llllIIlIlI[4]] = var9[var18];
    ...
    private static String llIIllIlIIIII(String var13, String var11) {
        try {
            SecretKeySpec var16 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var11.getBytes(StandardCharsets.UTF_8)), llllIIlIlI[13]), "DES");
            Cipher var19 = Cipher.getInstance("DES");
            var19.init(llllIIlIlI[6], var16);
    ...
    private static String llIIllIlIIIIl(String var6, String var2) {
        try {
        ...
        block12: {
            ...
            block11: {
                ...
                if (x.llIIllIlIlIIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
                    var21 = new d(llllIIlIlI[24], llllIIlIlI[5], llllIIlIlI[88]);
                    bu.add((d)var21);
                    0;
                }
                int[] nArray3 = new int[llllIIlIlI[5]];
                ...
                if (x.llIIllIlIlIIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
                    var21 = new d(llllIIlIlI[16], llllIIlIlI[5], llllIIlIlI[88]);
                    bu.add((d)var21);
                    0;
                }
                int[] nArray4 = new int[llllIIlIlI[5]];
                ...
                if (x.llIIllIlIlIIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
                    var21 = new d(llllIIlIlI[20], llllIIlIlI[5], llllIIlIlI[89]);
                    bu.add((d)var21);
                    0;
                }
                int[] nArray5 = new int[llllIIlIlI[5]];
                ...
                if (x.llIIllIlIlIIl(Bank.contains((int[])nArray5) ? 1 : 0)) {
                    var21 = new d(llllIIlIlI[17], llllIIlIlI[5], llllIIlIlI[89]);
                    bu.add((d)var21);
                    0;
                }
                int[] nArray6 = new int[llllIIlIlI[5]];
                ...
                if (x.llIIllIlIlIIl(Bank.contains((int[])nArray6) ? 1 : 0)) {
                    var21 = new d(llllIIlIlI[22], llllIIlIlI[25], llllIIlIlI[90]);
                    bu.add((d)var21);
                    0;
                }
                if (x.llIIllIlIlIIl(Bank.contains((Predicate)(var21 = item -> item.getName().toLowerCase().contains(llllIIlIIl[llllIIlIlI[95]]))) ? 1 : 0)) {
                    var1 = new d(llllIIlIlI[91], llllIIlIlI[19], llllIIlIlI[92]);
                    bu.add(var1);
                    0;
                }
                int[] nArray7 = new int[llllIIlIlI[5]];
                ...
                if (x.llIIllIlIlIIl(Bank.contains((int[])nArray7) ? 1 : 0)) {
                    var1 = new d(llllIIlIlI[15], llllIIlIlI[12], i.bp);
                    bu.add(var1);
                    0;
                }
                int[] nArray8 = new int[llllIIlIlI[5]];
            ...
            var1 = new d(llllIIlIlI[14], llllIIlIlI[50], llllIIlIlI[93]);
            bu.add(var1);
            0;
        }
    }

    private static String llIIllIlIIIlI(String var20, String var17) {
        ...
        int var12 = llllIIlIlI[4];
        char[] var22 = var20.toCharArray();
        int var4 = var22.length;
        int var7 = llllIIlIlI[4];
        while (x.llIIllIlIlIII(var7, var4)) {
            char var23 = var22[var7];
            var24.append((char)(var23 ^ var10[var12 % var10.length]));
            0;
            ++var12;
            ++var7;
            0;
