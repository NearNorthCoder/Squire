...
implements S {
    ...
    private static String llIllIlllllII(String var12, String var16) {
        try {
    ...
    private static String llIllIllllIll(String var21, String var18) {
        try {
            SecretKeySpec var24 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var18.getBytes(StandardCharsets.UTF_8)), lIIIIIIllII[18]), "DES");
            Cipher var25 = Cipher.getInstance("DES");
            var25.init(lIIIIIIllII[3], var24);
    ...
    private static void ae() {
        ...
        if (aa.llIlllIIIIIIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var14 = new d(lIIIIIIllII[0], aa.eB(), lIIIIIIllII[63]);
            bu.add((d)var14);
            0;
        }
        ...
        if (aa.llIlllIIIIIIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var14 = new d(lIIIIIIllII[7], lIIIIIIllII[3], lIIIIIIllII[5]);
            bu.add((d)var14);
            0;
        }
        if (aa.llIlllIIIIIIl(Bank.contains((Predicate)(var14 = item -> item.getName().toLowerCase().contains(lIIIIIIlIll[lIIIIIIllII[77]]))) ? 1 : 0)) {
            var2 = new d(lIIIIIIllII[64], lIIIIIIllII[13], lIIIIIIllII[65]);
            bu.add(var2);
            0;
        }
        ...
        if (aa.llIlllIIIIIIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var2 = new d(lIIIIIIllII[66], lIIIIIIllII[67], lIIIIIIllII[68]);
            bu.add(var2);
            0;
        }
    }
        ...
        block44: {
            ...
            block45: {
                ...
                if (aa.llIlllIIIIIIl(aa.aa() ? 1 : 0) && aa.llIlllIIIIIII(Game.getWildyLevel(), lIIIIIIllII[2])) {
                    ...
                    if (aa.llIlllIIIIIlI(var7) && aa.llIlllIIIIIIl(var7.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        AccBuilderTempleTrek.c = lIIIIIIlIll[lIIIIIIllII[3]];
                        a.a((BankLocation)var7);
                    }
                    if (aa.llIlllIIIIIlI(var7) && aa.llIllIlllllll(var7.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (aa.llIlllIIIIIll(Game.getWildyLevel())) {
                        ...
                        if (aa.llIllIlllllll(Inventory.contains((int[])nArray) ? 1 : 0)) {
                            ...
                            if (aa.llIlllIIIIllI(Players.getLocal().getWorldLocation().distanceTo(ju), lIIIIIIllII[20])) {
                                ...
                                var19 = TileObjects.getNearest((String[])stringArray2);
                                String[] stringArray3 = new String[lIIIIIIllII[2]];
                                stringArray3[aa.lIIIIIIllII[1]] = lIIIIIIlIll[lIIIIIIllII[46]];
                                if (aa.llIllIlllllll(var19.hasAction(stringArray3) ? 1 : 0)) {
                                    var19.interact(lIIIIIIlIll[lIIIIIIllII[47]]);
                                }
                                if (aa.llIlllIIIIIlI(var7)) {
                                    String[] stringArray4 = new String[lIIIIIIllII[2]];
                                    stringArray4[aa.lIIIIIIllII[1]] = lIIIIIIlIll[lIIIIIIllII[48]];
                                    if (aa.llIlllIIIIIIl(var19.hasAction(stringArray4) ? 1 : 0)) {
                                        int var23 = Skills.getExperience((Skill)Skill.PRAYER);
                                        int[] nArray3 = new int[lIIIIIIllII[2]];
                        ...
                        if (aa.llIlllIIIIIIl(Inventory.contains((int[])nArray4) ? 1 : 0)) {
                            ...
                            if (aa.llIllIlllllll(Inventory.contains((int[])nArray5) ? 1 : 0)) {
                                ...
                                if (aa.llIlllIIIIllI(Players.getLocal().getWorldLocation().distanceTo(ju), lIIIIIIllII[20])) {
                                    ...
                                    var19 = TileObjects.getNearest((String[])stringArray6);
                                    String[] stringArray7 = new String[lIIIIIIllII[2]];
                                    stringArray7[aa.lIIIIIIllII[1]] = lIIIIIIlIll[lIIIIIIllII[54]];
                                    if (aa.llIllIlllllll(var19.hasAction(stringArray7) ? 1 : 0)) {
                                        var19.interact(lIIIIIIlIll[lIIIIIIllII[55]]);
                                    }
                                    if (aa.llIlllIIIIIlI(var7)) {
                                        String[] stringArray8 = new String[lIIIIIIllII[2]];
                                        stringArray8[aa.lIIIIIIllII[1]] = lIIIIIIlIll[lIIIIIIllII[56]];
                                        if (aa.llIlllIIIIIIl(var19.hasAction(stringArray8) ? 1 : 0)) {
                                            List var23;
                                            if (aa.llIlllIIIIIIl(Dialog.isOpen() ? 1 : 0)) {
                                                int[] nArray6 = new int[lIIIIIIllII[2]];
                                                nArray6[aa.lIIIIIIllII[1]] = lIIIIIIllII[50];
                                                Inventory.getFirst((int[])nArray6).useOn((Actor)var7);
                                                Time.sleepTicks((int)lIIIIIIllII[3]);
                                                0;
                                            }
                                            if (aa.llIllIlllllll(Dialog.isOpen() ? 1 : 0) && aa.llIlllIIIIIIl((var23 = Dialog.getOptions()).isEmpty() ? 1 : 0)) {
                                                int var6 = lIIIIIIllII[1];
                                                while (aa.llIlllIIIIIII(var6, var23.size())) {
                                                    int[] nArray7 = new int[lIIIIIIllII[2]];
                                                    nArray7[aa.lIIIIIIllII[1]] = lIIIIIIllII[50];
                                                    if (aa.llIlllIIIIlIl(((Item)Inventory.getAll((int[])nArray7).get(lIIIIIIllII[1])).getQuantity(), lIIIIIIllII[2]) && aa.llIllIlllllll(((Widget)var23.get(var6)).getText().contains(lIIIIIIlIll[lIIIIIIllII[57]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)var23.get(var6)).getClickPoint().getX(), (int)((Widget)var23.get(var6)).getClickPoint().getY(), (boolean)lIIIIIIllII[2]);
                                                        Time.sleepTicks((int)lIIIIIIllII[3]);
                                                        0;
                                                    }
                                                    int[] nArray8 = new int[lIIIIIIllII[2]];
                                                    nArray8[aa.lIIIIIIllII[1]] = lIIIIIIllII[50];
                                                    if (aa.llIlllIIIIlIl(((Item)Inventory.getAll((int[])nArray8).get(lIIIIIIllII[1])).getQuantity(), lIIIIIIllII[13]) && aa.llIllIlllllll(((Widget)var23.get(var6)).getText().contains(lIIIIIIlIll[lIIIIIIllII[58]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)var23.get(var6)).getClickPoint().getX(), (int)((Widget)var23.get(var6)).getClickPoint().getY(), (boolean)lIIIIIIllII[2]);
                                                        Time.sleepTicks((int)lIIIIIIllII[3]);
                                                        0;
                                                    }
                                                    if (aa.llIllIlllllll(((Widget)var23.get(var6)).getText().contains(lIIIIIIlIll[lIIIIIIllII[59]]) ? 1 : 0)) {
                                                        Mouse.click((int)((Widget)var23.get(var6)).getClickPoint().getX(), (int)((Widget)var23.get(var6)).getClickPoint().getY(), (boolean)lIIIIIIllII[2]);
                                                        Time.sleepTicks((int)lIIIIIIllII[3]);
                                                        0;
                                                    }
            ...
            if (aa.llIlllIIIIllI(Players.getLocal().getWorldLocation().distanceTo(ju), lIIIIIIllII[20])) {
                ...
                var7 = TileItems.getNearest((String[])stringArray);
                if (aa.llIlllIIIIIlI(var7)) {
                    var7.interact(lIIIIIIlIll[lIIIIIIllII[62]]);
                }
            }
        }
    }

    private static String llIllIllllIlI(String var5, String var1) {
        var5 = new String(Base64.getDecoder().decode(var5.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var22 = new StringBuilder();
        char[] var8 = var1.toCharArray();
        int var17 = lIIIIIIllII[1];
        char[] var10 = var5.toCharArray();
        int var3 = var10.length;
        int var15 = lIIIIIIllII[1];
        while (aa.llIlllIIIIIII(var15, var3)) {
            char var20 = var10[var15];
            var22.append((char)(var20 ^ var8[var17 % var8.length]));
            0;
            ++var17;
            ++var15;
            0;
