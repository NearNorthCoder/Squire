...
import e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.v_Unknown;
...
implements S {
    ...
    private static String llIlIIlllllIl(String var2, String var17) {
        ...
        int var9 = lllllIlIll[1];
        char[] var15 = var2.toCharArray();
        int var24 = var15.length;
        int var16 = lllllIlIll[1];
        while (u.llIlIlIIlIlIl(var16, var24)) {
            char var21 = var15[var16];
            var20.append((char)(var21 ^ var13[var9 % var13.length]));
            0;
            ++var9;
            ++var16;
            0;
    ...
    private static boolean aa() {
        ...
        int[] nArray2 = nArray;
        int var28 = lllllIlIll[1];
        while (u.llIlIlIIlIlIl(var28, ((void)var8).length)) {
            int[] nArray3 = new int[lllllIlIll[0]];
            nArray3[u.lllllIlIll[1]] = var8[var28];
    ...
    private static String llIlIIlllllll(String var25, String var18) {
        try {
    ...
    private static String llIlIIllllllI(String var1, String var5) {
        try {
            SecretKeySpec var19 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var5.getBytes(StandardCharsets.UTF_8)), lllllIlIll[19]), "DES");
            Cipher var26 = Cipher.getInstance("DES");
            var26.init(lllllIlIll[3], var19);
            return new String(var26.doFinal(Base64.getDecoder().decode(var1.getBytes(StandardCharsets.UTF_8))), StandardCharsets.UTF_8);
        }
    ...
    private static void bu() {
        if (u.llIlIlIIlllIl(Players.getLocal().getWorldLocation().distanceTo(dv), lllllIlIll[3])) {
            ...
            if (u.llIlIlIIlIllI(var11.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (u.llIlIlIIlIlII(v.eW.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && u.llIlIlIIlIllI(var10.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && u.llIlIlIIlIllI(var22.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && u.llIlIlIIlIllI(dG.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && u.llIlIlIIlIllI(dH.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                Walker.stepAlong(List.of(v.eb));
                0;
                Time.sleepTicks((int)lllllIlIll[0]);
                0;
            }
            if (!u.llIlIlIIlIllI(var10.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || u.llIlIlIIlIlII(var22.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
        ...
        block82: {
            ...
            if (u.llIlIlIIlllII(e.j(dF), lllllIlIll[6])) {
                ...
                if (u.llIlIlIIlllII(Vars.getBit((int)lllllIlIll[26]), lllllIlIll[0]) && u.llIlIlIIlllII(Vars.getBit((int)lllllIlIll[34]), lllllIlIll[0]) && u.llIlIlIIlllII(Vars.getBit((int)lllllIlIll[37]), lllllIlIll[0])) {
                    ...
                    if (u.llIlIlIIllllI(Players.getLocal().getWorldLocation().distanceTo(dB), lllllIlIll[3])) {
                        ...
                        var3 = Dialog.getOptions();
                        if (u.llIlIlIIlIllI(var3.isEmpty() ? 1 : 0)) {
            ...
            if (u.llIlIlIIlllII(e.j(dF), lllllIlIll[15])) {
                ...
                if (u.llIlIlIIlIllI(Players.getLocal().getWorldLocation().getPlane())) {
                    var3 = new WorldArea(lllllIlIll[51], lllllIlIll[50], lllllIlIll[28], lllllIlIll[12], lllllIlIll[1]);
                    WorldArea var29 = new WorldArea(lllllIlIll[51], lllllIlIll[52], lllllIlIll[6], lllllIlIll[15], lllllIlIll[1]);
                    WorldArea var6 = new WorldArea(lllllIlIll[53], lllllIlIll[54], lllllIlIll[6], lllllIlIll[3], lllllIlIll[1]);
                    WorldArea var27 = new WorldArea(lllllIlIll[53], lllllIlIll[52], lllllIlIll[5], lllllIlIll[5], lllllIlIll[1]);
                    if (u.llIlIlIIlllIl(Players.getLocal().getWorldLocation().distanceTo(dC), lllllIlIll[3]) && u.llIlIlIIlIllI(var3.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && u.llIlIlIIlIllI(var29.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && u.llIlIlIIlIllI(var6.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && u.llIlIlIIlIllI(var27.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (u.llIlIlIIlIlII(lllllllllllllllllIlIIlIIlllIllIl2.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        ...
                        if (!u.llIlIlIIlIllI(var3.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !u.llIlIlIIlIllI(var29.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || !u.llIlIlIIlIllI(var6.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) || u.llIlIlIIlIlII(var27.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            String[] stringArray = new String[lllllIlIll[0]];
            ...
            if (u.llIlIlIIlllII(e.j(dF), lllllIlIll[16])) {
                ...
                if (u.llIlIlIIllllI(Players.getLocal().getWorldLocation().distanceTo(dE), lllllIlIll[25])) {
                    ...
                    if (u.llIlIlIIllIII(lllllllllllllllllIlIIlIIlllIllIl2) && u.llIlIlIIlllll(var3)) {
    ...
    private static void ae() {
        block33: {
                ...
                block31: {
                    block30: {
                        block29: {
                            block28: {
                                block27: {
                                        ...
                                        block25: {
                                            block24: {
                                                ...
                                                block23: {
                                                    ...
                                                    var23 = new d(lllllIlIll[11], lllllIlIll[12], lllllIlIll[103]);
                                                    bu.add((d)var23);
                                                    0;
                                                }
                                                if (u.llIlIlIIlIllI(Bank.contains((Predicate)(var23 = item -> item.getName().toLowerCase().contains(lllllIlIII[lllllIlIll[110]]))) ? 1 : 0)) {
                                                    var14 = new d(lllllIlIll[104], lllllIlIll[15], lllllIlIll[105]);
                                                    bu.add(var14);
                                                    0;
                                                }
                                                int[] nArray = new int[lllllIlIll[0]];
                                                ...
                                                if (u.llIlIlIIlIlII(Bank.contains((int[])nArray) ? 1 : 0)) {
                                                    ...
                                                    if (u.llIlIlIIlIlIl(Bank.getFirst((int[])nArray4).getQuantity(), lllllIlIll[6])) {
                                                        ...
                                                        var14 = new d(lllllIlIll[14], lllllIlIll[6] - Bank.getFirst((int[])nArray5).getQuantity(), lllllIlIll[106]);
                                                        bu.add(var14);
                                                        0;
                                                    }
                                                }
                                            ...
                                            var14 = new d(lllllIlIll[9], lllllIlIll[8], lllllIlIll[20]);
                                            bu.add(var14);
                                            0;
                                        }
                                        int[] nArray = new int[lllllIlIll[0]];
                                    ...
                                    var14 = new d(lllllIlIll[7], lllllIlIll[8], lllllIlIll[20]);
                                    bu.add(var14);
                                    0;
                                }
                                int[] nArray = new int[lllllIlIll[0]];
                            ...
                            var14 = new d(lllllIlIll[10], lllllIlIll[8], lllllIlIll[20]);
                            bu.add(var14);
                            0;
                        }
                        int[] nArray = new int[lllllIlIll[0]];
                        ...
                        if (u.llIlIlIIlIllI(Bank.contains((int[])nArray) ? 1 : 0)) {
                            var14 = new d(lllllIlIll[14], lllllIlIll[6], lllllIlIll[106]);
                            bu.add(var14);
                            0;
                        }
                    ...
                    var14 = new d(lllllIlIll[17], lllllIlIll[6], i.bp);
                    bu.add(var14);
                    0;
                }
                int[] nArray = new int[lllllIlIll[0]];
            ...
            var14 = new d(lllllIlIll[13], lllllIlIll[66], lllllIlIll[107]);
            bu.add(var14);
            0;
        }
    }
