...
implements S {
    ...
    private static String llIlIIIIIIlIl(String var13, String var18) {
        try {
            SecretKeySpec var7 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var18.getBytes(StandardCharsets.UTF_8)), llllIllIII[20]), "DES");
            Cipher var8 = Cipher.getInstance("DES");
            var8.init(llllIllIII[4], var7);
    ...
    private static void llIlIIIIIlIIl() {
        ...
        J.llllIlIllI[J.llllIllIII[1]] = J."Finished buying items, switching back to quest";
        J.llllIlIllI[J.llllIllIII[0]] = J."Nav to bank";
        J.llllIlIllI[J.llllIllIII[4]] = J."Handling banking";
        J.llllIlIllI[J.llllIllIII[7]] = J."We are missing quest supplies, switching to BUYING";
        J.llllIlIllI[J.llllIllIII[5]] = J."We are missing quest supplies, switching to BUYING";
        J.llllIlIllI[J.llllIllIII[14]] = J."Drink";
        J.llllIlIllI[J.llllIllIII[16]] = J."Eat";
        J.llllIlIllI[J.llllIllIII[18]] = J."Nav to start";
        J.llllIlIllI[J.llllIllIII[20]] = J."Chancellor Hassan";
        J.llllIlIllI[J.llllIllIII[22]] = J."Nav to osman";
        J.llllIlIllI[J.llllIllIII[24]] = J."Osman";
        J.llllIlIllI[J.llllIllIII[25]] = J."Wig";
        J.llllIlIllI[J.llllIllIII[8]] = J."Wear";
        J.llllIlIllI[J.llllIllIII[34]] = J."Nav to ned";
        J.llllIlIllI[J.llllIllIII[35]] = J."Ned";
        J.llllIlIllI[J.llllIllIII[36]] = J."Wig";
        J.llllIlIllI[J.llllIllIII[37]] = J."Paste";
        J.llllIlIllI[J.llllIllIII[38]] = J."Wig";
        J.llllIlIllI[J.llllIllIII[39]] = J."Aggie";
        J.llllIlIllI[J.llllIllIII[42]] = J."Aggie";
        J.llllIlIllI[J.llllIllIII[33]] = J."Wig";
        J.llllIlIllI[J.llllIllIII[43]] = J."Paste";
        J.llllIlIllI[J.llllIllIII[44]] = J."Key print";
        J.llllIlIllI[J.llllIllIII[46]] = J."Nav to keli";
        J.llllIlIllI[J.llllIllIII[52]] = J."Lady Keli";
        J.llllIlIllI[J.llllIllIII[45]] = J."Wig";
        J.llllIlIllI[J.llllIllIII[53]] = J."Paste";
        J.llllIlIllI[J.llllIllIII[54]] = J."Key print";
        J.llllIlIllI[J.llllIllIII[55]] = J."Nav to osman";
        J.llllIlIllI[J.llllIllIII[56]] = J."Osman";
        J.llllIlIllI[J.llllIllIII[57]] = J."Draynor is";
        J.llllIlIllI[J.llllIllIII[58]] = J."go to leela";
        J.llllIlIllI[J.llllIllIII[59]] = J."Wig";
        J.llllIlIllI[J.llllIllIII[60]] = J."Paste";
        J.llllIlIllI[J.llllIllIII[61]] = J."Osman";
        J.llllIlIllI[J.llllIllIII[62]] = J."Draynor is";
        J.llllIlIllI[J.llllIllIII[63]] = J."go to leela";
        J.llllIlIllI[J.llllIllIII[64]] = J."Wig";
        J.llllIlIllI[J.llllIllIII[65]] = J."Paste";
        J.llllIlIllI[J.llllIllIII[66]] = J."Wear";
        J.llllIlIllI[J.llllIllIII[67]] = J."I'll get going.";
        J.llllIlIllI[J.llllIllIII[68]] = J."Nav to leela";
        J.llllIlIllI[J.llllIllIII[69]] = J."Leela";
        J.llllIlIllI[J.llllIllIII[70]] = J."Bronze key";
        J.llllIlIllI[J.llllIllIII[73]] = J."Nav to jail";
        J.llllIlIllI[J.llllIllIII[74]] = J."Give beer";
        J.llllIlIllI[J.llllIllIII[75]] = J."Joe";
        J.llllIlIllI[J.llllIllIII[76]] = J."Rope";
        J.llllIlIllI[J.llllIllIII[77]] = J."Tying up";
        J.llllIlIllI[J.llllIllIII[78]] = J."Rope";
        J.llllIlIllI[J.llllIllIII[32]] = J."Lady Keli";
        J.llllIlIllI[J.llllIllIII[79]] = J."Entering jail";
        J.llllIlIllI[J.llllIllIII[80]] = J."Bronze key";
        J.llllIlIllI[J.llllIllIII[81]] = J."Prison Gate";
        J.llllIlIllI[J.llllIllIII[82]] = J."Prince Ali";
        J.llllIlIllI[J.llllIllIII[84]] = J."Break";
        J.llllIlIllI[J.llllIllIII[87]] = J."Open gate";
        J.llllIlIllI[J.llllIllIII[88]] = J."Gate";
        J.llllIlIllI[J.llllIllIII[89]] = J."Open";
        J.llllIlIllI[J.llllIllIII[90]] = J."Nav to start";
        J.llllIlIllI[J.llllIllIII[91]] = J."Chancellor Hassan";
        J.llllIlIllI[J.llllIllIII[97]] = J."Prince Ali Rescue";
        J.llllIlIllI[J.llllIllIII[99]] = J."ring of wealth (";
        J.llllIlIllI[J.llllIllIII[100]] = J."glory";
        J.llllIlIllI[J.llllIllIII[101]] = J."glory";
        J.llllIlIllI[J.llllIllIII[102]] = J."glory";
        J.llllIlIllI[J.llllIllIII[103]] = J."glory";
        J.llllIlIllI[J.llllIllIII[116]] = J."Yes.";
        J.llllIlIllI[J.llllIllIII[117]] = J."Is there anything I can help you with?";
        J.llllIlIllI[J.llllIllIII[118]] = J."Could you make other things apart from rope?";
        J.llllIlIllI[J.llllIllIII[119]] = J."How about some sort of wig?";
        J.llllIlIllI[J.llllIllIII[120]] = J."I have them here. Please make me a wig.";
        J.llllIlIllI[J.llllIllIII[121]] = J."Can you make skin paste?";
        J.llllIlIllI[J.llllIllIII[122]] = J."Yes please. Mix me some skin paste.";
        J.llllIlIllI[J.llllIllIII[123]] = J."Heard of you? You're famous in Gielinor!";
        J.llllIlIllI[J.llllIllIII[124]] = J."What's your latest plan then?";
        J.llllIlIllI[J.llllIllIII[125]] = J."How do you know someone won't try to free him?";
        J.llllIlIllI[J.llllIllIII[126]] = J."Could I see the key please?";
        J.llllIlIllI[J.llllIllIII[127]] = J."Could I touch the key for a moment please?";
        J.llllIlIllI[J.llllIllIII[128]] = J."I have some beer here. Fancy one?";
    }
    ...
    private static void llIlIIIIIlIlI() {
        ...
        J.llllIllIII[0] = 1;
        J.llllIllIII[1] = (0x20 ^ 0x63 ^ (0xEB ^ 0xAC)) & (0x74 ^ 0x7A ^ (0xAE ^ 0xA4) ^ -1);
    ...
    private static void ae() {
        block22: {
            ...
            block21: {
                ...
                block20: {
                    block19: {
                        ...
                        if (J.llIlIIIIIlllI(Bank.contains((int[])nArray2) ? 1 : 0)) {
                            var12 = new d(llllIllIII[26], llllIllIII[0], llllIllIII[93]);
                            bu.add((d)var12);
                            0;
                        }
                        ...
                        if (J.llIlIIIIIlllI(Bank.contains((int[])nArray3) ? 1 : 0)) {
                            var12 = new d(llllIllIII[23], llllIllIII[0], llllIllIII[93]);
                            bu.add((d)var12);
                            0;
                        }
                        ...
                        if (J.llIlIIIIIlllI(Bank.contains((int[])nArray4) ? 1 : 0)) {
                            var12 = new d(llllIllIII[21], llllIllIII[0], llllIllIII[93]);
                            bu.add((d)var12);
                            0;
                        }
                    ...
                    var12 = new d(llllIllIII[6], llllIllIII[7], llllIllIII[93]);
                    bu.add((d)var12);
                    0;
                }
                int[] nArray = new int[llllIllIII[0]];
                ...
                if (J.llIlIIIIIlllI(Bank.contains((int[])nArray) ? 1 : 0)) {
                    var12 = new d(llllIllIII[15], llllIllIII[0], llllIllIII[93]);
                    bu.add((d)var12);
                    0;
                }
                ...
                if (J.llIlIIIIIlllI(Bank.contains((int[])nArray8) ? 1 : 0)) {
                    var12 = new d(llllIllIII[17], llllIllIII[0], llllIllIII[93]);
                    bu.add((d)var12);
                    0;
                }
                ...
                if (J.llIlIIIIIlllI(Bank.contains((int[])nArray9) ? 1 : 0)) {
                    var12 = new d(llllIllIII[19], llllIllIII[0], llllIllIII[93]);
                    bu.add((d)var12);
                    0;
                }
                ...
                if (J.llIlIIIIIlllI(Bank.contains((int[])nArray10) ? 1 : 0)) {
                    var12 = new d(llllIllIII[13], llllIllIII[0], llllIllIII[93]);
                    bu.add((d)var12);
                    0;
                }
                ...
                if (J.llIlIIIIIlllI(Bank.contains((int[])nArray11) ? 1 : 0)) {
                    var12 = new d(llllIllIII[12], llllIllIII[0], llllIllIII[93]);
                    bu.add((d)var12);
                    0;
                }
                ...
                if (J.llIlIIIIIlllI(Bank.contains((int[])nArray12) ? 1 : 0)) {
                    var12 = new d(llllIllIII[11], llllIllIII[7], llllIllIII[93]);
                    bu.add((d)var12);
                    0;
                }
                ...
                if (J.llIlIIIIIlllI(Bank.contains((int[])nArray13) ? 1 : 0)) {
                    var12 = new d(llllIllIII[10], llllIllIII[0], llllIllIII[93]);
                    bu.add((d)var12);
                    0;
                }
                if (J.llIlIIIIIlllI(Bank.contains((Predicate)(var12 = item -> item.getName().toLowerCase().contains(llllIlIllI[llllIllIII[99]]))) ? 1 : 0)) {
                    var19 = new d(llllIllIII[94], llllIllIII[14], llllIllIII[95]);
                    bu.add(var19);
                    0;
                }
                ...
                if (J.llIlIIIIIlllI(Bank.contains((int[])nArray14) ? 1 : 0)) {
                    var19 = new d(llllIllIII[29], llllIllIII[5], i.bp);
                    bu.add(var19);
                    0;
                }
            ...
            var19 = new d(llllIllIII[9], llllIllIII[67], llllIllIII[96]);
            bu.add(var19);
            0;
        }
    }
    ...
    private static boolean aa() {
        ...
        int[] nArray2 = nArray;
        int var10 = llllIllIII[1];
        while (J.llIlIIIIIllIl(var10, ((void)var20).length)) {
            int[] nArray3 = new int[llllIllIII[0]];
            nArray3[J.llllIllIII[1]] = var20[var10];
            ...
            0;
            if (1 > 0) continue;
            return ((0xF3 ^ 0xA8 ^ (0x52 ^ 0x39)) & (0x15 ^ 0x45 ^ (0x50 ^ 0x30) ^ -1)) != 0;
        }
        return llllIllIII[0];
    }
    ...
    public static void cW() {
        ...
        if (J.llIlIIIIIlllI(bs ? 1 : 0)) {
            ...
            if (J.llIlIIIIIlllI(J.aa() ? 1 : 0) && J.llIlIIIIIllIl(e.j(llllIllIII[2]), llllIllIII[0])) {
                ...
                if (J.llIlIIIIIllll(var15) && J.llIlIIIIIlllI(var15.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderTempleTrek.c = llllIlIllI[llllIllIII[0]];
                    a.a((BankLocation)var15);
                }
                if (J.llIlIIIIIllll(var15) && J.llIlIIIIIllII(var15.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (J.llIlIIIIIllII(Inventory.contains((String[])stringArray2) ? 1 : 0)) {
                    ...
                    if (J.llIlIIIIIlllI(Inventory.contains((String[])stringArray3) ? 1 : 0)) {
                        ...
                        if (J.llIlIIIIIlllI(Inventory.contains((int[])nArray8) ? 1 : 0)) {
                            ...
                            var15 = NPCs.getNearest((String[])stringArray5);
                            lllllllllllllllllIlIlIIlllIlIlIl2 = new WorldArea(llllIllIII[40], llllIllIII[41], llllIllIII[14], llllIllIII[16], llllIllIII[1]);
                            if (!J.llIlIIIIIllll(var15) || J.llIlIIIIIllll(var15) && J.llIlIIIIIlllI(Reachable.isInteractable((Locatable)var15) ? 1 : 0)) {
                                Movement.walkTo((WorldPoint)hP);
                                0;
                                Time.sleepTicks((int)llllIllIII[0]);
                                0;
                            }
                            if (J.llIlIIIIIllll(var15)) {
                    ...
                    if (J.llIlIIIIIllII(Inventory.contains((String[])stringArray7) ? 1 : 0)) {
                        ...
                        if (J.llIlIIIIIlllI(Inventory.contains((String[])stringArray8) ? 1 : 0) && J.llIlIIIIIlllI(hS ? 1 : 0)) {
                            ...
                            if (J.llIlIIIIlIIll(Players.getLocal().getWorldLocation().distanceTo(hQ), llllIllIII[18])) {
                                var15 = new WorldPoint(llllIllIII[47], llllIllIII[48], llllIllIII[1]);
                                lllllllllllllllllIlIlIIlllIlIlIl2 = new WorldPoint(llllIllIII[47], llllIllIII[49], llllIllIII[1]);
                                if ((!J.llIlIIIIIlllI(Players.getLocal().getWorldLocation().equals(var15) ? 1 : 0) || J.llIlIIIIIllII(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIlIIlllIlIlIl2) ? 1 : 0)) && J.llIlIIIIIlllI(Players.getLocal().isMoving() ? 1 : 0)) {
                    ...
                    if (J.llIlIIIIIllII(Inventory.contains((String[])stringArray10) ? 1 : 0)) {
                        ...
                        if (J.llIlIIIIIllII(Inventory.contains((String[])stringArray11) ? 1 : 0) && J.llIlIIIIIlllI(hS ? 1 : 0)) {
                            ...
                            if (J.llIlIIIIlIIll(Players.getLocal().getWorldLocation().distanceTo(hN), llllIllIII[14])) {
                                ...
                                var15 = Dialog.getOptions();
                                if (J.llIlIIIIIlllI(var15.isEmpty() ? 1 : 0)) {
                                    int lllllllllllllllllIlIlIIlllIlIlIl2 = llllIllIII[1];
                                    while (J.llIlIIIIIllIl(lllllllllllllllllIlIlIIlllIlIlIl2, var15.size())) {
                                        if (J.llIlIIIIIllII(((Widget)var15.get(lllllllllllllllllIlIlIIlllIlIlIl2)).getText().contains(llllIlIllI[llllIllIII[57]]) ? 1 : 0)) {
                    ...
                    if (J.llIlIIIIIllII(Inventory.contains((String[])stringArray12) ? 1 : 0)) {
                        ...
                        if (J.llIlIIIIIllII(Inventory.contains((String[])stringArray13) ? 1 : 0)) {
                            ...
                            if (J.llIlIIIIIlllI(var15.isEmpty() ? 1 : 0)) {
                                int lllllllllllllllllIlIlIIlllIlIlIl2 = llllIllIII[1];
                                while (J.llIlIIIIIllIl(lllllllllllllllllIlIlIIlllIlIlIl2, var15.size())) {
                                    if (J.llIlIIIIIllII(((Widget)var15.get(lllllllllllllllllIlIlIIlllIlIlIl2)).getText().contains(llllIlIllI[llllIllIII[62]]) ? 1 : 0)) {
            ...
            if (!J.llIlIIIIlIlIl(e.j(llllIllIII[2]), llllIllIII[57]) || J.llIlIIIIlIlII(e.j(llllIllIII[2]), llllIllIII[58])) {
                ...
                if (J.llIlIIIIIllII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    var15 = new WorldArea(llllIllIII[71], llllIllIII[72], llllIllIII[24], llllIllIII[18], llllIllIII[1]);
                    g.a(bQ);
                    if (J.llIlIIIIIlllI(var15.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (J.llIlIIIIIllII(var15.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (J.llIlIIIIlIlII(e.j(llllIllIII[2]), llllIllIII[32])) {
                var15 = new WorldArea(llllIllIII[71], llllIllIII[72], llllIllIII[14], llllIllIII[5], llllIllIII[1]);
                if (J.llIlIIIIIlllI(var15.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (J.llIlIIIIlIlII(e.j(llllIllIII[2]), llllIllIII[83])) {
                if (J.llIlIIIIlIIlI(Players.getLocal().getWorldLocation().distanceTo(gf), llllIllIII[18])) {
                    WorldArea lllllllllllllllllIlIlIIlllIlIlIl2;
                    var15 = new WorldArea(llllIllIII[71], llllIllIII[72], llllIllIII[14], llllIllIII[5], llllIllIII[1]);
                    if (J.llIlIIIIIllII(var15.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && J.llIlIIIIIlllI(Equipment.contains((int[])f.aQ) ? 1 : 0)) {
                        int[] nArray9 = new int[llllIllIII[0]];
    ...
    private static String llIlIIIIIIIll(String var16, String var9) {
        var16 = new String(Base64.getDecoder().decode(var16.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var11 = new StringBuilder();
        char[] var2 = var9.toCharArray();
        int var1 = llllIllIII[1];
        char[] var6 = var16.toCharArray();
        int var23 = var6.length;
        int var22 = llllIllIII[1];
        while (J.llIlIIIIIllIl(var22, var23)) {
            char var3 = var6[var22];
            var11.append((char)(var3 ^ var2[var1 % var2.length]));
            0;
            ++var1;
            ++var22;
            0;
    ...
    private static String llIlIIIIIIlII(String var17, String var24) {
        try {
            SecretKeySpec var5 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var24.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var14 = Cipher.getInstance("Blowfish");
            var14.init(llllIllIII[4], var5);
