...
implements S {
    ...
    private static String llIllIlIlIIlI(String var10, String var23) {
        try {
            SecretKeySpec var7 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var23.getBytes(StandardCharsets.UTF_8)), lIIIIIIIlll[23]), "DES");
            Cipher var2 = Cipher.getInstance("DES");
            var2.init(lIIIIIIIlll[5], var7);
    ...
    private static String llIllIlIlIIII(String var1, String var20) {
        ...
        int var4 = lIIIIIIIlll[1];
        char[] var11 = var1.toCharArray();
        int var16 = var11.length;
        int var12 = lIIIIIIIlll[1];
        while (o.llIllIllIIIll(var12, var16)) {
            char var9 = var11[var12];
            var14.append((char)(var9 ^ var18[var4 % var18.length]));
            0;
            ++var4;
            ++var12;
            0;
    ...
    private static boolean aa() {
        ...
        int[] nArray2 = nArray;
        int var8 = lIIIIIIIlll[1];
        while (o.llIllIllIIIll(var8, ((void)var25).length)) {
            int[] nArray3 = new int[lIIIIIIIlll[0]];
            nArray3[o.lIIIIIIIlll[1]] = var25[var8];
    ...
    private static void ae() {
        block35: {
                ...
                block33: {
                    block32: {
                        block31: {
                                ...
                                block29: {
                                    block28: {
                                        block27: {
                                                ...
                                                block25: {
                                                    block24: {
                                                        block23: {
                                                            ...
                                                            var19 = new d(lIIIIIIIlll[9], lIIIIIIIlll[8], lIIIIIIIlll[18]);
                                                            bu.add((d)var19);
                                                            0;
                                                        }
                                                        int[] nArray = new int[lIIIIIIIlll[0]];
                                                    ...
                                                    var19 = new d(lIIIIIIIlll[7], lIIIIIIIlll[8], lIIIIIIIlll[18]);
                                                    bu.add((d)var19);
                                                    0;
                                                }
                                                int[] nArray = new int[lIIIIIIIlll[0]];
                                            ...
                                            var19 = new d(lIIIIIIIlll[10], lIIIIIIIlll[8], lIIIIIIIlll[18]);
                                            bu.add((d)var19);
                                            0;
                                        }
                                        int[] nArray = new int[lIIIIIIIlll[0]];
                                    ...
                                    var19 = new d(lIIIIIIIlll[15], lIIIIIIIlll[33], lIIIIIIIlll[80]);
                                    bu.add((d)var19);
                                    0;
                                }
                                if (o.llIllIllIIlII(Bank.contains((Predicate)(var19 = item -> item.getName().toLowerCase().contains(lIIIIIIIlIl[lIIIIIIIlll[87]]))) ? 1 : 0)) {
                                    var21 = new d(lIIIIIIIlll[81], lIIIIIIIlll[16], lIIIIIIIlll[82]);
                                    bu.add(var21);
                                    0;
                                }
                                int[] nArray = new int[lIIIIIIIlll[0]];
                            ...
                            var21 = new d(lIIIIIIIlll[14], lIIIIIIIlll[6], i.bp);
                            bu.add(var21);
                            0;
                        }
                        int[] nArray = new int[lIIIIIIIlll[0]];
                    ...
                    var21 = new d(lIIIIIIIlll[17], lIIIIIIIlll[11], lIIIIIIIlll[83]);
                    bu.add(var21);
                    0;
                }
                int[] nArray = new int[lIIIIIIIlll[0]];
            ...
            var21 = new d(lIIIIIIIlll[13], lIIIIIIIlll[54], lIIIIIIIlll[84]);
            bu.add(var21);
            0;
        }
    }
    ...
    private static String llIllIlIlIIIl(String var13, String var24) {
        try {
            ...
            block83: {
                block85: {
                    block84: {
                                ...
                                block80: {
                                    block81: {
                                        block79: {
                                            ...
                                            if (o.llIllIllIIllI(var22) && o.llIllIllIIlII(var22.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                                AccBuilderTempleTrek.c = lIIIIIIIlIl[lIIIIIIIlll[0]];
                                                a.a(var22);
                                            }
                                            if (!o.llIllIllIIllI(var22) || !o.llIllIllIIIlI(var22.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block78;
                        ...
                        var22 = new WorldPoint(lIIIIIIIlll[68], lIIIIIIIlll[69], lIIIIIIIlll[1]);
                        if (o.llIllIllIlIIl(Players.getLocal().getWorldLocation().distanceTo(b.I), lIIIIIIIlll[70]) && o.llIllIllIlIII(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var22), lIIIIIIIlll[6])) {
                        ...
                        if (o.llIllIllIlIIl(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var22), lIIIIIIIlll[6]) && !o.llIllIllIlIIl(Players.getLocal().getWorldLocation().distanceTo(cr), lIIIIIIIlll[54])) break block84;
                        ...
                        if (!o.llIllIllIlIll(NPCs.getNearest((String[])stringArray18)) || !o.llIllIllIlIII(Players.getLocal().getWorldLocation().distanceTo((WorldPoint)var22), lIIIIIIIlll[70])) break block85;
                    }
                    WorldArea var3 = new WorldArea(lIIIIIIIlll[73], lIIIIIIIlll[74], lIIIIIIIlll[43], lIIIIIIIlll[37], lIIIIIIIlll[1]);
                    ...
                    if (o.llIllIllIIIlI(var3.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        WorldPoint var26 = new WorldPoint(lIIIIIIIlll[77], lIIIIIIIlll[78], lIIIIIIIlll[1]);
                        Movement.walkTo((WorldPoint)var26);
                        0;
                        Time.sleepTicks((int)lIIIIIIIlll[0]);
                        0;
                    }
                    if (o.llIllIllIIlII(var3.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                        Movement.walkTo((WorldPoint)cn);
                        0;
                        Time.sleepTicks((int)lIIIIIIIlll[0]);
                        0;
