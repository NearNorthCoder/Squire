...
implements S {
    ...
    private static String llIlIllIlIIll(String var20, String var9) {
        try {
            SecretKeySpec var3 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var9.getBytes(StandardCharsets.UTF_8)), llllllIlII[21]), "DES");
            Cipher var4 = Cipher.getInstance("DES");
            var4.init(llllllIlII[5], var3);
    ...
    private static String llIlIllIlIlII(String var11, String var2) {
        var11 = new String(Base64.getDecoder().decode(var11.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var8 = new StringBuilder();
        char[] var13 = var2.toCharArray();
        int var17 = llllllIlII[0];
        char[] var1 = var11.toCharArray();
        int var15 = var1.length;
        int var12 = llllllIlII[0];
        while (P.llIlIllIllIll(var12, var15)) {
            char var19 = var1[var12];
            var8.append((char)(var19 ^ var13[var17 % var13.length]));
            0;
            ++var17;
            ++var12;
            0;
    ...
    private static String llIlIllIlIlIl(String var10, String var21) {
        try {
                ...
                block48: {
                    block46: {
                        ...
                        if (P.llIlIllIllIll(e.j(llllllIlII[9]), llllllIlII[1])) {
                            ...
                            if (P.llIlIlllIIIII(var14) && P.llIlIllIlllII(var14.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                AccBuilderTempleTrek.c = llllllIIll[llllllIlII[10]];
                                a.a(var14);
                                Time.sleepTicks((int)llllllIlII[5]);
                                0;
                            }
                            if (P.llIlIlllIIIII(var14) && P.llIlIllIllIlI(var14.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (P.llIlIllIlllII(Inventory.contains((String[])stringArray) ? 1 : 0)) {
                    ...
                    if (P.llIlIllIllIlI(Inventory.contains((String[])stringArray3) ? 1 : 0)) {
                        ...
                        if (P.llIlIlllIIIlI(Players.getLocal().getWorldLocation().distanceTo(iE), llllllIlII[10])) {
                            ...
                            var14 = TileObjects.getNearest((String[])stringArray4);
                            var14.interact(llllllIIll[llllllIlII[37]]);
                            Time.sleepTicks((int)llllllIlII[7]);
                            0;
                        }
                        if (P.llIlIlllIIIlI(Players.getLocal().getWorldLocation().distanceTo(iF), llllllIlII[3])) {
                            ...
                            var14 = NPCs.getNearest((String[])stringArray7);
                            if (P.llIlIlllIIIII(var14)) {
                                ...
                                if (P.llIlIlllIIlII(Players.getLocal().getInteracting()) && P.llIlIllIlllII(var14.isDead() ? 1 : 0)) {
                                    var14.interact(llllllIIll[llllllIlII[45]]);
                                    Time.sleepTicks((int)llllllIlII[5]);
                                    0;
                                }
                            }
    ...
    private static void ae() {
        ...
        if (P.llIlIllIlllII(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var18 = new d(llllllIlII[15], llllllIlII[1], llllllIlII[50]);
            bu.add((d)var18);
            0;
        }
        int[] nArray3 = new int[llllllIlII[1]];
        ...
        if (P.llIlIllIlllII(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var18 = new d(llllllIlII[17], llllllIlII[1], llllllIlII[51]);
            bu.add((d)var18);
            0;
        }
        int[] nArray4 = new int[llllllIlII[1]];
        ...
        if (P.llIlIllIlllII(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var18 = new d(llllllIlII[14], llllllIlII[1], llllllIlII[50]);
            bu.add((d)var18);
            0;
        }
        int[] nArray5 = new int[llllllIlII[1]];
        ...
        if (P.llIlIllIlllII(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var18 = new d(llllllIlII[19], llllllIlII[1], llllllIlII[52]);
            bu.add((d)var18);
            0;
        }
        ...
        if (P.llIlIllIlllII(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var18 = new d(llllllIlII[6], llllllIlII[3], llllllIlII[50]);
            bu.add((d)var18);
            0;
        }
        ...
        if (P.llIlIllIllIlI(Bank.contains((int[])nArray7) ? 1 : 0)) {
            ...
            if (P.llIlIllIllIll(Bank.getFirst((int[])nArray8).getQuantity(), llllllIlII[32])) {
                var18 = new d(llllllIlII[6], llllllIlII[53], llllllIlII[54]);
                bu.add((d)var18);
                0;
            }
        }
        if (P.llIlIllIlllII(Bank.contains((Predicate)(var18 = item -> item.getName().toLowerCase().contains(llllllIIll[llllllIlII[61]]))) ? 1 : 0)) {
            var22 = new d(llllllIlII[55], llllllIlII[11], llllllIlII[56]);
            bu.add(var22);
            0;
        }
        ...
        if (P.llIlIllIlllII(Bank.contains((int[])nArray9) ? 1 : 0)) {
            var22 = new d(llllllIlII[16], llllllIlII[53], llllllIlII[57]);
            bu.add(var22);
            0;
        }
        ...
        if (P.llIlIllIlllII(Bank.contains((int[])nArray10) ? 1 : 0)) {
            var22 = new d(llllllIlII[58], llllllIlII[11], i.bp);
            bu.add(var22);
            0;
        }
    }
