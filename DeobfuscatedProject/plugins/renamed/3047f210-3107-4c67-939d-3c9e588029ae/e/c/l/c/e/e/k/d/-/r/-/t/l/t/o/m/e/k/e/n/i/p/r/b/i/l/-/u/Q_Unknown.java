...
implements S {
    ...
    private static String llIIIlllIllII(String var19, String var18) {
        try {
            SecretKeySpec var1 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var18.getBytes(StandardCharsets.UTF_8)), lllIllIIII[20]), "DES");
            Cipher var6 = Cipher.getInstance("DES");
            var6.init(lllIllIIII[3], var1);
    ...
    private static void ae() {
        ...
        if (Q.llIIIllllIIlI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var13 = new d(lllIllIIII[11], lllIllIIII[1], lllIllIIII[49]);
            bu.add((d)var13);
            0;
        }
        int[] nArray3 = new int[lllIllIIII[1]];
        ...
        if (Q.llIIIllllIIlI(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var13 = new d(lllIllIIII[14], lllIllIIII[1], lllIllIIII[49]);
            bu.add((d)var13);
            0;
        }
        if (Q.llIIIllllIIlI(Bank.contains((Predicate)(var13 = item -> item.getName().toLowerCase().contains(lllIlIllll[lllIllIIII[56]]))) ? 1 : 0)) {
            var3 = new d(lllIllIIII[50], lllIllIIII[9], lllIllIIII[51]);
            bu.add(var3);
            0;
        }
        ...
        if (Q.llIIIllllIIlI(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var3 = new d(lllIllIIII[17], lllIllIIII[18], lllIllIIII[52]);
            bu.add(var3);
            0;
        }
        ...
        if (Q.llIIIllllIIlI(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var3 = new d(lllIllIIII[13], lllIllIIII[53], lllIllIIII[52]);
            bu.add(var3);
            0;
        }
        ...
        if (Q.llIIIllllIIlI(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var3 = new d(lllIllIIII[12], lllIllIIII[9], i.bp);
            bu.add(var3);
            0;
        }
    }

    private static String llIIIlllIlIlI(String var20, String var9) {
        try {
    ...
    private static String llIIIlllIlIll(String var11, String var8) {
        var11 = new String(Base64.getDecoder().decode(var11.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var22 = new StringBuilder();
        char[] var21 = var8.toCharArray();
        int var15 = lllIllIIII[0];
        char[] var23 = var11.toCharArray();
        int var2 = var23.length;
        int var5 = lllIllIIII[0];
        while (Q.llIIIllllIIIl(var5, var2)) {
            char var17 = var23[var5];
            var22.append((char)(var17 ^ var21[var15 % var21.length]));
            0;
            ++var15;
            ++var5;
            0;
        ...
        block48: {
            ...
            block51: {
                block52: {
                    block50: {
                        ...
                        if (Q.llIIIllllIIIl(e.j(lllIllIIII[7]), lllIllIIII[1])) {
                            ...
                            if (Q.llIIIllllIlIl(var7) && Q.llIIIllllIIlI(var7.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                            ...
                            if (Q.llIIIllllIlIl(var7) && Q.llIIIllllIIII(var7.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    ...
                    if (Q.llIIIllllIIIl(e.j(lllIllIIII[7]), lllIllIIII[1]) && Q.llIIIllllIIII(Q.aa() ? 1 : 0)) {
                        ...
                        if (Q.llIIIllllIlll(Players.getLocal().getWorldLocation().distanceTo(iH), lllIllIIII[9])) {
                            ...
                            if (Q.llIIIllllIlIl(var7)) {
                                String[] stringArray2 = new String[lllIllIIII[1]];
                                stringArray2[Q.lllIllIIII[0]] = lllIlIllll[lllIllIIII[18]];
                                if (Q.llIIIllllIIII(var7.hasAction(stringArray2) ? 1 : 0) && Q.llIIIllllIlll(var7.getWorldLocation().distanceTo(iH), lllIllIIII[16])) {
                                    var7.interact(lllIlIllll[lllIllIIII[22]]);
                ...
                if (Q.llIIIllllIlll(Players.getLocal().getWorldLocation().distanceTo(iI), lllIllIIII[3])) {
                    ...
                    Item var12 = Inventory.getFirst((String[])stringArray5);
                    if (Q.llIIIllllIlIl(var7)) {
                ...
                if (Q.llIIIllllIlII(Inventory.getCount((String[])stringArray))) {
                    ...
                    if (Q.llIIIllllIIIl(Inventory.getCount((String[])stringArray8), lllIllIIII[1])) {
                        ...
                        if (Q.llIIIllllIlll(Players.getLocal().getWorldLocation().distanceTo(iJ), lllIllIIII[3])) {
                            ...
                            if (Q.llIIIllllIlIl(var7)) {
                                var7.interact(lllIlIllll[lllIllIIII[39]]);
                                Time.sleepTicks((int)lllIllIIII[3]);
                                0;
                            }
                        }
            ...
            if (Q.llIIIlllllIII(e.j(lllIllIIII[7]), lllIllIIII[3])) {
                ...
                if (Q.llIIIllllIlIl(var7)) {
                    ...
                    if (Q.llIIIllllIIII(var7.hasAction(stringArray12) ? 1 : 0)) {
                        ...
                        var7.interact(lllIlIllll[lllIllIIII[47]]);
                        Time.sleepTicks((int)lllIllIIII[5]);
                        0;
                    }
                }
