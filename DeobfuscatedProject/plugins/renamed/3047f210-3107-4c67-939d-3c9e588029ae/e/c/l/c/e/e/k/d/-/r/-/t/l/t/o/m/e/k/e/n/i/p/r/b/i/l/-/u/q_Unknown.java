...
import e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.aa_Unknown;
...
import e.c.l.c.e.e.k.d.-.r.-.t.l.t.o.m.e.k.e.n.i.p.r.b.i.l.-.u.r_Unknown;
...
implements S {
    ...
    private static String llIIllIIlIIlI(String var18, String var19) {
        var18 = new String(Base64.getDecoder().decode(var18.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var21 = new StringBuilder();
        char[] var2 = var19.toCharArray();
        int var20 = llllIIlIll[1];
        char[] var13 = var18.toCharArray();
        int var15 = var13.length;
        int var9 = llllIIlIll[1];
        while (q.llIIllIlllIII(var9, var15)) {
            char var11 = var13[var9];
            var21.append((char)(var11 ^ var2[var20 % var2.length]));
            0;
            ++var20;
            ++var9;
            0;
    ...
    public static void aV() {
        ...
        if (q.llIIllIlllIIl(bs ? 1 : 0)) {
            ...
            if (q.llIIllIlllIIl(q.aa() ? 1 : 0) && q.llIIllIlllIlI(Skills.getLevel((Skill)Skill.AGILITY), llllIIlIll[2]) && q.llIIllIlllIlI(Skills.getLevel((Skill)Skill.PRAYER), llllIIlIll[3]) && q.llIIllIlllIII(e.j(llllIIlIll[9]), llllIIlIll[0]) && q.llIIllIlllIll(e.j(llllIIlIll[5]), llllIIlIll[6])) {
                ...
                if (q.llIIllIllllII(var3) && q.llIIllIlllIIl(var3.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                    AccBuilderTempleTrek.c = llllIIIlll[llllIIlIll[10]];
                    a.a((BankLocation)var3);
                }
                if (q.llIIllIllllII(var3) && q.llIIllIllIlll(var3.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
            ...
            if (!q.llIIlllIIIIIl(e.j(llllIIlIll[9]), llllIIlIll[10]) || !q.llIIlllIIIIIl(e.j(llllIIlIll[9]), llllIIlIll[27]) || q.llIIllIlllIll(e.j(llllIIlIll[9]), llllIIlIll[37])) {
                ...
                if (q.llIIlllIIIIII(Players.getLocal().getWorldLocation().distanceTo(cP), llllIIlIll[27])) {
                    ...
                    if (q.llIIllIlllIIl(var3.isEmpty() ? 1 : 0) && q.llIIllIllllII(lllllllllllllllllIlIllIlIIIIllIl2 = (NPC)var3.stream().filter(nPC -> {
                        boolean bl;
                        ...
                        int var5 = llllIIlIll[0];
                        int var4 = Static.getClient().getWorld();
                        while (q.llIIllIllIlll(var5)) {
                            ...
                            if (!q.llIIlllIIIIIl(Static.getClient().getWorld(), var4)) continue;
                            var5 = llllIIlIll[1];
                            0;
            ...
            if (q.llIIllIlllIll(e.j(llllIIlIll[9]), llllIIlIll[54]) && q.llIIllIllIlll(cV.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ck = llllIIlIll[1];
                var3 = new WorldPoint(llllIIlIll[60], llllIIlIll[61], llllIIlIll[1]);
                lllllllllllllllllIlIllIlIIIIllIl2 = new WorldPoint(llllIIlIll[60], llllIIlIll[62], llllIIlIll[1]);
                WorldPoint var5 = new WorldPoint(llllIIlIll[60], llllIIlIll[63], llllIIlIll[1]);
                WorldPoint var4 = new WorldPoint(llllIIlIll[60], llllIIlIll[64], llllIIlIll[1]);
                if (q.llIIllIllllll(Players.getLocal().getWorldLocation().distanceTo(cR), llllIIlIll[10]) && q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals(var3) ? 1 : 0) && q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIllIlIIIIllIl2) ? 1 : 0) && q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals((Object)var4) ? 1 : 0) && q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals((Object)var5) ? 1 : 0) && q.llIIllIlllIIl(cU.contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                ...
                if (q.llIIlllIIIIII(Players.getLocal().getWorldLocation().distanceTo(cR), llllIIlIll[10]) && q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals(var3) ? 1 : 0) && q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIllIlIIIIllIl2) ? 1 : 0) && q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals((Object)var4) ? 1 : 0) && q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals((Object)var5) ? 1 : 0)) {
                    String[] stringArray = new String[llllIIlIll[0]];
                ...
                if (!q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals(var3) ? 1 : 0) || !q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIllIlIIIIllIl2) ? 1 : 0) || !q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals((Object)var4) ? 1 : 0) || q.llIIllIllIlll(Players.getLocal().getWorldLocation().equals((Object)var5) ? 1 : 0)) {
                    String[] stringArray = new String[llllIIlIll[0]];
                    stringArray[q.llllIIlIll[1]] = llllIIIlll[llllIIlIll[68]];
                    TileObject var16 = TileObjects.getNearest((String[])stringArray);
                    if (q.llIIllIllllII(var16)) {
                        String[] stringArray2 = new String[llllIIlIll[0]];
                        stringArray2[q.llllIIlIll[1]] = llllIIIlll[llllIIlIll[69]];
                        if (q.llIIllIllIlll(var16.hasAction(stringArray2) ? 1 : 0)) {
                            AccBuilderTempleTrek.c = llllIIIlll[llllIIlIll[70]];
                            var16.interact(llllIIIlll[llllIIlIll[71]]);
                            Time.sleepTicks((int)llllIIlIll[4]);
                            0;
                        }
                    }
                }
                if (q.llIIllIllIlll(Players.getLocal().getWorldLocation().equals((Object)var4) ? 1 : 0)) {
                    String[] stringArray = new String[llllIIlIll[0]];
                ...
                if (q.llIIllIllIlll(cU.contains(Players.getLocal().getWorldLocation()) ? 1 : 0) && q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals(var3) ? 1 : 0) && q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals((Object)lllllllllllllllllIlIllIlIIIIllIl2) ? 1 : 0) && q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals((Object)var4) ? 1 : 0) && q.llIIllIlllIIl(Players.getLocal().getWorldLocation().equals((Object)var5) ? 1 : 0)) {
            ...
            if (q.llIIllIlllIll(e.j(llllIIlIll[9]), llllIIlIll[77])) {
                if (q.llIIllIlllIIl(Dialog.isOpen() ? 1 : 0)) {
                    ...
                    var3 = NPCs.getAll((String[])stringArray);
                    if (q.llIIllIllllIl(var3.size())) {
                        ((NPC)var3.get(llllIIlIll[1])).interact(llllIIIlll[llllIIlIll[3]]);
                ...
                if (q.llIIllIllIlll(Dialog.isOpen() ? 1 : 0)) {
                    ...
                    if (q.llIIllIlllIIl((var3 = Widgets.getChildren((int)llllIIlIll[80], (int)llllIIlIll[0], widget -> widget.isVisible())).isEmpty() ? 1 : 0)) {
                        int lllllllllllllllllIlIllIlIIIIllIl2 = llllIIlIll[1];
                        while (q.llIIllIlllIII(lllllllllllllllllIlIllIlIIIIllIl2, var3.size())) {
                            if ((!q.llIIllIlllIIl(((Widget)var3.get(llllIIlIll[1])).getText().contains(llllIIIlll[llllIIlIll[81]]) ? 1 : 0) || q.llIIllIllIlll(((Widget)var3.get(llllIIlIll[1])).getText().contains(llllIIIlll[llllIIlIll[82]]) ? 1 : 0)) && q.llIIllIllIlll(((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getText().contains(llllIIIlll[llllIIlIll[83]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getX(), (int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getY(), (boolean)llllIIlIll[0]);
                                Time.sleepTicks((int)llllIIlIll[4]);
                                0;
                            }
                            if (q.llIIllIllIlll(((Widget)var3.get(llllIIlIll[1])).getText().contains(llllIIIlll[llllIIlIll[84]]) ? 1 : 0) && q.llIIllIllIlll(((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getText().contains(llllIIIlll[llllIIlIll[42]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getX(), (int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getY(), (boolean)llllIIlIll[0]);
                                Time.sleepTicks((int)llllIIlIll[4]);
                                0;
                            }
                            if ((!q.llIIllIlllIIl(((Widget)var3.get(llllIIlIll[1])).getText().contains(llllIIIlll[llllIIlIll[85]]) ? 1 : 0) || q.llIIllIllIlll(((Widget)var3.get(llllIIlIll[1])).getText().contains(llllIIIlll[llllIIlIll[77]]) ? 1 : 0)) && q.llIIllIllIlll(((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getText().contains(llllIIIlll[llllIIlIll[86]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getX(), (int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getY(), (boolean)llllIIlIll[0]);
                                Time.sleepTicks((int)llllIIlIll[4]);
                                0;
                            }
                            if (q.llIIllIllIlll(((Widget)var3.get(llllIIlIll[1])).getText().contains(llllIIIlll[llllIIlIll[87]]) ? 1 : 0) && q.llIIllIllIlll(((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getText().contains(llllIIIlll[llllIIlIll[88]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getX(), (int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getY(), (boolean)llllIIlIll[0]);
                                Time.sleepTicks((int)llllIIlIll[4]);
                                0;
                            }
                            if (q.llIIllIllIlll(((Widget)var3.get(llllIIlIll[1])).getText().contains(llllIIIlll[llllIIlIll[89]]) ? 1 : 0) && q.llIIllIllIlll(((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getText().contains(llllIIIlll[llllIIlIll[90]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getX(), (int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getY(), (boolean)llllIIlIll[0]);
                                Time.sleepTicks((int)llllIIlIll[4]);
                                0;
                            }
                            if (q.llIIllIllIlll(((Widget)var3.get(llllIIlIll[1])).getText().contains(llllIIIlll[llllIIlIll[91]]) ? 1 : 0) && q.llIIllIllIlll(((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getText().contains(llllIIIlll[llllIIlIll[92]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getX(), (int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getY(), (boolean)llllIIlIll[0]);
                                Time.sleepTicks((int)llllIIlIll[4]);
                                0;
                            }
                            if (q.llIIllIllIlll(((Widget)var3.get(llllIIlIll[1])).getText().contains(llllIIIlll[llllIIlIll[93]]) ? 1 : 0) && q.llIIllIllIlll(((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getText().contains(llllIIIlll[llllIIlIll[94]]) ? 1 : 0)) {
                                Mouse.click((int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getX(), (int)((Widget)var3.get(lllllllllllllllllIlIllIlIIIIllIl2)).getClickPoint().getY(), (boolean)llllIIlIll[0]);
                                Time.sleepTicks((int)llllIIlIll[4]);
                                0;
                            }
    ...
    private static void ae() {
        ...
        block52: {
            block51: {
                block50: {
                        ...
                        block48: {
                            block47: {
                                block46: {
                                        ...
                                        block44: {
                                            block43: {
                                                block42: {
                                                        ...
                                                        block40: {
                                                            block39: {
                                                                block38: {
                                                                        ...
                                                                        block36: {
                                                                            block35: {
                                                                                ...
                                                                                if (q.llIIllIlllIIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
                                                                                    var14 = new d(llllIIlIll[16], llllIIlIll[0], llllIIlIll[141]);
                                                                                    bu.add((d)var14);
                                                                                    0;
                                                                                }
                                                                                int[] nArray3 = new int[llllIIlIll[0]];
                                                                                ...
                                                                                if (q.llIIllIlllIIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
                                                                                    var14 = new d(llllIIlIll[17], llllIIlIll[0], llllIIlIll[141]);
                                                                                    bu.add((d)var14);
                                                                                    0;
                                                                                }
                                                                                int[] nArray4 = new int[llllIIlIll[0]];
                                                                                ...
                                                                                if (q.llIIllIlllIIl(Bank.contains((int[])nArray4) ? 1 : 0)) {
                                                                                    var14 = new d(llllIIlIll[18], llllIIlIll[0], llllIIlIll[141]);
                                                                                    bu.add((d)var14);
                                                                                    0;
                                                                                }
                                                                                int[] nArray5 = new int[llllIIlIll[0]];
                                                                                ...
                                                                                if (q.llIIllIlllIIl(Bank.contains((int[])nArray5) ? 1 : 0)) {
                                                                                    var14 = new d(llllIIlIll[22], llllIIlIll[0], llllIIlIll[141]);
                                                                                    bu.add((d)var14);
                                                                                    0;
                                                                                }
                                                                                int[] nArray6 = new int[llllIIlIll[0]];
                                                                            ...
                                                                            var14 = new d(llllIIlIll[19], llllIIlIll[4], llllIIlIll[141]);
                                                                            bu.add((d)var14);
                                                                            0;
                                                                        }
                                                                        int[] nArray = new int[llllIIlIll[0]];
                                                                    ...
                                                                    var14 = new d(llllIIlIll[32], llllIIlIll[43], llllIIlIll[142]);
                                                                    bu.add((d)var14);
                                                                    0;
                                                                }
                                                                int[] nArray = new int[llllIIlIll[0]];
                                                            ...
                                                            var14 = new d(llllIIlIll[20], llllIIlIll[39], llllIIlIll[114]);
                                                            bu.add((d)var14);
                                                            0;
                                                        }
                                                        int[] nArray = new int[llllIIlIll[0]];
                                                    ...
                                                    var14 = new d(llllIIlIll[24], llllIIlIll[12], llllIIlIll[41]);
                                                    bu.add((d)var14);
                                                    0;
                                                }
                                                int[] nArray = new int[llllIIlIll[0]];
                                            ...
                                            var14 = new d(llllIIlIll[26], llllIIlIll[25], llllIIlIll[41]);
                                            bu.add((d)var14);
                                            0;
                                        }
                                        int[] nArray = new int[llllIIlIll[0]];
                                    ...
                                    var14 = new d(llllIIlIll[28], llllIIlIll[8], llllIIlIll[143]);
                                    bu.add((d)var14);
                                    0;
                                }
                                int[] nArray = new int[llllIIlIll[0]];
                            ...
                            var14 = new d(llllIIlIll[30], llllIIlIll[21], i.bp);
                            bu.add((d)var14);
                            0;
                        }
                        int[] nArray = new int[llllIIlIll[0]];
                    ...
                    var14 = new d(llllIIlIll[36], llllIIlIll[27], e.c(llllIIlIll[144], llllIIlIll[145]));
                    bu.add((d)var14);
                    0;
                }
                int[] nArray = new int[llllIIlIll[0]];
            ...
            var14 = new d(llllIIlIll[34], llllIIlIll[10], e.c(llllIIlIll[146], llllIIlIll[147]));
            bu.add((d)var14);
            0;
        }
        int[] nArray = new int[llllIIlIll[0]];
        ...
        if (q.llIIllIlllIIl(Bank.contains((int[])nArray) ? 1 : 0)) {
            var14 = new d(llllIIlIll[15], llllIIlIll[0], llllIIlIll[141]);
            bu.add((d)var14);
            0;
        }
        if (q.llIIllIlllIIl(Bank.contains((Predicate)(var14 = item -> item.getName().toLowerCase().contains(llllIIIlll[llllIIlIll[151]]))) ? 1 : 0)) {
            var23 = new d(llllIIlIll[148], llllIIlIll[10], llllIIlIll[149]);
            bu.add(var23);
            0;
        }
        ...
        if (q.llIIllIlllIIl(Bank.contains((int[])nArray25) ? 1 : 0)) {
            var23 = new d(llllIIlIll[14], llllIIlIll[73], llllIIlIll[150]);
            bu.add(var23);
            0;
        }
    }
    ...
    private static String llIIllIIlIIIl(String var7, String var12) {
        try {
    ...
    private static String llIIllIIlIIII(String var10, String var1) {
        try {
            SecretKeySpec var24 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var1.getBytes(StandardCharsets.UTF_8)), llllIIlIll[23]), "DES");
            Cipher var8 = Cipher.getInstance("DES");
            var8.init(llllIIlIll[4], var24);
