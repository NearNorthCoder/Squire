...
implements S {
    ...
    private static String llIllIIllIIlI(String var16, String var12) {
        var16 = new String(Base64.getDecoder().decode(var16.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var14 = new StringBuilder();
        char[] var19 = var12.toCharArray();
        int var2 = lIIIIIIIIlI[0];
        char[] var20 = var16.toCharArray();
        int var9 = var20.length;
        int var10 = lIIIIIIIIlI[0];
        while (Y.llIllIIlllIII(var10, var9)) {
            char var8 = var20[var10];
            var14.append((char)(var8 ^ var19[var2 % var19.length]));
            0;
            ++var2;
            ++var10;
            0;
    ...
    public static void ae() {
        ...
        if (Y.llIllIIlllIIl(Bank.contains((int[])nArray2) ? 1 : 0)) {
            ...
            var21 = new d(lIIIIIIIIlI[8], lIIIIIIIIlI[1], lIIIIIIIIlI[36]);
            bu.add((d)var21);
            0;
        }
        if (Y.llIllIIlllIIl(Bank.contains(var21 = item -> item.getName().toLowerCase().contains(lIIIIIIIIIl[lIIIIIIIIlI[45]])) ? 1 : 0)) {
            var13 = new d(lIIIIIIIIlI[37], lIIIIIIIIlI[9], lIIIIIIIIlI[38]);
            bu.add(var13);
            0;
        }
        ...
        if (Y.llIllIIlllIIl(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var13 = new d(lIIIIIIIIlI[39], lIIIIIIIIlI[40], lIIIIIIIIlI[41]);
            bu.add(var13);
            0;
        }
    }
                ...
                block34: {
                    block33: {
                        block32: {
                            ...
                            if (Y.llIllIIlllIll(var17 = BankLocation.getNearest()) && Y.llIllIIlllIIl(var17.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                AccBuilderTempleTrek.c = lIIIIIIIIIl[lIIIIIIIIlI[3]];
                                a.a(var17);
                            }
                            if (!Y.llIllIIlllIll(var17) || !Y.llIllIIllIlll(var17.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block31;
            ...
            if (Y.llIllIIllIlll(Y.aa() ? 1 : 0)) {
                ...
                if (Y.llIllIIlllIIl(Bank.isOpen() ? 1 : 0) && Y.llIllIIlllIIl(Players.getLocal().isAnimating() ? 1 : 0)) {
                    ...
                    if (Y.llIllIIlllIIl(Production.isOpen() ? 1 : 0)) {
                        ...
                        Item var7 = Inventory.getFirst((int[])nArray8);
                        if (Y.llIllIIlllIll(var17) && Y.llIllIIlllIll(var7)) {
                            var17.useOn(var7);
    ...
    private static String llIllIIllIlII(String var1, String var15) {
        try {
    ...
    private static String llIllIIllIIll(String var6, String var18) {
        try {
            SecretKeySpec var22 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var18.getBytes(StandardCharsets.UTF_8)), lIIIIIIIIlI[12]), "DES");
            Cipher var11 = Cipher.getInstance("DES");
            var11.init(lIIIIIIIIlI[3], var22);
