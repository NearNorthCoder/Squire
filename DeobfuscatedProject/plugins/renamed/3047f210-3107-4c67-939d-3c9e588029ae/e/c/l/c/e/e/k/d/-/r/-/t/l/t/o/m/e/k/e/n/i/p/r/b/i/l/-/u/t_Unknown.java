...
public class t_Unknown {
    ...
    public static void ae() {
        ...
        if (t.llIIlIIIllIlI(Bank.contains((int[])nArray2) ? 1 : 0)) {
            var13 = new d(dt, lllIllIllI[1], lllIllIllI[22]);
            bu.add((d)var13);
            0;
        }
        ...
        if (t.llIIlIIIllIlI(Bank.contains((int[])nArray3) ? 1 : 0)) {
            var13 = new d(lllIllIllI[8], lllIllIllI[1], lllIllIllI[23]);
            bu.add((d)var13);
            0;
        }
        ...
        if (t.llIIlIIIllIlI(Bank.contains((int[])nArray4) ? 1 : 0)) {
            var13 = new d(lllIllIllI[7], lllIllIllI[1], lllIllIllI[24]);
            bu.add((d)var13);
            0;
        }
        ...
        if (t.llIIlIIIllIlI(Bank.contains((int[])nArray5) ? 1 : 0)) {
            var13 = new d(lllIllIllI[25], lllIllIllI[5], lllIllIllI[13]);
            bu.add((d)var13);
            0;
        }
        ...
        if (t.llIIlIIIllIlI(Bank.contains((int[])nArray6) ? 1 : 0)) {
            var13 = new d(lllIllIllI[26], lllIllIllI[27], lllIllIllI[13]);
            bu.add((d)var13);
            0;
        }
        ...
        if (t.llIIlIIIllIlI(Bank.contains((int[])nArray7) ? 1 : 0)) {
            var13 = new d(lllIllIllI[28], lllIllIllI[29], lllIllIllI[13]);
            bu.add((d)var13);
            0;
        }
        ...
        if (t.llIIlIIIllIlI(Bank.contains((int[])nArray8) ? 1 : 0)) {
            var13 = new d(lllIllIllI[30], lllIllIllI[31], lllIllIllI[13]);
            bu.add((d)var13);
            0;
        }
        ...
        if (t.llIIlIIIllIlI(Bank.contains((Predicate)(var13 = item -> item.getName().toLowerCase().contains(lllIllIlIl[lllIllIllI[40]]))) ? 1 : 0)) {
            var8 = new d(lllIllIllI[33], lllIllIllI[6], lllIllIllI[34]);
            bu.add(var8);
            0;
        }
        ...
        if (t.llIIlIIIllIlI(Bank.contains((int[])nArray17) ? 1 : 0)) {
            var8 = new d(lllIllIllI[35], lllIllIllI[36], lllIllIllI[37]);
            bu.add(var8);
            0;
        }
    }
    ...
    private static String llIIlIIIlIlIl(String var17, String var5) {
        try {
            SecretKeySpec var16 = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(var5.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            Cipher var6 = Cipher.getInstance("Blowfish");
            var6.init(lllIllIllI[2], var16);
    ...
    private static String llIIlIIIlIIll(String var9, String var1) {
        try {
            SecretKeySpec var20 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var1.getBytes(StandardCharsets.UTF_8)), lllIllIllI[11]), "DES");
            Cipher var11 = Cipher.getInstance("DES");
            var11.init(lllIllIllI[2], var20);
    ...
    private static void llIIlIIIlIlll() {
        ...
        t.lllIllIllI[0] = (0xF5 ^ 0x8E ^ (0xDC ^ 0xA9)) & (0x11 ^ 0xD ^ (0x81 ^ 0x93) ^ -1);
        t.lllIllIllI[1] = 1;
        t.lllIllIllI[2] = 2;
        t.lllIllIllI[3] = 3;
        ...
        block28: {
                        ...
                        block33: {
                            block32: {
                                block30: {
                                    ...
                                    if (t.llIIlIIIllIll(var23) && t.llIIlIIIllIlI(var23.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) {
                                        AccBuilderTempleTrek.c = lllIllIlIl[lllIllIllI[3]];
                                        a.a(var23);
                                    }
                                    if (!t.llIIlIIIllIll(var23) || !t.llIIlIIIllIII(var23.getArea().contains(Players.getLocal().getWorldLocation()) ? 1 : 0)) break block29;
            ...
            if (t.llIIlIIIllIII(t.bk() ? 1 : 0)) {
                ...
                if (t.llIIlIIIllIlI(Bank.isOpen() ? 1 : 0)) {
                    ...
                    int var23 = lllIllIllI[0];
                    while (t.llIIlIIIllIIl(var23, du.length)) {
                        int[] nArray = new int[lllIllIllI[1]];
                        nArray[t.lllIllIllI[0]] = du[var23];
                        Item var7 = Inventory.getFirst((int[])nArray);
                        if (t.llIIlIIIllIll(var7)) {
                            int[] nArray13 = new int[lllIllIllI[1]];
                            nArray13[t.lllIllIllI[0]] = var7.getId();
                            if (t.llIIlIIIllIII(Inventory.contains((int[])nArray13) ? 1 : 0)) {
                                String[] stringArray = new String[lllIllIllI[1]];
                                stringArray[t.lllIllIllI[0]] = lllIllIlIl[lllIllIllI[10]];
                                if (t.llIIlIIIllIII(var7.hasAction(stringArray) ? 1 : 0)) {
                                    var7.interact(lllIllIlIl[lllIllIllI[11]]);
                                    Time.sleepTicks((int)lllIllIllI[1]);
                                    0;
                                }
                                String[] stringArray2 = new String[lllIllIllI[1]];
                                stringArray2[t.lllIllIllI[0]] = lllIllIlIl[lllIllIllI[12]];
                                if (t.llIIlIIIllIII(var7.hasAction(stringArray2) ? 1 : 0)) {
                                    var7.interact(lllIllIlIl[lllIllIllI[13]]);
                                    Time.sleepTicks((int)lllIllIllI[1]);
                                    0;
                                }
                                String[] stringArray3 = new String[lllIllIllI[1]];
                                stringArray3[t.lllIllIllI[0]] = lllIllIlIl[lllIllIllI[14]];
                                if (t.llIIlIIIllIII(var7.hasAction(stringArray3) ? 1 : 0)) {
                                    var7.interact(lllIllIlIl[lllIllIllI[15]]);
                                    Time.sleepTicks((int)lllIllIllI[1]);
                                    0;
                                }
                                Time.sleepTicks((int)lllIllIllI[1]);
    ...
    private static void llIIlIIIlIllI() {
        ...
        t.lllIllIlIl[t.lllIllIllI[0]] = t."Buying items";
        t.lllIllIlIl[t.lllIllIllI[1]] = t."Finished buying items, switching back to gearing";
        t.lllIllIlIl[t.lllIllIllI[2]] = t."Get Mage Gear Util";
        t.lllIllIlIl[t.lllIllIllI[3]] = t."Navigating to bank";
        t.lllIllIlIl[t.lllIllIllI[4]] = t."Opening bank";
        t.lllIllIlIl[t.lllIllIllI[6]] = t."Handling banking";
        t.lllIllIlIl[t.lllIllIllI[9]] = t."We are missing supplies, switching to BUYING Util";
        t.lllIllIlIl[t.lllIllIllI[10]] = t."Wear";
        t.lllIllIlIl[t.lllIllIllI[11]] = t."Wear";
        t.lllIllIlIl[t.lllIllIllI[12]] = t."Wield";
        t.lllIllIlIl[t.lllIllIllI[13]] = t."Wield";
        t.lllIllIlIl[t.lllIllIllI[14]] = t."Equip";
        t.lllIllIlIl[t.lllIllIllI[15]] = t."Equip";
        t.lllIllIlIl[t.lllIllIllI[17]] = t."Staff of air";
        t.lllIllIlIl[t.lllIllIllI[18]] = t."Leather gloves";
        t.lllIllIlIl[t.lllIllIllI[19]] = t."Staff of air";
        t.lllIllIlIl[t.lllIllIllI[20]] = t."Leather gloves";
        t.lllIllIlIl[t.lllIllIllI[38]] = t."Wear";
        t.lllIllIlIl[t.lllIllIllI[39]] = t."Wear";
        t.lllIllIlIl[t.lllIllIllI[40]] = t."ring of wealth (";
    }

    private static String llIIlIIIlIlII(String var21, String var19) {
        ...
        int var12 = lllIllIllI[0];
        char[] var3 = var21.toCharArray();
        int var15 = var3.length;
        int var2 = lllIllIllI[0];
        while (t.llIIlIIIllIIl(var2, var15)) {
            char var4 = var3[var2];
            var10.append((char)(var4 ^ var18[var12 % var18.length]));
            0;
            ++var12;
            ++var2;
            0;
