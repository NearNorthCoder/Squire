...
extends Enum<f> {
    ...
    private static String lIllIllIIlllIll(String var22, String var23) {
        ...
        int var19 = lIlIIIIIIIlII[0];
        char[] var20 = var22.toCharArray();
        int var3 = var20.length;
        int var18 = lIlIIIIIIIlII[0];
        while (f.lIllIllIIllllll(var18, var3)) {
            char var7 = var20[var18];
            var14.append((char)(var7 ^ var1[var19 % var1.length]));
            0;
            ++var19;
            ++var18;
            0;
    ...
    private static String lIllIllIIlllIIl(String var12, String var9) {
        try {
            ...
            var13.init(lIlIIIIIIIlII[3], var4);
    ...
    static {
        block2: {
            ...
            int var5 = lIlIIIIIIIlII[0];
            while (f.lIllIllIIllllll(var5, (int)var6)) {
                void var15;
                void var8 = var15[var5];
                int[] var2 = var8.l();
                int var17 = var2.length;
                int var21 = lIlIIIIIIIlII[0];
                while (f.lIllIllIIllllll(var21, var17)) {
                    void var16;
                    int var11 = var2[var21];
                    var16.put((Object)var11, (Object)var8);
                    0;
                    ++var21;
                    0;
                    if (3 >= 0) continue;
