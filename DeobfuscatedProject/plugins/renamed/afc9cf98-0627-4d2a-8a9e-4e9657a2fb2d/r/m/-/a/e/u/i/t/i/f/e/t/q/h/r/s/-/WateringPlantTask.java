...
/* TASK: Watering Plant -> WateringplantTask */
...
extends r {
    ...
    public boolean run() {
        ...
        TileObject var7 = var2.Z.a(lIIlllllIIlll[lIIlllllIlIII[1]]);
        if (v.lIllIlIlllIIIlI(var7)) {
            return lIIlllllIlIII[1];
        }
        var7.interact(lIIlllllIIlll[lIIlllllIlIII[0]]);
        GameObject var6 = (GameObject)var7;
        Player var1 = Players.getLocal();
        if (v.lIllIlIlllIIIll(var6.getWorldArea().isInMeleeDistance(var1.getWorldArea()) ? 1 : 0)) {
            var2.sleep(lIIlllllIlIII[3]);
        }
        return lIIlllllIlIII[0];
    }

    private static String lIllIlIllIllllI(String var4, String var9) {
        var4 = new String(Base64.getDecoder().decode(var4.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var8 = new StringBuilder();
        char[] var12 = var9.toCharArray();
        int var11 = lIIlllllIlIII[1];
        char[] var13 = var4.toCharArray();
        int var3 = var13.length;
        int var10 = lIIlllllIlIII[1];
        while (v.lIllIlIlllIIllI(var10, var3)) {
            char var5 = var13[var10];
            var8.append((char)(var5 ^ var12[var11 % var12.length]));
            0;
            ++var11;
            ++var10;
            0;
