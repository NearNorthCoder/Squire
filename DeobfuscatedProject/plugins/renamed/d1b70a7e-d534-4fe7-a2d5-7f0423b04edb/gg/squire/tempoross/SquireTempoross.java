...
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.BuildingWorkAreaTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.CookingFishTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.UsingSpecialAttackTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.FishingTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.FillingEmptyBucketsTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.HandlingFiresTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.FishingTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.HarpooningPoolsTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.RepairingMastTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.TetheringToMastTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.DepositingFishIntoCannonTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.GatheringBucketsTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.GatheringHammerTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.GatheringHarpoonTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.GatheringRopeTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.RidExtrasTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.BoardingShipTask;
import p.s.o.t.u.m.r.s.i.e.s.-.o.e.r.q.BoardingShipTask;
...
extends SquirePlugin {
    ...
    private static void lIllIIIlllIllIl() {
        ...
        SquireTempoross.lIIllIllllIlI[SquireTempoross.lIIllIllllIll[1]] = SquireTempoross."Douse";
        SquireTempoross.lIIllIllllIlI[SquireTempoross.lIIllIllllIll[2]] = SquireTempoross."Douse";
    }
    ...
    private static String lIllIIIlllIlIll(String var14, String var2) {
        var14 = new String(Base64.getDecoder().decode(var14.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var16 = new StringBuilder();
        char[] var9 = var2.toCharArray();
        int var3 = lIIllIllllIll[1];
        char[] var15 = var14.toCharArray();
        int var11 = var15.length;
        int var20 = lIIllIllllIll[1];
        while (SquireTempoross.lIllIIIllllIlll(var20, var11)) {
            char var7 = var15[var20];
            var16.append((char)(var7 ^ var9[var3 % var9.length]));
            0;
            ++var3;
            ++var20;
            0;
    ...
    private static String lIllIIIlllIllII(String var18, String var10) {
        try {
            ...
            var8.init(lIIllIllllIll[3], var1);
    ...
    public WorldPoint a(NPC nPC) {
        ...
        WorldPoint var6 = var4.getWorldLocation().dy(lIIllIllllIll[21]);
        if (SquireTempoross.lIllIIIllllIIlI(Reachable.isWalkable((WorldPoint)var6) ? 1 : 0)) {
            return var6;
        }
        WorldPoint var13 = var4.getWorldLocation().dx(lIIllIllllIll[2]);
        if (SquireTempoross.lIllIIIllllIIlI(Reachable.isWalkable((WorldPoint)var13) ? 1 : 0)) {
            return var13;
        }
        WorldPoint var17 = var4.getWorldLocation().dy(lIIllIllllIll[2]);
        if (SquireTempoross.lIllIIIllllIIlI(Reachable.isWalkable((WorldPoint)var17) ? 1 : 0)) {
            return var17;
        }
        WorldPoint var12 = var4.getWorldLocation().dx(lIIllIllllIll[21]);
        if (SquireTempoross.lIllIIIllllIIlI(Reachable.isWalkable((WorldPoint)var12) ? 1 : 0)) {
            return var12;
        }
        return null;
    }
    ...
    private static void lIllIIIlllIlllI() {
        ...
        SquireTempoross.lIIllIllllIll[2] = 1;
        SquireTempoross.lIIllIllllIll[3] = 2;
        SquireTempoross.lIIllIllllIll[4] = 3;
        ...
        SquireTempoross.lIIllIllllIll[21] = -1;
