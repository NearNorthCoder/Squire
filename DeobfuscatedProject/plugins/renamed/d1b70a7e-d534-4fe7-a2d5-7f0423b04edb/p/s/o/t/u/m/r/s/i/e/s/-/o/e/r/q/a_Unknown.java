...
public class a_Unknown {
    ...
    private static String lIllIIIllIlIlll(String var10, String var8) {
        try {
            SecretKeySpec var11 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var8.getBytes(StandardCharsets.UTF_8)), lIIllIllllIII[18]), "DES");
            Cipher var22 = Cipher.getInstance("DES");
            var22.init(lIIllIllllIII[9], var11);
    ...
    public void a(ChatMessage chatMessage) {
        ...
        if (a.lIllIIIlllIIllI(var12.contains(lIIllIlllIllI[lIIllIllllIII[13]]) ? 1 : 0)) {
            var1.r = lIIllIllllIII[1];
            var1.i += lIIllIllllIII[1];
            var1.s = null;
            System.out.println(lIIllIlllIllI[lIIllIllllIII[14]]);
        }
        if (a.lIllIIIlllIIllI(var12.contains(lIIllIlllIllI[lIIllIllllIII[15]]) ? 1 : 0)) {
            String var5 = var12.substring(lIIllIllllIII[16], var12.indexOf(lIIllIlllIllI[lIIllIllllIII[17]]));
            String var2 = var5.replace(lIIllIlllIllI[lIIllIllllIII[18]], lIIllIlllIllI[lIIllIllllIII[19]]).replace(lIIllIlllIllI[lIIllIllllIII[20]], lIIllIlllIllI[lIIllIllllIII[21]]);
            int var18 = Integer.parseInt(var2);
            var1.h += var18;
        }
        if (a.lIllIIIlllIIllI(var12.toLowerCase().contains(lIIllIlllIllI[lIIllIllllIII[22]]) ? 1 : 0)) {
            var1.p = lIIllIllllIII[1];
        }
        if (!a.lIllIIIlllIIlll(var12.contains(lIIllIlllIllI[lIIllIllllIII[23]]) ? 1 : 0) || a.lIllIIIlllIIllI(var12.contains(lIIllIlllIllI[lIIllIllllIII[24]]) ? 1 : 0)) {
            var1.p = lIIllIllllIII[0];
        }
        if (a.lIllIIIlllIIllI(var12.contains(lIIllIlllIllI[lIIllIllllIII[3]]) ? 1 : 0)) {
            var1.q = lIIllIllllIII[1];
        }
    }
    ...
    private static String lIllIIIllIlIllI(String var3, String var21) {
        ...
        int var7 = lIIllIllllIII[0];
        char[] var9 = var3.toCharArray();
        int var17 = var9.length;
        int var15 = lIIllIllllIII[0];
        while (a.lIllIIIlllIlIlI(var15, var17)) {
            char var14 = var9[var15];
            var13.append((char)(var14 ^ var23[var7 % var23.length]));
            0;
            ++var7;
            ++var15;
            0;
    ...
    private static String lIllIIIllIlIlIl(String var6, String var16) {
        try {
            ...
            var24.init(lIIllIllllIII[9], var20);
