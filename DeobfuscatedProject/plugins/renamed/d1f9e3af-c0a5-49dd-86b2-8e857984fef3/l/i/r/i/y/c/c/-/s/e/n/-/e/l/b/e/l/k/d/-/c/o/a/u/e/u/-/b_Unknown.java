...
public class b_Unknown {
                    ...
                    if (b.lIIIIIIlIIII(GrandExchange.isSelling() ? 1 : 0)) {
                        ...
                        Time.sleepUntil(() -> {
                            ...
                            if (b.lIIIIIIllIII(GrandExchange.getItemId(), (Integer)lIIIIIIlIIlIlII.get(lIIIIIIlIIlIIlI))) {
                                ...
                                0;
                                if (-1 > 3) {
                                    return ((128 + 70 - 65 + 21 ^ 131 + 124 - 230 + 124) & (0x48 ^ 0xA ^ (0x4B ^ 6) ^ -1)) != 0;
                                }
                            } else {
                                bl = lIIllIllI[0];
                            }
    ...
    private static void lIIIIIIIlllI() {
        ...
        b.lIIllIlIl[b.lIIllIllI[0]] = b."Wear";
        b.lIIllIlIl[b.lIIllIllI[1]] = b."Grand Exchange";
        b.lIIllIlIl[b.lIIllIllI[8]] = b."In F2P, need to switch to a P2P world, ending script";
        b.lIIllIlIl[b.lIIllIllI[4]] = b."Stamina potion(4)";
        b.lIIllIlIl[b.lIIllIllI[7]] = b."Stamina potion (4)";
        b.lIIllIlIl[b.lIIllIllI[25]] = b."tablet";
        b.lIIllIlIl[b.lIIllIllI[26]] = b."(tablet)";
        b.lIIllIlIl[b.lIIllIllI[13]] = b."";
        b.lIIllIlIl[b.lIIllIllI[28]] = b."Close";
        b.lIIllIlIl[b.lIIllIllI[29]] = b."wealth";
        b.lIIllIlIl[b.lIIllIllI[3]] = b."wealth";
        b.lIIllIlIl[b.lIIllIllI[27]] = b."ring of wealth (";
    }
        ...
        block65: {
                        ...
                        if (b.lIIIIIIlIIIl(Bank.contains((int[])nArray2) ? 1 : 0) && b.lIIIIIIlIlII(Players.getLocal().getWorldLocation().distanceTo(J), lIIllIllI[3])) {
                            ...
                            Time.sleepUntil(() -> {
                                ...
                                if (b.lIIIIIIlIlll(Inventory.getCount((int[])nArray))) {
                                    bl = lIIllIllI[1];
                                    0;
                                    if (((73 + 20 - -55 + 28 ^ 140 + 112 - 99 + 9) & (34 + 62 - 51 + 145 ^ 132 + 55 - 37 + 22 ^ -1)) < -1) {
                                        return ((0x80 ^ 0x84 ^ (0xE5 ^ 0x80)) & (0x54 ^ 0x14 ^ (0x1E ^ 0x3F) ^ -1)) != 0;
                                    }
                                } else {
                                    bl = lIIllIllI[0];
                                }
            ...
            while (b.lIIIIIIlIIlI(lIIIIIIlIlIIIII2, K.size())) {
                ...
                while (b.lIIIIIIlIIII(b.a(lIIIIIIlIIlllll) ? 1 : 0)) {
                    ...
                    0;
                    0;
                    if ((0x79 ^ 0x39 ^ (0x63 ^ 0x27)) > -1) continue;
                    return;
                }
                if (b.lIIIIIIlIIIl(GrandExchange.canCollect() ? 1 : 0)) {
                    GrandExchange.collect();
                    Time.sleepUntil(() -> {
                        ...
                        if (b.lIIIIIIlIIII(GrandExchange.canCollect() ? 1 : 0)) {
                            ...
                            if (-(0x86 ^ 0xB1 ^ (0x51 ^ 0x63)) >= 0) {
                                return ((31 + 209 - 110 + 93 ^ 25 + 27 - -88 + 57) & (0x58 ^ 0x5D ^ (0x30 ^ 0x2F) ^ -1)) != 0;
                            }
                        } else {
                            bl = lIIllIllI[0];
                        }
                ...
                ++lIIIIIIlIlIIIII2;
                0;
                if (((0x24 ^ 6 ^ (0x5B ^ 0x53)) & (0x6A ^ 0x5C ^ (0x37 ^ 0x2B) ^ -1)) <= 0) continue;
                return;
            }
        }
    }
