...
implements W {
    ...
    private static void lIIlIIIlIIll() {
        ...
        al.lIlIllIII[1] = (0x38 ^ 0x55 ^ (0x1C ^ 0x79)) & (0x2B ^ 0x41 ^ (0x1B ^ 0x79) ^ -1);
        al.lIlIllIII[2] = 1;
        al.lIlIllIII[3] = 2;
        al.lIlIllIII[4] = 3;
    ...
    private static void lIIlIIIlIIlI() {
        ...
        al.lIlIlIllI[al.lIlIllIII[1]] = al."Buying items";
        al.lIlIlIllI[al.lIlIllIII[2]] = al."Finished buying items, switching back to prayer";
        al.lIlIlIllI[al.lIlIllIII[3]] = al."Navigating to bank";
        al.lIlIlIllI[al.lIlIllIII[4]] = al."Handling banking";
        al.lIlIlIllI[al.lIlIllIII[6]] = al."We are missing prayer supplies, switching to BUYING";
        al.lIlIlIllI[al.lIlIllIII[13]] = al."Drink";
        al.lIlIlIllI[al.lIlIllIII[15]] = al."Tele to wildy";
        al.lIlIlIllI[al.lIlIllIII[17]] = al."Rub";
        al.lIlIlIllI[al.lIlIllIII[18]] = al."Lava Maze";
        al.lIlIlIllI[al.lIlIllIII[19]] = al."Okay, teleport to level 41 Wilderness.";
        al.lIlIlIllI[al.lIlIllIII[21]] = al."Nav to altar";
        al.lIlIlIllI[al.lIlIllIII[41]] = al."1 tick pray";
        al.lIlIlIllI[al.lIlIllIII[44]] = al."Chaos altar";
        al.lIlIlIllI[al.lIlIllIII[20]] = al."Large door";
        al.lIlIlIllI[al.lIlIllIII[46]] = al."Open";
        al.lIlIlIllI[al.lIlIllIII[47]] = al."Open";
        al.lIlIlIllI[al.lIlIllIII[48]] = al."Open";
        al.lIlIlIllI[al.lIlIllIII[49]] = al."Chaos altar";
        al.lIlIlIllI[al.lIlIllIII[51]] = al."Nav to altar";
        al.lIlIlIllI[al.lIlIllIII[52]] = al."Unnoting bones";
        al.lIlIlIllI[al.lIlIllIII[14]] = al."Elder Chaos druid";
        al.lIlIlIllI[al.lIlIllIII[53]] = al."Large door";
        al.lIlIlIllI[al.lIlIllIII[54]] = al."Open";
        al.lIlIlIllI[al.lIlIllIII[55]] = al."Open";
        al.lIlIlIllI[al.lIlIllIII[56]] = al."Open";
        al.lIlIlIllI[al.lIlIllIII[57]] = al."Exchange";
        al.lIlIlIllI[al.lIlIllIII[58]] = al."Exchange 5";
        al.lIlIlIllI[al.lIlIllIII[59]] = al."Exchange All";
        al.lIlIlIllI[al.lIlIllIII[60]] = al."Suiciding";
        al.lIlIlIllI[al.lIlIllIII[61]] = al."Wine of zamorak";
        al.lIlIlIllI[al.lIlIllIII[62]] = al."Take";
        al.lIlIlIllI[al.lIlIllIII[75]] = al."Prayer training";
        al.lIlIlIllI[al.lIlIllIII[77]] = al."ring of wealth (";
    }
}
