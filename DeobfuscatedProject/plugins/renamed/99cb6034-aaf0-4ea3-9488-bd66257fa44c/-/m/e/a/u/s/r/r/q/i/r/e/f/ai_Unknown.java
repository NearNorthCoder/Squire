...
extends HerbType {
    ...
    private static void llllIIllIlIIll() {
        ...
        ai.llIIIIlllIIl[0] = 3;
        ai.llIIIIlllIIl[1] = 138 + 15 - 31 + 48 ^ 155 + 32 - 127 + 114;
        ai.llIIIIlllIIl[2] = 144 + 27 - 141 + 156 ^ 97 + 147 - 119 + 64;
        ai.llIIIIlllIIl[3] = 0x34 ^ 0x3C;
        ai.llIIIIlllIIl[4] = 0x6C ^ 0x67;
        ai.llIIIIlllIIl[5] = 0x7F ^ 0x73;
        ai.llIIIIlllIIl[6] = (0x4C ^ 0x7D ^ 3) & (3 ^ 0x16 ^ (0x16 ^ 0x31) ^ -1);
        ai.llIIIIlllIIl[7] = 0x40 ^ 0x6F ^ (0x98 ^ 0xBA);
        ai.llIIIIlllIIl[8] = 0x78 ^ 0x68;
        ai.llIIIIlllIIl[9] = 55 + 37 - 38 + 123 ^ 44 + 99 - 100 + 117;
        ai.llIIIIlllIIl[10] = 0x60 ^ 0x72;
        ai.llIIIIlllIIl[11] = 0x71 ^ 0x64;
        ai.llIIIIlllIIl[12] = 0xE ^ 0x55 ^ (0xC9 ^ 0x84);
        ai.llIIIIlllIIl[13] = 0xAE ^ 0xB9;
        ai.llIIIIlllIIl[14] = 0x6C ^ 0x76;
        ai.llIIIIlllIIl[15] = 0xAC ^ 0xB7;
        ai.llIIIIlllIIl[16] = 0xC ^ 0x79 ^ (0xCB ^ 0xA2);
        ai.llIIIIlllIIl[17] = 0x5E ^ 0x6E ^ (0xB6 ^ 0x99);
        ai.llIIIIlllIIl[18] = 188 + 68 - 163 + 138 ^ 60 + 80 - -32 + 27;
        ai.llIIIIlllIIl[19] = 0x1B ^ 0x6F ^ (0x21 ^ 0x74);
        ai.llIIIIlllIIl[20] = 0xF ^ 0x24 ^ (0xAF ^ 0xA7);
        ai.llIIIIlllIIl[21] = 0x57 ^ 0x5E ^ (0x95 ^ 0xB8);
        ai.llIIIIlllIIl[22] = 0xD ^ 0x28;
        ai.llIIIIlllIIl[23] = 9 ^ 0x21;
        ai.llIIIIlllIIl[24] = 0x76 ^ 0x5F;
        ai.llIIIIlllIIl[25] = 0x20 ^ 0x35 ^ (0xB6 ^ 0x89);
        ai.llIIIIlllIIl[26] = 0x3F ^ 0x78;
        ai.llIIIIlllIIl[27] = 0x30 ^ 2 ^ (0xCA ^ 0xB0);
        ai.llIIIIlllIIl[28] = 0x39 ^ 0x72;
        ai.llIIIIlllIIl[29] = 37 + 115 - 101 + 203 ^ 119 + 162 - 164 + 61;
        ai.llIIIIlllIIl[30] = 0x76 ^ 0x40 ^ (0x4F ^ 0x34);
        ai.llIIIIlllIIl[31] = 0x5D ^ 0xD;
        ai.llIIIIlllIIl[32] = 0x39 ^ 0x68;
        ai.llIIIIlllIIl[33] = 0xF4 ^ 0xA6;
        ai.llIIIIlllIIl[34] = 0x46 ^ 0x25 ^ (0xA4 ^ 0x92);
        ai.llIIIIlllIIl[35] = 0x49 ^ 0x7C ^ (0xD2 ^ 0xB1);
        ai.llIIIIlllIIl[36] = 0xEE ^ 0xC7 ^ (0xBF ^ 0xC1);
        ai.llIIIIlllIIl[37] = 0x3F ^ 0x4A ^ (0xEA ^ 0xC5);
        ai.llIIIIlllIIl[38] = 0x1D ^ 0xD ^ (0x6F ^ 0x24);
        ai.llIIIIlllIIl[39] = 0x20 ^ 0x7C;
        ai.llIIIIlllIIl[40] = 3 ^ 0x5C;
        ai.llIIIIlllIIl[41] = 0x75 ^ 0x15;
        ai.llIIIIlllIIl[42] = 66 + 36 - -7 + 83 ^ 61 + 17 - 50 + 136;
        ai.llIIIIlllIIl[43] = 0x28 ^ 0x65 ^ (0x21 ^ 9);
        ai.llIIIIlllIIl[44] = 0x40 ^ 0x33 ^ (0x5D ^ 0x46);
        ai.llIIIIlllIIl[45] = 0x56 ^ 0x3F;
        ai.llIIIIlllIIl[46] = 74 + 7 - 34 + 89;
        ai.llIIIIlllIIl[47] = (0x1C ^ 8) + (0xD8 ^ 0xAE) - (0xD ^ 0x43) + (0x3B ^ 0x76);
        ai.llIIIIlllIIl[48] = 48 + 100 - 70 + 61;
        ai.llIIIIlllIIl[49] = (0x33 ^ 0x7D) + (3 ^ 0x21) - (0x82 ^ 0xBC) + (0xFF ^ 0xA5);
        ai.llIIIIlllIIl[50] = 105 + 30 - 40 + 46;
        ai.llIIIIlllIIl[51] = 33 + 40 - 59 + 128;
        ai.llIIIIlllIIl[52] = (0x51 ^ 0x4C) + (0x52 ^ 7) - -(0x3A ^ 0x3F) + (0x77 ^ 0x6E);
        ai.llIIIIlllIIl[53] = (0xE2 ^ 0x9A) + (0x51 ^ 0x20) - (0xCE ^ 0xA3) + (0x92 ^ 0x87);
        ai.llIIIIlllIIl[54] = (8 ^ 0x56) + (0xF ^ 0x3E) - (98 + 52 - 141 + 124) + (33 + 68 - -8 + 27);
        ai.llIIIIlllIIl[55] = 118 + 95 - 88 + 22;
        ai.llIIIIlllIIl[56] = (9 ^ 0x5F) + (7 ^ 0x53) - (0xEF ^ 0xAE) + (0xAD ^ 0x81);
        ai.llIIIIlllIIl[57] = 103 + 128 - 154 + 73;
        ai.llIIIIlllIIl[58] = (0xA2 ^ 0xAA) + (0x9A ^ 0xC0) - (0x49 ^ 0x5B) + (0x40 ^ 7);
        ai.llIIIIlllIIl[59] = (0x64 ^ 0x57) + (0x6B ^ 0x13) - (0x14 ^ 0xA) + (0x59 ^ 0x52);
        ai.llIIIIlllIIl[60] = (0x2E ^ 0x79) + (50 + 81 - 72 + 68) - (0xEF ^ 0xAC) + (0x76 ^ 0x71);
        ai.llIIIIlllIIl[61] = 133 + 15 - 104 + 111;
        ai.llIIIIlllIIl[62] = 25 + 22 - -60 + 49;
        ai.llIIIIlllIIl[63] = 52 + 25 - -69 + 11;
        ai.llIIIIlllIIl[64] = 14 + 103 - 78 + 120;
        ai.llIIIIlllIIl[65] = 116 + 99 - 64 + 9;
        ai.llIIIIlllIIl[66] = (0x64 ^ 0x70) + (0x6F ^ 0x32) - (0x5E ^ 0x7B) + (0x2F ^ 0x76);
        ai.llIIIIlllIIl[67] = (0x1B ^ 0x65) + (0xC2 ^ 0xB4) - (0xD1 ^ 0xBF) + (0x10 ^ 0x30);
        ai.llIIIIlllIIl[68] = (0x46 ^ 0x22) + (0xB2 ^ 0xB6) - (0xD4 ^ 0x9C) + (47 + 78 - 79 + 90);
        ai.llIIIIlllIIl[69] = (0x52 ^ 3) + (0x7A ^ 0x1F) - (0xB2 ^ 0xC2) + (0x29 ^ 0x4A);
        ai.llIIIIlllIIl[70] = 185 + 100 - 251 + 166;
        ai.llIIIIlllIIl[71] = 109 + 66 - 113 + 139;
        ai.llIIIIlllIIl[72] = 118 + 124 - 115 + 34 + (0xB8 ^ 0x99) - (106 + 126 - 167 + 102) + (6 + 173 - 145 + 143);
        ai.llIIIIlllIIl[73] = 9 + 95 - -61 + 40;
        ai.llIIIIlllIIl[74] = 113 + 96 - 112 + 109;
        ai.llIIIIlllIIl[75] = 3 + (0xC0 ^ 0xA6) - -(0x4E ^ 0xE) + (0xA4 ^ 0x8C);
        ai.llIIIIlllIIl[76] = 37 + 98 - -13 + 2 + (37 + 141 - 88 + 52) - (107 + 102 - 129 + 52) + (0xE ^ 0x3C);
        ai.llIIIIlllIIl[77] = 66 + 29 - -57 + 59;
        ai.llIIIIlllIIl[78] = 137 + 134 - 222 + 165;
        ai.llIIIIlllIIl[79] = 69 + 75 - 135 + 122 + (0xAF ^ 0xC2) - (0x69 ^ 6) + (0x25 ^ 0x73);
        ai.llIIIIlllIIl[80] = 127 + 9 - 9 + 33 + (0x6A ^ 0x60) - (0x56 ^ 0x78) + (0xCC ^ 0x90);
        ai.llIIIIlllIIl[81] = 61 + 119 - 146 + 185;
        ai.llIIIIlllIIl[82] = (0xFF ^ 0xAB) + (195 + 92 - 271 + 193) - (0 ^ 0x5C) + (0xB7 ^ 0xA4);
        ai.llIIIIlllIIl[83] = 35 + 66 - 89 + 125 + (0xE8 ^ 0xAD) - (155 + 97 - 236 + 144) + (81 + 60 - 134 + 168);
        ai.llIIIIlllIIl[84] = (0x67 ^ 0x2F) + (0x55 ^ 0x37) - (0x9E ^ 0xC2) + (67 + 105 - 113 + 87);
        ai.llIIIIlllIIl[85] = 132 + 179 - 304 + 218;
        ai.llIIIIlllIIl[86] = 22 + 102 - -23 + 20 + (0x16 ^ 0x7A) - (128 + 6 - 27 + 58) + (0xF ^ 0x78);
        ai.llIIIIlllIIl[87] = 60 + 169 - 205 + 204 + (0x71 ^ 0xD) - (39 + 10 - -61 + 17) + (0x76 ^ 0x73);
        ai.llIIIIlllIIl[88] = (0xDE ^ 0x95) + (0x88 ^ 0x86) - -(0x7C ^ 0x50) + (0x7F ^ 0x1B);
        ai.llIIIIlllIIl[89] = 48 + 229 - 99 + 56;
        ai.llIIIIlllIIl[90] = 169 + 86 - 201 + 201;
    }
