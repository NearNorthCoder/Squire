...
extends HerbType {
    ...
    private static void llllIIIIllllII() {
        ...
        ah.llIIIIIIlIII[38] = 0x75 ^ 0x3C ^ 3;
        ...
        ah.llIIIIIIlIII[62] = (0x5C ^ 0x59) + (0xCE ^ 0x94) - -(0x7D ^ 0x5C) + 3;
        ...
        ah.llIIIIIIlIII[71] = (0x38 ^ 0x6D) + (0xFF ^ 0x82) - (0x74 ^ 0x37) + 2;
