...
extends SquirePlugin {
    ...
    private static void lllllI() {
        lIlII = new int[6];
        BankNoteRunecrafter.lIlII[0] = (0x80 ^ 0x8B ^ (0x86 ^ 0xB2)) & (0xB2 ^ 0xA2 ^ (0x83 ^ 0xAC) ^ -1);
        BankNoteRunecrafter.lIlII[1] = 1;
        BankNoteRunecrafter.lIlII[2] = 2;
        BankNoteRunecrafter.lIlII[3] = 3;
    ...
    private static void llllIl() {
        ...
        BankNoteRunecrafter.lIIll[BankNoteRunecrafter.lIlII[0]] = BankNoteRunecrafter."Craft-rune";
        BankNoteRunecrafter.lIIll[BankNoteRunecrafter.lIlII[1]] = BankNoteRunecrafter."Craft-rune";
        BankNoteRunecrafter.lIIll[BankNoteRunecrafter.lIlII[2]] = BankNoteRunecrafter."essence";
        BankNoteRunecrafter.lIIll[BankNoteRunecrafter.lIlII[3]] = BankNoteRunecrafter."essence";
    }
