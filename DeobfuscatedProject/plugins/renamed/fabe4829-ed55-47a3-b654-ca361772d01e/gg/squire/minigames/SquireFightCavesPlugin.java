...
import h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.BankTask;
import h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.EatTask;
import h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.EnterCaveTask;
import h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.PrayerSwitchTask;
import h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.n_Unknown;
import h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.JadFightTask;
import h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.Wave15To30Task;
import h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.Wave1To6Task;
import h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.WaveWave31_62Task;
import h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.Wave7To14Task;
...
extends SquirePlugin {
    ...
    public void a(ChatMessage chatMessage) {
        if (SquireFightCavesPlugin.llllIlllIIIlII(chatMessage.getType(), ChatMessageType.GAMEMESSAGE) && SquireFightCavesPlugin.llllIlllIIIllI(chatMessage.getMessage().contains(llIIIlllIlIl[llIIIlllIllI[4]]) ? 1 : 0)) {
            0;
            h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.a(llIIIlllIllI[6]);
            0;
            h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.b(llIIIlllIllI[6]);
            h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.i(llIIIlllIllI[4]);
            h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.f(llIIIlllIllI[4]);
            h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.g(llIIIlllIllI[4]);
            h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.d(llIIIlllIllI[4]);
            ...
            if (SquireFightCavesPlugin.llllIlllIIIlll(n2)) {
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.EEnum.g().filter(e2 -> {
                    boolean bl;
                ...
                0;
                a.info("setting current wave to: " + h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.p());
            }
        }
    }
    ...
    private void b(e e2) {
        0;
        h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.b(e2.i());
    }
    ...
    public void a(AnimationChanged animationChanged) {
        ...
        void var13;
        0;
        if (SquireFightCavesPlugin.llllIlllIIlIII(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.n() ? 1 : 0)) {
            if (SquireFightCavesPlugin.llllIlllIIIllI(animationChanged.getActor().equals(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.n_Unknown.b(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.BEnum.BLOB)) ? 1 : 0) && SquireFightCavesPlugin.llllIlllIIIlIl(animationChanged.getActor().getAnimation(), llIIIlllIllI[1])) {
                0;
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.b(llIIIlllIllI[4]);
                0;
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.i(Static.getClient().getTickCount());
                0;
                a.info("Setting blob attack: " + h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.w());
            }
            if (SquireFightCavesPlugin.llllIlllIIIllI(var13.getActor().equals(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.n_Unknown.b(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.BEnum.RANGER)) ? 1 : 0) && SquireFightCavesPlugin.llllIlllIIIlIl(var13.getActor().getAnimation(), llIIIlllIllI[0])) {
                f cfr_ignored_0 = var5.e;
                0;
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.b(llIIIlllIllI[4]);
                f cfr_ignored_1 = var5.e;
                0;
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.g(Static.getClient().getTickCount());
                f cfr_ignored_2 = var5.e;
                0;
                a.info("" + h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.u());
            }
            if (SquireFightCavesPlugin.llllIlllIIIllI(var13.getActor().equals(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.n_Unknown.b(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.BEnum.MAGER)) ? 1 : 0) && SquireFightCavesPlugin.llllIlllIIIlIl(var13.getActor().getAnimation(), llIIIlllIllI[2])) {
                f cfr_ignored_3 = var5.e;
                0;
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.b(llIIIlllIllI[4]);
                f cfr_ignored_4 = var5.e;
                0;
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.f(Static.getClient().getTickCount());
            }
            if (SquireFightCavesPlugin.llllIlllIIIllI(var13.getActor().equals(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.n_Unknown.b(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.BEnum.MELEER)) ? 1 : 0) && SquireFightCavesPlugin.llllIlllIIIlIl(var13.getActor().getAnimation(), llIIIlllIllI[3])) {
                f cfr_ignored_5 = var5.e;
                0;
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.b(llIIIlllIllI[4]);
                f cfr_ignored_6 = var5.e;
                0;
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.d(Static.getClient().getTickCount());
                a.info("client tick count = " + Static.getClient().getTickCount());
            }
        }
        if (SquireFightCavesPlugin.llllIlllIIlIIl(var4 = NPCs.getNearest((int[])h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.c_Unknown.v)) && SquireFightCavesPlugin.llllIlllIIIllI(var13.getActor().equals(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.n_Unknown.b(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.BEnum.JAD)) ? 1 : 0)) {
            if (SquireFightCavesPlugin.llllIlllIIIlIl(var13.getActor().getAnimation(), llIIIlllIllI[15])) {
                f cfr_ignored_7 = var5.e;
                0;
                h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.c(Static.getClient().getTickCount());
            }
    ...
    private void a(e e2) {
        0;
        h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.a(e2);
    }

    protected void onStart() {
        this.b.add((Overlay)this.c);
        0;
        h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.f_Unknown.a(h.-.q.i.r.s.u.s.i.e.v.a.c.g.-.t.e.f.EEnum.WAVE3);
