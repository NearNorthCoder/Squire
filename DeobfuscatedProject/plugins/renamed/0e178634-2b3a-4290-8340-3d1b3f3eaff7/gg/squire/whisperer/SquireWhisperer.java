...
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.UsingImbuedHeartTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.EnteringRealmTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.WalkingOnGreenOrbsTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.KillingSetOfGhostsTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.HidingBehindPillarTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.a_Unknown;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.d_Unknown;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.DrinkingStaminaPotionTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.RechargingTridentTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.WalkingToTheBankTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.WalkingToBossTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.WithdrawingItemsTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.AttackingWhispererTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.DisturbingOddFigureTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.DodgingTentaclesTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.HandlingPrayersTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.MovingOutOfMeleeRangeTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.TakingLootTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.TeleportingOutTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.DrinkingBrewsTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.DroppingEmptyVialsTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.EatingFoodTask;
import r.e.s.w.e.-.i.h.p.s.r.r.e.q.u.i.RestoringPrayerTask;
...
extends SquirePlugin {
    ...
    private static String llIIIIIlIllIlII(String var2, String var7) {
        try {
            SecretKeySpec var8 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var7.getBytes(StandardCharsets.UTF_8)), lIlIllIllIIII[9]), "DES");
            Cipher var9 = Cipher.getInstance("DES");
            var9.init(lIlIllIllIIII[3], var8);
    ...
    public void a(ChatMessage chatMessage) {
        ...
        if (SquireWhisperer.llIIIIIlIlllIlI(var6.getMessage().contains(lIlIllIlIllII[lIlIllIllIIII[2]]) ? 1 : 0)) {
            SquireWhisperer var1;
            var1.g = lIlIllIllIIII[2];
    ...
    private static String llIIIIIlIllIIll(String var3, String var5) {
        try {
            ...
            var4.init(lIlIllIllIIII[3], var10);
