...
import g.r.r.-.t.q.i.u.o.e.s.BEnum;
...
extends Enum<d> {
    ...
    private static void lllllllIIlIIII() {
        ...
        d.llIIlllIIlII[d.llIIlllIIlIl[0]] = d."Guardian of %s";
        d.llIIlllIIlII[d.llIIlllIIlIl[1]] = d."AIR";
        d.llIIlllIIlII[d.llIIlllIIlIl[7]] = d."MIND";
        d.llIIlllIIlII[d.llIIlllIIlIl[12]] = d."WATER";
        d.llIIlllIIlII[d.llIIlllIIlIl[19]] = d."EARTH";
        d.llIIlllIIlII[d.llIIlllIIlIl[13]] = d."FIRE";
        d.llIIlllIIlII[d.llIIlllIIlIl[30]] = d."BODY";
        d.llIIlllIIlII[d.llIIlllIIlIl[37]] = d."COSMIC";
        d.llIIlllIIlII[d.llIIlllIIlIl[43]] = d."CHAOS";
        d.llIIlllIIlII[d.llIIlllIIlIl[20]] = d."NATURE";
        d.llIIlllIIlII[d.llIIlllIIlIl[56]] = d."LAW";
        d.llIIlllIIlII[d.llIIlllIIlIl[63]] = d."DEATH";
        d.llIIlllIIlII[d.llIIlllIIlIl[69]] = d."BLOOD";
    }
    ...
    private static String lllllllIIIlllI(String var3, String var6) {
        try {
    ...
    private static String lllllllIIIllIl(String var18, String var13) {
        try {
            SecretKeySpec var17 = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(var13.getBytes(StandardCharsets.UTF_8)), llIIlllIIlIl[43]), "DES");
            Cipher var4 = Cipher.getInstance("DES");
            var4.init(llIIlllIIlIl[7], var17);
    ...
    private static String lllllllIIIllll(String var11, String var9) {
        var11 = new String(Base64.getDecoder().decode(var11.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        StringBuilder var10 = new StringBuilder();
        char[] var16 = var9.toCharArray();
        int var2 = llIIlllIIlIl[0];
        char[] var5 = var11.toCharArray();
        int var19 = var5.length;
        int var12 = llIIlllIIlIl[0];
        while (d.lllllllIIlIIlI(var12, var19)) {
            char var7 = var5[var12];
            var10.append((char)(var7 ^ var16[var2 % var16.length]));
            0;
            ++var2;
            ++var12;
            0;
