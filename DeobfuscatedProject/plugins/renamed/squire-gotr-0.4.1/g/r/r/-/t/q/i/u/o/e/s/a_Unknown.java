...
public class a_Unknown {
    ...
    public void a(MenuAutomated menuAutomated) {
        void var3_3;
        void var21;
        if (g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llllllllIlIIlI(menuAutomated.getTarget().contains(llIIllllIlII[llIIllllIllI[0]]) ? 1 : 0)) {
            return;
        }
        int var12 = Integer.parseInt(var21.getTarget().replace(llIIllllIlII[llIIllllIllI[1]], llIIllllIlII[llIIllllIllI[2]]).trim());
        e var7 = e.c(var12);
        if (g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llllllllIlIIll((Object)var7)) {
            return;
        }
        this.b = var3_3;
    }
    ...
    private static void llllllllIlIIIl() {
        ...
        g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIllI[0] = (123 + 134 - 131 + 20 ^ 77 + 93 - 141 + 132) & (0xCC ^ 0x90 ^ (0x3F ^ 0x50) ^ -1);
        g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIllI[1] = 1;
        g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIllI[2] = 2;
        g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIllI[3] = -1;
        g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIllI[4] = 3;
        g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIllI[5] = 0x19 ^ 0x1D;
        g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIllI[6] = 0x1E ^ 0x16;
    }
    ...
    private static void llllllllIIllIl() {
        ...
        g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIlII[g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIllI[0]] = g.r.r.-.t.q.i.u.o.e.s.a_Unknown."ItemId=";
        g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIlII[g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIllI[1]] = g.r.r.-.t.q.i.u.o.e.s.a_Unknown."ItemId=";
        g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIlII[g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIllI[2]] = g.r.r.-.t.q.i.u.o.e.s.a_Unknown."";
        g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIlII[g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llIIllllIllI[4]] = g.r.r.-.t.q.i.u.o.e.s.a_Unknown."You cannot add any more essence to the pouch";
    }

    static {
        g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llllllllIlIIIl();
        g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llllllllIIllIl();
    ...
    public void a(ChatMessage chatMessage) {
        a var19;
        void var8;
        if (g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llllllllIlIlIl(chatMessage.getType(), ChatMessageType.GAMEMESSAGE) && g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llllllllIlIlIl(chatMessage.getType(), ChatMessageType.SPAM)) {
            return;
        }
        if (g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llllllllIlIIlI(var8.getMessage().startsWith(llIIllllIlII[llIIllllIllI[4]]) ? 1 : 0)) {
            return;
        }
        if (g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llllllllIlIIll((Object)var19.b)) {
            // empty if block
        }
    }
    ...
    public void a(MenuOptionClicked menuOptionClicked) {
        void var2_2;
        void var3;
        if (g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llllllllIlIlII(menuOptionClicked.getItemId(), llIIllllIllI[3])) {
            return;
        }
        e var15 = e.c(var3.getItemId());
        if (g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llllllllIlIIll((Object)var15)) {
            return;
        }
        this.b = var2_2;
    }
    ...
    private static String llllllllIIllII(String var26, String var25) {
        ...
        while (g.r.r.-.t.q.i.u.o.e.s.a_Unknown.llllllllIlIllI(var23, var2)) {
