...
extends OverlayPanel {
    ...
    public SquireInfoBox(T plugin) {
        this.plugin = plugin;
        this.taskManager = ((SquirePlugin)plugin).getManager();
        this.name = ((Plugin)plugin).getName();
        this.version = ((SquirePlugin)plugin).getVersion();
    ...
    public Dimension render(Graphics2D graphics2D) {
        if (((SquirePlugin)this.plugin).isPaintDisabled()) {
            return null;
        }
