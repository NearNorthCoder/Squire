...
public enum HousePortal {
    ...
    WATCHTOWER(new WorldPoint(2931, 4717, 2), "Yanille Watchtower Portal", "Watchtower", "Watchtower"),
    ...
    BARROWS(new WorldPoint(3563, 3313, 0), "Barrows Portal", "Enter", "Barrows"),
    ...
    private HousePortal(WorldPoint destination, String portalName, String nexusTarget) {
        ...
        this.portalAction = "Enter";
        this.nexusTarget = nexusTarget;
    }

    private HousePortal(WorldPoint destination, String portalName, String portalAction, String nexusTarget) {
        this.destination = destination;
        this.portalName = portalName;
