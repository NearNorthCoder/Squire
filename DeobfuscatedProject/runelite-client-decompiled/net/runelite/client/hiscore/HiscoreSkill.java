...
public enum HiscoreSkill {
    ...
    LAST_MAN_STANDING("LMS - Rank", HiscoreSkillType.ACTIVITY),
    ...
    CALVARION("Calvar'ion", HiscoreSkillType.BOSS),
    ...
    DUKE_SUCELLUS("Duke Sucellus", HiscoreSkillType.BOSS),
    ...
    LUNAR_CHESTS("Lunar Chests", HiscoreSkillType.BOSS),
    ...
    SCURRIUS("Scurrius", HiscoreSkillType.BOSS),
    SKOTIZO("Skotizo", HiscoreSkillType.BOSS),
    SOL_HEREDIT("Sol Heredit", HiscoreSkillType.BOSS),
    SPINDEL("Spindel", HiscoreSkillType.BOSS),
    ...
    THE_LEVIATHAN("The Leviathan", HiscoreSkillType.BOSS),
    THE_WHISPERER("The Whisperer", HiscoreSkillType.BOSS),
    ...
    VARDORVIS("Vardorvis", HiscoreSkillType.BOSS),
