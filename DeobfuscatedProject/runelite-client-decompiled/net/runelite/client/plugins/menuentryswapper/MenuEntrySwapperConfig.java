...
extends Config {
    ...
    @ConfigItem(keyName="teleportSubmenus", name="Teleport submenus", description="Use submenus for max, construction, hunter, and diary cape teleports", section="items")
    default public boolean teleportSubmenus() {
        return false;
    }
