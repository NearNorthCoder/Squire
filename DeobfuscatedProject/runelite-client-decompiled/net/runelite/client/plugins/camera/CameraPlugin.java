...
MouseListener {
    ...
    void copyConfigs() {
        this.client.setCameraMouseButtonMask(!this.config.rightClickMenuBlocksCamera() ? 20 : 0);
    ...
    public void onScriptCallbackEvent(ScriptCallbackEvent event) {
        ...
        if ("outerZoomLimit".equals(event.getEventName())) {
            int outerZoomLimit;
            int outerLimit = Ints.constrainToRange(this.config.outerLimit(), -400, 400);
    ...
    public void keyReleased(KeyEvent e) {
        if (e.getKeyCode() == 17) {
            ...
            if (this.config.controlFunction() == ControlFunction.CONTROL_TO_RESET) {
                int zoomValue = Ints.constrainToRange(this.config.ctrlZoomValue(), -400, 1004);
