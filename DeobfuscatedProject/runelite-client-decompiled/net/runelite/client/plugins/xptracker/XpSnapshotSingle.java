...
final class XpSnapshotSingle {
    ...
    public String toString() {
        return "XpSnapshotSingle(actionType=" + String.valueOf((Object)this.getActionType()) + ", startLevel=" + this.getStartLevel() + ", endLevel=" + this.getEndLevel() + ", startGoalXp=" + this.getStartGoalXp() + ", endGoalXp=" + this.getEndGoalXp() + ", xpGainedInSession=" + this.getXpGainedInSession() + ", xpRemainingToGoal=" + this.getXpRemainingToGoal() + ", xpPerHour=" + this.getXpPerHour() + ", skillProgressToGoal=" + this.getSkillProgressToGoal() + ", actionsInSession=" + this.getActionsInSession() + ", actionsRemainingToGoal=" + this.getActionsRemainingToGoal() + ", actionsPerHour=" + this.getActionsPerHour() + ", timeTillGoal=" + this.getTimeTillGoal() + ", timeTillGoalHours=" + this.getTimeTillGoalHours() + ", timeTillGoalShort=" + this.getTimeTillGoalShort() + ")";
    }
    ...
    public static class XpSnapshotSingleBuilder {
        ...
        public String toString() {
            return "XpSnapshotSingle.XpSnapshotSingleBuilder(actionType=" + String.valueOf((Object)this.actionType) + ", startLevel=" + this.startLevel + ", endLevel=" + this.endLevel + ", startGoalXp=" + this.startGoalXp + ", endGoalXp=" + this.endGoalXp + ", xpGainedInSession=" + this.xpGainedInSession + ", xpRemainingToGoal=" + this.xpRemainingToGoal + ", xpPerHour=" + this.xpPerHour + ", skillProgressToGoal=" + this.skillProgressToGoal + ", actionsInSession=" + this.actionsInSession + ", actionsRemainingToGoal=" + this.actionsRemainingToGoal + ", actionsPerHour=" + this.actionsPerHour + ", timeTillGoal=" + this.timeTillGoal + ", timeTillGoalHours=" + this.timeTillGoalHours + ", timeTillGoalShort=" + this.timeTillGoalShort + ")";
        }
    }
}
