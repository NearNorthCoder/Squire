...
extends Plugin {
    ...
    public void onGrandExchangeOfferChanged(GrandExchangeOfferChanged offerEvent) {
        ...
        log.debug("GE offer updated: state: {}, slot: {}, item: {}, qty: {}, lastLoginTick: {}", offer.getState(), slot, offer.getItemId(), offer.getQuantitySold(), this.lastLoginTick);
    ...
    private void setGeTitle() {
        ...
        stringStack[n] = String.valueOf(stringStack[n]) + titleBuilder.toString();
    }
    ...
    void openGeLink(String name, int itemId) {
        String url = this.runeLiteConfig.useWikiItemPrices() ? "https://prices.runescape.wiki/" + (this.client.getWorldType().contains(WorldType.FRESH_START_WORLD) ? "fsw" : "osrs") + "/item/" + itemId : "https://services.runescape.com/m=itemdb_oldschool/" + name.replaceAll(" ", "+") + "/viewitem?obj=" + itemId;
