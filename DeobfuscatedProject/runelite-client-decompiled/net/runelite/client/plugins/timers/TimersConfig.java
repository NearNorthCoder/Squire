...
extends Config {
    ...
    @ConfigItem(keyName="showMenaphiteRemedy", name="Menaphite remedy timer", description="Configures whether Menaphite remedy timer is displayed")
    ...
    @ConfigItem(keyName="showHealGroup", name="Heal Group timer", description="Configures whether heal group timer is displayed")
    ...
    @ConfigItem(keyName="showFarmersAffinity", name="Farmer's Affinity", description="Configures whether Farmer's Affinity (Puro-Puro) timer is displayed")
    default public boolean showFarmersAffinity() {
        return true;
    }

    @ConfigItem(keyName="showSpellbookSwap", name="Spellbook Swap timer", description="Configures whether Spellbook Swap timer is displayed")
