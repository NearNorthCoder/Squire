...
extends Config {
    ...
    @ConfigItem(position=11, keyName="hidePets", name="Hide Other Players' Pets", description="Configures whether or not other player pets are hidden")
    ...
    @ConfigItem(position=15, keyName="hideThralls", name="Hide Thralls", description="Configures whether or not Thralls are hidden")
    default public boolean hideThralls() {
        return false;
    }

    @ConfigItem(position=16, keyName="hideRandomEvents", name="Hide Random Events", description="Configures whether or not Random events are hidden")
