...
public class ZMIData {
    ...
    public boolean equals(Object o) {
        ...
        if (this$itemsReceived == null ? other$itemsReceived != null : !((Object)this$itemsReceived).equals(other$itemsReceived)) {
            return false;
        }
        Multiset<Integer> this$itemsRemoved = this.getItemsRemoved();
        Multiset<Integer> other$itemsRemoved = other.getItemsRemoved();
        return !(this$itemsRemoved == null ? other$itemsRemoved != null : !((Object)this$itemsRemoved).equals(other$itemsRemoved));
    }
    ...
    public int hashCode() {
        ...
        result = result * 59 + ($itemsReceived == null ? 43 : ((Object)$itemsReceived).hashCode());
        Multiset<Integer> $itemsRemoved = this.getItemsRemoved();
        result = result * 59 + ($itemsRemoved == null ? 43 : ((Object)$itemsRemoved).hashCode());
        return result;
    }
