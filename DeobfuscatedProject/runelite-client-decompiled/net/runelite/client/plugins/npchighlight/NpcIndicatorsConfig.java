...
extends Config {
    public static final String GROUP = "npcindicators";
    ...
    @ConfigItem(position=7, keyName="npcToHighlight", name="NPCs to Highlight", description="List of NPC names to highlight. Format: (NPC), (NPC)")
