...
extends Overlay {
    ...
    public Dimension render(Graphics2D g) {
        ...
        if (this.config.showHitpoints()) {
            this.renderRegen(g, 0xA00007, this.plugin.getHitpointsPercentage(), HITPOINTS_COLOR);
        }
        if (this.config.showSpecial()) {
            this.renderRegen(g, 0xA00022, this.plugin.getSpecialPercentage(), SPECIAL_COLOR);
        }
        return null;
    }
