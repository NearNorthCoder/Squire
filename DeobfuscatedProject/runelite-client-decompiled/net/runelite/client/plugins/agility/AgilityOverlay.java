...
extends Overlay {
    ...
    private void highlightTile(Graphics2D graphics, LocalPoint playerLocation, Tile tile, Color color) {
        Polygon poly;
        if (tile.getPlane() == this.client.getPlane() && tile.getItemLayer() != null && tile.getLocalLocation().distanceTo(playerLocation) < 2350 && (poly = Perspective.getCanvasTilePoly((Client)this.client, (LocalPoint)tile.getLocalLocation(), (int)tile.getPlane())) != null) {
