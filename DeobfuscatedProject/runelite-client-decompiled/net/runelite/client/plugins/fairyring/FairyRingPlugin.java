...
extends Plugin {
    ...
    private void updateFilter(String filter) {
        ...
        Widget list = this.client.getWidget(24969224);
        Widget favorites = this.client.getWidget(24969225);
        if (list == null) {
            return;
        }
        ...
        if (this.codes == null) {
            ...
            for (Widget w2 : list.getStaticChildren()) {
                ...
                if (Strings.isNullOrEmpty(w2.getText())) continue;
        ...
        this.client.runScript(new Object[]{72, 24969382, 24969224, newHeight});
    }
