...
extends Overlay {
    ...
    private void renderLoadingLines(Graphics2D graphics) {
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            Point p0 = Perspective.localToCanvas((Client)this.client, (LocalPoint)lp0, (int)this.client.getPlane());
            Point p1 = Perspective.localToCanvas((Client)this.client, (LocalPoint)lp1, (int)this.client.getPlane());
