...
extends DevToolsFrame {
    ...
    ScriptInspector(Client client, EventBus eventBus, ConfigManager configManager) {
        ...
        this.jList = new JList<Integer>(this.listModel);
    ...
    private void removeSelectedFromSet() {
        ...
        int script = this.listModel.get(index);
    ...
    private static class ScriptTreeNode
    extends DefaultMutableTreeNode {
        ...
        public String toString() {
            ...
            if (this.source != null) {
                ...
                output = (String)output + "  -  " + WidgetUtil.componentToInterface((int)id) + "." + WidgetUtil.componentToId((int)id);
            ...
            if (this.args != null) {
                output = (String)output + " args: " + Arrays.toString(this.args);
            }
            return output;
        }
