...
extends PluginPanel {
    ...
    private JPanel createOptionsPanel() {
        ...
        notificationBtn.addActionListener(e -> this.scheduledExecutorService.schedule(() -> {
            Notification notif = new Notification().withEnabled(true).withTrayIconType(TrayIcon.MessageType.ERROR);
            this.notifier.notify(notif, "Wow!");
        }, 3L, TimeUnit.SECONDS));
        ...
        try {
            ...
            log.info("Shell couldn't be loaded", e3);
        }
        ...
        try {
            ...
            uiDefaultsBtn.addFrame(new DevToolsFrame(){
                {
                    this.getContentPane().add((Component)FlatUIDefaultsInspector.createInspectorPanel(), "Center");
                    this.pack();
                }
            });
