...
extends Config {
    ...
    @ConfigItem(keyName="valuableDrop", name="Screenshot Valuable drops", description="Configures whether or not screenshots are automatically taken when you receive a valuable drop.<br>Requires 'Loot drop notifications' to be enabled in the RuneScape settings.", position=14, section="what")
    ...
    @ConfigItem(keyName="untradeableDrop", name="Screenshot Untradeable drops", description="Configures whether or not screenshots are automatically taken when you receive an untradeable drop.<br>Requires 'Untradeable loot notifications' to be enabled in the RuneScape settings.", position=16, section="what")
    ...
    @ConfigItem(keyName="baHighGamble", name="Screenshot BA high gambles", description="Take a screenshot of your reward from a high gamble at Barbarian Assault.", position=18, section="what")
    ...
    @ConfigItem(keyName="wildernessLootChest", name="Screenshot wilderness loot chest", description="Take a screenshot when opening wilderness loot chest.", position=21, section="what")
