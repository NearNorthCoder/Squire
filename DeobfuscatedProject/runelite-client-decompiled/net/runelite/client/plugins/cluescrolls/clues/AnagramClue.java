...
ObjectClueScroll {
    ...
    public static AnagramClue forText(String text) {
        for (AnagramClue clue : CLUES) {
            if (!text.equalsIgnoreCase(ANAGRAM_TEXT + clue.text) && !text.equalsIgnoreCase(ANAGRAM_TEXT_BEGINNER + clue.text) && !text.equalsIgnoreCase(clue.question)) continue;
            return clue;
        }
        return null;
    }
    ...
    private static int $default$objectId() {
        return -1;
    }

    AnagramClue(String text, String npc, WorldPoint location, String area, @Nullable String question, @Nullable String answer, int objectId) {
        this.text = text;
        this.npc = npc;
    ...
    public static class AnagramClueBuilder {
        ...
        private boolean objectId$set;
        private int objectId$value;

        AnagramClueBuilder() {
        }

        public AnagramClueBuilder text(String text) {
            this.text = text;
            return this;
        }

        public AnagramClueBuilder npc(String npc) {
            this.npc = npc;
            return this;
        }

        public AnagramClueBuilder location(WorldPoint location) {
            this.location = location;
            return this;
        }
        ...
        public AnagramClueBuilder objectId(int objectId) {
            this.objectId$value = objectId;
            this.objectId$set = true;
            return this;
        }

        public AnagramClue build() {
            int objectId$value = this.objectId$value;
            if (!this.objectId$set) {
                objectId$value = AnagramClue.$default$objectId();
            }
            return new AnagramClue(this.text, this.npc, this.location, this.area, this.question, this.answer, objectId$value);
        }

        public String toString() {
            return "AnagramClue.AnagramClueBuilder(text=" + this.text + ", npc=" + this.npc + ", location=" + String.valueOf(this.location) + ", area=" + this.area + ", question=" + this.question + ", answer=" + this.answer + ", objectId$value=" + this.objectId$value + ")";
        }
    }
}
