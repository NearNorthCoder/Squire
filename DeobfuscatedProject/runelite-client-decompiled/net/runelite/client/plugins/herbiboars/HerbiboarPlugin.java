...
extends Plugin {
    ...
    private static final Set<Integer> START_OBJECT_IDS = ImmutableSet.of(Integer.valueOf(30519), Integer.valueOf(30520), Integer.valueOf(30521), Integer.valueOf(30522), Integer.valueOf(30523));
    private static final List<Integer> HERBIBOAR_REGIONS = ImmutableList.of(Integer.valueOf(14652), Integer.valueOf(14651), Integer.valueOf(14908), Integer.valueOf(14907));
    @Inject
    ...
    private boolean checkArea() {
        ...
        for (int region : HERBIBOAR_REGIONS) {
            if (!ArrayUtils.contains(mapRegions, region)) continue;
            return true;
        }
        return false;
    }
