...
extends Plugin {
    ...
    private static final Set<Integer> SOURCELESS_PLAYER_SOUNDS = ImmutableSet.of(Integer.valueOf(200));
    private static final Set<Integer> PRAYER_SOUNDS = ImmutableSet.of(Integer.valueOf(2690), Integer.valueOf(2688), Integer.valueOf(2664), Integer.valueOf(2685), Integer.valueOf(2670), Integer.valueOf(2684), new Integer[]{2689, 2662, 2679, 2678, 1982, 2666, 2668, 2687, 2691, 2667, 2675, 2677, 2676, 2665, 2669, 2682, 2680, 2686, 3826, 3825, 2663});
    @Inject
    ...
    private class Slider {
        ...
        protected void moveHandle(int x) {
            ...
            level = Ints.constrainToRange(level, 0, this.channel.max);
