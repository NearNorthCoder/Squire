...
extends Overlay {
    ...
    private void initRenderers() {
        ...
        this.barRenderers.put(BarMode.RUN_ENERGY, new BarRenderer(() -> 100, () -> this.client.getEnergy() / 100, () -> this.getRestoreValue("Run Energy"), () -> {
            if (this.client.getVarbitValue(25) != 0) {
                return RUN_STAMINA_COLOR;
            }
            return ENERGY_COLOR;
        }, () -> ENERGY_HEAL_COLOR, () -> this.energyIcon));
        this.barRenderers.put(BarMode.SPECIAL_ATTACK, new BarRenderer(() -> 100, () -> this.client.getVarpValue(300) / 10, () -> 0, () -> SPECIAL_ATTACK_COLOR, () -> SPECIAL_ATTACK_COLOR, () -> this.specialIcon));
    }
