...
extends Config {
    ...
    @ConfigItem(keyName="onlyShowLoot", name="Only show own items", description="Only shows items that are yours or you can pick up", position=25)
    default public boolean onlyShowOwnItems() {
        return false;
    }
