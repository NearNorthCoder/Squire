...
implements AutoCloseable {
    ...
    void send(WebsocketMessage message) {
        ...
        Party.Data data = (Party.Data)Party.Data.newBuilder().setData(ByteString.copyFromUtf8((String)json)).build();
    ...
    private void send(Party.C2S message) {
        ...
        this.webSocket.send(okio.ByteString.of(message.toByteArray()));
    }
    ...
    public void onMessage(WebSocket webSocket, okio.ByteString bytes) {
        ...
        switch (s2c.getMsgCase()) {
            ...
            case DATA: {
                ...
                try {
                    message = this.gson.fromJson(data.getData().toStringUtf8(), WebsocketMessage.class);
                }
