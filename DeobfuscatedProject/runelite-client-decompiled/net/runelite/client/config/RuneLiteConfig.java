...
extends Config {
    ...
    @ConfigItem(keyName="notificationFocused", name="Send notifications when focused", description="Toggles all notifications for when the client is focused", position=28, section="notificationSettings")
    default public boolean sendNotificationsWhenFocused() {
        return false;
    }

    @Alpha
    @ConfigItem(keyName="notificationFlashColor", name="Notification Flash", description="Sets the color of the notification flashes.", position=29, section="notificationSettings")
