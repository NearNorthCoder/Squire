...
public class ChatClient {
    ...
    public LayoutRoom[] getLayout(String username) throws IOException {
        ...
        try {
            ...
            InputStream in = response.body().byteStream();
            LayoutRoom[] layoutRoomArray = this.gson.fromJson((Reader)new InputStreamReader(in, StandardCharsets.UTF_8), LayoutRoom[].class);
            if (response != null) {
                response.close();
            }
    ...
    public Set<Integer> getPetList(String username) throws IOException {
        ...
        try {
            ...
            InputStream in = response.body().byteStream();
            Set set = (Set)this.gson.fromJson((Reader)new InputStreamReader(in, StandardCharsets.UTF_8), new TypeToken<Set<Integer>>(){}.getType());
            if (response != null) {
                response.close();
            }
            return set;
