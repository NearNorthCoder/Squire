...
extends FlatCheckBoxUI {
    @FlatStylingSupport.Styleable
    protected float rolloverIconAlpha = 1.0f;

    public static ComponentUI createUI(JComponent c) {
        return FlatUIUtils.canUseSharedUI((JComponent)c) ? FlatUIUtils.createSharedUI(RuneLiteCheckBoxUI.class, () -> new RuneLiteCheckBoxUI(true)) : new RuneLiteCheckBoxUI(false);
    }
