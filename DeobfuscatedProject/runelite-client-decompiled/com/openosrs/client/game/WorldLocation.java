...
public enum WorldLocation {
    ...
    WATERBIRTH_DUNGEON_DKS_1("DKS", new Location(2886, 4473, 2941, 4424), 0),
    WATERBIRTH_DUNGEON_DKS_2("DKS", new Location(2886, 4409, 2941, 4361), 0),
    ...
    DUEL_ARENA("Duel Arena", new Location(3338, 3252, 3391, 3204), 0),
    ...
    PRIFDDINAS("Prifddinas", new Location(3221, 6056, 3241, 6039), 0),
    ...
    private WorldLocation(String name, Location location, int plane) {
        this.name = name;
    ...
    public static Collection<WorldLocation> getNonWildernessLocations() {
        return Arrays.stream(WorldLocation.values()).filter(loc -> PvPUtil.getWildernessLevelFrom(loc.worldArea.toWorldPoint()) < 0).collect(Collectors.toList());
    }
    ...
    public static String location(WorldPoint worldPoint) {
        ...
        s = (String)s + " of ";
        if (((String)(s = (String)s + LOCATION_MAP.get(closestArea))).startsWith(" of ")) {
    ...
    public String toString() {
        return "WorldLocation{name='" + this.name + "', worldArea=" + String.valueOf(this.worldArea) + "}";
    }
    ...
    static {
        ...
        for (WorldLocation value : WorldLocation.values()) {
